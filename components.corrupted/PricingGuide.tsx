            ...
            <table className="w-full min-w-[800px]">;
              <thead>;
                <tr className="border-b border-gray-200">;
                  ...
                  <th className="text-center p-4 font-semibold text-gray-900">Market Average</th>;
                  <th className="text-center p-4 font-semibold text-gray-900">You Save</th>;
                </tr>;
              </thead>;
              <tbody>;
                  ...
                  <tr key={index} className="border-b border-gray-100 hover: bg-gray-50">;,
                    ...
                    <td className="p-4 text-center">;
                      <div className="font-semibold text-blue-600">;
                        ${service.starter.toLocaleString()}
                      </div>;
                    </td>;
                    <td className="p-4 text-center">;
                      <div className="font-semibold text-blue-600">;
                        ${service.professional.toLocaleString()}
                      </div>;
                    </td>;
                    <td className="p-4 text-center">;
                      <div className="font-semibold text-blue-600">;
                        ${service.enterprise.toLocaleString()}
                      </div>;
                    </td>;
                    <td className="p-4 text-center">;
                      <div className="text-gray-600">;
                        ${service.marketAverage.toLocaleString()}
                      </div>;
                    </td>;
                    <td className="p-4 text-center">;
          ...
          <div className="text-center">;
            ...
            <div className="grid grid-cols-1 md: grid-cols-3 gap-8 mt-8">;,
              ...
              <div className="text-center">;
                ...
                <h4 className="text-xl font-semibold mb-2">Enterprise Quality</h4>;
                <p className="text-blue-100">Bank-level security and 99.9% uptime</p>;
              </div>;
              <div className="text-center">;
                <Users className="w-12 h-12 mx-auto mb-4 text-blue-200" />;
                <h4 className="text-xl font-semibold mb-2">24/7 Support</h4>;
                <p className="text-blue-100">Dedicated support team always available</p>;
              </div>;
            </div>;
          </div>;
        </div>;

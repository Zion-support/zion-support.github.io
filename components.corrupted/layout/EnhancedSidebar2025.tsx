...
name: "Quantum Computing",";
        ...
        subItems[";
          ...
          { name: "Quantum Logistics", href: "/quantum-logistics-optimization" },"{ name: "Quantum Cybersecurity", href: "/quantum-cybersecurity-platform" }
        ];,
},;
      {;
...
name: "Enterprise IT",";
        ...
        subItems[";
          ...
          { name: "Quantum Data Center", href: "/quantum-data-center" },"{ name: "Quantum Cloud Migration", href: "/quantum-cloud-migration" }
        ];,
},;
      {;
...
name: "Micro SAAS",";
        ...
        subItems[";
          ...
          { name: "Marketing Automation Platform", href: "/marketing-automation-platform" },"{ name: "Project Management AI", href: "/project-management-ai" }
        ];,
},;
      {;
...
name: "Space Technology",";
        ...
        subItems[";
          ...
          { name: "Space Resource Management", href: "/space-resource-management" },"{ name: "Interplanetary Communication", href: "/interplanetary-communication" }
        ];,
},;
      {;
...
href: "/ai-services", icon: Brain,";
        ...
        subItems[";
          ...
          { name: "AI Emotional Intelligence", href: "/ai-emotional-intelligence-platform" },"{ name: "AI Legal Contract Analyzer", href: "/ai-legal-contract-analyzer" }
        ];,;,
},;
      {;
const sidebarSections = [;
  {;
    ...
    href: '/ai-emotional-intelligence-platform' }, { name: 'AI Legal Contract Analyzer',href: '/ai-legal-contract-analyzer' }'        ]'      }, {;
        name: 'Quantum Computing',;
    ...
    href: '/quantum-logistics-optimization' }, { name: 'Quantum Cybersecurity',href: '/quantum-cybersecurity-platform' }'        ]'      }, {;
        name: 'Enterprise IT',;
    ...
    href: '/quantum-data-center' }, { name: 'Quantum Cloud Migration',href: '/quantum-cloud-migration' }'        ]'      }, {;
        name: 'Micro SAAS',;
    ...
    href: '/marketing-automation-platform' }, { name: 'Project Management AI',href: '/project-management-ai' }'        ]'      }, {;
        name: 'Space Technology',;
    ...
    href: '/space-resource-management' }, { name: 'Interplanetary Communication',href: '/interplanetary-communication' }'        ]'      }, {;
        name: 'Emerging Tech',;
    ...
    href: '/advanced-robotics' }, { name: 'Biotechnology Platform',href: '/biotechnology-platform' }'        ]';
    ];,
},;
  {;
";
    ...
    href: '/history' },'          { name: 'Careers',href: '/careers' }'        ]'      }, {;
        name: 'Resources',;
    name: '        href: '/resources',;
    ...
    href: '/whitepapers' }, { name: 'Webinars',href: '/webinars' }'        ]'      }, {;
        name: 'Support',;
    name: '        href: '/support',;
...
className={`fixed left-0 top-0 h-full w-80 bg-black/95 backdrop-blur-xl border-r border-gray-800/50 z-50 overflow-y-auto}
        ...
        <div className="p-6 space-y-6>          {/* Home Link */}"          <Link;>
          ...
          {/* Service Sections */}
          {sidebarSections.map((section, sectionIndex) => (<div key={sectionIndex} className="space-y-3>              <button"                onClick={() => toggleSection(section.title)}
                      ...
                      <div key="{itemIndex}" className="space-y-2>";
                          ...
                          className="w-full" flex items-center justify-between p-2 hover: bg-gray-800/30 rounded-lg transition-all duration-300 group text-left"",
                            <item.icon className="w-4 h-4 text-gray-400 group-hover: text-cyan-400 transition-colors duration-200 />",;
                              ...
                              <p: className="text-gray-500" text-xs>{item.description}</p>"{item.subItems: && item.subItems.length > 0 && (",
                          ...
                          <div key="{item.name}">";
                            ...
                            >`";
                              ...
                              {item.children && (";
                                  ...
                                  {expandedItems.includes(item.name) ? (""className="{`flex" items-center px-4 py-3 rounded-lg transition-colors ${;
                                isActive(item.href)";
...
<div className="pt-6" border-t border-gray-800/50">"            <h4 className="text-sm" font-semibold text-gray-400 mb-3 uppercase tracking-wider>Quick Stats</h4>"            <div className="grid grid-cols-2 gap-3>              <div className="text-center p-3 bg-gray-800/30 rounded-lg border border-gray-700/30">                <div className="text-lg" font-bold text-cyan-400">500+</div>"                <div className="text-xs" text-gray-400>Services</div>"              </div>"              <div className="text-center" p-3 bg-gray-800/30 rounded-lg border border-gray-700/30>"                <div className="text-lg font-bold text-purple-400>1000+</div>                <div className="text-xs text-gray-400">Clients</div>              </div>            </div>";
          ...
          {/* comment */}";
            <div: className="p-4 bg-gradient-to-r from-cyan-500/20 to-purple-600/20 rounded-lg border border-cyan-500/30>,",;
              <h4: className = "text-sm font-semibold text-white mb-2">Ready to Transform ? </h4>," : <p
...
";
                          <div className="flex items-center gap-3">" : <item.icon className="w-4" h-4 text-gray-400 group-hover
...
<div className="pt-6 border-t border-gray-800/50>            <h4 className="text-sm font-semibold text-gray-400 mb-3 uppercase tracking-wider">Quick Stats</h4>"            <div className="grid grid-cols-2 gap-3>              <div className="text-center p-3 bg-gray-800/30 rounded-lg border border-gray-700/30">"                <div className="text-lg font-bold text-cyan-400>500+</div>                <div className="text-xs text-gray-400">Services</div>"              </div>"              <div className="text-center p-3 bg-gray-800/30 rounded-lg border border-gray-700/30>                <div className="text-lg font-bold text-purple-400">1000+</div>"                <div className="text-xs text-gray-400>Clients</div>              </div>"            </div>;
          ...
          <div className="pt-6 border-t border-gray-800/50>            <div className="p-4 bg-gradient-to-r from-cyan-500/20 to-purple-600/20 rounded-lg border border-cyan-500/30">"              <h4 className="text-sm font-semibold text-white mb-2>Ready to Transform ? </h4>              <p className="text-gray-300 text-xs mb-3">"                Get in touch to discuss your revolutionary technology needs."              </p>;
              <Link : >
                href="/contact""                onClick={onClose}"                className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-cyan-500 to-purple-600 hover
          </div>;
        </div>;
      </motion.div>;
</>;);,
...
export default EnhancedSidebar2025,";
            ...
            <div className="p-4 bg-gradient-to-r from-cyan-500/20 to-purple-600/20 rounded-lg border border-cyan-500/30">";
              ...
              <p className="text-gray-300 text-xs mb-3">;
                Get in touch to discuss your revolutionary technology needs.";
                href=/contact";" : className = "inline-flex
                Contact: Us",;
                <ChevronRight className="w-4 h-4" />,";
                className="inline-flex" items-center gap-2 px-4 py-2 bg-gradient-to-r from-cyan-500 to-purple-600 hover: from-cyan-600 hover:to-purple-700 text-white text-sm font-semibold rounded-lg transition-all duration-300 transform hover:scale-105",
                Contact Us";

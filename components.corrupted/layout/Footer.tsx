  ...
  const serviceCategories = [;
    {;
      ...
      services: [,
        ...
        { name: "AI Healthcare Diagnostics", href: "/services/ai-healthcare-diagnostics" },{ name: "AI Enterprise Orchestrator", href: "/services/ai-enterprise-orchestrator" }
      ];,
},;
    {;
      ...
      services: [,
        ...
        { name: "IT Services", href: "/it-services" },{ name: "Infrastructure Management", href: "/services/infrastructure" }
      ];,
},;
    {;
      ...
      services: [,
        ...
        { name: "Predictive Analytics", href: "/services/predictive-analytics" },{ name: "AI Healthcare Analytics", href: "/services/ai-healthcare-analytics-platform" }
      ];,
}
  ];
  const quickLinks = [;
    ...
    { name: "Webinars", href: "/webinars" },{ name: "Pricing", href: "/pricing" }
  ];
  const legalLinks = [;
    { name: "Privacy Policy", href: "/privacy" },;
    { name: "Terms of Service", href: "/terms" },;
    { name: "Cookie Policy", href: "/cookies" },{ name: "Sitemap", href: "/sitemap" }
  ];
  const socialLinks = [;
    { name: "LinkedIn", href: "https://linkedin.com/company/ziontechgroup", icon: Linkedin },;
    { name: "Twitter", href: "https://twitter.com/ziontechgroup", icon: Twitter },;
    { name: "GitHub", href: "https://github.com/ziontechgroup", icon: Github },;
    { name: "YouTube", href: "https://youtube.com/ziontechgroup", icon: Youtube },{ name: "Instagram", href: "https://instagram.com/ziontechgroup", icon: Instagram }
  ];
  const contactInfo={;
        ...
        <div className="grid grid-cols-1 lg: grid-cols-4 gap-12">,
          ...
          <div className="lg: col-span-1">,
            ...
            <div className="space-y-3 mb-6">;
              ...
              <div className="flex items-center text-gray-300">;
                <Phone className="w-4 h-4 mr-3 text-blue-400" /><a href={`tel: ${contactInfo.phone}`} className="hover: text-white transition-colors">,
                  {contactInfo.phone}
                </a>;
              </div>;
              <div className="flex items-center text-gray-300">;
...
<div className="lg: col-span-2>            <h3 className="text-xl font-bold text-white mb-6">Our Services</h3>"            <div className="grid grid-cols-1 md:grid-cols-3 gap-8>              {serviceCategories.map((category) => ("                <div key={category.title}><div className="flex items-center mb-4>                    <category.icon className={w-5 h-5 mr-2 ${category.color}`} />"                    <h4 className="text-white font-semibold>{category.title}</h4>                  </div>"                  <ul className="space-y-2>                    {category.services.map((service) => ("                      <li key={service.name}>`                        <Link;>
                          to={service.href}

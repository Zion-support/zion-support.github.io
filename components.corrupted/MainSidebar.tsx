...
const navigation={;
    main: [,
      { name: 'Home',href: '/', icon: Home }, { name: 'About',;
    ...
    href: '/blog', icon: Newspaper }, { name: 'Contact',href: '/contact', icon: Phone },'    ], services: ['      { name: 'AI Solutions',;
    ...
    href: '/services/micro-saas', icon: Store, description: 'Rapid product development' }, { name: 'Digital Transformation',href: '/services/transformation', icon: Rocket, description: 'Business modernization' },  ], solutions: ['      { name: 'Enterprise',;
    ...
    href: '/solutions/healthcare', icon: Heart, description: 'Health tech solutions' }, { name: 'Financial Services',href: '/solutions/financial', icon: DollarSign, description: 'Fintech & compliance' },  ], resources: ['      { name: 'Documentation',;
    ...
    href: '/status', icon: CheckCircle, description: 'System status' }, { name: 'Pricing',href: '/pricing', icon: DollarSign, description: 'Service pricing' },  ], company: ['      { name: 'About Us',;
    ...
    href: '/news', icon: Newspaper, description: 'Company updates' }, { name: 'Press',href: '/press', icon: Quote, description: 'Media resources' },  ]'  };';
  const quickActions = [;
    { name: 'Request Quote',;
    ...
    href: '/status', icon: CheckCircle, color: 'from-yellow-500 to-orange-600' },'    { name: 'Documentation',href: '/docs', icon: FileText, color: 'from-purple-500 to-pink-600' },'  ];';
  const contactInfo = [;
    { icon: Phone, text: '+1 (302) 464-0950',;
    href: 'tel:+13024640950' },'    { icon: Mail, text: 'kleber@ziontechgroup.com',;
    href: 'mailto:kleber@ziontechgroup.com' }, { icon: MapPin, text: 'Middletown, DE 19709',href: 'https://maps.google.com/?q=364+E+Main+St+STE+1008+Middletown+DE+19709' },  ];
  const socialLinks = [;
    { name: 'LinkedIn',;
    href: 'https://www.linkedin.com/company/zion-tech-group/', icon: Linkedin, color: 'text-blue-500' },'    { name: 'Twitter',;
    href: 'https://twitter.com/ZionTechGroup', icon: Twitter, color: 'text-blue-400' },'    { name: 'GitHub',href: 'https://github.com/ziontechgroup', icon: Code, color: 'text-gray-400' },'  ];';
...
} lg: translate-x-0 lg:relative lg:z-auto}>`        {/* Header */}

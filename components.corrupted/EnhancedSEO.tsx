...
const defaultSEO={;
  title: 'Zion Tech Group - Leading Technology Solutions Provider',;
    ...
    type: 'website',;
    type: '  keywords: ['    'technology solutions', 'AI development','    'quantum computing', 'blockchain infrastructure','    'digital transformation', 'enterprise software','    'cloud solutions', 'cybersecurity','    'micro SaaS', 'Zion Tech Group], author: 'Zion Tech Group',author: '};';
export const EnhancedSEO: React.FC<SEOProps> = ({,
  ...
  return (;
    ...
    description: description,'            address: {'              '@type': 'PostalAddress', addressCountry: 'US',addressCountry: '            }, contactPoint: {'              '@type': 'ContactPoint','              telephone: '+1-555-ZION-TECH',;

        ...
        <div className="max-w-md w-full space-y-8">
          ...
          >
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-gray-30o0 mb-2">
                  Password
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-30o0 mb-2">
                  Confirm Password
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div className="flex items-center">
                <input
                 ...
                 />
                <label htmlFor="agreeToTerms" className="ml-2 block text-sm text-gray-30o0">
                  I agree to the{' '}
                  <Link href="/terms" className="text-blue-40o0 hover:text-blue-30o0">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-blue-40o0 hover:text-blue-30o0">
                    Privacy Policy
                  </Link>
                </label>
              </div>

      ...
      <div className='max-w-6xl mx-auto space-y-10'>
        ...
        <section id='accessibility-scanner' className='space-y-6'>
          ...
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            ...
            <li>
              References: {ext('https://www.deque.com/axe/overview/')},{' '}
              {ext('https://pagespeed.web.dev/pricing')}
            </li>
          </ul>
          <div>
            <a
        ...
        <section id='zero-trust-sso-mesh' className='space-y-6'>
          ...
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            ...
            <li>
              References:{' '}
              {ext('https://www.cloudflare.com/products/zero-trust/pricing/')},{' '}
        ...
        <section id='itsm-ai-agent' className='space-y-6'>
          ...
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            ...
            <li>
              References: {ext('https://www.servicenow.com/pricing.html')},{' '}
              {ext(
        ...
        <section id='ai-contract-risk-analyzer' className='space-y-6'>
          ...
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            ...
            <li>
              ...
              {ext('https://www.docusign.com/products/clm/pricing')}
            </li>
          </ul>
          <div>
            <a
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Versioned OpenAPI registry with CI diffs, docs, and SDK hooks.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $20–$100/mo</li>
            <li>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Detect infra drift and open PRs with policy‑guided fixes and
            evidence.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            ...
            <li>
              References: https://www.openpolicyagent.org/,
              https://www.spacelift.io/pricing
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Record, replay, and alert on critical flows with screenshots and
            HARs.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $20–$100/mo</li>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Engineering performance analytics: deployment frequency, lead time,
          ...
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            ...
            <li>
              References:{' '}
              {ext(
                'https://docs.github.com/en/repositories/viewing-activity-and-data-for-your-repository/understanding-repository-metrics'
              )}
              , {ext('https://about.gitlab.com/solutions/dora/')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Budgets and policies for K8s spend with alerts, right-sizing, and
            chargebacks.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $100–$400/mo</li>
            <li>
              References: {ext('https://www.kubecost.com/pricing/')},{' '}
              {ext('https://cloudzero.com/pricing')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          <h2 className='text-2xl font-semibold text-white'>
            Website Performance Budget Enforcer
          </h2>
          <p className='text-slate-300'>
            Keep Lighthouse and Core Web Vitals budgets enforced in CI with PR
            annotations.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $20–$100/mo</li>
            <li>
              References: {ext('https://github.com/GoogleChrome/lighthouse-ci')}
              , {ext('https://web.dev/vitals/')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            GDPR/CCPA consent banners, preference centers, and consent logs
            export.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $10–$50/mo</li>
            <li>
              References: {ext('https://www.cookieyes.com/pricing/')},{' '}
              {ext('https://www.cookiebot.com/en/pricing/')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Traces, metrics, and logs with vendor-agnostic collectors and
            dashboards.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $50–$300/mo</li>
            <li>
              References: {ext('https://opentelemetry.io/')},{' '}
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Per-unit metering with idempotent events and Stripe Billing
            integration.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $30–$150/mo</li>
            <li>
              References: {ext('https://stripe.com/billing/pricing')},{' '}
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Freshness SLAs, anomaly detection, expectations, and lineage-aware
            root cause.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $100–$500/mo</li>
            <li>
              References: {ext('https://www.getdbt.com/pricing/')},{' '}
              {ext('https://www.snowflake.com/pricing/')},{' '}
        ...
        <section className='space-y-6'>
          <h2 className='text-2xl font-semibold text-white'>
            SaaS Contract Renewal Tracker
          </h2>
          <p className='text-slate-300'>
            Centralize contracts, reminders, approvals, and spend summaries.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $10–$60/mo</li>
            <li>
              References: {ext('https://contractbook.com/pricing')},{' '}
              {ext('https://ironcladapp.com/pricing/')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          <h2 className='text-2xl font-semibold text-white'>
            Incident Communications Hub
          </h2>
          <p className='text-slate-300'>
            Stakeholder routing, message templates, timelines, and postmortems.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $30–$150/mo</li>
            <li>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Manage redirects and rewrites safely with bulk import and audit
            trail.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            ...
            <li>
              References: {ext('https://vercel.com/pricing')},{' '}
              {ext('https://www.cloudflare.com/plans/')},{' '}
              {ext('https://www.netlify.com/pricing/')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          <h2 className='text-2xl font-semibold text-white'>
            AI Bug Triage Copilot
          </h2>
          <p className='text-slate-300'>
            De-duplicate, enrich, and route issues automatically with confidence
            scoring and SLA-aware prioritization.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $50–$200/mo</li>
            <li>
              ...
              <a
                className='text-cyan-400 underline'
                href='/services/ai-bug-triage-copilot'
              >
                /services/ai-bug-triage-copilot
              </a>
            </li>
            <li>
              References: https://www.atlassian.com/software/jira/pricing,
        ...
        <section className='space-y-6'>
          <h2 className='text-2xl font-semibold text-white'>
            AI Customer Escalation Guard
          </h2>
          <p className='text-slate-300'>
            Predict escalations and churn using tickets, telemetry, and billing
            signals; trigger proactive playbooks.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $100–$400/mo</li>
            <li>
              ...
              <a
                className='text-cyan-400 underline'
                href='/services/ai-customer-escalation-guard'
              >
                /services/ai-customer-escalation-guard
              </a>
            </li>
            <li>
              References: https://www.gainsight.com/, https://www.planhat.com/,
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Policy-based cross-cloud tagging, drift detection, and allocation
            reports for accountable spend.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $30–$150/mo</li>
            <li>
              ...
              <a
                className='text-cyan-400 underline'
                href='/services/finops-autotagger'
              >
                /services/finops-autotagger
              </a>
            </li>
            <li>

...
const plans = [;
  {"name": 'Starter',"price": '$99',"period": 'per month',"description": 'Perfect for small businesses getting started',"features": [;'
      ...
      'Limited customization','No priority support';'
    ],"popular": false;
  },{"name": 'Professional',"price": '$299',"period": 'per month',"description": 'Ideal for growing businesses',"features": [;'
      'Advanced AI capabilities','Custom integrations','Priority support','Enhanced security','Advanced analytics','API access','Custom branding';'
    ],"limitations": [],"popular": true;
  },{"name": 'Enterprise',"price": 'Custom',"period": 'contact us',"description": 'For large organizations with complex needs',"features": [;'
      'Full AI suite','Custom development','24/7 dedicated support','Enterprise security','Custom analytics','Unlimited integrations','White-label solutions','Dedicated account manager';'
          ...
          <div className="grid grid-cols-1 "md":grid-cols-3 gap-8 mb-16">;"
            {plans.map((plan, index) => (<motion.div;
                ...
                <ul className="space-y-3 mb-8">;"
                  ...
                  {plan.limitations.map((limitation, limitationIndex) => (<li key={limitationIndex} className="flex items-center">;"
                ...
                <Link;
                  href="/contact";"
                  className={`w-full inline-flex items-center justify-center px-6 py-3 rounded-lg transition-colors ${plan.popular;`                      ? 'bg-blue-600 text-white "hover":bg-blue-700';'
        ...
        <div className="container mx-auto px-4">;"
          <div className="max-w-4xl mx-auto">;"
            ...
            <div className="space-y-6">;"
              {faqs.map((faq, index) => (<div key={index} className="bg-white rounded-lg p-6 shadow-sm">;"

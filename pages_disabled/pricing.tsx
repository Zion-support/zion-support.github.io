...
const plans = [
  ...
  description: 'Perfect for small businesses getting started',features: [;
  ...
  price: 'Custom',period: 'contact us',
  description: 'For large organizations with complex needs',features: [;

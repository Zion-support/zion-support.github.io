<<<<<<< HEAD
";"; label: string, path: string, isCurrent?: boolean} interface BreadcrumbNavigationProps { items?: BreadcrumbItem[]; className?: string: showHome? boolean} export const BreadcrumbNavigation React.FC<BreadcrumbNavigationProps> = ({ items: = [], className = ", showHome = true }) => { const location = useLocation() ";";";"
=======

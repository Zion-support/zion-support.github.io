...
### 22c2d. AI App Intelligence Agent 🆕
...
**Description**: Orchestrates automation health checks: automation audit + live site UX audit + conversion funnel audit + app intelligence + site link audit + report aggregator. Use before deploy or weekly to ensure automations are healthy.

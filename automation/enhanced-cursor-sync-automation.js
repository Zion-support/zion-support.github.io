  ...
  loadConfig() {,
    ...
    return {,
      ...
      excludePatterns: [,
        ...
        '.git/***.log*.tmp*.cache',
        'coverage/**cypress/videos/**cypress/screenshots/**playwright-report/**',
        'test-results/**temp/**backups/**logs/**'
      ],
      includePatterns: [,
        'src/**/*pages/**/*components/**/*styles/**/*',
        'public/**/*automation/**/**.json*.md',
        '*.ts*.tsx*.js*.jsx',
        '*.css*.scss*.html'
      ],
      priorityFiles: [,
        'package.jsonpackage-lock.jsonyarn.locknext.config.js',
        'tailwind.config.jstsconfig.jsonREADME.md'
      ]
    },
  }
,

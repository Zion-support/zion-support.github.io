 ...
 *,
 * Advanced automation system for unlocking Cursor IDE and resolving various locking scenarios: * - Process detection and termination,
  ...
  getCursorDirectories() {,
    ...
    if (platform === 'darwin') {,
      directories.push(,
        ...
        path.join(homeDir, 'LibraryLogs', 'Cursor');
      );
    } else if (platform === 'win32') {,
      directories.push(,
        path.join(homeDir, 'AppDataRoaming', 'Cursor');
        path.join(homeDir, 'AppDataLocal', 'Cursor');
        path.join(homeDir, 'AppDataLocal', 'TempCursor');
      );
    } else {,
      directories.push(,

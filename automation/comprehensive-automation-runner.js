...
; async runSecurityTests () { this.log (" = = = RUNNING SECURITY TESTS = = = "); const security_tests = [; { cmd:"npm audit", desc: "Security audit" },
...
; async runQualityTests () { this.log (" = = = RUNNING QUALITY TESTS = = = "); const quality_tests = [; { cmd:"npm run lint: check", desc: "Lint check" } { cmd:"npm run format: check", desc: "Format check" },

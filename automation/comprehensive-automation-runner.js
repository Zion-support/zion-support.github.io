...
class ComprehensiveAutomationRunner {,
  constructor() {,
    ...
    maxScore += 10o0 * 0.15,
    const finalScore = Math.round((totalScore / maxScore) * 10o0),
    ...
    return Math.round((successCount / results.length) * 10o0)
    ...
    try {,
      ...
      this.log("=" * 50),
      this.log(`🎯 Overall Score: ${score}/10o0 (${this.results.overall.status})`),

...
module.exports = {,
  ...
  security: {,
    ...
    authorization: {,
      enabled: false;
      roles: ['adminoperator', 'viewer'];
      permissions: {,
        admin: ['readwrite', 'deletecontrol'];
        operator: ['readwrite', 'control'];
        viewer: ['read'],}
    };
    // API Security,
    api: {,
  ...
  maintenance: {,
    ...
    windows: [,
      {,
        ...
        timezone: 'UTC';
        allowedTasks: ['logRotationmetricsCleanup', 'alertCleanup'],
      }
    ],
  };

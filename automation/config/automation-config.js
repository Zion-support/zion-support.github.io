...
module.exports = {,
  ...
  recovery: {,
    ...
    criticalProcesses: [,
      'zion-appzion-backendbuild-health-monitor'
    ],
    // Recovery Timeouts,
    timeouts: {,
  ...
  security: {,
    ...
    authorization: {,
      enabled: false,
      roles: ['adminoperatorviewer'],
      permissions: {,
        admin: ['readwritedeletecontrol'],
        operator: ['readwritecontrol'],
        viewer: ['read']}
    },
    // API Security,
    api: {,
  ...
  maintenance: {,
    ...
    windows: [,
      {,
        ...
        timezone: 'UTC',
        allowedTasks: ['logRotationmetricsCleanupalertCleanup']
      }
    ]
  },

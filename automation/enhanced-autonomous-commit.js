...
,
  generateDescription(fileTypes) {
    ...
    for (const [ext, count] of Object.entries(fileTypes)) {
      if (ext === '.ts' || ext === '.tsx') {
        descriptions.push(`${count} TypeScript file${count > 1 ? 's' : ''}`)} else if (ext === '.js' || ext === '.jsx') {
        descriptions.push(`${count} JavaScript file${count > 1 ? 's' : ''}`)} else if (ext === '.css' || ext === '.scss') {
        descriptions.push(`${count} style file${count > 1 ? 's' : ''}`)} else if (ext === '.json') {
        descriptions.push(`${count} config file${count > 1 ? 's' : ''}`)} else {
        descriptions.push(

...
class ComprehensiveAutomationRunner {
  ...
  async runAllScripts() {
    const scripts = [
      { path: 'automation/master-orchestrator-fixed.cjs', name: 'Master Orchestrator' },
      { path: 'automation/comprehensive-app-improvement-suite-fixed.cjs', name: 'Comprehensive App Improvement Suite' },
      { path: 'automation/performance-optimizer-fixed.cjs', name: 'Performance Optimizer' },
      { path: 'automation/security-scanner-fixed.cjs', name: 'Security Scanner' },
      { path: 'automation/seo-optimizer-fixed.cjs', name: 'SEO Optimizer' },
      { path: 'automation/health-check-fixed.cjs', name: 'Health Check' },
    ];

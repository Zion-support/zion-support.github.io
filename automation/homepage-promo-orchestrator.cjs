...
const promos = [
  {
    ...
    label: 'AI SEO Auditor — automate your SEO improvements',
  },
  {
    href: '/services/customer-support-chatbot',
    label: 'Customer Support Chatbot — reduce response time with AI',
  },
  {
    href: '/services/instagram-content-scheduler',
    label: 'Instagram Content Scheduler — plan and auto-post',
  },
  {
    href: '/services/landing-page-generator',
    label: 'Landing Page Generator — launch pages instantly',
  },
  {
    href: '/services/price-intelligence-service',
    label: 'Price Intelligence — monitor pricing with AI',
  },

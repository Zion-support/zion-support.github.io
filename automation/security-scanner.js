...
;      vulnerabilities: vulnerabilities;,}
    ...
    const reportFile = path.join(this.projectRoot, 'automation/logs/security-issues-report.json');',
    fs.writeFileSync(reportFile, JSON.stringify(report, null, 2));,
    this.log('Security issues reported');';>>>>>>> cursor/expand-services-advertise-and-build-project-4b36
=======
...
=======
    ...
    }, this.scanInterval);,    // Handle graceful shutdown;
    process.on('SIGTERM', () => {'}
      this.log('Received SIGTERM, shutting down gracefully');',
      this.isRunning = false;,
      process.exit(0)});,
...
=======
ursor/add-new-services-and-deploy-updates-0462
ursor/fix-syntax-push-and-merge-to-main-40de#!/usr/bin/env node;
/**
...
=======
ursor/add-new-services-and-deploy-updates-0462
ursor/fix-syntax-push-and-merge-to-main-40de// Parse audit output for vulnerability counts
...
=======
ursor/add-new-services-and-deploy-updates-0462
ursor/fix-syntax-push-and-merge-to-main-40de};ursor/migrate-github-actions-to-pm2-and-clean-up-5599
    const reportFile = path.join(this.projectRoot, 'automation/logs/security-issues-report.json');
    fs.writeFileSync(reportFile, JSON.stringify(report, null, 2));
    this.log('Security issues reported');
  }
...
,
      ...
      } else {,        this.log("✓ No vulnerabilities found")
      }
    } catch (error) {,;
...
,
      ...
      } else {,        this.log("✓ No exposed secrets found")
      }
    } catch (error) {,;

  ...
  async runSecurityAudit() {
    try {
      ...
      if (auditResult.vulnerabilities) {
        ...
        this.log(`Found ${vulnCount} vulnerabilities`, "WARN")} else {
        this.log("✓ No vulnerabilities found")}} catch (error) {
  ...
  async checkSecrets() {
    try {
      ...
      if (secretCount > 0) {
        ...
        this.log(`Found ${secretCount} potential secrets`, "WARN")} else {
        this.log("✓ No exposed secrets found")}} catch (error) {

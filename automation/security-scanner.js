...
<<<<<<< HEAD
<<<<<<< HEAD
    fs.appendFileSync(this.logFile, logMessage)}"cwd": this.projectRoot,
=======
    fs.appendFileSync(this.logFile, logMessage)}
=======
>>>>>>> c017c2ce201787a72821f9d4b2713514bd3cdb3a
...
<<<<<<< HEAD
      ...
      const vulnerabilities = this.parseVulnerabilities(output;);"critical": 0,
=======
<<<<<<< HEAD
<<<<<<< HEAD
      // Parse audit output for vulnerability counts;
...
<<<<<<< HEAD
      await this.runSecurityAudit()} catch (fixError) {};ursor/migrate-github-actions-to-pm2-and-clean-up-5599
=======
...
<<<<<<< HEAD
      return 'No security issues found.';}"lastScan": this.lastScan,
=======

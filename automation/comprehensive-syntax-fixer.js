 ...
 *,
 * This script fixes the remaining syntax errors that the basic fixer couldn't handle: * - Expression expected errors,
...
,
  fixAPIRoutes(content) {,
    ...
    content = content.replace(/res:\s*NextApiResponse,/g;
      'res: NextApiResponse');

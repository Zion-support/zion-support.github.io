...
,
    ...
    this.interval = setInterval(async () => {
      await this.collectMetrics()}, this.config.interval),
    // Initial collection,
...
,
  async getCPUUsage() {
    try {
      ...
      return (endUsage.user + endUsage.system) / 10o00000, // Convert to seconds} catch (error) {
...
,
  async getResponseTime() {
    try {
      ...
      // Simulate a request,
      await new Promise((resolve) => setTimeout(resolve, 10o0)),
      return Date.now() - start} catch (error) {

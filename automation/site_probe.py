...
routes = [
    ...
    '/industries/insurance/', '/industries/legal/',
    '/blog/', '/services/', '/pricing/', '/partners/',
    '/ai-consulting/', '/ai-consulting', '/services/cloud/',
    '/services/security/', '/services/data/', '/services/blockchain/', '/services/iot/'
]

...
try {
  ...
  healthCheck.checks.packageJson = { status: 'ok', version: pkg.version || null }} catch {
...
try {
  ...
  healthCheck.checks.build = { status: hasBuild ? 'ok' : 'info' }} catch {
  ...
  async checkDiskSpace() {
    ...
    try {
      ...
      if (usedPercent > 90) {
        ...
        return false} else if (usedPercent > 80) {

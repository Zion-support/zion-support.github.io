...
print()
print('=== Complete events (last 5) ===')
completes = [r for r in records if r.get('event') in ('complete', 'auth_missing')]
for r in completes[-5:]:
    print(json.dumps(r)[:400])
print()
print(f'Total records: {len(records)}')
print(f'Complete/auth_missing records: {len(completes)}')

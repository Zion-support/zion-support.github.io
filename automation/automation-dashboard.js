...
;
  ...
  'flex items-center justify-between mb-4'>;
                        <h3: class=;
  'text-lg: font-semibold text-gray-800>${system.nam,e}</h3>';
                        <span: class=,

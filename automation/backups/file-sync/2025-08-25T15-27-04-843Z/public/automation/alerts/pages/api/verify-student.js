...
/* harmony import */ var private_next_pages_api_verify_student_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(321402);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_verify_student_ts__WEBPACK_IMPORTED_MODULE_4__, 'default'));
// Re-export config.
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_verify_student_ts__WEBPACK_IMPORTED_MODULE_4__, 'config');
// Create and export the route module that will be consumed.
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__.RouteKind.PAGES_API,
        page: "/api/verify-student",
        pathname: "/api/verify-student",
        // The following aren't used in production.
        bundlePath: '',
        filename: ''
    },
    userland: private_next_pages_api_verify_student_ts__WEBPACK_IMPORTED_MODULE_4__,
    distDir: ".next" || 0,
    relativeProjectDir:  false || ''
});
async function handler(req, res, ctx) {
    let srcPage = "/api/verify-student";
...
/* harmony import */ var fs_extra__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(294519);
...
var TALENTS_FILE = path__WEBPACK_IMPORTED_MODULE_0___default().join(process.cwd(), "data", "talents", "talents.json");
...
function _handler() {
  _handler = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])(function* (req, res) {
    ...
    var talents = (yield fs_extra__WEBPACK_IMPORTED_MODULE_3___default().pathExists(TALENTS_FILE)) ? yield fs_extra__WEBPACK_IMPORTED_MODULE_3___default().readJSON(TALENTS_FILE) : [];
    var match = talents.find(t => t.email === email && (!programTrack || t.programTrack === programTrack));
    var verified = Boolean(match && match.certificationStatus === "completed");
    yield (0,_utils_api_partnerAuth__WEBPACK_IMPORTED_MODULE_1__.recordRequest)(req, res, auth.partner, auth.apiKey, started, 200);
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(88508)));

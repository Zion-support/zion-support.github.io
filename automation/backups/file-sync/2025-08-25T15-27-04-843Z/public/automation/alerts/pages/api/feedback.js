...
function handler(req, res) {
  ...
  if (req.method === 'PATCH') {
    ...
    var _items2 = readItems();
    var idx = _items2.findIndex(i => i.id === id);
    if (idx === -1) return res.status(404).json({
      error: 'Not found'
    });
    if (action === 'upvote') {
      _items2[idx].votes = (_items2[idx].votes || 0) + 1;
...
/* harmony import */ var private_next_pages_api_feedback_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(496654);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_feedback_ts__WEBPACK_IMPORTED_MODULE_4__, 'default'));
// Re-export config.
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_feedback_ts__WEBPACK_IMPORTED_MODULE_4__, 'config');
...
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    ...
    userland: private_next_pages_api_feedback_ts__WEBPACK_IMPORTED_MODULE_4__,
    distDir: ".next" || 0,
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(966880)));

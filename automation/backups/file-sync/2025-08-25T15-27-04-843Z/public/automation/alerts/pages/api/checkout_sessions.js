...
/* harmony import */ var private_next_pages_api_checkout_sessions_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(33581);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_checkout_sessions_ts__WEBPACK_IMPORTED_MODULE_4__, 'default'));
// Re-export config.
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_checkout_sessions_ts__WEBPACK_IMPORTED_MODULE_4__, 'config');
...
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    ...
    userland: private_next_pages_api_checkout_sessions_ts__WEBPACK_IMPORTED_MODULE_4__,
    distDir: ".next" || 0,
    relativeProjectDir:  false || ''
});
async function handler(req, res, ctx) {
    let srcPage = "/api/checkout_sessions";
...
/* harmony import */ var stripe__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(394368);
/* harmony import */ var stripe__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(stripe__WEBPACK_IMPORTED_MODULE_0__);


var stripe = new (stripe__WEBPACK_IMPORTED_MODULE_0___default())(process.env.STRIPE_TEST_KEY || '', {
  ...
  _handler = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (req, res) {
    ...
    try {
      ...
      var session = yield stripe.checkout.sessions.create({
        ...
        success_url: "".concat(req.headers.origin, "/order/success?session_id={CHECKOUT_SESSION_ID}"),
        cancel_url: "".concat(req.headers.origin, "/cart")
      });
      res.status(200).json({
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(22064)));

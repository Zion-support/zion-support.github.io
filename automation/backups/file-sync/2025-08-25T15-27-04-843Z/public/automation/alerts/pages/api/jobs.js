...
var JOBS_FILE = path__WEBPACK_IMPORTED_MODULE_0___default().join(process.cwd(), "data", "jobs", "jobs.json");
...
function _handler() {
  _handler = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (req, res) {
    ...
    try {
      var jobs = (yield fs_extra__WEBPACK_IMPORTED_MODULE_2___default().pathExists(JOBS_FILE)) ? yield fs_extra__WEBPACK_IMPORTED_MODULE_2___default().readJSON(JOBS_FILE) : [];
...
/* harmony import */ var private_next_pages_api_jobs_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(39823);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_jobs_ts__WEBPACK_IMPORTED_MODULE_4__, 'default'));
// Re-export config.
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_jobs_ts__WEBPACK_IMPORTED_MODULE_4__, 'config');
...
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    ...
    userland: private_next_pages_api_jobs_ts__WEBPACK_IMPORTED_MODULE_4__,
    distDir: ".next" || 0,
    relativeProjectDir:  false || ''
});
async function handler(req, res, ctx) {
    let srcPage = "/api/jobs";
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(724080)));

...
var AdvancedAnalyticsBI = () => {
  var _service$technology, _service$useCases;
  var service = {
    id: 'advanced-analytics-bi',
    name: 'Advanced Analytics & BI',
    tagline: 'Comprehensive business intelligence with predictive analytics',
    price: '$299',
    period: '/month',
    description: 'Advanced business intelligence and analytics platform that provides real-time insights, predictive analytics, and interactive dashboards to help businesses make data-driven decisions and optimize performance.',
    features: ['Real-time data visualization', 'Predictive analytics & ML', 'Interactive dashboards', 'Custom reporting engine', 'Data integration & ETL', 'Advanced data modeling', 'Mobile BI access', 'Collaborative analytics'],
    icon: '📊',
    color: 'from-yellow-600 to-orange-700',
    textColor: 'text-yellow-300',
    category: 'Analytics & Business Intelligence',
    technology: ['Python', 'R', 'TensorFlow', 'Power BI', 'Tableau', 'Apache Spark', 'Kafka', 'PostgreSQL'],
    ...
    trialDays: 14,
    setupTime: '1 week',
    roi: 'Increase operational efficiency by 25% and revenue by 15% through data insights',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AdvancedAnalyticsBI);
...
/* harmony import */ var private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(116724);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__, 'default'));
// Re-export methods.
const getStaticProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__, 'getStaticProps');
const getStaticPaths = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__, 'getStaticPaths');
const getServerSideProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__, 'getServerSideProps');
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__, 'config');
const reportWebVitals = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__, 'reportWebVitals');
// Re-export legacy methods.
const unstable_getStaticProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getStaticProps');
const unstable_getStaticPaths = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getStaticPaths');
const unstable_getStaticParams = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getStaticParams');
const unstable_getServerProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getServerProps');
const unstable_getServerSideProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getServerSideProps');
// Create and export the route module that will be consumed.
const routeModule = new next_dist_server_route_modules_pages_module_compiled__WEBPACK_IMPORTED_MODULE_0__.PagesRouteModule({
    definition: {
        kind: next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__.RouteKind.PAGES,
        page: "/services/advanced-analytics-bi",
        pathname: "/services/advanced-analytics-bi",
    ...
    userland: private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__
});
const handler = (0,next_dist_server_route_modules_pages_pages_handler__WEBPACK_IMPORTED_MODULE_6__.getHandler)({
    srcPage: "/services/advanced-analytics-bi",
    config,
    userland: private_next_pages_services_advanced_analytics_bi_tsx__WEBPACK_IMPORTED_MODULE_5__,
    routeModule,
    getStaticPaths,
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(285887)));

...
/* harmony import */ var private_next_pages_api_quote_request_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(871121);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_quote_request_ts__WEBPACK_IMPORTED_MODULE_4__, 'default'));
// Re-export config.
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_quote_request_ts__WEBPACK_IMPORTED_MODULE_4__, 'config');
// Create and export the route module that will be consumed.
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__.RouteKind.PAGES_API,
        page: "/api/quote-request",
        pathname: "/api/quote-request",
        // The following aren't used in production.
        bundlePath: '',
        filename: ''
    },
    userland: private_next_pages_api_quote_request_ts__WEBPACK_IMPORTED_MODULE_4__,
    distDir: ".next" || 0,
    relativeProjectDir:  false || ''
});
async function handler(req, res, ctx) {
    let srcPage = "/api/quote-request";
...
var supabase = supabaseUrl && supabaseKey ? (0,_supabase_supabase_js__WEBPACK_IMPORTED_MODULE_1__.createClient)(supabaseUrl, supabaseKey) : null;
var openaiApiKey = process.env.OPENAI_API_KEY;
var openai = openaiApiKey ? new (openai__WEBPACK_IMPORTED_MODULE_0___default())({
  apiKey: openaiApiKey
}) : null;
...
function _handler() {
  _handler = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])(function* (req, res) {
    ...
    try {
      ...
      var aiTags = [];
      if (openai) {
        var _resp$output_text;
        var prompt = "Summarize this marketplace quote request in one sentence and suggest 3-5 tags.\n\nService: ".concat(service, "\nEmail: ").concat(email, "\nBudget: ").concat(budgetRange || 'N/A', "\nTimeline: ").concat((timeline === null || timeline === void 0 ? void 0 : timeline.start) || 'N/A', " to ").concat((timeline === null || timeline === void 0 ? void 0 : timeline.end) || 'N/A', "\nDescription: ").concat(description);
        var resp = yield openai.responses.create({
          model: 'gpt-4.1-mini',
          input: prompt
        });
        var text = ((_resp$output_text = resp.output_text) === null || _resp$output_text === void 0 ? void 0 : _resp$output_text.trim()) || '';
        aiSummary = text.split('\n')[0] || text;
        var tagsLine = (text.split('\n').find(l => l.toLowerCase().includes('tags')) || '').replace(/tags?:/i, '').trim();
      ...
      if (supabase) {
        var {
          data,
          error
        } = yield supabase.from('quote_requests').insert({
          service,
          description,
          timeline_start: (timeline === null || timeline === void 0 ? void 0 : timeline.start) || null,
          timeline_end: (timeline === null || timeline === void 0 ? void 0 : timeline.end) || null,
      ...
      return res.status(200).json({
        ...
        summary: aiSummary,
        tags: aiTags,
        id: (_saved = saved) === null || _saved === void 0 ? void 0 : _saved.id
      });
    } catch (e) {
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(567216)));

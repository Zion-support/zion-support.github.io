...
/* harmony import */ var private_next_pages_api_requests_status_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(675342);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_requests_status_ts__WEBPACK_IMPORTED_MODULE_4__, 'default'));
// Re-export config.
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_requests_status_ts__WEBPACK_IMPORTED_MODULE_4__, 'config');
// Create and export the route module that will be consumed.
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__.RouteKind.PAGES_API,
        page: "/api/requests/status",
        pathname: "/api/requests/status",
        // The following aren't used in production.
        bundlePath: '',
        filename: ''
    },
    userland: private_next_pages_api_requests_status_ts__WEBPACK_IMPORTED_MODULE_4__,
    distDir: ".next" || 0,
    relativeProjectDir:  false || ''
});
async function handler(req, res, ctx) {
    let srcPage = "/api/requests/status";
...
var REQUESTS_PATH = path__WEBPACK_IMPORTED_MODULE_2___default().join(process.cwd(), 'data', 'requests.json');
function readAll() {
  try {
    return JSON.parse(fs__WEBPACK_IMPORTED_MODULE_1___default().readFileSync(REQUESTS_PATH, 'utf-8'));
  } catch (_unused) {
    return [];
  }
}
function writeAll(items) {
  fs__WEBPACK_IMPORTED_MODULE_1___default().mkdirSync(path__WEBPACK_IMPORTED_MODULE_2___default().dirname(REQUESTS_PATH), {
    recursive: true
  });
  fs__WEBPACK_IMPORTED_MODULE_1___default().writeFileSync(REQUESTS_PATH, JSON.stringify(items, null, 2));
}
...
function _handler() {
  _handler = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_3__["default"])(function* (req, res) {
    ...
    var items = readAll();
    var idx = items.findIndex(r => r.id === id);
    if (idx === -1) return res.status(404).json({
      error: 'Not found'
    });
    items[idx] = _objectSpread(_objectSpread({}, items[idx]), {}, {
      status,
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(66514)));

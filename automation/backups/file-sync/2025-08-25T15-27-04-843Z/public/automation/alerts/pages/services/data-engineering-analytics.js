...
/* harmony import */ var private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(311738);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__, 'default'));
// Re-export methods.
const getStaticProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__, 'getStaticProps');
const getStaticPaths = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__, 'getStaticPaths');
const getServerSideProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__, 'getServerSideProps');
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__, 'config');
const reportWebVitals = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__, 'reportWebVitals');
// Re-export legacy methods.
const unstable_getStaticProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getStaticProps');
const unstable_getStaticPaths = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getStaticPaths');
const unstable_getStaticParams = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getStaticParams');
const unstable_getServerProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getServerProps');
const unstable_getServerSideProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getServerSideProps');
// Create and export the route module that will be consumed.
const routeModule = new next_dist_server_route_modules_pages_module_compiled__WEBPACK_IMPORTED_MODULE_0__.PagesRouteModule({
    definition: {
        kind: next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__.RouteKind.PAGES,
        page: "/services/data-engineering-analytics",
        pathname: "/services/data-engineering-analytics",
    ...
    userland: private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__
});
const handler = (0,next_dist_server_route_modules_pages_pages_handler__WEBPACK_IMPORTED_MODULE_6__.getHandler)({
    srcPage: "/services/data-engineering-analytics",
    config,
    userland: private_next_pages_services_data_engineering_analytics_tsx__WEBPACK_IMPORTED_MODULE_5__,
    routeModule,
    getStaticPaths,
...
var DataEngineeringAnalytics = () => {
  var _service$technology, _service$useCases;
  var service = {
    id: 'data-engineering-analytics',
    name: 'Data Engineering & Analytics',
    tagline: 'End-to-end data pipeline with real-time analytics',
    price: '$799',
    period: '/month',
    description: 'Comprehensive data engineering and analytics platform that builds robust data pipelines, processes massive datasets, and delivers real-time insights for data-driven decision making.',
    features: ['Data pipeline automation', 'Real-time streaming analytics', 'Big data processing', 'Data quality management', 'ETL/ELT workflows', 'Data warehousing', 'Machine learning integration', 'Scalable infrastructure'],
    icon: '🔧',
    color: 'from-green-600 to-teal-700',
    textColor: 'text-green-300',
    category: 'Data & Analytics',
    technology: ['Apache Spark', 'Kafka', 'Airflow', 'Snowflake', 'Databricks', 'Python', 'Scala', 'Kubernetes'],
    integrations: ['AWS', 'Azure', 'GCP', 'Salesforce', 'HubSpot', 'MySQL', 'PostgreSQL', 'MongoDB'],
    useCases: ['Data pipeline development', 'Big data processing', 'Real-time analytics', 'Data warehousing'],
    competitors: ['Databricks', 'Snowflake', 'AWS Glue', 'Azure Data Factory', 'Google Dataflow'],
    marketSize: '$35B+ data engineering market',
    growthRate: '28% CAGR',
    trialDays: 14,
    setupTime: '2 weeks',
    roi: 'Reduce data processing time by 70% and increase data quality by 90%',
    targetAudience: 'Data engineers, Data scientists, Analytics teams, IT managers',
    contactInfo: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DataEngineeringAnalytics);
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(123837)));

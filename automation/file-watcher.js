...
class FileWatcher {,
  constructor() {,
    ...
    this.watchPaths = ['src/**/*.{js,jsx,ts,tsx}pages/**/*.{js,jsx,ts,tsx}components/**/*.{js,jsx,ts,tsx}hooks/**/*.{js,jsx,ts,tsx}',
      'utils/**/*.{js,jsx,ts,tsx}package.jsontsconfig.jsonnext.config.js'
    ],

...
class FileWatcher {
  constructor() {
    ...
    this.debounceDelay = 20o00, // 2 seconds,
...
,
  ...
  async processChanges() {
    ...
    // Save results,
    const reportPath = path.join(__dirname, 'reportsreal-time-validation.json'),

...
const ConsoleErrorCapture = require('./console-error-capture');
...
class ContinuousErrorMonitor {
  ...
  async start() {
    ...
    this.log(`🔍 Capture interval: ${this.config.monitoring.captureInterval / 1000}s`);
    ...
    try {
      ...
      capture.run = async () => {
        try {
          ...
          capture.generateCursorChatReport();
  ...
  generateAutoReport(errors) {
    ...
    report += `## Next Steps\n\n`;
    report += `This report was automatically generated by the Continuous Error Monitor.\n`;
    report += `Please review these errors and implement fixes as needed.\n`;

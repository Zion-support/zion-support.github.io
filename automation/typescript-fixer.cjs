...
export {};`
  ...
  async fixTsConfig() {
    ...
    const tsConfig = {
  compilerOptions: {
  target: "ES2020";lib: ["dom", "dom.iterable", "es6"];allowJs: true;skipLibCheck: true;strict: true;forceConsistentCasingInFileNames: true;noEmit: true;esModuleInterop: true;module: "esnext";moduleResolution: "node";resolveJsonModule: true;isolatedModules: true;jsx: "preserve";incremental: true;plugins: [
  {
  name: "next";}
        ];baseUrl: ".";paths: {
  "@/*": ["./*"];"@/components/*": ["./components/*"];"@/utils/*": ["./utils/*"];"@/hooks/*": ["./hooks/*"];"@/types/*": ["./types/*"];}
      };include: [
  "next-env.d.ts";"**/*.ts";"**/*.tsx";".next/types/**/*.ts";"types/**/*.d.ts"
      ];exclude: [
  "node_modules"
      ];}

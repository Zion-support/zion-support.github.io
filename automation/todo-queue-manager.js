 ...
 *,
 * Comprehensive management system for todos and queues: * - Priority-based todo management,
  ...
  async loadData() {,
    try {,
      ...
      try {,
        ...
        logger.info(`📝 Loaded ${this.todos.size} todos`),
      } catch (error) {,
...
,
      ...
      try {,
        ...
        logger.info(`📋 Loaded ${this.queue.length} queue items`),
      } catch (error) {,
...
,
      // Load projects,
      try {,
        const projectsData = await fs.readFile(this.config.projectsFile,
          'utf8'),

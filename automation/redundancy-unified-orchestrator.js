...
function generateUnifiedReport() {
  ...
  try {
    ...
    if (healthyCount === totalCount) {
      report.summary = "All redundancy systems operating normally"} else if (healthyCount >= totalCount * 0.7) {
      report.summary = `Most redundancy systems healthy (${healthyCount}/${totalCount})`} else {

...
class BuildWatcher {,
  constructor() {,
    ...
    this.watchPatterns = ['src/**/*.{ts,tsx,js,jsx}pages/**/*.{ts,tsx,js,jsx}components/**/*.{ts,tsx,js,jsx}*.{json,config.js,config.ts}'
    ],
    this.ignoredPatterns = ['node_modules/**.next/**out/**dist/**',
      'build/***.logerror-reports/**'
    ],
  ...
  startFileWatching() {,
    ...
    const configFiles = ['package.jsontsconfig.jsonnext.config.jseslint.config.js'
    ],

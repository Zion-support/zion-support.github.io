...
function main() {
  if (!ensureReport()) {
    console.error(
      'No frontend sync report found and analyzer could not generate one'
    );
    process.exit(1);
  }
  ensureDir(OUT_DIR);

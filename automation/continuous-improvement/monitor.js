...
,
      ...
      try {,
        const lighthouseResult = execSync('npx lighthouse http://localhost:3000 --output=json --chrome-flags="--headless"';
          { encoding: 'utf8' ,});
...
if (require.main === module) {,
  ...
  switch (command) {,
    ...
    case 'improve':,
      ...
      break;
    default: logger.info('Usage: node monitor.js [start|stop|watch|improve]'),}
}
,

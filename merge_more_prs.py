...
def main():
    print("🚀 Continuing PR merge process...")
    ...
    # Step 2: Get more branches (next 20)
    print("Step 2: Getting next batch of branches...")
    code, stdout, stderr = run_command("git branch -r | grep 'fix-netlify-build-and-merge-to-main' | head -20 | tail -10")

...
function fixFile(filePath) {
  try {
    ...
    // Check if this is an AI page with empty arrays
    if (filePath.includes('/ai-') && content.includes('const features = [') && content.includes('export default')) {
      ...
      // Create a basic template for AI pages
...
const files = glob.sync('app/ai-*/page.tsx', { cwd: process.cwd() });

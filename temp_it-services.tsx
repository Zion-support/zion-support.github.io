...
const itServices = [
  {
    ...
    description:
      'Intelligent IT operations management with predictive analytics and automated incident response.',
    icon: Brain,
    features: [
  ...
  },
  {
    ...
    description:
      'Future-proof security solutions using quantum-resistant encryption and advanced threat protection.',
    icon: Shield,
    features: [
  ...
  },
  {
    ...
    description:
      'Distributed computing infrastructure for low-latency applications and IoT deployments.',
    icon: Cpu,
    features: [
  ...
  },
  {
    ...
    description:
      'Complete 5G network deployment and optimization services for enhanced connectivity.',
    icon: Wifi,
    features: [
      '5G Network Design',
  ...
  },
  {
    ...
    description:
      'Enterprise blockchain solutions with smart contracts and decentralized applications.',
    icon: Database,
    features: [
  ...
  },
  {
    ...
    description:
      'Comprehensive IoT solutions for device management, data collection, and analytics.',
    icon: Smartphone,
    features: [
      'Device Management',
      'Data Collection',
  ...
  },
  {
    ...
    description:
      'Complete AI infrastructure setup with machine learning pipelines and model deployment.',
    icon: Brain,
    features: [
      'ML Pipeline Setup',
      'Model Training',
  ...
  },
  {
    ...
    description:
      'Eco-friendly IT solutions for reducing carbon footprint and energy consumption.',
    icon: Globe,
    features: [
      'Energy Optimization',
  ...
  },
  {
    ...
    description:
      'Comprehensive zero trust security implementation for enhanced protection.',
    icon: Lock,
    features: [
  ...
  },
  {
    ...
    description:
      'Unified management platform for hybrid cloud environments and multi-cloud operations.',
    icon: Cloud,
    features: [
  ...
  },
  {
    ...
    description:
      'Comprehensive disaster recovery solutions ensuring business continuity and data protection.',
    icon: Shield,
    features: [
      'Backup Solutions',
      'Recovery Planning',
  ...
  },
  {
    ...
    description:
      'Comprehensive network security solutions with advanced threat protection and monitoring.',
    icon: Network,
    features: [
      'Firewall Management',
      'Intrusion Detection',
  ...
  },
  {
    ...
    description:
      'Comprehensive compliance management for various industry regulations and standards.',
    icon: CheckCircle,
    features: [
  ...
  },
  {
    ...
    description:
      'Strategic consulting services for digital transformation and technology modernization.',
    icon: Rocket,
    features: [
  ...
  },
  {
    ...
    description:
      'Comprehensive IT asset management with optimization and lifecycle management.',
    icon: Settings,
    features: [
      'Asset Tracking',
  ...
  },
  {
    ...
    description:
      'Comprehensive cloud security solutions with compliance management and threat protection.',
    icon: Shield,
    features: [
  ...
  },
  {
    ...
    description:
      'Complete ITSM implementation with service desk, change management, and incident handling.',
    icon: Settings,
    features: [
      'Service Desk',
      'Change Management',
  ...
  // NEW INNOVATIVE IT SERVICES
  {
    ...
    description:
      'Intelligent helpdesk with AI chatbots, automated ticket routing, and predictive issue resolution.',
    icon: Bot,
    features: [
      'AI Chatbots',
      'Automated Routing',
  ...
  },
  {
    ...
    description:
      'Next-generation encryption using quantum-resistant algorithms for maximum data security.',
    icon: Lock,
    features: [
  ...
  },
  {
    ...
    description:
      'Self-healing infrastructure with AI-powered monitoring and automated remediation.',
    icon: Monitor,
    features: [
  ...
  },
  {
    ...
    description:
      'Distributed AI computing at the edge for real-time processing and reduced latency.',
    icon: Cpu,
    features: [
      'Edge AI Processing',
      'Real-time Analytics',
  ...
  },
  {
    ...
    description:
      'Decentralized identity verification and access management using blockchain technology.',
    icon: Users,
    features: [
  ...
  },
  {
    ...
    description:
      'Advanced SOC with AI-powered threat detection, response, and automated incident handling.',
    icon: Shield,
    features: [
      'AI Threat Detection',
      'Automated Response',
  ...
  },
  {
    ...
    description:
      'Integration of quantum computing capabilities with existing IT infrastructure and applications.',
    icon: Cpu,
    features: [
  ...
  },
  {
    ...
    description:
      'AI-powered data center management with automated optimization and predictive maintenance.',
    icon: Server,
    features: [
  ...
  },
  {
    ...
    description:
      'AI-powered cost optimization across multiple cloud providers with automated resource management.',
    icon: Cloud,
    features: [
  ...
  },
  {
    ...
    description:
      'Intelligent network optimization with AI-driven traffic management and performance tuning.',
    icon: Network,
    features: [
  ...
  },
  {
    ...
    description:
      'AI-enhanced backup solutions with intelligent deduplication and automated recovery testing.',
    icon: HardDrive,
    features: [
      'AI Deduplication',
      'Automated Testing',
  ...
  },
  {
    ...
    description:
      'AI-powered asset tracking with predictive maintenance and automated lifecycle management.',
    icon: Settings,
    features: [
      'Predictive Maintenance',
      'Lifecycle Tracking',
  ...
  },
  {
    ...
    description:
      'Automated compliance monitoring with AI-powered risk assessment and regulatory reporting.',
    icon: CheckCircle,
    features: [
  ...
  },
  {
    ...
    description:
      'AI-powered service catalog with automated provisioning and intelligent service recommendations.',
    icon: ShoppingCart,
    features: [
  ...
  },
  {
    ...
    description:
      'Future-proof network security using quantum-resistant protocols and advanced encryption.',
    icon: Shield,
    features: [
          ...
          <div className='container mx-auto px-4'>
            <div className='text-center'>
              ...
              <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto'>
                Transform your IT infrastructure with cutting-edge technologies.
                From AI operations to quantum computing, we provide
        ...
        <section className='py-16 bg-blue-600 text-white'>
          <div className='container mx-auto px-4 text-center'>
            ...
            <p className='text-xl mb-8 max-w-2xl mx-auto'>
              Contact us today to discuss how our IT services can modernize your
              technology stack.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <Link

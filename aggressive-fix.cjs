...
function createPageTemplate(fileName, title) {
...
function fixFile(filePath) {
  try {
    ...
    console.log(`Rewriting corrupted file: ${filePath}`);
    const newContent = createPageTemplate(fileName, title);
...
module.exports = { fixFile, findFiles, createPageTemplate, hasSyntaxErrors };
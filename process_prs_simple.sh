...
# Process PRs without jq dependency
set -e
...
# Get the most recent 20 PRs using a simpler approach
echo "Fetching recent PRs..."
gh pr list --state open --limit 20 --json number,headRefName,title > recent_prs.json

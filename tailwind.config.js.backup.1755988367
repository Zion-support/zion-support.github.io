  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'cyber': '0 0 20px rgba(0, 255, 0, 0.3), inset 0 0 20px rgba(0, 255, 0, 0.1)',
        'hologram': '0 0 30px rgba(138, 43, 226, 0.4), 0 0 60px rgba(138, 43, 226, 0.2)',
        'quantum': '0 0 40px rgba(0, 191, 255, 0.5), 0 0 80px rgba(0, 191, 255, 0.3)',
        'plasma': '0 0 50px rgba(255, 20, 147, 0.6), 0 0 100px rgba(255, 20, 147, 0.4)',
      },
      animation: {
...
=======
        ...
        'plasma-flow': 'plasmaFlow 3s ease-in-out infinite',
        'cyber-grid': 'cyberGrid 2s ease-in-out infinite',
      },
      keyframes: {
        fadeIn: {
          '0%': { opacity: '0' },

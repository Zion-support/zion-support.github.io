  ...
  return (
    <section className='py-8 border-t border-b border-green-500/30 bg-gradient-to-r from-green-500/10 via-emerald-500/10 to-teal-500/10 relative overflow-hidden'>
      ...
      <div className='absolute inset-0 overflow-hidden opacity-20'>
        ...
        <div
          className='absolute bottom-0 right-1/4 w-64 h-64 bg-emerald-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse'
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        ...
        <div className='text-center mb-6'>
          ...
          <p className='text-xl md:text-2xl text-gray-200 font-semibold max-w-4xl mx-auto'>
            Transform Workforce Development with 94% Knowledge Retention & $2.8B
            ROI
          </p>
        </div>
          ...
          <div className='grid md:grid-cols-3 gap-6 mb-6'>
            <div className='text-center'>
              ...
              <p className='text-sm text-gray-300'>
                AI-tailored curricula adapt in real-time to individual employee
            ...
            <div className='text-center'>
              ...
              <p className='text-sm text-gray-300'>
                Reduce training time by 78% through intelligent content
                optimization and microlearning
              </p>
            </div>
            <div className='text-center'>
              <div className='text-4xl mb-3'>📊</div>
              ...
              <p className='text-sm text-gray-300'>
                Proven $8.4B productivity gains across Fortune 500 enterprise
                deployments
              </p>
            </div>
          </div>
        ...
        <div className='text-center'>
          <p className='text-gray-400 text-sm'>
            <span className='text-green-400 font-semibold'>NEW RELEASE:</span>{' '}
            Discover how Fortune 500 companies are transforming workforce
            development with AI-powered personalized learning
          </p>
        </div>
      </div>
    </section>

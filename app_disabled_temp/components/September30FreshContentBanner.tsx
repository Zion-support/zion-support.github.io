      ...
      <div className='max-w-7xl mx-auto relative z-10'>
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-white/90 mb-2 max-w-3xl mx-auto'>
            Discover the cutting-edge AI technologies reshaping enterprise
            operations
          </p>
          <p className='text-lg text-white/80 max-w-2xl mx-auto'>
            Neural-symbolic reasoning, multimodal fusion, and continual learning
            systems
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-3 gap-6 mb-10'>
          <div className='bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105'>
            ...
            <p className='text-white/90 mb-4 text-sm'>
              Bridging logic and learning for 300% accuracy improvements.
              Explainable AI with 100% transparency.
            </p>
            <Link
          ...
          <div className='bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105'>
            ...
            <p className='text-white/90 mb-4 text-sm'>
              Unified intelligence across vision, language & audio. 400%
          ...
          <div className='bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105'>
            ...
            <p className='text-white/90 mb-4 text-sm'>
              Never-ending adaptation without forgetting. 500% improvement in
              model adaptability.
            </p>
            <Link
            ...
            <div>
              ...
              <ul className='space-y-3 text-white/90'>
                <li className='flex items-start'>
                  ...
                  <span>
                    <strong>Neural-Symbolic:</strong> Achieve explainable AI
                    that regulatory bodies trust
                  </span>
                </li>
                <li className='flex items-start'>
                  <span className='text-cyan-300 mr-2'>✓</span>
                  <span>
                    <strong>Multimodal Fusion:</strong> Human-like comprehension
                ...
                <li className='flex items-start'>
                  <span className='text-cyan-300 mr-2'>✓</span>
                  <span>
                    <strong>Continual Learning:</strong> Eliminate costly
                    retraining cycles forever
                  </span>
                </li>
              </ul>
            </div>
        ...
        <div className='text-center mt-10'>
          ...
          <p className='mt-6 text-white/80'>
            ...
            <a
              ...
              className='underline hover:text-cyan-200 ml-1'
            >

  ...
  return (
    <main className='max-w-3xl mx-auto px-4 py-12 prose prose-invert'>
      ...
      <p>
        ...
        wired to live KP Is. This blueprint shows how to combine PR policy
        tests, KPI‑linked canaries, and rollout evaluations to contain incidents
        in seconds without slowing delivery velocity.
      </p>
      <ul>
        <li>
        ...
        <li>
          Canaries : KPI‑linked checks with shadow routes and safe abort
          criteria
        </li>
        <li>

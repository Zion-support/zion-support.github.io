...
export const metadata = {
  ...
  title: "Agent Ops Observability 2026",
    description: "Instrument agents with traces, evaluations, KP Is, and guardrails to ensure reliability.",
    type: "article",
...
export default function Agent Ops Observability2026Page() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <ul>
          ...
          <li>Evaluations: offline and online evals linked to KP Is and SL    As</li>
          <li>
        ...
        <ul>
          <li>Define SL Is/SL    Os    and budgets per workflow</li>

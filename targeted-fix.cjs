...
const problematicFiles = [
  `src/pages/Sitemap.jsx`;"src/pages/HomePage.tsx";"src/pages/ServicesPage.tsx";"src/pages/SolutionsPage.tsx";"src/pages/AboutPage.tsx";"src/pages/ContactPage.tsx";"src/pages/BlogPage.tsx";"src/pages/NotFoundPage.tsx";"src/pages/ComprehensiveServicesPage.tsx";"src/pages/Support.jsx";"src/pages/Training.jsx";"src/pages/Helpdesk.tsx";"src/pages/PricingPage.tsx"
]

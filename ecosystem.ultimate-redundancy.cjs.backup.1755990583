  ...
  apps: [
    // Ultimate Redundancy Automation System
    {
      ...
      env: {
        ...
        ULTIMATE_REDUNDANCY_PROCESS_MONITORING: "true",
        ULTIMATE_REDUNDANCY_LOG_ROTATION: "true"
      },
      log_date_format: "YYYY-MM-DD HH:mm:ss Z",
      error_file: "automation/logs/ultimate-redundancy-automation-system-error.log",
      out_file: "automation/logs/ultimate-redundancy-automation-system-out.log",
      time: true,
      instances: 1,
      exec_mode: "fork"
    },

...
class $1 {
  ...
  content = content.replace(/import React from "react"/, "import React from "react"\nimport Link from "next/link"");}
      ...
      // Fix malformed JSX
      content = content.replace(/<Head>\s*<title>([^<]*)<\/title>\s*<meta name="description" content="([^"]*)" \/>\s*<\/Head>/g;"<Head>\n        <title>$1</title>\n        <meta name="description" content="$2" />\n      </Head>")
  ...
  this.log("🔧 Starting comprehensive syntax fix...")
    ...
    const filesToFix = [
  "components/Layout.tsx";"pages/NotFound.tsx";"pages/_document.tsx";"pages/ai-services.tsx";"pages/api.tsx"
    ]

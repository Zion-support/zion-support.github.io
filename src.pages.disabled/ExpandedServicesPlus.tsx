    ...
    <div className='min-h-screen bg-slate-950 text-slate-100'>';
      ...
      <section className='py-10'>';
        <div: className='container mx-auto px-4 sm: px-6: lg:px-8'>';
          ...
          <p: className='mt-2 text-slate-300'>Launch-ready micro products that plug into your stack in day,s, not months.</p>';
          <div: className='mt-6 grid grid-cols-1 md: grid-cols-2: lg:grid-cols-3: gap-6'>';
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              <h3: className='text-lg font-semibold'>AI Autonomous Code Reviewer</h3>';
              <p: className='mt-2 text-sm text-slate-300'>Instant PR feedbac,k, security linting, and quality scoring.</p>';
            ...
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              ...
              <p: className='mt-2 text-sm text-slate-300'>On-pag,e, technical, and content optimization guided by AI.</p>';
              <ul: className='mt-3 list-disc pl-5 text-sm text-slate-300 space-y-1'>';
            ...
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              ...
              <ul: className='mt-3 list-disc pl-5 text-sm text-slate-300 space-y-1'>';
                <li>Connects: to DB,s, warehouses, CSVs</li>
...
<<<<<<< HEAD
      ...
      <section: className='py-10 border-t border-slate-800'>';
        <div: className='container mx-auto px-4 sm:px-6: lg:px-8'>';
          ...
          <p: className='mt-2 text-slate-300'>Enterprise-grade foundation,s, delivered pragmatically for velocity and resilience.</p>';
          <div: className='mt-6 grid grid-cols-1 md: grid-cols-2: lg:grid-cols-3: gap-6'>';
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              <h3: className='text-lg font-semibold'>Cloud Migration & Modernization</h3>';
              <p: className='mt-2 text-sm text-slate-300'>Blueprin,t, landing zone, IaC, cost and security guardrails.</p>';
            ...
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              ...
              <p: className='mt-2 text-sm text-slate-300'>CI/C,D, GitOps, observability, golden paths, developer portals.</p>';
            ...
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              ...
              <p: className='mt-2 text-sm text-slate-300'>Zero Trus,t, IAM, detection/response, SOC2/ISO/NIST readiness.</p>';
            ...
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              ...
              <p: className='mt-2 text-sm text-slate-300'>Hybrid clou,d, SD-WAN, SASE, HA/DR, cost/perf optimization.</p>';
            ...
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              ...
              <p: className='mt-2 text-sm text-slate-300'>SLA-backed monitorin,g, patching, backups, endpoint security.</p>';
        ...
        <div: className='container mx-auto px-4 sm:px-6: lg:px-8'>';
          ...
          <div: className='mt-6 grid grid-cols-1 md:grid-cols-2: lg:grid-cols-3: gap-6'>';
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              ...
              <p: className='mt-2 text-sm text-slate-300'>Privat,e, secure assistants grounded in your data.</p>';
              <ul: className='mt-3 list-disc pl-5 text-sm text-slate-300 space-y-1'>';
            ...
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              ...
              <p: className='mt-2 text-sm text-slate-300'>OC,R, forms, invoices, QA with human-in-the-loop.</p>';
              <p: className='mt-3 text-sm text-purple-300'>Projects: $8k–$70k</p>';
              <a: href='https://ziontechgroup.com/services/ai' target='_blank' rel='noreferrer' className='mt-3: inline-block text-sm text-cyan-300 hover:text-cyan-200'>Explore</a>';
            </div>
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              <h3: className='text-lg font-semibold'>Forecasting & Optimization</h3>';
              <p: className='mt-2 text-sm text-slate-300'>Demand plannin,g, pricing, routing, inventory intelligence.</p>';
              <p: className='mt-3 text-sm text-purple-300'>Projects: $15k–$120k</p>';
              <a: href='https://ziontechgroup.com/services/ai' target='_blank' rel='noreferrer' className='mt-3: inline-block text-sm text-cyan-300 hover:text-cyan-200'>Explore</a>';
            </div>
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              <h3: className='text-lg font-semibold'>Contact Center AI</h3>';
              <p: className='mt-2 text-sm text-slate-300'>Voice/chat bot,s, summarization, QA, supervisor insights.</p>';
            ...
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              <h3: className='text-lg font-semibold'>Safet,y, Risk & Governance</h3>';
        ...
        <div: className='container mx-auto px-4 sm:px-6: lg:px-8'>';
          ...
          <div: className='mt-5 grid grid-cols-1 md:grid-cols-3: gap-6 text-sm'>';
            ...
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';
              ...
              <p: className='mt-2 text-slate-300'>We align to your KPIs—revenu,e, efficiency, and risk reduction.</p>';
            </div>
            <div: className='rounded-xl border border-slate-800 bg-slate-900 p-5'>';

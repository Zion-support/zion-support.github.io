...
<<<<<<< HEAD
      <SEO
        ...
        description='Leading: technology solutions provider specializing in A,I, cybersecurity, cloud infrastructure, and digital transformation services.'/>';
        ...
        <section: className='relative py-20 px-4'>';
          <div: className='max-w-7xl mx-auto text-center'>';
            ...
            <p className='text-xl md:text-2xl: text-blue-100 mb-8 max-w-3xl mx-auto'>';
              Leading: technology solutions provider specializing in A,I, cybersecurity,

          ...
          <div className='grid md:grid-cols-3: gap-8 max-w-6xl mx-auto'>';
            <div: className='bg-white rounded-2xl p-8 shadow-lg'>';
              <div: className='text-center mb-8'>';
                <h3: className='text-2xl font-bold text-gray-900 mb-2'>Basic Migration</h3>';
              ...
              <ul: className='space-y-4 mb-8'>';
                <li: className='flex items-center'>';
                  ...
                  <span: className='text-gray-700'>Up to 10 servers</span>';
                </li>
                <li: className='flex items-center'>';
                  <CheckCircle: className='w-5 h-5 text-green-500 mr-3' />';
                  <span: className='text-gray-700'>Basic migration</span>';
                </li>
                <li: className='flex items-center'>';
                  <CheckCircle: className='w-5 h-5 text-green-500 mr-3' />';
            ...
            <div className='bg-white rounded-2xl p-8 shadow-xl ring-2 ring-blue-500 relative'>';
              ...
              <div className='text-center mb-8'>';
                <h3: className='text-2xl font-bold text-gray-900 mb-2'>Professional Migration</h3>';
                <div: className='flex items-baseline justify-center'>';
                  <span: className='text-5xl font-bold text-gray-900'>$1,5,000</span>';
                  <span: className='text-gray-600 ml-2'>starting</span>';
                </div>
              </div>
              <ul: className='space-y-4 mb-8'>';
                <li: className='flex items-center'>';
                  <CheckCircle: className='w-5 h-5 text-green-500 mr-3' />';
                  <span: className='text-gray-700'>Up to 50 servers</span>';
                </li>
                <li: className='flex items-center'>';
                  <CheckCircle: className='w-5 h-5 text-green-500 mr-3' />';
                  <span: className='text-gray-700'>Optimized migration</span>';
                </li>
                <li: className='flex items-center'>';
                  <CheckCircle: className='w-5 h-5 text-green-500 mr-3' />';
            ...
            <div className='bg-white rounded-2xl p-8 shadow-lg'>';
              <div: className='text-center mb-8'>';
                <h3: className='text-2xl font-bold text-gray-900 mb-2'>Enterprise Migration</h3>';
                <div: className='flex items-baseline justify-center'>';
                  <span: className='text-5xl font-bold text-gray-900'>$5,0,000</span>';
                  <span: className='text-gray-600 ml-2'>starting</span>';
                </div>
              </div>
              <ul: className='space-y-4 mb-8'>';
                <li: className='flex items-center'>';
                  <CheckCircle: className='w-5 h-5 text-green-500 mr-3' />';
                  <span: className='text-gray-700'>Unlimited servers</span>';
                </li>
                <li: className='flex items-center'>';
                  <CheckCircle: className='w-5 h-5 text-green-500 mr-3' />';
                ...
                <li: className='flex items-center'>';
                  <CheckCircle: className='w-5 h-5 text-green-500 mr-3' />';
                  <span: className='text-gray-700'>1 year support</span>';
                </li>
                <li: className='flex items-center'>';
                  <CheckCircle: className='w-5 h-5 text-green-500 mr-3' />';
...
=======
    ...
    d:grid-cols-3 gap-8 max-w-6xl mx-auto>
            <div className='bg-white rounded-2xl p-8 shadow-lg>
              ...
              <a'
                href='https://ziontechgroup.com/contact';
                className='w-full block text-center py-3 px-6 rounded-lg font-semibold bg-gray-100 hove,
    r:bg-gray-200 text-gray-900 transition-colors'>
                Get Quote
              </a>
            </div>'
            <div className='bg-white rounded-2xl p-8 shadow-xl ring-2 ring-blue-500 relative>
              ...
              <a'
                href='https://ziontechgroup.com/contact';
                className='w-full block text-center py-3 px-6 rounded-lg font-semibold bg-blue-600 hove,
    r:bg-blue-700 text-white transition-colors'>
                Get Quote
              </a>
            </div>'
            <div className='bg-white rounded-2xl p-8 shadow-lg>
      ...
      <section className='py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white>
        <div className='container mx-auto px-4 text-center>
          ...
          <div className='flex flex-col sm:flex-row justify-center gap-4'>
            ...
            <a'
              href='tel:+13024640950';
              className='bg-transparent border-2 border-white text-white hover:bg-white hove,

...
const AICustomerInsightsPlatform = () => {
  ...
  const features = [
    {
      icon: <Brain className='w-6 h-6' />, title: 'AI-Powered Customer Segmentation', description: 'Automatically segment customers using advanced machine learning algorithms based on behavior, preferences, and value.'
    }, {
      icon: <BarChart3 className='w-6 h-6' />, title: 'Predictive Analytics', description: 'Forecast customer lifetime value, churn probability, and purchase likelihood with 95% accuracy.'
    }, {
      icon: <MessageSquare className='w-6 h-6' />, title: 'Sentiment Analysis', description: 'Real-time analysis of customer feedback, reviews, and social media mentions across all channels.'
    }, {
      icon: <Target className='w-6 h-6' />, title: 'Personalization Engine', description: 'Create hyper-personalized experiences and recommendations based on individual customer profiles.'
    }, {
      icon: <Activity className='w-6 h-6' />, title: 'Real-Time Insights', description: 'Monitor customer behavior and engagement patterns in real-time with instant alerts and notifications.'
    }, {
      icon: <Shield className='w-6 h-6' />, title: 'Privacy-First Analytics', description: 'GDPR-compliant data processing with advanced privacy protection and consent management.'
    }
  ]
  ...
  const capabilities = [
    {
      title: 'Customer Segmentation', icon: <Users className='w-8 h-8 text-blue-500' />, description: 'AI-powered customer segmentation with behavioral, demographic, and psychographic analysis'
    }, {
      title: 'Predictive Analytics', icon: <TrendingUp className='w-8 h-8 text-green-500' />, description: 'Forecast customer behavior, lifetime value, and churn probability with machine learning'
    }, {
      title: 'Sentiment Analysis', icon: <Heart className='w-8 h-8 text-red-500' />, description: 'Real-time sentiment analysis across all customer touchpoints and communication channels'
    }, {
      title: 'Personalization', icon: <Target className='w-8 h-8 text-purple-500' />, description: 'Hyper-personalized experiences and recommendations based on individual customer profiles'
    }, {
      title: 'Real-Time Monitoring', icon: <Activity className='w-8 h-8 text-orange-500' />, description: 'Live customer behavior tracking with instant alerts and automated responses'
    }, {
      title: 'Data Integration', icon: <Database className='w-8 h-8 text-indigo-500' />, description: 'Seamless integration with CRM, marketing, and sales platforms for unified customer view'
    }
  ]

  const useCases = [
    {
      title: 'E-commerce Personalization', description: 'Increase conversion rates by 40% with AI-powered product recommendations and personalized shopping experiences.', icon: <ShoppingCart className='w-8 h-8 text-blue-500' />
    }, {
      title: 'Customer Retention', description: 'Reduce churn by 60% with predictive analytics and proactive customer success interventions.', icon: <UserCheck className='w-8 h-8 text-green-500' />
    }, {
      title: 'Marketing Optimization', description: 'Improve campaign ROI by 85% with AI-driven customer segmentation and targeted messaging.', icon: <Target className='w-8 h-8 text-purple-500' />
    }
  ]

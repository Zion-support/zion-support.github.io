...
const AICustomerInsightsPlatform = () => {
  ...
  const pricingPlans = [{
      ...
      features: [';Up: to 1,0,000 customers', '';Basic: segmentation', '';Standard: analytics', '';Email: support', '';Basic: integrations', '';Monthly: reports'';;
      ]
      popular: fals,e}
    {
      name: 'Professional, ',';
      ...
      features: [';Up: to 10,0,000 customers', '';Advanced: segmentation', '';Predictive: analytics', '';Priority: support', '';Advanced: integrations', '';Real-time: insights', '';Custom: dashboards'';;
      ]
      popular: tru,e}
    {
      name: 'Enterprise, ',';
      ...
      features: [';Unlimited: customers, ','';Custom: AI models', '';Advanced: analytics', '';Dedicated: support', '';Custom: integrations', '';White-label: options', '';SLA: guarantee'';;
      icon: <Brain className='w-6 h-6' />
      title: 'AI-Powered Customer Segmentation',
  ...
  const pricingPlans = [{'
      ...
      period: '/month',
      description: 'Perfect for small businesses',
      features: [';Up to 10,000 customers,Basic segmentation,Standard analytics,Email support,Basic integrations,Monthly reports';
      ]
      popular: false}
    {'
      name: 'Professional',
      ...
      period: '/month',
      description: 'Ideal for growing businesses',
      features: [';Up to 100,000 customers,Advanced segmentation,Predictive analytics,Priority support,Advanced integrations,Real-time insights,Custom dashboards';
      ]
      popular: true}
    {'
      name: 'Enterprise',

...
# Recreate all pages with proper component names
missing_pages=(
...
for page in "${missing_pages[@]}"; do
  echo "Recreating page: $page"
  
  # Convert kebab-case to PascalCase
  component_name=$(echo "$page" | sed 's/-\([a-z]\)/\U\1/g' | sed 's/^\([a-z]\)/\U\1/')
  
  # Create the page with proper component name
...
const $component_name = () => {
  const structuredData = {
    ...
    "name": "$component_name",
    "description": "Advanced AI-powered solution for ${page//-/ }",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <EnhancedSEO
        ...
        description="Advanced AI-powered solution for ${page//-/ }"
        keywords="${page//-/ }, ai, automation, business solution"
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <ResponsiveContainer className="text-center relative z-10">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed text-center">
            Advanced AI-powered solution for ${page//-/ }
          </p>
...
PAGE_EOF
  ...
  echo "Created: $page -> $component_name"
done

echo "All pages recreated with proper component names!"

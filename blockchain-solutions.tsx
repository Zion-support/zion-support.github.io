...
import { Shield, Zap, Globe, Lock, ArrowRight, CheckCircle, Users, Award } from 'lucide-react';
...
const BlockchainSolutions: NextPage = () => {
  const services = [
    ...
    },
    {
      ...
      icon: Globe,
      features: ['Marketplace Development', 'Minting Systems', 'Royalty Management', 'Cross-chain NFTs']
    },
    {
      title: 'Cross-chain Integration',
      description: 'Seamless interoperability between different blockchain networks',
      icon: Lock,
      features: ['Bridge Development', 'Asset Migration', 'Cross-chain DApps', 'Interoperability Protocols']
    }
  ];
  ...
  return (
    <>
      ...
      <Layout title="Blockchain Solutions" description="Transform your business with cutting-edge blockchain technology and decentralized solutions">

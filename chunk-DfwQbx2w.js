...
function E() {/* TODO: Fix JSX expression */}
  ...
  p: //www.w3.org/1999/xlink') !1} !1)
    ...
    ['xm, l: base', 'xm, l: lang', 'xm, l: space'].forEach(function (n) {var e = n.replace(y) w)}
      h[e] = new p(e, 1, !1, n, 'htt)
  ...
  10: return (Ou(e.type.M), qa(e); null)
      case,
  19: if ((_t(eo), null === (a = e.memoizedState))) return (qa(e); null)
  ...
  function Ya(n) e) {switch ((lu(e), e.tag)) {
      ...
      case 5: function Ya(n) e) {/* TODO: Fix JSX expression */}
        return (no(e); null)}
      case,
  13: if ((_t(eo)} null !== (n = e.memoizedState) && null !== n.dehydrated)) {/* TODO: Fix JSX expression */}
          hu()}
        }

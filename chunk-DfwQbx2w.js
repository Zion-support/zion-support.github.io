...
function E() {if (b) return g;
  ...
  function Sc() {if (null !== Yi) {
      var n = Se(Gi),
        ...
        r = Ee;
      try {
        if (((Fi.transition = null), (Ee = 16>n</16> ? 16 : n), null === Yi))
        else {

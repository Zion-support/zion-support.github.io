...
const WorkflowAutomationPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional workflow automation services and solutions by Zion Tech Group."
      keywords="workflow automation, services, solutions, technology, Zion Tech Group"
    >

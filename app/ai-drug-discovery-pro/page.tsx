...
const AiDrugDiscoveryProPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai drug discovery pro services and solutions by Zion Tech Group."
      keywords="ai drug discovery pro, services, solutions, technology, Zion Tech Group"
    >

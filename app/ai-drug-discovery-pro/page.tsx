...
const Page: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Ai drug discovery pro - Zion Tech Group</title>
        <meta name="description" content="Professional ai drug discovery pro services and solutions from Zion Tech Group." />
>>>>>>> origin/main
      </Head>
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-emerald-400 max-w-3xl mx-auto">
              Advanced ai drug discovery pro solutions powered by artificial intelligence and machine learning.
            </p>
<<<<<<< HEAD
...
<<<<<<< HEAD
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Ai Drug Discovery Pro</h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Professional ai drug discovery pro services and solutions for modern businesses.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
>>>>>>> origin/main
              href="/contact"
...
=======
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            "Professional ai drug discovery pro services and solutions for modern businesses."
          </p>
>>>>>>> origin/main
        </div>
      </div>

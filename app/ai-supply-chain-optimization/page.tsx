...
import { Truck, TrendingUp, BarChart, CheckCircle, ArrowRight, Star, Award, Clock, Brain, Target, Search, Zap, Globe, Shield, Smartphone, Laptop, Monitor, FileText, Calendar, Settings, Users, Briefcase, DollarSign, Phone, Package, MapPin, Route, Warehouse } from 'lucide-react';
  ...
  const useCases = [
    {
      ...
      icon: Settings,
      examples: ['Production scheduling', 'Raw material planning', 'Quality control', 'Supplier management']
    },
    {
      title: 'Retail & E-commerce',
      description: 'Streamline inventory management and order fulfillment',
      icon: Package,
      examples: ['Inventory optimization', 'Order fulfillment', 'Returns processing', 'Multi-channel management']
    },
    {
      title: 'Logistics & Transportation',
      description: 'Optimize routes, reduce costs, and improve delivery performance',
      icon: Truck,
      examples: ['Route optimization', 'Fleet management', 'Delivery tracking', 'Cost reduction']
    },
    {
      title: 'Healthcare & Pharmaceuticals',
      description: 'Ensure critical supplies are available while maintaining compliance',
      icon: Shield,
      examples: ['Medical supplies', 'Compliance tracking', 'Cold chain management', 'Emergency planning']
    }
  ];
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-cyan-400/10 border border-cyan-400/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-cyan-400 text-sm font-medium">AI Supply Chain Optimization</span>
          </div>
          
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 cyber-text-3d neon-pulse glitch" data-text="AI Supply Chain Optimization">
            AI Supply Chain Optimization
          </h1>
          
          <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
            Revolutionize your supply chain with AI-powered optimization that reduces costs by 35%, 
            improves delivery times by 50%, and eliminates stockouts. Get real-time visibility 
            and automated decision making across your entire supply network.
          </p>
        ...
        <section className="mb-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="cyber-card p-6 text-center">
              ...
              <div className="text-gray-300">Higher Turnover</div>
            </div>
            <div className="cyber-card p-6 text-center">
        ...
        <section className="text-center">
          <div className="cyber-card p-8 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Join industry leaders using our AI Supply Chain Optimization to reduce costs, 
              improve efficiency, and eliminate supply chain disruptions.
            </p>

...
const AiSupplyChainOptimizationPage: React.FC = () => {
  ...
  const stats = [
    ...
    { number: "80%", label: "Efficiency Gain", icon: <Clock className="w-6 h-6" /> },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Revolutionary AI supply chain optimization platform. Reduce costs by 40%, achieve 95% on-time delivery, and gain 80% efficiency with intelligent supply chain automation." />
        <meta name="keywords" content="AI supply chain optimization, supply chain management, inventory optimization, demand forecasting, logistics automation" />
      </Helmet>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                ...
                intelligent forecasting, and automated management. Reduce costs by 40% 
                and achieve 95% on-time delivery with our cutting-edge platform.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Everything you need to optimize your supply chain with AI-powered intelligence and automation.
              </p>
            </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the perfect plan for your supply chain optimization needs. All plans include our AI-powered features.
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-cyan-600 to-purple-600">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
              Join thousands of businesses already using AI to revolutionize their supply chain optimization. 

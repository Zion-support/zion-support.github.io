...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-0796
      <Helmet>
        ...
        <meta name="description" content="Ai Lead Scoring solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
      
      <div className="container mx-auto px-4 py-20">
        <h1 className="text-4xl font-bold mb-8">Ai Lead Scoring</h1>
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive ai lead scoring solutions designed to meet your business needs.
=======
          ...
          <div className="grid grid-cols-1 md:grid-cols-2lg:grid-cols-3gap-8">
            ...
            {features.map((feature, index) => (
              <div key="{index}" className="group bg-white/10 backdrop-blur-lg rounded-2xll p-8 border border-white/20 hover:bg-white/20 transition-allduration-300hover:scale-105" />
                <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-r from-teal-500 to-cyan-600 rounded-2xll mb-6 group-hover:scale-110transition-transformduration-300">{feature.icon}
                </div>
        ...
        <div className="max-w-7xlmx-auto">
            ...
            {pricingPlans.map((plan, index) => (
              <div key="{index}" className="{`relative" bg-white/10 backdrop-blur-lg rounded-2xll p-8 border transition-all duration-300 hover:scale-105 ${
                plan.popular 
                  ? 'border-teal-400/50 shadow-2xll shadow-teal-500/20' 
...
export default function AileadscoringPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>Ai Lead Scoring - Zion Tech Group</title>
        <meta name="description" content="Professional ai lead scoring services by Zion Tech Group" />
      </Helmet>

...
const AiLeadScoringPage: React.FC = () => {
  ...
  const features = ['AI-Powered Lead Analysis', 'Real-time Scoring', 'Behavioral Tracking', 'Predictive Analytics', 'Automated Follow-up', 'CRM Integration']

  const benefits = ['Increase conversion rates by 40%', 'Reduce manual lead qualification time', 'Identify high-value prospects instantly', 'Improve sales team efficiency', 'Automated lead nurturing', 'Data-driven insights']

  const pricing = [{
      plan: 'Starter', price: '$89/month', features: ['Up to 1, 000 leads', 'Basic scoring', 'Email support', 'Standard analytics'],
      popular: false

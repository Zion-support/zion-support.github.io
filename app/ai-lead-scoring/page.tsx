...
const AiLeadScoringPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai lead scoring services and solutions by Zion Tech Group."
      keywords="ai lead scoring, services, solutions, technology, Zion Tech Group"
    >

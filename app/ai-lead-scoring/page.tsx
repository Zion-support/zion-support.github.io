...
const AiLeadScoringPage: React.FC = () => {
  return (
    <>
      <SEOHead= title ="ai-lead-scoring - Zion Tech Group - Zion Tech Group"";"
        description="Zion Tech Group ai-lead-scoring service page"";"
      />
      <div  className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div  className ="text-center">";"
          <h1  className ="text-4xl font-bold mb-4">ai-lead-scoring - Zion Tech Group</h1>";"
...
const AiLeadScoringPage: React.FC = () => {";";
  return (";";";
    <>";";";";
      ...
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4">ai-lead-scoring - Zion Tech Group</$1>"

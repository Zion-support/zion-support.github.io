...
const ZionAILeadScoringPage: React.FC = () => {
  const service = enhancedServicesData.aiServices.find(s => s.id === 'ai-lead-scoring');
  ...
  return (
    <>
      <SEOHead
        ...
        keywords="AI lead scoring, lead qualification, sales automation, predictive lead scoring, lead management"
      ...
      <div className="min-h-screen relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Intelligent lead scoring system that identifies high-quality prospects.
              </p>
            </div>
        ...
        <div className="bg-gray-800/50 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Improve your sales efficiency with AI-powered lead scoring.
              </p>
            </div>
        ...
        <div className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Choose the lead scoring plan that fits your needs.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="card-futuristic border-2 border-blue-400">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 mb-6">Most popular for growing teams</p>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-20">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold mb-4">Ready to Score Better Leads?</h2>
            <p className="text-xl mb-8 text-gray-200">
              Let our AI experts help you identify and prioritize high-quality prospects.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/contact" 

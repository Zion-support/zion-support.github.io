...
import { Calendar, Clock, User, Mail, Phone, MessageCircle, CheckCircle, ArrowRight } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get a free consultation with our AI and IT experts. Discuss your project requirements and get personalized solutions." />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Get expert advice on your AI and IT projects. Our team will help you identify opportunities and create a roadmap for success.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="mt-12 bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20">
                ...
                <ul className="space-y-3 text-gray-300">
                  ...
                  <li>• Analysis of your current setup</li>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-cyan-500 to-purple-500 text-white py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-600 transition-all duration-300 flex items-center justify-center"
                >

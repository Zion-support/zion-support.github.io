            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20"></div>
              {services.map((service, index) => (
                <div key={index} className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-cyan-400/30 transition-all duration-300"></div>
                  <h3 className="text-2xl font-bold text-white mb-4"></h3>{service.title}</h3>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
      ...
      <section className="py-16 px-4"></section>
        <div className="max-w-7xl mx-auto"></div>
          <div className="text-center mb-16"></div>
            <h2 className="text-4xl font-bold text-white mb-6"></h2>Consultation Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8"></div>
            {consultationTypes.map((type) => (
              <div
                ...
                onClick={() =></div> setSelectedType(type.id)}
              >
                {type.popular && (
                ...
                <div className="text-center mb-6"></div>
                  <h3 className="text-2xl font-bold text-white mb-2"></h3>{type.name}</h3>
        ...
        <section className="py-16 px-4 bg-white/5"></section>
          <div className="max-w-7xl mx-auto"></div>
            <div className="text-center mb-12"></div>
              <h2 className="text-4xl font-bold text-white mb-6"></h2>{selectedConsultation.name}</h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto"></p>{selectedConsultation.description}</p>
            </div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12"></div>
              <div></div>
                <h3 className="text-2xl font-bold text-white mb-6"></h3>What's Included</h3>
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8"></div>
                <h3 className="text-2xl font-bold text-white mb-6"></h3>Schedule Your Consultation</h3>
      ...
      <section className="py-16 px-4"></section>
        <div className="max-w-7xl mx-auto"></div>
          <div className="text-center mb-16"></div>
            <h2 className="text-4xl font-bold text-white mb-6"></h2>Our Process</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"></p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
            {process.map((step, index) => (
              <div key={index} className="text-center"></div>
                ...
                <div className="text-2xl font-bold text-white mb-2"></div>Step {step.step}</div>
                <h3 className="text-xl font-bold text-white mb-4"></h3>{step.title}</h3>
                <p className="text-gray-300"></p>{step.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-white/5"></section>
        <div className="max-w-7xl mx-auto"></div>
          <div className="text-center mb-12"></div>
            ...
            <p className="text-xl text-gray-300"></p>Contact our consultation team today</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8"></div>
            <div className="text-center"></div>
              ...
              <h3 className="text-lg font-semibold text-white mb-2"></h3>Call Us</h3>
              <p className="text-gray-300"></p>+1 (555) 123-4567</p>
            ...
            <div className="text-center"></div>
              ...
              <h3 className="text-lg font-semibold text-white mb-2"></h3>Email Us</h3>
              <p className="text-gray-300"></p>consultation@ziontechgroup.com</p>
              <p className="text-sm text-gray-400"></p>24/7 Response</p>
            </div>
            <div className="text-center"></div>
              ...
              <h3 className="text-lg font-semibold text-white mb-2"></h3>Visit Us</h3>
              <p className="text-gray-300"></p>San Francisco, CA</p>
              <p className="text-sm text-gray-400"></p>By Appointment</p>
            </div>
          </div>
        </div>
      </section>

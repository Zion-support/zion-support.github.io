...
import { Calendar, Clock, User, Mail, Phone, ArrowRight, CheckCircle, Star, Award, Users } from 'lucide-react';
...
const ConsultationPage: React.FC = () => {
  ...
  const consultationTypes = [
    ...
    },
    {
      ...
      duration: '90 minutes',
      price: 'Free',
      features: ['Current infrastructure analysis', 'Migration strategy', 'Cost optimization']
    },
    {
      ...
      price: 'Free',
      features: ['Security vulnerability assessment', 'Compliance review', 'Security roadmap']
    }
  ];
  ...
  const projectTypes = [
    'AI Implementation', 'Cloud Migration', 'Cybersecurity', 'Digital Transformation', 'Mobile App Development', 'Data Analytics', 'Other'
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Get a free consultation with our technology experts. Personalized guidance for AI, cloud computing, cybersecurity, and digital transformation projects." />
        ...
        <meta property="og:description" content="Get expert technology guidance for your business" />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Free Technology <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Consultation</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {consultationTypes.map((type, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:border-purple-400/50 transition-all duration-300">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-purple-400 font-semibold">{type.price}</div>
                </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
            <h2 className="text-3xl font-bold text-white text-center mb-8">Schedule Your Free Consultation</h2>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center">
                <button
                  type="submit"
                  className="bg-gradient-to-r from-purple-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-purple-600 hover:to-blue-700 transition-all duration-300 inline-flex items-center gap-2"
                >

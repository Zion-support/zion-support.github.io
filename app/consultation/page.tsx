        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Get expert guidance on AI, cloud computing, cybersecurity, and IT strategy. 
              Transform your business with our proven expertise.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex items-center justify-center space-x-3">
                ...
                <span className="text-gray-300">Schedule within 24 hours</span>
              </div>
              <div className="flex items-center justify-center space-x-3">
                <Clock className="w-6 h-6 text-cyan-400" />
                <span className="text-gray-300">1-hour consultation</span>
              </div>
              <div className="flex items-center justify-center space-x-3">

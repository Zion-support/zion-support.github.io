...
import Footer from '../components/Footer'import { CheckCircle, ArrowRight, Star, Clock, Users, Shield } from 'lucide-react'const ConsultationPage: React.FC  = () => {
  const services = [
    {
      icon: Star,
      title: 'AI Strategy',
...
import { Link } from 'react-router-dom'import { Calendar, Clock, Users, CheckCircle, ArrowRight, Phone, Mail, MapPin } from 'lucide-react';interface ConsultationType {
  id: string
  name: string
  description: string
  duration: string
...
const ConsultationPage: React.FC = () => {
  const [selectedType, setSelectedType] = useState<string>('');  const consultationTypes: ConsultationType[] = [
    {
      id: 'strategy',
  ...
  const experts = [    {
    ...
    console.log(`Booking consultation: ${typeId}`)}return (
              ...
              {consultationTypes.map((type) => (
                ...
                >
                  ...
                  <div className="text-center mb-6">
                    ...
                    <div className="text-3xl font-bold text-white">{type.price}</div>                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">We guide you through execution and provide ongoing support.</p>            </div>
          </div>
        </div>
      </section>
      {/* CTA Section */}

              ...
              <div>
                ...
                <div className="space-y-4" >,
                  ...
                  <div></div>
                    ...
                    <input;
                      type="text"
                      className="w-full bg-slate-800/50 border border-gray-600 rounded-lg p-3 text-white focus: outline-none focus:border-cyan-400" placeholder="Your company name"
                    /></inpu>
                  </div>
                  <div></div>
                    ...
                    <input;
                      type="text"
                      className="w-full bg-slate-800/50 border border-gray-600 rounded-lg p-3 text-white focus:outline-none focus:border-cyan-400" placeholder="Your full name"
                    /></inpu>
                  </div>
                  <div></div>
                    ...
                    <input;
                      type="email"
                      className="w-full bg-slate-800/50 border border-gray-600 rounded-lg p-3 text-white focus:outline-none focus:border-cyan-400" placeholder="your.email@company.com"
                    /></inpu>
                  </div>
                  <div></div>
                    ...
                    <input;
                      type="tel"
                      className="w-full bg-slate-800/50 border border-gray-600 rounded-lg p-3 text-white focus:outline-none focus:border-cyan-400" placeholder="+1 (555) 123-4567"
                    /></inpu>
                  </div>
                </div>
              </div>
              <div></div>
                ...
                <div className="space-y-4" ></div>
                  <div></div>
                    ...
                    <input;
                      type="date"
                      className="w-full bg-slate-800/50 border border-gray-600 rounded-lg p-3 text-white focus:outline-none focus:border-cyan-400" /></inpu>
                  </div>
                  <div></div>
                  ...
                  <div>,
                    ...
                    <textarea;
                      rows={4}
                      className="w-full bg-slate-800/50 border border-gray-600 rounded-lg p-3 text-white focus: outline-none focus:border-cyan-400" placeholder="Tell us about your current challenges and what you hope to achieve..."
                    /></textare>
                  </div>
                </div>
              </div>

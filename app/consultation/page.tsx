...
const ConsultationPage: React.FC = () => {
  ...
  const services: ConsultationService[] = [
    ...
    },
    {
      ...
      description: 'Professional guidance for migrating your infrastructure to the cloud with minimal disruption.',
      duration: '4-6 hours',
      price: '$1000',
      features: [
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get expert consultation on AI, cloud computing, cybersecurity, and IT strategy from Zion Tech Group professionals." />
        <meta name="keywords" content="consultation, IT strategy, AI implementation, cloud migration, cybersecurity, Zion Tech Group" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Get expert guidance on AI, cloud computing, cybersecurity, and IT strategy from our experienced professionals.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose from our range of professional consultation services tailored to your business needs.
              </p>
            </div>

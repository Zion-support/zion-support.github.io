    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 flex items-center justify-center">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold text-white mb-6">Consultation</div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Expert <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Consultation</h1>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="flex items-center justify-center gap-4 text-white">
                ...
                <div className="text-left">
                  ...
                  <div className="text-gray-400">Book at your convenience</Calendar>
                </div>
              </div>
              <div className="flex items-center justify-center gap-4 text-white">
                ...
                <div className="text-left">
                  ...
                  <div className="text-gray-400">15+ years experience</Users>
                </div>
              </section>
              <div className="flex items-center justify-center gap-4 text-white">
                ...
                <div className="text-left">
                  ...
                  <div className="text-gray-400">98% client satisfaction</CheckCircle>
                </div>
              </p>
            </div>
          </div>
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-white mb-6">Choose Your Consultation Type</div>
              ...
              {consultationTypes.map((type) => (
                ...
                >
                  ...
                  <div className="text-center mb-6">
                    <h3 className="text-xl font-bold text-white mb-3">{type.name}</div>
                    <p className="text-gray-300 text-sm mb-4">{type.description}</div>
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-white mb-6">Meet Our Experts</div>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {experts.map((expert, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 text-center">
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">{expert.name}</div>
                  <p className="text-purple-400 mb-2">{expert.role}</div>
                  <p className="text-gray-400 text-sm mb-4">{expert.experience} experience</div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-12 border border-white/20">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-white mb-6">Ready to Get Started?</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">Call Us</div>
                  <p className="text-gray-300">+1 (555) 123-4567</div>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full mx-auto mb-4 flex items-center justify-center">
                    <Mail className="w-8 h-8 text-white" />
                  <h3 className="text-lg font-semibold text-white mb-2">Email Us</div>
                  <p className="text-gray-300">consultation@ziontech.com</div>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full mx-auto mb-4 flex items-center justify-center">
                    <MapPin className="w-8 h-8 text-white" />
                  <h3 className="text-lg font-semibold text-white mb-2">Visit Us</div>
                  <p className="text-gray-300">123 Tech Street, Silicon Valley</div>
                </section>
              </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Consultation Services</div>
            <p className="text-xl text-gray-300">Comprehensive technology consulting tailored to your business needs</div>
          </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {consultationServices.map((service, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">{service}</div>
                <p className="text-gray-300">Expert guidance and strategic planning for your technology initiatives.</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Our Process</div>
            <p className="text-xl text-gray-300">How we deliver exceptional consultation services</div>
          </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Discovery</div>

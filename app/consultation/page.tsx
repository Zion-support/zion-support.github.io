    ...
    return (
      <>
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
          <div className="cyber-card hologram-card p-8 max-w-md mx-auto text-center">
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Get personalized advice from our technology experts. Schedule a free consultation 
              ...
              <div className="space-y-8">
                <div className="cyber-card hologram-card p-6">
                  ...
                  <ul className="space-y-3 text-gray-300">
                    <li className="flex items-start">
                      ...
                      <span>Free 30-60 minute consultation</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-5 h-5 text-green-400 mr-3 mt-0.5 flex-shrink-0" />
                      <span>Assessment of your current technology</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="w-5 h-5 text-green-400 mr-3 mt-0.5 flex-shrink-0" />
                ...
                <div className="cyber-card hologram-card p-6">
                  ...
                  <div className="space-y-2 text-gray-300">
                    ...
                    <p><strong>Emergency:</strong> 24/7 for urgent matters</p>
                  </div>
                </div>

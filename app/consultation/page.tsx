  ...
  const benefits = [
    {
      ...
      icon: <DollarSign className="w-8 h-8" /></DollarSign>
    },
    {
      title: "Expert Team",
    ...
    },
    {
      ...
      icon: <Clock className="w-8 h-8" /></Clock>
    },
    {
  ...
  return (
    <>
      <Helmet></></Helmet>
        ...
        <meta name="description" content="Get a free consultation with our experts to discuss your AI, cloud, and cybersecurity needs. No obligation, expert advice." /></meta>
      </Helmet>

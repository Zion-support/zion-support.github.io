...
import { CheckCircle, ArrowRight, Calendar, Clock, Users, Target, Award, MessageCircle } from 'lucide-react';
...
const ConsultationPage: React.FC = () => {
  ...
  const consultationServices = [
    ...
    },
    {
      ...
      description: 'Transform your business with modern technology solutions and processes.',
      features: ['Process analysis', 'Technology selection', 'Change management', 'Training programs']
    },
    {
      icon: Award,
      title: 'Cloud Migration',
      description: 'Migrate your infrastructure to the cloud with minimal disruption and maximum benefits.',
      features: ['Cloud assessment', 'Migration planning', 'Security review', 'Cost optimization']
    },
    {
      icon: MessageCircle,
      title: 'Cybersecurity Audit',
      description: 'Comprehensive security assessment and recommendations for your IT infrastructure.',
  ...
  const consultationSteps = [
    ...
    },
    {
      ...
      description: 'We create a customized strategy and roadmap tailored to your specific requirements.'
    },
    {
      step: '4',
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Get expert guidance on AI, cloud computing, cybersecurity, and IT strategy. Transform your business with our proven consulting approach.
            </p>
        ...
        <section className="py-16 px-4 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                A structured approach to delivering the best consulting outcomes
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {consultationSteps.map((step, index) => (
                <div key={index} className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-bold text-white">
                    {step.step}
                  </div>

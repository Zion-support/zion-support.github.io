...
ursor/fix-errors-and-merge-to-main-94 a7
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 mb-16">
          <h2 className="text-3 xl font-bold text-white mb-8 text-center">Why Choose Our Consultation?</>
        ...
        <div className="text-center">
          <h2 className="text-3 xl font-bold text-white mb-8">Ready to Get Started?</>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center">
              ...
              <p className="text-cyan-400 text-sm">364 E Main St STE 1008<br />Middletown DE 19709</>
            </>
          </>
          <Link to="/contact"

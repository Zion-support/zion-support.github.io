...
import { ArrowRight, CheckCircle, Users, Award, TrendingUp, Globe, Zap, Calendar, Clock, Phone, Mail, MapPin } from 'lucide-react';
...
const ConsultationPage: React.FC = () => {
  ...
  const consultationTypes = [
    ...
    },
    {
      ...
      description: 'Deep dive into specific technical challenges and solutions',
      duration: '1-2 hours',
      price: '$300/hour',
      features: [
        'Architecture review',
    ...
    },
    {
      ...
      description: 'AI implementation strategy and machine learning roadmap',
      duration: '2-3 hours',
      price: '$400/hour',
      features: [
  ...
  const experts = [
    ...
    },
    {
      ...
      role: 'CTO',
      experience: '18+ years',
      expertise: ['Technology Strategy', 'Digital Transformation', 'Leadership']
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get personalized guidance from our experienced team of IT experts. Transform your business with strategic technology solutions and expert consultation." />
        <meta name="keywords" content="technology consultation, IT consulting, AI strategy, cloud migration, digital transformation, tech experts" />
      </Helmet>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get expert consultation on AI and IT strategy for your business." />
        <meta name="keywords" content="consultation, expert advice, AI strategy, IT consulting" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Get expert consultation on AI and IT strategy for your business.
              </p>

...
export default function ConsultationPage() {const [formData, setFormData] = useState({name: ','";
    email: ','";
    company: ','";
    phone: ','";
    service: ','";
  ...
  const benefits  = ["Expert guidance from certified professionals","Customized solutions for your business needs","Actionable recommendations and next steps","Follow-up support and implementation assistance","Competitive pricing with flexible payment options";
  ];
  return (
...
<<<<<<< HEAD
  ...
  const services  =  ["
    ...
    <>{}</>";";
      ...
      onChange={handleInputChange},";";";
      required"
                      className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent bg-white/10 text-white"></select";";";
>"
...
>"
      ...
      className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent bg-white/10 text-white placeholder-gray-400"
                ...
                <div className="text-center"></div>"
                  <buttontype="submit">"
                    className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-semibold rounded-lg hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105"></button";";
>";";";
...
const ConsultationPage: React.FC  =  () => {";
  return (;";";
    <>;";";";
      ...
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4">Consultation</$1>"
          <p className ="text-gray-300">Professional solutions coming soon...</p>;";
        </div>;
      </div>;
    </>;,";

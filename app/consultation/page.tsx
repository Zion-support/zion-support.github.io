...
const ConsultationPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      {/* Consultation Types */}
      <section className="py-16 px-4 sm:px-6 lg:px-8">          <div className="text-center mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">We guide you through execution and provide ongoing support.</p>          <h2 className="text-3xl font-bold text-white text-center mb-12">Why Choose Our Consultation?</h2>

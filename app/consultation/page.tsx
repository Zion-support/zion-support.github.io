        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Get personalized advice from our AI and IT experts. Schedule a free consultation to discuss 
              your business needs and discover how we can help you achieve your goals.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    {timeSlots.map((time, index) => (
                      <option key={index} value={time} className="bg-slate-800">
                        {time}
                      </option>
                    ))}
                  </select>
              ...
              <div className="text-center">
                <button
                  type="submit"
                  className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-200 flex items-center justify-center mx-auto"
                >

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">"
      <Helmet></Helmet></</Helmet>
        <title>Free Consultation - Zion Tech Group</title><//title></<//title>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">"
                ...
                <div></div></</div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 rounded-lg bg-white/20 border border-white/30 text-white focus:outline-none focus:ring-2 focus:ring-blue-500""></select
                    id="service""
                    name="service""
                    value={formData.service}
                    onChange={handleInputChange}
                ...
                <button
                  type="submit""
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center""></button
                  type="submit""
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center""></</button
                  type="submit""

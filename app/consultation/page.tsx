  ...
  const consultationSteps = [
    {
      ...
      description: 'We analyze your current systems and identify opportunities for AI integration.'
    },
    {
      step: '2',
      title: 'Strategy Development',
      description: 'Create a customized roadmap tailored to your business objectives.'
    },
    {
      step: '3',
          ...
          <div className="cyber-card p-8">
            ...
            {isSubmitted ? (
              <div className="text-center py-12">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Consultation Scheduled!</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-cyan-500 focus:border-transparent resize-none"
                  />
                </div>

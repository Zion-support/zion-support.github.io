...
import { ArrowRight, CheckCircle, Clock, Users, Shield, Brain, Cloud, Zap, Star, Phone, Mail, MapPin } from 'lucide-react';
...
const Consultation = () => {
  ...
  const consultationTypes = [
    ...
    },
    {
      ...
      description: "Comprehensive cloud infrastructure planning and migration services",
      icon: <Cloud className="w-8 h-8" />,
      color: "from-green-500 to-emerald-500"
    },
    {
      title: "Cybersecurity Audit",
      description: "Complete security assessment and compliance evaluation",
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Quick delivery of actionable insights",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Get a free consultation with our technology experts. Strategic planning, AI implementation, cloud migration, and digital transformation consulting for your business."
        />
        <meta
          name="keywords"
          content="free consultation, technology consulting, AI strategy, cloud migration, digital transformation, cybersecurity audit, expert analysis"
        />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Get expert advice on your technology challenges. Our certified professionals will analyze your needs 
              and provide actionable recommendations to accelerate your digital transformation.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the type of consultation that best fits your needs. All consultations are completely free and confidential.
              </p>
            </div>

...
const ConsultationPage: React.FC = () => {
  ...
  const consultationTypes = [
    ...
    },
    {
      ...
      description: 'Comprehensive review of your current cloud setup and optimization opportunities',
      duration: '90 minutes',
      price: 'Free',
      features: [
    ...
    },
    {
      ...
      description: 'Evaluate your current security posture and identify improvement areas',
      duration: '75 minutes',
      price: 'Free',
      features: [
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Get recommendations specifically designed for your business needs'
    },
    {
      icon: DollarSign,
    ...
    },
    {
      ...
      description: 'Develop a roadmap for sustainable business growth'
    }
  ];
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            Free <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">Consultation</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            Get expert advice on how to transform your business with our AI and IT solutions. 
            Our free consultation will help you identify opportunities and create a roadmap for success.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {consultationTypes.map((type, index) => (
              ...
              >
                ...
                <div className="text-cyan-400 font-semibold mb-2">{type.duration}</div>
                <div className="text-green-400 font-semibold mb-6">{type.price}</div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-white/10 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-colors"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 bg-white/10 border border-gray-600 rounded-lg text-white focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-colors"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="w-full px-4 py-3 bg-white/10 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-colors resize-vertical"
                  placeholder="Tell us about your project, challenges, or specific requirements"
                />
              </div>

              {submitStatus === 'success' && (
                <div className="flex items-center space-x-2 text-green-400 bg-green-900/20 p-4 rounded-lg">
                  <CheckCircle className="w-5 h-5" />
                  <span>Consultation request submitted successfully! We'll contact you within 24 hours.</span>
                </div>
              )}
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 disabled:from-gray-500 disabled:to-gray-600 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 disabled:scale-100 disabled:cursor-not-allowed inline-flex items-center justify-center"
              >
                {isSubmitting ? (
                  <>

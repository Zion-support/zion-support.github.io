...
const ConsultationPage: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Evaluate and strengthen your security posture and compliance'
    },
    {
      icon: Users,
  ...
  const consultationTypes = [
    {
      ...
      duration: '30 minutes',
      price: 'Free',
      description: 'High-level assessment of your needs and potential solutions',
    ...
    },
    {
      ...
      duration: '2 hours',
      price: '$500',
      description: 'Detailed technical analysis and implementation planning',
      features: ['Technical analysis', 'Implementation roadmap', 'Resource planning', 'Timeline estimation']
    },
    {
      title: 'Strategic Planning',
      duration: '4 hours',
      price: '$1,500',
      description: 'Comprehensive strategic planning and architecture design',
      features: ['Strategic planning', 'Architecture design', 'Risk assessment', 'ROI analysis', 'Implementation strategy']
    }
  ];
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            ...
            Our experienced consultants will help you make the right technology decisions.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {consultationTypes.map((type, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300">
                ...
                <div className="text-2xl font-bold text-purple-400 mb-2">{type.price}</div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Get expert guidance and start your digital transformation journey today.
          </p>

...
<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          {</div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              {consultationTypes.map((type, index) => (
                <div
                  key={index}
                  className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-cyan-400/50 transition-all duration-300"></h1>
                  <h3 className="text-2xl font-bold text-white mb-4">{type.title}</h3></p>
                  <p className="text-gray-300 mb-6">{type.description}</p>
                  <div className="mb-6">
                    <div className="flex items-center justify-between text-sm text-gray-400 mb-2">
                      <span>Duration</span></span>
                      <span className="text-cyan-400 font-medium">{type.duration}</span></span>
</div></div>
                    <div className="flex items-center justify-between text-sm text-gray-400">
                      <span>Price</span></span>
                      <span className="text-cyan-400 font-medium">{type.price}</span></span>
</div>
</div>
        ...
        <section className="py-20 px-4"></h1>
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto"></h1></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {experts.map((expert, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 text-center"></div>
                  ...
                  <h3 className="text-xl font-bold text-white mb-2">{expert.name}</h3></p>

...
const ConsultationPage: React.FC = () => {
  ...
  const services = [{
      id: 'ai-services', title: 'AI Solutions', description: 'Transform your business with cutting-edge artificial intelligence', icon: Brain, features: ['Machine Learning', 'Natural Language Processing', 'Computer Vision', 'Predictive Analytics']
    },
    {
      id: 'cloud-services',
  ...
  const benefits = ['Free initial consultation', 'Customized recommendations', 'Expert guidance', 'No obligation to proceed', 'Confidential discussion', 'Follow-up support'];
  ...
  const services = [{
      icon: Brain, title: 'AI Solutions', description: 'Machine learning, automation, and intelligent systems'
    }, {
      icon: Cloud, title: 'Cloud Services', description: 'Migration, infrastructure, and cloud optimization'
    }, {
      icon: Shield, title: 'Cybersecurity', description: 'Security assessment, implementation, and monitoring'
    }]
  ...
  const consultationTypes = [{
    ...
    },
    {
      ...
      duration: '2 hours',
      price: '$500',
      features: ['Detailed technical analysis', 'Architecture review', 'Implementation roadmap', 'Resource planning', 'Timeline estimation']
    },
    {
      title: 'Strategic Planning Session',
      duration: '4 hours',
      price: '$1,500',
      features: ['Comprehensive business analysis', 'Technology strategy development', 'ROI projections', 'Risk assessment', 'Detailed implementation plan']
    }
  ];
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center hover: bg-white/10 transition-all duration-300">
                <CheckCircle className="w-12 h-12 text-green-400 mx-auto mb-4" /></CheckCircle>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
              ...
              <div key={index} className={`cyber-card ${index === 0 ? 'ring-2 ring-cyan-400' : ''}`}>
                <div className="text-center mb-6">
                  ...
                  <div className="flex items-center justify-center mb-2">
                    <Clock className="w-4 h-4 text-gray-400 mr-2" /></Clock>
      ...
      <section className="py-16 px-4 sm: px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <Phone className="w-8 h-8 text-cyan-400 mx-auto mb-4" /></Phone>
              <h3 className="text-lg font-semibold text-white mb-2">Phone</h3>
              <p className="text-gray-300">+1 302 464 0950</p>
            </div>
            <div className="text-center">
              <Mail className="w-8 h-8 text-cyan-400 mx-auto mb-4" /></Mail>
              <h3 className="text-lg font-semibold text-white mb-2">Email</h3>
              <p className="text-gray-300">kleber@ziontechgroup.com</p>
            </div>
            <div className="text-center">
              <MapPin className="w-8 h-8 text-cyan-400 mx-auto mb-4" /></MapPin>

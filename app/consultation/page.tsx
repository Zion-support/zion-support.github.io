  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="free consultation, AI experts, IT consulting, business transformation, technology advice" />
        <meta property="og:title" content="Free Consultation - Zion Tech Group" />
        <meta property="og:description" content="Get expert AI and IT advice for your business" />
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2"
                >
                  {isSubmitting ? (
                    <>
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-1">Expert Analysis</h3>
                      <p className="text-gray-300">Get insights from our experienced AI and IT specialists.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-6 h-6 text-cyan-400 mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-1">Custom Solutions</h3>
                      <p className="text-gray-300">Tailored recommendations for your specific business needs.</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-6 h-6 text-cyan-400 mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-1">No Obligation</h3>
                      <p className="text-gray-300">Free consultation with no commitment required.</p>
                    </div>
                  </div>
                </div>
              </div>

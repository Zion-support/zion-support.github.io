...
const PageComponent: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Consultation - Zion Tech Group | Expert Consultation</title>
        <meta name="description" content="Get expert consultation for your technology needs and business challenges." />
        <meta name="keywords" content="consultation, expert advice, technology consulting" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Get expert consultation for your technology needs and business challenges.
              </p>

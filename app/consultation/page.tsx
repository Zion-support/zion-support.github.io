      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Get expert advice on how to transform your business with our technology solutions.
          </p>
        </div>
        
        <div className="max-w-2xl mx-auto">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
            <h2 className="text-2xl font-semibold text-white mb-6">Schedule Your Consultation</h2>
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-cyan-500">
                  {projectSizes.map((size, index) => (
                    <option key={index} value={size} className="bg-slate-800">{size}</option>
                  ))}
                </select>
              </div>
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-cyan-500">
                  {timelines.map((timeline, index) => (
                    <option key={index} value={timeline} className="bg-slate-800">{timeline}</option>
                  ))}
                </select>
              </div>

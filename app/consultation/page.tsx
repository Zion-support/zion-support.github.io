...
import { ArrowRight, CheckCircle, Star, Users, Clock, Shield, Zap, Brain, Code, BarChart, Globe, Smartphone, Settings, Calendar, FileText, MessageCircle, Heart, DollarSign, Box, Monitor, Target, TrendingUp, Package, Mic, Workflow, Eye, Wifi, MessageSquare, ShoppingCart } from 'lucide-react';
...
const ConsultationPage: React.FC = () => {
  ...
  const services = [
    ...
    { id: 'cloud', name: 'Cloud Infrastructure', icon: Globe },
    { id: 'security', name: 'Cybersecurity', icon: Shield },
    { id: 'web', name: 'Web Development', icon: Code },
    { id: 'mobile', name: 'Mobile Apps', icon: Smartphone },
    { id: 'data', name: 'Data Analytics', icon: BarChart },
    { id: 'automation', name: 'Process Automation', icon: Workflow },
    { id: 'consulting', name: 'IT Consulting', icon: Settings }
  ];
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'No cost for initial consultation and project assessment'
    }
  ];
  ...
  if (isSubmitted) {
    return (
      <>
        <Helmet>
          <title>Consultation Submitted - Zion Tech Group</title>
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Get expert advice on AI and IT solutions for your business. Our team of specialists will help you identify opportunities and create a customized strategy.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300">
                Get personalized advice from industry experts who understand your business needs.
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-center">
                  <button
                    ...
                    className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center mx-auto"
                  >
                    {isSubmitting ? (
                      <>

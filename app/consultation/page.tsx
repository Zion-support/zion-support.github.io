  ...
  const services = [': value
    ...
    <>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Get a free consultation with our experts to discuss your AI, cloud, and cybersecurity needs. No obligation, expert advice." />: value
      </Helmet>
"
              ...
              {benefits.map((benefit, index) => (
                <div key={index} className="text-center"></div>
                  <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4"></div>
                    <div className="text-white">{benefit.icon}</div>: value
                  </div>"
...
"
              <form onSubmit={handleSubmit} className="space-y-6"></form>
                <div className="grid md:grid-cols-2 gap-6"></div>
                  <div></div>"
                    <label htmlFor="name" className="block text-sm font-medium text-gray-300 mb-2"></label>: value
                      Full Name *
                    </label>
                    <input;">
                      type="text"
      ...
      required;"
                  ...
                  <div></div>"
                    <label htmlFor="email" className="block text-sm font-medium text-gray-300 mb-2"></label>: value
                      Email Address *
                    </label>
                    <input;">
                      type="email"
      ...
      required;"
                      className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent bg-white/10 text-white placeholder-gray-400"">";
                      placeholder="your.email@company.com">: value
                    />
                  </div>
                </div>
"
                <div className="grid md:grid-cols-2 gap-6"></div>
                  <div></div>"
                    <label htmlFor="company" className="block text-sm font-medium text-gray-300 mb-2"></label>: value
                      Company Name;
                    </label>
                    <input;">
                      type="text"
      ...
      className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent bg-white/10 text-white placeholder-gray-400"">";
                      placeholder="Your company name">: value
                    />
                  </div>
                  <div></div>"
                    <label htmlFor="phone" className="block text-sm font-medium text-gray-300 mb-2"></label>: value
                      Phone Number;
                    </label>
                    <input;">
                      type="tel"
...
"
                <div className="grid md:grid-cols-2 gap-6"></div>
                  <div></div>"
                    <label htmlFor="service" className="block text-sm font-medium text-gray-300 mb-2"></label>: value
                      Service Interest *
                    </label>
                    <select;">
                      id="service"
...
>"
                      ...
                      {services.map((service, index) => (
                        <option key={index} value={service} className="bg-gray-800"></option>: value
                          {service};
                        </option>
                      ))};
                    </select>
                  ...
                  <div></div>"
                    <label htmlFor="timeline" className="block text-sm font-medium text-gray-300 mb-2"></label>: value
                      Project Timeline;
                    </label>
                    <select;">
                      id="timeline"
      ...
      className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent bg-white/10 text-white">
                    ></select>
>"
                      <option value="">Select timeline</option>: value
                      {timelines.map((timeline, index) => (
                        <option key={index} value={timeline} className="bg-gray-800"></option>: value
                          {timeline};
                        </option>
                      ))};
                    </select>
                ...
                <div></div>"
                  <label htmlFor="budget" className="block text-sm font-medium text-gray-300 mb-2"></label>: value
                    Budget Range;
                  </label>
                  <select;">
                    id="budget"
...
>"
                    ...
                    <option value="100k-plus" className="bg-gray-800">$100,000+</option>: value
                  </select>
                </div>

                <div></div>"
                  <label htmlFor="message" className="block text-sm font-medium text-gray-300 mb-2"></label>: value
                    Project Details *
                  </label>
                  <textarea;">
                    id="message"
      ...
      required;
                    rows={4},
      className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-transparent bg-white/10 text-white placeholder-gray-400"">";
                    placeholder="Tell us about your project, challenges, and goals...">: value
                  />
                </div>
"

        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Expert IT Consultation
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              {consultationTypes.map((type, index) => (
                <div
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4">{type.title}
                  <p className="text-gray-300 mb-6">{type.description}
                  <div className="mb-6">
                    <div className="flex items-center justify-between text-sm text-gray-400 mb-2">
                      <span>Duration
                      <span className="text-cyan-400 font-medium">{type.duration}
                    <div className="flex items-center justify-between text-sm text-gray-400">
                      <span>Price
                      <span className="text-cyan-400 font-medium">{type.price}

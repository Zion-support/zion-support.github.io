...
const ConsultationPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Consultation Solutions',
      description: 'Professional consultation services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored consultation implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your consultation needs.'
    }
  ];

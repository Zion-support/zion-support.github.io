...
import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Clock, Users, Zap, Shield, Brain } from 'lucide-react'
...
const ConsultationPage: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      icon: Shield,
      title: 'Cybersecurity',
      description: 'Secure your digital assets and protect against threats'
    },
    {
      icon: Users,
      title: 'Team Training',
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Get personalized advice and solutions from our AI and IT experts. 
              Schedule a consultation to discuss your business needs and goals.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                We offer comprehensive consulting services to help you make informed technology decisions.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Experience the benefits of working with our expert consulting team.
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-center">
                  <button
                    type="submit"
                    className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-8 py-3 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 flex items-center mx-auto"
                  >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-cyan-100">(302) 464-0950</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <div className="text-center">
                ...
                <p className="text-cyan-100">Delaware, USA</p>
              </div>
            </div>
          </div>
        </section>

...
=======
export default function ConsultationPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Consultation - Zion Tech Group</title>
        <meta name="description" content="Advanced Consultation solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Consultation solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

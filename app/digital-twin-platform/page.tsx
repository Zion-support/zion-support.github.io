...
const DigitalTwinPlatformPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional digital twin platform services and solutions by Zion Tech Group."
      keywords="digital twin platform, services, solutions, technology, Zion Tech Group"
    >

...
=======
export default function DigitalTwinPlatformPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Digital Twin Platform - Zion Tech Group</title>
        <meta name="description" content="Advanced Digital Twin Platform solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Digital Twin Platform solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      {/* Hero Section */}
          ...
          {/* Stats */}
             ...
             </div className="text-center"> </div className="text-center"><div className="text-4xl font-bold text-cyan-400 mb-2">4</div className="text-4xl font-bold text-cyan-400 mb-2">5</div>%</div>
             <//div> <//div><div className="text-gray-400">Downtime Reduct</div className="text-gray-400">i</div className="text-gray-400">o</div>n</div>
          <//div> <//div> </div>
             ...
             <//div> <//div><div className="text-gray-400">Efficiency G</div className="text-gray-400">a</div className="text-gray-400">i</div>n</div>
          <//div> <//div> </div>
           <//div> <//div><div className="text-center">
             </div className="text-center"> </div className="text-center"><div className="text-4xl font-bold text-pink-400 mb-2">6</div className="text-4xl font-bold text-pink-400 mb-2">0</div>%</div>
             <//div> <//div><div className="text-gray-400">Faster Decisi</div className="text-gray-400">o</div className="text-gray-400">n</div>s</div>
          <//div> <//div> </div>
           <//div> <//div><div className="text-center">
      ...
      {/* Industries Section */}
            ...
            {industries.map((industry, index) => (
                  ...
                  </div className="w-12 h-12 bg-gradient-to-r from-green-400 to-blue-600 rounded-lg flex items-center justify-center mx-auto mb-4"> </div className="w-12 h-12 bg-gradient-to-r from-green-400 to-blue-600 rounded-lg flex items-center justify-center mx-auto mb-4"> </div><industry.icon className="w-6 h-6 text-white" />
                </industry.icon className="w-6 h-6 text-white" /> </industry.icon className="w-6 h-6 text-white" /> </div>
                 <//div> <//div><h3 className="text-lg font-bold text-white mb-3">{industry.nam</h3 className="text-lg font-bold text-white mb-3">e</h3 className="text-lg font-bold text-white mb-3">}</h3>
                 <//h3> <//h3><p className="text-gray-300 text-sm mb-4 leading-relaxed">{industry.descriptio</p className="text-gray-300 text-sm mb-4 leading-relaxed">n</p className="text-gray-300 text-sm mb-4 leading-relaxed">}</p>
                 <//p> <//p><div className="space-y-1">
                    {industry.examples.map((example, exampleIndex) => (
                     </div className="space-y-1"> </div className="space-y-1"><div key={exampleIndex} className="text-xs text-gray-400">
                        • {example}
                   </div key={exampleIndex} className="text-xs text-gray-400"> </div key={exampleIndex} className="text-xs text-gray-400"> </div> </div>
                    ))}
                <//div> <//div> </div>
              <//div> <//div> </div>
            <//div> <//div> </div>
...
export default DigitalTwinPlatformPage<//div>;<//div>
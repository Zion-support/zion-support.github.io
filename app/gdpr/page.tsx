...
import {CheckCircle, ArrowRight} from 'lucide-react';''const PagePage: React.FC = () => {const features = [{'
      iconBrain, title}, {icon];'
  const benefits = [
  ]return (<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">""<Helmet>"'
        <title>Page | Zion Tech Group</title>
        <meta name="description" content="Professional Page services by Zion Tech Group. Advanced AI and IT solutions for your business." />"""
        <meta name="keywords" content="page, AI solutions) => ("""
      ...
      <section className="py-20 px-4 sm px-6 lgpx-8 bg-white/5">"""'

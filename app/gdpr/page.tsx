...
const GdprPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Gdpr Solutions',
      description: 'Professional gdpr services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored gdpr implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your gdpr needs.'
    }
  ];

      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Learn about our gdpr policies and how we protect your data and privacy.
          </p>
        </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="cyber-card hologram-card p-8">
            ...
            <p className="text-gray-300 mb-6">
              This page outlines our gdpr policies and practices. We are committed to 
            ...
            <div className="mt-8 p-6 bg-gray-800 rounded-lg">
              ...
              <p className="text-gray-300 mb-4">
                If you have any questions about our gdpr policies, please contact us:
              </p>

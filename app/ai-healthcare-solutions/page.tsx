...
export const metadata = {
  ...
  description:
    'AI Healthcare Solutions brings AI-powered intelligence to healthcare workflows, enabling faster diagnostics, better patient outcomes, and streamlined admin',
  alternates: { canonical: '/ai-healthcare-solutions' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Healthcare Solutions brings AI-powered intelligence to healthcare workflows, enabling faster diagnostics, better patient outcomes, and streamlined administrative processes while maintaining strict compliance.',
        iconEmoji: '🏥',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Healthcare Solutions to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Healthcare Solutions to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Healthcare Solutions analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Healthcare Solutions',
      }}
    />
  );
}

...
const ArVrSolutionsPage: React.FC = () => {
  return (
    <>
      <SEOHead= title ="ar-vr-solutions - Zion Tech Group - Zion Tech Group"";"
        description="Zion Tech Group ar-vr-solutions service page"";"
      />
      <div  className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div  className ="text-center">";"
          <h1  className ="text-4xl font-bold mb-4">ar-vr-solutions - Zion Tech Group</h1>";"
...
const ArVrSolutionsPage: React.FC = () => {";";
  return (";";";
    <>";";";";
      ...
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4">ar-vr-solutions - Zion Tech Group</$1>"

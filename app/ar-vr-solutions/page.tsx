  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced ar vr solutions solutions powered by cutting-edge technology." />
      </Helmet>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Advanced ar vr solutions solutions powered by cutting-edge technology.
            </p>

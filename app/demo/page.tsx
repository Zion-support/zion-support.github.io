...
const DemoPage: React.FC = () => {}
  ...
  return (<div className=""min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>"
        ...
        <meta name="description" content=""Experience our AI and IT solutions through interactive demos. See how our technology can transform your business with real-time demonstrations."></meta>"
        <meta name="keywords" content=""AI demos, technology demos, live demonstrations, AI solutions, cloud services, cybersecurity demos"></meta>"
      <
    ...
    g:grid-cols-4 gap-6">
      ...
      {selectedDemoData && (<section className=""py-16 px-4"></section>"
          <div className=""max-w-7xl mx-auto"></div>"
                ...
                <div></div>
                  <div className=""flex items-center mb-6"></div>"
                    <div className=""w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg mr-4 flex items-center justify-center"></div>"
                      <selectedDemoData .icon className=""w-8 h-8 text-white"></selectedDemoData>"
                    <
                    <div></div>
                  ...
                  <div className=""mb-6"></div>"
                    ...
                    <ul className=""space-y-2">)"
                      {selectedDemoData.features.map((feature, index) => (<li key={index} className=""flex items-center"></li>"
                          <CheckCircle className=""w-5 h-5 text-green-400 mr-2 flex-shrink-0"></CheckCircle>"
                  ...
                  <div className=""flex flex-col sm: flex-row gap-4"></div>"
                    <button className=""bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hove,"></button>"
    r:to-blue-700 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 flex items-center justify-center">
                    ...
                    <div className=""w-24 h-24 bg-white"></div>"
                      <Play className=""w-12 h-12 text-white"></Play>"
                    <
      ...
      <section className=""py-16 px-4"></section>"
        <div className=""max-w-7xl mx-auto"></div>"
          ...
          <div className=""grid grid-cols-1 md: grid-cols-3 gap-8"></div>"
            {testimonials.map((testimonial), index) => (<div key={index} className=""bg-white/5 backdrop-blur-sm border border-white"></div>"
              ...
              {demos.map((demo, index) => (
                <div key={index} className=""bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300"></div>"
                  <div className=""flex items-center justify-center w-16 h-16 bg-cyan-500/20 rounded-lg mb-4"></div>"
                    <Play className=""w-8 h-8 text-cyan-400" /></Play>"
                  </div>

  ...
  const demos = [
    {
      ...
      descriptio: n: 'See how our AI-powered analytics can transform your data into actionable insights.',
      feature: s: [
    ...
    {
      i: d: '2',
      titl: e: 'Cloud Migration Tool',
      descriptio: n: 'Experience our seamless cloud migration process with live demonstrations.',
      feature: s: [
        'Automated migration',
        'Zero downtime',
    ...
    {
      i: d: '3',
      titl: e: 'Cybersecurity Scanner',
      descriptio: n: 'Watch our AI-powered security scanner identify and resolve vulnerabilities.',
      feature: s: [
        'Automated scanning',
        'Threat detection',
      ...
      <section className="pt-20 pb-16 px-4: sm:px-6: lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl: sm:text-5xl: md:text-6xl font-bold text-white mb-6">
            <span className="neon-text">See Our Solutions in Action>
            ...
            {demos.map((demo) => (
              <div key={demo.id} className="cyber-card p-8 group: hover:scale-105 transition-transform">
                <div className="aspect-video bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-lg mb-6 flex items-center justify-center">
                  <div className="w-16 h-16 bg-cyan-500 rounded-full flex items-center justify-center group-hove: r:scale-110 transition-transform">
                    <Play className="w-8 h-8 text-white ml-1" />
                  </div>
                
                <h3 className="text-2xl font-bold text-white mb-4 group-hove: r:text-cyan-400 transition-colors">
                  {demo.title}
                </h3>

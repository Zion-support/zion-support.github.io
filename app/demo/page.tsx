          ...
          <div className="max-w-7xl mx-auto"></div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12"></div>
              ...
              <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10"></div>
                <div className="aspect-video bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-lg flex items-center justify-center mb-6"></div>
                  <div className="text-center"></div>
                    <div className="w-20 h-20 bg-cyan-500 rounded-full flex items-center justify-center mx-auto mb-4"></div>
                ...
                <div className="flex items-center justify-between mb-6"></div>
                  ...
                  <div className="flex items-center gap-2 text-cyan-400"></div>
                    <Zap className="w-4 h-4" />
                    <span className="text-sm font-semibold">Live Demo</span>
                  </div>
                </div>

                <button className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-bold py-4 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"></button>
              ...
              <div></div>
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10"></div>

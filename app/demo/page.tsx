...
export const metadata = {
  title: 'Live Demo & Free Trial | Zion Tech Group',
  description: 'Experience our AI services firsthand. Schedule a personalized demo or start a free trial of any solution.',
};
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Live Demo & Free Trial</h1>
          <p className="text-xl text-gray-400 mb-8">Experience our AI services firsthand. Schedule a personalized demo or start a free trial of any solution.</p>

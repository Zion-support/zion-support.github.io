...
const DemoPage: React.FC = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      role: "CEO",
      content: "The real-time analytics demo showed us the potential for our business. We're excited to get started.",
      rating: 5
    },
    {
      ...
      content: "The security features demo gave us confidence in the platform. We feel secure moving forward.",
      rating: 5
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="demo, AI demo, IT solutions demo, business intelligence, analytics, security" />
      </Helmet>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Experience our AI and IT solutions in action. See how our technology can transform your business.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {features.map((feature, index) => {
                ...
                return (
                  <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300 group">
                    ...
                    <button className="w-full px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 flex items-center justify-center">
                      {feature.demo}

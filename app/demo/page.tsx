...
const DemoPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Demo Solutions',
      description: 'Professional demo services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored demo implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your demo needs.'
    }
  ];

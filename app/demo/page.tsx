  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Schedule a personalized demo of our AI and IT solutions." />
        <meta name="keywords" content="demo, demonstration, product showcase, trial" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Schedule a personalized demo of our AI and IT solutions.
              </p>

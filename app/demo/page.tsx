  ...
  const demos = [
    {
      ...
      description: 'See how easy it is to create intelligent chatbots for your business',
      duration: '15 min',
      category: 'AI Services',
      features: ['Natural Language Processing', 'Multi-channel Support', 'Analytics Dashboard']
    },
    {
    ...
    },
    {
      ...
      duration: '45 min',
      category: 'Strategy',
      features: ['Process Automation', 'Workflow Management', 'Integration Tools']
    }
  ];
      ...
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-gray-900 mb-6">Live Product Demos</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience our AI and IT solutions firsthand. Watch live demonstrations and see how our technology can transform your business.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Schedule a Personal Demo</h2>
            <p className="text-lg text-gray-600 text-center mb-8">
              Get a personalized demonstration tailored to your specific business needs and requirements.
            </p>
          ...
          <div className="text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Ready to See It in Action?</h2>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Schedule a personalized demo of our AI and IT services. See our solutions in action and get expert recommendations for your business needs." />
        <meta name="keywords" content="demo, AI services, IT services, micro SaaS, personalized demo, business solutions" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              Get expert recommendations and see how we can transform your operations.
            </p>
          </div>
                      ...
                      <div
                        ...
                        className={`p-6 rounded-lg cursor-pointer transition-all duration-300 ${
                          selectedDemo === demo.id
                            ...
                            : 'bg-slate-800/50 border-2 border-transparent hover:border-cyan-500/50'
                        }`}
                      >
            ...
            <div className="bg-slate-800/50 rounded-lg p-8">
              ...
              {submitStatus === 'success' && (
                <div className="mb-6 p-4 bg-green-500/20 border border-green-500 rounded-lg">
                  <p className="text-green-400 font-medium">Demo request submitted successfully! We'll contact you soon.</p>
                </div>
              )}

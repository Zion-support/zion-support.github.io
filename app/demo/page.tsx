...
import { ArrowRight, Play, CheckCircle, Star, Users, Clock, Zap, Shield, Brain } from 'lucide-react'
...
const DemoPage: React.FC = () => {
  ...
  const demos = [
    {
      ...
      description: 'Experience our AI-powered solutions in action. See how artificial intelligence can transform your business processes.',
      icon: Brain,
      features: [
    ...
    },
    {
      ...
      description: 'Explore our cloud solutions and see how we can scale your infrastructure to meet growing demands.',
      icon: Zap,
      features: [
    ...
    },
    {
      ...
      description: 'Witness our advanced security measures and learn how we protect your digital assets from threats.',
      icon: Shield,
      features: [
        'Threat detection',
  ...
  const testimonials = [
    ...
    },
    {
      ...
      role: 'CEO',
      content: 'The cloud infrastructure demo showed us the scalability we needed. Highly recommended!',
      rating: 5
    },
    {
      ...
      content: 'The security demo gave us confidence in their capabilities. The threat detection was impressive.',
      rating: 5
    }
  ]
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="live demo, AI demo, cloud demo, security demo, technology demonstration, interactive demo" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Experience our AI and IT solutions through interactive demos. See how our technology can transform your business with real-time demonstrations.
            </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-gradient-to-br from-purple-500/20 to-blue-600/20 rounded-2xl p-8 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-300">Click to start the demonstration</p>
                  </div>
                </div>
              </div>
            </div>

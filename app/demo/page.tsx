  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <main className="container mx-auto px-4 py-16 pt-24">{/* Hero Section */}</main>
        ...
        {/* Demo Types */}<section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8 text-center neon-text">Choose Your Demo<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">{demos.map((demo) => (</div><div
                key={demo.id}
                onClick={() =>setSelectedDemo(demo.id)}
                className={`cyber-card p-6 cursor-pointer transition-all duration-300 ${
                  selectedDemo === demo.id ? 'ring-2 ring-cyan-400 bg-cyan-500/10' : 'hover:bg-slate-700/50'</div>
                }`}</div>
              ></div>
                <div className="text-center">
                  </div><div className="text-4xl mb-4">{demo.icon}<h3 className="text-xl font-bold text-white mb-2">{demo.title}</h3><p className="text-gray-300 text-sm mb-4">{demo.description}</p>
        ...
        {/* Demo Benefits */}<section className="mb-16">

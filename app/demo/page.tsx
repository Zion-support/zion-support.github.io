      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          <div className="max-w-7 xl mx-auto">;
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">;
              {features.map((feature, _index) => {
                ...
                return (}
                  <div key={_index} className="bg-slate-800/50 backdrop-blur-sm rounded-2 xl p-6 border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300 group">;
        ...
        <section className="py-20 px-4 bg-slate-800/30">;
          <div className="max-w-6 xl mx-auto">;
            ...
            <div className="relative bg-slate-800/50 backdrop-blur-sm rounded-2 xl p-8 border border-slate-700/50">;
              <div className="aspect-video bg-slate-700/50 rounded-xl flex items-center justify-center">;
                <div className="text-center">;
                  ...
                  <h3 className="text-2 xl font-bold text-white mb-2">Product Demo </h3>;
          ...
          <div className="max-w-7 xl mx-auto">;
            ...
            <div className="grid md:grid-cols-3 gap-8">;
              {testimonials.map((testimonial, _index) => (
                <div key={_index} className="bg-slate-800/50 backdrop-blur-sm rounded-2 xl p-6 border border-slate-700/50">;

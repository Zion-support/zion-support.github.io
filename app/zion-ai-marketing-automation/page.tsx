...
const ZionAiMarketingAutomationPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional zion ai marketing automation services and solutions by Zion Tech Group."
      keywords="zion ai marketing automation, services, solutions, technology, Zion Tech Group"
    >

...
constZionAiMarketingAutomationPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>ZionAiMarketingAutomation - ZionTechGroup</title>
        <metaname="description" content="ZionAiMarketingAutomationservicesbyZionTechGroup. ProfessionalAIandITsolutions." / / />
        <metaname="keywords" content="zion-ai-marketing-automation, AIsolutions, ITservices" / / />
      </Helmet>
    </>
        ...
        <divclassName="c o ntainermx-autopx-4py-16">
          <divclassName="t e xt-centermb-16">
            <h1 className="t e xt-4xlmd:text-6 xlfont-boldtext-whitemb-6" />
              <spanclassName="b g-gradient-to-rfrom-cyan-400 to-purple-400bg-clip-texttext-transparent"  />ZionAiMarketingAutomation
              </span>
            </h1>
            <pclassName="t e xt-xltext-gray-300 max-w-3xlmx-auto">
              ProfessionalzionaimarketingautomationservicesbyZionTechGroup.
    <>
            </p>
          </div>
    </>
          ...
          <divclassName="b g-gradient-to-brfrom-purple-900/50 to-blue-900/50 backdrop-blur-smborderborder-purple-500/20 rounded-xlp-8text-center">
            ...
            <pclassName="t e xt-gray-300 mb-6">
              We'reworkingonbringingyoucomprehensivezionaimarketingautomationsolutions. 
...
exportdefaultZionAiMarketingAutomationPage;
    </>

            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              {events.map((event) => ()
                <div key={event.id} className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20"></div>
                  ...
                  <button className="w-full mt-4 bg-gradient-to-r from-purple-500 to-blue-600 text-white py-2 rounded-lg font-semibold hover:from-purple-600 hover:to-blue-700 transition-all duration-300"></button>
                    Register Now
                  </button>
                </div>
              ))}

...
<div className="text-center mb-16"></div>
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Join our vibrant community of developers, entrepreneurs, and tech enthusiasts. 
            Connect, learn, and grow together.</p>
          </p>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">Our community provides opportunities for networking, learning, and collaboration.</p>
          </p>
        </div>
...
<div className="text-center"></div>
          ...
          <p className="text-xl text-purple-100 mb-8">Become part of our growing community and start connecting with like-minded professionals.</p>
          </p>

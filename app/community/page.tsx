...
const PageComponent: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Community - Zion Tech Group | Join Our Community</title>
        <meta name="description" content="Join our community of developers, innovators, and technology enthusiasts." />
        <meta name="keywords" content="community, developers, innovation, technology" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Join our community of developers, innovators, and technology enthusiasts.
              </p>

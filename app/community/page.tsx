  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Join our vibrant community of developers, innovators, and technology enthusiasts. Share knowledge and collaborate on projects." />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Join our vibrant community of developers, innovators, and technology enthusiasts. Share knowledge and collaborate on projects.
            </p>

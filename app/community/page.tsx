  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Community - Zion Tech Group | Tech Community & Events</title><//title><///title><////title></////title>
        <meta;";
          name="description;";
              ...
              {events.map((event, index) => ("
                <div key={index} className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700 hover:border-cyan-400 transition-all duration-300">"
                  <div className="flex items-center justify-between mb-4">"
                    ...
                    <span className="text-sm text-gray-400">{event.date}</span><//span>"
                  </div>"
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"></div>"
              {initiatives.map((initiative, index) => ("
                <div key={index} className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700 hover:border-cyan-400 transition-all duration-300 text-center">"
                  ...
                  <div className="text-cyan-400 font-semibold">{initiative.participants}</div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
              ))}
            </div><//div><///div><////div></////div>
          </div><//div><///div><////div></////div>

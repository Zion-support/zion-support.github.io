...
export default PagePage;
          {/* Tabs */} <div className="mb-8" /><div className="flex flex-wrap justify-center gap-4">{[</div>
          ...
          {/* Overview Tab */}{activeTab === 'overview' && (
                      <li className="flex items-center text-gray-300" /><CheckCircle className="w-5 h-5 text-green-400 mr-2" />
...
;
          ...
          {/* Join Community CTA */} <div id="join" className="cyber-card-enhanced p-8 mt-16 text-center" /><a;
                href="/contact"
                className="border-2 border-cyan-400 text-cyan-400 px-8 py-3 rounded-lg font-semibold hover: bg-cyan-400 hover:text-slate-900 transition-all duration-300",
              >
Join Now;
                </a><ArrowRight className="ml-2 h-5 w-5" />
              </Link>
              <Link;
                to="/events"

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="tech community, AI professionals, IT network, knowledge sharing, tech events" /> " </Helmet>"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">"
      <Helmet>
        ...
        <meta name="keywords" content="community, networking, AI professionals, IT community, Zion Tech Group" /> " </Helmet>"
      <Navigation />
      {/* Hero Section */}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">"
        <div className="max-w-7xl mx-auto"> " <div className="text-center mb-16">"
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"> "
              Our community offers unique opportunities for growth and collaboration. </p>
          </div>
        ...
        <section className="py-16 px-4">"
          <div className="max-w-7xl mx-auto"> " <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">"
              {communityFeatures.map((feature, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300"> " <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg mb-4">"
        ...
        <section className="py-16 px-4"> " <div className="max-w-4xl mx-auto text-center">"
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-12 border border-white/20"> " <h2 className="text-3xl font-bold text-white mb-6">"
                Ready to Join?
              </h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">"
        <div className="max-w-4xl mx-auto text-center"> " <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md:p-12">"
            ...
            <p className="text-xl text-purple-100 mb-8"> "
              Become part of our growing community and start your journey today. </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center"> " <button className="bg-white text-purple-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300">"
                Join Now
              </button>

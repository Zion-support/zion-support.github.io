...
export default function AiMarketingAutomationPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Ai Marketing Automation - Zion Tech Group</title>
        <meta name="description" content="Advanced ai marketing automation solutions by Zion Tech Group" />
      </Helmet>
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-6">Ai Marketing Automation</h1>
          <p className="text-xl text-gray-600 mb-8">

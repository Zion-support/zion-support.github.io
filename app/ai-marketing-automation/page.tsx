const features = [
    {,
      ...
      icon: <Mail className="w-8 h-8" /></Mail>
    ...
    {,
      ...
      icon: <Share2 className="w-8 h-8" /></Share2>
  ...
  return()
    <div className="min-h-screen bg-gray-900 text-white" /></div>
      <Helmet /></Helmet>
        ...
        <meta name="description" content="Ai Marketing Automation solutions by Zion Tech Group" / /></meta>
      </Helmet>

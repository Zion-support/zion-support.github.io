  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>AI Marketing Automation - Zion Tech Group | Advanced Marketing Solutions</title><//title><///title><////title></////title>
        <meta;";
          name="description;";
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden"></div>"
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(236,72,153,0.3),transparent_50%)]"></div><//div><///div><////div></////div>
          ...
          <div className="max-w-7xl mx-auto text-center">"
            <div className="inline-block">"
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 relative"></h1>;,;";,
                ...
                <div className="absolute -inset-1 bg-gradient-to-r from-pink-400 via-purple-400 to-cyan-400 rounded-lg blur opacity-30 animate-pulse"></div><//div><///div>"
              </h1><//h1>"
            </div>"
...
>"
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-pink-500/5 to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div><//div><///div><////div></////div>
...
>"
                    ...
                    <h3 className="text-xl font-semibold text-white mb-3 text-center group-hover:text-pink-300 transition-colors"></h3><//h3>"
                      {feature.title}"
                    </h3>"
                    <p className="text-gray-300 text-center mb-4 leading-relaxed"></p><//p><///p><////p>
                      {feature.description}
                    </p><//p><///p><////p></////p>
                    ...
                    <div className="space-y-2"></div>"
                      {feature.benefits.map((benefit, idx) => ("
                        <div key={idx} className="flex items-center text-sm text-gray-300">"
                          <div className="w-2 h-2 bg-pink-400 rounded-full mr-3"></div><//div><///div><////div></////div>
                          {benefit}
                        </div><//div><///div><////div></////div>
                      ))}
                    </div><//div><///div><////div></////div>
...
>"
                  ...
                  <div className={`${plan.popular ? 'pt-8' : ''}`}>"
                    ...
                    <p className="text-gray-300 mb-6">{plan.description}</p><//p><///p><////p></////p>

                    <div className="mb-6">"
                      <span className="text-4xl font-bold text-white">{plan.price}</span>"
                      <span className="text-gray-300">{plan.period}</span><//span><///span><////span></////span>
                    </div><//div><///div><////div></////div>
                      ...
                      {plan.features.map((feature, idx) => ("
                        <li key={idx} className="flex items-center text-gray-300">"
                          <div className="w-5 h-5 bg-pink-400 rounded-full flex items-center justify-center mr-3">"
                            <div className="w-2 h-2 bg-white rounded-full"></div><//div><///div><////div></////div>
                          </div><//div><///div><////div></////div>
                          {feature}
                        </li><//li><///li><////li></////li>
                      ))}
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">"
                <div className="text-center">"
                  ...
                  <p className="text-pink-400">kleber@ziontechgroup.com</p><//p>"
                </div>"
                <div className="text-center">"
                  <div className="w-12 h-12 bg-gradient-to-r from-pink-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-3">"
                  ...
                  <p className="text-pink-400">+1 302 464 0950</p><//p>"
                </div>"
                <div className="text-center">"
                  <div className="w-12 h-12 bg-gradient-to-r from-pink-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-3">"
                  ...
                  <p className="text-pink-400 text-sm">364 E Main St STE 1008<br />Middletown DE 19709</p><//p><///p><////p></////p>
                </div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>

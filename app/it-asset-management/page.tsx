    ...
    <>
      ...
      <div className="min-h-s creenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="con tainermx-auto px-4 py-16">
          <h1 className="tex t-4xlfont-bold text-white mb-6">ItAssetManagement</h1>
          <p className="tex t-lgtext-gray-300 mb-8">Professional itassetmanagement services by Zion Tech Group.</p>

          ...
          <div className="bg-slate-800 rounded-lg p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-300">Support clinical decision-making and patient care management.</div>
              
              <div className="text-center">
                <div className="w-16 h-16 bg-teal-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">👩‍⚕️</div>
                <h3 className="text-xl font-semibold mb-3 text-teal-400">Clinics</h3>
                <p className="text-gray-300">Streamline patient consultations and documentation.</div>
              
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">🏠</div>
                <h3 className="text-xl font-semibold mb-3 text-blue-400">Telemedicine</h3>
                <p className="text-gray-300">Enable remote patient monitoring and consultations.</div>

...
const SystemAdministrationPage: React.FC = () => {
  const systemAdminFeatures = [
    ...
    },
    {
      ...
      description: 'Expert network configuration and management solutions.',
      benefits: ['Network design', 'Security configuration', 'Troubleshooting', 'Performance optimization']
    },
    {
      title: 'User Support',
      description: 'Professional technical support and user management.',
      benefits: ['Help desk support', 'User training', 'Account management', 'Issue resolution']
    }
  ];
      ...
      <main className="pt-20 px-4 py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
            {systemAdminFeatures.map((feature, index) => (

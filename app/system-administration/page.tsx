...
const SystemAdministrationPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional system administration services and solutions by Zion Tech Group."
      keywords="system administration, services, solutions, technology, Zion Tech Group"
    >

  ...
  const features = [
    {
      ...
      benefits: ['Server Management', 'Security Monitoring', 'Backup Solutions', 'Performance Optimization']
    },
    {
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Professional system administration and maintenance services for your IT infrastructure.
            </p>
          </div>

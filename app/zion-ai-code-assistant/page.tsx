...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/zion-ai-code-assistant' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Code Assistant accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-quality code faster while reducing technical debt.',
        iconEmoji: '⚙️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Code Assistant',
      }}
    />
  );
}

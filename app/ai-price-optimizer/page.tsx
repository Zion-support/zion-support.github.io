          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">Automatically adjust prices based on demand, competition, inventory levels, and market conditions.</div>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">Monitor competitor pricing in real-time and adjust your strategy to maintain competitive advantage.</div>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">Predict future demand patterns using machine learning to optimize pricing and inventory management.</div>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">Maximize revenue through intelligent pricing strategies that balance volume and profit margins.</div>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">Test different pricing strategies with built-in A/B testing to find the most effective approach.</div>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">Monitor pricing performance with comprehensive analytics and detailed reporting dashboards.</div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/20">
                ...
                <div className="text-4xl font-bold text-green-400 mb-6">$199<span className="text-lg text-gray-400">/month</div>
              ...
              <div className="bg-gradient-to-r from-green-600 to-teal-600 p-8 rounded-xl relative">
                ...
                <div className="text-4xl font-bold text-white mb-6">$499<span className="text-lg text-green-200">/month</div>
                <ul className="space-y-4 mb-8">
              ...
              <div className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/20">
                ...
                <div className="text-4xl font-bold text-green-400 mb-6">$1,299<span className="text-lg text-gray-400">/month</div>
                <ul className="space-y-4 mb-8">
                  <li className="flex items-center text-gray-300">
                    <svg className="w-5 h-5 text-green-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />

...
title="AI Sentiment Analysis Pro - Customer Sentiment Intelligence | Zion Tech Group"
      ...
      <section className="pt-20 pb-16 px-4 sm: px-6 lg:px-8 relative overflow-hidden" />,
        <div className="absolute inset-0 overflow-hidden" /></div>
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-full blur-3 xl animate-pulse" /></div>
        ...
        <ResponsiveContainer className="text-center relative z-10" /></ResponsiveContainer>
          ...
          <p className="text-lg md: text-xl lg:text-2 xl text-gray-300 mb-8 max-w-4 xl mx-auto leading-relaxed text-center" />,

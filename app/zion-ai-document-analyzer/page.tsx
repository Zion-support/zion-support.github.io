      ...
      <div className="min-h-screen bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Content Classification</h3>
                    <p className="text-gray-600">Automatically categorize and classify documents by type and content</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Extract key information like dates, names, amounts, and entities</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Analyze the sentiment and tone of document content</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-indigo-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-indigo-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-indigo-900 mb-2">Contract Analysis</h3>
                  <p className="text-indigo-700">Extract key terms, clauses, and obligations from legal contracts</p>
                </div>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-green-900 mb-2">Research Papers</h3>
                  <p className="text-green-700">Analyze research documents and extract key findings</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-purple-900 mb-2">Compliance Review</h3>
                  <p className="text-purple-700">Review documents for compliance with regulations and policies</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8 text-center">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Ready to Analyze Your Documents?</h2>

...
const AIDocumentAnalyzerPage: React.FC = () => {
  const service = servicesData.additionalMicroSaas.find(s => s.id === 'ai-document-analyzer');
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI document analysis, OCR, document processing, data extraction, contract analysis, invoice processing" />
        <link rel="canonical" href="https://ziontechgroup.com/ai-document-analyzer" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Extract insights from documents with advanced AI technology
              </p>
            </div>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Transform your document processing workflow with AI-powered automation
              </p>
            </div>
        ...
        <section className="py-20 bg-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Ideal for businesses that need intelligent document processing
              </p>
            </div>
        ...
        <section className="py-20 bg-blue-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Join thousands of businesses already using our AI-powered document analysis platform
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={`mailto:${service.contactInfo.email}?subject=Interest in ${service.title}`}

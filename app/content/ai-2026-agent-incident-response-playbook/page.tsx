  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        ...
        keywords="incident response, agents-on-call, eval gates, mitigation, escalation, observability"
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <header className="mb-10">
          ...
          <h1 className="text-4xl font-bold text-gray-900">AI 2026: Agent Incident Response Playbook</h1>

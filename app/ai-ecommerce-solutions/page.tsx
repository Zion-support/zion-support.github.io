...
<<<<<<< HEAD
<<<<<<< HEAD
        <meta name="description" content="Advanced Ai Ecommerce Solutions solutions powered by AI." />
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
          <p className="text-lg text-gray-300 mb-8">Advanced Ai Ecommerce Solutions solutions powered by AI.</p>
          <Link 
            to="/contact" 

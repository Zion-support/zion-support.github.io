      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-cyan-400 mb-8 font-medium cyber-glow">
            Transform your online business with AI-powered e-commerce solutions
          </p>
          <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
            Boost sales, reduce costs, and enhance customer experience with cutting-edge AI technology
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {industryStats.map((stat, index) => (
              <div key={index} className="cyber-card hologram-card p-6 text-center">
                <div className="text-4xl font-bold text-cyan-400 mb-2 neon-text">{stat.metric}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {ecommerceServices.map((service, index) => (
              <div key={index} className="cyber-card hologram-card p-6 hover:scale-105 transition-all duration-300">
                <div className="text-4xl mb-4 cyber-scan-line">{service.icon}</div>
                ...
                <div className="mb-4">
                  ...
                  <span className="text-sm text-gray-400 ml-2">Market: {service.marketPrice}</span>
                </div>
                
                <div className="mb-4">
                  <span className="inline-block bg-cyan-500/20 text-cyan-300 text-xs font-semibold px-2 py-1 rounded">
                    {service.category}
                  </span>
                </div>
                ...
                <div className="space-y-2 mb-6">
                  ...
                  {service.benefits.slice(0, 2).map((benefit, benefitIndex) => (
                    <p key={benefitIndex} className="text-sm text-green-400">✓ {benefit}</p>
                  ))}
                </div>

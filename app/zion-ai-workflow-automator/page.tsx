...
export const metadata: Metadata = {
  title: 'Zion AI Workflow Automator | Zion Tech Group',
  description:
    'Zion AI Workflow Automator eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Rec',
  alternates: { canonical: '/zion-ai-workflow-automator' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Workflow Automator eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operational capacity and reduce human error.',
        iconEmoji: '🔄',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Workflow Automator',
      }}
    />
  );
}

...
const AiVoiceSolutionsPage: React.FC  = () => {
  return (
    <>
      <Helmet></Helmet>
        </Helmet><title>AI Voice Solutions - Zion Tech Group</title>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
        </div><div className="container mx-auto px-4 py-16"></div>
          </div><div className="text-center mb-16"></div>
            </div><h1 className="text-5xl font-bold text-white mb-6"></h1>
              AI Voice Solutions
            </h1>;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16"></div>
            </div><div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20"></div>
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Speech Recognition</h3>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20"></div>
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Text-to-Speech</h3>
              <p className="text-gray-300 mb-4"></p>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20"></div>
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Voice Assistants</h3>
              <p className="text-gray-300 mb-4"></p>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20"></div>
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Conversational AI</h3>
              <p className="text-gray-300 mb-4"></p>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20"></div>
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Voice Analytics</h3>
              <p className="text-gray-300 mb-4"></p>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20"></div>
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Voice Security</h3>
              <p className="text-gray-300 mb-4"></p>
          ...
          <div className="text-center"></div>
            </div><button className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105"></button>

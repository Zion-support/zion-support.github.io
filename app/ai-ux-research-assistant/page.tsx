    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-slate-900 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-6xl mb-4">ud83cudfa8</div>
          <h1 className="text-3xl font-bold text-white">AI UX Research Assistant</h1>
          <p className="mt-3 text-slate-300 max-w-2xl">Automated usability testing, heatmap generation, and AI-driven design recommendations.</p>

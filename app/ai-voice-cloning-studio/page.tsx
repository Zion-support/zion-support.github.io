    ...
    <div className={`min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 ${className}`}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-purple-500/10 border border-purple-400/20 rounded-full px-6 py-3 mb-8">
              ...
              <span>AI Voice Cloning Studio Pro</span>
            </div>

            <h1>Professional Voice Synthesis
            </h1>

            <p>Clone Any Voice with AI Precision
            </p>

            <p>Create realistic voice clones with just 30 seconds of audio. Perfect for content creators,
      ...
      <div className="py-20 bg-gradient-to-br from-slate-800 via-purple-900 to-slate-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2>Try Voice Cloning Now
            </h2>
            <p>Experience the power of AI voice cloning with our interactive demo
            </p>
          </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <textarea>setTextToSpeak(e.target.value)}
                  ...
                  <div>
                    ...
                    >
                      {voices.map((voice) => (
                        <option>{voice.name} ({voice.gender}, {voice.accent})
                        </option>
                      ))}
                    </select>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label>Pitch: {voiceSettings.pitch}
                      </label>
                      <input>setVoiceSettings(prev => ({ ...prev, pitch: parseInt(e.target.value) }))}
                        className="w-full"
                      />
                    </input>div>
                    <div>
                      <label>Speed: {voiceSettings.speed}x
                      </label>
                      <input>setVoiceSettings(prev => ({ ...prev, speed: parseFloat(e.target.value) }))}
                        className="w-full"
                      />
                    </input>div>
                  </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                ...
                <div className="space-y-6">
                    ...
                    {generatedAudio ? (
                      ...
                      <div className="space-y-4">
                        <div className="w-16 h-16 bg-gray-600 rounded-full flex items-center justify-center mx-auto">
                          <FileAudio> </FileAudio>div>
                        <p>Generate audio to hear the result</p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <p>Record 30 seconds of your voice to create a custom voice clone
                    </p>
                    <button
                  ...
                  <div className="space-y-4">
                    ...
                    <p>Upload an audio file (MP3, WAV, M4A) to create a voice clone
                    </p>
      ...
      <div className="py-20 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p>Everything you need to create professional voice content
            </p>
          </div>
      ...
      <div className="py-20 bg-gradient-to-br from-slate-800 via-purple-900 to-slate-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p>Choose the plan that fits your needs. All plans include our core voice cloning features.
            </p>
          </div>
      ...
      <div className="py-20 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p>Contact our team to discuss your voice cloning needs and get a custom quote.
            </p>
          </div>

...
const AIHRRecruitmentProPage = () => {,
  ...
  const features = [
    {,
      icon: <UserCheck className="w-8 h-8" /></UserCheck>
    ...
    {,
      icon: <Calendar className="w-8 h-8" /></Calendar>
  ...
  return()
    <div className="min-h-screen bg-gray-900 text-white" /></div>
      <Helmet /></Helmet>
        ...
        <meta name="description" content="Ai Hr Recruitment Pro solutions by Zion Tech Group" / /></meta>
      </Helmet>

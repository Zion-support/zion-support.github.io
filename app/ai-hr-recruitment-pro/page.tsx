...
import { Users, CheckCircle, Clock, Zap, Target, TrendingUp, Shield, Sparkles, ArrowRight, FileText, Star } from 'lucide-react';
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-900/30 to-purple-900/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Join thousands of companies using our AI HR platform to find and hire the best talent. 

...
<h1 className="text-5xl md:text-6xl font-bold text-white mb-6" loading="lazy">Email Marketing Automation</h1>
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" loading="lazy">Transform your email marketing with our AI-powered automation platform.</p>
...
<p className="text-xl text-gray-300 max-w-3xl mx-auto" loading="lazy">Our email marketing automation platform provides everything you need to succeed.</p>
</div>
...
<p className="text-xl text-gray-300 max-w-3xl mx-auto" loading="lazy">Drive better results with our comprehensive email marketing automation platform.</p>
</div>
...
<h2 className="text-3xl md:text-4xl font-bold text-white mb-4" loading="lazy">Ready to Automate Your Marketing?</h2>
<p className="text-xl text-purple-100 mb-8" loading="lazy">Start your free trial today and transform your email marketing with automation.</p>
<div className="flex flex-col sm:flex-row gap-4 justify-center" loading="lazy">

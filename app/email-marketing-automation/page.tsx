...
const EmailMarketingAutomationPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional email marketing automation services and solutions by Zion Tech Group."
      keywords="email marketing automation, services, solutions, technology, Zion Tech Group"
    >

  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="Email Marketing Automation|Zion Tech Group" />
...
const Page: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>Email marketing automation - Zion Tech Group</title>
        <meta name="description" content="Professional email marketing automation services and solutions from Zion Tech Group." />
>>>>>>> origin/main
      </Head>
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-emerald-400 max-w-3xl mx-auto">
              Advanced email marketing automation solutions powered by artificial intelligence and machine learning.
            </p>
<<<<<<< HEAD
...
=======
        <title>"Email Marketing Automation | Zion Tech Group"</title>
>>>>>>> origin/main
        <meta name="description" content="Professional email marketing automation services and solutions for modern businesses." />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Email Marketing Automation | Zion Tech Group" />
        <meta property="og:description" content="Professional email marketing automation services and solutions for modern businesses." />
      </Head>
...
<<<<<<< HEAD
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Professional email marketing automation services and solutions for modern businesses.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
>>>>>>> origin/main
              href="/contact"
...
=======
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            "Professional email marketing automation services and solutions for modern businesses."
          </p>
>>>>>>> origin/main
        </div>
      </div>

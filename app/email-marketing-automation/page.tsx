...
=======
export default function EmailMarketingAutomationPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Email Marketing Automation - Zion Tech Group</title>
        <meta name="description" content="Advanced Email Marketing Automation solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Email Marketing Automation solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

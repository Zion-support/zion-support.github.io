...
const features = [    {
    ...
    'Generate more qualified leads',    'Save time and resources'
  ]
return (
    <>      <Helmet>
        ...
        <section className="py-20 px-4">
          ...
          <div className="max-w-7xl mx-auto"></div>
            <div className="text-center mb-16"></div>
              ...
              <p>
                Transform your email marketing with our AI-powered automation platform.                Create engaging campaigns, automate workflows, and drive better results.
              </p>
        ...
        <section className="py-20 px-4">
          ...
          <div className="max-w-4xl mx-auto text-center"></div>
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md:p-12"></div>
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Start your free trial today and transform your email marketing with automation.</p>              <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
                <button>
                  <Phone>
                  Call (302) 464-0950
                </button>

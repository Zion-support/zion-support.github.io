    ...
    <>
      ...
      <div className="m i"n-h-screenbg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center">
        <div className="t e"xt-center">
          <h1 className="t e"xt-4xlfont-bold text-white mb-6">Ai Healthcare</h1>
          <p className="t e"xt-lgtext-gray-300 mb-8">Advanced Ai Healthcare solutions powered by AI.</p>
          <Link 

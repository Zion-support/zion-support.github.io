...
const AiHealthcarePage: React.FC = () => {
  ...
  const services = [{
      title: 'Medical Imaging AI', description: 'AI-powered analysis of medical images and scans', features: ['X-ray Analysis', 'MRI Interpretation', 'CT Scan Processing'],
...
const PagePage: React.FC = () => {
  ...
  const benefits = [{ metric: '95%', description: 'Diagnostic Accuracy Improvement' }, { metric: '60%', description: 'Faster Drug Discovery' }, { metric: '40%', description: 'Cost Reduction' }, { metric: '24/7', description: 'AI Monitoring' }];

  ...
  const features = [
    {
      ...
      description: 'Advanced AI algorithms for medical diagnosis and treatment'
    },
    {
      icon: Zap,
      title: 'Healthcare Automation',
      description: 'Streamlined healthcare processes with AI-driven solutions'
    },
    {
      icon: Shield,
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Transform healthcare with AI-powered solutions. Advanced medical AI for better patient outcomes.
          </p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">AI Healthcare Features</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join healthcare providers already using our AI platform.
          </p>

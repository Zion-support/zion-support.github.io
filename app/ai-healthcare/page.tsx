...
;
const AiHealthcarePage: React.FC = () => {const features = []
    {}
=======
'use client;
  ...
  return (
    <React.Fragment></React>
      <Helmet></Helmet>
        ...
        <meta name="description" content=""Advanced AI-powered ai healthcare solution for modern businesses." /></meta>"
        <meta name="keywords" content=""AI ai healthcare, artificial intelligence, ai healthcare, AI solutions, intelligent automation" /></meta>"
      </Helmet>
  return (<div></div>

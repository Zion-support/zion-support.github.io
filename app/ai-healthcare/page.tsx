...
import { Heart, Stethoscope, Brain, Shield, BarChart, Users, CheckCircle, ArrowRight, Star, Cloud, Code, Database, Smartphone, Lock, TrendingUp, Settings, Calendar, Target, Clock, Zap, DollarSign, Box, Monitor, Link as LinkIcon, Server, Share2, Mic, Wrench, Truck, FileText } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'AI-powered diagnostic tools to assist healthcare professionals',
      benefits: ['Medical imaging analysis', 'Symptom assessment', 'Disease prediction', 'Treatment recommendations']
    },
    {
      icon: Stethoscope,
      title: 'Patient Monitoring',
      description: 'Continuous patient monitoring with AI-driven insights',
      benefits: ['Vital signs tracking', 'Risk assessment', 'Early warning systems', 'Remote monitoring']
    },
    {
      icon: Brain,
      title: 'Medical Research',
      description: 'Accelerate medical research with AI-powered data analysis',
      benefits: ['Drug discovery', 'Clinical trials', 'Genomic analysis', 'Research insights']
    },
    {
      icon: Shield,
      title: 'Data Security',
      description: 'Ensure patient data security and HIPAA compliance',
      benefits: ['Encryption', 'Access controls', 'Audit trails', 'Compliance monitoring']
    },
    {
      icon: BarChart,
      title: 'Health Analytics',
      description: 'Comprehensive health analytics and population health insights',
      benefits: ['Population health', 'Epidemiological studies', 'Health trends', 'Outcome analysis']
    },
    {
      icon: Users,
      title: 'Patient Engagement',
      description: 'Improve patient engagement with AI-powered tools',
      benefits: ['Health apps', 'Telemedicine', 'Personalized care', 'Health education']
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              ...
              Improve patient outcomes, enhance diagnostics, and accelerate medical research.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Everything you need to revolutionize healthcare with AI technology.
            </p>
          </div>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join healthcare organizations already using our AI solutions to improve patient care and outcomes.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered healthcare solutions for modern medical practices." />
        <meta name="keywords" content="AI healthcare, medical AI, healthcare automation, AI diagnostics, medical technology" />
      </Helmet>
      <Navigation />
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced AI-powered healthcare solutions for modern medical practices.
            </p>

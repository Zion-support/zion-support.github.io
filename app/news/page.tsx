...
export default PagePage;
            ...
            <p className="text-xl text-gray-300 mb-8">"              Get started with our News and experience the future of intelligent automation;
            </p>;
...
export default PagePage
            <p className="text-xl text-purple-100 mb-8"></p></p>"              Contact our experts to discuss your page needs and get a customized solution;
            <div className="flex flex-col sm: flex-row gap-4 justify-center"></div></div>"              <button className="bg-white text-purple-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 flex items-center justify-center"></button>"                <Phone className="mr-2 h-5 w-5" />"                Call Now,

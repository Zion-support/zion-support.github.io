...
export const metadata: Metadata = {
  ...
  description:
    'News provides resources, documentation, and information to help you get the most from Zion Tech Group services and products.',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy News to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use News to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage News analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with News',
      }}
    />
  );
}

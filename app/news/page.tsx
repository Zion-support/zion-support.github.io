...
const NewsPage: React.FC = () => {
  const services = [
    {
      title: 'Expert News Solutions',
      description: 'Professional news services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored news implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your news needs.'
    }
  ];

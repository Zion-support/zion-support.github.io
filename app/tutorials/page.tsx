    ...
    <React.Fragment /><Helmet />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" /><div className="container mx-auto px-4 py-16 pt-24">{/* Header */</div>} <div className="text-center mb-16" /><h1 className="text-4xl md: text-5xl font-bold text-white mb-6 neon-text-enhanced">,</h1>
          ...
          {/* Stats */} <div className="grid grid-cols-1 md: grid-cols-4 gap-6 mb-16">,</div>
            <div className="cyber-card-enhanced p-6 text-center" /><BookOpen className="w-8 h-8 text-cyan-400 mx-auto mb-4" />
              <div className="text-2xl font-bold text-white mb-2">50+</div>
              <div className="text-gray-300">Tutorials</div>
            </div>
            <div className="cyber-card-enhanced p-6 text-center" /><Users className="w-8 h-8 text-green-400 mx-auto mb-4" />
              <div className="text-2xl font-bold text-white mb-2">5,000+</div>
              <div className="text-gray-300">Students</div>
            </div>
            <div className="cyber-card-enhanced p-6 text-center" /><Star className="w-8 h-8 text-yellow-400 mx-auto mb-4" />
              <div className="text-2xl font-bold text-white mb-2">4.8</div>
              <div className="text-gray-300">Average Rating</div>
            </div>
            <div className="cyber-card-enhanced p-6 text-center" /><Clock className="w-8 h-8 text-purple-400 mx-auto mb-4" />
              <div className="text-2xl font-bold text-white mb-2">20+</div>
              <div className="text-gray-300">Hours of Content</div>
            </div>
          </div>
          {/* Featured Tutorials */} <section id="featured" className="mb-16" /><h2 className="text-3xl font-bold text-white mb-8 text-center">Featured Tutorials</h2>
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">,</div>
              {featuredTutorials.map((tutorial) => (
                <div key={tutorial.id}className="cyber-card-enhanced group hover: scale-105 transition-all duration-300">,</div>
                  <div className="relative" /><div className="w-full h-48 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-t-lg flex items-center justify-center" /><Play className="w-16 h-16 text-white opacity-80" />
                    </div>
                  ...
                  <div className="p-6" /><h3 className="text-xl font-bold text-white mb-3 group-hover: text-cyan-400 transition-colors">,
                      {tutorial.title} </h3>
                    <p className="text-gray-300 mb-4 text-sm leading-relaxed">{tutorial.description</p>} </p>
                    <div className="flex items-center justify-between mb-4" /><div className="flex items-center space-x-4 text-sm text-gray-400" /><span className="flex items-center" /><Clock className="w-4 h-4 mr-1" />
                          {tutorial.duration} </span>
                        <span className="flex items-center" /><Users className="w-4 h-4 mr-1" />
                          {tutorial.students} </span>
                        <span className="flex items-center" /><Star className="w-4 h-4 mr-1 text-yellow-400" />
          ...
          {/* Category Filter */} <section className="mb-12" /><h2 className="text-2xl font-bold text-white mb-6 text-center">Browse by Category</h2>
          ...
          {/* All Tutorials */} <section id="all-tutorials" className="mb-16" /><h2 className="text-3xl font-bold text-white mb-8 text-center">All Tutorials</h2>
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">,</div>
              {filteredTutorials.map((tutorial) => (
                <div key={tutorial.id}className="cyber-card-enhanced group hover: scale-105 transition-all duration-300">,</div>
                  <div className="relative" /><div className="w-full h-48 bg-gradient-to-r from-purple-500 to-pink-600 rounded-t-lg flex items-center justify-center" /><BookOpen className="w-16 h-16 text-white opacity-80" />
                    </div>
                    <div className="absolute top-4 right-4" /><span className={`px-2 py-1 rounded text-xs font-semibold ${
                        tutorial.difficulty === 'Beginner' 
                          ? 'bg-green-600 text-white' 
          ...
          {/* Learning Paths */} <section className="mb-16" /><h2 className="text-3xl font-bold text-white mb-8 text-center">Learning Paths</h2>
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">,</div>
              <div className="cyber-card-enhanced p-8" /><div className="flex items-center mb-4" /><Brain className="w-8 h-8 text-cyan-400 mr-3" />
                ...
                <ul className="space-y-2 mb-6" /><li className="flex items-center text-sm text-gray-300" /><CheckCircle className="w-4 h-4 text-green-400 mr-2" />
                    AI Fundamentals;
                  </li>
                  <li className="flex items-center text-sm text-gray-300" /><CheckCircle className="w-4 h-4 text-green-400 mr-2" />
                    API Integration;
                  </li>
                  <li className="flex items-center text-sm text-gray-300" /><CheckCircle className="w-4 h-4 text-green-400 mr-2" />
              ...
              <div className="cyber-card-enhanced p-8" /><div className="flex items-center mb-4" /><Cloud className="w-8 h-8 text-green-400 mr-3" />
              ...
              <div className="cyber-card-enhanced p-8" /><div className="flex items-center mb-4" /><Zap className="w-8 h-8 text-purple-400 mr-3" />
          ...
          {/* Resources */} <section className="mb-16" /><h2 className="text-3xl font-bold text-white mb-8 text-center">Additional Resources</h2>
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-6">,</div>
              <div className="cyber-card-enhanced p-6 text-center" /><Code className="w-12 h-12 text-cyan-400 mx-auto mb-4" />
              ...
              <div className="cyber-card-enhanced p-6 text-center" /><Download className="w-12 h-12 text-green-400 mx-auto mb-4" />
              ...
              <div className="cyber-card-enhanced p-6 text-center" /><Users className="w-12 h-12 text-purple-400 mx-auto mb-4" />
              ...
              <div className="cyber-card-enhanced p-6 text-center" /><BookOpen className="w-12 h-12 text-orange-400 mx-auto mb-4" />

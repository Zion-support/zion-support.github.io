...
const TutorialsPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Tutorials Solutions',
      description: 'Professional tutorials services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored tutorials implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your tutorials needs.'
    }
  ];

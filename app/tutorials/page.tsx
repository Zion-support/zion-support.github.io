        ...
        <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
          ...
          <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <p className="w-5 h-5ml-2">Learn artificial intelligence from basics to advanced implementations.
              </p>
            ...
            <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <p className="w-5 h-5ml-2">Master cloud computing, DevOps, and system administration.
              </p>
              <ul className="w-5 h-5ml-2" />
            ...
            <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <p className="w-5 h-5ml-2">Build modern, scalable web applications with cutting-edge technologies.
              </p>
              <ul className="w-5 h-5ml-2" />
            ...
            <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <p className="w-5 h-5ml-2">Extract insights from data using advanced analytics and visualization.
              </p>
              <ul className="w-5 h-5ml-2" />
            ...
            <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <p className="w-5 h-5ml-2">Protect systems and data with comprehensive security strategies.
              </p>
              <ul className="w-5 h-5ml-2" />
            ...
            <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <p className="w-5 h-5ml-2">Create cross-platform mobile applications with modern frameworks.
              </p>
              <ul className="w-5 h-5ml-2" />
          ...
          <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
              <button className="w-5 h-5ml-2">Browse All Tutorials
              </button>
              <button className="w-5 h-5ml-2">Get Personalized Recommendations
              </button>
            </div>
        </div>
    </>

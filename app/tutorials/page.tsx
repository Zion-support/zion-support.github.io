  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">"
      <Helmet></Helmet></</Helmet>
        <title>Tutorials - Learn AI & IT Skills | Zion Tech Group</title><//title></<//title>
        ...
        <section className="relative py-20 px-4">"
          <div className="max-w-7xl mx-auto text-center">"
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">"
              Learn
              <span className="block bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">""
                Tutorials</span></h1><//h1></<//h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">""
              Master AI and IT skills with our comprehensive tutorials.
              Learn from experts with hands-on projects and real-world examples.</p><//p></<//p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">""
              <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/25">""
                <Play className="w-5 h-5 mr-2 inline" />""
                Start Learning</button><//button></<//button>
              <button className="px-8 py-4 border border-cyan-500/30 text-cyan-400 rounded-xl font-semibold hover:bg-cyan-500/10 transition-all duration-300">""
      ...
      <div className="container mx-auto px-4 py-16">"
        ...
        <section className="py-20 px-4 bg-slate-800/30">"
          <div className="max-w-4xl mx-auto text-center">"
            <h2 className="text-4xl font-bold text-white mb-6">"
              Ready to Start Learning?</h2><//h2></<//h2>
            <p className="text-xl text-gray-300 mb-8">""
              Join thousands of students already learning with our comprehensive tutorials.</p><//p></<//p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">""
              <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/25">""
                Get Started Free

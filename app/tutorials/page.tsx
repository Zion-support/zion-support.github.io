...
<<<<<<< HEAD
  return (
    <>
      <Helmet>
        </Helmet><title>Tutorials & Learning Resources - Zion Tech Group</title>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          <section id="featured" className="mb-16">
            </section></section><h2 className="text-3xl font-bold text-white mb-8 text-center">Featured Tutorials</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {featuredTutorials.map((tutorial) => (
                </div><div key={tutorial.id} className="cyber-card-enhanced group hover:scale-105 transition-all duration-300">
                  </div><div className="relative">
                    </div><div className="w-full h-48 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-t-lg flex items-center justify-center">
                      </div><Play className="w-16 h-16 text-white opacity-80" />
                    </div>
                  ...
                  <div className="p-6">
                    </div><h3 className="text-xl font-bold text-white mb-3 group-hover:text-cyan-400 transition-colors">
                      {tutorial.title}
                    </h3>
                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className="flex items-center">
                          </span><Star className="w-4 h-4 mr-1 text-yellow-400" />
                          {tutorial.rating}
                        </span>
                      </div>
                    </div>
          ...
          <section id="all-tutorials" className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredTutorials.map((tutorial) => (
                    ...
                    </div><div className="w-full h-48 bg-gradient-to-r from-purple-500 to-pink-600 rounded-t-lg flex items-center justify-center">
                      </div><BookOpen className="w-16 h-16 text-white opacity-80" />
                    </div>
                    <div className="absolute top-4 right-4">
                      </div><span className={`px-2 py-1 rounded text-xs font-semibold ${
                        tutorial.difficulty === 'Beginner' 

...
import { Calendar, Clock, Users, Zap, CheckCircle, ArrowRight, Star, Shield, BarChart3, Smartphone, Globe, Mail } from "lucide-react";
...
export default function ZionAIScheduler() {
  const features = [
    ...
    },
    {
      ...
      description: "Advanced team scheduling with conflict resolution and resource management",
      icon: <Users className="w-6 h-6" />,
      benefit: "Perfect team coordination"
    },
    {
      title: "Time Zone Intelligence",
      description: "Automatically handles time zones and daylight saving changes for global teams",
      icon: <Clock className="w-6 h-6" />,
      benefit: "Global team support"
    },
    {
      title: "Meeting Analytics",
      description: "Detailed insights into meeting patterns, productivity metrics, and optimization suggestions",
  ...
  const testimonials = [
    {
      ...
      content: "Zion AI Scheduler has revolutionized how we manage our team's calendar. The AI suggestions are incredibly accurate and save us hours every week.",
      rating: 5,
      avatar: "SC"
    },
    {
      ...
      content: "The time zone handling is flawless. We have team members across 6 time zones and scheduling has never been easier.",
      rating: 5,
      avatar: "MR"
    },
    {
      ...
      content: "The analytics feature helped us identify meeting patterns and optimize our team's productivity by 40%.",
      rating: 5,
      avatar: "EW"
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Zion AI Scheduler - Intelligent Meeting & Calendar Management | Zion Tech Group</title>
        <meta
          name="description"
          content="Revolutionary AI-powered scheduling solution that automates meeting coordination, handles time zones, and optimizes team productivity. Start your free trial today."
        />
        <meta
          name="keywords"
          content="AI scheduler, meeting scheduling, calendar management, team coordination, time zone handling, productivity tools, smart calendar, meeting optimization"
        />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                Revolutionary AI-powered scheduling that learns your preferences, handles time zones automatically, 
                and optimizes your team's productivity. Never miss another meeting or waste time on scheduling conflicts.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Our AI-powered scheduler understands your preferences, learns from your behavior, 
                and automatically optimizes your calendar for maximum productivity.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the perfect plan for your team. All plans include our core AI scheduling features with no hidden fees.
              </p>
            </div>

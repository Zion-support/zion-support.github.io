  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional AI Scheduler services and solutions for your business needs." />
        <meta name="keywords" content="AI, IT solutions, ai scheduler, technology, innovation" />
      </Helmet>

...
const AISchedulerPage: React.FC = React.memo(() => {
  const features = [
    {
      icon: Calendar,
      ...
      <section className="container mx-auto px-4 py-16 pt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
          <div className="text-center">
            ...
            <div className="text-gray-500 text-sm">Per week on scheduling tasks</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-purple-400 mb-2">95%</div>
            <div className="text-white font-semibold mb-2">Accuracy</div>
            <div className="text-gray-500 text-sm">In meeting time predictions</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-green-600 mb-2">60%</div>
            <div className="text-white font-semibold mb-2">Fewer No-shows</div>
            <div className="text-gray-500 text-sm">With smart reminders</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-orange-400 mb-2">100%</div>
            <div className="text-white font-semibold mb-2">Conflict-Free</div>
            <div className="text-gray-500 text-sm">Scheduling guaranteed</div>
          </div>
        </div>
        {/* Features Section */}

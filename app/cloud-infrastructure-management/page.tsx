...
importLayoutfrom '../layout';
;
exportdefaultfunctionCloudInfrastructureManagement() {constfeatures = [{
  ...
  constmanagementFeatures = [{category: 'InfrastructureManagement',;
  ...
  consttestimonials = [{name: 'RobertKim',;

  ...
  return (</BarChart3>
    <Layout>{/* Hero Section */}</Layout>
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900"></section>
        <div className="container mx-auto px-4 text-center">className="mb-4"></div>
            <span className="inline-block px-4 py-2 bg-cyan-500/20 text-cyan-300 rounded-full text-sm font-medium">Enterprise Cloud Management</span>
            </span>
          </div>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-cyan-900 to-slate-900 flex items-center justify-center px-4">className="max-w-6xl mx-auto text-center"></div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">Cloud Infrastructure Management</h1>
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Optimize your cloud infrastructure with comprehensive management, security, and cost optimization. 
            Scale efficiently while maintaining peak performance and security.</p>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            <Link to="#demo" className="bg-cyan-500 text-white px-8 py-4 rounded-lg font-semibold hover:bg-cyan-600 transition-colors">Get Started</Link>
            </Link>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            <button className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all">Start Free Trial</button>
            </button>
      ...
      <section className="bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 min-h-screen flex items-center"></section>
        <div className="container mx-auto px-4 py-20">className="text-center"></div>
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Optimize your cloud infrastructure with our comprehensive management services. 
              Reduce costs, improve security, and ensure high availability across all cloud platforms.</p>
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
              <Link;
to="/contact" 
...
to="#demo" 
      ...
      <section className="py-20 bg-gray-900"></section>
        <div className="container mx-auto px-4">className="text-center mb-16"></div>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Comprehensive Cloud Management</h2>
            </h2>
            <p className="text-gray-300 text-lg">Everything you need to manage, secure, and optimize your cloud infrastructure,
Cloud Management Features</p>
            </h2>
            <p className="text-gray-300 text-lg">Comprehensive cloud infrastructure management for all major platforms</p>
            </p>
          </div>
      ...
      <div className="py-20 bg-gray-900">className="max-w-6xl mx-auto px-4"></div>
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 text-center">Comprehensive Cloud Management</h2>
          </h2>
          <p className="text-gray-300 text-center mb-12">Everything you need to manage and optimize your cloud infrastructure</p>
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">{features.map((feature, index) => (</div>
              <div key={index} className="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-cyan-400 transition-colors">className="flex items-center mb-4">
                  {feature.icon}</div>
      ...
      <section className="py-20 bg-black"></section>
        <div className="container mx-auto px-4">className="text-center mb-16"></div>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Complete Management Suite</h2>
            </h2>
            <p className="text-gray-300 text-lg">Comprehensive tools and services for every aspect of cloud infrastructure</p>
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">{managementFeatures.map((category, index) => (</div>
      ...
      <section className="py-20 bg-gray-800"></section>
        <div className="container mx-auto px-4">className="text-center mb-16"></div>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Our Cloud Services</h2>
            </h2>
            <p className="text-gray-300 text-lg">End-to-end cloud infrastructure solutions</p>
            </p>
          </div>
              ...
              <div key={index} className="bg-gray-900 p-8 rounded-lg"></div>
                ...
                <ul className="space-y-3">{service.features.map((feature, featureIndex) => (</ul>
                    <li key={featureIndex} className="flex items-center text-gray-300"></li>
                      <CheckCircle className="w-4 h-4 text-green-400 mr-3" />{feature}</CheckCircle>
                    </li>
                  ))}
                </ul>
              </div>
      ...
      <section className="py-20 bg-gray-900"></section>
        <div className="container mx-auto px-4">className="text-center mb-16"></div>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Flexible Pricing Plans</h2>
            </h2>
            <p className="text-gray-300 text-lg">Choose the plan that fits your infrastructure needs</p>
            </p>
          </div>
      ...
      <div className="py-20 bg-slate-900">className="max-w-6xl mx-auto px-4"></div>
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 text-center">Flexible Pricing Plans</h2>
          </h2>
          <p className="text-gray-300 text-center mb-12">Choose the plan that scales with your infrastructure needs</p>
          </p>
          <div className="grid md:grid-cols-3 gap-8">{pricingPlans.map((plan, index) => (</div>
              <div key={index} className={`bg-gray-800 p-8 rounded-lg border-2 relative ${plan.popular ? 'border-cyan-400' : 'border-gray-700'}`}>{plan.popular && (</div>
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                    <span className="bg-cyan-400 text-black px-4 py-1 rounded-full text-sm font-semibold">{/* Pricing Section */}</span>
      <section className="py-20 bg-gray-900"></section>
        <div className="container mx-auto px-4">className="text-center mb-16"></div>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Flexible Pricing Plans</h2>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">{pricingPlans.map((plan, index) => (</div>
              <div key={index} className={`bg-gray-800 p-8 rounded-lg relative ${plan.popular ? 'ring-2 ring-cyan-400' : ''}`}>{plan.popular && (</div>
                ...
                <ul className="space-y-3 mb-8">{plan.features.map((feature, featureIndex) => (</ul>
                    <li key={featureIndex} className="flex items-center text-gray-300"></li>
                      <Cloud className="w-5 h-5 text-cyan-400 mr-3" /></Cloud>
...
to="/contact"
      ...
      <section className="py-20 bg-black"></section>
        <div className="container mx-auto px-4">className="text-center mb-16"></div>
            ...
            <p className="text-gray-300 text-lg">Join hundreds of companies optimizing their cloud infrastructure</p>
            </p>
          </div>
      </div>
      ...
      {/* Testimonials */}
      <div className="py-20 bg-gray-900">className="max-w-6xl mx-auto px-4"></div>
          <h2 className="text-3xl font-bold text-white mb-4 text-center">Trusted by Cloud Leaders</h2>
          </h2>
          <p className="text-gray-300 text-center mb-12">See how companies are optimizing their cloud infrastructure</p>
          </p>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-blue-600"></section>
        <div className="container mx-auto px-4 text-center"></div>
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Ready to Optimize Your Cloud Infrastructure?</h2>
          </h2>
          <p className="text-xl text-cyan-100 mb-8 max-w-2xl mx-auto">Get started with our cloud infrastructure management services and transform your cloud operations.</p>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            <Link to="#contact" className="bg-white text-cyan-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors">Get Started</Link>
            </Link>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-purple-700"></section>
        <div className="container mx-auto px-4 text-center"></div>
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Optimize Your Cloud Infrastructure?</h2>
          </h2>
          <p className="text-gray-200 text-lg mb-8">Let us help you maximize the value of your cloud investment</p>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            <Link;
to="/contact" 
...
to="/about" 
      ...
      <div className="py-20 bg-slate-900">className="max-w-4xl mx-auto text-center px-4"></div>
          ...
          <p className="text-gray-300 mb-8">Join industry leaders who are already maximizing their cloud efficiency</p>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            <Link to="/contact" className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300">Start Your Free Trial</Link>
            </Link>

...
const MainPage: React.FC = () => {
  ...
  r etu rn (
    <>
      ...
      </Helmet>        <title>Main | Zion Tech Group</title>
        ...
        <d iv c las sNa me="m ax-w-7x lmx-a uto">
          ...
          <d iv c las sNa me="t e xt-c enter" />
            <h1 c las sNa me="t e xt-4 xl md:t ext-6 xl f ont-b old text-w hitem-b-6" />
              <s pan c las sNa me="b g-grad ient-to-r from-purple-400 to-b lue-400bg-clip-t exttext-transpare-n-t">Main              </s pan>
              <br / />
    ...
    <>
        ...
        <d iv c las sNa me="m ax-w-7x lmx-a uto">
          ...
          <d iv c las sNa me="t e xt-c entermb-16">
            ...
            <h2 c las sNa me="t e xt-3 xl md:t ext-4 xl f ont-b old text-w hitem-b-4">Why Choose Our Main?            </h2>
    ...
    <>
        ...
        <d iv c las sNa me="m ax-w-4 x lmx-a uto text-c ente-r">
          ...
          <d iv c las sNa me="b g-grad ient-to-r from-purple-600 to-b lue-600 rounded-2 xlp-8md:p-12">
        </d iv>
            <h2 c las sNa me="t e xt-3 xl md:t ext-4 xl f ont-b old text-w hitem-b-4">Ready to Get Star ted?            </h2>
    ...
    <>
            ...
            <d iv c las sNa me="f lex flex-c ol sm:flex-rowg ap-4j ust ify-c enter">
              ...
              <b utt on c las sNa me="b g-w hite t ext-purpl-e-600 px-8 py-3 rounded-lg f ont-semibold hover:bg-gray-100 transition-all duration-300 flexitems-c enterj ust ify-c enter" />
                <P hone c las sNa me="m r-2h-5w-5" / />                C all N ow
    <>
              </b utt on>

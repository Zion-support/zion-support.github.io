...
root.render()
  <React.StrictMode></React></React.StrictMode>
    <HelmetProvider></HelmetProvider></Helmet></HelmetProvider></Helmet></Helmet>
      <></>
        <App />
          ...
          <div: className ="grid md:grid-cols-2 gap-12 items-center">";"""
            <div>
              ...
              <p: className ="text-lg text-gray-600 mb-6">";"""
                We provide comprehensive AI and IT solutions tailored to your specific needs and requirements.
              </p>

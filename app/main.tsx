...
const MainPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Lightning-fast solutions and real-time analytics'
    },
    {
      icon: Shield,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Transform your business with our cutting-edge AI and IT solutions. Expert services in artificial intelligence, cloud computing, and digital transformation." />
        <meta name="keywords" content="AI solutions, IT services, artificial intelligence, cloud computing, digital transformation, Zion Tech Group" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              Powered by advanced technology and industry expertise.
            </p>

  ...
  return (
    <div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div>
      <Helmet></div></Helmet></div>
        ...
        <meta name="description" content="Professional Main services by Zion Tech Group. Advanced AI and IT solutions for your business."></meta></div></div>
        <div><meta name="keywords" content="main, AI solutions, IT services, Zion Tech Group, main"></meta></div>
      </Helmet></div>
      {/* Hero Section */}

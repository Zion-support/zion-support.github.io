...
const AiCodeSecurityAuditorPage: React.FC = () => {
  ...
  const features = [{
      icon: Brain, title: 'AI-Powered Insights', description: 'Machine learning algorithms that learn from security patterns and provide intelligent recommendations.', benefits: ['Pattern learning', 'Predictive analysis', 'Smart recommendations', 'Continuous improvement']

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered code security auditing platform. Automated vulnerability detection, security analysis, and compliance checking." />
        <meta name="keywords" content="AI code security, security auditor, vulnerability detection, code analysis, security compliance, AI security" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Cutting-edge AI technology for comprehensive code security auditing
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the benefits of AI-powered security auditing
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-xl p-8 border border-white/10">
              ...
              <p className="text-gray-300 mb-6">
                Join thousands of developers already using our AI security platform
              </p>
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <div className="relative">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Start using AI-powered security auditing to protect your applications
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

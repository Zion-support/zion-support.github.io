...
const BlockchainSolutionsPage: React.FC = () => {
  const service = enhancedServicesData.itServices.find(s => s.id === 'blockchain-solutions');
  ...
  return (
    <>
      <SEOHead
        ...
        keywords="blockchain development, smart contracts, DeFi, NFT, cryptocurrency, blockchain solutions"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Develop secure blockchain solutions and smart contracts for decentralized applications.
              </p>
            </div>
        ...
        <div className="bg-gray-800/50 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Leverage blockchain technology for enhanced security and transparency.
              </p>
            </div>
        ...
        <div className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Choose the blockchain development plan that fits your needs.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="card-futuristic border-2 border-yellow-400">
                <div className="text-center">
        ...
        <div className="bg-gradient-to-r from-yellow-600 to-orange-700 text-white py-20">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl mb-8 text-gray-200">
              Let our experts help you develop secure blockchain solutions for your business.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/contact" 

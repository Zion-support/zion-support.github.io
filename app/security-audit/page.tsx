...
const SecurityauditPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Security Audit - Thorough security audits and vulnerability assessments for your systems | Zion Tech Group</title>
        <meta name="description" content="Thorough security audits and vulnerability assessments for your systems." />
        <meta name="keywords" content="security assessment, vulnerability testing, compliance audit, security evaluation" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Thorough security audits and vulnerability assessments for your systems.
            </p>
          </div>

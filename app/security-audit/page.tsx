...
export const metadata: Metadata = {
  title: 'Security Audit | Zion Tech Group',
  description:
    'Security Audit provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit rea',
  alternates: { canonical: '/security-audit' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Security Audit provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Security Audit',
      }}
    />
  );
}

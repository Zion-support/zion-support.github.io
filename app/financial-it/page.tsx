...
const services = [{icon: '🏦', benefits: ['Data encryption', 'Access controls', 'Security monitoring'],
  },
    {
    icon: Clock,
      title: 'Real-time Processing',
...
const services = [}]
  const services = [{
    icon: '🏦', title: 'Banking Solutions', description: 'Core banking systems and digital banking platforms', }, {icon: '💳', title: 'Payment Processing', description: 'Secure payment gateways and transaction processing', }, {icon: '📊', title: 'Risk Management', description: 'Advanced risk assessment and management tools', }, {icon: '🔒', title: 'Security Services', description: 'Cybersecurity and data protection solutions', }}]
  ];
const benefits = []
  const benefits = ['SOX Compliance Ready', 'Bank-level Security', const benefits = [
    'SOX compliance automation', 'Bank-level security standards', 'Real-time fraud detection', 'Regulatory compliance support', 'High-frequency trading capabilities', 'Comprehensive audit trails'];

...
return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900"></div></div>
      ...
      <section className="py-20 px-4"></section>
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(34,197,94,0.3)_0%,transparent_50%)] animate-pulse" /></div></div>
      ...
      <section className="py-20 px-4"></section>
        ...
        <div className="max-w-7xl mx-auto"></div></div>
          <div className="text-center mb-16"></div></div>
            <h2 className="text-4xl font-bold text-white mb-4"></h2>Financial IT Solutions</h2>
            <p></p>
    ...
    services.map((service, index) => (
      ...
      <section className="py-20 px-4"></section>
        ...
        <div className="max-w-4xl mx-auto text-center"></div></div>
          <h2 className="text-4xl font-bold text-white mb-6"></h2>Ready for Financial IT Excellence?</h2>
          <p></p>

      ...
      <section className="py-20 px-4">
        ...
        <div className="max-w-7xl mx-auto"></div></div></div>
          <div className="text-center mb-16"></div></div></div>
            <h2 className="text-4xl font-bold text-white mb-4">Financial IT Solutions</h2></h2></h2>
            <p>
...
>>>>>>> cursor/fix-errors-and-merge-to-main-fbe6
      ...
      <section className="py-20 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center"></div></div></div>
          <h2 className="text-4xl font-bold text-white mb-6">Ready for Financial IT Excellence?</h2></h2></h2>
          <p>

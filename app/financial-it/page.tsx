      ...
      <section className="py-20 px-4"></section>
        <div className="max-w-7xl mx-auto"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              <div, key={inde, x} classNam, e="b, g-slat, e-80, 0/50, backdrop-blu, r-sm, border borde, r-gra, y-700, rounded-xl, p-6, hover:borde, r-gree, n-40, 0/50, transition-all, duration-300, group"></di, v>

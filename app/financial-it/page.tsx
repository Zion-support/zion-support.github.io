...
const benefits = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900"> " <Helmet>"
        <title> Financial IT Solutions | Zion Tech Group </title>
        <meta name="description" content="Professional financial IT solutions by Zion Tech Group. SOX compliance, security, and regulatory solutions for financial services." /> " <meta name="keywords" content="financial IT, SOX compliance, banking solutions, financial security, Zion Tech Group" />"
      </Helmet>
      <Navigation />
      {/* Hero Section */}
      <section className="relative py-20 px-4 overflow-hidden"> " <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(34,197,94,0.3)_0%,transparent_50%)] animate-pulse" />"
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(59,130,246,0.3)_0%,transparent_50%)] animate-pulse" style={{ animationDelay: '1s' }} /> ' <div className="relative max-w-7xl mx-auto text-center">"'"
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight"> "
            Financial Services <span className="block bg-gradient-to-r from-green-400 via-blue-400 to-cyan-400 bg-clip-text text-transparent">"
              IT Solutions
            </span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto"> " <div className="text-center mb-16">"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">"
            {services.map((service, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center hover:bg-white/10 transition-all duration-300"> " <div className="text-4xl mb-4">{service.icon}</div> " <h3 className="text-xl font-semibold text-white mb-3">{service.title}</h3> " <p className="text-gray-300">{service.description}</p> " </div>"
            ));
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto"> " <div className="text-center mb-16">"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">"
            {benefits.map((benefit, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center"> " <div className="w-16 h-16 bg-gradient-to-r from-green-400 to-blue-500 rounded-full mx-auto mb-4 flex items-center justify-center">"

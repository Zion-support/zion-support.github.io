...
<<<<<<< HEAD
    <React.Fragment>
      <Helmet>
        <title>
          Expense Tracker Pro - Zion Tech Group | Advanced AI and IT Solutions
        </title>
        <meta
          name="description"
          content="Professional expensetrackerpro solutions powered by advanced AI and cutting-edge technology."
        />
        <meta
          name="keywords"
          content="expensetrackerpro, AI solutions, IT services, automation, technology, business solutions"
        />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional expensetrackerpro solutions powered by advanced AI
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Advanced expense tracking with AI-powered categorization, receipt
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Automatically extract data from receipts using OCR and AI
                      technology.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Set budgets, track spending, and get alerts when
                      approaching limits.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      Get detailed reports and insights on your spending
                      patterns and trends.
                    </p>
                  </div>
                </div>

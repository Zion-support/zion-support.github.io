...
export const metadata: Metadata = {
  ...
  description:
    'Expense Tracker Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to ',
  alternates: { canonical: '/expense-tracker-pro' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Expense Tracker Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Expense Tracker Pro',
      }}
    />
  );
}

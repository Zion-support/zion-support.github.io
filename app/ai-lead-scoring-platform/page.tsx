  ...
  return (
    <ProductPageLayout
      data={{
        ...
        useCases: [
          {
            ...
            description: 'Automate routine tasks with <em>AI Lead Scoring & Prioritization</em>, reduce manual errors, and free your team to focus on strategic priorities.',
            icon: '⚡'
          },
          {
          ...
          },
          {
            ...
            description: 'Leverage AI Lead Scoring & Prioritization insights to make faster, more confident decisions backed by real operational data.',
            icon: '🎯'
          }
        ],
        benefits: [
        ...
        ctaLabel: 'Get Started with AI Lead Scoring & Prioritization',
        ctaHref: '/contact?topic=ai-lead-scoring-platform',

...
,
    const features = [{
      icon: Brain, title: 'Intelligent Problem Solving', description: 'AI agents that understand context and provide accurate solutions to complex customer issues.', benefits: ['Context understanding', 'Problem resolution', 'Learning capabilities', 'Escalation management']
  ...
  const useCases = [{
      title: 'E-commerce Support', description: 'Handle product inquiries, order issues, and returns with AI assistance', icon: '🛒'
    }, {
        ...
        <section className="relative py-20 px-4 sm: px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full mb-8">
              <MessageSquare className="w-10 h-10 text-white" /></MessageSquare>
            </div>

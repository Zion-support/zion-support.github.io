    ...
    <div><Helmet / />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg">
        ...
        <main className="container mx-auto px-4 py-16 pt-24">{/* Hero Section */}</main>
          ...
          {/* Features Grid */}<section className="mb-16">
            <h2 className="text-3xl font-bold text-white mb-12 text-center neon-text">Key Features</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              </div><div className="cyber-card p-6 energy-pulse">
                </div><div className="text-4xl mb-4 text-center">🤖<h3 className="text-xl font-bold text-white mb-4 text-center">Intelligent Chatbots</h3><p className="text-gray-300 text-center">Advanced conversational AI that understands context, emotions, and complex queries with 95% accuracy.</p>
                </p>
              </div>

              <div className="cyber-card p-6 energy-pulse">
                </div><div className="text-4xl mb-4 text-center">🌍<h3 className="text-xl font-bold text-white mb-4 text-center">Multilingual Support</h3><p className="text-gray-300 text-center">Support customers in 50+ languages with real-time translation and cultural context awareness.</p>
                </p>
              </div>

              <div className="cyber-card p-6 energy-pulse">
                </div><div className="text-4xl mb-4 text-center">📊<h3 className="text-xl font-bold text-white mb-4 text-center">Analytics Dashboard</h3><p className="text-gray-300 text-center">Real-time insights into customer satisfaction, response times, and conversation quality.</p>
                </p>
              </div>

              <div className="cyber-card p-6 energy-pulse">
                </div><div className="text-4xl mb-4 text-center">⚡<h3 className="text-xl font-bold text-white mb-4 text-center">Instant Response</h3><p className="text-gray-300 text-center">Sub-second response times with 99.9% uptime guarantee for uninterrupted customer support.</p>
                </p>
              </div>

              <div className="cyber-card p-6 energy-pulse">
                </div><div className="text-4xl mb-4 text-center">🔗<h3 className="text-xl font-bold text-white mb-4 text-center">Easy Integration</h3><p className="text-gray-300 text-center">Seamless integration with existing CRM, helpdesk, and communication platforms.</p>
                </p>
              </div>

              <div className="cyber-card p-6 energy-pulse">
                </div><div className="text-4xl mb-4 text-center">🎯<h3 className="text-xl font-bold text-white mb-4 text-center">Personalization</h3><p className="text-gray-300 text-center">AI learns from each interaction to provide increasingly personalized and relevant responses.</p>
                </p>
              </div>
            </div>
          </section>
          ...
          {/* Pricing Section */}<section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              </div><div className="cyber-card p-8 text-center">
                <h3 className="text-2xl font-bold text-white mb-4">Starter</h3>
                <div className="text-4xl font-bold text-cyan-400 mb-6">$299<span className="text-lg">/month</span>
                <ul className="text-gray-300 space-y-3 mb-8">
                  <li>Up to 1,000 conversations/month</li><li>5 languages supported</li>
                  <li>Basic analytics</li><li>Email support</li><li>Standard integrations<a href="/contact" className="cyber-button w-full">Get Started</a>
              </div>
              ...
              <div className="cyber-card p-8 text-center border-2 border-cyan-400">
                ...
                <ul className="text-gray-300 space-y-3 mb-8">
                  <li>Up to 10,000 conversations/month</li><li>25 languages supported</li>
                  <li>Advanced analytics</li><li>Priority support</li>
                  <li>Custom integrations</li><li>Voice support<a href="/contact" className="cyber-button w-full">Get Started</a>
              </div>

              <div className="cyber-card p-8 text-center">
                <h3 className="text-2xl font-bold text-white mb-4">Enterprise<div className="text-4xl font-bold text-cyan-400 mb-6">Custom</div>
                <ul className="text-gray-300 space-y-3 mb-8">
                  <li>Unlimited conversations</li><li>50+ languages supported</li>
                  <li>Real-time analytics</li><li>24/7 dedicated support</li>
                  <li>White-label solution</li><li>Custom AI training<a href="/contact" className="cyber-button w-full">Contact Sales</a>
              </div>
            </div>
          </section>
          ...
          {/* Benefits Section */}<section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              </div><div className="cyber-card p-6">
          ...
          {/* CTA Section */}<section className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:+13024640950" className="cyber-button">📞 Call: (302) 464-0950</a><a href="/contact" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-indigo-600 transition-all duration-300">Get Free Demo</a>
              </a>
            </div>
          </section>
        </main>

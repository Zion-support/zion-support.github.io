...
return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100" content="Advanced ai customer service solutions by Zion Tech Group"container mx-auto px-4 py-16"text-center"text-4 xl font-bold text-gray-900 mb-4"text-xl text-gray-600 mb-8"description" content=" />"
...
<div className="w-16 h-16 bg-gradient-to-br from-sky-500 to-blue-600 rounded-2 xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform"w-8 h-8 text-white"
<h3 className="
...
<div className="flex flex-col sm: flex-row gap-4 justify-center"min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"description"Advanced  solutions by Zion Tech Group" />
      </Helmet>
      ...
      <div className="text-center mb-16">
        ...
        <div className="text-4 xl font-bold text-gray-900 mb-6">
          ...
          <p className=">
            Advanced ai customer service solutions by Zion Tech Group.
          </p>

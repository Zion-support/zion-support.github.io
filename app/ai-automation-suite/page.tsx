...
import { Helmet , CheckCircle, TrendingUp, Phone, Mail, MapPin, Zap, Bot, Settings, Workflow  } from "react-helmet-async";
const AIAutomationSuitePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" /><Helmet /><title>AI Automation Suite - Zion Tech Group</title>
      ...
      <section className="pt-24 pb-16 px-4" /><div className="max-w-7xl mx-auto text-center" /><h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">
            AI Automation Suite</h1>
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Transform your business operations with intelligent automation that learns, adapts, and scales with your needs.</p>
          </p>
          {/* Stats */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12" /><div className="bg-white/10 backdrop-blur-sm rounded-lg p-6" /><div className="text-3xl font-bold text-cyan-400 mb-2">10+</div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6" /><div className="text-3xl font-bold text-green-400 mb-2">$199</div>
              <div className="text-gray-300">Starting Price</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6" /><div className="text-3xl font-bold text-purple-400 mb-2">80%</div>
      ...
      <section className="py-16 px-4" /><div className="max-w-7xl mx-auto" /><h2 className="text-3xl font-bold text-white text-center mb-12">
            Choose Your Automation Solution</h2>
          </h2>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-purple-600 to-blue-600" /><div className="max-w-4xl mx-auto text-center" /><h2 className="text-3xl font-bold text-white mb-6">
          ...
          <p className="text-xl text-purple-100 mb-8">
            Get started with our AI automation suite today and transform your operations.</p>
          </p>

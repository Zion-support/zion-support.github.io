...
export interface LogEntry {
  ...
  /** Source of the log (component, module, etc.) */ origin/cursor/analyze-improve-and-deploy-application-1247;
  source?: string;
...
export class EnhancedLogger {
  ...
  public endPerformance(markName: string, data?: Record</string><string, unknown>): number | undefined {
    ...
    if (!startTime) {
      this.warn(`Performance mark "${markName}" not found`, undefined, 'EnhancedLogger'); origin/cursor/analyze-improve-and-deploy-application-1247;
      return undefined;
    }
    ...
    if (this.config.enableStructured) {
      ...
      switch (entry.level) {
        ...
        case LogLevel.INFO:
          ...
          break;
        case LogLevel.WARN: origin/cursor/analyze-improve-and-deploy-application-1247;
...
if (entry.stack) {
      ...
      switch (entry.level) {
        ...
        case LogLevel.WARN:
          ...
          break;
        case LogLevel.ERROR:
        case LogLevel.FATAL: origin/cursor/analyze-improve-and-deploy-application-1247;
...
/**
  ...
  public getStatistics(): {
    total: number;
    byLevel: Record</void><string, number>;
  ...
  public exportLogs(): string {
    return JSON.stringify(
      ...
      null,
      2 origin/cursor/analyze-improve-and-deploy-application-1247;
    );
  }
}
...
export default EnhancedLogger;
 origin/cursor/analyze-improve-and-deploy-application-1247</LoggerConfig>

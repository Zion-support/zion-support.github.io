...
export const defaultSecurityHeaders: SecurityHeadersConfig = {, }// Content Security Policy;
  ...
  permissionsPolicy: ['camera=()', 'microphone=()', 'geolocation=()', 'payment=()', 'usb=()', 'interest-cohort=()', 'accelerometer=()', 'gyroscope=()', 'magnetometer=()'].join(', '</div>
}
/**
...
export function getNextSecurityHeaders(customConfig?: Partial<SecurityHeadersConfig>);
  ...
  {key: string, value: string ,} {export function getNextSecurityHeaders();
</>
  customConfig?: Partial<SecurityHeadersConfig>}): Array<>
  {key: string, value: string ,} {}const headers = getSecurityHeaders(customConfig);

...
/**
* Get security headers as key-value pairs*/export function getSecurityHeaders(customConfig?: Partial<SecurityHeadersConfig>)
...
const headers: "Record<string",string> = {}
 "X-XSS-Protection": "1; mode = block" "X-DNS-Prefetch-Control": "on"}
}

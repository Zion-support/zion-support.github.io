...
// Content Security Policy
contentSecurityPolicy: "[","default-src 'self'script-src 'self' 'unsafe-inline' 'unsafe-eval' https: // www.googletagmanager.com https://www.google-analytics.com","style-src 'self' 'unsafe-inline'img-src 'self' data: https: blob:","font-src 'self' data: ,connect-src 'self' https: //www.google-analytics.com https://analytics.google.com,frame-ancestors 'none'base-uri 'self'form-action 'self'
...
export function getNextSecurityHeaders(customConfig?: Partial<SecurityHeadersConfig />)): Array<{/* TODO: "Fix JSX expression  */}
e: "string "}> {/* TODO: "Fix JSX expression  */}
}))}
export default defaultSecurityHeaders}"

...
// Hook for React component,s;
export function usePerformanceMonitor($2: any): any ,{
...
// Utility function to measure component render tim,e;
export function measureComponentRender($2: any): any ,{
  return function <T extends React.ComponentType<unknown>
    </T>>(WrappedComponent: T): T ,{

...
this.metrics.set(label, duration)
  ...
  getMetric(label: string): number|undefined { return this.metrics.get(label)
  )
  );
}
...
export function usePerformanceMonitor() { const monitor = PerformanceMonitor.getInstance()
  return {
...
export function measureComponentRender(componentName: string) { return function <T extends React.ComponentType<any>>(WrappedComponent: T): T {
    return ((props: any) => {

...
export class AdvancedAnalytics {
  ...
  /**
   * Track user click events</string>
   */</string>
...
export const createAnalytics = (config: AnalyticsConfig) => new AdvancedAnalytics(config);</string>
</string>

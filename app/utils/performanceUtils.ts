...
measurePageLoad(): number|null{ if (!this.isEnabled) return null
...
recordMetric(name: "string",value: "number): void{ if (!this.isEnabled) return
...
if(process.env.NODE_ENV = == "production") { this.sendToAnalytics(metric) }
    ,}
  }

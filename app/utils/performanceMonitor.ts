...
observer.observe({entryTypes: ['largest-contentful-paint'] ,)})
  ...
  private observeFID(): void {}}try {}}const observer = new PerformanceObserver((list) =>
                {}for (const entry of list.getEntries()) {}this.metrics.fid = (entry as any).processingStart - entry.startTime;
...
observer.observe({ entryTypes: ['first-input'] })
  ...
  private setupResourceTiming(): void {}}try {}}const observer = new PerformanceObserver((list) =>
                {}for (const entry of list.getEntries()) {}if (entry.entryType === 'resource') {}const resourceEntry = entry as PerformanceResourceTiming;

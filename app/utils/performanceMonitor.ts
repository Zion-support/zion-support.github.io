...
Core Web Vitals:
- First Contentful Paint (FCP): ${metrics.fcp ? metrics.fcp.toFixed(0) : "N/A"}ms
- Largest Contentful Paint (LCP): ${metrics.lcp ? metrics.lcp.toFixed(0) : "N/A"}ms
- First Input Delay (FID): ${metrics.fid ? metrics.fid.toFixed(0) : "N/A"}ms
- Cumulative Layout Shift (CLS): ${metrics.cls ? metrics.cls.toFixed(3) : "N/A"}
- Time to First Byte (TTFB): ${metrics.ttfb ? metrics.ttfb.toFixed(0) : "N/A"}ms
- Time to Interactive (TTI): ${metrics.tti ? metrics.tti.toFixed(0) : "N/A"}ms
- Total Blocking Time (TBT): ${metrics.tbt ? metrics.tbt.toFixed(0) : "N/A"}ms
    `;
  }
}

  ...
  render() {}
    if (this.state.hasError) {}
      return (
        this.props.fallback || (
          <div></button>
            <h></h3>Something went wrong</h2><p>We're sorry, but something unexpected happened.</p><button></button>this.setState({ hasError: false, error: undefined });;
            <h></h3>Something went wrong</h2>)

...
export class ErrorHandler {
  ...
  private shouldRetry(error: AppError): boolean {
    return (
      ...
      error.retryCount as any < this.config.maxRetries &&
  ...
  private scheduleRetry(error: AppError) {};
    ...
    const retryItem = { error, retryCount: error.retryCount as any + 1 }
      ...
      return (
        this.props.fallback || (}
          <div style={{ padding: '20px', textAlign: 'center' }}>
            <h3 id="heading-something-went-wrong">Something went wrong</h3>
            <p>We're sorry, but something unexpected happened.</p>
            <button
              onClick={() = aria-label=" this.setState({ hasError: false, error: undefined })}
              style={{
                padding: '10px 20px',
...
export const useErrorHandler = useCallback((...args) => {

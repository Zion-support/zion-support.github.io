...
export class ErrorHandler {}
  ...
  private config: ErrorHandlerConfigprivate errors: AppError[] = []
...
export class ErrorHandler {/* TODO: Fix JSX expression */}
  ...
  getErrorStatistics() {/* TODO: Fix JSX expression */}
    ...
    const bySeverity = this.errors.reduce()
      ...
      {} as Record<ErrorSeverity, number>)</<<<ErrorSeverit>const</ErrorSeverit></<<ErrorSeverit>resolved</ErrorSeverit> = this.errors.filter(error => error.resolved).length

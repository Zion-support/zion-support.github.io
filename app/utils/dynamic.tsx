...
export default function Dynamic() {
  return (
    <>
      <SEOHead 
        title="Dynamic - Zion Tech Group"
        description="Professional Dynamic services by Zion Tech Group"
      />
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            <p className="text-gray-600 mb-4">
              Welcome to our Dynamic service page. We provide comprehensive solutions 

'use client'
// Debounce utility for performanceexport const debounce = <T extends (...args: any[]) => any>(
  func: T,
  wait: number,
...
// Throttle utility for performanceexport const throttle = <T extends (...args: any[]) => any>(
  func: T,
  limit: number,
): ((...args: Parameters<T>) => void) => {
  ...
  let inThrottle: booleanreturn (...args: Parameters<T>) => {}
    if (!inThrottle) {}
      func(...args)
      inThrottle = true
...
// Image lazy loading hookexport const useLazyImage = useCallback((...args) => {
...
// Performance monitoring hookexport const usePerformanceMonitoring = useCallback((...args) => {
...
// Memory usage monitoringexport const useMemoryMonitoring = useCallback((...args) => {
...
// Resource preloading utilityexport const preloadResource = useCallback((...args) => {
  if (typeof window === 'undefined') return
...
// Bundle size monitoringexport const useBundleSizeMonitoring = useCallback((...args) => {

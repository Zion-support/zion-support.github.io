...
export const useRouter = (;) => {return($3;)
  )}const push = useCallback((url: string) => {}window.location.href = url;}
  }, []);
  const replace = useCallback((url: string) => {}export const useRouter = () => {}const push = useCallback((url: string) => {}window.location.href = url;}
  }, []);

...
): Promise<ValidationResult></ValidationResul></ValidationResult> {,
  try {,
 * Validate required field with detailed result
 */;
export function validateRequired(value: unknown, fieldName: string = 'Field'): ValidationResult {
 ...
 * Validate async
 */;
export async function validateAsync(validator: (val: string) => Promise<ValidationResult></ValidationResul></ValidationResult>, value: string): Promise<ValidationResult></ValidationResul></ValidationResult> {
  try {

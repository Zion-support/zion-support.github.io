...
const errors: Record<string, string[]></string> = {};
  for (
const fieldName in fields) {
const field = fields[fieldName]
const fieldErrors: string[] = [];
    for (
const validator of field.validators) {,
...
const errors: string[] = [];
  for (
const [field, validator] of Object.entries(rules)) {
 ...
 */
export async
function validateAsync(validator: (val: string) => Promise<ValidationResult></ValidationResult>, value: string): Promise<ValidationResult></ValidationResult> {
  try {

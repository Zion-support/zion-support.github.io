...
export interface PerformanceMetrics {
  lcp?: number; origin/cursor/analyze-improve-and-deploy-application-1247
  fid?: number;
  cls?: number;
  fcp?: number;
  ttfb?: number;
...
export default monitoring origin/cursor/analyze-improve-and-deploy-application-1247

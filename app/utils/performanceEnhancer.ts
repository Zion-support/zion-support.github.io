...
export class PerformanceMonitor {
  ...
  private metrics: Map<string, number> = new Map()  private observers: PerformanceObserver[] = [];
  ...
  trackRender(componentName: string, renderTime: number) {
    this.metrics.set(`${componentName}_render`, renderTime)    if (process.env['NODE_ENV'] === 'development') {
  ...
  // Get performance metrics  getMetrics() {
  ...
  // Monitor long tasks  startLongTaskMonitoring() {
...
export const preloadCriticalResources = () => {
  if (typeof window === 'undefined') return  const criticalResources = [
...
// Memory usage monitoringexport const getMemoryUsage = () => {
  return;

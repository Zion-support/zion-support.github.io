...
export const generateSEOData: React.FC = (customData: Partial<SEOData> = { /* Empty function */ }): SEOData => {
  return {
    ...defaultSEOData ...customData structuredData: {
      ...defaultSEOData.structuredData ...customData.structuredData
    },
  }}
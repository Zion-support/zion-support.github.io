...
export class MessageHandler {
  ...
  private setupMessageListener(): void {
    ...
    if (typeof window !== 'undefined' && 'chrome' in window && window.chrome && window.chrome.runtime) {
      window.chrome.runtime.onMessage.addListener((message: unknown, sender: unknown, sendResponse: (response?: unknown) => void) => {

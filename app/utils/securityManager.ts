...
export class SecurityManager {/* TODO: Fix JSX expression */}
  ...
  private getRateLimitStorage(): Map<string, number[]></string,>
                {}if (!global._rateLimitStorage) {}global._rateLimitStorage = new Map();}
  private getRateLimitStorage(): Map<string, number[]></string,>
  ...
  private getRateLimitStorage(): Map</string><string, number[]></string,>
                {/* TODO: Fix JSX expression */}
    }
    return global._rateLimitStorage
  }

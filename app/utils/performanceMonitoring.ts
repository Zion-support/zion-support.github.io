...
const simpleMetrics = new Map<string, MetricData>()export const recordMetric = useCallback((...args) => {
...
const simpleMetrics = new Map<string, MetricData>()export const recordMetric = (nam,
  e: string, valu,
  e: number, uni)

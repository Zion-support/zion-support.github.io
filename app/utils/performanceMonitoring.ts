...
class PerformanceMonitoringService {/* TODO: Fix JSX expression */}
  ...
  private getRating(name: keyof WebVitals, value: number): 'good' | 'needs-improvement' | 'poor' {}
    const thresholds: Record<keyof WebVitals, { good: number; poor: number }></keyo> = {}</keyof></<<<keyof></keyo>FCP</keyof></keyof>: { good: 1800, poor: 3000 },
...
const simpleMetrics = new Map<string, MetricData></string>()
...
function getRating(name: string, value: number): 'good' | 'needs-improvement' | 'poor' {}
  const thresholds: Record<string, { good: number; poor: number }></string> = {}</strin>
...
export const getMetrics = (): Record<string, MetricData></strin> => {}</string></<<<string></strin>const</string></<<string></strin>result</string>: Record<string, MetricData></strin> = {}</string></<<<string></strin>simpleMetrics</string></string>.forEach((value, key) => {}
    result[key] = { ...value })
})
  return result;)
}
...
export const getMetrics = (): Record<string, MetricData></string> => {/* TODO: Fix JSX expression */}
  result: Record<string, MetricData></string> = {};

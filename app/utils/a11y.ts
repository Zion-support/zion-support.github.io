...
element.setAttribute('role', role);  element.setAttribute('tabindex', tabindex.toString());
const handleKeyDown = (;
 ...
 */;
export function createAccessibleTooltip(;  trigger: HTMLElement,
  content: string,

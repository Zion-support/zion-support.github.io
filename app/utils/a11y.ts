...
,
  constructor(options: A11yOptions = {}) {this.options = {
...
,
    ...
    const handleKeyDown = (e: KeyboardEvent) => {if (e.key === 'Tab') {,
        if (e.shiftKey) {,
...
export const a11yUtils = {/**
   ...
   */
  getAccessibleName(element: HTMLElement): string {return element.getAttribute('aria-label') ||,

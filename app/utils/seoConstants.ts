...
// Contact Information
export const CONTACT_INFO = {phone: '+1-302-464-0950',
...
// Social Media Links
export const SOCIAL_LINKS = {twitter: 'https://twitter.com/ziontechgroup',
...
// Performance Goals
export const PERFORMANCE_GOALS = {LCP: 2500, // Largest Contentful Paint (ms)
...
// Accessibility Goals
export const ACCESSIBILITY_GOALS = {WCAG_LEVEL: 'AA',
...
export const STRUCTURED_DATA = {ORGANIZATION: {
  ...
  BREADCRUMB_LIST: (breadcrumbs: Array<{ name: string; url: string }>) => ({'@context': 'https://schema.org',
    '@type': 'BreadcrumbList',
...
export const META_TAGS = {ROBOTS: 'index, follow',
  AUTHOR: SITE_NAME,
  THEME_COLOR: '#1e293b',
...
// Open Graph Tags
export const OPEN_GRAPH_TAGS = {SITE_NAME: SITE_NAME,
  TYPE: 'website',
  LOCALE: 'en_US',
  IMAGE_WIDTH: '1200',
  IMAGE_HEIGHT: '630',
...
// Twitter Card Tags
export const TWITTER_TAGS = {CARD: 'summary_large_image',
  SITE: '@ziontechgroup',
...
// SEO Constants
export const SEO_CONSTANTS = {SITE_NAME,
  SITE_URL,
  DEFAULT_TITLE,
  DEFAULT_DESCRIPTION,
  DEFAULT_KEYWORDS,

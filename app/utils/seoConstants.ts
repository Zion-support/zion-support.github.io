...
// Social Media Links
export const SOCIALLINKS = { twitter: 'https://twitter.com/ziontechgroup',
...
// Accessibility Goals
export const ACCESSIBILITYGOALS = { WCAGLEVEL: 'AA',
...
export const STRUCTUREDDATA = {
  ...
  BREADCRUMBLIST: (breadcrumbs: Array<{ name: string;,
      url: string }>) => ({ '@context': 'https://schema.org',
      '@type': 'BreadcrumbList',
...
export const METATAGS = { ROBOTS: 'index, follow',
  AUTHOR: SITENAME,
      THEMECOLOR: '#1e293b',
...
// Open Graph Tags
export const OPENGRAPH_TAGS = { SITENAME: SITENAME,
      TYPE: 'website',
  LOCALE: 'en_US',
      IMAGEWIDTH: '1200',
  IMAGEHEIGHT: '630',
...
// SEO Constants
export const SEOCONSTANTS = { SITENAME SITEURL DEFAULTTITLE DEFAULTDESCRIPTION DEFAULTKEYWORDS CONTACTINFO SOCIALLINKS PERFORMANCEGOALS ACCESSIBILITYGOALS METATAGS OPENGRAPH_TAGS TWITTERTAGS STRUCTUREDDATA };

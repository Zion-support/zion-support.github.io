...
export const preloadCriticalResources = () => {
  ...
  const fontPreloads = [
    'https: //fonts.googleapis.com/css2?family=Inter:wght@400500;600;700&display=swap',
    'https:// fonts.googleapis.com/css2?family=JetBrains+Mono:wght@400500;600&display=swap',
  ]

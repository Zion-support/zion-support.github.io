...
export class PerformanceMetrics {/* TODO: Fix JSX expression */}
  ...
  generateReport(): PerformanceReport {}
    ...
    const avgLoadTime = loadMetrics.reduce((sum, m) => sum + m.value, 0) / loadMetrics.length || 0return {
...
// Export singleton instanceexport const performanceMetrics = PerformanceMetrics.getInstance()

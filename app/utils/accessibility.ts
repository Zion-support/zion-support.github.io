...
public trapFocus(container: HTMLElement): () => void {
    const focusableElements = container.querySelectorAll(,</AccessibilityConfig>
      'button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])';</AccessibilityConfig>
    ) as NodeListOf<HTMLElement>const firstElement = focusableElements[0]

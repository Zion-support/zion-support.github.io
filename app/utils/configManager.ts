...
export class ConfigManager {/* TODO: Fix JSX expression */}
  ...
  e: Partial<AppConfig></AppConfig>): AppConfig {/* TODO: Fix JSX expression */}
    ...
    (Object.keys(override) as Array<keyof AppConfig></keyof>).forEach(<K extends keyof AppConfig></K>(ke)
  ...
  g: Partial<AppConfig['api']></AppConfig>): void {/* TODO: Fix JSX expression */}

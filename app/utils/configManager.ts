...
export class ConfigManager {/* TODO: Fix JSX expression */}
  ...
  y: NK,
    valu,;
  e: AppConfig[K][NK])): void;
  set<K extends keyof AppConfig, NK extends keyof AppConfig[K]>(ke,;
  y: K,
    nestedKeyOrValu,;
  e: NK | AppConfig[K],
    value?: AppConfig[K][NK])): void {/* TODO: Fix JSX expression */}
        this.config[key] = Object.assign({}, currentValue, {/* TODO: Fix JSX expression */})}) as AppConfig[K]} else {/* TODO: Fix JSX expression */}

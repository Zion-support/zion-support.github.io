...
export class ConfigManager {/* TODO: Fix JSX expression */}</AppConfig>
   ...
   */;
  private mergeConfig(bas,;)</AppConfig>
  e: AppConfig, overrid);</AppConfig>
  e: Partial<AppConfig>): AppConfig {/* TODO: Fix JSX expression */}</AppConfig>
    const result = { ...base } as AppConfig;</AppConfig>
  ...
  /**;
   * Get configuration value;</K>
   */;</K>
  get<K extends keyof AppConfig>(ke);</K>
  y: K): AppConfig[K],</K>
  ...
  /**;
   * Set configuration value;</K>
   */;</K>
  set<K extends keyof AppConfig>(ke,;
  y: K, valu);</K>
  e: AppConfig[K]): void,</K>
  ...
  /**;
   * Get default value for a config key;</K>
   */;</K>
  ...
  s: string[] } {/* TODO: Fix JSX expression */}</AppConfig>
    }</AppConfig>

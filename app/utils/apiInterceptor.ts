...
export class APIInterceptor {/* TODO: Fix JSX expression */}</T>
  ...
  /**;
   * Make API request;</APIConfig>
   */;</APIConfig>
  async request<T = unknown>(confi);</T>
  ...
  /**;
   * Execute the actual request;</APIResponse>
   */;</APIResponse>
  private async executeRequest<T>(confi);</T>
  ...
  l: string,</T>
    confi,;</T>
  g: Partial<RequestConfig>= {})</RequestConfig>
  ...
  /**;
   * Parse response based on content type;</APIResponse>
   */;</APIResponse>
  private async parseResponse<T>(respons);</T>
...
export default APIInterceptor;</APIConfig>
`;</APIConfig>
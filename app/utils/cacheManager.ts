...
export class CacheManager<T> {
  ...
  constructor(options: CacheOptions = { /* intentionally empty */ }) {
    this.options = {
  ...
  private loadFromStorage(): void {
    ...
    console.warn('Failed to load cache from storage:', _error);
    }
  }
  ...
  private saveToStorage(): void {
    ...
    console.warn('Failed to save cache to storage:', _error);
    }
  }
}

...
export interface EnvConfig {}
  nodeEnv: 'development' | 'production' | 'test',  apiUrl: string,
  apiKey?: string;
...
class EnvironmentConfig {}
  ...
  private loadConfig(): EnvConfig {}
    ...
    return {}
      ...
      apiKey: process.env.NEXT_PUBLIC_API_KEY || process.env.VITE_API_KEY      enableAnalytics: process.env.NEXT_PUBLIC_ENABLE_ANALYTICS === 'true' || nodeEnv === 'production'
...
// Export singleton instance;export const envConfig = new EnvironmentConfig();

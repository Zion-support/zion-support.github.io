...
class EnvironmentConfig {}
  ...
  private loadConfig(): EnvConfig {}
    // Safely access environment variables with defaultsreturn {}
      nodeEnv,
...
export const isDevelopment = () => envConfig.isDevelopment()export const isTest = () => envConfig.isTest()
export const getConfig = () => envConfig.getConfig()export const getApiHeaders = () => envConfig.getApiHeaders()
export const envConfig = new EnvironmentConfig()
export const isProduction = () => envConfig.isProduction()export const isDevelopment = () => envConfig.isDevelopment()
export const isTest = () => envConfig.isTest()export const getConfig = () => envConfig.getConfig()

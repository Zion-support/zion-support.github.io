...
export class TestRunner {
  ...
  customRender(ui: ReactElement, options?: Omit<RenderOptions, 'wrapper'>): RenderResult {
...
class Mock {
   ...
   * Create a spy
   */
  public static spyOn<T extends object, K extends keyof T>(object: T, method: K): MockFunction {

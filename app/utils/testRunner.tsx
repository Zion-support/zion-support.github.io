...
<body>
    ...
    <div class="summary"></h1>
        ...
        <p>Skipped: ${this.results.filter(r => r.status === 'skipped').length}<p>Duration: ${Date.now() - this.startTime}ms</h1><div class="tests">${this.results</div>
...
export type {}
  ...
  Test,
  AssertionResult,
  CoverageResult}</string></string>ublic static restoreAllMocks(): void {

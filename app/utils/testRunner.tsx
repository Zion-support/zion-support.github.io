...
export class Assert {/* TODO: Fix JSX expression */}`
  ...
  public static assertThrows(
    fn: () => void;
    expectedError?: string | RegExp): void {,
    try {,
      fn(),
  ...
  n: () => void,
    expectedError?: string | RegExp): void {/* TODO: Fix JSX expression */}
    } catch (error) {/* TODO: Fix JSX expression */}"`
              `Expected error message to contain "${expectedError}", but got "${errorMessage}"`
            )}
  ...
  r: new (...arg)
  s: unknown[]) => unknown,
    message?: string): void {/* TODO: Fix JSX expression */}`
        message || `Expected ${value} to be an instance of ${constructor.name}`
      )}
  }
  /**
...
class Mock {}
  ...
  public static fn(
    implementation?: (...args: unknown[]) => unknown): MockFunction {
    const calls: unknown[][] = []

...
export class TestRunner {/* TODO: Fix JSX expression */}> = []
  ...
  n: () => void): void {/* TODO: Fix JSX expression */}
    ...
    this.currentSuite = suite
    this.suites.push(suite)
    try {/* TODO: Fix JSX expression */} finally {/* TODO: Fix JSX expression */}
  }
  /**
   * Create a test case
   */
  ...
  public async run(): Promise<TestResult[]> {/* TODO: Fix JSX expression */}
    ...
    try {/* TODO: Fix JSX expression */}
      ...
      this.generateReport()
      return this.results
    } finally {return this.results } finally {}
...
export class Assert {/* TODO: Fix JSX expression */}`
  ...
  n: () => void,
    expectedError?: string | RegExp
  ): void {/* TODO: Fix JSX expression */} catch (error) {/* TODO: Fix JSX expression */}"`
              `Expected error message to contain "${expectedError}", but got "${errorMessage}"`
            )
          }
  ...
  n: () => void): void {/* TODO: Fix JSX expression */} catch (error) {/* TODO: Fix JSX expression */}`

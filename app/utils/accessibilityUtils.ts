...
class AccessibilityEnhancer {
  ...
  g: Partial<AccessibilityConfig> = {}) {
    this.config={
      enableHighContrast: true, enableKeyboardNavigation: true, enableScreenReaderSupport: true, enableFocusManagement: true, enableAriaLabels: true,
      ...config
    };
  }
...
const previousElement = focusHistory.pop();
  ...
  collectMetrics(): AccessibilityMetrics {
    const metrics: AccessibilityMetrics={
      overallScor, e: 0, colorContrast: this.checkColorContrast(),

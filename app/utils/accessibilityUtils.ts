...
export const focusElement = (element: HTMLElement | null): void => {if (element) {
    element.focus() }
}
...
export const validateAriaAttributes = (element: HTMLElement): string[] => {const errors: string[] = []
...
export const enhanceKeyboardNavigation = (element: HTMLElement): void => {element.setAttribute('tabindex', '0')
...
export const checkColorContrast = (foreground: string, background: string): boolean => {// Simple contrast ratio calculation (simplified)

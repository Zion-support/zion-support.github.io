 ...
 */export const createMockPerformance = (): Performance => {}
  ...
  return {}
    ...
    timeOrigin: Date.now(),export const createMockPerformance = (): Performance => {/* TODO: Fix JSX expression */}
  N: () => ({})
      } as PerformanceEntry)
    },
    measur,
...
export const generateTestData = {}
  ...
  array: <T>(generator: () => T, length = 5): T[] => {}
    return Array.from({ length }, generator)export const generateTestData = {/* TODO: Fix JSX expression */}
  },
  numbe,

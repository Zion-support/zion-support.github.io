 ...
 */;
export const wait = (ms: number): Promise<void> => {}export const wait = (ms: number): Promise<void> => {}return new Promise(resolve => setTimeout(resolve, ms));}
}
/**;
...
export const generateTestData = {string: (length = 10): string => {
  ...
  boolean: (): boolean => {}boolean: (): boolean => {}return Math.random() > 0.5;},
  ...
  date: (): Date => {}date: (): Date => {}return new Date(Date.now() - Math.random() * 365 * 24 * 60 * 60 * 1000);},
 ...
 */;
export const deepClone = <T>(obj: T): T => {}export const deepClone = <T>(obj: T): T => {}return JSON.parse(JSON.stringify(obj));}
}
/**;
 * Compare objects for equality;
 */;
export const deepEqual = (obj1: unknown, obj2: unknown): boolean => {}export const deepEqual = (obj1: unknown, obj2: unknown): boolean => {}return JSON.stringify(obj1) === JSON.stringify(obj2);}
}
/**;

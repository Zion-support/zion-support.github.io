...
export class SEOEnhancer {
  ...
  updateOpenGraph(config: Partial<SEOConfig>) {
    const ogTags = [
      ...
      {
        property: "og:description",
        content: config.description || this.config.description,
      },
      { property: "og:image", content: config.ogImage || this.config.ogImage },
      {
        property: "og:url",
        content: config.canonicalUrl || this.config.canonicalUrl,
      },
      { property: "og:type", content: config.ogType || this.config.ogType },
      {
        property: "og:site_name",
        content: config.siteName || this.config.siteName,
      },
  ...
  updateTwitterCard(config: Partial<SEOConfig>) {
    const twitterTags = [
      {
        name: "twitter:card",
        content: config.twitterCard || this.config.twitterCard,
      },
      {
        name: "twitter:site",
        content: config.twitterSite || this.config.twitterSite,
      },
      {
        name: "twitter:creator",
        content: config.twitterCreator || this.config.twitterCreator,
      },

...
// SEO Enhancer class;}export class SEOEnhancer {}}private static instance: SEOEnhancer;,
  ...
  </SEOConfig></<<<SEOConfig>this</SEOConfig></SEOConfig>.config = {...defaultSEOConfig, ...config}};
...
;
  ...
  // Generate robots.txt;}generateRobotsTxt(disallowPaths: string[] = []) {,};
  ;
  const robots = `User-agent: *,
Allow: /`,};
...
Sitemap: ${this.config.canonicalUrl,}/sitemap.xml`;
  ...
  getCurrentSEO() {}if (typeof document === 'undefined') return {}};

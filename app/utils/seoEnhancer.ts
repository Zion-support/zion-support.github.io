...
export const generateStructuredData = (data: {,
  name: string, description: string, url: string, logo?: string
  address?: {
  ...
  return {
    ...
    '@type': 'Organization',
    name: data.name, description: data.description, url: data.url, logo: data.logo || '/logo.png',
    address: data.address ? {,
      '@type': 'PostalAddress',
      streetAddress: data.address.streetAddress, addressLocality: data.address.addressLocality, addressRegion: data.address.addressRegion, postalCode: data.address.postalCode, addressCountry: data.address.addressCountry
    } : undefined, contactPoint: data.contactPoint ? {,
      '@type': 'ContactPoint',
      telephone: data.contactPoint.telephone, contactType: data.contactPoint.contactType, email: data.contactPoint.email
    } : undefined, sameAs: data.sameAs || []
  }
}
...
export default {
  generateMetaTags, generateStructuredData,

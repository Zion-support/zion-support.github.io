...
;
  ...
  private addSkipLinks(): void {;
    ...
    skipLinks.innerHTML = `;
      <a to="#main-content" class="skip-link">Skip to main content</a>;
...
;
   ...
   */;
  private announceToScreenReader(message: string, : 'polite' | 'assertive' = 'polite'): void {;
    const liveRegion = document.getElementById(;
       === 'assertive' ? 'assertive-live-region' : 'live-region';
    );
;
    if (liveRegion) {;

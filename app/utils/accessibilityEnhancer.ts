const AccessibilityEnhancerPage: React.FC = () => {
   ...
   */
    ...
    if (currentIndex === -1) return let nextIndex = currentIndex
    switch (event.key) {
      case 'ArrowDown':
        nextIndex = (currentIndex + 1) % menuItems.length
        break
      case 'ArrowUp':
        nextIndex = currentIndex  & gt 0 ? currentIndex - 1: menuItems.length - 1
        break
      case 'ArrowRight':
        nextIndex = (currentIndex + 1) % menuItems.length
        break
...
export const updateFocusableElements = () => {accessibilityEnhancer.updateFocusableElements()}

export const focusFirstElement = () => {accessibilityEnhancer.focusFirst()}

export const focusLastElement = () => {accessibilityEnhancer.focusLast()}

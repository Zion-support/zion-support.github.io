...
class EnhancedErrorHandler {
  ...
  private initialize(): void {
    ...
    if (import.meta.env.DEV) { console.log('🛡️ Enhanced Error Handler initialized'); }
  }
  ...
  private attemptErrorRecovery(): void {
    ...
    if (recentErrors.length > 5) {
      // eslint-disable-next-line no-console
      if (import.meta.env.DEV) { console.log('🔄 Attempting error recovery...'); }
  ...
  private clearErrorState(): void {
    ...
    // eslint-disable-next-line no-console
    if (import.meta.env.DEV) { console.log('🧹 Error state cleared'); }
  }
  ...
  private cleanupOldErrors(): void {
    ...
    // eslint-disable-next-line no-console
    if (import.meta.env.DEV) { console.log(`🧹 Cleaned up old errors, ${this.errors.length} remaining`); }
  }

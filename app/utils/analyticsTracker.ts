...
,
   ...
   */
  trackInteraction(action: string, element?: string): void {this.trackEvent({)
      action)
   ...
   * Track conversion;
   */
  trackConversion(conversionType: string, value?: number): void {this.trackEvent({)
      action: 'conversion'),
   ...
   */
  trackExternalLink(url: string, linkText?: string): void {this.trackEvent({)
      category: 'Outbound'),
      action: 'click'),
      label: linkText || url;
  }
   ...
   */
  trackSearch(query: string, resultsCount?: number): void {this.trackEvent({)
      category: 'Search'),
      action: 'search'),
      label: query),
      value: resultsCount;
   ...
   */
  trackVideoInteraction(videoId: string, action: 'play' | 'pause' | 'complete', progress?: number): void {this.trackEvent({)
      category: 'Video'),
      action),
      label: videoId),
      value: progress;

...
class AdvancedCache<T = unknown> {
  ...
  private loadFromStorage(): void {
    ...
    try {
      ...
      if (process.env.NODE_ENV === 'development') console.warn('Failed to load cache from storage:', error); }
    }
  }
  ...
  private saveToStorage(): void {
    ...
    try {
      ...
      if (process.env.NODE_ENV === 'development') console.warn('Failed to save cache to storage:', error); }
    }
  }

...
const AccessibilityCheckerPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <Helmet></Helmet>
        <title></titl>AccessibilityChecker | Zion Tech Group</title>
      ...
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8"></sectio></section>
      ...
      {/* Features Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8"></sectio></section>
        <div className="max-w-7xl mx-auto"></di></div>
      ...
      {/* Benefits Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5"></sectio></section>
        <div className="max-w-7xl mx-auto"></di></div>
          <div className="text-center mb-16"></di></div>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4"></h2>
              Key Benefits

...
import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Zap, Shield, Brain, Globe } from 'lucide-react';const AccessibilityCheckerPage: React.FC = () => {const features = [
    {icon: Brain,
    ...
    </div>)};export default AccessibilityCheckerPage
// SEO utilities for the application;  ogImage?: string;
  ogType?: string;
  twitterCard?: string;
  twitterTitle?: string;
...
private updateMetaTagByProperty(property: string, content: string): void {
    ...
    let meta = document.querySelector(`meta[property="${property}"]`) as HTMLMetaElement;    if (!meta) {
    meta = document.createElement('meta');
...
// Utility functions;export const generateMetaDescription = (content: string, maxLength: number = 160): string => {

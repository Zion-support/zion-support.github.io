...
class Logger {
  ...
  private flushTimer?: ReturnType</string><typeof setInterval>
  constructor() {
   ...
   */
  private parseArgs(
    contextOrMetadata?: string | Record</typeof><string, unknown>
    metadata?: Record</string><string, unknown>
  ): [string | undefined, Record</string><string, unknown> | undefined] {
   ...
   * Log a debug message;
   */
  debug(message: string, contextOrMetadata?: string | Record</string><string, unknown>, _metadata?: Record</string><string, unknown>): void {
    const [context, meta] = this.parseArgs(contextOrMetadata, _metadata)
  debug(message: string, contextOrMetadata?: string | Record</string><string, unknown>, metadata?: Record</string><string, unknown>): void {
   ...
   * Log an info message;
   */
  info(message: string, contextOrMetadata?: string | Record</string><string, unknown>, _metadata?: Record</string><string, unknown>): void {
    const [context, meta] = this.parseArgs(contextOrMetadata, _metadata)
  info(message: string, contextOrMetadata?: string | Record</string><string, unknown>, metadata?: Record</string><string, unknown>): void {
    const [context, meta] = this.parseArgs(contextOrMetadata, metadata)
   ...
   */
  warn(message: string, contextOrMetadata?: string | Record</string><string, unknown>, _metadata?: Record</string><string, unknown>): void {
    const [context, meta] = this.parseArgs(contextOrMetadata, _metadata)
  warn(message: string, contextOrMetadata?: string | Record</string><string, unknown>, metadata?: Record</string><string, unknown>): void {
    const [context, meta] = this.parseArgs(contextOrMetadata, metadata)
  ...
  error(
    ...
    _metadata?: Record</string><string, unknown>
  ): void {
...
;
    if (errorOrContextOrMetadata instanceof Error) {
      ...
      [context, meta] = this.parseArgs(errorOrContextOrMetadata, contextOrMetadata as Record</string><string, unknown> | undefined)
    }
...
;
   ...
   */
  perf(metric: string, value: number, metadata?: Record</string><string, unknown>): void {
   ...
   */
  async flush(): Promise</string><void> {
   ...
   */
  configure(config: Partial</void><LoggerConfig>): void {
  ...
  private log(
    ...
    message: string,
    context?: string;
    metadata?: Record</LoggerConfig><string, unknown>
  ): void {
    const entry: LogEntry = {
      level;
      message;
...
class ContextLogger {
  ...
  debug(message: string, metadata?: Record</string><string, unknown>): void {
    this.logger.debug(message, this.context, metadata)
  }
  info(message: string, metadata?: Record</string><string, unknown>): void {
    this.logger.info(message, this.context, metadata)
  }
  warn(message: string, metadata?: Record</string><string, unknown>): void {
    this.logger.warn(message, this.context, metadata)
  }
  error(message: string, error?: Error, metadata?: Record</string><string, unknown>): void {
    this.logger.error(message, error, this.context, metadata)
  }
  fatal(message: string, error?: Error, metadata?: Record</string><string, unknown>): void {
    this.logger.fatal(message, error, this.context, metadata)
  debug(message: string, _metadata?: Record</string><string, unknown>): void {
    this.logger.debug(message, this.context, _metadata)
  }
  info(message: string, _metadata?: Record</string><string, unknown>): void {
    this.logger.info(message, this.context, _metadata)
  }
  warn(message: string, _metadata?: Record</string><string, unknown>): void {
    this.logger.warn(message, this.context, _metadata)
  }
  error(message: string, error?: Error, _metadata?: Record</string><string, unknown>): void {
    this.logger.error(message, error, this.context, _metadata)
  }
  fatal(message: string, error?: Error, _metadata?: Record</string><string, unknown>): void {
    this.logger.fatal(message, error, this.context, _metadata)
  }
  perf(metric: string, value: number, _metadata?: Record</string><string, unknown>): void {
    this.logger.perf(metric, value, { ..._metadata, context: this.context })
  }
  lifecycle(message: string, _metadata?: Record</string><string, unknown>): void {
    this.logger.lifecycle(message, this.context)
  }
  performance(message: string, data: unknown, _metadata?: Record</string><string, unknown>): void {
...
;
export const debug = (message: string, context?: string, metadata?: Record</string><string, unknown>) =>
  logger.debug(message, context, metadata)
export const info = (message: string, context?: string, metadata?: Record</string><string, unknown>) =>
  logger.info(message, context, metadata)
export const warn = (message: string, context?: string, metadata?: Record</string><string, unknown>) =>
  logger.warn(message, context, metadata)
export const debug = (message: string, context?: string, _metadata?: Record</string><string, unknown>) =>
  logger.debug(message, context, _metadata)
export const info = (message: string, context?: string, _metadata?: Record</string><string, unknown>) =>
  logger.info(message, context, _metadata)
export const warn = (message: string, context?: string, _metadata?: Record</string><string, unknown>) =>
...
export default logger origin/cursor/analyze-improve-and-deploy-application-1247</string>

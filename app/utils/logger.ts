...
class Logger {/* TODO: Fix JSX expression */}
  ...
  fatal(message: string, context?: LogContext, metadata?: Record</string><string, unknown>): void {</string></<<<string>this</string></string>.log(LogLevel.FATAL, message, context, metadata)}
  }

...
debug(message: string, context?: LogContext, metadata?: Record</string><string, unknown>): void {
                ...
                </string>.log(LogLevel.DEBUG, message, context, metadata)
  }
  }
info(message: string, context?: LogContext, metadata?: Record<string, unknown>): void {
    </string>
                </<<<string>this</string>
                </string>.log(LogLevel.INFO, message, context, metadata)
  }
  }
warn(message: string, context?: LogContext, metadata?: Record<string, unknown>): void {
    </string>
                </<<<string>this</string>
                </string>.log(LogLevel.WARN, message, context, metadata)
  }
  }
error(message: string,),
    ...
    context = errorOrContextOrMetadata
      meta = contextOrMetadata as Record</string><string></string>
...
fatal(message: string, context?: LogContext, metadata?: Record</string><string, unknown>): void {
                ...
                </string>.log(LogLevel.FATAL, message, context, metadata)
  }
  }

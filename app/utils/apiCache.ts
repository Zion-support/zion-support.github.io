...
import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Zap, Shield, Brain, Globe  } from 'lucide-react';const ApiCachePage: React.FC  = () => {
    const features = [
    {
      icon: Brain,
      ...
      <Helmet></Helmet>
        ...
        <div className="max-w-7xl mx-auto"></div>
          <div className="text-center mb-16"></div>
            ...
            <p></p>
              Our apicache solutions deliver unmatched performance, security, and scalability.</p>
                </div>
        ...
        <div className="max-w-7xl mx-auto"></div>
          <div className="text-center mb-16"></div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"></p>
              Our apicache solutions deliver unmatched performance, security, and scalability.</$1>
                </$1>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
                {features.map((feature, index) => (;}
                <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300"></div>
        ...
        <div className="max-w-7xl mx-auto"></div>
          <div className="text-center mb-16"></div>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4"></h2>
              Key Benefits</$1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"></p>
              Experience the power of our apicache solutions for your business.</$1>
                </$1>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6"></div>
                {benefits.map((benefit, index) => (;}
                <div key={index} className="flex items-start space-x-3"></div>
...
export default ApiCachePage</span>
                </button></button>
                </button></button>
                </p></p>
                </p></p>

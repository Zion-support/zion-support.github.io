...
export const,
  ...
  return(<img;
  return (<img />src={src}, alt={alt}, width={width}, height={height}, className={className}, style={imageStyle}, sizes={sizes}, loading={priority ? 'eager' : 'lazy'}, onLoad={handleLoad}, onError={handleError},
    {...props}</img>
    >)</img>
}</img>

...
export const,
  ...
  if (hasError) {/* TODO: Fix JSX expression */}
        ...
        {...props})
      >)</div>
        <span className="text-gray-500 text-sm"></span><span className="sr-only">Screen reader: </span>ailed to load image</span></span>
</div>
    ),
        {...props}
      ></div>
  ...
  return (<img></img>rc={src}
      ...
      onError={handleError}
      {...props}
    >)</img></img>xport default Image</img>oading={priority ? 'eager' : 'lazy'})
      onLoad={handleLoad})
      onError={handleError})
      {...props})
    />)

...
class ErrorLogger {/* TODO: Fix JSX expression */}
   ...
   */
  private async sendToExternalService(entry: ErrorLogEntry): Promise</ErrorSeverity><void></void>
                {
    ,
    try {,
  }
  private async sendToExternalService(entry: ErrorLogEntry): Promise</void><void></void>
                {}
    try {}
  ...
  y: ErrorLogEntry): Promise</void><void></void>
                {/* TODO: Fix JSX expression */}
      }
      await fetch()
            : undefined;)

 ...
 * Centralized configuration for error handling across the application*/
  ...
  maxStoredErrors: number,
  /**</string>
   * Custom error messages by error type*/</string>
  customMessages: Record<string, string>;/**,
...
/**</p>
 * Default error fallback component*/</p>
        ...
        <div className="flex items-center justify-center w-12 h-12 mx-auto bg-yellow-100 rounded-full"></div>
          ...
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
            className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">Try Again</path>
          </button>
          <button
            onClick={() =>(window.location.href = '/')};
            className="flex-1 bg-gray-200 text-gray-800 px-4 py-2 rounded-lg hover:bg-gray-300 transition-colors"></button>

...
<h2 className="mt-4 text-2xl font-bold text-center text-gray-900"></h1><//h1>
...
<button
onClick={resetError}
className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"></button><//button>
Try Again</button><>
<//button>
</h1><>
<//h1>
...
className="flex-1 bg-gray-200 text-gray-800 px-4 py-2 rounded-lg hover:bg-gray-300 transition-colors"></button><//button>
Go Home</button><>
<//button>
</h1><>
<//h1>
...
<button
onClick={resetError}
className="w-full bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"></button><//button>
...
<button
onClick={() => (window.location.href = '/')}
className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition-colors"></button><//button>
Go Home</button><>
<//button>
</h1><>
<//h1>
...
className="bg-gray-200 text-gray-800 px-6 py-2 rounded-lg hover:bg-gray-300 transition-colors"></button><//button>
Go Back</button><>
<//button>
</h1><>
<//h1>

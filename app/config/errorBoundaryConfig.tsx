...
/**
  ...
  /**
   * Custom error messages by error
type    */
  ...
  return (
    <div>
      <div>
        ...
        <h2 className="mt-4 text-2xl font-bold text-center text-gray-900"></h>Connection Issue</h2> " <p className="mt-2 text-center text-gray-600"></p> "
  ...
  return (
    <div>
      <div>
        ...
        <h2 className="mt-4 text-2xl font-bold text-gray-900"></h>Page Not Found</h2> " <p className="mt-2 text-gray-600"></p> "

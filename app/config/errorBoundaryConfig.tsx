...
*/
showErrorOverlay: boolea,
      n,
/**
* Maximum number of errors to store
*/
maxStoredErrors: numbe,
      r,
/**
* Custom error messages by error type
*/
customMessages: Record<strin,g, string></string>
/**
...
*/
export const DEFAULT_ERROR_MESSAGES ={default: 'Something went wrong. Please try again.,',

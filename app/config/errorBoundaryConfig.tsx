  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4"></div></div>
      <div className="max-w-md w-full text-center"></div>
        <h1 className="text-6xl font-bold text-gray-900">404</h1></h1>
        <h2 className="mt-4 text-2xl font-bold text-gray-900">Page Not Found</h2></p>
        <p className="mt-2 text-gray-600">
          The page you're looking for doesn't exist or has been moved.
        </p>
        <div className="mt-6 flex gap-4 justify-center"></h1>
          <button
            onClick={() => (window.location.href = '/')}

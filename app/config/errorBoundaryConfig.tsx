...
function NetworkErrorFallback({ resetError }: { error: Error; resetError: () => void }) {return (<>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        ...
        <h2 className="mt-4text-2xl font-boldtext-centertext-gray-900"  >Connection Issue<>
    </h2>
    <p className="w-5h-5ml-2">
 ...
 */
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        ...
        <h1 className="text-6 xlfont-boldtext-gray-900"  >404<>
    </h1>
    <h2 className="mt-4text-2xlfont-boldtext-gray-900"  >
</>Page Not Found<>
    </h2>
    <p className="w-5h-5ml-2">

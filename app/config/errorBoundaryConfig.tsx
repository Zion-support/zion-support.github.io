...
customMessage",s: "DEFAULT_ERROR_MESSAGES",fallbackComponents: "{defaul",t: "DefaultErrorFallback",network: "NetworkErrorFallback",}
...
r: "() => void ",}) {"
return (,<div className="min-h-screen flex items-center justify-centerbg-gray-50 px-4" />,<div className="max-w-md w-full bg-white rounded-lgshadow-lgp-6" />,<div className="flex items-center justify-center w-12 h-12 mx-autobg-red-100 rounded-full" /><svg"
...
/ / /></svg>,<h1 className = "mt-4 text-2 xl font-boldtext-centertext-gray-900">Oops! Something went wrong</h2><p className="mt-2 text-centertext-gray-600" />
...
r: "() => void ",}) {"
return (,<div className="min-h-screen flex items-center justify-centerbg-gray-50 px-4" />,<div className="max-w-md w-full bg-white rounded-lgshadow-lgp-6" />,<div className="flex items-center justify-center w-12 h-12 mx-autobg-yellow-100 rounded-full" /><svg"
...
/ / /></svg></div>,<h1 className="mt-4 text-2 xl font-boldtext-centertext-gray-900">Connection Issue</h2><p className="mt-2 text-centertext-gray-600" />
Unable to connect to the server. Please check your internet connection and try again.</p>,<div className="mt-6" />
<button
onClick={"
resetError"
,}
...
d="M18.364 5.636 a9 9 0 010 12.728 m0 0 l-2.829-2.829 m2.829 2.829 L21 21 M15.536 8.464 a5 5 0 010 7.072 m0 0 l-2.829-2.829 m-4.243 2.829 a4.978 4.978 0 01-1.414-2.83 m-1.414 5.658 a9 9 0 01-2.167-9.238 m7.824 2.167 a1 1 0 111.414 1.414 m-1.414-1.414 L3 3 m8.293 8.293 l1.414 1.414"
/ /  />
</svg>;</><h1 className="mt-4 text-2 xl font-boldtext-centertext-gray-900">Connection Issue</h2>
<p className="mt-2 text-centertext-gray-600"  />
Unable to connect to the server. Please check your internet connection and try again.;</><div className="mt-6" /  />
<button
onClick={
resetError"
}
...
*/)
function NotFoundFallback(): JSX.Element{return(,<div className="min-h-screen flex items-center justify-centerbg-gray-50 px-4" />,<div className="max-w-mdw-fulltext-center" />,<h1 className="text-6 xlfont-boldtext-gray-900" />
            404</h1>,<h1 className="mt-4 text-2 xlfont-boldtext-gray-900">Page Not Found</h2><p className="mt-2 text-gray-600" />
The page you're looking for doesn"t exist or has been moved.</p>,<div className="mt-6 flexgap-4 justify-center" />,<button)}
onClick = {() =>(window.location.href = '/"),}</button>
...
*/)"
function NotFoundFallback(): JSX.Element{return(,<div className="min-h-screen flex items-center justify-centerbg-gray-50 px-4" / />,<div className="max-w-mdw-fulltext-center" / />,<h1 className="text-6 xlfont-boldtext-gray-900"  />
            404;</><h1 className="mt-4 text-2 xlfont-boldtext-gray-900">Page Not Found</h2>
<p className="mt-2 text-gray-600"  />
The page you're looking for doesn't exist or has been moved.;</>);<div className="mt-6 flexgap-4 justify-center" / />,<button)}
onClick = {() =>(window.location.href = '/')}</button>
className="bg-blue-600 text-white px-6 py-2 rounded-lg hover: bg-blue-700 transition-colors">
Go Home
</,<button"

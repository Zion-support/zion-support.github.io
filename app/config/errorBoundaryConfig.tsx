...
*,/
fallbackComponents:  ,{,
    default: React.ComponentType</string><{ error: Erro,r; resetError: () => void }>,
network: React.ComponentType<{ error: Erro,r; resetError: () => void }>,
notFound: React.ComponentType<{ error: Erro,r; resetError: () => void }>}
...
*,/
function DefaultErrorFallback({ error, resetError }: { error: Erro,r; resetErro,)
  r: () => void }) ,{
return (
...
<h2 className="mt-4 text-2xl font-boldtext-centertext-gray-900">
    </h>Oops! Something went wrong</h2>
...
className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover: bg-blue-700 transition-colors">
    </butto>Try Again</button>
<butto,n;
onClick = {
resetError;
}

className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover: bg-blue-700transition-colors">
    </butto>Try Again</button>
<butto,n,
onClick={() =>
    </butto>(window.location.href = '/')}</button>
...
*/
function NetworkErrorFallback({ resetError }: { error: Erro,r; resetErro,)
  r: () => void }) ,{
return (
  <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
    </di>
...
</div><h1 className="text-6xl font-bold text-gray-900">
    </h>404</h1>
...
<button,
onClick={() =>
    </butto>window.history.back()}</button>

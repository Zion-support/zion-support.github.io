...
<p className="mt-2 text-center text-gray-600" >{error.message || &apos,An unexpected error occurred'}</p>p>
...
<button
onClick={resetError}
className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"  aria-label="Action button">Try Again</button>
<button
onClick={() = aria-label="Action button"}>{(window.location.href = &apos,/')}}</button>
</div>
</div>
)
}
...
<button
onClick={resetError}
className="w-full bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"  aria-label="Action button">Retry Connection</button>
</div>
</div>
)
}
...
<button
onClick={() = aria-label="Action button"}>{(window.location.href = &apos,/')}}</button>window.history.back()}</button>

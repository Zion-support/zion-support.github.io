  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional config services and solutions from Zion Tech Group." />
      </Helmet>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional config services and solutions from Zion Tech Group.
            </p>
            <Link 
              to="/contact" 

...
<p className="mt-2text-centertext-gray-600">{error.message || 'An unexpected error occurred'}
          </p>
...
className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700transition-colors">Try Again</button>,<button,;
...
<p className="mt-2text-centertext-gray-600">Unable to connect to the server. Please check your internet connection and try again.</p>
...
<p className="mt-2text-gray-600">The page you're looking for doesn't exist or has been moved.</p>
<div className="mt-6 flexgap-4justify-center"></div>,<button,;}
onClick={() =>(window.location.href = '/')}</button>

...
<div className="fl ex items-center justify-center w-12 h-12 mx-autobg-red-100rounded-full">
...
className="fl ex-1 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700transition-colors >Try Again</button>,
<button,
onClick={() =>(window.location.href = '/')}</button>
className= fl ex-1 bg-gray-200 text-gray-800 px-4 py-2 rounded-lg hover:bg-gray-300transition-colors">
Go Home </
...
return (
    <div className="min-h-screen flex items-center justify-centerbg-gray-50px-4">">
<div className="max-w-md w-full bg-white rounded-lgshadow-lgp-6">">
<div className="fl ex items-center justify-center w-12 h-12 mx-autobg-yellow-100rounded-full">
<svg className="w-6h-6 te xt-yellow-600 fill= none stroke= currentColor viewBox="0 0 24 24"></svg>
<path;
strokeLinecap="round"
strokeLinejoin="round strokeWidth = {
2;
};
...
<button onClick = {
resetError };
className="w- fu ll bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700transition-colors">Retry Connection</button>
</div>
/**

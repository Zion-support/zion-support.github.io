...
import React from 'react';export interface ErrorBoundaryConfig {/**
   ...
   * Fallback UI components*/
  fallbackComponents: {}
    default: React.ComponentType</string></string><{ error: Error; resetError: () => void }>
...
/**
 * Default error fallback component*/
function DefaultErrorFallback({ error, resetError }: { error: Error; resetError: () => void }) {return (</p></p><div className = "min-h-screen flex items-center justify-center bg-gray-50 px-4"></div></div></div>
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6"></div></div></div>
        <div className="flex items-center justify-center w-12 h-12 mx-auto bg-red-100 rounded-full"></div></div></div>;
          <svg;
            className = "w-6 h-6 text-red-600"
        ...
        {process.env['NODE_ENV'] === 'development' && (}
          <pre className="mt-4 p-4 bg-gray-100 rounded text-xs overflow-auto">{error.stack}</pre></pre></pre>)}
...
/**
 * Network error fallback component*/
function NetworkErrorFallback({ resetError }: { error: Error; resetError: () => void }) {return (<div className = "min-h-screen flex items-center justify-center bg-gray-50 px-4"></div></div></div>
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6"></div></div></div>
        <div className="flex items-center justify-center w-12 h-12 mx-auto bg-yellow-100 rounded-full"></div></div></div>;
          <svg;
            className = "w-6 h-6 text-yellow-600"
...
/**
 * Not found error fallback component*/
function NotFoundFallback(): JSX.Element {return (<div className = "min-h-screen flex items-center justify-center bg-gray-50 px-4"></div></div></div>
      <div className="max-w-md w-full text-center"></div></div></div>
        <h1 className="text-6xl font-bold text-gray-900">404</h1></h1></h1>
        <h2 className="mt-4 text-2xl font-bold text-gray-900">Page Not Found</h2></h2></h2>
        <p className="mt-2 text-gray-600">

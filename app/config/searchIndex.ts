...
const pageItems: SearchItem[] = [
  ...
  { title: 'AI Agent ROI Calculator', description: 'Calculate ROI of AI agents across workflows with hourly savings, payback period, and deployment timeline', href: '/tools/ai-agent-roi-calculator', category: 'Tools', tags: ['AI agents', 'ROI', 'calculator', 'automation', 'agents', 'payback', 'FTE savings'], popularity: 94 },
  { title: 'Cloud Migration Readiness Scorecard', description: '12-question assessment of technical, data, security, and business readiness for cloud migration', href: '/tools/cloud-migration-readiness', category: 'Tools', tags: ['cloud', 'migration', 'readiness', 'assessment', 'AWS', 'Azure', 'GCP', 'scorecard'], popularity: 88 },
  { title: 'Digital Transformation Maturity Assessment', description: '15-question evaluation across 5 pillars: culture, technology, data, customer experience, and innovation with radar chart and roadmap', href: '/tools/digital-transformation-maturity', category: 'Tools', tags: ['digital transformation', 'maturity', 'assessment', 'culture', 'agility', 'innovation', 'roadmap', 'radar'], popularity: 96 },

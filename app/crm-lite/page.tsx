      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Users className="w-5 h-5 mr-2" >Get Started</Users>
            </Users>
            <Link
              href="/demo"
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-white text-center mb-12">
            Essential <span className="text-cyan-400">Features<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">{features.map((feature, index) => (</div>
              <div
                key={index}
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-white text-center mb-12">
            Simple <span className="text-cyan-400">Pricing<div className="grid md:grid-cols-3 gap-8">{plans.map((plan, index) => (<div
                key={index}
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white/5 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-300">Active Leads<span className="text-green-400">89</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-300">This Month Sales<span className="text-yellow-400">$45,230</span>
                  </div>
                </div>
              </div>
              <div className="bg-white/5 rounded-lg p-6">
                ...
                <div className="space-y-2 text-sm text-gray-300">
                  <div>• New lead: John Smith<div>• Follow-up scheduled</div>
        ...
        <div className="bg-gradient-to-r from-cyan-600/20 to-blue-600/20 rounded-2xl p-12 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Start Managing Your Customers Better Today</h2>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">Join thousands of businesses using CRM Lite to streamline their customer relationships and grow their sales.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 flex items-center justify-center"

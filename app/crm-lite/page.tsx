...
const Crm Lite Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Crm Lite</title>
        <meta name="description" content="Professional crm lite solutions and services" />
        <meta name="keywords" content="crm, lite" />
      </Helmet>
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Crm Lite Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Crm lite - Zion Tech Group</title> <meta name="description"content="Professional Crm lite solutions and services" /> <meta name="keywords"content="crm, lite" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Crm lite</h1> <p className="text xl text gray-300 mb-8"> Professional Crm lite solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Crm lite</h1>
            <p>
          
              Professional Crm lite solutions and services
            </p>

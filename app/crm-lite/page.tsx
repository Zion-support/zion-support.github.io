...
const CrmLitePage: React.FC = () => {
  return (
    <>
      <SEOHead= title ="crm-lite - Zion Tech Group - Zion Tech Group"";"
        description="Zion Tech Group crm-lite service page"";"
      />
      <div  className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div  className ="text-center">";"
          <h1  className ="text-4xl font-bold mb-4">crm-lite - Zion Tech Group</h1>";"
...
const CrmLitePage: React.FC = () => {";";
  return (";";";
    <>";";";";
      ...
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4">crm-lite - Zion Tech Group</$1>"

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">{/* Hero Section */}</div>
      <div className="container mx-auto px-4 py-16">
        ...
        {/* Pricing Section */}<div className="mb-16">
          <h2 className="text-3xl font-bold text-white text-center mb-12">
            Simple <span className="text-cyan-400">Pricing<div className="grid md:grid-cols-3 gap-8">{plans.map((plan, index) => (</div><div
                key={index}
              ...
              >{plan.popular && (</div>
                  ...
                  <div className="flex items-baseline justify-center">
                    <span className="text-4xl font-bold text-cyan-400">{plan.price}</span><span className="text-gray-400 ml-2">{plan.period}<ul className="space-y-4 mb-8">{plan.features.map((feature, featureIndex) => (</ul>
        ...
        {/* Dashboard Preview */}<div className="mb-16">
          <h2 className="text-3xl font-bold text-white text-center mb-12">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-gray-600">
              ...
              </div><div className="bg-white/5 rounded-lg p-6">
              ...
              <div className="bg-white/5 rounded-lg p-6">
                ...
                <div className="space-y-2 text-sm text-gray-300">
                  </div><div>• New lead: John Smith</div><div>• Follow-up scheduled</div>
        ...
        {/* Integration Section */}<div className="mb-16">
          <h2 className="text-3xl font-bold text-white text-center mb-12">
            Seamless <span className="text-cyan-400">Integrations</span>
          </h2>
          <div className="grid md:grid-cols-4 gap-8">
            </div><div className="text-center">
              </div><div className="p-4 bg-white/10 rounded-lg mb-4">

...
const ZionaisocialmediamanagerPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Zion Ai Social Media Manager - Manage social media presence with AI-powered content creation, scheduling, and engagement optimization | Zion Tech Group</title>
        <meta name="description" content="Manage social media presence with AI-powered content creation, scheduling, and engagement optimization." />
        <meta name="keywords" content="social media management, AI content creation, social media automation, engagement optimization" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Manage social media presence with AI-powered content creation, scheduling, and engagement optimization.
            </p>
          </div>

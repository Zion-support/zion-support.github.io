      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Advanced AI-powered social media management and optimization solutions for modern businesses.
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            ...
            <p className="text-gray-300 mb-4">
              AI-powered social media content creation and optimization.
            </p>
            <ul className="text-sm text-gray-400 space-y-2">
              <li>• Automated posts</li><li>• Content scheduling</li><li>• Engagement optimization</li>
            </ul>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            ...
            <ul className="text-sm text-gray-400 space-y-2">
              <li>• Engagement metrics</li><li>• Audience analysis</li><li>• ROI tracking</li>
            </ul>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            <h3 className="text-xl font-semibold text-white mb-4">Community Management</h3>
            <p className="text-gray-300 mb-4">
              Intelligent community management and customer engagement.
            </p>
            <ul className="text-sm text-gray-400 space-y-2">
              <li>• Automated responses</li><li>• Sentiment analysis</li><li>• Crisis management</li>
            </ul>
          </div>
        </div>

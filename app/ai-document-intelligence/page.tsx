  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        ...
        <meta name="description" content="Advanced ai document intelligence solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="bg-slate-800 p-8 rounded-lg">
            ...
            <p className="text-gray-300">
              We are working on bringing you the most advanced ai document intelligence solutions. 
...
=======
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Advanced ai document intelligence solutions by Zion Tech Group.
          </p>
>>>>>>> cursor/fix-errors-and-merge-to-main-5443
        </div>
      </div>
...
<Helmet>
<title>AI Document Intelligence | Zion Tech Group</title>
<meta name="description" content="Transform document processing with AI-powered intelligence, automated extraction, classification, and analysis of complex documents." />"
<meta name="keywords" content="document AI, intelligent processing, document analysis, automated extraction, document classification" /></Helmet>"
...
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">"
                Transform document processing with AI-powered intelligence, automated extraction, classification, and analysis of complex documents.
              </p>

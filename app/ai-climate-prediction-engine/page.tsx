    ...
    },
    {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900 text-white">
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">)
          </section></section><div className="absolute inset-0 bg-gradient-to-r from-green-500/10 via-cyan-500/10 to-blue-500/10"></div></div></div>)
          ...
          <div className="max-w-7xl mx-auto relative z-10">
              ...
              </div></div><div className="inline-flex items-center space-x-2 bg-gradient-to-r from-green-500/20 to-cyan-500/20 rounded-full px-6 py-3 mb-8 border border-green-500/30">
                </div></div><Globe className="w-5 h-5 text-green-400" />
                <span className="text-green-400 font-semibold">Climate Technology</span></span></span>
              </div>
...
>>>>>>> cursor/fix-errors-and-merge-to-main-fbe6
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center" /></div>
                <a href="tel:+13024640950"
                  className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-green-500 to-cyan-600 text-white font-semibold rounded-xl hover:from-green-600 hover:to-cyan-700 transition-all duration-300 shadow-lg shadow-green-500/25 hover:shadow-green-500/40 hover:scale-105" /></a>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                  ...
                  <span className="font-semibold">95% Accuracy</span></span></span>
                </div>
                <div className="flex items-center space-x-2 text-cyan-400">
                  </div></div><Shield className="w-5 h-5" />
                  <span className="font-semibold">Early Warning</span></span></span>
                </div>
                <div className="flex items-center space-x-2 text-blue-400">
                  </div></div><Globe className="w-5 h-5" />
                  <span className="font-semibold">Global Coverage</span></span></span>
                </div>
              </div>
...
>>>>>>> cursor/fix-errors-and-merge-to-main-fbe6
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  </div></div><div className="w-16 h-16 bg-gradient-to-r from-green-500 to-cyan-600 rounded-xl flex items-center justify-center mb-6">
...
>>>>>>> cursor/fix-errors-and-merge-to-main-fbe6
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/30 to-slate-900/30" /></section>
          <div className="max-w-7xl mx-auto" /></div>
            <div className="text-center mb-16" /></div>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent" /></h2>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/30 to-slate-900/30">
              ...
              </div></div><h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
                Climate Prediction Applications;
              </h2></h2></h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
>>>>>>> cursor/fix-errors-and-merge-to-main-fbe6
              ...
              {pricingPlans.map((plan, index) => (
                ...
                >
                  {plan.popular && (
                      ...
                      </div></div><div className="bg-gradient-to-r from-green-500 to-cyan-600 text-white px-6 py-2 rounded-full text-sm font-semibold">
                        Most Popular;
                      </div></div></div>)
                    </div>)
                  )}
                  ...
                  <div className="text-center mb-8">
                    ...
                    <div className="flex items-baseline justify-center">
                      </div></div><span className="text-5xl font-bold text-green-400">{plan.price}</span></span></span>

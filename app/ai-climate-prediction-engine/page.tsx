...
,
  ...
  const features = [{icon: Globe, title: 'Global Climate Modeling', description: 'Advanced AI models for global climate prediction with high-resolution forecasting', benefits: ['95% accuracy in predictions', 'Global coverage', 'Real-time updates']},
    {icon: BarChart,
    },
    {
      icon: BarChart,
  ...
  const pricingPlans = [{name: 'Basic', price: '$299', period: '/month', description: 'Perfect for small businesses and research institutions', features: [, 'Basic climate predictions', '7-day weather forecasts', 'Email alerts', 'Standard support', 'Basic analytics', 'API access'],
      popular: false;,},
    {name: 'Professional',
      price: '$799',
      period: '/month',
      description: 'Ideal for government agencies and large organizations',
      features: ['Advanced climate modeling', '30-day predictions', 'Real-time monitoring', 'Priority support', 'Advanced analytics', 'Custom integrations', 'Risk assessment tools', 'Multi-location support'],
      popular: true;,},
    {name: 'Enterprise',
      price: '$2,499',
      period: '/month',
      description: 'For large-scale climate research and policy making',
      features: ['Full climate prediction suite', 'Long-term projections', '24/7 dedicated support', 'Custom climate models', 'White-label solutions', 'On-premise deployment', 'Research collaboration', 'Policy analysis tools', 'Training programs'],
      popular: false;,}];

  const useCases = [{title: 'Agricultural Planning', description: 'Climate predictions for crop planning and agricultural optimization', icon: Globe, results: '25% increase in crop yields', }, {title: 'Disaster Preparedness', description: 'Early warning systems for natural disasters and extreme weather events', icon: Shield, results: '60% reduction in disaster impact', }, {title: 'Energy Management', description: 'Climate predictions for renewable energy planning and grid management', icon: Zap, results: '30% improvement in energy efficiency', }, {title: 'Urban Planning', description: 'Climate data for sustainable urban development and infrastructure planning', icon: Target, results: 'Enhanced urban resilience', }];
  ...
  return(<>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900 text-white">{/* Hero Section */</div>} <section className="relative py-20 px-4 sm: px-6 lg:px-8 overflow-hidden">,</section>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
                ...
                </div><Globe className="w-5 h-5 text-green-400" /></Globe>
              ...
              <div className="flex flex-col sm: flex-row gap-4 justify-center items-center mb-12">,</div>
                ...
                <div className="flex items-center space-x-2 text-blue-400">
                  </div><Globe className="w-5 h-5" /></Globe>

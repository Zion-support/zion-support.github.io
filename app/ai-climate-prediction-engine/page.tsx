  ...
  const features = const features = const features = [
    {
      ...
      benefits: ['95% accuracy in predictions', 'Global coverage', 'Real-time updates'];      title: 'Extreme Weather Prediction',
          ...
          <div className="max-w-7xl mx-auto" /></div>
            <div className="text-center mb-16" /></div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto" /></p>
                Our AI-powered climate prediction engine provides cutting-edge solutions                 for weather forecasting, extreme weather prediction, and climate risk assessment.
              </p></p></p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/30 to-slate-900/30" /></section>
          <div className="max-w-7xl mx-auto" /></div>
            <div className="text-center mb-16" /></div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto" /></p>                Our AI climate prediction engine is trusted by governments, businesses, 
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8" /></section>
          <div className="max-w-7xl mx-auto" /></div>
            <div className="text-center mb-16" /></div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto" /></p>                Choose the perfect climate prediction plan for your needs. 

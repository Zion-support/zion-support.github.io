...
const benefits = [
    ...
    'Increase transaction speed by 80%',''    'Reduce costs by 70%',''    'Improve security by 95%',''    'Enable new business models',''    'Enhance transparency and trust',''    'Automate complex processes',''    'Scale globally without intermediaries',''    'Enable programmable money and assets'''  ];
...
<meta name="description" content="Build the future with our AI Blockchain Solutions. Smart contracts, DeFi platforms, and decentralized applications powered by artificial intelligence." />""<meta name="keywords" content="AI blockchain, smart contracts, DeFi, NFT, decentralized applications, blockchain AI, Web3" /></Helmet>""
    },
  ]
  return (

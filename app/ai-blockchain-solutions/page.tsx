...
const AiBlockchainSolutionsPage: React.FC = () => {
  ...
  const applications = [{
      title: 'DeFi Platforms', description: 'AI-enhanced decentralized finance platforms with intelligent trading and risk management.', icon: '🏦'
    }, {
      title: 'NFT Marketplaces', description: 'Intelligent NFT platforms with AI-powered curation and valuation systems.', icon: '🎨'
    }, {
      title: 'Supply Chain', description: 'Blockchain-based supply chain solutions with AI-powered tracking and optimization.', icon: '📦'
    }, {
      title: 'Identity Management', description: 'Decentralized identity solutions with AI-enhanced security and privacy.', icon: '🆔'
    }, {
      title: 'Healthcare Records', description: 'Secure healthcare data management with AI-powered analytics and insights.', icon: '🏥'
    }, {
      title: 'Financial Services', description: 'AI-powered financial services built on blockchain technology.', icon: '💳'
      benefits: ['Growth strategies', 'Market analysis', 'Competitive insights', 'ROI optimization']
    }
  ];

  const benefits = ['Increase transaction speed by 80%', 'Reduce costs by 70%', 'Improve security by 95%', 'Enable new business models', 'Enhance transparency and trust', 'Automate complex processes', 'Scale globally without intermediaries', 'Enable programmable money and assets'];

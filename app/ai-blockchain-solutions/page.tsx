  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Integrate AI with blockchain technology to create secure, intelligent, and decentralized solutions." />
        <meta name="keywords" content="AI solutions, artificial intelligence, ai blockchain solutions, AI technology, intelligent automation" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Integrate AI with blockchain technology to create secure, intelligent, and decentralized solutions.
              </p>

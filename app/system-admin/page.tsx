  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <Helmet>
        ...
        <meta name="description" content="System Admin solutions by Zion Tech Group" />
      </Helmet>
      
      <div className="container mx-auto px-4 py-20">
        <h1 className="text-4xl font-bold mb-8">System Admin</h1>
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive system admin solutions designed to meet your business needs.
          </p>
<<<<<<< HEAD
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="System administration tools and services." />
        <meta name="keywords" content="system admin, administration, management, tools" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              System administration tools and services.
=======
      {/* Features Section */}

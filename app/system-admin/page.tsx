...
=======
export default function SystemAdminPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>System Admin - Zion Tech Group</title>
        <meta name="description" content="Advanced System Admin solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced System Admin solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

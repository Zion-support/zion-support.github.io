  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="AI-powered system admin solution for intelligent automation and optimization" />
        <meta name="keywords" content="AI, system, admin, automation, artificial intelligence, business solutions" />
      </Helmet>
      <Navigation />
        ...
        <section className="py-20 px-4 relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              AI-powered system admin solution for intelligent automation and optimization
            </p>

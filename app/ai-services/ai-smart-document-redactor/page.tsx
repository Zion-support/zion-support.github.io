...
export const metadata: Metadata = {
  ...
  description: "AI Smart Document Redactor — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-smart-document-redactor" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Smart Document Redactor', href: '/ai-services/ai-smart-document-redactor' },
        ],
      }
    />
  );

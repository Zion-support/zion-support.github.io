...
export const metadata: Metadata = {
  ...
  description: "AI Legal Document Review — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-legal-doc-review" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Legal Document Review', href: '/ai-services/ai-legal-doc-review' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  title: "AI Knowledge Base & RAG Platform | Zion Tech Group",
  description: "AI Knowledge Base & RAG Platform — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-knowledge-base-rag" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Knowledge Base & RAG Platform', href: '/ai-services/ai-knowledge-base-rag' },
        ],
      }
    />
  );

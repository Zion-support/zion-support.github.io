...
export const metadata: Metadata = {
  ...
  description: "Predictive Maintenance for Manufacturing — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-predictive-maintenance-factory" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Predictive Maintenance for Manufacturing', href: '/ai-services/ai-predictive-maintenance-factory' },
        ],
      }
    />
  );

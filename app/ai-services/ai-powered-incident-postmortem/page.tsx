...
export const metadata: Metadata = {
  ...
  description: "AI-Powered Incident Postmortem Generator — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-powered-incident-postmortem" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI-Powered Incident Postmortem Generator', href: '/ai-services/ai-powered-incident-postmortem' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "AI Profitability Dashboard — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-profitability-dashboard" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Profitability Dashboard', href: '/ai-services/ai-profitability-dashboard' },
        ],
      }
    />
  );

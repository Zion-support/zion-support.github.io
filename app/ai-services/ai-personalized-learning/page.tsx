...
export const metadata: Metadata = {
  ...
  description: "AI Personalized Learning Platform — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-personalized-learning" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Personalized Learning Platform', href: '/ai-services/ai-personalized-learning' },
        ],
      }
    />
  );

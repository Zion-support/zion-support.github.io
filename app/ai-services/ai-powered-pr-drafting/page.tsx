...
export const metadata: Metadata = {
  ...
  description: "AI-Powered PR Drafting & Description — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-powered-pr-drafting" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI-Powered PR Drafting & Description', href: '/ai-services/ai-powered-pr-drafting' },
        ],
      }
    />
  );

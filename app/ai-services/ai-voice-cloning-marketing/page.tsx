...
export const metadata: Metadata = {
  ...
  description: "AI Voice Cloning for Marketing — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-voice-cloning-marketing" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Voice Cloning for Marketing', href: '/ai-services/ai-voice-cloning-marketing' },
        ],
      }
    />
  );

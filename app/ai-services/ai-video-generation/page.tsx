...
export const metadata: Metadata = {
  title: 'AI Video Generation and Synthetic Media | Zion Tech Group',
  description: 'Enterprise video creation with AI scripting, voice synthesis, avatar generation, scene composition, and automated post-production.',
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Video Generation and Synthetic Media',

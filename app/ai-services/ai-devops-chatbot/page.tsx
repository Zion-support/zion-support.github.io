...
export const metadata: Metadata = {
  ...
  description: "AI DevOps Chatbot — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-devops-chatbot" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI DevOps Chatbot', href: '/ai-services/ai-devops-chatbot' },
        ],
      }
    />
  );

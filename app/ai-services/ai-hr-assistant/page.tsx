...
export const metadata: Metadata = {
  ...
  description: 'End-to-end HR automation from resume screening to engagement surveys, performance reviews, and policy Q&A.',
  alternates: { canonical: '/ai-services/ai-hr-assistant' },
};

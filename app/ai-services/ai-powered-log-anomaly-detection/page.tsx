...
export const metadata: Metadata = {
  ...
  description: "AI-Powered Log Anomaly Detection — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-powered-log-anomaly-detection" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI-Powered Log Anomaly Detection', href: '/ai-services/ai-powered-log-anomaly-detection' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "AI Personal Finance Coach — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-personal-finance-coach" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Personal Finance Coach', href: '/ai-services/ai-personal-finance-coach' },
        ],
      }
    />
  );

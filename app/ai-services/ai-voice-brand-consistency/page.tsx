...
export const metadata: Metadata = {
  title: "AI Voice Brand Consistency Checker | Zion Tech Group",
  description: "AI Voice Brand Consistency Checker — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-voice-brand-consistency" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Voice Brand Consistency Checker', href: '/ai-services/ai-voice-brand-consistency' },
        ],
      }
    />
  );

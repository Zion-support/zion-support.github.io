...
export const metadata: Metadata = {
  title: "AI-Powered Grant Writing Assistant — Zion Tech Group",
  ...
  keywords: "AI services, IT services, AI-Powered Grant Writing Assistant",
  openGraph: {
...
export default function AipoweredGrantWritingAssistantPage() {
  return (

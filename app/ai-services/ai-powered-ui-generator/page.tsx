...
export const metadata: Metadata = {
  ...
  description: "AI-Powered UI Generator (Text-to-UI) — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-powered-ui-generator" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI-Powered UI Generator (Text-to-UI)', href: '/ai-services/ai-powered-ui-generator' },
        ],
      }
    />
  );

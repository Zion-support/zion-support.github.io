...
export const metadata: Metadata = {
  title: "AI Supply Chain Risk Predictor — Zion Tech Group",
  ...
  keywords: "AI services, IT services, AI Supply Chain Risk Predictor",
  openGraph: {
...
export default function AiSupplyChainRiskPredictorPage() {
  return (

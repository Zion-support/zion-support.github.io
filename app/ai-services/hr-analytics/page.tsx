...
export const metadata: Metadata = {
  ...
  description:
    'HR Analytics transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more conf',
  alternates: { canonical: '/ai-services/hr-analytics' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'HR Analytics transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with HR Analytics',
      }}
    />
  );
}

...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-0361
      <Helmet>
        ...
        <meta name="description" content="Hr Analytics solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
      
      <div className="container mx-auto px-4 py-20">
        <h1 className="text-4xl font-bold mb-8">Hr Analytics</h1>
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive hr analytics solutions designed to meet your business needs.
          </p>
<<<<<<< HEAD
...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-0796
      <Helmet>
        <title>Hr Analytics - Zion Tech Group</title>
        <meta name="description" content="Professional hr analytics services by Zion Tech Group" />
      </Helmet>

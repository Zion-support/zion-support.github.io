...
export const metadata: Metadata = {
  ...
  description: "AI Customer Sentiment Tracker — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-customer-sentiment-tracker" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Customer Sentiment Tracker', href: '/ai-services/ai-customer-sentiment-tracker' },
        ],
      }
    />
  );

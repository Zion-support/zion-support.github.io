...
export const metadata: Metadata = {
  ...
  description: "Predictive Churn Risk Scoring — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/predictive-churn-risk" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Predictive Churn Risk Scoring', href: '/ai-services/predictive-churn-risk' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "Enterprise AI Question Answering (Internal Knowledge) — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-powered-question-answering" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Enterprise AI Question Answering (Internal Knowledge)', href: '/ai-services/ai-powered-question-answering' },
        ],
      }
    />
  );

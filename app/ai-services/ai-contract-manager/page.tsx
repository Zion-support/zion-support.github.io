...
export const metadata: Metadata = {
  ...
  description: "AI Contract Manager — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-contract-manager" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Contract Manager', href: '/ai-services/ai-contract-manager' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "AI LLM Router Pro — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-llm-router-pro" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI LLM Router Pro', href: '/ai-services/ai-llm-router-pro' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  title: 'AI Intelligent Document Processing and Routing | Zion Tech Group',
  description: 'Automated document intake with AI extraction, classification, and intelligent routing to the right team or workflow.',
  alternates: { canonical: '/ai-services/ai-intelligent-routing' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Intelligent Document Processing and Routing',
        ...
        pricing: [
          { tier: 'Starter', price: '$349', period: '/month', features: ['Core AI features', 'Up to 10K requests/mo', 'Standard analytics', 'Email support'] },
          { tier: 'Professional', price: '$799', period: '/month', features: ['All Starter', 'Up to 100K requests/mo', 'Advanced analytics', 'Priority support', 'API access'] },
          { tier: 'Enterprise', price: '$1799', period: '/month', features: ['Everything in Pro', 'Unlimited', 'Dedicated training', '24/7 support', 'SLA', 'On-premise'] },
        ],
        contact: {

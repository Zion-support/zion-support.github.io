...
export const metadata: Metadata = {
  title: "Smart Energy Optimization for Buildings — Zion Tech Group",
  ...
  keywords: "AI services, IT services, Smart Energy Optimization for Buildings",
  openGraph: {
...
export default function SmartEnergyOptimizationForBuildingsPage() {
  return (

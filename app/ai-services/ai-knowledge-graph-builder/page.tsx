...
export const metadata: Metadata = {
  ...
  description: "Knowledge Graph Builder — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-knowledge-graph-builder" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Knowledge Graph Builder', href: '/ai-services/ai-knowledge-graph-builder' },
        ],
      }
    />
  );

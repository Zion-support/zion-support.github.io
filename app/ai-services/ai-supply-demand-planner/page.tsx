...
export const metadata: Metadata = {
  ...
  description: "AI Supply & Demand Planner — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-supply-demand-planner" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Supply & Demand Planner', href: '/ai-services/ai-supply-demand-planner' },
        ],
      }
    />
  );

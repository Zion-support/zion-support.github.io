...
export const metadata: Metadata = {
  ...
  description:
    'Content Generation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn',
  alternates: { canonical: '/ai-services/content-generation' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Content Generation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Content Generation',
      }}
    />
  );
}

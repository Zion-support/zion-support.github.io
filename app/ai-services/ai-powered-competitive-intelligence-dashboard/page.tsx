...
export const metadata: Metadata = {
  title: "AI-Powered Competitive Intelligence Dashboard — Zion Tech Group",
  ...
  keywords: "AI services, IT services, AI-Powered Competitive Intelligence Dashboard",
  openGraph: {
...
export default function AipoweredCompetitiveIntelligenceDashboardPage() {
  return (

...
export const metadata: Metadata = {
  ...
  description: "AI API Orchestration Layer — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-api-orchestration-layer" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI API Orchestration Layer', href: '/ai-services/ai-api-orchestration-layer' },
        ],
      }
    />
  );

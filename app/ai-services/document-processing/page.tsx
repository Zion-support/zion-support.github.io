...
const Document Processing Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        ...
        <meta name="keywords" content="document, processing" />
      </Helmet>
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Document Processing Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Document processing - Zion Tech Group</title> <meta name="description"content="Professional Document processing solutions and services" /> <meta name="keywords"content="document, processing" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Document processing</h1> <p className="text xl text gray-300 mb-8"> Professional Document processing solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Document processing</h1>
            <p>
          
              Professional Document processing solutions and services
            </p>
...
export default Document;; Processing Page

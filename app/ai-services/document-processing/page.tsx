...
export const metadata: Metadata = {
  ...
  description:
    'Document Processing eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim op',
  alternates: { canonical: '/ai-services/document-processing' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Document Processing eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operational capacity and reduce human error.',
        iconEmoji: '🔄',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Document Processing',
      }}
    />
  );
}

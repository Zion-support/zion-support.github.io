...
export const metadata: Metadata = {
  title: 'AI Video Analytics and Visual Intelligence | Zion Tech Group',
  description: 'Real-time video analytics for retail, security, and manufacturing - crowd analysis, anomaly detection, and operational insights.',
  alternates: { canonical: '/ai-services/ai-video-analytics' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Video Analytics and Visual Intelligence',

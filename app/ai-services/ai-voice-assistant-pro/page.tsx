...
export const metadata: Metadata = {
  ...
  description: "Voice Assistant Pro — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-voice-assistant-pro" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Voice Assistant Pro', href: '/ai-services/ai-voice-assistant-pro' },
        ],
      }
    />
  );

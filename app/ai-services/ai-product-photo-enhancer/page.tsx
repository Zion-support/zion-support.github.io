...
export const metadata: Metadata = {
  ...
  description: "AI Product Photo Enhancer — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-product-photo-enhancer" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Product Photo Enhancer', href: '/ai-services/ai-product-photo-enhancer' },
        ],
      }
    />
  );

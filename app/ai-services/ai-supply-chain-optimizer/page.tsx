...
export const metadata: Metadata = {
  title: 'AI Supply Chain Optimization and Demand Forecasting | Zion Tech Group',
  description: 'End-to-end supply chain intelligence with ML demand forecasting, inventory optimization, and logistics route planning.',
  alternates: { canonical: '/ai-services/ai-supply-chain-optimizer' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Supply Chain Optimization and Demand Forecasting',
        ...
        pricing: [
          { tier: 'Starter', price: '$699', period: '/month', features: ['Core AI features', 'Up to 10K requests/mo', 'Standard analytics', 'Email support'] },
          { tier: 'Professional', price: '$1599', period: '/month', features: ['All Starter', 'Up to 100K requests/mo', 'Advanced analytics', 'Priority support', 'API access'] },
          { tier: 'Enterprise', price: '$3499', period: '/month', features: ['Everything in Pro', 'Unlimited', 'Dedicated training', '24/7 support', 'SLA', 'On-premise'] },
        ],
        contact: {

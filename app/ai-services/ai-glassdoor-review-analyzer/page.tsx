...
export const metadata: Metadata = {
  ...
  description: "AI Glassdoor & Review Analyzer — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-glassdoor-review-analyzer" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Glassdoor & Review Analyzer', href: '/ai-services/ai-glassdoor-review-analyzer' },
        ],
      }
    />
  );

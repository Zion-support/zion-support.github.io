...
export const metadata: Metadata = {
  ...
  description: "Revenue Optimization Engine — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-revenue-optimizer" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Revenue Optimization Engine', href: '/ai-services/ai-revenue-optimizer' },
        ],
      }
    />
  );

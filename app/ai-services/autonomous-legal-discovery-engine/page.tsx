...
export const metadata: Metadata = {
  title: "Autonomous Legal Discovery Engine — Zion Tech Group",
  ...
  keywords: "AI services, IT services, Autonomous Legal Discovery Engine",
  openGraph: {
...
export default function AutonomousLegalDiscoveryEnginePage() {
  return (

...
export const metadata: Metadata = {
  title: "Generative Data Synthesis for Model Training | Zion Tech Group",
  description: "Generative Data Synthesis for Model Training — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/generative-data-synthesis" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Generative Data Synthesis for Model Training', href: '/ai-services/generative-data-synthesis' },
        ],
      }
    />
  );

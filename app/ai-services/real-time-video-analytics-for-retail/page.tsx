...
export const metadata: Metadata = {
  title: "Real-Time Video Analytics for Retail — Zion Tech Group",
  ...
  keywords: "AI services, IT services, Real-Time Video Analytics for Retail",
  openGraph: {
...
export default function RealtimeVideoAnalyticsForRetailPage() {
  return (

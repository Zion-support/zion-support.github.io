...
export const metadata: Metadata = {
  ...
  description: "Autonomous Code Review Agent — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/autonomous-code-review-agent" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Autonomous Code Review Agent', href: '/ai-services/autonomous-code-review-agent' },
        ],
      }
    />
  );

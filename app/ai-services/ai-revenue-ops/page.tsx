...
export const metadata: Metadata = {
  ...
  description: "AI Revenue Operations (RevOps) — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-revenue-ops" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Revenue Operations (RevOps)', href: '/ai-services/ai-revenue-ops' },
        ],
      }
    />
  );

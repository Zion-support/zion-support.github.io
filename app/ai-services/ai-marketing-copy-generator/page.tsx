...
export const metadata: Metadata = {
  ...
  description: "AI Marketing Copy Generator — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-marketing-copy-generator" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Marketing Copy Generator', href: '/ai-services/ai-marketing-copy-generator' },
        ],
      }
    />
  );

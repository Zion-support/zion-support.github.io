...
export const metadata: Metadata = {
  ...
  description: "AI Dyslexia Assist — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-dyslexia-assist" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Dyslexia Assist', href: '/ai-services/ai-dyslexia-assist' },
        ],
      }
    />
  );

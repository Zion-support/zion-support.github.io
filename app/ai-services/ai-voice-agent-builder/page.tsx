...
export const metadata: Metadata = {
  ...
  description: "AI Voice Agent Builder — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-voice-agent-builder" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Voice Agent Builder', href: '/ai-services/ai-voice-agent-builder' },
        ],
      }
    />
  );

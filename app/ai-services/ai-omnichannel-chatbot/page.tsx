...
export const metadata: Metadata = {
  ...
  description: "AI Omnichannel Chatbot — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-omnichannel-chatbot" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Omnichannel Chatbot', href: '/ai-services/ai-omnichannel-chatbot' },
        ],
      }
    />
  );

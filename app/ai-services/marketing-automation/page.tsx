...
export const metadata: Metadata = {
  ...
  description:
    'Marketing Automation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Tu',
  alternates: { canonical: '/ai-services/marketing-automation' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Marketing Automation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Marketing Automation',
      }}
    />
  );
}

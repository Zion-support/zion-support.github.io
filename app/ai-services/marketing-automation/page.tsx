...
const MarketingAutomationPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional marketing automation services and solutions by Zion Tech Group."
      keywords="marketing automation, services, solutions, technology, Zion Tech Group"
    >

...
export const metadata: Metadata = {
  title: "AI-Powered Customer Onboarding Workflows — Zion Tech Group",
  ...
  keywords: "AI services, IT services, AI-Powered Customer Onboarding Workflows",
  openGraph: {
...
export default function AipoweredCustomerOnboardingWorkflowsPage() {
  return (

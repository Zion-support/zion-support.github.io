...
export const metadata: Metadata = {
  ...
  description: "AI for Sustainable Operations (Green AI) — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-sustainable-ops" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI for Sustainable Operations (Green AI)', href: '/ai-services/ai-sustainable-ops' },
        ],
      }
    />
  );

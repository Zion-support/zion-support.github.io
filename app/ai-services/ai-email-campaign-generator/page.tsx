...
export const metadata: Metadata = {
  ...
  description: "Email Campaign Generator — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-email-campaign-generator" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Email Campaign Generator', href: '/ai-services/ai-email-campaign-generator' },
        ],
      }
    />
  );

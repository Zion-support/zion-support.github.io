...
export const metadata: Metadata = {
  ...
  description: "AI Supply Chain Visibility Platform — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-supply-chain-visibility" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Supply Chain Visibility Platform', href: '/ai-services/ai-supply-chain-visibility' },
        ],
      }
    />
  );

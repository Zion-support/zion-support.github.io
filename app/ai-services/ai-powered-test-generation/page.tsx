...
export const metadata: Metadata = {
  ...
  description: "AI-Powered Test Suite Generator — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-powered-test-generation" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI-Powered Test Suite Generator', href: '/ai-services/ai-powered-test-generation' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "Customer 360 Unified Profile — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-customer-360" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Customer 360 Unified Profile', href: '/ai-services/ai-customer-360' },
        ],
      }
    />
  );

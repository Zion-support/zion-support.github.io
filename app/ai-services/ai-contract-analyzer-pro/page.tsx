...
export const metadata: Metadata = {
  ...
  description: "Contract Analyzer Pro — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-contract-analyzer-pro" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Contract Analyzer Pro', href: '/ai-services/ai-contract-analyzer-pro' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  title: "AI-Powered PR & Media Monitoring — Zion Tech Group",
  ...
  keywords: "AI services, IT services, AI-Powered PR & Media Monitoring",
  openGraph: {
...
export default function AipoweredPrAndMediaMonitoringPage() {
  return (

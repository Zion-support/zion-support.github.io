...
export const metadata: Metadata = {
  ...
  description: "AI Bug-to-Issue Router — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-bug-to-issue-router" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Bug-to-Issue Router', href: '/ai-services/ai-bug-to-issue-router' },
        ],
      }
    />
  );

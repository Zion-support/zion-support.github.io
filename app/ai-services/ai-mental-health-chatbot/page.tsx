...
export const metadata: Metadata = {
  ...
  description: "AI Mental Health Companion — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-mental-health-chatbot" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Mental Health Companion', href: '/ai-services/ai-mental-health-chatbot' },
        ],
      }
    />
  );

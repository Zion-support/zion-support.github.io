...
export const metadata: Metadata = {
  title: "Intelligent Supply Chain Carbon Footprint Tracker — Zion Tech Group",
  ...
  keywords: "AI services, IT services, Intelligent Supply Chain Carbon Footprint Tracker",
  openGraph: {
...
export default function IntelligentSupplyChainCarbonFootprintTrackerPage() {
  return (

...
export const metadata: Metadata = {
  ...
  description: 'Personalized onboarding, performance reviews, engagement tracking, and retention prediction.',
  alternates: { canonical: '/ai-services/ai-employee-experience' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with AI Employee Experience Platform',
        pricing: [

...
export const metadata: Metadata = {
  ...
  description: "AI Talent Acquisition Platform — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-talent-acquisition-platform" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Talent Acquisition Platform', href: '/ai-services/ai-talent-acquisition-platform' },
        ],
      }
    />
  );

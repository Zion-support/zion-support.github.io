...
export const metadata: Metadata = {
  title: "AI KYC / AML Compliance Engine | Zion Tech Group",
  description: "AI KYC / AML Compliance Engine — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-kyc-aml-compliance" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI KYC / AML Compliance Engine', href: '/ai-services/ai-kyc-aml-compliance' },
        ],
      }
    />
  );

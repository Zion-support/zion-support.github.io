  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900to-slate-900 pt-20">
      ...
      <div className="max-w-7 xl mx-auto px-4 sm:px-6 lg:px-8py-16 text-center">
        <h1 className="text-4 xl font-boldtext-white mb-6"  >Process Automation</h1>
        <p className="text-lgtext-gray-300 mb-8">Professional process automation services coming soon.</p>

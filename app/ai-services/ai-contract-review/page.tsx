...
export const metadata: Metadata = {
  ...
  description: "AI Contract Review Assistant — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-contract-review" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Contract Review Assistant', href: '/ai-services/ai-contract-review' },
        ],
      }
    />
  );

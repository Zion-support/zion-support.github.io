...
export const metadata: Metadata = {
  ...
  description: "Competitor Intelligence Engine — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-competitor-intelligence" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Competitor Intelligence Engine', href: '/ai-services/ai-competitor-intelligence' },
        ],
      }
    />
  );

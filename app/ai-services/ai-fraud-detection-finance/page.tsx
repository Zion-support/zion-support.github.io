...
export const metadata: Metadata = {
  ...
  description: "AI Fraud Detection for Finance — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-fraud-detection-finance" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Fraud Detection for Finance', href: '/ai-services/ai-fraud-detection-finance' },
        ],
      }
    />
  );

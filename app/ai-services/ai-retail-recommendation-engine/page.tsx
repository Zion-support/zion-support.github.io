...
export const metadata: Metadata = {
  ...
  description: "AI Retail Recommendation Engine — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-retail-recommendation-engine" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Retail Recommendation Engine', href: '/ai-services/ai-retail-recommendation-engine' },
        ],
      }
    />
  );

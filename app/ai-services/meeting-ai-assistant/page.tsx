...
export const metadata: Metadata = {
  ...
  description: "Meeting AI Assistant (Record, Transcribe, Summarize) — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/meeting-ai-assistant" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Meeting AI Assistant (Record, Transcribe, Summarize)', href: '/ai-services/meeting-ai-assistant' },
        ],
      }
    />
  );

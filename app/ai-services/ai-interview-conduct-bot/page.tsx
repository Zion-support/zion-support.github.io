...
export const metadata: Metadata = {
  ...
  description: "AI Interview Conduct Bot — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-interview-conduct-bot" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Interview Conduct Bot', href: '/ai-services/ai-interview-conduct-bot' },
        ],
      }
    />
  );

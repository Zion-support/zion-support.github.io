...
export const metadata: Metadata = {
  ...
  description: 'AI-powered multi-channel support with automated ticket routing, sentiment analysis, knowledge base integration, and 24/7 resolution.',
  alternates: { canonical: '/ai-services/ai-customer-support' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with AI Customer Support',
        pricing: [

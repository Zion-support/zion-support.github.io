...
export const metadata: Metadata = {
  ...
  description: "AI Visual Inspection & Quality Control — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-visual-inspection" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Visual Inspection & Quality Control', href: '/ai-services/ai-visual-inspection' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "Real-Time Translation Engine — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-realtime-translation" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Real-Time Translation Engine', href: '/ai-services/ai-realtime-translation' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "AI Code Audit & Security Scanner — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-code-audit-security" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Code Audit & Security Scanner', href: '/ai-services/ai-code-audit-security' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  title: 'AI Ethics, Safety and Governance Framework | Zion Tech Group',
  ...
  alternates: { canonical: '/ai-services/ai-ethics-governance' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Ethics, Safety and Governance Framework',

  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Professional predictive maintenance services and solutions from Zion Tech Group." />
      </Head>
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-emerald-400 max-w-3xl mx-auto">
              Advanced predictive maintenance solutions powered by artificial intelligence and machine learning.
            </p>
          </div>
...
<<<<<<< HEAD
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Predictive Maintenance</h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Professional predictive maintenance services and solutions for modern businesses.</p>
...
=======
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            "Professional predictive maintenance services and solutions for modern businesses."
          </p>
>>>>>>> origin/main
        </div>
      </div>

...
const PredictiveMaintenancePage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional predictive maintenance services and solutions by Zion Tech Group."
      keywords="predictive maintenance, services, solutions, technology, Zion Tech Group"
    >

...
export const metadata: Metadata = {
  ...
  description: "AI Legal Contract Redaction — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-legal-contract-redaction" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Legal Contract Redaction', href: '/ai-services/ai-legal-contract-redaction' },
        ],
      }
    />
  );

...
const Customer Experience Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Customer Experience</title>
        <meta name="description" content="Professional customer experience solutions and services" />
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Customer Experience Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Customer experience - Zion Tech Group</title> <meta name="description"content="Professional Customer experience solutions and services" /> <meta name="keywords"content="customer, experience" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Customer experience</h1> <p className="text xl text gray-300 mb-8"> Professional Customer experience solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Customer experience</h1>
            <p>
          
              Professional Customer experience solutions and services
            </p>
...
export default Customer;; Experience Page

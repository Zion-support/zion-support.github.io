...
export const metadata: Metadata = {
  title: 'AI Code Migration and Legacy Modernization | Zion Tech Group',
  description: 'AI-powered legacy code analysis, automated migration planning, and assisted code transformation to modern cloud-native stacks.',
  alternates: { canonical: '/ai-services/ai-code-migration' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Code Migration and Legacy Modernization',
        ...
        pricing: [
          { tier: 'Starter', price: '$2999', period: '/month', features: ['Core AI features', 'Up to 10K requests/mo', 'Standard analytics', 'Email support'] },
          { tier: 'Professional', price: '$5999', period: '/month', features: ['All Starter', 'Up to 100K requests/mo', 'Advanced analytics', 'Priority support', 'API access'] },
          { tier: 'Enterprise', price: '$14999', period: '/month', features: ['Everything in Pro', 'Unlimited', 'Dedicated training', '24/7 support', 'SLA', 'On-premise'] },
        ],
        contact: {

...
export const metadata: Metadata = {
  ...
  description: "AI Hiring Pipeline Optimizer — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-hiring-pipeline-optimizer" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Hiring Pipeline Optimizer', href: '/ai-services/ai-hiring-pipeline-optimizer' },
        ],
      }
    />
  );

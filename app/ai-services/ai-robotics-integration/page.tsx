...
export const metadata: Metadata = {
  title: 'AI Robotics Integration and Autonomous Systems | Zion Tech Group',
  ...
  alternates: { canonical: '/ai-services/ai-robotics-integration' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Robotics Integration and Autonomous Systems',
        ...
        pricing: [
          { tier: 'Starter', price: '$599', period: '/month', features: ['Core AI features', 'Up to 10K requests/mo', 'Standard analytics', 'Email support'] },
          { tier: 'Professional', price: '$1299', period: '/month', features: ['All Starter', 'Up to 100K requests/mo', 'Advanced analytics', 'Priority support', 'API access'] },
          { tier: 'Enterprise', price: '$2999', period: '/month', features: ['Everything in Pro', 'Unlimited', 'Dedicated training', '24/7 support', 'SLA', 'On-premise'] },
        ],
        contact: {

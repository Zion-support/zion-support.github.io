...
export const metadata: Metadata = {
  ...
  description: "AI Code Review Assistant — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-code-review-assistant" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Code Review Assistant', href: '/ai-services/ai-code-review-assistant' },
        ],
      }
    />
  );

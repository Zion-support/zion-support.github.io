...
export const metadata: Metadata = {
  ...
  description: "AI Accessibility Content Optimizer — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-accessibility-optimizer" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Accessibility Content Optimizer', href: '/ai-services/ai-accessibility-optimizer' },
        ],
      }
    />
  );

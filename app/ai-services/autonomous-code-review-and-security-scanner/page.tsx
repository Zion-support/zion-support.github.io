...
export const metadata: Metadata = {
  title: "Autonomous Code Review & Security Scanner — Zion Tech Group",
  ...
  keywords: "AI services, IT services, Autonomous Code Review & Security Scanner",
  openGraph: {
...
export default function AutonomousCodeReviewAndSecurityScannerPage() {
  return (

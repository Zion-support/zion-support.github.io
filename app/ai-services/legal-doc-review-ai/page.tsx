...
export const metadata: Metadata = {
  ...
  description: "AI Legal Document Review & Risk Analysis — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/legal-doc-review-ai" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Legal Document Review & Risk Analysis', href: '/ai-services/legal-doc-review-ai' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  title: "AI Form Filler & Automation | Zion Tech Group",
  description: "AI Form Filler & Automation — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-form-filler-intelligence" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Form Filler & Automation', href: '/ai-services/ai-form-filler-intelligence' },
        ],
      }
    />
  );

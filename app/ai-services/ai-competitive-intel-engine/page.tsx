...
export const metadata: Metadata = {
  ...
  description: "AI Competitive Intel Engine — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-competitive-intel-engine" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Competitive Intel Engine', href: '/ai-services/ai-competitive-intel-engine' },
        ],
      }
    />
  );

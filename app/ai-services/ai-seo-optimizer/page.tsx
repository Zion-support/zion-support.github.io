...
export const metadata: Metadata = {
  ...
  description: "AI SEO Content Optimizer — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-seo-optimizer" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI SEO Content Optimizer', href: '/ai-services/ai-seo-optimizer' },
        ],
      }
    />
  );

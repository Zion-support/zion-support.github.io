...
export const metadata: Metadata = {
  ...
  description: "AI BDR/SDR Agent — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-bdr-sdr-agent" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI BDR/SDR Agent', href: '/ai-services/ai-bdr-sdr-agent' },
        ],
      }
    />
  );

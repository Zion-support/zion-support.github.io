...
export const metadata: Metadata = {
  ...
  description: "AI Dashboard Designer — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-dashboard-designer" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Dashboard Designer', href: '/ai-services/ai-dashboard-designer' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "AI-Driven Customer Segmentation & Persona Engine — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-driven-customer-segmentation" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI-Driven Customer Segmentation & Persona Engine', href: '/ai-services/ai-driven-customer-segmentation' },
        ],
      }
    />
  );

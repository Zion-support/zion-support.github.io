...
export const metadata: Metadata = {
  ...
  description: "AI Data Quality Guardian — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-data-quality-guardian" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Data Quality Guardian', href: '/ai-services/ai-data-quality-guardian' },
        ],
      }
    />
  );

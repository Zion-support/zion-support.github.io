...
const BusinessIntelligencePage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional business intelligence services and solutions by Zion Tech Group."
      keywords="business intelligence, services, solutions, technology, Zion Tech Group"
    >

  ...
  return (
    <>
      ...
      <SEOHead
        ...
        description="Professional business intelligence services by Zion Tech Group."
      />
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-4">Business Intelligence</h1>
          <p className="text-gray-300">Professional business intelligence services coming soon...</p>
        </div>
      </div>
    </>
  );

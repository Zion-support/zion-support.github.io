...
export const metadata: Metadata = {
  title: "AI Observability Turbo | Zion Tech Group",
  description: "AI Observability Turbo — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-observability-turbo" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Observability Turbo', href: '/ai-services/ai-observability-turbo' },
        ],
      }
    />
  );

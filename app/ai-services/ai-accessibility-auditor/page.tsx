...
export const metadata: Metadata = {
  ...
  description: "AI Accessibility Auditor — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-accessibility-auditor" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Accessibility Auditor', href: '/ai-services/ai-accessibility-auditor' },
        ],
      }
    />
  );

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Quality Assurance services by Zion Tech Group. Professional AI and IT solutions." />
        <meta name="keywords" content="quality-assurance, AI solutions, IT services" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        <div className="container mx-auto px-4 py-20">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl">
            Professional quality assurance services by Zion Tech Group.
          </p>
          
          <div className="bg-slate-800 p-8 rounded-lg">
            <h2 className="text-2xl font-bold text-white mb-4">Coming Soon</h2>
            <p className="text-gray-300">
              We are working on bringing you the most advanced quality assurance solutions. 
...
>>>>>>> cursor/fix-errors-and-merge-to-main-5443
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Quality Assurance - Zion Tech Group</title>
        <meta name="description" content="Advanced quality assurance solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
...
=======
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Advanced quality assurance solutions by Zion Tech Group.
          </p>
        </div>
      </div>
    </div>

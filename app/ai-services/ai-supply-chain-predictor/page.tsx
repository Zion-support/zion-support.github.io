...
export const metadata: Metadata = {
  ...
  description: "AI Supply Chain Predictor — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-supply-chain-predictor" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Supply Chain Predictor', href: '/ai-services/ai-supply-chain-predictor' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "AI Codebase Documentation Generator — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-codebase-doc-generator" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Codebase Documentation Generator', href: '/ai-services/ai-codebase-doc-generator' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "AI Sustainability & Carbon Tracker — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-sustainability-carbon-tracker" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Sustainability & Carbon Tracker', href: '/ai-services/ai-sustainability-carbon-tracker' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "AI Competitive Price Tracker — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-competitive-price-tracker" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Competitive Price Tracker', href: '/ai-services/ai-competitive-price-tracker' },
        ],
      }
    />
  );

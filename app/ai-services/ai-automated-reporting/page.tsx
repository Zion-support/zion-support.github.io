...
export const metadata: Metadata = {
  ...
  description: "Automated Reporting Engine — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-automated-reporting" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Automated Reporting Engine', href: '/ai-services/ai-automated-reporting' },
        ],
      }
    />
  );

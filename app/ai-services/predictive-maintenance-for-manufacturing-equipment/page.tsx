...
export const metadata: Metadata = {
  title: "Predictive Maintenance for Manufacturing Equipment — Zion Tech Group",
  ...
  keywords: "AI services, IT services, Predictive Maintenance for Manufacturing Equipment",
  openGraph: {
...
export default function PredictiveMaintenanceForManufacturingEquipmentPage() {
  return (

...
export const metadata: Metadata = {
  title: 'AI Spatial Computing and AR/VR Analytics | Zion Tech Group',
  description: 'AI-powered spatial computing for AR/VR experiences - 3D scene understanding, gesture recognition, and immersive analytics.',
  alternates: { canonical: '/ai-services/ai-spatial-computing' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Spatial Computing and AR/VR Analytics',

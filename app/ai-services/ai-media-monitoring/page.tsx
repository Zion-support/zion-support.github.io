...
export const metadata: Metadata = {
  ...
  description: "AI Media & News Monitoring — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-media-monitoring" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Media & News Monitoring', href: '/ai-services/ai-media-monitoring' },
        ],
      }
    />
  );

...
export default function AICustomerSentimentAnalytics() {
  const features = [
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <section className="relative overflow-hidden py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">AI Customer Sentiment Analytics</h1>
            <p className="text-xl text-slate-400 max-w-3xl mx-auto">Real-time sentiment analysis across reviews, surveys, social media, and support interactions to drive proactive customer experience improvements.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-slate-400 text-center mb-10 max-w-2xl mx-auto">Average market price: $210–$490/month for comparable sentiment analytics solutions. We deliver enterprise-grade quality at competitive rates.</p>
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 text-center">
              <h3 className="text-slate-400 font-medium mb-2">Starter</h3>
              <p className="text-3xl font-bold text-white mb-4">$349/mo</p>
            ...
            <div className="bg-blue-600/20 border-2 border-blue-500 rounded-xl p-6 text-center relative">
              ...
              <p className="text-3xl font-bold text-white mb-4">$799/mo</p>
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 text-center">
              ...
              <p className="text-3xl font-bold text-white mb-4">$1,999/mo</p>

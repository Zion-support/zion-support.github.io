...
export const metadata: Metadata = {
  title: "AI Nutrition & Meal Planner | Zion Tech Group",
  description: "AI Nutrition & Meal Planner — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-nutrition-meal-planner" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Nutrition & Meal Planner', href: '/ai-services/ai-nutrition-meal-planner' },
        ],
      }
    />
  );

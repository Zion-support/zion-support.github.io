...
export const metadata: Metadata = {
  ...
  description: 'Demand forecasting, inventory optimization, supplier risk scoring, and logistics routing.',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with AI Supply Chain Optimization',
        pricing: [

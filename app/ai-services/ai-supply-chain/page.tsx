...
export const metadata: Metadata = {
  title: 'AI Supply Chain Intelligence and Optimization | Zion Tech Group',
  description: 'End-to-end supply chain visibility with demand forecasting, supplier risk scoring, route planning, and inventory optimization.',
  alternates: { canonical: '/ai-services/ai-supply-chain' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Supply Chain Intelligence and Optimization',

...
export const metadata: Metadata = {
  ...
  description: "AI-Driven API Design Assistant — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-driven-api-design-assistant" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI-Driven API Design Assistant', href: '/ai-services/ai-driven-api-design-assistant' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "AI Voice Agent (Phone) — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-voice-agent" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Voice Agent (Phone)', href: '/ai-services/ai-voice-agent' },
        ],
      }
    />
  );

...
export default function AIPredictiveWorkforcePlanning() {
  const features = [
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <section className="relative overflow-hidden py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">AI Predictive Workforce Planning</h1>
            <p className="text-xl text-slate-400 max-w-3xl mx-auto">Forecast hiring needs, optimize team composition, and predict attrition risk with AI-powered HR analytics and workforce modeling.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-slate-400 text-center mb-10 max-w-2xl mx-auto">Average market price: $360–$840/month for comparable workforce planning solutions. We deliver enterprise-grade quality at competitive rates.</p>
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 text-center">
              <h3 className="text-slate-400 font-medium mb-2">Starter</h3>
              <p className="text-3xl font-bold text-white mb-4">$599/mo</p>
            ...
            <div className="bg-blue-600/20 border-2 border-blue-500 rounded-xl p-6 text-center relative">
              ...
              <p className="text-3xl font-bold text-white mb-4">$1,299/mo</p>
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 text-center">
              ...
              <p className="text-3xl font-bold text-white mb-4">$3,499/mo</p>
      ...
      <section className="py-16 px-6 bg-slate-800/30">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-6">Ready to Transform Your Workforce Planning?</h2>

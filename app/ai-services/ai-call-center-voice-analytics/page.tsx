...
export const metadata: Metadata = {
  ...
  description: "AI Call Center Voice Analytics — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-call-center-voice-analytics" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Call Center Voice Analytics', href: '/ai-services/ai-call-center-voice-analytics' },
        ],
      }
    />
  );

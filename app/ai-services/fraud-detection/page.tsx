...
const FraudDetectionPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional fraud detection services and solutions by Zion Tech Group."
      keywords="fraud detection, services, solutions, technology, Zion Tech Group"
    >

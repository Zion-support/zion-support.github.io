...
export const metadata: Metadata = {
  title: "AI E-commerce Smart Search | Zion Tech Group",
  description: "AI E-commerce Smart Search — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-ecommerce-smart-search" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI E-commerce Smart Search', href: '/ai-services/ai-ecommerce-smart-search' },
        ],
      }
    />
  );

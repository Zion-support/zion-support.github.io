...
export const metadata: Metadata = {
  ...
  description: "AI-AIOps Anomaly Detection — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-aiops-anomaly-detection" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI-AIOps Anomaly Detection', href: '/ai-services/ai-aiops-anomaly-detection' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  title: "Predictive churn for SaaS platforms — Zion Tech Group",
  ...
  keywords: "AI services, IT services, Predictive churn for SaaS platforms",
  openGraph: {
...
export default function PredictiveChurnForSaasPlatformsPage() {
  return (

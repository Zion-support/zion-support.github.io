...
export const metadata: Metadata = {
  ...
  description: "AI Tax Compliance Calculator — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-tax-compliance-calculator" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Tax Compliance Calculator', href: '/ai-services/ai-tax-compliance-calculator' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "AI-Assisted Code Migration & Refactoring — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-for-code-migration" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI-Assisted Code Migration & Refactoring', href: '/ai-services/ai-for-code-migration' },
        ],
      }
    />
  );

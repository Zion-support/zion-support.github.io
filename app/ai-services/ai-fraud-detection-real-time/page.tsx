...
export const metadata: Metadata = {
  ...
  description: "Real-Time Fraud Detection — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-fraud-detection-real-time" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Real-Time Fraud Detection', href: '/ai-services/ai-fraud-detection-real-time' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: 'Neural MT across 100+ languages with domain fine-tuning and terminology management.',
  alternates: { canonical: '/ai-services/ai-translation-services' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with AI Translation & Localization',
        pricing: [

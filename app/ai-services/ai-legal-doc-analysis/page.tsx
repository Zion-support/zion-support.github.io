...
export const metadata: Metadata = {
  title: 'AI Legal Document Analysis and Contract Review | Zion Tech Group',
  ...
  alternates: { canonical: '/ai-services/ai-legal-doc-analysis' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Legal Document Analysis and Contract Review',

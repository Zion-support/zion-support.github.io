...
export const metadata: Metadata = {
  ...
  description: "AI Video Generator & Editor — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-video-generator" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Video Generator & Editor', href: '/ai-services/ai-video-generator' },
        ],
      }
    />
  );

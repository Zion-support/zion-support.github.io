...
export const metadata: Metadata = {
  ...
  description: "AI Knowledge Base & Knowledge Graph Agent — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-knowledge-base-agent" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Knowledge Base & Knowledge Graph Agent', href: '/ai-services/ai-knowledge-base-agent' },
        ],
      }
    />
  );

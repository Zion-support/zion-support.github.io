...
export const metadata: Metadata = {
  ...
  description: "Social Sentiment Tracker — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-social-sentiment-tracker" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Social Sentiment Tracker', href: '/ai-services/ai-social-sentiment-tracker' },
        ],
      }
    />
  );

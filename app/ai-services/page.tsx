...
const AIServicesPage: React.FC = () => {
  const aiServices = [
    ...
    },
    {
      ...
      description: 'Build advanced conversational AI systems with natural language processing capabilities.',
      features: ['NLP processing', 'Intent recognition', 'Context awareness', 'Multi-language support'],
  ...
  const benefits = [
    {
      ...
      description: 'Leverage the latest AI technologies and machine learning models',
    ...
    },
    {
      ...
      description: 'Dedicated AI specialists to guide your implementation',
      icon: <Shield className="w-6 h-6 text-green-500" />
    },
    {
      title: 'ROI Focused',
      description: 'Proven AI solutions that deliver measurable business value',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Advanced AI services including content generation, chatbots, analytics, computer vision, and conversational AI. Transform your business with cutting-edge artificial intelligence." />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Transform your business with cutting-edge artificial intelligence solutions. From content generation to computer vision, we deliver AI that works.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              We deliver AI solutions that actually work and drive real business results
            </p>
          </div>

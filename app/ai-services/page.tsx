...
const AIServicesPage: React.FC = () => {
  const aiServices = [
    ...
    },
    {
      ...
      description:
        "Advanced forecasting and trend analysis with machine learning",
      icon: TrendingUp,
      price: "$1,700/month",
      features: [
        "Sales Forecasting",
    ...
    },
    {
      ...
      description:
        "Personalized recommendation systems for e-commerce and content",
      icon: Target,
      price: "$1,400/month",
      features: [
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              Transform your business with our comprehensive AI services. From
              machine learning to computer vision, we provide cutting-edge
              artificial intelligence solutions tailored to your specific needs.
            </p>
          </section>
          ...
          <section className="text-center">
            <div className="cyber-card p-8 max-w-4xl mx-auto">
              ...
              <p className="text-gray-300 mb-6 text-lg">
                Our AI experts are ready to help you implement cutting-edge
                artificial intelligence solutions that will revolutionize your

...
export default function PagePage() {
  return (
    <>
      <Head>
        <title>AiServices - Zion Tech Group - Zion Tech Group</title>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Comprehensive AI services including machine learning, natural language processing, computer vision, and automation. Transform your business with cutting-edge AI technology.
          </p>
          <Link
            href="/contact"

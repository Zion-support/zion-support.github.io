...
import { CheckCircle, ArrowRight, Brain, Zap, Eye, MessageCircle, BarChart, Shield, Users, Clock, DollarSign, Star, Mic, Image } from 'lucide-react';
...
const AiServicesPage: React.FC = () => {
  const aiServices = [
    ...
    },
    {
      ...
      description: 'Intelligent voice assistant with natural language processing and custom command training.',
      features: ['Voice recognition', 'Multi-language support', 'Custom commands', 'Real-time processing', 'Mobile deployment'],
      pricing: '$799/month',
      popular: true,
      category: 'Voice'
    },
    {
      ...
      description: 'Create stunning images from text descriptions with advanced AI art generation technology.',
      features: ['Text-to-image', 'Style transfer', 'High-resolution output', 'Multiple art styles', 'API integration'],
      pricing: '$149/month',
      popular: true,
      category: 'Creative'
    },

...
const AIServicesPage: React.FC = () => {
  const features = [
    {
      ...
      description: "Automate your business processes with intelligent AI solutions that work 24/7.",
      icon: <Brain className="w-6 h-6" />,
      benefits: ["Process automation", "Intelligent workflows", "24/7 operation"]
    },
    {
      title: "Machine Learning Solutions",
      description: "Leverage advanced machine learning models to gain insights and make predictions.",
      icon: <Cpu className="w-6 h-6" />,
      benefits: ["Predictive analytics", "Pattern recognition", "Data insights"]
    },
    {
      title: "Natural Language Processing",
      description: "Understand and process human language with our advanced NLP capabilities.",
      icon: <Target className="w-6 h-6" />,
      benefits: ["Text analysis", "Language understanding", "Content generation"]
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>AI Services - Advanced AI Solutions | Zion Tech Group</title>
        <meta name="description" content="Transform your business with our comprehensive AI services including automation, machine learning, and natural language processing." />
        <meta name="keywords" content="AI services, artificial intelligence, machine learning, automation, NLP, AI solutions" />
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-16">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 mb-6">
                ...
                <span className="text-blue-400 text-sm font-medium">#1 AI Services Provider</span>
              </div>
              ...
              <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                Transform your business with our comprehensive AI services including automation, 
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Everything you need to implement AI in your business with our expert services.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Flexible pricing options designed to scale with your AI needs
              </p>
            </div>

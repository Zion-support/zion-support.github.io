...
const AiServicesPage: React.FC = () => {
  ...
  const aiServices = [
    ...
    {
      icon: <MessageCircle className="w-8-h-8text-purple-400" / />,
    ...
    {
      icon: <Eye className="w-8-h-8text-green-400" />,
    ...
    {
      icon: <Mic className="w-8-h-8text-orange-400" />,
    ...
    {
      icon: <FileText className="w-8-h-8text-blue-400" / />,
    ...
    {
      icon: <Users className="w-8-h-8text-pink-400" / />,
    ...
    {
      icon: <Heart className="w-8-h-8text-red-400" />,
    ...
    {
      icon: <DollarSign className="w-8-h-8text-green-400" />,
    ...
    {
      icon: <Target className="w-8-h-8text-yellow-400" />,
    ...
    {
      icon: <Settings className="w-8-h-8text-gray-400" />,
    ...
    {
      icon: <Cpu className="w-8-h-8text-indigo-400" />,
  ...
  const stats = [
    { number: '500+', label: 'AI Models Deployed', icon: <Brain className="w-6-h-6text-cyan-400" / /> },
    { number: '99.9%', label: 'Uptime Guarantee', icon: <Shield className="w-6-h-6text-green-400" / /> },
    { number: '24/7', label: 'AI Monitoring', icon: <Clock className="w-6-h-6text-blue-400" / /> },
    { number: '150+', label: 'AI Experts', icon: <Users className="w-6-h-6text-purple-400" / /> }
  ];
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900to-slate-900">
              ...
              {filteredServices.map((service, index) => (
                <div
                  ...
                  <div className="space-y-3">
                    ...
                    <Link to="/contact" className="w-full inline-flex items-center justify-center px-4 py-3 border border-purple-400 text-purple-400 font-semibold rounded-lg hover:bg-purple-400 hover:text-whitetransition-all duration-300">Get Quote
                            </Link>
      </div>
    </div>
              ))}
        ...
        <section className="py-20-px-4relative" />
          <div className="relativemax-w-7-xlmx-auto">
            <div className="text-centermb-16">
              <h2 className="text-4-xl md:text-5xl font-boldtext-white mb-6" />
              ...
              {[
                {
                  ...
                  icon: <Target className="w-8-h-8text-cyan-400" />
                },
                {
                  step: '02',
                ...
                },
                {
                  ...
                  icon: <Brain className="w-8-h-8text-green-400" />
                },
                {
                  step: '04',
        ...
        <section className="py-20" />
          <div className="containermx-autopx-4">
            <div className="bg-gradient-to-r from-cyan-900/50 to-purple-900/50 backdrop-blur-sm border border-cyan-500/20 rounded-2 xlp-12 text-center">
              <h2 className="text-4 xl font-boldtext-white mb-6"  />Ready to Transform Your Business with AI?
              </h2>
        ...
        <section className="py-20 bg-gradient-to-brfrom-slate-900-to-gray-900" />
          <div className="max-w-7 xl mx-auto px-4 sm:px-6-lg:px-8 text-center">
            <h2 className="text-3 xl md:text-4 xl font-boldtext-white mb-4"  />Ready to Transform Your Business with AI?
            </h2>

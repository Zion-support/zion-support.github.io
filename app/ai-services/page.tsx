  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive AI services including chatbots, computer vision, machine learning, and automation. Transform your business with cutting-edge AI technology." />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              AI <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">Services</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Cutting-edge artificial intelligence solutions designed to automate, optimize, and transform your business operations.
            </p>

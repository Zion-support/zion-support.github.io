...
import { CheckCircle, ArrowRight, Brain, Zap, Shield, Star, Eye, MessageSquare, BarChart3 } from 'lucide-react';
...
export default function AIServicesPage() {
  const services = [
    ...
    },
    {
      ...
      title: 'AI Chatbots',
      description: 'Build intelligent chatbots that can handle customer inquiries, provide support, and engage users 24/7.',
    ...
    },
    {
      ...
      features: ['Image classification', 'Object detection', 'Facial recognition', 'Custom models'],
    ...
    },
    {
      ...
      title: 'AI Security',
      description: 'Enhance your security posture with AI-powered threat detection and automated security monitoring.',
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: 'The AI chatbot handles 90% of our customer inquiries automatically. Our support team can focus on complex issues.',
      rating: 5,
      avatar: 'ER'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Transform your business with our comprehensive AI services including content generation, automation, chatbots, and analytics." />
        <meta name="keywords" content="AI services, artificial intelligence, content generation, automation, chatbots, analytics" />
      </Helmet>

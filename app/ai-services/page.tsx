  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive AI services including chatbots, data analytics, computer vision, and machine learning solutions for businesses." />
        <meta name="keywords" content="AI services, artificial intelligence, machine learning, chatbots, data analytics, computer vision" />
      </Helmet>

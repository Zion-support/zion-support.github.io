...
const AIServicesPage = () => {
  const services = [
    ...
    {
      title: "AI Automation",
      description: "Streamline your business processes with intelligent automation. Reduce manual work and increase efficiency by up to 80%.",
    ...
    },
    {
      ...
      description: "Create high-quality content at scale with our AI-powered content generation tools. From blog posts to marketing copy.",
      icon: <Brain className="w-8 h-8" />,
      features: ["Blog post generation", "Marketing copy", "Social media content", "SEO optimization"],
      link: "/ai-content-generation",
      color: "from-green-500 to-emerald-500"
    },
    {
      title: "AI Customer Service",
      description: "Enhance customer experience with intelligent chatbots and automated support systems. 24/7 customer assistance.",
      icon: <Users className="w-8 h-8" />,
      features: ["Intelligent chatbots", "Automated responses", "Sentiment analysis", "Multi-language support"],
      link: "/ai-customer-service",
      color: "from-orange-500 to-red-500"
    },
    {
      title: "AI Marketing",
      description: "Optimize your marketing campaigns with AI-driven insights. Target the right audience with precision and maximize ROI.",
      icon: <Target className="w-8 h-8" />,
      features: ["Audience targeting", "Campaign optimization", "A/B testing", "ROI maximization"],
      link: "/ai-marketing",
      color: "from-pink-500 to-rose-500"
    },
    {
      title: "AI Healthcare",
      description: "Revolutionize healthcare with AI-powered diagnostic tools and patient care management systems.",
      icon: <Shield className="w-8 h-8" />,
      features: ["Diagnostic assistance", "Patient monitoring", "Drug discovery", "Treatment optimization"],
      link: "/ai-healthcare",
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            Transform your business with cutting-edge artificial intelligence. From analytics to automation, 
            we provide comprehensive AI solutions that drive real results and measurable growth.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              ...
              From data analytics to customer service, we have the AI tools you need to succeed.
            </p>
          </div>

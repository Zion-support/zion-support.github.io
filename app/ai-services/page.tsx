import { ArrowRight, Zap, Shield, Globe, Database, Code, Smartphone, Brain, BarChart3, Users, Target, FileText, Mail, TrendingUp, CheckCircle, Star, Sparkles, Bot, Cpu, Eye, MessageSquare, Settings, Lock, Monitor, Smartphone as PhoneIcon } from "lucide-react";
  ...
  const aiServices = [
    {
      ...
      features: ["Real-time Analytics", "Predictive Modeling", "Custom Dashboards", "API Integration", "Machine Learning Models", "Automated Insights"],
      category: "Analytics",
      popular: true
    },
    {
      ...
      features: ["Multi-language Support", "Sentiment Analysis", "CRM Integration", "Live Chat Handoff", "Voice Recognition", "Escalation Management"],
    ...
    },
    {
      ...
      features: ["Threat Detection", "Automated Response", "Compliance Reports", "24/7 Monitoring", "Behavioral Analysis", "Incident Forensics"],
      category: "Security",
      popular: true
    },
    {
      ...
      price: "From $199/month",
      features: ["Email Automation", "Social Media", "Lead Scoring", "A/B Testing", "Customer Segmentation", "ROI Analytics"],
      category: "Marketing"
    },
    {
      title: "AI Project Management Pro",
      description: "Manage projects more efficiently with AI-powered planning and optimization. Smart resource allocation and progress tracking.",
      icon: <Smartphone className="w-8 h-8" />,
      path: "/ai-project-management-pro",
      color: "from-teal-500 to-cyan-500",
      price: "From $179/month",
      features: ["Smart Planning", "Resource Optimization", "Risk Assessment", "Progress Tracking", "Team Collaboration", "Predictive Analytics"],
    ...
    },
    {
      ...
      path: "/ai-data-analytics-engine",
      color: "from-amber-500 to-yellow-500",
      price: "From $249/month",
      features: ["ML Models", "Interactive Dashboards", "Data Pipeline", "Real-time Processing", "Data Mining", "Statistical Analysis"],
    ...
    },
    {
      ...
      features: ["Code Generation", "Bug Detection", "Performance Optimization", "Documentation", "Code Review", "Learning Mode"],
    ...
    },
    {
      ...
      description: "Build and deploy advanced conversational AI applications. Voice assistants, chatbots, and virtual agents for any industry.",
      icon: <MessageSquare className="w-8 h-8" />,
      path: "/ai-conversational-platform",
      color: "from-orange-500 to-red-500",
      price: "From $279/month",
      features: ["Voice Recognition", "Natural Language Processing", "Multi-channel Support", "Custom Training", "Analytics Dashboard", "API Integration"],
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="AI services, artificial intelligence, machine learning, automation, analytics, content generation, customer service, marketing AI, cybersecurity AI, business intelligence, conversational AI"
        />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                ...
                Choose from our advanced artificial intelligence solutions.
              </p>
            </div>

...
const AIServicesPage: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      features: ['Custom AI Models', 'Data Pipeline Setup', 'Model Training', 'Deployment & Monitoring']
    },
    {
      icon: TrendingUp,
      ...
      features: ['Performance Tuning', 'Model Retraining', 'Cost Optimization', 'Scalability Enhancement']
    },
    {
      icon: Target,
      title: 'AI Training',
    ...
    },
    {
      icon: Eye,
      title: 'Computer Vision',
      description: 'Image and video analysis solutions using state-of-the-art computer vision technology.',
    ...
    },
    {
      ...
      features: ['Real-time Dashboards', 'Predictive Insights', 'Automated Reporting', 'Data Visualization']
    }
  ];

...
const AiServicesPage = () => {
  const aiServices = [
    ...
    },
    {
      ...
      description: "Generate professional videos using AI-powered video creation tools.",
      icon: "🎥",
      price: "$800/month",
      features: ["Video Scripts", "Auto-editing", "Voice Synthesis", "Visual Effects"],
    ...
    },
    {
      ...
      description: "Protect your business with intelligent threat detection and prevention.",
      icon: "🔒",
      price: "$700/month",
    ...
    },
    {
      ...
      icon: "⚙️",
      price: "$400/month",
      features: ["Process Automation", "Task Scheduling", "Data Processing", "Integration"],
  ...
  const testimonials = [
    {
      ...
      content: "Zion Tech Group's AI services have revolutionized our content creation process. The quality and speed are unmatched.",
      rating: 5
    },
    {
      name: "Michael Chen",
      company: "DataFlow Solutions",
      content: "Their AI analytics platform gave us insights we never knew existed. Game-changing for our business.",
      rating: 5
    },
    {
      name: "Emily Rodriguez",
      company: "SecureNet Ltd.",
      content: "The AI cybersecurity solution has significantly improved our threat detection capabilities. Highly recommended.",
      rating: 5
    }
  ];

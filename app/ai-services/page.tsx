        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-6xl mx-auto">{/* Header */}</div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">AI Services</h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">Comprehensive AI solutions designed to transform your business operations. </p className="text-xl text-gray-300 max-w-3xl mx-auto">
                From chatbots to computer vision, we have the AI expertise you need.</p className="text-xl text-gray-300 max-w-3xl mx-auto">
              </p>
            ...
            <div className="text-center">
              <div className="bg-slate-800/50 rounded-lg p-8">
                <h2 className="text-2xl font-bold text-white mb-4">Ready to Transform Your Business with AI?</h2 className="text-2xl font-bold text-white mb-4">
                </h2>
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">Let our AI experts help you choose the right solutions for your business needs. </p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                  Get a free consultation and see how AI can transform your operations.</p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                </p>

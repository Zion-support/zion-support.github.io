  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI services to transform your business with artificial intelligence" />
      </Helmet>
                ...
                <div key={service.id} className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700 hover:border-cyan-500 transition-all duration-300 hover:transform hover:scale-105">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      ...
                      <span className="text-cyan-400 text-sm">{service.category}</span>
                    </div>
                  </div>

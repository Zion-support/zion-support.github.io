  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive AI services with high performance, enterprise security, and global scalability for business transformation." />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Implement our AI services to transform your business operations.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact"

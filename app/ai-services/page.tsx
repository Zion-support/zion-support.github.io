...
const AIServicesPage: React.FC = () => {
  ...
  const categories = ['All', 'Analytics', 'Customer Service', 'Content', 'Security', 'Vision', 'Automation'];

  return (
    <>
      <SEOHead 
        title="AI Services - Zion Tech Group"
        description="Discover our comprehensive suite of AI services designed to transform your business. From machine learning to computer vision, we have the AI tools you need."
        keywords="AI services, artificial intelligence, machine learning, computer vision, natural language processing, AI automation, AI analytics"
      />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 lg:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto">
                Choose from our comprehensive collection of AI services, each designed to solve specific business challenges.
              </p>
            </div>
        ...
        <section className="relative z-10 py-16 lg:py-20 bg-slate-800/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 lg:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto">
                Our AI services leverage cutting-edge technologies to deliver intelligent automation and insights.
              </p>
            </div>
        ...
        <section className="relative z-10 py-16 lg:py-20">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg sm:text-xl text-gray-300 mb-8 lg:mb-12">
              Transform your business with our cutting-edge AI services. Get started today and experience the future of intelligent automation.
            </p>

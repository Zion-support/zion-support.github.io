  ...
  return (
    <>
      ...
      <div className="min-h-screen relative">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(139,92,246,0.1)_0%,transparent_50%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(0,255,255,0.1)_0%,transparent_50%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_40%_40%,rgba(236,72,153,0.1)_0%,transparent_50%)]"></div>
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-r from-purple-600 to-pink-700 text-white py-20 z-10">
          <div className="absolute inset-0 bg-black opacity-20"></div>
          <div className="absolute inset-0 bg-gradient-to-r from-purple-600/50 to-pink-700/50"></div>
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-20">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 holographic">
                Advanced AI Services
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-cyan-200 max-w-3xl mx-auto neon-text">
                Transform your business with cutting-edge artificial intelligence solutions
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="neon-button px-8 py-3 rounded-lg font-semibold hover:scale-105 transition-all duration-300">
                  Start AI Journey
                </button>
                <button className="glass-card border-2 border-cyan-400 text-cyan-400 px-8 py-3 rounded-lg font-semibold hover:bg-cyan-400 hover:text-gray-900 transition-all duration-300 hover:scale-105">
                  View AI Solutions
                </button>
              </div>
            </div>
        ...
        <section className="py-16 relative z-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center glass-card p-6 hover:scale-105 transition-all duration-300 group">
                <div className="bg-gradient-to-r from-purple-500 to-pink-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 float">
                  <Brain className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-cyan-400 transition-colors">AI Experts</h3>
                <p className="text-gray-300">PhD-level data scientists and AI researchers</p>
              </div>
              <div className="text-center glass-card p-6 hover:scale-105 transition-all duration-300 group">
                <div className="bg-gradient-to-r from-green-500 to-cyan-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 float-delayed">
                  <Zap className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-green-400 transition-colors">Rapid Deployment</h3>
                <p className="text-gray-300">Deploy AI solutions in weeks, not months</p>
              </div>
              <div className="text-center glass-card p-6 hover:scale-105 transition-all duration-300 group">
                <div className="bg-gradient-to-r from-blue-500 to-purple-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 float">
                  <Target className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-blue-400 transition-colors">Custom Solutions</h3>
                <p className="text-gray-300">Tailored AI models for your specific use case</p>
              </div>
              <div className="text-center glass-card p-6 hover:scale-105 transition-all duration-300 group">
                <div className="bg-gradient-to-r from-orange-500 to-pink-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 float-delayed">
                  <BarChart className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-orange-400 transition-colors">Proven ROI</h3>
        ...
        {categories.map(category => (
          <section key={category} className="py-16 relative z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 neon-text">
                  {category} Solutions
                ...
                {aiServices
                  ...
                  .map((service, index) => (
                    <div key={index} className="glass-card p-6 hover:scale-105 transition-all duration-300 group">
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {service.technologies.map((tech, techIndex) => (
                            <span key={techIndex} className="bg-cyan-500/20 text-cyan-300 text-xs px-2 py-1 rounded border border-cyan-500/30">
                              {tech}
                            </span>
                          ))}
                        </div>
                      ...
                      <button className="w-full neon-button py-2 px-4 rounded-lg font-semibold hover:scale-105 transition-all duration-300">
                        Get AI Consultation
                      </button>
                    </div>
                  ))}
        ...
        <section className="py-16 relative z-10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center glass-card p-6 hover:scale-105 transition-all duration-300 group">
                <Brain className="w-12 h-12 text-cyan-400 mx-auto mb-4 float" />
                <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-cyan-400 transition-colors">Deep Learning</h3>
                <p className="text-gray-300">Neural networks, CNNs, RNNs, and transformer models</p>
              </div>
              <div className="text-center glass-card p-6 hover:scale-105 transition-all duration-300 group">
                <MessageSquare className="w-12 h-12 text-green-400 mx-auto mb-4 float-delayed" />
                <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-green-400 transition-colors">Natural Language Processing</h3>
                <p className="text-gray-300">Text analysis, sentiment, translation, and generation</p>
              </div>
              <div className="text-center glass-card p-6 hover:scale-105 transition-all duration-300 group">
                <Eye className="w-12 h-12 text-purple-400 mx-auto mb-4 float" />
                <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-purple-400 transition-colors">Computer Vision</h3>
                <p className="text-gray-300">Image recognition, object detection, and video analysis</p>
              </div>
              <div className="text-center glass-card p-6 hover:scale-105 transition-all duration-300 group">
                <Cpu className="w-12 h-12 text-orange-400 mx-auto mb-4 float-delayed" />
                <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-orange-400 transition-colors">Machine Learning</h3>
                <p className="text-gray-300">Supervised, unsupervised, and reinforcement learning</p>
              </div>
              <div className="text-center glass-card p-6 hover:scale-105 transition-all duration-300 group">
                <Sparkles className="w-12 h-12 text-pink-400 mx-auto mb-4 float" />
                <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-pink-400 transition-colors">Generative AI</h3>
                <p className="text-gray-300">Content generation, creative AI, and synthetic data</p>
              </div>
              <div className="text-center glass-card p-6 hover:scale-105 transition-all duration-300 group">
                <BarChart className="w-12 h-12 text-indigo-400 mx-auto mb-4 float-delayed" />
                <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-indigo-400 transition-colors">Predictive Analytics</h3>
        ...
        <section className="py-16 bg-gradient-to-r from-purple-600 to-pink-600 text-white relative z-10">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-20">
            ...
            <p className="text-xl mb-8 text-cyan-200 neon-text">
              Contact our AI experts for a free consultation and custom AI strategy development
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="tel:+13024640950"
                className="neon-button px-8 py-3 rounded-lg font-semibold hover:scale-105 transition-all duration-300 inline-flex items-center"
              >
                📞 +1 302 464 0950
              </a>
              <a 
                href="mailto:kleber@ziontechgroup.com"
                className="glass-card border-2 border-cyan-400 text-cyan-400 px-8 py-3 rounded-lg font-semibold hover:bg-cyan-400 hover:text-gray-900 transition-all duration-300 hover:scale-105"
              >

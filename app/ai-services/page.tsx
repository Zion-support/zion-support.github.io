...
const AIServicesPage: React.FC = () => {
  const aiServices = [
    ...
    },
    {
      ...
      description: 'Automate your email marketing with AI-powered personalization, subject line optimization, and send time optimization.',
      features: [
    ...
    },
    {
      ...
      description: 'Build custom voice assistants with natural language processing, speech recognition, and multi-platform deployment.',
      features: [
    ...
    },
    {
      ...
      description: 'Comprehensive automation platform that uses AI to streamline business processes and reduce manual work.',
      features: [
        'Workflow automation',
        'Document processing',
        'Data extraction',
  ...
  const benefits = [
    {
      ...
      description: 'Our AI solutions have helped businesses increase productivity by 300% and reduce costs by 50%.'
    },
    {
      icon: <CheckCircle className="w-6 h-6 text-blue-500" />,
      title: 'Easy Integration',
      description: 'Seamlessly integrate with your existing systems and workflows with our comprehensive APIs.'
    },
    {
      icon: <CheckCircle className="w-6 h-6 text-purple-500" />,
      title: '24/7 Support',
      description: 'Get round-the-clock support from our AI experts to ensure your success.'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered solutions including content generation, chatbots, analytics, and automation. Transform your business with cutting-edge artificial intelligence." />
        <meta name="keywords" content="AI services, artificial intelligence, machine learning, chatbot, content generation, analytics, automation" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto mb-6 sm:mb-8 px-4">
                ...
                From content generation to automation, we provide the AI tools you need to succeed.
              </p>

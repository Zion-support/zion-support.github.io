...
const AiServicesPage: React.FC = () => {
  const services = [{
    ...
    },
    {
      icon: "ico,n: Shield", "
      title: "AI Security", ;: "$4"
      description: "AI-powered security solutions to protect your business and data.", ;: "$4
...
const AiServicesPage: React.FC = () => {
  ...
  const testimonials = [{name: "Dr. Sarah Johnson", ";"
      ...
      role: "CTO";
      content: Zion's AI healthcare solutions have revolutionized our diagnostic capabilities. We've seen a 40% improvement in accuracy.", ;: "$4""
      rating: "5;""}
    },
    {name: "Michael Chen",
      company: "E-commerce Plus",
      role: "CEO"
      content: The AI automation tools have transformed our operations. We've reduced manual work by 80% and increased productivity significantly.", ;: "$4""
      rating: "5;""}
    },

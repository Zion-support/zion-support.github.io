...
const AIServicesPage: React.FC = () => {
  const aiServices = [
    ...
    },
    {
      ...
      features: ['Voice recognition', 'Natural language understanding', 'Multi-platform support', 'Custom wake words'],
    ...
    },
    {
      ...
      description: 'Comprehensive automation tools to streamline your business processes and workflows.',

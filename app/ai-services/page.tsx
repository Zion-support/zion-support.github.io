      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              We deliver exceptional AI services with unmatched expertise and support
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">Certified AI professionals with years of experience in enterprise solutions.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-300">Round-the-clock monitoring and support for your AI systems.</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">Reduce operational costs by up to 60% with intelligent automation.</p>
            </div>
          </div>
        </div>
      </section>

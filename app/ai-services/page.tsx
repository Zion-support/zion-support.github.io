...
const AIServicesPage: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      features: ['24/7 availability', 'Multi-language support', 'Custom training', 'Analytics dashboard'],
    ...
    },
    {
      ...
      features: ['Process automation', 'Workflow optimization', 'Task scheduling', 'Integration APIs'],
  ...
  const benefits = [
    {
      ...
      title: '10x Faster',
      description: 'Complete tasks in minutes instead of hours'
    },
    {

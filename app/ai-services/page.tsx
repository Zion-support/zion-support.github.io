...
>
      ...
      <FuturisticBackground />
        ...
        <section className="py-20 px-4"></section>
          ...
          <div className="max-w-4xl mx-auto text-center"><h2 className="text-4xl font-bold text-white mb-6"
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center"><button className="bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-8 py-3 rounded-lg hover:from-purple-700 hover:to-cyan-700 transition-all duration-300"></button>
                Get Started,
              </button>
              <button className="border border-white/30 text-white px-8 py-3 rounded-lg hover: bg-white/10 transition-all duration-300"></button>
      <div className="relative z-10 min-h-screen bg-slate-900"></div>
        ...
        <section className="relative py-20 px-4 sm: px-6 lg:px-8"></section>
          ...
          <div className="max-w-7xl mx-auto text-center"><h1 className="text-4xl md: text-6xl font-bold text-white mb-6"
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center"><button className="bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 text-white font-bold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105"></button>
                Get Started,
              </button>
              <button className="border border-purple-500 text-purple-400 hover: bg-purple-500 hover:text-white font-bold py-3 px-8 rounded-lg transition-all duration-300"></button>
                Learn More,
              </button>
            </div>
    </div>
      ...
      <FuturisticBackground>
                ...
                { services.map((service, _index) => ( }
                  <div key={_index} className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 hover: border-cyan-500/50 transition-all duration-300 group"></div>
                    ...
                    ></div>
                      ...
                      <service.icon className="w-6 h-6 md: w-8 md:h-8 text-white" /></service.icon>
                    </div>
    </div>
              ...
              {services.map((service, index) => (
                ...
                <div key={index} className="bg-slate-800 rounded-lg p-6 hover: bg-slate-700 transition-all duration-300 transform hover:scale-105"></div>
                  ...
                  <div className={`w-12 h-12 rounded-lg bg-gradient-to-r ${service.color} flex items-center justify-center mb-4`}></div>`,
                    <service.icon className="w-6 h-6 text-white" /></service.icon>
                  </div>
    </div>
                  <h3 className="text-xl font-semibold text-white mb-3">{service.title}</h3>
                  <p className="text-gray-300 mb-4">{service.description}</p>
                  <button className="text-purple-400 hover: text-purple-300 font-medium flex items-center"></button>
                    Learn More <Right className="w-4 h-4 ml-1" /></Right>
                  </button>)
                </div>)
              ))
            </div>
        ...
        { /* Features Section */ }
        <section className="py-20 px-4 sm: px-6 lg:px-8 bg-slate-800"></section>
    </section>
          <div className="max-w-7xl mx-auto"><h2 className="text-3xl md: text-4xl font-bold text-white text-center mb-12"
              Why Choose Our AI Services?,
            </h2>

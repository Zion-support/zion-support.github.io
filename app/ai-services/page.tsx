...
const AiServicesPage: React.FC = () => {
  ...
  const testimonials = [{name: Dr. Sarah Johnson", ";]      company: "MedTech Solutions", ;"
      role: "CTO
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-purple-60 to-cyan-60 text-white px-8 py-3 rounded-lg hover: from-purple-70 hove,r:to-cyan-70 transition-all duration-30o0">
                Get Started
              </button>

...
const AiServicesPage: React.FC = () => {
  ...
  const aiServices = [      price: 'Starting at $349/month',
...
const AIServicesPage: React.FC = () => {
  ...
  ]return (      price: 'Starting at $1,199/month',
      popular: false
    }
  ];
  ...
  return (      <Navigation />      {/* Stats Section */}
            ...
            <div className="space-y-4">
              {benefits.slice(0, 3).map((benefit, index) => (
                <div key={index} className="flex items-center">
                  ...
                  <span className="text-gray-300">{benefit}</span>          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-lg p-4">
                ...
                <span className="text-gray-300">{benefit}</span>          <h2 className="text-3xl font-bold text-white text-center mb-12">Our AI Services</h2>
            ...
            {filteredServices.map((service) => (
              <div key={service.id} className={`bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border transition-all duration-300 hover:scale-105 ${
                ...
                <button className={`w-full py-4 px-6 rounded-lg font-bold text-lg transition-all duration-300 ${
                  ...
                  Learn More
                </button>      <Footer />>>>>>>> cursor/analyze-improve-and-deploy-application-e765
    </div>
  );
};

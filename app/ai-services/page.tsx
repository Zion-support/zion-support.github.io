...
const categories = ['All', 'Analytics', 'Automation', 'Security', 'Document Processing', 'Customer Experience', 'Content Creation', 'Industrial AI', 'Financial AI', 'Healthcare AI', 'Supply Chain', 'Quantum Computing', 'Advanced AI', 'Immersive Technology', 'Climate Tech', 'Pharmaceutical AI', 'Fashion Tech', 'Creative AI', 'Energy Tech', 'Autonomous Systems', 'Blockchain AI', 'Cognitive AI', 'AI Development', 'Quantum ML', 'Space Technology', 'Scientific AI', 'Data Visualization', 'Quantum Security', 'Neural Interface', 'Quantum Optimization', 'Immersive Learning', 'Quantum AI', 'Immersive Workspace', 'Quantum Finance', 'Immersive Design', 'Immersive Analytics', 'Environmental AI', 'Agricultural AI', 'Legal AI', '3D AI', 'Mobile AI', 'CDN AI', 'BI AI', 'API AI', 'Security AI'];
  ...
  if (!isLoaded) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 flex items-center justify-center" loading="lazy">
        <div className="animate-spin rounded-full h-32 w-32 border-b-2 border-white" loading="lazy"></div>
      </div>
    );
  }

  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 relative overflow-hidden" loading="lazy">{/* Futuristic Background Effects */}</div>
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(0,255,255,0.1)_0%,transparent_50%)] animate-pulse" loading="lazy" />
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(139,92,246,0.1)_0%,transparent_50%)] animate-pulse" loading="lazy" style={{ animationDelay: '1s' }} />
      <div className="absolute inset-0 bg-[linear-gradient(rgba(0,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(0,255,255,0.03)_1px,transparent_1px)] bg-[length:50px_50px]" loading="lazy" />{/* Animated Grid Pattern */}</div>
      <div className="absolute inset-0 opacity-20" loading="lazy">
        <div className="absolute top-0 left-0 w-full h-full bg-[linear-gradient(90deg,rgba(0,255,255,0.1)_1px,transparent_1px),linear-gradient(rgba(0,255,255,0.1)_1px,transparent_1px)] bg-[length:100px_100px] animate-pulse" loading="lazy" />
      </div>

      {/* Header */}
      <div className="relative overflow-hidden" loading="lazy">
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-pink-500/10 animate-pulse" loading="lazy"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 relative z-10" loading="lazy">
          <div className="text-center" loading="lazy">

            <div className="inline-block mb-6" loading="lazy">
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-4 neon-text" loading="lazy">AI Services</h1>h1>
              <div className="h-1 w-32 bg-gradient-to-r from-cyan-400 to-purple-600 mx-auto rounded-full" loading="lazy"></div>
            </div>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed" loading="lazy">Transform your business with our comprehensive suite of cutting-edge AI-powered solutions</p>p>

            {/* Stats */}
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-5xl mx-auto mb-12" loading="lazy">
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-cyan-400/20" loading="lazy">
                <div className="text-3xl font-bold text-cyan-400 mb-2" loading="lazy">35+</div>
                <div className="text-gray-300" loading="lazy">AI Services</div>
              </div>
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-purple-400/20" loading="lazy">
                <div className="text-3xl font-bold text-purple-400 mb-2" loading="lazy">25K+</div>
                <div className="text-gray-300" loading="lazy">Active Users</div>
              </div>
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-pink-400/20" loading="lazy">
                <div className="text-3xl font-bold text-pink-400 mb-2" loading="lazy">99.9%</div>
                <div className="text-gray-300" loading="lazy">Accuracy Rate</div>
              </div>
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-green-400/20" loading="lazy">
                <div className="text-3xl font-bold text-green-400 mb-2" loading="lazy">24/7</div>
                <div className="text-gray-300" loading="lazy">AI Support</div>
              </div>
            </div>
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent" loading="lazy">AI Services</h1>h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto neon-glow-cyan" loading="lazy">Transform your business with our comprehensive suite of AI-powered solutions</p>p>
            <div className="flex flex-wrap justify-center gap-4 mb-8" loading="lazy">
              <div className="holographic px-6 py-3 rounded-lg" loading="lazy">
                <span className="text-cyan-400 font-semibold" loading="lazy">15+ AI Platforms</span>
              </div>
              <div className="holographic px-6 py-3 rounded-lg" loading="lazy">
                <span className="text-purple-400 font-semibold" loading="lazy">25,000+ Companies</span>
              </div>
              <div className="holographic px-6 py-3 rounded-lg" loading="lazy">
                <span className="text-pink-400 font-semibold" loading="lazy">99.9% Accuracy</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Category Filter */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" loading="lazy">
        <div className="flex flex-wrap justify-center gap-4" loading="lazy">{categories.map((category) => (</div>
            <button
              key={category}
              className="px-6 py-3 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 text-white hover:bg-white/20 hover:border-cyan-400/50 transition-all duration-300 font-medium" loading="lazy"
             aria-label="Action button">{category}</button>
          ))}
        </div>
      </div>

      {/* Services Section */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16" loading="lazy">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" loading="lazy">{services.map((service) => (</div>
            <div
              key={service.id}
            ...
            >{/* Animated Background */}</div>
              <div className="absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-purple-600/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500" loading="lazy" />

              <div className="relative z-10" loading="lazy">
                <div className="flex items-start justify-between mb-6" loading="lazy">
                  <div className={`p-4 rounded-xl bg-gradient-to-r ${service.color} text-white group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
                    <service.icon className="h-8 w-8" loading="lazy" />
                  </div>
                  <div className="flex items-center space-x-2" loading="lazy">{service.popular && (</div>
                      <span className="px-3 py-1 bg-gradient-to-r from-orange-500 to-red-500 text-white text-xs rounded-full flex items-center font-bold shadow-lg" loading="lazy">
                        <Star className="w-3 h-3 mr-1" loading="lazy" />
                        Popular
                      </span>
                    )}
                    <div className="flex items-center text-yellow-400" loading="lazy">
                      <Star className="w-4 h-4 fill-current" loading="lazy" />
                      <span className="ml-1 text-sm font-medium" loading="lazy">{service.rating}</span>
                    </div>
                  </div>
                </div>

                <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-cyan-400 transition-colors duration-300" loading="lazy">{service.name}</h3>h3>

                <p className="text-gray-300 mb-6 leading-relaxed" loading="lazy">{service.description}</p>p>

                <div className="mb-6" loading="lazy">
                  <h4 className="text-lg font-semibold text-white mb-3 flex items-center" loading="lazy">
                    <Zap className="w-4 h-4 mr-2 text-cyan-400" loading="lazy" />
                    Key Features:
                  </h4>
                  <ul className="space-y-2" loading="lazy">
                    {service.features.slice(0, 4).map((feature, index) => (
                      <li key={index} className="flex items-center text-gray-300 text-sm" loading="lazy">
                        <CheckCircle className="w-4 h-4 text-green-400 mr-2 flex-shrink-0" loading="lazy" />
                        {feature}
                      </li>
                    ))}
                    {service.features.length > 4 && (
                      <li className="text-cyan-400 text-sm font-medium" loading="lazy">
                ...
                <div className="flex items-center justify-between mb-6" loading="lazy">
                  <div className="text-sm text-gray-400" loading="lazy">{service.users} users</div>div>
                  <div className="px-3 py-1 bg-white/10 rounded-full text-sm text-cyan-400 font-medium" loading="lazy">{service.category}</div>div>
                </div>

                <div className="mb-6" loading="lazy">
                  <div className="text-lg font-semibold text-cyan-400 mb-2" loading="lazy">{service.pricing}</div>div>
                  <h4 className="text-lg font-semibold text-white mb-3" loading="lazy">Key Capabilities:</h4>
                  <ul className="space-y-1" loading="lazy">
                    {service.capabilities.map((capability, index) => (
                      <li key={index} className="flex items-center text-gray-300 text-sm" loading="lazy">
                        <CheckCircle className="w-3 h-3 text-green-400 mr-2 flex-shrink-0" loading="lazy" />
                        {capability}
                      </li>
                    ))}
                  </ul>
                ...
                <div className="space-y-3" loading="lazy">
                  <a
                    href={service.link}
                    className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 text-white py-3 px-6 rounded-xl font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center group-hover:shadow-lg group-hover:shadow-cyan-500/25" loading="lazy"
                  >Get Started</a>
                    <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-300" loading="lazy" />
                  </a>
                  <a
                    href="/contact"
                    className="w-full border border-cyan-400/50 text-cyan-400 py-3 px-6 rounded-xl font-semibold hover:bg-cyan-400/10 transition-all duration-300 flex items-center justify-center" loading="lazy"
                  >Learn More</a>a>
                </div>
              </div>
      ...
      {/* CTA Section */}
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 py-16" loading="lazy">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center" loading="lazy">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4" loading="lazy">Ready to Transform Your Business with AI?</h2>h2>
          <p className="text-xl text-purple-100 mb-8" loading="lazy">Join 25,000+ companies already using our cutting-edge AI solutions. Start your free trial today!</p>p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8" loading="lazy">
            <a
              href="https://ziontechgroup.com/contact"
              className="bg-white text-purple-600 py-4 px-8 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-all duration-300" loading="lazy"
            >Start Your Free Trial</a>a>
            <a
              href="tel:+13024640950"
              className="border-2 border-white text-white py-4 px-8 rounded-lg font-semibold text-lg hover:bg-white hover:text-purple-600 transition-all duration-300" loading="lazy"
            >Call: +1 (302) 464-0950</a>a>
          </div>
          <div className="text-purple-100 text-sm" loading="lazy">

...
const AiServicesPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Ai Services Solutions',
      description: 'Professional ai services services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored ai services implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your ai services needs.'
    }
  ];

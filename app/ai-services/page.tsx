  ...
  const services = [
    {
      ...
      description: 'Develop comprehensive AI strategies tailored to your business needs.',
      icon: Brain,
      features: ['AI readiness assessment', 'Technology roadmap', 'ROI analysis', 'Implementation planning']
    },
    {
      title: 'Machine Learning Solutions',
      description: 'Build and deploy custom machine learning models for your specific use cases.',
      icon: BarChart,
      features: ['Custom model development', 'Data preprocessing', 'Model training', 'Deployment & monitoring']
    },
    {
      title: 'Natural Language Processing',
      description: 'Implement advanced NLP solutions for text analysis and language understanding.',
      icon: Globe,
      features: ['Text analysis', 'Sentiment analysis', 'Language translation', 'Chatbot development']
    },
    {
      title: 'Computer Vision',
      description: 'Develop computer vision solutions for image and video analysis.',
      icon: Eye,
      features: ['Image recognition', 'Object detection', 'Video analysis', 'Quality inspection']
    },
    {
      title: 'Predictive Analytics',
      description: 'Leverage historical data to predict future trends and outcomes.',
      icon: TrendingUp,
      features: ['Forecasting', 'Risk assessment', 'Demand prediction', 'Performance optimization']
    },
    {
      title: 'AI Automation',
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Discover the powerful AI technologies that can revolutionize your business operations.
              </p>
            </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Experience the transformative power of AI with our proven track record and expertise.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

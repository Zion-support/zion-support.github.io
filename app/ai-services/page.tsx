...
const AiServicesPage: React.FC = () => {
  ...
  const categories = [
    { id: 'overview', name: 'Overview', icon: <BarChart className="w-5h-5ml-2" /&gt; } ,</BarChart / />
    { id: 'analytics', name: 'Analytics', icon: <TrendingUp className="w-5h-5ml-2" /&gt; } ,</TrendingUp / />
    { id: 'conversational', name: 'Conversational', icon: <MessageCircle className="w-5h-5ml-2" /&gt; } ,</MessageCircle / />
    { id: 'security', name: 'Security', icon: <Shield className="w-5h-5ml-2" /&gt; } ,</Shield / />
    { id: 'vision', name: 'Computer Vision', icon: <Eye className="w-5h-5ml-2" /&gt; } ,</Eye / />
    { id: 'voice', name: 'Voice AI', icon: <Mic className="w-5h-5ml-2" /&gt; } ,</Mic / />
    { id: 'content', name: 'Content', icon: <FileText className="w-5h-5ml-2" /&gt; } ,</FileText / />
    { id: 'customer', name: 'Customer Service', icon: <Users className="w-5h-5ml-2" /&gt; } ,</Users / />
    { id: 'automation', name: 'Automation', icon: <Workflow className="w-5h-5ml-2" /&gt; }</Workflow / />
  ];
  const stats = [
    { number: '500+', label: 'AI Models Deployed', icon: <Brain className="w-5h-5ml-2" /&gt; } ,</Brain / />
    { number: '99.9%', label: 'Uptime Guarantee', icon: <Shield className="w-5h-5ml-2" /&gt; } ,</Shield / />
    { number: '24/7', label: 'AI Monitoring', icon: <Clock className="w-5h-5ml-2" /&gt; } ,</Clock / />
    { number: '150+', label: 'AI Experts', icon: <Users className="w-5h-5ml-2" /&gt; }</Users / />
  ];
      ...
      <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />
        {/* Hero Section */}  <section className="w-5h-5ml-2" / />
          ...
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />
            ...
            <h1 className="w-5h-5ml-2" / />
              Transform Your Business with{' '}  <span className="w-5h-5ml-2" />AI Technology;
              </span>
            </h1>
  ...
  r:scale-105" / />
        ...
        {/* Services Grid */}  <section className="w-5h-5ml-2" / />
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />
            <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />
        ...
        {/* AI Process Section */}  <section className="w-5h-5ml-2" / />
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />
            <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />

...
const AIServicesPage: React.FC = () => {
  const aiServices = [
    ...
    },
    {
      ...
      description: 'Build custom voice assistants and chatbots with natural language processing capabilities.',
      features: ['Voice recognition', 'Natural language understanding', 'Multi-language support', 'Custom training'],
      pricing: 'Starting at $89/month',
    ...
    },
    {
      ...
      features: ['User profiling', 'Collaborative filtering', 'A/B testing', 'Real-time updates'],
    ...
    },
    {
      ...
      description: 'Advanced image analysis and recognition for various business applications.',
      features: ['Object detection', 'Facial recognition', 'Text extraction', 'Quality assessment'],

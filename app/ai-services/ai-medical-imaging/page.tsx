...
export const metadata: Metadata = {
  title: 'AI Medical Imaging and Diagnostics | Zion Tech Group',
  description: 'FDA-ready AI diagnostic support for radiology, pathology, and dermatology with anomaly detection and case prioritization.',
  alternates: { canonical: '/ai-services/ai-medical-imaging' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Medical Imaging and Diagnostics',
        ...
        pricing: [
          { tier: 'Starter', price: '$999', period: '/month', features: ['Core AI features', 'Up to 10K requests/mo', 'Standard analytics', 'Email support'] },
          { tier: 'Professional', price: '$2499', period: '/month', features: ['All Starter', 'Up to 100K requests/mo', 'Advanced analytics', 'Priority support', 'API access'] },
          { tier: 'Enterprise', price: '$5999', period: '/month', features: ['Everything in Pro', 'Unlimited', 'Dedicated training', '24/7 support', 'SLA', 'On-premise'] },
        ],
        contact: {

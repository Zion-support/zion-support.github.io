...
export const metadata: Metadata = {
  ...
  description: "AI-Powered Tech Debt Quantifier — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-powered-tech-debt-quantifier" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI-Powered Tech Debt Quantifier', href: '/ai-services/ai-powered-tech-debt-quantifier' },
        ],
      }
    />
  );

...
const EnergyManagementPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Energy Management Solutions',
      description: 'Professional energy management services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored energy management implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your energy management needs.'
    }
  ];

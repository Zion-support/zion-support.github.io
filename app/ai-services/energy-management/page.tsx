...
const EnergyManagementPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional energy management services and solutions by Zion Tech Group."
      keywords="energy management, services, solutions, technology, Zion Tech Group"
    >

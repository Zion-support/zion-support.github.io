...
export const metadata: Metadata = {
  ...
  description: "AI-Powered SEO Content Optimizer — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-powered-seo-optimizer" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI-Powered SEO Content Optimizer', href: '/ai-services/ai-powered-seo-optimizer' },
        ],
      }
    />
  );

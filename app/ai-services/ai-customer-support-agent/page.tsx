...
export const metadata: Metadata = {
  ...
  description: "AI Customer Support Agent — professional enterprise service from Zion Tech Group.",
  alternates: { canonical: "/ai-services/ai-customer-support-agent" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Customer Support Agent', href: '/ai-services/ai-customer-support-agent' },
        ],
      }
    />
  );

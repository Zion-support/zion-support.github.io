...
<div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-green-500/20 to-blue-500/20 border border-green-500/30 mb-6"></div><>
<//div>
<Sparkles className="w-4 h-4 text-green-400 mr-2" /><>
</Sparkles className="w-4 h-4 text-green-400 mr-2" />
<span className="text-green-400 text-sm font-medium"></span className="text-green-400 text-sm font-medium">
...
<span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-400 to-purple-400"></span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-400 to-purple-400">
...
<p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed"></p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                ...
                forecasting, smart reorder optimization, and automated purchase</p><//p>
                orders that reduce costs and eliminate stockouts.</p><>
<//p>
</p><>
<//p>
...
<div className="text-3xl md:text-4xl font-bold text-green-400 mb-2"></div><//div>
                    30%</div><>
<//div>
</div><>
<//div>
<div className="text-gray-300 text-sm"></div><//div>
                    Reduction in Inventory Costs</div><>
<//div>
</div><>
<//div>
</div><>
...
<p className="text-lg text-gray-300"></p><//p>
                Optimize inventory for any business type</p><>
<//p>
</p><>
<//p>
</div><>
...
<div className="text-sm text-gray-300 group-hover:text-green-400 transition-colors"></div><//div>
                    {industry.name}</div><>
<//div>
</div><>
<//div>
...
<h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6"></h1><//h1>
                Powerful Features for Inventory Optimization</h1><>
<//h1>
</h2><>
<//h2>
<p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed"></p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Everything you need to optimize inventory levels, reduce costs,</p><//p>
                and eliminate stockouts with AI intelligence.</p><>
<//p>
</p><>
<//p>
</div><>
...
<div className="text-green-400 mb-4 group-hover:scale-110 transition-transform duration-300"></div><//div>
                    {feature.icon}</div><>
<//div>
</div><>
<//div>
<h3 className="text-xl font-semibold text-white mb-3 group-hover:text-green-400 transition-colors"></h1><//h1>
                    {feature.title}</h1><>
<//h1>
</h3><>
<//h3>
...
<h2 className="text-3xl md:text-4xl font-bold text-white mb-4"></h1><//h1>
                Choose Your Inventory Management Plan</h1><>
<//h1>
</h2><>
<//h2>
<p className="text-xl text-gray-300 max-w-3xl mx-auto"></p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Flexible pricing options designed to scale with your inventory</p><//p>
                needs</p><>
<//p>
</p><>
<//p>
...
<span className="text-4xl font-bold text-green-400"></span className="text-4xl font-bold text-green-400">
                        {plan.price}
                      </span><>
<//span>
...
<h2 className="text-3xl md:text-4xl font-bold text-white mb-4"></h1><//h1>
                Trusted by Inventory Professionals</h1><>
<//h1>
</h2><>
<//h2>
<p className="text-xl text-gray-300 max-w-3xl mx-auto"></p><//p>
                See how businesses are optimizing their inventory with AI</p><>
<//p>
</p><>
<//p>
</div><>
...
<div className="w-10 h-10 bg-gradient-to-r from-green-500 to-blue-600 rounded-full flex items-center justify-center text-white font-semibold mr-3"></div><//div>
...
<div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/20 rounded-2xl p-12"></div><>
<//div>
<h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6"></h1><//h1>
                Ready to Optimize Your Inventory?</h1><>
<//h1>
</h2><>
<//h2>
<p className="text-xl text-gray-300 mb-8 leading-relaxed"></p className="text-xl text-gray-300 mb-8 leading-relaxed">
                ...
                Optimizer Pro to reduce costs and eliminate stockouts. Start</p><//p>
                your free trial today and see the difference AI can make.</p><>
<//p>
</p><>
<//p>

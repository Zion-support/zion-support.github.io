    ...
    <>
      ...
      <div className="min-h-screen pt-16">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-16">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-green-500/20 to-blue-500/20 border border-green-500/30 mb-6">
                ...
                <span>#1 AI Inventory Management Platform
                </span>
              </div>

              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                <span>Zion AI Inventory Optimizer Pro
                </span>
              </h1>

              <p>Transform your inventory management with AI-powered demand
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
                <div className="text-center">
                  ...
                  <div>Reduction in Inventory Costs
                  </div>
                </div>
                <div className="text-center">
                  <div>95%
                ...
                <div className="text-center">
                  ...
                  <div>Reduction in Overstock
                  </div>
                </div>
                <div className="text-center">
                  <div>99%
                  </div>
                  <div>Service Level Achievement
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p>Optimize inventory for any business type
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2>Powerful Features for Inventory Optimization
              </h2>
              <p>Everything you need to optimize inventory levels, reduce costs,
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-purple-800/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2>Choose Your Inventory Management Plan
              </h2>
              <p>Flexible pricing options designed to scale with your inventory
                needs
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2>Trusted by Inventory Professionals
              </h2>
              <p>See how businesses are optimizing their inventory with AI
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/20 rounded-2xl p-12">
              <h2>Ready to Optimize Your Inventory?
              </h2>
              <p>Join thousands of businesses already using Zion AI Inventory

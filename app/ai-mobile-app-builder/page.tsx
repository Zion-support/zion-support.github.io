...
<h1 className="text-5xl md:text-7xl font-bold text-white mb-6">Ai Mobile App Builder</h1>
            <p>
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center"></div>
              ...
              <button className="bg-gradient-to-r from-teal-500 to-blue-600 text-white px-8 py-4 rounded-full font-semibold hover:from-teal-600 hover:to-blue-700 transition-all duration-300">View Demo, origin/cursor/analyze-improve-and-deploy-application-1247
              </button>
            </div>
          </div>
        </section>
...
<h2 className="text-4xl font-bold text-white mb-4">Ready to Get Started?</h2>
              ...
              <div className="flex flex-col sm: flex-row gap-4 justify-center"></div>
                ...
                <button className="bg-gradient-to-r from-teal-500 to-blue-600 text-white px-8 py-4 rounded-full font-semibold hover:from-teal-600 hover:to-blue-700 transition-all duration-300">Learn More origin/cursor/analyze-improve-and-deploy-application-1247
                </button>
              </div>
            </div>
          </div>

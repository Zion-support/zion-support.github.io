...
const RoboticsIntegrationPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional robotics integration services and solutions by Zion Tech Group."
      keywords="robotics integration, services, solutions, technology, Zion Tech Group"
    >

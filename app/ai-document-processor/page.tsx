...
import { FileText, Zap, Search, ArrowRight } from "lucide-react";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered document processor for automated processing and analysis." />
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Advanced AI-powered document processor for automated processing and analysis.
            </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Let us help you implement advanced AI document processing for your business.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

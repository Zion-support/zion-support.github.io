...
import { Brain, BarChart, FileText, Zap } from 'lucide-react'
...
const AiDocumentProcessorPage = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Intelligent document processing with automated data extraction and analysis.',
    },
    {
      icon: Zap,
      title: 'Automation',
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-sky-900 to-slate-900 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-gradient-to-r from-blue-600 to-sky-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-sky-700 transition-all duration-300">
              Get Started
            </button>
      ...
      <section className="py-20 bg-gradient-to-r from-slate-900 to-sky-900">

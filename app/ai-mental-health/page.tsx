...
import { CheckCircle, Heart, BarChart3, Shield, Brain, ArrowRight, Zap, Users, Target, Clock, Heart, Leaf, ShoppingCart, Trophy } from 'lucide-react';
...
const AimentalhealthPage: React.FC = () => {
  const features = [
    {
      ...
      description: 'AI-powered monitoring of mental health indicators'
    },
    {
      icon: Users,
      title: 'Therapy Assistance',
      description: 'AI-assisted therapy and counseling support'
    },
    {
      icon: Shield,
      title: 'Crisis Detection',
      description: 'Early detection of mental health crises and intervention'
    },
    {
      icon: Zap,
      title: 'Wellness Tracking',
      description: 'Comprehensive wellness tracking and recommendations'
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>AI Mental Health Solutions | Zion Tech Group - AI-Powered Solutions</title>
        <meta name="description" content="AI-powered mental health monitoring, therapy assistance, and wellness support" />
        <meta name="keywords" content="ai, mental, health, AI solutions, technology, automation" />
      </Helmet>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              AI-powered mental health monitoring, therapy assistance, and wellness support
            </p>
          </div>
        </section>

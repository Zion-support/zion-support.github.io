  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900">
      <Navigation >{/* Hero Section */}</Navigation>
            ...
            </div><div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-green-600 to-blue-600 rounded-full mb-6">
      ...
      {/* Features Section */}<section className="py-16 px-4 bg-slate-800/50">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Advanced Predictive Features</h2><p className="text-xl text-gray-300 max-w-3xl mx-auto">Comprehensive AI-powered predictive maintenance solution with real-time monitoring and intelligent insights.<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{features.map((feature, index) => (</div>
              <div key={index} className="bg-slate-800/80 backdrop-blur-sm border border-green-400/20 rounded-xl p-6 hover:border-green-400/40 transition-all duration-300">
                  ...
                  </div><div className="w-10 h-10 bg-gradient-to-r from-green-600 to-blue-600 rounded-lg flex items-center justify-center">
                    <Brain className="w-5 h-5 text-white"  / />
                  <h3 className="text-lg font-semibold text-white">{feature}</h3><p className="text-gray-300 text-sm">{feature === 'Machine learning algorithms for failure prediction' && 'Advanced ML models analyze historical data and sensor readings to predict equipment failures with 95%+ accuracy.'}</p>
      ...
      {/* Industries Section */}<section className="py-16 px-4">
        </section><div className="container mx-auto max-w-6xl">
          </div><div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Industry Applications</h2><p className="text-xl text-gray-300 max-w-3xl mx-auto">Proven results across multiple industries with significant cost savings and improved reliability.<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{industries.map((industry, index) => (</div>
              <div key={index} className="bg-slate-800/80 backdrop-blur-sm border border-green-400/20 rounded-xl p-6 hover:border-green-400/40 transition-all duration-300">
                  ...
                  </div><div className="w-12 h-12 bg-gradient-to-r from-green-600 to-blue-600 rounded-lg flex items-center justify-center">
      ...
      {/* Benefits Section */}<section className="py-16 px-4 bg-slate-800/50">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Proven Business Benefits</h2><p className="text-xl text-gray-300 max-w-3xl mx-auto">Transform your maintenance operations with measurable results and significant cost savings.<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{benefits.map((benefit, index) => (</div>
              <div key={index} className="text-center">
                </div><div className="w-16 h-16 bg-gradient-to-r from-green-600 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
                  <CheckCircle className="w-8 h-8 text-white"  / />
                <h3 className="text-xl font-semibold text-white mb-2">{benefit}</h3><p className="text-gray-300">{benefit === 'Reduce maintenance costs by 30-50%' && 'Optimize maintenance schedules and prevent unnecessary repairs, resulting in significant cost savings.'}</p>
      ...
      {/* Pricing Section */}<section id="pricing" className="py-16 px-4">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Choose Your Plan</h2><p className="text-xl text-gray-300 max-w-3xl mx-auto">Flexible pricing plans designed to meet your predictive maintenance needs at any scale.<div className="grid grid-cols-1 md:grid-cols-3 gap-8">{pricingPlans.map((plan, index) => (</div><div key={index} className={`bg-slate-800/80 backdrop-blur-sm border rounded-xl p-8 relative ${plan.popular ? 'border-green-400/40 ring-2 ring-green-400/20' : 'border-gray-600/40'}`}>{plan.popular && (</div>
      ...
      {/* Contact Section */}<section id="contact" className="py-16 px-4 bg-gradient-to-r from-green-600 to-blue-600">

...
<h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">Ai Predictive Maintenance</h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">Advanced AI-powered ai predictive maintenance solution for modern businesses.</p>

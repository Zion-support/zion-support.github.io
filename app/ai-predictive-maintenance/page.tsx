...
const AiPredictiveMaintenancePage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai predictive maintenance services and solutions by Zion Tech Group."
      keywords="ai predictive maintenance, services, solutions, technology, Zion Tech Group"
    >

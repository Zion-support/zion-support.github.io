...
import { Settings, BarChart, Zap, Shield, CheckCircle, Star, Users, Clock, DollarSign, ArrowRight, Phone, Mail, MapPin, Brain, Cpu, Target, MessageSquare, TrendingUp, AlertTriangle, Wrench, Database, Globe } from 'lucide-react';
            ...
            {features.map((feature, index) => (
              <div key={index} className="bg-slate-800/80 backdrop-blur-sm border border-green-400/20 rounded-xl p-6 hover:border-green-400/40 transition-all duration-300">
                ...
                <p className="text-gray-300 text-sm">
                  ...
                  {feature === 'IoT device connectivity' && 'Connect and monitor thousands of IoT sensors and devices for comprehensive equipment visibility.'}
                  {feature === 'Cloud-based analytics platform' && 'Scalable cloud platform that processes massive amounts of data and provides insights through advanced analytics.'}
                </p>
              </div>
            ))}
          </div>
            ...
            {benefits.map((benefit, index) => (
              <div key={index} className="text-center">
                ...
                <p className="text-gray-300">
                  {benefit === 'Reduce maintenance costs by 30-50%' && 'Optimize maintenance schedules and prevent unnecessary repairs, resulting in significant cost savings.'}
                  ...
                  {benefit === 'Extend asset lifespan' && 'Proactive maintenance and optimal operating conditions extend the useful life of your equipment.'}
                  {benefit === 'Improve safety and compliance' && 'Predictive maintenance reduces safety risks and helps maintain compliance with industry regulations.'}
                </p>
              </div>
            ))}
          </div>

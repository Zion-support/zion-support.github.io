...
;
exportdefaultfunctionAICodeAssistantProPage() {constfeatures = [{
  ...
  constpricingPlans = [{name: 'Developer',;
      price: '$29',;
      period: '/month',;
    ...
    {name: 'Team',;
      ...
      features: ['Upto 10,000 codegenerations/month',;
        'AdvancedAIfeatures',;
    ...
    {name: 'Enterprise',;
      ...
      features: ['Unlimitedcodegenerations',;
        'AllAIfeatures',;
        'Customintegrations',;
        'Dedicatedsupport',;
        'White-labeloption',;
  ...
  constintegrations = [{name: 'VSCode', icon: '💻' },;
  ...
  constsupportedLanguages = ['Python', 'JavaScript', 'TypeScript', 'Java', 'C++', 'C#', 'Go', 'Rust',;

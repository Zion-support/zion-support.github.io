  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Build intelligent autonomous systems that can operate independently and make decisions in real-time." />
        <meta name="keywords" content="AI autonomous systems, artificial intelligence, automation, robotics, intelligent systems, autonomous vehicles" />
      </Helmet>
        ...
        <section className="py-20 px-4 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Discover how Ai Autonomous Systems can transform your business across different domains
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

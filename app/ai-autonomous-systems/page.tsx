...
const AiAutonomousSystemsPage: React.FC = () => {
  return (
    ...
    <>
        ...
        <d iv c las sName="c onta iner mx-auto px-4-py-16">
          ...
          <d iv c las sName="t e xt-c ent ermb-16">
            ...
            <h1 c las sName="t e xt-4 xl md:t ext-6 xl f ont-b old text-w hitem-b-6" />
              <s pan c las sName="b g-g rad ient-to-r from-c yan-400 to-purple-400bg-clip-t exttext-transpare-n-t">Ai Autonomous Systems
              </s pan>
            </h1>
    ...
    <>
            ...
            <h2 c las sName="t e xt-2 xl f ont-b old text-w hitem-b-4">C omi ng S oon</h2>
            <p c las sName="t e xt-g ray-300mb-6" />
    </>              We're working on bringing you comprehensive ai autonomous systems solutions. 
              Contact us to learn more about our services.
    <>
            </p>
            <b utton c las sName="b g-g rad ient-to-r from-c yan-500 to-purple-500 t ext-w hit-e px-8 py-3 rounded-lg f ont-semibold hover:from-c yan-600 hover:to-purple-600transition-allduration-300">Contact Us
            </b utton>
          </d iv>
      </d iv>
          </d iv>

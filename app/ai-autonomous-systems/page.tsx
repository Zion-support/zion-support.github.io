  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI Autonomous Systems solutions powered by AI technology." />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced AI Autonomous Systems solutions powered by AI technology.
            </p>

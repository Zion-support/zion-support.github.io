...
const AiAutonomousSystemsPage: React.FC = () => {
  ...
  const features = [{
      icon: Brain, title: 'AI Decision Making', description: 'Advanced AI algorithms for autonomous decision making in complex environments.', benefits: ['Real-time processing', 'Adaptive learning', 'Risk assessment', 'Optimization']
  ...
  const applications = [{
      title: 'Autonomous Vehicles', description: 'Self-driving cars, trucks, and drones with advanced AI navigation and safety systems.', icon: '🚗'
    }, {
                  ...
                  <ul className="space-y-2">
                    {feature.benefits.map((benefit, benefitIndex) => (
                      <li key={benefitIndex} className="flex items-center text-sm text-gray-300">
                        <CheckCircle className="w-4 h-4 text-violet-400 mr-2 flex-shrink-0" /></CheckCircle>
                        {benefit}
                      </li>
                    ))}
                  </ul>

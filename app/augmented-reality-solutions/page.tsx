          ...
          <div className="bg-slate-800 rounded-lg p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-300">iOS and Android AR applications using ARKit and ARCore.</div>
              
              <div className="text-center">
                <div className="w-16 h-16 bg-red-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">🥽</div>
                <h3 className="text-xl font-semibold mb-3 text-red-400">AR Glasses</h3>
                <p className="text-gray-300">Enterprise AR solutions for HoloLens and Magic Leap.</div>
              
              <div className="text-center">
                <div className="w-16 h-16 bg-purple-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">🌐</div>
                <h3 className="text-xl font-semibold mb-3 text-purple-400">Web AR</h3>
                <p className="text-gray-300">Browser-based AR experiences accessible on any device.</div>

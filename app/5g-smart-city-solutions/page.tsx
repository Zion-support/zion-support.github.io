...
export default function GsmartcitysolutionsPage() {
  return (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-xl text-gray-600 mb-6">
              Transform your city with 5G-powered smart solutions. Enable connected infrastructure, real-time monitoring, and citizen services.
            </p>

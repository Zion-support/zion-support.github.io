...
const AiSpeechSynthesisPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai speech synthesis services and solutions by Zion Tech Group."
      keywords="ai speech synthesis, services, solutions, technology, Zion Tech Group"
    >

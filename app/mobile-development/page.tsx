...
const MobileDevelopmentPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional mobile development services and solutions by Zion Tech Group."
      keywords="mobile development, services, solutions, technology, Zion Tech Group"
    >

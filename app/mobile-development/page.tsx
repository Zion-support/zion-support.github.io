...
const MobileDevelopmentPage: React.FC = () => {
  ...
  return()
    ...
    <>
    <title>
</>MobileDevelopment - Zion Tech Group<>
    </title>
    <h1 className="text-4xl font-bold text-white mb-6">
</>MobileDevelopment<>
    </h1>
    <p className="text-lg text-gray-300 mb-8">
</>Professional mobiledevelopment services coming soon.</p>
    ...
    <h1 className="w-5h-5ml-2" />
                ...
                Mobile <span className="bg-gradient-to-rfrom-cyan-400to-purple-400bg-clip-texttext-transparent"  >Development<>
    </span>
    </h1>
</>
    ...
    <h2 className="w-5h-5ml-2" />
                ...
                Our <span className="bg-gradient-to-rfrom-cyan-400to-purple-400bg-clip-texttext-transparent"  >Mobile Solutions<>
    </span>
    </h2>
</>
  ...
  r:scale-105" />
    ...
    <span className="text-2 xlfont-boldtext-cyan-400"  >
</>{service.price}<>
    </span>
    <Link;</Link>
</></Link>
    ...
    <h2 className="w-5h-5ml-2" />
                ...
                Our <span className="bg-gradient-to-rfrom-cyan-400to-purple-400bg-clip-texttext-transparent"  >Process<>
    </span>
    </h2>
</>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                    ...
                    <span className="text-2 xlfont-boldtext-cyan-400"  >{step.step}<>
    </span>
    </div>
</>
                  <h3 className="text-xl font-bold text-white mb-4"  >{step.title}<>
    </h3>
    ...
    <h3 className="text-2 xl font-bold text-white mb-4"  >
</>Fast Development<>
    </h3>
    <p className="w-5h-5ml-2">

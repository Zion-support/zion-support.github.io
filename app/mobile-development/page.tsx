  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced mobile development solutions powered by cutting-edge AI technology to transform your business operations and drive growth." />
        ...
        <meta property="og:description" content="Advanced mobile development solutions powered by cutting-edge AI technology to transform your business operations and drive growth." />
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-8">
                ...
                <span className="text-cyan-400 font-medium">Mobile Development</span>
              </div>
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Advanced mobile development solutions powered by cutting-edge AI technology to transform your business operations and drive growth.
              </p>

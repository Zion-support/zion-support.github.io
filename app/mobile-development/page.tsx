...
export const metadata: Metadata = {
  ...
  description:
    'Mobile Development accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-qual',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Mobile Development accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-quality code faster while reducing technical debt.',
        iconEmoji: '⚙️',
        features: [
                  {

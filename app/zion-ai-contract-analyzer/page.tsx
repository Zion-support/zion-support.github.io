...
export const metadata: Metadata = {
  ...
  description:
    'Zion AI Contract Analyzer streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your te',
  alternates: { canonical: '/zion-ai-contract-analyzer' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Contract Analyzer streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Contract Analyzer',
      }}
    />
  );
}

...
const Cloud Security Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Cloud Security</title>
        <meta name="description" content="Professional cloud security solutions and services" />
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Cloud Security Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Cloud security - Zion Tech Group</title> <meta name="description"content="Professional Cloud security solutions and services" /> <meta name="keywords"content="cloud, security" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Cloud security</h1> <p className="text xl text gray-300 mb-8"> Professional Cloud security solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Cloud security</h1>
            <p>
          
              Professional Cloud security solutions and services
            </p>
...
export default Cloud;; Security Page

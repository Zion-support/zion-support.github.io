...
const CloudSecurityPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional cloud security services and solutions by Zion Tech Group."
      keywords="cloud security, services, solutions, technology, Zion Tech Group"
    >

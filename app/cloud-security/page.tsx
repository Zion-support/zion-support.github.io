  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive cloud security solutions to protect your business data." />
        <meta name="keywords" content="cloud security, cybersecurity, data protection, cloud compliance" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Comprehensive cloud security solutions to protect your business data.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our cloud security solutions are designed to help your business grow and succeed.
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-blue-600">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Contact us today to learn more about our cloud security solutions.
            </p>

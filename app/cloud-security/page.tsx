...
const benefits = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"> " <Helmet>"
        ...
        <meta name="description" content="Professional Cloud Security services by Zion Tech Group. Advanced AI and IT solutions for your business." /> " <meta name="keywords" content="cloud security, cybersecurity, data protection, AI solutions, IT services, Zion Tech Group" />"
      </Helmet>
      {/* Hero Section */}

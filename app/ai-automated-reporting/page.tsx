      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">{/* Hero Section */}</div>
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Ai Automated Reporting</h1>h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Professional aiautomatedreporting solutions powered by advanced AI</p>

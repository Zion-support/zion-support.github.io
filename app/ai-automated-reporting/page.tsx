...
export default function AIAutomatedReporting() {
  const features = [
    {
      ...
      description: "Automatically generate comprehensive reports from your data with intelligent insights and visualizations",
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: "The automated scheduling and team collaboration features have made our reporting workflow so much more efficient. We can now focus on analysis instead of report creation.",
      rating: 5,
      avatar: "LJ"
    }
  ];
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                See what our users say about AI Automated Reporting
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10 bg-gradient-to-r from-teal-900/30 to-cyan-900/30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Join thousands of teams who use AI Automated Reporting to streamline their reporting process. 

...
=======
export default function AiAutomatedReportingPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Ai Automated Reporting - Zion Tech Group</title>
        <meta name="description" content="Advanced Ai Automated Reporting solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Ai Automated Reporting solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

  ...
  const features = [
    {
      ...
      description: 'Generate comprehensive reports automatically using AI algorithms.',
    ...
    },
    {
      ...
      description: 'Schedule automated reports to be generated and delivered on time.',

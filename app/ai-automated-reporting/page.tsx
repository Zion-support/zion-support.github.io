...
<<<<<<< HEAD
      <Helmet>
        ...
        <meta name="keywords" content="ai automated reporting, services, solutions, technology" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Professional ai automated reporting services delivered by experienced professionals.
            </p>
          </div>

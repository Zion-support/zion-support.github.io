  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        ...
        <meta name="description" content="Advanced ai automated reporting solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="bg-slate-800 p-8 rounded-lg">
            ...
            <p className="text-gray-300">
              We are working on bringing you the most advanced ai automated reporting solutions. 
...
'use client';';
import React from 'react';';';
import { Helmet , BarChart, TrendingUp, FileText, Zap, Brain, CheckCircle, ArrowRight, Star, Users, Clock, Shield, Target  } from 'react-helmet-async';';';
...
<meta name="keywords" content="AI reporting, automated reports, business intelligence, data analytics, smart reporting, AI insights" /></Helmet>"
...
<span className="text-cyan-400 font-medium">AI-Powered Intelligence</span></div>"
...
<TrendingUp className="w-6 h-6 text-white" /></div>"
...
<span className="text-purple-400 font-bold">+150%</span></div>"
<div className="flex justify-between items-center">"
...
=======
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Advanced ai automated reporting solutions by Zion Tech Group.
          </p>
        </div>
      </div>
    </div>

...
import { ArrowRight, Bug, Brain, Shield, Users, CheckCircle, Star, Phone, Play, Mail, BarChart3, Eye, Lock, Network } from 'lucide-react';
  ...
  const features = [
    {
      ...
      benefits: ["Real-time detection", "Zero-day protection", "Behavioral analysis", "Predictive security"]
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: "Advanced Firewall",
      description: "Next-generation firewall with AI-powered traffic analysis and threat blocking.",
      benefits: ["Deep packet inspection", "Application control", "Intrusion prevention", "VPN integration"]
    },
    {
      icon: <Eye className="w-6 h-6" />,
      title: "Security Monitoring",
      description: "24/7 security operations center with AI-driven threat hunting and incident response.",
      benefits: ["24/7 monitoring", "Threat hunting", "Incident response", "Forensic analysis"]
    },
    {
      icon: <Lock className="w-6 h-6" />,
      title: "Data Protection",
      description: "Comprehensive data encryption, backup, and recovery solutions for all your critical assets.",
      benefits: ["End-to-end encryption", "Automated backups", "Disaster recovery", "Compliance management"]
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Identity Management",
      description: "Multi-factor authentication and identity access management with AI-powered risk assessment.",
      benefits: ["MFA enforcement", "Single sign-on", "Risk-based access", "Privilege management"]
    },
    {
      icon: <BarChart3 className="w-6 h-6" />,
      title: "Security Analytics",
      description: "Comprehensive security dashboards and reporting with AI-driven insights and recommendations.",
      benefits: ["Real-time dashboards", "Custom reports", "Risk assessment", "Compliance reporting"]
    }
  ];
  ...
  const threatTypes = [
    {
      ...
      description: "Advanced detection and prevention of malware, ransomware, and other malicious software",
      icon: <Bug className="w-8 h-8" />,
      coverage: "99.9%"
    },
    {
      title: "Phishing Defense",
      description: "AI-powered email security that identifies and blocks sophisticated phishing attempts",
      icon: <Mail className="w-8 h-8" />,
      coverage: "99.7%"
    },
    {
      title: "DDoS Mitigation",
      description: "Real-time protection against distributed denial-of-service attacks",
      icon: <Network className="w-8 h-8" />,
      coverage: "100%"
    },
    {
      title: "Insider Threats",
      description: "Behavioral analysis to detect and prevent insider threats and data exfiltration",
  ...
  const testimonials = [
    {
      ...
      role: "CISO",
      content: "The AI cybersecurity platform has reduced our security incidents by 95%. The predictive capabilities are game-changing.",
      rating: 5
    },
    {
      name: "Sarah Williams",
      ...
      role: "IT Director",
      content: "HIPAA compliance has never been easier. The automated monitoring and reporting save us hours every week.",
      rating: 5
    },
    {
      ...
      content: "The threat detection is incredibly accurate. We've prevented several potential breaches before they could cause damage.",
      rating: 5
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Protect your business with our AI-powered cybersecurity platform. Advanced threat detection, 24/7 monitoring, and compliance management for modern enterprises." />
        <meta name="keywords" content="AI cybersecurity, threat detection, security monitoring, data protection, compliance, SOC 2, HIPAA, GDPR" />
        <meta property="og:title" content="AI Cybersecurity Platform - Zion Tech Group" />
        <meta property="og:description" content="Advanced AI-powered cybersecurity platform with real-time threat detection and protection" />

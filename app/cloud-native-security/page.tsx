...
export const metadata: Metadata = {
  ...
  description:
    'Cloud Native Security provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate au',
  alternates: { canonical: '/cloud-native-security' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Cloud Native Security provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Cloud Native Security',
      }}
    />
  );
}

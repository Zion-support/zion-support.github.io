...
const Cloud Native Security Page: React.FC = () => {
  return (
    <>
      <Helmet />
        <title>CloudNative Security - ZionTech Group</title>
        <meta name ="description" content="Cloud Native Securityservices by Zion Tech Group. Professional AI and IT solutions." / / />
        <meta name ="keywords" content="cloud-native-security, AIsolutions, ITservices" / / />
      </Helmet>
        ...
        <div className ="containermx-autopx-4py-16" />
          <div className ="text-centermb-16" />
            <h1className ="text-4 xlmd:text-6 xlfont-boldtext-whitemb-6" />
              <spanclassName ="bg-gradient-to-rfrom-cyan-400 to-purple-400bg-clip-texttext-transparent"  />CloudNative Security
              </span>
            </h1>
            <pclassName ="text-xltext-gray-300 max-w-3xlmx-auto" />
              Professionalcloud nativesecurity servicesby ZionTech Group.
            </p>
          </div>
          ...
          <div className ="bg-gradient-to-brfrom-purple-900/50 to-blue-900/50 backdrop-blur-smborder border-purple-500/20 rounded-xlp-8text-center" />
            ...
            <pclassName ="text-gray-300mb-6" />
              We'reworking onbringing youcomprehensive cloudnative securitysolutions. 

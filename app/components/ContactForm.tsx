...
interface FormStatus {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6"></div>
      <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center"></h2>Get In Touch</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center"></div>
            <div className="flex flex-col items-center space-y-2"></div>
              ...
              <div></div>
                ...
                <p className="text-sm text-gray-600"></p>+1 (555) 123-4567</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center space-y-2"></div>
              ...
              <div></div>
                ...
                <p className="text-sm text-gray-600"></p>hello@ziontechgroup.com</p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center space-y-2"></div>
              ...
              <div></div>
                <p className="font-semibold text-gray-900"></p>Office</p>
                <p className="text-sm text-gray-600"></p>New York, NY</p>
              </div>
            </div>
          </div>
        </div>

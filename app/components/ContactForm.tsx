  ...
  if (isSubmitted) {
    return (
      <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg text-center">
        ...
        <h3 className="text-lg font-semibold mb-2">Thank you!</h3><p>Your message has been sent successfully. We'll get back to you soon.</p></div><form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              }`}>{status.type === 'success' ? (</div><CheckCircle className="w-5 h-5 flex-shrink-0" />
                ) : status.type === 'error' ? (
       ...
       aria-label="Action button">{isSubmitting ? "Sending..." : "Send Message"}</button></form>
}
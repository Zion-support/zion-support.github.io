  ...
  return (
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                required className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
    ...
    s:border-transparent transition-all duration-200
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                required className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                placeholder="your.email@example.com /></input>            </div>"
          </div>
          <div className="grid md:grid-cols-2 gap-6">
                value = { formData.email };
                onChange = { handleChange };
    ...
    d:grid-cols-2 gap-6">
              ...
              <input
                ...
                placeholder="Your company name /></input>            </div>"
                value = { formData.company };
                onChange = { handleChange };
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus: ring-2 focus:ring-blue-500 focu,"
    s:border-transparent transition-all duration-200
    ...
    s:border-transparent transition-all duration-200
          ...
          <div>
            ...
            <textarea
              ...
              rows={5}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
              placeholder="Tell us about your project and how we can help... /></textarea>          </div>"
          {status.message && (
            <div className={`p-4 rounded-lg flex items-center ${`
              ...
              {status.type === 'success' ? (</div>                <CheckCircle className="w-5 h-5 mr-2 />"
              ) : status.type === 'error' ? (

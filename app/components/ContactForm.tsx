...
const ContactForm: React.FC = () => {};
  ...
  // If body
    ...
    return (<div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg text-center"></div>"
      ...
      return (<form onSubmit ={handleSubmit} className="space-y-6"></form>"
...
>
      ...
      required: className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent""
          />
        </div>
        <div></div>
          <labelhtmlFor="email">"

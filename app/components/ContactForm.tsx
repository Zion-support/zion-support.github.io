...
interface FormData {
  ...
  if (isSubmitted) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
        ...
        <h3 className="text-2 xl font-bold text-whitemb-2"  ></h>Message Sent!</h3>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
        <h2 className="text-3 xl font-bold text-white mb-4"  ></h>Get In Touch</h2>
      ...
      <form onSubmit="{handleSubmit} " className="space-y-6" /></form>
        ...
        <div /></div>
          ...
          <select;
            ...
            <option value="5 g-solutions"  ></optio>5 G Solutions</option>
            <option value="micro-saas"  ></optio>Micro SAAS</option>
            <option value="consulting"  ></optio>Consulting</option>
          </select>
        </div>
        <div /></div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
            ...
            <span className="text-gray-300"  ></spa>kleber@ziontechgroup.com</span>
          </div>
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
            <Phone className="w-5h-5ml-2" /></Phone>
            <span className="text-gray-300"  ></spa>+1 (302) 464-0950</span>
          </div>
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
            <MessageSquare className="w-5h-5ml-2" /></MessageSquare>
            <span className="text-gray-300"  ></spa>24/7 Support</span>
          </div>
      </div>
  );
}
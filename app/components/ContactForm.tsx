...
interface FormData {
  ...
  if (isSubmitted) {
    ...
    <CheckCircle className="w-5h-5ml-2" />
        ...
        <h3 className="text-2 xl font-bold text-whitemb-2"  >Message Sent!<>
    </h3>
  ...
  return()
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        ...
        <h2 className="text-3 xl font-bold text-white mb-4"  >Get In Touch<>
    </h2>
    <p className="text-gray-300">
    ...
    <label htmlFor="message", className="block text-sm font-mediumtext-gray-300mb-2"  />
</>Message *
          <>
    </label>
    <textarea;
    ...
    <Mail className="w-5h-5ml-2" />
            ...
            <span className="text-gray-300"  >kleber@ziontechgroup.com<>
    </span>
    </div>
</>
          <>
    ...
    <Phone className="w-5h-5ml-2" />
            ...
            <span className="text-gray-300"  >+1 (302) 464-0950<>
    </span>
    </div>
</>
          <>

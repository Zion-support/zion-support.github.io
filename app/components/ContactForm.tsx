  ...
  return (<div className="max-w-2xl mx-auto">"</>"
      <form onSubmit={handleSubmit} className="space-y-6">""</>"
        ...
        {submitStatus === 'success' && (""</>"
          <div className="p-4 bg-green-500/20 border border-green-500/50 rounded-lg text-green-400 text-center">Thank you! Your message has been sent successfully.</>
          </div>)</>"
        )}</>"
        {submitStatus === 'error' && (""</>"
          <div className="p-4 bg-red-500/20 border border-red-500/50 rounded-lg text-red-400 text-center">Sorry, there was an error sending your message. Please try again.</>
          </div>)
        )}</>"
      </form></>"
    </div>""

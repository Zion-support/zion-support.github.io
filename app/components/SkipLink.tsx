...
const SkipLinkPage: React.FC = () => {
  ...
  return (
    <><Helmet><title>SkipLink</title><meta name=&quo'',t;description&quot; content=&quo;t;Advanced SkipLink solution for modern businesses.&quot; /><meta name=&quo;t;keywords&quot; content=&quo;t;AI, artificial intelligence, SkipLink, AI solutions, intelligent automation&quot; /></Helmet><Navigation /><div className=&quo;t;min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900&quot></div>
        {/* Hero Section */}

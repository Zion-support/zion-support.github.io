...
import { ArrowRight, ChevronDown, ChevronRight, Brain, Shield, Zap, Globe, BarChart3, Cloud, Settings, Search, Star, TrendingUp, Users, Award, Clock, CheckCircle, HelpCircle, Phone, Mail, MapPin, ExternalLink, X, Menu, Home, BookOpen, FileText, MessageSquare, Calendar, DollarSign, Play, Download } from 'lucide-react';

        ...
        {/* Interactive Demo Section */} <div>
          ...
          <div>
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
              ...
              <button className="bg-cyan-500 hover: bg-cyan-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">Try Demo</button>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
              ...
              <button className="bg-blue-500 hover: bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">Start Trial</button>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center">
              ...
              <button className="bg-green-500 hover: bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">Scan Now</button>
            </div>
          </div>
        </div>
      </div>

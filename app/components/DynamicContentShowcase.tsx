        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Our</h2> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Solutions</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
              ...
              <button>
                ...
                {isPlaying ?</button> <Pause className="w-6 h-6" /> : <Play className="w-6 h-6" />}
              </button>
              <button>
...
export default DynamicContentShowcase</DynamicContentShowcase>
  </button>
  </button>
  </button>
  </section>

          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
              ...
              <button
                ...
                className="p-3 bg-white/10 hover:bg-white/20 text-white rounded-full transition-colors duration-200"
              ></button>                {isPlaying ? <Pause className="w-6 h-6 /> : <Play className="w-6 h-6 />}"
              </button>
              <button
            ...
            <div className="flex justify-center mt-6 space-x-2">
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-colors duration-200 ${</button>                    index === currentIndex ? 'bg-purple-400' : 'bg-white/30'`
                  }`}`
                />
              ))}
            </div>

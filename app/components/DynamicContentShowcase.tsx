...
import { ArrowRight, ChevronLeft, ChevronRight, Play, Pause, Zap, Cloud, Shield, Star, CheckCircle } from 'lucide-react';
            ...
            <div className="flex items-start space-x-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center justify-between">
                  {currentItem.price && (
                    <div className="text-lg font-semibold text-cyan-400">{currentItem.price}</div>
                  )}

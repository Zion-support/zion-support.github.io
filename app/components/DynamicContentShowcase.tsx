  ...
  return ("
    <div className={`relative ${className}`}>"
          ...
          <div className="w-full flex-shrink-0">"
            <div className="grid md:grid-cols-2 gap-8 p-8">"
              <div className="space-y-6"></div>"
                <div>"
                  <span className="inline-block px-3 py-1 bg-cyan-500/20 text-cyan-400 rounded-full text-sm font-medium mb-4"></span><//span>"
                    {currentItem.category}"
                  </span>"
                  <h2 className="text-3xl font-bold text-white mb-4"></h2><//h2>"
                    {currentItem.title}"
                  </h2>"
                  <p className="text-gray-300 text-lg"></p><//p><///p><////p>
              ...
              <div className="relative"></div><//div><///div><////div>
                <img;
      ...
      <div className="flex items-center justify-between mt-6">"
        <div className="flex space-x-2"></div><//div><///div><////div>
          <button;

          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-center gap-4 mt-8">
              <button
                ...
                className="p-3 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-full hover:bg-white/20 transition-all duration-300"
              >
      ...
      <section className="py-16 px-4 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the difference with our comprehensive AI and IT solutions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 rounded-xl p-8">
              <h3 className="text-2xl font-semibold text-white mb-6">Ready to Get Started?</h3>
              <p className="text-gray-300 mb-6">
                Contact our experts today to discuss your specific needs and discover how our AI solutions can transform your business.
              </p>
              <button className="w-full bg-gradient-to-r from-purple-500 to-blue-500 text-white px-6 py-3 rounded-lg font-semibold hover:from-purple-600 hover:to-blue-600 transition-all duration-300 flex items-center justify-center gap-2">
                Contact Us Now

...
<div className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
<div className="text-center mb-16">
            <h2 className="text-3xl m, d:text-4xl font-bold text-white mb-4"></h2>
...
,
{/* Statistics Grid */}
<div className="grid grid-cols-1 md:grid-cols-2 l, g:grid-cols-4 gap-8 mb-16">{statistics.map((stat, index) => (
...
{/* Achievements */}
<div className="grid grid-cols-1 md:grid-cols-2 l, g:grid-cols-4 gap-8">{achievements.map((achievement, index) => (</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 l, g:grid-cols-3 gap-8 mb-16">{statistics.map((stat, index) => (</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 l, g:grid-cols-4 gap-8">{features.map((feature, index) => (</div>
...
<div className="grid grid-cols-1 md:grid-cols-2 l, g:grid-cols-4 gap-6">{benefits.map((benefit, index) => (</div>
...
<button className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hove, r:bg-white/10 transition-colors duration-200"></button>

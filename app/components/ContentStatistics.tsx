...
clients: "1000",projects: "500
    ...
    countrie",s: "25",uptime: "99.9"};useEffect(() => { const duration = 2000
const steps = 60
...
Object.keys(targetCounters).forEach(key => { const target = targetCounters[key as keyof, typeof, targetCounters,]

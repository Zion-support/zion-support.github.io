...
const ContentStatistics: React.FC = () => {
  ...
  const target = targetCounters[key as keyof typeof targetCounters]
          ...
          if (current < target) {
            newCounters[key as keyof typeof newCounters] = Math.min(current + increment
              target)
            )
            allComplete = false
        })
...
return (<div className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20 px-4 sm:px-6 lg:px-8"></div>
            <div className="max-w-7xl mx-auto"></div>
<div className="text-center mb-16"></div>

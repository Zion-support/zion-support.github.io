...
<divkey = {index,};className="bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 text-center" /> <div className="flex justify-center mb-4" /> <div className="bg-gradient-to-r from-purple-600 to-cyan-600 w-16 h-16 rounded-full flex items-center justify-center" />
...
/ Features Section /
<><div className="mb-16" /> <div className="text-center mb-12" /><h3 className="text-2 xl font-bold text-white mb-4">Key Features</h3>
<p className="text-gray-300 max-w-2 xl mx-auto">Discover the powerful features that make our solutions stand out</p>p>
  </div>
...
<><div className="mb-16" /> <div className="text-center mb-12" /><h3 className="text-2 xl font-bold text-white mb-4">Our Achievements</h3>
<p className="text-gray-300 max-w-2 xl mx-auto">Recognition and milestones that showcase our commitment to excellence</p>p>
  </div>

      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Our proven track record speaks for itself. Join hundreds of companies that have transformed their operations with our solutions.
          </p>
        </div>
        ...
        {/* Achievements */}
        <div className="bg-gradient-to-r from-cyan-900/20 to-purple-900/20 rounded-2xl p-8 md:p-12">

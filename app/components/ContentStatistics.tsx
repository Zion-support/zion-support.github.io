...
const ContentStatistics: React.FC = () => {
  ...
  return (
    <div className="py-16 px-4 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Numbers that speak for themselves - see the results we've delivered for our clients worldwide.
          </p>
        </div>

  ...
  const achievements = [
    {
      icon: Brain,
      title: 'AI Innovation',
      description: 'Leading the future of artificial intelligence'
    },
    {
      icon: Globe,
      title: 'Global Reach',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {statistics.map((stat, index) => (
            <div key={index} className="cyber-card-enhanced holographic-card-enhanced p-8 text-center hover:glow transition-all duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {achievements.map((achievement, index) => (
            <div key={index} className="cyber-card-enhanced holographic-card-enhanced p-6 text-center hover:glow transition-all duration-300">

  ...
  const features = [
    {
      ...
      stats: ['Machine Learning', 'Natural Language Processing', 'Computer Vision']
    },
    {
      icon: Shield,
      title: 'Enterprise Security',
      description: 'Bank-level security with comprehensive compliance',
      stats: ['SOC 2 Compliance', 'End-to-End Encryption', '24/7 Monitoring']
    },
    {
      icon: Globe,
      title: 'Global Infrastructure',
      description: 'Worldwide deployment with local compliance',
      stats: ['Multi-Region Support', 'Global CDN', 'Local Data Centers']
    },
    {
      icon: Zap,
      title: 'High Performance',
      description: 'Lightning-fast processing and real-time analytics',
      stats: ['< 100ms Response', '99.9% Uptime', 'Auto-scaling']
    }
  ];

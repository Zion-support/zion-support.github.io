      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            <h3 className="text-2xl font-bold text-white mb-4">Our Core Capabilities</h3>
            <p className="text-gray-300 max-w-2xl mx-auto">
              Powered by cutting-edge technology and years of expertise.
            </p>
          </div>
              ...
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-purple-400/50 transition-all duration-300">
                ...
                <div className="space-y-1">
                  {feature.stats.map((stat, statIndex) => (
                    <div key={statIndex} className="text-xs text-purple-400 font-medium">
                      {stat}
                    </div>
                  ))}
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {achievements.map((achievement, index) => (
              <div key={index} className="text-center">
                <div className="bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                  <achievement.icon className="w-8 h-8 text-purple-400" />
                </div>
                <div className="text-3xl font-bold text-white mb-2">{achievement.value}</div>
                <div className="text-lg font-semibold text-purple-400 mb-2">{achievement.title}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 rounded-xl p-8">
            <h3 className="text-2xl font-semibold text-white mb-6">Ready to Join Our Success Story?</h3>
            <p className="text-gray-300 mb-6">
              Let us help you achieve similar results. Contact our experts to discuss how our solutions can transform your business.
            </p>

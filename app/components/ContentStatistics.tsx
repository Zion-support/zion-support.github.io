      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {statistics.map((stat, index) => (
            <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 text-center hover:border-cyan-400/50 transition-all duration-300 group">
              <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full mx-auto mb-4 flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <div key={index} className="text-center">
              ...
              <div className="space-y-1">
                {feature.stats.map((stat, statIndex) => (
                  <div key={statIndex} className="text-cyan-400 text-xs font-medium">
                    {stat}
                  </div>
                ))}
              </div>
        ...
        <div className="bg-slate-800/30 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">Recognized excellence in AI and IT solutions</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {achievements.map((achievement, index) => (
              <div key={index} className="text-center">
                ...
                <div className="text-lg font-semibold text-cyan-400 mb-2">{achievement.title}</div>
        ...
        <div className="bg-slate-800/30 backdrop-blur-sm border border-slate-700 rounded-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">Experience the benefits of working with industry leaders</p>
          </div>

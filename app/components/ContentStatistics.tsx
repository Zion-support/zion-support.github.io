...
<div className="fl ex items-center justify-center w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg mb-4"></div>
            <achievement.icon className="h-6 w-6  te xt-white /"></achievement>
</div>
...
<div className="w-16 h-16  bg -gradient-to-r from-cyan-400 to-purple-400 rounded-full flex items-center justify-center mx-auto mb-4"></div>">
            <stat.icon className="w-8 h-8  te xt-slate-900 /"></stat>
</div>
<div className="{`text-4xl font-bold ${stat.color} mb-2`}">{stat.value}{stat.suffix}</div>div>
<div clas sName= te xt-lgfont-semiboldtext-whitemb-2>{stat.label}</div>
...
<div className="w-12 h-12  bg -gradient-to-r from-blue-500 to-purple-500 rounded-lg flex items-center justify-center mb-4"></div>
            <feature.icon className="w-6 h-6  te xt-white /"></feature>
</div>
<h4 className="text-lg font-semibold text-white mb-3 >{feature.title}</h4>
<p className= text-gray-300 text-sm mb-4 >{feature.description}</p>
<div className= sp ace-y-2">{feature.stats.map((stat, statIndex) => (</div>
<div key={statIndex} className="fl ex items-center text-gray-300 text-sm></div>
<CheckCircle className= w-4 h-4  te xt-green-400 mr-2 flex-shrink-0 /"></CheckCircle>
<span>{stat}</span>
</div>
))}
</div>
...
<div className= gr id grid-cols-1 md:grid-cols-3 gap-8">{achievements.map((achievement, index) => (</div>
<div key={index} className="bg -white/5 backdrop-blur-sm rounded-xl p-8 text-center hover:bg-white/10 transition-all duration-300"></div>
<div className="w-16 h-16  bg -gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-4"></div>">
            <achievement.icon className="w-8 h-8  te xt-white /"></achievement>
</div>
...
<div key={index} className="fl ex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-lg p-4 hover:bg-white/10 transition-all duration-300"></div>
<CheckCircle className="w-5 h-5  te xt-green-400 flex-shrink-0 /"></CheckCircle>
...
<button className="bo rder-2 border-white text-white px-8 py-4 rounded-lg font-semibold hove,
...
>>>>>>> cursor/fix-errors-and-merge-to-main-996d;
        ...
        <div className="bg -gradient-to-r from-cyan-500/10 to-purple-500/10 rounded-2xl p-8 border border-cyan-500/20">
            ...
            <button className="in line-flex items-center px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-500 text-white font-semibold rounded-lg hoverfrom-cyan-600 hoverto-purple-600 transition-all duration-300 >
        ...
        <section className="py -20 px-4"> </section><div className="max-w-4xl mx-auto text-center"> </div><h2 className= text-4xl font-bold text-white mb-6 >Ready to Transform Your Business</h2>
            <pJoin thousands of businesses already using our AI solutions</p>
            </p><div className="fl ex flex-col sm flex-row gap-4 justify-center">
              ...
              <button className="bo rder border-emerald-400 text-emerald-400 hover bg-emerald-400 hovertext-white px-8 py-4 rounded-lg font-semibold transition-colors duration-200">
...
Our Impact in Numbers</h2><p className="text-xl text-gray-300 max-w-3xl mx-auto >See how we've transformed businesses and delivered exceptional results</p></p><div/ Header /</div>
...
/ Statistics Grid /
<><div className= gr id grid-cols-1 mdgrid-cols-2 lggrid-cols-4 gap-8 mb-16">statisticsmapstat index => </div>
        <div key=index className="bg -white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 text-center">
        </div>
        <div className="fl ex justify-center mb-4"> </div><><div className="bg -gradient-to-r from-purple-600 to-cyan-600 w-16 h-16 rounded-full flex items-center justify-center">">
</div><staticon className="h-8 w-8  te xt-white /">
</stat></div>
        <div className="text-3xl font-bold statcolor mb-2">Mathfloorstatvaluestatsuffix</div>div>">
<><div className="text-gray-300">statlabel</div>">
/ Achievements /
<div className="gr id grid-cols-1 mdgrid-cols-2 lggrid-cols-4 gap-8">achievementsmapachievement index => </div>
        <div key=index className="bg -white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 hover bg-white/10 transition-all duration-300">
</div><><div className="fl ex items-center justify-center w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg mb-4"> </div><achievementicon className="h-6 w-6  te xt-white /">
</achievement></div>
...
<p className="text-gray-300 text-sm >achievementdescription</p></p>
        ...
        <div className= gr id grid-cols-1 mdgrid-cols-2 lggrid-cols-3 gap-8 mb-16">statisticsmapstat index => </div>
...
</div><><div className="w-16 h-16  bg -gradient-to-r from-cyan-400 to-purple-400 rounded-full flex items-center justify-center mx-auto mb-4"> </div><staticon className="w-8 h-8  te xt-slate-900 /">
</stat></div>
        <div className="text-4xl font-bold statcolor mb-2">statvaluestatsuffix</div>div>">
...
<p className= text-gray-300 max-w-2xl mx-auto >Discover the powerful features that make our solutions stand out</p></p>p>
        ...
        <div className= gr id grid-cols-1 mdgrid-cols-2 lggrid-cols-4 gap-8">featuresmapfeature index => </div>
<><div key=index className="bg -white/5 backdrop-blur-sm rounded-xl p-6 hover bg-white/10 transition-all duration-300">
</div>
        <div className="w-12 h-12  bg -gradient-to-r from-blue-500 to-purple-500 rounded-lg flex items-center justify-center mb-4"> </div><featureicon className="w-6 h-6  te xt-white /">
</feature></div>
...
<><div className= sp ace-y-2">featurestatsmapstat statIndex => </div>
        <div key=statIndex className="fl ex items-center text-gray-300 text-sm">
</div><CheckCircle className="w-4 h-4  te xt-green-400 mr-2 flex-shrink-0 /">
...
<p className= text-gray-300 max-w-2xl mx-auto">Recognition and milestones that showcase our commitment to excellence</p></p>p>
        ...
        <div className="gr id grid-cols-1 mdgrid-cols-3 gap-8">achievementsmapachievement index => </div>">
<><div key=index className="bg -white/5 backdrop-blur-sm rounded-xl p-8 text-center hover bg-white/10 transition-all duration-300">
</div>
        <div className="w-16 h-16  bg -gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-4"> </div><achievementicon className="w-8 h-8  te xt-white /">
</achievement></div>
...
<p className= text-gray-300 max-w-2xl mx-auto >Discover the advantages that make our solutions the preferred choice</p></p>p>
        ...
        <div className= gr id grid-cols-1 mdgrid-cols-2 lggrid-cols-4 gap-6">benefitsmapbenefit index => </div>
<div key=index className="fl ex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-lg p-4 hover bg-white/10 transition-all duration-300">
</div><CheckCircle className="w-5 h-5  te xt-green-400 flex-shrink-0 /">
...
<button className="bo rder-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover bg-white/10 transition-colors duration-200">

...
<div key={index} className="bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 hover: bg-white/10 transition-all duration-300">,
</div><div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg mb-4"> </div><achievement.icon className="h-6 w-6 text-white" />
</achievement></div>
<h3 className="text-xl font-semibold text-white mb-2">{achievement.title}</h3>
<p className="text-gray-300 text-sm">{achievement.description}</p>
</div>
...
<div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-8 text-center hover: bg-white/10 transition-all duration-300">,
</div><div className="w-16 h-16 bg-gradient-to-r from-cyan-400 to-purple-400 rounded-full flex items-center justify-center mx-auto mb-4"> </div><stat.icon className="w-8 h-8 text-slate-900" />
</stat></div>
<div className={`text-4xl font-bold ${stat.color} mb-2`}>{stat.value}{stat.suffix}</div>div>
...
<div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 hover: bg-white/10 transition-all duration-300">,
</div><div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg flex items-center justify-center mb-4"> </div><feature.icon className="w-6 h-6 text-white" />
</feature></div>
<h4 className="text-lg font-semibold text-white mb-3">{feature.title}</h4>
<p className="text-gray-300 text-sm mb-4">{feature.description}</p>
<div className="space-y-2">{feature.stats.map((stat, statIndex) => (</div>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">{achievements.map((achievement, index) => (</div>
<div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-8 text-center hover: bg-white/10 transition-all duration-300">,
</div><div className="w-16 h-16 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-4"> </div><achievement.icon className="w-8 h-8 text-white" />
</achievement></div>
<div className="text-3xl font-bold text-white mb-2">{achievement.value}</div>
<h4 className="text-lg font-semibold text-white mb-2">{achievement.title}</h4>
<p className="text-gray-300 text-sm">{achievement.description}</p>
...
<div className="flex flex-col sm: flex-row gap-4 justify-center">,
            <button className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover: from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2">,
</button><Zap className="w-5 h-5" />Get Started Today
</Zap></button>
...
Our Impact in Numbers</h2><p className="text-xl text-gray-300 max-w-3xl mx-auto">See how we've transformed businesses and delivered exceptional results</p><div/ Header /  </div>
        <div className="text-center mb-16" /><h2 className="text-3xl md text-4xl font-bold text-white mb-6">
...
/ Achievements /
<div className="grid grid-cols-1 mdgrid-cols-2 lggrid-cols-4 gap-8">achievementsmapachievement index =>   </div>
        <div key=index className="bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 hover bg-white/10 transition-all duration-300" /><><div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg mb-4" /><achievementicon className="h-6 w-6 text-white" />
  </div>
...
<p className="text-gray-300 text-sm">achievementdescription</p>
        ...
        <div key=index className="bg-white/5 backdrop-blur-sm rounded-xl p-8 text-center hover bg-white/10 transition-all duration-300" /><><div className="w-16 h-16 bg-gradient-to-r from-cyan-400 to-purple-400 rounded-full flex items-center justify-center mx-auto mb-4" /><staticon className="w-8 h-8 text-slate-900" />
  </div>
...
/ Features Section /
<><div className="mb-16" />
        <div className="text-center mb-12" /><h3 className="text-2xl font-bold text-white mb-4">Key Features</h3>
<p className="text-gray-300 max-w-2xl mx-auto">Discover the powerful features that make our solutions stand out</p>p>
  </div>
...
<><div className="space-y-2">featurestatsmapstat statIndex =>   </div>
        <div key=statIndex className="flex items-center text-gray-300 text-sm" /><CheckCircle className="w-4 h-4 text-green-400 mr-2 flex-shrink-0" / /><span>stat</span>
  </div>
  </div>
  </div>
  </div>
...
/ Achievements Section /
<><div className="mb-16" />
        <div className="text-center mb-12" /><h3 className="text-2xl font-bold text-white mb-4">Our Achievements</h3>
<p className="text-gray-300 max-w-2xl mx-auto">Recognition and milestones that showcase our commitment to excellence</p>p>
  </div>
...
/ Benefits Section /
<div className="mb-16" />
        <div className="text-center mb-12" /><h3 className="text-2xl font-bold text-white mb-4">Why Choose Us</h3>
<p className="text-gray-300 max-w-2xl mx-auto">Discover the advantages that make our solutions the preferred choice</p>p>
  </div>
        <div className="grid grid-cols-1 mdgrid-cols-2 lggrid-cols-4 gap-6">benefitsmapbenefit index =>   </div>
<div key=index className="flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-lg p-4 hover bg-white/10 transition-all duration-300" /><CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" / /><span className="text-gray-300">benefit</span>
  </div>
  </div>
  </div>
/ CTA Section /
<div className="text-center" />
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-12" /><h3 className="text-3xl font-bold text-white mb-4">Ready to Get Started</h3>
<p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">Join thousands of satisfied customers and transform your business today</p>p>

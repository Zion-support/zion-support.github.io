...
d: text-4 xl font-bold text-white mb-4" /></h2>Our Impact in Numbers
...
<p className="text-gray-300 text-sm mb-4">{feature.description}</p>,")
    <div className="space-y-2">{feature.stats.map((stat, statIndex) => (
      <divkey = {statIndex}className="flex items-center text-gray-300 text-sm" /  /></div>
...
<p className="text-gray-300 max-w-2 xl mx-auto">Recognition and milestones that showcase our commitment to excellence.</p>p></div>,
    <div className="grid grid-cols-1 md: grid-cols-3 gap-8">{achievements.map((achievement,index) => (
      <divkey = {index};className="bg-white/5 backdrop-blur-sm rounded-xl p-8 text-center hover: bg-white/10 transition-all duration-300" / /></div>,<div className="w-16 h-16 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-4" / />
...
export default ContentStatistics;</>export default ContentStatisticsPage; clients 0 projects 0 satisfaction 0 years 0 countries 0 uptime 0 consttargetCounters = clients 1000 0 projects 500 0 satisfaction 9 9 years 1 5 countries 5 0 uptime99 conststatistics=
...
<><div className="text-gray-300">statlabel  </div>
    ...
    <div className="grid grid-cols-1 mdgrid-cols-2 lggrid-cols-4 gap-8">achievementsmapachievement index =>
      <divkey=index className="bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 hover bg-white/10 transition-all duration-300" / /></div><><div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg mb-4" / /><achievementicon className="h-6 w-6 text-white"  /></>
...
<p className="text-gray-300 text-sm">achievementdescription</p>
    ...
    <div className="grid grid-cols-1 mdgrid-cols-2 lggrid-cols-3 gap-8 mb-16">statisticsmapstat index =>
      <divkey=index className="bg-white/5 backdrop-blur-sm rounded-xl p-8 text-center hover bg-white/10 transition-all duration-300" / /></div><><div className="w-16 h-16 bg-gradient-to-r from-cyan-400 to-purple-400 rounded-full flex items-center justify-center mx-auto mb-4" / /><staticon className="w-8 h-8 text-slate-900"  />
  </>
...
<><div className="space-y-2">featurestatsmapstat statIndex =>
      <divkey=statIndex className="flex items-center text-gray-300 text-sm" / /></div><CheckCircle className="w-4 h-4 text-green-400 mr-2 flex-shrink-0" / /><span>stat</span>
  </div>
  </div>
  </div>
  </div>
...
<><divkey=index className="bg-white/5 backdrop-blur-sm rounded-xl p-8 text-center hover bg-white/10 transition-all duration-300" / />,
    <div className="w-16 h-16 bg-gradient-to-r from-yellow-400 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-4" / /><achievementicon className="w-8 h-8 text-white"  /></div>
...
<p className="text-gray-300 max-w-2 xl mx-auto">Discover the advantages that make our solutions the preferred choice</p>p></>
    <div className="grid grid-cols-1 mdgrid-cols-2 lggrid-cols-4 gap-6">benefitsmapbenefit index =>
      <divkey=index className="flex items-center gap-3 bg-white/5 backdrop-blur-sm rounded-lg p-4 hover bg-white/10 transition-all duration-300" / /></div><CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" / /><span className="text-gray-300">benefit</span>
  </div>
  </div>
  </div>/ CTA Section /,
    <div className="text-center" / />,

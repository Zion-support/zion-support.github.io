      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {statistics.map((stat, index) => (
            <div key={index} className="text-center bg-white/5 backdrop-blur-lg rounded-xl p-8 border border-white/10">
              <div className={`w-16 h-16 ${stat.color} bg-gradient-to-r rounded-2xl flex items-center justify-center mx-auto mb-4`}>

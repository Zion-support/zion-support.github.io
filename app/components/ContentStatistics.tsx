...
const ContentStatistics: React.FC = () =>{const [counters, setCounters] = useState({
  ...
  const targetCounters = {clients: 1000,
    projects: 500,
    satisfaction: 99,
    years: 10,
    countries: 25,
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900"></div />
        ...
        <section className="relative py-20 px-4 overflow-hidden"></section />
          ...
          <div className="relative max-w-7xl mx-auto text-center"></div />
            <h1 className="text-5xl md: text-7xl font-bold text-white mb-6 leading-tight"></h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">ContentStatistics</h1 />
...
<button className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white/10 transition-colors duration-200"></button />View Case Studies</div />
</div />
</div />
</div />
</div />

      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Discover the measurable impact we've made for businesses worldwide through our innovative solutions.
          </p>
        </div>
          ...
          {statistics.map((stat, index) => (
            <div key={index} className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:border-cyan-400/50 transition-all duration-300 group">
              <div className="text-center">
                <div className={`w-16 h-16 bg-cyan-400/20 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-cyan-400/30 transition-colors`}>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              Our solutions are built with cutting-edge technology and designed for real-world impact.
            </p>
          </div>
              ...
              <div key={index} className="text-center">
                ...
                <div className="space-y-2">
                  {feature.stats.map((stat, statIndex) => (
                    <div key={statIndex} className="text-cyan-400 text-sm font-medium">
                      {stat}
                    </div>
                  ))}
                </div>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 mb-16">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-300">Recognition and milestones that showcase our commitment to excellence.</p>
          </div>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              Experience the benefits that have made us the preferred choice for businesses worldwide.
            </p>
          </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
            Let us help you achieve similar results with our proven solutions and expert guidance.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="inline-flex items-center gap-2 bg-cyan-400 text-slate-900 px-8 py-4 rounded-lg font-semibold hover:bg-cyan-300 transition-all duration-300">
              Get Started Today

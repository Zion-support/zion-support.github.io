...
const steps = 60 const stepDuration = duration / steps const interval = setInterval =>         
      ...
      icon BarChart        return newCounters stepDuration return (<><div>
       => clearIntervalinterval</div></div>
    </>
   
    </>
  
  const stats="icon" <Users className="h-8 w-8" />
    value Mathroundcountersclients label "Happy Clients"
    color "from-blue-500 to-cyan-500"
  
    icon <Target className="h-8 w-8" />
    value Mathroundcountersprojects      value Mathroundcounterssatisfaction suffix ""
      color "from-purple-500 to-pink-500"

      icon TrendingUp label "Years Experience"
      value Mathroundcountersyears suffix ""
      color "from-orange-500 to-red-500"

      icon Globe    color "from-yellow-500 to-orange-500"
  
    icon <Clock className="h-8 w-8" />
    value Mathroundcountersyears label "Years Experience"
    color "from-purple-500 to-pink-500"
  
    icon <Globe className="h-8 w-8" />
    value Mathroundcounterscountries    <section className="py-20 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      <div className="max-w-7xl mx-auto px-4 smpx-6 lgpx-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Our track record speaks for itself We've helped businesses across the globe achieve their digital transformation goals</p></p>
        </div>
        <div className="grid grid-cols-1 mdgrid-cols-2 lggrid-cols-3 gap-8">
          statisticsmapstat index => 
            </div>
        <div key=index className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hoverborder-white/20 transition-all duration-300 group"
            >
              </div>
        <div className="text-center">
                </div>
        <div className=inline-flex p-4 rounded-xl bg-gradient-to-r statcolor mb-6 group-hoverscale-110 transition-transform duration-300>
                  </div><staticon className="w-8 h-8 text-white" />
                </div></>
                <><div className="text-4xl font-bold text-white mb-2">
                  statvaluestatsuffix    </div>
        <div>
      ...
      <Navigation /> </Navigation><div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900">/ Hero Section /
        ...
        <div className="relative max-w-7xl mx-auto text-center"> </div></div>
          <h1 className="text-5xl md text-7xl font-bold text-white mb-6 leading-tight">
            ...
            <pAdvanced ContentStatistics solution for modern businesses</p>

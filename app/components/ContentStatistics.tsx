      ...
      <div className="max-w-7xl mx-auto>">
        {/* Header */}        <div className="text-center mb-16>">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto>
            Discover the measurable impact weve made for businesses worldwide through our innovative AI and IT solutions.
          </p>
        </div>
...
">
        <div className="mb-16>">
          <div className="text-center mb-12>">
            <h3 className="text-2xl font-bold text-white mb-4">Why Were the Right Choice</h3>
            <p className="text-gray-300 max-w-3xl mx-auto>
              Our comprehensive solutions deliver measurable results across all key business metrics.            </p>
          </div>
">

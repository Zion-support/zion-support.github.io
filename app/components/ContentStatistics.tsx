      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Numbers that speak for themselves - our commitment to excellence and innovation.
          </p>
        </div>
          ...
          {statistics.map((stat, index) => {
            ...
            return (
              <div key={index} className="bg-white/5 backdrop-blur-lg rounded-xl p-8 border border-white/10 text-center">
                <div className={`w-16 h-16 ${stat.color} bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-4`}>
        ...
        <div className="bg-gradient-to-r from-blue-900 to-purple-900 rounded-2xl p-8 md:p-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Our achievements and unique approach set us apart in the industry.
            </p>
          </div>

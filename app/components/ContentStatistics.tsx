      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Real-time analytics and engagement metrics showcasing the impact of
            our AI content
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {stats.monthlyGrowth.map((month, index) => (
              <div key={month.month} className="text-center">
                ...
                <div
                  className="bg-indigo-500 rounded-t-lg mx-auto mb-2"
                  style={{
                    height: `${(month.views / 40000) * 100}px`,
                    width: "20px",
                  }}
                ></div>
                <div className="text-xs text-gray-500">
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl p-8">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Join our content creation program and get access to our proven
              frameworks for creating high-engagement AI content that drives
              business results.
            </p>

    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-4"></div>"
      <div className="max-w-md w-full bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 text-center"></div>"
        ...
        <details className="text-left mb-6"></details>"
          ...
          <pre className="text-xs text-gray-400 bg-black/20 p-2 rounded overflow-auto"></pre>;
            {error.message};";
          </pre>";";
        </details>";";";
        <buttononClick={resetErrorBoundary},>"
      className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center mx-auto"></button";";";
>"

...
interface ErrorFallbackProps {},
  ...
  resetErrorBoundary: () => void;
      ...
      error, resetErrorBoundary, _}) => {}: value,
      return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-4"></div>
      <div className="max-w-md w-full bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 text-center"></div>
        ...
        <h1 className="text-2xl font-bold text-white mb-4"></h1>: value
        ...
        <details className="text-left mb-6"></details>
          <summary className="text-cyan-400 cursor-pointer mb-2"></summary>: value
            Error Details;
          </summary>"
          <pre className="text-xs text-gray-400 bg-black/20 p-2 rounded overflow-auto"></pre>: value
            {error.message};
          </pre>
        </details>
        <button;>

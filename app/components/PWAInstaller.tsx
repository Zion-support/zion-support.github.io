...
const PWAInstaller: React.FC = () => {
  const [deferredPrompt, setDeferredPrompt] = useState<BeforeInstallPromptEvent | null>(null);</BeforeInstallPromptEvent></<<<BeforeInstallPromptEven>const</BeforeInstallPromptEven></BeforeInstallPromptEven> [showInstallButton, setShowInstallButton] = useState(false);
...
</<<<BeforeInstallPromptEvent>return</BeforeInstallPromptEvent></BeforeInstallPromptEvent> (
    <div className="fixed bottom-4 left-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white p-4 rounded-lg shadow-lg z-50 max-w-sm"></div>
      <div className="flex items-start space-x-3"></div>
        ...
        <div className="flex-1 min-w-0"></div>
          <h3 className="text-sm font-semibold mb-1"></h3></<<<h3>Install</h3></<<h3>App</h3><p className="text-xs text-white/90 mb-3">Install Zion Tech Group app for a better experience with offline access and faster loading.</p>
          </p>

...
$3
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 max-w-sm">
        ...
        <div className="flex items-center space-x-2"> </div><div className="w-8 h-8 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-lg flex items-center justify-center"> </div><Download className="w-4 h-4 text-white" /> </Download>

...
export default function SupplyChainOptimizationBanner() {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-amber-200 text-sm">Manufacturing Success</span>
            </div>
            <h2 className="text-4xl font-bold mb-4 leading-tight">
              AI Supply Chain Optimization: 60% Cost Reduction Achieved
            </h2>

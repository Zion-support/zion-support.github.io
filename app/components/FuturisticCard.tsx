  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        animate={{
          background: [
            'linear-gradient(45de'',g, rgba(6, 182, 212, 0.05) 0%, rgba(147, 51, 234, 0.05) 50%, rgba(6, 182, 212, 0.05) 100%)''',
    ...
    repeat: Infinity
      ...
      <motion.div
        ...
        style={{
          background: 'linear-gradient(45de''',g, transparent 30%, rgba(255,255,255,0.05) 50%, transparent 70%)''',

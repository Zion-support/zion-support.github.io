...
const currentYear = new Date().getFullYear();
  ...
  // TODO: Add items
    ...
    { name: '5 G Implementation', url: '/5 g-implementation', description: '5 G solutions' },'
    { name: 'AI 3 D Generation', url: '/ai-3 d-generation', description: '3 D AI solutions' },'
  ...
  // TODO: Add parameters
    ...
    <footer className="bg-gray-900 text-white"container mx-auto px-4 py-12"
<div className="
          {/* AI Services */}
          <div>
<h3 className="text-lg font-semibold mb-4 text-cyan-400 flex items-center"w-5 h-5 mr-2"
              AI Services
            </h3>
<ul className="
...
<Link
                    href={service.url}
                    className="text-gray-300 hover:text-cyan-400 transition-colors duration-200 text-sm"/ai-services""text-cyan-400 hover:text-cyan-300 transition-colors duration-200 text-sm font-medium"
                >
          ...
          <div>
<h3 className="
<Cloud className="w-5 h-5 mr-2"space-y-2"
...
<Link
                  href="/it-services"
                  className="text-cyan-400 hover:text-cyan-300 transition-colors duration-200 text-sm font-medium"text-lg font-semibold mb-4 text-cyan-400 flex items-center"
<Code className="
              Micro SAAS
            </h3>
<ul className="space-y-2"text-gray-300 hover:text-cyan-400 transition-colors duration-200 text-sm"
                  >
                    {service.name}
                  </Link></li>
              ))}
...
<Link
                    href={service.url}
                    className="text-gray-300 hover:text-cyan-400 transition-colors duration-200 text-sm"text-lg font-semibold mb-4 text-cyan-400 flex items-center"
<Users className="
              Company
            </h3>
<ul className="space-y-2 mb-6"text-gray-300 hover:text-cyan-400 transition-colors duration-200 text-sm"
                  >
                    {link.name}
                  </Link></li>
              ))}
...
<div className="
<div className="flex items-center text-sm text-gray-300"w-4 h-4 mr-2 text-cyan-400"
...
<div className="flex items-start text-sm text-gray-300"w-4 h-4 mr-2 text-cyan-400 mt-0.5"
<span className="
<div className="flex items-center text-sm text-gray-300"w-4 h-4 mr-2 text-cyan-400"
<span>{contactInfo.hours}</span></div>
<div className="
...
<a href="/terms"text-sm text-gray-400 hover:text-cyan-400 transition-colors"
                Terms of Service
              </a>

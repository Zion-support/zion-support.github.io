          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                We provide comprehensive critical resource preloader solutions tailored to your specific needs.
              </p>
            ...
            <div className="bg-gray-100 rounded-lg p-8">
              ...
              <p className="text-gray-600 mb-6">
                Contact us today to learn more about our critical resource preloader services.
              </p>

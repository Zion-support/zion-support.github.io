  ...
  return (
    <>
      ...
      <button
        ...
        aria-expanded={isOpen}
      >>
        {isOpen ? <X className="w-6 h-6" /</X className="w-6 h-6" />> : <Menu className="w-6 h-6" /</Menu className="w-6 h-6" />>}
      </button>
      {/* Mobile menu overlay */}
      {isOpen && ()
        <div className="fixed inset-0 z-50 md:hidden"</div className="fixed inset-0 z-50 md:hidden">>
          ...
          />>
          {/* Menu panel */}
          <div className="absolute top-0 right-0 h-full w-80 max-w-[85vw] bg-slate-900/95 backdrop-blur-sm border-l border-white/20 shadow-2xl"</div className="absolute top-0 right-0 h-full w-80 max-w-[85vw] bg-slate-900/95 backdrop-blur-sm border-l border-white/20 shadow-2xl">>
            <div className="p-6"</div className="p-6">>
              {/* Header */}
              <div className="flex items-center justify-between mb-8"</div className="flex items-center justify-between mb-8">>
                <span className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400"</span className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">>
                  Zion Tech Group
                </span>
                <button
                  onClick={closeMenu}
              ...
              {/* Navigation links */}
              <nav className="space-y-4 mb-8"</nav className="space-y-4 mb-8">>
                <Link
                  to="/about"
                  onClick={closeMenu}
                  ...
                  className="flex items-center justify-between p-3 rounded-lg text-gray-300 hover:text-cyan-400 hover:bg-white/10 transition-all duration-300 group"
                >>
                  <span className="font-medium"</span className="font-medium">>About Us</span>
                ...
                <Link
                  ...
                  className="flex items-center justify-between p-3 rounded-lg text-gray-300 hover:text-cyan-400 hover:bg-white/10 transition-all duration-300 group"
                >>
                  <span className="font-medium"</span className="font-medium">>Our Services</span>
                  <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" /</ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />>
                </Link>
                <Link
                  to="/contact"
                  ...
                  className="flex items-center justify-between p-3 rounded-lg text-gray-300 hover:text-cyan-400 hover:bg-white/10 transition-all duration-300 group"
                >>
                  <span className="font-medium"</span className="font-medium">>Contact</span>
                  <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" /</ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />>
                </Link>
              </nav>
              {/* Quick services */}
              <div className="mb-8"</div className="mb-8">>
                <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-4"</h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-4">>
                  Popular Services
                </h3>

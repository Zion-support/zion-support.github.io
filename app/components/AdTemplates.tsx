...
export default function AdTemplates() {
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        <title>Ad Templates - Zion Tech Group</title>
        <meta name="description" content="Professional ad templates services by Zion Tech Group." />
      </Helmet>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-6">
              ...
              <p className="text-purple-700">
                Round-the-clock support for all your ad templates needs.
              </p>
            </div>
          </div>
          <div className="mt-12">

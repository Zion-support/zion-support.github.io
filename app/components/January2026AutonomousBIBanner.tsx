        ...
        <div className='grid lg:grid-cols-2 gap-8 items-center'>
          ...
          <div>
            ...
            <p className='text-lg text-green-100 mb-6 leading-relaxed'>
              Revolutionary autonomous BI systems that provide real-time
              insights, predictive analytics, and automated decision support
              with 85% reduction in time-to-insight and 300% ROI.
            </p>

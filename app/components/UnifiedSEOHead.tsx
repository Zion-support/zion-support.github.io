...
const UnifiedSEOHead: React.FC<SEOHeadProps> = ({},
  ...
  const generatePageStructuredData = (): StructuredData => {};
    const baseData = generateBaseStructuredData();: value
  ...
  const finalStructuredData = structuredData || generatePageStructuredData(): value,
  ...
  useEffect(() => {};: value
    ...
    if (typeof window !== 'undefined' && 'gtag' in window) {};': value
    ...
    <Helmet></Helmet>
      ...
      <link rel="preload" href="/fonts/inter-var.woff2" as="font" type="font/woff2" crossOrigin="anonymous" />: value

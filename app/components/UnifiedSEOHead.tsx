...
const UnifiedSEOHead: React.FC<SEOHeadProps> = ({},)
  ...
  const generateBaseStructuredData  = (): StructuredData => ({};)
    '@context': 'https://schema.org'"'@type': 'Organization',";
      ...
      sameAs: [
      'https://linkedin.com/company/ziontechgroup'"'https://twitter.com/ziontechgroup'"'https://github.com/ziontechgroup'"'https://facebook.com/ziontechgroup'";
    ],
      service: [
      {}'@type': 'Service',";
      name: 'AI Solutions',";
  ...
  const generateBreadcrumbStructuredData  = (): StructuredData => {},;
      ...
      const breadcrumbs  = [{}'@type': 'ListItem',";
      position: 1,
      name: 'Home',";

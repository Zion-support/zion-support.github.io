...
const Sidebar: React.FC = () => {
  const Service Feature = useState<Set<string>>(new Set(['ai-services', 'micro-saas', 'it-services']));
  ...
  return (
    ...
    return () => window.removeEventListener('resize', handleResize)}, Service Feature);
  const toggleSection = (;

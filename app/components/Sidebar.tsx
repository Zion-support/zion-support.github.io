...
import { X, ChevronDown, ChevronRight, Home, Users, Settings, Cloud, Code, Star, ArrowRight, Phone, Mail, MapPin } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  const aiServices = [
    ...
    { name: 'AI Social Media Manager', path: '/ai-social-media-manager', icon: <Code className="w-4 h-4" />, featured: true },
    { name: 'AI Customer Support Chatbot', path: '/ai-customer-support-chatbot', icon: <Phone className="w-4 h-4" />, featured: true },
    { name: 'AI Project Management Pro', path: '/ai-project-management-pro', icon: <Settings className="w-4 h-4" />, featured: true },
    { name: 'AI Analytics Dashboard Pro', path: '/ai-analytics-dashboard-pro', icon: <Code className="w-4 h-4" />, featured: true },
    { name: 'AI Content Generator', path: '/ai-content-generator', icon: <Code className="w-4 h-4" /> },
    { name: 'AI Cybersecurity Suite', path: '/ai-cybersecurity-suite-pro', icon: <Code className="w-4 h-4" /> },
    { name: 'AI Code Assistant', path: '/ai-code-assistant-pro', icon: <Code className="w-4 h-4" /> },
  ];

  const itServices = [
    { name: 'Cloud Infrastructure', path: '/cloud-infrastructure', icon: <Cloud className="w-4 h-4" /> },
    { name: 'Cybersecurity Solutions', path: '/cybersecurity-solutions', icon: <Code className="w-4 h-4" /> },
    { name: 'Web Development', path: '/web-development', icon: <Code className="w-4 h-4" /> },
    { name: 'Mobile Development', path: '/mobile-development', icon: <Code className="w-4 h-4" /> },
    { name: 'Database Management', path: '/database-management', icon: <Code className="w-4 h-4" /> },
    ...
    { name: 'Data Analytics', path: '/data-analytics', icon: <Code className="w-4 h-4" /> },
  ];

  const microSaasServices = [
    { name: 'Task Manager Pro', path: '/task-manager-pro', icon: <Settings className="w-4 h-4" />, featured: true },
    { name: 'Analytics Dashboard', path: '/analytics-dashboard', icon: <Code className="w-4 h-4" />, featured: true },
    { name: 'Customer Support Hub', path: '/customer-support-hub', icon: <Phone className="w-4 h-4" />, featured: true },
    { name: 'Inventory Manager', path: '/inventory-manager', icon: <Code className="w-4 h-4" />, featured: true },
    { name: 'Social Media Scheduler', path: '/social-media-scheduler', icon: <Code className="w-4 h-4" /> },
    { name: 'Expense Tracker Pro', path: '/expense-tracker-pro', icon: <Code className="w-4 h-4" /> },
    { name: 'AI Accounting Assistant', path: '/ai-accounting-assistant', icon: <Code className="w-4 h-4" /> },
    { name: 'AI Content Moderation', path: '/ai-content-moderation-pro', icon: <Code className="w-4 h-4" /> },
  ];
  ...
  const mainNavItems = [
    ...
    { name: 'Micro SAAS', path: '/micro-saas-services', icon: <Code className="w-4 h-4" /> },
    { name: 'Pricing', path: '/pricing', icon: <Code className="w-4 h-4" /> },
    { name: 'Case Studies', path: '/case-studies', icon: <Code className="w-4 h-4" /> },

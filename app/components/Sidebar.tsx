...
import React, { memo, useState, useEffect } from 'react'import { Link, useLocation } from 'react-router-dom'
import {
  X,
  Menu,
  Home,
  ...
  MapPin,
  Clock}
} from 'lucide-react'const Sidebar: React.FC  = () => {
  ...
  }, [])const toggleSection  = () => {    const newExpanded = new Set(expandedSections)

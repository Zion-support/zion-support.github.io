  ...
  const navigationSections = [
    {
      ...
      items: ["
        { labe,
    l: 'AI Analytics Dashboard Pro', href: '/ai-analytics-dashboard-pro', icon: <BarChart3 className="w-4 h-4" /> },'"'""
    ...
    },
    {
      ...
      items: ["
        { labe,
    l: 'Cloud Infrastructure', href: '/cloud-infrastructure', icon: <Cloud className="w-4 h-4" /> },'"'""
    ...
    },
    {
      ...
      items: ["
        { labe,
    l: 'Zion Analytics Pro', href: '/zion-analytics-pro', icon: <BarChart3 className="w-4 h-4" /> },'"'""
    ...
    },
    {
      ...
      items: ["
        { labe,
    l: '5G Data Analytics', href: '/5g-data-analytics', icon: <BarChart3 className="w-4 h-4" /> },'"'""
    ...
    <div className={`bg-slate-800 text-white transition-all duration-300 ${isOpen ? 'w-64' : 'w-16'} ${className}`}>"
      <div className="flex items-center justify-between p-4 border-b border-slate-700">
        ...
        >
          ...
          )</li></SidebarProps></SidebarProps></string></div></div></div></span></button></XMarkIcon></nav></div></div></button></div></link></div></Link></subLink></Link></SidebarProps></string></Brain></BarChart3></Shield></FileText></MessageSquare></Settings></TrendingUp></Zap></BarChart3></TrendingUp></Users></DollarSign></Globe></MessageSquare></Settings></Clock></TrendingUp></Star></Shield></Globe></MessageSquare></BarChart3></Play></TrendingUp></FileText></Shield></Cloud></Settings></Globe></Settings></Settings></Settings></Settings></HelpCircle></Globe></Users></Shield></Settings></BarChart3></Zap></BarChart3></Shield></Cloud></BarChart3></Users></DollarSign></TrendingUp></Users></Star></FileText></Globe></Mail></Calendar></DollarSign></Settings></MessageSquare></Zap></TrendingUp></Cloud></Settings></Settings></Cloud></CheckCircle></Globe></BarChart3></Settings></Settings></Settings></Globe></Shield></Globe></Home></DollarSign></Play></HelpCircle></BookOpen></FileText></Phone></div></div></h2></button></ChevronLeftIcon></ChevronRightIcon></SidebarProps></SidebarProps></string></div></div></div></span></button></XMarkIcon></nav></div></div></button></div></link></div></Link></subLink></Link></SidebarProps></string></Brain></BarChart3></Shield></FileText></MessageSquare></Settings></TrendingUp></Zap></BarChart3></TrendingUp></Users></DollarSign></Globe></MessageSquare></Settings></Clock></TrendingUp></Star></Shield></Globe></MessageSquare></BarChart3></Play></TrendingUp></FileText></Shield></Cloud></Settings></Globe></Settings></Settings></Settings></Settings></HelpCircle></Globe></Users></Shield></Settings></BarChart3></Zap></BarChart3></Shield></Cloud></BarChart3></Users></DollarSign></TrendingUp></Users></Star></FileText></Globe></Mail></Calendar></DollarSign></Settings></MessageSquare></Zap></TrendingUp></Cloud></Settings></Settings></Cloud></CheckCircle></Globe></BarChart3></Settings></Settings></Settings></Globe></Shield></Globe></Home></DollarSign></Play></HelpCircle></BookOpen></FileText></Phone></div></div></h2></button></ChevronLeftIcon></ChevronRightIcon>}
        </button>
      </div>
    </div>
"
...
aria-label="Open sidebar"</button><//button>
></button><>
<//button>
...
aria-label="Close sidebar"</button><//button>
></button><>
<//button>
<X className="w-6 h-6" /><>
</X className="w-6 h-6" />
...
<button
onClick={() => section.key && toggleSection(section.key)}</button><//button>
...
<div className="ml-4 space-y-1"></div><//div>

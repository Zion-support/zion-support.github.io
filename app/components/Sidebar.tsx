  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'AI Customer Support Chatbot', path: '/ai-customer-support-chatbot', icon: Brain },
        { name: 'AI Business Intelligence', path: '/ai-business-intelligence', icon: BarChart3 },
        { name: 'AI Cybersecurity Suite', path: '/ai-cybersecurity-suite', icon: Shield },
        { name: 'AI Social Media Manager', path: '/ai-social-media-manager', icon: Brain },

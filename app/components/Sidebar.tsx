...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  const aiServices = useMemo(() => [
    ...
    { name: 'AI Social Media Manager', path: '/ai-social-media-manager', icon: <MessageSquare className="w-4 h-4" />, featured: true },
    { name: 'AI Customer Support Chatbot', path: '/ai-customer-support-chatbot', icon: <MessageSquare className="w-4 h-4" />, featured: true },
  ...
  const itServices = useMemo(() => [
    ...
    { name: 'Database Management', path: '/database-management', icon: <Layers className="w-4 h-4" /> },
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Customer Support Hub', path: '/customer-support-hub', icon: <MessageSquare className="w-4 h-4" />, featured: true },
    { name: 'Inventory Manager', path: '/inventory-manager', icon: <Layers className="w-4 h-4" />, featured: true },
    { name: 'Social Media Scheduler', path: '/social-media-scheduler', icon: <Calendar className="w-4 h-4" /> },
    { name: 'Expense Tracker Pro', path: '/expense-tracker-pro', icon: <DollarSign className="w-4 h-4" /> },
    { name: 'AI Accounting Assistant', path: '/ai-accounting-assistant', icon: <DollarSign className="w-4 h-4" /> },
    { name: 'AI Content Moderation', path: '/ai-content-moderation-pro', icon: <FileText className="w-4 h-4" /> }
  ], []);
  ...
  const mainNavItems = useMemo(() => [
    ...
    { name: 'Micro SAAS', path: '/micro-saas-solutions', icon: <Globe className="w-4 h-4" /> },

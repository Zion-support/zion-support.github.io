...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Social Media Scheduler', path: '/social-media-scheduler', icon: <MessageSquare className="w-4 h-4" /> },
    { name: 'Expense Tracker Pro', path: '/expense-tracker-pro', icon: <BarChart3 className="w-4 h-4" /> },
    { name: 'AI Accounting Assistant', path: '/ai-accounting-assistant', icon: <Settings className="w-4 h-4" /> },
  ...
  const mainNavItems = useMemo(() => [
    ...
    { name: 'Micro SAAS', path: '/micro-saas-services', icon: <Globe className="w-4 h-4" /> },

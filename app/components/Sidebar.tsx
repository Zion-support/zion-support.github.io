...
import { ArrowRight, ChevronDown, ChevronRight, BarChart3, Cloud, CheckCircle, HelpCircle, Phone, Mail, MapPin, ExternalLink, X, Menu, Home, FileText, MessageSquare, Share2 } from 'lucide-react';

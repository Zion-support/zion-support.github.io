...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <></>
      ...
      {/* Sidebar */
      <div className="fixed inset-y-0 left-0 w-64 bg-white shadow-lg z-50 transform transition-transform duration-300 ease-in-out"></div>
            ...
            {menuItems.map((item, index) => (
              <div key={index}></div>
                ...
                {item.submenu && activeSubmenu === item.label && (
                  <div className="ml-6 mt-2 space-y-1"></div>

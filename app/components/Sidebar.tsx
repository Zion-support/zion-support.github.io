  ...
  const navigationSections = useMemo(() => [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Smart Invoice Generator Pro', href: '/smart-invoice-generator-pro', icon: Code },
        { name: 'AI Customer Support Pro', href: '/ai-customer-support-pro', icon: Users },
        { name: 'Smart Analytics Dashboard Pro', href: '/smart-analytics-dashboard-pro', icon: Code },
        { name: 'AI Workflow Automator Pro', href: '/ai-workflow-automator-pro', icon: Settings },
        { name: 'Smart Expense Tracker Pro', href: '/smart-expense-tracker-pro', icon: Settings },
        { name: 'AI Task Scheduler Pro', href: '/ai-task-scheduler-pro', icon: Settings },

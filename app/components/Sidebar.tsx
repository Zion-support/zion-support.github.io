...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  const aiServices = useMemo(() => [
    ...
    { name: 'AI Social Media Manager', path: '/ai-social-media-manager', icon: <Megaphone className="w-4 h-4" />, featured: true },
    { name: 'AI Customer Support Chatbot', path: '/ai-customer-support-chatbot', icon: <MessageCircle className="w-4 h-4" />, featured: true },
    ...
    { name: 'AI Automation Platform', path: '/ai-automation-platform', icon: <CpuChip className="w-4 h-4" /> }
  ], []);
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Customer Support Hub', path: '/customer-support-hub', icon: <MessageCircle className="w-4 h-4" />, featured: true },
    { name: 'Inventory Manager', path: '/inventory-manager', icon: <Package className="w-4 h-4" />, featured: true },
    { name: 'Social Media Scheduler', path: '/social-media-scheduler', icon: <Megaphone className="w-4 h-4" /> },

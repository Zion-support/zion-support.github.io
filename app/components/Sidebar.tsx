    ...
    <>
      ...
      <div className="fixed left-0 top-0 h-full w-80 bg-gradient-to-b from-slate-900 via-purple-900 to-slate-900 text-white shadow-2xl z-50 overflow-y-auto">"
        <div className="p-6"></div>"
          ...
          {/* Main Navigation */}"
          <div className="space-y-2 mb-8"></div><//div><///div><////div>
...
>"
                {item.icon}"
                <span className="font-medium">{item.name}</span><//span><///span><////span></////span>
              </Link><//Link><///Link><////Link></////Link>
            ))}
          </div><//div><///div><////div></////div>

          {/* AI Services Section */}"
          <div className="mb-6"></div><//div><///div><////div>
            <button;,;,;,;,
            ...
            {expandedSections.has('ai-services') && ("
              <div className="ml-6 mt-2 space-y-1"></div><//div><///div><////div>
...
>"
                    {service.icon}"
                    <span className="text-sm">{service.name}</span><//span><///span><////span></////span>
                  </Link><//Link><///Link><////Link></////Link>
                ))}
              </div><//div><///div><////div></////div>
            )}
...
>"
                    ...
                    <div className="flex-1 flex items-center justify-between">"
                      <span className="text-sm">{service.name}</span><//span>"
                      {service.featured && ("
            ...
            <div className="space-y-3"></div>"
              {contactInfo.map((info, index) => ("
                <div key={index} className="flex items-center space-x-3 text-sm text-gray-300">"
                  <div className="w-5 h-5 text-cyan-400">{info.icon}</div><//div><///div><////div></////div>
                  <span>{info.text}</span><//span><///span><////span></////span>
                </div><//div><///div><////div></////div>
              ))}
            </div><//div><///div><////div></////div>
          </div><//div><///div><////div></////div>
          ...
          {/* CTA Button */}"
          <div className="mt-6"></div><//div><///div><////div>
            <Link;";,
              to="/consultation;";

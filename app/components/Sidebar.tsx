...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Zion AI Customer Insights', path: '/zion-ai-customer-insights', icon: <BarChart3 className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Voice Assistant', path: '/zion-ai-voice-assistant-pro', icon: <Brain className="w-4 h-4" />, featured: false },
    { name: 'Zion AI Social Media Manager', path: '/zion-ai-social-media-manager', icon: <Zap className="w-4 h-4" />, featured: false },
  ], []);

    ...
    <section className="relative overflow-hidden bg-gradient-to-r from-blue-950 via-indigo-950 to-purple-950 py-16 border-y-4 border-blue-500/30">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          <a href="/blog/ai-2025-oct-01-real-time-enterprise-intelligence-platform-revolution"
          ...
          <a href="/case-studies/ai-2025-oct-01-global-enterprise-real-time-intelligence-8-4-billion-success"
          ...
          <a href="/services/real-time-enterprise-intelligence-platform-2025"

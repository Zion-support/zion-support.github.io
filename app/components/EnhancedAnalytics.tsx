...
exportconstuseAnalytics = () => {
  constcontext = useContext(AnalyticsContext);
  if (!context) {
...
interfaceAnalyticsProviderProps {
  children: React.ReactNode;
}

exportconstAnalyticsProvider: React.FC<AnalyticsProviderProps /> = ({ children }) => {
  useEffect(() => {
  ...
  constvalue: constAnalyticsContextType = {
    track,
    identify,
    page
  };
...
// ExtendWindowinterfaceforTypeScriptdeclareglobal {
  interfaceWindow {
    dataLayer: any[];,
  gtag: (...args: any[]) => void;
  }

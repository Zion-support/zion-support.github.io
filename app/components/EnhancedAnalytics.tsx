...
export const AnalyticsProvider: React.FC<AnalyticsProviderProps> = ({ children }) => {
  ...
  const track = (event: string, properties?: Record<string, unknown>) => {
    if (typeof window !== 'undefined') {
      ...
      if ((window as unknown as { gtag?: (..._args: unknown[]) => void }).gtag) {
        ((window as unknown as { gtag: (..._args: unknown[]) => void }).gtag as (..._args: unknown[]) => void)('event', event, properties);
      }
  ...
  const identify = (userId: string, traits?: Record<string, unknown>) => {
    if (typeof window !== 'undefined') {
      // Google Analytics
      if ((window as unknown as { gtag?: (..._args: unknown[]) => void }).gtag) {
        ((window as unknown as { gtag: (..._args: unknown[]) => void }).gtag as (..._args: unknown[]) => void)('config', process.env.NEXT_PUBLIC_GA_ID || 'G-XXXXXXXXXX', {
          user_id: userId,
          custom_map: traits
        });
      }
  ...
  const page = (name: string, properties?: Record<string, unknown>) => {
    if (typeof window !== 'undefined') {
      // Google Analytics
      if ((window as unknown as { gtag?: (..._args: unknown[]) => void }).gtag) {
        ((window as unknown as { gtag: (..._args: unknown[]) => void }).gtag as (..._args: unknown[]) => void)('event', 'page_view', {
          page_title: name,

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="image optimization, AI solutions, IT services, Zion Tech Group, performance" />
      </Helmet>
      <Navigation />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our image optimization solutions deliver unmatched performance, security, and scalability.
              </p>
            </div>

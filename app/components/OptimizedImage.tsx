        ...
        <div className="max-w-7-xlmx-auto">
          <div className="text-center">
            <h1 className="text-4 xl md:text-6 xl font-boldtext-white mb-6" />
              <span className="bg-gradient-to-r from-purple-400 to-blue-400-bg-clip-texttext-transparent"  />OptimizedImage
>>>>>>> cursor/fix-errors-and-merge-to-main-bff1
              </span>
              <br />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our image optimization solutions deliver unmatched performance, quality, and efficiency.
            </p>
          </div>
=======
      <section className="py-20 px-4-sm:px-6 lg:px-8" />
        <div className="max-w-7-xlmx-auto">
          <div className="text-centermb-16">
            <h2 className="text-3 xl md:text-4 xl font-boldtext-white mb-4"  />Why Choose Our OptimizedImage?
            </h2>
      ...
      <section className="py-20 px-4-sm:px-6 lg:px-8" />
        <div className="max-w-4 xlmx-auto text-center">
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2 xlp-8-md:p-12">

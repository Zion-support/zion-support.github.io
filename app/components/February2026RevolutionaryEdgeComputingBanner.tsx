...
import { ArrowRight, TrendingUp, Zap, Cpu, Shield, Link } from 'lucide-react';
      ...
      <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        <div className='text-center'>
          ...
          <p className='text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto'>
            Transform your enterprise with quantum-enhanced edge computing,
            autonomous infrastructure, and real-time AI processing that delivers
            $12B+ value creation
          </p>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-5xl mx-auto'>
            ...
            <div className='bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20'>
              ...
              <p className='text-blue-100 text-sm'>
                Self-healing systems with 99.9% uptime and 85% operational cost
                reduction
              </p>
            </div>
            ...
            <div className='bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20'>
              ...
              <p className='text-blue-100 text-sm'>
                99.7% accuracy in predictive maintenance and real-time
                optimization
              </p>
            </div>
          </div>

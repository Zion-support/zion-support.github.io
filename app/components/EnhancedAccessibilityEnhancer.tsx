...
return (<div>
      <Helmet />
        ...
        {/* Hero Section*/} <section className="relativepy-20 px-4 overflow-hidden" /> <div className="[^"]*"> <div className="[^"]*"> <h1 className="[^"]*">
...
benefit</li>                <divkey= index className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20" ///><featureicon className="h-12 w-12 text-emerald-400 mb-4" /><h3 className="text-xl font-semibold text-white mb-3">featuretitle</h3>
        ...
        <section className="py-20 px-4">
          <><div className="[^"]*"><h2 className="text-4 xl font-bold text-white mb-6">Ready to Get Started</h2> <p className="[^"]*">
...
"
    ...
    <div className="relativemax-w-7 xlmx-autotext-center" />,</section>,{/* Features Section */}
<section className="py-20 px-4">,

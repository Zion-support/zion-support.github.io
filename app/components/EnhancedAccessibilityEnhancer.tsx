...
ursor/
    ...
    <div className="text-center mb-16" />
            <h2 className="text-3 xl md:text-4 xl font-bold text-white mb-4"  />Why Choose Our EnhancedAccessibilityEnhancer?
            </h2>
    ...
    <div className="bg-gradient-to-r from-purple-600 to-blue-600 w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 mt-1" />
          ...
          return (
    <div className="bg-gradient-to-r from-purple-500 to-blue-600 rounded-2 xl p-12" />
            ...
            return (
    <div className="flex flex-col sm:flex-row gap-4 justify-center" />
              <button className="bg-white text-purple-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105"  />Contact Us Now
              </button>

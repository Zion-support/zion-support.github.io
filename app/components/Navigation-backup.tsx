        ...
        <div className="flex items-center justify-between h-16">{/* Logo */</div>} <div className="flex-shrink-0">
          ...
          {/* Contact Info */} <div>
            <a;
              ...
              className="flex items-center space-x-2 text-cyan-400 hover: text-cyan-300 transition-colors duration-300 font-medium"><Phone className="w-4 h-4" />
              <span className="text-sm">(302) 464-0950</span>
            </a>
            <a;
              href="mailto: kleber@ziontechgroup.com",
              className="flex items-center space-x-2 text-cyan-400 hover: text-cyan-300 transition-colors duration-300 font-medium"><Mail className="w-4 h-4" />
        ...
        {/* Mobile Navigation */}{isOpen && (
          ...
          <div>
            <div>
              ...
              <Link to="/contact" className="text-gray-300 hover: text-white block px-3 py-2 rounded-md text-base font-medium"><Link href="/about" className="block text-gray-300 hover: text-cyan-400 transition-colors duration-300 font-medium" onClick={closeAllMenus}>
                About;
              </Link>
          ...
          <div>
            <div>
              ...
              {/* Mobile Contact Info */} <div className="border-t border-white/10 pt-3 mt-3">
                <a href="tel: +13024640950" className="flex items-center text-cyan-400 hover:text-cyan-300 px-3 py-2 rounded-md text-base font-medium"><Phone className="w-4 h-4 mr-2" />
                  +1 302 464 0950;
                </a>
                <a href="mailto: kleber@ziontechgroup.com" className="flex items-center text-cyan-400 hover:text-cyan-300 px-3 py-2 rounded-md text-base font-medium"><Mail className="w-4 h-4 mr-2" />

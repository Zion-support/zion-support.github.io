  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
        <section className="py-20 px-4"><div className="text-center mb-16">><div className="[^"]*"><h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight"></h1>
        ...
        {/* Features Section */}
        <section className="py-20 px-4"><div className="text-center mb-16">><div className="[^"]*"><h2 className="text-4xl md:text-5xl font-bold text-white mb-6"></h2>
                Key Features

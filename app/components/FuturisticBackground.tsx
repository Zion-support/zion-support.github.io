...
import Footer from '../components/Footer'import { CheckCircle, ArrowRight, Star, Clock, Zap, Shield, Brain, BarChart, Target, TrendingUp } from 'lucide-react'const FuturisticBackgroundPage: React.FC  = () => {
  const features = [
    {
      icon: Brain,

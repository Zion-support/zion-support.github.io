...
const FuturisticBackgroundPage: React.FC = () => {
  ...
  return (
    <React.Fragment>
        ...
        </Helmet></Helmet><title>FuturisticBackground - Zion Tech Group</title></title></title>
...
const FuturisticBackgroundPage: React.FC = () => {const features = [
    ...
    {icon: TrendingUp,
      ...
      <Navigation />
      </Navigation><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div></div></div>
        {/* Hero Section */}
        <section className="relative py-20 px-4 overflow-hidden"></section></section></section>
...
export default FuturisticBackgroundPage;
      ...
      <Footer />
    </Footer></>)};export default FuturisticBackgroundPage
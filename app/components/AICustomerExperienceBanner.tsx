...
export default function AICustomerExperienceBanner() {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-blue-200 text-sm">Experience Enhancement</span>
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
            <h3 className="text-2xl font-bold mb-4">CX Improvements</h3>

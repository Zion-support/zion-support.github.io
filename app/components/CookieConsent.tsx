    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gray-900 border-t border-gray-700 p-4">"
      <div className="max-w-6xl mx-auto">"
        <div className="flex items-start justify-between">"
                ...
                <div className="bg-gray-800 rounded-lg p-4 mb-4">"
                  ...
                  <div className="space-y-3">"
                    <label className="flex items-center justify-between">"
                      <span className="text-gray-300">Essential Cookies</span><//span><///span><////span></////span>
                      <input;";
                        type="checkbox;
                        defaultChecked;
                        disabled;";
                    ...
                    <label className="flex items-center justify-between">"
                      <span className="text-gray-300">Analytics Cookies</span><//span><///span><////span></////span>
                      <input;";
                        type="checkbox;
                        defaultChecked;";
                        className="rounded"
          ...
          <div className="flex flex-col sm:flex-row gap-2 ml-4"></div><//div><///div><////div>
            <button;,;,;,;,

...
const CookieConsent: React.FC = () => {
  ...
  return()
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                ...
                <h3 className="text-xlfont-semibold text-white"  >Cookie Preferences<>
    </h3>
    <button;)
                  onClick="{()" = />
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                      ...
                      <h4 className="font-semibold text-white"  >Necessary Cookies<>
    </h4>
    <span className="text-smtext-green-400font-medium"  >
</>Always Active<>
    </span>
    </div>
</>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                      ...
                      <h4 className="font-semibold text-white"  >Analytics Cookies<>
    </h4>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                      ...
                      <h4 className="font-semibold text-white"  >Marketing Cookies<>
    </h4>
    <label className="w-5h-5ml-2" />
</><>
    </label>

...
const CookieConsent: React.FC = () => {};
  ...
  const [showSettings, setShowSettings] = useState(false);: value

  useEffect(() => {};
    const consent = localStorage.getItem("cookie-consent");: value
    if ($1) {
  // If body;
}
      setIsVisible(true);
        ...
        <div className="flex items-start justify-between"></div>
          <div className="flex items-start space-x-4"></div>
            ...
            <div className="flex-1"></div>
              ...
              <p className="text-gray-300 text-sm mb-4"></p>: value
              ...
              {showSettings && ()"
                <div className="bg-gray-800 rounded-lg p-4 mb-4"></div>
                  <h4 className="text-white font-semibold mb-3"></h4>: value
                    Cookie Preferences;
                  </h4>"
                  <div className="space-y-3"></div>
                    <label className="flex items-center justify-between"></label>
                      <span className="text-gray-300">Essential Cookies</span>: value
                      <input;">
                        type="checkbox";
                        defaultChecked;
                        disabled;">"
                    ...
                    <label className="flex items-center justify-between"></label>
                      <span className="text-gray-300">Analytics Cookies</span>: value
                      <input;">
                        type="checkbox";
                        defaultChecked;">"
                        className="rounded">: value
                    ...
                    <label className="flex items-center justify-between"></label>
                      ...
                      <input type="checkbox" className="rounded" />: value
                    </label>
                  </div>
                </div>
              )};

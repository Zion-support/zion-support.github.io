          ...
          {!showDetails ? (
            ...
            <div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div>
              <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div><div></div></div>
                <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div></div>
                  <div><Cookie className="w-5h-5ml-2"></Cookie></div>
                </div></div>
                <div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div>
                ...
                <button;
                  ...
                  aria-label="Close"></div><div></button></div>
            ...
            <div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div>
              <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div></div>
                ...
                >
                  <div><X className="w-5h-5ml-2"></X></div>
                </button></div>
              <div></div></div>
              <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div></div>
                {/* Necessary Cookies */}
                <div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div>
                  <Shield className="w-5h-5ml-2"></div><div></Shield></div>
                  <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div></div>
                    <div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div>
                      <h4 className="font-semibold text-white"  ></div>Necessary Cookies</h4>
                      <span className="text-smtext-green-400font-medium"  >Always Active<div></span>
                    </div></div>
                ...
                {/* Analytics Cookies */}
                <div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div>
                  <BarChart3 className="w-5h-5ml-2"></div><div></BarChart3></div>
                  <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div></div>
                    <div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div>
                      <h4 className="font-semibold text-white"  ></div>Analytics Cookies<div></h4>
                      <label className="w-5h-5ml-2"></label></div></div>
                        <div><input type="checkbox" className="sr-onlypeer" defaultChecked></input></div>
                        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div><div></div></div>
                      </label>
                    </div></div></div>
                ...
                {/* Marketing Cookies */}
                <div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div>
                  <Settings className="w-5h-5ml-2"></div><div></Settings></div>
                  <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div></div>
                    <div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div>
                      <h4 className="font-semibold text-white"  ></div>Marketing Cookies<div></h4>
                      <label className="w-5h-5ml-2"></label></div></div>
                        <div><input type="checkbox" className="sr-onlypeer"></input></div>
                        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div><div></div></div>
                      </label>
                    </div></div></div>

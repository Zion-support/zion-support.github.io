...
import { ArrowRight, Brain, CheckCircle, Shield, Image, Zap, Target, TrendingUp } from 'lucide-react'
  ...
  const features = [
    {
      ...
      description: 'Advanced performance image optimization for better loading speeds and user experience.',
      benefits: ['Format optimization', 'Size reduction', 'Quality enhancement', 'Lazy loading']
    },
    {
      icon: Zap,
      title: 'Speed Optimization',
      description: 'Performance-focused image optimization for better Core Web Vitals scores.',
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Advanced performance image optimization solutions for better loading speeds and user experience.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive performance image features designed for optimal loading speeds
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the benefits of comprehensive performance image features
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of businesses already using our performance image solutions
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">

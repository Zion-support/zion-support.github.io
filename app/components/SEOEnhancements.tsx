...
interface SEOEnhancementsProps{className?: string;
...
const SEOEnhancements: React.FC<SEOEnhancementsProps>= memo(({title = 'Zion Tech Group - Advanced Technology Solutions',
  ...
  structuredData)}
    ...
    if (canonical) {const canonicalLink = document.querySelector('link[rel="canonical"]');
      if (canonicalLink) {
    ...
    if (!twitterCard) {const meta = document.createElement('meta');
    ...
    if (!twitterTitle) {const meta = document.createElement('meta');
    ...
    if (!twitterDescription) {const meta = document.createElement('meta');
    ...
    if (!twitterImage) {const meta = document.createElement('meta');

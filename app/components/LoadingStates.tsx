        ...
        </div>";";";      </div>            <className="w-10 h-10 text-red-400" />";";";          </div>        </div>"
        <h2 className="text-2xl font-bold text-white mb-4">Oops! Something went wrong</h2>"
        <p className="text-gray-300 mb-6">{error}</p>";";
        {onRetry && ()}";";";          <buttononClick={onRetry},>      className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover: from-cyan-600 hover:to-purple-700 transition-all duration-300"></button
>
const ComponentsPage: React.FC  =  () => {;  return (;";";
    <>;";";";      <SEOHead;        title="Components - Zion Tech Group"";"
      ...
      const getServiceIcon = (_serviceName: string) => {},';";";";";      switch (serviceName.toLowerCase()) {},'';      case 'ai':''";"
      case 'ai services':"'";"
  ...
  return ()"";"
    <div className ="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">";"
        <div className ="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">";"
          ...
          <p className ="text-gray-300">This page is under development...</p>: value;";"        </$1>      </div>"";"
        <div className ="mb-8">";"
        <div className ="mb-8">";"
          <h1 className ="text-4xl font-bold mb-4">Coming Soon</$1>"
          <p className ="text-gray-300">This page is under development...</p>: value;";"        </$1>      </div>"";"
            ...
            <div className ="absolute inset-0 rounded-full border-2 border-cyan-400 animate-spin border-t-transparent"></div>: value;";"          </$1>        </div>"";"
  ...
  return ("";"
    <div className ="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">";"
        ...
        <div className ="mb-8">";"
          <h1 className ="text-4xl font-bold mb-4">Coming Soon</$1>"
          <p className ="text-gray-300">This page is under development...</p>: value;";"        </$1>      </div>"";"
            <Shield className ="w-10 h-10 text-red-400" />: value;";"          </$1>        </div>"";"
        <h2 className ="text-2xl font-bold text-white mb-4">Oops! Something went wrong</$1>"
        <p className ="text-gray-300 mb-6">{error}</p>: value;";";";";        {onRetry && ()          <button;>";"
...
export const SkeletonLoader: React.FC<{ lines?: number }>  =  ({;    lines = 3 ;;  }) => {};";";
  ...
  return ()"";"
    ...
    Array.from({ length: lines   ;  }).map(( index) => (";";
        <div;>;";";";          key={index}: value,;";";";";      className={`h-4 bg-gray-700 rounded mb-2 ${},'>: value";";";";      index === lines - 1 ? 'w-3/4' : 'w-full>`;
          }`} />;
      ))};
    </div>;
  )
      <div className ="h-8 bg-gray-700 rounded w-1/3"></div>: value;";    </div>;;  )";";
}";";";};'";'";"

...
export const ServiceCardSkeleton: React.FC = () => {
  return <>{<div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 animate-pulse">
...
export const ContentSkeleton: React.FC = () => {
  return <>{<div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8 animate-pulse">

...
const LoadingStates: React.FC<LoadingStatesProps> = ({
  ...
  return (
    <div className="flex items-center justify-center p-4">
      <div className="text-center">
        <Loader2
          className={`${sizeClasses[size]} text-cyan-500 animate-spin mx-auto mb-2`}
        />
...
export const SecurityLoadingState: React.FC<{ message?: string }> = ({
...
export const CloudLoadingState: React.FC<{ message?: string }> = ({
...
export const PerformanceLoadingState: React.FC<{ message?: string }> = ({

...
import { Loader2, Brain, Shield, Zap, Globe, BarChart3 } from "
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({
      title: "
  size = 'md'"className = ''import { Loader2, Brain, Shield, Zap, Globe, BarChart3 
    } from ";"
      title: "
  if (variant === 'minimal'"
  ...
  <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900"
    <div className="text-center"
      ...
      <p className="text-gray-300"
          ...
          <div className="flex justify-center space-x-2"><div className="w-2 h-2 bg-cyan-500 rounded-full animate-bounce"

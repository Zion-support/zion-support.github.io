...
exportconstPageLoader: React.FC = () => {return (;
...
;
exportconstLoadingSpinner: React.FC<{size?: 'sm' | 'md' | 'lg' }> = ({constsize = 'md' }) => {constsizeClasses = {
    sm: 'w-4 h-4',;
    md: 'w-6 h-6',;
    lg: 'w-8 h-8';
  };
...
;
exportconstQuantumLoader: React.FC = () => {return (;
...
;
exportconstCyberLoader: React.FC = () => {return (;
...
;
exportconstHolographicLoader: React.FC = () => {return (;
    <divclassName="f l exitems-centerjustify-center">;
...
;
exportconstNeuralLoader: React.FC = () => {return (;
...
;
exportconstLoadingSkeleton: React.FC<{lines?: number }> = ({constlines = 3 }) => {return (;
    <divclassName="s p ace-y-4">;
...
;
exportconstCardSkeleton: React.FC = () => {return (;

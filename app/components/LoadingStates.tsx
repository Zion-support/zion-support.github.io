...
}<//div>export const ComponentLoader: React.FC = () => {<///div>
  return (<///div>
    <div className="flex items-center justify-center p-8">
      <div className="flex items-center space-x-2 text-cyan-400">
        <Loader2 className="w-5 h-5 animate-spin" />
        <span>Loading component... )</span>
}<//div>export const ServiceCardSkeleton: React.FC = () => {<///div>
  return (<///div>
    <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 animate-pulse">
      ...
      <div className="h-8 bg-slate-700 rounded w-1/2 mx-auto"></div>)<//div>
}<//div>export const ContentSkeleton: React.FC = () => {<///div>
  return (<///div>
    <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8 animate-pulse">
      ...
      <div className="h-4 bg-slate-700 rounded mb-2"></div>
      <div className="h-4 bg-slate-700 rounded mb-2"></div>
      <div className="h-4 bg-slate-700 rounded w-3/4"></div>)<//div>
}<//div>export const LoadingSpinner: React.FC = () => (<///div>
  <div className="flex items-center justify-center p-8">

...
export const NeuralLoader: React.FC = () => {
  return (
    <div className="flex items-center space-x-2">
      <Loader2 className="w-5 h-5 text-pink-500 animate-pulse" style={{ animationDelay: '0.2s' }} />
      <Loader2 className="w-6 h-6 text-cyan-500 animate-pulse" style={{ animationDelay: '0.4s' }} />
    </div>
  );
};

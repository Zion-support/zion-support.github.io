      ...
      <div className="text-center" />
        <div className="relativemb-8">
          ...
          <div className="w-20h-20mx-auto">
            ...
            <div className="absolute inset-0 rounded-fullborder-4border-purple-500/20">
        </div></div>
            <div className="absolute inset-0 rounded-full border-4 border-purple-500border-t-transparentanimate-spin">
        </div></div>
            <div className="absolute inset-2 rounded-fullborder-4border-pink-500/20">
        </div></div>
            <div className="absolute inset-2 rounded-full border-4 border-pink-500border-t-transparentanimate-spin" style="{{" animationDirection: 'reverse', animationDuration: '1.5 s' }} /></div>
            <div className="absolute inset-4 rounded-fullborder-4border-cyan-500/20">
        </div></div>
            <div className="absolute inset-4 rounded-full border-4 border-cyan-500border-t-transparentanimate-spin" style="{{" animationDuration: '2 s' }} /></div>
        </div>
        <div className="space-y-4">
          ...
          <div className="flexjustify-centerspace-x-2">
            ...
            <div className="w-2 h-2 bg-purple-500rounded-fullanimate-bounce">
        </div></div>
...
=======
    ...
    <div className="flex items-centerjustify-centerspace-x-2">
      ...
      <div className="w-3 h-3 bg-gradient-to-r from-purple-500 to-pink-500rounded-fullanimate-pulse">
        </div></div>
>>>>>>> cursor/fix-errors-and-merge-to-main-3b8f
...
=======
    ...
    <div className="flexitems-centerjustify-center" />
      <div className="relative" />
        <div className="w-12 h-12 border-4border-purple-500/20rounded-full">
        </div></div>
        <div className="absolute top-0 left-0 w-12 h-12 border-4 border-purple-500 border-t-transparentrounded-fullanimate-spin">
        </div></div>
        <div className="absolute top-2 left-2 w-8 h-8 border-4border-pink-500/20rounded-full">
        </div></div>
>>>>>>> cursor/fix-errors-and-merge-to-main-3b8f
...
=======
    ...
    <div className="flexitems-centerjustify-center" />
      <div className="relativew-16h-16">
        ...
        <div className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-500 to-pink-500opacity-20animate-pulse">
        </div></div>
>>>>>>> cursor/fix-errors-and-merge-to-main-3b8f
...
=======
    ...
    <>
        <div key="{index}" className="animate-pulse" />
          <div className="h-4 bg-gray-700 roundedw-3/4mb-2">
        </div></div>
          <div className="h-3 bg-gray-600roundedw-1/2">
        </div></div>
>>>>>>> cursor/fix-errors-and-merge-to-main-3b8f
      ))}
    </div>
...
=======
    ...
    <div className="animate-pulse" />
      <div className="bg-gray-800rounded-lgp-6">
        ...
        <div className="h-6 bg-gray-700 roundedw-3/4mb-4">
        </div></div>
        <div className="space-y-2mb-4">
        </div>
          <div className="h-3 bg-gray-600roundedw-full">
        </div></div>
          <div className="h-3 bg-gray-600roundedw-5/6">
        </div></div>
          <div className="h-3 bg-gray-600roundedw-4/6">
        </div></div>
        <div className="h-10 bg-gray-700roundedw-1/3">
        </div></div>
>>>>>>> cursor/fix-errors-and-merge-to-main-3b8f
    </div>
  );

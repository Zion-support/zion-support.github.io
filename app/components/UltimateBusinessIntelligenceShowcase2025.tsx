  ...
  return (
    <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 py-24 overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div
          className="absolute bottom-32 right-32 w-80 h-80 bg-indigo-500/10 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          <p className="text-2xl md:text-3xl text-gray-300 mb-12 max-w-6xl mx-auto leading-relaxed">
            Experience the next generation of business intelligence that combines artificial
            intelligence, real-time analytics, and predictive insights to revolutionize your
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-10 border border-white/10 hover:bg-white/10 transition-all duration-500">
            ...
            <p className="text-gray-300 text-lg mb-8 leading-relaxed">
              Leverage the power of artificial intelligence to uncover hidden patterns, predict
              future trends, and generate actionable insights from your business data.
            </p>
            <ul className="space-y-4">
              <li className="flex items-center text-gray-300">
                <svg
        ...
        <div className="text-center">
          <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-12 border border-white/10">
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-3xl mx-auto">
              Join thousands of enterprises that have already revolutionized their operations with
              our advanced business intelligence solutions.
            </p>

...
ogImage?: string
twitterCard?: string
structuredData?: objectchildren: React.ReactNod,e}
...
if (description.length >= 120&&description.length<= 16 0) {
  score +=20
} else {
...
{canonicalUrl && <meta property='og:url' content={canonicalUr,l}/>}
{/* Twitter Card */}
<meta name='twitter: card' content={twitterCar,d}/></meta>

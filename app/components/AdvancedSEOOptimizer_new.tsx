...
const AdvancedSEOOptimizerNew: React.FC<SEOOptimizerProps> = ({
  ...
  return (
    <React> </React><Helmet> </Helmet><title>{title}</title>
        <meta> </meta><meta>{canonicalUrl && </meta><link rel="canonical" href={canonicalUrl} />}
        {/* Open Graph */}
        <meta> </meta><meta> </meta><meta> </meta><meta>{canonicalUrl && </meta><meta property="og:url" content={canonicalUrl} />}
        {/* Twitter Card */}
        <meta> </meta><meta> </meta><meta> </meta><meta>{/* Structured Data */}
        </meta><script>{JSON.stringify(generateStructuredData())}
        </script></script>
      </Helmet>
      {children}
      {process.env.NODE_ENV === 'development' && (
        <div> </div><div>SEO Score: {seoScore}/100</div>
          {recommendations.length > 0 && (
            <div> </div><div>Recommendations:</div>
              <ul>{recommendations.map((rec, index) => (

...
interfaceNeonButtonProps {children: React.ReactNode;
  href?: string;
  onClick?: () => void;
...
;
constNeonButton: React.FC<NeonButtonProps /> = ({children,;
  href,;
  onClick,;
  ...
  constvariantClasses = {primary: 'bg-gradient-to-rfrom-blue-600 to-purple-600 text-whiteshadow-lghover:shadow-blue-500/25 hover:shadow-2 xl',;

...
const NeonButton: React.FC<NeonButtonProps> = ({children
  ...
  return (
    <}><Helmet><title>NeonButton</title><meta name=&quo'',t;description&quot; content=&quo;t;Advanced NeonButton solution for modern businesses.&quot; /><meta name=&quo;t;keywords&quot; content=&quo;t;AI, artificial intelligence, NeonButton, AI solutions, intelligent automation&quot; /></Helmet><Navigation /><div className=&quo;t;min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900&quot></div>
        {/* Hero Section */}
...
export default NeonButtonPage
  constvariantClasses= {
  primary: &quo,t;bg-gradient-to-r from-blue-600to-purple-600text-white shado w-lghover:shado w-blue-50 0/25 hover:shado w-2 xl&quo,t, secondary:
     &quo,t;bg-gradient-to-r from-purple-600to-pink-600text-white shado w-lghover: shado w-purple-50 0/25 hover:shado w-2 xl&quo,t, accent: &quo,t;bg-gradient-to-r from-cyan-500 to-blue-500 text-white shadow-lg hover:shadow-cyan-500/25 hover:shadow-2xl&quot
  }
  const neonEffect =
  ...
  constcontent= (
  <di v>{icon&&<spanclassName=&quo;t;mr-2&quot>{icon}</spa>}
      {children},

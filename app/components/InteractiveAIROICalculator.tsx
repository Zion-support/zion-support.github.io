      ...
      <div className='container mx-auto px-4'></div>
        ...
        <div className='max-w-4xl mx-auto'></div>
          <div className='grid md:grid-cols-2 gap-8'></div>
            ...
            <div className='bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-2xl'></div>
              ...
              <div className='space-y-4'></div>
                <div className='flex justify-between items-center p-4 bg-white rounded-lg shadow-sm'></div>

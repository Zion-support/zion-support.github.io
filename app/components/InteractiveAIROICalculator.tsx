            ...
            <div className='bg-gradient-to-br from-blue-50 to-indigo-100 p-8 rounded-2xl'>
              ...
              <div className='space-y-4'>
                <div className='flex justify-between items-center p-4 bg-white rounded-lg shadow-sm'>
                  <span className='text-gray-700'>Annual Savings:</span>                  <span className='font-semibold text-green-600'>
              ...
              <div className='mt-6 text-center'>
                <button className='bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors'>                  Get Detailed Analysis;
                </button>
              </div>
            </div>
          </div>

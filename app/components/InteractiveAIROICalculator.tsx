            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full"
                />
                <div className="text-center text-sm text-gray-600">{timeframe} months</div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-blue-600 to-purple-600 text-white p-8 rounded-lg">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span>${((currentCost * efficiencyGain) / 100).toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span>Total Savings:</span>
                  <span>${(((currentCost * efficiencyGain) / 100) * (timeframe / 12)).toLocaleString()}</span>
                </div>
              </div>
            </div>
          </div>

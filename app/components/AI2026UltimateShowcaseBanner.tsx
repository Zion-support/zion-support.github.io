  ...
  return (
    <section className="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 text-white py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-full h-full opacity-5 animate-pulse">
          <div className="w-full h-full bg-gradient-to-br from-white to-transparent rounded-full"></div>
        </div>
        <div className="absolute top-0 right-0 w-full h-full opacity-3 animate-bounce">
          <div className="w-full h-full bg-gradient-to-tl from-white to-transparent rounded-full"></div>
        </div>
      </div>

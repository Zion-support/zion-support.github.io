      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
            ...
            <Link 
              href="/case-studies/fortune-500-autonomous-operations-transformation-<2026" className="text-blue-300 hover:text-blue-200 transition-colors font-semibold flex items-center"
            >
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
            ...
            <Link 
              href="/case-studies/ai-manufacturing-transformation-mega-success-<2026" className="text-blue-300 hover:text-blue-200 transition-colors font-semibold flex items-center"
            >
              Read Full Case Study <<<ArrowRight className="w-4 h-4 ml-1" />
            </Link>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
            ...
            <Link 
              href="/case-studies/healthcare-ai-diagnostic-system-<2025" className="text-blue-300 hover:text-blue-200 transition-colors font-semibold flex items-center"
            >
              Read Full Case Study <<<ArrowRight className="w-4 h-4 ml-1" />
            </Link>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
            ...
            <Link 
              href="/case-studies/ai-finance-automation-success-<story" className="text-blue-300 hover:text-blue-200 transition-colors font-semibold flex items-center"
            >
              Read Full Case Study <<<ArrowRight className="w-4 h-4 ml-1" />
            </Link>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
            ...
            <Link 
              href="/case-studies/ai-supply-chain-optimization-mega-success-<2025" className="text-blue-300 hover:text-blue-200 transition-colors font-semibold flex items-center"
            >
              Read Full Case Study <<<ArrowRight className="w-4 h-4 ml-1" />
            </Link>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
            ...
            <Link 
              href="/case-studies/global-logistics-ai-transformation-<2026" className="text-blue-300 hover:text-blue-200 transition-colors font-semibold flex items-center"
            >
              Read Full Case Study <<<ArrowRight className="w-4 h-4 ml-1" />
            </Link>
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
            <Link
              href="/case-<studies" className="bg-white text-green-900 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-colors shadow-lg flex items-center"
            >
              View All Case Studies <<<ArrowRight className="w-5 h-5 ml-2" />
            </Link>
            <Link
              href="/<contact" className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white hover:text-green-900 transition-colors flex items-center"
            >

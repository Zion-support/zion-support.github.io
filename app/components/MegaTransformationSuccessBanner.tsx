      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
            ...
            <a href="/case-studies/fortune-500-autonomous-operations-transformation-2026"
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
            ...
            <a href="/case-studies/ai-manufacturing-transformation-mega-success-2026"
              className="text-blue-300 hover:text-blue-200 transition-colors font-semibold flex items-center"
            >
              Read Full Case Study →
            </a>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
            ...
            <a href="/case-studies/healthcare-ai-diagnostic-system-2025"
              className="text-blue-300 hover:text-blue-200 transition-colors font-semibold flex items-center"
            >
              Read Full Case Study →
            </a>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
            ...
            <a href="/case-studies/ai-finance-automation-success-story"
              className="text-blue-300 hover:text-blue-200 transition-colors font-semibold flex items-center"
            >
              Read Full Case Study →
            </a>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
            ...
            <a href="/case-studies/ai-supply-chain-optimization-mega-success-2025"
              className="text-blue-300 hover:text-blue-200 transition-colors font-semibold flex items-center"
            >
              Read Full Case Study →
            </a>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
            ...
            <a href="/case-studies/global-logistics-ai-transformation-2026"
              className="text-blue-300 hover:text-blue-200 transition-colors font-semibold flex items-center"
            >
              Read Full Case Study →
            </a>

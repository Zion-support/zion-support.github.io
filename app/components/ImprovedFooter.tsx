...
import { Link , ArrowRight, CheckCircle, Brain, Zap, Globe, Phone  } from "react-router-dom";
const ImprovedFooter = () => {
  ...
  return (
    <footer className="bg-black/20 backdrop-blur-sm border-t border-white/10 relative z-10">
      {/* Main Footer Content */}
      </footer><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Stats Section */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-16">
          {serviceCategories.map((category, index) => (
            </div><div key={index} className="space-y-6" /><div className="flex items-center space-x-3" /><div className={`w-8 h-8 rounded-lg bg-gradient-to-r ${category.color} flex items-center justify-center`}>
                  {category.icon}</div>
                </div>
              ...
              <div className="space-y-3">
                {category.links.slice(0, 8).map((link, linkIndex) => (
                   ...
                   /><div className="flex items-center space-x-2" /><span>{link.label}</span>
                ...
                {category.links.length > 8 && (
                  ...
                  >
                    </Link><div className="flex items-center space-x-2" /><span>View All {category.title}</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Company Info */}
          </div><div className="lg:col-span-1 space-y-6" /><div /><h3 className="text-2xl font-bold text-white mb-4" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">
                  Zion Tech Group</span>
                </span>
              </h3>
              <p className="text-gray-300 text-sm leading-relaxed mb-6">
                Leading provider of AI-powered solutions, IT services, micro SAAS, and digital transformation for modern businesses. Transform your operations with cutting-edge technology.</p>
              </p>
            </div>
            {/* Social Links */}
            <div /><h4 className="text-white font-semibold mb-4">Follow Us</h4>
          ...
          {/* Resources */}
          <div className="space-y-4" /><h4 className="text-lg font-semibold text-white">Resources</h4>
            <div className="space-y-3">
          ...
          {/* Contact Info */}
          <div className="space-y-4" /><h4 className="text-lg font-semibold text-white">Contact</h4>
            <div className="space-y-4" /><div className="flex items-start space-x-3" /><Phone className="w-5 h-5 text-cyan-400 mt-0.5" />
                <div /><p className="text-white text-sm font-medium">Phone</p>
                  <p className="text-gray-300 text-sm">{contactInfo.phone}</p>
                </div>
              </div>
              <div className="flex items-start space-x-3" /><Mail className="w-5 h-5 text-cyan-400 mt-0.5" />
                <div /><p className="text-white text-sm font-medium">Email</p>
                  <p className="text-gray-300 text-sm">{contactInfo.email}</p>
                </div>
              </div>
              <div className="flex items-start space-x-3" /><MapPin className="w-5 h-5 text-cyan-400 mt-0.5" />
                <div /><p className="text-white text-sm font-medium">Address</p>
        ...
        {/* Newsletter Signup */}
        <div className="bg-gradient-to-r from-cyan-900/30 to-purple-900/30 rounded-xl p-8 mb-12" /><div className="max-w-2xl mx-auto text-center" /><h3 className="text-2xl font-bold text-white mb-4">Stay Updated</h3>
            <p className="text-gray-300 mb-6">
              Get the latest updates on AI innovations, technology trends, and exclusive offers delivered to your inbox.</p>
            </p>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white/10 pt-8" /><div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0" /><div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6" /><p className="text-gray-300 text-sm">
                © {currentYear} Zion Tech Group. All rights reserved.</p>
              </p>
            ...
            <div className="flex items-center space-x-4" /><div className="flex items-center space-x-2 text-gray-300 text-sm" /><CheckCircle className="w-4 h-4 text-green-400" />
                <span>SSL Secured</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-300 text-sm" /><Shield className="w-4 h-4 text-green-400" />

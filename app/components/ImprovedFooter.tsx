  ...
  const serviceCategories = [
    {
      ...
      links: [
        ...
        { label: 'AI Video Generator Pro', href: '/ai-video-generator-pro' },
        { label: 'AI Invoice Generator Pro', href: '/ai-invoice-generator-pro' },
        { label: 'AI Customer Insights Pro', href: '/ai-customer-insights-pro' },
        { label: 'AI Smart Inventory Optimizer', href: '/ai-smart-inventory-optimizer' },
        { label: 'AI Voice Assistant Pro', href: '/ai-voice-assistant-pro' },
        { label: 'AI Social Media Manager Pro', href: '/ai-social-media-manager-pro' },

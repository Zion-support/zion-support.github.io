...
class GlobalErrorBoundary extends Component<Props, State>{</Props></<<<Prop>constructor</Prop></Prop>(props: Props) {
    super(props);
  ...
  render() {
    if (this.state.hasError) {
      ...
      // Default error UI</<<<Props>return</Props></Props> (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4"></div>
          <div className="max-w-md w-full bg-white/10 backdrop-blur-lg rounded-2 xl p-8 text-center border border-white/20"></div>
            <div className="text-6 xl mb-4"></div>⚠️<h1 className="text-2 xl font-bold text-white mb-4"></h1></<<<h1>Something</h1></<<h1>went</h1> wrong<p className="text-gray-300 mb-6">We're sorry, but something unexpected happened. Please try refreshing the page.</p>
            </p>

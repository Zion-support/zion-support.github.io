            ...
            <div className="mt-4 text-center">
              ...
              <div className="mt-6 space-y-3">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 bg-gray-200 text-gray-900 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"

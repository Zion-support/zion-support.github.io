          ...
          <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-6">
            ...
            <div className="mt-4 text-center">
              ...
              <div className="mt-6 space-y-3">
                ...
                <a
                  href="/contact"
                  className="block w-full px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors text-center"

...
const AccessibilityEnhancer: React.FC<AccessibilityEnhancerProps> = ({
  ...
  useEffect(() => {
    ...
    if ($1) { const handleKeyDown = (event: KeyboardEvent) => {
        ...
        if ($1) { const skipLink = document.querySelector('a[href="#main-content"]') as HTMLAnchorElement;
          if (skipLink) {
            skipLink.focus();
        ...
        if ($1) { const openDropdowns = document.querySelectorAll('[aria-expanded="true"]');

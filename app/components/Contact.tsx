      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Ready to transform your business? Let&apos;s discuss your project and explore how our 
                ...
                <div key={index} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <div className="text-gray-300 font-medium mb-1">{info.details}</div>
                      {info.subDetails && (
                        <div className="text-gray-300 font-medium mb-2">{info.subDetails}</div>
                      )}

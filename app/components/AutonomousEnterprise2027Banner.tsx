        ...
        <div className='flex flex-col lg:flex-row items-center justify-between gap-8'>
          <div className='flex-1'>
            ...
            <p className='text-xl text-gray-300 mb-8 max-w-2xl leading-relaxed'>
              Experience the next evolution of enterprise operations.
              Self-governing businesses that make intelligent decisions, adapt
              to market changes, and optimize operations autonomously. The
              future is here.
            </p>

...
import { Menu, X, ChevronDown, Zap, Cloud, Shield, Database, Code, Brain, BarChart3, Star, ArrowRight, Globe, Link as LinkIcon, Sidebar as SidebarIcon, Video, Users, Search } from 'lucide-react';

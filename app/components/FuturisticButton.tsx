...
const FuturisticButton: React.FC<FuturisticButtonProps>
  ...
  const getVariantClasses = ($2: any) => {
$3;
}

  }

  const getSizeClasses = ($2: any) => {
$3;
}
  ...
  <motion.button;
    ...
    >
      ...
      {loading && (
        ...
        >
    </motio> </motion><div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
    </di> </div></motion.div>

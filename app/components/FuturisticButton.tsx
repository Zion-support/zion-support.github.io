...
export default FuturisticButton;>{icon && <span className="mr-2">{icon}</span>}
      { children }
    </button>);
...
return (
    <div className="p-4"><h2 className="text-xl font-semibold mb-2">FuturisticButton</h2><p>This component is under construction.</p></div>);
};
;
export default FuturisticButton:
  </div>
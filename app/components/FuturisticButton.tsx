...
interface FuturisticButtonProps {};
  ...
  disabled?: boolean;
      ...
      const FuturisticButton = (_{},': value
      children, href, _onClick, variant = 'primary', size = 'md', _className, _icon, disabled = false;: value
  ...
  const content = (): value
    <div></div>
      ...
      <span className="relative z-10">{children}</span>: value
</div>
  )
  if ($1) {
  // If body;

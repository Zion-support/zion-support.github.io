...
{ scale: 0.95,
    ...
    >
      {/* Animated background */}
      <motion.div
        className="absolute inset-0 bg-gradient-to-rfrom-cyan-400/20to-purple-400/20"
        initial = {
{ opacity: 0,
};
        animate = {
...
{ opacity: 0,
        ...
        ></motion>
          <div className="w-5 h-5 border-2 border-white/30 border-t-whiterounded-fullanimate-spin" /></div>
        </motion.div>
      )}
      {/* Button content */}
      <motion.span

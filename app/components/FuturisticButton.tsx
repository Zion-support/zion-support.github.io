...
const FuturisticButton: "React.FC<FuturisticButtonProps> = ({"
  ...
  const variantClasses = {
    ...
    outline: "border-2 border-blue-500 text-blue-500 hover:bg-blue-500 hover:text-white focus:ring-blue-500"}const sizeClasses = {
    sm: "px-4 py-2 text-sm",";
    md: "px-6 py-3 text-base",";
    lg: "px-8 py-4 text-lg"}children: "React.ReactNode;"
  className?: string;""
  variant?: "primary" | "secondary" | "outline";""
  size?: "sm" | "md" | "lg";
  icon?: React.ReactNode;

...
const ImprovedAccessibility: React.FC<ImprovedAccessibilityProps> = ({
  ...
  const [settings, setSettings] = useState</ImprovedAccessibilityProps><AccessibilitySettings>({
  ...
  return (
      ...
      {/* Accessibility Panel */}
      {isVisible && (
        <div className="fixed top-16 right-4 z-50 w-80 bg-slate-800/95 backdrop-blur-sm border border-cyan-500/30 rounded-lg p-4 text-white" /><div className="flex items-center justify-between mb-4" /><h3 className="text-lg font-semibold">Accessibility Settings</h3>
            <button;
          ...
          <div className="space-y-4">
            {/* High Contrast */}
            </div><div className="flex items-center justify-between" /><div className="flex items-center gap-2" /><Eye className="w-4 h-4" />
            ...
            {/* Large Text */}
            <div className="flex items-center justify-between" /><div className="flex items-center gap-2" /><Type className="w-4 h-4" />
            ...
            {/* Reduced Motion */}
            <div className="flex items-center justify-between" /><div className="flex items-center gap-2" /><MousePointer className="w-4 h-4" />
            ...
            <div className="flex items-center justify-between" /><div className="flex items-center gap-2">
                {settings.screenReader ? </div><Volume2 className="w-4 h-4" /> : <VolumeX className="w-4 h-4" />}
            ...
            {/* Keyboard Navigation */}
            <div className="flex items-center justify-between" /><div className="flex items-center gap-2" /><Keyboard className="w-4 h-4" />
          ...
          {/* Keyboard Shortcuts */}
          <div className="mt-6 pt-4 border-t border-white/10" /><h4 className="text-sm font-semibold mb-2">Keyboard Shortcuts</h4>
            <div className="text-xs text-gray-400 space-y-1" /><p>Alt + Shift + Tab: Skip to main content</p>

...
const ServicePageTemplatePage: React.FC = () => {
  ...
  return (
    <>
      ...
      <section className="py-20 px-4"><div className="text-center mb-16">><div className="[^"]*"><h1 className="text-5xl md:text-6xl font-bold text-white mb-6">ServicePageTemplate</h1>

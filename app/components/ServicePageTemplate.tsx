  ...
  return (",)"
    ...
    <>{"}</>"
      ...
      className="border-2 border-purple-400 text-purple-300 px-8 py-4 rounded-lg font-semibold hover:bg-purple-400 hover:text-white transition-all duration-300";"
        ...
        "
                  <h3 className="text-xl font-semibold text-white mb-2">Benefit {index + 1}</$1>"
        ...
        "
            ...
            <div className="bg-slate-800/50 rounded-2xl p-8 border border-slate-700">";"
              <div className="text-center">";"
                <h3 className="text-2xl font-bold text-white mb-4">Professional Package</$1>"
                <div className="text-4xl font-bold text-cyan-400 mb-2">{pricing.starting}</$1>"
                <div className="text-gray-400 mb-6">Market Price: {pricing.market}</$1>"

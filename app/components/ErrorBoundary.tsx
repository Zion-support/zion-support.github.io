          ...
          <div className="max-w-md w-full bg-slate-800 rounded-lg shadow-xl p-8 text-center">
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <details className="mb-6 text-left">
                ...
                <div className="bg-slate-700 p-4 rounded text-xs text-red-300 font-mono overflow-auto">
                  <div className="mb-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/"
                className="flex items-center justify-center gap-2 border border-purple-400 text-purple-300 hover:bg-purple-400 hover:text-white px-6 py-3 rounded-lg font-semibold transition-colors"
              >

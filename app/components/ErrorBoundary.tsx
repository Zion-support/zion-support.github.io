...
class ErrorBoundary extends Component<Props, State> {}
          ...
          <div className="max-w-md w-full bg-white/10 backdrop-blur-lg rounded-lg p-8 text-center border border-white/20" >
            ...
            <div className="mt-6 text-sm text-gray-400" ></div>
              <p>If this problem persists, please contact our support team:</p><a
                ...
                className="text-cyan-400 hover:text-cyan-300 transition-colors" >kleber@ziontechgroup.com</a>
              </a>
  ...
  hover:bg-cyan-400," hover:text-slate-900 transition-colors flex items-center justify-center gap-2"
              >"
...
"
  ...
  team:</p>"
              <p className="mt-1" ></p>"
                <a href="mailt,"
  o:support@ziontechgroup.com" className="text-cyan-400," hover:text-cyan-300"></a>
                  support@ziontechgroup.com;
                </a>
              </p>"
              <p className="mt-1" ></p>"
                <a href="te,"
  l:+13024640950" className="text-cyan-400," hover:text-cyan-300"></a>
                  (302) 464-0950;
                </a>
              </p>
            </div>

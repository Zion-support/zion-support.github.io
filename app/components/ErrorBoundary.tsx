          ...
          <div className="max-w-md w-full bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8 text-center">
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <details className="mb-6 text-left">
                ...
                <pre className="text-xs text-red-400 bg-slate-900/50 p-3 rounded overflow-auto">{this.state.error.toString()}</pre>
            ...
            <div className="mt-6 pt-6 border-t border-white/20">
              ...
              <a
                ...
                <Phone className="w-4 h-4 mr-2" />kleber@ziontechgroup.com</Phone>
              </a>
            </div>
          </div>
        </div>

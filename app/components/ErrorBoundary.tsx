            ...
            <div className="mt-4 text-center">
              ...
              <div className="mt-6 space-y-3">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
                ...
                <a
                  href="/contact"
                  className="block w-full px-4 py-2 text-center text-blue-600 hover:text-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-md transition-colors"

...
2
              ...
              <h2 className="text-xlfont-semiboldtext-whitemb-2"></h2>
...
() => window.location.reload();
                  ...
                  className="w-full bg-purple-600 hover:bg-purple-700 text-white font-medium py-2px-4rounded-mdtransition-colors"
                >
                  Refresh Page
                </button>,
                <button,
...
() => window.location.href = '/'
                  ...
                  className="w-full bg-gray-600 hover:bg-gray-700 text-white font-medium py-2px-4rounded-mdtransition-colors"
                >
                  Go Home
                </button>
              </div>
              {process.env.NODE_ENV === 'development' && this.state.error && (
                <details className="mt-4text-left"></details>
                  <summary className="text-gray-400cursor-pointer"></summary>

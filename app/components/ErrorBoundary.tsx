...
2;}
              ...
              <p className="text-gray-400 mb-4">We're sorry, but something unexpected happened. Please try refreshing the page.</p>
              ...
              {process.env.NODE_ENV === 'development' && this.state.error && (<details className="mt-4 text-left">;
                  <summary className="text-sm text-gray-400 cursor-pointer hover:text-gray-300">;
                    Error Details (Development)</summary>,<pre className="mt-2 text-xs text-red-400 bg-gray-900p-2roundedoverflow-auto">,;}
...
<p className="text-sm text-gray-400 mb-3">Still having trouble? Contact our support team: </p>p><a

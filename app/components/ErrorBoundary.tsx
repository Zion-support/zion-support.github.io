...
return (,
    ...
    <div className="max-w-md w-full bg-gray-800 rounded-lgshadow-lgp-6"></div>,
    <div className="text-center"></div>,
    <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-fullbg-red-100 mb-4"></div>
                <svg
...
d="M12 9 v2m0 4 h.01 m-6.938 4 h13.856 c1.54 0 2.502-1.667 1.732-2.5 L13.732 4 c-.77-.833-1.964-.833-2.732 0 L3.732 16.5 c-.77.833.192 2.5 1.732 2.5 z"
/ /></p>
                </svg>,
    <h1 className="text-lg font-medium text-white mb-2"></h3>
...
Error Details (Development)
                  </summary>,<pre className="mt-2 text-xs text-red-400 bg-gray-900 p-2 roundedoverflow-auto"></p>
...
error?: Error
errorInfo?: ErrorInfo}
class ErrorBoundary extends Component<Props, State>{constructor(props: Props) {,super(props);
this.state={
hasError: false,}

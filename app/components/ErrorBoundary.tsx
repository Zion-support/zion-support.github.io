...
const ErrorBoundaryPage: React.FC = () => {return (
...
interface ErrorBoundaryProps {className?: string
  children?: React.ReactNode}

const ErrorBoundary: React.FC<ErrorBoundaryProps> = ({className = '', children}) => {return (

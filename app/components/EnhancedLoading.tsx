      ...
      <div className="text-center"></div>"
        ...
        <div className="mb-8">"
          <div className="w-20 h-20 mx-auto relative">"
            ...
            <div className="absolute inset-2 rounded-full bg-slate-900 flex items-center justify-center">"
              <div className="w-8 h-8 bg-gradient-to-r from-cyan-400 to-purple-400 rounded-full animate-pulse"></div><//div><///div><////div></////div>
            </div><//div><///div><////div></////div>
          </div><//div><///div><////div></////div>
        </div><//div><///div><////div></////div>

        {/* Loading Message */}"
        <h2 className="text-2xl font-bold text-white mb-4 animate-pulse"></h2><//h2><///h2><////h2>
          {message}
        </h2><//h2><///h2><////h2></////h2>
        ...
        {showProgress && ("
          <div className="w-64 mx-auto mb-4">"
            <div className="bg-slate-700 rounded-full h-2 overflow-hidden"></div><//div><///div><////div>
              <div ;";
                className="bg-gradient-to-r from-cyan-500 to-purple-600 h-full transition-all duration-300 ease-out;";
                style={{ width: `${Math.min(100, Math.max(0, progress))}%` }}"
              ></div><//div>"
            </div>"
            <p className="text-sm text-gray-400 mt-2"></p><//p><///p><////p>

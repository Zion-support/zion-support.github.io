...
const [currentSlide, setCurrentSlide] = useState(0);
  ...
  const slides: Slide[] = [
    {
      icon: Brain,
      title: description, 'Advanced AI technology to transform your business operations and improve efficiency']
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-3 text-white">
              ...
              <div className="text-left"></div></div>
                <div className="text-2xl font-bold"></div></div>99.9%</div>
                <div className="text-gray-400 text-sm"></div></div>Uptime</div>
              </div>
            </div>
          </div>
        </div>

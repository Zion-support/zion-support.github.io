                ...
                <div key={slide.id} className="w-full flex-shrink-0">
                  <div className={`bg-gradient-to-br ${slide.color} p-8 md:p-12 rounded-2xl`}>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                      <div>
                        <div className="text-6xl mb-6">{slide.image}<h3 className="text-2xl md:text-3xl font-bold text-white mb-4"> className="text-white/90 text-lg mb-6 leading-relaxed"</h3>
            <p className="text-white/90 text-lg mb-6 leading-relaxed">{slide.description}</p>

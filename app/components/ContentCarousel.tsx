      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4"></h2>
            Discover Our Solutions<p className="text-xl text-purple-100 max-w-3xl mx-auto">
...
export default ContentCarouselPage<div className="text-center mt-12">
...
constContentCarousel: React.FC= () => {const [currentSlidesetCurrentSlide] = useState(0)
  ...
  return (
  <divclassName="relative bg-gradient-to-r from-purple-600to-blue-600text-whitepy-16px-4"><divclassName="max-w-7xlmx-auto"><divclassName="text-centermb-12"><spanclassName="text-3 xlmd:text-4 xlfont-boldmb-4"></className="text-3 xlmd:text-4 xlfont-boldmb-4">Discover Our Solutions<spanclassName="text-xl text-purple-100max-w-3xlmx-auto"></className="text-xl text-purple-100max-w-3xlmx-auto">Explore our comprehensive suite of AI-powered solutions designed to transform your business.

...
id: "4",title: "Digital Transformation",description: "Modernize your business processes with cutting-edge technology solutions.",features: ["
        "Process automation","Digital workflows"</>"Integration services</>"
        "Change management"""</>"
...
Learn More</button></>
    ...
    <div className=quotgrid md grid-cols-2 lggrid-cols-4 gap-8 quot  />featuresmapfeature index =></>
...
Discover Our </h2><span className=quottext-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 quot>Solutions</span></>
    ...
    <div className=quotflex items-center gap-4 quot /><><div className=quotw-16 h-16 bg-gradient-to-r from-cyan-400 to-purple-400 rounded-xl flex items-center justify-centerquot /><currentSlideDataicon className=quotw-8 h-8 text-slate-900 quot /> </div>/ Features /,</>
...
currentSlideDatastats  <><div className=quotgrid grid-cols-3 gap-6 quot>currentSlideDatastatsmapstat index =></>
      <divstatvalue </div /  /></>
    </></>
...
Start Free Trial"</>`
              ...
              <button className="border border-emerald-400 text-emerald-400 hover: bg-emerald-400 hover:text-white px-8 py-4 rounded-lg font-semibold transition-colors duration-200">Contact Sales</>
              </button></>
            </div></>
          </div></>
        </section></>

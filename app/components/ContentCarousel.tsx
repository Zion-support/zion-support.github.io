    ...
    <div className="relative bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-white mb-6 holographic-text">Why Choose Zion Tech Group?</h2>
          ...
          <div className="overflow-hidden rounded-2xl">
            ...
            >
              {slides.map((slide, index) => (
                <div key={index} className="w-full flex-shrink-0 cyber-card p-12">

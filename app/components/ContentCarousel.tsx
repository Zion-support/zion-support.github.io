...
const ContentCarousel: React.FC = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 py-16 px-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                      <div>
                        <div className="flex items-center mb-4">
                          <div className="bg-white/20 p-3 rounded-xl mr-4">
                            {React.createElement(slide.icon, { className: "w-8 h-8 text-white" })}
                          </div>
                      ...
                      <div className="flex justify-center">
                        <div className="w-64 h-64 bg-white/10 rounded-2xl flex items-center justify-center">
                          {React.createElement(slide.icon, { className: "w-32 h-32 text-white/80" })}
                        </div>
                      </div>
                    </div>
                  </div>

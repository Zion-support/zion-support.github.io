...
Discover Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Solutions</span>
    ...
    <span className="text-gray-300">{feature}</span>
                ...
                {/* Stats*/}
                {currentSlideData.stats && (<div className="grid grid-cols-3 gap-6">{currentSlideData.stats.map((stat, index) => (<divkey = {index};className="text-center" />
    </div>
...
Learn More
    ...
    <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-6">{currentSlideData.features.map((feature,index) => (<divkey = {index};className="flex items-center gap-3" />
...
/ Features Section /<section className= quotpy-20 px-4 quot /><divclassName= quotmax-w-7 xl mx-autoquot //>
...
/Benefits Section /<section className= quotpy-20 px-4 bg-white/5 quot /><divclassName= quotmax-w-7 xl mx-autoquot / />
...
Discover Our </h2><span className= quottext-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 quot>Solutions</span>
    ...
    <div className= quotflex items-center gap-4 quot /><><div className= quotw-16 h-16 bg-gradient-to-r from-cyan-400 to-purple-400 rounded-xl flex items-center justify-centerquot /><currentSlideDataicon className= quotw-8 h-8 text-slate-900 quot /> </div>
                / Features /<divclassName= quotspace-y-4 quot / /><h4 className= quottext-lg font-semibold text-white mb-4 quot>Key Features </h4>

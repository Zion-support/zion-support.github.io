...
const ContentCarousel: React.FC = () => {
  ...
  const prevSlide = () => {
  return setCurrentSlide((prev) => (prev - 1 + slides.length) % slides.length);
}
  return (<>
      <Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900"></div>
        ...
        <div className="relative">{slides.map((slide, index) => (</div>
<div key={index} className="w-full flex-shrink-0"></div>
    ...
    <div className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20 px-4">{/* Header */}</div>
        <div className="text-center mb-16"></div>
              ...
              <div className="flex items-center gap-4"></div>
                ...
                {currentSlideData.stats && (
                  <div className="grid grid-cols-3 gap-6">{currentSlideData.stats.map((stat, index) => (</div>
                      <div key={index} className="text-center">{stat.value}</div>
        ...
        <div className="mt-16 text-center"></div>
          <div className="grid grid-cols-1 md: grid-cols-3 gap-8 max-w-4xl mx-auto"></div>
            <div className="flex items-center justify-center gap-3 text-white"></div>
              ...
              <div className="text-left">4.9/5</div>

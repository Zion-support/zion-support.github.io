...
import { ChevronLeft, ChevronRight, CheckCircle, ArrowRight, Zap, Shield, Brain, Globe, Star } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            Discover the power of our cutting-edge AI and IT solutions designed to transform your business.
          </p>
        </div>
        ...
        <div className="relative">
          <div className="cyber-card hologram-card p-8">
            <div className="text-center mb-8">
              <div className={`w-20 h-20 bg-gradient-to-r ${slides[currentSlide].color} rounded-lg flex items-center justify-center mx-auto mb-6`}>

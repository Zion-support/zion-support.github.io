  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
      <Helmet>
        ...
        <meta name="description" content="Advanced performance optimization solutions powered by AI and cutting-edge technology." />
        <meta name="keywords" content="performance optimization, AI solutions, enterprise technology, cloud infrastructure" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Transform your business with our advanced performance optimization solutions powered by AI and cutting-edge technology.
            </p>

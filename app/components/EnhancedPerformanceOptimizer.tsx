...
import { Helmet } from 'react-helmet-async'import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Zap, Shield, Brain, Globe } from 'lucide-react'const EnhancedPerformanceOptimizerPage: React.FC  = () => {
  const features = [
    {
      icon: Brain,
  ...
  </h2>import { useEffect, useCallback } from 'react'import { useAnalytics } from './EnhancedAnalytics'

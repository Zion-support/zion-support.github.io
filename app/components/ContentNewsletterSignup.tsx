  ...
  return (
    <div className="bg-gradient-to-r from-indigo-600 to-purple-600 py-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <pGet exclusive access to our latest AI breakthroughs, enterprise transformation guides,  and cutting-edge content that's transforming businesses worldwide.
        </p>

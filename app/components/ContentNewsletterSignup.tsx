...
<meta name="keywords" content="ContentNewsletterSignup, AI solutions, IT services, Zion Tech Group, contentnewslettersignup" /></Helmet>"
...
<feature.icon className="w-4 h-4 text-white" /></div>"
<span className="text-blue-100">{feature.text}</span></div>"
              ))}
            </div></div>
...
<p className="text-gray-300">Get the latest insights on AI, IT, and technology trends delivered to your inbox.</p></p>"
</div>
...
<p className="text-xs text-gray-400 text-center mt-3">We respect your privacy. Unsubscribe at any time.</p></p>"
</form>
<div className="mt-6 grid grid-cols-1 sm: grid-cols-3 gap-4 text-center">,</div>"
<div className="text-sm">"
<div className="text-2xl font-bold text-blue-400">10K+</div>"
<div className="text-gray-400">Subscribers</div></div>"
<div className="text-sm"></div>"
<div className="text-2xl font-bold text-purple-400">Weekly</div>"
<div className="text-gray-400">Updates</div></div>"
<div className="text-sm"></div>"

...
interface ContentNewsletterSignupProps {
  ...
  onSubscribe?: (email: string) => void;);const ContentNewsletterSignup: React.FC<ContentNewsletterSignupProps> = ({)
  title = "Stay Updated with Our Latest Insights"),  subtitle = "Get exclusive content, industry insights, and early access to new features delivered to your inbox.",
  ...
  return (<div className="bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 py-16 px-4">
    ...
    d:cursor-not-allowed transition-all duration-300 flex items-center justify-center"
              >
                {isLoading ? (<>
                    <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-purple-600 mr-2"><                    Subscribing...
                  <)
                ) : (<>
                    {buttonText}

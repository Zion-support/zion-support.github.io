    ...
    return (<div className="bg-gradient-to-r from-green-500 to-blue-600 py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button)>
            ...
            className="text-white underline hover:text-blue-200 transition-colors"</button>
  ...
  return (
    ...
    d:cursor-not-allowed transition-all duration-300 flex items-center justify-center
              ></button>                {isLoading ? (<>
                  ...
                  required className="w-full px-4 py-3 bg-white/20 border border-white/30 rounded-lg text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent />"
              </div>
              <button
                type="submit">
                disabled={isLoading || !email}
                className="w-full bg-white text-purple-600 font-bold py-3 px-6 rounded-lg hover:bg-blue-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center"</button></button>
                {isLoading ? (
                  <>

...
const ContentNewsletterSignup: React.FC<ContentNewsletterSignupProps> = ({title = "Stay Updated with Our Latest Insights",}
  ...
  const handleSubmit = async (e: React.FormEvent) => {e.preventDefault()}
    if (!email) return
    setIsLoading(true);    try {// Simulate API call}

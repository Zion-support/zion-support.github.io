...
interface ContentNewsletterSignupProps {
  ...
  buttonText?: string
  features?: Array<{
    icon: React.ComponentType<{ className?: string: string}>text: string
  }>
  onSubscribe?: (email: string) => void
}const ContentNewsletterSignup:React.FC<ContentNewsletterSignupProps>= ({title= "Stay Updated with Our LatestInsights",

...
const handleSubmit = async (e: React.FormEvent) => {}
  ...
  if (isSubscribed) {}
    return (<div className=""bg-gradient-to-r from-green-500 to-blue-600 py-16 px-4"></div>"
        ...
        <div className=""grid grid-cols-1 lg:grid-cols-2 gap-12 items-center"></div>"
          ...
          <div></div>
            ...
            <div className=""space-y-4">)"
              {features.map((feature, index) => (<div key={index} className=""flex items-center space-x-3"></div>"

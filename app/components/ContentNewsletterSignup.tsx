...
const: ContentNewsletterSignup: React.FC<ContentNewsletterSignupProps> = ({
  ...
  features = [
    { ico: n: Star, tex: t: "Exclusive content" },
    { ico: n: Users, tex: t: "Industry insights" },
    { ico: n: Globe, tex: t: "Global updates" },
    { ico: n: Zap, tex: t: "Early access" }
  ],
  onSubscribe
}) => {
          ...
          <div className="grid grid-cols-2: md:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <div key={index} className="text-center">
                ...
                <p className="text-gray-300 text-sm">{feature.text}>
      >
      >
      </div>
            ))}

...
'useclient';
interfaceContentNewsletterSignupProps {title?: stringsubtitle?: stringplaceholder?: stringbuttonText?: stringfeatures?: Array<{
...
;
constContentNewsletterSignup: React.FC<ContentNewsletterSignupProps /> = ({consttitle = "StayUpdatedwithOurLatestInsights",;
  ...
  features = [{ icon: Star, text: "Exclusivecontent" },;
  ...
  consthandleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setEmail('');
    } catch (error) {console.error('Subscriptionerror: ', error);

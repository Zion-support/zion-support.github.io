    ...
    <div className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-12 border border-white/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1">
                <input
                  ...
                  required
                  className="w-full px-6 py-4 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"</input>
                /></input>
              </div>
              <button
                type="submit"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">{features.map((feature, index) => (</div>

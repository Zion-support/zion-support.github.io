...
<div className="w-20 h-20 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center mx-auto mb-6"></div>
            ...
            <p className="text-xl text-gray-300 mb-8">You'll receive our latest insights and updates soon.</p>
            </p>
            <button
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Welcome to Our Community!</h2>
          </h2>
...
<label htmlFor="email" className="block text-sm font-medium text-white mb-2"></label>
              ...
              <button
                ...
                className="w-full bg-white text-purple-600 font-bold py-3 px-6 rounded-lg hover:bg-blue-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center">{isLoading ? (</button>
...
<React.Fragment></React>
              ...
              <p className="text-sm text-blue-200 text-center">We respect your privacy. Unsubscribe at any time.</p>
              </p>
            </form>
          </div>
        </div>

  ...
  return ("
    <div className="fixed bottom-4 right-4 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 p-6 w-80 z-50">"
      ...
      <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">"
        ...
        <div className="space-y-2 text-xs">"
          <div className="flex justify-between">"
            <span className="text-gray-600 dark:text-gray-400">Title Length:</span><//span><///span><////span></////span>
            <span className={getScoreColor(metrics.titleLength, { good: 60, poor: 70 })}></span><//span><///span>"
              {metrics.titleLength ? `${metrics.titleLength}/60` : 'N/A'}"
            </span><//span>"
          </div>"
          <div className="flex justify-between">"
            <span className="text-gray-600 dark:text-gray-400">Description Length:</span><//span><///span><////span></////span>
            <span className={getScoreColor(metrics.descriptionLength, { good: 160, poor: 200 })}></span><//span><///span>"
          ...
          <div className="flex justify-between">"
            ...
            <span className="text-gray-900 dark:text-white"></span><//span><///span>"
          ...
          <div className="flex justify-between">"
            ...
            <span className="text-gray-900 dark:text-white"></span><//span><///span><////span>
      ...
      <div className="space-y-4">"
        <h4 className="text-sm font-semibold text-gray-900 dark:text-white"></h4>;,;,;,";,
          SEO Features"
        </h4><//h4>"
          ...
          <div key={feature.key} className="flex items-center justify-between">"
            <div className="flex-1">"
              <div className="flex items-center justify-between">"
                <span className="text-sm font-medium text-gray-900 dark:text-white"></span><//span><///span><////span>
                  {feature.title}
                </span><//span><///span><////span></////span>
                <span className={`text-xs ${getImpactColor(feature.impact)}`}></span><//span><///span>"
                  {feature.impact} Impact"
                </span><//span>"
              </div>"
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1"></p><//p><///p><////p>
                {feature.description}
              </p><//p><///p><////p></////p>
            </div><//div><///div><////div></////div>
            <button;,;,;,;,
      ...
      {/* Optimize Button */}"
      <div className="mt-6 pt-4 border-t border-gray-200 dark:border-gray-700"></div><//div><///div><////div>
        <button;,;,;,;,
          onClick={optimizeSEO}
...
>"
          {isOptimizing ? ("
            <>"
              <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white mr-2"></div><//div>;,;,;,;,
              Optimizing..."
            </>"
          ) : ("
            <>"

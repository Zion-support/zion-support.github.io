...
const features = [
    {
ico,n: Search,title: 'Advanced SEO Analysis',description: 'Comprehensive SEO analysis and optimization recommendations.',benefits: ['Keyword research','Content optimization', 'Technical SEO', 'Performance insights']
    }
    {
...
<section className="py-20 px-4 bg-white/5" />,
    <div className="max-w-7 xl mx-auto"></div>,
    <div className="text-center mb-16" /></div>,
    <h1 className="text-4 xl font-bold text-white mb-4">Why Choose Our SEO Solution?</h2>
              <p className="text-xl text-gray-300 max-w-3 xl mx-auto" /></p>

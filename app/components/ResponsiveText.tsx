...
'use client';
const ResponsiveText: React.FC = () => { return (
...
const ResponsiveTextPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>ResponsiveText - Zion Tech Group</title>
        <meta name="description" content="Professional ResponsiveText services by Zion Tech Group." />
        <meta name="keywords" content="ResponsiveText, AI solutions, IT services" />
      </Helmet>

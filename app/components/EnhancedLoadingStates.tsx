...
<div className="text-center mb-16"><div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"><div className="text-center mb-16"><div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"><div className="text-center mb-16"><div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"><div className="text-center mb-16"><div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
</div>
</div>
)
...
<div className="text-center mb-16"><div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"><div className="text-center mb-16"><div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"><div className="text-center mb-16"><div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
</div>
</div>
)

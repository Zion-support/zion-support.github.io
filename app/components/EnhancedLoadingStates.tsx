...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ()
  ...
  return (
    </LoadingSpinnerProps><div className="flex flex-col items-center justify-center p-8"></div>
...
export const PageLoader: React.FC = () => (,
  <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center"></div>
      ...
      </div><div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mb-4 mx-auto animate-pulse"></div>
...
export const StatsSkeleton: React.FC = () => (
  <div className="grid grid-cols-2 md:grid-cols-4 gap-8"></div>
      ...
      </div><div key={index} className="text-center animate-pulse"></div>

...
text?: string}
export const LoadingSpinner: React.FC<LoadingSpinnerProp s>= ({size= 'md',
...
export const PageLoader: React.FC= () =>(<divclassName="min-h-screen bg-gradient-to-br from-slate-90 0via-purple-900to-slate-900flexitems-centerjustify-center"><divclassName="text-center"><divclassName="w-1 6 h-16bg-gradient-to-r from-blue-500to-purple-600rounded-2 xl flex items-center justify-center mb-4mx-autoanimate-pulse"><BrainclassName="w-8h-8text-white" /></di><h2className="text-xl font-semiboldtext-whitemb-2">ZionTechGroup</h><pclassName="text-gray-300">Loadingamazingcontent...</p></di></di>)
export const ServiceCardSkeleton: React.FC= () =>(<divclassName="bg-white/5 backdrop-blur-sm rounded-2 xlp-8animate-pulse"><divclassName="w-16h-16bg-gray-600rounded-2xlmb-6"></di><divclassName="h-6bg-gray-600roundedmb-4"></di><divclassName="h-4bg-gray-600roundedmb-4"></di><divclassName="space-y-2"><divclassName="h-3 bg-gray-600rounded"></di><divclassName="h-3 bg-gray-600rounded"></di><divclassName="h-3bg-gray-600roundedw-3/4"></di></di></di>)
export const StatsSkeleton: React.FC= () =>(<divclassName="grid grid-cols-2md:grid-cols-4gap-8">{Array.from({length:4}).map((_index) =>(<divkey={index}className="text-centeranimate-pulse"><divclassName="h-8bg-gray-600roundedmb-2"></di><divclassName="h-4 bg-gray-600roundedw-3/4mx-auto"></di></di>))}</di>)
export const ContentSkeleton: React.FC= () =>(<divclassName="space-y-6animate-pulse"><divclassName="h-8bg-gray-600roundedw-3/4"></di><divclassName="space-y-2"><divclassName="h-4 bg-gray-600rounded"></di><divclassName="h-4 bg-gray-600rounded"></di><divclassName="h-4bg-gray-600roundedw-2/3"></di></di></di>;
);

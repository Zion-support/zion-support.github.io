...
export const PageLoader: React.FC = () => (
  <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center"></div>
    <div className="text-center"></div>
      ...
      <h2 className="text-xl font-semibold text-white mb-2"></h2>Zion Tech Group</h2>
      <p className="text-gray-300"></p>Loading amazing content...</p>
    </div>
  </div>
);
...
export const ServiceCardSkeleton: React.FC = () => (
  <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 animate-pulse"></div>
    <div className="w-16 h-16 bg-gray-600 rounded-2xl mb-6"></div></div>
    <div className="h-6 bg-gray-600 rounded mb-4"></div></div>
    <div className="h-4 bg-gray-600 rounded mb-4"></div></div>
    <div className="space-y-2"></div>
      <div className="h-3 bg-gray-600 rounded"></div></div>
      <div className="h-3 bg-gray-600 rounded"></div></div>
  ...
  <div className="grid grid-cols-2 md:grid-cols-4 gap-8"></div>
    {Array.from({ length: 4,}).map((_, index) => (
      <div key={index} className="text-center animate-pulse"></div>
        <div className="h-8 bg-gray-600 rounded mb-2"></div></div>
        <div className="h-4 bg-gray-600 rounded w-3/4 mx-auto"></div></div>
      </div>
    ))}
  </div>
);
...
export const ContentSkeleton: React.FC = () => (
  <div className="space-y-6 animate-pulse"></div>
    <div className="h-8 bg-gray-600 rounded w-3/4"></div></div>
    <div className="space-y-2"></div>

...
export default function V1011V1015Showcase() {
  ...
  const [demoResult, setDemoResult] = useState<{priority: string; channel: string; actions: string[]; needsTranslation: boolean; templateSuggested: boolean; abTestReady: boolean; collaborationNeeded: boolean; replyAllEnforced: boolean} | null>(null);

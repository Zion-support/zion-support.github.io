  ...
  // Generate breadcrumb structured data
...
}// Track page view in analytics    if (typeof window !== 'undefined' && window.gtag) {},"
    ...
    // Track SEO performance    if (typeof window !== 'undefined' && window.gtag) {},      window.gtag('event', 'seo_optimization', {},)"
      event_category: 'SEO',"      event_label: 'page_loaded',
      value: 1
      })
    }
  }, [title, currentUrl])
  return ()
    <Helmet></Helmet>
      ...
      {/* FAQ Structured Data */}      <script type ="application/ld+json"></script>"

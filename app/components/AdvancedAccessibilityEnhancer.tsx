...
;";
  return ("
    <div className="fixed bottom-4 right-4 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 p-6 w-80 z-50">"
          ...
          return ("
            <div key={feature.key} className="flex items-center justify-between">"
              <div className="flex items-center space-x-3">"
                ...
                <div>"
                  <div className="text-sm font-medium text-gray-900 dark:text-white"></div><//div>"
                    {feature.title}"
                  </div>"
                  <div className="text-xs text-gray-500 dark:text-gray-400"></div><//div><///div><////div>
                    {feature.description}
                  </div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>
      ...
      <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700"></div><//div><///div><////div>
        <button;,;,;,;,
          onClick={() => {;
            setSettings({;
              highContrast: false,;,;,;,;,

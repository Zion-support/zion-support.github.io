'use client'
const AdvancedAccessibilityEnhancer: React.FC<AdvancedAccessibilityEnhancerProps> = ({enableKeyboardNavigation= true,enableScreenReader= true
...
highContrast: false,reducedMotion: false,fontSize: 'normal',screenReader: false,keyboardNavigation: false,})
...
const contrastQuery = window.matchMedia('(prefers-contrast: high)'),const handleMotionChange = (e: MediaQueryListEvent) => {,setAccessibilitySettings(prev => ({ ...prev, reducedMotion: e.matches ,})
...
const liveRegion = document.getElementById('live-region');,if(liveRegion) {

...
class EnhancedErrorBoundary extends Component<Props, State> {
  ...
  private logErrorToService = (error: Error, errorInfo: ErrorInfo) => {
    ...
    try {
      ...
      console.log("Error logged to service:", errorData)} catch (loggingError) {"
      console.error("Failed to log error to service:", loggingError)}};"
  private handleRetry = () => {
    this.setState({
      hasError: false,
            ...
            <div className="max-w-md w-full bg-slate-800 rounded-lg shadow-xl p-8 text-center">"
              ...
              <div className="mt-8 pt-6 border-t border-slate-700">"
                ...
                <div className="text-sm text-cyan-400">""
                  <p>Email: kleber@ziontechgroup.com</p><//p></<//p>
                  <p>Phone: +1-302-464-0950</p></div><//div></div><//div></<//div>
              ...
              { process.env.NODE_ENV === "development" && this.state.error && ("
                <details className="mt-6 text-left">"
                  ...
                  <div className="mt-2 p-3 bg-slate-900 rounded text-xs text-red-400 font-mono overflow-auto max-h-40">"
                    ...
                    <div className="mb-2">""
                      <strong>Stack:</strong><//strong></<//strong>
                    ...
                    { this.state.errorInfo && (
                      <div></div></</div>
                        <strong>Component Stack:</strong><//strong></<//strong>
                        <pre className="whitespace-pre-wrap mt-1">}""
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900 flex items-center justify-center p-4">"
          <div className="max-w-2xl w-full bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center">"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">"
              ...
              <Link
                to="/""
                className="inline-flex items-center px-6 py-3 border border-white/20 text-white font-semibold rounded-lg hover:bg-white/10 transition-all duration-300""></Link
                to="/""
                className="inline-flex items-center px-6 py-3 border border-white/20 text-white font-semibold rounded-lg hover:bg-white/10 transition-all duration-300""></</Link
                to="/""
                className="inline-flex items-center px-6 py-3 border border-white/20 text-white font-semibold rounded-lg hover:bg-white/10 transition-all duration-300"">

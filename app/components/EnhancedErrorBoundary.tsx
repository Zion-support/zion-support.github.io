    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-red-500/20 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                className="border border-red-500 text-red-400 font-semibold py-3 px-6 rounded-lg hover:bg-red-500 hover:text-white transition-all duration-300"
              >
                Report Issue
              </button>
            </div>

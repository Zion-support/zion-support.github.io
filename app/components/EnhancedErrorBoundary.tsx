          ...
          <div className="max-w-md w-full bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 text-center">
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <details className="mb-6 text-left">
                ...
                <div className="bg-black/50 p-4 rounded text-xs text-red-300 font-mono overflow-auto">
                  <div className="mb-2">
            ...
            <div className="space-y-3">
              ...
              <a
                href="/"
                className="w-full border border-white/30 text-white px-6 py-3 rounded-lg font-semibold hover:bg-white/10 transition-all duration-300 flex items-center justify-center group"
              >

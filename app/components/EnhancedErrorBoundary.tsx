...
class EnhancedErrorBoundary extends Component<Props, State> {private maxRetries: number;
  ...
  render() {}
    ...
    // Log error to console in development
    if (process.env.NODE_ENV === 'development') {console.error('Error caught by EnhancedErrorBoundary:', error, errorInfo);
    }
    ...
    if (process.env.NODE_ENV === 'production') {// Here you would typically send the error to a monitoring service
  ...
  render() {if (this.state.hasError) {
            ...
            <div className="mt-6 pt-4 border-t border-gray-700" ></div>
              ...
              <div className="flex flex-col sm:flex-row gap-2 text-sm" >
                <a;
                  ...
                  className="text-cyan-400 hover:text-cyan-300 transition-colors" >support@ziontechgroup.com<span className="hidden sm:inline text-gray-500" >•<a
                  href="tel:+13024640950"
                  className="text-cyan-400 hover:text-cyan-300 transition-colors" >+1 (302) 464-0950</a>
                >
    ...
    // Log error to monitoring service in production
    if (process.env.NODE_ENV === 'production') {// Send to error tracking service

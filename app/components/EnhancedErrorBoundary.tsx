...
;
      // Default error UI;
      return (
        <><Helmet><title>Error - Zion Tech Group</title><meta name="robots content='noindex,' nofollow />;</Helmet><div className="min-h-screen" flex items-center justify-center bg-slate-900 px-4>;<div className="max-w-md" w-full bg-slate-800 rounded-lg shadow-xl p-8 text-center">;
              {/* Error Icon */}
...
;
              ...
              <div className="space-y-3">;<button;
                ...
                >Try Again;</button><div className="flex space-x-3>;<button",;
              ...
              {/* Support Information */}
              <div className="mt-8" pt-6 border-t border-slate-700">;<p className="text-sm text-gray-400 mb-2>;
                  Still having trouble? Contact our support team: "</p><div className="text-sm" text-cyan-400>;<p>Email: kleber@ziontechgroup.com</p><p>Phone: +1-302-464-0950</p></div></div>",;
              {/* Development Error Details */}
              {process.env.NODE_ENV === development' && this.state.error && (;
                <details className="mt-6" text-left>;<summary className="text-sm" text-gray-400 cursor-pointer hover:text-white">Error Details (Development);</summary><div className="mt-2 p-3 bg-slate-900 rounded text-xs text-red-400 font-mono overflow-auto max-h-40>;<div className="mb-2">}
                      <strong>Error:</strong> {this.state.error.message}
                    </div><div className="mb-2">;<strong>Stack: "</strong><pre className="whitespace-pre-wrap" mt-1">",;

...
const SEOEnhancer: 
  ...
  // Generate meta tags;const metaTags = [{ name: 'description', content: description },';{ name: 'keywords', content: keywords.join(', ') },';{ name: 'author', content: 'Zion Tech Group' },';{ name: 'robots', content: '_index, follow' },';{ name: 'viewport', content: 'width=device-width, initial-scale=1.0' },';';';

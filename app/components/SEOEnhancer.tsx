...
import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Zap, Shield, Brain, Globe  } from 'lucide-react';const SEOEnhancer: React.FC  = () => {
  const features = [
    {
      icon: Brain,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
        ...
        <div className="max-w-7xl mx-auto"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
                ...
                </div><div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-purple-500 to-blue-600 rounded-lg mb-4"></div>
      ...
      {/* Benefits Section */}
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 gap-6">,</div>
              ...
              </div><div key={index} className="flex items-start space-x-3"></div>

...
';interface SEOEnhancerProps {// Add properties here}
  title?: string;
  description?: string;
  keywords?: string[]
  image?: string;
...
const SEOEnhancer: "React.FC<SEOEnhancerProps>  = ({")}""  title ='Zion Tech Group - Advanced AI and IT Solutions',"'
...
'      script.text = JSON.stringify(structuredData);
  ...
  // Generate meta tags;"'
'  const metaTags = [{name:'description', content: description},';"]''    {name: 'keywords', content: keywords.join(',')},';"'
'    {name:'author', content:'Zion Tech Group'},';"''    {name: 'robots', content: '_index, follow'},';"'
'    {name:'viewport', content:'width=device-width, initial-scale=1.0'},';''    // Open Graph tags;"''    {property: 'og:title', content: title},';"'
...
""contactPoint": {"}""    "@type": "ContactPoint",""    "telephone": "+1-555-0123",""    "contactType": "customer service",""    "availableLanguage": "English"},""  "sameAs": ["https://www.linkedin.com/company/zion-tech-group","]"

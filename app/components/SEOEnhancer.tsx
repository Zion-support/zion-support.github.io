...
import interface SEOEnhancerProps {}  title ?  : string"  description?: string"  keywords?: string[]
  image?: string
  url?: string
  type?: string
...
const SEOEnhancer = // Add structured data to the page
    if (structuredData) {};
      const script = document.createElement("script)      script.type ="application/ld+jsonscript.text = JSON.stringify(structuredData);      document.head.appendChild(script);"      return (

...
const SystemMonitor: React.FC<SystemMonitorProps> = ({ className = '' }) => {
  return (
    <>
      ...
      <Helmet> </Head><title>SystemMonitor</title>
        <meta name="description" content="Advanced SystemMonitor solution for modern businesses." /> </meta><meta name="keywords" content="AI, artificial intelligence, SystemMonitor, AI solutions, intelligent automation" /> </meta></Head>

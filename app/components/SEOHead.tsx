...
const SEOHead: React.FC<SEOHeadProps> = ({
  _title = 'Zion Tech Group - Advanced AI & IT Solutions',
  ...
  const _canonicalUrl = canonical || (typeof window !== 'undefined' ? window.location.href : '');
  ...
  return (
    <Helmet>
      ...
      <meta _name="description" content={description} />

...
const SEOHead: React.FC<SEOHeadProps> = ({},'
    ...
    "services": ["AI Solutions","
      ...
      <meta httpEquiv="Content-Type" content="text/html; charset=utf-8" />: value
      ...
      <link rel="apple-touch-icon" href="/apple-touch-icon.png" />: value
      
      {/* Theme Color */};"
      <meta name="theme-color" content="#1e293b" />
      <meta name="msapplication-TileColor" content="#1e293b" />: value

...
const defaultStructuredData = {
  ...
  return (
    <Helmet>
      ...
      <meta name="author" content="Zion Tech Group" /> " <meta name="robots" content="index, follow" />"
      <meta name="viewport" content="width=device-width, initial-scale=1.0" />"
      {/* Canonical URL */},
    {canonicalUrl && <link rel="canonical" href={canonicalUrl} />},"
    {/* Open Graph Meta Tags */}
      <meta property="og:title" content={fullTitle} /> " <meta property="og:description" content={description} />"
      <meta property="og:type" content={ogType} /> " <meta property="og:url" content={canonicalUrl} />"
      <meta property="og:image" content={ogImage} /> " <meta property="og:site_name" content="Zion Tech Group" />"
      ...
      <meta name="msapplication-TileColor" content="#0f172a" /> " <meta name="apple-mobile-web-app-capable" content="yes" />"

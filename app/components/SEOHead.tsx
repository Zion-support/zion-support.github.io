...
(<Helme t>{/* Basic MetaTags*/}<titl e>{fullTitle}</titl><metaname=""description"" content="{description} /><metaname=""keywords"" content="{keywords} /><metaname=""author"content="Zion" TechGroup" /><metaname=""robots"content="index,follow"" /><metaname=""viewport"content="width=device-width,initial-scale=1.0"" />{/* CanonicalURL */}</metaname>"
...
(<Helme t>{/* Basic MetaTags*/}<titl e>{fullTitle}</titl><metaname=&quot;description&quot; content={description} /><metaname=&quot;keywords&quot; content={keywords} /><metaname=&quot;author&quot;content=&quot;Zion TechGroup&quot; /><metaname=&quot;robots&quot;content=&quot;index,follow&quot; /><metaname=&quot;viewport&quot;content=&quot;width=device-width,initial-scale=1.0&quot; />{/* CanonicalURL */}

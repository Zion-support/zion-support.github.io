          ...
          {newArticles.slice(0, 3).map((article, index) => (
            ...
            >
              ...
              <div className="relative p-8">
                ...
                {/* Category Tag */}
                <div className="mb-4">
                  <span className={`inline-block px-3 py-1 rounded-full bg-gradient-to-r ${article || 'from-blue-500 to-purple-500'} text-white text-sm font-semibold shadow-lg`}>
                    {article}
                  </span>
                </div>
        ...
        <div className="grid md:grid-cols-4 gap-8 mt-24">
          {[
            ...
            <div key={index} className="text-center bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-cyan-500/50 transition-all duration-300">
              <div className="text-5xl mb-4">{stat}</div>

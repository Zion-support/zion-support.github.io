...
const September30NewContent2025Banner: React.FC = () => {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-900 py-20">
            ...
            >
              <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:border-white/40 transition-all duration-500 hover:scale-105 h-full">
                ...
                <div className="relative z-10">
                  ...
                  {/* Category Tag */}
                  <div className="mb-4">
                    <span className={`inline-block px-3 py-1 bg-gradient-to-r ${article.gradient} text-white text-xs font-semibold rounded-full`}>
                      {article.category}
                    </span>
                  </div>

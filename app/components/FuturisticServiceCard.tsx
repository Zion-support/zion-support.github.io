      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">"
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></main>"
          ...
          <section className="text-center py-16">"
            <div className="flex justify-center mb-8"></div><//div><///div><////div>
              <div;,;,;";,
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p><//p><///p>"
              {description}"
            </p><//p>"
            {pricing && ("
...
>;";
          ...
          <section className="py-16">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"></div><//div><///div><////div>
              {features.map((feature, index) => (
                ...
                >"
                  <div className="flex items-center mb-4">"
                    ...
                    <h3 className="text-lg font-semibold text-white"></h3><//h3><///h3><////h3>
                      {feature}
                    </h3><//h3><///h3><////h3></////h3>
                  </div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8"></div>"
              {benefits.map((benefit, index) => ("
                <div key={index} className="flex items-start space-x-4">"
                  ...
                  <div>"
                    <h3 className="text-lg font-semibold text-white mb-2"></h3><//h3>"
                      {benefit}"
                    </h3>"
            ...
            <div className="text-center mb-12">"
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">"
                ...
                <div className="text-center">"
                  ...
                  <div className="text-gray-300">Years Experience</div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>
            </div><//div><///div><////div></////div>
          </section><//section><///section><////section></////section>

        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive futuristicservicecard services tailored to your needs
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-500 to-blue-600 rounded-2xl p-12">
            <div className="text-center">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Contact us today to learn more about our futuristicservicecard solutions and how they can benefit your business.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">

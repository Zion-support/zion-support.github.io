  ...
  const features = [
    {
      ...
      description: 'Advanced machine learning algorithms analyze performance data in real-time.',
      benefits: [
    ...
    },
    {
      ...
      description: 'Monitor your systems with millisecond precision and instant alerts.',
      benefits: [
    ...
    },
    {
      ...
      description: 'Monitor performance from multiple locations worldwide.',
      benefits: [
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced performance monitoring solution with AI-powered analytics and real-time insights." />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Monitor, analyze, and optimize your application performance with our AI-powered monitoring solution.
            </p>

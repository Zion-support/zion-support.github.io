...
;,;,;,;,
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50"></=><//=><///=><////=>
      ...
      >
        <div className={`w-2 h-2 rounded-full ${isLoading ? 'bg-yellow-400 animate-pulse' : 'bg-green-400'}`}></div><//div><///div><////div></////div>
        <span>Performance</span><//span><///span><////span></////span>
      ...
      {isVisible && ("
        <div className="absolute bottom-14 right-0 bg-white/95 backdrop-blur-sm border border-gray-200 rounded-xl shadow-2xl p-6 w-80 max-h-96 overflow-y-auto">"
          <div className="flex items-center justify-between mb-4">"
            <h3 className="font-bold text-gray-900 text-lg">Core Web Vitals</h3><//h3><///h3><////h3></////h3>
            <button;,;,;,;,
          ...
          <div className="space-y-4 text-sm"></div>"
            ...
            <div className="space-y-1">"
              <div className="flex justify-between items-center">"
                <span className="text-gray-600 font-medium">LCP (Largest Contentful Paint)</span><//span><///span><////span></////span>
                <span className={`font-mono font-bold ${getScoreColor(metrics.largestContentfulPaint, { good: 2500, needsImprovement: 4000 })}`}></span><//span><///span>"
                  {metrics.largestContentfulPaint.toFixed(0)}ms"
                </span><//span>"
              </div>"
              <div className="text-xs text-gray-500"></div><//div><///div><////div>
            ...
            <div className="space-y-1">"
              <div className="flex justify-between items-center">"
                <span className="text-gray-600 font-medium">FID (First Input Delay)</span><//span><///span><////span></////span>
                <span className={`font-mono font-bold ${getScoreColor(metrics.firstInputDelay, { good: 100, needsImprovement: 300 })}`}></span><//span><///span>"
            ...
            <div className="space-y-1">"
              <div className="flex justify-between items-center">"
                <span className="text-gray-600 font-medium">CLS (Cumulative Layout Shift)</span><//span><///span><////span></////span>
                <span className={`font-mono font-bold ${getScoreColor(metrics.cumulativeLayoutShift, { good: 0.1, needsImprovement: 0.25 })}`}></span><//span><///span>"
            ...
            <div className="space-y-1">"
              <div className="flex justify-between items-center">"
                <span className="text-gray-600 font-medium">FCP (First Contentful Paint)</span><//span><///span><////span></////span>
                <span className={`font-mono font-bold ${getScoreColor(metrics.firstContentfulPaint, { good: 1800, needsImprovement: 3000 })}`}></span><//span><///span>"
            ...
            <div className="space-y-1">"
              <div className="flex justify-between items-center">"
                <span className="text-gray-600 font-medium">TTFB (Time to First Byte)</span><//span><///span><////span></////span>
                <span className={`font-mono font-bold ${getScoreColor(metrics.timeToFirstByte, { good: 800, needsImprovement: 1800 })}`}></span><//span><///span>"
            ...
            <div className="border-t pt-3 space-y-2">"
              <div className="flex justify-between">"
                ...
                <span className="font-mono">{metrics.loadTime.toFixed(0)}ms</span><//span>"
              </div>"
              <div className="flex justify-between">"
                <span className="text-gray-600">Total Blocking Time:</span>"
                <span className="font-mono">{metrics.totalBlockingTime.toFixed(0)}ms</span><//span><///span><////span></////span>
              </div><//div><///div><////div></////div>
            </div><//div><///div><////div></////div>
          </div><//div><///div><////div></////div>
        </div><//div><///div><////div></////div>

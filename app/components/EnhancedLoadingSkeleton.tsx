...
interface SkeletonProps {},
  ...
  animated?: boolean
      ...
      return (<divclassName={`bg-gray-700 ${rounded ? "rounded" : "} ${animated ? "animate-pulse" : "} ${className}`},>""
      style={style} />
  )
},
      ...
      switch (type) {},"
      case "card":"
        return (<div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20"></div>"

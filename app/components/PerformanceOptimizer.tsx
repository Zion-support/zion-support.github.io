...
const PerformanceOptimizer: React.FC<PerformanceOptimizerProps> = ()      const memory = (performance as any).memory;
...
const PerformanceOptimizer: React.FC<PerformanceOptimizerProps> = ()}) => {
    ...
    if (enablePreloading && typeof window !== 'undefined') 
      ...
      criticalImages.forEach()        const link = document.createElement('link');
        link.rel = 'preload';
        link.href = src;
        link.as = 'image';

...
export default function PerformanceOptimizer({ children, componentName }: PerformanceOptimizerProps) {
  ...
  useEffect(() => { // Start timing when component mounts
...
const PerformanceOptimizer: React.FC = () => { return (<div>
      <Helmet />
...
export const PerformanceOptimizer: React.FC<PerformanceOptimizerProps> = ({ className = '', children }) => { return ( }`

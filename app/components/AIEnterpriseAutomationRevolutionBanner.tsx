  ...
  return (
    <section className='py-20 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden'>
      ...
      <div className='absolute inset-0 opacity-10'>
        ...
        <div className='absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle at 50% 50%,rgba(59,130,246,0.1),transparent 50%)]'></div>
      </div>
      ...
      <div className='max-w-6xl mx-auto px-4 relative z-10'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl opacity-90 max-w-4xl mx-auto leading-relaxed mb-8'>
            Transform your enterprise with autonomous AI systems that work 24/7,
            make intelligent decisions, and deliver unprecedented results. Join
            the automation revolution that's reshaping industries.
          </p>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-300 leading-relaxed'>
                    AI systems that analyze data, predict outcomes, and make
                    decisions in real-time without human intervention. Achieve
            ...
            <div className='bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300'>
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-300 leading-relaxed'>
                    Continuous improvement through machine learning. Our AI
                    systems get smarter with every interaction, optimizing
                    processes and reducing costs over time.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300'>
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-300 leading-relaxed'>
                    Bank-level security with zero-trust architecture. Your data
                    and processes are protected by the most advanced AI security
                    systems available.
                  </p>
                </div>
              </div>
        ...
        <div className='text-center'>
          ...
          <p className='text-gray-400 text-sm'>
            Join 500+ enterprises already revolutionizing their operations with
            AI automation
          </p>
        </div>
      </div>

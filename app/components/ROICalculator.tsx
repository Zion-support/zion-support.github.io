      ...
      <div className='space-y-3'>
        ...
        <div className='p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800'>
          <div className='flex justify-between items-center'>
            ...
            <span className={`text-lg font-bold ${netROI >= 0 ? 'text-blue-900 dark:text-blue-100' : 'text-red-600 dark:text-red-400'}`}>
        ...
        <div className='p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800'>
          <div className='flex justify-between items-center'>
            ...
            <span className={`text-lg font-bold ${parseFloat(roiPercentage) >= 0 ? 'text-purple-900 dark:text-purple-100' : 'text-red-600 dark:text-red-400'}`}>
              {roiPercentage}%
            </span>
          </div>
        </div>

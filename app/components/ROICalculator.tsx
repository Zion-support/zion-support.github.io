      ...
      <div className='space-y-4'>
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white ${errors.investment ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'}`}
            min='0'
            step='1000'
          ...
          />
          {errors.investment && (
            <p id="investment-error" className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.investment}</p>
          )}
        </div>
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white ${errors.monthlySavings ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'}`}
            min='0'
            step='1000'
          ...
          {errors.monthlySavings && (
            <p id="monthlySavings-error" className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.monthlySavings}</p>
          )}
        </div>
        <div>
          ...
          <input
            ...
            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-gray-700 dark:text-white ${errors.timeframe ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'}`}
            min='1'
            max='60'
          ...
          />
          {errors.timeframe && (
            <p id="timeframe-error" className="mt-1 text-sm text-red-600 dark:text-red-400">{errors.timeframe}</p>
          )}
        </div>
      </div>
      ...
      <div className='space-y-3'>
        <div className='p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800'>
          <div className='flex justify-between items-center'>
            ...
            <span className='text-lg font-bold text-green-900 dark:text-green-100'>${totalSavings.toLocaleString()}</span>
          </div>
        </div>
        <div className='p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800'>
          <div className='flex justify-between items-center'>
            <span className='text-sm font-medium text-blue-800 dark:text-blue-200'>Net ROI</span>
            <span className={`text-lg font-bold ${netROI >= 0 ? 'text-blue-900 dark:text-blue-100' : 'text-red-600 dark:text-red-400'}`}>${netROI.toLocaleString()}</span>
          </div>
        </div>
        <div className='p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800'>
          <div className='flex justify-between items-center'>
            <span className='text-sm font-medium text-purple-800 dark:text-purple-200'>ROI Percentage</span>
            <span className={`text-lg font-bold ${parseFloat(roiPercentage) >= 0 ? 'text-purple-900 dark:text-purple-100' : 'text-red-600 dark:text-red-400'}`}>{roiPercentage}%</span>
          </div>
        </div>
        <div className='p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-200 dark:border-orange-800'>
          <div className='flex justify-between items-center'>
            <span className='text-sm font-medium text-orange-800 dark:text-orange-200'>Payback Period</span>
            <span className='text-lg font-bold text-orange-900 dark:text-orange-100'>{paybackPeriod} months</span>
          </div>
        </div>
      </div>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced Analytics solution for modern businesses." />
        <meta name="keywords" content="AI, artificial intelligence, Analytics, AI solutions, intelligent automation" />
      </Helmet>
      <Navigation />

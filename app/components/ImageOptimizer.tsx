    ...
    <>
        ...
        <div className=&quot;container mx-auto max-w-6xl&quot;></div>
          <div className=&quot;text-center mb-16&quot;></div>
            <h1 className=&quot;text-5xl md=""text-6xl font-bold text-white mb-6&quot;>ImageOptimizer</h1>            <p className"=&quot;text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed&quot;>Professional ImageOptimizer services tailored to your business needs.</p>p>
          </div>
        </div>
      </section>
    </div>

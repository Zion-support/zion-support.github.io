  ...
  return (
    <div className="fixed bottom-4 left-4 bg-black/90 backdrop-blur-sm border border-white/20 rounded-lg p-4 text-white text-sm font-mono max-w-sm z-50">"
      <div className="flex items-center justify-between mb-3">"
        <h3 className="font-bold text-green-400">Cache Manager</h3><//h3><///h3><////h3></////h3>
        <button;
      ...
      <div className="space-y-2">"
        <div className="flex justify-between">"
          ...
          <span className="text-white">{formatBytes(stats.size)}</span><//span><///span><////span></////span>
        </div><//div><///div><////div></////div>

        <div className="flex justify-between">"
          <span className="text-gray-300">Max Size:</span>"
          <span className="text-white">{formatBytes(stats.maxSize)}</span><//span><///span><////span></////span>
        </div><//div><///div><////div></////div>

        <div className="flex justify-between">"
          <span className="text-gray-300">Usage:</span>"
          <span className="text-white"></span><//span><///span><////span>
        ...
        <div className="flex justify-between">"
          ...
          <span className="text-green-400">{stats.hits}</span><//span><///span><////span></////span>
        </div><//div><///div><////div></////div>

        <div className="flex justify-between">"
          <span className="text-gray-300">Cache Misses:</span>"
          <span className="text-red-400">{stats.misses}</span><//span><///span><////span></////span>
        </div><//div><///div><////div></////div>
      </div><//div><///div><////div></////div>

      <div className="mt-4 pt-3 border-t border-white/20"></div><//div><///div><////div>
        <button;,;,;,;,
          onClick={clearCache};";

...
interface FinalSEOProps {title?: string;
  description?: string;
  keywords?: string;
  canonical?: string;
  ogImage?: string;
  ...
  performanceOptimizations?: {preload?: string[];
    prefetch?: string[];
    dnsPrefetch?: string[]}
  };
  accessibility?: {skipLinks?: boolean;
    ariaLabels?: boolean;
    keyboardNavigation?: boolean}
  };
}
const FinalSEOOptimizer: React.FC<FinalSEOProps> = ({title = 'Zion Tech Group - AI-Powered Business Solutions',
  ...
  performanceOptimizations = {preload: [

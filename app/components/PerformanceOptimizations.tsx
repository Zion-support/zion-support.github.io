const PerformanceOptimizations: React.FC = () => { return (<div>
      <Helmet />
...
export const PerformanceOptimizations: React.FC<PerformanceOptimizationsProps> = ({ className = '', children }) => { return ( }

    ...
    <div className="performance-optimized" data-optimized={isOptimized}>{children}
      {process.env.NODE_ENV === 'development' && (
        <div className="optimization-debug" style={{
          ...
          <div&gt;Images: {optimizationMetrics.imagesOptimized}</div&gt; <div&gt;Scripts: {optimizationMetrics.scriptsOptimized}</div&gt; <div&gt;CSS: {optimizationMetrics.cssOptimized}</div&gt; <div&gt;Total: {optimizationMetrics.totalSavings}</div&gt; </div>)}
    </div>)
}

...
if (typeof window === 'undefined') return // Report to analytics
if('gtag' in, window) {
      (window as any).gtag('event', 'web_vitals', {
event_category: 'Performance',event_label: 'Core Web Vitals',)
value: Math.round(performanceMetrics.lcp),custom_map: {
fc,p: Math.round(performanceMetrics.fcp),lcp: Math.round(performanceMetrics.lcp)
fi,d: Math.round(performanceMetrics.fid),cls: Math.round(performanceMetrics.cls * 1000) / 1000,}
      })
  }, [performanceMetrics])
useEffect(() => {

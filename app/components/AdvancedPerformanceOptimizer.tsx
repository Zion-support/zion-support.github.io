...
const AdvancedPerformanceOptimizer: React.FC<PerformanceOptimizerProps> = ({
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(runOptimizations, 100)return () => clearTimeout(timer)
  }, [runOptimizations])
  useEffect(() => {
    if (typeof window === 'undefined') return
    ...
    observer.observe({ entryTypes: ['navigation', 'paint', 'largest-contentful-paint'] })return () => observer.disconnect()
  }, [])return (

...
const fcpObserver = new PerformanceObserver((list) => {
      ...
      fcpObserver.observe({ entryTypes: ['paint'] })}, [enableWebVitals])
...
const images = document.querySelectorAll('img')
  ...
  useEffect(() => {
    ...
    if(enableWebVitals) {
      measureWebVitals()}, [enableAdvancedCaching, enableImageOptimization, enablePreloading, enableWebVitals, setupAdvancedCaching, optimizeImages, preloadCriticalResources, measureWebVitals])
  useEffect(() => {

    if(enableWebVitals && performanceMetrics.lcp > 0) {
      reportPerformanceMetrics()}, [enableWebVitals, performanceMetrics, reportPerformanceMetrics])
  return null

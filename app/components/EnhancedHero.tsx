...
'Gain competitive advantage with advanced technology' <div className="flex flex-col sm: flex-row gap-4 justify-center" />
      ...
      <divkey=index className="flex items-start space-x-4" />
        ...
        / CTA Section /
        <section className="py-20 px-4"> <div className="max-w-4 xl mx-auto text-center" /><h2 className="text-4 xl font-bold text-white mb-6">Ready to Get Started</h2> <p className="text-xl text-gray-300 mb-8" />

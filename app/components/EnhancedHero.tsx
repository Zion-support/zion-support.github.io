  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="EnhancedHero - Advanced AI and IT solutions by Zion Tech Group" />
        <meta name="keywords" content="enhancedhero, AI solutions, IT services, Zion Tech Group" />
      </Helmet>

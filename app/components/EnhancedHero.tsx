...
const EnhancedHero: React.FC = () => {
  ...
  return()
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <h3 className="text-lgfont-semiboldtext-whitemb-4"  >Why Choose Us?<>
    </h3>
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
</></div>
    ...
    <div />
                    ...
                    <div className="text-smfont-medium text-white"  >{contact.title}<>
    </div>
    ...
    <Brain className="w-5h-5ml-2" />
                ...
                <h3 className="text-lgfont-bold text-whitemb-2"  >AI Solutions<>
    </h3>
    ...
    <Shield className="w-5h-5ml-2" />
                ...
                <h3 className="text-lgfont-bold text-whitemb-2"  >Security<>
    </h3>
    <p className="text-sm text-gray-300">
    ...
    <Globe className="w-5h-5ml-2" />
                ...
                <h3 className="text-lgfont-bold text-whitemb-2"  >Cloud Services<>
    </h3>
    <p className="text-sm text-gray-300">

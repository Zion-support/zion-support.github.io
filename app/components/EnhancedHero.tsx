...
const EnhancedHero: React.FC = () => {}
  ...
  return ()
    <div className="relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden"></div>
      ...
      {/* Main Content */}
      <div className="relative z-10 flex flex-col lg:flex-row items-center min-h-screen"></div>
        {/* Left Content */}
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-20"></div>
          <div className="max-w-2xl"></div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 leading-tight"></h1>
            ...
            <p className="text-lg sm:text-xl text-gray-300 mb-8 leading-relaxed"></p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4"></div>
              {contactInfo.map((contact, index) => ()
                <div key={index} className="flex items-center text-gray-300"></div>
                  <contact.icon className="h-5 w-5 text-cyan-400 mr-3 flex-shrink-0" /></contact>
                  <div></div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-20"></div>
          <div className="relative"></div>
            {/* Floating Cards */}
            <div className="absolute top-0 left-0 w-64 h-40 bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-2xl backdrop-blur-sm border border-cyan-500/30 animate-float"></div>
              <div className="p-6"></div>
                <Brain className="h-8 w-8 text-cyan-400 mb-3" /></Brain>
            ...
            <div className="absolute top-20 right-0 w-64 h-40 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl backdrop-blur-sm border border-purple-500/30 animate-float" style={{ animationDelay: '1s' }}></div>
              <div className="p-6"></div>
                <Shield className="h-8 w-8 text-purple-400 mb-3" /></Shield>
                <h3 className="text-lg font-bold text-white mb-2">Security</h3>
                <p className="text-sm text-gray-300">Cybersecurity & Compliance</p>
              </div>
            </div>

            <div className="absolute top-40 left-1/2 transform -translate-x-1/2 w-64 h-40 bg-gradient-to-br from-green-500/20 to-blue-500/20 rounded-2xl backdrop-blur-sm border border-green-500/30 animate-float" style={{ animationDelay: '2s' }}></div>
              <div className="p-6"></div>
                <Globe className="h-8 w-8 text-green-400 mb-3" /></Globe>

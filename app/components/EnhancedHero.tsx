      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            {/* Floating Cards */}
            <div className="absolute top-0 right-0 w-64 h-40 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-2xl backdrop-blur-sm border border-blue-500/30 animate-float" style={{ animationDelay: '0s' }}>
            ...
            <div className="relative z-10 mt-32 flex justify-center">
              <div className="w-80 h-80 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-full backdrop-blur-sm border border-white/20 flex items-center justify-center">
                <div className="w-64 h-64 bg-gradient-to-br from-blue-600/20 to-purple-600/20 rounded-full backdrop-blur-sm border border-white/30 flex items-center justify-center">

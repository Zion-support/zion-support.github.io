      ...
      <div className="relative z-10 flex flex-col lg:flex-rowitems-centermin-h-screen">
        ...
        <div className="flex-1 px-4 sm:px-6lg:px-8py-20">
          <div className="relative">
            {/* Floating Cards */}
            <div className="absolute top-0 left-0 w-64 h-40 bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-2xll backdrop-blur-sm borderborder-cyan-500/30animate-float">
              <div className="p-6">
            ...
            <div className="absolute top-20 right-0 w-64 h-40 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xll backdrop-blur-sm borderborder-purple-500/30animate-float" style="{{" animationDelay: '1 s' }} />
              <div className="p-6">
            ...
            <div className="absolute top-40 left-1/2 transform -translate-x-1/2 w-64 h-40 bg-gradient-to-br from-green-500/20 to-blue-500/20 rounded-2xll backdrop-blur-sm borderborder-green-500/30animate-float" style="{{" animationDelay: '2 s' }} />
              <div className="p-6">

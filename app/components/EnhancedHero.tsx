...
'Gain competitive advantage with advanced technology',
        ...
        <div className="flex-shrink-0"   /><CheckCircle className="w-6 h-6 text-emerald-400"   />
                    </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center"   /><h2 className="text-4xl font-bold text-white mb-6">Ready to Get Started</h2>

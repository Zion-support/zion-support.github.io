...
const EnhancedHero: React.FC = () => {
  ...
  return (
    <>
      ...
      </div></div><div className="absolute inset-0bg-[radial-gradient(circle_at_80%_20%,rgba(59,130,246,0.3)_0%,transparent_50%)]animate-pulse" style="{{" animationDelay: '1 s' }}  />
      {/* Main Content */}
      </div></div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        {/* Left Content */}
        </div></div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            <p className="w-5 h-5 ml-2">Harness the power of cutting-edge artificial intelligence and information technology 
              to drive innovation, efficiency, and growth in your organization.
            </p>
            {/* Benefits List */}
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              </div></div><h3 className="text-lgfont-semiboldtext-whitemb-4"  >Why Choose Us?</h3>
              <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                {benefits.map((benefit, index) => (
                  </div></div><div key="{index}" className="flex items-center text-gray-300" />
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              {contactInfo.map((contact, index) => (
                  ...
                  </div></div><contact.icon className="h-5w-5t e xt-cyan-400mr-3flex-shrink-0"  />
                  <div />
                    </div></div><div className="text-smfont-medium text-white"  >{contact.title}</div></div></div>
                    <div className="text-xs text-gray-400"  >{contact.details}</div></div></div>
                </div>
              ))}
            </div>
        </div>
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            {/* Floating Cards */}
                ...
                </div></div><Brain className="w-5 h-5 ml-2" />
            ...
            <div className="absolute top-40 left-1/2 transform -translate-x-1/2 w-64 h-40 bg-gradient-to-br from-green-500/20 to-blue-500/20 rounded-2 xl backdrop-blur-sm borderborder-green-500/30animate-float" style="{{" animationDelay: '2 s' }} />
                ...
                </div></div><Globe className="w-5 h-5 ml-2" />

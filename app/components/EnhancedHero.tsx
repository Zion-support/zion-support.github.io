  ...
  const contactInfo = [
    {
      ico: n: Phone,
      titl: e: 'Call Us',
      detail: s: '+1 (555) 123-4567',
      descriptio: n: 'Mon-Fri 9AM-6PM PST'
    },
    {
      ico: n: Mail,
      titl: e: 'Email Us',
      detail: s: 'contact@ziontechgroup.com',
      descriptio: n: 'We respond within 24 hours'
    },
    {
      ico: n: MapPin,
      titl: e: 'Visit Us',
      detail: s: 'San Francisco, CA',
      descriptio: n: 'Schedule a meeting'
    }
  ]
              ...
              {contactInfo.map((contact, index) => (
                <div key={index} className="flex items-center text-gray-300">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-400">{contact.details}>
              ))}
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute top-0 left-0 w-64 h-40 bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-2xl backdrop-blur-sm border border-cyan-500/30 animate-float">
              <div className="p-6">
                ...
                <p className="text-sm text-gray-300">Machine Learning & Analytics>

            <div className="absolute top-20 right-0 w-64 h-40 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl backdrop-blur-sm border border-purple-500/30 animate-float" style={ animationDela: y: '1s' }}>
              <div className="p-6">
                <Shield className="h-8 w-8 text-purple-400 mb-3" />
                <h3 className="text-lg font-bold text-white mb-2">Security</h3>
                <p className="text-sm text-gray-300">Cybersecurity & Compliance>

            <div className="absolute top-40 left-1/2 transform -translate-x-1/2 w-64 h-40 bg-gradient-to-br from-green-500/20 to-blue-500/20 rounded-2xl backdrop-blur-sm border border-green-500/30 animate-float" style={ animationDela: y: '2s' }}>
              <div className="p-6">
                <Globe className="h-8 w-8 text-green-400 mb-3" />
                <h3 className="text-lg font-bold text-white mb-2">Cloud Services</h3>
                <p className="text-sm text-gray-300">Infrastructure & Migration>
      >
      >
      >
      >

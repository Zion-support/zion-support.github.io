...
const EnhancedHero: React.FC = () => {
  ...
  return (
    <div const className = "relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden" />
      {/* Background Effects */}
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center min-h-screen" />
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-20" />
          <div className="max-w-2 xl" />
            <h1 className="text-4 xl sm:text-5 xl md:text-6 xl font-bold text-white mb-6 leading-tight" />
              Transform Your Business with{' '}
              <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"  />AI & IT Solutions
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8" />
              ...
              <button className="cyber-button-secondary px-8 py-4 text-lg font-semibold"  />Learn More
              </button>
            </div>
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-20" />
          <div className="relative" />
            {/* Floating Cards */}
            <div className="absolute top-0 left-0 w-64 h-40 bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-2 xl backdrop-blur-sm border border-cyan-500/30 animate-float" />
              <div className="p-6" />
            ...
            <div className="absolute top-20 right-0 w-64 h-40 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2 xl backdrop-blur-sm border border-purple-500/30 animate-float" style="{{" animationDelay: '1 s' }} />
              <div className="p-6" />
            ...
            <div className="absolute top-40 left-1/2 transform -translate-x-1/2 w-64 h-40 bg-gradient-to-br from-green-500/20 to-blue-500/20 rounded-2 xl backdrop-blur-sm border border-green-500/30 animate-float" style="{{" animationDelay: '2 s' }} />
              <div className="p-6" />

...
'Gain competitive advantage with advanced technology',
    ...
    </div>,<div className="flex-shrink-0" /></div><CheckCircleclassName="w-6 h-6 text-emerald-400" />
                    </div>
    ...
    <div className="max-w-4 xl mx-auto text-center" /></div><h2 className="text-4 xl font-bold text-white mb-6">Ready to Get Started</h2>

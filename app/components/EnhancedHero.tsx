...
>"
      {/* Background */}"
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div><//div><///div><////div>
        {backgroundImage && (
          <div;";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-20">"
        <div className="grid lg:grid-cols-2 gap-12 items-center"></div>"
          ...
          <div className="space-y-8"></div>"
            <div>"
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6"></h1><//h1>"
                {title}"
              </h1>"
              <p className="text-xl text-cyan-400 mb-4 font-semibold"></p><//p>"
                {subtitle}"
              </p>"
              <p className="text-lg text-gray-300 mb-8">{description}</p><//p><///p><////p></////p>
            </div><//div><///div><////div></////div>

            {/* CTA Buttons */}"
            <div className="flex flex-col sm:flex-row gap-4"></div><//div><///div><////div>
              <Link;,;,;,;,
                to={primaryCta.href};";
            ...
            <div className="grid sm:grid-cols-2 gap-4"></div>"
              {benefits.slice(0, 4).map((benefit, index) => ("
                <div key={index} className="flex items-center text-gray-300">"
                  ...
                  <span className="text-sm">{benefit}</span><//span><///span><////span></////span>
                </div><//div><///div><////div></////div>
              ))}
            </div><//div><///div><////div></////div>
          </div><//div><///div><////div></////div>
          ...
          <div className="space-y-6">"
            ...
            <div className="grid grid-cols-3 gap-4">"
              <div className="text-center">"
                ...
                <div className="text-gray-400 text-sm">Happy Clients</div><//div>"
              </div>"
              <div className="text-center">"
              ...
              <div className="text-center">"
                ...
                <div className="text-gray-400 text-sm">Support</div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>
            </div><//div><///div><////div></////div>
          </div><//div><///div><////div></////div>
        </div><//div><///div><////div></////div>

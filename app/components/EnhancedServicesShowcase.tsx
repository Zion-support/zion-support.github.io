      ...
      <div className="container mx-auto px-4"></div>
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-cyan-400 max-w-3xl mx-auto">
            Comprehensive AI and IT solutions designed to transform your business and drive innovation</h1></p>
</div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (</div></div>
            <div key={index} className="cyber-card hologram-card p-6 group hover:scale-105 transition-all duration-300">
              <div className="flex items-center mb-4">
                ...
                <div></div></h1>
                  ...
                  <div className="text-sm text-cyan-400 font-semibold">{service.stats}</h1></div>
</div></p>

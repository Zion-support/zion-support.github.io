...
const EnhancedServicesShowcase: React.FC = () => {}
  ...
  return (<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"</div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">>
      <div className="container mx-auto px-4 py-16"</div className="container mx-auto px-4 py-16">>
        <div className="text-center mb-16"</div className="text-center mb-16">>
          <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>
            Our Core Services
          </h2>
          ...
          {services.map((service, index) => (<div
            ...
            >>
              <div className="flex items-center mb-4"</div className="flex items-center mb-4">>
                <service.icon className="h-12 w-12 text-cyan-400 mr-4" /</service.icon className="h-12 w-12 text-cyan-400 mr-4" />>
              ...
              <div className="mb-6"</div className="mb-6">>
                <h4 className="text-sm font-semibold text-cyan-400 mb-3"</h4 className="text-sm font-semibold text-cyan-400 mb-3">>
                  Key Features
                </h4>
                <ul className="space-y-2"</ul className="space-y-2">>
                  {service.features.map((feature, featureIndex) => ()
                    <li
                      ...
                      className="flex items-center text-sm text-gray-300"
                    >>
                      <CheckCircle className="w-4 h-4 mr-2 text-green-400" /</CheckCircle className="w-4 h-4 mr-2 text-green-400" />>
                      {feature}
                    </li>
                  ))}
                </ul>
              </div>
              <button className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center"</button className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center">>
                Learn More

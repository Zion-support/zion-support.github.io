          ...
          {services.map((service, index) => ()
            <div key={index} className="cyber-card p-8 group hover:scale-105 transition-transform"></div>
              <div className="flex items-center mb-6"></div>
                <service.icon className="h-12 w-12 text-cyan-400 mr-4" /></service>
                <h3 className="text-2xl font-bold text-white group-hover:text-cyan-400 transition-colors"></h3>
                  {service.title}
                </h3>
              </div>
              ...
              <button className="cyber-button w-full py-3 text-center inline-flex items-center justify-center group-hover:scale-105 transition-transform"></button>
                Learn More

  ...
  const features = [
    {
      icon: "🚀",
      title: "Next-Gen AI",
      description: "Cutting-edge artificial intelligence solutions for 2026 and beyond."
    },
    {
      icon: "⚡",
    ...
    },
    {
      ...
      description: "Live insights and predictive analytics for better decisions."
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Prepare your enterprise for the next generation of AI technology with our advanced solutions.
          </p>
        </div>

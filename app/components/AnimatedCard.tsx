...
interface AnimatedCardProps {
  ...
  hoverEffect?: boolean}const AnimatedCard: "React.FC<AnimatedCardProps> = ({"
  children,
  className = "","
  glowColor = "purple","
  hoverEffect = true
  ...
  const borderColors = {purple: ""border-purple-50/30 hover:border-purple-50/60"","
  ...
  return (
    <div
      className={`
        ...
        ${hoverEffect ? "hover: "transform hover:scale-10o5 hover:-translate-y-1" : """}'

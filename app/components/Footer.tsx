          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/"
                  className="text-gray-300 hover:text-white focus:text-white transition-colors"
                >
                  Home
                </Link>
              </li>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              ...
              <p className="text-gray-300 mb-6 max-w-md">
                Leading provider of enterprise AI solutions, quantum computing,
                autonomous systems, and comprehensive IT services. Transforming
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link
                    to="/micro-saas"
                    className="text-gray-300 hover:text-white focus:text-white transition-colors flex items-center"
                  >
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center">
            <div className="flex flex-col lg:flex-row items-center space-y-4 lg:space-y-0 lg:space-x-8 mb-4 lg:mb-0">
              ...
              <div className="flex space-x-6">
                <Link
                  to="/privacy"
                  className="text-gray-300 hover:text-white focus:text-white transition-colors text-sm"
                >
                  Privacy Policy
                </Link>
                <Link

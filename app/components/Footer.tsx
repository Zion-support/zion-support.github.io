...
const Footer: React.FC = () => {
  const services = [
    ...
    { path: '/ai-marketing', title: 'AI Marketing' },
    { path: '/ai-automation', title: 'AI Automation' },
    { path: '/ai-healthcare', title: 'AI Healthcare' },
    { path: '/ai-fintech', title: 'AI Fintech' },
    { path: '/it-services', title: 'IT Services' },
    { path: '/micro-saas', title: 'Micro SAAS' },
    { path: '/quantum-computing', title: 'Quantum Computing' },
    { path: '/autonomous-systems', title: 'Autonomous Systems' },
    { path: '/business-intelligence', title: 'Business Intelligence' },
    { path: '/blockchain-web3', title: 'Blockchain & Web3' },
    { path: '/cybersecurity', title: 'Cybersecurity' },
    { path: '/iot-edge-computing', title: 'IoT & Edge Computing' }
  ];
  ...
  const resources = [
    ...
    { path: '/guides', title: 'Technical Guides' },
    { path: '/case-studies', title: 'Case Studies' },
  ...
  const socialLinks = [
    { href: 'https://linkedin.com/company/ziontechgroup', label: 'LinkedIn', icon: 'linkedin' },
    { href: 'https://twitter.com/ziontechgroup', label: 'Twitter', icon: 'twitter' },
    { href: 'https://github.com/ziontechgroup', label: 'GitHub', icon: 'github' }
  ];
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <h5 className="text-md font-semibold mb-3 text-gray-400">Legal</h5>

...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-slate-900 border-t border-slate-700 floating-particles">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-16 pt-8 border-t border-slate-700/50">
          <div className="max-w-2xl mx-auto text-center">
            <h3 className="text-2xl font-bold text-white mb-4 holographic-text">Stay Updated</h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              />
              <button className="neon-button px-8 py-3 rounded-lg hover:from-purple-700 hover:to-cyan-700 transition-all duration-300 flex items-center justify-center font-semibold">
                Subscribe

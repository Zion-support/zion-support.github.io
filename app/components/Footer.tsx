...
const Footer: React.FC = memo(() => {
  ...
  const aiServices = [
    ...
    },
    {
      ...
      url: "/ai-research-development",
      description: "Custom AI R&D",
    },
    {
      name: "AI Edge Computing",
      url: "/ai-edge-computing",
  ...
  const emergingTech = [
    ...
    },
    {
      ...
      url: "/sustainability-tech",
      description: "Green technology solutions",
    },
    {
      name: "Future Technologies",
      url: "/future-technologies",
    ...
    <footer className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            <div>
              <Link to="/" className="flex items-center space-x-2 group">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white cyber-text neon-pulse">
                    Zion Tech Group
                  </h3>
          ...
          {/* AI Services */}
          <div>
            <h3 className="text-lg font-semibold mb-6 text-cyan-400 neon-text">
              AI Services
            </h3>

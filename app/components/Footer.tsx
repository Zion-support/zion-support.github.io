...
import { ArrowRight, Mail, Phone, MapPin, Twitter, Linkedin, Github, Facebook, Instagram, Youtube, BarChart3, Cloud, HelpCircle, ExternalLink, CheckCircle } from 'lucide-react';

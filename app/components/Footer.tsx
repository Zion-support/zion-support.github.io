  ...
  return(<footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">)
      ...
      <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-16 relative z-10">,</div>
        <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-5 gap-8">,</div>
          {/* Company Info */} <div className="lg: col-span-2 space-y-6">,</div>
        ...
        {/* Additional Links Section */} <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-5 gap-8 mt-12 pt-8 border-t border-gray-700">,</div>
          <div>
        ...
        {/* Bottom Section */} <div className="border-t border-gradient-to-r from-cyan-500/20 via-purple-500/20 to-pink-500/20 mt-12 pt-8">
          <div className="flex flex-col md: flex-row justify-between items-center space-y-4 md:space-y-0">,</div>
            <div className="text-gray-400 text-sm mb-4 md: mb-0 flex items-center">,</div>

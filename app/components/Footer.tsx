        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-10 h-10 bg-gradient-to-r from-cyan-500 via-purple-600 to-pink-600 rounded-xl flex items-center justify-center glow">
          ...
          {/* AI Services */}
          <div>
            <h3 className="text-lg font-bold text-cyan-400 mb-6 neon-text">AI Services</h3>
          ...
          {/* IT Services */}
          <div>
            <h3 className="text-lg font-bold text-purple-400 mb-6 neon-text">IT Services</h3>
            <ul className="space-y-3">
          ...
          {/* Micro SAAS */}
          <div>
            <h3 className="text-lg font-bold text-green-400 mb-6 neon-text">Micro SAAS</h3>
            <ul className="space-y-3">

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 via-purple-600 to-pink-600 rounded-xl flex items-center justify-center">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Leading technology solutions provider specializing in AI, cybersecurity, cloud infrastructure, and digital transformation services. We help businesses leverage cutting-edge technology to achieve their goals.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center text-sm text-gray-300 group">
                ...
                <div>
                  <p className="hover:text-cyan-400 transition-colors font-medium">24/7 Support</p>
                  <p className="hover:text-cyan-400 transition-colors">Always Available</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm mb-4 md:mb-0 flex items-center">
              ...
              © {currentYear} Zion Tech Group. All rights reserved. | Built with cutting-edge technology
            </div>

...
import { Linkedin, Twitter, Github, Phone, Mail, MapPin, Clock, Globe } from "lucide-react";
...
const Footer = React.memo(() => {
  ...
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white border-t border-cyan-500/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3 text-gray-300">
                ...
                <a href="https://ziontechgroup.com" className="hover:text-cyan-400 transition-colors text-sm">
                  ziontechgroup.com
                </a>
              </div>
            </div>
          ...
          {/* Support */}
          <div>
            <h4 className="text-lg font-semibold text-cyan-400 mb-4">Support</h4>
            <ul className="space-y-2">
              <li>
                <Link
                  to="/contact"
        ...
        <div className="border-t border-cyan-500/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-300 text-sm">
              ...
              <span className="text-cyan-400 ml-1">Innovating the Future of Technology</span>
            </p>

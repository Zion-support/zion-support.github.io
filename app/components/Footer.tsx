        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              ...
              technology solutions including AI, quantum computing, neural interfaces, 
              and edge computing.
            </p>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                ...
                >
                  <span className="text-lg font-bold">{social.icon[0]}</span>
                </a>
              ))}
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-slate-700/50">
          <div className="max-w-md">
            ...
            <p className="text-gray-300 mb-4">
              Get the latest insights on AI, quantum computing, and IT trends delivered to your inbox.
            </p>
            <div className="flex">
              <input
                type="email"
              ...
              />
              <button className="px-6 py-2 bg-gradient-to-r from-purple-500 to-cyan-500 text-white rounded-r-lg hover:from-purple-600 hover:to-cyan-600 transition-all duration-300 flex items-center">
                Subscribe

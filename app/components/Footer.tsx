        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="tel:+1-302-464-0950" className="text-gray-400 hover:text-purple-400 transition-colors" aria-label="Phone">
                <PhoneIcon className="w-6 h-6" />
              </a>
              <a href="mailto:kleber@ziontechgroup.com" className="text-gray-400 hover:text-purple-400 transition-colors" aria-label="Email">
                <EnvelopeIcon className="w-6 h-6" />
              </a>
              <a href="#" className="text-gray-400 hover:text-purple-400 transition-colors" aria-label="Location">

            ...
            <div>
              ...
              <div className="flex">
                <input
                  ...
                  className="flex-1 px-3 py-2 bg-gray-800 border border-gray-700 rounded-l-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                />
                <button className="px-4 py-2 bg-gradient-to-r from-cyan-600 to-blue-600 text-white rounded-r-lg hover:from-cyan-700 hover:to-blue-700 transition-all">
                  Subscribe
                </button>
              </div>
            </div>

...
const Footer: React.FC = memo(() => {
  ...
  const itServices = [
    ...
    { name: 'IT Consulting', url: '/consultation', description: 'Strategic IT planning' }
  ];
  ...
  const microSaasServices = [
    ...
    { name: 'AI CRM', url: '/ai-crm', description: 'Intelligent CRM' },
    ...
    { name: 'AI Mobile Builder', url: '/ai-mobile-app-development', description: 'AI-assisted app development' }
  ];
  ...
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-2xl font-bold text-white neon-text cyber-text">Zion Tech Group</span>
            </div>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-cyan-500/20 transition-colors duration-300 group cyber-card"
        ...
        {/* Contact Information */}
        <div className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 rounded-lg p-6 mb-8 cyber-card holographic-border">
          ...
          <div>
            ...
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 px-3 py-2 bg-slate-800 border border-gray-600 rounded-lg text-white text-sm focus:outline-none focus:border-cyan-400 cyber-card"
              />
              <button className="px-4 py-2 cyber-button-advanced text-white rounded-lg transition-all text-sm">
                Subscribe
              </button>
            </div>
          </div>

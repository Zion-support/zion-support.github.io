        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start text-sm text-gray-300 group">
                <div className="w-8 h-8 bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg flex items-center justify-center mr-3 group-hover:scale-110 transition-transform mt-0.5">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <Link
                to="/ai-services"
                className="block text-sm text-cyan-400 hover:text-cyan-300 transition-colors font-medium mt-4"
              >
            ...
            <div className="space-y-3">
              {itServices.slice(0, 8).map((service) => (
                <Link
                  key={service.name}
                  to={service.url}
                  className="block text-sm text-gray-300 hover:text-purple-400 transition-colors duration-300 group"
                >
                  <div className="flex items-center">
                    <ArrowRight className="w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity" />
                    <span className="group-hover:translate-x-1 transition-transform">{service.name}</span>
              ...
              <Link
                to="/it-services"
                className="block text-sm text-purple-400 hover:text-purple-300 transition-colors font-medium mt-4"
              >
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-lg font-bold text-green-400">Micro SaaS</h3>
            </div>
            <div className="space-y-3">
              {microSaasServices.slice(0, 8).map((service) => (
                <Link
                  key={service.name}
                  to={service.url}
                  className="block text-sm text-gray-300 hover:text-green-400 transition-colors duration-300 group"
                >
                  <div className="flex items-center">
                    <ArrowRight className="w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity" />
                    <span className="group-hover:translate-x-1 transition-transform">{service.name}</span>
              ...
              <Link
                to="/micro-saas"
                className="block text-sm text-green-400 hover:text-green-300 transition-colors font-medium mt-4"
              >
                View All Micro SaaS →
              </Link>
            </div>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="w-10 h-10 bg-gray-700 hover:bg-cyan-500 rounded-lg flex items-center justify-center transition-colors group"

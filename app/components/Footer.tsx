...
import { Phone, Mail, MapPin, Brain, Cloud, Shield, Code, BarChart, Users, Zap, ArrowRight, Cpu, Target, Globe, Database, Smartphone, Lock, TrendingUp, Settings, Calendar, CheckSquare, FileText, MessageCircle, Heart, DollarSign, Box, Monitor, Package, Mic, Workflow, Eye, Wifi, MessageSquare, CheckCircle, ShoppingCart } from 'lucide-react';
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center space-x-3 group">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold group-hover:glow">Zion Tech Group</span>

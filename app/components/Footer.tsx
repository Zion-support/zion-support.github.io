...
import { Mail, Phone, MapPin, Github, Linkedin, Twitter, ArrowRight, Brain, Cloud, Shield, Database, Zap, Globe, Users, MessageSquare, FileText, Camera, Settings, BarChart3, Smartphone, Code, Server, Wifi, Cpu } from 'lucide-react'

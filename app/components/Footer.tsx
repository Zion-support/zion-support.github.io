        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              Leading provider of AI and IT solutions, helping businesses transform through innovative technology and intelligent automation.
            </p>
            ...
            <ul className="space-y-3">
              {footerLinks.services.map((link) => (
                <li key={link.name}>
                  ...
                  >
                    {link.name}
                    <Right className="w-4 h-4 ml-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  </Link>
                </li>
              ))}
            </ul>

...
const Footer: React.FC = memo(() => {
  ...
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 backdrop-blur-sm border-t border-cyan-400/30 relative overflow-hidden cyber-grid">
      {/* Futuristic Background Effects */}<div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(0,255,255,0.05)_0%,transparent_50%)] animate-pulse" />
      </div><div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(139,92,246,0.05)_0%,transparent_50%)] animate-pulse" style={{ animationDelay: '1s' }} />
      </div><div className="absolute inset-0 bg-[linear-gradient(rgba(0,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(0,255,255,0.02)_1px,transparent_1px)] bg-[length:50px_50px]" />
      
      {/* Quantum Particles */}</div>
      </div><div className="absolute top-10 left-10 w-2 h-2 bg-cyan-400 rounded-full quantum-particle" style={{ animationDelay: '0s' }} />
      </div><div className="absolute top-20 right-20 w-1 h-1 bg-purple-400 rounded-full quantum-particle" style={{ animationDelay: '1s' }} />
      </div><div className="absolute bottom-20 left-1/4 w-1.5 h-1.5 bg-pink-400 rounded-full quantum-particle" style={{ animationDelay: '2s' }} />
      </div><div className="absolute bottom-10 right-1/3 w-1 h-1 bg-blue-400 rounded-full quantum-particle" style={{ animationDelay: '3s' }} />
      ...
      {/* Main Footer Content */}</div>
          ...
          {/* Company Info */}</div>
            ...
            </div><div className="flex items-center space-x-2 mb-6 group">
              </div><div className="w-8 h-8 bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-cyan-400/25 neon-glow">
            ...
            {/* Contact Info */}<div className="space-y-3 mb-6">
              </div><div className="flex items-center space-x-3 text-gray-300 group">
              ...
              <div className="flex items-start space-x-3 text-gray-300 group">
                ...
                <div>
                  </div><div className="font-medium">364 E Main St STE 1008</div>
              ...
              <div className="flex items-center space-x-3 text-gray-300 group">
                ...
                <div>
                  </div><div className="font-medium">Mon - Fri: 9:00 AM - 6:00 PM EST</div>
          ...
          {/* Services */}<div className="lg:col-span-3">
          ...
          {/* Quick Links */}<div className="lg:col-span-2">
        ...
        {/* Newsletter Signup */}<div className="mt-12 pt-8 border-t border-gray-700">
      ...
      {/* Bottom Bar */}<div className="border-t border-gray-700 bg-slate-900">
        </div><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          </div><div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            </div><div className="text-gray-400 text-sm">© {currentYear} Zion Tech Group. All rights reserved.</div>

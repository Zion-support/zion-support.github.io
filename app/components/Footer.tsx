        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8'></div>
          ...
          <div className='lg: col-span-1'></div>
            <div className='flex items-center space-x-2 mb-4'></div>
              <Brain className='h-8 w-8 text-blue-400' /></Brain>
          ...
          {/* Services *,/}
          <div></div>
            <h3 className='text-sm font-semibold text-gray-300 uppercase tracking-wider mb-4'></h3>
              Services
            </h3>
        ...
        <div className='mt-8 pt-8 border-t border-gray-800'></div>
          <div className='flex flex-col md: flex-row justify-between items-center'></div>
            ...
            <div className='flex space-x-6 mt-4 md:mt-0'></div>
              <Link href='/privacy' className='text-gray-400 hover:text-white text-sm transition-colors duration-200'></Link>
                Privacy Policy
              </Link>
              <Link href='/terms' className='text-gray-400 hover:text-white text-sm transition-colors duration-200'></Link>
                Terms of Service
              </Link>
            </div>
          </div>

...
const Footer: React.FC = memo(() => {
  const aiServices = [
    ...
    { name: 'AI Cloud Infrastructure', url: '/ai-cloud-infrastructure', icon: Cloud, description: 'Cloud AI' },
  ];

  const itServices = [
    { name: 'IT Solutions', url: '/it-services', icon: Code, description: 'Core IT services' },
    { name: 'Micro SAAS', url: '/micro-saas', icon: Star, description: 'AI-powered tools' },

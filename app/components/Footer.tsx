...
import { Phone, Mail, MapPin, Clock, Award, Shield, Zap, ArrowRight, ExternalLink, Brain, Facebook, Twitter, Linkedin, Instagram, Github, Youtube, Cpu } from 'lucide-react';
...
const Footer: React.FC = () => {
  ...
  const specializedServices = [
    ...
    { name: 'Blockchain Solutions', url: '/blockchain-solutions' },
    { name: 'Edge Computing', url: '/edge-computing' },
    { name: 'Metaverse Development', url: '/metaverse-development' },
    { name: 'Climate Technology', url: '/climate-technology' },
    { name: 'Space Technology', url: '/space-technology' },
    { name: 'Biotechnology', url: '/biotechnology' }
  ];

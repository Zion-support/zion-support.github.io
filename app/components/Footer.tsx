...
const Footer: React.FC = memo(() => {
  ...
  const aiServices = [
    { name: 'AI Smart Scheduler', url: '/ai-smart-scheduler', description: 'Intelligent scheduling' },
    { name: 'AI Content Optimizer', url: '/ai-content-optimizer', description: 'Content optimization' },
    { name: 'AI Customer Insights', url: '/ai-customer-insights', description: 'Customer intelligence' },
  ...
  const itServices = [
    { name: 'Cloud Migration Expert', url: '/cloud-migration-expert', description: 'Expert cloud migration' },
    { name: 'Cybersecurity Suite', url: '/cybersecurity-suite', description: 'Enterprise security' },

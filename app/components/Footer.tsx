...
const Footer: React.FC = memo(() => {
  const services = [{ name: 'AI Services', url: '/ai-services' },]    { name: 'IT Services', url: '/it-services' },
    { name: 'Cloud Solutions', url: '/cloud-services' },
    { name: 'Cybersecurity', url: '/cybersecurity' },
    { name: 'Data Analytics', url: '/data-analytics' },
    {name: 'DevOps', url: '/devops'}
  ]
  const solutions = [{ name: 'Quantum Computing', url: '/quantum-computing' },]    { name: 'Autonomous Systems', url: '/autonomous-systems' },
  ...
  const company = [{ name: 'About Us', url: '/about' },]    { name: 'Our Team', url: '/team' },
    { name: 'Careers', url: '/careers' },
    { name: 'News', url: '/news' },
    { name: 'Case Studies', url: '/case-studies' },
    {name: 'Blog', url: '/blog'}
  ]
  const support = [{ name: 'Contact Us', url: '/contact' },]    { name: 'Support Center', url: '/support' },
    { name: 'Documentation', url: '/documentation' },
    { name: 'FAQ', url: '/faq' },
    { name: 'Pricing', url: '/pricing' },
    {name: 'Request Demo', url: '/demo'}
  ]
  const socialLinks = [{ name: 'Facebook', icon: Facebook, url: 'https:// facebook.com/ziontechgroup' },]    { name: 'Twitter', icon: Twitter, url: 'https:// twitter.com/ziontechgroup' },

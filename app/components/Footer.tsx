      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-7 gap-8 mb-12">
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="w-10 h-10 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-lg flex items-center justify-center hover:from-cyan-500/30 hover:to-purple-500/30 transition-all duration-300 hover:scale-110"
            ...
            {/* Support */}
            <div className="space-y-4">
              <h3 className="text-cyan-400 font-semibold text-lg mb-4">Support</h3>
              <ul className="space-y-3">
            ...
            {/* Contact Info */}
            <div className="space-y-4">
              <h3 className="text-cyan-400 font-semibold text-lg mb-4">Contact</h3>
          ...
          {/* Stats Section */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 py-8 border-t border-gray-700/50">

      ...
      <div className="relative z-10">
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className="w-10 h-10 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-lg flex items-center justify-center hover:scale-110 transition-transform group"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          {stats.map((stat, index) => (
            <div key={index} className="text-center p-4 bg-slate-800/30 rounded-lg border border-cyan-500/20">
        ...
        {/* Contact Info */}
        <div className="bg-slate-800/30 rounded-lg p-6 mb-8 border border-cyan-500/20">

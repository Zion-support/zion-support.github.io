...
const Footer: React.FC = memo(() => {
  ...
  const microSaasServices = [
    ...
    { name: 'AI Analytics Dashboard', url: '/ai-analytics-dashboard', description: 'Analytics Dashboard' },
    { name: 'AI CRM', url: '/ai-crm', description: 'AI Customer Management' },
    { name: 'Email Optimizer', url: '/ai-email-assistant', description: 'Email marketing' },

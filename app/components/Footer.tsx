...
const Footer: React.FC = () => {
  const microSaasServices = [
    ...
    { name: 'AI Real Estate Analyzer', url: '/ai-real-estate-analyzer', description: 'Property valuation & analysis' },
    { name: 'AI Supply Chain Optimizer', url: '/ai-supply-chain-optimizer', description: 'Supply chain intelligence' },
    { name: 'AI Healthcare Assistant', url: '/ai-healthcare-assistant', description: 'Medical AI solutions' },
    { name: 'AI Legal Document Analyzer', url: '/ai-legal-analyzer', description: 'Legal document analysis' },
    { name: 'AI Manufacturing Optimizer', url: '/ai-manufacturing-optimizer', description: 'Smart manufacturing' },
    { name: 'AI Energy Management', url: '/ai-energy-management', description: 'Energy optimization' },
    { name: 'AI Insurance Risk Assessor', url: '/ai-insurance-risk', description: 'Risk assessment & fraud detection' },
    { name: 'AI Transportation Optimizer', url: '/ai-transportation-optimizer', description: 'Fleet & logistics management' },
    { name: 'AI Education Platform', url: '/ai-education-platform', description: 'Personalized learning' },
  ...
  const aiServices = [
    ...
    { name: 'AI Automation Suite', url: '/ai-automation', description: 'Process automation' },
    { name: 'AI Data Intelligence', url: '/ai-data-intelligence', description: 'Advanced data analytics' },
    { name: 'AI 3D & AR Solutions', url: '/ai-3d-ar', description: '3D & augmented reality' },
    { name: 'AI Voice & Audio', url: '/ai-voice-audio', description: 'Voice synthesis & processing' },
    { name: 'AI Content Intelligence', url: '/ai-content-intelligence', description: 'Content generation & optimization' },
    { name: 'AI Predictive Analytics', url: '/ai-predictive-analytics', description: 'Advanced forecasting' },
    { name: 'AI Security & Fraud Detection', url: '/ai-security-fraud', description: 'AI-powered security' },
    { name: 'AI Healthcare Solutions', url: '/ai-healthcare-solutions', description: 'Medical AI applications' },
    { name: 'AI Financial Intelligence', url: '/ai-financial-intelligence', description: 'Financial AI services' },
    { name: 'AI Quantum Computing', url: '/ai-quantum-computing', description: 'Quantum algorithms' },
    { name: 'AI Autonomous Systems', url: '/ai-autonomous-systems', description: 'Self-managing systems' },
    { name: 'AI Blockchain Solutions', url: '/ai-blockchain-solutions', description: 'Blockchain & Web3 AI' },
    { name: 'AI IoT & Edge Computing', url: '/ai-iot-edge', description: 'Edge AI processing' },
    { name: 'AI Robotics Solutions', url: '/ai-robotics-solutions', description: 'Intelligent robotics' },
    { name: 'AI Climate & Environmental', url: '/ai-climate-environmental', description: 'Environmental AI' }
  ];

  const itServices = [
    { name: 'Cloud Migration & Management', url: '/cloud-migration', description: 'AWS/Azure/GCP setup' },
    { name: 'Cybersecurity Solutions', url: '/cybersecurity', description: 'Advanced security solutions' },
    ...
    { name: 'IT Strategy & Consulting', url: '/it-consulting', description: 'Strategic IT guidance' },
    { name: 'Network Infrastructure', url: '/network-infrastructure', description: 'Enterprise networking' },
    { name: 'Mobile App Development', url: '/mobile-app-development', description: 'iOS/Android development' },
    ...
    { name: 'Blockchain & Web3 Solutions', url: '/blockchain-web3', description: 'Decentralized solutions' },
    { name: 'IoT & Edge Computing', url: '/iot-edge-computing', description: 'Connected devices' },
    { name: 'AI Infrastructure', url: '/ai-infrastructure', description: 'AI infrastructure setup' },
    { name: 'Enterprise Integration', url: '/enterprise-integration', description: 'System integration' },
    { name: 'Disaster Recovery & Backup', url: '/disaster-recovery-backup', description: 'Data protection' },
    { name: 'Compliance & Governance', url: '/compliance-governance', description: 'Regulatory compliance' },
    { name: 'AI Infrastructure & MLOps', url: '/ai-infrastructure-mlops', description: 'ML operations' },
    { name: 'Quantum Computing Infrastructure', url: '/quantum-computing-infrastructure', description: 'Quantum computing setup' },
    { name: 'Edge Computing Solutions', url: '/edge-computing-solutions', description: 'Edge infrastructure' },
    { name: '5G & Next-Gen Networks', url: '/5g-next-gen-networks', description: '5G implementation' },
    { name: 'Digital Twin Solutions', url: '/digital-twin-solutions', description: 'Digital twin creation' },
    { name: 'AR/VR Development', url: '/ar-vr-development', description: 'Immersive experiences' },
    { name: 'Smart City Solutions', url: '/smart-city-solutions', description: 'Smart city infrastructure' },
    { name: 'Cybersecurity Operations Center', url: '/cybersecurity-operations-center', description: '24/7 security monitoring' },
    { name: 'Data Science Platform', url: '/data-science-platform', description: 'End-to-end data science' }
  ];

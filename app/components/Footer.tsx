        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>
                <Link to="/ai-marketing" className="hover:text-cyan-400 transition-colors">
                  AI Marketing
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/ai-healthcare" className="hover:text-cyan-400 transition-colors">
                  AI Healthcare
                </Link>
              </li>
              <li>
                <Link to="/ai-fintech" className="hover:text-cyan-400 transition-colors">
                  AI Fintech
                </Link>
              </li>
              <li>
                <Link to="/ai-data-analytics" className="hover:text-cyan-400 transition-colors">
                  AI Data Analytics
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/ai-workflow-automation" className="hover:text-cyan-400 transition-colors">
          ...
          {/* IT & Tech Services */}
          <div>
            <h4 className="text-lg font-semibold mb-4 text-cyan-400">IT & Tech Services</h4>
            <ul className="space-y-2 text-gray-300">
              <li>
              ...
              <li>
                <Link to="/quantum-computing" className="hover:text-cyan-400 transition-colors">
                  Quantum Computing
                </Link>
              </li>
              <li>
                <Link to="/autonomous-systems" className="hover:text-cyan-400 transition-colors">
                  Autonomous Systems
                </Link>
              </li>
              <li>
                <Link to="/business-intelligence" className="hover:text-cyan-400 transition-colors">
                  Business Intelligence
                </Link>
              </li>
              <li>
                <Link to="/blockchain-web3" className="hover:text-cyan-400 transition-colors">
                  Blockchain & Web3
                </Link>
              </li>
              <li>
                <Link to="/iot-edge-computing" className="hover:text-cyan-400 transition-colors">
                  IoT & Edge Computing
                </Link>
              </li>
              <li>
                <Link to="/cybersecurity" className="hover:text-cyan-400 transition-colors">
                  Cybersecurity
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="https://docs.ziontechgroup.com" className="text-gray-300 hover:text-cyan-400 transition-colors">
                  Documentation
                </a>
              </li>
            </ul>

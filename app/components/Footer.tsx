          ...
          <div className="lg:col-span-2">
            ...
            <div className="text-sm text-gray-400 mb-4">
              <p>
                ...
                <a href="mailto:contact@ziontechgroup.com" className="hover:text-white transition-colors">
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-center md:text-left text-gray-300">
              © {currentYear} Zion Tech Group. All rights reserved. | <a href="https://ziontechgroup.com" className="hover:text-white transition-colors">ziontechgroup.com</a>
            </p>

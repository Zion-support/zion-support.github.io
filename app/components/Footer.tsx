        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Leading provider of AI and IT solutions, empowering businesses with cutting-edge technology and innovative strategies.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/business-intelligence" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Business Intelligence
                </Link>
              </li>
              <li>
                <Link to="/iot-edge" className="text-gray-300 hover:text-white transition-colors text-sm">
                  IoT & Edge Computing
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/guides" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Guides
                </Link>
              </li>
              <li>

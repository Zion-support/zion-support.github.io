  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'IoT Solutions', href: '/iot-edge-computing' },
        { name: 'AR/VR Development', href: '/it-services' },
        { name: 'Edge Computing', href: '/iot-edge-computing' },
        { name: '5G Solutions', href: '/it-services' },
      ],
    },
  ];

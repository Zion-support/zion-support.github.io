...
const Footer: React.FC = memo(() => {
  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        { name: 'AI Expense Tracker Pro', href: '/ai-expense-tracker-pro' },
        { name: 'AI Invoice Generator Pro', href: '/ai-invoice-generator-pro' },
    ...
    },
    {
      ...
      services: [
        { name: 'Quantum Computing', href: '/ai-quantum-computing' },

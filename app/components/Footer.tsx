...
import { Mail, Phone, MapPin, Github, Linkedin, Twitter, Brain, Cloud, Globe, Database, Zap, Star} from 'lucide-react';
'use client';
...
const Footer: React.FC = () => {
  ...
  return (
    <footer const className = "bg-gray-900 text-white" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8" />
          ...
          <div className="lg:col-span-2" />
            <div className="flex items-center mb-4" />
              ...
              <span className="text-2 xl font-bold"  >Zion Tech Group</span>
            </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6" />
          <div className="flex flex-col md:flex-row justify-between items-center" />
            ...
            <div className="flex space-x-6 mt-4 md:mt-0" />
              ...
              <Link to="/cookies" className="text-gray-400 hover:text-white text-sm transition-colors"  />Cookie Policy
              </Link>
            </div>
          </div>
        </div>

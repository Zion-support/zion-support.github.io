          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start text-sm text-gray-300">
                ...
                <span className="leading-relaxed">{contactInfo.address}</span></span>
</div></div>
              <div className="flex items-center text-sm text-gray-300">
                <Clock className="w-4 h-4 mr-2 text-cyan-400" /></span>
                <span>{contactInfo.hours}</span></span>
</div>
              <div className="text-xs text-cyan-400 font-medium">
                {contactInfo.emergency}</div>
</div>
</div>
</div></div>

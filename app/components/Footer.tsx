...
const Footer: React.FC = () => {
  ...
  const microSaas = [
    ...
    { name: 'Code Security', href: '/services/code-security' },
    { name: 'Performance Monitor', href: '/services/performance-monitor' }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Leading provider of advanced AI and IT solutions, delivering cutting-edge technology 
              to transform businesses and accelerate growth in the digital age.
            </p>

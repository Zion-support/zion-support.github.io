...
const Footer: React.FC = memo(() => {
  ...
  const fiveGServices = [
    ...
    { name: '5G Network Infrastructure', url: '/5g-network-infrastructure', description: '5G infrastructure setup' },
    ...
    <footer className="relative bg-slate-900 text-gray-300 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mt-12 pt-8 border-t border-gray-700">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-4 text-cyan-400">5G Solutions</h3>
            <ul className="space-y-2">

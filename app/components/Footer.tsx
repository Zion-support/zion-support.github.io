...
const Footer: React.FC = memo(() => {
  ...
  const aiServices = [
    ...
    { name: 'AI Mobile Apps', url: '/ai-mobile-app-builder', description: 'Mobile AI applications' },
    ...
    { name: 'AI Document Processing', url: '/ai-document-processor', description: 'Intelligent document processing' },
    { name: 'AI Machine Learning', url: '/ai-ml-platform', description: 'Complete ML platform' },
    { name: 'AI Computer Vision', url: '/ai-image-recognition', description: 'Advanced computer vision' },
    ...
    { name: 'AI Edge Computing', url: '/ai-edge', description: 'AI at the edge' }
  ];
  ...
  const itServices = [
    ...
    { name: 'Network Infrastructure', url: '/network-infrastructure', description: 'Network infrastructure' },
    { name: 'System Management', url: '/system-management', description: 'System management' },
    ...
    { name: 'IT Monitoring', url: '/it-monitoring', description: 'Real-time monitoring' },
  ...
  const emergingTech = [
    ...
    { name: 'IoT Solutions', url: '/iot-solutions', description: 'Connected devices' },
    { name: 'Big Data Analytics', url: '/big-data-analytics', description: 'Data-driven insights' },
    ...
    { name: 'R&D Services', url: '/rd-services', description: 'R&D and prototyping' },
    { name: 'Green Tech', url: '/green-tech', description: 'Green technology solutions' },
    { name: 'Future Tech', url: '/future-tech', description: 'Emerging tech solutions' }
  ];

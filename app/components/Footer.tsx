  ...
  const companyLinks = [
      ...
      <div>
        <div>
          {/* Company Info */} <div>
            <div className="flex items-center space-x-3 group">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold neon-text-enhanced group-hover: glow">Zion Tech Group</span><span className="text-sm text-cyan-400 font-medium tracking-wider">AI & IT SOLUTIONS</span>
              </div>
            </div>
          ...
          {/* Micro SAAS */} <div className="cyber-card-enhanced p-6 rounded-2xl">
        ...
        {/* Bottom Section */} <div className="border-t border-gradient-to-r from-cyan-500/20 via-purple-500/20 to-pink-500/20 mt-12 pt-8">
          <div>
            <div>

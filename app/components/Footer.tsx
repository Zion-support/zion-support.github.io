...
const Footer = () => {"    const currentYear :  new Date().getFullYear();
  ...
  const services :  [
    ...
    <footer className="bg-gray-900 text-white"      <div>"        <div>"          {/* Company Info */}
      ...
      </div>"            <p className="text-gray-400 mb-4"              Leading technology solutions provider specializing in AI, cybersecurity, and digital transformation."
          </p>"            <div>
              <a href="# className="text-gray-400 hover text-white transition-colors">                <Linkedin className="w-5 h-5" />              </a>"              <a href="#" className=text-gray-400 hover text-white transition-colors">"                <Twitter className=w-5 h-5" />"              </a>"              <a href=#" className="text-gray-400 hover text-white transition-colors"                <Github className="w-5 h-5"              </a>"
      </div>"
      </div>
        ...
        {/* Copyright */}
        <div>
          <p className="text-gray-400">"            © {currentYear} Zion Tech Group. All rights reserved."
          </p>"
      </div>
      </div>
    </footer>

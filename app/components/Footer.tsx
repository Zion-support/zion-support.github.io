  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Workflow Automation', path: '/ai-workflow-automation' }
      ]
    },
    {
      title: 'Micro SAAS',
      ...
      services: [
        ...
        { name: 'API Development', path: '/it-services' },
        { name: 'Database Services', path: '/it-services' },
        { name: 'Developer Tools', path: '/it-services' },
        { name: 'Productivity Tools', path: '/it-services' },
        { name: 'Marketing Tools', path: '/it-services' },
        { name: 'Analytics Dashboard', path: '/business-intelligence' }
      ]
    },
    {
      title: 'Emerging Tech',
      ...
      services: [
        ...
        { name: 'AR/VR Development', path: '/it-services' },
        { name: '5G Solutions', path: '/it-services' },
        { name: 'Edge AI', path: '/ai-services' }
      ]
    }
  ];

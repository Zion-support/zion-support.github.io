...
import { aiServices, itServices, technologies, company, resources, contactInfo, socialLinks, stats } from '../data/navigation';
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <a href={`tel:${contactInfo.phone.replace(/\s/g, '')}`} className="text-gray-300 hover:text-white transition-colors">
                  {contactInfo.phone}
                </a>
              </div>
              <div className="flex items-center">

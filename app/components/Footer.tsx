...
const Footer: React.FC = memo(() => {
  ...
  const aiServices = [
    ...
    { name: 'AI Email Marketing', url: '/ai-email-marketing-automation', description: 'Smart email campaigns' },
    { name: 'AI Project Management', url: '/ai-project-management', description: 'Intelligent project planning' },
    { name: 'AI Customer Service Bot', url: '/ai-customer-service-bot', description: '24/7 intelligent support' },
    { name: 'AI Inventory Management', url: '/ai-inventory-management', description: 'Smart stock optimization' },
    { name: 'AI Financial Advisor', url: '/ai-financial-advisor', description: 'Smart investment management' },

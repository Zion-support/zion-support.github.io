...
,"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">";"
        ...
        "
          {/* Services */};"
          <div>";"
            <h3 className="text-white font-semibold mb-4">Services</$1>"
      ...
      className="text-gray-300 hover:text-white transition-colors flex items-center";"
        ...
        "
          ...
          <div>","
        "
            <h3 className="text-white font-semibold mb-4">Solutions</$1>"
            <ul className="space-y-2">","
        "
      ...
      className="text-gray-300 hover:text-white transition-colors flex items-center";"
        ...
        "
          ...
          <div>","
        "
            <h3 className="text-white font-semibold mb-4">Resources</$1>"
            <ul className="space-y-2">","
        "
      ...
      className="text-gray-300 hover:text-white transition-colors flex items-center";"
        ...
        "
          ...
          <div>","
        "
            <h3 className="text-white font-semibold mb-4">Company</$1>"
            <ul className="space-y-2">","
        "
              {company.map((item) => (",)}"
        "
      ...
      className="text-gray-300 hover:text-white transition-colors flex items-center";"
        ...
        "
              <div>","
        "
                <p className="text-white font-medium">+1 302 464 0950</$1>"
        ...
        "
              <div>","
        "
                <p className="text-white font-medium">kleber@ziontechgroup.com</$1>"
        ...
        "
              <div>","
        "
                <p className="text-white font-medium">364 E Main St STE 1008</$1>"

...
const Footer: React.FC = () => {
  ...
  const microSaasServices = [
    ...
    { name: "Zion AI Accounting Assistant", path: "/zion-ai-accounting-assistant" },
    { name: "Zion AI 3D Generator", path: "/zion-ai-3d-generator" },
    { name: "Zion AI Blockchain Analytics", path: "/zion-ai-blockchain-analytics" },
  ];

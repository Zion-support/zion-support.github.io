...
const Footer: React.FC = memo(() => {
  ...
  const aiServices = [
    ...
    { name: 'AI Cybersecurity Advanced', url: '/ai-cybersecurity-advanced', description: 'AI-powered security' },
    { name: 'Quantum AI Optimization', url: '/quantum-ai-optimization', description: 'Quantum computing for AI' },

    ...
    <footer className="bg-slate-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12"></div>
        ...
        <div className="flex items-center space-x-2"></div>
            ...
            <p className="text-gray-400 text-sm">Leading provider of AI and IT solutions, empowering businesses with cutting-edge technology and innovative digital transformation services.</p>
        ...
        <div className="flex flex-wrap gap-6 mb-4 md:mb-0"></div>
            {legal.map((item, index) => (<Link}
                key={index}
                href={item.url}
                className="text-gray-400 hover:text-white transition-colors text-sm";
              >

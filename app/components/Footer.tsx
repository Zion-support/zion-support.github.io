        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li>
                <Link to="/ai-web-development" className="hover:text-white transition-colors">
                  AI Web Development
                </Link>
              </li>
              <li>
                <Link to="/ai-consulting" className="hover:text-white transition-colors">
                  AI Consulting
                </Link>
              </li>
              <li>
                <Link to="/ai-support" className="hover:text-white transition-colors">
                  AI Support
                </Link>
              </li>
              <li>

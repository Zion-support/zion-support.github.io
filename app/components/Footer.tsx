...
export default function Footer() {
  const services = [
    ...
    { name: 'Cloud Consulting', path: '/it-services/cloud-consulting' },
    { name: 'Network Security', path: '/it-services/network-security' },
    { name: 'Data Backup & Recovery', path: '/it-services/data-backup-recovery' },

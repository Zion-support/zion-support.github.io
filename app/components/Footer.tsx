...
const Footer: React.FC = memo(() => {
  ...
  const microSaasServices = [
    ...
    { name: 'AI Email Marketing', url: '/ai-email-marketing-automation', description: 'Email campaign automation' },
    { name: 'AI Project Manager', url: '/ai-project-manager', description: 'Project coordination' },
    { name: 'AI Feedback Analyzer', url: '/ai-customer-feedback-analyzer', description: 'Customer feedback analysis' },

...
const Footer: React.FC = memo(() => {
  ...
  return (
    <footer className="bg-slate-900 text-white cyber-grid-advanced">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 via-purple-600 to-pink-600 rounded-xl flex items-center justify-center quantum-pulse">
                <Brain className="w-7 h-7 text-white" />
              </div>
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-white neon-text-advanced" data-text="Zion Tech Group">Zion Tech Group</span>
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 hover-glow">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-cyan-400 neon-text-enhanced">AI Services</h3>
            <ul className="space-y-2">
              {aiServices.slice(0, 8).map((service) => (
                <li key={service.name}>
                  <Link 
                    to={service.url} 
                    className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 text-sm hover-glow"
                  >
                    {service.name}
                  </Link>
                </li>
              ...
              <li>
                <Link 
                  to="/ai-services" 
                  className="text-cyan-400 hover:text-cyan-300 transition-colors duration-300 text-sm font-medium hover-glow"
                >
          ...
          {/* IT Services */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-purple-400 neon-text-enhanced">IT Services</h3>
            <ul className="space-y-2">
              {itServices.slice(0, 8).map((service) => (
                <li key={service.name}>
                  <Link 
                    to={service.url} 
                    className="text-gray-300 hover:text-purple-400 transition-colors duration-300 text-sm hover-glow"
                  >
                    {service.name}
                  </Link>
                </li>
              ...
              <li>
                <Link 
                  to="/it-services" 
                  className="text-purple-400 hover:text-purple-300 transition-colors duration-300 text-sm font-medium hover-glow"
                >
          ...
          {/* Micro SAAS */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-green-400 neon-text-enhanced">Micro SAAS</h3>
            <ul className="space-y-2">
              {microSaasServices.slice(0, 8).map((service) => (
                <li key={service.name}>
                  <Link 
                    to={service.url} 
                    className="text-gray-300 hover:text-green-400 transition-colors duration-300 text-sm hover-glow"
                  >
                    {service.name}
                  </Link>
                </li>
              ...
              <li>
                <Link 
                  to="/micro-saas" 
                  className="text-green-400 hover:text-green-300 transition-colors duration-300 text-sm font-medium hover-glow"
                >
                  View All Micro SAAS →
                </Link>
              </li>
          ...
          {/* Company & Resources */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-orange-400 neon-text-enhanced">Company</h3>
            <ul className="space-y-2">
              {companyLinks.map((link) => (
                <li key={link.name}>
                  <Link 
                    to={link.url} 
                    className="text-gray-300 hover:text-orange-400 transition-colors duration-300 text-sm hover-glow"
                  >
                    {link.name}
                  </Link>
                </li>
        ...
        {/* Contact Section */}
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 mb-8 holographic-card-advanced">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-cyan-400 neon-text-enhanced">Contact Information</h3>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-purple-400 neon-text-enhanced">Business Hours</h3>
              <div className="space-y-2">
                <div className="flex items-center space-x-3">
                  <Clock className="w-5 h-5 text-purple-400" />
                  <span className="text-gray-300 text-sm">Monday - Friday: 9:00 AM - 6:00 PM EST</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Clock className="w-5 h-5 text-purple-400" />
                  <span className="text-gray-300 text-sm">Saturday: 10:00 AM - 4:00 PM EST</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Clock className="w-5 h-5 text-purple-400" />
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold text-green-400 neon-text-enhanced">Get Started</h3>
              <p className="text-gray-300 text-sm">
                Ready to transform your business with AI and IT solutions? Let's discuss your project.
              </p>
              <Link 
                to="/contact" 
                className="inline-flex items-center space-x-2 quantum-button text-white px-6 py-3 rounded-lg font-medium"
              >
        ...
        <div className="border-t border-cyan-500/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              <Link to="/privacy" className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 text-sm hover-glow">
                Privacy Policy
              </Link>
              <Link to="/terms" className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 text-sm hover-glow">
                Terms of Service
              </Link>
              <Link to="/cookies" className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 text-sm hover-glow">
                Cookie Policy
              </Link>
            </div>
          </div>

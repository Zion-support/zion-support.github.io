...
const Footer: React.FC = memo(() => {
  const aiServices = [
    ...
    { name: 'AI Cloud Infrastructure', url: '/ai-cloud-infrastructure', description: 'Cloud AI services' },
    { name: 'AI Mobile App Development', url: '/ai-mobile-app-development', description: 'AI-powered mobile apps' }
  ];
  ...
  const specializedServices = [
    ...
    { name: 'AR/VR Solutions', url: '/ar-vr', description: 'Immersive experiences' },
    { name: '5G Solutions', url: '/5g-solutions', description: 'Next-gen connectivity' }
  ];

...
const Footer: React.FC = memo(() => {
  return (
    <footer className="glass-dark border-t border-cyan-400/20 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            <h4 className="text-md font-semibold mb-4 text-green-400">Company</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="text-md font-semibold mb-4 text-pink-400">Resources</h4>
            <ul className="space-y-2">
              <li><Link to="/blog" className="text-gray-300 hover:text-pink-400 transition-colors">Blog</Link></li>
              <li><Link to="/api-docs" className="text-gray-300 hover:text-pink-400 transition-colors">API Docs</Link></li>
          ...
          <div>
            <h4 className="text-md font-semibold mb-4 text-orange-400">Legal</h4>
            <ul className="space-y-2">

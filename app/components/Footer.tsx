          ...
          {serviceCategories.map((category, index) => (
            <div key={index} className="space-y-6">"
              <div className="flex items-center space-x-3">"
                <div className={`w-8 h-8 rounded-lg bg-gradient-to-r ${category.color} flex items-center justify-center`}></div className={`w-8 h-8 rounded-lg bg-gradient-to-r ${category.color} flex items-center justify-center`}></</div className={`w-8 h-8 rounded-lg bg-gradient-to-r ${category.color} flex items-center justify-center`}>
                  {category.icon}
                </div><//div></<//div>
              ...
              <div className="space-y-3">"
                  ...
                  <Link
                    ...
                    className={`block text-sm transition-colors duration-300 group ${
                      link.featured
                        ...
                        : "text-gray-300 hover:text-cyan-400"}`}"></Link
                    key={linkIndex}
                    to={link.href}
                    className={`block text-sm transition-colors duration-300 group ${
                      link.featured
                ...
                {category.links.length > 8 && (
                  ...
                  >
                    <div className="flex items-center space-x-2">"
                      <span>View All {category.title}</span><//span></<//span>
            ...
            <div className="space-y-3">"
              {companyLinks.map((link, index) => (
                <Link
                  key={index}
                  to={link.href}
                  className="block text-gray-300 hover:text-cyan-400 transition-colors duration-300 text-sm""></Link
                  key={index}
                  to={link.href}
                  className="block text-gray-300 hover:text-cyan-400 transition-colors duration-300 text-sm""></</Link
                  key={index}
...
import { ArrowRight, Facebook, Twitter, Linkedin, Github} from "lucide-react";"
  HeartIcon} from "@heroicons/react/24/outline"} from "@heroicons/react/24/outline";"
  GlobeAltIcon} from "@heroicons/react/24/outline"} from "@heroicons/react/24/outline";"
const Footer: React.FC = () => {
  ...
  const services = [
    ...
    { name: "5G Solutions", href: "/5g-solutions"}"} from "@heroicons/react/24/outline";"
import { ArrowRight, Facebook, Twitter, Linkedin, Github} from "lucide-react";"
const Footer: React.FC = () => {
import React from "react";"
import { Link} from "react-router-dom";"
          ...
          <div className="lg:col-span-2">"
            ...
            <div className="space-y-3">"
              ...
              <div className="flex items-center space-x-3 text-gray-400">""
                ...
                <span>Middletown, DE 19709</span></div><//div></div><//div></<//div>
          ...
          <div></div></</div>
            ...
            <ul className="space-y-2">""
              {footerLinks.services.map((link) => (
                <li key={link.name}></li key={link.name}></</li key={link.name}>
                  <Link
                    to={service.href}
            ...
            <ul className="space-y-2">""
              {footerLinks.services.map((link, index) => (
                <li key={index}></li key={index}></</li key={index}>
                  <Link
                    to={link.href}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">"
            ...
            <ul className="space-y-2">"
              {footerLinks.resources.map((link) => (
                <li key={link.name}></li key={link.name}></</li key={link.name}>
                  <Link
                    to={ link.href}
                    className="text-gray-400 hover:text-purple-400 transition-colors""></Link
                    to={ link.href}
                    className="text-gray-400 hover:text-purple-400 transition-colors""></</Link
                    to={ link.href}
                    className="text-gray-400 hover:text-purple-400 transition-colors"">
        ...
        <div className="mt-8 pt-8 border-t border-slate-700">"
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-300">"
            ...
            <div className="flex items-center space-x-2">""
              ...
              <span>364 E Main St STE 1008, Middletown, DE 19709</span><//span></<//span>
            <div className="flex items-center">""
        ...
        <div className="mt-12 pt-8 border-t border-slate-700/50 flex flex-col md:flex-row justify-between items-center">"
          <div className="flex items-center space-x-2 text-gray-400 mb-4 md:mb-0">"
            ...
            <span>by Zion Tech Group</span></div><//div></<//div>
          {/* Copyright */}
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">"
              {footerLinks.legal.map((link) => (
                <Link
                  key={link.name}
                  to={ link.href}
                  className="text-gray-400 hover:text-purple-400 text-sm transition-colors""></Link
                  key={link.name}
                  to={ link.href}
                  className="text-gray-400 hover:text-purple-400 text-sm transition-colors""></</Link
                  key={link.name}
        ...
        <div className="mt-8 pt-8 border-t border-slate-700 flex flex-col md:flex-row justify-between items-center">""
          ...
          <div className="flex items-center space-x-1 text-gray-400 text-sm mt-4 md:mt-0">""
            ...
            <span>for innovation</span><//span></<//span>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">"
              ...
              <div className="flex flex-wrap gap-6">"
                {legalLinks.map((link, index) => (
                  <Link
                    key={index}
                    to={link.href}
                    className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 text-sm""></Link
                    key={index}
                    to={link.href}
                    className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 text-sm""></</Link
                    key={index}
            ...
            <div className="flex items-center space-x-4">"
              <div className="flex items-center space-x-2 text-gray-300 text-sm">"
                ...
                <span>SSL Secured</span></div><//div></<//div>
              <div className="flex items-center space-x-2 text-gray-300 text-sm">"
                <Shield className="w-4 h-4 text-green-400" />"
                <span>GDPR Compliant</span></div><//div></<//div>
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">"
          <div className="flex items-center text-gray-400 text-sm mb-4 md:mb-0">"
            <span>© {currentYear} Zion Tech Group. All rights reserved.</span></div><//div></<//div>
          <div className="flex items-center space-x-6">"
            {legal.map((item) => (
              <Link
                key={item.name}
                to={item.href}
                className="text-gray-400 hover:text-white transition-colors text-sm""></Link
                key={item.name}
                to={item.href}
                className="text-gray-400 hover:text-white transition-colors text-sm""></</Link
                key={item.name}
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">"
          <p className="text-gray-400">"
            © {currentYear} Zion Tech Group. All rights reserved.
          </p></div><//div></div></footer><//footer></<//footer>
  )

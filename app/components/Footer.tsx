    ...
    <footer className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-gray-300 text-sm leading-relaxed max-w-md">
                Leading provider of AI-powered solutions, cybersecurity, cloud infrastructure, and digital transformation for modern businesses. Transform your operations with cutting-edge technology.
              </p>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center text-gray-300 hover:text-cyan-400 hover:bg-cyan-500/20 transition-all duration-300 group"
          ...
          {/* Stats Section */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 py-8 border-t border-gray-800">

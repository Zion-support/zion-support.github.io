...
import { Mail, Phone, MapPin, Github, Linkedin, Twitter, Brain, Cloud, Shield, Code, Network, BarChart3, Bot } from 'lucide-react';

export default function Footer() {
  const services = [
    { name: 'AI Services', href: '/ai-services', icon: <Brain className="w-4 h-4" /> },
    { name: 'IT Services', href: '/it-services', icon: <Cloud className="w-4 h-4" /> },
    { name: 'Micro SaaS', href: '/micro-saas', icon: <Code className="w-4 h-4" /> },
    { name: '5G Solutions', href: '/5g-implementation', icon: <Network className="w-4 h-4" /> },

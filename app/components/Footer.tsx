...
const Footer: React.FC = memo(() => {
  ...
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden">{/* Futuristic Background Effects */}</footer>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">{/* Company Info */}</div>
          ...
          <div className="cyber-card-enhanced p-6 rounded-2xl">
            ...
            <ul className="space-y-3">{aiServices.slice(0, 6).map((service, index) => (</ul>
                <li key={index}>
                  <Link 
                    to={service.url}
          ...
          <div className="cyber-card-enhanced p-6 rounded-2xl">
            ...
            <ul className="space-y-3">{microSaasServices.slice(0, 6).map((service, index) => (</ul>
                <li key={index}>
                  <Link 
                    to={service.url}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mt-12 pt-8 border-t border-gray-700">
          ...
          <div>
            ...
            <ul className="space-y-2">{resourcesLinks.map((link, index) => (</ul>
                <li key={index}>
                  <Link 
                    to={link.url} 
                    className="text-gray-300 hover:text-cyan-400 text-sm transition-colors"
          ...
          <div>
            ...
            <ul className="space-y-2">{enterpriseLinks.map((link, index) => (</ul>
                <li key={index}>
                  <Link 
                    to={link.url} 
                    className="text-gray-300 hover:text-cyan-400 text-sm transition-colors"

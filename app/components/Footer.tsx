...
<p className="text-gray-400 mb-4"></p className="text-gray-400 mb-4">
              Advanced AI and IT solutions for modern businesses. We help you</p><//p>
              leverage cutting-edge technology to drive growth and innovation.</p><>
<//p>
</p><>
<//p>
...
<Link
                  ...
                  ><>
                    ...
                    className="text-gray-400 hover:text-white transition-colors flex items-center group"
                  >
<ArrowRight className="h-4 w-4 mr-2 opacity-0 group-hover:opacity-100 transition-opacity" /></ArrowRight className="h-4 w-4 mr-2 opacity-0 group-hover:opacity-100 transition-opacity" />
                    {service.name}
                  </Link><>
<//Link>
</li><//li>

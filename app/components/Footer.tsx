...
const Footer: React.FC = () => {
  ...
  const services = [
    ...
    { name: 'Cloud Architecture', href: '/cloud-infrastructure' },
    { name: 'Web Development', href: '/it-services' },
    { name: 'Mobile Apps', href: '/it-services' },
    { name: 'Data Analytics', href: '/ai-data-analytics' },
    { name: 'DevOps', href: '/it-services' }
  ];

  const products = [
    { name: 'AI Platform', href: '/ai-services' },
    { name: 'Cloud Suite', href: '/cloud-infrastructure' },
    { name: 'Analytics Dashboard', href: '/ai-data-analytics' },
    { name: 'Mobile SDK', href: '/it-services' }
  ];

...
const Footer: React.FC = memo(() => {
  ...
  const emergingTech = [
    { name: '5G Implementation', url: '/5g-implementation', description: 'Next-gen connectivity' },
    ...
    { name: 'AI Blockchain Solutions', url: '/ai-blockchain-solutions', description: 'Decentralized AI' },

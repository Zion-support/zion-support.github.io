...
const Footer: React.FC = () => {
  ...
  const itServices = [
    ...
    { name: 'AI-Powered DevOps Platform', url: '/ai-powered-devops-platform', description: 'Advanced DevOps automation' }
  ];
  ...
  const microSaasServices = [
    ...
    { name: 'Zion AI Customer Insights Pro', url: '/zion-ai-customer-insights-pro', description: 'Advanced customer analytics' },
    { name: 'Zion AI Marketing Automation Pro', url: '/zion-ai-marketing-automation-pro', description: 'AI-powered marketing platform' },
    { name: 'Zion AI Supply Chain Optimizer', url: '/zion-ai-supply-chain-optimizer', description: 'Supply chain optimization' }
  ];

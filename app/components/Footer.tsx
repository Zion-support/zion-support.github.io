        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Leading the future of AI and IT solutions. We help businesses transform 
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/it-solutions" className="text-gray-300 hover:text-white transition-colors text-sm">
                  IT Solutions
                </Link>
              </li>
              <li>
                <Link to="/micro-saas-solutions" className="text-gray-300 hover:text-white transition-colors text-sm">
                  Micro SaaS
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300 text-sm">info@ziontech.com</p>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs">San Francisco, CA 94105</p>
                </div>
              </div>
            </div>
          </div>

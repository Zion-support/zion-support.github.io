...
import { Phone, Mail, MapPin, Award, Shield, ArrowRight, Brain, Globe, Facebook, Twitter, Linkedin, Instagram, Youtube, Github, TrendingUp, CheckCircle } from 'lucide-react';

  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Automation', href: '/ai-workflow-automation' }
      ]
    },
    {
      title: 'IT Solutions',
    ...
    },
    {
      ...
      services: [
        { name: 'AI Content Generator', href: '/micro-saas/ai-content-generator' },
        { name: 'Smart Analytics', href: '/micro-saas/smart-analytics' },
        { name: 'AI Support Bot', href: '/micro-saas/ai-support-bot' },
        { name: 'Email Marketing', href: '/micro-saas/smart-email-marketing' },
        { name: 'Project Management', href: '/micro-saas/ai-project-management' },
        { name: 'Social Media Manager', href: '/micro-saas/ai-social-manager' },
        { name: 'Invoice Generator', href: '/micro-saas/smart-invoice' },
        { name: 'Lead Scoring', href: '/micro-saas/ai-lead-scoring' }
      ]
    },
    {
      title: 'Emerging Tech',

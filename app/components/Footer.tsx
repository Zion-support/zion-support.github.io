...
const Footer: React.FC = memo(() => {
  const aiServices = [
    ...
    { name: 'AI Chatbots', url: '/ai-services', description: 'Conversational AI' },
    { name: 'AI Content Generation', url: '/ai-services', description: 'Content creation' },
    { name: 'AI Analytics', url: '/ai-services', description: 'Predictive analytics' }
  ];

  const itServices = [
    { name: 'Cloud Infrastructure', url: '/it-services', description: 'Cloud management' },
    { name: 'Cybersecurity', url: '/it-services', description: 'Security solutions' },
    { name: 'Network Management', url: '/it-services', description: 'Network infrastructure' },
    { name: 'DevOps & Automation', url: '/it-services', description: 'CI/CD pipelines' },
    { name: 'Database Administration', url: '/it-services', description: 'Database management' },
    { name: 'IT Help Desk', url: '/it-services', description: 'Technical support' },
    { name: 'Backup & Recovery', url: '/it-services', description: 'Data protection' },
    { name: 'IT Consulting', url: '/it-services', description: 'Strategic planning' }
  ];

  const microSaasServices = [
    { name: 'AI Content Writer', url: '/micro-saas', description: 'Content generation' },
    { name: 'AI Image Generator', url: '/micro-saas', description: 'Image creation' },
    { name: 'AI Code Assistant', url: '/micro-saas', description: 'Code generation' },
    { name: 'Smart Scheduler', url: '/micro-saas', description: 'Meeting scheduling' },
    { name: 'Email Automation', url: '/micro-saas', description: 'Email marketing' },
    { name: 'Social Media Manager', url: '/micro-saas', description: 'Social automation' },
    { name: 'AI CRM', url: '/micro-saas', description: 'Customer management' },
    { name: 'Business Intelligence', url: '/micro-saas', description: 'Data analytics' }
  ];

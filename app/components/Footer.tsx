  ...
  return ("
    <footer className="bg-slate-900 text-white">
      ...
      <div className="container mx-auto px-4 py-16">"
          ...
          {serviceCategories.map((category, index) => ("
            <div key={index} className="lg: col-span-1">"
              <div className="flex items-center mb-6"></div>,
                <div className={`w-8 h-8 rounded-lg bg-gradient-to-r ${category.color} flex items-center justify-center mr-3`}></div>
                  {category.icon},
                </div>"
        ...
        {/* Additional Links */}"
        <div className="grid grid-cols-1 md: grid-cols-3 gap-8 mt-12 pt-8 border-t border-slate-700"></div>
          <div>"
        ...
        <div className="mt-12 pt-8 border-t border-slate-700">"
          <div className="max-w-md mx-auto text-center">"
            ...
            <div className="flex"></div>
              ...
              />"
              <button className="px-6 py-2 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-r-lg transition-colors flex items-center"></button>
                Subscribe"

...
import { Phone, Mail, MapPin, Clock, Zap, Brain, Cloud, Code, Users, Cpu, ArrowRight, Github, Linkedin, Twitter, Database, Shield, Globe, Sparkles, Star } from 'lucide-react';
...
const Footer: React.FC = memo(() => {
  ...
  const fiveGServices = [
    ...
    { name: '5G Network Infrastructure', url: '/5g-network-infrastructure', description: '5G network setup' },
    { name: '5G IoT Solutions', url: '/5g-iot-solutions', description: 'IoT connectivity' },
    { name: '5G Edge Computing', url: '/5g-edge-computing', description: 'Edge processing' },

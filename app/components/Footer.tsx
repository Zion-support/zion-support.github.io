// app/components/Footer.tsx — client-side (uses no Node APIs)
'use client';
      ...
      <div className="container-page py-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-7 text-sm">
        ...
        <div className="lg:col-span-1">
          ...
          <p className="text-slate-400 mt-2 text-xs leading-relaxed">
            {serviceCount.toLocaleString()}+ AI, IT &amp; Micro-SaaS services — enterprise automation,
            cybersecurity, cloud, and data solutions headquartered in Middletown, DE.
          </p>

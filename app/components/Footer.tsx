...
import { Phone, Mail, MapPin, Clock, Zap, Brain, Cloud, Code, Users, ArrowRight, Star, Shield, Target, Globe, CheckCircle } from 'lucide-react';
...
const Footer: React.FC = memo(() => {
  ...
  return (
    <footer className="relative bg-slate-900 text-gray-300 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_80%_20%,_var(--tw-gradient-stops))] from-purple-500/5 via-transparent to-transparent" />
            ...
            <ul className="space-y-3">
              {aiServices.map((service, index) => (
                <li key={index}>
                  ...
                  >
                    <CheckCircle className="w-3 h-3 text-cyan-400 mr-2 opacity-0 group-hover:opacity-100 transition-opacity" />
                    <div>
            ...
            <ul className="space-y-3">
              {itServices.map((service, index) => (
                <li key={index}>
                  ...
                  >
                    <CheckCircle className="w-3 h-3 text-purple-400 mr-2 opacity-0 group-hover:opacity-100 transition-opacity" />
                    <div>
            ...
            <ul className="space-y-3">
              {microSaasServices.map((service, index) => (
                <li key={index}>
                  ...
                  >
                    <CheckCircle className="w-3 h-3 text-green-400 mr-2 opacity-0 group-hover:opacity-100 transition-opacity" />
                    <div>
                      <div className="font-medium group-hover:text-green-300">{service.name}</div>
                      <div className="text-xs text-gray-400 group-hover:text-gray-300">{service.description}</div>
                    </div>
                  </Link>
                </li>

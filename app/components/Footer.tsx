      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-center space-x-3 group">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold neon-text group-hover:glow">Zion Tech Group</span>
          ...
          <div className="cyber-card p-6 rounded-2xl">
            <h3 className="text-lg font-bold mb-6 text-cyan-400 flex items-center neon-text">
          ...
          {/* IT Services */}
          <div className="cyber-card p-6 rounded-2xl">
            <h3 className="text-lg font-bold mb-6 text-purple-400 flex items-center neon-text">
          ...
          {/* Micro SAAS */}
          <div className="cyber-card p-6 rounded-2xl">
            <h3 className="text-lg font-bold mb-6 text-green-400 flex items-center neon-text">

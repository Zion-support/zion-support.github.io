...
import { Zap, Mail, Phone, MapPin, Facebook, Twitter, Linkedin, Github, Sparkles, Brain, Cloud, Shield, Code, Users, BarChart3, Server } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/services" className="text-cyan-400 hover:text-cyan-300 transition-colors text-sm font-medium">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/services" className="text-purple-400 hover:text-purple-300 transition-colors text-sm font-medium">
                  View All Micro SAAS →
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/services" className="text-blue-400 hover:text-blue-300 transition-colors text-sm font-medium">

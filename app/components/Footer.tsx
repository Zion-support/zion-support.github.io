...
import { Phone, Mail, MapPin, Clock, Zap, Brain, Cloud, Code } from 'lucide-react';
            ...
            <ul className="space-y-3">
              {aiServices.map((service, index) => (
                <li key={index}>
                  ...
                  >
                    <div className="w-2 h-2 bg-cyan-500 rounded-full mr-3 group-hover:scale-150 transition-transform"></div>
                    {service.name}
                  </Link>
                </li>
              ))}

        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <Link to="/ai-services" className="hover:text-white transition-colors flex items-center">
                  <Award className="w-4 h-4 mr-2 text-blue-400" />
                  AI Services
                </Link>
              </li>
              <li>
                <Link to="/micro-saas" className="hover:text-white transition-colors flex items-center">
                  <Zap className="w-4 h-4 mr-2 text-blue-400" />
                  Micro SAAS
                </Link>
              </li>
              <li>
                <Link to="/it-services" className="hover:text-white transition-colors flex items-center">

...
const Footer: React.FC = memo(() => {
  ...
  const emergingTech = [
    ...
    { name: 'Blockchain Solutions', url: '/blockchain-solutions', description: 'Connected devices' },
    { name: 'IoT Solutions', url: '/iot-solutions', description: 'Decentralized solutions' },
    { name: 'Big Data Analytics', url: '/big-data-analytics', description: 'Data insights' },

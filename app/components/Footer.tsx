...
const Footer: React.FC = () => {
  ...
  const aiServices = [
    { name: 'AI Voice Assistant', url: '/ai-voice-assistant', description: 'Natural voice interactions' },
    { name: 'AI Email Assistant', url: '/ai-email-assistant', description: 'Intelligent email management' },
    { name: 'AI Content Generator', url: '/ai-content-generator', description: 'Advanced content creation' },
  ...
  const itServices = [
    { name: 'Cloud Migration', url: '/cloud-migration', description: 'Expert cloud migration' },
    { name: 'Cybersecurity Solutions', url: '/cybersecurity-solutions', description: 'Enterprise security' },
  ...
  const microSaasServices = [
    { name: 'Zion Analytics Pro', url: '/zion-analytics-pro', description: 'Advanced business intelligence' },
    { name: 'Zion Voice AI', url: '/zion-voice-ai', description: 'Enterprise voice assistant' },
    { name: 'Zion Email Pro', url: '/zion-email-pro', description: 'Intelligent email management' },
    { name: 'Zion Content AI', url: '/zion-content-ai', description: 'AI content creation' },

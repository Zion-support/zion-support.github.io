        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 text-lg leading-relaxed">
              ...
              innovative micro SAAS platforms, and comprehensive digital solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/ai-services" className="text-gray-300 hover:text-blue-400 transition-colors">All AI Services</Link></li>
              ...
              <li><Link to="/micro-saas-solutions" className="text-gray-300 hover:text-blue-400 transition-colors">Micro SAAS Solutions</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/it-services" className="text-gray-300 hover:text-blue-400 transition-colors">All IT Services</Link></li>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-400 text-sm">
                <a href="https://ziontechgroup.com" className="hover:text-blue-400 transition-colors">ziontechgroup.com</a> | 
                <span className="mx-2">Mobile: +1 302 464 0950</span> | 
                <span className="mx-2">Email: kleber@ziontechgroup.com</span>
              </p>
            </div>
            <div className="flex flex-wrap justify-center lg:justify-end space-x-6 mt-4 lg:mt-0">
              ...
              <Link to="/accessibility" className="text-gray-400 hover:text-blue-400 text-sm transition-colors">Accessibility</Link>
            </div>
          </div>
        </div>
      </div>

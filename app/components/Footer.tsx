        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Leading provider of AI and IT solutions for modern businesses. We empower organizations 
              with cutting-edge technology to drive growth, efficiency, and innovation.
            </p>
          ...
          {/* AI Services */}
          <div>
            <h4 className="text-lg font-semibold mb-6 text-white">AI Services</h4>
            <ul className="space-y-3">
              ...
              <li><Link to="/ai-content-generator" className="text-gray-300 hover:text-blue-400 transition-colors">AI Content Generator</Link></li>
          ...
          {/* IT Services */}
          <div>
            <h4 className="text-lg font-semibold mb-6 text-white">IT Services</h4>
            <ul className="space-y-3">
              ...
              <li><Link to="/database-management" className="text-gray-300 hover:text-blue-400 transition-colors">Database Management</Link></li>
              <li><Link to="/network-infrastructure" className="text-gray-300 hover:text-blue-400 transition-colors">Network Infrastructure</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/zion-ai-document-analyzer" className="text-gray-300 hover:text-blue-400 transition-colors">Document Analyzer</Link></li>
              <li><Link to="/zion-ai-social-media-manager" className="text-gray-300 hover:text-blue-400 transition-colors">Social Media Manager</Link></li>
              <li><Link to="/zion-ai-project-manager" className="text-gray-300 hover:text-blue-400 transition-colors">Project Manager</Link></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-8 mb-4 md:mb-0">
              ...
              <div className="flex space-x-6">
                ...
                <Link to="/accessibility" className="text-gray-300 hover:text-blue-400 transition-colors text-sm">
                  Accessibility
                </Link>
              </div>
            </div>

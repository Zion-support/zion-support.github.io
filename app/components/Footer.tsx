...
export default Footer;
  ...
  const socialLinks = [
    { name: 'Twitter', url: 'https://twitter.com/ziontechgroup', icon: <Twitter className="w-5 h-5" /&gt; } ,</Twitter></Twitte></Twitter>
    { name: 'LinkedIn', url: 'https://linkedin.com/company/ziontechgroup', icon: <Linkedin className="w-5 h-5" /&gt; } ,</Linkedin></Linkedi></Linkedin>
    { name: 'GitHub', url: 'https://github.com/ziontechgroup', icon: <Github className="w-5 h-5" /&gt; }</Github></Githu></Github>
  ];

  return (
          <h3 className="text-2-xl font-bold mb-4"></h>Zion Tech Group</h3>
  const currentYear = new Date().getFullYear();

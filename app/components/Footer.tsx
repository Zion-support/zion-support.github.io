...
return (
    ...
    <span className="text-xl font-bold">Zion Tech Group</span>/div>p className="text-gray-400 text-sm"></p>
Leading provider of AI and IT solutions, empowering businesses with cutting-edge technology and innovative digital transformation services.
    ...
    <div className="flex space-x-4"></div>a href="#" className="text-gray-400 hover: text-white transition-colors">
                <GithubclassNam e="w-5 h-5" />
              </a>a href="#" className="text-gray-400 hover:text-white transition-colors">
                <LinkedinclassNam e="w-5 h-5" />
              </a>a href="#" className="text-gray-400 hover:text-white transition-colors">
                <TwitterclassNam e="w-5 h-5" />
              </a>/div>/div>
          {/* AI Services */,},
    <div className="space-y-4"></div>,
    <h1 className="text-lg font-semibold flex items-center"></h3>BrainclassNam e="w-5 h-5 mr-2 text-cyan-400" />
AI Services
              ...
              {aiServices.map((service, index) => (
                <li key={index}>
                  <Link href={service.url} className="text-gray-400 hover: text-white transition-colors text-sm flex items-center group">
                    <ArrowRightclassNam e="w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity" />
                    {service.name,}
                  </Link>/li>
              ))}
            </ul>/div>
          {/* IT Services */},
    <div className="space-y-4"></div>,
    <h1 className="text-lg font-semibold flex items-center"></h3>CloudclassNam e="w-5 h-5 mr-2 text-purple-400" />
IT Services
            </h3>ul className="space-y-2">

        ...
        <div className="max-w-7xl mx-auto py-20 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            <div className="lg:col-span-2">
              <h3 className="text-3xl font-bold mb-6 holographic-text font-['Orbitron'] cyber-glitch" data-text="ZION TECH GROUP">ZION TECH GROUP</h3>
              <p className="text-gray-300 mb-8 leading-relaxed text-lg matrix-text">
              ...
              <div className="space-y-3 text-sm text-gray-300">
                <p className="flex items-center text-base"><strong className="text-cyan-400 mr-3 text-lg">📞</strong> <a href="tel:+13024640950" className="hover:text-cyan-300 transition-colors neon-glow text-lg">+1 302 464 0950</a></p>
                <p className="flex items-center text-base"><strong className="text-cyan-400 mr-3 text-lg">✉️</strong> <a href="mailto:kleber@ziontechgroup.com" className="hover:text-cyan-300 transition-colors text-lg">kleber@ziontechgroup.com</a></p>
                <p className="flex items-center text-base"><strong className="text-cyan-400 mr-3 text-lg">📍</strong> <span className="text-lg">364 E Main St STE 1008<br />Middletown DE 19709</span></p>
                <p className="flex items-center text-base"><strong className="text-cyan-400 mr-3 text-lg">🌐</strong> <a href="https://ziontechgroup.com" className="hover:text-cyan-300 transition-colors text-lg">https://ziontechgroup.com</a></p>
              </div>
              <div className="flex space-x-4 mt-6">
                <a href="https://ziontechgroup.com" className="text-gray-300 hover:text-cyan-300 transition-colors neon-glow p-3 rounded-lg hover:bg-cyan-500/10 hover:scale-110 transform">
          ...
          <div>
            <h4 className="text-xl font-bold mb-6 text-gradient holographic-text">Core Services</h4>
          ...
          <div>
            <h4 className="text-lg font-bold mb-6 text-cyan-400">AI Services</h4>
          ...
          <div>
            <h4 className="text-lg font-bold mb-6 text-purple-400">Zion AI Tools</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="text-lg font-bold mb-6 text-green-400">Micro SaaS Solutions</h4>
            <ul className="space-y-2">

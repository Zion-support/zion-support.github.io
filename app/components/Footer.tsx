...
import { Phone, Mail, MapPin, Clock, Zap, Brain, Cloud, ArrowRight } from 'lucide-react';
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-10 right-10 w-80 h-80 bg-cyan-500/5 rounded-full blur-3xl animate-pulse delay-1000"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              <div className="w-10 h-10 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg flex items-center justify-center animate-glow-pulse">
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3 group">
                <Phone className="w-5 h-5 text-purple-400 group-hover:text-cyan-400 transition-colors" />
                <a 
              ...
              <div className="flex items-center space-x-3 group">
                <MapPin className="w-5 h-5 text-purple-400 group-hover:text-cyan-400 transition-colors" />
                <span className="text-gray-300">364 E Main St STE 1008, Middletown DE 19709</span>
              </div>
              <div className="flex items-center space-x-3 group">
                <Clock className="w-5 h-5 text-purple-400 group-hover:text-cyan-400 transition-colors" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="cyber-card group hover:scale-105 transition-transform">
              <div className="text-4xl font-bold text-cyan-400 mb-2 animate-glow-pulse">500+</div>
              <div className="text-gray-300">Enterprise Clients</div>
            </div>
            <div className="cyber-card group hover:scale-105 transition-transform">
              <div className="text-4xl font-bold text-green-400 mb-2 animate-glow-pulse">$2.5B+</div>
              <div className="text-gray-300">Cost Savings Delivered</div>
            </div>
            <div className="cyber-card group hover:scale-105 transition-transform">
              <div className="text-4xl font-bold text-purple-400 mb-2 animate-glow-pulse">99.9%</div>
              <div className="text-gray-300">Uptime Guarantee</div>
            </div>
            <div className="cyber-card group hover:scale-105 transition-transform">
              <div className="text-4xl font-bold text-orange-400 mb-2 animate-glow-pulse">24/7</div>

...
const Footer: React.FC = memo(() => {
  const aiServices = [
    ...
    { name: 'AI Content Generation', url: '/ai-content-generation', icon: MessageSquare, description: 'AI content creation' },
    ...
    { name: 'AI Customer Support', url: '/ai-customer-support', icon: MessageSquare, description: 'Support automation' },
  ...
  const itServices = [
    ...
    { name: 'Database Services', url: '/ai-data-analytics', icon: Database, description: 'Database management' }
  ];
  ...
  const specializedServices = [
    ...
    { name: 'Robotics', url: '/robotics', icon: Cpu, description: 'Robotic solutions' }
  ];

          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <a href="mailto:info@ziontechgroup.com" className="text-white hover:text-purple-400 transition-colors duration-200">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <a href="tel:+1-555-0123" className="text-white hover:text-purple-400 transition-colors duration-200">
                  +1 (555) 012-3456
                </a>
              </div>
            </div>

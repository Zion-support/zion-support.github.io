        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">          {/* Company Info */}
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex space-x-4">
              ...
              </a>          <div className="cyber-card-enhanced p-6 rounded-2xl">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-6 flex items-center">
              <Database className="w-5 h-5 mr-2 text-purple-400" />                  <Link 
                    to={service.url}
              ...
              {microSaasServices.map((service, index) => (
                <li key={index}>
                  <Link 
                    ...
                    <div className="w-2 h-2 bg-green-400 rounded-full mr-3 group-hover:scale-150 transition-transform"></div>                    {service.name}
                  </Link>
                </li>
              ))}
            ...
            <ul className="space-y-3">
              {supportLinks.map((link, index) => (
                <li key={index}>
                  ...
                  >
                    <ArrowRight className="w-3 h-3 mr-2" />          <div>

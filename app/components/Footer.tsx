        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services/micro-saas" className="text-slate-400 hover:text-blue-400 transition-colors">
                  Micro SaaS
                </Link>
              </li>
              <li>
                <Link href="/services/ai-services" className="text-slate-400 hover:text-blue-400 transition-colors">
                  AI Services
                </Link>
              </li>
              <li>
                <Link href="/services/it-services" className="text-slate-400 hover:text-blue-400 transition-colors">
                  IT Services
                </Link>
              </li>
              <li>
                <Link href="/services/blockchain" className="text-slate-400 hover:text-blue-400 transition-colors">
                  Blockchain
                </Link>
              </li>
            </ul>

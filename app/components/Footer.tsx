...
import { Phone, Mail, MapPin, Clock, Award, Shield, Zap, ArrowRight, Brain, Cloud, Code, BarChart, Users, Globe, Facebook, Twitter, Linkedin, Instagram, Youtube, Github, MessageSquare, Star, TrendingUp, CheckCircle, Sparkles, Target, Database, Settings, Cpu, Lock, BarChart3, FileText, Search, Bot, Palette, Camera, Music, Video, Gamepad2, ShoppingCart, CreditCard, Building, Factory, Car, Plane, Ship, Train, Home, Heart, Stethoscope, GraduationCap, Briefcase, Wrench, Hammer, Paintbrush, Scissors, BookOpen, Calculator, Calendar, Clock3, Compass, Navigation, PieChart, TrendingDown, Activity, Zap as Lightning, Target as Crosshair, Shield as Security, Users as People, Star as StarIcon, CheckCircle as Check, ArrowRight as Arrow, Phone as PhoneIcon, Mail as MailIcon, MapPin as Location } from 'lucide-react';
...
const Footer: React.FC = memo(() => {
  ...
  const microSaasServices = [
    ...
    { name: 'AI Social Media Manager', url: '/ai-social-media-manager', description: 'Automated social media management', icon: '📱', price: '$79/month', popular: true },
    { name: 'AI Analytics Dashboard', url: '/ai-analytics-dashboard', description: 'AI-powered business intelligence', icon: '📈', price: '$149/month', popular: true },
    { name: 'AI Email Marketing', url: '/ai-email-marketing', description: 'Intelligent email campaigns', icon: '📧', price: '$99/month', popular: true },
    { name: 'AI Customer Support Bot', url: '/ai-customer-support-bot', description: '24/7 AI customer support', icon: '🤖', price: '$149/month', popular: true },
    { name: 'AI Code Review Assistant', url: '/ai-code-generation', description: 'Automated code analysis', icon: '🔍', price: '$89/month', popular: false },
    { name: 'AI Content Generator', url: '/ai-content-generation', description: 'AI-powered content creation', icon: '✍️', price: '$69/month', popular: false },
    { name: 'AI SEO Optimizer', url: '/ai-seo-optimizer', description: 'AI-driven SEO optimization', icon: '🎯', price: '$79/month', popular: false },
    { name: 'AI Invoice Generator', url: '/ai-invoice-generator', description: 'Automated invoicing system', icon: '📄', price: '$49/month', popular: false },
    { name: 'AI Lead Scoring', url: '/ai-lead-scoring', description: 'Intelligent lead qualification', icon: '🎯', price: '$129/month', popular: false },
    { name: 'AI Sales Forecasting', url: '/ai-sales-forecasting', description: 'Advanced sales predictions', icon: '📊', price: '$199/month', popular: false },
    { name: 'AI E-commerce Optimizer', url: '/ai-ecommerce-optimizer', description: 'E-commerce optimization', icon: '🛒', price: '$179/month', popular: false }
  ];
  ...
  const aiServices = [
    ...
    { name: 'AI Healthcare', url: '/ai-healthcare-solutions', description: 'Medical AI solutions' },
    { name: 'AI Fintech', url: '/ai-fintech', description: 'Financial AI applications' },
    { name: 'AI Content Generation', url: '/ai-content-generation', description: 'AI content creation' },
    { name: 'AI Data Analytics', url: '/ai-data-visualization', description: 'Advanced data insights' },
    ...
    { name: 'AI 3D Generation', url: '/ai-3d-generation', description: 'AI 3D modeling' },
    ...
    { name: 'AI Fitness Coach', url: '/ai-fitness-coach', description: 'AI fitness training' }
  ];

  const itServices = [
    { name: 'IT Services', url: '/it-services', description: 'Comprehensive IT support' },
    { name: 'IT Infrastructure', url: '/it-infrastructure-solutions', description: 'Enterprise infrastructure' },
    ...
    { name: 'IT Training & Certification', url: '/it-training-certification', description: 'Professional development' },

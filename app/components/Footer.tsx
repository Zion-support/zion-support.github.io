...
const Footer: React.FC = memo(() => {
  return (
    <footer className="bg-black bg-opacity-90 backdrop-blur-sm text-white neon-border">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            <h3 className="text-lg font-semibold mb-4 neon-glow-blue">Zion Tech Group</h3>
            ...
            <div className="mb-4">
              ...
              <p className="text-white">✉️ kleber@ziontechgroup.com</p>
          ...
          <div>
            <h4 className="text-md font-semibold mb-4 neon-glow-green">Services</h4>
          ...
          <div>
            <h4 className="text-md font-semibold mb-4 neon-glow-green">AI Tools</h4>
            <ul className="space-y-2">
              <li><Link to="/zion-ai-content-moderator" className="text-gray-300 hover:text-cyan-400 transition-colors">Content Moderator</Link></li>
              ...
              <li><Link to="/zion-ai-workflow-automator-pro" className="text-gray-300 hover:text-cyan-400 transition-colors">Workflow Automator Pro</Link></li>
              <li><Link to="/zion-ai-email-marketing-pro" className="text-gray-300 hover:text-cyan-400 transition-colors">Email Marketing Pro</Link></li>
              <li><Link to="/zion-ai-customer-churn-predictor" className="text-gray-300 hover:text-cyan-400 transition-colors">Customer Churn Predictor</Link></li>
              ...
              <li><Link to="/zion-ai-task-scheduler" className="text-gray-300 hover:text-cyan-400 transition-colors">Task Scheduler</Link></li>
              <li><Link to="/pricing" className="text-gray-300 hover:text-cyan-400 transition-colors">Pricing</Link></li>
            </ul>
          </div>
          
          <div>
            <h4 className="text-md font-semibold mb-4 neon-glow-green">Company</h4>
            <ul className="space-y-2">
          ...
          <div>
            <h4 className="text-md font-semibold mb-4 neon-glow-green">Resources</h4>
            <ul className="space-y-2">

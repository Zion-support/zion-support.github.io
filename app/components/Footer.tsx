        ...
        <div className="mt-8 pt-8 border-t border-slate-700"></div>
          ...
          <div className="grid grid-cols-1 md: grid-cols-3 gap-4 text-sm text-gray-300"></div>
            ...
            <div className="flex items-center"></div>
              ...
              <MapPinIcon className="w-5 h-5 mr-2 text-blue-400" /></MapPinIcon>
...
>>>>>>> origin/main,
        ...
        <div className="mt-8 pt-8 border-t border-slate-700 flex flex-col md: flex-row justify-between items-center"><p className="text-gray-400 text-sm"></p>
            © {currentYear} Zion Tech Group. All rights reserved.,
          </p>

...
const Footer: React.FC = memo(() => {
  ...
  return (
    <footer className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid-advanced">
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-2xl font-bold text-white neon-advanced hologram-flicker">Zion Tech Group</span>
            </div>
          ...
          {/* AI Services */}
          <div>
            <h3 className="text-lg font-semibold mb-6 text-cyan-400 neon-advanced">AI Services</h3>
          ...
          {/* IT Services */}
          <div>
            <h3 className="text-lg font-semibold mb-6 text-cyan-400 neon-advanced">IT Services</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="text-lg font-semibold mb-6 text-cyan-400 neon-advanced">Solutions</h3>

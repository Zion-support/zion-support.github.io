        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/services-advertising" className="text-gray-300 hover:text-white transition-colors">AI Advertising</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              ...
              <li><Link to="/iot-edge-computing" className="hover:text-white transition-colors">IoT & Edge Computing</Link></li>

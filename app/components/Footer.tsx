  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Contract Analyzer Pro', href: '/ai-contract-analyzer' },
        { name: 'AI Inventory Optimizer Pro', href: '/ai-inventory-optimizer' },
        { name: 'AI Voice Assistant Pro', href: '/ai-voice-assistant' },
        { name: 'AI Website Builder Pro', href: '/ai-website-builder' },
        { name: 'AI Data Visualizer Pro', href: '/ai-data-visualizer' },
        { name: 'AI Sales Predictor Pro', href: '/ai-sales-predictor' }
      ]
    },
    {

          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-orange-600/20 border border-orange-400/30">
                {/* @ts-ignore */}{/* @ts-ignore */}<Factory className="w-5 h-5 text-orange-300 mr-2" />
                <span className="text-orange-200 text-sm font-medium">Autonomous Manufacturing</span>
              </div>
              
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                The <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-red-400">Manufacturing</span> Revolution
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-orange-600/30 rounded-lg flex items-center justify-center">
                  {/* @ts-ignore */}{/* @ts-ignore */}<Cogs className="w-4 h-4 text-orange-300" />
                </div>
              ...
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-red-600/30 rounded-lg flex items-center justify-center">
                  {/* @ts-ignore */}{/* @ts-ignore */}<TrendingUp className="w-4 h-4 text-red-300" />
                </div>
              ...
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-yellow-600/30 rounded-lg flex items-center justify-center">
                  {/* @ts-ignore */}{/* @ts-ignore */}<Factory className="w-4 h-4 text-yellow-300" />
                </div>
                <span className="text-gray-300">Autonomous Quality Control</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-8 h-8 bg-orange-600/30 rounded-lg flex items-center justify-center">
                  {/* @ts-ignore */}{/* @ts-ignore */}<Zap className="w-4 h-4 text-orange-300" />
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                {/* @ts-ignore */}{/* @ts-ignore */}<Factory className="w-5 h-5 mr-2" />
              ...
              <div className="relative w-full h-96 bg-gradient-to-br from-orange-800/20 to-red-800/20 rounded-2xl border border-orange-400/20 backdrop-blur-sm">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative">
                    ...
                    <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-8 w-8 h-8 bg-red-400 rounded animate-spin" style={{ animationDuration: '2s', animationDirection: 'reverse' }}></div>
                    ...
                    <div className="absolute right-0 top-1/2 transform -translate-y-1/2 translate-x-8 w-8 h-8 bg-orange-400 rounded animate-spin" style={{ animationDuration: '3s', animationDirection: 'reverse' }}></div>
                  </div>
                </div>

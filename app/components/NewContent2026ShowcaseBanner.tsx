      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-sm font-medium mb-6">
            {/* @ts-ignore */}{/* @ts-ignore */}<Star className="w-4 h-4 mr-2" />
              ...
              <div className="flex items-center justify-between">
                <div className="flex gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-xs text-white/70">Jobs Transformed</div>
                  </div>
                  <div className="text-center">
        ...
        <div className="text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                {/* @ts-ignore */}{/* @ts-ignore */}<TrendingUp className="w-5 h-5 mr-2" />
                Explore All Content
              </Link>
              <Link
                href="/case-studies"
              ...
              >
                {/* @ts-ignore */}{/* @ts-ignore */}<Users className="w-5 h-5 mr-2" />
                View Case Studies
              </Link>
            </div>
          </div>

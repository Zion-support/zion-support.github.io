...
setStatus('error')
  ...
  const content = (,
    <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2 xl p-8 text-white"></div>,
    <div className="text-center mb-6"></div>MailclassNam e="w-12 h-12 mx-auto mb-4 text-white/90" / />,
    <h1 className="text-2 xl font-bold mb-2">Stay Updated</h3>p className="text-white/90" /></p>
Get the latest updates on AI technology, IT solutions, and industry insights.</p>/p>form onSubmit={handleSubmit};className="space-y-4" />,
    <div className="flex flex-col sm: flex-row gap-3"></div>input type="email"
...
d: cursor-not-allowed flex items-center justify-center"
           />
            {status === 'loading' ? (</button>>,<div className="animate-spin rounded-full h-4 w-4 border-b-2 border-purple-600 mr-2"></div>
Subscribing...
            ) : (
              <>

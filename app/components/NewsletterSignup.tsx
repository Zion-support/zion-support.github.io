...
const NewsletterSignup: React.FC<NewsletterSignupProps> = ({ variant = 'inline', onClose }) => {</NewsletterSignupProps>
  ...
  const content = (<div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 text-white"></div>
        <div className="text-center mb-6"></div>
        <Mail className="w-12 h-12 mx-auto mb-4 text-white/90" / />
        <h3 className="text-2xl font-bold mb-2">Stay Updated</h3>
        <p className="text-white/90">Get the latest updates on AI technology, IT solutions, and industry insights.</p>
        </p>
  ...
  d:cursor-not-allowed flex items-center justify-center";
      ...
      ;
        ...
        {
  message && (<div className={`flex items-center space-x-2 text-sm ${

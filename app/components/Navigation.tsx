...
const Navigation: React.FC = () => {
  ...
  const emergingTech = [
    { name: '5G Implementation', href: '/5g-implementation', description: '5G network solutions', icon: Zap },
    { name: 'AI 3D Generation', href: '/ai-3d-generation', description: '3D content creation', icon: Sparkles },
    { name: 'Blockchain Solutions', href: '/ai-blockchain-solutions', description: 'Blockchain technology', icon: Shield },
    { name: 'Edge Computing', href: '/ai-edge-computing', description: 'Edge AI solutions', icon: Cpu },
    { name: 'Quantum Computing', href: '/quantum-computing', description: 'Quantum solutions', icon: Target }
  ];

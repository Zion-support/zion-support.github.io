...
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Customer Support', href: '/ai-customer-support', icon: Users, description: 'Customer Service' },
    ...
    { name: 'AI Healthcare', href: '/ai-healthcare', icon: Shield, description: 'Medical AI' },
    ...
    { name: 'AI Process Automation', href: '/ai-automation', icon: Settings, description: 'Process AI' },
  ...
  const itServices = [
    ...
    { name: 'Cloud Migration', href: '/cloud-migration', icon: Cloud, description: 'Migration Services' },
    { name: 'DevOps & CI/CD', href: '/devops', icon: Settings, description: 'Development Ops' },
    ...
    { name: 'IT Infrastructure', href: '/it-infrastructure', icon: Settings, description: 'Enterprise Infrastructure' },
    ...
    { name: 'Process Automation', href: '/process-automation', icon: Settings, description: 'Workflow Automation' },
  ...
  const microSaasServices = [
    ...
    { name: 'Project Management Pro', href: '/project-management-pro', icon: Calendar, description: 'Project Management' },
    ...
    { name: 'Property Management AI', href: '/property-management-ai', icon: Settings, description: 'Real Estate' },
    { name: 'Legal Document Manager', href: '/legal-document-manager', icon: FileText, description: 'Legal & Compliance' },
    ...
    { name: 'AI Writing Assistant', href: '/ai-writing-assistant', icon: FileText, description: 'Content Creation' }
  ];

  const emergingTech = [
    { name: 'Quantum Computing', href: '/quantum-computing', icon: Cpu, description: 'Quantum Solutions' },
    { name: 'Robotics & Automation', href: '/robotics', icon: Settings, description: 'Intelligent Robotics' },
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center space-x-3" onClick={closeAllMenus}>
            <div className="relative">
              ...
              <div className="absolute -inset-1 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-lg blur opacity-30"></div>
            </div>
              ...
              <div>
                ...
                {aiServicesOpen && (
                  <div className="mt-2 space-y-2 pl-6">
                    ...
                    <Link
                      href="/ai-services"
                      className="block text-cyan-400 hover:text-cyan-300 transition-colors duration-300 text-sm font-medium"
                      onClick={closeAllMenus}
                    >

          ...
          <div className="hidden lg:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <div className="relative">
                ...
                {servicesOpen && (
                  <div className="absolute left-0 mt-2 w-64 bg-slate-800/95 backdrop-blur-md rounded-lg shadow-xl py-2 z-50 border border-cyan-500/20">
                    <Link to="/ai-services" className="block px-4 py-3 text-sm text-gray-300 hover:text-cyan-400 hover:bg-slate-700/50 transition-colors flex items-center">
                      <Brain className="w-4 h-4 mr-3" />
                      AI Services
                    </Link>
                    <Link to="/it-services" className="block px-4 py-3 text-sm text-gray-300 hover:text-cyan-400 hover:bg-slate-700/50 transition-colors flex items-center">
                      <Settings className="w-4 h-4 mr-3" />
                      IT Services
                    </Link>
                    <Link to="/micro-saas" className="block px-4 py-3 text-sm text-gray-300 hover:text-cyan-400 hover:bg-slate-700/50 transition-colors flex items-center">
                      <Zap className="w-4 h-4 mr-3" />
                      Micro SaaS
                    </Link>
                    <div className="border-t border-gray-600 my-2"></div>
                    <Link to="/pricing" className="block px-4 py-3 text-sm text-gray-300 hover:text-cyan-400 hover:bg-slate-700/50 transition-colors flex items-center">
                      <Target className="w-4 h-4 mr-3" />
                      Pricing
                    </Link>
                    <Link to="/consultation" className="block px-4 py-3 text-sm text-gray-300 hover:text-cyan-400 hover:bg-slate-700/50 transition-colors flex items-center">
        ...
        {isOpen && (
          <div className="lg:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-slate-800/95 backdrop-blur-md rounded-lg mt-2 border border-cyan-500/20">
              ...
              <Link to="/micro-saas" className="text-gray-300 hover:text-cyan-400 block px-3 py-2 rounded-md text-base font-medium transition-colors">
                Micro SaaS
              </Link>

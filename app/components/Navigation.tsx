                ...
                <div className="absolute top-full left-0 mt-2 w-96 bg-slate-800 rounded-lg shadow-xl border border-cyan-500/20 py-4 z-50">
                  <div className="grid grid-cols-3 gap-4 px-4">
                    ...
                    <div>
                      ...
                      <Link to="/iot-edge-computing" className="block px-3 py-2 text-gray-300 hover:bg-cyan-500/10 hover:text-cyan-400 rounded">
                        IoT & Edge Computing
                      </Link>
                    </div>
                  </div>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="ml-4 space-y-2">
                  ...
                  <Link to="/business-intelligence" className="block text-gray-300 hover:text-cyan-400 transition-colors">
                    Business Intelligence
                  </Link>
                  <Link to="/iot-edge-computing" className="block text-gray-300 hover:text-cyan-400 transition-colors">
                    IoT & Edge Computing
                  </Link>
                </div>
              </div>

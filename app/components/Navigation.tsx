...
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Code Review Pro', href: '/ai-code-review', icon: Code, description: 'Automated code analysis' },
    { name: 'AI SEO Optimizer', href: '/ai-seo-optimizer', icon: Target, description: 'SEO optimization' },
  ...
  const microSaasServices = [
    { name: 'AI Code Review', href: '/ai-code-review', icon: Code, description: 'Automated code analysis' },
    { name: 'AI SEO Optimizer', href: '/ai-seo-optimizer', icon: Target, description: 'SEO automation' },
    { name: 'AI Analytics Dashboard', href: '/ai-analytics-dashboard', icon: BarChart, description: 'Business intelligence' },
    { name: 'AI Marketing Tools', href: '/ai-marketing', icon: TrendingUp, description: 'Marketing automation' },

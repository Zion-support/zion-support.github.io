...
const Navigation: React.FC = () => {
  ...
  const microSaasServices = [
    ...
    { name: 'Zion AI Sales Forecaster', url: '/zion-ai-sales-forecaster', icon: TrendingUp },
    { name: 'Zion AI Customer Insights Pro', url: '/zion-ai-customer-insights-pro', icon: Users },
    { name: 'Zion AI Content Studio Pro', url: '/zion-ai-content-studio-pro', icon: FileText }
  ];

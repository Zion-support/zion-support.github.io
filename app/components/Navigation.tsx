...
const Navigation: React.FC = () => {
  ...
  return (
    <nav className="bg-slate-900/90 backdrop-blur-md shadow-lg sticky top-0 z-50 border-b border-cyan-500/20 hologram-scan">
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden lg:flex space-x-8">
            ...
            <div className="relative">
              ...
              {servicesOpen && (
                <div className="absolute top-full left-0 mt-2 w-96 bg-slate-800/95 backdrop-blur-md rounded-lg shadow-xl border border-cyan-500/30 py-4 z-50">
                  <div className="grid grid-cols-3 gap-4 px-4">
                    ...
                    <div>
                      ...
                      <Link to="/ai-data-analytics" className="block px-3 py-2 text-gray-300 hover:bg-cyan-500/20 hover:text-cyan-400 rounded">
                        AI Data Analytics
                      </Link>
                      <Link to="/ai-cybersecurity" className="block px-3 py-2 text-gray-300 hover:bg-cyan-500/20 hover:text-cyan-400 rounded">
                        AI Cybersecurity
                      </Link>
                      <Link to="/ai-workflow-automation" className="block px-3 py-2 text-gray-300 hover:bg-cyan-500/20 hover:text-cyan-400 rounded">
                        AI Workflow Automation
                      </Link>
                      <Link to="/ai-cloud-infrastructure" className="block px-3 py-2 text-gray-300 hover:bg-cyan-500/20 hover:text-cyan-400 rounded">
                        AI Cloud Infrastructure
                      </Link>
                      <Link to="/ai-ecommerce-solutions" className="block px-3 py-2 text-gray-300 hover:bg-cyan-500/20 hover:text-cyan-400 rounded">
                        AI E-commerce Solutions
                      </Link>
                      <Link to="/ai-mobile-app-development" className="block px-3 py-2 text-gray-300 hover:bg-cyan-500/20 hover:text-cyan-400 rounded">

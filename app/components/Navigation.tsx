        ...
        <div className="lg:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-slate-900/95 backdrop-blur-md border-t border-cyan-500/20">
            ...
            <div className="pt-4 space-y-2">
              <Link
                to="/demo"
                className="block w-full border border-cyan-400 text-cyan-400 px-6 py-3 rounded-lg font-semibold text-center hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300"
                onClick={() => setIsMenuOpen(false)}
              >
                Demo
              </Link>

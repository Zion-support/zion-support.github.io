  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Drug Discovery', path: '/ai-drug-discovery', description: 'Pharmaceutical AI solutions' },
        { name: 'AI Climate Modeling', path: '/ai-climate-modeling', description: 'Environmental AI solutions' },
        { name: 'AI Space Exploration', path: '/ai-space-exploration', description: 'Space technology AI' },
        { name: 'AI Brain-Computer Interface', path: '/ai-brain-computer-interface', description: 'BCI technology' },
        { name: 'AI Quantum Computing', path: '/ai-quantum-computing', description: 'Quantum AI solutions' },
        { name: 'AI Autonomous Vehicles', path: '/ai-autonomous-vehicles', description: 'Self-driving AI' },
        { name: 'AI Smart Manufacturing', path: '/ai-smart-manufacturing', description: 'Industrial AI' },
        { name: 'AI Medical Diagnosis', path: '/ai-medical-diagnosis', description: 'Medical AI diagnostics' },
        { name: 'AI Agriculture', path: '/ai-agriculture', description: 'Farming AI solutions' },
        { name: 'AI Smart Cities', path: '/ai-smart-cities', description: 'Urban AI technology' },
        { name: 'AI Education Platform', path: '/ai-education-platform', description: 'Educational AI' },
        { name: 'AI Video Creator', path: '/ai-video-creator', description: 'AI video production' },
        { name: 'AI Store Manager', path: '/ai-store-manager', description: 'E-commerce AI' },
        { name: 'AI Legal Assistant', path: '/ai-legal-assistant', description: 'Legal AI tools' },
        { name: 'AI Music Producer', path: '/ai-music-producer', description: 'AI music creation' },
        { name: 'AI Property Manager', path: '/ai-property-manager', description: 'Real estate AI' },
        { name: 'AI Stock Trader', path: '/ai-stock-trader', description: 'Trading AI' },
        { name: 'AI Event Planner', path: '/ai-event-planner', description: 'Event AI planning' },
        { name: 'AI Fleet Manager', path: '/ai-fleet-manager', description: 'Fleet AI management' },
        { name: 'AI Garden Manager', path: '/ai-garden-manager', description: 'Gardening AI' },
        { name: 'AI Recipe Generator', path: '/ai-recipe-generator', description: 'Cooking AI' },
        { name: 'AI Game Developer', path: '/ai-game-developer', description: 'Game AI development' },
        { name: 'AI Book Summarizer', path: '/ai-book-summarizer', description: 'Reading AI' },
        { name: 'AI Fitness Coach', path: '/ai-fitness-coach', description: 'Fitness AI' },
        { name: 'AI Interior Designer', path: '/ai-interior-designer', description: 'Design AI' },
        { name: 'AI Job Matcher', path: '/ai-job-matcher', description: 'Career AI' },
        { name: 'AI Travel Planner', path: '/ai-travel-planner', description: 'Travel AI' },
        { name: 'AI Lab Assistant', path: '/ai-lab-assistant', description: 'Scientific AI' },
        { name: 'AI Content Creator', path: '/ai-content-creator', description: 'Content AI' },
        { name: 'AI Manufacturing Optimizer', path: '/ai-manufacturing-optimizer', description: 'Manufacturing AI' },
        { name: 'AI Entertainment Manager', path: '/ai-entertainment-manager', description: 'Entertainment AI' }
      ]
    },
    {
      title: 'IT Services',
      ...
      services: [
        ...
        { name: 'IT Security Audit', path: '/it-security-audit', description: 'Security assessments' },
        { name: 'Mobile Device Management', path: '/mobile-device-management', description: 'MDM solutions' },
        { name: 'Web Development', path: '/web-development', description: 'Modern web apps' },
        { name: 'API Development', path: '/api-development', description: 'API solutions' },
        { name: 'IT Maintenance', path: '/it-maintenance', description: 'System maintenance' },
        { name: 'IT Monitoring', path: '/it-monitoring', description: 'System monitoring' },
        { name: 'IT Compliance', path: '/it-compliance', description: 'Regulatory compliance' },
        { name: 'Data Management', path: '/data-management', description: 'Data governance' },
        { name: 'IT Migration', path: '/it-migration', description: 'System migration' },
        { name: 'IT Strategy', path: '/it-strategy', description: 'Strategic planning' },
        { name: 'IT Integration', path: '/it-integration', description: 'System integration' },
        { name: 'IT Analytics', path: '/it-analytics', description: 'Performance analytics' },
        { name: 'IT Support Desk', path: '/it-support-desk', description: 'Help desk services' }
      ]
    },
    {
      title: 'Micro SAAS',
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Drug Discovery', path: '/ai-drug-discovery', description: 'Pharmaceutical AI' },
        { name: 'AI Climate Modeling', path: '/ai-climate-modeling', description: 'Environmental AI' },
        { name: 'AI Space Exploration', path: '/ai-space-exploration', description: 'Space AI' },
        { name: 'AI Brain-Computer Interface', path: '/ai-brain-computer-interface', description: 'BCI technology' },
        { name: 'AI Quantum Computing', path: '/ai-quantum-computing', description: 'Quantum AI' },
        { name: 'AI Autonomous Vehicles', path: '/ai-autonomous-vehicles', description: 'Self-driving AI' },
        { name: 'AI Smart Manufacturing', path: '/ai-smart-manufacturing', description: 'Industrial AI' },
        { name: 'AI Medical Diagnosis', path: '/ai-medical-diagnosis', description: 'Medical AI' },
        { name: 'AI Agriculture', path: '/ai-agriculture', description: 'Farming AI' },
        { name: 'AI Smart Cities', path: '/ai-smart-cities', description: 'Urban AI' },
        { name: 'AI Education Platform', path: '/ai-education-platform', description: 'Educational AI' }
      ]
    }
  ];

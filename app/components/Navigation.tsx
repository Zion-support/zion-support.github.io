  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Cloud Infrastructure', path: '/ai-cloud-infrastructure', description: 'AI-powered cloud solutions' },
        { name: 'AI E-commerce Solutions', path: '/ai-ecommerce-solutions', description: 'E-commerce AI platforms' },
        { name: 'AI Mobile App Development', path: '/ai-mobile-app-development', description: 'AI mobile applications' }
      ]
    },
    {
      title: 'IT Services',

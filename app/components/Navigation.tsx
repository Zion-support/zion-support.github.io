  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Scheduler', path: '/ai-scheduler', description: 'Intelligent scheduling & coordination' },
        { name: 'AI Writing Assistant', path: '/ai-writing-assistant', description: 'AI-powered content creation' },
        { name: 'AI Email Assistant', path: '/ai-email-assistant', description: 'Smart email marketing' },
        { name: 'AI Analytics Pro', path: '/ai-analytics-pro', description: 'Advanced business analytics' },
        { name: 'AI Design Studio', path: '/ai-design-studio', description: 'AI graphic design tools' },
        { name: 'AI Security Monitor', path: '/ai-security-monitor', description: 'Real-time security monitoring' },
        { name: 'AI Financial Planner', path: '/ai-financial-planner', description: 'Intelligent financial planning' },
        { name: 'AI Learning Platform', path: '/ai-learning-platform', description: 'Personalized learning solutions' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Cybersecurity Suite', path: '/cybersecurity-suite', description: 'Comprehensive security solutions' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Writing Assistant', path: '/ai-writing-assistant', description: 'AI content creation' },
        { name: 'AI Email Assistant', path: '/ai-email-assistant', description: 'Smart email marketing' },
        { name: 'AI Analytics Pro', path: '/ai-analytics-pro', description: 'Advanced analytics' },
        { name: 'AI Design Studio', path: '/ai-design-studio', description: 'AI graphic design' },
        { name: 'AI Security Monitor', path: '/ai-security-monitor', description: 'Security monitoring' },
        { name: 'AI Financial Planner', path: '/ai-financial-planner', description: 'Financial planning' },

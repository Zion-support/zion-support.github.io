            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-80 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="py-1">
                  ...
                  <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider mt-2">Solutions</div>
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-80 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="py-1">
                  ...
                  <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider mt-2">Analytics & Predictions</div>
                  ...
                  <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider mt-2">Business Tools</div>
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="pl-6 space-y-1">
              ...
              <Link to="/zion-smart-expense-tracker" className="text-gray-600 hover:text-blue-600 block px-3 py-2 rounded-md text-sm">Smart Expense Tracker</Link>
            </div>

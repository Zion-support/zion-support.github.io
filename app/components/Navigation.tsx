...
const Navigation: React.FC = () => {
  ...
  const servicesDropdown = [{ name: 'AI Services', href: '/ai-services', icon: Brain }, { name: 'IT Services', href: '/it-services', icon: Code }, { name: 'Cloud Infrastructure', href: '/cloud-infrastructure', icon: Cloud }, { name: 'Cybersecurity', href: '/cybersecurity', icon: Shield }, { name: 'Data Analytics', href: '/data-analytics', icon: BarChart }, { name: 'Web Development', href: '/web-development', icon: Code }, { name: 'Mobile Development', href: '/mobile-development', icon: Code }]

  const companyDropdown = [{ name: 'About Us', href: '/about', icon: Users }, { name: 'Our Team', href: '/team', icon: Users }, { name: 'Careers', href: '/careers', icon: Users }, { name: 'Case Studies', href: '/case-studies', icon: FileText }, { name: 'Blog', href: '/blog', icon: FileText }]

  const resourcesDropdown = [{ name: 'Pricing', href: '/pricing', icon: DollarSign }, { name: 'Consultation', href: '/consultation', icon: Users }, { name: 'Demo', href: '/demo', icon: Code }, { name: 'Support', href: '/support', icon: Users }, { name: 'Tutorials', href: '/tutorials', icon: FileText }]

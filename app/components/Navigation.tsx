...
const Navigation: React.FC = () => {
  ...
  // Service data
  const aiServices = [
    { name: 'AI Analytics', href: '/ai-analytics', description: 'Advanced AI-powered analytics', icon: BarChart },
    { name: 'AI Marketing', href: '/ai-marketing', description: 'AI-driven marketing automation', icon: Target },
    { name: 'AI Customer Support', href: '/ai-customer-support', description: 'Intelligent customer service', icon: Users },
    { name: 'AI Data Analytics', href: '/ai-data-analytics', description: 'Data insights and visualization', icon: Database },
  ];

  const itServices = [
    { name: 'Cloud Services', href: '/cloud-services', description: 'Scalable cloud solutions', icon: Cloud },
    { name: 'Cybersecurity', href: '/cybersecurity', description: 'Advanced security solutions', icon: Shield },
    { name: 'Blockchain', href: '/blockchain', description: 'Blockchain development', icon: Lock },
  ];

  const microSaasServices = [
    { name: 'Micro SaaS Platform', href: '/micro-saas', description: 'Complete SaaS solutions', icon: Code },
  ];

  const emergingTech = [
    { name: 'Quantum Computing', href: '/quantum-computing', description: 'Next-gen computing', icon: Cpu },
    { name: 'IoT Solutions', href: '/iot', description: 'Internet of Things', icon: Smartphone },
  ];

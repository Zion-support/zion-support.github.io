...
import { ChevronDown, Phone, Mail, MapPin, Menu, X, ArrowRight } from 'lucide-react';import { ChevronDown, Phone, Mail, MapPin, Menu, X, Brain, Cloud, Shield, Code, BarChart, Users, Zap, ArrowRight } from 'lucide-react';
...
import { ChevronDown, Phone, Mail, Menu, X, Brain, Code } from 'lucide-react';import { ChevronDown, Phone, Mail, MapPin, Menu, X, Brain, Cloud, Shield, Code, BarChart, Users, Zap } from 'lucide-react';
import { 
  ChevronDown, 
  Phone, 
  Mail, 
...
const Navigation: React.FC = () => {
  ...
  const toggleMenu = () => {
    ...
    setIsOpen(false);
        ...
        { name: 'AI Content Generation', path: '/ai-content-generation' },        { name: 'AI Data Analytics', path: '/ai-data-analytics' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Network Services', path: '/networking' }        { name: 'IT Infrastructure', path: '/it-infrastructure', description: 'Enterprise infrastructure' },
  ...
  const services = [
    ...
    { name: 'AI Advertising', href: '/services-advertising' },    { name: 'IT Solutions', href: '/it-services', icon: Code, description: 'Core IT services' },
  ...
  const itServices = [
    ...
    { name: 'Web Development', href: '/ai-services', icon: Code },
  ...
  const emergingTech = [
    ...
    { name: 'IoT Solutions', href: '/iot-edge-computing', icon: Cloud },
    { name: 'AR/VR Development', href: '/ai-services', icon: Code },
    { name: 'Edge Computing', href: '/iot-edge-computing', icon: Cloud },
  ...
  return (
    ...
    <nav className="bg-slate-900/90 backdrop-blur-md shadow-lg sticky top-0 z-50 border-b border-cyan-500/20 cyber-glow"      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <Link
              ...
              className="text-white hover:text-cyan-400 font-medium transition-colors"          {/* Desktop Menu */}
          <div className="hidden lg:flex items-center space-x-8">
            <Link
              to="/"
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center space-x-1 text-white hover:text-cyan-400 font-medium transition-colors"                className={`flex items-center space-x-1 font-medium transition-colors hover:text-purple-600 ${
                  isScrolled ? 'text-gray-700' : 'text-white'
                }`}
              >
                <span>Services</span>
              ...
              {servicesOpen && (
                <div className="absolute top-full left-0 mt-2 w-96 bg-white rounded-xl shadow-2xl border border-gray-200 py-6 z-50">
                  <div className="grid grid-cols-2 gap-6 px-6">
                              key={index}
                              to={service.href}
                              className="block text-sm text-gray-600 hover:text-blue-600 py-1"                              onClick={closeAllMenus}
                            >
            ...
            <Link
              to="/about"
              className="text-white hover:text-cyan-400 font-medium transition-colors"              onClick={closeAllMenus}
            >
              Case Studies
            </Link>
            <Link
              to="/blog"
              className="text-white hover:text-cyan-400 font-medium transition-colors"            <Link
              to="/blog"
              className={`font-medium transition-colors hover:text-purple-600 ${
                isScrolled ? 'text-gray-700' : 'text-white'
              }`}
            ...
            <Link
              ...
              to="tel:+13024640950"
              className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-4 py-2 rounded-lg font-medium hover:from-purple-700 hover:to-blue-700 transition-all flex items-center space-x-2"              onClick={closeAllMenus}
            >
              Get Started
            </a>
          </div>
        ...
        {isOpen && (
          <div className="lg:hidden border-t border-gray-200 py-6 bg-white">
            <div className="space-y-6">
              <Link 
                to="/" 
                className="block text-lg font-medium text-gray-900 hover:text-purple-600 transition-colors"                onClick={closeAllMenus}
              >
                Home
              </Link>
              <Link 
              ...
              <Link
                to="/contact"
                className="block px-3 py-2 text-gray-700 hover:text-blue-600 font-medium"              <Link 
                to="/contact" 

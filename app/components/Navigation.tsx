...
const Navigation = React.memo<NavigationProps>(({ onSidebarToggle }) => {
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Zion AI Document Processor', path: '/zion-ai-document-processor', icon: <Code className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Email Marketer', path: '/zion-ai-email-marketer', icon: <Zap className="w-4 h-4" /> },

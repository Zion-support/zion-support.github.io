...
const Navigation: React.FC = () => {
  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Mobile Development', path: '/ai-mobile-app-development' },
        { name: 'Web Development', path: '/it-services' },
        { name: 'System Integration', path: '/it-services' }
      ]
    },
    {
      title: 'Micro SAAS',
  ...
  const aiServices = [
    ...
    { name: 'Predictive Analytics', href: '/ai-data-analytics', icon: BarChart },
  ...
  const emergingTech = [
    ...
    { name: 'AR/VR Development', href: '/ai-mobile-app-development', icon: Code },
    { name: 'Edge Computing', href: '/iot-edge-computing', icon: Cloud },
    { name: '5G Solutions', href: '/it-infrastructure', icon: Zap },
  ];

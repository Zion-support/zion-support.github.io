...
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Customer Support', href: '/ai-customer-support', icon: Users, description: 'Customer Service AI' },
    ...
    { name: 'AI Lead Generation', href: '/ai-lead-generation', icon: Target, description: 'Lead Generation AI' },
  ...
  const itServices = [
    ...
    { name: 'System Administration', href: '/system-admin', icon: Settings, description: 'System Management' },
    { name: 'IT Consulting', href: '/it-consulting', icon: Users, description: 'IT Strategy' },
    { name: 'Managed IT Services', href: '/managed-it', icon: Shield, description: '24/7 IT Support' },
    { name: 'IT Training', href: '/it-training', icon: Users, description: 'Staff Development' }
  ];
  ...
  const microSaasServices = [
    ...
    { name: 'Analytics Tools', href: '/analytics-tools', icon: BarChart, description: 'Business Intelligence' },
    { name: 'Communication Tools', href: '/communication-tools', icon: Users, description: 'Team Collaboration' },
    { name: 'HR & Recruitment', href: '/hr-recruitment-tools', icon: Users, description: 'HR Solutions' },
    { name: 'Customer Support Tools', href: '/customer-support-tools', icon: Shield, description: 'Support Tools' },
    { name: 'Sales & CRM', href: '/sales-crm-tools', icon: TrendingUp, description: 'Sales Management' },
    { name: 'Project Management', href: '/project-management-tools', icon: Settings, description: 'Project Planning' },
    { name: 'Content Creation', href: '/content-creation-tools', icon: Code, description: 'Content Tools' }
  ];
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      isScrolled ? 'bg-slate-900/95 backdrop-blur-md shadow-lg' : 'bg-slate-900/95 backdrop-blur-md'
    } border-b border-cyan-500/20 cyber-nav`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <Link href="/" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 font-medium" onClick={closeAllMenus}>
              Home
            </Link>
            ...
            <Link href="/about" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 font-medium" onClick={closeAllMenus}>
              About
            </Link>
            <Link href="/contact" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 font-medium" onClick={closeAllMenus}>
              Contact
            </Link>
            <Link href="/blog" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 font-medium" onClick={closeAllMenus}>
              Blog
            </Link>
          </div>

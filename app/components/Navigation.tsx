  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Data Visualization', path: '/ai-data-visualization', description: 'AI-powered data insights' },
        { name: 'AI Workflow Automation', path: '/ai-workflow-automation', description: 'Workflow optimization' },
        { name: 'AI Cloud Infrastructure', path: '/ai-cloud-infrastructure', description: 'Cloud migration & setup' },
        { name: 'AI E-commerce Solutions', path: '/ai-ecommerce-solutions', description: 'E-commerce platforms' },
        { name: 'AI Mobile App Development', path: '/ai-mobile-app-development', description: 'Mobile applications' }
      ]
    },
    {
      title: 'IT Services',
      ...
      services: [
        ...
        { name: 'Micro SAAS', path: '/micro-saas', description: '50+ ready-to-use apps' }
      ]
    },
    {
      title: 'Micro SAAS',
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'IoT Edge', path: '/iot-edge', description: 'Edge computing solutions' },

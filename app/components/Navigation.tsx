  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Network Services', path: '/it-services' }
      ]
    },
    {
      title: 'Micro SAAS',
      ...
      services: [
        ...
        { name: 'Marketing Tools', path: '/ai-marketing' }
      ]
    },
    {
      title: 'Specialized',
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <div className="lg:hidden border-t border-gray-700 py-6 bg-slate-900/95 backdrop-blur-md">
                  ...
                  <div className="ml-4 space-y-2 mt-2">
                    {serviceCategories.map((category, categoryIndex) => (
                      <div key={categoryIndex} className="space-y-1">
                        <div className="text-sm font-medium text-cyan-400 mb-1">{category.title}</div>

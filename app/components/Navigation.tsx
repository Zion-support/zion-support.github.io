  ...
  const navigation = [
    ...
    { name: 'About', href: '/about', icon: InformationCircleIcon },
    {
      ...
      submenu: [
        ...
        { name: 'AI Customer Feedback Analyzer', href: '/ai-customer-feedback-analyzer', icon: ChartBarIcon },
        { name: 'AI Inventory Optimizer Pro', href: '/ai-inventory-optimizer-pro', icon: CircleStackIcon },
        { name: 'AI Legal Document Analyzer', href: '/ai-legal-document-analyzer', icon: DocumentTextIcon },
        { name: 'AI Medical Diagnosis Assistant', href: '/ai-medical-diagnosis-assistant', icon: UserGroupIcon },

  ...
  const navigation = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { name: 'AI Customer Insights Pro', href: '/ai-customer-insights-pro', icon: ChartBarIcon },
        { name: 'AI Supply Chain Optimizer', href: '/ai-supply-chain-optimizer-pro', icon: CircleStackIcon },
        { name: 'AI HR Assistant Pro', href: '/ai-hr-assistant-pro', icon: UserGroupIcon },
        { name: 'AI Energy Optimizer Pro', href: '/ai-energy-optimizer-pro', icon: BoltIcon },
        { name: 'AI Legal Assistant Pro', href: '/ai-legal-assistant-pro', icon: ShieldCheckIcon },
        { name: 'AI Healthcare Assistant', href: '/ai-healthcare-assistant-pro', icon: CpuChipIcon },
        { name: 'AI Real Estate Optimizer', href: '/ai-real-estate-optimizer-pro', icon: CpuChipIcon },
        { name: 'AI Education Platform', href: '/ai-education-platform-pro', icon: CpuChipIcon },
        { name: 'AI Logistics Optimizer', href: '/ai-logistics-optimizer-pro', icon: CpuChipIcon },
        { name: 'AI FinTech Solutions', href: '/ai-fintech-solutions-pro', icon: CurrencyDollarIcon },
        { name: 'AI Gaming Platform', href: '/ai-gaming-platform-pro', icon: CpuChipIcon },
        { name: 'AI Agriculture Optimizer', href: '/ai-agriculture-optimizer-pro', icon: CpuChipIcon },
        { name: 'AI Retail Optimizer', href: '/ai-retail-optimizer-pro', icon: CpuChipIcon },
        { name: 'AI Transportation Optimizer', href: '/ai-transportation-optimizer-pro', icon: CpuChipIcon },
        { name: 'AI Construction Optimizer', href: '/ai-construction-optimizer-pro', icon: CpuChipIcon },
        { name: 'AI Environmental Monitor', href: '/ai-environmental-monitor-pro', icon: CpuChipIcon },
        { name: 'AI Travel Optimizer', href: '/ai-travel-optimizer-pro', icon: CpuChipIcon },
        { name: 'AI Insurance Optimizer', href: '/ai-insurance-optimizer-pro', icon: ShieldCheckIcon },
        { name: 'AI Manufacturing Optimizer', href: '/ai-manufacturing-optimizer-pro', icon: CpuChipIcon },
        { name: 'AI Cybersecurity Pro', href: '/ai-cybersecurity-pro', icon: ShieldCheckIcon },
        { name: 'AI Blockchain Optimizer', href: '/ai-blockchain-optimizer-pro', icon: CpuChipIcon },
        { name: 'AI Space Tech Pro', href: '/ai-space-tech-pro', icon: RocketLaunchIcon },
        { name: 'AI Quantum Computing', href: '/ai-quantum-computing-pro', icon: CpuChipIcon }
      ]
    },
    {
      name: 'IT Solutions',

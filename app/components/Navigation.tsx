...
{ name: 'AI Smart Calendar', path: '/ai-smart-calendar', description: 'Intelligent scheduling and time management', icon: '📅', popular: true },
        ...
        { name: 'AI Advanced Analytics', path: '/ai-advanced-analytics', description: 'Advanced AI-powered analytics platform', icon: '📊', popular: true },
        ...
        { name: 'AI Holographic Collaboration', path: '/ai-holographic-collaboration', description: 'Immersive 3D collaboration platform', icon: '🥽', popular: true }
      ]
    },
    {
      title: 'AI Services',

...
import { Menu, X, ChevronDown, Zap, Cloud, Shield, Database, Code, Smartphone, Brain, Cpu, Server, Wifi, BarChart3, Users, Mail, FileText, MessageSquare, Target, TrendingUp, Sparkles, Calendar, ShoppingCart, Key, QrCode, Share2, Settings, TreePine, Calculator, Box, Link as LinkIcon } from 'lucide-react'
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-slate-800/95 backdrop-blur-lg rounded-lg mt-2 border border-white/10">
              ...
              <div className="px-3 py-2">
                <div className="text-purple-400 font-medium mb-2">Micro SAAS</div>
                <div className="pl-4 space-y-1">
              ...
              {/* Mobile IT Services */}
              <div className="px-3 py-2">
                <div className="text-blue-400 font-medium mb-2">IT Services</div>
                <div className="pl-4 space-y-1">

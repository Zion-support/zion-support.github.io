          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <div className="relative group">
              ...
              <div
                onMouseEnter={() => setServicesOpen(true)}
                onMouseLeave={() => setServicesOpen(false)}
                className="absolute left-0 mt-2 w-72 bg-white rounded-md shadow-lg z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200"
              >
                <div className="py-1">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-80 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="py-1">
                  <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">AI Tools</div>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="px-3 py-2">
              ...
              <div className="ml-4 space-y-1">
                ...
                <Link to="/zion-ai-customer-churn-predictor-pro" className="text-gray-600 hover:text-blue-600 block px-3 py-1 rounded-md text-sm">Churn Predictor Pro</Link>
                <Link to="/zion-ai-customer-sentiment-tracker" className="text-gray-600 hover:text-blue-600 block px-3 py-1 rounded-md text-sm">Sentiment Tracker</Link>

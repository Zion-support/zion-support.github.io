...
import { ChevronDown, Phone, Mail, MapPin, Menu, X, Brain, Cloud, Shield, Code, BarChart, Users, Zap, Target, Star } from 'lucide-react';
              ...
              <div>
                ...
                {servicesOpen && (
                  <div className="mt-4 ml-4 space-y-3">
                    ...
                    <Link
                      to="/services"
                      className="block text-sm text-purple-600 font-medium hover:text-purple-700 transition-colors"
                      onClick={closeAllMenus}
                    >
                      View All Services →
                    </Link>

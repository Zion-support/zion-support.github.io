...
import { Menu, X, ChevronDown, Zap, Cloud, Shield, Database, Code, Brain, BarChart3, Star, ArrowRight, Wrench } from 'lucide-react'
...
const Navigation = React.memo(() => {
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Zion AI Meeting Assistant', path: '/zion-ai-meeting-assistant', icon: <Brain className="w-4 h-4" />, featured: true },

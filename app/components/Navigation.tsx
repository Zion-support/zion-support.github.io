...
const Navigation = React.memo(() => {
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Zion CRM Intelligence', path: '/zion-crm-intelligence', icon: <Database className="w-4 h-4" />, featured: true },
    { name: 'Zion Email Marketing Pro', path: '/zion-email-marketing-pro', icon: <Zap className="w-4 h-4" />, featured: true },
    { name: 'Zion Project Management Pro', path: '/zion-project-management-pro', icon: <Code className="w-4 h-4" />, featured: true },

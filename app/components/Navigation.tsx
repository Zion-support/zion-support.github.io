...
import { ChevronDown, Phone, Mail, MapPin, Menu, X, Brain, Cloud, Shield, Code, BarChart, Users, Zap, ArrowRight, Sparkles, Cpu, Target, Globe, Database, Smartphone, Lock, TrendingUp, Star, Settings, Calendar, CheckSquare, FileText, MessageSquare } from 'lucide-react';
...
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Automation', href: '/ai-workflow-automation', icon: Zap, description: 'Process Automation' },
    ...
    { name: 'AI Voice Cloning', href: '/ai-voice-cloning', icon: MessageSquare, description: 'Voice AI' },
    { name: 'AI 3D Generation', href: '/ai-3d-generation', icon: Globe, description: '3D AI' },
    { name: 'AI Chatbot Builder', href: '/ai-chatbot-builder', icon: MessageSquare, description: 'Chatbot AI' },
    { name: 'AI Scheduler', href: '/ai-scheduler', icon: Calendar, description: 'Scheduling AI' },
    { name: 'AI Writing Assistant', href: '/ai-writing-assistant', icon: Code, description: 'Writing AI' }
  ];
  ...
  const itServices = [
    ...
    { name: 'Compliance', href: '/compliance', icon: Shield, description: 'Compliance Solutions' },
  ...
  const microSaasServices = [
    ...
    { name: 'AI Analytics Dashboard', href: '/ai-analytics-dashboard', icon: BarChart, description: 'Analytics Dashboard' },
    { name: 'AI CRM', href: '/ai-crm', icon: Users, description: 'AI Customer Management' },
    { name: 'Email Optimizer', href: '/ai-email-assistant', icon: Mail, description: 'Email Marketing' },

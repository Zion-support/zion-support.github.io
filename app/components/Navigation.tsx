    ...
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link 
            to="/" 
            className="flex items-center space-x-2 text-2xl font-bold text-cyan-400 neon-text cyber-text"
                  ...
                  <div className="ml-4 space-y-2 mt-2">
                    {serviceCategories.map((category, categoryIndex) => (
                      <div key={categoryIndex}>
                        <div className="text-gray-300 font-semibold text-sm mb-2 flex items-center">
                        ...
                        <div className="ml-6 space-y-1">
                          ...
                          {category.services.length > 3 && (
                            <Link
                              to="/services"
                              className="block text-sm text-cyan-400 hover:text-cyan-300 transition-colors py-1"
                              onClick={closeAllMenus}
                            >

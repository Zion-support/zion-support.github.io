...
const Navigation = React.memo(() => {
  ...
  const aiServices = useMemo(() => [
    ...
    { name: 'AI Image Recognition', path: '/ai-image-recognition', icon: <Brain className="w-4 h-4" /> },
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Zion AI Sales Predictor', path: '/zion-ai-sales-predictor', icon: <BarChart3 className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Churn Predictor', path: '/zion-ai-customer-churn-predictor', icon: <Shield className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Social Media Manager', path: '/zion-ai-social-media-manager', icon: <Brain className="w-4 h-4" />, featured: true },

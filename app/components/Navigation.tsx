          ...
          <div className="hidden lg:flex items-center space-x-8">
              ...
              {aiServicesOpen && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-slate-800/95 backdrop-blur-lg rounded-lg shadow-xl border border-cyan-500/20 p-6">
                  <div className="grid grid-cols-1 gap-3">
                    ...
                    <Link to="/ai-quantum-computing" className="flex items-center space-x-3 p-2 rounded-lg hover:bg-cyan-500/10 transition-colors">
                      <Cpu className="w-5 h-5 text-cyan-400" />
                      <div>
                        <div className="font-medium text-white">AI Quantum Computing</div>
                        <div className="text-sm text-gray-400">Revolutionary quantum solutions</div>
                      </div>
                    </Link>
                  </div>
            ...
            <div className="relative group">
              ...
              {microSaasOpen && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-slate-800/95 backdrop-blur-lg rounded-lg shadow-xl border border-cyan-500/20 p-6">
                  <div className="grid grid-cols-1 gap-3">
                    <Link to="/zion-analytics-pro" className="flex items-center space-x-3 p-2 rounded-lg hover:bg-cyan-500/10 transition-colors">
                      <BarChart className="w-5 h-5 text-cyan-400" />
                      <div>
                        <div className="font-medium text-white">Zion Analytics Pro</div>
                        <div className="text-sm text-gray-400">AI-powered business intelligence</div>
                      </div>
                    </Link>
                    <Link to="/zion-chat-ai" className="flex items-center space-x-3 p-2 rounded-lg hover:bg-cyan-500/10 transition-colors">
                      <MessageCircle className="w-5 h-5 text-cyan-400" />
                      <div>
                        <div className="font-medium text-white">Zion Chat AI</div>
                        <div className="text-sm text-gray-400">Advanced customer support</div>
                      </div>
                    </Link>
                    <Link to="/zion-invoice-genius" className="flex items-center space-x-3 p-2 rounded-lg hover:bg-cyan-500/10 transition-colors">
                      <FileText className="w-5 h-5 text-cyan-400" />
                      <div>
                        <div className="font-medium text-white">Zion Invoice Genius</div>
                        <div className="text-sm text-gray-400">AI-powered invoicing</div>
                      </div>
                    </Link>
                    <Link to="/zion-security-shield" className="flex items-center space-x-3 p-2 rounded-lg hover:bg-cyan-500/10 transition-colors">
                      <Shield className="w-5 h-5 text-cyan-400" />
                      <div>
                        <div className="font-medium text-white">Zion Security Shield</div>

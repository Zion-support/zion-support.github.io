          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white/10 backdrop-blur-lg border-t border-white/20">
            ...
            <div className="px-3 py-2">
              ...
              <div className="ml-4 space-y-1">
                ...
                <Link to="/ai-content-generator" className="text-gray-300 hover:text-purple-300 block py-1 text-sm" onClick={() => setIsOpen(false)}>AI Content Generator</Link>
                <Link to="/ai-chatbot-builder" className="text-gray-300 hover:text-purple-300 block py-1 text-sm" onClick={() => setIsOpen(false)}>AI Chatbot Builder</Link>
                <Link to="/ai-analytics-dashboard" className="text-gray-300 hover:text-purple-300 block py-1 text-sm" onClick={() => setIsOpen(false)}>AI Analytics Dashboard</Link>
                <Link to="/ai-email-assistant" className="text-gray-300 hover:text-purple-300 block py-1 text-sm" onClick={() => setIsOpen(false)}>AI Email Assistant</Link>
              </div>
            </div>
            ...
            <div className="px-3 py-2">
              ...
              <div className="ml-4 space-y-1">
                ...
                <Link to="/cloud-migration" className="text-gray-300 hover:text-purple-300 block py-1 text-sm" onClick={() => setIsOpen(false)}>Cloud Migration</Link>
                <Link to="/cybersecurity-solutions" className="text-gray-300 hover:text-purple-300 block py-1 text-sm" onClick={() => setIsOpen(false)}>Cybersecurity</Link>
                <Link to="/devops-cicd" className="text-gray-300 hover:text-purple-300 block py-1 text-sm" onClick={() => setIsOpen(false)}>DevOps & CI/CD</Link>
                <Link to="/data-analytics" className="text-gray-300 hover:text-purple-300 block py-1 text-sm" onClick={() => setIsOpen(false)}>Data Analytics</Link>
              </div>
            </div>
            ...
            <div className="px-3 py-2">
              ...
              <div className="ml-4 space-y-1">
                ...
                <Link to="/ai-task-manager" className="text-gray-300 hover:text-purple-300 block py-1 text-sm" onClick={() => setIsOpen(false)}>AI Task Manager</Link>
                <Link to="/ai-expense-tracker" className="text-gray-300 hover:text-purple-300 block py-1 text-sm" onClick={() => setIsOpen(false)}>AI Expense Tracker</Link>
                <Link to="/ai-password-manager" className="text-gray-300 hover:text-purple-300 block py-1 text-sm" onClick={() => setIsOpen(false)}>AI Password Manager</Link>
              </div>
            </div>

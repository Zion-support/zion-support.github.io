...
const Navigation: React.FC = () => {
  ...
  // Service data
  const aiServices = [
    { name: 'AI Healthcare Solutions', href: '/ai-healthcare-solutions', icon: Heart, description: 'Medical AI & diagnostics' },
    { name: 'AI Fintech Solutions', href: '/ai-fintech-solutions', icon: DollarSign, description: 'Financial AI technology' },
  ...
  const itServices = [
    { name: '5G Implementation', href: '/5g-implementation', icon: Wifi, description: 'Next-gen connectivity' },
    { name: 'Edge Computing Solutions', href: '/edge-computing-solutions', icon: Cpu, description: 'Distributed processing' },

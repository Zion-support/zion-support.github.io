  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Telepathic Interface', path: '/ai-telepathic-interface', description: 'Direct brain-computer interface', icon: '🧠', popular: true },
        { name: 'AI 3D Generation Studio', path: '/ai-3d-generation', description: 'AI-powered 3D model creation', icon: '🎨', popular: true },
        { name: 'AI Smart Calendar', path: '/ai-smart-calendar', description: 'Intelligent time management', icon: '📅', popular: true },

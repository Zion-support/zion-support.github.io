...
const Navigation = () => {
  ...
  return (
    <nav className="bg-gray-900/95 backdrop-blur-lg border-b border-white/10 sticky top-0 z-50" role="navigation" aria-label="Main navigation">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 group" aria-label="Zion Tech Group - Home">
              <div className="flex items-center">
                ...
                <span className="ml-2 text-2xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent group-hover:from-purple-300 group-hover:to-blue-300 transition-all duration-300">
                  Zion Tech Group
                </span>
              </div>
            </Link>

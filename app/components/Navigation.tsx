...
import { Menu, X, ChevronDown, Zap, Cloud, Shield, Globe, Database, Code, Smartphone, Users, BarChart3 } from 'lucide-react'
...
export default function Navigation() {
  ...
  const services = [
    ...
    { name: 'Micro SAAS', path: '/micro-saas', icon: <Cloud className="w-4 h-4" /> },
    { name: 'IT Services', path: '/it-services', icon: <Shield className="w-4 h-4" /> },
    { name: 'Cloud Consulting', path: '/it-services/cloud-consulting', icon: <Cloud className="w-4 h-4" /> },
    { name: 'Network Security', path: '/it-services/network-security', icon: <Shield className="w-4 h-4" /> },
    { name: 'Data Backup', path: '/it-services/data-backup-recovery', icon: <Database className="w-4 h-4" /> },

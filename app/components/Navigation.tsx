...
const Navigation: React.FC = memo(() => {
  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      color: 'text-blue-400',
      services: [
        { name: 'IT Consulting', path: '/it-consulting', description: 'Comprehensive IT support' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Business Intelligence', path: '/ai-business-intelligence', description: 'Real-time business intelligence' },
        ...
        { name: 'AI Mobile App Builder', path: '/ai-mobile-app-builder', description: 'AI-assisted app development' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Autonomous Systems', path: '/ai-autonomous-systems', description: 'Self-managing systems' },
        ...
        { name: 'AI Robotics', path: '/ai-robotics', description: 'Intelligent robots' },
        { name: 'AR/VR Solutions', path: '/ar-vr-solutions', description: 'Immersive experiences' },
        { name: 'Smart City Solutions', path: '/smart-city-solutions', description: 'Urban technology solutions' }
      ]
    }
  ];

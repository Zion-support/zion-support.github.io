  ...
  const navigation = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { name: 'Task Manager Pro', href: '/zion-ai-task-scheduler', icon: CheckCircleIcon },
        { name: 'Analytics Dashboard', href: '/zion-smart-analytics-dashboard', icon: ChartBarIcon },
        { name: 'Customer Support Hub', href: '/zion-ai-customer-support-pro', icon: ChatBubbleLeftRightIcon },
        { name: 'Inventory Manager', href: '/zion-smart-inventory-manager', icon: CircleStackIcon },
        ...
        { name: 'AI Translator', href: '/zion-ai-translation-service', icon: GlobeAltIcon },
        ...
        { name: 'AI Legal Assistant', href: '/ai-services', icon: ShieldCheckIcon },
        { name: 'AI Medical Assistant', href: '/ai-services', icon: UserGroupIcon },
        { name: 'AI Education Tutor', href: '/ai-services', icon: AcademicCapIcon },
        { name: 'AI Real Estate Analyzer', href: '/ai-data-visualizer', icon: ChartBarIcon },
        { name: 'AI Supply Chain Optimizer', href: '/ai-solutions', icon: CogIcon }
      ]
    },
    {
      name: 'IT Solutions',
      ...
      submenu: [
        ...
        { name: 'VR Solutions', href: '/augmented-reality-solutions', icon: EyeIcon },
        { name: 'RPA Solutions', href: '/devops-automation', icon: CogIcon },
        { name: 'Low-Code Platform', href: '/web-development', icon: CodeBracketIcon },
        { name: 'Serverless Architecture', href: '/cloud-infrastructure', icon: CloudIcon },
        { name: 'Container Orchestration', href: '/devops-automation', icon: CircleStackIcon },
        { name: 'AI Infrastructure', href: '/ai-solutions', icon: CpuChipIcon },
        { name: 'Data Lake Solutions', href: '/data-analytics', icon: CircleStackIcon }
      ]
    },
    {
      name: 'Resources',

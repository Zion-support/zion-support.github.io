...
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Customer Support', href: '/ai-customer-support', icon: Users, description: 'Support automation' },
    { name: 'AI Sales Automation', href: '/ai-sales-automation', icon: TrendingUp, description: 'Sales optimization' },
    { name: 'AI Data Visualization', href: '/ai-data-visualization', icon: BarChart, description: 'Visual analytics' }
  ];
  ...
  const microSaasServices = [
    ...
    { name: 'AI Workflow Automation', href: '/ai-workflow-automation', icon: Settings, description: 'Process automation' },
    { name: 'AI Data Visualization', href: '/ai-data-visualization', icon: BarChart, description: 'Visual analytics' }
  ];
                      ...
                      {microSaasOpen && (
                        <div className="space-y-2 ml-6">
                          ...
                          <div className="pt-2 border-t border-gray-200 mt-2">
                            <div className="text-xs font-semibold text-gray-500 mb-1">Emerging Tech</div>
                            {emergingTech.slice(0, 3).map((tech, index) => (
                              <Link
                                key={index}
                                to={tech.href}

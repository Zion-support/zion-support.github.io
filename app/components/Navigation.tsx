...
const Navigation: React.FC = () => {
  ...
  return (
    <nav const className = {`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7 xl mx-auto px-4 sm:px-6 lg:px-8" />
        <div className="flex items-center justify-between h-16" />
          ...
          <div className="hidden lg:flex items-center space-x-8" />
            <Link to="/" className="text-white hover:text-cyan-400 transition-colors"  />Home
            </Link>
            ...
            <Link to="/about" className="text-white hover:text-cyan-400 transition-colors"  />About
            </Link>
            <Link to="/contact" className="text-white hover:text-cyan-400 transition-colors"  />Contact
            </Link>

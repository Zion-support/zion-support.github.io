      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
            ...
            {navigationItems.map((item) => (
              <div key={item.label} className="relative group">
                <Link
                  ...
                  onMouseEnter={() => item.dropdown && setIsAiServicesOpen(item.label === 'AI Services')}
                  onMouseLeave={() => item.dropdown && setIsAiServicesOpen(false)}
                >
                  {item.icon}
                ...
                {/* Dropdown Menu */}
                {item.dropdown && item.label === 'AI Services' && isAiServicesOpen && (
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <Link
              to="/demo"
              className="px-4 py-2 text-sm font-medium text-gray-300 hover:text-cyan-400 transition-colors flex items-center space-x-2"
            >

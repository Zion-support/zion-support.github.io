...
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Video Analysis', href: '/ai-video-analysis', icon: Monitor, description: 'Video content analysis' },
    ...
    { name: 'AI Predictive Modeling', href: '/ai-predictive-modeling', icon: TrendingUp, description: 'ML forecasting' },
    ...
    { name: 'AI Supply Chain Intelligence', href: '/ai-supply-chain-ai', icon: Package, description: 'Supply chain optimization' },
    ...
    { name: 'AI Knowledge Management', href: '/ai-knowledge-management', icon: Database, description: 'Smart knowledge systems' },
  ...
  const itServices = [
    ...
    { name: 'API Development', href: '/api-development', icon: LinkIcon, description: 'API solutions' },
    ...
    { name: 'Network Infrastructure', href: '/network-infrastructure', icon: Wifi, description: 'Network setup' },
    { name: 'IT Asset Management', href: '/it-asset-management', icon: Box, description: 'Asset lifecycle' },
    ...
    { name: 'Advanced API Development', href: '/api-development-advanced', icon: LinkIcon, description: 'Enterprise-grade APIs' },
  ...
  const microSaasServices = [
    ...
    { name: 'Zion Social Scheduler', href: '/zion-social-scheduler', icon: Calendar, description: 'Social media management' },
    { name: 'Zion AI Video Editor', href: '/zion-ai-video-editor', icon: Monitor, description: 'AI video editing' },
    ...
    { name: 'Zion AI Supply Chain Optimizer', href: '/zion-ai-supply-chain-optimizer', icon: Package, description: 'Supply chain AI' },
    { name: 'Zion AI Fraud Detector', href: '/zion-ai-fraud-detector', icon: Shield, description: 'Fraud detection' },
    { name: 'Zion AI Customer Service Pro', href: '/zion-ai-customer-service-pro', icon: Users, description: 'Advanced customer service' },
    { name: 'Zion AI Marketing Automation', href: '/zion-ai-marketing-automation', icon: TrendingUp, description: 'Marketing AI' },
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              {microSaasOpen && (
                <div className="absolute top-full left-0 mt-3 w-[450px] bg-slate-900/98 backdrop-blur-xl rounded-2xl shadow-2xl border border-green-500/30 p-6 cyber-card-enhanced holographic-card-enhanced">
                  <div className="mb-4">
                    <h3 className="text-lg font-bold text-green-400 neon-text-enhanced">Micro SaaS</h3>
                    <p className="text-sm text-gray-400">Specialized software solutions for modern businesses</p>
                  </div>
                  <div className="grid grid-cols-1 gap-3 max-h-96 overflow-y-auto custom-scrollbar">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <Link
              to="/consultation"
              className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white px-6 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/25"
            >
              Get Started
            </Link>
          </div>
          ...
          <div className="lg:hidden mobile-menu">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-slate-900/98 backdrop-blur-xl rounded-2xl mt-2 border border-cyan-500/30">
              ...
              <div className="px-3 py-2">
                <Link
                  to="/consultation"
                  className="block w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white px-4 py-3 rounded-lg font-medium text-center transition-all duration-300"
                  onClick={closeAllMenus}
                >
                  Get Started
                </Link>

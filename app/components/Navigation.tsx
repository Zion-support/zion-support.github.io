...
import { Menu, X, ChevronDown, Zap, Cloud, Shield, Database, Code, Brain, BarChart3, Star, ArrowRight, Sidebar as SidebarIcon, Globe, Monitor, Users, Settings, Smartphone, Mail, Phone, MapPin } from 'lucide-react'
...
const Navigation = React.memo<NavigationProps>(({ onSidebarToggle }) => {
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Zion AI Invoice Generator', path: '/zion-ai-invoice-generator', icon: <Code className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Social Scheduler', path: '/zion-ai-social-scheduler', icon: <Zap className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Expense Tracker', path: '/zion-ai-expense-tracker', icon: <BarChart3 className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Customer Support Chatbot', path: '/zion-ai-customer-support-chatbot', icon: <Brain className="w-4 h-4" />, featured: true },

  ...
  const navigationItems = [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { name: '5G Edge Computing', path: '/5g-edge-computing', price: '$699/month', icon: Cpu2 },

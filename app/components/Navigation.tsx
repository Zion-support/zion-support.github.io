  ...
  const navigationItems = [
    {
      ...
      dropdown: [
        { label: 'AI Analytics', href: '/ai-analytics', description: 'Data analytics powered by AI' },
        { label: 'AI Automation', href: '/ai-automation', description: 'Automate your workflows' },
        { label: 'AI Content Generation', href: '/ai-content-generation', description: 'Create content with AI' },
        { label: 'AI Customer Service', href: '/ai-customer-service', description: 'AI-powered customer support' },
    ...
    },
    {
      ...
      dropdown: [
        ...
        { label: 'Mobile Development', href: '/mobile-development', description: 'Mobile app development' },
        { label: 'IT Support', href: '/it-support', description: 'Technical support services' },

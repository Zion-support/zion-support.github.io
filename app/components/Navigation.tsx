  ...
  const navigation = [
    ...
    { name: 'About', href: '/about', icon: InformationCircleIcon },
    {
      ...
      submenu: [
        ...
        { name: 'AI Analytics Dashboard', href: '/analytics-dashboard', icon: ChartBarIcon },
        { name: 'AI Chatbots', href: '/ai-chatbots', icon: ChatBubbleLeftRightIcon },
        { name: 'Computer Vision', href: '/computer-vision', icon: EyeIcon },
        { name: 'AI Automation', href: '/ai-automation', icon: CogIcon }
      ]
    },
    {
      name: 'Micro SaaS',
      ...
      submenu: [
        ...
        { name: 'Social Media Manager', href: '/social-media-manager', icon: ShareIcon },

...
import { Menu, X, ChevronDown, Zap, Cloud, Shield, Globe, Database, Code, Smartphone, Brain, Cpu } from 'lucide-react'
...
export default function Navigation() {
  ...
  const services = [
    ...
    { name: 'Micro SAAS Services', path: '/micro-saas-services', icon: <Cpu className="w-4 h-4" /> },

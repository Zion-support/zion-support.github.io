  ...
  const navigation = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { name: 'AI Analytics Dashboard Pro', href: '/ai-analytics-dashboard', icon: ChartBarIcon },
        ...
        { name: 'AI Social Media Manager Pro', href: '/ai-social-media-manager-pro', icon: ShareIcon },
        ...
        { name: 'AI Medical Assistant Pro', href: '/ai-medical-assistant-pro', icon: UserGroupIcon },

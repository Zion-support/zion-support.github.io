...
import { ChevronDown, Mail, Menu, X, Brain, Cloud, Shield, Code, BarChart, Users, Zap, ArrowRight, Cpu, Target, Globe, Database, Smartphone, TrendingUp, Settings, Calendar, CheckSquare, FileText, MessageCircle, Heart, DollarSign, Box, Monitor, Package, Mic, Workflow, Eye, Wifi, ShoppingCart } from 'lucide-react';
...
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Email Assistant', url: '/ai-email-assistant', icon: Mail },
  ...
  const microSaasServices = [
    ...
    { name: 'Zion AI Video Editor', url: '/ai-video-editor', icon: Monitor },
    { name: 'Zion AI Code Reviewer', url: '/ai-code-assistant-pro', icon: Code },
  ];

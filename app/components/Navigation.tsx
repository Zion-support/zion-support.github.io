...
const Navigation: React.FC = () => {
  ...
  const microSaasServices = [
    ...
    { name: 'Zion Email Automation', href: '/zion-email-automation', icon: MessageCircle, description: 'Email marketing AI' },
    ...
    { name: 'Zion AI Email Assistant', href: '/zion-ai-email-assistant', icon: MessageCircle, description: 'Smart email management' },

...
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Content Generation', href: '/ai-content-generation', icon: MessageSquare, description: 'Content creation' },
    { name: 'AI Sales Automation', href: '/ai-sales-automation', icon: TrendingUp, description: 'Sales optimization' },
    { name: 'AI Customer Support', href: '/ai-customer-support', icon: MessageSquare, description: 'Support automation' },
  ...
  const itServices = [
    ...
    { name: 'IT Infrastructure', href: '/it-infrastructure', icon: Cloud, description: 'Infrastructure solutions' },
    ...
    { name: 'DevOps', href: '/ai-workflow-automation', icon: Settings, description: 'DevOps services' },
    { name: 'Database Services', href: '/ai-data-analytics', icon: Database, description: 'Database management' }
  ];
  ...
  const microSaasServices = [
    ...
    { name: 'AI Document Processing', href: '/micro-saas', icon: MessageSquare, description: 'Document intelligence' },
    { name: 'AI Customer Support', href: '/micro-saas', icon: Users, description: 'Support automation' },
    { name: 'AI Content Writer', href: '/micro-saas', icon: MessageSquare, description: 'Content generation' },
    { name: 'AI Task Manager', href: '/micro-saas', icon: Settings, description: 'Task automation' }
  ];
  ...
  const emergingTech = [
    ...
    { name: 'Robotics', href: '/robotics', icon: Cpu, description: 'Intelligent robots' },

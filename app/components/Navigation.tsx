      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <span className={`transition-colors ${isScrolled ? 'text-white' : 'text-cyan-400'}`}>
              Zion Tech Group
            </span>
          </Link>
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <div className="lg:hidden border-t border-gray-200 py-6 bg-slate-900/95 backdrop-blur-md">

  ...
  const serviceCategories = [
    {
      ...
      services: [
        { name: 'AI Solutions', path: '/ai-services', description: 'Comprehensive AI solutions' },
        ...
        { name: 'AI Sales Automation', path: '/ai-sales-automation', description: 'Sales AI tools' },
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <span className="text-white neon-text">Zion Tech Group</span>
          </Link>
                        ...
                        <div className="space-y-2">
                          {category.services.slice(0, 6).map((service, serviceIndex) => (
                            <Link
                              key={serviceIndex}
                              to={service.path}
                              className="block px-3 py-2 text-sm text-gray-300 hover:bg-cyan-500/10 hover:text-cyan-400 rounded-lg transition-colors group"
                              onClick={closeAllMenus}
                            >

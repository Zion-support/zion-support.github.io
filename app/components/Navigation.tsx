...
import { Menu, X, ChevronDown, Zap, Cloud, Shield, Database, Code, Brain, BarChart3, Star, ArrowRight, Wrench, Truck } from 'lucide-react'
...
const Navigation = React.memo(() => {
  ...
  const aiServices = useMemo(() => [
    ...
    { name: 'AI Supply Chain Optimization', path: '/ai-supply-chain-optimization', icon: <Truck className="w-4 h-4" /> }
  ], [])
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Zion AI Document Processor', path: '/zion-ai-document-processor', icon: <Database className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Video Generator', path: '/zion-ai-video-generator', icon: <Code className="w-4 h-4" />, featured: true },

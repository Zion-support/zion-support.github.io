...
{ name: 'AI Smart Calendar', path: '/ai-smart-calendar', description: 'Intelligent scheduling and time management', icon: '📅', popular: true },
        ...
        { name: 'AI Energy Grid Management Pro', path: '/ai-energy-grid-management-pro', description: 'Intelligent energy optimization', icon: '⚡', popular: true },
        { name: 'AI Legal Research Pro', path: '/ai-legal-research-pro', description: 'Advanced legal research', icon: '⚖️', popular: true },
        ...
        { name: 'AI Autonomous Systems', path: '/ai-autonomous-systems', description: 'Self-managing systems', icon: '🤖', popular: true },
        ...
        { name: 'AI Content Delivery Network', path: '/ai-content-delivery-network', description: 'Intelligent CDN optimization', icon: '🌐', popular: true },
        { name: 'AI API Manager', path: '/ai-api-manager', description: 'Intelligent API management', icon: '🔗', popular: true },
        { name: 'AI Code Security Auditor', path: '/ai-code-security-auditor', description: 'Advanced code security analysis', icon: '🔒', popular: true },
        { name: 'AI Business Intelligence', path: '/ai-business-intelligence', description: 'Advanced business insights', icon: '📊', popular: true },
        { name: 'AI E-commerce Solutions', path: '/ai-ecommerce-solutions', description: 'Complete e-commerce platform', icon: '🛒', popular: true },
        { name: 'AI Investment Optimizer', path: '/ai-investment-optimizer', description: 'AI-powered investment optimization', icon: '📈', popular: true },
        { name: 'AI Manufacturing', path: '/ai-manufacturing', description: 'Smart manufacturing solutions', icon: '🏭', popular: true },
        { name: 'AI Insurance', path: '/ai-insurance', description: 'Intelligent insurance management', icon: '🛡️', popular: true },
        { name: 'AI Education Platform', path: '/ai-education', description: 'Personalized learning platform', icon: '🎓', popular: true },
        { name: 'AI Code Generation', path: '/ai-code-generation', description: 'AI-powered code generation', icon: '💻', popular: true },
        { name: 'AI Customer Support Chatbot', path: '/ai-customer-support-chatbot', description: 'Advanced conversational AI', icon: '💬', popular: true },
        { name: 'AI Email Marketing Automation', path: '/ai-email-marketing-automation', description: 'Intelligent email marketing', icon: '📧', popular: true },
        { name: 'AI Energy', path: '/ai-energy', description: 'Smart energy management', icon: '⚡', popular: true },
        { name: 'AI Healthcare Solutions', path: '/ai-healthcare-solutions', description: 'Comprehensive healthcare AI', icon: '🏥', popular: true },
        { name: 'AI Fintech', path: '/ai-fintech', description: 'Financial technology solutions', icon: '💳', popular: true },
        { name: 'AI Computer Vision', path: '/ai-computer-vision', description: 'Advanced computer vision', icon: '👁️', popular: true },

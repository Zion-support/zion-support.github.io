          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="px-3 py-2">
              ...
              <div className="space-y-1">
                <div className="text-gray-600 px-6 py-1 text-sm font-medium">AI & Machine Learning</div>
                ...
                <div className="text-gray-600 px-6 py-1 text-sm font-medium mt-2">IT Services</div>
                ...
                <div className="text-gray-600 px-6 py-1 text-sm font-medium mt-2">Infrastructure</div>
                ...
                <div className="text-gray-600 px-6 py-1 text-sm font-medium mt-2">Business Solutions</div>
                ...
                <div className="text-gray-600 px-6 py-1 text-sm font-medium mt-2">AI Tools</div>

      ...
      dropdownItems: [
        {
          ...
          items: [
            ...
            { name: 'AI Financial Advisor', path: '/ai-financial-advisor', icon: <DollarSign className="w-4 h-4" /> },
        ...
        },
        {
          ...
          items: [
            ...
            { name: 'Zion AI Project Manager Pro', path: '/zion-ai-project-manager-pro', icon: <Clock className="w-4 h-4" /> }
          ]
        }
      ]
    },
                  ...
                  >
                    ...
                    {item.hasDropdown && (
                      <ChevronDown className={`w-4 h-4 transition-transform duration-300 ${
                        ...
                        (item.name === 'Micro SAAS' && isMicroSaasOpen) ? 'rotate-180' : ''
                      }`} />
                    )}
                  </Link>

                ...
                <div className="absolute top-full left-0 mt-2 w-96 bg-white rounded-lg shadow-xl border py-4 z-50">
                  <div className="grid grid-cols-2 gap-4 px-4">
                    <div>
                      ...
                      <Link to="/it-services-comprehensive" className="block px-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600 rounded">
                        Comprehensive IT
                      </Link>
                    </div>
                    <div>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="ml-4 space-y-2">
                  ...
                  <Link to="/it-services-comprehensive" className="block text-gray-600 hover:text-blue-600 transition-colors">
                    Comprehensive IT
                  </Link>

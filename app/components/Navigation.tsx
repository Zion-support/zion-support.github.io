...
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Customer Support', href: '/ai-customer-support', icon: Bot, description: 'Support automation' },
    { name: 'AI Sales Automation', href: '/ai-sales-automation', icon: TrendingUp, description: 'Sales optimization' },
    { name: 'AI E-commerce Solutions', href: '/ai-ecommerce-solutions', icon: ShoppingCart, description: 'E-commerce AI' },
    { name: 'AI Mobile App Development', href: '/ai-mobile-app-development', icon: Smartphone, description: 'Mobile AI apps' },
    { name: 'AI Workflow Automation', href: '/ai-workflow-automation', icon: Workflow, description: 'Workflow optimization' },
  ...
  const itServices = [
    ...
    { name: 'Mobile Development', href: '/ai-mobile-app-development', icon: Smartphone, description: 'Mobile apps' },
    { name: 'Web Development', href: '/services', icon: Globe, description: 'Web solutions' },
    { name: 'DevOps', href: '/devops', icon: Settings, description: 'DevOps services' },
    ...
    { name: 'IT Infrastructure', href: '/it-infrastructure', icon: Layers, description: 'Infrastructure setup' },
    { name: 'Business Intelligence', href: '/business-intelligence', icon: BarChart, description: 'BI solutions' }
  ];

  const microSaasServices = [
    { name: 'AI Code Review', href: '/micro-saas', icon: Code, description: 'Automated code analysis', price: '$29/mo' },
    { name: 'AI SEO Optimizer', href: '/micro-saas', icon: Target, description: 'SEO automation', price: '$49/mo' },
    { name: 'AI Analytics Dashboard', href: '/micro-saas', icon: BarChart, description: 'Business intelligence', price: '$79/mo' },
    { name: 'AI Marketing Tools', href: '/micro-saas', icon: TrendingUp, description: 'Marketing automation', price: '$99/mo' },
    { name: 'AI Document Processing', href: '/micro-saas', icon: FileText, description: 'Document intelligence', price: '$39/mo' },
    { name: 'AI Customer Support', href: '/micro-saas', icon: Bot, description: 'Support automation', price: '$59/mo' },
    { name: 'AI Email Marketing', href: '/micro-saas', icon: Mail, description: 'Email automation', price: '$69/mo' },
    { name: 'AI Social Media Manager', href: '/micro-saas', icon: Globe, description: 'Social media automation', price: '$89/mo' },
    { name: 'AI Project Manager', href: '/micro-saas', icon: Workflow, description: 'Project automation', price: '$79/mo' },
    { name: 'AI Data Scraper', href: '/micro-saas', icon: Database, description: 'Data extraction', price: '$49/mo' },
    { name: 'AI Invoice Generator', href: '/micro-saas', icon: FileText, description: 'Invoice automation', price: '$39/mo' },
    { name: 'AI Lead Generator', href: '/micro-saas', icon: Target, description: 'Lead generation', price: '$99/mo' },
    { name: 'AI Content Scheduler', href: '/micro-saas', icon: Clock, description: 'Content scheduling', price: '$29/mo' },
    { name: 'AI Performance Monitor', href: '/micro-saas', icon: Activity, description: 'Performance tracking', price: '$59/mo' },
    { name: 'AI Idea Generator', href: '/micro-saas', icon: Lightbulb, description: 'Creative ideation', price: '$19/mo' }
  ];
                  ...
                  <div className="grid grid-cols-3 gap-6 px-6">
                        ...
                        <div className="space-y-2 ml-6">
                          {aiServices.slice(0, 6).map((service, index) => (
                            <Link
                              key={index}
                              to={service.href}
                              className="block text-sm text-gray-600 hover:text-blue-600 py-1 group"
                              onClick={closeAllMenus}
                            >
                          ...
                          <Link
                            to="/ai-services"
                            className="block text-xs text-blue-600 hover:text-blue-700 font-medium mt-2"
                            onClick={closeAllMenus}
                          >
                    ...
                    <div>
                      ...
                      >
                        ...
                        <ChevronDown className={`w-3 h-3 transition-transform ${microSaasOpen ? 'rotate-180' : ''}`} />
                      </button>
                      {microSaasOpen && (
                        <div className="space-y-2 ml-6">

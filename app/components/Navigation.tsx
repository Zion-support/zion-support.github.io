...
import { Menu, X, ChevronDown, Zap, Cloud, Shield, Globe, Database, Code, Smartphone, Brain, BarChart3, Lock, Star, ArrowRight, Users, Mic, Image, Cpu } from 'lucide-react'
...
const Navigation = React.memo(() => {
  ...
  const aiServices = useMemo(() => [
    ...
    { name: 'AI Image Generator', path: '/ai-image-generator', icon: <Image className="w-4 h-4" /> },
  ...
  const itServices = useMemo(() => [
    { name: 'AI-Powered DevOps', path: '/ai-powered-devops', icon: <Cpu className="w-4 h-4" /> },
    { name: 'Edge Computing Solutions', path: '/edge-computing-solutions', icon: <Globe className="w-4 h-4" /> },
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Zion AI Marketing Automation', path: '/zion-ai-marketing-automation', icon: <Zap className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Finance Assistant', path: '/zion-ai-finance-assistant', icon: <BarChart3 className="w-4 h-4" />, featured: true },
    { name: 'Zion AI HR Manager', path: '/zion-ai-hr-manager', icon: <Users className="w-4 h-4" />, featured: true },

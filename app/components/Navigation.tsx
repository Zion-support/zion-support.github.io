...
export default function Navigation() {
  ...
  const aiServices = [
    ...
    { name: 'AI Document Processor', path: '/ai-document-processor', icon: <Database className="w-4 h-4" /> },
    { name: 'AI Financial Advisor', path: '/ai-financial-advisor', icon: <Brain className="w-4 h-4" /> },
  ...
  const itServices = [
    ...
    { name: 'API Development', path: '/api-development', icon: <Server className="w-4 h-4" /> },
  ...
  const microSaasServices = [
    ...
    { name: 'AI Time Tracker', path: '/ai-time-tracker', icon: <Cpu className="w-4 h-4" /> },
    { name: 'AI Project Manager', path: '/ai-project-manager', icon: <Brain className="w-4 h-4" /> },
    { name: 'AI CRM Assistant', path: '/ai-crm-assistant', icon: <Database className="w-4 h-4" /> },
    { name: 'AI Email Manager', path: '/ai-email-manager', icon: <Code className="w-4 h-4" /> }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-1">
            ...
            <Link to="/about" className="text-gray-900 hover:text-purple-600 px-3 py-2 text-sm font-medium transition-colors">
              About
            </Link>
            ...
            <Link to="/5g-implementation" className="text-gray-900 hover:text-purple-600 px-3 py-2 text-sm font-medium transition-colors">
              5G Solutions
            </Link>
            <Link to="/contact" className="text-gray-900 hover:text-purple-600 px-3 py-2 text-sm font-medium transition-colors">
              Contact
            </Link>
            <Link 
              to="/contact" 

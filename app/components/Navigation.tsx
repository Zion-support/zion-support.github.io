  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Quantum Financial Oracle Pro', path: '/ai-quantum-financial-oracle-pro', description: 'Quantum-powered financial analysis', icon: '⚛️', popular: true },
        { name: 'AI 3D Generation Studio Pro', path: '/ai-3d-generation-studio-pro', description: 'AI-powered 3D model generation', icon: '🎨', popular: true },
        { name: 'AI Mobile App Builder Pro', path: '/ai-mobile-app-builder-pro', description: 'AI-powered mobile app development', icon: '📱', popular: true },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Holographic Workspace Pro', path: '/ai-holographic-workspace-pro', description: 'Immersive 3D collaboration', icon: '🥽', popular: false },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Quantum-Safe Security Solutions', path: '/quantum-safe-security', description: 'Future-proof quantum-safe security', icon: '🔒', popular: false }
      ]
    },
    {
      ...
      services: [
        ...
        { name: 'AI Autonomous Systems Platform Pro', path: '/ai-autonomous-systems-platform-pro', description: 'AI-powered autonomous systems', icon: '🤖', popular: true },
        { name: 'AI Blockchain Solutions Pro', path: '/ai-blockchain-solutions-pro', description: 'AI-powered blockchain technology', icon: '⛓️', popular: true },
        { name: 'AI Holographic Workspace Pro', path: '/ai-holographic-workspace-pro', description: 'Immersive 3D collaboration', icon: '🥽', popular: false },
        { name: 'AI Energy Management System Pro', path: '/ai-energy-management-system-pro', description: 'Smart energy optimization', icon: '⚡', popular: true },
        { name: 'AI Music Composition Suite Pro', path: '/ai-music-composition-suite-pro', description: 'AI-powered music creation', icon: '🎵', popular: true },

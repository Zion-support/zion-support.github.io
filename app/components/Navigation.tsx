...
const Navigation: React.FC = memo(() => {
  ...
  return (
    <nav className="nav-futuristic">
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="md:hidden flex items-center">
            <button
              ...
              className="text-gray-700 hover:text-blue-600 focus:outline-none focus:text-blue-600 focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2"
      ...
      {isOpen && (
        <div id="mobile-menu" className="md:hidden glass-effect mx-4 mt-2 rounded-lg" role="menu">

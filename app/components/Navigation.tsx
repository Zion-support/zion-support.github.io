  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Quantum Task Optimizer', path: '/ai-quantum-task-optimizer', description: 'Quantum-powered task optimization', icon: '⚛️', popular: true },
        { name: 'AI Neural Memory Workspace', path: '/ai-neural-memory-workspace', description: 'AI workspace with memory', icon: '🧠', popular: true },
        { name: 'AI Holographic Workspace', path: '/ai-holographic-workspace', description: 'Immersive 3D workspace', icon: '🌐', popular: true }
      ]
    },
    {
      title: 'AI Services',
  ...
  return (
    <>
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled ? 'bg-slate-900/95 backdrop-blur-md shadow-lg border-b border-cyan-400/20 neon-glow-cyan cyber-grid-enhanced' : 'bg-transparent quantum-field'
      }`}>
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link 
            to="/" 
            className="flex items-center space-x-3 text-2xl font-bold group neural-glow"
            onClick={closeAllMenus}
          >
            <div className="w-10 h-10 bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 rounded-xl flex items-center justify-center group-hover:scale-110 transition-all duration-300 shadow-lg shadow-cyan-400/25 quantum-entangled">
              <Zap className="w-6 h-6 text-white" />
            </div>
            <span className="cyber-text-enhanced holographic-text">
              Zion Tech Group
            </span>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <Link
              to="/"
              className="text-white hover:text-cyan-400 transition-all duration-300 font-medium neon-glow-cyan hover:neon-glow-cyan quantum-entangled"
              onClick={closeAllMenus}
            >
              Home
            </Link>

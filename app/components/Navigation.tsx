...
import { Menu, X, ChevronDown, Zap, Cloud, Shield, Globe, Database, Code, Smartphone, Brain, Cpu, Server, Wifi, FileText, DollarSign, BarChart3, Mail } from 'lucide-react'
...
export default function Navigation() {
  ...
  const aiServices = [
    ...
    { name: 'AI Invoice Generator', path: '/ai-invoice-generator', icon: <Globe className="w-4 h-4" /> },

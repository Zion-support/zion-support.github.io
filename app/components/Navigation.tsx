      ...
      {isOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link to="/ai-services" className="text-gray-700 hover:text-blue-600 block px-3 py-2 rounded-md text-sm font-medium ml-4">
              AI Services
            </Link>
            <Link to="/it-services" className="text-gray-700 hover:text-blue-600 block px-3 py-2 rounded-md text-sm font-medium ml-4">
              IT Services
            </Link>
            <Link to="/cloud-infrastructure" className="text-gray-700 hover:text-blue-600 block px-3 py-2 rounded-md text-sm font-medium ml-4">

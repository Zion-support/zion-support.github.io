            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-slate-800 rounded-lg mt-2">
              ...
              <div className="px-3 py-2">
                ...
                <div className="ml-4 space-y-1">
                  <Link to="/ai-services" className="text-gray-300 hover:text-white block px-3 py-2 rounded-md text-sm">
                    AI Services
                  </Link>
                  <Link to="/it-services" className="text-gray-300 hover:text-white block px-3 py-2 rounded-md text-sm">
                    IT Services
                  </Link>
                  <Link to="/micro-saas" className="text-gray-300 hover:text-white block px-3 py-2 rounded-md text-sm">
                    Micro SaaS
                  </Link>
                </div>
              </div>

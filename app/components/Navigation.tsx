  ...
  const navigationItems = [
    ...
    },
    {
      ...
      dropdownItems: [
        ...
        { name: 'IT Strategy Consulting', path: '/it-strategy-consulting' },
    ...
    },
    {
      ...
      dropdownItems: [
        ...
        { name: 'AI Meeting Transcriber', path: '/zion-ai-meeting-transcriber' },
        { name: 'AI Document Analyzer', path: '/zion-ai-document-analyzer' },
        { name: 'AI Email Optimizer', path: '/zion-ai-email-optimizer' }
      ]
    },
    {
      name: '5G Solutions',

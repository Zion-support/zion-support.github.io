...
import { Menu, X, ChevronDown, Cloud, Code, Smartphone, Brain, Cpu, Wifi, Users } from 'lucide-react'
  ...
  const services = [
    ...
    },
    {
      ...
      subServices: [
        ...
        { title: 'Network Infrastructure', href: '/network-infrastructure' },
    ...
    },
    {
      ...
      subServices: [
        ...
        { title: 'Multi-Cloud Strategy', href: '/multi-cloud-strategy' },
    ...
    },
    {
      ...
      subServices: [
        { title: '5G Network Design', href: '/5g-network-design' },
        { title: 'IoT Integration', href: '/iot-integration' },
        { title: 'Edge Computing', href: '/edge-computing' },
        { title: '5G Security', href: '/5g-security' },
        { title: 'Network Optimization', href: '/network-optimization' },
        { title: '5G Testing', href: '/5g-testing' }
      ]
    },
    {
      ...
      subServices: [
        ...
        { title: 'Data Strategy', href: '/data-strategy' },
        { title: 'Change Management', href: '/change-management' },
    ...
    },
    {
      ...
      subServices: [
        { title: 'AI Content Writer Pro', href: '/ai-content-writer-pro' },
        ...
        { title: 'AI Social Media Manager', href: '/ai-social-scheduler' },

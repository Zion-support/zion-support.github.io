...
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Cyber Defense Matrix', href: '/ai-cyber-defense-matrix', icon: Shield, description: 'Advanced cybersecurity' },
    { name: 'AI Business Intelligence Pro', href: '/ai-business-intelligence-pro', icon: BarChart, description: 'Enterprise BI' },
    { name: 'AI Drug Discovery Pro', href: '/ai-drug-discovery-pro', icon: Heart, description: 'Pharmaceutical AI' },
    { name: 'AI Agricultural Intelligence', href: '/ai-agricultural-intelligence-pro', icon: Globe, description: 'Smart farming' },
    { name: 'AI Cloud Infrastructure', href: '/ai-cloud-infrastructure', icon: Cloud, description: 'Intelligent cloud' },
    { name: 'AI Code Generation', href: '/ai-code-generation', icon: Code, description: 'Automated coding' },
    { name: 'AI Code Security Auditor', href: '/ai-code-security-auditor', icon: Shield, description: 'Code security' },
    { name: 'AI Content Delivery Network', href: '/ai-content-delivery-network', icon: Cloud, description: 'Smart CDN' },
    { name: 'AI Content Management', href: '/ai-content-management', icon: FileText, description: 'Smart CMS' },
    { name: 'AI Content Writer', href: '/ai-content-writer', icon: FileText, description: 'AI writing assistant' },
    { name: 'AI Content Studio', href: '/ai-content-studio', icon: FileText, description: 'Content creation studio' },
    { name: 'AI Design Studio', href: '/ai-design-studio', icon: FileText, description: 'AI design tools' },
    { name: 'AI Document Processor', href: '/ai-document-processor', icon: FileText, description: 'Document processing' },
    { name: 'AI Document Scanner', href: '/ai-document-scanner', icon: FileText, description: 'Smart scanning' },
    { name: 'AI Customer Service', href: '/ai-customer-service', icon: Users, description: 'Customer service AI' },
    { name: 'AI Customer Support', href: '/ai-customer-support', icon: MessageCircle, description: 'Support automation' },
    { name: 'AI Customer Support Bot', href: '/ai-customer-support-bot', icon: MessageCircle, description: 'Support bot' },
    { name: 'AI Customer Support Chatbot', href: '/ai-customer-support-chatbot', icon: MessageCircle, description: 'Advanced chatbot' },
    { name: 'AI Cybersecurity Monitor', href: '/ai-cybersecurity-monitor', icon: Shield, description: 'Security monitoring' },
    { name: 'AI Cybersecurity Suite', href: '/ai-cybersecurity-suite', icon: Shield, description: 'Complete security' },
    { name: 'AI Data Visualization', href: '/ai-data-visualization', icon: BarChart, description: 'Smart visualizations' },
    { name: 'AI Translation Services', href: '/ai-translation-services', icon: Globe, description: 'Language translation' }
  ];

      ...
      dropdownItems: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: 'IT Security Services', path: '/it-security-services', icon: <Shield className="w-4 h-4" /> },
            { name: 'IT Project Management', path: '/it-project-management', icon: <Award className="w-4 h-4" /> },
            { name: 'IT Infrastructure', path: '/it-infrastructure', icon: <Database className="w-4 h-4" /> },
            { name: 'IT Support', path: '/it-support', icon: <Phone className="w-4 h-4" /> }
          ]
        },
        {
          name: '5G Solutions',
      ...
      dropdownItems: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: 'AI Lead Generation', path: '/ai-lead-generation', icon: <Users className="w-4 h-4" /> },

  ...
  const navigationItems = useMemo(() => [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { label: 'AI Code Assistant', href: '/ai-code-assistant' },
        { label: 'AI Cybersecurity', href: '/ai-cybersecurity' },
        { label: 'AI Document Intelligence', href: '/ai-document-intelligence' },
    ...
    },
    {
      ...
      dropdown: [
        ...
        { label: 'Zion AI Content Studio', href: '/zion-ai-content-studio' },
        ...
        { label: 'Zion AI Email Assistant', href: '/zion-ai-email-assistant' },
        { label: 'Zion AI Security Monitor', href: '/zion-ai-security-monitor' }
      ]
    },
    {
      label: '5G Solutions',
            ...
            {navigationItems.map((item) => (
              <div key={item.label} className="relative group">
                ...
                {item.dropdown && activeDropdown === item.label && (
                  <div className="absolute top-full left-0 mt-2 w-80 bg-slate-800/95 backdrop-blur-sm rounded-lg border border-white/10 shadow-xl z-50">
                    <div className="py-2">
                    ...
                    <div className="ml-4 space-y-1">
                      {item.dropdown.map((dropdownItem) => (
                        <Link
                          key={dropdownItem.label}
                          to={dropdownItem.href}
                          className="block px-3 py-2 text-sm text-gray-400 hover:text-cyan-400 hover:bg-white/5 rounded-md"
                          onClick={() => setIsMenuOpen(false)}
                        >
                          {dropdownItem.label}
                        </Link>

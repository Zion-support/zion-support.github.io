...
const Navigation = React.memo<NavigationProps>(({ onSidebarToggle }) => {
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Zion AI Code Reviewer Pro', path: '/zion-ai-code-reviewer-pro', icon: <Code className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Contract Analyzer', path: '/zion-ai-contract-analyzer', icon: <FileText className="w-4 h-4" />, featured: true },

...
import { ChevronDown, Phone, Mail, MapPin, Menu, X, Brain, Cloud, Shield, Code, BarChart, Users, Zap, ArrowRight, Sparkles, Cpu, Target, Globe, Database, Smartphone, Lock, TrendingUp, Settings, Calendar, CheckSquare, FileText, MessageCircle, Heart, DollarSign, Box, Monitor, Link as LinkIcon, Server, Package, Share2 } from 'lucide-react';
...
const Navigation: React.FC = () => {
  ...
  const microSaasServices = [
    ...
    { name: 'AI Email Marketing', href: '/ai-email-marketing-automation', icon: Mail, description: 'Email campaign automation' },
    { name: 'AI Feedback Analyzer', href: '/ai-customer-feedback-analyzer', icon: MessageCircle, description: 'Customer feedback analysis' }
  ];

          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <div className="relative group">
              <button
                ...
                className="flex items-center space-x-1 text-gray-300 hover:text-purple-400 transition-colors duration-300 font-medium">
            ...
            <div className="relative group">
              <button
                ...
                className="flex items-center space-x-1 text-gray-300 hover:text-green-400 transition-colors duration-300 font-medium">
            ...
            <div className="relative group">
              <button
                ...
                className="flex items-center space-x-1 text-gray-300 hover:text-orange-400 transition-colors duration-300 font-medium">

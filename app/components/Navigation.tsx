...
const Navigation: React.FC = () => {
  ...
  return (
    <nav className="bg-gray-900 shadow-2xl border-b border-cyan-500/20 relative overflow-hidden">
      {/* Animated background */}
        ...
        <div className="flex justify-between h-20">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 group">
              <h1 className="text-3xl font-bold holographic group-hover:scale-105 transition-transform duration-300">
                Zion Tech Group
              </h1>
            </Link>
          </div>
            ...
            <div className="relative">
              ...
              {servicesOpen && (
                <div
                  onMouseEnter={() => setServicesOpen(true)}
                  onMouseLeave={() => setServicesOpen(false)}
                  className="absolute left-0 mt-2 w-96 bg-gray-800/95 backdrop-blur-lg rounded-xl shadow-2xl border border-cyan-500/20 z-50 neon-glow"
                >
                  <div className="py-2">
                    ...
                    <Link to="/ai-services" className="block px-4 py-3 text-sm text-gray-300 hover:bg-cyan-500/10 hover:text-cyan-400 transition-all duration-300">
                      AI Services
                    </Link>
                    <Link to="/ai-solutions" className="block px-4 py-3 text-sm text-gray-300 hover:bg-cyan-500/10 hover:text-cyan-400 transition-all duration-300">
                      AI Solutions
                    </Link>
                    <Link to="/ai-content-generator" className="block px-4 py-3 text-sm text-gray-300 hover:bg-cyan-500/10 hover:text-cyan-400 transition-all duration-300">
                      AI Content Generator
                    </Link>
                    <Link to="/data-analytics" className="block px-4 py-3 text-sm text-gray-300 hover:bg-cyan-500/10 hover:text-cyan-400 transition-all duration-300">
                      Data Analytics
                    </Link>
                    ...
                    <Link to="/it-services" className="block px-4 py-3 text-sm text-gray-300 hover:bg-purple-500/10 hover:text-purple-400 transition-all duration-300">
                      IT Services
                    </Link>
                    <Link to="/web-development" className="block px-4 py-3 text-sm text-gray-300 hover:bg-purple-500/10 hover:text-purple-400 transition-all duration-300">
                      Web Development
                    </Link>
                    <Link to="/mobile-development" className="block px-4 py-3 text-sm text-gray-300 hover:bg-purple-500/10 hover:text-purple-400 transition-all duration-300">
                      Mobile Development
                    </Link>
                    <Link to="/database-management" className="block px-4 py-3 text-sm text-gray-300 hover:bg-purple-500/10 hover:text-purple-400 transition-all duration-300">
                      Database Management
                    </Link>
                    <Link to="/network-infrastructure" className="block px-4 py-3 text-sm text-gray-300 hover:bg-purple-500/10 hover:text-purple-400 transition-all duration-300">
                    ...
                    <Link to="/cloud-infrastructure" className="block px-4 py-3 text-sm text-gray-300 hover:bg-green-500/10 hover:text-green-400 transition-all duration-300">
                      Cloud Infrastructure
                    </Link>
                    <Link to="/5g-solutions" className="block px-4 py-3 text-sm text-gray-300 hover:bg-green-500/10 hover:text-green-400 transition-all duration-300">
                      5G Solutions
                    </Link>
                    ...
                    <Link to="/digital-transformation" className="block px-4 py-3 text-sm text-gray-300 hover:bg-pink-500/10 hover:text-pink-400 transition-all duration-300">
                      Digital Transformation
                    </Link>
                    <Link to="/micro-saas-solutions" className="block px-4 py-3 text-sm text-gray-300 hover:bg-pink-500/10 hover:text-pink-400 transition-all duration-300">
                    ...
                    <Link to="/zion-ai-content-moderator" className="block px-4 py-3 text-sm text-gray-300 hover:bg-orange-500/10 hover:text-orange-400 transition-all duration-300">
                      AI Content Moderator
                    </Link>
                    <Link to="/zion-ai-customer-churn-predictor" className="block px-4 py-3 text-sm text-gray-300 hover:bg-orange-500/10 hover:text-orange-400 transition-all duration-300">
                      Customer Churn Predictor
                    </Link>
                    <Link to="/zion-ai-customer-sentiment-tracker" className="block px-4 py-3 text-sm text-gray-300 hover:bg-orange-500/10 hover:text-orange-400 transition-all duration-300">
                      Customer Sentiment Tracker
                    </Link>
                    <Link to="/zion-ai-document-analyzer" className="block px-4 py-3 text-sm text-gray-300 hover:bg-orange-500/10 hover:text-orange-400 transition-all duration-300">
                      Document Analyzer
                    </Link>
                    <Link to="/zion-ai-financial-forecaster" className="block px-4 py-3 text-sm text-gray-300 hover:bg-orange-500/10 hover:text-orange-400 transition-all duration-300">
                      Financial Forecaster
                    </Link>
                    <Link to="/zion-ai-sales-predictor" className="block px-4 py-3 text-sm text-gray-300 hover:bg-orange-500/10 hover:text-orange-400 transition-all duration-300">
                      Sales Predictor
                    </Link>
                    <Link to="/zion-ai-workflow-automator" className="block px-4 py-3 text-sm text-gray-300 hover:bg-orange-500/10 hover:text-orange-400 transition-all duration-300">
                      Workflow Automator
                    </Link>
                  </div>
                </div>
      ...
      {isOpen && (
        <div className="md:hidden bg-gray-800/95 backdrop-blur-lg border-t border-cyan-500/20">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link to="/" className="text-gray-300 hover:text-cyan-400 block px-3 py-2 rounded-lg text-base font-medium transition-all duration-300 hover:bg-cyan-500/10">
              Home
            </Link>
            <Link to="/about" className="text-gray-300 hover:text-cyan-400 block px-3 py-2 rounded-lg text-base font-medium transition-all duration-300 hover:bg-cyan-500/10">
              About
            </Link>

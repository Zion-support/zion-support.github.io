...
const Navigation: React.FC<NavigationProps> = ({ onSidebarToggle }) => {
  ...
  const itServices = useMemo(() => [
    ...
    { name: 'AI-Powered DevOps', path: '/ai-powered-devops', icon: <Settings className="w-4 h-4" /> },
    { name: 'Blockchain Solutions', path: '/blockchain-solutions', icon: <Link className="w-4 h-4" /> }
  ], []);

...
const Navigation = React.memo(() => {
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Zion AI Accounting Assistant', path: '/zion-ai-accounting-assistant', icon: <BarChart3 className="w-4 h-4" />, featured: true },
    { name: 'Zion AI 3D Generation', path: '/zion-ai-3d-generation', icon: <Code className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Climate Solutions Pro', path: '/zion-ai-climate-solutions-pro', icon: <Shield className="w-4 h-4" />, featured: true },

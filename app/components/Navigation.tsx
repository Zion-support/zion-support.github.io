...
export default function Navigation() {
  ...
  const aiServices = [
    ...
    { name: 'AI Security Monitor', path: '/ai-security-monitor', icon: <Shield className="w-4 h-4" /> }
  ]
  ...
  const microSaasServices = [
    ...
    { name: 'AI Email Optimizer', path: '/ai-email-optimizer', icon: <Zap className="w-4 h-4" /> },
    { name: 'AI Time Tracker', path: '/ai-time-tracker', icon: <Cpu className="w-4 h-4" /> },
    { name: 'AI Budget Planner', path: '/ai-budget-planner', icon: <Database className="w-4 h-4" /> },
    { name: 'AI CRM Lite', path: '/ai-crm-lite', icon: <Smartphone className="w-4 h-4" /> },
    { name: 'AI Analytics Tools', path: '/analytics-tools', icon: <Database className="w-4 h-4" /> },

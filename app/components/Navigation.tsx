...
const Navigation: React.FC<NavigationProps> = ({ onSidebarToggle }) => {
  ...
  const aiServices = useMemo(() => [
    ...
    { name: "AI Project Management", path: "/ai-project-management", icon: <Package className="w-4 h-4" /> },
  ...
  const mainNavItems = useMemo(() => [
    { name: "Home", path: "/", icon: <Monitor className="w-4 h-4" /> },
  ...
  return (
    <nav className="bg-gradient-to-r from-slate-900/95 via-purple-900/95 to-slate-900/95 backdrop-blur-md border-b border-cyan-500/20 sticky top-0 z-50">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              {activeDropdown === 'ai-services' && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-slate-800/95 backdrop-blur-md rounded-lg shadow-xl border border-cyan-500/20 py-4 z-50">
            ...
            <div className="relative group">
              <button
                className="flex items-center space-x-1 text-gray-300 hover:text-cyan-400 transition-colors py-2"
                onMouseEnter={() => setActiveDropdown('5g-solutions')}
                onMouseLeave={() => setActiveDropdown(null)}
              >

...
import { Menu, X, ChevronDown, Brain, Cpu, Smartphone, Cloud, Shield, Globe, Database, Code, Wifi } from 'lucide-react'
...
export default function Navigation() {
  ...
  const aiServices = [
    ...
    { name: 'AI Email Assistant', path: '/ai-email-assistant', icon: <Smartphone className="w-4 h-4" /> },

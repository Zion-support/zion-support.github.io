...
const Navigation: React.FC = () => {
  ...
  const emergingTech = [
    ...
    { name: 'AI 3D Generation', href: '/ai-3d-generation', description: '3D content creation', icon: Cpu },
    { name: 'Holographic Workspace', href: '/ai-holographic-workspace', description: 'Immersive workspace', icon: Globe },
    { name: 'Edge Computing', href: '/ai-edge-computing', description: 'Edge AI solutions', icon: Smartphone }
  ];

        ...
        <div className="hidden lg:flex items-center gap-6">
          ...
          <div className="relative group">
            ...
            <div className={`absolute top-full left-0 mt-2 w-96 bg-white rounded-lg shadow-lg border border-gray-200 transition-all duration-200 z-50 ${
              ...
              <div className="py-4">
                <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wide">Core Service Categories</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <Link href="/services/ai-services-comprehensive" className="block text-gray-600 hover:text-blue-600 transition-colors">🧠 AI Services</Link>
              <Link href="/services/advanced-micro-saas-solutions" className="block text-gray-600 hover:text-blue-600 transition-colors">🚀 Micro SaaS</Link>
              <Link href="/services/it-services-comprehensive" className="block text-gray-600 hover:text-blue-600 transition-colors">💻 IT Services</Link>

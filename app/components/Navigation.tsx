            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-96 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="py-2">
                  ...
                  <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider mt-2">Automation & Workflow</div>
                  ...
                  <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider mt-2">Document & Analysis</div>
                  ...
                  <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider mt-2">Management Tools</div>
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 mt-2 w-80 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="py-2">
                  ...
                  <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider mt-2">Popular Solutions</div>
                  <Link to="/pricing" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Pricing Plans</Link>
                  ...
                  <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider mt-2">Resources</div>
                  <Link to="/api-docs" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">API Documentation</Link>
                  <Link to="/blog" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Blog & News</Link>
        ...
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 max-h-96 overflow-y-auto">
            ...
            <div className="pl-6 space-y-1">
              ...
              <Link to="/api-docs" className="text-gray-600 hover:text-blue-600 block px-3 py-2 rounded-md text-sm">API Docs</Link>
            </div>

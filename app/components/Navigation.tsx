...
import { ChevronDown, Phone, Mail, MapPin, Menu, X, Brain, Cloud, Shield, Code, BarChart, Users, Zap, Star, ArrowRight } from 'lucide-react';
  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'DevOps & CI/CD', path: '/ai-workflow-automation' },
        { name: 'Database Services', path: '/ai-data-analytics' },
        { name: 'API Development', path: '/services' },
        { name: 'System Integration', path: '/services' },
        { name: 'Network Security', path: '/cybersecurity' },
        { name: 'Data Backup & Recovery', path: '/services' }
      ]
    },
    {
      title: 'Micro SAAS',
      ...
      services: [
        ...
        { name: 'Finance Tools', path: '/micro-saas' },
        { name: 'HR Tools', path: '/micro-saas' }
      ]
    },
    {
      title: 'Specialized',
      ...
      services: [
        ...
        { name: 'AR/VR Solutions', path: '/services' },
        { name: '5G Solutions', path: '/services' }
      ]
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            <span className={`transition-colors ${isScrolled ? 'text-white' : 'text-cyan-400 neon-text'}`}>
              Zion Tech Group
            </span>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <Link 
              to="/contact" 
              className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-6 py-2 rounded-lg font-medium hover:from-cyan-600 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl flex items-center space-x-2"
              onClick={closeAllMenus}
            >
              <span>Contact</span>
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <div className="lg:hidden border-t border-cyan-500/20 py-6 bg-slate-900/95 backdrop-blur-md">
            <div className="space-y-6">
              <Link 
                to="/" 
                className="block text-lg font-medium text-white hover:text-cyan-400 transition-colors"
                onClick={closeAllMenus}
              >
                Home
              </Link>
              ...
              <div>
                <button
                  onClick={toggleServices}
                  className="flex items-center justify-between w-full text-lg font-medium text-white hover:text-cyan-400 transition-colors"
                >
                  <span>Services</span>
                ...
                {servicesOpen && (
                  <div className="mt-4 space-y-4">
                    ...
                    <div className="ml-4 pt-4 border-t border-gray-700">
                      <Link
                        to="/services"
                        className="block text-center bg-gradient-to-r from-cyan-500 to-purple-600 text-white py-2 px-4 rounded-lg font-medium hover:from-cyan-600 hover:to-purple-700 transition-all"
                        onClick={closeAllMenus}
                      >
                        View All Services
                      </Link>
              ...
              <div className="pt-4 border-t border-gray-700">
                ...
                <Link 
                  to="/contact" 
                  className="block w-full text-center bg-gradient-to-r from-cyan-500 to-purple-600 text-white py-3 px-4 rounded-lg font-medium hover:from-cyan-600 hover:to-purple-700 transition-all"
                  onClick={closeAllMenus}
                >
                  Contact Us
                </Link>

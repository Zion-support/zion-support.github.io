...
const Navigation = React.memo(() => {
  ...
  const microSaasServices = useMemo(() => [
    ...
    { name: 'Zion Smart Invoicing', path: '/zion-smart-invoicing', icon: <Zap className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Translator', path: '/zion-ai-translator', icon: <Zap className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Code Reviewer', path: '/zion-ai-code-reviewer', icon: <Code className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Social Media', path: '/zion-ai-social-media', icon: <Zap className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Customer Insights', path: '/zion-ai-customer-insights', icon: <Users className="w-4 h-4" />, featured: true },
    { name: 'Zion AI Email Marketing', path: '/zion-ai-email-marketing', icon: <Zap className="w-4 h-4" />, featured: true },

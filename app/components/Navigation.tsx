  ...
  const services = [
    {
      ...
      href: '/ai-services',
      icon: Zap,
      description: 'AI Content Generation, Computer Vision, NLP'
    },
    {
      title: 'IT Services',
      href: '/it-services',
      icon: Code,
      description: 'Infrastructure, Cybersecurity, Cloud Migration'
    },
    {
      title: 'Micro SAAS',
      href: '/micro-saas-services',
      icon: Smartphone,
      description: 'AI Tools, Analytics, Email Management'
    },
    {

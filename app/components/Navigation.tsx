  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Mobile Development', path: '/ai-mobile-app-development', description: 'Mobile app development' },
                  ...
                  <div className="mt-2 ml-4 space-y-2">
                    {serviceCategories.map((category, categoryIndex) => (
                      <div key={categoryIndex}>
                        <div className="text-sm font-semibold text-cyan-400 mb-2">{category.title}</div>

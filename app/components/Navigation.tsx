...
const Navigation: React.FC = () => {
  ...
  return (
    <nav className="bg-black/80 backdrop-blur-md border-b border-cyan-500/20 shadow-lg sticky top-0 z-50">
            ...
            <div className="relative">
              ...
              {servicesOpen && (
                <div
                  onMouseEnter={() => setServicesOpen(true)}
                  onMouseLeave={() => setServicesOpen(false)}
                  className="absolute left-0 mt-2 w-80 bg-black/90 backdrop-blur-md border border-cyan-500/20 rounded-xl shadow-lg z-50"
                >
                  <div className="py-1">
                    ...
                    <Link to="/it-services" className="block px-4 py-2 text-sm text-gray-300 hover:bg-purple-500/10 hover:text-purple-400 transition-colors">
                      IT Services
                    </Link>
                    <Link to="/web-development" className="block px-4 py-2 text-sm text-gray-300 hover:bg-purple-500/10 hover:text-purple-400 transition-colors">
                      Web Development
                    </Link>
                    <Link to="/mobile-development" className="block px-4 py-2 text-sm text-gray-300 hover:bg-purple-500/10 hover:text-purple-400 transition-colors">
                      Mobile Development
                    </Link>
                    <Link to="/database-management" className="block px-4 py-2 text-sm text-gray-300 hover:bg-purple-500/10 hover:text-purple-400 transition-colors">
                      Database Management
                    </Link>
                    <Link to="/network-infrastructure" className="block px-4 py-2 text-sm text-gray-300 hover:bg-purple-500/10 hover:text-purple-400 transition-colors">
                      Network Infrastructure
                    </Link>
                    
                    <div className="px-4 py-2 text-xs font-semibold text-pink-400 uppercase tracking-wider border-b border-pink-500/20 mt-2">Infrastructure</div>
                    <Link to="/cloud-infrastructure" className="block px-4 py-2 text-sm text-gray-300 hover:bg-pink-500/10 hover:text-pink-400 transition-colors">
                      Cloud Infrastructure
                    </Link>
                    <Link to="/5g-solutions" className="block px-4 py-2 text-sm text-gray-300 hover:bg-pink-500/10 hover:text-pink-400 transition-colors">
                      5G Solutions
                    </Link>
                    ...
                    <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider border-b border-gray-100 mt-2">New AI Services</div>
        ...
        <div className="md:hidden bg-black/90 backdrop-blur-md border-t border-cyan-500/20">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <div className="space-y-1">
              ...
              <div className="text-gray-700 px-3 py-2 text-base font-medium mt-4">New AI Services</div>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Link to="/5g-implementation" className="text-gray-700 hover:text-blue-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">
              5G Solutions
            </Link>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
              ...
              <div className="px-3 py-2">
                ...
                <div className="ml-4 space-y-1">
                  <Link to="/ai-services" className="text-gray-600 hover:text-blue-600 block py-1 text-sm" onClick={() => setIsOpen(false)}>All AI Services</Link>
                  {aiServices.slice(0, 4).map((service, index) => (
                    <Link key={index} to={service.path} className="text-gray-600 hover:text-blue-600 block py-1 text-sm" onClick={() => setIsOpen(false)}>
                      {service.name}
                    </Link>
                  ))}
                </div>
              ...
              <div className="px-3 py-2">
                ...
                <div className="ml-4 space-y-1">
                  <Link to="/it-services" className="text-gray-600 hover:text-blue-600 block py-1 text-sm" onClick={() => setIsOpen(false)}>All IT Services</Link>
              ...
              <div className="px-3 py-2">
                ...
                <div className="ml-4 space-y-1">
                  <Link to="/micro-saas-services" className="text-gray-600 hover:text-blue-600 block py-1 text-sm" onClick={() => setIsOpen(false)}>All Micro SAAS</Link>
              ...
              <Link to="/5g-implementation" className="text-gray-700 hover:text-blue-600 block px-3 py-2 rounded-md text-base font-medium transition-colors">
                5G Solutions
              </Link>

  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Developer Tools', path: '/micro-saas#developer-tools' },
        { name: 'Business Apps', path: '/micro-saas#business-apps' },
        { name: 'Productivity Tools', path: '/micro-saas#productivity' },
        { name: 'Marketing Tools', path: '/micro-saas#marketing' },
        { name: 'Analytics Tools', path: '/micro-saas#analytics' },
        { name: 'Finance Tools', path: '/micro-saas#finance' },
        { name: 'HR Tools', path: '/micro-saas#hr' }
      ]
    },
    {
      title: 'Specialized',
                  ...
                  <div className="ml-4 space-y-2 mt-2">
                    {serviceCategories.map((category, categoryIndex) => (
                      <div key={categoryIndex}>
                        <div className="text-cyan-300 font-semibold text-sm mb-2">{category.title}</div>

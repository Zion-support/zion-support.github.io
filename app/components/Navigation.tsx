...
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Robotics', href: '/ai-robotics', icon: Settings, price: '$2,000/mo' },
    { name: 'AI Blockchain Solutions', href: '/ai-blockchain-solutions', icon: Lock, price: '$1,800/mo' },
    { name: 'AI Autonomous Systems', href: '/ai-autonomous-systems', icon: Settings, price: '$2,500/mo' }
  ];

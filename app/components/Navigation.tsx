      ...
      dropdownItems: [
        {
          ...
          items: [
            { name: 'AI Voice Assistant Pro', path: '/ai-voice-assistant-pro', icon: <Brain className="w-4 h-4" /> },
            { name: 'AI Image Recognition Pro', path: '/ai-image-recognition-pro', icon: <Eye className="w-4 h-4" /> },
      ...
      dropdownItems: [
        {
          ...
          items: [
            ...
            { name: 'AI Image Recognition Pro', path: '/ai-image-recognition-pro', icon: <Eye className="w-4 h-4" /> },
            { name: 'AI Fraud Detection Pro', path: '/ai-fraud-detection-pro', icon: <Shield className="w-4 h-4" /> },
            { name: 'Smart Inventory Optimizer Pro', path: '/smart-inventory-optimizer-pro', icon: <Package className="w-4 h-4" /> },

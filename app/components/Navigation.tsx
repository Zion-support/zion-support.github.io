  ...
  const navigation = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { name: 'Business Analytics Pro', href: '/business-analytics', icon: ChartBarIcon },
        { name: 'Task Manager Pro', href: '/task-manager-pro', icon: CheckCircleIcon },
        { name: 'AI Email Marketing', href: '/ai-email-marketing', icon: EnvelopeIcon },
        { name: 'Cybersecurity Monitor Pro', href: '/cybersecurity-monitor', icon: ShieldCheckIcon },
        { name: 'Cloud Backup Pro', href: '/cloud-backup-pro', icon: CloudIcon },
        { name: 'AI Customer Support Bot', href: '/ai-customer-support', icon: CpuChipIcon },
        { name: 'AI Social Media Manager', href: '/social-media-manager', icon: ShareIcon },
        { name: 'Expense Tracker Pro', href: '/expense-tracker-pro', icon: CurrencyDollarIcon },
        { name: 'Team Collaboration Hub', href: '/team-collaboration', icon: UserGroupIcon }
      ]
    },
    {
      name: 'IT Solutions',
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0 flex items-center group">
              <div className="h-8 w-8 bg-gradient-to-r from-purple-600 to-cyan-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                <span className="text-white font-bold text-lg">Z</span>
              </div>
              <span className="ml-2 text-white font-bold text-xl group-hover:text-cyan-300 transition-colors">Zion Tech Group</span>
                ...
                <Link
                  ...
                  className={`flex items-center px-3 py-2 rounded-md text-sm font-medium transition-colors border-b-2 ${
                    isActive(item.href)
                      ...
                      : 'border-transparent text-gray-300 hover:border-cyan-300 hover:text-white'
                  }`}
                >
          ...
          <div className="lg:hidden flex items-center">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-300 hover:text-white hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white transition-colors"
            >
                ...
                {item.submenu ? (
                  <div>
                    ...
                    <div className={`pl-6 ${
                      ...
                      (item.name === 'Company' && isCompanyOpen)
                        ? 'block' : 'hidden'
                          className="flex items-center px-3 py-2 text-sm text-gray-300 hover:text-white hover:bg-slate-700 transition-colors"
                        >
                          <subItem.icon className="w-4 h-4 mr-3" />

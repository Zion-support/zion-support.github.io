...
import { 
  ChevronDown, Phone, Mail, MapPin, Menu, X, Brain, Cloud, Shield, 
  Code, BarChart, Target, Globe, Database, Smartphone, Lock, 
  TrendingUp, Settings, Calendar, FileText, MessageCircle, Heart, 
  DollarSign, Box, Monitor, Link as LinkIcon, Server, Package, Mic, 
  Workflow, Eye, Wifi, MessageSquare, CheckCircle, ShoppingCart, 
  Zap, Cpu, Users, ArrowRight, Sparkles
} from 'lucide-react';
...
const Navigation: React.FC = () => {
  ...
  const microSaasServices = [
    { name: 'AI Content Studio Pro', href: '/ai-content-studio-pro', icon: FileText, description: 'Complete content creation suite' },
    { name: 'Smart Analytics Dashboard', href: '/smart-analytics-dashboard', icon: BarChart, description: 'Real-time business intelligence' },
    { name: 'AI Customer Support Bot', href: '/ai-customer-support-bot', icon: MessageCircle, description: 'Intelligent chatbot' },
    { name: 'Automated Email Marketing', href: '/automated-email-marketing', icon: Mail, description: 'AI-powered email campaigns' },
    { name: 'Smart Invoice Generator', href: '/smart-invoice-generator', icon: DollarSign, description: 'Automated invoice creation' },
    { name: 'AI Project Manager', href: '/ai-project-manager', icon: Calendar, description: 'Intelligent project management' },
    { name: 'Social Media Scheduler', href: '/social-media-scheduler', icon: Globe, description: 'AI-powered social media management' },
    { name: 'AI Code Assistant', href: '/ai-code-assistant', icon: Code, description: 'Intelligent code completion' },
    { name: 'Smart Inventory Manager', href: '/smart-inventory-manager', icon: Package, description: 'AI-powered inventory management' },
    { name: 'AI SEO Optimizer', href: '/ai-seo-optimizer', icon: Target, description: 'Automated SEO analysis' },
    { name: 'Voice Assistant Platform', href: '/voice-assistant-platform', icon: Mic, description: 'Enterprise-grade voice AI' },
    { name: 'AI Document Processor', href: '/ai-document-processor', icon: FileText, description: 'Intelligent document analysis' }
  ];

  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Code Generator', path: '/ai-code-generator', description: 'AI-powered code generation' },
        { name: 'AI Music Composer', path: '/ai-music-composer', description: 'AI music creation' },
        { name: 'AI Video Creator', path: '/ai-video-creator', description: 'AI video production' },
        { name: 'AI Art Generator', path: '/ai-art-generator', description: 'AI digital art creation' },
        { name: 'AI Research Assistant', path: '/ai-research-assistant', description: 'AI research tools' },
        { name: 'AI Language Tutor', path: '/ai-language-tutor', description: 'AI language learning' },
        { name: 'AI Market Predictor', path: '/ai-market-predictor', description: 'AI market analysis' },
        { name: 'AI Stock Trader', path: '/ai-stock-trader', description: 'AI trading automation' },
        { name: 'AI Smart Home Manager', path: '/ai-smart-home-manager', description: 'AI home automation' },
        { name: 'AI Personal Trainer', path: '/ai-personal-trainer', description: 'AI fitness coaching' },
        { name: 'AI Health Monitor', path: '/ai-health-monitor', description: 'AI health tracking' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Supply Chain Optimizer', path: '/ai-supply-chain-optimizer', description: 'AI supply chain management' },
        { name: 'AI HR Management', path: '/ai-hr-management', description: 'AI human resources' },
        { name: 'AI Energy Optimizer', path: '/ai-energy-optimizer', description: 'AI energy management' },
        { name: 'AI Fleet Management', path: '/ai-fleet-management', description: 'AI fleet optimization' },
        { name: 'AI Manufacturing Optimizer', path: '/ai-manufacturing-optimizer', description: 'AI manufacturing' },
        { name: 'AI Banking Solutions', path: '/ai-banking-solutions', description: 'AI banking automation' },
        { name: 'AI Sustainability Tracker', path: '/ai-sustainability-tracker', description: 'AI sustainability' },

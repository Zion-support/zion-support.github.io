  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Contract Analyzer Pro', path: '/ai-contract-analyzer', description: 'AI-powered contract analysis', icon: '📋', popular: true },
        { name: 'AI Inventory Optimizer Pro', path: '/ai-inventory-optimizer', description: 'Intelligent inventory management', icon: '📦', popular: true },
        { name: 'AI Voice Assistant Pro', path: '/ai-voice-assistant', description: 'Advanced voice AI assistant', icon: '🎤', popular: true },
        { name: 'AI Website Builder Pro', path: '/ai-website-builder', description: 'AI-powered website builder', icon: '🌐', popular: true }
      ]
    },
    {
      title: 'AI Services',
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Blockchain Integration Services', path: '/blockchain-integration', description: 'Web3 and blockchain solutions', icon: '⛓️', popular: true },

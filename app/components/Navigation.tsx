...
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Smart Scheduler', href: '/ai-smart-scheduler', icon: Calendar, description: 'Intelligent scheduling' },
    { name: 'AI Content Optimizer', href: '/ai-content-optimizer', icon: FileText, description: 'Content optimization' },
    { name: 'AI Customer Insights', href: '/ai-customer-insights', icon: Users, description: 'Customer intelligence' },
  ...
  const itServices = [
    { name: 'Cloud Migration Expert', href: '/cloud-migration-expert', icon: Cloud, description: 'Expert cloud migration' },
    { name: 'Cybersecurity Suite', href: '/cybersecurity-suite', icon: Shield, description: 'Enterprise security' },

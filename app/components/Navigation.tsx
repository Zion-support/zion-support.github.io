  ...
  const services = [
    {
      ...
      subServices: [
        ...
        { title: 'Natural Language Processing', href: '/ai-nlp' }
      ]
    },
    {
      title: 'IT Services',
    ...
    },
    {
      ...
      subServices: [
        ...
        { title: 'Multi-Cloud Strategy', href: '/multi-cloud' },
        { title: 'Cloud Backup', href: '/backup-recovery' },
        { title: 'Cloud Monitoring', href: '/it-monitoring' }
      ]
    },
    {
      ...
      subServices: [
        ...
        { title: 'IoT Integration', href: '/iot' },
    ...
    },
    {
      ...
      subServices: [
        ...
        { title: 'Data Strategy', href: '/data-analytics' },
        { title: 'Change Management', href: '/digital-transformation' },
        { title: 'Technology Consulting', href: '/it-consulting' }
      ]
    }
  ]

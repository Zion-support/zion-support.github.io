          ...
          <div className="lg:hidden py-4 border-t border-gray-700">
            <div className="flex flex-col space-y-4">
              ...
              <div className="space-y-2">
                <div className="text-gray-300 font-semibold text-lg border-b border-gray-600 pb-2">AI & IT Services</div>
              ...
              <div className="space-y-2">
                <div className="text-gray-300 font-semibold text-lg border-b border-gray-600 pb-2">Technologies</div>
                <div className="ml-4 space-y-2">
                  {technologies.map((tech, index) => (
                    <Link
                      key={index}
              ...
              {/* Company Section */}
              <div className="space-y-2">
                <div className="text-gray-300 font-semibold text-lg border-b border-gray-600 pb-2">Company</div>
                <div className="ml-4 space-y-2">
              ...
              {/* Resources Section */}
              <div className="space-y-2">
                <div className="text-gray-300 font-semibold text-lg border-b border-gray-600 pb-2">Resources</div>
                <div className="ml-4 space-y-2">

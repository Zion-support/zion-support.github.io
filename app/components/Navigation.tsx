...
import { ChevronDown, Phone, Mail, MapPin, Menu, X, Brain, Cloud, Shield, Code, BarChart, Users, Zap, ArrowRight, Sparkles, Cpu, Target, Globe, Database, Smartphone, Lock, TrendingUp, Star, Settings, Calendar, CheckSquare, FileText, Building, Factory, Home, Briefcase, BookOpen, MessageSquare } from 'lucide-react';
  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Voice Cloning', path: '/ai-voice-cloning', description: 'Voice synthesis services' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Content Generation', path: '/ai-content-generation', description: 'Content creation suite' },
        { name: 'AI CRM', path: '/ai-crm', description: 'Intelligent customer management' },
        { name: 'AI Customer Support', path: '/ai-customer-support', description: 'AI-powered support' },
        { name: 'AI Data Analytics', path: '/ai-data-analytics', description: 'Advanced analytics' },
        { name: 'AI Data Visualization', path: '/ai-data-visualization', description: 'Data visualization' },
        { name: 'AI E-commerce Solutions', path: '/ai-ecommerce-solutions', description: 'E-commerce optimization' },
        { name: 'AI Email Assistant', path: '/ai-email-assistant', description: 'Email management' },
        { name: 'AI Lead Generation', path: '/ai-lead-generation', description: 'Lead generation' },
        { name: 'AI Marketing', path: '/ai-marketing', description: 'Marketing automation' },
        { name: 'AI Mobile App Development', path: '/ai-mobile-app-development', description: 'Mobile development' },
        { name: 'AI Music Composition', path: '/ai-music-composition', description: 'Music generation' },
        { name: 'AI Sales Automation', path: '/ai-sales-automation', description: 'Sales automation' },
        { name: 'AI Scheduler', path: '/ai-scheduler', description: 'Smart scheduling' },
        { name: 'AI Video Generation', path: '/ai-video-generation', description: 'Video creation' },
        { name: 'AI Voice Cloning', path: '/ai-voice-cloning', description: 'Voice synthesis' },
        { name: 'AI Workflow Automation', path: '/ai-workflow-automation', description: 'Workflow automation' },
        { name: 'AI Writing Assistant', path: '/ai-writing-assistant', description: 'Writing tools' },
        { name: 'Analytics Tools', path: '/analytics-tools', description: 'Business analytics' },
        ...
        { name: 'Marketing Tools', path: '/marketing-tools', description: 'Marketing solutions' },
        { name: 'Productivity', path: '/productivity', description: 'Productivity tools' },
        { name: 'Smart Analytics', path: '/smart-analytics', description: 'Intelligent analytics' },

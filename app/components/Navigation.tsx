  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Blockchain Solutions', path: '/ai-blockchain-solutions', description: 'AI-powered blockchain tech', icon: '⛓️', popular: true },
...
{ name: 'AI Smart Calendar', path: '/ai-smart-calendar', description: 'Intelligent scheduling and time management', icon: '📅', popular: true },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Quantum Computing Infrastructure', path: '/quantum-computing-infrastructure', description: 'Next-gen quantum solutions', icon: '⚛️', popular: true },
        { name: 'AI-Powered Quantum Security', path: '/ai-quantum-security', description: 'Quantum-resistant security', icon: '🔒', popular: true },
        { name: 'Neural Interface Development', path: '/neural-interface-development', description: 'Brain-computer interfaces', icon: '🧠', popular: false },
        { name: 'Holographic Display Systems', path: '/holographic-display-systems', description: '3D holographic displays', icon: '🥽', popular: false },
        { name: 'Satellite Management Systems', path: '/satellite-management-systems', description: 'AI-powered satellite ops', icon: '🛰️', popular: true },
        { name: 'Space Mission Control', path: '/space-mission-control', description: 'Advanced mission control', icon: '🚀', popular: false },
        { name: 'Aerospace AI Solutions', path: '/aerospace-ai-solutions', description: 'AI-powered aerospace', icon: '✈️', popular: true },
        { name: 'AI Biotech Platform', path: '/ai-biotech-platform', description: 'Biotechnology AI platform', icon: '🧬', popular: true },
        { name: 'Precision Medicine AI', path: '/precision-medicine-ai', description: 'Personalized medicine AI', icon: '💊', popular: true },
        { name: 'Synthetic Biology Platform', path: '/synthetic-biology-platform', description: 'Bioengineering AI', icon: '🔬', popular: false },
        { name: 'AI Manufacturing 4.0', path: '/ai-manufacturing-4-0', description: 'Smart manufacturing AI', icon: '🏭', popular: true },
        { name: 'Autonomous Robotics Systems', path: '/autonomous-robotics-systems', description: 'AI-powered robotics', icon: '🤖', popular: true },
        { name: 'Digital Twin Technology', path: '/digital-twin-technology', description: 'Real-time digital twins', icon: '👥', popular: false }

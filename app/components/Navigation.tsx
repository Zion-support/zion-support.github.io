...
const Navigation: React.FC = () => {
  ...
  const technologies = [
    { name: 'Machine Learning', url: '/ai-services' },
    { name: 'Natural Language Processing', url: '/ai-services' },
    { name: 'Computer Vision', url: '/ai-services' },
    { name: 'Quantum Computing', url: '/quantum-computing' },
    { name: 'Blockchain', url: '/blockchain-web3' },
    { name: 'IoT Solutions', url: '/iot-edge-computing' }
  ];
  ...
  const resources = [
    ...
    { name: 'GitHub', url: 'https://github.com/ziontechgroup' }
  ];

    ...
    },
    {
      ...
      services: [
        ...
        },
        {
          name: "AI Fintech",
          path: "/ai-fintech",
          description: "Financial AI applications",
        },
        {
        ...
        },
        {
          ...
          description: "Mobile AI applications",
        },
        {
          name: "AI E-commerce Solutions",
          path: "/ai-ecommerce-solutions",
          description: "E-commerce AI platforms",
        },
        {
        ...
        },
        {
          ...
          description: "Intelligent sales processes",
        },
        {
        ...
        },
        {
          ...
          path: "/ai-nlp",
          description: "Advanced NLP solutions",
        },
        {
        ...
        },
        {
          ...
          path: "/ai-research-development",
          description: "Custom AI R&D",
        },
        {
    ...
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          path: "/it-support",
          description: "24/7 IT management",
        },
        {
    ...
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          path: "/ai-mobile-builder",
          description: "AI-assisted app development",
        },
        {
          name: "AI SEO Optimizer",
        ...
        },
        {
          ...
          description: "Advanced sales predictions",
        },
        {
        ...
        },
        {
          ...
          description: "Future outcome predictions",
        },
      ],
    },
    {
      ...
      services: [
        ...
        },
        {
          name: "Robotics",
          path: "/robotics",
          description: "Intelligent robots",
        },
        {
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link href="/" className="flex items-center space-x-2 group">
            ...
            <div className="hidden sm:block">
              <h1 className="text-xl font-bold text-white cyber-text neon-pulse">
                Zion Tech Group
              </h1>
                            ...
                            .map((service, serviceIndex) => (
                              ...
                              >
                                {typeof service.icon === "string" ? (
                                  ...
                                  <service.icon className="w-3 h-3 inline mr-1" />
                                )}{" "}
                                {service.name}
                              </Link>
                            ))}

...
import { ChevronDown, Phone, Mail, MapPin, Menu, X, Brain, Cloud, Shield, Code, BarChart, Users, Zap, ArrowRight, Sparkles, Cpu, Target, Globe, Database, Smartphone, Lock, TrendingUp, Settings, Calendar, CheckSquare, FileText, MessageCircle, Heart, Monitor, Package } from 'lucide-react';
              ...
              {aiServicesOpen && (
                <div className="absolute top-full left-0 mt-2 w-96 bg-slate-800/95 backdrop-blur-md rounded-lg shadow-xl border border-cyan-500/20 p-4 cyber-card">
                  <div className="grid grid-cols-1 gap-2">
                    ...
                    <Link
                      to="/ai-services"
                      className="flex items-center space-x-3 p-3 rounded-lg hover:bg-cyan-500/10 transition-colors duration-300 group border-t border-cyan-500/20 mt-2 pt-3"
                      onClick={closeAllMenus}
                    >
                      <ArrowRight className="w-5 h-5 text-cyan-400" />
                      <div>
                        <div className="text-cyan-400 font-medium">View All AI Services</div>
                        <div className="text-xs text-gray-400">Complete AI solutions portfolio</div>
                      </div>
                    </Link>
                  </div>
                </div>
                ...
                <div className="absolute top-full left-0 mt-2 w-80 bg-slate-800/95 backdrop-blur-md rounded-lg shadow-xl border border-cyan-500/20 p-4 cyber-card">
                  <div className="grid grid-cols-1 gap-2">
                    ...
                    >
                      <ArrowRight className="w-5 h-5 text-cyan-400" />
                      <div>
                        <div className="text-cyan-400 font-medium">View All IT Services</div>
                        <div className="text-xs text-gray-400">Complete IT solutions portfolio</div>
                      </div>
                    </Link>
                  </div>
                </div>
                ...
                <div className="absolute top-full left-0 mt-2 w-96 bg-slate-800/95 backdrop-blur-md rounded-lg shadow-xl border border-cyan-500/20 p-4 cyber-card">
                  <div className="grid grid-cols-1 gap-2">
                    ...
                    >
                      <ArrowRight className="w-5 h-5 text-cyan-400" />
                      <div>
                        <div className="text-cyan-400 font-medium">View All Micro SAAS</div>
                        <div className="text-xs text-gray-400">Complete micro SaaS portfolio</div>
                      </div>
                    </Link>
                  </div>
                </div>

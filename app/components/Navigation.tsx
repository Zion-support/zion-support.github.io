...
import { Phone, Mail, MapPin, Home, Settings, Brain, Cpu, BarChart, MessageSquare, PieChart, Code, Video, Mic, Zap, Eye, Palette, Music, Heart, Cloud, Shield, Database, Menu, X } from 'lucide-react';

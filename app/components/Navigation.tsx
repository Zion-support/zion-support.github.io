...
export default function Navigation() {
  ...
  const itServices = [
    ...
    { name: 'DevOps Solutions', path: '/devops-solutions', icon: <Server className="w-4 h-4" /> },
    { name: 'Data Analytics', path: '/data-analytics', icon: <BarChart3 className="w-4 h-4" /> },
    { name: 'Cybersecurity', path: '/cybersecurity', icon: <Shield className="w-4 h-4" /> },
    { name: 'API Development', path: '/api-development', icon: <Database className="w-4 h-4" /> },
    { name: 'Database Management', path: '/database-management', icon: <Database className="w-4 h-4" /> },
    { name: 'IT Infrastructure', path: '/it-infrastructure', icon: <Server className="w-4 h-4" /> },
    { name: 'Blockchain Solutions', path: '/blockchain-solutions', icon: <Shield className="w-4 h-4" /> },
    { name: 'IoT Development', path: '/iot-development', icon: <Wifi className="w-4 h-4" /> },

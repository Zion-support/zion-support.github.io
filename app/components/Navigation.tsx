...
const Navigation: React.FC<NavigationProps> = ({ onSidebarToggle }) => {
  ...
  const fiveGServices = [
    { name: "5 G Implementation", href: "/5 g-implementation", icon: <Cpu className="w-4 h-4" /> },
    { name: "5 G Edge Computing", href: "/5 g-edge-computing", icon: <Zap className="w-4 h-4" /> },
    { name: "5 G IoT Solutions", href: "/5 g-iot-solutions", icon: <Wifi className="w-4 h-4" /> },
    { name: "5 G Smart City", href: "/5 g-smart-city-solutions", icon: <Building2 className="w-4 h-4" /> }
  ];

...
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Voice Assistant', href: '/ai-voice-assistant', icon: Brain, description: 'Voice AI Solutions' },
    { name: 'AI Predictive Maintenance', href: '/ai-predictive-maintenance', icon: Brain, description: 'Predictive Analytics' },
    { name: 'AI Supply Chain Optimization', href: '/ai-supply-chain-optimization', icon: Brain, description: 'Supply Chain AI' },
    { name: 'AI Quality Control', href: '/ai-quality-control', icon: Brain, description: 'Quality Assurance AI' },
    { name: 'AI Energy Management', href: '/ai-energy-management', icon: Brain, description: 'Smart Energy AI' },
    { name: 'AI Talent Acquisition', href: '/ai-talent-acquisition', icon: Brain, description: 'Recruitment AI' },
    { name: 'AI Risk Management', href: '/ai-risk-management', icon: Brain, description: 'Risk Assessment AI' },
    { name: 'AI Content Moderation', href: '/ai-content-moderation', icon: Brain, description: 'Content Moderation AI' },
    { name: 'AI Translation Services', href: '/ai-translation-services', icon: Brain, description: 'Translation AI' },
    { name: 'AI Personalization Engine', href: '/ai-personalization-engine', icon: Brain, description: 'Personalization AI' },
    { name: 'AI Sentiment Analysis', href: '/ai-sentiment-analysis', icon: Brain, description: 'Sentiment AI' },
    { name: 'AI Video Analytics', href: '/ai-video-analytics', icon: Brain, description: 'Video Analysis AI' },
    { name: 'AI Chatbot Pro', href: '/ai-chatbot-pro', icon: Brain, description: 'Advanced Chatbots' },
    { name: 'AI Code Review', href: '/ai-code-review', icon: Brain, description: 'Code Analysis AI' },
    { name: 'AI Market Research', href: '/ai-market-research', icon: Brain, description: 'Market Intelligence AI' },
    { name: 'AI Legal Document Analysis', href: '/ai-legal-document-analysis', icon: Brain, description: 'Legal AI' },
    { name: 'AI Weather Prediction', href: '/ai-weather-prediction', icon: Brain, description: 'Weather AI' },
    { name: 'AI Traffic Optimization', href: '/ai-traffic-optimization', icon: Brain, description: 'Traffic AI' },
    { name: 'AI Gaming Solutions', href: '/ai-gaming-solutions', icon: Brain, description: 'Gaming AI' },
    { name: 'AI Real Estate Analytics', href: '/ai-real-estate-analytics', icon: Brain, description: 'Real Estate AI' },
  ...
  const itServices = [
    ...
    { name: 'Cloud Security Audit', href: '/cloud-security-audit', icon: Shield, description: 'Security Assessment' },
    { name: 'Disaster Recovery Planning', href: '/disaster-recovery-planning', icon: Shield, description: 'Business Continuity' },
    { name: 'Network Security Implementation', href: '/network-security-implementation', icon: Lock, description: 'Network Security' },
    { name: 'IT Asset Management', href: '/it-asset-management', icon: Database, description: 'Asset Tracking' },
    { name: 'Remote Work Solutions', href: '/remote-work-solutions', icon: Globe, description: 'Remote Infrastructure' },
    { name: 'IT Training & Certification', href: '/it-training-certification', icon: Users, description: 'Team Training' },
    { name: 'API Development & Management', href: '/api-development-management', icon: Code, description: 'API Solutions' },
    { name: 'IT Performance Optimization', href: '/it-performance-optimization', icon: Zap, description: 'Performance Tuning' },
    { name: 'Cloud Cost Optimization', href: '/cloud-cost-optimization', icon: BarChart, description: 'Cost Reduction' },
    { name: 'IT Compliance Management', href: '/it-compliance-management', icon: Shield, description: 'Compliance Solutions' },
  ...
  const microSaasServices = [
    ...
    { name: 'AI Meeting Scheduler', href: '/ai-meeting-scheduler', icon: Calendar, description: 'Smart Scheduling' },
    { name: 'AI Social Media Scheduler', href: '/ai-social-media-scheduler', icon: Globe, description: 'Social Media AI' },
    { name: 'AI Password Manager', href: '/ai-password-manager', icon: Lock, description: 'Secure Password AI' },
    { name: 'AI Time Tracker', href: '/ai-time-tracker', icon: Clock, description: 'Time Management AI' },
    { name: 'AI Note Taker', href: '/ai-note-taker', icon: FileText, description: 'Smart Note Taking' },
    { name: 'AI Habit Tracker', href: '/ai-habit-tracker', icon: CheckSquare, description: 'Habit Building AI' },
    { name: 'AI Recipe Generator', href: '/ai-recipe-generator', icon: Sparkles, description: 'Cooking AI' },
    { name: 'AI Fitness Coach', href: '/ai-fitness-coach', icon: Target, description: 'Fitness AI' },
    { name: 'AI Language Learning', href: '/ai-language-learning', icon: Globe, description: 'Language AI' },
    { name: 'AI Budget Planner', href: '/ai-budget-planner', icon: BarChart, description: 'Financial AI' },
    { name: 'AI Travel Planner', href: '/ai-travel-planner', icon: Globe, description: 'Travel AI' },
    { name: 'AI Home Automation', href: '/ai-home-automation', icon: Settings, description: 'Smart Home AI' },
    { name: 'AI Study Assistant', href: '/ai-study-assistant', icon: FileText, description: 'Learning AI' },
    { name: 'AI Pet Care Tracker', href: '/ai-pet-care-tracker', icon: Target, description: 'Pet Care AI' },
    { name: 'AI Plant Care Assistant', href: '/ai-plant-care-assistant', icon: Sparkles, description: 'Plant Care AI' },
    { name: 'AI Mood Tracker', href: '/ai-mood-tracker', icon: BarChart, description: 'Wellness AI' },
    { name: 'AI Sleep Optimizer', href: '/ai-sleep-optimizer', icon: Clock, description: 'Sleep AI' },
    { name: 'AI Meditation Guide', href: '/ai-meditation-guide', icon: Target, description: 'Mindfulness AI' },
    { name: 'AI Reading Assistant', href: '/ai-reading-assistant', icon: FileText, description: 'Reading AI' },

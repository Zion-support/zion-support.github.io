...
import { Menu, X, ChevronDown, Zap, Cloud, Shield, Database, Code, Smartphone, Brain, Cpu, Server, Wifi, BarChart3, FileText, CheckCircle, CreditCard, Lock, Heart, Calendar, Mail, Share2, MessageSquare, Search } from 'lucide-react'
...
export default function Navigation() {
  ...
  const microSaasServices = [
    { name: 'AI Content Writer Pro', path: '/micro-saas/ai-content-writer-pro', icon: <FileText className="w-4 h-4" /> },
    { name: 'AI Task Manager', path: '/micro-saas/ai-task-manager', icon: <CheckCircle className="w-4 h-4" /> },
    { name: 'AI Expense Tracker', path: '/micro-saas/expense-tracker', icon: <CreditCard className="w-4 h-4" /> },
    { name: 'AI Password Manager', path: '/micro-saas/ai-password-manager', icon: <Lock className="w-4 h-4" /> },
    { name: 'AI Invoice Generator', path: '/micro-saas/ai-invoice-generator', icon: <FileText className="w-4 h-4" /> },
    { name: 'AI Health Tracker', path: '/micro-saas/ai-health-tracker', icon: <Heart className="w-4 h-4" /> },
    { name: 'AI Smart Calendar', path: '/micro-saas/ai-smart-calendar', icon: <Calendar className="w-4 h-4" /> },
    { name: 'AI Email Assistant', path: '/micro-saas/ai-email-assistant', icon: <Mail className="w-4 h-4" /> },
    { name: 'AI Social Manager', path: '/micro-saas/social-manager', icon: <Share2 className="w-4 h-4" /> },
    { name: 'AI Support Bot', path: '/micro-saas/support-bot', icon: <MessageSquare className="w-4 h-4" /> },
    { name: 'AI Analytics Dashboard', path: '/micro-saas/analytics-dashboard', icon: <BarChart3 className="w-4 h-4" /> },
    { name: 'AI SEO Optimizer', path: '/micro-saas/seo-optimizer', icon: <Search className="w-4 h-4" /> }
  ];

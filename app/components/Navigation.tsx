            ...
            {navigation.map((item) => (
              <div key={item.name} className="relative">
                <Link
                  ...
                  className={`flex items-center px-3 py-2 rounded-md text-sm font-medium border-b-2 transition-colors ${
                    isActive(item.href)
                    ...
                    <div className={`pl-6 ${
                      ...
                      {item.submenu.map((subItem) => (
                        <Link
                          key={subItem.name}
                          to={subItem.href}
                          className="flex items-center px-3 py-2 text-sm text-gray-300 hover:text-white hover:bg-slate-700 rounded-md"
                        >
                          <subItem.icon className="w-4 h-4 mr-3" />
                          <span>{subItem.name}</span>
                        </Link>

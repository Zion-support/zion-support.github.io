  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Project Management', path: '/ai-project-management', description: 'AI-powered project planning' },
        { name: 'AI Customer Analytics', path: '/ai-customer-analytics', description: 'Customer insights & segmentation' },
        ...
        { name: 'AI Social Media Management', path: '/ai-social-media-management', description: 'Social media AI' }
      ]
    },
    {
      title: 'IT Services',
      ...
      services: [
        ...
        { name: 'Cloud Migration', path: '/cloud-migration', description: 'Zero-downtime cloud migration' },

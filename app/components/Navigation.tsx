...
const Navigation: React.FC<NavigationProps> = ({ onSidebarToggle }) => {
  ...
  const navigation = [
    ...
    { 
      ...
      icon: BriefcaseIcon,
      submenu: [
        { name: 'AI Services', href: '/ai-services', icon: CogIcon },
        { name: 'IT Services', href: '/it-services', icon: BriefcaseIcon },
        { name: 'Cloud Infrastructure', href: '/cloud-infrastructure', icon: CogIcon },
    ...
    { 
      ...
      submenu: [
        ...
        { name: 'Micro SAAS', href: '/micro-saas-solutions', icon: CogIcon },
        { name: '5G Solutions', href: '/5g-solutions', icon: CogIcon },
      ]
    },

  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Workflow Automation', path: '/ai-workflow-automation', description: 'Business process automation' },
        { name: 'AI Cloud Infrastructure', path: '/ai-cloud-infrastructure', description: 'Cloud AI services' },
        { name: 'AI E-commerce Solutions', path: '/ai-ecommerce-solutions', description: 'E-commerce AI platform' },
        { name: 'AI Mobile App Development', path: '/ai-mobile-app-development', description: 'Mobile AI development' },

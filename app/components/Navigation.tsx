  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI E-commerce Solutions', path: '/ai-ecommerce-solutions', description: 'E-commerce AI tools' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Network Services', path: '/it-infrastructure', description: 'Network infrastructure' }
      ]
    },
    {
      title: 'Micro SAAS',

...
const Navigation: React.FC = () => {
  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Email Marketing', path: '/micro-saas', description: 'Marketing automation' },
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 cyber-glow ${
      isScrolled ? 'bg-gray-900/95 backdrop-blur-md shadow-lg cyber-pulse' : 'bg-transparent'
    }`}>
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link 
            to="/" 
            className="flex items-center space-x-2 text-2xl font-bold quantum-entanglement"
          ...
          >
            ...
            <span className={`transition-colors neon-text cyber-glow ${isScrolled ? 'text-gray-900' : 'text-white'}`}>
              Zion Tech Group
            </span>
          </Link>

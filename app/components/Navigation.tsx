...
const Navigation: React.FC = () => {
  ...
  const itServices = [
    ...
    { name: 'Services Overview', href: '/services', icon: Target }
  ];

  const specializedServices = [
    { name: 'Specialized Services', href: '/specialized-services', icon: Cpu },

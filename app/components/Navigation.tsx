...
import { ChevronDown, Phone, Mail, MapPin, Menu, X, Brain, Cloud, Shield, Code, BarChart, Users, Zap, ArrowRight, Sparkles, Cpu, Target, Globe, Database, Smartphone, Lock, TrendingUp, Settings, Calendar, CheckSquare, FileText, Building, Search } from 'lucide-react';
const Navigation: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Drug Discovery', href: '/ai-drug-discovery-pro', icon: Shield, description: 'Pharmaceutical AI' },
    { name: 'AI Climate Solutions', href: '/ai-climate-solutions-pro', icon: Globe, description: 'Climate AI' },
    { name: 'AI Energy Grid', href: '/ai-energy-grid-management-pro', icon: Zap, description: 'Smart Grid AI' },
    { name: 'AI Financial Crime', href: '/ai-financial-crime-detection-pro', icon: Lock, description: 'Fraud Detection AI' },
    { name: 'AI Agricultural', href: '/ai-agricultural-intelligence-pro', icon: Globe, description: 'AgTech AI' },
    { name: 'AI 3D Generation', href: '/ai-3d-generation', icon: Brain, description: '3D AI Solutions' },
    { name: 'AI Holographic', href: '/ai-holographic-workspace', icon: Brain, description: 'Holographic AI' },
    { name: 'AI Autonomous Systems', href: '/ai-autonomous-systems', icon: Brain, description: 'Autonomous AI' },
    { name: 'AI Blockchain', href: '/ai-blockchain-solutions', icon: Shield, description: 'Blockchain AI' },
    { name: 'AI API Management', href: '/ai-api-management', icon: Settings, description: 'API AI Management' },
    { name: 'AI Business Intelligence', href: '/ai-business-intelligence', icon: BarChart, description: 'BI AI Solutions' },
    { name: 'AI Computer Vision', href: '/ai-computer-vision', icon: Brain, description: 'Vision AI' },
    { name: 'AI Content Delivery', href: '/ai-content-delivery-network', icon: Globe, description: 'CDN AI' },
    { name: 'AI Content Writer', href: '/ai-content-writer', icon: Code, description: 'Writing AI' },
    { name: 'AI CRM Assistant', href: '/ai-crm-assistant', icon: Users, description: 'CRM AI' },
    { name: 'AI Customer Support Bot', href: '/ai-customer-support-bot', icon: Users, description: 'Support Bot AI' },
    { name: 'AI Cybersecurity Monitor', href: '/ai-cybersecurity-monitor', icon: Lock, description: 'Security Monitor AI' },
    { name: 'AI Cybersecurity Suite', href: '/ai-cybersecurity-suite', icon: Lock, description: 'Security Suite AI' },
    { name: 'AI Document Processor', href: '/ai-document-processor', icon: Code, description: 'Document AI' },
    { name: 'AI Document Scanner', href: '/ai-document-scanner', icon: Code, description: 'Scanner AI' },
    ...
    { name: 'AI Email Marketing', href: '/ai-email-marketing', icon: Mail, description: 'Email Marketing AI' },
    { name: 'AI Email Marketing Automation', href: '/ai-email-marketing-automation', icon: Mail, description: 'Email Automation AI' },
    { name: 'AI Energy', href: '/ai-energy', icon: Zap, description: 'Energy AI' },
    { name: 'AI Enterprise Solutions', href: '/ai-enterprise-solutions', icon: Building, description: 'Enterprise AI' },
    { name: 'AI Expense Tracker', href: '/ai-expense-tracker', icon: BarChart, description: 'Expense AI' },
    { name: 'AI Fashion Design', href: '/ai-fashion-design', icon: Sparkles, description: 'Fashion AI' },
    { name: 'AI Financial Advisor', href: '/ai-financial-advisor', icon: TrendingUp, description: 'Financial Advisor AI' },
    { name: 'AI Financial Analyzer', href: '/ai-financial-analyzer', icon: BarChart, description: 'Financial Analysis AI' },
    { name: 'AI Fitness Coach', href: '/ai-fitness-coach', icon: Users, description: 'Fitness AI' },
    { name: 'AI Fraud Detection', href: '/ai-fraud-detection', icon: Shield, description: 'Fraud AI' },
    { name: 'AI Healthcare Solutions', href: '/ai-healthcare-solutions', icon: Shield, description: 'Healthcare AI' },
    { name: 'AI Holographic Workspace', href: '/ai-holographic-workspace', icon: Brain, description: 'Holographic AI' },
    { name: 'AI HR', href: '/ai-hr', icon: Users, description: 'HR AI' },
    { name: 'AI Image Recognition', href: '/ai-image-recognition', icon: Brain, description: 'Image AI' },
    { name: 'AI Infrastructure Monitoring', href: '/ai-infrastructure-monitoring', icon: Settings, description: 'Infrastructure AI' },
    { name: 'AI Inventory Management', href: '/ai-inventory-management', icon: BarChart, description: 'Inventory AI' },
    { name: 'AI Inventory Manager', href: '/ai-inventory-manager', icon: BarChart, description: 'Inventory Manager AI' },
    { name: 'AI Investment Optimizer', href: '/ai-investment-optimizer', icon: TrendingUp, description: 'Investment AI' },
    { name: 'AI Invoice Generator', href: '/ai-invoice-generator', icon: BarChart, description: 'Invoice AI' },
    { name: 'AI Lead Generation', href: '/ai-lead-generation', icon: Target, description: 'Lead Gen AI' },
    { name: 'AI Legal', href: '/ai-legal', icon: FileText, description: 'Legal AI' }
  ];
  const itServices = [
    ...
    { name: 'Cloud Security', href: '/cloud-security', icon: Shield, description: 'Cloud Security' },
    { name: 'Network Solutions', href: '/network-solutions', icon: Globe, description: 'Network Infrastructure' },
    { name: 'IT Support', href: '/it-support', icon: Users, description: 'IT Support Services' },
    { name: 'IT Asset Management', href: '/it-asset-management', icon: Settings, description: 'Asset Management' },
    { name: 'Website Hosting', href: '/website-hosting', icon: Globe, description: 'Hosting Services' },
    { name: 'Mobile Device Management', href: '/mobile-device-management', icon: Smartphone, description: 'Device Management' },
    { name: 'Compliance Services', href: '/compliance-services', icon: Shield, description: 'Compliance Solutions' },
    ...
    { name: 'Accessibility Services', href: '/accessibility', icon: Users, description: 'Accessibility Solutions' }
  ];
  const microSaasServices = [
    ...
    { name: 'AI Code Assistant', href: '/ai-code-assistant', icon: Code, description: 'Code Generation' },
    { name: 'AI Code Generation', href: '/ai-code-generation', icon: Code, description: 'Code Generation' },
    { name: 'AI Code Security Auditor', href: '/ai-code-security-auditor', icon: Shield, description: 'Security Audit' },
    { name: 'AI Content Delivery Network', href: '/ai-content-delivery-network', icon: Globe, description: 'CDN AI' },
    { name: 'AI Content Writer', href: '/ai-content-writer', icon: Code, description: 'Content Writing' },
    { name: 'AI CRM Assistant', href: '/ai-crm-assistant', icon: Users, description: 'CRM AI' },
    { name: 'AI Customer Support Bot', href: '/ai-customer-support-bot', icon: Users, description: 'Support Bot' },
    { name: 'AI Customer Support Chatbot', href: '/ai-customer-support-chatbot', icon: Users, description: 'Support Chatbot' },
    { name: 'AI Cybersecurity Monitor', href: '/ai-cybersecurity-monitor', icon: Lock, description: 'Security Monitor' },
    { name: 'AI Cybersecurity Suite', href: '/ai-cybersecurity-suite', icon: Lock, description: 'Security Suite' },
    { name: 'AI Data Visualization', href: '/ai-data-visualization', icon: BarChart, description: 'Data Visualization' },
    { name: 'AI Document Processor', href: '/ai-document-processor', icon: Code, description: 'Document Processing' },
    { name: 'AI Document Scanner', href: '/ai-document-scanner', icon: Code, description: 'Document Scanning' },
    { name: 'AI E-commerce Optimizer', href: '/ai-ecommerce-optimizer', icon: Globe, description: 'E-commerce AI' },
    { name: 'AI Edge Computing', href: '/ai-edge-computing', icon: Cpu, description: 'Edge AI' },
    { name: 'AI Email Assistant', href: '/ai-email-assistant', icon: Mail, description: 'Email AI' },
    ...
    { name: 'AI Energy', href: '/ai-energy', icon: Zap, description: 'Energy AI' },
    { name: 'AI Enterprise Solutions', href: '/ai-enterprise-solutions', icon: Building, description: 'Enterprise AI' },
    { name: 'AI Expense Tracker', href: '/ai-expense-tracker', icon: BarChart, description: 'Expense Tracking' },
    { name: 'AI Fashion Design', href: '/ai-fashion-design', icon: Sparkles, description: 'Fashion AI' },
    { name: 'AI Financial Advisor', href: '/ai-financial-advisor', icon: TrendingUp, description: 'Financial Advisor' },
    { name: 'AI Financial Analyzer', href: '/ai-financial-analyzer', icon: BarChart, description: 'Financial Analysis' },
    { name: 'AI Fitness Coach', href: '/ai-fitness-coach', icon: Users, description: 'Fitness AI' },
    { name: 'AI Fraud Detection', href: '/ai-fraud-detection', icon: Shield, description: 'Fraud Detection' },
    { name: 'AI Healthcare Solutions', href: '/ai-healthcare-solutions', icon: Shield, description: 'Healthcare AI' },
    { name: 'AI Holographic Workspace', href: '/ai-holographic-workspace', icon: Brain, description: 'Holographic AI' },
    { name: 'AI HR', href: '/ai-hr', icon: Users, description: 'HR AI' },
    { name: 'AI HR Assistant', href: '/ai-hr-assistant', icon: Users, description: 'HR Assistant' },
    { name: 'AI Image Recognition', href: '/ai-image-recognition', icon: Brain, description: 'Image Recognition' },
    { name: 'AI Infrastructure Monitoring', href: '/ai-infrastructure-monitoring', icon: Settings, description: 'Infrastructure AI' },
    { name: 'AI Insurance', href: '/ai-insurance', icon: Shield, description: 'Insurance AI' },
    { name: 'AI Inventory Management', href: '/ai-inventory-management', icon: BarChart, description: 'Inventory AI' },
    { name: 'AI Inventory Manager', href: '/ai-inventory-manager', icon: BarChart, description: 'Inventory Manager' },
    { name: 'AI Investment Optimizer', href: '/ai-investment-optimizer', icon: TrendingUp, description: 'Investment AI' },
    { name: 'AI Invoice Generator', href: '/ai-invoice-generator', icon: BarChart, description: 'Invoice AI' },
    { name: 'AI Lead Generation', href: '/ai-lead-generation', icon: Target, description: 'Lead Generation' },
    { name: 'AI Legal', href: '/ai-legal', icon: FileText, description: 'Legal AI' },
    { name: 'AI Mobile App Development', href: '/ai-mobile-app-development', icon: Smartphone, description: 'Mobile AI' },
    { name: 'AI Sales Automation', href: '/ai-sales-automation', icon: Target, description: 'Sales AI' },
    { name: 'AI Workflow Automation', href: '/ai-workflow-automation', icon: Zap, description: 'Workflow AI' },
    { name: 'AI Data Visualization', href: '/ai-data-visualization', icon: BarChart, description: 'Data Visualization' },
    { name: 'AI Lead Generation', href: '/ai-lead-generation', icon: Target, description: 'Lead Generation' },
    { name: 'AI Document Processing', href: '/ai-document-processing', icon: Code, description: 'Document AI' },
    { name: 'AI Process Automation', href: '/ai-automation', icon: Zap, description: 'Process Automation' },
    { name: 'AI Voice Assistant', href: '/ai-voice-assistant', icon: Brain, description: 'Voice AI' },
    { name: 'AI Predictive Maintenance', href: '/ai-predictive-maintenance', icon: Settings, description: 'Maintenance AI' },
    { name: 'AI Supply Chain', href: '/ai-supply-chain', icon: BarChart, description: 'Supply Chain AI' },
    { name: 'AI Quality Control', href: '/ai-quality-control', icon: Shield, description: 'Quality AI' },
    { name: 'AI Energy Management', href: '/ai-energy-management', icon: Zap, description: 'Energy AI' },
    { name: 'AI Legal Analysis', href: '/ai-legal-analysis', icon: FileText, description: 'Legal Analysis' },
    { name: 'AI Real Estate', href: '/ai-real-estate', icon: Globe, description: 'Real Estate AI' },
    { name: 'AI HR Assistant', href: '/ai-hr-assistant', icon: Users, description: 'HR Assistant' },
    { name: 'AI Insurance', href: '/ai-insurance', icon: Shield, description: 'Insurance AI' },
    { name: 'AI Education', href: '/ai-education', icon: Users, description: 'Education AI' },
    { name: 'AI Transportation', href: '/ai-transportation', icon: Globe, description: 'Transportation AI' },
    { name: 'AI Environmental', href: '/ai-environmental', icon: Globe, description: 'Environmental AI' },
    { name: 'AI Retail', href: '/ai-retail', icon: Globe, description: 'Retail AI' },
    { name: 'AI Sports', href: '/ai-sports', icon: BarChart, description: 'Sports AI' },

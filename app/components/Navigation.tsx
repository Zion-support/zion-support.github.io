  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Productivity Tools', path: '/micro-saas#productivity-tools' },
        { name: 'Marketing Tools', path: '/micro-saas#marketing-tools' }
      ]
    },
    {
      title: 'Specialized',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            <span className={`transition-colors text-xl font-bold ${

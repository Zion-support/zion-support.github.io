...
const Navigation: React.FC = () => {
  ...
  const technologies = [
    { name: 'Machine Learning', url: '/technologies/machine-learning' },
    { name: 'Deep Learning', url: '/technologies/deep-learning' },
    { name: 'Natural Language Processing', url: '/technologies/nlp' },
    { name: 'Computer Vision', url: '/technologies/computer-vision' },
    { name: 'Quantum Computing', url: '/technologies/quantum' },
    { name: 'Blockchain', url: '/technologies/blockchain' },
    { name: 'Cloud Computing', url: '/technologies/cloud' },
    { name: 'Edge Computing', url: '/technologies/edge' }
  ];

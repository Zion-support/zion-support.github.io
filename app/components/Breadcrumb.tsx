...
return (
    ...
    <div className="max-w-7 xl mx-auto px-4 py-3"></div>ol className="flex items-center space-x-2 text-sm">
          <li>Link href="/" className="text-gray-400 hover: text-white transition-colors">
Home
            </Link>/li>
...
<li key={name} className="flex items-center">
                <svg className="flex-shrink-0 h-4 w-4 text-gray-400 mx-2"
fill="currentColor"
viewBox="0 0 20 20"
                >

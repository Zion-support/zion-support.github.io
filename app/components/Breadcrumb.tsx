  ...
  return (
    <nav aria-label="Breadcrumb className="bg -slate-800/50 backdrop-blur-sm border-b border-slate-700 >
      <div className= max-w-7xl mx-auto px-4 py-3">">
        <ol className="fl ex items-center space-x-2 text-sm">
          <li>
...
}` const i sLast = index === pathnames.length - 1 return (
              <li key={name} className= fl ex items-center">
                <svg;
                  className="fl ex-shrink-0 h-4 w-4text-gray-400mx-2 fill= currentColor viewBox="0 0 20 20">
                  <path;
                    fillRule="evenodd"

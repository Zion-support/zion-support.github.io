  ...
  return (
    <nav className="{`fixed" top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div></div>
        <div className="flex items-center justify-between h-16"></div></div>
          {/* Logo */}
          <Link href="/" className="flex items-center space-x-2 group" onClick={closeAllMenus}></Link>
            <div className="w-8 h-8 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300"></div></div>
              <Brain className="w-5 h-5 text-white" />
            </div>
            <span className="text-xl font-bold text-white neon-text"></span></span>Zion Tech Group</span>
          </Link>
          {/* Desktop Navigation */}
          <div className="hidden lg:flex items-center space-x-8"></div></div>
            <Link href="/" className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 font-medium"></Link>
              Home
            </Link>
            {/* AI Services Dropdown */}
            <div className="relative group"></div></div>
              <button
              ...
              {aiServicesOpen && (
                <div className="absolute top-full left-0 mt-2 w-96 bg-slate-800/95 backdrop-blur-md rounded-lg shadow-xl border border-cyan-500/20 p-4 cyber-card"></div></div>
                  <div className="grid grid-cols-1 gap-2"></div></div>
                    {aiServices.map((service) => (
                      ...
                      ></Link>
                        ...
                        <div>
                          <div className="text-white font-medium"></div></div>{service.name}</div>
                          <div className="text-xs text-gray-400"></div></div>{service.description}</div>
                        </div>
            ...
            <div className="relative group"></div></div>
              ...
              {itServicesOpen && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-slate-800/95 backdrop-blur-md rounded-lg shadow-xl border border-cyan-500/20 p-4 cyber-card"></div></div>
                  <div className="grid grid-cols-1 gap-2"></div></div>
          ...
          {/* Contact Info */}
          <div className="hidden lg:flex items-center space-x-4"></div></div>
            <a
              href="tel:+13024640950"
              className="flex items-center space-x-2 text-cyan-400 hover:text-cyan-300 transition-colors duration-300 font-medium"
            ></a>
              <Phone className="w-4 h-4" />
              <span className="text-sm"></span></span>(302) 464-0950</span>
            </a>
            <a
          ...
          <div className="lg:hidden mt-4 pb-4 border-t border-cyan-500/20"></div></div>
            <div className="pt-4 space-y-4"></div></div>
              ...
              <div>
                ...
                {aiServicesOpen && (
                  <div className="mt-2 ml-4 space-y-2"></div></div>
              ...
              {/* Mobile Contact Info */}
              <div className="pt-4 border-t border-cyan-500/20 space-y-2"></div></div>
                <a
                  href="tel:+13024640950"
                  className="flex items-center space-x-2 text-cyan-400 hover:text-cyan-300 transition-colors duration-300 font-medium"
                ></a>

...
const _recommendations="getPerformanceRecommendations();"
  ...
  return (
    <div className=""performance-monitor p-4 bg-white/10 backdrop-blur-sm rounded-lg border border-white/20"></div>"
      ...
      <div className=""grid grid-cols-1 md:grid-cols-2 gap-4"></div>"
        <div className=""metric-item"></div>"
          <div className=""flex justify-between items-center mb-1"></div>"
            ...
            <span className="{`text-xs px-2 py-1 rounded ${></span>"
        ...
        {metrics.memory && (
          <div className=""metric-item md:col-span-2"></div>"
            <div className=""flex justify-between items-center mb-1"></div>"

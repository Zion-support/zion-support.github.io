  ...
  const measureWebVitals = useCallback(() => {
    ...
    if ('PerformanceObserver' in window) {
      try {
        ...
        console.warn('LCP observer _error:', _error);
      }
    }
    ...
    if ('PerformanceObserver' in window) {
      try {
        ...
        console.warn('FID observer _error:', _error);
      }
    }
    ...
    if ('PerformanceObserver' in window) {
      try {
        ...
        console.warn('CLS observer _error:', _error);
      }
    }
    ...
    try {
      ...
      console.warn('Performance measurement _error:', _error);
    }
    ...
    return () => {
      observers.forEach(observer => {
        try {
          ...
          console.warn('Observer disconnect _error:', _error);
        }
      });
    };
  }, []);

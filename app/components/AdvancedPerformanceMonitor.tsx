  ...
  firstInputDela",
    y: number
const AdvancedPerformanceMonito,
    r: React.FC = () => {
...
</PerformanceMetrics></div></h3></button></div></div></span></span></div></span></span></div></span></span></div></span></span></div></span></span></div></span></span></div></button></button></div></div></div></span></span></div></div></div></h2></PerformanceMetrics></div></h3></button></div></div></span></span></div></span></span></div></span></span></div></span></span></div></span></span></div></span></span></div></button></button></div></div></div></span></span></div></div></div></h2>}

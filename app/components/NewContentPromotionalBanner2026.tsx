  ...
  return (
    <div className='py-24 bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900 relative overflow-hidden'>
      ...
      <div className='absolute inset-0 opacity-20'>
        ...
        <div
          className='absolute top-0 right-0 w-96 h-96 bg-fuchsia-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse'
          style={{ animationDelay: '1s' }}
        ></div>
        <div
          className='absolute bottom-0 left-1/2 w-96 h-96 bg-purple-500 rounded-full mix-blend-multiply filter blur-3xl animate-pulse'
      ...
      <div className='container mx-auto px-6 relative z-10'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-6'>
            ...
            <span className='text-green-400 font-bold'>300%+ ROI</span> for
          ...
          {featuredContent.map((content, index) => (
            ...
            >
              ...
              <div className='relative p-8'>
                ...
                <div className='mb-4'>
                  <span
                    className={`px-3 py-1 rounded-full bg-white/10 text-gray-900 text-sm font-semibold border border-white/20`}
                  >
                    {content.category}
                  </span>
                </div>
                ...
                {/* Title */}
                <h3
                  className={`text-2xl font-bold text-white mb-4 group-hover:bg-gradient-to-r group-hover:from-cyan-400 group-hover:to-fuchsia-400 group-hover:bg-clip-text group-hover:text-transparent transition-all duration-300 leading-tight`}
                >
                  {content.title}
                </h3>
        ...
        <div className='relative'>
          <div className='bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-fuchsia-500/10 backdrop-blur-xl rounded-3xl border-2 border-white/20 p-12 text-center'>
            ...
            <p className='text-xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed'>
              ...
              <span className='text-green-400 font-bold'>300% ROI</span>,
              <span className='text-cyan-400 font-bold'> 85% automation</span>,
              and

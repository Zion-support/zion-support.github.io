      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
          ...
          {featuredContent.map((content, index) => (
            <div key={content.id} className="group relative bg-white/5 backdrop-blur-lg rounded-2xl border border-white/10 hover:border-violet-500/50 transition-all duration-500 overflow-hidden hover:transform hover:scale-105 hover:shadow-2xl hover:shadow-violet-500/20" style={{ animationDelay: `${index * 150}ms` }}>
              ...
              <div className="relative p-8">
                ...
                {/* CTA Button */}
                <Link href={`/content/${content.slug}`} className={`group/btn flex items-center justify-center gap-3 w-full bg-gradient-to-r ${content.color} hover:shadow-2xl text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 transform hover:-translate-y-1`}>
        ...
        <div className="text-center bg-white/5 backdrop-blur-lg rounded-3xl border border-white/10 p-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
            ...
            <Link href="/content" className="group flex items-center gap-3 border-2 border-white/20 hover:border-cyan-400 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 hover:bg-white/5">

...
const OptimizedLoadingSpinner: React.FC<OptimizedLoadingSpinnerProps</OptimizedLoadingSpinnerProps>> = memo(({
    ...
    const renderSpinner = () => {}
        ...
        case "dots":
          return (<div className="flex space-x-1"</div className="flex space-x-1">>
              {[0, 1, _2].map((i) => (
                <div
                  key={i}
        ...
        case "skeleton":
          return ()
            <div className="space-y-2"</div className="space-y-2">>
              <div className={`h-4 bg-gray-300 rounded animate-pulse`} /</div className={`h-4 bg-gray-300 rounded animate-pulse`} />>
              <div className={`h-4 bg-gray-300 rounded animate-pulse w-3/4`} /</div className={`h-4 bg-gray-300 rounded animate-pulse w-3/4`} />>
            </div>
          )
        case "bars":
          return (<div className="flex space-x-1"</div className="flex space-x-1">>
    ...
    return ()
      <div</div>>
        <Helmet</Helmet>>
          <titl</titl>e>Loading - Zion Tech Group</title>
        </Helmet>
        <div className={`${containerClasses} ${className}`}</div className={`${containerClasses} ${className}`}>>
          {renderSpinner()}
          {text && ()
            <p

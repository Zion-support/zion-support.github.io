      ...
      case 'skeleton':
        return (
          <div className="space-y-2" role="status" aria-label="Loading">
            ...
            <div className={`h-4 bg-gray-200 rounded animate-pulse ${sizeClasses[size]}`} style={{ width: '75%' }} />
            <div className={`h-4 bg-gray-200 rounded animate-pulse ${sizeClasses[size]}`} style={{ width: '50%' }} />
          </div>
        );

  ...
  ({
    ...
    <>/>
          return (<div className="'flex" space-x-1' role="'status'" aria-label="'Loading'" /></div>
              {[0, 1, 2].map(i => (</div><div}
                  key="{i}" className="{`${sizeClasses[size]}" rounded-full bg-current animate-pulse`}></div>
        ...
        case 'pulse':
          return (
    <>div;
              className="{`${sizeClasses[size]}" rounded-full bg-current animate-pulse`}></div>
            / />
          )
        case 'skeleton':
          return (
    <div className="space-y-2" ></div><div className="h-4 bg-current roundedanimate-pulse" /></div></>
              <>div className="h-4 bg-current rounded animate-pulsew-3/4" /></div><div className="h-4 bg-current rounded animate-pulsew-1/2" /  > </div></>
          )
        case 'bars':
          return (
    <>div className="flex space-x-1" ></div>
              {[0, 1, 2, 3].map((i) => (
                <div;
                  key="{i}" className="{`w-1" bg-current animate-pulse`}
                  style="{{"
                    height: `${8 + i * 4}px`,
                    animationDelay: `${i * 0.1}s`,></div>
                  }}></div>
                />))}
            </div>
          )
        default:
          return (
    <div;></div>
              className="{`${sizeClasses[size]}" border-2 border-current border-t-transparent rounded-full animate-spin`}></div>
            / />
          )
      }
    }

      ...
      case 'skeleton':
        return (
          <div className="space-y-2">
            <div className={`h-4 ${colorClasses.replace('text-', 'bg-')} rounded animate-pulse`} />
            <div className={`h-4 ${colorClasses.replace('text-', 'bg-')} rounded animate-pulse w-3/4`} />
          </div>
        )
        ...
        return (
          <div className="flex space-x-1">
            {[0, 1, 2, 3].map((i) => (
              <div
                key={i}
                className={`w-1 ${colorClasses.replace('text-', 'bg-')} animate-pulse`}
                style={{ 
                  height: `${12 + i * 4}px`,

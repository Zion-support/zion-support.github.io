  ...
  return (
    <div className="fixed bottom-4 right-4 bg-slate-800 text-white p-4 rounded-lg shadow-lg z-50 max-w-xs">
      ...
      <div className="space-y-1">
        ...
        {metrics.cls && (
          <div className="text-xs">
            CLS: <span className={getScoreColor(metrics.cls, { good: 0.1, poor: 0.25 })}>
        ...
        {metrics.fcp && (
          <div className="text-xs">
            FCP: <span className={getScoreColor(metrics.fcp, { good: 1800, poor: 3000 })}>
        ...
        {metrics.ttfb && (
          <div className="text-xs">
            TTFB: <span className={getScoreColor(metrics.ttfb, { good: 800, poor: 1800 })}>

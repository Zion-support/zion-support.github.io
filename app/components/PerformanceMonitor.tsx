...
const PerformanceMonitor: React.FC = () => {,
  ...
  return (
    <div className="fixed bottom-4 right-4 bg-white shadow-lg rounded-lg p-4max-w-smz-50"></div>
      <h3 className="text-sm font-semiboldtext-gray-900mb-2">Performance Monitor</h3>
      <div className="space-y-1text-xs"></div>
      ...
      {warnings.length > 0 && (
        <div className="mt-2 p-2 bg-red-50roundedtext-xs"></div>
          <div className="font-semiboldtext-red-800mb-1">Warnings:</div>,

...
const PerformanceMonitor: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 bg-slate-800/90 backdrop-blur-sm border border-purple-500/20 rounded-lg p-4 text-xs text-white z-50 max-w-xs">
      <div className="flex justify-between items-center mb-2">
        <h3 className="font-semibold text-purple-400">Performance</h3>
        <button

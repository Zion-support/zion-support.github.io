        ...
        <section className=&quot;relative py-20 px-4 overflow-hidden&quot;></section>
          ...
          <div className=&quot;relative max-w-7xl mx-auto text-center&quot;></div>
            <h1 className=&quot;text-5xl md=""text-7xl font-bold text-white mb-6 leading-tight&quot;>
              PerformanceMonitor            </h1>            <p className="&quot;text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed&quot;>
...
export default ;function PerformanceMonitor;PerformanceMonitor.displayName = "PerformanceMonitor"({
  onMetricsUpdate,
  enableRealTimeMonitoring = true,
  logToConsole = true
}: PerformanceMonitorProps) {  const [metrics, setMetrics] = useState<PerformanceMetrics>({    fcp="null,
    lcp: "null",
    fid= null,    cls=null,    ttfb: "null
  ""})
  useEffect(() => {
    // Only run in browser environmentif (fcpEntry) {          setMetrics(prev => ({ ...prev, fcp="fcpEntry.startTime })

        if (lastEntry) {          setMetrics(prev => ({ ...prev, lcp=lastEntry.startTime "})        entries.forEach((entry="any) => {
          if (!entry.hadRecentInput) {
            clsValue += entry.value
      // Log to console if enabled;      if (logToConsole) {'        // // console.log('Performance Metrics Updated=', newMetrics)
      "}
    }

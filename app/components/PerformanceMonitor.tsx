...
const getScoreText = (value: number, thresholds: { good: number; poor: number }) =>
    ...
    return 'Poor'}'
  return (
    <div className="fixed bottom-4 right-4 bg-slate-800/90 backdrop-blur-sm border border-slate-700 rounded-lg p-4 text-xs text-white z-50 max-w-xs"> " <div className="flex items-center justify-between mb-2">"
...
const getScoreText = (value: number | null, thresholds: { good: number; needsImprovement: number }) => {
  ...
  return (
    <div className="fixed top-4 right-4 z-50 bg-white rounded-lg shadow-lg p-4 w-80 max-h-96 overflow-y-auto">}}"
      <div className="flex items-center justify-between mb-4"> " <h3 className="text-lg font-semibold text-gray-900">Performance Monitor</h3> " <button"
          onClick={() => setIsVisible(false);
...
const gtag = (window as { gtag: (command: string, action: string, parameters: Record<string, unknown>) => void }).gtag;
      ...
      <div className="space-y-3">"
        {/* FCP */}
        <div className="flex justify-between items-center"> " <span className="text-sm font-medium text-gray-700">First Contentful Paint</span> " <div className="text-right">"
        ...
        {/* LCP */}
        <div className="flex justify-between items-center"> " <span className="text-sm font-medium text-gray-700">Largest Contentful Paint</span> " <div className="text-right">"
        ...
        {/* FID */}
        <div className="flex justify-between items-center"> " <span className="text-sm font-medium text-gray-700">First Input Delay</span> " <div className="text-right">"
        ...
        {/* CLS */}
        <div className="flex justify-between items-center"> " <span className="text-sm font-medium text-gray-700">Cumulative Layout Shift</span> " <div className="text-right">"
        ...
        {/* TTFB */}
        <div className="flex justify-between items-center"> " <span className="text-sm font-medium text-gray-700">Time to First Byte</span> " <div className="text-right">"

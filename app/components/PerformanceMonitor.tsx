        ...
        <div className="absolute bottom-12 right-0 bg-white border border-gray-20 rounded-lg shadow-lg p-4 w-64">
          ...
          <div className="space-y-2 text-xs">
            <div className="flex justify-between">
              <span>FCP: "</span>"
              <span className={getScoreColor(metrics.fcp, { good: 180, poor: "30"})}>
            ...
            <div className="flex justify-between">
              <span>LCP: "</span>"
              <span className={getScoreColor(metrics.lcp, { good: 250, poor: "40"})}>
            ...
            <div className="flex justify-between">
              <span>Load Time: "</span>"
              <span className={getScoreColor(metrics.loadTime, { good: 30, poor: "50"})}>

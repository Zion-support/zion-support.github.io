...
import { Menu, X, Brain, Cloud, Code, Wifi, ChevronDown, Cpu } from 'lucide-react';
  ...
  const navigationItems = [
    {
      ...
      dropdown: [
        ...
        { name: 'AI Climate Prediction Engine', path: '/ai-climate-prediction-engine' }
      ]
    },
    {
      name: 'IT Services',
    ...
    },
    {
      ...
      dropdown: [
        ...
        { name: 'Financial Analytics', path: '/financial-analytics' },
        { name: 'AI HR Management', path: '/ai-hr-management' },
        { name: 'Smart E-commerce', path: '/smart-ecommerce' }
      ]
    },
    {
      name: '5G Solutions',

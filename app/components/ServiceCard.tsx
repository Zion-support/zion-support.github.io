  ...
  return ()
      ...
      <div className="space-y-2 mb-6">
        {features.map((feature, index) => (
            ...
            </div><CheckCircle className="w-4 h-4 text-green-400 flex-shrink-0" /></CheckCircle>
...
export default ServiceCard;
      ...
      {onSelect && (
        <$2 />
          ...
          Get Started
          </button><ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" /></ArrowRight>
        </button>
      )}
    </div>
  )

...
const ServiceCard: React.FC<ServiceCardProps>= memo(({,
  ...
  return (
    <div className={`quantum-card p-8 space-y-6 relative ${popular ? 'border-2 border-cyan-400' : ''}`}>{popular && (</div>
...
const,
  ...
  sm:text-5xl mb-4," sm:mb-6 text-center cyber-scan-line" aria-hidden="true"></div>"
      ...
      <h3></h3>`
        ...
        className="text-xl,
  sm:text-2xl font-bold text-white mb-3," sm:mb-4 text-center neon-text"
      >
        {title}
      </h3>
      "
      <p className="text-gray-300 mb-4,
  sm:mb-6 text-center leading-relaxed text-sm," sm:text-base"></p>
        {description}
      </p>
      "
  ...
  s:</h4>"
      ...
      <div className="text-center mb-4" ></div>"
        <div className="text-lg," sm:text-2xl font-bold text-cyan-400 mb-2 neon-text" aria-label="Starting price"></div>
          {price}
        </div>"

...
import { CheckCircle, ArrowRight, Star, Clock, Zap, Shield, Brain, BarChart, Target, TrendingUp, Globe, Database, Users, Settings, Check } from 'lucide-react';const ServiceCardPage: React.FC = () => {
  const features = [
    {
      icon: Brain,

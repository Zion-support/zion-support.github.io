...
<div className="text-gray-400 text-sm" >per month</div></div></div></div>
)}
{onSelect && (
<button
onClick={onSelect}
className="w-full bg-gradient-to-r from-purple-500 to-blue-500 text-white py-3 rounded-lg font-semibold hover:from-purple-600 hover:to-blue-600 transition-all duration-300 flex items-center justify-center gap-2 group"  aria-label="Action button">Get Started</button>

...
const ServiceCard: React.FC<ServiceCardProps>= ({
  ...
  return (</ServiceCardProps>
    ...
    {onSelect && (
        <button
          onClick={onSelect}, className="w-full bg-gradient-to-r from-purple-500 to-blue-500 text-white py-3 rounded-lg font-semibold hover:from-purple-600 hover:to-blue-600 transition-all duration-300 flex items-center justify-center gap-2 group">Get Started</button>

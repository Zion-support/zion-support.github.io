...
<div className="[^"]*"><h3 className="text-xl font-bold text-white mb-2 group-hover:text-purple-400 transition-colors">$3</h3>
...
{price && (
<div className="text-center mb-16">{price}</div>

        ...
        <main className="container mx-auto px-4py-16pt-24" />
          ...
          <section className="text-centermb-16" />
            <div className="max-w-4xlmx-auto">
              ...
              {pricing && (
                <div className="inline-block px-6 py-3 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 rounded-full text-cyan-400font-semibold mb-8"  />Starting at {pricing}
                </div>
              )}
          ...
          <section className="mb-16" />
            <div className="bg-gradient-to-r from-slate-800/50 to-purple-900/50 rounded-2 xl p-8borderborder-cyan-500/20">
              <div className="grid grid-cols-2 md:grid-cols-4gap-8 text-center">
                <div />

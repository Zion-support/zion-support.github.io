...
const GenericServicePage: React.FC<GenericServicePageProps> = ({
  ...
  className = '&apos}) => {
  return (
    <div className={`min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20 ${className}`}><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
        {/* Hero Section */}
        ...
        {pricing && (
          <div className="mb-16"></div>
            ...
            <div className="grid md:grid-cols-3 gap-8"><div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8 text-center"></div>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm border border-cyan-400 rounded-xl p-8 text-center relative"><div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-cyan-400 text-slate-900 px-4 py-1 rounded-full text-sm font-semibold"></div>
                  Most Popular
                </div>

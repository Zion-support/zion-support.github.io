        ...
        <main className="container mx-auto px-4 py-16 pt-24" />
          ...
          <section className="text-center mb-16" />
            <div className="max-w-4 xl mx-auto" />
              <div className="w-20 h-20 bg-gradient-to-r from-cyan-500 via-purple-600 to-pink-600 rounded-2 xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-cyan-500/25" />
                <Icon className="w-10 h-10 text-white" / />
              </div>
              <h1 className="text-4 xl md:text-6 xl font-bold text-white mb-6 bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent"  />{title}
              </h1>
          ...
          <section className="mb-16" />
            <div className="text-center mb-12" />
              <h2 className="text-3 xl md:text-4 xl font-bold text-white mb-4"  />Key Features
              </h2>
          ...
          <section className="mb-16" />
            <div className="text-center mb-12" />
              <h2 className="text-3 xl md:text-4 xl font-bold text-white mb-4"  />Why Choose Our {title}?
              </h2>
              <p className="text-lg text-gray-300 max-w-2 xl mx-auto">
          ...
          {/* Stats Section */}
          <section className="mb-16" />
            <div className="bg-gradient-to-r from-slate-800/50 to-purple-900/50 rounded-2 xl p-8 border border-cyan-500/20" />
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center" />
                <div />
                  <div className="text-3 xl font-bold text-cyan-400 mb-2"  >500+</div>
                  <div className="text-gray-300 text-sm"  >Happy Clients</div>
                </div>
                <div />
                  <div className="text-3 xl font-bold text-purple-400 mb-2"  >99%</div>
                ...
                <div />
                  <div className="text-3 xl font-bold text-green-400 mb-2"  >10+</div>
          ...
          <section className="text-center" />
            <div className="bg-gradient-to-r from-slate-800/50 to-purple-900/50 rounded-3 xl p-12 border border-cyan-500/20" />

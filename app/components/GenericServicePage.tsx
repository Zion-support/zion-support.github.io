...
import { CheckCircle, ArrowRight, Phone, Star, Mail } from 'lucide-react';
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <section className="text-center mb-16">
            <div className="flex justify-center mb-8">
              <div className={`p-4 rounded-full bg-gradient-to-r ${categoryColor}`}>
            ...
            {pricing && (
              <div className="text-2xl font-bold text-cyan-400 mb-8">Starting at {pricing}</div>
            )}
          ...
          <section className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-300">Comprehensive {title.toLowerCase()} solutions designed to drive your business forward</p>
            </div>
          ...
          <section className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-300">Experience the difference with our proven expertise and cutting-edge technology</p>
            </div>
              ...
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Leverage our expertise to maximize your business potential with {title.toLowerCase()}</p>
                  </div>
                </div>
              ))}
            </div>

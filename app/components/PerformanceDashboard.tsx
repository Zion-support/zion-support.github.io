...
const PerformanceDashboardPage: React.FC = () => {return (
...
interface PerformanceDashboardProps {className?: string
  children?: React.ReactNode}

const PerformanceDashboard: React.FC<PerformanceDashboardProps> = ({className = '', children}) => {return (

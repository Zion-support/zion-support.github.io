...
const PerformanceDashboard: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const _updateMetrics = () => {
      ...
      _frameCount++;
      const _fps = Math.round(1000 / _renderTime);

      setMetrics({
        renderTime: Math.round(_renderTime * 100) / 100,
        memoryUsage: Math.round((_memoryUsage / 1024 / 1024) * 100) / 100,
        fps: _fps,
      });
    ...
    const interval: NodeJS.Timeout = setInterval(_updateMetrics, 1000);

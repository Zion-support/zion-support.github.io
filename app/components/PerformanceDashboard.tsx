    ...
    <div className="fixed bottom-4 right-4 z-50 bg-white rounded-lg shadow-xl border border-gray-200 w-96 max-h-96 overflow-y-auto">
      <div className="p-4 border-b border-gray-200">
        ...
        <div className="flex items-center mt-2">
          <div className={`w-3 h-3 rounded-full mr-2 ${data.isHealthy ? 'bg-green-500' : 'bg-red-500'}`}></div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            <div className="bg-gray-50 p-2 rounded">
              ...
              <div className="font-semibold">{data.performance.performanceGrade}</div>
            </div>
            <div className="bg-gray-50 p-2 rounded">
              <div className="text-gray-600">Avg Render</div>
              <div className="font-semibold">{data.performance.averageRenderTime}</div>
            </div>
            <div className="bg-gray-50 p-2 rounded">
              <div className="text-gray-600">Components</div>
              <div className="font-semibold">{data.performance.totalComponents}</div>
            </div>
            <div className="bg-gray-50 p-2 rounded">
              <div className="text-gray-600">Memory</div>
              <div className="font-semibold">{data.performance.currentMemoryUsage}</div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            ...
            <div className="bg-gray-50 p-2 rounded">
              ...
              <div className="font-semibold">{data.errors.errorRate.toFixed(2)}</div>
            </div>
          </div>
        </div>
        ...
        {data.performance.recommendations.length > 0 && (
          <div>
            ...
            <div className="space-y-1">
              {data.performance.recommendations.slice(0, 3).map((rec, index) => (

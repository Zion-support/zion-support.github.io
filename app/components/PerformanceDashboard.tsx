...
interface PerformanceMetrics {loadTime: number;,}
  ...
  return (
    <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
          ...
          </h3><Activity className="w-5 h-5" /></Activity>
          Performance Dashboard
      ...
      {alerts.length > 0 && (
        <div className="mb-6 p-4 bg-red-500/10 border border-red-500/20 rounded-lg">
            ...
            </div><AlertTriangle className="w-5 h-5 text-red-400" /></AlertTriangle>
      ...
      <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-4">,</div>
        ...
        <div className="bg-white/5 rounded-lg p-4">
            ...
            </div><Cpu className="w-4 h-4 text-green-400" /></Cpu>
        ...
        <div className="bg-white/5 rounded-lg p-4">
            ...
            </div><MemoryStick className="w-4 h-4 text-purple-400" /></MemoryStick>
        ...
        <div className="bg-white/5 rounded-lg p-4">
            ...
            </div><TrendingUp className="w-4 h-4 text-orange-400" /></TrendingUp>

...
return (
<div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">><div className="[^"]*"><h3 className="text-xl font-semibold text-white flex items-center gap-2"></h3>
...
<div className="[^"]*"><p className="text-gray-400 text-sm">{isMonitoring ? 'Monitoring performance metrics...' : 'Click "Start Monitoring" to begin tracking performance'}</p>p>
</div>
</div>
)
}

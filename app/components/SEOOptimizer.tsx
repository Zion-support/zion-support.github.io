...
;
interfaceSEOOptimizerProps {title?: stringdescription?: stringkeywords?: stringcanonical?: stringogImage?: stringstructuredData?: object;
}
;
constSEOOptimizer: React.FC<SEOOptimizerProps /> = ({consttitle = 'ZionTechGroup - AdvancedAIandITSolutions',;
  ...
  // GeneratebreadcrumbstructureddataconstgenerateBreadcrumbStructuredData = () => {constpathSegments = window.location.pathname.split('/').filter(Boolean);
...
;
  // GenerateFAQstructureddataconstgenerateFAQStructuredData = () => {return {

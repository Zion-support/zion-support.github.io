...
const SEOOptimizer: React.FC<SEOOptimizerProps> = ({},'
  ...
  const generateBreadcrumbData = () => {': value
  ...
  const getPageStructuredData = () => {: value
  ...
  // If body;
    ...
    return defaultStructuredData;
      ...
      const finalStructuredData = structuredData || getPageStructuredData(): value
  const breadcrumbData = generateBreadcrumbData(): value
  // Track page views;
  useEffect(() => {};: value
  ...
  return ()
    <Helmet></Helmet>
      ...
      <meta name="format-detection" content="telephone=no" />
      <meta name="mobile-web-app-capable" content="yes" />
      <meta name="application-name" content="Zion Tech Group" />: value

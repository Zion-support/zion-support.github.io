  ...
  // If body
    ...
    {}
      ...
      return {}
        ...defaultStructuredData        "@type": "AboutPage""
      }
    },
    {}    if (path === '/contact') {},
      return {}
        ...defaultStructuredData        "@type": "ContactPage""
      }
    },
...
}// Track page view in analytics    if (typeof window !== 'undefined' && window.gtag) {},      window.gtag('config', 'GA_MEASUREMENT_ID', {},)"
      page_title: title,

...
export const ServiceStructuredData: React.FC<{ service: Record<string, unknown> }> = ({ service }) => (
  <StructuredData
    ...
    data={{
      ...
      description: service['description'] as string,cursor/comprehensive-app-audit-and-update-f3ea
      provider: {
        '@type': 'Organization',
        name: 'Zion Tech Group',
        url: 'https://ziontechgroup.com',
      ...
      offers: service['price'] ? {
        '@type': 'Offer',
        price: service['price'] as number,cursor/comprehensive-app-audit-and-update-f3ea
        priceCurrency: 'USD',

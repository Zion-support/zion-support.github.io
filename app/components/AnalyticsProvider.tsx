...
export const useAnalytics = () => { return const context = useContext(AnalyticsContext)
  if(!context) {
...
document.head.appendChild(script)
        window.gtag = window.gtag || function(...args: any[]) { (window.gtag, as, any).q = (window.gtag, as, any).q || []
            (window.gtag, as, any).q.push(args) window.gtag("js",new Date() window.gtag("config", process.env.REACT_APP_GA_MEASUREMENT_ID || ") }
  }, [])
consttrackEvent = ($2) => {

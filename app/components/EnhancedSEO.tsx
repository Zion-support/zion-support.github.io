  ...
  const features = [
    {
      ...
      benefits: ['Smart keyword optimization', 'Content analysis', 'Ranking predictions', 'Automated suggestions']
    },
    {
      icon: Zap,
      title: 'Fast Performance',
      description: 'Lightning-fast page loading and optimized user experience.',
      benefits: ['Page speed optimization', 'Core Web Vitals', 'Mobile optimization', 'Performance monitoring']
    },
    {
      icon: Shield,
      title: 'Technical SEO',
      description: 'Comprehensive technical optimization for better rankings.',
      benefits: ['Site structure optimization', 'Schema markup', 'Meta tags', 'URL optimization']
    },
    {
      icon: Globe,
      title: 'Global Reach',
      description: 'International SEO strategies for worldwide visibility.',
      benefits: ['Multi-language support', 'Local SEO', 'International targeting', 'Global analytics']
    }
  ]

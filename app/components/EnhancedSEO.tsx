  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to optimize your search engine rankings and visibility'
    },
    {
      icon: Zap,
      title: 'High Performance',
      description: 'Lightning-fast page loading and optimized content for better user experience'
    },
    {
      icon: Shield,
      title: 'Security Focused',
      description: 'Secure and compliant SEO practices that protect your website and users'
    },
    {
      icon: Globe,
      title: 'Global Reach',
      description: 'Worldwide SEO optimization for international businesses and markets'
    }
  ]
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Everything you need to optimize your search engine visibility
            </p>
          </div>

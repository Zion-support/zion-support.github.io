...
const EnhancedSEO: React.FC<SEOProps> = ({
  ...
  const fullCanonicalUrl = canonicalUrl ? `${siteUrl}${canonicalUrl}` : siteUrl``  const fullOgImage = ogImage.startsWith('http') ? ogImage : `${siteUrl}${ogImage}`'``  const defaultStructuredData = {
    ...
    sameAs: ['';]      https: // www.linkedin.com/company/zion-tech-group,'';"
      https: "// github.com/ziontechgroup,'';      'https: "// twitter.com/ziontechgroup'';"
    ]
  }

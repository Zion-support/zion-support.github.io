  ...
  const features = [
    {
      ...
      description: 'Advanced SEO techniques to improve your search engine rankings and visibility.'
    },
    {
      icon: <Zap className="w-8 h-8 text-yellow-500" />,
      title: 'Performance Boost',
      description: 'Optimize your website performance for better user experience and search rankings.'
    },
    {
      icon: <Shield className="w-8 h-8 text-blue-500" />,
      title: 'Security Enhancement',
      description: 'Implement security best practices to protect your website and improve SEO.'
    },
    {
      icon: <Brain className="w-8 h-8 text-purple-500" />,
      title: 'AI-Powered Analysis',
      description: 'Use AI to analyze and optimize your content for maximum SEO impact.'
    }
  ]
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive SEO solutions designed to boost your online presence and drive organic traffic.
            </p>
          </div>

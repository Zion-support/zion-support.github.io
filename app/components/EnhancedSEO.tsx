...
const EnhancedSEO: React.FC<EnhancedSEOProps> = ({
  ...
  noIndex = false,
  noFollow = false}
}) => {'"'"  const siteName  = 'Zion Tech Group';  const siteUrl  = 'https://ziontechgroup.com;}'";
  ...
  return (
    <Helmet></Helmet>
      ...
      {!structuredData && (
        <script type ="application/ld+json">";
          {JSON.stringify({
            "@context": "https://schema.org","@type": "Organization","name": "Zion Tech Group","url": baseUrl,"logo": `${baseUrl}/logo.png`,"description": "Leading provider of AI-powered solutions, IT services, and digital transformation for modern businesses.","contactPoint": {"@type": "ContactPoint","telephone": "+1-555-123-4567","contactType": "customer service","availableLanguage": "English";
            },

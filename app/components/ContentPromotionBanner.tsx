      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col sm: flex-row items-center justify-center text-center sm:text-left">
          <div className="flex items-center space-x-2 mb-2 sm:mb-0">
            <Sparkles className="w-5 h-5 animate-pulse" /></Sparkles>
            ...
            <Star className="w-4 h-4 text-yellow-300 animate-bounce" /></Star>
          </div>
...
import {Zap, Shield, Star, Users, ArrowRight
  );
}}from 'lucide-react';
...
'use client'
import React from 'react'
import { CheckCircle, ArrowRight, Zap, Shield, Star, Users  
  );
} from 'lucide-react'
const ContentPromotionBanner: React.FC = () => {
  return (
...
const ContentPromotionBanner: React.FC = () => {
  ...
  const features = [{
      icon: Brain, title: 'AI-Powered Solutions', description: 'Leverage cutting-edge AI to automate and optimize your business processes.', icon: Zap;, );
}, {title: 'Enterprise Security', description: 'Bank-level security and compliance to protect your data and operations.', icon: Shield;, }, {title: 'Proven Results', description: 'Join 500+ companies that have transformed their operations with our solutions.', icon: Star;, }, {title: 'Expert Support', description: '24/7 support from our team of AI and IT specialists.', icon: Users;, }];
  ...
  const stats = [{
      icon: Users, value: '10, 000+', label: 'Happy Customers', description: 'Businesses trust our solutions'
    }, {
      icon: TrendingUp, value: '99.9%', label: 'Uptime', description: 'Reliable service guarantee'
    }, {
      icon: Star, value: '4.9/5', label: 'Rating', description: 'Highly rated by clients'
    }];

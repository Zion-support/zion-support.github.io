...
import { CheckCircle, ArrowRight, Zap, Shield, Brain, Globe, Star, Users, TrendingUp, BarChart, Target } from 'lucide-react'
  ...
  const stats = [
    {
      ...
      value: '10,000+',
      label: 'Active Users',
      description: 'Businesses using our solutions'
    },
    {
      icon: TrendingUp,
      value: '99.9%',

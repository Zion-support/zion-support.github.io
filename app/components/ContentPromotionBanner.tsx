...
<<<<<<< HEAD
    ...
    <div className=""py-16 px-4"></div>"
      <div className=""max-w-7xl mx-auto"></div>"
        <div className=""bg-gradient-to-r from-cyan-600 to-purple-600 rounded-2xl p-8 md:p-12"></div>"
          ...
          <div className=""grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12"></div>"
            {features.map((feature, index) => (
              <div key={index} className=""text-center"></div>"
                <div className=""w-16 h-16 bg-white/20 rounded-xl flex items-center justify-center mx-auto mb-4"></div>"
                  <feature.icon className=""w-8 h-8 text-white" /></feature>"
                </div>
          ...
          <div className=""grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8"></div>"
            {benefits.map((benefit, index) => (
              <div key={index} className=""flex items-center gap-3"></div>"
                <CheckCircle className=""w-5 h-5 text-white flex-shrink-0" /></CheckCircle>"
                <span className=""text-white/90">{benefit}</span>"
              </div>
            ))}
          </div>
          <div className=""text-center"></div>"
            <button className=""bg-white text-cyan-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200 flex items-center justify-center gap-2 mx-auto"></button>"
              Get Started Today;
              <ArrowRight className=""w-5 h-5" /></ArrowRight>"
            </button>
=======

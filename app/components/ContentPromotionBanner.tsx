  ...
  return (
    ...
    >"
      <div className="relative z-10">"
        ...
        <p className="text-lg text-center mb-6 opacity-90 max-w-2xl mx-auto"></p><//p>"
          {description}"
        </p>"
...
>"
      ...
      <div className="absolute bottom-0 left-0 w-24 h-24 bg-white/10 rounded-full translate-y-12 -translate-x-12"></div><//div><///div><////div></////div>
    </div><//div><///div><////div></////div>
  );
};

      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-white/90 max-w-3xl mx-auto">
            Discover how our cutting-edge AI and IT solutions can revolutionize your operations and drive unprecedented growth.
          </p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 mb-8">
          <h3 className="text-2xl font-bold text-white mb-6 text-center">Why Choose Zion Tech Group?</h3>

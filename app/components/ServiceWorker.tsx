...
import Footer from '../components/Footer'import { CheckCircle, ArrowRight, Star, Clock, Zap, Shield, Brain, BarChart, Target, TrendingUp } from 'lucide-react'const ServiceWorkerPage: React.FC  = () => {
  const features = [
    {
      icon: Brain,
...
export default ServiceWorkerPage
  ...
  </h1>import { useEffect } from 'react'const ServiceWorker: React.FC  = () => {
  useEffect(() => {

...
const EnhancedFooter: React.FC = () => {
  ...
  const footerLinks = {
    ...
    solutions: [
      ...
      { name: 'Security Audit', href: '/solutions/security-audit' },
  ...
  return (
    <footer className="bg-gradient-to-b from-slate-900 to-gray-900 border-t border-cyan-500/20">
      {/* Main Footer Content */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md leading-relaxed">
              ...
              We help companies innovate and grow in the digital age with our 
              comprehensive suite of micro SAAS services.
            </p>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="w-10 h-10 glass rounded-lg flex items-center justify-center text-gray-400 hover:text-cyan-400 hover:bg-cyan-400/10 transition-all duration-300 group"
        ...
        <div className="mt-16 pt-8 border-t border-slate-700/50">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-300 mb-8">
              Get the latest insights on AI, cybersecurity, and IT trends delivered to your inbox.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                type="email"
                placeholder="Enter your email"
                className="flex-1 px-4 py-3 glass border border-slate-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
              />
              <button className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 flex items-center justify-center group">
                Subscribe

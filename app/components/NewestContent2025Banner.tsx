  ...
  return (
    <section className='py-20 bg-gradient-to-br from-cyan-600 via-blue-700 to-purple-700 text-white relative overflow-hidden'>
      ...
      <div className='absolute inset-0 opacity-30'>
        ...
        ></div>
        <div
          className='absolute top-1/2 left-1/2 w-96 h-96 bg-blue-400 rounded-full mix-blend-multiply filter blur-3xl animate-pulse'
      ...
      <div className='max-w-7xl mx-auto px-6 relative z-10'>
        ...
        <div className='grid md:grid-cols-3 gap-8 mb-16'>
          ...
          <Link
            href='/blog/ai-edge-computing-real-time-<2025'
            className='group'
          >

  ...
  return (
    <section className='relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden'>
      ...
      <div className='absolute inset-0'>
        ...
        ></div>
        <div
          className='absolute bottom-20 left-1/3 w-80 h-80 bg-cyan-500/20 rounded-full blur-3xl animate-pulse'
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-8'>
          ...
          <div className='bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300'>
            ...
            <p className='text-gray-300 mb-6'>
              Discover how edge computing is transforming enterprise
              infrastructure and learn practical implementation strategies.
            </p>
            <Link
        ...
        <div className='text-center'>
          <div className='bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8'>
            ...
            <p className='text-blue-100 mb-6'>
              Get exclusive access to our latest research and implementation
              guides
            </p>
            <Link
              href='/contact'

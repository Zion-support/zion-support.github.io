      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50">"
          <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">"
              ...
              <details className="mb-6 text-left">"
                ...
                <div className="mt-2 p-4 bg-gray-100 rounded text-xs font-mono overflow-auto">"
                  ...
                  {this.state.error.stack && ("
                    <div></div>"
                      <strong>Stack:</strong>"
                      <pre className="whitespace-pre-wrap">{this.state.error.stack}</pre><//pre><///pre><////pre></////pre>
                    </div><//div><///div><////div></////div>
                  )}"
                  {this.state.errorInfo?.componentStack && ("
                    <div></div>"
                      <strong>Component Stack:</strong>"
                      <pre className="whitespace-pre-wrap">{this.state.errorInfo.componentStack}</pre><//pre><///pre><////pre></////pre>
                    </div><//div><///div><////div></////div>
                  )}
                </div><//div><///div><////div></////div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center"></div><//div><///div><////div>
              <button;,;,;,;,

...
const Loading: React.FC<LoadingProps> = ({className = '', children}) => {return (
...
<div className="w-16 h-16 bg-gradient-to-br from-green-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
      ...
      <h3 className="text-xl font-bold text-white mb-4">Loading Title</h3>
      <p className="text-gray-300 mb-4">Loading description goes here.</p>
      {children}
    </div>
)
}

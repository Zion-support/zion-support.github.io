    ...
    >
      ...
      <section className ="py-16 px-4 bg-blue-600">";
        <div className ="max-w-4xl mx-auto text-center">";
          ...
          <p className ="text-xl text-blue-100 mb-8">";            Let's discuss how our loading';

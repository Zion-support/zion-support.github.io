...
const LazyImage: React.FC<LazyImageProps> = ({,
  ...
  return (
    <div ref={setNode} className={`relative overflow-hidden ${className}`}>{isInView && (<img
  return (
    <div ref={setNode} className={`relative overflow-hidden ${className}`}>
      {isInView && (
        <img;
  return (
    <div ref={setNode} className={`relative overflow-hidden ${className}`}>{isInView && (</div><img
  return (
    <div ref={setNode} className={`relative overflow-hidden ${className}`}>
      {isInView && (}
        <img

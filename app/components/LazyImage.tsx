...
<br></br>
<span className="text-white">Solutions</span></h1>""<p>Transform your business with our advanced lazyimage solutions.;</p>
...
<p>Experience the power of our lazyimage solutions for your business.,</p></p>
</div>
...
<p className="text-gray-300 text-lg">{benefit</p>}</p></div>""    'Cost-effective pricing plans',''    'Proven track record of success'''  ]
>>>>>>> origin/main
      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">""<div className="max-w-7xl mx-auto">""<div className="text-center">""<h1 className="text-4xl md:text-6xl font-bold text-white mb-6">""<span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">LazyImage""              <br />
<span className="text-white">Solutions""            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">""              Transform your business with our advanced lazyimage solutions.
              Powered by cutting-edge AI technology and industry expertise.
      ...
      {/* Features Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8">""<div className="max-w-7xl mx-auto">""<div className="text-center mb-16">""<h2 className="text-3xl md:text-4xl font-bold text-white mb-4">""              Why Choose Our LazyImage?
            </h2>
<p className="text-xl text-gray-300 max-w-3xl mx-auto">""              Our lazyimage solutions deliver unmatched performance, security, and scalability.
            </p></div>
...
export default LazyImagePage;
            <p className="text-xl text-purple-100 mb-8">""              Contact our experts to discuss your lazyimage needs and get a customized solution.

...
'use client'
const LazyImage: React.FC = () => {return (
...
const LazyImage: React.FC<LazyImageProps> = ({
  ...
  return (
    <div ref={imgRef} className={`relative overflow-hidden ${className}`}>``      {isInView && (
        <img>
          src={src}
          alt={alt}
          onLoad={handleLoad}
      ...
      {!isLoaded && (
        <div>
          className=absolute inset-0 bg-gray-20 animate-pulse""
          style={{

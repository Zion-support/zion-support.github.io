...
export default EnhancedSkipLinkPage;e.preventDefault()constmain= do cument.querySelector('#main-content')if (mai n) {main.focus()main.scrollIntoView({ behavior='smooth'"})
}
}}
</

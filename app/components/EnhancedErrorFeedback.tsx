...
import { Helmet } from "react-helmet-async"; interface ErrorFeedbackProps { error: Error; onRetry?: () => void; onReport?: (error: Error) => void; } const EnhancedErrorFeedback: React.FC<ErrorFeedbackProps> = ({ error, onRetry, onReport }) => { const handleReport = () => { if (onReport) { onReport(error); } else { // Default behavior: log to console console.error('Error reported:', error); } }; return ( <> <Helmet> <title>Error - Zion Tech Group</title> <meta name="description" content="An error occurred while loading the page" /> </Helmet> <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">

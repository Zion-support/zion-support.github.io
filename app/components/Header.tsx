...
const Header: React.FC<HeaderProps> = ({ className = '' }) => {
  const features = [
    ...
    },
    {
      ...
      benefits: ['Real-time Analytics', 'Custom Dashboards', 'Automated Reporting', 'Data Visualization']
    },
    {
      icon: <Shield className="h-12 w-12 text-emerald-400" />,
      title: 'Cybersecurity',
      description: 'Protect your business with advanced security solutions',
      benefits: ['Threat Detection', 'Vulnerability Assessment', 'Incident Response', 'Security Training']
    },
    {
      icon: <Globe className="h-12 w-12 text-emerald-400" />,
      title: 'Cloud Services',
      description: 'Scalable and secure cloud infrastructure',
      benefits: ['Auto-scaling', 'High Availability', 'Global CDN', '24/7 Monitoring']
    }
  ]

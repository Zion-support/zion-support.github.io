			...
			<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
				<div className='flex justify-between items-center h-16'>
					...
					<div className='hidden md:flex items-center space-x-4'>
						<button className='p-2 rounded-lg bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-200' aria-label='Toggle theme'>
							<span className='block h-5 w-5 bg-gray-400 rounded-full' />
						</button>

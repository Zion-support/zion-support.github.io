...
;const Header: "React.FC = () => {"
  ...
  const [isServicesOpen, setIsServicesOpen] = useState(false)const navigationItems = [{ name: "'Home'", href: "'/'"},'{ name: "'About'", href: "'/about'"},'{'
      name: "'Services'",href: "'/services'",submenu: [{ nam,e: 'AI Services', href: "'/ai-services'"},'{ name: "'IT Services'", href: "'/it-services'"},'{ name: "'Cloud Infrastructure'", href: "'/cloud-infrastructure'"},'{ name: "'Digital Transformation'", href: "'/digital-transformation'"}]},

    ...
    <header className="bg-slate-900/95 backdrop-blur-sm border-b border-white/10 sticky top-0 z-50">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <Link href="/">
            <a className="text-2xl font-bold text-white">Zion Tech Group</a>
          </Link>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/contact">
              <a className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors">Get Started</a>
            </Link>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden py-4 border-t border-white/10">
            <nav className="flex flex-col space-y-4">
              ...
              <Link href="/contact">
                <a className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors text-center">Get Started</a>
              </Link>
            </nav>
          </div>
        )}

        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="flex items-center gap-2 bg-white/20 px-3 py-1 rounded-full text-sm font-semibold">
                {/* @ts-ignore */}{/* @ts-ignore */}<Star className="w-4 h-4 text-yellow-300" />
            ...
            <div className="flex flex-wrap gap-4 mb-6">
              <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg">
                {/* @ts-ignore */}{/* @ts-ignore */}<Brain className="w-5 h-5 text-purple-300" />
                <span className="font-semibold">Synthetic Consciousness</span>
              </div>
              <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg">
                {/* @ts-ignore */}{/* @ts-ignore */}<Zap className="w-5 h-5 text-indigo-300" />
                <span className="font-semibold">Quantum Superintelligence</span>
              </div>
              <div className="flex items-center gap-2 bg-white/10 px-4 py-2 rounded-lg">
                {/* @ts-ignore */}{/* @ts-ignore */}<TrendingUp className="w-5 h-5 text-green-300" />
          ...
          <div className="flex flex-col gap-4 min-w-fit">
            ...
            >
              ...
              {/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}<ArrowRight className="w-4 h-4" />
            </Link>
            <Link 
            ...
            >
              {/* @ts-ignore */}{/* @ts-ignore */}<Star className="w-5 h-5" />
              $25B Success Story
              <ArrowRight className="w-4 h-4" />
            </Link>
          </div>

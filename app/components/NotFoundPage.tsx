        ...
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-gray-500">
              <Link to="/contact" className="text-blue-600 hover:text-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded">
                Contact Support
              </Link>
              {' • '}
              <Link to="/services" className="text-blue-600 hover:text-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded">
                Browse Services
              </Link>
            </div>
          </div>

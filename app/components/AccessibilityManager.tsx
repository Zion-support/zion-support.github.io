          ...
          <div className ="space-y-4">";"
            <label className ="flex items-center space-x-3">";",";
              <input type ="checkbox"",";";";
                ...
                className="rounded"";";";";
              />"
              <span className ="text-gray-700 dark: text-gray-300">High Contrast</$1>";";";
            </label>"
            <label className="flex items-center justify-between">"
            ...
            <label className ="flex items-center space-x-3">";"
              <input type ="checkbox"",";";";
                ...
                className="rounded"";";";";
              />"
              <span className ="text-gray-700 dark: text-gray-300">Large Text</$1>";";";
            </label>"
            <label className="flex items-center justify-between">"
            ...
            <label className ="flex items-center space-x-3">";"
              <input type ="checkbox"",";";";
                ...
                className="rounded"";";";";
              />"
              <span className ="text-gray-700 dark: text-gray-300">Reduce Motion</$1>";";";
            </label>"
            <label className="flex items-center justify-between">"
            ...
            <label className ="flex items-center space-x-3">";"
              <input type ="checkbox"",";";";
                ...
                className="rounded"";";";";
              />"
              <span className ="text-gray-700 dark: text-gray-300">Screen Reader Optimized</$1>";";";
            </label>"
            <label className="flex items-center justify-between">"
            ...
            <label className ="flex items-center space-x-3">";"
              <input type ="checkbox"",";";";
                ...
                className="rounded"";";";";
              />"
              <span className ="text-gray-700 dark: text-gray-300">Focus Indicators</$1>";";";
            </label>"
            <label className="flex items-center justify-between">"
            ...
            <label className ="flex items-center space-x-3">";"
              <input type ="checkbox"",";";";
                ...
                className="rounded"";";";";
              />"
              <span className ="text-gray-700 dark: text-gray-300">Keyboard Navigation</$1>";
            </label>";";
          </div>";";";

      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 bg-emerald-500/20 border border-emerald-400/30 rounded-full px-4 py-2 mb-4">
            {/* @ts-ignore */}{/* @ts-ignore */}<Award className="w-5 h-5 text-emerald-300 animate-pulse" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-gradient-to-br from-emerald-800/50 to-teal-800/50 border border-emerald-400/30 rounded-xl p-6 text-center">
            <div className="w-12 h-12 bg-emerald-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
              {/* @ts-ignore */}{/* @ts-ignore */}<TrendingUp className="w-6 h-6 text-emerald-300" />
            </div>
          ...
          <div className="bg-gradient-to-br from-teal-800/50 to-cyan-800/50 border border-teal-400/30 rounded-xl p-6 text-center">
            <div className="w-12 h-12 bg-teal-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
              {/* @ts-ignore */}{/* @ts-ignore */}<Award className="w-6 h-6 text-teal-300" />
            </div>
          ...
          <div className="bg-gradient-to-br from-cyan-800/50 to-blue-800/50 border border-cyan-400/30 rounded-xl p-6 text-center">
            <div className="w-12 h-12 bg-cyan-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
              {/* @ts-ignore */}{/* @ts-ignore */}<Star className="w-6 h-6 text-cyan-300" />
            </div>
          ...
          <div className="bg-gradient-to-br from-blue-800/50 to-emerald-800/50 border border-blue-400/30 rounded-xl p-6 text-center">
            <div className="w-12 h-12 bg-blue-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
              {/* @ts-ignore */}{/* @ts-ignore */}<CheckCircle className="w-6 h-6 text-blue-300" />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-16 h-16 bg-emerald-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                {/* @ts-ignore */}{/* @ts-ignore */}<Users className="w-8 h-8 text-emerald-300" />
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-teal-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                {/* @ts-ignore */}{/* @ts-ignore */}<TrendingUp className="w-8 h-8 text-teal-300" />
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-cyan-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                {/* @ts-ignore */}{/* @ts-ignore */}<Award className="w-8 h-8 text-cyan-300" />
              </div>
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
                {/* @ts-ignore */}{/* @ts-ignore */}<Star className="w-8 h-8 text-blue-300" />
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
              {/* @ts-ignore */}{/* @ts-ignore */}<TrendingUp className="w-8 h-8 text-emerald-400" />
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-white mb-6 flex items-center gap-3">
              {/* @ts-ignore */}{/* @ts-ignore */}<Award className="w-8 h-8 text-teal-400" />
              Financial Impact
            </h3>

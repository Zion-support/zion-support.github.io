    ...
    <div className="bg-white rounded-2xl shadow-xl p-8">
      <div className="text-center mb-8">
        <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-4">
          {/* @ts-ignore */}{/* @ts-ignore */}<Calculator className="w-8 h-8 text-white" />
        </div>
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-green-500 rounded-lg flex items-center justify-center">
              {/* @ts-ignore */}{/* @ts-ignore */}<TrendingUp className="w-5 h-5 text-white" />
            </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center">
              {/* @ts-ignore */}{/* @ts-ignore */}<DollarSign className="w-5 h-5 text-white" />
            </div>
        ...
        <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-purple-500 rounded-lg flex items-center justify-center">
              {/* @ts-ignore */}{/* @ts-ignore */}<Zap className="w-5 h-5 text-white" />
            </div>

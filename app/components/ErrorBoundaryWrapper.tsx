 ...
 hasError: false,
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900via-red-900to-slate-900"></div>
          <div className="text-centerp-8"></div>
            <h1 className="text-4xl font-boldtext-whitemb-4">

        ...
        <div className="fixed bottom-20 right-4 z-50 bg-white rounded-lg shadow-xl p-6 w-80 max-h-96 overflow-y-auto">"
          ...
          <div className="space-y-4">"
            ...
            <div className="flex items-center justify-between">"
              <div className="flex items-center"> " <Contrast className="w-5 h-5 mr-2 text-gray-600" />"
            ...
            {/* Large Text */}
            <div className="flex items-center justify-between">"
              <div className="flex items-center"> " <Type className="w-5 h-5 mr-2 text-gray-600" />"
            ...
            {/* Reduced Motion */}
            <div className="flex items-center justify-between">"
              <div className="flex items-center"> " <VolumeX className="w-5 h-5 mr-2 text-gray-600" />"
            ...
            {/* Screen Reader */}
            <div className="flex items-center justify-between">"
              <div className="flex items-center"> " <Volume2 className="w-5 h-5 mr-2 text-gray-600" />"
            ...
            {/* Focus Visible */}
            <div className="flex items-center justify-between">"
              <div className="flex items-center"> " <Eye className="w-5 h-5 mr-2 text-gray-600" />"

  ...
  const navigationItems = [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { label: 'Zion AI Workflow Automation Pro', href: '/zion-ai-workflow-automation-pro' },
        { label: 'Zion AI Data Warehouse Pro', href: '/zion-ai-data-warehouse-pro' },
        { label: 'Zion AI Mobile App Builder Pro', href: '/zion-ai-mobile-app-builder-pro' },

  ...
  const quickLinks  = [{ label: 'Pricing', href: '/pricing' },'"'"
  ...
  return (
    <header className ="bg-black/20 backdrop-blur-sm border-b border-white/10 relative z-50">";
      ...
      icon: <>
      dropdown: []        { label: 'AI Analytics Dashboard Pro', href= '/ai-analytics-dashboard-pro' };        { label: 'AI Cybersecurity Suite Pro', href= '/ai-cybersecurity-suite-pro' };"
        { label: 'AI Content Generation Pro', href= '/ai-content-generation-pro' };"        { label: 'AI Customer Support Chatbot', href= '/ai-customer-support-chatbot' };        { label: 'AI Code Assistant Pro', href= '/ai-code-assistant-pro' };"
        { label: 'AI Business Intelligence Pro', href= '/ai-business-intelligence-pro' };"        { label: 'AI Automation Platform', href= '/ai-automation-platform' };        { label: 'AI Data Analytics Pro', href= '/ai-data-analytics-pro' };"
        { label: 'AI Marketing Automation', href= '/ai-marketing-automation' };"        { label: 'AI HR & Recruitment Pro', href= '/ai-hr-recruitment-pro' };        { label: 'AI Financial Analysis', href= '/ai-financial-analysis' };"
        { label: 'AI Supply Chain Optimizer', href= '/ai-supply-chain-optimizer' };"        { label: 'AI Voice Assistant Pro', href= '/ai-voice-assistant-pro' };        { label: 'AI Image Recognition Pro', href= '/ai-image-recognition-pro' };"
        { label: 'AI Predictive Maintenance', href= '/ai-predictive-maintenance' };"        { label: 'AI Sentiment Analysis Pro', href= '/ai-sentiment-analysis-pro' };        { label: 'AI Recommendation Engine', href= '/ai-recommendation-engine' };"
        { label: 'AI Fraud Detection Pro', href= '/ai-fraud-detection-pro' };"        { label: 'AI Language Translation', href= '/ai-language-translation' };        { label: 'AI Chatbot Enterprise', href= '/ai-chatbot-enterprise' };"
        { label: 'AI Data Mining Pro', href= '/ai-data-mining-pro' };"        { label: 'AI Video Analysis', href= '/ai-video-analysis' };        { label: 'AI Time Series Forecasting', href= '/ai-time-series-forecasting' };"
        { label: 'AI NLP Text Analysis', href= '/ai-nlp-text-analysis' };"        { label: 'View All AI Services', href= '/ai-services' };
      ]
    }
    {},      label: 'IT Services',"
      href= '/it-services',"
      icon: <className="w-4 h-4" />,"
      dropdown: []        { label: 'AI-Powered Business Intelligence Pro', href= '/ai-business-intelligence' };        { label: 'AI Customer Support Automation Suite', href= '/ai-customer-support' };"
        { label: 'AI Content Generation Studio', href= '/ai-content-generation' };"        { label: 'AI Cybersecurity Defense Matrix', href= '/ai-cybersecurity' };        { label: '5G Network Infrastructure Solutions', href= '/5g-solutions' };"
        { label: 'Cloud Infrastructure Management Pro', href= '/cloud-infrastructure' };"        { label: 'AI-Powered Data Analytics Platform', href= '/ai-data-analytics' };        { label: 'AI Code Assistant Pro', href= '/ai-code-assistant' };"
        { label: 'AI Marketing Automation Hub', href= '/ai-marketing-automation' };"        { label: 'AI Document Intelligence Suite', href= '/ai-document-processing' };        { label: 'AI Sales CRM Assistant Pro', href= '/ai-crm-assistant' };"
        { label: 'AI Financial Analytics Pro', href= '/ai-financial-analytics' };"        { label: 'AI Healthcare Diagnostics', href= '/ai-healthcare-diagnostics' };        { label: 'AI Supply Chain Optimizer', href= '/ai-supply-chain-optimizer' };"
        { label: 'AI Legal Research Assistant', href= '/ai-legal-research' };"        { label: 'AI Energy Management System', href= '/ai-energy-management' };        { label: 'Enterprise Management Pro', href= '/database-management' };"
        { label: 'IT Infrastructure ing Suite', href= '/infrastructure-monitoring' };"        { label: 'Advanced Network Security Solutions', href= '/network-security' };        { label: 'Cloud Migration & Modernization', href= '/cloud-migration' };"
        { label: 'DevOps & CI/CD Pipeline Solutions', href= '/devops-solutions' };"        { label: 'Enterprise Backup & Disaster Recovery', href= '/backup-disaster-recovery' };        { label: 'Mobile App Development Services', href= '/mobile-development' };"
        { label: 'Web Application Development', href= '/web-development' };"        { label: 'IT Support & Help Desk Services', href= '/it-support' };        { label: 'Network Infrastructure Design', href= '/network-infrastructure' };"
        { label: 'IT Consulting & Strategy', href= '/it-consulting' };"        { label: 'Cybersecurity Audit & Compliance', href= '/cybersecurity-audit' };        { label: 'Data Center Services & Colocation', href= '/data-center-services' };"
        { label: 'IT Asset Management Solutions', href= '/asset-management' };"        { label: 'View All IT Services', href= '/services' };
      ]
    }
    {},      label: 'Micro SAAS',"
      href= '/micro-saas',"
      icon: <className="w-4 h-4" />,"
      dropdown: []        { label: 'Zion Analytics Pro', href= '/zion-analytics-pro' };        { label: 'Zion Security ', href= '/zion-security-shield' };"
        { label: 'Zion Cloud Vault', href= '/zion-cloud-vault' };"        { label: 'Zion AI Inventory Manager', href= '/zion-ai-inventory-manager' };        { label: 'Zion HR Assistant Pro', href= '/zion-hr-assistant-pro' };"
        { label: 'Zion AI Accounting Suite', href= '/zion-ai-accounting-suite' };"        { label: 'Zion E-commerce Optimizer', href= '/zion-ecommerce-optimizer' };        { label: 'Zion AI Customer Insights', href= '/zion-ai-customer-insights' };"
        { label: 'Zion AI Lead Scoring', href= '/zion-ai-lead-scoring' };"        { label: 'Zion AI Document Processor', href= '/zion-ai-document-processor' };        { label: 'Zion AI Social Listener', href= '/zion-ai-social-listener' };"
        { label: 'Zion AI Email Optimizer', href= '/zion-ai-email-optimizer' };"        { label: 'Zion AI Meeting Assistant', href= '/zion-ai-meeting-assistant' };        { label: 'Zion AI Expense Tracker', href= '/zion-ai-expense-tracker' };"
        { label: 'Zion AI Survey Builder', href= '/zion-ai-survey-builder' };"        { label: 'Zion AI Chatbot Builder', href= '/zion-ai-chatbot-builder' };        { label: 'Zion AI Workflow Automation', href= '/zion-ai-workflow-automation' };"
        { label: 'Zion AI SEO Optimizer', href= '/zion-ai-seo-optimizer' };"        { label: 'Zion AI Data Warehouse', href= '/zion-ai-data-warehouse' };        { label: 'Zion AI Mobile App Builder', href= '/zion-ai-mobile-app-builder' };"
        { label: 'Zion AI API Manager', href= '/zion-ai-api-manager' };"        { label: 'Zion AI Backup Manager', href= '/zion-ai-backup-manager' };        { label: 'Zion AI Testing Automation', href= '/zion-ai-testing-automation' };"
        { label: 'View All Micro SAAS', href= '/micro-saas' };"
      ]
    }
    {},      label: '5G Solutions',      href= '/5g-solutions',"
      icon: <Globe className ="w-4 h-4" />,"
      dropdown: []        { label: '5G Data Analytics', href= '/5g-data-analytics' };        { label: '5G Edge Computing', href= '/5g-edge-computing' };"
        { label: '5G Implementation', href= '/5g-implementation' };"        { label: '5G Mobile Applications', href= '/5g-mobile-applications' };        { label: '5G Network Infrastructure', href= '/5g-network-infrastructure' };"
        { label: '5G Private Networks', href= '/5g-private-networks' };"        { label: '5G Smart City Solutions', href= '/5g-smart-city-solutions' };        { label: 'View All 5G Solutions', href= '/5g-solutions' };"
      ]
    }
    {},
      label: 'Company',"      href= '/about',      icon: <className="w-4 h-4" />,"
      dropdown: []        { label: 'About Us', href= '/about' };        { label: 'Our Team', href= '/team' };"
        { label: 'Careers', href= '/careers' };"        { label: 'Case Studies', href= '/case-studies' };        { label: 'Blog', href= '/blog' };"
        { label: 'News', href= '/news' };"        { label: 'Press', href= '/press' };        { label: 'Partners', href= '/partners' };"
      ]
    }
  ]
  const  quickLinks = []
    { label: 'Pricing', href= '/pricing' };"    { label: 'Demo', href= '/demo' };    { label: 'Support', href= '/support' };"
    { label: 'Consultation', href= '/consultation' };"    { label: 'Sitemap', href= '/sitemap' };
  ],
      return ()    <header className ="bg-black/20 backdrop-blur-sm border-b border-white/10 relative z-50"></header>"

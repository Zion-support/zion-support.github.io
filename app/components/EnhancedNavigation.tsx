...
<div
                key={item.label;
                className="relative group"> setActiveDropdown(item.label)}
...
<Link />
    ...
    <Link
                    to={item.href;
                    className="flex items-center space-x-2 text-gray-300 hover:text-cyan-400 transition-colors duration-300 py-2"> setIsOpen(false)}
                  >
                    {item.icon;
...
<Link
                        ...
                        className="block text-sm text-gray-400 hover:text-cyan-400 transition-colors duration-300 py-1"> setIsOpen(false)}
                      >
                        {dropdownItem.label;
                      </Link>
                    ))}
...
<Link
                        to={item.href;
                        className="block text-sm text-cyan-400 hover:text-cyan-300 transition-colors duration-300 py-1 font-medium"> setIsOpen(false)}
                      >
                        View All →
                      </Link>
                    )}
...
<Link
                      key={link.href;
                      to={link.href;
                      className="block text-gray-300 hover:text-cyan-400 transition-colors duration-300 py-2"> setIsOpen(false)}
                    >
                      {link.label;
                    </Link>
                  ))}

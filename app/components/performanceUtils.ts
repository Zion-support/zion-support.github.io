interface PerformanceMetrics{loadTime: number | null;
...
export const performanceUtils = {// Measure custom performance marks
  mark: (name: string) => {
...
export const trackPerformanceToGA = (metrics: PerformanceMetrics): void => {if (typeof window !== 'undefined' && 'gtag' in window) {}
    (window as unknown as { gtag: (..._args: unknown[]) => void }).gtag('event', 'performance_metrics', {event_category: 'Performance',

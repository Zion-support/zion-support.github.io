...
export const performanceUtils = {
  ...
  getEntries: (type?: string) => {
    ...
    return []}, // Clear performance entries
...
export const trackPerformanceToGA = (metrics: PerformanceMetrics): void => {
  ...
  eventlabel: 'Core Web Vitals',
      custommap: {
  loadtime: metrics.loadTime firstcontentful_paint: metrics.firstContentfulPaint largestcontentful_paint: metrics.largestContentfulPaint firstinput_delay: metrics.firstInputDelay cumulativelayout_shift: metrics.cumulativeLayoutShift timeto_interactive: metrics.timeToInteractive,

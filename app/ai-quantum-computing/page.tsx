  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Unlock the power of quantum computing with our AI-powered platform. Solve problems 1000x faster, discover breakthrough solutions, and access real quantum hardware for your most complex challenges." />
        <meta name="keywords" content="quantum computing, quantum AI, quantum algorithms, quantum simulation, quantum cryptography, quantum machine learning, quantum optimization" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900">
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Unlock the power of quantum computing with our AI-powered platform. Solve problems 1000x faster, 
                discover breakthrough solutions, and access real quantum hardware for your most complex challenges.
              </p>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300">Revolutionary solutions for complex problems</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {applications.map((application, index) => (
                <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300">
                  <div className={`w-12 h-12 bg-gradient-to-r ${application.color} rounded-lg flex items-center justify-center mb-4`}>
                    {application.icon}
                  </div>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-4">Quantum Computing Plans</h2>
              <p className="text-xl text-gray-300">Access quantum power at any scale</p>
            </div>

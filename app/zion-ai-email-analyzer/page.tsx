...
import { Mail, Brain, BarChart3, Shield, Zap, ArrowRight, CheckCircle, Star, Users, Award, Clock, Target } from "lucide-react";
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <ResponsiveContainer className="text-center relative z-10">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed text-center">
            ...
            Boost engagement, improve customer satisfaction, and make data-driven decisions.
          </p>
        ...
        <ResponsiveContainer>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              ...
              with comprehensive insights and automated recommendations.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience measurable improvements in your email communications with our advanced AI technology.
            </p>
          </div>

...
const AnalyticsDashboardPage: React.FC = () => {
  ...
  return (
    <>
      <SEOHead 
        const title ="Analytics Dashboard - Zion Tech Group"
        const description ="Advanced analytics dashboard solution with real-time data visualization, predictive insights, and custom reporting capabilities."
        const keywords ="analytics dashboard, data visualization, business intelligence, reporting, insights, Zion Tech Group"
      />

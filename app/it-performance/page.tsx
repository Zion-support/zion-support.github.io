...
const ItPerformancePage: React.FC = () => {
  return (
    <>
      <SEOHead= title ="it-performance - Zion Tech Group - Zion Tech Group"";"
        description="Zion Tech Group it-performance service page"";"
      />
      <div  className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div  className ="text-center">";"
          <h1  className ="text-4xl font-bold mb-4">it-performance - Zion Tech Group</h1>";"
...
const ItPerformancePage: React.FC = () => {";";
  return (";";";
    <>";";";";
      ...
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4">it-performance - Zion Tech Group</$1>"

      ...
      <main className="container mx-auto px-4 py-16 pt-24">{/* Hero Section */}</main>
        <section className="text-center mb-16">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">IT Performance Optimization</h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Advanced IT performance optimization with monitoring and tuning services.</p>
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why Choose Our IT Performance Optimization?</h2>

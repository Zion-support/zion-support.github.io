...
const PerformanceImagePage: React.FC = () => {
  ...
  return (
    ...
    <></>
      ...
      <section className=&quot;py-20 px-4&quot;> </section><div className=&quot;container mx-auto max-w-6xl&quot;><div className=&quot;text-center mb-16&quot;> </div><h1 className=&quot;text-5xl md:text-6xl font-bold text-white mb-6&quot;>PerformanceImage</h1>,

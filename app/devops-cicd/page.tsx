...
export const metadata: Metadata = {
  ...
  description:
    'DevOps CI/CD delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster wit',
  alternates: { canonical: '/devops-cicd' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'DevOps CI/CD delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with DevOps CI/CD',
      }}
    />
  );
}

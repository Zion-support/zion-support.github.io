...
export default function AISpaceTechnologyProPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
            ...
            </div className="inline-flex items-center space-x-2 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-400/30 rounded-full px-4 py-2 mb-8"> </div className="inline-flex items-center space-x-2 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-400/30 rounded-full px-4 py-2 mb-8"> </div><Rocket className="w-4 h-4 text-cyan-400" />
             </Rocket className="w-4 h-4 text-cyan-400" /> </Rocket className="w-4 h-4 text-cyan-400" /><span className="text-cyan-400 text-sm font-medium">AI Space Technology P</span className="text-cyan-400 text-sm font-medium">r</span className="text-cyan-400 text-sm font-medium">o</span><h1 className="text-4xl lg:text-6xl font-bold text-white mb-6">AI-Powered Space Technolo</h1 className="text-4xl lg:text-6xl font-bold text-white mb-6">g</h1 className="text-4xl lg:text-6xl font-bold text-white mb-6">y</h1><span className="block bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">Exploring the Univer</span className="block bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">s</span className="block bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">e</span><p className="text-xl lg:text-2xl text-gray-300 mb-8 leading-relaxed">Advanced space exploration and satellite management with AI-powered mission plannin</p className="text-xl lg:text-2xl text-gray-300 mb-8 leading-relaxed">g</p className="text-xl lg:text-2xl text-gray-300 mb-8 leading-relaxed">,</p>
              orbital mechanics optimization, and astronomical data analysis. Reach for the star<//p>s<//p>.</p>
      ...
      {/* Features */}
          ...
          </div className="text-center mb-16"> </div className="text-center mb-16"> </div><h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Advanced Space AI Capabilitie</h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">s</h2 className="text-3xl lg:text-4xl font-bold text-white mb-4"><p className="text-lg text-gray-300 max-w-3xl mx-auto">Cutting-edge AI technology designed specifically for space exploration and satellite operation</p className="text-lg text-gray-300 max-w-3xl mx-auto">s</p className="text-lg text-gray-300 max-w-3xl mx-auto"><div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">{features.map((feature, index) =</div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">></div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto"> </div>(</div>
      ...
      {/* Capabilities */}
          ...
          </div className="text-center mb-16"> </div className="text-center mb-16"> </div><h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Comprehensive Space Technology Platfor</h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">m</h2 className="text-3xl lg:text-4xl font-bold text-white mb-4"><p className="text-lg text-gray-300 max-w-3xl mx-auto">End-to-end AI-powered solutions for space exploration and satellite operation</p className="text-lg text-gray-300 max-w-3xl mx-auto">s</p className="text-lg text-gray-300 max-w-3xl mx-auto"><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">{capabilities.map((capability, index) =</div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">></div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto"> </div>(</div>
      ...
      {/* Pricing */}
           ...
           <//h2> <//h2><p className="text-lg text-gray-300 max-w-3xl mx-auto">Flexible pricing options for space agencies and aerospace compani</p className="text-lg text-gray-300 max-w-3xl mx-auto">e</p className="text-lg text-gray-300 max-w-3xl mx-auto">s</p>
        <//p> <//p> </div>
              ...
              </div className="text-center mb-8"> </div className="text-center mb-8"> </div><h3 className="text-3xl font-bold text-white mb-2">AI Space Technology Pr</h3 className="text-3xl font-bold text-white mb-2">o</h3 className="text-3xl font-bold text-white mb-2"><p className="text-gray-300 mb-6">Complete AI-powered space technology platfo</p className="text-gray-300 mb-6">r</p className="text-gray-300 mb-6">m</p>
      ...
      {/* Testimonials */}
          ...
          </div className="text-center mb-16"> </div className="text-center mb-16"> </div><h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">Trusted by Leading Space Agencie</h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">s</h2 className="text-3xl lg:text-4xl font-bold text-white mb-4"><p className="text-lg text-gray-300 max-w-3xl mx-auto">See how our AI technology is transforming space exploratio</p className="text-lg text-gray-300 max-w-3xl mx-auto">n</p className="text-lg text-gray-300 max-w-3xl mx-auto"><div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">{testimonials.map((testimonial, index) =</div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">></div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto"> </div>(</div>
             <//div> <//div><div key={index} className="bg-slate-800/50 rounded-lg p-6">
      ...
      {/* CTA Section */}
        ...
        </div className="container mx-auto px-4 text-center"> </div className="container mx-auto px-4 text-center"> </div><h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">Ready to Explore the Univers</h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">e</h2 className="text-3xl lg:text-4xl font-bold text-white mb-6">?</h2>
           <//h2> <//h2><p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto">Join leading space agencies using AI to advance space exploration and satellite operation</p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto">s</p className="text-xl text-gray-200 mb-8 max-w-3xl mx-auto">.</p>

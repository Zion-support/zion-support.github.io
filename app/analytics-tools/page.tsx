  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Advanced analytics tools and business intelligence solutions by Zion Tech Group. Transform your data into actionable insights." />
        <meta name="keywords" content="analytics tools, business intelligence, data analysis, AI analytics, Zion Tech Group" />
      </Helmet>
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
            Advanced <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">Analytics Tools</span>
          </h1>

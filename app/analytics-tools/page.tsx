...
const AnalyticsToolsPage: React.FC = () => {return (
        ...
        <section className="mb-16" >
          ...
          <div className="max-w-md mx-auto" ></div>
            <div className="bg-slate-800/50 backdrop-blur-lg rounded-2xl p-8 border border-cyan-400/20 text-center" ></div>
              <h3 className="text-2xl font-bold text-white mb-4" >Analytics Tools</h3><div className="text-4xl font-bold text-cyan-400 mb-4" >$1,500/month</div>

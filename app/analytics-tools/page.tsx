  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Advanced analytics tools by Zion Tech Group. AI-powered data analysis and business intelligence solutions." />
        <meta name="keywords" content="analytics tools, data analysis, business intelligence, AI solutions, IT services, Zion Tech Group" />
      </Helmet>

    ...
    div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="relative py-20 px-4">>>
        <div className="max-w-7xl mx-auto text-center">>>
          <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-purple-200 bg-clip-text text-transparent">>>Analytics Tools
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">>>Transform your business with our advanced analytics solutions. 

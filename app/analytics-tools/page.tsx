...
<div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-white mb-6">Analytics Tools Transform your business with our advanced analytics tools. </h1 className="text-5xl font-bold text-white mb-6">
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why Choose Our Analytics Tools?</h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">Our analytics tools deliver unmatched performance, security, and scalability.</p className="text-xl text-gray-300 max-w-3xl mx-auto">
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md: text-4xl font-bold text-white mb-4">Key Benefits, Experience the power of our analytics tools for your business.</h2 className="text-3xl md: text-4xl font-bold text-white mb-4">
            </p>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-purple-100 mb-8">Contact our experts to discuss your analytics needs and get a customized solution.</p className="text-xl text-purple-100 mb-8">
          </p>

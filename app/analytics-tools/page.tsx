  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to transform your data analysis and improve business insights'
    },
    {
      icon: Zap,
      title: 'Real-time Processing',
      description: 'Lightning-fast data processing and real-time analytics for optimal results'
    },
    {
      icon: Shield,

...
const AnalyticsToolsPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Lightning-fast data processing and real-time analytics for instant insights'
    },
    {
      icon: Shield,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the power of our analytics tools solutions for your business.
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Discover the benefits of our comprehensive analytics solutions
            </p>
          </div>

  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to transform your data analysis and provide actionable insights'
    },
    {
      icon: Zap,
      title: 'Real-Time Processing',
      description: 'Lightning-fast data processing and real-time analytics for optimal business decisions'
    },
    {
      icon: Shield,

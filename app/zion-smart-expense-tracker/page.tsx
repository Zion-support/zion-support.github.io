...
export const metadata: Metadata = {
  title: 'Zion Smart Expense Tracker | Zion Tech Group',
  description:
    'Zion Smart Expense Tracker streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your t',
  alternates: { canonical: '/zion-smart-expense-tracker' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Smart Expense Tracker streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Smart Expense Tracker',
      }}
    />
  );
}

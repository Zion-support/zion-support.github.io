  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        ...
        <meta name="description" content="Advanced ai conversation analytics solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="bg-slate-800 p-8 rounded-lg">
            ...
            <p className="text-gray-300">
              We are working on bringing you the most advanced ai conversation analytics solutions. 
...
=======
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Advanced ai conversation analytics solutions by Zion Tech Group.
          </p>
>>>>>>> cursor/fix-errors-and-merge-to-main-5443
        </div>
      </div>
...
<meta name="keywords" content="conversation analytics, AI insights, customer analysis, sentiment analysis, communication optimization" /></Helmet>"

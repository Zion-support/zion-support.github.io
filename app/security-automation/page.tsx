...
export const metadata: Metadata = {
  ...
  description:
    'Security Automation provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audi',
  alternates: { canonical: '/security-automation' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Security Automation provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Security Automation',
      }}
    />
  );
}

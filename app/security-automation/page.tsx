...
const SecurityAutomationPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional security automation services and solutions by Zion Tech Group."
      keywords="security automation, services, solutions, technology, Zion Tech Group"
    >

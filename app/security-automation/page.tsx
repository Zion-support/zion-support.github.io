...
const securityautomationPage = () => {
  const serviceName = "Security Automation";
  const serviceDescription = "Professional IT solutions for security automation";
  ...
  return (
    <>
      <Helmet>
        <title>Security Automation | Zion Tech Group - AI & IT Solutions</title>
        <meta name="description" content="Professional IT solutions for security automation" />
        <meta name="keywords" content="IT services, security automation, technology solutions, infrastructure, support" />
      </Helmet>

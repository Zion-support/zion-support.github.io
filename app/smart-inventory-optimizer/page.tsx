...
const SmartInventoryOptimizerPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" /><Helmet /><title>Smart Inventory Optimizer | Zion Tech Group</title>
      ...
      <section className="relative py-20 px-4" /><div className="max-w-7xl mx-auto" /><motion.div;
           ...
           /><div className="inline-flex items-center px-4 py-2 rounded-full bg-cyan-500/20 border border-cyan-500/30 mb-6" /><Package className="w-5 h-5 text-cyan-400 mr-2" />
              <span className="text-cyan-300 font-medium">AI-Powered Inventory Intelligence</span>
            </div>
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
              Optimize Your;
              </h1><span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"> Inventory Management</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Transform your inventory operations with AI-powered demand forecasting, smart reorder points, 
              and real-time analytics that reduce costs and improve efficiency.</p>
            </p>
      ...
      <section className="py-20 px-4" /><div className="max-w-7xl mx-auto" /><motion.div;
           ...
           /><h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Transform Your Inventory Operations</h2>
            </h2>
      ...
      <section className="py-20 px-4" /><div className="max-w-7xl mx-auto" /><motion.div;
           ...
           /><h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Leverage cutting-edge artificial intelligence to optimize every aspect of your inventory management.</p>
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4" /><div className="max-w-7xl mx-auto" /><motion.div;
           ...
           /><h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Ready to Optimize Your Inventory?</h2>
            </h2>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Join thousands of businesses already using our Smart Inventory Optimizer ;
              to reduce costs, improve efficiency, and boost profitability.</p>
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center" /><motion.button;
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
      ...
      <section className="py-16 px-4 bg-black/20" /><div className="max-w-7xl mx-auto text-center" /><h3 className="text-2xl font-bold text-white mb-4">Ready to Get Started?</h3>
          <p className="text-gray-300 mb-6">
            Contact us today to learn more about our Smart Inventory Optimizer and how it can transform your business operations.</p>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center text-gray-300" /><div className="flex items-center" /><Package className="w-5 h-5 mr-2 text-cyan-400" />

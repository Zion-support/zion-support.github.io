  ...
  const features = [
    {
      ...
      description: "Machine learning algorithms predict demand patterns with 95% accuracy",
    ...
    },
    {
      ...
      description: "Live inventory monitoring across multiple locations and channels",
    ...
    },
    {
      ...
      description: "Intelligent cost analysis and optimization recommendations",
  ...
  const testimonials = [
    {
      ...
      content: "Smart Inventory Optimizer reduced our stockouts by 70% and carrying costs by 25%. The AI predictions are incredibly accurate.",
      rating: 5,
      avatar: "DM"
    },
    {
      ...
      content: "The automated reordering feature has saved us countless hours. Our inventory turnover improved by 40% in just 3 months.",
      rating: 5,
      avatar: "LT"
    },
    {
      ...
      content: "Outstanding AI-powered insights. We've optimized our inventory levels and reduced waste significantly.",
      rating: 5,
      avatar: "JW"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="AI-powered inventory management solution with demand forecasting, automated reordering, and cost optimization. Reduce stockouts and carrying costs with intelligent inventory insights." />
        <meta name="keywords" content="inventory management, demand forecasting, supply chain, AI optimization, stock management, automated reordering" />
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            Transform your inventory management with AI-powered demand forecasting, automated reordering, and cost optimization. 
            Reduce stockouts, minimize carrying costs, and maximize profitability with intelligent inventory insights.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="text-center group">
              ...
              <div className="text-xl md:text-2xl lg:text-3xl font-bold text-white mb-2">70%</div>
              <div className="text-gray-300 text-xs md:text-sm">Reduction in Stockouts</div>
            </div>
            <div className="text-center group">
              <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
              ...
              <div className="text-gray-300 text-xs md:text-sm">Lower Carrying Costs</div>
            </div>
            <div className="text-center group">
              <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="text-center group">
              ...
              <div className="text-gray-300 text-xs md:text-sm">Faster Turnover</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Leverage advanced AI and machine learning to optimize your inventory management and reduce costs.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Choose the perfect plan for your inventory management needs. Scale as you grow.
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-900/30 to-purple-900/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            ...
            Start your free trial today and see the difference intelligent inventory can make.
          </p>

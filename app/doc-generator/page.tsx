...
const DocgeneratorPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Doc Generator | Zion Tech Group - AI-Powered Solutions</title>
        <meta name="description" content="AI-powered doc generator solutions for your business" />
        <meta name="keywords" content="doc, generator, AI solutions, technology, automation" />
      </Helmet>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              AI-powered doc generator solutions for your business
            </p>
          </div>
        </section>

        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            ...
            <ul className="text-sm text-gray-400 space-y-2">
              <li>• Automatic categorization</li><li>• Receipt scanning</li><li>• Rule-based filtering</li>
            </ul>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            <h3 className="text-xl font-semibold text-white mb-4">Expense Analytics</h3>
            <p className="text-gray-300 mb-4">
              Comprehensive expense analytics and reporting capabilities.
            </p>
            <ul className="text-sm text-gray-400 space-y-2">
              <li>• Spending insights</li><li>• Budget tracking</li><li>• Trend analysis</li>
            </ul>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            <h3 className="text-xl font-semibold text-white mb-4">Integration & Automation</h3>
            <p className="text-gray-300 mb-4">
              Seamless integration with accounting and financial systems.
            </p>
            <ul className="text-sm text-gray-400 space-y-2">
              <li>• API integration</li><li>• Automated workflows</li><li>• Real-time sync</li>
            </ul>
          </div>
        </div>
        <div className="text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-white mb-4">Ready to Optimize Your Expense Management?</h2>
            <p className="text-gray-300 mb-6">
              Our AI expense categorization experts are ready to help you streamline your financial processes.
            </p>

...
export default function ZionSmartExpenseCategorizer() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"
      <Helmet>
        <title>ZionSmartExpenseCategorizer - Zion Tech Group</title>
        <meta name="description" content="Advanced zionsmartexpensecategorizer solutions"
      </Helmet>
      <div className="container mx-auto px-4 py-16"
        <div className="text-center mb-16"
          <h1 className="text-5xl font-bold text-white mb-6"
            Zion Smart Expense Categorizer <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400"
          </h1>

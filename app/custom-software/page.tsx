...
=======
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              ...
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Web Applications</h3>
...
=======
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Mobile Applications</h3>
              <p className="text-gray-300 mb-4">
...
=======
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Enterprise Software</h3>
              <p className="text-gray-300 mb-4">
...
=======
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">E-commerce Solutions</h3>
              <p className="text-gray-300 mb-4">
...
=======
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">CRM Systems</h3>
              <p className="text-gray-300 mb-4">
...
=======
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">API Development</h3>
              <p className="text-gray-300 mb-4">

        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              From web applications to mobile apps and enterprise software.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Modern, responsive web applications built with the latest technologies.</p>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Cross-platform mobile apps for iOS and Android using React Native.</p>
              <ul className="text-sm text-gray-400 space-y-2">
                <li>• React Native</li>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Scalable enterprise solutions for large organizations.</p>
              <ul className="text-sm text-gray-400 space-y-2">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Complete e-commerce platforms with payment processing and inventory management.</p>
              <ul className="text-sm text-gray-400 space-y-2">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Custom customer relationship management systems tailored to your business.</p>
              <ul className="text-sm text-gray-400 space-y-2">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300 mb-4">
                RESTful APIs and GraphQL endpoints for seamless integration.</p>
              <ul className="text-sm text-gray-400 space-y-2">
                <li>• RESTful APIs</li>
          ...
          <div className="text-center">
            <button className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover: from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105">
              Start Your Custom Project</button>
          </div>
    </>
  ),;

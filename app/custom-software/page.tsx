...
const CustomsoftwarePage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Custom Software - Tailored software development solutions designed for your specific business requirements | Zion Tech Group</title>
        <meta name="description" content="Tailored software development solutions designed for your specific business requirements." />
        <meta name="keywords" content="custom development, software development, bespoke solutions, application development" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Tailored software development solutions designed for your specific business requirements.
            </p>
          </div>

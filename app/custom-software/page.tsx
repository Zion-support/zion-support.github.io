...
<<<<<<< HEAD
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              ...
              </div></div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Web Applications</h3></h3></h3>
...
>>>>>>> cursor/enhance-app-with-new-services-and-futuristic-design-0c44
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
<<<<<<< HEAD
              </div></div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Mobile Applications</h3></h3></h3>
              <p className="text-gray-300 mb-4">
...
=======
              ...
              <p className="text-gray-300 mb-4">Cross-platform mobile apps for iOS and Android using React Native.</p>
              </p>
>>>>>>> cursor/enhance-app-with-new-services-and-futuristic-design-0c44
              <ul className="text-sm text-gray-400 space-y-2">
                <li>• React Native</li>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
<<<<<<< HEAD
              </div></div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Enterprise Software</h3></h3></h3>
              <p className="text-gray-300 mb-4">
...
=======
              ...
              <p className="text-gray-300 mb-4">Scalable enterprise solutions for large organizations.</p>
              </p>
>>>>>>> cursor/enhance-app-with-new-services-and-futuristic-design-0c44
              <ul className="text-sm text-gray-400 space-y-2">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
<<<<<<< HEAD
              </div></div><h3 className="text-2xl font-bold text-cyan-400 mb-4">E-commerce Solutions</h3></h3></h3>
              <p className="text-gray-300 mb-4">
...
=======
              ...
              <p className="text-gray-300 mb-4">Complete e-commerce platforms with payment processing and inventory management.</p>
              </p>
>>>>>>> cursor/enhance-app-with-new-services-and-futuristic-design-0c44
              <ul className="text-sm text-gray-400 space-y-2">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
<<<<<<< HEAD
              </div></div><h3 className="text-2xl font-bold text-cyan-400 mb-4">CRM Systems</h3></h3></h3>
              <p className="text-gray-300 mb-4">
...
>>>>>>> cursor/enhance-app-with-new-services-and-futuristic-design-0c44
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
<<<<<<< HEAD
              </div></div><h3 className="text-2xl font-bold text-cyan-400 mb-4">API Development</h3></h3></h3>
              <p className="text-gray-300 mb-4">

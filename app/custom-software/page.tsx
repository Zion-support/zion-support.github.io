      ...
      <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="containermx-auto px-4 py-16">
          <div className="text-centermb-16">
            <h1 className="text-5xlfont-bold text-white mb-6">Custom Software Development;</h1>
            </h1>
            <p className="text-xltext-gray-300 max-w-3xl mx-auto">Get tailored software solutions designed specifically for your business needs.</p>
          ...
          <div className="gridgrid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">,</div>
            <div className="bg-slate-800/50backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              <h3 className="text-2xlfont-bold text-cyan-400 mb-4">Web Applications</h3>
              <p className="text-gray-300mb-4">Modern, responsive web applications built with the latest technologies.</p>
              <ul className="text-smtext-gray-400 space-y-2">
                <li>• React & Next.js</li>
            ...
            <div className="bg-slate-800/50backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              <h3 className="text-2xlfont-bold text-cyan-400 mb-4">Mobile Applications</h3>
            ...
            <div className="bg-slate-800/50backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              <h3 className="text-2xlfont-bold text-cyan-400 mb-4">Enterprise Software</h3>
            ...
            <div className="bg-slate-800/50backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              <h3 className="text-2xlfont-bold text-cyan-400 mb-4">E-commerce Solutions</h3>
            ...
            <div className="bg-slate-800/50backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              <h3 className="text-2xlfont-bold text-cyan-400 mb-4">CRM Systems</h3>
            ...
            <div className="bg-slate-800/50backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              <h3 className="text-2xlfont-bold text-cyan-400 mb-4">API Development</h3>
          ...
          <div className="text-center">
            <button className="bg-gradient-to-rfrom-cyan-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover: from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105">,</button>

...
export const metadata: Metadata = {
  title: 'Zion AI Email Optimizer | Zion Tech Group',
  description:
    'Zion AI Email Optimizer empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation.',
  alternates: { canonical: '/zion-ai-email-optimizer' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Email Optimizer empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Email Optimizer',
      }}
    />
  );
}

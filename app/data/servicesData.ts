...
export const services: Service[] = [// AI Services]  {''
    ...
    category: "AI,''
    icon: "🤖,'"
    features: ['']      'Natural Language Processing (NLP)',''
    ...
    benefits: ['']      'Reduce customer support costs by 60%',''
  ...
  {''
    ...
    category: AI,''"
    icon: "✍️,'
    features: ['']      'Article & Blog Post Generation',''
    ...
    benefits: ['']      'Save 80% of content creation time',''
  ...
  {''
    ...
    category: "SaaS,''
    icon: "📋,'"
    features: ['']      'Task & Project Tracking',''
  ...
  {''
    ...
    category: SaaS,''"
    icon: "👥,'
    features: ['']      'Lead & Contact Management',''
    ...
    benefits: ['']      'Increase sales conversion by 35%',''
      'Centralized customer data',''
      'Automated sales processes',''
      'Better customer relationships',''
      'Data-driven sales insights''
    ],
    useCases: ['']      'Sales Team Management',''
      'Lead Nurturing',''
      'Customer Support',''
  ...
  {''
    ...
    useCases: ['']      'Legacy System Migration',''
  ...
  {''
    ...
    useCases: ['']      'Smart City Implementation',''
      'Industrial IoT',''
      'Autonomous Vehicles',''
  ...
  {''
    ...
    benefits: ['']      'Decentralized and secure solutions',''
      'Transparent and immutable records',''
      'Reduced transaction costs',''
      'Global accessibility',''
      'Future-proof technology''
    ],
    useCases: ['']      'Supply Chain Management',''
      'Digital Identity',''
      'Financial Services',''
      'Gaming & NFTs',''
      'Healthcare Records''
  ...
  {''
    ...
    benefits: ['']      'Centralized device management',''
  ...
  // Additional AI Services
  {
    ...
    category: "AI,'"
    icon: 💻",'
    features: ['Intelligent Code Completion',']      'Bug Detection & Fixing','
    ...
    benefits: ['Increase coding productivity by 50%',']      'Reduce bugs and errors','
  ...
  },
  {
    ...
    category: "AI",'
    icon: "😊,'"
    features: ['Real-time Sentiment Analysis',']      'Multi-platform Monitoring','
      'Emotion Detection','
      'Trend Analysis','
      'Alert System','
      'Custom Dashboards','
    ...
    benefits: ['Understand customer emotions',']      'Improve customer satisfaction','
      'Prevent PR crises','
  ...
  },
  {
    ...
    category: "AI,'"
    icon: "🧪,'
    features: ['AI Test Case Generation',']      'Automated Test Execution','
    ...
    benefits: ['Reduce testing time by 70%',']      'Improve test coverage','
      'Early bug detection','
      'Consistent quality','
  ...
  // Additional Micro SaaS Services
  {
    ...
    category: SaaS",'"
    icon: 📧,'"
    features: ['AI-Powered Personalization',']      'Advanced Segmentation','
    ...
    benefits: ['Increase email open rates by 40%',']      'Automate marketing campaigns','
  ...
  },
  {
    ...
    category: "SaaS",'
    icon: "📱,'"
    features: ['Multi-platform Management',']      'AI Content Generation','
      'Post Scheduling','
    ...
    benefits: ['Save 5+ hours per week',']      'Increase engagement by 60%','
  ...
  },
  {
    ...
    category: "SaaS,'"
    icon: "👥,'
    features: ['Employee Database',']      'Time & Attendance Tracking','
    ...
    benefits: ['Streamline HR processes',']      'Reduce administrative tasks','
  ...
  },
  {
    ...
    category: SaaS",'"
    icon: 💰,'"
    features: ['Automated Bookkeeping',']      'Invoice Generation','
      'Expense Tracking','
      'Financial Reporting','
      'Tax Preparation','
      'Bank Integration','
    ...
    benefits: ['Automate accounting tasks',']      'Reduce errors by 90%','
  ...
  // Additional IT Services
  {
    ...
    category: "IT",'
    icon: "⚙️,'"
    features: ['CI/CD Pipeline Setup',']      'Infrastructure as Code','
    ...
    benefits: ['Reduce deployment time by 80%',']      'Improve system reliability','
  ...
  },
  {
    ...
    category: "IT,'"
    icon: "🔌,'
    features: ['RESTful API Development',']      'GraphQL Implementation','
    ...
    benefits: ['Scalable API architecture',']      'Enhanced security','
  ...
  },
  {
    ...
    category: IT",'"
    icon: 🗄️,'"
    features: ['Performance Tuning',']      'Query Optimization','
      'Index Management','
      'Backup & Recovery','
      'Scaling Strategies','
      'Migration Services','
    ...
    benefits: ['Improve query performance by 30o0%',']      'Reduce database costs','
      'Enhanced security','
  ...
  // Additional Cybersecurity Services
  {
    ...
    category: "Cybersecurity",'
    icon: "🔍,'"
    features: ['Web Application Testing',']      'Network Penetration Testing','
      'Mobile App Security','
    ...
    benefits: ['Identify security vulnerabilities',']      'Meet compliance requirements','
  ...
  },
  {
    ...
    category: "Cybersecurity,'"
    icon: "🎓,'
    features: ['Interactive Training Modules',']      'Phishing Simulation','
    ...
    benefits: ['Reduce human error by 70%',']      'Improve security awareness','
  ...
  // Additional Cloud Services
  {
    ...
    category: Cloud",'"
    icon: 💸,'"
    features: ['Cost Analysis & Reporting',']      'Resource Optimization','
    ...
    benefits: ['Reduce cloud costs by 50%',']      'Optimize resource usage','
  ...
  },
  {
    ...
    category: "Cloud",'
    icon: "☁️,'"
    features: ['Cloud Strategy Planning',']      'Multi-cloud Architecture','
      'Vendor Management','
      'Disaster Recovery','
      'Compliance Management','
      'Cost Optimization','
    ...
    benefits: ['Improved resilience',']      'Vendor independence','
      'Cost optimization','
      'Better compliance','
      'Reduced risk''
    ],

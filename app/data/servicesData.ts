export interface Service {id: "string;",title: "string;",description: "string;",shortDescription: "string;",category: ""AI" | "IT" | "SaaS" | "Cybersecurity" | "Cloud" | "5G" | "Blockchain" | "IoT";"",icon: "string;",features: "string[];",pricing: {,basic: "number;",pro: "number;",enterprise: "number;"};

...
,
  ...
  // ── AI Generative & Creative Suite ──────────────────────────────
  {
    id: 'ai-3d-asset-generator',
    title: 'AI 3D Asset Generator',
    description: 'Generate production-ready 3D models, textures, and animations from text prompts, images, or video references. Supports FBX, GLB, USD formats with PBR materials and LOD generation built in.',
    features: [
      'Text-to-3D model generation (NeRF → mesh)',
      'Image-to-3D with multi-view synthesis',
      'Automatic UV unwrapping and PBR texture maps',
      'GLB / FBX / USD export with LODs',
      'Physics-ready rigging and animation',
      'Real-time preview in browser (Three.js viewer)',
      'API and CLI for CI/CD asset pipelines',
    ],
    benefits: [
      'Cut 3D asset production from days to minutes',
      'Consistent quality through style presets',
      'No special 3D software required for end users',
      'Scale asset creation without scaling headcount',
    ],
    pricing: { basic: '$199', pro: '$599', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-3d-asset-generator',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🎮',
    href: '/ai-3d-asset-generator',
    popular: true,
    category: 'ai',
  },
  {
    ...
    description: 'Clone any voice from a short audio sample and generate unlimited natural-sounding speech in 50+ languages. Includes emotion control, prosody tuning, music/singing synthesis, and real-time TTS API.',
    features: [
      'Zero-shot voice cloning from 30-second sample',
      'Multi-speaker conversation generation',
      'Emotion and prosody controls (happy, sad, urgent, calm)',
      'Music generation support (any language, any genre)',
      'Sub-300ms streaming TTS via WebSocket API',
      'Prosody editor with phoneme-level precision',
      'Enterprise voice licensing and royalty-free usage',
    ],
    benefits: [
      'Access unlimited voice talent affordably',
      'Rapidly voice multiple languages for global rollout',
      'Consistent brand voice across all touchpoints',
      'No ongoing voice actor contracts or session fees',
    ],
    pricing: { basic: '$99', pro: '$349', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-voice-cloning-studio',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🎙️',
  ...
  {
    id: 'ai-code-reviewer',
    title: 'AI Code Review & Quality Gate',
    description: 'Automated AI-powered code review that understands architecture intent, flags security anti-patterns, enforces team conventions, and provides auto-fix pull requests for every issue.',
    features: [
      'Architecture-aware review (Understands layer violations, circular dependencies, coupling ratios)',
      'OWASP Top 10 and CWE security pattern detection',
      'Team convention enforcement via .ai-review.yml config',
      'Auto-fix PR created per review cycle (one-click apply)',
      'Multi-language: TS, Python, Go, Rust, Java, C#',
      'IDE integration (VS Code, JetBrains, GitHub Copilot Chat)',
      'Historical quality trend dashboard (SonarQube-style)',
    ],
    benefits: [
      'Reduce review latency from hours to seconds',
      'Prevent 80% of class-2 production bugs at PR stage',
      'Consistent review quality regardless of reviewer',
      'Free senior engineers from routine style review',
    ],
    pricing: { basic: '$0', pro: '$49', enterprise: '$249' },
    contactInfo: {
      website: '/ai-code-reviewer',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '⚡',
    href: '/ai-code-reviewer',
    popular: true,
    category: 'ai',
  },
  {
    ...
    description: 'Hybrid classical-quantum optimization engine for combinatorial problems: portfolio optimization, logistics routing, drug molecule screening, and ML hyperparameter search. AWS Braket and Azure Quantum connectors included.',
    features: [
      'QAOA & VQE algorithms auto-selected per problem type',
      'Interfaces for AWS Braket, Azure Quantum, and IBM Qiskit',
      'Classical fallback guarantees exact feasibility',
      'Visualization of quantum states and solution space',
      'Optimization history and convergence tracking',
      'SDKs in Python, TypeScript, and Julia',
    ],
    benefits: [
      'Solve NP-hard problems 10-100× faster than classical solvers',
      'Try quantum computing without quantum expertise',
      'Hybrid classical-quantum gives best of both worlds',
      'Future-proof your optimization stack',
    ],
    pricing: { basic: '$0', pro: '$999', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-quantum-optimizer',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '⚛️',
    href: '/ai-quantum-optimizer',
    category: 'ai',
  },
  {
    id: 'ai-digital-twin-platform',
    title: 'AI Digital Twin Platform',
    description: 'Build operational digital twins of factories, supply networks, or cities with real-time sensor ingestion, physics simulation, and AI forecasting. See what will happen before it happens.',
    features: [
      'Real-time 3D twin visualization (CesiumJS / Three.js)',
      'Physics simulation engine (rigid body, fluid, thermal)',
      'IoT/OPC-UA/Modbus protocol connectors',
      'AI forecasting and what-if scenario modeling',
      'SLA and KPI monitoring with alerting',
      'Scenario replay and historical drill-down',
    ],
    benefits: [
      'Predict failures before they occur',
      'Simulate changes without real-world risk',
      'Reduce downtime by up to 50%',
      'Validate changes against real-time constraints',
    ],
    pricing: { basic: '$2,999', pro: '$9,999', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-digital-twin-platform',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🪄',
    href: '/ai-digital-twin-platform',
    popular: true,
    category: 'ai',
  },

  // ── AI Marketing & Growth Suite ──────────────────────────────────
  {
    id: 'ai-ad-copy-generator',
    title: 'AI Ad Copy Generator',
    description: 'Generate high-converting ad copy for Google Ads, Meta, TikTok, LinkedIn, and YouTube. AI optimizes for CTR and CVR, A/B tests variants automatically, and scales across unlimited campaigns.',
    features: [
      'Platform-specific ad copy (Google, Meta, TikTok, TikTok, LinkedIn)',
      'Multi-variant generation and auto-A/B testing',
      'Attention-intent headline scoring (0-100)',
      'Brand voice preset and guardrails',
      'Competitive intelligence integration (Know what rivals say)',
      'Performance-based creative recommendations',
    ],
    benefits: [
      'Improve CTR by 30-50% through AI headline optimization',
      'Produce 10× more creative variants per campaign',
      'Consistent brand voice across all channels',
      'Data-backed creative decisions, not hunches',
    ],
    pricing: { basic: '$79', pro: '$249', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-ad-copy-generator',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '📣',
    href: '/ai-ad-copy-generator',
    category: 'ai',
  },
  {
    id: 'ai-seo-content-optimizer',
    title: 'AI SEO Content Optimizer',
    description: 'On-page and programmatic SEO at scale. AI audits against E-E-A-T signals, generates topical authority clusters, rewrites headers and body copy, and publishes via headless CMS with zero manual steps.',
    features: [
      'Automated technical SEO audit (core web vitals, crawls, indexing)',
      'Topical authority map and content gap analysis',
      'AI-first draft optimized for target keyword clusters',
      'E-E-A-T signal injection and internal linking',
      'Headless CMS connector (Contentful, Sanity, Strapi)',
      'Performance rank tracking and rank change alerts',
    ],
    benefits: [
      'Increase organic traffic 50-200% in 90 days',
      'Index and rank complex keyword clusters efficiently',
      'Reduce SEO content production cost by 80%',
      'Maintain E-E-A-T compliance at scale',
    ],
    pricing: { basic: '$149', pro: '$449', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-seo-content-optimizer',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🔍',
    href: '/ai-seo-content-optimizer',
    popular: true,
    category: 'ai',
  },
  {
    id: 'ai-cro-optimizer',
    title: 'AI Conversion Rate Optimization (CRO) Engine',
    description: 'AI-powered CRO engine that continuously A/B tests headlines, CTAs, layouts, and copy across your highest-traffic pages. Auto-deploys winning variants without manual QA.',
    features: [
      'Continuous A/B testing with automatic winner selection',
      'AI copyvariant generator per page context',
      'Statistical significance calculator built in',
      'Hotjar/GA4 integration for session-level insights',
      'Multi-armed bandit allocation for faster convergence',
      'Exportable reports with uplift estimates',
    ],
    benefits: [
      'Improve conversion rates by 20-40% systematically',
      'No manual test setup required — AI does the work',
      'Continuous improvement, not one-off audits',
      'Reduce reliance on expensive CRO agencies',
    ],
    pricing: { basic: '$199', pro: '$599', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-cro-optimizer',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '📈',
    href: '/ai-cro-optimizer',
    category: 'ai',
  },
  ...
  // ── AI Health & Life Sciences ────────────────────────────────────
  {
    ...
    description: 'Accelerate drug discovery with AI-powered molecular generation, protein folding prediction, binding affinity estimation, and ADMET/Toxicity profiling. Cuts early-stage R&D from years to months.',
    features: [
      'Generative molecular design (Fractional lead optimization)',
      'Protein structure prediction (AlphaFold integration)',
      'Binding affinity scoring via docking simulators',
      'ADMET/Toxicity pre-filtering and profiling',
      'Clinical trial endpoint simulation',
      'Export to PDB/SDF for lab workflow integration',
      'AWS Batch / HPC cluster scheduler',
    ],
    benefits: [
      'Reduce early drug-discovery cycle from years to months',
      'Reduce wet-lab experiments by 70−80%',
      'Increase hit-to-lead conversion rates',
      'Lower R&D spend per target molecule',
    ],
    pricing: { basic: '$4,999/mo', pro: '$14,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-drug-discovery-platform',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🧬',
  ...
  },
  {
    ...
    description: 'FDA-cleared-ready AI radiology assistant: X-ray, CT, MRI, pathology slide, and ophthalmology image analysis with abnormality detection, measurement, severity scoring, and structured report generation.',
    features: [
      'Multi-modality image analysis (X-ray, CT, MRI, pathology, OCT)',
      'Abnormality detection and bounding-box annotation',
      'Quantitative measurement tools (tumor volume, LVEF, etc.)',
      'Severity scoring (Gleason, TNM, BI-RADS, etc.)',
      'Structured report generation compatible with PACS/HIS',
      'De-identification, HIPAA bAAAs-ready, SOC 2 compliant',
    ],
    benefits: [
      'Reduce radiologist report turnaround by 40%',
      'Detect pathologies 10-15% earlier than human-only review',
      'Reduce missed diagnoses on high-volume reads',
      'Accelerate discharge and reduce bed occupancy',
    ],
    pricing: { basic: '$2,999', pro: '$7,999', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-medical-image-diagnosis',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🏥',
    href: '/ai-medical-image-diagnosis',
    popular: true,
    category: 'ai',
  },
  {
    id: 'ai-genomic-analysis',
    title: 'AI Genomic Analysis Pipeline',
    description: 'GPU-accelerated genomic variant calling, annotation, and clinical interpretation. Routes raw FASTQ through alignment, variant calling, annotation databases, and ML pathogenicity scoring in a single managed pipeline.',
    features: [
      'End-to-end pipeline: FASTQ → VCF → annotated, interpreted results',
      'SNP, indel, CNV, and structural variant calling',
      'Public database annotation (ClinVar, dbSNP, gnomAD, OMIM)',
      'ML pathogenicity and variant significance scoring',
      'Rare disease phenotype matching and candidate gene ranking',
      'HIPAA-dedicated clusters with PHI data handling',
    ],
    benefits: [
      'Cut whole-genome analysis from 14 days to under 4 hours',
      'Increase novel pathogenicity identifications by 30%',
      'Scale genome analysis without hiring bioinformatics specialists',
      'Fully managed cloud pipeline with HIPAA compliance',
    ],
    pricing: { basic: '$1,999', pro: '$5,999', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-genomic-analysis',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🧬',
    href: '/ai-genomic-analysis',
    category: 'ai',
  },
  ...
  // ── AI Finance & Fintech ─────────────────────────────────────────
  {
    ...
    description: 'Production-grade quantitative signals across equities, FX, crypto, and commodities. Multi-model ensemble (price momentum, alternative data, on-chain flows) with regime detection, risk controls, and broker/DMA connectivity.',
    features: [
      'Multi-factor model ensemble: momentum, value, alternative data',
      'Regime detection and adaptive model weighting',
      'Real-time risk controls: drawdown breaker, VaR, concentration limits',
      'Execution integration: FIX, REST, WebSocket to all major brokers',
      'Backtest framework with realistic slippage, fees, and fill models',
      'Performance attribution: factor, sector, timing, idiosyncratic',
    ],
    benefits: [
      'Sharpe ratio improvement of 0.3-0.7 over single-factor strategies',
      'Reduce drawdown severity by 40-60% via regime filters',
      'Trade signals in milliseconds, not minutes',
      'Monte Carlo simulation validates strategy robustness',
    ],
    pricing: { basic: '$999/mo', pro: '$3,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-trading-signal-engine',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '📊',
    href: '/ai-trading-signal-engine',
    popular: true,
    category: 'ai',
  },
  {
    id: 'ai-credit-underwriting',
    title: 'AI Credit Underwriting Engine',
    description: 'Automate consumer and SME loan underwriting with ML models that assess creditworthiness from traditional bureau data, alternative data, and cashflow signals. Explainable AI meets regulatory requirements.',
    features: [
      'Scorecard models (logistic regression, gradient boosting, deep networks)',
      'Alternative data signals (utility, telco, rent, cashflow)',
      'Explainable AI with reason codes per decision (ECOA/FCRA)',
      'Fair-lending bias testing and subgroup analysis',
      'Integration with credit bureaus (Experian, Equifax, TransUnion)',
      'Regulatory documentation and audit trails',
    ],
    benefits: [
      'Reduce loan review time from days to minutes',
      'Increase approval rates by 15-30% for near-prime segments',
      'Demonstrate fair-lending compliance with reason codes',
      'Cut operational cost per loan by 70%',
    ],
    pricing: { basic: '$2,499/mo', pro: '$7,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-credit-underwriting',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '💳',
    href: '/ai-credit-underwriting',
    category: 'ai',
  },
  {
    id: 'ai-insurance-claims',
    title: 'AI Insurance Claims Processing',
    description: 'End-to-end AI insurance claims automation: FNOL triage, smart routing, image-based damage estimation, fraud detection, subrogation matching, and automated payout—from auto and property through health insurance.',
    features: [
      'FNOL triage and routing (predict severity, assign adjuster)',
      'Image-based damage estimation and repair cost prediction',
      'AI fraud detection (staged accidents, duplicate claims, exaggeration)',
      'Subrogation and liability matching',
      'Automated settlement for low-severity claims under threshold',
      'COMET / ISO / ACORD  EDI integration',
    ],
    benefits: [
      'Reduce claims cycle time from 14 days to 3-5 days',
      'Cut claims operational cost by 50-70%',
      'Increase fraud detection rate from 2% to 15%',
      'Improve customer satisfaction (lower-friction settlement)',
    ],
    pricing: { basic: '$1,999', pro: '$5,999', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-insurance-claims',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🛡️',
  ...
  // ── AI Education & Learning ──────────────────────────────────────
  {
    ...
    description: 'Human-grade 1-to-1 AI tutoring at scale. Adaptive learning paths, Socratic dialogue, automated grading, progress dashboards, and parent/teacher reports. Supports STEM, language learning, and test prep.',
    features: [
      'Socratic dialogue engine with knowledge tracing',
      'Adaptive difficulty based on mastery (IRT model)',
      'Automated problem generation and step-by-step solutions',
      'Multilingual tutoring in 30+ languages',
      'Parent and teacher dashboards with mastery heatmaps',
      'LTI / Canvas / Google Classroom integration',
    ],
    benefits: [
      '1-to-1 tutoring at 5% the cost per student',
      '24/7 availability — student schedules always covered',
      'Personalized pace that no human tutor can scale to',
      'Objective mastery measurement for every learner',
    ],
    pricing: { basic: '$49', pro: '$149', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-tutoring-platform',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '📚',
    href: '/ai-tutoring-platform',
    popular: true,
    category: 'ai',
  },
  {
    ...
    description: 'AI-powered remote proctoring: browser lockdown, webcam monitoring, plagiarism detection, identity verification, and real-time anomaly alerts. Supports high-stakes exams, certification tests, and academic assessments.',
    features: [
      'Browser lockdown with tab-switch, copy-paste, and screen-share detection',
      'Webcam and screen monitoring with gaze tracking',
      'Multi-person identity verification (face match against ID)',
      'Plagiarism detection with similarity scoring',
      'Real-time fraud alert dashboard and post-exam reports',
      'AIPA / GDPR / FERPA compliant data handling',
    ],
    benefits: [
      'Cut exam administration costs by 70%',
      'Eliminate identity fraud in remote-certification programs',
      'Reduce proctor-to-student ratio from 1:25 to 1:500',
      'Pass regulatory audits with detailed evidence trails',
    ],
    pricing: { basic: '$99', pro: '$299', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-exam-proctoring',
      email: 'commercial@ziontechgroup.com',
      phone: '/ai-exam-proctoring',
    },
    icon: '🎓',
    href: '/ai-exam-proctoring',
    category: 'ai',
  },
  ...
  // ── AI Industrial & Manufacturing ────────────────────────────────
  {
    ...
    description: 'Vibration, temperature, acoustic, and electrical signal analysis to predict bearing, motor, pump, and turbine failures weeks before they happen. Reduces unplanned downtime by 40-60% across factory floors.',
    features: [
      'Multi-sensor fusion (vibration, temp, acoustics, current)',
      'Remaining Useful Life (RUL) estimation per component',
      'Root cause identification via AI signal deconvolution',
      'CMMS integration (Fiix, SAP, IBM Maximo)',
      'Edge inference on gateway devices (on-premise)',
      'Mobile alerts and dashboard with drill-down waveforms',
    ],
    benefits: [
      'Reduce unplanned downtime by 40-60%',
      'Reduce maintenance spend by 20-30% (run-to-failure elimination)',
      'Extend equipment life through proactive replacements',
      'Lower spares inventory holding costs',
    ],
    pricing: { basic: '$1,499', pro: '$4,999', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-predictive-maintenance',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🔧',
  ...
  },
  {
    ...
    description: 'High-speed visual defect detection on production lines using multi-spectral cameras and deep learning. Identifies scratches, dents, misalignments, missing parts, surface-finish deviations, and label errors in real time.',
    features: [
      'Multi-spectral image capture (visible, UV, IR, polarized)',
      'Real-time inference at 200 FPS on production line cameras',
      'Defect type classification and severity scoring',
      'Trend analysis and SPC control charts (AI-augmented)',
      'Retraining pipeline for new defect classes without ML team',
      'MES integration (SAP ME, Siemens Opcenter, Plex)',
    ],
    benefits: [
      'Inspection speed 10-50× faster than manual inspection',
      'Defect detection accuracy 99.5%+, exceeding human consistency',
      'Reduce quality escapes and warranty costs by 60%+',
      'Lower rework costs through early detection',
    ],
    pricing: { basic: '$2,499', pro: '$7,999', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-quality-inspection',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🔬',
    href: '/ai-quality-inspection',
    popular: true,
    category: 'ai',
  },
  {
    ...
    description: 'Battery storage dispatch optimization, renewable forecasting, demand-side management, and energy procurement arbitrage. Maximize energy margin while hitting decarbonization targets and grid stability requirements.',
    features: [
      'Battery storage dispatch optimization (Day-ahead / Real-time)',
      'Solar + Wind generation forecasting (NWP + satellite)',
      'Demand response and load shifting automation',
      'Energy procurement: PPA, PPAs, and spot-market arbitrage',
      'Scope 1 / 2 / 3 carbon accounting and reporting',
      'DERMS- and SCADA-integrated real-time control',
    ],
    benefits: [
      'Increase energy margin by 15-35% through optimized dispatch',
      'Reduce peak-demand charges and demand-response penalties',
      'Accelerate decarbonization with data-backed decisions',
      'Minimize curtailment and renewable spill losses',
    ],
    pricing: { basic: '$1,999', pro: '$5,999', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-energy-optimization',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '⚡',
    href: '/ai-energy-optimization',
    category: 'ai',
  },
  ...
  // ── Cybersecurity & Intelligence ────────────────────────────────
  {
    ...
    description: 'Automated threat intelligence platform that ingests, normalizes, and enriches IOCs from 200+ feeds — MITRE ATT&CK mapping, dark web monitoring, geopolitical event correlation — and delivers analyst-ready briefs in minutes, not days.',
    features: [
      'IoC normalization and enrichment (IP, domain, hash, YARA)',
      'MITRE ATT&CK technique mapping and ATT&CK Navigator export',
      'Dark web and underground marketplace monitoring',
      'Geopolitical threat correlation and campaign tracking',
      'Automated TIP reports and analyst brief generation',
      'Integration with Sentinel, Splunk, QRadar, and SIEM/XDR',
    ],
    benefits: [
      'Reduce analyst research time from hours to minutes',
      'IoC coverage across 200+ feeds, fully correlated',
      'Improve MTTR by 30-50% with contextualized threat data',
      'Deliver executive threat briefs automatically on schedule',
    ],
    pricing: { basic: '$499', pro: '$1,499', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-threat-intelligence',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🕵️',
    href: '/ai-threat-intelligence',
    popular: true,
    category: 'security',
  },
  {
    id: 'ai-deepfake-detection',
    title: 'AI Deepfake & Synthetic Media Detection',
    description: 'Detect AI-generated images, deepfake videos, cloned audio, and LLM-generated text at scale. Enterprise-grade API with batch processing and browser extension for real-time verification.',
    features: [
      'Image and video deepfake detection (GAN and diffusion artifacts)',
      'Voice clone and synthetic audio detection',
      'LLM-generated text watermark detection and detection',
      'Batch API with async job processing',
      'Browser extension for real-time media verification',
      'Detailed forensics report with heatmaps and confidence scores',
    ],
    benefits: [
      'Protect brand and executive reputation from deepfake attacks',
      'Detect synthetic fraud in identity verification before payout',
      'Stay ahead of synthetic media threats as models evolve',
      'Scale verification without manual review queue',
    ],
    pricing: { basic: '$299', pro: '$999', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-deepfake-detection',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🎭',
  ...
  },
  {
    ...
    title: 'AI Privileged Access Management',
    description: 'AI-driven PAM that continuously revues, recommends, and enforces least-privilege access rules across your cloud, on-prem, and SaaS estate. Live session escalation, session recording, and zero-trust ready.',
    features: [
      'Continuous entitlement review via ML anomaly detection',
      'Least-privilege rule engine with auto-certification',
      'Privileged session recording and keystroke analytics',
      'Emergency just-in-time access with real-time approval',
      'Shadow-admin detection across cloud and on-prem',
      'SOC 2, PCI-DSS, HIPAA evidence packs and reporting',
    ],
    benefits: [
      'Reduce excess access privileges by 70%+',
      'Detect active breached accounts within seconds',
      'Meet SOX and SOC 2 access review requirements on autopilot',
      'Zero standing admin access — JIT by default',
    ],
    pricing: { basic: '$1,499', pro: '$4,999', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-privilege-access-manager',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🔑',
    href: '/ai-privilege-access-manager',
    category: 'security',
  },
  ...
  // ── Data Engineering ────────────────────────────────────────────
  {
    ...
    description: 'Continuously monitor, profile, and repair your data lake, warehouse, and API feeds. ML anomaly detection for null spikes, schema drift, freshness breaks, and statistical outliers — with auto-healing pipelines.',
    features: [
      'Automated data profiling and anomaly detection',
      'Schema drift alerts with lineage visualization',
      'Self-healing pipelines with retry, fallback, and data repair',
      'Freshness SLA tracking and alerting',
      'Custom quality rules with threshold and ML anomaly detection',
      'SLA credits, data quality scoring, and trend analytics',
    ],
    benefits: [
      'Eliminate bad data from reaching dashboards and models',
      'Reduce data engineering toil by 60% via self-healing',
      'Improve data trust score across the organization',
      'Meet data SLA requirements with automated tracking',
    ],
    pricing: { basic: '$399', pro: '$1,299', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-data-quality-fabric',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🕸️',
    href: '/ai-data-quality-fabric',
    category: 'data',
  },
  {
    id: 'ai-feature-store',
    title: 'AI Feature Store',
    description: 'Centralized feature store for ML teams: versioned feature definitions, online/offline serving, feature discovery, A/B testing on training sets, and point-in-time correctness guarantees across streaming and batch pipelines.',
    features: [
      'Online and offline feature stores with consistent APIs',
      'Feature versioning and lineage, rollback at any point',
      'Point-in-time correctness guarantees for training zero leakage',
      'Feature discovery portal and metadata registry',
      'Streaming feature pipelines (Kafka, Flink, Spark Structured Streaming)',
      'Monitoring for training-serving skew and staleness alerts',
    ],
    benefits: [
      'Reduce ML feature engineering time by 50-70%',
      'Eliminate training-serving skew and data leakage',
      'Enable feature reuse across 10+ ML models without duplication',
      'Stabilize and accelerate model retraining and CI',
    ],
    pricing: { basic: '$599', pro: '$1,999', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-feature-store',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '⚗️',
  ...
  },
  {
    ...
    title: 'AI Metadata & Data Lineage Manager',
    description: 'Automated metadata collection, data lineage tracing, impact analysis, and data governance at scale. ML-powered column profiling and PII detection built in.',
    features: [
      'Auto-discovered metadata across 50+ data sources',
      'End-to-end lineage from source to table to dashboard to model',
      'Impact analysis: who is affected by a schema change',
      'ML-powered PII/PHI/PCI scanner across all pipelines',
      'Self-service data catalog with search and starred datasets',
      'Governance policies and access requests with workflow approval',
    ],
    benefits: [
      'Cut data discovery time from days to seconds',
      'Meet data governance requirements with full audit trails',
      'Reduce privacy risk with automated PII scanning',
      'Accelerate onboarding of new data engineers',
    ],
    pricing: { basic: '$499', pro: '$1,599', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-metadata-management',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '📋',
    href: '/ai-metadata-management',
    category: 'data',
  },

  // ── IT Infrastructure & DevEx ───────────────────────────────────
  {
    id: 'ai-infra-provisioner',
    title: 'AI Infrastructure Provisioner',
    description: 'AI-infers infrastructure needs from code and traffic patterns — automatically sizes clusters, provisions VPCs, configures IAM, and applies HA/DR patterns without manual Terraform expertise.',
    features: [
      'Code-aware inference of infrastructure requirements',
      'Auto-generated Terraform / Pulumi / CloudFormation',
      'HA/DR pattern recommendation and implementation',
      'Cost estimates and recommendations before apply',
      'Drift detection and self-healing drift remediation',
      'Multi-cloud: AWS, GCP, Azure, and private-cloud targets',
    ],
    benefits: [
      'Provision production infra in minutes, not weeks',
      'Reduce infrastructure errors by 80% via AI generation',
      'Hire platform engineers faster — AI fills expertise gaps',
      'Optimize costs by right-sizing at code-ship time',
    ],
    pricing: { basic: '$899/mo', pro: '$2,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-infra-provisioner',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🏗️',
    href: '/ai-infra-provisioner',
    popular: true,
    category: 'it',
  },
  {
    id: 'ai-log-analysis',
    title: 'AI Log Analysis & Root Cause',
    description: 'AI-powered log analytics with automatic structured extraction, anomaly detection, log correlation across microservices, and AI-generated root cause summaries in plain English — no query language needed.',
    features: [
      'Automatic log parsing and structured field extraction',
      'AI anomaly detection across log volume, error rate, latency, and patterns',
      'Cross-service causal chain visualization and RCA',
      'Plain-English root cause summary with evidence links',
      'Natural language query ("show me all payment failures last hour")',
      'Integration: Datadog, Splunk, CloudWatch, Loki/ELK',
    ],
    benefits: [
      'Reduce MTTR by 60% via instant RCA instead of log spelunking',
      'Detect cross-service issues that escape single-tool monitoring',
      'Free SREs from writing and maintaining alert rules',
      'Investigation 80% automated, not manual',
    ],
    pricing: { basic: '$499', pro: '$1,499', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-log-analysis',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '📋',
    href: '/ai-log-analysis',
    popular: true,
    category: 'it',
  },
  {
    id: 'ai-load-testing',
    title: 'AI Load & Performance Testing',
    description: 'AI-designed load-test suites that stress your API, web, and mobile endpoints at production scale with realistic traffic patterns. Auto-generates load profiles from production traces, predicts breaking points, and produces CI/CD ready test scripts.',
    features: [
      'AI-generated load profiles from production traffic traces',
      'Scalable distributed load injection (10K−1M concurrent users)',
      'Smart ramp-up and scenario modeling',
      'AI breaking-point prediction and capacity analysis',
      'Security / DDoS simulation alongside performance tests',
      'k6/Gatling/Artillery CI/CD pipeline integration',
    ],
    benefits: [
      'Catch capacity issues before production deployment',
      'Reduce load test scripting time by 80%',
      'Predict breaking points with ML, not guesswork',
      'Deploy with confidence at any scale',
    ],
    pricing: { basic: '$199', pro: '$699', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-load-testing',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🚀',
    href: '/ai-load-testing',
    category: 'it',
  },
  ...
  // ── Cloud & DevOps ──────────────────────────────────────────────
  {
    ...
    title: 'AI Kubernetes Optimization',
    description: 'Auto-right-size your Kubernetes workloads: HPA tuning, pod right-sizing, node auto-scaling, spot-instance placement, and cost allocation across 100+ clusters. No manual YAML expertise required.',
    features: [
      'Auto-right-sizing pods: CPU/memory requests and limits per workload',
      'Intelligent HPA tuning from pod-level telemetry',
      'Node auto-scaler with spot/preemptible VM orchestration',
      'Cluster cost allocation by namespace, service, team',
      'Workload placement recommendations (spot vs on-demand vs committed)',
      'OOMKill, P99 latency, and scheduling delay alerts',
    ],
    benefits: [
      'Reduce K8s cluster costs by 30-50%',
      'Achieve <5% scheduling waste (over-provisioning)',
      'Eliminate cluster capacity planning guesswork',
      'Support 100+ cluster fleets with 1 platform engineer',
    ],
    pricing: { basic: '$299/mo', pro: '$899/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-kubernetes-optimizer',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '☸️',
    href: '/ai-kubernetes-optimizer',
    popular: true,
    category: 'cloud',
  },
  {
    ...
    description: 'Deploy and operate serverless applications with built-in AI optimization: cold-start elimination, auto-tuned memory/timeout, cost prediction, P99 latency guarantees, and observability dashboards.',
    features: [
      'Cold-start elimination via pre-warming and snapshot restore',
      'Auto-tuned memory, timeout, and concurrency per endpoint',
      'Edge deployment with geo-routing optimization',
      'Cost prediction and anomaly detection for each function',
      'Built-in observability: traces, DORA metrics, business KPIs',
      'Deploy via CLI, CI/CD, or Terraform provider',
    ],
    benefits: [
      'Reduce serverless costs by 40-70% over default configs',
      'Achieve sub-10ms cold starts consistently',
      'Deploy to 100+ edge locations with zero configuration',
      'Scales from prototype to 10M RPS without refactoring',
    ],
    pricing: { basic: '$0 pay-per-use', pro: '$199/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-serverless-platform',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '⚡',
    href: '/ai-serverless-platform',
    category: 'cloud',
  },
  {
    id: 'ai-vpc-zero-trust',
    title: 'AI Zero Trust Network',
    description: 'Zero Trust Network Access (ZTNA) with AI-driven trust scoring: continuously evaluates device posture, user behavior, geo-velocity, service identity, and context to grant least-privilege access in real time.',
    features: [
      'Continuous trust scoring (device, user, geo-velocity, service)',
      'Micro-segmentation with identity-aware proxy baked in',
      'Least-privilege access per app, per session, per user',
      'AI-based anomaly detection and auto-remediation',
      'Full session recording and audit trail',
      'NIST 800-207 compliant by design',
    ],
    benefits: [
      'Reduce breach blast radius by 90%',
      'Eliminate VPN sprawl and lateral movement risk',
      'Support hybrid/multi-cloud from a single control plane',
      'Comply with Zero Trust mandates without manual policy ops',
    ],
    pricing: { basic: '$499/mo', pro: '$1,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-vpc-zero-trust',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🛡️',
    href: '/ai-vpc-zero-trust',
    popular: true,
    category: 'cloud',
  },
  ...
  // ── Automation & Operations ─────────────────────────────────────
  {
    ...
    description: 'AI-powered RPA with computer-vision-based UI automation, cognitive document processing, semantic validation, exception handling with human-in-the-loop, and governance dashboard for 1,000+ bot fleets.',
    features: [
      'Computer-vision-based UI automation (no selectors needed)',
      'Cognitive document processing (OCR + NER + classification)',
      'Semantic validation prevents silent data corruption',
      'AI-driven exception handling and human-in-the-loop escalation',
      'Governance dashboard: bot utilization, SLA, audit trails',
      'Unattended bots run 24/7 with idle-time auto-sleep',
    ],
    benefits: [
      'Automate 80% of repetitive knowledge work with high accuracy',
      'Cut RPA development time by 60% vs logic-only bots',
      'Error rate drops from 5-10% (legacy bots) to <0.1%',
      'Scale automation without hiring automation specialists',
    ],
    pricing: { basic: '$299/bot/mo', pro: '$799/bot/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-rpa-platform',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🤖',
    href: '/ai-rpa-platform',
    category: 'automation',
  },
  {
    id: 'ai-test-automation-framework',
    title: 'AI Test Automation Framework',
    description: 'AI-first end-to-end test suite: auto-generates tests from user journeys, self-healing selectors, visual diff regression testing, flake detection, test prioritization, and AI-generated fix suggestions for failing tests.',
    features: [
      'Test generation from Playwright/Selenium autoplay recordings',
      'Self-healing selectors (survives DOM attribute and structure changes)',
      'Visual regression testing with AI diff scoring',
      'Flake detection and ML-based flake risk scoring',
      'Test prioritization: run high-impact tests first',
      'One-click fix suggestions from open-source Stack Overflow and docs',
    ],
    benefits: [
      'Reduce QA cycle times from days to hours',
      'Cut test maintenance by 80% via self-healing',
      'Achieve 95%+ coverage without proportional QA headcount',
      'Ship features with confidence even on rapid refactors',
    ],
    pricing: { basic: '$299/mo', pro: '$899/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-test-automation-framework',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🧪',
    href: '/ai-test-automation-framework',
    category: 'automation',
  },
  {
    id: 'ai-low-code-integration',
    title: 'AI Low-Code Integration Platform',
    description: 'Visual workflow builder with 500+ pre-built connectors and an AI copilot that translates natural language requests ("when Stripe payment fails, notify Slack and retry 3x") into production-ready workflows.',
    features: [
      '500+ pre-built connectors (SaaS, DBs, APIs, on-prem)',
      'AI copilot for workflow generation from natural language',
      'Visual flow designer with drag-and-drop and inline code',
      'Built-in retry, circuit breaker, dead-letter queue, error handling',
      'Schema evolution and backward-compatible deploy strategy',
      'Audit logs, run history, SLA tracking, and alerting',
    ],
    benefits: [
      'Build and deploy integrations in hours, not weeks',
      'Eliminate integration build and maintenance backlog',
      'Enable citizen integration as well as professional engineers',
      'Ship integrations safely with built-in error handling',
    ],
    pricing: { basic: '$199', pro: '$599', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-low-code-integration',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🔗',
    href: '/ai-low-code-integration',
    category: 'automation',
  },

  // ── New AI Services for AI Services Category ────────────────────
  {
    id: 'ai-governance-compliance',
    title: 'AI Governance & Compliance Suite',
    description: 'Full AI governance stack: model card auto-generation, bias testing, fairness scoring, EU AI Act risk classification, regulatory reporting, and AI audit trails. Makes your AI systems explainable, auditable, and compliant.',
    features: [
      'Automated model card generation and version registry',
      'Fairness and bias testing across protected attributes',
      'EU AI Act risk classification and conformity scoring',
      'Regulatory reporting for FDA, NIST AI RMF, ISO 42001',
      'Centralized AI audit trail with tamper-evident evidence',
      'Human-in-the-loop bias review workflow with notifications',
    ],
    benefits: [
      'Get to EU AI Act compliance in weeks, not months',
      'Reduce manual audit prep from weeks to hours',
      'Mitigate reputational and regulatory risk proactively',
      'Enable AI governance without hiring a dedicated governance team',
    ],
    pricing: { basic: '$1,499/mo', pro: '$4,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-governance-compliance',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '⚖️',
    href: '/ai-governance-compliance',
    popular: true,
    category: 'ai',
  },
  {
    id: 'ai-reinforcement-learning-ops',
    title: 'AI Reinforcement Learning Operations (RLOps)',
    description: 'Production-grade ML system for training, evaluating, and deploying RL agents in sim-to-real pipelines. Supports Gymnasium, Brax, MuJoCo, IsaacSim, and custom environments with distributed training and A/B deployment.',
    features: [
      'Distributed RL training with automatic checkpointing',
      'Environment registry with simulators (Gymnasium, Brax, IsaacSim)',
      'Policy evaluation, distillation, and safe deployment gating',
      'Sim-to-real transfer validation suite',
      'Chronicle logger for reward, policy, and episode analysis',
      'Distributed evaluation cluster with GPU scheduling',
    ],
    benefits: [
      'Train RL agents 5-10× faster via distributed training',
      'Deploy RL policies safely with behavior validation gates',
      'Sim-to-real success rates improve from 50% to 90%+',
      'Experiment management without manual checkpoint bookkeeping',
    ],
    pricing: { basic: '$999/mo', pro: '$3,499/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-reinforcement-learning-ops',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🔄',
    href: '/ai-reinforcement-learning-ops',
    category: 'ai',
  },
  {
    id: 'ai-federated-learning',
    title: 'AI Federated Learning Platform',
    description: 'Train global AI models across distributed edge devices and siloed data sources without centralizing data. Supports cross-device and cross-silo FL with secure aggregation, differential privacy, and model compression.',
    features: [
      'Cross-device (mobile/IoT) and cross-silo (org/region) FL',
      'Secure aggregation (SecAgg) with cryptographic noise',
      'Differential privacy guarantees (ε-differential privacy)',
      'Model pruning and quantization for edge distribution',
      'Automated hyperparameter tuning per round',
      'Training monitoring dashboard with device participation rates',
    ],
    benefits: [
      'Train on private/siloed data without data movement',
      'Reduce central compute costs by 60-80%',
      'Stay compliant with data residency laws effortlessly',
      'Enable collaborative model training across competitors',
    ],
    pricing: { basic: '$1,999/mo', pro: '$5,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-federated-learning',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🌐',
    href: '/ai-federated-learning',
    category: 'ai',
  },
  ...
  // ── IT Observability ─────────────────────────────────────────────
  {
    ...
    title: 'Synthetic Monitoring & Uptime Intelligence',
    description: 'Synthetic monitoring across 200+ locations worldwide: HTTP/API, SSL, DNS, TCP, browser playback, and real-browser CI testing. AI-driven anomaly detection, PWA support, and instant alerting with on-call routing.',
    features: [
      '200+ global monitoring locations across all continents',
      'HTTP/API, SSL, DNS, TCP, and full browser playback checks',
      'PWA and deep-link URL checks',
      'AI-powered anomaly detection (synthetic + real-traffic)',
      'On-call routing: PagerDuty, Slack, email, webhook, SMS',
      'Historical replay, correlation, and root cause drill-down',
    ],
    benefits: [
      'Detect outages globally up to 5 minutes before users report',
      'Confirm golden-path availability 24/7 regardless of real traffic',
      'Reduce false positives with AI anomaly filtering',
      'Fix production issues faster with synthetic replay evidence',
    ],
    pricing: { basic: '$49/mo', pro: '$149/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/it-synthetic-monitoring',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '📡',
    href: '/it-synthetic-monitoring',
    popular: true,
    category: 'it',
  },
  {
    ...
    description: 'Intelligent API gateway with AI-driven rate limiting, bot detection, credential stuffing prevention, schema enforcement, anomaly-based security policies, and auto-generated developer portal.',
    features: [
      'Rate limiting: per-key, per-endpoint, per-IP, exponential backoff',
      'AI bot detection (behavioral fingerprint, velocity scoring)',
      'JWT/OAuth2/API-key mutual auth with rotation automation',
      'Schema enforcement with OpenAPI contract validation',
      'Auto-generated developer portal with interactive docs, SDKs',
      'Edge caching, compression, and geo-routing rules',
    ],
    benefits: [
      'Block automated attacks before they hit your APIs',
      'Reduce API abuse and operational costs by 60%',
      'Ship APIs faster: auto-generated portal and SDKs',
      'Enforce API contracts without manual gateway ops',
    ],
    pricing: { basic: '$0 (open-source)', pro: '$1,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/it-api-gateway-ai',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🔌',
    href: '/it-api-gateway-ai',
    popular: true,
    category: 'it',
  },
  {
    id: 'it-identity-governance',
    title: 'AI Identity Governance & Administration',
    description: 'AI-driven identity lifecycle: auto-onboarding, role mining, access certifications, orphaned-access cleanup, SOD conflict detection, and identity analytics dashboard.',
    features: [
      'Auto-onboarding workflow tied to HRIS events (Okta + Workday)',
      'Role-mining: discover implicit role clusters from access data',
      'Automated access certification campaigns with AI pre-fill',
      'Orphaned-access and excess-permission detection',
      'SoD conflict detection with remediation suggestions',
      'Identity analytics: access tenure, usage heatmap, risk scoring',
    ],
    benefits: [
      'Certify 10,000+ users quarterly without a team of analysts',
      'Reduce SoD violations and audit findings by 70%',
      'Automate 90% of IGA lifecycle events',
      'Stay compliant with FedRAMP, SOX, NIST SP 800-63 access reviews',
    ],
    pricing: { basic: '$999/mo', pro: '$3,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/it-identity-governance',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '👤',
    href: '/it-identity-governance',
    category: 'it',
  },
  {
    id: 'secure-file-transfer',
    title: 'Secure Managed File Transfer (MFT)',
    description: 'Enterprise-grade managed file transfer with end-to-end encryption, SFTP/HTTPS/AS2 protocols, workflow automation, scheduled transfers, audit trails, and compliance reporting — SOC 2, HIPAA, PCI-DSS ready.',
    features: [
      'Protocol support: SFTP, FTPS, HTTPS, AS2, OFTP',
      'End-to-end encryption with PGP and AES-256',
      'Workflow automation: rename, transform, validate, notify',
      'Automated scheduling with SLA and retry management',
      'Full transfer audit trail and compliance reports',
      'HA cluster with active-active failover',
    ],
    benefits: [
      'Replace ad-hoc file sharing with audited, encrypted transfer',
      'Meet compliance requirements with full audit trails',
      'Automate high-volume batch transfers with zero manual steps',
      'HA cluster eliminates single-point-of-failure',
    ],
    pricing: { basic: '$499', pro: '$1,499', enterprise: 'Custom' },
    contactInfo: {
      website: '/secure-file-transfer',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🔐',
  ...
  },
  {
    ...
    description: 'Ultra-secure vault for API keys, DB credentials, TLS certs, and cloud secrets with automatic rotation, dynamic secrets, fine-grained IAM policies, and encrypted secret brokers for every major cloud and runtime.',
    features: [
      'Secrets storage: KV, certificates, SSH keys, database credentials',
      'Dynamic secrets: on-demand, short-lived DB/VM credentials',
      'Automatic rotation with zero application restart',
      'Fine-grained IAM: per-path, per-mount, per-secret permissions',
      'Encrypted secret broker for every cloud and runtime',
      'Full audit trail with immutable log stream to SIEM',
    ],
    benefits: [
      'Eliminate secrets exposure risk from code and CI/CD logs',
      'Achieve zero-trust credential access across all environments',
      'Pass PCI-DSS, SOC 2, and FedRAMP secrets audit requirements',
      'Centralize secret management for 100+ apps across multiple clouds',
    ],
    pricing: { basic: '$299/mo', pro: '$999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-secrets-management',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🗝️',
    href: '/ai-secrets-management',
    popular: true,
    category: 'it',

  {
    ...
    description: 'Unified API gateway routing across OpenAI, Anthropic, Mistral with cost-optimization and fallback chains.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
      'Feature highlight four',
      'Feature highlight five',
    ],
    benefits: [
      'Key benefit one',
      'Key benefit two',
    ...
    pricing: { basic: '$1,299/mo', pro: '$4,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-services/ai-llm-router-pro',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🔀',
    href: '/ai-services/ai-llm-router-pro',
    popular: True,
    category: 'ai',
  },
...

  {
    ...
    description: 'No-code builder for autonomous voice agents: IVR replacement, booking, and support triage via real-time STT+LLM+TTS.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$499/mo', pro: '$1,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-services/ai-voice-agent-builder',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '📞',
    href: '/ai-services/ai-voice-agent-builder',
    popular: True,
    category: 'ai',
  },
...

  {
    ...
    description: 'Automated candidate screening and interviewing with structured scoring — cuts time-to-hire by 70%.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    contactInfo: {
      website: '/ai-services/ai-interview-conduct-bot',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🎙️',
    href: '/ai-services/ai-interview-conduct-bot',
    popular: False,
    category: 'ai',
  },
...

  {
    ...
    description: 'Aggregate and analyze employer reviews from Glassdoor, Indeed, LinkedIn with sentiment trends and competitive comparison.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    contactInfo: {
      website: '/ai-services/ai-glassdoor-review-analyzer',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🏢',
    href: '/ai-services/ai-glassdoor-review-analyzer',
    popular: False,
    category: 'ai',
  },
...

  {
    ...
    description: 'Natural-language dashboard builder: describe your KPIs, get an interactive auto-refreshing dashboard in minutes.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$299/mo', pro: '$999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-services/ai-dashboard-designer',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '📈',
    href: '/ai-services/ai-dashboard-designer',
    popular: False,
    category: 'ai',
  },
...

  {
    ...
    description: 'Multi-jurisdiction sales & use tax lookup, exemption management, and audit-ready filing reports.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    contactInfo: {
      website: '/ai-services/ai-tax-compliance-calculator',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🧾',
    href: '/ai-services/ai-tax-compliance-calculator',
    popular: False,
    category: 'ai',
  },
...

  {
    ...
    description: 'Parse bug reports and crash dumps → auto-create GitHub/Jira issues with reproduction steps and priority scoring.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    contactInfo: {
      website: '/ai-services/ai-bug-to-issue-router',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🐛',
    href: '/ai-services/ai-bug-to-issue-router',
    popular: True,
    category: 'ai',
  },
...

  {
    ...
    title: 'AI Voice Brand Consistency Checker',
    description: 'Score brand-text quality against voice, tone, and style guide — flag violations and auto-correct draft copies.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$199/mo', pro: '$699/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-services/ai-voice-brand-consistency',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🗣️',
    href: '/ai-services/ai-voice-brand-consistency',
    popular: False,
    category: 'ai',
  },
...

  {
    ...
    description: 'Personalized budget optimization, debt payoff simulation, investment allocation, and retirement projection.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    contactInfo: {
      website: '/ai-services/ai-personal-finance-coach',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '💰',
    href: '/ai-services/ai-personal-finance-coach',
    popular: False,
    category: 'ai',
  },
...

  {
    ...
    description: 'Personal meal plans from dietary preferences, allergies, macro targets — auto-generated grocery lists per recipe.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$9/mo', pro: '$29/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-services/ai-nutrition-meal-planner',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🥗',
    href: '/ai-services/ai-nutrition-meal-planner',
    popular: False,
    category: 'ai',
  },
...

  {
    ...
    description: 'Analyse ATS pipelines, auto-source candidates, score against role, and benchmark referral vs agency ROI.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    contactInfo: {
      website: '/ai-services/ai-hiring-pipeline-optimizer',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '👥',
    href: '/ai-services/ai-hiring-pipeline-optimizer',
    popular: False,
    category: 'ai',
  },
...

  {
    ...
    description: 'Auto-generate professional e-commerce imagery: background removal, studio lighting, shadow, multi-variant generation.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    contactInfo: {
      website: '/ai-services/ai-product-photo-enhancer',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '📸',
    href: '/ai-services/ai-product-photo-enhancer',
    popular: False,
    category: 'ai',
  },
...

  {
    ...
    description: 'Monitor competitor pricing across e-commerce and SaaS — alerts, repricing recommendations, historical trend charts.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$149/mo', pro: '$499/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-services/ai-competitive-price-tracker',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🏷️',
    href: '/ai-services/ai-competitive-price-tracker',
    popular: False,
    category: 'ai',
  },
...

  {
    ...
    description: 'Customer, product, and channel profitability engine: COGS attribution, LTV/CAC, cohort curves, board-ready P&L.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    contactInfo: {
      website: '/ai-services/ai-profitability-dashboard',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '💹',
    href: '/ai-services/ai-profitability-dashboard',
    popular: False,
    category: 'ai',
  },
...

  {
    ...
    description: 'Load, stress, spike, and soak testing for REST & GraphQL APIs. Auto-generate scripts, CI/CD regression gates.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$99/mo', pro: '$499/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/it-services/it-api-performance-testing',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '⚡',
    href: '/it-services/it-api-performance-testing',
    popular: True,
    category: 'it',
  },
...

  {
    ...
    description: 'Tabletop to live-fire IR drills with scorecards, postmortem templates, and team improvement tracking.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$299/mo', pro: '$999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/it-services/it-incident-response-simulator',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🚨',
    href: '/it-services/it-incident-response-simulator',
    popular: False,
    category: 'it',
  },
...

  {
    ...
    description: 'Tagging enforcement, anomaly spend detection, right-sizing recommendations with chargeback/showback cost allocation.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$49/mo', pro: '$399/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/it-services/it-cloud-cost-governance',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '☁️',
    href: '/it-services/it-cloud-cost-governance',
    popular: True,
    category: 'it',
  },
...

  {
    ...
    title: 'IT Observability & Centralized Logging',
    description: 'Prometheus+Grafana+Loki+Tempo stack. Structured logging with correlation IDs, alertmanager, log tiering to S3.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$499/mo', pro: '$1,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/it-services/it-observability-logging',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '👁️',
    href: '/it-services/it-observability-logging',
    popular: False,
    category: 'it',
  },
...

  {
    ...
    description: 'Enterprise AI knowledge base with auto-ingestion from 50+ sources, hybrid search, and citation-backed answers.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$499/mo', pro: '$1,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-services/ai-knowledge-base-rag',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '📚',
    href: '/ai-services/ai-knowledge-base-rag',
    popular: True,
    category: 'ai',
  },
...

  {
    ...
    title: 'AI Form Filler & Automation',
    description: 'Zero-code form automation recorder — fills any PDF, web form, DocuSign, or government portal with zero manual effort.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$49/mo', pro: '$149/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-services/ai-form-filler-intelligence',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '📋',
    href: '/ai-services/ai-form-filler-intelligence',
    popular: True,
    category: 'ai',
  },
...

  {
    ...
    description: 'Multi-LLM routing with load balancing, fallback chains, token budgeting, and unified API across OpenAI, Anthropic, Gemini.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$1,499/mo', pro: '$4,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-services/ai-api-orchestration-layer',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🔀',
    href: '/ai-services/ai-api-orchestration-layer',
    popular: True,
    category: 'ai',
  },
...

  {
    ...
    title: 'AI KYC / AML Compliance Engine',
    description: 'Automated identity verification, sanctions screening, biometric liveness — FINRA / OFAC / FATF compliant.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$1,299/mo', pro: '$4,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-services/ai-kyc-aml-compliance',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🛡️',
    href: '/ai-services/ai-kyc-aml-compliance',
    popular: True,
    category: 'ai',
  },
...

  {
    ...
    description: 'Automated PII/PHI/PCI redaction in PDFs and images with ML entity detection — court-ready verbatim output.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$99/mo', pro: '$499/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-services/ai-smart-document-redactor',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🔒',
    href: '/ai-services/ai-smart-document-redactor',
    popular: True,
    category: 'ai',
  },
...

  {
    ...
    description: 'Proactive DQ monitoring: schema drift, anomaly scoring, automated profiling, DQ scorecards, PII flagging — Snowflake, BigQuery, Databricks.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$499/mo', pro: '$1,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-services/ai-data-quality-guardian',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🛡️',
    href: '/ai-services/ai-data-quality-guardian',
    popular: False,
    category: 'ai',
  },
...

  {
    ...
    description: 'AI observability: distributed tracing, log anomaly detection, auto-RCA — Datadog/Runsible/Grafana data import compatible.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    pricing: { basic: '$999/mo', pro: '$3,999/mo', enterprise: 'Custom' },
    contactInfo: {
      website: '/ai-services/ai-observability-turbo',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '📡',
    href: '/ai-services/ai-observability-turbo',
    popular: True,
    category: 'ai',
  },
...

  {
    ...
    title: 'AI E-commerce Smart Search',
    description: 'NL product search, visual search, fuzzy matching, personalized ranking — 20–40% conversion uplift.',
    features: [
      'Feature highlight one',
      'Feature highlight two',
      'Feature highlight three',
    ...
    contactInfo: {
      website: '/ai-services/ai-ecommerce-smart-search',
      email: 'commercial@ziontechgroup.com',
      phone: '+1 302 464 0950',
    },
    icon: '🛍️',
    href: '/ai-services/ai-ecommerce-smart-search',
    popular: False,
    category: 'ai',
  },
  },

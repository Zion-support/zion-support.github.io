...
export const allServices: Service[] = [
  ...
  ...automationServices,
  // ══════════════════════════════════════════════════════════════
  // WAVE 22: NEW SERVICES (18 additions)
  // ══════════════════════════════════════════════════════════════

  // ── AI SERVICES ──
  {
    id: 'ai-clinical-trial-design-optimizer',
    title: 'AI Clinical Trial Design Optimizer — Pharmaceutical Research',
    description: 'AI-powered clinical trial design and optimization. Patient recruitment modeling, endpoint prediction, adaptive trial protocols, and regulatory submission support. Reduces trial failure rate by 35% and accelerates timelines.',
    features: ['Patient recruitment modeling','Adaptive trial protocols','Endpoint prediction','Regulatory submission support (FDA/EMA)','Risk-based monitoring','Real-time enrollment dashboards','Historical trial data mining'],
    benefits: [],
    ...
    icon: '💊', href: '/services/ai-clinical-trial-design-optimizer',
    popular: false, category: 'ai', industry: 'Healthcare & Life Sciences',
  },
  {
    id: 'ai-fraud-detection-real-time',
    title: 'AI Real-Time Fraud Detection — Transaction Monitoring',
    description: 'Real-time fraud detection for financial transactions. ML models analyze behavioral patterns, device fingerprinting, and network graphs to flag fraudulent activity in under 50ms. Reduces false positives by 70% with adaptive learning.',
    features: ['Real-time transaction scoring (<50ms)','Behavioral biometrics','Device fingerprinting','Network graph analysis','Adaptive ML models','Case management dashboard','Regulatory reporting'],
    benefits: [],
    ...
    icon: '🔒', href: '/services/ai-fraud-detection-real-time',
    popular: true, category: 'ai', industry: 'Financial Services & FinTech',
  },
  {
    id: 'ai-predictive-customer-lifetime-value',
    title: 'AI Predictive Customer Lifetime Value — CLV Modeling',
    description: 'Predict customer lifetime value with 95% accuracy. ML models analyze purchase history, engagement patterns, churn signals, and cohort behavior. Enables targeted marketing spend and personalized retention campaigns.',
    features: ['CLV prediction (95% accuracy)','Churn risk scoring','Cohort analysis','Retention campaign automation','Revenue forecasting','Customer segmentation','A/B testing framework'],
    benefits: [],
    ...
    icon: '💎', href: '/services/ai-predictive-customer-lifetime-value',
    popular: false, category: 'ai', industry: 'Retail & E-Commerce',
  },
  // ── IT SERVICES ──
  {
    id: 'it-zero-trust-network-implementation',
    title: 'IT Zero Trust Network Implementation — Never Trust, Always Verify',
    description: 'Complete Zero Trust architecture implementation. Identity-aware microsegmentation, continuous authentication, least-privilege access, and encrypted communications. Includes SASE integration, ZTNA deployment, and legacy system modernization.',
    features: ['Identity-aware microsegmentation','Continuous authentication','ZTNA deployment','SASE integration','Legacy system modernization','Compliance framework (NIST 800-207)','24/7 monitoring'],
    benefits: [],
    pricing: {basic:'$3,999/mo', pro:'$9,999/mo', enterprise:'$24,999/mo'},
    contactInfo: { website:'/services/it-zero-trust-network-implementation', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '🔐', href: '/services/it-zero-trust-network-implementation',
    popular: false, category: 'it', industry: 'General',
  },
  // ── SECURITY SERVICES ──
  {
    id: 'security-red-team-operations',
    title: 'Security Red Team Operations — Adversary Simulation',
    description: 'Full-scope red team operations simulating real-world adversaries. Social engineering, physical penetration testing, network exploitation, and cloud attack chains. Detailed reporting with executive summaries and remediation roadmaps.',
    features: ['Adversary simulation (APT-level)','Social engineering campaigns','Physical penetration testing','Network & cloud exploitation','Executive summary reporting','Remediation roadmap','Purple team collaboration'],
    benefits: [],
    pricing: {basic:'$4,999/mo', pro:'$12,999/mo', enterprise:'$29,999/mo'},
    contactInfo: { website:'/services/security-red-team-operations', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '🎭', href: '/services/security-red-team-operations',
    popular: false, category: 'security', industry: 'General',
  },
  {
    id: 'security-saas-security-posture',
    title: 'Security SaaS Security Posture Management — SSPM',
    description: 'Automated SaaS security posture management. Discovers all SaaS applications, assesses security configurations, enforces policies, and monitors for misconfigurations across Microsoft 365, Google Workspace, Salesforce, Slack, and 500+ integrations.',
    features: ['SaaS discovery & inventory','Configuration assessment','Policy enforcement','Misconfiguration monitoring','Compliance reporting (SOC2/ISO27001)','500+ SaaS integrations','Auto-remediation'],
    benefits: [],
    pricing: {basic:'$499/mo', pro:'$1,299/mo', enterprise:'$3,499/mo'},
    contactInfo: { website:'/services/security-saas-security-posture', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '☁️', href: '/services/security-saas-security-posture',
    popular: false, category: 'security', industry: 'General',
  },
  // ── CLOUD SERVICES ──
  {
    id: 'cloud-data-lakehouse-architecture',
    title: 'Cloud Data Lakehouse Architecture — Unified Analytics Platform',
    description: 'Design and implement modern data lakehouse architecture on AWS/Azure/GCP. Combines data lake flexibility with warehouse performance using Delta Lake/Iceberg/Hudi. Includes streaming ingestion, governance, and cost optimization.',
    features: ['Lakehouse design (Delta Lake/Iceberg/Hudi)','Streaming ingestion (Kafka/Kinesis)','Data governance & catalog','Cost optimization','ML platform integration','Multi-cloud support','Performance tuning'],
    benefits: [],
    pricing: {basic:'$2,499/mo', pro:'$6,499/mo', enterprise:'$14,999/mo'},
    contactInfo: { website:'/services/cloud-data-lakehouse-architecture', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '🏠', href: '/services/cloud-data-lakehouse-architecture',
    popular: false, category: 'cloud', industry: 'General',
  },
  // ── AUTOMATION SERVICES ──
  {
    id: 'automation-citizen-developer-platform',
    title: 'Automation Citizen Developer Platform — No-Code Workflow Builder',
    description: 'Self-service automation platform for non-technical users. Drag-and-drop workflow builder, pre-built connectors for 200+ apps, approval chains, data transformation, and governance guardrails. Empowers business teams to automate without IT dependency.',
    features: ['Drag-and-drop workflow builder','200+ app connectors','Approval chains','Data transformation','Governance guardrails','Audit trail','Template library (100+)'],
    benefits: [],
    pricing: {basic:'$99/mo', pro:'$299/mo', enterprise:'$699/mo'},
    contactInfo: { website:'/services/automation-citizen-developer-platform', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '🧩', href: '/services/automation-citizen-developer-platform',
    popular: true, category: 'automation', industry: 'General',
  },
  // ── DATA SERVICES ──
  {
    id: 'data-data-quality-engineering',
    title: 'Data Quality Engineering — Automated Data Observability',
    description: 'Automated data quality monitoring and observability. Schema drift detection, anomaly detection in metrics, data freshness monitoring, and lineage tracking. Prevents downstream analytics failures with proactive alerting.',
    features: ['Schema drift detection','Metric anomaly detection','Data freshness monitoring','Lineage tracking','Proactive alerting','SLI/SLO tracking','Integration with dbt/Airflow'],
    benefits: [],
    pricing: {basic:'$399/mo', pro:'$999/mo', enterprise:'$2,499/mo'},
    contactInfo: { website:'/services/data-data-quality-engineering', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '✅', href: '/services/data-data-quality-engineering',
    popular: false, category: 'data', industry: 'General',
  },
  {
    id: 'data-cdp-customer-data-platform',
    title: 'Data Customer Data Platform (CDP) — Unified Customer Profiles',
    description: 'Enterprise customer data platform. Unifies customer data from all touchpoints into persistent identity-resolved profiles. Real-time segmentation, activation to 200+ destinations, and privacy-compliant data governance.',
    features: ['Identity resolution','Real-time segmentation','200+ activation destinations','Privacy compliance (GDPR/CCPA)','Cross-channel attribution','Customer journey analytics','Consent management'],
    benefits: [],
    pricing: {basic:'$999/mo', pro:'$2,499/mo', enterprise:'$6,999/mo'},
    contactInfo: { website:'/services/data-cdp-customer-data-platform', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '👤', href: '/services/data-cdp-customer-data-platform',
    popular: true, category: 'data', industry: 'Marketing',
  },
]

...
export const microSaasServices: Service[] = [
  {
    id: 'micro-saas-vulnerability-scanner-pro',
    title: 'AI Vulnerability Scanner Pro',
    description: 'Continuous automated vulnerability scanning for web apps, APIs, and cloud infrastructure. AI-powered risk scoring with prioritized remediation steps and compliance mapping (OWASP, NIST, PCI-DSS).',
    features: ['Continuous automated scanning','AI risk scoring','Compliance mapping (OWASP/NIST/PCI-DSS)','Prioritized remediation','Executive dashboards','API security testing'],
    pricing: {basic:'149', pro:'449', enterprise:'1499'},
    contactInfo: {website:'/services/micro-saas-vulnerability-scanner-pro', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950'},
    icon: '🛡️',
    href: '/services/micro-saas-vulnerability-scanner-pro',
    popular: true,
    category: 'micro-saas',
  ...
  {
    id: 'micro-saas-siem-platform',
    title: 'Cloud SIEM & Threat Detection Platform',
    description: 'Security Information and Event Management platform with AI-powered threat detection, log aggregation, real-time correlation, and automated incident response playbooks.',
    features: ['Real-time log aggregation','AI threat detection','Automated incident response','Compliance reporting','Cloud-native architecture','Threat intelligence feeds'],
    pricing: {basic:'299', pro:'899', enterprise:'2499'},
    contactInfo: {website:'/services/micro-saas-siem-platform', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950'},
    icon: '🔍',
    href: '/services/micro-saas-siem-platform',
    popular: true,
    category: 'micro-saas',
    industry: 'Security',
    stage: 'published',
  ...
  {
    id: 'micro-saas-data-backup-recovery',
    title: 'AI Data Backup & Disaster Recovery',
    description: 'Automated backup and disaster recovery with AI-optimized scheduling, incremental backups, cross-region replication, and one-click restore. Supports VMs, databases, and S3.',
    features: ['AI-optimized backup scheduling','Incremental backups','Cross-region replication','One-click restore','Ransomware detection','Compliance archiving'],
    pricing: {basic:'99', pro:'299', enterprise:'999'},
    contactInfo: {website:'/services/micro-saas-data-backup-recovery', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950'},
    icon: '💾',
    href: '/services/micro-saas-data-backup-recovery',
    popular: true,
    category: 'micro-saas',
  ...
  },
  {
    ...
    description: 'AI-powered employee engagement with pulse surveys, sentiment analysis, automated action plans, and predictive attrition modeling. Integrates with Slack, Teams, and HRIS.',
    features: ['AI pulse surveys','Sentiment analysis','Predictive attrition modeling','Automated action plans','Slack/Teams integration','HRIS sync'],
  ...
  {
    id: 'micro-saas-smart-inventory',
    title: 'Smart Inventory Management',
    description: 'AI-driven inventory optimization with demand forecasting, automated reorder points, supplier performance tracking, and multi-location sync. Reduces carrying costs by 25%.',
    features: ['Demand forecasting','Automated reorder points','Supplier tracking','Multi-location sync','Barcode/QR scanning','Integration with Shopify/WooCommerce'],
    pricing: {basic:'79', pro:'249', enterprise:'799'},
    contactInfo: {website:'/services/micro-saas-smart-inventory', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950'},
    icon: '📦',
    href: '/services/micro-saas-smart-inventory',
    popular: false,
    category: 'micro-saas',
    industry: 'Retail',
    stage: 'published',
  ...
  {
    id: 'micro-saas-pentest-automation',
    title: 'Automated Penetration Testing Platform',
    description: 'Continuous automated pentesting with OWASP Top 10 coverage, API security testing, social engineering simulations, and detailed remediation reports with CVSS scoring.',
    features: ['OWASP Top 10 coverage','API security testing','Social engineering simulations','CVSS scoring','Detailed remediation reports','Compliance documentation'],
    pricing: {basic:'349', pro:'999', enterprise:'2999'},
    contactInfo: {website:'/services/micro-saas-pentest-automation', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950'},
    icon: '🔐',
    href: '/services/micro-saas-pentest-automation',
    popular: true,
    category: 'micro-saas',
    industry: 'Cybersecurity',
    stage: 'published',
  ...
  {
    id: 'micro-saas-api-gateway-manager',
    title: 'API Gateway & Management Platform',
    description: 'Full lifecycle API management with rate limiting, authentication, analytics, versioning, and developer portal. Supports REST, GraphQL, and gRPC with sub-millisecond latency.',
    features: ['Rate limiting & throttling','OAuth 2.0 / JWT auth','Real-time analytics','API versioning','Developer portal','REST/GraphQL/gRPC'],
    pricing: {basic:'129', pro:'399', enterprise:'1299'},
    contactInfo: {website:'/services/micro-saas-api-gateway-manager', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950'},
    icon: '🔗',
    href: '/services/micro-saas-api-gateway-manager',
    popular: false,
    category: 'micro-saas',
  ...
  {
    id: 'micro-saas-ecommerce-analytics',
    title: 'E-Commerce Analytics & CRO Platform',
    description: 'AI-powered analytics for e-commerce with funnel analysis, A/B testing, customer lifetime value prediction, cart abandonment recovery, and personalized product recommendations.',
    features: ['Funnel analysis','A/B testing engine','CLV prediction','Cart abandonment recovery','Product recommendations','Shopify/WooCommerce/Magento integration'],
    pricing: {basic:'59', pro:'199', enterprise:'599'},
    contactInfo: {website:'/services/micro-saas-ecommerce-analytics', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950'},
    icon: '📊',
    href: '/services/micro-saas-ecommerce-analytics',
    popular: true,
    category: 'micro-saas',
    industry: 'E-Commerce',
    stage: 'published',

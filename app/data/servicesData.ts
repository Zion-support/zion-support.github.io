  ...
  },
{
  ...
  {id:'ai-quantum-machine-learning-compiler',title:'AI Quantum ML Compiler',description:'Compiles classical ML training loops to quantum circuits: auto-generates VQE ansatz from PyTorch/Keras, allocates qubits under NISQ constraints, applies zero-noise extrapolation. Runs on Azure Quantum, AWS Braket, IBM Quantum.',features:['Auto-quantum circuit synthesis from classical ML','Qubit allocation optimizer NISQ-aware','Zero-noise extrapolation error mitigation','Torch/Keras to quantum IR transpiler'],benefits:['Cut quantum algorithm design from months to days','NISQ-aware compiler maximises real hardware fidelity','Hybrid quantum-classical training loops auto-generated'],pricing:{basic:'499',pro:'1499',enterprise:'4999'},contactInfo:{website:'/services/ai-quantum-machine-learning-compiler',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},icon:'Q',href:'/services/ai-quantum-machine-learning-compiler',category:'ai'},
  {id:'ai-synthetic-biology-cloud-lab',title:'AI Synthetic Biology Cloud Lab',description:'In silico design-build-test: protein design via ESM/ProtT5, CRISPR target finding, gene circuit topology, wet-lab protocol generation. Integrates with Benchling/plasmids.io.',features:['Protein sequence design via ESM/ProtT5','CRISPR off-target scoring + gRNA generation','Gene circuit topology optimizer','Wet-lab protocol generator','Benchling + lab instrument API bindings'],benefits:['Design proteins before bench spend','Cut CRISPR design cycles from weeks to hours','Protocols unambiguous zero bench mistakes'],pricing:{basic:'799',pro:'2499',enterprise:'8999'},contactInfo:{website:'/services/ai-synthetic-biology-cloud-lab',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},icon:'Q',href:'/services/ai-synthetic-biology-cloud-lab',category:'ai'},
  {id:'ai-neural-interface-design-system',title:'AI Neural Interface Design System',description:'End-to-end neural implant design: EEG localization, electrode array optimization, spike sorting, motor-cortex intention decoder, closed-loop stimulation. FDA 510(k) pre-sub documentation generator.',features:['EEG source-localization inverse solver','Electrode array SNR-optimal placement optimizer','Real-time spike sorting + neural decoder','FDA 510(k) pre-sub documentation per model','Closed-loop DBS RL stimulation policy trainer'],benefits:['Cut neural implant design from 2 years to 3 months','FDA submission review-ready','Closed-loop DBS beats open-loop for Parkinsons'],pricing:{basic:'2999',pro:'9999',enterprise:'29999'},contactInfo:{website:'/services/ai-neural-interface-design-system',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},icon:'Q',href:'/services/ai-neural-interface-design-system',category:'ai'},
  {id:'ai-legal-settlement-outcome-predictor',title:'AI Legal Settlement Outcome Predictor',description:'Predicts litigation settlement values: case law similarity, judge/jurisdiction profiling, opposing counsel track record, payout analytics, recommended settlement range, trial probability assessment..',features:['ML outcome model per judge/jurisdiction profile','1M+ case law similarity scoring','Opposing counsel win-loss + settlement-track profile','Exposure heatmap per claim for settlement value','Trial vs settlement expected-value per strategy'],benefits:['Settle for 15-30% less overpayment via data vs gut-feel','Avoid trial losses with strategy-backed risk analysis','Case-load prioritized by settlement likelihood cuts hours'],pricing:{basic:'299',pro:'999',enterprise:'3999'},contactInfo:{website:'/services/ai-legal-settlement-outcome-predictor',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},icon:'Q','href':'/services/ai-legal-settlement-outcome-predictor','category':'ai'},
  {id:'ai-air-quality-predictive-forecaster',title:'AI Air Quality Predictive Forecaster',description:'Hyper-local health-risk forecaster: PM2.5/NOx/O3/CO2 multi-sensor fusion, weather traffic emissions, per-location risk score, public-health alert dispatch API, HVAC ventilation automation..',features:['Hyper-local 100m sensor grid risk scoring','Sensor fusion weather + traffic + PM2.5/NOx/O3','Public-health alert auto-dispatch per vulnerable group','HVAC ventilation API per zone','Health-dept 24/48h threshold breach alert'],benefits:['Pollution spikes forecast 48h ahead cut asthma-relief spend','Indoor CO2 cut 35% via predictive ventilation','Alerts change tenant behaviour in seconds'],'pricing':{basic:'99',pro:'399',enterprise:'1499'},'contactInfo':{website:'/services/ai-air-quality-predictive-forecaster',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},'icon':'Q','href':'/services/ai-air-quality-predictive-forecaster','category':'ai'},
  {id:'ai-crowd-behaviour-queue-simulator',title:'AI Crowd Behaviour Queue Simulator',description:'CCTV+RTSP pose skeleton extraction agent-based crowd simulation: predicts queue/bottleneck/slip-fall hot-spots, emergency-egress violation detection, what-if simulation. Privacy-safe PII stripped at ingress..',features:['RTSP CCTV ingress + YOLO-pose skeleton extraction','Agent-based crowd simulation per zone','Queue/bottleneck/slip-fall hot-spot detector ML','Emergency-egress violation + pre-emptive alarm','Privacy-safe PII stripped no raw video stored'],benefits:['Predict queue overflow 15min before it happens','Emergency-egress compliance pre-audit','Pre-emptive barrier placement saves lost-revenue'],'pricing':{basic:'599',pro:'1999',enterprise:'5999'},'contactInfo':{website:'/services/ai-crowd-behaviour-queue-simulator',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},'icon':'Q','href':'/services/ai-crowd-behaviour-queue-simulator','category':'ai'},
  {id:'ai-news-anomaly-story-detector',title:'AI News Anomaly Story Arc Detector',description:'Crawls global news/social feeds 50L languages: novel story arc detection, disinformation CIB pattern matching, viral-potential scoring, ranked editorial brief per arc. For newsrooms PR brand-watch teams..',features:['50L-language news/social ingest','Story-arc detection via time-series novelty ML','Disinformation CIB pattern matching lock-step accounts','Viral-potential score + propagation forecast','Editable editorial brief per arc'],benefits:['Break stories 2-48h before competitors','Catch coordinated campaigns at seed-stage','Cut daily briefing from hours to minutes'],'pricing':{basic:'79',pro:'299',enterprise:'999'},'contactInfo':{website:'/services/ai-news-anomaly-story-detector',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},'icon':'Q','href':'/services/ai-news-anomaly-story-detector','category':'ai'},
  {id:'ai-opensource-license-compliance-scanner',title:'AI Open-Source License Compliance Scanner',description:'SCA for legal/compliance teams: parses SBOM CycloneDX/SPDX, classifies 500+ SPDX licenses, output-use risk scoring permissive/copyleft/patent-risk, policy exception workflow, Snyk/Checkmarx/WhiteSource export format..',features:['SBOM parser CycloneDX + SPDX both formats','500+ SPDX license classifier','Output-use risk score permissive-copyleft-patent-risk','Workflow engine per repo/org policy rules','Snyk/Checkmarx/WhiteSource compatible export'],benefits:['Cut legal compliance review from 10 weeks to 10 mins','Prevent GPL taint in commercial products at build-time','Per-project compliance report per counsel template'],'pricing':{basic:'149',pro:'499',enterprise:'1999'},'contactInfo':{website:'/services/ai-opensource-license-compliance-scanner',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},'icon':'Q','href':'/services/ai-opensource-license-compliance-scanner','category':'ai'},
  {id:'ai-portfolio-variance-optimizer',title:'AI Portfolio Variance Tax-Optimizer',description:'Multi-factor portfolio optimizer: Barra + Fama-French 5-factor model, CVaR constraint, sector caps, tax-loss harvesting per position, cheaper-hedge surfacer, Basel III/IV capital.',features:['Barra + Fama-French 5-factor model per holding','CVaR + max-drawdown constraint per portfolio','Sector single-name exposure caps','Tax-loss harvesting per position','Cheaper-hedge surfacer ETF-future-protective-put'],benefits:['Portfolio volatility cut 15-25% vs passive index','Tax-loss harvesting adds after-tax alpha','CFO/trustee-ready PDF no manual Excel rebuild'],'pricing':{basic:'399',pro:'1299',enterprise:'3999'},'contactInfo':{website:'/services/ai-portfolio-variance-optimizer',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},'icon':'Q','href':'/services/ai-portfolio-variance-optimizer','category':'ai'},
{
      id: 'ai-deepfake-voice-spoof-detector',
      title: 'AI Deepfake Voice & Spoof Detection',
      description: 'Real-time deepfake voice detection for phone/video calls: spectrogram analysis, prosody anomaly scoring, bandwidth pattern vs natural speech, speaker-gender mismatch alert. Detects ElevenLabs/Murphy AI/custom GAN voice clones. SIP/VoIP provider + Zoom/Teams integration..',
      features: [
        'Spectrogram + prosody anomaly scoring per call segment',
        'Speaker-gender mismatch alert per voice clone fingerprint',
        'ElevenLabs/Murphy AI/custom GAN detection',
        'SIP/VoIP + Zoom/Teams integration per carrier',
        'Sub-200ms real-time verdict per audio chunk',
      ],
      benefits: [
        'Block voice-spoof fraud before social-engineering succeeds',
        'Zero voice-spoof false alarms with spectrogram confirmation',
        'Regulator-ready deepfake audio logs per financial/health provider',
      ],
      pricing: { basic: '149', pro: '499', enterprise: '1999' },
      contactInfo: { website: '/services/ai-deepfake-voice-spoof-detector', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
      icon: '🎙️',
      href: '/services/ai-deepfake-voice-spoof-detector',
      category: 'ai',
    },
    {
      id: 'ai-supply-chain-disruption-predictor',
      title: 'AI Supply Chain Disruption & Risk Predictor',
      description: 'Multi-signal supply chain risk: weather/port/sanction/news-event scoring per supplier + lane, inventory OTIF prediction, lead-time variance forecasting, near-miss from IoT shipment telemetry across tier-1 + tier-2 supplier graph. Procurement + logistics planner dashboard..',
      features: [
        'Tier-1 + tier-2 supplier graph with risk scoring',
        'Weather/port/sanction/news-event signal fusion',
        'Inventory OTIF forecast per lane per supplier',
        'IoT shipment telemetry real-time rerouting trigger',
        'Procurement + logistics planner dashboard',
      ],
      benefits: [
        'Detect disruption signals 7-14 days before cargo fails to deliver',
        'Reduce safety-stock by 20% without service-level risk',
        'Planner dashboard replaces 10-person manual risk team',
      ],
      pricing: { basic: '299', pro: '999', enterprise: '3499' },
      contactInfo: { website: '/services/ai-supply-chain-disruption-predictor', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
      icon: '📦',
      href: '/services/ai-supply-chain-disruption-predictor',
      category: 'ai',
    },
    {
      id: 'ai-chronic-disease-progression-tracker',
      title: 'AI Chronic Disease Progression & Treatment Response Tracker',
      description: 'Longitudinal EHR ML for chronic disease: tracks progression markers for diabetes/CKD/CHF, auto-flags treatment non-response, predicts 6-24-month outcome per patient. Integrates HL7/FHIR Epic/Cerner/Allscripts. Patient + clinician dual-report per progression event..',
      features: [
        'EHR longitudinal feature engineering per chronic condition',
        'Treatment non-response flag per medication + biomarker trend',
        '6-24-month outcome forecast per patient ML',
        'FHIR/HL7 Epic/Cerner/Allscripts integration',
        'Patient + clinician dual-report PDF per event',
      ],
      benefits: [
        'Catch disease progression before next clinical review cycle',
        'Reduce chronic-care trial-and-error via pharmacogenomic model',
        'Patient report drives adherence + reduces 30-day readmission',
      ],
    ...
    {
      id: 'ai-smart-grid-load-balancer',
      title: 'AI Smart Grid Load Balancer & Demand Forecaster',
      description: 'Distribution grid ML optimizer: 15-min-ahead load forecast per feeder zone, DER (solar/battery/EV) injection balancing, voltage/var optimization per constraint, outage impact propagation. SCADA/DERMS/OpenADR compatible..',
      features: [
        '15-min-ahead load forecast per feeder zone LSTM',
        'DER injection real-time balancing solar/battery/EV',
        'Voltage/var optimization per thermal + voltage constraint',
        'Outage impact propagation per grid event topology',
        'SCADA/DERMS/OpenADR compatible open-protocol',
      ],
      benefits: [
        'Reduce distribution overload incidents by 60%',
        'Integrate 3x more renewable DER capacity without curtailment',
        'Prevent grid-failure cascades before operator intervention',
      ],
      pricing: { basic: '499', pro: '1499', enterprise: '4999' },
      contactInfo: { website: '/services/ai-smart-grid-load-balancer', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
      icon: '⚡',
      href: '/services/ai-smart-grid-load-balancer',
      category: 'ai',
    },
    {
      id: 'ai-marine-fisheries-sustainability',
      title: 'AI Marine Fisheries Sustainability & Quota Manager',
      description: 'Satellite + AIS + eDNA ocean sensor fusion for fisheries management: species-abundance per-square-km, IUU fishing detection per RFMO, catch-quota prediction per stock, bycatch-risk hot-spot. Fisheries manager + conservation NGO dashboard..',
      features: [
        'AIS + satellite SAR fusion per EEZ/MPA boundary',
        'IUU fishing detection per RFMO convention rules',
        'Catch-quota simulation per stock assessment model',
        'Bycatch-risk hot-spot per species + season',
        'Fisheries manager + conservation NGO dashboard',
      ],
      benefits: [
        'Detect IUU vessels within 24h before offload',
        'Cut patrol cost by 70% vs manual AIS watch',
        'Quota forecast prevents stock collapse from over-reporting',
      ],
      pricing: { basic: '399', pro: '1299', enterprise: '3999' },
    ...
    {
      id: 'ai-edplag-content-authenticity',
      title: 'AI Academic Content Authenticity & Plagiarism Detection',
      description: 'Full-stack academic integrity engine: cross-references student work against internet + subscription + internal databases, detects AI-generated content (GPT/Claude/Copyleaks watermarking), contract-cheating (essay-mill match + stylometry), peer-collusion clusters. Proctoring-integrated incident report..',
      features: [
        'Cross-reference internet + subscription + institutional databases',
        'AI-generated content detection GPT/Claude/Copyleaks watermarking',
        'Contract-cheating essay-mill match + stylometry scoring',
        'Peer-collusion cluster detection per similarity network',
        'Proctoring-integrated incident report per submission',
      ],
      benefits: [
        'Detect contract cheating in seconds vs hours of manual review',
        'AI-generated content flagged before instructor grading queue',
        'Academic integrity maintained at scale for online programmes',
      ],
      pricing: { basic: '99', pro: '349', enterprise: '1299' },
      contactInfo: { website: '/services/ai-edplag-content-authenticity', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
      icon: '🎓',
      href: '/services/ai-edplag-content-authenticity',
      category: 'ai',
    },
  {
    id: 'ai-meeting-assistant-actions',
    title: 'AI Meeting Assistant with Takeaway Actions',
    description: 'Real-time meeting co-pilot: live transcription (Whisper v3/Large-v3 Turbo), simultaneous translation, action-item extraction (who-does-what-by-when), decision tracker with sentiment, and auto-post action cards to Asana/Monday/Jira — all in real-time during the meeting, not after.',
    icon: '🎤',
    features: ['Real-time live transcription: Whisper v3 Turbo, <200 ms audio-to-text end-to-end', 'Simultaneous translation: 50+ language pairs via SeamlessM4T — captions in participant language', 'Auto action-item extraction: tree-of-thought extraction from conversation; owner, deadline, ticket linked', 'Meeting sentiment tracker: detects controversy/agreement/blocker — flags in sidebar for host', 'Auto-post: Slack message, Asana card, Google Calendar event per action item — no manual copy-paste'],
    benefits: ['Cut post-meeting admin from 15 min/meeting to 0 — every action item auto-posted', 'Run 2× more effective async meetings: attendees who couldn\'t attend get full transcript+actions', 'Reduce "who said what" conflict with verbatim cross-lingual translation', 'Track action-item completion automatically via Asana/Jira integration', 'Basic $199/mo 50 hrs/mo | Pro $499/mo 500 hrs/mo | Enterprise $1,499/mo unlimited'],
    pricing: { basic: '199', pro: '499', enterprise: '1499' },
    contactInfo: { website: '/services/ai-meeting-assistant-actions', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/ai-meeting-assistant-actions',
    category: 'ai',
    popular: false,
  },
  {
    id: 'ai-financial-statement-analyzer',
    title: 'AI Financial Statement Analyzer',
    description: 'Ingest annual/quarterly reports (10-K, 10-Q, 20-F) and extract structured balance sheet, income statement, cash-flow, and segment data without manual keying. Cross-compare against peer universe; flag earnings quality red flags (revenue recognition shifts, reserve manipulation, related-party transactions).',
    icon: '📈',
    features: ['10-K/10-Q/20-F ingestion: prevents OCR/PDF layout breakage — tabular + footnote extraction via Donut/LayoutLM', 'P&L + Balance sheet + Cash Flow structured output: mapped by GAAP line item into machine-readable JSON', 'Earnings quality flags: revenue recognition change vs prior year, reserve ratio shift, one-time item detection, related-party flag', 'Peer universe comparison: visualise margin, capex, ROE vs sector peer quartiles', 'Export: XBRL JSON, PDF report with director-ready executive summary + supporting evidence page'],
    benefits: ['Cut equity research model build from 3 days to 1 hour per company', 'Eliminate keying errors from manual PDF spreadsheet entry', 'Surface earnings quality red flags pre-earnings call — short-cover ahead of peers', 'Regulatory body ready: full XBRL/GAAP line-item traceability per report', 'Basic $499/report | Pro $999/report bulk 10+ | Enterprise $3,999/mo unlimited'],
    pricing: { basic: '499', pro: '999', enterprise: '3999' },
    contactInfo: { website: '/services/ai-financial-statement-analyzer', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/ai-financial-statement-analyzer',
    category: 'ai',
    popular: false,
  },
  {
    id: 'ai-privacy-policy-impact-assessor',
    title: 'AI Privacy Policy Impact Assesser',
    description: 'Process your privacy policy, terms-of-service, and data-sharing agreements against privacy regulations (GDPR Art. 13/14, CCPA, HIPAA, PIPEDA, LGPD, APPI). Flags discrepancies, missing mandatory disclosures, data-type misclassification, international transfer violations, and produces a compliance evidence package.',
    icon: '🔒',
    features: ['Multi-regulation scoring: GDPR Art.13/14, CCPA §1798.100, HIPAA Notice of Privacy, PIPEDA, LGPD, APPI', 'Data-flow tracer: maps each PII category (name, email, IP, device ID, location) to every third-party tracker', 'International transfer flag: detects EU→US / US→EU transfers and flags invalidity risk post-Schrems II', 'Evidence package: NLP evidence snippets (quoted policy text) + regulation clause reference per finding', 'Remediation tracker: drafts amendment text per discrepancy; version diff vs prior review'],
    benefits: ['Cut privacy policy review from 4 weeks to 4 hours — for $0 vs £500+ external privacy-law counsel', 'Reduce regulatory fine risk: pre-screen before ICO/CNIL/FTC industry review', 'Maintainable evidence package — reuse for annual SOC 2 / ISO 27701 audit boundary assessment', 'Up-to-date: model fine-tuned on latest guidance from ICO, EDPB, CNIL, FTC', 'Basic $199/policy | Pro $499/yr 3 policies | Enterprise $1,999/yr unlimited policies'],
    pricing: { basic: '199', pro: '499', enterprise: '1999' },
    contactInfo: { website: '/services/ai-privacy-policy-impact-assessor', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/ai-privacy-policy-impact-assessor',
    category: 'ai',
    popular: false,
  },
  {
    id: 'ai-powerpoint-presentation-generator',
    title: 'AI-Powered PowerPoint Generator',
    description: 'Generate production-ready PowerPoint presentations from a topic, document, or URL. Auto-writes slide decks with speaker notes, data visualisation charts, branded template application, and Editable support for editing AI-generated content in the browser — output as .pptx or in real-time browser preview.',
    icon: '📊',
    features: ['Topic → deck: enter "Q2 Sales Results" → full 15-slide deck with charts, speaker notes, agenda slide', 'Doc-to-deck: upload PDF/Word/Google Doc → extract structure → branded presentation with one-click publish', 'Branded templates: upload your corporate template — auto-apply logo, fonts, colours to every slide', 'Data viz: embedded charts from your datasets (CSV/Excel paste auto-charts), auto-updated on data change', 'Editing: in-browser slide editor + AI rewrite per slide + inline image swap + speaker note edit'],
    benefits: ['Cut deck production time from 2 days to 30 minutes — $0 vs design agency quote', 'Consistent brand execution: same branded template on every deck regardless of author', 'Reusable slides: save individual "data viz" or "team chart" slides to the asset library', 'Export as .pptx or share as live link with version history per slide', 'Basic $49/mo 10 decks | Pro $149/mo unlimited decks | Enterprise $499/mo unlimited'],
    pricing: { basic: '49', pro: '149', enterprise: '499' },
    contactInfo: { website: '/services/ai-powerpoint-presentation-generator', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/ai-powerpoint-presentation-generator',
    category: 'ai',
    popular: false,
  },
  {
    id: 'ai-employee-knowledge-retriever',
    title: 'Employee-Powered Knowledge Retriever',
    description: 'Internal knowledge Q&A: ingest Slack/Teams threads, Confluence pages, Drive files, Notion docs, and support tickets; build a searchable RAG knowledge base that answers employee questions with attributed source snippets. Features: onboarding FAQ, benefits lookup, runbook query, sales enablement KB, HR policy search.',
    icon: '💡',
    features: ['Multi-source ingest: Slack/Teams message history, Confluence, Google Drive, Notion, Zendesk, Jira', 'RAG answer with source attribution: verbatim snippet + confidence score + linked source doc per answer', 'Role-scoped KB: employees see benefits KB, engineers see runbooks, sales sees enablement — same index', 'Slack/Teams bot: /ask-zion-bot inside Slack/Teams — answers in-thread with [sources] linked', 'Admin analytics: unanswered questions, top search terms, source doc gaps per team'],
    benefits: ['Reduce IT/HR support tickets by 30–50% — employees self-serve without waiting', 'Brand-new employees productive 30–50% faster with instant self-serve runbook search', 'No more tribal knowledge documented on Slack forever — Wayback Machine for your company brain', 'MBTA: "how do I request PTO" answered in Slack in 2 sec, not 24h email', 'Basic $99/mo 25 employees | Pro $399/mo 250 employees | Enterprise $1,499/mo unlimited'],
    pricing: { basic: '99', pro: '399', enterprise: '1499' },
    contactInfo: { website: '/services/ai-employee-knowledge-retriever', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/ai-employee-knowledge-retriever',
    category: 'ai',
    popular: true,
  },
  {
    id: 'ai-athlete-performance-coach',
    title: 'AI Athlete Performance Coach',
    description: 'Personal AI coach for amateur and enthusiast athletes: ingest training data (Strava, Garmin, TrainingPeaks), build periodised training plans, suggest pace targets per session, detect overtraining via HRV/rest-day trend, and auto-generate nutrition macros and hydration strategies per sport (cycling, running, triathlon, CrossFit).',
    icon: '🏃',
    features: ['Data ingest: Strava, Garmin Connect, TrainingPeaks, Apple Health, Whoop — 30s manual CSV upload', 'Periodised training plan: macro-cycle (12 wks), meso-cycle (4 wks), micro-cycle (1 wk) — adapts weekly per completion', 'Overtraining detection: HRV trend vs 4-week baseline + RPE (Rate of Perceived Exertion) trend', 'Session guidance: pace/power/hr zones per interval; auto-replace if open-slot session added', 'Nutrition macros: Mifflin-St Jeor + training load multiplier; hydration sodium/potassium/fluid recommendation'],
    benefits: ['Improve VO2 max and FTP 5–15% in 12 weeks with periodised plan — data-proven', 'Prevent overtraining injuries — 40% of overtraining athletes are unaware without HRV trend', 'Nutrition guidance adapts to training load — no manual macro spreadsheet', 'Race day plan: exact pacing strategy per target time + elevation profile', 'Basic $29/mo 1 athlete | Pro $79/mo family 4 athletes | Enterprise $199/mo team/coach 25 athletes'],
    pricing: { basic: '29', pro: '79', enterprise: '199' },
    contactInfo: { website: '/services/ai-athlete-performance-coach', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/ai-athlete-performance-coach',
    category: 'ai',
    popular: false,
  },
...

{
  ...
  {id:'devsecops-pipeline',title:'DevSecOps Pipeline Automation',description:'Security-baked CI/CD pipeline: SAST, DAST, secrets scanning, container image signing, SBOM generation, and penetration-test gates. Enforces policy as code before every production deployment.',features:['Intelligent automation and orchestration','Enterprise-grade integration','Real-time monitoring and alerts','Scalable multi-tenant architecture'],benefits:['Reduce operational costs','Accelerate time-to-market','Maintain enterprise compliance','Scale proportionally with growth'],pricing:{basic:'49',pro:'199',enterprise:'799'},contactInfo:{website:'/services/devsecops-pipeline',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},icon:'◆',href:'/services/devsecops-pipeline',category:'it'},  {id:'ai-quantum-machine-learning-compiler',title:'AI Quantum ML Compiler',description:'Compiles classical ML training loops to quantum circuits: auto-generates VQE ansatz from PyTorch/Keras, allocates qubits under NISQ constraints, applies zero-noise extrapolation. Runs on Azure Quantum, AWS Braket, IBM Quantum.',features:['Auto-quantum circuit synthesis from classical ML','Qubit allocation optimizer NISQ-aware','Zero-noise extrapolation error mitigation','Torch/Keras to quantum IR transpiler'],benefits:['Cut quantum algorithm design from months to days','NISQ-aware compiler maximises real hardware fidelity','Hybrid quantum-classical training loops auto-generated'],pricing:{basic:'499',pro:'1499',enterprise:'4999'},contactInfo:{website:'/services/ai-quantum-machine-learning-compiler',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},icon:'Q',href:'/services/ai-quantum-machine-learning-compiler',category:'ai'},


{
      id: 'it-low-code-workflow-automation-platform',
      title: 'Low-Code Workflow Automation & Integration Platform',
      description: 'Enterprise workflow builder with 1000+ pre-built connectors: visual drag-drop flow editor, REST + GraphQL + SOAP API orchestration, event-driven triggers, SLA/SLO routing with auto-retry. On-prem Docker K8s deployment + SOC2-audit trail. Zapier/Make alternative for enterprise..',
      features: [
        '1000+ pre-built connectors SaaS/database/on-prem',
        'Visual drag-drop flow editor BPMN/DMN support',
        'Event-driven triggers per webhook/cron/change-feed',
        'Auto-retry dead-letter queue per SLA tier',
        'On-prem Docker/K8s deployment SOC2-audit trail',
      ],
      benefits: [
        'Cut integration project from weeks to days — no code required',
        '1000+ connectors replace custom middleware per SaaS stack',
        'On-prem deployment satisfies air-gapped + regulated industry',
      ],
      pricing: { basic: '49', pro: '199', enterprise: '799' },
      contactInfo: { website: '/services/it-low-code-workflow-automation-platform', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
      icon: '🔧',
      href: '/services/it-low-code-workflow-automation-platform',
      category: 'it',
    },
    {
      id: 'it-serverless-edge-compute-platform',
      title: 'Serverless Edge Compute & Global Deployment Platform',
      description: 'Edge-first serverless: cold-start <100ms JavaScript/WASM functions, 300+ global PoPs deployment, per-request billing, DDoS-protected. Open-standard runtime, Bring Your Own Compute (BYOC). OpenFaaS-compatible CLI..',
      features: [
        'Cold-start <100ms JavaScript/WASM edge functions',
        '300+ global PoPs deployment single CLI command',
        'Per-request billing banded throughput pricing',
        'DDoS protection + WAF per request',
        'Open-standard Bring Your Own Compute (BYOC) runtime',
      ],
      benefits: [
        '100x faster cold-start vs traditional serverless cold-start latency',
        'Global deployment in seconds per CI/CD pipeline integration',
        'Per-request saves cost for spiky vs always-on VMs',
      ],
      pricing: { basic: '0', pro: '99', enterprise: '1999' },
      contactInfo: { website: '/services/it-serverless-edge-compute-platform', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
      icon: '⚡',
      href: '/services/it-serverless-edge-compute-platform',
      category: 'it',
    },
    {
      id: 'it-observability-logging-tracing-platform',
      title: 'Observability: Logging, Tracing & Metrics (OpenTelemetry-Native)',
      description: 'Full-stack observability with OpenTelemetry-native ingestion: distributed tracing (Jaeger-compatible), structured log aggregation with full-text search, metrics + alerting per SLO/SLI/error-budget. Self-host Kafka/ClickHouse, Prometheus + Grafana compatible dashboards..',
      features: [
        'OpenTelemetry-native traces + metrics + logs unified ingestion',
        'Jaeger/Zipkin-compatible distributed trace explorer UI',
        'Full-text search + filter per structured + unstructured logs',
        'PromoQL + Prometheus/Grafana query + dashboard compatible',
        'Self-host Kafka + ClickHouse or managed cloud variant',
      ],
      benefits: [
        'Complete distributed tracing without vendor lock-in',
        'Log search + trace correlation cuts incident MTTR by 70%',
        'OpenTelemetry-native means no reinstrumentation on switch',
      ],
      pricing: { basic: '29', pro: '149', enterprise: '699' },
      contactInfo: { website: '/services/it-observability-logging-tracing-platform', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
      icon: '📊',
      href: '/services/it-observability-logging-tracing-platform',
      category: 'it',
    },
    {
      id: 'it-secrets-management-hsm-vault',
      title: 'Secrets Management: HSM-Backed Vault with Zero-Knowledge',
      description: 'Enterprise secrets vault with HSM-backed key material: zero-knowledge encryption at rest, dynamic secrets rotation per service-account TTL, least-privilege access per role per environment. AWS/KMS/GCP/Azure KMS plugin federation. SOC2 Type II + FedRAMP-audited..',
      features: [
        'HSM-backed FIPS 140-2 Level 3 validated key material',
        'Dynamic secrets rotation per service-account TTL',
        'Least-privilege policy per role per env namespace',
        'AWS/KMS/GCP/Azure KMS plugin federation',
        'SOC2 Type II + FedRAMP-audited key lifecycle',
      ],
      benefits: [
        'Zero-knowledge at rest — vault admin cannot read secrets',
        'Auto-rotation eliminates credential-stale incident risk',
        'Least-privilege per role satisfies compliance audit',
      ],
      pricing: { basic: '39', pro: '199', enterprise: '899' },
      contactInfo: { website: '/services/it-secrets-management-hsm-vault', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
      icon: '🔐',
      href: '/services/it-secrets-management-hsm-vault',
      category: 'it',
    },
    {
      id: 'it-edge-gateway-industrial-iot',
      title: 'Edge Gateway & Industrial IoT Orchestration',
      description: 'Edge IoT gateway for industrial use: OPC-UA/Modbus/MQTT protocol translation, local decision engine (no cloud dependency), industrial temperature —40C/+85C ATEX/IECEx certified, OTA firmware update + rollback per gateway fleet. Fleet management console with digital-twin..',
      features: [
        'OPC-UA + Modbus + MQTT protocol translation per factory',
        'Local decision engine inference no cloud latency',
        'Industrial —40C/+85C temp + ATEX/IECEx certified',
        'OTA firmware update + rollback per gateway fleet',
        'Digital-twin update + asset tag correlation',
      ],
      benefits: [
        '100+ field devices per gateway without cloud hop',
        'Industrial certs eliminate field-deployment paperwork',
        'OTA rolling-out keeps fleet current — zero truck-roll',
      ],
      pricing: { basic: '199', pro: '699', enterprise: '2999' },
      contactInfo: { website: '/services/it-edge-gateway-industrial-iot', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
      icon: '🏭',
      href: '/services/it-edge-gateway-industrial-iot',
      category: 'it',
    },
    {
      id: 'it-self-healing-kubernetes-platform',
      title: 'Self-Healing Kubernetes Platform + GitOps Fleet Manager',
      description: 'GitOps-first Kubernetes fleet manager: per-cluster health-scoring, auto-patch + auto-upgrade with canary promotion, drift-detection per Helm chart, blue-green cluster promotion. EKS/GKE/AKS + self-host unified RBAC + OIDC. Team cost allocation per namespace..',
      features: [
        'GitOps-first per-cluster health-scoring + auto-healing',
        'Auto-patch + auto-upgrade with canary rollouts',
        'Helm chart drift-detection per cluster state',
        'EKS/GKE/AKS + self-hosted K8s unified management',
        'Team cost allocation per namespace per environment',
      ],
      benefits: [
        'Cluster drift fixed before SRE page — zero incident from config drift',
        'Upgrade canary rollback means zero-downtime K8s upgrade',
        'GitOps trail satisfies SOC2 + change-audit compliance',
      ],
      pricing: { basic: '99', pro: '499', enterprise: '1999' },
    ...
    },
    {
      ...
      title: 'Zero Trust Network Access (ZTNA) + Software-Defined Perimeter',
      description: 'Zero Trust Network Access with Software-Defined Perimeter: per-user/per-device micro-segmentation before network entry, least-privilege per application, continuous session validation per risk score. Replaces VPN for hybrid/remote workforce with SAML/OIDC + device-posture..',
      features: [
        'Per-user/per-device micro-segmentation before routing',
        'Continuous session validation per behavioural risk score',
        'VPN replacement — zero legacy client install required',
        'SAML/OIDC + service-account least-privilege integration',
        'Device posture check before network access granted',
      ],
      benefits: [
        'Replace 5000-user VPN with ZTNA — no more lateral movement risk',
        'Zero Trust satisfies NIST SP 800-207 audit compliance',
        'Stolen tokens expire immediately with risk-scored session',
      ],
      pricing: { basic: '19', pro: '79', enterprise: '299' },
    ...
    },
  {
    ...
    description: 'Cloud-managed EDR with behavioural-based threat detection, automated containment, and forensic investigation toolkit. Covers Windows, macOS, Linux, iOS, Android. Correlates endpoint telemetry with network telemetry to detect lateral movement; produces MITRE ATT&CK technique coverage matrix per host.',
    icon: '🛡️',
    features: ['Behavioural threat detection: fileless malware, living-off-the-land (LotL), credential dumping', 'Automated containment: isolate endpoint, kill process, restore from snapshot — per-event or per-threshold', 'Forensic timeline: complete process tree, file operations, network connections per host before/after', 'MITRE ATT&CK matrix: colour-mapped technique coverage per host and organisation-wide', 'Cross-platform: Windows, macOS, Linux, iOS, Android from one console'],
    benefits: ['Reduce mean-time-to-respond (MTTR) from 47 min to <5 min', 'Detect fileless/LotL threats missed by signature-based AV', 'Accelerate root-cause attribution: one-click forensic timeline export for incident post-mortem', 'Centralised telemetry for 500–50,000 endpoints — scales without more SOC analysts', 'Basic $12/endpoint/mo min 25 ($300) | Pro $8/endpoint 100+ | Enterprise $5/endpoint 1k+'],
    pricing: { basic: '300', pro: '800', enterprise: 'Looking' },
  ...
  {
    id: 'it-cloud-cost-optimisation',
    title: 'Cloud Cost Optimisation',
    description: 'Automated cloud cost management across AWS, GCP, Azure, and DigitalOcean: rightsizing recommendations, reserved-instance coverage, idle resource detection, spend anomaly alerts, and per-team cost chargeback/sharing dashboards with Slack/Teams weekly digests.',
    icon: '💰',
    features: ['Multi-cloud: AWS, GCP, Azure, DigitalOcean — one dashboard for all invoices + usage', 'Rightsizing: 40+ resource types per cloud; per-instance recommendation = CPU/mem/network/disk savings', 'RI/SP/CUD coverage analysis: shows uncovered-on-demand coverage gap by resource and team', 'Idle resource detection: unattached EBS, unused EIP, idle RDS, unused ALB/NLB, idle GKE nodepool', 'Team chargeback: cost per environment × team tag ( kostner/meltano-style) — Slack/Teams weekly reports'],
    benefits: ['Cut cloud spend 20–40% within 90 days of deployment', 'No more unmanaged cloud bills in the mid-month finance email', 'Executive dashboard: actual vs budget variance with 30-day forecast', 'Attenuate risk of accidental Overage alarms on CapEx-managed sub-accounts', 'Basic $0/mo (free up to $5k/month managed) | Pro $499/mo | Enterprise $1,499/mo'],
    pricing: { basic: '0', pro: '499', enterprise: '1499' },
    contactInfo: { website: '/services/it-cloud-cost-optimisation', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/it-cloud-cost-optimisation',
    category: 'it',
    popular: true,
  },
  {
    id: 'it-performance-monitoring-observability',
    title: 'Application Performance Monitoring (APM)',
    description: 'Full-stack APM with distributed tracing (OpenTelemetry-native), real-user monitoring (RUM), synthetic API monitoring from 12 global vantage points, log aggregation, and infrastructure metrics. Auto-instruments 30+ languages and frameworks — no code changes for Node, Python, Ruby, Go, Java, PHP, .NET.',
    icon: '📊',
    features: ['OpenTelemetry-native: accepts OTLP spans/metrics/logs — no vendor lock-in on instrumentation', 'Distributed tracing: waterfall view with flame-graph; filter by service, endpoint, latency percentile', 'Synthetic monitoring: 12 global vantage points; monitor REST/GraphQL/gRPC/WebSocket; SSL expiry alerts', 'RUM: Core Web Vitals, error rates, JS exceptions — session replay for crash-analysable user session', 'Host + container metrics: CPU, memory, disk, network, gc; auto-correlates with service latency spikes'],
    benefits: ['Reduce MTTR 60–80%: trace from dropped KPI → slow DB query → infra bottleneck in <30 sec', 'Proactively fix Core Web Vitals before Google penalises SEO ranking', 'Spot memory leaks before they crash production — percentiles not averages', 'Fast on-call rotation: PagerDuty/Grafana alerts tied to service/latency quartile thresholds', 'Basic $49/mo 1 service | Pro $199/mo 10 services | Enterprise custom'],
    pricing: { basic: '49', pro: '199', enterprise: 'Custom' },
    contactInfo: { website: '/services/it-performance-monitoring-observability', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/it-performance-monitoring-observability',
    category: 'it',
    popular: false,
  },
  {
    ...
    description: '3-2-1 backup strategy as a managed service: daily encrypted snapshots of VMs, databases (RDS, MongoDB, PostgreSQL), and object storage; geo-replicated to 3 regions; RTO/RPO SLA guaranteed; ransomware immutable storage; one-click disaster recovery to warm-standby environment.',
    icon: '💾',
    features: ['3-2-1 fully managed: 3 copies, 2 media types, 1 off-site geo-replicated', 'RTO/SLA: warm standby 15-min RTO, 5-min RPO with SLA financial backstop', 'Immutable / air-gapped storage: WORM compliance backups immune to ransomware encryption', 'Database-native backup: RDS snapshots + log backups, MongoDB Point-in-Time, PostgreSQL PITR', 'DR drill bot: automatically spins up warm standby on schedule, runs smoke tests, auto-tears down, reports pass/fail'],
    benefits: ['Guaranteed recovery within RTO — pay a penalty if we miss it', 'Recover from ransomware even if local backups were encrypted', 'Cut DR drill manual effort from 2 days to 30 minutes (automated bot)', 'Disaster recovery as a managed service — no DR runbook updates required', 'Basic $299/mo 500 GB | Pro $999/mo 5 TB | Enterprise $2,999/mo 50 TB'],
    pricing: { basic: '299', pro: '999', enterprise: '2999' },
    contactInfo: { website: '/services/it-backup-disaster-recovery', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/it-backup-disaster-recovery',
    category: 'it',
    popular: false,
  ...
  {
    id: 'it-load-balancer-traffic-manager',
    title: 'Global Load Balancer & Traffic Manager',
    description: 'Anycast global load balancer with health-check routing, weighted round-robin, failover policies, and DDoS Layer 4-7 mitigation. Supports HTTP/HTTPS, TCP, UDP, WebSocket, and gRPC. Geo-IP routing by country/continent or ASN; health-checks on HTTP status, TCP connect, or custom script.',
    icon: '⚖️',
    features: ['Anycast global LB: 200+ edge PoPs — sub-5 ms decision latency per DNS query', 'Health-checks: HTTP/HTTPS status, TCP connect, gRPC health, custom Lua script, or agent probe', 'Failover policies: primary → secondary → tertiary → drain; TTL 1s for sub-second failover', 'DDoS L4+L7: SYN-flood, UDP-flood, HTTP flood, slowloris, fragmented-packet mitigation baked in', 'Geo-IP routing: route by country, continent, or ASN — supports peering-policy steering per carrier'],
    benefits: ['Eliminate single-point-of-failure for any internet-facing service', 'Cut user-perceived latency 30–60% for global user bases with edge-terminated TLS', 'Downtime from upstream failure: sub-second failover with <1% error rate during transition', 'See live traffic geo-map with per-region health status in ops dashboard', 'Basic $49/mo 100k req/s | Pro $199/mo 1M req/s | Enterprise $799/mo unlimited'],
    pricing: { basic: '49', pro: '199', enterprise: '799' },
    contactInfo: { website: '/services/it-load-balancer-traffic-manager', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/it-load-balancer-traffic-manager',
    category: 'it',
    popular: false,
  },
  {
    id: 'it-wifi-6-wifi-7-deployment',
    title: 'Wi-Fi 6 / Wi-Fi 7 Enterprise Deployment',
    description: 'Enterprise Wi-Fi 6 (802.11ax) and Wi-Fi 7 (802.11be) wireless LAN design, deployment, validation, and ongoing support. Site survey (Ekahau/Intel); BSSID/SSID design; voice-over-Wi-Fi (802.11r/k/v) PoE switch placement; RF channel/power planning; 5G/Wi-Fi handover; Interference analysis and ongoing RF monitoring.',
    icon: '📡',
    features: ['Pre-deployment site survey: Ekahau/Intel predictive + active survey; heat-map export as floorplan overlay', 'Wi-Fi 6 (802.11ax): OFDMA, MU-MIMO, BSS colouring, target wake time (TWT) for IoT devices', 'Wi-Fi 7 (802.11be): 320 MHz channels, 4K QAM, multi-link operation (MLO) for 40 Gbps throughput', 'VoWi-Fi design: 802.11r fast BSS transition, 802.11k neighbour report, 12-room roaming cell sizing', 'Post-deployment validation: Roaming RTT <30 ms, throughput test >300 Mbps, RF interference report'],
    benefits: ['4–8× capacity upgrade vs Wi-Fi 5 with same AP count — defers CAPEX for 5+ years', 'Enterprise-grade roaming: <30 ms Handoff for desktop + laptop + industrial IoT device mesh', 'Roaming validations with heatmap + spectrum report for SOP compliance', 'Design to capacity: single RF plan covers 500-seat stadium, 50,000 ft² warehouse, or multi-campus', 'Design + Surveyflat 4,999 | Deployment $1,499/AP $5/AP/month managed | Wi-Fi 7 Migration $7,999'],
    pricing: { basic: '4999', pro: '1499', enterprise: '7999' },
    contactInfo: { website: '/services/it-wifi-6-wifi-7-deployment', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/it-wifi-6-wifi-7-deployment',
    category: 'it',
    popular: false,
  },
// ─── AI (6 new) ───────────────────────────────────────────────────────────
  ...
  {id:'zero-trust-network-access',title:'Zero-Trust Network Access (ZTNA)',description:'Zero-trust identity-aware proxy: every connection authenticated per user/device/context. Granular per-app policies, micro-segmentation, session recording.',features:['Identity-aware proxy (IAM to ZTNA gateway)','Per-user + per-device + per-context access policy','Micro-segmentation per app/resource sensitivity','Session recording + threat analytics','Continuous trust evaluation re-auth on risk'],benefits:['Zero implicit trust — all connections authenticated','Block lateral movement from compromised device','Granular per-resource access without VPN','Meet NIST SP 800-207 Zero Trust requirements'],pricing:{basic:'299',pro:'799',enterprise:'2499'},contactInfo:{website:'/services/zero-trust-network-access',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},icon:'★',href:'/services/zero-trust-network-access',category:'cloud'},
{
      ...
      title: 'AI Ops Incident Intelligence & Auto-Remediation Platform',
      description: 'AI-First Ops: postmortem auto-summary per incident, root-cause hypothesis scoring per change/metric/log correlation, remediation playbook auto-recommendation per historical ticket. Integrates PagerDuty/OpsGenie reducing MTTR by 80%..',
      features: [
        'Postmortem auto-summary per incident RCA + impact bundle',
        'Root-cause hypothesis scoring per graph-traversal ML',
        'Remediation playbook auto-recommended per historical ticket',
        'PagerDuty/OpsGenie bidirectional alert integration',
        'MTTR reduction 80% vs manual incident response workflow',
      ],
      benefits: [
        'Auto-generated postmortem cuts on-call admin 80%',
        'Root-cause hypothesis scoring means 2-3x faster MTTR',
        'Playbook recommendations turn 1,000 incidents into knowledge base',
      ],
      pricing: { basic: '49', pro: '199', enterprise: '799' },
    ...
    {
      id: 'cloud-k8s-gitops-continuous-deployment',
      title: 'GitOps Continuous Deployment for Kubernetes',
      description: 'GitOps-native CD platform for K8s: declarative deployment manifests per env, progressive delivery (canary + blue-green), auto-rollback per SLO breach. ArgoCD/Flux-compatible API, per-env RBAC + OIDC. Open-source core + enterprise tiers..',
      features: [
        'Declarative manifests per env with env-specific overrides',
        'Progressive delivery canary + blue-green per Git tag',
        'Auto-rollback per SLO breach threshold in production',
        'ArgoCD/Flux-compatible API with provider-agnostic Git',
        'Per-env RBAC + OIDC identity for environment isolation',
      ],
      benefits: [
        'Zero-downtime deployment per canary — auto-rollback instant',
        'Git audit trail satisfies SOC2 + change-approval compliance',
        'Progressive delivery per feature flag run-time direction',
      ],
      pricing: { basic: '0', pro: '79', enterprise: '399' },
      contactInfo: { website: '/services/cloud-k8s-gitops-continuous-deployment', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
      icon: '🔄',
      href: '/services/cloud-k8s-gitops-continuous-deployment',
      category: 'cloud',
    },
    {
      id: 'cloud-cost-chargeback-showback-platform',
      title: 'Cloud Cost Chargeback & Showback Platform',
      description: 'Multi-cloud cost-chargeback: AWS/GCP/Azure billing ingestion, cost allocation per team/project/env via tag/rules engine, real-time cost dashboard per budget owner, chargeback invoice per finance. Anomaly alert per idle-resource waste..',
      features: [
        'Multi-cloud AWS/GCP/Azure billing ingestion + reconciliation',
        'Tag/rules engine allocates cost per team/project/env',
        'Real-time cost dashboard per budget owner monthly forecast',
        'Chargeback invoice + SOX-compliant cost audit trail',
        'Anomaly alert per cost-spend spike + idle-resource waste',
      ],
      benefits: [
        'Cut cloud waste by 30% — idle resources identified before bill',
        'Chargeback invoice eliminates finance manual reconciliation',
        'Team sight-accountability — no more cloud shadow-IT cost',
      ],
      pricing: { basic: '49', pro: '199', enterprise: '899' },
      contactInfo: { website: '/services/cloud-cost-chargeback-showback-platform', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
      icon: '💰',
      href: '/services/cloud-cost-chargeback-showback-platform',
      category: 'cloud',
    },
  {
    id: 'cloud-vpc-flow-logs-analytics',
    title: 'VPC Flow Logs Analytics',
    description: 'Collect, enrich, index, and query AWS VPC / GCP VPC / Azure NSG flow logs in real-time. Build an interactive network topology map showing all ingress/egress flows; detect unexpected open ports, lateral movement, data exfiltration patterns, and cost-waste from unused ENIs via click-through filtering.',
    icon: '🌐',
    features: ['VPC/eni/NSG flow log ingestion: AWS VPC Flow Logs, GCP VPC Flow Logs, Azure NSG Flow Logs in one pipeline', 'Auto-enrichment: geo-IP, WHOIS, threat-intel (AbuseIPDB, OTX, Microsoft Threat Intel)', 'Interactive topology: live network graph (D3 / React Force Graph); click node to see all flows', 'Security queries: unexpected SSH/RDP open ports, lateral movement beaconing, bulk data exfil pattern', 'Cost waste: unused ENIs, unattached EIPs, idle Internet Gateways, over-provisioned NAT Gateways'],
    benefits: ['Detect lateral movement and data exfiltration patterns in VPCs in seconds — no manual S3 log parsing', 'Reduce unknown-egress risk 80% with IP geo-table flagged by threat-intel', 'Cut AWS networking cost 15–30% from idle ENIs + over-provisioned NATs', 'Pre- and post-incident context: unifies VPC flow logs with SIEM findings', 'Basic $399/mo 50 VPCs | Pro $999/mo 500 VPCs | Enterprise $2,999/mo unlimited'],
    pricing: { basic: '399', pro: '999', enterprise: '2999' },
    contactInfo: { website: '/services/cloud-vpc-flow-logs-analytics', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/cloud-vpc-flow-logs-analytics',
    category: 'cloud',
    popular: false,
  },
  {
    id: 'cloud-ai-inference-gateway',
    title: 'AI Inference Gateway',
    description: 'Unified API gateway for all LLM and generative AI models: model router (route to cheapest/fastest/quality-optimised provider), prompt versioning, team-scoped API keys, usage quotas, cost attribution, response caching with similarity dedup, and PII Guard to block sensitive-text before it leaves your network.',
    icon: '🚀',
    features: ['Model router: rank by cost, latency, quality — auto-failover on upstream outage', 'Prompt versioning: stage → prod with A/B testing traffic splitting per prompt version', 'Team-scoped API keys: dev / staging / prod per-team sub-keys with budget caps', 'Response cache: semantic similarity dedup (embedding cosine) — cut duplicate LLM calls 60–90%', 'PII Guard: regex + transformer-based detector (email, SSN, phone, credit card) — block before API call'],
    benefits: ['Cut LLM inference spend 30–60% via smart routing + response caching + batch optimisation', 'Eliminate PII leaks via guardrail intercept before prompt leaves your network', 'Version-control prompts in git — no more "which version is in prod?" confusion', 'Single API key for 10+ providers — eliminate per-provider credential sprawl', 'Basic $99/mo 500k tokens | Pro $399/mo 5M tokens | Enterprise $1,499/mo 50M tokens'],
    pricing: { basic: '99', pro: '399', enterprise: '1499' },
    contactInfo: { website: '/services/cloud-ai-inference-gateway', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/cloud-ai-inference-gateway',
    category: 'cloud',
    popular: true,
  },
  {
    id: 'cloud-edge-ai-inference',
    title: 'Edge AI Inference',
    description: 'Run vision, audio, and tabular ML models at the edge (CPU, Raspberry Pi, Jetson Orin, Coral TPU) with no cloud roundtrip. Convert PyTorch/TensorFlow models to ONNX, quantise to INT8, and deploy via gatway with OTA model updates and health checks.',
    icon: '🧠',
    features: ['Model conversion pipeline: PyTorch/TensorFlow → ONNX → INT8 quantise with accuracy validation', 'Hardware targets: x86 CPU, Raspberry Pi 4/5, Nvidia Jetson Orin, Google Coral TPU, AWS Panorama', 'OTA model updates: staged rollout with health-check rollback on inference latency spike', 'Vision models: YOLOv8 (object detection), SAM2 (segmentation), OCR (PaddleOCR, EasyOCR)', 'Audio/Language: Whisper.cc STT, TTS (Piper, Coqui), text-classification, keyword-wake word'],
    benefits: ['Sub-50ms inference latency with no cloud dependency — works offline', 'Eliminate per-image video/audio stream cloud egress cost (30–99% cheaper than cloud)', 'Enforce data-residency: raw sensory data never leaves the device — GDPR/HIPAA friendly', 'Retrain loop: capture mislabeled samples → OTA update → improved model in 24h', 'Basic $799/mo 10 devices | Pro $1,999/mo 100 devices | Enterprise custom'],
    pricing: { basic: '799', pro: '1999', enterprise: 'Custom' },
    contactInfo: { website: '/services/cloud-edge-ai-inference', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/cloud-edge-ai-inference',
    category: 'cloud',
    popular: false,
  },
  {
    id: 'cloud-web-application-firewall',
    title: 'Managed Web Application Firewall',
    description: 'OCI-aware managed WAF with pre-configured rule-sets (OWASP Core Rule Set, CVE-matched signatures), custom regex rules per-app, anomaly-based rate-limiting, geo-blocking, and built-in DDoS L7 mitigation. Includes 24/7 SOC threat-intel feed and log shipping to S3/ELK.',
    icon: '🔥',
    features: ['OWASP Core Rule Set (CRS) + CVE-matched signatures auto-updated within 24h of CVE publish', 'Anomaly rate-limiting: learns baseline RPS per endpoint, auto-spikes trigger 2-hour lockout', 'Geo-blocking + IP reputation: blocklist from AbuseIPDB, OTX, Tor exit lists with dry-run mode', 'SOC Intel feed: 24/7 analyst-curated threat-intel pushed to WAF rule engine — zero manual rule writing', 'Log shipping: all events to S3/CloudWatch Logs / ELK / Splunk with 12-month retention included'],
    benefits: ['Block 99% of automated exploits (SQLi, XSS, RFI, LFI) out-of-the-box', 'Reduce DDoS attack surface cost by 80% vs self-managed WAF staff time', 'No firewall rules to maintain — SOC feed continuously updates rule sets', 'PCI-DSS requirement 6.6 fully auditable with built-in compliance dashboards', 'Basic $199/mo 1 domain | Pro $599/mo 10 domains | Enterprise $1,999/mo unlimited'],
    pricing: { basic: '199', pro: '599', enterprise: '1999' },
    contactInfo: { website: '/services/cloud-web-application-firewall', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/cloud-web-application-firewall',
    category: 'cloud',
    popular: true,
  },
  {
    id: 'cloud-container-image-scanning',
    title: 'Container Image Scanning',
    description: 'Continuous container image vulnerability scanning on Docker Hub / Amazon ECR / GCP Artifact Registry upstream. Multi-layer SBOM generation, CVE severity scoring (CVSS 3.1), license-compliance (SPDX, Snyk, WhiteSource), and policy-based gating to block vulnerable images from reaching production Kubernetes clusters.',
    icon: '🐳',
    features: ['Multi-registry scanning: Docker Hub, ECR, GCP Artifact Registry, GitHub Container Registry, Quay.io', 'SBOM generation: CycloneDX + SPDX per image layer; export as JSON/LD', 'CVE scoring: CVSS 3.1 base + temporal, with CISA KEV auto-flag as critical', 'OS + language-package scanning: Debian, Alpine, Ubuntu, RHEL + npm, pip, gems, cargo', 'Policy gates: block image push if critical CVE >N days unpatched; GitHub Action + CI hooks'],
    benefits: ['Block CVEs before they reach staging/production — shift-left container security', 'Quantify image attack surface: every CVE, every base-image layer, every dependency', 'SPDX/SBOM exports for VEX/CTIA compliance reporting', 'Reduce container security review cycle from 2 weeks to 2 hours', 'Basic $99/mo 500 images | Pro $399/mo 5k images | Enterprise $1,199/mo unlimited'],
    pricing: { basic: '99', pro: '399', enterprise: '1199' },
    contactInfo: { website: '/services/cloud-container-image-scanning', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/cloud-container-image-scanning',
    category: 'cloud',
    popular: false,
  },
// ─── IT (6 new) ───────────────────────────────────────────────────────────
...
{
      id: 'security-threat-intelligence-platform',
      title: 'Threat Intelligence & IOC Feeds Platform',
      description: 'Enterprise threat-intelligence platform: 500K+ daily IOCs from 50+ commercial + open feeds, auto-enrichment per asset inventory CVSS + criticality, STIX/TAXII export, alert correlation per MITRE ATT&CK. On-prem or SaaS. MISP compatible..',
      features: [
        '500K+ daily IOCs from 50+ commercial + open threat feeds',
        'Auto-enrichment per asset inventory CVSS + criticality',
        'STIX/TAXII export + MISP correlation format',
        'Alert correlation per MITRE ATT&CK technique matrix',
        'Custom rule builder per SOC tenancy custom policy',
      ],
      benefits: [
        'IOC coverage 10x higher than free feeds — premium intel included',
        'Auto-enrichment puts IOC in context — false positives drop sharply',
        'MITRE ATT&CK correlation gives attack narrative per IOC alert',
      ],
      pricing: { basic: '49', pro: '199', enterprise: '799' },
      contactInfo: { website: '/services/security-threat-intelligence-platform', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
      icon: '🧠',
    ...
    },
    {
      ...
      title: 'Container Security: Registry + Runtime Scanner',
      description: 'Container security: CI/CD registry vulnerability scan + CVE severity per image, runtime enforcement with Falco WAF rules, admission-control per Kubernetes OPA/Gatekeeper, SBOM generation + license compliance. ECR/GCR/DockerHub. CIS benchmark for Kubernetes..',
      features: [
        'Registry scan per push: CVE + severity per image layer',
        'Runtime enforcement Falco WAF rules per K8s admission',
        'OPA/Gatekeeper policy per K8s admission webhook',
        'SBOM generation CycloneDX + SPDX + license compliance',
        'CIS benchmark compliance grid per K8s version',
      ],
      benefits: [
        'Block vulnerable image before it reaches production',
        'Runtime enforcement catches zero-day CVE before CVSS database',
        'OPA/Gatekeeper policy-as-code satisfies compliance audit',
      ],
  ...
  {
    id: 'security-api-security-scanner',
    title: 'Automated API Security Scanner',
    description: 'Continuous API security testing: fuzz REST/GraphQL/gRPC endpoints with OWASP Top 10 attack patterns, detect Broken Object Level Authorization (BOLA/IDOR), rate-limit bypass, PII/secret leaks in responses, and JWT validation gaps. Integrates into CI pipeline and developer IDE.',
    icon: '🎯',
    features: ['OWASP Top 10 for APIs fuzzing: BOLA/IDOR, mass-assignment, exfiltration, SSRF, injection', 'GraphQL introspection scan: detect exposed types, resolvers, and depth-limit gaps', 'JWT/API key validation: algorithm confusion, none-algorithm, expiry bypass, audience mismatch', 'PII/secret in response scanner: regex + LLM classifier for SSN, credit card, API keys', 'CI + IDE integrations: GitHub Action, GitLab CI, VS Code extension with inline findings'],
    benefits: ['Find 10–50 API vulnerabilities per scan — most OWASP BOLA/BOPLA issues missed in pen-tests', 'Shift-left: catch vulns in PR before staging deploy', 'Reduce API security audit prep time 70% — generates SAST evidence for SOC 2, ISO 27001', 'Remediation guidance per finding: curl example, code fix suggested', 'Basic $399/mo 10 APIs | Pro $999/mo 100 APIs | Enterprise $3,999/mo unlimited'],
    pricing: { basic: '399', pro: '999', enterprise: '3999' },
    contactInfo: { website: '/services/security-api-security-scanner', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/security-api-security-scanner',
    category: 'security',
    popular: false,
  },
  {
    id: 'security-soc-virtual-analyst',
    title: 'SOC Virtual Analyst / AI L1',
    description: 'AI-first Tier-1 SOC analyst: continuously correlates alerts from CrowdStrike, SentinelOne, Microsoft Defender, Vectra, and Zeek into coherent incidents; runs containment playbooks (block IP, quarantine host, disable account); escalates only what needs human judgment reducing alert fatigue by 80–95%.',
    icon: '🤖',
    features: ['Multi-source correlation: 50+ connectors for CrowdStrike, SentinelOne, MS Defender, Vectra, Zeek, Suricata', 'Runbook playbooks: block IP, quarantine endpoint, disable AD account — multi-step, multi-system', 'Escalation rationale: natural language summary of attack chain + MITRE ATT&CK mapping per incident', 'Human handoff: full context conversation thread pre-attached for Tier-2 analyst', 'Audit log: every alert, correlation, decision, and override timestamped + signed for compliance'],
    benefits: ['Reduce Tier-1 SOC analyst headcount cost 60–80% for MDR service providers', 'Reduce MTTR from hours to minutes: auto-containment in <2 min of malicious indicator', 'Cut alert noise: 10,000 alerts/day → 10–50 escalated incidents', '24/7 coverage at junior-analyst salary — no burnout, no attrition risk', 'Basic $1,999/mo 5k events/day | Pro $5,999/mo 50k events/day | Enterprise custom'],
    pricing: { basic: '1999', pro: '5999', enterprise: 'Custom' },
    contactInfo: { website: '/services/security-soc-virtual-analyst', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/security-soc-virtual-analyst',
    category: 'security',
    popular: false,
  },
  {
    ...
    description: 'Audit and plan your organisation\'s migration to quantum-resistant cryptography (CRYSTALS-Kyber/Dilithium, SPHINCS+, FIPS 203/204/205). Scans TLS/certificate inventory, SSH host keys, VPN tunnels, code-signing, and PKI hierarchies; produces migration roadmap with vendor-product shortlist and timeline.',
    icon: '🔐',
    features: ['Cryptographic inventory: all TLS certs, SSH host keys, VPN IKE, code-signing tokens, YubiKey PIV', 'Vulnerability scoring per asset: TLS-1.3 vs SHA-256 vs RSA-2048 (Grover/Shor exposure)', 'PQC migration roadmap: phased plan with vendor shortlist per asset type (2026/2028/2034 windows)', 'Dev support: OpenSSL 3.5 / BoringSSL PQC migration guide + test harness + staging', 'Executive readiness report: board-ready one-pager for C-suite on quantum-resilience posture'],
    benefits: ["Hackers harvest now, decrypt later: PQC migration now prevents future breaches of today's encrypted data", 'Regulatory readiness: NIST SP 800-208 compliance path pre-NIST deadline', 'Competitive differentiator for managed-security and MSP forward-security services', 'Avoid rushed & expensive emergency PQC migration later at 3–5× the cost', 'Assessment $4,999 flat | Planning $12,999 flat | Ongoing compliance $2,499/mo'],
    pricing: { basic: '4999', pro: '12999', enterprise: '2499' },
  ...
  {
    id: 'security-owasp-top-10-compliance-scanner',
    title: 'OWASP Top 10 Compliance Scanner',
    description: 'Automated web-application compliance scanning for OWASP Top 10 2021 and the WSTG v4.2. Maps every finding to the relevant OWASP category, CWE ID, and the OWASP Testing Guide step that triggered it; also maps to PCI-DSS control A6, CWE Top 25, MITRE CAPEC, and GDPR Art. 32.',
    icon: '🛡️',
    features: ['OWASP Top 10 2021: A01 Broken Access Control through A10 Server-Side Request Forgery', 'WSTG v4.2 mapping: complete step mapping per OWASP Testing Guide — not ranked', 'CWE Top 25 + PCI-DSS A6 mapping + GDPR Art.32 breach-risk classification', 'Remediation with expiring CVEs/CAN IDs attached: zero-day CVE check per finding', 'CI/CD integration: GitHub Action, GitLab CI; fails PR when medium+ findings found'],
    benefits: ['Quantify application security posture in 1 report, not 12', 'Reduce pen-test bill by 30–50% — scanner pre-fixes 60% of OWASP Top 10 findings', 'Regulatory evidence for OWASP, PCI-DSS, GDPR with exemption-ready documentation', 'Developer-friendly: WSTG-steps mapped per finding — "copy fix code" per vulnerability', 'Basic $199/mo 5 scans | Pro $699/mo 20 scans | Enterprise $1,999/mo unlimited'],
    pricing: { basic: '199', pro: '699', enterprise: '1999' },
    contactInfo: { website: '/services/security-owasp-top-10-compliance-scanner', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/security-owasp-top-10-compliance-scanner',
    category: 'security',
    popular: false,
  },
  {
    id: 'security-incident-knowledge-base',
    title: 'Incident Knowledge Base & Playbook Engine',
    description: 'Searchable security incident knowledge base: granular playbook steps per alert type (MFA bypass, ransomware, data exfil, phishing), with the EXACT commands to run across SentinelOne, CrowdStrike, EDR, SIEM, firewall, zero-trust, and ticketing tool. Includes run-book builder for custom incident types.',
    icon: '📚',
    features: ['50+ pre-built runbooks: ransomware, lateral movement, MFA bypass, exfiltration, phishing, DDoS', 'Exact tool commands per step: SentinelOne CLI, CrowdStrike Falcon, MS Defender, PaloAlto CLI, Azure AD', 'Playbook builder: custom incident types with branching logic + approval gates', 'Incident post-mortem template: auto-fills from runbook execution log + timeline', 'Integrations: Slack notify, Jira create ticket, Confluence update runbook page'],
    benefits: ['Reduce MTTR by 50–70% — Tier-1 analyst has exact CLI command in 1 click', 'Standardise playbooks across SOC team — no tribal knowledge written on whiteboards', 'Runbook auto-updates when new CVE-affected IOC added', 'Pass PCI-DSS / ISO 27001 tabletop audits with 50+ documented incident runbooks', 'Basic $499/mo 10 SOC users | Pro $1,299/mo unlimited users | Enterprise $3,999/mo'],
    pricing: { basic: '499', pro: '1299', enterprise: '3999' },
    contactInfo: { website: '/services/security-incident-knowledge-base', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/security-incident-knowledge-base',
    category: 'security',
    popular: false,
  },
// ─── CLOUD (5 new) ────────────────────────────────────────────────────────
  ...
  {id:'streaming-realtime-analytics',title:'Real-Time Streaming Analytics',description:'Sub-second analytics on event streams: Kafka/Redpanda/PubSub to Flink/Spark — sessionization, windowed aggregates, anomaly detection. Sub-second refresh dashboard.',features:['Multi-broker: Kafka/Redpanda + connectors','Flink/Spark Streaming windowed aggregation','Sub-second event to alert latency','Anomaly detection per metric stream (Z-score)','Grafana/Looker real-time dashboard'],benefits:['Real-time fraud detection sub-second','Session analytics for product usage real-time','No warehouse ETL lag','Event-time + watermarked, no late-arrival skew'],pricing:{basic:'999',pro:'2999',enterprise:'9999'},contactInfo:{website:'/services/streaming-realtime-analytics',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},icon:'★',href:'/services/streaming-realtime-analytics',category:'data'},
{
      ...
      description: 'Streaming feature store for ML: point-in-time correct joins (no training-serving skew), low-latency serving <10ms, feature lineage graph per transformation, A/B experimentation per feature flag. Spark/Flink/Kafka/Redis + PyTorch/TF/Scikit-learn compatible..',
      features: [
        'Point-in-time correct joins no training-serving skew',
        'Low-latency feature serving <10ms online store',
        'Feature lineage graph per upstream transformation',
        'A/B experimentation per feature flag + rollout',
        'Spark/Flink/Kafka/Redis + PyTorch/TF/Scikit-learn native',
      ],
      benefits: [
        'Eliminate training-serving skew from point-in-time joins',
        '10ms feature serving enables real-time ML inference at scale',
        'Feature lineage graph satisfies MLOps compliance audit',
      ],
      pricing: { basic: '199', pro: '699', enterprise: '2499' },
    ...
    },
    {
      ...
      title: 'NLP Pipeline Orchestrator & Text Analytics Platform',
      description: 'Pre-built NLP pipeline orchestrator: entity + relation + sentiment extraction, document clustering per embedding model, zero-shot classification fine-tuning, managed model registry. REST + gRPC API per document ingestion queue..',
      features: [
        'Entity + relation + sentiment extraction per document class',
        'Document clustering per sentence/paragraph embedding model',
        'Zero-shot classification fine-tuned model registry',
        'REST + gRPC API per document ingestion queue',
        'MLflow-compatible experiment tracking per pipeline',
      ],
      benefits: [
        'Pre-built NLP pipelines reduce text-AI project from months to days',
        'Managed model registry eliminates duplicate NLP model training',
        'gRPC API handles 100K docs/sec pipeline throughput',
      ],
      pricing: { basic: '99', pro: '399', enterprise: '1499' },
  ...
  {
    id: 'data-geospatial-iot-platform',
    title: 'Geospatial IoT Platform',
    description: 'Ingest, store, and query location-tagged sensor streams at petabyte scale. Routes, zones, and geofences are computed server-side using PostGIS+TimescaleDB; alerts fire on real-time deviation from expected routes or asset dwell time. Fleet managers get a live heat-map dashboard with drill-through to individual asset telemetry.',
    icon: '🌍',
    features: ['PostGIS+TimescaleDB: store location + sensor payloads in one table, index on ST_GeomFromText', 'Geofence engine: define zones (GeoJSON) and evaluate dwell-time + crossing rules in-database', 'Real-time heat-map: Deck.gl / Mapbox GL tile layer streaming from Redis GEOADD pub-sub', 'Route deviation detection: Kalman-filter smoothed trajectory vs expected route per asset', 'Export: GeoJSON, CSV, Parquet — webhook or SFTP push for downstream analytics'],
    benefits: ['Reduce stolen-asset recovery time 70% with live geofence alerts', 'Cut fleet fuel spend 10–15% via route deviation + idle-time analysis', 'Eliminate truckrolls for field instruments — predict next maintenance visit', 'Auditable asset telemetry: timestamped GPS + sensor readings for insurance/liability', 'Basic $799/mo 5k active assets | Pro $2,499/mo 50k assets | Enterprise custom'],
    pricing: { basic: '799', pro: '2499', enterprise: 'Custom' },
    contactInfo: { website: '/services/data-geospatial-iot-platform', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/data-geospatial-iot-platform',
    category: 'data',
    popular: false,
  },
  {
    ...
    description: 'Unified customer identity graph: ingest 1st-party events from web, app, CRM, support, and billing; stitch anonymous to known using deterministic + probabilistic matching; segment with a visual rule builder or SQL; activate audiences to ad platforms (Google/Meta/TikTok/Programmatic) and personalisation tools.',
    icon: '👥',
    features: ['Identity graph: deterministic email/phone match + probabilistic browser/device graph', 'Real-time event pipeline: Kafka → Flink → S3/Parquet; sub-second identity resolution', 'Visual segment builder: AND/OR rules, cohort lookalikes, predictive RFM segments', 'Activation APIs: push audiences to Google Ads, Meta Ads, TikTok, Braze, Braze, Segment', 'Consent & privacy: CCPA/GDPR right-to-erase, consent signals auto-dropped from segments'],
    benefits: ['Single source of truth for every customer identity — no more siloed segmenting', 'Activate audiences in <5 min, no engineering tickets', 'Reduce churn by targeting at-risk segments before they leave', 'Zero PII in downstream activation platforms — privacy-by-design', 'Basic $1,999/mo 100k profiles | Pro $5,999/mo 1M profiles | Enterprise custom'],
    pricing: { basic: '1999', pro: '5999', enterprise: 'Custom' },
    contactInfo: { website: '/services/data-customer-data-platform', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/data-customer-data-platform',
    category: 'data',
    popular: false,
  },
  {
    id: 'data-fraud-detection-ml-pipeline',
    title: 'Real-Time Fraud Detection Pipeline',
    description: 'Streaming fraud scoring at sub-100ms latency: XGBoost + LightGBM ensemble scores every payment/transaction event as it lands in Kafka; auto-blocks high-risk transactions, flags medium-risk for review, and surfaces feature importance per decision. Feedback loop from chargeback → label → model retrain.',
    icon: '🛡️',
    features: ['Sub-100ms scoring: Flink streaming + ONNX model serving on GPU-accelerated K8s nodes', 'Ensemble model: LightGBM + XGBoost + graph-feature module; auto-fallback on model drift', 'Label feedback loop: chargeback/fraud data → Kafka topic → daily auto-retrain with MLflow', 'Feature store: online for scoring, offline for training — versioned & lineage-tracked', 'Case management UI: fraud analyst review queue with decision audit trail + override audit log'],
    benefits: ['Cut false-positive fraud blocks by 40–60% with ensemble scoring', 'Reduce chargeback rate 30–50% via real-time blocking', 'Satisfy PSD2/PCI-DSS compliance logging with immutable decision audit trail', 'ML workflow managed end-to-end, not stitched from vendor components', 'Basic $1,499/mo 100k txns/day | Pro $3,999/mo 1M txns/day | Enterprise custom'],
    pricing: { basic: '1499', pro: '3999', enterprise: 'Custom' },
    contactInfo: { website: '/services/data-fraud-detection-ml-pipeline', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/data-fraud-detection-ml-pipeline',
    category: 'data',
    popular: false,
  },
  {
    id: 'data-time-series-anomaly-detector',
    title: 'Time-Series Anomaly Detector',
    description: 'Detect anomalies in high-cardinality time-series (100k+ metrics) using unsupervised (Isolation Forest, Autoencoder) and semi-supervised (Prophet, LSTM-AD) models. Self-tuning seasonal baselines; zero cold-start. Strikes PagerDuty/OpsGenie with adaptive noise filtering to suppress false alerts.',
    icon: '📉',
    features: ['Unsupervised + semi-supervised ensembles: Isolation Forest + Prophet + LSTM-AD', 'Self-tuning seasonal baselines: hourly/daily/weekly seasonality auto-detected', 'High-cardinality scaling: 100k+ series with per-series model selection at query time', 'Adaptive noise filter: suppresses false alerts on noisy metrics using rolling std-dev z-score', 'Webhook + OpsGenie/PagerDuty integrations; Slack alert threads with metric sparklines'],
    benefits: ['Cut MTTR 40–70% by surfacing anomalies before incidents escalate', 'Zero false-positive alarm fatigue with noise-filter stacking', 'Detect slow-drip degradation invisible to static threshold alerts', 'Built-in correlation: groups related anomalies into one incident context', 'Basic $499/mo 10k series | Pro $1,499/mo 100k series | Enterprise custom'],
    pricing: { basic: '499', pro: '1499', enterprise: 'Custom' },
    contactInfo: { website: '/services/data-time-series-anomaly-detector', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/data-time-series-anomaly-detector',
    category: 'data',
    popular: false,
  },
  {
    id: 'data-llm-evaluation-harness',
    title: 'LLM Evaluation & Observability Harness',
    description: 'Continuous quality evaluation of LLM applications: run unit-test-style regression suites against production prompts, track drift in faithfulness, toxicity, factual accuracy, latency, and token cost over time. Integrates with LangSmith, Arize, Prometheus, and your CI pipeline.',
    icon: '🔬',
    features: ['Regression test suite: assert semantics, not exact tokens (embedding similarity threshold)', 'Faithfulness + factual accuracy: RAG response scored vs retrieved chunks context coverage', 'Drift dashboard: per-metric time-series (faithfulness, toxicity, latency, tokens/prompt) with alerts', 'Prometheus exporter + Grafana dashboard + webhook alerts on metric threshold breach', 'CI integration: run evaluation on git push to feature branch, block merge on regression'],
    benefits: ['Catch prompt regressions before production deployment — shift-left quality', 'Track LLM drift over time — know when files ingested corrupted context', 'Drill from "faithfulness dropped" → specific failing prompt in one click', 'Quantify cost/quality tradeoffs: auto-run A/B experiments across prompt versions', 'Basic $999/mo 10k eval runs | Pro $2,999/mo 100k runs | Enterprise $9,999/mo unlimited'],
    pricing: { basic: '999', pro: '2999', enterprise: '9999' },
    contactInfo: { website: '/services/data-llm-evaluation-harness', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/data-llm-evaluation-harness',
    category: 'data',
    popular: false,
  },
// ─── SECURITY (5 new) ─────────────────────────────────────────────────────
  ...
  {id:'observability-aiops',title:'AIOps: Observability Automation',description:'AIOps: anomaly detection, log-based alerting, AI RCA, runbook auto-generation, incident correlation, auto-severity, self-healing remediation, MTTR tracking.',features:['Anomaly detection per metric/log/trace','Log-based alert pattern — alert less signal more','AI RCA correlating across signals','Auto-generated runbook per incident type','Self-healing action per whitelisted scenario'],benefits:['Cut alert volume 80% — signal no noise','Reduce MTTR by 60% with AI RCA','Self-healing resolves before on-call','Runbook auto-generated institutional knowledge'],pricing:{basic:'499',pro:'1499',enterprise:'4999'},contactInfo:{website:'/services/observability-aiops',email:'kleber@ziontechgroup.com',phone:'+1 302 464 0950'},icon:'★',href:'/services/observability-aiops',category:'automation'},
{
      ...
      features: [
        ...
        'S3/GCS/ADLS batch + Kafka real-time unified model store',
        'MLflow-compatible experiment tracking per pipeline',
      ],
      benefits: [
        'Model stays current — auto-retrain on drift within hours',
    ...
    },
    {
      ...
      features: [
        ...
        'Audit trail per SAP action per GRC compliance',
      ],
      benefits: [
    ...
    },
  {
    ...
    description: 'OCR-free full-text extraction from PDFs, images, and scanners using LayoutLM/Donut fine-tuned models. Auto-classifies documents (invoice PO, contract, W-9, medical form), extracts structured fields with confidence scoring, and routes to the right downstream system.',
    icon: '🤖',
    features: ['OCR-free LM-based extraction (LayoutLM/Donut) — handles noisy, rotated, multi-column pages', 'Auto-classify 70+ document types with zero-shot & fine-tuned labels', 'Confidence-scored field extraction: key-value pairs, tables, checkbox, signatures', 'Built-in human-in-the-loop (HITL) review queue with one-click correction & model fine-tune', 'Native integrations: QuickBooks, Xero, DocuSign, NetSuite, Salesforce, Slack, PostgreSQL'],
    benefits: ['Cut document processing time 80–95% vs manual data entry', 'Reduce keying errors to <1% field-level accuracy', 'Extract tables and multi-column layouts automatically — no custom rules', 'Audit trail on every extraction — compliance-ready', 'Pricing: Basic $499/mo 500 docs | Pro $1499/mo 5k docs | Enterprise custom'],
    pricing: { basic: '499', pro: '1499', enterprise: 'Custom' },
  ...
  },
  {
    ...
    description: 'Automatically discover, visualise, and optimise real business processes by ingesting event-log data from ERP, CRM, BPM, and ticketing systems. Identifies bottlenecks, deviations, and automation opportunities using conformance checking and process variant clustering.',
    icon: '⛏️',
    features: ['Auto-discovers process maps from ERP/CRM/BPM event logs (SAP, Oracle, Salesforce, Jira, ServiceNow)', 'Conformance checking — compares actual vs ideal paths with deviation scoring', 'Bottleneck & rework hotspot detection: queue time, cycle time, handover waste', 'RPA opportunity scoring: suggests which steps to auto-route + effort estimate', 'Executive dashboard: process KPIs, SLA drift, cost-per-transaction trend'],
    benefits: ['Identify hidden bottlenecks invisible in manual process reviews', 'Quantify RPA/automation ROI before any script is written', 'Reduce end-to-end cycle time 20–40% on average', 'Continuous monitoring: catch process drift after go-live', 'Basic $1,499/mo 5 processes | Pro $3,999/mo unlimited | Enterprise custom'],
    pricing: { basic: '1499', pro: '3999', enterprise: 'Custom' },
  ...
  {
    id: 'automation-customer-onboarding-automation',
    title: 'Customer Onboarding Automation',
    description: 'End-to-end onboarding workflow: welcome email → document e-sign → provisioning accounts across 40+ SaaS tools → Slack/Teams invite → billing trigger. Fully configurable per customer tier (self-serve, professional, enterprise) with progressive disclosure forms and personalised handoff sequences.',
    icon: '👋',
    features: ['Self-serve configurable onboarding flows per customer tier', 'Provisioning integrations: Slack, Okta, QuickBooks, HubSpot, Notion, Jira — 40+ apps', 'E-signature + document capture: DocuSign/HelloSign embedded signing', 'Progressive disclosure forms with conditional logic (Airtable-like) + branching paths', 'Trigger SLA countdown timers; auto-escalate stalled onboarding to CSM'],
    benefits: ['Cut time-to-first-value from 30 days to <30 minutes', 'Reduce onboarding drop-off by 40–60% with progressive disclosure', 'Free CSM capacity by 70% for self-serve accounts', 'Auditable onboarding trail — every step timestamped', 'Basic $799/mo 500 onboardings | Pro $1,999/mo 5k onboardings | Enterprise custom'],
    pricing: { basic: '799', pro: '1999', enterprise: 'Custom' },
    contactInfo: { website: '/services/automation-customer-onboarding-automation', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/automation-customer-onboarding-automation',
    category: 'automation',
    popular: false,
  },
  {
    id: 'automation-intelligent-chatbot-builder',
    title: 'Intelligent Chatbot Builder',
    description: 'Low-code visual bot builder with RAG and tool-calling: connect to Confluence/Notion/SharePoint/Drive knowledge bases, define custom tools (Lookup CRM, Create Ticket, Check Order), set tone/brand guardrails, and deploy to web widget, Slack, WhatsApp, or phone IVR in minutes.',
    icon: '💬',
    features: ['No-code visual flow builder: intent → action → handoff with branching logic', 'RAG knowledge base: Confluence, Notion, SharePoint, Google Drive, S3 — OAuth auto-sync', 'Tool calling: link actions to REST APIs, DB queries, or SDK calls — no custom code', 'Brand guardrails: tone, scope, escalation rules, answer-review queue', 'Omnichannel deploy: web widget, Intercom/Zendesk embeds, Slack, WhatsApp, Twilio IVR'],
    benefits: ['Resolve 60–80% of tier-1 support tickets without human agent', 'Keep knowledge base in sync automatically — no manual FAQ updates', 'Escalate correctly with full conversation context pre-attached', 'Analytics dashboard: deflection rate, CSAT, unresolved topics trends', 'Basic $399/mo 1k msgs | Pro $1,199/mo 25k msgs | Enterprise custom'],
    pricing: { basic: '399', pro: '1199', enterprise: 'Custom' },
    contactInfo: { website: '/services/automation-intelligent-chatbot-builder', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/automation-intelligent-chatbot-builder',
    category: 'automation',
    popular: true,
  },
  {
    id: 'automation-revenue-operations-platform',
    title: 'RevOps Automation Platform',
    description: 'Revenue Operations (RevOps) orchestration: auto-qualify leads from web forms, enrich with Clearbit/ZoomInfo data, route to right AE by territory + load, create HubSpot/Salesforce opportunities, trigger Slack bookkeeping alerts, and close-loop revenue attribution across Marketing → Sales → Support.',
    icon: '🔄',
    features: ['Lead qualification scoring: behavioural + demographic + firmographic signals', 'Auto-enrichment: Clearbit/ZoomInfo/6sense API — 100+ data fields populated', 'Territory/load-aware AE routing with round-robin fairness', 'Closed-loop revenue attribution: Marketing→SQL→Opportunity→Invoice→Collection', 'Slack/Teams revenue alerts: new deal, renewal date, upsell flagging with @mentions'],
    benefits: ['Increase marketing-sourced pipeline 25–50% with better routing', 'Cut AE admin time 60% — no manual CRM entry', 'Replace monthly revenue reporting calls with real-time dashboard', 'Automatically close attribution gaps last seen in spreadsheets', 'Basic $599/mo 10k contacts | Pro $1,799/mo 100k contacts | Enterprise custom'],
    pricing: { basic: '599', pro: '1799', enterprise: 'Custom' },
    contactInfo: { website: '/services/automation-revenue-operations-platform', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/automation-revenue-operations-platform',
    category: 'automation',
    popular: true,
  },
// ─── DATA (5 new) ──────────────────────────────────────────────────────────
  ...
  {
    id: 'automation-ai-helpdesk-automator',
    title: 'AI-Driven IT Helpdesk Automator',
    description: 'Uses AI chatbots and knowledge bases to automatically resolve common IT tickets (password resets, software installs, access requests).',
    icon: '★',
    features: [
        'Natural language understanding for ticket classification',
        'Integration with ITSM tools (ServiceNow, Jira, Zendesk)',
        'Knowledge base article suggestion and execution',
        'Escalation to human agents for complex issues'
    ],
    benefits: [
        'Reduce helpdesk ticket volume by 40-60%',
        'Provide 24/7 instant support for common issues',
        'Free up IT staff for strategic projects',
        'Improve user satisfaction with faster resolution'
    ],
    pricing: {basic: '1799', pro: '4299', enterprise: '12999'},
    contactInfo: { website: '/services/automation-ai-helpdesk-automator', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950' },
    href: '/services/automation-ai-helpdesk-automator',
    category: 'automation',
    popular: false
  },
];

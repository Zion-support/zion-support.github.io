...
export const services: Service[] = ['
  {''
    ...
    features: [''
      ...
      'AI Chatbots',Automated Decision Making;
    ],
    pricing: {
      basic: 5000,
      pro: 15000,
    ...
    benefits: [''
      ...
      'Better Decision Making',Automated Processes',''
      'Improved Customer Experience',Competitive Advantage;
    ],'
    useCases: [''
...
''
      ...
      'Risk Mitigation',24/7 Monitoring',''
...
''
    ...
    features: [''
      ...
      'DevOps Implementation',Cloud Management',''
    ...
    benefits: [''
      ...
      'Global Reach',Reduced Maintenance;
    ],'
    useCases: [''
      'Application Hosting',Data Storage',''
      'Backup Solutions',Development Environments',''
      'Production Workloads',Hybrid Cloud;
    ],'
    technologies: [''
      'AWS',Azure',''
      'Google Cloud',Docker',''
  ...
  {''
    ...
    features: [''
      ...
      'Digital Strategy',Technology Adoption;
    ],
    pricing: {
      basic: 10000,
      pro: 30000,
    ...
    benefits: [''
      ...
      'Increased Agility',Cost Reduction',''
      'Competitive Advantage',Future-Ready Operations;
    ],'
    useCases: [''
      'Process Modernization',System Integration',''
      'Workflow Automation',Digital Strategy',''
      'Change Management',Technology Adoption;
    ],'
    technologies: [''
      'RPA',API Integration',''
      'Workflow Engines',Data Analytics',''
      'Cloud Platforms',Mobile Solutions',''
      'IoT Integration;
    ],'
    contactInfo: {''
      phone: '+1-302-464-0950',''
  ...
  {''
    ...
    icon: 'SignalIcon','
    features: [''
      'Network Implementation',IoT Connectivity',''
      'Mobile Optimization',Enterprise Services',''
    ...
    benefits: [''
      ...
      'Massive Connectivity',Enhanced Mobility',''
      'Edge Computing',Future-Ready Infrastructure;
    ],'
    useCases: [''
      'Smart Cities',Industrial IoT',''
      'Autonomous Vehicles',Remote Work',''
      'AR/VR Applications',Real-time Analytics;
    ],'
    technologies: [''
      '""5G"" NR',Edge Computing',''
      'Network Slicing',MEC',''
      'IoT Platforms',SDN/NFV',''
      'AI/ML;
    ],'
    contactInfo: {''
      phone: '+1-302-464-0950',''
  ...
  {''
    ...
    features: [''
      ...
      'Subscription Management',Scalable Architecture',''
      'Multi-tenancy',Analytics Dashboard;
    ],
    pricing: {
      basic: 8000,
      pro: 25000,
    ...
    benefits: [''
      'Rapid Deployment',Scalable Architecture',''
      'Cost-Effective',Easy Maintenance',''
      'Multi-tenant Support',Revenue Generation;
    ],'
    useCases: [''
      'Business Tools',Productivity Apps',''
      'Industry Solutions',API Services',''
      'Data Management',Automation Tools;
    ],'
    technologies: [''
      'React',Node.js',''
      'PostgreSQL',Redis',''

...
export const aiServices: Service[] = [
  ...
  },
  {
    ...
    title: 'AI Support Ticket Triage & Resolution',
    description: 'Auto classify, prioritize, resolve support tickets. Reads messages, matches knowledge base, suggests responses. Reduces resolution time 70%.',
    features: ['Auto classification', 'AI response suggestions', 'Auto-resolution for common issues', 'Sentiment analysis', 'Multi-channel', 'Agent assist', 'SLA tracking'],
    benefits: ['70% faster resolution', 'Auto-resolve 40-60% of issues', 'Better CSAT', 'Scale without hiring'],
    pricing: {basic: '$199/mo', pro: '$499/mo', enterprise: '$1299/mo'},
    contactInfo: {website: '/services/ai-support-ticket-triage', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950'},
    icon: 'ticket',
    href: '/services/ai-support-ticket-triage',
    popular: false,
    category: 'ai',
  ...
  },
  {
    ...
    description: 'Generate images and videos from text for marketing and social. Brand style training, upscaling, background removal, batch generation.',
    features: ['Text-to-image (multiple styles)', 'Text-to-video (up to 60s)', 'Brand style training', '4K upscaling', 'Background removal', 'Batch generation (100+)', 'Commercial license', 'API access'],
    benefits: ['20x faster visual production', 'Eliminate stock photos', 'Consistent brand style', '100+ images in minutes'],
  ...
  },
  {
    ...
    title: 'AI Content Studio - Automated Creation',
    description: 'AI-generated content for blogs, social, email, ads, product descriptions. Trained on brand voice. SEO optimization. 10x more content at 1/10th cost.',
    features: ['Blog post generation (2000+ words)', 'Social media content', 'Email campaign content', 'Product descriptions at scale', 'SEO optimization', 'Brand voice training', 'Content calendar', 'Performance analytics'],
    benefits: ['10x more content', 'Consistent brand voice', 'SEO-optimized', 'Free team for strategy'],
    pricing: {basic: '$99/mo', pro: '$249/mo', enterprise: '$499/mo'},
    contactInfo: {website: '/services/ai-content-studio', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950'},
    icon: 'pen',
  ...
  {
    id: 'ai-workflow-automation-intelligent',
    title: 'AI Workflow Automation - Intelligent',
    description: 'Automate business processes with AI that makes decisions, not just rules. Invoice processing, email routing, approvals, data entry. 100+ integrations.',
    features: ['Visual workflow builder', 'AI decision nodes', 'Document classification', 'Email routing', 'Approval workflows', '100+ integrations', 'Human-in-loop fallback', 'Analytics'],
    benefits: ['Automate 70% of back-office', 'AI adapts to changes', 'Process hours to minutes', 'Accuracy with human override'],
    pricing: {basic: '$299/mo', pro: '$699/mo', enterprise: '$1499/mo'},
    contactInfo: {website: '/services/ai-workflow-automation-intelligent', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950'},
    icon: 'cogs',
    href: '/services/ai-workflow-automation-intelligent',
    popular: false,
    category: 'ai',
    industry: 'Automation',
  },
,
  {
    ...
    description: 'Machine learning model that predicts which customers are at risk of leaving 30-60 days before they churn. Integrates with your CRM to trigger automated retention campaigns.',
    features: ['30-60 day churn prediction','CRM integration (Salesforce, HubSpot)','Churn reason analysis','Automated retention playbooks','Model retraining pipeline','Revenue impact dashboard'],
    benefits: ['Reduce churn by 25-40%','Save $50K+ in annual revenue','Proactive vs reactive retention','Understand WHY customers leave'],
  ...
  },
  {
    ...
    description: 'Extract structured data from any document type — contracts, invoices, IDs, forms — using advanced OCR + NLP. Processes thousands of documents per hour with 99%+ accuracy.',
    features: ['99%+ extraction accuracy','50+ pre-built document models','Custom model training','Human-in-the-loop validation','API for automation workflows','SOC 2 compliant processing'],
    benefits: ['Process docs 20x faster','Near-zero human error','Unlock data trapped in PDFs','Scale without hiring'],
  ...
  {
    id: 'ai-smart-pricing-optimizer',
    title: 'AI Smart Pricing Optimizer',
    description: 'Dynamic pricing engine that analyzes market conditions, competitor pricing, demand signals, and customer segments to recommend optimal prices in real-time.',
    features: ['Competitor price monitoring','Demand-based dynamic pricing','A/B price testing','Segment-specific pricing','Revenue impact simulator','E-commerce platform integration'],
    benefits: ['Increase revenue 5-15%','React to market changes instantly','Find the sweet spot per segment','Data-driven price decisions'],
    pricing: { basic:'199', pro:'499', enterprise:'1299' },
    contactInfo: { website:'/services/ai-smart-pricing-optimizer', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '💱',
    href: '/services/ai-smart-pricing-optimizer',
    popular: false,
    category: 'ai',
...
,
  {
    id: 'ai-semantic-search-engine',
    title: 'AI Semantic Search Engine',
    description: 'Enterprise search that understands meaning, not just keywords. Indexes documents, wikis, emails, and databases to find relevant information in seconds using natural language queries.',
    features: ["Natural language search","Multi-format document indexing","API for app integration","Access control by user role","Search analytics dashboard","Multi-language support"],
    benefits: ["Find information 10x faster","No more lost documents","Works with existing tools","Self-improving results"],
    pricing: { basic:'199', pro:'499', enterprise:'1499' },
    contactInfo: { website:'/services/ai-semantic-search-engine', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '🔍',
    href: '/services/ai-semantic-search-engine',
    popular: true,
    category: 'ai',
    industry: 'All Industries',
    stage: 'published',
  },
  {
    ...
    description: 'No-code platform to create intelligent chatbots for websites, WhatsApp, and social media. Train your bot on your knowledge base, handle FAQs automatically, and escalate to humans when needed.',
    features: ["No-code visual builder","Knowledge base training","Multi-channel (web, WhatsApp, Messenger)","Human handoff","Analytics dashboard","Multilingual support"],
    benefits: ["Reduce support tickets by 60%","24/7 customer engagement","Train once, deploy everywhere","Self-improving responses"],
...
export const itServices: Service[] = [
  ...
  {
    id: 'it-microsoft365-management',
    title: 'Microsoft 365 Management & Security',
    description: 'Complete M365 setup, migration, management, security. Exchange, Teams, SharePoint, OneDrive, Intune, Defender. Ongoing management and support.',
    features: ['Tenant setup and configuration', 'Email migration', 'Teams governance', 'SharePoint management', 'Intune device management', 'Defender hardening', 'User provisioning', 'Monthly reports'],
    benefits: ['Enterprise M365 from day one', 'Secure email', 'Organized Teams/SharePoint', 'Predictable costs'],
    pricing: {basic: '$1,200/mo', pro: '$2,500/mo', enterprise: '$5,000/mo'},
    contactInfo: {website: '/services/it-microsoft365-management', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950'},
    icon: 'office',
    href: '/services/it-microsoft365-management',
    popular: false,
    category: 'it',
  ...
  },
  {
    ...
    description: 'Database design, optimization, tuning for PostgreSQL, MySQL, MongoDB, Redis. Schema design, query optimization, indexing, migration.',
    features: ['Schema design and review', 'Query performance analysis', 'Indexing strategy', 'Connection pooling', 'Read replicas', 'Cross-platform migration', 'Backup strategy', 'Monitoring setup'],
    benefits: ['10-100x faster queries', '10x more traffic', 'Prevent outages', 'Reduce DB costs'],
    pricing: {basic: '$1,500/project', pro: '$3,500/project', enterprise: '$7,500/project'},
    contactInfo: {website: '/services/it-database-optimization', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950'},
    icon: 'database-gear',
    href: '/services/it-database-optimization',
    popular: false,
    category: 'it',
    industry: 'Data',
  },
,
  {
    id: 'it-managed-endpoint-protection',
    title: 'Managed Endpoint Protection & EDR',
    description: '24/7 endpoint detection and response for workstations, servers, and mobile devices. Monitors, isolates, and remediates threats automatically. Managed by our security team.',
    features: ['24/7 SOC monitoring','AI-powered threat detection','Automatic isolation & remediation','Device compliance reporting','Vulnerability patching','Remote wipe for lost devices'],
    benefits: ['Block 99.9% of malware','Mean time to respond: <15 min','Meet compliance requirements','Eliminate need for in-house SOC'],
    pricing: { basic:'12', pro:'25', enterprise:'45' },
    contactInfo: { website:'/services/it-managed-endpoint-protection', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '🛡️',
    href: '/services/it-managed-endpoint-protection',
    popular: true,
    category: 'it',
  ...
  },
  {
    ...
    description: 'Cloud-based disaster recovery that keeps your business running during outages, ransomware attacks, or natural disasters. Automated failover with under 1-hour RTO.',
    features: ['Automated failover & failback','Under 1-hour RTO guarantee','Ransomware recovery snapshots','Regular DR testing included','Multi-cloud support','Compliance-ready runbooks'],
    benefits: ['Survive any outage','Protect against ransomware','Minimize data loss (near-zero RPO','Sleep easy with automated recovery'],
    pricing: { basic:'199', pro:'499', enterprise:'1499' },
  ...
  {
    id: 'it-ner-risk-score-monitor',
    title: 'NIST & Cyber Risk Score Monitor',
    description: 'Continuously assess your security posture against NIST CSF, SOC 2, ISO 27001, and CIS benchmarks. Get a real-time risk score with prioritized remediation steps.',
    features: ['Real-time risk scoring','NIST CSF / SOC 2 / ISO 27001 mapping','Prioritized remediation plans','Executive dashboard','Compliance gap analysis','Third-party risk monitoring'],
    benefits: ['See your security score at a glance','Close critical gaps first','Avoid costly audit failures','Demonstrate due diligence to clients'],
    pricing: { basic:'99', pro:'299', enterprise:'799' },
    contactInfo: { website:'/services/it-nist-risk-score-monitor', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '📊',
    href: '/services/it-nist-risk-score-monitor',
    popular: false,
    category: 'it',
  ...
  {
    id: 'it-network-health-monitoring',
    title: 'Network Health & Performance Monitoring',
    description: '24/7 network monitoring for uptime, latency, bandwidth, and security. Covers on-premise, cloud, and hybrid environments with automated alerting.',
    features: ['24/7 uptime monitoring','Latency & heat mapping','Bandwidth usage analytics','Automated incident alerts','Cloud + on-prem coverage','Monthly executive reports'],
    benefits: ['99.9% network uptime','Identify bottlenecks before users notice','Reduce IT tickets by 40%','Capacity planning with real data'],
    pricing: { basic:'149', pro:'399', enterprise:'999' },
    contactInfo: { website:'/services/it-network-health-monitoring', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '◉',
    href: '/services/it-network-health-monitoring',
    popular: false,
    category: 'it',
    industry: 'All Industries',
    stage: 'published',
...
,
  {
    id: 'it-vciso-as-a-service',
    title: 'vCISO as a Service',
    description: 'Virtual Chief Information Security Officer for companies that need executive-level security leadership without the full-time hire. Includes security strategy, compliance, incident response planning, and board reporting.',
    features: ["Fractional CISO (10-40 hrs/month)","Security strategy & roadmap","Compliance management (SOC 2, ISO 27001, HIPAA)","Incident response planning","Vendor security assessments","Board-level security reporting"],
    benefits: ["80% cheaper than full-time CISO","Immediate expertise","No hiring overhead","Scales with your needs"],
    pricing: { basic:'2499', pro:'4999', enterprise:'9999' },
    contactInfo: { website:'/services/it-vciso-as-a-service', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '👔',
    href: '/services/it-vciso-as-a-service',
    popular: true,
    category: 'it',
    industry: 'All Industries',
    stage: 'published',
  ...
  {
    id: 'it-siem-as-a-service',
    title: 'SIEM as a Service',
    description: 'Security Information and Event Management without the enterprise price tag. 24/7 log monitoring, threat detection, and incident response for SMBs.',
    features: ["24/7 log collection & analysis","Real-time threat alerts","Compliance reporting (PCI DSS, HIPAA, SOC 2)","Incident response playbooks","Custom detection rules","Monthly security reports"],
    benefits: ["Enterprise-grade security for SMB prices","No hardware to manage","Immediate threat detection","Compliance-ready"],
    pricing: { basic:'499', pro:'1299', enterprise:'2999' },
    contactInfo: { website:'/services/it-siem-as-a-service', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '📊',
    href: '/services/it-siem-as-a-service',
    popular: false,
    category: 'it',
    industry: 'All Industries',
    stage: 'published',
...
export const cloudServices: Service[] = [
  ...
  {
    id: 'cloud-kubernetes-platform-eng',
    title: 'Kubernetes Platform Engineering',
    description: 'End-to-end K8s platform. Cluster provisioning, Helm charts, Prometheus/Grafana, ELK/Loki, Istio, developer portals.',
    features: ['Cluster provisioning (EKS, AKS, GKE)', 'Helm chart library', 'Prometheus + Grafana', 'Centralized logging', 'Istio service mesh', 'Developer portal', 'GitOps (ArgoCD/Flux)', 'Security policies'],
    benefits: ['Production K8s without complexity', 'GitOps deployments', 'Full observability', 'Secure by default'],
    pricing: {basic: '$1,500/mo', pro: '$3,500/mo', enterprise: '$7,500/mo'},
    contactInfo: {website: '/services/cloud-kubernetes-platform-eng', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950'},
    icon: 'k8s',
    href: '/services/cloud-kubernetes-platform-eng',
    popular: false,
    category: 'cloud',
    industry: 'Containers',
  },
,
  {
    id: 'cloud-cost-optimization-audit',
    title: 'Cloud Cost Optimization Audit & FinOps',
    description: 'Comprehensive audit of your AWS, Azure, or GCP spending. Identify waste, right-size resources, and implement reserved instance strategies. Average savings: 35%.',
    features: ['Multi-cloud cost analysis','Idle resource identification','Reserved instance strategy','Storage tier optimization','Monthly FinOps reports','Tagging governance'],
    benefits: ['Average 35% cost reduction','Eliminate waste immediately','Predictable monthly spending','Engineering team cost awareness'],
    pricing: { basic:'499', pro:'1499', enterprise:'3999' },
    contactInfo: { website:'/services/cloud-cost-optimization-audit', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '◌',
    href: '/services/cloud-cost-optimization-audit',
    popular: true,
    category: 'cloud',
    industry: 'All Industries',
    stage: 'published',
  },
  {
    ...
    description: 'Unified management across AWS, Azure, and GCP. Deploy, monitor, and optimize workloads from a single pane of glass with automated governance.',
    features: ['Single multi-cloud dashboard','Automated workload placement','Policy-based governance','Cost allocation by team/project','Security posture mgmt','Terraform/CloudFormation templates'],
    benefits: ['Avoid vendor lock-in','Best price per workload','Centralized security policies','Team-level cost accountability'],
    pricing: { basic:'349', pro:'999', enterprise:'2999' },
    contactInfo: { website:'/services/cloud-multi-cloud-orchestrator', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '☁️',
...
export const securityServices: Service[] = [
  ...
  {
    id: 'security-identity-access-mgmt',
    title: 'Identity & Access Management (IAM)',
    description: 'Centralized identity with SSO, MFA, RBAC, user lifecycle automation. 200+ app integrations.',
    features: ['SSO (SAML, OIDC)', 'Multi-Factor Auth (MFA)', 'Role-Based Access (RBAC)', 'User provisioning (SCIM)', 'Conditional access', 'Directory integration', 'Access reviews', 'Privileged access mgmt'],
    benefits: ['One login for all apps', 'Automated onboarding/offboarding', 'Meet compliance', 'Least-privilege enforcement'],
    pricing: {basic: '$3/user/mo', pro: '$7/user/mo', enterprise: '$15/user/mo'},
    contactInfo: {website: '/services/security-identity-access-mgmt', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950'},
    icon: 'key',
    href: '/services/security-identity-access-mgmt',
    popular: false,
    category: 'security',
    industry: 'Identity',
  },
,
  {
    id: 'sec-pentest-as-a-service',
    title: 'Penetration Testing as a Service (PTaaS)',
    description: 'Continuous manual + automated penetration testing by certified ethical hackers. Includes web apps, APIs, cloud infrastructure, and social engineering tests.',
    features: ['Certified OSCP/CEH testers','Web app + API testing','Cloud infrastructure testing','Social engineering simulations','Remediation guidance','Retest verification'],
    benefits: ['Find vulnerabilities before attackers','Meet compliance (PCI DSS, SOC 2)','Actionable remediation plans','Continuous — not just annual'],
    pricing: { basic:'999', pro:'2999', enterprise:'7999' },
    contactInfo: { website:'/services/sec-pentest-as-a-service', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '🔐',
    href: '/services/sec-pentest-as-a-service',
    popular: true,
    category: 'security',
    industry: 'All Industries',
    stage: 'published',
  ...
  {
    id: 'sec-zero-trust-architecture',
    title: 'Zero Trust Architecture Implementation',
    description: 'Design and implement a zero-trust security framework across your organization. Micro-segmentation, least-privilege access, continuous verification.',
    features: ['Identity-aware micro-segmentation','Least-privilege access design','Continuous device verification','Encrypted east-west traffic','Policy automation','Compliance mapping (NIST 800-207)'],
    benefits: ['Prevent lateral movement','Assume breach, verify everything','Simplify compliance audits','Secure remote workforce'],
    pricing: { basic:'2499', pro:'7499', enterprise:'Custom' },
    contactInfo: { website:'/services/sec-zero-trust-architecture', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '🔒',
    href: '/services/sec-zero-trust-architecture',
    popular: true,
    category: 'security',
    industry: 'All Industries',
    stage: 'published',
...
export const dataServices: Service[] = [
  ...
  },
  {
    ...
    description: 'Discover, catalog, govern data assets. Automated discovery, lineage tracking, quality scoring, access policies. 50+ source integrations.',
    features: ['Automated discovery', 'Data lineage (field-level)', 'Quality scoring', 'Business glossary', 'Column-level access', 'PII detection', 'Metadata API', '50+ source integrations'],
    benefits: ['Know your data and where', 'GDPR/CCPA lineage', 'Automated quality', 'Column-level control'],
    pricing: {basic: '$399/mo', pro: '$999/mo', enterprise: '$2,499/mo'},
    contactInfo: {website: '/services/data-catalog-governance-platform', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950'},
    icon: 'book',
    href: '/services/data-catalog-governance-platform',
    popular: false,
    category: 'data',
    industry: 'Governance',
  },
,
  {
    ...
    title: 'Data Lakehouse Architecture & Implementation',
    description: 'Modern data platform combining the best of data lakes and data warehouses. Support BI, ML, and real-time analytics on a single unified platform.',
    features: ['Delta Lake / Apache Iceberg setup','Batch + streaming ingestion','Data quality automation','Self-service BI layer','ML model registry','Cost-based query optimization'],
    benefits: ['One platform for all data workloads','Eliminate data silos','Sub-second query performance','Governance + flexibility'],
    pricing: { basic:'2999', pro:'7999', enterprise:'Custom' },
    contactInfo: { website:'/services/data-lakehouse-architecture', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '📊',
    href: '/services/data-lakehouse-architecture',
    popular: false,
    category: 'data',
    industry: 'All Industries',
    stage: 'published',
  ...
  {
    id: 'data-real-time-observability',
    title: 'Real-Time Data Observability Platform',
    description: 'Monitor data quality, freshness, and accuracy across your entire pipeline. Detect anomalies before they impact dashboards or ML models.',
    features: ['Data quality dashboards','Freshness & volume anomaly detection','Schema change alerts','Column-level lineage','Auto-remediation rules','Slack/PagerDuty integration'],
    benefits: ['Never trust bad data again','Detect pipeline issues in minutes','Ensure ML model accuracy','Reduce data team firefighting by 80%'],
    pricing: { basic:'199', pro:'549', enterprise:'1499' },
    contactInfo: { website:'/services/data-real-time-observability', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '📋',
    href: '/services/data-real-time-observability',
    popular: true,
    category: 'data',
    industry: 'All Industries',
    stage: 'published',
...
export const automationServices: Service[] = [
  ...
  {
    id: 'automation-rpa-desktop',
    title: 'Robotic Process Automation (RPA)',
    description: 'Automate repetitive desktop and web tasks. Clicks, types, copies between systems. Legacy app support. Reduces manual work 80%.',
    features: ['Visual designer (no code)', 'Web and desktop automation', 'Excel/CSV/PDF processing', 'Email automation', 'Database operations', 'ERP/SAP integration', 'Scheduled execution', 'Robot monitoring'],
    benefits: ['Automate 80% of repetitive work', 'Legacy system support', '24/7 error-free', 'ROI in 3 months'],
    pricing: {basic: '$499/mo', pro: '$1,299/mo', enterprise: '$2,999/mo'},
    contactInfo: {website: '/services/automation-rpa-desktop', email: 'kleber@ziontechgroup.com', phone: '+1 302 464 0950'},
    icon: 'robot-arm',
    href: '/services/automation-rpa-desktop',
    popular: false,
    category: 'automation',
    industry: 'RPA',
  },
,
  {
    id: 'auto-robotic-process-automation',
    title: 'Robotic Process Automation (RPA) Studio',
    description: 'Design, deploy, and manage software robots that automate repetitive business processes. From data entry to report generation — without changing existing systems.',
    features: ['Visual drag-and-drop robot builder','Screen scraping & OCR','Excel/ERP/CRM integration','Robot scheduling & orchestration','Exception handling workflows','Audit trail & compliance logs'],
    benefits: ['Automate 70% of repetitive tasks','Save 200+ hours per month','99.5% accuracy rate','Deploy in weeks, not months'],
    pricing: { basic:'199', pro:'599', enterprise:'1499' },
    contactInfo: { website:'/services/auto-robotic-process-automation', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '🤖',
    href: '/services/auto-robotic-process-automation',
    popular: true,
    category: 'automation',
    industry: 'All Industries',
    stage: 'published',
  ...
  {
    id: 'auto-intelligent-email-triage',
    title: 'Intelligent Email Triage & Response System',
    description: 'AI-powered email management that categorizes incoming messages, drafts responses, routes to the right team, and auto-resolves common inquiries.',
    features: ['Automatic categorization & priority scoring','Draft response suggestions','Smart routing to teams','Auto-resolution for FAQs','SLA tracking','Multi-language support'],
    benefits: ['Handle 3x more emails with same team','<2 hour average resolution time','Zero missed emails','Consistent response quality'],
    pricing: { basic:'99', pro:'249', enterprise:'699' },
    contactInfo: { website:'/services/auto-intelligent-email-triage', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '📧',
    href: '/services/auto-intelligent-email-triage',
    popular: false,
    category: 'automation',
    industry: 'Customer Support',
    stage: 'published',
...
export const microSaasServices: Service[] = [
  {
    id: 'micro-saas-crm-pipeline-manager',
    title: 'Micro-SAAS CRM & Pipeline Manager',
    description: 'Lightweight CRM designed for small-to-mid businesses. Track leads, manage deals, automate follow-ups, and forecast revenue without the complexity of enterprise CRM.',
    features: ['Visual drag-and-drop pipeline','Email sequencing & templates','Lead scoring automation','Revenue forecasting dashboard','Calendar & task sync','Custom deal stages'],
    benefits: ['Close 30% more deals','Never miss a follow-up','Clear revenue visibility','15-min setup — no training needed'],
    pricing: { basic:'29', pro:'79', enterprise:'199' },
    contactInfo: { website:'/services/micro-saas-crm-pipeline-manager', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '📊',
    href: '/services/micro-saas-crm-pipeline-manager',
    popular: true,
    category: 'micro-saas',
    industry: 'Sales',
    stage: 'published',
  ...
  {
    id: 'micro-saas-subscription-billing-engine',
    title: 'Micro-SAAS Subscription Billing Engine',
    description: 'Recurring billing platform for SaaS businesses. Handles subscription management, invoicing, dunning, tax compliance, and revenue recognition.',
    features: ['Automated recurring invoicing','Dunning management','Proration & plan changes','Stripe/Tax API integrations','Revenue recognition reports','Customer self-service portal'],
    benefits: ['Eliminate billing errors','Recover 40% of failed payments','Automate tax compliance','Real-time MRR/ARR dashboards'],
    pricing: { basic:'49', pro:'149', enterprise:'499' },
    contactInfo: { website:'/services/micro-saas-subscription-billing-engine', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '💳',
    href: '/services/micro-saas-subscription-billing-engine',
    popular: true,
    category: 'micro-saas',
    industry: 'SaaS',
    stage: 'published',
  },
  {
    ...
    title: 'Micro-SAAS Employee Onboarding Portal',
    description: 'Digital onboarding platform that automates new hire paperwork, training checklists, equipment requests, and buddy assignments. Reduces onboarding time by 60%.',
    features: ['Digital document signing','Automated task checklists','Training module tracker','Equipment & access requests','Progress dashboard for HR','Buddy/mentor matching'],
    benefits: ['60% faster onboarding','Zero paperwork errors','Consistent new hire experience','HR team saves 10+ hours per hire'],
  ...
  },
  {
    ...
    title: 'Micro-SAAS Customer Feedback Analytics',
    description: 'Collect, analyze, and act on customer feedback from surveys, reviews, support tickets, and social media. AI identifies trends and sentiment in real-time.',
    features: ['Multi-channel feedback collection','AI sentiment analysis','NPS/CSAT tracking','Trend detection & alerts','Automated response suggestions','Export to PDF/PowerPoint'],
    benefits: ['Increase NPS by 20+ points','Identify issues before they escalate','Data-driven product decisions','Close the feedback loop automatically'],
    pricing: { basic:'49', pro:'129', enterprise:'349' },
    contactInfo: { website:'/services/micro-saas-feedback-analytics', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '📣',
    href: '/services/micro-saas-feedback-analytics',
    popular: false,
    category: 'micro-saas',
    industry: 'Customer Success',
    stage: 'published',
  },
  {
    ...
    title: 'Micro-SAAS Project Timeline & Gantt Tracker',
    description: 'Visual project planning with Gantt charts, resource allocation, and deadline tracking. Built for agencies and small teams that need clarity, not complexity.',
    features: ['Drag-and-drop Gantt charts','Resource workload view','Milestone tracking','Client-facing timeline sharing','Slack/Teams notifications','Budget vs. actual hours'],
    benefits: ['95% on-time delivery','Real-time stakeholder visibility','Eliminate status meetings','Accurate project costing'],
    pricing: { basic:'19', pro:'59', enterprise:'179' },
...
,
  {
    id: 'msaas-estimate-quote-builder',
    title: 'Estimate & Quote Builder',
    description: 'Professional estimate and quote creation tool for service businesses. Create branded quotes, track acceptance rates, and integrate with Stripe for instant payment.',
    features: ["Drag-and-drop quote builder","Branded templates","E-signature acceptance","Stripe payment integration","Quote analytics","CRM sync (HubSpot, Salesforce)"],
    benefits: ["Close 40% more quotes","Get paid instantly","Professional appearance","Track what works"],
    pricing: { basic:'29', pro:'79', enterprise:'199' },
    contactInfo: { website:'/services/msaas-estimate-quote-builder', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '📄',
    href: '/services/msaas-estimate-quote-builder',
    popular: false,
    category: 'microSaas',
  ...
  {
    id: 'msaas-review-manager',
    title: 'Review Management Platform',
    description: 'Collect, monitor, and respond to online reviews across Google, Yelp, and industry-specific sites. AI-powered response suggestions and reputation analytics.',
    features: ["Multi-platform review monitoring","AI response suggestions","Automated review requests (SMS/Email)","Reputation score tracking","Competitor comparison","Team collaboration"],
    benefits: ["Improve ratings automatically","Never miss a negative review","Get more 5-star reviews","Track reputation over time"],
    pricing: { basic:'39', pro:'99', enterprise:'249' },
    contactInfo: { website:'/services/msaas-review-manager', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '⭐',
    href: '/services/msaas-review-manager',
    popular: false,
    category: 'microSaas',
    industry: 'All Industries',
    stage: 'published',
...
export const devOpsServices: Service[] = [
  {
    id: 'devops-gitops-deployment-pipeline',
    title: 'GitOps Deployment Pipeline',
    description: 'End-to-end CI/CD using Git as the single source of truth. Every change is versioned, reviewed, and deployed automatically. Supports Kubernetes, ECS, and VMs.',
    features: ['Git-triggered deployments','Automated canary analysis','Rollback in <30 seconds','Infrastructure-as-Code (Terraform/Pulumi)','Secrets management','Multi-environment promotion'],
    benefits: ['Deploy 10x faster','Zero-downtime deployments','Full audit trail','Consistent environments'],
    pricing: { basic:'149', pro:'449', enterprise:'1299' },
    contactInfo: { website:'/services/devops-gitops-deployment-pipeline', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '⚙️',
    href: '/services/devops-gitops-deployment-pipeline',
    popular: true,
    category: 'devops',
    industry: 'Technology & SaaS',
    stage: 'published',
  ...
  {
    id: 'devops-sre-reliability-as-a-service',
    title: 'Site Reliability Engineering (SRE) as a Service',
    description: 'Dedicated SRE team that manages your production systems. We set SLIs/SLOs, handle on-call, run incident post-mortems, and continuously improve reliability.',
    features: ['24/7 on-call coverage','SLI/SLO definition & tracking','Incident post-mortem automation','Error budget management','Chaos engineering exercises','Monthly reliability reports'],
    benefits: ['Achieve 99.99% uptime','Reduce MTTR by 60%','Focus engineering on features, not incidents','Data-driven reliability decisions'],
    pricing: { basic:'2499', pro:'5999', enterprise:'Custom' },
    contactInfo: { website:'/services/devops-sre-reliability-as-a-service', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '📊',
    href: '/services/devops-sre-reliability-as-a-service',
    popular: false,
    category: 'devops',
    industry: 'Technology & SaaS',
    stage: 'published',
...
,
  {
    ...
    title: 'Infrastructure as Code (IaC) Studio',
    description: 'Visual infrastructure management using Terraform, Pulumi, and AWS CloudFormation. Provision, manage, and version control your cloud infrastructure with a visual interface.',
    features: ["Visual infrastructure designer","Terraform/Pulumi/CloudFormation","Drift detection","Cost estimation before deploy","Version control integration","Multi-cloud support"],
    benefits: ["Provision in minutes, not days","Prevent configuration drift","See costs before deploying","Full audit trail"],
    pricing: { basic:'299', pro:'799', enterprise:'1999' },
  ...
  {
    id: 'devops-cicd-pipeline-builder',
    title: 'CI/CD Pipeline Builder',
    description: 'Visual CI/CD pipeline creation for GitHub, GitLab, and Bitbucket. Build, test, and deploy automatically with pre-built templates for any tech stack.',
    features: ["Visual pipeline designer","50+ pre-built templates","Docker/K8s deployment","Automated testing integration","Rollback on failure","Deployment analytics"],
    benefits: ["Deploy 10x faster","Zero-downtime deployments","Catch bugs before production","Full deployment visibility"],
    pricing: { basic:'99', pro:'299', enterprise:'799' },
    contactInfo: { website:'/services/devops-cicd-pipeline-builder', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '🔄',
    href: '/services/devops-cicd-pipeline-builder',
    popular: false,
    category: 'devops',
    industry: 'Technology & SaaS',
    stage: 'published',
...
export const blockchainServices: Service[] = [
  {
    ...
    description: 'Comprehensive security audit of Ethereum, Solana, or Polygon smart contracts. Manual review + automated tools. Includes gas optimization recommendations.',
    features: ['Manual code review','Automated vulnerability scanning (Slither, Mythril)','Gas optimization report','Front-running protection analysis','Access control review','Detailed PDF report with severity ratings'],
    benefits: ['Prevent multi-million dollar exploits','Meet investor due diligence requirements','Optimize gas costs by 20-40%','Deploy with confidence'],
    pricing: { basic:'1499', pro:'3999', enterprise:'9999' },
    contactInfo: { website:'/services/blockchain-smart-contract-audit', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '⛓️',
    href: '/services/blockchain-smart-contract-audit',
    popular: false,
    category: 'blockchain',
    industry: 'Web3 & DeFi',
    stage: 'published',
  },
  {
    ...
    title: 'NFT Marketplace Builder & Launchpad',
    description: 'End-to-end NFT marketplace development — minting, bidding, auctions, royalty management, and wallet integration. White-label ready.',
    features: ['Smart contract development (ERC-721/1155)','Minting & auction engine','Wallet integration (MetaMask, WalletConnect)','Admin dashboard','Royalty management','Analytics & reporting'],
    benefits: ['Launch in 4-6 weeks','Custom branded marketplace','No technical team needed','Built-in royalty distribution'],
    pricing: { basic:'2999', pro:'7999', enterprise:'Custom' },
...
,
  { id: 'blockchain-token-launchpad', title: 'Token Launchpad & ICO Platform', description: 'End-to-end platform for launching utility tokens and ICOs. Includes smart contract development, KYC/AML verification, and investor dashboard.', features: ["ERC-20/BEP-20 token creation","Smart contract audit","KYC/AML integration","Investor dashboard","Vesting schedules","Multi-chain deployment"], benefits: ["Launch token in days, not months","Built-in compliance","Investor-ready platform","Multi-chain flexibility"], pricing: { basic:'2499', pro:'5999', enterprise:'Custom' }, contactInfo: { website:'/services/blockchain-token-launchpad', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' }, icon: '🚀', href: '/services/blockchain-token-launchpad', popular: false, category: 'blockchain', industry: 'Web3 & DeFi', stage: 'published', }
];


export const iotServices: Service[] = [
  {
    id: 'iot-predictive-maintenance-platform',
    title: 'IoT Predictive Maintenance Platform',
    description: 'Sensor data analytics that predicts equipment failures before they happen. Reduce unplanned downtime by 50% and extend asset life. Works with any industrial equipment.',
    features: ['Real-time sensor monitoring','ML-based failure prediction','Maintenance scheduling optimization','Historical trend analysis','Mobile alerts for technicians','ERP/CMMS integration'],
    benefits: ['50% reduction in unplanned downtime','Extend equipment life 20-30%','Data-driven parts inventory','ROI typically within 6 months'],
    ...
    icon: '📡',
    href: '/services/iot-predictive-maintenance-platform',
    popular: true,
    category: 'iot',
  ...
  {
    id: 'iot-smart-building-energy-optimizer',
    title: 'Smart Building Energy Optimizer',
    description: 'IoT-based energy management for commercial buildings. Automatically adjusts HVAC, lighting, and equipment based on occupancy, weather, and utility rates. Average savings: 25%.',
    features: ['Occupancy-based HVAC control','Utility rate optimization','Solar/battery integration','Carbon footprint tracking','Tenant comfort monitoring','Monthly energy reports'],
    benefits: ['25% energy cost reduction','Reduce carbon footprint','Improve tenant comfort','Remote building management'],
    pricing: { basic:'349', pro:'999', enterprise:'2999' },
    contactInfo: { website:'/services/iot-smart-building-energy-optimizer', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' },
    icon: '🏢',
    href: '/services/iot-smart-building-energy-optimizer',
    popular: false,
    category: 'iot',
...
,
  { id: 'iot-fleet-management-platform', title: 'Fleet Management & GPS Tracking', description: 'Real-time GPS tracking and fleet management for vehicle fleets.', features: ["Real-time GPS tracking","Route optimization","Fuel consumption monitoring","Driver behavior scoring","Maintenance scheduling","Geofencing alerts"], benefits: ["Reduce fuel costs by 20%","Improve driver safety","Optimize routes automatically","Extend vehicle lifespan"], pricing: { basic:'49', pro:'99', enterprise:'199' }, contactInfo: { website:'/services/iot-fleet-management-platform', email:'kleber@ziontechgroup.com', phone:'+1 302 464 0950' }, icon: '🚚', href: '/services/iot-fleet-management-platform', popular: false, category: 'iot', industry: 'Logistics & Transportation', stage: 'published', }
];

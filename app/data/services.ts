...
export const microSAASServices = [
  ...
  {title: 'AI Project Manager Pro',
    description: 'Intelligent project planning with AI-powered resource optimization, timeline prediction, and risk assessment. Trusted by 10,000+ teams worldwide.',;    icon: 'bar-chart',
    price: '$99/month',
  ...
  {title: 'AI Meeting Assistant Pro',
    description: 'Revolutionary meeting management with real-time transcription, action item extraction, and intelligent follow-ups. Used by Fortune 500 companies.',;    icon: 'target',
    price: '$79/month',
  ...
  {title: 'AI Document Intelligence Pro',
    description: 'Transform any document into actionable insights with AI-powered analysis, summarization, and knowledge extraction.',;    icon: '📄',
    price: '$89/month',
  ...
  {title: 'AI Personal Assistant Pro',
    description: 'Your intelligent personal assistant that manages emails, schedules, and tasks with natural language processing.',;    icon: '🤖',
    price: '$49/month',
  ...
  {title: 'AI Team Collaboration Hub',
    description: 'Advanced team collaboration platform with AI-powered insights, smart notifications, and productivity analytics.',;    icon: 'users',
    price: '$99/month',
    originalPrice: '$149/month',
  ...
  {title: 'AI Task Manager Pro',
    description: 'Smart task management with AI prioritization, deadline prediction, and productivity insights. Boost your productivity by 60%.',;    icon: 'check',
    price: '$49/month',
    originalPrice: '$79/month',
  ...
  {title: 'AI Workflow Automation Pro',    icon: '📅',
    price: '$39/month',
  ...
  {title: 'AI Time Tracker Pro',
    description: 'Intelligent time tracking with productivity insights, automated reporting, and team analytics. Trusted by remote teams globally.',;    icon: '⏱️',
    price: '$34/month',
  ...
  {title: 'AI Content Writer Pro',
    description: 'Advanced AI content creation with SEO optimization, brand voice consistency, and multi-language support. Generate 10 x more content.',;    icon: '✍️',
    price: '$89/month',
    originalPrice: '$129/month',
  ...
  {title: 'AI Video Creator Pro',
    description: 'Professional video creation with AI-powered editing, voice synthesis, and automated production. Create studio-quality videos in minutes.',;    icon: 'film',
    price: '$149/month',
  ...
  {title: 'AI Podcast Studio Pro',
    description: 'Complete podcast production suite with AI-powered editing, transcription, and distribution. Launch your podcast in 24 hours.',;    icon: '🎙️',
    price: '$79/month',
    originalPrice: '$119/month',
  ...
  {title: 'AI Graphic Design Studio',
    description: 'Professional graphic design with AI-powered tools, templates, and brand consistency. Create stunning visuals without design skills.',;    icon: 'palette',
    price: '$69/month',
  ...
  {title: 'AI Website Builder Pro',
    description: 'Intelligent website builder with AI-powered design, content generation, and SEO optimization. Launch your site in minutes.',;    icon: 'globe',
    price: '$89/month',
    originalPrice: '$129/month',
  ...
  {title: 'AI Social Media Manager Pro',
    description: 'Automated social media management with AI-powered content creation, scheduling, and analytics. Grow your audience by 300%.',;    icon: 'smartphone',
    price: '$69/month',
    originalPrice: '$99/month',
  ...
  {title: 'AI Email Marketing Suite',
    description: 'Intelligent email marketing with AI-powered personalization, A/B testing, and automation. Increase open rates by 150%.',;    icon: 'Email:',
    price: '$59/month',
  ...
  {title: 'AI SEO Optimizer Pro',
    description: 'Advanced SEO optimization with AI-powered keyword research, content analysis, and ranking tracking. Boost organic traffic by 200%.',;    icon: 'search',
    price: '$79/month',
    originalPrice: '$119/month',
  ...
  {title: 'AI Lead Generation Pro',
    description: 'Automated lead generation with AI-powered prospecting, qualification, and nurturing. Generate 5 x more qualified leads.',;    icon: '🎯',
    price: '$99/month',
    originalPrice: '$149/month',
...
export const aiServices = [
  {title: 'Machine Learning Solutions',
    description: 'Custom ML models for predictive analytics, decision-making, and intelligent automation. Trusted by Fortune 500 companies.',;    icon: Brain,
    price: '$1,500/month',
...
export const services: Service[] = [,
  ...
  {id: 'ai-project-manager',
    ...
    pricing: {,  email: 'kleber@ziontechgroup.com',

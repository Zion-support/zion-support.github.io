...
export const services: Service[] = [
  // AI Services
  {
    ...
    features: [
      'AI-powered task prioritization', 'Automated resource allocation',
    ...
    benefits: [
      '40% faster project delivery', '25% reduction in project costs',
  ...
  },
  {
    ...
    features: [
      'Natural language understanding', 'Multi-language support (50+ languages)',
    ...
    benefits: [
      '80% reduction in response time', '24/7 availability',
      '90% customer satisfaction rate',
      '60% cost reduction vs human agents'
    ],
    useCases: [
      'E-commerce customer support', 'SaaS product support',
  ...
  },
  {
    ...
    features: [
      'Multi-format content generation', 'SEO optimization',
    ...
    benefits: [
      '10x faster content creation', 'Consistent brand messaging',
      'SEO-optimized content',
      'Multi-language support'
    ],
    useCases: [
      'Blog content creation', 'Social media marketing',
  ...
  },
  {
    ...
    benefits: [
      '50% faster insights generation', 'Predictive accuracy up to 95%',
  ...
  },
  {
    ...
    benefits: [
      '99.9% threat detection accuracy', '50% faster incident response',
  ...
  // Micro SAAS Services
  {
    ...
    features: [
      'Multi-platform posting', 'AI content suggestions',
    ...
    benefits: [
      '3x more engagement', 'Save 15 hours/week',
  ...
  },
  {
    ...
    features: [
      'AI-powered segmentation', 'Personalized content',
    ...
    benefits: [
      '40% higher open rates', '60% increase in click-through rates',
      'Automated campaign optimization',
      'Personalized customer journeys'
    ],
    useCases: [
      'E-commerce marketing', 'Newsletter campaigns',
      'Lead nurturing',
      'Customer retention'
    ],
    icon: '📧'
  ...
  },
  {
    ...
    features: [
      'AI keyword research', 'Content optimization suggestions',
      'Competitor analysis',
      'Ranking tracking',
      'Technical SEO audit',
    ...
    benefits: [
      '50% faster SEO results', 'Comprehensive keyword analysis',
      'Automated optimization suggestions',
      'Competitive advantage insights'
    ],
    useCases: [
      'Website optimization', 'Blog content SEO',
      'E-commerce SEO',
      'Local business SEO'
    ],
    icon: '🎯'
  ...
  },
  {
    ...
    features: [
      'Automated invoice creation', 'AI data extraction',
      'Payment tracking',
      'Recurring billing',
    ...
    benefits: [
      '90% time savings on invoicing', 'Reduced billing errors',
      'Faster payment processing',
      'Professional invoice templates'
    ],
    useCases: [
      'Freelancer billing', 'Small business invoicing',
  ...
  },
  {
    ...
    features: [
      'Automatic time tracking', 'AI productivity insights',
    ...
    benefits: [
      'Accurate time tracking', 'Productivity optimization',
      'Project profitability analysis',
      'Team performance insights'
    ],
    useCases: [
      'Freelancer time tracking', 'Team productivity monitoring',
      'Project billing',
  ...
  // IT Services
  {
    ...
    features: [
      'Multi-cloud deployment', 'Auto-scaling capabilities',
      'Disaster recovery',
      'Security compliance',
    ...
    benefits: [
      '99.9% uptime guarantee', '50% cost reduction vs on-premise',
      'Instant scalability',
      'Enhanced security'
    ],
    useCases: [
  ...
  },
  {
    ...
    features: [
      'Network security monitoring', 'Endpoint protection',
      'Email security',
    ...
    benefits: [
      '360-degree security coverage', 'Compliance with industry standards',
      '24/7 security monitoring',
      'Rapid threat response'
    ],
    useCases: [
      'Enterprise security', 'Healthcare compliance',
      'Financial services',
      'Government agencies'
    ],
    icon: '🛡️'
  ...
  },
  {
    ...
    benefits: [
      '10x faster deployments', 'Reduced deployment errors',
      'Automated testing',
      'Improved team productivity'
    ],
    useCases: [
      'Software development', 'Microservices deployment',
      'Cloud migration',
  ...
  },
  {
    ...
    benefits: [
      'Improved database performance', 'Data security and compliance',
      'Reduced downtime',
      'Expert database administration'
    ],
    useCases: [
      'Enterprise databases', 'E-commerce platforms',
      'Data analytics',
  ...
  // Emerging Technologies
  {
    ...
    features: [
      'Quantum algorithm development', 'Optimization problems',
    ...
    benefits: [
      'Exponential computational power', 'Revolutionary problem solving',
  ...
  },
  {
    ...
    features: [
      'Smart contract development', 'DeFi platform creation',
    ...
    benefits: [
      'Decentralized solutions', 'Enhanced security',
      'Transparency and trust',
      'Future of digital assets'
    ],
    useCases: [
      'DeFi applications', 'NFT marketplaces',
  ...
  },
  {
    ...
    features: [
      'IoT device management', 'Edge computing infrastructure',

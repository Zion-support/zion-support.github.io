import {
  Brain, Shield, Stethoscope, DollarSign, Truck, FileText, Factory, GraduationCap, MessageSquare, Settings, BarChart, Eye, CreditCard, Cloud, Building, Database, Lock, Code, Smartphone, Settings as SettingsIcon, Target, Zap, BarChart as BarChartIcon, Users, Globe, Cpu, Lock as LockIcon  
} from 'lucide-react'
...
export const services: Service[] = [
  ...
  'Customer Support Automation',
    ...
    technologies: [
  'OpenAI GPT-4', 'TensorFlow', 'React', 'Node.js', 'MongoDB', 'WebSocket'
],
  ...
  'Invoice Processing',
    ...
    technologies: [
  'Tesseract OCR', 'AWS Textract', 'Python', 'FastAPI', 'PostgreSQL', 'Redis'
],
  ...
  'Lead Generation',
    ...
    technologies: [
  'React', 'TypeScript', 'Node.js', 'MongoDB', 'Stripe', 'SendGrid'
],
  ...
  'Smart Home Control',
    ...
    technologies: [
  'Google Speech API', 'Amazon Polly', 'WebRTC', 'Node.js', 'WebSocket', 'TensorFlow'
],
  ...
  'Payment Fraud',
    ...
    technologies: [
  'TensorFlow', 'Scikit-learn', 'Python', 'FastAPI', 'Redis', 'PostgreSQL'
],
  ...
  'Quality Control',
    ...
    technologies: [
  'OpenCV', 'TensorFlow', 'PyTorch', 'Python', 'FastAPI', 'AWS S3'
],
  ...
  'Cryptocurrency Exchanges',
    ...
    technologies: [
  'Solidity', 'Web3.js', 'Ethereum', 'Polygon', 'IPFS', 'MetaMask'
],
  ...
  'Smart Cities',
    ...
    technologies: [
  'MQTT', 'Node.js', 'Python', 'MongoDB', 'Grafana', 'InfluxDB'
],
  ...
  'Sales Teams',
    ...
    technologies: [
  'Python', 'Scikit-learn', 'TensorFlow', 'React', 'Node.js', 'PostgreSQL'
],
  ...
  'Manufacturing',
    ...
    technologies: [
  'Python', 'TensorFlow', 'IoT Sensors', 'Time Series Analysis', 'React', 'Node.js'
],
  ...
  'E-commerce',
    ...
    technologies: [
  'Python', 'Machine Learning', 'React', 'Node.js', 'Redis', 'PostgreSQL'
],
  ...
  'Office Scheduling',
    ...
    technologies: [
  'React', 'Node.js', 'Calendar APIs', 'Machine Learning', 'PostgreSQL', 'Redis'
],
  ...
  'Sales Teams',
    ...
    technologies: [
  'Python', 'Machine Learning', 'React', 'Node.js', 'Salesforce API', 'PostgreSQL'
],
  ...
  'Business Intelligence',
    ...
    technologies: [
  'D3.js', 'React', 'Python', 'Machine Learning', 'Node.js', 'PostgreSQL'
],
  ...
  'Email Marketing',
    ...
    technologies: [
  'Python', 'Machine Learning', 'React', 'Node.js', 'Email APIs', 'PostgreSQL'
],
  ...
  'Social Media Marketing',
    ...
    technologies: [
  'React', 'Node.js', 'Social Media APIs', 'MongoDB', 'Redis', 'AWS'
],
  ...
  'Personal Finance',
    ...
    technologies: [
  'React', 'Node.js', 'OCR Technology', 'Machine Learning', 'PostgreSQL', 'AWS'
],
  ...
  'Project Management',
    ...
    technologies: [
  'React', 'Node.js', 'Machine Learning', 'PostgreSQL', 'Redis', 'WebSocket'
],
  ...
  'Content Marketing',
    ...
    technologies: [
  'OpenAI GPT-4', 'DALL-E', 'React', 'Node.js', 'MongoDB', 'AWS'
],
  ...
  'Website Localization',
    ...
    technologies: [
  'Google Translate API', 'OpenAI', 'React', 'Node.js', 'MongoDB', 'Redis'
],
  ...
  'Marketing Videos',
    ...
    technologies: [
  'OpenAI Sora', 'FFmpeg', 'React', 'Node.js', 'AWS S3', 'WebRTC'
],
  ...
  'Podcast Production',
    ...
    technologies: [
  'Web Audio API', 'FFmpeg', 'OpenAI Whisper', 'React', 'Node.js', 'AWS'
],
  ...
  'Application Databases',
    ...
    technologies: [
  'PostgreSQL', 'MySQL', 'MongoDB', 'Redis', 'AWS RDS', 'Docker'
],
  ...
  'Corporate Networks',
    ...
    technologies: [
  'Cisco', 'Juniper', 'Fortinet', 'AWS', 'Azure', 'Docker'
],
  ...
  'Web Applications',
    ...
    technologies: [
  'OWASP', 'Nmap', 'Burp Suite', 'Metasploit', 'Nessus', 'Custom Tools'
],
  ...
  'Financial Modeling',
    ...
    technologies: [
  'Qiskit', 'Cirq', 'Q#', 'Python', 'Quantum Hardware', 'Cloud Quantum'
],
  ...
  'IoT Applications',
    ...
    technologies: [
  'Kubernetes', 'Docker', 'AWS Edge', 'Azure Edge', 'Google Edge', '5G'
],
  ...
  'Retail & E-commerce',
    ...
    technologies: [
  'Unity', 'ARCore', 'ARKit', 'WebXR', 'React Native', 'Unreal Engine'
],
  ...
  'Training & Simulation',
    ...
    technologies: [
  'Unity', 'Unreal Engine', 'Oculus SDK', 'SteamVR', 'WebXR', 'OpenXR'
],
  ...
  'Data Entry',
    ...
    technologies: [
  'UiPath', 'Automation Anywhere', 'Blue Prism', 'Python', 'RPA Tools', 'APIs'
],
  ...
  'Web Applications',
    ...
    technologies: [
  'AWS Lambda', 'Azure Functions', 'Google Cloud Functions', 'Node.js', 'Python', 'Docker'
],
  ...
  'Microservices',
    ...
    technologies: [
  'Kubernetes', 'Docker', 'Helm', 'Prometheus', 'Grafana', 'Istio'
],
  ...
  'Machine Learning',
    ...
    technologies: [
  'NVIDIA GPUs', 'Kubernetes', 'TensorFlow', 'PyTorch', 'Docker', 'AWS'
],
  ...
  'Big Data Analytics',
    ...
    technologies: [
  'Apache Spark', 'Hadoop', 'AWS S3', 'Apache Kafka', 'Elasticsearch', 'Kubernetes'
],
  ...
  'Law Firms',
    ...
    technologies: [
  'OpenAI GPT-4', 'Legal Databases', 'NLP', 'Python', 'React', 'PostgreSQL'
],
  ...
  'Hospitals',
    ...
    technologies: [
  'Medical AI', 'NLP', 'Machine Learning', 'Python', 'React', 'HIPAA Compliance'
],
  ...
  'K-12 Education',
    ...
    technologies: [
  'Machine Learning', 'NLP', 'React', 'Node.js', 'MongoDB', 'Video Streaming'
],
  ...
  'Real Estate Agents',
    ...
    technologies: [
  'Machine Learning', 'Real Estate APIs', 'Python', 'React', 'PostgreSQL', 'Maps API'
],
  ...
  'Manufacturing',
    ...
    technologies: [
  'Machine Learning', 'Optimization Algorithms', 'Python', 'React', 'PostgreSQL', 'IoT'
],
  ...
  'Game Development',
    ...
    technologies: [
  'NeRF', 'Blender', 'Unity', 'React', 'Node.js', 'AWS'
],
  ...
  'Enterprise Support',
    ...
    technologies: [
  'OpenAI GPT-4', 'Custom Models', 'React', 'Node.js', 'Kubernetes', 'AWS'
],
  ...
  'Software Development',
    ...
    technologies: [
  'OpenAI Codex', 'GitHub Copilot', 'VS Code', 'Python', 'JavaScript', 'Docker'
],
  ...
  'Social Media',
    ...
    technologies: [
  'Computer Vision', 'NLP', 'Machine Learning', 'React', 'Node.js', 'AWS'
],
  ...
  'E-commerce',
    ...
    technologies: [
  'OpenAI GPT-4', 'Sentiment Analysis', 'React', 'Node.js', 'PostgreSQL', 'Redis'
],
  ...
  'Business Processes',
    ...
    technologies: [
  'Workflow Engines', 'Machine Learning', 'React', 'Node.js', 'PostgreSQL', 'Docker'
],
  ...
  'E-commerce',
    ...
    technologies: [
  'Machine Learning', 'Email APIs', 'React', 'Node.js', 'PostgreSQL', 'Redis'
],
  ...
  'Investment Firms',
    ...
    technologies: [
  'Financial AI', 'Machine Learning', 'Python', 'React', 'PostgreSQL', 'Financial APIs'
],
  ...
  'Sales Teams',
    ...
    technologies: [
  'Machine Learning', 'Time Series', 'Python', 'React', 'PostgreSQL', 'Sales APIs'
],
  ...
  'Global Businesses',
    ...
    technologies: [
  'Advanced NLP', 'Custom Models', 'React', 'Node.js', 'MongoDB', 'Cloud Translation'
],
  ...
  'Voice Assistants',
    ...
    technologies: [
  'Advanced TTS', 'Neural Networks', 'React', 'Node.js', 'Audio Processing', 'Cloud APIs'
],
...
export const microSAASServices = [
  ...
  title: 'AI Project Manager Pro',
    ...
    benefits: [
  '40% productivity increase', '70% fewer delays', '85% planning accuracy', '30% cost reduction'
],
  ...
  title: 'AI Meeting Assistant Pro',
    ...
    features: [
  'Real-time transcription', 'Action item extraction', 'Meeting summaries', 'Follow-up automation', 'Calendar integration', 'Voice recognition', 'Multi-language support', 'Meeting analytics'
],
    benefits: [
  '90% meeting efficiency', 'Zero missed action items', 'Automatic follow-ups', 'Better meeting outcomes'
],
  ...
  title: 'AI Document Intelligence Pro',
    ...
    features: [
  'Document analysis', 'Smart summarization', 'Knowledge extraction', 'Search & discovery', 'Version control', 'Collaboration tools', 'OCR processing', 'Multi-format support'
],
    benefits: [
  '80% faster document processing', 'Better knowledge retention', 'Improved search', 'Enhanced collaboration'
],
  ...
  title: 'AI Personal Assistant Pro',
    ...
    features: [
  'Email management', 'Smart scheduling', 'Task automation', 'Voice commands', 'Calendar sync', 'Reminder system', 'Travel planning', 'Expense tracking'
],
    benefits: [
  '50% time savings', 'Never miss important tasks', 'Better organization', 'Reduced stress'
],
  ...
  title: 'AI Team Collaboration Hub',
    ...
    originalPrice: '$149/month',
    features: [
  'Team analytics', 'Smart notifications', 'Project tracking', 'Communication tools', 'File sharing', 'Video conferencing', 'Task management', 'Performance insights'
],
    benefits: [
  '35% team productivity increase', 'Better communication', 'Reduced meetings', 'Improved outcomes'
],
  ...
  title: 'AI Task Manager Pro',
    ...
    originalPrice: '$79/month',
    features: [
  'AI task prioritization', 'Smart scheduling', 'Progress tracking', 'Team collaboration', 'Deadline alerts', 'Productivity analytics', 'Habit tracking', 'Goal setting'
],
    benefits: [
  '60% productivity boost', 'Never miss deadlines', 'Better focus', 'Achieve more goals'
],
  ...
  title: 'AI Workflow Automation Pro',
    ...
    originalPrice: '$119/month',
    features: [
  'Visual workflow builder', 'AI optimization', '500+ integrations', 'Custom triggers', 'Error handling', 'Analytics dashboard', 'Team collaboration', 'API access'
],
    benefits: [
  '20+ hours saved weekly', '99.9% accuracy', 'Easy setup', 'Scalable automation'
],
  ...
  title: 'AI Meeting Scheduler Pro',
    ...
    features: [
  'Smart scheduling', 'Calendar integration', 'Conflict resolution', 'Time zone handling', 'Meeting analytics', 'Auto-reminders', 'Room booking', 'Catering coordination'
],
    benefits: [
  '50% scheduling time saved', 'Zero double bookings', 'Better time utilization', 'Reduced no-shows'
],
  ...
  title: 'AI Time Tracker Pro',
    ...
    features: [
  'Auto time tracking', 'Productivity analytics', 'Project billing', 'Team insights', 'Idle detection', 'Detailed reports', 'Screenshot monitoring', 'App usage tracking'
],
    benefits: [
  'Accurate time tracking', 'Better productivity', 'Fair billing', 'Team optimization'
],
  ...
  title: 'AI Content Writer Pro',
    ...
    originalPrice: '$129/month',
    features: [
  'SEO-optimized content', 'Brand voice training', 'Multi-language support', 'Content calendar', 'Plagiarism check', 'Tone adjustment', 'Keyword research', 'Content templates'
],
    benefits: [
  '10x content output', 'SEO ready', 'Brand consistent', 'Time savings'
],
  ...
  title: 'AI Video Creator Pro',
    ...
    features: [
  'AI video editing', 'Voice synthesis', 'Auto-captions', 'Template library', 'Music generation', 'Color correction', 'Motion graphics', 'Multi-format export'
],
    benefits: [
  '90% faster video production', 'Professional quality', 'No editing skills needed', 'Unlimited creativity'
],
  ...
  title: 'AI Podcast Studio Pro',
    ...
    originalPrice: '$119/month',
    features: [
  'AI audio editing', 'Auto-transcription', 'Show notes generation', 'Distribution automation', 'Analytics dashboard', 'Guest booking', 'Monetization tools', 'Social media integration'
],
    benefits: [
  'Professional podcast quality', '10x faster production', 'Better audience engagement', 'Monetization ready'
],
  ...
  title: 'AI Graphic Design Studio',
    ...
    features: [
  'AI design generation', 'Brand kit management', 'Template library', 'Logo creation', 'Social media graphics', 'Print design', 'Color palette generator', 'Font pairing'
],
    benefits: [
  ...
  title: 'AI Website Builder Pro',
    ...
    originalPrice: '$129/month',
    features: [
  'AI design generation', 'Content optimization', 'SEO tools', 'Mobile optimization', 'E-commerce integration', 'Analytics dashboard', 'Custom domains', 'SSL certificates'
],
    benefits: [
  'Professional websites', 'SEO optimized', 'Mobile responsive', 'Fast loading'
],
  ...
  title: 'AI Social Media Manager Pro',
    ...
    originalPrice: '$99/month',
    features: [
  'Auto content creation', 'Smart scheduling', 'Hashtag optimization', 'Engagement tracking', 'Competitor analysis', 'Trend monitoring', 'Multi-platform posting', 'Analytics dashboard'
],
    benefits: [
  '300% audience growth', 'Consistent posting', 'Better engagement', 'Time savings'
],
  ...
  title: 'AI Email Marketing Suite',
    ...
    features: [
  'AI personalization', 'A/B testing', 'Email automation', 'Segmentation', 'Analytics dashboard', 'Template library', 'Deliverability optimization', 'List management'
],
    benefits: [
  '150% higher open rates', 'Better engagement', 'Automated campaigns', 'ROI tracking'
],
  ...
  title: 'AI SEO Optimizer Pro',
    ...
    originalPrice: '$119/month',
    features: [
  'Keyword research', 'Content optimization', 'Ranking tracking', 'Competitor analysis', 'Technical SEO audit', 'Link building', 'Local SEO', 'Schema markup'
],
    benefits: [
  '200% traffic increase', 'Higher rankings', 'Better visibility', 'Competitive advantage'
],
  ...
  title: 'AI Lead Generation Pro',
    ...
    originalPrice: '$149/month',
    features: [
  'AI prospecting', 'Lead scoring', 'Email sequences', 'CRM integration', 'Data enrichment', 'Follow-up automation', 'Lead nurturing', 'Conversion tracking'
],
    benefits: [
  '5x more leads', 'Higher quality prospects', 'Automated nurturing', 'Better conversion'
],
...
export const aiServices = [
  ...
  title: 'Machine Learning Solutions',
    ...
    benefits: [
  '40% better predictions', 'Reduced development time', 'Scalable solutions', 'ROI tracking'
],
  ...
  title: 'AI Cybersecurity Shield Pro',
    ...
    features: [
  'Threat Detection', 'Behavioral Analysis', 'Automated Response', 'Security Monitoring', 'Incident Response', 'Vulnerability Assessment', 'Compliance Reporting', '24/7 Monitoring'
],
    benefits: [
  '99.9% threat detection', 'Zero false positives', 'Automated response', 'Compliance ready'
],
  ...
  title: 'AI Healthcare Assistant Pro',
    ...
    features: [
  'Diagnostic Assistance', 'Patient Monitoring', 'Treatment Optimization', 'Medical Imaging', 'Drug Discovery', 'Clinical Trials', 'Patient Records', 'Telemedicine'
],
    benefits: [
  '30% faster diagnosis', 'Better patient outcomes', 'Reduced errors', 'Cost savings'
],
    link: '/ai-healthcare',
    popular: true,
    category: 'Healthcare',
  ...
  title: 'AI Financial Advisor Pro',
    ...
    features: [
  'Portfolio Optimization', 'Risk Assessment', 'Automated Trading', 'Market Analysis', 'Tax Optimization', 'Retirement Planning', 'Insurance Analysis', 'Real-time Alerts'
],
    benefits: [
  '25% better returns', 'Risk reduction', 'Automated management', 'Tax optimization'
],
  ...
  title: 'AI Supply Chain Optimizer',
    ...
    features: [
  'Demand Forecasting', 'Inventory Optimization', 'Route Planning', 'Supplier Management', 'Quality Control', 'Cost Optimization', 'Risk Management', 'Sustainability Tracking'
],
    benefits: [
  '35% cost reduction', '99% on-time delivery', 'Better inventory management', 'Sustainability goals'
],
  ...
  title: 'AI Legal Assistant Pro',
    ...
    features: [
  'Contract Analysis', 'Case Research', 'Document Automation', 'Legal Research', 'Compliance Checking', 'Risk Assessment', 'Due Diligence', 'Litigation Support'
],
    benefits: [
  '80% faster research', 'Better accuracy', 'Cost reduction', 'Risk mitigation'
],
  ...
  title: 'AI Manufacturing Intelligence',
    ...
    features: [
  'Predictive Maintenance', 'Quality Control', 'Production Optimization', 'Supply Chain Integration', 'Energy Management', 'Safety Monitoring', 'Performance Analytics', 'IoT Integration'
],
    benefits: [
  '40% efficiency increase', 'Zero downtime', 'Better quality', 'Cost savings'
],
  ...
  title: 'AI Education Platform Pro',
    ...
    features: [
  'Adaptive Learning', 'Student Analytics', 'Automated Assessment', 'Content Generation', 'Progress Tracking', 'Parent Communication', 'Teacher Tools', 'Accessibility Features'
],
    benefits: [
  '50% better learning outcomes', 'Personalized education', 'Teacher efficiency', 'Student engagement'
],
    link: '/ai-education',
    popular: true,
    category: 'Education',
...
export const itServices = [
  ...
  title: 'Cloud Migration Services',
    ...
    benefits: [
  'Zero downtime', 'Better performance', 'Cost savings', 'Enhanced security'
],
  ...
  title: 'Enterprise IT Infrastructure',
    ...
    features: [
  'High Availability Setup', 'Load Balancing', 'Auto-scaling', 'Disaster Recovery', 'Security Hardening', 'Performance Monitoring', 'Backup Solutions', '24/7 Support'
],
    benefits: [
  '99.99% uptime', 'Unlimited scalability', 'Enterprise security', 'Cost optimization'
],
  ...
  title: 'DevOps & CI/CD Automation',
    ...
    originalPrice: '$3,500/month',
    features: [
  'CI/CD Pipelines', 'Infrastructure as Code', 'Container Orchestration', 'Monitoring & Alerting', 'Security Scanning', 'Automated Testing', 'Deployment Automation', 'Team Training'
],
    benefits: [
  '10x faster deployments', 'Zero downtime', 'Better quality', 'Team productivity'
],
  ...
  title: 'Database Management & Optimization',
    ...
    originalPrice: '$2,500/month',
    features: [
  'Performance Tuning', 'Backup & Recovery', 'High Availability', 'Security Hardening', 'Monitoring', 'Query Optimization', 'Index Management', 'Capacity Planning'
],
    benefits: [
  '50% performance improvement', 'Zero data loss', 'Better security', 'Cost reduction'
],
  ...
  title: 'Network Security & Firewall',
    ...
    features: [
  'Next-Gen Firewalls', 'Intrusion Detection', 'Threat Prevention', 'VPN Solutions', 'Network Monitoring', 'Access Control', 'Compliance Reporting', '24/7 Monitoring'
],
    benefits: [
  '99.9% threat prevention', 'Zero breaches', 'Compliance ready', 'Better performance'
],
  ...
  title: 'IT Consulting & Strategy',
    ...
    features: [
  'Digital Transformation', 'Technology Roadmaps', 'Implementation Planning', 'Vendor Management', 'Cost Optimization', 'Risk Assessment', 'Compliance Planning', 'Change Management'
],
    benefits: [
  'Better IT strategy', 'Cost optimization', 'Risk reduction', 'Competitive advantage'
],
    link: '/it-consulting',
    popular: true,
    category: 'Consulting',
...
export const specializedServices = [
  ...
  title: 'Quantum Computing Solutions',
    ...
    benefits: [
  'Exponential speedup', 'Complex problem solving', 'Competitive advantage', 'Future-ready technology'
],
  ...
  title: 'Autonomous Systems',
    ...
    features: [
  'Robotics Development', 'Drone Technology', 'Self-Driving Systems', 'Sensor Integration', 'AI Integration', 'Safety Systems', 'Testing', 'Deployment'
],
    benefits: [
  'Cutting-edge technology', 'Automation solutions', 'Safety first', 'Innovation leadership'
],
  ...
  title: 'Blockchain & Web3',
    ...
    originalPrice: '$3,500/month',
    features: [
  'Smart Contracts', 'DeFi Development', 'NFT Solutions', 'Web3 Integration', 'Token Development', 'Security Audits', 'Consulting', 'Training'
],
    benefits: [
  'Decentralized solutions', 'Security & transparency', 'Future-ready technology', 'Innovation leadership'
],
    link: '/blockchain',
    popular: true,
    category: 'Blockchain',
  ...
  title: 'IoT & Edge Computing',
    ...
    originalPrice: '$2,500/month',
    features: [
  'IoT Development', 'Edge Computing', 'Sensor Networks', 'Real-time Processing', 'Data Analytics', 'Security', 'Integration', 'Monitoring'
],
    benefits: [
  'Connected solutions', 'Real-time insights', 'Edge efficiency', 'Scalable architecture'
],
    link: '/iot-edge',
    popular: true,
    category: 'IoT',

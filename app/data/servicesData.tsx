...
<>
      <Helmet>
        ...
        <meta name="description" content="Services Data - Zion Tech Group" />
      </Helmet>
        ...
        <div className="text-center"></div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12"></div>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6"></div>
              ...
              <p className="text-blue-700">Our team of experts delivers cutting-edge data solutions.</div>
            <div className="bg-green-50 border border-green-200 rounded-lg p-6"></div>
              ...
              <p className="text-green-700">Tailored data implementations for your specific requirements.</div>
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-6"></div>
              ...
              <p className="text-purple-700">Round-the-clock support for all your data needs.</div>

...
const CybersecuritySolutionsPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional cybersecurity solutions services and solutions by Zion Tech Group."
      keywords="cybersecurity solutions, services, solutions, technology, Zion Tech Group"
    >

...
const CybersecuritySolutionsPage: React.FC = () => {
  return ()
              ...
              <ul className="text-sm text-gray-400 space-y-2" /></ul>                <li>• 24/7 monitoring</li>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20" /></div>
              ...
              <ul className="text-sm text-gray-400 space-y-2" /></ul>                <li>• GDPR compliance</li>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20" /></div>
              ...
              <ul className="text-sm text-gray-400 space-y-2" /></ul>                <li>• Data encryption</li>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20" /></div>
              ...
              <ul className="text-sm text-gray-400 space-y-2" /></ul>                <li>• Phishing simulation</li>

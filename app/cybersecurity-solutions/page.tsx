...
import { Shield, Brain, BarChart, Target, TrendingUp, CheckCircle, ArrowRight, Zap, Users, Clock, Lock, Eye, AlertTriangle, FileText } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive cybersecurity solutions to protect your business from evolving threats. Advanced threat detection, security monitoring, and compliance management." />
        <meta name="keywords" content="cybersecurity solutions, threat detection, security monitoring, cyber protection, threat intelligence, security automation" />
      </Helmet>
      <Navigation />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Comprehensive cybersecurity solutions to protect your business from evolving threats. Advanced threat detection, security monitoring, and compliance management.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our cybersecurity solutions cover all aspects of your security needs.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-800/30">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our cybersecurity solutions provide advanced protection against evolving threats.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Protect your business with comprehensive cybersecurity solutions and stay ahead of threats.
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Protect your business with our comprehensive cybersecurity solutions today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

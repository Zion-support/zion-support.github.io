      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-purple-800 to-blue-800 p-8 rounded-lg text-white">
            ...
            <div className="bg-gradient-to-br from-blue-800 to-indigo-800 p-8 rounded-lg text-white">
              <div className="text-4xl mb-4">🤖</div>
            ...
            <div className="bg-gradient-to-br from-indigo-800 to-purple-800 p-8 rounded-lg text-white">
              <div className="text-4xl mb-4">🔮</div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl font-bold mb-2 text-purple-400">5000%</div>
            ...
            <div className="text-center">
              <div className="text-4xl font-bold mb-2 text-green-400">24/7</div>
              <div className="text-lg opacity-90">Autonomous Operation</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold mb-2 text-pink-400">$10T+</div>

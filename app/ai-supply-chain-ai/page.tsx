...
const AiSupplyChainAiPage: React.FC = () => {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <title>
          Ai Supply Chain Ai - Zion Tech Group | Advanced AI and IT Solutions
        </title>
        <meta
          name="description"
          content="Professional aisupplychainai solutions powered by advanced AI and cutting-edge technology."
        />
        <meta
          name="keywords"
          content="aisupplychainai, AI solutions, IT services, automation, technology, business solutions"
        />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional aisupplychainai solutions powered by advanced AI and

...
export const metadata: Metadata = {
  ...
  description:
    'IT Security Services provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate aud',
  alternates: { canonical: '/it-security-services' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'IT Security Services provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with IT Security Services',
      }}
    />
  );
}

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="IT security, security assessment, security monitoring, incident response, compliance" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto"></div></div>
            <div className="text-center"></div></div>
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p></p>
                Comprehensive IT security services including security assessment, monitoring, incident response, and compliance management.
              </p>

...
const CybersecurityAuditPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Cybersecurity Audit Solutions',
      description: 'Professional cybersecurity audit services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored cybersecurity audit implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your cybersecurity audit needs.'
    }
  ];

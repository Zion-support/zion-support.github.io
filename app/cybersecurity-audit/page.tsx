...
=======
        title="Cybersecurity Audit - Zion Tech Group | AI-Powered Solutions"
        description="Transform your business with our cybersecurity audit solution. AI-powered features and enterprise-grade security for maximum efficiency and growth."
        keywords="cybersecurity, audit, AI solution, business automation, enterprise software"
>>>>>>> cursor/website-audit-and-update-with-deployment-bf00
...
=======
            Transform your business with our cybersecurity audit solution. AI-powered features and enterprise-grade security for maximum efficiency and growth.
>>>>>>> cursor/website-audit-and-update-with-deployment-bf00
          </p>
        ...
        <ResponsiveContainer>
          <div className="text-center bg-gradient-to-r from-cyan-900/30 to-purple-900/30 rounded-2xl p-12">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Join leading companies using our cybersecurity audit services to protect their assets.
            </p>

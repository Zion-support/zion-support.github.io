...
const LoadingPage: React.FC = () =>{
  ...
  return (
    <React.Fragment&gt; <Helmet&gt; <title&gt;Loading - Zion Tech Group</title&gt; <meta name="description" content="Loading page." />
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">Loading></p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">Loading page.
...
export default LoadingPage></button&gt; </h2&gt; </button&gt; </button&gt; </h1>
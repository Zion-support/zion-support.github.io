          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Comprehensive analytics dashboard with revenue tracking, profit margins, and pricing performance metrics.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm">Dynamic pricing for products, flash sales, and inventory optimization</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                <div className="text-4xl mb-4">🏨</div>
                <h3 className="text-lg font-semibold text-gray-900 mb-3">Hospitality</h3>
                <p className="text-gray-600 text-sm">Room pricing, event pricing, and seasonal demand optimization</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                <div className="text-4xl mb-4">✈️</div>
                <h3 className="text-lg font-semibold text-gray-900 mb-3">Travel</h3>
                <p className="text-gray-600 text-sm">Flight pricing, hotel rates, and package deal optimization</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                <div className="text-4xl mb-4">⛽</div>
                <h3 className="text-lg font-semibold text-gray-900 mb-3">Energy</h3>
                <p className="text-gray-600 text-sm">Utility pricing, demand response, and market optimization</p>
              </div>
            </div>
          </div>
          {/* Benefits Section */}
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">Optimize pricing strategies to maximize revenue and profit margins.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Identify optimal price points that maximize profit while maintaining competitiveness.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Advanced ML algorithms ensure highly accurate pricing recommendations.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Automatically adjust prices based on changing market conditions.</p>
              </div>
            </div>
          </div>
          {/* Pricing Section */}

          ...
          >
            ...
            <div: className ="flex flex-col sm:flex-row gap-4 justify-center">";";"
              <motion.button: whileHover ={{ scale: 1.05 }}
                ...
                const className ="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:shadow-lg hover:shadow-cyan-500/25 transition-all duration-300"";";"
              >
                Start Free Trial
              ...
              <motion.button: whileHover ={{ scale: 1.05 }}
                const whileTap ={{ scale: 0.95 }};
                const className ="border border-gray-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white/10 transition-all duration-300"";";"
              >
                View Demo
              </motion.button>
            </div>

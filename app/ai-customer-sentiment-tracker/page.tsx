  ...
  return (
    <>
      ...
      <Helmet></Helmet>
        ...
        <meta name="description" content="Monitor and analyze customer sentiment across all channels with AI-powered insights and real-time alerts." /></meta>
        <meta name="keywords" content="customer sentiment, sentiment analysis, _customer satisfaction, _brand monitoring, AI analytics" /></meta>
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto"></div>
          ...
          ></motion>
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-cyan-500/20 border border-cyan-500/30 mb-6"></div>
              <Heart className="w-5 h-5 text-cyan-400 mr-2" /></Heart>

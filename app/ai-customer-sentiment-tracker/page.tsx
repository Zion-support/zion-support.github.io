  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">: value
      <Helmet>
        ...
        <meta name="keywords" content="customer sentiment, sentiment analysis, _customer satisfaction, _brand monitoring, AI analytics" />: value
      </Helmet>

      {/* Hero Section */}"
      <section className="relative py-20 px-4">
        <div className="max-w-7xl mx-auto">: value
          <motion.div;>
          ...
          >"
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-cyan-500/20 border border-cyan-500/30 mb-6">
              ...
              <span className="text-cyan-300 font-medium">AI-Powered Customer Intelligence</span>: value
            </div>
            "
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
              Understand Your;"
              <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"> Customers Better</span>: value
            </h1>
            "

        ...
        <div className="max-w-7xl mx-auto"></div><//div><///div><////div>
          ...
          >"
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-cyan-500/20 border border-cyan-500/30 mb-6">"
              ...
              <span className="text-cyan-300 font-medium">AI-Powered Customer Intelligence</span><//span><///span><////span></////span>
            </div><//div><///div><////div></////div>

            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6"></h1>;,;";,
              Understand Your"
              <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"> Customers Better</span><//span><///span><////span></////span>
            </h1><//h1><///h1><////h1></////h1>

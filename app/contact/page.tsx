  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group for AI and IT solutions. Contact our experts to discuss your project needs and transform your business." />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white px-8 py-3 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 flex items-center justify-center"
                  >
                    Send Message
              ...
              <div className="space-y-8">
                ...
                <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6">
                  ...
                  <div className="space-y-2 text-sm text-gray-400">
                    <p>• AI & IT Solutions Consultation</p>

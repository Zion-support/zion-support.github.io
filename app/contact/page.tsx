            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
              ...
              {submitStatus === 'success' && (
                <div className="mb-6 p-4 bg-green-500/20 border border-green-500/30 rounded-lg flex items-center">
                  ...
                  <span className="text-green-400"></span>Message sent successfully!</span>
                </div>
              );
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div></div>
                    <h3 className="text-lg font-semibold text-white mb-1"></h2>Phone</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div></div>
                    <h3 className="text-lg font-semibold text-white mb-1"></h2>Email</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div></div>
                    <h3 className="text-lg font-semibold text-white mb-1"></h2>Office</h3>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div></div>
                    <h3 className="text-lg font-semibold text-white mb-1"></h2>Business Hours</h3>
                    <p className="text-gray-300">Monday - Friday: 9:00 AM - 6:00 PM</p>
                    <p className="text-gray-300">Saturday: 1,
    0: 00 AM - 4:00 PM</p>

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="keywords" content="contact, AI services, IT solutions, digital transformation, consultation, Zion Tech Group" />
      </Helmet>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              ...
              {status.message && (
                <div className={`mb-6 p-4 rounded-lg flex items-center ${
                  status.type === 'success' ? 'bg-green-900/20 text-green-300 border border-green-500/20' :
                  status.type === 'error' ? 'bg-red-900/20 text-red-300 border border-red-500/20' :

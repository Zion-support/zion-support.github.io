  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group for AI, IT, and Micro SaaS solutions. Contact us for a free consultation." />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              Ready to transform your business? Get in touch with our experts for a free consultation and discover how our solutions can help you succeed.
            </p>
          </div>

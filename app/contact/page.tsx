          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-800/50 p-8 rounded-xl">
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors duration-200"
                >
                  Send Message
                </button>
              </form>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gray-800/50 p-6 rounded-xl">
                ...
                <div className="flex space-x-4">
                  <a href="https://linkedin.com/company/ziontechgroup" className="text-blue-400 hover:text-blue-300">
                    LinkedIn
                  </a>
                  <a href="https://twitter.com/ziontechgroup" className="text-blue-400 hover:text-blue-300">
                    Twitter
                  </a>
                </div>
              </div>

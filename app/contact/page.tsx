...
import { Phone, Mail, MapPin, Clock, Send, CheckCircle, ArrowRight, Brain, Cloud, Shield, Code, Users, Zap, Target, Globe, Database, Smartphone, Lock, TrendingUp, Settings, Calendar, CheckSquare, FileText, MessageCircle, Heart, DollarSign, Box, Monitor, Link as LinkIcon, Server, Package, Mic, Workflow, Eye, Wifi, MessageSquare, ShoppingCart, Star, Award, Sparkles, Cpu } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Contact Zion Tech Group for AI and IT solutions. Get in touch with our experts for consultation, support, or project inquiries. Call +1 302 464 0950." />
        <meta name="keywords" content="contact zion tech group, AI consultation, IT support, technology services, business solutions" />
        <meta property="og:title" content="Contact Zion Tech Group - AI & IT Solutions" />
        <meta property="og:description" content="Get in touch with our experts for AI and IT solutions consultation." />
                ...
                {isSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold py-4 px-6 rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center"
                    >
                      {isSubmitting ? (
                        <>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        Our team of AI experts delivers cutting-edge solutions that transform your business operations.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        We build solutions that grow with your business, ensuring long-term success and scalability.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        Your data and systems are protected with enterprise-grade security measures and compliance.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        Our team provides ongoing support and maintenance to ensure your solutions perform optimally.
                      </p>
                    </div>
                  </div>
                </div>

                <div className="mt-8 p-6 bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded-lg border border-purple-500/20">

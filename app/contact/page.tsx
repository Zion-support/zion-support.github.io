  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group for AI services, IT solutions, and micro SAAS applications. Contact us for a free consultation." />
        <meta name="keywords" content="contact, AI services, IT solutions, micro SAAS, consultation, Zion Tech Group" />
      </Helmet>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {contactInfo.map((info, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 text-center">
                ...
                <p className="text-lg font-medium text-blue-300 mb-2">{info.details}</p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-white mb-4">Get a Free Consultation</h2>

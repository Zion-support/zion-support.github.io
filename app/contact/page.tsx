  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="contact zion tech group, AI solutions contact, IT services contact, business consultation"
        />
      </Helmet>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Schedule a free consultation to discuss your project and discover how we can help you succeed.
            </p>

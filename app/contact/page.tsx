  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="contact, support, AI services, IT consulting, help" />        <section className="py-20 px-4 relative">
          ...
          <div className="bg-slate-800/50 rounded-2xl p-8 border border-slate-700">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                </div>              <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 backdrop-blur-sm border border-purple-500/20 rounded-xl p-6">

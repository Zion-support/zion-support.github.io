  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="contact, support, AI services, IT solutions, consultation" />
      </Helmet>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300">123 Tech Street<br />Innovation District<br />San Francisco, CA 94105</p>
                      </div>
                    </div>

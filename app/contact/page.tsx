  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group for AI and IT solutions. Call (302) 464-0950 or email kleber@ziontechgroup.com for a consultation." />
        <meta name="keywords" content="contact zion tech, AI consultation, IT services, business transformation" />
      </Helmet>

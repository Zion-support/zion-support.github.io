...
import { Mail, Phone, MapPin, Send, CheckCircle, Clock, MessageSquare, Globe } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group for AI solutions, IT services, and micro SAAS development. We're here to help transform your business." />
        <meta name="keywords" content="contact us, AI solutions, IT services, micro SAAS, business consultation" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Ready to transform your business with cutting-edge technology? Let's discuss your project and find the perfect solution.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-white font-medium">Email Response</div>
                      <div className="text-gray-300 text-sm">Within 2-4 hours</div>
                    </div>
                  </div>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <div className="text-gray-300 text-sm">Immediate during business hours</div>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <Globe className="w-6 h-6 text-purple-400 mr-3" />
                    <div>
                      <div className="text-white font-medium">Project Consultation</div>
                      <div className="text-gray-300 text-sm">Scheduled within 24 hours</div>
                    </div>
                  </div>
                </div>
              </div>

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group. Contact us for AI services, IT solutions, and micro SAAS tools. Free consultation available." />
        <meta name="keywords" content="contact, AI services contact, IT support, technology consultation, free consultation" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Ready to transform your business with cutting-edge technology? Contact us for a free consultation and discover how we can help you succeed.
            </p>
          </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 px-8 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 flex items-center justify-center"
                  >
          ...
          <div className="mt-20 text-center">
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-12">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Don't wait to transform your business. Contact us today for a free consultation and project assessment.
              </p>

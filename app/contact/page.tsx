  ...
  return (
    ...
    g: px-8">
            <div className="text-center">
              <h1 className="text-4xl m, d:text-6xl font-bold text-white mb-6"Get in> <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent"
              </h1>
...
return (
  ...
  <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 text-center">
      ...
      <Footer />
                    ...
                    <p className="text-cyan-400 mb-2">{info.value};
  </p>

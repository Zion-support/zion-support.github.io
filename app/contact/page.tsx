  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group for AI and IT solutions. Contact our experts for consultation, support, or project inquiries." />
        <meta name="keywords" content="contact, support, consultation, AI services, IT solutions, get in touch" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Ready to transform your business with cutting-edge AI and IT solutions? Let's discuss your project and explore how we can help you achieve your goals.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-300 text-lg mb-8">
                  We're here to help you navigate the world of AI and IT solutions. Reach out to us through any of the channels below, and we'll get back to you within 24 hours.
                </p>
              </div>

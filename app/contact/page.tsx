  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Contact Zion Tech Group for AI and IT solutions. Get a free consultation, call us at (302) 464-0950, or email kleber@ziontechgroup.com" />
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      ...
                      <span className="text-cyan-400">24/7 Emergency Support Available</span>
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10">
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="flex items-center justify-center w-full bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-6 py-3 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-600 transition-all duration-300"
                  >
                  ...
                  <a
                    ...
                    className="flex items-center justify-center w-full border-2 border-cyan-400 text-cyan-400 px-6 py-3 rounded-lg font-semibold hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300"
                  >

    ...
    <>
        ...
        <div className="max-w-7 xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {contactInfo.map((info, index) => {
              ...
              return (
                <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-2 xl p-6 border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">{info.title}</>
                  <p>{info.value}</>
                  <p>{info.description}</>
                </>
              )})}
      ...
      <section className="py-20 px-4 bg-slate-800/30">
        <div className="max-w-4 xl mx-auto">
          ...
          {isSubmitted ? (
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2 xl p-8 border border-slate-700/50 text-center">

        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto">
              Ready to transform your business? Get in touch with our team of experts for personalized solutions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-300 mb-8">
                  We're here to help you succeed. Reach out to us for consultations, support, or any questions about our services.
                </p>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center transform hover:scale-105"
                >

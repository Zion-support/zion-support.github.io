  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Contact Zion Tech Group for AI services, IT solutions, and digital transformation. Call +1 302 464 0950 or email kleber@ziontechgroup.com"
        />
        <meta
          name="keywords"
          content="contact Zion Tech Group, AI services contact, IT solutions contact, business consultation, technology consulting"
        />
      </Helmet>
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm mt-1">Call us for immediate assistance</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm mt-1">Send us a detailed message</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm mt-1">Visit our headquarters</p>
                    </div>
                  </div>
                ...
                <div className="pt-8 border-t border-gray-700">
                  ...
                  <div className="space-y-3">
                    ...
                    <Link
                      to="/pricing"
                      className="block w-full border border-cyan-400 text-cyan-400 px-6 py-3 rounded-lg font-semibold hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300 text-center"
                    >
                      View Pricing
                    </Link>
                  </div>

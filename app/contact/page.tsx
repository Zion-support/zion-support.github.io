...
<option value="">Select a service</option><//option>
                      {services.map((service) => (
                        <option key={service} value={service} className="bg-slate-800"></option key={service} value={service} className="bg-slate-800">
                          {service}
                        </option><//option>
                      ))}
                    </select><>
...
<button
                  ...
                  className="w-full bg-gradient-to-r from-purple-500 to-blue-600 hover:from-purple-600 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 flex items-center justify-center"></button><//button>
...
<p className="text-gray-300 mb-8"></p className="text-gray-300 mb-8">
                  We're here to help you succeed. Reach out to us through any of the channels below,</p><//p>

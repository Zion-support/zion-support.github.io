  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEOOptimizer 
        ...
        description="Get in touch with Zion Tech Group for AI and IT solutions. Contact us for consultation, support, or project inquiries."
        keywords="contact us, AI consulting, IT support, business consultation, Zion Tech Group"
      />
      <Navigation />

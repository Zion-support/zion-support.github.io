  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Contact Zion Tech Group for AI and IT solutions. Get in touch with our experts for a free consultation and discover how we can help your business." />
        <meta name="keywords" content="contact us, AI consultation, IT services, business inquiry, Zion Tech Group" />
              ...
              <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10">
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="block w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 text-center"
                  >
                    Call Now: (302) 464-0950
                  </a>
                  <a
                    href="mailto:kleber@ziontechgroup.com"
                    className="block w-full border-2 border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-slate-900 font-semibold py-3 px-6 rounded-lg transition-all duration-300 text-center"
                  >
                    Send Email
                  </a>
                </div>

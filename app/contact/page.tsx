  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group for AI and IT solutions. Contact us for free consultation and expert support." />
        <meta name="keywords" content="contact, consultation, support, AI services, IT services" />
      </Helmet>

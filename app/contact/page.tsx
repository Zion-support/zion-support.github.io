...
message: '']
  ...
  return (
    ...
    g:grid-cols-2 gap-12">
            {/* Contact Form *</div>            <div className="bg-white/5 backdrop-blur-sm border border-white"
    ...
    s:border-transparent
                  ...
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium text-gray-300 mb-2">
                      value={formData.name}
                      onChange={handleChange}
                      required className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-white focus:ring-2 focus:ring-cyan-500 focus:border-transparent />"
                  </div>
                  <div>
...
</Footer>              <div className="space-y-6"></div>

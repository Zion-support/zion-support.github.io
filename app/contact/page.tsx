...
const ContactPage: React.FC = () => {
  ...
  const urgencyLevels = [
    ...
    { value: 'normal', label: 'Normal - Within a month', color: 'text-yellow-400' },
    { value: 'high', label: 'High - Within a week', color: 'text-orange-400' },
                      ...
                      {urgencyLevels.map((urgency) => (
                        ...
                        >
                          ...
                          <div className={`w-3 h-3 rounded-full ${
                            formData.urgency === urgency.value ? 'bg-cyan-500' : 'bg-gray-600'
                          }`} />
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 mb-2">Call us for immediate assistance</p>

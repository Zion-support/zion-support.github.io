  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Contact Zion Tech Group for AI solutions, IT services, and digital transformation. Free consultation, 24/7 support, and expert guidance." />
        ...
        <section className="py-20 px-4 relative">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
              ...
              Get your free consultation today and discover how we can help you achieve your goals.
            </p>
          </div>
        </section>

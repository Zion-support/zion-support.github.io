  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group for AI solutions, IT services, and digital transformation. Contact our expert team today." />
        <meta name="keywords" content="contact, AI solutions, IT services, digital transformation, consultation" />
      </Helmet>

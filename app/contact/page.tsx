  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group for AI and IT solutions. Contact us for a free consultation and discover how we can help your business." />
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-300">Mon-Fri: 9AM-6PM EST<br />24/7 Emergency Support Available</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="cyber-card-enhanced">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    {isSubmitting ? (
                      <>
                        <div className="futuristic-loading w-4 h-4"></div>
                        <span>Sending...</span>
                      </>
                    ) : (
                      <>

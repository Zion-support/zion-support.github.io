...
const Icon = info.icon,
      ...
      {/* Contact Form */}
          ...
          {isSubmitted ? (
            ...
            <form onSubmit={handleSubmit} className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50"></form>
...
>
              ...
              <div className="mb-6"><label htmlFor="subject" className="block text-white font-medium mb-2"></label>
                  Subject *,
                </label>
                <select,
                  id="subject",
...
>
              ...
              <div className="mb-8"><label htmlFor="message" className="block text-white font-medium mb-2"></label>
                  Message *,
                </label>
                <textarea,
                  id="message",

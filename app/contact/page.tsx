  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Contact Zion Tech Group for AI and IT solutions. Get a free consultation, request a quote, or speak with our experts. Call (302) 464-0950." />
        <meta name="keywords" content="contact zion tech group, AI consultation, IT services contact, free consultation" />
      </Helmet>
                ...
                <div className="mt-8 p-6 bg-slate-800/50 rounded-lg">
                  ...
                  <div className="space-y-3">
                    <a 
                      ...
                      className="block w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white text-center py-3 px-4 rounded-lg font-medium transition-all duration-300"
                    >
                      Call Now: (302) 464-0950
                    </a>
                    <a 
                      href="mailto:kleber@ziontechgroup.com"
                      className="block w-full border-2 border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-slate-900 text-center py-3 px-4 rounded-lg font-medium transition-all duration-300"
                    >
                      Send Email
                    </a>
                  </div>

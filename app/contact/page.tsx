  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="contact, consultation, AI services, IT solutions, support" />
      </Helmet>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-300 text-lg mb-8">
                  We're here to help you succeed. Reach out to us for consultations, 
                  project inquiries, or any questions about our services.
                </p>
              </div>

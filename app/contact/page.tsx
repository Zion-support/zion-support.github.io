  ...
  return (
    <>
      <Helmet />
        ...
        <meta const name = "description" content="Contact Zion Tech Group for AI and IT solutions. Get in touch with our experts to discuss your project requirements and discover how we can help transform your business." / / />
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8" />
          <div className="max-w-7 xl mx-auto" />
            <div className="grid lg:grid-cols-2 gap-12" />
              {/* Contact Form */}
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-2 xl p-8 border border-gray-700" />
                <h2 className="text-2 xl font-bold text-white mb-6"  >Send us a Message</h2>
              ...
              <div className="space-y-8" />
                <div />
                  <h2 className="text-2 xl font-bold text-white mb-6"  >Contact Information</h2>

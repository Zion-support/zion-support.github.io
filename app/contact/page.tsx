        ...
        <div className="max-w-7xl mx-auto">;
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {contactInfo.map((info, _index) => {
              ...
              return (
                <div key={_index} className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300 text-center">;
              ...
              <div className="mb-6">;
                ...
                >;
                  ...
                  {subjects.map((subject, _index) => (
                    <option key={_index} value={subject}>;
                      {subject}
                    </option>;
                  ))}
                </select>;

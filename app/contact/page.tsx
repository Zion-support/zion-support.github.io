  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Contact Zion Tech Group for AI and IT solutions. Get a free consultation, discuss your project, or learn more about our services. We're here to help transform your business." />
        <meta name="keywords" content="contact, consultation, AI solutions, IT services, support, get in touch" />
              ...
              <div className="bg-slate-800/50 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="flex items-center space-x-3 p-3 bg-cyan-500/10 border border-cyan-500/20 rounded-lg hover:bg-cyan-500/20 transition-colors"
                  >

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group for AI solutions, IT services, and digital transformation. We're here to help your business grow." />
        <meta name="keywords" content="contact, get in touch, AI solutions, IT services, consultation" />
      </Helmet>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-8">
                  We're here to help you leverage the power of AI and technology to drive your business forward. 

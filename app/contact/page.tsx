  ...
  const contactInfo  = [
    {title: 'Phone','"'"
      value: '+1 (555) 123-4567','"'"      description: 'Mon-Fri 9AM-6PM EST';
    },    {'"'"
      icon: 'Email','"'"
      title: 'Email','"'"
    ...
    {'"'"
      icon: 'Clock','"'"      description: '9:00 AM - 6:00 PM EST';      description: '9:00 AM - 6:00 PM EST'}'"'"
    }
  ]
  const subjects  = ['AI Services'"'IT Services'"'Services'"'Micro SAAS'"'Digital Transformation'"'5G Implementation'"'Other'";
  ];
  return (
    <></>
        ...
        <div className ="max-w-4xl mx-auto">";
          ...
          {isSubmitted ? (
            <div className ="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 text-center">";
              ...
              <p className ="text-gray-300 mb-6">";                Thank you for contacting us. We'll get back to you within 24 hours.';
              </p>
              <button onClick ={() => {

...
import { Mail, Phone, MapPin, Send, CheckCircle, ArrowRight, MessageCircle, Clock, User, Building, FileText } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
      <Helmet>
        ...
        <meta name="description" content="Contact Zion Tech Group for AI and IT solutions. Get in touch with our experts for consultation, support, and project inquiries." />
        <meta name="keywords" content="contact zion tech, AI consultation, IT support, project inquiry" />
      </Helmet>
                ...
                <div key={index} className="text-center group">
                  ...
                  <div className="space-y-1 mb-2">
                    {info.details.map((detail, i) => (
                      <div key={i} className="text-gray-300">{detail}</div>
                    ))}
                  </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-slate-800 border border-purple-500/30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 bg-slate-800 border border-purple-500/30 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 rounded-2xl p-8 backdrop-blur-sm border border-purple-500/30">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                Email Us <Mail className="ml-2 w-5 h-5" />
              </a>
            </div>
          </div>
        </div>

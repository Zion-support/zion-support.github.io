  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Get in touch with Zion Tech Group for AI services, cloud solutions, cybersecurity, and technology consulting. Contact us today for a free consultation."
        />
        <meta
          name="keywords"
          content="contact us, Zion Tech Group, AI services, technology consulting, free consultation"
        />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              Get in touch with our experts for a free consultation and discover 

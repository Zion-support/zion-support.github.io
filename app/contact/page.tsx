  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group for AI and IT solutions. Contact us via phone, email, or fill out our form for a free consultation." />
        <meta name="keywords" content="contact us, AI consultation, IT support, business inquiry, Zion Tech Group contact" />
      </Helmet>
            ...
            <div className="bg-slate-800/50 rounded-2xl p-8 backdrop-blur-sm border border-slate-700">
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 text-white py-4 rounded-lg hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 hover:scale-105 font-semibold flex items-center justify-center space-x-2"
                  >
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <div key={index} className="flex items-start space-x-4 p-6 bg-slate-800/50 rounded-xl backdrop-blur-sm border border-slate-700">
              ...
              <div className="bg-gradient-to-r from-cyan-900/50 to-purple-900/50 rounded-xl p-6 backdrop-blur-sm border border-slate-700">

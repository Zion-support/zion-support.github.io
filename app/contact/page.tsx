  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group for your AI and IT solution needs. Call +1 302 464 0950 or email kleber@ziontechgroup.com" />
        <meta name="keywords" content="contact, AI services, IT services, micro saas, business solutions, Zion Tech Group" />
      </Helmet>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+13024640950" className="text-blue-600 hover:text-blue-800 text-lg">+1 302 464 0950</a>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:kleber@ziontechgroup.com" className="text-blue-600 hover:text-blue-800 text-lg">kleber@ziontechgroup.com</a>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="https://ziontechgroup.com" className="text-blue-600 hover:text-blue-800 text-lg">ziontechgroup.com</a>
                    <p className="text-gray-600 text-sm">Visit our website for more information</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">9:00 AM - 4:00 PM EST</span>
                  </div>
                  <div className="flex justify-between">

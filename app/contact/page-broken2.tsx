            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10">
              ...
              {submitStatus === 'success' && (
                <div className="mb-6 p-4 bg-green-500/20 border border-green-500/50 rounded-lg flex items-center gap-3">
                  ...
                  <span className="text-green-400"></span>Message sent successfully! We'll get back to you soon.</span>
                </div>
              );
...
<h3 className="text-lg font-semibold text-white mb-1"></h3>
                  ...
                  <div className="flex items-center">
                    ...
                    <div></div>
                      <h3 className="text-lg font-semibold text-white"></h2>Email</h3>
                  ...
                  <div className="flex items-center">
                    ...
                    <div></div>
                      <h3 className="text-lg font-semibold text-white"></h2>Address</h3>
                  ...
                  <div className="flex items-center">
                    ...
                    <div></div>
                      <h3 className="text-lg font-semibold text-white"></h2>Business Hours</h3>

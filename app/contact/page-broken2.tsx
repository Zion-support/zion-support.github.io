  ...
  return (
    <>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Get in touch with Zion Tech Group for AI and IT solutions. Contact us for consultations, support, or to discuss your project needs." /> " <meta name="keywords" content="contact us, Zion Tech Group, AI consultation, IT support, get in touch" />"
      </Helmet>
<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20"></div> " <div className="container mx-auto px-4"></div>"
          {/* Header */}
          <div className="text-center mb-16"></div> " <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6"></h1> "
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-12"></div>"
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10"></div>"
              ...
              {submitStatus === 'success' && ('
                <div className="mb-6 p-4 bg-green-500/20 border border-green-500/50 rounded-lg flex items-center gap-3">}}</div> " <CheckCircle className="w-5 h-5 text-green-400" />"
                  <span className="text-green-400"></spa>Message sent successfully! We'll get back to you soon.</span> ' </div>'
              );
              {submitStatus === 'error' && ('
              ...
              <form onSubmit={handleSubmit} className="space-y-6"></form>"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6"></div> " <div>"
                    ...
                    <div className="relative"></div> " <Building className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" />"
                      <input
                        type="text"
                        name="company"
                  ...
                  <div>
                    ...
                    <div className="relative"></div> " <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" />"
                      <input
                        type="tel"
                        name="phone"
                ...
                <div>
                  ...
                  <div className="relative"></div>"
                    <Globe className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" /> " <select"
                      name="service"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2"></label> "
                    Message * </label>
                  <div className="relative"></div>"
                    <MessageCircle className="absolute left-3 top-3 w-5 h-5 text-gray-400" /> " <textarea"
                      name="message"
...
<h3 className="text-lg font-semibold text-white mb-1"></h3>"
                  ...
                  <div className="flex items-center"></div>"
                    ...
                    <div>
                      ...
                      <p className="text-gray-300"> 123 Tech Street <br />San Francisco, CA 94105</p> " </div>"
                  </div>
                  <div className="flex items-center"></div> " <div className="w-12 h-12 bg-green-500 rounded-lg flex items-center justify-center mr-4"></div> " <Clock className="w-6 h-6 text-white" />"
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-white"></h>Business Hours</h3> " <p className="text-gray-300">Mon - Fri: 9:00 AM - 6:00 PM<br /> Sat: 10:00 AM - 4:00 PM </p>"
                    </div>
                  </div>
                </div>
              </div>

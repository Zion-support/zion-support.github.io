...
<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20"></div>
        <div className="container mx-auto px-4"></div>
          ...
          <div className="text-center mb-16"></div>
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Ready to transform your business? Let's discuss your project and explore;</p>
    ...
    isSubmitting ? (;</button>
            ...
            <div className="space-y-8"></div>
              <div />
                ...
                <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">We're here to help! Reach out to us through any of these channels</p>

...
const services = [
    ...
    'Cybersecurity',
    'DevOps',
    'Consulting',</HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>
    'Other';</HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>
  ]</HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>const contactInfo = [
    {
    icon: Phone,
      title: 'Phone',
...
<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20"></div>
        <div className="container mx-auto px-4"></div>{/* Header */}<//div>
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-12"></div>{/* Contact Form */}<//div>

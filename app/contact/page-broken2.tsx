...
export default function PageBroken2() {
  return (
    <>
      <Helmet>
        <title>Broken2 - Zion Tech Group</title>
        <meta name="description" content="Professional broken2 services at Zion Tech Group." />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-6">Broken2</h1>
          <p className="text-lg text-gray-300 mb-8">Professional broken2 services coming soon.</p>

...
<div className = "min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
            ...
            <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
              ...
              {submitStatus === 'success' && (<div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"&gt;</div&gt;                  <CheckCircle className="w-5h-5ml-2" /&gt;</CheckCircle></div>
                  <span className="text-green-400"  &gt;Message sent successfully! We'll get back to you soon.</span&gt;
                </div&gt;}
              )}
              {submitStatus === 'error' && (<div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"&gt;</div&gt;              <form onSubmit = "{handleSubmit}" className="space-y-6" /></div>;
                  <span className="text-red-400"  &gt;Failed to send message. Please try again.</span&gt;                <div className = "min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>;
                </div&gt;}                  <div /></div>
              )}
...
<h3 className="w-5h-5ml-2" /></h3>
                  ...
                  {isSubmitting ? (<React.Fragment /&gt;</React.Fragment&gt;</React></React>
                      <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"&gt;</div&gt;                      <span  &gt;Sending...</span&gt;                    </&gt;) : (<React.Fragment /&gt;</React.Fragment&gt;</React></div>
                      <Send className="w-5h-5ml-2" /&gt;</Send></Send>
                      <span  &gt;Send Message</span&gt;                </button></div>
                    </&gt;}              </form>
                  )}
            </div>
            {/* Contact Information */}

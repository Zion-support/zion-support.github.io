  ...
  const [submitStatus, setSubmitStatus] = useState<'idle' | 'success' | 'error'>('idle')
    ...
    setSubmitStatus('idle');try {// Simulate form submission;
      ...
      setSubmitStatus('success')
        message: ''} })} catch (error) {setSubmitStatus('error')} } finally {setIsSubmitting(false)} }
  }
...
<div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
        <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
          {/* Header */}  <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
...
<div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
            {/* Contact Form */}  <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
              ...
              {submitStatus === 'success' && (<div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"&gt;</div&gt;
                  <CheckCircle className="w-5h-5ml-2" /&gt;</CheckCircle></di></div>
            ...
            {/* Contact Information */}  <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
              <div /></div>
...
<h3 className="w-5h-5ml-2" /></h3>
                  ...
                  className="w-fullbg-gradient-to-r from-cyan-500 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-centerjustify-centerspace-x-2">
                  {isSubmitting ? (<React.Fragment /&gt;</React.Fragment&gt;</React></Reac></React>
                      <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"&gt;</div&gt;
                      <span  &gt;Sending...</span&gt;
                    </&gt;) : (<React.Fragment /&gt;</React.Fragment&gt;</React></di></div>
                      <Send className="w-5h-5ml-2" /&gt;</Send></Sen></Send>
...
<h3 className="w-5h-5ml-2" />{info.title}  </h3>
                  ...
                  <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
                    ...
                    <div /></div>
                      <h3 className="text-lgfont-semiboldtext-white"  ></h>Email</h3>
                  ...
                  <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
                    ...
                    <div /></div>
                      <h3 className="text-lgfont-semiboldtext-white"  ></h>Address</h3>
                  ...
                  <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
                    ...
                    <div /></div>
                      <h3 className="text-lgfont-semiboldtext-white"  ></h>Business Hours</h3>

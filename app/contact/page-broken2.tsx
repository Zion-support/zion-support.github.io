        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-16">
            <h1 className="text-5xl lg:text-7xl font-bold text-white mb-6">              Get in
              ...
              <
            <
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">              Ready to transform your business? Let's discuss your project and explore 
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-300 mb-8">                  We're here to help! Reach out to us through any of these channels 
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-300 mb-8">                    We're here to help you transform your business with cutting-edge AI and technology solutions.
                  <
                <

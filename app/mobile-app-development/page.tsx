...
const MobileAppDevelopmentPage: React.FC = () => {
  ...
  const features = ['iOS & Android Development', 'Cross-Platform Solutions', 'Native Performance', 'UI/UX Design', 'App Store Optimization', 'Maintenance & Support']

  const benefits = ['Increase mobile presence by 300%', 'Native performance optimization', 'Cross-platform compatibility', 'Professional UI/UX design', 'App store optimization', 'Ongoing maintenance support']

  const pricing = [{
      plan: 'Basic App', price: '$1, 999/month', features: ['Simple functionality', 'Basic UI/UX', 'iOS or Android', '3 months support'],
      popular: false
            ...
            <div className="text-center mb-16">
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-2xl flex items-center justify-center">
                  <Smartphone className="w-8 h-8 text-white" /></Smartphone>
                </div>
              </div>

    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      <article className="prose prose-lg max-w-none">
        ...
        <div className="border-t border-gray-200 pt-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Link to="/case-studies/ai-2026-neural-architecture-search-mega-success" className="block p-4 border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-all duration-200">
            ...
            <Link to="/case-studies/fortune-500-ai-transformation-mega-success-2026" className="block p-4 border border-gray-200 rounded-lg hover:border-green-300 hover:bg-green-50 transition-all duration-200">

      ...
      <section className="text-left">
        ...
        <div className="text-left">
          <div className="text-left">
            ...
            <div className="text-left">
              <div className="text-left">
                <span className="text-left">Additional Annual Revenue:<"
                <span className="text-left">$50M<"
              </div>
              <div className="text-left">
                <span className="text-left">ROI on AI Investment:<"
                <span className="text-left">340%<"
              </div>
              <div className="text-left">
                <span className="text-left">Cost Reduction:<"
                <span className="text-left">$35M<"
              </div>
              <div className="text-left">
          ...
          <div className="text-left">
            ...
            <div className="text-left">
              ...
              <div className="text-left">
                <span className="text-left">Lead Time Reduction:<"

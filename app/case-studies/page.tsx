  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Real-world success stories from our AI and IT implementations." />
        <meta name="keywords" content="Case Studies, AI solutions, IT services, Zion Tech Group" />
      </Helmet>
        ...
        <section className="py-20 px-4 relative">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
              Real-world success stories from our AI and IT implementations.
            </p>

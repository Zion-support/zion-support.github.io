  ...
  const caseStudies = [
    {
      ...
      service: "ai",
      challenge:
        "Manual diagnosis processes were time-consuming and prone to human error, leading to delayed treatments and inconsistent results.",
      solution:
        "Implemented an AI-powered diagnostic system that analyzes medical images and patient data to provide accurate, rapid diagnoses.",
      results: [
    ...
    },
    {
      ...
      service: "ai",
      challenge:
        "Traditional fraud detection systems were missing sophisticated attacks and generating too many false positives, costing millions in losses.",
      solution:
        "Deployed advanced AI fraud detection system with real-time monitoring and machine learning algorithms.",
      results: [
    ...
    },
    {
      ...
      service: "ai",
      challenge:
        "Outdated manufacturing processes were causing production delays, quality issues, and high operational costs.",
      solution:
        "Implemented comprehensive smart factory solution with AI-powered predictive maintenance and quality control.",
      results: [
    ...
    },
    {
      ...
      service: "ai",
      challenge:
        "Generic customer experiences were leading to low engagement and poor conversion rates across all channels.",
      solution:
        "Deployed AI-powered personalization engine that creates unique experiences for each customer.",
      results: [
    ...
    },
    {
      ...
      service: "cloud",
      challenge:
        "On-premises infrastructure was limiting scalability and causing frequent downtime during peak usage.",
      solution:
        "Migrated entire infrastructure to cloud with automated DevOps pipelines and monitoring.",
      results: [
    ...
    },
    {
      ...
      service: "security",
      challenge:
        "Legacy security systems were vulnerable to modern cyber threats and non-compliant with new regulations.",
      solution:
        "Implemented comprehensive security suite with advanced threat detection and compliance management.",
      results: [
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl lg:text-2xl text-gray-300 mb-8 leading-relaxed">
              ...
              businesses across industries transform their operations with AI
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {filteredCaseStudies.map((study) => (
                <div
                  key={study.id}
                  className="bg-slate-800/50 rounded-lg overflow-hidden hover:bg-slate-700/50 transition-all duration-300"
                >
                  <div className="relative">
                    ...
                    <div className="absolute top-4 left-4 flex gap-2">
                      <div
                        className={`w-8 h-8 ${getServiceColor(study.service)}`}
                      >
                        {React.createElement(getServiceIcon(study.service), {
                          className: "w-8 h-8",
                        })}
                      </div>
                  ...
                  <div className="p-6">
                    <div className="flex items-center space-x-2 mb-3">
                      ...
                      />
                      <span className="text-cyan-400 font-medium text-sm capitalize">
                        {study.industry}
                      </span>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="case studies, success stories, client results, AI solutions, business transformation" />
      </Helmet>
                    ...
                    <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8">
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-purple-400 font-semibold">{study.company}</p>
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="text-gray-300 text-sm">{study.results.performance}</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <Users className="w-5 h-5 text-blue-400" />
                              <span className="text-gray-300 text-sm">{study.results.conversion}</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <DollarSign className="w-5 h-5 text-yellow-400" />
                              <span className="text-gray-300 text-sm">{study.results.revenue}</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <Star className="w-5 h-5 text-purple-400" />
                              <span className="text-gray-300 text-sm">{study.results.satisfaction}</span>
                            </div>
                          </div>
                        </div>

...
import { CheckCircle, ArrowRight, Users, Award, Clock, Star, TrendingUp, Building } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Explore some of our most successful projects and the impact they've had on our clients.
              </p>
            </div>

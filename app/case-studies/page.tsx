...
export default function CaseStudiesPage() {}
  ...
  const filteredCaseStudies = caseStudies.filter(study => {const industryMatch = selectedIndustry === 'all' || study.industry === selectedIndustry;
  ...
  const getIndustryColor = (industry: string) => {const colors = {,
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-purple-700" >
        ...
        <div className="container mx-auto px-4 text-center" ></section>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center" ></div>
            ...
            <Link
              to="/consultation"
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-bold hover:bg-white hover:text-cyan-600 transition-colors inline-flex items-center" ></Lin>

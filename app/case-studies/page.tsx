  ...
  const caseStudies = [
    {
      ...
      challenge: 'Manual data analysis processes were taking 40+ hours per week and prone to human error',
      solution: 'Developed custom AI platform with machine learning models for real-time financial data analysis',
      results: [
    ...
    },
    {
      ...
      industry: 'Healthcare',
      challenge: 'Manual patient scheduling and billing processes causing delays and errors',
      solution: 'Comprehensive automation platform with AI-powered scheduling and billing optimization',
      results: [
    ...
    },
    {
      ...
      challenge: 'Need for affordable, scalable analytics solution for small to medium e-commerce businesses',
      solution: 'Built comprehensive micro SaaS platform with real-time analytics, inventory management, and customer insights',
      results: [
    ...
    },
    {
      ...
      solution: 'IoT platform with sensors, real-time monitoring, and predictive maintenance capabilities',
      results: [
      ...
      technologies: ['Python', 'IoT Sensors', 'AWS IoT', 'React', 'Time Series DB'],
      duration: '8 months',
      team: '10 developers',
      image: '/api/placeholder/600/400',
      featured: false
    },
    {
      ...
      challenge: 'Need for transparent, tamper-proof supply chain tracking across multiple countries',
      solution: 'Blockchain-based supply chain platform with smart contracts and real-time tracking',
      results: [
    ...
    },
    {
      ...
      challenge: 'Increasing cyber threats requiring 24/7 monitoring and rapid response capabilities',
      solution: 'AI-powered cybersecurity platform with threat detection, automated response, and compliance reporting',
      results: [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our most impactful projects that showcase the power of technology transformation
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-xl p-8 text-center shadow-lg">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              ...
              with our technology solutions. Let's discuss how we can help you achieve similar results.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
  ...
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
      ...
      <div className="p-6">
        ...
        <p className="text-gray-600 text-sm mb-3"><strong>Client:</strong> {study.client}</p>
        
        <div className="mb-4">
          <h4 className="font-medium text-gray-900 text-sm mb-1">Key Results:</h4>

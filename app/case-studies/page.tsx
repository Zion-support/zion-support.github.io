...
export const metadata: Metadata = {
  ...
  description:
    'Discover real-world AI transformation success stories. See how companies achieved $500M+ savings, 99% automation, and 600% ROI with our AI solutions.',
  keywords:
    'AI case studies, success stories, AI transformation, enterprise AI, automation success, AI ROI, digital transformation',
};
...
const caseStudies = [
  {
    ...
    excerpt:
      'See how a Fortune 500 manufacturer achieved 90% efficiency gains and $50M annual savings through comprehensive AI transformation.',
  ...
  },
  {
    ...
    excerpt:
      'See how a Fortune 500 company achieved $50M+ in savings and a 300% ROI through comprehensive AI transformation with Zion Tech Group.',
  ...
  {
    title:
      'AI FinTech Quantum Transformation 2026: $100M Revenue & 99.9% Security',
    slug: 'ai-fintech-quantum-transformation-2026',
    excerpt:
      'See how a leading FinTech achieved $100M revenue increase, 99.9% security improvement, and quantum-powered trading capabilities.',
  ...
  },
  {
    ...
    excerpt:
      'Discover how a Fortune 500 company achieved $500M+ annual savings and 99% process automation through comprehensive AI transformation.',
    company: 'Fortune 500 Manufacturing',
    industry: 'Manufacturing',
    results: {
      savings: '$500M+',
  ...
  },
  {
    ...
    excerpt:
      'Achieved 80% faster response time, 24/7 support, and 95% customer satisfaction with AI virtual assistant.',
  ...
  },
  {
    ...
    excerpt:
      'Achieved 75% process efficiency improvement and 300% ROI in 6 months with AI workflow automation.',
  ...
  },
  {
    ...
    excerpt:
      'Achieved zero-defect manufacturing with 99.99% quality assurance and 60% increase in production efficiency.',
      ...
      <section className='bg-gradient-to-r from-green-600 to-blue-600 py-20'>
        <div className='container mx-auto px-6 text-center'>
          ...
          <p className='text-xl text-green-100 mb-8 max-w-3xl mx-auto'>
            Real-world AI transformation success stories from Fortune 500
            companies and enterprise clients. See how our solutions deliver
            measurable results.
          </p>
              ...
              >
                ...
                <div className='p-6'>
                  <div className='flex items-center gap-2 mb-3'>
                    <span
                      className={`bg-${study.color}-100 text-${study.color}-800 px-2 py-1 rounded-full text-xs font-medium`}
                    >
                      {study.industry}
                    </span>

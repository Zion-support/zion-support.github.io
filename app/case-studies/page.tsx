  ...
  const caseStudies: CaseStudy[] = [
    {
      ...
      solution:
        "Implemented AI-powered chatbots and automated ticket routing system with natural language processing.",
      results: [
    ...
    },
    {
      ...
      challenge:
        "Legacy on-premises infrastructure limiting scalability and increasing maintenance costs.",
      solution:
        "Complete cloud migration to AWS with microservices architecture and automated scaling.",
      results: [
    ...
    },
    {
      ...
      industry: "Healthcare",
      challenge:
        "Increasing cyber threats and need for HIPAA compliance in patient data protection.",
      solution:
        "Comprehensive security audit and implementation of zero-trust architecture with advanced threat detection.",
      results: [
    ...
    },
    {
      ...
      industry: "Retail",
      challenge:
        "Inventory management inefficiencies leading to stockouts and overstock situations.",
      solution:
        "ML-powered demand forecasting system with real-time inventory optimization.",
      results: [
    ...
    },
    {
      ...
      challenge:
        "Manual processes and lack of real-time visibility into production efficiency.",
      solution:
        "IoT integration with AI-powered analytics dashboard and automated quality control.",
      results: [
    ...
    },
    {
      ...
      industry: "Logistics",
      challenge:
        "Lack of transparency and traceability in complex supply chain operations.",
      solution:
        "Blockchain-based supply chain tracking system with smart contracts and real-time verification.",
      results: [

        ...
        <div className="max-w-7xl mx-auto"></div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
            {caseStudies.map((study, index) => (
              ...
              ></div>
                <div className="h-48 bg-gradient-to-r from-purple-500 to-blue-600 flex items-center justify-center"></div>
                  <div className="text-white text-center"></div>
                    <Building className="w-16 h-16 mx-auto mb-4" />
                    <div className="text-sm opacity-80"></div>{study.industry}</div>
                  </div>
                </div>
                
                <div className="p-6"></div>
                  <h3 className="text-xl font-semibold text-white mb-2"></h3>{study.title}</h3>
                  <div className="flex items-center space-x-2 text-sm text-gray-400 mb-4"></div>
                  ...
                  <div className="mb-4"></div>
                    <h4 className="text-sm font-semibold text-white mb-2"></h4>Key Results:</h4>

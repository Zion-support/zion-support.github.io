...
import { ArrowRight, ExternalLink, Building, Users, TrendingUp, Award, CheckCircle } from 'lucide-react';
...
const CaseStudiesPage: React.FC = () => {
  const caseStudies: CaseStudy[] = [
    ...
    },
    {
      ...
      image: '/api/placeholder/600/400',
      description: 'Built a comprehensive ML platform for predictive analytics and business intelligence.',
      results: ['300% faster data processing', '85% accuracy improvement', 'Real-time insights']
    },
    {
      id: '5',
      ...
      image: '/api/placeholder/600/400',
      description: 'Connected manufacturing equipment with IoT sensors for predictive maintenance and optimization.',
      results: ['25% reduction in downtime', '30% energy savings', 'Predictive maintenance success']
    },
    {
      id: '6',
      title: 'Blockchain Supply Chain Solution',
      client: 'SupplyChain Global',
      industry: 'Logistics',
      image: '/api/placeholder/600/400',
      description: 'Implemented blockchain technology for transparent and secure supply chain management.',
      results: ['100% traceability', '50% faster transactions', 'Enhanced security']
    }
  ];
            ...
            {caseStudies.map((study, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white px-4 py-2 rounded-lg font-semibold hover:from-purple-700 hover:to-blue-700 transition-all duration-300 flex items-center justify-center group">

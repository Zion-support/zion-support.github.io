...
export default function CaseStudiesPage() {
  ...
  const caseStudies = [{
id: 1, title: 'AI-Powered Supply Chain Optimization', client: 'Global Manufacturing Corp', industry: 'Manufacturing', category: 'ai', challenge: 'Inefficient supply chain management leading to 30% inventory waste and delayed deliveries', solution: 'Implemented AI-driven demand forecasting and automated inventory management system', results: [
    ...
    },
    {
      ...
      results: ['99.9% system uptime achieved', '50% reduction in infrastructure costs', 'Enhanced security compliance', '3x faster application deployment'],
    ...
    },
    {
      ...
      results: ['50, 000+ active users in first year', '95% user satisfaction rating', '40% reduction in hospital visits', 'Streamlined patient-doctor communication'],
...
const CaseStudiesPage: React.FC = () => {
  ...
  const caseStudies = [{
    ...
    },
    {
      ...
      industry: 'Finance',
      duration: '4 months',
      results: ['99.9% uptime achieved', '60% reduction in infrastructure costs', '3x faster application performance', 'Zero downtime during migration'],
    ...
    },
    {
      ...
      industry: 'Retail',
      duration: '3 months',
      results: ['40% increase in revenue', '85% improvement in decision-making speed', 'Real-time analytics dashboard', 'Predictive inventory management'],
                  ...
                  <div className="bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-2xl p-8 backdrop-blur-lg border border-white/10">
                    <div className="text-center text-white">
                      ...
                      <div className="grid grid-cols-2 gap-6">
                        <div className="text-center">
                          <TrendingUp className="w-8 h-8 text-cyan-400 mx-auto mb-2" /></TrendingUp>
                          <div className="text-xl font-bold">{study.results.conversion}</div>
                          <div className="text-sm opacity-75">Conversion Rate</div>
                        </div>
                        <div className="text-center">
                          <DollarSign className="w-8 h-8 text-cyan-400 mx-auto mb-2" /></DollarSign>

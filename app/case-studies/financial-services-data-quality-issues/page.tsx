...
export const metadata: Metadata = {
  title: 'Financial Services Case Study: 99% accuracy improvement | Zion Tech Group',
  description: 'Learn how we helped Financial Services Solutions Inc achieve 99% accuracy improvement through Machine learning models.',
  openGraph: {
    title: 'Financial Services Case Study | Zion Tech Group',
    description: '99% accuracy improvement',
    url: 'https://ziontechgroup.com/case-studies/financial-services-data-quality-issues',
  },

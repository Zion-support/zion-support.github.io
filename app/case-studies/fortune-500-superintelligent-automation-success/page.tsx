    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mt-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Link to="/case-studies/ai-2027-consciousness-fusion-mega-success" className="group block bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-purple-500/50 transition-all duration-300">
            ...
            <Link to="/case-studies/quantum-ai-enterprise-transformation" className="group block bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-blue-500/50 transition-all duration-300">
            ...
            <Link to="/case-studies/autonomous-enterprise-operations-success" className="group block bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-green-500/50 transition-all duration-300">

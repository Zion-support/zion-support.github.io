      ...
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-2xl md:text-3xl text-gray-300 mb-8 font-semibold max-w-3xl mx-auto">
            How a Fortune 500 company achieved unprecedented success with Meta-Cognitive Superintelligence AI
          </p>
        ...
        <section id="case-study-details" className="py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              our Meta-Cognitive Superintelligence AI system across their global operations.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-blue-500/50 transition-all duration-300">
              ...
              <p className="text-gray-300 mb-6">
                Revolutionary AI system capable of thinking about its own thinking processes, 
                enabling self-improvement and autonomous decision-making.
              </p>
              <ul className="space-y-2 mb-6 text-gray-300">
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-purple-500/50 transition-all duration-300">
              ...
              <p className="text-gray-300 mb-6">
                Achieved $5 billion in measurable value through cost savings, revenue increase, 
        ...
        <div className="bg-gradient-to-r from-green-900/50 via-emerald-900/50 to-teal-900/50 rounded-xl p-8 border border-green-500/30 text-center">
          ...
          <p className="text-xl text-gray-300 mb-6">
            Discover how your organization can leverage Meta-Cognitive Superintelligence AI 
            to achieve unprecedented business transformation.
          </p>

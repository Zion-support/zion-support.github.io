    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-200 sticky top-0 z-50 bg-white shadow-sm">
        <nav className="flex items-center justify-between px-4 py-3 max-w-6xl mx-auto">
          <a href="/" className="font-bold text-lg text-gray-900 hover:text-blue-600 transition-colors">
            Zion Tech Group
          </a>
          <div className="hidden md:flex gap-6">
            <a href="/case-studies" className="text-gray-700 hover:text-blue-600 transition-colors">Case Studies</a>
            <a href="/content-hub" className="text-gray-700 hover:text-blue-600 transition-colors">Content Hub</a>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <section className="mt-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <a href="/case-studies/ai-supply-chain-optimization-2026" className="group">
            ...
            <a href="/case-studies/ai-finance-automation" className="group">
              <div className="border border-gray-200 rounded-xl p-6 hover:border-blue-300 transition-colors">
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600">
            ...
            <a href="/case-studies/retail-ai-transformation" className="group">
              <div className="border border-gray-200 rounded-xl p-6 hover:border-blue-300 transition-colors">
                <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div>
              ...
              <div className="space-y-2">
                <a href="/services" className="block text-gray-600 hover:text-blue-600 transition-colors">All Services</a>
                <a href="/services/ai-autonomous-operations" className="block text-gray-600 hover:text-blue-600 transition-colors">AI Autonomous Operations</a>
                <a href="/services/micro-saas" className="block text-gray-600 hover:text-blue-600 transition-colors">Micro SaaS</a>
              </div>
            </div>
            <div>
              ...
              <div className="space-y-2">
                ...
                <a href="/content-hub" className="block text-gray-600 hover:text-blue-600 transition-colors">Content Hub</a>
                <a href="/case-studies" className="block text-gray-600 hover:text-blue-600 transition-colors">Case Studies</a>
              </div>
            </div>
            <div>

                ...
                <div className="text-left">
                  ...
                  <div className="text-left">
                    <div className="text-left">
                      ...
                      <span className="text-left">$5.2 Billion<"
                    </div>
                    <div className="text-left">
                      <span className="text-left">Annual Cost Savings:<"
                      <span className="text-left">$2.1 Billion<"
                    </div>
                    <div className="text-left">
                ...
                <div className="text-left">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-left">
                      ...
                      <span className="text-left">99% improvement<"
                    </div>
                    <div className="text-left">
                      <span className="text-left">Supply Chain:<"
                      <span className="text-left">85% waste reduction<"
                    </div>
                    <div className="text-left">

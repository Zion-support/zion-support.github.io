        ...
        <div className="text-left">"
          <div className="text-left">"
            ...
            <ul className="text-left">"
              <li className="text-left">"
                ...
                <span className="text-left">1,000,000x faster<"
              </li>
              <li className="text-left">"
                <span>Accuracy Rate:<
              ...
              <li className="text-left">"
                <span>Response Time:<
                <span className="text-left">Sub-millisecond<"
              </li>
              <li className="text-left">"
                <span>Uptime:<
          ...
          <div className="text-left">"
            ...
            <ul className="text-left">"
              ...
              <li className="text-left">"
                <span>Maintenance Savings:<
                <span className="text-left">$200B<"
              </li>
              <li className="text-left">"

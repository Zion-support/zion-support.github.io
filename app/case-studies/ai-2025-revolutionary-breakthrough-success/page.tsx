        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8">
          <div className="space-y-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Week 1-2: Assessment & Planning</h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Week 3-4: System Design</h3>
                <p className="text-gray-600">Custom AI architecture design and integration planning.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold text-sm">3</div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Week 5-8: Implementation</h3>
                <p className="text-gray-600">AI system deployment and integration with existing infrastructure.</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-8 h-8 bg-green-500 rounded-full flex items-center justify-center text-white font-bold text-sm">4</div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-2">Week 9-12: Optimization</h3>
                <p className="text-gray-600">Performance tuning and continuous improvement.</p>
              </div>
            </div>
          </div>
        </div>

        ...
        <div className="text-left">
          ...
          <ul className="text-left">
            <li className="text-left">
              <span className="text-left">•<"
              <span><strong>Autonomous Manufacturing:</strong> Fully self-managing production facilities with minimal human oversight<
            </li>
            <li className="text-left">
              <span className="text-left">•<"
              <span><strong>Predictive Market Intelligence:</strong> AI systems that anticipate market changes and adjust strategies accordingly<
            </li>
            <li className="text-left">
              <span className="text-left">•<"
              <span><strong>Sustainable Operations:</strong> AI-driven sustainability initiatives targeting carbon neutrality<
            </li>
          </ul>

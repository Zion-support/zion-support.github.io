    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <a href="/services/ai-edge-computing-solutions" className="block p-4 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-lg hover:shadow-lg transition-shadow">
        ...
        <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white p-6 rounded-lg mt-8">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="/contact" className="bg-white text-green-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
              Start Your Transformation
            </a>
            <a href="/services/ai-edge-computing-solutions" className="bg-green-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-400 transition-colors">
              View Our Services
            </a>
          </div>
        </div>

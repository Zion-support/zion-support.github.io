...
export const metadata: Metadata = {
  title: 'Logistics Case Study: 99% accuracy improvement | Zion Tech Group',
  description: 'Learn how we helped Logistics Solutions Inc achieve 99% accuracy improvement through Computer vision.',
  openGraph: {
    title: 'Logistics Case Study | Zion Tech Group',
    description: '99% accuracy improvement',
    url: 'https://ziontechgroup.com/case-studies/logistics-competitive-pressure',
  },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Logistics Solutions Inc was facing significant challenges with competitive pressure,

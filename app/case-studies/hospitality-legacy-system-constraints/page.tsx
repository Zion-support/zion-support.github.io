...
export const metadata: Metadata = {
  title: 'Hospitality Case Study: 100% compliance achievement | Zion Tech Group',
  description: 'Learn how we helped Hospitality Solutions Inc achieve 100% compliance achievement through Automated decision-making.',
  openGraph: {
    title: 'Hospitality Case Study | Zion Tech Group',
    description: '100% compliance achievement',
    url: 'https://ziontechgroup.com/case-studies/hospitality-legacy-system-constraints',
  },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Hospitality Solutions Inc was facing significant challenges with legacy system constraints,

      ...
      <section className="text-left">
        ...
        <div className="text-left">
          <div className="text-left">
            ...
            <div className="text-left">
              <div className="text-left">
                <span className="text-left">Mission Completion:<"
                <span className="text-left">100%<"
              </div>
              <div className="text-left">
                <span className="text-left">Navigation Accuracy:<"
              ...
              <div className="text-left">
                <span className="text-left">Data Quality:<"
          ...
          <div className="text-left">
            ...
            <div className="text-left">
              <div className="text-left">
                <span className="text-left">Mission Duration:<"
                <span className="text-left">-33%<"
              </div>
              <div className="text-left">
                <span className="text-left">Fuel Efficiency:<"
                <span className="text-left">+45%<"
              </div>
              <div className="text-left">
                <span className="text-left">Data Collection:<"
                <span className="text-left">+500%<"
              </div>
              <div className="text-left">
                <span className="text-left">Human Intervention:<"

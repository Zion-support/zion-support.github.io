    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          <div className="bg-gradient-to-br from-green-50 to-emerald-100 p-6 rounded-lg">
            ...
            <ul className="text-green-800 space-y-2">
              ...
              <li>• <strong>$1.8B</strong> Operational Savings</li>
            </ul>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-100 p-6 rounded-lg">
            ...
            <ul className="text-blue-800 space-y-2">
              ...
              <li>• <strong>78%</strong> Faster Decision Making</li>
            </ul>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="text-gray-700 space-y-2">
                ...
                <li><strong>Facilities:</strong> 200+ Locations</li>
              </ul>
            </div>
            <div>
        ...
        <div className="bg-green-50 border-l-4 border-green-400 p-6 mb-8">
          ...
          <div className="flex gap-4">
            <Link 
              href="/<contact" className="bg-green-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition-colors"
            >
              Start Your Transformation
            </Link>
            <Link 
              href="/<services" className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors"
            >
              View Our Services
            </Link>
          </div>
      ...
      <div className="mt-12 border-t pt-8">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <Link 
            href="/case-studies/ai-2026-global-enterprise-transformation-<success" className="block p-4 border rounded-lg hover:shadow-md transition-shadow"
          >
          ...
          <Link 
            href="/case-studies/fortune-500-ai-transformation-mega-success-<2026" className="block p-4 border rounded-lg hover:shadow-md transition-shadow"
          >

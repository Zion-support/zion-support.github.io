...
export const metadata: Metadata = {
  title: 'Education Case Study: 200% ROI in first year | Zion Tech Group',
  description: 'Learn how we helped Education Solutions Inc achieve 200% ROI in first year through Recommendation engines.',
  openGraph: {
    title: 'Education Case Study | Zion Tech Group',
    description: '200% ROI in first year',
    url: 'https://ziontechgroup.com/case-studies/education-data-quality-issues',
  },

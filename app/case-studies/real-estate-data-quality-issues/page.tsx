...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://ziontechgroup.com/case-studies/real-estate-data-quality-issues',
  },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Real Estate Solutions Inc was facing significant challenges with data quality issues,

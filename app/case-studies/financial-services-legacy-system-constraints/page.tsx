...
export const metadata: Metadata = {
  title: 'Financial Services Case Study: 50% reduction in costs | Zion Tech Group',
  description: 'Learn how we helped Financial Services Solutions Inc achieve 50% reduction in costs through Anomaly detection.',
  openGraph: {
    title: 'Financial Services Case Study | Zion Tech Group',
    description: '50% reduction in costs',
    url: 'https://ziontechgroup.com/case-studies/financial-services-legacy-system-constraints',
  },
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      <section className="py-20 max-w-5xl mx-auto px-4">
        ...
        <p className="text-xl text-gray-600 leading-relaxed">
          A case study on transforming financial services operations through
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-4">
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Financial Services Solutions Inc was facing significant challenges with legacy system constraints,

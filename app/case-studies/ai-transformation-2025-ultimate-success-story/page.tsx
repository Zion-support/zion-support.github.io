            ...
            <div>
              ...
              <div>
                ...
                <div>
                  ...
                  <div className="text-sm opacity-75">Total Annual Impact</div>
                </div>
                <div>
                  <div className="text-2xl font-bold">99%</div>
                  <div className="text-sm opacity-75">Employee Satisfaction</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16">
          <div>
            <div>
              ...
              <div>
                <div>
                  ...
                  <ul className="space-y-2 text-red-700">
                    ...
                    <li>• <strong>Supply Chain Disruptions:</strong> 34% increase in delivery delays</li>
              ...
              <h3>Phase 1: AI Readiness Assessment (Months 1-2)</h3>
              <p><strong>Initial Investment:</strong> $2.5 million</p>
              <p>Our team conducted a comprehensive analysis of GMS's operations, identifying 47 high-impact AI implementation opportunities across: </p>
              <div>
              ...
              <p><strong>Investment:</strong> $8.2 million</p>
              <p>We selected three high-impact pilot programs:</p>
              <div>
                <div>
              ...
              <h3>Phase 3: Enterprise-Wide Rollout (Months 7-18)</h3>
              <p><strong>Investment:</strong> $15.8 million</p>
              <p>Building on pilot success, we implemented AI across all GMS operations: </p>
              <div>
                <div>
                ...
                <div>
                  ...
                  <ul className="text-sm text-cyan-700 space-y-1">
                    ...
                    <li>• <strong>Cost Savings:</strong> $890 million annually</li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="text-sm text-pink-700 space-y-1">
                    ...
                    <li>• <strong>Cost Reduction:</strong> $234 million annually</li>
                  </ul>
                </div>
              </div>
              ...
              <div>
                ...
                <div>
                  <div>
                    <div className="text-3xl font-bold">$26.5M</div>
                    <div className="text-sm opacity-90">Total Investment</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold">$212.4M</div>
              ...
              <div>
                <div>
                  ...
                  <ul className="space-y-2 text-green-700">
                    ...
                    <li>• <strong>Maintenance Optimization:</strong> $234 million</li>
                    <li>• <strong>Customer Service:</strong> $156 million</li>
                    <li>• <strong>Administrative Automation:</strong> $89 million</li>
                  </ul>
                </div>
                <div>
                  ...
                  <ul className="space-y-2 text-blue-700">
                    ...
                    <li>• <strong>Premium Pricing:</strong> $95 million</li>
                  </ul>
                </div>
              </div>
              <div>

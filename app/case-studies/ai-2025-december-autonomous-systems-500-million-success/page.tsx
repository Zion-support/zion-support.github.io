        ...
        <footer className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row gap-6">
            <div className="flex-1">
              ...
              <Link 
                href="/<contact" className="inline-block bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-400 hover:to-emerald-500 text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 shadow-lg hover:shadow-green-500/50"
              >
            ...
            <div className="flex-1">
              ...
              <div className="space-y-3">
                <Link 
                  href="/blog/ai-2025-december-advanced-autonomous-<systems" className="block p-4 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-lg border border-blue-500/30 hover:border-blue-400/50 transition-colors"
                >
                ...
                <Link 
                  href="/blog/ai-2025-december-quantum-computing-<breakthrough" className="block p-4 bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-lg border border-purple-500/30 hover:border-purple-400/50 transition-colors"
                >

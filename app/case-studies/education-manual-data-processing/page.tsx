...
export const metadata: Metadata = {
  title: 'Education Case Study: 50% reduction in costs | Zion Tech Group',
  description: 'Learn how we helped Education Solutions Inc achieve 50% reduction in costs through Recommendation engines.',
  openGraph: {

  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <meta
          name="description"
          content="Professional aivideoanalysis solutions powered by advanced AI and cutting-edge technology."
        />
        <meta
          name="keywords"
          content="aivideoanalysis, AI solutions, IT services, automation, technology, business solutions"
        />
      </Helmet>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI, AiDataVisualization, automation, technology, solutions" />
      </Helmet>"
      {/* Hero Section */};""
        ...
        <div className="max-w-7xl mx-auto">""
          <div className="text-center">""
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">,
              Advanced ai data visualization solutions powered by artificial intelligence to transform your business operations,"
            </p>""

      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg">
        ...
        <main className="container mx-auto px-4 py-16 pt-24">{/* Hero Section */}</main>
          <section className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 neon-text">AI Data Visualization<p className="text-xl text-cyan-400 mb-8 font-medium">Transform data into actionable insights<p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">Create stunning, interactive data visualizations with AI-powered insights,</p>

  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Transform your data into stunning visualizations with AI-powered analytics, interactive dashboards, and predictive insights. Make data-driven decisions faster."
        ...
        <main className="pt-16">
          ...
          <section className="container mx-auto px-4 py-16 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Transform your data into stunning visualizations with AI-powered analytics and interactive dashboards
              </p>
            </div>
          </section>
          ...
          <section className="container mx-auto px-4 py-16 text-center">
            <div className="cyber-card p-12 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Join 200+ companies already using our AI data visualization solutions
              </p>

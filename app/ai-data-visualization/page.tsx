...
const AiDataVisualizationPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Let AI analyze your data and automatically generate insights and trends.",
      benefits: [
        "Automatic insights",
        "Trend detection",
        "Anomaly detection",
    ...
    },
    {
      ...
      description: "Perform complex statistical analysis and predictive modeling with AI algorithms.",
      benefits: [
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered data visualization for interactive dashboards and insights." />
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Advanced AI-powered data visualization for interactive dashboards and insights.
            </p>

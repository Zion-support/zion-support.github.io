...
const AiEmailAssistantPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Ai Email Assistant Solutions',
      description: 'Professional ai email assistant services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored ai email assistant implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your ai email assistant needs.'
    }
  ];
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Professional Ai email assistant solutions and services
            </p>

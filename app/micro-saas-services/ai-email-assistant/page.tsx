...
export const metadata = {
  ...
  keywords: 'ai email assistant, technology services, Zion Tech Group',
  openGraph: {
    title: 'Ai email assistant | Zion Tech Group',
    description: 'Professional ai email assistant services and solutions by Zion Tech Group.',
    type: 'website',
  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Professional ai email assistant services and solutions by Zion Tech Group." />
      </Head>

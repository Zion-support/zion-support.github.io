...
const AiLeadGenerationPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Ai Lead Generation Solutions',
      description: 'Professional ai lead generation services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored ai lead generation implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your ai lead generation needs.'
    }
  ];
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-8">Ai lead generation</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional Ai lead generation solutions and services
            </p>

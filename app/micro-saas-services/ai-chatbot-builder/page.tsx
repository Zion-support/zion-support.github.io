        ...
        <div className="max-w-4xl mx-auto" >
            ...
            <div className="space-y-6" >)
              <div>)
                ...
                <input;),
                  ...
                  className="w-full p-3 bg-gray-800 text-white rounded-lg border border-gray-600 focus: border-cyan-400 focus:outline-none" placeholder="Enter your bot name..."
                />,
              </div>,
              <div>,
          ...
          <div className="text-center" >
            <a;
              ...
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-indigo-600 transition-all duration-300" >Start Building</a>
            </a>
          </div>
        </div>
      </main>

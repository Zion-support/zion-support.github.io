...
export const metadata = {
  ...
  keywords: 'ai chatbot builder, technology services, Zion Tech Group',
  openGraph: {
    title: 'Ai chatbot builder | Zion Tech Group',
    description: 'Professional ai chatbot builder services and solutions by Zion Tech Group.',
    type: 'website',
  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Professional ai chatbot builder services and solutions by Zion Tech Group." />
      </Head>

      ...
      <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <div className="cyber-card p-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  </div><div className="w-2 h-2 bg-cyan-400 rounded-full"><span className="text-gray-300">Drag-and-drop builder</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-cyan-400 rounded-full"><span className="text-gray-300">Natural language processing</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-cyan-400 rounded-full"><span className="text-gray-300">Multi-language support</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-cyan-400 rounded-full"><span className="text-gray-300">Analytics dashboard</span>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-pink-400 rounded-full"><span className="text-gray-300">Custom branding</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-pink-400 rounded-full"><span className="text-gray-300">Live chat handoff</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-pink-400 rounded-full"><span className="text-gray-300">API access</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <ul className="text-gray-300 space-y-2">
                <li>1 chatbot</li><li>1,000 conversations/month</li>
            ...
            <div className="cyber-card p-6 text-center border-2 border-cyan-400">
              ...
              <ul className="text-gray-300 space-y-2">
                <li>5 chatbots</li><li>10,000 conversations/month</li>
                <li>Advanced features</li><li>Priority support</li><li>Analytics</li>
              </ul>
            </div>
            <div className="cyber-card p-6 text-center">
              ...
              <ul className="text-gray-300 space-y-2">
                <li>Unlimited chatbots</li><li>Unlimited conversations</li>

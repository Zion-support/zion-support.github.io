...
import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Zap, Shield, Brain, Globe  } from 'lucide-react';const MicroSaasServicesPage: React.FC  = () => {
    const features = [
    {
      icon: Brain,
...
export default MicroSaasServicesPage</div>
                </div></div>
                </div></div>
                </div></div>
                </div></div>

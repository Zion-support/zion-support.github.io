...
import { CheckCircle, ArrowRight, Zap, Shield, Globe, DollarSign, Users, Clock, Star, Brain, BarChart, Mail, FileText, CreditCard, Calendar, Camera, Headphones, Database, Lock } from 'lucide-react';
...
const MicroSaasServicesPage: React.FC = () => {
  ...
  const categories = ['All', 'Content', 'Analytics', 'Productivity', 'Sales', 'Marketing', 'Finance'];

...
export const microSaasServices: MicroSaasService[] = [  // AI-Powered Productivity Tools;
  {,;
  ...
  },
  {
    ...
    popular: true,
    category: 'Content & Marketing',    rating: 4.6;
    users: '30,000+',;
    freeTrial: '14 days',;
  ...
  },
  {
    ...
    popular: true,
    category: 'Business & Finance',    rating: 4.9;
    users: '12,000+',;
    freeTrial: '14 days',;

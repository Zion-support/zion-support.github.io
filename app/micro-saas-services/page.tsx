...
export default function Page() {,
  ...
  const microSaasServices = [
    {,
      ...
      icon: <AnalyticsIcon className="w-8 h-8" /></AnalyticsIcon>
    ...
    {,
      ...
      icon: <ProtectionIcon className="w-8 h-8" /></ProtectionIcon>
    ...
    {,
      ...
      icon: <CloudIcon className="w-8 h-8" /></CloudIcon>
      price: "From $99/month"
    ...
    {,
      ...
      icon: <TeamIcon className="w-8 h-8" /></TeamIcon>
    ...
    {,
      ...
      icon: <MarketingIcon className="w-8 h-8" /></MarketingIcon>
    ...
    {,
      ...
      icon: <ScheduleIcon className="w-8 h-8" /></ScheduleIcon>
      price: "From $99/month"
      originalPrice: "$199/month"
      features: [
    ...
    {,
      ...
      icon: <EmailIcon className="w-8 h-8" /></EmailIcon>
      price: "From $79/month"
    ...
    {,
      ...
      icon: <Package className="w-8 h-8" /></Package>
    ...
    {,
      ...
      icon: <Receipt className="w-8 h-8" /></Receipt>
      price: "From $89/month"
    ...
    {,
      ...
      icon: <DocumentIcon className="w-8 h-8" /></DocumentIcon>
    ...
    {,
      ...
      icon: <ConfigIcon className="w-8 h-8" /></ConfigIcon>
  ...
  return()
    <div className="min-h-screen bg-gray-900 text-white" /></div>
      <Helmet /></Helmet>
        ...
        <meta name="description" content="Micro Saas Services solutions by Zion Tech Group" / /></meta>
      </Helmet>

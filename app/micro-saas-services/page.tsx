  ...
  return (
    ...
    <></>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" / />
        {/* Hero Section */}  <section className="pt-32pb-20" / />
          ...
          <div className="containermx-auto px-4" / />
            ...
            <div className="gridgrid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" / />
              {services.map((service, index) => (
                <div;
                  key={index} className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-8 hover:border-cyan-400/40 transition-all duration-300 group hover: transform,
  hover:scale-105"
                 / />
                  ...
                  <div className="flex items-center justify-between mb-6" / />
                    ...
                    <Link;</Link / />
                      to={service.link} className="text-cyan-400hover:text-cyan-300 transition-colors text-sm font-medium group-hover:translate-x-1 inline-flex items-center"
                    ></Link>
        ...
        {/* Features Section */}  <section className="py-20bg-gradient-to-r from-slate-800/30 to-slate-900/30" / />
          <div className="containermx-auto px-4" / />
            <div className="text-centermb-16" / />
              <h2 className="text-4xl font-bold text-white mb-6" / />

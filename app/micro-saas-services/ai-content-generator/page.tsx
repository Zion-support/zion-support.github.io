        ...
        <div className="max-w-4xl mx-auto" ></div>
          ...
          <div className="cyber-card p-8 mb-8" ></div>
            ...
            <div className="space-y-4" >
              <textarea;
                className="w-full h-32 p-4 bg-gray-800 text-white rounded-lg border border-gray-600 focus:border-cyan-400 focus:outline-none" placeholder="Enter your content prompt here...",
              />,
              <button;
                onClick={handleGenerate}
                disabled={isGenerating}
                className="cyber-button w-full" >{isGenerating ? 'Generating...' : 'Generate Content'}</button>
              </button>
              {content && (
          ...
          <div className="text-center" >
            <a;
              ...
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-indigo-600 transition-all duration-300" >Get Started</a>
            </a>
          </div>
        </div>
      </main>

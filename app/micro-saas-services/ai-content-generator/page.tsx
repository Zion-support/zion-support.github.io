...
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed"></p><//p>
              Advanced AI-powered ai content generator solution for modern businesses.</p><>
<//p>
</p><>
<//p>
<div className="flex flex-col sm:flex-row gap-4 justify-center"></div><>
<//div>
<button className="bg-gradient-to-r from-violet-500 to-blue-600 hover:from-violet-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105"></button><//button>
                Get Started</button><>
<//button>
</h1><>
<//h1>
<button className="border border-violet-400 text-violet-400 hover:bg-violet-400 hover:text-white font-bold py-4 px-8 rounded-lg transition-all duration-300"></button><//button>
                View Demo</button><>
<//button>
</h1><>
<//h1>

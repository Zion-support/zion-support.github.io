...
const EnterpriseSolutionsPage: React.FC = () => {
  ...
  const features = ['Enterprise Architecture', 'Scalable Infrastructure', 'Advanced Security', 'Integration Services', '24/7 Support', 'Custom Solutions']

  const benefits = ['Scale to enterprise level', 'Reduce operational costs', 'Enhanced security posture', 'Seamless integrations', 'Dedicated support team', 'Custom enterprise features']

  const pricing = [{
      plan: 'Enterprise Starter', price: '$2, 999/month', features: ['Up to 500 users', 'Basic enterprise features', 'Email support', 'Standard SLA'],
      popular: false

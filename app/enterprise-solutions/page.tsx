  ...
  const features = [
    {
      ...
      description: 'Advanced enterprise solutions solutions powered by artificial intelligence.',
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Professional enterprise solutions services to help your business succeed and grow.
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-12">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Contact us today to learn more about our enterprise solutions services.
              </p>

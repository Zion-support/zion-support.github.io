...
'Gain competitive advantage with advanced technology'
      ...
      <section className="py-16 bg-gray-50" /><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" /><div className="text-center mb-12" /><h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {mobileServices.map((service, index) => (
              </div><div key={index} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow border border-gray-100" /><div className="text-4xl mb-4">{service.icon}</div>
                <h3 className="text-xl font-semibold text-gray-900 mb-3">{service.title}</h3>
                <p className="text-gray-600 mb-4">{service.description}</p>
                <div className="mb-4" /><span className="text-2xl font-bold text-indigo-600">{service.price}</span>
                  <span className="text-sm text-gray-500 ml-2">Market: {service.marketPrice}</span>
                </div>
                <div className="mb-4" /><span className="inline-block bg-indigo-100 text-indigo-800 text-xs font-semibold px-2 py-1 rounded">
                ...
                <div className="space-y-2 mb-6" /><h4 className="font-semibold text-gray-900">Key Benefits:</h4>
      ...
      <section className="py-16 bg-white" /><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" /><div className="text-center mb-12" /><h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Our Mobile Development?</h2>
            </h2>
            <p className="text-xl text-gray-600">
      ...
      <section className="py-16 bg-gray-50" /><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" /><div className="text-center mb-12" /><h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8" /><div className="bg-white rounded-lg p-8 shadow-lg" /><div className="text-yellow-400 text-2xl mb-4">★★★★★</div>
            ...
            <div className="bg-white rounded-lg p-8 shadow-lg" /><div className="text-yellow-400 text-2xl mb-4">★★★★★</div>

  ...
  const mobileServices = [
    {
      ...
      price: '$4999/project',
      features: [
        'Native iOS & Android development', 'AI/ML integration',
      ...
      benefits: [
        'Faster development time', 'Lower development costs',
        'Advanced AI features',
        'Scalable architecture'
      ],
      marketPrice: '$8000-15,000/project',
    ...
    },
    {
      ...
      benefits: [
        'Improve user engagement', 'Reduce support costs',
        '24/7 customer service',
        'Personalized experiences'
      ],
      marketPrice: '$2000-4,000/month',
    ...
    },
    {
      ...
      price: '$899/month'
      features: [
        'User behavior tracking', 'Performance monitoring',
        'Crash analytics',
        'A/B testing',
        'Conversion tracking',
      ...
      benefits: [
        'Improve app performance', 'Increase user retention',
        'Optimize user experience',
        'Data-driven decisions'
      ],
      marketPrice: '$1500-3,000/month',
      category: 'Analytics'
    ...
    },
    {
      ...
      price: '$1599/month',
      features: [
        'Threat detection', 'Data encryption',
      ...
      benefits: [
        'Protect user data', 'Prevent security breaches',
        'Ensure compliance',
        'Build user trust'
      ],
      marketPrice: '$2500-5,000/month',
      category: 'Security'
    ...
    },
    {
      ...
      price: '$1199/month',
      features: [
        'Personalized campaigns', 'Smart push notifications',
        'In-app messaging',
        'User segmentation',
        'A/B testing',
        'Engagement tracking',
      ...
      benefits: [
        'Increase user engagement', 'Boost retention rates',
        'Improve conversion',
    ...
    },
    {
      ...
      price: '$799/month'
      features: [
        'Automated test generation', 'Performance testing',
        'UI/UX testing',
      ...
      benefits: [
        'Reduce testing time by 80%', 'Improve app quality',
        'Catch bugs early',
        'Lower testing costs'
      ],
      marketPrice: '$1200-2,500/month',
      category: 'Testing'
        ...
        <section className="mb-16">
          ...
          <div className="max-w-md mx-auto"></div>
            <div className="bg-slate-800/50 backdrop-blur-lg rounded-2xl p-8 border border-cyan-400/20 text-center"></div>
              <h3 className="text-2xl font-bold text-white mb-4">AI Mobile App Development</h3><div className="text-4xl font-bold text-cyan-400 mb-4">$1500/month</div>

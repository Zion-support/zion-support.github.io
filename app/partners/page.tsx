  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Join our network of strategic partners and expand your business with Zion Tech Group." />
        <meta name="keywords" content="partners, partnerships, strategic alliances, business collaboration" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Join our network of strategic partners and expand your business with Zion Tech Group.
              </p>

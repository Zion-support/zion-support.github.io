...
const PageComponent: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Partners - Zion Tech Group | Our Partners</title>
        <meta name="description" content="Meet our trusted partners and learn about our collaboration opportunities." />
        <meta name="keywords" content="partners, collaboration, business partnerships" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Meet our trusted partners and learn about our collaboration opportunities.
              </p>

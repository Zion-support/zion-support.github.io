...
logo: '/api/placeholder/200/100',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        <title>Partners - Zion Tech Group | Partner Program
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {benefits.map((benefit, index) => (}
                  <div key={index} className="flex items-center text-gray-300">
                    ...
                    {benefit}
                  <h3 className="text-xl font-bold text-gray-900 mb-3">{tier.name}
                  <p className="text-gray-600 mb-6">{tier.description}
                  <div className={`w-full h-2 bg-gradient-to-r ${tier.color} rounded-full`}>
              ))}
      {/* Partners Grid */}
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-900">Our Partners
              ...
              {partners.map((partner, index) => (}
                <div key={index} className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-500">{partner.category}
                    {partner.website && (
                      <a}
                        href={partner.website}
                        target="_blank"
...
{/* CTA Section */}
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-12 text-gray-900">Partner Benefits
      ...
      <section className="py-16 bg-blue-900 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">Ready to Partner With Us?

            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16"></div>
              {partners.map((partner, index) => (
                <div key={index} className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-cyan-400/30 transition-all duration-300"></div>
                  ...
                  <h3 className="text-xl font-bold text-white mb-2"></h3>{partner.name}</h3>
                </div>
              ))}
            </div>
                  </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
      ...
      <section className="py-16 px-4 bg-white/5"></section>
        <div className="max-w-7xl mx-auto"></div>
          <div className="text-center mb-16"></div>
            <h2 className="text-4xl font-bold text-white mb-6"></h2>Why Partner With Us?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8"></div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 text-center"></div>
              ...
              <h3 className="text-xl font-bold text-white mb-4"></h3>Strategic Collaboration</h3>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 text-center"></div>
              ...
              <h3 className="text-xl font-bold text-white mb-4"></h3>Joint Go-to-Market</h3>
              <p className="text-gray-300"></p>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 text-center"></div>
              ...
              <h3 className="text-xl font-bold text-white mb-4"></h3>Certification Programs</h3>
              <p className="text-gray-300"></p>
        ...
        <div className="max-w-7xl mx-auto"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
            {filteredPartners.map((partner) => (
              <div key={partner.id} className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 border border-white/20"></div>
                ...
                <h3 className="text-xl font-bold text-white mb-2"></h3>{partner.name}</h3>
                <p className="text-gray-300 text-sm mb-4"></p>{partner.category}</p>
                <p className="text-gray-300 mb-6"></p>{partner.description}</p>
          ...
          {filteredPartners.length === 0 && (
            <div className="text-center py-12"></div>
              <p className="text-gray-400 text-lg"></p>No partners found matching your criteria.</p>
            </div>
          )}
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-white/5"></section>
        <div className="max-w-7xl mx-auto"></div>
          <div className="text-center mb-16"></div>
            <h2 className="text-4xl font-bold text-white mb-6"></h2>Partnership Tiers</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"></p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8"></div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/20"></div>
              <div className="flex items-center gap-3 mb-6"></div>
                ...
                <h3 className="text-2xl font-bold text-white"></h3>Certified Partner</h3>
              </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-blue-400/50 ring-2 ring-blue-400/20"></div>
              <div className="flex items-center gap-3 mb-6"></div>
                ...
                <h3 className="text-2xl font-bold text-white"></h3>Preferred Partner</h3>
              </div>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/20"></div>
              <div className="flex items-center gap-3 mb-6"></div>
                ...
                <h3 className="text-2xl font-bold text-white"></h3>Strategic Partner</h3>
              </div>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-4 h-4 text-green-400" />

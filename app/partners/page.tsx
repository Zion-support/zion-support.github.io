  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Strategic partnerships with leading technology companies to deliver comprehensive AI and IT solutions." />
        <meta name="keywords" content="partners, strategic partnerships, technology alliances, AI solutions, IT services" />
      </Helmet>

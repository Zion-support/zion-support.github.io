...
import { CheckCircle, ArrowRight, ExternalLink } from 'lucide-react';import { CheckCircle, ExternalLink, Award, Users, Handshake, TrendingUp } from 'lucide-react';
...
const PartnersPage: React.FC = () => {
  ...
  const benefits = [
    ...
    'Certified expertise and solutions'      logo: '/images/partners/google-cloud.png',
  ...
  return (
    <>      <Helmet>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {partners.map((partner, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300">
                  ...
                  <span className="inline-block bg-purple-600 text-white text-xs px-2 py-1 rounded-full">                    {partner.category}
                  </span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {benefits.map((benefit, index) => (
                  <div key={index} className="flex items-center space-x-3">
                    <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0" />                    <span className="text-gray-300">{benefit}</span>
      ...
      <Footer />          <div className="max-w-4xl mx-auto text-center">

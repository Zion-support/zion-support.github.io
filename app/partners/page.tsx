  ...
  return (
    <></></</>
      <Helmet></Helmet></</Helmet>
        <title>Partners - Strategic Partnerships | Zion Tech Group</title><//title></<//title>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">{/* Hero Section */}"
        <section className="relative py-20 px-4">"
          <div className="max-w-7xl mx-auto text-center">"
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">"
              Our
              <span className="block bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">""
                Partners</span></h1><//h1></<//h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">""
              Join our growing ecosystem of strategic partners and unlock new opportunities
              for growth and innovation.</p><//p></<//p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">""
              <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/25">""
                Become a Partner
        ...
        <section className="py-20 px-4">"
          <div className="max-w-4xl mx-auto text-center">"
            <h2 className="text-4xl font-bold text-white mb-6">"
              Ready to Partner with Us?</h2><//h2></<//h2>
            <p className="text-xl text-gray-300 mb-8">""
              Join our partner ecosystem and unlock new opportunities for growth and innovation.</p><//p></<//p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">""
              <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/25">""
                Apply Now
                <Right className="w-5 h-5 ml-2 inline" /></button>""

...
const benefits = [
  ...
  const partnershipTiers = [
    ...
    },
    {
      ...
      icon:</Award> <Handshake className="w-8 h-8 text-blue-500" />,
      color: 'from-blue-400 to-purple-500'
    },
    {
      name: 'Certified Partners',
      description: 'Qualified partners with specialized expertise',
      icon:</Handshake> <CheckCircle className="w-8 h-8 text-green-500" />,
  ...
  return (</CheckCircle>
    <React.Fragment></React>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Our strategic partners and ecosystem that help us deliver world-class AI and IT solutions." /></meta>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <section className="py-20 px-4"></section>
          <div className="max-w-7xl mx-auto text-center"></div>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Strategic</h1> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Partnerships</span>
            </h1>
        ...
        <section className="py-16 px-4"></section>
          <div className="max-w-7xl mx-auto"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {partnershipTiers.map((tier, index) => (</div>
...
const stats = [
    ...
    { icon:</Building2> <Users className="w-8 h-8 text-green-500" />, value: '1000+', label: 'Joint Customers' },
    { icon:</Users> <Zap className="w-8 h-8 text-purple-500" />, value: '95%', label: 'Success Rate' },
    { icon:</Zap> <Award className="w-8 h-8 text-orange-500" />, value: '25+', label: 'Awards Won' }
  ];
return (</Award>
    <div className="min-h-screen bg-gray-50"></div>
      <Helmet></Helmet>
        <title>Partners - Zion Tech Group | Partner Program</title>
        <meta name="description" content="Join our partner ecosystem and grow your business with Zion Tech Group. Strategic, preferred, and certified partner programs available." /></meta>
        ...
        <div className="container mx-auto px-4"></div>
          <div className="max-w-6xl mx-auto"></div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {partners.map((partner, index) => (</div>
                <div key={index} className="bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-shadow duration-300"></div>
                  <div className="flex items-center mb-4"></div>
                    <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center mr-4"></div>
                  ...
                  <div className="flex items-center justify-between"></div>
                    ...
                    {partner.website && (
                      ...
                      >
                        Visit</a> <ExternalLink className="w-4 h-4 ml-1" />
                      </ExternalLink>
                    )}
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {benefits.map((benefit, index) => (</div>
                <div key={index} className="flex items-start"></div>
                  <CheckCircle className="w-5 h-5 text-green-500 mr-3 mt-1 flex-shrink-0" /></CheckCircle>
        ...
        <div className="container mx-auto px-4"></div>
          <div className="max-w-4xl mx-auto text-center"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
              ...
              >
                Apply Now</Link> <ArrowRight className="w-4 h-4 ml-2" />
              </ArrowRight>
              <Link
                to="/partners/benefits"
                className="border border-white text-white hover:bg-white hover:text-blue-900 px-8 py-3 rounded-lg font-medium transition-colors duration-200"

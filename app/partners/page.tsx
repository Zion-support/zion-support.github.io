...
;const PartnersPage: "React.FC = () => {"
  const partners = [{}
    ...
    {}
      name: "'Amazon Web Services'",logo: "'☁️'",description: "'infrastructure and AI services collaboration'",category: "'"},'
    {}
      name: "'Google '",logo: "'🔍'",description: "'AI and machine learning platform integration'",category: "'AI/ML'"},'
    {}
      name: "'IBM'",logo: "'💼'",description: "'Enterprise AI solutions and consulting'",category: "'Enterprise'"},'
    {}
      name: "'Salesforce'",logo: "'📊'",description: "'CRM and business intelligence integration'",category: "'CRM'"},'
    {}

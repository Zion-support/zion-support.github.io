...
const PartnersPage: React.FC = () => {
  return (
,
  const partners = [import {ExternalLink, Award, Handshake, Users, Star, CheckCircle, ArrowRight
  );
}}from 'lucide-react';

interface Partner {id: string;, }
  name: string;, logo: string;, description: string;, category: string;, website: string;, tier: 'preferred' | 'certified' | 'strategic';, }const PartnersPage: React.FC = () => {
  return (, const [selectedCategory, setSelectedCategory] = useState('all');
  const [selectedTier, setSelectedTier] = useState('all');

  const partners: Partner[] = [import Navigation from '../components/Navigation';
import Footer from '../components/Footer';
import { CheckCircle, ArrowRight, Globe, Shield, Users, Zap, Star, Award  
  );
} from 'lucide-react';
...
const PartnersPage: React.FC = () => {
  ...
  const benefits = [
    {
      icon: Globe, title: 'Global Reach', description: 'Access to international markets and customers worldwide'
    
  );
}, {
      icon: Shield, title: 'Enterprise Focus', description: 'Dedicated support for enterprise-level partnerships'
    }, {
      icon: Users, title: 'Dedicated Support', description: '24/7 technical support and partnership management'
    }, {
      icon: Zap, title: 'Fast Integration', description: 'Quick and easy integration with existing systems'
    }];

  const partnerTypes = [{
      title: 'Technology Partners', description: 'Integrate our solutions with your technology stack', features: ['API Access', 'SDK Support', 'Technical Documentation', 'Co-marketing Opportunities']
    },
    {
...
const PartnersPage: React.FC = () => {
  ...
  const partners = [interface Partner {
  name: string;
  logo: string;
  description: string;
  category: string;
...
const PartnersPage: React.FC = () => {
  ...
  const partners: Partner[] = ['use client'
...
const PartnersPage: React.FC = () => {
  ...
  const partners = [
import { ExternalLink, Award, Handshake, Users, Star, CheckCircle, ArrowRight  
  );
} from 'lucide-react'
interface Partner {
  id: string
...
}, {id: '2', name: 'Amazon Web Services', logo: '/images/partners/aws.png', }'Access to cutting-edge technology', {
      id: '1', name: 'Microsoft', logo: '/api/placeholder/200/100', description: 'Strategic partnership for Azure cloud solutions and AI services', category: 'Cloud & AI'
      description: 'Strategic cloud and AI solutions partner', category: 'Cloud & AI', website: 'https://microsoft.com', tier: 'strategic'
    }, {
      id: '2', name: 'Amazon Web Services', logo: '/api/placeholder/200/100', description: 'Leading cloud infrastructure and machine learning platform provider', category: 'Cloud Computing'
    }, {
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              <div className="flex items-center mb-4">
                <Star className="w-5 h-5 text-yellow-400 mr-2" /></Star>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              <div className="flex items-center mb-4">
                <Award className="w-5 h-5 text-cyan-400 mr-2" /></Award>
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              <div className="flex items-center mb-4">
                <Zap className="w-5 h-5 text-purple-400 mr-2" /></Zap>
...
export default PartnersPage;
  ...
  const benefits = [{title: 'Certified Expertise', description: 'Our team holds certifications from leading technology partners', icon: CheckCircle;, }, {title: 'Priority Support', description: 'Get priority access to partner resources and support channels', icon: CheckCircle;, }, {title: 'Latest Technology', description: 'Access to cutting-edge tools and early release features', icon: CheckCircle;, }, {title: 'Cost Optimization', description: 'Leverage partner pricing and volume discounts for your projects', icon: CheckCircle;, }];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">
              ...
              ></Link>
                <Building2 className="w-5 h-5 mr-2" /></Building2>
                Become a Partner
              </Link>
              <Link to="/about"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md: grid-cols-3 gap-8">,</div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 text-center">
                ...
                </div><Users className="w-8 h-8 text-white" /></Users>
              </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 text-center">
                ...
                </div><Award className="w-8 h-8 text-white" /></Award>
              </div>
          ...
          <div className="grid grid-cols-1 md: grid-cols-3 gap-8">,</div>
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <ul className="space-y-3 text-gray-300">
                  ...
                  </li><CheckCircle className="w-4 h-4 text-green-400" /></CheckCircle>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-blue-400/50 ring-2 ring-blue-400/20">
                  ...
                  </div><Award className="w-6 h-6 text-white" /></Award>
                </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                  ...
                  </div><Star className="w-6 h-6 text-white" /></Star>
                </div>

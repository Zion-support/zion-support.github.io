...
const PartnersPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Partners Solutions',
      description: 'Professional partners services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored partners implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your partners needs.'
    }
  ];

        ...
        <div className="max-w-7xl mx-auto"></div>;
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16"></div>;
            {partners.map((partner, index) => (}
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover: border-white/20 transition-all duration-300 flex items-center justify-center"></div>;
                <img;
src={partner.logo} ;
alt: {partner.name};

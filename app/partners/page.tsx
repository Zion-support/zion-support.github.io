...
logo: '/api/placeholder/200/100',
  ...
  const benefits = [
    ...
    'Certified expertise and solutions'
      ...
      description: 'Advanced AI and machine learning platform with global reach',      logo: '/partners/microsoft.png',
  ...
  const partnershipTypes = [  const getTierInfo = (tier: string) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="keywords" content="partners, partnerships, technology partners, channel partners, strategic alliances" />      {/* Stats Section */}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-3xl p-12 border border-slate-700">
            ...
            <p className="text-xl text-gray-300 mb-8">
              ...
              Let's work together to deliver exceptional value to our clients.export default PartnersPage;
  </button>
  </h2>
  </div>
  </div>

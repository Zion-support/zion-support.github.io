...
const PageFiveGPrivateNetworksPage: React.FC = () => {
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="5G private networks, enterprise 5G, private wireless, industrial 5G" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Secure 5G private network solutions for enterprise and industrial applications.
            </p>
          </div>
...
export default PageFiveGPrivateNetworksPage;
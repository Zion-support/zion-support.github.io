  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced 5G Private Networks for modern businesses and enterprises." />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Leverage the power of 5G networks with our advanced Private Networks designed for modern businesses and enterprises.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/contact"

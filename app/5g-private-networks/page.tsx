...
const FiveGPrivateNetworksPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>5g Private Networks - Private 5G network solutions for enterprise and industrial applications | Zion Tech Group</title>
        <meta name="description" content="Private 5G network solutions for enterprise and industrial applications." />
        <meta name="keywords" content="private 5G, enterprise networks, industrial 5G, secure connectivity" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Private 5G network solutions for enterprise and industrial applications.
            </p>
          </div>

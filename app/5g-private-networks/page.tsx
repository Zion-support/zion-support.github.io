...
const Page5gPrivateNetworksPage: React.FC = () => {
  const services = [
    {
      title: 'Expert 5g Private Networks Solutions',
      description: 'Professional 5g private networks services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored 5g private networks implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your 5g private networks needs.'
    }
  ];

const FiveGPrivateNetworks: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        ...
        <meta name="keywords" content="5g, private, networks" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-8">5g private networks</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional 5g private networks solutions and services
            </p>
...
export default Page5gPrivateNetworksPage;

  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to create immersive AR/VR experiences for your business'
    },
    {
      icon: Zap,
      title: 'Real-Time Rendering',
      description: 'Lightning-fast rendering and real-time interactions for optimal user experience'
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: 'Deploy across multiple platforms and devices worldwide'
    }
  ];

  const benefits = [
    'Advanced AR/VR technology integration',
    'Real-time rendering and interactions',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="keywords" content="AR, VR, augmented reality, virtual reality, platform, AI solutions, IT services, Zion Tech Group" />
      </Helmet>

...
const benefits = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"> " <Helmet>"
        ...
        <meta name="description" content="Professional AR/VR Platform services by Zion Tech Group. Advanced AI and IT solutions for your business." /> " <meta name="keywords" content="AR VR platform, virtual reality, augmented reality, AI solutions, IT services, Zion Tech Group" />"
      </Helmet>
      {/* Hero Section */}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">"
        <div className="max-w-7xl mx-auto"> " <div className="text-center mb-16">"
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"> "
              Our AR/VR platform solutions deliver unmatched performance, security, and scalability. </p>
          </div>

...
import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Zap, Shield, Brain, Globe  } from 'lucide-react';const ARVRPlatformPage: React.FC  = () => {
  const features = [
    {
      icon: Brain,
        ...
        <div className="max-w-7xl mx-auto"></div>
          <div className="text-center mb-16"></div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"></p>
                ...
                </p><h3 className="text-xl font-semibold text-white mb-3"></h3>
                {feature.title}
                </h3>
                <p className="text-gray-300"></p>
                {feature.description}
...
Our AR/VR solutions deliver unmatched performance, security, and scalability.
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"></p>
          </p><div className="grid grid-cols-1 md:grid-cols-2 gap-6"></div>

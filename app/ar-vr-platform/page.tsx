...
const ArVrPlatformPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ar vr platform services and solutions by Zion Tech Group."
      keywords="ar vr platform, services, solutions, technology, Zion Tech Group"
    >

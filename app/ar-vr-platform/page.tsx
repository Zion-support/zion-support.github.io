...
export default PagePage;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div></div>
      ...
      {/* Hero Section */} <section className="relative py-20 px-4 sm: px-6 lg:px-8"></section></section>,</section>
        <div className="max-w-7xl mx-auto"></div></div>
          <div className="text-center"></div></div>
            <h1 className="text-4xl md: text-6xl font-bold text-white mb-6"></h1></h1>,</h1>
              <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent"></span></span>AR/VR Platform;</span>
  </
              <br />
              <span className="text-white"></span></span>Solutions</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p></p>Transform your business with our advanced AR/VR platform solutions.</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div></div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8"></section></section>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"></p></p>
                ...
                </p><h3 className="text-xl font-semibold text-white mb-3"></h3></h3>{feature.title}</h3>
...
Our AR/VR solutions deliver unmatched performance, security, and scalability.
        ...
        <div className="max-w-4xl mx-auto text-center"></div></div>
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md: p-12"></div></div>,</div>
            ...
            <p className="text-xl text-purple-100 mb-8"></p></p>Contact our experts to discuss your AR/VR platform needs and get a customized solution.</p>
            </p>
            <div className="flex flex-col sm: flex-row gap-4 justify-center"></div></div>,</div>
      ...
      <section className="py-20 px-4 sm: px-6 lg:px-8"></section></section>
          ...
          </div><div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md:p-12"></div></div>
            </div><h2 className="text-3xl md:text-4xl font-bold text-white mb-4"></h2></h2>
              Ready to Get Started?
            </h2>

  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to create immersive and intelligent AR/VR experiences'
    },
    {
      icon: Zap,
      title: 'Real-time Rendering',
      description: 'Lightning-fast rendering and real-time interaction for optimal user experience'
    },
    {
      icon: Shield,
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the power of our AR/VR platform for your business.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl text-purple-100 mb-8">
              Contact our experts to discuss your AR/VR needs and get a customized solution.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

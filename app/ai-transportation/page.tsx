  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional aitransportation services at Zion Tech Group." />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-6">AiTransportation</h1>
          <p className="text-lg text-gray-300 mb-8">Professional aitransportation services coming soon.</p>

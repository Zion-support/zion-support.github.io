...
<p>Advanced AI-powered ai transportation solution for modern businesses.</p></p>
<div className="
...
<button className="
              <button className="border border-sky-400 text-sky-400 hover:bg-sky-400 hover:text-white font-bold py-4 px-8 rounded-lg transition-all duration-300"py-20 px-4"
...
export default function AiTransportation() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100" content="Advanced ai transportation solutions by Zion Tech Group"container mx-auto px-4 py-16"text-center"text-4 xl font-bold text-gray-900 mb-6"text-xl text-gray-600 mb-8">
            Advanced ai transportation solutions by Zion Tech Group.
          </p>
        </div>
      </div>
    </div>

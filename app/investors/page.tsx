  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Discover investment opportunities with Zion Tech Group and be part of the AI revolution." />
        <meta name="keywords" content="investors, investment, funding, AI technology, business opportunities" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Discover investment opportunities with Zion Tech Group and be part of the AI revolution.
              </p>

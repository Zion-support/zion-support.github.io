...
const Investors Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Investors</title>
        <meta name="description" content="Professional investors solutions and services" />
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Investors Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Investors - Zion Tech Group</title> <meta name="description"content="Professional Investors solutions and services" /> <meta name="keywords"content="investors" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Investors</h1> <p className="text xl text gray-300 mb-8"> Professional Investors solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Investors</h1>
            <p>
          
              Professional Investors solutions and services
            </p>

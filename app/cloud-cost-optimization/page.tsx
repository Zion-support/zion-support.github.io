...
const cloudcostoptimizationPage = () => {
  const serviceName = "Cloud Cost Optimization";
  const serviceDescription = "Professional IT solutions for cloud cost optimization";
  ...
  return (
    <>
      <Helmet>
        <title>Cloud Cost Optimization | Zion Tech Group - AI & IT Solutions</title>
        <meta name="description" content="Professional IT solutions for cloud cost optimization" />
        <meta name="keywords" content="IT services, cloud cost optimization, technology solutions, infrastructure, support" />
      </Helmet>

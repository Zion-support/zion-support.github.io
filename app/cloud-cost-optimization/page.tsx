...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/cloud-cost-optimization' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Cloud Cost Optimization delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Cloud Cost Optimization',
      }}
    />
  );
}

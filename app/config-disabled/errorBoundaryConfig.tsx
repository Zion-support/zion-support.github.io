...
return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4"><div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6"></div>
</div><div className="flex items-center justify-center w-12 h-12 mx-auto bg-red-100 rounded-full"></div>
</div><svg
...
return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4"><div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6"></div>
</div><div className="flex items-center justify-center w-12 h-12 mx-auto bg-yellow-100 rounded-full"></div>
</div><svg
...
return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4"><div className="max-w-md w-full text-center"></div>

      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Automate and optimize your sales process with AI-powered tools and insights
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
            ...
            <p className="text-gray-300 mb-6">AI-powered lead qualification and scoring</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">Sales Forecasting</h3>
            <p className="text-gray-300 mb-6">Predictive sales forecasting and pipeline management</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
            ...
            <p className="text-gray-300 mb-6">Deep customer analysis for better sales strategies</p>
          </div>
        </div>
      </div>
    </div>

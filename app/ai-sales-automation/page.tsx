  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Revolutionize your sales process with AI-powered automation. Lead scoring, predictive analytics, and intelligent sales workflows that boost revenue by 300%."
        keywords={['AI sales automation', 'lead scoring', 'predictive analytics', 'sales intelligence', 'CRM automation']}
          ...
          <section className="container mx-auto px-4 py-16 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Revolutionize your sales process with AI-powered automation. 
                Boost revenue by 300% with intelligent lead scoring and predictive analytics.
              </p>
          ...
          <section className="container mx-auto px-4 py-16 text-center">
            <div className="cyber-card p-12 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Join 500+ companies already using our AI sales automation solutions
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="tel:+13024640950"

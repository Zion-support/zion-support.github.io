  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Revolutionize your sales process with AI-powered automation, lead scoring, and intelligent customer engagement. Increase sales by 300% and reduce manual work by 80%."
        ...
        <main className="pt-16">
          ...
          <section className="container mx-auto px-4 py-16 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Revolutionize your sales process with AI-powered automation and intelligent customer engagement
              </p>
            </div>
          </section>
          ...
          <section className="container mx-auto px-4 py-16 text-center">
            <div className="cyber-card p-12 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Join 300+ companies already using our AI sales automation solutions
              </p>

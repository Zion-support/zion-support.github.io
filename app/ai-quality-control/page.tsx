...
const AIQualityControlPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>AI Quality Control | Zion Tech Group - AI Services</title>
        <meta name="description" content="AI-powered quality control and assurance solutions for manufacturing and production processes." />
        <meta name="keywords" content="ai quality control, ai services, AI solutions, technology services, Zion Tech Group" />
      </Helmet>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
            AI-powered quality control and assurance solutions for manufacturing and production processes.
          </p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-12 border border-white/20">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Contact us today to learn more about our AI Quality Control solutions and how they can benefit your business.
            </p>

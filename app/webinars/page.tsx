...
const WebinarsPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Webinars Solutions',
      description: 'Professional webinars services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored webinars implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your webinars needs.'
    }
  ];

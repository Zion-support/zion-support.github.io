...
const AI3DGenerationPage: React.FC = () => {
  ...
  const useCases = [
    ...
    },
    {
      ...
      description: 'Create 3D assets for movies, TV shows, and animations',
      icon: '🎬'
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Transform text descriptions into stunning 3D models with our AI-powered 3D generation technology. Create photorealistic assets in seconds." />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              Create photorealistic assets, characters, and environments in seconds, not hours.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our AI 3D generation technology combines cutting-edge machine learning with 
                advanced 3D processing to deliver exceptional results.
              </p>
            </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our AI 3D generation technology is transforming industries across the globe.
              </p>
            </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Start generating professional 3D models with our AI technology today. 

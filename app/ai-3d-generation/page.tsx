...
const Ai3dGenerationPage: React.FC = () => {
  return (
    <>Helmet>
        ...
        <meta
          name="description"
          content="Professional ai 3d generation solutions and services"
        />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-9 00 via-purple-9 0 0 to-slate-9 0 0">
        <div className="container mx-auto px-4 py-1 6">
          <div className="text-center">
            <h1 className="text-4 xl font-bold text-white mb-8">Ai 3d generation</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional Ai 3d generation solutions and services</p>

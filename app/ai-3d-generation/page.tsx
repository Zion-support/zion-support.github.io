  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="AI-powered ai 3d generation solution for intelligent automation and optimization" />
        <meta name="keywords" content="AI, ai, 3d, generation, automation, artificial intelligence, business solutions" />
      </Helmet>
      <Navigation />
<<<<<<< HEAD
      ...
      {/* Applications Section */}
            ...
            {applications.map((app, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center hover:bg-white/10 transition-all duration-300"></div></div>
                <div className="text-4xl mb-4"></div></div>{app.icon}</div>
                <h3 className="text-xl font-semibold text-white mb-2"></h3></h3>{app.title}</h3>
                <p className="text-gray-300"></p></p>{app.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4"></section></section>
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(59,130,246,0.3)_0%,transparent_50%)] animate-pulse" style={{ animationDelay: '1s' }} />
          <div className="relative max-w-7xl mx-auto text-center"></div></div>
            </div><h1 className="text-5xl md:text-7xl font-bold text-white mb-6"></h1></h1>
              AI 3D Generation
=======
...
>>>>>>> cursor/fix-errors-and-merge-to-main-9eaa
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              AI-powered ai 3d generation solution for intelligent automation and optimization
            </p>
<<<<<<< HEAD
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div></div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Get started with our Ai 3d Generation and experience the future of intelligent automation.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105">
                Start Free Trial

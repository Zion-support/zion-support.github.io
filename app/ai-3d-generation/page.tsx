...
export default function AI3DGenerationPage() {
  const features = [
    ...
    },
    {
      ...
      description: 'Simply describe what you want and our AI creates detailed 3D models instantly.'
    },
    {
      icon: <Camera className="w-8 h-8 text-green-500" />,
      title: 'Image-to-3D Conversion',
      description: 'Transform 2D images into fully textured 3D models with realistic materials and lighting.'
    },
    {
      icon: <Layers className="w-8 h-8 text-orange-500" />,
      title: 'High-Resolution Output',
      description: 'Generate 3D models in various formats including OBJ, FBX, STL, and more.'
    },
    {
      icon: <Zap className="w-8 h-8 text-yellow-500" />,
      title: 'Real-time Processing',
      description: 'Create 3D models in seconds, not hours. Our optimized AI delivers fast results.'
    },
    {
      icon: <BarChart3 className="w-8 h-8 text-red-500" />,
      title: 'Customizable Parameters',
      description: 'Fine-tune your 3D models with detailed control over style, complexity, and materials.'
    }
  ]

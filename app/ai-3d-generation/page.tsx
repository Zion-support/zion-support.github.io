  ...
  const useCases = [
    {
      ...
      description: 'Create 3D assets for games quickly and efficiently',
      icon: '🎮'
    },
    {
      title: 'Architecture',
    ...
    {
      title: 'Education',
      description: 'Create educational 3D content and simulations',
      icon: '🎓'
    }
  ];

  const benefits = [
    '10x faster than traditional modeling',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Transform text into stunning 3D models with our AI-powered 3D generation technology. Create professional-quality 3D content in seconds." />
        <meta name="keywords" content="AI 3D generation, 3D modeling, text-to-3D, AI technology, 3D content creation" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              Create professional-quality 3D content in seconds, not hours.
            </p>

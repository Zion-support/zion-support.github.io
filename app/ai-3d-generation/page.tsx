        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Create stunning 3D models, animations, and virtual environments with AI-powered tools
            </p>
          ...
          {/* Use Cases Section */}
          <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-900/50 rounded-lg mb-16">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {applications.map((application, index) => (
                  <div key={index} className="cyber-card p-8">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-3 text-center">{application.title}</h3>

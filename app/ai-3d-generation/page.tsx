...
const Ai3dGenerationPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Continuously optimize performance with machine learning insights.',
    }
  ]
  ...
  const applications = [
    {
      ...
      description: 'Create stunning 3D assets for games and interactive experiences',
      icon: '🎮'
    },
    {
      title: 'Architecture',
      description: 'Generate architectural models and visualizations',
      icon: '🏗️'
    },
    {
      title: 'VR/AR',
    ...
    },
    {
      ...
      description: 'Design and prototype products with AI assistance',
      icon: '📱'
    }
  ]

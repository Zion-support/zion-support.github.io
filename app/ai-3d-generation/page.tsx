...
const Ai3dGenerationPage: React.FC = () => {
  return (
    ...
    const features = [{
      icon: Cube, title: 'Text-to-3D', description: 'Generate 3D models from simple text descriptions using advanced AI algorithms.', benefits: ['Natural language input', 'High-quality output', 'Multiple formats']
  ...
  const applications = [{
      title: 'Game Development', description: 'Create game assets, characters, and environments', icon: '🎮'
    }, {
      title: 'Architecture', description: 'Generate building models and architectural visualizations', icon: '🏗️'
    }, {
      title: 'Product Design', description: 'Design and prototype products with 3D models', icon: '📱'
    }, {
  ...
  const benefits = ['Reduce 3D content creation time by 90%', 'Lower production costs by 80%', 'Create unlimited unique 3D assets', 'Accelerate game and app development', 'Enable rapid prototyping', 'Improve visual quality and consistency', 'Scale content production instantly', 'Reduce dependency on 3D artists'];

...
const Ai3dGenerationPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Accurate targeting and personalization for better user engagement.',
    },
    {
      icon: TrendingUp,
      title: 'Performance Optimization',
      description: 'Continuous optimization to improve performance and results.',
    },
    {
      icon: Globe,
      title: 'Global Reach',
      description: 'Scale your operations globally with our worldwide infrastructure.',
    },
    {
      icon: Database,
      title: 'Data Management',
      description: 'Secure and efficient data management and processing capabilities.',
    }
  ]

  const benefits = [
    'Advanced AI algorithms for intelligent insights',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI 3D generation, 3D modeling, artificial intelligence, game assets, architectural visualization, 3D design" />
      </Helmet>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-purple-500/20 to-blue-600/20 rounded-2xl p-8">
                ...
                <p className="text-gray-300 mb-6">
                  Join thousands of creators who are already using our AI 3D generation technology to bring their ideas to life.
                </p>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Start creating stunning 3D models today with our AI-powered generation technology.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

...
const Ai3dGenerationPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Generate 3D assets for games and interactive experiences',
      icon: '🎮'
    },
    {
      title: 'Architecture',
      description: 'Create detailed architectural models and visualizations',
      icon: '🏗️'
    },
    {
  ...
  const applications = [
    ...
    {
      title: 'Architecture',
      description: 'Design buildings and interior spaces',
      icon: '🏢'
    },
    {
      title: 'E-commerce',
      description: 'Generate product visualizations for online stores',
      icon: '🛒'
    },
    {
      title: 'Education',
      description: 'Create educational content and simulations',
      icon: '🎓'
    }
  ];

  const benefits = [
    'Generate 3D models in seconds instead of hours',
    'Reduce design costs by up to 70%',
    'Create unlimited variations and iterations',
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our AI technology can generate high-quality 3D models for various applications
              </p>
            </div>

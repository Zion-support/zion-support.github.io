...
const AiWorkflowAutomationPage: React.FC = () => {
  const features = [
    ...
    "Intelligent process monitoring and analytics",
  ...
  const stats = [
    ...
    { number: "95%", label: "Process Accuracy", icon: <Target className="w-6 h-6" /> },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Revolutionary AI workflow automation platform. Save 80% time, achieve 95% process accuracy, and reduce costs by 60% with intelligent automation and optimization." />
        <meta name="keywords" content="AI workflow automation, process automation, business process management, workflow optimization, task automation" />
      </Helmet>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                ...
                intelligent optimization, and seamless integration. Save 80% time 
                and achieve 95% process accuracy with our cutting-edge platform.
              </p>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the perfect plan for your workflow automation needs. All plans include our AI-powered features.
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-cyan-600 to-purple-600">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
              Join thousands of businesses already using AI to revolutionize their workflow automation. 

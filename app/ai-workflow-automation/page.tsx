...
import { CheckCircle, ArrowRight, TrendingUp, Settings } from 'lucide-react';

export const metadata: Metadata = {
  title: 'AI Workflow Automation Services | Zion Tech Group',
  description: 'Intelligent workflow automation solutions that streamline business processes, reduce costs, and improve efficiency. AI-powered automation for every industry.',
  keywords: 'workflow automation, business process automation, RPA, AI automation, process optimization, digital transformation',
};

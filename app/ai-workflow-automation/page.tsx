      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Automate complex workflows with AI technology
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Our ai workflow automation solutions leverage cutting-edge technology to deliver exceptional results. 
              We combine industry expertise with innovative approaches to solve complex business challenges 
              and drive growth.
            </p>
            <div className="space-y-4">
              <div className="flex items-center text-gray-300">
                <Workflow className="w-6 h-6 text-blue-400 mr-3" />

...
const AiWorkflowAutomationPage: React.FC = () => {
  ...
  const benefits = [
    'Automated aiworkflowautomation processes',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Intelligent workflow automation solutions that streamline business processes and increase efficiency." />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Intelligent workflow automation solutions that streamline business processes and increase efficiency.
            </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300">Everything you need for effective aiworkflowautomation</p>
            </div>

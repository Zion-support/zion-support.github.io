  ...
  return (
    <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
      ...
      <div className="max-w-7xl mx-autopx-4 sm:px-6 lg:px-8 py-16 text-center">
        <h1 className="text-4xl font-boldtext-white mb-6">5G Edge Computing</h1>
        <p className="text-lgtext-gray-300mb-8">Professional 5G edge computing services coming soon.</p>
        <Link
          to="/contact"

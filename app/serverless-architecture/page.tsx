...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/serverless-architecture' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Serverless Architecture delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Serverless Architecture',
      }}
    />
  );
}

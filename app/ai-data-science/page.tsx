...
import { BarChart, TrendingUp, CheckCircle, ArrowRight, Star, Award, Clock, Brain, Target, Search, Zap, Globe, Shield, Smartphone, Laptop, Monitor, FileText, Calendar, Settings, Users, Briefcase, DollarSign, Phone, Activity, Wrench } from 'lucide-react';
import Navigation from '../components/Navigation';
import Footer from '../components/Footer';

const AIDataSciencePage: React.FC = () => {
  const features = [
  ...
  const useCases = [
    {
      ...
      description: 'Transform business data into actionable insights and predictions',
      icon: BarChart,
      examples: ['Sales forecasting', 'Customer analytics', 'Market analysis', 'Performance metrics']
    },
    {
      title: 'Healthcare Analytics',
      description: 'Analyze medical data for improved patient care and outcomes',
      icon: Heart,
      examples: ['Patient diagnosis', 'Treatment optimization', 'Drug discovery', 'Health monitoring']
    },
    {
      title: 'Financial Modeling',
      description: 'Build predictive models for financial analysis and risk assessment',
      icon: DollarSign,
      examples: ['Risk assessment', 'Portfolio optimization', 'Fraud detection', 'Market prediction']
    },
    {
      title: 'Manufacturing',
      description: 'Optimize manufacturing processes with data-driven insights',
      icon: Settings,
  ...
  const pricingTiers = [
    {
      ...
      price: '$1,299',
      period: '/month',
      description: 'Perfect for small data science projects and teams',
      features: [
        'Up to 10 datasets',
        'Basic AI analysis',
    ...
    },
    {
      ...
      price: '$4,999',
      period: '/month',
      description: 'For large organizations with extensive data operations',
      features: [
        'Unlimited datasets',
        'Custom AI models',
        '24/7 processing',
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-cyan-400/10 border border-cyan-400/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-cyan-400 text-sm font-medium">AI Data Science</span>
          </div>
          
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 cyber-text-3d neon-pulse glitch" data-text="AI Data Science">
            AI Data Science
          </h1>
          
          <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
            Unlock the power of your data with AI-powered data science that accelerates analysis 
            by 85%, improves accuracy by 90%, and reduces manual work by 75%. Transform raw data 
            into actionable insights and predictive models.
          </p>
        ...
        <section className="text-center">
          <div className="cyber-card p-8 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Join data-driven organizations using our AI Data Science to unlock insights, 
              build predictive models, and make smarter decisions with their data.
            </p>

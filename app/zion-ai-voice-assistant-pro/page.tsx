        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            ...
            <p className="text-gray-300 mb-4">
              Advanced AI-powered voice recognition and processing.
            </p>
            <ul className="text-sm text-gray-400 space-y-2">
              <li>• Natural language processing</li><li>• Multi-language support</li><li>• Context understanding</li>
            </ul>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            <h3 className="text-xl font-semibold text-white mb-4">Task Automation</h3>
            <p className="text-gray-300 mb-4">
              Intelligent task automation and workflow management.
            </p>
            <ul className="text-sm text-gray-400 space-y-2">
              <li>• Voice commands</li><li>• Process automation</li><li>• Integration capabilities</li>
            </ul>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
            <h3 className="text-xl font-semibold text-white mb-4">Custom Solutions</h3>
            <p className="text-gray-300 mb-4">
              Tailored voice assistant solutions for your business needs.
            </p>
            <ul className="text-sm text-gray-400 space-y-2">
              <li>• Custom training</li><li>• Industry-specific features</li><li>• Scalable deployment</li>
            </ul>
          </div>
        </div>
        <div className="text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 max-w-2xl mx-auto">
            ...
            <p className="text-gray-300 mb-6">
              Our AI voice assistant experts are ready to help you integrate voice technology.
            </p>

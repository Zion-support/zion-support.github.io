...
export default SupplyChainOptimizerPage
        <section className="py-20 px-4"></section></section>"          <div className="max-w-7xl mx-auto"></div></div>"            <div className="text-center mb-16"></div></div>"              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6"></h1></h1>Supply Chain Optimizer"              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p></p>Optimize your supply chain with AI-powered tools."            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div></div>"              {features.map((feature, index) => (
                <div key={index} className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-cyan-400/50 transition-all duration-300"></div></div>"                  <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full flex items-center justify-center mb-6"></div></div>"                    <feature.icon className="w-8 h-8 text-white" />"                  <h3 className="text-xl font-bold text-white mb-4"></h3></h3>{feature.title}"                  <p className="text-gray-300"></p></p>{feature.description}"              ))}
  )
}

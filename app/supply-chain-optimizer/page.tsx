...
export default function SupplyChainOptimizerPage() {
  return (
    <>
      <Helmet>
        <title>SupplyChainOptimizerPage - Zion Tech Group</title>
        <meta name="description" content="Professional supplychainoptimizerpage services by Zion Tech Group." />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Professional supplychainoptimizerpage services by Zion Tech Group.
            </p>

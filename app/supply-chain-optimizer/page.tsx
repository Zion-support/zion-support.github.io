  ...
  return (
    <React.Fragment></React>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Optimize your supply chain with AI-powered tools. Logistics optimization, demand forecasting, and automated processes." /></meta>
        <meta name="keywords" content="supply chain optimization, logistics management, demand forecasting, supply chain AI, inventory optimization" /></meta>
      </Helmet>

        ...
        <section className="py-20 px-4 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300">Comprehensive supply chain optimizer solution</p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                ...
                <p className="text-gray-300">
                  Description of feature 1 for supply chain optimizer.
                </p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                ...
                <p className="text-gray-300">
                  Description of feature 2 for supply chain optimizer.
                </p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                ...
                <p className="text-gray-300">
                  Description of feature 3 for supply chain optimizer.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 px-4 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300">Transform your business with our supply chain optimizer solution</p>
            </div>
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                ...
                <p className="text-gray-300 mb-6">
                  Ready to get started? Contact us to learn more about our supply chain optimizer solutions.
                </p>

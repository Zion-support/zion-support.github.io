...
const AIOpsPage: React.FC = () => {
  ...
  const features = [{
      icon: Settings, title: 'Intelligent IT Operations', description: 'AI-powered IT operations that automatically detect, diagnose, and resolve issues before they impact your business.', benefits: ['Proactive monitoring', 'Automated remediation', 'Predictive analytics']
  ...
  const benefits = ['Reduce IT downtime by up to 90%', 'Cut operational costs by 60%', 'Improve system reliability by 95%', 'Faster incident resolution', 'Proactive issue prevention', 'Enhanced security posture'];

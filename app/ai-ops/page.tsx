...
<Navigation >{/* Hero Section */}</Navigation>
        ...
        </section><div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(120,119,198,0.3)_0%,transparent_50%)] animate-pulse" />
        </div><div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(255,119,198,0.3)_0%,transparent_50%)] animate-pulse" style={{ animationDelay: '1s' }} />
...
{/* Features Section */}<section className="py-20 px-4">
            ...
            <h2 className="text-4xl font-bold text-white mb-4">Powerful AI Operations Features</h2><p className="text-xl text-gray-300 max-w-3xl mx-auto">Comprehensive AI-powered IT operations solution designed for modern enterprises<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{features.map((feature, index) => (</div>

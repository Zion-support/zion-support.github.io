...
>>>>>>> origin/main
    ...
    'Cost-effective pricing plans',''>>>>>>> cursor/delete-records-a75e
...
<meta name="description" content="Professional Page services by Zion Tech Group. Advanced AI and IT solutions for your business." />""<meta name="keywords" content="page, AI solutions, IT services, Zion Tech Group, page" />""<title>Page | Zion Tech Group</title>
<meta name="description" content="AI-powered solution" />""<meta name="keywords" content="AI, artificial intelligence, business solutions" /></Helmet>""      {/* Hero Section */} <section className="py-20 px-4">""<div className="max-w-7xl mx-auto">""<div className="text-center mb-16">""<h2 className="text-4xl font-bold text-white mb-4">Section Title</h2></Helmet>""      {/* Hero Section */}
        <div className="max-w-7xl mx-auto">""<div className="text-center">""<h1 className="text-4xl md:text-6xl font-bold text-white mb-6">""<span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">""                Page
              </span>
<br />
...
<section className="py-20 px-4 sm:px-6 lg:px-8">""<p className="text-xl text-gray-300">Section description</p></div>""</div>
>>>>>>> origin/main
        </section>
>>>>>>> origin/main
          </div></div>

  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <Helmet>
        ...
        <meta name="description" content="Robotics solutions by Zion Tech Group" />
      </Helmet>
      
      <div className="container mx-auto px-4 py-20">
        <h1 className="text-4xl font-bold mb-8">Robotics</h1>
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive robotics solutions designed to meet your business needs.
          </p>
<<<<<<< HEAD
...
const RoboticsSolutionsPage: React.FC = () => {
  const features = [
    {
      icon: Brain,
<<<<<<< HEAD
...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-03fc
        ...
        <meta name="description" content="Advanced robotics solutions for automation." />
        <meta name="keywords" content="robotics, automation, AI, manufacturing" />
      </Helmet>
<<<<<<< HEAD
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced robotics solutions for automation.
=======

...
const RoboticsPage: React.FC = () => {
  const roboticsServices = [
    {
      ...
      description:
        "Automate repetitive business processes with intelligent software robots.",
      icon: "🤖",
    ...
    },
    {
      ...
      description:
        "Advanced robotic systems for manufacturing, assembly, and material handling.",
      icon: "🏭",
    ...
    },
    {
      ...
      description:
        "Intelligent service robots for customer interaction, cleaning, and assistance.",
      icon: "👥",
    ...
    },
    {
      ...
      description:
        "Self-navigating robots for warehouse, hospital, and facility operations.",
      icon: "🚛",
    ...
    },
    {
      ...
      description:
        "Safe human-robot collaboration systems for shared workspaces.",
      icon: "🤝",
    ...
    },
    {
      ...
      description:
        "Intelligent robots with machine learning capabilities for adaptive behavior.",
      icon: "🧠",
    ...
    },
    {
      ...
      description:
        "Advanced computer vision solutions for quality control and inspection.",
      icon: "👁️",
    ...
    },
    {
      ...
      description:
        "Complete integration of robotic systems into existing workflows and infrastructure.",
      icon: "🔧",
    ...
    },
    {
      ...
      description:
        "Comprehensive maintenance and support services for robotic systems.",
      icon: "🛠️",
    ...
    },
    {
      ...
      description:
        "Strategic guidance for robotic automation adoption and implementation.",
      icon: "💡",
    ...
    },
    {
      ...
      description:
        "Bespoke robotic solutions designed for specific business requirements.",
      icon: "⚙️",
    ...
    },
    {
      ...
      description:
        "Comprehensive training programs for robotic systems operation and maintenance.",
      icon: "🎓",
  ...
  const categories = [
    ...new Set(roboticsServices.map((service) => service.category)),
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Advanced robotics and automation services including RPA, industrial robots, service robots, and AI-powered automation solutions."
        />
        <meta
          name="keywords"
          content="robotics services, RPA, industrial automation, service robots, AI robotics, robotic process automation"
        />
      </Helmet>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 text-teal-100 max-w-3xl mx-auto">
                Transform your operations with intelligent robots and advanced
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Expert robotics engineers delivering intelligent automation
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Certified engineers with deep expertise in robotics and
                  automation
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Fast implementation with proven methodologies and best
                  practices
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Comprehensive safety systems and compliance with industry
                  standards
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Average 300% ROI within 18 months of implementation
                </p>
              </div>
            </div>
          </div>
          ...
          <section key={category} className="py-16 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">
                  Specialized {category.toLowerCase()} services for intelligent
                  automation
                </p>
              </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Comprehensive robotics solutions covering all aspects of
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-gradient-to-br from-teal-50 to-cyan-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Intelligent RPA solutions for business process automation
                </p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Advanced robotic systems for manufacturing and production
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-violet-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Customer service and assistance robots
                </p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-amber-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Autonomous mobile robots for logistics and transportation
                </p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-pink-50 to-rose-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Advanced computer vision for quality control and inspection
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-gradient-to-r from-teal-600 to-cyan-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 text-teal-100">
              Contact our robotics experts for a free consultation and custom
              automation strategy
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a

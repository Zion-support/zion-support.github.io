...
const ApidevelopmentPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Api Development | Zion Tech Group - AI-Powered Solutions</title>
        <meta name="description" content="AI-powered api development solutions for your business" />
        <meta name="keywords" content="api, development, AI solutions, technology, automation" />
      </Helmet>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              AI-powered api development solutions for your business
            </p>
          </div>
        </section>

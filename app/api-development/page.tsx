        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              API development services including RESTful APIs, GraphQL, and microservices.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Design and develop RESTful APIs following industry best practices and standards.</p>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Modern GraphQL APIs for efficient data fetching and real-time subscriptions.</p>
              <ul className="text-sm text-gray-400 space-y-2">
                <li>• Schema design</li>
                <li>• Resolvers</li>
                <li>• Subscriptions</li>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Scalable microservices architecture for distributed applications.</p>
              <ul className="text-sm text-gray-400 space-y-2">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Comprehensive security measures to protect your APIs from threats.</p>
              <ul className="text-sm text-gray-400 space-y-2">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Thorough testing strategies to ensure API reliability and performance.</p>
              <ul className="text-sm text-gray-400 space-y-2">
                <li>• Unit testing</li>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300 mb-4">
                Complete API lifecycle management and monitoring solutions.</p>
              <ul className="text-sm text-gray-400 space-y-2">
                <li>• API gateway</li>

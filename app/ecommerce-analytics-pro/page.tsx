...
,
  const features = [{
      icon: BarChart, title: 'Real-time Analytics', description: 'Track sales, conversions, and customer behavior in real-time with advanced analytics dashboards.'
  );
}, {icon: TrendingUp, title: 'Revenue Optimization', description: 'Identify trends and opportunities to maximize revenue and improve profit margins.', }, {icon: Users, title: 'Customer Insights', description: 'Understand customer segments, preferences, and purchasing patterns for targeted marketing.'}, {icon: ShoppingCart, title: 'Inventory Management', description: 'Optimize stock levels and predict demand with AI-powered inventory analytics.', }, {icon: DollarSign, title: 'Pricing Intelligence', description: 'Dynamic pricing recommendations based on market conditions and competitor analysis.', }, {icon: Target, title: 'Conversion Tracking', description: 'Monitor and optimize conversion funnels to increase sales and reduce cart abandonment.', }]

...
export const metadata = {
  ...
  description: 'Advanced e-commerce analytics solutions powered by AI',
  keywords: 'e-commerce analytics, AI, business intelligence, data analysis',
  openGraph: {
    title: 'E-commerce Analytics Pro | Zion Tech Group',
    description: 'Advanced e-commerce analytics solutions powered by AI',
    type: 'website',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Advanced e-commerce analytics solutions powered by AI
          </p>

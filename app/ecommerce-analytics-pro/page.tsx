  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Professional ecommerce analytics pro services and solutions from Zion Tech Group." />
      </Head>
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-emerald-400 max-w-3xl mx-auto">
              Advanced ecommerce analytics pro solutions powered by artificial intelligence and machine learning.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-slate-800 p-6 rounded-lg">
              <SimpleIcon name="brain" className="w-12 h-12 text-emerald-400 mb-4" />
            ...
            <div className="bg-slate-800 p-6 rounded-lg">
              <SimpleIcon name="chart" className="w-12 h-12 text-emerald-400 mb-4" />
            ...
            <div className="bg-slate-800 p-6 rounded-lg">
              <SimpleIcon name="target" className="w-12 h-12 text-emerald-400 mb-4" />

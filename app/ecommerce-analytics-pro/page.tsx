...
export const metadata = {
  ...
  description: 'Professional Ecommerce Analytics Pro services and solutions',
  keywords: 'ecommerce analytics pro, ecommerce, analytics, technology, services, AI, IT solutions',
  openGraph: {
    title: 'Ecommerce Analytics Pro | Zion Tech Group',
    description: 'Professional Ecommerce Analytics Pro services and solutions',
    type: 'website',

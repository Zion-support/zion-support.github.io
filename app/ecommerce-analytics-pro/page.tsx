        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-4xl md: text-6xl font-bold text-white mb-6">E-commerce Analytics Pro, Transform your e-commerce business with AI-powered analytics that drive growth, optimize operations, and maximize revenue.</h1 className="text-4xl md: text-6xl font-bold text-white mb-6">
              </p>
            </div>
...
export default EcommerceAnalyticsProPage<//React.Fragment>
  </h1>
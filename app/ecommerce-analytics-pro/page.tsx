...
<h1 className="text-4xl md:text-6xl font-bold text-white mb-6" loading="lazy">E-commerce Analytics Pro</h1>
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" loading="lazy">Transform your e-commerce business with AI-powered analytics that drive growth, optimize operations, and maximize revenue.</p>
</div>

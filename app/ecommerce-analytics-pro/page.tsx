...
export const metadata = {
  ...
  description: 'Professional ecommerce-analytics-pro services and solutions by Zion Tech Group.',
  keywords: 'ecommerce-analytics-pro, technology, services, Zion Tech Group',
  openGraph: {
    title: 'Ecommerce Analytics Pro - Zion Tech Group',
    description: 'Professional ecommerce-analytics-pro services and solutions by Zion Tech Group.',
    type: 'website',

import { ArrowRight, BarChart3, CheckCircle, Star, Users, TrendingUp, Clock, Shield, Zap, Globe, Mail, Smartphone } from "lucide-react";
  ...
  const testimonials = [
    {
      ...
      role: "CEO",
      content: "Zion Analytics Pro transformed how we understand our business. The predictive modeling helped us increase revenue by 40% in just 3 months.",
      rating: 5,
      avatar: "SJ"
    },
    {
    ...
    },
    {
      ...
      content: "The API integration made it so easy to connect all our tools. Setup was seamless and the support team was fantastic.",
      rating: 5,
      avatar: "ER"
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Transform your data into actionable insights with Zion Analytics Pro. Real-time dashboards, predictive analytics, and automated reporting for businesses of all sizes."
        />
        <meta
          name="keywords"
          content="business intelligence, analytics platform, data visualization, predictive analytics, real-time dashboards, business intelligence software"
        />
      </Helmet>

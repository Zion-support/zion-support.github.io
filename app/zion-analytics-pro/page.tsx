import { ArrowRight, BarChart3, TrendingUp, Users, Zap, CheckCircle, Star, Clock, Shield, Globe, Smartphone, Mail } from "lucide-react";
...
export default function ZionAnalyticsPro() {
  const features = [
    {
      ...
      benefits: ["Instant insights", "Customizable views", "Mobile responsive", "Export capabilities"]
    },
    {
      title: "Predictive Analytics",
      description: "Leverage AI-powered forecasting to predict trends, customer behavior, and business outcomes.",
      icon: <TrendingUp className="w-6 h-6" />,
      benefits: ["Future trend prediction", "Risk assessment", "Opportunity identification", "Data-driven decisions"]
    },
    {
      title: "Customer Analytics",
      description: "Deep insights into customer behavior, segmentation, and lifetime value analysis.",
      icon: <Users className="w-6 h-6" />,
      benefits: ["Customer segmentation", "Behavior analysis", "Lifetime value", "Retention insights"]
    },
    {
      title: "Automated Reporting",
      description: "Generate comprehensive reports automatically with scheduled delivery and custom formatting.",
  ...
  const testimonials = [
    ...
    },
    {
      ...
      role: "CTO",
      content: "The real-time dashboards give us instant insights into our operations. We can now make data-driven decisions in real-time.",
      rating: 5,
      avatar: "MC"
    },
    {
      ...
      content: "The automated reporting saves us hours every week. The reports are comprehensive and beautifully formatted.",
      rating: 5,
      avatar: "ER"
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Transform your data into actionable insights with Zion Analytics Pro. Real-time dashboards, predictive analytics, and automated reporting for modern businesses. Starting at $29/month."
        />
        <meta
          name="keywords"
          content="business intelligence, analytics platform, data visualization, predictive analytics, real-time dashboards, automated reporting, AI analytics, business insights"
        />
      </Helmet>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                  ...
                  Real-time dashboards, predictive analytics, and automated reporting designed for modern businesses.
                </p>
              ...
              {pricingPlans.map((plan, index) => (
                <div
                  ...
                  className={`relative bg-white/10 backdrop-blur-sm rounded-xl p-8 border ${
                    plan.popular 
                      ? 'border-blue-500/30 bg-gradient-to-r from-blue-500/20 to-cyan-500/20' 
                      : 'border-white/20'
                  }`}
                >
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                      <div className="bg-gradient-to-r from-blue-500 to-cyan-600 text-white px-4 py-1 rounded-full text-sm font-semibold">
                        Most Popular
                      </div>
                    </div>
                  )}

...
features: ["Up to 20 data sources", "Advanced dashboards", "Custom reports", "Priority support", "10GB data storage", "Advanced analytics", "Team collaboration", "White-label options"],
popular: true,
    },
    {
      name: "Enterprise",
...
features: ["Unlimited data sources", "Custom dashboards", "Advanced reporting", "24/7 support", "Unlimited storage", "AI-powered insights", "Custom integrations", "Dedicated account manager"],
popular: false,
    }
  ];
;

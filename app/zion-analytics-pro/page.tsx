...
export const metadata: Metadata = {
  ...
  description:
    'Zion Analytics Pro transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, mor',
  alternates: { canonical: '/zion-analytics-pro' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Analytics Pro transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Analytics Pro',
      }}
    />
  );
}

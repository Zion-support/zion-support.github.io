      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-white mb-6">
            Zion Analytics <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Pro</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Advanced analytics platform with AI-powered insights and real-time monitoring
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
            ...
            <p className="text-gray-300 mb-6">Live data analysis and visualization</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
            ...
            <p className="text-gray-300 mb-6">Comprehensive performance monitoring and reporting</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
            ...
            <p className="text-gray-300 mb-6">Personalized dashboards for your business needs</p>
          </div>
        </div>
      </div>
    </div>

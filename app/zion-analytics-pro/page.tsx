          ...
          <div className="max-w-7xl mx-auto"></div>
            <div className="text-center mb-16"></div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16"></div>
                ...
                ></Link>
                  Watch Demo
                  <BarChart3 className="w-5 h-5 ml-2 group-hover:rotate-12 transition-transform" /></BarChart3>
                </Link>
              </div>
                ...
                ></div>
                  ...
                  <div className="flex items-center mb-3"></div>
                    {[...Array(testimonial.rating)].map(( i) => (
                      <Star key={i} className="w-4 h-4 text-yellow-400 fill-current" /></Star>
                    ))}
                  </div>
          ...
          <div className="max-w-4xl mx-auto text-center"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
              ...
              <Link
                ...
                className="border border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300 group hover:scale-105"
              ></Link>
                <DollarSign className="w-5 h-5 mr-2 group-hover:rotate-12 transition-transform" /></DollarSign>
                View Pricing
              </Link>
            </div>

  ...
  return (
    ...
    d:text-6xl font-bold text-white mb-6 leading-tight">
                ...
                <div className="flex flex-col sm: "flex-row gap-4 mb-8">
                  ...
                  >
                    Watch Demo"
                    <Play className="min-h-screen bg-white"
    ",
        ...
        <section className="py-16 px-4 sm: "px-6 lg:px-8 relative z-10">"
          <div className="max-w-7xl mx-auto">"
            <div className="text-center mb-16">"
              <h2 className="min-h-screen bg-white"
    ",
...
</div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></section></Link></Link></Link></span></BarChart3></TrendingUp></FileText></Database></PieChart></Bell></Users></Shield></Database></Clock></Helmet></title></meta></meta></div></div></div></section></div></div></div></div></BarChart3></span></h1></span></p></div></Link></ArrowRight></Link></Play></div></div></div></div></div></div></div></div></h3></div></div></div></span></span></div></div></div></div></div></div></div></div></div></div></span></span></div></section></div></div></h2></span></div></div></div></h3></div></div></CheckCircle></span></section></div></div></h2></span></div></div></div></span></div></h3></div></span></span></div></div></CheckCircle></span></Link></ArrowRight></section></div></div></h2></div></div></div></Star></div></div></div></div></div></section></div></div></h2></div></div></div></Mail></h3></div></div></Phone></h3></div></div></MapPin></h3></p></br></div></Link></ArrowRight></Link></BarChart3></TrendingUp></FileText></Database></PieChart></Bell></Users></Shield></Database></Clock></Helmet></title></meta></meta></div></div></div></section></div></div></div></div></BarChart3></span></h1></span></p></div></Link></ArrowRight></Link></Play></div></div></div></div></div></div></div></div></h3></div></div></div></span></span></div></div></div></div></div></div></div></div></div></div></span></span></div></section></div></div></h2></span></div></div></div></h3></div></div></CheckCircle></span></section></div></div></h2></span></div></div></div></span></div></h3></div></span></span></div></div></CheckCircle></span></Link></ArrowRight></section></div></div></h2></div></div></div></Star></div></div></div></div></div></section></div></div></h2></div></div></div></Mail></h3></div></div></Phone></h3></div></div></MapPin></h3></p></br></div></Link></ArrowRight></Link>}
</span>
</span>"
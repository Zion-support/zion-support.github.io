...
const ZionAnalyticsProPage: React.FC  = () => {return (
    <>
      <Helmet></Helmet>
        ...
        <meta name="keywords" content="business intelligence, analytics platform, real-time dashboards, AI analytics, reporting" />
      </Helmet>

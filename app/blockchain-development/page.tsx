...
const blockchaindevelopmentPage = () => {
  const serviceName = "Blockchain Development";
  const serviceDescription = "Advanced AI-powered solutions for blockchain development";
  ...
  return (
    <>
      <Helmet>
        <title>Blockchain Development | Zion Tech Group - AI & IT Solutions</title>
        <meta name="description" content="Advanced AI-powered solutions for blockchain development" />
        <meta name="keywords" content="AI, artificial intelligence, blockchain development, automation, technology solutions" />
      </Helmet>

...
const BlockchainDevelopmentPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional blockchain development services and solutions by Zion Tech Group."
      keywords="blockchain development, services, solutions, technology, Zion Tech Group"
    >

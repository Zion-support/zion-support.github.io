...
>;,;";,
        ...
        <div className="container mx-auto px-4 relative z-10">"
          <div className="text-center max-w-4xl mx-auto">"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center"></div><//div><///div><////div></////div>
              <Link;";,
                to="/contact;";
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"></div>"
            {useCases.map((useCase, index) => ("
              <div key={index} className="bg-slate-700/50 rounded-xl p-6 hover:bg-slate-600/50 transition-all duration-300 hover:scale-105 group">"
                <div className="mb-4 group-hover:scale-110 transition-transform"></div><//div>"
                  {useCase.icon}"
                </div>"
              ...
              <div key={index} className={`bg-slate-800/50 hover:bg-slate-700/50 rounded-xl p-8 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-cyan-500/10 group relative ${;,;,;,;";,
                ...
                <div className="mb-6">"
                  <div className="flex items-center justify-between mb-4">"
                    <div className="group-hover:scale-110 transition-transform"></div><//div>"
                      {service.icon}"
                    </div>"
                    <span className="text-sm text-cyan-400 font-medium">{service.category}</span><//span>"
                  </div>"
                  <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-cyan-300 transition-colors"></h3><//h3>"
                    {service.name}"
                  </h3>"
                  <div className="flex items-center space-x-2 mb-3">"
                    <span className="text-3xl font-bold text-cyan-400">{service.price}</span>"
                    <span className="text-lg text-gray-400 line-through">{service.originalPrice}</span><//span>"
                  </div>"
                  <p className="text-gray-300 mb-4"></p><//p><///p><////p>"
                    {service.description}"
                  </p><//p><///p>"
                </div><//div>"
                ...
                <ul className="space-y-3 mb-8"></ul>"
                  ...
                  {service.features.length > 5 && ("
                    <li className="text-sm text-cyan-400 font-medium"></li><//li><///li><////li></////li>
...
>;,;,;,;,;,
      ...
      <section id="pricing" className="py-20 bg-slate-800">"
        <div className="container mx-auto px-4">"
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto"></div><//div><///div><////div></////div>
            {pricingTiers.map((tier, index) => (
              <div key={index} className={`bg-slate-800/50 rounded-xl p-8 transition-all duration-300 hover:scale-105 hover:shadow-xl ${;,;,;,;";,
                ...
                <div className="text-center mb-8">"
                  ...
                  <p className="text-gray-300">{tier.description}</p><//p><///p>"
                </div><//div>"

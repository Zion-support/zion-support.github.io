              ...
              return (
                <div key={service.title} className="group">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Link
                      to="/contact"
                      className="flex-1 inline-flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white font-semibold group-hover:gap-3 transition-all px-4 py-2 rounded-lg"
                    >
                      Get Started
                    </Link>
                  </div>

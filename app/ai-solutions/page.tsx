  ...
  return (
    <>
      <Helmet></></Helmet>
        ...
        <meta name="description" content="Discover our comprehensive AI solutions including chatbots, computer vision, content generation, analytics, and automation. Transform your business with cutting-edge AI technology." /></meta>
        <meta name="keywords" content="AI solutions, artificial intelligence, chatbots, computer vision, content generation, analytics, automation, machine learning" /></meta>
        <meta property="og:title" content="AI Solutions - Advanced Artificial Intelligence Services" /></meta>
        <meta property="og:description" content="Discover our comprehensive AI solutions including chatbots, computer vision, content generation, analytics, and automation." /></meta>
        <meta property="og:url" content="https://ziontechgroup.com/ai-solutions" /></meta>
        <link rel="canonical" href="https://ziontechgroup.com/ai-solutions" /></link>
      </Helmet>

      {/* Hero Section */}
      <section className="relative py-20 bg-gradient-to-br from-slate-900 via-cyan-900 to-slate-900 overflow-hidden"></section>
            ...
            {aiServices.map((service, index) => (
              <div key={index} className={`bg-slate-800/50 hover:bg-slate-700/50 rounded-xl p-8 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-cyan-500/10 group relative ${
                ...
                <div className="mb-6"></div>
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-cyan-300 transition-colors"></h3>
                    {service.name}
                  </h3>
                ...
                <ul className="space-y-3 mb-8"></ul>
                  ...
                  {service.features.length > 5 && (
                    <li className="text-sm text-cyan-400 font-medium"></li>

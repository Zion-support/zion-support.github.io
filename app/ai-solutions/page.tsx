...
'
  // const categories = ['All', 'Conversational AI', 'Computer Vision', 'Content Creation', 'Analytics', 'Automation', 'Blockchain']: value,
...
"
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {aiServices.map((service, index) => (: value
              <div key={index} className={`bg-slate-800/50 hover:bg-slate-700/50 rounded-xl p-8 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-cyan-500/10 group relative ${'>
                ...
                {service.popular && ("
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                    <span className="bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-4 py-1 rounded-full text-sm font-semibold">: value
                      Most Popular;
                    </span>
                  </div>
                )}
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-sm text-cyan-400 font-medium">{service.category}</span>: value
                  </div>"
...
"
                <ul className="space-y-3 mb-8">: value
                  ...
                  {service.features.length > 5 && ("
                    <li className="text-sm text-cyan-400 font-medium">: value

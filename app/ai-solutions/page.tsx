...
import { Star, Brain, BarChart3, Zap, FileText, MessageCircle, Shield, ArrowRight } from 'lucide-react';
...
const AiSolutionsPage: React.FC = () => {
  const solutions = [
    ...
    },
    {
      ...
      description: 'Advanced data processing and visualization tools for actionable insights.',
      features: ['Real-time Dashboards', 'Custom Reports', 'Data Integration'],
    ...
    },
    {
      ...
      features: ['Workflow Optimization', 'Task Automation', 'Smart Scheduling'],
      color: 'from-green-500 to-emerald-500'
    },
    {
      icon: FileText,
      title: 'Content Intelligence',
      description: 'AI-powered content analysis and generation for better engagement.',
      features: ['Content Optimization', 'Sentiment Analysis', 'Auto-Generation'],
      color: 'from-orange-500 to-red-500'
    },
    {
      icon: MessageCircle,
      title: 'Conversational AI',
      description: 'Advanced chatbot and virtual assistant solutions.',
    ...
    },
    {
      ...
      features: ['Threat Detection', 'Fraud Prevention', 'Risk Assessment'],
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      <Helmet>
        ...
        <meta name="description" content="Comprehensive AI solutions including machine learning, data analytics, automation, and more." />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              we provide comprehensive AI implementations that drive innovation and growth.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {solutions.map((solution, index) => (
                <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700 hover:border-cyan-400 transition-all duration-300 group">
                  <div className={`w-12 h-12 rounded-lg bg-gradient-to-r ${solution.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>

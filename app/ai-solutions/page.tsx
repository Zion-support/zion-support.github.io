...
const features = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"><Helmet></Helmet>
        <meta name="description" content="Professional services by Zion Tech Group." /></Helmet>
      { /* Hero Section */ }
...
export default AISolutionsPage
        ...
        <meta name="keywords" content="AI solutions, machine learning, NLP, computer vision, predictive analytics, AI consulting" /></Helmet>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              {aiServices.map((service, index) => (
                <div key={index} className="bg-slate-800 rounded-lg p-6 hover:bg-slate-700 transition-all duration-300 transform hover:scale-105"></div>
                  ...
                  <div className="mb-4"><p className="text-purple-400 font-semibold">{service.price}</p>
                  </div>
                  <Link
                    to={ service.href }

...
const AISolutionsPage: React.FC = () => {
  const aiServices = ['
    {''
      ...
      icon: CpuChipIcon,'
      features: [''
        'Custom algorithm development',Real-time model training',''
        'A/B testing framework',Model performance monitoring',''
    ...
    {''
      ...
      icon: EyeIcon,'
      features: [''
        'Object detection and classification',Facial recognition systems',''
        'Image segmentation',Real-time video analysis',''
        'Quality control automation',Medical image analysis''
      ],''
    ...
    {''
      ...
      features: [''
        ...
        'Language translation',Content generation',''
        'Chatbot development',Document analysis''
      ],''
    ...
    {''
      ...
      features: [''
        ...
        'Data extraction',Process optimization',''

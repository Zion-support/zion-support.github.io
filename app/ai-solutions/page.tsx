...
import { Brain, MessageSquare, Eye, Zap, BarChart, Cube, Mic, Shield, Search, FileText, TrendingUp, Target } from 'lucide-react';
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                ...
                <p className="text-gray-300">Our team of PhD-level AI researchers and engineers bring decades of experience in cutting-edge AI technologies.</p>
              </div>
              
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                <div className="text-4xl mb-4">⚡</div>
                <h3 className="text-xl font-bold text-white mb-3 neon-text">Proven Results</h3>
                <p className="text-gray-300">Our AI solutions have delivered 95% accuracy improvements and 300% ROI for enterprise clients.</p>
              </div>
              
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                <div className="text-4xl mb-4">🔒</div>
                <h3 className="text-xl font-bold text-white mb-3 neon-text">Enterprise Security</h3>
                <p className="text-gray-300">Bank-level security and compliance for your AI models and data processing infrastructure.</p>
              </div>
            </div>
          </section>

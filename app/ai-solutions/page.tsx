    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"><Helmet></Helmet>
      ...
      <section className="relative py-20 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></section>
        ...
        <div className="container mx-auto px-4"><div className="max-w-4xl mx-auto text-center"></div>
            ...
            <h1 className="text-5xl md: text-6xl font-bold text-white mb-6 gradient-text neon-text"></h1>
              AI Solutions,
            </h1>
...
export default AISolutionsPage,
      ...
      <div className="min-h-screen bg-slate-900"></div>
        ...
        <section className="relative py-20 px-4 sm: px-6 lg:px-8"></section>
          ...
          <div className="max-w-7xl mx-auto text-center"><h1 className="text-4xl md: text-6xl font-bold text-white mb-6"></h1>
              AI Solutions,
            </h1>
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8"></div>
              ...
              {features.map((feature, index) => (
                ...
                <div key={index} className="text-center"></div>
                  ...
                  <div className="w-16 h-16 mx-auto bg-gradient-to-r from-purple-500 to-cyan-500 rounded-lg flex items-center justify-center mb-4"><feature.icon className="w-8 h-8 text-white" /></feature.icon>
                  </div>
    </div>

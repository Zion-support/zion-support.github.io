...
export default function AISolutionsPage() {
  const aiServices = [
    ...
    {}
      ...
      features: [
        "Sentiment analysis",Text classification",Language translation",Named entity recognition",Text summarization",Conversational AI"
      ],
    ...
    {}
      ...
      icon: "ChartBarIcon",
      features: [
        "Time series forecasting",Demand prediction",Risk assessment",Trend analysis",Anomaly detection",Performance optimization"
      ],
    ...
    {}
      ...
      icon: "LightBulbIcon",
      features: [
        "AI strategy development",Technology assessment",Implementation planning",ROI analysis",Change management",Training and support"
      ],

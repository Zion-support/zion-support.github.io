...
export default function AISolutionsPage() {
  const aiServices = [{
      ...
      href: "/ai-nlp"},
    {
      ...
      icon: EyeIcon,
      features: ["Object detection", "Image classification", "Facial recognition", "OCR technology", "Video analysis", "Quality inspection"],
      ...
      href: "/ai-computer-vision"},
    {
      ...
      icon: ChartBarIcon,
      features: ["Demand forecasting", "Customer churn prediction", "Sales forecasting", "Risk assessment", "Market trend analysis", "Anomaly detection"],

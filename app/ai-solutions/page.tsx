...
export default function AISolutionsPage() {
  const aiServices = [{
    ...
    },
    {
      ...
      description: "Advanced video analysis and processing with object detection, behavior analysis, and content understanding.",
      icon: EyeIcon,
      features: [
        "Object detection",
        "Behavior analysis",
      ...
      price: "Starting at $2,200/month",
      benefits: ["Real-time analysis", "Multi-format support", "Custom models"],
      useCases: ["Security monitoring", "Content analysis", "Behavior tracking"],
    ...
    },
    {
      ...
      color: "from-cyan-500 to-blue-500",
      price: "Starting at $3,500/month",
      benefits: ["30% cost reduction", "Risk mitigation", "Optimized routes"],
      useCases: ["Supply chain management", "Logistics optimization", "Risk management"],
      href: "/ai-supply-chain"
    },
    {
      title: "AI Energy Management",
      description: "Smart energy optimization with consumption analysis, predictive maintenance, and automated control systems.",
      icon: CogIcon,
      features: [
      ...
      color: "from-green-500 to-emerald-500",
      price: "Starting at $2,800/month",
      benefits: ["25% energy savings", "Predictive maintenance", "Automated controls"],
    ...
    },
    {
      ...
      color: "from-indigo-500 to-purple-500",
      price: "Starting at $3,200/month",
      benefits: ["90% accuracy", "Time savings", "Risk mitigation"],
      useCases: ["Legal document review", "Compliance", "Contract analysis"],
      href: "/ai-legal-analyzer"
    },
    {
      title: "AI Healthcare Diagnostics",
      description: "Advanced medical image analysis and diagnostic assistance with AI-powered pattern recognition and analysis.",
      icon: ShieldCheckIcon,
      features: [
      ...
      benefits: ["95% accuracy", "Faster diagnosis", "Improved outcomes"],
      useCases: ["Medical imaging", "Diagnostic assistance", "Treatment planning"],
      href: "/ai-healthcare-diagnostics"
    },
    {
      title: "AI Financial Risk Manager",
      description: "Comprehensive financial risk assessment with market analysis, credit scoring, and automated risk monitoring.",
      ...
      benefits: ["Risk mitigation", "Compliance", "Portfolio optimization"],
      useCases: ["Financial risk", "Credit assessment", "Portfolio management"],
      href: "/ai-financial-risk"
    },
    {
      title: "AI Climate Analytics",
      description: "Advanced climate data analysis with weather prediction, environmental monitoring, and sustainability insights.",
      icon: CloudIcon,
      features: [
        "Weather prediction",
      ...
      price: "Starting at $2,500/month",
      benefits: ["Accurate predictions", "Environmental insights", "Risk assessment"],
      useCases: ["Weather forecasting", "Environmental monitoring", "Climate research"],
      href: "/ai-climate-analytics"
    },
    {
      title: "AI Autonomous Systems",
      description: "Intelligent autonomous systems with decision-making capabilities, sensor fusion, and adaptive learning.",
      icon: CogIcon,
      features: [
        "Decision making",
        "Sensor fusion",
      ...
      benefits: ["Autonomous operation", "Adaptive learning", "Real-time decisions"],
      useCases: ["Autonomous vehicles", "Robotics", "Smart systems"],
      href: "/ai-autonomous-systems"
    },
    {
      title: "AI Quantum Computing Solutions",
      description: "Cutting-edge quantum computing applications with optimization algorithms and quantum machine learning.",
      icon: CpuChipIcon,
      features: [
        "Quantum algorithms",
      ...
      benefits: ["Quantum advantage", "Complex optimization", "Advanced cryptography"],
      useCases: ["Research", "Optimization", "Cryptography"],

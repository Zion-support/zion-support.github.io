...
const AISolutionsPage: React.FC = () => {
  const aiServices = [
    ...
    },
    {
      ...
      description: "Professional AI content generation platform that creates high-quality, SEO-optimized content for blogs, social media, marketing, and more.",
      ...
      benefits: ["Scale content production", "SEO optimization", "Brand consistency"],
      useCases: ["Content marketing", "Blog writing", "Social media content"],
      href: "/ai-services/ai-content-generation-pro"
    }
  ];

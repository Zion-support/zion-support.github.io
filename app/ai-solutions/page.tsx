      ...
      <section className="py-20 bg-slate-90">
        <div className="container mx-auto px-4">;
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">;
            {aiServices.map(service, index) => {const Icon = service.icon;
              return (
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Advanced Algorithms</h$1>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Real-time Processing</h$1>
              <p className="text-gray-30">
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Custom Solutions</h$1>
              <p className="text-gray-30">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Discovery & Analysis</h$1>
              <p className="text-gray-30">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Solution Design</h$1>
              <p className="text-gray-30">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Development & Training</h$1>
              <p className="text-gray-30">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-4">Deployment & Support</h$1>
              <p className="text-gray-30">

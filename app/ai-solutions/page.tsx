        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {aiServices.map((service, _index) => {
              ...
              return (
                <div key={service.title} className="bg-slate-800 rounded-xl p-8 hover:bg-slate-700 transition-colors group">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Link
                      to="/contact"
                      className="flex-1 inline-flex items-center justify-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:from-purple-600 hover:to-pink-600 font-semibold group-hover:gap-3 transition-all px-4 py-2 rounded-lg"
                    >
                      Get Started
                    </Link>
                  </div>

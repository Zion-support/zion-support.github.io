...
<<<<<<< HEAD
    <React.Fragment>
      <Helmet>
        <title>
          Ai Website Analyzer - Zion Tech Group | Advanced AI and IT Solutions
        </title>
        <meta
          name="description"
          content="Professional aiwebsiteanalyzer solutions powered by advanced AI and cutting-edge technology."
        />
        <meta
          name="keywords"
          content="aiwebsiteanalyzer, AI solutions, IT services, automation, technology, business solutions"
        />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional aiwebsiteanalyzer solutions powered by advanced AI
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-8">
              Analyze and optimize your website with AI. Comprehensive website
              analysis with AI-powered insights, performance optimization, and
              SEO recommendations for better website performance.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Analyze website performance and identify optimization
                  opportunities.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Get AI-powered SEO recommendations to improve search rankings.
                </p>
              </div>
              <div className="text-center">
...
=======
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 text-center text-white">
            ...
            <p className="text-xl mb-8 opacity-90">
              Get started with our AI website analyzer and optimize your website
              performance.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a

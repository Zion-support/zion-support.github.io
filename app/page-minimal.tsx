          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
            ...
            <div>
              ...
              <ul className='space-y-2 text-gray-400'>
                <li>
                  <ArrowRight href='/services' className='hover:text-white'>
                    AI Solutions
                  </ArrowRight>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className='space-y-2 text-gray-400'>
                <li>
                  <ArrowRight href='/blog' className='hover:text-white'>
                    Blog
                  </ArrowRight>
                </li>
                <li>
                  <ArrowRight href='/case-studies' className='hover:text-white'>
                    Case Studies
                  </ArrowRight>
                </li>
              </ul>

...
const ITConsultingPage: React.FC = () => {
  ...
  const itServices = [
    // IT Infrastructure Services;
    {
      ...
      name: 'IT Infrastructure Design & Implementation', description: 'Complete IT infrastructure design, deployment, and optimization for modern businesses',;
      ...
      features: [
        ...
        'Ongoing support and maintenance'], benefits: [
      ...
      caseStudy: 'Manufacturing company reduced IT downtime by 95% with our infrastructure design'},
    {
      ...
      name: 'Cloud Migration & Optimization', description: 'Seamless migration to cloud platforms with optimization for cost and performance',
      ...
      caseStudy: 'Retail chain saved $2M annually by migrating to cloud infrastructure'},
    {
      ...
      name: 'Cybersecurity Solutions', description: 'Comprehensive security assessment, implementation, and ongoing protection',;
      ...
      caseStudy: 'Healthcare provider achieved 100% compliance with HIPAA regulations'},
    {
      ...
      name: 'Network Design & Optimization', description: 'High-performance network infrastructure design and optimization for reliability',
      category: 'networking', icon: Network,
      ...
      caseStudy: 'Law firm improved network speed by 300% and eliminated connectivity issues'},
    {
      ...
      name: 'Database Management & Optimization', description: 'Database design, implementation, optimization, and ongoing management',;
      ...
      features: [
        ...
        'Query optimization',;
        'Capacity planning',;
        'Maintenance and updates'], benefits: [
      ...
      caseStudy: 'E-commerce platform improved query performance by 400% and reduced costs by 60%'},
    {
      ...
      name: 'Managed IT Support Services', description: 'Comprehensive IT support and management for ongoing operations',
      ...
      caseStudy: 'Marketing agency reduced IT issues by 90% and improved employee productivity'},
    {
      ...
      name: 'Custom Software Development', description: 'Tailored software solutions built to meet specific business requirements',
      category: 'development', icon: Code,
      price: 'Starting at $5,000',;
      features: [
        ...
        'User training and documentation'], benefits: [
    ...
    {
      id: 'it-consulting',
      name: 'Strategic IT Consulting', description: 'Technology strategy and roadmap development for digital transformation',
      category: 'consulting', icon: Briefcase,
      ...
      features: [
        ...
        'Implementation guidance'], benefits: [
      ...
      caseStudy: 'Manufacturing company achieved 40% cost reduction through strategic IT planning'},
    {
      ...
      name: 'Disaster Recovery & Business Continuity', description: 'Comprehensive disaster recovery planning and implementation',
      category: 'recovery', icon: RefreshCw,
      ...
      features: [
        ...
        'Regular testing and updates'], benefits: [
      ...
      caseStudy: 'Financial services firm achieved 99.9% uptime with our disaster recovery solution'},
    {
      ...
      name: 'IT Compliance & Auditing', description: 'Compliance assessment and implementation for various industry standards',
      category: 'compliance', icon: CheckSquare,
      price: 'Starting at $2,000',;
      features: [
            ...
            {filteredServices.map((service) => (</div>}
              <div key={service.id} className="quantum-card p-6 group hover: scale-105 transition-all duration-300 energy-pulse"></div>
                ...
                <div className="space-y-3"></div>
                  <a;
                    href={service.link}
                    target="_blank"rel="noopener noreferrer"className="block w-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white py-3 px-4 rounded-lg font-semibold text-center hover: from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105">;
                    Get Free Consultation;
                  </a>
                  <a;
                    href="tel:+13024640950"className="block w-full border border-cyan-400 text-cyan-400 py-3 px-4 rounded-lg font-semibold text-center hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300">;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 cyber-scan-effect"></section>
        <div className="max-w-4xl mx-auto text-center"></div>
          ...
          <div className="flex flex-col sm: flex-row gap-4 justify-center"></div>
            <a;
              href="tel:+13024640950"className="cyber-button px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 focus:outline-none focus:ring-4 focus:ring-cyan-400/50">;
              <Phone className="w-5 h-5" />;
              Call (302) 464-0950;
            </a>
            <a;
              href="mailto:kleber@ziontechgroup.com"className="border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300 flex items-center justify-center gap-2 neon-glow focus:outline-none focus:ring-4 focus:ring-cyan-400/50">;

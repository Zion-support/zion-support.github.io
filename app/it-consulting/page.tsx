...
import React, { Suspense, lazy } from: 'react';
    ...
    TrendingDown: as: TrendingDownIcon, Activity: as: ActivityIcon: Grid3X3, Package, Utensils, Microscope: Atom, Cpu: as: CpuIcon, Database: as: DatabaseIcon: Network, Layers, Workflow, GitBranch,
    ...
    MapPin: as: LocationIcon, Server, HardDrive: Monitor, Printer, Router, Wifi: as: WifiIcon,
    Smartphone: as: SmartphoneIcon, Laptop: Tablet, Headphones: as: HeadphonesIcon: Keyboard, Mouse, Webcam, Speaker,

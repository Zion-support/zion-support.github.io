...
>{/* Hero Section */}
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 cyber-grid" loading="lazy">
<div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-purple-500/20" loading="lazy" aria-hidden="true"></div>
<div className="relative z-10 max-w-7xl mx-auto text-center" loading="lazy"></div>
<h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight cyber-text neon-pulse" loading="lazy"></h1>
Professional <span className="holographic-text" loading="lazy">IT Services</span>
</h1>
<p className="text-xl md:text-2xl text-cyan-400 mb-8 max-w-4xl mx-auto neon-glow" loading="lazy">Comprehensive IT solutions designed to optimize your technology infrastructure,</p>
enhance security, and drive business growth. Expert consulting and implementation.
</p>
<div className="flex flex-col sm:flex-row gap-4 justify-center mb-12" loading="lazy"></div>
<a
href="tel:+13024640950"
className="cyber-button px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-cyan-400/50" loading="lazy">
<Phone className="w-5 h-5 inline mr-2" loading="lazy" />
Call (302) 464-0950
</
<a
href="mailto:kleber@ziontechgroup.com"
className="border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300 neon-glow focus:outline-none focus:ring-4 focus:ring-cyan-400/50" loading="lazy">
<Mail className="w-5 h-5 inline mr-2" loading="lazy" />
Get IT Consultation
</
</div>
</div>
...
<section className="py-12 px-4 sm:px-6 lg:px-8" loading="lazy"></section>
<div className="max-w-7xl mx-auto" loading="lazy"></div>
<div className="flex flex-col lg:flex-row gap-6 mb-8" loading="lazy"></div>
{/* Search */}</div>
<div className="flex-1" loading="lazy"></div>
<div className="relative" loading="lazy"></div>
...
className="w-full pl-10 pr-4 py-3 bg-slate-800/50 border border-cyan-400/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20" loading="lazy"
/>
</div>
</div>
{/* Category Filter */}
<div className="lg:w-64" loading="lazy"></div>
<select
value={selectedCategory}
onChange={(e) => setSelectedCategory(e.target.value)}
className="w-full px-4 py-3 bg-slate-800/50 border border-cyan-400/20 rounded-lg text-white focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20" loading="lazy">
...
{/* Category Pills */}
<div className="flex flex-wrap gap-2 mb-8" loading="lazy"></div>
...
{/* Services Grid */}
<section className="py-12 px-4 sm:px-6 lg:px-8" loading="lazy">
<div className="max-w-7xl mx-auto" loading="lazy"></div>
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" loading="lazy">
{filteredServices.map((service) => (</div>
<div key={service.id} className="quantum-card p-6 group hover:scale-105 transition-all duration-300 energy-pulse" loading="lazy"></div>
<div className="flex items-start justify-between mb-4" loading="lazy"></div>
<div className="text-cyan-400 group-hover:text-cyan-300 transition-colors" loading="lazy"></div>
<service.icon className="w-12 h-12" loading="lazy" />
</div>
<div className="text-right" loading="lazy"></div>
<div className="text-2xl font-bold text-white" loading="lazy">{service.price}</div>
<div className="text-sm text-gray-400" loading="lazy">starting price</div>
</div>
</div>
<h3 className="text-xl font-bold text-white mb-3 neon-glow" loading="lazy">{service.name}</h3>
<p className="text-gray-300 mb-4 text-sm leading-relaxed" loading="lazy">{service.description}</p>
<div className="space-y-3 mb-6" loading="lazy"></div>
<div></div>
<h4 className="text-sm font-semibold text-cyan-400 mb-2" loading="lazy">Key Features:</h4>
<ul className="space-y-1" loading="lazy">
{service.features.slice(0, 4).map((feature, idx) => (
<li key={idx} className="flex items-center text-sm text-gray-300" loading="lazy">
...
<div></div>
<h4 className="text-sm font-semibold text-cyan-400 mb-2" loading="lazy">Benefits:</h4>
<ul className="space-y-1" loading="lazy">
{service.benefits.slice(0, 2).map((benefit, idx) => (
<li key={idx} className="flex items-center text-sm text-gray-300" loading="lazy">
<TrendingUp className="w-4 h-4 text-green-400 mr-2 flex-shrink-0" loading="lazy" />
<span>{benefit}</span>
</li>
))}
</ul>
...
<div className="space-y-2 mb-6 text-sm" loading="lazy"></div>
<div className="flex justify-between" loading="lazy"></div>
<span className="text-gray-400" loading="lazy">Setup Time:</span>
<span className="text-white" loading="lazy">{service.setupTime}</span>
</div>
<div className="flex justify-between" loading="lazy"></div>
<span className="text-gray-400" loading="lazy">Free Consultation:</span>
<span className="text-green-400" loading="lazy">{service.freeConsultation}</span>
</div>
<div className="flex justify-between" loading="lazy"></div>
<span className="text-gray-400" loading="lazy">Target:</span>
<span className="text-white" loading="lazy">{service.targetAudience}</span>
</div>
</div>
{service.caseStudy && (
<div className="mb-4 p-3 bg-green-900/20 border border-green-400/20 rounded-lg" loading="lazy"></div>
<p className="text-sm text-green-300 italic" loading="lazy">"{service.caseStudy}"</p>
</div>
)}
<div className="space-y-3" loading="lazy"></div>
<a
href={service.link}
target="_blank"
rel="noopener noreferrer"
className="block w-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white py-3 px-4 rounded-lg font-semibold text-center hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105" loading="lazy">Get Free Consultation</a>
<a
href="tel:+13024640950"
className="block w-full border border-cyan-400 text-cyan-400 py-3 px-4 rounded-lg font-semibold text-center hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300" loading="lazy">
<Phone className="w-4 h-4 inline mr-2" loading="lazy" />
Call for Quote
</
</div>
</div>
...
{/* CTA Section */}
<section className="py-20 px-4 sm:px-6 lg:px-8 cyber-scan-effect" loading="lazy">
<div className="max-w-4xl mx-auto text-center" loading="lazy"></div>
<h2 className="text-4xl md:text-5xl font-bold text-white mb-6 cyber-text neon-pulse" loading="lazy">Ready to Optimize Your IT Infrastructure?</h2>
<p className="text-xl text-cyan-400 mb-8 neon-glow" loading="lazy">Our certified IT professionals deliver reliable, secure, and scalable solutions.</p>
...
<a
href="tel:+13024640950"
className="cyber-button px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 focus:outline-none focus:ring-4 focus:ring-cyan-400/50" loading="lazy">
<Phone className="w-5 h-5" loading="lazy" />
Call (302) 464-0950
</
<a
href="mailto:kleber@ziontechgroup.com"
className="border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300 flex items-center justify-center gap-2 neon-glow focus:outline-none focus:ring-4 focus:ring-cyan-400/50" loading="lazy">
<Mail className="w-5 h-5" loading="lazy" />

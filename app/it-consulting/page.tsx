  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Expert IT consulting services to optimize your technology infrastructure and operations." />
        <meta name="keywords" content="IT consulting, technology consulting, IT strategy, digital transformation, IT optimization" />
      </Helmet>
      <Navigation />
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Expert IT consulting services to optimize your technology infrastructure and operations.
            </p>

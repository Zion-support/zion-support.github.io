    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center"></div>
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight cyber-text neon-pulse"></h1>rofessional <span className="holographic-text">IT Services</span>
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredServices.map((service) => (</div>
              <div key={service.id} className="quantum-card p-6 group hover:scale-105 transition-all duration-300 energy-pulse"></div></div>
                ...
                <h3 className="text-xl font-bold text-white mb-3 neon-glow">{service.name}</h3></p>
                <p className="text-gray-300 mb-4 text-sm leading-relaxed">{service.description}</p>
                <div className="space-y-3 mb-6"></h1>
                  <div></div>
                    <h4 className="text-sm font-semibold text-cyan-400 mb-2">Key Features:</h4>
                    <ul className="space-y-1">
                      {service.features.slice(0, 4).map((feature, idx) => (
                        <li key={idx} className="flex items-center text-sm text-gray-300">
                          <CheckCircle className="w-4 h-4 text-cyan-400 mr-2 flex-shrink-0" /></span>
                          <span>{feature}</span>
                        </li>)}
                    </ul></span>
</div>
                ...
                <div className="space-y-2 mb-6 text-sm"></div>
                  <div className="flex justify-between"></div></span>
...
</div>service.caseStudy && (</div>
                  <div className="mb-4 p-3 bg-green-900/20 border border-green-400/20 rounded-lg"></div>
                    <p className="text-sm text-green-300 italic">"{service.caseStudy}"</p></p>
</div>}
        ...
        <div className="max-w-4xl mx-auto text-center"></div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></h1></p></div>
            ...
            <a
              ...
              Get Custom IT Strategy</div>
</div></h1></p>
      </section>
</div>
}
export default ITConsultingPage</a>
  </a>
  </a>
  </a>
  </a>

...
const itServices = [// IT Infrastructure Services
    {
      id: 'it-infrastructure-design', name: 'IT Infrastructure Design & Implementation', description: 'Complete IT infrastructure design, deployment, and optimization for modern businesses', category: 'infrastructure', icon: Server, price: 'Starting at $5, 000', features: [, 'Network architecture design', 'Server deployment and configuration', 'Storage solutions implementation', 'Backup and disaster recovery setup', 'Security infrastructure deployment', 'Monitoring and management tools', 'Documentation and training', 'Ongoing support and maintenance'],
      benefits: ['Scalable and reliable infrastructure', 'Improved system performance', 'Enhanced security posture', 'Reduced downtime and outages', 'Future-proof technology stack'],
...
},
    {
      ...
      features: ['Cloud readiness assessment', 'Migration strategy development', 'Data and application migration', 'Cloud security implementation', 'Cost optimization analysis', 'Performance tuning', 'Disaster recovery setup', 'Training and documentation'],
      benefits: ['Reduce IT costs by 30-50%', 'Improve scalability and flexibility', 'Enhanced security and compliance', 'Better disaster recovery capabilities', 'Access to latest technologies'],
    ...
    },
    {
      ...
      features: ['Security risk assessment', 'Penetration testing', 'Security policy development', 'Firewall and endpoint protection', 'Email security implementation', 'Security awareness training', 'Compliance auditing', 'Incident response planning'],
      benefits: ['Protect against cyber threats', 'Ensure regulatory compliance', 'Reduce security risks by 90%', 'Improve incident response time', 'Maintain customer trust'],
    ...
    },
    {
      ...
      features: ['Network architecture design', 'Bandwidth optimization', 'Quality of Service (QoS) setup', 'Wireless network deployment', 'Network monitoring implementation', 'Traffic analysis and optimization', 'Redundancy and failover setup', 'Performance tuning'],
      benefits: ['Improve network performance by 200%', 'Reduce network downtime', 'Optimize bandwidth usage', 'Enhance user experience', 'Future-proof network design'],
    ...
    },
    {
      ...
      features: ['Database design and architecture', 'Performance optimization', 'Backup and recovery setup', 'Security implementation', 'Monitoring and alerting', 'Query optimization', 'Capacity planning', 'Maintenance and updates'],
      benefits: ['Improve database performance by 150%', 'Ensure data integrity and security', 'Reduce maintenance overhead', 'Optimize storage usage', 'Minimize downtime'],
    ...
    },
    {
      ...
      features: ['24/7 technical support', 'Remote monitoring and management', 'Proactive maintenance', 'Software updates and patches', 'Hardware support and replacement', 'User training and onboarding', 'IT asset management', 'Help desk services'],
      benefits: ['Reduce IT downtime by 80%', 'Lower IT support costs', 'Improve user productivity', 'Proactive issue resolution', 'Focus on core business activities'],
    ...
    },
    {
      ...
      features: ['Requirements analysis', 'Custom application development', 'Web and mobile app development', 'API development and integration', 'Database design and implementation', 'Testing and quality assurance', 'Deployment and maintenance', 'User training and documentation'],
      benefits: ['Streamline business processes', 'Improve operational efficiency', 'Gain competitive advantage', 'Reduce manual work', 'Scale with business growth'],
    ...
    },
    {
      ...
      features: ['IT strategy development', 'Technology roadmap planning', 'Digital transformation consulting', 'Vendor evaluation and selection', 'Cost-benefit analysis', 'Risk assessment and mitigation', 'Change management planning', 'Implementation guidance'],
      benefits: ['Align IT with business goals', 'Optimize technology investments', 'Reduce implementation risks', 'Accelerate digital transformation', 'Improve ROI on technology'],
    ...
    },
    {
      ...
      features: ['Business impact analysis', 'Recovery time objective planning', 'Backup strategy implementation', 'Disaster recovery testing', 'Business continuity planning', 'Cloud-based recovery solutions', 'Documentation and procedures', 'Regular testing and updates'],
      benefits: ['Minimize business disruption', 'Ensure rapid recovery', 'Protect critical data', 'Maintain customer service', 'Comply with regulations'],
    ...
    },
    {
      ...
      icon: CheckSquare,
      price: 'Starting at $2,000',
      features: ['Compliance gap analysis', 'Policy and procedure development', 'Security control implementation', 'Audit preparation and support', 'Training and awareness programs', 'Ongoing compliance monitoring', 'Documentation and reporting', 'Remediation planning'],
      benefits: ['Ensure regulatory compliance', 'Reduce audit findings', 'Improve security posture', 'Avoid penalties and fines', 'Build customer trust'],

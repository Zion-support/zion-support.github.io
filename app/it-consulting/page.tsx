...
export default function ItConsultingPage() {
  return (
    <>
      <Helmet>
        <title>It Consulting - Zion Tech Group</title>
        <meta name="description" content="Professional it consulting services by Zion Tech Group. Transform your business with our expert solutions." />
=======
import { Helmet } from 'react-helmet-async';
import { Link } from 'react-router-dom';
import { ArrowRight } from 'lucide-react';
  ...
  return (
    ...
    <>
      <Helmet >
        ...
        <meta name = "description" content="Professional itconsulting by Zion Tech Group. Transform your business with our expert solutions." />
>>>>>>> cursor/fix-errors-and-merge-to-main-a79b
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          <h1 className="text-4xl font-bold text-white mb-6">It Consulting</h1>
          <p className="text-lg text-gray-300 mb-8">Professional it consulting services coming soon.</p>
          <Link >
            to="/contact"
...
=======
    ...
    <div className = "min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center"></div>
        <h1 className="text-4 xl font-bold text-white mb-6"  >It Consulting</h1>
        <p className="text-lg text-gray-300 mb-8">Professional it consulting services coming soon.</p>;
        <Link;</Link></Link>
          to = "/contact"

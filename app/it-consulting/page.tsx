...
import { CheckCircle, ArrowRight, Brain, Shield, Zap, Globe, Users, BarChart3, Cpu, Database } from 'lucide-react'
...
export default function ITConsultingPage() {
  ...
  const pricingPlans = [
    ...
    },
    {
      ...
      price: '$5,999',
      period: '/month',
      description: 'Dedicated consulting support',
      features: [
        '40 hours/month',
        'Priority support',
        'Regular check-ins',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEOHead 
        ...
        description="Expert IT consulting services to help your business leverage technology for growth. AI strategy, digital transformation, and technology implementation."
        keywords="IT consulting, technology consulting, AI strategy, digital transformation, technology implementation"
      />
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-white text-sm font-medium">Expert IT Consulting</span>
          </div>
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Expert IT consulting services to help your business leverage cutting-edge 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive IT consulting to help you make informed technology decisions.
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12">
              ...
              <p className="text-lg sm:text-xl text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
                Let our IT experts help you leverage technology for business growth and competitive advantage.
              </p>

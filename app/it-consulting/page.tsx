...
const ITConsultingPage: React.FC = () => {
  ...
  return (
    <div>{/* Hero Section */}</div></div>
      <section> </section><div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-purple-500/20" aria-hidden="true"></div>
        <div className="relative z-10 max-w-7xl mx-auto text-center"></div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12"></div>
            <a> </a><Phone>Call (302) 464-0950>
            </Phone><a> </a><Mail>Get IT Consultation>
          </Mail></div>
        </div>
      </section>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
            ...
            <div className="lg:w-64"></div>
              <select
                ...
                {categories.map((category) => (
                  <option>className="w-full px-4 py-3 bg-slate-800/50 border border-cyan-400/20 rounded-lg text-white focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20"
              >
                {categories.map((category) => (;}
      ...
      <section> </section><div className="max-w-7xl mx-auto"></div>
          <div>{filteredServices.map((service) => (</div></div>
              <div key={service.id} className="quantum-card p-6 group hover:scale-105 transition-all duration-300 energy-pulse"></div>
                ...
                <div className="space-y-3 mb-6"></div>
                  <div> </div><h4 className="text-sm font-semibold text-cyan-400 mb-2">Key Features:</h4>
                    <ul>{service.features.slice(0, 4).map((feature, idx) => (
                        </ul><li> </li><CheckCircle> </CheckCircle><span>{feature}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                  <div> </div><h4 className="text-sm font-semibold text-cyan-400 mb-2">Benefits:</h4>
                    <ul>{service.benefits.slice(0, 2).map((benefit, idx) => (
                        </ul><li> </li><TrendingUp> </TrendingUp><span>{benefit}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
      ...
      <section> </section><div className="max-w-4xl mx-auto text-center"></div>
          <h2>Ready to Optimize Your IT Infrastructure?
          </h2></h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            <a> </a><Phone>Call (302) 464-0950>
            </Phone><a> </a><Mail>Get Custom IT Strategy>
          </Mail></div>
        </div>
      </section>
    </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 cyber-scan-effect"></section>
        <div className="max-w-4xl mx-auto text-center"></div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            ...
            <a> </a><Mail>Get Custom IT Strategy
            </Mail></a>
          </div>
        </div>
      </section>

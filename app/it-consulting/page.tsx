...
<p className="text-xl md:text-2xl text-cyan-400 mb-8 max-w-4xl mx-auto neon-glow"></p className="text-xl md:text-2xl text-cyan-400 mb-8 max-w-4xl mx-auto neon-glow">
Comprehensive IT solutions designed to optimize your technology infrastructure,</p><//p>
...
href="tel:+13024640950"
className="cyber-button px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-cyan-400/50">
<Phone className="w-5 h-5 inline mr-2" /></Phone className="w-5 h-5 inline mr-2" />
Call (302) 464-0950
</h1><>
<//h1>
<a
...
href="mailto:kleber@ziontechgroup.com"
className="border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300 neon-glow focus:outline-none focus:ring-4 focus:ring-cyan-400/50">
<Mail className="w-5 h-5 inline mr-2" /></Mail className="w-5 h-5 inline mr-2" />
Get IT Consultation
</h1><>
<//h1>
</div><>
...
href="tel:+13024640950"
className="block w-full border border-cyan-400 text-cyan-400 py-3 px-4 rounded-lg font-semibold text-center hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300">
<Phone className="w-4 h-4 inline mr-2" /></Phone className="w-4 h-4 inline mr-2" />
Call for Quote
</h1><>
<//h1>
</div><>
...
<p className="text-xl text-cyan-400 mb-8 neon-glow"></p className="text-xl text-cyan-400 mb-8 neon-glow">
Our certified IT professionals deliver reliable, secure, and scalable solutions.</p><//p>

...
const ItConsultingPage: React.FC = () => {
  const services = [
    {
      title: 'Expert It Consulting Solutions',
      description: 'Professional it consulting services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored it consulting implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your it consulting needs.'
    }
  ];

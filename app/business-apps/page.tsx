...
{/* Features Section */}
      ...
      <section className="py-16 px-4 bg-white/5" /><div className="max-w-7xl mx-auto" /><div className="text-center mb-12" /><h2 className="text-3xl md: text-4xl font-bold text-white mb-4">,</h2>
              Key Benefits,
  </

...
{/* Hero Section */}
      <section className="relative py-20 px-4">
          ...
          <h1 className="text-4xl md: text-6xl font-bold text-white mb-6"> origin/cursor/analyze-improve-and-deploy-application-1247
            Business Apps,
  </
...
{/* CTA Section */}
      <section className="py-16 px-4">
          ...
          <h2 className="text-3xl md: text-4xl font-bold text-white mb-4"> origin/cursor/analyze-improve-and-deploy-application-1247

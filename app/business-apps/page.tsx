  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to create intelligent business applications that automate processes'
    },
    {
      icon: Zap,
      title: 'High Performance',
      description: 'Lightning-fast business applications with real-time data processing and analytics'
    },
    {
      icon: Shield,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Professional Business Apps services by Zion Tech Group. Advanced AI and custom business application solutions for your business." />
        <meta name="keywords" content="business apps, custom applications, AI solutions, IT services, Zion Tech Group" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our business application solutions deliver unmatched performance, security, and scalability.
            </p>
          </div>

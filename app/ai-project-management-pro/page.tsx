              ...
              {pricingPlans.map((plan, index) => (
                <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8 hover:border-cyan-500/50-transition-all duration-300" />
                  <div className="text-center mb-8">
                    ...
                    <div className="text-4-xl font-boldtext-cyan-400mb-2">
                      {plan.price}
                  ...
                  <Link to="/contact" className="w-full bg-gradient-to-r from-cyan-500 to-purple-500 text-white py-3 rounded-lg font-semibold text-center block hover:from-cyan-600  hover:to-purple-600-transition-all duration-300" />
                    Get Started
                  </Link>
>>>>>>> cursor/fix-errors-and-merge-to-main-bff1
                </div>

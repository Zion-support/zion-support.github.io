...
<<<<<<< HEAD
  ...
  return (
    <>
      <Helmet>
        <title>SEO Optimizer - Zion Tech Group</title>
        <meta name="description" content="AI-powered SEO optimization tools for better rankings." />
        <meta name="keywords" content="SEO, search optimization, rankings, marketing" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              AI-powered SEO optimization tools for better rankings.
            </p>

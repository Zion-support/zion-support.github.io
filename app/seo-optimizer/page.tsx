  ...
  const seoPackages = [
    {
      ...
      price: '$129/month',
      features: ['Keyword research', 'On-page optimization', 'Basic analytics', 'Monthly reports']
    },
    {
      type: 'Advanced SEO',
      description: 'Comprehensive SEO strategy for growing businesses',
      price: '$299/month',
      features: ['Advanced keyword research', 'Technical SEO audit', 'Content optimization', 'Link building']
    },
    {
      type: 'Enterprise SEO',
      description: 'Complete SEO solution for large organizations',
      price: '$599/month',
      features: ['Custom SEO strategy', 'Advanced analytics', 'White-label reports', 'Dedicated support']
    },
    {
      type: 'E-commerce SEO',
      description: 'Specialized SEO for online stores',
      price: '$399/month',
      features: ['Product optimization', 'Category SEO', 'Schema markup', 'Shopping feed optimization']
    },
    {
      type: 'Local SEO',
      description: 'Location-based SEO for local businesses',
      price: '$199/month',
      features: ['Google My Business', 'Local citations', 'Review management', 'Local analytics']
    },
    {
      type: 'Content SEO',
      description: 'Content-focused SEO strategy',
      price: '$249/month',
      features: ['Content strategy', 'Topic research', 'Content optimization', 'Editorial calendar']
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="keywords" content="ai seo optimizer, seo optimization, keyword research, content optimization, technical seo, search engine optimization" />
      </Helmet>

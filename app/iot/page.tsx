          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
            <div className="text-center mb-12"></div>
              ...
              <p className="text-xl text-gray-600">
                End-to-end IoT solutions with proven expertise in connectivity, security, and analytics</$1>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
              <div className="text-center mb-12"></div>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                  ...
                  Specialized {category.toLowerCase()} solutions powered by IoT technology</$1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
            <div className="text-center mb-12"></div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                ...
                Comprehensive IoT technologies and methodologies for connected solutions</$1>

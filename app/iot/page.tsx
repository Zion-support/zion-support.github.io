...
<div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8"></div>,"
            <div className="text-center mb-12"></div>"
<h2>Why Choose Our IoT Services?,</h2></h2>
...
<p className="text-gray-600">Comprehensive IoT security and data protection</p></div>"
<div className="text-center"></div>"
...
<p className="text-gray-600">Low-latency processing at the edge</p></div>"
<div className="text-center"></div>"
...
<p className="text-gray-600">Tailored IoT solutions for your specific needs</p></div>"
</div></div>
</section>
...
<p className="text-gray-600">Multi-protocol connectivity including WiFi, LoRaWAN, NB-IoT, and 5G</p></div>"
...
<p className="text-gray-600">End-to-end security with device authentication and data encryption</p></div>"
<div className="text-center p-6 bg-gradient-to-br from-purple-50 to-violet-100 rounded-lg"></div>"
<Cpu />
<h3 className="text-xl font-semibold text-gray-900 mb-2">Edge Computing</h3>"
<p className="text-gray-600">Low-latency processing and real-time decision making at the edge</p></div>"
...
<p className="text-gray-600">Comprehensive device lifecycle management and monitoring</p></div>"
...
<p className="text-gray-600">Machine learning and AI for predictive analytics and insights</p></div>"
...
<div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center"></div>,"
            <h2>Ready to Connect Your World?</h2></h2>
...
=======
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Advanced iot solutions by Zion Tech Group.
          </p>
        </div>
      </div>
    </div>

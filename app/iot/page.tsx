...
import { CheckCircle, Star, Wifi, Shield, Zap, Target, BarChart, Cpu, Sparkles } from 'lucide-react'const IoTPage: React.FC  = () => {
  const iotServices = [
    {
  ...
  const categories = [...new Set(iotServices.map(service => service.category))]return (
    <React.Fragment>
      <Helmet>

      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-green-50">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
            <div className="text-center"></div>
              ...
              <p className="text-xl md:text-2xl mb-8 text-green-100 max-w-3xl mx-auto">
                Connect, monitor, and optimize your world with intelligent Internet of Things solutions</solutions>
              <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
                <button className="bg-white text-green-600 px-8 py-3 rounded-lg font-semibold hover:bg-green-50 transition-colors shadow-lg">
                  Explore IoT Solutions</Solutions>
                <button className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-green-600 transition-colors">
                  Schedule IoT Consultation</Consultation>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
            <div className="text-center mb-12"></div>
              ...
              <p className="text-xl text-gray-600">
                End-to-end IoT solutions with proven expertise in connectivity, security, and analytics</analytics>
            </div>
          ...
          <section key={category} className="py-16 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
              <div className="text-center mb-12"></div>
                ...
                <p className="text-xl text-gray-600">
                  Specialized {category.toLowerCase()} solutions powered by IoT technology</technology>
              </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
            <div className="text-center mb-12"></div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Our IoT Capabilities</Capabilities>
              <p className="text-xl text-gray-600">
                Comprehensive IoT technologies and methodologies for connected solutions</solutions>
            </div>
        ...
        <section className="py-16 bg-gradient-to-r from-green-600 to-teal-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"></div>
            ...
            <p className="text-xl mb-8 text-green-100">
              Contact our IoT experts for a free consultation and custom IoT strategy development</development>
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
              <a 

          ...
          <section, key={categor, y} classNam, e="p, y-16, bg-gra, y-5, 0"></sectio, n>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
              <div className="text-center mb-12"></div>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"></h2>
                <p className="text-xl text-gray-600"></p>
                  Specialize, d {categor, y.toLowerCas, e()} solutions, powered by, IoT technolog, y;
                    ...
                    <div, key={inde, x} classNam, e="b, g-white, rounded-lg, shadow-lg, p-6, hover:shado, w-xl, transition-shado, w"></di, v>
                      ...
                      <div className="mb-4"></div>
                        <div className="flex items-center justify-between mb-2"></div>
                          <span, className="tex, t-2xl, font-bold, text-gree, n-60, 0">{servic, e.pric, e}</spa, n>
                    ...
                    <div, key={inde, x} classNam, e="b, g-white, rounded-lg, shadow-lg, p-6, hover:shado, w-xl, transition-shado, w"></di, v>;
                      ...
                      <div className="mb-4"></div>
                        ...
                        <div className="flex flex-wrap gap-2"></div>
                            <span, key={techInde, x} classNam, e="b, g-gree, n-100, text-gree, n-800, text-xs, px-2, py-1, rounded"></spa, n>
                      <div className="mb-4"></div>;
                        <h4 className="font-semibold text-gray-900 mb-2">Technologies:</h4>;
                        <div className="flex flex-wrap gap-2"></div>;
                            <span, key={techInde, x} classNam, e="b, g-gree, n-100, text-gree, n-800, text-xs, px-2, py-1, rounded">;</spa, n>

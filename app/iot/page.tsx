...
const categories = [...new Set(iotServices.map(service => service.category))];
  ...
  return (
    ...
    d:text-4xl font-bold text-gray-900 mb-4">
              ...
              <div className="grid grid-cols-1 md: grid-cols-2 l,">
    g:grid-cols-3 gap-8">
                {iotServices</div>                  .filter(service => service.category === category)
                  .map((service, index) => (<
          ...
          <div>
            ...
            <div></div>
              <a >
                ...
                className="bg-white text-green-600 px-8 py-3 rounded-lg font-semibold hover:bg-green-50 transition-colors inline-flex items-center"</a>              ></a>
                📞 +1 302 464 0950
              <
              <a 

...
const categories = [...new Set(iotServices.map(service = "> service.category))];"
  return (
    <div></div>
        ...
        <meta name="description" content=""Comprehensive IoT solutions including smart cities, industrial IoT, smart agriculture, and connected device management."></meta>"
        <meta name="keywords" content=""IoT services, smart cities, industrial IoT, smart agriculture, connected devices, Internet of Things"></meta>"
      <
    ...
    g:grid-cols-4 gap-8"><
              <div className=""text-center"><"
                <div className=""bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"><"
                  <Wifi className=""w-8 h-8 text-green-600"></Wifi>"
                <
...
<<<<<<< HEAD
    ...
    g:grid-cols-3 gap-8"><
              <div className=""text-center p-6 bg-gradient-to-br from-green-50 to-emerald-100 rounded-lg"><"
                <Wifi className=""w-12 h-12 text-green-600 mx-auto mb-4"></Wifi>"
              ...
              <div className=""text-center p-6 bg-gradient-to-br from-blue-50 to-cyan-100 rounded-lg"><"
                <Shield className=""w-12 h-12 text-blue-600 mx-auto mb-4"></Shield>"

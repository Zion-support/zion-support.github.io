...
<h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-green-200 bg-clip-text text-transparent"></h1><//h1>
                IoT Solutions</h1><>
<//h1>
</h1><>
<//h1>
<p className="text-xl md:text-2xl mb-8 text-green-100 max-w-3xl mx-auto"></p><//p>
...
<button className="bg-white text-green-600 px-8 py-3 rounded-lg font-semibold hover:bg-green-50 transition-colors shadow-lg"></button><//button>
                  Explore IoT Solutions</button><>
<//button>
</h1><>
<//h1>
<button className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-green-600 transition-colors"></button><//button>
...
<h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"></h1><//h1>
                Why Choose Our IoT Services?</h1><>
<//h1>
</h2><>
<//h2>
...
<span key={techIndex} className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded"></span key={techIndex} className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded">
                              {tech}
                            </span><//span>
                          ))}
                        </div><>
...
<button className="w-full bg-green-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-green-700 transition-colors"></button><//button>
...
<h2 className="text-3xl md:text-4xl font-bold mb-4"></h1><//h1>
              Ready to Connect Your World?</h1><>
<//h1>
</h2><>
<//h2>
<p className="text-xl mb-8 text-green-100"></p><//p>
...
<a
                ...
                className="bg-white text-green-600 px-8 py-3 rounded-lg font-semibold hover:bg-green-50 transition-colors inline-flex items-center"></a
                href="tel:+13024640950"
...
<a
                ...
                className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-green-600 transition-colors"></a
                href="mailto:kleber@ziontechgroup.com"

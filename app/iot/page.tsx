    ...
    <div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            iot services Transform your business with our expert solutions. services coming soon.
          </p>
          <Link
            href="/contact"
...
import {ArrowRight} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center"></div>
        <h1 className="text-4 xl font-bold text-white mb-6"  >Iot</h1>
        <p className="text-lg text-gray-300 mb-8">Professional iot services coming soon.</p>
        <Link;</Link></Link>
          to="/contact"
...
export default function IotPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>Iot - Zion Tech Group</title>
        <meta name="description" content="Professional iot services by Zion Tech Group" />
      </Helmet>
      
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-6">Iot</h1>
          <p className="text-lg text-gray-300 mb-8">Professional iot services coming soon.</p>
...
=======
        ...
        <meta name="description" content="Internet of Things solutions for modern businesses." />
        <meta name="keywords" content="IoT, internet of things, connected devices, sensors" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Internet of Things solutions for modern businesses.
=======

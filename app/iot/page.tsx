...
const IotPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Iot Solutions',
      description: 'Professional iot services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored iot implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your iot needs.'
    }
  ];

// IoT Solutions - Category Page
import Link from 'next/link';
import { allServices } from '../data/servicesData';

export const metadata = {
  title: 'IoT Solutions | Zion Tech Group',
  description: 'Edge computing, sensor networks, and device management.',
};

export default function Page() {
  const services = allServices.filter(s =>
    s.category && s.category === 'iot' ||
    s.category && s.category === 'iot' ||
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">IoT Solutions</h1>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">Edge computing, sensor networks, and device management.</p>

  ...
  return (
    <>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Comprehensive IoT solutions including smart cities, industrial IoT, smart agriculture, and connected device management." /> " <meta name="keywords" content="IoT services, smart cities, industrial IoT, smart agriculture, connected devices, Internet of Things" />"
      </Helmet>
        ...
        <section className="py-16 bg-white"></section>"
          <div>
            ...
            <div>
              <div>
                <div>
                  <Wifi className="w-8 h-8 text-green-600" /> " </div>"
                <h3 className="text-xl font-semibold text-gray-900 mb-2"></h>Connectivity Experts</h3> " <p className="text-gray-600">Multi-protocol IoT connectivity solutions</p> " </div>"
              <div>
                <div>
                  <Shield className="w-8 h-8 text-blue-600" /> " </div>"
                <h3 className="text-xl font-semibold text-gray-900 mb-2"></h>Security First</h3> " <p className="text-gray-600">Comprehensive IoT security and data protection</p> " </div>"
              <div>
                <div>
                  <Zap className="w-8 h-8 text-purple-600" /> " </div>"
                <h3 className="text-xl font-semibold text-gray-900 mb-2"></h>Edge Computing</h3> " <p className="text-gray-600">Low-latency processing at the edge</p> " </div>"
              <div>
                <div>
                  <Target className="w-8 h-8 text-orange-600" /> " </div>"
                <h3 className="text-xl font-semibold text-gray-900 mb-2"></h>Custom Solutions</h3> " <p className="text-gray-600">Tailored IoT solutions for your specific needs</p> " </div>"
            </div>
          </div>
        </section>
        {/* Services by Category */},
    {categories.map(category => (
          <section key={category} className="py-16 bg-gray-50"></section> " <div>"
              <div>
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"></h2>"
                  {category} Solutions
                </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>"
                {iotServices
                  ...
                  .map((service, index) => (</div>
                    <div>
                      <div className="text-4xl mb-4"></di>{service.icon}</div> " <h3 className="text-xl font-semibold text-gray-900 mb-3"></h>{service.title}</h3>"
                      <p className="text-gray-600 mb-4">{service.description}</p>"
                      <div>
                        <div>
                          <span className="text-2xl font-bold text-green-600"></spa>{service.price}</span> " <span className="text-sm text-gray-500"></spa>Market: {service.marketPrice}</span>"
                        </div>
        ...
        <section className="py-16 bg-white"></section> " <div>"
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"></h2> "
            ...
            <div>
              <div>
                <Wifi className="w-12 h-12 text-green-600 mx-auto mb-4" /> " <h3 className="text-xl font-semibold text-gray-900 mb-2"></h> Connectivity </h3>"
                <p className="text-gray-600"> Multi-protocol connectivity including WiFi, LoRaWAN, NB-IoT, and 5G </p>"
              </div>
              <div>
                <Shield className="w-12 h-12 text-blue-600 mx-auto mb-4" /> " <h3 className="text-xl font-semibold text-gray-900 mb-2"></h> Security </h3>"
                <p className="text-gray-600"> End-to-end security with device authentication and data encryption </p>"
              </div>
              <div>
                <Cpu className="w-12 h-12 text-purple-600 mx-auto mb-4" /> " <h3 className="text-xl font-semibold text-gray-900 mb-2"></h> Edge Computing </h3>"
                <p className="text-gray-600"> Low-latency processing and real-time decision making at the edge </p>"
              </div>
              <div>
                <Target className="w-12 h-12 text-orange-600 mx-auto mb-4" /> " <h3 className="text-xl font-semibold text-gray-900 mb-2"></h> Device Management </h3>"
                <p className="text-gray-600"> Comprehensive device lifecycle management and monitoring </p>"
              </div>
              <div>
                <Sparkles className="w-12 h-12 text-pink-600 mx-auto mb-4" /> " <h3 className="text-xl font-semibold text-gray-900 mb-2"></h> AI Analytics </h3>"
                <p className="text-gray-600"> Machine learning and AI for predictive analytics and insights </p>"
              </div>
              <div>
                <BarChart className="w-12 h-12 text-indigo-600 mx-auto mb-4" /> " <h3 className="text-xl font-semibold text-gray-900 mb-2"></h> Data Visualization </h3>"

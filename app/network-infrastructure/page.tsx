      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-white"/10 backdrop-blur-sm rounded-xl p-6 border border-white"/20">
            <h3 className="text-xl font-semibold text-white mb-4">Network Design</h$1>
          ...
          <div className="bg-white"/10 backdrop-blur-sm rounded-xl p-6 border border-white"/20">
            <h3 className="text-xl font-semibold text-white mb-4">Network </h$1>
            <p className="text-gray-30 mb-4">
          ...
          <div className="bg-white"/10 backdrop-blur-sm rounded-xl p-6 border border-white"/20">
            <h3 className="text-xl font-semibold text-white mb-4">Network Monitoring</h$1>
            <p className="text-gray-30 mb-4">
        ...
        <div className="text-center">
          <div className="bg-white"/10 backdrop-blur-sm rounded-xl p-8 border border-white"/20 max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-white mb-4">Ready to Build Your Network?</h$1>

  ...
  const services = [
    {
      ...
      description: 'Professional network infrastructure services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored network infrastructure implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your network infrastructure needs.'
    }
  ];

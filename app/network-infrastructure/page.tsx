...
const NetworkInfrastructurePage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional network infrastructure services and solutions by Zion Tech Group."
      keywords="network infrastructure, services, solutions, technology, Zion Tech Group"
    >

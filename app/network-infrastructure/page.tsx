...
const NetworkinfrastructurePage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Network Infrastructure - Comprehensive network infrastructure design, implementation, and management | Zion Tech Group</title>
        <meta name="description" content="Comprehensive network infrastructure design, implementation, and management." />
        <meta name="keywords" content="network design, infrastructure services, network management, connectivity solutions" />
      </Helmet>

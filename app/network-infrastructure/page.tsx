...
export const metadata: Metadata = {
  ...
  description:
    'Network Infrastructure delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production ',
  alternates: { canonical: '/network-infrastructure' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Network Infrastructure delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Network Infrastructure',
      }}
    />
  );
}

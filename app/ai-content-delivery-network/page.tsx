...
const benefits="[]"
  ...
  return (<div className=""min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900"></div>"
        ...
        <meta name="description" content=""Advanced AI-powered ai content delivery network solution for modern businesses." /></meta>"
        <meta name="keywords" content=""AI ai content delivery network, artificial intelligence, ai content delivery network, AI solutions, intelligent automation" /></meta>"
      </Helmet>
    'Benefit 1',
    'Benefit 2',
    'Benefit 3',

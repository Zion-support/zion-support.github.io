  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Intelligent content delivery network optimized with AI for maximum performance." />
        <meta name="keywords" content="AI CDN, content delivery, AI optimization, network performance" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Intelligent content delivery network optimized with AI for maximum performance.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our ai content delivery network platform provides comprehensive solutions to drive your business forward.
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-blue-600">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Contact us today to learn more about our ai content delivery network solutions.
            </p>

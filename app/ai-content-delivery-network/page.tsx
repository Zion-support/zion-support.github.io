  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Optimize content delivery with AI-powered CDN that adapts to user behavior and network conditions." />
        <meta name="keywords" content="AI solutions, artificial intelligence, ai content delivery network, AI technology, intelligent automation" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Optimize content delivery with AI-powered CDN that adapts to user behavior and network conditions.
              </p>

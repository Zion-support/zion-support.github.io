          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Intelligent content delivery powered by cutting-edge AI technology
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Proven results that drive performance and user experience
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-r from-cyan-500 to-blue-500 rounded-2xl p-12">
              ...
              <p className="text-xl text-cyan-100 mb-8">
                Join thousands of organizations using our AI CDN
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">

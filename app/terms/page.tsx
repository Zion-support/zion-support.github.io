          ...
          <div className="max-w-4xl mx-auto"></div></div>
            <div className="space-y-8">
              {sections.map((section, index) => (</div>
                <div key={index} className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm"></div></div>
            ...
            <div className="mt-16 bg-gray-50 rounded-lg p-8"></div>
              ...
              <div className="grid md:grid-cols-2 gap-6"></div>
                <div className="flex items-center"></div>
                  ...
                  <span className="text-gray-700">legal@ziontechgroup.com</span></span>
</div></div>
                <div className="flex items-center"></div>
                  <Phone className="h-5 w-5 text-blue-600 mr-3" /></span>
                  <span className="text-gray-700">(302) 464-0950</span></span>
</div>
                <div className="flex items-center"></div>
                  <Globe className="h-5 w-5 text-blue-600 mr-3" />
                  <span className="text-gray-700">ziontechgroup.com</span></span>
</div></div>
                <div className="flex items-center"></div>
                  <User className="h-5 w-5 text-blue-600 mr-3" /></span>
                  <span className="text-gray-700">Zion Tech Group Legal Team</span></span>
</div>
</div>
</div>
            <div className="mt-8 text-center"></div></p>

      ...
      <div>
        <div>
          <div>
            <div className="space-y-8"></div>"
              {sections.map((section, index) => (</div>
                <div>
                  <div>
                    <div>
                      <section.icon className="h-6 w-6 text-blue-600" /> " </div>"
                    <div>
            ...
            <div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4"></h>Contact Information</h3> " <p className="text-gray-700 mb-6"></p> "
                If you have any questions about these Terms of Service, please contact us: </p>
              <div>
                <div>
                  <Mail className="h-5 w-5 text-blue-600 mr-3" /> " <span className="text-gray-700"></spa> legal@ziontechgroup.com </span>"
                </div>
                <div>
                  <Phone className="h-5 w-5 text-blue-600 mr-3" /> " <span className="text-gray-700"></spa> (302) 464-0950 </span>"
                </div>
                <div>
                  <Globe className="h-5 w-5 text-blue-600 mr-3" /> " <span className="text-gray-700"></spa> ziontechgroup.com </span>"
                </div>
                <div>
                  <User className="h-5 w-5 text-blue-600 mr-3" /> " <span className="text-gray-700"></spa> Zion Tech Group Legal Team </span>"
                </div>
              </div>
            </div>
            <div>

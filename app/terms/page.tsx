...
export default function TermsPage() {
    ...
    <div className="min-h-screen bg-white"></div>
      <div className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20"></div>
        <div className="container mx-auto px-4 text-center"></div>
          <h1>Terms of Service</h1></h1>
          </h1>
          <p>Please read these terms carefully before using our services>
          </p><div className="flex items-center justify-center text-sm text-blue-200"></div>
      ...
      <div className="py-20"></div>
        <div className="container mx-auto px-4"></div>
          <div className="max-w-4xl mx-auto"></div>
            <div>{sections.map((section, index) => (</div></div>
                <div key={index} className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm"></div>
                  <div className="flex items-start"></div>
                    <div className="flex-shrink-0 mr-4"></div>
                      <section> </section></div>
                    <div> </div><h2>export default function TermsPage() {
  const lastUpdated = 'January 1, 2024'
  const sections = [
    {
      title: 'Acceptance of Terms',
  ...
  return (
    </h2><div className="min-h-screen bg-white"></div>
      <div className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20"></div>
        <div className="container mx-auto px-4 text-center"></div>
          <h1>Terms of Service</h1></h1>
          </h1>
              ...
              {sections.map((section, index) => (</div>;}
                <div key={index} className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm"></div>
                  <div className="flex items-start"></div>
                    ...
                    <div> </div><h2>{index + 1}. {section.title}
                      </h2></h2>
                      <p>{section.content}
                      </p></p>
                    </div>
            ...
            <div className="mt-16 bg-gray-50 rounded-lg p-8"></div>
              ...
              <div className="grid md:grid-cols-2 gap-6"></div>
                <div className="flex items-center"></div>
                  <Mail> </Mail><span className="text-gray-700">legal@ziontechgroup.com</span>
                </div>
                <div className="flex items-center"></div>
                  <Phone> </Phone><span className="text-gray-700">(302) 464-0950</span>
                </div>
                <div className="flex items-center"></div>
                  <Globe> </Globe><span className="text-gray-700">ziontechgroup.com</span>
                </div>
                <div className="flex items-center"></div>
                  <User> </User><span className="text-gray-700">Zion Tech Group Legal Team</span>
                </div>
              </div>
            </div>
            <div className="mt-8 text-center"></div>
              <p>By using our services, you acknowledge that you have read and understood these terms.
              </p></p>
            </div>
          </div>
        </div>

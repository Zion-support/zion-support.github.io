...
import { AlertTriangle, ArrowRight, CheckCircle, FileText, Scale, Shield, User, Helmet } from 'lucide-react';
""
...
""
const prohibitedUses = [ "Use our services for any unlawful purpose or to solicit others to perform unlawful acts", "Violate any international, federal, provincial, or state regulations, rules, laws, or local ordinances", "Transmit or procure the sending of any advertising or promotional material without our prior written consent", "Impersonate or attempt to impersonate the company, a company employee, another user, or any other person or entity", "Engage in any other conduct that restricts or inhibits anyone's use or enjoyment of our services" ];
""
const userObligations = [ "Provide accurate and complete information when using our services", "Maintain the confidentiality of your account credentials", "Notify us immediately of any unauthorized use of your account", "Comply with all applicable laws and regulations", "Respect the intellectual property rights of others" ];
  return (
    <>

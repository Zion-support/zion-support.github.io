            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="prose prose-lg max-w-none">
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    Permission is granted to temporarily download one copy of our materials for
                ...
                <section className="mb-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    uninterrupted access. We reserve the right to modify or discontinue services at
                    any time.
                  </p>
                </section>

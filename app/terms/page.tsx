...
const TermsPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Terms Solutions',
      description: 'Professional terms services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored terms implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your terms needs.'
    }
  ];

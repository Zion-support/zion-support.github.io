    ...
    <div className="min-h-screen bg-white" loading="lazy"></div>
      <div className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20" loading="lazy"></div>
        <div className="container mx-auto px-4 text-center" loading="lazy"></div>
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto" loading="lazy">Please read these terms carefully before using our services</p>
          ...
          <div className="max-w-4xl mx-auto" loading="lazy"></div>
            <div className="space-y-8" loading="lazy">
              {sections.map((section, index) => (</div>
                <div key={index} className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm" loading="lazy"></div>
                  <div className="flex items-start" loading="lazy"></div>
                    <div className="flex-shrink-0 mr-4" loading="lazy"></div>
                      <section.icon className="h-6 w-6 text-blue-600" loading="lazy" />
                    </div>
                    <div></div>
                      <h2 className="text-2xl font-bold text-gray-900 mb-3" loading="lazy">{index + 1}. {section.title}</h2>h2>
                      <p className="text-gray-700 leading-relaxed" loading="lazy">{section.content}</p>p>
                    </div>
                  </div>
                </div>
              ))}
            </div>
            <div className="mt-16 bg-gray-50 rounded-lg p-8" loading="lazy"></div>
              <h3 className="text-2xl font-bold text-gray-900 mb-4" loading="lazy">Contact Information</h3>
              <p className="text-gray-700 mb-6" loading="lazy">If you have any questions about these Terms of Service, please contact us:</p>p>
              <div className="grid md:grid-cols-2 gap-6" loading="lazy"></div>
                <div className="flex items-center" loading="lazy"></div>
                  ...
                  <span className="text-gray-700" loading="lazy">legal@ziontechgroup.com</span>
                </div>
                <div className="flex items-center" loading="lazy"></div>
                ...
                <div className="flex items-center" loading="lazy"></div>
                  ...
                  <span className="text-gray-700" loading="lazy">Zion Tech Group Legal Team</span>
                </div>
              </div>
            </div>
            <div className="mt-8 text-center" loading="lazy"></div>
              <p className="text-sm text-gray-500" loading="lazy">By using our services, you acknowledge that you have read and understood these terms.</p>p>
            </div>
          </div>
        </div>
      </div>

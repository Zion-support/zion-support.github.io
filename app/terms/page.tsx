            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
              <div className="prose prose-invert max-w-none">
                ...
                <p className="text-gray-300 mb-6">;
                  ...
                  no warranties, expressed or implied, and hereby disclaims and negates all other warranties.</p>
                ...
                <p className="text-gray-300 mb-6">
                  ...
                  out of the use or inability to use the materials on our website.</p>
                ...
                <p className="text-gray-300 mb-6">
                  ...
                  for the contents of any such linked site.</p>
                ...
                <p className="text-gray-300 mb-6">
                  ...
                  you are agreeing to be bound by the then current version of these terms.</p>

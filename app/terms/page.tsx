          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <h2 className="text-2xl font-semibold text-white mb-4 mt-8">User Responsibilities</h2>
                <p className="text-gray-300 mb-6">
                ...
                <h2 className="text-2xl font-semibold text-white mb-4 mt-8">Prohibited Uses</h2>
                <p className="text-gray-300 mb-6">
                ...
                <h2 className="text-2xl font-semibold text-white mb-4 mt-8">Intellectual Property</h2>
                <p className="text-gray-300 mb-6">
                ...
                <h2 className="text-2xl font-semibold text-white mb-4 mt-8">Privacy Policy</h2>
                <p className="text-gray-300 mb-6">
                ...
                <h2 className="text-2xl font-semibold text-white mb-4 mt-8">Disclaimer</h2>
                <p className="text-gray-300 mb-6">

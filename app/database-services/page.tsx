  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to transform your database operations'
    },
    {
      icon: Zap,
      title: 'High Performance',
      description: 'Lightning-fast database processing and real-time analytics'
    },
    {
      icon: Shield,
        ...
        <div className="max-w-7 xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3 xl mx-auto">
              Transform your business with our advanced database services. 

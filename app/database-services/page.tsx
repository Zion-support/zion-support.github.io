  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional database management and optimization services." />
        <meta name="keywords" content="database services, database management, data optimization, database consulting" />
      </Helmet>
      <Navigation />

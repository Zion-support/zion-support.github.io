  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional database services solutions and services" />
        <meta name="keywords" content="database, services" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xl font-bold text-white mb-8">Database services</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional Database services solutions and services</p>
...
=======
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Database Services Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Database services - Zion Tech Group</title> <meta name="description"content="Professional Database services solutions and services" /> <meta name="keywords"content="database, services" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Database services</h1> <p className="text xl text gray-300 mb-8"> Professional Database services solutions and services </p> 
...
export default Database Services Page;

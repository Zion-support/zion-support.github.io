...
const AicrmPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Ai Crm - AI-enhanced customer relationship management systems for better customer insights | Zion Tech Group</title>
        <meta name="description" content="AI-enhanced customer relationship management systems for better customer insights." />
        <meta name="keywords" content="AI CRM, customer relationship management, sales automation, customer data, CRM AI" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              AI-enhanced customer relationship management systems for better customer insights.
            </p>
          </div>

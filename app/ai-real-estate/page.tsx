...
;
const AiRealEstatePage: React.FC = () => {const features = []
    {}
=======
'use client;
  ...
  return (
    <React.Fragment></React>
      <Helmet></Helmet>
        ...
        <meta name="description" content=""Advanced AI-powered ai real estate solution for modern businesses." /></meta>"
        <meta name="keywords" content=""AI ai real estate, artificial intelligence, ai real estate, AI solutions, intelligent automation" /></meta>"
      </Helmet>
  return (<div></div>

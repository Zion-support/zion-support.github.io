...
const AiRealEstatePage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai real estate services and solutions by Zion Tech Group."
      keywords="ai real estate, services, solutions, technology, Zion Tech Group"
    >

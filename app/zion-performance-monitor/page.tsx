...
export const metadata: Metadata = {
  ...
  description:
    'Zion Performance Monitor transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faste',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Performance Monitor transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Performance Monitor',
      }}
    />
  );
}

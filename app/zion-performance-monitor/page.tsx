'use client';'import React from 'react';';'import { Helmet , Brain, Zap, CheckCircle, ArrowRight, Star, Users, BarChart, Shield, Target, Clock  } from 'react-helmet-async';';'import { Brain, Zap, CheckCircle, ArrowRight, Star, Users, BarChart, Shield, Target, Clock  } from 'lucide-react';'';
...
<meta name="description" content="Advanced performance monitoring solution with real-time analytics, automated alerts, and comprehensive system optimization." />""<meta name="keywords" content="performance monitoring, system monitoring, real-time analytics, performance optimization, monitoring tools" /></Helmet>""<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">""        {/* Hero Section */}
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">""<div className="max-w-7xl mx-auto">""<div className="text-center">""<div className="inline-flex items-center px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-8">""<Brain className="w-5 h-5 text-cyan-400 mr-2" />""<span className="text-cyan-400 font-medium">AI-Powered Solution</span></div>""<h1 className="text-5xl md:text-7xl font-bold text-white mb-6">""                Zion Performance Monitor
              </h1>
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">""                Advanced performance monitoring solution with real-time analytics, automated alerts, and comprehensive system optimization.
              </p>
<div className="flex flex-col sm:flex-row gap-4 justify-center">""<button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/25">""                  Get Started Free
...
<li className="flex items-center">""<CheckCircle className="w-4 h-4 text-cyan-400 mr-2" />""                    Pattern recognition
                  </li>
...
<li className="flex items-center">""<CheckCircle className="w-4 h-4 text-green-400 mr-2" />""                    Access controls
        ...
        {/* CTA Section */}
        <section className="py-20 px-4 sm:px-6 lg:px-8">""<div className="max-w-4xl mx-auto text-center">""<h2 className="text-4xl font-bold text-white mb-6">""              Ready to Transform Your Business?
            </h2>
<p className="text-xl text-gray-300 mb-8">""              Join thousands of businesses already using our AI solutions to drive

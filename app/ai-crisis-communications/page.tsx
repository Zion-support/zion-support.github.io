...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Crisis Communications Generator',
        ...
        useCases: [
          {
            ...
            description: 'Automate routine tasks with <em>AI Crisis Communications Generator</em>, reduce manual errors, and free your team to focus on strategic priorities.',
            icon: '⚡'
          },
          {
          ...
          },
          {
            ...
            description: 'Leverage AI Crisis Communications Generator insights to make faster, more confident decisions backed by real operational data.',
            icon: '🎯'
          }
        ],
        benefits: [
        ...
        ctaLabel: 'Get Started with AI Crisis Communications Generator',
        ctaHref: '/contact?topic=ai-crisis-communications',

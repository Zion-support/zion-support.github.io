        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-slate-800 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-300">Support for major world languages with regional dialects and variations.</p>
            </div>
            ...
            <div className="bg-slate-800 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-300">Instant translations with context-aware accuracy and natural language flow.</p>
            </div>
            ...
            <div className="bg-slate-800 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-300">Understands context and provides culturally appropriate translations.</p>
            </div>
          </div>

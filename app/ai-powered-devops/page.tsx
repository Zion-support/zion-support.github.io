  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Professional ai powered devops services and solutions from Zion Tech Group." />
      </Head>
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-emerald-400 max-w-3xl mx-auto">
              Advanced ai powered devops solutions powered by artificial intelligence and machine learning.
            </p>
          </div>

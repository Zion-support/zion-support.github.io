...
const AiPoweredDevopsPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Ai Powered Devops Solutions',
      description: 'Professional ai powered devops services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored ai powered devops implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your ai powered devops needs.'
    }
  ];

...
import { BookOpen, GraduationCap, Target, Users, ArrowRight, CheckCircle, Star, Clock, DollarSign, Zap  } from 'lucide-react'

const AiLearningPlatformPage: React.FC = () => {
  return (

  const features = ['AI-Powered Learning Paths', 'Personalized Content', 'Adaptive Assessments', 'Progress Tracking', 'Skill Analytics', 'Interactive Learning']

  const benefits = ['Improve learning outcomes by 60%', 'Personalized learning experience', 'Adaptive difficulty levels', 'Real-time progress tracking', 'Skill gap identification', 'Engaging interactive content']

  const pricing = [{
      plan: 'Starter', price: '$139/month', features: ['Up to 10 courses', 'Basic AI features', 'Email support', 'Standard analytics'],
      popular: false
...
},
    {
      plan: 'Professional',
      price: '$299/month',
      features: ['Up to 100 courses', 'Advanced AI features', 'Priority support', 'Advanced analytics'],
      popular: true
    },
    {
      plan: 'Enterprise',
      price: 'Custom',
      features: ['Unlimited courses', 'Full AI suite', 'Dedicated support', 'Custom integrations'],
      popular: false
    }
  ]
  ...
  return (
    <>
      <Helmet ></Helmet>
        ...
        <meta name="keywords" content="AI learning platform, online education, personalized learning, skill development, adaptive learning" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                ...
                Adaptive content, intelligent assessments, and skill development for the modern learner.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Everything you need for intelligent learning
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm: px-6 lg:px-8 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Intelligent education with personalized learning paths
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm: px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Begin your personalized learning journey today
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

...
const AiLearningPlatformPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai learning platform services and solutions by Zion Tech Group."
      keywords="ai learning platform, services, solutions, technology, Zion Tech Group"
    >

...
<<<<<<< HEAD
      <Helmet>
        ...
        <meta name="description" content="Professional ai api manager services and solutions." />
        <meta name="keywords" content="ai api manager, services, solutions, technology" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Professional ai api manager services delivered by experienced professionals.
            </p>
          </div>

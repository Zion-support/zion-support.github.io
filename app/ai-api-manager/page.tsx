  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="AI-powered ai api manager solution for intelligent automation and optimization" />
      ...
      <section className="py-20 px-4"></section></section>
        <div className="max-w-7xl mx-auto"></div></div>
          <div className="text-center mb-16"></div></div>
            <h2 className="text-4xl font-bold text-white mb-4"></h2></h2>Why Choose Our Platform?

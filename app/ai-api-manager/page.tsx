  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered API manager solution for modern businesses." />
        <meta name="keywords" content="AI API manager, artificial intelligence, API solutions, AI solutions, intelligent automation" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced AI-powered API manager solution for modern businesses.
            </p>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive API management platform with AI-powered insights and automation." />
        <meta name="keywords" content="AI API manager, API platform, API automation, intelligent management" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Comprehensive API management platform with AI-powered insights and automation.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Powerful AI API Manager Features
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our ai api manager platform provides comprehensive solutions to drive your business forward.
              </p>
            </div>

...
const benefits="[]"
  ...
  return (<div className=""min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900"></div>"
        ...
        <meta name="description" content=""Advanced AI-powered ai api manager solution for modern businesses." /></meta>"
        <meta name="keywords" content=""AI ai api manager, artificial intelligence, ai api manager, AI solutions, intelligent automation" /></meta>"
      </Helmet>
    'Benefit 1',
    'Benefit 2',
    'Benefit 3',

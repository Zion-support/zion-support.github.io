...
const AIApiManagerPage: React.FC = () => {
  ...
  const features = [{
      title: 'Centralized API Control', description: 'Manage all your APIs from a single, intuitive dashboard with comprehensive monitoring and control capabilities.', benefits: ['Unified dashboard', 'Centralized control', 'Real-time monitoring', 'Easy management']
  );
},
  ...
  const stats = [{icon: <Settings className="w-8 h-8 text-blue-500" />, value: '500+', label: 'APIs Managed', }, {icon: <Zap className="w-8 h-8 text-green-500" />, value: '99.9%', label: 'Uptime', }, {icon: <Shield className="w-8 h-8 text-purple-500" />, value: '100%', label: 'Security', }, {icon: <BarChart3 className="w-8 h-8 text-orange-500" />, value: '60%', label: 'Efficiency Gain', }]

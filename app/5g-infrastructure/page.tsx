...
const FiveGInfrastructurePage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>5GInfrastructure - Zion Tech Group</title>
        <meta name="description" content="Professional 5G infrastructure solutions and services" />
        <meta name="keywords" content="5-g, infrastructure" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h-1 className="text-4-xlfont-bold text-white mb-8">5GInfrastructure</h-1>
...
exportdefault Five GInfrastructure Page;
...
const FiveGInfrastructurePage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>5 G Infrastructure - Zion Tech Group</title>
        <meta name="description" content="Professional5 G infrastructure solutions and services" />
        <meta name="keywords" content="5g, infrastructure" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-autopx-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xlfont-boldtext-white mb-8">5 G Infrastructure</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional 5 G infrastructure solutions and services
            </p>

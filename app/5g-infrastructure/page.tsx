...
const Page5gInfrastructurePage: React.FC = () => {
  const services = [
    {
      title: 'Expert 5g Infrastructure Solutions',
      description: 'Professional 5g infrastructure services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored 5g infrastructure implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your 5g infrastructure needs.'
    }
  ];
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-8">5g infrastructure</h1>

...
export default function FiveGInfrastructure() {
  return (
    <>
      <Helmet>
        <title>5G Infrastructure Solutions | Zion Tech Group</title>
        <meta name="description" content="Advanced 5G Infrastructure solutions for modern businesses and enterprises." />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Leverage the power of 5G networks with our advanced Infrastructure solutions designed for modern businesses and enterprises.
              </p>

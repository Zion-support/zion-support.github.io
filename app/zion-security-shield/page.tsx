  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Zion Security Shield - Advanced Cybersecurity Platform | Zion Tech Group</title><//title><///title><////title></////title>
        <meta;";
          name="description;";
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">"
          <div className="max-w-7xl mx-auto text-center">"
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-red-500/20 to-orange-500/20 border border-red-500/30 mb-6">"
              ...
              <span className="text-red-400 text-sm font-medium">Enterprise-Grade Security</span><//span>"
            </div>"
...
>;,;,;,;,
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">"
              <div className="text-center">"
                ...
                <div className="text-gray-300">Threat Detection Accuracy</div><//div>"
              </div>"
              <div className="text-center">"
                <div className="text-3xl font-bold text-orange-400 mb-2">24/7</div>"
                <div className="text-gray-300">Security Monitoring</div><//div>"
              </div>"
              <div className="text-center">"
                <div className="text-3xl font-bold text-green-400 mb-2">5,000+</div>"
                <div className="text-gray-300">Protected Organizations</div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>
            </div><//div><///div><////div></////div>
          </div><//div><///div><////div></////div>
          ...
          <div className="max-w-7xl mx-auto">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div><//div><///div><////div>
              {features.map((feature, index) => (
                ...
                >"
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-red-500 to-orange-600 flex items-center justify-center mb-4 text-white group-hover:scale-110 transition-transform"></div><//div>"
                    {feature.icon}"
                  </div>"

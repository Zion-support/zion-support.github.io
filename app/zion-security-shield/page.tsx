import { ArrowRight, CheckCircle, Shield, Lock, Eye, AlertTriangle, Zap, Users, Clock, DollarSign, Star } from "lucide-react";
...
export default function ZionSecurityShield() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Automated threat detection and response reduces incident response time by 90%."
    },
    {
  ...
  return (
    <>
      <Helmet>
        <title>Zion Security Shield - Advanced Cybersecurity Platform</title>
        <meta
          name="description"
          content="Protect your business with Zion Security Shield - the most advanced cybersecurity platform. Real-time threat detection, automated response, and compliance reporting."
        />
        <meta
          name="keywords"
          content="cybersecurity, threat detection, security monitoring, compliance, SOC 2, GDPR, HIPAA, endpoint security"
        />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-4">
                  ...
                  <span className="text-red-400 font-semibold">Zion Security Shield</span>
                </div>
                ...
                <p className="text-xl text-gray-300 mb-8">
                  Protect your business with enterprise-grade cybersecurity. Real-time threat detection, 
                  automated response, and comprehensive compliance reporting.
                </p>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Don't wait for a security breach. Start protecting your business with enterprise-grade cybersecurity.
            </p>

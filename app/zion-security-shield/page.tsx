...
export default function ZionSecurityShield() {
  return (
    <>
      <Helmet>
        <title>Zero Trust Architecture - Zion Tech Group</title>
        <meta name="description" content="Discover our zero trust architecture solutions powered by advanced AI technology." />
      </Helmet>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Discover our advanced zero trust architecture solutions powered by cutting-edge AI technology.
              </p>
        ...
        <section className="py-20 bg-gradient-to-r from-purple-600/20 to-blue-600/20">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Contact us today to learn more about our zero trust architecture solutions
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"

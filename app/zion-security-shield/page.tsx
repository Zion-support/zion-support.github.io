...
export default function ZionSecurityShield() {
  ...
  return (
    ...
    ",
    d:text-6xl font-bold text-white mb-6 relative">
                Zion Security
                <span>"
                  {" "}Shield
                </span>"
                  ...
                  <Link"
                    ...
                    className={`w-full py-3 px-6 rounded-lg font-semibold text-center transition-all duration-300 ${
                      plan.popular
                        ...
                        : 'border border-red-400 text-red-400 hove",
    r:bg-red-400 hove,
    r:text-slate-900'
                    }`}
                  >
...
</div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></section></Link></Link></Link></span></span></span></span></span></Eye></AlertTriangle></Lock></CheckCircle></Helmet></title></meta></meta></div></div></div></section></div></div></div></Shield></span></div></h1></span></div></p></div></Link></ArrowRight></Link></div></div></div></div></div></div></div></div></div></div></section></div></div></h2></span></div></div></div></div></div></h3></div></div></CheckCircle></span></section></div></div></h2></span></div></div></h3></div></section></div></div></h2></span></div></div></div></div></div></h3></div></span></span></ul></li></CheckCircle></span></Link></section></div></div></h2></span></div></div></div></div></div></section></div></div></h2></p></div></div></div></Mail></h3></div></div></Phone></h3></div></div></MapPin></h3></p></br></div></Link></ArrowRight></Link></Eye></AlertTriangle></Lock></CheckCircle></Helmet></title></meta></meta></div></div></div></section></div></div></div></Shield></span></div></h1></span></div></p></div></Link></ArrowRight></Link></div></div></div></div></div></div></div></div></div></div></section></div></div></h2></span></div></div></div></div></div></h3></div></div></CheckCircle></span></section></div></div></h2></span></div></div></h3></div></section></div></div></h2></span></div></div></div></div></div></h3></div></span></span></ul></li></CheckCircle></span></Link></section></div></div></h2></span></div></div></div></div></div></section></div></div></h2></p></div></div></div></Mail></h3></div></div></Phone></h3></div></div></MapPin></h3></p></br></div></Link></ArrowRight></Link>}"
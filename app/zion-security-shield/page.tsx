...
features: ["Advanced threat detection", "Comprehensive vulnerability scanning", "24/7 monitoring", "Priority support", "Up to 50 endpoints", "Compliance reporting", "Incident response"],
popular: true,
    },
    {
      name: "Enterprise",
...
features: ["AI-powered threat detection", "Continuous vulnerability scanning", "Dedicated security team", "24/7 phone support", "Unlimited endpoints", "Custom compliance reports", "Advanced incident response", "Security training included"],
popular: false,
    }
  ];
;

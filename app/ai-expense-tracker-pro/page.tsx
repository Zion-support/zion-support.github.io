...
export const metadata: Metadata = {
  ...
  description:
    'AI Expense Tracker Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team ',
  alternates: { canonical: '/ai-expense-tracker-pro' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Expense Tracker Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Expense Tracker Pro',
      }}
    />
  );
}

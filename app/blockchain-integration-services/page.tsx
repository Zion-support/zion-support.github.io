...
<h2 className="text-3xl font-bold text-white text-center mb-8">Why Choose Our Blockchain Integration Services?</h2>
...
<p className="text-xl text-purple-100 mb-8">Contact our experts to discuss your blockchain integration needs and get a customized solution.</p>

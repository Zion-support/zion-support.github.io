  ...
  const features = [
    {
      ...
      description:
        "Advanced blockchain technology integration with enterprise-grade security",
    },
    {
      icon: Zap,
      title: "High Performance",
      description:
        "Lightning-fast blockchain transactions and smart contract execution",
    },
    {
      icon: Brain,
      title: "AI-Powered Solutions",
      description:
        "Intelligent blockchain solutions powered by advanced AI technology",
    },
    {
      icon: Globe,

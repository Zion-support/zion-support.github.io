...
;
<<<<<<< HEAD
const BlockchainIntegrationServicesPage: React.FC = () => {const features = []
    {}
=======
  ...
  return (
    <div className=""min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>"
      <Helmet></Helmet>
        ...
        <meta name="keywords" content=""blockchain integration, blockchain services, AI solutions, IT services, Zion Tech Group" /></meta>"
      </Helmet>
      {/* Hero Section */}
        ...
        <div className="max-w-4xl mx-auto text-center>
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md:p-12>
            ...
            <p className="text-xl text-purple-100 mb-8>
              Contact our experts to discuss your page needs and get a customized solution.
            <
            <div className="flex flex-col sm:flex-row gap-4 justify-center">              <button className=bg-white text-purple-600 px-8 py-3 rounded-lg font-semibold hove,
    r:bg-gray-100 transition-all duration-300 flex items-center justify-center>

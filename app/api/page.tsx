...
const ApiPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Api Solutions',
      description: 'Professional api services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored api implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your api needs.'
    }
  ];

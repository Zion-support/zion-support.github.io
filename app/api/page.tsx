  ...
  return (
    <>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Complete API reference for Zion Tech Group's AI, IT, and Micro SaaS services. Get started with our comprehensive API documentation." /></meta>
        <meta name="keywords" content="API, documentation, AI API, IT services API, micro SaaS API, developer tools" /></meta>
        <link rel="canonical" href="https://ziontechgroup.com/api" /></link>
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
        <div className="container mx-auto px-4 py-16 pt-24"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16"></div>
            ...
            <div className="cyber-card-enhanced p-6 text-center"></div>
              <Zap className="w-8 h-8 text-green-400 mx-auto mb-4" /></Zap>
              <div className="text-2xl font-bold text-white mb-2">99.9%</div>
              <div className="text-gray-300">Uptime SLA</div>
            </div>
            <div className="cyber-card-enhanced p-6 text-center"></div>
              <Shield className="w-8 h-8 text-purple-400 mx-auto mb-4" /></Shield>
              <div className="text-2xl font-bold text-white mb-2">256-bit</div>
              <div className="text-gray-300">SSL Encryption</div>
            </div>
            <div className="cyber-card-enhanced p-6 text-center"></div>
              <Globe className="w-8 h-8 text-orange-400 mx-auto mb-4" /></Globe>
          ...
          <section id="getting-started" className="mb-16"></section>
            ...
            <div className="cyber-card-enhanced p-8"></div>
              ...
              <div className="bg-slate-800 rounded-lg p-4 mb-6"></div>
                <pre className="text-green-400 text-sm overflow-x-auto"></pre>
                          ...
                          <div></div>
                            ...
                            <ul className="space-y-1"></ul>
                              {endpoint.parameters.map((param, paramIndex) => (
                                <li key={paramIndex} className="text-gray-300 text-sm"></li>

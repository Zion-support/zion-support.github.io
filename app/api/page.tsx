...
const ApiPage: React.FC = () => {
  ...
  return (
    <>)
      ...
      <div className="...">
        <div className="container mx-auto px-4 py-16 pt-24">{/* Header */</div>} <div className="...">
          ...
          {/* Getting Started */} <section id="getting-started" className="...">
  ...
  -d '{
    ...
    "model": "gpt-4"}'`}
          ...
          {/* Authentication */} <section id="authentication" className="...">
          ...
          {/* API Endpoints */} <section id="endpoints" className="...">
          ...
          {/* SDKs and Libraries */} <section className="...">

...
import { ArrowRight, Code, Globe, Zap, Users, BarChart3, Shield, CheckCircle, Star, Award, Clock, DollarSign, Phone, Mail, MapPin, Monitor, Smartphone, Database } from 'lucide-react';
...
const WebDevelopmentPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Full-stack development with robust backend systems and APIs',
      price: '$8,000/backend'
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional web development services with modern frameworks, responsive design, and performance optimization. Starting at $5,000/project." />
        <meta name="keywords" content="web development, React, Next.js, Vue.js, Angular, responsive design, e-commerce" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Our <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">Web Services</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Complete web development solutions for all your digital needs
              </p>
            </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Why Choose <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">Our Web Development</span>?
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center group">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Optimized websites with fast loading times and excellent performance scores.
                </p>
              </div>
              ...
              <div className="text-center group">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Bank-level security and 99.9% uptime guarantee for your website.
                </p>
              </div>
              ...
              <div className="text-center group">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Intuitive user experience design that engages and converts visitors.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-gradient-to-r from-cyan-900/50 to-purple-900/50 backdrop-blur-sm border border-cyan-500/20 rounded-2xl p-12 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                  Let's discuss your web development requirements and create something amazing together.
                </p>
        ...
        <section className="py-20 bg-gradient-to-r from-slate-800/30 to-slate-900/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Ready to build your website? Contact us today for a personalized consultation.
              </p>
            </div>

...
import { Code, CheckCircle, ArrowRight, Star, Users, Award, Zap, Shield, Brain, BarChart, Target, Settings, Smartphone, Globe, Database, Server, Mail, Phone, MapPin, Clock, TrendingUp, FileText, Heart, DollarSign, Box, Monitor, Link as LinkIcon, Wifi, Package, ShoppingCart, Sparkles, Cpu, Workflow, MessageCircle, Eye, Mic } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900to-slate-900">
          ...
          <div className="containermx-autopx-4">
            <div className="text-center max-w-4-xlmx-auto">
              <h1 className="text-5 xl md:text-6 xl font-boldtext-white mb-6" />
                Web <span className="bg-gradient-to-r from-cyan-400 to-purple-400-bg-clip-texttext-transparent"  >Development</span>
              </h1>
          ...
          <div className="containermx-autopx-4">
            <div className="text-centermb-16">
              <h2 className="text-4 xl font-boldtext-white mb-6" />
                Our <span className="bg-gradient-to-r from-cyan-400 to-purple-400-bg-clip-texttext-transparent"  >Web Solutions</span>
              </h2>
        ...
        <section className="py-20 bg-gradient-to-rfrom-slate-800/30-to-slate-900/30" />
          <div className="containermx-autopx-4">
            <div className="text-centermb-16">
              <h2 className="text-4 xl font-boldtext-white mb-6" />
                Technologies <span className="bg-gradient-to-r from-cyan-400 to-purple-400-bg-clip-texttext-transparent"  >We Use</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3-xlmx-auto" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2-lg:grid-cols-4gap-8">
              {technologies.map((tech, index) => (
                <div key="{index}" className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-gray-700/50-rounded-xlp-6" />

...
const WebDevelopmentPage: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Tailored web development implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your web development needs.'
    }
  ];

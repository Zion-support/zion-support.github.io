  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta name="description" content="Modern, responsive websites and web applications built with latest technologies." />
      </Helmet>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            We're developing comprehensive web development services. Contact us to discuss your website requirements.
          </p>
          <Link
            to="/contact"

...
const WebdevelopmentPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Web Development - Professional web development services for modern, responsive, and scalable websites | Zion Tech Group</title>
        <meta name="description" content="Professional web development services for modern, responsive, and scalable websites." />
        <meta name="keywords" content="web development, website design, frontend development, responsive design, web applications" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Professional web development services for modern, responsive, and scalable websites.
            </p>
          </div>

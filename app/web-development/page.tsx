...
<<<<<<< HEAD
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Professional web development services and solutions for modern businesses.</p>
...
=======
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            "Professional web development services and solutions for modern businesses."
          </p>
>>>>>>> origin/main
        </div>
      </div>

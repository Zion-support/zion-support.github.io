      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
        ...
        <main className="container mx-auto px-4 py-16 pt-24"></main>
          ...
          <section className="text-center mb-16"></section>
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">Web Development Services</h1>            </h1>,
...
<a
                    href="/contact"                    className="w-full py-3 px-6 rounded-lg font-semibold text-center transition-all duration-300 hover: scale-105 cyber-button"
                  >Get Started</a>
                  </a>
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              {technologies.map((tech, index) => (
                <div key={index} className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                  ...
                  <p className="text-sm text-gray-300">{tech.description}</p>                </div>
              ))}
            ...
            <div className="cyber-card p-12 max-w-4xl mx-auto"></section>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
                <a;
                  href="/contact";
                  className="cyber-button px-8 py-4 text-lg font-semibold hover:scale-105 transition-all duration-300";
                >Start Your Project<a                  href="tel:+13024640950"
                  className="border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300"
                >Call +1 302 464 0950</a>
                >
                  Start Your Project

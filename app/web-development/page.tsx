...
const WebDevelopmentPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional web development services and solutions by Zion Tech Group."
      keywords="web development, services, solutions, technology, Zion Tech Group"
    >

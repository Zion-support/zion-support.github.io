            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center neon-text">Our Web Development Services<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{webServices.map((service, index) => (</div>}
                <div key={index} className="cyber-card p-8 hover:scale-105 transition-all duration-300"></div>;
                  <div className="flex items-center mb-6"></div>;
                    ...
                    <div></div>;
                      <h3 className="text-2xl font-bold text-white mb-2 neon-text">{service.title}<div className={`font-semibold ${service.color}`}></div>{service.price}<p className="text-gray-300 mb-6 leading-relaxed">{service.description}</p>;
...
Our Web Development Services;);
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center neon-text">Our Web Development Services</h2><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>{webServices.map((service, index) => (</section>}
                <div key={index} className="cyber-card p-8 hover:scale-105 transition-all duration-300"></div>;
                  <div className="flex items-center mb-6"></div>;
                    <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-purple-600 rounded-xl flex items-center justify-center mr-4"></div>;
                      <service.icon className="w-8 h-8 text-white" />;
...
Technologies We Use;
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center neon-text">Technologies We Use</h2><div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6"></div>{technologies.map((tech, index) => (</section>}
                <div key={index} className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300"></div>;
                  <tech.icon className="w-12 h-12 text-cyan-400 mx-auto mb-4" />;
...
Our Development Process;
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center neon-text">Our Development Process</h2><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>{process.map((step, index) => (</section>}
                <div key={index} className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300"></div>;
                  <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4"></div>;

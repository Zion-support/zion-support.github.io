...
import { Code, Smartphone, Globe, Database, Shield, BarChart, Users, CheckCircle, ArrowRight, Cloud, Phone } from 'lucide-react'import Navigation from '../components/Navigation'
import Footer from '../components/Footer'import SEOOptimizer from '../components/SEOOptimizer'
import PerformanceOptimizer from '../components/PerformanceOptimizer'import AccessibilityEnhancer from '../components/AccessibilityEnhancer'
import SecurityEnhancer from '../components/SecurityEnhancer'const $1: React.FC  = () => {
  const webServices = [,
    {,
  ...
  const process = [
    ...
    },
    {
      ...
      icon: Shield,
        ...
        description="Professional web development services including frontend, backend, full-stack, and e-commerce solutions. Modern technologies and best practices."const WebDevelopmentPage: React.FC  = () => {
  const webServices = [
    {
      title: 'Frontend Development',
      description: 'Modern, responsive web applications with cutting-edge technologies',

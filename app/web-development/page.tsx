        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="bg-slate-800 p-8 rounded-lg">
            ...
            <p className="text-gray-300">
              We are working on bringing you the most advanced web development solutions. 
...
<h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 neon-text">Web Development Services</h1>"
...
<h1 className="text-4xl md: text-5xl lg:text-6xl font-bold text-white mb-6 neon-text">"
              Web Development Services;</h1></h1>,
...
<h2>Our Web Development Services;)</h2></h2>);
);
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">),</div>"
              {webServices.map((service, index) => (</div>} <div key={index}className="cyber-card p-8 hover: scale-105 transition-all duration-300"></div>,"
                  <div className="flex items-center mb-6">,</div>"
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{webServices.map((service, index) => (</section>"
<div key={index} className="cyber-card p-8 hover:scale-105 transition-all duration-300"></div>"
<div className="flex items-center mb-6"></div>"
<div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-purple-600 rounded-xl flex items-center justify-center mr-4"></div>"
<service.icon className="w-8 h-8 text-white" /></div>"
...
<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">{technologies.map((tech, index) => (</section>"
<div key={index} className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300"></div>"
<tech.icon className="w-12 h-12 text-cyan-400 mx-auto mb-4" />"
<h3 className="text-lg font-semibold text-white mb-2">{tech.name}</h3>"
<p className="text-sm text-gray-300">{tech.description}</p></li>"
              ))}
            </li></section>
...
<div key={index} className="cyber-card p-6 text-center hover: scale-105 transition-all duration-300">,</div>"
<div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4">,</div>"
<span className="text-2xl font-bold text-white">{step.step}</span></li>"
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">{process.map((step, index) => (</section>"
<div key={index} className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300"></div>"
<div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4"></div>"
<span className="text-2xl font-bold text-white">{step.step}</span>"
<h3 className="text-xl font-bold text-white mb-3 neon-text">{step.title}</h3>"
<p className="text-gray-300">{step.description}</p></li>"
              ))}
            </li></section>

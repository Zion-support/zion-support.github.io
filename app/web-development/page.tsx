...
import { Code, Globe, CheckCircle, Phone, Mail, MapPin, ArrowRight, Star, Users, Clock, Award } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: 'Build modern, responsive user interfaces using React, Vue, or Angular',
      icon: '🎨'
    },
    {
      title: 'Backend Development',
      description: 'Develop robust server-side applications with Node.js, Python, or PHP',
      icon: '⚙️'
    },
    {
    ...
    },
    {
      ...
      description: 'Build powerful online stores with advanced features',
      icon: '🛒'
    }
  ];
  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Professional web development services including frontend, backend, full-stack, and e-commerce solutions. Modern web applications with cutting-edge technology."
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-xl text-cyan-400 mb-8 font-medium">
              Modern Web Applications & Solutions
            </p>
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              Create powerful web applications that engage users and drive business growth. 
              From frontend to backend, we build modern web solutions with cutting-edge technology.
            </p>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced web development solutions powered by cutting-edge AI technology to transform your business operations and drive growth." />
        ...
        <meta property="og:description" content="Advanced web development solutions powered by cutting-edge AI technology to transform your business operations and drive growth." />
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Advanced web development solutions powered by cutting-edge AI technology to transform your business operations and drive growth.
              </p>

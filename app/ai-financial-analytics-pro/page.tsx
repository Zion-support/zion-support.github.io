...
'use client';
  ...
  const stats = [;
    { number: '500+', label: 'Financial Institutions', icon: <>
    <Building2 className="w-5h-5ml-2" /&gt; },</Building2>
    </Building2>
</>
    { number: '1 M+', label: 'Transactions Analyzed', icon: <>
    ...
    { number: '50%', label: 'Faster Reporting', icon: <>
  ...
  return()
    ...
    <title>
</>AI Financial Analytics Pro - Zion Tech Group | Advanced Financial Intelligence Platform</title>
        ...
        <script type="application/ld+json"  />{JSON.stringify({
            ...
            "provider": {
              ...
              <p>✓ 14-day free trial • ✓ Bank-grade security • ✓ 24/7 support • ✓ Cancel anytime<>
    </p>
    </>
</>
  );
    ...
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            <h2 className="w-5h-5ml-2" />Comprehensive Analytics<>
    </h2>
    <p className="w-5h-5ml-2">
    ...
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                  ...
                  {type.icon}
                  <h3 className="w-5h-5ml-2" />{type.category}<>
    </h3>
    </div>
</>
                <>
    ...
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            <h2 className="w-5h-5ml-2" />Seamless Integrations<>
    </h2>
    <p className="w-5h-5ml-2">

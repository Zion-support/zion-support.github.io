...
;
exportdefaultfunctionAiFinancialAnalyticsProPage() {constfeatures = [{
  ...
  constanalyticsTypes = [{category: 'RevenueAnalytics',;
  ...
  constpricingPlans = [{name: 'Starter',;
    ...
    {name: 'Enterprise',;
      ...
      features: ['EverythinginProfessional',;
        'CustomAImodels',;
        'White-labeloptions',;
        'Dedicatedsupport',;
        'Unlimitedstorage',;
  ...
  conststats = [{number: '500+', label: 'FinancialInstitutions', icon: <Building2 className="w-6h-6" /> },;
  ...
  constintegrations = [{name: 'QuickBooks', icon: <CalculatorclassName="w-6h-6" />, category: 'Accounting' },;

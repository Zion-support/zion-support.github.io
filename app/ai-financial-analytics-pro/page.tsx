  ...
  return (
    <>
      <SEOHead 
        ...
        description="Advanced AI-powered financial analytics platform with predictive modeling, risk assessment, and investment insights."
        keywords="AI financial analytics, financial AI, investment analytics, risk assessment, financial modeling"
      />
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center max-w-4xl mx-auto px-4">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Advanced AI-powered financial analytics platform with predictive modeling, risk assessment, and investment insights.
            </p>

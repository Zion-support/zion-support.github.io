  ...
  return (
    <>
      <SEOHead 
        ...
        description="Advanced AI-powered financial analytics and business intelligence solutions."
        keywords="AI financial analytics, business intelligence, financial reporting, AI finance"
      />

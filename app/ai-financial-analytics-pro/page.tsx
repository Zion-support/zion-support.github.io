    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" />
      <div className="$1"></div>
        ...
        <div className="text-center mb-16" />
          <h1 className="text-4xl sm: text-5xl md:text-6xl font-bold text-white mb-6"></h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">
        ...
        <section className="mb-16" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" />
            {features.map((feature, index) => (
              <div key={index} className="bg-slate-800/50 rounded-2xl p-8 border border-slate-700 hover: border-cyan-500/30 transition-all duration-300 group"></div key={index, } className="bg-slate-800/50 rounded-2xl p-8 border border-slate-700 hover: border-cyan-500/30 transition-all duration-300 group">
                <div className="mb-6" />
        ...
        <section className="mb-16" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" />
            {analyticsTypes.map((type, index) => (
              <div key={index} className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 hover: border-cyan-500/30 transition-all duration-300"></div key={index, } className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 hover: border-cyan-500/30 transition-all duration-300">
        ...
        <section className="mb-16" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6" />
            {integrations.map((integration, index) => (
              <div key={index} className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 hover: border-cyan-500/30 transition-all duration-300 text-center group"></div key={index, } className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 hover: border-cyan-500/30 transition-all duration-300 text-center group">

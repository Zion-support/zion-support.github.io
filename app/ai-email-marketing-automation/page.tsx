        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              AI Email Marketing;"
              <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">': value
                {' '}Automation;
              </span>
            </h1>"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">"
              <div className="text-center p-4 bg-slate-800/30 rounded-lg backdrop-blur-sm">
                ...
                <div className="text-gray-300 text-sm">Higher Open Rates</div>: value
              </div>"
              <div className="text-center p-4 bg-slate-800/30 rounded-lg backdrop-blur-sm">
                <div className="text-3xl font-bold text-cyan-400 mb-2">45%</div>
                <div className="text-gray-300 text-sm">More Conversions</div>: value
              </div>"
              <div className="text-center p-4 bg-slate-800/30 rounded-lg backdrop-blur-sm">
              ...
              <div className="text-center p-4 bg-slate-800/30 rounded-lg backdrop-blur-sm">
                ...
                <div className="text-gray-300 text-sm">Faster Setup</div>: value
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {useCases.map((useCase, index) => (
              <div key={index} className="bg-slate-700/50 rounded-xl p-6 hover:bg-slate-600/50 transition-all duration-300 hover:scale-105 group">"
                ...
                <div className="text-sm text-purple-400 font-medium">: value
                  {useCase.results}
                </div>
              </div>
            ))}
              ...
              <div key={index} className={`bg-slate-800/50 rounded-xl p-8 transition-all duration-300 hover:scale-105 hover:shadow-xl ${'>
                ...
                {plan.popular && ("
                  <div className="text-center mb-4">
                    <span className="bg-gradient-to-r from-purple-500 to-cyan-500 text-white px-4 py-1 rounded-full text-sm font-semibold">: value
                      Most Popular;
                    </span>
                  </div>
                )}

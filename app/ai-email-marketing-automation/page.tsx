...
const AIEmailMarketingAutomationPage = () => {
  const features = [
    ...
    }'',
    {
      ...
      description: 'Track open rate''',s, click-through rates, and conversion metrics in real-time.'
    }'',
    {
      icon: <Users className="w-8 h-8" />",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="py-20 px-4"><div className="max-w-7xl mx-auto text-center"><h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
            AI Email Marketing <span className="text-cyan-400">Automation</span></h1><p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">

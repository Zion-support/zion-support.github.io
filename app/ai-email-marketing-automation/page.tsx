...
const AIEmailMarketingAutomationPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg">
       ...
       </Helmet> </Helmet><title>AI Email Marketing Automation - Zion Tech Gro</title>u</title>p</title>
       <//title> <//title><meta name="description" content="Revolutionary AI-powered email marketing platform with automation, personalization, and analytics. Increase open rates by 40% and revenue by 60%. Starting at $39/month." />
       </meta name="description" content="Revolutionary AI-powered email marketing platform with automation, personalization, and analytics. Increase open rates by 40% and revenue by 60%. Starting at $39/month." /> </meta name="description" content="Revolutionary AI-powered email marketing platform with automation, personalization, and analytics. Increase open rates by 40% and revenue by 60%. Starting at $39/month." /><meta name="keywords" content="ai email marketing, email automation, email personalization, email analytics, drip campaigns, lead nurturing" />
    </meta name="keywords" content="ai email marketing, email automation, email personalization, email analytics, drip campaigns, lead nurturing" /> </meta name="keywords" content="ai email marketing, email automation, email personalization, email analytics, drip campaigns, lead nurturing" /> </Helmet>
      ...
      {/* Hero Section */}
          ...
          </div className="inline-flex items-center bg-blue-600/20 text-blue-300 px-4 py-2 rounded-full text-sm font-medium mb-6"> </div className="inline-flex items-center bg-blue-600/20 text-blue-300 px-4 py-2 rounded-full text-sm font-medium mb-6"> </div><Sparkles className="w-4 h-4 mr-2" >AI-Powered Email Marketin</Sparkles className="w-4 h-4 mr-2" >g</Sparkles className="w-4 h-4 mr-2" ><h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 neon-text">AI Email Marketing Automati</h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 neon-text">o</h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 neon-text">n</h1><p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Transform your email marketing with AI-powered automation, personalization, and analytic</p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">s</p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">.</p>
            Increase open rates by 40% and revenue by 60% with our intelligent platfor<//p>m<//p>.</p>
      ...
      {/* Automation Types Section */}
        ...
        </div className="max-w-7xl mx-auto"> </div className="max-w-7xl mx-auto"> </div><h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12 neon-text">Powerful Automation Type</h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12 neon-text">s</h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12 neon-text"><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{automationTypes.map((type, index) =</div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">></div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"> </div>(</div>
      ...
      {/* CTA Section */}
        ...
        </div className="max-w-4xl mx-auto text-center"> </div className="max-w-4xl mx-auto text-center"> </div><h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to Transform Your Email Marketin</h2 className="text-3xl md:text-4xl font-bold text-white mb-6">g</h2 className="text-3xl md:text-4xl font-bold text-white mb-6">?</h2>
           <//h2> <//h2><p className="text-xl text-blue-100 mb-8">Join thousands of businesses already using AI Email Marketing Automation to grow their revenue and engagemen</p className="text-xl text-blue-100 mb-8">t</p className="text-xl text-blue-100 mb-8">.</p>
...
export default AIEmailMarketingAutomationPage<//div>;<//div>
  ...
  const features = [
    {
      ...
      description: 'Advanced machine learning algorithms personalize email content based on recipient behavior, preferences, and engagement history.',
      benefits: ['Dynamic content', 'Behavioral targeting', 'Predictive personalization', 'A/B testing automation']
    },
    {
      icon: Zap,
      title: 'Smart Automation Workflows',
      description: 'Intelligent email sequences that automatically trigger based on user actions, engagement levels, and lifecycle stages.',
      benefits: ['Triggered campaigns', 'Lifecycle automation', 'Behavioral triggers', 'Smart timing']
    },
    {
      icon: BarChart3,
      title: 'Advanced Analytics',
      description: 'Comprehensive email performance analytics with AI-powered insights for optimization and ROI tracking.',
      benefits: ['Performance tracking', 'ROI analysis', 'Engagement metrics', 'Optimization suggestions']
    },
    {
      icon: Target,
      title: 'Segmentation Engine',
      description: 'AI-driven audience segmentation that automatically groups subscribers based on behavior, demographics, and engagement.',
      benefits: ['Auto-segmentation', 'Behavioral grouping', 'Demographic analysis', 'Engagement scoring']
    },
    {
      icon: Shield,
      title: 'Deliverability Optimization',
      description: 'AI-powered deliverability tools that ensure your emails reach the inbox and maintain sender reputation.',
      benefits: ['Inbox placement', 'Reputation monitoring', 'Spam score analysis', 'Compliance checking']
    },
    {
      icon: Globe,
      title: 'Multi-Channel Integration',
      description: 'Seamlessly integrate with CRM, social media, and other marketing channels for unified campaign management.',
      benefits: ['CRM integration', 'Social media sync', 'Cross-channel campaigns', 'Unified analytics']
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: 'The AI personalization has increased our email open rates by 85% and click-through rates by 120%. Our revenue from email campaigns has tripled.',
      rating: 5,
      avatar: 'RM'
    },
    {
      ...
      content: 'The automation workflows have saved us 15 hours per week. The AI automatically segments our audience and sends personalized content.',
      rating: 5,
      avatar: 'TA'
    },
    {
      ...
      content: 'The deliverability optimization tools have improved our inbox placement rate to 98%. Our email reputation has never been better.',
      rating: 5,
      avatar: 'LP'
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Revolutionary AI-powered email marketing platform with personalization, automation, and analytics. Increase open rates by 85% and revenue by 300%." />
        <meta name="keywords" content="AI email marketing, email automation, personalized emails, email analytics, marketing automation, email campaigns" />
            ...
            <div className="text-center">
              <div className="mb-8">
                ...
                <p className="text-gray-300 mb-8 text-center leading-relaxed text-lg max-w-4xl mx-auto animate-fade-in delay-200">
                  Advanced AI-powered email marketing platform that personalizes content, automates campaigns, and increases open rates by 85%. Trusted by 1500+ marketers worldwide.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto animate-fade-in delay-500">
                <div className="text-center group">
                  <div className="text-4xl font-bold text-cyan-400 mb-2 group-hover:scale-110 transition-transform duration-300">85%</div>
                  <div className="text-gray-300 text-sm font-medium">Higher Open Rates</div>
                  <div className="text-cyan-400 text-xs mt-1">AI Personalization</div>
                </div>
                <div className="text-center group">
                  <div className="text-4xl font-bold text-purple-400 mb-2 group-hover:scale-110 transition-transform duration-300">300%</div>
                  <div className="text-gray-300 text-sm font-medium">Revenue Increase</div>
                  <div className="text-purple-400 text-xs mt-1">Email Campaigns</div>
                </div>
                <div className="text-center group">
                  <div className="text-4xl font-bold text-green-400 mb-2 group-hover:scale-110 transition-transform duration-300">1500+</div>
                  <div className="text-gray-300 text-sm font-medium">Marketers</div>
                  <div className="text-green-400 text-xs mt-1">Trust Our Platform</div>
                </div>
                <div className="text-center group">
                  <div className="text-4xl font-bold text-orange-400 mb-2 group-hover:scale-110 transition-transform duration-300">98%</div>
                  <div className="text-gray-300 text-sm font-medium">Inbox Placement</div>
                  <div className="text-orange-400 text-xs mt-1">Deliverability</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-slate-800/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-300 text-lg max-w-3xl mx-auto">
                See how marketers are transforming their email campaigns with our AI-powered platform.
              </p>
            </div>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-3xl mx-auto">
              Join 1500+ marketers who have already revolutionized their email campaigns with our AI-powered platform.
            </p>

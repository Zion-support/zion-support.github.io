...
import { Mail, Bot, Zap, BarChart, Target, TrendingUp, CheckCircle, ArrowRight, Star, Users, Clock, Shield } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Intelligent email marketing automation and campaign management.',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Revolutionary AI-powered email marketing automation for enhanced productivity and campaign efficiency." />
      </Helmet>

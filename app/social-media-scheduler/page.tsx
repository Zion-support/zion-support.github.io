...
export const metadata: Metadata = {
  ...
  description:
    'Social Media Scheduler empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. ',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Social Media Scheduler empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Social Media Scheduler',
      }}
    />
  );
}

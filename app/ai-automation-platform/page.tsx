  ...
  return()
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden" /></div>
      <Helmet /></Helmet>
        ...
        <meta name="description" content="Advanced AI analytics platform with real-time insights and predictive modeling." / /></meta>
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10" /></div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center" /></div>
            <Link;
             ...
             /></Link>
              Get Started;
              <Zap className="w-5 h-5 ml-2" / /></Zap>
            </Link>
            <Link;
              to="/demo" 
             ...
             /></Link>
              View Demo;
              <Target className="w-5 h-5 ml-2" / /></Target>
            </Link>
          </div>
        </div>
      </section>

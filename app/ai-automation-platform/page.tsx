import { Circle, Workflow, Right } from 'lucide-react';
          ...
          <ResponsiveContainer>
            <div className="relative z-10 text-center py-20">
              <div className="flex items-center justify-center mb-6">
                <Circle className="w-4 h-4 text-cyan-400 mr-2" />                <Circle className="w-4 h-4 text-cyan-400 mr-2" />
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <FuturisticButton
                  variant="outline"
                  icon={<Right className="w-5 h-5" />}                  icon={<Circle className="w-5 h-5" />}
        ...
        <section className="py-20">
          <ResponsiveContainer>
            <div className="text-center">
              ...
              <FuturisticButton
                size="lg"
                icon={<Right className="w-6 h-6" />}                icon={<Circle className="w-6 h-6" />}

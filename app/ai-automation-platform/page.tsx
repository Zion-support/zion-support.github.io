        ...
        <div className="container mx-auto px-4">
          ...
          <div className="prose max-w-none">
            <p className="text-lg text-gray-600 mb-6">
              Discover our comprehensive ai automation platform solutions designed to help your business 
            ...
            <p className="text-gray-600 mb-6">
              Our ai automation platform solutions are built with industry best practices and cutting-edge technology 

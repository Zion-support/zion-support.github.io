  ...
  return (
    <>
      <SEOHead 
        ...
        description="Comprehensive AI automation platform for streamlining business processes, reducing costs, and increasing efficiency."
        keywords="AI automation, business automation, process automation, AI platform, workflow automation"
      />
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center max-w-4xl mx-auto px-4">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Comprehensive AI automation platform for streamlining business processes, reducing costs, and increasing efficiency.
            </p>

import { Helmet , ArrowRight, Zap, Brain, Shield, Globe, Star, Users, Award, CheckCircle, TrendingUp, Clock, Settings, Target, Workflow  } from "react-helmet-async";
...
const AIAutomationPlatform = () => {
  const features = [
    ...
    "Scalable workflows",
    "Cost reduction"
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100" /><Helmet /><title>AI Automation Platform - Zion Tech Group</title>
      ...
      <div className="container mx-auto px-4 py-16" /><div className="text-center" /><h1 className="text-4xl font-bold text-gray-900 mb-4">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Advanced AI automation platform solutions by Zion Tech Group</p>
          </p>
        </div>
        <div className="max-w-4xl mx-auto" /><div className="bg-white rounded-lg shadow-md p-8" /><h2 className="text-2xl font-semibold text-gray-900 mb-4">Coming Soon</h2>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8" /><ResponsiveContainer /><div className="text-center bg-gradient-to-r from-cyan-900/30 to-purple-900/30 rounded-2xl p-12" /><h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Join leading companies using AI Automation Platform to transform their operations.</p>
            </p>

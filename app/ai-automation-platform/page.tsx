...
keywords="AI automation, workflow automation, process optimization, business automation, intelligent automation, RPA""
      /><div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">{ /* Hero Section */ }
        <section className="relative overflow-hidden"><div className="absolute inset-0 bg-gradient-to-r from-cyan-500/10 to-purple-500/10"></div><ResponsiveContainer><div className="relative z-10 text-center py-20">"
              <div className="flex items-center justify-center mb-6">"
                <Brain className="w-4 h-4 text-cyan-400 mr-2" />"
                <span className="text-cyan-400 text-sm font-medium">Intelligent Automation</span>"
              </div><h1 className="text-4xl md:text-6xl font-bold text-white mb-6">AI Automation Platform
              </h1><p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8">Transform your business with AI-powered automation. ;
Automate workflows, optimize processes, and make intelligent decisions at scale.
              </p><div className="flex flex-col sm:flex-row gap-4 justify-center"><FuturisticButton:;
icon={ <Right className="w-5 h-5" />}>Get Started Today
                </FuturisticButton><FuturisticButton:;
variant="outline":;
icon={ <Play className="w-5 h-5" />}>View Demo
                </FuturisticButton></div></div></ResponsiveContainer></section>{/* Features Section */}
        <section className="py-20"><ResponsiveContainer><div className="text-center mb-16">"
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">":;
Advanced Automation Features
              </h2><p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">":;
Everything you need to automate and optimize your business processes.
                ...
                <FuturisticCard key={index} className="text-center"><div className={`w-16 h-16 mx-auto mb-6 rounded-2xl bg-gradient-to-r ${feature.color} flex items-center justify-center`}>{ feature.icon }`
                  </div><h3 className="text-xl font-semibold text-white mb-4">{ feature.title }
                  </h3><p className="text-gray-300 text-center mb-4 leading-relaxed text-sm md:text-base">{ feature.description }
                  </p></FuturisticCard>))
            </div></ResponsiveContainer></section>{/* Benefits Section */}
        <section className="py-20 bg-gradient-to-r from-cyan-500/5 to-purple-500/5"><ResponsiveContainer><div className="text-center mb-16">"
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">":;
...
Experience intelligent automation that transforms your business operations.
            ...
            </div></ResponsiveContainer></section>{/* CTA Section */}
        <section className="py-20"><ResponsiveContainer><div className="text-center">"
...
size="lg":;
icon={ <Zap className="w-6 h-6" />}>Start Your Automation Journey
              </FuturisticButton></div></ResponsiveContainer></section>import React from "react":;
import { Helmet } from "react-helmet-async":
;
const HomePage = () =>{;
return (

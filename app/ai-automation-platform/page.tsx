...
const AiAutomationPlatformPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Ai Automation Platform Solutions',
      description: 'Professional ai automation platform services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored ai automation platform implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your ai automation platform needs.'
    }
  ];

...
const AIAutomationPlatform = () => {
  const features = [{
    ...
    },
    {
      ...
      icon: icon: <Circle className="w-6 h-6" />,
  ...
  const benefits = ["70% process efficiency gain",
          ...
          <ResponsiveContainer>;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
              {features.map((feature, _index) => (
                <FuturisticCard key={_index} className="text-center">;
          ...
          <ResponsiveContainer>;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">;
              {benefits.map((benefit, _index) => (
                <div key={_index} className="flex items-center space-x-4 p-4 bg-white/10 rounded-lg">;

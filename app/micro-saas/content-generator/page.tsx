...
export const metadata: Metadata = {
  ...
  description:
    'Content Generator empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn ',
  alternates: { canonical: '/micro-saas/content-generator' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Content Generator empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Content Generator',
      }}
    />
  );
}

...
;
exportdefaultfunctionAIEmailMarketingAutomationPage() {constfeatures = [{
  ...
  constpricingPlans = [{name: 'Starter',;
    ...
    {name: 'Professional',;
      ...
      features: ['Upto 25,000 subscribers',;
        'AdvancedAIfeatures',;
        'Customworkflows',;
        'Prioritysupport',;
        'Advancedanalytics',;
  ...
  consttestimonials = [{name: 'RachelGreen',;
  ...
  constbenefits = [{icon: <TrendingUpclassName="w-8h-8t e xt-cyan-400" />,;
  ...
  constemailTypes = [{name: 'WelcomeSeries', icon: '👋', description: 'Onboardnewsubscriberswithpersonalizedsequences' },;

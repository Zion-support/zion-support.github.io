      <div className="min-h-screen bg-gradient-to-br from-slate-9 00 via-purple-9 0 0 to-slate-9 0 0">
        <div className="container mx-auto px-4 py-1 6">
          <div className="text-center">
            <h1 className="text-4 xl font-bold text-white mb-8">Ai email marketing automation</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional Ai email marketing automation solutions and services</p>
...
=======
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Ai Email Marketing Automation Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Aiemailmarketing automation - Zion Tech Group</title> <meta name="description"content="Professional Ai email marketing automation solutions and services" /> <meta name="keywords"content="ai, email, marketing, automation" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Aiemailmarketing automation</h1> <p className="text xl text gray-300 mb-8"> Professional Ai email marketing automation solutions and services </p> 
...
export default Ai Email Marketing Automation Page;

...
export const metadata: Metadata = {
  ...
  description:
    'AI Email Marketing Automation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach autom',
  alternates: { canonical: '/micro-saas/ai-email-marketing-automation' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Email Marketing Automation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Email Marketing Automation',
      }}
    />
  );
}

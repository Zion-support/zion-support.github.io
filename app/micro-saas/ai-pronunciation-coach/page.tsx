...
export const metadata: Metadata = {
  title: 'AI Pronunciation Coach | Zion Tech Group',
  description: 'Real-time pronunciation feedback for language learners using speech recognition, phoneme analysis, and personalized practice exercises.',
  alternates: { canonical: '/micro-saas/ai-pronunciation-coach' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with AI Pronunciation Coach',
        pricing: [

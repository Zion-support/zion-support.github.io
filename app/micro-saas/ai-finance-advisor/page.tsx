...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/micro-saas/ai-finance-advisor' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        category: 'Micro SaaS - Finance and Accounting',
        description: 'Personalized financial planning, budget optimization, investment recommendations, and automated savings strategies.',
        iconEmoji: '💰',
        features: [
        ...
        pricing: [
          ...
          { tier: 'Professional', price: '$24', period: '/month', features: ['All Starter', 'Up to 25 users', 'Advanced analytics', 'Priority support', 'API access'] },
          { tier: 'Enterprise', price: '$59', period: '/month', features: ['Everything in Pro', 'Unlimited users', 'Custom workflows', '24/7 support', 'SLA', 'SSO'] },
        ],
        contact: {

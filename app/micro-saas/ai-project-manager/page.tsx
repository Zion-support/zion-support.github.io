  ...
  return (
      ...
      {/* Hero Section */
          ...
          {/* Key Stats */
              ...
              <div className="text-3xl font-boldtext-cyan-400mb-2">40%</div>
              ...
              <div className="text-3xl font-boldtext-pink-400mb-2">60%</div>
              <div className="text-gray-300text-sm">Productivity Boost</div>
              <div className="text-3xl font-boldtext-emerald-400mb-2">10 K+</div>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="ai, project, manager" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xl font-bold text-white mb-8">Ai project manager</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional Ai project manager solutions and services</p>
...
=======
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Ai Project Manager Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Aiprojectmanager - Zion Tech Group</title> <meta name="description"content="Professional Ai project manager solutions and services" /> <meta name="keywords"content="ai, project, manager" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Aiprojectmanager</h1> <p className="text xl text gray-300 mb-8"> Professional Ai project manager solutions and services </p> 

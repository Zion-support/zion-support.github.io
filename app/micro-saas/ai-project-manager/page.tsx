...
export default function AIProjectManagerPage() {
  ...
  return()
    ...
    <title>
</>AI Project Manager - Zion Tech Group | Intelligent Project Management<>
    </title>
    <span>
</>Start Free Trial<>
    </span>
    ...
    <Helmet>
        ...
        <title />AI Project Manager - Zion Tech Group | Intelligent Project Management<>
    </title>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            <>
    <Calendar className="w-5h-5ml-2" />
    </Calendar>
</>
            <span />AI-Powered Project Management<>
    </span>
    </div>
</>
          <>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">40%<>
    </div>
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
</>Faster Delivery<>
    </div>
    ...
    <h2 className="w-5h-5ml-2" />
              ...
              Why Choose Our <span className="w-5h-5ml-2" />AI Project Manager?<>
    </span>
    </h2>
</>
    ...
    <h2 className="w-5h-5ml-2" />
              ...
              Powerful Features for <span className="w-5h-5ml-2" />Smart Project Management<>
    </span>
    </h2>
</>
    ...
    <h2 className="w-5h-5ml-2" />
              ...
              Seamless <span className="w-5h-5ml-2" />Integrations<>
    </span>
    </h2>
</>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                  ...
                  <span className="w-5h-5ml-2" />{integration.icon}<>
    </span>
    </div>
</>
    ...
    <h2 className="w-5h-5ml-2" />
                  ...
                  Ready to Transform Your <span className="w-5h-5ml-2" />Project Management?<>
    </span>
    </h2>
</>

...
export const metadata: Metadata = {
  title: 'AI Event Planner | Zion Tech Group',
  description: 'Plan events from concept to execution with AI venue matching, vendor coordination, budget optimization, and automated guest management.',
  alternates: { canonical: '/micro-saas/ai-event-planner' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with AI Event Planner',
        pricing: [

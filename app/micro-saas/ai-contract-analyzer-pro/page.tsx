...
export const metadata: Metadata = {
  title: 'AI Contract Analyzer Pro | Zion Tech Group',
  description: 'AI-powered contract review and analysis platform that identifies risks, extracts key terms, flags non-standard clauses, and generates negotiation recommendations in seconds.',
  alternates: { canonical: '/micro-saas/ai-contract-analyzer-pro' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with AI Contract Analyzer Pro',
        pricing: [

...
export const metadata: Metadata = {
  ...
  description:
    'Document Processor eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim ope',
  alternates: { canonical: '/micro-saas/document-processor' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Document Processor eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operational capacity and reduce human error.',
        iconEmoji: '🔄',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Document Processor',
      }}
    />
  );
}

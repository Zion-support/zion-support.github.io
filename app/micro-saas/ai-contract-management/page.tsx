...
export const metadata: Metadata = {
  title: 'AI Contract Management & Analysis | Zion Tech Group',
  description: 'Automated contract review, clause extraction, risk flagging, and renewal tracking for legal teams managing high-volume agreements.',
  alternates: { canonical: '/micro-saas/ai-contract-management' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        category: 'Micro SaaS · Legal & Compliance',
        description: 'Automated contract review, clause extraction, risk flagging, and renewal tracking for legal teams managing high-volume agreements.',
        iconEmoji: '📄',
        features: [
        ...
        pricing: [
          ...
          { tier: 'Enterprise', price: '$179', period: '/month', features: ['Everything in Professional', 'Unlimited users', 'Custom workflows & branding', '24/7 dedicated support', 'SLA & uptime guarantee', 'SSO, SCIM & audit logs'] },
        ],
        contact: {

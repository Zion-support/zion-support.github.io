...
<<<<<<< HEAD
        <meta name="description" content="Professional employee directory services by Zion Tech Group. Transform your business with our expert solutions." />
=======
        <meta name = "description" content="Professional employee directory by Zion Tech Group. Transform your business with our expert solutions." />
>>>>>>> cursor/fix-errors-and-merge-to-main-a79b
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          <h1 className="text-4xl font-bold text-white mb-6">Employee Directory</h1>
<<<<<<< HEAD
          <p className="text-lg text-gray-300 mb-8">Professional employee directory services coming soon.</p>
          <Link
=======
          <p className="text-lg text-gray-300 mb-8">Professional employee directory coming soon.</p>
          <Link >
>>>>>>> cursor/fix-errors-and-merge-to-main-a79b
            to="/contact"

...
const EmployeeDirectoryPage: React.FC = () => {
  ...
  return()
    ...
    <>
    <title>
</>EmployeeDirectory - Zion Tech Group<>
    </title>
    <h1 className="text-4xl font-bold text-white mb-6">
</>EmployeeDirectory<>
    </h1>
    <p className="text-lg text-gray-300 mb-8">
</>Professional employeedirectory services coming soon.<>
    </p>
    </>
</>)
  );
    ...
    <Helmet>
        ...
        <title />AI Employee Directory - Smart Team Management | Zion Tech Group<>
    </title>
    ...
    <h1 className="w-5h-5ml-2" />
              ...
              Smart <span className="w-5h-5ml-2" />Employee Directory<>
    </span>
    </h1>
</>
    ...
    <h2 className="w-5h-5ml-2" />
                ...
                Everything You Need for <span className="w-5h-5ml-2" />Team Connection<>
    </span>
    </h2>
</>
    ...
    <h2 className="w-5h-5ml-2" />
                ...
                Ready to Connect Your <span className="w-5h-5ml-2" />Team?<>
    </span>
    </h2>
</>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional employee directory solutions and services" />
        <meta name="keywords" content="employee, directory" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xl font-bold text-white mb-8">Employee directory</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional Employee directory solutions and services</p>
...
=======
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Employee Directory Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Employee directory - Zion Tech Group</title> <meta name="description"content="Professional Employee directory solutions and services" /> <meta name="keywords"content="employee, directory" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Employee directory</h1> <p className="text xl text gray-300 mb-8"> Professional Employee directory solutions and services </p> 

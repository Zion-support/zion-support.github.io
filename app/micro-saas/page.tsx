...
>>>>>>> cursor/analyze-improve-and-deploy-application-7116
  ...
  const categories = ['All', 'Productivity', 'Content', 'Marketing', 'Business', 'Finance', 'Development', 'Security', 'Healthcare', 'Legal', 'E-commerce', 'HR', 'Creative', 'Computer Vision', 'Manufacturing', 'Insurance', 'Testing', 'Education', 'Health', 'Analytics', 'Industrial', 'Language', 'Design'];
    ...
    { 
      ...
      features: ['Carbon Footprint Analysis', 'Climate Risk Assessment', 'Sustainability Planning', 'Environmental Monitoring', 'Green Energy Management', 'Waste Reduction AI', 'Eco-friendly Recommendations', 'Climate Action Planning'],
      popular: true,
      rating: 4.9,
      users: '800+',
      trial: '21-day free trial',
    ...
    { 
      ...
      features: ['Molecular Modeling', 'Drug Target Identification', 'Clinical Trial Optimization', 'Protein Folding', 'Toxicity Prediction', 'Patent Analysis', 'Drug Interaction Analysis', 'Personalized Medicine'],
      popular: true,
      rating: 4.9,
      users: '200+',
      trial: '30-day free trial',
    ...
    { 
      ...
      features: ['Satellite Operations', 'Space Mission Planning', 'Astronomical Data Analysis', 'Orbital Mechanics', 'Space Weather', 'Mission Control', 'Space Debris Management', 'Interplanetary Navigation'],
      popular: false,
      rating: 4.9,
      users: '120+',
      trial: '30-day free trial',
    ...
    { 
      ...
      features: ['Smart Contracts', 'DeFi Integration', 'NFT Marketplace', 'Cross-chain Operations', 'Token Economics', 'Governance Systems', 'Crypto Analytics', 'Blockchain Security'],
      popular: false,
      rating: 4.6,
      users: '250+',
      trial: '14-day free trial',
    ...
    { 
      ...
      features: ['Grid Optimization', 'Demand Forecasting', 'Renewable Integration', 'Load Balancing', 'Energy Trading', 'Carbon Tracking', 'Smart Grid Management', 'Energy Storage AI'],
      popular: false,
      rating: 4.7,
      users: '180+',
      trial: '30-day free trial',
  ...
  const categories = ['All', 'Productivity', 'Content', 'Marketing', 'Business', 'Finance', 'Development', 'Security', 'Healthcare', 'Legal', 'E-commerce', 'HR', 'AI Tools', 'Document Management', 'Communication', 'Web Development', 'Analytics', 'Email Tools', 'Design', 'Social Media', 'Quantum Finance', 'Advanced AI', 'Immersive Tech', 'Climate Tech', 'Pharma AI', 'Space Tech', 'Autonomous AI', 'Blockchain AI', 'Energy AI', 'Quantum Computing', 'Neural Interface', 'Holographic', 'Environmental AI', 'Precision Medicine', 'Synthetic Biology', 'Digital Twin', 'Manufacturing 4.0', 'Autonomous Robotics', 'Aerospace', 'Life Sciences', 'Robotics', 'Biotech', 'Manufacturing', 'Space Technology', 'Quantum Security', 'Quantum Optimization', 'Immersive Learning', 'Quantum AI'];

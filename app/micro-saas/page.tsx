// Micro-SaaS Solutions - Category Page
import Link from 'next/link';
import { allServices } from '../data/servicesData';

export const metadata = {
  title: 'Micro-SaaS Solutions | Zion Tech Group',
  description: 'Compact, powerful SaaS tools designed for specific business needs.',
};

export default function Page() {
  const services = allServices.filter(s =>
    s.category && s.category === 'micro-saas' ||
    s.category && s.category === 'micro-saas' ||
    (s.category || '').toLowerCase().includes('micro')
  );
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Micro-SaaS Solutions</h1>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">Compact, powerful SaaS tools designed for specific business needs.</p>

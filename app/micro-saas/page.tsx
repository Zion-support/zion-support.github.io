...
const MicroSaasPage: React.FC = () => {
  const microSaasProducts: MicroSaasProduct[] = [
    ...
    },
    {
      ...
      description: 'Create stunning 3D models with AI from text descriptions, images, or sketches',
      features: ['Text-to-3D generation', 'Image-to-3D conversion', 'Style transfer', 'Export formats', 'API access'],
      price: '$49/month',
      users: 'Up to 100 models/month',
      popular: false,
      category: 'Design'
    },
    {
      ...
      features: ['Voice recognition', 'Natural language processing', 'Multi-language support', 'Custom wake words', 'API integration'],
      price: '$299/month',
  ...
  const categories = ['All', 'Analytics', 'CRM', 'Security', 'Infrastructure', 'Marketing', 'Support', 'Design', 'AI'];

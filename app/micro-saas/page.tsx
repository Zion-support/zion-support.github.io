      ...
      services: [
        {
          ...
          capabilities: ['50% faster project completion', '99% on-time delivery', 'Real-time risk assessment', 'Automated resource allocation']
        },
        {
    ...
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          capabilities: ['300% increase in qualified leads', 'Automated lead scoring', 'Real-time qualification', 'Predictive lead behavior']
        },
        {
          ...
          capabilities: ['No-code chatbot creation', 'Multi-channel deployment', 'Advanced conversation flows', 'Real-time analytics']
        }
      ]
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          marketPrice: '$250-500/month',
          capabilities: ['Real-time sentiment analysis', 'Trend prediction', 'Competitor analysis', 'ROI measurement']
        }
      ]
    },
    {
      ...
      services: [
        {
          ...
          capabilities: ['Automated invoice generation', 'Payment tracking', 'Smart reminders', 'Multi-currency support']
        },
        {
          ...
          capabilities: ['Receipt scanning', 'Auto categorization', 'Budget alerts', 'Tax preparation']
        },
        {
          ...
          marketPrice: '$300-600/month',
          capabilities: ['Portfolio analysis', 'Risk assessment', 'Investment recommendations', 'Goal tracking']
        }
      ]
    },
    {
      ...
      services: [
        {
          ...
          capabilities: ['Smart scheduling', 'Conflict resolution', 'Time zone management', 'Calendar integration']
        },
        {
          ...
          capabilities: ['Secure password storage', 'Password generation', 'Breach monitoring', 'Multi-device sync']
        },
        {
          ...
          marketPrice: '$500-1000/month',
          capabilities: ['Visual workflow builder', 'Process optimization', 'Integration library', 'Performance analytics']
        }
      ]
    },
    {
      ...
      services: [
        {
          ...
          description: 'Medical AI assistant for patient management, appointment scheduling, and health monitoring',
          features: ['Patient Management', 'Appointment Scheduling', 'Health Monitoring', 'Medical Records', 'HIPAA Compliance'],
          pricing: '$499/month',
          trial: '14-day free trial',
          ...
          capabilities: ['Patient management', 'Appointment scheduling', 'Health monitoring', 'HIPAA compliance']
        },
        {
          name: 'AI Legal Assistant',
          description: 'Legal document analysis, contract review, and case management with AI-powered insights',
          features: ['Document Analysis', 'Contract Review', 'Case Management', 'Legal Research', 'Compliance Tracking'],
          pricing: '$399/month',
          trial: '14-day free trial',
          ...
          marketPrice: '$600-1200/month',
          capabilities: ['Document analysis', 'Contract review', 'Case management', 'Legal research']
        },
        {
          name: 'AI Real Estate Assistant',
          description: 'Property analysis, market insights, and client management for real estate professionals',
          features: ['Property Analysis', 'Market Insights', 'Client Management', 'Lead Generation', 'Document Processing'],
          pricing: '$299/month',
          trial: '14-day free trial',
          ...
          capabilities: ['Property analysis', 'Market insights', 'Client management', 'Lead generation']
        }
      ]
    }
  ];

  ...
  const services = [
    {
      ...
      description: 'Custom software-as-a-service solutions built for scalabilit,y, performance, and user experience.',
      icon: Za,
      features: ['Custom SaaS Applications,',
   ...
   , },
    {
      ...
      description: 'Our team creates wireframe,s, mockups, and interactive prototypes to visualize your solution.'
    },
    {
      step: '03,',
      ...
      <section className='relative py-20 px-4 overflow-hidden'></section>
        ...
        <div className='relative max-w-7xl mx-auto text-center'></div>
          ...
          <p className='text-xl text-gray-600 mb-8 max-w-3xl mx-auto'></p>
            Buil,d, launch, and scale your software-as-a-service solution with our expert development team. 

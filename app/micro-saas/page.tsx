...
=======
    ...
    { 
      ...
      category: 'Smart Home', 
      price: '$149/mo',
      description: 'AI-powered smart home automation with voice control, energy optimization, and predictive maintenance',
      features: ['Voice Control', 'Energy Optimization', 'Predictive Maintenance', 'Security Integration', 'Climate Control', 'Lighting Automation', 'Appliance Management', 'Energy Analytics'],
      popular: true,
      rating: 4.8,
      users: '3,200+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-smart-home-controller',
      capabilities: ['40% energy savings', 'Voice-controlled automation', 'Predictive maintenance', 'Smart security integration']
    },
    { 
      name: 'AI Personal Fitness Coach Pro', 
      href: '/ai-personal-fitness-coach', 
      icon: Users, 
      category: 'Health & Fitness', 
      price: '$79/mo',
      description: 'Personalized AI fitness coaching with workout plans, nutrition guidance, and progress tracking',
      features: ['Personalized Workouts', 'Nutrition Planning', 'Progress Tracking', 'Form Analysis', 'Goal Setting', 'Wearable Integration', 'Social Features', 'Health Analytics'],
      popular: true,
      rating: 4.7,
      users: '5,800+',
      trial: '7-day free trial',
      link: 'https://ziontechgroup.com/ai-personal-fitness-coach',
      capabilities: ['Personalized fitness plans', 'Real-time form analysis', 'Nutrition optimization', 'Progress tracking']
    },
    { 
      ...
      category: 'Education', 
      price: '$59/mo',
      description: 'AI-powered language learning with personalized lessons, pronunciation training, and conversation practice',
      features: ['Personalized Lessons', 'Pronunciation Training', 'Conversation Practice', 'Grammar Analysis', 'Vocabulary Building', 'Progress Tracking', 'Multi-language Support', 'Speech Recognition'],
      popular: true,
      rating: 4.9,
      users: '8,500+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-language-learning',
      capabilities: ['Faster language acquisition', 'Accurate pronunciation', 'Personalized learning', 'Real-time feedback']
    },
    { 
      ...
      price: '$39/mo',
      description: 'AI-powered recipe creation with dietary restrictions, ingredient optimization, and nutritional analysis',
      features: ['Recipe Generation', 'Dietary Restrictions', 'Ingredient Optimization', 'Nutritional Analysis', 'Meal Planning', 'Shopping Lists', 'Cooking Instructions', 'Allergy Alerts'],
      popular: true,
      rating: 4.6,
      users: '4,200+',
      trial: '7-day free trial',
      link: 'https://ziontechgroup.com/ai-recipe-generator',
      capabilities: ['Personalized recipes', 'Nutritional optimization', 'Dietary compliance', 'Smart meal planning']
    },
    { 
      ...
      features: ['Itinerary Planning', 'Budget Optimization', 'Real-time Updates', 'Weather Integration', 'Local Recommendations', 'Booking Management', 'Travel Alerts', 'Expense Tracking'],
      popular: true,
      rating: 4.8,
      users: '2,900+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-travel-planner',
      capabilities: ['Optimized itineraries', 'Budget savings', 'Real-time updates', 'Personalized recommendations']
    },
    { 
      name: 'AI Personal Finance Manager', 
      href: '/ai-personal-finance-manager', 
      icon: DollarSign, 
      category: 'Finance', 
      price: '$69/mo',
      description: 'AI-powered personal finance management with budgeting, investment advice, and expense tracking',
      features: ['Budget Management', 'Investment Advice', 'Expense Tracking', 'Bill Reminders', 'Savings Goals', 'Credit Monitoring', 'Tax Planning', 'Financial Insights'],
      popular: true,
      rating: 4.7,
      users: '6,100+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-personal-finance-manager',
      capabilities: ['Smart budgeting', 'Investment optimization', 'Expense categorization', 'Financial goal tracking']
    },
    { 
      name: 'AI Home Security Monitor', 
      href: '/ai-home-security-monitor', 
      icon: Shield, 
      category: 'Security', 
      price: '$89/mo',
      description: 'AI-powered home security with facial recognition, motion detection, and automated alerts',
      features: ['Facial Recognition', 'Motion Detection', 'Automated Alerts', 'Video Analytics', 'Mobile App', 'Cloud Storage', 'Night Vision', 'Two-way Audio'],
      popular: true,
      rating: 4.8,
      users: '3,700+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-home-security-monitor',
      capabilities: ['Advanced threat detection', 'Facial recognition', 'Automated monitoring', 'Real-time alerts']
    },
    { 
      name: 'AI Garden Assistant Pro', 
      href: '/ai-garden-assistant', 
      icon: Sprout, 
      category: 'Gardening', 
      price: '$49/mo',
      description: 'AI-powered gardening assistant with plant care guidance, pest detection, and growth optimization',
      features: ['Plant Care Guidance', 'Pest Detection', 'Growth Optimization', 'Watering Schedules', 'Fertilizer Recommendations', 'Weather Integration', 'Plant Identification', 'Garden Planning'],
      popular: false,
      rating: 4.5,
      users: '1,800+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-garden-assistant',
      capabilities: ['Plant health monitoring', 'Pest detection', 'Growth optimization', 'Smart watering']
    },
    { 
      name: 'AI Pet Care Assistant', 
      href: '/ai-pet-care-assistant', 
      icon: Heart, 
      category: 'Pet Care', 
      price: '$59/mo',
      description: 'AI-powered pet care with health monitoring, feeding schedules, and behavior analysis',
      features: ['Health Monitoring', 'Feeding Schedules', 'Behavior Analysis', 'Vet Reminders', 'Exercise Tracking', 'Nutrition Planning', 'Emergency Alerts', 'Pet Profiles'],
      popular: true,
      rating: 4.7,
      users: '2,400+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-pet-care-assistant',
      capabilities: ['Health monitoring', 'Behavioral insights', 'Automated care', 'Emergency alerts']
    },
    { 
      ...
      category: 'Wellness', 
      price: '$39/mo',
      description: 'AI-powered meditation and wellness coaching with personalized sessions and stress management',
      features: ['Personalized Sessions', 'Stress Management', 'Sleep Optimization', 'Mood Tracking', 'Breathing Exercises', 'Guided Meditations', 'Progress Analytics', 'Wellness Plans'],
      popular: true,
      rating: 4.8,
      users: '4,600+',
      trial: '7-day free trial',
      link: 'https://ziontechgroup.com/ai-meditation-wellness',
      capabilities: ['Personalized wellness', 'Stress reduction', 'Sleep improvement', 'Mood tracking']
    },
    { 
      ...
      category: 'Education', 
      price: '$79/mo',
      description: 'AI-powered study assistant with personalized learning plans, note-taking, and exam preparation',
      features: ['Personalized Learning', 'Note-taking AI', 'Exam Preparation', 'Flashcard Generation', 'Progress Tracking', 'Study Schedules', 'Subject Analysis', 'Performance Insights'],
      popular: true,
      rating: 4.9,
      users: '7,200+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-study-assistant',
      capabilities: ['Personalized learning', 'Smart note-taking', 'Exam preparation', 'Progress optimization']
    },
    { 
      ...
      features: ['Outfit Recommendations', 'Color Analysis', 'Wardrobe Optimization', 'Style Matching', 'Occasion Dressing', 'Trend Analysis', 'Shopping Lists', 'Style Evolution'],
      popular: true,
      rating: 4.6,
      users: '3,100+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-personal-stylist',
      capabilities: ['Personalized styling', 'Color coordination', 'Wardrobe optimization', 'Trend analysis']
    },
    { 
      ...
      category: 'Health', 
      price: '$49/mo',
      description: 'AI-powered sleep optimization with sleep tracking, environment control, and sleep quality improvement',
      features: ['Sleep Tracking', 'Environment Control', 'Sleep Quality Analysis', 'Bedtime Optimization', 'Wake-up Optimization', 'Sleep Coaching', 'Progress Tracking', 'Health Integration'],
      popular: true,
      rating: 4.7,
      users: '5,300+',
      trial: '7-day free trial',
      link: 'https://ziontechgroup.com/ai-sleep-optimizer',
      capabilities: ['Sleep quality improvement', 'Environment optimization', 'Sleep coaching', 'Health insights']
    },
    { 
      ...
      category: 'Fitness', 
      price: '$89/mo',
      description: 'AI-powered personal training with workout customization, form analysis, and performance tracking',
      features: ['Workout Customization', 'Form Analysis', 'Performance Tracking', 'Nutrition Guidance', 'Injury Prevention', 'Goal Setting', 'Progress Analytics', 'Video Coaching'],
      popular: true,
      rating: 4.8,
      users: '4,800+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-personal-trainer',
      capabilities: ['Personalized training', 'Form correction', 'Performance optimization', 'Injury prevention']
    },
    { 
      name: 'AI Memory Palace Builder', 
      href: '/ai-memory-palace', 
      icon: Brain, 
      category: 'Productivity', 
      price: '$59/mo',
      description: 'AI-powered memory enhancement with spatial memory techniques and cognitive training',
      features: ['Spatial Memory Training', 'Cognitive Exercises', 'Memory Palace Creation', 'Recall Practice', 'Progress Tracking', 'Brain Training', 'Memory Games', 'Performance Analytics'],
      popular: false,
      rating: 4.6,
      users: '1,900+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-memory-palace',
      capabilities: ['Memory enhancement', 'Cognitive training', 'Spatial memory', 'Recall improvement']
    },
    { 
      name: 'AI Habit Tracker Pro', 
      href: '/ai-habit-tracker', 
      icon: Target, 
      category: 'Productivity', 
      price: '$29/mo',
      description: 'AI-powered habit tracking with smart reminders, progress analysis, and behavior optimization',
      features: ['Smart Reminders', 'Progress Analysis', 'Behavior Optimization', 'Habit Streaks', 'Goal Setting', 'Motivation System', 'Analytics Dashboard', 'Social Features'],
      popular: true,
      rating: 4.7,
      users: '6,500+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-habit-tracker',
      capabilities: ['Habit formation', 'Progress tracking', 'Behavior optimization', 'Motivation system']
    },
    { 
      ...
      category: 'Food', 
      price: '$79/mo',
      description: 'AI-powered personal chef with meal planning, cooking guidance, and dietary optimization',
      features: ['Meal Planning', 'Cooking Guidance', 'Dietary Optimization', 'Ingredient Substitution', 'Nutritional Analysis', 'Shopping Lists', 'Cooking Timers', 'Recipe Scaling'],
      popular: true,
      rating: 4.8,
      users: '3,400+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-personal-chef',
      capabilities: ['Personalized meal plans', 'Cooking guidance', 'Dietary compliance', 'Nutrition optimization']
    },
    { 
      name: 'AI Personal Shopper Pro', 
      href: '/ai-personal-shopper', 
      icon: ShoppingCart, 
      category: 'Shopping', 
      price: '$49/mo',
      description: 'AI-powered personal shopping with product recommendations, price tracking, and deal alerts',
      features: ['Product Recommendations', 'Price Tracking', 'Deal Alerts', 'Wishlist Management', 'Size Recommendations', 'Style Matching', 'Budget Management', 'Purchase History'],
      popular: true,
      rating: 4.6,
      users: '4,100+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-personal-shopper',
      capabilities: ['Smart recommendations', 'Price optimization', 'Deal discovery', 'Style matching']
    },
    { 
      ...
      features: ['Task Management', 'Smart Scheduling', 'Email Management', 'Calendar Integration', 'Reminder System', 'Voice Commands', 'Automation Rules', 'Learning Adaptation'],
      popular: true,
      rating: 4.9,
      users: '8,200+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-personal-assistant',
      capabilities: ['Task automation', 'Smart scheduling', 'Voice control', 'Learning adaptation']
    },
    { 
      name: 'AI Personal Coach Pro', 
      href: '/ai-personal-coach', 
      icon: Users, 
      category: 'Coaching', 
      price: '$149/mo',
      description: 'AI-powered personal coaching with goal setting, progress tracking, and motivational support',
      features: ['Goal Setting', 'Progress Tracking', 'Motivational Support', 'Action Planning', 'Habit Building', 'Performance Analysis', 'Coaching Sessions', 'Success Metrics'],
      popular: true,
      rating: 4.8,
      users: '2,700+',
      trial: '21-day free trial',
      link: 'https://ziontechgroup.com/ai-personal-coach',
      capabilities: ['Goal achievement', 'Progress tracking', 'Motivational support', 'Performance optimization']
    },
    { 
      name: 'AI Personal Therapist Pro', 
      href: '/ai-personal-therapist', 
      icon: Heart, 
      category: 'Mental Health', 
      price: '$199/mo',
      description: 'AI-powered mental health support with mood tracking, therapy sessions, and wellness guidance',
      features: ['Mood Tracking', 'Therapy Sessions', 'Wellness Guidance', 'Stress Management', 'Anxiety Support', 'Depression Monitoring', 'Progress Tracking', 'Crisis Support'],
      popular: true,
      rating: 4.7,
      users: '1,800+',
      trial: '30-day free trial',
      link: 'https://ziontechgroup.com/ai-personal-therapist',
      capabilities: ['Mental health support', 'Mood tracking', 'Therapy sessions', 'Wellness guidance']
    },
    { 
      name: 'AI Personal Nutritionist Pro', 
      href: '/ai-personal-nutritionist', 
      icon: Scale, 
      category: 'Health', 
      price: '$89/mo',
      description: 'AI-powered nutrition planning with meal recommendations, dietary analysis, and health optimization',
      features: ['Meal Recommendations', 'Dietary Analysis', 'Health Optimization', 'Allergy Management', 'Weight Management', 'Supplement Guidance', 'Progress Tracking', 'Health Integration'],
      popular: true,
      rating: 4.8,
      users: '5,600+',
      trial: '14-day free trial',
      link: 'https://ziontechgroup.com/ai-personal-nutritionist',
      capabilities: ['Personalized nutrition', 'Health optimization', 'Dietary compliance', 'Weight management']
    }
  ];

  const categories = ['All', 'Productivity', 'Content', 'Marketing', 'Business', 'Finance', 'Development', 'Security', 'Healthcare', 'Legal', 'E-commerce', 'HR', 'AI Tools', 'Document Management', 'Communication', 'Web Development', 'Analytics', 'Email Tools', 'Design', 'Social Media', 'Space Tech', 'Climate Tech', 'Science', 'Computing', 'Transportation', 'Optimization', 'Education', 'Smart Home', 'Health & Fitness', 'Food & Cooking', 'Travel', 'Gardening', 'Pet Care', 'Wellness', 'Fashion', 'Health', 'Fitness', 'Coaching', 'Mental Health', 'Food', 'Shopping'];
>>>>>>> cursor/enhance-app-with-new-services-and-futuristic-design-c63e

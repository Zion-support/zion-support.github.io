...
const MicroSaasPage: React.FC = () => {
  ...
  const microSaasTools = [
    ...
    },
    {
      ...
      description: 'Intelligent HR management platform with AI-powered recruitment, employee analytics, and automated workflows.',
      features: ['AI Resume Screening', 'Candidate Matching', 'Interview Scheduling', 'Employee Performance Analytics', 'Automated Onboarding', 'Skills Assessment', 'Compliance Management', 'Payroll Integration'],
      price: '$129/month',
      marketPrice: '$300-800/month',
      benefits: ['Reduce hiring time by 60%', 'Improve candidate quality', 'Automated HR processes', 'Better employee insights'],
      icon: Users,
      category: 'hr',
      link: 'https://ziontechgroup.com/zion-ai-hr-assistant-pro'
    },
    {
      title: 'Zion AI Accounting Suite',
      description: 'Comprehensive AI-powered accounting platform with automated bookkeeping, tax preparation, and financial forecasting.',
      features: ['Automated Bookkeeping', 'AI Tax Preparation', 'Financial Forecasting', 'Expense Categorization', 'Invoice Processing', 'Bank Reconciliation', 'Compliance Reporting', 'Multi-currency Support'],
      price: '$149/month',
      marketPrice: '$400-1000/month',
      benefits: ['Save 90% bookkeeping time', 'Automated tax filing', 'Real-time financial insights', 'Compliance assurance'],
      icon: DollarSign,
      category: 'finance',
    ...
    },
    {
      ...
      features: ['AI Demand Forecasting', 'Automated Reordering', 'Supply Chain Optimization', 'Real-time Inventory Tracking', 'Supplier Management', 'Cost Analysis', 'Multi-location Support', 'Integration APIs'],
      price: '$99/month',
      marketPrice: '$250-600/month',
      benefits: ['Reduce inventory costs by 30%', 'Prevent stockouts', 'Optimize supply chain', 'Real-time visibility'],
      icon: BarChart3,
      category: 'inventory',
    ...
    },
    {
      ...
      features: ['Contract Analysis', 'Legal Document Review', 'Compliance Monitoring', 'Risk Assessment', 'Document Templates', 'Legal Research', 'Case Law Analysis', 'Client Portal'],
      price: '$199/month',
      marketPrice: '$500-1500/month',
      benefits: ['Reduce legal review time by 80%', 'Improve accuracy', 'Compliance assurance', 'Cost savings'],
      icon: Shield,
      category: 'legal',
    ...
    },
    {
      ...
      description: 'HIPAA-compliant healthcare analytics platform with patient insights, treatment optimization, and predictive diagnostics.',
      features: ['Patient Analytics', 'Treatment Optimization', 'Predictive Diagnostics', 'HIPAA Compliance', 'Medical Image Analysis', 'Drug Interaction Checking', 'Clinical Decision Support', 'Electronic Health Records Integration'],
      price: '$299/month',
      marketPrice: '$800-2000/month',
      benefits: ['Improve patient outcomes', 'Reduce diagnostic errors', 'Optimize treatments', 'Compliance ready'],
      icon: Shield,
      category: 'healthcare',
      link: 'https://ziontechgroup.com/zion-ai-healthcare-analytics'
    }
  ]
  ...
  const categories = [
    ...
    { id: 'hr', name: 'HR & Recruitment', count: microSaasTools.filter(t => t.category === 'hr').length },
    { id: 'inventory', name: 'Inventory Management', count: microSaasTools.filter(t => t.category === 'inventory').length },
    { id: 'legal', name: 'Legal & Compliance', count: microSaasTools.filter(t => t.category === 'legal').length },
    { id: 'healthcare', name: 'Healthcare', count: microSaasTools.filter(t => t.category === 'healthcare').length }
  ]

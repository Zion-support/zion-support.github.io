...
const PageComponent: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Micro SaaS - Zion Tech Group | Micro SaaS Solutions</title>
        <meta name="description" content="Discover our micro SaaS solutions designed for small and medium businesses." />
        <meta name="keywords" content="micro saas, small business, software solutions" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Discover our micro SaaS solutions designed for small and medium businesses.
              </p>

...
const MicroSaasPage: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      name: 'Zion Social Scheduler Pro',
    ...
    },
    {
      ...
      description: 'Advanced time tracking with productivity analytics and team management features.',
      price: '$39/month',
    ...
    },
    {
      ...
      description: 'Drag-and-drop form builder with advanced logic, payments, and analytics.',
      price: '$49/month',
      marketPrice: '$100-300/month',
      features: [
    ...
    {
      id: 'zion-survey-tool',
      name: 'Zion Survey Tool',
      description: 'Advanced survey creation with AI-powered insights and automated reporting.',
      price: '$59/month',
    ...
    {
      id: 'zion-document-signer',
      name: 'Zion Document Signer',
      description: 'Electronic signature solution with document management and workflow automation.',
      price: '$39/month',
      ...
      popular: false,
      icon: FileText,
      link: 'https://sign.ziontechgroup.com'
    },
    {
      id: 'zion-video-conferencing',
      name: 'Zion Video Conferencing',
      description: 'Professional video conferencing with AI features, recording, and collaboration tools.',
      price: '$99/month',
      ...
      popular: true,
      icon: Video,
      link: 'https://meet.ziontechgroup.com'
    },
    {
      id: 'zion-task-manager',
      name: 'Zion Task Manager',
      ...
      popular: true,
      icon: CheckSquare,
      link: 'https://tasks.ziontechgroup.com'
    },
    {
      id: 'zion-customer-feedback',
      name: 'Zion Customer Feedback',
      description: 'Comprehensive feedback collection and analysis platform with sentiment analysis.',
      price: '$69/month',
      marketPrice: '$150-400/month',
      features: [
        'Feedback collection',
    ...
    },
    {
      ...
      description: 'Complete API management platform with monitoring, security, and analytics.',
      price: '$149/month',
      marketPrice: '$300-800/month',
      features: [
        'API gateway',
    ...
    {
      id: 'zion-email-verifier',
      name: 'Zion Email Verifier',
      description: 'Advanced email validation and verification service with real-time checking.',
      price: '$29/month',
      ...
      popular: false,
      icon: Mail,
      link: 'https://verify.ziontechgroup.com'
    },
    {
      id: 'zion-website-monitor',
      name: 'Zion Website Monitor',
      description: 'Comprehensive website monitoring with uptime tracking and performance analytics.',
      price: '$49/month',
      marketPrice: '$100-300/month',
      features: [
        'Uptime monitoring',
    ...
    },
    {
      ...
      description: 'AI-powered live chat widget with automated responses and team handoff.',
      price: '$39/month',
      marketPrice: '$80-250/month',
      features: [
        'Live chat widget',
    ...
    {
      id: 'zion-file-converter',
      name: 'Zion File Converter',
      description: 'Advanced file conversion service supporting 100+ formats with batch processing.',
      price: '$19/month',
      marketPrice: '$40-120/month',
      features: [
        '100+ file formats',
      ...
      popular: false,
      icon: FileText,
      link: 'https://convert.ziontechgroup.com'
    },
    {
      id: 'zion-qr-generator',
      name: 'Zion QR Generator',
      description: 'Professional QR code generator with analytics, customization, and bulk creation.',
      price: '$29/month',
      marketPrice: '$60-180/month',
      features: [
        'QR code generation',
      ...
      popular: false,
      icon: QrCode,
      link: 'https://qr.ziontechgroup.com'
    },
    {
      id: 'zion-screenshot-tool',
      name: 'Zion Screenshot Tool',
      description: 'Advanced screenshot and screen recording tool with annotation and sharing features.',
      price: '$19/month',
      marketPrice: '$40-120/month',
      features: [
        'Screenshot capture',
      ...
      popular: false,
      icon: Camera,
      link: 'https://screenshot.ziontechgroup.com'
    },
    {
      id: 'zion-url-shortener',
      name: 'Zion URL Shortener',
      description: 'Professional URL shortening service with analytics, customization, and team management.',
      price: '$19/month',
      marketPrice: '$40-120/month',
      features: [
        'URL shortening',
      ...
      popular: false,
      icon: Link,
      link: 'https://short.ziontechgroup.com'
    },
    {
      id: 'zion-color-palette',
      name: 'Zion Color Palette',
      description: 'AI-powered color palette generator with accessibility checking and brand integration.',
      price: '$29/month',
      marketPrice: '$60-180/month',
      features: [
        'AI color generation',
      ...
      popular: false,
      icon: Palette,
      link: 'https://colors.ziontechgroup.com'
    },
    {
      id: 'zion-font-finder',
      name: 'Zion Font Finder',
      description: 'AI-powered font identification and recommendation service with licensing information.',
      price: '$39/month',
      marketPrice: '$80-250/month',
      features: [
        'Font identification',
      ...
      popular: false,
      icon: Type,
      link: 'https://fonts.ziontechgroup.com'
    },
    {
      id: 'zion-gradient-generator',
      name: 'Zion Gradient Generator',
      description: 'Advanced gradient generator with CSS export, animation, and team collaboration.',
      price: '$19/month',
      marketPrice: '$40-120/month',
      features: [
        'Gradient generation',
      ...
      popular: false,
      icon: Palette,
      link: 'https://gradients.ziontechgroup.com'
    }
  ];
  ...
  const categories = [
    ...
    { id: 'Forms', name: 'Forms', count: services.filter(s => s.category === 'Forms').length },

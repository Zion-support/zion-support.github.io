                 ...
                 />
                  ...
                  <div className="text-center mb-6" />
                    <div className="flex items-center justify-center space-x-2 mb-2" />
                      <span className="text-3 xl font-bold text-white"  >{product.price}</span>
                      <span className="text-lg text-gray-400 line-through"  >{product.originalPrice}</span>
                    </div>
                    <span className="text-sm text-green-400 font-semibold"  />Save {Math.round((1 - parseInt(product.price.replace('$', '')) / parseInt(product.originalPrice.replace('$', ''))) * 100)}%
                    </span>
                  </div>
                  ...
                  <div className="space-y-3 mb-6" />
                    ...
                    {product.features.length > 4 && (
                      <div className="text-sm text-gray-400 text-center"  />+{product.features.length - 4} more features
                      </div>
                    )}
                  </div>

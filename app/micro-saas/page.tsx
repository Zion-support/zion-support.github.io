...
const MicroSaasPage = () => {
  const microSaasServices = [
    ...
    {
      id: 'ai-smart-inventory-optimizer',
      name: 'AI Smart Inventory Optimizer',
      ...
      popular: true,
      link: '/ai-smart-inventory-optimizer',
  ...
  const categories = [
    ...
    { name: 'AI Inventory', count: microSaasServices.filter(s => s.category.includes('Inventory')).length, color: 'from-indigo-500 to-purple-500' },

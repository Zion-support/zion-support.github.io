...
const MicroSAASPage: React.FC = () => {
  ...
  const microSAASServices = [
    ...
    { 
      ...
      capabilities: ['50% faster hiring process', '90% resume accuracy', 'Automated onboarding', 'Performance insights']
    },
    { 
      ...
      category: 'Design', 
      price: '$79/mo',
      description: 'AI-powered logo design with brand analysis and custom creation',
      features: ['Brand Analysis', 'Logo Generation', 'Color Palette', 'Font Matching', 'Vector Export', 'Brand Guidelines'],
      popular: true,
      rating: 4.6,
      users: '1,500+',
      trial: '7-day free trial',
      link: 'https://ziontechgroup.com/ai-logo-designer',
      capabilities: ['95% brand consistency', 'Unlimited revisions', 'Professional quality', 'Instant delivery']
    },
    { 

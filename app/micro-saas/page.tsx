...
const MicroSaasPage: React.FC = () => {
  ...
  const _products = [
    ...
    },
    {
      ...
      description:
        "Comprehensive analytics and reporting tool for small to medium businesses.",
      category: "analytics",
      icon: TrendingUp,
      features: [
        "Real-time metrics",
    ...
    },
    {
      ...
      description:
        "Streamline team communication and project management with our all-in-one platform.",
    ...
    },
    {
      ...
      description:
        "Advanced security monitoring and threat detection for your digital assets.",
      category: "security",
      icon: Shield,
      features: [
        "Threat detection",
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <section className="py-20 px-4">
          ...
          </div><div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-blue-600 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
          
          </div><product.icon className="w-8 h-8 text-white" />
        <div className="flex items-center gap-2">
          ...
          </div><div className="flex items-center gap-4 text-gray-300 text-sm">
        ...
        <section className="py-20 px-4 bg-white/5">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
                ...
                Our micro SaaS products are helping businesses worldwide achieve
                their goals.
              </p>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          </div><div className="text-4xl font-bold text-purple-400 mb-2">
                  10K+
        
          </div><div className="text-gray-300">Active Users
          ...
          </div><div className="text-gray-300">Products
          ...
          </div><div className="text-gray-300">Uptime
          ...
          </div><div className="text-gray-300">Average Rating
        </div>
      </div>{" "}
        </div>
      </div>
        ...
        <section className="py-20 px-4">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
              ...
              Choose from our collection of micro SaaS products and start

...
>>>>>>> cursor/analyze-improve-and-deploy-application-7116
    ...
    { 
      ...
      category: 'Legal AI', 
      price: '$2,800/mo',
      description: 'Intelligent legal research with AI-powered case analysis and precedent discovery',
      features: ['Case Analysis', 'Precedent Discovery', 'Legal Research', 'Document Analysis', 'Compliance Checking', 'Contract Review', 'Legal Writing', 'Citation Analysis'],
      popular: false,
      rating: 4.8,
      users: '400+',
      trial: '21-day free trial',
      link: 'https://ziontechgroup.com/ai-legal-research-pro',
      capabilities: ['90% faster research', 'Comprehensive case analysis', 'Precedent discovery', 'Legal writing assistance']
    },
    { 
      ...
      features: ['Crop Monitoring', 'Yield Optimization', 'Pest Detection', 'Weather Analysis', 'Soil Analysis', 'Irrigation Management', 'Harvest Planning', 'Market Analysis'],
      popular: true,
      rating: 4.7,
      users: '600+',
      trial: '30-day free trial',
      link: 'https://ziontechgroup.com/ai-agricultural-intelligence-pro',
      capabilities: ['25% yield increase', 'Smart irrigation', 'Pest prevention', 'Weather prediction']
    },
    { 
      ...
      features: ['Fraud Detection', 'Risk Assessment', 'Compliance Monitoring', 'Transaction Analysis', 'Pattern Recognition', 'Alert System', 'Investigation Tools', 'Regulatory Reporting'],
      popular: true,
      rating: 4.9,
      users: '1,200+',
      trial: '21-day free trial',
      link: 'https://ziontechgroup.com/ai-financial-crime-detection-pro',
      capabilities: ['99.9% fraud detection', 'Real-time monitoring', 'Compliance automation', 'Risk mitigation']
    }
  ];

  const categories = ['All', 'Productivity', 'Content', 'Marketing', 'Business', 'Finance', 'Development', 'Security', 'Healthcare', 'Legal', 'E-commerce', 'HR', 'Creative', 'Computer Vision', 'Manufacturing', 'Insurance', 'Testing', 'Education', 'Health', 'Analytics', 'Industrial', 'Language', 'Design', 'Email Tools', 'Social Media', 'Immersive Tech', 'Autonomous AI', 'Blockchain AI', 'Energy AI', 'Space Tech', 'Environmental AI', 'Pharma AI', 'Quantum Finance', 'Advanced AI', 'Fashion Tech', 'Creative AI', 'Energy Tech', 'Autonomous Systems', 'Supply Chain AI', 'Legal AI', 'AgTech AI', 'Financial AI'];
      icon: Palette, 
      category: 'Design', 
      price: '$79/mo',
      description: 'AI-powered logo design with brand analysis, multiple variations, and professional quality output',

              ...
              {filteredProducts.map((product, index) => (
                <div key={index} className="bg-slate-800/50 rounded-lg p-6 hover:bg-slate-800/70 transition-all duration-300 group">
                  ...
                  <div className="mb-4">
                    ...
                    {product.marketPrice && (
                      <div className="text-sm text-gray-500">
                        Market price: <span className="line-through">{product.marketPrice}</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="flex space-x-2">
                    <a
                      href="/contact"
                      className="flex-1 bg-slate-700 hover:bg-slate-600 text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 text-center flex items-center justify-center"
                    >
                      Learn More
            ...
            <div className="text-center">
              <div className="bg-slate-800/50 rounded-lg p-8">
                ...
                <p className="text-gray-300 mb-6">
                  Choose from our collection of micro SaaS tools and start automating your business today.
                </p>

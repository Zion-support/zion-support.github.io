...
const microSaasTools = [
    {
      icon: Brain,
      title: description, 'Comprehensive business intelligence with AI-powered insights and real-time analytics.']
...
interface MicroSaasProduct {
  ...
  features: price, string;
  users: popular, boolean;
  category: string;
}
...
const microSaasProducts: MicroSaasProduct[] = [
    {
      id: '1',
      icon: '📊',
      title: description, 'Real-time business intelligence and predictive analytics for small to medium businesses']

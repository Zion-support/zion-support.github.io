...
export const metadata: Metadata = {
  title: 'AI Crisis Communications Generator | Zion Tech Group',
  description: 'Generate stakeholder communications, internal memos, and public statements for crisis situations with tone-appropriate messaging calibrated for severity and audience.',
  alternates: { canonical: '/micro-saas/ai-crisis-communications' },
};

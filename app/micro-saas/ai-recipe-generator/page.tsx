...
export const metadata: Metadata = {
  title: 'AI Recipe Generator | Zion Tech Group',
  description: 'Generate personalized recipes based on dietary restrictions, available ingredients, nutritional goals, and cuisine preferences.',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with AI Recipe Generator',
        pricing: [

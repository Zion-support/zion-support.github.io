...
export const metadata: Metadata = {
  ...
  description:
    'Expense Tracker streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focu',
  alternates: { canonical: '/micro-saas/expense-tracker' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Expense Tracker streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Expense Tracker',
      }}
    />
  );
}

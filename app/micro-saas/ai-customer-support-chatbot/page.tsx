...
;
exportdefaultfunctionAICustomerSupportChatbotPage() {constfeatures = [{
  ...
  consttestimonials = [{name: 'AmandaFoster',;
  ...
  constbenefits = [{icon: <ClockclassName="w-8h-8t e xt-cyan-400" />,;
  ...
  constuseCases = [{title: 'FAQAutomation',;

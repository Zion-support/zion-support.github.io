...
export default function AICustomerSupportChatbotPage() {
  ...
  return (
      ...
      {/* Hero Section */
          ...
          {/* Key Stats */
              ...
              <div className="text-3xl font-boldtext-cyan-400mb-2">70%</div>
              <div className="text-gray-300text-sm">Faster Resolution</div>
              <div className="text-3xl font-boldtext-purple-400mb-2">98%</div>
              ...
              <div className="text-3xl font-boldtext-emerald-400mb-2">30 K+</div>
 ...
 (
                  ...
                  <h3 className="text-xl font-bold text-whitegroup-hover:text-cyan-400transition-colors">{useCase.title</h3>
                  {useCase.description
    </h3>
                <div className="text-cyan-400 text-smfont-semiboldtext-center">{useCase.benefit</div>
            ))

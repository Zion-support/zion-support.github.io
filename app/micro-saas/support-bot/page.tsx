...
const SmartSupportBotPage: React.FC = () => {
  return (
    <React> </React><Helmet> </Helmet><title>Smart Support Bot | Zion Tech Group - AI Customer Service Automation</title>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
        <section> </section><div className="max-w-7xl mx-auto text-center"></div>
            <div className="inline-flex items-center space-x-2 bg-green-500/20 text-green-400 px-4 py-2 rounded-full text-sm font-medium mb-6"></div>
              <Bot> </Bot><span>Smart Support Bot</span>
            </div>
            <h1>AI Customer Service </h1></h1>
...
const SmartSupportBotPage: React.FC = () => {
  return (
    <></>
      <Helmet> </Helmet><title>Smart Support Bot | Zion Tech Group - AI Customer Service Automation</title>
        <meta> </meta><link> </link></Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>

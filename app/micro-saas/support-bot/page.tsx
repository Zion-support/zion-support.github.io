  ...
  return (
    <>
      <Helmet></Helmet>
        ...
        <meta name="description" content="AI-powered customer service automation with intelligent support bot. 24/7 customer assistance and automated responses." /> " <link rel="canonical" href="https://ziontechgroup.com/micro-saas/support-bot" />"
      </Helmet>
      <div>
        <section className="pt-24 pb-16 px-4"></section>"
          <div>
            <div>
              <Bot className="w-4 h-4" /> " <span>Smart Support Bot</span>"
            </div>

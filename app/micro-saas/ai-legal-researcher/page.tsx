...
export const metadata: Metadata = {
  title: 'AI Legal Research Assistant | Zion Tech Group',
  ...
  alternates: { canonical: '/micro-saas/ai-legal-researcher' },
};
    ...
    <ProductPageLayout
      data={{
        ...
        pricing: [
          ...
          { tier: 'Professional', price: '$99', period: '/month', features: ['All Starter', 'Up to 25 users', 'Advanced analytics', 'Priority support', 'API access'] },
          { tier: 'Enterprise', price: '$249', period: '/month', features: ['Everything in Pro', 'Unlimited users', 'Custom workflows', '24/7 support', 'SLA', 'SSO'] },
        ],
        contact: {

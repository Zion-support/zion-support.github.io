...
export const metadata: Metadata = {
  title: 'AI Compliance Checklist Builder | Zion Tech Group',
  description: 'Build compliance checklists for SOC 2, ISO 27001, HIPAA, GDPR, and PCI DSS with AI-guided questionnaires, gap analysis, and automated evidence collection workflows.',
  alternates: { canonical: '/micro-saas/ai-compliance-checklist' },
};

...
const AITaskManagerPage: React.FC = () => {
  ...
  const pricingPlans = ['
    {''
      ...
      features: [''
        'Unlimited tasks',AI prioritization',''
        'Smart scheduling',Basic analytics',''
        'Cross-platform sync',Email support'
      ],
      popular: false
    },'
    {''
      ...
      features: [''
        'Everything in Personal',Advanced analytics',''
    ...
    {''
      ...
      features: [''
        'Everything in Professional',Advanced team features',''
        'Enterprise security',Custom AI training',''
  ...
  return (
    <>
      <Helmet></Helmet>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/micro-saas/ai-task-manager" /></link>
      </Helmet>

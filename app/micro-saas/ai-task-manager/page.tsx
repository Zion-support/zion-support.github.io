...
const AITaskManagerPage: React.FC = () => {
  ...
  const pricingPlans  = [
    {name: 'Personal','"'""
      ...
      features: [
        'Unlimited tasks','"'AI prioritization','"'Smart scheduling','"'Basic analytics','"'Cross-platform sync','"'Email support'"''
      ],
      popular: false
      ...
      features: [
        'Everything in Personal','"'Advanced analytics','"'Team collaboration','"'Workflow automation','"'Priority support','"'Custom integrations'"''
      ],
      popular: true
      ...
      features: [
        'Everything in Professional','"'Advanced team features','"'Enterprise security','"'Custom AI training','"'Dedicated support','"'White-label options'"''
      ],
      popular: false

  ]
  const stats  = [{ number: '40%', label: 'Productivity Increase', icon: <Zap className="w-6 h-6 text-cyan-400" /> },'"'";"
    { number: '95%', label: 'Task Completion Rate', icon: <CheckCircle className="w-6 h-6 text-emerald-400" /> },'"'";"
    { number: '2hrs', label: 'Time Saved Daily', icon: <Clock className="w-6 h-6 text-purple-400" /> },'"'";"
    { number: '50K+', label: 'Active Users', icon: <Users className="w-6 h-6 text-orange-400" /> }'"'";"
  ]

    ...
    <ProductPageLayout
      data={{
        ...
        pricing: [
          ...
          { tier: 'Professional', price: '$39', period: '/month', features: ['All Starter', 'Up to 25 users', 'Advanced analytics', 'Priority support', 'API access'] },
          { tier: 'Enterprise', price: '$99', period: '/month', features: ['Everything in Pro', 'Unlimited users', 'Custom workflows', '24/7 support', 'SLA', 'SSO'] },
        ],
        contact: {

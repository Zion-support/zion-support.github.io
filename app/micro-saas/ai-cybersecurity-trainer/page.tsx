...
export const metadata: Metadata = {
  title: 'AI Cybersecurity Training Platform | Zion Tech Group',
  description: 'Interactive AI-driven phishing simulations, security awareness modules, and compliance training with personalized learning paths for employees.',
  alternates: { canonical: '/micro-saas/ai-cybersecurity-trainer' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        category: 'Micro SaaS · Security Awareness',
        description: 'Interactive AI-driven phishing simulations, security awareness modules, and compliance training with personalized learning paths for employees.',
        iconEmoji: '🛡',
        features: [
        ...
        pricing: [
          { tier: 'Starter', price: '$15', period: '/month', features: ['Core AI features', 'Up to 3 users', 'Basic analytics', 'Email support'] },
          { tier: 'Professional', price: '$39', period: '/month', features: ['All Starter features', 'Up to 25 users', 'Advanced analytics', 'Priority support', 'API access'] },
          { tier: 'Enterprise', price: '$99', period: '/month', features: ['Everything in Pro', 'Unlimited users', 'Custom workflows', '24/7 support', 'SLA guarantee', 'SSO'] },
        ],
        contact: {

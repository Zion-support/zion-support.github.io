...
export const metadata: Metadata = {
  title: 'AI Patent Analyzer | Zion Tech Group',
  description: 'Analyze patent landscapes, identify prior art, assess novelty, and generate patent application drafts with AI-powered legal reasoning.',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with AI Patent Analyzer',
        pricing: [

...
export const metadata: Metadata = {
  title: 'AI Language Learning Tutor | Zion Tech Group',
  ...
  alternates: { canonical: '/micro-saas/ai-language-tutor' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        category: 'Micro SaaS - Education and Research',
        description: 'Personalized language tutoring with AI conversation practice, pronunciation feedback, and adaptive lesson planning.',
        iconEmoji: '🌐',
        features: [
        ...
        pricing: [
          ...
          { tier: 'Professional', price: '$29', period: '/month', features: ['All Starter', 'Up to 25 users', 'Advanced analytics', 'Priority support', 'API access'] },
          { tier: 'Enterprise', price: '$69', period: '/month', features: ['Everything in Pro', 'Unlimited users', 'Custom workflows', '24/7 support', 'SLA', 'SSO'] },
        ],
        contact: {

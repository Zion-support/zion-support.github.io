...
export default function ContractManagerPage() {
  ...
  return (
    ...
    <>
      <Helmet >
        <title>Contract Manager - Zion Tech Group</title>
<<<<<<< HEAD
        <meta name="description" content="Professional contract manager services by Zion Tech Group. Transform your business with our expert solutions." />
=======
        <meta name = "description" content="Professional contract manager by Zion Tech Group. Transform your business with our expert solutions." />
>>>>>>> cursor/fix-errors-and-merge-to-main-a79b
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          <h1 className="text-4xl font-bold text-white mb-6">Contract Manager</h1>
<<<<<<< HEAD
          <p className="text-lg text-gray-300 mb-8">Professional contract manager services coming soon.</p>
          <Link
=======
          <p className="text-lg text-gray-300 mb-8">Professional contract manager coming soon.</p>
          <Link >
>>>>>>> cursor/fix-errors-and-merge-to-main-a79b
            to="/contact"
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
        ...
        <section className="w-5h-5ml-2" /></section>
          ...
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
            ...
            <p className="w-5h-5ml-2">Automate contract management with AI-powered insights, smart templates, 
        ...
        <section className="w-5h-5ml-2" /></section>
          ...
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
              ...
              <p className="w-5h-5ml-2">Everything you need to manage contracts efficiently and stay compliant.
              </p>
            </div>
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
        ...
        <section className="w-5h-5ml-2" /></section>
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
              ...
              <p className="w-5h-5ml-2">Choose the plan that fits your business needs. All plans include a 14-day free trial.
              </p>
            </div>
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
        ...
        <section className = "w-5h-5ml-2" /></section>
          ...
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
              ...
              <p className="w-5h-5ml-2">Join thousands of businesses already using our AI-powered contract management solution. 

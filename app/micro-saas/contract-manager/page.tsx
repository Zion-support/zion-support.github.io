...
export const metadata: Metadata = {
  ...
  description:
    'Contract Manager streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to foc',
  alternates: { canonical: '/micro-saas/contract-manager' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Contract Manager streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Contract Manager',
      }}
    />
  );
}

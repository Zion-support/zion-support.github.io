...
const ContractManagerPage: React.FC = () => {
  ...
  return()
    ...
    <>
    <title>
</>ContractManager - Zion Tech Group<>
    </title>
    <h1 className="text-4xl font-bold text-white mb-6">
</>ContractManager<>
    </h1>
    <p className="text-lg text-gray-300 mb-8">
</>Professional contractmanager services coming soon.<>
    </p>
    </>
</>)
  );
    ...
    <Helmet>
        ...
        <title />AI Contract Manager - Smart Contract Management | Zion Tech Group<>
    </title>
    ...
    <h1 className="w-5h-5ml-2" />
              ...
              Smart <span className="w-5h-5ml-2" />Contract Manager<>
    </span>
    </h1>
</>
    ...
    <h2 className="w-5h-5ml-2" />
                ...
                Ready to Streamline Your <span className="w-5h-5ml-2" />Contract Management?<>
    </span>
    </h2>
</>

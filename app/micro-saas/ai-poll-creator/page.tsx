...
export const metadata: Metadata = {
  title: 'AI Poll & Survey Creator | Zion Tech Group',
  description: 'Generate research-grade surveys and polls with AI-optimized question design, unbiased response options, skip logic, and statistical analysis built in for actionable insights.',
  alternates: { canonical: '/micro-saas/ai-poll-creator' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with AI Poll & Survey Creator',
        pricing: [

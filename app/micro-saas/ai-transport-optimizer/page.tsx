  ...
  return (
    <ProductPageLayout
      data={{
        ...
        category: 'Micro SaaS - Supply Chain and Logistics',
        description: 'AI-powered route optimization for fleets, last-mile delivery scheduling, and real-time traffic adaptation.',
        iconEmoji: '🚛',
        features: [

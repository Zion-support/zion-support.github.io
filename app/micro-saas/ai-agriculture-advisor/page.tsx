...
export const metadata: Metadata = {
  title: 'AI Agriculture and Crop Management | Zion Tech Group',
  ...
  alternates: { canonical: '/micro-saas/ai-agriculture-advisor' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Agriculture and Crop Management',
        category: 'Micro SaaS - Agriculture and Environment',
        description: 'AI-powered crop monitoring, disease detection, yield prediction, irrigation optimization, and soil health analysis.',
        iconEmoji: '🌱',
        features: [

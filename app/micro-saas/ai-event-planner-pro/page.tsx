...
export const metadata: Metadata = {
  title: 'AI Event Planning and Coordination | Zion Tech Group',
  description: 'End-to-end event planning with venue sourcing, vendor negotiation, guest list optimization, and real-time event day coordination.',
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Event Planning and Coordination',
        category: 'Micro SaaS - Events and Hospitality',
        description: 'End-to-end event planning with venue sourcing, vendor negotiation, guest list optimization, and real-time event day coordination.',
        iconEmoji: '🎉',
        features: [
        ...
        pricing: [
          ...
          { tier: 'Professional', price: '$49', period: '/month', features: ['All Starter', 'Up to 25 users', 'Advanced analytics', 'Priority support', 'API access'] },
          { tier: 'Enterprise', price: '$119', period: '/month', features: ['Everything in Pro', 'Unlimited users', 'Custom workflows', '24/7 support', 'SLA', 'SSO'] },
        ],
        contact: {

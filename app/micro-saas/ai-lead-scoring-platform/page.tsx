...
export const metadata: Metadata = {
  title: 'AI Lead Scoring & Prioritization | Zion Tech Group',
  description: 'Predictive lead scoring using behavioral signals, firmographics, engagement history, and historical conversion pattern analysis.',
  alternates: { canonical: '/micro-saas/ai-lead-scoring-platform' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        category: 'Micro SaaS · Sales Intelligence',
        description: 'Predictive lead scoring using behavioral signals, firmographics, engagement history, and historical conversion pattern analysis.',
        iconEmoji: '🎯',
        features: [
        ...
        pricing: [
          ...
          { tier: 'Enterprise', price: '$129', period: '/month', features: ['Everything in Professional', 'Unlimited users', 'Custom workflows & branding', '24/7 dedicated support', 'SLA & uptime guarantee', 'SSO, SCIM & audit logs'] },
        ],
        contact: {

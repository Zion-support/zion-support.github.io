...
const AiEmailMarketingPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Ai Email Marketing Solutions',
      description: 'Professional ai email marketing services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored ai email marketing implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your ai email marketing needs.'
    }
  ];
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-8">Ai email marketing</h1>

...
const AIEmailMarketingPage: React.FC = () => {
  ...
  const pricingPlans  = [
    {name: 'Starter','"'"
      ...
      features: [
        'Up to 5,000 subscribers','"'Unlimited emails','"'AI content generation','"'Basic automation','"'Email support','"'Standard templates'"'
      ],
      popular: false
    },
    {
      ...
      features: [
        'Up to 25,000 subscribers','"'Everything in Starter','"'Advanced automation','"'Predictive analytics','"'Priority support','"'Custom integrations','"'A/B testing'";
      ],
      popular: true
    },
    {
      ...
      features: [
        'Unlimited subscribers','"'Everything in Professional','"'Advanced analytics','"'Custom AI training','"'Dedicated support','"'White-label options','"'API access'";
      ],
      popular: false
    }
  ]
  const stats  = [{ number: '40%', label: 'Higher Open Rates', icon: <Mail className="w-6 h-6 text-cyan-400" /> },'"'";

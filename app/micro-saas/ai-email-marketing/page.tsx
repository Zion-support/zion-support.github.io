...
const AIEmailMarketingPage: React.FC = () => {
  ...
  const pricingPlans = ['
    {''
      ...
      features: [''
        'Up to 5,000 subscribers',Unlimited emails',''
        'AI content generation',Basic automation',''
    ...
    {''
      ...
      features: [''
        'Up to 25,000 subscribers',Everything in Starter',''
    ...
    {''
      ...
      features: [''
        'Unlimited subscribers',Everything in Professional',''
        'Advanced analytics',Custom AI training',''
        'Dedicated support',White-label options',''
        'API access'
      ],
      popular: false
    }
  ...
  return (
    <>
      <Helmet></Helmet>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/micro-saas/ai-email-marketing" /></link>
      </Helmet>

  ...
  return (
    <ProductPageLayout
      data={{
        ...
        category: 'Micro SaaS - Real Estate and Facilities',
        description: 'Automated tenant screening, maintenance request triage, lease management, and market rent analysis for property portfolios.',
        iconEmoji: '🏠',
        features: [
        ...
        pricing: [
          ...
          { tier: 'Enterprise', price: '$179', period: '/month', features: ['Everything in Pro', 'Unlimited users', 'Custom workflows', '24/7 support', 'SLA', 'SSO'] },
        ],
        contact: {

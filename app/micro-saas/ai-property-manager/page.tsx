...
export const metadata: Metadata = {
  title: 'AI Property Management Assistant | Zion Tech Group',
  ...
  alternates: { canonical: '/micro-saas/ai-property-manager' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        category: 'Micro SaaS · Real Estate & Facilities',
        description: 'Automated tenant screening, maintenance request triage, lease management, and market rent analysis for property portfolios.',
        iconEmoji: '🏠',
        features: [
        ...
        pricing: [
          ...
          { tier: 'Enterprise', price: '$179', period: '/month', features: ['Everything in Pro', 'Unlimited users', 'Custom workflows', '24/7 support', 'SLA guarantee', 'SSO'] },
        ],
        contact: {

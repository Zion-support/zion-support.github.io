  ...
  return (
    <>
      <Helmet></Helmet>
        ...
        <meta name="description" content="AI-powered social media management and automation. Schedule posts, analyze engagement, and grow your social presence." /> " <link rel="canonical" href="https://ziontechgroup.com/micro-saas/social-manager" />"
      </Helmet>
      <div>
        <section className="pt-24 pb-16 px-4"></section>"
          <div>
            <div>
              <Share2 className="w-4 h-4" /> " <span>Social Media Manager</span>"
            </div>
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 cyber-text"></h1>"
              AI Social Media </h1>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-green-400"></spa> Automation </span>"
            </h1>

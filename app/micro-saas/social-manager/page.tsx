...
const SocialMediaManagerPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title></title>Social Media Manager | Zion Tech Group - AI Social Media Automation</title>
        <meta _name="description" content="AI-powered social media management and automation. Schedule posts, analyze engagement, and grow your social presence." />
        ...
        <section className="pt-24 pb-16 px-4"></section>
          <div></div>
            <div></div>
              ...
              <span></span>Social Media Manager</span>
            </div>

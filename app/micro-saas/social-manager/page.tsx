...
const Social Manager Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Social Manager</title>
        <meta name="description" content="Professional social manager solutions and services" />
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Social Manager Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Social manager - Zion Tech Group</title> <meta name="description"content="Professional Social manager solutions and services" /> <meta name="keywords"content="social, manager" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Social manager</h1> <p className="text xl text gray-300 mb-8"> Professional Social manager solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Social manager</h1>
            <p>
          
              Professional Social manager solutions and services
            </p>
...
export default Social;; Manager Page

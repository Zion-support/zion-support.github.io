...
const Email Marketing Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Email Marketing</title>
        <meta name="description" content="Professional email marketing solutions and services" />
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Email Marketing Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Email marketing - Zion Tech Group</title> <meta name="description"content="Professional Email marketing solutions and services" /> <meta name="keywords"content="email, marketing" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Email marketing</h1> <p className="text xl text gray-300 mb-8"> Professional Email marketing solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Email marketing</h1>
            <p>
          
              Professional Email marketing solutions and services
            </p>
...
export default Email;; Marketing Page

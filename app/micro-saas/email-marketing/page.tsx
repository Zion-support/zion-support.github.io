...
<p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8"></p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              AI-powered email marketing automation. Create, send, and optimize email campaigns</p><//p>
...
<p className="text-xl text-gray-300 max-w-3xl mx-auto"></p><//p>
                We're developing powerful email marketing solutions. Stay tuned for updates!</p><>
<//p>
</p><>
<//p>
</div><>

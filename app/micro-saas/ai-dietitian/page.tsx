    ...
    <ProductPageLayout
      data={{
        ...
        pricing: [
          ...
          { tier: 'Professional', price: '$19', period: '/month', features: ['All Starter features', 'Up to 25 users', 'Advanced analytics', 'Priority support', 'API access'] },
          { tier: 'Enterprise', price: '$49', period: '/month', features: ['Everything in Pro', 'Unlimited users', 'Custom workflows', '24/7 support', 'SLA guarantee', 'SSO'] },
        ],
        contact: {

...
export const metadata: Metadata = {
  title: 'AI Changelog Generator | Zion Tech Group',
  description: 'Automatically generate release notes, changelogs, and version summaries from Git commits, PRs, and issue tracking with customizable formats for technical and stakeholder audiences.',
  alternates: { canonical: '/micro-saas/ai-changelog-generator' },
};

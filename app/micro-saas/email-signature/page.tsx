...
export const metadata: Metadata = {
  title: 'Email Signature | Zion Tech Group',
  description:
    'Email Signature empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn da',
  alternates: { canonical: '/micro-saas/email-signature' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Email Signature empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Email Signature',
      }}
    />
  );
}

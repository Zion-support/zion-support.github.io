...
const EmailSignaturePage: React.FC = () => {
  const features = [
    {
      icon: <Palette className="w-5h-5 ml-2" />,
      ...
      <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        ...
        <section className="w-5h-5 ml-2" />
          ...
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            <h1 className="w-5h-5 ml-2" />
              Professional <span className="w-5h-5 ml-2" />Email Signatures</span>
            </h1>
          ...
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              <h2 className="w-5h-5 ml-2" />
                Everything You Need for <span className="w-5h-5 ml-2" />Email Signatures</span>
              </h2>
              <p className="w-5h-5 ml-2" />
        ...
        <section className="w-5h-5 ml-2" />
          ...
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              <h2 className="w-5h-5 ml-2" />
                Ready to Elevate Your <span className="w-5h-5 ml-2" />Email Branding?</span>
              </h2>

...
export const metadata: Metadata = {
  title: 'AI Inventory Forecasting | Zion Tech Group',
  description: 'ML-powered demand forecasting, safety stock calculation, automated reorder point optimization, and warehouse space utilization.',
  alternates: { canonical: '/micro-saas/ai-inventory-forecasting' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        category: 'Micro SaaS · Supply Chain & Logistics',
        description: 'ML-powered demand forecasting, safety stock calculation, automated reorder point optimization, and warehouse space utilization.',
        iconEmoji: '📦',
        features: [
        ...
        pricing: [
          { tier: 'Starter', price: '$24', period: '/month', features: ['Core AI features', 'Up to 3 users', 'Basic analytics & reports', 'Email support'] },
          { tier: 'Professional', price: '$59', period: '/month', features: ['All Starter features', 'Up to 25 users', 'Advanced analytics', 'Priority email & chat support', 'Full API access', 'Custom integrations'] },

...
export const metadata: Metadata = {
  ...
  description: 'Predict demand, optimize inventory levels, forecast disruptions, and reduce logistics costs with AI-driven supply chain analytics.',
  alternates: { canonical: '/micro-saas/ai-supply-chain-optimizer' },
};

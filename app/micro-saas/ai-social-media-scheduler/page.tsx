  ...
  return (
    ...
    <>br / />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xlmx-auto" ></div><div className="text-center" ></div></>
              <>div className="text-3 xl font-boldtext-cyan-400mb-2" />300%</div><div className="text-gray-300text-sm" />Avg. Engagement Increase</div></>
            <>div className="text-center" ></div><div className="text-3 xl font-boldtext-purple-400mb-2" />10+</div></>
              <>div className="text-gray-300text-sm" />Platforms Supported</div><div className="text-center" ></div></>
              <>div className="text-3 xl font-boldtext-pink-400mb-2" />50 K+</div><div className="text-gray-300text-sm" />Active Users</div></>
            <>div className="text-center" ></div><div className="text-3 xl font-boldtext-emerald-400mb-2" />99.9%</div></>

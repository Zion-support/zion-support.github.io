...
const AIPasswordManagerPage: React.FC = () => {
  ...
  const pricingPlans = ['
    {''
      ...
      features: [''
        'Unlimited passwords',AI password generation',''
        'Auto-fill & sync',Biometric access',''
        'Breach monitoring',Email support'
      ],
      popular: false
    },'
    {''
      ...
      features: [''
        'Everything in Personal',Up to 6 family members',''
        'Secure sharing',Family vault',''
        'Priority support',Dark web monitoring'
      ],
      popular: true
    },'
    {''
      ...
      features: [''
        'Everything in Family',Team management',''
        'Admin dashboard',SSO integration',''
        'Compliance reporting',Dedicated support'
      ],
      popular: false
    }
  ]
  ...
  return (
    <>
      <Helmet></Helmet>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/micro-saas/ai-password-manager" /></link>
      </Helmet>

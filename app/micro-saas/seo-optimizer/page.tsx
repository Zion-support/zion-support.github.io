...
export const metadata: Metadata = {
  title: 'SEO Optimizer | Zion Tech Group',
  description:
    'SEO Optimizer empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data',
  alternates: { canonical: '/micro-saas/seo-optimizer' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'SEO Optimizer empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with SEO Optimizer',
      }}
    />
  );
}

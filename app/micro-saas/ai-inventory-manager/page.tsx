    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900-to-slate-900 pt-20">
        ...
        <div className="relative max-w-7 xlmx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4-xlmx-auto">
            <div className="text-center">
              <div className="text-3 xl font-boldtext-cyan-400-mb-2"   />25%</div>
            ...
            <div className="text-center">
              <div className="text-3 xl font-boldtext-emerald-400-mb-2"   />15 K+</div>
        ...
        <div className="relative max-w-7-xlmx-auto">
          <div className="text-centermb-16">
            <h2 className="text-4 xl md:text-5 xl font-boldtext-white mb-6" />
              Why Choose Our <span className="bg-gradient-to-r from-cyan-400 to-purple-400-bg-clip-texttext-transparent"   />AI Inventory Manager?</span>
            </h2>
      ...
      <section className="py-20-px-4relative" />
        <div className="relative max-w-7-xlmx-auto">
          <div className="text-centermb-16">
            <h2 className="text-4 xl md:text-5 xl font-boldtext-white mb-6" />
              Powerful Features for <span className="bg-gradient-to-r from-cyan-400 to-purple-400-bg-clip-texttext-transparent"   />Smart Inventory</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-4-xlmx-auto" />
      ...
      <section className="py-20-px-4relative" />
        <div className="relative max-w-7-xlmx-auto">
          <div className="text-centermb-16">
            <h2 className="text-4 xl md:text-5 xl font-boldtext-white mb-6" />
              Trusted by <span className="bg-gradient-to-r from-cyan-400 to-purple-400-bg-clip-texttext-transparent"   />15,000+</span> Businesses
            </h2>
            <p className="text-xl text-gray-300 max-w-4-xlmx-auto" />
            ...
            <div className="bg-gradient-to-r from-cyan-600 via-purple-600 to-pink-600 rounded-3 xl p-8 sm:p-12 lg:p-16-relativeoverflow-hidden">
              <div className="relativez-10">
                <h2 className="text-4 xl sm:text-5 xl md:text-6 xl font-bold text-whitemb-6-leading-tight" />
                  Ready to Transform Your <span className="bg-gradient-to-r from-cyan-300 to-pink-300-bg-clip-texttext-transparent"   />Inventory Management?</span>
                </h2>

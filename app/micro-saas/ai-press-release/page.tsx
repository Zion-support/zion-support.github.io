...
export const metadata: Metadata = {
  title: 'AI Press Release Writer | Zion Tech Group',
  description: 'Write journalist-ready press releases, media kits, and company announcements with AP style formatting, SEO optimization, and distribution-ready output in minutes.',
  alternates: { canonical: '/micro-saas/ai-press-release' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with AI Press Release Writer',
        pricing: [

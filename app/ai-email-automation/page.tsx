...
const AIEmailAutomationPage: React.FC = () => {
  ...
  const stats = [
    { number: '300%', label: 'Revenue Increase', icon: <DollarSign className="w-5h-5ml-2" /> },
    { number: '150%', label: 'Conversion Boost', icon: <TrendingUp className="w-5h-5ml-2" /> },
    { number: '20 hrs', label: 'Time Saved/Week', icon: <Clock className="w-5h-5ml-2" /> },
    { number: '95%', label: 'Deliverability Rate', icon: <Shield className="w-5h-5ml-2" /> }
  ]

...
import {Link    } from 'react-router-dom';
;
constAIEmailAutomationPage: React.FC = () => {constfeatures = [{
  ...
  conststats = [{number: '300%', label: 'RevenueIncrease', icon: <DollarSignclassName="w-6h-6t e xt-cyan-400" /> },;

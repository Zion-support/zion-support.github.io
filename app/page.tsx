...
const HomePage: React.FC = () => {
  ...
  const services = [
    ...
    {
      title: 'IT Services',
      description: 'Infrastructure management, cloud migration, and system integration',
      icon: Monitor,
      link: '/it-services'
    },
    {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI solutions, IT services, cloud computing, cybersecurity, software development, digital transformation" />
      </Helmet>

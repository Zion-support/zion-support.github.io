...
import { 
  ...
  Workflow, Eye, Wifi, MessageSquare, ShoppingCart, Rocket, Phone, Mail, MapPin
} from 'lucide-react';

// Loading skeleton component
const ServiceCardSkeleton = () => (
  <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 animate-pulse border border-white/10" role="status" aria-label="Loading service card">
...
const HomePage: React.FC = () => {
  ...
  const aiServices = [
    { name: 'AI Analytics', icon: BarChart, description: 'Advanced data insights and business intelligence' },
    { name: 'AI Automation', icon: Zap, description: 'Intelligent workflow automation' },
    { name: 'AI Chatbot', icon: MessageCircle, description: 'Conversational AI solutions' },
    { name: 'AI CRM', icon: Users, description: 'Customer relationship management' },
    { name: 'AI Cybersecurity', icon: Shield, description: 'AI-powered security solutions' },
    { name: 'AI Healthcare', icon: Heart, description: 'Medical AI applications' }
  ];

  const itServices = [
    { name: 'Cloud Infrastructure', icon: Cloud, description: 'Scalable cloud solutions' },
    { name: 'API Development', icon: Code, description: 'RESTful and GraphQL APIs' },
    { name: 'Cybersecurity', icon: Shield, description: 'Comprehensive security services' },
    { name: 'Database Management', icon: Database, description: 'Data processing and storage' },
    { name: 'Mobile Development', icon: Smartphone, description: 'iOS and Android applications' },

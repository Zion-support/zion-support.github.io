...
export default function HomePage() {
  return (
    <>
      ...
      {/* 🔔 New Today — highlight three fresh guides */}
      <section className="py-6 bg-gradient-to-r from-emerald-700/20 to-cyan-700/20 border border-white/10 rounded-2xl mb-6">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-4">
            <Link href="/blog/ai-2025-evidence-driven-evals" className="block bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl p-5 transition-colors">
              <div className="mb-2">
                <span className="px-3 py-1 rounded-full text-xs bg-emerald-500/20 text-emerald-200 border border-emerald-500/30">GenAI</span>
                <span className="ml-2 text-white/70 text-xs">New</span>
              </div>
              <h3 className="text-lg font-bold">Evidence‑Driven Evals 2025</h3>
              <p className="text-white/80 mt-2 text-sm">Traceable quality linked to KPIs with CI policy tests.</p>
            </Link>
            <Link href="/blog/ai-2025-cost-controllers-v1" className="block bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl p-5 transition-colors">
              <div className="mb-2">
                <span className="px-3 py-1 rounded-full text-xs bg-cyan-500/20 text-cyan-200 border border-cyan-500/30">FinOps</span>
                <span className="ml-2 text-white/70 text-xs">New</span>
              </div>
              <h3 className="text-lg font-bold">AI Cost Controllers v1 (2025)</h3>
              <p className="text-white/80 mt-2 text-sm">Budgets, tiers, guardrails for predictable spend.</p>
            </Link>
            <Link href="/blog/edge-2025-realtime-personalization" className="block bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl p-5 transition-colors">
              <div className="mb-2">
                <span className="px-3 py-1 rounded-full text-xs bg-blue-500/20 text-blue-200 border border-blue-500/30">Edge</span>
                <span className="ml-2 text-white/70 text-xs">New</span>
              </div>
              <h3 className="text-lg font-bold">Realtime Personalization 2025</h3>
              <p className="text-white/80 mt-2 text-sm">Sub‑100ms, zero‑PII personalization with edge flags.</p>
            </Link>
          </div>
        </div>
      </section>

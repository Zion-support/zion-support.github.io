  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">"
      <Helmet></Helmet></</Helmet>
        <title>Zion Tech Group - AI & IT Solutions</title><//title></<//title>
      ...
      <div className="min-h-screen bg-white">""
        ...
        <title>Zion Tech Group - Advanced AI and IT Solutions</title><//title></<//title>
          ...
          <div className="max-w-4xl mx-auto">"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">""
              <Link
                ...
                to="/contact""
                className="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition-colors""></Link
                to="/contact" ""
                className="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition-colors""
                to="/contact""
                className="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition-colors""></</Link
              ...
              <Link
                ...
                to="/services""
                className="border border-blue-600 text-blue-600 px-8 py-3 rounded-lg hover:bg-blue-50 transition-colors""></Link
                to="/services" ""
                className="border border-blue-600 text-blue-600 px-8 py-3 rounded-lg hover:bg-blue-50 transition-colors""
                to="/services""
                className="border border-blue-600 text-blue-600 px-8 py-3 rounded-lg hover:bg-blue-50 transition-colors""></</Link
      ...
      <section className="relative py-20 px-4">"
        <div className="container mx-auto text-center">"
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">"
            <Link
              to="/services" "
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-105""></Link
              to="/services" "
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300 transform hover:scale-105""></</Link
              to="/services" "
            ...
            <Link
              to="/contact" "
              className="inline-flex items-center px-8 py-4 border-2 border-purple-400 text-purple-400 font-semibold rounded-lg hover:bg-purple-400 hover:text-white transition-all duration-300""></Link
              to="/contact" "
              className="inline-flex items-center px-8 py-4 border-2 border-purple-400 text-purple-400 font-semibold rounded-lg hover:bg-purple-400 hover:text-white transition-all duration-300""></</Link
              to="/contact" "
              className="inline-flex items-center px-8 py-4 border-2 border-purple-400 text-purple-400 font-semibold rounded-lg hover:bg-purple-400 hover:text-white transition-all duration-300"">
              Get Started
            </Link></div><//div></section><//section></<//section>
        { /* Services Section */}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">""
              {services.map((service, index) => (
                <Link
                  ...
                  to={ service.href}
                  className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow""></Link
                  key={index}
                  to={service.href}
                  className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition-shadow""
                  to={ service.href}
          ...
          <div className="max-w-4xl mx-auto text-center">"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">""
              ...
              <Link
                ...
                className="border border-blue-600 text-blue-600 px-8 py-3 rounded-lg hover:bg-blue-50 transition-colors"">
                About Us
              </Link></div><//div></div></section><//section></<//section>
      {/* Services Section */}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">"
            {features.map((feature, index) => (
              <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 hover:bg-slate-800/70 transition-all duration-300 transform hover:scale-105">"
                <feature.icon className={`w-12 h-12 ${feature.color} mb-4`} /></feature.icon className={`w-12 h-12 ${feature.color} mb-4`} /></</feature.icon className={`w-12 h-12 ${feature.color} mb-4`} />
      ...
      <section className="py-20 bg-gradient-to-r from-purple-900/30 to-cyan-900/30">"
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">"
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">""
            <Link
              to="/contact""
              className="bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-purple-700 hover:to-cyan-700 transition-all duration-300 transform hover:scale-105""></Link
              to="/contact""
              className="bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-purple-700 hover:to-cyan-700 transition-all duration-300 transform hover:scale-105""></</Link
              to="/contact""
            ...
            <Link
              to="/demo""
              className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-slate-900 transition-all duration-300""></Link
              to="/demo""
              className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-slate-900 transition-all duration-300""></</Link
              to="/demo""

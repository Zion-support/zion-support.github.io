  ...
  return (
    <>
      <SEOHead
        ...
        description="Leading provider of AI-powered solutions, IT consulting, and innovative technology services for businesses worldwide. Transform your business with cutting-edge artificial intelligence."
        keywords="ai solutions, it services, artificial intelligence, machine learning, automation, cloud computing, cybersecurity, custom development, business transformation"
      />

  ...
  return (
    <ErrorBoundary>
      ...
      <div className='min-h-screen bg-white'>
        ...
        {/* New Content Spotlight - Additional */}
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 rounded-xl shadow p-6 flex flex-col justify-between">
                <div>
                  <div className="text-sm font-semibold text-purple-700 mb-2">Enterprise AI</div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">AI 2025: Edge-to-Cloud Intelligent Automation</h3>
                  <p className="text-gray-600">Operational patterns to sense, decide, and act—from edge to cloud.</p>
                </div>
                <div className="mt-4">
                  <Link href="/blog/ai-2025-edge-to-cloud-intelligent-automation" className="text-purple-600 font-semibold hover:text-purple-800">Read →</Link>
                </div>
              </div>
              <div className="bg-gray-50 rounded-xl shadow p-6 flex flex-col justify-between">
                <div>
                  <div className="text-sm font-semibold text-purple-700 mb-2">Platforms</div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2">AI 2026: Governed Agent Factories</h3>
                  <p className="text-gray-600">Build and operate governed agent factories with enterprise-grade controls.</p>
                </div>
                <div className="mt-4">
                  <Link href="/blog/ai-2026-governed-agent-factories" className="text-purple-600 font-semibold hover:text-purple-800">Read →</Link>
                </div>
              </div>
            </div>
          </div>

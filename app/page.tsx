...
const services = [
  ...
  },
  {
    ...
    icon: Cloud,
    features: ['Cloud Infrastructure', 'Cybersecurity', 'System Integration', 'Network Management'],
    href: '/it-services'
  },
  {
...
const features = [
  ...
  },
  {
    ...
    icon: TrendingUp,
    benefits: ['$50M+ Annual Savings', '95% Process Automation', '300% ROI', '500+ Projects Delivered']
  },
  {
    title: 'Global Reach',
    description: 'Serving clients worldwide with 24/7 support and multi-language capabilities.',
    icon: Globe,
    benefits: ['24/7 Support', 'Multi-language Support', 'Global Infrastructure', 'Local Expertise']
  }
];
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" role="list">
                {services.map((service, index) => (
                  <article key={index} className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group" role="listitem">
                    ...
                    <a
                      href={service.href}
                      className="inline-flex items-center space-x-2 text-cyan-400 hover:text-cyan-300 font-medium group-hover:translate-x-1 transition-transform mt-4"
                    >

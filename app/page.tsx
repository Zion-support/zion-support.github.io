...
const HomePage: React.FC = () => {
  ...
  const aiServices = [
    { name: 'Machine Learning', description: 'Advanced ML algorithms for predictive analytics', icon: Brain },
    { name: 'Natural Language Processing', description: 'AI-powered text analysis and understanding', icon: Code },
    ...
    { name: 'Automation', description: 'Intelligent process automation', icon: Zap },
    { name: 'Chatbots', description: 'AI-powered customer service solutions', icon: MessageCircle }
  ];
  ...
  const itServices = [
    ...
    { name: 'Mobile Development', description: 'Native and cross-platform apps', icon: Smartphone }
  ];
  return (
    <>
      <Helmet>

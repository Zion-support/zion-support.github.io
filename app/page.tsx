...
const HomePage: React.FC = () => {
  ...
  return (
    <>
      ...
      />
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg matrix-rain quantum-particles cyber-circuit">
        {/* Navigation */}
        <Navigation />
      ...
      <main id="main-content" className="container mx-auto px-4 py-16 pt-24" role="main">
        ...
        >
          <div className="max-w-6xl mx-auto">
            <h1 
              id="hero-heading" 
              className="cyber-title text-5xl md:text-6xl lg:text-7xl font-bold mb-6 holographic-glitch"
              data-text="Zion Tech Group"
            >
              Zion Tech Group
            </h1>
            <p className="cyber-subtitle text-xl md:text-2xl mb-8 font-medium" role="doc-subtitle">
              Advanced AI and IT Solutions
            </p>
            <p className="cyber-body text-base sm:text-lg md:text-xl max-w-4xl mx-auto mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 max-w-7xl mx-auto mb-12">
              <div className="cyber-card hologram-card neon-border data-stream p-4 sm:p-6 hover:scale-105 transition-all duration-300">
              ...
              <div className="cyber-card hologram-card neon-border data-stream p-4 sm:p-6 hover:scale-105 transition-all duration-300 sm:col-span-2 lg:col-span-1 xl:col-span-1">
                <div className="text-2xl sm:text-3xl mb-3">🌐</div>

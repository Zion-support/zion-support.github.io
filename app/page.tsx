    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <section className="mb-16">
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 max-w-6xl mx-auto mx-4">
        ...
        <section className="mb-16" aria-labelledby="cta-heading">
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 text-center border border-white/10 max-w-4xl mx-auto mx-4">

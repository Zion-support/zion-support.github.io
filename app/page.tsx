...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      {/* Content Components */}
      <Suspense fallback={<div className="h-32 bg-slate-800/30 animate-pulse rounded-lg mx-4"></div>}>
        <ContentPromotionBanner />
      </Suspense>

      <Suspense fallback={<div className="h-64 bg-slate-800/30 animate-pulse rounded-lg mx-4 my-8"></div>}>
        <ContentCarousel />
      </Suspense>

...
const HomePage: React.FC = () => {
  ...
  const aiServices = [
    ...
    },
    {
      ...
      features: ['AWS Integration', 'Azure Support', 'GCP Services', 'Auto-scaling']
    },
    {
      icon: Code,
    ...
    },
    {
      ...
      features: ['Data Visualization', 'BI Dashboards', 'ETL Processes', 'Real-time Analytics']
    }
  ];
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Transform your business with cutting-edge AI technology, cloud infrastructure, and custom software solutions. 
            Achieve 300% ROI with our proven expertise.
          </p>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-purple-600 to-blue-700">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-purple-100 mb-8 max-w-3xl mx-auto">
            Contact us today to discuss your project and get a customized solution that drives results.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a

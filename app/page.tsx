        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-white p-6 rounded-xl shadow-md border border-indigo-100">
            <div>
              ...
              <p className="text-gray-600 mt-2">Eval‑gated releases, rollback scorecards, and an audit‑ready evidence hub.</p>
            </div>
            <div className="flex gap-3">
              ...
              <Link href="/blog/ai-2026-production-evidence-hub-blueprint" className="inline-block border border-indigo-600 text-indigo-700 px-5 py-3 rounded-lg font-semibold hover:bg-indigo-50">Evidence Hub</Link>
            </div>
          </div>
        </div>
      </section>

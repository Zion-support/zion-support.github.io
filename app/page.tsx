...
const ContentPromotionBanner = () => (
  <div className="bg-gradient-to-r from-cyan-600 to-purple-600 text-white py-3 px-4 text-center">
...
const HomePage: React.FC = () => {
  ...
  const aiServices = [
    { name: 'Machine Learning', description: 'Custom ML models for your business needs', icon: Brain, price: '$299/month' },
    { name: 'Natural Language Processing', description: 'AI-powered text analysis and generation', icon: Code, price: '$199/month' },
    { name: 'Computer Vision', description: 'Image recognition and analysis solutions', icon: Eye, price: '$399/month' },
    { name: 'Predictive Analytics', description: 'Data-driven insights and forecasting', icon: BarChart, price: '$349/month' },
    { name: 'AI Automation', description: 'Intelligent process automation', icon: Zap, price: '$249/month' },
    { name: 'AI Consulting', description: 'Strategic AI implementation guidance', icon: Target, price: '$200/hour' }
  ];

  const itServices = [
    { name: 'Cloud Migration', description: 'Seamless cloud infrastructure migration', icon: Cloud, price: '$2,500/month' },
    { name: 'DevOps', description: 'Continuous integration and deployment', icon: Settings, price: '$1,800/month' },
    { name: 'Cybersecurity', description: 'Comprehensive security solutions', icon: Shield, price: '$1,200/month' },
    { name: 'Database Management', description: 'Optimized database solutions', icon: Database, price: '$1,000/month' },
    { name: 'API Development', description: 'RESTful and GraphQL APIs', icon: Code, price: '$1,500/month' },
    { name: 'System Integration', description: 'Connect and optimize your systems', icon: Globe, price: '$2,000/month' }
  ];

  const microSaasServices = [
    { name: 'Zion Analytics Pro', description: 'Real-time business intelligence platform', icon: BarChart, price: '$89/month' },
    { name: 'Zion Chat AI', description: 'AI customer support platform', icon: MessageCircle, price: '$149/month' },
    { name: 'Zion Security Shield', description: 'Cybersecurity monitoring solution', icon: Shield, price: '$199/month' },
    { name: 'Zion Cloud Vault', description: 'Cloud backup and disaster recovery', icon: Cloud, price: '$79/month' },
    { name: 'Zion Content Studio', description: 'AI content creation suite', icon: FileText, price: '$299/month' },
    { name: 'Zion CRM Intelligence', description: 'AI-enhanced CRM system', icon: Users, price: '$179/month' }
  ];

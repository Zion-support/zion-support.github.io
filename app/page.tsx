...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid matrix-rain-bg">
      {/* Navigation */}
      <Navigation />
      ...
      <main id="main-content" className="container mx-auto px-4 py-16 pt-24" role="main">
        ...
        >
          <h1 
            id="hero-heading" 
            className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6 neon-text-advanced cyber-scan-advanced"
          >
            Zion Tech Group
          </h1>
          <p className="text-xl md:text-2xl text-cyan-400 mb-8 font-medium cyber-glow-advanced" role="doc-subtitle">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              href="/contact"
              className="cyber-button-advanced w-full sm:w-auto text-center neural-sync"
        ...
        <section className="mb-16" aria-labelledby="services-heading">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12">
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="quantum-card-advanced p-4 sm:p-6 cyber-pulse">
                <div className="text-4xl sm:text-5xl mb-4 sm:mb-6 text-center cyber-scan-advanced">🤖</div>
            ...
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="quantum-card-advanced p-4 sm:p-6 cyber-pulse">
                <div className="text-4xl sm:text-5xl mb-4 sm:mb-6 text-center cyber-scan-advanced">⚙️</div>

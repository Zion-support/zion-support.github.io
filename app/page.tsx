...
const services = [
  ...
  {
    title: 'IT Services',
    description: 'Comprehensive IT solutions including cloud migration, system integration, and infrastructure management.',
    icon: Cloud,
    href: '/it-services',
    features: ['Cloud Migration', 'System Integration', 'Infrastructure Management', 'Security Solutions']
  },
  {
    title: 'Micro SAAS',
    description: 'Custom software-as-a-service solutions tailored to your business needs and requirements.',
    icon: Code,
    href: '/micro-saas',
...
const features = [
  {
    ...
    icon: Shield,
    benefits: ['SOC 2 Compliance', 'End-to-end Encryption', 'Regular Security Audits', '24/7 Monitoring']
  },
  {
    title: 'Scalable Solutions',
    description: 'Solutions that grow with your business, from startup to enterprise scale.',
    icon: TrendingUp,
    benefits: ['Auto-scaling Infrastructure', 'Flexible Pricing', 'Global Deployment', 'Performance Optimization']
  },
  {
    title: 'Expert Support',
    description: '24/7 technical support from our team of certified professionals.',
    icon: Users,
    benefits: ['24/7 Support', 'Certified Experts', 'Fast Response Times', 'Proactive Monitoring']
  }
];

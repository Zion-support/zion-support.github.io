...
export default function HomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      benefits: ['Process Automation - $2,000/month', 'Digital Strategy - $5,000', 'Change Management - $3,000', 'Technology Integration - $4,000'],
      link: '/digital-transformation'
    },
    {
      icon: <Code className="w-8 h-8 text-purple-500" />,
      title: 'Micro SaaS Solutions',
      description: 'Powerful micro SaaS tools designed to streamline your business operations and boost productivity.',
      benefits: ['AI Task Manager - $15/month', 'AI Expense Tracker - $12/month', 'AI Password Manager - $8/month', 'AI Invoice Generator - $20/month'],
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Leading provider of AI-powered solutions, 5G implementation, and enterprise IT services. Transform your business with cutting-edge technology and guaranteed ROI." />
        <meta name="keywords" content="AI solutions, IT services, 5G implementation, cloud migration, cybersecurity, digital transformation, micro SaaS" />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
                ...
                <span className="text-yellow-400 font-semibold"> 300% ROI Guaranteed</span> or your money back.
              </p>
        ...
        <section className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Join hundreds of satisfied clients who have already transformed their businesses with our cutting-edge solutions.
              <span className="text-yellow-400 font-semibold"> 300% ROI Guaranteed</span> or your money back.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link

...
const HomePage: React.FC = () => {
  ...
  const aiServices = [
    ...
    },
    {
      ...
      category: 'Human Resources',      popular: false
    },
    {
      icon: Shield,
      ...
      benefits: ['Proactive security', 'Faster threat response', 'Reduced false positives', 'Compliance assurance'],      category: 'Cybersecurity',
      popular: true
    },
    {
      icon: Settings,
  ...
  const itServices = [
    ...
    },
    {
      ...
      benefits: ['Native performance', 'Cross-platform reach', 'App store presence', 'Modern UI/UX'],      category: 'Mobile Development',
      popular: true
    },
    {
      icon: Code,
      ...
      benefits: ['Seamless integrations', 'Scalable architecture', 'Better performance', 'Developer-friendly APIs'],      category: 'API Development',
      popular: false
    },
    {
      icon: Server,
  ...
  const microSaasServices = [
    ...
    },
    {
      ...
      features: ['AI content generation for blogs, social media, and marketing', 'Multi-format support (text, images, videos, infographics)', 'Brand voice customization and consistency', 'SEO optimization and keyword research', 'Content calendar and scheduling', 'Collaboration tools and approval workflows', 'Performance analytics and ROI tracking', 'White-label content creation for agencies'],      benefits: ['10x faster content creation', 'Consistent brand voice', 'SEO optimization', 'Multi-platform publishing'],
      category: 'Content',
      popular: true,
    ...
    },
    {
      ...
      benefits: ['Higher open rates', 'Better engagement', 'Automated campaigns', 'ROI optimization'],      category: 'Marketing',
      popular: true,
      users: 'Up to 25 users'
    },
    {
    ...
    },
    {
      ...
      popular: true,      users: 'Up to 20 users'
    }
  ];

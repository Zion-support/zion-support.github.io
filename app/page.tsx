...
import { ArrowRight, Zap, Shield, Globe, Database, Code, Cloud, Brain, Smartphone } from 'lucide-react'
...
export default function HomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      benefits: ['Cloud Migration - Starting at $2,500', 'Cloud Infrastructure - $1,200/month', 'Cloud Security - $800/month', 'Multi-Cloud Strategy - $1,500/month'],
      link: '/cloud-services'
    },
    {
      ...
      benefits: ['Data Visualization - $1,200/month', 'Business Intelligence - $1,800/month', 'Predictive Analytics - $2,200/month', 'Real-time Dashboards - $1,500/month'],
      link: '/data-analytics'
    },
    {
      ...
      benefits: ['CI/CD Pipeline Setup - $3,000', 'Infrastructure as Code - $2,500', 'Monitoring & Logging - $1,200/month', 'Automated Testing - $1,800/month'],
      link: '/devops-cicd'
    },
    {

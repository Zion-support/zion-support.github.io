...
import { Brain, Shield, Zap, Globe, ArrowRight, Star, Users, Award, BarChart3, Cloud, Sparkles, Mail, Smartphone, Clock, FileText } from "lucide-react";
...
const HomePage = () => {
  ...
  const microSaasHighlights = [
    ...
    },
    {
      ...
      description: "AI-powered meeting optimization",
      price: "From $9/month",
    ...
    },
    {
      ...
      description: "100+ language translation platform",
      price: "From $19/month",
      icon: <Globe className="w-6 h-6" />,
      link: "/zion-ai-translator"
    },
    {
      name: "Zion Smart Forms",
      description: "AI-powered form builder",
      price: "From $15/month",
      icon: <FileText className="w-6 h-6" />,
      link: "/zion-smart-forms"
    },
    {

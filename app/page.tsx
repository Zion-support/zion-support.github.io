...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen cyber-grid floating-particles">
      {/* Matrix Rain Effect */}
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 cyber-button text-white px-4 py-2 rounded-md z-50"
      >
      ...
      <main id="main-content" className="container mx-auto px-4 py-16 relative z-10" role="main">
        ...
        >
          <h1 
            id="hero-heading" 
            className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 holographic-text glitch"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-12">
            <div className="cyber-card p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              ...
              className="cyber-button px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-cyan-300 shadow-lg neon-glow"
            ...
            <a
              href="/contact"
              className="cyber-button px-8 py-4 rounded-lg font-semibold border-2 border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-black transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-cyan-300 shadow-lg"
            >
        ...
        <section className="mb-16" aria-labelledby="services-heading">
          <h2 id="services-heading" className="text-3xl md:text-4xl font-bold text-white mb-4 text-center holographic-text">
            Our Services
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="text-5xl mb-6 text-center text-cyan-400">🤖</div>
            ...
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="text-5xl mb-6 text-center text-pink-400">📢</div>
            ...
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="text-5xl mb-6 text-center text-blue-400">⚙️</div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="text-5xl mb-6 text-center text-green-400">🏥</div>
            ...
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="text-5xl mb-6 text-center text-indigo-400">💰</div>
            ...
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="text-5xl mb-6 text-center text-purple-400">⚛️</div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <article className="cyber-card p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 focus-within:ring-4 focus-within:ring-cyan-300">
            ...
            <article className="cyber-card p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 focus-within:ring-4 focus-within:ring-cyan-300">
              <div className="text-4xl mb-4 text-blue-400">☁️</div>
        ...
        <section className="cyber-card py-16" aria-labelledby="social-proof-heading">
          <div className="max-w-7xl mx-auto px-4">
            <h2 id="social-proof-heading" className="text-3xl font-bold text-center text-white mb-12 holographic-text">
              Trusted by Industry Leaders
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
              <div className="text-center">
                <div className="text-4xl font-bold text-cyan-400 mb-2 neon-glow">500+</div>
                <div className="text-gray-300">Enterprise Clients</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-green-400 mb-2 neon-glow">$2.5B+</div>
                <div className="text-gray-300">Cost Savings Delivered</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-purple-400 mb-2 neon-glow">99.9%</div>
                <div className="text-gray-300">Uptime Guarantee</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-yellow-400 mb-2 neon-glow">24/7</div>
                <div className="text-gray-300">Support Available</div>
              </div>
            </div>

            <div className="cyber-card p-8 shadow-lg">
        ...
        <section className="text-center cyber-card rounded-2xl p-12" aria-labelledby="cta-heading">
          <h2 id="cta-heading" className="text-3xl md:text-4xl font-bold text-white mb-6 holographic-text">

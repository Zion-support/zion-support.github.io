  ...
  return (
    <ErrorBoundary>
      ...
      <div className='min-h-screen bg-white'>
        ...
        {/* Promo: New Guide - Hyperautomation Business Playbook 2026 (secondary highlight) */}
        <section className="py-10 bg-white">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-white flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-lg">
              <div>
                <div className="text-sm font-semibold opacity-90 mb-2">New guide</div>
                <h3 className="text-2xl font-bold mb-2">AI 2026: Hyperautomation Business Playbook</h3>
                <p className="opacity-90 max-w-2xl">Practical blueprint to design, deploy, and scale AI-driven hyperautomation across your enterprise.</p>
              </div>
              <div className="shrink-0">
                <Link href="/blog/ai-2026-hyperautomation-business-playbook" className="bg-white text-purple-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100">
                  Read the Playbook
                </Link>
              </div>
            </div>

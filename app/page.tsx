...
import { Phone, Mail, MapPin, Clock, ArrowRight, Star, CheckCircle, Zap, Shield, Brain, Cloud, Code, BarChart, Users, Sparkles, Cpu, Target, Globe, Database, Smartphone, Lock, TrendingUp, Settings, Calendar, CheckSquare, FileText, MessageCircle, Heart, DollarSign, Box, Monitor, Share2 } from 'lucide-react';
...
const HomePage: React.FC = () => {
  ...
  const microSaasServices = [
    ...
    },
    {
      ...
      description: 'Analyze customer feedback with AI-powered sentiment analysis and insights.',
      href: '/ai-customer-feedback-analyzer',
      price: '$59-399/month',
      features: ['Sentiment Analysis', 'Trend Detection', 'Customer Segmentation', 'Automated Insights']
    }
  ];
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden" aria-labelledby="hero-heading">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              improve efficiency, and stay ahead of the competition. From AI-powered micro SAAS solutions
              to enterprise IT services, we provide everything you need to succeed.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="tel:+13024640950" 
                onClick={handlePhoneClick}
                className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 text-center inline-flex items-center justify-center"
              ...
              <a 
                ...
                className="border border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 text-center inline-flex items-center justify-center"
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-800/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Specialized software-as-a-service solutions designed to automate and optimize your business processes
              </p>
            </div>

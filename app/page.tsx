    ...
    <>
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          {/* Floating Neon Orbs */}
          <div className="absolute top-20 left-10 w-20 h-20 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full opacity-30 animate-pulse blur-sm"></div>
          <div className="absolute bottom-20 right-10 w-32 h-32 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full opacity-30 animate-pulse delay-1000 blur-sm"></div>
          <div className="absolute top-1/2 left-20 w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full opacity-30 animate-pulse delay-500 blur-sm"></div>
          <div className="absolute top-1/3 right-1/4 w-24 h-24 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full opacity-20 animate-pulse delay-700 blur-sm"></div>
          <div className="absolute bottom-1/3 left-1/3 w-28 h-28 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full opacity-25 animate-pulse delay-300 blur-sm"></div>
        </div>
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-purple-600/20 to-cyan-600/20 blur-xl"></div>
            </p>
            
            <p className="text-lg text-gray-400 mb-12 max-w-3xl mx-auto relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center relative z-10">
              <Link 
                to="/contact" 
                className="group relative bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-purple-700 hover:to-cyan-700 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 overflow-hidden"
              >
              ...
              <Link 
                to="/services" 
                className="group relative border-2 border-purple-400 text-purple-300 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-purple-400 hover:text-white transition-all duration-300 flex items-center gap-2 overflow-hidden"
              >
      ...
      <section className="py-20 bg-slate-900 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* AI Solutions */}
            <div className="group relative bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover:border-purple-500 transition-all duration-300 hover:transform hover:scale-105 overflow-hidden">
            ...
            {/* Cybersecurity */}
            <div className="group relative bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover:border-cyan-500 transition-all duration-300 hover:transform hover:scale-105 overflow-hidden">
            ...
            <div className="group relative bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover:border-green-500 transition-all duration-300 hover:transform hover:scale-105 overflow-hidden">
            ...
            <div className="group relative bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover:border-yellow-500 transition-all duration-300 hover:transform hover:scale-105 overflow-hidden">
            ...
            {/* Micro SaaS */}
            <div className="group relative bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover:border-pink-500 transition-all duration-300 hover:transform hover:scale-105 overflow-hidden">
            ...
            {/* 5G Solutions */}
            <div className="group relative bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover:border-indigo-500 transition-all duration-300 hover:transform hover:scale-105 overflow-hidden">

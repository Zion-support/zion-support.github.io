  ...
  const microSaasHighlights = [
    {
      ...
      description: "Transform email management with AI sentiment analysis, smart categorization, and automated response suggestions",
      price: "From $29/month",
    ...
    },
    {
      ...
      description: "Monitor customer sentiment across all channels with AI-powered analysis and predictive insights",
      price: "From $39/month",
    ...
    },
    {
      ...
      description: "Automatically categorize expenses with 98% accuracy using AI and OCR receipt scanning",
      price: "From $19/month",

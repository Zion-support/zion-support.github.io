...
import { CheckCircle, ArrowRight, Zap, Brain, Cloud, Shield, Database, Code, Smartphone, Cpu, Server, Wifi, BarChart3, Users, Clock, Star, Sparkles, Rocket, Target, TrendingUp, Globe, MessageSquare } from 'lucide-react'
...
const HomePage: React.FC = () => {
  ...
  const stats = [
    { number: '1,200+', label: 'Projects Completed', icon: <Rocket className="w-8 h-8" /> },
    ...
    { number: '48hr', label: 'Response Time', icon: <MessageSquare className="w-8 h-8" /> }
  ]

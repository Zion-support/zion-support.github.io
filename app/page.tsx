...
const HomePage: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'Chatbots & Virtual Assistants', description: 'Intelligent customer service automation', icon: MessageCircle },
    { name: 'Process Automation', description: 'Streamline workflows with AI automation', icon: Workflow }
  ];

  const itServices = [
    { name: 'Cloud Migration', description: 'Seamless transition to cloud infrastructure', icon: Cloud },
    { name: 'DevOps & CI/CD', description: 'Automated deployment and monitoring', icon: Settings },
    { name: 'API Development', description: 'RESTful and GraphQL API solutions', icon: Code },
    { name: 'Database Management', description: 'Optimized data storage and retrieval', icon: Database },
    { name: 'Security Audits', description: 'Comprehensive security assessments', icon: Shield },
    { name: 'Performance Optimization', description: 'Speed and efficiency improvements', icon: TrendingUp }
  ];
          ...
          >
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 max-w-7xl mx-auto mb-12 px-4">
                <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-4 sm:p-6 hover:scale-105 transition-all duration-300">
                ...
                <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-4 sm:p-6 hover:scale-105 transition-all duration-300 sm:col-span-2 lg:col-span-1 xl:col-span-1">
                  <div className="text-2xl sm:text-3xl mb-3">🌐</div>
          ...
          <section className="mb-16" aria-labelledby="services-heading">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12">
              <Suspense fallback={<ServiceCardSkeleton />}>
                <article className="bg-white/5 backdrop-blur-lg rounded-2xl p-4 sm:p-6 border border-white/10 hover:border-cyan-400/30 transition-all duration-300">

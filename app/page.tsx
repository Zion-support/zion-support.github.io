...
const HomePage: React.FC = () => {
  ...
  const aiServices = [
    ...
    },
    {
      ...
      description: 'Image recognition and visual intelligence solutions',
      icon: Eye
    },
    {
      name: 'Predictive Analytics',
      description: 'Data-driven insights and forecasting capabilities',
      icon: BarChart
    },
    {
    ...
    },
    {
      ...
      description: 'AI-driven workflow optimization and automation',
      icon: Workflow
    }
  ];
  ...
  const itServices = [
    ...
    },
    {
      ...
      description: 'Connecting disparate systems and platforms',
      icon: LinkIcon
    }
  ];

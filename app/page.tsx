...
import { ArrowRight, Zap, Shield, Globe, Database, Code, Cloud, Brain, Users, Target } from 'lucide-react'
  ...
  const microSaasTools = [
    {
      ...
      description: 'Intelligent project management with AI-powered prioritization and scheduling.',
    ...
    },
    {
      ...
      description: 'Smart financial planning with budgeting and investment analysis.',
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Powerful AI-driven tools designed to boost productivity and streamline operations
              </p>
            </div>

...
export default function HomePage() {
  return (
    <div className="animate-fade-in">
      ...
      <div className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="max-w-6xl mx-auto px-4 py-3 flex flex-col md:flex-row items-center gap-2 md:gap-4 justify-between">
          <div className="flex items-center gap-2 text-sm md:text-base">
            <span>✨ NEW 2026:</span>
            <Link href="/blog/ai-supply-chain-automation-2026" className="underline hover:text-yellow-200">Supply Chain Automation</Link>
            <span className="hidden md:inline">•</span>
            <Link href="/blog/ai-go-to-market-plays-2026" className="underline hover:text-yellow-200">GTM Plays</Link>
            <span className="hidden md:inline">•</span>
      ...
      <AIRetailAutomationBanner />
      <NewContent2026Banner />
      {/* Additional banners are available; showing a curated subset here */}
      <AIMultimodalEnterpriseBanner />
      <AIEnterpriseAutomationBanner />
      <AIDataAnalyticsEnterpriseBanner />
      <EnterpriseTransformationSuccessBanner />
      ...
      <section className="py-20 bg-gradient-to-br from-purple-50 to-blue-50">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Link href="/blog/ai-supply-chain-automation-2026" className="group">

      ...
      <div className=min-h-screen bg-white">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                ...
                <ul className="text-sm text-gray-500 space-y-1">
                  ...
                  <li>• Compliance Management</li></ul>
              </div></div>
          </div></section>
        {/* Features Section */}
        ...
        <section className="py-20 px-4 bg-blue-600">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className=flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/contact>                className="bg-white text-blue-600 px-8 py-3 rounded-lg hover:bg-gray-100 transition-colors"
              >
                Contact Us
              </Link>
              <Link to=/services">                className="border border-white text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition-colors"
              >
                Our Services
              </Link>
            </div>

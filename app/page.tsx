  ...
  const features = [
    {
      ...
      description:
        "Comprehensive AI solutions from chatbots to predictive analytics, fraud detection, and content generation",
    ...
    },
    {
      ...
      description:
        "Ready-to-use SaaS applications for social media, expense tracking, task management, and more",
    ...
    },
    {
      ...
      description:
        "Complete web and mobile development services with modern technologies and best practices",
    ...
    },
    {
      ...
      description:
        "Advanced cybersecurity, compliance, and data protection solutions for enterprise clients",
    ...
    },
    {
      ...
      description:
        "Cutting-edge technologies including blockchain, IoT, quantum computing, AR/VR, and edge computing",
    ...
    },
    {
      ...
      description:
        "24/7 support across 50+ countries with dedicated account managers and technical experts",
    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <h1
              className="text-5xl md:text-7xl font-bold mb-6 holographic-text cyber-glitch"
            ...
            <p className="text-lg text-gray-400 mb-12 max-w-3xl mx-auto leading-relaxed">
              ...
              cloud infrastructure, and enterprise-grade IT solutions. We help
              companies innovate, scale, and succeed in the digital age.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Discover our most popular AI and IT solutions designed to
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredServices.map((service: any, index: number) => (
              ...
              >
                <div
                  className={`w-16 h-16 rounded-lg bg-gradient-to-r ${service.gradient} p-4 mb-6 icon-bounce`}
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 rounded-full bg-gradient-to-r ${feature.gradient} p-4 mx-auto mb-4 icon-bounce`}
                >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="glass-card p-8 hover-lift transition-all duration-500">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                75+ AI-powered solutions including chatbots, document
                processing, fraud detection, predictive analytics, and
                specialized assistants for legal, medical, and educational
                sectors.
              </p>
              <div className="flex flex-wrap gap-2 mb-6">
            ...
            <div className="glass-card p-8 hover-lift transition-all duration-500">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                25+ ready-to-use SaaS applications for social media management,
...
<<<<<<< HEAD
            ...
            <div className="glass-card p-8 hover-lift transition-all duration-500">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Complete IT services including web development, mobile apps,
                cloud infrastructure, DevOps automation, security audits, and
            ...
            <div className="glass-card p-8 hover-lift transition-all duration-500">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Cutting-edge technologies including blockchain, IoT, quantum
                computing, AR/VR, edge computing, and robotic process
                automation.
              </p>
              <div className="flex flex-wrap gap-2 mb-6">
                <span className="px-3 py-1 bg-orange-500/10 text-orange-400 text-xs rounded-full border border-orange-500/20">
                  Blockchain
                </span>
                <span className="px-3 py-1 bg-orange-500/10 text-orange-400 text-xs rounded-full border border-orange-500/20">
                  IoT
            ...
            <div className="glass-card p-8 hover-lift transition-all duration-500">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                Enterprise-grade AI solutions including advanced chatbots, code
                assistants, workflow automation, and specialized AI tools for
            ...
            <div className="glass-card p-8 hover-lift transition-all duration-500">
              ...
              <p className="text-gray-400 mb-6 leading-relaxed">
                ...
                with enterprise solutions and 24/7 global support across 50+
                countries.
              </p>
              <div className="flex flex-wrap gap-2 mb-6">
                <span className="px-3 py-1 bg-teal-500/10 text-teal-400 text-xs rounded-full border border-teal-500/20">
                  From $9/mo
                </span>
                <span className="px-3 py-1 bg-teal-500/10 text-teal-400 text-xs rounded-full border border-teal-500/20">
                  24/7 Support

...
const HomePage: React.FC = () => {
  ...
  const aiServices = [
    { name: 'Machine Learning', description: 'Custom ML models for predictive analytics', icon: Brain },
    { name: 'Natural Language Processing', description: 'AI-powered text analysis and generation', icon: Code },
    { name: 'Computer Vision', description: 'Image recognition and visual intelligence', icon: Eye },
    { name: 'Predictive Analytics', description: 'Data-driven insights and forecasting', icon: BarChart },
    { name: 'Chatbots & Virtual Assistants', description: 'Intelligent conversational AI', icon: MessageCircle },
    { name: 'Process Automation', description: 'Streamline workflows with AI', icon: Workflow }
  ];
  ...
  const itServices = [
    ...
    { name: 'Database Management', description: 'Optimized database design and maintenance', icon: Database },

...
const HomePage: React.FC = () => {
  ...
  const microSAASServices = [
    ...
    },
    {
      ...
      icon: '✍️',
      price: '$69/month',
      features: ['SEO-optimized content', 'Multiple content types', 'Brand voice training', 'Plagiarism detection'],
      benefits: ['10x content output', '95% SEO score', '50% cost reduction'],
      link: '/ai-content-writer',
      popular: true
    },
    {
      title: 'AI Lead Generation',
      description: 'Automatically find and qualify leads using AI-powered prospecting',
      icon: '🎯',
      price: '$199/month',
      features: ['Smart lead scoring', 'Contact enrichment', 'Email sequences', 'CRM integration'],
      benefits: ['300% more qualified leads', '60% conversion rate', '25 hours saved/week'],
      link: '/ai-lead-generation',
      popular: true
    },
    {
      title: 'AI Invoice Generator',
      description: 'Automate invoice creation and management with AI-powered processing',
      icon: '🧾',
      price: '$49/month',
    ...
    },
    {
      ...
      icon: '📅',
      price: '$39/month',
      features: ['Smart scheduling', 'Time zone handling', 'Calendar sync', 'Meeting analytics'],
      benefits: ['80% scheduling efficiency', 'Zero double bookings', '5 hours saved/week'],
    ...
    },
    {
      ...
      icon: '💰',
      price: '$29/month',
      features: ['Receipt scanning', 'Auto-categorization', 'Tax preparation', 'Expense reports'],
      benefits: ['95% accuracy', 'Tax compliance', '2 hours saved/week'],
    ...
    },
    {
      ...
      icon: '🌐',
      price: '$79/month',
      features: ['AI design suggestions', 'Content generation', 'SEO optimization', 'Mobile responsive'],
      benefits: ['10x faster development', 'Professional results', 'No coding required'],
    ...
    },
    {
      ...
      icon: '📦',
      price: '$129/month',
      features: ['Demand forecasting', 'Reorder automation', 'Stock optimization', 'Analytics dashboard'],
    ...
    },
    {
      ...
      description: 'Generate legal documents and contracts with AI-powered templates and compliance',
      icon: '⚖️',
      price: '$199/month',
      features: ['Document templates', 'Compliance checking', 'Version control', 'Digital signatures'],
      benefits: ['90% time saved', 'Legal compliance', 'Error reduction'],
    ...
    },
    {
      ...
      icon: '💼',
      price: '$89/month',
      features: ['Portfolio analysis', 'Risk assessment', 'Goal tracking', 'Market insights'],
      benefits: ['Better returns', 'Risk management', 'Financial goals achieved'],
    ...
    },
    {
      ...
      benefits: ['99% accuracy', 'Real-time processing', 'Cost effective'],
    ...
    },
    {
      ...
      icon: '🎬',
      price: '$99/month',
      features: ['Auto-editing', 'Scene detection', 'Color correction', 'Audio enhancement'],
      benefits: ['10x faster editing', 'Professional quality', 'No skills required'],
    ...
    },
    {
      ...
      benefits: ['Hands-free operation', 'Increased productivity', 'Better accessibility'],
      link: '/ai-voice-assistant',
      popular: false
    },
    {
      title: 'AI Data Cleaner',
      description: 'Clean and standardize your data with AI-powered data quality tools',
      icon: '🧹',
      price: '$79/month',
      features: ['Duplicate detection', 'Data validation', 'Format standardization', 'Quality scoring'],
      benefits: ['95% data accuracy', 'Time savings', 'Better insights'],
      link: '/ai-data-cleaner',
      popular: false
    },
    {
      title: 'AI SEO Optimizer',
      description: 'Optimize your website for search engines with AI-powered SEO analysis',
      icon: '🔍',
      price: '$119/month',
      features: ['Keyword research', 'Content optimization', 'Technical SEO', 'Rank tracking'],
      benefits: ['200% traffic increase', 'Higher rankings', 'Better visibility'],
    ...
    },
    {
      ...
      icon: '⏰',
      price: '$49/month',
      features: ['Automatic tracking', 'Productivity analysis', 'Project billing', 'Team insights'],
      benefits: ['Accurate billing', 'Productivity insights', 'Better time management'],
      link: '/ai-time-tracker',
      popular: false
    },
    {
      title: 'AI Backup Manager',
      description: 'Automated backup solutions with AI-powered data protection and recovery',
      icon: '💾',
      price: '$69/month',
      features: ['Automated backups', 'Version control', 'Recovery testing', 'Cloud storage'],
      benefits: ['Data protection', 'Peace of mind', 'Quick recovery'],
    ...
    },
    {
      ...
      icon: '⚡',
      price: '$179/month',
      features: ['Process mapping', 'Automation rules', 'Integration APIs', 'Performance monitoring'],
      benefits: ['80% process efficiency', 'Error reduction', 'Cost savings'],
  ...
  const aiServices = [
    ...
    },
    {
      ...
      description: 'AI-powered cloud infrastructure and optimization services',
      icon: Cloud,
      price: '$1,800/month',
      features: ['Cloud AI Services', 'Auto-scaling', 'Cost Optimization', 'Performance Monitoring'],
      color: 'text-indigo-400'
    },
    {
      title: 'AI IoT Solutions',
      description: 'Internet of Things solutions with AI-powered data processing',
      icon: Settings,
      price: '$1,900/month',
      features: ['Sensor Data Analysis', 'Predictive Maintenance', 'Real-time Monitoring', 'Edge Computing'],
      color: 'text-teal-400'
    }
  ];
  ...
  const itServices = [
    ...
    },
    {
      ...
      icon: Briefcase,
      price: '$1,800/month',
      features: ['IT Strategy', 'Digital Transformation', 'Technology Assessment', 'Vendor Management'],
      color: 'text-indigo-400'
    },
    {
    ...
    },
    {
      ...
      icon: Code,
      price: '$2,500/month',
      features: ['Custom Applications', 'Legacy Modernization', 'API Development', 'Quality Assurance'],
      color: 'text-orange-400'
    },
    {

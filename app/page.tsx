    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="flex items-center justify-center min-h-screen px-6">
        <div className="max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            <Link 
              href="/contact" 
              className="border-2 border-gray-300 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-gray-900 transition-all duration-300"
            >
              Get Started
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">AI Innovation</h3>
              <p className="text-gray-600">
                Cutting-edge artificial intelligence solutions that drive business growth and efficiency.
              </p>
            </div>
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Scalable cloud solutions that ensure reliability, security, and performance for your business.
              </p>
            </div>
            <div className="text-center p-6">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <Link 
            href="/contact" 
            className="bg-white text-blue-600 px-10 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 inline-block"
          >
            Start Your Journey
          </Link>
        </div>

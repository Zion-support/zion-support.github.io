        ...
        <section className="mb-16" aria-labelledby="services-heading">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <article className="quantum-card p-4 sm:p-6 energy-pulse">
              ...
              <div className="mt-4">
                <div className="text-lg sm:text-xl font-bold text-cyan-400 mb-2 neon-text">Starting at $1,500/month</div>
                <a href="/ai-services" className="text-cyan-400 hover:text-cyan-300 font-medium text-sm sm:text-base transition-all duration-300 hover:neon-glow">
                  Learn More →
                </a>
              </div>
            ...
            <article className="quantum-card p-4 sm:p-6 energy-pulse">
              ...
              <div className="mt-4">
                <div className="text-lg sm:text-xl font-bold text-green-400 mb-2 neon-text">Starting at $2,500/month</div>
            ...
            <article className="quantum-card p-4 sm:p-6 energy-pulse">
              ...
              <div className="mt-4">
                <div className="text-lg sm:text-xl font-bold text-blue-400 mb-2 neon-text">Starting at $2,500/month</div>

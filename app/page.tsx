        ...
        <div className="container-page">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
            {[
              ...
              { key: 'V47', name: 'Smart CC Suggester', emoji: '👥', color: 'from-teal-500/20 to-cyan-500/10 border-teal-500/30',
                desc: 'Analyzes thread participants and email context → suggests missing CC recipients before every send. Never drop an important stakeholder from a Reply-All thread again.',
                tech: 'Org templates · Thread history · Cross-org patterns' },
              { key: 'V48', name: 'Sentiment Shift Detector', emoji: '🎭', color: 'from-red-500/20 to-orange-500/10 border-red-500/30',
                desc: 'Monitors tone changes within threads — detects frustration, satisfaction drops, and escalation signals. Adjusts response tone automatically when sentiment shifts.',
                tech: 'Valence lexicon · Escalation signals · De-escalation engine' },

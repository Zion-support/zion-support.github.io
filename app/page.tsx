...
import { ArrowRight, Zap, Shield, Globe, Database, Code, Cloud, CheckCircle, Smartphone, Wifi, BarChart3, Users, Settings, FileText, Lock, Brain, Cpu, Server } from 'lucide-react'
  ...
  const features = [
    {
      ...
      benefits: ['AI Content Generation - $99/month', 'AI Chatbot Builder - $149/month', 'AI Analytics - $199/month', 'AI Automation - $299/month'],
      link: '/ai-services'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta name="keywords" content="AI solutions, IT services, cloud computing, digital transformation, micro SAAS, 5G implementation" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900 ml-3">AI Innovation</h3>
              </div>
              <p className="text-gray-600">Cutting-edge AI solutions that adapt to your business needs and scale with your growth.</p>
            </div>
            <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600">Bank-level security with encryption, compliance standards, and advanced threat protection.</p>
            </div>
            <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              <div className="flex items-center mb-4">
              ...
              <p className="text-gray-600">Worldwide deployment and support for international businesses with 24/7 technical assistance.</p>
            </div>
            <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              <div className="flex items-center mb-4">
                <Database className="w-8 h-8 text-orange-500" />
                <h3 className="text-xl font-semibold text-gray-900 ml-3">Data Analytics</h3>
              </div>
              <p className="text-gray-600">Advanced data processing and analytics to drive informed business decisions.</p>
            </div>
            <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              <div className="flex items-center mb-4">
                <Code className="w-8 h-8 text-red-500" />
                <h3 className="text-xl font-semibold text-gray-900 ml-3">Custom Development</h3>
              </div>
              <p className="text-gray-600">Tailored software solutions built to meet your specific business requirements.</p>
            </div>
            <div className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              <div className="flex items-center mb-4">
                <Cloud className="w-8 h-8 text-cyan-500" />
                <h3 className="text-xl font-semibold text-gray-900 ml-3">Cloud Services</h3>
              </div>
              <p className="text-gray-600">Scalable cloud infrastructure and migration services for modern businesses.</p>
            </div>
          </div>
        </div>
      </section>

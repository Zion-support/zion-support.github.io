...
const HomePage: React.FC = () => {
  const services = [
    ...
    },
    {
      icon: CogIcon,
      title: 'IT Solutions',
      description: 'Comprehensive IT infrastructure, cloud services, and technology consulting.',
      href: '/it-solutions',
    ...
    },
    {
      ...
      description: 'Specialized micro SaaS applications designed to solve specific business challenges.',
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-900 text-white">
        {/* Hero Section */}
        <section className="relative overflow-hidden py-20 lg:py-32 matrix-bg">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <div className="inline-flex items-center space-x-2 bg-slate-800/50 px-4 py-2 rounded-full border border-purple-500/50 mb-8">
                ...
                <span className="text-purple-300 text-sm font-medium">Advanced Technology Solutions</span>
              </div>
              
              <h1 className="text-5xl lg:text-7xl font-bold mb-8 bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent cyber-text">
                Zion Tech Group
              </h1>
              
              <p className="text-xl lg:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
                Leading provider of AI-powered solutions, cybersecurity, cloud infrastructure, micro SaaS applications, and digital transformation services that drive innovation and growth.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                ...
                <Link
                  to="/about"
                  className="border-2 border-purple-400 text-purple-300 px-8 py-4 rounded-lg font-semibold hover:bg-purple-400 hover:text-white transition-all duration-300 hover-glow"
                >
                  Learn More
                </Link>
              </div>
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto">
                {stats.map((stat, index) => (
                  <div key={index} className="text-center hologram">
                    <div className="text-3xl lg:text-4xl font-bold text-purple-400 mb-2 cyber-text">
                      {stat.number}
                    </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font-bold mb-6">
                Our <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent cyber-text">Services</span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {services.map((service, index) => (
                <Link
                  key={index}
                  to={service.href}
                  className="group bg-slate-800/50 p-8 rounded-xl hover:bg-slate-700/50 transition-all duration-300 transform hover:scale-105 border border-slate-700 hover:border-purple-500/50 hover-lift hover-glow hologram"
                >
                  <div className={`w-16 h-16 bg-gradient-to-r ${service.gradient} rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 neon-border`}>

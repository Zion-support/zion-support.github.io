          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 mb-8 sm:mb-12 leading-relaxed max-w-3xl mx-auto">
                Transform your business with cutting-edge AI technology. We deliver intelligent solutions that drive growth, efficiency, and innovation.
              </p>
                ...
                <Suspense key={index} fallback={<ServiceCardSkeleton />}>
                  <article className="quantum-card p-4 sm:p-6 energy-pulse">
                    <div className="text-4xl sm:text-5xl mb-4 sm:mb-6 text-center cyber-scan-line">
                      <service.icon className="w-12 h-12 mx-auto text-blue-400" />
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <a href={`/services/${service.title.toLowerCase().replace(/\s+/g, '-')}`} className="text-blue-400 hover:text-blue-300 font-medium text-sm sm:text-base transition-all duration-300 hover:neon-glow">
                    Learn More →
                  </a>
                </div>
              </article>

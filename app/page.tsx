...
export default function HomePage() {
  return (
    <>
      ...
      <section className="relative min-h-screen animated-bg particles cyber-grid flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-6xl md:text-8xl font-bold mb-8 neon-text-purple glitch" data-text="Zion Tech Group">
              Zion Tech Group
            </h1>
            <p className="text-2xl md:text-3xl text-gray-300 mb-8 leading-relaxed">
              Next-Generation AI and IT Solutions
            </p>
            <p className="text-lg text-gray-400 mb-12 max-w-4xl mx-auto">
              Empowering businesses with cutting-edge artificial intelligence, cybersecurity solutions, 
              cloud infrastructure, and digital transformation services to drive unprecedented innovation and growth.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link 
                to="/contact" 
                className="group bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-10 py-5 rounded-lg font-semibold text-xl hover:from-purple-700 hover:to-cyan-700 transition-all duration-300 hover-lift hover-glow flex items-center gap-3"
              >
                Get Started Today
              ...
              <Link 
                to="/services" 
                className="group border-2 border-purple-400 text-purple-300 px-10 py-5 rounded-lg font-semibold text-xl hover:bg-purple-400 hover:text-white transition-all duration-300 hover-lift flex items-center gap-3"
              >
                Explore Services
                <ArrowRightIcon className="w-6 h-6 group-hover:translate-x-1 transition-transform" />
              </Link>
      ...
      <section className="py-20 bg-slate-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* AI Solutions */}
            <div className="group holographic-card p-8 rounded-xl hover-lift hover-glow transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform neon-glow-purple">
            ...
            {/* Cybersecurity */}
            <div className="group holographic-card p-8 rounded-xl hover-lift hover-glow transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform neon-glow-cyan">
            ...
            <div className="group holographic-card p-8 rounded-xl hover-lift hover-glow transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform neon-glow-green">
            ...
            <div className="group holographic-card p-8 rounded-xl hover-lift hover-glow transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform neon-glow-orange">
            ...
            {/* Micro SaaS */}
            <div className="group holographic-card p-8 rounded-xl hover-lift hover-glow transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-500 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform neon-glow-pink">
            ...
            {/* 5G Solutions */}
            <div className="group holographic-card p-8 rounded-xl hover-lift hover-glow transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform neon-glow-purple">
      ...
      <section className="py-20 bg-gradient-to-r from-slate-900 to-purple-900 matrix-rain">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <Link 
              to="/about" 
              className="inline-flex items-center gap-2 bg-white text-slate-900 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-colors hover-lift"
            >
      ...
      {/* Contact Section */}
      <section className="py-20 bg-slate-900 animated-bg">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 neon-text-purple">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="flex items-center justify-center gap-4 text-gray-300 group">
                <PhoneIcon className="w-6 h-6 text-purple-400 group-hover:scale-110 transition-transform" />
                <a href="tel:+13024640950" className="hover:text-purple-400 transition-colors">+1-302-464-0950</a>
              </div>
              <div className="flex items-center justify-center gap-4 text-gray-300 group">
                <EnvelopeIcon className="w-6 h-6 text-purple-400 group-hover:scale-110 transition-transform" />
                <a href="mailto:kleber@ziontechgroup.com" className="hover:text-purple-400 transition-colors">kleber@ziontechgroup.com</a>
              </div>
              <div className="flex items-center justify-center gap-4 text-gray-300 group">
                <MapPinIcon className="w-6 h-6 text-purple-400 group-hover:scale-110 transition-transform" />
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link 
                to="/contact" 
                className="bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-10 py-5 rounded-lg font-semibold text-xl hover:from-purple-700 hover:to-cyan-700 transition-all duration-300 hover-lift hover-glow"
              >
                Get In Touch
              </Link>
              <Link 
                to="/demo" 
                className="border-2 border-purple-400 text-purple-300 px-10 py-5 rounded-lg font-semibold text-xl hover:bg-purple-400 hover:text-white transition-all duration-300 hover-lift"
              >
                Schedule Demo
              </Link>
            </div>

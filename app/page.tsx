          ...
          <div className="container mx-auto px-4 py-12">
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {microSAASServices.slice(6, 12).map((service) => (
                    <li key={service.title}>
                      <a
                        href={service.link}
                        className="group flex items-center text-sm text-gray-300 hover:text-cyan-400 transition-colors"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <ul className="space-y-1">
                      ...
                      <li><a href="/team" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">Our Team</a></li>
                      <li><a href="/careers" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">Careers</a></li>
                      <li><a href="/case-studies" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">Case Studies</a></li>
                    </ul>
                  </div>
                  <div>
                    <h4 className="text-white font-medium mb-2">Support</h4>
                    <ul className="space-y-1">
                      <li><a href="/contact" className="text-sm text-gray-300 hover:text-cyan-400 transition-colors">Contact Us</a></li>
            ...
            <div className="border-t border-gray-700 mt-8 pt-8">
              <div className="flex flex-col md:flex-row justify-between items-center">
                ...
                <div className="flex space-x-6">
                  <a href="/privacy" className="text-sm text-gray-400 hover:text-cyan-400 transition-colors">Privacy Policy</a>
                  <a href="/terms" className="text-sm text-gray-400 hover:text-cyan-400 transition-colors">Terms of Service</a>
                  <a href="/cookies" className="text-sm text-gray-400 hover:text-cyan-400 transition-colors">Cookie Policy</a>
                  <a href="/gdpr" className="text-sm text-gray-400 hover:text-cyan-400 transition-colors">GDPR Compliance</a>
                </div>
              </div>
            </div>
          </div>

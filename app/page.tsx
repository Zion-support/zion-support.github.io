...
const HomePage: React.FC = () => {
  const features = [
    ...
    },
    {
      icon: Star,
      title: 'Innovation',
      description: 'We stay ahead of technology trends to deliver the best solutions.'
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI solutions, IT services, quantum computing, digital transformation, enterprise software" />
      </Helmet>

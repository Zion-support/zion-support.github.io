...
const HomePage: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI CRM', icon: Users, description: 'AI-powered customer relationship management' },
    { name: 'AI Cybersecurity', icon: Shield, description: 'Advanced threat protection' },
    { name: 'AI Data Analytics', icon: Database, description: 'Data-driven insights and analytics' }
  ];

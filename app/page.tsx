...
import { ArrowRight, Zap, Shield, Globe, Database, Code, Cloud, Smartphone, Brain, CheckCircle } from 'lucide-react'
...
export default function HomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      benefits: ['Cloud Migration - $2,500+', 'Cloud Infrastructure - $1,200/month', 'Cloud Security - $800/month', 'Multi-Cloud Strategy - $3,000+'],
      link: '/cloud-services'
    },
    {
      ...
      benefits: ['Business Intelligence - $1,500/month', 'Data Visualization - $800/month', 'Predictive Analytics - $2,200/month', 'Real-time Dashboards - $1,000/month'],
      link: '/data-analytics'
    },
    {
      ...
      benefits: ['DevOps Setup - $3,500+', 'CI/CD Pipeline - $1,800/month', 'Infrastructure as Code - $2,200/month', 'Monitoring & Alerting - $600/month'],
      link: '/devops'
    },
    {

...
const HomePage = React.memo(function HomePage() {
  return (
    <>
      <Helmet>
        <title>
          Zion Tech Group - Advanced AI and IT Solutions | Enterprise AI
          Transformation
        </title>
        <meta
          name='description'
        ...
        <meta
          name='keywords'
          content='AI solutions, enterprise AI, digital transformation, automation, cloud services, AI consulting, business intelligence'
        />
        ...
        <meta
          property='og:title'
          content='Zion Tech Group - Advanced AI and IT Solutions'
        />
        <meta
              ...
              <div className='grid md:grid-cols-3 gap-8'>
                <div className='bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow'>
                  ...
                  <p className='text-gray-600 mb-6'>
                    Advanced analytics and machine learning solutions that
                    provide actionable insights for strategic decision-making.
                  </p>
                  <Link
                    to='/services/ai-business-intelligence-2025'
                ...
                <div className='bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow'>
                  ...
                  <Link
                    to='/services/ai-cloud-infrastructure-2025'
                    className='text-indigo-600 font-medium hover:text-indigo-700'
                  >
                    Learn More →
                  </Link>
                ...
                <div className='bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow'>
                  ...
                  <p className='text-gray-600 mb-6'>
                    Protect your digital assets with advanced AI-powered
                    security solutions and threat detection systems.
                  </p>
                  <Link
                    to='/services/ai-cybersecurity-2025'
                    className='text-indigo-600 font-medium hover:text-indigo-700'
                  >
                    Learn More →
                  </Link>
            ...
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
              <div className='text-center mb-12'>
                ...
                <p className='text-lg text-gray-600'>
                  Discover our latest AI insights, case studies, and success
                  stories.
                </p>
              </div>
              ...
              <div className='grid md:grid-cols-3 gap-8'>
                <Link
                  to='/blog/ai-enterprise-transformation-2026'
                  className='group'
                >
                  <div className='bg-gray-50 rounded-lg p-6 hover:shadow-lg transition-shadow'>
                    ...
                    <p className='text-gray-600 mb-4'>
                      Master AI enterprise transformation with proven
                      strategies, ROI frameworks, and implementation roadmaps.
                    </p>
                ...
                <Link to='/blog/ai-autonomous-systems-2026' className='group'>
                  <div className='bg-gray-50 rounded-lg p-6 hover:shadow-lg transition-shadow'>
                    ...
                    <p className='text-gray-600 mb-4'>
                      Master autonomous AI systems with 300% ROI strategies and
                ...
                <Link
                  to='/case-studies/manufacturing-ai-transformation-2026'
                  className='group'
                >
                  <div className='bg-gray-50 rounded-lg p-6 hover:shadow-lg transition-shadow'>
                    <div className='flex items-center justify-between mb-4'>
                    ...
                    <p className='text-gray-600 mb-4'>
                      See how a global manufacturer achieved 60% cost reduction
                      and 90% efficiency improvement.
                    </p>
                    <div className='text-indigo-600 font-medium group-hover:text-indigo-700'>
                      View Case Study →
                    </div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
            ...
            <div className='border-t border-gray-800 mt-8 pt-8 text-center'>
              <p className='text-gray-400'>
                &copy; 2026 Zion Tech Group. All rights reserved. | Privacy

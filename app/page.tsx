...
import { CheckCircle, ArrowRight, Zap, Shield, Globe, Brain, Cloud, Smartphone, Database, Cpu, Lock, BarChart3 } from 'lucide-react';
...
const HomePage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      benefits: ['Cloud Migration - $1,200/month', 'Infrastructure Setup - $800/month', 'Security Solutions - $600/month', 'Cost Optimization - $400/month'],
      link: '/cloud-services'
    },
    {
    ...
    },
    {
      ...
      benefits: ['Process Automation - $3,000/month', 'Digital Workforce - $2,500/month', 'Customer Experience - $1,800/month', 'Data Strategy - $2,200/month'],

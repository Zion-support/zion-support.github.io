            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                ...
                <article className="cyber-card hologram-card p-4 sm:p-6">
                  ...
                  <h3 className="text-lg sm:text-2xl font-semibold text-white mb-3 sm:mb-4">Automation</h3>
                  <p className="text-gray-300 mb-3 sm:mb-4 text-sm sm:text-base">
                    Streamline your workflows with intelligent automation solutions that reduce manual work and increase efficiency.
                  </p>
                  <div className="text-center">
                ...
                <article className="cyber-card hologram-card p-4 sm:p-6">
                  ...
                  <p className="text-gray-300 mb-3 sm:mb-4 text-sm sm:text-base">
                    Scalable cloud infrastructure solutions designed to support your business growth and digital transformation.
                  </p>
                  <div className="text-center">
                    <div className="text-lg font-bold text-green-400 mb-2">Starting at $999/month</div>
                    <a href="/cloud-services" className="text-green-400 hover:text-green-300 font-medium text-sm sm:text-base">
                      Learn More →
                    </a>
                  </div>
                </article>

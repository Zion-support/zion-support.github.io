  ...
  return (
    <ErrorBoundary>
      ...
      <div className='min-h-screen bg-white'>
        ...
        {/* Promo: New Article - Autonomous Agents Infrastructure Blueprint 2026 */}
        <section className="py-12 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div>
                <div className="text-sm font-semibold text-purple-700 mb-2">New on the blog</div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">AI 2026: Autonomous Agents Infrastructure Blueprint</h3>
                <p className="text-gray-600 max-w-2xl">Reference architecture and operating model to run autonomous agents safely, reliably, and at scale across the enterprise.</p>
              </div>
              <div className="shrink-0">
                <Link href="/blog/ai-2026-autonomous-agents-infrastructure-blueprint" className="bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700">
                  Read Article
                </Link>
              </div>
            </div>
        ...
        {/* Promo: New Article - Edge AI Security Playbook 2025 */}
        <section className="py-12 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-xl shadow-lg p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
              <div>
                <div className="text-sm font-semibold text-purple-700 mb-2">New on the blog</div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">Edge AI Security Playbook 2025</h3>
                <p className="text-gray-600 max-w-2xl">Security patterns, controls, and architectures to safely deploy AI at the edge across distributed environments.</p>
              </div>
              <div className="shrink-0">
                <Link href="/blog/edge-ai-security-playbook-2025" className="bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700">
                  Read Article
                </Link>
              </div>
            </div>

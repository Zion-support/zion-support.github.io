...
import { ServiceCardSkeleton } from './components/EnhancedLoadingStates';
                ...
                <Suspense key={service.title} fallback={<ServiceCardSkeleton />}>
                  <article className="quantum-card p-4 sm:p-6 energy-pulse">
                    <div className="text-4xl sm:text-5xl mb-4 sm:mb-6 text-center cyber-scan-line">
                      {service.icon === Brain ? '🤖' : service.icon === Cloud ? '☁️' : service.icon === Cpu ? '⚙️' : '💼'}
                    </div>
                    ...
                    <div className="text-center mb-4">
                      <div className="text-cyan-400 font-semibold text-sm sm:text-base">{service.price}</div>
                    </div>
                    <div className="text-center">
                      <a 
                        href={service.href}
                        className="cyber-button text-sm sm:text-base px-4 py-2 inline-block">
                        Learn More
                      </a>
                    </div>
                  </article>

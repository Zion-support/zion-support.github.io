...
const HomePage: React.FC = () => {
  ...
  const microSAASServices = [
    ...
    // New Innovative Micro SAAS Services
    {
      ...
      price: '$89/month',
      originalPrice: '$129/month',
      features: ['Sentiment analysis', 'Action item extraction', 'Meeting analytics', 'Productivity insights', 'Follow-up automation', 'Team performance', 'Meeting optimization', 'ROI tracking'],
      benefits: ['25% more productive meetings', 'Zero missed action items', 'Better team engagement', 'Meeting ROI insights'],
    ...
    },
    {
      ...
      description: 'Intelligent contract analysis with risk assessment, compliance checking, and automated review. Legal AI at your fingertips.',
      icon: '📋',
      price: '$149/month',
      originalPrice: '$199/month',
      features: ['Contract analysis', 'Risk assessment', 'Compliance checking', 'Clause extraction', 'Automated review', 'Legal insights', 'Version comparison', 'Deadline tracking'],
      benefits: ['90% faster contract review', 'Reduced legal risks', 'Better compliance', 'Cost savings'],
    ...
    },
    {
      ...
      price: '$79/month',
      originalPrice: '$119/month',
      features: ['Demand forecasting', 'Automated reordering', 'Waste reduction', 'Stock optimization', 'Supplier management', 'Cost tracking', 'Analytics dashboard', 'Mobile alerts'],
      benefits: ['30% inventory cost reduction', 'Zero stockouts', 'Reduced waste', 'Better cash flow'],
    ...
    },
    {
      ...
      price: '$99/month',
      originalPrice: '$149/month',
      features: ['Behavior prediction', 'Churn prevention', 'Personalized recommendations', 'Customer segmentation', 'Lifetime value analysis', 'Engagement tracking', 'A/B testing', 'ROI measurement'],
      benefits: ['40% higher retention', 'Better customer experience', 'Increased lifetime value', 'Data-driven decisions'],
    ...
    {
      title: 'AI Energy Manager Pro',
      description: 'Smart energy management with consumption optimization, cost reduction, and sustainability tracking. Go green with AI.',
      icon: '⚡',
      price: '$69/month',
      originalPrice: '$99/month',
      features: ['Consumption optimization', 'Cost reduction', 'Sustainability tracking', 'Smart scheduling', 'Energy forecasting', 'Carbon footprint', 'Bill analysis', 'Green recommendations'],
      benefits: ['25% energy cost reduction', 'Carbon footprint tracking', 'Smart automation', 'Sustainability goals'],
    ...
    },
    {
      ...
      description: 'Professional translation with AI-powered accuracy, context understanding, and cultural adaptation. Break language barriers.',
      icon: '🌐',
      price: '$49/month',
      originalPrice: '$79/month',
      features: ['100+ languages', 'Context understanding', 'Cultural adaptation', 'Voice translation', 'Document translation', 'Real-time translation', 'Quality assurance', 'Team collaboration'],
      benefits: ['99% accuracy', 'Cultural context', 'Real-time translation', 'Professional quality'],
    ...
    },
    {
      ...
      description: 'Intelligent resume creation with ATS optimization, skill matching, and job-specific customization. Land your dream job.',
      icon: '📄',
      price: '$39/month',
      originalPrice: '$59/month',
      features: ['ATS optimization', 'Skill matching', 'Job-specific customization', 'Template library', 'Cover letter generation', 'Interview prep', 'Career insights', 'Portfolio integration'],
      benefits: ['90% ATS pass rate', 'Better job matches', 'Professional presentation', 'Career advancement'],
    ...
    },
    {
      ...
      description: 'Complete event management with AI-powered planning, vendor coordination, and attendee engagement. Perfect events every time.',
      icon: '🎉',
      price: '$89/month',
      originalPrice: '$129/month',
      features: ['Event planning', 'Vendor coordination', 'Attendee engagement', 'Budget management', 'Timeline creation', 'Venue selection', 'Catering coordination', 'Post-event analytics'],
      benefits: ['50% planning time saved', 'Better attendee experience', 'Cost optimization', 'Stress-free events'],
    ...
    {
      title: 'AI Learning Path Pro',
      description: 'Personalized learning with AI-curated content, skill assessment, and progress tracking. Master any skill faster.',
      icon: '🎓',
      price: '$59/month',
      originalPrice: '$89/month',
      features: ['Personalized content', 'Skill assessment', 'Progress tracking', 'Learning paths', 'Interactive lessons', 'Certification prep', 'Peer learning', 'Achievement system'],
      benefits: ['3x faster learning', 'Personalized approach', 'Better retention', 'Career advancement'],
    ...
    },
    {
      ...
      description: 'Smart home control with AI-powered automation, energy optimization, and security monitoring. Transform your living space.',
      icon: '🏠',
      price: '$79/month',
      originalPrice: '$119/month',
      features: ['Smart automation', 'Energy optimization', 'Security monitoring', 'Voice control', 'Scene creation', 'Device integration', 'Remote access', 'Analytics dashboard'],
      benefits: ['30% energy savings', 'Enhanced security', 'Convenience', 'Cost reduction'],
    ...
    },
    {
      ...
      description: 'Intelligent travel planning with personalized itineraries, cost optimization, and real-time updates. Travel smarter, not harder.',
      icon: '✈️',
      price: '$49/month',
      originalPrice: '$79/month',
      features: ['Personalized itineraries', 'Cost optimization', 'Real-time updates', 'Booking integration', 'Weather alerts', 'Local insights', 'Budget tracking', 'Group planning'],
      benefits: ['40% cost savings', 'Perfect itineraries', 'Real-time updates', 'Stress-free travel'],
    ...
    },
    {
      ...
      description: 'Smart investment management with portfolio analysis, risk assessment, and automated rebalancing. Grow your wealth intelligently.',
      icon: '📈',
      price: '$99/month',
      originalPrice: '$149/month',
      features: ['Portfolio analysis', 'Risk assessment', 'Automated rebalancing', 'Market insights', 'Tax optimization', 'Performance tracking', 'Goal setting', 'Alert system'],
      benefits: ['20% better returns', 'Risk management', 'Tax optimization', 'Automated management'],
    ...
    },
    {
      ...
      description: 'Creative recipe creation with dietary preferences, nutrition analysis, and meal planning. Cook like a professional chef.',
      icon: '👨‍🍳',
      price: '$29/month',
      originalPrice: '$49/month',
      features: ['Recipe generation', 'Dietary preferences', 'Nutrition analysis', 'Meal planning', 'Shopping lists', 'Cooking timers', 'Photo recognition', 'Community sharing'],
      benefits: ['Endless recipe variety', 'Nutritional balance', 'Meal planning', 'Cooking skills'],
    ...
    {
      title: 'AI Language Tutor Pro',
      description: 'Personalized language learning with AI conversation practice, pronunciation coaching, and cultural immersion. Master any language.',
      icon: '🗣️',
      price: '$59/month',
      originalPrice: '$89/month',
      features: ['Conversation practice', 'Pronunciation coaching', 'Cultural immersion', 'Progress tracking', 'Adaptive learning', 'Voice recognition', 'Grammar correction', 'Certification prep'],
      benefits: ['3x faster fluency', 'Perfect pronunciation', 'Cultural understanding', 'Confident speaking'],
    ...
    {
      title: 'AI Garden Planner Pro',
      description: 'Smart gardening with plant recommendations, care schedules, and harvest optimization. Grow the perfect garden.',
      icon: '🌱',
      price: '$39/month',
      originalPrice: '$59/month',
      features: ['Plant recommendations', 'Care schedules', 'Harvest optimization', 'Weather integration', 'Pest detection', 'Soil analysis', 'Garden layout', 'Progress tracking'],
      benefits: ['Higher yields', 'Healthy plants', 'Optimal timing', 'Gardening success'],
    ...
    },
    {
      ...
      description: 'Intelligent sleep analysis with personalized recommendations, sleep tracking, and wellness insights. Sleep better, live better.',
      icon: '😴',
      price: '$49/month',
      originalPrice: '$79/month',
      features: ['Sleep analysis', 'Personalized recommendations', 'Sleep tracking', 'Wellness insights', 'Smart alarms', 'Environment control', 'Habit tracking', 'Progress reports'],
      benefits: ['Better sleep quality', 'Increased energy', 'Health improvement', 'Productivity boost'],
    ...
    },
    {
      ...
      description: 'Comprehensive pet care with health monitoring, behavior analysis, and personalized recommendations. Keep your pets healthy and happy.',
      icon: '🐕',
      price: '$39/month',
      originalPrice: '$59/month',
      features: ['Health monitoring', 'Behavior analysis', 'Personalized recommendations', 'Vet reminders', 'Nutrition tracking', 'Exercise planning', 'Emergency alerts', 'Health records'],
      benefits: ['Better pet health', 'Early problem detection', 'Cost savings', 'Peace of mind'],
      link: '/ai-pet-care',
      popular: true,
      category: 'Pet Care',
      rating: 4.8,
    ...
    },
    {
      ...
      description: 'Personalized meditation with AI-guided sessions, stress analysis, and mindfulness tracking. Find your inner peace.',
      icon: '🧘',
      price: '$29/month',
      originalPrice: '$49/month',
      features: ['AI-guided sessions', 'Stress analysis', 'Mindfulness tracking', 'Personalized programs', 'Progress monitoring', 'Mood tracking', 'Sleep integration', 'Community support'],
      benefits: ['Reduced stress', 'Better focus', 'Emotional balance', 'Mental wellness'],
    ...
    },
    {
      ...
      description: 'Smart habit formation with AI motivation, progress analysis, and goal achievement. Build better habits that stick.',
      icon: '🎯',
      price: '$19/month',
      originalPrice: '$39/month',
      features: ['Habit tracking', 'AI motivation', 'Progress analysis', 'Goal setting', 'Streak tracking', 'Reward system', 'Social accountability', 'Insights dashboard'],
      benefits: ['Better habit formation', 'Increased motivation', 'Goal achievement', 'Life improvement'],
    ...
    {
      title: 'AI Weather Intelligence Pro',
      description: 'Advanced weather forecasting with personalized alerts, activity recommendations, and climate insights. Weather that works for you.',
      icon: '🌤️',
      price: '$39/month',
      originalPrice: '$59/month',
      features: ['Advanced forecasting', 'Personalized alerts', 'Activity recommendations', 'Climate insights', 'Location tracking', 'Severe weather warnings', 'Historical data', 'API access'],
      benefits: ['Accurate forecasts', 'Personalized insights', 'Safety alerts', 'Activity optimization'],
    ...
    },
    {
      ...
      description: 'Advanced memory training with AI-powered techniques, spaced repetition, and cognitive enhancement. Unlock your memory potential.',
      icon: '🧠',
      price: '$49/month',
      originalPrice: '$79/month',
      features: ['Memory techniques', 'Spaced repetition', 'Cognitive enhancement', 'Personalized training', 'Progress tracking', 'Memory games', 'Recall practice', 'Performance analytics'],
      benefits: ['Better memory', 'Cognitive enhancement', 'Learning acceleration', 'Mental sharpness'],
  ...
  const aiServices = [
    ...
    // New Advanced AI Services
    {
      ...
      description: 'Revolutionary drug discovery with AI-powered molecular design, toxicity prediction, and clinical trial optimization. Accelerate pharmaceutical innovation.',
      icon: Stethoscope,
      price: '$5,000/month',
      originalPrice: '$7,500/month',
      features: ['Molecular Design', 'Toxicity Prediction', 'Clinical Trial Optimization', 'Drug Repurposing', 'Side Effect Analysis', 'Patent Analysis', 'Regulatory Compliance', 'Research Collaboration'],
    ...
    },
    {
      ...
      description: 'Advanced climate modeling with AI-powered weather prediction, environmental monitoring, and sustainability optimization. Fight climate change with AI.',
      icon: Globe,
      price: '$2,500/month',
      originalPrice: '$3,500/month',
      features: ['Climate Modeling', 'Weather Prediction', 'Environmental Monitoring', 'Carbon Footprint Analysis', 'Sustainability Optimization', 'Disaster Prediction', 'Resource Management', 'Policy Analysis'],
      benefits: ['Better climate predictions', 'Environmental protection', 'Resource optimization', 'Disaster prevention'],
    ...
    },
    {
      ...
      features: ['Satellite Management', 'Space Debris Tracking', 'Mission Optimization', 'Orbital Mechanics', 'Communication Systems', 'Navigation Assistance', 'Data Analysis', 'Mission Planning'],
      benefits: ['Enhanced space missions', 'Better satellite management', 'Improved safety', 'Cost optimization'],
    ...
    },
    {
      ...
      description: 'Complete metaverse solutions with AI-powered virtual worlds, avatar creation, and immersive experiences. Build the future of digital interaction.',
      icon: Cpu,
      price: '$3,500/month',
      originalPrice: '$5,000/month',
      features: ['Virtual World Creation', 'Avatar Generation', 'Immersive Experiences', 'AI NPCs', 'Virtual Economy', 'Social Interaction', 'Cross-platform Integration', 'Real-time Rendering'],
      benefits: ['Immersive experiences', 'AI-powered interactions', 'Scalable virtual worlds', 'Future-ready technology'],
    ...
    },
    {
      ...
      description: 'Advanced biotechnology with AI-powered genetic analysis, protein folding, and synthetic biology. Revolutionize life sciences with AI.',
      icon: Stethoscope,
      price: '$4,500/month',
      originalPrice: '$6,500/month',
      features: ['Genetic Analysis', 'Protein Folding', 'Synthetic Biology', 'Drug Design', 'Biomarker Discovery', 'Personalized Medicine', 'Lab Automation', 'Research Optimization'],
      benefits: ['Faster research', 'Better treatments', 'Personalized medicine', 'Cost reduction'],
    ...
    },
    {
      ...
      description: 'Comprehensive smart city solutions with AI-powered traffic management, energy optimization, and citizen services. Build cities of the future.',
      icon: Building,
      price: '$3,000/month',
      originalPrice: '$4,500/month',
      features: ['Traffic Management', 'Energy Optimization', 'Citizen Services', 'Public Safety', 'Environmental Monitoring', 'Infrastructure Management', 'Data Analytics', 'IoT Integration'],
      benefits: ['Better city management', 'Improved citizen experience', 'Resource optimization', 'Sustainable development'],
      link: '/ai-smart-city',
      popular: true,
      category: 'Smart City',
      rating: 4.8,
    ...
    },
    {
      ...
      description: 'Advanced edge computing with AI-powered real-time processing, low-latency inference, and distributed intelligence. Bring AI to the edge.',
      icon: Cpu,
      price: '$2,200/month',
      originalPrice: '$3,200/month',
      features: ['Real-time Processing', 'Low-latency Inference', 'Distributed Intelligence', 'Edge AI Models', 'IoT Integration', 'Bandwidth Optimization', 'Security', 'Scalability'],
    ...
    },
    {
      ...
      description: 'Revolutionary quantum machine learning with quantum algorithms, optimization, and hybrid classical-quantum systems. Unlock quantum advantage.',
      icon: Cpu,
      price: '$6,000/month',
      originalPrice: '$9,000/month',
      features: ['Quantum Algorithms', 'Quantum Optimization', 'Hybrid Systems', 'Quantum Neural Networks', 'Quantum Data Processing', 'Quantum Simulation', 'Research Collaboration', 'Training Programs'],
      benefits: ['Exponential speedup', 'Quantum advantage', 'Complex problem solving', 'Future-ready technology'],
      link: '/ai-quantum-ml',
      popular: true,
      category: 'Quantum AI',
      rating: 4.9,
    ...
    },
    {
      ...
      description: 'Complete autonomous vehicle solutions with AI-powered navigation, safety systems, and fleet management. Drive the future of transportation.',
      icon: Car,
      price: '$4,500/month',
      originalPrice: '$6,500/month',
      features: ['Autonomous Navigation', 'Safety Systems', 'Fleet Management', 'Sensor Fusion', 'Path Planning', 'Object Detection', 'Traffic Analysis', 'Predictive Maintenance'],
      benefits: ['Enhanced safety', 'Efficient transportation', 'Reduced accidents', 'Cost optimization'],
    ...
    },
    {
      ...
      description: 'Advanced digital twin solutions with AI-powered simulation, predictive modeling, and real-time monitoring. Create perfect digital replicas.',
      icon: Cpu,
      price: '$3,200/month',
      originalPrice: '$4,800/month',
      features: ['Digital Simulation', 'Predictive Modeling', 'Real-time Monitoring', 'Virtual Testing', 'Performance Optimization', 'Maintenance Prediction', 'Data Integration', 'Visualization'],
      benefits: ['Better predictions', 'Reduced downtime', 'Cost savings', 'Improved performance'],
    ...
    },
    {
      ...
      description: 'Next-generation robotics with AI-powered control, human-robot interaction, and autonomous operation. Build intelligent robots.',
      icon: Settings,
      price: '$3,800/month',
      originalPrice: '$5,500/month',
      features: ['AI Control Systems', 'Human-Robot Interaction', 'Autonomous Operation', 'Sensor Integration', 'Learning Capabilities', 'Safety Systems', 'Custom Development', 'Integration Support'],
      benefits: ['Intelligent automation', 'Human-robot collaboration', 'Enhanced safety', 'Flexible operation'],
    ...
    },
    {
      ...
      description: 'Advanced AI cybersecurity with threat hunting, behavioral analysis, and automated response. Protect against next-generation threats.',
      icon: Shield,
      price: '$2,800/month',
      originalPrice: '$4,200/month',
      features: ['Threat Hunting', 'Behavioral Analysis', 'Automated Response', 'Zero-day Detection', 'Incident Response', 'Compliance Monitoring', 'Security Training', '24/7 Monitoring'],
      benefits: ['Proactive security', 'Faster threat detection', 'Automated response', 'Better compliance'],
    ...
    },
    {
      ...
      description: 'Comprehensive financial technology with AI-powered trading, risk management, and fraud detection. Revolutionize financial services.',
      icon: CreditCard,
      price: '$2,500/month',
      originalPrice: '$3,800/month',
      features: ['Algorithmic Trading', 'Risk Management', 'Fraud Detection', 'Credit Scoring', 'Regulatory Compliance', 'Real-time Analysis', 'Portfolio Optimization', 'API Integration'],
      benefits: ['Better trading performance', 'Reduced risk', 'Fraud prevention', 'Regulatory compliance'],
      link: '/ai-fintech-solutions',
      popular: true,
      category: 'FinTech',
      rating: 4.8,
      users: '250+',
    ...
    {
      title: 'AI HealthTech Platform',
      description: 'Complete health technology with AI-powered diagnostics, treatment optimization, and patient monitoring. Transform healthcare delivery.',
      icon: Stethoscope,
      price: '$3,500/month',
      originalPrice: '$5,200/month',
      features: ['AI Diagnostics', 'Treatment Optimization', 'Patient Monitoring', 'Medical Imaging', 'Drug Discovery', 'Clinical Trials', 'Telemedicine', 'Data Security'],
      benefits: ['Better diagnoses', 'Improved treatments', 'Cost reduction', 'Better patient outcomes'],
      link: '/ai-healthtech-platform',
      popular: true,
      category: 'HealthTech',
      rating: 4.9,
      users: '180+',
    ...
    },
    {
      ...
      description: 'Revolutionary education technology with AI-powered personalized learning, assessment, and content generation. Transform education.',
      icon: GraduationCap,
      price: '$1,800/month',
      originalPrice: '$2,700/month',
      features: ['Personalized Learning', 'AI Assessment', 'Content Generation', 'Adaptive Curriculum', 'Student Analytics', 'Teacher Tools', 'Accessibility Features', 'Progress Tracking'],
      benefits: ['Better learning outcomes', 'Personalized education', 'Teacher efficiency', 'Student engagement'],
      link: '/ai-edtech-solutions',
      popular: true,
      category: 'EdTech',
      rating: 4.8,
      users: '500+',
    ...
    {
      title: 'AI RetailTech Solutions',
      description: 'Advanced retail technology with AI-powered customer insights, inventory optimization, and personalized shopping. Revolutionize retail.',
      icon: ShoppingCart,
      price: '$2,200/month',
      originalPrice: '$3,300/month',
      features: ['Customer Insights', 'Inventory Optimization', 'Personalized Shopping', 'Demand Forecasting', 'Price Optimization', 'Supply Chain', 'Customer Service', 'Analytics Dashboard'],
      benefits: ['Better customer experience', 'Optimized inventory', 'Increased sales', 'Cost reduction'],
      link: '/ai-retailtech-solutions',
      popular: true,
      category: 'RetailTech',
      rating: 4.7,
      users: '350+',
  ...
  const itServices = [
    ...
    // New Advanced IT Services
    {
      ...
      description: 'Complete AI infrastructure with GPU clusters, model deployment, and performance optimization. Power your AI initiatives.',
      icon: Cpu,
      price: '$2,800/month',
      originalPrice: '$4,200/month',
      features: ['GPU Cluster Management', 'Model Deployment', 'Performance Optimization', 'Auto-scaling', 'Monitoring', 'Cost Optimization', 'Security', '24/7 Support'],
      benefits: ['Optimal AI performance', 'Cost efficiency', 'Scalable infrastructure', 'Expert management'],
    ...
    },
    {
      ...
      description: 'Advanced quantum computing infrastructure with quantum processors, simulators, and development environments. Access quantum power.',
      icon: Cpu,
      price: '$5,500/month',
      originalPrice: '$8,500/month',
      features: ['Quantum Processors', 'Quantum Simulators', 'Development Environments', 'Quantum Algorithms', 'Research Tools', 'Training Programs', 'Expert Support', 'Custom Solutions'],
      benefits: ['Quantum advantage', 'Cutting-edge technology', 'Research acceleration', 'Future-ready solutions'],
    ...
    },
    {
      ...
      description: 'Complete metaverse development with virtual worlds, avatars, and immersive experiences. Build the future of digital interaction.',
      icon: Globe,
      price: '$4,200/month',
      originalPrice: '$6,300/month',
      features: ['Virtual World Creation', 'Avatar Systems', 'Immersive Experiences', 'Cross-platform Integration', 'Real-time Rendering', 'AI Integration', 'Monetization Tools', 'Analytics'],
      benefits: ['Immersive experiences', 'Scalable platforms', 'Future-ready technology', 'Monetization opportunities'],
    ...
    },
    {
      ...
      description: 'Advanced edge computing with real-time processing, low-latency applications, and distributed intelligence. Bring computing to the edge.',
      icon: Cpu,
      price: '$1,800/month',
      originalPrice: '$2,700/month',
      features: ['Edge Servers', 'Real-time Processing', 'Low-latency Applications', 'IoT Integration', 'Data Processing', 'Security', 'Monitoring', 'Scalability'],
      benefits: ['Ultra-low latency', 'Real-time processing', 'Reduced bandwidth', 'Enhanced security'],
    ...
    },
    {
      ...
      description: 'Comprehensive climate technology with environmental monitoring, carbon tracking, and sustainability optimization. Fight climate change.',
      icon: Globe,
      price: '$2,200/month',
      originalPrice: '$3,300/month',
      features: ['Environmental Monitoring', 'Carbon Tracking', 'Sustainability Optimization', 'Climate Modeling', 'Data Analytics', 'Reporting Tools', 'IoT Sensors', 'AI Integration'],
      benefits: ['Environmental impact', 'Sustainability goals', 'Cost savings', 'Compliance'],
    ...
    },
    {
      ...
      description: 'Advanced space technology with satellite management, space debris tracking, and mission optimization. Explore the cosmos.',
      icon: Globe,
      price: '$4,800/month',
      originalPrice: '$7,200/month',
      features: ['Satellite Management', 'Space Debris Tracking', 'Mission Optimization', 'Communication Systems', 'Data Analysis', 'Navigation Systems', 'Research Tools', 'Expert Support'],
      benefits: ['Enhanced space missions', 'Better satellite management', 'Improved safety', 'Cost optimization'],
    ...
    },
    {
      ...
      description: 'Specialized biotechnology IT with lab automation, data analysis, and research optimization. Accelerate life sciences research.',
      icon: Stethoscope,
      price: '$3,500/month',
      originalPrice: '$5,250/month',
      features: ['Lab Automation', 'Data Analysis', 'Research Optimization', 'Sample Management', 'Compliance Tools', 'Integration', 'Security', 'Expert Support'],
      benefits: ['Faster research', 'Better data management', 'Compliance', 'Cost reduction'],
    ...
    },
    {
      ...
      description: 'Next-generation robotics with AI control, human-robot interaction, and autonomous operation. Build intelligent robots.',
      icon: Settings,
      price: '$4,500/month',
      originalPrice: '$6,750/month',
      features: ['AI Control Systems', 'Human-Robot Interaction', 'Autonomous Operation', 'Sensor Integration', 'Safety Systems', 'Custom Development', 'Integration', 'Training'],
      benefits: ['Intelligent automation', 'Human-robot collaboration', 'Enhanced safety', 'Flexible operation'],
    ...
    },
    {
      ...
      description: 'Advanced digital twin solutions with real-time simulation, predictive modeling, and virtual testing. Create perfect digital replicas.',
      icon: Cpu,
      price: '$3,800/month',
      originalPrice: '$5,700/month',
      features: ['Real-time Simulation', 'Predictive Modeling', 'Virtual Testing', 'Data Integration', 'Visualization', 'Performance Optimization', 'Maintenance Prediction', 'Custom Development'],
      benefits: ['Better predictions', 'Reduced downtime', 'Cost savings', 'Improved performance'],
    ...
    },
    {
      ...
      description: 'Next-generation cybersecurity with AI-powered threat detection, zero-trust architecture, and automated response. Protect against advanced threats.',
      icon: Shield,
      price: '$3,200/month',
      originalPrice: '$4,800/month',
      features: ['AI Threat Detection', 'Zero-Trust Architecture', 'Automated Response', 'Behavioral Analysis', 'Incident Response', 'Compliance', 'Security Training', '24/7 Monitoring'],
      benefits: ['Proactive security', 'Faster threat detection', 'Automated response', 'Better compliance'],
    ...
    },
    {
      ...
      description: 'Comprehensive smart city technology with traffic management, energy optimization, and citizen services. Build cities of the future.',
      icon: Building,
      price: '$3,500/month',
      originalPrice: '$5,250/month',
      features: ['Traffic Management', 'Energy Optimization', 'Citizen Services', 'Public Safety', 'Environmental Monitoring', 'IoT Integration', 'Data Analytics', 'Custom Development'],
      benefits: ['Better city management', 'Improved citizen experience', 'Resource optimization', 'Sustainable development'],
    ...
    },
    {
      ...
      description: 'Complete financial technology infrastructure with trading systems, payment processing, and regulatory compliance. Power financial innovation.',
      icon: CreditCard,
      price: '$2,800/month',
      originalPrice: '$4,200/month',
      features: ['Trading Systems', 'Payment Processing', 'Regulatory Compliance', 'Risk Management', 'Data Security', 'API Integration', 'Monitoring', '24/7 Support'],
      benefits: ['Secure transactions', 'Regulatory compliance', 'High performance', 'Cost efficiency'],
      link: '/fintech-infrastructure',
      popular: true,
      category: 'FinTech',
      rating: 4.8,
      users: '200+',
    ...
    },
    {
      ...
      description: 'Complete health technology infrastructure with patient management, medical imaging, and telemedicine. Transform healthcare delivery.',
      icon: Stethoscope,
      price: '$3,200/month',
      originalPrice: '$4,800/month',
      features: ['Patient Management', 'Medical Imaging', 'Telemedicine', 'Data Security', 'Compliance', 'Integration', 'Analytics', '24/7 Support'],
      benefits: ['Better patient care', 'Improved efficiency', 'Data security', 'Compliance'],
    ...
    },
    {
      ...
      description: 'Comprehensive education technology with learning management, student analytics, and virtual classrooms. Transform education delivery.',
      icon: GraduationCap,
      price: '$1,500/month',
      originalPrice: '$2,250/month',
      features: ['Learning Management', 'Student Analytics', 'Virtual Classrooms', 'Content Management', 'Assessment Tools', 'Integration', 'Security', 'Support'],
      benefits: ['Better learning outcomes', 'Improved efficiency', 'Student engagement', 'Cost reduction'],
    ...
    },
    {
      ...
      description: 'Advanced retail technology with customer analytics, inventory management, and personalized shopping. Revolutionize retail operations.',
      icon: ShoppingCart,
      price: '$2,000/month',
      originalPrice: '$3,000/month',
      features: ['Customer Analytics', 'Inventory Management', 'Personalized Shopping', 'Point of Sale', 'E-commerce Integration', 'Analytics', 'Security', 'Support'],
      benefits: ['Better customer experience', 'Optimized operations', 'Increased sales', 'Cost reduction'],

...
{ emoji: '🏆', label: `${serviceCount}+ Services`, sub: 'AI & IT catalog', color: 'from-amber-500/20 to-yellow-500/10' },
      ...
      {/* ── Our Services & Solutions — Full Catalog ── */}
      <section className="py-20 border-t border-slate-800 bg-gradient-to-b from-slate-900/50 to-slate-950">
        <div className="container-page">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-14">
            {[
              { emoji: "🧠", title: "AI & Machine Learning", desc: "Custom LLM fine-tuning, RAG systems, neural architecture design, and AI product development. From concept to production in weeks.", price: "From $2,500/mo", href: "/ai-ml-platform", color: "from-purple-500/20 to-indigo-500/20 border-purple-500/20", tag: "AI Services" },
              { emoji: "☁️", title: "Cloud Infrastructure", desc: "AWS, Azure & GCP architecture, migration, cost optimization, and 24/7 managed services. 99.9% uptime SLA guaranteed.", price: "From $1,800/mo", href: "/cloud-solutions", color: "from-sky-500/20 to-blue-500/20 border-sky-500/20", tag: "Cloud Services" },
              { emoji: "🔐", title: "Cybersecurity & Compliance", desc: "Penetration testing, SOC 2 readiness, GDPR compliance, zero-trust architecture, and 24/7 threat monitoring.", price: "From $3,000/mo", href: "/cybersecurity", color: "from-red-500/20 to-orange-500/20 border-red-500/20", tag: "Security" },
              { emoji: "📊", title: "Data Analytics & BI", desc: "Real-time dashboards, predictive analytics, data warehousing, ETL pipelines, and custom BI solutions.", price: "From $1,500/mo", href: "/smart-analytics-dashboard", color: "from-green-500/20 to-emerald-500/20 border-green-500/20", tag: "Data Services" },
              { emoji: "🤖", title: "Business Automation", desc: "Workflow automation, RPA bots, intelligent document processing, and end-to-end process orchestration. Save 20+ hours/week.", price: "From $800/mo", href: "/workflow-automation", color: "from-pink-500/20 to-rose-500/20 border-pink-500/20", tag: "Automation" },
              { emoji: "🖥️", title: "IT Services & Support", desc: "Help desk, system administration, network management, software development, and IT consulting. Remote & on-site.", price: "From $500/mo", href: "/it-services", color: "from-blue-500/20 to-cyan-500/20 border-blue-500/20", tag: "IT Services" },
            ].map((svc, i) => (
              <a key={i} href={svc.href} className={`group relative flex flex-col gap-3 p-6 rounded-2xl border bg-gradient-to-br ${svc.color} hover:scale-[1.02] transition-transform`}>
                <div className="flex items-start justify-between">
          ...
          <div className="mb-14">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { name: "Project-Based", price: "From $5,000", desc: "Fixed-scope projects with clear deliverables. Ideal for MVPs, migrations, and one-time implementations.", features: ["Fixed timeline & budget", "Dedicated project manager", "Source code ownership", "90-day support included"], cta: "Get a Quote", color: "border-slate-700", btn: "btn-secondary" },
                { name: "Monthly Retainer", price: "From $2,000/mo", desc: "Ongoing partnership with dedicated hours each month. Priority support and consistent innovation cadence.", features: ["Flexible monthly hours", "Priority response SLA", "Quarterly strategy reviews", "Unused hours roll over"], cta: "Start a Retainer", color: "border-purple-500/40", btn: "btn-primary" },
                { name: "Enterprise", price: "Custom", desc: "Full-stack teams embedded in your organization. White-glove service for mission-critical initiatives.", features: ["Dedicated team", "Custom SLA & uptime", "On-site availability", "Executive success manager"], cta: "Contact Us", color: "border-slate-700", btn: "btn-secondary" },
              ].map((plan, i) => (
          ...
          <div className="text-center rounded-2xl border border-purple-500/20 bg-gradient-to-r from-purple-900/20 via-slate-900/40 to-indigo-900/20 p-10">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-4">
              <a href="tel:+13024640950" className="btn-primary text-base px-8 py-3">📞 +1 302 464 0950</a>
              <a href="mailto:kleber@ziontechgroup.com" className="btn-secondary text-base px-8 py-3">✉️ kleber@ziontechgroup.com</a>
            </div>

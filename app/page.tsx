...
import { Phone, Mail, MapPin, ArrowRight, Star, CheckCircle, Brain, Cloud, Shield, Code, BarChart, Users } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <div className="mb-8">
              ...
              <p className="text-gray-300 mb-8 text-center leading-relaxed text-lg max-w-4xl mx-auto">

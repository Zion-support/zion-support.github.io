...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:absolute focus:top-24 focus:left-4 bg-cyan-600 text-white px-4 py-2 rounded-md z-50 neon-button"
      >
      ...
      <main id="main-content" className="container mx-auto px-4 py-16 relative z-10" role="main">
        ...
        >
          <h1 
            id="hero-heading" 
            className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 neon-text glitch-text"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mb-12">
            <div className="cyber-card p-6 hover:bg-cyan-400/10 transition-all duration-300 transform hover:-translate-y-1 group">
          ...
          <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              href="/contact"
              className="cyber-card px-8 py-4 text-cyan-400 hover:text-white hover:bg-cyan-400/10 transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-cyan-400/30 neon-border"
            >
        ...
        <section className="mb-16" aria-labelledby="services-heading">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:bg-cyan-400/10 transition-all duration-300 transform hover:-translate-y-2 group">
                ...
                <div className="text-center">
                  ...
                  <a href="/ai-services" className="text-cyan-400 hover:text-white font-medium transition-colors">
                    Learn More →
                  </a>
                </div>
              </article>
            ...
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:bg-cyan-400/10 transition-all duration-300 transform hover:-translate-y-2 group">
                ...
                <div className="text-center">
                  ...
                  <a href="/ai-marketing" className="text-pink-400 hover:text-white font-medium transition-colors">
                    Learn More →
                  </a>
                </div>
              </article>
            ...
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:bg-cyan-400/10 transition-all duration-300 transform hover:-translate-y-2 group">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-cyan-400 mb-2">Starting at $399/month</div>
                  <a href="/ai-automation" className="text-cyan-400 hover:text-white font-medium transition-colors">
                    Learn More →
                  </a>
                </div>
              </article>
            ...
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:bg-cyan-400/10 transition-all duration-300 transform hover:-translate-y-2 group">
                ...
                <div className="text-center">
                  ...
                  <a href="/ai-healthcare" className="text-green-400 hover:text-white font-medium transition-colors">
                    Learn More →
                  </a>
                </div>
              </article>
            ...
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:bg-cyan-400/10 transition-all duration-300 transform hover:-translate-y-2 group">
                ...
                <div className="text-center">
                  ...
                  <a href="/ai-fintech" className="text-indigo-400 hover:text-white font-medium transition-colors">
                    Learn More →
                  </a>
                </div>
              </article>
            ...
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:bg-cyan-400/10 transition-all duration-300 transform hover:-translate-y-2 group">
                ...
                <div className="text-center">
                  ...
                  <a href="/quantum-computing" className="text-purple-400 hover:text-white font-medium transition-colors">
                    Learn More →
                  </a>
                </div>
              </article>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <article className="cyber-card p-6 hover:bg-cyan-400/10 transition-all duration-300 transform hover:-translate-y-1 group">
        ...
        <section className="text-center cyber-card p-12" aria-labelledby="cta-heading">

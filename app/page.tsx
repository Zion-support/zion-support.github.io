      ...
      <section className="py-8 bg-gradient-to-r from-indigo-50 to-purple-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-white p-6 rounded-xl shadow-md border border-purple-100">
            <div>
              <p className="text-sm font-semibold text-purple-700">New content</p>
              <h2 className="text-2xl font-bold text-gray-900 mt-1">Just published: Eval‑Ready AI Pipelines + Real‑Time RAG</h2>
              <p className="text-gray-600 mt-2">Evaluation‑first delivery with governance gates and low‑latency retrieval architectures.</p>
            </div>
            <div className="flex gap-3">
              <Link href="/blog/ai-2026-eval-ready-ai-pipelines-in-production" className="inline-block bg-purple-600 text-white px-5 py-3 rounded-lg font-semibold hover:bg-purple-700">Eval‑Ready Pipelines</Link>

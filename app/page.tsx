...
const HomePage: React.FC = () => {
  ...
  const aiServices = [
    ...
    { name: 'AI Cybersecurity', icon: Shield, description: 'Advanced threat protection' },
  ...
  const itServices = [
    ...
    { name: 'API Development', icon: Code, description: 'API development & management' },
    { name: 'Cybersecurity', icon: Shield, description: 'Comprehensive security' },
        ...
        <main id="main-content" className="container mx-auto px-4 py-16 pt-24" role="main">
          ...
          <section className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/contact"
                className="px-8 py-4 border border-white text-white rounded-lg font-semibold hover:bg-white hover:text-indigo-600 transition-all duration-300 flex items-center justify-center"
              >

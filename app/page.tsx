...
import { Phone, Mail, MapPin, Clock, Star, Zap, Shield, Globe, Brain, Cpu, Target, BarChart, MessageSquare, Eye, Sparkles, ArrowRight, CheckCircle, TrendingUp, Users, Award, Lock, Database, Cloud, Code, Smartphone, Settings, FileText, Search, Bot, Palette, Camera, Music, Video, Gamepad2, ShoppingCart, CreditCard, Building, Factory, Car, Plane, Ship, Train, Home, Heart, Stethoscope, GraduationCap, Briefcase, Wrench, Hammer, Paintbrush, Scissors, BookOpen, Calculator, Calendar, Clock3, Compass, Navigation, PieChart, TrendingDown, Activity, Zap as Lightning, Target as Crosshair, Shield as Security, Users as People, Star as StarIcon, CheckCircle as Check, ArrowRight as Arrow, Phone as PhoneIcon, Mail as MailIcon, MapPin as Location, Server } from 'lucide-react';
...
const HomePage: React.FC = () => {
  ...
  const microSAASServices = [
    ...
    },
    {
      ...
      benefits: ['50% content creation time saved', '40% better engagement', 'SEO optimized content'],
    ...
    },
    {
      ...
      benefits: ['60% organic traffic increase', '25% better rankings', 'Automated optimization'],
      link: '/ai-seo-optimizer',
      popular: false
    },
    {
      title: 'AI Voice Cloning',
      description: 'Create realistic voice clones for content creation and customer service',
      icon: '🎤',
      price: '$199/month',
      features: ['Voice synthesis', 'Multi-language support', 'Emotion control', 'API integration'],
      benefits: ['90% voice similarity', '50% content creation cost reduction', '24/7 voice availability'],
    ...
    },
    {
      ...
      icon: '🎬',
      price: '$179/month',
      features: ['Video generation', 'Auto-editing', 'Text-to-video', 'Template library'],
      benefits: ['80% video production time saved', 'Professional quality output', 'Cost-effective production'],
      link: '/ai-video-generation',
      popular: false
    },
    {
      title: 'AI 3D Generation',
      description: 'Generate 3D models and animations using AI technology',
      icon: '🎨',
      price: '$249/month',
      features: ['3D model generation', 'Animation creation', 'Texture mapping', 'Export options'],
      benefits: ['70% faster 3D creation', 'Professional quality models', 'Reduced design costs'],
      link: '/ai-3d-generation',
      popular: false
    },
    {
      title: 'AI Fashion Design',
      description: 'AI-powered fashion design and trend prediction platform',
      icon: '👗',
      price: '$159/month',
      features: ['Design generation', 'Trend analysis', 'Color matching', 'Pattern creation'],
      benefits: ['60% design time reduction', 'Trend accuracy 85%', 'Innovative designs'],
      link: '/ai-fashion-design',
      popular: false
    },
    {
      title: 'AI Music Composition',
      description: 'Create original music compositions using AI technology',
      icon: '🎵',
      price: '$119/month',
      features: ['Music generation', 'Style adaptation', 'Instrument selection', 'Export formats'],
      benefits: ['Unlimited music creation', 'Professional quality', 'Copyright-free compositions'],
    ...
    },
    {
      ...
      icon: '💪',
      price: '$89/month',
      features: ['Personalized plans', 'Progress tracking', 'Nutrition guidance', 'Form analysis'],
    ...
    },
    {
      ...
      icon: '⚙️',
      price: '$199/month',
      features: ['Process automation', 'Workflow design', 'Integration APIs', 'Monitoring'],
      benefits: ['90% process automation', '60% time savings', 'Error reduction'],
  ...
  const aiServices = [
    {
      ...
      features: ['Business Intelligence', 'Customer Experience', 'Supply Chain Optimization', 'Financial Analytics'],
      color: 'text-purple-400',
      link: '/ai-enterprise-solutions'
    },
    {
      title: 'AI Healthcare Solutions',
      description: 'Revolutionary AI solutions for healthcare and medical applications',
      icon: Heart,
      price: 'Starting at $2,499/month',
      features: ['Diagnostic Assistance', 'Patient Monitoring', 'Drug Discovery', 'Mental Health Support'],
      color: 'text-blue-400',
    ...
    },
    {
      ...
      description: 'Advanced data visualization and business intelligence solutions',
      icon: BarChart,
      price: '$1,100/month',
  ...
  const itServices = [
    {
      ...
      features: ['Cloud Management', 'Network Design', 'Data Centers', 'Cybersecurity'],
      color: 'text-blue-400',

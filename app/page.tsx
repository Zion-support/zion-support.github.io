...
const HomePage: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Self-managing systems and automation solutions for enhanced efficiency and reliability.',
      icon: Settings,
      features: ['Process Automation', 'Smart Systems', 'IoT Integration', 'Monitoring'],
  ...
  const features = [
    {
      ...
      description: 'Bank-level security with encryption and compliance standards to protect your data.',
      icon: Shield,
      benefits: ['End-to-end encryption', 'SOC 2 compliance', 'Regular security audits', '24/7 monitoring']
    },
    {
      title: 'Scalable Solutions',
      description: 'Flexible and scalable solutions that grow with your business needs.',
      icon: TrendingUp,
      benefits: ['Auto-scaling', 'Load balancing', 'Performance optimization', 'Cost efficiency']
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock technical support and maintenance for uninterrupted operations.',
      icon: Clock,
      benefits: ['Expert support team', 'Fast response times', 'Proactive monitoring', 'Emergency assistance']
    }
  ];

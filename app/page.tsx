...
const ServiceCardSkeleton: React.FC = memo(() => (
  <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 animate-pulse" role="status" aria-label="Loading service card">
    <div className="h-4 bg-gray-300/20 rounded mb-4"></div>
    <div className="h-3 bg-gray-300/20 rounded mb-2"></div>
        ...
        <main id="main-content" className="container mx-auto px-4 py-16 pt-24" role="main">
          ...
          <section className="mb-16" aria-labelledby="services-heading">
            ...
            <div className="mb-12">
              ...
              <p className="text-base sm:text-lg text-gray-300 text-center mb-12 max-w-3xl mx-auto px-4">
                Affordable, powerful AI-driven tools for modern businesses. 50+ ready-to-use applications with real functionality.
              </p>

    ...
    <>
      ...
      <div className="min-h-screen bg-slate-900 text-white futuristic-bg">
        ...
        <section className="relative overflow-hidden min-h-screen flex items-center">
          ...
          <div className="absolute top-1/4 right-1/4 w-48 h-48 bg-green-500/5 rounded-full blur-2xl animate-pulse delay-2000 floating"></div>
          <div className="absolute bottom-1/4 left-1/4 w-56 h-56 bg-orange-500/5 rounded-full blur-2xl animate-pulse delay-3000 floating"></div>
          ...
          <div className="absolute inset-0 opacity-20 cyber-grid"></div>
            ...
            <div className="text-center">
              <div className="relative inline-block mb-6">
                ...
                <div className="absolute -inset-2 bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 rounded-lg blur opacity-20 animate-pulse delay-500"></div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 lg:mb-16 px-4">
                <Link to="/contact"
                  className="relative group cyber-button neon-border-animated"
                >
                ...
                <Link to="/about"
                  className="relative group btn-futuristic neon-glow"
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {services.map((service, index) => (
                <Link key={index}
                  to={service.href}
                  className="group relative holographic-card p-6 sm:p-8 glass-card hover:transform hover:scale-105 overflow-hidden"
                  style={{
                    animationDelay: `${index * 100}ms`
                  }}
                >
        ...
        <section className="py-16 sm:py-20 bg-slate-800/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="group holographic-card glass-card p-6 hover:scale-105 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-cyan-300 transition-colors neon-text">
              ...
              <div className="group holographic-card glass-card p-6 hover:scale-105 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-purple-300 transition-colors neon-text">
                ...
                <div className="flex items-center justify-between mb-4">
                  <span className="text-2xl font-bold text-purple-400 neon-text">$349/mo</span>
              ...
              <div className="group holographic-card glass-card p-6 hover:scale-105 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-green-300 transition-colors neon-text">
                  Task Manager Pro
                </h3>
                <p className="text-gray-400 mb-4 text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
              ...
              <div className="group holographic-card glass-card p-6 hover:scale-105 transition-all duration-300">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-sm text-blue-400 font-medium neon-text">Sales & CRM</span>
                </div>
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-blue-300 transition-colors neon-text">
                  CRM Optimizer Pro
                </h3>
                <p className="text-gray-400 mb-4 text-sm">
                  AI-powered customer relationship management with automated lead scoring, sales forecasting, and customer insights.
                </p>
                <div className="flex items-center justify-between mb-4">
                  <span className="text-2xl font-bold text-blue-400 neon-text">$149/mo</span>
              ...
              <div className="group holographic-card glass-card p-6 hover:scale-105 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-yellow-300 transition-colors neon-text">
                  Expense Tracker Pro
                </h3>
                <p className="text-gray-400 mb-4 text-sm">
                  Smart expense management with receipt scanning, automated categorization, and financial reporting for businesses.
                </p>
                <div className="flex items-center justify-between mb-4">
                  <span className="text-2xl font-bold text-yellow-400 neon-text">$39/mo</span>
              ...
              <div className="group holographic-card glass-card p-6 hover:scale-105 transition-all duration-300">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-sm text-pink-400 font-medium neon-text">Marketing</span>
                </div>
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-pink-300 transition-colors neon-text">
                  Social Media Scheduler Pro
                </h3>
                <p className="text-gray-400 mb-4 text-sm">
                  AI-powered social media management with content scheduling, analytics, and engagement optimization across all platforms.
                </p>
                <div className="flex items-center justify-between mb-4">
                  <span className="text-2xl font-bold text-pink-400 neon-text">$59/mo</span>

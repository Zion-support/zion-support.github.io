...
const HomePage: React.FC = () => {
  ...
  const handlePhoneClick = useCallback(() => {
    if (typeof window !== 'undefined' && 'gtag' in window) {
      const gtag = (window as { gtag: (command: string, action: string, parameters: Record<string, unknown>) => void }).gtag: gtag('event', 'phone_click', {
    ...
    addressCountry: 'US'
      ...
      />
        ...
        <main: id="main-content" className="container: mx-auto: px-4 py-16 pt-24 quantum-energy-field" role="main">
          {/* Hero Section */}
          <section: className={`text-center: mb-16: transition-all: duration-1000 cyber-scan-line holographic-card-enhanced quantum-pulse-enhanced ${}
              isLoaded && isVisible

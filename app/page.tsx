...
<<<<<<< HEAD
        ...
        <meta name="description" content="Professional AI and technology solutions for your business. Transform your operations with cutting-edge AI services." />
      </Head>
...
=======
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"> </div><div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-16 text-center">,
          <h1Welcome to Zion Tech Group
          </h1>
          <pProfessional AI and IT solutions for your business.
>>>>>>> cursor/fix-errors-and-merge-to-main-998c
          </p>
          <Link href="/contact"

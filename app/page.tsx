...
import { ArrowRight, Zap, Shield, Database, Code, Cloud, CheckCircle, Smartphone } from 'lucide-react'
...
export default function HomePage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Custom micro SAAS solutions tailored to your specific business needs and requirements.',
      benefits: ['Custom Development - Starting at $3,000', 'API Integration - $800/month', 'Maintenance & Support - $500/month', 'Scalability Solutions - $1,200/month'],

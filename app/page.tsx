...
export default function HomePage() {
  const seoData: SEOData = {
    ...
    keywords: 'AI solutions, IT services, cloud computing, digital transformation, 5G implementation, micro SAAS, artificial intelligence, business automation',
    url: 'https://ziontechgroup.com',
    type: 'website',
    image: 'https://ziontechgroup.com/og-image.jpg',
    tags: ['AI', 'IT Services', 'Cloud Computing', 'Digital Transformation', '5G', 'Technology']
  }

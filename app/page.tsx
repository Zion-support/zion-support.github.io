...
import { Phone, Mail, MapPin, Clock, ArrowRight, Star, CheckCircle, Zap, Shield, Brain, Cloud, Code, BarChart, Users, Sparkles, Cpu, Target, Globe, Database, Smartphone, Lock, TrendingUp, Settings, Calendar, CheckSquare, FileText, MessageCircle, Heart, DollarSign, Box, Monitor, Link as LinkIcon, Server, Rocket, Award, Globe2, Layers, BarChart3, PieChart, Activity, Target as TargetIcon, Zap as ZapIcon, Shield as ShieldIcon, Brain as BrainIcon, Cloud as CloudIcon, Code as CodeIcon, BarChart as BarChartIcon, Users as UsersIcon, Sparkles as SparklesIcon, Cpu as CpuIcon, Target as TargetIcon2, Globe as GlobeIcon, Database as DatabaseIcon, Smartphone as SmartphoneIcon, Lock as LockIcon, TrendingUp as TrendingUpIcon, Settings as SettingsIcon, Calendar as CalendarIcon, CheckSquare as CheckSquareIcon, FileText as FileTextIcon, MessageCircle as MessageCircleIcon, Heart as HeartIcon, DollarSign as DollarSignIcon, Box as BoxIcon, Monitor as MonitorIcon, Link as LinkIcon2, Server as ServerIcon, Rocket as RocketIcon, Award as AwardIcon, Globe2 as Globe2Icon, Layers as LayersIcon, BarChart3 as BarChart3Icon, PieChart as PieChartIcon, Activity as ActivityIcon } from 'lucide-react';

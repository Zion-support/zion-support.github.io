...
const HomePage: React.FC = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: 'Their cloud infrastructure is rock-solid. We\'ve had zero downtime since implementation and our costs decreased by 40%.',
      rating: 5
    },
    {
      name: 'Emily Rodriguez',
      company: 'DataFlow Systems',
      content: 'The cybersecurity services gave us peace of mind. Our data has never been more secure, and compliance is now effortless.',
      rating: 5
    }
  ];
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
              {additionalServices.map((service, index) => (
                ...
                >
                  <div className="text-white text-xs sm:text-sm font-medium mb-1">{service.name}</div>

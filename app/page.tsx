      ...
      <main id="main-content" className="container mx-auto px-4 py-16 pt-24" role="main">
        ...
        <section className="mb-16" aria-labelledby="services-heading">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <article className="quantum-card p-4 sm:p-6">
          ...
          <div className="text-center mt-8">
            <a 
              href="/services"
              className="cyber-button inline-block px-6 sm:px-8 py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-indigo-300 text-sm sm:text-base"
            >
              View All Services
            </a>
          </div>

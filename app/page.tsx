  ...
  const services = [
    {
      ...
      href: '/ai-services',
      features: ['Machine Learning', 'Natural Language Processing', 'Computer Vision', 'Predictive Analytics', 'AI Automation', 'Chatbot Development']
    },
    {
      icon: Cloud,
      title: 'IT Services',
      description: 'Comprehensive IT solutions including cloud infrastructure, cybersecurity, and custom development.',
      href: '/it-services',
      features: ['Cloud Migration', 'Cybersecurity', 'DevOps', 'Database Management', 'Web Development', 'Mobile Apps']
    },
    {
      icon: BarChart,
      title: 'Micro SaaS',
      description: 'Powerful micro SaaS tools designed to solve specific business problems with AI-powered automation.',
      href: '/micro-saas',
      features: ['Analytics Dashboard', 'AI Chatbot', 'Security Monitor', 'Cloud Backup', 'Performance Tracker', 'Workflow Automation']
    }
  ];
              ...
              {services.map((service, index) => (
                <Suspense key={index} fallback={<ServiceCardSkeleton />}>
                  <article className="quantum-card p-4 sm:p-6 energy-pulse">
                    <div className="text-4xl sm:text-5xl mb-4 sm:mb-6 text-center cyber-scan-line">{service.icon && <service.icon className="w-12 h-12 mx-auto text-cyan-400" />}</div>

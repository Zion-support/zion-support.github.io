...
const features = [
  ...
  },
  {
    ...
    icon: Cloud,
    benefits: ['AWS/Azure/GCP', 'Auto-scaling', 'Disaster Recovery', 'Security Compliance']
  },
  {
    ...
    <React.Fragment>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg matrix-rain">
        ...
        <main id="main-content" className="container mx-auto px-4 py-16 pt-24" role="main">
          ...
          {/* Services Section */}
          <section className="py-20 px-4 sm:px-6 lg:px-8 mb-16" aria-labelledby="services-heading">
            <div className="max-w-7xl mx-auto">
          ...
          {/* Features Section */}
          <section className="py-20 px-4 sm:px-6 lg:px-8 mb-16">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900/50 mb-16">
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">

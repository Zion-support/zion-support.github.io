  ...
  const services = [
    {
      ...
      benefits: ['AI Content Generation - $500/month', 'AI Chatbots - $300/month', 'AI Analytics - $800/month', 'AI Automation - $1,200/month'],
      link: '/ai-services'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 px-4">Why Choose Zion Tech Group?</h2>
            <p className="text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto px-4">

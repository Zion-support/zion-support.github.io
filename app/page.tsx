...
import AITransformationSuccessBanner from '../components/AITransformationSuccessBanner';
import InteractiveAITransformationCalculator from '../components/InteractiveAITransformationCalculator';
import NewBlogContentBanner from '../components/NewBlogContentBanner';
  ...
  return (
    <>
      ...
      <div className="animate-fade-in">
        ...
        <NewBlogContentBanner />

        {/* AI Transformation Success Banner */}
        <AITransformationSuccessBanner />

        {/* Interactive AI Transformation Calculator */}
        <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-900 mb-6">
                Calculate Your AI Transformation Impact
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Get personalized ROI projections and transformation insights based on your company size, 
                industry, and current automation level.
              </p>
            </div>
            <InteractiveAITransformationCalculator />
          </div>
        </section>

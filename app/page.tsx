...
const HomePage: React.FC = () => {
  ...
  const microSAASServices = [
    ...
    },
    {
      ...
      description: 'Revolutionary meeting management with real-time transcription, sentiment analysis, and intelligent action item extraction. Used by Fortune 500 companies.',
      icon: '🎯',
      price: '$79/month',
    ...
    },
    {
      ...
      description: 'Intelligent note-taking with automatic organization, search, and knowledge extraction. Never lose important information again.',
      icon: '📝',
      price: '$29/month',
      originalPrice: '$49/month',
      features: ['Voice-to-text', 'Auto-organization', 'Smart search', 'Knowledge extraction', 'Cross-device sync', 'Collaboration', 'Export options', 'AI summaries'],
      benefits: ['Never lose notes', 'Better organization', 'Quick search', 'Enhanced learning'],
      link: '/ai-note-taking',
      popular: true,
      category: 'Productivity',
      rating: 4.7,
    ...
    },
    {
      ...
      description: 'Smart calendar management with AI-powered scheduling, conflict resolution, and time optimization. Maximize your productivity.',
      icon: '🗓️',
      price: '$39/month',
      originalPrice: '$59/month',
      features: ['Smart scheduling', 'Conflict resolution', 'Time optimization', 'Meeting insights', 'Auto-blocking', 'Travel time calculation', 'Buffer time management', 'Priority scheduling'],
      benefits: ['Better time management', 'Reduced conflicts', 'Optimized schedules', 'Increased productivity'],
    ...
    {
      title: 'AI Focus Manager Pro',
      description: 'Advanced focus management with AI-powered distraction blocking, productivity tracking, and concentration optimization.',
      icon: '🎯',
      price: '$24/month',
      originalPrice: '$39/month',
      features: ['Distraction blocking', 'Focus tracking', 'Productivity analytics', 'Break reminders', 'Environment optimization', 'Goal tracking', 'Habit building', 'Performance insights'],
      benefits: ['Better focus', 'Increased productivity', 'Reduced distractions', 'Achieve goals faster'],
      link: '/ai-focus-manager',
      popular: true,
      category: 'Productivity',
      rating: 4.6,
      users: '40,000+',
    ...
    {
      title: 'AI Blog Generator Pro',
      description: 'Intelligent blog content creation with SEO optimization, topic research, and automated publishing. Create engaging blogs that rank.',
      icon: '📝',
      price: '$69/month',
      originalPrice: '$99/month',
      features: ['Topic research', 'SEO optimization', 'Content planning', 'Auto-publishing', 'Image generation', 'Internal linking', 'Meta descriptions', 'Social sharing'],
      benefits: ['Higher search rankings', 'Engaging content', 'Time savings', 'Better SEO'],
    ...
    {
      title: 'AI Copywriting Assistant Pro',
      description: 'Professional copywriting with AI-powered persuasion techniques, A/B testing, and conversion optimization. Boost sales by 200%.',
      icon: '💼',
      price: '$79/month',
      originalPrice: '$119/month',
      features: ['Persuasive copy', 'A/B testing', 'Conversion optimization', 'Headline generation', 'Call-to-action optimization', 'Email copy', 'Ad copy', 'Landing page copy'],
      benefits: ['200% higher conversions', 'Better copy', 'A/B testing', 'Increased sales'],
      link: '/ai-copywriting-assistant',
      popular: true,
      category: 'Content',
      rating: 4.9,
      users: '30,000+',
    ...
    {
      title: 'AI Technical Writer Pro',
      description: 'Professional technical documentation with AI-powered clarity, structure, and user-friendly explanations. Perfect for developers.',
      icon: '🔧',
      price: '$89/month',
      originalPrice: '$129/month',
      features: ['Technical documentation', 'API documentation', 'User guides', 'Code comments', 'Tutorial creation', 'Version control', 'Collaboration tools', 'Multi-format export'],
      benefits: ['Clear documentation', 'Better user experience', 'Time savings', 'Professional quality'],
      link: '/ai-technical-writer',
      popular: true,
      category: 'Content',
      rating: 4.7,
      users: '18,000+',
    ...
    {
      title: 'AI Content Translator Pro',
      description: 'Advanced content translation with AI-powered accuracy, cultural adaptation, and brand voice preservation. Translate to 100+ languages.',
      icon: '🌍',
      price: '$59/month',
      originalPrice: '$89/month',
      features: ['100+ languages', 'Cultural adaptation', 'Brand voice preservation', 'Context awareness', 'Quality assurance', 'Batch processing', 'API access', 'Human review'],
      benefits: ['Global reach', 'Cultural accuracy', 'Brand consistency', 'Cost effective'],
      link: '/ai-content-translator',
      popular: true,
      category: 'Content',
      rating: 4.8,
      users: '35,000+',
    ...
    },
    {
      ...
      description: 'Intelligent ad campaign management with AI-powered optimization, targeting, and budget allocation. Maximize ROI by 300%.',
      icon: '📊',
      price: '$149/month',
      originalPrice: '$199/month',
      features: ['AI optimization', 'Smart targeting', 'Budget allocation', 'A/B testing', 'Performance tracking', 'Multi-platform support', 'Creative generation', 'ROI optimization'],
      benefits: ['300% higher ROI', 'Better targeting', 'Automated optimization', 'Cost savings'],
    ...
    },
    {
      ...
      description: 'AI-powered influencer discovery, outreach, and campaign management. Find the perfect influencers for your brand.',
      icon: '👥',
      price: '$89/month',
      originalPrice: '$129/month',
      features: ['Influencer discovery', 'Audience analysis', 'Outreach automation', 'Campaign tracking', 'ROI measurement', 'Content collaboration', 'Payment processing', 'Performance analytics'],
      benefits: ['Perfect influencer matches', 'Better campaign ROI', 'Automated outreach', 'Detailed analytics'],
    ...
    },
    {
      ...
      description: 'Intelligent content planning with AI-powered scheduling, trend analysis, and performance optimization. Never run out of content ideas.',
      icon: '📅',
      price: '$49/month',
      originalPrice: '$79/month',
      features: ['Content planning', 'Trend analysis', 'Optimal timing', 'Performance tracking', 'Team collaboration', 'Multi-platform sync', 'Content templates', 'Analytics dashboard'],
      benefits: ['Never run out of ideas', 'Better timing', 'Improved performance', 'Team coordination'],
    ...
    },
    {
      ...
      description: 'Deep customer insights with AI-powered behavior analysis, churn prediction, and lifetime value optimization.',
      icon: '👤',
      price: '$79/month',
      originalPrice: '$119/month',
      features: ['Behavior analysis', 'Churn prediction', 'Lifetime value', 'Segmentation', 'Personalization', 'Retention strategies', 'Customer journey mapping', 'Predictive modeling'],
      benefits: ['Better customer understanding', 'Reduced churn', 'Higher lifetime value', 'Improved retention'],
    ...
    },
    {
      ...
      description: 'Intelligent market research with AI-powered trend analysis, competitor monitoring, and opportunity identification.',
      icon: '🔍',
      price: '$89/month',
      originalPrice: '$129/month',
      features: ['Trend analysis', 'Competitor monitoring', 'Market sizing', 'Opportunity identification', 'Consumer insights', 'Brand monitoring', 'Sentiment analysis', 'Report generation'],
      benefits: ['Better market understanding', 'Competitive advantage', 'Opportunity identification', 'Data-driven strategy'],
    ...
    {
      title: 'AI Tax Optimizer Pro',
      description: 'Intelligent tax optimization with AI-powered deductions, compliance monitoring, and tax planning. Maximize your tax savings.',
      icon: '🧮',
      price: '$99/month',
      originalPrice: '$149/month',
      features: ['Tax optimization', 'Deduction finder', 'Compliance monitoring', 'Tax planning', 'Multi-jurisdiction support', 'Audit protection', 'Document management', 'Expert consultation'],
      benefits: ['Maximum tax savings', 'Compliance assurance', 'Audit protection', 'Peace of mind'],
    ...
    {
      title: 'AI Budget Planner Pro',
      description: 'Smart budget planning with AI-powered recommendations, goal tracking, and financial forecasting. Achieve your financial goals.',
      icon: '📋',
      price: '$39/month',
      originalPrice: '$59/month',
      features: ['Budget planning', 'Goal tracking', 'Financial forecasting', 'Spending analysis', 'Savings optimization', 'Debt management', 'Investment planning', 'Retirement planning'],
      benefits: ['Better financial control', 'Goal achievement', 'Debt reduction', 'Wealth building'],
    ...
    {
      title: 'AI Credit Score Optimizer',
      description: 'Intelligent credit score improvement with AI-powered recommendations and monitoring. Boost your credit score by 50+ points.',
      icon: '📊',
      price: '$49/month',
      originalPrice: '$79/month',
      features: ['Credit monitoring', 'Score optimization', 'Debt management', 'Payment reminders', 'Credit report analysis', 'Identity protection', 'Score tracking', 'Improvement tips'],
      benefits: ['50+ point improvement', 'Better credit health', 'Identity protection', 'Financial freedom'],
      link: '/ai-credit-optimizer',
      popular: true,
      category: 'Finance',
      rating: 4.8,
      users: '28,000+',
    ...
    {
      title: 'AI Investment Advisor Pro',
      description: 'Personalized investment advice with AI-powered portfolio optimization and risk management. Build wealth intelligently.',
      icon: '💎',
      price: '$89/month',
      originalPrice: '$129/month',
      features: ['Portfolio optimization', 'Risk management', 'Investment recommendations', 'Market analysis', 'Tax-efficient investing', 'Rebalancing', 'Performance tracking', 'Goal-based investing'],
      benefits: ['Better returns', 'Risk management', 'Tax efficiency', 'Goal achievement'],
  ...
  const aiServices = [
    ...
    },
    {
      ...
      description: 'Advanced voice AI with natural language understanding, multi-language support, and intelligent responses.',
      icon: Mic,
      price: '$1,300/month',
      originalPrice: '$1,800/month',
      features: ['Voice Recognition', 'Natural Language Understanding', 'Multi-language Support', 'Conversation Management', 'Voice Synthesis', 'Intent Recognition', 'Context Awareness', 'API Integration'],
      benefits: ['Natural interactions', 'Multi-language support', 'Better user experience', 'Reduced support costs'],
    ...
    },
    {
      ...
      description: 'Intelligent recommendation systems with personalization, collaborative filtering, and real-time optimization.',
      icon: Target,
      price: '$1,200/month',
      originalPrice: '$1,600/month',
      features: ['Personalization', 'Collaborative Filtering', 'Real-time Optimization', 'A/B Testing', 'Performance Analytics', 'Multi-channel Support', 'Scalable Architecture', 'API Access'],
      benefits: ['Higher engagement', 'Better conversions', 'Personalized experience', 'Increased revenue'],
    ...
    },
    {
      ...
      description: 'Enterprise-grade chatbot platform with natural language processing, multi-channel support, and advanced analytics.',
      icon: Bot,
      price: '$1,000/month',
      originalPrice: '$1,400/month',
      features: ['Natural Language Processing', 'Multi-channel Support', 'Advanced Analytics', 'Integration Hub', 'Custom Training', 'Voice Support', 'Escalation Management', 'Performance Monitoring'],
      benefits: ['24/7 customer support', 'Reduced costs', 'Better customer satisfaction', 'Scalable solution'],
    ...
    },
    {
      ...
      description: 'Intelligent content moderation with AI-powered detection, classification, and automated action. Keep your platform safe.',
      icon: Shield,
      price: '$1,200/month',
      originalPrice: '$1,600/month',
      features: ['Content Detection', 'Classification', 'Automated Action', 'Multi-language Support', 'Image Analysis', 'Video Analysis', 'Text Analysis', 'Real-time Processing'],
      benefits: ['Safer platforms', 'Reduced manual work', 'Better accuracy', 'Cost savings'],
    ...
    {
      title: 'AI Process Automation Pro',
      description: 'Intelligent process automation with AI-powered workflow optimization, decision making, and exception handling.',
      icon: Settings,
      price: '$1,400/month',
      originalPrice: '$1,900/month',
      features: ['Workflow Automation', 'Decision Making', 'Exception Handling', 'Process Optimization', 'Integration Hub', 'Performance Monitoring', 'Scalable Architecture', 'API Access'],
    ...
    },
    {
      ...
      description: 'Intelligent quality assurance with AI-powered testing, defect detection, and automated quality control.',
      icon: CheckCircle,
      price: '$1,300/month',
      originalPrice: '$1,700/month',
      features: ['Automated Testing', 'Defect Detection', 'Quality Control', 'Performance Testing', 'Security Testing', 'Regression Testing', 'Test Generation', 'Analytics Dashboard'],
      benefits: ['Better quality', 'Faster testing', 'Reduced defects', 'Cost savings'],
  ...
  const itServices = [
    ...
    },
    {
      ...
      description: 'Modern web development with responsive design, performance optimization, and SEO best practices.',
      icon: Globe,
      price: '$2,200/month',
      originalPrice: '$3,200/month',
      features: ['Responsive Design', 'Performance Optimization', 'SEO Best Practices', 'E-commerce Integration', 'CMS Development', 'API Development', 'Security Implementation', 'Maintenance & Support'],
      benefits: ['Modern websites', 'Better performance', 'SEO optimized', 'Mobile responsive'],
    ...
    },
    {
      ...
      description: 'Complete data center services with colocation, cloud hosting, and disaster recovery solutions.',
      icon: Database,
      price: '$2,500/month',
      originalPrice: '$3,500/month',
      features: ['Colocation Services', 'Cloud Hosting', 'Disaster Recovery', 'Backup Solutions', 'Monitoring', 'Security', 'Scalability', '24/7 Support'],
      benefits: ['Reliable infrastructure', 'Disaster recovery', 'Scalable solutions', 'Cost effective'],
    ...
    },
    {
      ...
      description: 'Comprehensive IT support with 24/7 helpdesk, remote assistance, and proactive maintenance.',
      icon: Users,
      price: '$1,000/month',
      originalPrice: '$1,500/month',
      features: ['24/7 Helpdesk', 'Remote Assistance', 'Proactive Maintenance', 'Software Support', 'Hardware Support', 'Network Support', 'Security Support', 'Training'],
      benefits: ['24/7 support', 'Faster resolution', 'Proactive maintenance', 'Reduced downtime'],
      link: '/it-support',
      popular: true,
      category: 'Support',
      rating: 4.8,
    ...
    },
    {
      ...
      description: 'Advanced cloud security with compliance management, data protection, and threat monitoring.',
      icon: Shield,
      price: '$1,600/month',
      originalPrice: '$2,200/month',
      features: ['Compliance Management', 'Data Protection', 'Threat Monitoring', 'Access Control', 'Encryption', 'Audit Logging', 'Incident Response', 'Security Training'],
      benefits: ['Compliance ready', 'Data protection', 'Threat prevention', 'Audit support'],
      link: '/cloud-security',
      popular: true,
      category: 'Security',
      rating: 4.8,
    ...
    },
    {
      ...
      price: '$1,000/month',
      originalPrice: '$1,400/month',
      features: ['Asset Inventory', 'Lifecycle Management', 'Cost Optimization', 'License Management', 'Depreciation Tracking', 'Procurement Support', 'Disposal Management', 'Reporting'],
      benefits: ['Better asset control', 'Cost optimization', 'Compliance ready', 'Reduced waste'],
    ...
    },
    {
      ...
      description: 'Comprehensive backup and disaster recovery solutions with automated backups and rapid recovery.',
      icon: Database,
      price: '$1,300/month',
      originalPrice: '$1,800/month',
      features: ['Automated Backups', 'Disaster Recovery', 'Data Replication', 'Recovery Testing', 'Monitoring', 'Compliance', 'Cloud Backup', '24/7 Support'],
      benefits: ['Data protection', 'Rapid recovery', 'Compliance ready', 'Peace of mind'],
    ...
    },
    {
      ...
      description: 'Comprehensive IT training programs with hands-on learning and certification support.',
      icon: GraduationCap,
      price: '$800/month',
      originalPrice: '$1,200/month',
      features: ['Hands-on Training', 'Certification Support', 'Custom Curriculum', 'Online Learning', 'Instructor-led Training', 'Assessment Tools', 'Progress Tracking', 'Certification Exams'],
      benefits: ['Better skills', 'Certification ready', 'Customized learning', 'Career advancement'],
      link: '/it-training',
      popular: true,
      category: 'Training',
      rating: 4.7,
    ...
    },
    {
      ...
      description: 'Comprehensive IT performance optimization with monitoring, analysis, and improvement recommendations.',
      icon: Zap,
      price: '$1,400/month',
      originalPrice: '$2,000/month',
      features: ['Performance Monitoring', 'Analysis & Reporting', 'Optimization Recommendations', 'Capacity Planning', 'Load Testing', 'Bottleneck Identification', 'Performance Tuning', 'Continuous Improvement'],
      benefits: ['Better performance', 'Cost optimization', 'Scalability', 'User satisfaction'],
      link: '/it-performance',
      popular: true,
    ...
    },
    {
      ...
      description: 'Complete network infrastructure design, implementation, and management with high availability and security.',
      icon: Globe,
      price: '$1,600/month',
      originalPrice: '$2,200/month',
      features: ['Network Design', 'Implementation', 'Monitoring', 'Security', 'Performance Optimization', 'Troubleshooting', 'Upgrades', '24/7 Support'],
      benefits: ['Reliable network', 'Better performance', 'Enhanced security', 'Scalable solution'],
    ...
    },
    {
      ...
      description: 'Comprehensive compliance and governance solutions with audit support and regulatory compliance.',
      icon: FileText,
      price: '$1,500/month',
      originalPrice: '$2,000/month',
      features: ['Compliance Management', 'Audit Support', 'Regulatory Compliance', 'Policy Management', 'Risk Assessment', 'Documentation', 'Training', 'Monitoring'],
      benefits: ['Compliance ready', 'Audit support', 'Risk reduction', 'Regulatory compliance'],
      link: '/compliance',
      popular: true,
      category: 'Compliance',
      rating: 4.8,
    ...
    },
    {
      ...
      description: 'Comprehensive developer tools and platforms with CI/CD, testing, and deployment automation.',
      icon: Code,
      price: '$1,200/month',
      originalPrice: '$1,600/month',
      features: ['CI/CD Pipelines', 'Testing Tools', 'Deployment Automation', 'Code Quality', 'Version Control', 'Collaboration Tools', 'Monitoring', 'Documentation'],
      benefits: ['Faster development', 'Better quality', 'Automated deployment', 'Team collaboration'],
    ...
    },
    {
      ...
      price: '$1,100/month',
      originalPrice: '$1,500/month',
      features: ['Marketing Automation', 'Analytics', 'Campaign Management', 'Lead Management', 'Email Marketing', 'Social Media', 'Content Management', 'ROI Tracking'],
      benefits: ['Better marketing', 'Automated campaigns', 'Better ROI', 'Data-driven decisions'],
    ...
    },
    {
      ...
      description: 'Comprehensive productivity solutions with collaboration tools, project management, and workflow automation.',
      icon: BarChart,
      price: '$1,000/month',
      originalPrice: '$1,400/month',
      features: ['Collaboration Tools', 'Project Management', 'Workflow Automation', 'Document Management', 'Communication Tools', 'Task Management', 'Time Tracking', 'Reporting'],
      benefits: ['Better productivity', 'Team collaboration', 'Workflow automation', 'Better organization'],
      link: '/productivity',
      popular: true,
      category: 'Productivity',
      rating: 4.7,
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description: 'Complete metaverse solutions with virtual worlds, avatars, and immersive experiences. Build the next generation of digital interaction.',
      icon: Cube,
      price: '$3,500/month',
      originalPrice: '$5,000/month',
      features: ['Virtual Worlds', 'Avatar Systems', 'Immersive Experiences', 'VR/AR Integration', '3D Environments', 'Social Features', 'Monetization', 'Analytics'],
      benefits: ['Immersive experiences', 'New revenue streams', 'Future-ready platform', 'Competitive advantage'],
    ...
    },
    {
      ...
      description: 'Next-generation robotics with AI integration, human-robot collaboration, and autonomous operation. Revolutionize your operations.',
      icon: Settings,
      price: '$4,500/month',
      originalPrice: '$6,500/month',
      features: ['AI Integration', 'Human-Robot Collaboration', 'Autonomous Operation', 'Advanced Sensors', 'Machine Learning', 'Safety Systems', 'Custom Development', 'Integration'],
      benefits: ['Advanced automation', 'Human-robot collaboration', 'Safety first', 'Operational efficiency'],
    ...
    },
    {
      ...
      description: 'Comprehensive digital twin solutions with real-time monitoring, simulation, and predictive analytics. Optimize your physical assets.',
      icon: Cpu,
      price: '$3,200/month',
      originalPrice: '$4,500/month',
      features: ['Real-time Monitoring', 'Simulation', 'Predictive Analytics', '3D Visualization', 'IoT Integration', 'Machine Learning', 'Custom Development', 'Analytics'],
      benefits: ['Real-time insights', 'Predictive maintenance', 'Optimized operations', 'Cost savings'],
    ...
    },
    {
      ...
      description: 'Advanced climate technology with carbon tracking, sustainability analytics, and environmental monitoring. Build a sustainable future.',
      icon: Globe,
      price: '$2,800/month',
      originalPrice: '$4,000/month',
      features: ['Carbon Tracking', 'Sustainability Analytics', 'Environmental Monitoring', 'Green Energy', 'Waste Management', 'Compliance', 'Reporting', 'Optimization'],
      benefits: ['Sustainability goals', 'Cost savings', 'Compliance ready', 'Environmental impact'],
    ...
    },
    {
      ...
      description: 'Cutting-edge space technology solutions with satellite systems, space data analytics, and space-based services.',
      icon: Globe,
      price: '$5,500/month',
      originalPrice: '$8,000/month',
      features: ['Satellite Systems', 'Space Data Analytics', 'Ground Station Services', 'Space-based IoT', 'Earth Observation', 'Communication Systems', 'Navigation', 'Research'],
      benefits: ['Space-based insights', 'Global coverage', 'Advanced technology', 'Competitive advantage'],
    ...
    },
    {
      ...
      description: 'Advanced biotechnology IT solutions with genomic analysis, drug discovery, and medical research platforms.',
      icon: Stethoscope,
      price: '$4,200/month',
      originalPrice: '$6,000/month',
      features: ['Genomic Analysis', 'Drug Discovery', 'Medical Research', 'Clinical Trials', 'Data Management', 'AI Integration', 'Compliance', 'Analytics'],
      benefits: ['Medical breakthroughs', 'Faster research', 'Better outcomes', 'Cost savings'],
    ...
    },
    {
      ...
      description: 'Comprehensive smart city solutions with urban analytics, IoT integration, and citizen services. Build the cities of tomorrow.',
      icon: Building,
      price: '$3,800/month',
      originalPrice: '$5,500/month',
      features: ['Urban Analytics', 'IoT Integration', 'Citizen Services', 'Traffic Management', 'Energy Optimization', 'Public Safety', 'Data Analytics', 'Integration'],
      benefits: ['Better city management', 'Citizen satisfaction', 'Cost optimization', 'Sustainability'],
    ...
    },
    {
      ...
      description: 'Advanced financial technology solutions with payment processing, digital banking, and financial analytics.',
      icon: CreditCard,
      price: '$2,200/month',
      originalPrice: '$3,200/month',
      features: ['Payment Processing', 'Digital Banking', 'Financial Analytics', 'Risk Management', 'Compliance', 'API Integration', 'Security', 'Mobile Apps'],
      benefits: ['Better financial services', 'Cost reduction', 'Enhanced security', 'Customer satisfaction'],
    ...
    },
    {
      ...
      description: 'Comprehensive health technology infrastructure with telemedicine, patient management, and medical analytics.',
      icon: Stethoscope,
      price: '$2,500/month',
      originalPrice: '$3,500/month',
      features: ['Telemedicine', 'Patient Management', 'Medical Analytics', 'Electronic Health Records', 'AI Integration', 'Compliance', 'Security', 'Integration'],
      benefits: ['Better healthcare', 'Cost reduction', 'Patient satisfaction', 'Improved outcomes'],
    ...
    },
    {
      ...
      description: 'Advanced educational technology solutions with learning management, student analytics, and virtual classrooms.',
      icon: GraduationCap,
      price: '$1,800/month',
      originalPrice: '$2,500/month',
      features: ['Learning Management', 'Student Analytics', 'Virtual Classrooms', 'Assessment Tools', 'Content Management', 'AI Integration', 'Mobile Learning', 'Analytics'],
      benefits: ['Better learning outcomes', 'Student engagement', 'Cost reduction', 'Scalable education'],
    ...
    },
    {
      ...
      description: 'Comprehensive retail technology solutions with e-commerce, inventory management, and customer analytics.',
      icon: ShoppingCart,
      price: '$2,000/month',
      originalPrice: '$2,800/month',
      features: ['E-commerce Platform', 'Inventory Management', 'Customer Analytics', 'Point of Sale', 'Mobile Commerce', 'AI Integration', 'Analytics', 'Integration'],
      benefits: ['Better retail experience', 'Increased sales', 'Cost reduction', 'Customer satisfaction'],
    ...
    },
    {
      ...
      description: 'Next-generation cybersecurity solutions with AI-powered threat detection, zero-trust architecture, and advanced analytics.',
      icon: Shield,
      price: '$3,000/month',
      originalPrice: '$4,200/month',
      ...
      benefits: ['Advanced protection', 'Proactive security', 'Compliance ready', 'Peace of mind'],
    ...
    },
    {
      ...
      description: 'Revolutionary quantum AI computing solutions combining quantum computing with artificial intelligence for breakthrough performance.',
      icon: Cpu,
      price: '$6,000/month',
      originalPrice: '$9,000/month',
      features: ['Quantum AI Algorithms', 'Hybrid Computing', 'Quantum Machine Learning', 'Optimization', 'Research & Development', 'Custom Solutions', 'Training', 'Support'],
      benefits: ['Breakthrough performance', 'Complex problem solving', 'Competitive advantage', 'Future technology'],
    ...
    },
    {
      ...
      description: 'Cutting-edge neural interface technology with brain-computer interfaces, neural prosthetics, and cognitive enhancement.',
      icon: Brain,
      price: '$4,800/month',
      originalPrice: '$7,000/month',
      features: ['Brain-Computer Interfaces', 'Neural Prosthetics', 'Cognitive Enhancement', 'Neural Monitoring', 'Research & Development', 'Medical Applications', 'Training', 'Support'],
      benefits: ['Revolutionary technology', 'Medical breakthroughs', 'Enhanced capabilities', 'Future-ready solutions'],
      link: '/neural-interface-technology',
      popular: true,
    ...
    },
    {
      ...
      description: 'Revolutionary materials science solutions with smart materials, nanotechnology, and advanced manufacturing.',
      icon: Settings,
      price: '$3,500/month',
      originalPrice: '$5,000/month',
      features: ['Smart Materials', 'Nanotechnology', 'Advanced Manufacturing', 'Material Testing', 'Research & Development', 'Custom Solutions', 'Quality Control', 'Analytics'],
      benefits: ['Advanced materials', 'Better performance', 'Cost reduction', 'Innovation leadership'],
      link: '/advanced-materials-science',
      popular: true,
      category: 'Materials',
      rating: 4.7,
      users: '80+',
    ...
    },
    {
      ...
      description: 'Comprehensive augmented reality solutions with AR applications, spatial computing, and immersive experiences.',
      icon: Eye,
      price: '$2,800/month',
      originalPrice: '$4,000/month',
      features: ['AR Applications', 'Spatial Computing', 'Immersive Experiences', '3D Visualization', 'Mobile AR', 'Enterprise AR', 'Analytics', 'Integration'],
      benefits: ['Immersive experiences', 'Better engagement', 'Enhanced productivity', 'Competitive advantage'],
    ...
    },
    {
      ...
      description: 'Comprehensive analytics platform with real-time processing, machine learning, and predictive analytics for enterprise insights.',
      icon: BarChart,
      price: '$2,200/month',
      originalPrice: '$3,200/month',
      features: ['Real-time Processing', 'Machine Learning', 'Predictive Analytics', 'Data Visualization', 'Custom Dashboards', 'API Integration', 'Scalable Architecture', 'Support'],
      benefits: ['Better insights', 'Real-time analytics', 'Predictive power', 'Data-driven decisions'],
      link: '/advanced-analytics-platform',
      popular: true,
      category: 'Analytics',
      rating: 4.8,
      users: '300+',

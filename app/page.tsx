  ...
  return (
    <ErrorBoundary>
      <SEO
        ...
        url="/"
      />
      {/* New Promo: Operational Evidence‑Led Decisions (Sept 2025) */}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 bg-white p-6 rounded-xl shadow-md border border-purple-100">
            <div>
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-1">AI 2026: Operational Evidence‑Led Decisions</h2>
              <p className="text-gray-600 mt-2">Centralize evals, incidents, approvals, and KPIs to drive safe, audit‑ready operations.</p>
            </div>
            <div className="flex gap-3">
              <Link href="/blog/ai-2026-operational-evidence-led-decisions" className="inline-block bg-purple-600 text-white px-5 py-3 rounded-lg font-semibold hover:bg-purple-700">Read Blueprint</Link>
              <Link href="/content/ai-2026-operational-excellence-handbook" className="inline-block border border-purple-600 text-purple-700 px-5 py-3 rounded-lg font-semibold hover:bg-purple-50">Excellence Handbook</Link>
            </div>
          </div>
        </div>
      </section>

...
import { CheckCircle, ArrowRight, Star, Clock, Zap, Shield, Brain, BarChart, Target, TrendingUp, Globe, Database, Users, Settings, Mail, Code, Cloud, Smartphone, Eye, MessageCircle, Workflow } from 'lucide-react';
...
const HomePage: React.FC = () => {
  ...
  const stats = [
    ...
    { icon: <Target className="w-8 h-8 text-cyan-400" />, value: '1000+', label: 'Projects Completed' },
    { icon: <Star className="w-8 h-8 text-cyan-400" />, value: '99%', label: 'Client Satisfaction' },
    { icon: <Clock className="w-8 h-8 text-cyan-400" />, value: '10+', label: 'Years Experience' }
  ];

  const aiServices = [
    { name: 'Machine Learning', description: 'Custom ML models for predictive analytics and automation', icon: Brain },
    { name: 'Natural Language Processing', description: 'AI-powered text analysis and language understanding', icon: Code },
    { name: 'Computer Vision', description: 'Image recognition and visual intelligence solutions', icon: Eye },
    { name: 'Predictive Analytics', description: 'Data-driven insights and forecasting capabilities', icon: BarChart },
    { name: 'AI Chatbots', description: 'Intelligent conversational agents for customer service', icon: MessageCircle },
    { name: 'Process Automation', description: 'Streamline workflows with intelligent automation', icon: Workflow }
  ];

  const itServices = [
    { name: 'Cloud Migration', description: 'Seamless transition to cloud infrastructure', icon: Cloud },
    { name: 'DevOps Implementation', description: 'Automated deployment and continuous integration', icon: Settings },
    { name: 'Database Optimization', description: 'Performance tuning and data management', icon: Database },
    { name: 'Security Audits', description: 'Comprehensive security assessment and hardening', icon: Shield },
    { name: 'API Development', description: 'RESTful and GraphQL API design and implementation', icon: Code },
    { name: 'Mobile Development', description: 'Native and cross-platform mobile applications', icon: Smartphone }
  ];
  return (
    <>
      <Helmet>

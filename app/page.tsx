...
const HomePage: React.FC = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: 'Professional team with deep technical knowledge. Highly recommended for any tech project.',
      rating: 5
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI, artificial intelligence, IT solutions, cloud computing, cybersecurity, data analytics, business automation" />
      </Helmet>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-300">
              Leading provider of cutting-edge technology solutions that drive innovation, 

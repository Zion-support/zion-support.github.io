...
import { Brain, Cloud, Shield, Zap, ArrowRight, CheckCircle, Star, Users, Globe, Code, BarChart, Target, Sparkles, Cpu, Database, Smartphone, Lock, TrendingUp, Settings, Calendar, FileText, MessageCircle, Heart, DollarSign, Box, Monitor, Link as LinkIcon, Server, Package, Mic, Workflow, Eye, Wifi, MessageSquare, ShoppingCart, Rocket, Phone, Mail, MapPin, Clock } from 'lucide-react';
...
const HomePage: React.FC = () => {
  ...
  const aiServices = [
    { name: 'AI Chatbots & NLP', icon: MessageCircle, description: 'Advanced conversational AI' },
    { name: 'Computer Vision', icon: Eye, description: 'Image and video analysis' },
    { name: 'Predictive Analytics', icon: BarChart, description: 'Data-driven insights' },
    { name: 'Voice AI', icon: Mic, description: 'Speech recognition and synthesis' },
    { name: 'AI Automation', icon: Workflow, description: 'Intelligent process automation' },
    { name: 'Machine Learning', icon: Brain, description: 'Custom ML models' }
  ];

  const itServices = [
    { name: 'Cloud Infrastructure', icon: Cloud, description: 'AWS, Azure, GCP solutions' },
    ...
    { name: 'Database Management', icon: Database, description: 'Data optimization' },
    { name: 'IT Support', icon: Monitor, description: '24/7 technical support' }
  ];

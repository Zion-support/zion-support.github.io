...
export default function HomePage() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Next-generation connectivity solutions with ultra-fast speeds',
      href: '/5g-implementation',
      icon: Wifi
    },
    {
      title: 'Digital Transformation',
      description: 'Comprehensive digital business transformation services',
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/about" className="bg-gradient-to-r from-purple-500 to-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-purple-600 hover:to-blue-700 transition-all duration-300 flex items-center justify-center">
              Get Started
              <ArrowRight className="ml-2 h-5 w-5" />
            </a>
            <a href="/contact" className="border border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-all duration-300">
              Learn More
            </a>
          </div>
        </div>

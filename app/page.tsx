...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid relative overflow-hidden">
      ...
      <main id="main-content" className="container mx-auto px-4 py-20" role="main">
        {/* Hero Section */}
        <section
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-6 py-3 rounded-full text-sm font-semibold mb-8">
          ...
          <p className="text-2xl md:text-3xl text-cyan-400 mb-8 font-medium" role="doc-subtitle">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
            <div className="cyber-card p-8 hover:scale-105 transition-all duration-500 group">
              <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                <span className="text-2xl">🚀</span>
              </div>
              <h3 className="font-bold text-white mb-4 text-xl text-center group-hover:text-cyan-400 transition-colors">AI-Powered Solutions</h3>
              <p className="text-gray-300 leading-relaxed text-center">Transform your business with cutting-edge artificial intelligence, machine learning, and automation technologies</p>
            </div>
            <div className="cyber-card p-8 hover:scale-105 transition-all duration-500 group">
              ...
              <h3 className="font-bold text-white mb-4 text-xl text-center group-hover:text-green-400 transition-colors">Proven Results</h3>
              <p className="text-gray-300 leading-relaxed text-center">Delivering $50M+ annual savings, 95% process automation, and 300% ROI for enterprise clients</p>
            </div>
            <div className="cyber-card p-8 hover:scale-105 transition-all duration-500 group">
              ...
              <h3 className="font-bold text-white mb-4 text-xl text-center group-hover:text-purple-400 transition-colors">Enterprise Security</h3>
              <p className="text-gray-300 leading-relaxed text-center">Bank-level security and compliance for your critical data and infrastructure</p>
            </div>
          </div>
          ...
          <div className="mt-16 flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <a
              href="/contact"
              className="bg-white/10 text-white px-8 py-4 rounded-xl font-semibold border border-cyan-500 hover:bg-cyan-500/20 transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-cyan-300 shadow-lg"
            >
        ...
        <section className="mb-20" aria-labelledby="services-heading">
          <h2 id="services-heading" className="text-4xl md:text-5xl font-bold text-white mb-6 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:scale-105 transition-all duration-500 group">
                <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                  <span className="text-2xl">🤖</span>
                </div>
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-cyan-400 mb-4">Starting at $299/month</div>
                  <a href="/ai-services" className="text-cyan-400 hover:text-cyan-300 font-medium group-hover:underline">
                    Learn More →
                  </a>
                </div>
              </article>
            ...
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:scale-105 transition-all duration-500 group">
                ...
                <h3 className="text-2xl font-bold text-white mb-4 text-center group-hover:text-purple-400 transition-colors">AI Marketing</h3>
                <p className="text-gray-300 mb-6 text-center leading-relaxed">
                  Revolutionary AI-powered marketing automation, ad optimization, and content generation.
                </p>
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-400 mb-4">Starting at $199/month</div>
                  <a href="/ai-marketing" className="text-purple-400 hover:text-purple-300 font-medium group-hover:underline">
                    Learn More →
                  </a>
                </div>
              </article>
            ...
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="cyber-card p-8 hover:scale-105 transition-all duration-500 group">
                ...
                <h3 className="text-2xl font-bold text-white mb-4 text-center group-hover:text-green-400 transition-colors">AI Automation</h3>
                <p className="text-gray-300 mb-6 text-center leading-relaxed">
                  Intelligent automation of business processes with decision-making capabilities and exception handling.
                </p>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-400 mb-4">Starting at $399/month</div>
                  <a href="/ai-automation" className="text-green-400 hover:text-green-300 font-medium group-hover:underline">
                    Learn More →
                  </a>
                </div>
              </article>

  ...
  const aiServices = [
    {
      icon: Brain,
      title: 'AI Consulting',
      description: 'Strategic AI consulting to transform your business with cutting-edge artificial intelligence solutions.',
    ...
    },
    {
      ...
      description: 'Scalable AI cloud infrastructure and deployment services for enterprise applications.',
    ...
    },
    {
      ...
      description: 'Custom AI model development and integration services tailored to your specific needs.',
              ...
              {aiServices.map((service, index) => (
                <div key={index} className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
                  ...
                  <div className="text-center">
                    ...
                    <a href={service.link} className="text-blue-400 hover:text-blue-300 font-medium transition-colors">
                      Learn More →
                    </a>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-300">Optimized performance and speed for all our solutions</p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300">24/7 expert support from our AI and IT specialists</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Get started with our AI and IT solutions today and see the difference tomorrow.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

...
const HomePage: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Comprehensive IT services including cloud migration, cybersecurity, and network management.',
      price: 'From $299/month'
    },
    {
      icon: <BarChart3 className="w-6 h-6 text-purple-500" />,
      title: 'Micro SAAS Applications',
      description: 'Specialized software solutions for specific business needs with intelligent automation.',
      price: 'From $69/month'
    },
    {
      icon: <Bot className="w-6 h-6 text-orange-500" />,
      title: '5G Implementation',
      description: 'Next-generation 5G solutions for enhanced connectivity and IoT applications.',
            ...
            {services.map((service, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 group">
                <div className="flex items-center mb-4">
                  {service.icon}
                  <h3 className="text-lg font-semibold text-white ml-3 group-hover:text-purple-300 transition-colors">{service.title}</h3>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Over 5 years of experience in AI, IT, and digital transformation across various industries.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Bank-level security with compliance certifications and 24/7 monitoring for your peace of mind.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Quick setup and deployment with pre-built templates and automated processes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
            {[
              ...
              'Kubernetes', 'MongoDB', 'PostgreSQL', 'Redis', 'TensorFlow', 'OpenAI'
            ].map((tech, index) => (

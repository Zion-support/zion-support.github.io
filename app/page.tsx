  ...
  <div className="bg-slate-800/50 rounded-2xl p-8 mb-16">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      <div className="text-center">
        ...
        <p className="text-gray-300">Streamline your business processes with intelligent automation</p>
      </div>
      <div className="text-center">
        <div className="text-6xl mb-4">☁️</div>
        <h3 className="text-xl font-bold text-white mb-4">Cloud Solutions</h3>
        <p className="text-gray-300">Scalable and secure cloud infrastructure for modern businesses</p>
      </div>
      <div className="text-center">
        <div className="text-6xl mb-4">🔒</div>
...
const ContentNewsletterSignup = () => (
  <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 rounded-2xl p-8 mb-16">
    <h2 className="text-3xl font-bold text-white mb-4 text-center">Stay Updated</h2>
    <p className="text-gray-300 text-center mb-8">Get the latest insights on AI and IT solutions</p>

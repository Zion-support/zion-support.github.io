  ...
  return (
    <div>
        ...
        <div className="relative max-w-7xl mx-auto text-center"></div>
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">Advanced page fixed solutions powered by AI technology.</p>p><div className="flex flex-col sm: flex-row gap-4 justify-center"></div>

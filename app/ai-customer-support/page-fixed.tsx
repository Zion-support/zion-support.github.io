...
const Pagefixed = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>Pagefixed | Zion Tech Group</title>
        <meta name="description" content="Pagefixed - Advanced AI and IT solutions by Zion Tech Group" />
        <meta name="keywords" content="pagefixed, AI solutions, IT services, Zion Tech Group" />
      </Helmet>

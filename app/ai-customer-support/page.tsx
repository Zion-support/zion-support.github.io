          ...
          <section className="text-center mb-16 relative overflow-hidden">
            ...
            <div className="relative z-10 py-16 px-4">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Transform your customer service with intelligent AI that provides instant, accurate, and personalized support 24/7.
              </p>
          ...
          <section className="text-center py-16">
            <div className="bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-2xl p-8">
              ...
              <p className="text-gray-300 mb-6 text-lg">
                Contact us for a free consultation and discover how AI can revolutionize your customer service.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a

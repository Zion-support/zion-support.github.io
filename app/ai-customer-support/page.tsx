          ...
          <section className="container mx-auto px-4 py-16">
            <div className="text-center mb-16">
              ...
              <p className="text-xl md:text-2xl text-cyan-400 mb-8">
                Revolutionary AI-Powered Customer Service
              </p>
              <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-12">
                Transform your customer support with intelligent AI chatbots, omnichannel support, 
                and automated workflows that deliver 95% customer satisfaction while reducing costs by 60%.
              </p>

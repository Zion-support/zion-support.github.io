...
const AICustomerSupportPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Automate routine tasks and escalate complex issues to human agents seamlessly.',
      benefits: ['Task automation', 'Smart routing', 'Workflow optimization', 'Efficiency gains']
    },
    {
      icon: Shield,
      title: 'Advanced Security',
      description: 'Enterprise-grade security with data encryption and compliance management.',
      benefits: ['Data encryption', 'GDPR compliance', 'SOC 2 certified', 'Privacy protection']
    },
    {
      icon: BarChart,
      title: 'Analytics & Insights',
      description: 'Comprehensive analytics dashboard with customer insights and performance metrics.',
      benefits: ['Real-time analytics', 'Customer satisfaction tracking', 'Performance metrics', 'ROI analysis']
    },
    {
      icon: Users,
      title: 'Human-AI Collaboration',
      description: 'Seamless handoff between AI and human agents with context preservation.',
      benefits: ['Smooth handoff', 'Context preservation', 'Agent assistance', 'Quality assurance']
    }
  ];
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-r from-teal-500 to-cyan-500 rounded-2xl p-12">
              ...
              <p className="text-xl text-teal-100 mb-8">
                Join thousands of businesses using our AI Customer Support
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">

...
const PageBackupPage: React.FC = () => {
    ...
    <div>
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
              <section className="relative py-20 px-4 overflow-hidden"></section>
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(147,51,234 0.3
        </div>
    </div>
  )_0% transparent_50%)] animate-pulse" /></div>
        ...
        <div className="relative max-w-7xl mx-auto text-center"></div>
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">Advanced page backup solutions powered by AI technology.</p>p><div className="flex flex-col sm: flex-row gap-4 justify-center"></div>
  ...
  r: scale-110 transition-transform"></div>
                  ...
                  {feature.benefits && (<ul className="space-y-2"></ul>
        ...
        <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-12"></div>
              ...
              <p className="text-xl text-gray-300 mb-8">Contact our experts to discuss your requirements and get started today.</p>p><div className="flex flex-col sm: flex-row gap-4 justify-center"></div>

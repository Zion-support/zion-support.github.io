...
const PageBackupPage: React.FC = () => {
    ...
    <div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">">
        <section className="re lative py-20 px-4 overflow-hidden"></section>
          <div className="ab solute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(147,51,234,0.3)_0%,transparent_50%)] animate-pulse /">
          <div className="ab solute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(59,130,246,0.3)_0%,transparent_50%)] animate-pulse style={{ animationDelay: '1s' }} /">
          <div className="re lative max-w-7xl mx-auto text-center">
            ...
            <div className= fl ex flex-col sm: flex-row gap-4 justify-center">
              ...
              <button className="bo rder border-purple-400 text-purple-400 hover: bg-purple-400 hove,
  ...
  r: scale-110 transition-transform ></div>
                    <feature.icon className="w-8 h-8  te xt-white /"></feature>
                  </div>
                  ...
                  {feature.benefits && (
                    <ul className= sp ace-y-2"></ul>
                      {feature.benefits.map((benefit, idx) => (</ul>
                        <li key={idx} className="fl ex items-center text-sm text-gray-400 ></li>
                          <CheckCircle className= w-4 h-4  te xt-green-400 mr-2 /"></CheckCircle>
                          {benefit}</CheckCircle>
                        </li>
                      ))}
                    </ul>

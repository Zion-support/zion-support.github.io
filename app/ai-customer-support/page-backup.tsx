'use client';'import React from 'react';';'import {Helmet}}from 'react-helmet-async';';'import Navigation from '../components/Navigation';';'import Footer from '../components/Footer';';'import {CheckCircle, ArrowRight, Star, Clock, Zap, Shield, Brain, BarChart, Target, TrendingUp}}from 'lucide-react';';'const PageBackupPage: React.FC = () => {,;
const features = [

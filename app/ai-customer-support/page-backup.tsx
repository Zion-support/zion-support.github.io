...
const PageBackupPage: React.FC = () => {
    ...
    <div />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
            <h1 className="text-4xl font-bold text-white mb-6">Page Backup</h1>
  ...
  r:text-white font-bold py-4 px-8 rounded-lg transition-all duration-300">Learn More
        ...
        <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 mb-8">Powerful AI technology that drives results</p>

...
export const metadata = {
  ...
  alternates: { canonical: '/ai-fraud-detection-pro' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Fraud Detection Pro provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Fraud Detection Pro',
      }}
    />
  );
}

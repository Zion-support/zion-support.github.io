...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Fashion Stylist & Personal Shopper',
        ...
        useCases: [
          {
            ...
            description: 'Automate routine tasks with <em>AI Fashion Stylist & Personal Shopper</em>, reduce manual errors, and free your team to focus on strategic priorities.',
            icon: '⚡'
          },
          {
          ...
          },
          {
            ...
            description: 'Leverage AI Fashion Stylist & Personal Shopper insights to make faster, more confident decisions backed by real operational data.',
            icon: '🎯'
          }
        ],
        benefits: [
        ...
        ctaLabel: 'Get Started with AI Fashion Stylist & Personal Shopper',
        ctaHref: '/contact?topic=ai-fashion-stylist',

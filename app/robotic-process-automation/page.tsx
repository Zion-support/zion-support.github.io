          ...
          <div className="bg-slate-800 rounded-lg p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-300">Invoice processing, financial reporting, and reconciliation.</div>
              
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">👥</div>
                <h3 className="text-xl font-semibold mb-3 text-blue-400">Human Resources</h3>
                <p className="text-gray-300">Employee onboarding, payroll processing, and benefits administration.</div>
              
              <div className="text-center">
                <div className="w-16 h-16 bg-purple-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">🛒</div>
                <h3 className="text-xl font-semibold mb-3 text-purple-400">Customer Service</h3>
                <p className="text-gray-300">Order processing, customer inquiries, and support ticket management.</div>

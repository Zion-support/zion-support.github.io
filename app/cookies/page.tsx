...
const CookiesPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Cookie Policy - Zion Tech Group | Cookie Usage Information</title>
        <meta name="description" content="Learn about how Zion Tech Group uses cookies on our website. Understand cookie types, management options, and your privacy choices." />
        <meta name="keywords" content="cookie policy, cookies, privacy, data protection, website cookies" />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-400 max-w-3xl mx-auto">
                ...
                on our website to enhance your browsing experience and provide our services.
              </p>
            </div>
          </div>
        </section>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Learn about how Zion Tech Group uses cookies on our website. Understand the types of cookies we use and how to manage your preferences." />
        <meta name="keywords" content="cookie policy, cookies, privacy, data protection, website analytics" />
        <meta property="og:title" content="Cookie Policy - Zion Tech Group" />
        <meta property="og:description" content="Learn about our cookie usage and privacy practices" />
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Cookie <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">Policy</span>
            </h1>
                ...
                <div key={index} className="bg-slate-700/50 rounded-lg p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      ...
                      {type.necessary && (
                        <span className="text-xs bg-green-500 text-white px-2 py-1 rounded-full">Required</span>
                      )}
                    </div>
                  </div>

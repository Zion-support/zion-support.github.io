...
;const CookiesPage: React.FC = () => {
  return (<div>
    ...
    d: {new Date().toLocaleDateString()}
                ...
                <p className="text-gray-700 mb-6>                  Cookies are small text files that are placed on your computer or mobile device when you visit our website.
                <
                
                <h2 className="text-2xl font-bold text-gray-900 mb-4>How We Use Cookies<
                <p className="text-gray-700 mb-6>                  We use cookies to improve your experience on our website, analyze site traffic, and personalize content.
                <

...
const CookiesPage: React.FC = () => {const features = [
    {icon: Wifi,
      ...
      benefits: ['Benefit 1', 'Benefit 2', 'Benefit 3']} , {icon: Settings,
    ...
    {icon: Eye,
      ...
      examples: ['Page views', 'User behavior', 'Performance metrics']} , {icon: Shield,
...
<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"
      ...
      <main className="pt-20">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
            ...
            </div><h1 className="text-4xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400 mb-6">
              </h>Cookie Policy
            </h1>
    ...
    d: grid-cols-2 l, g:grid-cols-3 gap-8"
      ...
      <Footer />
                  ...
                  <h3 className="text-xl font-semibold text-white mb-3"></h>{type.title}</h3>
                  <p className="text-gray-300 mb-4">{type.description}</p>
                  <ul className="text-sm text-gray-400 space-y-1">
                    </ul>{type.examples.map((example, exampleIndex) => (
                      <li key={exampleIndex}></l>• {example}</li>
                    )
    </>
  )
                  </ul>
    ...
    d: grid-cols-2 l, g:grid-cols-3 gap-8"
      ...
      <Footer />
                  ...
                  <div>
                    </div><h4 className="text-lg font-semibold text-cyan-400 mb-2"></h>Cookie Consent</h4>
      ...
      <Footer />
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                </div><h3 className="text-2xl font-bold text-white mb-4"></h>Third-Party Cookies</h3>
                ...
                <ul className="space-y-2 text-gray-300">
                  </ul><li></l>• Google Analytics - for website analytics</li>
                  <li></l>• Social media platforms - for social sharing features</li>
                  <li></l>• Advertising networks - for targeted advertising</li>
                </ul>
              </div>
      ...
      <Footer />
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                </div><h3 className="text-2xl font-bold text-white mb-4"></h>Updates to This Policy</h3>
                <p className="text-gray-300">

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Information about how we use cookies and similar technologies." />
        <meta name="keywords" content="cookie policy, cookies, data usage" />
      </Helmet>

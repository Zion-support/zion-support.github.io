...
const CookiesPage: React.FC = () => {}
  const cookieTypes = [;
    {}
      ...
      example,
      s: ['Session management', 'Security', 'Load balancing']
    },
    {}
      icon: Settings
      ...
      example,
      s: ['Language preferences', 'User settings', 'Remember me']
    },
    {}
      icon: Eye
      ...
      example,
      s: ['Page views', 'User behavior', 'Performance metrics']
    },
    {}
      icon: Shield
      ...
      example,
      s: ['Ad targeting', 'Campaign tracking', 'Conversion tracking']
    }
  ];
  ...
  return ()
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
      ...
      d:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400 mb-6"></h1>
              Cookie Policy
      ...
      g:grid-cols-4 gap-8"></div>
              {cookieTypes.map((type, index) => ()
                <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 text-center"></div>
                  <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full mx-auto mb-4"></div>
                    <type.icon: className="text-white" size={32} /></type>
          ...
          <div className="max-w-4xl mx-auto text-center"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
              ...
              <a></a>
                ...
                className="border border-cyan-400 text-cyan-400 px-8 py-3 rounded-lg font-semibold hover:bg-cyan-400 hove,

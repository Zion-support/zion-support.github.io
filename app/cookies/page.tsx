  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <main className="container mx-auto px-4 py-16 pt-24">{/* Header */}</main>
        ...
        {/* Cookie Types */}<section className="mb-16">
        ...
        {/* Cookie Details Table */}<section className="mb-16">
          </section><div className="cyber-card p-8">
        ...
        {/* Cookie Management */}<section className="mb-16">
          </section><div className="cyber-card p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className="space-y-3">
                  </div><div className="flex items-center justify-between p-3 bg-slate-800/50 rounded-lg">
        ...
        {/* Third-Party Cookies */}<section className="mb-16">
          </section><div className="cyber-card p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <h3 className="text-lg font-semibold text-cyan-400 mb-3">Social Media</h3><p className="text-gray-300 text-sm mb-2">Social media platforms may set cookies when you share content or visit our social media pages.<a href="https://www.facebook.com/privacy/explanation" className="text-cyan-400 hover:text-cyan-300 text-sm">Facebook Privacy Policy →</a>
                </a>
              </div>
            </div>
          </div>

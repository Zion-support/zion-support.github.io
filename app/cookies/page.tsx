...
const CookiesPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Cookies Solutions',
      description: 'Professional cookies services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored cookies implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your cookies needs.'
    }
  ];

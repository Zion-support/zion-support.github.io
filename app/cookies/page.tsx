...
export default function CookiesPage() {
  return (
    <>
      <Helmet>
        <title>Cookie Policy - Zion Tech Group<div></title>
        <meta name="description" content="Our cookie usage and preferences." /></div>
      </Helmet></div>
      <div><div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center"></div></div>
        <div className="text-center"></div></div></div>
          ...
          <p className="text-lg text-gray-300 mb-8">How we use cookies on our website.<div></p>
        </div></div>
      </div></div>
    </></div>
  );

        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto">{/* Header */}</div>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">This Cookie Policy explains how Zion Tech Group uses cookies and similar technologies on our website.</p>
              </p>
            ...
            <div className="bg-slate-800/50 rounded-lg p-8 mb-12">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">Cookies are small text files that are placed on your computer or mobile device when you visit a website. 
                They are widely used to make websites work more efficiently and to provide information to website owners.</p>
              </p>
              <p className="text-gray-300 leading-relaxed">This website uses cookies to improve your browsing experience, analyze site traffic, and personalize content. 
                By continuing to use this website, you consent to our use of cookies as described in this policy.</p>
              </p>
            </div>
            ...
            <div className="mb-12">
              ...
              <div className="space-y-8">{cookieTypes.map((type, index) => (</div>
                  <div key={index}, className="bg-slate-800/50 rounded-lg p-8">
                    <div className="flex items-start space-x-4 mb-6">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          {type.necessary && (
                            <span className="bg-green-500 text-white px-3 py-1 rounded-full text-sm font-semibold">Necessary</span>
                            </span>
                          )}
                        </div>
                    ...
                    <div>
                      ...
                      <ul className="grid grid-cols-1 md:grid-cols-2 gap-2">{type.examples.map((example, exampleIndex) => (</ul>
            ...
            <div className="bg-slate-800/50 rounded-lg p-8 mb-12">
              ...
              <div className="space-y-4 text-gray-300">
                <p>We may also use third-party cookies from trusted partners to enhance your experience and analyze website performance. 
                  These may include:</p>
                </p>
                ...
                <p>These third-party services have their own privacy policies and cookie practices. We recommend reviewing their policies 
                  for more information about how they use cookies.</p>
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-8 mb-12">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-gray-300 mb-4">Most web browsers allow you to control cookies through their settings preferences. You can:</p>
                  </p>
                ...
                <div>
                  ...
                  <p className="text-gray-300 mb-4">When you first visit our website, you'll see a cookie consent banner. You can:</p>
                  </p>
                  <ul className="space-y-2 text-gray-300 ml-6">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Please note that disabling certain cookies may affect the functionality of our website and your user experience. 
                    Some features may not work properly if cookies are disabled.</p>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-8 mb-12">
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <p>The duration of persistent cookies varies depending on their purpose. Some may last for a few days, 
                  while others may remain for several years.</p>
                </p>
              </div>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-8 mb-12">
              ...
              <div className="space-y-4 text-gray-300">
                <p>We may update this Cookie Policy from time to time to reflect changes in our practices or for other operational, 
                  legal, or regulatory reasons. We will notify you of any material changes by posting the updated policy on this page.</p>
                </p>
            ...
            <div className="bg-gradient-to-r from-cyan-500/10 to-blue-600/10 border border-cyan-500/20 rounded-lg p-8">
              ...
              <p className="text-gray-300 mb-6">If you have any questions about our use of cookies or this Cookie Policy, please contact us:</p>
              </p>

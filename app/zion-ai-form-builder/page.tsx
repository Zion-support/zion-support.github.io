        ...
        <div id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">Create beautiful forms with our intuitive drag-and-drop interface. No coding required.</div>

            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-3xl mb-4">🤖</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">AI-Powered Validation</h3>
              <p className="text-gray-600">Smart validation that learns from user behavior to provide better error messages and suggestions.</div>

            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-3xl mb-4">⚡</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Conditional Logic</h3>
              <p className="text-gray-600">Create dynamic forms that show/hide fields based on user responses for better user experience.</div>

            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-3xl mb-4">💡</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Smart Field Suggestions</h3>
              <p className="text-gray-600">AI suggests the best field types and options based on your form's purpose and content.</div>

            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-3xl mb-4">📱</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Mobile Optimization</h3>
              <p className="text-gray-600">Forms automatically adapt to mobile devices with touch-friendly interfaces and responsive design.</div>

            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-3xl mb-4">🔒</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Spam Protection</h3>
              <p className="text-gray-600">Advanced spam protection with CAPTCHA, honeypot fields, and AI-powered bot detection.</div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gray-50 p-8 rounded-xl">
                ...
                <div className="text-4xl font-bold text-green-600 mb-6">$19<span className="text-lg text-gray-500">/month</div>
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-center"><span className="text-green-500 mr-2">✓</span> Basic analytics</ul>
              ...
              <div className="bg-green-600 text-white p-8 rounded-xl relative">
                ...
                <div className="text-4xl font-bold mb-6">$49<span className="text-lg opacity-80">/month</div>
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-center"><span className="text-green-300 mr-2">✓</span> Custom branding</ul>
              ...
              <div className="bg-gray-50 p-8 rounded-xl">
                ...
                <div className="text-4xl font-bold text-green-600 mb-6">$149<span className="text-lg text-gray-500">/month</div>
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-center"><span className="text-green-500 mr-2">✓</span> API access</ul>
                <a href="/contact" className="w-full bg-green-600 text-white text-center py-3 rounded-lg font-semibold hover:bg-green-700 transition-colors block">
                  Contact Sales
                </div>
        </div>

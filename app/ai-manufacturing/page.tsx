  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional AI Manufacturing services and solutions for your business needs." />
        <meta name="keywords" content="AI, IT solutions, ai manufacturing, technology, innovation" />
      </Helmet>

...
=======
export default function AiManufacturingPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Ai Manufacturing - Zion Tech Group</title>
        <meta name="description" content="Advanced Ai Manufacturing solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Ai Manufacturing solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

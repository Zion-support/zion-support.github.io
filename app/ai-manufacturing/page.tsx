...
const AiManufacturingPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai manufacturing services and solutions by Zion Tech Group."
      keywords="ai manufacturing, services, solutions, technology, Zion Tech Group"
    >

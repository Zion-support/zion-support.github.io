      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Keep your servers running at peak performance with our comprehensive management services. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Everything you need to keep your servers secure, optimized, and running smoothly.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Professional server management services tailored to your business needs.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Choose the plan that fits your server infrastructure needs. All plans include 24/7 support.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Let our expert team manage your servers so you can focus on your business. 

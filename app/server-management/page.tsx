...
import {Link    } from 'react-router-dom';
;
constServerManagementPage: React.FC = () => {constfeatures = [{
  ...
  constservices = [{icon: <ServerclassName="w-8h-8t e xt-cyan-400" />,;

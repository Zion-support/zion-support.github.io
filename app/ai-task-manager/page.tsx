    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Navigation >{/* Hero Section */}</Navigation>
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              AI Task Manager <span className="text-cyan-400">Pro</span><p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Revolutionize your productivity with AI-powered task management. Smart prioritization,</p>
      ...
      {/* Features Grid */}<section className="py-16 px-4">
            ...
            <h2 className="text-4xl font-bold text-white mb-4">Powerful Features</h2><p className="text-xl text-gray-300">Everything you need to manage tasks efficiently<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{features.map((feature, index) => (</div>
      ...
      {/* Benefits Section */}<section className="py-16 px-4 bg-slate-800/30">
            ...
            <h2 className="text-4xl font-bold text-white mb-4">Why Choose AI Task Manager Pro?</h2><p className="text-xl text-gray-300">Proven results and cutting-edge technology<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{benefits.map((benefit, index) => (</div>
      ...
      {/* Pricing Section */}<section className="py-16 px-4">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-cyan-400/20 rounded-xl p-8 text-center">
              ...
              <div className="text-5xl font-bold text-cyan-400 mb-2">$49<span className="text-xl text-gray-300">/month</span><p className="text-gray-300">Per user, billed monthly</p>
            </div>

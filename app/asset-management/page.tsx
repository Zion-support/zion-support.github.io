...
const AssetManagementPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Asset Management Solutions',
      description: 'Professional asset management services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored asset management implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your asset management needs.'
    }
  ];

          ...
          <div className="bg-gray-50 rounded-lg p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-600">Continuously test and optimize your email campaigns with AI-driven A/B testing.</div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Dynamic Segmentation</h3>
                <p className="text-gray-600">Automatically segment your audience based on behavior, preferences, and engagement patterns.</div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Smart Scheduling</h3>
                <p className="text-gray-600">AI determines the optimal send times for each recipient to maximize open and click rates.</div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Performance Optimization</h3>
                <p className="text-gray-600">Continuously optimize campaign performance based on real-time data and AI insights.</div>
        </>
  )
  }

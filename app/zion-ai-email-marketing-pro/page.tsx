    ...
    <>
      ...
      <div className="min-h-screen pt-16">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="text-center mb-16">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 mb-6">
                ...
                <span>#1 AI Email Marketing Platform
                </span>
              </div>

              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                <span>Zion AI Email Marketing Pro
                </span>
              </h1>

              <p>Transform your email marketing with AI-powered content
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
                ...
                <div className="text-center">
                  ...
                  <div>Emails Sent Daily</div>
                </div>
                <div className="text-center">
                  <div>99.9%
                  </div>
                  <div>Deliverability Rate
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2>All Types of Email Campaigns
              </h2>
              <p>From newsletters to transactional emails, we've got you covered
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2>Powerful Features for Email Marketing Success
              </h2>
              <p>Everything you need to create, send, and optimize email
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-purple-800/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2>Choose Your Email Marketing Plan
              </h2>
              <p>Flexible pricing options designed to scale with your email
                marketing needs
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2>Trusted by Email Marketing Professionals
              </h2>
              <p>See how marketers are transforming their email campaigns with AI
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-2xl p-12">
              <h2>Ready to Transform Your Email Marketing?
              </h2>
              <p>Join thousands of businesses already using Zion AI Email

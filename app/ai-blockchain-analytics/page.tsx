...
import { CheckCircle, ArrowRight, BarChart, Shield, Zap } from "lucide-react";
  ...
  const features = [
    {
      ...
      benefits: ["Transaction analysis", "Pattern recognition", "Risk assessment"],
    },
    {
      icon: Shield,
      title: "Security Monitoring",
      description: "Real-time security monitoring and threat detection for blockchain networks.",
      benefits: ["Anomaly detection", "Threat intelligence", "Compliance monitoring"],
    },
    {
      icon: Zap,
      title: "Real-time Processing",
      description: "High-speed processing of blockchain data with real-time insights.",
      benefits: ["Live data feeds", "Instant alerts", "Performance metrics"],
    },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered blockchain analytics and security monitoring" />
        <meta property="og:title" content="AI Blockchain Analytics | Zion Tech Group" />
        <meta property="og:description" content="Advanced AI-powered blockchain analytics and security monitoring" />
      </Helmet>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Advanced AI-powered analytics for blockchain networks, smart contracts, and cryptocurrency transactions.
          </p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Ready to Implement Blockchain Analytics?
          </h2>
          <p className="text-xl text-gray-300 mb-8">
            Let us help you build advanced blockchain analytics for your business.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">

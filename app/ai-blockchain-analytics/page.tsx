  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered blockchain analytics solutions. Real-time insights, transaction analysis, and intelligent reporting for blockchain networks." />
        <meta name="keywords" content="AI blockchain analytics, blockchain analysis, crypto analytics, blockchain intelligence, DeFi analytics" />
      </Helmet>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Advanced AI-powered blockchain analytics solutions. Real-time insights, 
            transaction analysis, and intelligent reporting for blockchain networks.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Cutting-edge AI technology for blockchain intelligence and analysis
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the benefits of AI-powered blockchain intelligence
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-xl p-8 border border-white/10">
              ...
              <p className="text-gray-300 mb-6">
                Join thousands of blockchain projects already using our AI analytics platform
              </p>
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <div className="relative">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Start using AI-powered blockchain analytics to gain deep insights
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

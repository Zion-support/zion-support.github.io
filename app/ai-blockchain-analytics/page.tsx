  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered blockchain analytics for cryptocurrency and distributed ledger technologies." />
        <meta name="keywords" content="AI blockchain analytics, cryptocurrency analysis, blockchain intelligence, crypto trading, DeFi analytics" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced AI-powered blockchain analytics for cryptocurrency and distributed ledger technologies.
            </p>
        ...
        <section className="py-20 px-4 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Discover how Ai Blockchain Analytics can transform your business across different domains
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Analyze blockchain data with AI-powered insights and predictive analytics for better decision making." />
        <meta name="keywords" content="AI solutions, artificial intelligence, ai blockchain analytics, AI technology, intelligent automation" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Analyze blockchain data with AI-powered insights and predictive analytics for better decision making.
              </p>

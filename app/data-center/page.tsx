  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to optimize your data center operations and efficiency'
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description: 'Worldwide data center deployment and support for international businesses'
    }
  ]
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-12 border border-white/20 text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Contact us today to learn more about our data center solutions and how they can benefit your business.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Leverage AI to address climate challenges with intelligent environmental monitoring and optimization." />
        <meta name="keywords" content="AI solutions, artificial intelligence, ai climate solutions pro, AI technology, intelligent automation" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Leverage AI to address climate challenges with intelligent environmental monitoring and optimization.
              </p>

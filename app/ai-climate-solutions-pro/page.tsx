...
import { Leaf, Globe, TrendingUp, ArrowRight } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Advanced AI-powered climate monitoring and analysis solutions.",
      benefits: [
    ...
    },
    {
      ...
      description: "Comprehensive sustainability solutions for environmental impact reduction.",
      benefits: [
    ...
    },
    {
      ...
      description: "Advanced analytics for climate data and environmental trends.",
      benefits: [
        "Climate modeling",
        "Risk assessment",
        "Impact analysis",
                    ...
                    <ul className="space-y-2">
                      {feature.benefits.map((benefit, benefitIndex) => (
                        <li key={benefitIndex} className="flex items-start text-sm text-gray-300">
                          <Leaf className="w-4 h-4 text-purple-400 mr-2 flex-shrink-0" />
                          {benefit}
                        </li>
                      ))}
                    </ul>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Let us help you implement advanced AI climate solutions for environmental sustainability.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

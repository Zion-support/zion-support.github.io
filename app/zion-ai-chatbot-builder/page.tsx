  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Build intelligent chatbots without coding. Zion AI Chatbot Builder offers no-code AI chatbot creation with advanced NLP, multi-language support, and enterprise-grade security. Start free trial today."
        />
        <meta
          name="keywords"
          content="AI chatbot builder, no-code chatbot, conversational AI, customer support automation, lead generation, chatbot platform, AI assistant, natural language processing"
        />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                Build intelligent, conversational AI chatbots without coding. Create engaging customer experiences 
                with our no-code platform featuring advanced NLP, multi-language support, and enterprise-grade security.
              </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-purple-800/50 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                From customer support to lead generation, our AI chatbots adapt to your business needs.
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-900/30 to-purple-900/30 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of businesses using Zion AI Chatbot Builder to enhance customer experiences and drive growth.
            </p>

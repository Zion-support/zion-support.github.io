...
<<<<<<< HEAD
      ...
      <title>Page - Zion Tech Group</title>
        ...
        <h1 className="text-4 xl font-boldtext-whitemb-6">Cybersecurity</h1>
        <p className="text-lgtext-gray-300mb-8">Professional cybersecurity services coming soon.</p>
          Contact Us
...
=======
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        </div><h1 className="text-4 xl font-boldtext-white mb-6"  >Cybersecurity
        </h1>
        <p className="text-lg text-gray-300 mb-8">Professional cybersecurity services coming soon.
        </p>
        <Link
          to="/contact"
...
=======
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
      ...
      <div className="max-w-7xlmx-auto px-4 sm:px-6 lg:px-8 py-16 text-center"></div>
        ...
        <p className="text-lgtext-gray-300 mb-8">Professional cybersecurity services coming soon.</p>
        <Link;</Link></Link>
          to="/contact"

...
const CybersecurityPage: React.FC = () => {
  return (
    <>
      ...
      /></></SEOHead>
      {/* Hero Section */}
      <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900 flex items-center"></section>
        <div className="absolute inset-0 bg-black/50"></div>
        <div className="container mx-auto px-4 relative z-10"></div>
          <div className="max-w-4xl mx-auto text-center"></div>
            <div className="inline-flex items-center gap-2 bg-red-500/20 text-red-400 px-4 py-2 rounded-full text-sm font-medium mb-6"></div>
              <Shield className="w-4 h-4" /></Shield>
              Advanced Security Solutions
            </div>
            
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-red-100 to-red-300 bg-clip-text text-transparent"></h1>
              Cybersecurity
      ...
      <section className="py-20 bg-slate-800"></section>
        <div className="container mx-auto px-4"></div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
            <div className="bg-slate-700 p-8 rounded-xl hover:bg-slate-600 transition-colors"></div>
              <div className="w-12 h-12 bg-red-500/20 rounded-lg flex items-center justify-center mb-6"></div>
                <Shield className="w-6 h-6 text-red-400" /></Shield>
              </div>
            ...
            <div className="bg-slate-700 p-8 rounded-xl hover:bg-slate-600 transition-colors"></div>
              <div className="w-12 h-12 bg-red-500/20 rounded-lg flex items-center justify-center mb-6"></div>
                <Lock className="w-6 h-6 text-red-400" /></Lock>
              </div>
            ...
            <div className="bg-slate-700 p-8 rounded-xl hover:bg-slate-600 transition-colors"></div>
              <div className="w-12 h-12 bg-red-500/20 rounded-lg flex items-center justify-center mb-6"></div>
                <Eye className="w-6 h-6 text-red-400" /></Eye>
              </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-red-600 to-purple-600"></section>
        <div className="container mx-auto px-4 text-center"></div>
          <h2 className="text-4xl font-bold text-white mb-6"></h2>
            Ready to Secure Your Business?
          </h2>
          <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto"></p>

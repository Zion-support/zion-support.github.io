...
const CybersecurityPage: React.FC = () => {
  const securityServices = [
    {
      ...
      description:
        "AI-powered threat detection and response systems that identify and neutralize cyber threats in real-time.",
      icon: "🛡️",
    ...
    },
    {
      ...
      description:
        "Comprehensive security testing to identify vulnerabilities and assess security posture.",
      icon: "🔍",
    ...
    },
    {
      ...
      description:
        "24/7 security monitoring and incident response with dedicated security analysts.",
      icon: "🏢",
    ...
    },
    {
      ...
      description:
        "Comprehensive cloud security for AWS, Azure, and Google Cloud with compliance monitoring.",
      icon: "☁️",
    ...
    },
    {
      ...
      description:
        "Comprehensive data protection solutions including encryption, DLP, and privacy compliance.",
      icon: "🔒",
    ...
    },
    {
      ...
      description:
        "Advanced network security with next-generation firewalls and intrusion prevention systems.",
      icon: "🌐",
    ...
    },
    {
      ...
      description:
        "Advanced email security solutions to prevent phishing, malware, and email-based attacks.",
      icon: "📧",
    ...
    },
    {
      ...
      description:
        "Comprehensive mobile device security with MDM, app security, and threat protection.",
      icon: "📱",
    ...
    },
    {
      ...
      description:
        "Comprehensive compliance management for GDPR, HIPAA, SOX, and other regulatory requirements.",
      icon: "📋",
    ...
    },
    {
      ...
      description:
        "Comprehensive security awareness training programs to educate employees about cyber threats.",
      icon: "🎓",
    ...
    },
    {
      ...
      description:
        "Rapid incident response and digital forensics services for security breaches and investigations.",
      icon: "🚨",
  ...
  const _categories = [
    ...new Set(securityServices.map((service) => service.category)),
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Advanced cybersecurity services including threat detection, penetration testing, zero trust security, and comprehensive security solutions."
        />
        <meta
          name="keywords"
          content="cybersecurity services, threat detection, penetration testing, zero trust, security consulting, SOC services"
        />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 text-red-100 max-w-3xl mx-auto">
                Protect your business with advanced cybersecurity solutions and
                expert threat
                protectioncursor/add-new-services-and-deploy-updates-f159
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Expert security professionals delivering comprehensive
                protection against evolving cyber
                threatscursor/add-new-services-and-deploy-updates-f159
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Cutting-edge security technologies and AI-powered threat
                  detection
                </p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Quick incident response and recovery to minimize business
                  impact
                </p>
                cursor/add-new-services-and-deploy-updates-f159
              </div>
          ...
          <section key={category} className="py-16 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">
                  Specialized {category.toLowerCase()} services for
                    ...
                    >
                      ...
                      <div className="mb-4">
                        ...
                        <div className="text-sm text-green-600 font-semibold">
                          Save up to 50% vs market
                          ratescursor/add-new-services-and-deploy-updates-f159
                        </div>
                      </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Comprehensive security solutions covering all aspects of cyber
                protection
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-violet-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Comprehensive data protection and privacy solutions
                </p>
              </div>
        ...
        <section className="py-16 bg-gradient-to-r from-red-600 to-orange-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 text-red-100">
              ...
              and custom protection strategy
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a

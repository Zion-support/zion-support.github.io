  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to detect and prevent cyber threats'
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description: 'Worldwide cybersecurity protection and support'
    }
  ]
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the power of our cybersecurity solutions for your business.
            </p>
          </div>

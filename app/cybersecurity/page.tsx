  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to protect your systems and data from cyber threats'
    },
    {
      icon: Zap,
      title: 'Real-time Monitoring',
      description: 'Lightning-fast threat detection and response for optimal security'
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: 'Worldwide security monitoring and support for international businesses'
    }
  ]
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our cybersecurity solutions deliver unmatched protection, security, and peace of mind.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-12 border border-white/20 text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Contact us today to learn more about our cybersecurity solutions and how they can protect your business.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

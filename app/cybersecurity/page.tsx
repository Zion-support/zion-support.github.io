  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced cybersecurity solutions to protect your digital assets and data." />
        <meta name="keywords" content="cybersecurity, security solutions, data protection, network security, cyber defense" />
      </Helmet>
      <Navigation />
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced cybersecurity solutions to protect your digital assets and data.
            </p>

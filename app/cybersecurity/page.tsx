...
const CybersecurityPage: React.FC = () => {
  ...
  const services = [{
      title: 'Security Assessment', description: 'Comprehensive security evaluation and vulnerability testing', features: ['Penetration Testing', 'Vulnerability Scanning', 'Security Audits'],
...
const PagePage: React.FC = () => {
  ...
  const benefits = [{ metric: '99.9%', description: 'Threat Detection Rate' }, { metric: '24/7', description: 'Security Monitoring' }, { metric: '15min', description: 'Average Response Time' }, { metric: '100%', description: 'Compliance Guarantee' }
            ...
            {services.map((service, index) => (
              <div key={index} className="cyber-card hologram-card p-6">
                ...
                <div className="text-center">
                  ...
                  <Link to="/contact" className="text-red-400 hover: text-red-300 font-medium"></Link>
                    Learn More →
                  </Link>
                </div>
              </div>
...
const CybersecurityPage: React.FC = () => {
  ...
  const features = [{
      icon: Shield, title: 'Advanced Threat Protection', description: 'Multi-layered security solutions to protect against sophisticated cyber threats and attacks.'
    
  );
}, {
      icon: Lock, title: 'Data Encryption', description: 'End-to-end encryption for all your sensitive data and communications.'
    }, {
      icon: Eye, title: '24/7 Monitoring', description: 'Continuous monitoring and real-time threat detection across all your systems.'
    }, {
      icon: AlertTriangle, title: 'Incident Response', description: 'Rapid response and recovery services to minimize damage from security breaches.'
    }]

  const benefits = ['Protect sensitive business data', 'Comply with industry regulations', 'Prevent costly security breaches', 'Maintain business continuity', 'Build customer trust and confidence', 'Reduce security-related downtime', 'Access to security experts', 'Customized security solutions']

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional cybersecurity services by Zion Tech Group. Expert solutions for your business needs." />
        <meta name="keywords" content="cybersecurity, technology, solutions, business, professional" />
      </Helmet>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              Professional cybersecurity solutions designed to help your business succeed and grow.
            </p>

  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Comprehensive cybersecurity solutions including threat detection, vulnerability assessment, incident response, and security compliance. Protect your business from cyber threats."
        keywords={['cybersecurity', 'security services', 'threat detection', 'vulnerability assessment', 'incident response', 'security compliance', 'cyber protection']}
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              ...
              From threat detection to incident response, we provide complete security solutions tailored to your needs.
            </p>
          ...
          <section className="text-center">
            <div className="cyber-card p-8 max-w-4xl mx-auto">
              ...
              <p className="text-gray-300 mb-6 text-lg">
                Contact our cybersecurity experts today to discuss how our security solutions 
                can protect your business from cyber threats and ensure compliance.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="/contact"

...
<<<<<<< HEAD
  ...
  return (
    <React.Fragment>
      <Helmet>
        <title>
          Cybersecurity - Zion Tech Group | Advanced AI and IT Solutions
        </title>
        <meta
          name="description"
          content="Professional cybersecurity solutions powered by advanced AI and cutting-edge technology."
        />
        <meta
          name="keywords"
          content="cybersecurity, AI solutions, IT services, automation, technology, business solutions"
        />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional cybersecurity solutions powered by advanced AI and
...
=======
      name: "Security Audit",
      description:
        "Comprehensive security assessment of your systems and infrastructure",
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <h1
              ...
              data-text="Cybersecurity Solutions"
            >
              Cybersecurity Solutions
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Protect your business with our comprehensive cybersecurity
              solutions. Advanced threat detection, data encryption, compliance
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              We combine cutting-edge technology with deep security expertise to
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {securityFeatures.map((feature, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-20 h-20 rounded-full bg-gradient-to-r ${feature.gradient} p-6 mx-auto mb-6 icon-bounce`}
                  >
                    <Icon className="h-8 w-8 text-white" />
                  </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="glass-card p-12">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              comprehensive cybersecurity solutions and expert support.
            </p>

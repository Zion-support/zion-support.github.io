...
import { CheckCircle, Star, Shield, Lock, Eye, AlertTriangle, Database, Globe, Cloud, X } from 'lucide-react';
  ...
  return (
    <>
      <Head>
        ...
        <meta name="keywords" content="cybersecurity services, threat detection, penetration testing, zero trust, security consulting, SOC services" />      </Head>

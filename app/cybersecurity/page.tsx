...
const CybersecurityPage = () => {
  const securityServices = [
    {
      ...
      description: "Advanced threat protection and detection systems to keep your business safe",
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Security Consulting",
      description: "Expert security consulting to help you build a robust security strategy",
      color: "from-green-500 to-emerald-500"
    },
    {
      icon: <Calendar className="w-8 h-8" />,
      title: "Compliance Management",
      description: "Ensure your business meets all security compliance requirements",
      color: "from-purple-500 to-pink-500"
    },
    {
      icon: <Phone className="w-8 h-8" />,
      title: "Incident Response",
      description: "Rapid incident response and recovery services when security issues arise",
  ...
  const securityProcess = [
    ...
    },
    {
      ...
      description: "Develop a comprehensive security strategy tailored to your business needs"
    },
    {
      step: "3",
      title: "Implementation",
      description: "Implement security solutions and best practices across your organization"
    },
    {
      step: "4",
  ...
  const testimonials = [
    {
      ...
      role: "CISO",
      company: "TechCorp",
      content: "The cybersecurity services have significantly improved our security posture. We feel much more protected now.",
      rating: 5,
      avatar: "SC"
    },
    {
      ...
      content: "Excellent security services. The implementation was smooth and the ongoing support is outstanding.",
      rating: 5,
      avatar: "MR"
    },
    {
      ...
      company: "SecureCorp",
      content: "The threat protection capabilities are impressive. We've prevented several potential attacks.",
      rating: 5,
      avatar: "EJ"
    }
  ];
      ...
      <EnhancedAccessibility>
        <FuturisticBackgroundEnhanced>
          <EnhancedSEO
            ...
            description="Get comprehensive cybersecurity services from Zion Tech Group. Advanced threat protection, security consulting, and compliance management to secure your business."
            ...
            <section className="py-20 px-4 sm:px-6 lg:px-8">
              <ResponsiveContainer>
                <div className="text-center mb-16">
                  ...
                  <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                    Get the most out of your security investment with our expert services
                  </p>
                </div>

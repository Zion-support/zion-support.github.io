...
const services = [
  {
    ...
    description: "Comprehensive security assessment to identify and prioritize vulnerabilities in your systems.",
    price: "Starting at $2,500",
    features: ["Network scanning", "Penetration testing", "Report generation"],
  ...
  },
  {
    ...
    features: ["GDPR compliance", "HIPAA compliance", "SOC 2 preparation"],

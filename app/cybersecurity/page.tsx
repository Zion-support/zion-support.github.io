...
const CybersecurityPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Cybersecurity - Zion Tech Group | AI & IT Solutions</title>
        <meta name="description" content="Comprehensive cybersecurity solutions to protect your business from threats." />
        <meta name="keywords" content="cybersecurity, security, threat protection, Zion Tech Group" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 py-16">
            <div className="text-center mb-16">
              <h1 className="text-5xl font-bold text-white mb-6">
                <span className="bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">Cybersecurity</span>
              </h1>

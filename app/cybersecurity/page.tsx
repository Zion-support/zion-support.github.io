...
import { Shield, Lock, AlertTriangle, CheckCircle, Phone, Mail, MapPin, ArrowRight, Star, Users, Clock, Award } from 'lucide-react';
...
const CybersecurityPage: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Secure all devices and endpoints with comprehensive antivirus and monitoring',
      icon: '💻'
    },
    {
      title: 'Data Protection',
      description: 'Encrypt and secure sensitive data with advanced encryption and access controls',
      icon: '🔐'
    },
    {
  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Comprehensive cybersecurity solutions including threat detection, vulnerability assessment, incident response, and compliance management. Protect your business from cyber threats."
        keywords={['cybersecurity', 'threat detection', 'vulnerability assessment', 'incident response', 'security monitoring', 'penetration testing']}
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              ...
              From threat detection to incident response, we keep your digital assets secure 24/7.
            </p>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="cyber-card p-8 text-center">
                <h3 className="text-2xl font-bold text-white mb-4 neon-text">Essential</h3>
                <div className="text-4xl font-bold text-red-400 mb-6">$1,599<span className="text-lg text-gray-400">/month</span></div>
              ...
              <div className="cyber-card p-8 text-center">
                ...
                <div className="text-4xl font-bold text-red-400 mb-6">$4,999<span className="text-lg text-gray-400">/month</span></div>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />

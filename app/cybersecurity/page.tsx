      ...
      <section: className ="py-20 bg-slate-800">""";
        <div: className ="container mx-auto px-4">""";
          <div: className ="text-center mb-16">""";
            <h2: className ="text-4xl font-bold text-white mb-4">Our Security Services>;
        ...
        "";
              <h3: className ="text-xl font-semibold text-white mb-4">Threat Detection>;
        ...
        "";
              <h3: className ="text-xl font-semibold text-white mb-4">Vulnerability Assessment>;
              <p: className ="text-gray-300 mb-4">",";
        "";
        ...
        "";
              <h3: className ="text-xl font-semibold text-white mb-4">Security ing>;
              <p: className ="text-gray-300 mb-4">",";
        "";

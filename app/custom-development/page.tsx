  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Custom Development Services - Zion Tech Group | Software Development Solutions</title><//title><///title><////title></////title>
        <meta;";
          name="description;";
...
>"
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/5 to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div><//div><///div><////div></////div>
...
>"
                    ...
                    <div className="space-y-3">"
                      ...
                      <div className="flex flex-wrap gap-2 justify-center"></div><//div><///div><////div>
...
>
                    ...
                    <div className="mt-4 text-center"></div><//div><///div><////div>
                      <Link;
                        to={service.path};";

...
export default function CustomDevelopmentPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Custom Development - Zion Tech Group</title>
        <meta name="description" content="Advanced Custom Development solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Custom Development solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

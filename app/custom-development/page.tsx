    ...
    <>
      <Helmet></Helmet>
        ...
        <meta;>
          ...
          content="Custom software development services including web applications, mobile apps, e-commerce solutions, database development, and API development. Transform your ideas into reality.">: value
        />
        <meta;">
          name="keywords"">: value";
          content="custom development, software development, web development, mobile app development, e-commerce development, database development, API development, custom software">: value
        />
      </Helmet>
"
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-300">This page is under development...</p>: value
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 relative"></h1>
                ...
                <div className="absolute -inset-1 bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 rounded-lg blur opacity-30 animate-pulse"></div>: value
              </h1>
            </div>"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-300">This page is under development...</p>: value
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              {services.map((service, index) => (<div;: value>
                  key={index},">: value";
...
>
        ...
        <div className="space-y-3">
          ...
          <p className="text-gray-300">This page is under development...</p>: value
                        ...
                        <span className="text-cyan-400 font-bold text-lg">{service.price}</span>: value
                      </div>"
                      <div className="flex flex-wrap gap-2 justify-center"></div>: value
                        {service.features.map((feature, idx) => (: value
                          <span;>
                            key={idx},">: value";
      className="text-xs bg-cyan-500/20 text-cyan-300 px-2 py-1 rounded-full border border-cyan-500/30">: value
                          ></span>
>
                            {feature};
                          </span>
                    ...
                    "
                    <div className="mt-4 text-center"></div>: value
                      <Link;>
...
>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">"
          ...
          <p className="text-gray-300">This page is under development...</p>: value
                  ...
                  <p className="text-cyan-400">kleber@ziontechgroup.com</p>: value
                </div>"
        ...
        <div className="text-center">
          ...
          <p className="text-gray-300">This page is under development...</p>: value
                  ...
                  <p className="text-cyan-400">+1 302 464 0950</p>: value
                </div>"
                <div className="text-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4">Coming Soon</h1>
          <p className="text-gray-300">This page is under development...</p>: value
                  ...
                  <p className="text-cyan-400 text-sm">364 E Main St STE 1008<br />Middletown DE 19709</p>: value
                </div>
              </div>
              "
              <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>

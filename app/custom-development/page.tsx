  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Bespoke AI and IT solutions designed specifically for your business needs." />
        <meta name="keywords" content="custom development, bespoke solutions, tailored software" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Bespoke AI and IT solutions designed specifically for your business needs.
              </p>

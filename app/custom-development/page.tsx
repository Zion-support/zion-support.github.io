      ...
      className="inline-flex items-center text-cyan-400 hover:text-cyan-300 font-medium group-hover:translate-x-1 transition-all duration-300""
        ...
        <div  className ="max-w-4xl mx-auto text-center">"
          ...
          <p  className ="text-gray-300">This page is under development...</p>"
              ...
              <p  className ="text-xl text-gray-300 mb-8"></p>"                Let's discuss your project and create a custom solution that perfectly fits your business needs. '
                Contact us today for a personalized consultation.
              </p>
              
              {/* Contact Details */}              <div  className ="grid grid-cols-1 md=grid-cols-3 gap-6 mb-8">"

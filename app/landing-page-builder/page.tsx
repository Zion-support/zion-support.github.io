          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <p className="text-gray-600">
                Build beautiful landing pages with our intuitive drag-and-drop interface.
              </p>
            </div>
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">AI Optimization</h3>
              <p className="text-gray-600">
                AI-powered suggestions to optimize your pages for better conversions.
              </p>
            </div>
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Mobile Responsive</h3>
              <p className="text-gray-600">
                All pages are automatically optimized for mobile devices.
              </p>
            </div>
          </div>

    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">{/* Hero Section */}</div>
      <div className="container mx-auto px-4 py-16"></div>
        <div className="text-center mb-16"></div>
          <h1 className="text-5 xl font-bold text-white mb-6"></h1></<<<h1>Landing</h1></<<h1>Page</h1> <span className="text-cyan-400"></span></<<<span>Builder</span></span><p className="text-xl text-gray-300 max-w-3 xl mx-auto mb-8">Create high-converting landing pages in minutes with our AI-powered builder.</p></<<<p>No</p></<<p>coding</p> required - just drag, drop, and launch.</p>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            ...
            ></Lin>
              <Layout className="w-5 h-5 mr-2" >Start Building</Layou>
            </Layout>
            <Link
              href="/demo"
        ...
        {/* Templates Section */}
        <div className="mb-16"></div>
          <h2 className="text-3 xl font-bold text-white text-center mb-12"></h2></<<<h2>Professional</h2></h2> <span className="text-cyan-400"></span></<<<span>Templates</span></span><div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">{templates.map((template, index) => (</div>
              <div
                key={index}
                className="bg-white/10 backdrop-blur-lg rounded-2 xl p-6 text-center border border-gray-600 hover:border-cyan-400/50 transition-all duration-300"
              ></div>
                <h3 className="text-xl font-semibold text-white mb-2"></h>{template.category}<div className="text-cyan-400 font-bold text-lg mb-2"></div>{template.count}<p className="text-gray-300 text-sm">{template.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-cyan-600/20 to-blue-600/20 rounded-2 xl p-12 text-center"></div>
          <h2 className="text-3 xl font-bold text-white mb-4"></h2></<<<h2>Ready</h2></<<h2>to</h2> Build Your Landing Page?<p className="text-xl text-gray-300 mb-8 max-w-2 xl mx-auto">Join thousands of businesses creating high-converting landing pages with our builder.</p>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            <Link
              href="/contact"

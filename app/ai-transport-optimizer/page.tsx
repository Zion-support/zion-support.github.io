...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Transportation Route Optimizer',
        ...
        useCases: [
          {
            ...
            description: 'Automate routine tasks with <em>AI Transportation Route Optimizer</em>, reduce manual errors, and free your team to focus on strategic priorities.',
            icon: '⚡'
          },
          {
          ...
          },
          {
            ...
            description: 'Leverage AI Transportation Route Optimizer insights to make faster, more confident decisions backed by real operational data.',
            icon: '🎯'
          }
        ],
        benefits: [
        ...
        ctaLabel: 'Get Started with AI Transportation Route Optimizer',
        ctaHref: '/contact?topic=ai-transport-optimizer',

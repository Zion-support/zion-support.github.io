...
export const metadata = {
  ...
  description:
    'Scoped I Ds, on‑device aggregation, and differential privacy for actionable insights without PII at <100ms.'};;

export default function Page() {return (<main className="max-w-4xl mx-auto px-4 py-12">
      <div className="mb-8">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <ul>
          <li>Scoped I    Ds    derived from device secrets and per‑app salts</li>

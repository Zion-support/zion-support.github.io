...
export default function Page() {return (<mainclassName='max-w-4xl mx-auto px-4 py-12'>
      <divclassName='mb-8'>
        <spanclassName='inline-block text-xs px-3 py-1 rounded-full bg-cyan-100 text-cyan-800 border border-cyan-200 mr-2'>
          Analytics
        </span>
        <spanclassName='inline-block text-xs px-3 py-1 rounded-full bg-blue-100 text-blue-800 border border-blue-200'>
          2026
        </span>
      </div>
      ...
      <pclassName='text-gray-600 text-lg mb-8'>
      ...
      <divclassName='prose prose-invert max-w-none'>

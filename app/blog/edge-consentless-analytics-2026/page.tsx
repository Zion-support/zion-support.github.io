  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="mt-10 flex gap-4">
        <a href="/blog" className="inline-block bg-cyan-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-cyan-700">Explore More Articles</a>
        <a href="/contact" className="inline-block border-2 border-cyan-600 text-cyan-600 px-6 py-3 rounded-lg font-semibold hover:bg-cyan-600 hover:text-white">Talk to an Expert</a>
      </div>
    </main>
  );
}
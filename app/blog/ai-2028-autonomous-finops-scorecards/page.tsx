      ...
      <article className="max-w-4xl mx-auto px-4 py-12 prose prose-invert prose-emerald">
        ...
        <div className="mt-10 p-6 rounded-2xl bg-emerald-900/40 border border-emerald-700/40">
          ...
          <div className="flex flex-wrap gap-3">
            <a href="/blog/ai-2027-cost-optimization-playbook" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-white transition-colors">
              Cost Optimization Playbook 2027 →
            </a>
            <a href="/blog/genai-quality-tiers-v2-2026" className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-white transition-colors">

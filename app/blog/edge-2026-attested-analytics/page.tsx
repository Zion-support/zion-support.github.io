	...
	return (
		<main className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
			...
			<p>
				...
				and differential privacy, then sign attestations so teams can trust every metric.
			</p>
			<ul>
			...
			<p>
				Related reads: <a href="/blog/edge-private-analytics-2027">Edge Private Analytics 2027</a>{' '}
				and <a href="/blog/verifiable-edge-analytics-2026">Verifiable Edge Analytics 2026</a>.
			</p>
			<p>

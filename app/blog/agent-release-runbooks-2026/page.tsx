...
export const metadata = {
  ...
  description: "Approvals + budgets + KPI-linked canary evals with instant rollback for safe agent releases.",
  type: "article",
  published Time: '2026-01-30T00:00:00Z'};;

export default function Agent Release Runbooks2026() {return (<div className="min-h-screen bg-gradient-to-br from-fuchsia-950 via-purple-950 to-indigo-950 text-white">
        ...
        <article Name="max-w-4xl mx-auto">
          <header className="mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold mb-4 bg-gradient-to-r from-fuchsia-300 to-purple-300 bg-clip-text text-transparent">
              Agent Release Runbooks: Approvals Budgetsand Instant    Rollback
            </h1>

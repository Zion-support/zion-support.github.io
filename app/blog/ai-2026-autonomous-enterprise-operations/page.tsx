            ...
            <div className="space-y-8">
              {[
                ...
                <div key={index} className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10">
                  <h3 className="text-2xl font-bold text-white mb-3">{application}</h3>
                  <p className="text-gray-400 mb-4">{application}</p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">{phase}</h3>

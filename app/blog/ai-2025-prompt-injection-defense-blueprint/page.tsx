// @ts-nocheck
export const metadata = {title: 'Prompt Injection Defense 2025: Enterprise Blueprint for Safe GenAI',
  description: 'Practical, enterprise-ready blueprint to defend against prompt injection with layered policies, model hardening, and continuous red teaming.',
  openGraph: {
...
export default function Page() {return (<div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-slate-900 text-white">

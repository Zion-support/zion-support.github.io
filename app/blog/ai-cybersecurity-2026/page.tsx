    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h4 className="text-xl font-bold text-green-600 mb-3">🚀 Response Features</h4>
            <ul className="text-gray-700 space-y-2">
        ...
        <div className="bg-gray-50 p-6 rounded-lg mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white p-4 rounded-lg">
              <h5 className="font-bold text-blue-600 mb-2">Never Trust, Always Verify</h5>
              <p className="text-sm text-gray-600">Continuous authentication and authorization for all users and devices</p>
            </div>
            <div className="bg-white p-4 rounded-lg">
              <h5 className="font-bold text-green-600 mb-2">Least Privilege Access</h5>
              <p className="text-sm text-gray-600">Minimal access rights based on business requirements</p>
            </div>
            <div className="bg-white p-4 rounded-lg">
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="border-l-4 border-blue-500 pl-6">
            <h3 className="text-xl font-bold text-gray-900 mb-2">Threat Intelligence</h3>
            <p className="text-gray-700">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h4 className="text-xl font-bold text-blue-600 mb-3">📈 Performance Metrics</h4>
            <ul className="text-gray-700 space-y-2">
        ...
        <div className="bg-red-600 text-white p-6 rounded-xl mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/<contact" className="bg-white text-red-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-center"
            >
              Get Security Assessment
            </Link>
            <Link
              href="/services/cybersecurity-<consulting" className="border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-red-600 transition-colors text-center"
            >

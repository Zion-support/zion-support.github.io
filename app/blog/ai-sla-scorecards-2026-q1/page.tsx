...
export const metadata = {
  ...
  description:
    'Design and ship AI SLA scorecards wired to business KPIs with budgets, canaries, and instant rollback. A practical 2026 Q1 playbook for reliable autonomy.',
  openGraph: {
      ...
      <section className='py-16'>
        <div className='max-w-4xl mx-auto px-6 prose prose-lg'>
          ...
          <p>
            ...
            stable by tying SLIs (latency, accuracy, cost per output) to product
            KPIs with explicit error budgets and rollback triggers.
          </p>

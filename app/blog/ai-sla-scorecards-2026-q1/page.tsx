    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50">
      <header className="bg-gradient-to-br from-indigo-900 via-purple-900 to-slate-900 text-white py-20">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="flex items-center gap-6 text-white/70 mt-8">
            ...
            <div className="flex items-center gap-2">🕐<span>16 min read</span></div>
          </div>
        </div>
      </header>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-2xl font-bold mb-6 flex items-center gap-2">🛡️ Reference SLIs</h2>
        ...
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl p-8">
            ...
            <div className="flex gap-3">
              <a href="/contact" className="bg-white text-indigo-700 px-6 py-3 rounded-lg font-semibold inline-flex items-center gap-2">Talk to experts →</a>
              <a href="/blog/ai-governance-live-scorecards-2026" className="border border-white/50 px-6 py-3 rounded-lg font-semibold inline-flex items-center gap-2">Read live scorecards</a>
            </div>
          </div>
        </div>
      </section>

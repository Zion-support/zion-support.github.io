  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <nav className="mb-8">
          <ArrowRight href="/blog" className="text-blue-600 hover:text-blue-700">← Back to Blog</ArrowRight>
        </nav>
        ...
        <div className="mt-12">
          <ArrowRight href="/blog" className="text-blue-600 font-semibold hover:text-blue-700">Browse more articles →</ArrowRight>
        </div>
      </div>
    </div>
  );

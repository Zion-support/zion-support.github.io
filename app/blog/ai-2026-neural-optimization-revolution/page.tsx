  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <article className="prose prose-lg max-w-none">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Core Techniques</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Reference Architecture</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <h3 className="font-semibold text-gray-900 mb-2">Online Path (sub-100ms)</h3>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              <h3 className="font-semibold text-gray-900 mb-2">Batch/Async Path</h3>
              <ul className="list-disc list-inside text-gray-700 space-y-1">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Business Impact</h2>

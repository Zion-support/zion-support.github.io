...
export const metadata = {title:'Enterprise Knowledge Graph Orchestration — October 2025',
  description:
...
export default function Page() {return (<mainclassName='max-w-3xl mx-auto px-4 py-12'>
      <headerclassName='mb-8'>
        <divclassName='inline-block bg-indigo-100 text-indigo-800 px-3 py-1 rounded-full text-xs font-semibold'>
          NEW — Oct 1, 2025
        </div>
      ...
      <sectionclassName='prose prose-slate max-w-none'>
        <p>
          We walk through ingestion patterns, entity resolution, policy tagging,
          and graph-powered retrieval augmented generation. The architecture
          improves answer precision by 30–55% while meeting audit and retention
          requirements.
        </p>
        <ol>

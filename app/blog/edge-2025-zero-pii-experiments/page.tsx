...
export default function EdgeExperiments2025() {return (<divclassName='max-w-4xl mx-auto px-4 py-10'>
      <articleclassName='prose prose-lg max-w-none'>
        <headerclassName='mb-8'>
          <divclassName='flex items-center gap-2 mb-3'>
            <spanclassName='bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-3 py-1 rounded-full text-xs font-bold'>
              ANALYTICS
            </span>
            <spanclassName='text-sm text-gray-500'>September 30, 2025</span>
          </div>
          <h1className='text-4xl md:text-5xl font-bold text-gray-900 leading-tight'>
            Edge Experiments 2025 — Zero‑PII Global A/B with Privacy Budgets
          </h1>
          <pclassName='text-xl text-gray-600 mt-4'>
        ...
        <sectionclassName='mb-8 bg-cyan-50 rounded-lg p-6'>
          <h2className='text-2xl font-bold text-gray-900 mb-4'>
            Why This Matters
          </h2>
          <divclassName='grid md:grid-cols-3 gap-4'>
            <divclassName='bg-white p-4 rounded-lg shadow-sm text-center'>
              <divclassName='text-3xl font-bold text-cyan-600 mb-1'>
                &lt;100ms
              </div>
              <divclassName='text-sm text-gray-600'>Latency</div>
            </div>
            <divclassName='bg-white p-4 rounded-lg shadow-sm text-center'>
              <divclassName='text-3xl font-bold text-blue-600 mb-1'>0 PII</div>
              <divclassName='text-sm text-gray-600'>Scoped IDs</div>
            </div>
            <divclassName='bg-white p-4 rounded-lg shadow-sm text-center'>
              <divclassName='text-3xl font-bold text-indigo-600 mb-1'>DP</div>
              <divclassName='text-sm text-gray-600'>Differential Privacy</div>
            </div>
          </div>
        </section>
        ...
        <sectionclassName='mb-10'>
          ...
          <olclassName='list-decimal list-inside text-gray-700 space-y-2'>
        ...
        <divclassName='border-t border-gray-200 pt-8 mt-12'>

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      <main className="container mx-auto px-6 py-12">
        <nav className="mb-8">
          <a href="/blog" className="text-cyan-300 hover:text-cyan-200 transition-colors">
            ← Back to Blog
          </a>
        </nav>
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-lg max-w-none space-y-10">
            <section>
              <h2 className="text-2xl md:text-3xl font-bold mb-3 text-cyan-300">Reliability Design Principles</h2>
            ...
            <section>
              <h2 className="text-2xl md:text-3xl font-bold mb-3 text-teal-300">Observability & Evals</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                  <h3 className="text-xl font-bold mb-2 text-cyan-200">Traces & Budgets</h3>
                  <p className="text-white/80">Track every tool call, token, and decision with cost budgets per task.</p>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                  <h3 className="text-xl font-bold mb-2 text-teal-200">Eval Scorecards</h3>
                  <p className="text-white/80">Continuously evaluate accuracy, safety, and business outcomes with regression alerts.</p>
                </div>
              </div>
            </section>

            <section>
              <h2 className="text-2xl md:text-3xl font-bold mb-3 text-fuchsia-300">Rollout & Incident Response</h2>
              <ul className="space-y-2 text-white/80">
            ...
            <section className="bg-gradient-to-br from-cyan-500/20 to-teal-500/20 border border-cyan-500/30 rounded-2xl p-8">
              <h2 className="text-3xl font-bold mb-3 text-center">Make Autonomy Measurable</h2>
              ...
              <div className="flex justify-center gap-4">
                <a href="/contact" className="bg-gradient-to-r from-cyan-500 to-teal-600 hover:from-cyan-400 hover:to-teal-500 text-white font-bold py-3 px-6 rounded-xl transition-all">
                  Talk to an Expert
                </a>

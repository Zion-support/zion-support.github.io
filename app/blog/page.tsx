...
const BlogPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Blog Solutions',
      description: 'Professional blog services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored blog implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your blog needs.'
    }
  ];

...
const posts = [
  {
    ...
    description: 'A practical roadmap to fund govern and ship AI with KPI‑linked scorecards and guardrails‑as‑code.',
  ...
  },
  {
    ...
    description: "Explore the groundbreaking convergence of quantum computing and neural networks that's revolutionizing enterprise AI in 2026.",
  ...
  },
  {
    ...
    description: 'Discover how synthetic consciousness AI is revolutionizing enterprise operations with self-aware systems and autonomous decision-making.',
  ...
  },
  {
    ...
    description: 'Learn how autonomous AI systems are revolutionizing enterprise operations with self-managing self-optimizing and self-healing capabilities.',
  ...
  {
    title: 'Gen AI Security in 2025: Practical Controls That Actually Work',
    description: 'A pragmatic security blueprint for production Gen AI: controls gateways and evals.',
  ...
  },
  {
    ...
    description: 'A pragmatic blueprint for multi-tenant eval-driven RAG with strong isolation and uptime.',
  ...
  },
  {
    ...
    description: 'Milestones guardrails and evals that keep AI features shipping on time with quality.',
  ...
  },
  {
    ...
    description: 'Move inference to the edge for sub-100 ms decisions resilience and bandwidth savings.',
    href: '/blog/edge-ai-in-manufacturing-2025',
    date: '2025-09-11',
    tags: ['Edge AI', 'Manufacturing', 'IoT']
  },
  {
    title: 'Gen AI Evals in Production: What Actually Works',
    description: 'Build continuous eval loops with golden tasks HITL audits and drift-aware sampling.',
    href: '/blog/genai-evals-in-production',
    date: '2025-09-11',
    tags: ['Gen AI', 'Evals', 'Quality']
  },
  {
    title: 'Startup Micro SaaS Playbook: From Idea to $10k MRR',
    description: 'A pragmatic blueprint to launch and grow a Micro SaaS with capital efficiency.',
  ...
  },
  {
    ...
    description: 'Translate policy into day-to-day decisions with risk tiering evals and reviews.',
  ...
  },
  {
    ...
    description: 'Run ML and Gen AI on serverless with predictable cost and strong reliability.',
  ...
  },
  {
    ...
    description: 'How to harden agents for production with logging evals safety and cost controls.',
    href: '/blog/production-grade-ai-agents',
    date: '2025-09-11',
    tags: ['AI', 'Agents', 'ML Ops']
  },
  {
  ...
  },
  {
    ...
    description: 'Automation-first FinOps: waste sweeps rightsizing approvals commitments and guardrails.',
  ...
  },
  {
    ...
    description: 'Production-ready patterns for self-service assistants case triage agent copilots and QA.',
  ...
  },
  {
    ...
    description: 'A pragmatic framework to reduce inference costs while maintaining performance and velocity.',
  ...
  },
  {
    ...
    description: 'Step-by-step architecture and rollout plan for RAG in regulated multi-tenant environments.',
  ...
  },
  {
    ...
    description: 'Ingestion lakehouse transformations metrics and activation that actually work at scale.',

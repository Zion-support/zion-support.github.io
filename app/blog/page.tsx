...
const BlogPage: React.FC = () => {
  ...
  const blogPosts: BlogPost[] = [
    ...
    },
    {
      ...
      excerpt: 'Discover how micro SaaS solutions are revolutionizing the way businesses approach software and automation.',
      author: 'Product Team',
      date: '2023-12-28',
      readTime: '6 min read',
      category: 'Micro SaaS',
      tags: ['Micro SaaS', 'Business Software', 'Automation'],
      featured: true
    },
    {
      id: '6',
      title: 'IT Infrastructure Modernization Strategies',
      excerpt: 'Learn the best practices for modernizing your IT infrastructure to support digital transformation.',
      author: 'IT Solutions Team',
      date: '2023-12-20',
      readTime: '8 min read',
      category: 'IT Services',
      tags: ['IT Infrastructure', 'Digital Transformation', 'Modernization'],
      featured: false
    }
  ];

  const categories = ['All', 'AI & Machine Learning', 'Cloud Computing', 'Cybersecurity', 'Development', 'Micro SaaS', 'IT Services'];
        ...
        <section className="relative py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Stay updated with the latest trends in AI, cloud computing, cybersecurity, and IT solutions.
            </p>

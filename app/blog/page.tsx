...
export default function BlogPage() {
  ...
  const featuredPost = {
    ...
    excerpt:
      "Explore the latest trends in enterprise AI adoption, from quantum computing integration to autonomous systems, and discover how businesses are leveraging AI for competitive advantage.",
  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Learn the essential steps and strategies for successful cloud migration, including planning, execution, and optimization techniques.",
    ...
    },
    {
      ...
      excerpt:
        "Discover how AI is both creating new security challenges and providing innovative solutions to protect enterprise data and systems.",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive guide to leading successful digital transformation initiatives, from strategy development to implementation.",
    ...
    },
    {
      ...
      excerpt:
        "Explore how edge computing is revolutionizing AI deployment and enabling real-time processing at the network edge.",
      author: "Michael Rodriguez",
      authorRole: "Head of Engineering",
      authorImage: "/images/authors/michael-rodriguez.jpg",
    ...
    },
    {
      ...
      excerpt:
        "Learn about the importance of AI ethics and how to implement responsible AI practices in your organization.",
      author: "Dr. Sarah Chen",
      authorRole: "Head of AI Research",
      authorImage: "/images/authors/sarah-chen.jpg",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl lg:text-2xl text-gray-300 mb-8 leading-relaxed">
              Stay updated with the latest trends in AI, cloud computing,
              cybersecurity, and digital transformation. Expert insights from
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="p-8">
                  <div className="flex items-center space-x-2 mb-4">
                    <div
                      className={`w-8 h-8 ${getCategoryColor(featuredPost.category)}`}
                    >
                      {React.createElement(
              ...
              {filteredPosts.map((post) => (
                ...
                >
                  <div className="relative">
                    ...
                    <div className="absolute top-4 left-4">
                      <div
                        className={`w-8 h-8 ${getCategoryColor(post.category)}`}
                      >
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-r from-cyan-600 to-purple-700 rounded-lg p-8">
              ...
              <p className="text-xl text-gray-200 mb-8">
                Get the latest articles, industry insights, and expert opinions

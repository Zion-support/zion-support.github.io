          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              {categories.map((category) => (
                <button
                  key={category}
                  className="px-6 py-2 bg-slate-800/50 backdrop-blur-lg border border-cyan-500/20 rounded-lg text-white hover:bg-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300"
                >
                  {category}
                </button>
              ))}

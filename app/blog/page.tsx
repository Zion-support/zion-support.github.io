...
const BlogPage = () => {
  ...
  const categories = [
    ...
    { name: "AI & Machine Learning", value: "ai", count: 5 },
    { name: "Cybersecurity", value: "security", count: 3 },
    { name: "Cloud Computing", value: "cloud", count: 2 },
    { name: "Digital Transformation", value: "digital", count: 2 }
  ];
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: "Step-by-step approach to migrating your infrastructure to the cloud successfully.",
      author: "Cloud Team",
      date: "2024-01-05",
    ...
    },
    {
      ...
      excerpt: "How small, focused software solutions are revolutionizing business operations.",
      author: "Product Team",
      date: "2024-01-01",
      readTime: "7 min read",
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                />
              </div>

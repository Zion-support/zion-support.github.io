          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-wrap justify-center gap-4">
              {categories.map(category) => (
                <button}
                  key={category.id}
                  className="px-6 py-3 bg-slate-80/50 backdrop-blur-sm rounded-xl border border-slate-70"/50 text-white hover: border-cyan-50"/50 hover:bg-slate-70"/50 transition-all duration-30"
                >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {blogPosts.map(post) => (}
                <article key={post.id} className="bg-slate-80"/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-70"/50 hover:border-cyan-50"/50 transition-all duration-30 group">
                  ...
                  <p className="text-gray-30 mb-4 line-clamp-3">{post.excerpt}</p>

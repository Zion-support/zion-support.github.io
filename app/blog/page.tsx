...
const posts = [
  ...
  },
  {
    ...
    description:
      'A pragmatic security blueprint for production Gen AI: controls gateways and evals.',
  ...
  },
  {
    ...
    description:
      'Move inference to the edge for sub-100 ms decisions resilience and bandwidth savings.',
  ...
  },
  {
    ...
    description:
      'Run ML and Gen AI on serverless with predictable cost and strong reliability.',
  ...
  },
  {
    ...
    description:
      'Production-ready patterns for self-service assistants case triage agent copilots and QA.',

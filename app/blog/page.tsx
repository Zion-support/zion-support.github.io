...
const BlogPage: React.FC = () => {
  ...
  const blogPosts: BlogPost[] = [
    ...
    },
    {
      ...
      excerpt: 'Discover how micro SaaS applications are revolutionizing the way businesses operate.',
      author: 'David Kim',
      date: '2023-12-28',
      readTime: '6 min read',
      category: 'Micro SaaS',
      tags: ['Micro SaaS', 'Business Tools', 'Innovation'],
      featured: false
    },
    {
      id: '6',
      title: 'AI-Powered Customer Support: A Complete Guide',
      excerpt: 'Learn how to implement AI customer support solutions that improve efficiency and customer satisfaction.',
      author: 'Lisa Zhang',
      date: '2023-12-20',
      readTime: '7 min read',
      category: 'AI & Machine Learning',
  ...
  const categories = ['All', 'AI & Machine Learning', 'Cloud Computing', 'Cybersecurity', 'Development', 'Micro SaaS'];
                  ...
                  <div className="aspect-video bg-gradient-to-br from-cyan-500/20 to-purple-500/20 relative overflow-hidden">
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        <div className="text-4xl font-bold text-white mb-2">{post.category.charAt(0)}</div>

...
const BlogPage: React.FC = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: 'Learn how to successfully navigate digital transformation initiatives that drive real business value.',
  ...
  const categories = ['All', 'AI & Technology', 'Cloud Services', 'Cybersecurity', 'Micro SaaS', 'Emerging Tech', 'Digital Transformation'];

...
const BlogPage: React.FC = () => {
  ...
  const blogPosts: BlogPost[] = [
    ...
    },
    {
      ...
      excerpt: 'How blockchain is revolutionizing healthcare data management and patient privacy.',
      content: 'Full article content...',
      ...
      image: '/images/blog/blockchain-healthcare.jpg',
      featured: false
    },
    {
      id: '6',
      title: 'Microservices Architecture Patterns',
      excerpt: 'Best practices for designing and implementing microservices in modern applications.',
      content: 'Full article content...',
      author: 'Lisa Zhang',
      date: '2023-12-20',
      readTime: '9 min read',
  ...
  const categories = ['all', 'AI & Machine Learning', 'Cloud Computing', 'Cybersecurity', 'Development', 'Blockchain'];

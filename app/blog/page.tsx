...
const BlogPage: React.FC = () => {
  ...
  const categories = ['all', 'AI & Machine Learning', 'Cybersecurity', 'Cloud Computing', 'DevOps', 'Data Analytics', 'IoT'];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        <title>Blog - Zion Tech Group | Latest Tech Insights & News</title>
        ...
        <meta name="keywords" content="tech blog, AI insights, cybersecurity news, cloud computing, DevOps, data analytics" />
      </Helmet>

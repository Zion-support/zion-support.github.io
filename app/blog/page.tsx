  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Latest insights and articles on AI, technology, and business solutions from Zion Tech Group." />
        <meta name="keywords" content="blog, AI insights, technology articles, business solutions, Zion Tech Group" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredPosts.map((post) => (
                <article key={post.id} className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300">
                  <div className="mb-4">
                    <img 
                      src={post.image} 
                      alt={post.title}

      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        {posts.map((post) => (
          <a key={post.href} href={post.href} className='group'>
            <article className='bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 hover:border-purple-500/50 transition-all duration-300'>
              ...
              <h2 className='text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors duration-300'>
                {post.title}
              </h2>
              ...
              <div className='mt-4 text-purple-400 font-semibold group-hover:text-purple-300 transition-colors duration-300'>
                Read more →
              </div>
            </article>
          </a>

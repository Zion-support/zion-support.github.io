...
const BlogPage: React.FC = () => {
  ...
  const blogPosts: BlogPost[] = [
    ...
    },
    {
      ...
      excerpt: 'Leveraging big data to improve patient outcomes and operational efficiency.',
      content: 'Full article content...',
      author: 'Dr. Robert Kim',
      date: '2023-12-28',
      readTime: '9 min read',
      category: 'Data Analytics',
      tags: ['Healthcare', 'Data', 'Analytics'],
      image: '/images/blog/healthcare-analytics.jpg',
      featured: false
    },
    {
      id: '6',
      title: 'Mobile App Development Trends',
      excerpt: 'The latest trends and technologies shaping mobile application development.',
      content: 'Full article content...',
      author: 'Maria Garcia',
      date: '2023-12-25',
      readTime: '6 min read',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta name="keywords" content="technology blog, AI insights, cloud computing, cybersecurity, tech trends" />
      </Helmet>

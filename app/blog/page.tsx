...
const BlogPage: React.FC = () => {
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: 'A complete guide to successful cloud migration for businesses of all sizes.',
      author: 'Lisa Wang',
      date: '2023-12-28',
      readTime: '8 min read',
    ...
    {
      id: 6,
      title: 'AI Customer Support Solutions: Revolutionizing Service',
      excerpt: 'How AI is transforming customer service and support operations across industries.',

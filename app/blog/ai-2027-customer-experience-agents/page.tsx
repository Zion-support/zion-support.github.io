    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-6">
          <h1 className="text-4xl font-extrabold mb-4">AI 2027: Customer Experience Agents — 24/7 Autonomous CX</h1>
          <p className="text-slate-300 mb-6">Budgets, KPI‑linked scorecards, evals, and instant rollback to ship safe CX autonomy.</p>
          <div className="prose prose-invert">
            ...
            <ul>
              ...
              <li>Live scorecards tied to KPIs (CSAT, AHT, FCR) with rollback triggers</li>

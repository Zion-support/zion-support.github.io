    ...
    <div className='min-h-screen bg-gradient-to-br from-emerald-50 via-white to-lime-50'>
      <div className='max-w-4xl mx-auto px-6 py-16'>
        ...
        <article className='prose prose-emerald max-w-none'>
          <p>
            Building sustainable AI requires model-choice scorecards,
            datacenter-aware routing, and carbon-aware scheduling. This primer
            covers practical tooling and KPIs for greener AI.
          </p>
          <h2>Key Practices</h2>
          <ul>

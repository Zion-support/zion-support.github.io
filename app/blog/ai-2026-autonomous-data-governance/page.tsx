    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert prose-slate max-w-none">
          ...
          <p>
            Related reading: {' '}
            <Link to="/blog/agentic-workflow-orchestration-2026" className="text-teal-300 hover:text-teal-200">
        ...
        <div className="mt-12">
          <Link to="/blog" className="inline-block bg-white text-teal-700 px-6 py-3 rounded-lg font-bold hover:bg-teal-50">
            ← Back to Blog
          </Link>
        </div>
      </main>

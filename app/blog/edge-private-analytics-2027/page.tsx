  ...
  return (
    <div>
      <div>
        ...
        <section>
          ...
          <div>
            <Link href="/blog/genai-reliability-scorecards-2027" className="group">
              <div>
                <h4>GenAI Reliability Scorecards 2027</h4>
                <p>Budgets, canaries, and rollback wired to outcomes.</p>
              </div>
            </Link>
            <Link href="/blog/edge-private-experimentation-2026" className="group">
              <div>
                <h4>Edge Private Experimentation 2026</h4>
                <p>Compliant A/B with scoped IDs and DP noise.</p>
              </div>
            </Link>
          </div>
        </article>
        ...
        <div>
          <div>
            <h3>Build Private Analytics</h3>
            <p>Design zero‑PII analytics without hurting UX.</p>
            <div>

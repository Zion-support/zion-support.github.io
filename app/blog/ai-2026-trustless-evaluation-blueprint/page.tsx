			...
			<main className="max-w-3xl mx-auto px-6 py-16">
				...
				<div className="prose prose-invert prose-slate max-w-none">
					...
					<p>
						...
						<a href="/blog/agentic-workflow-orchestration-2026" className="text-purple-300 hover:text-purple-200">Agentic Workflow Orchestration 2026</a>.
					</p>
				</div>

				<div className="mt-12">
					<a href="/blog" className="inline-block bg-white text-purple-700 px-6 py-3 rounded-lg font-bold hover:bg-purple-50">
						← Back to Blog
					</a>
				</div>
			</main>

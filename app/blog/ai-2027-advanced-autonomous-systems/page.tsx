      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <ArrowRight href="/blog/ai-2027-autonomous-governance-blueprint" className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
            ...
            <ArrowRight href="/case-studies/ai-2027-mega-transformation-success" className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">

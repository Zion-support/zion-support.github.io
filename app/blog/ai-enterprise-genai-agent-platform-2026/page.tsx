        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-4 text-emerald-300">Platform Pillars</h2>
            ...
            <section className="mb-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                  ...
                  <p className="text-white/70">P95 latency ≤ 2.5s • Success ≥ 99.5% • Policy violations ≤ 0.01% • 30–70% cost down</p>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                  <h3 className="font-semibold mb-2">Security</h3>
                  <p className="text-white/70">Data residency, key isolation, per‑tool scopes, attestations, and privacy redaction.</p>
                </div>
              </div>
            </section>

            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-4 text-fuchsia-300">Rollout Plan</h2>
          ...
          <div className="mt-12 bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <a href="/contact" className="text-emerald-300 hover:text-emerald-200 font-semibold">Talk to experts →</a>
          </div>
        </article>
      </main>
    </div>

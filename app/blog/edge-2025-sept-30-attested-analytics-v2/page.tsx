      ...
      <article className="max-w-4xl mx-auto px-6 py-16">
        ...
        <aside className="bg-indigo-500/10 border border-indigo-400/20 rounded-xl p-6">
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-1">
            <li>
              <a href="/blog/edge-2026-zero-pii-analytics" className="text-indigo-300 hover:text-indigo-200">
                Edge 2026 Zero‑PII Analytics
              </a>
            </li>
            <li>
              <a href="/blog/edge-consentless-experiments-2026-q4" className="text-indigo-300 hover:text-indigo-200">

        ...
        <div className="space-y-8">
          ...
          <section className="bg-gradient-to-r from-blue-50 to-purple-50 p-8 rounded-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link 
                href="/services/ai-autonomous-<operations" className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-8 py-3 rounded-lg font-semibold hover:from-blue-600 hover:to-purple-600 transition-all duration-300 text-center"
              >

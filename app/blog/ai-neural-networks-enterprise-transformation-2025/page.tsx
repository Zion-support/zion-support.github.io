  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-fuchsia-900 text-white">
      <main className="container mx-auto px-6 py-12">
        <nav className="mb-8">
          <a href="/blog" className="text-purple-300 hover:text-purple-200 transition-colors">
            ← Back to Blog
          </a>
        </nav>
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-white/5 border border-white/10 rounded-xl p-6">
            ...
            <a href="/contact" className="text-purple-300 hover:text-purple-200 font-semibold">Talk to experts →</a>
          </div>
        </article>
      </main>
    </div>

      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-8 rounded-xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/services/ai-quantum-computing"
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a href="/blog/ai-2027-quantum-breakthrough" className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
            ...
            <a href="/case-studies/fortune-500-quantum-ai-transformation-2026" className="block p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">

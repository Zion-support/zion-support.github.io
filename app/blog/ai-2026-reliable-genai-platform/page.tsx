      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <footer className="mt-12 pt-6 border-t border-white/10 text-white/70">
          <p>
            Continue exploring:
            {' '}
            <a href="/blog/ai-2027-cost-optimization-playbook" className="text-emerald-400 hover:text-emerald-300">Cost Optimization Playbook</a>
            {' '}•{' '}
            <a href="/blog/agentic-workflow-orchestration-2026" className="text-fuchsia-300 hover:text-fuchsia-200">Agentic Workflow Orchestration</a>
          </p>
        </footer>
      </main>
    </div>

        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-4 text-indigo-300">Threat Model</h2>
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold mb-4 text-purple-300">Reference Controls</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                  <h3 className="font-semibold mb-2">Guardrails</h3>
                  <p className="text-white/75">Input/output filtering, jailbreak detection, secure tool scopes, and audits.</p>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                  <h3 className="font-semibold mb-2">Crypto</h3>
                  <p className="text-white/75">PQ‑safe KEMs, rotating keys, sealed storage, and mutual TLS with attestation.</p>
                </div>
              </div>
            </section>
          </div>
          ...
          <div className="mt-12 bg-white/5 border border-white/10 rounded-xl p-6">
            <h3 className="text-xl font-bold mb-2">Need a security blueprint?</h3>
            <p className="text-white/80 mb-4">We design zero‑trust AI platforms hardened against future quantum threats.</p>

...
export const metadata: Metadata = {
  title: 'Deep Learning vs Machine Learning: When to Use Each | Zion Tech Group Blog',
  description: 'Explore deep learning vs machine learning: when to use each and discover how AI automation is transforming businesses across industries.',
  openGraph: {
    title: 'Deep Learning vs Machine Learning: When to Use Each | Zion Tech Group Blog',
    description: 'Explore deep learning vs machine learning: when to use each and discover how AI automation is transforming businesses across industries.',
    type: 'article',
    url: 'https://ziontechgroup.com/blog/deep-learning-vs-machine-learning-when-to-use-each',
  },

...
export const metadata: Metadata = {
  ...
  description: 'Database Migration Service: practical frameworks, templates, and implementation guidance from Zion Tech Group.',
  alternates: { canonical: 'https://ziontechgroup.com/blog/database-migration-service-2026-8955/' },
};
    ...
    <main className="mx-auto max-w-4xl px-6 py-12">
      ...
      <article>
        <header className="mb-8">
          <h1 className="text-3xl font-bold tracking-tight text-white">Database Migration Service</h1>
          <p className="mt-2 text-gray-300">Database Migration Service: practical frameworks, templates, and implementation guidance from Zion Tech Group.</p>
        </header>

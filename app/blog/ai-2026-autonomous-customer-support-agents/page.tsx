...
export const metadata = {
  ...
  description: 'Blueprint to deploy autonomous customer support agents with routing, guardrails, evaluation gates, and observability to improve CSAT and reduce costs.',
  keywords: [
    'autonomous agents',
    'customer support',
    'AI support agents',

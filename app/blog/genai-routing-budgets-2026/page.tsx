...
export default function Page() {
  return (
    <main className="text-left">"
      <h1 className="text-left">GenAI Budget‑Aware Routing 2026</h1>"
      <p className="text-left">Deliver predictable cost and quality with tiered models, semantic caches, and evals.</p>"

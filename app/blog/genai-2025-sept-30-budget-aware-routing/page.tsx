      ...
      <article className="max-w-4xl mx-auto px-6 py-16">
        ...
        <aside className="bg-purple-500/10 border border-purple-400/20 rounded-xl p-6">
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-1">
            <li>
              <a href="/blog/genai-routing-blueprints-2026" className="text-purple-300 hover:text-purple-200">
                GenAI Routing Blueprints 2026
              </a>
            </li>
            <li>
              <a href="/blog/practical-rag-in-production" className="text-purple-300 hover:text-purple-200">

    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="text-center bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 rounded-2xl">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/case-studies/ai-2026-mega-transformation-<success" className="bg-white text-blue-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-colors"
          >

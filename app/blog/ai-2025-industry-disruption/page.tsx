    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          <h2>Healthcare</h2>
          <p>98% diagnostic accuracy, 60% faster diagnosis, and $15M annual savings across 25 hospitals.</p>
          <h2>Finance</h2>
          <p>Fraud reduction by 70%, 250% claim processing throughput, and $75M annual savings at Fortune 100.</p>
          <h2>Manufacturing</h2>
          <p>Defect reduction 60%, downtime reduction 35%, and supply chain forecast accuracy +22%.</p>
          <h2>Retail</h2>
          <p>Personalization driving 300% revenue LTV uplift and 40% customer satisfaction improvement.</p>
        </div>

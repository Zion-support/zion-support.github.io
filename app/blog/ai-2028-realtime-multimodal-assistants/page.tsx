  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-12 prose prose-invert">
      ...
      <p>
        ...
        low-latency routing, and KPI‑linked evaluation for production‑grade multimodal systems.
      </p>
      <ul>
        <li>Unified vision‑language‑audio embeddings with cross‑modal attention</li>
        <li>Latency budgets: perception ≤60ms, reasoning ≤70ms, actuation ≤20ms</li>

      ...
      <div className="prose prose-lg max-w-none">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Link to="/blog/ai-2028-autonomous-enterprise-revolution" className="block p-4 border border-gray-200 rounded-lg hover:border-purple-500 transition-colors">
            ...
            <Link to="/case-studies/quantum-ai-success-story-2028" className="block p-4 border border-gray-200 rounded-lg hover:border-purple-500 transition-colors">

          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 space-y-8">
              ...
              <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
                ...
                <Link 
                  href="/<services" className="block bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold text-center hover:bg-gray-100 transition-colors mb-4"
                >
                  Get Free Consultation
                </Link>
                <Link 
                  href="/case-<studies" className="block border-2 border-white/30 text-white px-6 py-3 rounded-lg font-semibold text-center hover:bg-white/10 transition-colors"
                >
                  View Case Studies
                </Link>
              </div>

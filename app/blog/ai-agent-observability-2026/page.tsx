  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-violet-900 to-slate-900 text-white">
      <main className="container mx-auto px-6 py-12">
        <nav className="mb-8">
          <Link to="/blog" className="text-violet-300 hover:text-violet-200 transition-colors">
            ← Back to Blog
          </Link>
        </nav>
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-lg max-w-none space-y-12">
            <section>
              <h2 className="text-3xl font-bold mb-6 text-violet-300">Signal Model</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-fuchsia-300">Architecture</h2>
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                  <h3 className="text-xl font-bold mb-3 text-violet-200">Evaluation</h3>
                  <ul className="space-y-2 text-white/80">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-cyan-300">Scorecards & SLOs</h2>
            ...
            <section className="bg-gradient-to-br from-violet-500/20 to-fuchsia-500/20 border border-violet-500/30 rounded-2xl p-8">
              <h2 className="text-3xl font-bold mb-4 text-center">Ship Reliable Autonomy</h2>
              ...
              <div className="flex justify-center gap-4">
                <Link to="/contact" className="bg-gradient-to-r from-violet-500 to-fuchsia-600 hover:from-violet-400 hover:to-fuchsia-500 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 shadow-lg">
                  Talk to an Expert
                </Link>
                <Link to="/case-studies" className="border-2 border-violet-500 text-violet-300 hover:bg-violet-500 hover:text-white font-bold py-4 px-8 rounded-xl transition-all duration-300">
                  View Case Studies
                </Link>
              </div>
            </section>
          ...
          <footer className="mt-16 pt-8 border-t border-white/20">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-4">
                <Link to="/blog" className="text-violet-300 hover:text-violet-200 transition-colors">← Back to Blog</Link>
                <Link to="/contact" className="text-fuchsia-300 hover:text-fuchsia-200 transition-colors">Get in Touch</Link>
              </div>
            </div>
          </footer>
        </article>

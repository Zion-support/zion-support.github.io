...
export const metadata = {
  ...
  title: "AI 2027: Operational Scorecards — SL Is, Budgets, Rollback",
  description:
    'Design operational scorecards that wire SL Is to KP Is with budgeted actions, approvals, and instant rollback for reliable autonomy.'};;

export default function Page() {return (<div className="min-h-screen bg-white text-gray-900">
      <article Name="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-lg text-gray-700 leading-relaxed mb-6">
          ...
          indicators (SL Is) to product KP    Is   , enabling budgeted

        ...
        <div className="relative mb-12 rounded-2xl overflow-hidden">
          <div className="aspect-video bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-600 flex items-center justify-center">
            <div className="text-center text-white">
              {/* @ts-ignore */}{/* @ts-ignore */}<Brain className="w-24 h-24 mx-auto mb-4 opacity-80" />
          ...
          <div className="prose prose-lg prose-invert max-w-none">
            ...
            <div className="bg-gradient-to-r from-blue-900/50 to-purple-900/50 border border-blue-500/30 rounded-xl p-8 mb-12">
              <h2 className="text-2xl font-bold text-white mb-4 flex items-center gap-3">
                {/* @ts-ignore */}{/* @ts-ignore */}<Target className="w-6 h-6 text-blue-400" />
                Executive Summary
              </h2>
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-6 flex items-center gap-3">
                {/* @ts-ignore */}{/* @ts-ignore */}<Brain className="w-8 h-8 text-purple-400" />
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-6 flex items-center gap-3">
                {/* @ts-ignore */}{/* @ts-ignore */}<Zap className="w-8 h-8 text-yellow-400" />
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-6 flex items-center gap-3">
                {/* @ts-ignore */}{/* @ts-ignore */}<Shield className="w-8 h-8 text-green-400" />
            ...
            <div className="mb-12">
              <h2 className="text-3xl font-bold text-white mb-6 flex items-center gap-3">
                {/* @ts-ignore */}{/* @ts-ignore */}<Globe className="w-8 h-8 text-cyan-400" />
            ...
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  Get Started Today
                  {/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}<ArrowRight className="w-4 h-4" />
                </Link>
                <Link 
                  href="/services"

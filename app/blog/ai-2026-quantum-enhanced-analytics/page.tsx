          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 rounded-3xl p-8 md:p-12">
            ...
            <div className="mt-12 p-8 bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/30 rounded-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  href="/<contact" className="px-8 py-3 bg-gradient-to-r from-cyan-600 to-purple-600 text-white font-semibold rounded-xl hover:from-cyan-700 hover:to-purple-700 transition-all duration-300 text-center"
                >
                  Get Quantum Analytics
                </Link>
                <Link 
                  href="/services/quantum-<computing" className="px-8 py-3 border border-purple-500 text-purple-400 font-semibold rounded-xl hover:bg-purple-500/10 transition-all duration-300 text-center"
                >
                  Learn More
                </Link>
              </div>

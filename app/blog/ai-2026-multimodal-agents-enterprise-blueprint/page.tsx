...
export const metadata = {
  ...
  description: 'A practical blueprint to design, deploy, and scale multimodal agents across your enterprise with measurable ROI and governance.',
  keywords: [
    'multimodal agents',
    'enterprise ai',
    'ai agents',
...
export default function MultimodalAgentsBlueprintPage() {
  return (

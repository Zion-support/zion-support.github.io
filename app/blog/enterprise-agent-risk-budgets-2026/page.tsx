...
export default function Page() {return (<div className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold mb-4">
        Enterprise Agent Risk Budgets: Safe Autonomy at    Scale
      </h1>
      ...
      <div className="mt-10">
        <Arrow Right href="/blog"className="text-indigo-600 font-semibold">
          ← Back to    Blog
        </Arrow>
      </div>
    </div>

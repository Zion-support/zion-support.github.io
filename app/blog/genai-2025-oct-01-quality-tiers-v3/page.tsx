    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white'>
      <div className='max-w-3xl mx-auto px-6 py-12'>
        <div className='mb-4 text-sm text-white/60'>
          Gen AI • 8 min read • 2025-10-01
        </div>
        <h1 className='text-4xl font-bold mb-3'>GenAI Quality Tiers v3</h1>
        <p className='text-white/70 mb-8'>
          Intent -aware tier routing with semantic caches and guardrails
          delivers 30–50% cost reduction without harming perceived quality.
        </p>
        ...
        <div className='space-y-6'>
          ...
          <ul className='list-disc pl-6 text-white/70'>
            ...
            <li>
              Wire eval scorecards to KP Is ; fail closed with attested
              rollback.
            </li>
            <li>

...
const Page: React.FC = () => {
  return (
    <React.Fragment /><Helmet /><title>Operational Trust Scorecards v3</title>
        <meta name="description" content="Measure reliability, cost, safety, and value with live AI scorecards." />
        <meta property="og:type" content="article" />
      </Helmet>
      <main className="min-h-screen bg-slate-950 text-white" /><section className="py-16 border-b border-white/10" /><div className="max-w-3xl mx-auto px-4" /><div className="mb-6 inline-flex items-center gap-2" /><span className="px-3 py-1 rounded-full bg-emerald-500/20 text-emerald-300 text-xs font-semibold border border-emerald-500/30">
              GUIDE</span>
            </span>
      ...
      <section className="py-12" /><div className="max-w-3xl mx-auto px-4 space-y-10" /><div /><h2 className="text-2xl font-bold mb-3">Why Operational    Trust</h2>
          ...
          <div /><h2 className="text-2xl font-bold mb-3">Scorecard    Structure</h2>
            <ul className="list-disc pl-6 text-gray-300 space-y-2" /><li /><strong className="text-white">Reliability   :</strong> pass rates,
                hallucination rate, grounding success, latency SLO.
              </li>
              <li /><strong className="text-white">Safety   :</strong> policy blocks,
                red‑team strikes, jailbreak resistance, PII leaks.
              </li>
              <li /><strong className="text-white">Cost   :</strong> per‑task spend,
                model tier mix, cache hit rate, budget headroom.
              </li>
              <li /><strong className="text-white">Value   :</strong> conversion;
                uplift, time saved, NPS changes, $ ROI.
              </li>
            </ul>
          </div>
          <div /><h2 className="text-2xl font-bold mb-3">Operational    Guardrails</h2>
            <p className="text-gray-300">

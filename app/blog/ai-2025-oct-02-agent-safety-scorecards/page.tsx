  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark text-white">
      <div className="container mx-auto px-6 py-16">
        ...
        <p className="text-zion-slate-light mb-6">KPIs, budgets, and rollback triggers that keep autonomous agents safe at speed.</p>
        <article className="prose prose-invert max-w-3xl">
          <p>
            Design scorecards for autonomous agents that connect service‑level indicators to business KPIs.
            Use budgeted actions, live canaries, and deterministic rollback to ship faster without
            regressions. This guide covers practical metrics, CI policy tests, and runtime guardrails

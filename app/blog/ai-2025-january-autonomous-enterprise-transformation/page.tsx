            ...
            <div className='space-y-6 mb-8'>
              <div className='bg-gradient-to-r from-blue-900/20 to-cyan-900/20 backdrop-blur-sm rounded-xl p-6 border border-blue-500/20'>
                <div className='flex items-center gap-4 mb-4'>
                  <div className='bg-gradient-to-r from-blue-500 to-cyan-600 text-white font-bold py-2 px-4 rounded-lg text-sm'>
                    Phase 1
                  </div>
              ...
              <div className='bg-gradient-to-r from-green-900/20 to-purple-900/20 backdrop-blur-sm rounded-xl p-6 border border-green-500/20'>
                <div className='flex items-center gap-4 mb-4'>
                  <div className='bg-gradient-to-r from-green-500 to-purple-600 text-white font-bold py-2 px-4 rounded-lg text-sm'>
                    Phase 3
                  </div>
                  <h3 className='text-xl font-bold text-white'>
                    Process Integration
              ...
              <div className='bg-gradient-to-r from-purple-900/20 to-pink-900/20 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20'>
                <div className='flex items-center gap-4 mb-4'>
                  <div className='bg-gradient-to-r from-purple-500 to-pink-600 text-white font-bold py-2 px-4 rounded-lg text-sm'>
                    Phase 4
                  </div>
                  <h3 className='text-xl font-bold text-white'>

      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-cyan-600 rounded-2xl p-8 text-white text-center mt-12">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a to="/services" className="bg-white text-indigo-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">Explore Services</a>
            <a to="/contact" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-indigo-600 transition-colors">Talk to Experts</a>
          </div>
        </div>
      </article>

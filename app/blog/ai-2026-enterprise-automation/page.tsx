  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 text-white">
      <main className="container mx-auto px-6 py-12">
        <nav className="mb-8">
          <Link to="/blog" className="text-blue-300 hover:text-blue-200 transition-colors">
            ← Back to Blog
          </Link>
        </nav>
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-lg max-w-none space-y-12">
            <section>
              <h2 className="text-3xl font-bold mb-6 text-blue-300">Reference Architecture</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-cyan-300">Outcomes & Benchmarks</h2>
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="bg-white/5 rounded-lg p-4">
                  <div className="text-2xl font-bold text-purple-300">P95 ↓ 33%</div>
            ...
            <section className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-500/30 rounded-2xl p-8">
              <h2 className="text-3xl font-bold mb-4 text-center">Need Enterprise‑Grade Autonomy?</h2>

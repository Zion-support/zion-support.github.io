      ...
      <div className="bg-gradient-to-r from-purple-900 via-blue-900 to-indigo-900 rounded-2xl p-8 mb-8 text-white">
        ...
        <div className="flex flex-wrap gap-4">
          <div className="flex items-center gap-2 bg-white/10 rounded-lg px-4 py-2">
            {/* @ts-ignore */}{/* @ts-ignore */}<TrendingUp className="w-5 h-5 text-green-400" />
          ...
          <div className="flex items-center gap-2 bg-white/10 rounded-lg px-4 py-2">
            {/* @ts-ignore */}{/* @ts-ignore */}<Brain className="w-5 h-5 text-purple-400" />
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-6 border border-purple-200">
            ...
            <div className="flex items-center gap-2 text-sm text-purple-600 font-semibold">
              {/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}<Zap className="w-4 h-4" />

...
export const metadata = {
  ...
  title: "Enterprise AI Safety Highlights (Sep 30, 2025)",
    description: "Live guardrails, runtime scorecards, and verified data flows. Actionable and audited.",
    type: "article",
...
export default function EnterpriseAI Safety Highlights2025() {
  return (

...
export const metadata: Metadata = {
  ...
  description: 'Event Driven Architecture: practical frameworks, templates, and implementation guidance from Zion Tech Group.',
  alternates: { canonical: 'https://ziontechgroup.com/blog/event-driven-architecture-2026-8893/' },
};
    ...
    <main className="mx-auto max-w-4xl px-6 py-12">
      ...
      <article>
        <header className="mb-8">
          <h1 className="text-3xl font-bold tracking-tight text-white">Event Driven Architecture</h1>
          <p className="mt-2 text-gray-300">Event Driven Architecture: practical frameworks, templates, and implementation guidance from Zion Tech Group.</p>
        </header>

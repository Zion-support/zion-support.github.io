  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <main className="max-w-3xl mx-auto px-6 py-16">
        <div className="mb-8">
          <a href="/blog" className="text-emerald-400 hover:text-emerald-300">← Back to Blog</a>
        </div>
        ...
        <footer className="mt-12 pt-6 border-t border-white/10 text-white/70">
          <p>
            ...
            {' '}•{' '}
            <a href="/blog/genai-routing-quality-tiers-q4-2025" className="text-fuchsia-300 hover:text-fuchsia-200">GenAI Quality Tiers</a>
          </p>
        </footer>
      </main>
    </div>

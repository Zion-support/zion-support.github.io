      ...
      <main className='max-w-3xl mx-auto px-6 py-16'>
        ...
        <header className='mb-6'>
          ...
          <p className='text-white/70 mt-3'>
            Wire KPI‑linked guardrails into delivery with PR checks, budgeted
            actions, and instant rollback. Ship faster without surprises.
          </p>
        </header>
        <article className='prose prose-invert prose-slate max-w-none'>
          ...
          <p>
            ...
            constraints. It comes from live scorecards tied to product KPIs,
            policy tests in CI, and runtime canaries.
          </p>

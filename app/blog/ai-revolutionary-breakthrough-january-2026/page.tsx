        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 mb-8">
              {/* @ts-ignore */}{/* @ts-ignore */}<TrendingUp className="w-5 h-5 text-blue-400" />
            ...
            <section className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-center gap-2">
                      {/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}<Zap className="w-5 h-5 text-green-500" />
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-center gap-2">
                      {/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}<Zap className="w-5 h-5 text-blue-500" />
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-center gap-2">
                      {/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}<Zap className="w-5 h-5 text-purple-500" />
                ...
                <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-center gap-2">
                      {/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}{/* @ts-ignore */}<Zap className="w-5 h-5 text-orange-500" />

        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <a href="/blog/ai-quantum-computing-breakthrough-2026" className="group">
              ...
              <a href="/blog/ai-autonomous-enterprise-2026" className="group">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all hover:scale-105">
                  <div className="p-8">
              ...
              <a href="/case-studies/ai-mega-transformation-success-2026" className="group">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all hover:scale-105">
                  <div className="p-8">
                    <div className="text-4xl mb-4">🏆</div>

      ...
      <article className="max-w-4xl mx-auto px-6 py-16">
        ...
        <aside className="bg-emerald-500/10 border border-emerald-400/20 rounded-xl p-6">
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-1">
            <li>
              <a href="/blog/ai-2026-safe-autonomy-scorecards" className="text-emerald-300 hover:text-emerald-200">
                AI 2026 Safe Autonomy Scorecards
              </a>
            </li>
            <li>
              <a href="/blog/ai-governance-real-time-2026" className="text-emerald-300 hover:text-emerald-200">

    ...
    <main className='min-h-screen bg-gradient-to-b from-gray-50 to-white'>
      <div className='max-w-3xl mx-auto px-6 py-16'>
        ...
        <p className='text-lg text-gray-700 leading-relaxed mb-6'>
          Deliver private, sub‑100ms personalization using scoped identifiers,
          on‑device models, and differential privacy. This field guide shows how
        ...
        <div className='rounded-xl border border-emerald-200 bg-emerald-50 p-5 mb-10'>
          ...
          <p className='text-emerald-800 text-sm'>
            ...
            metrics collection to the edge, add DP noise at source, and enforce

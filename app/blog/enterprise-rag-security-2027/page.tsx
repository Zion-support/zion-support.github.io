...
export default function Page() {return (<mainclassName='min-h-screen bg-gradient-to-b from-gray-50 to-white'>
      <divclassName='max-w-3xl mx-auto px-6 py-16'>
        ...
        <divclassName='rounded-xl border border-indigo-200 bg-indigo-50 p-5 mb-10'>
          <divclassName='text-indigo-700 font-semibold mb-2'>Quickstart</div>
          <pclassName='text-indigo-800 text-sm'>

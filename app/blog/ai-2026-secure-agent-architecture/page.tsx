...
export const metadata = {
  ...
  description: 'Blueprint for zero-trust agents with isolation domains, policy-as-code, runtime guards, and continuous verification.',
  keywords: [
    'secure agents',
    'zero trust',
    'policy as code',
...
export default function SecureAgentArchitecturePage() {
  return (

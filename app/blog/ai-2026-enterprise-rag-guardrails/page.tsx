      ...
      <main className="container mx-auto px-6 py-12">
        ...
        <article className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-invert prose-lg max-w-none space-y-12">
            <section>
              <h2 className="text-3xl font-bold mb-6 text-indigo-300">Guardrail Architecture Overview</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-blue-300">Policy Enforcement Playbook</h2>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                  <h3 className="text-xl font-bold mb-3 text-indigo-200">Input & Retrieval Policies</h3>
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                  <h3 className="text-xl font-bold mb-3 text-indigo-200">Generation Policies</h3>
                  <ul className="space-y-2 text-white/80">
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-cyan-300">Routing & Cost Controls</h2>
              ...
              <div className="grid md:grid-cols-3 gap-4 mt-4">
                ...
                <div className="bg-white/5 rounded-lg p-4">
                  <div className="text-2xl font-bold text-purple-300">99.95%</div>
            ...
            <section>
              <h2 className="text-3xl font-bold mb-6 text-fuchsia-300">Observability & Feedback</h2>
              <ul className="space-y-2 text-white/80">
            ...
            <section className="bg-gradient-to-br from-indigo-500/20 to-blue-500/20 border border-indigo-500/30 rounded-2xl p-8">
              <h2 className="text-3xl font-bold mb-4 text-center">Deploy Guardrails with Confidence</h2>

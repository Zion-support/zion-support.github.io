      ...
      <div className="text-left""></div>"
        <section className="text-left"">"</section>
          ...
          <p className="text-left"">"
            ...
            clear policies, observability, and rollback paths to ensure actions stay within budget and business intent."</p>
          </p>
        </section>
        ...
        <section className="text-left"">"</section>
          ...
          <p className="text-left"">"
            ...
            outcomes. Promote only when guardrail SLOs are consistently met."</p>
          </p>
        </section>

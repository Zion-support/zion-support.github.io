      ...
      <header className="bg-gradient-to-br from-fuchsia-900 via-purple-900 to-slate-900 text-white py-20">
        <div className="max-w-5xl mx-auto px-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 mb-6">
            {/* @ts-ignore */}{/* @ts-ignore */}<ListChecks className="w-4 h-4 text-fuchsia-300" />
          ...
          <div className="flex items-center gap-6 text-white/70 mt-8">
            ...
            <div className="flex items-center gap-2">{/* @ts-ignore */}{/* @ts-ignore */}<Clock className="w-4 h-4" /><span>18 min read</span></div>
          </div>
        </div>
      </header>
          ...
          <div className="bg-gradient-to-r from-fuchsia-600 to-indigo-600 text-white rounded-2xl p-8 flex items-center justify-between gap-4">
            <div>
              <h3 className="text-2xl font-bold flex items-center gap-2">
                {/* @ts-ignore */}
                <FileWarning className="w-5 h-5" /> Prevent Regressions
              </h3>
              <p className="text-white/90">We implement v2 runbooks in 4–6 weeks with audits and training.</p>
            </div>
            <Link href="/contact" className="bg-white text-fuchsia-700 px-6 py-3 rounded-lg font-semibold inline-flex items-center gap-2">Engage 
              {/* @ts-ignore */}

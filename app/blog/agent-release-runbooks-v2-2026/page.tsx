    ...
    <main className="min-h-screen bg-gradient-to-br from-fuchsia-50 via-white to-purple-50">
      <header className="bg-gradient-to-br from-fuchsia-900 via-purple-900 to-slate-900 text-white py-20">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-3xl">
            Ship autonomous agents with budgeted actions, KPI canaries, approvals and one‑click
            rollback.
          </p>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-6 prose prose-lg">
          ...
          <p>
            Operational safety hinges on three primitives: hard budgets, lightweight approvals and
            KPI-linked canaries that trigger automatic rollback when thresholds are breached.
          </p>

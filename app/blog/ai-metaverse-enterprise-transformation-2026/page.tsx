    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-6 text-gray-600 mb-8">
          ...
          <div className="flex items-center gap-2">
            {/* @ts-ignore */}{/* @ts-ignore */}<Globe className="w-5 h-5" />
            <span>Metaverse</span>
          </div>
          <div className="flex items-center gap-2">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-white">
              <div className="w-24 h-24 mx-auto mb-6 bg-white bg-opacity-20 rounded-full flex items-center justify-center">
                {/* @ts-ignore */}{/* @ts-ignore */}<Globe className="w-12 h-12" />
              </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                {/* @ts-ignore */}{/* @ts-ignore */}<Users className="w-6 h-6 text-blue-600" />
              </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center">
                {/* @ts-ignore */}{/* @ts-ignore */}<Zap className="w-6 h-6 text-purple-600" />
              </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center">
                {/* @ts-ignore */}{/* @ts-ignore */}<Target className="w-6 h-6 text-green-600" />
              </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-orange-100 rounded-lg flex items-center justify-center">
                {/* @ts-ignore */}{/* @ts-ignore */}<Globe className="w-6 h-6 text-orange-600" />
              </div>

    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="mt-10 flex gap-3">
          <a href="/blog" className="bg-white text-blue-700 px-5 py-3 rounded-lg font-semibold hover:bg-slate-100">Back to Blog</a>
          <a href="/content-hub" className="border border-white/30 text-white px-5 py-3 rounded-lg font-semibold hover:bg-white/10">Explore Content Hub</a>
        </div>
      </div>
    </div>
  );

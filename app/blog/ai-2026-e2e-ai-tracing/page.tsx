...
export default function Page() {return (<divclassName='min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 text-white'>
      <divclassName='max-w-4xl mx-auto px-6 py-16'>
        <divclassName='mb-8 text-sm text-blue-300'>
          AI Operations • 12 min read • Jan 30, 2026
        </div>
        <h1className='text-4xl md:text-5xl font-extrabold mb-4'>
          E2E AI Tracing 2026: From Prompts to Outcomes
        </h1>
        <pclassName='text-lg text-slate-300 mb-8'>
        ...
        <divclassName='prose prose-invert prose-indigo max-w-none'>

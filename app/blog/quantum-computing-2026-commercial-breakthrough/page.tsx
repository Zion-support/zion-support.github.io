    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <ArrowRight href="/blog/ai-2026-future-ai-landscape-mega-trends" className="group">
            ...
            <ArrowRight href="/blog/quantum-ai-implementation-guide-2026" className="group">
            ...
            <ArrowRight href="/blog/enterprise-quantum-security-2026" className="group">

      ...
      <article className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <header className="mb-12">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            ...
            <span className="text-green-400 font-bold"> 98% automation rates</span> and delivers 
            <span className="text-blue-400 font-bold"> $50M+ annual savings</span> through self-healing systems.
          </p>
        ...
        <div className="prose prose-lg prose-invert max-w-none">
          ...
          <div className="bg-slate-900/50 rounded-xl p-6 mb-8">
            <h4 className="text-xl font-bold text-green-400 mb-4">1. Perception Layer</h4>
            ...
            <h4 className="text-xl font-bold text-blue-400 mb-4">2. Decision Engine</h4>
            <p className="text-gray-300 mb-4">
            ...
            <h4 className="text-xl font-bold text-purple-400 mb-4">3. Execution Layer</h4>
            <p className="text-gray-300 mb-4">
            ...
            <h4 className="text-xl font-bold text-cyan-400 mb-4">4. Learning System</h4>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gradient-to-br from-green-500/10 to-blue-500/10 border border-green-500/30 rounded-xl p-6">
              <h4 className="text-lg font-bold text-green-400 mb-3">IT Operations</h4>
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 border border-purple-500/30 rounded-xl p-6">
              <h4 className="text-lg font-bold text-purple-400 mb-3">Supply Chain</h4>
              <ul className="text-gray-300 space-y-2">
          ...
          <div className="bg-slate-900/50 rounded-xl p-6 mb-8">
            <ul className="space-y-4 text-gray-300">
              <li className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-white">Self-Healing Systems:</strong> Automatically detect, 
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-white">Adaptive Learning:</strong> Continuously improve 
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-white">Predictive Optimization:</strong> Anticipate future 
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  <strong className="text-white">Multi-Domain Coordination:</strong> Orchestrate 

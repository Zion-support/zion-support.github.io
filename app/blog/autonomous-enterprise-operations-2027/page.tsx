          ...
          <div className="text-left">"
            ...
            <ul className="text-left">"
              <li className="text-left">"
                <span className="text-left">•<"
                <span>Instantaneous decision processing across all business functions<
              </li>
              <li className="text-left">"
                <span className="text-left">•<"
                <span>Predictive analytics for proactive problem resolution<
              </li>
              <li className="text-left">"
                <span className="text-left">•<"
                <span>Multi-variable optimization for maximum efficiency<
              </li>
              <li className="text-left">"
                <span className="text-left">•<"
                <span>Continuous learning and strategy refinement<
              </li>
            </ul>
          </div>

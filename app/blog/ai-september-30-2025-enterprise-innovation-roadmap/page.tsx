        ...
        <article className="prose prose-lg prose-invert max-w-none">
          ...
          <div className="bg-gradient-to-r from-emerald-600 to-cyan-600 rounded-xl p-6 text-center">
            ...
            <div className="flex gap-3 justify-center">
              <a href="/contact" className="bg-white text-emerald-700 px-6 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors">Start a pilot</a>
              <a href="/blog" className="border border-white/70 text-white px-6 py-2 rounded-lg font-semibold hover:bg-white hover:text-emerald-700 transition-colors">Learn more</a>
            </div>
          </div>
        </article>
      </div>

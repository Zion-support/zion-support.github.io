...
export default function EnterpriseInnovationRoadmapSept302025() {return (<divclassName='min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900'>
      <divclassName='max-w-4xl mx-auto px-4 py-12'>
        <headerclassName='mb-10 text-center'>
          <divclassName='inline-flex items-center gap-2 bg-emerald-600 text-white px-4 py-1.5 rounded-full text-xs font-semibold mb-4'>
            <span>NEW</span>
        ...
        <articleclassName='prose prose-lg prose-invert max-w-none'>
          <h2className='text-2xl font-bold text-white mb-3'>Roadmap Stages</h2>
          <divclassName='space-y-6 mb-8'>
            <divclassName='bg-white/5 border border-white/10 rounded-xl p-5'>
              <h3className='text-white font-semibold mb-1'>1) Pilot</h3>
            ...
            <divclassName='bg-white/5 border border-white/10 rounded-xl p-5'>
              <h3className='text-white font-semibold mb-1'>2) Productize</h3>
              <pclassName='text-gray-300'>
            ...
            <divclassName='bg-white/5 border border-white/10 rounded-xl p-5'>
              <h3className='text-white font-semibold mb-1'>3) Platform</h3>
              <pclassName='text-gray-300'>
            ...
            <divclassName='bg-white/5 border border-white/10 rounded-xl p-5'>
              <h3className='text-white font-semibold mb-1'>4) Outcomes</h3>
              <pclassName='text-gray-300'>
          ...
          <divclassName='grid md:grid-cols-3 gap-6 mb-10'>
            <divclassName='bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-5'>
              ...
              <divclassName='text-white font-semibold'>ROI visibility</div>
            </div>
            <divclassName='bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-5'>
              <divclassName='text-3xl mb-2'>🛡️</div>
              <divclassName='text-white font-semibold'>Governed scale</div>
            </div>
            <divclassName='bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-5'>
              <divclassName='text-3xl mb-2'>🚀</div>
              <divclassName='text-white font-semibold'>Faster launches</div>
            </div>
          </div>

          <divclassName='bg-gradient-to-r from-emerald-600 to-cyan-600 rounded-xl p-6 text-center'>
            <h3className='text-2xl font-bold text-white mb-2'>
              Accelerate your AI roadmap
            </h3>
            <pclassName='text-emerald-100 mb-4'>

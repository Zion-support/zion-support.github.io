	...
	return (
		<main className="max-w-3xl mx-auto px-4 py-12">
			<header className="mb-8">
				<div className="inline-block bg-emerald-100 text-emerald-800 px-3 py-1 rounded-full text-xs font-semibold">NEW — Oct 1, 2025</div>
				<h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 mt-4">Trustworthy AI Governance Updates</h1>
				<p className="text-gray-600 mt-3">Operational guardrails for autonomous systems with measurable risk and continuous verification.</p>
			</header>
			...
			<div className="mt-10">
				<ArrowRight href="/blog" className="text-emerald-600 font-semibold hover:text-emerald-700">← Back to Blog</ArrowRight>
			</div>
		</main>
	);
}

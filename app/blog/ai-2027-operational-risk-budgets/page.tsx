...
export default function AI2027OperationalRisk Budgets Page() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <article className="prose prose-lg max-w-none">
        ...
        <ul>
          <li>SL Is and SL Os mapped to product KP    Is</li>
        ...
        <ul>
          <li>Define business-aligned KP Is and guardrail SL    Is</li>

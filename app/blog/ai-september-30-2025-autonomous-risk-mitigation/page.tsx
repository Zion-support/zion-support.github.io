        ...
        <article className="prose prose-lg prose-invert max-w-none">
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-fuchsia-600 rounded-xl p-6 text-center">
            ...
            <div className="flex gap-3 justify-center">
              <a href="/contact" className="bg-white text-indigo-700 px-6 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors">Talk to experts</a>
              <a href="/blog" className="border border-white/70 text-white px-6 py-2 rounded-lg font-semibold hover:bg-white hover:text-indigo-700 transition-colors">Explore more</a>
            </div>
          </div>
        </article>
      </div>

...
export default function NewInOctober2025() {return (<mainclassName='min-h-screen bg-white'>
      ...
      <section className='py-14'>
        <divclassName='max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-8'>
          <a
          ...
          >
            <divclassName='text-sm font-semibold text-emerald-600 mb-2'>
              New
            </div>
            <h2className='text-2xl font-bold mb-2 group-hover:text-emerald-700'>
            ...
            <divclassName='mt-4 text-emerald-700 font-semibold'>
              Read the playbook →
            </div>
          </a>
          ...
          <a
           ...
           className='group block rounded-xl border border-gray-200 p-6 hover:shadow-xl transition-shadow'
          >
            <divclassName='text-sm font-semibold text-fuchsia-600 mb-2'>
              Featured
            </div>
            <h2className='text-2xl font-bold mb-2 group-hover:text-fuchsia-700'>
            ...
            <divclassName='mt-4 text-fuchsia-700 font-semibold'>
              Read the article →
            </div>
          </a>
        </div>

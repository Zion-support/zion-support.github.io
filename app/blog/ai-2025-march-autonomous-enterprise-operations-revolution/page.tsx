        ...
        <div className="text-left""></div>"
          <div className="text-left""></div>"
            ...
            <h1 className="text-left"">"
              The Future of Business Automation"</h1>
            </h1>
            ...
            <div className="text-left""></div>"
              <a 
                ...
                className="text-left"">"
                Get Autonomous Operations Consultation →"</a>
              </a>
              <a 
                href="/case-studies""
                className="text-left"">"
        ...
        <div className="text-left""></div>"
          <div className="text-left""></div>"
            ...
            <div className="text-left""></div>"
              ...
              <p className="text-left"">"
                Ready to transform your enterprise with autonomous operations? Our expert team provides comprehensive assessments, strategic roadmaps, seamless technology integration, and ongoing optimization support."</p>
              </p>

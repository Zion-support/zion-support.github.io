              ...
              <section className="mb-12">
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                  ...
                  <div className="flex gap-4">
                    <a href="/contact" className="px-6 py-3 rounded-lg bg-cyan-500 text-white font-semibold hover:bg-cyan-400">
                      Talk to an Expert
                    </a>
                    <a href="/blog" className="px-6 py-3 rounded-lg bg-white/10 border border-white/20 hover:bg-white/20">
                      More Articles
                    </a>
                  </div>
                </div>

  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <ul>
          <li>Policy gateway with allow/deny lists, purpose binding, and PI boundaries</li>
          <li>Budget‑aware router with quality tiers, canaries, and fallback paths</li>
          <li>Verifier services for tool use, retrieval citations, and output contracts</li>
          <li>Observability: traces spanning prompts → tools → outcomes with KPIs</li>
        </ul>

        <h2>Safety Controls</h2>
        <ul>
          <li>Pre‑execution approvals for high‑impact actions (funds transfer, config change)</li>
          <li>Runtime anomaly detection on tokens, tools, latency, and drift</li>

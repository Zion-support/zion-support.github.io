...
export const metadata: Metadata = {
  ...
  description:
    'IT Infrastructure Solutions delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to produc',
  alternates: { canonical: '/it-infrastructure-solutions' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'IT Infrastructure Solutions delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with IT Infrastructure Solutions',
      }}
    />
  );
}

...
import { Eye, Camera, Search, Shield, CheckCircle, ArrowRight } from 'lucide-react';
  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Advanced computer vision solutions for object detection, image analysis, facial recognition, and video processing. Transform visual data into actionable insights."
        keywords={['computer vision', 'image analysis', 'object detection', 'facial recognition', 'video processing', 'OCR', 'visual AI']}
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900">
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center neon-text">
              Why Choose Our Vision Solutions?
            </h2>
          ...
          <section className="text-center">
            <div className="cyber-card p-8 max-w-4xl mx-auto">
              ...
              <p className="text-gray-300 mb-6 text-lg">
                Contact our computer vision experts today to discuss how visual AI can transform 
                your business and unlock insights from your image and video data.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="/contact"

...
import { Eye, Camera, CheckCircle, Phone, Mail, MapPin, ArrowRight, Star, Users, Clock, Award } from 'lucide-react';
...
const AIVisionPage: React.FC = () => {
  ...
  const benefits = [
    ...
    'Reduced manual inspection by 90%',
  ...
  const useCases = [
    {
      ...
      description: 'Automatically detect defects in manufacturing with 99.9% accuracy',
      icon: '🔍'
    },
    {
      title: 'Security & Surveillance',
      description: 'Facial recognition and object detection for enhanced security systems',
      icon: '🛡️'
    },
    {
      title: 'Medical Imaging',
      description: 'Analyze X-rays, MRIs, and CT scans to assist medical professionals',
      icon: '🏥'
    },
    {
      title: 'Retail Analytics',
      description: 'Track customer behavior and inventory levels using computer vision',
      icon: '🛒'
    }
  ];
  ...
  return (
    <>
      <SEOOptimizer
        ...
        keywords={['computer vision', 'object detection', 'image classification', 'facial recognition', 'video analysis', 'OCR']}
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-xl text-green-400 mb-8 font-medium">
              Advanced Image & Video Analysis Solutions
            </p>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="cyber-card p-8 text-center">
                ...
                <div className="text-4xl font-bold text-green-400 mb-6">$1,800<span className="text-lg text-gray-400">/month</span></div>
              ...
              <div className="cyber-card p-8 text-center ring-2 ring-green-400">
                ...
                <div className="text-4xl font-bold text-green-400 mb-6">$2,800<span className="text-lg text-gray-400">/month</span></div>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
              ...
              <div className="cyber-card p-8 text-center">
                ...
                <div className="text-4xl font-bold text-green-400 mb-6">$4,500<span className="text-lg text-gray-400">/month</span></div>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />

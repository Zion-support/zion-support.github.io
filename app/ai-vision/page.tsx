  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        ...
        <meta name="description" content="Advanced ai vision solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
...
const AiVisionPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Ai Vision - Zion Tech Group</title>
        <meta name="description" content="Ai Vision services by Zion Tech Group. Professional AI and IT solutions." />
        <meta name="keywords" content="ai-vision, AI solutions, IT services" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="bg-slate-800 p-8 rounded-lg">
            ...
            <p className="text-gray-300">
              We are working on bringing you the most advanced ai vision solutions. 

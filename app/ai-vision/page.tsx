...
export default function AivisionPage() {
  return (
    <div className ="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900to-slate-900pt-20">
      <Helmet>
        <title>AiVision - ZionTech Group</title>
        <meta name ="description" content="Professionalai visionservices by Zion Tech Group. Transformyour businesswith ourexpert solutions." / / />
      </Helmet>
      <div className ="max-w-7 xlmx-autopx-4 sm:px-6 lg:px-8py-16text-center" />
        <h1className ="text-4 xlfont-boldtext-whitemb-6"  >AiVision</h1>
        <pclassName ="text-lg text-gray-300 mb-8">Professionalai visionservices comingsoon.</p>

...
const AiInventoryManagementPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai inventory management services and solutions by Zion Tech Group."
      keywords="ai inventory management, services, solutions, technology, Zion Tech Group"
    >

...
export const metadata: Metadata = {
  ...
  description:
    'AI Inventory Management streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team',
  alternates: { canonical: '/ai-inventory-management' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Inventory Management streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Inventory Management',
      }}
    />
  );
}

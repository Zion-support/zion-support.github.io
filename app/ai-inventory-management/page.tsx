      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <div className="inline-flex items-center space-x-2 bg-orange-500/10 border border-orange-500/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-orange-400 text-sm font-medium">AI Inventory Management</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-orange-400 mb-8 font-medium">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (
              <div key={index} className="hologram-card-enhanced p-6 hover:scale-105 transition-all duration-300">
                <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">

        ...
        <main className="container mx-auto px-4 py-16 pt-24">{/* Hero Section */}</main>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="cyber-card p-6 text-center">
                <div className="text-4xl font-bold text-green-400 mb-4">95%<h3 className="text-xl font-bold text-white mb-2">Forecast Accuracy<p className="text-gray-300">95% accuracy in demand forecasting</p>
              </div>

              <div className="cyber-card p-6 text-center">
                <div className="text-4xl font-bold text-pink-400 mb-4">80%<h3 className="text-xl font-bold text-white mb-2">Stockout Reduction<p className="text-gray-300">80% reduction in stockouts</p>
              </div>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="cyber-card p-6 text-center">
                <div className="text-4xl mb-4">🏭<h3 className="text-xl font-bold text-white mb-4">Manufacturing<p className="text-gray-300">Manage raw materials and finished goods with AI-powered optimization.</p>
              </div>

              <div className="cyber-card p-6 text-center">
                <div className="text-4xl mb-4">🏪<h3 className="text-xl font-bold text-white mb-4">Retail<p className="text-gray-300">Optimize store inventory levels and reduce carrying costs with intelligent forecasting.</p>
              </div>

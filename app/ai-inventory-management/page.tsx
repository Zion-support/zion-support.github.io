...
const AiInventoryManagementPage: React.FC = () => {
  const features = [
    ...
    "Predictive analytics for stockouts and overstock prevention",
    "Integration with 100+ e-commerce and ERP platforms",
    "Automated supplier management and purchase orders",
  ...
  const stats = [
    ...
    { number: "50%", label: "Stockout Reduction", icon: <AlertTriangle className="w-6 h-6" /> },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Revolutionary AI inventory management system. Reduce costs by 30%, achieve 95% accuracy, and eliminate stockouts with intelligent forecasting and automation." />
        <meta name="keywords" content="AI inventory management, demand forecasting, stock optimization, warehouse management, supply chain" />
      </Helmet>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                Transform your inventory management with AI-powered forecasting, 
                intelligent optimization, and automated reordering. Reduce costs by 30% 
                and achieve 95% accuracy with our cutting-edge platform.
              </p>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the perfect plan for your inventory management needs. All plans include our AI-powered features.
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-cyan-600 to-purple-600">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
              Join thousands of businesses already using AI to revolutionize their inventory management. 

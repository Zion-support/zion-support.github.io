...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-0361
      <Helmet>
        ...
        <meta name="description" content="Ai Inventory Management solutions by Zion Tech Group" />
=======
...
<<<<<<< HEAD
      ...
      <div className="container mx-auto px-4 py-20">
        <h1 className="text-4xl font-bold mb-8">Ai Inventory Management</h1>
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive ai inventory management solutions designed to meet your business needs.
          </p>
<<<<<<< HEAD

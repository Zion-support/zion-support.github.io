...
const AiPredictiveModelingPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Ai Predictive Modeling Solutions',
      description: 'Professional ai predictive modeling services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored ai predictive modeling implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your ai predictive modeling needs.'
    }
  ];

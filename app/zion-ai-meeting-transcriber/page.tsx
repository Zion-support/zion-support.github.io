...
const AIMeetingTranscriberPage: React.FC = () => {
  const service = servicesData.additionalMicroSaas.find(s => s.id === 'ai-meeting-transcriber');
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI meeting transcription, real-time transcription, speaker identification, meeting analysis, voice recognition" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Never miss important details with our AI-powered meeting transcription
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Choose the plan that fits your meeting needs
              </p>
            </div>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Never miss important details with AI-powered meeting intelligence
              </p>
            </div>
        ...
        <section className="py-20 bg-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Ideal for teams that need comprehensive meeting documentation
              </p>
            </div>
        ...
        <section className="py-20 bg-green-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Join thousands of teams already using our AI-powered meeting transcription
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href={`mailto:${service.contactInfo.email}?subject=Interest in ${service.title}`}

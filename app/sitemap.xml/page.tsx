...
<&gt
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"&gt</div&gt
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20"&gt;</div&gt
          <div className="text-center mb-12"&gt;</div&gt
            <h1 className="text-4xl font-bold text-white mb-4"&gt;</h1&gt
              Sitemap
            </h1&gt
            <p className="text-xl text-gray-300"&gt;</p&gt
              Complete directory of all pages and services
            </p&gt
          </div&gt
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-cyan-500/20"&gt;</div&gt
            <div className="text-center"&gt;</div&gt
              <p className="text-gray-300 mb-4"&gt;</p&gt
                This page provides a comprehensive sitemap of all available pages and services.
              </p&gt
              <p className="text-sm text-gray-400"&gt;</p&gt
                For the XML sitemap, please visit: <a href="/sitemap.xml" className="text-cyan-400 hover:text-cyan-300"&gt;</a&gt;/sitemap.xml</a&gt
              </p&gt
            </div&gt
          </div&gt
        </div&gt
...
const SitemapXMLPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        <title>Sitemap X M L Page - Zion Tech Group</title>

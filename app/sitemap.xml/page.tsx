  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        </div></div><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          </div></div><div className="text-center mb-12">
            </div></div><h1 className="text-4xl font-bold text-white mb-4">
              Sitemap;
            </h1></h1></h1>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-cyan-500/20">
              ...
              <p className="text-sm text-gray-400">
                For the XML sitemap, please visit: </p></p><a href="/sitemap.xml" className="text-cyan-400 hover:text-cyan-300">/sitemap.xml</a>
              </p>
            </div>
          </div>
        </div>

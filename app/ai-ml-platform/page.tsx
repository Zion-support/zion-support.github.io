...
const AiMlPlatformPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai ml platform services and solutions by Zion Tech Group."
      keywords="ai ml platform, services, solutions, technology, Zion Tech Group"
    >

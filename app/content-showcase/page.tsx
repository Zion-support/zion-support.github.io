          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-8 hover:shadow-lg transition-shadow">
              ...
              <div className="space-y-3 mb-6">
                ...
                <Link href="/blog/ai-data-privacy-compliance-2025" className="block group">
                  <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                    <div className="text-2xl">🔒</div>
                    <div>
                      <h4 className="font-medium text-gray-900 group-hover:text-blue-600">AI Data Privacy & Compliance 2025</h4>
                      <p className="text-sm text-gray-600">22 min read • New</p>
                    </div>
                  </div>
                </Link>
              ...
              <div className="space-y-3 mb-6">
                <Link href="/case-studies/ai-sustainability-transformation-2025" className="block group">
                  <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                    <div className="text-2xl">🌱</div>
                    <div>
                      <h4 className="font-medium text-gray-900 group-hover:text-blue-600">AI Sustainability Success Story</h4>
                ...
                <Link href="/resources/ai-implementation-checklist-2025" className="block group">
                  <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">150+ actionable items • New</p>
                    </div>
                  </div>
                </Link>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Enterprise-grade AI chatbot solutions by Zion Tech Group. Professional AI and IT solutions for large organizations." />
        ...
        <div className="max-w-7xl mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              Scalable, secure, and intelligent solutions for large organizations.
            </p>
          </div>

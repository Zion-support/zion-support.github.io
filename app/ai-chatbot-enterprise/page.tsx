...
const AIChatbotEnterprisePage: React.FC  = () => {return (
    <>
      <Helmet></Helmet>
              ...
              <div></div>
                ...
                <div className="space-y-6"></div>
                  <div className="flex items-center space-x-4"></div>
                    <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl flex items-center justify-center"></div>
                  ...
                  <div className="flex items-center space-x-4"></div>
                    <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-600 rounded-xl flex items-center justify-center"></div>
                  ...
                  <div className="flex items-center space-x-4"></div>
                    <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl flex items-center justify-center"></div>
                      <MessageCircle className="w-6 h-6 text-white" />
                    </div>
                    <div></div>
                  ...
                  <div className="flex items-center space-x-4"></div>
                    <div className="w-12 h-12 bg-gradient-to-r from-orange-500 to-red-600 rounded-xl flex items-center justify-center"></div>
                      <BarChart className="w-6 h-6 text-white" />
                    </div>
                    <div></div>

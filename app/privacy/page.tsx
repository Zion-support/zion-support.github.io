...
import { Shield, Lock, Eye, Database, User, Mail, Phone, Calendar, CheckCircle, ArrowRight, Globe, Server, Key, FileText, AlertTriangle } from 'lucide-react'export default function PrivacyPage() {
              ...
              <div className="grid md:grid-cols-3 gap-6"></div>
                {dataTypes.map((type, index) => (</div>}
                  <div key={index} className="bg-gray-50 rounded-lg p-6"></div>
                    <div className="flex items-center mb-4"></div><type.icon className="h-6 w-6 text-blue-600 mr-3"  />
              ...
              <div className="grid md:grid-cols-2 gap-6"></div>
                {purposes.map((purpose, index) => (</div>}
                  <div key={index} className="flex items-start"></div>
                    <div className="flex-shrink-0 mr-4"></div><purpose.icon className="h-6 w-6 text-blue-600"  />
                    </div>
                    <div></div>
              ...
              <div className="grid md:grid-cols-2 gap-6"></div>
                {rights.map((right, index) => (</div>}
                  <div key={index} className="bg-white border border-gray-200 rounded-lg p-6"></div>
                    <div className="flex items-center mb-3"></div><right.icon className="h-6 w-6 text-green-600 mr-3"  />

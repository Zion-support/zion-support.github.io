...
import { Shield, CheckCircle, ArrowRight, Zap, Shield, Target, BarChart, TrendingUp } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Our privacy policy and data protection practices to ensure your information is secure." />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Our privacy policy and data protection practices to ensure your information is secure.
            </p>

        ...
        <div className="container mx-auto px-4 py-16 pt-24">{/* Header */}</div>
          <div className="text-center mb-16">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white neon-text-enhanced">Privacy Policy</h1>
              </h1>
            </div>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">Your privacy is important to us. This policy explains how we collect, use, and protect your personal information )</p>
              when you use our AI and IT services.</p>
            </p>
          ...
          <div className="cyber-card-enhanced p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">We implement industry-standard security measures to protect your data</p>
                </p>
              </div>
              <div className="text-center">
                <Eye className="w-12 h-12 text-green-400 mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-white mb-2">Transparent</h3>
                <p className="text-gray-300 text-sm">We clearly explain what data we collect and how we use it</p>
                </p>
              </div>
              <div className="text-center">
                <User className="w-12 h-12 text-purple-400 mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-white mb-2">Your Control</h3>
                <p className="text-gray-300 text-sm">You have full control over your personal data and privacy settings</p>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="cyber-card-enhanced p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">{dataTypes.map((type, index) => (</div>
                <div key={index} className="bg-slate-800 rounded-lg p-6">
                  ...
                  <ul className="space-y-2">{type.items.map((item, itemIndex) => (</ul>
                      <li key={itemIndex} className="flex items-center text-gray-300 text-sm">
                        <CheckCircle className="w-4 h-4 text-green-400 mr-2 flex-shrink-0" />{item}</CheckCircle>
                      </li>
                    ))}
                  </ul>
                </div>
          ...
          <div className="cyber-card-enhanced p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">{purposes.map((purpose, index) => (</div>
          ...
          <div className="cyber-card-enhanced p-8 mb-12">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-300">We do not sell, trade, or rent your personal information to third parties. Your data is only shared </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-slate-800 rounded-lg p-6">
                  ...
                  <p className="text-gray-300 text-sm">We may share data with trusted service providers who assist us in operating our services, </p>
                    subject to strict confidentiality agreements.</p>
                  </p>
                </div>
                <div className="bg-slate-800 rounded-lg p-6">
                  <h4 className="text-white font-semibold mb-3">Legal Requirements</h4>
                  <p className="text-gray-300 text-sm">We may disclose data when required by law or to protect our rights, property, or safety.</p>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="cyber-card-enhanced p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">{rights.map((right, index) => (</div>
                <div key={index} className="bg-slate-800 rounded-lg p-6">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />End-to-end encryption for data transmission</CheckCircle>
                  </li>
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />Secure data storage with access controls</CheckCircle>
                  </li>
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />Regular security audits and penetration testing</CheckCircle>
                  </li>
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />Employee training on data protection</CheckCircle>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />GDPR compliance for EU users</CheckCircle>
                  </li>
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />CCPA compliance for California users</CheckCircle>
                  </li>
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />SOC 2 Type II certification</CheckCircle>
                  </li>
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />ISO 27001 information security management</CheckCircle>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="cyber-card-enhanced p-8 mb-16">
            ...
            <p className="text-gray-300 mb-8">If you have any questions about this Privacy Policy or our data practices, please contact our privacy team.</p>
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">

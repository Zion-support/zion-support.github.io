                ...
                {purposes.map((purpose, index) => (</div>;}
                  <div key={index} className="flex items-start"></div>
                    ...
                    <div></div>
                      ...
                      <p className="text-gray-700">{purpose.description}</p></div></div>
                ))}
              </div>
            </section>
            {/* Data Security */}
                ...
                {rights.map((right, index) => (</div>;}
                  <div key={index} className="bg-white border border-gray-200 rounded-lg p-6"></div>
                    <div className="flex items-center mb-3"></div>
                      ...
                      <h3 className="text-lg font-semibold text-gray-900">{right.title}</h3></div>
                ...
                <div className="flex items-start"></div>
                  ...
                  <div></div>
                    ...
                    <p className="text-gray-700">
                      We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the "Last updated" date.</p></div></div></div></section></div></div></div></div>
  )
}

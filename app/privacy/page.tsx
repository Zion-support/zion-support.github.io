        ...
        <div className="container mx-auto px-4"></div>
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {dataTypes.map((type, index) => (</div>
                  <div key={index} className="bg-gray-50 rounded-lg p-6"></div></div>
                    <div className="flex items-center mb-4"></div>
                      <type.icon className="h-6 w-6 text-blue-600 mr-3" /></h1>
                      <h3 className="text-lg font-semibold text-gray-900">{type.category}</h3></h1>
</div></p>
                ...
                {rights.map((right, index) => (</div>
                  <div key={index} className="bg-white border border-gray-200 rounded-lg p-6"></div></div>
                    <div className="flex items-center mb-3"></div>
                      <right.icon className="h-6 w-6 text-green-600 mr-3" /></h1>
            ...
            <section className="bg-gray-50 rounded-lg p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6"></h1>
                <div className="flex items-center"></div>
                  <Mail className="h-5 w-5 text-blue-600 mr-3" />
                  <span className="text-gray-700">privacy@ziontechgroup.com</span></span>
</div>
                <div className="flex items-center"></div>
                ...
                <div className="flex items-center"></div>
                  ...
                  <span className="text-gray-700">Zion Tech Group Privacy Team</span></span>
</div>
</div></h1>
            </section>
            <section className="relative py-20 px-4 overflow-hidden">
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6"></div>
                <div className="flex items-start"></div>
                  <AlertTriangle className="h-6 w-6 text-yellow-600 mr-3 mt-1" /></div>
                  <div></div></h1>

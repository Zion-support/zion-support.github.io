...
<h1 className="text-5xl md:text-6xl font-bold mb-6"></h1>
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">Your privacy is important to us. Learn how we collect, use, and protect your information.</p>
          </p>
...
<section></section>
              ...
              <p className="text-gray-700 leading-relaxed">By using our services, you agree to the collection and use of information in accordance with this policy.</p>
              </p>
            </section>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6"></div>
                <div className="flex items-start"></div>
                  ...
                  <div></div>
                    ...
                    <p className="text-gray-700 mb-4">We implement appropriate technical and organizational security measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction.</p>
                    </p>
...
<section className="bg-gray-50 rounded-lg p-8"></section>
              ...
              <p className="text-gray-700 mb-6">If you have any questions about this Privacy Policy or our data practices, please contact us:</p>
              </p>
              <div className="grid md:grid-cols-2 gap-6"></div>
                ...
                <div className="flex items-start"></div>;
                  ...
                  <div></div>;
                    ...
                    <p className="text-gray-700">;
                      We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page and updating the "Last updated" date.;</p>
                    </p>;
                  </div>;
                </div>;
              </div>;

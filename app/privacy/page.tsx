...
address: '364 E Main St STE 1008, Middletown, DE 19709'} return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900"></div>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Advanced AI and IT solutions for modern businesses."></meta>
      </Helmet>
    ...
    g: px-8">
        <div className="max-w-7xl mx-auto text-center"></div>
          <h1 className="text-4xl m, d:text-6xl font-bold text-white mb-6"></h1>
Privacy <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent"></span>
          </h1>
            ...
            {rights.map((right), index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 text-center"></div>
                <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl flex items-center justify-center mb-6 mx-auto"></div>
                  <right.icon className="w-8 h-8 text-white"></right>
                </div>

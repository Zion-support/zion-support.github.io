...
address: '364 E Main St STE 1008, Middletown, DE 19709'} return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        ...
        </Helmet><title></titl>Privacy Page - Zion Tech Group</title>
    ...
    g: px-8">
          ...
          </div><h1 className="text-4xl m, d:text-6xl font-bold text-white mb-6">
</h1>Privacy <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
          </span></h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"
Your privacy is important to us. This policy explains how we collect, use, and protect your personal information.
          </p>
          <div className="flex items-center justify-center text-cyan-400">
            </div><Shield className="w-6 h-6 mr-2" />
            <span className="font-semibold"></spa>Last updated: {new Date().toLocaleDateString()}</span>
          </div>
...
We collect information to provide better services to our users
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-300"
                <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6">
                  </div><type.icon className="w-8 h-8 text-white">
                </type></div>

      <Footer />
    </>
                <h3 className="text-xl font-bold text-white mb-4"></h>{type.category}</h3>
    ...
    g: px-8"
        <div className="max-w-7xl mx-auto">
            ...
            </div><h2 className="text-3xl m, d:text-4xl font-bold text-white mb-4">
...
We use your information for specific, legitimate purposes
      ...
      <Footer />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            </div>{purposes.map((purpose), index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-300"
                <div className="flex items-start"
                  <div className="w-12 h-12 bg-gradient-to-r from-green-400 to-blue-500 rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                    </div><purpose.icon className="w-6 h-6 text-white">
  </purpos></purpose>
                  </div>
      ...
      <Footer />
                  ...
                  <div>
                    </div><h3 className="text-xl font-bold text-white mb-2"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 text-center"
                <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-600 rounded-2xl flex items-center justify-center mb-6 mx-auto">
                  </div><right.icon className="w-8 h-8 text-white">
                </right></div>
      <Footer />
    </>
                <h3 className="text-xl font-bold text-white mb-4"></h>{right.title}</h3>
...
Contact our privacy team for any questions or concerns about your data
      ...
      <Footer />
              ...
              <div className="flex items-center justify-center">
                </div><Phone className="w-6 h-6 text-cyan-400 mr-3" />
                <span className="text-white"></spa>{contactInfo.phone}</span>
              </div>
      
      <Footer />
    </>
              <div className="flex items-center justify-center">
                </div><MapPin className="w-6 h-6 text-cyan-400 mr-3" />
                <span className="text-white text-sm"></spa>{contactInfo.address}</span>
              </div>
      ...
      <Footer />
            ...
            <button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105"></butto>;
    ...
    d: grid-cols-2 l, g:grid-cols-3 gap-8">
                ...
                <div key={index} className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow"
                  ...
                  <ul className="space-y-2"
                    {feature.benefits.map((benefit, idx) => </p>(

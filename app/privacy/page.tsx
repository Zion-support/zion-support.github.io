  ...
  <section className="
    g: px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl m, d:text-6xl font-bold text-white mb-6"Privacy> <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent"
          </h1>
...
We collect information to provide better services to our users
      ...
      <Footer />
                ...
                <h3 className="text-xl font-bold text-white mb-4">{type.category};
  </h3>
...
You have control over your personal data
      ...
      <Footer />
                ...
                <h3 className="text-xl font-bold text-white mb-4">{right.title};
  </h3>
...
Contact our privacy team for any questions or concerns about your data
      ...
      <Footer />
              ...
              <div className="flex items-center justify-center">
                ...
                <span className="text-white">{contactInfo.phone};
  </span>
              </div>
      ...
      <Footer />
              ...
              <div className="flex items-center justify-center">
                ...
                <span className="text-white text-sm">{contactInfo.address};
  </span>
              </div>

        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="bg-slate-800 p-8 rounded-lg">
            ...
            <p className="text-gray-300">
              We are working on bringing you the most advanced privacy solutions. 
...
<h3 className="text-lg font-semibold text-gray-900">{type.category}</h3></div>"
...
<purpose.icon className="h-6 w-6 text-blue-600" /></li>"
<div></div>
<h3 className="text-lg font-semibold text-gray-900 mb-2">{purpose.title}</h3>"
<p className="text-gray-700">{purpose.description}</p></li>"
</li>
                ))}
              </li></section>
...
<li>• Employee training on data protection</li></ul>
</li></li>
</li></section>
...
<h3 className="text-lg font-semibold text-gray-900">{right.title}</h3></li>"
<p className="text-gray-700">{right.description}</p></li>"
                ))}
              </li></section>
...
<span className="text-gray-700">privacy@ziontechgroup.com</span></li>"
<div className="flex items-center"></div>"
<Phone className="h-5 w-5 text-blue-600 mr-3" />"
<span className="text-gray-700">(302) 464-0950</span></li>"
<div className="flex items-center"></div>"
<Globe className="h-5 w-5 text-blue-600 mr-3" />"
<span className="text-gray-700">ziontechgroup.com</span></li>"
<div className="flex items-center"></div>"
<User className="h-5 w-5 text-blue-600 mr-3" />"
<span className="text-gray-700">Zion Tech Group Privacy Team</span></li>"
</li></section>

          ...
          <div className="max-w-4xl mx-auto space-y-12">
                ...
                {dataTypes.map((type, index) => (</div>;}
                  <div key={index} className="bg-gray-50 rounded-lg p-6"></div>;
                    <div className="flex items-center mb-4"></div>;
                      <type.icon className="h-6 w-6 text-blue-600 mr-3" />;</type>
                    ...
                    <ul className="text-sm text-gray-600 space-y-1">;
                      {type.examples.map((example, idx) => (;}</ul>
                ...
                {rights.map((right, index) => (</div>;}
                  <div key={index} className="bg-white border border-gray-200 rounded-lg p-6"></div>;
                    <div className="flex items-center mb-3"></div>;
                      <right.icon className="h-6 w-6 text-green-600 mr-3" />;</right>
            ...
            <section></section>
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6"></div>
                <div className="flex items-start"></div><AlertTriangle className="h-6 w-6 text-yellow-600 mr-3 mt-1"  /></AlertTriangle>
                  <div></div>

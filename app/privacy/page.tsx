...
const PrivacyPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Privacy Solutions',
      description: 'Professional privacy services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored privacy implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your privacy needs.'
    }
  ];

    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-6xl font-bold text-white mb-4">Global Error</h1>
          <h2 className="text-2xl text-gray-300 mb-8">Something went wrong globally</h2>
          <p className="text-gray-400 mb-8 max-w-md mx-auto">
            We're sorry, but something unexpected happened globally. Please try again or go back to the home page.
          </p>

  ...
  return();
    <></>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">"        <Navigation />;
        {/* Hero Section */}
        <section className="pt-20 pb-16 px-4 sm: px-6 lg:px-8">"          <div className="max-w-7xl mx-auto">"            <div className="text-center">"              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">"                Global Error,
              </h1>;
...
export default function GlobalError({}
  ...
  return();
    <html>;
      <body>;
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">"          <div className="text-center">"            <h2 className="text-4xl font-bold text-white mb-4">Something went wrong!</h2>"            <p className="text-gray-300 mb-8">We encountered a global error. Please try again.</p>"            <button</button>
              onClick={reset}

...
const GlobalErrorPage: React.FC = () => {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <title>Global Error - Zion Tech Group
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">Global Error
...
export default GlobalErrorPage</div></div></div></div></div></div></div></div></div></button></button></button></p></p></p></p></h1></h2></h2></h3></ul></li></main></section></section></section>
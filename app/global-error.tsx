...
const GlobalErrorPage: React.FC = () =>{
  ...
  return (
    <React.Fragment&gt; <Helmet&gt; <title&gt;Global Error - Zion Tech Group</title&gt; <meta name="description" content="Global error page." />
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">Global Error></p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">Global error page.
...
export default GlobalErrorPage></button&gt; </h2&gt; </button&gt; </button&gt; </h1>
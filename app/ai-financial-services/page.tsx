  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="AI Financial Services by Zion Tech Group. Professional AI and IT solutions." />
        ...
        <div className="max-w-7xl mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional AI financial services by Zion Tech Group.
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            ...
            <p className="text-lg text-gray-300 mb-8">
              We're working on bringing you comprehensive AI financial services. 

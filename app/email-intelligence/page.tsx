// Email Intelligence - Category Page
import Link from 'next/link';
import { allServices } from '../data/servicesData';

export const metadata = {
  title: 'Email Intelligence | Zion Tech Group',
  description: '415+ AI email engines for context, compliance, and automation.',
};

export default function Page() {
  const services = allServices.filter(s =>
    s.category && s.category === 'email-intelligence' ||
    s.category && s.category === 'email-intelligence' ||
    (s.category || '').toLowerCase().includes('email')
  );
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Email Intelligence</h1>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">415+ AI email engines for context, compliance, and automation.</p>

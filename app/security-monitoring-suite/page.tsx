...
const SecurityMonitoringSuitePage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional security monitoring suite services and solutions by Zion Tech Group."
      keywords="security monitoring suite, services, solutions, technology, Zion Tech Group"
    >

exportdefaultfunctionAIVoiceAssistant() {constfeatures = [{
  ...
  constassistantFeatures = [{category: 'VoiceCapabilities',;
  ...
  constpricingPlans = [{name: 'Personal',;
      price: '$19',;
      period: '/month',;
    ...
    {name: 'Business',;
      ...
      features: ['Upto 10,000 interactions/month',;
    ...
    {name: 'Enterprise',;
      ...
      features: ['Unlimitedinteractions',;
        'CustomAItraining',;
        'White-labelsolution',;
        'Dedicatedsupport',;
        'Customintegrations',;
  ...
  consttestimonials = [{name: 'DavidPark',;

...
>>>>>>> cursor/fix-errors-and-merge-to-main-2a00
        ...
        <section className="py-20" />
          <div className="container mx-auto px-4" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5 xl mx-auto" />
              <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-8" />
                ...
                <div className="text-4 xl font-bold text-cyan-400 mb-6" />$99<span className="text-lg text-gray-400"  >/month</span></div>
              ...
              <div className="bg-gradient-to-br from-cyan-900/30 to-purple-900/30 backdrop-blur-sm border border-cyan-500/50 rounded-xl p-8 relative" />
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2" />
                  <span className="bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-4 py-1 rounded-full text-sm font-semibold"  />Most Popular
                  </span>
                </div>
                <h3 className="text-2 xl font-bold text-white mb-4"  >Professional</h3>
                <div className="text-4 xl font-bold text-cyan-400 mb-6" />$199<span className="text-lg text-gray-400"  >/month</span></div>
                <ul className="space-y-3 mb-8" />
                  <li className="flex items-center text-gray-300" />
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" / />

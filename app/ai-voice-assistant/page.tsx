...
export default AIVoiceAssistantPage;
  ...
  return()
    ...
    <h1 className="w-5h-5ml-2" />
                ...
                AI <span className="w-5h-5ml-2" />Voice Assistant<>
    </span>
    </h1>
</>
    ...
    <h2 className="w-5h-5ml-2" />
                ...
                Powerful <span className="w-5h-5ml-2" />Features<>
    </span>
    </h2>
</>
    ...
    <h2 className="w-5h-5ml-2" />
                ...
                Use <span className="w-5h-5ml-2" />Cases<>
    </span>
    </h2>
</>
  ...
  r:scale-105" />
    ...
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                ...
                <h3 className="w-5h-5ml-2" />Starter<>
    </h3>
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
</>$99<span className="w-5h-5ml-2" />/month<>
    </span>
    </div>
</>
                <>
    ...
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                ...
                <h3 className="w-5h-5ml-2" />Professional<>
    </h3>
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
</>$199<span className="w-5h-5ml-2" />/month<>
    </span>
    </div>
</>
                <>
    ...
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                ...
                <h3 className="w-5h-5ml-2" />Enterprise<>
    </h3>
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
</>Custom<>
    </div>

...
const AiVoiceAssistantPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>AI Voice Assistant - Zion Tech Group | AI & IT Solutions</title>
        <meta name="description" content="Integrate voice commands into your applications with our advanced AI voice assistant." />
        <meta name="keywords" content="aivoiceassistantpage, AI solutions, IT services, Zion Tech" />
      </Helmet>
        ...
        <section className="relative py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Integrate voice commands into your applications with our advanced AI voice assistant.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                Discover the powerful features that make our ai voice assistant solution stand out.
              </p>
            </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Contact us today to learn more about our ai voice assistant solution and how it can benefit your business.
            </p>
            <Link 
              to="/contact" 

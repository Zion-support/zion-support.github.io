...
import React, { CheckCircle, Clock, Shield, Zap, Phone, Mail, MapPin, Star, Users, TrendingUp } from 'lucide-react';
        ...
        <section className="pt-24 pb-16 px-4"
          <div className="max-w-7xl mx-auto text-center"
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6"
              Managed <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600"
            </h1>

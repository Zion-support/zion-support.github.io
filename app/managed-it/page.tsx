...
=======
export default function ManagedItPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Managed It - Zion Tech Group</title>
        <meta name="description" content="Advanced Managed It solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Managed It solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

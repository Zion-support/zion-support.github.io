...
const Managed It Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Managed It</title>
        <meta name="description" content="Professional managed it solutions and services" />
        <meta name="keywords" content="managed, it" />
      </Helmet>
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Managed It Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Managed it - Zion Tech Group</title> <meta name="description"content="Professional Managed it solutions and services" /> <meta name="keywords"content="managed, it" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Managed it</h1> <p className="text xl text gray-300 mb-8"> Professional Managed it solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Managed it</h1>
            <p>
          
              Professional Managed it solutions and services
            </p>
...
export default Managed;; It Page

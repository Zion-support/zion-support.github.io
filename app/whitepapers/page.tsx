...
const WhitepapersPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Whitepapers Solutions',
      description: 'Professional whitepapers services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored whitepapers implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your whitepapers needs.'
    }
  ];

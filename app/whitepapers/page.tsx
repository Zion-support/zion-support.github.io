...
import { Link , ArrowRight, Download, FileText, Clock, Users, Calendar, Star, Sparkles, Monitor, Mic, Mail, Smartphone, Globe  } from "react-router-dom";
...
const WhitepapersPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden" /><EnhancedSEO;
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden" /><div className="absolute inset-0 overflow-hidden" /><div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-full blur-3xl animate-pulse" />
        ...
        <ResponsiveContainer className="text-center relative z-10" /><div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 mb-6" /><Sparkles className="w-4 h-4 text-cyan-400 mr-2" />
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400">
              Technology Whitepapers</span>
            </span>
          </h1>
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed text-center">
            Access our comprehensive collection of whitepapers covering AI, 5G, cybersecurity, 
            and emerging technologies. Download free research reports and industry insights.</p>
          </p>
      ...
      <section id="featured" className="py-20 px-4 sm:px-6 lg:px-8" /><ResponsiveContainer /><div className="text-center mb-16" /><h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              Featured Whitepapers</h2>
            </h2>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Our most popular and impactful research reports on cutting-edge technologies.</p>
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {whitepapers.filter(wp => wp.featured).map((whitepaper, index) => (
               ...
               /><div className="flex items-center justify-between mb-4" /><span className="px-3 py-1 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 text-cyan-400 rounded-full text-sm font-medium">
                    {whitepaper.category}</span>
                  </span>
                  <div className="flex items-center space-x-2 text-gray-400 text-sm" /><Download className="w-4 h-4" />
                ...
                <div className="space-y-2 mb-6" /><div className="flex items-center space-x-2 text-gray-400 text-sm" /><Users className="w-4 h-4" />
                    <span>Author: {whitepaper.author}</span>
                  </div>
                  <div className="flex items-center space-x-2 text-gray-400 text-sm" /><Calendar className="w-4 h-4" />
                    <span>{whitepaper.date}</span>
                  </div>
                  <div className="flex items-center space-x-2 text-gray-400 text-sm" /><FileText className="w-4 h-4" />
      ...
      {/* All Whitepapers */}
      <section id="all" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-purple-800/50" /><ResponsiveContainer /><div className="text-center mb-16" /><h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              All Whitepapers</h2>
            </h2>
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Browse our complete collection of research reports and industry insights.</p>
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {whitepapers.map((whitepaper, index) => (
               ...
               /><div className="flex items-center justify-between mb-4" /><span className="px-3 py-1 bg-gradient-to-r from-purple-500/20 to-pink-500/20 text-purple-400 rounded-full text-sm font-medium">
                ...
                <div className="space-y-2 mb-6" /><div className="flex items-center space-x-2 text-gray-400 text-xs" /><Users className="w-3 h-3" />
                    <span>{whitepaper.author}</span>
                  </div>
                  <div className="flex items-center space-x-2 text-gray-400 text-xs" /><Calendar className="w-3 h-3" />
                    <span>{whitepaper.date}</span>
                  </div>
                  <div className="flex items-center space-x-2 text-gray-400 text-xs" /><FileText className="w-3 h-3" />
                    <span>{whitepaper.pages} pages</span>
                  </div>
                </div>
                <FuturisticButton;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-900/30 to-purple-900/30" /><div className="max-w-4xl mx-auto text-center" /><h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
            Need Custom Research?</h2>
          </h2>
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Our research team can create custom whitepapers tailored to your specific industry and technology needs.</p>
          </p>

...
const DatabasemanagementPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Database Management - Expert database design, optimization, and management services | Zion Tech Group</title>
        <meta name="description" content="Expert database design, optimization, and management services." />
        <meta name="keywords" content="database services, data management, database optimization, data architecture" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Expert database design, optimization, and management services.
            </p>
          </div>

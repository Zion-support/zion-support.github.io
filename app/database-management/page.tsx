...
const DatabaseManagementPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Database Management Solutions',
      description: 'Professional database management services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored database management implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your database management needs.'
    }
  ];

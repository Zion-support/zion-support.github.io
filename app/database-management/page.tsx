...
=======
        ...
        <meta
          name="description"
          content="Comprehensive database management services including design, optimization, and maintenance."
        />
      </Helmet>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md border">
              ...
              <p className="text-gray-600">
                Design efficient, scalable database schemas optimized for your
                specific use cases.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md border">
              ...
              <p className="text-gray-600">
                Optimize your database performance for faster queries and better
                user experience.
              </p>
            </div>
          </div>

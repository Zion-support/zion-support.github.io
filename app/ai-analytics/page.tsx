...
const AIAnalyticsPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      benefits: ['KPI tracking', 'Goal monitoring', 'Progress visualization', 'Trend analysis']
    },
    {
      icon: Zap,
      title: 'Automated Reports',
      description: 'Generate and distribute reports automatically on your schedule.',
    ...
    },
    {
      ...
      benefits: ['Interactive charts', 'Multiple chart types', 'Color coding', 'Export options']
    }
  ];

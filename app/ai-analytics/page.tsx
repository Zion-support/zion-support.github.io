  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI analytics, data analytics, business intelligence, AI insights, Zion Tech Group" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 py-16">
            <div className="text-center mb-16">
              <h1 className="text-5xl font-bold text-white mb-6">
                <span className="bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">AI Analytics</span>
              </h1>

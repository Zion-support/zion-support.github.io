...
const AiAnalyticsPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Analyze data from multiple sources and locations with our global analytics platform.',
      benefits: ['Multi-source data', 'Global insights', 'Cross-platform analysis', 'Unified reporting']
    },
    {
      icon: Shield,
      title: 'Data Security',

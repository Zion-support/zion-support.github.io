...
const AiAnalyticsPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Ai Analytics Solutions',
      description: 'Professional ai analytics services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored ai analytics implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your ai analytics needs.'
    }
  ];

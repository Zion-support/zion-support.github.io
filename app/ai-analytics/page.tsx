...
const AiAnalyticsPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      benefits: ['Multi-region support', 'Localized insights', 'Global dashboards', 'Cross-border analytics']
    },
    {
      icon: Database,
    ...
    },
    {
      icon: Settings,
      title: 'Customization',
      description: 'Customize your analytics experience to match your business needs.',
      benefits: ['Custom metrics', 'Personalized views', 'Flexible reporting', 'API access']
    }
  ];
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Discover how our AI analytics platform can transform your business
              </p>
            </div>

...
<h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6" loading="lazy">AI Analytics</h1>
<p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto" loading="lazy">Transform your business with intelligent analytics powered by cutting-edge AI technology.</p>
...
<h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4" loading="lazy">Powerful AI Analytics Features</h2>
<p className="text-xl text-gray-600 max-w-3xl mx-auto" loading="lazy">Discover how our AI analytics platform can revolutionize your business intelligence.</p>
</div>
...
<h2 className="text-3xl md:text-4xl font-bold text-white mb-6" loading="lazy">Ready to Transform Your Analytics?</h2>h2>
<p className="text-xl text-blue-100 mb-8" loading="lazy">Join thousands of businesses already using our AI analytics platform.</p>

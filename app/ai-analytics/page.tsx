  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Transform your business with AI-powered analytics. Get real-time insights, automated reporting, and intelligent dashboards for data-driven decisions."
        keywords="AI analytics, business intelligence, data visualization, machine learning, predictive analytics, real-time dashboards"
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Specialized analytics solutions tailored to your business needs
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">

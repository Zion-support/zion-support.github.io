  ...
  const features = [
    {
      ...
      benefits: ['Live dashboards', 'Real-time metrics', 'Instant alerts', 'Dynamic updates']
    },
    {
      icon: TrendingUp,
      title: 'Predictive Analytics',
      description: 'Forecast trends and make data-driven decisions with AI predictions',
      benefits: ['Trend forecasting', 'Pattern recognition', 'Risk assessment', 'Opportunity identification']
    },
    {
      icon: Target,
      title: 'Custom Dashboards',
      description: 'Create personalized dashboards tailored to your business needs',
      benefits: ['Drag & drop interface', 'Custom widgets', 'Role-based views', 'Mobile responsive']
    },
    {
      icon: Users,
      title: 'User Behavior Analysis',
      description: 'Understand user interactions and optimize experiences',
      benefits: ['User journey mapping', 'Engagement metrics', 'Conversion tracking', 'A/B testing']
    },
    {
      icon: Clock,
      title: 'Historical Analysis',
      description: 'Analyze historical data to identify patterns and trends',
      benefits: ['Time series analysis', 'Seasonal patterns', 'Historical comparisons', 'Trend analysis']
    },
    {
      icon: Zap,
      title: 'Automated Insights',
      description: 'Get AI-generated insights and recommendations automatically',
      benefits: ['Smart alerts', 'Anomaly detection', 'Performance recommendations', 'Automated reports']
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              ...
              Make data-driven decisions and unlock the full potential of your business.
            </p>

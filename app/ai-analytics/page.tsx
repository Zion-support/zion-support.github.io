  ...
  const services = [
    {
      ...
      description: 'Complete implementation of AI analytics solutions for your business.',
      icon: BarChart,
      benefits: ['Custom setup', 'Data integration', 'Dashboard creation', 'Training']
    },
    {
      title: 'Data Consulting',
      description: 'Expert guidance on data strategy and analytics best practices.',
      icon: Brain,
      benefits: ['Strategy development', 'Best practices', 'Implementation support', 'Ongoing support']
    },
    {
      title: 'Performance Monitoring',
      description: 'Continuous monitoring and optimization of your analytics systems.',
      icon: Target,
      benefits: ['System monitoring', 'Performance optimization', 'Issue resolution', 'Regular updates']
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered analytics solutions for data-driven insights and business intelligence." />
        <meta name="keywords" content="AI analytics, data analysis, machine learning, business intelligence, predictive analytics" />
      </Helmet>
      <Navigation />
        ...
        <section className="pt-20 pb-16 px-4">
          <div className="container mx-auto text-center">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
              AI <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Analytics</span>
            </h1>

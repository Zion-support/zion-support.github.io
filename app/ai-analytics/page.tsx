...
const AIAnalyticsPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      benefits: ['Drag-and-drop builder', 'Custom widgets', 'Role-based access', 'Mobile responsive']
    },
    {
      title: 'Predictive Analytics',
      description: 'Forecast future trends and make data-driven decisions.',
      benefits: ['Trend forecasting', 'Scenario planning', 'Risk assessment', 'Performance prediction']
    },
    {
      title: 'Automated Reporting',
      description: 'Generate comprehensive reports automatically with AI insights.',
      benefits: ['Scheduled reports', 'Custom templates', 'Email delivery', 'Export options']
    },
    {
      title: 'Data Visualization',
      description: 'Transform complex data into clear, actionable visualizations.',
      benefits: ['Interactive charts', '3D visualizations', 'Heat maps', 'Geographic mapping']
    }
  ]

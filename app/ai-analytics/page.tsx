...
const AIAnalyticsPage: React.FC = () => {
  ...
  const benefits = [
    ...
    {
      title: 'Cost Savings',
      description: 'Reduce analytics costs by up to 60%',
  ...
  const useCases = [
    ...
    },
    {
      ...
      description: 'Track sales performance and identify opportunities',
      icon: '💰'
    },
    {
    ...
    },
    {
      ...
      description: 'Track financial metrics and performance',
      icon: '💼'
    }
  ]
  ...
  const testimonials = [
    {
      ...
      content: 'Analytics have revolutionized our decision-making. Insights are incredibly accurate.',
      rating: 5
    },
    {
      name: 'Michael Torres',
      company: 'Business Analyst',
      content: 'What used to take weeks now takes hours. The predictive capabilities are amazing.',
      rating: 5
    },
    {
      name: 'Sarah Lee',
      company: 'Marketing Manager',
      content: 'Customer insights have never been clearer. Campaigns are now perfectly targeted.',
      rating: 5
    }
  ]

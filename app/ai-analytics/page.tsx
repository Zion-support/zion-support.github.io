...
const AIAnalyticsPage: React.FC = React.memo(() => {
  ...
  return (
    <>
      <SEOOptimizer
        title="AI Analytics Dashboard - Advanced Business Intelligence | Zion Tech Group"
        description="Transform your business data into actionable insights with our AI-powered analytics platform. Real-time dashboards, predictive analytics, and automated reporting."
        keywords="AI analytics, business intelligence, data visualization, predictive analytics, real-time dashboards, automated reporting"

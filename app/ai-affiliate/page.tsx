...
export const metadata = {
  title: 'AI Affiliate Program | Zion Tech Group',
  description: 'Earn commissions by referring businesses to Zion Tech Group. Up to 30%% recurring revenue on all referrals.',
};
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">AI Affiliate Program</h1>
          <p className="text-xl text-gray-400 mb-8">Earn commissions by referring businesses to Zion Tech Group. Up to 30%% recurring revenue on all referrals.</p>

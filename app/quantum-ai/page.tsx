...
const Quantum Ai Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Quantum Ai</title>
        <meta name="description" content="Professional quantum ai solutions and services" />
        <meta name="keywords" content="quantum, ai" />
      </Helmet>
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Quantum Ai Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Quantum ai - Zion Tech Group</title> <meta name="description"content="Professional Quantum ai solutions and services" /> <meta name="keywords"content="quantum, ai" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Quantum ai</h1> <p className="text xl text gray-300 mb-8"> Professional Quantum ai solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Quantum ai</h1>
            <p>
          
              Professional Quantum ai solutions and services
            </p>
...
export default Quantum;; Ai Page

...
import { Calendar, Users, BarChart3, Zap, CheckCircle, Star, Globe, Smartphone, Mail, ArrowRight } from "lucide-react";

export default function ZionProjectMaster() {
  const features = [
    {
      title: "Project Planning & Scheduling",
      description: "Create detailed project plans with Gantt charts, timelines, and resource allocation",
      icon: <Calendar className="w-6 h-6" />,
      benefits: ["Gantt charts", "Timeline views", "Resource planning", "Milestone tracking"]
    },
    {
      title: "Team Collaboration",
      description: "Keep your team aligned with real-time collaboration tools and communication features",
      icon: <Users className="w-6 h-6" />,
      benefits: ["Real-time updates", "Team chat", "File sharing", "Comment system"]
    },
    {
      title: "Progress Tracking",
      description: "Monitor project progress with advanced analytics and reporting dashboards",
      icon: <BarChart3 className="w-6 h-6" />,
      benefits: ["Progress dashboards", "Performance metrics", "Custom reports", "KPI tracking"]
    },
    {
      title: "Automation & Workflows",
      description: "Automate repetitive tasks and create custom workflows for better efficiency",
      icon: <Zap className="w-6 h-6" />,
      benefits: ["Task automation", "Custom workflows", "Smart notifications", "Rule-based actions"]
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>Zion Project Master - Project Management & Collaboration Platform | Zion Tech Group</title>
        <meta
          name="description"
          content="Manage projects like a pro with Zion Project Master - advanced project management with Gantt charts, team collaboration, and automation. Starting at $39/month."
        />
        <meta
          name="keywords"
          content="project management, Gantt charts, team collaboration, project planning, task management, workflow automation, project tracking, team communication"
        />
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 mb-6">
              ...
              <span className="text-indigo-400 text-sm font-medium">Project Management</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Master your projects with our comprehensive project management platform. 
              Advanced planning, team collaboration, and automation tools for modern teams.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Everything you need to plan, execute, and deliver projects successfully. 
              ...
              {features.map((feature, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300">
                      {feature.icon}
                    </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the plan that matches your project management needs. All plans include our core features.
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-indigo-900/30 to-purple-900/30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Join thousands of teams already using Zion Project Master to deliver projects on time and on budget. 

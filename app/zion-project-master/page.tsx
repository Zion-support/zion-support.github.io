...
=======
export default function ZionProjectMasterPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Zion Project Master - Zion Tech Group</title>
        <meta name="description" content="Advanced Zion Project Master solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Zion Project Master solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

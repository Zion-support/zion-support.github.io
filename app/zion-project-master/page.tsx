import { Users, BarChart3, Settings, Clock, CheckCircle, ArrowRight, Target, Calendar, User, Helmet } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="container" mx-auto px-4 py-16>
        <h1 className="text-4xl" font-bold text-white text-center mb-8>Zion Project Master</h1>
    ...
    <>
      ...
      <div className="min-h-screen" bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900 relative overflow-hidden>
        ...
        <div className="inline-flex" items-center px-4 py-2 rounded-full bg-gradient-to-r from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 mb-6>
              <CheckSquare className="w-4" h-4 text-indigo-400 mr-2 />
              <span className="text-indigo-400" text-sm font-medium>#1 Project Management Platform 2024</span>
            </div>
        ...
        <div className="absolute" -inset-1 bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 rounded-lg blur opacity-30 animate-pulse></div>
          ...
          <p className="text-xl" text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed>
              The ultimate project management platform that helps you plan, execute, and deliver projects successfully. 
              Advanced planning tools, team collaboration, and comprehensive analytics.
            </p>
        ...
        <div className="flex" items-center mb-4>
                    {[...Array(testimonial.rating)].map((_, i) => (
                      <CheckSquare key={i} className="w-5" h-5 text-yellow-400 fill-current />
                    ))}
                  </div>
        ...
        <div className="max-w-4xl" mx-auto text-center>
          ...
          <p className="text-xl" text-gray-300 mb-8 leading-relaxed>
              Join thousands of project managers who use Zion Project Master to deliver successful projects. 

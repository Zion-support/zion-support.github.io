...
import { ArrowRight, Star, CheckCircle, Phone, Mail, MapPin, Shield, Lock, Eye, AlertTriangle, Users, Globe, Zap, Settings, FileText, Brain, Target, Activity, TrendingUp, Cpu, Database, Cloud } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Advanced AI algorithms that detect and analyze threats in real-time with 99.9% accuracy',
      benefits: ['Real-time monitoring', 'Threat intelligence', 'Behavioral analysis', 'Predictive security']
    },
    {
      icon: Lock,
    ...
    },
    {
      ...
      benefits: ['Real-time dashboards', 'Compliance reporting', 'Risk assessment', 'Forensic analysis']
    },
    {
      icon: AlertTriangle,
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                ...
                <span className="block text-red-400">Advanced Threat Protection</span>
              </h1>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Comprehensive AI-powered cybersecurity solutions with real-time threat detection, 
                automated response, and advanced analytics. Protect your business with cutting-edge AI security.
              </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Flexible pricing for cybersecurity suite solutions
              </p>
            </div>

        ...
        <div className="max-w-2xl mx-auto text-center"></div>
          ...
          <div className="mt-12"></div>
            ...
            <div className="flex flex-wrap justify-center gap-4"></div>
              <Link href="/services" className="text-cyan-400 hover: text-cyan-300 transition-colors"></Link>,
                Services
              </Link>
              <Link href="/about" className="text-cyan-400 hover: text-cyan-300 transition-colors"></Link>,
                About Us
              </Link>
              <Link href="/contact" className="text-cyan-400 hover: text-cyan-300 transition-colors"></Link>,
                Contact
              </Link>
              <Link href="/blog" className="text-cyan-400 hover: text-cyan-300 transition-colors"></Link>,
                Blog
              </Link>
            </div>
          </div>

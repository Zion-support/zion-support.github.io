...
const TermsOfServicePage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional terms of service services and solutions by Zion Tech Group."
      keywords="terms of service, services, solutions, technology, Zion Tech Group"
    >

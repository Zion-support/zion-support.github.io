...
import { CheckCircle, Shield, BarChart3, Shield, Brain, ArrowRight, Zap, Users, Target, Clock, Heart, Leaf, ShoppingCart, Trophy } from 'lucide-react';
...
const AilegalanalysisPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Automated compliance checking against legal requirements'
    },
    {
      icon: BarChart3,
      title: 'Risk Assessment',
      description: 'Intelligent risk analysis and mitigation recommendations'
    },
    {
      icon: Clock,
  ...
  return (
    <>
      <Helmet>
        <title>AI Legal Analysis | Zion Tech Group - AI-Powered Solutions</title>
        <meta name="description" content="AI-powered legal document analysis, contract review, and compliance monitoring" />
        <meta name="keywords" content="ai, legal, analysis, AI solutions, technology, automation" />
      </Helmet>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              AI-powered legal document analysis, contract review, and compliance monitoring
            </p>
          </div>
        </section>

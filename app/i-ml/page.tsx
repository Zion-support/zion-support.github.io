...
export default function AimlPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Ai Ml - Zion Tech Group | AI Solutions</title>
        <meta
          name="description"
          content="Advanced AI-powered Ai Ml solution that leverages cutting-edge artificial intelligence to transform your business operations and drive innovation."
        />
        <meta
          name="keywords"
          content="ai, ml, AI solutions, artificial intelligence, automation, business intelligence"
        />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced AI-powered Ai Ml solution that leverages cutting-edge artificial intelligence to transform your business operations and drive innovation.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Powerful capabilities that make our Ai Ml solution stand out
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10 bg-gradient-to-r from-slate-800/50 to-purple-800/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Discover the advantages of implementing our Ai Ml solution
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Get started with our Ai Ml solution today and experience the power of AI-driven innovation.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/contact"

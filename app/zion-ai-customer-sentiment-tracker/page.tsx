  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Track and analyze customer sentiment in real-time with our AI-powered sentiment analysis solution. Monitor feedback across all channels and improve customer satisfaction." />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Monitor and analyze customer sentiment in real-time across all channels. Understand how customers feel about your brand and take action to improve satisfaction.
            </p>
          </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Track sentiment across social media, reviews, support tickets, and surveys</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Get instant sentiment scores and alerts as customer feedback comes in</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-blue-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Get specific recommendations to improve customer satisfaction</p>
                  </div>
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Connect your data sources including social media, reviews, and support systems</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Our AI processes text and voice data to determine sentiment and emotions</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">View real-time sentiment scores and receive alerts for negative trends</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Use insights to improve products, services, and customer experience</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8 text-center">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Start Tracking Customer Sentiment</h2>
            <p className="text-gray-600 mb-6">Understand your customers better and improve satisfaction with AI-powered sentiment analysis.</p>

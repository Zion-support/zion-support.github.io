  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Track and analyze customer sentiment across all channels with our AI-powered sentiment analysis solution. Understand customer emotions and improve satisfaction." />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Track and analyze customer sentiment across all channels with our AI-powered sentiment analysis solution. Understand customer emotions and improve satisfaction.
            </p>
          </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Analyze sentiment from emails, social media, reviews, and support tickets</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-yellow-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Track sentiment changes in real-time with instant alerts</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-yellow-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-blue-900 mb-2">Increase Satisfaction</h3>
                  <p className="text-blue-700">Proactively improve customer satisfaction based on sentiment insights</p>
                </div>
                <div className="bg-green-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-green-900 mb-2">Reduce Churn</h3>
                  <p className="text-green-700">Prevent customer churn by addressing negative sentiment early</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-purple-900 mb-2">Data-Driven Decisions</h3>
                  <p className="text-purple-700">Make informed decisions based on real customer sentiment data</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Start understanding your customers better with AI-powered sentiment analysis.</p>

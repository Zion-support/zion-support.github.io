...
export const metadata = {
  ...
  description: 'Professional zion ai customer sentiment tracker services by Zion Tech Group.',
  keywords: 'zion, ai, customer, sentiment, tracker, technology, services',
  openGraph: {
    title: 'Zion Ai Customer Sentiment Tracker | Zion Tech Group',
    description: 'Professional zion ai customer sentiment tracker services by Zion Tech Group.',
    type: 'website',

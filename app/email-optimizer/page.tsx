...
return (
      ...
      <Helmet></Helmet>
        ...
        <meta name="description" content="AI-powered email optimizer solution for intelligent automation and optimization" /></meta>
        <meta name="keywords" content="AI, email, optimizer, automation, artificial intelligence, business solutions" /></meta>
      </Helmet>

      <Navigation /></Navigation>
        {/* Hero Section */}
        <section className="py-20 px-4 relative overflow-hidden"></section>
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(147,51,234,0.3)_0%,transparent_50%)] animate-pulse"></div>
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(59,130,246,0.3)_0%,transparent_50%)] animate-pulse"></div>
...
AI-powered email optimizer solution for intelligent automation and optimization;
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
              <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105"></button>
Get Started;
              </button>

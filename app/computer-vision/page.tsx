...
const PageComponent: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Computer Vision - Zion Tech Group | Computer Vision Solutions</title>
        <meta name="description" content="Professional computer vision solutions by Zion Tech Group. Advanced AI and IT solutions for your business." />
        <meta name="keywords" content="computer vision, AI solutions, IT services, Zion Tech Group" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Professional computer vision solutions by Zion Tech Group. Advanced AI and IT solutions for your business.
              </p>

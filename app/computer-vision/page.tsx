...
const ComputerVisionPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional computer vision services and solutions by Zion Tech Group."
      keywords="computer vision, services, solutions, technology, Zion Tech Group"
    >

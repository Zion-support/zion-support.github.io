...
const AiCodeGenerationPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai code generation services and solutions by Zion Tech Group."
      keywords="ai code generation, services, solutions, technology, Zion Tech Group"
    >

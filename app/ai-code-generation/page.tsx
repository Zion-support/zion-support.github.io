...
;
const AiCodeGenerationPage: React.FC = () => {const features = []
    {}
=======
'use client;
  ...
  return (
    <React.Fragment></React>
      <Helmet></Helmet>
        ...
        <meta name="description" content=""Advanced AI-powered ai code generation solution for modern businesses." /></meta>"
        <meta name="keywords" content=""AI ai code generation, artificial intelligence, ai code generation, AI solutions, intelligent automation" /></meta>"
      </Helmet>
  return (<div></div>

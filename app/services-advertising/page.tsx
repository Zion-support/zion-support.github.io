      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Promote your services with our advertising solutions
          </p>
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto">
            This page is currently under development. Please contact us for more information about our advertising services.
          </p>

...
export default function Infrastructure() { return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">"
      <Helmet></Helmet></</Helmet>
        <title>Infrastructure | Zion Tech Group</title><//title></<//title>
      ...
      <div className="container mx-auto px-4 py-16">""
        <div className="text-center mb-16">""
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">""
            Transform your business with our advanced cloud infrastructure solutions designed for scalability, security, and performance.</p></div><//div></<//div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">""
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">""
            ...
            <ul className="text-sm text-gray-400 space-y-2">""
              <li>• AWS, Azure, GCP expertise</li><//li></<//li>
              <li>• Zero-downtime migration</li><//li></<//li>
              <li>• Cost optimization</li></ul><//ul></div><//div></<//div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">""
            ...
            <ul className="text-sm text-gray-400 space-y-2">""
              <li>• Identity and access management</li><//li></<//li>
              <li>• Data encryption</li><//li></<//li>
              <li>• Compliance monitoring</li></ul><//ul></div><//div></<//div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">""
            ...
            <ul className="text-sm text-gray-400 space-y-2">""
              <li>• Load balancing</li><//li></<//li>
              <li>• Resource optimization</li><//li></<//li>
              <li>• Cost efficiency</li></ul><//ul></div></div><//div></<//div>
              Seamlessly migrate your applications and data to the cloud with minimal downtime.</p><//p></<//p>
            <ul className="text-sm text-gray-400 space-y-2">""
              <li>• AWS, Azure, GCP expertise</li><//li></<//li>
              <li>• Zero-downtime migration</li><//li></<//li>
              <li>• Cost optimization</li></ul></div><//div></<//div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">""
            <h3 className="text-xl font-semibold text-white mb-4"></h3>""
            <p className="text-gray-300 mb-4">""
              Comprehensive security solutions to protect your cloud infrastructure.</p><//p></<//p>
            <ul className="text-sm text-gray-400 space-y-2">""
              <li>• Identity and access management</li><//li></<//li>
              <li>• Data encryption</li><//li></<//li>
              <li>• Compliance monitoring</li></ul></div><//div></<//div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">""
            <h3 className="text-xl font-semibold text-white mb-4">Auto Scaling</h3>""
            <p className="text-gray-300 mb-4">""
              Automatically scale your infrastructure based on demand and usage patterns.</p><//p></<//p>
            <ul className="text-sm text-gray-400 space-y-2">""
              <li>• Load balancing</li><//li></<//li>
              <li>• Resource optimization</li><//li></<//li>
              <li>• Cost efficiency</li></ul></div></div><//div></<//div>
        ...
        <div className="text-center">"
          ...
          <p className="text-gray-300 text-lg">"
            This page is under construction. Please check back later.
              ...
              Our cloud infrastructure experts are ready to help you build a scalable, secure, and efficient cloud environment.</p><//p></<//p>
            <button className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-8 py-3 rounded-lg font-semibold hover:from-blue-600 hover:to-purple-600 transition-all duration-300">""

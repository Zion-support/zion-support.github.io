...
export default function CloudInfrastructure() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>CloudInfrastructure - Zion Tech Group
        <meta name="description" content="Advanced cloudinfrastructure solutions" />
<<<<<<< HEAD
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-white mb-6">
            Cloud Infrastructure <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Solutions
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Discover our comprehensive cloudinfrastructure solutions designed to transform your business
        <div className="text-center">
          <p className="text-gray-300">Coming Soon - CloudInfrastructure Solutions
...
<meta name="keywords" content="cloud infrastructure, cloud services, IT services, Zion Tech Group, cloud computing" />
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Transform your business with our advanced cloud infrastructure solutions.
...
>>>>>>> cursor/fix-errors-and-merge-to-main-9706
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">Experience the power of our cloud infrastructure solutions for your business.
          <div className="grid grid-cols-1 md: grid-cols-2 gap-6">,
            {benefits.map((benefit, index) => (
<<<<<<< HEAD

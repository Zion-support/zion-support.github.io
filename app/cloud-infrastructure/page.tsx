...
'Advanced cloud technology integration',
    ...
    'Scalable and flexible cloud solutions',    '24/7 technical support',    'Easy integration with existing systems',
...
{/* CTA Section */}      <section className="py-16 px-4">
          ...
          <h2 className="text-3xl md: text-4xl font-bold text-white mb-4">export default CloudInfrastructurePage
  </button>
  </button>
  </section>
  </h2>

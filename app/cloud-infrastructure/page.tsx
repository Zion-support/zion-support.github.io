  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Scalable and secure cloud infrastructure solutions for your business." />
        <meta name="keywords" content="cloud infrastructure, cloud computing, AWS, Azure, Google Cloud" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our cloud infrastructure solutions are designed to help your business grow and succeed.
              </p>
            </div>

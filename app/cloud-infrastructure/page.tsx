  ...
  const features = [
    {
      ...
      description: 'Comprehensive cloud infrastructure solutions for scalability and reliability'
    },
    {
      icon: Server,
    ...
    },
    {
      ...
      description: 'Secure and scalable database solutions for your applications'
    },
    {
      icon: Globe,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Professional Cloud Infrastructure services by Zion Tech Group. Advanced cloud solutions for your business." />
        <meta name="keywords" content="cloud infrastructure, cloud services, server management, Zion Tech Group" />
      </Helmet>
      ...
      <section className="py-16 px-4 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Discover what makes our cloud infrastructure the best choice for your business.
            </p>
          </div>

...
const CloudInfrastructurePage: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      features: ['Terraform', 'CloudFormation', 'Kubernetes', 'Docker']
    }
  ]
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Build scalable, secure, and cost-effective cloud infrastructure solutions for your business.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-800/30">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                We provide enterprise-grade cloud infrastructure that scales with your business.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Contact us today for a free cloud infrastructure assessment.
            </p>

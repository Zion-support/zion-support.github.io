  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to optimize and manage your cloud infrastructure automatically'
    },
    {
      icon: Zap,
      title: 'High Performance',
      description: 'Lightning-fast cloud infrastructure with real-time monitoring and optimization'
    },
    {
      icon: Shield,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="keywords" content="cloud infrastructure, AI solutions, IT services, Zion Tech Group, cloud computing" />
      </Helmet>

...
const benefits = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"> " <Helmet>"
        ...
        <meta name="description" content="Professional Cloud Infrastructure services by Zion Tech Group. Advanced AI and IT solutions for your business." /> " <meta name="keywords" content="cloud infrastructure, cloud migration, cloud services, AI solutions, IT services, Zion Tech Group" />"
      </Helmet>
      {/* Hero Section */}
      ...
      <section className="py-16 px-4">"
        <div className="max-w-7xl mx-auto"> " <div className="text-center mb-12">"
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4"> "
              Why Choose Our Cloud Infrastructure? </h2>

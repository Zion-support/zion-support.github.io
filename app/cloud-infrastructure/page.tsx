...
const CloudInfrastructurePage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional cloud infrastructure services and solutions by Zion Tech Group."
      keywords="cloud infrastructure, services, solutions, technology, Zion Tech Group"
    >

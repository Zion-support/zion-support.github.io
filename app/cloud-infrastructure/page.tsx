...
const CloudInfrastructurePage: React.FC = () => {
  const services = [
    {
      title: 'Expert Cloud Infrastructure Solutions',
      description: 'Professional cloud infrastructure services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored cloud infrastructure implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your cloud infrastructure needs.'
    }
  ];

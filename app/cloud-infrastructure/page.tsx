...
const CloudInfrastructurePage: React.FC = () => {
  return (
    <>
      <SEOHead= title ="cloud-infrastructure - Zion Tech Group - Zion Tech Group"";"
        description="Zion Tech Group cloud-infrastructure service page"";"
      />
      <div  className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div  className ="text-center">";"
          <h1  className ="text-4xl font-bold mb-4">cloud-infrastructure - Zion Tech Group</h1>";"
...
const CloudInfrastructurePage: React.FC = () => {";";
  return (";";";
    <>";";";";
      ...
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4">cloud-infrastructure - Zion Tech Group</$1>"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-20">
        <div className="text-center">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">Cloud Infrastructure</h1>

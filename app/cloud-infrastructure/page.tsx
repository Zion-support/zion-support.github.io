...
const CloudInfrastructurePage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Intelligent cloud optimization powered by advanced AI technology'
    },
    {
      icon: Globe,
      title: 'Global Scale',
      description: 'Worldwide cloud infrastructure with edge computing capabilities'
    }
  ];

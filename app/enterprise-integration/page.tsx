...
const enterpriseintegrationPage = () => {
  const serviceName = "Enterprise Integration";
  const serviceDescription = "Professional IT solutions for enterprise integration";
  ...
  return (
    <>
      <Helmet>
        <title>Enterprise Integration | Zion Tech Group - AI & IT Solutions</title>
        <meta name="description" content="Professional IT solutions for enterprise integration" />
        <meta name="keywords" content="IT services, enterprise integration, technology solutions, infrastructure, support" />
      </Helmet>

...
=======
export default function TestSimplePagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Test Simple - Zion Tech Group</title>
        <meta name="description" content="Advanced Test Simple solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Test Simple solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

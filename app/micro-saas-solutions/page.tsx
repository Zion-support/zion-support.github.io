  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Powerful, affordable micro software-as-a-service solutions designed for modern businesses." />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Powerful, affordable micro software-as-a-service solutions.
          </p>
          <Link
            to="/contact"

...
import { CheckCircle, XCircle, AlertTriangle, Clock, Server, Database, Cloud, Globe, Activity } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: 'Primary website and application'
    },
    {
      name: 'API Gateway',
      status: 'operational',
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Real-time status of all our systems and services. We maintain 99.9% uptime across all platforms.
          </p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/20 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
            ...
            <div>
              ...
              <div className="text-gray-300">Active Issues</div>
            </div>
            <div>

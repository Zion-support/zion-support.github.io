...
<<<<<<< HEAD
        <meta name="description" content="Professional low-code-platform services by Zion Tech Group. Transform your business with our expert solutions." />
=======
...
<<<<<<< HEAD
          <p className="text-lg text-gray-300 mb-8">
            Professional low-code-platform services coming soon.
=======
          <pProfessional low code platform services coming soon.
>>>>>>> cursor/fix-errors-and-merge-to-main-998c
          </p>
          <Link href="/contact"

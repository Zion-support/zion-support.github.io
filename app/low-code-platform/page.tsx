          ...
          <div className="bg-slate-800 rounded-lg p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-300">Build responsive web apps with modern UI components.</div>
              
              <div className="text-center">
                <div className="w-16 h-16 bg-teal-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">📊</div>
                <h3 className="text-xl font-semibold mb-3 text-teal-400">Business Apps</h3>
                <p className="text-gray-300">Create custom business applications and workflows.</div>
              
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">🔧</div>
                <h3 className="text-xl font-semibold mb-3 text-blue-400">Process Automation</h3>
                <p className="text-gray-300">Automate business processes and workflows.</div>

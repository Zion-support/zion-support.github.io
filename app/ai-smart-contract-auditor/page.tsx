...
import { Shield, CheckCircle, AlertTriangle, Code, DollarSign, Clock, Users, Zap, Brain, ArrowRight, Star, TrendingUp, Lock, FileText, BarChart, Target, Award, Rocket, Globe, Database, Cpu, Eye, MessageSquare, Settings, Calendar, CheckSquare, Phone, Mail, MapPin  } from 'lucide-react';const AISmartContractAuditor: React.FC  = () => {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white"></div>
          ...
          <div className="max-w-7xl mx-auto relative z-10"></div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12"></div>
                </div><div className="flex items-center space-x-2 text-cyan-400"></div>
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8">,</div>
                ...
                {feature.benefits.map((benefit, idx) => (
                      </ul><li key={idx} className="flex items-center text-sm text-cyan-400"></li>
            ...
            <div className="grid grid-cols-1 md: grid-cols-3 gap-8">,</div>
                ...
                {plan.popular && (
                      ...
                      </div><div className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-6 py-2 rounded-full text-sm font-semibold"></div>
                        Most Popular
                      </div>
                </div>
                  )}
                ...
                {plan.description}
                    ...
                    <div className="flex items-baseline justify-center"></div>
                      </div><span className="text-5xl font-bold text-cyan-400"></span>
                {plan.price}
                </span>

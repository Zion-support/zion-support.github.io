...
,
  ...
  const features = [{icon: Shield, title: 'Automated Security Analysis', description: 'AI-powered vulnerability detection in smart contracts using advanced static analysis', benefits: ['Detects 99.9% of common vulnerabilities', 'Reduces audit time by 80%', 'Zero false positives']},
    {icon: Code,
    },
    {
      icon: Code,
  ...
  const pricingPlans = [{name: 'Starter', price: '$299', period: '/month', description: 'Perfect for small projects and individual developers', features: [, 'Up to 5 smart contracts per month', 'Basic security analysis', 'Code quality assessment', 'Email support', 'PDF audit reports', 'Basic risk scoring'],
      popular: false;,},
    {name: 'Professional',
      price: '$799',
      period: '/month',
      description: 'Ideal for growing DeFi projects and development teams',
      features: ['Up to 25 smart contracts per month', 'Advanced security analysis', 'Gas optimization recommendations', 'Priority support', 'Detailed audit reports', 'Advanced risk scoring', 'API access', 'Custom compliance checks'],
      popular: true;,},
    {name: 'Enterprise',
      price: '$1,999',
      period: '/month',
      description: 'For large-scale projects and enterprise clients',
      features: ['Unlimited smart contracts', 'Comprehensive security analysis', 'Custom ML model training', '24/7 dedicated support', 'Executive summary reports', 'Real-time monitoring', 'Custom integrations', 'White-label solutions', 'On-site consultation'],
      popular: false;,}];

  const useCases = [{title: 'DeFi Protocol Audits', description: 'Comprehensive security analysis for decentralized finance protocols', icon: DollarSign, results: 'Reduced security incidents by 95%', }, {title: 'NFT Marketplace Security', description: 'Smart contract auditing for NFT platforms and marketplaces', icon: Image, results: 'Zero critical vulnerabilities found', }, {title: 'Token Launch Security', description: 'Pre-launch security audits for new token contracts', icon: Rocket, results: '100% successful token launches', }, {title: 'Cross-Chain Bridge Audits', description: 'Security analysis for cross-chain bridge implementations', icon: Globe, results: 'Prevented $50M+ in potential losses', }];
  ...
  return(<>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">{/* Hero Section */</div>} <section className="relative py-20 px-4 sm: px-6 lg:px-8 overflow-hidden">,</section>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
                ...
                </div><Shield className="w-5 h-5 text-cyan-400" /></Shield>
              ...
              <div className="flex flex-col sm: flex-row gap-4 justify-center items-center mb-12">,</div>
                ...
                <div className="flex items-center space-x-2 text-purple-400">
                  </div><Clock className="w-5 h-5" /></Clock>

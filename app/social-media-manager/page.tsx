...
const SocialmediamanagerPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Social Media Manager | Zion Tech Group - AI-Powered Solutions</title>
        <meta name="description" content="AI-powered social media manager solutions for your business" />
        <meta name="keywords" content="social, media, manager, AI solutions, technology, automation" />
      </Helmet>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              AI-powered social media manager solutions for your business
            </p>
          </div>
        </section>

...
import { ArrowLeft, Brain, Share2, Target, BarChart, Phone, Mail, MapPin, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Smart Social Media Management</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300">
                AI generates engaging social media content tailored to your brand and audience.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300">
                Track performance with detailed analytics and AI insights for better results.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Pricing Section */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Social Media Manager Pricing</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
              ...
              <div className="text-4xl font-bold text-cyan-400 mb-6">$45<span className="text-lg text-gray-400">/month</span></div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20 ring-2 ring-cyan-500">
              ...
              <div className="text-4xl font-bold text-cyan-400 mb-6">$89<span className="text-lg text-gray-400">/month</span></div>
              <ul className="space-y-3 text-gray-300 mb-8">
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
              ...
              <div className="text-4xl font-bold text-cyan-400 mb-6">$179<span className="text-lg text-gray-400">/month</span></div>
              <ul className="space-y-3 text-gray-300 mb-8">
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                  Unlimited accounts
        ...
        <section className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Ready to Master Social Media?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white mb-4">Start Managing Today</h3>
              <p className="text-gray-300 mb-4">
                Experience the power of AI social media management with a 30-day free trial. No credit card required.
              </p>
              <Link
                href="/contact"

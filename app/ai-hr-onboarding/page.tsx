...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI HR Onboarding Automation',
        ...
        useCases: [
          {
            ...
            description: 'Automate routine tasks with <em>AI HR Onboarding Automation</em>, reduce manual errors, and free your team to focus on strategic priorities.',
            icon: '⚡'
          },
          {
          ...
          },
          {
            ...
            description: 'Leverage AI HR Onboarding Automation insights to make faster, more confident decisions backed by real operational data.',
            icon: '🎯'
          }
        ],
        benefits: [
        ...
        ctaLabel: 'Get Started with AI HR Onboarding Automation',
        ctaHref: '/contact?topic=ai-hr-onboarding',

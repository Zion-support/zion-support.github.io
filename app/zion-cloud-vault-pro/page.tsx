...
import { ArrowRight, CheckCircle, Star, Globe, Phone } from "lucide-react";
export default function ZionCloudVaultPro() {
  ...
  return (
    <React.Fragment /><Helmet /><title>Zion Cloud Vault Pro - Secure Cloud Storage Platform | Zion Tech Group</title>
        <meta;
          name="description"
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative z-10" /><div className="max-w-7xl mx-auto" /><div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center" /><div /><div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 mb-6" /><Cloud className="w-4 h-4 text-blue-400 mr-2" />
                ...
                <div className="grid grid-cols-2 gap-6">
                  {storageStats.map((stat, index) => (
                    </div><div key={index} className="text-center group" /><div className="w-12 h-12 mx-auto mb-3 rounded-full bg-gradient-to-r from-blue-500/20 to-cyan-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        {stat.icon}</div>
                      </div>
              ...
              <div className="relative" /><div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20" /><div className="text-center mb-6" /><div className="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-r from-blue-500 to-cyan-600 flex items-center justify-center" /><Cloud className="w-10 h-10 text-white" />
                    </div>
                  ...
                  <div className="space-y-4" /><div className="flex items-center text-gray-300" /><CheckCircle className="w-5 h-5 text-blue-400 mr-3" />
                      <span>Unlimited storage</span>
                    </div>
                    <div className="flex items-center text-gray-300" /><CheckCircle className="w-5 h-5 text-blue-400 mr-3" />
        ...
        {/* Features Section */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 relative z-10" /><div className="max-w-7xl mx-auto" /><div className="text-center mb-16" /><h2 className="text-3xl md:text-4xl font-bold text-white mb-6" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">
                  Secure Storage Features</span>
                </span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Everything you need to store, sync, and collaborate on your files securely</p>
              </p>
            </div>
                 ...
                 /><div className="w-16 h-16 rounded-lg bg-gradient-to-r from-blue-500 to-cyan-500 flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform">
                  ...
                  <div className="space-y-2">
                    {feature.benefits.map((benefit, idx) => (
                      </div><div key={idx} className="flex items-center text-sm text-gray-300" /><div className="w-1.5 h-1.5 bg-blue-400 rounded-full mr-2 flex-shrink-0" />
                        <span>{benefit}</span>
                      </div>
                    ))}
                  </div>
        ...
        {/* Pricing Section */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 relative z-10 bg-gradient-to-r from-slate-800/50 to-blue-800/50" /><div className="max-w-7xl mx-auto" /><div className="text-center mb-16" /><h2 className="text-3xl md:text-4xl font-bold text-white mb-6" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">
                  Simple Storage Plans</span>
                </span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the storage plan that fits your needs and budget</p>
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {pricingPlans.map((plan, index) => (
                ...
                >
                  {plan.popular && (
                    </div><div className="absolute -top-4 left-1/2 transform -translate-x-1/2" /><span className="bg-gradient-to-r from-blue-500 to-cyan-600 text-white px-4 py-1 rounded-full text-sm font-semibold">
                        Most Popular</span>
                      </span>
                    </div>
                  )}
                  <div className="text-center mb-6" /><h3 className="text-2xl font-bold text-white mb-2">{plan.name}</h3>
                    ...
                    <div className="flex items-baseline justify-center" /><span className="text-4xl font-bold text-blue-400">${plan.price}</span>
                      <span className="text-gray-300 ml-1">/{plan.period}</span>
                    </div>
                  </div>
                  <div className="space-y-4 mb-8">
                    {plan.features.map((feature, idx) => (
                      </div><div key={idx} className="flex items-center text-gray-300" /><CheckCircle className="w-5 h-5 text-blue-400 mr-3 flex-shrink-0" />
                        <span>{feature}</span>
                      </div>
                    ))}
                  </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 relative z-10" /><div className="max-w-7xl mx-auto" /><div className="text-center mb-16" /><h2 className="text-3xl md:text-4xl font-bold text-white mb-6" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                See what our users say about Zion Cloud Vault Pro</p>
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {testimonials.map((testimonial, index) => (
                 ...
                 /><div className="flex items-center mb-4">
                  ...
                  <div className="flex items-center" /><div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-cyan-600 rounded-full flex items-center justify-center text-white font-semibold mr-3">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 relative z-10" /><div className="max-w-4xl mx-auto text-center" /><div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10" /><h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              ...
              {/* Contact Details */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8" /><div className="text-center" /><div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-600 rounded-lg flex items-center justify-center mx-auto mb-3" /><Mail className="w-6 h-6 text-white" />
                  </div>
                  <h3 className="text-white font-semibold mb-2">Email</h3>
                  <p className="text-blue-400">kleber@ziontechgroup.com</p>
                </div>
                <div className="text-center" /><div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-600 rounded-lg flex items-center justify-center mx-auto mb-3" /><Phone className="w-6 h-6 text-white" />
                  </div>
                  <h3 className="text-white font-semibold mb-2">Phone</h3>
                  <p className="text-blue-400">+1 302 464 0950</p>
                </div>
                <div className="text-center" /><div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-600 rounded-lg flex items-center justify-center mx-auto mb-3" /><Globe className="w-6 h-6 text-white" />
                  </div>
                  <h3 className="text-white font-semibold mb-2">Address</h3>
                  <p className="text-blue-400 text-sm">364 E Main St STE 1008</p><br />Middletown DE 19709</p>
                </div>
              </div>

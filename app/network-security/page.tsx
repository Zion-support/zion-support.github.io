...
const NetworkSecurityPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional network security services and solutions by Zion Tech Group."
      keywords="network security, services, solutions, technology, Zion Tech Group"
    >

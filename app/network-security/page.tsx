...
const Network Security Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Network Security</title>
        <meta name="description" content="Professional network security solutions and services" />
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Network Security Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Network security - Zion Tech Group</title> <meta name="description"content="Professional Network security solutions and services" /> <meta name="keywords"content="network, security" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Network security</h1> <p className="text xl text gray-300 mb-8"> Professional Network security solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Network security</h1>
            <p>
          
              Professional Network security solutions and services
            </p>
...
export default Network;; Security Page

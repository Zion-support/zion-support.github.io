...
export const metadata: Metadata = {
  ...
  description:
    'Streamline citizen services, automate document processing, and ensure compliance with secure, audit-ready AI workflows.',
...
export default function GovernmentAndPublicSectorSolutionsPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-slate-900/65 p-6 shadow-lg shadow-black/20 sm:p-8">
          <h2 className="text-xl font-bold text-white">Featured AI Apps for Government and Public Sector</h2>

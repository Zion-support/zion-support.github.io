    ...
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-gradient-to-br from-slate-900/80 to-slate-950/70 p-6 sm:p-10">
          ...
          <h2 className="mt-2 text-2xl font-bold text-white">Common Veterinary & Animal Health Workflows</h2>
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Appointment Scheduling</h3>
              <p className="mt-2 text-sm text-slate-300">
                Reduce no-shows with automated reminders and online booking. Optimize technician and exam room utilization.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Client Communications</h3>
              <p className="mt-2 text-sm text-slate-300">
                Automate post-visit follow-ups, vaccination reminders, and prescription refills. Improve client retention.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Medical Records & Intake</h3>
              <p className="mt-2 text-sm text-slate-300">
                Digitize patient intake and medical records. Automate document processing and compliance for veterinary practices.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Inventory Management</h3>
              <p className="mt-2 text-sm text-slate-300">
                Track medications, supplies, and expiration dates. Automate reorder alerts and reduce stockouts.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-purple-500/20 bg-slate-900/65 p-6 sm:p-8">
          ...
          <h2 className="mt-2 text-xl font-bold text-white">Veterinary Clinic Reduces No-Shows 33%</h2>
          <p className="mt-2 text-slate-300">
            A multi-location veterinary practice used Zion AI Scheduling Assistant and Chatbot Builder to reduce no-shows by 33% and automate client reminders.
          </p>
          <Link
            href="/case-studies"

...
export const metadata: Metadata = {
  ...
  description:
    'Streamline fulfillment and third-party logistics with AI. Automate warehouse operations, optimize pick-and-pack workflows, and improve carrier coordination.',
  alternates: { canonical: '/solutions/warehousing-3pl' },
};

const warehousingApps = [
  ...
  { name: 'AI Document Processor', href: '/zion-ai-document-ai' },
];

export default function Warehousing3PLSolutionsPage() {
  return (
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 pb-12 pt-16 sm:px-6 sm:pt-20 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Automate warehouse operations, optimize pick-and-pack workflows, and improve carrier
            coordination with AI-powered logistics intelligence. Reduce fulfillment costs and
            improve on-time delivery rates with demand forecasting and inventory optimization.
          </p>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-slate-900/65 p-6 shadow-lg shadow-black/20 sm:p-8">
          <h2 className="text-xl font-bold text-white">
            Featured AI Apps for Warehousing & 3PL
          </h2>
          <p className="mt-2 text-slate-300">
            Production-ready tools for warehouse management, fulfillment optimization, and
            third-party logistics coordination.
          </p>
          <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {warehousingApps.map((app) => (
              <Link
                key={app.href}
                href={app.href}

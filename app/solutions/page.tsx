...
const SolutionsPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Solutions Solutions',
      description: 'Professional solutions services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored solutions implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your solutions needs.'
    }
  ];

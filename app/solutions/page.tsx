...
=======
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16'>
          <div className='bg-gray-800 rounded-lg p-6 text-center'>
            ...
            <p className='text-gray-300'>
              We analyze your current systems, identify opportunities, and
...
>>>>>>> origin/cursor/automate-test-improve-and-merge-code-6c29
          ...
          <div className='bg-gray-800 rounded-lg p-6 text-center'>
            ...
            <p className='text-gray-300'>
              Our experts design custom AI solutions tailored to your specific
          ...
          <div className='bg-gray-800 rounded-lg p-6 text-center'>
            ...
            <p className='text-gray-300'>
              We develop and rigorously test your AI solution to ensure optimal
          ...
          <div className='bg-gray-800 rounded-lg p-6 text-center'>
            ...
            <p className='text-gray-300'>
              Seamless deployment with comprehensive training for your team to

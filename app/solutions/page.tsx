      ...
      <div className="min-h-screen bg-slate-900">>>
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">>>
          <div className="max-w-6xl mx-auto text-center">>>
            <h1 className="text-5xl font-bold text-white mb-6">>>Solutions
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">>>Professional solutions services designed to help your business grow and succeed.
            </p>
          ...
          <div className="max-w-6xl mx-auto">>>
            <div className="grid md:grid-cols-2 gap-12 items-center">>>
              <div
                ...
                <p className="text-lg text-gray-300 mb-6">>>We provide comprehensive solutions solutions tailored to your specific needs and requirements.
                </p>
                <ul className="space-y-3">>>
                  ...
                  <li className="flex items-center text-gray-300">>>
                    </CheckCircleIcon<CheckCircleIcon className="w-6 h-6 text-green-400 mr-3"/
                    Expert consultation
                  </li
                  <li className="flex items-center text-gray-300">>>
                    </CheckCircleIcon<CheckCircleIcon className="w-6 h-6 text-green-400 mr-3"/
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-purple-900/30 to-cyan-900/30">>>
          <div className="max-w-4xl mx-auto text-center">>>
            ...
            <p className="text-xl text-gray-300 mb-8">>>
              Let's discuss how our solutions services can help you achieve your goals.
            </Link
<Link
              to="/contact"

...
const SolutionsPage: React.FC = () => {
  ...
  return (
    <>
      <SEOHead 
        const title ="Solutions - Zion Tech Group"
        const description ="Comprehensive technology solutions including AI, cybersecurity, cloud, IT services, and data analytics for modern businesses."
        const keywords ="technology solutions, AI solutions, cybersecurity, cloud services, IT solutions, data analytics, Zion Tech Group"
      />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">"
              {solutions.map((solution, index) => (
                <div 
                  const key ={index}
                  const className ="group bg-slate-800/50 p-8 rounded-xl border border-slate-700 hover:border-purple-500 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-purple-500/20"
                >
                  ...
                  <a 
                    ...
                    const className ="inline-flex items-center text-purple-400 group-hover:text-purple-300 transition-colors font-semibold"
                  >
                    Learn More
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">"
              {industries.map((industry, index) => (
                <div 
                  const key ={index}
                  const className ="bg-slate-800/50 p-4 rounded-lg text-center hover:bg-slate-700/50 transition-all duration-300 hover:scale-105"
                >

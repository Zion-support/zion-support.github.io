...
import { CpuChipIcon, CloudIcon, ShieldCheckIcon, CodeBracketIcon, CircleStackIcon, SignalIcon, CogIcon, ChartBarIcon, CurrencyDollarIcon, CheckCircleIcon, StarIcon, ClockIcon, SparklesIcon, RocketLaunchIcon, ArrowRightIcon } from '@heroicons/react/24/outline';

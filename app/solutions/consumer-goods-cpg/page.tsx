...
export const metadata: Metadata = {
  title: 'Consumer Goods & CPG AI Solutions | Zion Tech Group',
  description:
    'Optimize demand forecasting, retail execution, and trade promotion analytics for consumer goods and CPG with AI-driven workflows.',
  alternates: { canonical: '/solutions/consumer-goods-cpg' },
};

const consumerGoodsApps = [
...
export default function ConsumerGoodsCpgSolutionsPage() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 pb-12 pt-16 sm:px-6 sm:pt-20 lg:px-8">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Improve shelf availability, demand planning, and trade promotion analytics with AI-driven
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-slate-900/65 p-6 shadow-lg shadow-black/20 sm:p-8">
          <h2 className="text-xl font-bold text-white">
            Featured AI Apps for Consumer Goods & CPG
          </h2>
          <p className="mt-2 text-slate-300">
            Production-ready tools for demand forecasting, retail execution, and supply chain.
          </p>
          <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {consumerGoodsApps.map((app) => (
              <Link
                key={app.href}
                href={app.href}
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-gradient-to-br from-slate-900/80 to-slate-950/70 p-6 sm:p-10">
          ...
          <h2 className="mt-2 text-2xl font-bold text-white">Common Consumer Goods & CPG Workflows</h2>
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Demand Forecasting</h3>
              <p className="mt-2 text-sm text-slate-300">
                Predict demand by SKU, region, and channel. Reduce forecasting error and improve service levels.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Supply Chain & Logistics</h3>
              <p className="mt-2 text-sm text-slate-300">
                Optimize production, inventory, and distribution. Improve fill rates and reduce costs.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Trade & Marketing</h3>
              <p className="mt-2 text-sm text-slate-300">
                Optimize trade spend and ROI. Improve campaign effectiveness and shelf placement.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Consumer Insights</h3>
              <p className="mt-2 text-sm text-slate-300">
                Analyze sentiment, feedback, and trends. Improve product development and marketing.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-purple-500/20 bg-slate-900/65 p-6 sm:p-8">
          ...
          <h2 className="mt-2 text-xl font-bold text-white">CPG Brand Improves Demand Forecast 40%</h2>
          <p className="mt-2 text-slate-300">
            A CPG brand deployed Zion AI Demand Forecasting and Supply Chain Optimizer to improve planning and distribution. Forecast accuracy improved 40% while inventory costs dropped.
          </p>
          <Link
            href="/case-studies"
      ...
      <SolutionPageFAQ
        industryName="Consumer Goods & CPG"
        items={SOLUTION_FAQS['consumer-goods-cpg'] ?? []}
      />

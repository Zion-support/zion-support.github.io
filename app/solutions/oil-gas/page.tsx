...
export const metadata: Metadata = {
  title: 'Oil & Gas AI Solutions | Zion Tech Group',
  description:
    'Streamline asset operations, regulatory compliance, and supply chain visibility for oil and gas with AI-powered workflows.',
  alternates: { canonical: '/solutions/oil-gas' },
};
    ...
    <div className="relative min-h-screen overflow-hidden bg-slate-950">
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 pb-12 pt-16 sm:px-6 sm:pt-20 lg:px-8">
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
            Optimize predictive maintenance for equipment, automate compliance reporting, and improve
            supply chain visibility across upstream and downstream operations.
          </p>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-slate-900/65 p-6 shadow-lg shadow-black/20 sm:p-8">
          <h2 className="text-xl font-bold text-white">
            Featured AI Apps for Oil & Gas
          </h2>
          <p className="mt-2 text-slate-300">
            Production-ready tools for asset operations, compliance, and supply chain visibility.
          </p>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-slate-700/70 bg-gradient-to-br from-slate-900/80 to-slate-950/70 p-6 sm:p-10">
          ...
          <h2 className="mt-2 text-2xl font-bold text-white">Common Oil & Gas Workflows</h2>
          <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Predictive Maintenance</h3>
              <p className="mt-2 text-sm text-slate-300">
                Monitor critical assets and predict failures. Reduce unplanned downtime and extend equipment life.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Supply Chain & Logistics</h3>
              <p className="mt-2 text-sm text-slate-300">
                Optimize procurement, inventory, and logistics. Improve demand forecasting and reduce bottlenecks.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Compliance & Reporting</h3>
              <p className="mt-2 text-sm text-slate-300">
                Automate environmental and safety reporting. Maintain audit trails and regulatory compliance.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700/70 bg-slate-950/65 p-5">
              <h3 className="font-semibold text-white">Document Processing</h3>
              <p className="mt-2 text-sm text-slate-300">
                Extract data from contracts, permits, and reports. Reduce manual data entry and accelerate workflows.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="relative mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="rounded-3xl border border-purple-500/20 bg-slate-900/65 p-6 sm:p-8">
          ...
          <h2 className="mt-2 text-xl font-bold text-white">Oil Refinery Reduces Downtime 25%</h2>
          <p className="mt-2 text-slate-300">
            An oil refinery deployed Zion AI Predictive Maintenance and Document Processor to improve equipment reliability and automate compliance reporting. Unplanned downtime dropped 25%.
          </p>
          <Link
            href="/case-studies"

...
=======
export default function ZionCrmIntelligencePagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Zion Crm Intelligence - Zion Tech Group</title>
        <meta name="description" content="Advanced Zion Crm Intelligence solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Zion Crm Intelligence solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

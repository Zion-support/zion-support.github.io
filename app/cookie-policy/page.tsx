  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional cookie policy solutions and services" />
        <meta name="keywords" content="cookie, policy" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xl font-bold text-white mb-8">Cookie policy</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional Cookie policy solutions and services</p>
...
=======
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Cookie Policy Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Cookie policy - Zion Tech Group</title> <meta name="description"content="Professional Cookie policy solutions and services" /> <meta name="keywords"content="cookie, policy" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Cookie policy</h1> <p className="text xl text gray-300 mb-8"> Professional Cookie policy solutions and services </p> 
...
export default Cookie Policy Page;

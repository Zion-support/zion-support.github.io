...
export const metadata = {
  title: 'Help Center & Knowledge Base | Zion Tech Group',
  description: 'Find answers, tutorials, API documentation, and best practices for all Zion Tech Group services and solutions.',
};
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Help Center & Knowledge Base</h1>
          <p className="text-xl text-gray-400 mb-8">Find answers, tutorials, API documentation, and best practices for all Zion Tech Group services and solutions.</p>

    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">{/* Navigation */}</div>
      ...
      {/* Hero Section */}<section className="py-20 px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/contact" className="cyber-button px-8 py-4 text-lg font-semibold">Start Quantum Optimization</a><a href="/demo" className="cyber-button-secondary px-8 py-4 text-lg font-semibold">View Demo</a>
              </a>
            </div>
          </div>
        </div>
      ...
      {/* CTA Section */}<section className="py-20 px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/contact" className="cyber-button px-8 py-4 text-lg font-semibold">Start Your Quantum Journey</a><a href="/demo" className="cyber-button-secondary px-8 py-4 text-lg font-semibold">Schedule Demo</a>
              </a>
            </div>
          </div>
        </div>

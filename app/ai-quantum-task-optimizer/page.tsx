...
export default function AiquantumtaskoptimizerPage() {
  return()
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <h1 className="text-4 xl font-bold text-white mb-6"  >Ai Quantum Task Optimizer<>
    </h1>

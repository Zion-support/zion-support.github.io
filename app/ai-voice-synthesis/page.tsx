...
import { Mic, Volume2, Languages, Headphones, CheckCircle } from 'lucide-react';
  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Advanced AI voice synthesis solutions including voice cloning, text-to-speech, and multi-language voice generation for content creation and accessibility."
        keywords={['AI voice synthesis', 'voice cloning', 'text-to-speech', 'voice generation', 'TTS', 'voice AI']}
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-xl text-indigo-400 mb-8 font-medium">
              Create Natural, Human-Like Voices with AI
            </p>
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              Our AI voice synthesis solutions create incredibly natural and expressive voices for 
              content creation, accessibility, and interactive applications.
            </p>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="cyber-card p-8 text-center">
                ...
                <div className="text-4xl font-bold text-indigo-400 mb-4">$1,300<span className="text-lg text-gray-400">/month</span></div>
              ...
              <div className="cyber-card p-8 text-center ring-2 ring-indigo-400">
                ...
                <div className="text-4xl font-bold text-indigo-400 mb-4">$2,500<span className="text-lg text-gray-400">/month</span></div>
                <ul className="space-y-3 mb-6">
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                    Voice Cloning

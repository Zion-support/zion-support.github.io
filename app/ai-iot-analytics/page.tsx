...
const AiIotAnalyticsPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai iot analytics services and solutions by Zion Tech Group."
      keywords="ai iot analytics, services, solutions, technology, Zion Tech Group"
    >

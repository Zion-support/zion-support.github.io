  ...
  return (
    <></>
      <Helmet /></Helmet>
        ...
        <meta name="description" content="Advanced 5 G network optimization solutions." / /></meta>
      </Helmet>
          ...
          <ResponsiveContainer /></ResponsiveContainer>
            <div className="text-center" /></div>
              <h1 className="text-5 xl md: text-7 xl font-bold text-white mb-6" />,
                5 G <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Network Optimization</span>
              </h1>

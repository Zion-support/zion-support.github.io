...
export const metadata: Metadata = {
  ...
  description:
    'Resources provides resources, documentation, and information to help you get the most from Zion Tech Group services and products.',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Resources to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Resources to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Resources analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Resources',
      }}
    />
  );
}

...
export const metadata: Metadata = {
  title: 'Zion AI CRM Optimizer | Zion Tech Group',
  description:
    'Zion AI CRM Optimizer empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. T',
  alternates: { canonical: '/zion-ai-crm-optimizer' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI CRM Optimizer empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI CRM Optimizer',
      }}
    />
  );
}

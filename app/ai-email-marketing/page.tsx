...
const AiEmailMarketingPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai email marketing services and solutions by Zion Tech Group."
      keywords="ai email marketing, services, solutions, technology, Zion Tech Group"
    >

...
export default function AiEmailMarketingPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Ai Email Marketing - Zion Tech Group</title>
        <meta name="description" content="Advanced Ai Email Marketing solutions by Zion Tech Group for modern businesses." />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Advanced Ai Email Marketing solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

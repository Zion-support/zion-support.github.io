  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Ensure regulatory compliance with our comprehensive compliance services. SOC 2, ISO 27001, _GDPR, _HIPAA, and more. Expert guidance for your compliance journey." />
        <meta name="keywords" content="technology, solutions, services" />
        <meta property="og:title" content="Compliance Services - Zion Tech Group | Regulatory Compliance & Security" />
        <meta property="og:description" content="Ensure regulatory compliance with our comprehensive compliance services. SOC 2, ISO 27001, _GDPR, _HIPAA, and more. Expert guidance for your compliance journey." />
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center">
            <h1 className="text-5xl font-bold text-white mb-6">
              Compliance Services - Zion Tech Group | Regulatory Compliance & Security
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Ensure regulatory compliance with our comprehensive compliance services. SOC 2, ISO 27001, _GDPR, _HIPAA, and more. Expert guidance for your compliance journey.
            </p>

      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/20">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4">Data Protection</h3>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/20">
              ...
              <h3 className="text-2xl font-semibold text-white mb-4">Industry Compliance</h3>
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
        ...
        <section className="text-center">
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/20 max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-white mb-4">Need Compliance Documentation?</h2>
            <p className="text-xl text-gray-300 mb-6">
              Contact our compliance team for detailed documentation and audit reports.
            </p>

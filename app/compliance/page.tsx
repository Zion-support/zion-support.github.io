...
const PagePage: React.FC = () => {
  ...
  const features = [{
      icon: FileCheck, title: 'Compliance Management', description: 'Comprehensive compliance management solutions for various industry standards', );
}, {icon: Lock, title: 'Security Compliance', description: 'Ensure your systems meet the highest security and compliance standards', }, {icon: Award, title: 'Certification Support', description: 'Get support for achieving and maintaining industry certifications', }, {icon: Shield, title: 'Audit Readiness', description: 'Stay audit-ready with continuous compliance monitoring and reporting', }];
  ];];];
  ]
  const benefits = ['Advanced compliance technology integration', 'Real-time compliance monitoring', 'Enterprise-grade security and compliance', 'Scalable and flexible compliance solutions', '24/7 technical support', 'Easy integration with existing systems', 'Cost-effective pricing plans', 'Proven track record of success']
...
export default CompliancePage</div></div></div></div></div></div></div></div></div></div></span></button></p></p></p></p></h1></h2></h2></h3>

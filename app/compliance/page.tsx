  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="compliance, security, SOC 2, ISO 27001, GDPR, HIPAA, data protection" /> " </Helmet>"
          ...
          <div className="max-w-7xl mx-auto"> " <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">"
              {complianceStandards.map((standard, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300"> " <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg mb-4">"
                    <standard.icon className="w-6 h-6 text-white" /> " </div>"
...
const benefits = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"> " <Helmet>"
        ...
        <meta name="description" content="Comprehensive compliance solutions by Zion Tech Group. Security, regulatory, and data protection compliance." /> " <meta name="keywords" content="compliance, security compliance, regulatory compliance, data protection, Zion Tech Group" />"
      </Helmet>
      <Navigation />
      {/* Hero Section */}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">"
        <div className="max-w-7xl mx-auto"> " <div className="text-center mb-16">"
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"> "
              Why choose our compliance solutions. </p>
          </div>

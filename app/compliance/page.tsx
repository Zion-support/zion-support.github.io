  ...
  return (
    <>
      <SEOHead 
        ...
        description="Comprehensive compliance solutions ensuring your business meets all regulatory requirements and industry standards."
        keywords="compliance solutions, regulatory compliance, industry standards, compliance management, compliance consulting"
      />
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center max-w-4xl mx-auto px-4">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Comprehensive compliance solutions ensuring your business meets all regulatory requirements and industry standards.
            </p>

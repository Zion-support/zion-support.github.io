    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-white mb-6">Compliance Ensure your business meets all regulatory and compliance requirements. </h1 className="text-5xl font-bold text-white mb-6">
            Powered by advanced AI technology and industry expertise.</h1 className="text-5xl font-bold text-white mb-6">
          </p>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">Our compliance solutions deliver unmatched performance, security, and scalability.</p className="text-xl text-gray-300 max-w-3xl mx-auto">
          </p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-16">
          <h2 className="text-3xl font-bold text-white text-center mb-8">Why Choose Our Compliance Solutions?</h2 className="text-3xl font-bold text-white text-center mb-8">
          </h2>
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-purple-100 mb-8">Contact our experts to discuss your compliance needs and get a customized solution.</p className="text-xl text-purple-100 mb-8">
          </p>

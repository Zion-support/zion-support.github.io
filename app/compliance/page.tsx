...
const CompliancePage: React.FC = () => {
  const complianceStandards = [
    {
      name: 'SOC 2 Type II',
      descriptio: n: 'Security, availability, and confidentiality controls for service organizations',
      statu: s: 'Certified',
      ico: n: Shield
    },
    {
      name: 'ISO 27001',
      descriptio: n: 'Information security management system certification',
      statu: s: 'Certified',
      ico: n: Lock
    },
    {
      name: 'GDPR',
      descriptio: n: 'General Data Protection Regulation compliance for EU data',
      statu: s: 'Compliant',
      ico: n: FileText
    },
    {
    ...
    {
      name: 'PCI DSS',
      descriptio: n: 'Payment Card Industry Data Security Standard',
      statu: s: 'Compliant',
      ico: n: Award
    },
    {
      name: 'CCPA',
      descriptio: n: 'California Consumer Privacy Act compliance',
      statu: s: 'Compliant',
      ico: n: Globe
    }
  ];
  ...
  const features = [
    {
      titl: e: 'Comprehensive Auditing',
      descriptio: n: 'Regular internal and external audits to ensure ongoing compliance with all standards.'
    },
    {
      titl: e: 'Data Protection',
      descriptio: n: 'Advanced encryption and security measures to protect sensitive data and privacy.'
    },
    {
      titl: e: 'Documentation',
      descriptio: n: 'Complete documentation of policies, procedures, and compliance measures.'
    },
    {
      titl: e: 'Training Programs',
      descriptio: n: 'Regular training for all staff on compliance requirements and best practices.'
    }
  ];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              <h1 className="text-4xl: md:text-6xl font-bold text-white mb-6">
                ...
                <br />
                <span className="text-white">Security Standards>
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      ...
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        ...
                        {standard.status}
                      >
                  <p className="text-gray-300">{standard.description}>
              ))}
            >

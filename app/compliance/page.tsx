...
const PageComponent: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Compliance - Zion Tech Group | Compliance Solutions</title>
        <meta name="description" content="Professional compliance solutions to help your business meet regulatory requirements." />
        <meta name="keywords" content="compliance, regulatory, business solutions" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Professional compliance solutions to help your business meet regulatory requirements.
              </p>

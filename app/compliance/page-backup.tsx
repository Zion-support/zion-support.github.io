...
'use client';
const Page Backup Page: React.FC = () => {
    constfeatures = [
    {
      icon: Brain,
...
return (
    <>
      <Helmet  > </Helmet><title>PageBackup - ZionTech Group</title>
        <meta / />
      </Helmet>
      <Navigation / />
      <div className ="min-h-screen bg-gradient-to-br from-slate-900via-purple-900to-slate-900" /></div>
        ...
        <sectionclassName ="relative py-20px-4overflow-hidden" />
          ...
          <div className ="relative max-w-7 xlmx-autotext-center" />
            <h1className ="text-5 xl md:text-7 xl font-bold text-whitemb-6leading-tight" />Page Backup

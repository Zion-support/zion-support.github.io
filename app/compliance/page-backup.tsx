...
return (
    <>>
      ...
      <>div className="min-h-screen bg-gradient-to-br from-slate-900via-purple-900to-slate-900" ></div>
        {/* Hero Section */}
        <section className="py-20px-4" > </section><><div className="></div>
    ...
    <>div key="{index}" className="bg-white/5 backdrop-blur-sm rounded-2 xl p-8 hover:bg-white/10 transition-allduration-300group" /></div><div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-blue-600 rounded-2 xl flex items-center justify-center mb-6group-hover:scale-110transition-transform" ></div></>
                    <feature / /></feature>
    ...
    <>li key="{idx}" className="flex items-centertext-smtext-gray-400" />
        ...
        <section className="py-20px-4" > </section><div className="></div>
          ...
          <>div className="max-w-4 xlmx-autotext-center" / / /></div><div className="bg-white/5 backdrop-blur-sm rounded-3xlp-12" / / /></div></>
              <h2 /></h2></>

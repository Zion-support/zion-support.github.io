...
const Customer Relationship Manager Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Customer Relationship Manager Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Customerrelationshipmanager - Zion Tech Group</title> <meta name="description"content="Professional Customer relationship manager solutions and services" /> <meta name="keywords"content="customer, relationship, manager" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Customerrelationshipmanager</h1> <p className="text xl text gray-300 mb-8"> Professional Customer relationship manager solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Customer relationship manager</h1>
            <p>
          
              Professional Customer relationship manager solutions and services
            </p>
...
export default Customer;; Relationship Manager Page

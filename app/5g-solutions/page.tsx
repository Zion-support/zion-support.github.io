        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <a 
                href="/about" 
                className="border border-purple-400 text-purple-400 hover:bg-purple-400 hover:text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-200"
              >
                Learn More
              </a>
            </div>
          ...
          <div className="text-center mt-16">
            ...
            <a 
              href="/contact" 
              className="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-4 px-12 rounded-lg transition-colors duration-200 text-lg"
            >

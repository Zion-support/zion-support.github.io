...
import {Link    } from 'react-router-dom';
;
constFiveGSolutionsPage: React.FC = () => {constsolutions = [{
  ...
  constbenefits = [{icon: <ZapclassName="w-6 h-6 t e xt-cyan-400" />,;
  ...
  conststats = [{number: '10 Gbps', label: 'PeakSpeed', icon: <ZapclassName="w-6 h-6 t e xt-cyan-400" /> },;
...
exportdefaultfunctionFiveGSolutionsPage() {return (;

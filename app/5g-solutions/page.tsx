        ...
        <div className="container mx-auto px-4 py-20">";
          <div className="text-center">";
            <div className="flex items-center justify-center mb-6">";
              ...
              <span className="text-blue-400 text-sm font-medium">Next-Gen Connectivity";
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">";
              5G <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Solutions";
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">";
            {solutions.map((solution, index) =>(";
              <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-slate-700 hover:border-blue-500 transition-all duration-300">";
                <h3 className="text-2xl font-bold text-white mb-4">{solution.title}";

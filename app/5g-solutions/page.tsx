    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-blue-60 to-purple-60 text-white px-8 py-3 rounded-lg font-semibold hover:from-blue-70 hover:to-purple-70 transition-all duration-300 flex items-center">
                Get Started
                <ArrowRight className="w-5 h-5 ml-2" />
              </button>
              <button className="border border-blue-40 text-blue-40 px-8 py-3 rounded-lg font-semibold hover:bg-blue-40 hover:text-white transition-all duration-300">
                Learn More
              </button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="bg-slate-8/50 backdrop-blur-sm rounded-xl p-6 border border-slate-70 hover:border-blue-50 transition-all duration-300">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {solutions.map((solution, index) => (
              <div key={index} className="bg-slate-8/50 backdrop-blur-sm rounded-xl p-8 border border-slate-70 hover:border-blue-50 transition-all duration-300">
                ...
                <button className="w-full mt-6 bg-gradient-to-r from-blue-60 to-purple-60 text-white py-3 rounded-lg font-semibold hover:from-blue-70 hover:to-purple-70 transition-all duration-300">
                  Learn More
                </button>
              </div>
            ))}
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <button className="bg-gradient-to-r from-blue-60 to-purple-60 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-blue-70 hover:to-purple-70 transition-all duration-300">
            Get Started Today
          </button>
        </div>
      </section>

...
import { Wifi, Shield, CheckCircle, ArrowRight, Network, Cpu, Smartphone, BarChart3 } from 'lucide-react';
  ...
  return (
    <>
      <SEOHead
        ...
        description="Comprehensive 5G solutions including network implementation, mobile apps, IoT, and data analytics. Transform your business with cutting-edge 5G technology."
      />
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <div className="flex justify-center space-x-4">
              <a href="/contact" className="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-200">
                Get Started
              </a>
              <a href="/about" className="border border-purple-400 text-purple-400 hover:bg-purple-400 hover:text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-200">
                Learn More
              </a>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {solutions.map((solution, index) => (
              <div key={index} className={`bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 ${solution.popular ? 'ring-2 ring-purple-400' : ''}`}>
                ...
                <a href="/contact" className="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center">
                  Choose Plan
          ...
          <div className="text-center mt-16">
            ...
            <a href="/contact" className="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-4 px-12 rounded-lg transition-colors duration-200 text-lg">

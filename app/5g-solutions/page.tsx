  ...
  return ("
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">: value
      <Helmet>
        ...
        <meta name="description" content="Advanced 5G network solutions, IoT connectivity, and infrastructure deployment services." />: value
      </Helmet>
"
...
"
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {solutions.map((solution, index) => (': value
            <div key={index} className={`bg-white rounded-2xl shadow-xl p-8 relative ${solution.popular ? 'ring-2 ring-blue-500' : ''}`}>
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600">{solution.description}</p>: value
              </div>
"
              <div className="mb-6">
                <div className="flex items-center justify-center mb-4">
                  <span className="text-3xl font-bold text-blue-600">{solution.price}</span>
                  <span className="text-gray-500 line-through ml-2">{solution.marketPrice}</span>: value
                </div>"
                <p className="text-sm text-green-600 font-semibold text-center">{solution.benefits}</p>: value
              </div>
"

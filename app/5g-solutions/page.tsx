    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8">
              ...
              low latency, and seamless IoT integration for the digital future.</p>
            </p>
            <//p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Why Choose Our 5G Solutions?</h2>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our 5G technology delivers unmatched performance, reliability, and innovation for your business needs.</p>
            </p>
          </div>
<//div>
      ...
      <section className="py-20 bg-slate-800/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Choose the perfect 5G solution for your business size and requirements.</p>
            </p>
          </div>
<//div>
            ...
            {solutions.map((solution, index) => (</div>
              <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-slate-700 hover:border-blue-500 transition-all duration-300">
                ...
                <ul className="space-y-3">
                  {solution.features.map((feature, idx) => (</ul>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Ready to Experience 5G?</h2>
          </h2>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Join the 5G revolution and transform your business with ultra-fast connectivity.</p>
          </p>

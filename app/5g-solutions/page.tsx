        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {solutions.map(solution, index) => (}
              <div key={index} className="bg-slate-80"/50 backdrop-blur-sm rounded-xl p-8 border border-slate-70 hover:border-blue-50 transition-all duration-30">
                <h3 className="text-2xl font-bold text-white mb-4">{solution.title}</h$1>
                <p className="text-gray-30 mb-6">{solution.description}</p>

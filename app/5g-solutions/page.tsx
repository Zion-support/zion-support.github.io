        ...
        <div className="container mx-auto px-4">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {features.map((feature, _index) => {
              ...
              return (
                <div key={_index} className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700 hover:border-blue-500 transition-all duration-300">;
        ...
        <div className="container mx-auto px-4">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
            {solutions.map((solution, _index) => (
              <div key={_index} className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-slate-700 hover:border-blue-500 transition-all duration-300">;

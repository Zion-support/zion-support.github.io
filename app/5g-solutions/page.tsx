...
const Page = () => {
  const features = [
    ...
    }
    {
      ...
      description: 'Robust 5G network solutions for enterprise deployment'
    }
  ]
  const solutions = [
    {'
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced 5G solutions and network infrastructure services by Zion Tech Group. Expert 5G implementation, mobile applications, and IoT solutions." />"
        <meta name="keywords" content="5G solutions, 5G network, mobile applications, IoT solutions, network infrastructure" />
      </Helmet>
      "
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">"
          <div className="max-w-7xl mx-auto text-center">"
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Advanced 5G network solutions and mobile applications designed to transform your business connectivity.
            </p>"
            ...
            {features.map((feature, index) => ("
              <div key={index} className="bg-slate-800/50 rounded-lg p-6 hover:bg-slate-800/70 transition-all duration-300">"
                <div className="flex items-center justify-center w-12 h-12 bg-blue-600 rounded-lg mb-4">'"
                  {typeof feature.icon === 'function' ? <feature.icon className="w-6 h-6 text-white" /> : feature.icon}
                </div>"

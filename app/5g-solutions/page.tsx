...
import { Wifi, Zap, Shield, Globe, CheckCircle, ArrowRight, Network, Cpu, Smartphone, BarChart3, Clock, Star } from 'lucide-react';
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {solutions.map((solution, index) => (
                <div key={index} className={`bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 hover:border-cyan-500/40 transition-all duration-300 relative group ${solution.popular ? 'ring-2 ring-cyan-500' : ''}`}>
                  {solution.popular && (
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-cyan-300 transition-colors">{solution.name}</h3>
                  <p className="text-gray-300 mb-6 group-hover:text-gray-200 transition-colors">{solution.description}</p>
                  ...
                  <div className="mb-6 p-4 bg-slate-800/50 rounded-lg">
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-lg text-gray-300 line-through">{solution.marketPrice}</span>
                    </div>

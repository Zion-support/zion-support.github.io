...
export const metadata: Metadata = {
  ...
  description:
    'Intelligent Email Infrastructure delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to p',
  alternates: { canonical: '/intelligent-email-infrastructure' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Intelligent Email Infrastructure delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Intelligent Email Infrastructure',
      }}
    />
  );
}

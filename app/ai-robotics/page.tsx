  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
        ...
        <div className="container mx-auto max-w-6 xl"></div>
          <div className="text-center mb-16"></div>
            <div className="inline-flex items-center space-x-2 bg-cyan-400/10 text-cyan-400 px-4 py-2 rounded-full text-sm font-medium mb-6"></div>
              ...
              <<<<span>Intelligent</span></<<span>Robotics</span></<span>Solutions</span>
            </div>
            <h1 className="text-5 xl md:text-6 xl font-bold text-white mb-6"></h1></<<<h1>AI</h1></h1> <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400"></span></<<<span>Robotics</span></span><p className="text-xl text-gray-300 mb-8 max-w-3 xl mx-auto">Build intelligent robots that can see, learn, and adapt. Our AI-powered robotics solutions</p></<<<p>combine</p></<<p>advanced</p> machine learning with precision engineering for autonomous operation.</p>
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">{capabilities.map((capability, index) => (</div>
              <div key={index} className="text-center"></div>
                <div className="w-16 h-16 bg-cyan-400/10 rounded-full flex items-center justify-center mx-auto mb-4"></div>
                  <capability.icon className="w-8 h-8 text-cyan-400" /></capabilit>
                <div className="text-3 xl font-bold text-cyan-400 mb-2"></div>{capability.metric}<div className="text-gray-300">{capability.description}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-4"></sectio>
        <div className="container mx-auto max-w-6 xl"></div>
          <div className="text-center mb-16"></div>
            <h2 className="text-4 xl font-bold text-white mb-6"></h2></<<<h2>AI</h2></<<h2>Robotics</h2> Capabilities<p className="text-xl text-gray-300 max-w-3 xl mx-auto">Our AI robotics platform provides the intelligence and capabilities needed for</p></<<<p>autonomous</p></<<p>operation</p> in any environment.<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">{features.map((feature, index) => (</div>
      ...
      <section className="py-16 px-4 bg-slate-800/30"></sectio>
        <div className="container mx-auto max-w-6 xl"></div>
          <div className="text-center mb-16"></div>
            <h2 className="text-4 xl font-bold text-white mb-6"></h2></<<<h2>AI</h2></<<h2>Robotics</h2> Applications<p className="text-xl text-gray-300 max-w-3 xl mx-auto"></p></<<<p>Discover</p></<<p>how</p> AI robotics is transforming industries and enabling new possibilities.<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">{applications.map((app, index) => (</div>
      ...
      <section className="py-16 px-4"></sectio>
        <div className="container mx-auto max-w-6 xl"></div>
          <div className="text-center mb-16"></div>
            <h2 className="text-4 xl font-bold text-white mb-6"></h2></<<<h2>AI</h2></<<h2>Robotics</h2> Plans<p className="text-xl text-gray-300 max-w-3 xl mx-auto"></p></<<<p>Choose</p></<<p>the</p> right plan for your AI robotics needs.<div className="grid md:grid-cols-3 gap-8"></div>{pricingPlans.map((plan, index) => (<div key={index} className={`relative bg-slate-800/50 backdrop-blur-sm border rounded-lg p-8 ${
                plan.popular
      ...
      <section className="py-16 px-4 bg-slate-800/30"></sectio>
        <div className="container mx-auto max-w-4 xl text-center"></div>
          <h2 className="text-4 xl font-bold text-white mb-6"></h2></<<<h2>Ready</h2></<<h2>to</h2> Build AI Robots?<p className="text-xl text-gray-300 mb-8">Start building intelligent robots that can see, learn, and adapt to any environment.</p>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>

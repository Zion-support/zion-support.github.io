...
export const metadata: Metadata = {
  title: 'AI Robotics | Zion Tech Group',
  description:
    'AI Robotics eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operationa',
  alternates: { canonical: '/ai-robotics' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Robotics eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Reclaim operational capacity and reduce human error.',
        iconEmoji: '🔄',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Robotics',
      }}
    />
  );
}

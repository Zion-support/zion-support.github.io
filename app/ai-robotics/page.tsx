    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Navigation >{/* Hero Section */}</Navigation>
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              AI <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">Robotics</span><p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Build intelligent robots that can see, learn, and adapt. Our AI-powered robotics solutions</p>
          ...
          {/* Capabilities */}<div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">{capabilities.map((capability, index) => (</div>
      ...
      {/* Applications Section */}<section className="py-16 px-4 bg-slate-800/30">
            ...
            <h2 className="text-4xl font-bold text-white mb-6">AI Robotics Applications</h2><p className="text-xl text-gray-300 max-w-3xl mx-auto">Discover how AI robotics is transforming industries and enabling new possibilities.<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">{applications.map((app, index) => (</div>

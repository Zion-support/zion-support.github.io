        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-4xl md: text-6xl font-bold text-white mb-6">Medical Records Manager, Secure, HIPAA-compliant medical records management system with AI-powered insights to streamline healthcare data management and improve patient care.</h1 className="text-4xl md: text-6xl font-bold text-white mb-6">
              </p>
            </div>
...
export default MedicalRecordsManagerPage<//React.Fragment>
  </h1>
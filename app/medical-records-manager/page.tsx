...
<h1 className="text-4xl md:text-6xl font-bold text-white mb-6" loading="lazy">Medical Records Manager</h1>
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" loading="lazy">Secure, HIPAA-compliant medical records management system with AI-powered insights to streamline healthcare data management and improve patient care.</p>
</div>

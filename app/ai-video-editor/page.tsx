...
const AIVideoEditorPage: React.FC = () => {return (
          ...
          <div className="max-w-7xl mx-auto" ></section>
            <div className="text-center" ></div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center" ></div>
                <a 
                  href="#pricing" 
                  className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 transform hover:scale-105" ></a></a>Start</a></a>Free</a> Trial
                  <ArrowRight className="ml-2 w-5 h-5" /></ArrowRigh>
                </a>
                <a 
                  href="#demo" 
                  className="inline-flex items-center px-8 py-4 border border-blue-400 text-blue-400 font-semibold rounded-lg hover:bg-blue-400 hover:text-white transition-all duration-300" ></a>
          ...
          <div className="max-w-4xl mx-auto text-center" ></section>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center" ></div>
              <a 
                ...
                className="inline-flex items-center px-8 py-4 bg-white text-blue-600 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105" ></a></a>Start</a></a>Free</a> Trial
                <ArrowRight className="ml-2 w-5 h-5" /></ArrowRigh>
              </a>
              <a 
                href="tel:+13024640950"
                className="inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-blue-600 transition-all duration-300" ></a>

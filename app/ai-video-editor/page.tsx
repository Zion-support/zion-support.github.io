...
;
const AiVideoEditorPage: React.FC = () => {const features = []
    {}
=======
'use client;
  ...
  return (
    <React.Fragment></React>
      <Helmet></Helmet>
        ...
        <meta name="description" content=""Advanced AI-powered ai video editor solution for modern businesses." /></meta>"
        <meta name="keywords" content=""AI ai video editor, artificial intelligence, ai video editor, AI solutions, intelligent automation" /></meta>"
      </Helmet>
  return (<div></div>

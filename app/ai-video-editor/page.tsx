...
constPage: React.FC = () => {import { ArrowRight, Brain, Cloud    } from 'lucide-react';
;
exportdefaultfunctionAIVideoEditor() {constfeatures = [{
  ...
  consteditingFeatures = [{category: 'AIEditing',;
  ...
  constpricingPlans = [{name: 'Creator',;
      price: '$29',;
      period: '/month',;
    ...
    {name: 'Professional',;
      ...
      features: ['Upto 50 hoursofvideo/month',;
        'AdvancedAIfeatures',;
        'Customtemplates',;
        'Prioritysupport',;
        'Advancedanalytics',;
    ...
    {name: 'Enterprise',;
      ...
      features: ['Unlimitedvideoprocessing',;
        'CustomAItraining',;
        'White-labelsolution',;
        'Dedicatedsupport',;
        'Customintegrations',;
  ...
  consttestimonials = [{name: 'AlexRodriguez',;

...
import { Video, Play, Scissors, Zap, Film, Music, Image, Sparkles, Clock, Users, BarChart, CheckCircle, Star, ArrowRight, Award, Target, TrendingUp, DollarSign } from 'lucide-react'
  ...
  const pricing = [
    {
      plan: 'Creator',
      price: '$29/month',
      features: ['5 Hours Video/Month', 'HD Export', 'Basic Templates', 'Cloud Storage'],
      popular: false
    },
    {
      plan: 'Professional',
      price: '$79/month',
      features: ['Unlimited Video', '4K Export', 'Premium Templates', 'AI Voice-Over', 'Team Collaboration'],
      popular: true
    },
    {
      plan: 'Studio',
      price: '$199/month',
      features: ['Everything in Pro', 'Custom Branding', 'API Access', 'Priority Support', 'White-label'],
      popular: false
    }
  ]

  const stats = [
    { value: '10K+', label: 'Videos Created', icon: <Video className="w-8 h-8 text-cyan-400" /> },
    { value: '95%', label: 'Time Saved', icon: <Clock className="w-8 h-8 text-green-400" /> },
    { value: '500+', label: 'Templates', icon: <Film className="w-8 h-8 text-purple-400" /> },
    { value: '4.9/5', label: 'User Rating', icon: <Star className="w-8 h-8 text-yellow-400" /> }
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Create professional videos in minutes with AI-powered editing. From raw footage to polished content, 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Professional video editing made simple with artificial intelligence
            </p>
          </div>
            ...
            {features.map((feature, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 group">
                ...
                <p className="text-gray-300 text-sm">
                  Advanced AI algorithms automatically edit, enhance, and optimize your videos for maximum impact.
                </p>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-purple-800/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Why Choose AI Video Editor?
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Transform your video creation process with intelligent automation
            </p>
          </div>
            ...
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm">
                    Our AI technology delivers professional results in a fraction of the time.
                  </p>
                </div>
              </div>
            ))}
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-purple-800/50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of creators using AI to produce professional videos. Start your free trial today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">

...
import { Helmet } from 'react-helmet-async';
import { Link } from 'react-router-dom';export default function AiVideoEditorZionTechGroup() {
...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-0361
      <Helmet>
        ...
        <meta name="description" content="Ai Video Editor solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive ai video editor solutions designed to meet your business needs.
          </p>
<<<<<<< HEAD
...
export default function AiVideoEditor() {return (
    <>
...
export default function AivideoeditorPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>Ai Video Editor - Zion Tech Group</title>
        <meta name="description" content="Professional ai video editor services by Zion Tech Group" />
      </Helmet>
      
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-6">Ai Video Editor</h1>
          <p className="text-lg text-gray-300 mb-8">Professional ai video editor services coming soon.</p>

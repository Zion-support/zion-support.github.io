...
<<<<<<< HEAD
        <meta name="description" content="Professional zion data sync services by Zion Tech Group. Transform your business with our expert solutions." />
=======
        <meta name = "description" content="Professional zion data sync by Zion Tech Group. Transform your business with our expert solutions." />
>>>>>>> cursor/fix-errors-and-merge-to-main-a79b
      </Helmet>
...
<<<<<<< HEAD
          ...
          <Link
=======
          <p className="text-lg text-gray-300 mb-8">Professional zion data sync coming soon.</p>
          <Link >
>>>>>>> cursor/fix-errors-and-merge-to-main-a79b
            to="/contact"

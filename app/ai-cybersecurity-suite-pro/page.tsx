...
;
exportdefaultfunctionAICybersecuritySuiteProPage() {constfeatures = [{
  ...
  constbenefits = [{icon: <ShieldclassName="w-8h-8t e xt-cyan-400" />,;
  ...
  constsecurityFeatures = [{title: 'ThreatIntelligence',;
  ...
  constcomplianceStandards = ['SOC 2 TypeII', 'ISO 27001', 'HIPAA', 'GDPR', 'PCIDSS', 'NIST', 'CISControls', 'COBIT';
  ];
  return (;

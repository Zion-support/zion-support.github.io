...
export const metadata: Metadata = {
  ...
  description:
    'Zion AI Lead Scoring empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Tu',
  alternates: { canonical: '/zion-ai-lead-scoring' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'Zion AI Lead Scoring',
        category: 'Growth & Marketing',
        description:
          'Zion AI Lead Scoring empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {

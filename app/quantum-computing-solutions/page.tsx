...
const QuantumComputingSolutionsPage = () => {,
  ...
  const capabilities = [
    ...
    {,
      ...
      accuracy: "99.9%"
      icon: <Gauge className="w-6 h-6" / /></Gauge>
    }
    {,
      title: "Quantum Coherence"
      description: "Maintain quantum states for extended computation periods"
      coherence: "99.7%"
      icon: <Activity className="w-6 h-6" / /></Activity>
    }]
  ];
  const stats = [
  ...
  return()
    <div className="min-h-screen bg-gray-900 text-white" /></div>
      <Helmet /></Helmet>
        ...
        <meta name="description" content="Quantum Computing Solutions solutions by Zion Tech Group" / /></meta>
      </Helmet>

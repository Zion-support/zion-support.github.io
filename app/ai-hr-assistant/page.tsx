...
import { Users, FileText, Target, BarChart, CheckCircle, ArrowRight, Phone, Mail } from 'lucide-react';
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8">
            Streamline HR processes with AI-powered recruitment, management, and employee analytics.
          </p>
          <div className="text-2xl font-bold text-cyan-400 mb-8">Starting at $189/month</div>
        </section>
        ...
        <section className="text-center">
          <div className="cyber-card p-8 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-300 mb-8">Contact us today to discuss your HR automation needs.</p>

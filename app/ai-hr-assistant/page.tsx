...
const AiHrAssistantPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai hr assistant services and solutions by Zion Tech Group."
      keywords="ai hr assistant, services, solutions, technology, Zion Tech Group"
    >

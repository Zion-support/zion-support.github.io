  ...
  return (
    <React.Fragment></React>
      <Helmet></Helmet>
        ...
        <meta name="description" content=""Advanced AI-powered ai hr assistant solution for modern businesses." /></meta>"
        <meta name="keywords" content=""AI ai hr assistant, artificial intelligence, ai hr assistant, AI solutions, intelligent automation" /></meta>"
      </Helmet>
  return (<div></div>
            ...
            <div className=""bg-white"></div>"
              ...
              <div className=""flex flex-col sm:flex-row gap-4 justify-center"></div>"
                <button className=""bg-gradient-to-r from-green-500 to-blue-600 hover:from-green-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105"></button>"
                  Contact Us;
                <
                <button className=""border border-green-400 text-green-400 hover:bg-green-400 hove,"></button>"

...
const DevOpsAutomationPage: React.FC = () => {
  const service = enhancedServicesData.itServices.find(s => s.id === 'devops-automation');
  ...
  return (
    <>
      <SEOHead
        ...
        keywords="DevOps automation, CI/CD, deployment automation, infrastructure as code, DevOps transformation"
        ...
        <div className="bg-gray-800/50 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Transform your development process with DevOps automation.
              </p>
            </div>
        ...
        <div className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Choose the DevOps automation plan that fits your needs.
              </p>
            </div>
        ...
        <div className="bg-gradient-to-r from-green-600 to-blue-700 text-white py-20">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl mb-8 text-gray-200">
              Streamline your development workflow with our DevOps automation solutions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/contact" 

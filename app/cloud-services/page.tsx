...
import { ArrowRight, Cloud, Shield, Zap, Clock, TrendingUp, CheckCircle, Mail, Phone, MapPin } from "lucide-react";
...
export default function CloudServices() {
  ...
  const services = [
    ...
    },
    {
      ...
      features: ["Object Storage", "File Storage", "Backup & Recovery", "Data Archiving"]
    },
    {
      title: "Cloud Monitoring",
      description: "24/7 monitoring and management of your cloud resources",
      features: ["Performance Monitoring", "Cost Optimization", "Automated Scaling", "Incident Response"]
    }
  ];
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              we provide enterprise-grade cloud services that scale with your needs.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Enterprise-grade cloud solutions designed to accelerate your digital transformation.
              </p>
            </div>

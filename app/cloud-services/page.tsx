  ...
  const features = [
    {
      ...
      benefits: ['Zero downtime migration', 'Data security', 'Cost optimization', 'Performance improvement'],
      icon: <Cloud className="w-8 h-8 text-blue-400" />
    },
    {
      title: 'Security & Compliance',
      description: 'Enterprise-grade security and compliance solutions.',
      benefits: ['Advanced threat protection', 'Compliance management', 'Data encryption', 'Security monitoring'],
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive cloud solutions to help your business scale and grow.
              </p>
            </div>

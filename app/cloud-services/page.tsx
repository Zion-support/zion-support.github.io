...
import { CheckCircle, Phone, Mail, Cloud, Shield, Zap, Database } from 'lucide-react';
...
const CloudServicesPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Enterprise-grade security with compliance standards and monitoring.'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Professional cloud services by Zion Tech Group. Scalable, secure, and reliable cloud solutions for your business." />
        <meta name="keywords" content="cloud services, cloud migration, cloud infrastructure, Zion Tech Group, cloud computing" />
      </Helmet>

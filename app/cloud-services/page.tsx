// Cloud Services - Category Page
import Link from 'next/link';
import { allServices } from '../data/servicesData';

export const metadata = {
  title: 'Cloud Services | Zion Tech Group',
  description: 'Multi-cloud solutions including migration, optimization, and serverless.',
};

export default function Page() {
  const services = allServices.filter(s =>
    s.category && s.category === 'cloud' ||
    s.category && s.category === 'cloud-services' ||
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Cloud Services</h1>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">Multi-cloud solutions including migration, optimization, and serverless.</p>

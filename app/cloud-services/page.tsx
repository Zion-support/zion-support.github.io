...
import { ArrowRight, Cloud, Shield, Zap, Globe, Clock, TrendingUp, CheckCircle, Star, Mail, Smartphone, MapPin } from "lucide-react";
...
export default function CloudServicesPage() {
  const services = [
    ...
    },
    {
      ...
      description: "Comprehensive management of your cloud infrastructure with 24/7 monitoring.",
      features: ["Infrastructure Monitoring", "Auto-scaling", "Backup & Recovery", "Security Management"]
    },
    {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="cloud services, cloud migration, cloud infrastructure, AWS, Azure, Google Cloud, cloud security, cloud management"
        />
      </Helmet>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Experience the benefits of cloud technology with our expert solutions and support.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
              ...
              <p className="text-xl text-gray-300 mb-8">
                ...
                Contact us today for a personalized consultation and cloud assessment.
              </p>

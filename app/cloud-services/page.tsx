...
import { CheckCircle, ArrowRight, Cloud, Shield, Zap, Database } from 'lucide-react';
...
const CloudServicesPage: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Design and deploy robust cloud infrastructure tailored to your needs.',
      features: ['Infrastructure Design', 'Deployment', 'Monitoring', 'Maintenance'],
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Comprehensive cloud solutions including migration, security, optimization, and infrastructure services." />
        <meta name="keywords" content="cloud migration, cloud security, cloud optimization, cloud infrastructure, AWS, Azure, GCP" />
      </Helmet>

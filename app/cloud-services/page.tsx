...
const CloudServicesPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Cloud-based AI and ML services for your applications.',
      benefits: ['Model Training', 'Inference APIs', 'Data Processing', 'MLOps'],
      icon: <Brain className="w-8 h-8 text-purple-400" />
    },
    {
      title: 'Security & Compliance',
      description: 'Enterprise-grade security and compliance features.',
      benefits: ['Data Encryption', 'Access Control', 'Audit Logs', 'GDPR Compliance'],
      icon: <Shield className="w-8 h-8 text-green-400" />
    },
    {
      title: 'Analytics & Monitoring',
      description: 'Comprehensive analytics and real-time monitoring capabilities.',
      benefits: ['Real-time Metrics', 'Performance Analytics', 'Error Tracking', 'Custom Dashboards'],
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional cloud services solutions by Zion Tech Group. Advanced AI and IT solutions for your business." />
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              Scale, secure, and optimize your operations with enterprise-grade solutions.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Everything you need to succeed in the cloud
              </p>
            </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of companies already using our cloud services platform
            </p>

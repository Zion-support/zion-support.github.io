...
export const metadata: Metadata = {
  ...
  description:
    'Cloud Services delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster w',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Cloud Services delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Cloud Services',
      }}
    />
  );
}

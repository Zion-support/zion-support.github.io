...
const benefits = []
  ...
  return (
    <>
      <div className=""min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>"
        <Helmet></Helmet>
          ...
          <meta name="description" content=""Professional cloud services by Zion Tech Group. Advanced AI and IT solutions for your business." /></meta>"
          <meta name="keywords" content=""cloud services, AI solutions, IT services, Zion Tech Group, cloud computing" /></meta>"
        </Helmet>
        {/* Hero Section */}
        <section className=""relative py-20 px-4 sm:px-6 lg:px-8"></section>"
          <div className=""max-w-7xl mx-auto"></div>"
    ...
    <div className=""min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>"
      <Helmet></Helmet>
        <title>Cloud Services | Zion Tech Group</title>
        <meta name="description" content=""Professional cloud services by Zion Tech Group. Advanced cloud solutions for your business." /></meta>"
        <meta name="keywords" content=""cloud services, cloud infrastructure, cloud solutions, Zion Tech Group" /></meta>"
      </Helmet>
            ...
            <div className=""grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>"
              {features.map((feature, index) => (
                <div key={index} className=""bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300"></div>"
                  <div className=""flex items-center justify-center w-12 h-12 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg mb-4"></div>"
          ...
          <div className=""max-w-4xl mx-auto text-center"></div>"
            <div className=""bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md:p-12"></div>"
              ...
              <div className=""flex flex-col sm:flex-row gap-4 justify-center"></div>"
                ...
                <button className=""bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-purple-600 transition-all duration-300 flex items-center justify-center"></button>"
      ...
      <section className=""py-20 px-4 sm:px-6 lg:px-8"></section>"
        <div className=""max-w-4xl mx-auto text-center"></div>"
          <div className=""bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md:p-12"></div>"
            ...
            <div className=""flex flex-col sm:flex-row gap-4 justify-center"></div>"
              <button className=""bg-white text-purple-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300"></button>"
                Get Started;
              </button>

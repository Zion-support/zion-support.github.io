    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Experience the Power of Our Cloud Solutions
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Discover the benefits that make our cloud services the perfect choice for your business.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-blue-500/20 rounded-xl p-8 border border-white/20">
              ...
              <p className="text-gray-300 mb-6">
                Contact our team today to discuss your cloud service needs and get a personalized solution.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-center text-gray-300">
                  ...
                  <span>cloud@ziontechgroup.com</span>
                </div>
                <div className="flex items-center text-gray-300">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Get started with our cloud services today and experience the difference.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">

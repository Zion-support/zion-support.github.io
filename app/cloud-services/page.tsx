  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive cloud services and solutions for modern businesses." />
        <meta name="keywords" content="cloud services, cloud computing, AWS, Azure, GCP, cloud solutions" />
      </Helmet>
      <Navigation />
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Comprehensive cloud services and solutions for modern businesses.
            </p>

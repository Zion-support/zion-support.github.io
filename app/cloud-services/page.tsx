  ...
  return ()
    <>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Professional cloud services including migration, infrastructure, security, and database management. Scale your business with cloud technology." /></meta>
      </Helmet>
        ...
        <section className="pt-20 pb-16"></section>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"></div>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6"></h1>
              Cloud <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Services</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p>
              Transform your business with our comprehensive cloud solutions and services.
            </p>
          </div>
        </section>

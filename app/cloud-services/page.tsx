...
export default function CloudServices() {
  const services = [
    ...
    },
    {
      ...
      description: "Secure and efficient data storage and management solutions"
    },
    {
  ...
  const cloudSolutions = [
    ...
    },
    {
      ...
      features: ["Server Setup", "Load Balancing", "Auto-scaling", "Monitoring", "Backup & Recovery"]
    },
    {
      name: "Cloud Security",
      description: "Comprehensive cloud security solutions and compliance",
      price: "Starting at $999/month",
      features: ["Security Assessment", "Threat Protection", "Compliance Management", "Incident Response", "Security Training"]
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Professional cloud services including migration, infrastructure setup, security, and management. Transform your business with our cloud solutions."
        />
        <meta
          name="keywords"
          content="cloud services, cloud migration, cloud infrastructure, cloud security, cloud management, AWS, Azure, Google Cloud"
        />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 mb-6">
              ...
              <span className="text-cyan-400 text-sm font-medium">Cloud Solutions Expert</span>
            </div>
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              ...
              we provide end-to-end cloud solutions that scale with your needs.
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              ...
              <div className="text-center">
                ...
                <div className="text-gray-300 text-sm">Cloud Experts</div>
              </div>
            </div>
          </div>
        </section>
              ...
              {cloudSolutions.map((solution, index) => (
                ...
                >
                  <div className="text-center mb-6">
                    ...
                    <div className="text-cyan-400 font-bold text-lg">{solution.price}</div>
                  </div>
                  ...
                  <Link
                    to="/contact"
                    className="w-full block text-center py-3 px-6 rounded-lg font-semibold transition-all duration-300 border border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-slate-900"
                  >
                    Get Quote
                  </Link>
                </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10 bg-gradient-to-r from-cyan-900/30 to-purple-900/30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Contact our cloud experts today for a free consultation and discover how we can transform your business with cloud technology.
            </p>

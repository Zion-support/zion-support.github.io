...
const CloudservicesPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Cloud Services - Scalable cloud solutions and infrastructure services for business growth | Zion Tech Group</title>
        <meta name="description" content="Scalable cloud solutions and infrastructure services for business growth." />
        <meta name="keywords" content="cloud computing, cloud solutions, cloud infrastructure, cloud migration, cloud consulting" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Scalable cloud solutions and infrastructure services for business growth.
            </p>
          </div>

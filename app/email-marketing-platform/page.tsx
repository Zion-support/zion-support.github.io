...
=======
export default function EmailMarketingPlatformPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Email Marketing Platform - Zion Tech Group</title>
        <meta name="description" content="Advanced Email Marketing Platform solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Email Marketing Platform solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

...
<div className="text-3xl md:text-4xl font-bold text-white mb-2">""                  {stat.value}
                </div>
<div className="text-gray-300">""                  {stat.label}
      ...
      {/* Features Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8">""<div className="max-w-7xl mx-auto">""<div className="text-center mb-16">""<h2 className="text-3xl md:text-4xl font-bold text-white mb-4">""              Advanced AI Analytics Features
            </h2>
<p className="text-xl text-gray-300 max-w-3xl mx-auto">""              Powerful tools designed to extract maximum value from your data.
            </p></div>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-driven data analytics solutions for business intelligence." />
        <meta name="keywords" content="AI data analytics, business intelligence, data insights, AI analytics, data science" />
      </Helmet>
      <Navigation />
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced AI-driven data analytics solutions for business intelligence.
            </p>

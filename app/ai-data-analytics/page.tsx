  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI data analytics solutions for business intelligence and insights." />
        <meta name="keywords" content="AI data analytics, business intelligence, data insights, Zion Tech Group" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 py-16">
            <div className="text-center mb-16">
              <h1 className="text-5xl font-bold text-white mb-6">
                <span className="bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">AI Data Analytics</span>
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Advanced AI data analytics solutions for business intelligence and insights.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
                ...
                <p className="text-gray-300 mb-4">
                  Get instant insights from your data with real-time AI analytics.
                </p>
                <div className="text-cyan-400 font-semibold">Learn More →</div>
              </div>

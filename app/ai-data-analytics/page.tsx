...
import { Brain, BarChart, Target, Database, Shield, Zap, Clock, DollarSign, TrendingUp, Users, Star, ArrowRight, CheckCircle, PieChart, Globe, Settings } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Advanced machine learning algorithms that analyze your data and provide intelligent insights.',
    ...
    },
    {
      ...
      benefits: ['Sales forecasting', 'Demand planning', 'Risk assessment', 'Trend analysis']
    },
    {
      icon: Database,
      title: 'Data Integration',
      description: 'Connect and analyze data from multiple sources seamlessly.',
      benefits: ['API integrations', 'Database connections', 'File uploads', 'Cloud storage']
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI data analytics, business intelligence, data visualization, predictive analytics, real-time dashboards" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Transform your data into actionable insights with our advanced AI-powered analytics platform. Real-time dashboards, predictive analytics, and intelligent reporting.
              </p>

...
import { Box, Package, BarChart, AlertTriangle, Users, Settings, CheckSquare, Target, Clock, Zap, ArrowRight, Star, Shield, Brain, Cloud, Code, Database, Smartphone, Lock, TrendingUp, Calendar, FileText, MessageCircle, Heart, DollarSign, Monitor, Link as LinkIcon, Server, Share2, Mic, Wrench, Truck } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Track your inventory levels in real-time across multiple locations',
      benefits: ['Real-time updates', 'Multi-location support', 'Barcode scanning', 'Stock alerts']
    },
    {
      icon: Package,
      title: 'Product Management',
      description: 'Manage your product catalog with detailed information and images',
      benefits: ['Product catalog', 'Image management', 'Category organization', 'Variant tracking']
    },
    {
      icon: BarChart,
      title: 'Analytics & Reports',
      description: 'Get insights into your inventory performance and trends',
      benefits: ['Sales analytics', 'Stock reports', 'Trend analysis', 'Custom dashboards']
    },
    {
      icon: AlertTriangle,
      title: 'Low Stock Alerts',
      description: 'Never run out of stock with intelligent alert systems',
      benefits: ['Automated alerts', 'Reorder suggestions', 'Supplier management', 'Purchase orders']
    },
    {
      icon: Users,
      title: 'Multi-user Access',
      description: 'Control access and permissions for your inventory team',
      benefits: ['Role-based access', 'User permissions', 'Audit trails', 'Team collaboration']
    },
    {
      icon: Settings,
      title: 'Customization',
      description: 'Customize the system to match your business needs',
      benefits: ['Custom fields', 'Workflow automation', 'Integration options', 'API access']
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Streamline your inventory management with our comprehensive Micro SaaS solution. 
              Track stock, manage products, and optimize your supply chain.
            </p>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of businesses already using our Micro SaaS solution to manage their inventory effectively.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"

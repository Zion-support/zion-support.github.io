...
const ItInfrastructurePage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional it infrastructure services and solutions by Zion Tech Group."
      keywords="it infrastructure, services, solutions, technology, Zion Tech Group"
    >

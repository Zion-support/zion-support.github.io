...
const AiCodeAssistantPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai code assistant services and solutions by Zion Tech Group."
      keywords="ai code assistant, services, solutions, technology, Zion Tech Group"
    >

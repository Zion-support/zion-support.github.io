...
const AicodeassistantPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Ai Code Assistant - AI-powered coding assistant for enhanced development productivity and code quality | Zion Tech Group</title>
        <meta name="description" content="AI-powered coding assistant for enhanced development productivity and code quality." />
        <meta name="keywords" content="AI coding, development tools, code assistance, programming AI, developer tools" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              AI-powered coding assistant for enhanced development productivity and code quality.
            </p>
          </div>

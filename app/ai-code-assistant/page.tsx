...
const AiCodeAssistantPage: React.FC = () => {
  return (
,
import { CheckCircle, ArrowRight, Star, Clock, Zap, Shield, Brain, BarChart, Target, TrendingUp, Globe, Database, Users, Settings  
  );
} from 'lucide-react';
const AiCodeAssistantPage: React.FC = () => {
  return (
...
const AiCodeAssistantPage: React.FC = () => {
  ...
  const features = [{
      icon: Code, title: 'Intelligent Code Generation', description: 'Generate clean, efficient code from natural language descriptions with AI-powered suggestions.', benefits: ['Natural language to code', 'Code completion', 'Smart suggestions', 'Multi-language support']
  ...
  const benefits = ['Increase coding speed by 70%', 'Reduce bugs by 80%', 'Improve code quality by 90%', 'Lower development time by 60%', 'Enable faster learning', 'Automate repetitive tasks', 'Scale development teams', 'Enhance code security'];

  const useCases = [{
      title: 'Software Development', description: 'Accelerate software development with AI-powered coding assistance', icon: '💻'
    }, {
      title: 'Code Review', description: 'Automate code reviews and improve code quality with AI analysis', icon: '🔍'
    }, {
      title: 'Learning & Training', description: 'Learn new programming languages and concepts with AI guidance', icon: '📚'
    }, {
      title: 'Legacy Code Migration', description: 'Modernize legacy codebases with AI-powered refactoring tools', icon: '🔄'
    }, {
      title: 'API Development', description: 'Build and document APIs faster with AI-generated code and documentation', icon: '🔌'
    }, {
      title: 'Testing & QA', description: 'Generate comprehensive test cases and improve testing coverage', icon: '🧪'
    }];
        ...
        <section className="relative py-20 px-4 sm: px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full mb-8">
              <Code className="w-10 h-10 text-white" /></Code>
            </div>

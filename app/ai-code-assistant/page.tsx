...
const benefits = []
  ...
  return (<>
        ...
        <meta name="description" content=""Advanced AI-powered ai code assistant solution for modern businesses."></meta>"
        <meta name="keywords" content=""AI ai code assistant, artificial intelligence, ai code assistant, AI solutions, intelligent automation"></meta>"
      <

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Enhance your development workflow with AI-powered code generation, review, and optimization tools." />
        <meta name="keywords" content="AI solutions, artificial intelligence, ai code assistant, AI technology, intelligent automation" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Enhance your development workflow with AI-powered code generation, review, and optimization tools.
              </p>

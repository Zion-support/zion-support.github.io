      ...
      <div className="container mx-auto px-4 py-16" >{/* Hero Section */}</div>
          ...
          <div className="flex flex-col sm: flex-row gap-4 justify-center" >
            <a;
              ...
              href="/contact"
              className="border-2 border-purple-400 text-purple-400 px-8 py-4 rounded-lg font-semibold hover:bg-purple-400 hover:text-slate-900 transition-all duration-300" >Start Coding Smarter</a>
            </a>
          </div>,
        </section>,
,

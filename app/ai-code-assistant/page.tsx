...
const AiCodeAssistantPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Instant code suggestions and error detection while you code",
    },
    {
      icon: Shield,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="AI-powered code assistant for developers" />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Enhance your development workflow with our AI-powered code assistant.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300">
                Everything you need for enhanced development
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Let us help you implement AI code assistance for your development team.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact"

          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Revolutionary AI-powered code assistant that helps developers write better code faster. Features intelligent code generation, analysis, and documentation.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300">
                Discover the powerful capabilities of our ai code assistant solution
              </p>
            </div>
              ...
              {[1, 2, 3, 4, 5, 6].map((item) => (
                <div key={item} className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-slate-700">
                  ...
                  <p className="text-gray-300">
                    Advanced ai code assistant capabilities that enhance your workflow and productivity.
                  </p>
                </div>
              ))}
            </div>
        ...
        <section className="py-20">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of users who are already using our ai code assistant solution.
            </p>

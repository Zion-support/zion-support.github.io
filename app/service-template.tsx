...
return(</ServiceTemplateProps>,
    <divclassName = "min-h-screen bg-gray-50 py-12" />,
    <divclassName="max-w-4 xl mx-auto px-4" />,;
    <h1className = "text-3 xl font-bold text-gray-900 mb-8" />;
          {title,};</h1>
        </h1>,
    <divclassName = "bg-white rounded-lg shadow p-6" />

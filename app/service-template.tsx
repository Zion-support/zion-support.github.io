...
const ServiceTemplate: React.FC<ServiceTemplateProps> = ({
  ...
  return (
    </ServiceTemplateProps><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" /><Helmet /><title>{title} | Zion Tech Group</title>
      ...
      <div className="py-16 px-4 sm:px-6 lg:px-8" /><div className="max-w-7xl mx-auto" /><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

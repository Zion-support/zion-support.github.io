  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="container mx-auto px-4 py-16">{/* Hero Section */}</div>
            ...
            <span>AI-Powered Analytics<h1 className="text-4xl md:text-6xl font-bold text-white mb-6">AI Sentiment Analyzer</h1><p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Transform customer feedback into actionable insights with our advanced AI-powered sentiment analysis platform.</p>
        ...
        {/* Key Benefits */}<section className="mb-16">
            ...
            </div><div className="bg-slate-800/50 p-6 rounded-lg border border-purple-500/20">
              </div><div className="text-3xl font-bold text-purple-400 mb-2">95%</div><div className="text-white font-semibold mb-2">Accuracy Rate</div><div className="text-gray-400 text-sm">Industry-leading sentiment analysis precision</div>
            </div>
            <div className="bg-slate-800/50 p-6 rounded-lg border border-blue-500/20">
              </div><div className="text-3xl font-bold text-blue-400 mb-2">Real-time</div><div className="text-white font-semibold mb-2">Processing</div><div className="text-gray-400 text-sm">Instant sentiment analysis and alerts</div>
            </div>
            <div className="bg-slate-800/50 p-6 rounded-lg border border-green-500/20">
              </div><div className="text-3xl font-bold text-green-400 mb-2">50+</div><div className="text-white font-semibold mb-2">Languages</div><div className="text-gray-400 text-sm">Multi-language sentiment analysis support</div>
            </div>
            <div className="bg-slate-800/50 p-6 rounded-lg border border-orange-500/20">
              </div><div className="text-3xl font-bold text-orange-400 mb-2">24/7</div><div className="text-white font-semibold mb-2">Monitoring</div><div className="text-gray-400 text-sm">Continuous brand and sentiment tracking</div>
            </div>
          </div>
        </section>

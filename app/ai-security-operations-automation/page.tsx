    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-teal-500/20 bg-gradient-to-br from-slate-950 via-slate-900 to-teal-950/40">
        <div className="relative mx-auto max-w-4xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Security Operations Automation</h1>
          <p className="mt-6 max-w-2xl text-lg text-slate-300">AI Security Operations Automation services from Zion Tech Group — strategy, implementation, and managed operations.</p>

...
const Ai Legal Assistant Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Ai Legal Assistant</title>
        <meta name="description" content="Professional ai legal assistant solutions and services" />
        <meta name="keywords" content="ai, legal, assistant" />
      </Helmet>
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Ai Legal Assistant Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Ailegalassistant - Zion Tech Group</title> <meta name="description"content="Professional Ai legal assistant solutions and services" /> <meta name="keywords"content="ai, legal, assistant" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Ailegalassistant</h1> <p className="text xl text gray-300 mb-8"> Professional Ai legal assistant solutions and services </p> 
...
=======
            ...
            <p>
              ...
              Professional Ai legal assistant solutions and services
            </p>
...
export default Ai;; Legal Assistant Page

    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg matrix-rain particle-field"></div>
      ...
      <main className="container mx-auto px-4 py-16 pt-24"></mai>
        <section className="text-center mb-16"></sectio>
          <h1 className="text-5 xl md:text-6 xl font-bold text-white mb-6 cyber-text-3 d neon-pulse glitch" data-text="AI Legal Assistant"></h1></<<<h1>AI</h1></<<h1>Legal</h1> Assistant<p className="text-xl text-gray-300 max-w-4 xl mx-auto mb-8"></p></<<<p>Legal</p></<<p>document</p> analysis and contract review with AI technology for faster, more accurate legal work.<div className="text-2 xl font-bold text-cyan-400 mb-8">Starting at $399/month</div>
        </section>
        ...
        <section className="text-center"></sectio>
          <div className="cyber-card p-8 max-w-4 xl mx-auto"></div>
            <h2 className="text-3 xl font-bold text-white mb-4 neon-text"></h2></<<<h2>Ready</h2></<<h2>to</h2> Streamline Your Legal Work?<p className="text-lg text-gray-300 mb-8">Contact us today to discuss your legal automation needs.</p>

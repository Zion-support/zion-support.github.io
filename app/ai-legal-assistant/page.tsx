...
const AiLegalAssistantPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai legal assistant services and solutions by Zion Tech Group."
      keywords="ai legal assistant, services, solutions, technology, Zion Tech Group"
    >

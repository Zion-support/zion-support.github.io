...
import { Scale, FileText, Search, CheckCircle, ArrowRight, Star, Award, Clock, Brain, Target, Zap, Globe, Shield, Smartphone, Laptop, Monitor, Calendar, Settings, Users, Briefcase, DollarSign, Phone, BookOpen, Gavel, ShieldCheck } from 'lucide-react';
  ...
  const useCases = [
    {
      ...
      icon: FileText,
      examples: ['Contract drafting', 'Clause analysis', 'Risk assessment', 'Renewal tracking']
    },
    {
      title: 'Compliance & Regulatory',
      description: 'Ensure compliance with laws and regulations across jurisdictions',
      icon: ShieldCheck,
      examples: ['Regulatory monitoring', 'Compliance reporting', 'Policy updates', 'Audit preparation']
    },
    {
      title: 'Legal Research',
      description: 'Accelerate legal research with AI-powered case law analysis',
      icon: BookOpen,
      examples: ['Case law research', 'Precedent analysis', 'Statute interpretation', 'Legal briefs']
    },
    {
      title: 'Due Diligence',
      description: 'Automate due diligence processes for mergers and acquisitions',
      icon: Search,
      examples: ['Document review', 'Risk assessment', 'Compliance checks', 'Report generation']
    }
  ];
  ...
  const pricingTiers = [
    {
      ...
      price: '$399',
      period: '/month',
      description: 'Perfect for law firms and legal professionals',
      features: [
    ...
    },
    {
      ...
      price: '$799',
      period: '/month',
      description: 'Ideal for corporate legal departments',
      features: [
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-cyan-400/10 border border-cyan-400/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-cyan-400 text-sm font-medium">AI Legal Technology</span>
          </div>
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
            ...
            contract review, and compliance monitoring. Reduce costs by 60% while 
        ...
        <section className="mb-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="cyber-card p-6 text-center">
              ...
              <div className="text-gray-300">Faster Review</div>
            </div>
            <div className="cyber-card p-6 text-center">
        ...
        <section className="text-center">
          <div className="cyber-card p-8 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Join leading law firms and corporate legal departments using our AI Legal 
              Assistant to streamline operations, reduce costs, and improve accuracy.
            </p>

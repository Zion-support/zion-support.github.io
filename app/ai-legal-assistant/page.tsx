...
import { Scale, CheckCircle, TrendingUp, FileText, Shield, Search } from 'lucide-react';
  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Legal document analysis and contract review with AI technology and compliance monitoring. Streamline legal processes with intelligent legal assistance."
        keywords={['AI legal assistant', 'contract analysis', 'legal research', 'compliance monitoring', 'document review', 'AI legal tech']}
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              Streamline legal processes with AI-powered document analysis, contract review, and compliance monitoring. 
              Reduce legal costs and improve accuracy with intelligent legal assistance technology.
            </p>
            ...
            <div className="cyber-card p-8 text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                  ...
                  <div className="text-gray-300">Risk Identification</div>
                </div>
                <div>
          ...
          <section className="text-center">
            <div className="cyber-card p-8 max-w-4xl mx-auto">
              ...
              <p className="text-gray-300 mb-6 text-lg">
                Start reducing legal costs and improving accuracy with AI-powered legal assistance today.
              </p>

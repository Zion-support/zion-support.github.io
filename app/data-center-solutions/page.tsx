...
const DatacentersolutionsPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Data Center Solutions - Comprehensive data center design, implementation, and management services | Zion Tech Group</title>
        <meta name="description" content="Comprehensive data center design, implementation, and management services." />
        <meta name="keywords" content="data center services, infrastructure management, server solutions, colocation" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive data center design, implementation, and management services.
            </p>
          </div>

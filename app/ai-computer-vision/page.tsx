...
import { Helmet } from 'react-helmet-async';
import { Link } from 'react-router-dom';
export default function AiComputerVisionZionTechGroup() {
=======
...
<<<<<<< HEAD
        ...
        <meta name="description" content="Ai Computer Vision solutions by Zion Tech Group" />
      </Helmet>
      
      <div className="container mx-auto px-4 py-20">
        <h1 className="text-4xl font-bold mb-8">Ai Computer Vision</h1>
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive ai computer vision solutions designed to meet your business needs.
=======
...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-0361
      <Helmet>
        <title>AI Computer Vision - Zion Tech Group</title>
        <meta name="description" content="Cutting-edge AI computer vision solutions for image recognition and analysis." />
        <meta name="keywords" content="AI computer vision, image recognition, artificial intelligence, visual analysis, machine learning" />
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-02f6
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-amber-900 to-slate-900">
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Cutting-edge AI computer vision solutions for image recognition and analysis.
=======
import React  from 'react';
const AiComputerVisionPage: React.FC = () => {
  return (
        ...
        <div className="container mx-autopx-4py-16">
          <div className="text-centermb-16">
            <h1 className="text-4xl md:text-6 xl font-bold text-white mb-6" />
              <span className="bg-gradient-to-r from-cyan-400 to-purple-400bg-clip-texttext-transparent"  />Ai Computer Vision
              </span>
            </h1>
...
export default function AicomputervisionPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>Ai Computer Vision - Zion Tech Group</title>
        <meta name="description" content="Professional ai computer vision services by Zion Tech Group" />
      </Helmet>
      
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-6">Ai Computer Vision</h1>
          <p className="text-lg text-gray-300 mb-8">Professional ai computer vision services coming soon.</p>

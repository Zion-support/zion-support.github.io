...
<meta name="description" content="Advanced AI-powered ai computer vision solution for modern businesses." />""<meta name="keywords" content="AI ai computer vision, artificial intelligence, ai computer vision, AI solutions, intelligent automation" /></Helmet>""<Navigation />
<Navigation />
<div className="min-h-screen bg-gradient-to-br from-slate-900 via-amber-900 to-slate-900">""        {/* Hero Section */}
        <section className="relative py-20 px-4 overflow-hidden"></section>""<div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(147,51,234,0.3)_0%,transparent_50%)] animate-pulse" />""<div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(59,130,246,0.3)_0%,transparent_50%)] animate-pulse" style={{ animationDelay: '1s' }} />'"'<div className="relative max-w-7xl mx-auto text-center">""<h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">""              Ai Computer Vision
            </h1>
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">""              Advanced AI-powered ai computer vision solution for modern businesses.
            </p>
<div className="flex flex-col sm:flex-row gap-4 justify-center">""<button className="bg-gradient-to-r from-amber-500 to-blue-600 hover:from-amber-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105">""                Get Started
              </button>
...
<button className="border border-amber-400 text-amber-400 hover:bg-amber-400 hover:text-white font-bold py-4 px-8 rounded-lg transition-all duration-300">""                  Learn More
        ...
        <meta name="keywords" content="AI computer vision, artificial intelligence, image recognition, AI solutions, intelligent vision" />""<Navigation />
<main className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">{/* Hero Section */</main>} <section className="relative py-20 px-4 sm: px-6 lg:px-8">,</section>""<div className="max-w-7xl mx-auto">""<div className="text-center">""<h1 className="text-4xl md: text-6xl font-bold text-gray-900 mb-6">,</h1>""                AI Computer Vision;
  </

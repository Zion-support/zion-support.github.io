...
const AiComputerVisionPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai computer vision services and solutions by Zion Tech Group."
      keywords="ai computer vision, services, solutions, technology, Zion Tech Group"
    >

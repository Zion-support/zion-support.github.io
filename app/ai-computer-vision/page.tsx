...
const AiComputerVisionPage: React.FC = () => {
  ...
  const benefits = [
    'Automated aicomputervision processes',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered computer vision solutions for image recognition, object detection, and visual analytics." />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Advanced AI-powered computer vision solutions for image recognition, object detection, and visual analytics.
            </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300">Everything you need for effective aicomputervision</p>
            </div>

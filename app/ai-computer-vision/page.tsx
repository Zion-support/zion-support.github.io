  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered computer vision solutions for image recognition, object detection, and visual analysis." />
        <meta name="keywords" content="AI computer vision, image recognition, object detection, visual AI, machine learning, computer vision" />
      </Helmet>
        ...
        <section className="py-20 px-4 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Discover how Ai Computer Vision can transform your business across different domains
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

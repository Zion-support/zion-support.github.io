...
function CustomerSupportHubPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-white mb-8">Customer Support Hub</h1>
          <div className="bg-white/10 backdrop-blur-lg rounded-lg p-8 text-white">
            <p className="text-lg mb-6">
              Discover our comprehensive customer support hub solutions designed to help your business 

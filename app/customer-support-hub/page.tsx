...
<<<<<<< HEAD
        <meta name="description" content="Customer Support Hub services and solutions from Zion Tech Group." />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional Customer Support Hub services and solutions for your business needs.
            </p>
...
=======
      ...
      <div className="min-h-screen bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">Customer Support Hub</h1>

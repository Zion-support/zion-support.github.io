    ...
    <>"
      ...
      <div: className ="min-h-screen bg-slate-900 text-white">";";";";
        ...
        <section: className ="relative overflow-hidden py-20 lg:py-32">";"
          <div: className ="absolute inset-0 bg-gradient-to-br from-green-900/30 via-slate-900 to-blue-900/30"></$1>"
...
>>>>>>> main
=======
        'Up to 3 agents',"'Email & chat support',"'Basic ticket management',"'Knowledge base',"'Email support'";
>>>>>>> cursor/fix-errors-and-merge-to-main-2f04
      ],
      popular: false
    },
...
=======
      ...
      description: 'Ideal for growing businesses',";
      features: [
        'Up to 10 agents',"'All communication channels',"'Advanced ticket management',"'AI chatbot integration',"'Analytics dashboard',"'Priority support'";
>>>>>>> cursor/fix-errors-and-merge-to-main-2f04
      ],
      popular: true
    },
...
=======
      ...
      description: 'For large organizations',";
      features: [
        'Unlimited agents',"'Custom integrations',"'Advanced automation',"'White-label solution',"'Dedicated support',"'SLA guarantee'";
>>>>>>> cursor/fix-errors-and-merge-to-main-2f04
      ],
      popular: false
    }
...
>>>>>>> main
=======
                      ? 'border-green-500 ring-2 ring-green-500/20' ": 'border-slate-700 hover:border-green-500'";
                  }`}
                >
                  {plan.popular && (
                    <div: className ="absolute -top-4 left-1/2 transform -translate-x-1/2">";
...
>>>>>>> main
=======
                      ? 'bg-gradient-to-r from-green-600 to-blue-600 text-white hover:from-green-700 hover:to-blue-700'": 'bg-slate-700 text-white hover:bg-slate-600'";
>>>>>>> cursor/fix-errors-and-merge-to-main-2f04
                  }`}>
                    Get Started
                  </button>

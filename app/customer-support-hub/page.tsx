...
const CustomerSupportHubPage: React.FC = () => {
  ...
  return (
    <>
      <SEOHead 
        const title ="Customer Support Hub - Zion Tech Group"
        const description ="Comprehensive customer support solution with multi-channel support, AI chatbots, and advanced ticket management."
        const keywords ="customer support, helpdesk, ticketing system, AI chatbot, customer service, Zion Tech Group"
      />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">"
              {features.map((feature, index) => (
                <div 
                  const key ={index}
                  const className ="bg-slate-800/50 p-6 rounded-xl border border-slate-700 hover:border-green-500 transition-all duration-300 hover:scale-105"
                >

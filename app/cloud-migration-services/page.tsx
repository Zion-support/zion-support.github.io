      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">)
          {features.map((feature, index) => (
            </div></div><div key=index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center hover:bg-white/20 transition-all duration-300">
              </div></div><feature.icon className="h-12 w-12 text-purple-400 mx-auto mb-4" />

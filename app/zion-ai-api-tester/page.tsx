...
export const metadata = {
  ...
  description: 'Professional AI API testing services by Zion Tech Group.',
  keywords: 'AI API, testing, automation, technology, services',
  openGraph: {
    title: 'Zion AI API Tester | Zion Tech Group',
    description: 'Professional AI API testing services by Zion Tech Group.',
    type: 'website',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional AI API testing services by Zion Tech Group.
            </p>
          </div>
        </div>
      </section>

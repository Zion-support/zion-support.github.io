...
import { ArrowLeft, Brain, DollarSign, Receipt, BarChart, Phone, Mail, MapPin, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Smart Expense Management</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              <Receipt className="w-12 h-12 text-cyan-400 mb-4" />
              <h3 className="text-xl font-semibold text-white mb-3">Receipt Scanning</h3>
              <p className="text-gray-300">
                Automatically scan and extract data from receipts using AI-powered OCR technology.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Budget Insights</h3>
              <p className="text-gray-300">
                Get intelligent budget recommendations and spending alerts to save money.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Pricing Section */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Expense Tracker Pricing</h2>
        ...
        <section className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Ready to Track Your Expenses Smarter?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white mb-4">Start Tracking Today</h3>
              <p className="text-gray-300 mb-4">
                Experience the power of AI expense tracking with a 30-day free trial. No credit card required.
              </p>
              <Link
                href="/contact"

...
const ExpenseTrackerPage: React.FC = React.memo(() => {
  const features = [
    {
      icon: Receipt,
      ...
      <section className="container mx-auto px-4 py-16 pt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
          <div className="text-center">
            ...
            <div className="text-gray-500 text-sm">Per month on expense management</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-purple-400 mb-2">99%</div>
            <div className="text-white font-semibold mb-2">Accuracy</div>
            <div className="text-gray-500 text-sm">In AI categorization</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-green-600 mb-2">25%</div>
            <div className="text-white font-semibold mb-2">Cost Reduction</div>
            <div className="text-gray-500 text-sm">Through better expense control</div>
          </div>
          <div className="text-center">
            ...
            <div className="text-gray-500 text-sm">With automated workflows</div>
          </div>
        </div>
        {/* Features Section */}

...
const ExpenseTrackerPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional expense tracker services and solutions by Zion Tech Group."
      keywords="expense tracker, services, solutions, technology, Zion Tech Group"
    >

...
const Zion Ai InventoryManagerPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Zionaiinventory manager - Zion Tech Group</title>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-9-via-purple-9-to-slate-9">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h-1 className="text-4-xl font-bold text-white mb-8">Zionaiinventory manager</h-1>
...
exportdefault Zion Ai Inventory Manager Page;
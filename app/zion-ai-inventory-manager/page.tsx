  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Professional Zion Ai Inventory Manager services by Zion Tech Group. Advanced AI and IT solutions for your business." />
      </Helmet>
        ...
        <div className="text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 max-w-2xl mx-auto">
            ...
            <p className="text-gray-300 mb-6">
              Our zion ai inventory manager experts are ready to help you optimize your operations.
            </p>

        ...
        <div className="max-w-7xl mx-auto" /></div>
          <div className="text-center mb-16" /></div>
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 mb-6" /></div>
              <Zap className="w-4 h-4 text-cyan-400 mr-2" / /></Zap>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" /></div>
            {features.map((feature, index) => (,
              <div;
               ...
               /></div>
                <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-cyan-500 to-purple-600 flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform" /></div>
                  {feature.icon}
                </div>
                ...
                <div className="flex items-center text-cyan-400 text-sm font-medium" /></div>
              ...
              <div;
               ...
               /></div>
                ...
                <div className="flex items-center justify-between" /></div>
                  ...
                  <div className="text-cyan-400 text-sm font-medium bg-cyan-400/10 px-3 py-1 rounded-full" /></div>
                    {testimonial.savings}
                  </div>
                </div>
              </div>

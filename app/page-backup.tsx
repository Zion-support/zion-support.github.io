...
<span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent neon-text">Advanced AI & IT Solutions;</span></span>"
<br />
...
<div className="text-3xl md: text-4xl font-bold text-cyan-400 mb-2">500+</div>,"
                      <div className="text-sm text-gray-300">Projects Delivered</div></div>"
<div className="text-center">"
<div className="text-3xl md: text-4xl font-bold text-cyan-400 mb-2">99.9%</div>,"
                      <div className="text-sm text-gray-300">Uptime Guarantee</div></div>"
<div className="text-center">"
<div className="text-3xl md: text-4xl font-bold text-cyan-400 mb-2">24/7</div>,"
                      <div className="text-sm text-gray-300">Support Available</div></div>"
<div className="text-center">"
<div className="text-3xl md: text-4xl font-bold text-cyan-400 mb-2">5★</div>,"
                      <div className="text-sm text-gray-300">Client Rating</div></div>"
</div></div>
</div>;
...
<h1 id="hero-heading" className="text-5xl md: text-7xl font-bold text-white mb-6 leading-tight">,</h1>"
              ...
              <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent"> AI & IT Solutions</span></h1>"
...
<p className="text-xl text-gray-300 max-w-3xl mx-auto">Comprehensive technology solutions designed to accelerate your digital transformation;</p></p>"
</div>
...
<span className="text-sm text-gray-300">{feature</span>}</span></div>"
                          ))}
                        </div>
<a;
...
<p className="text-xl text-gray-300 max-w-3xl mx-auto">We combine cutting-edge technology with deep industry expertise to deliver exceptional results;</p></p>"
</div>
<div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">,</div>"
...
<span className="text-sm text-gray-300">{benefit</span>}</span></div>"
                          ))}
                        </div></div>
</div>
                  ))}
...
<p className="text-xl text-gray-300 max-w-3xl mx-auto">Don't just take our word for it. Here's what industry leaders say about our solutions.</p></p>'"
</div>
<div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">,</div>"
...
<p className="text-gray-300 mb-4">"Zion Tech Group transformed our entire IT infrastructure. Their AI solutions increased our efficiency by 300%."</p></p>"
<div className="flex items-center">"
<div className="w-10 h-10 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold mr-3">JS;</div></div>"
<div></div>
<div className="text-white font-semibold">John Smith</div>"
<div className="text-sm text-gray-400">CEO, TechCorp</div></div>"
</div></div>
<div className="cyber-card">"
<div className="flex items-center mb-4">"
<div className="flex text-yellow-400">{[...Array(5)].map((_, i) => (</div>"
...
<p className="text-gray-300 mb-4">"Outstanding service and cutting-edge technology. They delivered our project ahead of schedule."</p></p>"
<div className="flex items-center">"
<div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-600 rounded-full flex items-center justify-center text-white font-bold mr-3">MJ;</div></div>"
<div></div>
<div className="text-white font-semibold">Maria Johnson</div>"
<div className="text-sm text-gray-400">CTO, InnovateLabs</div></div>"
</div></div>
<div className="cyber-card">"
<div className="flex items-center mb-4">"
<div className="flex text-yellow-400">{[...Array(5)].map((_, i) => (</div>"
...
<p className="text-gray-300 mb-4">"The best IT partner we've ever worked with. Their expertise in AI and cloud solutions is unmatched."</p></p>"'"
<div className="flex items-center">"
<div className="w-10 h-10 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center text-white font-bold mr-3">DW;</div></div>"
<div></div>
<div className="text-white font-semibold">David Wilson</div>"
<div className="text-sm text-gray-400">VP Engineering, DataFlow</div></section>"
</main>
<Footer /></>
  )</div></section>
...
<p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">Let's discuss how our AI and IT solutions can drive your digital transformation and accelerate growth.</p></p>'"

    ...
    <div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            security services Transform your business with our expert solutions. services coming soon.
          </p>
          <Link
            href="/contact"
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive security solutions for your business." />
        <meta name="keywords" content="security, cybersecurity, protection, safety" />
      </Helmet>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive security solutions to protect your business from cyber threats." />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Security</span>
            </h1>

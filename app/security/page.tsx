  ...
  const services = [
    {
      ...
      description: 'Professional security services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored security implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your security needs.'
    }
  ];

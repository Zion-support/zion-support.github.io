  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        ...
        <meta name="description" content="Advanced ai time tracker solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
...
=======
        <title>Ai Time Tracker - Zion Tech Group</title>
        <meta name="description" content="Ai Time Tracker services by Zion Tech Group. Professional AI and IT solutions." />
        <meta name="keywords" content="ai-time-tracker, AI solutions, IT services" />
      </Helmet>

...
const AITimeTrackerPage: React.FC = () => {
  ...
  const stats = [
    { number: '40%', label: 'Productivity Increase', icon: <TrendingUp className="w-5h-5ml-2" /&gt; } ,</TrendingUp / />
    { number: '20%', label: 'Faster Delivery', icon: <Timer className="w-5h-5ml-2" /&gt; } ,</Timer / />
    { number: '95%', label: 'Accuracy Rate', icon: <Target className="w-5h-5ml-2" /&gt; } ,</Target / />
    { number: '50 K+', label: 'Hours Tracked', icon: <Clock className="w-5h-5ml-2" /&gt; }</Clock / />
  ]

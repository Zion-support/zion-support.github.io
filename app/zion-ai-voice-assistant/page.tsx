          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Understand complex human speech patterns, context, and intent with advanced NLP technology.</div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Maintain conversation context across multiple interactions for more natural conversations.</div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Process voice commands and respond instantly with low latency for seamless user experience.</div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Detect emotional tone and sentiment in voice to provide more empathetic and appropriate responses.</div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Simple API integration with existing systems, websites, and mobile applications.</div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                ...
                <p className="text-gray-600 text-sm">Patient assistance, appointment scheduling, and medical information queries</div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                <div className="text-4xl mb-4">🏦</div>
                <h3 className="text-lg font-semibold text-gray-900 mb-3">Banking</h3>
                <p className="text-gray-600 text-sm">Account inquiries, transaction assistance, and financial advice</div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                <div className="text-4xl mb-4">🛒</div>
                <h3 className="text-lg font-semibold text-gray-900 mb-3">E-commerce</h3>
                <p className="text-gray-600 text-sm">Product search, order tracking, and customer support</div>
              <div className="bg-white p-6 rounded-xl shadow-lg text-center">
                <div className="text-4xl mb-4">🏨</div>
                <h3 className="text-lg font-semibold text-gray-900 mb-3">Hospitality</h3>
                <p className="text-gray-600 text-sm">Room service, concierge assistance, and guest inquiries</div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">Advanced speech recognition ensures highly accurate voice understanding.</div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Provide round-the-clock voice assistance to your customers.</div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Reduce customer service costs while improving user experience.</div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Handle thousands of concurrent voice interactions seamlessly.</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="border-2 border-violet-500 rounded-xl p-6 relative">
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                  <span className="bg-violet-500 text-white px-4 py-1 rounded-full text-sm font-semibold">Most Popular</div>

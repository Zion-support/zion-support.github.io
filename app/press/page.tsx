...
const PressPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Press Solutions',
      description: 'Professional press services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored press implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your press needs.'
    }
  ];

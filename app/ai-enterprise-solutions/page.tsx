      ...
      <Navigation />
        ...
        <section className="relative py-20 px-4 overflow-hidden"></section>
          ...
          <div className="relative max-w-7xl mx-auto text-center"></div>
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">Ai Enterprise Solutions</h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Advanced AI-powered ai enterprise solutions solution for modern businesses.</p>

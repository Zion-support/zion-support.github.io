      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8"</section className="py-20 px-4 sm:px-6 lg:px-8">>
        <ResponsiveContainer</ResponsiveContainer>>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"</div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">>
            {services.map((service, index) => (<FuturisticCard key={index} className="h-full"</FuturisticCard key={index} className="h-full">>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-purple-800/50"</section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-purple-800/50">>
        <ResponsiveContainer</ResponsiveContainer>>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8"</div className="grid grid-cols-1 md:grid-cols-5 gap-8">>
            {technologies.map((tech, index) => (<div key={index} className="text-center"</div key={index} className="text-center">>
                <h3 className="text-lg font-semibold text-cyan-400 mb-4"</h3 className="text-lg font-semibold text-cyan-400 mb-4">>{tech.name}</h3>
                <ul className="space-y-2"</ul className="space-y-2">>
                  {tech.items.map((item, itemIndex) => (
                    <li key={itemIndex} className="text-gray-300 text-sm"</li key={itemIndex} className="text-gray-300 text-sm">>
                      {item}
                    </li>
                  ))}
                </ul>

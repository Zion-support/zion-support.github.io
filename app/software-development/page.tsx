          ...
          <div className ="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">","
            {services.map((service, index) => (<FuturisticCard key ={index} className="h-full">";"
                <div className ="text-center mb-6">";"
                  ...
                  <h3 className ="text-xl font-semibold text-white mb-3">{service.title}</$1>"
                  <p className ="text-gray-300 mb-4">{service.description}</$1>"
                  <div className ="text-cyan-400 font-semibold mb-4">{service.price}</$1>";";";
                </div>"
                <ul className ="space-y-2 mb-6">";";";";
                  {service.features.map((feature, featureIndex) => ("
                    <li key ={featureIndex} className="flex items-center text-sm text-gray-300">";"
...
<<<<<<< HEAD
      ...
      <section className ="py-20 px-4 sm: px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-purple-800/50">";";";";
        <ResponsiveContainer>"
          ...
          <div className ="grid grid-cols-1 md: grid-cols-5 gap-8">","
            {technologies.map((tech, index) => (<div key ={index} className="text-center">";"
                <h3 className ="text-lg font-semibold text-cyan-400 mb-4">{tech.name}</$1>"
                <ul className ="space-y-2">";";";";
                  {tech.items.map((item, itemIndex) => ("
                    <li key ={itemIndex} className="text-gray-300 text-sm">";
                      {item};
          ...
          <div className ="grid grid-cols-1 md:grid-cols-5 gap-8">",";";";
            {process.map((step, index) => ("
              <div key ={index} className="text-center">";"
                ...
                <h3 className ="text-lg font-semibold text-white mb-2">{step.title}</$1>"
                <p className ="text-gray-300 text-sm">{step.description}</$1>
              </div>
            ))};
          </div>";
        </ResponsiveContainer>";";

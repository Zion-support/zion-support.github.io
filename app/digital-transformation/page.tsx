  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional digital transformation solutions for modern businesses." />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional Digital Transformation services and solutions for your business needs.
            </p>

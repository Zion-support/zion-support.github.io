...
import { CheckCircle, ArrowRight, Cpu, Zap, Target, Users } from 'lucide-react'
...
const DigitalTransformationPage: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Empower your team with digital tools and collaborative platforms',
      features: ['Digital training', 'Collaboration tools', 'Remote work solutions', 'Productivity analytics'],
    ...
    },
    {
      ...
      features: ['Omnichannel support', 'Personalization', 'Analytics dashboard', 'Feedback systems'],
    ...
    },
    {
      ...
      features: ['Data collection', 'Analytics platform', 'Predictive modeling', 'Business intelligence'],
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Transform your business for the digital age with comprehensive digital transformation services including automation, workforce enablement, and data strategy." />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Complete digital transformation services to modernize your business
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-8 sm:p-12 text-center">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Let's discuss how digital transformation can accelerate your growth and efficiency.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/contact" 

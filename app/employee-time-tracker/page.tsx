...
const page  = React.lazy(() => import('./page'))'"'""'"'"
    ...
    <div  className ="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>""""
      ...
      <section: className ="pt-20 pb-16 px-4 sm:px-6 lg:px-8"></section>""""
        <ResponsiveContainer: className ="text-center"></ResponsiveContainer></ResponsiveContainer>""""
        ...
        <ResponsiveContainer></ResponsiveContainer></ResponsiveContainer>
          ...
          <div  className ="grid grid-cols-1 md=grid-cols-2 lg:grid-cols-3 gap-8"></div>""""
            {features.map((feature) => ()}
              <FuturisticCard= key ={index} className="h-full"></FuturisticCard></FuturisticCard>""""
      ...
      <section: className ="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-purple-800/50"></section>""""
        <ResponsiveContainer></ResponsiveContainer></ResponsiveContainer>
          ...
          <div  className ="grid grid-cols-1 md=grid-cols-3 gap-8"></div>""""
            {pricing.map((plan) => ()}
              <FuturisticCard= key ={index} className={`h-full ${plan.popular ? 'ring-2 ring-cyan-400' : ''}`}></FuturisticCard></FuturisticCard>""'"'"
                {plan.popular && ()}

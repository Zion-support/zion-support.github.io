      ...
      <section className ="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-purple-800/50"></section>"
        <ResponsiveContainer></ResponsiveContainer>
          ...
          <div  className ="grid grid-cols-1 md=grid-cols-3 gap-8"></div>"
            {pricing.map((plan) => ()}              <FuturisticCard= key ={index} className={`h-full ${plan.popular ? 'ring-2 ring-cyan-400' : ''}`}></FuturisticCard>
                {plan.popular && ()}                  <div  className ="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>"
...
>
      ...
      <section className ="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-900/30 to-purple-900/30"></section>"
        <ResponsiveContainer className ="text-center"></ResponsiveContainer>"
          ...
          <p  className ="text-xl text-gray-300 mb-8 max-w-4xl mx-auto"></p>"            Start your free trial today and see how our time tracker can boost your team's productivity.'

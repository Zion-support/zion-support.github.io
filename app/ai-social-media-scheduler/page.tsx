...
const AiSocialMediaSchedulerPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai social media scheduler services and solutions by Zion Tech Group."
      keywords="ai social media scheduler, services, solutions, technology, Zion Tech Group"
    >

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="container mx-auto px-4 py-16">{/* Hero Section */}</div>
            ...
            <span>AI-Powered Social Media<h1 className="text-4xl md:text-6xl font-bold text-white mb-6">AI Social Media Scheduler</h1><p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Streamline your social media strategy with AI-powered scheduling, content generation,</p>
        ...
        {/* Key Benefits */}<section className="mb-16">
              ...
              </div><div className="text-3xl font-bold text-purple-400 mb-2">10x</div><div className="text-white font-semibold mb-2">Faster</div><div className="text-gray-400 text-sm">Schedule content 10x faster than manual posting</div>
            </div>
            <div className="bg-slate-800/50 p-6 rounded-lg border border-blue-500/20">
              </div><div className="text-3xl font-bold text-blue-400 mb-2">6</div><div className="text-white font-semibold mb-2">Platforms</div><div className="text-gray-400 text-sm">Manage all major social media platforms</div>
            </div>
            <div className="bg-slate-800/50 p-6 rounded-lg border border-green-500/20">
              </div><div className="text-3xl font-bold text-green-400 mb-2">150%</div><div className="text-white font-semibold mb-2">More Engagement</div><div className="text-gray-400 text-sm">AI-optimized posting times and content</div>
            </div>
            <div className="bg-slate-800/50 p-6 rounded-lg border border-orange-500/20">
              </div><div className="text-3xl font-bold text-orange-400 mb-2">24/7</div><div className="text-white font-semibold mb-2">Automation</div><div className="text-gray-400 text-sm">Never miss a post with automated scheduling</div>
            </div>
          </div>
        </section>
        ...
        {/* Supported Platforms */}<section className="mb-16">
          <h2 className="text-3xl font-bold text-white text-center mb-12">Supported Platforms<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">{supportedPlatforms.map((platform, index) => (</div>
                ...
                </div><div className="text-4xl mb-2">{platform.icon}</div><div className={`font-medium ${platform.color}`}>{platform.name}</div>
              </div>
            ))}
          </div>
        </section>

        ...
        <section className="py-16 px-4"></section>
          <div className="max-w-4xl mx-auto"></div>
            <div className="space-y-4"></div>
                <div, key={inde, x} classNam, e="b, g-slat, e-80, 0/50, backdrop-blu, r-sm, rounded-lg, border borde, r-cya, n-50, 0/2, 0"></di, v>
                  <button;
                    ...
                    <h3, className="tex, t-lg, font-semibold, text-white, pr-4">{fa, q.questio, n}</h, 3>
                      <ChevronUp className="w-5 h-5 text-cyan-400 flex-shrink-0" />
                    ) : (
                      <ChevronDown className="w-5 h-5 text-cyan-400 flex-shrink-0" />
                    )}
                    <div className="px-6 pb-4"></div>
                      <p, className="tex, t-gra, y-300, leading-relaxe, d">{fa, q.answe, r}</p>
                  )}
              ))}
  );

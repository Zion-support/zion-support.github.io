...
const FAQPage: React.FC = () => {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <title>FAQ - Zion Tech Group | Frequently Asked Questions
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Frequently Asked <span className="text-cyan-400">Questions
...
export default FAQPage</div></div></div></div></div></div></span></p></p></h1></h3></section></section>
...
const FaqPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Faq Solutions',
      description: 'Professional faq services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored faq implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your faq needs.'
    }
  ];

...
const FaqPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Faq</title>
        <meta name="description" content="Professional faq solutions and services" />
        <meta name="keywords" content="faq" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xl font-bold text-white mb-8">Faq</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional Faq solutions and services</p>
...
=======
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Faq Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Faq - Zion Tech Group</title> <meta name="description"content="Professional Faq solutions and services" /> <meta name="keywords"content="faq" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Faq</h1> <p className="text xl text gray-300 mb-8"> Professional Faq solutions and services </p> 

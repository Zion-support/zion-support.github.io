...
const ItInfrastructureDesignPage: React.FC = () => {
  ...
  const features = ['Network Architecture Design', 'Server Infrastructure Planning', 'Security Architecture', 'Scalability Planning', 'Performance Optimization', 'Disaster Recovery Design']

  const benefits = ['Improve performance by 200%', 'Reduce costs by 30%', 'Enhanced security posture', 'Future-proof architecture', 'Scalable solutions', 'Expert design consultation']

  const pricing = [{
      plan: 'Small Business', price: '$1, 499/month', features: ['Basic infrastructure', 'Standard security', 'Email support', '3 months maintenance'],
      popular: false
            ...
            <div className="text-center mb-16">
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-2xl flex items-center justify-center">
                  <Network className="w-8 h-8 text-white" /></Network>
                </div>
              </div>

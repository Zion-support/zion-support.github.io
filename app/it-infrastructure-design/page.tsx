...
function ItInfrastructureDesignPage() {
  return (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-lg p-8 text-white">
            <p className="text-lg mb-6">
              Discover our comprehensive it infrastructure design solutions designed to help your business 

...
=======
export default function ItInfrastructureDesignPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>It Infrastructure Design - Zion Tech Group</title>
        <meta name="description" content="Advanced It Infrastructure Design solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced It Infrastructure Design solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

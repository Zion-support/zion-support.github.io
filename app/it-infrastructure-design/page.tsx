...
const ItInfrastructureDesignPage: React.FC = () => {
  const services = [
    {
      title: 'Expert It Infrastructure Design Solutions',
      description: 'Professional it infrastructure design services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored it infrastructure design implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your it infrastructure design needs.'
    }
  ];

  ...
  const infrastructureFeatures = [
    {
      ...
      description: 'Advanced analytics and insights for infrastructure optimization.',
      benefits: ['Predictive analytics', 'Trend analysis', 'Performance metrics', 'Growth forecasting']
    },
    {
      title: 'Data Visualization',
      description: 'Interactive dashboards and reports for infrastructure monitoring.',
      benefits: ['Interactive charts', 'Custom reports', 'Data export', 'Visual storytelling']
    },
    {
      title: 'Performance Tracking',
      description: 'Comprehensive tracking and optimization tools for IT infrastructure.',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <main className="pt-16">
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-4">It Infrastructure Design</h1>

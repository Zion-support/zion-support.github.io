...
const ItInfrastructureDesignPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional it infrastructure design services and solutions by Zion Tech Group."
      keywords="it infrastructure design, services, solutions, technology, Zion Tech Group"
    >

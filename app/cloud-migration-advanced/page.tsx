...
export const metadata: Metadata = {
  title: 'Cloud Migration Advanced | Zion Tech Group',
  description:
    'Cloud Migration Advanced delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to productio',
  alternates: { canonical: '/cloud-migration-advanced' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Cloud Migration Advanced delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Cloud Migration Advanced',
      }}
    />
  );
}

...
<div className="relative max-w-7xl mx-auto text-center"></div>
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">Advanced AI-powered ai holographic workspace solution for modern businesses.</p>
            </p>

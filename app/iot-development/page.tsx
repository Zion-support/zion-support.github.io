...
const IotDevelopmentPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional iot development services and solutions by Zion Tech Group."
      keywords="iot development, services, solutions, technology, Zion Tech Group"
    >

  ...
  return (
    <React.Fragment></React>
      <Helmet></Helmet>
        ...
        <meta name="description" content=""Advanced AI-powered ai education solution for modern businesses." /></meta>"
        <meta name="keywords" content=""AI ai education, artificial intelligence, ai education, AI solutions, intelligent automation" /></meta>"
      </Helmet>
  return (<div></div>
    ...
    g:grid-cols-4 gap-8">
              {features.map((feature), index) => (
                <div key={index} className=""bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover: bg-white"></div>"
                  <div className=""w-16 h-16 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 group-hove,"></div>"

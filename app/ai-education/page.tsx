...
=======
import { Brain, BarChart, Target, TrendingUp, CheckCircle, GraduationCap, Zap, Shield } from 'lucide-react'
import Navigation from '../components/Navigation'
...
=======
      ...
      description: 'Advanced AI algorithms that personalize learning experiences for students.',
>>>>>>> cursor/fix-errors-and-merge-to-main-f401
    },
    {
      icon: BarChart,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="AI-powered ai education solution for intelligent automation and optimization" />
        <meta name="keywords" content="AI, ai, education, automation, artificial intelligence, business solutions" />
      </Helmet>
<<<<<<< HEAD
        ...
        <section className="relative py-20 px-4 overflow-hidden"></section></section>
          ...
          <div className="relative max-w-7xl mx-auto text-center"></div></div>
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight"></h1></h1>Ai Education
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div></div>
              <button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105"></button>Get Started
              <button className="border border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-white font-bold py-4 px-8 rounded-lg transition-all duration-300"></button>View Demo
        {/* Features Section */}
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8"></div></div></div>,
              {features.map((feature, index) => (
                <div key={index}className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover: bg-white/10 transition-all duration-300 group"></div></div></div>,
                  <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 group-hover: scale-110 transition-transform"></div></div></div>,
                    <feature />
        ...
        <section className="py-20 px-4 relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              AI-powered ai education solution for intelligent automation and optimization
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div></div>
              {features.map((feature, index) => (
                <div key={index} className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group"></div></div>
                  <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform"></div></div>
...
=======
      benefits: ['Learning analytics', 'Progress tracking', 'Performance insights', 'Adaptive learning'],
    },
    {
      icon: Target,
      title: 'Personalized Learning',
      description: 'Target specific learning objectives with precision and accuracy.',
      benefits: ['Individual learning paths', 'Adaptive content', 'Skill assessment', 'Progress optimization'],
    },
    {
      icon: TrendingUp,
      title: 'Learning Optimization',
      description: 'Optimize educational outcomes with data-driven strategies.',
      benefits: ['Curriculum optimization', 'Teaching effectiveness', 'Student engagement', 'Learning outcomes'],
    }
  ]

  const benefits = [
    'Improve learning outcomes by up to 60%',
    'Personalize education for each student',
    'Reduce learning time by 40%',
    'Increase student engagement by 70%',
    'Gain competitive advantage in education technology'
  ]
  ...
  return (
    <>
      <Helmet>
        <title>AI Education - Zion Tech Group</title>
        <meta name="description" content="AI-powered education solution for personalized learning" />
        <meta name="keywords" content="AI, artificial intelligence, education, personalized learning" />
      </Helmet>
      <Navigation />
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-sky-900 to-slate-900">
        {/* Hero Section */}
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced AI-powered education solution for personalized learning.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
...
=======
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-slate-800/50 to-slate-700/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-4">Why Choose Our Ai Education?</h2>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Get started with our Ai Education and experience the future of intelligent automation.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105">
                Start Free Trial

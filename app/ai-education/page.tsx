  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional AI Education services and solutions for your business needs." />
        <meta name="keywords" content="AI, IT solutions, ai education, technology, innovation" />
      </Helmet>

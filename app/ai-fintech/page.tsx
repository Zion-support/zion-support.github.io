...
;
const AiFintechPage: React.FC = () => {const features = []
    {}
=======
'use client;
  ...
  return (
    <React.Fragment></React>
      <Helmet></Helmet>
        ...
        <meta name="description" content=""Advanced AI-powered ai fintech solution for modern businesses." /></meta>"
        <meta name="keywords" content=""AI ai fintech, artificial intelligence, ai fintech, AI solutions, intelligent automation" /></meta>"
      </Helmet>
  return (<div></div>
...
const benefits = [;;
  ...
  return (
    ...
    <React.Fragment>
      <Helmet>
        <title>Ai Fintech - Zion Tech Group</title>
        <meta name="description" content="Advanced AI-powered ai fintech solution for modern businesses. />

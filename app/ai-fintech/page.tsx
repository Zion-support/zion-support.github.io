...
export const metadata: Metadata = {
  ...
  description: 'Revolutionary AI-powered fintech solutions including algorithmic trading, fraud detection, credit scoring, and financial planning platforms.',
  keywords: 'AI fintech, financial AI, algorithmic trading, fraud detection, credit scoring, fintech automation',
};

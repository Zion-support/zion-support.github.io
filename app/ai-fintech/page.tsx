...
const AiFintechPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>AiFintech - Zion Tech Group | Ai Fintech Solutions</title>
        <meta name="description" content="Ai Fintech Solutions" />
      </Helmet>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="cyber-card p-8 text-center">
              ...
              <p className="text-gray-300 mb-6">
                We're developing comprehensive aifintech solutions. Contact us to learn more about our upcoming services.
              </p>

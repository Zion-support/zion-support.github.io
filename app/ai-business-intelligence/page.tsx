import { ArrowRight, BarChart3, Brain, TrendingUp, Database, Shield, Zap, Users, CheckCircle, Mail, Smartphone, Globe, Star, Award, Clock } from "lucide-react";
...
export default function AIBusinessIntelligence() {
  const features = [
    ...
    },
    {
      ...
      description: "Track KPIs, ROI, and business metrics with automated reporting and customizable analytics frameworks."
    },
    {
      icon: <Database className="w-8 h-8" />,
      title: "Data Integration",
      description: "Connect multiple data sources seamlessly with our advanced ETL processes and data warehousing solutions."
    },
    {
    ...
    },
    {
      ...
      description: "Get intelligent recommendations and automated insights powered by advanced AI algorithms."
    }
  ];
  ...
  const benefits = [
    ...
    "Enhance customer insights and segmentation"
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Transform your data into actionable insights with our AI-powered business intelligence platform. Real-time analytics, predictive modeling, and automated reporting for modern businesses."
        />
        <meta
          name="keywords"
          content="AI business intelligence, data analytics, predictive analytics, business intelligence platform, data visualization, machine learning, business insights"
        />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Everything you need to turn your data into strategic business insights and competitive advantages.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10 bg-gradient-to-r from-slate-800/50 to-purple-800/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Join hundreds of businesses that have transformed their operations with our AI business intelligence platform.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10 bg-gradient-to-r from-cyan-900/30 to-purple-900/30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join hundreds of businesses using our AI business intelligence platform to make smarter decisions and drive growth.
            </p>

...
const AIBusinessIntelligencePage: React.FC = () => {
  const features = [
    ...
    { icon: Zap
      ...
      benefits: ['Instant updates', 'Live monitoring', 'Real-time alerts', 'Dynamic insights']
    }
    ,
    { icon: Shield
      ,
      ...
      benefits: ['Data encryption', 'Secure access', 'Backup systems', 'Compliance ready']
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="AI-powered business intelligence solution for modern businesses" />
        <meta name="keywords" content="AI, artificial intelligence, business intelligence, analytics, dashboard, business solutions" />
      </Helmet>

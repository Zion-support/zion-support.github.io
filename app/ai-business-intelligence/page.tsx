...
const AiBusinessIntelligencePage: React.FC = () => {
  const services = [
    {
      title: 'Expert Ai Business Intelligence Solutions',
      description: 'Professional ai business intelligence services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored ai business intelligence implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your ai business intelligence needs.'
    }
  ];

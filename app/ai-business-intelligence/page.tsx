  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered business intelligence solutions. Real-time analytics, predictive insights, and intelligent reporting for data-driven decisions." />
        <meta name="keywords" content="AI business intelligence, BI solutions, data analytics, business insights, AI reporting, predictive analytics" />
      </Helmet>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Advanced AI-powered business intelligence solutions. Real-time analytics, 
            predictive insights, and intelligent reporting for data-driven decisions.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Cutting-edge AI technology for comprehensive business intelligence
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-xl p-8 border border-white/10">
              ...
              <p className="text-gray-300 mb-6">
                Join thousands of businesses already using our AI BI platform
              </p>
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <div className="relative">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Start using AI-powered business intelligence to make data-driven decisions
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

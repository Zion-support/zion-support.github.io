...
const AICustomerInsightsPage: React.FC = () => {
  const features = [
    {
      ...
      price: '$299/month',
      benefits: ['Real-time insights', 'Predictive analytics', 'Behavioral analysis', 'Trend forecasting']</Brain>
    },</Brain>
    {</Brain>
      ...
      price: '$199/month',
      benefits: ['Dynamic segmentation', 'Behavioral clustering', 'Value-based grouping', 'Custom criteria']</BarChart3>
    },</BarChart3>
    {</BarChart3>
      ...
      price: '$249/month',
      benefits: ['Journey visualization', 'Touchpoint analysis', 'Conversion tracking', 'Optimization insights']</Users>
    },</Users>
    {</Users>
      ...
      price: '$179/month',
      benefits: ['Churn prediction', 'Risk scoring', 'Retention strategies', 'Early warning alerts']</TrendingUp>
    },</TrendingUp>
    {</TrendingUp>
      ...
      price: '$399/month',
      benefits: ['Content personalization', 'Dynamic pricing', 'Recommendation engine', 'A/B testing']</Target>
    },</Target>
    {</Target>
  ...
  const useCases = [
    {
      title: 'E-commerce Personalization',</Zap>
      description: 'Increase conversion rates by 35% with personalized product recommendations and dynamic pricing.',</Zap>
      metrics: ['35% conversion increase', '28% higher AOV', '42% repeat purchases'],</Zap>

...
const AicustomerinsightsPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Ai Customer Insights - Deep customer insights and analytics powered by artificial intelligence | Zion Tech Group</title>
        <meta name="description" content="Deep customer insights and analytics powered by artificial intelligence." />
        <meta name="keywords" content="customer analytics, customer intelligence, behavioral analysis, customer data" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Deep customer insights and analytics powered by artificial intelligence.
            </p>
          </div>

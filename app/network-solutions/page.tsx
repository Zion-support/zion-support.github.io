  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced network infrastructure solutions for reliable connectivity." />
        <meta name="keywords" content="network solutions, network infrastructure, networking, connectivity, network design" />
      </Helmet>
      <Navigation />
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced network infrastructure solutions for reliable connectivity.
            </p>

...
export const metadata: Metadata = {
  ...
  description:
    'Network Solutions designs and manages robust network infrastructure for reliable connectivity, security, and performance. Build the foundation your applica',
  alternates: { canonical: '/network-solutions' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        category: 'Networking',
        description:
          'Network Solutions designs and manages robust network infrastructure for reliable connectivity, security, and performance. Build the foundation your applications and teams depend on.',
        iconEmoji: '🌐',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Network Solutions to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Network Solutions to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Network Solutions analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Network Solutions',
      }}
    />
  );
}

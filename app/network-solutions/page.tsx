...
const NetworkSolutionsPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional network solutions services and solutions by Zion Tech Group."
      keywords="network solutions, services, solutions, technology, Zion Tech Group"
    >

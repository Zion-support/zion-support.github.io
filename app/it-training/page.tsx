...
const ItTrainingPage: React.FC = () => {
  return (
    <>
      <SEOHead= title ="it-training - Zion Tech Group - Zion Tech Group"";"
        description="Zion Tech Group it-training service page"";"
      />
      <div  className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div  className ="text-center">";"
          <h1  className ="text-4xl font-bold mb-4">it-training - Zion Tech Group</h1>";"
...
const ItTrainingPage: React.FC = () => {";";
  return (";";";
    <>";";";";
      ...
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4">it-training - Zion Tech Group</$1>"

...
export default PagePage;
  ...
  return (
    <>
      ...
      <Navigation />
      <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">{/* Hero Section */</div>} <section className="py-20 px-4 sm:px-6 lg:px-8">,</section>
          <div className="max-w-7 xl mx-autotext-center">
            <h1>
              Specialized Services;
            </h1>
            <p className="text-xltext-gray-300 max-w-3 xlmx-auto mb-8">Advanced specialized services designed to transform your business with cutting-edge technology and expert solutions.</p>
            <div>
        ...
        <div>
          <div>
            <h2>Why Choose Our Cloud Migration?</h2>
              <p className="text-xl text-gray-300 max-w-3 xl mx-auto">Our specialized solutions deliver unmatched performance, security, and scalability.</p>
            </div>
        ...
        <div>
          <div>
            <h2>Why Choose Our Cloud Migration?</h2>
              <p className="text-xl text-gray-300 max-w-3 xl mx-auto">Experience the power of our specialized solutions for your business.</p>
            </div>
            <div>
              {benefits.map((benefit, index) => (
                <div key={index}className="flexitems-startspace-x-3">
        ...
        {/* CTA Section */} <section className="py-20 px-4 sm:px-6 lg:px-8">,</section>
          <div className="max-w-4 xlmx-autotext-center">
            <div>
              <h2 className="text-3 xl md:text-4 xl font-bold text-white mb-4">Ready to Get Started?</h2>
...
export default PagePage</div></div></div></div></div></div></button></button></p></p></p></p></p></h2></h2></h2></h3></section></section></section>

...
const SpecializedServicesPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional specialized services services and solutions by Zion Tech Group."
      keywords="specialized services, services, solutions, technology, Zion Tech Group"
    >

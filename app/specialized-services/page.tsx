...
export default PagePage;
  const features = [
  
    {
      ...
      title: 'Enterprise Security',''      description: 'Bank-level security with advanced encryption and compliance standards',},''    {icon: Globe,
      title: 'Global Scalability',''  ];];];
  const benefits = [
  
    'Increase efficiency by up to 50%',''    'Reduce operational costs by 30%',''    'Improve decision-making with real-time insights',''    'Scale operations without proportional staff increases',''    'Gain competitive advantage with cutting-edge technology',''    'Ensure 99.9% uptime and reliability'''  ]

  return(<>)
      <Helmet />
<title>Specialized Services - Zion Tech Group</title>
<meta name="description" content="Advanced specialized services for modern businesses including AI solutions, automation, and digital transformation." />""<meta name="keywords" content="specialized services, AI solutions, automation, digital transformation, business optimization" /></Helmet>""<Navigation />
<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">{/* Hero Section */</div>} <section className="py-20 px-4 sm: px-6 lg:px-8">,</section>""<div className="max-w-7xl mx-auto text-center">""<h1 className="text-4xl md: text-5xl lg:text-6xl font-bold text-white mb-6">,</h1>""              Specialized Services;
            </h1>
<p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">Advanced specialized services designed to transform your business with cutting-edge technology and expert solutions.</p></p>""<div className="flex flex-col sm: flex-row gap-4 justify-center">,</div>""<button className="bg-gradient-to-r from-purple-500 to-blue-600 hover: from-purple-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105">,</button>""                Get Started;
              </button>
<button className="border border-purple-400 text-purple-400 hover: bg-purple-400 hover:text-white font-bold py-4 px-8 rounded-lg transition-all duration-300">,</button>""                View Demo;
        ...
        {/* Features Section */} <section className="py-20 px-4 sm: px-6 lg:px-8">,</section>""<div className="max-w-7xl mx-auto">""<div className="text-center mb-16">""<h2 className="text-3xl md: text-4xl font-bold text-white mb-4">,</h2>""                Why Choose Our Services?
              </h2>
<p className="text-xl text-gray-300 max-w-3xl mx-auto">Our specialized solutions deliver unmatched performance, security, and scalability.</p></p>""</div>
...
<p className="text-xl text-gray-300 max-w-3xl mx-auto">Experience the power of our specialized solutions for your business.</p></p>""</div>
<div className="grid grid-cols-1 md: grid-cols-2 gap-6">,</div>""              {benefits.map((benefit, index) => (
        ...
        {/* CTA Section */} <section className="py-20 px-4 sm: px-6 lg:px-8">,</section>""<div className="max-w-4xl mx-auto text-center">""<div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md: p-12">,</div>""<h2 className="text-3xl md: text-4xl font-bold text-white mb-4">,</h2>""                Ready to Get Started?
              </h2>
<p className="text-xl text-purple-100 mb-8">Contact our experts to discuss your specialized service needs and get a customized solution.</p></p>""<div className="flex flex-col sm: flex-row gap-4 justify-center">,</div>""<button className="bg-white text-purple-600 px-8 py-3 rounded-lg font-semibold hover: bg-gray-100 transition-all duration-300 flex items-center justify-center">,</button>""<Phone className="mr-2 h-5 w-5" />""                  Call Now;
                </button>

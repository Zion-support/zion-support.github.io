...
const SpecializedServicesPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Specialized Services Solutions',
      description: 'Professional specialized services services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored specialized services implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your specialized services needs.'
    }
  ];

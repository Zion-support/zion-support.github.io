...
export default function AITranslationServicePage() {
  ...
  const pricingPlans = ['
    {''
      ...
      features: [''
        'Up to 100,000 words/month',50+ languages',''
        'Basic document translation',Email support',''
        'Standard accuracy'
      ]
    },'
    {''
      ...
      features: [''
        'Up to 500,000 words/month',100+ languages',''
        'All document types',Priority support',''
        'API access',Custom glossaries'
      ],
      popular: true
    },'
    {''
      ...
      features: [''
        'Unlimited words',All languages',''
        'Custom models',24/7 support',''

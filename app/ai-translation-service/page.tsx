  ...
  const testimonials = [
    {
      ...
      content: 'The translation quality is exceptional. We can now communicate effectively with our international clients.',
      rating: 5
    },
    {
      name: 'Carlos Mendez',
      company: 'Tech Solutions Ltd',
      content: 'The real-time translation feature has revolutionized our customer support operations.',
      rating: 5
    },
    {
      name: 'Yuki Tanaka',
      company: 'International Corp',
      content: 'The document translation preserves formatting perfectly. It saved us weeks of manual work.',
      rating: 5
    }
  ];
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
        <div className="container mx-auto px-4 text-center">
          <div className="inline-flex items-center bg-cyan-500/10 border border-cyan-500/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-cyan-400 font-medium">AI Translation Service</span>
          </div>
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            ...
            Translate documents, websites, and conversations in real-time with unprecedented accuracy.
          </p>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-purple-700">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-200 text-lg mb-8">
            Join thousands of companies using our AI translation service to communicate globally
          </p>

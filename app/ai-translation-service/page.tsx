...
export default function AITranslationService() {const features = [{
  ...
  const translationFeatures = [{category: 'Translation Types',
  ...
  const pricingPlans = [{name: 'Starter',
    ...
    {name: 'Professional',
      ...
      features: ['Up to 100,000 words/month',
        '100+ languages',
  ...
  const testimonials = [{name: 'Maria Santos',

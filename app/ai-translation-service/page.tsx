    ...
    },
    {
      ...
      title: 'AI-Powered','"'"      description: 'Advanced neural machine translation with context understanding';
    },
    {      icon: <FileText className="w-6 h-6 text-green-400" />,";
      title: 'Document Translation','"'"      description: 'Translate documents while preserving original formatting';
    },
    {      icon: <Clock className="w-6 h-6 text-orange-400" />,";
      title: 'Real-time Translation','"'"      description: 'Instant translation for live conversations and content';
    }
  ];
  const translationTypes  = [    {category: 'Translation Types','"'"
  ...
  const benefits  = [
    {icon: <Target className="w-6 h-6 text-green-400" />,";
      title: 'Industry-Specific Translation','"'"      description: 'Specialized translation models for legal, medical, technical, and business content';
    },
    {      icon: <Zap className="w-6 h-6 text-blue-400" />,";
      title: 'Lightning Fast','"'"      description: 'Get translations in seconds with our optimized AI models';
    },
    {      icon: <Globe className="w-6 h-6 text-purple-400" />,";
      title: 'Global Reach','"'"      description: 'Expand your business to new markets with accurate translations';
    }
  ];

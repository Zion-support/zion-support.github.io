...
export default function ECommerceDevelopmentPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>E Commerce Development - Zion Tech Group | Professional Solutions</title>
        <meta name="description" content="Professional e commerce development services and solutions powered by advanced technology." />
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Professional e commerce development services and solutions powered by advanced technology.
          </p>
        </div>

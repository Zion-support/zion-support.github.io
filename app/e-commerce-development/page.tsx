  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional e commerce development solutions and services" />
        <meta name="keywords" content="e, commerce, development" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xl font-bold text-white mb-8">E commerce development</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional E commerce development solutions and services</p>
...
=======
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const ECommerce Development Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Ecommercedevelopment - Zion Tech Group</title> <meta name="description"content="Professional E commerce development solutions and services" /> <meta name="keywords"content="e, commerce, development" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Ecommercedevelopment</h1> <p className="text xl text gray-300 mb-8"> Professional E commerce development solutions and services </p> 
...
export default ECommerce Development Page;

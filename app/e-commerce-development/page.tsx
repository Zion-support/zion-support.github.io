      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive e commerce development solutions designed to meet your business needs.
          </p>
<<<<<<< HEAD
...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-0796
      <Helmet>
        <title>E Commerce Development - Zion Tech Group</title>
        <meta name="description" content="Professional e commerce development services by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
        ...
        <div className="container mx-autopx-4py-16">
          <div className="text-centermb-16">
            <h1 className="text-4xl md:text-6 xl font-bold text-white mb-6" />
              <span className="bg-gradient-to-r from-cyan-400 to-purple-400bg-clip-texttext-transparent"  />E Commerce Development
              </span>
            </h1>

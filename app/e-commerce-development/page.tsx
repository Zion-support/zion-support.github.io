...
const E Commerce Development Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">E commerce development</h1>
            <p>
...
export default E;; Commerce Development Page

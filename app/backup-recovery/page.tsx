...
const benefits = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"> " <Helmet>"
        ...
        <meta name="description" content="Professional Backup & Recovery services by Zion Tech Group. Advanced AI and IT solutions for your business." /> " <meta name="keywords" content="backup recovery, data protection, disaster recovery, AI solutions, IT services, Zion Tech Group" />"
      </Helmet>
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">"
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-center space-x-3">}}"
                <CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0" /> " <span className="text-gray-300">{benefit}</span> " </div>"
            ));
          </div>
        </div>
      </section>
      {/* CTA Section */}
      <section className="py-16 px-4">"
        <div className="max-w-4xl mx-auto text-center"> " <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">"

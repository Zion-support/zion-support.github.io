...
import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Zap, Shield, Brain, Globe, Database, Clock, ShieldCheck  } from 'lucide-react';const BackupRecoveryPage: React.FC  = () => {
  const features = [
    {
    }
  ]
...
<meta name="keywords" content="backup recovery, data protection, IT services, Zion Tech Group, disaster recovery" />
      ...
      <div className="container mx-auto px-4 py-16"></div>
        <div className="text-center mb-16"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
                {features.map((feature, index) => (
              </div><div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10"></div>

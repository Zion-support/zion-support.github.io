  ...
  const features = [
    {
      ...
      description: 'Automated backup solutions that protect your data 24/7'
    },
    {
      icon: ShieldCheck,
      title: 'Data Security',
      description: 'Enterprise-grade encryption and security for your backups'
    },
    {
      icon: Clock,
      title: 'Fast Recovery',
      description: 'Quick recovery times to minimize business downtime'
    },
    {
      icon: Globe,
      title: 'Cloud Storage',
      description: 'Secure cloud storage with global redundancy'
    }
  ];
      ...
      <section className="py-16 px-4 bg-white/5">
        <div className="max-w-7 xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3 xl md:text-4 xl font-bold text-white mb-4">Key Benefits</h2>
            <p className="text-xl text-gray-300 max-w-3 xl mx-auto">

...
const BackupRecoveryPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional backup recovery services and solutions by Zion Tech Group."
      keywords="backup recovery, services, solutions, technology, Zion Tech Group"
    >

  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to optimize backup strategies and ensure data protection'
    },
    {
      icon: Zap,
      title: 'Fast Recovery',
      description: 'Lightning-fast data recovery and restoration for minimal downtime'
    },
    {
      icon: Shield,

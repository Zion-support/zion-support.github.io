...
<h1 className="text-5xl font-bold text-white mb-6" loading="lazy">Backup & Recovery</h1>
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" loading="lazy">Transform your business with our advanced backup and recovery solutions.</p>
...
<h2 className="text-3xl md:text-4xl font-bold text-white mb-4" loading="lazy">Why Choose Our Backup & Recovery?</h2>h2>
<p className="text-xl text-gray-300 max-w-3xl mx-auto" loading="lazy">Our backup and recovery solutions deliver unmatched performance, security, and scalability.</p>
</div>
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" loading="lazy">{features.map((feature, index) => (
<div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10" loading="lazy">
<feature.icon className="w-12 h-12 text-purple-400 mb-4" loading="lazy" />
<h3 className="text-xl font-semibold text-white mb-2" loading="lazy">{feature.title}</h3>
...
{/* Benefits Section */}
<section className="py-16 px-4 bg-white/5" loading="lazy">
<div className="max-w-7xl mx-auto" loading="lazy">
<div className="text-center mb-12" loading="lazy">
<h2 className="text-3xl md:text-4xl font-bold text-white mb-4" loading="lazy">Key Benefits</h2>
<p className="text-xl text-gray-300 max-w-3xl mx-auto" loading="lazy">Experience the power of our backup and recovery solutions for your business.</p>
</div>
...
<CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0" loading="lazy" />
...
<p className="text-xl text-purple-100 mb-8" loading="lazy">Contact our experts to discuss your backup and recovery needs and get a customized solution.</p>
...
<h2 className="text-3xl font-bold text-white mb-6" loading="lazy">Ready to Get Started?</h2>h2>
<p className="text-xl text-purple-100 mb-8" loading="lazy">Contact our experts to discuss your backup and recovery needs and get a customized solution.</p>
<div className="flex flex-col sm:flex-row gap-4 justify-center" loading="lazy">
<button className="bg-white text-purple-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 flex items-center justify-center" loading="lazy" aria-label="Action button">
<Phone className="mr-2 h-5 w-5" loading="lazy" />

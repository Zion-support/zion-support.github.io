...
import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Zap, Shield, Brain, Globe, HardDrive, Cloud, RefreshCw } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Automated backup solutions with intelligent scheduling and data integrity verification'
    },
    {
      icon: Cloud,
      title: 'Cloud Storage',
      description: 'Secure cloud-based backup storage with global redundancy and high availability'
    },
    {
      icon: RefreshCw,
      title: 'Fast Recovery',
      description: 'Rapid data recovery with minimal downtime and point-in-time restoration capabilities'
    },
    {
      icon: Shield,
      title: 'Enterprise Security',
      description: 'Bank-level security with encryption and compliance standards for data protection'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              Powered by cutting-edge data protection technology and industry expertise.
            </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the power of our comprehensive backup and recovery solutions for your business.
            </p>
          </div>

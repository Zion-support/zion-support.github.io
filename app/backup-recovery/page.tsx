  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        ...
        <meta name="description" content="Advanced Backup Recovery solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Backup Recovery solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

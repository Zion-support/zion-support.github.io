...
export const metadata: Metadata = {
  ...
  description:
    'Backup Recovery delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster ',
  alternates: { canonical: '/backup-recovery' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Backup Recovery delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Backup Recovery',
      }}
    />
  );
}

  ...
  const features = [
    {
      ...
      description: 'Advanced backup technology to protect your critical data and ensure business continuity'
    },
    {
      icon: Zap,
      title: 'Fast Recovery',
      description: 'Lightning-fast data recovery with minimal downtime for your business operations'
    },
    {
      icon: Brain,
      title: 'AI-Powered Monitoring',
      description: 'Intelligent monitoring and automated backup verification using AI technology'
    },
    {
      icon: Globe,
      title: 'Global Coverage',
      description: 'Worldwide backup infrastructure with multiple data centers for maximum reliability'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="keywords" content="backup recovery, data protection, IT services, Zion Tech Group, business continuity" />
      </Helmet>

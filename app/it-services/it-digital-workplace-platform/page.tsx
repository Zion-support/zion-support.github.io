...
export const metadata: Metadata = {
  ...
  description: "Digital Workplace Platform — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-digital-workplace-platform" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Digital Workplace Platform', href: '/it-services/it-digital-workplace-platform' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "PCI DSS Compliance Suite — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-pcii-compliance-suite" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'PCI DSS Compliance Suite', href: '/it-services/it-pcii-compliance-suite' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  title: 'Serverless Architecture & Microservices | Zion Tech Group',
  description: 'Cloud-native serverless solutions with event-driven microservices, API gateways, function-as-a-service, and auto-scaling for maximum efficiency.',
  alternates: { canonical: '/it-services/serverless-architecture' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with Serverless Architecture & Microservices',
        pricing: [

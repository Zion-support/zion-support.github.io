...
export const metadata: Metadata = {
  title: "Incident Response Retainer (IR) | Zion Tech Group",
  description: "Incident Response Retainer (IR) — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/incident-response-retainer" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Incident Response Retainer (IR)', href: '/it-services/incident-response-retainer' },
        ],
      }
    />
  );

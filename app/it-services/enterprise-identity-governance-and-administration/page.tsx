...
export const metadata: Metadata = {
  title: "Enterprise Identity Governance & Administration — Zion Tech Group",
  description: "Enterprise IT service: Enterprise Identity Governance & Administration. Robust, scalable, secure.",
  keywords: "AI services, IT services, Enterprise Identity Governance & Administration",
  openGraph: {
...
export default function EnterpriseIdentityGovernanceAndAdministrationPage() {
  return (

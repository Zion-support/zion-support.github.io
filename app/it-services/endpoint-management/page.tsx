...
export const metadata: Metadata = {
  title: 'Endpoint Device Management (MDM) | Zion Tech Group',
  description: 'Centralized management of all endpoints — laptops, mobile devices, IoT — with automated patching, application deployment, and security policy enforcement.',
  alternates: { canonical: '/it-services/endpoint-management' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with Endpoint Device Management (MDM)',
        pricing: [

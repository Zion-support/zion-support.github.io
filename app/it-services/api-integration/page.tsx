...
export const metadata: Metadata = {
  ...
  description: 'REST/GraphQL APIs, third-party integrations, webhooks, and API gateway.',
  alternates: { canonical: '/it-services/api-integration' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with API Development & Integration',
        pricing: [

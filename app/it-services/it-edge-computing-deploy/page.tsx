...
export const metadata: Metadata = {
  ...
  description: "Edge Computing Deployment — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-edge-computing-deploy" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Edge Computing Deployment', href: '/it-services/it-edge-computing-deploy' },
        ],
      }
    />
  );

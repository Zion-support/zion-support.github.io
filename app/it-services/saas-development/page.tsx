...
export const metadata: Metadata = {
  ...
  description: 'Full-stack SaaS from MVP in 4-6 weeks to enterprise scale.',
  alternates: { canonical: '/it-services/saas-development' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with SaaS Product Development',
        pricing: [

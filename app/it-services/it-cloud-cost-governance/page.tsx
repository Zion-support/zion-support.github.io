...
export const metadata: Metadata = {
  ...
  description: "IT Cloud Cost Governance — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-cloud-cost-governance" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'IT Cloud Cost Governance', href: '/it-services/it-cloud-cost-governance' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "Secure File Transfer (MFT) — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-secure-file-transfer" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Secure File Transfer (MFT)', href: '/it-services/it-secure-file-transfer' },
        ],
      }
    />
  );

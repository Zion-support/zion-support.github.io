...
export const metadata: Metadata = {
  ...
  description: "Unified Observability Platform — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-observability-unified" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Unified Observability Platform', href: '/it-services/it-observability-unified' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/it-services/edge-computing' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        pricing: [
          { tier: 'Starter', price: '$1299', period: '/month', features: ['Core monitoring & alerting', 'Monthly compliance reports', 'Email support', 'Up to 50 endpoints'] },
          { tier: 'Professional', price: '$2999', period: '/month', features: ['All Starter features', 'Advanced analytics & dashboards', 'Priority support with SLA', 'Up to 500 endpoints', 'Custom integrations'] },
          { tier: 'Enterprise', price: '$6499', period: '/month', features: ['Everything in Professional', 'Dedicated account manager', '24/7 phone support', 'Unlimited endpoints', 'Custom SLA guarantees', 'On-site deployment support'] },
        ],
        contact: {

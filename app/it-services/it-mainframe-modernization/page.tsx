...
export const metadata: Metadata = {
  ...
  description: "Mainframe Modernization Service — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-mainframe-modernization" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Mainframe Modernization Service', href: '/it-services/it-mainframe-modernization' },
        ],
      }
    />
  );

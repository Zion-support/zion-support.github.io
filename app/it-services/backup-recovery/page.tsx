...
export const metadata: Metadata = {
  title: 'Backup and Disaster Recovery Solutions | Zion Tech Group',
  description: 'Enterprise backup with immutable storage, multi-region replication, and one-click failover.',
  alternates: { canonical: '/it-services/backup-recovery' },
};

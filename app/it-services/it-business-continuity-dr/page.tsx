...
export const metadata: Metadata = {
  ...
  description: "Business Continuity & Disaster Recovery — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-business-continuity-dr" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Business Continuity & Disaster Recovery', href: '/it-services/it-business-continuity-dr' },
        ],
      }
    />
  );

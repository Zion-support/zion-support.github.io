...
export const metadata: Metadata = {
  title: 'Cloud Cost Optimization (FinOps) | Zion Tech Group',
  description: 'Multi-cloud visibility, ML right-sizing, RI/SP optimization, saving 35%% average.',
  alternates: { canonical: '/it-services/cloud-cost-optimization' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with Cloud Cost Optimization (FinOps)',
        pricing: [

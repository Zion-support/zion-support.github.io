...
export const metadata: Metadata = {
  ...
  description: "Legacy System Modernization & Re-Platforming — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/legacy-system-modernization" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Legacy System Modernization & Re-Platforming', href: '/it-services/legacy-system-modernization' },
        ],
      }
    />
  );

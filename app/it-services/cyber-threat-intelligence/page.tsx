...
export const metadata: Metadata = {
  ...
  description: "AI Cyber Threat Intelligence Platform — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/cyber-threat-intelligence" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Cyber Threat Intelligence Platform', href: '/it-services/cyber-threat-intelligence' },
        ],
      }
    />
  );

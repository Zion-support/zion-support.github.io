...
export const metadata: Metadata = {
  ...
  description: "Disaster Recovery as a Service (DRaaS) — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-disaster-recovery" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Disaster Recovery as a Service (DRaaS)', href: '/it-services/it-disaster-recovery' },
        ],
      }
    />
  );

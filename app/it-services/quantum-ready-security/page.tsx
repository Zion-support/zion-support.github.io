...
export const metadata: Metadata = {
  title: "Quantum-Ready Cryptography & Security Assessment | Zion Tech Group",
  description: "Quantum-Ready Cryptography & Security Assessment — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/quantum-ready-security" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Quantum-Ready Cryptography & Security Assessment', href: '/it-services/quantum-ready-security' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "Multi-Cloud Networking — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-multi-cloud-networking" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Multi-Cloud Networking', href: '/it-services/it-multi-cloud-networking' },
        ],
      }
    />
  );

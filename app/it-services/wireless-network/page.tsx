...
export const metadata: Metadata = {
  title: 'Wireless Network Design and Optimization | Zion Tech Group',
  description: 'Enterprise Wi-Fi design, RF surveys, capacity planning, and optimization for campuses, warehouses, and smart buildings.',
  alternates: { canonical: '/it-services/wireless-network' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'Wireless Network Design and Optimization',
        ...
        pricing: [
          { tier: 'Starter', price: '$2999', period: '/month', features: ['Core features', 'Monthly reports', 'Email support', 'Up to 50 endpoints'] },
          { tier: 'Professional', price: '$7499', period: '/month', features: ['All Starter', 'Advanced analytics', 'Priority SLA', 'Up to 500 endpoints', 'Custom integrations'] },
          { tier: 'Enterprise', price: '$18999', period: '/month', features: ['Everything in Pro', 'Dedicated manager', '24/7 phone support', 'Unlimited', 'Custom SLA', 'On-site'] },
        ],
        contact: {

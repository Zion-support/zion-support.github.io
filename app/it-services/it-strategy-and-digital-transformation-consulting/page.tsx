...
export const metadata: Metadata = {
  ...
  keywords: "AI services, IT services, IT Strategy & Digital Transformation Consulting",
  openGraph: {
...
export default function ItStrategyAndDigitalTransformationConsultingPage() {
  return (

...
export const metadata: Metadata = {
  ...
  description: "Cloud-Native Storage Optimizer — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-cloud-native-storage" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Cloud-Native Storage Optimizer', href: '/it-services/it-cloud-native-storage' },
        ],
      }
    />
  );

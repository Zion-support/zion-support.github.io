...
export const metadata: Metadata = {
  ...
  description: "Identity Governance & Administration — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-identity-governance" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Identity Governance & Administration', href: '/it-services/it-identity-governance' },
        ],
      }
    />
  );

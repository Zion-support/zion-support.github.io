...
export const metadata: Metadata = {
  title: 'IT Strategy & Digital Transformation | Zion Tech Group',
  description: 'Tech stack assessment, transformation roadmaps, fractional CTO, and vendor evaluation.',
  alternates: { canonical: '/it-services/it-consulting' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with IT Strategy & Digital Transformation',
        pricing: [

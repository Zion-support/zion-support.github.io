...
export const metadata: Metadata = {
  title: 'Data Mesh and Modern Data Platform Architecture | Zion Tech Group',
  description: 'Implement data mesh with domain-oriented data ownership, self-serve infrastructure, and federated computational governance.',
  alternates: { canonical: '/it-services/data-mesh' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'Data Mesh and Modern Data Platform Architecture',
        ...
        pricing: [
          ...
          { tier: 'Professional', price: '$6999', period: '/month', features: ['All Starter', 'Advanced analytics', 'Priority SLA', 'Up to 500 endpoints', 'Custom integrations'] },
          { tier: 'Enterprise', price: '$16999', period: '/month', features: ['Everything in Pro', 'Dedicated manager', '24/7 phone support', 'Unlimited', 'Custom SLA', 'On-site'] },
        ],
        contact: {

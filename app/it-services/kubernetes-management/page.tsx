...
export const metadata: Metadata = {
  title: 'Container Orchestration and Kubernetes Management | Zion Tech Group',
  description: 'Enterprise Kubernetes deployment, management, and optimization minus multi-cluster orchestration, GitOps workflows, and service mesh implementation.',
  alternates: { canonical: '/it-services/kubernetes-management' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'Container Orchestration and Kubernetes Management',

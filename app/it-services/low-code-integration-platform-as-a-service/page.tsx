...
export const metadata: Metadata = {
  title: "Low-Code Integration Platform as a Service — Zion Tech Group",
  description: "Enterprise IT service: Low-Code Integration Platform as a Service. Robust, scalable, secure.",
  keywords: "AI services, IT services, Low-Code Integration Platform as a Service",
  openGraph: {
...
export default function LowcodeIntegrationPlatformAsAServicePage() {
  return (

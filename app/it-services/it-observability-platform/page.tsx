...
export const metadata: Metadata = {
  ...
  description: "Full-Stack Observability Platform — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-observability-platform" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Full-Stack Observability Platform', href: '/it-services/it-observability-platform' },
        ],
      }
    />
  );

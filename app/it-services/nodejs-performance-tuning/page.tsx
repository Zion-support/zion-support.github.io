...
export const metadata: Metadata = {
  ...
  description: "Node.js Performance Tuning & Profiling — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/nodejs-performance-tuning" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Node.js Performance Tuning & Profiling', href: '/it-services/nodejs-performance-tuning' },
        ],
      }
    />
  );

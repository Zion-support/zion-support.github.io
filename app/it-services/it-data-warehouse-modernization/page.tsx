...
export const metadata: Metadata = {
  ...
  description: "Data Warehouse Modernization — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-data-warehouse-modernization" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Data Warehouse Modernization', href: '/it-services/it-data-warehouse-modernization' },
        ],
      }
    />
  );

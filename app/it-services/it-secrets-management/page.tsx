...
export const metadata: Metadata = {
  ...
  description: "Secrets Management as a Service — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-secrets-management" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Secrets Management as a Service', href: '/it-services/it-secrets-management' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: 'Evaluate your organization quantum readiness, identify cryptographic vulnerabilities, and develop migration strategies for post-quantum security.',
  alternates: { canonical: '/it-services/quantum-readiness' },
};

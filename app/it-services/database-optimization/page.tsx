...
export const metadata: Metadata = {
  ...
  description: 'Query tuning, schema design, HA clustering, automated backups for PostgreSQL/MySQL/MongoDB.',
  alternates: { canonical: '/it-services/database-optimization' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with Database Optimization & Management',
        pricing: [

...
export const metadata: Metadata = {
  ...
  description: "Low-Code Platform Customization & Integration — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/low-code-platform-customization" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Low-Code Platform Customization & Integration', href: '/it-services/low-code-platform-customization' },
        ],
      }
    />
  );

      ...
      <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <div className="cyber-card p-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  </div><div className="w-2 h-2 bg-cyan-400 rounded-full"><span className="text-gray-300">Network security assessment</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-cyan-400 rounded-full"><span className="text-gray-300">Application security testing</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-cyan-400 rounded-full"><span className="text-gray-300">Social engineering tests</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-cyan-400 rounded-full"><span className="text-gray-300">Compliance verification</span>
                </div>
              </div>
              <div className="space-y-4">
                </div><div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-pink-400 rounded-full"><span className="text-gray-300">Incident response planning</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-pink-400 rounded-full"><span className="text-gray-300">Security policy review</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-pink-400 rounded-full"><span className="text-gray-300">Employee training</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-pink-400 rounded-full"><span className="text-gray-300">Remediation support</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="cyber-card p-8 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  </div><div className="w-2 h-2 bg-cyan-400 rounded-full"><span className="text-gray-300">SOC 2 Type II</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-cyan-400 rounded-full"><span className="text-gray-300">ISO 27001</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-cyan-400 rounded-full"><span className="text-gray-300">PCI DSS</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-cyan-400 rounded-full"><span className="text-gray-300">HIPAA</span>
                </div>
              </div>
              <div className="space-y-4">
                </div><div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-pink-400 rounded-full"><span className="text-gray-300">GDPR</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-pink-400 rounded-full"><span className="text-gray-300">NIST Framework</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-pink-400 rounded-full"><span className="text-gray-300">CIS Controls</span>
                </div>
                <div className="flex items-center space-x-3">
                  </div><div className="w-2 h-2 bg-pink-400 rounded-full"><span className="text-gray-300">Custom Requirements</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <ul className="text-gray-300 space-y-2">
                <li>Vulnerability scan</li><li>Basic penetration test</li>
                <li>Security report</li><li>30-day support</li>
              </ul>
            </div>
            <div className="cyber-card p-6 text-center border-2 border-cyan-400">
              ...
              <ul className="text-gray-300 space-y-2">
                <li>Full penetration test</li><li>Social engineering</li>
                <li>Compliance check</li><li>90-day support</li><li>Remediation plan</li>
              </ul>
            </div>
            <div className="cyber-card p-6 text-center">
              ...
              <ul className="text-gray-300 space-y-2">
                <li>Complete security audit</li><li>Red team exercise</li>
                <li>Compliance certification</li><li>6-month support</li><li>Dedicated team</li>
              </ul>
            </div>
          </div>

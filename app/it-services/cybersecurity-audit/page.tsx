...
export default function CybersecurityauditPa g e() {
return (
    <div className="min-h-screen bg-gradient-to-brfrom-slate-900via-purple-900to-slate-900pt-20">
      ...
      <div className="max-w-7xl mx-autopx-4sm:px-6lg:px-8py-16tex t-center">
        <h1 className="text-4xl font-boldtext-whitemb-6"  >Cybersecuri t y Audit</h1>
        <p className="text-lg text-gray-300 mb-8">Professional cybersecuri t y audit services coming soon.</p>
        <Link
          to="/contact"

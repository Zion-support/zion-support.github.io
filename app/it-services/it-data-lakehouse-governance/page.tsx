...
export const metadata: Metadata = {
  ...
  description: "Data Lakehouse Governance — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-data-lakehouse-governance" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Data Lakehouse Governance', href: '/it-services/it-data-lakehouse-governance' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "Legacy App Containerization — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-legacy-app-containerization" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Legacy App Containerization', href: '/it-services/it-legacy-app-containerization' },
        ],
      }
    />
  );

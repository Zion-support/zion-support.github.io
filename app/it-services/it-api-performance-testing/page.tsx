...
export const metadata: Metadata = {
  title: "IT API Load & Performance Testing | Zion Tech Group",
  description: "IT API Load & Performance Testing — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-api-performance-testing" },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={
        title: "IT API Load & Performance Testing",
        ...
        breadcrumb: [
          ...
          { label: 'IT API Load & Performance Testing', href: '/it-services/it-api-performance-testing' },
        ],
      }
    />
  );

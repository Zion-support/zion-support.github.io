...
export const metadata: Metadata = {
  title: 'Digital Twin and IoT Platform Development | Zion Tech Group',
  description: 'Build real-time digital replicas of physical systems minus factory floors, supply chains, and smart cities with predictive simulation.',
  alternates: { canonical: '/it-services/digital-twin-platform' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'Digital Twin and IoT Platform Development',

...
export const metadata: Metadata = {
  title: "Multi-Cloud Cost Visibility & Optimization — Zion Tech Group",
  description: "Enterprise IT service: Multi-Cloud Cost Visibility & Optimization. Robust, scalable, secure.",
  keywords: "AI services, IT services, Multi-Cloud Cost Visibility & Optimization",
  openGraph: {
...
export default function MulticloudCostVisibilityAndOptimizationPage() {
  return (

...
export const metadata: Metadata = {
  ...
  description: "Serverless API Gateway — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-serverless-api-gateway" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Serverless API Gateway', href: '/it-services/it-serverless-api-gateway' },
        ],
      }
    />
  );

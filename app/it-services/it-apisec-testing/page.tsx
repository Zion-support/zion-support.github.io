...
export const metadata: Metadata = {
  ...
  description: "API Security Testing — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-apisec-testing" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'API Security Testing', href: '/it-services/it-apisec-testing' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  title: '5G Network Planning and Deployment | Zion Tech Group',
  description: 'End-to-end 5G network architecture, RF planning, edge computing integration, and private 5G deployment for enterprise campuses.',
  alternates: { canonical: '/it-services/5g-network-deployment' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: '5G Network Planning and Deployment',

...
<p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto"></p><//p>
                Comprehensive technology solutions to power your business growth and digital transformation</p><>
<//p>
</p><>
<//p>
<div className="flex flex-col sm:flex-row gap-4 justify-center"></div><>
<//div>
<button className="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-colors"></button><//button>
                  Get Free Assessment</button><>
<//button>
</button><>
<//button>
<button className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors"></button><//button>
...
<h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"></h1><//h1>
                Why Choose Our IT Services?</h1><>
<//h1>
</h2><>
<//h2>
<p className="text-xl text-gray-600"></p><//p>
                Expert solutions delivered by certified professionals with proven track records</p><>
<//p>
</p><>
<//p>
</div><>
...
<p className="text-xl text-gray-600"></p><//p>
                  Professional {category.toLowerCase()} solutions tailored to your business needs</p><>
<//p>
</p><>
<//p>
</div><>
...
<h2 className="text-3xl md:text-4xl font-bold mb-4"></h1><//h1>
              Ready to Transform Your IT Infrastructure?</h1><>
<//h1>
</h2><>
<//h2>
<p className="text-xl mb-8 text-blue-100"></p><//p>
              Contact our certified IT experts for a free consultation and custom solution design</p><>
<//p>
</p><>
<//p>
<div className="flex flex-col sm:flex-row gap-4 justify-center"></div><>

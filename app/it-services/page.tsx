...
import { CheckCircle, ArrowRight, Cloud, Shield, Code, Database, Smartphone, DollarSign, Clock, Users, Server, Network, Settings, Globe, Lock, Monitor, HardDrive, Wifi, Cpu, Zap } from 'lucide-react';
  ...
  const itServices = [
    {
      ...
      description: 'Seamlessly migrate your infrastructure to AWS, Azure, or GCP with zero downtime, enhanced security, and cost optimization.',
      features: ['AWS/Azure/GCP migration', 'Zero downtime migration', 'Cost optimization', 'Security compliance', 'Multi-cloud strategy', 'Backup solutions'],
    ...
    },
    {
      ...
      description: 'Comprehensive security solutions including threat detection, penetration testing, compliance management, and 24/7 monitoring.',
      features: ['Security audit', 'Penetration testing', 'Compliance management', '24/7 monitoring', 'Incident response', 'Security training'],
    ...
    },
    {
      ...
      title: 'DevOps & CI/CD',
      description: 'Streamline your development process with automated deployment, continuous integration, and container orchestration.',
      features: ['CI/CD pipeline setup', 'Docker containerization', 'Kubernetes orchestration', 'Monitoring setup', 'Infrastructure as Code', 'Automated testing'],
    ...
    },
    {
      ...
      description: 'Expert database design, optimization, and maintenance services for optimal performance and data security.',
      features: ['Database design', 'Performance tuning', 'Backup & recovery', 'Migration services', 'Security hardening', 'Data analytics'],
    ...
    },
    {
      ...
      description: 'Custom mobile applications for iOS and Android platforms with native performance and modern UI/UX design.',
      features: ['Native iOS/Android apps', 'Cross-platform solutions', 'UI/UX design', 'App store deployment', 'Push notifications', 'Analytics integration'],
    ...
    },
    {
      ...
      features: ['Server setup & configuration', 'Network monitoring', 'Performance optimization', '24/7 support', 'Disaster recovery', 'Capacity planning'],
    ...
    },
    {
      ...
      description: 'Network design, implementation, and ongoing management services including VPN, firewall, and bandwidth optimization.',
      features: ['Network design', 'VPN setup', 'Firewall configuration', 'Bandwidth optimization', 'Network security', 'Wireless solutions'],
    ...
    },
    {
      ...
      description: 'Complete system administration and maintenance for Windows, Linux, and macOS environments.',
      features: ['User management', 'System updates', 'Performance monitoring', 'Troubleshooting', 'Documentation', 'Security patches'],
    ...
    },
    {
      ...
      description: 'Custom web applications and websites with modern frameworks, responsive design, and SEO optimization.',
      features: ['Custom web apps', 'Responsive design', 'SEO optimization', 'E-commerce solutions', 'CMS development', 'API integration'],
    ...
    },
    {
      ...
      description: 'Comprehensive data backup solutions with automated scheduling, off-site storage, and disaster recovery planning.',
      features: ['Automated backups', 'Off-site storage', 'Disaster recovery', 'Data encryption', 'Recovery testing', 'Compliance reporting'],
    ...
    },
    {
      ...
      description: '24/7 technical support and helpdesk services for your employees and end-users.',
      features: ['24/7 support', 'Remote assistance', 'Ticket management', 'Knowledge base', 'User training', 'Problem resolution'],
    ...
    },
    {
      ...
      features: ['Technology assessment', 'Strategic planning', 'Vendor evaluation', 'Cost analysis', 'Implementation roadmap', 'Change management'],

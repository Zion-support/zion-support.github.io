...
export default function ITServices() {,
  const itServices = [
    ...
    {,
      ...
      icon: <Code className="w-8 h-8" /></Code>
    ...
    {,
      ...
      icon: <Headphones className="w-8 h-8" /></Headphones>
    ...
    {,
      ...
      icon: <Smartphone className="w-8 h-8" /></Smartphone>
    ...
    {,
      ...
      icon: <Monitor className="w-8 h-8" /></Monitor>
    ...
    {,
      ...
      icon: <HardDrive className="w-8 h-8" /></HardDrive>
  ...
  return()
    <div /></div>
      <Helmet /></Helmet>
        ...
        <meta name="description" content="Comprehensive IT services including cloud infrastructure, cybersecurity, software development, and system integration. Expert solutions for modern businesses." / /></meta>
        <meta name="keywords" content="IT services, cloud infrastructure, cybersecurity, software development, system integration, IT consulting, technology solutions" / /></meta>
        <link rel="canonical" href="https://ziontechgroup.com/it-services" / /></link>
      </Helmet>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" />)
              {itServices.map((service, index) => (,
                <div;
                 ...
                 /></div>
                  <div className={`w-12 h-12 md:w-16 md:h-16 rounded-lg bg-gradient-to-r ${service.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`} /></div>
                    {service.icon}
                  </div>
                  <h3 className="text-lg md:text-xl font-semibold text-white mb-3 group-hover:text-cyan-400 transition-colors" /></h3>
                    {service.name}
                  </h3>
                  <p className="text-gray-300 mb-4 leading-relaxed text-sm md:text-base" /></p>
                    {service.description}
                  </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" /></div>
              {processSteps.map((step, index) => (
                <div key={index} className="text-center group" /></div>
                  <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300" /></div>
                    {step.icon}
                  </div>

...
const ITServicesPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <d iv c las sName="m in-h-screen bg-grad ient-to-br from-slate-900via-cyan-900to-slate-900">
        {/* H ero Section */}
    <>
        </><section c las sName="r e lative over flow-h iddenpt-20-pb-16" />
              {services.map((service, index) => (
                <d iv 
                  key="{index}"
                  c las sName="b g-grad ient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-8 hover:border-cyan-400/40 transition-all duration-300 grouphover:transformhover:scale-105" />
    <>
                    ...
                    <service.icon c las sName="w-8h-8t ext-w hite" />
                  </d iv>
    </>
              {process.map((step, index) => (
    <>
                </><d iv key="{index}" c las sName="t ext-centergroup" />

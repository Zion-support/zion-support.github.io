...
import { Cloud, Shield, Settings, Database, Briefcase, Globe, Smartphone, Code, BarChart, Wrench, Lock, Cpu, Link, HardDrive, FileCheck, CheckCircle, Phone, Mail, MapPin } from 'lucide-react';
  ...
  return (
    <>
      <SEOEnhancer
        ...
        description="Professional IT services including cloud migration, cybersecurity, DevOps, database management, and enterprise solutions. Transform your technology infrastructure with our expert team."
        keywords={['IT services', 'cloud migration', 'cybersecurity', 'DevOps', 'database services', 'enterprise solutions', 'IT consulting']}
        ...
        <main className="container mx-auto px-4 py-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto">
              From cloud migration to cybersecurity, our expert team delivers cutting-edge IT solutions that drive business growth, 
              enhance security, and optimize performance across your entire technology stack.
            </p>
          </section>
          ...
          {/* Why Choose Us */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-white text-center mb-12 neon-text">Why Choose Our IT Services?</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="cyber-card p-6 text-center">
                <div className="text-4xl mb-4">🔒</div>
                <h3 className="text-xl font-bold text-white mb-3 neon-text">Enterprise Security</h3>
                <p className="text-gray-300">
                  Bank-level security protocols and compliance standards to protect your critical business data and infrastructure.
                </p>
              </div>
              <div className="cyber-card p-6 text-center">
                <div className="text-4xl mb-4">⚡</div>
                ...
                <p className="text-gray-300">
                  Round-the-clock monitoring and support to ensure your systems run smoothly and efficiently at all times.
                </p>
              </div>
              <div className="cyber-card p-6 text-center">
                <div className="text-4xl mb-4">🚀</div>
                ...
                <p className="text-gray-300">
                  Future-proof technology solutions that grow with your business and adapt to changing requirements.
                </p>
              </div>
            </div>
          </section>
          ...
          {/* Process */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-white text-center mb-12 neon-text">Our Process</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">Comprehensive analysis of your current IT infrastructure and requirements</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">Strategic roadmap development with clear milestones and deliverables</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">Expert execution with minimal disruption to your business operations</p>
              </div>
              <div className="text-center">

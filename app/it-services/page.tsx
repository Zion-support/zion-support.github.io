        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              ...
              running smoothly and securely. Our expert team delivers reliable, scalable solutions tailored to your needs.
            </p>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                ...
                <p className="text-gray-300 mb-4">Bank-level security protocols and compliance standards to protect your critical business data and infrastructure.</p>
              </div>
              
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                <div className="text-4xl mb-4">⚡</div>
                <h3 className="text-xl font-bold text-white mb-3 neon-text">24/7 Support</h3>
                <p className="text-gray-300 mb-4">Round-the-clock monitoring and support to ensure your systems are always running at peak performance.</p>
              </div>
              
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                <div className="text-4xl mb-4">🚀</div>
                <h3 className="text-xl font-bold text-white mb-3 neon-text">Scalable Solutions</h3>
                <p className="text-gray-300 mb-4">Flexible, scalable IT infrastructure that grows with your business and adapts to changing needs.</p>
              </div>
            </div>
          </section>
          ...
          <section className="text-center">
            <div className="cyber-card p-8 max-w-4xl mx-auto">
              ...
              <p className="text-gray-300 mb-6 text-lg">
                Contact our IT experts today to discuss how our services can optimize your technology infrastructure and drive business growth.
              </p>

...
import { CheckCircle, ArrowRight, Server, Shield, Cloud, Database, Network, Settings, Users, Clock, DollarSign, Star, Code, Smartphone, Globe } from 'lucide-react';
...
const ItServicesPage: React.FC = () => {
  const itServices = [
    ...
    },
    {
      ...
      features: ['Web applications', 'API development', 'Microservices', 'Legacy modernization', 'Mobile apps'],
    ...
    },
    {
      ...
      features: ['Native iOS/Android', 'React Native', 'UI/UX design', 'App store deployment', 'Maintenance'],
    ...
    },
    {
      ...
      features: ['Responsive design', 'SEO optimization', 'Performance tuning', 'Security implementation', 'CMS integration'],
      pricing: 'Starting at $1,500/project',
      category: 'Web'
    }
  ];

  const categories = ['All', 'Infrastructure', 'Security', 'Cloud', 'Database', 'Network', 'Support', 'Development', 'Mobile', 'Web'];

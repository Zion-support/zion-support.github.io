...
const ItServicesPage: React.FC = () => {
  const itServices = [
    ...
    },
    {
      ...
      description: 'Comprehensive network security solutions including firewall management and intrusion detection.',
    ...
    },
    {
      ...
      title: 'IT Consulting',
      description: 'Strategic IT consulting to help optimize your technology infrastructure and processes.',
      features: ['Technology assessment', 'Strategic planning', 'Vendor management', 'Process optimization', 'ROI analysis'],
    ...
    },
    {
      ...
      description: 'Professional data recovery services for lost or corrupted data from various storage devices.',
      features: ['Hard drive recovery', 'RAID recovery', 'SSD recovery', 'Cloud data recovery', 'Emergency response'],
      pricing: 'Starting at $200/case',
      link: '/data-recovery',
      popular: false,
      duration: 'As needed'
    },
    {
      ...
      description: 'Specialized cloud security services to protect your cloud infrastructure and data.',
      features: ['Cloud security audit', 'Identity management', 'Data encryption', 'Compliance monitoring', 'Threat detection'],
    ...
    },
    {
      ...
      description: 'Secure and efficient data migration services between different systems and platforms.',
      features: ['Data mapping', 'Migration planning', 'Data validation', 'Zero downtime', 'Rollback planning'],

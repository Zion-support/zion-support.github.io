  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Professional IT services including cloud migration, cybersecurity, web development, mobile apps, database management, and more. Trusted by 500+ businesses."
        keywords="IT services, cloud migration, cybersecurity, web development, mobile apps, database management, network infrastructure, IT consulting, DevOps, data analytics"

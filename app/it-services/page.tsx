...
import { 
  ...
  Heart as HeartIcon3,
  Eye as EyeIcon3,
  ThumbsUp as ThumbsUpIcon3
} from 'lucide-react';
import { itServices, itServiceCategories } from '../../src/data/itServicesData';
...
export default function ITServicesPage() {
  ...
  const categories = ['All', ...itServiceCategories.map(cat => cat.name)];
                  ...
                  <div className="border-t border-gray-700 pt-6">
                    <div className="text-center mb-6">
                      <div className="text-3xl font-bold text-cyan-400 mb-2 neon-text-advanced">
                        {service.pricing.monthly > 0 ? formatPrice(service.pricing.monthly) : 'Custom'}
                        {service.pricing.monthly > 0 && <span className="text-lg text-gray-400">/month</span>}
                      </div>

...
import { CheckCircle, ArrowRight, Server, Shield, Cloud, Database, Code, Smartphone, DollarSign, Star } from 'lucide-react';
...
export default function ITServicesPage() {
  const services = [
    ...
    },
    {
      ...
      description: 'Protect your business with comprehensive security solutions including threat detection and prevention.',
      features: ['24/7 monitoring', 'Threat detection', 'Security audits', 'Compliance management'],
    ...
    },
    {
      ...
      description: 'Build powerful mobile applications for iOS and Android with modern frameworks and best practices.',
    ...
    },
    {
      ...
      title: 'DevOps & CI/CD',
      description: 'Streamline your development process with automated deployment and continuous integration pipelines.',
    ...
    },
    {
      ...
      description: 'Manage and optimize your IT infrastructure with proactive monitoring and maintenance services.',
  ...
  const features = [
    {
      ...
      description: 'Our certified professionals have extensive experience in enterprise IT solutions and cloud technologies.'
    },
    {
      icon: <CheckCircle className="w-6 h-6 text-green-500" />,
      title: '24/7 Support',
    ...
    },
    {
      ...
      description: 'Our IT services are designed to grow with your business and adapt to changing needs.'
    },
    {
      icon: <CheckCircle className="w-6 h-6 text-green-500" />,
      title: 'Security First',
      description: 'We prioritize security in all our solutions to protect your data and business operations.'
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: 'The cloud migration was seamless and our performance improved by 40%. Highly recommended!',
      rating: 5
    },
    {
      name: 'Lisa Martinez',
      company: 'TechStart Inc',
      content: 'Their cybersecurity solutions protected us from multiple threats. We feel much more secure now.',
      rating: 5
    },
    {
      name: 'Robert Kim',
      company: 'DataFlow Systems',
      content: 'The mobile app they developed increased our user engagement by 60%. Excellent work!',
      rating: 5
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Comprehensive IT services including cloud migration, cybersecurity, mobile development, and infrastructure management for modern businesses." />
        <meta name="keywords" content="IT services, cloud migration, cybersecurity, mobile development, DevOps, infrastructure management" />
      </Helmet>

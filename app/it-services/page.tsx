...
const ItServicesPage: React.FC = () => {
  ...
  const benefits = [
    {
      title: 'Cost Effective',</Users>,
      description: 'Reduce IT costs by up to 40% with our optimized solutions',</Users>,
      icon: <DollarSign className="w-6 h-6 text-green-500" />},
    {
      title: 'Fast Delivery',</DollarSign>,
      description: 'Quick turnaround times with agile development methodologies',</DollarSign>,
      icon: <Clock className="w-6 h-6 text-blue-500" />},
    {
      title: 'Expert Team',</Clock>,
      description: 'Certified professionals with 10+ years of experience',</Clock>,
      icon: <Users className="w-6 h-6 text-purple-500" />};</Users>,
  ];</Users>
      ...
      <main className="pt-20 px-4 py-20">
        <div className="max-w-7xl mx-auto">{/* Hero Section */}</div>
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">IT Services & Solutions</h1>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">Complete IT infrastructure services including cloud migration, cybersecurity, DevOps, mobile development, </p>
              and custom software solutions. We help businesses scale and secure their technology infrastructure.</p>
      ...
      <section className="pt-20 px-4 py-12 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 sm:mb-6">IT Services & Solutions</h1>
            </h1>
            <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto mb-6 sm:mb-8 px-4">Comprehensive IT services designed to modernize your infrastructure, enhance security, and drive digital transformation.</p>
            </p>
          ...
          {/* Stats Section */};
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16 lg:mb-20">{stats.map((stat, index) => (</div>
          ...
          <div className="mb-20">
            ...
            <div className="flex flex-wrap justify-center gap-6">{technologies.map((tech, index) => (</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{filteredServices.map((service, index) => (</div>
                <div key={index} className={`bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 group relative ${service.popular ? 'ring-2 ring-purple-500' : ''}`}>{service.popular && (</div>
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="bg-blue-600/20 text-blue-400 px-3 py-1 rounded-full text-xs font-semibold">{service.category}</span>
                    </span>
                  </div>
                ...
                <div className="flex justify-between items-center mb-4">
                  <span className="text-2xl font-bold text-white">{service.pricing}</span>
                  {service.popular && (
                    <span className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-3 py-1 rounded-full text-xs font-semibold">Popular</span>
                    </span>
                  )};
                </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-12">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">Let our expert team help you build, secure, and scale your technology infrastructure.</p>
      {/* Benefits Section */}</p>
      <section className="py-12 sm:py-16 lg:py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">Why Choose Our IT Services?</h2>
            <p className="text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto px-4">Experience the difference with our comprehensive IT solutions</p>
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">{benefits.map((benefit, index) => (</div>
              <div key={index} className="text-center">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12">
              ...
              <p className="text-lg sm:text-xl text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">Let's discuss how our IT services can transform your business operations and drive growth.</p>
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link 
                  to="/contact" 

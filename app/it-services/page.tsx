  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid-advanced neural-network-bg">
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-r from-slate-800 to-purple-900 text-white py-20 quantum-background">
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  ...
                  className="cyber-button px-8 py-3 rounded-lg font-semibold transition-colors inline-flex items-center"
                >
                  📞 +1 302 464 0950
                </a>
                <a 
                  href="mailto:kleber@ziontechgroup.com"
                  className="cyber-button px-8 py-3 rounded-lg font-semibold transition-colors"
        ...
        <section className="py-16 bg-gradient-to-r from-slate-800 to-purple-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center cyber-card-advanced p-6">
              ...
              <div className="text-center cyber-card-advanced p-6">
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Cloud-First Approach</h3>
        ...
        {categories.map(category => (
          <section key={category} className="py-16 bg-gradient-to-r from-slate-800 to-purple-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 neon-text">
                  {category} Services
                  ...
                  .map((service, index) => (
                    <div key={index} className="cyber-card-advanced p-6">
                      ...
                      <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {service.technologies.map((tech, techIndex) => (
                            <span key={techIndex} className="bg-cyan-900 text-cyan-300 text-xs px-2 py-1 rounded">
                              {tech}
                            </span>
                          ))}
                        </div>
                      ...
                      <div className="mb-4 p-3 bg-slate-800 rounded-lg">
                        <p className="text-sm text-cyan-300 font-medium">{service.contactInfo}</p>
                      </div>

                      <div className="flex gap-2">
                        <a 
                          href="tel:+13024640950"
                          className="flex-1 cyber-button py-2 px-4 rounded-lg font-semibold transition-colors text-center"
                        >
                          Call Now
                        </a>
                        <a 
        ...
        {/* Contact Section */}
        <section className="py-16 bg-gradient-to-r from-slate-800 to-purple-900 text-white quantum-background">

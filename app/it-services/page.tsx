...
const ItServicesPage: React.FC = () => {}
  ...
  return (
    ...
    <div></div>
        ...
        <meta name="description" content=""Comprehensive IT services including cloud, security, DevOps, and infrastructure solutions for modern businesses."></meta>"
        <meta name="keywords" content=""IT services, cloud computing, cybersecurity, DevOps, infrastructure, technology consulting"></meta>"
      <
    ...
    g:grid-cols-4 gap-8"><
              <div className=""text-center"><"
                <div className=""bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"><"
                  <Server className=""w-8 h-8 text-blue-600"></Server>"
                <
              ...
              <div className=""text-center"><"
                <div className=""bg-purple-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"><"
                  <Cloud className=""w-8 h-8 text-purple-600"></Cloud>"
                <
              ...
              <div className=""text-center"><"
                <div className=""bg-orange-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"><"
                  <Settings className=""w-8 h-8 text-orange-600"></Settings>"
                <
    ...
    <>
      <Helmet></Helmet>
        ...
        <meta name="description" content=""Comprehensive IT services including cloud solutions, cybersecurity, infrastructure management, and more. Expert IT support and consulting." /></meta>"
        <meta name="keywords" content=""IT services, cloud solutions, cybersecurity, IT infrastructure, managed IT, IT consulting, DevOps" /></meta>"
      </Helmet>

...
import { Search, CheckCircle, ArrowRight, Server, Shield, Cloud, Database, Cpu, Globe, Zap } from 'lucide-react'
...
const ITServicesPage: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Professional server administration and management services for optimal performance.',
      category: 'Server',
      icon: Server,
  ...
  const categories = ['all', 'Cloud', 'Security', 'Database', 'Network', 'Support', 'Server']
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">
            <span className="neon-text">IT Services</span>
          </h1>
          <p className="text-lg sm:text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Comprehensive IT solutions to keep your business running efficiently and securely in the digital age.
          </p>
        </div>
      </section>

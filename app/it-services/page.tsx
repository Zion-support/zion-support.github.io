  ...
  const services = [
    {
      ...
      description: 'Professional it services services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored it services implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your it services needs.'
    }
  ];

...
import { Cloud, Shield, Settings, Database, Smartphone, Code, BarChart, Globe, Lock, Users, Wrench, HardDrive, CheckCircle, ArrowRight, Phone, Mail, MapPin } from 'lucide-react';
...
const ITServicesPage: React.FC = () => {
  ...
  const categories = ['All', 'Cloud Computing', 'Security', 'DevOps', 'Data Management', 'Consulting', 'Networking', 'Mobile Development', 'Web Development', 'Data Analytics', 'Support', 'Blockchain', 'Data Protection'];

  return (
    <>
      <SEOEnhancer
        title="IT Services - Comprehensive Technology Solutions | Zion Tech Group"
        description="Professional IT services including cloud migration, cybersecurity, DevOps, database management, and more. Transform your technology infrastructure with our expert solutions."
        keywords={['it services', 'cloud migration', 'cybersecurity', 'devops', 'database management', 'it consulting', 'network infrastructure', 'web development']}
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Comprehensive IT solutions for modern enterprise infrastructure. From cloud migration 
              to cybersecurity, we provide end-to-end technology services that drive business success.
            </p>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="flex flex-wrap gap-4 justify-center mb-12">
              {categories.map((category) => (
                <button
                  key={category}
                  className="px-6 py-3 bg-slate-800 hover:bg-cyan-400 hover:text-slate-900 text-gray-300 rounded-lg transition-all duration-300"
                >
                  {category}
                </button>
              ))}
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                ...
                <p className="text-gray-300">Delivering measurable business value with 99% uptime and 40% cost reduction</p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">We develop a comprehensive IT strategy tailored to your business needs</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">We continuously monitor and optimize your systems for peak performance</p>
              </div>
            </div>
          </section>

...
const ITServicesPage: React.FC = () => {
  const itServices = [
    ...
    },
    {
      ...
      benefits: ['60% performance boost', 'Zero data loss', 'Automated backups']
    },
    {
      title: 'IT Consulting',
      ...
      benefits: ['Strategic guidance', 'Technology roadmap', 'ROI optimization']
    },
    {
      ...
      benefits: ['99.9% uptime', 'High performance', 'Secure connectivity']
    },
    {
    ...
    },
    {
      ...
      color: 'text-cyan-400',
      benefits: ['Modern tech stack', 'High performance', 'SEO optimized']
    },
    {
    ...
    },
    {
      ...
      color: 'text-gray-400',
      benefits: ['24/7 availability', 'Proactive maintenance', 'Rapid response']
    },
    {
      ...
      benefits: ['Secure transactions', 'Decentralized solutions', 'Future-proof technology']
    },
    {
      title: 'IoT Solutions',
      ...
      benefits: ['Connected devices', 'Real-time data', 'Automated processes']
    }
  ];
  ...
  return (
    <>
      <SEOOptimizer
        ...
        keywords={['IT services', 'cloud migration', 'cybersecurity', 'DevOps', 'database services', 'IT consulting', 'digital transformation']}
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              ...
              running smoothly and securely in the digital age.
            </p>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                ...
                <p className="text-gray-300 mb-4">Bank-level security and compliance with 24/7 monitoring and threat detection.</p>
              </div>
              
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                <div className="text-4xl mb-4">⚡</div>
                <h3 className="text-xl font-bold text-white mb-3 neon-text">Rapid Deployment</h3>
                <p className="text-gray-300 mb-4">Fast implementation with minimal downtime and maximum efficiency.</p>
              </div>
              
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                <div className="text-4xl mb-4">🔧</div>
                <h3 className="text-xl font-bold text-white mb-3 neon-text">24/7 Support</h3>
                <p className="text-gray-300 mb-4">Round-the-clock support and maintenance to keep your systems running smoothly.</p>
              </div>
            </div>
          </section>
          ...
          <section className="text-center">
            <div className="cyber-card p-8 max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold text-white mb-4 neon-text">Ready to Modernize Your IT Infrastructure?</h2>
              <p className="text-lg text-gray-300 mb-8">
                Let our IT experts help you design and implement the perfect technology solution for your business needs.
              </p>

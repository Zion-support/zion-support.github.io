  ...
  const itServices = [
    {
      ...
      color: 'text-blue-400',
      benefits: ['50% cost reduction', '99.9% uptime', 'Scalable infrastructure', '24/7 monitoring']
    },
    {
      title: 'Cybersecurity',
      ...
      color: 'text-red-400',
      benefits: ['99.9% threat detection', 'Real-time monitoring', 'Compliance ready', 'Expert support']
    },
    {
      title: 'DevOps & CI/CD',
      ...
      benefits: ['80% faster deployments', 'Zero downtime', 'Automated testing', 'Continuous integration']
    },
    {
      ...
      benefits: ['3x performance boost', 'Automated backups', 'Security hardening', 'Expert optimization']
    },
    {
      title: 'IT Consulting',
      ...
      benefits: ['Strategic guidance', 'Technology roadmap', 'Cost optimization', 'Digital transformation']
    },
    {
      ...
      benefits: ['High availability', 'Security first', 'Performance optimized', '24/7 support']
    },
    {
      ...
      color: 'text-pink-400',
      benefits: ['Native performance', 'Cross-platform', 'Modern UI/UX', 'App store ready']
    },
    {
      ...
      color: 'text-cyan-400',
      benefits: ['Modern tech stack', 'High performance', 'SEO optimized', 'Mobile responsive']
    },
    {
      ...
      benefits: ['Data-driven insights', 'Real-time dashboards', 'Predictive analytics', 'Business intelligence']
    },
    {
      ...
      color: 'text-gray-400',
      benefits: ['24/7 support', 'Proactive maintenance', 'Fast response', 'Expert technicians']
    },
    {
      ...
      benefits: ['Secure transactions', 'Decentralized apps', 'Token economy', 'DeFi integration']
    },
    {
      title: 'IoT Solutions',
      ...
      benefits: ['Connected devices', 'Real-time data', 'Smart automation', 'Scalable solutions']
    }
  ];
        ...
        <main className="container mx-auto px-4 py-16 pt-24" role="main">
          ...
          <section className="text-center mb-16 cyber-scan-line" aria-labelledby="hero-heading">
            <div className="max-w-6xl mx-auto">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
                ...
                we deliver enterprise-grade IT solutions that drive efficiency, security, and growth.
              </p>
          ...
          <section className="mb-16" aria-labelledby="it-services-heading">
            ...
            <p className="text-lg text-gray-300 text-center mb-12 max-w-3xl mx-auto px-4">
              End-to-end IT solutions designed to modernize your infrastructure and drive business success
            </p>
          ...
          <section className="mb-16" aria-labelledby="why-choose-heading">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                ...
                <p className="text-gray-300 mb-4">Certified IT professionals with decades of experience in enterprise solutions</p>
                <div className="text-2xl font-bold text-cyan-400">100+ IT Experts</div>
              </div>
              
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                <div className="text-4xl mb-4">⚡</div>
                <h3 className="text-xl font-bold text-white mb-3 neon-text">Proven Results</h3>
                <p className="text-gray-300 mb-4">Our IT solutions have helped 1000+ businesses achieve digital transformation</p>
                <div className="text-2xl font-bold text-green-400">99% Success Rate</div>
              </div>
              
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                <div className="text-4xl mb-4">🔒</div>
                <h3 className="text-xl font-bold text-white mb-3 neon-text">Enterprise Security</h3>
                <p className="text-gray-300 mb-4">Bank-level security and compliance for your critical IT infrastructure</p>

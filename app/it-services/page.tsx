...
const ItServicesPage: React.FC = () => {
  const itServices = [
    ...
    },
    {
      ...
      description: 'Expert cloud strategy, migration, and optimization services for AWS, Azure, and GCP.',
      features: ['Cloud strategy assessment', 'Migration planning', 'Cost optimization', 'Security compliance', 'Performance monitoring'],
    ...
    },
    {
      ...
      description: 'Advanced network security solutions including firewall management and threat detection.',
      features: ['Vulnerability assessment', 'Firewall configuration', 'Intrusion detection', 'VPN setup', '24/7 monitoring'],
    ...
    },
    {
      ...
      description: 'Comprehensive data protection with automated backups and rapid recovery solutions.',
      features: ['Automated daily backups', 'Real-time replication', 'Point-in-time recovery', 'Disaster recovery', '24/7 monitoring'],
  ...
  const categories = ['All', 'Infrastructure', 'Cloud', 'Security', 'Backup', 'Database', 'Network', 'Support'];

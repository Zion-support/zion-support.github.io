  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Comprehensive IT services including cloud migration, cybersecurity, DevOps, database management, and custom development. Transform your technology infrastructure."
        keywords={['IT services', 'cloud migration', 'cybersecurity', 'DevOps', 'database management', 'web development', 'IT consulting']}
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="cyber-card p-6 text-center">
                ...
                <p className="text-gray-300">Bank-level security protocols and compliance standards to protect your critical data.</p>
              </div>
              <div className="cyber-card p-6 text-center">
                <div className="text-4xl mb-4">⚡</div>
              ...
              <div className="cyber-card p-6 text-center">
                ...
                <p className="text-gray-300">Technology that grows with your business and adapts to changing needs.</p>
              </div>
            </div>
          </section>
          ...
          <section className="cyber-card p-8 text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              ...
              Get a free technology assessment and discover how we can transform your IT operations.
            </p>

...
import {ArrowRight, ShoppingCart  } from 'lucide-react';
;
constItServicesPage: React.FC = () => {useEffect(() => {
    setIsVisible(true);
  }, []);
;
  constitServices = [{title: 'CloudInfrastructure',;
...
constITServicesPage: React.FC = () => {
  constservices = [{
    ...
    {title: 'ITSupport',;
      ...
      features: ['24/7 technicalsupport',;
        'Remotemonitoring',;
    ...
    {title: 'BlockchainDevelopment',;
      ...
      features: ['Smartcontractdevelopment',;
        'DAppcreation',;
        'Tokendevelopment',;

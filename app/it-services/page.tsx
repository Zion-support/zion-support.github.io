...
const ITServicesPage: React.FC = () => {
  const itServices = [
    ...
    },
    {
      ...
      features: ['Native iOS/Android apps', 'React Native development', 'App store optimization', 'Push notifications'],
    ...
    },
    {
      ...
      features: ['24/7 technical support', 'System monitoring', 'Software updates', 'Hardware maintenance'],
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="keywords" content="IT services, cloud migration, cybersecurity, DevOps, data analytics, mobile development, IT support" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto mb-6 sm:mb-8 px-4">
              Transform your business with our comprehensive IT services. From cloud migration to cybersecurity, we provide end-to-end solutions tailored to your needs.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16 lg:mb-20">
            {itServices.map((service, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 group">
                ...
                {service.popular && (
                  <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-lg p-2 mb-4 text-center">
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">Our Process</h2>
            <p className="text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto px-4">

  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Comprehensive IT services including cloud migration, cybersecurity, DevOps, database management, and enterprise solutions. Transform your IT infrastructure with our expert team."
        keywords={['IT services', 'cloud migration', 'cybersecurity', 'DevOps', 'database management', 'IT consulting', 'enterprise solutions']}
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
              From cloud migration and cybersecurity to DevOps and enterprise integration, we provide 
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                ...
                <p className="text-gray-300 mb-4">Bank-level security and compliance for all your IT infrastructure and data</p>
              </div>
              
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                <div className="text-4xl mb-4">⚡</div>
                <h3 className="text-xl font-bold text-white mb-3 neon-text">24/7 Support</h3>
                <p className="text-gray-300 mb-4">Round-the-clock monitoring and support to keep your systems running smoothly</p>
              </div>
              
              <div className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                <div className="text-4xl mb-4">🚀</div>
                <h3 className="text-xl font-bold text-white mb-3 neon-text">Proven Expertise</h3>
                <p className="text-gray-300 mb-4">Certified experts with years of experience in enterprise IT solutions</p>
              </div>
            </div>
          </section>

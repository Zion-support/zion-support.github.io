...
import { Cloud, Shield, Settings, Database, Smartphone, Code, BarChart, Wrench, Lock, Cpu, Globe, Users, Building, CheckCircle, ArrowRight } from 'lucide-react';
  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Professional IT services including cloud migration, cybersecurity, DevOps, database management, and digital transformation. Expert solutions for modern businesses."
              ...
              {itServices.map((service, index) => (
                <div key={index} className="cyber-card p-6 hover:scale-105 transition-all duration-300">
                  ...
                  <div className="text-center">
                    ...
                    <a 
                      href="/contact" 
                      className="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-300 hover:scale-105 bg-cyan-600 hover:bg-cyan-700 text-white"
                    >
                      Get Started
                    </a>
                  </div>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">
                  We create a comprehensive strategy tailored to your business needs and goals.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">
                  We execute the plan with minimal disruption to your daily operations.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">
                  We provide ongoing support and optimization to ensure peak performance.
                </p>
              </div>
            </div>
          </section>

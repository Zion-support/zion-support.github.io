...
const ITServicesPage: React.FC = () => {
  const itServices = [
    ...
    },
    {
      ...
      icon: '☁️',
      price: 'Starting at $4,000/month',
      features: ['Cloud migration strategy', 'Zero downtime migration', 'Cost optimization', 'Security hardening', 'Performance tuning'],
    ...
    },
    {
      ...
      description: 'Custom enterprise applications with modern architecture and scalable solutions.',
      icon: '💻',
      price: 'Starting at $8,000/month',
      features: ['Custom application development', 'Modern architecture', 'Scalable solutions', 'Integration services', 'Maintenance'],
      benefits: ['Improve business processes', 'Increase efficiency', 'Reduce costs'],
      marketPrice: '$15,000-40,000/month',
      category: 'Application Development',
      technologies: ['React', 'Vue.js', 'Node.js', 'Python', 'Java'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Database Design & Optimization',
      description: 'Database architecture, performance tuning, and optimization for enterprise applications.',
      icon: '🗄️',
      price: 'Starting at $3,500/month',
    ...
    },
    {
      ...
      description: 'Complete IT infrastructure management with monitoring, maintenance, and optimization.',
      icon: '⚙️',
      price: 'Starting at $6,000/month',
      features: ['Infrastructure monitoring', 'Maintenance scheduling', 'Performance optimization', 'Capacity planning', 'Security management'],
      benefits: ['Improve system reliability', 'Reduce maintenance costs', 'Optimize performance'],
      marketPrice: '$10,000-25,000/month',
      category: 'Infrastructure',
      technologies: ['Monitoring Tools', 'Automation', 'Cloud Management', 'Security Tools', 'Backup Systems'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Enterprise Integration Services',
      description: 'System integration and API development for seamless data flow across enterprise applications.',
      icon: '🔌',
      price: 'Starting at $5,500/month',
      features: ['System integration', 'API development', 'Data migration', 'Workflow automation', 'Legacy system modernization'],
    ...
    },
    {
      ...
      description: 'Native and cross-platform mobile application development for enterprise needs.',
      icon: '📱',
      ...
      benefits: ['Reach mobile users', 'Improve user engagement', 'Increase productivity'],
    ...
    },
    {
      ...
      description: 'API gateway setup, management, and optimization for enterprise applications.',
      icon: '🌐',
      price: 'Starting at $4,000/month',
      features: ['API gateway setup', 'API management', 'Rate limiting', 'Security', 'Documentation'],
    ...
    {
      title: 'Enterprise Monitoring & Alerting',
      description: 'Comprehensive monitoring solutions with real-time alerting and performance tracking.',
      icon: '📈',
      price: 'Starting at $3,000/month',
      features: ['System monitoring', 'Performance tracking', 'Alert management', 'Log analysis', 'Incident response'],
      benefits: ['Prevent system failures', 'Improve performance', 'Reduce downtime'],
      marketPrice: '$5,000-12,000/month',
      category: 'Monitoring',
    ...
    },
    {
      ...
      description: 'Identity and access management solutions with single sign-on and multi-factor authentication.',
      icon: '👤',
      price: 'Starting at $4,500/month',
      features: ['Single sign-on', 'Multi-factor authentication', 'User provisioning', 'Access control', 'Audit logging'],
      benefits: ['Improve security', 'Simplify user management', 'Ensure compliance'],
      marketPrice: '$7,000-18,000/month',
      category: 'Identity Management',
      technologies: ['Active Directory', 'Okta', 'Auth0', 'SAML', 'OAuth'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Enterprise Content Management',
      ...
      icon: '📄',
      price: 'Starting at $3,500/month',
      features: ['Document management', 'Workflow automation', 'Content collaboration', 'Version control', 'Search capabilities'],
      benefits: ['Improve productivity', 'Streamline workflows', 'Enhance collaboration'],
      marketPrice: '$6,000-15,000/month',
      category: 'Content Management',
      technologies: ['SharePoint', 'Confluence', 'Jira', 'Custom Solutions', 'Workflow Engines'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Enterprise Communication Solutions',
      description: 'Unified communication platforms with video conferencing, messaging, and collaboration tools.',
      icon: '💬',
      price: 'Starting at $2,500/month',
      features: ['Video conferencing', 'Messaging', 'Collaboration tools', 'Integration services', 'Mobile support'],
      benefits: ['Improve communication', 'Enhance collaboration', 'Increase productivity'],
      marketPrice: '$4,000-10,000/month',
      category: 'Communication',
      technologies: ['Microsoft Teams', 'Slack', 'Zoom', 'Custom Solutions', 'Integration APIs'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Enterprise Backup & Archiving',
      description: 'Comprehensive backup solutions with long-term archiving and data retention management.',
      icon: '💾',
      price: 'Starting at $2,000/month',
      features: ['Automated backups', 'Long-term archiving', 'Data retention', 'Recovery testing', 'Compliance management'],
      benefits: ['Protect critical data', 'Ensure compliance', 'Reduce storage costs'],
      marketPrice: '$3,500-8,000/month',
      category: 'Backup & Archiving',
      technologies: ['Veeam', 'Commvault', 'AWS Glacier', 'Azure Archive', 'Tape Systems'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Enterprise Performance Optimization',
      description: 'System performance tuning, optimization, and capacity planning for enterprise applications.',
      icon: '⚡',
      price: 'Starting at $4,000/month',
      features: ['Performance tuning', 'Capacity planning', 'Load testing', 'Optimization', 'Monitoring'],
      benefits: ['Improve system performance', 'Optimize resource usage', 'Reduce costs'],
      marketPrice: '$6,000-15,000/month',
      category: 'Performance',
      technologies: ['Performance Tools', 'Load Testing', 'Monitoring', 'Optimization', 'Capacity Planning'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Enterprise Compliance Management',
      description: 'Compliance monitoring, reporting, and management for regulatory requirements.',
      icon: '📋',
      price: 'Starting at $3,000/month',
      features: ['Compliance monitoring', 'Regulatory reporting', 'Audit management', 'Policy enforcement', 'Risk assessment'],
      benefits: ['Ensure compliance', 'Reduce audit costs', 'Minimize regulatory risks'],
      marketPrice: '$5,000-12,000/month',
      category: 'Compliance',
      technologies: ['Compliance Tools', 'Audit Management', 'Reporting', 'Policy Management', 'Risk Assessment'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Enterprise Change Management',
      description: 'IT change management processes, approval workflows, and deployment automation.',
      icon: '🔄',
      price: 'Starting at $2,500/month',
      features: ['Change management', 'Approval workflows', 'Deployment automation', 'Rollback procedures', 'Impact analysis'],
      benefits: ['Reduce change risks', 'Improve deployment success', 'Minimize downtime'],
      marketPrice: '$4,000-10,000/month',
      category: 'Change Management',
      technologies: ['ServiceNow', 'Jira', 'Automation Tools', 'Workflow Engines', 'Deployment Tools'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Enterprise Asset Management',
      description: 'IT asset tracking, lifecycle management, and optimization for hardware and software.',
      icon: '📦',
      price: 'Starting at $2,000/month',
      features: ['Asset tracking', 'Lifecycle management', 'License management', 'Cost optimization', 'Inventory management'],
      benefits: ['Optimize asset usage', 'Reduce costs', 'Ensure compliance'],
      marketPrice: '$3,500-8,000/month',
      category: 'Asset Management',
      technologies: ['Asset Management Tools', 'License Management', 'Inventory Systems', 'Cost Tracking', 'Lifecycle Planning'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Enterprise Service Desk',
      description: 'IT service desk solutions with ticketing, knowledge management, and user support.',
      icon: '🎧',
      price: 'Starting at $3,500/month',
      features: ['Ticketing system', 'Knowledge management', 'User support', 'Incident management', 'Service catalog'],
      benefits: ['Improve user satisfaction', 'Reduce support costs', 'Streamline processes'],
      marketPrice: '$5,500-14,000/month',
      category: 'Service Desk',
      technologies: ['ServiceNow', 'Jira Service Desk', 'Zendesk', 'Knowledge Management', 'Ticketing Systems'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Enterprise Project Management',
      description: 'IT project management with planning, tracking, and delivery optimization.',
      icon: '📊',
      price: 'Starting at $4,000/month',
      features: ['Project planning', 'Resource management', 'Progress tracking', 'Risk management', 'Delivery optimization'],
      benefits: ['Improve project success', 'Optimize resources', 'Reduce risks'],
      marketPrice: '$6,000-15,000/month',
      category: 'Project Management',
      technologies: ['Project Management Tools', 'Resource Planning', 'Risk Management', 'Progress Tracking', 'Delivery Optimization'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Enterprise Training & Support',
      description: 'IT training programs, user education, and ongoing support services.',
      icon: '🎓',
      price: 'Starting at $2,000/month',
      features: ['Training programs', 'User education', 'Documentation', 'Support services', 'Knowledge transfer'],
      benefits: ['Improve user adoption', 'Reduce support costs', 'Enhance productivity'],
      marketPrice: '$3,500-8,000/month',
      category: 'Training & Support',
      technologies: ['Training Platforms', 'Documentation Tools', 'Support Systems', 'Knowledge Management', 'User Education'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Enterprise Vendor Management',
      description: 'IT vendor relationship management, contract optimization, and performance monitoring.',
      icon: '🤝',
      price: 'Starting at $3,000/month',
      features: ['Vendor management', 'Contract optimization', 'Performance monitoring', 'Cost analysis', 'Relationship management'],
      benefits: ['Optimize vendor relationships', 'Reduce costs', 'Improve service quality'],
      marketPrice: '$5,000-12,000/month',
      category: 'Vendor Management',
      technologies: ['Vendor Management Tools', 'Contract Management', 'Performance Monitoring', 'Cost Analysis', 'Relationship Management'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    },
    {
      title: 'Enterprise Innovation Lab',
      description: 'Technology innovation, proof of concept development, and emerging technology evaluation.',
      icon: '🔬',
      price: 'Starting at $5,000/month',
      features: ['Technology innovation', 'Proof of concept', 'Emerging technology evaluation', 'Innovation management', 'Research & development'],
      benefits: ['Drive innovation', 'Evaluate new technologies', 'Stay competitive'],
      marketPrice: '$8,000-20,000/month',
      category: 'Innovation',
      technologies: ['Innovation Tools', 'Research Platforms', 'Prototyping', 'Technology Evaluation', 'R&D Management'],
      contactInfo: 'Contact: kleber@ziontechgroup.com | +1 302 464 0950'
    }
  ];

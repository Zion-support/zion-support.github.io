...
import { ArrowRight, CheckCircle, Users, Award, Zap, Shield, Cloud, Code, BarChart, CheckSquare, DollarSign, Settings, Workflow, Wifi, TrendingUp, ShoppingCart, Cpu, Database, Smartphone, Server } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive IT services including cloud migration, cybersecurity, DevOps, data analytics, and custom development solutions." />
        <meta name="keywords" content="IT services, cloud migration, cybersecurity, DevOps, data analytics, software development" />
      </Helmet>

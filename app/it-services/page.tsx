                  ...
                  .map((service, index) => (<
                    <div key={index} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow><"
                      ...
                      <div className="mb-6><"
                        ...
                        <ul className="space-y-1>"
                          {service.benefits.map((benefit), benefitIndex) => (<li key={benefitIndex} className="
                        Get Quote;
                      <
                    <
                  ))}
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"
      ...
      <div className="container mx-auto px-4 py-20"
        <div className="text-center mb-16"
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6"
            IT <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent"
          </h1>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"
        ...
        <section className="py-20"
          <div className="container mx-auto px-4"
            <div className="text-center mb-16"
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6"
                Technologies We <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto"
        ...
        <section className="py-20 bg-gradient-to-r from-slate-800/30 to-slate-900/30"
          <div className="container mx-auto px-4"
            <div className="text-center mb-16"
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6"
                Why Choose Our <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto"

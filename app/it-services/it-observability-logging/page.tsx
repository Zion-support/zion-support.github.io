...
export const metadata: Metadata = {
  title: "IT Observability & Centralized Logging | Zion Tech Group",
  description: "IT Observability & Centralized Logging — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-observability-logging" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'IT Observability & Centralized Logging', href: '/it-services/it-observability-logging' },
        ],
      }
    />
  );

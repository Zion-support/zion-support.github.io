...
export const metadata: Metadata = {
  title: 'Blockchain Development and Smart Contract Auditing | Zion Tech Group',
  description: 'End-to-end blockchain solution development, smart contract creation, security auditing, and Web3 integration for enterprises.',
  alternates: { canonical: '/it-services/blockchain-development' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'Blockchain Development and Smart Contract Auditing',

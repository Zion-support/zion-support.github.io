...
export const metadata: Metadata = {
  ...
  description: "ESG Compliance Automation — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-esg-compliance-automation" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'ESG Compliance Automation', href: '/it-services/it-esg-compliance-automation' },
        ],
      }
    />
  );

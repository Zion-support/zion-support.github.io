...
export const metadata: Metadata = {
  title: "AI-Ready Data Pipeline Builder — Zion Tech Group",
  description: "Enterprise IT service: AI-Ready Data Pipeline Builder. Robust, scalable, secure.",
  keywords: "AI services, IT services, AI-Ready Data Pipeline Builder",
  openGraph: {
...
export default function AireadyDataPipelineBuilderPage() {
  return (

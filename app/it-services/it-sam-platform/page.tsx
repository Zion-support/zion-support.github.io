...
export const metadata: Metadata = {
  ...
  description: "IT Service Asset & Configuration Management — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-sam-platform" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'IT Service Asset & Configuration Management', href: '/it-services/it-sam-platform' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "AI Data Warehouse Modernization — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/data-warehouse-modernization" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Data Warehouse Modernization', href: '/it-services/data-warehouse-modernization' },
        ],
      }
    />
  );

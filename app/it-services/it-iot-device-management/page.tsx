...
export const metadata: Metadata = {
  ...
  description: "Enterprise IoT Device Management — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-iot-device-management" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Enterprise IoT Device Management', href: '/it-services/it-iot-device-management' },
        ],
      }
    />
  );

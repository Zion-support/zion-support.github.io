...
export const metadata: Metadata = {
  ...
  description: "AI Cloud Cost Optimizer — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/cloud-cost-ai-optimizer" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI Cloud Cost Optimizer', href: '/it-services/cloud-cost-ai-optimizer' },
        ],
      }
    />
  );

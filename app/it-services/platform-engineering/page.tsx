...
export const metadata: Metadata = {
  title: 'Platform Engineering and Internal Developer Portal | Zion Tech Group',
  description: 'Build internal developer platforms with self-service provisioning, golden paths, and developer experience optimization.',
  alternates: { canonical: '/it-services/platform-engineering' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'Platform Engineering and Internal Developer Portal',
        ...
        pricing: [
          { tier: 'Starter', price: '$2499', period: '/month', features: ['Core features', 'Monthly reports', 'Email support', 'Up to 50 endpoints'] },
          { tier: 'Professional', price: '$5499', period: '/month', features: ['All Starter', 'Advanced analytics', 'Priority SLA', 'Up to 500 endpoints', 'Custom integrations'] },

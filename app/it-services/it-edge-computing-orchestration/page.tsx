...
export const metadata: Metadata = {
  ...
  description: "Edge Computing Orchestration — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-edge-computing-orchestration" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Edge Computing Orchestration', href: '/it-services/it-edge-computing-orchestration' },
        ],
      }
    />
  );

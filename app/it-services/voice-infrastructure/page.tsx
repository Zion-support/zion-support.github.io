...
export const metadata: Metadata = {
  title: 'Voice Infrastructure and Contact Center Solutions | Zion Tech Group',
  ...
  alternates: { canonical: '/it-services/voice-infrastructure' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'Voice Infrastructure and Contact Center Solutions',

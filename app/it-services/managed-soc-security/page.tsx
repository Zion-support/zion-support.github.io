...
export const metadata: Metadata = {
  title: 'Managed SOC & Security Operations | Zion Tech Group',
  description: '24/7 Security Operations Center services with AI-powered threat detection, incident response, and continuous monitoring for your entire infrastructure.',
  alternates: { canonical: '/it-services/managed-soc-security' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with Managed SOC & Security Operations',
        pricing: [

...
export const metadata: Metadata = {
  ...
  description: 'WCAG 2.2 auditing, screen reader simulation, auto-remediation code, and CI/CD gates.',
  alternates: { canonical: '/it-services/accessibility-compliance' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with Accessibility & WCAG Compliance',
        pricing: [

...
export const metadata: Metadata = {
  ...
  description: "Kubernetes Multi-Cloud Management — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-kubernetes-multicloud" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Kubernetes Multi-Cloud Management', href: '/it-services/it-kubernetes-multicloud' },
        ],
      }
    />
  );

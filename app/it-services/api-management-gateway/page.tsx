...
export const metadata: Metadata = {
  ...
  description: "API Management & Developer Gateway — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/api-management-gateway" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'API Management & Developer Gateway', href: '/it-services/api-management-gateway' },
        ],
      }
    />
  );

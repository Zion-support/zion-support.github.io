...
export const metadata: Metadata = {
  ...
  description: "Multi-Cloud Cost Governance — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-multi-cloud-cost-governance" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Multi-Cloud Cost Governance', href: '/it-services/it-multi-cloud-cost-governance' },
        ],
      }
    />
  );

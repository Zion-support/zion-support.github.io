...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/it-services/network-security-monitoring' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        pricing: [
          { tier: 'Starter', price: '$899', period: '/month', features: ['Core monitoring & alerting', 'Monthly compliance reports', 'Email support', 'Up to 50 endpoints'] },
          { tier: 'Professional', price: '$1999', period: '/month', features: ['All Starter features', 'Advanced analytics & dashboards', 'Priority support with SLA', 'Up to 500 endpoints', 'Custom integrations'] },
          { tier: 'Enterprise', price: '$4499', period: '/month', features: ['Everything in Professional', 'Dedicated account manager', '24/7 phone support', 'Unlimited endpoints', 'Custom SLA guarantees', 'On-site deployment support'] },
        ],
        contact: {

...
export const metadata: Metadata = {
  title: "Legacy Application Containerization Service — Zion Tech Group",
  description: "Enterprise IT service: Legacy Application Containerization Service. Robust, scalable, secure.",
  keywords: "AI services, IT services, Legacy Application Containerization Service",
  openGraph: {
...
export default function LegacyApplicationContainerizationServicePage() {
  return (

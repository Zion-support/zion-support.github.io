...
export const metadata: Metadata = {
  ...
  description: "AI IT Helpdesk & Support — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/ai-it-helpdesk" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'AI IT Helpdesk & Support', href: '/it-services/ai-it-helpdesk' },
        ],
      }
    />
  );

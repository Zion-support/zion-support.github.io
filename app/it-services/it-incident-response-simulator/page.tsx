...
export const metadata: Metadata = {
  ...
  description: "IT Incident Response Simulator — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-incident-response-simulator" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'IT Incident Response Simulator', href: '/it-services/it-incident-response-simulator' },
        ],
      }
    />
  );

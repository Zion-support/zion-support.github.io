...
export const metadata: Metadata = {
  title: "IT Asset Discovery & Configuration Management — Zion Tech Group",
  description: "Enterprise IT service: IT Asset Discovery & Configuration Management. Robust, scalable, secure.",
  keywords: "AI services, IT services, IT Asset Discovery & Configuration Management",
  openGraph: {
...
export default function ItAssetDiscoveryAndConfigurationManagementPage() {
  return (

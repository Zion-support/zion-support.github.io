...
export const metadata: Metadata = {
  ...
  description: "SAP Integration Hub — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/it-sap-integration-hub" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'SAP Integration Hub', href: '/it-services/it-sap-integration-hub' },
        ],
      }
    />
  );

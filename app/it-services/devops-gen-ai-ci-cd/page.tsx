...
export const metadata: Metadata = {
  ...
  description: "Generative AI for DevOps & CI/CD — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/devops-gen-ai-ci-cd" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Generative AI for DevOps & CI/CD', href: '/it-services/devops-gen-ai-ci-cd' },
        ],
      }
    />
  );

...
export const metadata: Metadata = {
  ...
  description: "Remote IT Support & Helpdesk Outsourcing — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/remote-it-support" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Remote IT Support & Helpdesk Outsourcing', href: '/it-services/remote-it-support' },
        ],
      }
    />
  );

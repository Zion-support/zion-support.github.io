...
export const metadata: Metadata = {
  title: "Kubernetes Cluster Hardening & Compliance — Zion Tech Group",
  description: "Enterprise IT service: Kubernetes Cluster Hardening & Compliance. Robust, scalable, secure.",
  keywords: "AI services, IT services, Kubernetes Cluster Hardening & Compliance",
  openGraph: {
...
export default function KubernetesClusterHardeningAndCompliancePage() {
  return (

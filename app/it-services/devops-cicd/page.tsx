...
export const metadata: Metadata = {
  ...
  description: 'CI/CD pipelines, Kubernetes, IaC, SRE, and blue-green/canary deployments.',
  alternates: { canonical: '/it-services/devops-cicd' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        ctaLabel: 'Get Started with DevOps & CI/CD Automation',
        pricing: [

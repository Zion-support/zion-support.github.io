...
export const metadata: Metadata = {
  title: "Observability & SRE Platform as a Service — Zion Tech Group",
  description: "Enterprise IT service: Observability & SRE Platform as a Service. Robust, scalable, secure.",
  keywords: "AI services, IT services, Observability & SRE Platform as a Service",
  openGraph: {
...
export default function ObservabilityAndSrePlatformAsAServicePage() {
  return (

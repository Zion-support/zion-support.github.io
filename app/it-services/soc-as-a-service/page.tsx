...
export const metadata: Metadata = {
  ...
  description: "Security Operations Center as a Service (SOCaaS) — professional IT service from Zion Tech Group.",
  alternates: { canonical: "/it-services/soc-as-a-service" },
};
    ...
    <ProductPageLayout
      data={
        ...
        breadcrumb: [
          ...
          { label: 'Security Operations Center as a Service (SOCaaS)', href: '/it-services/soc-as-a-service' },
        ],
      }
    />
  );

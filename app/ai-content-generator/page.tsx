...
<h1 className="text-4xl md:text-6xl font-bold text-white mb-6">"
              AI <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Content Generator</span></h1>"
...
<p className="text-gray-300">{type.description}</p></div>"
            ))}
          </div></div>
</section>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="AI-powered content generation solutions for your business." />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            <h1 className="text-5xl font-bold text-white mb-6">
              <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">AI Content Generator</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              AI-powered content generation solutions designed to transform your business operations.
            </p>
          </div>

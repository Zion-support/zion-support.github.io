...
const MachineLearningPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Machine Learning Solutions',
      description: 'Professional machine learning services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored machine learning implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your machine learning needs.'
    }
  ];

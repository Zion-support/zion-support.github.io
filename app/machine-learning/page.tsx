...
export default function PagePage() {
  return (
    <div className="min-h-screen bg-gray-50" content="Advanced Page solutions by Zion Tech Group"min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100"description"Advanced machine learning solutions by Zion Tech Group" />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="text-4 xl font-bold text-gray-900 mb-6">
          ...
          <p className=">
            Advanced machine learning solutions by Zion Tech Group.
          </p>
        </div>
      </div>
    </div>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive API documentation and developer resources for integrating with our AI and IT solutions." />
        <meta name="keywords" content="API documentation, developer resources, integration guides, technical docs" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Comprehensive API documentation and developer resources for integrating with our AI and IT solutions.
              </p>

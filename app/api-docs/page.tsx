...
const filteredEndpoints = apiEndpoints.map(category => ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">"
      ...
      <Navigation />
      {/* Hero Section */}
      <section className="relative py-20 px-4"> " <div className="max-w-7xl mx-auto text-center">"
      ...
      <section className="py-16 px-4"> " <div className="max-w-7xl mx-auto">"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8"> " <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">"
              ...
              <h3 className="text-xl font-semibold text-white mb-3">1. Get API Key</h3> " <p className="text-gray-300 mb-4">Sign up and get your API key from the dashboard</p> " <button className="text-purple-400 hover:text-purple-300 font-medium">"
                Get API Key →
              </button>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10"> " <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-blue-600 rounded-lg flex items-center justify-center mb-4">"
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">"
              <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-blue-600 rounded-lg flex items-center justify-center mb-4"> " <Zap className="w-6 h-6 text-white" />"
              </div>
              <h3 className="text-xl font-semibold text-white mb-3">3. Integrate</h3> " <p className="text-gray-300 mb-4">Build amazing applications with our APIs</p> " <button className="text-purple-400 hover:text-purple-300 font-medium">"
                Start Building →
              </button>
            </div>
          </div>
      ...
      <section className="py-16 px-4">"
        <div className="max-w-7xl mx-auto"> " <h2 className="text-3xl font-bold text-white mb-12 text-center">API Endpoints</h2> " <div className="space-y-8">"
            {filteredEndpoints.map((category, categoryIndex) => (
              <div key={categoryIndex} className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10"> " <div className="flex items-center gap-4 mb-8">"
                  <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-blue-600 rounded-lg flex items-center justify-center"> " <category.icon className="w-6 h-6 text-white" />"
                  </div>
                  <div>
                ...
                <div className="space-y-6">"
                  {category.endpoints.map((endpoint, endpointIndex) => (
                    <div key={endpointIndex} className="bg-white/5 rounded-xl p-6 border border-white/10">}}"
                      <div className="flex items-center justify-between mb-4"> " <div className="flex items-center gap-4">"
                      ...
                      <div className="bg-slate-900 rounded-lg p-4 overflow-x-auto"> " <pre className="text-gray-300 text-sm">"

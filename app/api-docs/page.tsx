      ...
      <section className=""py-16 px-4"></section>"
        <div className=""max-w-7xl mx-auto"></div>"
          ...
          <div className=""grid grid-cols-1 lg: grid-cols-3 gap-8"></div>"
            <div className=""bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white"></div>"
            ...
            <div className=""bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white"></div>"
              ...
              <button className=""text-purple-400 hove,"></button>"
      ...
      <section className=""py-16 px-4"></section>"
        <div className=""max-w-7xl mx-auto"></div>"
          ...
          <div className=""space-y-8">)"
            {filteredEndpoints.map((category), categoryIndex) => (<div key={categoryIndex} className=""bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white"></div>"
                ...
                <div className=""space-y-6">)"
                  {category.endpoints.map((endpoint, endpointIndex) => (<div key={endpointIndex} className=""bg-white/5 rounded-xl p-6 border border-white"></div>"
        ...
        <div className=""max-w-4xl mx-auto text-center"></div>"
          ...
          <div className=""flex flex-col sm:flex-row gap-4 justify-center"></div>"
            <button className=""bg-white text-purple-600 px-8 py-4 rounded-xl font-semibold hover:bg-gray-100 transition-colors"></button>"
              Get API Key;
            <
            <button className=""border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hove,"></button>"

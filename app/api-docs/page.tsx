  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive API documentation and guides" />
        <meta property="og:title" content="API Documentation | Zion Tech Group" />
        <meta property="og:description" content="Comprehensive API documentation and guides" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300">
                Everything you need for API documentation success
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Let us help you create comprehensive API documentation.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact"

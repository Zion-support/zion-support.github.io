...
export const metadata: Metadata = {
  ...
  description:
    'API Docs accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-quality code f',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'API Docs accelerates software delivery with intelligent tooling, automated code analysis, and streamlined development workflows. Ship higher-quality code faster while reducing technical debt.',
        iconEmoji: '⚙️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with API Docs',
      }}
    />
  );
}

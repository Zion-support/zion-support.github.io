      ...
      <div className="max-w-7xl mx-auto"></div>
        ...
        <div className="mt-12 bg-blue-50 rounded-lg p-8"></div>
          ...
          <div className="flex flex-col sm: flex-row gap-4"></div>
            <a;
              href="/contact"className="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors text-center">;
              Contact Us;
            </a>
            <a;
              href="tel:+13024640950"className="border-2 border-blue-600 text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-blue-600 hover:text-white transition-colors text-center">;

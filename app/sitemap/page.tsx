  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Complete sitemap of all pages and sections on our website." />
        <meta name="keywords" content="sitemap, site navigation, website structure" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Complete sitemap of all pages and sections on our website.
              </p>

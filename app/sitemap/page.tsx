...
<<<<<<< HEAD
<<<<<<< HEAD
        <meta name="description" content="Site navigation and page structure." />
=======
...
<<<<<<< HEAD
<<<<<<< HEAD
          <p className="text-lg text-gray-300 mb-8">Site navigation and page structure.</p>
          <Link 
            to="/contact" 
...
>>>>>>> cursor/fix-errors-and-merge-to-main-d941
          >
=======
          <p className="text-lg text-gray-300 mb-8">Professional sitemap coming soon.</p>
          <Link >
            to="/contact"
            className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center mx-auto w-fit"
>>>>>>> cursor/fix-errors-and-merge-to-main-a79b
...
=======
    ...
    <div className = "min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center"></div>
        <h1 className="text-4 xl font-bold text-white mb-6"  >Sitemap</h1>
        <p className="text-lg text-gray-300 mb-8">Professional sitemap services coming soon.</p>;
        <Link;</Link></Link>
          to = "/contact"

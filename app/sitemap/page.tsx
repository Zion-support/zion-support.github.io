        ...
        <div className="container mx-auto px-4 py-16 pt-24"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16"></div>
            <div className="cyber-card-enhanced p-6 text-center"></div>
              ...
              <div className="text-2xl font-bold text-white mb-2"></div>{totalPages}</div>
              <div className="text-gray-300"></div>Total Pages</div>
            </div>
            <div className="cyber-card-enhanced p-6 text-center"></div>
              <Brain className="w-8 h-8 text-green-400 mx-auto mb-4" />
              <div className="text-2xl font-bold text-white mb-2"></div>50+</div>
              <div className="text-gray-300"></div>AI Services</div>
            </div>
            <div className="cyber-card-enhanced p-6 text-center"></div>
              <Cloud className="w-8 h-8 text-purple-400 mx-auto mb-4" />
              <div className="text-2xl font-bold text-white mb-2"></div>20+</div>
              <div className="text-gray-300"></div>IT Services</div>
            </div>
            <div className="cyber-card-enhanced p-6 text-center"></div>
              <Zap className="w-8 h-8 text-orange-400 mx-auto mb-4" />
              <div className="text-2xl font-bold text-white mb-2"></div>15+</div>
              <div className="text-gray-300"></div>Micro SaaS</div>
            </div>
          </div>
            ...
            {pageCategories.map((category, categoryIndex) => (
              <div key={categoryIndex} className="cyber-card-enhanced p-8"></div>
                <div className="flex items-center mb-6"></div>
                  ...
                  <h2 className="text-2xl font-bold text-white"></h2>{category.title}</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"></div>
                  {category.pages.map((page, pageIndex) => (
                    <div key={pageIndex} className="bg-slate-800 rounded-lg p-4 hover:bg-slate-700 transition-colors duration-300"></div>
                      ...
                      <p className="text-gray-300 text-sm mb-3"></p>{page.description}</p>
                      <a
                        href={page.url}
          ...
          <div className="cyber-card-enhanced p-8 mt-16"></div>
            <h2 className="text-2xl font-bold text-white mb-6 text-center"></h2>Can't Find What You're Looking For?</h2>
          ...
          <div className="cyber-card-enhanced p-6 mt-8 text-center"></div>
            <h3 className="text-lg font-semibold text-white mb-2"></h3>For Developers</h3>

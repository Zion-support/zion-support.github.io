        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-6xl mx-auto">{/* Header */}</div>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">Navigate our website easily with this comprehensive sitemap. 
                Find all our pages, services, and resources organized by category.</p>
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-8 mb-12">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">{quickLinks.map((link, index) => (</div>
                  <a
                    key={index}, href={link.url}, className="flex flex-col items-center p-4 bg-slate-700/50 rounded-lg hover:bg-slate-700 transition-all duration-300 group"
                  >
                    <link.icon className="w-6 h-6 text-cyan-400 mb-2 group-hover:scale-110 transition-transform" />
                    <span className="text-sm text-white text-center group-hover:text-cyan-300 transition-colors">{link.name}</span>
                    </span>
                  </a>
                ))}
              </div>
            ...
            {/* Sitemap Sections */}
            <div className="space-y-12">{sitemapSections.map((section, sectionIndex) => (</div>
                <div key={sectionIndex}, className="bg-slate-800/50 rounded-lg p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">{section.pages.map((page, pageIndex) => (</div>
                      <a
                        key={pageIndex}, href={page.url}, className="block p-4 bg-slate-700/30 rounded-lg hover:bg-slate-700/50 transition-all duration-300 group"
                      >
                        <div className="flex items-start justify-between mb-2">
                          <h3 className="text-lg font-semibold text-white group-hover:text-cyan-300 transition-colors">{page.name}</h3>
                          </h3>
                          <ArrowRight className="w-4 h-4 text-gray-400 group-hover:text-cyan-400 group-hover:translate-x-1 transition-all" />
                        </div>
                        <p className="text-sm text-gray-300 group-hover:text-gray-200 transition-colors">{page.description}</p>
                        </p>
                      </a>
                    ))}
                  </div>
            ...
            <div className="mt-16 text-center">
              <div className="bg-slate-800/50 rounded-lg p-8">
                ...
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">Use our search functionality or contact us directly for assistance.</p>
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
                  ...
                  <button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300">Search</button>
                  </button>
                </div>
              </div>
            </div>
            ...
            <div className="mt-12 text-center">
              <div className="bg-gradient-to-r from-cyan-500/10 to-blue-600/10 border border-cyan-500/20 rounded-lg p-8">
                ...
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">Our team is here to help you find exactly what you need. Contact us for personalized assistance.</p>
                </p>

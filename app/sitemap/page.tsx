...
const SitemapPage: React.FC = () =>{
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8"></div&gt; <div className="max-w-7xl mx-auto"></div&gt; <div className="text-center mb-12"></div&gt; <h1 className="text-4xl font-bold text-gray-900 mb-4">Sitemap</h1&gt; </h1&gt; <p className="text-xl text-gray-600">Navigate through all pages on our website><//div&gt; <div className="bg-white rounded-lg shadow-lg p-8"></div&gt; <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">{pages.map((page, index) =>(</div&gt; <div key={index} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow"></div&gt; <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  <a 
                    href={page.path} 
                    className="text-blue-600 hover:text-blue-700 transition-colors">{page.title}
                  </a&gt; </h3&gt; <p className="text-sm text-gray-600 mb-2">{page.description}
                </p&gt; <p className="text-xs text-gray-500">{page.path}
                </p&gt; </div>))}
          </div&gt; </div&gt; <div className="mt-12 bg-blue-50 rounded-lg p-8"></div&gt; <h2 className="text-2xl font-bold text-gray-900 mb-4">Need Help Finding Something?
          </h2&gt; <p className="text-gray-600 mb-6">If you can't find what you're looking for, feel free to contact us directly.
          </p&gt; <div className="flex flex-col sm:flex-row gap-4"></div&gt; <a 
              href="/contact"
              ...
              className="border-2 border-blue-600 text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-blue-600 hover:text-white transition-colors text-center">Call Us: (302) 464-0950><//div&gt; </div&gt; </div&gt; </div>)
}
export default SitemapPage></a&gt; </a&gt; </p>
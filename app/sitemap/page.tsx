  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Explore the complete sitemap of Zion Tech Group. Find all our AI services, IT solutions, resources, and pages in one organized view." />
        <meta name="keywords" content="sitemap, navigation, AI services, IT solutions, website structure" />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-400 max-w-3xl mx-auto">
                Navigate through all our services, resources, and pages. Find exactly what you're looking for 
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {quickLinks.map((link, index) => (
                  <a
                    key={index}
                    href={link.url}
                    className="flex flex-col items-center p-4 bg-slate-800/50 rounded-lg hover:bg-slate-700/50 transition-all duration-300 group"
                  >
                    <link.icon className="w-6 h-6 text-cyan-400 mb-2 group-hover:text-cyan-300" />
                    <span className="text-sm text-gray-300 text-center group-hover:text-white">{link.name}</span>
                  </a>
                ))}
              </div>
            </div>

...
const SitemapPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Sitemap Solutions',
      description: 'Professional sitemap services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored sitemap implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your sitemap needs.'
    }
  ];

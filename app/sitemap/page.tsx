        ...
        <div className="container mx-auto px-4 py-16 pt-24">{/* Header */}</div className="container mx-auto px-4 py-16 pt-24">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center mb-6">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white neon-text-enhanced">Sitemap</h1 className="text-4xl md:text-5xl font-bold text-white neon-text-enhanced">
              </h1>
            </div>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">Complete overview of all pages and resources available on our website. </p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Find what you're looking for quickly and easily.</p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            </p>
            <div className="flex items-center justify-center space-x-4 text-sm text-gray-400">
              <Calendar className="w-4 h-4" />
              <span>Last updated: {lastUpdated}</span>
              <Users className="w-4 h-4" />
              <span>{totalPages} pages {/* Quick Stats */}</span>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
            ...
            <div className="cyber-card-enhanced p-6 text-center">
              ...
              <div className="text-gray-300">Micro SaaS</div>{/* Page Categories */} {pageCategories.map((category, categoryIndex) => (<//div>
              <div key={categoryIndex} className="cyber-card-enhanced p-8">
                <div className="flex items-center mb-6">
                  ...
                  <span className="ml-4 px-3 py-1 bg-slate-700 text-cyan-400 text-sm font-semibold rounded">{category.pages.length} pages</span className="ml-4 px-3 py-1 bg-slate-700 text-cyan-400 text-sm font-semibold rounded">
                  </span>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">{category.pages.map((page, pageIndex) => (</div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div key={pageIndex} className="bg-slate-800 rounded-lg p-4 hover:bg-slate-700 transition-colors duration-300">
                      <div className="flex items-start justify-between mb-2">
                        <h3 className="text-lg font-semibold text-white group-hover:text-cyan-400 transition-colors">{page.name}</h3 className="text-lg font-semibold text-white group-hover:text-cyan-400 transition-colors">
                        </h3>
                        <a
                          href={page.url}
          ...
          <div className="cyber-card-enhanced p-8 mt-16">
            ...
            <p className="text-gray-300 text-center mb-8">Use our search functionality or contact our support team for assistance.</p className="text-gray-300 text-center mb-8">
            </p>
          ...
          <div className="cyber-card-enhanced p-6 mt-8 text-center">
            ...
            <p className="text-gray-300 mb-4">Access our XML sitemap for search engines and automated tools.</p className="text-gray-300 mb-4">
            </p>
            <a
              href="/sitemap.xml"
              className="text-cyan-400 hover:text-cyan-300 font-medium flex items-center justify-center"
            >
              <Code className="w-4 h-4 mr-2" />View XML Sitemap</Code className="w-4 h-4 mr-2" />

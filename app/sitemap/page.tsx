    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8"></div>
      <div className="max-w-7xl mx-auto"></div>
        <div className="text-center mb-12"></div>
          ...
          <p>Navigate through all pages on our website
  </p>
        </div>
        <div className="bg-white rounded-lg shadow-lg p-8"></div>
          <div>{pages.map((page, index) => (</div>
        ...
        <div className="mt-12 bg-blue-50 rounded-lg p-8"></div>
          ...
          <p>If you can't find what you're looking for, feel free to contact us directly.
          </p>
          <div className="flex flex-col sm:flex-row gap-4"></div>
            <a>Contact Us
  </a>h1>
            <a>Call Us: (302) 464-0950
  </a>h1>
          </div>
        </div>
      </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Policy-to-Control Compliance Mapper</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Maps written policies to enforceable controls, evidence requirements, and test schedules across frameworks.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Policy inventory and versioning</li>
            <li>Control mapping by framework</li>
            <li>Evidence requirement suggestions</li>
            <li>Test schedule generation</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Close policy-to-evidence gaps</li>
            <li>Reduce audit findings</li>
            <li>Maintain current control maps</li>
            <li>Simplify examiner requests</li>
        </ul>
      </section>

...
export const metadata = {
  ...
  description: "Enterprise DLP for endpoints, network, cloud, and email. Detect and prevent PII, IP, and sensitive data exfiltration with policy-based controls and OCR content ",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Enterprise DLP for endpoints, network, cloud, and email. Detect and prevent PII, IP, and sensitive data exfiltration with policy-based controls and OCR content </p>

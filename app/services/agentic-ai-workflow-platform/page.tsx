    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Agentic AI Workflow Orchestration Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Build and deploy autonomous AI agent teams that collaborate on complex business workflows. Agents plan, execute, review, and iterate — handling multi-step processes like RFP responses, compliance audits, and research synthesis with minimal human oversight.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-agent team builder with role assignment</li>
            <li>Autonomous planning, execution, and self-correction</li>
            <li>Human-in-the-loop approval gates</li>
            <li>Tool and API integration for agents (search, CRM, email)</li>
            <li>Workflow templates (RFP, audit, research, onboarding)</li>
            <li>Full audit trail and agent decision logging</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automate complex multi-step workflows end to end</li>
            <li>Reduce RFP response time from days to hours</li>
            <li>Ensure consistency with automated quality gates</li>
            <li>Scale expert workflows without adding headcount</li>
            <li>Full transparency with agent decision audit trails</li>
        </ul>
      </section>

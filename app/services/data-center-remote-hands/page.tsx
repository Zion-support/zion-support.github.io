    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Remote Hands &amp; Smart Hands Support</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">On-demand engineering support for hardware installation, rack-and-stack, cable patching, equipment swaps, and break-fix. 15-minute response SLA with technician dispatch to any facility location.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Rack-and-stack with torque screwdriving and labeling</li>
            <li>Server, network, and storage hardware replacement</li>
            <li>Fiber and copper cable patching with OTDR validation</li>
            <li>Temporary cross-connects and breakout cables</li>
            <li>OS reload and Bare Metal provisioning assistance</li>
            <li>Dedicated client portal with ticket tracking and photo updates</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Speed up deployments with on-demand engineer access</li>
            <li>Avoid costly travel for remote site fixes</li>
            <li>Guarantee SLA compliance with documented procedures</li>
            <li>Reduce accidental downtime with certified technician work</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Multi-Cloud DNS &amp; Traffic Manager</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Unified DNS management across cloud providers with intelligent traffic routing, health checks, and failover automation. Supports geo-routing, weighted round-robin, and latency-based routing policies.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Single pane of glass for Route53, Cloud DNS, Azure DNS</li>
            <li>Geo-location, latency, and weighted routing policies</li>
            <li>Automated health checks with instant failover</li>
            <li>DNSSEC management and compliance reporting</li>
            <li>Change audit log with approval workflows</li>
            <li>Terraform integration for infrastructure-as-code DNS</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate DNS as a single point of failure</li>
            <li>Route users to the fastest endpoint automatically</li>
            <li>Manage all cloud DNS from one dashboard</li>
            <li>Meet compliance with DNSSEC and audit trails</li>
        </ul>
      </section>

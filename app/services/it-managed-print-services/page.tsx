...
export const metadata = {
  title: 'Managed Print Services & Print Fleet Optimization | Zion Tech Group',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/it-managed-print-services',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Managed Print Services &amp; Print Fleet Optimization</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Full managed print service — we supply, monitor, optimize, and maintain your printing fleet. Remote monitoring, automatic toner replenishment, print policy enforcement, and detailed usage reporting. Reduce print costs by 30%.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Remote printer fleet monitoring</li>
            <li>Automatic toner and supply replenishment</li>
            <li>Print policy enforcement (duplex, B/W default)</li>
            <li>Usage tracking by department/user</li>
            <li>Secure print release (pull printing)</li>
            <li>Break-fix support with 4-hour response</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce print costs by 30%</li>
            <li>Never run out of toner again</li>
            <li>Secure sensitive documents with pull printing</li>
            <li>Track and control printing by department</li>
            <li>Predictable monthly costs, no surprises</li>
        </ul>
      </section>

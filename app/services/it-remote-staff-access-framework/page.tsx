    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Remote Staff Access Framework</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Safely provisions and governs remote access for distributed teams with MFA, device trust, least privilege, and session controls.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Remote access policy templates</li>
            <li>MFA and device trust requirements</li>
            <li>Least privilege access tiers</li>
            <li>Session timeout and monitoring</li>
            <li>VPN/ZTNA pairing guidance</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce unauthorized remote access risk</li>
            <li>Keep distributed teams productive</li>
            <li>Make audits simpler</li>
            <li>Reduce helpdesk access requests</li>
        </ul>
      </section>

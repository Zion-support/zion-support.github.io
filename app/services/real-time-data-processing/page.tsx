export const metadata = {title: 'Real Time Data Processing | Zion Tech Group',description: 'Professional real time data processing services for your business needs.',keywords: 'real-time-data-processing, services, business, technology';

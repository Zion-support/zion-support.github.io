...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/network-observability-platform',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Network Observability Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Full-stack network observability platform that provides real-time visibility into network performance, traffic patterns, and health metrics. Combines flow analysis, packet capture, and synthetic monitoring with AI-powered root cause analysis.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>NetFlow/sFlow analysis with application-level visibility</li>
            <li>Full packet capture with intelligent filtering and storage</li>
            <li>Synthetic transaction monitoring for critical applications</li>
            <li>AI-powered anomaly detection and root cause analysis</li>
            <li>Network topology auto-discovery and mapping</li>
            <li>Capacity planning with trend analysis and forecasting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce network troubleshooting time by 80%</li>
            <li>Detect performance degradation before users notice</li>
            <li>Optimize bandwidth allocation with traffic analysis</li>
            <li>Plan capacity accurately with AI-driven forecasting</li>
        </ul>
      </section>

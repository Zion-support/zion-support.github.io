    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Appwrite Self-Hosted Backend-as-a-Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Appwrite is a self-hosted open-source Backend-as-a-Service (BaaS) platform that provides everything mobile and web developers need — databases, authentication, storage, functions, real-time subscriptions, messaging — as a drop-in replacement for Firebase. Unlike Firebase (Google-owned, vendor lock-in, unpredictable pricing), Appwrite can be self-hosted on any infrastructure with full data control.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>All-in-one backend: Document database, OAuth2/OpenID auth (60+ providers), file storage, cloud functions</li>
            <li>Built-in avatars, localization, team management, usage metrics, and health monitoring</li>
            <li>Multi-platform SDKs: Flutter, Swift, Kotlin, JavaScript, React, Vue, Angular, Node, Python, PHP, Ruby, Dart</li>
            <li>Self-hosted with Docker Compose in under 3 minutes; Kubernetes-ready with Redis-backed caching</li>
            <li>Functions marketplace with community templates; scheduled cron functions; async execution with retry logic</li>
            <li>Open APIs compatible with OpenAPI 3.1; GraphQL support; Firebase migration compatibility layers</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$15/mo (Cloud Pro)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

...
export const metadata = {
  title: "Cognitive manager-telecom - Zion Tech Group",
  description: "Revolutionize telecom through intelligent automation. Our Cognitive manager-telecom leverages advanced machine learning to deliver network optimization at scale",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-manager-telecom-3fa0f17a`
  }
};

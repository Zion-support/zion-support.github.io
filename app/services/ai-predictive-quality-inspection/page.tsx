    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Predictive Quality Inspection for Manufacturing</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Computer vision AI that inspects products on manufacturing lines in real-time, detecting defects, dimensional deviations, and assembly errors at speeds up to 500 parts per minute. Reduces defect escape rate by 90% and eliminates manual inspection bottlenecks.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time visual inspection at up to 500 parts per minute</li>
            <li>Defect classification with root cause analysis</li>
            <li>Dimensional measurement with sub-millimeter accuracy</li>
            <li>Custom model training on your specific defect types</li>
            <li>Integration with PLCs, MES, and quality management systems</li>
            <li>Statistical process control (SPC) chart generation</li>
            <li>Traceability linking defects to production batch and machine</li>
            <li>Edge deployment for low-latency inspection without cloud dependency</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce defect escape rate by 90% compared to manual inspection</li>
            <li>Eliminate inspection bottlenecks that slow production lines</li>
            <li>Catch quality issues in real-time instead of at final inspection</li>
            <li>Reduce customer returns and warranty claims by 50%</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$29,999+/mo</p>
          </div>
        </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Revenue Forecaster</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Forecast revenue with AI-driven pipeline analysis, seasonality detection, and risk-adjusted close probabilities. Connects to CRM and finance systems.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Pipeline-aware revenue forecasting</li>
            <li>Seasonality and trend decomposition</li>
            <li>Risk-adjusted close probability</li>
            <li>CRM + ERP data synchronization</li>
            <li>Drill-down by segment, product, region</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Forecast accuracy improves by 30-50%</li>
            <li>See risk before it hits the quarter</li>
            <li>Model scenarios in minutes</li>
            <li>Align sales and finance on one view</li>
        </ul>
      </section>

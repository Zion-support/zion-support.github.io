    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Container Registry &amp; Image Scanner</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Secure container registry with built-in vulnerability scanning, image signing, and policy enforcement. Blocks deployment of vulnerable or unsigned images with SBOM generation and compliance reporting.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Private container registry with geo-replication</li>
            <li>CVE scanning on push with severity-based blocking</li>
            <li>Cosign/Notary image signing and verification</li>
            <li>SBOM generation in SPDX and CycloneDX formats</li>
            <li>Policy engine for base image and dependency rules</li>
            <li>Retention policies with automated garbage collection</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Prevent vulnerable images from reaching production</li>
            <li>Meet supply chain security requirements with signed images</li>
            <li>Generate SBOMs automatically for compliance audits</li>
            <li>Reduce image pull times with regional replication</li>
        </ul>
      </section>

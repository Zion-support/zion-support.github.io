  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/ai-genomics-pipeline` title="AI Genomics Analysis &amp; Precision Medicine Platform" />
        <h1 className="text-4xl font-bold mb-6">AI Genomics Analysis &amp; Precision Medicine Platform</h1>
        <p className="text-lg text-gray-300 mb-8">Process genomic data at scale: variant calling, pharmacogenomics, disease risk scoring, and treatment recommendations. HIPAA-compliant, FDA guidance-aligned pip</p>

        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Whole genome sequencing analysis</li>
            <li>Pharmacogenomics scoring</li>
            <li>Polygenic disease risk scoring</li>
            <li>Treatment response prediction</li>
            <li>HIPAA-compliant cloud pipeline</li>
          </ul>
        </div>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Process genomes in hours</li>
            <li>Personalize treatment plans</li>
            <li>Identify disease risk early</li>
          </ul>
        </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Lightweight CRM for Small Teams</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">A clean, fast CRM designed for small sales teams and startups. Contact management, deal pipeline, email tracking, and activity logging — none of the enterprise bloat. Set up in 5 minutes, start selling immediately.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Visual sales pipeline (drag-and-drop)</li>
            <li>Contact management with activity timeline</li>
            <li>Email sync and tracking</li>
            <li>Task and follow-up reminders</li>
            <li>Basic reporting (win rate, pipeline value)</li>
            <li>Import from CSV / other CRMs</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Set up in 5 minutes, no training needed</li>
            <li>Affordable alternative to Salesforce</li>
            <li>Track every customer interaction</li>
            <li>See your pipeline at a glance</li>
            <li>Grows with your team up to 50 users</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$59/user/mo</p>
          </div>
        </div>

  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/security-privacy-enhancing-technologies` title="Privacy Enhancing Technologies" />
        <h1 className="text-4xl font-bold mb-6">Privacy Enhancing Technologies</h1>
        <p className="text-lg text-gray-300 mb-8">Privacy Enhancing Technologies consulting and implementation: differential privacy budget tracking, homomorphic encryption proof-of-concept, zero-knowledge proo</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with privacy enhancing technologies</li>

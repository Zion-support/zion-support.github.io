export const metadata = {title: 'Business Process Automation | Zion Tech Group',description: 'Comprehensive business process automation services including RPA, workflow automation, AI-powered automation, and digital transformation solutions.';
}export default function BusinessAutomationPage() {return (<div className="animate-fade-in">;
  ...
  )}className={`w-full mt-6 py-3 rounded-lg font-semibold text-center block transition-colors ${popular;
            ? 'bg-green-600 text-white hover:bg-green-700';
            : 'bg-gray-100 text-gray-900 hover:bg-gray-200';
        }`}
function AutomationServiceCard() {return (<div className="border border-gray-200 rounded-xl p-6 bg-white hover:shadow-lg transition-all duration-200">;
  ...
  )}function AutomationTech() {return (<div className="border border-gray-200 rounded-xl p-6 bg-white">;
  ...
  )}function AutomationProcessStep() {return (<div className="text-center p-6">;
  ...
  )}function Pricing() {return (<section className="py-12 bg-gray-50 rounded-lg">;
      <div className="text-center mb-12">;
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">;
        <AutomationPlan;
          ...
          duration="2–4 weeks";
          features={[;
            "Process analysis","Automation opportunity identification","ROI calculation","Implementation roadmap","Technology recommendations","Detailed report";
          ]}
          popular={false}
        />;
        <AutomationPlan;
          ...
          duration="4–12 weeks";
          features={[;
            "Custom automation development","System integration","Testing & validation","User training","Documentation","3 months support";
          ]}
          popular={true}
        />;
        <AutomationPlan;
          ...
          duration="Ongoing";
          features={[;
            "24/7 monitoring","Performance optimization","Process improvements","Regular reporting","Maintenance & updates","Dedicated support";
          ]}
          popular={false}
        />;
      </div>;
  ...
  )}function AutomationPlan() {return (<div className={`border rounded-xl p-8 bg-white relative ${popular ? 'border-orange-500 shadow-lg' : 'border-gray-200'}`}>;

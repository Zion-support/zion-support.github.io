  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/compliance-automation-engine` title="Compliance Automation Engine" />
        <h1 className="text-4xl font-bold mb-6">Compliance Automation Engine</h1>
        <p className="text-lg text-gray-300 mb-8">Rule-based compliance engine that embeds regulatory logic into your data pipelines and APIs. Automates access reviews, entitlement certifications, policy violat</p>

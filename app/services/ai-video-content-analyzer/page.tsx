    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Video Content Analyzer &amp; Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automatically analyze video content for brand safety, transcription, object detection, and engagement scoring. Process user-generated video at scale. AI detects inappropriate content, extracts key moments, generates chapters, and creates searchable transcripts. Essential for media companies, education platforms, and enterprise video.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automatic video transcription in 30+ languages</li>
            <li>Object, scene, and face detection</li>
            <li>Brand-safety content scoring</li>
            <li>Highlight and key moment extraction</li>
            <li>Chapter generation and smart thumbnails</li>
            <li>Engagement prediction per video segment</li>
            <li>Copyright and duplicate content detection</li>
            <li>API with webhook delivery for completed analyses</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Moderate video at scale without human reviewers</li>
            <li>Make video libraries searchable and discoverable</li>
            <li>Increase viewer engagement by 35% with smart chapters</li>
            <li>Protect your platform from harmful video content</li>
        </ul>
      </section>

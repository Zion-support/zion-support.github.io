  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/w128-zero-trust` title="Zero Trust Network Architecture" />
        <h1 className="text-4xl font-bold mb-6">Zero Trust Network Architecture</h1>
        <p className="text-lg text-gray-300 mb-8">Identity-based security with microsegmentation, continuous verification, and least-privilege access across all resources.</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Eliminate lateral movement</li>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Disaster Recovery &amp; Business Continuity Planning</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Comprehensive DR/BC planning including risk assessment, RTO/RPO definition, runbook creation, backup strategy, and quarterly testing. Ensure your business survives any outage.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>RTO/RPO definition for all critical systems</li>
            <li>DR architecture design: hot/warm/cold standby strategies</li>
            <li>Automated backup and replication configuration</li>
            <li>Detailed runbooks for every failure scenario</li>
            <li>Quarterly DR testing with documented results</li>
            <li>Cloud-based DR as a Service (DRaaS) options</li>
            <li>Compliance documentation for auditors and regulators</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Achieve RTO under 1 hour for critical systems</li>
            <li>Avoid $300K+ average cost of unplanned downtime</li>
            <li>Meet regulatory requirements for business continuity</li>
            <li>Test and validate DR procedures quarterly, not just annually</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$2,999 (assessment + DR plan document)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$7,499 (full plan + implementation + 1 test)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$14,999 (multi-site, quarterly testing, 24/7 support)</p>
          </div>
        </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Security Legal Hold Automator</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automates legal hold workflows with policy-based collection, access controls, chain-of-custody records, and attorney review queues.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Policy-based hold activation</li>
            <li>Custodian targeting and filtering</li>
            <li>Evidence collection chains</li>
            <li>Access control and lock</li>
            <li>Audit-ready custody records</li>
            <li>Attorney review queues</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce manual hold overhead</li>
            <li>Preserve defensible evidence</li>
            <li>Reduce missed custodian risk</li>
            <li>Maintain audit trail quality</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Contract Governance Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Data contract management platform that defines, enforces, and monitors data quality agreements between producers and consumers. Ensures schema consistency, freshness SLAs, and semantic correctness across organizational boundaries.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Schema contract definition with versioning</li>
            <li>Automated freshness and completeness monitoring</li>
            <li>Breakage detection with automatic consumer notification</li>
            <li>Semantic validation with custom business rules</li>
            <li>Contract evolution with backward compatibility checks</li>
            <li>Data producer/consumer SLA dashboard</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate silent data breakages across teams</li>
            <li>Enforce data quality standards contractually</li>
            <li>Reduce time spent debugging data pipeline issues</li>
            <li>Build trust between data producers and consumers</li>
        </ul>
      </section>

...
export const metadata = {
  title: "Predictive Enterprise-Grade Financial Risk Scoring - Zion Tech Group",
  description: "Predictive risk scoring engine that assesses enterprise-grade financial vulnerabilities with machine learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/predictive-enterprise-grade-financial-risk-scoring-c1c30983`
  }
};

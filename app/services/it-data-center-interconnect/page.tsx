    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Interconnect &amp; Hybrid Cloud Networking</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Design and implement high-speed interconnects between data centers and cloud providers. Dedicated fiber, wavelength services, and SD-WAN for hybrid cloud. Achieve sub-1ms latency between on-prem and cloud with guaranteed bandwidth.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Dedicated fiber and wavelength interconnect design</li>
            <li>AWS Direct Connect, Azure ExpressRoute, GCP Interconnect</li>
            <li>SD-WAN overlay for intelligent traffic routing</li>
            <li>Sub-1ms latency paths with guaranteed bandwidth</li>
            <li>Redundant diverse path design for 99.999% availability</li>
            <li>Network monitoring and alerting 24/7</li>
            <li>Capacity planning and bandwidth forecasting</li>
            <li>Colocation facility cross-connect management</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Achieve enterprise-grade hybrid cloud connectivity</li>
            <li>Reduce cloud egress costs by up to 60%</li>
            <li>Guarantee latency and bandwidth for critical workloads</li>
            <li>Eliminate single points of failure in network paths</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$15,000/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$50,000+/mo</p>
          </div>
        </div>

...
export const metadata = {title: 'Blockchain Services | Zion Tech Group',title: 'Blockchain Services | Zion Tech Group',description: 'Comprehensive blockchain development services including smart contracts, DeFi protocols, NFT platforms, and enterprise blockchain solutions.',keywords: 'blockchain development, smart contracts, DeFi, NFT, Web3, cryptocurrency, enterprise blockchain, dApp development';
}export default function BlockchainPage() {return (<div className="animate-fade-in">;
    ...
    <div className="space-y-16">;
  ...
  )}title: 'Blockchain Solutions | Zion Tech Group',description: 'Comprehensive blockchain development services including smart contracts, DeFi applications, NFT platforms, and enterprise blockchain solutions.';
}export default function BlockchainPage() {return (<div className="animate-fade-in">;
      <section className="mb-16">;
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Blockchain Solutions</h1>;
        <p className="text-xl text-gray-600 mb-8 max-w-3xl">;
          Build the future with blockchain technology. From smart contracts to DeFi applications,we create secure, scalable blockchain solutions that drive innovation and value.;
        </p>;
      ...
      <section className="mb-16">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
          <BlockchainPricingCard;
            ...
            duration="1–3 weeks";
            features={[;
              "Code review","Security analysis","Gas optimization","Test coverage","Audit report";
            ]}
            recommended={false}
          />;
          <BlockchainPricingCard;
            ...
            duration="4–12 weeks";
            features={[;
              "Smart contracts","Frontend development","Backend integration","Testing & deployment","Documentation";
            ]}
            recommended={true}
          />;
          <BlockchainPricingCard;
            ...
            duration="8+ weeks";
            features={[;
              "Custom blockchain","Enterprise integration","Security & compliance","Training & support","Ongoing maintenance";
            ]}
            recommended={false}
          />;
        </div>;
  ...
  )}function BlockchainTechCard() {return (<div className="border border-gray-200 rounded-xl p-6 bg-white">;
      <h3 className="text-lg font-bold text-gray-900 mb-3">{title}</h3>;
      <p className="text-gray-600 mb-4 text-sm">{description}</p>;
      <div className="flex flex-wrap gap-2">;
        {technologies.map((tech, index) => (<span key={index} className="bg-orange-100 text-orange-800 px-2 py-1 rounded-full text-xs">;
            {tech}
          </span>;
        ))}
      </div>;
  ...
  )}function UseCaseCard() {return (<div className="border border-gray-200 rounded-xl p-6 bg-white">;
      <div className="text-3xl mb-3">{icon}</div>;
      <h3 className="text-lg font-bold text-gray-900 mb-3">{category}</h3>;
      <ul className="space-y-2">;
        {useCases.map((useCase, index) => (<li key={index} className="text-sm text-gray-600 flex items-center">;
            <span className="text-orange-500 mr-2">•</span> {useCase}
          </li>;
        ))}
      </ul>;
    </div>;
  )}function BlockchainPricingCard() {return (<div className={`border rounded-xl p-8 relative ${recommended ? 'border-orange-500 bg-orange-50' : 'border-gray-200 bg-white'}`}>;
      {recommended && (<div className="absolute -top-3 left-1/2 transform -translate-x-1/2">;
      ...
      <button className={`w-full mt-6 py-3 rounded-lg font-semibold transition-colors ${recommended;

    ...
    <div className=\"animate-fade-in\" />
      ...
      <section className=\"mb-16\" />
        ...
        <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8\" />
          <BlockchainServiceCard title=\"Smart Contract Development\"}
            description=\"Secure, audited smart contracts for various blockchain platforms\"}
            features={[\"Solidity development\", \"Security auditing\", \"Gas optimization\"}
            \"Multi-chain support\"
            \"Upgradeable contracts\"]
            price=\"$8,000-25,000\"
            icon=\"📜\"
          />
          <BlockchainServiceCard title=\"DeFi Protocol Development\"
            description=\"Decentralized finance protocols including DEXs, lending, and yield farming\"
            features={[\"AMM protocols\", \"Lending platforms\", \"Yield farming\"}
            \"Liquidity mining\"
            \"Governance tokens\"]
            price=\"$25,000-100,000\"
            icon=\"💰\"
          />
          <BlockchainServiceCard title=\"NFT Marketplace & Platform\"
            description=\"Complete NFT ecosystems with minting, trading, and marketplace functionality\"
            features={[\"NFT minting\", \"Marketplace development\", \"Royalty systems\"}
            \"Metadata management\"
            \"IPFS integration\"]
            price=\"$15,000-50,000\"
            icon=\"🎨\"
          />
          <BlockchainServiceCard title=\"dApp Development\"
            description=\"Decentralized applications with Web3 integration and user-friendly interfaces\"
            features={[\"Frontend development\", \"Web3 integration\", \"Wallet connectivity\"}
            \"User authentication\"
            \"Transaction management\"]
            price=\"$12,000-40,000\"
            icon=\"🌐\"
          />
          <BlockchainServiceCard title=\"Enterprise Blockchain\"
            description=\"Private and consortium blockchain solutions for enterprise use cases\"
            features={[\"Hyperledger Fabric\", \"Ethereum Enterprise\", \"Consortium setup\"}
            \"Permission management\"
            \"Integration APIs\"]
            price=\"$20,000-75,000\"
            icon=\"🏢\"
          />
          <BlockchainServiceCard title=\"Token Development & ICO\"
            description=\"Custom token creation and initial coin offering development\"
            features={[\"ERC-20/721/1155 tokens\", \"ICO platform\", \"Tokenomics design\"}
            \"Vesting contracts\"
            \"Compliance tools\"]
            price=\"$10,000-30,000\"
            icon=\"🪙\"
    ...
    <div className=\"min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100\" />
      ...
      <section className=\"mb-16\" />
        ...
        <div className=\"grid grid-cols-1 md:grid-cols-3 gap-8\" />
          <BlockchainTechStack title=\"Blockchain Platforms\"
            technologies={[\"Ethereum\", \"Polygon\", \"Binance Smart Chain\"}
            \"Solana\"
            \"Avalanche\"]
          />
          <BlockchainTechStack title=\"Development Tools\"
            technologies={[\"Hardhat\", \"Truffle\", \"Remix\"}
            \"OpenZeppelin\"
            \"Web3.js\"]
          />
          <BlockchainTechStack title=\"Frontend & Web3\"
      ...
      <section className=\"mb-16\" />
        ...
        <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8\" />
          <BlockchainUseCase title=\"Supply Chain\"
            description=\"Transparent and traceable supply chain management\"
            examples={[\"Product tracking\", \"Authenticity verification\"}
            \"Quality assurance\"
            \"Compliance reporting\"]
            icon=\"📦\"
          />
          <BlockchainUseCase title=\"Digital Identity\"
            description=\"Self-sovereign identity and credential management\"
            examples={[\"KYC/AML compliance\", \"Credential verification\"}
            \"Privacy protection\"
            \"Cross-platform identity\"]
            icon=\"🆔\"
          />
          <BlockchainUseCase title=\"Gaming & Metaverse\"
            description=\"Play-to-earn games and virtual world economies\"
            examples={[\"Game assets\", \"Virtual land\"}
            \"In-game currencies\"
            \"Player rewards\"]
            icon=\"🎮\"
          />
          <BlockchainUseCase title=\"Real Estate\"
            description=\"Property tokenization and fractional ownership\"
            examples={[\"Property tokens\", \"Fractional ownership\"}
            \"Rental income\"
            \"Property trading\"]
            icon=\"🏠\"
          />
          <BlockchainUseCase title=\"Healthcare\"
            description=\"Secure patient data and medical record management\"
            examples={[\"Patient records\", \"Drug traceability\"}
            \"Clinical trials\"
            \"Insurance claims\"]
            icon=\"🏥\"
          />
          <BlockchainUseCase title=\"Finance\"
            description=\"Decentralized financial services and products\"
            examples={[\"Cross-border payments\", \"Microfinance\"}
            \"Insurance\"
            \"Credit scoring\"]
            icon=\"💳\"
          />
...
function BlockchainServiceCard({ title, description, features, price,
  icon }: {
  title: string;
  description: string,
  features: string[],
...
function BlockchainProcessStep({ step, title,
  description }: {
  step: string,
  title: string;}
  description: string;},,
...
function BlockchainTechStack({ title,
  technologies }: {
  title: string;}
  technologies: string[];},,
  }) {

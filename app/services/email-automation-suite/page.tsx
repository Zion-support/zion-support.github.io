export const metadata = {title: 'Email Automation Suite | Zion Tech Group',description: 'Professional email automation suite services for your business needs.',keywords: 'email-automation-suite, services, business, technology';

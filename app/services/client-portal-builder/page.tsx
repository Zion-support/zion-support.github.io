    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Client Portal Builder</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Client Portal Builder is a white-label client management platform featuring secure file sharing, project tracking, integrated invoicing, and real-time messaging. It gives your business a professional client experience that strengthens relationships and streamlines communication.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>File sharing: secure drag-and-drop file sharing with version history and permissions</li>
            <li>Project tracking: Kanban boards, Gantt charts, and milestone tracking for client projects</li>
            <li>Integrated invoicing: create, send, and track invoices with online payment processing</li>
            <li>Real-time messaging: built-in chat with file attachments and conversation threading</li>
            <li>Client dashboard: branded client dashboard showing project status and upcoming tasks</li>
            <li>Time tracking: built-in time tracking linked to projects and invoices</li>
            <li>Custom branding: add your logo, colors, and domain for a fully white-labeled experience</li>
            <li>Access controls: granular permission settings for clients, team members, and stakeholders</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce client communication costs by 50% with a centralized portal for all interactions</li>
            <li>Improve client satisfaction with professional project tracking and transparent workflows</li>
            <li>Scale with enterprise-grade infrastructure supporting unlimited clients and projects</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$35/mo (up to 5 clients, basic portal)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$79/mo (up to 50 clients, full features)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited clients, white-label, custom domain, API access, SLA)</p>
          </div>
        </div>

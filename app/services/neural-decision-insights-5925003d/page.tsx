...
export const metadata = {
  title: "Neural Decision Insights - Zion Tech Group",
  description: "Transform your insurance operations with our Neural Decision Insights. This AI-driven solution automates fraud prevention with unprecedented accuracy and effici",
  alternates: {
    canonical: `https://ziontechgroup.com/services/neural-decision-insights-5925003d`
  }
};

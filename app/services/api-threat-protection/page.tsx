    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">API Threat Protection Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Dedicated API security platform that discovers shadow APIs, detects abuse patterns, enforces rate limits, and protects against OWASP API Top 10 threats. Provides real-time threat intelligence and automated response.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automatic API discovery including shadow and zombie APIs</li>
            <li>Behavioral analysis for abuse and anomaly detection</li>
            <li>OWASP API Top 10 threat protection</li>
            <li>Token abuse detection and credential stuffing prevention</li>
            <li>Real-time threat intelligence feed integration</li>
            <li>Automated response with customizable playbooks</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Discover and secure unknown APIs before attackers do</li>
            <li>Stop API abuse without impacting legitimate traffic</li>
            <li>Meet API security compliance requirements</li>
            <li>Reduce mean time to detect and respond to API threats</li>
        </ul>
      </section>

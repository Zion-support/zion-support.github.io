  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/w175-forensics-incident` title="Digital Forensics &amp; Incident Response" />
        <h1 className="text-4xl font-bold mb-6">Digital Forensics &amp; Incident Response</h1>
        <p className="text-lg text-gray-300 mb-8">DFIR service: evidence collection, forensic analysis, attribution, and legal-ready reporting. Respond to breaches with certified investigators and chain of cust</p>

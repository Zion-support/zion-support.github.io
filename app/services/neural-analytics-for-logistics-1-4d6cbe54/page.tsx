...
export const metadata = {
  title: "Neural Analytics for Logistics #1 - Zion Tech Group",
  description: "The future of logistics is here with Neural Analytics for Logistics #1. Powered by cutting-edge AI, this platform delivers threat detection like never before.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/neural-analytics-for-logistics-1-4d6cbe54`
  }
};

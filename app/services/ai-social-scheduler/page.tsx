...
export const metadata = {
  title: 'Ai Social Scheduler | Zion Tech Group',
  description: 'Professional ai social scheduler solutions for modern businesses. Transform your operations with our advanced ai social scheduler technology.'
};
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional ai social scheduler solutions for modern businesses. Transform your operations with our advanced ai social scheduler technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our ai social scheduler can help your business
...
<<<<<<< HEAD
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Contact us today to learn how our ai social scheduler services can transform your business.
          </p>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Warehouse Robotics Planner</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Intelligent warehouse automation planning platform that designs optimal robot fleet layouts, pick-path algorithms, and inventory placement strategies. Simulates throughput, identifies bottlenecks, and generates ROI projections for robotics investments.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Robot fleet layout designer with drag-and-drop warehouse mapping</li>
            <li>Pick-path optimization using ant colony algorithms</li>
            <li>Inventory placement heatmaps based on velocity analysis</li>
            <li>Throughput simulation with bottleneck identification</li>
            <li>ROI calculator with TCO comparison vs manual operations</li>
            <li>Integration with major WMS platforms (SAP, Oracle, Manhattan)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce picking time by up to 40% with optimized paths</li>
            <li>Increase warehouse throughput without expanding footprint</li>
            <li>Make data-driven robotics investment decisions</li>
            <li>Minimize robot idle time with intelligent task queuing</li>
        </ul>
      </section>

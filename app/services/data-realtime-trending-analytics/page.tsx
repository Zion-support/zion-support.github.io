  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/data-realtime-trending-analytics` title="Real-Time Trending Analytics" />
        <h1 className="text-4xl font-bold mb-6">Real-Time Trending Analytics</h1>
        <p className="text-lg text-gray-300 mb-8">Real-time windowed aggregation engine: 1-minute tumbling and hopping windows per dimension, per-interval top-K ranking, out-of-norm alerting, sigma deviation tr</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with real-time trending analytics</li>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Transactional Email Delivery Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">High-deliverability transactional email service with API, SMTP relay, template engine, real-time analytics, and automatic bounce/complaint handling. Built for SaaS companies who need reliable email infrastructure.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>REST API and SMTP relay with sub-100ms delivery</li>
            <li>Drag-and-drop template editor with dynamic variables</li>
            <li>Real-time analytics: delivery rate, opens, clicks, bounces</li>
            <li>Automatic bounce handling, suppression list management</li>
            <li>Webhook notifications for delivery events</li>
            <li>Dedicated IP addresses with warm-up automation</li>
            <li>SPF, DKIM, DMARC setup and monitoring</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Achieve 99.5% email deliverability with optimized infrastructure</li>
            <li>Reduce email infrastructure costs by 60% vs. building in-house</li>
            <li>Scale from 1K to 10M emails without architecture changes</li>
            <li>Ensure compliance with automatic bounce and complaint handling</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$19/mo (50K emails)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$79/mo (500K emails, dedicated IP)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$249/mo (5M emails, custom domain, SLA)</p>
          </div>
        </div>

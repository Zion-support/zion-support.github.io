...
export const metadata = {
  title: "Processor Smart - Hospitality #1 - Zion Tech Group",
  description: "The future of hospitality is here with Processor Smart - Hospitality #1. Powered by cutting-edge AI, this platform delivers network optimization like never befo",
  alternates: {
    canonical: `https://ziontechgroup.com/services/processor-smart---hospitality-1-b31a8096`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Monte Carlo Data Observability</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Monte Carlo is the category-defining data observability platform. It uses machine learning to automatically detect, resolve, and prevent data incidents — giving data teams end-to-end visibility into data health across modern cloud data stacks.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated anomaly detection across tables, columns, volume, and freshness</li>
            <li>End-to-end field-level data lineage from ingestion to dashboard</li>
            <li>Integrates with Snowflake, Databricks, BigQuery, Redshift, and Airflow</li>
            <li>Define and enforce data SLAs with automated monitoring and alerting</li>
            <li>Incident management with root-cause analysis and stakeholder communication</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Stop wasting 40% of data-team time on manual firefighting</li>
            <li>Detect broken dashboards and stale reports before stakeholders notice</li>
            <li>Build organization-wide trust in data product quality</li>
            <li>Trusted by Autodesk, Levi Strauss, Vimeo, and Fortune 500 companies</li>
        </ul>
      </section>

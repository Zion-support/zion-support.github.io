    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Contract Lifecycle Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Manage contracts: drafting, negotiation, execution, renewal, compliance. Reduce cycle time 50%.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Contract drafting from templates</li>
            <li>Negotiation and redlining</li>
            <li>E-signature and execution</li>
            <li>Obligation and milestone tracking</li>
            <li>Renewal and expiry alerts</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce contract cycle time by 50%</li>
            <li>Template drafting accelerates creation</li>
            <li>Obligation tracking prevents missed commitments</li>
            <li>Renewal alerts prevent auto-renewal surprises</li>
        </ul>
      </section>

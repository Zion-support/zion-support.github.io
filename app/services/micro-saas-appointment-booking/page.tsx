    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Appointment Booking &amp; Reminders</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Online booking, automated SMS and email reminders, calendar sync, and payment collection in one simple platform. Designed for professional services — consultants, salons, clinics, and tutors — who need to reduce no-shows and streamline scheduling.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Online booking page with customizable availability, buffer times, and service types</li>
            <li>Automated SMS and email reminders with configurable timing and templates</li>
            <li>Two-way calendar sync with Google Calendar, Outlook, and Apple Calendar</li>
            <li>Integrated payment collection via Stripe and PayPal at the time of booking</li>
            <li>Client management with appointment history, notes, and recurring booking support</li>
            <li>No-show tracking with automated follow-up and rescheduling workflows</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce no-shows by 75% with automated SMS and email reminders</li>
            <li>Eliminate back-and-forth scheduling with self-service online booking</li>
            <li>Get paid upfront with integrated Stripe and PayPal payment collection</li>
            <li>Calendar sync prevents double-bookings and keeps your schedule organized</li>
            <li>Recurring booking support retains clients with effortless repeat scheduling</li>
        </ul>
      </section>

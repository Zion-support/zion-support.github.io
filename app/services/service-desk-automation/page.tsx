    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Service Desk &amp; IT Support</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered IT service desk that automates ticket classification, routing, and resolution. Chatbot handles L1 requests automatically, escalates complex issues to human agents, and learns from resolved tickets.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI chatbot for L1 support with natural language understanding</li>
            <li>Automatic ticket classification and priority assignment</li>
            <li>Knowledge base auto-generation from resolved tickets</li>
            <li>SLA tracking with escalation and breach alerts</li>
            <li>Self-service portal with password reset and common fixes</li>
            <li>Integration with Slack, Teams, and email for ticket creation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Resolve 60% of tickets automatically without human agents</li>
            <li>Reduce average resolution time from hours to minutes</li>
            <li>Free IT staff from repetitive L1 requests</li>
            <li>Improve employee satisfaction with instant support</li>
        </ul>
      </section>

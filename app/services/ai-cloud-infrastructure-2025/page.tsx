            ...
            <div className="text-left">"
              <div className="text-left">"
                ...
                <ul className="text-left">"
                  <li className="text-left">"
                    ...
                    <span>Self-healing infrastructure automation<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">✓<"
                    <span>Predictive capacity planning & scaling<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">✓<"
                    <span>AI-driven cost optimization<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">✓<"
                    <span>Intelligent workload distribution<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">✓<"
                    <span>Automated security compliance<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">✓<"
                    <span>Real-time performance optimization<
                  </li>
                </ul>
              </div>
              ...
              <div className="text-left">"
                ...
                <ul className="text-left">"
                  <li className="text-left">"
                    <span className="text-left">→<"
                    <span>99.999% uptime guarantee (5 nines)<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">→<"
                    <span>70% reduction in cloud costs<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">→<"
                    <span>98% automatic issue resolution<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">→<"
                    <span>5x faster deployment speeds<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">→<"
                    <span>Zero downtime migrations<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">→<"
                    <span>Multi-cloud optimization<
                  </li>
                </ul>
              </div>
            </div>

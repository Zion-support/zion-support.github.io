    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Intelligent Process Mining</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered process mining platform that discovers actual process flows from event logs, identifies bottlenecks and deviations, and recommends automation opportunities. Bridges the gap between process analysis and RPA implementation.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Event log ingestion from ERP, CRM, and BPM systems</li>
            <li>Automated process discovery with variant analysis</li>
            <li>Conformance checking against reference models</li>
            <li>Bottleneck identification with root cause analysis</li>
            <li>Automation opportunity scoring per process step</li>
            <li>What-if simulation for process change impact</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Discover how processes actually run vs how they</li>
            <li>,
      </li>
            <li>,
      </li>

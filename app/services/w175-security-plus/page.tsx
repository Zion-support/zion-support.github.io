    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">SecurityPlus Lite — Basic SIEM</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Lightweight SIEM and log monitoring for small teams: threat rules, alerting, and incident tracking.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Log collection and parsing</li>
            <li>Threat rules and signatures</li>
            <li>Alerting via email/Slack</li>
            <li>Incident tracking and notes</li>
            <li>Compliance-ready audit log</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect threats without big security budgets</li>
            <li>Alerts reduce response time</li>
            <li>Incident tracking preserves evidence</li>
        </ul>
      </section>

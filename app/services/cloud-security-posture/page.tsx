    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloud Security Posture Management (CSPM)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Continuous cloud security posture assessment across AWS, Azure, and GCP. Detects misconfigurations, compliance violations, and drift from security baselines with automated remediation.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-cloud misconfiguration detection (500+ checks)</li>
            <li>Compliance benchmark mapping (CIS, NIST, PCI-DSS, SOC2)</li>
            <li>Drift detection from approved security baselines</li>
            <li>Auto-remediation with approval workflows</li>
            <li>Risk-prioritized findings with blast radius analysis</li>
            <li>Executive dashboards with trend and compliance scoring</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect and fix misconfigurations before attackers exploit them</li>
            <li>Maintain continuous compliance across all cloud accounts</li>
            <li>Reduce cloud security risk with automated remediation</li>
            <li>Report security posture to executives with clear metrics</li>
        </ul>
      </section>

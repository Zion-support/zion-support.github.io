    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Incident Management &amp; Response Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Full-cycle incident management platform that automates detection, triage, communication, and post-mortem. On-call scheduling, escalation policies, status page updates, and blameless post-mortem workflows.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated incident creation from monitoring alerts</li>
            <li>On-call scheduling with rotation and escalation policies</li>
            <li>Multi-channel notification (SMS, phone, Slack, push)</li>
            <li>Status page auto-update with subscriber notifications</li>
            <li>Incident timeline with automatic event correlation</li>
            <li>Blameless post-mortem templates with action item tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce MTTR with automated triage and escalation</li>
            <li>Keep customers informed with automatic status updates</li>
            <li>Build institutional knowledge from every incident</li>
            <li>Improve on-call experience with fair scheduling</li>
        </ul>
      </section>

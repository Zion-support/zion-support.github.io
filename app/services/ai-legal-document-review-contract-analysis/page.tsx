    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI-Powered Legal Document Review &amp; Contract Analysis</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automate legal document review and contract analysis with NLP-based AI. Clause extraction, risk scoring, deviation detection, and obligation tracking. Reduce contract review time from days to minutes while improving accuracy. Supports NDAs, MSAs, SOWs, employment agreements, and procurement contracts.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>NLP-based clause extraction and categorization</li>
            <li>Risk scoring per clause and overall contract</li>
            <li>Deviation detection against standard templates</li>
            <li>Obligation and deadline tracking</li>
            <li>Multi-language contract support (EN, ES, FR, DE, PT)</li>
            <li>Integration with CLM platforms (Ironclad, DocuSign, Agiloft)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Review contracts 20x faster than manual</li>
            <li>Catch 95% of non-standard clauses</li>
            <li>Eliminate human oversight in routine reviews</li>
            <li>Standardize legal review workflows</li>
            <li>Reduce external counsel costs by 40%</li>
        </ul>
      </section>

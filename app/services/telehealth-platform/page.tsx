    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Telehealth &amp; Virtual Care Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Complete telehealth solution for healthcare providers with HD video consultations, e-prescribing, appointment scheduling, and integrated billing. HIPAA-compliant with EHR integration and patient portal.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>E-prescribing with pharmacy network integration</li>
            <li>Automated appointment scheduling with reminders</li>
            <li>Integrated billing with insurance verification</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Expand patient reach beyond geographic limits</li>
            <li>Reduce no-shows with automated reminders</li>
            <li>Streamline workflows with EHR integration</li>
            <li>Increase revenue with virtual visit billing</li>
        </ul>
      </section>

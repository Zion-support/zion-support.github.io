...
export const metadata = {title: 'AI Meeting Assistant | Zion Tech Group',description: 'Revolutionary AI meeting platform with real-time transcription, intelligent summaries, and action item extraction. Transform your meetings with 95% accuracy and 50% time savings.',keywords: 'AI meeting assistant, meeting transcription, meeting summaries, action items, meeting analytics, virtual meetings';
}export default function AIMeetingAssistantPage() {return (<div className="space-y-16">;
      {/* Hero Section */}
      ...
      <section className="bg-gray-900 text-white py-16 rounded-lg">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
          <FeatureCard;
            ...
            benefits={[;
              "95% accuracy rate","50+ languages supported","Speaker identification","Noise cancellation";
            ]}
          />;
          <FeatureCard;
            icon="📝";
            ...
            benefits={[;
              "Key points extraction","Decision tracking","Insight generation","Custom summary formats";
            ]}
          />;
          <FeatureCard;
            icon="✅";
            ...
            benefits={[;
              "Auto action detection","Assignee assignment","Deadline tracking","Follow-up reminders";
            ]}
          />;
          <FeatureCard;
            icon="📊";
            ...
            benefits={[;
              "Participation metrics","Talk time analysis","Meeting effectiveness","Productivity insights";
            ]}
          />;
          <FeatureCard;
            icon="🔗";
            ...
            benefits={[;
              "Zoom integration","Microsoft Teams","Google Meet","Calendar sync";
            ]}
          />;
          <FeatureCard;
            icon="🤖";
            ...
            benefits={[;
              "Meeting optimization","Agenda suggestions","Follow-up strategies","Best practices";
            ]}
          />;
        </div>;
      </section>;
      ...
      <section className="py-12 bg-gray-50 rounded-lg">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">;
          <PricingCard;
            ...
            features={[;
              "Up to 10 hours/month","Basic transcription","Meeting summaries","Action item extraction","Email support","Basic analytics";
            ]}
          ...
          <PricingCard;
            ...
            features={[;
              "Up to 50 hours/month","Advanced AI features","Team collaboration","Custom integrations","Priority support","Advanced analytics","API access";
            ]}
            cta="Start Free Trial";
            popular={true}
          />;
          <PricingCard;
            ...
            features={[;
              "Unlimited hours","Custom AI models","White-label options","Dedicated support","Custom integrations","Advanced security","SLA guarantee";
            ]}
            cta="Contact Sales";
            popular={false}
          />;
      ...
      <section className="py-12 bg-gray-50 rounded-lg">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
          <UseCaseCard;
            ...
            benefits={[;
              "Professional transcripts","Client action tracking","Follow-up automation","Meeting recordings";
            ]}
          />;
          <UseCaseCard;
            icon="👥";
            ...
            benefits={[;
              "Team collaboration","Action item assignment","Progress tracking","Meeting effectiveness";
            ]}
          />;
          <UseCaseCard;
            icon="🎓";
            ...
            benefits={[;
              "Knowledge capture","Searchable content","Learning analytics","Progress tracking";
            ]}
          />;
        </div>;
      </section>;
      ...
      <section className="py-12">;
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">;
          {[;
            ...
            },{ name: "TensorFlow", icon: "⚡", description: "Machine learning" },{name: "WebRTC",icon: "📡",description: "Real-time communication";
            },{ name: "AWS", icon: "☁️", description: "Cloud infrastructure" },{ name: "Docker", icon: "🐳", description: "Containerization" },{ name: "Kubernetes", icon: "⚙️", description: "Orchestration" },{ name: "Redis", icon: "🔴", description: "Caching" },{ name: "PostgreSQL", icon: "🐘", description: "Database" },{ name: "Elasticsearch", icon: "🔍", description: "Search engine" },{ name: "React", icon: "⚛️", description: "Frontend" },{ name: "Node.js", icon: "🟢", description: "Backend" }
          ].map((tech, index) => (<div;
              key={index}

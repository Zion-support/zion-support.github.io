            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                    Track meeting effectiveness, participation rates, and key metrics to improve team productivity.
                  </p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="text-3xl mb-4">🔍</div>
                  ...
                  <p className="text-gray-600">
                    Search through all your meeting transcripts and summaries to find specific topics or decisions instantly.
                  </p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="text-3xl mb-4">🔔</div>
                  <h3 className="text-xl font-semibold mb-3">Follow-up Reminders</h3>
                  <p className="text-gray-600">
                    Automated follow-up reminders for action items and deadlines to keep everyone on track.
                  </p>
                </div>
              </div>
            </div>

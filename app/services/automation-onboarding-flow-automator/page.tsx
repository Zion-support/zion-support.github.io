    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Onboarding Flow Automator</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automates employee and vendor onboarding sequences with provisioning, access, training assignment, and evidence capture.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Role-based onboarding sequences</li>
            <li>Provisioning and access automation</li>
            <li>Training assignment and tracking</li>
            <li>Manager and buddy notifications</li>
            <li>Evidence and audit capture</li>
            <li>Offboarding mirror workflows</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Keep access consistent</li>
            <li>Produce compliant evidence</li>
            <li>Support distributed teams</li>
        </ul>
      </section>

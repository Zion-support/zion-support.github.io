    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Service Lifespan Dashboard</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Tracks end-to-end asset and service lifecycles with renewal forecasts, upgrade windows, and retirement risk scoring across teams and vendors.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Asset and service lifecycle timelines</li>
            <li>Renewal and end-of-support forecasting</li>
            <li>Upgrade window planning</li>
            <li>Vendor transition tracking</li>
            <li>Risk scoring by dependency</li>
            <li>Executive readiness reports</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce surprise upgrade costs</li>
            <li>Plan replacements before outages</li>
            <li>Keep vendor transitions visible</li>
            <li>Support budgeting with lifecycle data</li>
        </ul>
      </section>

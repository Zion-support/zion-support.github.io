    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Chaos Mesh Cloud-native Chaos Engineering</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Chaos Mesh is a cloud-native Chaos Engineering platform that orchestrates chaos on Kubernetes environments. It helps you improve the resilience of your systems by injecting faults.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Kubernetes-native, installed via Helm or Operators</li>
            <li>Supports pod, network, filesystem, and time chaos experiments</li>
            <li>Provides a web dashboard for experiment management</li>
            <li>Integrates with Prometheus for monitoring experiment impact</li>
            <li>Supports scheduling and auto-rollback of experiments</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Proactively identify system weaknesses before they cause outages</li>
            <li>Run experiments in production with safety controls</li>
            <li>Improve system resilience and mean time to recovery (MTTR)</li>
            <li>Used by Alibaba Cloud, ByteDance, and Schneider Electric</li>
        </ul>
      </section>

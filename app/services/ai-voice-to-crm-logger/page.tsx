    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Voice-to-CRM Auto-Logging Assistant</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automatically logs sales calls, meetings, and voice notes into your CRM. AI transcribes conversations, extracts action items, identifies deal signals, and creates CRM records. Works with Zoom, Teams, Google Meet, and phone calls.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automatic call transcription (Zoom, Teams, Meet, phone)</li>
            <li>AI extraction of action items, deals, contacts</li>
            <li>CRM record auto-creation (Salesforce, HubSpot, Dynamics)</li>
            <li>Deal signal detection (budget, timeline, authority)</li>
            <li>Follow-up email drafts from call notes</li>
            <li>Compliance recording and archiving</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate manual CRM data entry</li>
            <li>Never lose a detail from a sales call</li>
            <li>Capture deal signals automatically</li>
            <li>Follow up faster with AI-drafted emails</li>
            <li>Full call archive for compliance and training</li>
        </ul>
      </section>

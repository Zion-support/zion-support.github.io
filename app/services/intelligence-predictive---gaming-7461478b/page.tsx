...
export const metadata = {
  title: "Intelligence Predictive - Gaming - Zion Tech Group",
  description: "Next-generation gaming solution: Intelligence Predictive - Gaming. Combines process automation with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligence-predictive---gaming-7461478b`
  }
};

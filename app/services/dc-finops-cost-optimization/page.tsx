    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center FinOps &amp; Cost Optimization</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Implement FinOps practices across colocation and cloud hybrid environments. Track spend per tenant, workload, and team. Identify waste, negotiate contracts, and build showback/chargeback models that actually work.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-tenant cost visibility with drill-down to workloads and racks</li>
            <li>Waste detection: idle resources, stranded capacity, overprovisioned power</li>
            <li>Automated showback/chargeback with tenant billing customization</li>
            <li>Colocation and cloud cost normalization in a single pane of glass</li>
            <li>Contract benchmarking and renewal insights for vendors and carriers</li>
            <li>Budget alerts and variance analysis with trend forecasting</li>
            <li>Anomaly detection for unexpected spikes in power or network spend</li>
            <li>ROI modeling for new deployments and migration projects</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cut infrastructure waste by 25% through actionable FinOps insights</li>
            <li>Eliminate billing disputes with transparent, per-tenant cost tracking</li>
            <li>Negotiate vendor contracts with real utilization benchmarks</li>
            <li>Accelerate finance and engineering alignment with shared dashboards</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$5,500/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

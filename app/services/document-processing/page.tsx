...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/document-processing`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/document-processing` title="Document Processing" />
        <h1 className="text-4xl font-bold mb-6">Document Processing</h1>
        <p className="text-lg text-gray-300 mb-8">Document Processing eliminates manual bottlenecks with intelligent process automation, event-driven orchestration, and cross-system integration. Re...</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with document processing</li>

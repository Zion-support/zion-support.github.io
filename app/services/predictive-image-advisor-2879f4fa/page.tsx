...
export const metadata = {
  title: "Predictive Image Advisor - Zion Tech Group",
  description: "The future of healthcare is here with Predictive Image Advisor. Powered by cutting-edge AI, this platform delivers process automation like never before.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/predictive-image-advisor-2879f4fa`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloud Spend Forecasting Model</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Forecasts cloud spend by workload and team with variance analysis, anomaly explanation, and budget alerts.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Workload and team attribution</li>
            <li>Forecast variance analysis</li>
            <li>Anomaly explanation</li>
            <li>Budget and alert policies</li>
            <li>Reservation planning</li>
            <li>Executive and engineering views</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce budget surprise</li>
            <li>Improve forecasting accuracy</li>
            <li>Keep finance and engineering aligned</li>
            <li>Maintain growth without runaway costs</li>
        </ul>
      </section>

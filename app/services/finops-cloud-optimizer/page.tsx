    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">FinOps Cloud Cost Optimizer</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Comprehensive FinOps platform that analyzes cloud spend across AWS, Azure, and GCP. Identifies waste, recommends rightsizing, automates reserved instance purchases, and provides chargeback reports per team and project.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-cloud cost aggregation and normalization</li>
            <li>Idle resource detection with auto-remediation policies</li>
            <li>Rightsizing recommendations with performance impact estimates</li>
            <li>Reserved instance and savings plan portfolio optimization</li>
            <li>Chargeback/showback reports with custom allocation rules</li>
            <li>Budget alerts with forecasted overspend warnings</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce cloud spend by 25-40% through waste elimination</li>
            <li>Make informed reserved capacity purchasing decisions</li>
            <li>Allocate cloud costs fairly across teams and products</li>
            <li>Prevent budget overruns with predictive alerting</li>
        </ul>
      </section>

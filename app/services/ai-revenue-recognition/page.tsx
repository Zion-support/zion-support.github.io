    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Revenue Recognition &amp; ASC 606 Compliance</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automate revenue recognition for complex multi-element arrangements, subscriptions, usage-based pricing, and milestone contracts. AI handles contract analysis, performance obligation identification, variable consideration estimation, and journal entry generation. Fully compliant with ASC 606 and IFRS 15. Reduces close time for revenue by 80%.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated contract analysis &amp; obligation identification</li>
            <li>Variable consideration estimation (usage, bonuses)</li>
            <li>Revenue schedule generation &amp; journal entries</li>
            <li>Multi-element arrangement allocation</li>
            <li>ASC 606 / IFRS 15 compliance reporting</li>
            <li>Audit trail &amp; disclosure report generation</li>
            <li>Integration with ERP (NetSuite, SAP, QuickBooks)</li>
            <li>Real-time revenue dashboards &amp; forecasting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce revenue close time by 80%</li>
            <li>Ensure ASC 606 / IFRS 15 compliance</li>
            <li>Eliminate spreadsheet-based revenue tracking</li>
            <li>Automate complex multi-element allocations</li>
            <li>Pass revenue audits with full documentation</li>
        </ul>
      </section>

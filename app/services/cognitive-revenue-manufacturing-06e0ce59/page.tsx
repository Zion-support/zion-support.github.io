...
export const metadata = {
  title: "Cognitive revenue-manufacturing - Zion Tech Group",
  description: "Next-generation Manufacturing solution: Cognitive revenue-manufacturing. Combines process discovery with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-revenue-manufacturing-06e0ce59`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Data Protection &amp; Backup Strategy</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Protect business-critical data with layered backup, retention policies, recovery testing, and capacity planning. Reduce data loss impact and improve recovery confidence.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Layered backup architecture</li>
            <li>Retention and compliance rules</li>
            <li>Recovery drill automation</li>
            <li>Capacity and cost planning</li>
            <li>RPO and RTO tracking</li>
            <li>Cross-region redundancy checks</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce data loss impact</li>
            <li>Improve recovery confidence</li>
            <li>Lower storage and recovery costs</li>

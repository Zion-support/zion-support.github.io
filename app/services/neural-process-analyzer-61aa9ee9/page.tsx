...
export const metadata = {
  title: "Neural Process Analyzer - Zion Tech Group",
  description: "Revolutionize legal through intelligent automation. Our Neural Process Analyzer leverages advanced machine learning to deliver customer insights at scale.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/neural-process-analyzer-61aa9ee9`
  }
};

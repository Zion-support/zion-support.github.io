    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloud Cost Optimization</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Reduce cloud spend 20-40% with rightsizing, reserved instance planning, and waste detection across AWS, Azure, and GCP.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cost visibility and dashboards</li>
            <li>Rightsizing recommendations</li>
            <li>Reserved instance planning</li>
            <li>Waste detection and cleanup</li>
            <li>Multi-cloud normalization</li>
            <li>Anomaly alerts and budgets</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Lower spend without performance loss</li>
            <li>Visibility into every resource</li>
            <li>Protect against billing surprises</li>

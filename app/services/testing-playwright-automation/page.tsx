    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Playwright Test Automation Suite</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">End-to-end browser testing framework for modern web applications. Supports Chromium, Firefox, and WebKit with auto-wait, network interception, visual regression testing, and parallel execution across multiple browsers and devices.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Auto-wait and retry mechanisms for flaky tests</li>
            <li>Network interception and API mocking</li>
            <li>Visual regression testing with pixel-perfect diffs</li>
            <li>Parallel execution across browsers and devices</li>
            <li>CI/CD integration with GitHub Actions, GitLab CI</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Catch bugs before users do with reliable E2E tests</li>
            <li>Reduce test flakiness with smart auto-wait</li>
            <li>Run tests 10x faster with parallel execution</li>
            <li>Integrate seamlessly into existing CI/CD pipelines</li>
        </ul>
      </section>

...
export const metadata = {
  ...
  description: "Transform your hospitality operations with our Management Intelligent - Hospitality. This AI-driven solution automates customer insights with unprecedented accu",
  alternates: {

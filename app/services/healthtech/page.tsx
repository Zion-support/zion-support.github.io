export const metadata = {title: 'Healthtech | Zion Tech Group',description: 'Professional healthtech services for your business needs.',keywords: 'healthtech, services, business, technology';

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Code Security Reviewer</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Static application security testing (SAST) platform powered by large language models. Detects vulnerabilities, insecure patterns, and compliance issues in source code across 30+ languages with fix suggestions.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Deep code analysis across 30+ programming languages</li>
            <li>OWASP Top 10 and CWE vulnerability detection</li>
            <li>Context-aware fix suggestions with code patches</li>
            <li>Pull request scanning with inline comments</li>
            <li>Compliance checking (SOC2, HIPAA, PCI-DSS code requirements)</li>
            <li>False positive suppression with team feedback learning</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Catch security vulnerabilities before code reaches production</li>
            <li>Reduce security review time by 70% with AI-powered analysis</li>
            <li>Train developers on secure coding with contextual fix suggestions</li>
            <li>Meet compliance requirements with automated code scanning</li>
        </ul>
      </section>

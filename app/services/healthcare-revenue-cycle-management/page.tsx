...
export const metadata = {
  ...
  description: "Automate healthcare revenue cycle from patient registration to final payment. AI-powered coding, claims submission, denial management, and payment reconciliatio",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Automate healthcare revenue cycle from patient registration to final payment. AI-powered coding, claims submission, denial management, and payment reconciliatio</p>

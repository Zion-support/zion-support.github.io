    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Customer Intelligence Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Unify customer data from every touchpoint into a single AI-powered intelligence layer. Predict lifetime value, identify at-risk accounts, and auto-trigger retention campaigns. Integrates with Salesforce, HubSpot, Stripe, and any API source.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Unified customer data platform with AI enrichment</li>
            <li>Lifetime value prediction with 92% accuracy</li>
            <li>At-risk account detection 30 days in advance</li>
            <li>Automated retention campaign triggers</li>
            <li>Revenue attribution across all channels</li>
            <li>Real-time customer health scoring</li>
            <li>Custom segmentation without SQL</li>
            <li>CRM sync (Salesforce, HubSpot, etc.)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Increase average revenue per customer by 22%</li>
            <li>Eliminate hours of manual data analysis</li>

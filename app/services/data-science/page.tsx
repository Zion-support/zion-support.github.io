export const metadata = {
  ...
  description:
    'Comprehensive data science solutions including machine learning, predictive analytics, data engineering, and business intelligence services.',
};
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-4xl mx-auto'>
            ...
            data science solutions. We help businesses make data-driven
            decisions and unlock the power of their information.
          </p>
        </div>
  ...
  return (
    <div className='bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-12 text-center text-white'>
      ...
      <p className='text-xl mb-8 max-w-3xl mx-auto'>
        Let's discuss how data science can transform your business and drive
        better decision-making. Our data science experts are ready to help you

  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Revolutionize insurance through intelligent automation. Our Adaptive generator-insurance leverages advanced machine learning to deliver workflow management at s</p>

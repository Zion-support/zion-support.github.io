    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">LangChain + LangGraph — AI Agent Orchestration Framework</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">LangChain and LangGraph are the leading open-source frameworks for building, orchestrating, and deploying autonomous AI agents. LangChain provides the building blocks — LLM integrations, prompt chains, memory, and tool connectors — while LangGraph adds stateful, cyclic agent workflows with human-in-the-loop checkpoints. Together, they power production AI agents at companies like LinkedIn, Uber, and JP Morgan. With 90,000+ GitHub stars, LangChain has the largest AI engineering community, and LangGraph\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>LangGraph stateful agents: cyclic, branching workflows with persistent memory and human-in-the-loop</li>
            <li>700+ integrations: OpenAI, Anthropic, Google, Pinecone, PostgreSQL, Slack, GitHub, and more</li>
            <li>LangSmith observability: trace every LLM call, debug agent decisions, and evaluate output quality</li>
            <li>Multi-agent orchestration: coordinate teams of specialized agents with shared state and task routing</li>
            <li>Tool calling and function execution: agents use APIs, databases, code interpreters, and web browsers</li>
            <li>Memory management: short-term conversation history and long-term vector store retrieval (RAG)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Build production AI agents in days instead of months with pre-built orchestration primitives</li>
            <li>Debug and monitor every agent decision with LangSmith\\</li>
            <li>,
      </li>
            <li>,
      </li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (open source, MIT license)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$100/month (LangSmith observability, 50K traces)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (self-hosted, SSO, dedicated support, SLA)</p>
          </div>
        </div>

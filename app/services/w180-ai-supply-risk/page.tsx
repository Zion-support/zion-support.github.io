    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Monitor supply chain risks: supplier financial health, geopolitical events, weather disruptions.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Supplier financial health monitoring</li>
            <li>Geopolitical risk scoring</li>
            <li>Weather and natural disaster alerts</li>
            <li>Alternative supplier recommendations</li>
            <li>Single-source risk identification</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect supply risks before disruption</li>
            <li>Proactive alternative sourcing</li>
            <li>Single-source dependency visibility</li>
        </ul>
      </section>

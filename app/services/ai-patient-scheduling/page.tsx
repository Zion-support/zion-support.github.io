    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Patient Scheduling &amp; Flow Optimizer</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Intelligent patient scheduling platform for healthcare systems that optimizes appointment slots, reduces no-shows, and balances provider workloads. Predictive no-show modeling with automated reminder campaigns.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Predictive no-show modeling with patient risk scoring</li>
            <li>Intelligent overbooking based on cancellation probability</li>
            <li>Automated reminder campaigns via SMS, email, and phone</li>
            <li>Multi-location and multi-provider schedule optimization</li>
            <li>Waitlist management with automated backfill</li>
            <li>Patient self-service rescheduling with mobile app</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce no-shows by 35% with predictive interventions</li>
            <li>Increase provider utilization by 20% with smart scheduling</li>
            <li>Improve patient satisfaction with reduced wait times</li>
            <li>Maximize revenue with optimized appointment density</li>
        </ul>
      </section>

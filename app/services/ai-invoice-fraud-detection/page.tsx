    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Invoice Fraud Detection &amp; AP Automation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered accounts payable automation that detects fraudulent invoices, duplicate payments, and policy violations. Processes invoices from any format with 99.7% accuracy.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>OCR extraction from PDF, email, scanned paper, and EDI</li>
            <li>Fraud detection: fake vendors, altered amounts, duplicate invoices</li>
            <li>Three-way matching: PO → receipt → invoice</li>
            <li>Approval workflow routing based on amount and vendor</li>
            <li>Integration with QuickBooks, NetSuite, SAP, Xero</li>
            <li>Audit trail with every action logged and timestamped</li>
            <li>Vendor risk scoring based on historical patterns</li>
            <li>Real-time alerts for suspicious invoice patterns</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Prevent 99% of invoice fraud with AI-powered detection</li>
            <li>Reduce AP processing costs by 70% through automation</li>
            <li>Eliminate duplicate payments saving average $45K/year</li>
            <li>Cut invoice processing time from 15 minutes to 30 seconds</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$199/mo (500 invoices/mo)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$499/mo (5,000 invoices, fraud rules)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$1,499/mo (unlimited, custom models, ERP integration)</p>
          </div>
        </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Virtual Desktop Infrastructure (VDI)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Cloud-hosted virtual desktop platform that delivers Windows and Linux desktops to any device. Centralized management, GPU acceleration for design workloads, and enterprise security with zero-trust access.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Windows and Linux virtual desktops from any device</li>
            <li>GPU-accelerated instances for CAD, 3D, and video workloads</li>
            <li>Centralized image management with version control</li>
            <li>Zero-trust access with device posture verification</li>
            <li>Session recording for compliance and training</li>
            <li>Auto-scaling with per-user cost tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Enable secure remote work from any device</li>
            <li>Reduce endpoint management costs by 60%</li>
            <li>Meet data residency requirements with centralized storage</li>
            <li>Scale desktops up or down based on workforce needs</li>
        </ul>
      </section>

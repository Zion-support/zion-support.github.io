...
export const metadata = {
  ...
  description: "Transform your finance operations with our Automated Orchestrator for Finance. This AI-driven solution automates financial planning with unprecedented accuracy ",
  alternates: {

    ...
    <div className="text-left">"
      ...
      <section className="text-left">"
        ...
        <div className="text-left">"
          ...
          <div className="text-left">"
            ...
            <div className="text-left">"
              <div className="text-left">$95M+</div>"
          ...
          <div className="text-left">"
            ...
            <div className="text-left">"
              ...
              <ul className="text-left">"
                <li className="text-left">"
                  <span className="text-left">✓<"
                  <span>Sub-second query performance<
                </li>
                <li className="text-left">"
                  <span className="text-left">✓<"
                  <span>Live dashboards and alerts<
                </li>
                <li className="text-left">"
                  <span className="text-left">✓<"
                  <span>Streaming data pipelines<
                </li>
                <li className="text-left">"
                  <span className="text-left">✓<"
                  <span>Complex event processing<
                </li>
              </ul>
            </div>
            ...
            <div className="text-left">"
              ...
              <ul className="text-left">"
                <li className="text-left">"
                  <span className="text-left">✓<"
                  <span>Time series forecasting<
                </li>
                <li className="text-left">"
                  <span className="text-left">✓<"
                  <span>Churn prediction<
                </li>
                <li className="text-left">"
                  <span className="text-left">✓<"
                  <span>Demand forecasting<
                </li>
                <li className="text-left">"
                  <span className="text-left">✓<"
                  <span>Risk assessment models<
                </li>
              </ul>
            </div>
            ...
            <div className="text-left">"
              ...
              <ul className="text-left">"
                ...
                <li className="text-left">"
                  <span className="text-left">✓<"
                  <span>Pattern discovery<
                </li>
                <li className="text-left">"
                  <span className="text-left">✓<"
                  <span>Natural language insights<
                </li>
                <li className="text-left">"
                  <span className="text-left">✓<"
                  <span>Automated reporting<
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="text-left">"
          ...
          <div className="text-left">"
            <div className="text-left">"
              ...
              <div>
                <h3 className="text-left">Analytics & BI</h3>"
                <ul className="text-left">"
      ...
      <section className="text-left">"
        <div className="text-left">"
          ...
          <div className="text-left">"
            ...
            <div className="text-left">"
              <h3 className="text-left">Weeks 3-5: Platform Deployment</h3>"
      ...
      <section className="text-left">"
        <div className="text-left">"
          ...
          <p className="text-left">"
            Or explore our <Link href="/case-studies" className="text-left">success stories</Link> to see AI analytics in action"
          </p>
        </div>
      </section>

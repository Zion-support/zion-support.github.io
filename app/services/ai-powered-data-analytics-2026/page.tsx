      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <p className="mt-8 text-lg opacity-90">
            Or explore our <a href="/case-studies" className="underline hover:text-yellow-300">success stories</a> to see AI analytics in action
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <a href="/services/ai-cybersecurity-2025" className="block p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105">
            ...
            <a href="/services/ai-cloud-infrastructure-2025" className="block p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105">
            ...
            <a href="/services/ai-blockchain-integration-2025" className="block p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all hover:scale-105">

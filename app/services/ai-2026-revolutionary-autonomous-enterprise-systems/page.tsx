    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="border-t border-gray-200 pt-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <a href="/services/ai-autonomous-operations-2026" className="block p-6 border border-gray-200 rounded-lg hover:border-purple-300 hover:bg-purple-50 transition-all duration-200">
          ...
          <a href="/services/ai-2027-revolutionary-breakthrough-solutions" className="block p-6 border border-gray-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-all duration-200">

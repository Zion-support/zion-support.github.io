  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/healthcare-it-telemedicine-platform` title="Telemedicine Platform for Healthcare IT" />
        <h1 className="text-4xl font-bold mb-6">Telemedicine Platform for Healthcare IT</h1>
        <p className="text-lg text-gray-300 mb-8">HIPAA-compliant telemedicine platform with video consultations, e-prescribing, patient scheduling, and EHR integration.</p>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Colocation &amp; Wholesale Space Leasing</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Flexible colocation options from single cabinets to wholesale suites and build-to-spec shells. Power configurations from 5 kW to 2 MW+, redundant utility feeds, and carrier-neutral interconnection included.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cabinet, cage, suite, and wholesale hall configurations</li>
            <li>Redundant 2N power feeds and UPS-backed circuits</li>
            <li>Carrier-neutral meet-me room with 50+ providers</li>
            <li>Remote hands and smart hands service levels</li>
            <li>24/7 NOC and on-site security</li>
            <li>Tier III/IV certified facilities with 99.982% uptime SLA</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Scale from 1 cabinet to 10,000 sq ft without moving</li>
            <li>Avoid 18+ month build timelines with ready capacity</li>
            <li>Reduce colocation costs with consolidated billing</li>
            <li>Access to rich interconnection ecosystem for hybrid cloud</li>
        </ul>
      </section>

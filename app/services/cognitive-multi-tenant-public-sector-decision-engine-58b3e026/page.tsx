...
export const metadata = {
  title: "Cognitive Multi-Tenant Public Sector Decision Engine - Zion Tech Group",
  description: "Cognitive decision engine that processes multi-tenant signals to drive public sector strategy with deep learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-multi-tenant-public-sector-decision-engine-58b3e026`
  }
};

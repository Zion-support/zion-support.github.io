    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Velero Kubernetes Backup and Disaster Recovery</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Velero is an open source tool to safely backup and restore, perform disaster recovery, and migrate Kubernetes cluster resources and persistent volumes. It provides a simple, configurable and operationally robust way to back up your application state and associated data.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Backs up Kubernetes objects and persistent volumes to arbitrary cloud storage</li>
            <li>Supports snapshot-based volume backups for AWS EBS, GCE PD, Azure Disk, and more</li>
            <li>Enables cluster migration and resource movement between different Kubernetes clusters</li>
            <li>Provides built-in integration with AWS, Azure, and GCP for cloud-native volume snapshots</li>
            <li>Includes built-in helpers for commonly used cloud providers and CSI drivers</li>
            <li>Supports backup encryption, compression, and selective resource inclusion/exclusion</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminates complex custom backup scripts with standardized, reliable backup/restore</li>
            <li>Enables migration between Kubernetes clusters, clouds, and on-premise environments</li>
            <li>Provides point-in-time recovery for accidental deletions or cluster corruption</li>
            <li>Integrates with CSI drivers for application-consistent snapshots of stateful workloads</li>
            <li>Used by Red Hat, VMware, Microsoft Azure AKS, and thousands of Kubernetes clusters</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (OSS, Apache 2.0)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">Free tier (community support)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

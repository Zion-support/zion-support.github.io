  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">AI-Powered CRM Solution</h1>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Intelligent customer relationship management platform with AI-driven insights, 
          automated workflows, and predictive analytics to boost sales and customer satisfaction.
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-xl p-8 mb-16">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">CRM Benefits & ROI</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="text-center">
            <div className="text-4xl mb-4">📈</div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">37% Sales Increase</h3>
            <p className="text-gray-600">AI-driven insights boost conversion rates</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">⏰</div>
          ...
          <div className="text-center">
            <div className="text-4xl mb-4">🎯</div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">90% Accuracy</h3>
...
function PricingSection() {
  return (
    <div className="mb-16">
      <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">CRM Pricing Plans</h2>
...
function PricingCard({ name, price, duration, features, popular }: { 
  ...
  return (
    <div className={`relative bg-white border-2 rounded-xl p-8 ${popular ? 'border-indigo-500 shadow-lg' : 'border-gray-200'}`}>
      {popular && (
...
function ContactSection() {
  return (
    <div className="bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-xl p-8 text-center">
      <h3 className="text-2xl font-bold text-gray-900 mb-4">Ready to Transform Your Sales Process?</h3>
      <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
        Let's discuss your CRM needs and create an intelligent solution that drives sales growth and customer satisfaction.
      </p>

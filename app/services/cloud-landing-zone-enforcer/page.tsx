    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloud Landing Zone Enforcer</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enforces landing-zone standards across accounts and subscriptions with guardrails, drift alerts, and remediation playbooks.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Account and subscription guardrails</li>
            <li>Policy-as-code pairing</li>
            <li>Drift alerting</li>
            <li>Remediation playbooks</li>
            <li>Inventory and tagging enforcement</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Keep multi-account estates consistent</li>
            <li>Reduce onboarding drift</li>
            <li>Produce audit-ready evidence</li>
            <li>Accelerate new workload safe deployment</li>
        </ul>
      </section>

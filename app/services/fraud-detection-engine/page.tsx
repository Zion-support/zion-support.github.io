    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Real-Time Fraud Detection Engine</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered fraud detection platform that analyzes transactions in real-time using behavioral biometrics, device intelligence, and network analysis. Sub-50ms scoring with adaptive models that evolve with fraud patterns.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time transaction scoring with sub-50ms latency</li>
            <li>Behavioral biometrics (typing, mouse, touch patterns)</li>
            <li>Device intelligence with fingerprinting and emulation detection</li>
            <li>Network analysis with mule account identification</li>
            <li>Adaptive ML models that learn from new fraud patterns</li>
            <li>Case management with investigator workflow tools</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect fraud in real-time before transactions complete</li>
            <li>Reduce false positives by 60% with behavioral biometrics</li>
            <li>Adapt to new fraud schemes without manual rule updates</li>
            <li>Minimize fraud losses while maintaining customer experience</li>
        </ul>
      </section>

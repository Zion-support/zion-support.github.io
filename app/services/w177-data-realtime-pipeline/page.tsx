    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Realtime Data Pipeline</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Kafka/Flink-based streaming pipelines for operational analytics, CDC, and event-driven architectures with schema governance.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Stream processing and enrichment</li>
            <li>Schema registry and governance</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Insights within seconds, not hours</li>
            <li>Reduce batch-window complexity</li>
            <li>Governed data as it flows</li>
            <li>Resilient pipelines with replay</li>
        </ul>
      </section>

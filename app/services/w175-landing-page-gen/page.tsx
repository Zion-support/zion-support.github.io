    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">LandingPage Gen — AI Landing Pages</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Generate high-converting landing pages from a brief: copy, layout, images, and CTA variants. Publish to your domain or export as clean HTML.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI copy generation and variants</li>
            <li>Conversion-oriented layout templates</li>
            <li>Image sourcing and generation</li>
            <li>A/B variants and CTA optimization</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Launch landing pages in minutes</li>
            <li>Conversion-focused by default</li>
            <li>A/B variants improve results</li>

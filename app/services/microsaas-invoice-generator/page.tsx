    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Smart Invoice Generator &amp; Payment Hub</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Create and send professional invoices in seconds. Auto-calculate taxes, accept online payments, send reminders, and reconcile with bank feeds. AI suggests optimal send times for faster payment.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Smart invoice builder with templates</li>
            <li>Auto tax calculation by jurisdiction</li>
            <li>Online payment acceptance (Stripe, PayPal, ACH)</li>
            <li>AI-optimized send-time for faster payment</li>
            <li>Automated payment reminders</li>
            <li>Bank reconciliation and financial reports</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Get paid up to 30% faster with AI send-time</li>
            <li>Accept payments online in any currency</li>
            <li>Automate payment reminders — stop chasing</li>
            <li>Reconcile invoices with bank feeds</li>

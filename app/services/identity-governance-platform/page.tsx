    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Identity Governance &amp; Administration</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Comprehensive identity governance platform that manages the complete identity lifecycle — joiner, mover, leaver processes, access certifications, role management, and compliance reporting. Ensures least-privilege access at scale.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated joiner-mover-leaver provisioning workflows</li>
            <li>Access certification campaigns with manager attestation</li>
            <li>Role mining and role-based access control optimization</li>
            <li>Segregation of duties (SoD) violation detection</li>
            <li>Privileged access management with session recording</li>
            <li>Compliance reporting for SOX, HIPAA, PCI-DSS</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce access-related security incidents by 80%</li>
            <li>Automate compliance audits with continuous certification</li>
            <li>Eliminate orphaned accounts and excessive privileges</li>
            <li>Scale identity governance without adding headcount</li>
        </ul>
      </section>

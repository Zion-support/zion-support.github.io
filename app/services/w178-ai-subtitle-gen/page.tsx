    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Subtitle and Caption Generator</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Auto-generate subtitles: 100+ languages, speaker identification, formatting, export to SRT/VTT.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Speech-to-text in 100+ languages</li>
            <li>Speaker identification and diarization</li>
            <li>Caption formatting and timing</li>
            <li>Translation and transcreation</li>
            <li>Export to SRT, VTT, SCC, TTML</li>
            <li>Integration with YouTube, Vimeo, Rev</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Subtitles in 100+ languages</li>
            <li>Speaker identification improves accuracy</li>
            <li>Translation for global platforms</li>
            <li>Export to any subtitle format</li>
        </ul>
      </section>

...
export const metadata = {
  ...
  description: "Revolutionize energy through intelligent automation. Our AI Engine - Energy Edition leverages advanced machine learning to deliver risk assessment at scale.",
  alternates: {

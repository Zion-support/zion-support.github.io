  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Automated data catalog with AI-powered classification, lineage tracking, and governance policies. Discover, understand, and govern data assets across the enterp</p>

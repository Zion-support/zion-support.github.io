    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Multi-Cloud Cost Optimizer</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-driven cloud cost management across AWS, Azure, and GCP. Identifies waste, recommends reserved instance purchases, and automates resource right-sizing. Real-time cost allocation and chargeback.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cross-cloud cost visibility and analytics</li>
            <li>AI-powered waste detection and recommendations</li>
            <li>Reserved instance and savings plan optimization</li>
            <li>Automated resource right-sizing and scheduling</li>
            <li>Cost allocation with showback and chargeback</li>
            <li>Budget alerts with anomaly detection</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce cloud spend by 35% on average</li>
            <li>Eliminate wasted resources automatically</li>
            <li>Accurate cost allocation across teams and projects</li>
            <li>Predict and prevent budget overruns</li>
        </ul>
      </section>

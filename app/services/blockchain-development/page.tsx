export const metadata = { 
  ...
  description: 'Build secure, scalable blockchain applications, smart contracts, and Web3 solutions with expert blockchain development services.'
};

export default function BlockchainDevelopmentPage() {
  return (
    <section>
      <h1 style={{fontSize: 26, fontWeight: 800}}>Blockchain Development & Web3 Solutions</h1>
      <p style={{marginTop: 8, color: '#374151'}}>
        Build the future with secure, scalable blockchain applications, smart contracts, and Web3 solutions 
        that revolutionize business processes and create new revenue streams.
      </p>
      ...
      <div style={{marginTop: 24, padding: 20, backgroundColor: '#f0fdf4', borderRadius: 12, border: '1px solid #bbf7d0'}}>
        <h3 style={{fontSize: 18, fontWeight: 700, marginBottom: 12, color: '#14532d'}}>Why Choose Our Blockchain Services?</h3>
        <ul style={{color: '#166534', lineHeight: 1.6}}>
          <li>• <strong>Security First:</strong> All smart contracts undergo rigorous security auditing</li>
          <li>• <strong>Multi-Chain Expertise:</strong> Ethereum, Polygon, BSC, Solana, and more</li>
          <li>• <strong>Gas Optimization:</strong> Reduce transaction costs by up to 70%</li>
          <li>• <strong>Regulatory Compliance:</strong> Ensure compliance with evolving regulations</li>
          <li>• <strong>24/7 Support:</strong> Ongoing maintenance and monitoring services</li>
        </ul>
      </div>
...
function Pricing() {
  return (
    <div style={{marginTop: 32}}>
      <h2 style={{fontSize: 24, fontWeight: 700, marginBottom: 20, color: '#1f2937'}}>Blockchain Development Pricing</h2>
      ...
      <div style={{marginTop: 24, textAlign: 'center', padding: 20, backgroundColor: '#fef3c7', borderRadius: 12, border: '1px solid #fbbf24'}}>
        <h3 style={{fontSize: 18, fontWeight: 600, marginBottom: 8, color: '#92400e'}}>Free Blockchain Consultation</h3>
        <p style={{color: '#a16207', marginBottom: 16}}>
          Get expert advice on your blockchain project. We'll analyze your requirements 
          and provide a detailed roadmap with cost estimates and timeline.
        </p>

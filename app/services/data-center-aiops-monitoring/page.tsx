    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI-Driven Data Center Operations (DC AIOps)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automate data center operations with AI/ML-powered monitoring, predictive maintenance, and self-healing infrastructure. Reduce MTTR, optimize power usage effectiveness, and eliminate alert fatigue.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Power and thermal optimization using ML</li>
            <li>Self-healing workflows for network, power, and cooling</li>
            <li>Unified observability across DCIM, BMS, and IT systems</li>
            <li>Smart alerting that reduces noise by 80%</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce downtime and MTTR by up to 60%</li>
            <li>Cut energy costs through intelligent power optimization</li>
            <li>Free up ops teams from repetitive manual monitoring</li>
            <li>Deliver 99.999% availability for critical workloads</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Dubbing and Voiceover Studio</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI dubbing for video content: lip-sync, emotion matching, 50+ languages. Professional voiceovers without recording.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI dubbing with lip-sync</li>
            <li>Emotion and tone matching</li>
            <li>50+ language support</li>
            <li>Voice cloning from sample</li>
            <li>Batch processing for series</li>
            <li>Integration with Adobe Premiere, Descript, ElevenLabs</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Dub content in 50+ languages</li>
            <li>Lip-sync for natural viewing</li>
            <li>Emotion matching for authenticity</li>
            <li>Batch processing for series</li>
        </ul>
      </section>

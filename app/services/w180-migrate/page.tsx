...
export const metadata = {
  title: 'Cloud Migration Assessment and Execution | Zion Tech Group',
  description: 'End-to-end cloud migration: assessment, planning, 6R strategy.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/w180-migrate',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloud Migration Assessment and Execution</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">End-to-end cloud migration: assessment, planning, 6R strategy.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>6R migration strategy per workload</li>
            <li>TCO modeling and ROI analysis</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Migrate 100+ workloads with proven methodology</li>
            <li>6R strategy ensures optimal approach</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Access Request Auditor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Reviews access requests, approver behavior, and entitlement drift across directory and cloud identity systems.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Access request review</li>
            <li>Approver behavior scoring</li>
            <li>Entitlement drift alerts</li>
            <li>Policy violation capture</li>
            <li>Audit evidence exports</li>
            <li>Review and exception routing</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce entitlement sprawl</li>
            <li>Keep approvals evidence-based</li>
            <li>Accelerate audit prep</li>
            <li>Support least-privilege goals</li>
        </ul>
      </section>

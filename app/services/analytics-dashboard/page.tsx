export const metadata = {title: 'Analytics Dashboard | Zion Tech Group',description: 'Professional analytics dashboard services for your business needs.',keywords: 'analytics-dashboard, services, business, technology';

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Kilobots — Swarm Intelligence Orchestration Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Kilobots provides a commercial-grade swarm intelligence platform for coordinating hundreds to thousands of autonomous agents working collectively. Inspired by ant colonies and bee hives, swarm intelligence enables distributed problem-solving for logistics optimization, warehouse robotics, agricultural drone fleets, and emergency response coordination without central control.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Decentralized coordination algorithms — no single point of failure</li>
            <li>Support for 1000+ simultaneous heterogeneous robot agents</li>
            <li>Built-in consensus protocols: stigmergy, flocking, task allocation</li>
            <li>Digital twin simulation environment for pre-deployment testing</li>
            <li>ROS2 and MQTT integration for real hardware fleet management</li>
            <li>Emergent behavior analysis and safety constraint enforcement</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Warehouse picking efficiency increased 40% vs centralized WMS</li>
            <li>Scalable to 10,000+ agents without performance degradation</li>
            <li>Self-healing: swarm adapts when individual agents fail</li>
            <li>Agricultural drone fleets coordinate crop monitoring autonomously</li>
            <li>Military-grade robustness using bio-inspired communication protocols</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (simulation only)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$2,000/month (100 agents)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom ($50K+/program)</p>
          </div>
        </div>

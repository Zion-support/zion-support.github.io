...
export const metadata = {
  ...
  description: "Extract insights from clinical notes, medical records, and research papers. Medical entity recognition, phenotype extraction, clinical coding, and HIPAA-complia",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Extract insights from clinical notes, medical records, and research papers. Medical entity recognition, phenotype extraction, clinical coding, and HIPAA-complia</p>

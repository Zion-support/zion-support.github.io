    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Deepfake Detection Suite</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enterprise-grade deepfake detection platform that analyzes images, video, and audio for synthetic media manipulation. Uses ensemble models trained on latest generation attacks with real-time API for content moderation workflows.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Image forensics analysis (Error Level Analysis, metadata inspection)</li>
            <li>Video deepfake detection with frame-by-frame scoring</li>
            <li>Audio synthesis detection (voice cloning, speech generation)</li>
            <li>Confidence scores with explainable AI heatmaps</li>
            <li>REST API for real-time content moderation pipelines</li>
            <li>Batch processing for media library audits</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Protect brand reputation from synthetic media fraud</li>
            <li>Comply with emerging deepfake disclosure regulations</li>
            <li>Integrate detection into existing moderation workflows</li>
            <li>Stay ahead of evolving generation techniques with monthly model updates</li>
        </ul>
      </section>

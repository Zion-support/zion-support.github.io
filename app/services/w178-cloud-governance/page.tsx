    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloud Governance and Policy Engine</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Cloud governance: policy-as-code, tagging enforcement, cost controls, compliance guardrails.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Policy-as-code (OPA, Sentinel, AWS SCP)</li>
            <li>Tagging and naming enforcement</li>
            <li>Cost controls and budget alerts</li>
            <li>Compliance guardrails (CIS, custom)</li>
            <li>Account vending and landing zones</li>
            <li>Integration with AWS Organizations, Azure Policy</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Consistent governance across all accounts</li>
            <li>Policy-as-code enforces standards automatically</li>
            <li>Cost controls prevent budget overruns</li>
            <li>Compliance guardrails prevent misconfigurations</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Outline Knowledge Base</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Beautiful, open-source knowledge base and documentation platform designed for teams that want a self-hosted alternative to Notion or Confluence. Features a real-time collaborative editor, hierarchical document organization, full-text search, and a clean Slack-like interface that makes documentation enjoyable to write and maintain.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time collaborative rich-text editor with Markdown support, code blocks, and embeds</li>
            <li>Hierarchical document tree with drag-and-drop organization — structure knowledge like a filesystem</li>
            <li>Full-text search across all documents with instant results and highlighted matches</li>
            <li>Slack integration: share documents in channels, get notifications on edits, search docs from Slack</li>
            <li>SSO authentication via OIDC, SAML, and GitHub — enterprise identity management ready</li>
            <li>Self-hosted with Docker; PostgreSQL backend; S3-compatible storage for attachments and images</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Replaces Confluence ($5.75+/user/mo) and Notion ($8+/user/mo) with a self-hosted option that</li>
            <li>,
      </li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Cloud Team from $10/user/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Cloud Team: unlimited documents, 10GB storage</p>
          </div>
        </div>

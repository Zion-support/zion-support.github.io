  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/ai-precision-agriculture` title="AI Precision Agriculture &amp; Crop Management" />
        <h1 className="text-4xl font-bold mb-6">AI Precision Agriculture &amp; Crop Management</h1>
        <p className="text-lg text-gray-300 mb-8">AI-powered precision agriculture platform using satellite imagery, drone data, and IoT sensors to optimize crop yields and reduce resource waste.</p>

        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Satellite and drone crop health monitoring</li>
            <li>Soil moisture and nutrient analysis</li>

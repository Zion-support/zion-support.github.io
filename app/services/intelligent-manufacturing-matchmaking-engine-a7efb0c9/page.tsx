...
export const metadata = {
  title: "Intelligent Manufacturing Matchmaking Engine - Zion Tech Group",
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligent-manufacturing-matchmaking-engine-a7efb0c9`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/intelligent-manufacturing-matchmaking-engine-a7efb0c9` title="Intelligent Manufacturing Matchmaking Engine" />
        <h1 className="text-4xl font-bold mb-6">Intelligent Manufacturing Matchmaking Engine</h1>

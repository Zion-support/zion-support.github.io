// app/services/it-endpoint-security-compliance/page.tsx — IT Endpoint Security & Compliance
import Link from 'next/link';

export const metadata = {
  title: 'IT Endpoint Security & Compliance | Zion Tech Group',
  description: 'Comprehensive endpoint protection and compliance management for all devices.',
  openGraph: {
    title: 'IT Endpoint Security & Compliance | Zion Tech Group',
    description: 'Comprehensive endpoint protection and compliance management for all devices.',
    url: 'https://ziontechgroup.com/services/it-endpoint-security-compliance',
  },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      <section className="py-20 text-center max-w-7xl mx-auto px-4">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">IT Endpoint Security &amp; Compliance</h1>
        <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">Comprehensive endpoint protection and compliance management for all devices.</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            {features.map((feature) => (
              <div key={feature} className="p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl border border-blue-200">
                ...
                <p className="text-gray-600">Enterprise-grade endpoint security capabilities.</p>
              </div>
            ))}
          </div>
        </div>
            ...
            {benefits.map((benefit) => (
              <div key={benefit} className="flex items-start gap-4 p-6 bg-white rounded-xl shadow-lg border border-gray-200">
                <div>
                  ...
                  <p className="text-gray-600">Achieve robust security and compliance with our proven solutions.</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-white">
          <h2 className="text-4xl font-bold mb-4">Ready to Secure Your Endpoints?</h2>
          <p className="text-xl mb-8 text-blue-100">
            Let&apos;s discuss how IT Endpoint Security &amp; Compliance can help you protect your business.
          </p>

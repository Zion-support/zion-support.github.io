    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Network Infrastructure Design &amp; Support</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Complete network infrastructure services from design to ongoing support. Includes LAN/WAN design, SD-WAN deployment, WiFi site surveys, network security hardening, and 24/7 NOC monitoring. Optimize for performance, reliability, and cost. Supports Cisco, Meraki, Ubiquiti, and Aruba environments.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>LAN/WAN architecture design &amp; documentation</li>
            <li>SD-WAN deployment &amp; optimization</li>
            <li>WiFi site survey &amp; access point planning</li>
            <li>Network security hardening &amp; segmentation</li>
            <li>Firewall configuration &amp; management</li>
            <li>24/7 NOC monitoring &amp; alerting</li>
            <li>Capacity planning &amp; bandwidth optimization</li>
            <li>Vendor management &amp; hardware procurement</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Achieve 99.99% network uptime</li>
            <li>Optimize bandwidth costs with SD-WAN</li>
            <li>Secure network with zero-trust segmentation</li>
            <li>Scale network for growth without redesign</li>
            <li>24/7 expert monitoring without hiring NOC staff</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$2,499 (design + assessment)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$7,499 (deployment)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom managed NOC</p>
          </div>
        </div>

...
export const metadata = {
  title: "SQL-Powered E-Commerce Automation - Zion Tech Group",
  description: "Drive innovation in e-commerce with SQL-Powered E-Commerce Automation. This AI-powered platform transforms analytics processing into a competitive advantage.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/sql-powered-e-commerce-automation-ef10231f`
  }
};

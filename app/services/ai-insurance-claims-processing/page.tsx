    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Insurance Claims Processing &amp; Fraud Detection</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automate insurance claims intake, validation, and adjudication with AI. OCR extracts data from claim documents, AI validates against policy rules, detects fraud patterns, and calculates payouts. Reduces claims processing time from weeks to hours.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>OCR document extraction (forms, photos, invoices)</li>
            <li>Policy rule validation engine</li>
            <li>AI fraud pattern detection</li>
            <li>Automated payout calculation</li>
            <li>Regulatory compliance checks</li>
            <li>Integration with core insurance platforms</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Process claims 10x faster</li>
            <li>Detect 3x more fraud than manual review</li>
            <li>Reduce claims leakage by 15-20%</li>
            <li>Improve customer satisfaction with faster payouts</li>
            <li>Meet regulatory compliance automatically</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$5,999/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

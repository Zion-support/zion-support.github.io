...
export const metadata = {
  ...
  "description": 'Professional ai healthcare analytics solutions for your business needs.','
};
      ...
      <div className="container mx-auto px-4 py-20">"
        <div className="text-center mb-16">"
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">"
            Professional ai healthcare analytics solutions designed to meet your business requirements,
        ...
        <div className="max-w-6xl mx-auto">"
          ...
          <div className="text-center bg-white rounded-xl shadow-lg p-12">"
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">"
              Contact us today to discuss your ai healthcare analytics requirements,
...
export const metadata = {
  title: 'Ai Healthcare Analytics | Zion Tech Group',
  description: 'Professional ai healthcare analytics solutions for modern businesses. Transform your operations with our advanced ai healthcare analytics technology.'
};
...
=======
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional ai healthcare analytics solutions for modern businesses. Transform your operations with our advanced ai healthcare analytics technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our ai healthcare analytics can help your business
          </p>
          <a
            href="/contact"

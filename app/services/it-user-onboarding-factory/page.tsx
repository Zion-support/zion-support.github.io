    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT User Onboarding Factory</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automates provisioning, access requests, training assignments, and day-one readiness workflows for employees, vendors, and contractors.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Access request routing</li>
            <li>Training assignment automation</li>
            <li>Day-one readiness workflows</li>
            <li>MSP and vendor onboarding lanes</li>
            <li>HR and IT handoff history</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cut first-day setup time</li>
            <li>Reduce access request overhead</li>
            <li>Improve employee experience</li>
            <li>Speed vendor onboarding</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Contract Renewal Automation Runner</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Manages renewal workflows for SaaS, suppliers, and vendor contracts with renewal scoring, owner routing, and evidence capture.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Contract inventory and renewal dates</li>
            <li>Renewal risk scoring</li>
            <li>Owner routing and approval workflows</li>
            <li>Price change and negotiation notes</li>
            <li>Evidence package generation</li>
            <li>Calendar and notification integration</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce missed renewal windows</li>
            <li>Keep renewal strategy visible</li>
            <li>Produce deal-ready evidence</li>
            <li>Accelerate negotiation cycles</li>
        </ul>
      </section>

...
export const metadata = {
  title: 'Ai Chatbot Platform | Zion Tech Group',
  description: 'Professional ai chatbot platform solutions for modern businesses. Transform your operations with our advanced ai chatbot platform technology.'
};
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional ai chatbot platform solutions for modern businesses. Transform your operations with our advanced ai chatbot platform technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our ai chatbot platform can help your business
          </p>
          <a
            href="/contact"

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Ansys — Digital Twin Simulation &amp; Engineering Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Ansys is the global leader in engineering simulation and digital twin technology, providing physics-based simulation software that creates virtual replicas of physical products, systems, and processes. Used by 50,000+ companies including Tesla, Boeing, and Siemens.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Physics-based simulation: structural, thermal, fluid, electromagnetic analysis</li>
            <li>Live digital twins: combine simulation models with IoT sensor data</li>
            <li>Predictive maintenance: simulate wear, fatigue, and failure modes</li>
            <li>Optimization AI: automatically explore design spaces for optimal configurations</li>
            <li>Cloud simulation: run massive simulations on cloud HPC</li>
            <li>Industry-specific solutions: automotive, aerospace, energy, healthcare templates</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce physical prototyping costs by 75% with accurate virtual testing</li>
            <li>Accelerate time-to-market by 50% through simulation-driven design</li>
            <li>Trusted by 50,000+ companies including Tesla, Boeing, and Siemens</li>
            <li>Predict failures before they occur with live digital twins</li>
            <li>Explore thousands of design variations in hours instead of months</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$5,000/year (Ansys Discovery, basic simulation, 1 user)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$25,000/year (full physics suite, digital twin builder, 5 users)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited users, HPC, custom physics, SLA)</p>
          </div>
        </div>

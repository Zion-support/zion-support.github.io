  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/ai-gen-app-dev-1` title="AI-Powered Application Development" />
        <h1 className="text-4xl font-bold mb-6">AI-Powered Application Development</h1>
        <p className="text-lg text-gray-300 mb-8">End-to-end development service for building production-ready AI applications — from LLM-powered chatbots and RAG systems to multi-agent workflows and AI-native </p>

...
export const metadata = {
  title: "AI-Powered Hyper-Local Government Optimization Engine - Zion Tech Group",
  description: "AI-powered optimization engine that continuously improves hyper-local government performance through self-tuning algorithms.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-hyper-local-government-optimization-engine-5a1192ad`
  }
};

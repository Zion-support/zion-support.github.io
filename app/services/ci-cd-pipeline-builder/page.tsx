export const metadata = {
  ...
  description: 'Build robust CI/CD pipelines for continuous integration and deployment.',
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Build robust CI/CD pipelines for continuous integration and deployment.
          </p>
        </div>

...
>>>>>>> cursor/automate-test-improve-and-merge-code-5e91
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Contact us today to learn how our ci cd pipeline builder services can transform your business.
          </p>
...
export const metadata = {
  title: 'Ci Cd Pipeline Builder | Zion Tech Group',
  description: 'Professional ci cd pipeline builder solutions for modern businesses. Transform your operations with our advanced ci cd pipeline builder technology.'
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional ci cd pipeline builder solutions for modern businesses. Transform your operations with our advanced ci cd pipeline builder technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our ci cd pipeline builder can help your business
          </p>
          <a
            href="/contact"

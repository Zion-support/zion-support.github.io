...
export const metadata = {
  ...
  description: "Automated CI/CD pipeline creation with intelligent deployment strategies, monitoring, and rollback capabilities for faster, safer releases.",
};
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="bg-gradient-to-r from-purple-50 to-violet-50 border border-purple-200 rounded-xl p-8 mb-16">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Why Choose Our CI/CD Pipeline Builder?</h2>
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready to Streamline Your Deployments?</h2>
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
          Transform your deployment process with intelligent CI/CD pipelines that adapt to your needs and scale with your growth.
        </p>

...
export const metadata = {
  title: "Cloud-Native Context-Aware E-Commerce Orchestration - Zion Tech Group",
  description: "Cloud-native orchestration platform that manages context-aware e-commerce resources with auto-scaling and cost control.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cloud-native-context-aware-e-commerce-orchestration-3174b07d`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Financial Forecasting Copilot</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered financial planning and analysis (FP&amp;A) copilot that builds rolling forecasts, variance analyses, and scenario models from your actuals. Connects to ERPs, CRMs, and spreadsheets. Natural language queries let any stakeholder ask </p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Rolling forecast generation from historical actuals and pipeline data</li>
            <li>Natural language query interface for ad-hoc financial questions</li>
            <li>Scenario modeling with Monte Carlo simulation</li>
            <li>Automated variance analysis with AI-generated commentary</li>
            <li>Integration with NetSuite, SAP, QuickBooks, Salesforce, and Excel</li>
            <li>Board-ready report generation with charts and narrative</li>
            <li>Audit trail for every forecast assumption and data source</li>
            <li>Multi-entity consolidation and currency conversion</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cut forecast cycle time from weeks to hours</li>
            <li>Enable self-service financial insights for non-finance stakeholders</li>
            <li>Improve forecast accuracy by 35% with ML-driven projections</li>
            <li>Produce board-ready reports in minutes, not days</li>
        </ul>
      </section>

    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-amber-50">
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <a href="/services" className="text-amber-600 hover:text-amber-700 font-semibold mb-4 inline-block">
              ← Back to Services
            </a>
          ...
          <section>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <a href="/services/ai-cloud-infrastructure-2025" className="group">
                <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border border-gray-200">
                  <h3 className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-amber-600 transition-colors">

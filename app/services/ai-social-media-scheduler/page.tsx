        ...
        <div className="grid grid-cols-2 "md":grid-cols-3 "lg":grid-cols-5 gap-6">"
          {[
            ...
            <div key={index} className="text-center p-4 bg-white rounded-lg shadow-sm border border-gray-200">"
              <div className={`w-12 h-12 ${platform.color} rounded-full flex items-center justify-center mx-auto mb-3`}>`                <span className="text-white text-xl">{platform.icon}</span>"
              </div>
...
export const metadata = {
  title: 'Ai Social Media Scheduler | Zion Tech Group',
  description: 'Professional ai social media scheduler solutions for modern businesses. Transform your operations with our advanced ai social media scheduler technology.'
};
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional ai social media scheduler solutions for modern businesses. Transform your operations with our advanced ai social media scheduler technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our ai social media scheduler can help your business
          </p>
          <a
            href="/contact"

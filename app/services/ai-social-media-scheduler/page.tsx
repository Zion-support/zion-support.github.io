...
export const metadata = {
  ...
  keywords: 'ai-social-media-scheduler, social media, automation, AI tools'
};
...
<<<<<<< HEAD
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Automate your social media presence with AI-powered scheduling that optimizes 
            posting times and content for maximum engagement.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h2 className="text-3xl font-bold text-white mb-6">Why Choose Our AI Social Media Scheduler?</h2>
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Optimal Timing</h3>
                  <p className="text-gray-300">AI determines the best times to post for maximum engagement</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center mr-4 mt-1">
                ...
                <div>
                  ...
                  <p className="text-gray-300">AI suggests improvements to your posts for better performance</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center mr-4 mt-1">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Manage all your social media accounts from one dashboard</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-white mb-8">Ready to Optimize Your Social Media?</h2>
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Start automating your social media strategy with our AI-powered scheduling tools.
          </p>

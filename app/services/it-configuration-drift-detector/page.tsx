    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Configuration Drift Detector</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Detects unauthorized changes across firewall rules, device configs, endpoint settings, and cloud infra with policy-based compliance scoring.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Policy-based drift detection</li>
            <li>Baseline comparison across systems</li>
            <li>Change attribution and history</li>
            <li>Compliance scoring</li>
            <li>Alerting with remediation hints</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce unknown-config risk</li>
            <li>Preserve audit readiness</li>
            <li>Speed post-change reviews</li>
            <li>Keep environments compliant</li>
        </ul>
      </section>

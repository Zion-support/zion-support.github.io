    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">URL Shortener &amp; Link Analytics</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Branded URL shortener with deep link analytics, QR code generation, retargeting pixel support, and custom domains. Perfect for marketing teams tracking campaign performance across channels.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Branded short links with custom domains (e.g., your.co/link)</li>
            <li>Click analytics: geo, device, referrer, time-series</li>
            <li>QR code generation with logo, colors, and error correction</li>
            <li>Retargeting pixel injection for Facebook, Google, LinkedIn</li>
            <li>Link expiration, password protection, and geo-routing</li>
            <li>Bulk link import via CSV and API</li>
            <li>UTM parameter builder and auto-tagging</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Track every click across all marketing channels in one dashboard</li>
            <li>Increase CTR by 40% with branded vs. generic short links</li>
            <li>Retarget visitors who clicked but didn\\</li>
            <li>,
      </li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$9/mo (5K clicks/mo)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$39/mo (100K clicks, custom domain)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$149/mo (1M clicks, API, team seats)</p>
          </div>
        </div>

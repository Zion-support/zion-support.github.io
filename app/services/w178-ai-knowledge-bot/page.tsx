    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Knowledge Bot for Sales</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI bot answering sales questions: product info, pricing, competitive intel, battlecards.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Natural language product questions</li>
            <li>Pricing and discount guidance</li>
            <li>Competitive battlecards on demand</li>
            <li>ROI calculator and proposal content</li>
            <li>CRM context-aware answers</li>
            <li>Integration with Salesforce, Gong, Highspot</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce sales research time 60%</li>
            <li>Competitive intel on demand</li>
            <li>Pricing guidance ensures consistency</li>
            <li>ROI content for proposals</li>
        </ul>
      </section>

  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/security-ai-threat-hunter` title="AI Threat Hunter" />
        <h1 className="text-4xl font-bold mb-6">AI Threat Hunter</h1>
        <p className="text-lg text-gray-300 mb-8">Autonomous AI-powered threat hunting: continuous behavioural anomaly detection, novel attack chain reconstruction, MITRE ATT&amp;CK mapping, custom hunt queries, na</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with ai threat hunter</li>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS AI Incident Timeline</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Builds concise incident timelines from alerts, tickets, chat, and monitoring signals with impact framing and remediation tracking.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-source timeline assembly</li>
            <li>Impact and blast-radius framing</li>
            <li>Owner and action extraction</li>
            <li>Remediation status tracking</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce post-incident writeup time</li>
            <li>Keep leadership informed clearly</li>
            <li>Connect signals across tools</li>
            <li>Maintain audit-friendly records</li>
        </ul>
      </section>

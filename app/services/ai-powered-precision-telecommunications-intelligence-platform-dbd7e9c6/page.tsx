...
export const metadata = {
  title: "AI-Powered Precision Telecommunications Intelligence Platform - Zion Tech Group",
  description: "AI-driven intelligence platform that delivers precision insights and automated decision-making for telecommunications operations.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-precision-telecommunications-intelligence-platform-dbd7e9c6`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Zero-Trust API Gateway &amp; Micro-Segmentation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Secure all API traffic with zero-trust principles. Every request is authenticated, authorized, and encrypted. Micro-segmentation prevents lateral movement. Real-time threat detection and automatic rate limiting.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Per-request authentication and authorization</li>
            <li>mTLS encryption for all API traffic</li>
            <li>Micro-segmentation to prevent lateral movement</li>
            <li>Real-time threat detection and auto-blocking</li>
            <li>Rate limiting and DDoS protection</li>
            <li>API discovery and shadow API detection</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Every API request is verified — no implicit trust</li>
            <li>Prevent lateral movement after breach</li>
            <li>Discover and secure shadow APIs</li>
            <li>Stop DDoS and abuse automatically</li>
            <li>Meet zero-trust compliance requirements</li>
        </ul>
      </section>

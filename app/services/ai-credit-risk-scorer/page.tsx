    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Credit Risk Scoring Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered credit risk assessment platform that analyzes traditional and alternative data sources for lending decisions. Explainable AI models with regulatory compliance, bias monitoring, and real-time scoring APIs.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Alternative data analysis (cash flow, behavioral, social signals)</li>
            <li>Explainable AI with reason codes for every decision</li>
            <li>Bias monitoring with demographic parity tracking</li>
            <li>Real-time scoring API with sub-100ms response</li>
            <li>Regulatory compliance (ECOA, Fair Lending, GDPR)</li>
            <li>Model performance monitoring with drift detection</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Approve 20% more creditworthy applicants with alternative data</li>
            <li>Reduce default rates with more accurate risk assessment</li>
            <li>Ensure fair lending compliance with bias monitoring</li>
            <li>Make instant credit decisions with real-time scoring</li>
        </ul>
      </section>

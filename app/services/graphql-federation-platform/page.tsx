  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/graphql-federation-platform` title="GraphQL Federation &amp; API Composition Platform" />
        <h1 className="text-4xl font-bold mb-6">GraphQL Federation &amp; API Composition Platform</h1>
        <p className="text-lg text-gray-300 mb-8">Apollo Federation 2 gateway: compose 50+ microservice schemas into a unified GraphQL API, manage subgraph schema evolution, implement distributed caching, and p</p>

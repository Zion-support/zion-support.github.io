    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Survey &amp; NPS Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Create beautiful surveys, collect NPS and CSAT scores, analyze results with AI-powered insights, and automate follow-up workflows. Built for teams that need enterprise-grade feedback tools without enterprise complexity or pricing.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Drag-and-drop survey builder with 30+ question types and conditional logic</li>
            <li>NPS, CSAT, and CES scoring with trend analysis and benchmark comparisons</li>
            <li>AI-powered sentiment analysis and open-text categorization</li>
            <li>Automated follow-up workflows triggered by score thresholds or response patterns</li>
            <li>Multi-channel distribution: email, SMS, in-app, QR code, and web embed</li>
            <li>Real-time analytics dashboard with segment filtering and exportable reports</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Launch professional surveys in minutes with intuitive drag-and-drop builder</li>
            <li>AI sentiment analysis turns open-text responses into actionable insights</li>
            <li>Automated follow-ups close the feedback loop without manual effort</li>
            <li>Benchmark NPS scores against industry standards to gauge performance</li>
            <li>Multi-channel distribution maximizes response rates across customer touchpoints</li>
        </ul>
      </section>

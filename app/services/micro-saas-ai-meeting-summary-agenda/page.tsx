    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS AI Meeting Summary &amp; Agenda Builder</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Generates agendas from past meeting summaries and builds focused next-meeting prep packs with owners and decisions.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Past meeting summary ingestion</li>
            <li>Agenda generation from context</li>
            <li>Decision and action extraction</li>
            <li>Owner and deadline linking</li>
            <li>Recurring meeting support</li>
            <li>Export to calendar and docs</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce meeting prep time</li>
            <li>Keep continuity strong</li>
            <li>Improve meeting focus</li>
        </ul>
      </section>

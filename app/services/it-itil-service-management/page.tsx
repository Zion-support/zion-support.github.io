  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/it-itil-service-management` title="ITIL Service Management (ITSM) Platform" />
        <h1 className="text-4xl font-bold mb-6">ITIL Service Management (ITSM) Platform</h1>
        <p className="text-lg text-gray-300 mb-8">Full ITIL-aligned service management with AI-powered ticketing, change management automation, CMDB discovery, and self-service portal for enterprise IT operatio</p>

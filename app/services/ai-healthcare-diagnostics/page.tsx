    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Medical Diagnostics Assistance Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">FDA-cleared AI diagnostic assistance for radiology, pathology, and dermatology. Analyzes medical images with superhuman accuracy, flags anomalies for physician review, and generates structured reports. Integrates with EHR systems (Epic, Cerner). Reduces diagnostic errors by 45% and reading time by 30%.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>FDA-cleared AI diagnostic models</li>
            <li>Radiology, pathology, dermatology support</li>
            ...
            <li>DICOM &amp; HL7 FHIR compliant</li>
            <li>Physician override &amp; feedback loop</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce diagnostic errors by 45%</li>
            <li>Cut reading time by 30%</li>
            <li>Catch early-stage conditions humans miss</li>
            <li>Improve patient outcomes with faster diagnosis</li>
            <li>Scale specialist expertise across facilities</li>
        </ul>
      </section>

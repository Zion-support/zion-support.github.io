    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Environmental Monitoring &amp; Alarming</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Deploy sensor networks for temperature, humidity, airflow, water detection, and particulate monitoring across hot/cold aisles. Real-time alarming, integration with DCIM/BMS, and predictive analytics for early failure detection.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Wireless and wired temperature/humidity sensor arrays</li>
            <li>Water leak detection and under-floor fluid monitoring</li>
            <li>Air velocity and differential pressure sensors</li>
            <li>Real-time alarming via SMS/voice/email/webhook</li>
            <li>Integration with DCIM, BMS, and NOC dashboards</li>
            <li>Predictive analytics for thermal anomaly forecasting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect hot spots and thermal runaway before outages occur</li>
            <li>Reduce mean-time-to-detect for environmental faults by 80%</li>
            <li>Prevent costly water damage with early leak alerts</li>
            <li>Improve PUE by identifying overcooled aisles</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$599/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">PagerDuty Incident Management &amp; AIOps</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">PagerDuty is the industry-standard incident management and AIOps platform used by DevOps and SRE teams. It combines AI-powered event orchestration, on-call scheduling, automation, and real-time operations to help teams detect, triage, and resolve incidents faster.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI-powered event grouping and noise reduction with PagerDuty AIOps</li>
            <li>Global on-call scheduling with intelligent escalation policies</li>
            <li>Real-time incident timeline with Slack, MS Teams, and built-in comms</li>
            <li>900+ integrations including Datadog, AWS CloudWatch, Prometheus, ServiceNow</li>
            <li>Analytics, post-incident reviews, and blameless retrospective support</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce mean time to resolve (MTTR) by up to 86% with automated workflows</li>
            <li>Eliminate alert fatigue through AI-powered intelligent grouping</li>
            <li>Demonstrate operational excellence with SLO/SLA reporting and audit trails</li>
            <li>Used by Salesforce, Shopify, and 19,000+ organizations globally</li>
        </ul>
      </section>

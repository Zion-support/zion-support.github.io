...
export const metadata = {
  title: 'Automation Solutions - Zion Tech Group',
  description: 'Professional automation solutions solutions for your business needs.',
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          <div className='bg-gray-800 rounded-lg p-6'>
            ...
            <p className='text-gray-300'>
              Tailored automation solutions solutions designed for your specific
          ...
          <div className='bg-gray-800 rounded-lg p-6'>
            ...
            <p className='text-gray-300'>
              Round-the-clock support to ensure your automation solutions

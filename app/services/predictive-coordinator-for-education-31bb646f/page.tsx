...
export const metadata = {
  ...
  description: "Next-generation education solution: Predictive Coordinator for Education. Combines user experience with adaptive intelligence for optimal results.",
  alternates: {

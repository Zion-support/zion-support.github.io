...
export const metadata: Metadata = {
  ...
  description: 'Professional AI-powered data analytics solutions for your business needs.',
  keywords: 'ai-data-analytics, artificial-intelligence, data-science, machine-learning, business-intelligence'
};
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional AI-powered data analytics solutions designed to meet your business requirements 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Process and analyze data in real-time for immediate business insights.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Create stunning, interactive dashboards that make complex data easy to understand.
              </p>
            </div>
          </div>

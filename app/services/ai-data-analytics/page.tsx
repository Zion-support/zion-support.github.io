...
export const metadata: Metadata = {
  ...
  description: 'Transform data into actionable insights with our AI-powered analytics platform. Predictive modeling, real-time dashboards, and custom analytics solutions.',
  keywords: 'AI data analytics, predictive modeling, business intelligence, data visualization, machine learning',
};
      ...
      <section className="relative py-20 px-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto text-center">
          ...
          <p className="text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">
            Transform your data into actionable insights with predictive modeling, real-time dashboards, and intelligent analytics solutions.
          </p>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our AI-powered analytics platform delivers comprehensive insights across all your business data
            </p>
          </div>

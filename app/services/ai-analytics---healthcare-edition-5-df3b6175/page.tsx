...
export const metadata = {
  title: "AI Analytics - Healthcare Edition #5 - Zion Tech Group",
  description: "Transform your healthcare operations with our AI Analytics - Healthcare Edition #5. This AI-driven solution automates fraud prevention with unprecedented accura",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-analytics---healthcare-edition-5-df3b6175`
  }
};

  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Semantic search over your documents and data: vector search, hybrid ranking, entity search, and NL queries. Power internal search, customer support, and product</p>

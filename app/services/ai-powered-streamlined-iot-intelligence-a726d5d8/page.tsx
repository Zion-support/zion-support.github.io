...
export const metadata = {
  title: "AI-Powered Streamlined IoT Intelligence - Zion Tech Group",
  description: "Edge AI platform that processes IoT sensor data in real-time with streamlined insights.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-streamlined-iot-intelligence-a726d5d8`
  }
};

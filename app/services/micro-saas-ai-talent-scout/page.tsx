  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/micro-saas-ai-talent-scout` title="AI Talent Scout Platform" />
        <h1 className="text-4xl font-bold mb-6">AI Talent Scout Platform</h1>
        <p className="text-lg text-gray-300 mb-8">AI-powered recruitment with resume parsing and diversity analytics.</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>50% faster hiring</li>
            <li>40% better match</li>

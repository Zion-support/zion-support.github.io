    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Renewable Energy &amp; PPA Advisory for Data Centers</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Navigate renewable energy procurement, PPAs, and carbon offsetting specifically for data center power demand. We evaluate solar, wind, and hydro options, negotiate contracts, and validate REC delivery against your actual load profile.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Energy demand modeling aligned with your DC load curves</li>
            <li>Solar, wind, and hydro PPA sourcing and due diligence</li>
            <li>REC and GOO tracking validated against actual consumption</li>
            <li>Carbon offset portfolio management with additionality checks</li>
            <li>Grid-interactive and behind-the-meter solution design</li>
            <li>Regulatory and tax incentive analysis per jurisdiction</li>
            <li>Procurement RFP creation and vendor bid evaluation</li>
            <li>Long-term energy cost modeling with risk-adjusted scenarios</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Lock in long-term power costs below grid rates with bulk PPA deals</li>
            <li>Meet ESG targets with verifiable renewable energy matching</li>
            <li>Reduce procurement risk with technical due diligence and vendor vetting</li>
            <li>Lower total cost of ownership while improving sustainability credentials</li>
        </ul>
      </section>

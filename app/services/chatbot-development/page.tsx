        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <p className="text-gray-300">
              Tailored chatbot development solutions designed for your specific business requirements.
            </p>
          </div>
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <p className="text-gray-300">
              Round-the-clock support to ensure your chatbot development solutions run smoothly.
            </p>
          </div>
        </div>
      </div>

...
export const metadata = {
  title: "Cognitive Network Predictor - Zion Tech Group",
  description: "Next-generation retail solution: Cognitive Network Predictor. Combines maintenance scheduling with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-network-predictor-55d92d31`
  }
};

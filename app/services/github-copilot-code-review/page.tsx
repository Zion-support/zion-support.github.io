    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">GitHub Copilot Code Review — AI-Powered Pull Request Review</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">GitHub Copilot Code Review is an AI-powered code review tool that automatically analyzes pull requests, identifies bugs, security vulnerabilities, and code quality issues, and leaves contextual review comments directly in the PR. Built on OpenAI\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automatic PR analysis: AI reviews every pull request and leaves contextual comments</li>
            <li>Bug and vulnerability detection: catches logic errors, security flaws, and anti-patterns</li>
            <li>Custom review rules: define team-specific coding standards and enforcement policies</li>
            <li>Summary generation: auto-summarize PR changes for faster human reviewer context</li>
            <li>Suggested fixes: one-click apply AI-generated code fixes directly in the PR diff</li>
            <li>Integration with GitHub Actions: block merges on critical AI-detected issues</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce code review time by 50% — AI catches issues before human reviewers start</li>
            <li>Catch 30% more bugs and security vulnerabilities than manual review alone</li>
            <li>Enforce coding standards automatically across every repository and team</li>
            <li>Scale code review capacity without hiring additional senior engineers</li>
            <li>Native GitHub integration — no new tools, no context switching for developers</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Included with GitHub Team ($4/user/month)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">Included with GitHub Enterprise ($21/user/month)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (GitHub Enterprise Cloud + Advanced Security)</p>
          </div>
        </div>

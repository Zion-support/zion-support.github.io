    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Carbon Footprint Tracker</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered carbon emissions monitoring and reduction platform for enterprises. Tracks Scope 1, 2, and 3 emissions across supply chains, recommends reduction strategies, and automates ESG reporting.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Scope 1, 2, and 3 emissions tracking across operations</li>
            <li>AI-powered reduction recommendations with ROI analysis</li>
            <li>Automated ESG reporting (GRI, SASB, TCFD frameworks)</li>
            <li>Supply chain emissions mapping with supplier scoring</li>
            <li>Carbon offset marketplace integration</li>
            <li>Real-time emissions dashboard with trend analysis</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce carbon emissions by 30% with AI-guided actions</li>
            <li>Automate ESG reporting and ensure compliance</li>
            <li>Identify highest-impact reduction opportunities</li>
            <li>Demonstrate sustainability leadership to stakeholders</li>
        </ul>
      </section>

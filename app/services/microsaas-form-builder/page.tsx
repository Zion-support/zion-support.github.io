    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Advanced Form Builder &amp; Workflow Automation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Drag-and-drop form builder with conditional logic, calculations, file uploads, e-signatures, and multi-step workflows. Routes submissions to the right team, triggers automations, and updates databases. Replaces Typeform, JotForm, and paper processes. HIPAA and GDPR compliant options available.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Drag-and-drop form builder (no code)</li>
            <li>Conditional logic &amp; branching</li>
            <li>Calculations &amp; formula fields</li>
            <li>File uploads with cloud storage</li>
            <li>E-signature capture</li>
            <li>Workflow routing &amp; approval chains</li>
            <li>Integration with 50+ apps (Zapier, native)</li>
            <li>HIPAA/GDPR compliance options</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Replace paper forms and manual processes</li>
            <li>Automate approval workflows end-to-end</li>
            <li>Collect e-signatures without DocuSign costs</li>
            <li>Route submissions to the right team instantly</li>
            <li>Ensure compliance with built-in safeguards</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$29/mo (1,000 submissions)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$79/mo (10,000 submissions)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$199/mo (unlimited)</p>
          </div>
        </div>

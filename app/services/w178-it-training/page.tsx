    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Training and Enablement</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">IT training: cloud certifications, security awareness, DevOps practices, custom curriculum.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cloud certification prep (AWS, Azure, GCP)</li>
            <li>Security awareness training</li>
            <li>DevOps and CI/CD training</li>
            <li>Custom curriculum development</li>
            <li>Hands-on labs and workshops</li>
            <li>LMS integration and tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cloud certifications for career growth</li>
            <li>Security awareness reduces risk</li>
            <li>DevOps training accelerates delivery</li>
            <li>Custom curriculum for your stack</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$1,999</p>
          </div>

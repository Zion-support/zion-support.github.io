...
export const metadata = {
  ...
  description: "AI-powered subscription analytics and churn prediction platform. Tracks MRR, LTV, cohort analysis, and automates dunning emails to reduce involuntary churn by u",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">AI-powered subscription analytics and churn prediction platform. Tracks MRR, LTV, cohort analysis, and automates dunning emails to reduce involuntary churn by u</p>

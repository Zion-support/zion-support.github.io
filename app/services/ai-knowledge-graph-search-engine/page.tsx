  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/ai-knowledge-graph-search-engine` title="Knowledge Graph Search Engine" />
        <h1 className="text-4xl font-bold mb-6">Knowledge Graph Search Engine</h1>
        <p className="text-lg text-gray-300 mb-8">Semantic graph search engine: turn siloed docs, databases, and APIs into a unified knowledge graph with entity disambiguation, NL query rewriting, and cited ran</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>NL query rewriter — \</li>
            <li> becomes a graph query automatically</li>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with knowledge graph search engine</li>

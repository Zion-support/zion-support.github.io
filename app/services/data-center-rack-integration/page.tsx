    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Rack &amp; Cabinet Integration Services</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">End-to-end rack builds: mounting, labeling, PDUs, cable management, and network gear installation for new deployments and refreshes.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Server and switch rack installation</li>
            <li>PDU and power distribution setup</li>
            <li>Cable routing and management</li>
            <li>Pre-, during, and post-installation labeling</li>
            <li>Label audits and asset validation</li>
            <li>Handoff documentation and QA</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Faster time-to-production for new deployments</li>
            <li>Consistent build quality across locations</li>
            <li>Easier troubleshooting with clear labeling</li>
            <li>Reduced rework from missed cable or power planning</li>
        </ul>
      </section>

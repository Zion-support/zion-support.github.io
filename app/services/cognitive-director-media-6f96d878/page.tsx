...
export const metadata = {
  title: "Cognitive director-media - Zion Tech Group",
  description: "Next-generation media solution: Cognitive director-media. Combines data processing with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-director-media-6f96d878`
  }
};

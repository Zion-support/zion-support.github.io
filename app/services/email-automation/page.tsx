export const metadata = {title: 'Email Automation | Zion Tech Group',description: 'Professional email automation services for your business needs.',keywords: 'email-automation, services, business, technology';

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">PCI DSS Compliance Monitoring &amp; Reporting Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Continuous PCI DSS compliance scanning, automated evidence collection, gap analysis, and audit-ready reporting. Stay compliant year-round with real-time monitoring of all 12 PCI DSS requirements across your cardholder data environment.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Continuous compliance scanning across all 12 PCI DSS requirements</li>
            <li>Automated evidence collection from firewalls, servers, and network devices</li>
            <li>Gap analysis with prioritized remediation roadmaps</li>
            <li>Audit-ready report generation for QSA and internal assessments</li>
            <li>Real-time alerting on compliance drift and configuration changes</li>
            <li>Support for PCI DSS v4.0 with legacy v3.2.1 transition tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate manual evidence collection saving 200+ hours per audit cycle</li>
            <li>Continuous monitoring ensures compliance between annual assessments</li>
            <li>Gap analysis provides clear remediation priorities with effort estimates</li>
            <li>Audit-ready reports reduce QSA fees and accelerate certification</li>
            <li>Real-time alerts prevent compliance drift before it becomes a finding</li>
        </ul>
      </section>

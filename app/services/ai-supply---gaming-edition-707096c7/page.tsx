...
export const metadata = {
  title: "AI Supply - Gaming Edition - Zion Tech Group",
  description: "Unlock unprecedented growth with AI Supply - Gaming Edition. This autonomous system provides maintenance scheduling with zero manual intervention needed.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-supply---gaming-edition-707096c7`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Edge Micro Data Center as a Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Deploy and manage containerized micro data centers (5 kW to 200 kW) at factory, retail, telecom, or remote field sites. Pre-integrated power, cooling, security, and connectivity with centralized cloud orchestration.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>ISO container and rack-scale micro DC designs</li>
            <li>Ruggedized enclosures for industrial and outdoor environments</li>
            <li>Edge orchestration with Kubernetes and zero-touch provisioning</li>
            <li>Satellite or wireless backhaul integration</li>
            <li>Remote monitoring and automated health checks</li>
            <li>Terraform/Ansible-driven deployment automation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Bring compute to the data source with &lt;1 ms latency</li>
            <li>Deploy in days instead of months for time-sensitive projects</li>
            <li>Reduce WAN bandwidth costs by 70–90%</li>
            <li>Support IoT, AI inference, and 5G MEC workloads</li>
        </ul>
      </section>

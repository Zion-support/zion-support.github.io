    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Polygon ID — Blockchain-Based Digital Identity</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Polygon ID is a blockchain-based digital identity platform that enables self-sovereign identity (SSI) — giving individuals and organizations full control over their identity data without relying on centralized authorities. Built on Polygon\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Self-sovereign identity: users own and control their identity data</li>
            <li>Zero-knowledge proofs: verify claims without revealing underlying data</li>
            <li>W3C Verifiable Credentials: interoperable with global identity standards</li>
            <li>Decentralized Identifiers (DIDs): blockchain-anchored identifiers</li>
            <li>Privacy-preserving KYC: comply with regulations without storing sensitive data</li>
            <li>Selective disclosure: users share only the specific attributes required</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate centralized identity databases that are prime targets for data breaches</li>
            <li>Reduce KYC costs by 80% with reusable, privacy-preserving verifiable credentials</li>
            <li>Comply with GDPR, CCPA, and global privacy regulations by design</li>
            <li>Enable seamless cross-platform identity: one credential works across services</li>
            <li>Empower users with true data ownership</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$0.01/verification (managed service, 10K verifications/month)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (private chain, custom schemas, dedicated support)</p>
          </div>
        </div>

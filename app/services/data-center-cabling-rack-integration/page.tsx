    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Structured Cabling &amp; Rack Integration</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Design and install TIA-942 compliant structured cabling: copper Cat6A/Cat8, single-mode/multi-mode fiber, MPO/MTP breakout panels, cable management, and rack/cabinet installation with proper labeling and documentation.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>TIA-942 and ISO/IEC 11801 compliant infrastructure design</li>
            <li>Copper Cat6A/Cat8 and fiber (OS2/OM4/OM5) installation</li>
            <li>MPO/MTP trunk cabling and high-density patch panels</li>
            <li>Vertical and horizontal cable management systems</li>
            <li>Intelligent PDUs and power strip installation</li>
            <li>Digital floor plan and asset tagging documentation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Support 400G/800G/1.6T Ethernet migration paths</li>
            <li>Reduce cable congestion and improve airflow management</li>
            <li>Minimize unplanned downtime from cabling faults</li>
            <li>Accelerate moves/adds/changes with clear labeling</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$749/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

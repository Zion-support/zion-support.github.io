  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/data-product-catalog-svc` title="Data Product Catalog &amp; Lineage" />
        <h1 className="text-4xl font-bold mb-6">Data Product Catalog &amp; Lineage</h1>
        <p className="text-lg text-gray-300 mb-8">Auto-discover data assets from warehouse/lakehouse/BI. Business glossary auto-linked. Column-level lineage: table to report to dashboard. Auto-generated data co</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with data product catalog &amp; lineage</li>

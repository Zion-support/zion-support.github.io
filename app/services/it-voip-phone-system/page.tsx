    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">VoIP Phone System Management &amp; Deployment</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Cloud VoIP phone system deployment and management for businesses of all sizes. Auto-attendant, call routing, voicemail-to-email, call recording, CRM integration, and mobile apps. Replace expensive PBX systems with modern cloud telephony.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Auto-attendant and IVR menu builder</li>
            <li>Call routing, queues, and ring groups</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Save 50-70% vs traditional phone systems</li>
            <li>Work from anywhere with mobile apps</li>
            <li>Never miss a call with smart routing</li>
            <li>Know call volume and agent performance</li>

export const metadata = {title: 'AI Code Reviewer | Zion Tech Group',description: 'Automated code review with AI-powered analysis, security scanning, and performance optimization suggestions.',title: "AI Code Reviewer | Zion Tech Group",description: "Automated code review and quality analysis powered by AI. Improve code quality, catch bugs early, and maintain coding standards.",description:;
    "Automated code review and quality analysis powered by AI. Improve code quality, catch bugs early, and maintain coding standards.",ursor/automate-test-improve-and-merge-code-646c;
}export default function AICodeReviewerPage() {return (<div className="animate-fade-in">;
        ...
        <div>;
          ...
          <div className="space-y-4">;
            <PricingCard;
              ...
              features={[;
                'Up to 10,000 lines of code per month','Basic security scanning','Code quality analysis','Email support','GitHub integration',"Up to 5 repositories","Basic code analysis","Standard bug detection","Email support","GitHub/GitLab integration";
            ...
            <PricingCard;
              ...
              features={[;
                'Up to 100,000 lines of code per month','Advanced security scanning','Performance optimization','Priority support','All integrations included','Custom rules and standards',"Up to 25 repositories","Advanced AI analysis","Custom rules engine","Priority support","All integrations","Team analytics dashboard";
            ...
            <PricingCard;
              ...
              features={[;
                'Unlimited code analysis','Enterprise security scanning','Custom AI model training','24/7 dedicated support','On-premise deployment','Custom integrations','SLA guarantees',"Unlimited repositories","Advanced security scanning","Custom AI model training","Dedicated support","On-premise deployment","Custom integrations";
              ]}
              popular={false}"Custom integrations"]}
            />;
          </div>;
        </div>;
      </div>;
...
ursor/automate-test-improve-and-merge-code-646c;
  ...
  )}function FeatureItem() {function FeatureItem() {function FeatureItem() {ursor/automate-test-improve-and-merge-code-646c;
function FeatureItem() {return (<div className="flex items-start space-x-4">;
  ...
  )}function PricingCard() {return (<div className="border border-gray-200 rounded-xl p-6 bg-white">;
    <div;
      className={`border rounded-xl p-6 ${popular ? "border-blue-500 bg-blue-50" : "border-gray-200"}`}
    >;
      {popular && (<div className="bg-blue-500 text-white text-sm font-semibold px-3 py-1 rounded-full inline-block mb-4">;
          Most Popular;
        </div>;
...
function PricingCard({
  ...
  )}function StepCard() {function BenefitCard() {function StepCard() {ursor/automate-test-improve-and-merge-code-646c;
  return (<div className="text-center">;
      <div className="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">;
        {step}
      </div>;
      <h3 className="text-lg font-semibold text-gray-900 mb-2">{title}</h3>;
function BenefitCard() {return (<div className="text-center">;

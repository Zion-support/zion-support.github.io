export const metadata = {
  ...
  description:
    "Advanced predictive analytics platform with machine learning models for forecasting, risk assessment, and business intelligence. Transform data into actionable predictions.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Advanced predictive analytics platform with machine learning models
            for forecasting, risk assessment, and business intelligence.
            Transform data into actionable predictions.
          </p>
        </div>
  ...
  const industries = [
    {
      ...
      description:
        "Demand forecasting, inventory optimization, and customer analytics",
      icon: "🛍️",
      useCases: [
        "Sales forecasting",
...
function PricingCard({
  ...
  return (
    <div
      className={`relative border-2 rounded-xl p-8 ${popular ? "border-teal-500 bg-teal-50" : "border-gray-200"}`}
    >
      {popular && (
  ...
  return (
    <div className="bg-gradient-to-r from-teal-600 to-cyan-600 p-8 rounded-2xl text-center">
      ...
      <p className="text-xl text-teal-100 mb-8 max-w-3xl mx-auto">
        Contact our predictive analytics experts to discuss your data challenges
        and get a custom solution.
      </p>

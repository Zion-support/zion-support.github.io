    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Client Hardware Repair &amp; Triage</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Triage, dispatch, and repair tracking for client hardware with SLA visibility and spare parts forecasting.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Dispatch triage and routing</li>
            <li>Repair timeline and SLA tracking</li>
            <li>Parts inventory forecasting</li>
            <li>Repeat-failure detection</li>
            <li>Customer status notifications</li>
            <li>Cost and chargeback links</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce repair turnaround time</li>
            <li>Keep SLA commitments visible</li>
            <li>Control parts spend</li>

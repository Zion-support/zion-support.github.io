...
export const metadata = {
  title: "Automated automation-media - Zion Tech Group",
  description: "Revolutionize media through intelligent automation. Our Automated automation-media leverages advanced machine learning to deliver predictive analytics at scale.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/automated-automation-media-b5665a94`
  }
};

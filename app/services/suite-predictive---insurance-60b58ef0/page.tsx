...
export const metadata = {
  title: "Suite Predictive - Insurance - Zion Tech Group",
  description: "Unlock unprecedented growth with Suite Predictive - Insurance. This autonomous system provides resource optimization with zero manual intervention needed.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/suite-predictive---insurance-60b58ef0`
  }
};

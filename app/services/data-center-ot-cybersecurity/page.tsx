    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center OT Cybersecurity &amp; ICS Protection</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Secure operational technology systems (BMS, UPS, generator controllers, HVAC BAS, fire panels) against ransomware and targeted attacks. Network segmentation, vulnerability assessment, and incident response playbooks for DC infrastructure.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>OT asset discovery and network mapping (Modbus, BACnet, SNMP)</li>
            <li>Zero-trust segmentation between IT and OT networks</li>
            <li>ICS vulnerability assessment and patch management</li>
            <li>Threat detection and anomaly monitoring for facility systems</li>
            <li>Incident response planning and tabletop exercises</li>
            <li>NIST SP 800-82 and IEC 62443 compliance alignment</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Prevent OT-driven outages from ransomware and malware</li>
            <li>Achieve regulatory alignment for critical infrastructure</li>
            <li>Detect anomalous behavior in power and cooling systems</li>
            <li>Reduce risk of cascading failures between IT and OT</li>
        </ul>
      </section>

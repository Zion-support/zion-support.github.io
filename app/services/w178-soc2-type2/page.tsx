    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">SOC 2 Type II Audit Support</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Full SOC 2 Type II audit support: control implementation, evidence collection, auditor management.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>SOC 2 Type II gap analysis</li>
            <li>Control implementation and testing</li>
            <li>Automated evidence collection</li>
            <li>Auditor management and coordination</li>
            <li>Remediation tracking</li>
            <li>Post-audit continuous monitoring</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Pass SOC 2 Type II with confidence</li>
            <li>Automated evidence saves weeks of work</li>
            <li>Auditor management reduces stress</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$34,999</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

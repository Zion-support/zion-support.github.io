    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Geospatial &amp; Spatial Intelligence Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Process satellite imagery, aerial photography, and geospatial vectors with AI for object detection, change monitoring, and predictive spatial analytics. Supports agriculture, defense, logistics, and climate use cases.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Satellite and aerial imagery object detection</li>
            <li>Time-series change detection (construction, deforestation, flooding)</li>
            <li>Route optimization with live traffic and weather overlay</li>
            <li>Crop health monitoring and yield prediction</li>
            <li>Geospatial feature extraction from LiDAR and radar</li>
            <li>Web map integration and GIS-format export</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automate manual image analysis at planetary scale</li>
            <li>Detect changes and anomalies before they become incidents</li>
            <li>Optimize routes and logistics with real-world geospatial context</li>
            <li>Make faster, data-driven decisions with accurate spatial intelligence</li>
        </ul>
      </section>

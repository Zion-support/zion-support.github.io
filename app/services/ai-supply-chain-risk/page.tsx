    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Supply Chain Risk Monitor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Real-time supply chain risk intelligence platform that monitors suppliers, geopolitical events, weather disruptions, and financial health signals. Predicts disruptions 30-90 days in advance and recommends mitigation strategies.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-tier supplier mapping with dependency visualization</li>
            <li>Geopolitical risk scoring with news and sanctions monitoring</li>
            <li>Financial health monitoring of critical suppliers</li>
            <li>Weather and natural disaster impact prediction on logistics</li>
            <li>Alternative supplier recommendation engine</li>
            <li>Disruption simulation with scenario planning</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Predict supply chain disruptions 30-90 days in advance</li>
            <li>Reduce single-source dependency with alternative recommendations</li>
            <li>Minimize revenue impact from supplier failures</li>
            <li>Build resilient supply chains with data-driven diversification</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$1699/mo</p>
          </div>
        </div>

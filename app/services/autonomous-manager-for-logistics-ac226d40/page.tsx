...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Autonomous Manager for Logistics. This autonomous system provides sentiment analysis with zero manual intervention needed.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/autonomous-manager-for-logistics-ac226d40`
  }
};

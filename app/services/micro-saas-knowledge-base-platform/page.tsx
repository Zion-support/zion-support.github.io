    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Knowledge Base &amp; Help Center Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered knowledge base and help center that deflects support tickets by giving customers instant, accurate answers. AI suggests articles from support tickets, identifies content gaps, and keeps articles up-to-date. Includes analytics to measure self-service success.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI article suggestions from resolved support tickets</li>
            <li>Smart search with natural language understanding</li>
            <li>Content gap identification from unanswered customer questions</li>
            <li>Auto-translation into 30+ languages with quality review</li>
            <li>Customizable help center with your branding and domain</li>
            <li>Article freshness scoring and automated update reminders</li>
            <li>Integration with Zendesk, Intercom, Freshdesk, and Help Scout</li>
            <li>Self-service analytics (deflection rate, search success, NPS)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Deflect 30-40% of support tickets with self-service answers</li>
            <li>Keep knowledge base current with AI-generated article suggestions</li>
            <li>Reduce new agent ramp time with a comprehensive knowledge base</li>
            <li>Measure and improve self-service effectiveness with analytics</li>
        </ul>
      </section>

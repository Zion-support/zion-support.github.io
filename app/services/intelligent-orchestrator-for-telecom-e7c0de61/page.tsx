...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Intelligent Orchestrator for Telecom. This autonomous system provides process automation with zero manual intervention needed.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligent-orchestrator-for-telecom-e7c0de61`
  }
};

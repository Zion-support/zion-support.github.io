  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/automation-document-intelligence-pipeline` title="Legal Document Intelligence Pipeline" />
        <h1 className="text-4xl font-bold mb-6">Legal Document Intelligence Pipeline</h1>
        <p className="text-lg text-gray-300 mb-8">OCR + NLP document-intelligence: pipeline-abstract multi-service orchestration for contracts, invoices, and regulatory submissions; auto-classification, clause </p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with legal document intelligence pipeline</li>

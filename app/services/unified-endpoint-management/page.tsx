...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/unified-endpoint-management',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Comprehensive endpoint management platform that secures and manages laptops, desktops, mobile devices, and IoT from a single console. Zero-touch enrollment, compliance enforcement, and remote troubleshooting.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Single console for Windows, macOS, iOS, Android, and IoT</li>
            <li>Zero-touch enrollment with automated device provisioning</li>
            <li>Compliance enforcement with conditional access policies</li>
            <li>Remote troubleshooting with screen sharing and command execution</li>
            <li>Application management with silent install and update</li>
            <li>Asset inventory with hardware and software tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Manage all endpoints from one platform</li>
            <li>Reduce device provisioning time from hours to minutes</li>
            <li>Enforce security compliance across all devices</li>
            <li>Support remote workforce with self-service capabilities</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Product Launch Intelligence</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Tracks competitor launches, market noise, pricing signals, and demand trends to inform launch timing and messaging.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Competitor launch detection</li>
            <li>Demand and sentiment analysis</li>
            <li>Pricing signal tracking</li>
            <li>Launch timing recommendations</li>
            <li>Message performance baselines</li>
            <li>Executive launch briefings</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce launch misses</li>
            <li>Keep messaging competitive</li>
            <li>Act on market signals faster</li>
            <li>Support executive strategy</li>
        </ul>
      </section>

...
export const metadata = {
  title: "Intelligent analyzer-transportation - Zion Tech Group",
  description: "Revolutionize transportation through intelligent automation. Our Intelligent analyzer-transportation leverages advanced machine learning to deliver threat detec",
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligent-analyzer-transportation-df8e7a10`
  }
};

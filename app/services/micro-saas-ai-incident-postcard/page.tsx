    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS AI Incident Postcard</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Creates concise incident postcards for customers and leadership with timeline, impact, next actions, and confidence signals.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-source incident ingestion</li>
            <li>Impact and blast-radius framing</li>
            <li>Next actions and owner signals</li>
            <li>Customer-safe phrasing</li>
            <li>Confidence and gap labeling</li>
            <li>Email and PDF delivery</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce stakeholder anxiety</li>
            <li>Keep updates consistent</li>
            <li>Accelerate post-event communication</li>
            <li>Support on-call teams</li>
        </ul>
      </section>

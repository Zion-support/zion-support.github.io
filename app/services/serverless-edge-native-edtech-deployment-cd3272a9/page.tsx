...
export const metadata = {
  title: "Serverless Edge-Native Edtech Deployment - Zion Tech Group",
  description: "Serverless deployment platform that auto-scales edge-native edtech workloads without infrastructure management.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/serverless-edge-native-edtech-deployment-cd3272a9`
  }
};

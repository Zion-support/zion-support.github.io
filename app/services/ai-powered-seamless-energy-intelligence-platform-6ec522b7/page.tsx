...
export const metadata = {
  title: "AI-Powered Seamless Energy Intelligence Platform - Zion Tech Group",
  description: "AI-driven intelligence platform that delivers seamless insights and automated decision-making for energy operations.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-seamless-energy-intelligence-platform-6ec522b7`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Structured Cabling &amp; Fiber Infrastructure</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Design, certify, and deploy high-density structured cabling systems for data centers: copper Cat6a/Cat7 and single-mode/multi-mode fiber. TIA-942/EIA/TIA-568 compliant with full test reports and traceability.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>TIA-942 and EIA/TIA-568 compliant topology design</li>
            <li>MPO/MTP and LC fiber trunk deployment</li>
            <li>Copper Cat6a/Cat7 and Category 8 plant installation</li>
            <li>OTDR, IL/RL testing and certification reports</li>
            <li>Patch panel labeling and asset traceability</li>
            <li>10G/40G/100G/400G migration-ready pathways</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce signal degradation and link failures</li>
            <li>Accelerate move-add-change cycles with accurate documentation</li>
            <li>Support future upgrades to 400G/800G without re-cabling</li>
            <li>Achieve compliance with audit-ready test reports</li>
        </ul>
      </section>

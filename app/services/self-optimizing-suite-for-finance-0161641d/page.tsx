  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Revolutionize Finance through intelligent automation. Our Self-Optimizing Suite for Finance leverages advanced machine learning to deliver sentiment analysis at</p>

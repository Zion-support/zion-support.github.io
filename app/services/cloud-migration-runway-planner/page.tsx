    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloud Migration Runway Planner</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Creates prioritized migration runways with dependency mapping, blast-radius estimation, and rollback planning for hybrid estates.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Dependency mapping and sequencing</li>
            <li>Blast-radius estimation</li>
            <li>Migration runway timelines</li>
            <li>Rollback and roll-forward plans</li>
            <li>Environment pairing</li>
            <li>Cost projection by workload</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce migration surprises</li>
            <li>Keep rollback plans real</li>
            <li>Prioritize by business impact</li>
            <li>Maintain continuity during transitions</li>
        </ul>
      </section>

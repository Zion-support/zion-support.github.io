    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Linkerd Service Mesh</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Linkerd is a lightweight, ultra-secure service mesh for Kubernetes. It provides observability, reliability, and security without requiring application changes.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Zero-trust security with automatic mTLS between services</li>
            <li>Fine-grained traffic control (retries, timeouts, circuit breaking)</li>
            <li>Deep observability with request-level metrics and distributed tracing</li>
            <li>Lightweight data plane (written in Rust) for minimal latency</li>
            <li>Simple installation and upgrades via Helm or CLI</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Secure service-to-service communication without application changes</li>
            <li>Improve reliability with automatic retries and timeouts</li>
            <li>Gain visibility into service dependencies and performance</li>
            <li>Used by PayPal, Expedia, and Homeland Security for zero-trust networking</li>
        </ul>
      </section>

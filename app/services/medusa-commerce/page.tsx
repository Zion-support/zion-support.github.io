    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Medusa Composable Commerce</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Open-source composable commerce platform built for developers who want full control over their e-commerce stack. Headless, modular, and developer-first — built on Node.js with a modern API architecture. Provides the core commerce engine (products, orders, carts, payments, shipping) while letting developers compose exactly the features they need.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Headless commerce engine with REST and GraphQL storefront APIs — works with any frontend (Next.js, Remix, mobile)</li>
            <li>Modular architecture: pick only the modules you need (products, inventory, orders, payments, notifications, search)</li>
            <li>Multi-region and multi-currency support built in — sell globally without plugins</li>
            <li>Admin dashboard for order management, customer service, and product catalog</li>
            <li>Plugin ecosystem: Stripe, PayPal, Algolia search, Meilisearch, SendGrid, Slack notifications</li>
            <li>Self-host on any infrastructure; database-agnostic (PostgreSQL via TypeORM)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Zero transaction fees (Shopify charges 2% + payment processing; Medusa has no platform cut on self-hosted)</li>
            <li>Composable architecture means you only pay for what you use — no bloated monolith with features you</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Cloud Pro from $99/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Cloud Pro: unlimited orders, 10 admin users</p>
          </div>
        </div>

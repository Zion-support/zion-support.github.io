  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/devsecops-pipeline` title="DevSecOps Pipeline Automation" />
        <h1 className="text-4xl font-bold mb-6">DevSecOps Pipeline Automation</h1>
        <p className="text-lg text-gray-300 mb-8">Security-baked CI/CD pipeline: SAST, DAST, secrets scanning, container image signing, SBOM generation, and penetration-test gates. Enforces policy as code befor</p>

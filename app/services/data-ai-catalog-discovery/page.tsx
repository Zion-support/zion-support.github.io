    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI-Powered Data Catalog &amp; Discovery Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automatically discover, classify, and catalog all data assets across your organization. AI infers data types, detects PII, maps lineage, and makes data searchable. Self-service data discovery for analysts with built-in quality metrics.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated data discovery across databases and warehouses</li>
            <li>AI classification and PII detection</li>
            <li>Auto-mapped data lineage</li>
            <li>Self-service search and discovery portal</li>
            <li>Data quality scoring per asset</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Discover shadow data you did not know existed</li>
            <li>Find the data you need in seconds, not days</li>
            <li>Detect and protect PII automatically</li>
            <li>Trust data with quality scores</li>

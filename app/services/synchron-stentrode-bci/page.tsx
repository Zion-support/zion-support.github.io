    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Synchron Stentrode — Minimally Invasive Brain-Computer Interface</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Synchron\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Endovascular delivery — no craniotomy, no open brain surgery</li>
            <li>16-electrode stent-mounted array positioned in superior sagittal sinus</li>
            <li>Patients control iOS/Android devices, smart home, and messaging apps</li>
            <li>FDA IDE approved and Medicare reimbursement pathway established</li>
            <li>10+ patients implanted with zero serious adverse device events</li>
            <li>AI-powered signal decoding adapts to individual patient neural patterns</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Same-day procedure vs. multi-hour open brain surgery for competitors</li>
            <li>Lower infection risk: device delivered via natural blood vessels</li>
            <li>Medicare reimbursement pathway — accessible to broader patient population</li>
            <li>Patients regain digital independence: text, email, shop, control smart home</li>
            <li>Scalable platform: same device architecture for multiple neurological conditions</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Hospital implantation program</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Platform licensing for research institutions</p>
          </div>
        </div>

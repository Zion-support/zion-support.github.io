    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Sustainable Data Center Strategy &amp; Green Energy</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Transition data centers to net-zero operations with renewable energy sourcing, carbon tracking, and efficiency metrics. Build ESG-compliant infrastructure with PPAs, battery storage, and grid-interactive demand response.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Carbon footprint auditing and benchmarking</li>
            <li>Renewable PPA negotiation and procurement</li>
            <li>On-site solar, wind, and battery storage design</li>
            <li>Grid-interactive demand response participation</li>
            <li>PUE optimization and efficiency retrofits</li>
            <li>ESG reporting aligned with TCFD and CSRD frameworks</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Achieve net-zero facility certifications faster</li>
            <li>Reduce energy costs by 20% with renewables and storage</li>
            <li>Meet RFP sustainability requirements in top-tier deals</li>
            <li>Enhance brand reputation with verifiable green metrics</li>
        </ul>
      </section>

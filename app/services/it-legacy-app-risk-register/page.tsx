    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Legacy Application Risk Register</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Catalogues legacy apps with risk scoring, support status, integration inventory, and modernization roadmap tracking.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Application inventory and tagging</li>
            <li>Risk scoring by support and security factors</li>
            <li>Integration and data-flow mapping</li>
            <li>Modernization roadmap tracking</li>
            <li>End-of-life alerting</li>
            <li>Executive view of estate risk</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce surprise outages</li>
            <li>Prioritize modernization safely</li>
            <li>Keep executive risk visible</li>

...
export const metadata = {
  ...
  description: "Next-generation education solution: Management Cognitive - Education. Combines workflow management with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/management-cognitive---education-24ead0c2`
  }
};

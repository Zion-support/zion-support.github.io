...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/serverless-framework-platform',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Complete serverless development platform with function-as-a-service, API gateway, event routing, and built-in observability. Deploy from Git with automatic scaling, zero cold starts, and pay-per-use pricing.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Function-as-a-service with zero cold start technology</li>
            <li>Built-in API gateway with rate limiting and auth</li>
            <li>Event-driven architecture with message routing</li>
            <li>Automatic scaling from zero to millions of requests</li>
            <li>Built-in distributed tracing and logging</li>
            <li>Git-based deployment with preview environments</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate infrastructure management overhead</li>
            <li>Pay only for actual usage with no idle costs</li>
            <li>Scale automatically without capacity planning</li>
            <li>Deploy faster with Git-based CI/CD pipelines</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Site Reliability Engineering (SRE) Services</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enterprise SRE-as-a-Service. We design and operate your reliability platform: SLOs/SLIs, error budgets, incident management, capacity planning, and chaos engineering. Reduce MTTR by 70% and achieve 99.99% uptime without building an internal SRE team.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Error budget policies and alerts</li>
            <li>Incident management with blameless post-mortems</li>
            <li>Capacity modeling and planning</li>
            <li>Chaos engineering experiments and game days</li>
            <li>Runbook automation and self-healing systems</li>
            <li>24/7 on-call rotation with escalation</li>
            <li>Reliability reviews and continuous improvement</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Achieve 99.99% uptime without an internal SRE team</li>
            <li>Reduce MTTR by 70% with automated incident response</li>
            <li>Meet customer SLA commitments with confidence</li>
            <li>Focus engineering on features, not firefighting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$30,000+/mo</p>
          </div>
        </div>

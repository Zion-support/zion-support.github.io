    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Archival &amp; Retention Coordinator</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automates retention, archival, and deletion workflows across databases, object storage, and analytics systems with legal hold pairing.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Policy-driven retention schedules</li>
            <li>Archival destination orchestration</li>
            <li>Deletion readiness checks</li>
            <li>Legal hold coordination</li>
            <li>Compliance evidence exports</li>
            <li>Lifecycle status dashboards</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce storage cost</li>
            <li>Keep retention compliant</li>
            <li>Simplify deletion review</li>
            <li>Improve legal readiness</li>
        </ul>
      </section>

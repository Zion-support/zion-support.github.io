    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Digital Twin &amp; Capacity Simulation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Create a live digital replica of your data center for capacity planning, thermal simulation, and failure testing. Model hardware changes, power/thermal impact, and growth scenarios in 3D before touching physical infrastructure.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>3D live replica synchronized with DCIM and sensor telemetry</li>
            <li>Capacity planning with what-if modeling (racks, power, cooling)</li>
            <li>Thermal simulation to detect hotspots before deployment</li>
            <li>Failure injection: cable, power, cooling, network chain testing</li>
            <li>Growth trajectory forecasting with 12–36 month scenarios</li>
            <li>Change-impact preview for rack moves, adds, and decommissions</li>
            <li>Integration with Schneider, Eaton, Huawei DCIM and BMS</li>
            <li>Audit-friendly evidence logs for compliance and change control</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate costly overprovisioning with accurate capacity planning</li>
            <li>Prevent thermal failures by simulating changes before implementation</li>
            <li>Reduce planning cycles from weeks to hours</li>
            <li>Improve uptime by validating changes against modeled constraints</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$40,000+/mo</p>
          </div>
        </div>

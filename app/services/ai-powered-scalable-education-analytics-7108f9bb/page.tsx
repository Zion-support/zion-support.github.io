...
export const metadata = {
  title: "AI-Powered Scalable Education Analytics - Zion Tech Group",
  description: "AI-driven analytics platform that delivers scalable insights into education operations, providing real-time monitoring, predictive modeling, and automated repor",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-scalable-education-analytics-7108f9bb`
  }
};

  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/doc-intelligence-v2` title="Intelligent Document Processing v2" />
        <h1 className="text-4xl font-bold mb-6">Intelligent Document Processing v2</h1>
        <p className="text-lg text-gray-300 mb-8">Intelligent document processing: layout-aware OCR, handwriting recognition, table extraction, and form auto-fill. Handles invoices, contracts, medical records, </p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with intelligent document processing v2</li>

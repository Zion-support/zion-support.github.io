            ...
            <div className="text-left">"
              <div className="text-left">"
                ...
                <ul className="text-left">"
                  <li className="text-left">"
                    ...
                    <span>AI-powered threat detection & prevention<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">✓<"
                    <span>Quantum encryption protocols<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">✓<"
                    <span>Zero-trust architecture implementation<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">✓<"
                    <span>Real-time vulnerability scanning<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">✓<"
                    <span>Behavioral anomaly detection<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">✓<"
                    <span>Automated incident response<
                  </li>
                </ul>
              </div>
              ...
              <div className="text-left">"
                ...
                <ul className="text-left">"
                  <li className="text-left">"
                    <span className="text-left">→<"
                    <span>99.99% threat detection accuracy<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">→<"
                    <span>100% ransomware attack prevention<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">→<"
                    <span>$80M+ in breach cost savings<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">→<"
                    <span>&lt;10ms real-time response time<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">→<"
                    <span>24/7 AI security monitoring<
                  </li>
                  <li className="text-left">"
                    <span className="text-left">→<"
                    <span>Compliance certification support<
                  </li>
                </ul>
              </div>
            </div>

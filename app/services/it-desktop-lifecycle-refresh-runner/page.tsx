    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Desktop Lifecycle Refresh Runner</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Manages PC/Mac refresh cycles, OS migrations, and handoffs with inventory, imaging, and readiness tracking.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Golden image management</li>
            <li>OS migration automation</li>
            <li>Refresh scheduling</li>
            <li>Handoff checklists</li>
            <li>Asset tagging</li>
            <li>User readiness tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cut onboarding time by 60%</li>
            <li>Keep hardware current</li>
            <li>Reduce image drift</li>
            <li>Support distributed refresh</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Smart Inventory Management System</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Predict demand, optimize stock levels, and automate purchase orders with AI. Integrates with Shopify, WooCommerce, Amazon, and ERP systems. Reduces carrying costs by 30% and virtually eliminates stockouts.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI demand forecasting with seasonality detection</li>
            <li>Automatic purchase order generation</li>
            <li>Multi-warehouse inventory optimization</li>
            <li>Dead stock identification and liquidation suggestions</li>
            <li>Supplier lead time tracking and safety stock calc</li>
            <li>Real-time sync with Shopify, Amazon, WooCommerce</li>
            <li>Barcode and QR code scanning mobile app</li>
            <li>Custom alerts for low stock, overstock, and anomalies</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce inventory carrying costs by 30%</li>
            <li>Eliminate 95% of stockouts</li>
            <li>Free up working capital tied in excess inventory</li>
            <li>Make purchasing decisions with confidence</li>
        </ul>
      </section>

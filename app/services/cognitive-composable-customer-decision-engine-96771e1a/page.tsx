...
export const metadata = {
  title: "Cognitive Composable Customer Decision Engine - Zion Tech Group",
  description: "Cognitive decision engine that processes composable signals to drive customer strategy with deep learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-composable-customer-decision-engine-96771e1a`
  }
};

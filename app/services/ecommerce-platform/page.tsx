export const metadata = {title: 'Ecommerce Platform | Zion Tech Group',description: 'Professional ecommerce platform services for your business needs.',keywords: 'ecommerce-platform, services, business, technology';

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Relocation &amp; Migration Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">End-to-end data center relocation planning and execution. From physical server moves to cloud migrations, we handle logistics, cabling, testing, and cutover with zero downtime. Trusted by enterprises for mission-critical infrastructure moves.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Complete site assessment and migration planning</li>
            <li>Physical server packing, transport, and reinstallation</li>
            <li>Network reconfiguration and testing</li>
            <li>Zero-downtime cutover orchestration</li>
            <li>Cloud-to-cloud and hybrid migration paths</li>
            <li>Cable management and rack documentation</li>
            <li>Post-move validation and performance testing</li>
            <li>Insurance and chain-of-custody tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Zero downtime during critical infrastructure moves</li>
            <li>Avoid costly mistakes with expert planning</li>
            <li>Full documentation and as-built diagrams included</li>
            <li>Meet compliance requirements during transit</li>
        </ul>
      </section>

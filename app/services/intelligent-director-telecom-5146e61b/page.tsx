...
export const metadata = {
  ...
  description: "The future of telecom is here with Intelligent director-telecom. Powered by cutting-edge AI, this platform delivers predictive analytics like never before.",
  alternates: {

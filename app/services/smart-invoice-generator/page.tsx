...
export const metadata = {title: 'Smart Invoice Generator | Zion Tech Group',description: 'AI-powered invoice automation with smart templates, payment tracking, and financial analytics. Reduce billing time by 80% and get paid 30% faster.',keywords: 'invoice automation, smart invoicing, AI billing, payment tracking, financial analytics, invoice generator';
}export default function SmartInvoiceGeneratorPage() {return (<div className="space-y-16">;
      {/* Hero Section */}
      ...
      <section className="py-12">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
          <FeatureCard;
            ...
            benefits={[;
              "Auto-populate from projects","Smart template selection","Multi-currency support","Custom branding";
            ]}
          />;
          <FeatureCard;
            icon="💳";
            ...
            benefits={[;
              "Stripe & PayPal integration","Auto payment reminders","Recurring billing","Payment analytics";
            ]}
          />;
          <FeatureCard;
            icon="📊";
            ...
            benefits={[;
              "Real-time revenue tracking","Outstanding payment alerts","Cash flow forecasting","Tax preparation tools";
            ]}
          />;
          <FeatureCard;
            icon="🔄";
            ...
            benefits={[;
              "Milestone-based billing","Auto-send schedules","Follow-up sequences","Approval workflows";
            ]}
          />;
          <FeatureCard;
            icon="📱";
            ...
            benefits={[;
              "iOS & Android apps","Offline functionality","Photo receipt capture","Push notifications";
            ]}
          />;
          <FeatureCard;
            icon="🔗";
            ...
            benefits={[;
              "QuickBooks integration","Xero compatibility","Project management sync","API access";
            ]}
          />;
        </div>;
      </section>;
      ...
      <section className="py-12 bg-gray-50 rounded-lg">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">;
          <PricingCard;
            ...
            features={[;
              "Up to 50 invoices/month","Basic AI features","Payment processing","Mobile app","Email support","Basic reporting";
            ]}
          ...
          <PricingCard;
            ...
            features={[;
              "Up to 500 invoices/month","Advanced AI features","Team collaboration","Custom branding","Priority support","Advanced analytics","API access";
            ]}
            cta="Start Free Trial";
            popular={true}
          />;
          <PricingCard;
            ...
            features={[;
              "Unlimited invoices","Custom AI models","White-label options","Dedicated support","Custom integrations","Advanced security","SLA guarantee";
            ]}
            cta="Contact Sales";
            popular={false}
          />;
      ...
      <section className="py-12 bg-gray-50 rounded-lg">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
          <UseCaseCard;
            ...
            benefits={[;
              "Quick invoice creation","Time tracking integration","Professional templates","Mobile invoicing";
            ]}
          />;
          <UseCaseCard;
            icon="🏢";
            ...
            benefits={[;
              "Team collaboration","Client management","Automated workflows","Financial reporting";
            ]}
          />;
          <UseCaseCard;
            icon="🏭";
            ...
            benefits={[;
              "Custom integrations","Advanced analytics","Multi-currency support","Compliance features";
            ]}
          />;
        </div>;
      </section>;
...
>>>>>>> origin/main
  ...
  )}function MetricCard() {return (<div className="text-center p-6 bg-white rounded-lg shadow-md border border-gray-200">;
...
=======
  ...
  )}function TestimonialCard() {return (<div className="p-6 bg-white rounded-lg shadow-md border border-gray-200">;
      <p className="text-gray-600 mb-4 italic">&ldquo;{quote}&rdquo;</p>;
      <div className="border-t pt-4">;
        <div className="font-semibold text-gray-900">{author}</div>;
        <div className="text-sm text-gray-600">{role}</div>;

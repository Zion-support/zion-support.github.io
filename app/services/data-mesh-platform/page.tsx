    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Mesh Orchestration Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Self-service data platform that implements data mesh principles — domain-oriented data ownership, data as a product, federated governance. Enables teams to publish, discover, and consume data products with automated quality SLAs.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Data product catalog with searchable metadata registry</li>
            <li>Domain-based access control and ownership management</li>
            <li>Automated data quality checks with configurable SLAs</li>
            <li>Lineage tracking across domain boundaries</li>
            <li>Self-service data provisioning with approval workflows</li>
            <li>Usage analytics and cost allocation per domain</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate centralized data team bottlenecks</li>
            <li>Empower domain teams to own their data products</li>
            <li>Maintain governance without sacrificing agility</li>
            <li>Discover trusted data products across the organization</li>
        </ul>
      </section>

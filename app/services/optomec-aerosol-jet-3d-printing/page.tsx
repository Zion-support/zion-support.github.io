    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Optomec — Aerosol Jet 3D-Printed Electronics</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Optomec\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Print conductive traces (silver, copper, gold) on any 3D surface</li>
            <li>10-micron resolution — finer than screen printing by 10x</li>
            <li>Aerosol Jet 500: production throughput of 100,000+ components/hour</li>
            <li>Print antennas directly onto smartphone housings, eliminating separate antenna components</li>
            <li>Multi-material printing: conductors, dielectrics, resistors, and semiconductors</li>
            <li>NASA-qualified for printing electronics on spacecraft components</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate traditional PCB manufacturing — print circuits directly on products</li>
            <li>Reduce electronics weight by 60% in aerospace and automotive applications</li>
            <li>5G antenna printing: embed directly into device enclosures for optimal performance</li>
            <li>Rapid prototyping: go from CAD design to functional circuit in hours</li>
            <li>IoT sensor printing at 1/10th the cost of traditional MEMS fabrication</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Prototype printing service ($5,000/run)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$250K/production system</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom integration ($1M+)</p>
          </div>
        </div>

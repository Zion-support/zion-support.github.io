    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IBM Quantum Network — Enterprise Quantum Computing</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">IBM Quantum Network provides enterprises access to real quantum hardware (100+ qubit processors), quantum-safe cryptography tools, and hybrid quantum-classical algorithms. Industries from drug discovery to financial optimization are beginning practical quantum advantage pilots using IBM\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Access to 100+ qubit Eagle and Heron processors via cloud</li>
            <li>Qiskit Runtime for hybrid quantum-classical algorithm execution</li>
            <li>Quantum-safe cryptographic key distribution (QKD) readiness</li>
            <li>Error mitigation and zero-noise extrapolation techniques</li>
            <li>Industry-specific algorithm libraries (optimization, ML, chemistry)</li>
            <li>Dedicated quantum advantage consulting and proof-of-concept labs</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Early mover advantage on quantum-powered optimization</li>
            <li>Prepare cryptography infrastructure for the post-quantum era</li>
            <li>Drug molecular simulation 10-100x faster than classical supercomputers</li>
            <li>Portfolio optimization and risk analysis with quantum Monte Carlo</li>
            <li>Partner network of 200+ Fortune 500 companies and national labs</li>
        </ul>
      </section>

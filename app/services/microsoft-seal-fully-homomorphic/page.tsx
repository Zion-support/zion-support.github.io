    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Microsoft SEAL — Fully Homomorphic Encryption as a Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Microsoft SEAL enables computation on encrypted data without ever decrypting it. Enterprises can run analytics, ML inference, and database queries on ciphertext — meaning sensitive data (health records, financial data, government intel) is never exposed during processing. Now available as a managed cloud service.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>BFV and CKKS schemes for exact and approximate arithmetic on encrypted data</li>
            <li>Encrypted machine learning inference with &lt;10x overhead vs plaintext</li>
            <li>Database query evaluation on encrypted columns (WHERE, SUM, COUNT)</li>
            <li>Multi-party computation combining homomorphic and secret sharing</li>
            <li>Hardware acceleration on Intel HEXL and NVIDIA CUDA backends</li>
            <li>Managed service with key management and audit logging</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Process regulated data without compliance exposure</li>
            <li>Enable cross-organizational analytics without data sharing</li>
            <li>Cloud provider never sees plaintext — zero trust by mathematical proof</li>
            <li>HIPAA/GDPR compliant analytics on encrypted patient/customer data</li>
            <li>DARPA and intelligence community proven — now enterprise ready</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (open-source library)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$0.10/compute hour</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$25,000/hour sustained compute</p>
          </div>
        </div>

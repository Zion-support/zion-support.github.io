  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Screen every transaction for sanctions, export controls, and denied-party lists (OFAC, EU, UN). Real-time screening, false-positive reduction, and audit-ready r</p>

...
export const metadata = {
  title: "Edge-Native Cloud-Native Public Sector Processing - Zion Tech Group",
  description: "Edge-native processing layer that delivers cloud-native public sector insights with sub-millisecond latency.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/edge-native-cloud-native-public-sector-processing-df08211b`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Branded Community &amp; Membership Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Launch a branded online community for your customers, members, or fans. Includes discussion forums, member directories, event management, content libraries, and monetization (paid memberships, subscriptions). White-labeled with your domain and branding. Alternative to Facebook Groups and Slack with full data ownership.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Discussion forums with moderation tools</li>
            <li>Member profiles &amp; directory</li>
            <li>Event management (virtual &amp; in-person)</li>
            <li>Content library &amp; resource sharing</li>
            <li>Paid membership &amp; subscription billing</li>
            <li>Gamification (badges, points, leaderboards)</li>
            <li>Email digests &amp; notification preferences</li>
            <li>Custom domain &amp; white-label branding</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Own your community data (not Facebook/Slack)</li>
            <li>Monetize with paid memberships</li>
            <li>Increase customer retention by 35%</li>
            <li>Build brand advocacy and peer support</li>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Locus Robotics is the world\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-robot orchestration: coordinate 10,000+ robots across 300+ sites</li>
            <li>Human-robot collaboration: robots work alongside humans, increasing productivity 2-3x</li>
            <li>Zero infrastructure: deploy in existing warehouses with no facility modifications</li>
            <li>Dynamic task allocation: AI assigns tasks in real time based on robot location and priority</li>
            <li>Real-time analytics: monitor robot performance, throughput, and efficiency</li>
            <li>Rapid deployment: go live in days with pre-trained AI models</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Increase warehouse picking productivity by 2-3x with human-robot collaboration</li>
            <li>Reduce worker walking time by 80% — robots bring products to people</li>
            <li>Deploy in days without infrastructure changes</li>
            <li>Trusted by DHL, FedEx, and Boots across 300+ sites with 10,000+ robots</li>
            <li>Scale elastically: add robots during peak season and reduce during slow periods</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$50,000/year (5 robots, basic orchestration, 1 site)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$250,000/year (50 robots, full orchestration, multi-site)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited robots, custom integrations, SLA)</p>
          </div>
        </div>

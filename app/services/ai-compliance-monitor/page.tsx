    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Compliance Monitor &amp; Regulatory Tracker</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Continuously monitor your systems, data practices, and operations for compliance with GDPR, HIPAA, SOC 2, PCI-DSS, and industry-specific regulations. AI detects compliance gaps, auto-generates evidence packages, and alerts teams before audits.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time compliance posture monitoring across frameworks</li>
            <li>Automated evidence collection and audit trail generation</li>
            <li>Regulatory change detection and impact assessment</li>
            <li>Policy-to-control mapping with gap analysis</li>
            <li>Automated remediation workflows for common violations</li>
            <li>Executive compliance dashboard with risk scoring</li>
            <li>Integration with AWS, Azure, GCP compliance APIs</li>
            <li>Pre-built templates for GDPR, HIPAA, SOC 2, PCI-DSS</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Detect compliance gaps before they become violations</li>
            <li>Automate evidence collection across cloud environments</li>
            <li>Stay current with regulatory changes automatically</li>
        </ul>
      </section>

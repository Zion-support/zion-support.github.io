...
export const metadata = {
  title: 'Identity and Access Management (IAM) | Zion Tech Group',
  description: 'Deploy IAM: SSO, MFA, directory sync, lifecycle management.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/w179-iam-deploy',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Identity and Access Management (IAM)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Deploy IAM: SSO, MFA, directory sync, lifecycle management.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>SSO across all applications (SAML, OIDC)</li>
            <li>MFA with phishing-resistant factors</li>
            <li>Directory sync (AD, LDAP, Google)</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>One login for all applications</li>
            <li>MFA reduces credential attacks by 99%</li>
            <li>Automated lifecycle prevents orphan accounts</li>
        </ul>
      </section>

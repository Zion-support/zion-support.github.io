    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Customer Onboarding &amp; Time-to-Value Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automated customer onboarding that guides new users to their </p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>No-code onboarding flow builder with checklists and tooltips</li>
            <li>AI-personalized onboarding paths based on user role and goals</li>
            <li>In-app guidance with interactive walkthroughs and product tours</li>
            <li>Time-to-value tracking with milestone completion analytics</li>
            <li>Automated email sequences triggered by onboarding progress</li>
            <li>Health scoring for new accounts during onboarding period</li>
            <li>Integration with CRM, product analytics, and support tools</li>
            <li>A/B testing for onboarding flow optimization</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce time-to-value by 50% with personalized onboarding</li>
            <li>Decrease early churn by 35% with proactive intervention</li>
            <li>Scale onboarding without adding customer success headcount</li>
            <li>Identify product friction points from onboarding drop-off data</li>
        </ul>
      </section>

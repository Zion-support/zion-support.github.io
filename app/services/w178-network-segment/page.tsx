    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Network Segmentation and Micro-Segmentation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Design and implement network segmentation: VLANs, firewall policies, zero trust micro-segmentation.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>VLAN and subnet architecture</li>
            <li>Firewall policy implementation</li>
            <li>Micro-segmentation for data centers</li>
            <li>Zero trust network architecture</li>
            <li>Integration with VMware NSX, Cisco ACI, Illumio</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Limit lateral movement during breaches</li>
            <li>Micro-segmentation for critical assets</li>
            <li>Zero trust architecture</li>
            <li>Compliance with PCI, HIPAA network requirements</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$19,999</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

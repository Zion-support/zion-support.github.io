        ...
        <section className='mb-16'>
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            <div className='bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10'>
              ...
              <a
                href='/<contact'
                className='block w-full text-center bg-orange-500 text-white py-3 rounded-lg hover:bg-orange-600 transition-colors'
              >
                Get Started
              </a>
            </div>
            <div className='bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-emerald-400/50 border-2'>
              ...
              <a
                href='/<contact'
                className='block w-full text-center bg-emerald-500 text-white py-3 rounded-lg hover:bg-emerald-600 transition-colors'
              >
                Get Started
              </a>
            </div>
            <div className='bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10'>
              ...
              <a
                href='/<contact'
                className='block w-full text-center bg-red-500 text-white py-3 rounded-lg hover:bg-red-600 transition-colors'
              >
                Contact Sales
              </a>
            </div>

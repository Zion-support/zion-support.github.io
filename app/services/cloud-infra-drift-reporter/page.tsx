    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloud Infrastructure Drift Reporter</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Detects drift across IaC, live cloud, and service configs with evidence packages, blast-radius hints, and remediation playbooks.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>IaC and live-state comparison</li>
            <li>Drift attribution and history</li>
            <li>Blast-radius estimation</li>
            <li>Remediation playbook pairing</li>
            <li>Weekly compliance digests</li>
            <li>Evidence export for auditors</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce unknown config drift</li>
            <li>Keep IaC accurate</li>
            <li>Produce audit-ready evidence</li>
            <li>Accelerate remediation review</li>
        </ul>
      </section>

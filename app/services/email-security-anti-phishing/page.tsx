    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Email Security &amp; Anti-Phishing Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Advanced threat protection with DMARC/DKIM/SPF management, phishing simulation, and incident response. Shields your organization from business email compromise, ransomware, and social engineering attacks.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time advanced threat protection analyzing links, attachments, and sender behavior</li>
            <li>Managed DMARC, DKIM, and SPF configuration with guided deployment and monitoring</li>
            <li>Automated phishing simulation campaigns with difficulty tiers and scheduling</li>
            <li>24/7 incident response team with containment, forensics, and recovery playbooks</li>
            <li>Security awareness training modules tailored to simulation results and role types</li>
            <li>Executive dashboard with threat landscape overview, trends, and compliance scores</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Blocks 99.7% of phishing, spoofing, and business email compromise attempts</li>
            <li>Achieves DMARC enforcement (p=reject) within 90 days of onboarding</li>
            <li>Reduces employee click-through rates on phishing tests by up to 85%</li>
            <li>Provides sub-1-hour response SLA for confirmed security incidents</li>
            <li>Meets compliance requirements for SOC 2, HIPAA, and PCI-DSS email controls</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">ITIL Service Desk &amp; Incident Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Full ITIL-aligned service desk with incident, problem, change, and request management. AI-powered ticket routing, SLA tracking, and self-service portal. Replace expensive legacy tools like ServiceNow with a modern, affordable alternative that actually works.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI auto-ticket categorization and routing</li>
            <li>Incident, problem, and change management workflows</li>
            <li>SLA tracking with escalation policies</li>
            <li>Self-service portal with knowledge base</li>
            <li>Asset management and CMDB</li>
            <li>Change advisory board (CAB) approval workflows</li>
            <li>SSO integration (Okta, Azure AD, SAML)</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Eliminate lost tickets and missed SLAs</li>
            <li>Give employees self-service answers 24/7</li>
            <li>Replace ServiceNow at 1/10th the cost</li>
        </ul>
      </section>

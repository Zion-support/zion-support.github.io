    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">ShipmentTrack — Package Tracking</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Track packages across carriers: UPS, FedEx, USPS, DHL, Amazon. Notifications and analytics.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-carrier package tracking</li>
            <li>Real-time status updates</li>
            <li>Delivery exception alerts</li>
            <li>Tracking page with custom branding</li>
            <li>Analytics on shipping performance</li>
            <li>Integration with Shopify, WooCommerce, ShipStation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Track all packages in one place</li>
            <li>Real-time updates reduce support calls</li>
            <li>Delivery alerts improve customer experience</li>
            <li>Shipping analytics reveal carrier performance</li>
        </ul>
      </section>

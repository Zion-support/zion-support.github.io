...
<<<<<<< HEAD
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Transform your customer support with intelligent automation solutions that provide 
            24/7 assistance and improve customer satisfaction.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h2 className="text-3xl font-bold text-white mb-6">Why Choose Our AI Support?</h2>
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Provide immediate answers to customer queries 24/7</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center mr-4 mt-1">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Intelligently route complex issues to human agents</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center mr-4 mt-1">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Learning Capability</h3>
                  <p className="text-gray-300">Continuously improves from customer interactions</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Contact us today to learn how AI customer support automation can transform your business.
          </p>

...
function PricingTier({
  ...
  index) =>(
      ...
      <a href="mailto:kleber@ziontechgroup.com?subject=AI Customer Support Automation Quote - {name}"
...
export default function AICustomerSupportAutomationPage() {
    ...
    <div className="space-y-16" >
      ...
      <section className="text-center py-16 bg-gradient-to-br from-green-50 to-blue-100 rounded-lg" />
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center" >
          <a href="mailto:kleber@ziontechgroup.com?subject=AI Customer Support Demo"
  ...
  icon: '💻', description: 'Live support' ].map((integration,,,
  index) => (
            <div key={index}
  ...
  cta="Start Free Trial"
      ...
      <section className="py-12 bg-blue-600 rounded-lg text-white text-center" />
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center" >
          <a href="mailto:kleber@ziontechgroup.com?subject=AI Customer Support Automation Demo Request"

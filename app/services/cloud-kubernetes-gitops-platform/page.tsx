  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/cloud-kubernetes-gitops-platform` title="Kubernetes GitOps Platform" />
        <h1 className="text-4xl font-bold mb-6">Kubernetes GitOps Platform</h1>
        <p className="text-lg text-gray-300 mb-8">GitOps-driven Kubernetes operations: declarative manifests stored in Git, automated drift detection and reconciliation, environment promotion workflows, progres</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with kubernetes gitops platform</li>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Liquid &amp; Immersion Cooling Deployment</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">End-to-end liquid and immersion cooling migration for data centers. From feasibility and ROI analysis to installation, maintenance, and fire-suppression integration. Supports dielectric immersion, direct-to-chip, and rear-door heat exchangers.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Feasibility study and ROI calculator for cooling migration</li>
            <li>Rack-by-rack migration planning with zero downtime</li>
            <li>Dielectric immersion cooling tank design and installation</li>
            <li>Direct-to-chip cold-plate integration for high-density AI/HPC loads</li>
            <li>Fire-suppression and leak detection system integration</li>
            <li>Fluid quality monitoring and preventive maintenance scheduling</li>
            <li>Performance benchmarking and PUE validation post-deployment</li>
            <li>Staff training and Standard Operating Procedure authoring</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce cooling energy consumption by 50% vs traditional HVAC</li>
            <li>Support 100kW+ per rack for AI and HPC workloads</li>
            <li>Lower water usage with closed-loop immersion systems</li>
            <li>Extend hardware lifespan with stable, contamination-free cooling</li>
        </ul>
      </section>

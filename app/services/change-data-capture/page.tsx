    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Change Data Capture (CDC) Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Real-time change data capture platform that streams database changes to data warehouses, lakes, and applications with sub-second latency. Supports all major databases with exactly-once delivery guarantees.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Log-based CDC for PostgreSQL, MySQL, SQL Server, Oracle, MongoDB</li>
            <li>Schema evolution handling with backward compatibility</li>
            <li>Exactly-once delivery with checkpoint management</li>
            <li>Automatic table snapshotting for new subscriptions</li>
            <li>Integration with Snowflake, BigQuery, Redshift, Databricks</li>
            <li>Schema registry with Avro/Protobuf support</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Replace batch ETL with real-time streaming data</li>
            <li>Reduce database load vs query-based extraction</li>
            <li>Keep data warehouse in sync with source systems</li>
            <li>Enable real-time analytics without impacting production databases</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Expense Tracker Pro</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Expense Tracker Pro is an AI-powered expense management platform that automates receipt scanning, categorization, and budget tracking for small and medium businesses. With seamless QuickBooks and Xero integration, it eliminates manual expense entry and gives finance teams real-time visibility into company spending.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI receipt scanning: extract data from photos of receipts with 99% accuracy</li>
            <li>Smart categorization: automatically categorize expenses using machine learning</li>
            <li>Budget alerts: real-time notifications when spending approaches budget limits</li>
            <li>QuickBooks &amp; Xero sync: two-way integration with leading accounting platforms</li>
            <li>Multi-currency support: track expenses in 40+ currencies with live exchange rates</li>
            <li>Approval workflows: configurable multi-level approval chains for expense reports</li>
            <li>Mileage tracking: GPS-based automatic mileage logging for travel reimbursements</li>
            <li>Tax-ready reports: generate tax-compliant expense reports for year-end filing</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce expense processing costs by 75% with AI-powered receipt scanning</li>
            <li>Improve finance team efficiency by eliminating manual data entry</li>
            <li>Scale with enterprise-grade infrastructure supporting unlimited users and integrations</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$12/mo (up to 5 users, 50 receipts/month)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$29/mo (up to 25 users, 500 receipts/month)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited users, custom integrations, dedicated support)</p>
          </div>
        </div>

  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Revolutionize logistics through intelligent automation. Our Automation Cognitive - Logistics leverages advanced machine learning to deliver data processing at s</p>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Network Digital Twin &amp; Simulation Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Create a virtual replica of your entire network infrastructure. Simulate changes, test failover scenarios, and predict bottlenecks before they impact production. AI recommends optimal configurations and identifies single points of failure.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated network topology discovery</li>
            <li>Virtual network replica with real-time data</li>
            <li>Change simulation (what-if analysis)</li>
            <li>Failover and disaster scenario testing</li>
            <li>AI configuration optimization recommendations</li>
            <li>Single point of failure identification</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Test network changes without risk</li>
            <li>Predict bottlenecks before they impact users</li>
            <li>Validate failover procedures automatically</li>
            <li>Optimize network performance with AI</li>
            <li>Reduce unplanned outages by 70%</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Vendor &amp; Procurement Management Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Centralized vendor management with AI-powered procurement workflows. Track contracts, manage renewals, score vendor performance, and automate purchase approvals. Reduces procurement cycle time by 50% and ensures no contract auto-renews unexpectedly. Integrates with accounting and ERP systems.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Centralized vendor database &amp; profiles</li>
            <li>Contract lifecycle management</li>
            <li>Automated renewal alerts (90/60/30 days)</li>
            <li>Vendor performance scorecards</li>
            <li>Purchase request &amp; approval workflows</li>
            <li>Spend analytics by category/vendor</li>
            <li>Document storage &amp; e-signatures</li>
            <li>Integration with QuickBooks, SAP, NetSuite</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce procurement cycle time by 50%</li>
            <li>Never miss a contract renewal or deadline</li>
            <li>Optimize spend with vendor performance data</li>
            <li>Eliminate shadow IT and rogue purchasing</li>
            <li>Centralize all vendor communication and docs</li>
        </ul>
      </section>

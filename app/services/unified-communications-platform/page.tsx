...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/unified-communications-platform',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Unified Communications as a Service (UCaaS)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Cloud-native unified communications platform combining voice, video, messaging, and collaboration. PBX replacement with global PSTN connectivity, team chat, and video conferencing in one platform.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cloud PBX with global PSTN connectivity and local numbers</li>
            <li>HD video conferencing with screen sharing and recording</li>
            <li>Team messaging with channels, threads, and file sharing</li>
            <li>Contact center integration with queue management</li>
            <li>Mobile and desktop apps with seamless handoff</li>
            <li>Call analytics with quality monitoring and reporting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Replace legacy PBX with modern cloud communications</li>
            <li>Reduce telecom costs by 40-60% with cloud delivery</li>
            <li>Enable remote work with full-featured mobile apps</li>
            <li>Consolidate vendors with one platform for all communications</li>
        </ul>
      </section>

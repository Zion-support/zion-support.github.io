    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Endpoint Detection and Response (EDR)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">EDR deployment and management: threat detection, investigation, response across all endpoints.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>EDR agent deployment and management</li>
            ...
            <li>Integration with CrowdStrike, SentinelOne, Microsoft Defender</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect and respond to endpoint threats</li>
            <li>Automated investigation speeds response</li>
            <li>Threat hunting finds hidden attackers</li>

export const metadata = {title: 'Expense Tracker | Zion Tech Group',description: 'Professional expense tracker services for your business needs.',keywords: 'expense-tracker, services, business, technology';

...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/microsaas-client-portal-ticketing',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Client Portal &amp; Ticketing System</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">White-label client portal with integrated support ticketing, knowledge base, and SLA tracking. Give your clients a professional self-service experience while streamlining your support operations. Fully brandable and deployable in under 48 hours.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>White-label client portal with custom branding</li>
            <li>Support ticketing with priority and category routing</li>
            <li>Self-service knowledge base (articles, FAQs, guides)</li>
            <li>SLA tracking with automated escalation</li>
            <li>Client onboarding workflows and task lists</li>
            <li>Analytics dashboard (ticket volume, CSAT, resolution time)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Launch a professional client portal in 48 hours</li>
            <li>Reduce support ticket volume by 35% with self-service</li>
            <li>Meet SLA commitments with automated escalation</li>
            <li>Improve NPS with transparent ticket tracking</li>
            <li>Scale support without proportional headcount growth</li>
        </ul>
      </section>

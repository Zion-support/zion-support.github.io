...
export const metadata = {
  title: "Cloud-Native Advanced Gaming Orchestration - Zion Tech Group",
  description: "Cloud-native orchestration platform that manages advanced gaming resources with auto-scaling and cost control.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cloud-native-advanced-gaming-orchestration-c8254a18`
  }
};

  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/ai-compliance` title="AI Compliance &amp; Regulatory" />
        <h1 className="text-4xl font-bold mb-6">AI Compliance &amp; Regulatory</h1>
        <p className="text-lg text-gray-300 mb-8">Automated compliance monitoring, risk assessment, and audit trail management for GDPR, HIPAA, SOC 2, and more.</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with ai compliance &amp; regulatory</li>

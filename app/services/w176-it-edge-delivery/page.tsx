    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Edge Delivery &amp; CDN Hardening</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Secure, high-performance content delivery: edge routing, WAF rules, TLS hardening, and caching strategy tuned for static and dynamic assets.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Edge routing and failover</li>
            <li>WAF rule tuning and attack blocking</li>
            <li>TLS and HSTS enforcement</li>
            <li>Cache strategy and invalidation</li>
            <li>Asset compression and optimization</li>
            <li>Origin protection and access control</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Reduce attack surface at the edge</li>
            <li>Fewer outages with automated failover</li>
            <li>Cheaper bandwidth after optimization</li>
        </ul>
      </section>

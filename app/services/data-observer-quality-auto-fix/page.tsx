    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Observer Quality Auto-Fix</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Monitors data quality and applies automated remediation actions within policy boundaries so pipelines stay healthy with limited manual ops.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Quality rule monitoring</li>
            <li>Auto-remediation within policy</li>
            <li>Anomaly detection</li>
            <li>Pipeline health dashboards</li>
            <li>Owner alerts and evidence</li>
            <li>Escalation for unresolved breaches</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce pipeline breakage</li>
            <li>Keep quality consistent</li>
            <li>Reduce manual monitoring load</li>
            <li>Produce evidence for anomalies</li>
        </ul>
      </section>

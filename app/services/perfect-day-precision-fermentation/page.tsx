    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Perfect Day — Precision Fermentation Dairy Proteins</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Perfect Day uses precision fermentation to produce real whey and casein proteins identical to those in cow\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real dairy proteins (whey, casein) produced without cows — molecularly identical</li>
            <li>GRAS (Generally Recognized as Safe) FDA status for food use</li>
            <li>97% less water, 97% less land, 65% less greenhouse gas vs dairy farming</li>
            <li>Lactose-free, antibiotic-free, hormone-free, cholesterol-free</li>
            <li>B2B ingredient supply to food manufacturers + B2C branded products</li>
            <li>Precision fermentation platform extensible to egg proteins, collagen, and more</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Same taste and nutrition as dairy — no animal welfare concerns</li>
            <li>Supply chain resilience: production independent of weather, disease, or season</li>
            <li>97% reduction in water usage vs conventional dairy farming</li>
            <li>Addresses global protein demand without expanding animal agriculture</li>
            <li>Products already in 5,000+ US retail stores (Brave Robot ice cream, etc.)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Consumer products (B2C retail)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">B2B protein ingredient ($50/kg)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom formulation partnerships</p>
          </div>
        </div>

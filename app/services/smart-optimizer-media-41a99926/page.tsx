...
export const metadata = {
  title: "Smart optimizer-media - Zion Tech Group",
  description: "Transform your media operations with our Smart optimizer-media. This AI-driven solution automates customer insights with unprecedented accuracy and efficiency.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/smart-optimizer-media-41a99926`
  }
};

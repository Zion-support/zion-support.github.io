    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Incident Response &amp; Runbook Automation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Turn incident response from fire drills into automated workflows. Embed runbooks into ChatOps, auto-triage with AI, and orchestrate remediation across AWS, Azure, GCP, and on-prem systems.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI-powered alert classification and noise reduction</li>
            <li>Executable runbooks with approval gates and rollback</li>
            <li>ChatOps integration (Slack, Teams, PagerDuty, Opsgenie)</li>
            <li>Automated RCA draft generation from logs and metrics</li>
            <li>Chaos engineering experiments for resilience validation</li>
            <li>Post-incident review automation and action item tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cut MTTR by 50% with automated remediation playbooks</li>
            <li>Reduce on-call engineer burnout through intelligent triage</li>
            <li>Eliminate tribal knowledge dependency with documented runbooks</li>
            <li>Accelerate continuous improvement via automated post-mortems</li>
        </ul>
      </section>

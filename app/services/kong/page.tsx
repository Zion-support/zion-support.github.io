    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Kong API Gateway</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Kong is a cloud-native API gateway that delivers high performance and extensibility for managing, securing, and orchestrating APIs and microservices.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>High-performance plugin architecture (authentication, rate limiting, logging)</li>
            <li>Supports multiple protocols: HTTP/1.1, HTTP/2, WebSocket, TCP, TLS</li>
            <li>Provides declarative configuration via Kong Ingress Controller</li>
            <li>Integrates with major identity providers (OAuth2, OpenID Connect, LDAP)</li>
            <li>Offers detailed analytics and monitoring through Kong Manager</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Centralize API management, security, and traffic control</li>
            <li>Scale to handle thousands of requests per second with low latency</li>
            <li>Extend functionality with custom plugins in Lua, Go, or Python</li>
            <li>Used by NASA, Yahoo, and The New York Times for API management</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free tier (1M requests/month)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

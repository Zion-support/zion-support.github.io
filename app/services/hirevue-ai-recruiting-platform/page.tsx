    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">HireVue — AI-Powered Recruiting &amp; Talent Acquisition</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">HireVue is the leading AI-powered recruiting platform that transforms talent acquisition through video interviewing, AI assessments, and predictive analytics. Used by 700+ enterprise customers including Hilton, Unilever, and Delta Air Lines, HireVue processes 20 million+ interviews per year.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI video interviewing: structured interviews with AI-powered competency assessment</li>
            <li>Game-based assessments: evaluate cognitive ability, personality, and job-relevant skills</li>
            <li>Predictive analytics: AI predicts job performance and retention</li>
            <li>Bias reduction: structured evaluations and regular AI fairness audits</li>
            <li>ATS integration: seamless connection with Workday, SAP, Greenhouse, and Lever</li>
            <li>Compliance: EEOC, GDPR, and NYC Local Law 144 compliant</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce time-to-hire by 50% with AI-powered screening and assessment</li>
            <li>Improve quality-of-hire by 25% with predictive analytics</li>
            <li>Process 20 million+ interviews per year for 700+ enterprise customers</li>
            <li>Ensure fair hiring with regular AI bias audits and structured evaluations</li>
            <li>Scale recruiting without adding headcount through automation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$5,000/year (basic video interviewing, 100 assessments)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$25,000/year (AI assessments, analytics, 1,000 assessments)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited assessments, custom AI models, SLA)</p>
          </div>
        </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Content Compliance &amp; Moderation Engine</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automatically moderate user-generated content across text, images, and video using fine-tuned AI models. Detect hate speech, misinformation, copyright violations, and brand-safety risks in milliseconds. Essential for platforms, marketplaces, and social apps.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-modal moderation (text, image, video)</li>
            <li>Hate speech &amp; toxicity detection in 50+ languages</li>
            <li>Misinformation &amp; fact-check scoring</li>
            <li>Copyright &amp; IP violation detection</li>
            <li>Brand-safety risk classification</li>
            <li>Human-in-the-loop review queues</li>
            <li>Custom policy engine with regex + AI</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Protect your brand from harmful content</li>
            <li>Reduce moderation team costs by 80%</li>
            <li>Scale content review without headcount</li>

...
>>>>>>> cursor/automate-test-improve-and-merge-code-5e91
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">"
            Professional seo analyzer solutions designed to meet your business requirements,
        ...
        <div className="max-w-6xl mx-auto">"
          ...
          <div className="text-center bg-white rounded-xl shadow-lg p-12">"
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">"
              Contact us today to discuss your seo analyzer requirements,
...
>>>>>>> cursor/automate-test-improve-and-merge-code-5e91
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Contact us today to learn how our seo analyzer services can transform your business.
          </p>
...
export const metadata = {
  title: 'Seo Analyzer | Zion Tech Group',
  description: 'Professional seo analyzer solutions for modern businesses. Transform your operations with our advanced seo analyzer technology.'
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional seo analyzer solutions for modern businesses. Transform your operations with our advanced seo analyzer technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our seo analyzer can help your business
          </p>
          <a
            href="/contact"

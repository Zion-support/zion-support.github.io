    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center ITAD &amp; Procurement Lifecycle Services</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">End-to-end IT asset disposition (ITAD) and procurement: secure chain-of-custody, NIST 800-88 sanitization, remarketing, and vendor-neutral hardware procurement for data center refresh cycles.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Secure chain-of-custody and barcode/RFID asset tracking</li>
            <li>NIST 800-88 and DoD 5220.22-M data sanitization</li>
            <li>E-waste recycling with R2/ISO 14001 compliance</li>
            <li>Asset remarketing and value recovery programs</li>
            <li>Vendor-neutral hardware procurement for refresh cycles</li>
            <li>Audit-ready disposition documentation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Recover 20–60% of hardware residual value</li>
            <li>Eliminate data leakage risk with certified sanitization</li>
            <li>Streamline CapEx for hardware refresh programs</li>
            <li>Meet environmental and regulatory compliance requirements</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$699/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

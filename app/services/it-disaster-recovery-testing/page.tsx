    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Automated Disaster Recovery Testing</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Turn DR plans into tested, repeatable executions. Automates recovery validation, reporting, and compliance evidence for auditors and leadership.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Recovery runbook automation and scheduling</li>
            <li>Automated failover and failback validation</li>
            <li>RTO and RPO measurement per system</li>
            <li>Audit-ready evidence and executive reporting</li>
            <li>Cloud and on-prem recovery playbooks</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Prove readiness instead of maintaining paper plans</li>
            <li>Reduce recovery risk through repeated validation</li>
            <li>Deliver compliance evidence faster with automation</li>
        </ul>
      </section>

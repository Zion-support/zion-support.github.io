...
export const metadata = {
  title: 'Unified Communications as a Service (UCaaS) Deployment | Zion Tech Group',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/it-ucaas-platform',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Unified Communications as a Service (UCaaS) Deployment</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Deploy and manage a cloud-powered unified communications platform. Voice, video, messaging, and collaboration in one system. HD video conferencing, auto-attendant, call queues, screen sharing, and mobile apps. Replace legacy PBX and fragmented tools.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cloud voice with HD audio</li>
            <li>HD video conferencing (up to 500 participants)</li>
            <li>Team messaging and channels</li>
            <li>Auto-attendant and call queue management</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>One platform for all communication</li>
            <li>60% cost reduction vs legacy PBX</li>
            <li>Work from anywhere with full feature parity</li>
            <li>Integrate calls with CRM for context</li>
            <li>Scale instantly — add users in seconds</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$22/user/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

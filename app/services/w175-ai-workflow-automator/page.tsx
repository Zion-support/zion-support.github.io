    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Workflow Automator</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-defined automation across apps and data. Detects repetitive tasks, builds automation flows, and keeps them healthy with change-aware self-repair.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>AI-generated automation steps</li>
            <li>Cross-app orchestration</li>
            <li>Change-aware self-repair</li>
            <li>Human approval gates</li>
            <li>Executions logs and analytics</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automate repetitive work without scripting</li>
            <li>Flows self-repair on app changes</li>
            <li>Approvals keep control with humans</li>
            <li>Show ROI with execution logs</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Event Check-in &amp; Badge Printing</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Streamline event arrivals with mobile check-in, QR code scanning, on-demand badge printing, and real-time attendee analytics. Reduce check-in lines, impress attendees, and capture data that matters.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Mobile attendee check-in with QR code scanning</li>
            <li>On-demand badge printing with custom templates</li>
            <li>Real-time attendance tracking and capacity alerts</li>
            <li>Attendee analytics and engagement dashboards</li>
            <li>VIP and speaker badge differentiation</li>
            <li>Walk-up registration and same-day badge issuance</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cut check-in wait times by 70% with QR scanning</li>
            <li>Eliminate manual badge stuffing and pre-printing waste</li>
            <li>Real-time visibility into attendance for event organizers</li>
            <li>Professional on-site impression with instant badge printing</li>
            <li>Capture actionable attendee data for post-event follow-up</li>
        </ul>
      </section>

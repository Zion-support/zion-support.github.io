    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Speech Recognition Engine</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Multi-language speech-to-text with 98%+ accuracy. Real-time transcription, speaker diarization, custom vocabulary, and industry-specific models.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-language STT</li>
            <li>Real-time transcription</li>
            <li>Speaker diarization</li>
            <li>Custom vocabulary</li>
            <li>Industry models</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>98%+ transcription accuracy</li>
            <li>Supports 50+ languages</li>
            <li>Reduces manual transcription costs</li>
            <li>Custom models for domain-specific terms</li>
        </ul>
      </section>

...
export const metadata = {
  ...
  description: "Optimize quantum circuits for NISQ and fault-tolerant hardware: gate decomposition, noise-aware mapping, and error mitigation. Supports IBM, Google, IonQ backen",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6">AI Quantum Circuit Optimization Platform</h1>
        <p className="text-lg text-gray-300 mb-8">Optimize quantum circuits for NISQ and fault-tolerant hardware: gate decomposition, noise-aware mapping, and error mitigation. Supports IBM, Google, IonQ backen</p>

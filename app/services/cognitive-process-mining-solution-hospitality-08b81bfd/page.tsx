...
export const metadata = {
  ...
  description: "Next-generation hospitality solution: Cognitive Process Mining Solution - Hospitality. Combines quota optimization with adaptive intelligence for optimal result",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-process-mining-solution-hospitality-08b81bfd`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Operations Training &amp; Certification Programs</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Uptime Institute, DCi, and custom curricula for data center technicians, facilities staff, and managers: maintenance, safety, power, cooling, and emergency response. Hands-on labs and online instructor-led sessions.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Uptime Institute Tier certification prep</li>
            <li>Electrical safety (NFPA 70E) and lockout/tagout</li>
            <li>Thermal and airflow management labs</li>
            <li>Emergency response and incident command drills</li>
            <li>Online and on-site instructor-led cohorts</li>
            <li>Custom curriculum for proprietary infrastructure</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce human-error incidents with certified operators</li>
            <li>Improve retention with clear career ladders for DC staff</li>
            <li>Standardize procedures across multiple facilities</li>
            <li>Meet insurance and audit requirements for trained personnel</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Migration Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Expert data migration: schema translation, data transformation, validation, zero-downtime cutover.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Schema translation and optimization</li>
            <li>Data transformation and type mapping</li>
            <li>Stored procedure migration</li>
            <li>Validation and reconciliation</li>
            <li>Cutover planning with rollback</li>
            <li>Oracle, SQL Server, PostgreSQL, MySQL, MongoDB</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Expert migration between any engines</li>
            <li>Performance benchmarking validates success</li>
            <li>Rollback plan for safety</li>
        </ul>
      </section>

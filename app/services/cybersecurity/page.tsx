  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/cybersecurity` title="Cybersecurity &amp; Penetration Testing" />
        <h1 className="text-4xl font-bold mb-6">Cybersecurity &amp; Penetration Testing</h1>
        <p className="text-lg text-gray-300 mb-8">Comprehensive security assessments, vulnerability management, and incident response to protect your digital assets.</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Compliance audits (SOC 2, ISO 27001)</li>
          </ul>
        </div>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with cybersecurity &amp; penetration testing</li>

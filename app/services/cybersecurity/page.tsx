...
export const metadata = {title: 'Cybersecurity Services | Zion Tech Group',description: 'Comprehensive cybersecurity solutions including threat detection, compliance management, security audits, and incident response. Protect your business from cyber threats.';
  ...
  description: 'Comprehensive cybersecurity solutions including threat detection, compliance management, security audits, and incident response. Protect your business from cyber threats.',keywords: 'cybersecurity, threat detection, compliance management, security audits, incident response, penetration testing';
      ...
      <section className="py-12 bg-gray-50 rounded-lg">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
          <Item;
            ...
            details={[;
              "Comprehensive security assessment and risk analysis","Current security posture evaluation and gap identification","Regulatory compliance requirements analysis","Security strategy development and roadmap creation","Budget planning and resource allocation","Stakeholder alignment and security awareness";
            ]}/>;
          <Item;
            title="Implementation & Deployment";
            details={[;
              "Security technology selection and implementation","Policy development and procedure establishment","Security controls deployment and configuration","Integration with existing systems and processes","Testing and validation of security measures","Documentation and knowledge transfer";
            ]}/>;
          <Item;
            title="Monitoring & Optimization";
            details={[;
              "Continuous security monitoring and threat detection","Regular security assessments and vulnerability management","Incident response and forensic analysis","Security awareness training and education","Compliance monitoring and reporting","Ongoing optimization and improvement";
            ]}/>;
        </div>;
      </section>;
      <Pricing />;
      <ContactSection />;
function CyberServiceCard() {return (</div>;
      ...
      <ul className="space-y-2">;
        {features.map((feature, index) => (<li key={index} className="flex items-center text-sm text-gray-600">;
            <span className="text-green-500 mr-2">✓</span>;
            {feature}
function Item() {return (<div className="bg-white border border-gray-200 rounded-xl p-6">;
      <h3 className="text-xl font-bold text-gray-900 mb-4">{title}</h3>;
      <ul className="space-y-2">;
        {details.map((detail, index) => (<li key={index} className="flex items-start text-gray-600">;
  ...
  )}function Pricing() {return (<div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
        <Plan;
          name="Security Assessment";
          price="$5k–$15k";
function Pricing() {return (<section className="py-12">;
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
        <Plan;
          ...
          duration="2–4 weeks";
          features={[;
            "Security audit and assessment","Vulnerability scanning","Penetration testing","Risk analysis report","Remediation recommendations","Compliance review";
          ]}/>;
        <Plan;
          ...
          duration="8–16 weeks";
          features={[;
            "Security technology implementation","Policy and procedure development","Security controls deployment","Integration and testing","Staff training","Documentation and handover";
          ]}/>;
        <Plan;
          ...
          duration="Ongoing";
          features={[;
            "24/7 security monitoring","Threat detection and response","Vulnerability management","Security updates and patches","Incident response","Monthly security reports";
          ]}/>;
      </div>;
    </section>;
  )}function Plan() {return (<div className="bg-white border border-gray-200 rounded-xl p-8 hover:shadow-lg transition-shadow">;
      <h4 className="text-2xl font-bold text-gray-900 mb-2">{name}</h4>;
      <div className="text-3xl font-bold text-blue-600 mb-2">{price}</div>;
      <div className="text-gray-600 mb-6">{duration}</div>;
      <ul className="space-y-3 mb-8">;
        {features.map((feature, index) => (<li key={index} className="flex items-center text-gray-600">;
  ...
  )}function ContactSection() {return (<section className="py-12 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg">;

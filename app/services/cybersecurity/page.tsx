...
<<<<<<< HEAD
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Contact us today to learn how our cybersecurity services can transform your business.
          </p>
...
export const metadata = {
  title: 'Cybersecurity | Zion Tech Group',
  description: 'Professional cybersecurity solutions for modern businesses. Transform your operations with our advanced cybersecurity technology.'
};
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional cybersecurity solutions for modern businesses. Transform your operations with our advanced cybersecurity technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our cybersecurity can help your business
          </p>
          <a
            href="/contact"

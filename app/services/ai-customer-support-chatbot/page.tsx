    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Customer Support Chatbot</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI Customer Support Chatbot is an intelligent conversational AI platform that resolves up to 80% of customer inquiries automatically. Powered by advanced natural language understanding, it integrates with your knowledge base and seamlessly hands off complex issues to human agents when needed.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>80% auto-resolution: handle the majority of customer inquiries without human intervention</li>
            <li>Knowledge base integration: automatically pull answers from your existing documentation</li>
            <li>Human handoff: seamless transfer to live agents with full conversation context</li>
            <li>Multilingual support: understand and respond in 50+ languages out of the box</li>
            <li>Sentiment analysis: detect customer frustration and prioritize urgent conversations</li>
            <li>Omnichannel deployment: deploy on website, mobile app, WhatsApp, and social media</li>
            <li>Continuous learning: AI improves from every interaction and agent correction</li>
            <li>Analytics dashboard: track resolution rates, CSAT scores, and conversation trends</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce customer support costs by 60% with 80% automated inquiry resolution</li>
            <li>Improve customer satisfaction with instant, 24/7 AI-powered support</li>
            <li>Scale with enterprise-grade infrastructure supporting unlimited conversations and channels</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$49/mo (up to 500 conversations/month, basic NLU)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$149/mo (up to 10,000 conversations/month, advanced AI)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited conversations, custom models, dedicated infrastructure, SLA)</p>
          </div>
        </div>

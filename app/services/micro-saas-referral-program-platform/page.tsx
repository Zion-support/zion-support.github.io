    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Referral Program &amp; Affiliate Management Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Launch and manage customer referral programs and affiliate partnerships that drive viral growth. AI optimizes reward structures, identifies your best advocates, and automates payout processing. Tracks attribution across channels and prevents fraud.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Customizable referral program builder with drag-and-drop editor</li>
            <li>AI-optimized reward structure recommendations based on your margins</li>
            <li>Automated advocate identification from customer behavior signals</li>
            <li>Multi-tier referral and affiliate program support</li>
            <li>Fraud detection and duplicate referral prevention</li>
            <li>Automated payout processing via Stripe, PayPal, and gift cards</li>
            <li>Attribution tracking across email, social, and direct channels</li>
            <li>Real-time program analytics and ROI dashboards</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Acquire customers at 3-5x lower cost than paid advertising</li>
            <li>Turn your happiest customers into a scalable growth channel</li>
            <li>Optimize reward spend with AI-driven recommendations</li>
            <li>Prevent referral fraud that erodes program ROI</li>
        </ul>
      </section>

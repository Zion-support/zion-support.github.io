...
export const metadata: Metadata = {
  ...
  description:
    'Comprehensive AI services, micro SaaS solutions, and IT consulting. Transform your business with cutting-edge technology and automation.',
  keywords:
    'AI services, micro SaaS, IT consulting, cloud migration, DevOps, enterprise software, automation',
};
...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      description:
        'Create, innovate, and generate novel solutions with cutting-edge generative intelligence',
      icon: '✨',
      features: [
    ...
    },
    {
      ...
      description:
        'Seamless cloud transitions and optimized DevOps practices for modern infrastructure',
      icon: '☁️',
      features: [
    ...
    },
    {
      ...
      description:
        'Custom micro SaaS solutions designed for specific business needs and rapid deployment',
      icon: '🔧',
      features: [
    ...
    },
    {
      ...
      description:
        'Strategic AI implementation guidance for enterprise-scale digital transformation',
      icon: '🎯',
      features: [
    ...
    },
    {
      ...
      description:
        'Advanced security solutions powered by AI for comprehensive threat protection',
      icon: '🛡️',
      features: [
      ...
      <section className='relative py-20 px-6 bg-gradient-to-r from-blue-600 to-purple-600 text-white'>
        <div className='container mx-auto text-center'>
          ...
          <p className='text-2xl text-blue-100 mb-8 max-w-3xl mx-auto'>
            Transform your business with cutting-edge AI solutions, micro SaaS
            development, and enterprise IT services that drive growth and
            innovation.
          </p>
        ...
        <div className='container mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              From AI-powered analytics to autonomous business operations, we
              provide end-to-end technology solutions that deliver measurable
              results.
            </p>
          </div>
      ...
      <section className='py-20 bg-white'>
        <div className='container mx-auto px-6'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Our clients achieve remarkable improvements across key business
              metrics
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
            <div className='text-center bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-xl'>
              ...
              <p className='text-sm text-gray-600 mt-2'>
                Average client performance boost
              </p>
            </div>
          ...
          <div className='grid md:grid-cols-4 gap-8'>
            <div className='text-center'>
              ...
              <p className='text-gray-600'>
                Comprehensive assessment of your current systems, requirements,
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-600'>
                Custom solution design and implementation strategy tailored to
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-600'>
                Ongoing monitoring, support, and optimization to ensure
      ...
      <section className='py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white'>
        <div className='container mx-auto px-6 text-center'>
          ...
          <p className='text-xl text-blue-100 mb-8 max-w-2xl mx-auto'>
            Let's discuss how our AI and technology solutions can accelerate

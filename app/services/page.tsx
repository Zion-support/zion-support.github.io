...
<<<<<<< HEAD
      <Helmet>
        ...
        <meta name="description" content="Comprehensive AI, cybersecurity, cloud, and 5G solutions for your business needs." />
      </Helmet>
...
=======
            ...
            >
              ...
              <a
                href={service.path}
                className="block w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-3 px-6 rounded-xl text-center hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105"
              >
                Learn More
              </a>
>>>>>>> cursor/fix-errors-and-merge-to-main-234b

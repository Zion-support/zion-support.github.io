              ...
              <div className="flex flex-col md:flex-row gap-4 mb-6">
                ...
                <div className="md:w-64">
                  <div className="relative">
                    ...
                    <select>setSelectedCategory(e.target.value)}
                      className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 transition-colors appearance-none"</select>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            {totalPages > 1 && (
              <div className="flex justify-center items-center mt-12 space-x-2">
                <buttonMath.max(prev - 1, 1))}
                  disabled={currentPage === 1}
                  className="px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white hover:bg-white/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300"</button>
                  Previous</button>
                <div className="flex space-x-2">
                  {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
                    <buttonsetCurrentPage(page)}
                ...
                <buttonMath.min(prev + 1, totalPages))}
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <buttonGet Free Consultation</button>
              <buttonView Portfolio</button>
            </div>
          </div>
        </section>
      </div>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Discover our comprehensive range of AI services, IT solutions, and Micro SaaS tools designed to transform your business with cutting-edge technology." />
        <meta name="keywords" content="AI services, IT solutions, micro saas, business automation, technology consulting" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive AI services, IT solutions, and Micro SaaS tools designed to transform your business with cutting-edge technology.
              </p>
            </div>
              ...
              {filteredServices.map((service, index) => (
                <div key={index} className="bg-slate-800/50 backdrop-blur-lg rounded-xl p-6 border border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-sm text-cyan-400 font-medium capitalize">{service.category}</span>
                  </div>

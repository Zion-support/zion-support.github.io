  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Discover our comprehensive range of AI and IT services. From AI-powered solutions to cloud infrastructure and custom software development." />
        <meta name="keywords" content="AI services, IT services, cloud solutions, software development, cybersecurity, micro SaaS" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                ...
                From cutting-edge AI applications to robust IT infrastructure, we have everything you need to succeed.
              </p>
            </div>

...
export default function ServicesPage() {
  const services = [
    ...
    },
    {
      ...
      title: "Cybersecurity",
      description:
        "Protect your digital assets with our comprehensive cybersecurity solutions and threat monitoring.",
      features: [
        "Threat Detection",
        "Security Audits",
        "Incident Response",
    ...
    },
    {
      ...
      description:
        "Migrate and optimize your infrastructure with our cloud solutions and managed services.",
      features: [
        "Cloud Migration",
    ...
    },
    {
      ...
      title: "5G Solutions",
      description:
        "Leverage the power of 5G technology for next-generation connectivity and IoT solutions.",
      features: [
        "5G Infrastructure",
        "IoT Solutions",
        "Edge Computing",
    ...
    },
    {
      ...
      description:
        "Unlock insights from your data with our advanced analytics and business intelligence solutions.",
      features: [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta
          name="description"
          content="Comprehensive AI and IT services by Zion Tech Group"
        />
      </Helmet>
...
const ServicesPage: React.FC = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      name: "AI Services",
      icon: CpuChipIcon,
      count: getServicesByCategory("ai").length,
    },
    {
      id: "it",
      name: "IT Services",
      icon: CodeBracketIcon,
      count: getServicesByCategory("it").length,
    },
    {
      id: "cloud",
      name: "Cloud Solutions",
      icon: CloudIcon,
      count: getServicesByCategory("cloud").length,
    },
    {
      id: "security",
      name: "Security",
      icon: ShieldCheckIcon,
      count: getServicesByCategory("security").length,
    },
    {
      id: "blockchain",
      name: "Blockchain",
      icon: CircleStackIcon,
      count: getServicesByCategory("blockchain").length,
    },
    {
      id: "iot",
      name: "IoT Solutions",
      icon: SignalIcon,
      count: getServicesByCategory("iot").length,
    },
    {
      id: "devops",
      name: "DevOps",
      icon: CogIcon,
      count: getServicesByCategory("devops").length,
    },
    {
      id: "data",
      name: "Data Analytics",
      icon: ChartBarIcon,
      count: getServicesByCategory("data").length,
    },
  ];
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Discover our comprehensive range of AI-powered solutions, IT
              services, and enterprise software. All services come with
              transparent pricing, detailed documentation, and dedicated
              support.
            </p>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-6">
                    <div
                      className={`w-16 h-16 rounded-lg bg-gradient-to-r ${service.gradient} p-4 icon-bounce`}
                    >
                      <CategoryIcon className="h-8 w-8 text-white" />
                    </div>
                    <div
                      className={`px-3 py-1 rounded-full text-xs font-semibold border ${getStatusColor(service.status)}`}
                    >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="glass-card p-12">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Don't see exactly what you need? Our team can create custom AI and
              IT solutions tailored to your specific business requirements.
            </p>

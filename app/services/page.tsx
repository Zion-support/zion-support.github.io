...
import { Brain, Cloud, Shield, BarChart3, Smartphone, Database, Zap, Globe, CheckCircle, ArrowRight, Search, Filter,
  Eye, Settings, Users, MessageSquare, FileText, Target } from 'lucide-react';
...
=======
    ...
    },
    {
      ...
      description: 'Transform your data into actionable insights with machine learning algorithms and predictive analytics.',
      category: 'ai',
      price: 'Starting at $399/month',
      marketPrice: '$800-3000/month',
      benefits: ['Predictive insights', 'Real-time dashboards', 'Custom reports', 'ROI optimization']
    },
    {
      icon: Eye,
      ...
      benefits: ['Automated quality control', 'Security monitoring', 'Object detection', 'Custom model training']
    },
    {
      icon: MessageSquare,
      title: 'AI Voice Solutions',
      description: 'Speech recognition and text-to-speech solutions for voice-enabled applications and accessibility.',
      category: 'ai',
      price: 'Starting at $349/month',
      marketPrice: '$600-2500/month',
      benefits: ['Multi-language support', 'Voice commands', 'Accessibility features', 'Custom voice training']
    },
    {
      icon: Settings,
      title: 'AI Workflow Automation',
      description: 'Automate repetitive tasks and streamline business processes with intelligent workflow solutions.',
      category: 'ai',
      price: 'Starting at $249/month',
      marketPrice: '$400-1800/month',
      benefits: ['Process automation', 'Time savings', 'Error reduction', 'Scalable workflows']
    },
    {
      icon: FileText,
      title: 'AI Content Generation',
      description: 'Automated content creation for blogs, social media, and marketing materials with brand voice consistency.',
      category: 'ai',
      price: 'Starting at $199/month',
      marketPrice: '$300-1500/month',
      benefits: ['Content automation', 'SEO optimization', 'Brand consistency', 'Multi-format support']
    },
    ...
    // IT Services
    {
      ...
      description: 'Scalable cloud solutions on AWS, Azure, and GCP with automated deployment and monitoring.',
      category: 'it',
      price: 'Starting at $199/month',
    ...
    },
    {
      ...
      price: 'Starting at $299/month',
      marketPrice: '$500-2000/month',
      benefits: ['Responsive design', 'Performance optimization', 'SEO ready', 'Mobile-first approach']
    },
    {
      icon: Smartphone,
      ...
      price: 'Starting at $399/month',
      marketPrice: '$800-3000/month',
      benefits: ['Cross-platform', 'Native performance', 'App store optimization', 'Push notifications']
    },
    {
      icon: Shield,
      title: 'Cybersecurity',
      description: 'Comprehensive security solutions including audits, monitoring, and compliance support.',
      category: 'it',
      price: 'Starting at $199/month',
      marketPrice: '$400-1500/month',
      benefits: ['Security audits', 'Threat monitoring', 'Compliance support', 'Incident response']
    },
    {
      icon: Database,
      ...
      marketPrice: '$300-1200/month',
      benefits: ['Performance tuning', 'Backup & recovery', 'Migration support', 'Query optimization']
    },
    {
      icon: Zap,
      ...
      benefits: ['RESTful APIs', 'GraphQL support', 'Comprehensive docs', 'Rate limiting']
    },
    ...
    // Micro SaaS
    {
      ...
      description: 'Real-time business intelligence dashboard with customizable reports and data visualization.',
      category: 'micro-saas',
      price: '$99/month',
      marketPrice: '$200-800/month',
      benefits: ['Real-time analytics', 'Custom dashboards', 'Data visualization', 'Export reports']
    },
    {
      icon: MessageSquare,
      title: 'AI Chatbot Builder',
      description: 'No-code chatbot creation platform with multi-channel deployment and analytics.',
      category: 'micro-saas',
      price: '$79/month',
      marketPrice: '$150-600/month',
      benefits: ['No-code builder', 'Multi-channel', 'Analytics', 'Custom branding']
    },
    {
      icon: Target,
      title: 'AI Email Marketing',
      description: 'Automated email campaigns with A/B testing, segmentation, and advanced analytics.',
      category: 'micro-saas',
      price: '$59/month',
      marketPrice: '$100-400/month',
      benefits: ['Automated campaigns', 'A/B testing', 'Segmentation', 'Advanced analytics']
    },
    {
      icon: Settings,
      title: 'AI Project Management',
      description: 'Smart project management with task automation, team collaboration, and time tracking.',
      category: 'micro-saas',
      price: '$89/month',
      marketPrice: '$150-500/month',
      benefits: ['Task automation', 'Team collaboration', 'Time tracking', 'Smart reporting']
    },
    {
      icon: Globe,
      title: 'AI SEO Optimizer',
      description: 'Automated SEO tools with keyword research, content optimization, and rank tracking.',
      category: 'micro-saas',
      price: '$69/month',
      marketPrice: '$120-450/month',
      benefits: ['Keyword research', 'Content optimization', 'Rank tracking', 'Competitor analysis']
    },
    {
      icon: Users,
      title: 'AI Sales CRM',
      description: 'Intelligent CRM system with lead management, sales pipeline, and automation features.',
      category: 'micro-saas',
      price: '$129/month',
      marketPrice: '$200-800/month',
      benefits: ['Lead management', 'Sales pipeline', 'Automation', 'Integration']
    }
  ];
  ...
  const categories = [
    ...
    { id: 'micro-saas', label: 'Micro SaaS', icon: Settings }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive AI and IT services including chatbots, data analytics, web development, cloud infrastructure, and micro SaaS solutions." />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              return (
                ...
                >
                  <div className="text-center mb-6">
                    <div className="w-16 h-16 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="mt-20 text-center">
            <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 rounded-2xl p-12 border border-cyan-500/20">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Contact our experts for a free consultation and discover how our services 

...
const ServicesPage: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Powerful, affordable micro SAAS tools designed to streamline your business operations.',
      features: ['Business Intelligence', 'AI Chatbots', 'Security Monitoring', 'Content Creation'],
      href: '/micro-saas',
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/20 transition-all duration-300 border border-cyan-500/20 group">

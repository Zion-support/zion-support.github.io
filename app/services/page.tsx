    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-2">
                      <a 
                        ...
                        className="bg-blue-600 text-white px-4 py-2 rounded-lg font-semibold text-center hover:bg-blue-700 transition-colors text-sm"
                      >
                        Learn More
                      </a>
                      <a 
                        href={`tel:${service.contactInfo.phone}`}
                        className="bg-gray-100 text-gray-700 px-4 py-2 rounded-lg font-semibold text-center hover:bg-gray-200 transition-colors text-sm"
                      >
                        Call Now
                      </a>
                    </div>
          ...
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 text-center mb-8">IT Solutions</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

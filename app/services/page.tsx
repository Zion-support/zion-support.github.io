...
import { servicesData, serviceCategories, contactInfo } from '../data/servicesData';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
              ...
              From cutting-edge AI tools to robust infrastructure, we provide everything you need to succeed.
            </p>
            ...
            <div className="mb-12 p-6 glass-effect rounded-2xl max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <a href={`tel:${contactInfo.phone}`} className="text-gray-300 hover:text-cyan-400 transition-colors">{contactInfo.phone}</a>
                </div>
                <div className="flex items-center justify-center space-x-2">
                  <span className="text-cyan-400">📧</span>
                  <a href={`mailto:${contactInfo.email}`} className="text-gray-300 hover:text-cyan-400 transition-colors">{contactInfo.email}</a>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div className="mb-6">
                      <div className="flex items-baseline space-x-2">
                        ...
                        <span className="text-gray-400">
                          {service.category === 'saas' ? '/month' : 'starting'}
                        </span>
                      </div>
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 rounded-3xl p-12 border border-cyan-500/20">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  ...
                  <a href={`tel:${contactInfo.phone}`} className="px-8 py-3 border-2 border-cyan-500 text-cyan-400 rounded-full font-semibold text-lg hover:bg-cyan-500 hover:text-white transition-all duration-300 hover:scale-105">
                    Call Now
                  </a>
                </div>
              </div>

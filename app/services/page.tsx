        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border">
              ...
              <p className="text-gray-600">
                Complete IT infrastructure management, support, and consulting services for modern businesses.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border">
              ...
              <p className="text-gray-600">
                Next-generation 5G network solutions for enhanced connectivity and performance.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border">
              ...
              <p className="text-gray-600">
                Advanced data analytics and business intelligence solutions to drive informed decisions.
              </p>
            </div>
          </div>
        </div>

...
const ServicesPage: React.FC = () => {
  const serviceCategories = [{
      ...
      services: [{ name: 'AI Consulting & Strategy', price: '$2,500/month', description: 'Comprehensive AI strategy development and implementation planning', features: ['AI Roadmap Development', 'Technology Assessment', 'ROI Analysis', 'Implementation Planning'] },';
    ...
    },
    {
      ...
      color: 'text-blue-600',';
      bgColor: 'bg-blue-50',';
      services: [{ name: 'Migration', price: '$3,000/month', description: 'Seamless migration to cloud platforms with minimal downtime', features: ['AWS/Azure/GCP Migration', 'Data Transfer', 'Setup', 'Performance Optimization'] },';
    ...
    },
    {
      ...
      bgColor: 'bg-green-50',';
      services: [{ name: 'Digital Strategy', price: '$2,800/month', description: 'Comprehensive digital transformation strategy and implementation', features: ['Digital Assessment', 'Technology Roadmap', 'Change Management', 'ing Programs'] },';

...
const ServicesPage: React.FC = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      category: 'it',
      features: ['Custom Application Development', 'API Development', 'Integration Services', 'Performance Optimization'],
    ...
    },
    {
      ...
      category: 'it',
      features: ['24/7 Helpdesk Support', 'Remote Assistance', 'Hardware Maintenance', 'Software Installation'],
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive AI and IT solutions including chatbots, data analytics, cloud infrastructure, cybersecurity, and custom software development." />
        <meta name="keywords" content="AI services, IT solutions, cloud computing, cybersecurity, software development, micro SaaS" />
      </Helmet>

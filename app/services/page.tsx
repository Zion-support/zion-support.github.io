  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Explore our comprehensive range of AI and IT services including AI solutions, cloud computing, cybersecurity, and micro SaaS applications." />

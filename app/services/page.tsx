  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <meta name="description" content="Discover our comprehensive range of AI and IT services designed to transform your business. From AI solutions to cloud services and data analytics." /> " <meta name="keywords" content="AI services, IT services, cloud services, data analytics, cybersecurity, Zion Tech Group" />"
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden"> " <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(147,51,234,0.3)_0%,transparent_50%)] animate-pulse" />"
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(59,130,246,0.3)_0%,transparent_50%)] animate-pulse" style={{ animationDelay: '1s' }} /> ' <div className="relative max-w-7xl mx-auto text-center">"'"
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"> "
              Comprehensive AI and IT solutions designed to transform your business and drive growth. </p>
          </div>
        </section>
        {/* Search and Filter Section */}
        <section className="py-8 px-4"> " <div className="max-w-6xl mx-auto">"
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20"> " <div className="flex flex-col md:flex-row gap-4 mb-6">"
                ...
                <div className="md:w-64"> " <div className="relative">"
                    <Filter className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" /> " <select"
              ...
              {currentServices.map((service, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/20 transition-all duration-300 group relative">"
                  {service.popular && (
                    ...
                    <div className="bg-cyan-500/20 p-3 rounded-lg mr-4 group-hover:bg-cyan-500/30 transition-colors flex-shrink-0"> " <service.icon className="w-8 h-8 text-cyan-400" />"
                    </div>
                  ...
                  <div className="mb-6"> " <h4 className="text-sm font-semibold text-white mb-3">Key Features:</h4> " <ul className="space-y-2">"
                      {service.features.slice(0, 4).map((feature, featureIndex) => (
                        <li key={featureIndex} className="flex items-center text-sm text-gray-300"> " <CheckCircle className="w-4 h-4 text-green-400 mr-2 flex-shrink-0" />"
                          {feature}
                        </li>
                      ));
    ...
    {totalPages > 1 && (
        ...
        <section className="py-20 px-4"> " <div className="max-w-4xl mx-auto text-center">"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center"> " <button className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-semibold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105">"

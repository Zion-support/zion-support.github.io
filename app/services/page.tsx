...
export default function ServicesPage() {
  const services = [{]      title: 'AI Solutions',
          ...
          {services.map((service, index) => {
            ...
            return (
              <div key={index} className="bg-white p-6 rounded-lg shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
                <div className={`rounded-full p-3 w-12 h-12 mb-4 flex items-center justify-center ${getColorClasses(service.color)}`}>``                  <Icon className="w-6 h-6" />
                </div>

              ...
              {additionalServices.map((service, index) => (
                <Link
                 ...
                 />
                  ...
                  <h3 className="text-lg font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors"  />{service.title}
                  </h3>
                ...
                <div 
                 ...
                 />
                  <div className="relative mb-6" />
                    ...
                    <div className="absolute -top-2 -right-2 w-8 h-8 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold text-sm"  />{step.step}
                    </div>
                  </div>
                  <h3 className="text-xl font-bold text-white mb-3 group-hover:text-cyan-400 transition-colors"  />{step.title}
                  </h3>

...
import EnhancedSEO from "../components/SEOEnhancer";
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <Helmet>
          ...
          <meta name="description" content="Professional AI and IT services by Zion Tech Group." />
          <meta name="keywords" content="AI services, IT services, cybersecurity, cloud computing" />
        </Helmet>
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive AI and IT solutions designed to help your business grow and succeed.
            </p>
          </div>
          
          <div className="mt-16 space-y-16">
            {serviceCategories.map((category, categoryIndex) => (
              <div key={categoryIndex} className="bg-slate-800/30 backdrop-blur-sm rounded-2xl p-8">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {category.services.map((service, serviceIndex) => (
                    <div key={serviceIndex} className={`${category.bgColor} rounded-xl p-6 hover:shadow-lg transition-all duration-300`}>

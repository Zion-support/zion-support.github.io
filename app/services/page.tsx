  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive AI and IT services including custom development, cloud solutions, cybersecurity, and micro SaaS applications." />
        <meta name="keywords" content="AI services, IT services, cloud computing, cybersecurity, micro SaaS, custom development" />
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
              Discover our full range of AI and IT services designed to transform your business. 
              From custom AI solutions to cloud infrastructure, we have everything you need to succeed.
            </p>
          </section>

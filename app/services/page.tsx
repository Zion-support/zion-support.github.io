  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Explore our comprehensive range of AI and IT services designed to accelerate your business growth. From AI development to cloud infrastructure and cybersecurity." />
        <meta name="keywords" content="AI services, IT services, cloud infrastructure, cybersecurity, DevOps, data management, network infrastructure, business solutions" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          {/* AI Services Section */}
          <div className="mb-16">
            <h2 className="text-4xl font-bold text-gray-900 text-center mb-12">AI Services</h2>
          ...
          <div className="mb-16">
            <h2 className="text-4xl font-bold text-gray-900 text-center mb-12">IT Solutions</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl shadow-lg p-8 text-white text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              Get started with our comprehensive AI and IT services today and experience the power of intelligent automation.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="tel:+13024640950" 

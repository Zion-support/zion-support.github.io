  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Professional AI and IT services for your business transformation. Comprehensive solutions including AI services, IT infrastructure, micro SAAS, and specialized technology solutions."
        keywords={['AI services', 'IT solutions', 'business transformation', 'micro SAAS', 'cloud services', 'cybersecurity', 'automation']}

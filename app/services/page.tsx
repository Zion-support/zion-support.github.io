  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Explore our comprehensive AI, IT, and Micro SaaS services. From AI chatbots to cloud solutions, we provide cutting-edge technology services." />
        <meta name="keywords" content="AI services, IT services, micro SaaS, cloud computing, data analytics, cybersecurity" />
      </Helmet>
          ...
          <div className="max-w-4xl mx-auto mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" /></div>
                {filteredServices.map((service, index) => (
                  <div
                    key={index}
                    className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/20 rounded-lg p-6 hover:border-cyan-500/50 transition-all duration-300 group"
                  >

...
const ServicesPage: React.FC = () => {
  ...
  const services = [{
      icon: Brain, title: 'AI Solutions', description: 'Cutting-edge artificial intelligence solutions to transform your business', features: ['Machine Learning', 'Natural Language Processing', 'Computer Vision', 'Predictive Analytics', 'AI Automation', 'Chatbots'],
  ...
  const categories = [{ id: 'all', name: 'All Services', count: services.length }, { id: 'AI Services', name: 'AI Services', count: services.filter(s => s.category === 'AI Services').length }, { id: 'IT Services', name: 'IT Services', count: services.filter(s => s.category === 'IT Services').length }]

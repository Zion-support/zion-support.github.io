  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Discover our comprehensive AI and IT services. From AI-powered solutions to cloud infrastructure and micro SaaS platforms." />
        <meta name="keywords" content="AI services, IT services, cloud solutions, cybersecurity, software development, micro SaaS" />
      </Helmet>

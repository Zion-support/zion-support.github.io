export default function Services() {,
  const services = [
    ...
    {,
      ...
      icon: <Bot className="w-8 h-8" /></Bot>
    ...
    {,
      ...
      icon: <Wifi className="w-8 h-8" /></Wifi>
      path: "/5g-solutions"
    ...
    {,
      ...
      icon: <Phone className="w-8 h-8" /></Phone>
    ...
    {,
      ...
      icon: <Laptop className="w-8 h-8" /></Laptop>
  ...
  return()
    <div className="min-h-screen bg-gray-900 text-white" /></div>
      <Helmet /></Helmet>
        ...
        <meta name="description" content="Services solutions by Zion Tech Group" / /></meta>
      </Helmet>

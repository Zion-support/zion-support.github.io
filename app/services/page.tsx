...
import { Helmet } from 'react-helmet-async'import {
  ...
  Search,
  Filter
} from 'lucide-react'const ServicesPage: React.FC  = () => {
  const services = [
    // AI Services
    {
      icon: Brain,
  ...
  const servicesPerPage = 12;  const filteredServices = services.filter(service => {
  ...
  React.useEffect(() => {
    setCurrentPage(1)
  }, [selectedCategory, searchTerm])return (

...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/w178-receipt-scan',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">ReceiptScan — Expense Receipt OCR</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Scan and extract receipt data: merchant, date, amount, tax. Auto-categorize and export.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Merchant, date, amount, tax extraction</li>
            <li>Auto-categorization</li>
            <li>Duplicate receipt detection</li>
            <li>Export to QuickBooks, Xero, Expensify</li>
            <li>Integration with Expensify, Wave, FreshBooks</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Auto-categorization saves time</li>
            <li>Duplicate detection prevents errors</li>
            <li>Export to any accounting tool</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$5/mo</p>
          </div>

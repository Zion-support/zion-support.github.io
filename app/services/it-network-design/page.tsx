    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Network Design &amp; Optimization Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Professional network architecture design, implementation, and optimization for offices, data centers, and cloud environments. Includes network assessment, topology design, hardware selection, configuration, and performance tuning. Achieve 99.99% network uptime with redundant, secure architecture.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Comprehensive network assessment</li>
            <li>Topology design with redundancy planning</li>
            <li>Hardware selection &amp; vendor negotiation</li>
            <li>Firewall &amp; security configuration</li>
            <li>WiFi site survey &amp; optimization</li>
            <li>SD-WAN design &amp; implementation</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Reduce network-related downtime by 90%</li>
            <li>Optimize for current and future growth</li>
            <li>Secure network from external threats</li>
            <li>Lower TCO with right-sized infrastructure</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$2,499 (assessment + design)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$7,499 (full implementation)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

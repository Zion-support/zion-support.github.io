...
export const metadata = {
  ...
  description: "Managed Apache Flink streaming pipelines: sub-second event processing, exactly-once semantics, windowed aggregations, joins across Kafka/Pulsar/Kinesis sources,",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Managed Apache Flink streaming pipelines: sub-second event processing, exactly-once semantics, windowed aggregations, joins across Kafka/Pulsar/Kinesis sources,</p>

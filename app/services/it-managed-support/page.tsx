    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Managed IT Support &amp; Help Desk</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Full help desk coverage for growing teams: ticket routing, user provisioning, endpoint support, and a single escalation path so internal IT stays small and reliable.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Ticketing and triage workflows</li>
            <li>User onboarding/offboarding runs</li>
            <li>Endpoint support for macOS, Windows, iOS, Android</li>
            <li>Single escalation path to senior engineers</li>
            <li>Clear SLAs and coverage windows</li>
            <li>Incident summary reporting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Free internal staff from repetitive support work</li>
            <li>Keep support costs predictable</li>
            <li>Improve employee productivity through faster resolution</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$2,800/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

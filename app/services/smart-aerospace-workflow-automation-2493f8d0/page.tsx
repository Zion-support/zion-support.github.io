...
export const metadata = {
  title: "Smart Aerospace Workflow Automation - Zion Tech Group",
  description: "Intelligent workflow automation platform that streamlines aerospace processes and eliminates manual tasks.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/smart-aerospace-workflow-automation-2493f8d0`
  }
};

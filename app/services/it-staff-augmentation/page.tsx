    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Staff Augmentation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Add experienced engineers and operators without committing to permanent hires. Each engagement includes knowledge transfer, runbooks, and coverage planning for continuity.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Experienced engineer placement</li>
            <li>Role-based coverage for operations and engineering</li>
            <li>Knowledge transfer and documentation</li>
            <li>Coverage planning for shifts and handoffs</li>
            <li>Onboarding acceleration</li>
            <li>Performance reporting embedded into flows</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Scale team output quickly during peak demand</li>
            <li>Reduce recruiting and onboarding delays</li>
            <li>Maintain coverage across business hours</li>
            <li>Protect productivity during transitions</li>
        </ul>
      </section>

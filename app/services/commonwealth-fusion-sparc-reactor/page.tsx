    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Commonwealth Fusion Systems — SPARC Compact Fusion Reactor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Commonwealth Fusion Systems (CFS), spun out of MIT, is building SPARC — the world\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>High-temperature superconducting (HTS) magnets: 20 Tesla field strength — world record</li>
            <li>SPARC reactor: compact tokamak design, 140 MW fusion power output</li>
            <li>Net energy gain (Q&gt;2): more fusion energy produced than input heating power</li>
            <li>ARC power plant design: 200 MWe commercial fusion plant for grid connection</li>
            <li>$2B+ raised from Temasek, Google, Bill Gates, and Equinor</li>
            <li>Target: first fusion electricity to grid by early 2030s</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Unlimited clean energy: fuel from seawater (deuterium) and lithium (tritium)</li>
            <li>Zero carbon emissions during operation — no greenhouse gases</li>
            <li>No long-lived radioactive waste — fundamentally safer than fission</li>
            <li>Baseload power: runs 24/7 regardless of weather, unlike solar and wind</li>
            <li>Energy independence: fuel available to every nation on Earth</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Research partnership</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">Corporate PPA (power purchase agreement)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Strategic investment (Series B+)</p>
          </div>
        </div>

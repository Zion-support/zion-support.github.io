    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">White-Label Analytics Dashboard</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Embeddable white-label analytics platform that SaaS companies can rebrand and offer to their own customers. Includes customizable dashboards, report builder, data connectors, and multi-tenant architecture out of the box.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-tenant architecture with per-tenant customization</li>
            <li>Drag-and-drop dashboard builder with 40+ widget types</li>
            <li>White-label branding (logo, colors, domain, email)</li>
            <li>Embedded analytics with iframe and JavaScript SDK</li>
            <li>Data connector library (SQL, REST, GraphQL, CSV)</li>
            <li>Role-based access control per tenant and per user</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Add analytics to your SaaS product without building from scratch</li>
            <li>Generate recurring revenue from analytics as a feature</li>
            <li>Reduce time-to-market from months to days</li>
            <li>Maintain brand consistency with full white-labeling</li>
        </ul>
      </section>

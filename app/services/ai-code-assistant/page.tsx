export const metadata = {title: 'Ai Code Assistant | Zion Tech Group',description: 'Professional ai code assistant services for your business needs.',keywords: 'ai-code-assistant, services, business, technology';

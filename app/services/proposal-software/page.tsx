    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Proposal &amp; RFP Response Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered proposal management platform that automates RFP responses, proposal creation, and contract drafting. Content library, collaboration workflows, and win rate analytics.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI content generation from RFP requirements and past wins</li>
            <li>Content library with version control and approval workflows</li>
            <li>Collaborative editing with role-based access</li>
            <li>Win/loss analytics with proposal performance tracking</li>
            <li>CRM integration for opportunity-linked proposals</li>
            <li>E-signature integration for proposal acceptance</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce proposal creation time by 70%</li>
            <li>Increase win rates with data-driven content optimization</li>
            <li>Eliminate redundant content creation across teams</li>
            <li>Track what content wins and what doesn</li>
        </ul>
      </section>

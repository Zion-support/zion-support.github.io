...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/advanced-telemetry-for-agriculture-3f6274ba`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/advanced-telemetry-for-agriculture-3f6274ba` title="Advanced Telemetry for Agriculture" />

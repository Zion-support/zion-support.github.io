...
export const metadata = {
  ...
  description: "Next-generation education solution: Self-Optimizing Threat Advisor. Combines compliance monitoring with adaptive intelligence for optimal results.",
  alternates: {

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">NVIDIA Omniverse — Industrial Digital Twin Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">NVIDIA Omniverse is a platform for creating, simulating, and operating industrial digital twins at planet scale. It connects real-time 3D data from physical assets to virtual replicas using OpenUSD, enabling factories, buildings, and entire cities to be simulated, optimized, and operated from a single digital model.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>OpenUSD-based 3D scene composition and real-time collaboration</li>
            <li>Physics-accurate simulation with PhysX and Flow engines</li>
            <li>AI agent integration for autonomous factory operations</li>
            <li>ROS/ISA-95/OPC-UA connectivity to real industrial equipment</li>
            <li>Cloud-based deployment on NVIDIA OVX server infrastructure</li>
            <li>Pre-built reference applications for factories, warehouses, and robots</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce factory planning time from months to days</li>
            <li>Test production line changes in simulation before physical deployment</li>
            <li>Predict equipment failures 30 days in advance via twin analytics</li>
            <li>BMW, Siemens, and PepsiCo saving billions with digital twin optimization</li>
            <li>Seamless handoff from digital twin to real-world autonomous operations</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (individual)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$9,000/enterprise license/year</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom ($100K+ for deployment)</p>
          </div>
        </div>

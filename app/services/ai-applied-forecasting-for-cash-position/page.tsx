    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Forecasting for Cash Position</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Forecasts short-term cash position from receivables, payables, and payroll with scenario stress tests and alert rules.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Collection and payment prediction</li>
            <li>Payroll-based stress testing</li>
            <li>Scenario variance modeling</li>
            <li>Weekly cash view</li>
            <li>Bank and ERP pairing</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce cash surprises</li>
            <li>Improfy treasury planning</li>
            <li>Act on variance earlier</li>

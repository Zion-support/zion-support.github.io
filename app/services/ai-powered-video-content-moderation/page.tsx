    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI-Powered Video Content Moderation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Real-time video analysis, inappropriate content detection, age verification, and copyright detection powered by advanced computer vision and machine learning. Helps platforms maintain safe, compliant content at scale without manual review bottlenecks.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time video stream analysis processing thousands of concurrent feeds with sub-second latency</li>
            <li>Inappropriate content detection covering violence, nudity, hate symbols, and graphic material with 96% accuracy</li>
            <li>Automated age verification using facial analysis to restrict underage access to age-gated content</li>
            <li>Copyright detection engine that identifies unauthorized use of protected video, audio, and image assets</li>
            <li>Custom content policy builder with granular rules, whitelists, and category-specific thresholds</li>
            <li>Moderation dashboard with flagged content queue, appeal workflows, and detailed audit logs</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduces manual moderation workload by up to 90% through automated content screening</li>
            <li>Protects brand reputation by catching policy violations before they reach end users</li>
            <li>Ensures regulatory compliance with COPPA, GDPR, and platform-specific content regulations</li>
            <li>Scales effortlessly from thousands to millions of video uploads without adding headroom</li>
            <li>Provides detailed analytics on content trends, violation patterns, and moderation performance</li>
        </ul>
      </section>

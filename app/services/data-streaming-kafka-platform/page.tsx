    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Apache Kafka Data Streaming Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enterprise-grade real-time data streaming platform built on Apache Kafka. Handles millions of events per second with exactly-once processing guarantees, schema registry, and managed connectors for seamless data pipeline orchestration.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Managed Kafka clusters with auto-scaling</li>
            <li>Exactly-once processing semantics</li>
            <li>Schema Registry with Avro/Protobuf/JSON support</li>
            <li>Kafka Connect with 100+ pre-built connectors</li>
            <li>Real-time stream processing with Kafka Streams</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Process millions of events per second with sub-second latency</li>
            <li>Eliminate data loss with exactly-once delivery guarantees</li>
            <li>Reduce integration complexity with managed connectors</li>
            <li>Scale seamlessly from prototype to production workloads</li>
        </ul>
      </section>

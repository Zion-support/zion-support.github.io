  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Automated disaster recovery with one-click failover, continuous replication, and compliance testing. Achieves RPO &lt; 1 minute and RTO &lt; 15 minutes for critical a</p>

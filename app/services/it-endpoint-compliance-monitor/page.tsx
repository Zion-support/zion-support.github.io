    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Endpoint Compliance Monitor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Continuously checks endpoint posture across Windows, macOS, and Linux. Enforces policies, blocks drift, and delivers compliance dashboards.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Posture scoring per endpoint</li>
            <li>Policy drift alerts</li>
            <li>OS patch and encryption status</li>
            <li>Config templates by profile</li>
            <li>Agent and agentless collection</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce compliance drift by 60%</li>
            <li>Cut audit prep time</li>
            <li>Block risky endpoints before access</li>
            <li>Unify visibility across OS types</li>
        </ul>
      </section>

...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-catalog',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Catalog &amp; Lineage</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enterprise data catalog with automated discovery, classification, and lineage tracking. Understand where your data comes from, how it flows, and who uses it.</p>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Backup Integrity &amp; Verification Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Validates backup freshness, restorability, and retention policies across cloud and on-premises estates with evidence summaries.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Recovery job validation</li>
            <li>Freshness and retention reports</li>
            <li>Cross-site restore checks</li>
            <li>Policy compliance dashboards</li>
            <li>Alerting on backup drift</li>
            <li>Evidence exports</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce surprise restore failures</li>
            <li>Keep retention policies verified</li>
            <li>Produce audit-ready backup evidence</li>
            <li>Focus recovery readiness with tests</li>
        </ul>
      </section>

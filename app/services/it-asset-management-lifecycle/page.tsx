    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Asset Management &amp; Lifecycle Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Full IT asset management covering hardware and software tracking, license compliance, refresh planning, and end-of-life disposition. Centralized visibility into your entire IT estate with automated discovery, audit-ready reporting, and cost optimization recommendations.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated hardware and software asset discovery across on-premises and cloud environments</li>
            <li>Software license compliance tracking with usage metering and entitlement reconciliation</li>
            <li>Lifecycle management: procurement, deployment, maintenance, and end-of-life disposition</li>
            <li>Refresh planning with budget forecasting, performance scoring, and vendor comparison</li>
            <li>Audit-ready reports for SAM audits, ISO 27001, and regulatory compliance</li>
            <li>Integration with ITSM platforms including ServiceNow, Jira, and Freshservice</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate overspending on unused software licenses with real-time usage tracking</li>
            <li>Reduce audit risk with continuous license compliance monitoring</li>
            <li>Optimize refresh cycles with data-driven lifecycle recommendations</li>
            <li>Centralize IT asset visibility across hybrid and multi-cloud environments</li>
            <li>Cut IT procurement costs by 20% through better asset utilization insights</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Accessibility Compliance Checker</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automated web accessibility testing platform that scans sites and apps for WCAG 2.1/2.2 compliance. AI-powered remediation suggestions, screen reader simulation, and continuous monitoring for accessibility regressions.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated WCAG 2.1/2.2 AA and AAA compliance scanning</li>
            <li>Screen reader simulation with NVDA, JAWS, and VoiceOver testing</li>
            <li>AI-powered remediation suggestions with code snippets</li>
            <li>Continuous monitoring with regression alerts</li>
            <li>VPAT (Voluntary Product Accessibility Template) generation</li>
            <li>Integration with CI/CD pipelines for pre-deployment checks</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Avoid accessibility lawsuits with proactive compliance</li>
            <li>Reach 15% more users who have disabilities</li>
            <li>Fix accessibility issues 10x faster with AI suggestions</li>
            <li>Meet ADA, Section 508, and EN 301 549 requirements</li>
        </ul>
      </section>

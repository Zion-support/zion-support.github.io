...
export const metadata = {
  title: "Security Smart - Manufacturing - Zion Tech Group",
  description: "The future of Manufacturing is here with Security Smart - Manufacturing. Powered by cutting-edge AI, this platform delivers performance monitoring like never be",
  alternates: {
    canonical: `https://ziontechgroup.com/services/security-smart---manufacturing-7ef25fd9`
  }
};

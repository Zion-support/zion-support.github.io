...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/hybrid-cloud-orchestrator',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Hybrid Cloud Orchestration Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Unified hybrid cloud management platform that orchestrates workloads across on-premises, private cloud, and public cloud. Intelligent placement, cost optimization, and consistent security policies across all environments.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Unified management console for on-prem, private, and public cloud</li>
            <li>Intelligent workload placement based on cost, performance, and compliance</li>
            <li>Consistent security and governance policies across environments</li>
            <li>Automated burst-to-cloud for peak demand handling</li>
            <li>Data synchronization with conflict resolution</li>
            <li>Cost optimization with cross-cloud resource right-sizing</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Avoid vendor lock-in with true hybrid cloud flexibility</li>
            <li>Optimize costs by placing workloads in the right environment</li>
            <li>Maintain consistent security across all infrastructure</li>
            <li>Scale to public cloud for peaks without over-provisioning on-prem</li>
        </ul>
      </section>

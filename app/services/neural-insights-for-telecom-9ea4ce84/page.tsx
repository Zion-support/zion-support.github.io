...
export const metadata = {
  ...
  description: "Next-generation telecom solution: Neural Insights for Telecom. Combines process automation with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/neural-insights-for-telecom-9ea4ce84`
  }
};

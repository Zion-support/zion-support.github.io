    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Asset Lifecycle Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Complete IT asset tracking from procurement to disposal. Hardware, software, and cloud resource inventory with automated discovery, license compliance, and cost optimization. Integrates with ITSM, CMDB, and procurement systems.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated asset discovery across network and cloud</li>
            <li>Full lifecycle tracking: procurement to disposal</li>
            <li>Software license compliance monitoring</li>
            <li>Contract and warranty management</li>
            <li>Integration with ITSM (ServiceNow, Jira) and CMDB</li>
            <li>Cost allocation per department and project</li>
            <li>Disposal and data destruction certificate tracking</li>
            <li>Executive dashboard with total cost of ownership</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate ghost assets wasting budget</li>
            <li>Ensure 100% software license compliance</li>
            <li>Optimize hardware refresh cycles</li>
            <li>Reduce IT asset costs by 20-30%</li>
        </ul>
      </section>

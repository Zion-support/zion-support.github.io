    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Contract Lifecycle Management (CLM)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Simple, affordable CLM for small and mid-size businesses. Track contract milestones, auto-renewal deadlines, deliverables, and obligations. No enterprise complexity — just the features growing businesses need to stay on top of contracts.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Contract repository with full-text search</li>
            <li>Auto-renewal deadline alerts</li>
            <li>Milestone and deliverables tracking</li>
            <li>Obligation compliance monitoring</li>
            <li>Approval workflows and e-signatures</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Track all obligations in one place</li>
            <li>Get alerts 30/60/90 days before key dates</li>
            <li>Simple setup in under 30 minutes</li>
            <li>100x cheaper than enterprise CLM</li>
        </ul>
      </section>

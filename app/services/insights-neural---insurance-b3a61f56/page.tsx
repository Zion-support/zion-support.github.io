...
export const metadata = {
  title: "Insights Neural - Insurance - Zion Tech Group",
  description: "Revolutionize insurance through intelligent automation. Our Insights Neural - Insurance leverages advanced machine learning to deliver user experience at scale.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/insights-neural---insurance-b3a61f56`
  }
};

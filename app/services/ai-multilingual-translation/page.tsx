    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enterprise-grade AI document translation that preserves formatting, context, and domain-specific terminology. Supports 100+ languages with custom glossary support for legal, medical, technical, and financial domains. Translates PDFs, Word docs, presentations, and websites while maintaining layout. 10x faster than human translation with 98% accuracy.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>100+ language pairs supported</li>
            <li>Format-preserving translation (PDF, PPTX, DOCX)</li>
            <li>Custom glossary &amp; terminology management</li>
            <li>Domain-specific models (legal, medical, tech)</li>
            <li>Batch translation for large document sets</li>
            <li>Website localization with CMS integration</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Scale global content without scaling team</li>
            <li>Ensure terminology consistency with glossaries</li>
        </ul>
      </section>

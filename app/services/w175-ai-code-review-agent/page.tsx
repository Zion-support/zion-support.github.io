...
export const metadata = {
  ...
  description: "Autonomous code review agent that reviews every PR: correctness, security, performance, style, and architecture. Provides actionable comments with fix suggestio",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Autonomous code review agent that reviews every PR: correctness, security, performance, style, and architecture. Provides actionable comments with fix suggestio</p>

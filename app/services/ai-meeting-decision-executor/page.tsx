    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Meeting Decision Executor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Turns meeting outputs into tracked actions with owners, deadlines, and status checks while integrating with project systems.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Owner and deadline assignment</li>
            <li>Status tracking and reminders</li>
            <li>Integration with PM tools</li>
            <li>Shareholder reporting</li>
            <li>Meeting archive linking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Close the gap between discussion and execution</li>
            <li>Reduce missed action items</li>
            <li>Update stakeholders automatically</li>
            <li>Increase meeting ROI tracking</li>
        </ul>
      </section>

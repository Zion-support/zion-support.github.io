    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Managed Security Operations Center (SOC)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">24/7 managed SOC service with real-time threat detection, incident response, and compliance monitoring. Our security analysts and AI-powered SIEM platform monitor your infrastructure around the clock. Includes monthly security reports, vulnerability assessments, and incident response playbooks.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>24/7 threat monitoring &amp; detection</li>
            <li>AI-powered SIEM with behavioral analytics</li>
            <li>Incident response with 15-min SLA</li>
            <li>Vulnerability scanning &amp; patching</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Enterprise-grade security at 1/10th the cost</li>
            <li>Detect threats in minutes, not months</li>
            <li>Meet compliance requirements effortlessly</li>
            <li>Focus on business, not security fires</li>
            <li>Sleep knowing experts are watching</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$1,999/mo (up to 50 endpoints)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$4,999/mo (up to 250 endpoints)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

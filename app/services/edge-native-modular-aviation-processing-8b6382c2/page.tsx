...
export const metadata = {
  title: "Edge-Native Modular Aviation Processing - Zion Tech Group",
  description: "Edge-native processing layer that delivers modular aviation insights with sub-millisecond latency.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/edge-native-modular-aviation-processing-8b6382c2`
  }
};

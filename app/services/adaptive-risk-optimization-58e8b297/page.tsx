  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Transform your automotive operations with our Adaptive Risk Optimization. This AI-driven solution automates content generation with unprecedented accuracy and e</p>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Customer Support Ticket Routing &amp; Triage</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Eliminate manual ticket sorting with AI that auto-classifies incoming support requests, analyzes customer sentiment, assigns priority scores based on urgency and account value, and routes each ticket to the best-equipped support agent — reducing resolution times and improving customer satisfaction.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automatic ticket classification by type, product, and department</li>
            <li>Real-time sentiment analysis to detect frustrated or at-risk customers</li>
            <li>Intelligent priority scoring based on urgency, account tier, and SLA</li>
            <li>Smart agent assignment matching expertise, workload, and past performance</li>
            <li>Auto-response suggestions for common and repetitive ticket types</li>
            <li>Escalation rules engine with manager approval workflows</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce average ticket resolution time by 40% with intelligent routing</li>
            <li>Detect and prioritize at-risk customers before they churn</li>
            <li>Balance agent workloads automatically to prevent burnout</li>
            <li>Eliminate manual triage overhead saving hundreds of staff hours monthly</li>
            <li>Improve first-response times to meet and exceed SLA commitments</li>
        </ul>
      </section>

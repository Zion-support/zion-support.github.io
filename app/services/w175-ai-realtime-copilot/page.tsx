...
export const metadata = {
  ...
  description: "Real-time AI copilot for support agents: suggests answers, retrieves knowledge, drafts responses, and detects escalation signals mid-conversation. Reduce AHT by",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Real-time AI copilot for support agents: suggests answers, retrieves knowledge, drafts responses, and detects escalation signals mid-conversation. Reduce AHT by</p>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Agent Performance Auditor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Reviews AI agent, chatbot, and copilot outputs for quality, tone, policy adherence, and escalation behavior across channels.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Policy adherence checks</li>
            <li>Escalation and fallback analysis</li>
            <li>Model and prompt lineage tracking</li>
            <li>Supervisor review queues</li>
            <li>Weekly efficiency reports</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Improve assistant quality over time</li>
            <li>Reduce compliance misses</li>
            <li>Coach models like teams</li>
            <li>Make AI trust visible</li>
        </ul>
      </section>

...
<div className="max-w-6xl mx-auto" >
          ...
          <div className="text-center bg-white rounded-xl shadow-lg p-12" >
            <h2 className="text-3xl font-bold text-gray-900 mb-6" >Ready to Get Started?
            </h2>
...
exceptional customer experiences 24/7.
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16" >
        <FeatureCard title="AI Chatbots & Virtual Assistants"
          features={[
          ...
          icon="🤖"
        />
        <FeatureCard title="Ticket Management"
          features={[
          ...
          icon="🎫"
        />
        <FeatureCard title="Sentiment Analysis & Insights"
          features={[
      ...
      <div className="bg-gradient-to-r from-pink-50 to-rose-50 border border-pink-200 rounded-xl p-8 mb-16" >
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center" >Support Platform Benefits</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" >
          <div className="text-center" >
            <div className="text-4xl mb-4" >⚡</div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2" >80% Faster Resolution</h3>
          ...
          <div className="text-center" >
            <div className="text-4xl mb-4" >⭐</div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2" >95% Satisfaction</h3>
...
function PricingSection() {
  return (
    <div className="mb-16" >
      <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center" >Support Platform Pricing</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8" >
        <PricingCard name="Basic Support"
          price="$99/mo"
          ...
          popular={false}
        />
        <PricingCard name="Professional Support"
          price="$299/mo"
          ...
          popular={true}
        />
        <PricingCard name="Enterprise Support"
          price="$799/mo"
...
function PricingCard({
  ...
  return (
    <div className={`relative bg-white border-2 rounded-xl p-8 ${popular ? 'border-pink-500 shadow-lg' : 'border-gray-200'}`}
     >
      {popular && (
...
function ContactSection() {
  return (
    <div className="bg-gradient-to-r from-pink-50 to-rose-50 border border-pink-200 rounded-xl p-8 text-center" >
      <h3 className="text-2xl font-bold text-gray-900 mb-4" >Ready to Transform Your Customer Support?
      </h3>

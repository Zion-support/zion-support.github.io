    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Locus Robotics — Autonomous Mobile Robots for Warehouses</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Locus Robotics provides autonomous mobile robots (AMRs) that work alongside human workers in warehouses and distribution centers, picking, transporting, and sorting goods with minimal infrastructure changes. Their robots use AI-powered navigation, computer vision, and multi-robot coordination to increase pick productivity by 2-3x. Deployed in 300+ warehouses globally for retailers including DHL, Boots, and Material Bank.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Autonomous navigation: no facility modifications required — deploys in hours</li>
            <li>Multi-robot coordination: 500+ robots working simultaneously without collisions</li>
            <li>Human-robot collaboration: workers focus on picking, robots handle transport</li>
            <li>Fleet management dashboard: real-time robot locations, productivity, and battery status</li>
            <li>Integration with Manhattan, Blue Yonder, SAP, and other WMS platforms</li>
            <li>Proven 2-3x productivity increase vs. manual cart-based picking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Solve warehouse labor shortage: deploy robots in days, not months</li>
            <li>Workers achieve 300+ picks/hour vs. 80-100 with manual carts</li>
            <li>Scalable: add robots during peak season, scale down during slow periods</li>
            <li>Zero infrastructure: no QR codes, magnetic tape, or facility modifications needed</li>
            <li>ROI achieved within 12 months through labor cost reduction and throughput gains</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (facility assessment)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$1,500/robot/month</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom fleet pricing ($500K+/year)</p>
          </div>
        </div>

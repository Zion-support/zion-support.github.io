    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Legal Deposition Analyzer</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Transform legal deposition transcripts into structured, searchable intelligence. AI identifies key admissions, contradictions, credibility indicators, and case-relevant testimony. Compare statements across multiple depositions to find inconsistencies. Reduces attorney review time by 70%.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated deposition transcript parsing and structuring</li>
            <li>Key admission and commitment extraction with page-line citations</li>
            <li>Cross-deposition contradiction and inconsistency detection</li>
            <li>Credibility indicator analysis (evasion, hedging, certainty scoring)</li>
            <li>Timeline reconstruction from testimony across depositions</li>
            <li>Privilege and confidentiality flagging for sensitive content</li>
            <li>Export to case management systems (Clio, Relativity, DISCO)</li>
            <li>Attorney work product generation (exam outlines, summary memos)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce deposition review time by 70% with AI structuring</li>
            <li>Find contradictions across dozens of depositions instantly</li>
            <li>Prepare for trial with AI-generated examination outlines</li>
            <li>Never miss a key admission buried in hundreds of pages</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Harvey AI — Enterprise Legal AI Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Harvey AI is a generative AI platform built specifically for law firms and legal departments. Trained on legal data and integrated with Westlaw, LexisNexis, and firm knowledge bases, Harvey performs legal research, contract analysis, due diligence, and document drafting at superhuman speed. Used by 15,000+ lawyers at firms including Allen &amp; Overy, PwC, and KPMG, Harvey reduces legal research time by 80% and contract review by 90%.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Legal research: natural language queries across case law, statutes, and regulations</li>
            <li>Contract analysis: review 100+ page agreements in minutes, flag risks and anomalies</li>
            <li>Due diligence: automate M&amp;A document review across thousands of contracts</li>
            <li>Document drafting: generate memos, briefs, and contracts from natural language prompts</li>
            <li>Firm knowledge base: search internal precedents, templates, and expertise</li>
            <li>SOC 2 Type II certified, GDPR compliant, with firm-specific data isolation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce legal research time by 80% — hours become minutes</li>
            <li>Contract review 90% faster with consistent quality across all documents</li>
            <li>Lawyers focus on high-value strategy instead of repetitive document review</li>
            <li>New associates become productive 3x faster with AI-assisted research</li>
            <li>Firms handle 40% more matter volume without adding headcount</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Not available (enterprise only)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$1,000/seat/year (mid-size firms)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom ($500K+/year for AmLaw 100 firms)</p>
          </div>
        </div>

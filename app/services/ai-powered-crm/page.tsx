export const metadata = {
  ...
  description:
    "Revolutionary AI-powered CRM system that automates sales, predicts customer behavior, and maximizes revenue growth.",
};
  ...
  return (
    <section>
      ...
      <p style={{ marginTop: 8, color: "#374151" }}>
        ...
        predictive analytics, and AI-driven insights that boost sales by 300%.
      </p>
      ...
      >
        ...
        <ul style={{ color: "#0c4a6e", paddingLeft: 18 }}>
          <li>
            • <strong>300% increase</strong> in sales conversion rates
          </li>
          <li>
            • <strong>50% reduction</strong> in customer acquisition costs
          </li>
          <li>
            • <strong>90% accuracy</strong> in sales forecasting
          </li>
          <li>
            • <strong>24/7 AI assistance</strong> for your sales team
          </li>
        </ul>
      </div>
    </section>

...
export const metadata: Metadata = {
  ...
  keywords: 'ai-crm, artificial-intelligence, customer-relationship-management, machine-learning, sales-automation'
};
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">AI Customer Insights</h3>
              <p className="text-gray-600">
                AI-powered customer insights to understand behavior and preferences.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600">
                Automate sales processes and lead management with AI assistance.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Smart Communication</h3>
              <p className="text-gray-600">
                AI-driven communication tools for better customer engagement.
              </p>
            </div>
          </div>

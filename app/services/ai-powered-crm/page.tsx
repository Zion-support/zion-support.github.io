...
export const metadata = {
  ...
  title: "AI-Powered CRM Platform | Zion Tech Group",
  description:
    "Revolutionary CRM with AI automation, predictive analytics, and intelligent lead scoring. Boost sales by 40% with our advanced customer relationship management platform.",
  keywords:
    "AI CRM, customer relationship management, sales automation, lead scoring, predictive analytics, sales intelligence",

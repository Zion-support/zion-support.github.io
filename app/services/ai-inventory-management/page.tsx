  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Optimize inventory levels with AI-driven demand forecasting, automated reorder points, and supplier management. Reduces carrying costs by 30% and stockouts by 9</p>

...
export const metadata = {
  ...
  "description": 'Professional ai inventory management solutions for your business needs.','
};
...
>>>>>>> cursor/automate-test-improve-and-merge-code-5e91
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">"
            Professional ai inventory management solutions designed to meet your business requirements,
...
<<<<<<< HEAD
          ...
          <div className="text-center bg-white rounded-xl shadow-lg p-12">"
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">"
              Contact us today to discuss your ai inventory management requirements,
...
export const metadata = {
  title: 'Ai Inventory Management | Zion Tech Group',
  description: 'Professional ai inventory management solutions for modern businesses. Transform your operations with our advanced ai inventory management technology.'
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional ai inventory management solutions for modern businesses. Transform your operations with our advanced ai inventory management technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our ai inventory management can help your business
          </p>
          <a
            href="/contact"

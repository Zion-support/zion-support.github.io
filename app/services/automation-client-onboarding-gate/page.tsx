    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Client Onboarding Gate</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Runs structured client onboarding sequences with agreement checks, provisioning, access handoff, and success milestone tracking.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Agreement and compliance checks</li>
            <li>Provisioning automation</li>
            <li>Access handoff and training routing</li>
            <li>Milestone tracking</li>
            <li>Churn-risk signals</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce client activation time</li>
            <li>Keep onboarding consistent</li>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Saildrone — Autonomous Ocean Data Collection Vehicles</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Saildrone builds wind and solar-powered autonomous surface vehicles (ASVs) that patrol the world\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Wind and solar powered — zero emissions, 12+ month mission endurance</li>
            <li>100+ vehicle fleet operating across all major ocean basins</li>
            <li>Real-time satellite data transmission: weather, sea state, sub-surface profiles</li>
            <li>Hurricane Wing variant flies into Category 4+ storms for intensification data</li>
            <li>NOAA, NASA, and US Navy operational partnerships</li>
            <li>AI-powered fisheries monitoring and illegal fishing detection</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Hurricane track forecast accuracy improved by 30% with Saildrone data</li>
            <li>Detect illegal fishing in protected marine areas in real time</li>
            <li>Climate change research: ocean CO₂ uptake, acidification, and heat content</li>
            <li>Replace $50M research vessels with $500K autonomous fleets</li>
            <li>Persistent ocean presence: 24/7/365 data collection in remote regions</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Data subscription ($10K/year)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">Mission charter ($50K/mission)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Fleet deployment (custom $500K+)</p>
          </div>
        </div>

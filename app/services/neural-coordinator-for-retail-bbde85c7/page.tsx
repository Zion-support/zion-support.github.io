...
export const metadata = {
  ...
  description: "Revolutionize retail through intelligent automation. Our Neural Coordinator for Retail leverages advanced machine learning to deliver user experience at scale.",
  alternates: {

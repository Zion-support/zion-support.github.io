    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Plenty — AI-Powered Vertical Farming Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Plenty operates AI-controlled vertical farms that grow leafy greens and strawberries indoors using 99% less water and 95% less land than conventional agriculture. Their proprietary platform uses computer vision, machine learning, and environmental controls to optimize every aspect of plant growth — light spectrum, nutrients, temperature, and airflow — producing 350x more food per acre than outdoor farms.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI-optimized growing: computer vision monitors plant health in real time</li>
            <li>350x more productive per acre than conventional farming</li>
            <li>99% less water consumption vs. field agriculture</li>
            <li>Zero pesticides: controlled environment eliminates pest pressure</li>
            <li>Farm-to-store in 24 hours: facilities located near major population centers</li>
            <li>Year-round production: immune to weather, seasons, and climate disruptions</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Food security: grow locally even in arid, cold, or urban environments</li>
            <li>Water conservation: critical for drought-prone regions and growing populations</li>
            <li>Reduced supply chain: fresh produce within 24 hours of harvest</li>
            <li>Climate resilient: production independent of weather, floods, or wildfires</li>
            <li>Retail partnerships: Walmart, Whole Foods, and Albertsons stock Plenty produce</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Consumer (retail produce)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">Farm partnership program</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Turnkey farm solution ($50M+ per facility)</p>
          </div>
        </div>

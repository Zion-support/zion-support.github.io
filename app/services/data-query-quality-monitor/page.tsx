    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Query Quality Monitor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Monitors query and report quality across BI and SQL workloads with freshness, duplicate, null, and schema drift signals per dataset.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Query freshness monitoring</li>
            <li>Duplicate and null detection</li>
            <li>Schema drift alerts</li>
            <li>Owner accountability alerts</li>
            <li>Usage availability signals</li>
            <li>BI and warehouse integration</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce broken report incidents</li>
            <li>Keep query governance visible</li>
            <li>Support ownership clarity</li>
            <li>Accelerate debugging upstream</li>
        </ul>
      </section>

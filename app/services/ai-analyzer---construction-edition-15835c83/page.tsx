  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/ai-analyzer---construction-edition-15835c83` title="AI Analyzer - Construction Edition" />
        <h1 className="text-4xl font-bold mb-6">AI Analyzer - Construction Edition</h1>
        <p className="text-lg text-gray-300 mb-8">Transform your construction operations with our AI Analyzer - Construction Edition. This AI-driven solution automates user experience with unprecedented accurac</p>

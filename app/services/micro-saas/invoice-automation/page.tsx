...
export default function InvoiceAutomationSaaSPage() {
  ...
  const features = [
    'AI OCR for invoices, receipts, and POs',
    '3-way match (PO, receipt, invoice) with variance thresholds',
    'Approval workflows and vendor self-service portal',
    'Duplicate detection and fraud risk scoring',
    'ERP integrations (NetSuite, QuickBooks, SAP, Xero)',
    'Audit trails, SOC 2 controls, and retention policies'
  ];

  const pricing = [
    { name: 'Starter', price: '$499/month', details: ['Up to 1,000 invoices', 'SaaS', 'Email support'] },
    { name: 'Growth', price: '$1,250/month', details: ['Up to 10,000 invoices', 'SaaS', 'Priority support'] },
    { name: 'Enterprise', price: 'Custom', details: ['Unlimited', 'VPC/On‑prem', 'Dedicated support'] }
  ];
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/services/micro-saas/invoice-automation" />
      </Head>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50">
        <section className="py-16 border-b bg-white">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Invoice Automation</h1>
            <p className="text-gray-600 text-lg max-w-3xl">{description}</p>
            <div className="mt-6 flex gap-3">
              <Link href="/contact" className="bg-indigo-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-indigo-700">Start Free Trial</Link>
          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              <div className="space-y-2 text-gray-700">
                <div className="flex items-center"><Wallet className="w-5 h-5 text-indigo-700 mr-2" />Reduce AP costs by up to 70%</div>
                <div className="flex items-center"><Sparkles className="w-5 h-5 text-indigo-700 mr-2" />Accelerate cycle times and close faster</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-6 text-center bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl p-8">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Automate Payables with Confidence</h2>
            <p className="opacity-90 mb-6">From capture to ERP, stay audit-ready and on time.</p>

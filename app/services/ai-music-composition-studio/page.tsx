  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">AI-powered music creation: generate original compositions in any style, remix stems, auto-master tracks, and sync to video. Royalty-free output with commercial </p>

...
export default function AIExpenseManagementPage() {
  return (
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto">
            Streamline expense management with AI-powered automation, receipt processing, and intelligent categorization.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Automate your expense management with cutting-edge AI technology
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-200">
              ...
              <h3 className="text-xl font-semibold mb-3">Smart Receipt Processing</h3>
              <p className="text-gray-600 mb-4">
                AI-powered receipt scanning and data extraction with 99.8% accuracy for automatic expense entry.
              </p>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-200">
              ...
              <h3 className="text-xl font-semibold mb-3">Policy Compliance</h3>
              <p className="text-gray-600 mb-4">
                Automated policy checking and approval workflows to ensure compliance with company expense policies.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Intelligent expense categorization using machine learning to automatically assign categories and tax codes.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Comprehensive expense analytics and reporting with real-time insights and spending trends.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Native mobile app for expense submission, receipt capture, and approval workflows on the go.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                Comprehensive team expense management with role-based access and approval workflows.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Contact our experts today to discuss how our AI Expense Management Platform can transform your business
            </p>
          </div>

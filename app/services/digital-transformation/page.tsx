...
export const metadata = {
  title: 'Digital Transformation - Zion Tech Group',
  description: 'Professional digital transformation solutions for your business needs.',
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          <div className='bg-gray-800 rounded-lg p-6'>
            ...
            <p className='text-gray-300'>
              Tailored digital transformation solutions designed for your
          ...
          <div className='bg-gray-800 rounded-lg p-6'>
            ...
            <p className='text-gray-300'>
              Round-the-clock support to ensure your digital transformation

...
export const metadata = {
  title: 'Digital Transformation | Zion Tech Group',
  description: 'Professional digital transformation solutions for modern businesses. Transform your operations with our advanced digital transformation technology.'
};
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional digital transformation solutions for modern businesses. Transform your operations with our advanced digital transformation technology.
          </p>
        </div>
...
=======
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our digital transformation can help your business
          </p>
          <a
            href="/contact"

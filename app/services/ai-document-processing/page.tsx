    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Document Processing Pipeline</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">End-to-end intelligent document processing that ingests, classifies, extracts, and routes documents across your organization. Handles PDFs, scans, emails, and images with custom ML models trained on your document types. Processes millions of documents with human-in-the-loop validation.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-format ingestion (PDF, scan, email, image, fax)</li>
            <li>AI document classification with custom model training</li>
            <li>Structured and unstructured data extraction</li>
            <li>Human-in-the-loop validation and correction interface</li>
            <li>Automated routing to downstream systems and workflows</li>
            <li>Confidence scoring with auto-escalation thresholds</li>
            <li>Audit trail and compliance documentation</li>
            <li>API and webhook integration with ERP, CRM, and ECM</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Process documents 20x faster than manual handling</li>
            <li>Achieve 99%+ extraction accuracy with custom models</li>
            <li>Reduce document processing costs by 75%</li>

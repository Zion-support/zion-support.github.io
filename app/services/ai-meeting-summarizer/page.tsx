...
export const metadata = {
  title: 'AI Meeting Summarizer & Action Item Extractor | Zion Tech Group',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-meeting-summarizer',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Meeting Summarizer &amp; Action Item Extractor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automatically transcribe, summarize, and extract action items from meetings. Works with Zoom, Teams, Google Meet, and in-person recordings. AI identifies decisions, owners, and deadlines. Integrates with Slack, email, and project management tools.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time transcription (Zoom, Teams, Meet, in-person)</li>
            <li>AI-generated meeting summaries</li>
            <li>Action item extraction with owners and deadlines</li>
            <li>Decision and key point identification</li>
            <li>Auto-send summaries to Slack, email, or Teams</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Never take meeting notes again</li>
            <li>Ensure nothing falls through the cracks</li>
            <li>Search past meetings instantly</li>
            <li>Auto-notify action item owners</li>

...
export const metadata = {
  ...
  description: "Comprehensive penetration testing and red team exercises to identify vulnerabilities before attackers do. Includes network, web app, social engineering, and phy",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Comprehensive penetration testing and red team exercises to identify vulnerabilities before attackers do. Includes network, web app, social engineering, and phy</p>

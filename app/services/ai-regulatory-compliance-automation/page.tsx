  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Automate compliance monitoring and reporting for GDPR, HIPAA, SOC2, PCI-DSS, and industry-specific regulations. Continuous control monitoring, automated evidenc</p>

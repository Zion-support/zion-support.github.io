    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Test Data Management Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enterprise test data management platform that creates, masks, and provisions realistic test datasets. Ensures data privacy compliance in non-production environments while maintaining referential integrity and data realism.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Subset extraction with referential integrity preservation</li>
            <li>Data masking with format-preserving encryption</li>
            <li>Synthetic test data generation for edge cases</li>
            <li>Self-service test data provisioning for QA teams</li>
            <li>Data refresh automation with change detection</li>
            <li>Compliance validation (no PII in non-production)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate production data exposure in test environments</li>
            <li>Reduce test data provisioning time from days to minutes</li>
            <li>Ensure consistent test data across teams and environments</li>
            <li>Comply with data privacy regulations in all environments</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$649/mo</p>
          </div>
        </div>

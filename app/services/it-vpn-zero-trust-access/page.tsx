...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/it-vpn-zero-trust-access',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Zero Trust Network Access (ZTNA)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Replace legacy VPN with identity-based ZTNA. Controls access per app, per device, and per user with continuous verification, logging, and least-privilege policies.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Identity-centered access per app and resource</li>
            <li>Device posture checks before granting access</li>
            <li>Continuous verification and automatic revocation</li>
            <li>Least-privilege policies with audit logging</li>
            <li>Hybrid environment support for on-prem and cloud</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce breach exposure from stolen credentials</li>
            <li>Improve auditor visibility with per-session logs</li>
            <li>Remove broad network access behind a VPN</li>
            <li>Support remote and hybrid teams securely</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$1,200/mo</p>
          </div>
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$7,600/mo</p>
          </div>
        </div>

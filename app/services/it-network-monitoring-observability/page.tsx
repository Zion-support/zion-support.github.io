    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Network Monitoring &amp; Observability Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Full-stack network observability with AI-powered anomaly detection, traffic analysis, and root cause diagnosis. Monitors on-premises, cloud, and hybrid networks with real-time dashboards, automated alerting, and capacity forecasting.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time network topology mapping and visualization</li>
            <li>AI anomaly detection for traffic patterns and latency</li>
            <li>Flow analysis (NetFlow, sFlow, IPFIX) with deep packet inspection</li>
            <li>Automated root cause analysis for network incidents</li>
            <li>Bandwidth utilization tracking and capacity forecasting</li>
            <li>Integration with PagerDuty, Slack, ServiceNow</li>
            <li>SLA monitoring for network performance</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect network issues before users are impacted</li>
            <li>Reduce MTTR by 70% with AI root cause analysis</li>
            <li>Optimize bandwidth costs with usage insights</li>
            <li>Maintain network SLA compliance with continuous monitoring</li>
        </ul>
      </section>

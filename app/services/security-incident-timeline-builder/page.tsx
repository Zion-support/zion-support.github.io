    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Security Incident Timeline Builder</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Assembles defensible incident timelines from logs, tickets, alerts, and communication channels with blast-radius framing.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Timeline and blast-radius views</li>
            <li>Evidence linking</li>
            <li>Communication capture</li>
            <li>Recommandation and playbook notes</li>
            <li>PDF export for legal and PR</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Keep evidence defensible</li>
            <li>Accelerate stakeholder updates</li>
            <li>Support compliance and litigation</li>
        </ul>
      </section>

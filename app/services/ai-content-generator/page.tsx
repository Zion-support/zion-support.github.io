...
export const metadata = {
  title: 'Ai Content Generator | Zion Tech Group',
  description: 'Professional ai content generator solutions for modern businesses. Transform your operations with our advanced ai content generator technology.'
};
...
=======
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional ai content generator solutions for modern businesses. Transform your operations with our advanced ai content generator technology.
          </p>
        </div>
...
>>>>>>> cursor/automate-test-improve-and-merge-code-9862
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our ai content generator can help your business
          </p>
          <a
            href="/contact"
...
return (;
    <div className="p-6 bg-white rounded-xl shadow-md border border-gray-200">"
      <div className="text-4xl mb-4 text-blue-600">{icon"
}</div>
      <h3 className="text-xl font-semibold text-gray-900 mb-3">{title}</h3>"
...
return (;
    <div className={`p-8 rounded-xl border-2 ${popular ? 'border-blue-500 bg-blue-50' : 'border-gray-200 bg-white''} relative`}>`      {popular && (

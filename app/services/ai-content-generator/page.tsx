...
href="tel:+13024640950"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16" >
          <div >
            <h1 className="text-3xl font-bold text-gray-900 mb-8" >Powerful Features</h2>
...
icon="🔒"
                ...
                description="Built-in plagiarism detection ensures 100% original content with source attribution."
                benefits={["100% originality", "Source attribution", "Real-time checking", "Compliance reporting"]}
              />
            </div>
          </div>

          <div >
            <h1 className="text-3xl font-bold text-gray-900 mb-8" >Why Choose Our Platform?</h2>
            <div className="space-y-6" >
              <BenefitCard;
icon="⚡"
...
icon="💰"
                ...
                description="Reduce content creation costs by 70% while maintaining or improving quality standards."
              />
              <BenefitCard;
icon="🎯"
                title="Personalized Content"
                description="Generate personalized content for different audience segments and marketing channels."
              />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-16" >
          <h1 className="text-3xl font-bold text-gray-900 text-center mb-8" >Simple, Transparent Pricing</h2>
...
title="Enterprise"
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-12 text-center text-white" >
          <h1 className="text-4xl font-bold mb-6" >Ready to Transform Your Content Strategy?</h2>
...
function FeatureItem({ icon, title, description, benefits }: {icon: string; 
  title: string; 
  description: string}
  benefits: string[] }
}) {
  ...
  return (
    <div className="p-6 bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition-shadow" >
      ...
      <h1 className="text-xl font-semibold text-gray-900 mb-3" >{title}</h3>
...
function BenefitCard({ icon, title, description }: {icon: string; 
  title: string}
  description: string }
}) {
...
function PricingCard({ 
  ...
  return (<div className={`p-8 rounded-xl border-2 ${popular ? 'border-blue-500 bg-blue-50' : 'border-gray-200 bg-white'} relative`} >
      {popular && (
        <div className="absolute -top-4 left-1/2 transform -translate-x-1/2" >
          <span className="bg-blue-500 text-white px-4 py-2 rounded-full text-sm font-semibold" >Most Popular</span>
        </div>
      )<h1 className="text-2xl font-bold text-gray-900 mb-2" >{title}</h3>
      <div className="mb-4" >

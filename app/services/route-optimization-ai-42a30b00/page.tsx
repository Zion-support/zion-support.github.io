...
export const metadata = {
  title: "Route Optimization AI - Zion Tech Group",
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/route-optimization-ai-42a30b00`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/route-optimization-ai-42a30b00` title="Route Optimization AI" />

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS HR Leave &amp; Attendance Tracker</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Leave requests, attendance logging, shift scheduling, and payroll integration in one streamlined app. Designed for small-to-mid-sized teams that need modern HR tools without the bloat of enterprise suites.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Self-service leave requests with multi-level approval workflows and calendar sync</li>
            <li>Automated attendance logging via mobile app, web check-in, and biometric integrations</li>
            <li>Drag-and-drop shift scheduling with conflict detection and overtime alerts</li>
            <li>Payroll integration exporting hours, leave balances, and overtime to major payroll providers</li>
            <li>PTO policy engine supporting accruals, carryovers, blackout dates, and custom rules</li>
            <li>Team dashboard with attendance heatmaps, leave trends, and headcount analytics</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduces HR admin time by 70% through automated leave and attendance workflows</li>
            <li>Eliminates payroll errors with accurate, real-time hour and leave balance exports</li>
            <li>Improves employee satisfaction with transparent, self-service leave management</li>
            <li>Ensures labor law compliance with configurable policies and audit-ready reports</li>
            <li>Deploys in under a day with no IT team required — fully cloud-hosted and managed</li>
        </ul>
      </section>

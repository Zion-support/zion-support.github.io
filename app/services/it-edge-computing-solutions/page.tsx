  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/it-edge-computing-solutions` title="Edge Computing &amp; IoT Infrastructure" />
        <h1 className="text-4xl font-bold mb-6">Edge Computing &amp; IoT Infrastructure</h1>
        <p className="text-lg text-gray-300 mb-8">Deploy compute closer to your data sources with edge computing architecture — low-latency processing, distributed AI inference, and resilient IoT device managem</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with edge computing &amp; iot infrastructure</li>

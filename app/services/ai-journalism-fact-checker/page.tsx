  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Verify claims in real-time against 100M+ sources: statement verification, source credibility scoring, bias detection, and citation suggestions. Used by 50+ news</p>

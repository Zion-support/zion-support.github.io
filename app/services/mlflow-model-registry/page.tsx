    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">MLflow Model Registry</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Open-source platform for managing the complete machine learning lifecycle — experiment tracking, model versioning, deployment, and monitoring. Provides a centralized model registry with stage transitions (staging → production), A/B testing support, and reproducible pipelines that bridge the gap between data science experimentation and production deployment.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Experiment tracking: log parameters, metrics, artifacts, and compare runs across model versions</li>
            <li>Model Registry with stage transitions (None → Staging → Production → Archived) and approval workflows</li>
            <li>Reproducible ML pipelines with Docker/Kubernetes execution — any run can be re-executed identically</li>
            <li>Built-in model serving with REST API endpoints, batch inference, and A/B testing traffic splitting</li>
            <li>Integration with all major ML frameworks: PyTorch, TensorFlow, scikit-learn, XGBoost, HuggingFace</li>
            <li>Plugin architecture: extend with custom backends, storage, and deployment targets (SageMaker, Azure ML, Vertex AI)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminates </li>
            <li> ML deployment problems with reproducible, versioned pipelines</li>
            <li>Centralized model registry gives teams visibility into what</li>
            <li>,
      </li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Managed from $50/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Enterprise: SSO, RBAC, unlimited models</p>
          </div>
        </div>

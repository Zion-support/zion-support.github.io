    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Edge AI Inference &amp; IoT Intelligence Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Deploy trained AI models to edge devices, gateways, and IoT sensors with low-latency inference, model monitoring, and OTA updates. Optimize for bandwidth, compute, and power constraints.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Optimized inference runtime (ONNX, TensorRT, CoreML)</li>
            <li>Model compression and quantization for edge devices</li>
            <li>OTA model updates with A/B testing and rollback</li>
            <li>Edge-to-cloud data pipeline orchestration</li>
            <li>Model performance monitoring and drift detection</li>
            <li>Device fleet management and configuration</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Run AI inference with sub-millisecond latency at the edge</li>
            <li>Reduce bandwidth costs by 80% with on-device processing</li>
            <li>Maintain model freshness with seamless OTA updates</li>
            <li>Scale to thousands of devices with centralized management</li>
        </ul>
      </section>

...
export const metadata = {
  title: "Autonomous Inventory Director - Zion Tech Group",
  description: "Unlock unprecedented growth with Autonomous Inventory Director. This autonomous system provides document processing with zero manual intervention needed.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/autonomous-inventory-director-24dffd13`
  }
};

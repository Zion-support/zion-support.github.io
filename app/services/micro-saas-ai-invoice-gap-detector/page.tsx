    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS AI Invoice Gap Detector</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Detects missing, duplicate, and mismatched invoices across ERP, spreadsheet, and vendor payment records.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Invoice matching and gap detection</li>
            <li>Duplicate detection</li>
            <li>PO and receipt pairing</li>
            <li>Vendor exception alerts</li>
            <li>Monthly review packs</li>
            <li>ERP and bank pairing</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce AP leakage</li>
            <li>Keep vendor records clean</li>
            <li>Accelerate month-end close</li>

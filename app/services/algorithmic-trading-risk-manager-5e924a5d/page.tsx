...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/algorithmic-trading-risk-manager-5e924a5d`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/algorithmic-trading-risk-manager-5e924a5d` title="Algorithmic Trading Risk Manager" />

...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Manager Intelligent - Energy. This autonomous system provides image recognition with zero manual intervention needed.",
  alternates: {

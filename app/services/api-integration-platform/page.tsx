    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">API Integration &amp; Orchestration Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">No-code API integration platform that connects SaaS applications, databases, and services with pre-built connectors and custom API orchestration. Event-driven workflows, data transformation, and error handling.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>300+ pre-built connectors for popular SaaS and databases</li>
            <li>Visual API orchestration with drag-and-drop workflow builder</li>
            <li>Event-driven triggers with webhook and polling support</li>
            <li>Data transformation with mapping and formula engine</li>
            <li>Error handling with retry, fallback, and alert policies</li>
            <li>API mocking and testing environment for development</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Connect disparate systems without writing integration code</li>
            <li>Reduce integration development time by 80%</li>
            <li>Handle complex multi-step API orchestration visually</li>
            <li>Eliminate point-to-point integration spaghetti</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$249/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$549/mo</p>
          </div>
        </div>

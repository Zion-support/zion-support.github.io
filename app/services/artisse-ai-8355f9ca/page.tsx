...
export const metadata = {
  title: "Artisse AI - Zion Tech Group",
  description: "Artisse AI is a Hong Kong-based technology company founded by William Wu. The company developed a mobile photography application using generative artificial int",
  alternates: {
    canonical: `https://ziontechgroup.com/services/artisse-ai-8355f9ca`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Engineering Change Request Portal</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Lightweight change request platform for engineering teams. Standardizes submission, review, approval, rollout, and rollback with policy checks and audit history.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Tiered change request flows with urgency categories</li>
            <li>Review and approval routing with notifications</li>
            <li>Pre/post rollout validation checklists</li>
            <li>Rollback playbooks tied to tracked incidents</li>
            <li>Audit history with export for governance reviews</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce change-related incidents with standardized review</li>
            <li>Create repeatable governance without heavy ITSM overhead</li>
            <li>Improve communication between engineering and stakeholders</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Looking Glass Factory — Glasses-Free Holographic Displays</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Looking Glass Factory produces glasses-free holographic displays that show true 3D images viewable by multiple people simultaneously without headsets. Their displays use a proprietary light field engine that projects 45-100 perspectives of a 3D scene, creating a holographic effect visible to the naked eye. Applications span medical imaging, retail product visualization, digital signage, and creative industries.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Glasses-free 3D: view holographic content without headsets or special glasses</li>
            <li>45-100 simultaneous perspectives: multiple viewers see correct 3D from any angle</li>
            <li>Medical imaging: view CT/MRI scans as true 3D holograms for surgical planning</li>
            <li>Retail: display products as floating 3D holograms in store windows</li>
            <li>Unity/Unreal SDK: import 3D scenes directly into Looking Glass displays</li>
            <li>Portrait personal display: 6.9</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Surgeons view patient anatomy as true 3D holograms before operating</li>
            <li>Retailers increase engagement 3x with holographic product displays</li>
            <li>Designers and artists create and view 3D work without VR headset fatigue</li>
            <li>Education: students explore molecular structures, historical artifacts in 3D</li>
            <li>No motion sickness: natural viewing experience vs. VR headsets</li>
        </ul>
      </section>

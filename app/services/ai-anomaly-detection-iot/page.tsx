    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Anomaly Detection for IoT Fleets</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Real-time anomaly detection for IoT device fleets using edge ML models. Detect equipment failures, security breaches, and operational anomalies before they cause downtime.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time telemetry processing from MQTT, AMQP, HTTP protocols</li>
            <li>Unsupervised anomaly detection: no labeled data required</li>
            <li>Edge ML inference on NVIDIA Jetson, Raspberry Pi, ARM devices</li>
            <li>Custom alerting rules via SMS, email, Slack, PagerDuty</li>
            <li>Digital twin visualization of device fleet health</li>
            <li>Predictive maintenance scoring per device</li>
            <li>OTA model updates for edge deployed ML models</li>
            <li>Integration with AWS IoT, Azure IoT Hub, Google Cloud IoT</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect equipment failures 48 hours in advance on average</li>
            <li>Reduce unplanned downtime by 65% with predictive alerts</li>
            <li>Scale monitoring from 100 to 100,000 devices effortlessly</li>
            <li>Cut cloud processing costs by 80% with edge inference</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$399/mo (100 devices, cloud processing)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$1,199/mo (1,000 devices, edge inference)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$3,499/mo (10K+ devices, custom models, SLA)</p>
          </div>
        </div>

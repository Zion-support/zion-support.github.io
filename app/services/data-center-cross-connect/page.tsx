    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Cross-Connect &amp; Interconnection Services</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Provision and manage intra-facility cross-connects, inter-carrier peering, and hybrid cloud connectivity (AWS Direct Connect, Azure ExpressRoute, Google Cloud Interconnect). Layer 2 and Layer 3 circuit design.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Patch panel and fiber tray cross-connect provisioning</li>
            <li>Cloud on-ramp integration (AWS/Azure/GCP/OCI)</li>
            <li>Layer 2 EVPN and Layer 3 BGP peering design</li>
            <li>Metro Ethernet and DWavelength transport planning</li>
            <li>Bandwidth monitoring and SLA reporting</li>
            <li>Automated circuit provisioning via APIs</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce latency between tenants and cloud providers</li>
            <li>Eliminate complex VPN routing with direct cloud interconnect</li>
            <li>Speed up deployment from weeks to hours with automation</li>
            <li>Support multi-cloud architectures with consistent connectivity</li>
        </ul>
      </section>

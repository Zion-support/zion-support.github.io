    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">A/B Testing &amp; Feature Experiment Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Run experiments on features, pricing, and UX with statistical rigor. Bayesian statistics, sequential testing, and automatic winner declaration. No more waiting weeks for results — get answers 3x faster.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Bayesian A/B testing with early stopping</li>
            <li>Multivariate and split URL testing</li>
            <li>Feature flag integration for controlled rollouts</li>
            <li>Real-time results with statistical significance</li>
            <li>Segment analysis and cohort comparison</li>
            <li>Integrates with Segment, Mixpanel, GA4</li>
            <li>Collaborative experiment design workspace</li>
            <li>Experiment history and knowledge base</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Get experiment results 3x faster with Bayesian methods</li>
            <li>Reduce false positives with proper statistics</li>
            <li>Run more experiments without increasing risk</li>
            <li>Build a culture of data-driven decisions</li>
        </ul>
      </section>

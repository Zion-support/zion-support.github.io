    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Synthetic Data Generation for ML &amp; Testing</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Generate production-realistic synthetic data for ML training, privacy compliance, and QA testing. Preserve statistical distributions and edge cases without exposing PII or sensitive records.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Tabular synthetic data for ML training (CTGAN, TVAE)</li>
            <li>Image and video synthesis for CV model fine-tuning</li>
            <li>PII-safe synthetic datasets for regulated industries</li>
            <li>Statistical parity testing and bias mitigation</li>
            <li>Synthetic sensor data for IoT and industrial ML</li>
            <li>API/SDK for programmatic synthetic generation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Train ML models without compliance risk</li>
            <li>Overcome data scarcity for rare event classification</li>
            <li>Test data pipelines and ETL without touching PII</li>
            <li>Accelerate AI development cycles by 5x</li>
        </ul>
      </section>

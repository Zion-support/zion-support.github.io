    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>31 languages with industry-leading translation accuracy in blind evaluations</li>
            <li>Document translation: preserves formatting in PDF, DOCX, PPTX, and XLSX files</li>
            <li>API access: integrate DeepL translation into apps, websites, and workflows</li>
            <li>CAT tool integration: plugins for SDL Trados, memoQ, and other translation tools</li>
            <li>Data security: Pro and Enterprise plans guarantee data is deleted after translation</li>
            <li>Glossary feature: enforce consistent terminology across all translations</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>3x more accurate than competing translation engines in professional blind tests</li>
            <li>Translate entire documents while preserving layout and formatting</li>
            <li>Enterprise data security: GDPR compliant with zero data retention guarantee</li>
            <li>Reduce localization costs by 50% with AI-first translation workflows</li>
            <li>Used by 500,000+ businesses including Siemens, Sony, and the European Commission</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (500K chars/month)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$10.49/month (Pro, unlimited)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (API + team management + data security)</p>
          </div>
        </div>

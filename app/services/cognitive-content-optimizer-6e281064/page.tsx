...
export const metadata = {
  ...
  description: "Transform your Logistics operations with our Cognitive Content Optimizer. This AI-driven solution automates compliance monitoring with unprecedented accuracy an",
  alternates: {

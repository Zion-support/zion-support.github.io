...
export const metadata = {
  ...
  description: 'Bundles device, identity, access, app delivery, and experience signals into a single digital workplace health view for hybrid teams.',
  alternates: {
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Digital Workplace Suite</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Bundles device, identity, access, app delivery, and experience signals into a single digital workplace health view for hybrid teams.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Device and identity health scoring</li>
            <li>App delivery and access visibility</li>
            <li>Experience and wellness telemetry</li>
            <li>Unified ops dashboard</li>
            <li>Vendor integration templates</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce digital workplace gaps</li>
            <li>Keep hybrid operations coherent</li>
            <li>Simplify dashboard sprawl</li>
            <li>Support employee retention data</li>
        </ul>
      </section>

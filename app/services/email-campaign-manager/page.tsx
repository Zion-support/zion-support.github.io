export const metadata = {title: 'Email Campaign Manager | Zion Tech Group',description: 'Professional email campaign manager services for your business needs.',keywords: 'email-campaign-manager, services, business, technology';

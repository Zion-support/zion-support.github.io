    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI-Driven Data Center Cooling Optimization</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Machine learning models that optimize CRAC/CRAH setpoints, air distribution, and liquid cooling controls in real time. Reduce cooling energy by 20–40% while maintaining strict ASHRAE thermal envelopes.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Digital twin thermal modeling of the facility</li>
            <li>Real-time sensor ingestion (temperature, humidity, airflow)</li>
            <li>ML-based setpoint optimization with MPC control</li>
            <li>Anomaly detection for cooling equipment failures</li>
            <li>Integration with BMS/DCIM and existing PLC controls</li>
            <li>Energy savings reporting and PUE improvement tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce cooling energy consumption by 20–40%</li>
            <li>Maintain ASHRAE recommended thermal envelopes</li>
            <li>Predict cooling failures before they cause outages</li>
            <li>Document carbon reduction for ESG and sustainability reporting</li>
        </ul>
      </section>

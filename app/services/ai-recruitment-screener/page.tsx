...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-recruitment-screener',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Recruitment Screening Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Bias-aware AI recruitment platform that screens resumes, ranks candidates, and conducts initial video interview analysis. Ensures fair evaluation while reducing time-to-hire by 60%.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Resume parsing with skills extraction and experience mapping</li>
            <li>Bias detection and mitigation in screening criteria</li>
            <li>Video interview analysis with structured competency scoring</li>
            <li>Candidate ranking with explainable match scores</li>
            <li>Diversity analytics dashboard with pipeline metrics</li>
            <li>ATS integration (Greenhouse, Lever, Workday, iCIMS)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce time-to-hire by 60% with automated screening</li>
            <li>Improve quality of hire with competency-based matching</li>
            <li>Ensure fair evaluation with bias detection and removal</li>
            <li>Scale recruitment without proportional recruiter hiring</li>
        </ul>
      </section>

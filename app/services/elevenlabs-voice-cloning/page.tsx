    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">ElevenLabs — AI Voice Cloning &amp; Speech Synthesis</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">ElevenLabs is the world\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Instant voice cloning: create a digital replica of any voice from 30 seconds of audio</li>
            <li>Emotional control: adjust tone, pacing, and emotion to match context</li>
            <li>Multilingual synthesis: generate speech in 32 languages preserving voice character</li>
            <li>Voice library: access 1,000+ pre-built professional voices</li>
            <li>Real-time API: integrate voice generation into applications with sub-second latency</li>
            <li>Voice design: create entirely new synthetic voices by adjusting age, accent, and pitch</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Produce professional voiceover content 100x faster than traditional recording</li>
            <li>Clone any voice ethically with consent for personalized audio at scale</li>
            <li>Trusted by 1 million+ creators and enterprises including The New York Times and Samsung</li>
            <li>Support 32 languages with a single voice — no need for multilingual voice actors</li>
            <li>Process 10 billion+ characters per month with $200M+ in funding</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (10,000 characters/month, 3 custom voices)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$33/month (100,000 characters, 30 custom voices, commercial)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited characters, API access, dedicated infrastructure)</p>
          </div>
        </div>

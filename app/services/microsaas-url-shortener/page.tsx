    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">URL Shortener &amp; Link Management Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enterprise URL shortener with branded domains, QR codes, link analytics, and team management. Track clicks by location, device, and referrer. A/B test destination links. API-first design with webhooks for marketing automation integration.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Branded short domains (yourbrand.co)</li>
            <li>QR code generation for every link</li>
            <li>Click analytics (geo, device, referrer)</li>
            <li>A/B split testing for destinations</li>
            <li>Link expiration &amp; password protection</li>
            <li>Team workspaces &amp; role management</li>
            <li>API &amp; webhooks for automation</li>
            <li>Bulk link import via CSV</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Increase click-through rates by 34%</li>
            <li>Track campaign ROI accurately</li>
            <li>Professional branded links build trust</li>
            <li>Optimize with A/B testing data</li>

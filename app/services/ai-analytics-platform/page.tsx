    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Advanced business intelligence platform powered by AI and machine learning. 
      ...
      <div className="bg-gradient-to-r from-teal-50 to-cyan-50 border border-teal-200 rounded-xl p-8 mb-16">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Platform Capabilities</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="text-center">
            <div className="text-4xl mb-4">⚡</div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Real-time Processing</h3>
            <p className="text-gray-600">Process millions of data points in seconds</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">🎯</div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">95% Accuracy</h3>
            <p className="text-gray-600">AI predictions with industry-leading accuracy</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">🔒</div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Access insights anywhere with mobile apps</p>
          </div>
        </div>
      </div>
...
function PricingCard({ name, price, duration, features, popular }: { 
  ...
  return (
    <div className={`relative bg-white border-2 rounded-xl p-8 ${popular ? 'border-teal-500 shadow-lg' : 'border-gray-200'}`}>
      {popular && (
...
function ContactSection() {
  return (
    <div className="bg-gradient-to-r from-teal-50 to-cyan-50 border border-teal-200 rounded-xl p-8 text-center">
      <h3 className="text-2xl font-bold text-gray-900 mb-4">Ready to Unlock Your Data's Potential?</h3>
      <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
        Let's discuss your analytics needs and create an AI-powered platform that transforms your data into competitive advantage.
      </p>

...
export const metadata = {
  title: "Serverless Context-Aware Human Resources Deployment - Zion Tech Group",
  description: "Serverless deployment platform that auto-scales context-aware human resources workloads without infrastructure management.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/serverless-context-aware-human-resources-deployment-8b9ab9c2`
  }
};

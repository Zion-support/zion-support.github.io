    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Synthesia &amp; Synthetic Data Vault — AI Training Data Generation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Synthetic data generation platforms create statistically equivalent artificial datasets that preserve the patterns and relationships of real data while eliminating privacy risks. Used by Fortune 500 companies to train ML models when real data is scarce, biased, or restricted by HIPAA/GDPR. Now generating tabular data, video, text, and 3D scenes at scale.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Generative adversarial networks (GAN) and diffusion models for realistic data</li>
            <li>Statistical fidelity validation: synthetic data within 2% of real data distributions</li>
            <li>Privacy guarantee: zero-linkage attack demonstrated (K-anonymity preserved)</li>
            <li>Supports tabular, time-series, text, image, and video synthetic generation</li>
            <li>Smart imbalanced data augmentation for rare event ML training</li>
            <li>Data portability: export to Snowflake, BigQuery, Redshift, S3 formats</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Train ML models when real data is unavailable or restricted by regulation</li>
            <li>Eliminate HIPAA/GDPR exposure from training datasets</li>
            <li>Balance imbalanced datasets for fraud detection and rare disease diagnosis</li>
            <li>Reduce data acquisition costs by 95% vs manual data collection</li>
            <li>Enable cross-border data sharing without privacy policy violations</li>
        </ul>
      </section>

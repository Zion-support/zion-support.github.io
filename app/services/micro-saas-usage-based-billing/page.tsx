    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Usage-Based Billing Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Flexible usage-based and hybrid billing platform for SaaS companies. Supports metered billing, tiered pricing, overage charges, and custom pricing models. Real-time usage tracking, invoice generation, and revenue recognition. Integrates with Stripe and your product via API.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time usage metering and aggregation</li>
            <li>Flexible pricing models (tiered, volume, stairstep)</li>
            <li>Automated invoice generation and delivery</li>
            <li>Revenue recognition compliant with ASC 606</li>
            <li>Customer-facing usage dashboards and alerts</li>
            <li>Proration and mid-cycle upgrade/downgrade handling</li>
            <li>Integration with Stripe, QuickBooks, and Salesforce</li>
            <li>Dunning management and failed payment recovery</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Launch usage-based pricing without building billing infrastructure</li>
            <li>Increase revenue 20-30% with aligned pricing models</li>
            <li>Reduce billing errors and revenue leakage</li>
            <li>Give customers transparency into their usage and costs</li>
        </ul>
      </section>

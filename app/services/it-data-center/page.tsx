    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Design &amp; Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Full-service data center consulting from design to daily management. Includes site planning, power/cooling design, rack layout, equipment procurement, and 24/7 remote monitoring. Optimize for energy efficiency (PUE under 1.3), redundancy (Tier III+), and cost reduction.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Site assessment &amp; requirements analysis</li>
            <li>Power &amp; cooling design optimization</li>
            <li>Rack layout &amp; cable management</li>
            <li>Equipment procurement &amp; vendor negotiation</li>
            <li>Environmental monitoring (temp, humidity, air)</li>
            <li>24/7 remote monitoring &amp; alerting</li>
            <li>Capacity planning &amp; growth roadmaps</li>
            <li>Decommissioning &amp; migration planning</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Achieve PUE under 1.3 (industry leading)</li>
            <li>Reduce energy costs by 30-40%</li>
            <li>Plan for 10-year growth horizon</li>
            <li>Avoid costly redesigns with proper planning</li>
            <li>24/7 monitoring prevents costly outages</li>
        </ul>
      </section>

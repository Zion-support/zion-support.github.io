    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Multilingual Content Localization</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Go beyond translation — localize content for culture, context, and market. AI adapts idioms, references, humor, and formatting for each target market. Supports 50+ languages with human-in-the-loop quality assurance. Reduces localization costs by 70%.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI translation with cultural adaptation</li>
            <li>50+ language pairs supported</li>
            <li>Human-in-the-loop quality review</li>
            <li>Brand voice preservation across languages</li>
            <li>RTL and CJK language support</li>
            <li>CMS integration for automated workflows</li>
            <li>Translation memory for consistency</li>
            <li>Quality scoring per translated segment</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Launch in new markets 5x faster</li>
            <li>Reduce localization costs by 70%</li>
            <li>Maintain brand voice across all languages</li>
            <li>Avoid cultural missteps with AI that understands context</li>
        </ul>
      </section>

...
export const metadata = {
  ...
  description: "Revolutionize Media through intelligent automation. Our Performance Neural - Media leverages advanced machine learning to deliver network optimization at scale.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/performance-neural---media-2cdc9948`
  }
};

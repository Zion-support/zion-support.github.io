...
export const metadata = {
  ...
  description: "Automate ASC 606 / IFRS 15 compliance with AI. Analyzes contracts, identifies performance obligations, and generates journal entries. Integrates with ERP system",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Automate ASC 606 / IFRS 15 compliance with AI. Analyzes contracts, identifies performance obligations, and generates journal entries. Integrates with ERP system</p>

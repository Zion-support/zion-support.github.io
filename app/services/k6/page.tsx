    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">k6 Load Testing</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">k6 is a modern load testing tool, building on Load Impact</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Developer-centric with Go and JavaScript scripting API</li>
            <li>Cloud and local execution options</li>
            <li>Integrates with CI/CD pipelines (GitHub Actions, GitLab CI, Jenkins)</li>
            <li>Supports HTTP/1.1, HTTP/2, WebSocket, and more protocols</li>
            <li>Provides detailed metrics and trend analysis</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Catch performance regressions before they reach production</li>
            <li>Scale tests from a few virtual users to thousands</li>
            <li>Run tests in CI/CD for every pull request</li>
            <li>Used by Grafana Labs, Shopify, and Microsoft for performance validation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free tier (50K VUs)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

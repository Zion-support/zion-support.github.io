    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI-Powered Knowledge Base &amp; FAQ Chatbot</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">NLP-based chatbot that automatically builds and maintains your knowledge base. Generates FAQs from existing content, supports 50+ languages, and integrates with Slack and Microsoft Teams for instant employee and customer support.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>NLP-powered conversational chatbot with context-aware responses</li>
            <li>Automatic FAQ generation from documents, tickets, and knowledge articles</li>
            <li>Multi-language support for 50+ languages with auto-translation</li>
            <li>Analytics dashboard with query volume, resolution rate, and sentiment tracking</li>
            <li>Slack and Microsoft Teams integration for in-workflow support</li>
            <li>Self-learning engine that improves answers from user feedback and new content</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Deflect 70% of repetitive support tickets with instant AI answers</li>
            <li>Automatic FAQ generation keeps knowledge base current without manual effort</li>
            <li>Multi-language support enables global customer and employee self-service</li>
            <li>Analytics reveal knowledge gaps and trending support topics</li>
            <li>Slack and Teams integration puts answers where people already work</li>
        </ul>
      </section>

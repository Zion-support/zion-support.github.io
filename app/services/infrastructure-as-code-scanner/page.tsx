    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Infrastructure-as-Code Security Scanner</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">DevSecOps platform that scans Terraform, CloudFormation, Kubernetes manifests, and Ansible playbooks for security misconfigurations, compliance violations, and cost issues before deployment.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-framework support: Terraform, CloudFormation, K8s, Ansible</li>
            <li>500+ built-in security and compliance policies</li>
            <li>Custom policy creation with Rego/OPA</li>
            <li>CI/CD integration with GitHub Actions, GitLab CI, Jenkins</li>
            <li>Drift detection between code and deployed state</li>
            <li>Auto-remediation suggestions with one-click fixes</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Catch misconfigurations before they reach production</li>
            <li>Enforce security standards across all IaC repositories</li>
            <li>Reduce cloud security incidents from IaC errors</li>
            <li>Meet compliance requirements with continuous scanning</li>
        </ul>
      </section>

...
export const metadata = {
  title: "Automated Process Management #1 - Zion Tech Group",
  description: "Next-generation finance solution: Automated Process Management #1. Combines process automation with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/automated-process-management-1-a742a613`
  }
};

...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/route-optimization-ai-26d0a7eb`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/route-optimization-ai-26d0a7eb` title="Route Optimization AI" />

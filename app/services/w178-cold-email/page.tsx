...
export const metadata = {
  ...
  description: 'Cold email outreach: warmup, personalization, deliverability optimization, analytics. GDPR compliant.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/w178-cold-email',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">ColdOutreach — Cold Email Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Cold email outreach: warmup, personalization, deliverability optimization, analytics. GDPR compliant.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cold email campaign creation</li>
            <li>AI personalization and sequencing</li>
            <li>Email warmup and deliverability</li>
            <li>A/B testing for subject and content</li>
            <li>Unlimited sending accounts</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI personalization at scale</li>
            <li>Warmup improves deliverability</li>
            <li>A/B testing optimizes campaigns</li>
            <li>Unlimited sending accounts</li>
        </ul>
      </section>

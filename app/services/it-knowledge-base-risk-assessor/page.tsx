    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Knowledge Base Risk Assessor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Monitors internal docs, wikis, runbooks, and tickets for outdated instructions, access risks, and operational blind spots.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Outdated instruction detection</li>
            <li>Access-risk scoring</li>
            <li>Change signal correlation</li>
            <li>Remediation ticket creation</li>
            <li>Compliance markdown</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce knowledge rot and incident error</li>
            <li>Produce operational evidence automatically</li>
            <li>Identify hidden access exposure</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$1,249/mo</p>
          </div>
        </div>

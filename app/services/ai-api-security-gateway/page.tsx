    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI API Security Gateway &amp; Threat Protection</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Protect your APIs from abuse, data exfiltration, and business logic attacks. AI learns normal API behavior and automatically blocks anomalous requests. Includes rate limiting, schema validation, bot detection, and sensitive data masking.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI behavioral analysis of API traffic patterns</li>
            <li>Automatic blocking of anomalous requests</li>
            <li>Business logic attack detection (scraping, abuse)</li>
            <li>Rate limiting with per-endpoint granularity</li>
            <li>OpenAPI schema validation and enforcement</li>
            <li>Sensitive data masking in responses (PII, PCI)</li>
            <li>Bot detection and credential stuffing prevention</li>
            <li>Real-time alerting and SIEM integration</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Stop API abuse that WAFs miss</li>
            <li>Protect customer data from exfiltration</li>
            <li>Meet API security requirements for SOC 2 and PCI</li>
            <li>Reduce false positives with AI-powered detection</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Email Campaign Orchestrator &amp; Deliverability Suite</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">End-to-end email campaign automation with AI-powered content generation, send-time optimization, deliverability monitoring, and A/B testing. Warm up new domains, manage sender reputation, and stay out of spam.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI subject line and body generation</li>
            <li>Send-time optimization per recipient</li>
            <li>Deliverability monitoring (spam score, bounce rate)</li>
            <li>Domain warm-up and reputation management</li>
            <li>A/B testing with statistical significance</li>
            <li>List segmentation and suppression management</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Improve open rates by 35% with AI-optimized sends</li>
            <li>Protect sender reputation automatically</li>
            <li>Never land in spam with deliverability monitoring</li>
            <li>Generate email content in seconds</li>
            <li>Reach inbox at the right time for each contact</li>
        </ul>
      </section>

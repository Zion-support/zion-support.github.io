    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Energy Procurement &amp; PPA Advisory</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Navigate utility procurement, renewable PPAs, and grid-interactive demand response for data center operators. Energy benchmarking, tariff optimization, and sustainability-linked financing.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Utility tariff analysis and demand charge optimization</li>
            <li>Renewable PPA negotiation and offtake structuring</li>
            <li>Grid-interactive demand response enrollment and management</li>
            <li>Energy use intensity (EUI) benchmarking against peers</li>
            <li>Battery storage and co-location with on-site generation</li>
            <li>Carbon credit and REC accounting for ESG disclosures</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce energy spend by 10–25% through smarter procurement</li>
            <li>Lock in long-term renewable costs with PPAs</li>
            <li>Earn revenue streams through demand response participation</li>
            <li>Meet investor and customer carbon commitments with confidence</li>
        </ul>
      </section>

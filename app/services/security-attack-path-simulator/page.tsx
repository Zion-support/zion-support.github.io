    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Attack Path Simulator</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Models probable attacker paths from exposure to crown-jewel assets using graph analysis and control coverage mapping.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Asset and exposure mapping</li>
            <li>Attack path graph modeling</li>
            <li>Control coverage heatmaps</li>
            <li>Least privilege recommendations</li>
            <li>Scenario planning for threats</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Keep defenses evidence-based</li>
            <li>Prioritize high-risk paths</li>
            <li>Improve board risk communication</li>
        </ul>
      </section>

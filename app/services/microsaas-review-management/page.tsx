    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Review Management &amp; Reputation Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Monitor, manage, and respond to online reviews across Google, Yelp, TripAdvisor, and industry-specific sites. AI analyzes sentiment, suggests responses, and tracks reputation trends. Single dashboard for multi-location businesses.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-platform review monitoring (Google, Yelp, TripAdvisor, Amazon)</li>
            <li>AI sentiment analysis and trend tracking</li>
            <li>AI-suggested response generation</li>
            <li>Automated review request campaigns (SMS/email)</li>
            <li>Multi-location dashboard with comparison</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Never miss a negative review</li>
            <li>AI-suggested responses save hours</li>
            <li>Request reviews automatically at the right time</li>
            <li>Benchmark against competitors</li>
            <li>Improve star ratings and customer trust</li>
        </ul>
      </section>

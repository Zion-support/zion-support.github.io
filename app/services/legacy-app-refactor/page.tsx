  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/legacy-app-refactor` title="Legacy App Refactoring &amp; Strangler Fig" />
        <h1 className="text-4xl font-bold mb-6">Legacy App Refactoring &amp; Strangler Fig</h1>
        <p className="text-lg text-gray-300 mb-8">Strangler fig: reverse-engineer monolith deps, incrementally migrate bounded contexts to modern services with feature-flags, dual-run validation, rollback at ev</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with legacy app refactoring &amp; strangler fig</li>

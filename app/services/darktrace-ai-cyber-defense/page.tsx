    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Darktrace — Self-Learning AI Cybersecurity Defense</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Darktrace uses self-learning AI to detect and respond to cyber threats in real time across cloud, email, endpoints, and industrial systems. Unlike rule-based security tools, Darktrace\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Self-learning AI: no rules or signatures — learns your environment autonomously</li>
            <li>Real-time threat detection: identifies novel and zero-day attacks in seconds</li>
            <li>Autonomous response: Antigena automatically contains threats without human intervention</li>
            <li>Full coverage: cloud, email, endpoints, OT/ICS, and IoT from one platform</li>
            <li>Explainable AI: plain-language threat reports for security team and auditors</li>
            <li>MITRE ATT&amp;CK mapping: all detections mapped to known adversary techniques</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect threats that signature-based tools miss: novel malware, insider threats</li>
            <li>Mean time to detect reduced from 200 days to seconds</li>
            <li>Autonomous containment: stop ransomware spread in seconds, not hours</li>
            <li>Reduce SOC alert fatigue by 90% — only actionable, high-fidelity alerts</li>
            <li>Used by 6,500+ organizations including government agencies and critical infrastructure</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (30-day trial)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$50K/year (up to 500 assets)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom ($200K+/year for 10,000+ assets)</p>
          </div>
        </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Clinical Trial Management Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Streamline clinical trials with AI-powered patient recruitment, site selection, and protocol optimization. Real-time monitoring, adverse event detection, and regulatory submission automation.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI patient recruitment with EHR data matching</li>
            <li>Site selection optimization with enrollment forecasting</li>
            <li>Protocol deviation detection with automated alerts</li>
            <li>Adverse event monitoring with safety signal detection</li>
            <li>eCRF data capture with validation rules</li>
            <li>Regulatory submission document automation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Accelerate patient recruitment by 40%</li>
            <li>Reduce trial costs with optimized site selection</li>
            <li>Improve data quality with automated validation</li>
            <li>Speed regulatory submissions with auto-generated documents</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$1799/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$3999/mo</p>
          </div>
        </div>

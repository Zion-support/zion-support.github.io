...
export const metadata = {
  title: "Coordinator Self-Optimizing - Legal - Zion Tech Group",
  description: "Next-generation legal solution: Coordinator Self-Optimizing - Legal. Combines supply chain with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/coordinator-self-optimizing---legal-64272ace`
  }
};

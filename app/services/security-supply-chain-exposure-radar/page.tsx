    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Supply Chain Exposure Radar</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Monitors third-party and supplier risk across repos, build pipelines, and device fleets with exposure alerting.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Build and release pipeline telemetry</li>
            <li>Device and firmware exposure checks</li>
            <li>Alert routing by severity</li>
            <li>Incident correlation</li>
            <li>Executive exposure reports</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce third-party breach risk</li>
            <li>Keep suppliers accountable</li>
            <li>Produce defensible evidence</li>
            <li>Accelerate incident triage</li>
        </ul>
      </section>

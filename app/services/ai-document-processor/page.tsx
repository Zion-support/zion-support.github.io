    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Document Understanding Engine</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Advanced document AI platform that extracts, classifies, and structures data from any document type — PDFs, scans, forms, contracts, invoices. Goes beyond OCR with contextual understanding, table extraction, and automated workflow triggers.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-format ingestion (PDF, TIFF, JPEG, PNG, DOCX)</li>
            <li>Contextual entity extraction with custom field training</li>
            <li>Table and form structure preservation</li>
            <li>Document classification with 50+ pre-trained categories</li>
            <li>Automated workflow triggers based on extracted data</li>
            <li>Human-in-the-loop verification queue with confidence thresholds</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce manual data entry costs by up to 80%</li>
            <li>Process documents 10x faster than manual review</li>
            <li>Achieve 99%+ extraction accuracy on structured documents</li>
            <li>Scale document processing without adding headcount</li>
        </ul>
      </section>

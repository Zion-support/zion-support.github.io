    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Low-Code AI Application Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Empower business teams to build internal tools, workflows, and customer-facing apps with AI-assisted UI generation, natural language requirements, and multi-source data integration. No frontend expertise required.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Natural-language-to-UI generation and refinement</li>
            <li>Drag-and-drop workflow builder with AI actions</li>
            <li>Pre-built connectors for databases, APIs, SaaS tools</li>
            <li>Role-based access, audit logs, and enterprise security</li>
            <li>One-click deployment on cloud or self-hosted environments</li>
            <li>Embedded analytics and AI copilots inside every app</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Ship internal and customer apps in days, not months</li>
            <li>Reduce backlog by empowering non-developers to build</li>
            <li>Standardize UI/UX and security across custom tools</li>
            <li>Accelerate digital transformation with minimal engineering overhead</li>
        </ul>
      </section>

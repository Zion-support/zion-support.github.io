    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">SaaS Operations Support</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Keep SaaS operations reliable through lifecycle management, permission hygiene, integrations, usage monitoring, and renewals review tailored to business needs.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>SaaS app inventory and lifecycle management</li>
            <li>Permission audits and access hygiene</li>
            <li>Integration and automation monitoring</li>
            <li>Usage and ROI review</li>
            <li>Renewal and vendor management support</li>
            <li>Incident escalation for app-specific issues</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce shadow IT and access drift</li>
            <li>Improve SaaS ROI through active lifecycle management</li>
            <li>Simplify renewals and vendor negotiations</li>
            <li>Keep integrations reliable and documented</li>
        </ul>
      </section>

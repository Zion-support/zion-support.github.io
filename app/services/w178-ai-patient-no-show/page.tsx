    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Predict patient no-shows: risk scoring, automated reminders, overbooking optimization.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>No-show risk scoring per appointment</li>
            <li>Automated multi-channel reminders</li>
            <li>Overbooking optimization</li>
            <li>Waitlist management</li>
            <li>Rescheduling suggestions</li>
            <li>Integration with Athena, Epic, Cerner</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Automated reminders reduce manual calls</li>
            <li>Overbooking fills gaps</li>
            <li>Waitlist automation captures demand</li>
        </ul>
      </section>

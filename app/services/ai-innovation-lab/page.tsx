      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="bg-gradient-to-r from-blue-900/20 via-cyan-900/20 to-green-900/20 rounded-xl p-12 border border-blue-500/20 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <Link 
              href="/<contact" className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-blue-700 hover:to-cyan-700 transition-all shadow-lg hover:shadow-xl"
            >
              Schedule Demo
            </Link>
            <Link 
              href="/case-studies/ai-2026-neural-architecture-search-500x-<success" className="border border-white/20 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white/10 transition-all"
            >
              View Success Story
            </Link>
          </div>

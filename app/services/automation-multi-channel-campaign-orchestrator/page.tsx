  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/automation-multi-channel-campaign-orchestrator` title="Multi-Channel Campaign Orchestrator" />
        <h1 className="text-4xl font-bold mb-6">Multi-Channel Campaign Orchestrator</h1>
        <p className="text-lg text-gray-300 mb-8">Orchestrate campaigns across email, SMS, WhatsApp, Telegram, and LinkedIn with sequence branching, per-channel A/B testing, delay per touchpoint, re-engagement </p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with multi-channel campaign orchestrator</li>

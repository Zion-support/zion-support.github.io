    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Compliance Evidence Runner</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Collects, normalizes, and packages controls evidence from multiple systems into audit-ready packages with countersignature queues.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Evidence collection from integrations</li>
            <li>Normalization and tagging</li>
            <li>Exception and risk metadata</li>
            <li>Package generation by framework</li>
            <li>Review and approval routing</li>
            <li>Export for auditors and exams</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce evidence gathering time</li>
            <li>Keep packages consistent</li>
            <li>Eliminate manual folder shuffling</li>
            <li>Improve audit examiner experience</li>
        </ul>
      </section>

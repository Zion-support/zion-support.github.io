...
export const metadata = {
  title: 'Ai Healthcare Assistant | Zion Tech Group',
  description: 'Professional ai healthcare assistant solutions for modern businesses. Transform your operations with our advanced ai healthcare assistant technology.'
};
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional ai healthcare assistant solutions for modern businesses. Transform your operations with our advanced ai healthcare assistant technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our ai healthcare assistant can help your business
          </p>
          <a
            href="/contact"

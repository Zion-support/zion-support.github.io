export const metadata = {
  ...
  description: 'Revolutionary AI-powered healthcare platform that provides medical insights, patient monitoring, and automated diagnosis support for healthcare providers.',
};
...
export default function AIHealthcareAssistantPage() {
  return (
    <section>
      ...
      <p style={{ marginTop: 8, color: '#374151' }}>Transform healthcare delivery with AI that assists in diagnosis, monitors patients, and optimizes treatment plans for better outcomes.</p>
      ...
      <div style={{ marginTop: 24, padding: 16, backgroundColor: '#f0f9ff', borderRadius: 12, border: '1px solid #0ea5e9' }}>
        <h3 style={{ fontWeight: 700, color: '#0c4a6e', marginBottom: 8 }}>Healthcare Impact</h3>
        <ul style={{ color: '#0c4a6e', paddingLeft: 18 }}>
          <li>• <strong>35% reduction</strong> in diagnostic errors</li>
          <li>• <strong>50% faster</strong> diagnosis times</li>
          <li>• <strong>25% improvement</strong> in patient outcomes</li>
          <li>• <strong>40% cost savings</strong> in healthcare delivery</li>
        </ul>
      </div>
    </section>
  );

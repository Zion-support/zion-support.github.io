    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloud Migration Assessment Tool</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automated cloud migration planning platform that inventories on-premises workloads, analyzes dependencies, estimates migration effort, and generates optimized migration waves. Supports AWS, Azure, and GCP target architectures.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated agentless discovery of servers, apps, and dependencies</li>
            <li>Dependency mapping with network flow analysis</li>
            <li>Migration strategy recommendation (rehost, replatform, refactor)</li>
            <li>TCO comparison: on-prem vs cloud per workload</li>
            <li>Migration wave planning with risk and effort scoring</li>
            <li>Target architecture generation for AWS, Azure, or GCP</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate guesswork from migration planning</li>
            <li>Reduce migration risk with dependency-aware wave planning</li>
            <li>Optimize cloud costs before you migrate</li>
            <li>Accelerate migration timelines with automated assessment</li>
        </ul>
      </section>

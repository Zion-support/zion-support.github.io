    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Knowledge Base &amp; Help Center Builder</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Create a searchable, AI-powered knowledge base for your customers or internal team. Drag-and-drop editor, AI article suggestions, analytics on what customers search for, and seamless embedding in your website.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Drag-and-drop article editor</li>
            <li>AI article suggestions from support tickets</li>
            <li>Full-text search with AI understanding</li>
            <li>Analytics: popular articles, failed searches</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce support tickets by 40% with self-service</li>
            <li>AI suggests articles from real support questions</li>
            <li>Know what customers struggle with via search analytics</li>
            <li>Embed anywhere with a simple code snippet</li>
            <li>Translate to any language automatically</li>
        </ul>
      </section>

...
export const metadata = {
  title: "AI-Driven Advanced Marketing Automation - Zion Tech Group",
  description: "Intelligent marketing platform that creates advanced campaigns across channels, optimizing content and targeting.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-driven-advanced-marketing-automation-70280c1b`
  }
};

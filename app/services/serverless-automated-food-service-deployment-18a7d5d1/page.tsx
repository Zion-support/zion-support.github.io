...
export const metadata = {
  title: "Serverless Automated Food Service Deployment - Zion Tech Group",
  description: "Serverless deployment platform that auto-scales automated food service workloads without infrastructure management.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/serverless-automated-food-service-deployment-18a7d5d1`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Customer Data Platform (CDP) Setup &amp; Integration</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Implement and configure a Customer Data Platform that unifies customer data from all touchpoints. Single customer view across web, email, CRM, support, and advertising. Enable personalized marketing and analytics without engineering overhead.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>CDP deployment (Segment, mParticle, or open-source)</li>
            <li>Data source integration (web, mobile, CRM, email, ads)</li>
            <li>Identity resolution across devices and channels</li>
            <li>Audience segmentation builder</li>
            <li>Activation to marketing and analytics tools</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Create a single customer view</li>
            <li>Enable personalized marketing at scale</li>
            <li>Reduce data engineering dependency</li>
            <li>Meet privacy consent requirements</li>
        </ul>
      </section>

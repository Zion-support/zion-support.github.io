    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Employee Pulse &amp; Culture Analytics</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Weekly pulse surveys with AI-powered sentiment analysis, culture benchmarking, and engagement trend tracking. Quick 1-5 minute surveys keep a finger on organizational health. Manager-level dashboards with anonymized team insights.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Weekly pulse surveys (1-5 minutes to complete)</li>
            <li>AI sentiment analysis on open responses</li>
            <li>Culture and engagement benchmarking</li>
            <li>Manager dashboards with team insights</li>
            <li>Anonymous feedback channel</li>
            <li>Action recommendation engine</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Track culture and engagement weekly</li>
            <li>Identify teams needing support before burnout</li>
            <li>Benchmark against industry standards</li>
            <li>Anonymous channels encourage honest feedback</li>
            <li>AI recommends actions for managers</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Fraud Detection &amp; Prevention</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Real-time fraud detection for payments, accounts, and transactions. AI models trained on billions of transactions detect anomalies, synthetic identities, account takeover, and money laundering. Sub-50ms scoring API with explainable decisions for compliance teams.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time transaction scoring in under 50ms</li>
            <li>Synthetic identity detection with 99.7% accuracy</li>
            <li>Account takeover prevention with behavioral biometrics</li>
            <li>AML compliance screening and suspicious activity reports</li>
            <li>Custom fraud rules engine with visual builder</li>
            <li>Case management dashboard for fraud analysts</li>
            <li>Integration with payment processors and banking APIs</li>
            <li>Explainable AI decisions for regulatory compliance</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce fraud losses by 85% with real-time detection</li>
            <li>Minimize false positives that block legitimate customers</li>
            <li>Meet AML/BSA compliance requirements automatically</li>
            <li>Scale fraud prevention without adding headcount</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$9,999+/mo</p>
          </div>
        </div>

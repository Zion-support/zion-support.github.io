    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Identity Lifecycle Automation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automates joiner-mover-leaver identity workflows with role suggestions, policy enforcement, and audit evidence across directories and cloud apps.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Joiner-mover-leaver workflows</li>
            <li>Role and access suggestions</li>
            <li>Policy enforcement at change points</li>
            <li>Audit evidence capture</li>
            <li>Cloud app pairing</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce manual provisioning errors</li>
            <li>Keep access aligned to role</li>
            <li>Produce audit-ready evidence</li>
            <li>Support hybrid workforce safely</li>
        </ul>
      </section>

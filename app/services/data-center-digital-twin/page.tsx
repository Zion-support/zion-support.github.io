    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Digital Twin &amp; Simulation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Create physics-accurate digital twins of power, cooling, and IT infrastructure. Simulate changes before implementation, optimize capacity planning, and reduce risk with AI-driven scenario modeling.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>3D facility modeling with real-time telemetry sync</li>
            <li>Power distribution and cooling loop simulation</li>
            <li>AI-driven capacity planning and what-if analysis</li>
            <li>Change validation before physical implementation</li>
            <li>Integration with DCIM, BMS, and IT asset tools</li>
            <li>Predictive maintenance via failure scenario modeling</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Avoid costly design mistakes before deployment</li>
            <li>Plan 50+ kW rack density retrofits with confidence</li>
            <li>Reduce commissioning time by 40%</li>
            <li>Extend facility lifespan through informed upgrades</li>
        </ul>
      </section>

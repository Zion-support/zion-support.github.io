    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Code Quality &amp; Security Scanning Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Comprehensive SAST/DAST scanning, vulnerability detection, code quality metrics, and auto-fix suggestions for Python, JavaScript, Go, and Java. Integrates into CI/CD pipelines to catch bugs and security flaws before they reach production.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Static Application Security Testing (SAST) for Python, JS, Go, and Java</li>
            <li>Dynamic Application Security Testing (DAST) for running applications</li>
            <li>Code quality metrics: complexity, duplication, maintainability scoring</li>
            <li>AI-powered auto-fix suggestions with one-click patch application</li>
            <li>CI/CD pipeline integration with GitHub Actions, GitLab CI, Jenkins, and CircleCI</li>
            <li>Compliance reporting for OWASP Top 10, CWE, and custom security policies</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Catch security vulnerabilities before deployment with automated scanning</li>
            <li>Reduce code review time by 60% with AI-powered quality insights</li>
            <li>Auto-fix suggestions accelerate developer remediation workflows</li>
            <li>Unified dashboard for security and quality across all repositories</li>
            <li>Compliance-ready reports for SOC 2, ISO 27001, and internal audits</li>
        </ul>
      </section>

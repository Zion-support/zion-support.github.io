    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloud Cost Anomaly Guard</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Detects abnormal cloud spend changes by workload, region, and team with root-cause hints and budget alert routing.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Root-cause hinting</li>
            <li>Budget alert routing</li>
            <li>Blast-radius snapshots</li>
            <li>Weekly anomaly digests</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce surprise bills</li>
            <li>Keep engineering accountable</li>
            <li>Accelerate cost triage</li>
            <li>Maintain growth without runaway spend</li>
        </ul>
      </section>

export const metadata = {
  ...
  description:
    "Build powerful business automation workflows without coding. Drag-and-drop interface, 500+ integrations, and AI-powered workflow optimization.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            Drag-and-drop interface, 500+ integrations, and AI-powered workflow
            optimization.
          </p>
        </div>
...
function PricingCard({
  ...
  return (
    <div
      className={`relative border-2 rounded-xl p-8 ${popular ? "border-green-500 bg-green-50" : "border-gray-200"}`}
    >
      {popular && (
  ...
  return (
    <div className="bg-gradient-to-r from-green-600 to-blue-600 p-8 rounded-2xl text-center">
      ...
      <p className="text-xl text-green-100 mb-8 max-w-3xl mx-auto">
        Contact our automation experts to discuss your workflow needs and get a
        custom solution.
      </p>

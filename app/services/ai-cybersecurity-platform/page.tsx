...
import { CheckCircle, Star, Phone, Mail, MapPin, Zap, Shield, Lock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-slate-50">
      ...
      <section className="bg-gradient-to-r from-red-600 to-pink-600 text-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-red-100 mb-8 max-w-4xl mx-auto">
            Advanced threat detection and response with AI. Comprehensive cybersecurity platform with real-time monitoring and automated incident response.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Enterprise Security Pricing</h2>
            <p className="text-xl text-gray-600">Comprehensive protection for your organization</p>
          </div>
            ...
            <div className="bg-gradient-to-r from-red-50 to-pink-50 rounded-2xl p-8 border-2 border-red-200">
              ...
              <div className="grid md:grid-cols-3 gap-8 mb-8">
                <div className="text-center">
                  ...
                  <div className="text-gray-600">ROI (Preventing Breaches)</div>
                </div>
                <div className="text-center">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-gray-900 mb-2">3-6</div>
              ...
              <div className="text-center">
                <a 
                  href={`tel:${contactInfo.phone}`}
                  className="inline-flex items-center bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-lg text-lg font-medium transition-colors"
                >
                  <Phone className="h-5 w-5 mr-2" />
                  Start Free Trial
                </a>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Everything you need for enterprise-grade security</p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Proven Security Benefits</h2>
      ...
      <section className="py-16 bg-gradient-to-r from-red-50 to-pink-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Advanced Security Capabilities</h2>
            <p className="text-xl text-gray-600">Enterprise-grade security technology</p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Industries and organizations we protect</p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Meet industry compliance requirements</p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Leading the cybersecurity revolution</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-3xl font-bold text-red-600 mb-2">$12.4B</div>
      ...
      <section className="py-16 bg-gradient-to-r from-red-600 to-pink-600 text-white">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
            Join hundreds of enterprises that trust our AI-powered cybersecurity platform to protect their critical assets.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a 
              href={`tel:${contactInfo.phone}`}
              className="inline-flex items-center bg-white text-red-600 hover:bg-gray-100 px-8 py-4 rounded-lg text-lg font-medium transition-colors"
            >
              <Phone className="h-5 w-5 mr-2" />
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="flex items-center justify-center">
              <Phone className="h-5 w-5 mr-2" />
              <a href={`tel:${contactInfo.phone}`} className="hover:text-red-400">{contactInfo.phone}</a>
            </div>
            <div className="flex items-center justify-center">
              <Mail className="h-5 w-5 mr-2" />
              <a href={`mailto:${contactInfo.email}`} className="hover:text-red-400">{contactInfo.email}</a>
            </div>
            <div className="flex items-center justify-center">

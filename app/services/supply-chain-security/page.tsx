    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Software Supply Chain Security</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">End-to-end software supply chain security platform that scans dependencies, verifies SBOM integrity, detects malicious packages, and enforces artifact signing. Protects against dependency confusion, typosquatting, and compromised build pipelines.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>SBOM generation and continuous integrity verification</li>
            <li>Malicious package detection across npm, PyPI, Maven, NuGet</li>
            <li>Dependency confusion and typosquatting prevention</li>
            <li>Artifact signing with Sigstore/cosign integration</li>
            <li>Build pipeline provenance attestation (SLSA framework)</li>
            <li>Vendor risk scoring for third-party dependencies</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Prevent supply chain attacks before they reach production</li>
            <li>Meet CISA and executive order SBOM requirements</li>
            <li>Verify every artifact from source to deployment</li>
            <li>Reduce risk from third-party dependency vulnerabilities</li>
        </ul>
      </section>

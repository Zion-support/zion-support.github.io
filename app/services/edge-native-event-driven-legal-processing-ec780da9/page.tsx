...
export const metadata = {
  title: "Edge-Native Event-Driven Legal Processing - Zion Tech Group",
  description: "Edge-native processing layer that delivers event-driven legal insights with sub-millisecond latency.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/edge-native-event-driven-legal-processing-ec780da9`
  }
};

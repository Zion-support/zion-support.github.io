    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">CodeRabbit AI Code Review</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">CodeRabbit is an AI-powered code review assistant that integrates with GitHub, GitLab, and Bitbucket to provide context-aware, line-by-line review comments on pull requests — helping teams ship higher-quality code with less manual review overhead.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Line-by-line AI review comments on pull requests using large language models</li>
            <li>Learns your codebase conventions, style guides, and patterns over time</li>
            <li>Works with GitHub, GitLab, Bitbucket, and Azure DevOps</li>
            <li>Configurable review policies per repository, branch, and team</li>
            <li>Summarizes PR changes and flags security, correctness, and anti-pattern issues</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce code review cycle time by up to 50% with instant AI feedback</li>
            <li>Catch bugs, security vulnerabilities, and anti-patterns before merge</li>
            <li>Free up senior engineers from repetitive review tasks</li>
            <li>Adopted across thousands of open-source and enterprise repositories</li>
        </ul>
      </section>

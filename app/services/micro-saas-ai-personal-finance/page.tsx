  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">AI-powered personal finance manager that categorizes spending, predicts cash flow, and provides personalized financial advice. Like having a financial advisor i</p>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Telecommunications &amp; Carrier Coordination</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Streamline carrier onboarding, telco coordination, and meet-me room management for data centers. Carrier-neutral provisioning, circuit ordering, and SLA monitoring across multiple service providers.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Carrier-neutral meet-me room coordination</li>
            <li>Cross-connect and port provisioning management</li>
            <li>Circuit ordering and installation tracking</li>
            <li>Multi-carrier SLA monitoring and reporting</li>
            <li>Telecom inventory and cable management database</li>
            <li>Change management for carrier moves, adds, and changes</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce circuit provisioning time from weeks to days</li>
            <li>Avoid single-carrier lock-in with neutral coordination</li>
            <li>Improve SLA tracking and exception resolution</li>
            <li>Maintain accurate telecom inventory for capacity planning</li>
        </ul>
      </section>

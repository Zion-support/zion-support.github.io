...
export const metadata = {
  title: "Enterprise Self-Learning Blockchain Analytics Suite - Zion Tech Group",
  description: "Enterprise analytics suite that delivers self-learning blockchain insights with unified dashboards and reporting.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/enterprise-self-learning-blockchain-analytics-suite-9a2427b2`
  }
};

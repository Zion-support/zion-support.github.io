...
export const metadata = {
  title: "Analyzer AI - Sports - Zion Tech Group",
  description: "Next-generation sports solution: Analyzer AI - Sports. Combines quality control with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/analyzer-ai---sports-d5bdf31f`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Advanced Network &amp; Secure Access Services</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Design and operate secure, high-performance networks with SD-WAN, SASE, Zero Trust access, and traffic optimization. Improve performance while reducing security risk.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>SD-WAN design and tuning</li>
            <li>SASE policy management</li>
            <li>Secure remote access rollout</li>
            <li>Traffic optimization</li>
            <li>Branch site standardization</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Strengthen secure access controls</li>
            <li>Reduce connectivity-related incidents</li>
            <li>Simplify branch and remote operations</li>
        </ul>
      </section>

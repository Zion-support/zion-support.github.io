...
export const metadata = {title: 'Advanced Data Analytics & BI | Zion Tech Group',description: 'Transform your data into actionable insights with advanced analytics, real-time dashboards, and AI-powered business intelligence solutions.';
  title: 'Data Analytics Solutions | Zion Tech Group',description: 'Advanced data analytics solutions including business intelligence, data visualization, predictive analytics, and data engineering. Turn data into actionable insights.';
  description: 'Transform your data into actionable insights with advanced analytics, real-time dashboards, and AI-powered business intelligence solutions.',keywords: 'data analytics, business intelligence, data visualization, predictive analytics, data engineering';
}export default function DataAnalyticsPage() {return (<div className="animate-fade-in">;
            icon="⚡";
          />;
          <DataServiceCard;
  ...
  )}function DataAnalyticsBenefitCard() {return (<div className="text-center p-6 border border-gray-200 rounded-xl bg-white hover:shadow-lg transition-shadow">;
      <div className="text-4xl mb-4">{icon}</div>;
      <h3 className="text-lg font-semibold text-gray-900 mb-3">{title}</h3>;
      <p className="text-gray-600">{description}</p>;
    </div>;
  )}function Pricing() {return (<section className="mb-16">;
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
        <Plan;
          ...
          price="$5k–$15k";
          features={["2–3 weeks", "Data audit", "Requirements analysis", "Strategy roadmap", "Tool recommendations"]}popular={false}
        />;
        <Plan;
          name="Dashboard Development";
          price="$10k–$35k";
          features={["4–8 weeks", "Custom dashboards", "Data integration", "User training", "Documentation"]}popular={true}
        />;
        <Plan;
          name="Advanced Analytics";
          price="$20k–$75k";
          features={["8–16 weeks", "ML models", "Predictive analytics", "Real-time processing", "Ongoing support"]}popular={false}
        />;
      </div>;
    </section>;
  ...
  )}function CTASection() {return (<div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-8 text-center">;
      ...
      <section className="text-center py-16 bg-gradient-to-br from-purple-50 to-indigo-100 rounded-lg">;
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">;
          Transform your data into actionable insights with advanced analytics,real-time dashboards, and AI-powered business intelligence solutions.;
        </p>;
        <div className="flex flex-col sm:flex-row gap-4 justify-center">;
          <a;

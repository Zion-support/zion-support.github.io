    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Enterprise Data Catalog &amp; Discovery</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automated data catalog that discovers, profiles, and documents all data assets across the organization. Business glossary, data lineage, quality scoring, and self-service data discovery with natural language search.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated data asset discovery across databases, lakes, and warehouses</li>
            <li>Data profiling with statistical summaries and quality scores</li>
            <li>Business glossary with term definitions and ownership</li>
            <li>End-to-end data lineage with column-level granularity</li>
            <li>Natural language search across all data assets</li>
            <li>Access request workflow with approval chains</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate data silos with a searchable enterprise catalog</li>
            <li>Accelerate analytics with self-service data discovery</li>
            <li>Meet compliance requirements with documented lineage</li>
            <li>Reduce data team overhead with automated profiling</li>
        </ul>
      </section>

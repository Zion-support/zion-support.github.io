    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Customer Onboarding Automation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automate customer onboarding: welcome sequences, setup wizards, training, success milestones.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Welcome email and in-app sequences</li>
            <li>Setup wizard and configuration</li>
            <li>Training content delivery</li>
            <li>Success milestone tracking</li>
            <li>Health scoring and alerts</li>
            <li>Integration with Intercom, Pendo, Gainsight</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce time-to-value by 50%</li>
            <li>Automated sequences keep customers engaged</li>
            <li>Milestone tracking measures progress</li>
            <li>Health scoring identifies at-risk customers</li>
        </ul>
      </section>

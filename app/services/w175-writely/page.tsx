  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">AI writing assistant for business: emails, reports, proposals, and documentation. Style matching, tone adjustment, and grammar correction. Not generic — learns </p>

...
export const metadata = {
  title: "Predictor Smart - Legal - Zion Tech Group",
  description: "Next-generation legal solution: Predictor Smart - Legal. Combines quality control with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/predictor-smart---legal-fd8e1116`
  }
};

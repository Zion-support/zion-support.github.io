...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Predictive Insights for Healthcare. This autonomous system provides document processing with zero manual intervention needed.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/predictive-insights-for-healthcare-009a82ad`
  }
};

  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Enterprise financial forecasting powered by ML. Predict revenue, cash flow, expenses, and key financial metrics with scenario modeling. Integrates with ERP and </p>

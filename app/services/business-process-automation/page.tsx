    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Business Process Automation (BPA) Suite</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enterprise BPA platform that discovers, models, and automates complex business processes across departments. Combines workflow automation, document processing, and AI decision-making in one platform.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Process discovery through system log analysis</li>
            <li>Visual BPMN 2.0 process modeling with simulation</li>
            <li>AI-powered decision rules with natural language conditions</li>
            <li>Document processing with OCR and intelligent extraction</li>
            <li>Cross-department process orchestration</li>
            <li>Process analytics with bottleneck and compliance reporting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automate 60% of manual cross-functional processes</li>
            <li>Reduce process cycle times by 50%</li>
            <li>Ensure compliance with auditable process execution</li>
            <li>Continuously improve processes with analytics insights</li>
        </ul>
      </section>

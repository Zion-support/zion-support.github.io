export const metadata = {title: 'Voice Recognition | Zion Tech Group',description: 'Professional voice recognition services for your business needs.',keywords: 'voice-recognition, services, business, technology';

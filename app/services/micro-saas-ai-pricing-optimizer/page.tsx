  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">AI-powered pricing optimization for e-commerce and SaaS. Analyzes competitor pricing, demand elasticity, and customer segments to recommend optimal prices that </p>

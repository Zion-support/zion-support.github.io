...
export const metadata = {
  title: "AI-Powered Autonomous Hospitality Optimization Engine - Zion Tech Group",
  description: "AI-powered optimization engine that continuously improves autonomous hospitality performance through self-tuning algorithms.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-autonomous-hospitality-optimization-engine-fea8c047`
  }
};

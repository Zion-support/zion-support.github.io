    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Managed Print Services</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Managed Print Services is a comprehensive print infrastructure management solution that monitors printer fleets, automates supply replenishment, and tracks printing costs across the organization. It reduces print-related expenses by up to 30% while ensuring zero downtime for critical printing operations.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Fleet monitoring: real-time status monitoring of all networked printers and MFPs</li>
            <li>Supply automation: automatic toner and supply ordering when levels drop below threshold</li>
            <li>Cost tracking: detailed per-device, per-department, and per-user print cost analysis</li>
            <li>Secure printing: pull printing with badge or PIN authentication for confidential documents</li>
            <li>Remote diagnostics: proactive issue detection and remote troubleshooting</li>
            <li>Usage reporting: comprehensive reports on print volumes, trends, and optimization opportunities</li>
            <li>Environmental tracking: monitor paper consumption and carbon footprint reduction</li>
            <li>SLA management: guaranteed uptime with defined response and resolution times</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce print costs by 30% through fleet optimization and supply automation</li>
            <li>Improve IT efficiency by eliminating manual printer management tasks</li>
            <li>Scale with enterprise-grade infrastructure supporting unlimited devices and locations</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$5/device/mo (up to 20 devices, basic monitoring)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$12/device/mo (up to 200 devices, supply automation)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited devices, dedicated technician, SLA)</p>
          </div>
        </div>

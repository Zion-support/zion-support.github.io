export const metadata = {title: 'Ai Financial Analyzer | Zion Tech Group',description: 'Professional ai financial analyzer services for your business needs.',keywords: 'ai-financial-analyzer, services, business, technology';

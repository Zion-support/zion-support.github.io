...
export const metadata = {
  title: 'AI Governance & Compliance Platform | Zion Tech Group',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-governance-compliance-platform',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Governance &amp; Compliance Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Govern AI systems with policy enforcement, audit trails, bias detection, and model cards. Ensure compliance with EU AI Act, NIST AI RMF, ISO 42001, and internal AI risk policies across all models and deployments.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Model cards and lineage tracking</li>
            <li>Bias detection and fairness metrics</li>
            <li>EU AI Act and NIST AI RMF compliance dashboards</li>
            <li>Audit-ready traceability and evidence packs</li>
            <li>Risk scoring and approval workflows for high-risk AI</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Deploy AI with documented governance and audit trails</li>
            <li>Reduce compliance risk with automated evidence collection</li>
            <li>Build stakeholder trust with transparent AI operations</li>
            <li>Meet regulatory requirements before enforcement deadlines</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$899/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

...
export const metadata = {
  title: 'Ai Content Generation | Zion Tech Group',
  description: 'Professional ai content generation solutions for modern businesses. Transform your operations with our advanced ai content generation technology.'
};
...
=======
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional ai content generation solutions for modern businesses. Transform your operations with our advanced ai content generation technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our ai content generation can help your business
          </p>
          <a
            href="/contact"

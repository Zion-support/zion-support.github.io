    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Healthcare Compliance (HIPAA &amp; HITRUST)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Specialized compliance assessments, policy frameworks, and audit readiness for healthcare data centers handling PHI. HITRUST CSF, HIPAA Security Rule, and FedRAMP mapping with automated evidence collection.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>HIPAA Security Rule gap assessments for data centers</li>
            <li>HITRUST CSF certification program management</li>
            <li>Business associate agreement (BAA) development and review</li>
            <li>Audit automation and evidence collection tooling</li>
            <li>Incident response plan tailored for PHI breach scenarios</li>
            <li>Continuous monitoring and quarterly compliance reporting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Achieve HIPAA and HITRUST certification faster</li>
            <li>Reduce compliance overhead with automated evidence workflows</li>
            <li>Protect patient data with controls designed for healthcare</li>
            <li>Demonstrate security posture to auditors and regulators</li>
        </ul>
      </section>

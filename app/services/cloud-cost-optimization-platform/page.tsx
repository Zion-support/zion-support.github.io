    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Multi-Cloud Cost Optimization Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Ongoing cloud cost optimization across AWS, Azure, and GCP. Right-sizing, reserved instance planning, idle resource detection, and FinOps governance. Average 35% cost reduction.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated rightsizing recommendations for compute, storage, database</li>
            <li>Reserved instance and savings plan portfolio optimization</li>
            <li>Idle resource detection and cleanup automation</li>
            <li>Tag governance and chargeback/showback reporting</li>
            <li>Anomaly detection for unexpected cost spikes</li>
            <li>Monthly FinOps reviews with engineering teams</li>
            <li>Custom dashboards with unit economics (cost per transaction)</li>
            <li>Integration with CloudHealth, Spot.io, and native billing APIs</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce cloud spend by 35% on average within 90 days</li>
            <li>Eliminate waste from unused resources automatically</li>
            <li>Improve cost visibility with department-level chargeback</li>
            <li>Optimize reserved capacity saving $100K+ annually</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$499/mo (single cloud, up to $5K spend)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$1,499/mo (multi-cloud, up to $50K spend)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$3,999/mo (unlimited, FinOps team, SLA)</p>
          </div>
        </div>

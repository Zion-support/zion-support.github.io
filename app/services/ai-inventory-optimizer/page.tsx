    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Inventory Optimization Engine</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered inventory management platform that forecasts demand, optimizes reorder points, and balances stock across warehouses. Reduces carrying costs while preventing stockouts with probabilistic demand modeling.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Probabilistic demand forecasting with confidence intervals</li>
            <li>Multi-echelon inventory optimization across warehouses</li>
            <li>Automatic reorder point and safety stock calculation</li>
            <li>Seasonal and promotional demand modeling</li>
            <li>Supplier lead time variability analysis</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce inventory carrying costs by 20-35%</li>
            <li>Prevent stockouts with accurate demand forecasting</li>
            <li>Optimize warehouse space with intelligent stock placement</li>
            <li>Improve cash flow with right-sized inventory levels</li>
        </ul>
      </section>

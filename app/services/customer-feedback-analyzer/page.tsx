        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-gray-600">Identify pain points and opportunities to enhance customer experience</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-orange-500 mr-3 text-xl">✓</span>
            <div>
              <h3 className="font-semibold text-gray-900">Reduce Churn by 25%</h3>
              <p className="text-gray-600">Early detection of customer issues prevents cancellations</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-orange-500 mr-3 text-xl">✓</span>
            <div>
              ...
              <p className="text-gray-600">Make informed product and service improvements based on real feedback</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-orange-500 mr-3 text-xl">✓</span>
            <div>
              ...
              <p className="text-gray-600">Stay ahead by understanding customer needs and market trends</p>
            </div>
          </div>
        </div>
      </div>
...
function Plan({ name, price, features, popular = false }: { name: string; price: string; features: string[]; popular?: boolean }) {
  return (
    <div className={`border rounded-xl p-6 bg-white shadow-sm ${popular ? 'border-orange-500 ring-2 ring-orange-200' : 'border-gray-200'}`}>
      {popular && (

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Email Security, DMARC &amp; Deliverability Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Protect your domain from phishing and spoofing with DMARC, SPF, and DKIM management. Monitor email deliverability, investigate threats, and ensure legitimate emails reach the inbox. Full visibility into who is sending email using your domain.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>DMARC policy configuration and monitoring</li>
            <li>SPF and DKIM record management</li>
            <li>Email threat investigation dashboard</li>
            <li>Domain spoofing detection</li>
            <li>Deliverability monitoring for legitimate email</li>
            <li>Compliance reports (BIMI, MTA-STS)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Stop phishers from spoofing your domain</li>
            <li>Ensure your legitimate email reaches the inbox</li>
            <li>See everyone sending email using your domain</li>
            <li>Meet compliance with DMARC enforcement</li>

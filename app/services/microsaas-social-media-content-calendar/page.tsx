    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Social Media Content Calendar</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Plan, schedule, and analyze your social media presence across all major platforms from a single intuitive calendar. Our AI suggests optimal hashtags, identifies the best posting times, provides engagement analytics, and enables seamless team collaboration — so you can build your audience consistently and efficiently.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-platform scheduling for Instagram, LinkedIn, X, Facebook, and TikTok</li>
            <li>AI-powered hashtag suggestions based on content and trending topics</li>
            <li>Engagement analytics with reach, impressions, clicks, and conversion tracking</li>
            <li>Team collaboration tools with role-based access and approval workflows</li>
            <li>Content repurposing suggestions to maximize value from each piece</li>
            <li>Competitor benchmarking and performance comparison reports</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Save 10+ hours per week by batch-scheduling content across platforms</li>
            <li>Grow engagement rates with AI-optimized hashtag and timing recommendations</li>
            <li>Maintain a consistent brand presence without daily manual posting</li>
            <li>Empower team members to contribute content while maintaining quality control</li>
            <li>Measure real ROI with unified analytics across all social channels</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$69/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

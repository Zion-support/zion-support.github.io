    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Financial Close &amp; Reconciliation Automation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automate the month-end close process with AI-powered reconciliation, journal entry automation, variance analysis, and compliance documentation. Reduces close time from 10 days to 3 days. Integrates with QuickBooks, Xero, NetSuite, and SAP. Trusted by CFOs at mid-market and enterprise companies.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated intercompany reconciliation</li>
            <li>AI journal entry suggestions &amp; posting</li>
            <li>Variance analysis with anomaly flagging</li>
            <li>Close task management &amp; checklist automation</li>
            <li>Multi-GAAP/IFRS compliance support</li>
            <li>Audit trail &amp; supporting documentation</li>
            <li>ERP/accounting system integration</li>
            <li>Real-time close status dashboard</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce close time from 10 days to 3 days</li>
            <li>Eliminate manual reconciliation errors</li>
            <li>Free finance team for strategic work</li>
            <li>Always audit-ready with full documentation</li>
            <li>Standardize close process across entities</li>
        </ul>
      </section>

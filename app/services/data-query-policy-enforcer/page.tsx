    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Query Policy Enforcer</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enforces query-time access policy across data warehouses, lakes, and BI tools with near-real-time controls and usage telemetry.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Row and column policy enforcement</li>
            <li>Result masking and caching controls</li>
            <li>Usage telemetry and anomaly detection</li>
            <li>Query rewrite rules</li>
            <li>Integration with warehouses and BI</li>
            <li>Audit trail per query</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce unauthorized data exposure</li>
            <li>Keep analytics operational</li>
            <li>Produce query-level audit evidence</li>
            <li>Enable governed self-service analytics</li>
        </ul>
      </section>

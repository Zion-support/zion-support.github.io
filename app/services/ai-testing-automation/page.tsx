    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
          ...
          <p className="text-gray-600">
            Automate testing processes using AI technology to improve efficiency.
          </p>
        </div>
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
          ...
          <p className="text-gray-600">
            Perform tests quickly and efficiently with AI-powered tools.
          </p>
        </div>
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
          ...
          <p className="text-gray-600">
            Ensure comprehensive test coverage with AI-powered analysis.
          </p>
        </div>
      </div>
      ...
      <div className="text-center">
        ...
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
          Contact us today to discuss your testing automation needs and create intelligent solutions.
        </p>
        <a
          href="/contact"
          className="bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors inline-flex items-center"

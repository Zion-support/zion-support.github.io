    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Green IT Asset Lifecycle &amp; E-Waste Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Track and optimize the environmental impact of your IT assets from procurement to disposal. Carbon footprint per device, energy-efficient refresh recommendations, certified e-waste recycling, and ESG reporting.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>IT asset carbon footprint tracking</li>
            <li>Energy-efficient refresh recommendations</li>
            <li>Certified e-waste recycling coordination</li>
            <li>Hardware-as-a-Service (HaaS) optimization</li>
            <li>ESG and GRI reporting for IT assets</li>
            <li>Procurement sustainability scoring</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce IT carbon footprint by 25%</li>
            <li>Extend asset life with data-driven refresh cycles</li>
            <li>Ensure responsible e-waste disposal</li>
            <li>Meet ESG reporting requirements</li>
            <li>Save 15-20% on hardware with HaaS optimization</li>
        </ul>
      </section>

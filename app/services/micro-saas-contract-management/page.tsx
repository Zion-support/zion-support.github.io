...
export const metadata = {
  ...
  description: "Contract lifecycle management for small and medium businesses. Template library, e-signatures, renewal tracking, and AI-powered clause analysis. Integrates with",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Contract lifecycle management for small and medium businesses. Template library, e-signatures, renewal tracking, and AI-powered clause analysis. Integrates with</p>

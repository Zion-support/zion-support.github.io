    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI-Powered Sentiment Analysis for Social Media</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Real-time brand monitoring and sentiment analysis platform that tracks mentions, conversations, and trends across Twitter, Reddit, Instagram, and other social channels. Advanced NLP models deliver granular sentiment scores, emotion detection, competitor benchmarking, and trend alerts so marketing and PR teams can act on brand perception in real time.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time brand monitoring across Twitter, Reddit, Instagram, Facebook, LinkedIn, and YouTube</li>
            <li>Granular sentiment scoring (positive, negative, neutral) with emotion detection (joy, anger, fear, etc.)</li>
            <li>Competitor analysis with side-by-side sentiment benchmarking and share-of-voice tracking</li>
            <li>Trend detection with emerging topic clustering and viral content early-warning alerts</li>
            <li>Custom ML models trained on industry-specific language for higher accuracy in niche sectors</li>
            <li>Automated alerting for sentiment spikes, PR crises, and unusual mention volume changes</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect PR crises within minutes instead of hours with real-time sentiment monitoring</li>
            <li>Benchmark brand perception against competitors with quantitative share-of-voice metrics</li>
            <li>Identify emerging trends and viral opportunities before they peak</li>
            <li>Reduce manual social listening effort by 90% with automated sentiment classification</li>
            <li>Make data-driven marketing decisions backed by real audience sentiment data</li>
        </ul>
      </section>

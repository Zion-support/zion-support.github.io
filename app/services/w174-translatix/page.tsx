...
export const metadata = {
  ...
  description: "Developer-friendly app localization: string extraction, translation management, in-context editing, and automated deployment. 80+ languages with MT + human revi",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Developer-friendly app localization: string extraction, translation management, in-context editing, and automated deployment. 80+ languages with MT + human revi</p>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Contract Testing Framework</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automated data contract testing platform that validates data quality, schema, and freshness at every pipeline stage. Shift-left data testing with CI/CD integration and automatic breakage alerts.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Schema contract validation with drift detection</li>
            <li>Data quality rule testing with statistical assertions</li>
            <li>Freshness SLA monitoring with automatic alerts</li>
            <li>CI/CD integration with GitHub Actions and GitLab CI</li>
            <li>Contract versioning with backward compatibility checks</li>
            <li>Test result dashboard with trend analysis</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Catch data quality issues before they reach production</li>
            <li>Shift data testing left into the development process</li>
            <li>Reduce data incident MTTR with automated breakage alerts</li>
            <li>Build trust in data with continuous contract validation</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Automation Anywhere — Enterprise RPA &amp; AI Automation Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automation Anywhere is the world\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI-powered bots: combine RPA with generative AI for unstructured data and complex decisions</li>
            <li>No-code automation builder: citizen developers create bots with drag-and-drop designer</li>
            <li>Bot Store: 1,200+ pre-built automation templates for common business processes</li>
            <li>Enterprise governance: role-based access, audit trails, and compliance controls</li>
            <li>Process discovery: AI analyzes user actions to identify automation opportunities</li>
            <li>Cloud-native platform: deploy bots on cloud, on-prem, or hybrid with elastic scaling</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automate 80% of repetitive business processes with AI-powered bots</li>
            <li>Trusted by 4,000+ enterprises including Deloitte, Siemens, and Unilever</li>
            <li>Reduce process costs by 50-70% while improving accuracy and compliance</li>
            <li>Enable citizen developers: business users build automations without coding</li>
            <li>Scale from 1 bot to 1,000+ bots with enterprise-grade governance</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$750/month (basic bot, 1 user)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$2,500/month (unlimited bots, AI skills, 10 users)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited bots, dedicated AI training, on-prem option)</p>
          </div>
        </div>

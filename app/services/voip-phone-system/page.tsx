    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">VoIP Phone System</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">VoIP Phone System is a cloud-based business phone platform featuring auto-attendant, intelligent call routing, and deep CRM integration. It replaces legacy PBX systems with a modern, scalable communication solution that supports remote and hybrid workforces.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Auto-attendant: customizable IVR menus with professional greetings and routing</li>
            <li>Intelligent call routing: skills-based, round-robin, and time-based routing rules</li>
            <li>CRM integration: screen pops with customer data in Salesforce, HubSpot, and Zoho</li>
            <li>Call recording: automatic or on-demand call recording with searchable transcripts</li>
            <li>Video conferencing: built-in HD video meetings for up to 200 participants</li>
            <li>Mobile &amp; desktop apps: softphone apps for iOS, Android, Windows, and Mac</li>
            <li>Call analytics: real-time dashboards showing call volume, wait times, and agent performance</li>
            <li>Voicemail-to-email: automatic voicemail transcription and delivery to inbox</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce phone system costs by 50% compared to traditional PBX infrastructure</li>
            <li>Improve customer communication efficiency with intelligent call routing and CRM integration</li>
            <li>Scale with enterprise-grade infrastructure supporting unlimited users and global offices</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$18/user/mo (up to 10 users, basic calling)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$35/user/mo (up to 100 users, advanced features)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited users, custom IVR, dedicated trunk, SLA)</p>
          </div>
        </div>

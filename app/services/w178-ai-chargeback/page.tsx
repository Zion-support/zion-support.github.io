    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Chargeback Prevention</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Prevent payment chargebacks: fraud scoring, rule optimization, representment automation.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time chargeback risk scoring</li>
            <li>Rule optimization for fraud prevention</li>
            <li>Automated evidence collection</li>
            <li>Representment case building</li>
            <li>Reason code analysis</li>
            <li>Integration with Stripe, Braintree, Adyen</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce chargeback rate by 55%</li>
            <li>Real-time scoring prevents fraud</li>
            <li>Automated evidence for representment</li>
            <li>Reason code analysis identifies patterns</li>
        </ul>
      </section>

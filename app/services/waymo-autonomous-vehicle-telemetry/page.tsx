    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Waymo — Autonomous Vehicle Telemetry &amp; Fleet Intelligence</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Waymo, an Alphabet subsidiary, operates the world\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-sensor fusion: LiDAR, 29 cameras, and 6 radar units per vehicle</li>
            <li>Real-time telemetry: 20+ TB of sensor data processed per vehicle daily</li>
            <li>AI driving policy: deep learning models trained on 20M+ real-world miles</li>
            <li>Simulation platform: 20+ billion virtual miles for safety validation annually</li>
            <li>Fleet management: real-time vehicle health, routing, and passenger matching</li>
            <li>Safety reporting: 85% fewer injury-causing crashes vs. human driver baseline</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate human error: 94% of crashes involve human mistakes</li>
            <li>24/7 availability: autonomous fleets operate around the clock</li>
            <li>Reduce transportation costs by 50% vs. private car ownership</li>
            <li>Accessibility: provide mobility for elderly and disabled passengers</li>
            <li>Proven at scale: 150,000+ paid rides per week across 4 major US cities</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (ride-hailing per trip)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">Fleet partnership program</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (OEM licensing)</p>
          </div>
        </div>

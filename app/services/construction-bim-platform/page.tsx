  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/construction-bim-platform` title="AI BIM Collaboration Platform" />
        <h1 className="text-4xl font-bold mb-6">AI BIM Collaboration Platform</h1>
        <p className="text-lg text-gray-300 mb-8">AI-enhanced Building Information Modeling platform. Clash detection, design optimization, cost estimation, and 4D/5D BIM with real-time collaboration.</p>

        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Automated clash detection</li>
            <li>Design optimization AI</li>
            <li>Cost estimation from BIM models</li>
            <li>4D/5D BIM visualization</li>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce design conflicts by 80%</li>

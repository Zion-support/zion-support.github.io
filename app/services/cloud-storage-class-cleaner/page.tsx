    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Storage Class Cleaner</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Recommends storage lifecycle rules, tier transitions, and cleanup candidates to reduce cost and exposure.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Object storage inventory</li>
            <li>Lifecycle rule recommendations</li>
            <li>Cold and archive migration candidates</li>
            <li>Stale object detection</li>
            <li>Cost impact estimation</li>
            <li>Governance exception tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce unnecessary storage spend</li>
            <li>Keep data properly tiered</li>
            <li>Support retention policies</li>
            <li>Accelerate cleanup actions</li>
        </ul>
      </section>

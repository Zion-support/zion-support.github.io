...
export const metadata: Metadata = {
  ...
  description: 'Professional ai financial analytics services to help your business grow and succeed.',
  keywords: 'ai, financial, analytics, business solutions, professional services',

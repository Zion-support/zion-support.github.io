  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-16">
      ...
      <div className="bg-gradient-to-r from-cyan-50 to-blue-50 border border-cyan-200 rounded-xl p-8 mb-16">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Why Choose Our Computer Vision Solutions?</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-gray-600">State-of-the-art models with 95%+ accuracy across various use cases</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-cyan-500 mr-3 text-xl">✓</span>
            <div>
              ...
              <p className="text-gray-600">Optimized for low-latency applications with edge computing support</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-cyan-500 mr-3 text-xl">✓</span>
            <div>
              <h3 className="font-semibold text-gray-900">Custom Model Training</h3>
              <p className="text-gray-600">Tailored solutions for your specific industry and use case requirements</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-cyan-500 mr-3 text-xl">✓</span>
            <div>
              ...
              <p className="text-gray-600">Cloud and on-premise deployment options with automatic scaling</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-16 text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">Ready to See the Future?</h2>
        <p className="text-gray-600 mb-6">Start with a free consultation to explore how computer vision can transform your business.</p>
...
function Plan({ name, price, features, popular = false }: { name: string; price: string; features: string[]; popular?: boolean }) {
  return (
    <div className={`border rounded-xl p-6 bg-white shadow-sm ${popular ? 'border-cyan-500 ring-2 ring-cyan-200' : 'border-gray-200'}`}>
      {popular && (

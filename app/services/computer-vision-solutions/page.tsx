...
export const metadata = {
  title: 'Computer Vision Solutions | Zion Tech Group',
  description: 'Professional computer vision solutions solutions for modern businesses. Transform your operations with our advanced computer vision solutions technology.'
};
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional computer vision solutions solutions for modern businesses. Transform your operations with our advanced computer vision solutions technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our computer vision solutions can help your business
          </p>
          <a
            href="/contact"

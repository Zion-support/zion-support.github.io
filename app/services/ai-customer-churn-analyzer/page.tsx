    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Customer Churn Analyzer</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Predictive churn analysis platform that combines product usage, billing, support, and engagement data to identify customers at risk of leaving. Prescribes specific retention actions per customer segment.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-signal churn prediction (usage, billing, support, NPS)</li>
            <li>Customer health scoring with trend analysis</li>
            <li>Prescribed retention actions per risk segment</li>
            <li>Early warning alerts 30-60 days before likely churn</li>
            <li>Retention campaign automation with email and in-app triggers</li>
            <li>Revenue at risk forecasting with cohort comparison</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce churn by 25-45% with early intervention</li>
            <li>Prioritize CS efforts on highest-impact accounts</li>
            <li>Increase net revenue retention with proactive retention</li>
            <li>Understand root causes of churn with explainable AI</li>
        </ul>
      </section>

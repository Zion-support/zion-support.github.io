...
export const metadata = {
  ...
  description: "Next-generation legal solution: Neural Security Manager. Combines fraud prevention with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/neural-security-manager-97b0c167`
  }
};

...
export const metadata = {
  ...
  description: "Phancy Group Co., Ltd. doing business as 4Paradigm (Chinese: 第四范式; pinyin: Dìsì Fànshì) is a Chinese company publicly listed in Hong Kong that focuses on provid",
  alternates: {

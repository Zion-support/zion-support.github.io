    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Proposal &amp; Contract Generator</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Close deals faster with a streamlined proposal and contract creation platform. Choose from professionally designed templates, integrate e-signatures, set automated payment terms, and schedule follow-up reminders — turning hours of document preparation into minutes.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Library of customizable proposal and contract templates</li>
            <li>Built-in e-signature capture with Legally binding signatures</li>
            <li>Automated payment terms, invoicing, and milestone scheduling</li>
            <li>Follow-up reminder system with email and SMS notifications</li>
            <li>Client portal for proposal review, feedback, and approval</li>
            <li>Analytics dashboard tracking proposal views, time-to-sign, and win rates</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cut proposal creation time from hours to minutes with templates</li>
            <li>Increase close rates with professional, branded documents</li>
            <li>Reduce payment delays with automated term enforcement</li>
            <li>Never miss a follow-up with scheduled reminder sequences</li>
            <li>Track pipeline health with real-time proposal and contract analytics</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$89/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

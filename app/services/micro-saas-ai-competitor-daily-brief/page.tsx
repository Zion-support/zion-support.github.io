    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS AI Competitor Daily Brief</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Delivers concise competitor briefs with pricing, release, and hiring signals for operators who need timely competitive context.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Competitor monitoring feeds</li>
            <li>Pricing, release, and hiring signals</li>
            <li>Daily brief generation</li>
            <li>Signal relevance scoring</li>
            <li>Team sharing options</li>
            <li>Alerts for major changes</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce blind spots</li>
            <li>Keep strategy informed daily</li>
            <li>Accelerate competitive response</li>
            <li>Support sales and product teams</li>
        </ul>
      </section>

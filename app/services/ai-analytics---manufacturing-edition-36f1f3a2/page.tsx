  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">The future of manufacturing is here with AI Analytics - Manufacturing Edition. Powered by cutting-edge AI, this platform delivers document processing like never</p>

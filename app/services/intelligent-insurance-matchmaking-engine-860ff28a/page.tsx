...
export const metadata = {
  title: "Intelligent Insurance Matchmaking Engine - Zion Tech Group",
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligent-insurance-matchmaking-engine-860ff28a`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/intelligent-insurance-matchmaking-engine-860ff28a` title="Intelligent Insurance Matchmaking Engine" />
        <h1 className="text-4xl font-bold mb-6">Intelligent Insurance Matchmaking Engine</h1>

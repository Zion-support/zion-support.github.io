...
export const metadata = {
  title: "Smart Inventory Engine - Zion Tech Group",
  description: "Next-generation transportation solution: Smart Inventory Engine. Combines sales forecasting with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/smart-inventory-engine-af199a16`
  }
};

export const metadata = {
  ...
  description:
    'Comprehensive blockchain development including DeFi, NFTs, smart contracts, and Web3 applications. Build the future of decentralized technology.',
};
    ...
    <div className='animate-fade-in'>
      <section className='text-center py-12'>
        ...
        <p className='text-xl text-gray-600 max-w-3xl mx-auto mb-12'>
          Comprehensive blockchain development including DeFi, NFTs, smart
          contracts, and Web3 applications. Build the future of decentralized
          technology with our expert team.
        </p>
      </section>
    ...
    <section className='py-12 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg'>
      <div className='text-center'>
        ...
        <p className='text-lg text-gray-600 mb-8 max-w-2xl mx-auto'>
          Let's discuss your blockchain vision and create innovative
          decentralized solutions. Our blockchain experts have delivered 50+

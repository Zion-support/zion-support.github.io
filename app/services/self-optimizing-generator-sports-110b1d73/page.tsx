...
export const metadata = {
  ...
  description: "The future of sports is here with Self-Optimizing generator-sports. Powered by cutting-edge AI, this platform delivers threat detection like never before.",
  alternates: {

...
export const metadata = {
  title: "Insights Automated - Sports #1 - Zion Tech Group",
  description: "The future of sports is here with Insights Automated - Sports #1. Powered by cutting-edge AI, this platform delivers document processing like never before.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/insights-automated---sports-1-b80f43f5`
  }
};

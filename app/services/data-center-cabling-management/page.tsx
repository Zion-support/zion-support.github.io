    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Cabling &amp; Infrastructure Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Structured cabling, copper/fiber remediation, and patch panel management for reliable colocation and cloud connectivity. Supports TIA-606 labeling standards, move/add/change, and Panduit/Corning/Dynacom deployments.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Structured cabling design and audit</li>
            <li>Copper and fiber optic deployment</li>
            <li>Patch panel consolidation and labeling</li>
            <li>MAC (move/add/change) services</li>
            <li>TIA-606 compliance and documentation</li>
            <li>Preventive maintenance and remediation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce unplanned downtime from cable faults</li>
            <li>Improve port traceability and audit readiness</li>
            <li>Lower rack maintenance overhead</li>
            <li>Support accurate capacity planning</li>
        </ul>
      </section>

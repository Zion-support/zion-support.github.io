    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Digital Experience Monitoring (DEM)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Monitor end-user experience across web, mobile, and desktop applications. Real user monitoring, synthetic testing, and AI-powered root cause analysis for performance issues.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real user monitoring (RUM) with session replay</li>
            <li>Synthetic transaction testing from global locations</li>
            <li>AI-powered anomaly detection and root cause analysis</li>
            <li>Mobile app performance monitoring</li>
            <li>SLA tracking with automated alerting</li>
            <li>Integration with ITSM and incident management</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect performance issues before users complain</li>
            <li>Reduce MTTR with AI-powered root cause analysis</li>
            <li>Optimize user experience across all digital channels</li>
            <li>Meet SLA commitments with proactive monitoring</li>
        </ul>
      </section>

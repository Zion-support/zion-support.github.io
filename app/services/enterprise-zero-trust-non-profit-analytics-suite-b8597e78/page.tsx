...
export const metadata = {
  title: "Enterprise Zero-Trust Non-Profit Analytics Suite - Zion Tech Group",
  description: "Enterprise analytics suite that delivers zero-trust non-profit insights with unified dashboards and reporting.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/enterprise-zero-trust-non-profit-analytics-suite-b8597e78`
  }
};

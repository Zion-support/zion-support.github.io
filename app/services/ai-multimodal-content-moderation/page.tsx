    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Multimodal Content Moderation Engine</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Real-time content moderation across text, images, video, and audio using multimodal AI. Detects harmful content, hate speech, nudity, violence, and policy violations with 99.2% accuracy. Custom policy engine lets you define granular rules per community, region, and content type. Processes millions of pieces of content daily with sub-100ms latency.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multimodal analysis (text, image, video, audio) in a single API call</li>
            <li>Custom policy engine with region and community-specific rules</li>
            <li>Real-time moderation with sub-100ms p99 latency</li>
            <li>Human-in-the-loop review queue with priority scoring</li>
            <li>Automated appeal processing with AI-assisted decision support</li>
            <li>Detailed moderation analytics and trend dashboards</li>
            <li>Pre-built policy templates for major platform compliance (DSA, Online Safety)</li>
            <li>Webhook and batch processing APIs for high-volume platforms</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Moderate 10x more content without increasing headcount</li>
            <li>Reduce harmful content exposure by 99% with real-time detection</li>
            <li>Customize moderation strictness per community and jurisdiction</li>
            <li>Automate appeals to reduce moderator workload by 60%</li>
        </ul>
      </section>

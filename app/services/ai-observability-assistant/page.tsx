    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Observability Assistant</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Correlates metrics, traces, and logs into natural-language signals and recommended fixes for engineering teams.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Anomaly explanations</li>
            <li>Runbook links</li>
            <li>Brake-point analysis</li>
            <li>Change-risk scoring</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce root-cause time</li>
            <li>Keep incidents explainable</li>
            <li>Support on-call handoffs</li>
        </ul>
      </section>

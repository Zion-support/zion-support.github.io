    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloudflare Workers Serverless Edge</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Cloudflare Workers is a serverless execution platform that deploys code to Cloudflare\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Deploy JavaScript, Rust, C, and C++ to 300+ edge locations globally</li>
            <li>Zero cold starts with lightweight V8 isolates (no containers)</li>
            <li>Integrated KV storage, Durable Objects, and R2 object storage</li>
            <li>Built-in DDoS protection, WAF, and automatic SSL/TLS</li>
            <li>Cron Triggers and scheduled event support for background jobs</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Run compute at sub-millisecond latency from the nearest edge location</li>
            <li>Eliminate origin server costs for edge-eligible workloads</li>
            <li>Scale automatically to millions of requests with zero provisioning</li>
            <li>Powers production workloads at United Airlines, DoorDash, and Discord</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (100K requests/day)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$5/month (10M requests)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

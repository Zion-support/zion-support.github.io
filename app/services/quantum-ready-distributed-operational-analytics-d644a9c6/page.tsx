...
export const metadata = {
  title: "Quantum-Ready Distributed Operational Analytics - Zion Tech Group",
  description: "Quantum-ready analytics platform that prepares distributed operational workloads for future quantum acceleration.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/quantum-ready-distributed-operational-analytics-d644a9c6`
  }
};

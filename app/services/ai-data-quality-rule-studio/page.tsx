    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Data Quality Rule Studio</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Lets data owners define, test, and monitor validation rules with alerting, lineage links, and owner accountability.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Rule builder for data owners</li>
            <li>Validation scheduling and monitoring</li>
            <li>Lineage links</li>
            <li>Owner accountability and alerts</li>
            <li>Framework templates</li>
            <li>Evidence exports for analytics</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce broken dashboard incidents</li>
            <li>Make ownership explicit</li>
            <li>Produce quality evidence</li>
            <li>Speed up data onboarding</li>
        </ul>
      </section>

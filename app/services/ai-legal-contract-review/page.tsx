    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Legal Contract Review &amp; Risk Scoring</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Upload any contract — NDA, MSA, SaaS agreement, employment contract — and get an instant risk score, clause analysis, and redline suggestions. Trained on millions of legal documents. Reduces attorney review time by 70%.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Instant risk scoring on overall contract health</li>
            <li>Clause-by-clause analysis against your playbook</li>
            <li>Missing clause detection and auto-suggestions</li>
            <li>Redline suggestions with one-click accept</li>
            <li>Compare two contract versions side by side</li>
            <li>Obligation extraction and deadline tracking</li>
            <li>Multi-language contract support (20+ languages)</li>
            <li>Integration with DocuSign, CLM, and SharePoint</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Reduce outside counsel spend by up to 60%</li>
            <li>Never miss a risky clause or hidden obligation</li>
            <li>Standardize contract quality across the organization</li>
        </ul>
      </section>

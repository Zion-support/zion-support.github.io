    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Workflow &amp; Document Generator</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Generate SOPs, process documentation, training materials, and workflow diagrams automatically from screen recordings, verbal descriptions, or existing docs. Uses AI to structure, format, and keep documentation up-to-date as processes change.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Record a process — get a written SOP in minutes</li>
            <li>AI extracts steps from video and screen recordings</li>
            <li>Auto-generates flowcharts and process diagrams</li>
            <li>Keeps docs updated when processes change</li>
            <li>Multi-language documentation output</li>
            <li>Version history with change tracking</li>
            <li>Export to PDF, Confluence, Notion, Google Docs</li>
            <li>Team collaboration with review and approval</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cut documentation time by 90%</li>
            <li>Keep knowledge in the company, not just heads</li>
            <li>Onboard new employees 3x faster</li>
            <li>Maintain compliance documentation effortlessly</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Gitpod Cloud Development Environments</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Gitpod is a cloud development environment (CDE) platform that provides on-demand, fully-configured dev environments accessible from any browser. Every commit gets a pre-built workspace — eliminating </p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cloud-based VS Code, JetBrains Gateway, and Theia IDE in the browser</li>
            <li>Prebuilt workspaces start in seconds with zero local setup</li>
            <li>Native GitHub, GitLab, and Bitbucket deep integration</li>
            <li>Ephemeral or persistent workspaces with full Linux containers</li>
            <li>Dotfiles, SSH keys, extensions, and env vars pre-configured per project</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate local dev environment setup for new team members entirely</li>
            <li>Standardize tooling across the engineering organization</li>
            <li>Run builds, tests, and preview environments on every pull request </li>
            <li>Trusted by SAP, ThoughtWorks, and 800,000+ developers worldwide</li>
        </ul>
      </section>

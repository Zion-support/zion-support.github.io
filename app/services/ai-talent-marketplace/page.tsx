    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI-Powered Talent Marketplace &amp; Skills Intelligence</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Transform your HR with an internal talent marketplace. AI matches employees to projects, gigs, and mentorships based on skills, aspirations, and growth potential. Identifies skill gaps, recommends learning paths, and forecasts future talent needs.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI skills inference from work history and activity</li>
            <li>Internal project and gig matching</li>
            <li>Aspiration-based career path mapping</li>
            <li>Skill gap analysis with learning recommendations</li>
            <li>Succession planning and flight risk prediction</li>
            <li>DEI analytics and inclusive matching</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Increase internal mobility and retention by 40%</li>
            <li>Fill roles faster from within your organization</li>
            <li>Deploy talent to highest-impact projects</li>
            <li>Close skill gaps proactively with learning paths</li>

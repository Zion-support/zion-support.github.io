  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Deploy and manage applications at the edge with low-latency processing. Container orchestration, serverless functions, and data synchronization across edge loca</p>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI-Powered QA &amp; Test Automation Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automate functional, regression, and performance testing with AI-generated test scripts, visual validation, and self-healing locators. Reduce test maintenance and expand coverage without adding headcount.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI-generated test scripts from user stories and requirements</li>
            <li>Self-healing selectors resilient to UI changes</li>
            <li>Visual regression and pixel-perfect validation</li>
            <li>Cross-browser and cross-device test orchestration</li>
            <li>Performance and load testing with AI-driven test data</li>
            <li>Test analytics: flake detection, failure root-cause analysis</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce test creation time by 70% with AI-authored scripts</li>
            <li>Cut test maintenance overhead by 60% via self-healing locators</li>
            <li>Increase release velocity without sacrificing quality</li>
            <li>Catch visual regressions that traditional assertions miss</li>
        </ul>
      </section>

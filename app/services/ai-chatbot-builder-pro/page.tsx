  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/ai-chatbot-builder-pro` title="AI Chatbot Builder Pro" />
        <h1 className="text-4xl font-bold mb-6">AI Chatbot Builder Pro</h1>
        <p className="text-lg text-gray-300 mb-8">Build intelligent, multi-channel chatbots with RAG-powered knowledge bases, workflow automation, and seamless human handoff.</p>

        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>RAG-powered knowledge base from your docs</li>
            <li>Multi-channel — website, WhatsApp, Slack, Teams</li>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with ai chatbot builder pro</li>

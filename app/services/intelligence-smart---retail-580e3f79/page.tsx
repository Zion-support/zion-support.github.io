...
export const metadata = {
  ...
  description: "Next-generation retail solution: Intelligence Smart - Retail. Combines fraud prevention with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligence-smart---retail-580e3f79`
  }
};

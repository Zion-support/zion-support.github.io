...
export const metadata = {
  ...
  description: "AI-powered visual quality inspection for manufacturing: surface defects, dimension verification, color consistency, and assembly validation. 99.5% defect detect",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6">AI Visual Inspection System</h1>
        <p className="text-lg text-gray-300 mb-8">AI-powered visual quality inspection for manufacturing: surface defects, dimension verification, color consistency, and assembly validation. 99.5% defect detect</p>

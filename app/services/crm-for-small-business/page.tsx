    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">CRM for Small Business</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Simple yet powerful CRM designed for small businesses and solopreneurs. Contact management, deal tracking, email sequences, appointment scheduling, and invoicing in one affordable platform.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Contact management with custom fields and tags</li>
            <li>Deal pipeline with drag-and-drop stages and probability scoring</li>
            <li>Email sequences and templates with open/click tracking</li>
            <li>Appointment scheduling with calendar sync (Google, Outlook)</li>
            <li>Invoicing and payment collection via Stripe integration</li>
            <li>Task management with reminders and recurring tasks</li>
            <li>Mobile app for iOS and Android with offline mode</li>
            <li>Import/export from CSV, HubSpot, Salesforce migration tools</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Close 35% more deals with visual pipeline management</li>
            <li>Reduce admin time by 60% with automated follow-ups</li>
            <li>Affordable alternative to HubSpot/Salesforce at 1/5 the cost</li>
            <li>Get started in under 10 minutes with guided onboarding</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$19/user/mo (1,000 contacts)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$39/user/mo (10,000 contacts, automation)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$79/user/mo (unlimited, API, priority support)</p>
          </div>
        </div>

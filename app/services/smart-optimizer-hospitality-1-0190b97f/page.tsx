...
export const metadata = {
  title: "Smart optimizer-hospitality #1 - Zion Tech Group",
  description: "Transform your hospitality operations with our Smart optimizer-hospitality #1. This AI-driven solution automates energy management with unprecedented accuracy a",
  alternates: {
    canonical: `https://ziontechgroup.com/services/smart-optimizer-hospitality-1-0190b97f`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Precision Agriculture Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Satellite imagery, IoT sensor data, and weather models combined with AI to optimize crop yields, reduce water usage, and minimize fertilizer runoff. Provides field-level recommendations for planting, irrigation, pest management, and harvest timing. Increases yields by 15-20% while reducing input costs.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Satellite and drone imagery analysis for crop health monitoring</li>
            <li>Soil moisture and nutrient mapping with IoT sensor integration</li>
            <li>Variable rate application maps for seed, fertilizer, and pesticide</li>
            <li>Pest and disease early detection with treatment recommendations</li>
            <li>Irrigation scheduling optimization based on weather and soil data</li>
            <li>Yield prediction and harvest timing recommendations</li>
            <li>Carbon sequestration tracking and sustainability reporting</li>
            <li>Integration with major farm equipment and management software</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Increase crop yields by 15-20% with data-driven decisions</li>
            <li>Reduce water usage by 30% with precision irrigation scheduling</li>
            <li>Cut fertilizer costs by 25% with variable rate application</li>
            <li>Demonstrate sustainability practices for premium market access</li>
        </ul>
      </section>

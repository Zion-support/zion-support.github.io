    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Knowledge Transfer Runner</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Structures tacit tribal IT knowledge into reusable guides, checklists, and validation steps for turnover and growth.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Interview and capture flows</li>
            <li>Runbook generation</li>
            <li>Skill gap mapping</li>
            <li>Validation and quiz steps</li>
            <li>Document pairing</li>
            <li>Knowledge health scorecards</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce bus-factor risk</li>
            <li>Keep institutional knowledge</li>
            <li>Accelerate new-hire readiness</li>
            <li>Simplify offboarding</li>
        </ul>
      </section>

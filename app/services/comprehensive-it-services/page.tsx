  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Industry-Specific IT Solutions</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3">Healthcare IT</h3>
              <p className="text-gray-600 mb-4">
                HIPAA-compliant IT solutions for healthcare providers, hospitals, and medical practices.
              </p>
              <ul className="text-sm text-gray-600 space-y-1 mb-4">
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />HIPAA compliance</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />EMR integration</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Telemedicine platforms</li>
              </ul>
              <div className="text-sm text-gray-500">
                <span className="font-semibold">Starting at:</span> $2,500/month
              </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3">Financial Services IT</h3>
              <p className="text-gray-600 mb-4">
                Secure IT solutions for banks, credit unions, and financial institutions with regulatory compliance.
              </p>
              <ul className="text-sm text-gray-600 space-y-1 mb-4">
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />PCI DSS compliance</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Fraud detection systems</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Core banking systems</li>
              </ul>
              <div className="text-sm text-gray-500">
                <span className="font-semibold">Starting at:</span> $3,500/month
              </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3">Manufacturing IT</h3>
              <p className="text-gray-600 mb-4">
                Industrial IT solutions for smart manufacturing, IoT integration, and production optimization.
              </p>
              <ul className="text-sm text-gray-600 space-y-1 mb-4">
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />IoT integration</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Production monitoring</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Supply chain management</li>
              </ul>
              <div className="text-sm text-gray-500">
                <span className="font-semibold">Starting at:</span> $2,000/month
              </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3">Retail IT</h3>
              <p className="text-gray-600 mb-4">
                E-commerce and retail IT solutions for online stores, inventory management, and customer analytics.
              </p>
              <ul className="text-sm text-gray-600 space-y-1 mb-4">
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />E-commerce platforms</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Inventory management</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Customer analytics</li>
              </ul>
              <div className="text-sm text-gray-500">
                <span className="font-semibold">Starting at:</span> $1,800/month
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3">Education IT</h3>
              <p className="text-gray-600 mb-4">
                Educational IT solutions for schools, universities, and online learning platforms.
              </p>
              <ul className="text-sm text-gray-600 space-y-1 mb-4">
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Learning management systems</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Student information systems</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Online learning platforms</li>
              </ul>
              <div className="text-sm text-gray-500">
                <span className="font-semibold">Starting at:</span> $1,500/month
              </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <h3 className="text-xl font-semibold mb-3">Logistics IT</h3>
              <p className="text-gray-600 mb-4">
                Supply chain and logistics IT solutions for transportation, warehousing, and distribution.
              </p>
              <ul className="text-sm text-gray-600 space-y-1 mb-4">
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Supply chain management</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Fleet management systems</li>
                <li className="flex items-center"><CheckCircle className="w-4 h-4 text-green-500 mr-2" />Warehouse management</li>
              </ul>
              <div className="text-sm text-gray-500">
                <span className="font-semibold">Starting at:</span> $2,200/month
              </div>
            </div>
          </div>
        </div>

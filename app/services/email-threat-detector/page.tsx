    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Email Threat Detector</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered email security platform that detects phishing, BEC attacks, spear-phishing, and zero-day email threats. Real-time scanning of inbound and outbound mail with natural language understanding.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Blocks 99.9% of phishing attacks</li>
            <li>Prevents business email compromise</li>
            <li>Stays ahead of zero-day threats</li>
            <li>Reduces security team workload</li>
        </ul>
      </section>

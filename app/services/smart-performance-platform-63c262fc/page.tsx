...
export const metadata = {
  title: "Smart Performance Platform - Zion Tech Group",
  description: "The future of hospitality is here with Smart Performance Platform. Powered by cutting-edge AI, this platform delivers data processing like never before.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/smart-performance-platform-63c262fc`
  }
};

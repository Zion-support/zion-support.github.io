    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Climeworks — Direct Air Carbon Capture &amp; Storage</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Climeworks operates the world\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Direct air capture technology removes legacy CO₂ emissions permanently</li>
            <li>Carbfix mineralization: CO₂ turned into stone underground within 2 years</li>
            <li>Third-party verified carbon removal credits (Puro Standard certified)</li>
            <li>Modular design: each Orca unit captures 400 tons CO₂/year continuously</li>
            <li>Mammoth plant (2024): 36,000 tons/year capacity — world\\</li>
            <li>,
      </li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Meet Science-Based Targets initiative (SBTi) net-zero requirements</li>
            <li>Permanently remove historical carbon emissions — not just offset</li>
            <li>ESG report with independently verified carbon removal certificates</li>
            <li>Early mover on carbon removal as demand is projected to exceed supply 100x by 2030</li>
            <li>Removal credits qualify under Article 6 of the Paris Agreement</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$1,000/ton CO₂ removed</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$700/ton (&gt;1,000 tons/year)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$500/ton (enterprise multi-year agreements)</p>
          </div>
        </div>

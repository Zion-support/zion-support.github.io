...
export const metadata: Metadata = {
  ...
  description: 'Professional cybersecurity consulting services for your business needs.',
      ...
      <div className='container mx-auto px-4 py-16'>
        <div className='text-center mb-16'>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Professional cybersecurity consulting services for your business needs.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Contact us today to learn how our cybersecurity consulting services can transform your business.
          </p>
...
export const metadata = {
  title: 'Cybersecurity Consulting | Zion Tech Group',
  description: 'Professional cybersecurity consulting solutions for modern businesses. Transform your operations with our advanced cybersecurity consulting technology.'
};
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional cybersecurity consulting solutions for modern businesses. Transform your operations with our advanced cybersecurity consulting technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our cybersecurity consulting can help your business
          </p>
          <a
            href="/contact"

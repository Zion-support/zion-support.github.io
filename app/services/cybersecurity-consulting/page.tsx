      ...
      <div className="bg-gradient-to-r from-red-50 to-rose-50 border border-red-200 rounded-xl p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Expert Security Team</h3>
              <p className="text-gray-600">Certified professionals with 10+ years of cybersecurity experience</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-red-500 mr-3 text-xl">✓</span>
            <div>
              ...
              <p className="text-gray-600">Identify and mitigate threats before they become incidents</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-red-500 mr-3 text-xl">✓</span>
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-gray-600">Round-the-clock monitoring and incident response capabilities</p>
            </div>
          </div>
        </div>
      </div>
...
function Plan({ name, price, features, popular = false }: { name: string; price: string; features: string[]; popular?: boolean }) {
  return (
    <div className={`border rounded-xl p-6 bg-white shadow-sm ${popular ? 'border-red-500 ring-2 ring-red-200' : 'border-gray-200'}`}>
      {popular && (

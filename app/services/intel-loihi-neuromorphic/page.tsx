    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Intel Loihi 2 — Neuromorphic Computing Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Intel Loihi 2 is a neuromorphic processor that mimics the human brain\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>128 neuromorphic cores with 1 million artificial neurons per chip</li>
            <li>On-chip learning without backpropagation — 1000x energy efficiency</li>
            <li>Python-based Lava software framework for neuromorphic algorithm development</li>
            <li>Real-time sensory processing at sub-millisecond latency</li>
            <li>Supports spiking neural networks (SNNs) and biologically-inspired algorithms</li>
            <li>USB and PCIe form-factor developer kits available</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Edge AI inference at milliwatt power levels vs. watts for GPUs</li>
            <li>Real-time adaptive learning without cloud connectivity</li>
            <li>Ideal for always-on sensors, drones, and robotics</li>
            <li>Novel AI problem classes beyond traditional deep learning</li>
            <li>Research consortium membership included with enterprise programs</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Research (university program)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$50,000/development kit</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom ($200K+/program)</p>
          </div>
        </div>

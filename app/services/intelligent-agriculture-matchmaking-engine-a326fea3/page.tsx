...
export const metadata = {
  title: "Intelligent Agriculture Matchmaking Engine - Zion Tech Group",
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligent-agriculture-matchmaking-engine-a326fea3`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/intelligent-agriculture-matchmaking-engine-a326fea3` title="Intelligent Agriculture Matchmaking Engine" />
        <h1 className="text-4xl font-bold mb-6">Intelligent Agriculture Matchmaking Engine</h1>

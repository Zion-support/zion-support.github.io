    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Document Understanding API</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Extract structured data from any document type — invoices, receipts, contracts, IDs, forms — with a single API call. Pre-trained models for 50+ document types. Custom model training available. Processes documents in under 3 seconds.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Pre-trained models for 50+ document types</li>
            <li>Custom model training with your documents</li>
            <li>Confidence scores per extracted field</li>
            <li>Table and line-item extraction</li>
            <li>Handwriting recognition support</li>
            <li>Processing in under 3 seconds per page</li>
            <li>Batch processing and webhook delivery</li>
            <li>SOC2 and HIPAA compliant processing</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate manual data entry from documents</li>
            <li>Process documents 100x faster than humans</li>
            <li>Achieve 99%+ extraction accuracy out of the box</li>
            <li>Integrate document AI into any application via API</li>
        </ul>
      </section>

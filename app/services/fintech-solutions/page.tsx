...
export const metadata: Metadata = {
  ...
  description: 'Professional fintech solutions services for your business needs.',
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Professional fintech solutions services for your business needs.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Contact us today to learn how our fintech solutions services can transform your business.
          </p>

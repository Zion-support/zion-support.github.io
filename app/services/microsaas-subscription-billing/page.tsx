    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Subscription Billing &amp; Revenue Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Launch and manage recurring revenue with a lightweight subscription billing platform. Stripe and PayPal integration, dunning management, proration, usage-based billing, and revenue analytics. Designed for SaaS startups and digital product businesses.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Subscription management (create, upgrade, cancel)</li>
            <li>Automated dunning (failed payment recovery)</li>
            <li>Usage-based and tiered pricing models</li>
            <li>Proration and credit handling</li>
            <li>Revenue analytics (MRR, ARR, churn, LTV)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Launch subscription billing in days, not months</li>
            <li>Recover 15-25% more revenue with dunning</li>
            <li>Support any pricing model without engineering</li>
            <li>Real-time revenue metrics dashboard</li>
            <li>PCI-compliant — no credit card data on your servers</li>
        </ul>
      </section>

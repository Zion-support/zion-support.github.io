    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Real-Time Data Quality Monitor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Continuous data quality monitoring platform that profiles datasets, detects anomalies, and enforces quality rules across your entire data pipeline. Sends alerts before bad data reaches downstream consumers.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated profiling for new and changed datasets</li>
            <li>Rule builder with 100+ built-in quality checks</li>
            <li>Anomaly detection using statistical process control</li>
            <li>Drift monitoring for ML feature distributions</li>
            <li>Slack, PagerDuty, and email alert integrations</li>
            <li>Quality score dashboards with trend analysis</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Catch data quality issues before they reach reports</li>
            <li>Reduce time spent debugging downstream data problems</li>
            <li>Establish trust in data across the organization</li>
            <li>Meet data compliance requirements with audit trails</li>
        </ul>
      </section>

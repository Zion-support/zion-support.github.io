    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Hybrid Cloud &amp; Data Center Repatriation Services</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Seamlessly bridge on-premises data centers with public and private clouds. Migrate, repatriate, and orchestrate workloads across hybrid environments while controlling costs and maintaining compliance.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Workload assessment and placement strategy</li>
            <li>Cloud repatriation for analytics, ML, and databases</li>
            <li>Multi-cloud orchestration (AWS, Azure, GCP, on-prem)</li>
            <li>Cost governance and FinOps for hybrid environments</li>
            <li>Bandwidth optimization and egress cost control</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Lower TCO by 25% through intelligent workload placement</li>
            <li>Avoid noisy-neighbor latency with dedicated infrastructure</li>
            <li>Simplified compliance across multiple environments</li>
            <li>Predictable performance for databases and ERP systems</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Built Robotics — Autonomous Heavy Construction Equipment</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Built Robotics retrofits existing excavators, bulldozers, and skid steers with AI-powered autonomy, enabling them to dig, grade, and move earth without human operators. Their AI operator (ARI) uses GPS, LiDAR, and computer vision to execute construction plans with millimeter precision. Deployed on 100+ job sites across the US, Built Robotics addresses the construction industry\\</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Retrofit kit: converts any excavator/bulldozer to autonomous in 48 hours</li>
            <li>AI operator (ARI) executes construction plans with ±25mm accuracy</li>
            <li>24/7 operation: machines work night shifts without human operators</li>
            <li>Safety: eliminates human exposure to hazardous excavation and grading work</li>
            <li>Cloud-based fleet management: monitor all machines from a single dashboard</li>
            <li>Compatible with Caterpillar, Komatsu, John Deere, and Volvo equipment</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Address construction labor shortage: 1 autonomous machine = 3 shifts of work</li>
            <li>Zero serious safety incidents across 100+ job sites</li>
            <li>Projects completed 20-30% faster than manual operations</li>
            <li>Operators upskill to fleet management instead of leaving the industry</li>
            <li>ROI achieved within 6 months through productivity gains</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Pilot program (1 machine, 30 days)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$15,000/month per machine</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Fleet deployment (custom pricing)</p>
          </div>
        </div>

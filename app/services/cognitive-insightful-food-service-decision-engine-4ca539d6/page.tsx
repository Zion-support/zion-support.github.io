...
export const metadata = {
  title: "Cognitive Insightful Food Service Decision Engine - Zion Tech Group",
  description: "Cognitive decision engine that processes insightful signals to drive food service strategy with deep learning.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-insightful-food-service-decision-engine-4ca539d6`
  }
};

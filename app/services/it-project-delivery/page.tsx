    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Project Delivery Services</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Run infrastructure and application rollout projects with defined timelines, testing checkpoints, change management, and post-launch support periods.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Project scoping and milestone planning</li>
            <li>Implementation with staging validation</li>
            <li>Change and communication management</li>
            <li>Knowledge transfer sessions</li>
            <li>Post-launch support warranty</li>
            <li>Status reporting for stakeholders</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Deliver projects on schedule with predictable scope</li>
            <li>Reduce operational risk during infrastructure changes</li>
            <li>Keep leadership informed with concise status reporting</li>
            <li>Transfer knowledge so internal teams sustain outcomes</li>
        </ul>
      </section>

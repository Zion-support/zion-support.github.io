    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Client Portal &amp; Collaboration Hub</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Build a branded client portal in minutes. Share files, track project status, collect feedback, and communicate with clients — all in one white-labeled space. Perfect for agencies, consultants, and service businesses.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Drag-and-drop portal builder</li>
            <li>File sharing with version control</li>
            <li>Project status tracking and milestones</li>
            <li>In-portal messaging and comments</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Impress clients with a professional portal</li>
            <li>Reduce email clutter with in-portal messaging</li>
            <li>Track all client communication in one place</li>
            <li>White-label with your brand in minutes</li>
            <li>Collect approvals and feedback without back-and-forth</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$49/mo</p>
          </div>

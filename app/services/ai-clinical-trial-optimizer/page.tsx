    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Clinical Trial Optimizer</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered clinical trial management platform that optimizes patient recruitment, site selection, and protocol design. Predicts enrollment timelines, identifies at-risk sites, and recommends adaptive trial designs to accelerate drug development.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Patient recruitment matching using EHR data analysis</li>
            <li>Site performance scoring with predictive enrollment models</li>
            <li>Protocol optimization with simulation engine</li>
            <li>Risk-based monitoring with automated alerts</li>
            <li>Regulatory compliance tracking across jurisdictions</li>
            <li>Real-time dashboard with KPI tracking and forecasting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce trial timelines by up to 30%</li>
            <li>Improve recruitment rates with AI-matched patients</li>
            <li>Minimize protocol amendments with pre-trial simulation</li>
            <li>Ensure compliance across global regulatory requirements</li>
        </ul>
      </section>

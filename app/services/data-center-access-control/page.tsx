    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Access Control &amp; Compliance</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Physical security hardening for data centers: man traps, badge readers, biometric access, visitor management, and SOC/PCI-ready audit trails.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Biometric and multi-factor access</li>
            <li>Man trap and mantrap design</li>
            <li>Service entrance access hardening</li>
            <li>Visitor escort workflow</li>
            <li>Audit logging aligned with SOC/PCI requirements</li>
            <li>CCTV and door controller integration</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Prevent unauthorized physical access</li>
            <li>Meet compliance and audit requirements</li>
            <li>Enable traceable personnel movement</li>
            <li>Reduce risk with layered physical controls</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Document Classification &amp; Data Extraction</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Auto-classify documents, extract structured data with OCR, and route workflows intelligently. Eliminate manual data entry and accelerate document-driven processes across finance, legal, and operations.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automatic document classification across 50+ categories with 97% accuracy</li>
            <li>Structured data extraction from PDFs, scans, emails, and images using advanced OCR</li>
            <li>Intelligent workflow routing that assigns documents to the right team or approver</li>
            <li>Custom trainable models for industry-specific document types and templates</li>
            <li>Batch processing engine handling thousands of documents per hour</li>
            <li>Full audit trail with version history, confidence scores, and human-in-the-loop review</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cuts document processing time by 80% through end-to-end automation</li>
            <li>Reduces data-entry errors with machine-validated extraction results</li>
            <li>Speeds up approvals with smart routing that learns from past decisions</li>
            <li>Ensures compliance with tamper-evident audit logs and access controls</li>
            <li>Integrates with existing ERP, CRM, and document management systems via API</li>
        </ul>
      </section>

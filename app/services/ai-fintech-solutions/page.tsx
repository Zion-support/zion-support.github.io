...
export const metadata = {
  title: 'Ai Fintech Solutions | Zion Tech Group',
  description: 'Professional ai fintech solutions solutions for modern businesses. Transform your operations with our advanced ai fintech solutions technology.'
};
...
=======
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional ai fintech solutions solutions for modern businesses. Transform your operations with our advanced ai fintech solutions technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our ai fintech solutions can help your business
          </p>
          <a
            href="/contact"

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Site Selection &amp; Real Estate Advisory</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Evaluate and acquire data center sites with the right power, fiber, tax, and risk profiles. Fiber route analysis, utility redundancy maps, and tax incentive programs across target markets.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Power availability and latency mapping</li>
            <li>Carrier-neutral fiber route surveys and diversity analysis</li>
            <li>Tax incentive and enterprise zone qualification support</li>
            <li>Utility rate case tracking and redundancy evaluation</li>
            <li>Environmental and seismic risk assessments</li>
            <li>Zoning, permitting, and entitlement support</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce site selection risk from months to weeks</li>
            <li>Avoid costly build surprises with early utility and right-of-way analysis</li>
            <li>Maximize tax incentives for greenfield and brownfield projects</li>
            <li>Choose locations that ensure long-term operational resilience</li>
        </ul>
      </section>

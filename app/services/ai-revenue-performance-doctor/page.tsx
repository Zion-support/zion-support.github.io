    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Revenue Performance Doctor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Diagnoses revenue anomalies across pipeline, invoicing, collections, and renewals with prioritized fixes.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Pipeline anomaly scoring</li>
            <li>Invoice and AR review</li>
            <li>Collections behavior analysis</li>
            <li>Renewal gap detection</li>
            <li>Fix routing by owner</li>
            <li>Weekly revenue health brief</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Keep collections healthy</li>
            <li>Accelerate fix execution</li>
            <li>Support revenue operations</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Metrics Store &amp; Observability Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Centralized metrics store that standardizes business and technical metrics across the organization. Single source of truth for KPIs, SLOs, and operational metrics with versioning and access control.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Centralized metric definitions with versioning</li>
            <li>SLO tracking with error budget burn rate alerts</li>
            <li>Business and technical metric unification</li>
            <li>Dashboard-as-code with Git integration</li>
            <li>Access control per metric and per consumer</li>
            <li>Anomaly detection on metric trends</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate metric definition conflicts across teams</li>
            <li>Track SLOs with automated error budget management</li>
            <li>Create a single source of truth for all KPIs</li>
            <li>Version control metrics like code for reproducibility</li>
        </ul>
      </section>

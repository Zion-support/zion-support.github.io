    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Plane DevOps Project Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Open-source alternative to Jira and Linear built for modern engineering teams. Combines issue tracking, sprint planning, cycle analytics, and release management in a blazing-fast interface with AI-powered workload balancing.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Issue tracking with custom workflows and states</li>
            <li>Sprint planning with capacity forecasting</li>
            <li>Cycle time analytics and velocity tracking</li>
            <li>Release management with changelog generation</li>
            <li>AI-powered workload balancing across teams</li>
            <li>GitHub/GitLab/Bitbucket bidirectional sync</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Replace Jira with a faster, developer-friendly tool</li>
            <li>Gain real-time visibility into team velocity and bottlenecks</li>
            <li>Automate release notes and changelog generation</li>
            <li>Self-host for full data control or use managed cloud</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$0 (open source)</p>
          </div>

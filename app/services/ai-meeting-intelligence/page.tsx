...
export const metadata = {
  title: 'AI Meeting Intelligence & Action Tracking | Zion Tech Group',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/ai-meeting-intelligence',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Meeting Intelligence &amp; Action Tracking</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automatically records, transcribes, and analyzes meetings across Zoom, Teams, and Google Meet. AI generates summaries, extracts action items, tracks decisions, and follow-ups. Integrates with project management tools. Never miss an action item again. Speakers are identified, sentiment is tracked, and meeting ROI is measured.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automatic recording &amp; transcription (99% accuracy)</li>
            <li>AI-generated meeting summaries &amp; highlights</li>
            <li>Action item extraction &amp; owner assignment</li>
            <li>Decision tracking with timestamps</li>
            <li>Speaker identification &amp; talk-time analytics</li>
            <li>Sentiment &amp; engagement analysis</li>
            <li>Integration with Slack, Jira, Asana, Monday</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Save 5+ hours per week on meeting notes</li>
            <li>Never lose track of action items</li>
            <li>Make meetings searchable and accountable</li>
            <li>Reduce unnecessary meetings by 30%</li>
            <li>Onboard new teammates with meeting history</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$29/user/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$49/user/mo</p>
          </div>
        </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloud Continuity Plan Tester</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Simulates outages, data-loss scenarios, and key-service failures to validate recovery procedures, RTO, and RPO targets.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Outage scenario simulation</li>
            <li>Data loss drill automation</li>
            <li>RTO and RPO measurement</li>
            <li>Key-service dependency mapping</li>
            <li>Runbook validation</li>
            <li>Evidence and gap reports</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce recovery guesswork</li>
            <li>Validate true recovery capability</li>
            <li>Keep RTO and RPO credible</li>
            <li>Produce actional improvement lists</li>
        </ul>
      </section>

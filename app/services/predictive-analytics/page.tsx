        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-gray-600">Advanced ML models deliver highly accurate predictions across industries</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-violet-500 mr-3 text-xl">✓</span>
            <div>
              ...
              <p className="text-gray-600">Get instant predictions and recommendations as data changes</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-violet-500 mr-3 text-xl">✓</span>
            <div>
              ...
              <p className="text-gray-600">Tailored models for your specific business needs and industry</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-violet-500 mr-3 text-xl">✓</span>
...
function Plan({ name, price, features, popular = false }: { name: string; price: string; features: string[]; popular?: boolean }) {
  return (
    <div className={`border rounded-xl p-6 bg-white shadow-sm ${popular ? 'border-violet-500 ring-2 ring-violet-200' : 'border-gray-200'}`}>
      {popular && (

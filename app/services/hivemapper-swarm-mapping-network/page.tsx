    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Hivemapper — Decentralized Swarm Mapping Network</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Hivemapper operates a community-driven global mapping network using 100,000+ dashcam-equipped vehicles that collectively build and update maps in real time. Its swarm intelligence processes crowd-sourced video into 3D map tiles, detecting road changes, signage, and construction faster than any centralized mapping provider.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>100,000+ crowd-sourced mapping vehicles across 50+ countries</li>
            <li>AI-powered change detection: identifies new construction, signs, detours in &lt;24 hours</li>
            <li>Decentralized processing: video processed on-device and at edge nodes</li>
            <li>Map data available in 3D mesh and standard HD map formats</li>
            <li>Token-incentivized contributor network ensures continuous coverage</li>
            <li>API integration for autonomous vehicle fleet operators and logistics platforms</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Maps updated 150x faster than Google Street View</li>
            <li>Reduce autonomous vehicle mapping costs by 90%</li>
            <li>Hyperlocal road condition data for insurance and municipal planning</li>
            <li>Privacy-first: personal identifying information processed at edge</li>
            <li>Open mapping ecosystem prevents vendor lock-in</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (map consumer app)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$499/hardware kit</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$50,000+/year (map data license)</p>
          </div>
        </div>

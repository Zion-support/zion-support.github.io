...
export const metadata = {
  ...
  keywords: 'ai-invoice-generator, invoice automation, billing, AI services'
};
...
<<<<<<< HEAD
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Automate your invoicing process with AI-powered generation that creates professional 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <h2 className="text-3xl font-bold text-white mb-6">Why Choose Our AI Invoice Generator?</h2>
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Create invoices automatically from project data</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center mr-4 mt-1">
                ...
                <div>
                  ...
                  <p className="text-gray-300">AI-optimized templates for different business types</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center mr-4 mt-1">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Error Detection</h3>
                  <p className="text-gray-300">Automatically detect and fix common invoice errors</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Start generating professional invoices automatically with our AI-powered solution.
          </p>

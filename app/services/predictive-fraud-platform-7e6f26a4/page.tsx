...
export const metadata = {
  title: "Predictive Fraud Platform - Zion Tech Group",
  description: "The future of gaming is here with Predictive Fraud Platform. Powered by cutting-edge AI, this platform delivers inventory management like never before.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/predictive-fraud-platform-7e6f26a4`
  }
};

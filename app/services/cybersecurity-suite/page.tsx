...
;
export const metadata = {title: 'Cybersecurity Suite | Zion Tech Group',description: 'Comprehensive cybersecurity solutions including threat detection, vulnerability assessment, and security monitoring.',keywords: 'cybersecurity, threat detection, vulnerability assessment, security monitoring, penetration testing';
}export default function CybersecuritySuitePage() {return (</div>;
    </div>;
  )}</li>;
        ))}
      </ul>;
  ...
  )}function SecurityServicesSection() {const services = [;
    {title: "Security Assessment",description: "Comprehensive evaluation of your current security posture",duration: "2-4 weeks",price: "Starting at $15,000";
    },{title: "Penetration Testing",description: "Simulated cyber attacks to identify vulnerabilities",duration: "1-2 weeks",price: "Starting at $8,000";
    },{title: "Compliance Audit",description: "Ensure compliance with industry regulations and standards",duration: "3-6 weeks",price: "Starting at $25,000";
    },{title: "Security Training",description: "Employee cybersecurity awareness and training programs",duration: "Ongoing",price: "Starting at $5,000/month";
    },{title: "Incident Response",description: "Rapid response and recovery from security incidents",duration: "24/7",price: "Starting at $10,000/month";
    },{title: "Managed Security",description: "Complete outsourced security operations and monitoring",duration: "Ongoing",price: "Starting at $15,000/month";
    }
  ];return (<div className="bg-white rounded-2xl p-8 mb-16">;
      <h2 className="text-3xl font-bold text-gray-900 text-center mb-8">Security Services</h2>;
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">;
        {services.map((service, index) => (<div key={index} className="border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">;
  ...
  )}function PricingSection() {return (<div className="bg-white rounded-2xl p-8 mb-16">;
  ...
  )}function PricingCard() {return (<div className={`relative border-2 rounded-xl p-8 ${popular ? 'border-red-500 bg-red-50' : 'border-gray-200'}`}>;
  ...
  )}function ContactSection() {return (<div className="bg-gradient-to-r from-red-600 to-pink-600 p-8 rounded-2xl text-center">;

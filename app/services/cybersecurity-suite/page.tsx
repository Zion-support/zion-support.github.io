...
export const metadata: Metadata = {
  ...
  description:
    'Comprehensive cybersecurity solutions including security assessments, penetration testing, compliance audits, and managed security services.',
  keywords:
    'cybersecurity, security assessment, penetration testing, compliance, managed security, incident response',
};

...
export const metadata = {
  title: "Intelligent insights-healthcare #1 - Zion Tech Group",
  description: "Revolutionize healthcare through intelligent automation. Our Intelligent insights-healthcare #1 leverages advanced machine learning to deliver document processi",
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligent-insights-healthcare-1-433c2fec`
  }
};

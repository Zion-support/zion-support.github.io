    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Customer Journey Orchestration Engine</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Orchestrate personalized, multi-channel customer journeys powered by AI. Analyzes real-time behavior to determine the next best action across email, SMS, push, in-app, and web. AI optimizes timing, channel, and message for each individual. Increases engagement by 40% and conversion by 25%.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Visual journey builder with drag-and-drop workflow designer</li>
            <li>AI next-best-action engine for real-time personalization</li>
            <li>Multi-channel execution (email, SMS, push, in-app, web, direct mail)</li>
            <li>Behavioral trigger engine with sub-second response time</li>
            <li>Journey analytics with attribution and incrementality measurement</li>
            <li>A/B and multi-armed bandit testing for journey optimization</li>
            <li>Integration with CDP, CRM, and analytics platforms</li>
            <li>Consent management and preference center integration</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Increase customer engagement by 40% with personalized journeys</li>
            <li>Boost conversion rates by 25% with AI-optimized timing and channel</li>
            <li>Reduce manual campaign management by 60% with automated journeys</li>
            <li>Measure true incrementality of every journey touchpoint</li>
        </ul>
      </section>

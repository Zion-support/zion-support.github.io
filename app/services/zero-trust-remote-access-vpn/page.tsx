    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Zero-Trust Remote Access VPN Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Identity-based zero-trust remote access replacing legacy VPN. Device posture verification, split tunneling, full audit logging, and MFA enforcement ensure secure access from any device, anywhere. No network-level trust — every session is verified.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Identity-based access control integrated with Okta, Entra ID, and Google Workspace</li>
            <li>Device posture verification: OS patch level, disk encryption, EDR status</li>
            <li>Split tunneling for optimal performance with corporate and internet traffic routing</li>
            <li>Full audit logging of all access events with SIEM integration</li>
            <li>Maptive multi-factor authentication enforcement per application and per session</li>
            <li>Per-application access policies with no lateral network movement</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Replace legacy VPN with modern zero-trust architecture</li>
            <li>Device posture checks block non-compliant devices before access is granted</li>
            <li>Split tunneling improves user experience and reduces bandwidth costs</li>
            <li>Complete audit trail supports compliance and incident investigation</li>
            <li>Per-application access eliminates lateral movement attack surface</li>
        </ul>
      </section>

  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/micro-saas-white-label-sso` title="White-Label SSO &amp; Identity Provider" />
        <h1 className="text-4xl font-bold mb-6">White-Label SSO &amp; Identity Provider</h1>
        <p className="text-lg text-gray-300 mb-8">Embeddable single sign-on solution for SaaS platforms. Multi-tenant identity management, social login, MFA, and self-service branding for your customers.</p>

        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Multi-tenant SSO</li>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce auth dev time by 80%</li>

...
export const metadata: Metadata = {
  ...
  description: 'Professional qa testing services for your business needs.',
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Professional qa testing services for your business needs.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Contact us today to learn how our qa testing services can transform your business.
          </p>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Autonomous Database Tuning &amp; Optimization</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered database optimization that continuously monitors, tunes, and repairs database performance. Auto-index creation, query optimization, and anomaly detection for PostgreSQL, MySQL, SQL Server, and MongoDB.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Auto-index creation and removal</li>
            <li>Query plan analysis and optimization</li>
            <li>Anomaly detection and alerting</li>
            <li>Multi-engine support (Postgres, MySQL, SQL Server, MongoDB)</li>
            <li>Automated VACUUM and maintenance scheduling</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Improve query performance by up to 5x</li>
            <li>Eliminate manual index tuning</li>
            <li>Detect performance anomalies before outages</li>
            <li>Reduce database costs with right-sizing</li>

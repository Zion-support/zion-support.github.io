    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">API Rate Limiter</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Advanced rate limiting and traffic shaping for APIs. Supports token bucket, sliding window, and concurrent request limits with real-time dashboards.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Token bucket algo</li>
            <li>Sliding window</li>
            <li>Concurrent limits</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Prevents API abuse automatically</li>
            <li>Fair resource allocation across tenants</li>
            <li>Real-time traffic visibility</li>
            <li>Custom policies per endpoint</li>
        </ul>
      </section>

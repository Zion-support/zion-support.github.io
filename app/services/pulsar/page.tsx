    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Apache Pulsar Event Streaming</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Apache Pulsar is a cloud-native, distributed messaging and streaming platform built for geo-replication, multi-tenancy, and high performance.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-tenancy and geo-replication built-in</li>
            <li>Separation of compute and storage for independent scaling</li>
            <li>Schema Registry for data validation and evolution</li>
            <li>Functions and IO connectors for lightweight stream processing</li>
            <li>Native Kubernetes operator for easy deployment and management</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate data silos with seamless cross-region and cross-cloud streaming</li>
            <li>Reduce operational overhead with serverless streaming architecture</li>
            <li>Ensure data quality and compatibility with schema evolution</li>
            <li>Used by Splunk, Tencent, and Yahoo! for mission-critical event streaming</li>
        </ul>
      </section>

    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="mt-12 bg-gradient-to-r from-gray-50 to-blue-50 p-8 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <a href="/services/ai-autonomous-cloud-ops" className="block p-6 bg-white border border-gray-200 rounded-lg hover:border-blue-500 transition-colors">
          ...
          <a href="/services/ai-2026-enterprise-transformation" className="block p-6 bg-white border border-gray-200 rounded-lg hover:border-blue-500 transition-colors">
          ...
          <a href="/services/ai-2027-breakthrough-solutions" className="block p-6 bg-white border border-gray-200 rounded-lg hover:border-blue-500 transition-colors">

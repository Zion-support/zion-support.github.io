        ...
        <div className="lg:col-span-1">
          <div className="sticky top-8">
            <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-6 rounded-lg mb-6">
              ...
              <div className="space-y-4">
                <Link 
                  href="/<contact" className="block w-full bg-white text-indigo-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-center"
                >
                  Request Consultation
                </Link>
                <Link 
                  href="/case-studies/ai-2027-quantum-breakthrough-<success" className="block w-full border-2 border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-indigo-600 transition-colors text-center"
                >
                  View Success Story
                </Link>
              </div>

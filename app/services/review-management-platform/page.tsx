...
export const metadata = {
  ...
  description: "Monitor, collect, and manage online reviews across Google, Yelp, TripAdvisor, and industry-specific sites. AI-powered sentiment analysis, automated review reque",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Monitor, collect, and manage online reviews across Google, Yelp, TripAdvisor, and industry-specific sites. AI-powered sentiment analysis, automated review reque</p>

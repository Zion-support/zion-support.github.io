...
export const metadata = {
  title: "Edge-Native Resilient Fintech Processing - Zion Tech Group",
  description: "Edge-native processing layer that delivers resilient fintech insights with sub-millisecond latency.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/edge-native-resilient-fintech-processing-abe789a1`
  }
};

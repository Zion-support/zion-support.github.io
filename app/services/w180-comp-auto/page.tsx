...
export const metadata = {
  title: 'Compliance Automation Suite | Zion Tech Group',
  description: 'Automate compliance: SOC 2, HIPAA, PCI DSS, GDPR, ISO 27001.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/w180-comp-auto',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Compliance Automation Suite</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automate compliance: SOC 2, HIPAA, PCI DSS, GDPR, ISO 27001.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce audit preparation time by 80%</li>
            <li>Continuous compliance not just annual</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS AI Ops Morning Brief</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Delivers concise morning ops briefs with overnight incidents, changes, SLA risks, and prioritized action items.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Overnight incident digest</li>
            <li>Change and release summary</li>
            <li>SLA risk ranking</li>
            <li>Action item scratchpad</li>
            <li>Team and owner routing</li>
            <li>Email and chat delivery</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce morning ramp-up time</li>
            <li>Keep ops aware faster</li>
            <li>Accelerate incident response</li>
            <li>Support shift handoffs</li>
        </ul>
      </section>

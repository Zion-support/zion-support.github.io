...
export const metadata = {
  title: "Multi-Cloud AI Deployer - Zion Tech Group",
  description: "Deploy AI models across AWS, Azure, and GCP with automatic load balancing and failover.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/multi-cloud-ai-deployer-9e91a1d3`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Keycloak Identity &amp; Access Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Full-featured open-source identity and access management (IAM) solution providing single sign-on (SSO), user federation, identity brokering, and multi-tenancy. Supports OAuth 2.0, OpenID Connect, and SAML 2.0 — a drop-in replacement for Auth0, Okta, and Azure AD B2C without per-MAU pricing.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Single Sign-On (SSO) with OpenID Connect, OAuth 2.0, and SAML 2.0 protocol support</li>
            <li>User federation against LDAP, Active Directory, and custom user stores</li>
            <li>Identity brokering: log in via Google, GitHub, Facebook, or any OIDC/SAML identity provider</li>
            <li>Multi-tenant realm architecture — isolate user pools per client, department, or environment</li>
            <li>Admin console with fine-grained role-based access control (RBAC), groups, and custom themes</li>
            <li>Social login, two-factor authentication (TOTP/WebAuthn), and brute-force detection built in</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminates per-MAU identity platform costs (Auth0 starts at $23/mo per 1K users; Keycloak is free at any user count)</li>
            <li>Full data sovereignty over user credentials and authentication logs — critical for GDPR, HIPAA, and SOC 2 compliance</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">100% Free (OSS)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">Free at any user count</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Red Hat support available</p>
          </div>
        </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Windows Hybrid AD Modernization</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Modernize on-premises Active Directory into a cloud-connected hybrid model with identity sync, conditional access, device management, and migration runbooks.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Hybrid AD plan with domain trust cleanup</li>
            <li>Identity sync and credential hardening</li>
            <li>Conditional access and device compliance rules</li>
            <li>Device enrollment and management automation</li>
            <li>Privileged Access Workstation and admin protection</li>
            <li>Migration runbooks with rollback procedures</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Simplify management while modernizing identity</li>
            <li>Improve security with conditional access for all access paths</li>
            <li>Reduce privileged identity risk with admin protection</li>
        </ul>
      </section>

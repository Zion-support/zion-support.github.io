    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Voice Assistant Factory</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Build branded voice assistants for phone, web, and kiosk: speech-to-text, LLM orchestration, text-to-speech, and CRM integration.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>LLM conversation design and guardrails</li>
            <li>Multilingual voice profiles</li>
            <li>Call transcript and intent logging</li>
            <li>CRM and helpdesk handoff</li>
            <li>Scalable orchestration layer</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Serve customers by phone 24/7</li>
            <li>Reduce call center volume</li>
            <li>Keep brand voice consistent</li>
            <li>Capture structured call data</li>
        </ul>
      </section>

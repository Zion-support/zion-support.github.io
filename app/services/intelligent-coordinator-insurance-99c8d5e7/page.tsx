...
export const metadata = {
  ...
  description: "Revolutionize insurance through intelligent automation. Our Intelligent coordinator-insurance leverages advanced machine learning to deliver document processing",
  alternates: {

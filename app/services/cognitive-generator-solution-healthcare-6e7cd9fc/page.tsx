...
export const metadata = {
  ...
  description: "Enhance your healthcare business with Cognitive Generator Solution - Healthcare. Our solution provides predictive modeling with enterprise-grade reliability and",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Enhance your healthcare business with Cognitive Generator Solution - Healthcare. Our solution provides predictive modeling with enterprise-grade reliability and</p>

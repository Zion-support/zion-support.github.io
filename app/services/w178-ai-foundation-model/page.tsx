    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Foundation Model Fine-Tuning</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Fine-tune LLMs for your domain: data preparation, training, evaluation, deployment.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Data preparation and curation</li>
            <li>Fine-tuning (LoRA, QLoRA, full)</li>
            <li>Evaluation and benchmarking</li>
            <li>Deployment (API, on-prem, edge)</li>
            <li>Cost optimization (quantization, distillation)</li>
            <li>Integration with OpenAI, Anthropic, open-source</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Domain-specific AI without building from scratch</li>
            <li>Fine-tuning outperforms generic models</li>
            <li>Cost optimization reduces inference cost</li>
            <li>On-prem deployment for data privacy</li>
        </ul>
      </section>

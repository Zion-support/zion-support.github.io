    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Strapi Headless CMS</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Leading open-source headless CMS giving developers full control over content architecture while providing a beautiful admin panel for content editors. Self-hostable, API-first, and framework-agnostic — works with Next.js, Nuxt, Gatsby, React, Vue, mobile apps via REST or GraphQL APIs.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Intuitive admin panel with drag-and-drop content type builder — no coding required for content modeling</li>
            <li>REST and GraphQL APIs auto-generated from content types; SDKs for JavaScript, PHP, and more</li>
            <li>Role-based access control (RBAC) with granular permissions per content type and field</li>
            <li>Media library with image optimization, folder management, and CDN integration (S3, Cloudinary, etc.)</li>
            <li>Plugin ecosystem: SEO, Internationalization (i18n), Email, Upload, and 100+ community plugins</li>
            <li>Self-host on any infrastructure; database-agnostic (PostgreSQL, MySQL, SQLite, MariaDB)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminates SaaS CMS costs that scale with API calls and users (Contentful free tier: only 25K API calls/mo; Strapi is unlimited when self-hosted)</li>
            <li>Headless architecture future-proofs content — same backend serves web, mobile, IoT, and any future channel without migration</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Cloud Pro: 50K entries, 10 users</p>
          </div>
        </div>

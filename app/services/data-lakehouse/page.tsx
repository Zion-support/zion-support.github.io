...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/data-lakehouse`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/data-lakehouse` title="Data Lakehouse Platform" />
        <h1 className="text-4xl font-bold mb-6">Data Lakehouse Platform</h1>
        <p className="text-lg text-gray-300 mb-8">Unified platform combining data lake flexibility with data warehouse performance — ACID transactions, time travel, and open-table format support.</p>

        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Open-table format (Iceberg)</li>
            <li>ACID transactions</li>
            <li>Time-travel queries</li>
            <li>Schema evolution</li>
            <li>Separation of compute/storage</li>
          </ul>
        </div>

...
export const metadata = {title: 'DevOps Automation Services | Zion Tech Group',description: 'Professional DevOps automation with CI/CD pipelines, infrastructure as code, and monitoring solutions. DevOps services starting at $12k.',title: "DevOps Automation | Zion Tech Group",description: "Streamline your development workflow with comprehensive DevOps automation solutions. CI/CD, infrastructure as code, and monitoring.",description:;
    "Streamline your development workflow with comprehensive DevOps automation solutions. CI/CD, infrastructure as code, and monitoring.",ursor/automate-test-improve-and-merge-code-646c;
}export default function DevOpsAutomationPage() {return (<div className="max-w-6xl mx-auto px-4 py-8">;
      ...
      <div className="text-center mb-16">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">;
          <Item;
            ...
            details={[;
              'Automated testing','Build automation','Deployment pipelines','Quality gates','Rollback automation','Multi-environment support','Performance testing';
            ]}
        ...
        <div>;
          ...
          <div className="space-y-6">;
            <PricingCard;
              ...
              features={[;
                "CI/CD pipeline setup","Basic monitoring configuration","Docker containerization","Documentation and training","30-day support";
              ]}
              popular={false}
            />;
            <PricingCard;
              ...
              features={[;
                "Full CI/CD implementation","Infrastructure as Code","Kubernetes deployment","Advanced monitoring setup","Security integration","90-day support";
              ]}
              popular={true}
            />;
            <PricingCard;
              ...
              features={[;
                "Multi-environment setup","Custom tooling development","Advanced security automation","Performance optimization","Team training and mentoring","6-month support";
              ]}
              popular={false}
            />;
          </div>;
      ...
      <div className="bg-gray-50 rounded-xl p-8 mb-16">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">;
          ...
          <Item;
            title="Infrastructure as Code";
            details={[;
              'Terraform automation','Ansible playbooks','Kubernetes deployment','Docker containerization','Server provisioning','Configuration management','Environment replication';
            ]}
          />;
          <Item;
            title="Monitoring & Observability";
            details={[;
              'Application monitoring','Infrastructure monitoring','Log aggregation','Alerting systems','Performance metrics','Error tracking','Uptime monitoring';
            ]}
          />;
        </div>;
...
ursor/automate-test-improve-and-merge-code-646c;
  ...
  )}function Item() {return (<div className="border border-gray-200 rounded-xl p-6 bg-white">;
...
function FeatureItem() {return (<div className="flex items-start space-x-4">;
    ...
    >;
  ...
  )}function Pricing() {function StepCard() {return (<section>;
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">;
        <Plan;
          ...
          duration="4–8 weeks";
          features={[;
            'Basic CI/CD pipeline','Docker containerization','Simple monitoring','Automated testing','Basic documentation','Email support','30-day warranty';
          ]}
        />;
        <Plan;
          ...
          duration="8–16 weeks";
          features={[;
            'Everything in Basic','Advanced CI/CD','Infrastructure as Code','Comprehensive monitoring','Security automation','Priority support','90-day warranty';
          ]}
        />;
        <Plan;
          ...
          features={[;
            'Everything in Professional','Custom automation','Multi-cloud deployment','Advanced security','Dedicated support','SLA guarantees','Ongoing optimization';
          ]}
        />;
      </div>;
  ...
  )}function Plan() {return (<div className="border border-gray-200 rounded-xl p-6 bg-white hover:shadow-lg transition-shadow">;

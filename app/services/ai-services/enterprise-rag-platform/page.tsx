...
import { Database, Shield, CheckCircle, ArrowRight, Phone, Mail, MapPin } from 'lucide-react';

export default function EnterpriseRAGPlatformPage() {
  const title = 'Enterprise RAG Knowledge Platform — Zion Tech Group';
  const description = 'Secure Retrieval-Augmented Generation on your private data with governance, audit, and enterprise guardrails.';

  const features = [
    'Document ingestion with PII redaction',
    'Vector search and hybrid retrieval',
    'Prompt controls, guardrails, and audit logs',
    'SSO, roles, dataset scoping, and approval flows',
    'Human-in-the-loop feedback and curation',
    'On-prem and cloud deployment options'
  ];

  const pricing = [
    { name: 'Team', price: '$3,000/month', details: ['Up to 50k docs', 'SaaS deployment', 'Email support'] },
    { name: 'Business', price: '$8,000/month', details: ['Up to 500k docs', 'SaaS/VPC', 'Priority support'] },
    { name: 'Enterprise', price: 'Custom', details: ['Unlimited docs', 'On-prem/VPC', 'Dedicated support'] }
  ];
  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/services/ai-services/enterprise-rag-platform" />
      </Head>
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50">
        <section className="py-16 border-b bg-white">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Enterprise RAG Knowledge Platform</h1>
          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border p-6">
              ...
              <div className="space-y-2 text-gray-700">
                <div className="flex items-center"><Shield className="w-5 h-5 text-indigo-700 mr-2" />Granular access control and SSO</div>
                <div className="flex items-center"><Shield className="w-5 h-5 text-indigo-700 mr-2" />Full prompt/response auditability</div>
                <div className="flex items-center"><Shield className="w-5 h-5 text-indigo-700 mr-2" />Data residency options and retention policies</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-6 text-center bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-xl p-8">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Deploy with Confidence</h2>
            <p className="opacity-90 mb-6">From SaaS to on-prem, we meet your security and compliance requirements.</p>

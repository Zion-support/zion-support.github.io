...
function Plan({ name, price, features }: { name: string; price: string; features: string[] }) {
  return (
    <div style={{border: '1px solid #e5e7eb', borderRadius: 12, padding: 16}}>
      ...
      <a href="https://ziontechgroup.com" style={{display: 'inline-block', marginTop: 10, padding: '8px 12px', background: '#111827', color: '#fff', borderRadius: 8}}>Schedule workshop</a>
    </div>
  );
}

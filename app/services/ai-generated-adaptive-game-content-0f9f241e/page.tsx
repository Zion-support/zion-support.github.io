  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Procedural content generation platform that creates adaptive game assets, levels, narratives, and quests using generative AI, reducing development time and cost</p>

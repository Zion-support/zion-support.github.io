  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/adaptive-image-suite-bfd3d06e` title="Adaptive Image Suite" />
        <h1 className="text-4xl font-bold mb-6">Adaptive Image Suite</h1>
        <p className="text-lg text-gray-300 mb-8">Transform your education operations with our Adaptive Image Suite. This AI-driven solution automates threat detection with unprecedented accuracy and efficiency</p>

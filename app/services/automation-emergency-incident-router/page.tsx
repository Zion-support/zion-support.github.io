    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Emergency Incident Router</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Executes calibrated emergency response flows across alerts, people, vendors, and customers with status tracking and confirmation loops.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Severity-based routing rules</li>
            <li>Stakeholder notification paths</li>
            <li>Vendor and customer alerts</li>
            <li>Status tracking dashboard</li>
            <li>Retry and confirmation loops</li>
            <li>Post-event summary generation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce emergency response lag</li>
            <li>Keep communications accurate</li>
            <li>Produce complete incident records</li>
            <li>Reduce manual coordination overhead</li>
        </ul>
      </section>

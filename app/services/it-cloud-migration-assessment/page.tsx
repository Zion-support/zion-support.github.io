    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloud Migration Assessment &amp; Planning</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Comprehensive assessment of your on-premises infrastructure, applications, and data to create a prioritized cloud migration roadmap. AI analyzes dependencies, estimates costs, identifies risks, and recommends the optimal migration strategy (rehost, replatform, refactor) for each workload.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated discovery of servers, apps, and dependencies</li>
            <li>6R migration strategy recommendation per workload</li>
            <li>TCO analysis comparing on-prem vs. cloud costs</li>
            <li>Risk assessment with dependency mapping</li>
            <li>Phased migration roadmap with timeline and milestones</li>
            <li>Cloud provider comparison (AWS, Azure, GCP) for each workload</li>
            <li>Security and compliance gap analysis</li>
            <li>Post-migration validation and optimization plan</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce cloud migration costs by 30% with optimal strategy</li>
            <li>Eliminate surprises with complete dependency visibility</li>
            <li>Accelerate migration timeline with AI-powered planning</li>
            <li>Avoid costly rework with the right migration approach per workload</li>
        </ul>
      </section>

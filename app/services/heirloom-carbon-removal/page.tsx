    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Heirloom — Enhanced Rock Weathering Carbon Removal</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Heirloom accelerates natural limestone weathering to capture CO₂ from the air and permanently store it in concrete and soil. Their enhanced weathering process spreads pulverized limestone on agricultural land, where it absorbs CO₂ within months instead of the natural centuries-long timeline. This dual-use approach also improves soil pH and crop yields for farming communities.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Limestone-based carbon capture — no chemicals, no energy-intensive processes</li>
            <li>Spreads on agricultural land, improving soil health and crop productivity</li>
            <li>CO₂ permanently mineralized in soil and ocean alkalinity enhancement</li>
            <li>Third-party verified via Watershed and Puro Standard certification</li>
            <li>Dual benefit: carbon removal + agricultural soil remediation</li>
            <li>Scalable to billions of tons using globally abundant limestone reserves</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Lowest-cost permanent carbon removal pathway ($150/ton at scale)</li>
            <li>Farmers earn income from hosting limestone spreading operations</li>
            <li>Restores degraded agricultural soils while capturing CO₂</li>
            <li>Unlimited scalability — limestone is one of Earth\\</li>
            <li>,
      </li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$300/ton CO₂ removed</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$200/ton (&gt;5,000 tons/year)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$150/ton (large-scale programs)</p>
          </div>
        </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Clinical Trial Matching Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Match patients to eligible clinical trials using AI that parses unstructured EHR data, lab results, and physician notes against trial inclusion/exclusion criteria. Increases trial enrollment rates by 3x and reduces screening time by 80%. Integrates with major EHR systems and CTMS platforms.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI parsing of unstructured EHR data against trial criteria</li>
            <li>Real-time matching against ClinicalTrials.gov and sponsor databases</li>
            <li>Automated pre-screening questionnaire generation</li>
            <li>EHR integration (Epic, Cerner, Allscripts, Medidata)</li>
            <li>Patient consent and enrollment workflow automation</li>
            <li>Site-level enrollment analytics and bottleneck identification</li>
            <li>HIPAA-compliant data processing with BAA support</li>
            <li>Multi-site trial coordination and patient transfer workflows</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Increase trial enrollment rates by 3x with AI-powered matching</li>
            <li>Reduce patient screening time from hours to minutes per candidate</li>
            <li>Expand trial diversity with broader patient identification</li>
            <li>Accelerate time-to-enrollment for sponsors and sites</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Expense Report Auditor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automate expense auditing: receipt verification, policy checking, duplicate detection, anomaly flagging.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Receipt and invoice verification</li>
            <li>Policy compliance checking</li>
            <li>Duplicate expense detection</li>
            <li>Anomaly and outlier flagging</li>
            <li>Mileage and per diem validation</li>
            <li>Integration with Concur, Expensify, Chrome River</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce audit time 75%</li>
            <li>Policy compliance automated</li>
            <li>Duplicate detection prevents double-pay</li>
            <li>Anomaly flagging catches fraud</li>
        </ul>
      </section>

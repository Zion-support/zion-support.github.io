...
export const metadata = {
  ...
  description: "AI-powered email drafting with tone matching, audience adaptation, subject line optimization, and send-time prediction. Increase open rates by 35% and response ",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-6">AI Email Composer &amp; Optimizer</h1>
        <p className="text-lg text-gray-300 mb-8">AI-powered email drafting with tone matching, audience adaptation, subject line optimization, and send-time prediction. Increase open rates by 35% and response </p>

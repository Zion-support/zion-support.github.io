    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Project Time Tracking &amp; Invoicing</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">All-in-one team time tracking, client billing, automated invoicing, and profitability reports. Built for small agencies and freelancers who need professional billing without enterprise complexity. Integrates with Stripe and PayPal for seamless payment collection.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Team time tracking with project and task-level granularity</li>
            <li>Automated client billing with customizable hourly and fixed-rate models</li>
            <li>Invoice generation and delivery with payment reminders</li>
            <li>Profitability reports by project, client, and team member</li>
            <li>Stripe and PayPal integration for online payment collection</li>
            <li>Client portal for timesheet review, invoice approval, and payment</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce billing cycle time from days to minutes with automated invoicing</li>
            <li>Profitability reports reveal which projects and clients drive margin</li>
            <li>Integrated payments get you paid faster with fewer follow-ups</li>
            <li>Client portal reduces back-and-forth emails by 80%</li>
            <li>Simple setup gets your team tracking time in under 15 minutes</li>
        </ul>
      </section>

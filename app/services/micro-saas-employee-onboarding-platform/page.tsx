    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">End-to-end employee lifecycle management — from offer letter to exit. Automated onboarding checklists, equipment provisioning, training workflows, and compliance tracking. IT, HR, and managers stay aligned with real-time dashboards. Offboarding ensures zero security gaps when employees leave.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated onboarding checklists per role/department</li>
            <li>Equipment and access provisioning workflows</li>
            <li>Training path assignment and progress tracking</li>
            <li>Compliance document collection and e-signatures</li>
            <li>Offboarding security checklist and access revocation</li>
            <li>Integration with HRIS, ITSM, and identity providers</li>
            <li>New hire satisfaction surveys and analytics</li>
            <li>Manager dashboard with onboarding progress</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Ensure 100% compliance documentation</li>
            <li>Reduce new hire turnover by 30%</li>
            <li>Eliminate security gaps during employee transitions</li>
        </ul>
      </section>

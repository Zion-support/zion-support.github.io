...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/w180-observ',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Multi-Cloud Observability Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Unified observability across AWS, Azure, GCP: metrics, traces, logs.</p>

...
export const metadata = {
  title: "AI Optimizer - Hospitality Edition #8 - Zion Tech Group",
  description: "The future of hospitality is here with AI Optimizer - Hospitality Edition #8. Powered by cutting-edge AI, this platform delivers risk assessment like never befo",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-optimizer---hospitality-edition-8-cf070753`
  }
};

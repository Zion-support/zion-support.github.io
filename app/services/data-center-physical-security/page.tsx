    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Physical Security &amp; Access Control Systems</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Design, install, and certify layered physical security for data halls and support rooms: biometric access, mantraps, CCTV/AI video analytics, perimeter detection, and SOC 2 / ISO 27001 compliance alignment.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Biometric badge readers and PIN + card dual-factor mantrap design</li>
            <li>AI video analytics for tailgating and anomalous behavior detection</li>
            <li>Perimeter intrusion detection (fiber, microwave, beam)</li>
            <li>Security operations center integration and SIEM correlation</li>
            <li>Visitor management system (VMS) with escort tracking</li>
            <li>Audit logging and compliance evidence automation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Prevent unauthorized access to critical infrastructure</li>
            <li>Meet Uptime Institute Tier/ISO 27001 physical security requirements</li>
            <li>Reduce security incidents with real-time AI anomaly detection</li>
            <li>Streamline audit evidence collection for certification cycles</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Vendor Spend Tracker</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Aggregates spend, contract, and renewal signals across vendors with exception routing and monthly cost reviews.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Vendor spend consolidation</li>
            <li>Contract and renewal pairing</li>
            <li>Price drift alerts</li>
            <li>Savings and duplicate detection</li>
            <li>Owner and approval routing</li>
            <li>Monthly review packages</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce vendor sprawl cost</li>
            <li>Keep renewals visible</li>
            <li>Support procurement reviews</li>
            <li>Accelerate savings actions</li>
        </ul>
      </section>

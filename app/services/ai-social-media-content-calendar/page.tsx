    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Social Media Content Calendar &amp; Scheduler</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered social media management that creates content ideas, writes posts, generates hashtags, and schedules publishing across platforms. Analyzes performance to optimize future content. Works with Instagram, LinkedIn, X/Twitter, Facebook.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI content idea generation</li>
            <li>Post writing with brand voice</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Generate a month of content ideas in minutes</li>
            <li>Post at optimal times for engagement</li>
            <li>Consistent brand voice across all platforms</li>
            <li>Reach 3x more engagement with AI optimization</li>
            <li>Manage all platforms from one dashboard</li>
        </ul>
      </section>

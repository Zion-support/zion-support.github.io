  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Generate statistically accurate synthetic datasets for ML training, testing, and compliance. Preserves statistical properties of real data while ensuring zero p</p>

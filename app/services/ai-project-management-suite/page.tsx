...
export const metadata = {
  ...
  description: 'Professional ai project management suite solutions for your business needs.',
};
    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
          ...
          <p className="text-gray-600">
            Enhance your project management with AI technology to improve efficiency.
          </p>
        </div>
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
          ...
          <p className="text-gray-600">
            Get insights from project data to improve your management strategy.
          </p>
        </div>
        ...
        <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow">
          ...
          <p className="text-gray-600">
            Optimize resources and timelines using AI-powered analysis.
          </p>
        </div>
      </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Founder Revenue Intelligence Dashboard</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Unified founder dashboard for MRR, churn, LTV, CAC, and pipeline health with anomaly detection and action items wired into alerts and exports.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Unified subscription and revenue telemetry</li>
            <li>Churn and cohort views with explainable variance</li>
            <li>Automated anomaly detection and alerting</li>
            <li>Board-ready fetches, exports, and embedded charts</li>
            <li>Integration with billing, CRM, and warehouse outputs</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>See business health in one view instead of scattered reports</li>
            <li>Act on revenue anomalies before board reviews</li>
            <li>Reduce founder reporting time with automated summaries</li>
        </ul>
      </section>

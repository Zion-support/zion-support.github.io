    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Patch Management and Vulnerability Remediation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automated OS and application patching: vulnerability scanning, zero-day response.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated OS patching (Windows, Linux, macOS)</li>
            <li>Third-party application patching</li>
            <li>Vulnerability scanning (CVSS)</li>
            <li>Zero-day rapid response deployment</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Patch 95% of fleet within 72 hours</li>
            <li>Automated zero-day response</li>
            <li>Compliance-ready patch reporting</li>
        </ul>
      </section>

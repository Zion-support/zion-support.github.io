    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Crop Disease Detection &amp; Yield Prediction</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Analyze drone and satellite imagery with AI to detect crop diseases early, forecast yields accurately, and recommend targeted treatments. Reduce crop loss, optimize inputs, and maximize harvest value with actionable intelligence.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Drone and satellite imagery analysis</li>
            <li>Early-stage crop disease identification</li>
            <li>Yield forecasting based on historical and real-time data</li>
            <li>Treatment and intervention recommendations</li>
            <li>Soil health and moisture monitoring dashboards</li>
            <li>Season-over-season trend analysis and benchmarking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect crop diseases weeks before visible symptoms appear</li>
            <li>Reduce crop loss by up to 30% with early intervention</li>
            <li>Optimize fertilizer and pesticide usage for cost savings</li>
            <li>Improve yield prediction accuracy to within 90%+</li>
            <li>Make data-driven decisions instead of relying on intuition</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Governance Role Mapper</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Maps data ownership, stewardship, and duty-of-care roles across datasets, reports, and exports with accountability dashboards.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Owner and steward mapping</li>
            <li>Duty-of-care classification</li>
            <li>Access review pairing</li>
            <li>Incident and change routing</li>
            <li>Policy template pairing</li>
            <li>Audit-ready ownership views</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Reduce ‘no owner’ gaps</li>
            <li>Keep audits defensible</li>
            <li>Support data-product operating models</li>
        </ul>
      </section>

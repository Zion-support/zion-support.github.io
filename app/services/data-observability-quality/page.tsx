    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Observability &amp; Quality AI Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Monitor data freshness, volume, distribution, and schema with AI-powered anomaly detection. Auto-detect breaking changes, classify incidents, and suggest fixes. Keep analytics and ML training reliable.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Column-level profiling and freshness monitoring</li>
            <li>AI anomaly detection across metrics, logs, and traces</li>
            <li>Automated data lineage and impact analysis</li>
            <li>Schema change detection and breaking-change alerts</li>
            <li>Self-healing quality rules and automated remediation</li>
            <li>Integration with Databricks, Snowflake, BigQuery, Redshift</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Prevent bad data from reaching dashboards and ML models</li>
            <li>Cut data incident MTTR by 80% with automated root-cause suggestions</li>
            <li>Build trust in data across engineering, analytics, and business teams</li>
            <li>Reduce on-call data engineering burden with proactive alerts</li>
        </ul>
      </section>

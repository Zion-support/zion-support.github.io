    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Multi-Cloud Architecture Design</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Design multi-cloud architecture: AWS, Azure, GCP with unified networking, security, governance.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Cross-cloud identity and access</li>
            <li>Unified security and governance</li>
            <li>Cost optimization across providers</li>
            <li>Disaster recovery across clouds</li>
            <li>Integration with Terraform, Pulumi</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Unified governance across providers</li>

...
export const metadata = {
  title: "Delivery Performance - Sales - Zion Tech Group",
  description: "The future of sales is here with Delivery Performance - Sales. Powered by cutting-edge AI, this platform delivers performance insights like never before.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/delivery-performance-sales-6323fcd3`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Unified Endpoint Management (UEM)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Manage and secure all devices (laptops, mobile, IoT) from a single dashboard: enrollment, policy enforcement, patch management, and remote wipe.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cross-platform device enrollment (Windows, macOS, iOS, Android, Linux)</li>
            <li>Automated patch &amp; update deployment</li>
            <li>Endpoint detection &amp; response (EDR)</li>
            <li>Application whitelisting &amp; app catalog</li>
            <li>Remote lock, wipe, and geofencing</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce costs with unified endpoint management (uem)</li>

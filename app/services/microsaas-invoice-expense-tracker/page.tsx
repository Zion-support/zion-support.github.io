    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Invoice &amp; Expense Tracker for Freelancers</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">All-in-one invoicing and expense tracking for freelancers and solopreneurs. Create professional invoices, track expenses by category, auto-calculate taxes, and get paid online. Integrates with Stripe, PayPal, and bank feeds.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Professional invoice builder with custom branding</li>
            <li>Expense tracking with receipt scanning (OCR)</li>
            <li>Auto tax calculation and quarterly estimates</li>
            <li>Online payment collection (Stripe, PayPal, ACH)</li>
            <li>Bank feed integration for auto-import</li>
            <li>Profit/loss reports and tax-ready summaries</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Get paid faster with online payment links</li>
            <li>Never lose a receipt — scan and auto-categorize</li>
            <li>Know your tax liability in real-time</li>
            <li>Generate tax-ready reports in one click</li>
            <li>Look professional with branded invoices</li>
        </ul>
      </section>

...
export const metadata = {
  title: "Enterprise Serverless Fintech Analytics Suite - Zion Tech Group",
  description: "Enterprise analytics suite that delivers serverless fintech insights with unified dashboards and reporting.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/enterprise-serverless-fintech-analytics-suite-0a9d2c89`
  }
};

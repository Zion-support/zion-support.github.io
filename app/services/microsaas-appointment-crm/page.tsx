    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Appointment &amp; CRM Suite</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Lightweight appointment booking with built-in CRM for service businesses (salons, clinics, consultants). Online scheduling, automated reminders, client history, and payment collection in one simple app. No bloated features, just what small businesses need.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Online self-service booking page</li>
            <li>Automated SMS/email reminders (reduces no-shows 40%)</li>
            <li>Client history and notes</li>
            <li>Stripe/Square payment collection at booking</li>
            <li>Calendar sync (Google, Outlook)</li>
            <li>Simple analytics: bookings, revenue, retention</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce no-shows by 40% with automated reminders</li>
            <li>Collect payments at time of booking</li>
            <li>All client info in one place</li>
            <li>Set up in under 15 minutes</li>
            <li>No complex CRM learning curve</li>
        </ul>
      </section>

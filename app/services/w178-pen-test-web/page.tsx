    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Web Application Penetration Testing</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Expert web app pentesting: OWASP Top 10, business logic, API testing. OSCP certified testers.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Business logic vulnerability testing</li>
            <li>API security testing</li>
            <li>Authentication and session testing</li>
            <li>Detailed report with CVSS scoring</li>
            <li>Remediation guidance and retesting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>OSCP certified ethical hackers</li>
            <li>Detailed reports with actionable remediation</li>
            <li>Retesting verifies fixes</li>
        </ul>
      </section>

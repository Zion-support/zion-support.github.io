...
export const metadata = {
  title: "Processor Intelligent - Construction - Zion Tech Group",
  description: "Next-generation construction solution: Processor Intelligent - Construction. Combines supply chain with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/processor-intelligent---construction-ed31c731`
  }
};

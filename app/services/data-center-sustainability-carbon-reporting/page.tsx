    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Sustainability &amp; Carbon Reporting</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Implement Scope 1/2/3 emissions tracking, PUE benchmarking, renewable PPAs, and carbon accounting aligned with GHG Protocol and CSRD. Grid-aware workload scheduling for maximum renewable utilization.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>PUE, WUE, and carbon-intensity telemetry collection</li>
            <li>Scope 1/2/3 GHG Protocol emissions calculation</li>
            <li>Renewable energy matching and PPA advisory</li>
            <li>CSRD and EU ETS compliance reporting automation</li>
            <li>Grid-aware workload shifting to low-carbon hours</li>
            <li>Third-party audit evidence generation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce Scope 2 emissions by 30–60% with renewables</li>
            <li>Meet CSRD disclosure requirements on time</li>
            <li>Demonstrate ESG leadership to customers and investors</li>
            <li>Optimize energy spend with time-of-use and carbon-aware scheduling</li>
        </ul>
      </section>

...
export const metadata = {
  ...
  description: "AI-powered natural language processing for text classification, entity extraction, sentiment analysis, and summarization. Process millions of documents in minut",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">AI-powered natural language processing for text classification, entity extraction, sentiment analysis, and summarization. Process millions of documents in minut</p>

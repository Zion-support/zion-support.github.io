...
export const metadata = {
  title: "Engine Intelligent - Sports - Zion Tech Group",
  description: "Next-generation sports solution: Engine Intelligent - Sports. Combines fraud prevention with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/engine-intelligent---sports-0668df60`
  }
};

...
export const metadata = {
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/cloud-native-retail-optimization-60e8776c`
  }
};
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/cloud-native-retail-optimization-60e8776c` title="Cloud-Native Retail Optimization" />
        <h1 className="text-4xl font-bold mb-6">Cloud-Native Retail Optimization</h1>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Managed IT Infrastructure</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">24/7 managed infrastructure: network, servers, storage, and backup. Proactive monitoring, patching, and capacity planning under one SLA.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce downtime with proactive ops</li>
            <li>Focus internal teams on product work</li>
            <li>Predictable IT spend</li>
            <li>SLA protection for critical systems</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Modular Data Center Expansion &amp; Prefabricated Data Halls</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Accelerate data center expansion with prefabricated data halls, modular power and cooling pods, and rapid-deployment shell-and-core designs. Reduce build timelines from 18 months to under 6 months.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Prefabricated data hall modules (containerized or booth-style)</li>
            <li>Modular power and cooling skids (UPS, PDUs, CRAH/CRAC)</li>
            <li>Shell-and-core design for phased buildout</li>
            <li>Rapid deployment with factory acceptance testing (FAT)</li>
            <li>Seismic and environmental compliance engineering</li>
            <li>Integration with existing facility BMS and security systems</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cut construction timelines by 60–70%</li>
            <li>Reduce cost and schedule risk with off-site fabrication</li>
            <li>Scale capacity in sync with revenue growth</li>
            <li>Minimize disruption to live operations during expansion</li>
        </ul>
      </section>

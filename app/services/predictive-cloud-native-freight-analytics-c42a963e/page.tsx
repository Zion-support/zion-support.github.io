...
export const metadata = {
  title: "Predictive Cloud-Native Freight Analytics - Zion Tech Group",
  description: "Freight intelligence platform that provides cloud-native rate forecasting, capacity planning, and carrier performance analytics for logistics optimization.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/predictive-cloud-native-freight-analytics-c42a963e`
  }
};

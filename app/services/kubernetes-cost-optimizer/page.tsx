    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Kubernetes Cost Optimizer</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Kubernetes-specific cost management platform that analyzes cluster resource utilization, right-sizes workloads, identifies idle resources, and automates spot instance diversification. Reduces K8s cloud spend by 30-60%.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Per-namespace, per-deployment cost attribution</li>
            <li>Right-sizing recommendations with actual usage analysis</li>
            <li>Spot instance diversification with fallback strategies</li>
            <li>Idle resource detection and auto-reclamation</li>
            <li>Savings plan and reserved capacity optimization</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce Kubernetes cloud spend by 30-60%</li>
            <li>Eliminate resource waste from over-provisioned pods</li>
            <li>Automate spot instance usage for fault-tolerant workloads</li>
            <li>Attribute costs accurately to teams and projects</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Real-Time Streaming Analytics Engine</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">High-performance streaming analytics platform that processes millions of events per second with sub-second latency. Supports complex event processing, windowed aggregations, and real-time anomaly detection on live data streams.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Sub-second latency processing of 1M+ events/sec</li>
            <li>Complex event processing with pattern matching</li>
            <li>Sliding, tumbling, and session window aggregations</li>
            <li>Real-time anomaly detection with adaptive thresholds</li>
            <li>SQL-based stream processing with continuous queries</li>
            <li>Integration with Kafka, Kinesis, and Pulsar</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Make decisions on live data with sub-second latency</li>
            <li>Detect anomalies in real-time before they impact operations</li>
            <li>Replace brittle batch pipelines with continuous processing</li>
            <li>Scale horizontally without re-architecture</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Access Governance Hub</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Manages access reviews, role mining, entitlement inventories, and policy enforcement for IAM, SaaS, and privileged-access programs.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Role mining and clustering</li>
            <li>Policy violation detection</li>
            <li>Privileged access focus</li>
            <li>Reviewer workflow management</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce over-entitlement risk</li>
            <li>Speed audit responses</li>
            <li>Improve access hygiene</li>
            <li>Keep reviewers on track</li>
        </ul>
      </section>

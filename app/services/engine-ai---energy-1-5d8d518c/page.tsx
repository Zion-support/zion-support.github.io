...
export const metadata = {
  title: "Engine AI - Energy #1 - Zion Tech Group",
  description: "Revolutionize energy through intelligent automation. Our Engine AI - Energy #1 leverages advanced machine learning to deliver compliance monitoring at scale.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/engine-ai---energy-1-5d8d518c`
  }
};

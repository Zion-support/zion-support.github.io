    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Felix Smart — AI-Powered Smart City IoT Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Felix Smart provides an AI platform for managing smart city infrastructure — street lighting, waste collection, parking, air quality, and traffic flow — through a unified IoT dashboard. Their platform connects 100,000+ city devices, uses predictive analytics to optimize operations, and reduces municipal energy costs by 30-60%. Deployed in cities across Europe, Asia, and North America.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Unified IoT dashboard: manage lighting, waste, parking, air quality, and traffic</li>
            <li>Predictive maintenance: AI detects equipment failures before they occur</li>
            <li>Smart lighting optimization: dim/brighten based on pedestrian and vehicle traffic</li>
            <li>Waste collection routing: optimize pickup schedules based on bin fill-level sensors</li>
            <li>Air quality monitoring: real-time pollution mapping with 50m resolution</li>
            <li>Open API: integrate with existing city ERP, CRM, and citizen service platforms</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce municipal energy costs by 30-60% through intelligent lighting</li>
            <li>Citizens enjoy cleaner streets: waste collected when bins are full, not on fixed schedule</li>
            <li>Traffic congestion reduced 15% through adaptive signal timing</li>
            <li>Carbon footprint reduction: measurable sustainability metrics for ESG reporting</li>
            <li>Scalable: start with one district, expand to full city without platform changes</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Pilot (single district)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$50K/year (city-wide lighting)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom ($200K+/year full city deployment)</p>
          </div>
        </div>

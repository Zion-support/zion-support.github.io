    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Satellite Imagery Analytics Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Process and analyze satellite and drone imagery with AI for agriculture, urban planning, disaster response, and environmental monitoring. Change detection, object classification, and predictive modeling.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-spectral and SAR imagery processing</li>
            <li>AI object detection and land use classification</li>
            <li>Change detection with automated alerts</li>
            <li>Crop health monitoring with NDVI analysis</li>
            <li>Disaster damage assessment with rapid deployment</li>
            <li>Integration with major satellite data providers</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Monitor vast areas cost-effectively with satellite data</li>
            <li>Detect changes and anomalies in near real-time</li>
            <li>Make data-driven decisions for land and resource management</li>
            <li>Respond faster to natural disasters with damage mapping</li>
        </ul>
      </section>

...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/customer-data-platform',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Customer Data Platform (CDP)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enterprise customer data platform that unifies customer data from all touchpoints into a single, actionable profile. Real-time identity resolution, segmentation, and activation across marketing, sales, and service channels.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time identity resolution across devices and channels</li>
            <li>Unified customer profile with 360-degree view</li>
            <li>Behavioral segmentation with dynamic cohort building</li>
            <li>Privacy consent management with GDPR/CCPA compliance</li>
            <li>Activation connectors for 100+ marketing and ad platforms</li>
            <li>Customer journey analytics with attribution modeling</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate data silos with a single customer view</li>
            <li>Personalize experiences across all channels in real-time</li>
            <li>Improve marketing ROI with unified attribution</li>
            <li>Maintain privacy compliance with centralized consent</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI-Powered Energy Grid Optimization</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Smart grid load forecasting, renewable integration, demand response, and outage prediction powered by machine learning. Helps utilities reduce costs, improve reliability, and accelerate the transition to clean energy.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time load forecasting with 98% accuracy across distribution networks</li>
            <li>Renewable energy integration modeling for solar, wind, and battery storage</li>
            <li>Automated demand-response orchestration for peak shaving and load balancing</li>
            <li>Predictive outage detection using weather data, sensor feeds, and historical patterns</li>
            <li>Dynamic pricing engine that adjusts tariffs based on demand and grid stress</li>
            <li>Interactive grid health dashboard with drill-down analytics and KPI tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduces unplanned outages by up to 40% through predictive maintenance alerts</li>
            <li>Increases renewable energy utilization by optimizing generation schedules</li>
            <li>Lowers operational costs via intelligent demand-response automation</li>
            <li>Improves regulatory compliance with automated reporting and audit trails</li>
            <li>Scales to millions of smart-meter data points without performance degradation</li>
        </ul>
      </section>

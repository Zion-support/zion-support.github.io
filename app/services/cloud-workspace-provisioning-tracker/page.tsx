    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Cloud Workspace Provisioning Tracker</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Tracks cloud workspaces, lab environments, and SaaS account provisioning against expense, usage, and lifecycle rules.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Usage and expiration tracking</li>
            <li>Budget and anomaly alerts</li>
            <li>Request routing</li>
            <li>Access and retention rules</li>
            <li>Executive cloud hygiene view</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce unused cloud spend</li>
            <li>Keep lab access governed</li>
            <li>Produce actionable cleanup reports</li>
            <li>Simplify entitlement review</li>
        </ul>
      </section>

...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with AI Optimizer - Healthcare Edition #1. This autonomous system provides process automation with zero manual intervention needed.",
  alternates: {

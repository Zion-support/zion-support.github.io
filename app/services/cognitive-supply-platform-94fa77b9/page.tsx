...
export const metadata = {
  ...
  description: "The future of finance is here with Cognitive Supply Platform. Powered by cutting-edge AI, this platform delivers threat detection like never before.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-supply-platform-94fa77b9`
  }
};

...
export const metadata = {
  title: "Cognitive Supply Predictor - Zion Tech Group",
  description: "Next-generation retail solution: Cognitive Supply Predictor. Combines threat detection with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-supply-predictor-0b1b2f70`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Unified Communications as a Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">VoIP, video, messaging, collaboration in one platform.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Business VoIP with advanced call routing</li>
            <li>HD video conferencing</li>
            <li>Team messaging and channels</li>
            <li>Integration with CRM, email, calendar</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Replace 4+ tools with one platform</li>
            <li>50% savings vs separate tools</li>
        </ul>
      </section>

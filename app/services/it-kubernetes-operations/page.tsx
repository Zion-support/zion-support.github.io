    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Managed Kubernetes Operations</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Managed Kubernetes clusters with automated provisioning, governance, upgrades, security hardening, cost controls, and runbooks. Includes backups, multi-env promotion, and incident response for control plane and workloads.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cluster lifecycle provisioning and upgrades</li>
            <li>Policy enforcement and audit-ready manifests</li>
            <li>Automated backups and disaster recovery runbooks</li>
            <li>RBAC hardened baselines and pod security standards</li>
            <li>Cost visibility with quota and autoscaling policies</li>
            <li>Incident response for control plane and workloads</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Run production clusters with less operational overhead</li>
            <li>Reduce incident response time with standard playbooks</li>
            <li>Control cloud spend with quota plus autoscaling policies</li>
            <li>Ship changes through safer multi-env promotion paths</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$4,200/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$9,800/mo</p>
          </div>
        </div>

  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/ai-computer-vision` title="AI Computer Vision" />
        <h1 className="text-4xl font-bold mb-6">AI Computer Vision</h1>
        <p className="text-lg text-gray-300 mb-8">Image recognition, object detection, quality inspection, and visual search powered by deep learning models trained on your domain data.</p>

        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          <h2 className="text-2xl font-semibold mb-4">Key Features</h2>
          <ul className="list-disc list-inside space-y-2">
            <li>Image classification &amp; object detection</li>
            <li>Visual quality inspection &amp; defect detection</li>
            <li>OCR + layout analysis</li>
            <li>Visual search &amp; similarity matching</li>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with ai computer vision</li>

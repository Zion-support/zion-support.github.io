...
export const metadata = {
  title: "Quantum-Ready Frictionless Non-Profit Analytics - Zion Tech Group",
  description: "Quantum-ready analytics platform that prepares frictionless non-profit workloads for future quantum acceleration.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/quantum-ready-frictionless-non-profit-analytics-825ad541`
  }
};

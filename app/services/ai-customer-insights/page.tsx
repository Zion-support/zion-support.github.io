...
export const metadata = {title: 'AI Customer Insights | Zion Tech Group',description:;
    'Unlock customer behavior insights with AI-powered analytics, sentiment analysis, and predictive modeling. Drive growth with data-driven decisions.',title: "AI Customer Insights | Zion Tech Group",description: "Transform customer data into actionable insights with AI-powered analytics. Understand customer behavior, preferences, and trends.",description:;
    "Transform customer data into actionable insights with AI-powered analytics. Understand customer behavior, preferences, and trends.",ursor/automate-test-improve-and-merge-code-646c;
}export default function AICustomerInsightsPage() {return (<div className="animate-fade-in">;
...
ursor/automate-test-improve-and-merge-code-646c;
        ...
        <div>;
          ...
          <div className="space-y-6">;
            <PricingCard;
              ...
              features={[;
                'Up to 10,000 customers','Basic analytics','Sentiment analysis','Email support','Standard reports',"Up to 10,000 customer records","Basic behavioral analysis","Standard segmentation","Email support","Monthly reports";
                "Monthly reports",ursor/automate-test-improve-and-merge-code-646c;
              ]}
              popular={false}
            />;
            <PricingCard;
              ...
              features={[;
                'Up to 100,000 customers','Advanced AI features','Predictive modeling','Priority support','Custom dashboards','API access',"Up to 100,000 customer records","Advanced AI analytics","Predictive modeling","Real-time insights","Priority support","Custom dashboards";
                "Custom dashboards",ursor/automate-test-improve-and-merge-code-646c;
              ]}
              popular={true}
            />;
            <PricingCard;
              ...
              features={[;
                'Unlimited customers','Custom AI models','Real-time processing','24/7 support','Custom integrations','Dedicated analyst',"Unlimited customer records","Custom AI models","Advanced predictive analytics","Dedicated support","Custom integrations","On-premise deployment";
                "On-premise deployment",ursor/automate-test-improve-and-merge-code-646c;
              ]}
              popular={false}
            />;
          </div>;
  ...
  )}function FeatureItem() {function FeatureItem() {ursor/automate-test-improve-and-merge-code-646c;
...
ursor/automate-test-improve-and-merge-code-646c;
      {popular && (<div className="bg-teal-500 text-white text-sm font-semibold px-3 py-1 rounded-full inline-block mb-4">;
          Most Popular;
        </div>;
      )}
      ...
      <button;
        className={`w-full mt-6 py-3 px-4 rounded-lg font-semibold transition-colors ${popular;
  ...
  )}function StepCard() {function InsightCategory() {ursor/automate-test-improve-and-merge-code-646c;
  return (<div className="text-center p-6 border border-gray-200 rounded-lg hover:border-teal-300 transition-colors">;
      <div className="text-4xl mb-4">{icon}</div>;
      <h3 className="text-lg font-semibold text-gray-900 mb-3">{title}</h3>;
      <p className="text-gray-600">{description}</p>;
    </div>;
  )}function BenefitCard() {return (<div className="text-center p-6 border border-gray-200 rounded-lg hover:border-teal-300 transition-colors">;
      <div className="text-4xl mb-4">{icon}</div>;
      <h3 className="text-lg font-semibold text-gray-900 mb-3">{title}</h3>;
      <p className="text-gray-600">{description}</p>;
    </div>;
  )}function DataSourceCard() {return (<div className="text-center p-4 border border-gray-200 rounded-lg hover:border-teal-300 transition-colors">;
      <div className="text-3xl mb-2">{icon}</div>;
      <div className="text-sm font-medium text-gray-700">{name}</div>;
    </div>;
  )}function UseCaseCard() {return (<div className="p-6 border border-gray-200 rounded-lg hover:border-teal-300 transition-colors">;
      <div className="text-4xl mb-4">{icon}</div>;
      <h3 className="text-lg font-semibold text-gray-900 mb-3">{title}</h3>;
      <p className="text-gray-600">{description}</p>;
    </div>;
  )}function CTA() {return (<div className="bg-gradient-to-r from-teal-50 to-blue-50 border border-teal-200 rounded-xl p-8 text-center">;

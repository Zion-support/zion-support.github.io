    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Financial Data Warehouse Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Purpose-built financial data warehouse with pre-built schemas for banking, insurance, and capital markets. Regulatory reporting, risk analytics, and real-time position tracking with SOX-compliant audit trails.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Pre-built financial data models (banking, insurance, capital markets)</li>
            <li>Regulatory reporting templates (CCAR, Basel III, Solvency II)</li>
            <li>Real-time position tracking with P&amp;L attribution</li>
            <li>Risk analytics with VaR, stress testing, and scenario analysis</li>
            <li>SOX-compliant audit trails with immutable data lineage</li>
            <li>Data quality rules specific to financial data standards</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Accelerate regulatory reporting from weeks to days</li>
            <li>Reduce risk of regulatory non-compliance</li>
            <li>Unify financial data across business lines</li>
            <li>Enable real-time risk monitoring and decision-making</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$1199/mo</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$2499/mo</p>
          </div>
        </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI-Powered Recruitment Screening &amp; Candidate Matching</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Transform your hiring process with AI that parses resumes, ranks candidates against job criteria, detects screening bias, and automates interview scheduling. Reduce time-to-hire while improving candidate quality and diversity.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI resume parsing (PDF, DOCX, LinkedIn)</li>
            <li>Intelligent candidate ranking against job criteria</li>
            <li>Bias detection in screening decisions</li>
            <li>Automated interview scheduling (Calendlo integration)</li>
            <li>ATS integration (Greenhouse, Lever, Workable)</li>
            <li>Diversity analytics and reporting dashboard</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Screen 1000+ resumes in under 5 minutes</li>
            <li>Reduce time-to-hire by 50%</li>
            <li>Unbiased candidate evaluation</li>
            <li>Improve quality-of-hire scores</li>
            <li>Free recruiters from manual screening tasks</li>
        </ul>
      </section>

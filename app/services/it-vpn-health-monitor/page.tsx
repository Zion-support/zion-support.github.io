    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT VPN Health Monitor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Monitors VPN tunnels, concentrators, and remote-access session health for SMB and enterprise networks with alert-driven ops dashboards.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Tunnel and concentrator status</li>
            <li>Remote session monitoring</li>
            <li>Throughput and latency tracking</li>
            <li>Alert routing for failures</li>
            <li>Peak and baseline baselining</li>
            <li>Capacity and growth insight</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cut remote outage impact</li>
            <li>Keep remote work stable</li>
            <li>Improve headcount capacity planning</li>
            <li>Alert ops before users notice</li>
        </ul>
      </section>

      ...
      <div className="bg-gradient-to-r from-slate-50 to-gray-50 border border-slate-200 rounded-xl p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Reduce Processing Time by 90%</h3>
              <p className="text-gray-600">Automate repetitive document tasks and focus on high-value work</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-slate-500 mr-3 text-xl">✓</span>
            <div>
              <h3 className="font-semibold text-gray-900">99.5% Accuracy Rate</h3>
              <p className="text-gray-600">AI-powered validation ensures data accuracy and reduces errors</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-slate-500 mr-3 text-xl">✓</span>
            <div>
              <h3 className="font-semibold text-gray-900">Multi-Format Support</h3>
              <p className="text-gray-600">Process PDFs, images, Word docs, Excel files, and more</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-slate-500 mr-3 text-xl">✓</span>
            <div>
              ...
              <p className="text-gray-600">GDPR compliant with audit trails and secure data handling</p>
            </div>
          </div>
        </div>
      </div>
...
function Plan({ name, price, features, popular = false }: { name: string; price: string; features: string[]; popular?: boolean }) {
  return (
    <div className={`border rounded-xl p-6 bg-white shadow-sm ${popular ? 'border-slate-500 ring-2 ring-slate-200' : 'border-gray-200'}`}>
      {popular && (

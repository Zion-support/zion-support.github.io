...
export const metadata = {
  ...
  description: "Next-generation transportation solution: Automated Automation for Transportation. Combines fraud prevention with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/automated-automation-for-transportation-2b85b495`
  }
};

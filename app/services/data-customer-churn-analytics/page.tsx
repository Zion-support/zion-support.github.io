...
export const metadata = {
  title: 'Customer Churn Analytics | Zion Tech Group',
  description: 'Predictive analytics platform to identify at-risk customers and recommend retention strategies.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-customer-churn-analytics',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Customer Churn Analytics</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Predictive analytics platform to identify at-risk customers and recommend retention strategies.</p>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Document Workflow Automation Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">End-to-end document workflow automation that handles creation, review, approval, signing, and archival. Template library, conditional routing, e-signature integration, and compliance audit trails.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Drag-and-drop workflow designer with conditional routing</li>
            <li>Document template library with dynamic field population</li>
            <li>E-signature integration (DocuSign, Adobe Sign, HelloSign)</li>
            <li>Approval chains with delegation and escalation</li>
            <li>Version control with full audit trail</li>
            <li>Automated archival with retention policy enforcement</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce document processing time by 80%</li>
            <li>Eliminate paper-based workflows entirely</li>
            <li>Ensure compliance with complete audit trails</li>
            <li>Accelerate contract cycles with automated routing</li>
        </ul>
      </section>

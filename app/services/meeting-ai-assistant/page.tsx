  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/meeting-ai-assistant` title="Meeting AI Assistant (Record, Transcribe, Summarize)" />
        <h1 className="text-4xl font-bold mb-6">Meeting AI Assistant (Record, Transcribe, Summarize)</h1>
        <p className="text-lg text-gray-300 mb-8">Automatic meeting assistant that records, transcribes with speaker ID, generates action items, decisions, and summaries; integrates with Zoom, Teams, Google Mee</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with meeting ai assistant (record, transcribe, summarize)</li>

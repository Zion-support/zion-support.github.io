    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Intelligent Document Processing (IDP)</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered document processing that extracts, classifies, and validates data from any document type. Handles invoices, contracts, forms, and unstructured documents with human-in-the-loop verification.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-format document ingestion (PDF, scan, email, image)</li>
            <li>AI classification with 99% accuracy</li>
            <li>Structured and unstructured data extraction</li>
            <li>Human-in-the-loop verification workflow</li>
            <li>ERP and accounting system integration</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Process documents 10x faster than manual entry</li>
            <li>Reduce data entry errors by 95%</li>
            <li>Free staff from repetitive document handling</li>
            <li>Scale document processing without hiring</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Patch Management &amp; Compliance Automation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automate OS and application patching across Windows, Linux, and macOS endpoints. Test patches in staging, enforce SLA timelines, generate compliance reports for SOC 2, HIPAA, and PCI DSS. Zero-touch patching for critical CVEs.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cross-platform patch deployment (Win/Linux/Mac)</li>
            <li>Staging ring testing before production</li>
            <li>Critical CVE auto-patch within 24h SLA</li>
            <li>Patch compliance reporting (SOC 2/HIPAA/PCI)</li>
            <li>Third-party app patching (Chrome, Java, etc.)</li>
            <li>Rollback capability for failed patches</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Close critical vulnerabilities within 24 hours</li>
            <li>Eliminate manual patch tracking spreadsheets</li>
            <li>Pass compliance audits with automated reports</li>
            <li>Reduce patch-related incidents by 90%</li>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Waitlist Manager</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Waitlist Manager is a product launch platform that manages waitlists with position tracking, referral incentive programs, and automated onboarding sequences. It helps businesses build hype, convert interested prospects into paying customers, and optimize their launch funnel.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Position tracking: real-time waitlist position with estimated access timing</li>
            <li>Referral incentives: reward users for referring friends with tiered perks</li>
            <li>Onboarding sequences: automated email and SMS campaigns to educate waitlisted users</li>
            <li>Custom branding: fully customizable waitlist page with your logo and colors</li>
            <li>Social sharing: one-click sharing to Twitter, LinkedIn, Facebook, and WhatsApp</li>
            <li>Analytics dashboard: track signups, referral rates, and conversion metrics</li>
            <li>Priority tiers: create VIP tiers with early access and exclusive benefits</li>
            <li>API access: integrate waitlist signup into your existing website or app</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce customer acquisition costs by 40% with viral referral incentives</li>
            <li>Improve launch conversion rates with automated onboarding sequences</li>
            <li>Scale with enterprise-grade infrastructure supporting millions of waitlist signups</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$15/mo (up to 1,000 waitlist signups)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$29/mo (up to 25,000 signups, referral program)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited signups, white-label, API access)</p>
          </div>
        </div>

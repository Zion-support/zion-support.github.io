  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/analytics-attribution-mix` title="Analytics Attribution &amp; Marketing Mix Modeling" />
        <h1 className="text-4xl font-bold mb-6">Analytics Attribution &amp; Marketing Mix Modeling</h1>
        <p className="text-lg text-gray-300 mb-8">Multi-touch attribution (first/last/linear/time-decay/position-based) + marketing mix modeling. CAC, LTV, ROAS per channel, campaign, cohort. Recommended budget</p>
        ...
        <div className="bg-slate-900 rounded-xl p-6 mb-8">
          ...
          <ul className="list-disc list-inside space-y-2">
            <li>Reduce costs with analytics attribution &amp; marketing mix modeling</li>

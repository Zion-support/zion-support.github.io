    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">BuildingOS — Smart Building IoT Management Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">BuildingOS is a comprehensive smart building IoT management platform that integrates HVAC, lighting, security, occupancy sensors, and energy systems into a single intelligent dashboard. Using AI-driven analytics, BuildingOS optimizes energy consumption by 25-40%, predicts equipment failures, and automatically adjusts building conditions based on occupancy patterns and weather forecasts.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Unified building dashboard: monitor HVAC, lighting, security, and energy from one interface</li>
            <li>AI energy optimization: automatically adjust systems based on occupancy, weather, and utility rates</li>
            <li>Predictive maintenance: ML models detect equipment anomalies 2-4 weeks before failure</li>
            <li>Digital twin: virtual building replica for simulation and what-if analysis</li>
            <li>Multi-protocol integration: connects to BACnet, Modbus, MQTT, LoRaWAN, and 100+ systems</li>
            <li>Sustainability reporting: automated ESG and carbon footprint reporting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce energy costs by 25-40% with AI-driven optimization</li>
            <li>Prevent equipment failures with predictive maintenance</li>
            <li>Manage 10,000+ buildings from a single platform</li>
            <li>Achieve sustainability goals with automated carbon tracking</li>
            <li>Improve occupant comfort through intelligent climate control</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$2/building/month (basic monitoring, email alerts)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$8/building/month (AI optimization, predictive maintenance)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (digital twin, API access, dedicated support)</p>
          </div>
        </div>

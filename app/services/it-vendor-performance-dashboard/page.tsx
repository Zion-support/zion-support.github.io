    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Vendor Performance Dashboard</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Tracks vendor SLA performance, ticket trends, and cost against contract terms with escalation routing and renewal preparation.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>SLA measurement and breach tracking</li>
            <li>Ticket and incident trend analysis</li>
            <li>Cost and value dashboards</li>
            <li>Escalation and exception routing</li>
            <li>Renewal readiness scorecards</li>
            <li>Contract metadata linkage</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Keep vendors accountable</li>
            <li>Reduce contract surprises</li>
            <li>Make renewals data-driven</li>
            <li>Improve procurement negotiation</li>
        </ul>
      </section>

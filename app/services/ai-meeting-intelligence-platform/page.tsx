    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Meeting Intelligence &amp; Summarization</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automatically transcribe, summarize, and extract action items from every meeting. AI identifies decisions, assigns follow-ups, and creates searchable meeting notes. Integrates with Zoom, Teams, and Google Meet. Never miss an action item again.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Decision tracking with context</li>
            <li>Integration with Zoom, Teams, Google Meet</li>
            <li>Searchable meeting archive with full-text search</li>
            <li>CRM sync for meeting notes (Salesforce, HubSpot)</li>
            <li>Custom templates for different meeting types</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Never lose track of decisions or action items</li>
            <li>Make meetings searchable across your organization</li>
            <li>Keep stakeholders aligned without manual note-taking</li>
        </ul>
      </section>

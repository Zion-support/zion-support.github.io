    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">NPS &amp; Customer Feedback Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Collect, analyze, and act on customer feedback at scale. AI-powered sentiment analysis, trend detection, and automated follow-up workflows. Supports NPS, CSAT, CES, and custom surveys across email, in-app, and web channels.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-channel survey delivery (email, in-app, web, SMS)</li>
            <li>AI sentiment analysis and theme extraction from open text</li>
            <li>Automated follow-up workflows for detractors</li>
            <li>Trend analysis with anomaly detection on feedback scores</li>
            <li>Benchmarking against industry NPS standards</li>
            <li>Integration with CRM, helpdesk, and product analytics</li>
            <li>Custom survey builder with logic branching</li>
            <li>Real-time alerts for negative feedback escalation</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Increase response rates with multi-channel delivery</li>
            <li>Turn feedback into action with automated workflows</li>
            <li>Detect emerging issues before they impact retention</li>
            <li>Benchmark customer satisfaction against industry peers</li>
        </ul>
      </section>

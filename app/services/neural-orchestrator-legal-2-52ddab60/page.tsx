...
export const metadata = {
  ...
  description: "Transform your legal operations with our Neural orchestrator-legal #2. This AI-driven solution automates quality control with unprecedented accuracy and efficie",
  alternates: {

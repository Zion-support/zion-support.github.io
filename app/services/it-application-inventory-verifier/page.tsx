    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Application Inventory Verifier</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Audits deployed applications, running services, and dependency maps for drift, orphan, and operational risk signals.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Discovery across endpoints and servers</li>
            <li>Dependency and data-flow mapping</li>
            <li>Orphan and shadow IT detection</li>
            <li>Version and patch comparison</li>
            <li>Risk score by app</li>
            <li>Executive inventory view</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce shadow app risk</li>
            <li>Keep estate inventories current</li>
            <li>Accelerate audit evidence</li>
            <li>Support vendor rationalization</li>
        </ul>
      </section>

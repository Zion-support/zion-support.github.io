...
export const metadata = {
  title: "Analyzer Intelligent - Insurance - Zion Tech Group",
  description: "Revolutionize insurance through intelligent automation. Our Analyzer Intelligent - Insurance leverages advanced machine learning to deliver predictive analytics",
  alternates: {
    canonical: `https://ziontechgroup.com/services/analyzer-intelligent---insurance-417d88a1`
  }
};

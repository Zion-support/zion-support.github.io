    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Cyber-Physical Security Convergence</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Unify IT security with physical data center controls: integrate SIEM, access control, CCTV/AI video, and environmental sensors into a single SOC 2 and ISO 27001 aligned security architecture.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>SIEM integration with physical access control systems</li>
            <li>Correlated alerting for cyber and physical threat events</li>
            <li>AI video analytics for tailgating and anomalous behavior</li>
            <li>Environmental sensor monitoring (water, smoke, HVAC)</li>
            <li>Unified audit logging for SOC 2 and ISO 27001</li>
            <li>Incident response runbook bridging ITSM and physical security</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect blended cyber-physical attack scenarios</li>
            <li>Streamline audit evidence across IT and facilities teams</li>
            <li>Reduce mean-time-to-detect with correlated intelligence</li>
            <li>Achieve Zero Trust from the cage to the cloud</li>
        </ul>
      </section>

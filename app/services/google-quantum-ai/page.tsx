    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Google Quantum AI — Willow Processor Access</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Google Quantum AI offers enterprise access to the Willow quantum processor, demonstrating below-threshold quantum error correction for the first time. Their quantum computing service enables research and early commercial applications in materials science, logistics optimization, and machine learning.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Willow processor with 105 physical qubits and breakthrough error rates</li>
            <li>Cirq open-source quantum computing framework</li>
            <li>TensorFlow Quantum for hybrid quantum-classical ML</li>
            <li>Fermionic simulation for chemistry and materials science</li>
            <li>Strategic research partnership program with dedicated support</li>
            <li>Integration with Google Cloud for hybrid compute workflows</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>First commercial access to below-threshold error correction</li>
            <li>Quantum machine learning model training with exponential speedups</li>
            <li>Materials discovery simulation impossible on classical hardware</li>
            <li>Roadmap collaboration for future 1000+ logical qubit systems</li>
            <li>Joint research publication and IP sharing opportunities</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Research partnership only</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">Custom (enterprise program)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom ($500K+/year)</p>
          </div>
        </div>

export const metadata = {title: 'Ai Finance Analyzer | Zion Tech Group',description: 'Professional ai finance analyzer services for your business needs.',keywords: 'ai-finance-analyzer, services, business, technology';

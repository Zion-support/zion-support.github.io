...
export const metadata = {
  title: "Anthropic - Zion Tech Group",
  description: "Anthropic, PBC is an American artificial intelligence (AI) public benefit corporation headquartered in San Francisco, California. Its flagship product is Claude",
  alternates: {
    canonical: `https://ziontechgroup.com/services/anthropic-4c283164`
  }
};

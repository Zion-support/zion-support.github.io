        ...
        <div className="text-left">"
          <div className="text-left">"
            ...
            <ul className="text-left">"
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Lead scoring and qualification<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Customer lifetime value prediction<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Campaign performance optimization<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Market segmentation analysis<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Churn prediction and prevention<
              </li>
            </ul>
          </div>
          ...
          <div className="text-left">"
            ...
            <ul className="text-left">"
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Financial forecasting and budgeting<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
              ...
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Risk assessment and management<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
          ...
          <div className="text-left">"
            ...
            <ul className="text-left">"
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Employee performance analytics<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Turnover prediction<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Recruitment optimization<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Skills gap analysis<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Workforce planning<
              </li>
            </ul>
          </div>
          ...
          <div className="text-left">"
            ...
            <ul className="text-left">"
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Customer satisfaction analysis<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Support ticket prediction<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Personalization insights<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Product recommendation engine<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Customer journey optimization<
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="text-left">"
          <div className="text-left">"
            ...
            <ul className="text-left">"
              ...
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Basic dashboards<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Standard reports<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Email support<
          ...
          <div className="text-left">"
            ...
            <ul className="text-left">"
              ...
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Unlimited data sources<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"
                <span>Advanced dashboards<
              </li>
              <li className="text-left">"
                <span className="text-left">✓<"

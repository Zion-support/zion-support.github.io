    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Meeting Alchemy</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Turns meeting artifacts into structured datasets: action items, owners, deadlines, decisions, and sentiment for business intelligence use.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Meeting artifact ingestion</li>
            <li>Action and decision extraction</li>
            <li>Owner-deadline dataset generation</li>
            <li>Sentiment tagging</li>
            <li>BI/CRM export options</li>
            <li>Privacy-aware handling</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Turn meetings into usable data</li>
            <li>Connect discussion to execution</li>
            <li>Feed CRM and PM tools</li>
            <li>Keep history searchable</li>
        </ul>
      </section>

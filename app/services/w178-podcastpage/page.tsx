    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">PodcastPage — Podcast Hosting</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">All-in-one podcast hosting: upload, distribute, analytics, monetization. RSS feed and website.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Distribution to Apple, Spotify, Google</li>
            <li>Listener analytics and demographics</li>
            <li>Monetization (ads, subscriptions)</li>
            <li>Podcast website with player</li>
            <li>Integration with Buzzsprout, Libsyn, Anchor</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>All-in-one podcast platform</li>
            <li>Distribution to every major platform</li>
            <li>Analytics reveal listener demographics</li>
            <li>Monetization built in</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$12/mo</p>
          </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Advanced Form Builder &amp; Workflow</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">No-code form builder with conditional logic, payment collection, file uploads, and workflow automation. Multi-step forms, calculated fields, and 50+ integrations for lead generation, surveys, and applications.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Drag-and-drop form builder with 40+ field types</li>
            <li>Conditional logic with branching and calculated fields</li>
            <li>Payment collection with Stripe and PayPal integration</li>
            <li>Multi-step forms with progress indicators and save-resume</li>
            <li>Workflow automation with email, webhook, and CRM actions</li>
            <li>Analytics dashboard with conversion and drop-off tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Build complex forms without writing code</li>
            <li>Increase completion rates with multi-step UX</li>
            <li>Automate lead routing and follow-up workflows</li>
            <li>Collect payments alongside form submissions</li>
        </ul>
      </section>

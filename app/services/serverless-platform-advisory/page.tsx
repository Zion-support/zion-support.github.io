    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Serverless Architecture &amp; Platform Advisory</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Design and migrate to event-driven serverless architectures on AWS, Azure, and GCP. Reduce operational overhead with managed functions, queues, and storage. Includes cost modeling and reliability trade-off analysis.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Event-driven architecture design and implementation</li>
            <li>Function-as-a-Service migration and refactoring</li>
            <li>Managed queue and stream architecture (SQS, EventBridge, Pub/Sub)</li>
            <li>Cold start optimization and performance tuning</li>
            <li>Observability and tracing for distributed serverless workloads</li>
            <li>Cost modeling and capacity planning for variable traffic</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce infrastructure management overhead by 80%</li>
            <li>Scale to millions of users with zero capacity planning</li>
            <li>Pay only for compute you consume — often 40-60% cheaper</li>
            <li>Improve resilience with managed retries, DLQs, and multi-region failover</li>
        </ul>
      </section>

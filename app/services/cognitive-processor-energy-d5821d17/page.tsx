...
export const metadata = {
  ...
  description: "The future of energy is here with Cognitive processor-energy. Powered by cutting-edge AI, this platform delivers document processing like never before.",
  alternates: {

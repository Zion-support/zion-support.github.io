    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>N1 implant: 1,024 electrodes on 64 ultra-thin flexible threads</li>
            <li>Wireless charging and Bluetooth data transmission — no external wires</li>
            <li>Precision Robotics surgical robot for minimally invasive implantation</li>
            <li>First human patients control computers, play games, browse web via thought</li>
            <li>FDA Breakthrough Device designation for paralysis and neurological conditions</li>
            <li>Future applications: vision restoration, memory enhancement, depression treatment</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Restore independence to paralyzed patients — control devices with thought</li>
            <li>Treat previously incurable neurological conditions (ALS, Parkinson\\</li>
            <li>,
      </li>
            <li>,
      </li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Clinical trial participation</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">Medical device program (hospital partnership)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Research licensing (custom)</p>
          </div>
        </div>

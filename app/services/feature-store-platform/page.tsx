    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">ML Feature Store Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enterprise feature store that manages the complete ML feature lifecycle — creation, storage, versioning, serving, and monitoring. Ensures training-serving skew elimination and feature reuse across teams.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Centralized feature registry with versioning and lineage</li>
            <li>Online and offline feature serving with sub-ms latency</li>
            <li>Training-serving skew detection and alerting</li>
            <li>Feature sharing with access control across teams</li>
            <li>Point-in-time correct feature joins for backtesting</li>
            <li>Feature freshness monitoring with SLA dashboards</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate training-serving skew that degrades model accuracy</li>
            <li>Accelerate model development with reusable features</li>
            <li>Ensure regulatory compliance with full feature lineage</li>
            <li>Scale feature engineering across teams without duplication</li>
        </ul>
      </section>

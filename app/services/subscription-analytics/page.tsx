    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Subscription Analytics &amp; Billing Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">SaaS metrics and billing platform that tracks MRR, ARR, churn, LTV, and cohort analysis. Integrated billing with Stripe and Chargebee, dunning management, and revenue recognition automation.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>MRR/ARR tracking with expansion, contraction, and churn breakdown</li>
            <li>Cohort analysis with retention and revenue curves</li>
            <li>LTV prediction with payback period calculation</li>
            <li>Automated dunning with customizable retry logic</li>
            <li>Revenue recognition automation for ASC 606 compliance</li>
            <li>Investor-ready metrics dashboard with export</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Understand true unit economics with accurate LTV:CAC</li>
            <li>Reduce involuntary churn with smart dunning</li>
            <li>Automate revenue recognition for audit compliance</li>
            <li>Report to investors with confidence using accurate metrics</li>
        </ul>
      </section>

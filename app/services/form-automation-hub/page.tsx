    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Form Automation Hub</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Form Automation Hub is a powerful form builder and workflow automation platform featuring conditional logic, 50+ integrations, and multi-step workflows. It replaces paper forms, spreadsheets, and manual processes with intelligent digital forms that route data automatically.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Conditional logic: show/hide fields based on user responses for smart forms</li>
            <li>50+ integrations: connect to Slack, Google Sheets, Salesforce, Zapier, and more</li>
            <li>Multi-step workflows: route form submissions through approval chains automatically</li>
            <li>File uploads: support for documents, images, and signatures within forms</li>
            <li>Calculated fields: auto-compute totals, scores, and conditional outputs</li>
            <li>Mobile-responsive forms: forms that work perfectly on any device or screen size</li>
            <li>Data validation: real-time validation with custom error messages and rules</li>
            <li>Analytics &amp; reporting: track completion rates, drop-off points, and submission trends</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce form processing costs by 65% with automated workflows and integrations</li>
            <li>Improve data collection efficiency by replacing paper forms with smart digital forms</li>
            <li>Scale with enterprise-grade infrastructure supporting unlimited submissions and users</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$15/mo (up to 5 users, 1,000 submissions/month)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$39/mo (up to 25 users, 10,000 submissions/month)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited users, custom integrations, dedicated infrastructure)</p>
          </div>
        </div>

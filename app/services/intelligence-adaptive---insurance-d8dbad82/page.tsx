...
export const metadata = {
  title: "Intelligence Adaptive - Insurance - Zion Tech Group",
  description: "Revolutionize insurance through intelligent automation. Our Intelligence Adaptive - Insurance leverages advanced machine learning to deliver workflow management",
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligence-adaptive---insurance-d8dbad82`
  }
};

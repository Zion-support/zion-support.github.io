...
export const metadata = {
  title: "Insights AI - Finance - Zion Tech Group",
  description: "Unlock unprecedented growth with Insights AI - Finance. This autonomous system provides risk assessment with zero manual intervention needed.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/insights-ai---finance-50af629a`
  }
};

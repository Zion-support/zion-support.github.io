...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/w178-ai-invoice-process',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Invoice Processing</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automated invoice processing: line-item extraction, approval routing, GL coding, ERP posting.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Line-item extraction from any format</li>
            <li>GL code auto-assignment</li>
            <li>Approval workflow routing</li>
            <li>Three-way matching (PO, receipt, invoice)</li>
            <li>Duplicate detection</li>
            <li>Integration with NetSuite, SAP, QuickBooks</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce processing cost 70%</li>
            <li>GL coding automation</li>
            <li>Three-way matching prevents overpayment</li>
            <li>Duplicate detection catches errors</li>
        </ul>
      </section>

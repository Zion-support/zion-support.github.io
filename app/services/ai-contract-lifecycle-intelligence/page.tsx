  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/ai-contract-lifecycle-intelligence` title="Contract Lifecycle Intelligence" />
        <h1 className="text-4xl font-bold mb-6">Contract Lifecycle Intelligence</h1>
        <p className="text-lg text-gray-300 mb-8">AI contract lifecycle management: extract clauses and dates, auto-flag risk, renewal calendar, benchmark against market terms, amendment tracker across 200+ con</p>

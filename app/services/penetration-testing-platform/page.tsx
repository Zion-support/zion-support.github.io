    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Automated Penetration Testing Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Continuous automated penetration testing platform that simulates real-world attacks on web applications, APIs, and networks. AI-driven vulnerability discovery with prioritized remediation guidance.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated web application and API scanning</li>
            <li>AI-driven attack simulation with exploit chaining</li>
            <li>Network vulnerability assessment with service discovery</li>
            <li>Prioritized remediation with CVSS and business context</li>
            <li>Continuous testing with scheduled and on-demand scans</li>
            <li>Compliance reporting for PCI-DSS, SOC2, and ISO 27001</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Reduce pen testing costs by 80% with automation</li>
            <li>Maintain continuous security posture with scheduled scans</li>
            <li>Meet compliance requirements with automated reporting</li>
        </ul>
      </section>

...
export const metadata = {
  title: "Management AI - Retail - Zion Tech Group",
  description: "Transform your retail operations with our Management AI - Retail. This AI-driven solution automates compliance monitoring with unprecedented accuracy and effici",
  alternates: {
    canonical: `https://ziontechgroup.com/services/management-ai---retail-116ec4cf`
  }
};

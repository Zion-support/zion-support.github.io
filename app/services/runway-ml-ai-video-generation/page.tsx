    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Runway ML — AI Video Generation Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Runway ML is the leading AI video generation and editing platform that enables creators, filmmakers, and marketers to produce professional-quality video content using generative AI. Its Gen-3 Alpha model produces cinematic-quality video from text prompts, images, and reference videos. Used by 3 million+ creators and major studios including Marvel, BBC, and Samsung.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Gen-3 Alpha text-to-video: generate cinematic video from text prompts</li>
            <li>Image-to-video: animate still images with natural motion and camera movement</li>
            <li>30+ AI Magic Tools: object removal, motion tracking, green screen, style transfer</li>
            <li>Real-time video editing: AI-powered editing tools with instant preview</li>
            <li>Team collaboration: shared projects, version history, and review workflows</li>
            <li>API access: integrate generative models into custom applications</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Produce professional video content 10x faster without expensive equipment</li>
            <li>Trusted by 3 million+ creators and major studios including Marvel, BBC, and Samsung</li>
            <li>Reduce video production costs by 90% compared to traditional filming</li>
            <li>Iterate instantly: generate multiple video variations in minutes</li>
            <li>Democratize video creation: anyone can produce cinematic content without expertise</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (125 credits, 5GB assets, 720p)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$15/month (625 credits, 100GB, 4K)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited credits, team seats, API access)</p>
          </div>
        </div>

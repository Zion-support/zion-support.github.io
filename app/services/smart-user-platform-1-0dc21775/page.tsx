...
export const metadata = {
  title: "Smart User Platform #1 - Zion Tech Group",
  description: "Next-generation sports solution: Smart User Platform #1. Combines data processing with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/smart-user-platform-1-0dc21775`
  }
};

...
export const metadata = {
  title: "Neural engine-finance - Zion Tech Group",
  description: "Revolutionize finance through intelligent automation. Our Neural engine-finance leverages advanced machine learning to deliver image recognition at scale.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/neural-engine-finance-b7a6a4a5`
  }
};

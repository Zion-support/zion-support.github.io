...
export const metadata = {
  ...
  description: "Production image generation with fine-tuned models, brand consistency, style presets, and batch processing. Generate marketing assets, product images, and socia",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Production image generation with fine-tuned models, brand consistency, style presets, and batch processing. Generate marketing assets, product images, and socia</p>

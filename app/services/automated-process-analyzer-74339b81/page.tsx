...
export const metadata = {
  title: "Automated Process Analyzer - Zion Tech Group",
  description: "The future of Retail is here with Automated Process Analyzer. Powered by cutting-edge AI, this platform delivers process discovery like never before.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/automated-process-analyzer-74339b81`
  }
};

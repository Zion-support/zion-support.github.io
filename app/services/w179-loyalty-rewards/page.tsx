...
export const metadata = {
  ...
  description: 'Build customer loyalty programs: points, tiers, rewards, referrals. Increase repeat purchases.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/w179-loyalty-rewards',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">LoyaltyPlus - Loyalty Program</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Build customer loyalty programs: points, tiers, rewards, referrals. Increase repeat purchases.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Points and tier-based rewards</li>
            <li>Referral program integration</li>
            <li>Custom reward catalog</li>
            <li>Analytics on program performance</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Referral programs drive new customers</li>
            <li>Custom rewards for your business</li>
        </ul>
      </section>

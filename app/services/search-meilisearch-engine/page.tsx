    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Meilisearch Instant Search Engine</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Lightning-fast, typo-tolerant search engine for modern applications. Delivers relevant results in under 50ms with built-in faceting, filtering, geosearch, and AI-powered relevance tuning. Drop-in replacement for Elasticsearch at 1/10th the cost.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Typo-tolerant search with intelligent ranking</li>
            <li>Faceted navigation and filtering</li>
            <li>Geosearch with radius and polygon filters</li>
            <li>AI-powered relevance tuning and synonyms</li>
            <li>Multi-tenant search indexes</li>
            <li>Real-time indexing with zero downtime</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Deliver search results in under 50ms</li>
            <li>Reduce infrastructure costs vs Elasticsearch by 90%</li>
            <li>Improve conversion rates with better search relevance</li>
            <li>Deploy in minutes with managed cloud hosting</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI-Ready Data Center Infrastructure &amp; Colocation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Design, deploy, and optimize data centers for AI and GPU-heavy workloads. High-density power, advanced cooling, and scalable rack solutions tailored for LLM training, inference, and HPC clusters.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>High-density colocation (40–100+ kW per rack)</li>
            <li>GPU cluster deployment and power distribution</li>
            <li>Direct-to-chip and immersion cooling design</li>
            <li>AI workload profiling and right-sizing</li>
            <li>Interconnect planning for 400G/800G/1.6T networking</li>
            <li>Hyperscale and edge facility load balancing</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Run AI training clusters without thermal throttling</li>
            <li>Reduce power and cooling costs by up to 30%</li>
            <li>Future-proof facilities for next-gen accelerators</li>
            <li>Achieve 99.999% uptime for mission-critical AI workloads</li>
        </ul>
      </section>

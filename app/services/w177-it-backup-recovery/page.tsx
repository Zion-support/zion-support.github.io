    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Policy-driven backups, point-in-time recovery, and DR runbooks for SaaS and infrastructure with RPO/RTO guarantees.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Policy-driven backup schedules</li>
            <li>Point-in-time recovery</li>
            <li>DR runbooks and testing</li>
            <li>Cross-region replication</li>
            <li>RPO/RTO reporting</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce data loss risk</li>
            <li>Meet recovery objectives</li>
            <li>Operationalize DR with runbooks</li>
            <li>Retention compliance without guesswork</li>
        </ul>
      </section>

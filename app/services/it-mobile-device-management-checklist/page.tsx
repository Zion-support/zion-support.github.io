    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Mobile Device Management Checklist</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enforces consistent MDM policies, compliance checks, and audit evidence across phones, tablets, and kiosks.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Device enrollment checks</li>
            <li>Policy and compliance verification</li>
            <li>OS update tracking</li>
            <li>App allowlisting review</li>
            <li>Loss and wipe readiness</li>
            <li>Executive device posture reporting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce mobile device risk</li>
            <li>Keep compliance visible</li>

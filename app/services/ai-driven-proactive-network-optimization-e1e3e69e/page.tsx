  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Intelligent network management platform that uses proactive algorithms to optimize traffic routing, capacity planning, and quality of service across telecom inf</p>

...
export const metadata = {
  title: "Edge-Native Adaptive Energy Processing - Zion Tech Group",
  description: "Edge-native processing layer that delivers adaptive energy insights with sub-millisecond latency.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/edge-native-adaptive-energy-processing-c5a59f3e`
  }
};

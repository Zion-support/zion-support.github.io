    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS AI Change Note Compiler</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Compiles product and policy change notes, release summaries, and customer-facing update drafts from scattered sources.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Change extraction and classification</li>
            <li>Release note drafting</li>
            <li>Policy and compliance phrasing checks</li>
            <li>Publication scheduling</li>
            <li>Export and routing</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce manual release note work</li>
            <li>Keep communications consistent</li>
            <li>Accelerate customer updates</li>
            <li>Support policy-aware wording</li>
        </ul>
      </section>

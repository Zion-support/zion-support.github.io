  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">Project Management Suite</h1>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          All-in-one project management platform with AI-powered insights, team collaboration, 
          and advanced analytics to keep your projects on track and profitable.
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-xl p-8 mb-16">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Why Choose Our Project Management Suite?</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="text-center">
            <div className="text-4xl mb-4">⚡</div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">30% Faster Delivery</h3>
            <p className="text-gray-600">AI-optimized workflows reduce project completion time</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">💰</div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">25% Cost Savings</h3>
            <p className="text-gray-600">Better resource allocation and risk management</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">📊</div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Real-time Analytics</h3>
            <p className="text-gray-600">Comprehensive dashboards and reporting</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">🔗</div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Easy Integrations</h3>
            <p className="text-gray-600">Connect with 100+ popular business tools</p>
          </div>
        </div>
      </div>
...
function PricingCard({ name, price, duration, features, popular }: { 
  ...
  return (
    <div className={`relative bg-white border-2 rounded-xl p-8 ${popular ? 'border-orange-500 shadow-lg' : 'border-gray-200'}`}>
      {popular && (
...
function ContactSection() {
  return (
    <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-200 rounded-xl p-8 text-center">
      <h3 className="text-2xl font-bold text-gray-900 mb-4">Ready to Streamline Your Project Management?</h3>
      <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
        Let's discuss your project management needs and create a solution that boosts team productivity and project success.
      </p>

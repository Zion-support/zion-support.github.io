    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Project Management Suite</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">All-in-one project management platform with Gantt charts, Kanban boards, time tracking, resource planning, and client portals. Built for agencies and IT teams managing multiple concurrent projects.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Gantt charts with critical path analysis and dependency mapping</li>
            <li>Kanban boards with WIP limits, swimlanes, and automation rules</li>
            <li>Time tracking with billable hours, timesheets, and payroll export</li>
            <li>Resource planning with capacity forecasting and workload balancing</li>
            <li>Client portal with branded sharing, approval workflows, and comments</li>
            <li>Custom fields, templates, and automation recipes</li>
            <li>Integrations: Slack, GitHub, Google Drive, Zapier, 50+ more</li>
            <li>Advanced reporting: burndown charts, velocity, ROI tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Deliver projects 30% faster with visual planning and automation</li>
            <li>Reduce meeting time by 40% with async client collaboration</li>
            <li>Increase billable utilization by 25% with accurate time tracking</li>
            <li>Scale from 5 to 500 users without switching platforms</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$29/mo (5 users, 10 projects)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$79/mo (25 users, unlimited projects)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$199/mo (unlimited users, SSO, API)</p>
          </div>
        </div>

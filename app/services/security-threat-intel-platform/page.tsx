    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Threat Intelligence Platform Management &amp; Monitoring</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Managed Threat Intelligence Platform that aggregates, enriches, and operationalizes threat data from commercial, open-source, and internal feeds. AI correlates threats to your infrastructure and prioritizes by relevance.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-source feed aggregation (commercial + OSINT)</li>
            <li>AI threat correlation to your infrastructure</li>
            <li>IOC enrichment (IPs, domains, hashes, TTPs)</li>
            <li>Automated alert generation for relevant threats</li>
            <li>Integration with SIEM, EDR, firewalls</li>
            <li>Weekly threat briefings and reports</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Know about threats targeting your industry first</li>
            <li>Prioritize threats by relevance to your infra</li>
            <li>Enrich SIEM alerts with threat context</li>
            <li>Proactive defense, not reactive</li>
            <li>Data-driven security investment decisions</li>
        </ul>
      </section>

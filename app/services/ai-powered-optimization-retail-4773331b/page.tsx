...
export const metadata = {
  ...
  description: "Next-generation retail solution: AI-Powered optimization-retail. Combines maintenance scheduling with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-optimization-retail-4773331b`
  }
};

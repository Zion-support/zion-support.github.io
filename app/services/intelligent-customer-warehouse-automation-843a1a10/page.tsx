...
export const metadata = {
  title: "Intelligent Customer Warehouse Automation - Zion Tech Group",
  ...
  alternates: {
    canonical: `https://ziontechgroup.com/services/intelligent-customer-warehouse-automation-843a1a10`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Healthcare Data Interoperability Hub</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">HL7 FHIR-compliant data integration platform that connects EHRs, labs, pharmacies, and medical devices. Real-time data exchange with patient identity matching and consent management.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>HL7 FHIR R4 compliant API gateway</li>
            <li>Patient identity matching across systems</li>
            <li>Real-time data exchange with event streaming</li>
            <li>Consent management with patient preferences</li>
            <li>Lab results integration with LOINC mapping</li>
            <li>Medical device data ingestion (IoT/IoMT)</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Break down data silos across healthcare systems</li>
            <li>Enable coordinated care with unified patient records</li>
            <li>Meet interoperability mandates (21st Century Cures Act)</li>
            <li>Reduce manual data entry and transcription errors</li>
        </ul>
      </section>

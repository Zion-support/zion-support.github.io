    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Digital Twin &amp; Simulation-as-a-Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Create living digital replicas of physical assets, production lines, or supply chains for simulation, optimization, and predictive insights. Supports real-time telemetry, scenario planning, and what-if analysis.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Physics-based simulation and surrogate modeling</li>
            <li>Real-time telemetry ingestion and state synchronization</li>
            <li>What-if scenario planning and sensitivity analysis</li>
            <li>Virtual commissioning and process optimization</li>
            <li>Integration with SCADA, MES, and ERP systems</li>
            <li>3D visualization and immersive review environments</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce physical prototyping and testing costs by 60%</li>
            <li>Predict failures before they occur on real assets</li>
            <li>Optimize processes without disrupting production</li>
            <li>Accelerate innovation cycles with rapid virtual iterations</li>
        </ul>
      </section>

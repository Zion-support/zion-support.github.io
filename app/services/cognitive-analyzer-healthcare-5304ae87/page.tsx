...
export const metadata = {
  ...
  description: "The future of healthcare is here with Cognitive analyzer-healthcare. Powered by cutting-edge AI, this platform delivers quality control like never before.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-analyzer-healthcare-5304ae87`
  }
};

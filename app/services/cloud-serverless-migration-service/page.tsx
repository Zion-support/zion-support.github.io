  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Migrate from VMs/serverful to serverless (AWS Lambda, Cloud Functions, Azure Functions). Auto-assess refactoring needs, rewrite code, and optimize cold starts. </p>

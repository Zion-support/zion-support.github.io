    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">PostgreSQL Database Solutions</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">PostgreSQL is the world</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Full ACID compliance with MVCC for reliable concurrent access</li>
            <li>Advanced SQL: CTEs, window functions, lateral joins, recursive queries, JSON/JSONB with indexing</li>
            <li>1,000+ extensions: PostGIS (geospatial), TimescaleDB (time-series), pgvector (AI vector search)</li>
            <li>Built-in full-text search with ranking, stemming, and 30+ language dictionaries</li>
            <li>Streaming replication, point-in-time recovery (PITR), logical replication</li>
            <li>Kubernetes operators (CrunchyData, Zalando, CloudNativePG) for containerized deployments</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminates expensive commercial database licensing (Oracle $47,500+/core, SQL Server $15,000+/core)</li>
            <li>pgvector extension turns PostgreSQL into a vector database for AI/ML, replacing Pinecone ($70+/mo)</li>
            <li>Free at any scale with zero per-core or per-seat fees</li>
            <li>Most-loved database in Stack Overflow developer surveys, powers Apple, Spotify, Instagram</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$5/mo (managed)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">

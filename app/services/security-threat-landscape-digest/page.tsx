    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Threat Landscape Digest Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Aggregates threat feeds, CVE data, and industry telemetry into concise executive and analyst digests for faster decisions.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>CVE and threat feed aggregation</li>
            <li>Industry-relevant threat framing</li>
            <li>Executive and analyst summaries</li>
            <li>Mitigation prioritization</li>
            <li>Integration with incident workflow</li>
            <li>Daily and weekly delivery options</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce threat analysis time</li>
            <li>Keep leadership informed</li>
            <li>Focus teams on relevant threats</li>
            <li>Improve readiness posture</li>
        </ul>
      </section>

...
export const metadata = {
  title: "AI-Powered Smart Marketing Analytics - Zion Tech Group",
  description: "AI-driven analytics platform that delivers smart insights into marketing operations, providing real-time monitoring, predictive modeling, and automated reportin",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-smart-marketing-analytics-966fba28`
  }
};

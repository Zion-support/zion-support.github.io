    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Hardware Lifecycle Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Plan, execute, and track hardware refresh cycles from procurement to decommission. IT asset disposition (ITAD), secure data wiping, resale value recovery, and sustainability reporting. Avoid unplanned outages from aging infrastructure.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Hardware inventory and lifecycle heat maps by asset class</li>
            <li>Predictive refresh scheduling based on warranty and failure risk</li>
            <li>Secure data wiping (NIST 800-88) and chain-of-custody logging</li>
            <li>ITAD vendor management, pickup, and disposal/reuse workflows</li>
            <li>Asset resale and remarketing channel optimization</li>
            <li>Environmental impact reporting (e-waste diverted, CO2 avoided)</li>
            <li>Procurement forecasting tied to capacity and growth model</li>
            <li>Compliance audit trails for SOC 2, ISO 27001, and GDPR</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce unplanned outages by 90% with proactive hardware refresh</li>
            <li>Recover 40-60% of original asset value through remarketing</li>
            <li>Simplify audit readiness with chain-of-custody and wiping evidence</li>
            <li>Cut e-waste and improve sustainability reporting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$2,200/mo</p>
          </div>
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$22,000+/mo</p>
          </div>
        </div>

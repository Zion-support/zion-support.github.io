...
export default function AIContentOptimizerPage() {
  return (
    <section>
      ...
      <p style={{ marginTop: 8, color: '#374151' }}>Transform your content marketing with AI that writes, optimizes, and distributes content that converts at scale.</p>
      ...
      <div style={{ marginTop: 24, padding: 16, backgroundColor: '#f0fdf4', borderRadius: 12, border: '1px solid #22c55e' }}>
        <h3 style={{ fontWeight: 700, color: '#14532d', marginBottom: 8 }}>Proven Results</h3>
        <ul style={{ color: '#14532d', paddingLeft: 18 }}>
          <li>• <strong>400% increase</strong> in content engagement rates</li>
          <li>• <strong>250% boost</strong> in organic search traffic</li>
          <li>• <strong>80% reduction</strong> in content creation time</li>
          <li>• <strong>95% accuracy</strong> in SEO optimization</li>
        </ul>
      </div>
    </section>
  );
...
function Plan({ name, price, features }: { name: string; price: string; features: string[] }) {
  return (
    <div style={{ border: '1px solid #e5e7eb', borderRadius: 12, padding: 16 }}>
      ...
      <a href="mailto:kleber@ziontechgroup.com" style={{ display: 'inline-block', marginTop: 12, padding: '8px 16px', backgroundColor: '#3b82f6', color: 'white', textDecoration: 'none', borderRadius: 6 }}>Email Us</a>
    </div>
  );
}

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">BookingLite — Appointment Scheduling</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Simple appointment scheduling: online booking, calendar sync, reminders, payments.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Buffer time and max-to-book limits</li>
            <li>Integration with Calendly, Stripe, Zoom</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Calendar sync prevents double-booking</li>
            <li>Reminders reduce no-shows</li>
            <li>Payment at booking reduces cancellations</li>
        </ul>
      </section>

...
export const metadata = {
  ...
  description: "Plan and manage events with AI assistance. From venue selection to attendee engagement, automate logistics, budgeting, and marketing for conferences, webinars, ",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Plan and manage events with AI assistance. From venue selection to attendee engagement, automate logistics, budgeting, and marketing for conferences, webinars, </p>

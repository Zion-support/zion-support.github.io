...
export const metadata = {
  ...
  description: "Site Reliability Engineering platform: SLO definition, error budgets, incident management, chaos engineering, and reliability dashboards. Ship features without ",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Site Reliability Engineering platform: SLO definition, error budgets, incident management, chaos engineering, and reliability dashboards. Ship features without </p>

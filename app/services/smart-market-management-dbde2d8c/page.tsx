...
export const metadata = {
  title: "Smart Market Management - Zion Tech Group",
  description: "Next-generation legal solution: Smart Market Management. Combines energy management with adaptive intelligence for optimal results.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/smart-market-management-dbde2d8c`
  }
};

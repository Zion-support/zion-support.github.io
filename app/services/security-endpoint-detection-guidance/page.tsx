    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Endpoint Detection &amp; Response Guidance</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Advises EDR placement, tuning, and alert triage workflows with mapping to MITRE ATT&amp;CK and incident playbooks.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>EDR placement review</li>
            <li>Alert tuning recommendations</li>
            <li>MITRE ATT&amp;CK mapping</li>
            <li>Playbook pairing guidance</li>
            <li>Telemetry gap analysis</li>
            <li>Executive readiness summary</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Keep incident response coherent</li>
            <li>Make tooling investment clearer</li>
        </ul>
      </section>

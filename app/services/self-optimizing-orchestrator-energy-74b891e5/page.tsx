...
export const metadata = {
  ...
  description: "Transform your energy operations with our Self-Optimizing orchestrator-energy. This AI-driven solution automates user experience with unprecedented accuracy and",
  alternates: {

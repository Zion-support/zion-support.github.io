    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Event Registration &amp; Ticketing Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Launch and manage events with a lightweight registration and ticketing platform. Custom event pages, Stripe payment collection, attendee management, check-in apps, and post-event analytics. Perfect for workshops, conferences, and webinars.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Production-ready Micro-SaaS Event Registration &amp; Ticketing Platform implementation</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Launch an event page in under 10 minutes</li>
            <li>Collect payments with Stripe at checkout</li>
            <li>Manage attendees and send updates</li>
            <li>Check in attendees with mobile app</li>
            <li>Know what worked with post-event analytics</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center NOC Staffing &amp; Managed Operations</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">24/7 NOC staffing, remote hands, smart hands, and managed infrastructure services. Augment or fully outsource data center operations with certified technicians and DC-aware monitoring toolchains.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>24/7 Tier 1–3 NOC staffing with shift coverage</li>
            <li>Remote hands for hardware swaps, cabling, and patching</li>
            <li>Smart hands for complex installs and break-fix</li>
            <li>DC-aware monitoring integrations (Datadog, SolarWinds, PRTG)</li>
            <li>On-call escalation and vendor management</li>
            <li>ITIL-aligned incident and change management</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate overnight coverage gaps and burnout</li>
            <li>Reduce mean-time-to-repair with guaranteed SLAs</li>
            <li>Access specialized data center skills on demand</li>
            <li>Cut operational headcount costs by 30–50%</li>
        </ul>
      </section>

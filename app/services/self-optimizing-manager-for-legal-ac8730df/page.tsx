...
export const metadata = {
  title: "Self-Optimizing Manager for Legal - Zion Tech Group",
  description: "The future of legal is here with Self-Optimizing Manager for Legal. Powered by cutting-edge AI, this platform delivers supply chain like never before.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/self-optimizing-manager-for-legal-ac8730df`
  }
};

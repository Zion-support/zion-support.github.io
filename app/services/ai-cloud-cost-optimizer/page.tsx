  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/ai-cloud-cost-optimizer` title="AI Cloud Cost Optimizer" />
        <h1 className="text-4xl font-bold mb-6">AI Cloud Cost Optimizer</h1>
        <p className="text-lg text-gray-300 mb-8">ML-powered cloud cost optimizer: continuously rightsizes VMs, containers, serverless across AWS/GCP/Azure — reducing cloud spend 30-50% with zero manual interve</p>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">MemberPort — Membership Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Manage members: directory, dues, events, communications, renewals. For associations and clubs.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Dues and payment tracking</li>
            <li>Event management and RSVP</li>
            <li>Email and SMS communications</li>
            <li>Renewal automation</li>
            <li>Integration with Stripe, Mailchimp, QuickBooks</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Member directory always current</li>
            <li>Dues tracking and automated renewals</li>
            <li>Event management built in</li>
            <li>Communication tools for engagement</li>
        </ul>
      </section>

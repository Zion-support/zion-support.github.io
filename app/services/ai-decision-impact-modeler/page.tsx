    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Decision Impact Modeler</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Estimates downstream impact of decisions on costs, timelines, and risk so teams choose options with explicit evidence.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Decision input modeling</li>
            <li>Cost and timeline impact estimates</li>
            <li>Risk probability and severity</li>
            <li>Scenario comparison views</li>
            <li>Approval evidence records</li>
            <li>Executive summary outputs</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce decision reversal cost</li>
            <li>Keep options evidence-based</li>
            <li>Improve executive confidence</li>
            <li>Connect actions to business outcomes</li>
        </ul>
      </section>

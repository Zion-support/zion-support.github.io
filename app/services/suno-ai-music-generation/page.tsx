    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Suno AI — Text-to-Music Generation Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Suno AI is a generative music platform that creates complete original songs — vocals, instruments, and production — from text prompts. Users describe a style, mood, or concept in natural language and Suno produces a broadcast-ready 2-4 minute track. With 10 million+ users, Suno is democratizing music production for content creators, game developers, advertisers, and independent artists who lack traditional music production resources.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Text-to-song: describe any genre, mood, or concept in natural language</li>
            <li>Full vocal generation: AI sings lyrics in multiple languages and styles</li>
            <li>Instrumental mode: generate music without vocals for background/corporate use</li>
            <li>Commercial license: pro/enterprise plans include full commercial usage rights</li>
            <li>Custom styles: upload reference tracks to match specific musical aesthetics</li>
            <li>API access: integrate Suno generation into apps, games, and content platforms</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Content creators produce royalty-free music in seconds, not weeks</li>
            <li>Game developers generate dynamic soundtracks without hiring composers</li>
            <li>Small businesses create professional jingles and brand music at zero cost</li>
            <li>Independent artists prototype song ideas before studio recording</li>
            <li>Multilingual: generate music with vocals in 20+ languages</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (50 credits/day)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$10/month (2,500 credits)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$30/month (10,000 credits + commercial license)</p>
          </div>
        </div>

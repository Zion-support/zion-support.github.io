    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Synthetic Data Generation Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Privacy-preserving synthetic data platform that creates statistically representative artificial datasets from real data. Enables safe data sharing, testing, and ML training without exposing sensitive information.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Statistical distribution matching with fidelity scoring</li>
            <li>Referential integrity preservation across related tables</li>
            <li>Differential privacy guarantees with epsilon tuning</li>
            <li>Synthetic data quality assessment with utility metrics</li>
            <li>Support for tabular, time-series, and text data types</li>
            <li>API-based generation for CI/CD testing pipelines</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Enable data sharing without privacy violations</li>
            <li>Accelerate development with realistic test data</li>
            <li>Comply with GDPR, HIPAA, and CCPA requirements</li>
            <li>Augment rare classes in ML training datasets</li>
        </ul>
      </section>

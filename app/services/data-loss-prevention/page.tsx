    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Loss Prevention (DLP) Suite</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enterprise data loss prevention platform that monitors, detects, and blocks sensitive data exfiltration across endpoints, cloud apps, and network. Content inspection, user behavior analytics, and automated response policies.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Content inspection across email, cloud storage, and endpoints</li>
            <li>User behavior analytics for insider threat detection</li>
            <li>Automated blocking with customizable response policies</li>
            <li>Sensitive data classification with ML-based discovery</li>
            <li>Cloud app shadow IT discovery and risk assessment</li>
            <li>Compliance reporting for PCI-DSS, HIPAA, GDPR</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Prevent data breaches from both external and insider threats</li>
            <li>Automatically classify and protect sensitive data at scale</li>
            <li>Detect shadow IT cloud apps handling sensitive data</li>
            <li>Meet regulatory compliance with continuous monitoring</li>
        </ul>
      </section>

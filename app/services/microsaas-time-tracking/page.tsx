...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/microsaas-time-tracking',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Time Tracking &amp; Project Analytics Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automatic time tracking with project profitability analysis. Tracks time across apps, websites, and documents without manual timers. Generates client-ready invoices, identifies profitable vs unprofitable projects, and provides team productivity insights. Integrates with 100+ tools.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automatic time tracking (no manual entry)</li>
            <li>Project profitability analysis</li>
            <li>Client-ready invoice generation</li>
            <li>Budget alerts &amp; overrun prevention</li>
            <li>Team productivity dashboards</li>
            <li>Integration with 100+ tools (Jira, Asana, etc.)</li>
            <li>Billable vs non-billable hour tracking</li>
            <li>PTO &amp; leave management</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Recover 15-20% more billable hours</li>
            <li>Identify unprofitable projects early</li>
            <li>Eliminate timesheet management overhead</li>
            <li>Improve project estimates with historical data</li>
            <li>Increase team utilization by 25%</li>
        </ul>
      </section>

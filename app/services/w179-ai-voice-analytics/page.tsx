    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Voice Analytics for Call Centers</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Analyze customer calls: sentiment, intent, compliance, agent performance.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Compliance keyword spotting</li>
            <li>Agent performance scoring</li>
            <li>Integration with Genesys, Five9, NICE CXone</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Monitor 100% of calls not samples</li>
            <li>Real-time coaching improves agent performance</li>
            <li>Compliance monitoring on every call</li>
            <li>Sentiment trends reveal systemic issues</li>
        </ul>
      </section>

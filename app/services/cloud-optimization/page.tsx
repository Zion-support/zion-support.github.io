export const metadata = {
  ...
  description: 'Maximize cloud performance and minimize costs with our AI-powered cloud optimization services for AWS, Azure, and Google Cloud.',
};

export default function CloudOptimizationPage() {
  return (
    <section>
      <h1 style={{ fontSize: 26, fontWeight: 800 }}>Cloud Optimization Services</h1>
      <p style={{ marginTop: 8, color: '#374151' }}>Maximize cloud performance, minimize costs, and ensure scalability with our AI-powered cloud optimization solutions.</p>
      ...
      <div style={{ marginTop: 24, padding: 16, backgroundColor: '#f0fdf4', borderRadius: 12, border: '1px solid #22c55e' }}>
        <h3 style={{ fontWeight: 700, color: '#14532d', marginBottom: 8 }}>Optimization Results</h3>
        <ul style={{ color: '#14532d', paddingLeft: 18 }}>
          <li>• <strong>40% average</strong> cost reduction</li>
          <li>• <strong>60% improvement</strong> in application performance</li>
          <li>• <strong>99.9% uptime</strong> SLA guarantee</li>
          <li>• <strong>24/7 monitoring</strong> and support</li>
        </ul>
      </div>
    </section>
  );

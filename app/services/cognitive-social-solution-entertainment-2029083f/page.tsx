...
export const metadata = {
  title: "Cognitive Social Solution - Entertainment - Zion Tech Group",
  description: "Revolutionize entertainment through intelligent automation. Our Cognitive Social Solution - Entertainment leverages advanced machine learning to deliver content",
  alternates: {
    canonical: `https://ziontechgroup.com/services/cognitive-social-solution-entertainment-2029083f`
  }
};

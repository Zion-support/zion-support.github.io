    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Customer Churn Prediction &amp; Prevention Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Predict and prevent customer churn with machine learning models that analyze behavioral signals, usage patterns, support interactions, and billing history. Identify at-risk customers 60 days before they leave and trigger automated retention campaigns.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>ML-based churn prediction (60-day lookahead)</li>
            <li>Customer health scoring (0-100 scale)</li>
            <li>Automated retention campaign triggers</li>
            <li>Root cause churn analysis (feature-level)</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce churn by 25-40% within 6 months</li>
            <li>Increase customer lifetime value by 30%</li>
            <li>Prioritize at-risk accounts for CSMs</li>
            <li>Quantify impact of product changes on retention</li>
            <li>Automate win-back campaigns at scale</li>
        </ul>
      </section>

      ...
      <div className="bg-gradient-to-r from-pink-50 to-rose-50 border border-pink-200 rounded-xl p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Increase Open Rates by 60%</h3>
              <p className="text-gray-600">AI-optimized subject lines and send times maximize engagement</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-pink-500 mr-3 text-xl">✓</span>
            <div>
              <h3 className="font-semibold text-gray-900">Boost Conversions by 45%</h3>
              <p className="text-gray-600">Personalized content and smart segmentation drive better results</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-pink-500 mr-3 text-xl">✓</span>
            <div>
              <h3 className="font-semibold text-gray-900">Save 15+ Hours Weekly</h3>
              <p className="text-gray-600">Automated workflows handle repetitive tasks and follow-ups</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-pink-500 mr-3 text-xl">✓</span>
            <div>
              <h3 className="font-semibold text-gray-900">Compliance & Deliverability</h3>
              <p className="text-gray-600">GDPR compliant with high deliverability rates and spam protection</p>
            </div>
          </div>
        </div>
      </div>
...
function Plan({ name, price, features, popular = false }: { name: string; price: string; features: string[]; popular?: boolean }) {
  return (
    <div className={`border rounded-xl p-6 bg-white shadow-sm ${popular ? 'border-pink-500 ring-2 ring-pink-200' : 'border-gray-200'}`}>
      {popular && (

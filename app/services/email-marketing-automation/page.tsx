export const metadata = {title: 'Email Marketing Automation | Zion Tech Group',description: 'Professional email marketing automation services for your business needs.',keywords: 'email-marketing-automation, services, business, technology';

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Synthesia AI Digital Humans Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Synthesia is the leading AI video generation platform that creates photorealistic digital human presenters from text. Users type a script, select from 240+ AI avatars (diverse in ethnicity, age, and language), and Synthesia generates a professional video with natural lip-sync, gestures, and voice in 140+ languages. Used by 50,000+ companies including Google, Nike, and the BBC for training, marketing, and internal communications, Synthesia reduces video production costs by 90% and time from weeks to minutes. Its enterprise platform includes custom avatar creation (digital twins of real people), API access, and analytics on viewer engagement.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>240+ diverse AI avatars: choose presenters by ethnicity, age, clothing, and language</li>
            <li>140+ languages with natural lip-sync and regional accent accuracy</li>
            <li>Custom avatar creation: build a digital twin of a real spokesperson or executive</li>
            <li>Video API: generate videos programmatically from your application or workflow</li>
            <li>Brand kit integration: logos, colors, fonts, and backgrounds automatically applied</li>
            <li>Analytics dashboard: track viewer engagement, completion rates, and click-throughs</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Create professional videos in minutes instead of weeks</li>
            <li>Localize content into 140+ languages without re-recording or dubbing</li>
            <li>Trusted by 50,000+ companies including Google, Nike, BBC, and Reuters</li>
            <li>Custom avatars let executives and subject matter experts scale their presence</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$22/month (10 minutes of video, 70+ avatars)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$67/month (30 minutes, 140+ avatars, custom branding)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (unlimited video, custom avatars, API, SSO, dedicated support)</p>
          </div>
        </div>

...
export const metadata = {
  ...
  description: "Design, deploy, and manage Microsoft 365 or Google Workspace with governance, security, migration, and adoption training. Maximize ROI on your collaboration inv",
  alternates: {
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Design, deploy, and manage Microsoft 365 or Google Workspace with governance, security, migration, and adoption training. Maximize ROI on your collaboration inv</p>

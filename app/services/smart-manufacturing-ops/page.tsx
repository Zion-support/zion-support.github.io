    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Smart Manufacturing Operations Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Industry 4.0 platform that connects factory equipment, monitors production in real-time, and optimizes manufacturing processes. OEE tracking, predictive quality, and digital twin integration.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time OEE (Overall Equipment Effectiveness) tracking</li>
            <li>Predictive quality with in-line defect detection</li>
            <li>Digital twin integration for process simulation</li>
            <li>Energy monitoring with consumption optimization</li>
            <li>Production scheduling with constraint-based optimization</li>
            <li>Integration with PLCs, SCADA, and MES systems</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Increase OEE by 15-25% with real-time visibility</li>
            <li>Reduce defect rates by 40% with predictive quality</li>
            <li>Optimize energy consumption by 20%</li>
            <li>Simulate process changes with digital twins before implementing</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$1999/mo</p>
          </div>
        </div>

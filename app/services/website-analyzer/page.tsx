...
export const metadata = {
  ...
  description: 'Professional website analyzer solutions for modern businesses. Transform your operations with our advanced website analyzer technology.'
};
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional website analyzer solutions for modern businesses. Transform your operations with our advanced website analyzer technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our website analyzer can help your business
          </p>
          <a
            href="/contact"

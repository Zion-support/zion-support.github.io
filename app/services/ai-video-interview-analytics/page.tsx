    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Video Interview Analytics Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Analyze video interviews at scale with AI that evaluates candidate responses, communication skills, and role-fit indicators. Provides structured scoring, reduces interviewer bias, and accelerates hiring decisions. Integrates with major ATS platforms and video interview tools.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Structured interview scoring with customizable evaluation rubrics</li>
            <li>Communication skills analysis (clarity, conciseness, confidence)</li>
            <li>Role-fit scoring based on job description requirements</li>
            <li>Bias detection alerts for interviewers during live interviews</li>
            <li>Interview question bank optimized for role and seniority</li>
            <li>Integration with Greenhouse, Lever, Workday, and iCIMS</li>
            <li>Candidate experience analytics and feedback collection</li>
            <li>Hiring manager dashboard with candidate comparison views</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce time-to-hire by 40% with AI-accelerated interview review</li>
            <li>Improve hiring quality with structured, consistent evaluation</li>
            <li>Reduce unconscious bias with AI fairness monitoring</li>
            <li>Scale interview capacity without adding recruiter hours</li>
        </ul>
      </section>

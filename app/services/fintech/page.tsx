...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive FinTech solutions including payment processing, digital banking, cryptocurrency, and financial analytics for modern financial services.',
};

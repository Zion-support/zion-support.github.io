export const metadata = {
  ...
  description:
    "Complete financial technology solutions including digital banking, payment processing, trading platforms, and blockchain financial services. Bank-grade security and compliance.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Complete financial technology solutions including digital banking,
            payment processing, trading platforms, and blockchain financial
            services. Bank-grade security and compliance.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Our FinTech experts will help you build secure, scalable, and
            compliant financial solutions that meet the highest industry
            standards.
          </p>

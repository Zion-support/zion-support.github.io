export const metadata = { 
  ...
  description: 'Comprehensive DevOps solutions including CI/CD, infrastructure automation, monitoring, and site reliability engineering services.'
};
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">DevOps & Automation Services</h1>
          <p className="text-xl text-gray-600 max-w-4xl mx-auto">
            Streamline your development workflow with our comprehensive DevOps solutions. 
            We help teams deliver software faster, more reliably, and with higher quality.
          </p>
        </div>

        {/* CI/CD & Pipeline Services */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">CI/CD & Pipeline Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard
              ...
              features={["Pipeline design", "Automated testing", "Docker integration", "Security scanning"]}
              price="$8k - $25k"
              icon="🦊"
            />
            <ServiceCard
              ...
              features={["Master/slave setup", "Pipeline as code", "Plugin management", "Security hardening"]}
              price="$10k - $30k"
              icon="🔧"
            />
            <ServiceCard
              ...
              features={["Workflow design", "Matrix builds", "Secret management", "Custom actions"]}
              price="$5k - $15k"
              icon="🐙"
            />
            <ServiceCard
              ...
              features={["YAML pipelines", "Release management", "Artifact management", "Approval gates"]}
              price="$8k - $20k"
              icon="☁️"
            />
            <ServiceCard
              ...
              features={["Orb management", "Parallel execution", "Docker layer caching", "SSH debugging"]}
              price="$6k - $18k"
              icon="⭕"
            />
            <ServiceCard
              ...
              features={["Custom tooling", "Integration design", "Performance optimization", "Documentation"]}
              price="$15k - $50k"
              icon="🛠️"
            />
          </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Infrastructure Automation</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard
              title="Terraform Infrastructure"
              description="Infrastructure as Code using Terraform for consistent, repeatable deployments"
              features={["Module development", "State management", "Multi-environment", "Validation"]}
              price="$12k - $35k"
              icon="🏗️"
            />
            <ServiceCard
              ...
              features={["Playbook development", "Inventory management", "Role creation", "Testing"]}
              price="$8k - $25k"
              icon="🔧"
            />
            <ServiceCard
              ...
              features={["Cluster provisioning", "Helm charts", "Service mesh", "Monitoring"]}
              price="$20k - $60k"
              icon="☸️"
            />
            <ServiceCard
              ...
              features={["Dockerfile optimization", "Multi-stage builds", "Registry setup", "Security scanning"]}
              price="$5k - $20k"
              icon="🐳"
            />
            <ServiceCard
              ...
              features={["Template development", "Stack management", "Drift detection", "Cross-stack references"]}
              price="$10k - $30k"
              icon="☁️"
            />
            <ServiceCard
              ...
              features={["Multi-language support", "State management", "Testing framework", "CI/CD integration"]}
              price="$15k - $40k"
              icon="🚀"
            />
          </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Monitoring & Observability</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard
              title="Prometheus & Grafana"
              description="Complete monitoring stack with Prometheus metrics and Grafana dashboards"
              features={["Metrics collection", "Custom dashboards", "Alerting rules", "Service discovery"]}
              price="$10k - $30k"
              icon="📊"
            />
            <ServiceCard
              ...
              features={["Log aggregation", "Search optimization", "Index management", "Visualization"]}
              price="$15k - $40k"
              icon="🔍"
            />
            <ServiceCard
              ...
              features={["APM setup", "Infrastructure monitoring", "Log management", "Synthetic testing"]}
              price="$8k - $25k"
              icon="🐕"
            />
            <ServiceCard
              ...
              features={["APM setup", "Infrastructure monitoring", "Synthetic monitoring", "Alert policies"]}
              price="$6k - $20k"
              icon="📈"
            />
            <ServiceCard
              ...
              features={["Data ingestion", "Search optimization", "Dashboards", "Security monitoring"]}
              price="$20k - $60k"
              icon="🔍"
            />
            <ServiceCard
              ...
              features={["Custom metrics", "Integration design", "Alerting logic", "Dashboard creation"]}
              price="$25k - $70k"
              icon="⚙️"
            />
          </div>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Site Reliability Engineering</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard
              title="SLO & SLI Definition"
              description="Service Level Objectives and Indicators setup for reliability measurement"
              features={["SLO design", "SLI implementation", "Error budget tracking", "Reporting"]}
              price="$8k - $20k"
              icon="🎯"
            />
            <ServiceCard
            ...
            <ServiceCard
              ...
              features={["Process design", "Tool configuration", "Runbook creation", "Training"]}
              price="$10k - $25k"
              icon="🚨"
            />
            <ServiceCard
            ...
            <ServiceCard
              ...
              features={["Strategy design", "Backup implementation", "Recovery testing", "Documentation"]}
              price="$20k - $60k"
              icon="🛡️"
            />
            <ServiceCard
              ...
              features={["Growth analysis", "Resource modeling", "Scaling strategies", "Cost optimization"]}
              price="$12k - $35k"
              icon="📈"
            />
          </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard
              ...
              features={["Security scanning", "Policy enforcement", "Vulnerability management", "Compliance"]}
              price="$15k - $45k"
              icon="🔒"
            />
            <ServiceCard
              ...
              features={["Vault setup", "Secret rotation", "Access control", "Audit logging"]}
              price="$8k - $25k"
              icon="🗝️"
            />
            <ServiceCard
              ...
              features={["Image scanning", "Runtime security", "Policy enforcement", "Vulnerability management"]}
              price="$10k - $30k"
              icon="🐳"
            />
            <ServiceCard
              ...
              features={["Security groups", "Network policies", "Compliance scanning", "Audit trails"]}
              price="$12k - $35k"
              icon="🏗️"
            />
            <ServiceCard
              ...
              features={["Policy as code", "Automated scanning", "Compliance reporting", "Remediation"]}
              price="$20k - $50k"
              icon="📋"
            />
            <ServiceCard
              ...
              features={["SIEM setup", "Threat detection", "Incident response", "Forensics"]}
              price="$25k - $70k"
              icon="👁️"
            />
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">DevOps Service Packages</h2>
  ...
  return (
    <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-12 text-center text-white">
      ...
      <p className="text-xl mb-8 max-w-3xl mx-auto">
        Let's discuss how DevOps can transform your development workflow and improve your team's productivity. 
        Our DevOps experts are ready to help you build a world-class engineering culture.
      </p>

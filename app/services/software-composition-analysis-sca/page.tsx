    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Software Composition Analysis (SCA) Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automate open-source license compliance, detect known vulnerabilities, generate SBOMs, and enforce security policies across your entire codebase. Stay audit-ready and reduce supply-chain risk with continuous SCA.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated open-source license compliance scanning</li>
            <li>Known vulnerability detection from CVE databases</li>
            <li>Software Bill of Materials (SBOM) generation (SPDX, CycloneDX)</li>
            <li>Policy enforcement for approved/denied components</li>
            <li>CI/CD pipeline integration for continuous scanning</li>
            <li>Audit-ready reporting and compliance evidence export</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Avoid costly open-source license violations and legal risk</li>
            <li>Detect vulnerabilities before they reach production</li>
            <li>Generate SBOMs instantly for customer and regulatory requests</li>
            <li>Enforce security policies automatically on every commit</li>
            <li>Reduce audit preparation time from weeks to minutes</li>
        </ul>
      </section>

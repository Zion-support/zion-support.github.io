    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS AI Cart Abandonment Analyzer</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Detects cart abandonment patterns, drop-off signals, and recovery campaign opportunities across stores.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cart funnel drop-off detection</li>
            <li>Segment recovery targeting</li>
            <li>Recovery timing signals</li>
            <li>Monetary impact estimation</li>
            <li>Campaign effectiveness tracking</li>
            <li>Insight packaging</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Keep recovery accountable</li>
            <li>Accelerate campaign decisions</li>
            <li>Support merchandising actions</li>
        </ul>
      </section>

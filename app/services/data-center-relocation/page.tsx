...
export const metadata = {
  title: 'Data Center Migration & Relocation Services | Zion Tech Group',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-center-relocation',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center Migration &amp; Relocation Services</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">End-to-end data center migration planning and execution. From assessment and design to physical move, cloud migration, and post-move validation. Minimize downtime and risk.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Migration strategy: lift-and-shift, re-platform, re-architect</li>
            <li>Physical server packing, transport, and reinstallation</li>
            <li>Cloud migration to AWS, Azure, or GCP with optimization</li>
            <li>Network reconfiguration and DNS cutover planning</li>
            <li>Rollback procedures and contingency planning</li>
            <li>Post-migration validation and performance testing</li>
            <li>Documentation update and knowledge transfer</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce migration downtime to under 4 hours with proven methodology</li>
            <li>Avoid data loss with verified backup and checksum validation</li>
            <li>Optimize infrastructure costs by 40% with right-sized cloud resources</li>
            <li>Complete migration 50% faster with experienced project management</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$4,999 (assessment + migration plan)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$14,999 (full migration, up to 50 servers)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">Custom (large-scale, multi-site, hybrid cloud)</p>
          </div>
        </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Multimodal Search Engine</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Search across text, images, video, and audio: unified embeddings, hybrid ranking.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Text image video audio search</li>
            <li>Unified embeddings across modalities</li>
            <li>Hybrid vector + keyword ranking</li>
            <li>Natural language query understanding</li>
            <li>Multi-tenant and access controlled</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Hybrid ranking outperforms single modality</li>
            <li>NL queries find answers not just keywords</li>
            <li>Embeddable UI for any application</li>
        </ul>
      </section>

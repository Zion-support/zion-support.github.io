    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Property Damage Assessor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Assess property damage from photos: damage classification, severity scoring, repair cost estimation.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Damage classification from photos</li>
            <li>Severity scoring</li>
            <li>Automated repair cost estimation</li>
            <li>Claims routing and prioritization</li>
            <li>Before/after comparison</li>
            <li>Integration with Mitchell, CCC, Symbility</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Assess damage from photos in seconds</li>
            <li>Repair cost estimation without inspector</li>
            <li>Claims routing prioritizes severity</li>
            <li>Before/after comparison for documentation</li>
        </ul>
      </section>

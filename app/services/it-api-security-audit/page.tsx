    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">API Security Audit &amp; Penetration Testing</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Comprehensive security assessment of your REST, GraphQL, and gRPC APIs. AI-powered scanning combined with manual penetration testing identifies authentication flaws, injection vulnerabilities, data exposure, and business logic weaknesses. Includes detailed remediation guidance.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated API discovery and inventory mapping</li>
            <li>OWASP API Top 10 vulnerability testing</li>
            <li>Authentication and authorization bypass testing</li>
            <li>Business logic flaw identification</li>
            <li>Rate limiting and abuse scenario testing</li>
            <li>Data exposure and PII leak detection</li>
            <li>Detailed report with CVSS scoring and remediation steps</li>
            <li>Retesting after fixes to confirm resolution</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Identify critical API vulnerabilities before attackers do</li>
            <li>Meet security audit requirements for enterprise customers</li>
            <li>Protect sensitive data exposed through API endpoints</li>
            <li>Get actionable remediation steps, not just a vulnerability list</li>
        </ul>
      </section>

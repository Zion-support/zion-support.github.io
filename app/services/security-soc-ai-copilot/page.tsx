    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Security SOC AI Copilot — Analyst Force Multiplier</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI copilot for Security Operations Center analysts. Automatically triages alerts, enriches with threat intel, suggests investigation steps, and drafts incident reports. Reduces MTTD by 60% and analyst fatigue by 50%.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>AI alert triage and prioritization</li>
            <li>Threat intelligence enrichment (VirusTotal, Shodan, MITRE)</li>
            <li>Step-by-step investigation guidance</li>
            <li>Auto-drafted incident reports</li>
            <li>Playbook recommendations based on alert type</li>
            <li>Integration with Sentinel, Splunk, QRadar, Demisto</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce mean-time-to-detect by 60%</li>
            <li>Cut analyst alert fatigue by 50%</li>
            <li>Junior analysts perform like seniors</li>
            <li>Consistent investigation quality every time</li>
            <li>Free analysts for proactive threat hunting</li>
        </ul>
      </section>

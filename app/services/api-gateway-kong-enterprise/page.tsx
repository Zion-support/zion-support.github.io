...
export const metadata = {
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/api-gateway-kong-enterprise',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Kong Gateway API Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Enterprise API gateway for managing, securing, and scaling microservices. Features rate limiting, authentication, request/response transformation, plugin ecosystem, and real-time analytics. Handles billions of API calls with sub-millisecond latency.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>API routing and load balancing across services</li>
            <li>Rate limiting and quota management</li>
            <li>OAuth2, JWT, API key, and mTLS authentication</li>
            <li>Request/response transformation and validation</li>
            <li>Plugin ecosystem with 50+ pre-built extensions</li>
            <li>Real-time analytics and observability dashboard</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Secure APIs with enterprise-grade authentication</li>
            <li>Scale to billions of requests with sub-ms latency</li>
            <li>Reduce API management overhead by 80%</li>
            <li>Gain full visibility into API usage and performance</li>
        </ul>
      </section>

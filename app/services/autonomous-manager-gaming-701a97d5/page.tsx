...
export const metadata = {
  ...
  description: "Transform your gaming operations with our Autonomous manager-gaming. This AI-driven solution automates compliance monitoring with unprecedented accuracy and eff",
  alternates: {

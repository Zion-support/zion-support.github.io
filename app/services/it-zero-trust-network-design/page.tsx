...
export const metadata = {
  title: 'Zero-Trust Network Architecture Design & Implementation | Zion Tech Group',
  ...
  alternates: {
    canonical: 'https://ziontechgroup.com/services/it-zero-trust-network-design',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Zero-Trust Network Architecture Design &amp; Implementation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Design and implement a zero-trust network architecture from the ground up. Identity-aware micro-segmentation, continuous verification, no implicit trust. Includes network assessment, architecture design, implementation, and managed monitoring.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Current state network assessment</li>
            <li>Identity-aware micro-segmentation design</li>
            <li>Device trust and posture verification</li>
            <li>Least-privilege access policy framework</li>
            <li>Implementation and migration planning</li>
            <li>Ongoing zero-trust monitoring and enforcement</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminate implicit trust in your network</li>
            <li>Reduce breach blast radius by 90%</li>
            <li>Meet CMMC, NIST 800-207 requirements</li>
            <li>Secure remote work by design</li>

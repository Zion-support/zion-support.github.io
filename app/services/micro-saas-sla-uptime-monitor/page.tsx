    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">External SLA &amp; Uptime Monitor for Vendors</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Monitor vendor SLAs, uptime, response latency, and incident history from your customer perspective. Generates vendor scorecards and renewal risk alerts.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Vendor uptime and SLA measurement views</li>
            <li>Response latency and incident aging tracking</li>
            <li>Vendor scorecards with repeat-issue summaries</li>
            <li>Renewal risk alerts tied to performance trends</li>
            <li>Evidence exports for procurement and legal reviews</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Make vendor negotiations based on actual performance data</li>
            <li>Detect underperforming vendors before renewal cycles</li>
            <li>Reduce procurement review time with automated evidence</li>
        </ul>
      </section>

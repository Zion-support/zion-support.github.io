    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Center DCIM Software Deployment &amp; Integration</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Deploy and integrate data center infrastructure management (DCIM) platforms for unified monitoring of power, cooling, space, and network assets. Real-time dashboards, capacity forecasting, and automated ticketing integration.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>DCIM platform selection and deployment (Sunbird, Nlyte, Schneider, Raritan)</li>
            <li>Real-time power, thermal, and network asset monitoring</li>
            <li>Capacity planning dashboards and alerting</li>
            <li>Integration with BMS, PDUs, UPS, CRAC/CRAH units</li>
            <li>Automated workflow integration with ServiceNow/Jira</li>
            <li>IT asset discovery and CMDB synchronization</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Gain single-pane-of-glass visibility across all facility systems</li>
            <li>Reduce capacity planning time by 70% with predictive analytics</li>
            <li>Automate change management and compliance reporting</li>
            <li>Eliminate spreadsheet-based capacity tracking and forecasting errors</li>
        </ul>
      </section>

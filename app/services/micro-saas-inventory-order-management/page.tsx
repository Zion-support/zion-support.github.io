    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Micro-SaaS Inventory &amp; Order Management</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Multi-channel inventory sync, order tracking, supplier management, and low-stock alerts. Purpose-built for e-commerce sellers who need a lightweight yet powerful operations hub without enterprise complexity.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Real-time multi-channel inventory synchronization across Shopify, Amazon, WooCommerce, and more</li>
            <li>Unified order tracking with status updates, shipping labels, and delivery notifications</li>
            <li>Supplier management portal with lead times, MOQs, and purchase order automation</li>
            <li>Intelligent low-stock alerts with reorder-point suggestions based on sales velocity</li>
            <li>Barcode and SKU management with bulk import/export and variant support</li>
            <li>Sales analytics dashboard with channel performance, turnover rates, and margin tracking</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminates overselling with sub-second inventory sync across all sales channels</li>
            <li>Reduces stockouts by up to 60% with predictive reorder recommendations</li>
            <li>Saves 10+ hours per week on manual order processing and supplier follow-ups</li>
            <li>Provides a single source of truth for inventory, orders, and supplier data</li>
            <li>Scales from 100 to 100,000 SKUs without changing platforms or workflows</li>
        </ul>
      </section>

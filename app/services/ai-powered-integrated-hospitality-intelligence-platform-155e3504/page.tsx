...
export const metadata = {
  title: "AI-Powered Integrated Hospitality Intelligence Platform - Zion Tech Group",
  description: "AI-driven intelligence platform that delivers integrated insights and automated decision-making for hospitality operations.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-integrated-hospitality-intelligence-platform-155e3504`
  }
};

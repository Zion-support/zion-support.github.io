  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">The future of construction is here with AI Analyzer - Construction Edition #2. Powered by cutting-edge AI, this platform delivers financial planning like never </p>

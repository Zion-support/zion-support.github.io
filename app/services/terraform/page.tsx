    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Terraform Infrastructure-as-Code</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Terraform is the industry-standard infrastructure-as-code (IaC) tool used by millions of engineers to declaratively provision and manage cloud infrastructure across AWS, Azure, GCP, and 3,000+ other providers. Instead of clicking through cloud consoles, you define infrastructure in HCL and Terraform figures out the exact API calls needed. With plan-apply workflow, you get a preview of every change before it happens.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Multi-cloud provisioning across 3,000+ providers (AWS, Azure, GCP, Cloudflare, Datadog, Kubernetes)</li>
            <li>Plan-apply workflow with detailed diff — see exactly what will change before making any changes</li>
            <li>State management with remote backends (S3, GCS, Terraform Cloud) for team collaboration and drift detection</li>
            <li>Module registry with 25K+ community modules for battle-tested infrastructure patterns</li>
            <li>Policy-as-code with Open Policy Agent (OPA) and Sentinel for compliance guardrails</li>
            <li>CDK for Terraform (CDKTF) — define infrastructure in Python, TypeScript, Java, C#, or Go</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Eliminates manual cloud console configuration that causes 43% of cloud outages (Gartner)</li>
            <li>Every change is version-controlled, reviewed, and auditable</li>
            <li>Multi-cloud portability: same skills and modules work across AWS, Azure, GCP — eliminates vendor lock-in</li>
            <li>Powers infrastructure at Airbnb, Starbucks, Slack, and thousands of organizations</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">Free (OSS, MPL 2.0)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">Free tier (500 resources)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$0.00014/hr/resource</p>
          </div>
        </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Analytics Starter — Micro SaaS Metrics</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Prebuilt analytics dashboard for micro-SaaS: MRR, churn, signups, activation, LTV, and cohort retention. Connect Stripe, PostHog, or Baremetrics.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>MRR/ARR and churn tracking</li>
            <li>Signup and activation funnel</li>
            <li>Cohort retention views</li>
            <li>LTV and CAC calculation</li>
            <li>Stripe/PostHog connectors</li>
            <li>Embedded customer dashboard</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Make product decisions with real data</li>
            <li>Reduce churn by understanding drop-off</li>
            <li>Track growth weekly instead of monthly</li>
            <li>Investor-ready metrics in minutes</li>
        </ul>
      </section>

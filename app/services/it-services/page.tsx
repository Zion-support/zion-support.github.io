...
export const metadata = {title: "IT Services | Zion Tech Group - Complete IT Solutions & Infrastructure Management",description: "Comprehensive IT services including cloud migration, DevOps, cybersecurity, infrastructure management, and 24/7 support. Enterprise-grade IT solutions with 99.9% uptime guarantee.";
}export default function ITServicesPage() {return (<div className="animate-fade-in">;
      {/* Hero Section */}
...
export const metadata = {title: "IT Services & Solutions | Zion Tech Group",description:;
    "Comprehensive IT services including cloud migration, DevOps, cybersecurity, infrastructure management, and enterprise solutions. 24/7 support with 99.9% uptime guarantee.",keywords:;
    "IT services, cloud migration, DevOps, cybersecurity, infrastructure management, enterprise IT, cloud consulting, SRE";
}interface ITServiceProps  {title: string;
  description: string;
  price: string;
  features: string[];
  benefits: string[];
  icon: string;
  href: string;
}function ITService() {export const metadata = {title: "IT Services | Zion Tech Group - Complete IT Solutions & Support",description: "Comprehensive IT services including cloud migration, DevOps, cybersecurity, infrastructure management, and 24/7 support. Enterprise-grade solutions from $3,000/month with 99.9% uptime guarantee.";
export const metadata = {title: 'Service Name | Zion Tech Group',description: 'Service description for the Zion Tech Group service page.',keywords: 'service keywords, relevant terms';
}export default function ServicePage() {return (<div className="animate-fade-in">;
  ...
  )}function ITServiceCard() {return (<Link;
      href={href}
  ...
  )}function ManagedServiceCard() {return (<div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">;
  ...
  )}function TechExpertiseCard() {return (<div className="bg-white border border-gray-200 rounded-xl p-6 text-center">;
  ...
  )}function SLACard() {return (<div className="bg-white border border-gray-200 rounded-xl p-6 text-center">;
      <div className="text-3xl mb-4">{icon}</div>;
      <h3 className="text-lg font-bold text-gray-900 mb-2">{title}</h3>;
      <p className="text-gray-600 mb-4">{description}</p>;
      <ul className="space-y-2">;
        {metrics.map((metric, index) => (<li key={index} className="text-sm text-gray-600">;
            {metric}
          </li>;
        ))}
      </ul>;
    </div>;
  )}function ITPricingCard() {popular;
}: {title: string;
  price: string;
  period: string;
  description: string;
  features: string[];
  popular: boolean;
}) {return (<div className={`bg-white border rounded-xl p-8 ${popular ? 'border-purple-500 ring-2 ring-purple-200' : 'border-gray-200'}`}>;
      {popular && (<div className="bg-purple-500 text-white text-sm font-semibold px-3 py-1 rounded-full inline-block mb-4">;
          Most Popular;
        </div>;
      )}
  ...
  )}function IndustrySolutionCard() {return (<div className="space-y-16">;
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
            ...
            <ITServiceCard;
              ...
              features={[;
                "Multi-cloud strategy planning","Data migration automation","Cost optimization","24/7 cloud monitoring";
              ]}
            ...
            <ITServiceCard;
              ...
              features={[;
                "CI/CD pipeline setup","Infrastructure automation","Container orchestration","Monitoring & alerting";
              ]}
            ...
            <ITServiceCard;
              ...
              features={[;
                "Security audits & assessments","Threat detection & response","Compliance management","Security training";
              ]}
            ...
            <ITServiceCard;
              ...
              features={[;
                "Server & network management","Backup & disaster recovery","Performance optimization","Hardware lifecycle management";
              ]}
            ...
            <ITServiceCard;
              ...
              features={[;
                "24/7 technical support","Remote assistance","Issue tracking & resolution","User training & onboarding";
              ]}
            ...
            <ITServiceCard;
              ...
              features={[;
                "Data backup & recovery","Database optimization","Business intelligence","Data governance";
              ]}
            ...
            <ITServiceCard;
              ...
              features={[;
                "Network security assessment","Firewall configuration","Intrusion detection","Network performance monitoring";
              ]}
            ...
            <ITServiceCard;
              ...
              features={[;
                "SOX, HIPAA, GDPR compliance","Policy development","Risk assessment","Audit preparation";
              ]}
            ...
            <ITServiceCard;
              ...
              features={[;
                "IT strategy development","Technology roadmaps","Digital transformation","Vendor management";
              ]}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
            <CloudProviderCard;
              ...
              services={[;
                "EC2, S3, RDS management","Lambda serverless solutions","CloudFormation automation","Cost optimization";
              ]}
              pricing="From $3,500/month";
              icon="🟠";
            />;
            <CloudProviderCard;
              ...
              services={[;
                "Azure VM & App Services","Azure Active Directory","Azure DevOps integration","Hybrid cloud solutions";
              ]}
            ...
            <CloudProviderCard;
              ...
              services={[;
                "Compute Engine & Kubernetes","BigQuery data analytics","AI/ML platform integration","Multi-region deployment";
              ]}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
            <SupportTierCard;
              ...
              features={[;
                "Business hours support (9 AM - 5 PM)","Remote assistance","Basic monitoring","Monthly health reports","Email & phone support";
              ]}
            ...
            <SupportTierCard;
              ...
              features={[;
                "24/7 support availability","Proactive monitoring","Priority response times","Monthly strategy reviews","Dedicated account manager","Advanced security monitoring";
              ]}
            ...
            <SupportTierCard;
              ...
              features={[;
                "24/7 dedicated support team","Real-time monitoring & alerting","Immediate response times","Weekly strategy meetings","Dedicated technical team","Custom SLA agreements","On-site support available";
              ]}
      ...
      <section className="py-12">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
          <ITService;
            ...
            features={[;
              "Infrastructure assessment","Migration planning & execution","Data migration & validation","Application modernization","Cost optimization analysis";
            ]}
            benefits={[;
              "Reduced Costs","Better Scalability","Enhanced Security","Improved Performance";
            ]}
            icon="☁️";
          ...
          <ITService;
            ...
            features={[;
              "CI/CD pipeline setup","Infrastructure as code","Container orchestration","Automated testing","Monitoring & alerting";
            ]}
            benefits={[;
              "Faster Deployments","Reduced Errors","Better Collaboration","Automated Testing";
            ]}
            icon="⚙️";
          ...
          <ITService;
            ...
            features={[;
              "Security assessment & audit","Penetration testing","Vulnerability scanning","Compliance management","Security training & awareness";
            ]}
            benefits={[;
              "Enhanced Security","Compliance","Risk Reduction","Peace of Mind";
            ]}
            icon="🔒";
          ...
          <ITService;
            ...
            price="Starting at $5,000";
            features={[;
              "iOS & Android development","Cross-platform solutions","App store optimization","Push notifications","Analytics integration";
            ]}
            benefits={[;
              "Mobile Presence","User Engagement","Revenue Growth","Brand Visibility";
            ]}
            icon="📱";
          ...
          <ITService;
            ...
            price="Starting at $2,000";
            features={[;
              "RESTful API design","GraphQL implementation","Microservices architecture","API documentation","Performance optimization";
            ]}
            benefits={[;
              "Better Integration","Scalability","Developer Experience","Future-Proof";
            ]}
            icon="🔗";
          ...
          <ITService;
            ...
            features={[;
              "Database design & architecture","Performance optimization","Data migration","Backup & recovery","Monitoring & maintenance";
            ]}
            benefits={[;
              "Better Performance","Data Security","Scalability","Reliability";
            ]}
            icon="🗄️";
          ...
          <ITService;
            ...
            features={[;
              "Network design & planning","Firewall configuration","VPN setup","Network monitoring","Security hardening";
            ]}
            benefits={[;
              "Better Connectivity","Enhanced Security","Improved Performance","Reliability";
            ]}
            icon="🌐";
          ...
          <ITService;
            ...
            features={[;
              "24/7 technical support","Remote assistance","Issue tracking & resolution","User training","Knowledge base management";
            ]}
            benefits={[;
              "24/7 Support","Quick Resolution","User Satisfaction","Reduced Downtime";
            ]}
            icon="🎧";
          ...
          <ITService;
            ...
            features={[;
              "Backup strategy design","Automated backup systems","Disaster recovery planning","Data replication","Recovery testing";
            ]}
            benefits={[;
              "Data Protection","Business Continuity","Risk Mitigation","Peace of Mind";
            ]}
            icon="💾";
...
ursor/automate-test-improve-and-merge-code-646c;
      ...
      <section className="py-12 bg-gray-50 rounded-lg">;
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">;
          {[;
            { name: "AWS", icon: "☁️", description: "Cloud platform" },{ name: "Azure", icon: "🔵", description: "Microsoft cloud" },{name: "Google Cloud",icon: "🌐",description: "Google platform";
            },{ name: "Docker", icon: "🐳", description: "Containerization" },{ name: "Kubernetes", icon: "⚙️", description: "Orchestration" },{ name: "Terraform", icon: "🏗️", description: "Infrastructure" },{ name: "Jenkins", icon: "🔧", description: "CI/CD" },{ name: "GitLab", icon: "🦊", description: "DevOps platform" },{ name: "MongoDB", icon: "🍃", description: "NoSQL database" },{ name: "PostgreSQL", icon: "🐘", description: "SQL database" },{ name: "Redis", icon: "🔴", description: "Caching" },{ name: "Elasticsearch", icon: "🔍", description: "Search engine" }
          ].map((tech, index) => (<div;
              key={index}
      ...
      <section className="py-12 bg-gray-50 rounded-lg">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">;
          <PricingTier;
            ...
            features={[;
              "Basic cloud setup","Email & office solutions","Basic security measures","Monthly maintenance","Email support";
            ]}
            cta="Get Started";
          />;
          <PricingTier;
            ...
            features={[;
              "Advanced cloud solutions","DevOps implementation","Security monitoring","24/7 support","Performance optimization","Backup & recovery";
            ]}
            popular={true}
            cta="Get Started";
          />;
          <PricingTier;
            ...
            features={[;
              "Custom infrastructure design","Dedicated IT team","Advanced security suite","SLA guarantee","Custom integrations","White-label solutions";
            ]}
            cta="Contact Sales";
          />;
        </div>;
      ...
      <section className="py-12">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
          {[;
            {company: "E-commerce Platform",industry: "Retail",result: "99.9% uptime achieved",description:;
            ...
            },{company: "SaaS Startup",industry: "Technology",result: "50% faster deployments",description:;
            ...
            },{company: "Financial Services",industry: "Finance",result: "Zero security incidents",description:;
...
ursor/automate-test-improve-and-merge-code-646c;
  ...
  )}function CloudProviderCard() {return (<div className="border border-gray-200 rounded-xl p-6 bg-white">;
      <div className="text-4xl mb-4">{icon}</div>;
      <h3 className="text-xl font-bold text-gray-900 mb-3">{title}</h3>;
      <p className="text-gray-600 mb-4 leading-relaxed">{description}</p>;
      <ul className="text-gray-600 space-y-2 mb-4">;
        {services.map((service) => (<li key={service} className="flex items-center text-sm">;
  ...
  )}function SupportTierCard() {return (<div className={`relative border rounded-xl p-8 ${popular ? 'border-green-500 bg-green-50' : 'border-gray-200 bg-white'}`}>;

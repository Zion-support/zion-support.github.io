...
export const metadata = {
  ...
  description: 'Professional it services solutions for modern businesses. Transform your operations with our advanced it services technology.'
};
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional it services solutions for modern businesses. Transform your operations with our advanced it services technology.
          </p>
        </div>

  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-gray-300 mb-8">Host engaging virtual events, webinars, and hybrid conferences with interactive features. Includes registration management, live polling, Q&amp;A, breakout rooms, a</p>

...
export const metadata = {
  title: "Orchestrator Smart - Energy #1 - Zion Tech Group",
  description: "The future of energy is here with Orchestrator Smart - Energy #1. Powered by cutting-edge AI, this platform delivers workflow management like never before.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/orchestrator-smart---energy-1-af85f8b8`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Observability &amp; Reliability Suite</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">End-to-end data observability platform that monitors data pipelines for freshness, volume, schema, and quality issues. Automatic anomaly detection, root cause analysis, and incident management for data teams.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated data freshness monitoring with SLA tracking</li>
            <li>Volume anomaly detection with statistical baselines</li>
            <li>Schema change detection with downstream impact analysis</li>
            <li>Data quality rule engine with 100+ built-in checks</li>
            <li>Incident management with automatic root cause analysis</li>
            <li>Data pipeline dependency mapping with blast radius</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Detect data issues before they impact downstream consumers</li>
            <li>Reduce time spent debugging data pipeline failures</li>
            <li>Establish data reliability SLAs with automated monitoring</li>
            <li>Understand data lineage and impact of schema changes</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">GitHub Copilot — AI-Powered Code Generation</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">GitHub Copilot is an AI pair programmer that uses large language models trained on billions of lines of code to suggest entire lines or functions inside your editor. Integrated with VS Code, JetBrains, Neovim, and Visual Studio, Copilot understands context from comments, variable names, and surrounding code to generate contextually relevant code in 40+ programming languages. Over 1.8 million paid subscribers and 73,000 enterprise customers use Copilot to accelerate development by up to 55%.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Context-aware code suggestions in 40+ programming languages and frameworks</li>
            <li>Natural language to code: describe what you want in comments, get working code</li>
            <li>IDE integration: VS Code, JetBrains, Neovim, Visual Studio, and Xcode</li>
            <li>Copilot Chat: conversational AI assistant for debugging, explaining, and refactoring code</li>
            <li>Enterprise features: organization-wide policy controls, audit logs, and SOC 2 compliance</li>
            <li>Code security: filters suggestions to reduce exposure to vulnerable or copyrighted code</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Developers complete coding tasks 55% faster on average</li>
            <li>Reduce boilerplate writing by 80% — focus on architecture and logic</li>
            <li>New team members onboard faster with AI-guided code exploration</li>
            <li>Catch bugs earlier with AI-suggested test cases and edge case handling</li>
            <li>Used by 73,000+ enterprises including Fortune 500 companies</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$10/month (Individual)</p>
          </div>
          <div className="rounded-xl border border-cyan-500/40 bg-slate-900/80 p-5">
            <h3 className="font-semibold text-cyan-300">Pro</h3>
            <p className="mt-2 text-2xl font-bold">$19/month (Business)</p>
          </div>
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            <h3 className="font-semibold text-cyan-300">Enterprise</h3>
            <p className="mt-2 text-2xl font-bold">$39/user/month (Enterprise)</p>
          </div>
        </div>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Predictive Maintenance for Manufacturing</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">IoT sensor analysis, failure prediction, maintenance scheduling, and spare parts optimization powered by machine learning. Helps manufacturers minimize unplanned downtime, extend equipment life, and optimize maintenance budgets.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>IoT sensor data ingestion and analysis from vibration, temperature, pressure, and acoustic sensors</li>
            <li>Failure prediction models that identify equipment degradation weeks before breakdown occurs</li>
            <li>Intelligent maintenance scheduling that optimizes technician routes, parts availability, and production windows</li>
            <li>Spare parts inventory optimization using demand forecasting to reduce carrying costs while preventing stockouts</li>
            <li>Digital twin simulation for testing maintenance scenarios and predicting equipment behavior under stress</li>
            <li>Executive dashboard with OEE tracking, MTBF/MTTR trends, and cost-savings analytics</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduces unplanned downtime by up to 50% through early failure detection and proactive intervention</li>
            <li>Extends critical equipment lifespan by 20-30% with condition-based maintenance strategies</li>
            <li>Cuts maintenance costs by optimizing spare parts inventory and reducing emergency repairs</li>
            <li>Improves production planning with reliable equipment availability forecasts and risk scoring</li>
            <li>Integrates with existing SCADA, MES, and ERP systems via standard industrial protocols and APIs</li>
        </ul>
      </section>

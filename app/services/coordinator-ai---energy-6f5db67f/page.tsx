...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with Coordinator AI - Energy. This autonomous system provides maintenance scheduling with zero manual intervention needed.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/coordinator-ai---energy-6f5db67f`
  }
};

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Vendor Selection Advisor</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Compares vendor proposals, capabilities, and risk scores across evaluation criteria with recommendation packs.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Requirement alignment scoring</li>
            <li>Vendor comparison matrices</li>
            <li>Risk assessment and weighting</li>
            <li>Proof-of-concept tracking</li>
            <li>Negotiation support notes</li>
            <li>Executive recommendation packs</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce vendor evaluation time</li>
            <li>Keep criteria consistent</li>
            <li>Support governance review</li>
            <li>Accelerate selection decisions</li>
        </ul>
      </section>

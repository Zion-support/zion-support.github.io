    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Logistics Route Optimization</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">AI-powered route planning for delivery fleets. Reduces fuel costs by 20%, improves on-time delivery, and handles real-time traffic and weather adjustments.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Cuts fuel costs by 20%</li>
            <li>Improves on-time delivery rates</li>
            <li>Reduces fleet idle time</li>
            <li>Handles dynamic re-routing automatically</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Knowledge Retrieval Graph</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Builds a searchable internal knowledge graph from docs, tickets, and chat with entity resolution and provenance tracking.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Provenance citation tracking</li>
            <li>Team-specific namespaces</li>
            <li>Freshness scoring</li>
            <li>Query expansion</li>
            <li>Export to BI or vector stores</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce search time for answers</li>
            <li>Keep institutional knowledge usable</li>
            <li>Prevent outdated guidance reuse</li>
            <li>Support onboarding and audits</li>
        </ul>
      </section>

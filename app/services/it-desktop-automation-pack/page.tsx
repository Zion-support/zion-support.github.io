    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Desktop Automation Pack for IT Ops</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Standardizes workstation setup, patching signals, access checks, and repetitive ticket tasks for IT operations teams.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Workstation baseline checks</li>
            <li>Patch-state reporting</li>
            <li>Access review workflows</li>
            <li>Task automation library</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce repeat ticket work</li>
            <li>Standardize desktop readiness</li>
            <li>Speed onboarding support</li>
        </ul>
      </section>

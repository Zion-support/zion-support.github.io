    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Voice Agent for Customer Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Deploy AI voice agents that handle customer calls naturally — not robotic IVRs. Understands context, detects emotions, resolves common issues, and seamlessly transfers to humans when needed. Reduces call center costs by 60% while improving CSAT scores.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Seamless human handoff with full context</li>
            <li>Multi-language support (25+ languages)</li>
            <li>CRM integration (Salesforce, HubSpot, Zendesk)</li>
            <li>Custom voice cloning for brand consistency</li>
            <li>Post-call analytics and quality scoring</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            ...
            <li>Reduce average handle time by 45%</li>
            <li>Improve CSAT by 20% with consistent service</li>
            <li>Scale instantly during peak periods</li>
        </ul>
      </section>

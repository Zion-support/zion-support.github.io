    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Email &amp; Collaboration Security Services</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Harden email and collaboration suites with anti-phishing controls, DMARC enforcement, anomaly detection, and incident response playbooks for modern messaging platforms.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Anti-phishing gateway tuning</li>
            <li>DMARC enforcement and reporting</li>
            <li>Anomaly detection for mail flows</li>
            <li>Incident response playbooks</li>
            <li>Collaboration suite hardening</li>
            <li>Executive communication protection</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce phishing exposure</li>
            <li>Improve mail authentication posture</li>
            <li>Speed incident response</li>
            <li>Protect executive and sensitive mailboxes</li>
        </ul>
      </section>

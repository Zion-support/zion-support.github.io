...
export const metadata = {
  ...
  description: "Unlock unprecedented growth with AI-Powered analyzer-legal. This autonomous system provides document processing with zero manual intervention needed.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/ai-powered-analyzer-legal-9550b305`
  }
};

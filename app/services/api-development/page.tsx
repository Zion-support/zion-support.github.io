        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-gray-600">Build APIs that scale with your business growth and user demand</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-fuchsia-500 mr-3 text-xl">✓</span>
            <div>
              ...
              <p className="text-gray-600">Implement industry-standard security practices and authentication</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-fuchsia-500 mr-3 text-xl">✓</span>
            <div>
              ...
              <p className="text-gray-600">Create APIs that are easy to use and integrate with comprehensive documentation</p>
            </div>
          </div>
          <div className="flex items-start">
            <span className="text-fuchsia-500 mr-3 text-xl">✓</span>
...
function Plan({ name, price, features, popular = false }: { name: string; price: string; features: string[]; popular?: boolean }) {
  return (
    <div className={`border rounded-xl p-6 bg-white shadow-sm ${popular ? 'border-fuchsia-500 ring-2 ring-fuchsia-200' : 'border-gray-200'}`}>
      {popular && (

      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        <div className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">
            Contact us today to learn how our api development services can transform your business.
          </p>
...
export const metadata = {
  title: 'Api Development | Zion Tech Group',
  description: 'Professional api development solutions for modern businesses. Transform your operations with our advanced api development technology.'
};
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional api development solutions for modern businesses. Transform your operations with our advanced api development technology.
          </p>
        </div>
        ...
        <div className="bg-blue-50 rounded-2xl p-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let's discuss how our api development can help your business
          </p>
          <a
            href="/contact"

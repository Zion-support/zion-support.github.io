    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">AI Cybersecurity Analyst</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Autonomous AI security analyst that continuously monitors networks, endpoints, and cloud workloads for threats. Mimics human SOC analyst decision-making with automated triage, investigation, and response — operating 24/7 without fatigue.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Continuous network traffic analysis with behavioral baselines</li>
            <li>Automated alert triage with false positive suppression</li>
            <li>Threat investigation with evidence chain reconstruction</li>
            <li>Automated containment actions (isolate, block, quarantine)</li>
            <li>MITRE ATT&amp;CK technique mapping for every incident</li>
            <li>Natural language incident summaries for management reporting</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce SOC analyst workload by 80% with automated triage</li>
            <li>Detect threats that rule-based SIEM misses</li>
            <li>Respond to incidents in minutes instead of hours</li>
            <li>Scale security operations without hiring more analysts</li>
        </ul>
      </section>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Lineage &amp; Impact Analysis Platform</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automated data lineage discovery and visualization platform that maps data flow from source to consumption. Column-level lineage, impact analysis for schema changes, and compliance documentation for data governance.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Automated lineage discovery across databases, ETL, and BI tools</li>
            <li>Column-level lineage with transformation logic capture</li>
            <li>Impact analysis for proposed schema or pipeline changes</li>
            <li>Data flow visualization with interactive dependency graphs</li>
            <li>Compliance documentation with audit-ready lineage reports</li>
            <li>Integration with Snowflake, Databricks, dbt, and Airflow</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Understand exactly where data comes from and how it transforms</li>
            <li>Assess impact of changes before making them</li>
            <li>Meet GDPR and CCPA data provenance requirements</li>
            <li>Reduce time spent on data troubleshooting by 60%</li>
        </ul>
      </section>

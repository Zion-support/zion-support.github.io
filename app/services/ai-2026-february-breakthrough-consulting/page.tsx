      ...
      <section className="text-left">
        <div className="text-left">
          <div className="text-left">
            ...
            <h3 className="text-left">Our Consulting Methodology</h3>"
            <h4 className="text-left">Phase 1: Discovery and Assessment (Weeks 1-2)</h4>"
            <ul className="text-left">
            ...
            <h4 className="text-left">Phase 2: Strategy and Planning (Weeks 3-4)</h4>"
            <ul className="text-left">
            ...
            <h4 className="text-left">Phase 3: Implementation and Deployment (Weeks 5-12)</h4>"
            <ul className="text-left">
            ...
            <h4 className="text-left">Phase 4: Optimization and Support (Ongoing)</h4>"
            <ul className="text-left">

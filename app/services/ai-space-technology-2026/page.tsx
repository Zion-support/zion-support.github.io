          ...
          <div className="text-left">
            ...
            <div className="text-left">
              <div>
                ...
                <p className="text-left">Custom space AI implementation</p>"
              </div>
              
              <div>
                <h4 className="text-left">Implementation Time</h4>"
                <div className="text-left">12-24 months</div>"
                <p className="text-left">Full deployment and testing</p>"
              </div>
              
              <div>
                <h4 className="text-left">ROI Timeline</h4>"
                <div className="text-left">18-36 months</div>"

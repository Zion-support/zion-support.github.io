    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Accessibility Compliance Tracker</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Tracks internal systems, documents, and services for WCAG and Section 508 gaps with issue routing and evidence logging.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Accessibility issue tracking</li>
            <li>WCAG/508 gap analysis</li>
            <li>Owner routing and fixes</li>
            <li>Evidence and history logs</li>
            <li>Device and screen-reader tests</li>
            <li>Executive readiness cards</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce compliance review gaps</li>
            <li>Keep citizen services accessible</li>
            <li>Produce defensible evidence</li>
            <li>Simplify audit response</li>
        </ul>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-5">
            ...
            <p className="mt-2 text-2xl font-bold">$1,399/mo</p>
          </div>
        </div>

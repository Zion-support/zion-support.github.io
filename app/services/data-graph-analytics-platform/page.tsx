  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <BreadcrumbSchema path=`/services/data-graph-analytics-platform` title="Graph Analytics &amp; Network Intelligence" />
        <h1 className="text-4xl font-bold mb-6">Graph Analytics &amp; Network Intelligence</h1>
        <p className="text-lg text-gray-300 mb-8">Large-scale network analytics: entity relationship graph builder, centrality and community detection, per-edge anomaly scoring, influencer score per node, GNN-r</p>

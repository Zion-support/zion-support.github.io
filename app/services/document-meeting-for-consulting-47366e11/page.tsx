...
export const metadata = {
  title: "Document Meeting for Consulting - Zion Tech Group",
  description: "Unlock unprecedented growth with Document Meeting for Consulting. This autonomous system provides meeting intelligence with zero manual intervention needed.",
  alternates: {
    canonical: `https://ziontechgroup.com/services/document-meeting-for-consulting-47366e11`
  }
};

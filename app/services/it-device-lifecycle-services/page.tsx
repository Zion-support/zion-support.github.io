    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">IT Device Lifecycle &amp; Endpoint Services</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Standardize device provisioning, patching, monitoring, and decommission workflows across fleets. Reduce support overhead and maintain consistent security baselines.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Device provisioning automation</li>
            <li>Patch and update enforcement</li>
            <li>Endpoint health monitoring</li>
            <li>Secure decommission workflows</li>
            <li>Inventory and lifecycle tracking</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Reduce provisioning delays</li>
            <li>Improve patch coverage</li>
            <li>Maintain consistent device baselines</li>
            <li>Streamline device retirement</li>
        </ul>
      </section>

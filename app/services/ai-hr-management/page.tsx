  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-gray-900 mb-6">AI HR Management System</h1>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Intelligent human resources management with AI-powered recruitment, employee analytics, 
          and automated workflows to optimize your workforce and improve employee satisfaction.
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-200 rounded-xl p-8 mb-16">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">HR Management Benefits</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="text-center">
            <div className="text-4xl mb-4">⚡</div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">60% Faster Hiring</h3>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Predictive analytics prevent turnover</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">💰</div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">35% Cost Savings</h3>
            <p className="text-gray-600">Automated processes reduce HR costs</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">😊</div>
            <h3 className="text-lg font-semibold text-gray-900 mb-2">85% Satisfaction</h3>
...
function PricingSection() {
  return (
    <div className="mb-16">
      <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">HR Management Pricing</h2>
...
function PricingCard({ name, price, duration, features, popular }: { 
  ...
  return (
    <div className={`relative bg-white border-2 rounded-xl p-8 ${popular ? 'border-violet-500 shadow-lg' : 'border-gray-200'}`}>
      {popular && (
...
function ContactSection() {
  return (
    <div className="bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-200 rounded-xl p-8 text-center">
      <h3 className="text-2xl font-bold text-gray-900 mb-4">Ready to Transform Your HR Operations?</h3>
      <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
        Let's discuss your HR needs and create an AI-powered solution that optimizes your workforce and improves employee satisfaction.
      </p>

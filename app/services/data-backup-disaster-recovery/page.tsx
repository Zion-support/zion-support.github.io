...
export const metadata = {
  title: 'Data Backup & Disaster Recovery — Ransomware Protection | Zion Tech Group',
  description: 'Automated backup and disaster recovery with ransomware protection and instant restore capabilities.',
  alternates: {
    canonical: 'https://ziontechgroup.com/services/data-backup-disaster-recovery',
  },
};
    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Data Backup &amp; Disaster Recovery — Ransomware Protection</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">Automated backup and disaster recovery with ransomware protection and instant restore capabilities.</p>

    ...
    <main className="min-h-screen bg-slate-950 text-white">
      <section className="relative overflow-hidden border-b border-cyan-500/20 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
        ...
        <div className="relative mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Managed Detection &amp; Response (MDR) Cybersecurity Service</h1>
          <p className="mt-6 max-w-3xl text-lg leading-relaxed text-slate-300">24/7 managed security operations center (SOC) providing continuous threat monitoring, proactive threat hunting, endpoint detection and response (EDR), and rapid incident response. Expert analysts backed by AI-driven threat detection protect your organization around the clock.</p>
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>24/7/365 SOC monitoring by certified analysts</li>
            <li>Proactive threat hunting across endpoints and network</li>
            <li>Endpoint Detection &amp; Response (EDR) management</li>
            <li>Incident response with &lt;30 minute SLA</li>
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 sm:px-6 lg:px-8">
        ...
        <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Enterprise-grade security at 1/3 the cost of in-house SOC</li>
            <li>Detect threats that automated tools miss</li>
            <li>Respond to incidents in minutes, not hours</li>
            <li>Meet SOX, HIPAA, PCI-DSS compliance requirements</li>
            <li>Sleep knowing experts are watching your environment</li>
        </ul>
      </section>

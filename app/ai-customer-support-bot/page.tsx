...
import { Bot, CheckCircle, ArrowRight, Star, TrendingUp, Users, Target, Zap, Brain, MessageSquare, Clock, Globe } from 'lucide-react';
...
const AICustomerSupportBotPage: React.FC = () => {
  const features = [
    {
      ...
      description: 'Advanced NLP for understanding customer queries and providing accurate responses'
    },
    {
      icon: Clock,
    ...
    },
    {
      ...
      description: 'Comprehensive reporting on customer interactions and satisfaction'
    },
    {
      icon: Target,
      title: 'Multi-Channel Support',
      description: 'Support customers across website, mobile app, and social media'
    },
    {
      icon: Zap,
      title: 'Quick Setup',
      description: 'Deploy your AI bot in minutes with our easy-to-use platform'
    }
  ];
  ...
  const benefits = [
    ...
    '50% improvement in resolution rates'
  ];
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          <div className="max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 cyber-text-3d neon-pulse glitch" data-text="AI Customer Support Bot">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto mb-8 leading-relaxed">
              ...
              Reduce response time by 90% and increase satisfaction by 45%.
            </p>
        ...
        <section className="cyber-card p-8 text-center">
          ...
          <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
            Join thousands of businesses already using AI Customer Support Bot to provide better customer service.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="cyber-button px-8 py-4 text-lg font-semibold hover:scale-105 transition-all duration-300">
              Start Free Trial

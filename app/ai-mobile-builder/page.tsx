...
const AiMobileBuilderPage: React.FC = () => {
  ...
  const features = ['AI-Powered App Generation', 'Cross-Platform Development', 'Real-time Code Generation', 'Intelligent UI/UX Design', 'Automated Testing', 'One-Click Deployment']

  const benefits = ['Reduce development time by 80%', 'No coding experience required', 'Built-in best practices', 'Automatic optimization', '24/7 AI assistance', 'Scalable architecture']

  const pricing = [{
      plan: 'Starter', price: '$399/month', features: ['Up to 3 apps', 'Basic AI features', 'Standard support', '1GB storage'],
      popular: false

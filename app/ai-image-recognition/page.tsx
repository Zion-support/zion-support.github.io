...
const AiImageRecognitionPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai image recognition services and solutions by Zion Tech Group."
      keywords="ai image recognition, services, solutions, technology, Zion Tech Group"
    >

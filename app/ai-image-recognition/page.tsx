...
const AiImageRecognitionPage: React.FC = () => {
  ...
  const testimonials = [
    {
      ...
      role: 'CTO',
      content: 'This imagerecognition solution transformed our operations completely. Highly recommended!',
      rating: 5
    },
    {
      name: 'Michael Chen',
  ...
  return (
    <>
      <Helmet>
        <title>AiImageRecognition - Zion Tech Group | AI Solutions</title>
        <meta name="description" content="Professional imagerecognition services by Zion Tech Group. Transform your business with cutting-edge solutions." />
        <meta name="keywords" content="imagerecognition, ai solutions, business automation, Zion Tech Group" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
                AiImageRecognition <span className={"bg-gradient-to-r " + getGradientColors() + " bg-clip-text text-transparent"}>Solutions</span>
              </h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
                Transform your business with our advanced imagerecognition services.
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 mb-16">
              <h2 className="text-3xl font-bold text-white mb-8 text-center">Why Choose Our AiImageRecognition Services?</h2>
            ...
            <div className="bg-gradient-to-r from-cyan-900 to-purple-900 rounded-2xl p-8 text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Contact our experts today and discover how our imagerecognition solutions can drive your success.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className={"bg-gradient-to-r " + getButtonColors() + " text-white px-8 py-4 rounded-lg font-bold transition-all duration-300 flex items-center justify-center gap-2"}>

...
export const metadata: Metadata = {
  title: 'Zion AI Content Moderation | Zion Tech Group',
  description:
    'Zion AI Content Moderation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automati',
  alternates: { canonical: '/zion-ai-content-moderation' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Content Moderation empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Content Moderation',
      }}
    />
  );
}

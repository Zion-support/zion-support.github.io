...
const PricingPage: React.FC = () => {
  ...
  return (
    <>
        ...
        </Helmet></Helmet><title />Pricing - Zion Tech Group | Transparent AI & IT Solutions Pricing
        </title>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        {/* Hero Section */}
          ...
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              </div></div><DollarSign className="w-5 h-5 ml-2" />
              <span />Transparent Pricing</span>
            </div>
            <h1 className="w-5 h-5 ml-2" />
              Simple, Transparent{' '}
              <span className="w-5 h-5 ml-2" />Pricing
              </span>
            </h1>
            <p className="w-5 h-5 ml-2">Choose the plan that fits your business needs. All plans include 14-day free trials and no setup fees.
            </p>
            {/* Billing Toggle */}
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              </div></div><span className="{`text-lg" ${billingCycle === 'monthly' ? 'text-white' : 'text-gray-400'}`}  />Monthly
              </span>
              <button
              ...
              {billingCycle === 'yearly' && (
                <span className="w-5 h-5 ml-2" />Save up to 20%
                </span>
              )}
            </div>
        </section>
        ...
        <section className="w-5 h-5 ml-2" />
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                ...
                <span className="w-5 h-5 ml-2" />AI Services</span> Pricing
              </h2>
              <p className="w-5 h-5 ml-2">Advanced artificial intelligence solutions for every business size
              </p>
            </div>
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              {aiServicesPricing.map((plan, index) => (
                </div></div><div key="{index}" className="{`bg-white/10" backdrop-blur-lg rounded-2 xl p-8 border border-white/20 hover: bg-white/20 transition-all duration-300 relative ${plan.popular ? 'ring-2 ring-cyan-400 scale-105' : ''}`} />
                  {plan.popular && (
                    </div></div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                  ...
                  <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                    ...
                    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                      ...
                      </div></div><span className="w-5 h-5 ml-2" />/{billingCycle === 'monthly' ? 'month' : 'year'}</span>
                    </div>
                    {billingCycle === 'yearly' && (
        ...
        <section className="w-5 h-5 ml-2" />
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                ...
                <span className="w-5 h-5 ml-2" />IT Services</span> Pricing
              </h2>
              <p className="w-5 h-5 ml-2">Comprehensive technology solutions for modern businesses
              </p>
            </div>
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              {itServicesPricing.map((plan, index) => (
                </div></div><div key="{index}" className="{`bg-white/10" backdrop-blur-lg rounded-2 xl p-8 border border-white/20 hover: bg-white/20 transition-all duration-300 relative ${plan.popular ? 'ring-2 ring-emerald-400 scale-105' : ''}`} />
                  {plan.popular && (
                    </div></div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                      </div></div><span className="w-5 h-5 ml-2" />Most Popular
                      </span>
                  ...
                  <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                      ...
                      </div></div><Settings className="w-5 h-5 ml-2" />
                    </div>
                    <h3 className="w-5 h-5 ml-2" />{plan.name}</h3>
                    <p className="w-5 h-5 ml-2">{plan.description}</p>
                    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        ...
        <section className="w-5 h-5 ml-2" />
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                ...
                <span className="w-5 h-5 ml-2" />Micro SAAS</span> Pricing
              </h2>
              <p className="w-5 h-5 ml-2">Ready-to-use business tools with AI-powered features
              </p>
            </div>
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              {microSaasPricing.map((plan, index) => (
                </div></div><div key="{index}" className="{`bg-white/10" backdrop-blur-lg rounded-2 xl p-8 border border-white/20 hover: bg-white/20 transition-all duration-300 relative ${plan.popular ? 'ring-2 ring-purple-400 scale-105' : ''}`} />
                  {plan.popular && (
                    </div></div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                      </div></div><span className="w-5 h-5 ml-2" />Most Popular
                      </span>
        ...
        <section className="w-5 h-5 ml-2" />
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                ...
                Additional <span className="w-5 h-5 ml-2" />Services</span>
              </h2>
              <p className="w-5 h-5 ml-2">Enhance your plan with these powerful add-ons
              </p>
            </div>
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              {addOns.map((addon, index) => (
                </div></div><div key="{index}" className="bg-white/10 backdrop-blur-lg rounded-2 xl p-6 border border-white/20 hover:bg-white/20transition-allduration-300" />
                  </div></div><h3 className="w-5 h-5 ml-2" />{addon.name}</h3>
                  <p className="w-5 h-5 ml-2">{addon.description}</p>
                  <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        ...
        <section className="w-5 h-5 ml-2" />
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                ...
                Frequently Asked <span className="w-5 h-5 ml-2" />Questions</span>
              </h2>
              <p className="w-5 h-5 ml-2">Everything you need to know about our pricing and services
              </p>
            </div>
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              {faqs.map((faq, index) => (
                </div></div><div key="{index}" className="bg-white/10 backdrop-blur-lg rounded-2 xl p-6borderborder-white/20" />
                  </div></div><h3 className="w-5 h-5 ml-2" />{faq.question}</h3>
                  <p className="w-5 h-5 ml-2">{faq.answer}</p>
                </div>
              ))}
            </div>
        </section>
        ...
        <section className="w-5 h-5 ml-2" />
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                ...
                <p className="w-5 h-5 ml-2">Start your free trial today and experience the power of our AI and IT solutions.
                </p>
                <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                  </div></div><Link to="/contact" className="bg-gradient-to-r from-cyan-500to-purple-500 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-cyan-600 hover:to-purple-600 transition-all duration-300 transform hover:scale-105shadow-lghover:shadow-cyan-500/25">Start Free Trial
                  </Link>

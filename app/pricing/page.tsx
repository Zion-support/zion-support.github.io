  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="pricing, AI services, IT solutions, plans, enterprise, custom" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex justify-center mb-12">
              <div className="bg-slate-800/50 backdrop-blur-sm border border-purple-500/20 rounded-xl p-2">
                {[

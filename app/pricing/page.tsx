                ...
                <Link
                  ...
                  className={`w-full py-4 px-6 rounded-xl font-semibold text-center transition-all duration-300 flex items-center justify-center gap-2 ${
                    plan.popular
                      ...
                      : 'bg-white/10 text-white border-2 border-white/20 hover:border-cyan-400 hover:bg-cyan-400/10'
                  }`}
                >
                  Get Started
          ...
          <div className="mt-16 text-center">
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10">
              ...
              <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                Our Enterprise plan is fully customizable. Contact us to discuss your specific requirements and get a tailored quote.
              </p>
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-4 rounded-xl font-semibold hover:from-purple-600 hover:to-pink-600 transition-all duration-300"
              >

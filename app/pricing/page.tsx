  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <SEOOptimizer
        ...
        description="Transparent pricing for our AI solutions and technology services. Choose the plan that fits your business needs."
        keywords="pricing, AI solutions, technology services, plans, packages"
      />

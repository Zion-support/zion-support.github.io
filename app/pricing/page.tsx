...
const PageComponent: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Pricing - Zion Tech Group | Pricing Plans</title>
        <meta name="description" content="Choose the perfect pricing plan for your business needs and budget." />
        <meta name="keywords" content="pricing, plans, business solutions, cost" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Choose the perfect pricing plan for your business needs and budget.
              </p>

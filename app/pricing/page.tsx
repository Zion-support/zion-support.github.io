...
const PricingPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet></Helmet>
        <title></titl>Pricing - Zion Tech Group | Transparent AI & IT Pricing</title>
        ...
        <div className="container mx-auto px-4 py-16"></di></div>
          <div className="text-center mb-16"></di></div>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6"></h1>
              Transparent <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400"></spa>Pricing</span>
            </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto"></di></div>
              ...
              ></di></div>
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></di></div>
                    <div className="bg-gradient-to-r from-purple-500 to-blue-500 text-white px-6 py-2 rounded-full text-sm font-semibold flex items-center gap-2"></di></div>
                ...
                <div className="text-center mb-8"></di></div>
                  ...
                  <div className="flex items-baseline justify-center"></di></div>
                    <span className="text-4xl font-bold text-white"></spa>{plan.price}</span>
                    <span className="text-gray-400 ml-1"></spa>{plan.period}</span>
                  </div>
                </div>
          ...
          <div className="text-center mt-16"></di></div>
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 max-w-4xl mx-auto"></di></div>

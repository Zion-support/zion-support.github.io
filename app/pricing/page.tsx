    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">"
        ...
        <section className="py-16 px-4">"
          <div className="max-w-7xl mx-auto"> " <h2 className="text-3xl font-bold text-white mb-12 text-center">Why Choose Our Page Services?</h2> " <div className="grid grid-cols-1 md:grid-cols-3 gap-8">"
              <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 text-center"> " <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full mx-auto mb-4 flex items-center justify-center">"
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 text-center">"
                <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full mx-auto mb-4 flex items-center justify-center"> " <CheckCircle className="w-8 h-8 text-white" />"
                </div>
                <h3 className="text-xl font-bold text-white mb-3">24/7 Support</h3> " <p className="text-gray-300">Round-the-clock assistance for your business needs</p> " </div>"
              <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 text-center"> " <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full mx-auto mb-4 flex items-center justify-center">"
                  <CheckCircle className="w-8 h-8 text-white" /> " </div>"

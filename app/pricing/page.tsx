  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Transparent pricing for AI and IT solutions. Choose from our flexible plans or get a custom quote for enterprise needs." />
        <meta name="keywords" content="pricing, AI services, IT solutions, enterprise, custom solutions" />
      </Helmet>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {getCurrentServices().map((service, index) => (
                <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-cyan-500/20 rounded-xl p-6 hover:border-cyan-500/40 transition-all duration-300">
                  ...
                  <button className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-medium py-2 px-4 rounded-lg transition-all duration-300">
                    Get Started
                  </button>
                </div>
              ))}
          ...
          <section className="mb-16">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">
                All plans include our core services with no setup fees. Upgrade or downgrade at any time.
              </p>
            </div>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Transparent pricing for our AI and IT services. Choose the plan that fits your needs." />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Transparent pricing for our AI and IT services. Choose the plan that fits your needs.
            </p>

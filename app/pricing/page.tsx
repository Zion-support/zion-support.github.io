          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-6">
                ...
                <p className="text-gray-300">
                  The Enterprise plan includes custom AI solutions, a dedicated team, 24/7 support, and tailored features based on your specific needs.
                </p>
              </div>
              <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-white mb-3">
                ...
                <p className="text-gray-300">
                  Yes, we offer custom pricing for large organizations with specific requirements. Contact us for a personalized quote.
                </p>
              </div>
            </div>
          </div>

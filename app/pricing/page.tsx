        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-slate-800/50 rounded-lg p-6">
              ...
              <p className="text-gray-300">
                No setup fees for Starter and Professional plans. Enterprise plans may include setup costs depending on the complexity of your requirements.
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-6">
              ...
              <p className="text-gray-300">
                We accept all major credit cards, bank transfers, and can accommodate enterprise payment terms for larger contracts.
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-6">
              ...
              <p className="text-gray-300">
                Yes, our Enterprise plan includes fully customized solutions tailored to your specific business needs and requirements.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-slate-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
                className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25"
              >
                Start Free Trial
              </Link>
              <Link

...
const PricingPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Pricing Solutions',
      description: 'Professional pricing services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored pricing implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your pricing needs.'
    }
  ];

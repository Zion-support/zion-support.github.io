            ...
            {plans.map((plan, index) => (
              <div
                ...
                className={`relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border ${
                  plan.popular ? 'ring-2 ring-cyan-400 scale-105' : 'border-gray-600'
                }`}
              >
                {plan.popular && (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-300">
                Absolutely! Our Enterprise plan includes custom AI development and integrations. 
            ...
            <div>
              ...
              <p className="text-gray-300">
                All plans include support, with response times varying by plan. Professional and Enterprise 
                plans include priority support and dedicated account managers.
              </p>
            </div>
          </div>
        </div>

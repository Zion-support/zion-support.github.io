  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Transparent pricing for our AI and IT solutions. Choose the perfect plan for your business needs." />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="bg-slate-800/30 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 md:p-12">
              ...
              <div className="text-center">
                <Link
                  to="/contact"
                  className="inline-flex items-center gap-2 bg-gradient-to-r from-cyan-400 to-purple-400 text-slate-900 px-8 py-3 rounded-lg font-semibold hover:from-cyan-500 hover:to-purple-500 transition-all duration-300"
                >
                  Get Custom Quote
                  <ArrowRight className="w-4 h-4" />
                </Link>

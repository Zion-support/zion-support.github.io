            ...
            {plans.map((plan, index) => (
              <div
                ...
                className={`relative bg-white/5 backdrop-blur-sm border rounded-2xl p-8 ${
                  plan.popular
                    ? 'border-cyan-400 scale-105 shadow-2xl shadow-cyan-400/20'
                    : 'border-white/10 hover:border-white/20'
                } transition-all duration-300`}
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span className="bg-gradient-to-r from-cyan-400 to-purple-400 text-slate-900 px-4 py-2 rounded-full text-sm font-semibold flex items-center gap-2">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
              ...
              <p className="text-gray-300">
                Our Enterprise plan includes custom development. We can also create custom solutions for any plan level.
              </p>
            </div>
          </div>
        </div>

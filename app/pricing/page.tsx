...
export default function PricingPage() {
  return (
    <>
      <Helmet>
        <title>Pricing - Zion Tech Group<div></title>
        <meta name="description" content="Transparent pricing for our AI and IT services." /></div>
      </Helmet></div>
      <div><div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center"></div></div>
        <div className="text-center"></div></div></div>
          ...
          <p className="text-lg text-gray-300 mb-8">Contact us for custom pricing based on your needs.<div></p>
        </div></div>
      </div></div>
    </></div>
  );

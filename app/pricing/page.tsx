  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Affordable AI and IT solutions pricing. Choose from our flexible plans for AI services, IT solutions, and Micro SaaS products." />
        <meta name="keywords" content="pricing, AI services, IT solutions, Micro SaaS, affordable, plans" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Choose the perfect plan for your business needs. All plans include our premium AI and IT solutions.
            </p>
          </div>

          {/* Service Tabs */}
          <div className="flex justify-center mb-12">
            <div className="bg-slate-800/50 backdrop-blur-sm border border-cyan-400/20 rounded-lg p-2">
              {['ai', 'it', 'saas'].map((tab) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="capitalize">{tab === 'saas' ? 'Micro SaaS' : tab.toUpperCase()}</span>
                  </button>
                );
              })}
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {getCurrentServices().map((service, index) => (
              <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-cyan-400/20 rounded-lg p-6 hover:border-cyan-400/40 transition-all duration-300">
                ...
                <button className="w-full bg-gradient-to-r from-cyan-500 to-purple-500 text-white py-2 px-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-600 transition-all duration-300">
                  Get Started
                </button>
              </div>
            ))}
          ...
          <section className="mb-16">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">Complete Solutions</h2>
              <p className="text-gray-300 max-w-2xl mx-auto">
                All-inclusive packages that combine AI services, IT solutions, and ongoing support.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {plans.map((plan, index) => (
                <div key={index} className={`bg-slate-800/50 backdrop-blur-sm border rounded-lg p-8 relative ${
                  plan.popular 

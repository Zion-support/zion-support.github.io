  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Pricing - Zion Tech Group | AI & IT Solutions</title><//title><///title><////title></////title>
        <meta;";
          name="description;";
          ...
          <div className="max-w-7xl mx-auto">"
            <div className="text-center mb-16">"
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto"></p>;";
                Advanced AI solutions to transform your business operations and drive growth."
              </p><//p>"
            </div>"
...
>"
                  {plan.popular && ("
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">"
                      <span className="bg-gradient-to-r from-purple-500 to-cyan-600 text-white px-4 py-2 rounded-full text-sm font-semibold"></span>;,;,;,;,
                        Most Popular"
                      </span><//span><///span>"
                    </div><//div>"
                  )}"
...
>;,;,;,;,
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10">"
          <div className="max-w-4xl mx-auto">"
            ...
            <div className="space-y-6"></div><//div><///div><////div>
              {faqs.map((faq, index) => (
                <div;
                  key={index};";
                ...
                >"
                  ...
                  <p className="text-gray-300">{faq.answer}</p><//p><///p><////p></////p>
                </div><//div><///div><////div></////div>
              ))}
            </div><//div><///div><////div></////div>
          </div><//div><///div><////div></////div>

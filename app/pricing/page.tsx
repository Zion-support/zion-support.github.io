  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Transparent pricing for AI and IT solutions. Choose from our flexible plans or get a custom quote. Starting at $99/month for AI services." />
        <meta name="keywords" content="pricing, AI services pricing, IT services pricing, cloud migration cost, cybersecurity pricing" />
        <meta property="og:title" content="Pricing - Zion Tech Group" />
        <meta property="og:description" content="Affordable AI and IT solutions with transparent pricing. Get started today." />
          ...
          <section className="py-20 px-4">
            <div className="max-w-7xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Transparent, competitive pricing for all our AI and IT solutions. 
                Choose the plan that fits your business needs or get a custom quote.
              </p>
            </div>
          </section>
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                  Comprehensive solutions for large organizations with custom requirements and dedicated support.
                </p>
              </div>

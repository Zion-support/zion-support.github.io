        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <h1
              ...
              data-text="Transparent Pricing"
            >
              Transparent Pricing
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Choose the perfect plan for your business. All our services come
              with transparent pricing, no hidden fees, and flexible billing
              options.
            </p>
            ...
            <div className="flex items-center justify-center gap-4 mb-12">
              ...
              >
                <div
                  className={`absolute top-1 w-6 h-6 bg-cyan-400 rounded-full transition-transform ${
                    billingCycle === "yearly"
                      ? "translate-x-8"
                      : "translate-x-1"
                  }`}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              All plans include core features with different levels of support
              and customization
            </p>
          </div>
          ...
          <div className="space-y-6">
            <div className="glass-card p-6">
              ...
              <p className="text-gray-400">
                Yes! Most of our services offer a 14-day free trial. Contact us
            ...
            <div className="glass-card p-6">
              ...
              <p className="text-gray-400">
                No setup fees! All our services are ready to use immediately
                after signup.
              </p>
            </div>

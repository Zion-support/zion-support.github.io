  ...
  return (
    <>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Transparent pricing for AI services, IT solutions, and micro SaaS tools. Choose the perfect plan for your business needs." /></meta>
      </Helmet>
      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-16"></main>
        <div className="container mx-auto px-4 py-16"></div>
          <div className="max-w-6xl mx-auto"></div>
                ...
                ></div>
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                      <span className="bg-cyan-500 text-white px-4 py-2 rounded-full text-sm font-semibold flex items-center"></span>
                  ...
                  <div className="text-center mb-6"></div>
                    <div className={`w-16 h-16 bg-gradient-to-r ${plan.color} rounded-lg flex items-center justify-center mx-auto mb-4`}></div>
                      <plan.icon className="w-8 h-8 text-white" /></plan>
                    </div>
            ...
            {/* Enterprise Section */}
            <div className="bg-slate-800/50 rounded-lg p-8 text-center mb-16"></div>

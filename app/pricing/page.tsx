...
;
constPricingPage: React.FC = () => {const [billingCycle, setBillingCycle] = useState('monthly');
  ...
  constitServicesPricing = [{name: 'ITBasic',;
    ...
    {name: 'ITProfessional',;
      ...
      features: ['Full-stackdevelopment',;
        'Cloudmigration',;
        'Prioritysupport',;
        '24/7 monitoring',;
        'Advancedsecurity',;
    ...
    {name: 'ITEnterprise',;
      ...
      features: ['Customenterprisesolutions',;
  ...
  constmicroSaasPricing = [{name: 'MicroSAASStarter',;
  ...
  constaddOns = [{name: 'AIContentGeneration',;
  ...
  constfaqs = [{question: 'Whatisincludedinthefreetrial?',;
  ...
  constformatPrice = (price: number) => {returnnewIntl.NumberFormat('en-US', {
      style: 'currency',;
      currency: 'USD',;
...
;
  constgetSavings = (monthly: number, yearly: number) => {constmonthlyTotal = monthly * 12;

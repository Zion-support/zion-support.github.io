  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Transparent pricing for our AI and IT services. Choose from flexible plans or get a custom quote for your business needs." />
        <meta name="keywords" content="pricing, AI services pricing, IT services pricing, custom solutions, enterprise pricing" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            {getCurrentServices().map((service, index) => (
              <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300">
                ...
                <div className="mb-4">
                  <div className="text-sm text-gray-300 mb-2">Market Price: {service.marketPrice}</div>
                  <div className="text-xs text-green-400">Save up to 40%</div>
                </div>
          ...
          <section className="mb-16">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">All-Inclusive Plans</h2>
              <p className="text-gray-300 max-w-2xl mx-auto">
                Choose from our comprehensive plans that include multiple services at a discounted rate.
              </p>
            </div>

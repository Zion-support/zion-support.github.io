  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Transparent pricing for our AI and IT services. Choose the perfect plan for your business needs." />
        <meta name="keywords" content="pricing, AI services pricing, IT services cost, cloud solutions pricing, micro SaaS pricing" />
      </Helmet>
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the perfect plan for your business needs. All prices include setup, training, and ongoing support.
              </p>
            </div>

            {/* Service Category Tabs */}
            <div className="flex justify-center mb-12">
              <div className="bg-slate-800/50 backdrop-blur-lg rounded-lg p-2 border border-cyan-500/20">
                {[
            ...
            <div className="mb-16">
              <h2 className="text-3xl font-bold text-white text-center mb-12">
                Complete Solution Plans
              </h2>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {plans.map((plan, index) => (
                  <div key={index} className={`relative bg-slate-800/50 backdrop-blur-lg rounded-lg p-8 border transition-all duration-300 ${
                    plan.popular 

...
export default function IotedgecomputingPage() {
  return (
    <><Helmet>
        ...
        <meta name="description" content="Professional iotedgecomputing by Zion Tech Group. Transform your business with our expert solutions." />
      </Helmet>
    ...
    <><Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">Professional iot edge computing solutions coming soon.</p>
          <Link 
            to="/contact" 

...
const IotEdgeComputingPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Iot Edge Computing Solutions',
      description: 'Professional iot edge computing services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored iot edge computing implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your iot edge computing needs.'
    }
  ];

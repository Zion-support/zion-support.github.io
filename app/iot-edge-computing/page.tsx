  ...
  const features = [
    {
      icon: <Cpu className="w-8 h-8 text-blue-500" />,
      title: 'Edge Processing',
      description: 'Process data at the edge for reduced latency and improved real-time performance.'      description: 'Process data at the edge for reduced latency and improved real-time performance.'      description: 'Intelligent data management and analytics for IoT devices and sensors.',
    },
    {

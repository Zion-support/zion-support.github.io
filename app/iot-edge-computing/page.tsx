  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <Helmet>
        ...
        <meta name="description" content="Iot Edge Computing solutions by Zion Tech Group" />
      </Helmet>
      
      <div className="container mx-auto px-4 py-20">
        <h1 className="text-4xl font-bold mb-8">Iot Edge Computing</h1>
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive iot edge computing solutions designed to meet your business needs.
          </p>
<<<<<<< HEAD
...
<<<<<<< HEAD
    <>
      <Helmet>
        <title>IoT Edge Computing - Zion Tech Group</title>
        <meta name="description" content="Edge computing solutions for IoT applications." />
        <meta name="keywords" content="IoT, edge computing, sensors, connected devices" />
      </Helmet>

...
export default function AccessibilitypagePage() {
  return()
    ...
    <>
    <title>
</>Accessibility Page - Zion Tech Group<>
    </title>
    <h1 className="text-4xl font-bold text-white mb-6">
</>Accessibility Page<>
    </h1>
    <p className="text-lg text-gray-300 mb-8">
</>Learn about our commitment to accessibility and inclusive design.</p>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <h1 className="text-4 xl font-bold text-white mb-6"  >Accessibility Page<>
    </h1>
    <p className="text-lg text-gray-300 mb-8">
</>Professional accessibility page services coming soon.<>
    </p>
    <Link;</Link>
</></Link>
          to="/contact"

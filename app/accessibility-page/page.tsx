...
const AccessibilityPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      benefits: ['Audio descriptions', 'Closed captions', 'Alternative formats', 'Volume controls']
    },
    {
      icon: MousePointer,
      title: 'Motor Accessibility',
      description: 'Keyboard navigation, voice control, and assistive technologies for users with motor impairments.',
      benefits: ['Keyboard navigation', 'Voice control', 'Assistive devices', 'Customizable controls']
    },
    {
      icon: Keyboard,

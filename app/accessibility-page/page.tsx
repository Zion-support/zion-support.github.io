  ...
  return (
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
      ...
      <div className="max-w-7xlmx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        <h1 className="te xt-4 xl font-boldtext-white mb-6"  >Accessibility Page</h1>
        <p className="text-lgtext-gray-300mb-8">Professional accessibility page services coming soon.</p>
        <Link
          to="/contact"

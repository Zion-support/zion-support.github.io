...
import { Accessibility, Eye, Volume2, MousePointer, ArrowRight } from "lucide-react";
...
const AccessibilityPagePage: React.FC = () => {
  const features = [
    {
      ...
      description: "Comprehensive visual accessibility solutions for users with visual impairments.",
      benefits: [
    ...
    },
    {
      ...
      description: "Motor accessibility solutions for users with mobility impairments.",
      benefits: [
        "Keyboard navigation",
  ...
  return (
    <>
      <Helmet>
        <title>Accessibility Page - Zion Tech Group | AI & IT Solutions</title>
        <meta name="description" content="Comprehensive accessibility solutions for digital inclusion and compliance." />
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Comprehensive accessibility solutions for digital inclusion and compliance.
            </p>
                    ...
                    <ul className="space-y-2">
                      {feature.benefits.map((benefit, benefitIndex) => (
                        <li key={benefitIndex} className="flex items-start text-sm text-gray-300">
                          <Accessibility className="w-4 h-4 text-purple-400 mr-2 flex-shrink-0" />
                          {benefit}
                        </li>
                      ))}
                    </ul>

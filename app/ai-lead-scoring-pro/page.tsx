        ...
        <div id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">Track and analyze customer interactions across all touchpoints to understand engagement patterns</p>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">🎯</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Predictive Scoring</h3>
              <p className="text-gray-600">Use machine learning to predict conversion probability and identify high-value leads</p>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">✅</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Lead Qualification</h3>
              <p className="text-gray-600">Automatically qualify leads based on multiple criteria and behavioral indicators</p>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">🔮</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Conversion Prediction</h3>
              <p className="text-gray-600">Predict which leads are most likely to convert and when they'll be ready to buy</p>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">🔗</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">CRM Integration</h3>
              <p className="text-gray-600">Seamlessly integrate with your existing CRM and marketing automation platforms</p>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">📈</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Analytics Dashboard</h3>
              <p className="text-gray-600">Comprehensive analytics and insights into lead quality and conversion performance</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">Choose the plan that fits your lead scoring needs</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gray-50 p-8 rounded-xl">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Basic</h3>
                <div className="text-4xl font-bold text-indigo-600 mb-4">$149<span className="text-lg text-gray-500">/month</span></div>
              ...
              <div className="bg-indigo-600 text-white p-8 rounded-xl relative">
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <span className="bg-yellow-400 text-indigo-900 px-4 py-1 rounded-full text-sm font-semibold">Most Popular</span>
                </div>
                <h3 className="text-2xl font-bold mb-4">Pro</h3>
                <div className="text-4xl font-bold mb-4">$399<span className="text-lg opacity-75">/month</span></div>
                <ul className="space-y-3 mb-8">
              ...
              <div className="bg-gray-50 p-8 rounded-xl">
                ...
                <div className="text-4xl font-bold text-indigo-600 mb-4">$999<span className="text-lg text-gray-500">/month</span></div>
                <ul className="space-y-3 mb-8">
        ...
        <div className="bg-gray-50 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">See how our AI lead scoring can transform your sales process</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Sales Optimization</h3>
                <p className="text-gray-600">Focus your sales team on the highest-quality leads and improve conversion rates.</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Marketing Automation</h3>
                <p className="text-gray-600">Automatically segment leads and trigger personalized marketing campaigns based on scores.</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Lead Nurturing</h3>
                <p className="text-gray-600">Identify leads that need nurturing and deliver targeted content at the right time.</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Customer Acquisition</h3>
                <p className="text-gray-600">Find new customers who match your ideal customer profile and are likely to convert.</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Revenue Forecasting</h3>
                <p className="text-gray-600">Predict future revenue based on lead quality and conversion probability.</p>
              </div>
              
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Campaign Optimization</h3>
                <p className="text-gray-600">Optimize your marketing campaigns by focusing on channels that generate high-quality leads.</p>
              </div>
            </div>
          </div>
        </div>

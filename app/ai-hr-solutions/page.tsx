...
export const metadata = {
  title: 'AI HR Solutions | Zion Tech Group',
  description:
    'AI HR Solutions modernizes talent operations with AI-powered sourcing, screening, and workforce analytics. Hire faster, develop talent effectively, and mak',
  alternates: { canonical: '/ai-hr-solutions' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        category: 'HR & Talent',
        description:
          'AI HR Solutions modernizes talent operations with AI-powered sourcing, screening, and workforce analytics. Hire faster, develop talent effectively, and make data-driven people decisions.',
        iconEmoji: '👥',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI HR Solutions to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI HR Solutions to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI HR Solutions analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI HR Solutions',
      }}
    />
  );
}

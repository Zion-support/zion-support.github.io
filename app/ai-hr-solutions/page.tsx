    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              ...
              </div></div><h3 className="text-2xl font-bold text-cyan-400 mb-4">AI Recruitment</h3></h3></h3>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              </div></div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Employee Analytics</h3></h3></h3>
              <p className="text-gray-300 mb-4">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              </div></div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Workforce Planning</h3></h3></h3>
              <p className="text-gray-300 mb-4">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              </div></div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Learning & Development</h3></h3></h3>
              <p className="text-gray-300 mb-4">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              </div></div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Employee Experience</h3></h3></h3>
              <p className="text-gray-300 mb-4">
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              </div></div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Compliance & Safety</h3></h3></h3>
              <p className="text-gray-300 mb-4">

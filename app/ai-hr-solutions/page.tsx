...
const AiHrSolutionsPage: React.FC = () => {
  return (
    <>
      <Helmet>
        </Helmet><title>AI HR Solutions - Zion Tech Group</title>
>>>>>>> origin/main
...
=======
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              ...
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">AI Recruitment</h3>
              <p className="text-gray-300 mb-4">
                Streamline your hiring process with AI-powered candidate screening and matching.
>>>>>>> origin/main
              </p>
              <ul className="text-sm text-gray-400 space-y-2">
                </ul><li>• Resume screening</li>
...
=======
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Employee Analytics</h3>
              <p className="text-gray-300 mb-4">
                Gain deep insights into employee performance, engagement, and satisfaction.
>>>>>>> origin/main
              </p>
              <ul className="text-sm text-gray-400 space-y-2">
                </ul><li>• Performance tracking</li>
...
=======
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Workforce Planning</h3>
              <p className="text-gray-300 mb-4">
...
=======
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Learning & Development</h3>
              <p className="text-gray-300 mb-4">
                Personalized learning paths and skill development recommendations.
>>>>>>> origin/main
              </p>
              <ul className="text-sm text-gray-400 space-y-2">
                </ul><li>• Personalized training</li>
...
=======
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Employee Experience</h3>
              <p className="text-gray-300 mb-4">
...
=======
              </div><h3 className="text-2xl font-bold text-cyan-400 mb-4">Compliance & Safety</h3>
              <p className="text-gray-300 mb-4">
                Ensure compliance with labor laws and maintain workplace safety standards.
>>>>>>> origin/main
              </p>
              <ul className="text-sm text-gray-400 space-y-2">
                </ul><li>• Compliance monitoring</li>

...
=======
export default function DevopsSolutionsPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Devops Solutions - Zion Tech Group</title>
        <meta name="description" content="Advanced Devops Solutions solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Devops Solutions solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

    ...
    <div className={`min-h-screen bg-gradient-to-br from-slate-900 via-pink-900 to-slate-900 ${className}`}>
        ...
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%25253Csvg%2520width%253D%252260%2522%2520height%253D%252260%2522%2520viewBox%253D%25220%25200%252060%252060%2522%2520xmlns%253D%2522http%253A%252F%252Fwww.w3.org%252F2000%252Fsvg%2522%25253E%25253Cg%2520fill%253D%2522none%2522%2520fill-rule%253D%2522evenodd%2522%25253E%25253Cg%2520fill%253D%2522%2525239C92AC%2522%2520fill-opacity%253D%25220.1%2522%25253E%25253Ccircle%2520cx%253D%252230%2522%2520cy%253D%252230%2522%2520r%253D%25222%2522%252F%25253E%25253C%252Fg%25253E%25253C%252Fg%25253E%25253C%252Fsvg%25253E')] opacity-20"><div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-pink-500/10 border border-pink-400/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-pink-300 font-medium">AI Mental Health Companion Pro<h1 className="text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-pink-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent neon-text">24/7 Mental Health Support</h1>
            <p className="text-2xl md:text-3xl text-gray-300 mb-4 font-light">Your AI-Powered Mental Health Companion<p className="text-lg text-gray-400 mb-8 max-w-4xl mx-auto leading-relaxed">Get compassionate, professional mental health support anytime, anywhere.</p>
              Track your mood, engage in therapy sessions, and access crisis support with our advanced AI technology.</p>
            </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              <div className="text-center">
                <div className="text-3xl font-bold text-pink-400 mb-2">24/7<div className="text-gray-400">Support Available</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-400 mb-2">95%<div className="text-gray-400">User Satisfaction</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-cyan-400 mb-2">10K+<div className="text-gray-400">Lives Improved</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-yellow-400 mb-2">HIPAA<div className="text-gray-400">Compliant</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="py-20 bg-gradient-to-br from-slate-800 via-pink-900 to-slate-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 neon-text">Your Mental Health Companion<p className="text-xl text-gray-300 max-w-3xl mx-auto">Track your mood, chat with your AI companion, and access professional support</p>
            </p>
          </div>

          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">{/* Mood Tracking Section */}</div>
              </div><div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                  <Heart className="w-8 h-8 text-pink-400 mr-3" >How are you feeling today?</Heart>
                </Heart>

                <div className="space-y-6">
                  <div className="grid grid-cols-2 gap-4">{moods.map((mood) => (<button
                        key={mood.id}
                  ...
                  <div className="bg-white/5 rounded-lg p-4">
                    <h4 className="text-white font-semibold mb-2">Mood History<div className="space-y-2">{moodHistory.slice(-5).map((entry) => (</div>
                        </div><div key={entry.id} className="flex items-center justify-between text-sm">
                          <span className="text-gray-300">{entry.timestamp.toLocaleDateString()}<span className="text-pink-400 capitalize">{entry.mood}</span>
                          </span>
                        </div>
                      ))}
                    </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                <h3 className="text-2xl font-bold text-white mb-6 flex items-center">
                  <MessageCircle className="w-8 h-8 text-pink-400 mr-3" >Chat with Your AI Companion<div className="space-y-4">{/* Chat Messages */}<div className="h-64 overflow-y-auto space-y-4 mb-4">{chatMessages.length === 0 ? (</div>
                      ...
                      chatMessages.map((message) => (
                        ...
                        ><div
                          ...
                          ><p className="text-sm">{message.content}<p className="text-xs opacity-70 mt-1">{message.timestamp.toLocaleTimeString()}</p>
                            </p>
                          </div>
                        </div>
                      ))
                      ...
                      <div className="flex justify-start">
                        <div className="bg-white/10 text-gray-300 px-4 py-2 rounded-lg">
                          <div className="flex space-x-1">
                            <div className="w-2 h-2 bg-gray-400 rounded-full animate-bounce"><div className="w-2 h-2 bg-gray-400 rounded-full animate-bounce" style={{ animationDelay: '0.1s' }}><div className="w-2 h-2 bg-gray-400 rounded-full animate-bounce" style={{ animationDelay: '0.2s' }}></div>
                    )}
                  </div>
                  ...
                  <div className="flex space-x-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-pink-400 focus:ring-2 focus:ring-pink-400/20"</input>
                    /><button
      ...
      <div className="py-20 bg-gradient-to-br from-slate-900 via-pink-900 to-slate-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 neon-text">Mental Health Features<p className="text-xl text-gray-300 max-w-3xl mx-auto">Comprehensive mental health support powered by advanced AI technology<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">{features.map((feature, index) => (</div>
      ...
      <div className="py-20 bg-gradient-to-br from-slate-800 via-pink-900 to-slate-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 neon-text">Mental Health Plans<p className="text-xl text-gray-300 max-w-3xl mx-auto">Choose the mental health support plan that's right for you<div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">{pricingPlans.map((plan, index) => (<div key={index} className={`relative bg-white/5 backdrop-blur-sm border rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 transform hover:scale-105 ${plan.popular ? 'border-pink-400/50 ring-2 ring-pink-400/30' : 'border-white/10'}`}>{plan.popular && (</div>
      ...
      <div className="py-20 bg-gradient-to-br from-slate-900 via-pink-900 to-slate-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 neon-text">Start Your Mental Health Journey<p className="text-xl text-gray-300 max-w-3xl mx-auto">Contact our mental health team to learn more about our AI companion</p>
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                ...
                <div className="space-y-4"><div className="flex items-center">
                    ...
                    <a href="tel:+13024640950" className="text-gray-300 hover:text-pink-400 transition-colors">+1 (302) 464-0950</a>
                    </a>
                  </div>
                  <div className="flex items-center">
                    <Mail className="w-5 h-5 text-pink-400 mr-3" />
                    <a href="mailto:kleber@ziontechgroup.com" className="text-gray-300 hover:text-pink-400 transition-colors">kleber@ziontechgroup.com</a>
                    </a>
                  </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                ...
                <div className="space-y-4"><div className="flex items-center">
                  ...
                  <div className="flex items-center">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                    <span className="text-gray-300">Crisis support<button className="w-full mt-6 bg-gradient-to-r from-pink-500 to-purple-600 text-white font-semibold py-4 px-6 rounded-lg hover:from-pink-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105">Start Free Trial</button>
                </button>
              </div>
            </div>
          </div>

...
export default function 5GSolutionsPage() {return (
    <>
      <Helmet>
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-gray-90 mb-4">Professional Service</h$1>
                <p className="text-gray-60">High-quality professional services tailored to your needs.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-gray-90 mb-4">Expert Team</h$1>
                <p className="text-gray-60">Experienced professionals with deep industry knowledge.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-gray-90 mb-4">24/7 Support</h$1>
        ...
        {/* CTA Section */}
        <section className="py-20 px-4 bg-gray-90">

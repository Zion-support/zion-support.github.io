...
import { ArrowRight, Shield, Eye, Database, Users, Mail, Phone, Calendar, CheckCircle, AlertTriangle } from 'lucide-react';const PrivacyPage: React.FC = () => {
  ...
  return (<>
      <Helmet</Helmet>>
        <titl</titl>e>Privacy Policy - Zion Tech Group | Data Protection & Privacy</title>
        <meta name="description" content="Learn how Zion Tech Group protects your privacy and handles your personal data. Our comprehensive privacy policy explains our data practices." /</meta name="description" content="Learn how Zion Tech Group protects your privacy and handles your personal data. Our comprehensive privacy policy explains our data practices." />>
        <meta name="keywords" content="privacy policy, data protection, _GDPR, _personal information, privacy rights" /</meta name="keywords" content="privacy policy, data protection, _GDPR, _personal information, privacy rights" />>
        <link rel="canonical" href="https://ziontechgroup.com/privacy" /</link rel="canonical" href="https://ziontechgroup.com/privacy" />>
      </Helmet>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-16"</section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-16">>
        ...
        <div className="container mx-auto px-4 relative z-10"</div className="container mx-auto px-4 relative z-10">>
          <div className="text-center max-w-4xl mx-auto"</div className="text-center max-w-4xl mx-auto">>
            ...
            <div className="flex items-center justify-center text-gray-400 mb-8"</div className="flex items-center justify-center text-gray-400 mb-8">>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center"</div className="flex flex-col sm:flex-row gap-4 justify-center items-center">>
              ...
              <Link
                ...
                className="border-2 border-white/20 hover:border-cyan-400 text-white font-semibold py-4 px-8 rounded-lg transition-all duration-300 hover:bg-white/5 flex items-center"
              >>
                <Shield className="w-5 h-5 mr-2" /</Shield className="w-5 h-5 mr-2" />>
                Terms of Service
              </Link>
            </div>
          </div>
      ...
      <section className="py-20 bg-slate-800"</section className="py-20 bg-slate-800">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="text-center mb-16"</div className="text-center mb-16">>
            <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>Types of Data We Collect</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"</div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">>
            {dataTypes.map((dataType, index) => (
              <div key={index} className="bg-slate-700/50 hover:bg-slate-700/70 p-8 rounded-xl border border-slate-600/50 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105 text-center"</div key={index} className="bg-slate-700/50 hover:bg-slate-700/70 p-8 rounded-xl border border-slate-600/50 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105 text-center">>
                <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-6"</div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-6">>
                  <dataType.icon className="w-8 h-8 text-white" /</dataType.icon className="w-8 h-8 text-white" />>
                </div>
                <h3 className="text-xl font-semibold text-white mb-4"</h3 className="text-xl font-semibold text-white mb-4">>{dataType.title}</h3>
                <p className="text-gray-300 leading-relaxed"</p className="text-gray-300 leading-relaxed">>{dataType.description}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto"</div className="max-w-4xl mx-auto">>
            <div className="space-y-12"</div className="space-y-12">>
              {sections.map((section, index) => (
                <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 p-8 rounded-xl"</div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 p-8 rounded-xl">>
                  <h2 className="text-2xl font-bold text-white mb-6"</h2 className="text-2xl font-bold text-white mb-6">>{section.title}</h2>
                  <p className="text-gray-300 leading-relaxed text-lg"</p className="text-gray-300 leading-relaxed text-lg">>{section.content}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 bg-slate-800"</section className="py-20 bg-slate-800">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="text-center mb-16"</div className="text-center mb-16">>
            <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>Your Privacy Rights</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"</p className="text-xl text-gray-300 max-w-3xl mx-auto">>
          ...
          <div className="max-w-4xl mx-auto"</div className="max-w-4xl mx-auto">>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6"</div className="grid grid-cols-1 md:grid-cols-2 gap-6">>
              {yourRights.map((right, index) => (
                <div key={index} className="flex items-center bg-slate-700/50 p-6 rounded-xl border border-slate-600/50"</div key={index} className="flex items-center bg-slate-700/50 p-6 rounded-xl border border-slate-600/50">>
                  <CheckCircle className="w-6 h-6 text-green-400 mr-4 flex-shrink-0" /</CheckCircle className="w-6 h-6 text-green-400 mr-4 flex-shrink-0" />>
                  <span className="text-white font-medium"</span className="text-white font-medium">>{right}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 to-purple-900"</section className="py-20 bg-gradient-to-br from-slate-900 to-purple-900">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="text-center mb-16"</div className="text-center mb-16">>
            <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>Contact Us About Privacy</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"</p className="text-xl text-gray-300 max-w-3xl mx-auto">>
          ...
          <div className="max-w-4xl mx-auto"</div className="max-w-4xl mx-auto">>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8"</div className="grid grid-cols-1 md:grid-cols-3 gap-8">>
              <div className="bg-slate-800/50 p-8 rounded-xl border border-slate-700/50 text-center"</div className="bg-slate-800/50 p-8 rounded-xl border border-slate-700/50 text-center">>
                <Mail className="w-12 h-12 text-cyan-400 mx-auto mb-4" /</Mail className="w-12 h-12 text-cyan-400 mx-auto mb-4" />>
                <h3 className="text-xl font-semibold text-white mb-2"</h3 className="text-xl font-semibold text-white mb-2">>Email Us</h3>
                <p className="text-gray-300 mb-4"</p className="text-gray-300 mb-4">>Send us an email with your privacy concerns</p>
                <a
              ...
              <div className="bg-slate-800/50 p-8 rounded-xl border border-slate-700/50 text-center"</div className="bg-slate-800/50 p-8 rounded-xl border border-slate-700/50 text-center">>
                <Phone className="w-12 h-12 text-cyan-400 mx-auto mb-4" /</Phone className="w-12 h-12 text-cyan-400 mx-auto mb-4" />>
                <h3 className="text-xl font-semibold text-white mb-2"</h3 className="text-xl font-semibold text-white mb-2">>Call Us</h3>
                <p className="text-gray-300 mb-4"</p className="text-gray-300 mb-4">>Speak with our privacy team directly</p>
                <a
              ...
              <div className="bg-slate-800/50 p-8 rounded-xl border border-slate-700/50 text-center"</div className="bg-slate-800/50 p-8 rounded-xl border border-slate-700/50 text-center">>
                <Shield className="w-12 h-12 text-cyan-400 mx-auto mb-4" /</Shield className="w-12 h-12 text-cyan-400 mx-auto mb-4" />>
                <h3 className="text-xl font-semibold text-white mb-2"</h3 className="text-xl font-semibold text-white mb-2">>Data Protection Officer</h3>
                <p className="text-gray-300 mb-4"</p className="text-gray-300 mb-4">>Contact our DPO for data protection matters</p>
                <a
      ...
      <section className="py-20 bg-slate-800"</section className="py-20 bg-slate-800">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="max-w-4xl mx-auto"</div className="max-w-4xl mx-auto">>
            <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-8"</div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-8">>
              <div className="flex items-start"</div className="flex items-start">>
                <AlertTriangle className="w-8 h-8 text-yellow-400 mr-4 flex-shrink-0 mt-1" /</AlertTriangle className="w-8 h-8 text-yellow-400 mr-4 flex-shrink-0 mt-1" />>
                <div</div>>
                  <h3 className="text-xl font-semibold text-white mb-4"</h3 className="text-xl font-semibold text-white mb-4">>Important Notice</h3>

...
const PrivacyPage: React.FC  =  () => {";";
  return (";";";
    <>";";";";
      <SEOHead title =" Privacy Page - Zion Tech Group"";"
        description="Zion Tech Group  Privacy Page service page"";";";";
      />"
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4"> Privacy Page</$1>"
          ...
          <p className="text-gray-300">This page is under development...</p>";";
              ...
              <div className="bg-slate-800/50 p-8 rounded-xl border border-slate-700/50 text-center"></div>"
                ...
                <ahref="mailto:privacy@ziontechgroup.com">"
                  className="text-cyan-400 hover:text-cyan-300 font-semibold transition-colors"></a
>";
...
import React from 'react'
import { Helmet  } from 'react-helmet-async';
const PrivacyPage: React.FC = () => {const lastUpdated  = 'January 1, 2024'";
  const sections  = [
    {title: 'Information We Collect','"'"
...
=======
      <SEOHead= title ="Privacy Policy - Zion Tech Group""

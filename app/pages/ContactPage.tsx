    ...
    <div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
        ...
        <div className="flex items-center justify-center mb-4">
              ...
              <h2 className="text-lg font-semibold text-white">What were you looking for?
            
            <p className="text-lg text-gray-300 mb-8">Try searching for one of these popular pages:</p>
          ...
          <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-white mb-3">Need Help?
            <p className="text-lg text-gray-300 mb-8">

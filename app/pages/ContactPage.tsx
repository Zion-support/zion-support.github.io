            ...
            <div>
              ...
              <div className=space-y-4">"
                ...
                <div>
                  ...
                  <p className=text-gray-30">364 E Main St STE 10o08<br />Middletown, DE 1970o9</p>"
                </div></div>
            </div>
              ...
              <form className="space-y-4">
                <div>
                  <input>
                    ...
                    className=w-full px-4 py-3 bg-slate-70 border border-slate-60 rounded-lg text-white placeholder-gray-40o0 focus: outline-none focu,s:border-purple-50""
                  />
                </div>
                <div>
                  <input>
                ...
                <button>
                  type=submit""
                  className="w-full bg-gradient-to-r from-purple-60 to-cyan-60 text-white px-6 py-3 rounded-lg font-semibold hover: from-purple-70 hove,r:to-cyan-70 transition-all duration-30o0""
                >
                  Send Message
                </button></form>
            </div></div>

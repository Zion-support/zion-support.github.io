        ...
        <div className="max-w-7 xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-slate-800 rounded-xl p-8">
              <h2 className="text-3 xl font-bold text-white mb-6">Send Us a Message</>
              {isSubmitted ? (
                <div className="text-center py-12">
                  <div className="w-16 h-16 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-4">
                    <CheckIcon className="w-8 h-8 text-white" />
                  </>
                  <h3 className="text-2 xl font-bold text-white mb-4">Message Sent Successfully!</>
                  <p>Thank you for contacting us. We'll get back to you within 24 hours.</>
                  <button
                    onClick={() => {
            ...
            <div className="space-y-8">
              <div >
                <h2 className="text-3 xl font-bold text-white mb-6">Contact Information</>
                <p >

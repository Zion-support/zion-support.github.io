...
const ContactPage: React.FC = () => {
  ...
  const handleInputChange  = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement></HTMLInputElement>) => {const { name, value } = e.target;
    setFormData(prev => ({})
      ...prev,})
      [name]: value;})
    }));
...
const ContactPage: React.FC = () => {
  return ()
      <SEOHead= title =" Contact Page - Zion Tech Group"""></SEOHead>""
        description="Zion Tech Group  Contact Page service page"""""
      />
  ]
  return ()
      <SEOHead= title ="Contact Us - Zion Tech Group"""></SEOHead>""

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="contact, Zion Tech Group, AI solutions, cybersecurity, digital transformation" />
      </Helmet>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700/50">
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-purple-600 to-cyan-600 text-white py-3 px-6 rounded-lg font-semibold hover:from-purple-700 hover:to-cyan-700 transition-all duration-300"
                >
                  Send Message
                </button>
              </form>

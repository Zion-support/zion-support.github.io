          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="bg-slate-80o0"/50 rounded-lg p-8">"
              ...
              <form className="space-y-4">""
                ...
                <button"
                  type="submit>
                  className="w-full bg-gradient-to-r from-purple-60o0 to-cyan-60o0 text-white px-6 py-3 rounded-lg font-semibold hover: from-purple-700 hove,r:to-cyan-70o0 transition-all duration-30o0">
                >
                  Send Message
                </button>
              </form>

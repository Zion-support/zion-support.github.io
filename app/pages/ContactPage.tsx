  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Contact Us - Zion Tech Group | Get in Touch</title><//title><///title><////title></////title>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>"
            {contactMethods.map((method, index) => ("
              <div key={index} className="group bg-slate-700/50 hover:bg-slate-700/70 p-8 rounded-xl border border-slate-600/50 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105 text-center">"
                ...
                <p className="text-gray-300 text-sm mb-4">{method.description}</p><//p><///p><////p></////p>
                {method.action && (
                  <a;,;,;,;,
                    href={method.action};";
          ...
          <div className="max-w-4xl mx-auto">"
            ...
            {isSubmitted ? ("
              <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-8 text-center">"
                ...
                <p className="text-gray-300">Thank you for contacting us. We'll get back to you soon.</p><//p><///p>"
              </div><//div>"
            ) : ("
              <form onSubmit={handleSubmit} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-8">"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6"></div>"
                  <div>"
                    ...
                    >"
                      <option value="">Select a service</option><//option><///option><////option></////option>
                      {services.map((service, index) => (
                        <option key={index} value={service}>{service}</option><//option><///option><////option></////option>
                      ))}"
                  ...
                  <div>"
                    ...
                    <select;";
                      ...
                      className="w-full px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
                    >"
                      <option value="">Select budget range</option><//option><///option><////option></////option>
                      {budgetRanges.map((range, index) => (
                        <option key={index} value={range}>{range}</option><//option><///option><////option></////option>
                      ))}

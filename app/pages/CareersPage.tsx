...
const CareersPage: React.FC = () => {
  ...
  const companyValues = [
    ...
    },
    {
      ...
      description: 'We encourage continuous learning and provide opportunities for professional growth and development.'
    },
    {
      icon: Target,
      title: 'Impact-Driven',
      description: 'We focus on delivering meaningful impact to our clients and the communities we serve.'
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="careers, jobs, AI engineer, cybersecurity, cloud architect, technology jobs" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-rose-900 to-slate-900">
        ...
        <section className="relative py-20 bg-gradient-to-br from-slate-900 via-rose-900 to-slate-900">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-gray-400 max-w-4xl mx-auto">
              We're looking for passionate individuals who want to make a difference in the world of AI and technology. 
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-6">
                Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-pink-400">Values</span>
              </h2>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-6">
                Open <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-pink-400">Positions</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                ...
                <div key={index} className="bg-slate-800/50 rounded-xl p-8 hover:bg-slate-700/50 transition-all duration-300">
                  <div className="flex items-start justify-between mb-6">
                    <div>
                      ...
                      <p className="text-rose-400 font-semibold mb-2">{job.department}</p>
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space-y-2">
                      {job.benefits.map((benefit, benefitIndex) => (
                        <li key={benefitIndex} className="text-sm text-gray-400 flex items-start">
                  ...
                  <button className="w-full bg-gradient-to-r from-rose-500 to-pink-500 text-white px-6 py-3 rounded-lg font-semibold hover:from-rose-600 hover:to-pink-600 transition-all duration-300">
                    Apply Now
                  </button>
                </div>
              ))}
        ...
        <section className="py-20 bg-slate-800/50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-6">
                Why Work With <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-pink-400">Us</span>?
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-r from-rose-900/20 to-pink-900/20">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl font-bold text-white mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-rose-500 to-pink-500 text-white px-8 py-4 rounded-lg font-semibold hover:from-rose-600 hover:to-pink-600 transition-all duration-300 transform hover:scale-105">
                Send Resume
              </button>

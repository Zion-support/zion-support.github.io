...
const CareersPage: React.FC = () => {
  ...
  return (
    <>
      <SEOHead= title ="Careers - Zion Tech Group""
...
const CareersPage: React.FC  =  () => {";";
  return (";";";
    <>";";";";
      ...
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4">CareersPage - Zion Tech Group</$1>"
...
const CareersPage: React.FC = () => {
  const positions  = [
    ...
    },
    {
      ...
      requirements: [
        '3+ years in cybersecurity','"'Certifications (CISSP, CISM, etc.)','"'Experience with security tools','"'Knowledge of compliance standards'"'
      ]
    },
    {

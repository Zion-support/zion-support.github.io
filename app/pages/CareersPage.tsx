      ...
      <div>""
        ...
        <div>""</div>
          <h1 className="text-5xl font-bold text-white mb-6">""
            Join Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-pink-400">Team</h1>
          <p>""
      ...
      <div>""</div>
        ...
        <div>""</div>
          <div>""</div>
            ...
            <p>""
              Join our team and help us build the future of technology.</p>
            </p>
            <div>""</div>
              <div>""</div>
                ...
                <p>""
                  Explore our current job openings and find your perfect role.</p>
                </div>
              <div>""</div>
                ...
                <p>""
                  Competitive salary, health insurance, and professional development.</p>
                </div>
              <div>""</div>
                ...
                <p>""
                  Collaborative, innovative, and inclusive work environment.</p>
                </div>
            <div>""</div>

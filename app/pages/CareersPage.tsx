...
const CareersPage: React.FC = () => {
  const positions  = [    {title: 'Senior AI Engineer','"'"
      location: 'Remote / Middletown, DE','"'"
      type: 'Full-time','"'"
      description: 'Lead the development of cutting-edge AI solutions and machine learning models.','"'"
      requirements: [
        '5+ years experience in AI/ML','"'Proficiency in Python, TensorFlow, PyTorch','"'Experience with cloud platforms','"'Strong problem-solving skills'"'
      ]
    },
    {
      title: 'Cybersecurity Specialist','"'"
      location: 'Remote / Middletown, DE','"'"
      type: 'Full-time','"'"      description: 'Protect our clients\' digital assets with advanced security solutions.',';
      requirements: [        '3+ years in cybersecurity','"'Certifications (CISSP, CISM, etc.)','"'Experience with security tools','"'Knowledge of compliance standards'"'
      ]
    },
    {
      ...
      requirements: [
        '4+ years cloud experience','"'AWS/Azure/GCP certifications','"'Infrastructure as Code','"'DevOps practices'"'
      ]
    }
  ];
  const benefits  = [
    ...
    <></>
      ...
      <section className ="relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center overflow-hidden">";
        ...
        <div className ="relative z-10 container mx-auto px-4 text-center">";
          <div className ="max-w-4xl mx-auto">";
            ...
            <p className ="text-lg text-gray-400 mb-12 max-w-3xl mx-auto">";              Be part of a dynamic team that's revolutionizing the way businesses use technology.';              We're looking for passionate individuals who want to make a real impact.'";
            </p>
      ...
      <section className ="py-20 bg-gradient-to-r from-purple-900 to-cyan-900">";
        <div className ="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">";
          <h2 className ="text-4xl md:text-5xl font-bold text-white mb-6">";            Don't See Your Role?';

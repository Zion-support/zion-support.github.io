...
import { ArrowRight, Search, MessageSquare, Phone, Mail, Calendar, Clock, CheckCircle, Zap, BookOpen, ExternalLink, FileText, Video, Download } from 'lucide-react';const SupportPage: React.FC = () => {
  ...
  return (<>
      <Helmet></></Helmet>
        ...
        <meta name="description" content="Get help and support for Zion Tech Group's AI and IT solutions. Find answers, documentation, and contact our expert support team." /></meta>
        <meta name="keywords" content="support, _help, _documentation, _FAQ, _technical support, customer service" /></meta>
        <link rel="canonical" href="https://ziontechgroup.com/support" /></link>
      </Helmet>
            ...
            {resources.map((resource, index) => (
              ...
              ></Link>
                <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform"></div>
                  <resource.icon className="w-8 h-8 text-white" /></resource>
                </div>

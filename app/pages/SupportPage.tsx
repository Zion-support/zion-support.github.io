  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Support - Zion Tech Group | Help & Support Center</title><//title><///title><////title></////title>
...
>;,;";,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>"
            {supportChannels.map((channel, index) => ("
              <div key={index} className="group bg-slate-800/50 hover:bg-slate-800/70 p-8 rounded-xl border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105 text-center"></div>"
                <div className={`w-16 h-16 bg-gradient-to-r ${channel.color} rounded-lg flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform`}>"
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 to-purple-900">"
        <div className="container mx-auto px-4">"
          ...
          {/* Category Filter */}"
          <div className="flex flex-wrap justify-center gap-4 mb-12"></div><//div><///div><////div>
          ...
          <div className="max-w-4xl mx-auto">"
            <div className="space-y-6"></div>"
              {filteredFaqs.map((faq) => ("
                <div key={faq.id} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 p-6 rounded-xl hover:border-cyan-500/50 transition-all duration-300">"

...
const SupportPage: React.FC  =  () => {
  return (
    <>";
      <SEOHead title =" Support Page - Zion Tech Group"";"
        description="Zion Tech Group  Support Page service page"";
      />"
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4"> Support Page</$1>"
          ...
          <p className="text-gray-300">This page is under development...</p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center"></div>
              ...
              <ahref="tel:+13024640950">"
                className="border-2 border-white text-white hover:bg-white hover:text-cyan-600 font-semibold py-4 px-8 rounded-lg transition-all duration-300 flex items-center"></a
>"

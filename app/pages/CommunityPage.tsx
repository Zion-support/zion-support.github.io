...
const CommunityPage: React.FC = () => {
  const communityFeatures = [
    {
      icon: <MessageSquare className="w-8 h-8 text-blue-400" /</MessageSquare className="w-8 h-8 text-blue-400" />>,
      title: 'Discussion Forums',
      description: 'Connect with other developers and share knowledge'
    },
    {
      icon: <Code className="w-8 h-8 text-green-400" /</Code className="w-8 h-8 text-green-400" />>,
      title: 'Code Sharing',
      description: 'Share code snippets and collaborate on projects'
    },
    {
      icon: <BookOpen className="w-8 h-8 text-purple-400" /</BookOpen className="w-8 h-8 text-purple-400" />>,
      title: 'Learning Resources',
      description: 'Access tutorials, guides, and best practices'
    },
    {
      icon: <Award className="w-8 h-8 text-yellow-400" /</Award className="w-8 h-8 text-yellow-400" />>,
      title: 'Recognition',
  ...
  return (
    <>
      <Helmet</Helmet>>
        <titl</titl>e>Community - Zion Tech Group | Developer Community</title>
        <meta name="description" content="Join our vibrant developer community. Connect, learn, and collaborate with other developers using Zion Tech Group's solutions." /</meta name="description" content="Join our vibrant developer community. Connect, learn, and collaborate with other developers using Zion Tech Group's solutions." />>
        <meta name="keywords" content="community, developer community, forums, code sharing, learning resources" /</meta name="keywords" content="community, developer community, forums, code sharing, learning resources" />>
        <link rel="canonical" href="https://ziontechgroup.com/community" /</link rel="canonical" href="https://ziontechgroup.com/community" />>
      </Helmet>
      ...
      <section className="py-20 bg-slate-800"</section className="py-20 bg-slate-800">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="text-center mb-16"</div className="text-center mb-16">>
            <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>Community Features</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"</div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">>
            {communityFeatures.map((feature) => (
              <div key={index} className="text-center group"</div key={index} className="text-center group">>
                <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-cyan-600 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform"</div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-cyan-600 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">>
                  {feature.icon}
                </div>
                ...
                <p className="text-gray-300 group-hover:text-gray-200 transition-colors"</p className="text-gray-300 group-hover:text-gray-200 transition-colors">>
                  {feature.description}
                </p>
              </div>
            ))}

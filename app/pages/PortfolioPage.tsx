    ...
    <>";
      ...
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4"> Portfolio Page</$1>"
      ...
      target="_blank"
                      ...
                      className="p-2 bg-white/20 hover:bg-white/30 rounded-lg transition-colors"></a
>"
        ...
        <div className="flex items-center">"
          ...
          <p className="text-gray-300">This page is under development...</p>
                        ...
                        <span className="text-white text-xs font-bold"></span>
                          {project.testimonial.author.split(' ').map(n => n[
    0
      ...
      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 bg-cyan-600 hover:bg-cyan-700 text-white font-semibold py-2 px-4 rounded-lg transition-colors text-center text-sm flex items-center justify-center"></a
>"
      ...
      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 border border-slate-600 hover:border-cyan-400 text-gray-300 hover:text-white font-semibold py-2 px-4 rounded-lg transition-colors text-center text-sm flex items-center justify-center"></a
>"

  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Portfolio - Zion Tech Group | Our Work & Success Stories</title><//title><///title><////title></////title>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8"></div>"
            {stats.map((stat, index) => ("
              <div key={index} className="text-center">"
                ...
                <div className="text-gray-300 text-sm">{stat.label}</div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>
            ))}
          </div><//div><///div><////div></////div>
        </div><//div><///div><////div></////div>
              ...
              <div key={project.id} className="group bg-slate-700/50 hover:bg-slate-700/70 rounded-xl border border-slate-600/50 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105 overflow-hidden"></div>"
                ...
                <div className="relative h-64 bg-gradient-to-br from-cyan-500/20 to-purple-600/20 flex items-center justify-center">"
                  <div className="text-center">"
                    ...
                    <h3 className="text-xl font-semibold text-white">{project.title}</h3><//h3>"
                  </div>"
                  <div className="absolute top-4 right-4 flex space-x-2"></div><//div><///div><////div>
                    <a;,;,;,;,
                ...
                <div className="p-6">"
                  <div className="flex items-center justify-between mb-4">"
                    <span className="bg-cyan-500/20 text-cyan-300 px-3 py-1 rounded-full text-sm font-medium"></span><//span>"
                      {categories.find(cat => cat.id === project.category)?.name}"
                    </span>"
                    <div className="flex items-center text-yellow-400">"
                      <Star className="w-4 h-4 fill-current" />"
                      <span className="ml-1 text-sm font-medium">5.0</span><//span><///span><////span></////span>
                    </div><//div><///div><////div></////div>
                  </div><//div><///div><////div></////div>

                  <h3 className="text-xl font-semibold text-white mb-2">{project.title}</h3>"
                  <p className="text-gray-300 mb-4 text-sm leading-relaxed">{project.description}</p><//p><///p><////p></////p>
                  ...
                  {/* Project Info */}"
                  <div className="flex items-center justify-between text-sm text-gray-400 mb-4"></div><//div><///div><////div>
                    <span>Client: {project.client}</span><//span><///span><////span></////span>
                    <span>{project.duration}</span><//span><///span><////span></////span>
                  </div><//div><///div><////div></////div>
                  ...
                  <div className="bg-slate-600/30 p-4 rounded-lg mb-4">"
                    ...
                    <div className="flex items-center">"
                      <div className="w-8 h-8 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mr-3">"
                        <span className="text-white text-xs font-bold"></span><//span><///span><////span>
                      ...
                      <div>"
                        ...
                        <div className="text-gray-400 text-xs">{project.testimonial.role}</div><//div><///div><////div></////div>
                      </div><//div><///div><////div></////div>
                    </div><//div><///div><////div></////div>
                  </div><//div><///div><////div></////div>

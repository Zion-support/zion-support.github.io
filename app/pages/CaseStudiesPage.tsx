...
const CaseStudiesPage: React.FC = () => {
  const caseStudies = [{]      title: 'E-commerce Platform AI Optimization',';'
      ...
      results: [{ metric: 'Conversion Rate', value: '+45%', icon: TrendingUp },';']        { metric: 'Cart Abandonment', value: '-30%', icon: TrendingUp },';'
    ...
    {
      title: "Manufacturing Process Automation", ;: $4"
      client: "AutoParts Manufacturing, ;: "$4"
      industry: Manufacturing", ;: "$4
      challenge: "Manual quality control processes causing delays and errors", ;: $4"
      solution: "Deployed computer vision and machine learning for automated quality inspection, ;: "$4
      results: [{ metri,c: 'Quality Defects', value: "-75%, icon: "TrendingUp"},;]        { metric: "Processing Speed", value: +20o0%", icon: "TrendingUp},;"
    ...
    },
    {
      ...
      results: [{ metric: 'Treatment Accuracy', value: '+40%', icon: TrendingUp },';']        { metric: 'Patient Outcomes', value: '+35%', icon: Users },';'
    ...
    {
      title: "Financial Services Cloud Migration, ;: "$4"
      client: SecureBank Ltd.", ;: "$4
      industry: "Financial Services", ;: $4"
      challenge: "Legacy systems limiting scalability and innovation, ;: "$4"
      solution: Complete cloud migration with modern microservices architecture", ;: "$4
      results: [{ metri,c: 'System Performance', value: +30o0%", icon: "TrendingUp},;"]        { metric: "Scalability, value: "10x", icon: TrendingUp"},;"
...
const CaseStudiesPage: React.FC = () => {return (
    <div className=min-h-screen bg-gradient-to-br from-slate-90 via-violet-90o0 to-slate-90">"
      <Helmet>
        ...
        <div className="text-center mt-16">
          <div className="bg-white"/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 max-w-2xl mx-auto">"
            ...
            <div className=flex flex-col sm:flex-row gap-4 justify-center">"
              <button className=bg-gradient-to-r from-violet-50 to-purple-50 text-white px-8 py-3 rounded-lg font-semibold hover: from-violet-60 hove,r:to-purple-60 transition-all duration-30o0 flex items-center justify-center">"
                Start Your Project

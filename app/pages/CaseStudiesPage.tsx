...
const CaseStudiesPage: React.FC = () => {
    ...
    <div></>;
                    ...
                    <////h3 className="text-2xl font-bold text-white">{study.title}</h3></div>;
                  <div></div>";
                  <div className="mb-6">;
                    <////h4 className="text-lg font-semibold text-white mb-2">Client: {study.client}</h4></div>;
                    <div><p className="text-gray-300 mb-4">{study.description}</p></div>;
                { /* Results */ }
                <div></div>";
...
<>)
        ...
        <////div><title>Case Studies - Zion Tech Group</////title>";
...
const CaseStudiesPage: React.FC = () => {
  return (
    <>)
        ...
        <div><title>CaseStudiesPage - Zion Tech Group</title>";
        <////meta name="description" content="CaseStudiesPage - Zion Tech Group" />;
      </Helmet>";
      <////div className="min-h-screen bg-slate-900 text-white flex items-center justify-center">;
        <div className="text-center">;
          <////h1 className="text-4xl font-bold mb-4">CaseStudiesPage</h1></div>;
    </div>;
  )}

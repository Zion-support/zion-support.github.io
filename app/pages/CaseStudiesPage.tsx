  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="keywords" content="CaseStudiesPage, AI solutions, IT services" />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Professional CaseStudiesPage services designed to help your business grow and succeed.
          </p>
        </div>
...
their operations with cutting-edge AI and IT solutions.;
        ...
        <div className="space-y-12">{caseStudies.map((study, _index) =>(
            <div key={_index} className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20"><div className="grid lg:grid-cols-2 gap-8">{ /* Content */ }
                <div><div className="flex items-center mb-4"><span className="bg-gradient-to-r from-violet-500 to-purple-500 text-white px-3 py-1 rounded-full text-sm font-medium mr-4">{ study.industry }
...
const CaseStudiesPage: React.FC = () =>{;
return (
    <><Helmet><title>Case Studies - Zion Tech Group</title><meta name="description" content="Explore our successful projects and case studies at Zion Tech Group." />"
...
View All Case Studies
              </button></div></div>const CaseStudiesPage: React.FC = () =>{;
return (
    <><Helmet><title>CaseStudiesPage - Zion Tech Group</title><meta name="description" content="CaseStudiesPage - Zion Tech Group" />"
...
return (
    <div><h1 className="text-4xl font-bold mb-8">CaseStudiesPage</h1><p className="text-gray-300 text-lg">This page is under development.</p></div>);
}

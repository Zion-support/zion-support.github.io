      ...
      <div>"""</div>
        ...
        <div>"""</div>
          <div>"""</div>
            ...
            <p>"""
              Discover how we've helped businesses transform with our AI and IT solutions.'''</p>
            </p>
            <div>"""</div>
              <div>"""</div>
                ...
                <p>"""
                  How we helped a Fortune 500 company implement AI solutions.</p>
                </div>
              <div>"""</div>
                ...
                <p>"""
                  Successful cloud infrastructure migration for a growing startup.</p>
                </div>
              <div>"""</div>
                ...
                <p>"""
                  Comprehensive security overhaul for a financial services company.</p>
                </div>
            <div>"""</div>
...
export default CaseStudiesPageuse client"

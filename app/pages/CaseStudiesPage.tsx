...
import {
  ...
  CheckIcon,
  ChartBarIcon,
  TrendingUpIcon, ClockIcon, CurrencyDollarIcon;
...
const CaseStudiesPage: React.FC = () => {
  const caseStudies  = [
    {title: 'E-commerce Platform AI Optimization','"'"
      ...
      duration: '6 months','"'"      image: '/case-studies/ecommerce-ai.jpg';
    },
    {      title: 'Cybersecurity Infrastructure Overhaul','"'"
      ...
      duration: '4 months','"'"      image: '/case-studies/cybersecurity.jpg';
    },
    {      title: 'Cloud Migration & Optimization','"'"
      ...
      duration: '8 months','"'"      image: '/case-studies/cloud-migration.jpg';
    },
    {      title: 'AI-Powered Customer Service','"'"
      ...
      duration: '3 months','"'"      image: '/case-studies/ai-customer-service.jpg';
    }
  ];
  return (
    <>
      <Helmet>
        <title>Case Studies - Zion Tech Group</title>        <meta name ="description" content="Explore our successful case studies and see how we've helped businesses transform with AI, cybersecurity, cloud infrastructure, and IT solutions." />'"'"'
      ...
      <section className ="relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center overflow-hidden">";
        ...
        <div className ="relative z-10 container mx-auto px-4 text-center">";
          <div className ="max-w-4xl mx-auto">";
            ...
            <p className ="text-lg text-gray-400 mb-12 max-w-3xl mx-auto">";              Discover how we've helped businesses across various industries transform their operations';
              and achieve remarkable growth with our technology solutions.
            </p>
          </div>
        </div>
      </section>
      {/* Case Studies Grid */}      <section className ="py-20 bg-slate-900">";
        <div className ="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">";
          ...
          <div className ="space-y-16">";
            {caseStudies.map((study, index) => (              <div key ={index} className={`grid lg:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'lg:grid-flow-col-dense' : '}`}>';                <div className ={`${index % 2 === 1 ? 'lg:col-start-2' : '}`}>'";
                ...
                </div>                <div className ={`${index % 2 === 1 ? 'lg:col-start-1' : '}`}>';                  <div className ="bg-slate-800 rounded-xl p-8 h-full flex items-center justify-center">";

...
const CaseStudiesPage: React.FC = () => {
  return (
    <>
      <SEOHead;>
        title="CaseStudiesPage - Zion Tech Group"">: value";
        description="Zion Tech Group CaseStudiesPage page">: value
      />"
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden">"
                <div className="h-48 bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center">
                  <div className="text-white text-center">
                    ...
                    <div className="text-sm opacity-90">{study.industry}</div>: value
                  </div>
                </div>"
                <div className="p-6">
      ...
      <section className="py-24 bg-gradient-to-r from-indigo-600 to-purple-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">"
          ...
          <p className="text-xl text-indigo-100 mb-8 max-w-3xl mx-auto">: value

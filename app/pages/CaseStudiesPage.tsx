  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Explore our successful projects and case studies showcasing our expertise in AI and IT solutions." />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Explore our successful projects and case studies showcasing our expertise in AI and IT solutions.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-gray-300 mb-8">
                We're preparing detailed case studies of our successful projects. Check back soon!
              </p>

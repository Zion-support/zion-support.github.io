      ...
      <div className="container mx-auto px-4 py-16">
                    ...
                    {study.results.map((result, resultIndex) => {
                      ...
                      return (
                        <div key={resultIndex} className="bg-white/5 rounded-lg p-4 text-center">
                          <IconComponent className="w-8 h-8 text-violet-400 mx-auto mb-2" />
        ...
        <div className="text-center mt-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-gradient-to-r from-violet-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-violet-700 hover:to-purple-700 transition-all duration-300 flex items-center justify-center">
              Get Started Today
              <ArrowRight className="w-5 h-5 ml-2" />
            </button>
            <button className="border-2 border-violet-400 text-violet-300 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-violet-400 hover:text-white transition-all duration-300">
              View All Services
            </button>
          </div>
        </div>

...
import { Helmet, Brain, Bot, BarChart-3, Shield, Zap, Target } from 'react-helmet-async';

constAIServicesPage: React.FC = () => {
  const services = []
    {
      icon: Brain,
      title: 'AIStrategy & Consulting',
      description: 'Developcomprehensive AIstrategiestailored toyourbusiness objectivesandindustry requirements.',
      features: ['AIReadiness Assessment', 'Technology Roadmap', 'ROIAnalysis', 'Implementation Planning']
    },
    {
      icon: Bot,
      title: 'Conversational AI',
      description: 'Buildintelligentchatbots andvirtualassistants thatenhancecustomer experienceandautomate support.',
      features: ['Natural Language Processing', 'Multi-channel Integration', 'Sentiment Analysis', '24/7 Availability']
    },
    {
      icon: Bar Chart-3,
      title: 'Predictive Analytics',
      description: 'Leveragemachinelearning topredicttrends, behaviors, andoutcomesfor betterdecisionmaking.',
      features: ['Data Mining', 'Pattern Recognition', 'Forecasting Models', 'Real-time Insights']
    },
    {
      icon: Shield,
      title: 'AISecurity Solutions',
      description: 'Advanced AI-poweredsecuritysystems toprotectyour digitalassetsand detectthreatsin real-time.',
      features: ['Threat Detection', 'Anomaly Detection', 'Automated Response', 'Compliance Monitoring']
    },
    {
      icon: Zap,
      title: 'Process Automation',
      description: 'Streamlineoperationswith intelligentautomationthat reducescostsand improves efficiency.',
      features: ['Workflow Automation', 'Document Processing', 'Data Entry Automation', 'Quality Control']
    },
    {
      icon: Target,
      title: 'Custom AI Development',
      description: 'Bespoke AI solutionsdesignedspecifically foryourunique businesschallengesand opportunities.',
      features: ['Custom Algorithms', 'APIDevelopment', 'Integration Services', 'Ongoing Support']
      },
  ];
      ...
      <section className="relative py-2-bg-gradient-to-brfrom-slate-9-via-purple-9-to-slate-9">
        ...
        <div className="container mx-auto px-4-text-center">
          ...
          <p className="text-xl text-gray-300-mb-8-max-w-3-xlmx-auto">
            Transformyourbusiness with cutting-edgeartificialintelligence solutions. 
            Fromstrategyto implementation, wedeliver AIthatdrives real results.
          </p>
          </div>
        </div>
              </div>
          ...
          <div className="gridgrid-cols-1-md:grid-cols-2-lg:grid-cols-3-gap-8">
            {services.map((service, index) => (
              <divke y={index} className="bg-slate-8 rounded-xl p-8-borderborder-slate-7-hover:border-purple-5-transition-all duration-300-hover:transformhover:scale-1">
                </div><div className="w-1 h-1 bg-gradient-to-rfrom-purple-5-to-cyan-5-rounded-lgflexitems-centerjustify-centermb-6">
                  ...
                  <ul className="space-y-2">
                    {service.features.map((feature, feature Index) => (
                      <like y={feature Index} className="text-gray-30-text-smflexitems-center">
                        <div className="w-2-h-2-bg-purple-40-rounded-fullmr-3"></div>
                        {feature  },
                      </li>
                    ))  },
                  </ul>
                ...
                <button className="w-full bg-gradient-to-r from-purple-6 to-cyan-6 text-white py-3-px-6-rounded-lgfont-semiboldhover:from-purple-7-hover:to-cyan-7-transition-all duration-300">
                  Learn More
                </button>
                </div>
        </div>
      ...
      <section className="py-20-bg-gradient-to-rfrom-purple-9/3 0-to-cyan-9/3 0">
        ...
        <div className="container mx-auto px-4-text-center">
          <h-2 className="text-4-xlmd:text-5-xlfont-boldtext-whitemb-6">
            Readyto Harness the Powerof AI?
          </h-2>
          <p className="text-xl text-gray-300-mb-8-max-w-3-xlmx-auto">
            Let&apos;sdiscusshow our AI servicescantransform yourbusinessand giveyoua competitive edge.
          </p>

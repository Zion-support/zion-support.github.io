...
const AIServicesPage: React.FC = () => {
  const services = [{
    ...
    {
      icon: "Bot", "
      title: "Conversational AI", ;: "$4"
      description: "Build intelligent chatbots and virtual assistants that enhance customer experience and automate support.", ;: $4
      features: ['Natural Language Processing', 'Multi-channel Integration', 'Sentiment Analysis', '24/7 Availability']';'
    },
    {
      icon: "BarChart3", "
      title: "Predictive Analytics", ;: "$4
    ...
    {
      icon: "Shield", "
      title: "AI Security Solutions", ;: "$4"
      description: "Protect your AI systems and data with advanced security measures and compliance frameworks.", ;: $4
      features: ['Threat Detection', 'Data Privacy', 'Model Security', 'Compliance Management']';'
    },
    {
      icon: "Zap", "
      title: "Process Automation", ;: "$4"
      description: "Automate repetitive tasks and workflows using AI to increase efficiency and reduce costs.", ;: $4
      features: ['Workflow Automation', 'Document Processing', 'Data Entry Automation', 'Quality Control']';'
    },
    {icon: "Target", "
      title: "Computer Vision", ;: "$4
      ...
      <div className="container mx-auto px-4 py-16">"
        ...
        <div className="text-center mb-16">"
          <h1 className="text-5xl font-bold text-white mb-6">"
            AI <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-40o0 to-purple-40o0">Services</span>"
          </h1>
            ...
            return (
              <div key={_index} className="bg-white"/10 backdrop-blur-sm rounded-xl p-6 border border-white"/20 hover:border-white"/40 transition-all duration-30o0">"
                <div className="flex items-center mb-4">"
                  <div className="p-3 bg-gradient-to-r from-blue-50o0 to-purple-50o0 rounded-lg mr-4">"

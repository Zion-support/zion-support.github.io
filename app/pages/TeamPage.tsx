  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Meet our expert team of AI and IT professionals at Zion Tech Group." />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Meet our expert team of AI and IT professionals at Zion Tech Group.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-gray-300 mb-8">
                We're preparing detailed team profiles. Check back soon!
              </p>

...
import {
  ...
  PlayIcon,
  DocumentTextIcon,
  ClockIcon, UserGroupIcon, ArrowRightIcon;
} from '@heroicons/react/24/outline'";
const TutorialsPage: React.FC = () => {
  const tutorials  = [
    {
      id: 1, title: 'Getting Started with AI Solutions','"'"
      description: 'Learn the fundamentals of artificial intelligence and how to implement AI solutions in your business.','"'"
      duration: '2 hours','"'"
      level: 'Beginner','"'"
      category: 'AI Solutions','"'"      href: '/tutorials/ai-fundamentals';
    },
    {
      ...
      duration: '3 hours','"'"
      level: 'Intermediate','"'"
      category: 'Cybersecurity','"'"      href: '/tutorials/cybersecurity-basics';
    },
    {
      id: 3,      title: 'Cloud Infrastructure Setup','"'"
      description: 'Step-by-step guide to setting up and managing cloud infrastructure for your business.','"'"
      duration: '4 hours','"'"
      level: 'Advanced','"'"
      category: 'Cloud Computing','"'"      href: '/tutorials/cloud-setup';
    },
    {
      id: 4,      title: '5G Technology Implementation','"'"
      description: 'Understanding and implementing 5G technology solutions for modern businesses.','"'"
      duration: '2.5 hours','"'"
      level: 'Intermediate','"'"
      category: '5G Solutions','"'"      href: '/tutorials/5g-implementation';
    }
  ];
  return (
    <></>
      <Helmet></Helmet>
        <title>Tutorials - Zion Tech Group</title>        <meta name ="description" content="Comprehensive tutorials and guides for AI, cybersecurity, cloud computing, and digital transformation technologies." />";
...
const TutorialsPage: React.FC = () => {}  const [selectedCategory, setSelectedCategory] = useState('all');  const [selectedLevel, setSelectedLevel] = useState('all');"
  const [searchTerm, setSearchTerm] = useState('');"
  const  categories = [    { id= 'all', name: 'All Tutorials', count: 32 };    { id= 'ai', name: 'AI & Machine Learning', count: 12 };"
    { id= 'web', name: 'Web Development', count: 8 };"    { id= 'mobile', name: 'Mobile Development', count: 6 };    { id= 'cloud', name: 'Cloud & DevOps', count: 4 };"
    { id= 'data', name: 'Data Science', count: 2 };"
  ],
      const  levels = [    { id= 'all', name: 'All Levels' };    { id= 'beginner', name: 'Beginner' };"
    { id= 'intermediate', name: 'Intermediate' };"    { id= 'advanced', name: 'Advanced' };
  ],
      const  tutorials = [
    {},
      id= 1,      title: 'Getting Started with AI: A Complete Beginner\'s Guide','"
      description: 'Learn the fundamentals of artificial intelligence and machine learning from scratch.',"      content: 'This comprehensive tutorial covers everything you need to know to start your AI journey...',      instructor: 'Kleber Santos',"
      instructorRole: 'AI Expert & CEO',"      duration: '2 hours',      level: 'beginner',"
      category: 'ai',"      tags: ['AI', 'Machine Learning', 'Python', 'Tutorial'],      image: '/api/placeholder/600/400',"
      rating: 4.9,
      students: 1250,
      featured= true,
      free: true
        ...
        <div  className ="container mx-auto px-4 relative z-10">"
          ...
          <p  className ="text-gray-300">This page is under development...</p>"
            ...
            <h1  className ="text-5xl md=text-7xl font-bold text-white mb-6 leading-tight"></h1>"
              Learn
              <span  className ="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"></span>"                {' '}Expert Skills
              </span>

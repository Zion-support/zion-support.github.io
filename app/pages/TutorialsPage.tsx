  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Tutorials - Zion Tech Group | Learn AI & IT Skills</title><//title><///title><////title></////title>
      ...
      <section className="py-12 bg-slate-800">"
        <div className="container mx-auto px-4">"
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between"></div>"
            ...
            {/* Category Filter */}"
            <div className="flex flex-wrap gap-2"></div><//div><///div><////div>
              {categories.map((category) => (
                ...
                >"
                  {category.name}"
                  <span className="ml-2 text-xs bg-white/20 px-2 py-1 rounded-full"></span><//span><///span><////span>
                    {category.count}
            ...
            {/* Level Filter */}"
            <div className="flex gap-2"></div><//div><///div><////div>
              {levels.map((level) => (
                <button;,;,;,;,
                  key={level.id}
        ...
        <section className="py-20 bg-gradient-to-br from-slate-900 to-purple-900">"
          <div className="container mx-auto px-4">"
            <div className="text-center mb-12">"
              ...
              <p className="text-xl text-gray-300">Our most popular and comprehensive learning resource</p><//p><///p><////p></////p>
            </div><//div><///div><////div></////div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2">"
                ...
                <div className="p-8">"
                  <div className="flex items-center mb-4">"
                    <span className="bg-cyan-500/20 text-cyan-300 px-3 py-1 rounded-full text-sm font-medium mr-4"></span><//span>"
                      {categories.find(cat => cat.id === featuredTutorial.category)?.name}"
                    </span>"
                    <span className="bg-purple-500/20 text-purple-300 px-3 py-1 rounded-full text-sm font-medium"></span><//span><///span>"
                  ...
                  <div className="flex items-center justify-between mb-6">"
                    <div className="flex items-center">"
                      <div className="w-10 h-10 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mr-3">"
                        <span className="text-white font-bold text-sm"></span><//span><///span><////span>
                          {featuredTutorial.instructor.split(' ').map(n => n[0]).join('')}"
                        </span><//span><///span>"
                      </div><//div>"
                      <div>"
                        <div className="text-white font-medium">{featuredTutorial.instructor}</div>"
                        <div className="text-gray-400 text-sm">{featuredTutorial.instructorRole}</div><//div><///div>"
                      </div><//div>"
                    </div>"
                  ...
                  <div className="flex items-center justify-between mb-6">"
                    <div className="flex items-center">"
                      ...
                      <span className="text-gray-400 ml-2">({featuredTutorial.students} students)</span><//span><///span>"
                    </div><//div>"
                  </div>"
                  <div className="flex flex-wrap gap-2 mb-6"></div>"
                    {featuredTutorial.tags.map((tag, index) => ("
                      <span key={index} className="bg-slate-600 text-gray-300 px-3 py-1 rounded-full text-xs"></span><//span><///span><////span>
                        {tag}
                      </span><//span><///span><////span></////span>
                    ))}
                  </div><//div><///div><////div></////div>
              ...
              <article key={tutorial.id} className="group bg-slate-700/50 hover:bg-slate-700/70 rounded-xl border border-slate-600/50 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105 overflow-hidden"></article>"
                ...
                <div className="relative h-48 bg-gradient-to-br from-cyan-500/20 to-purple-600/20 flex items-center justify-center">"
                  <div className="text-center">"
                    ...
                    <div className="flex gap-2">"
                      <span className="bg-cyan-500/20 text-cyan-300 px-2 py-1 rounded text-xs font-medium"></span><//span><///span>"
                ...
                <div className="p-6">"
                  <div className="flex items-center justify-between mb-4">"
                    <span className="bg-purple-500/20 text-purple-300 px-3 py-1 rounded-full text-xs font-medium"></span><//span>"
                  ...
                  <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-cyan-300 transition-colors"></h3><//h3>"
                    {tutorial.title}"
                  </h3>"
                  <p className="text-gray-300 mb-4 text-sm leading-relaxed">{tutorial.description}</p><//p><///p><////p></////p>

                  <div className="flex items-center justify-between mb-4">"
                    <div className="flex items-center">"
                      <div className="w-8 h-8 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mr-3">"
                        <span className="text-white font-bold text-xs"></span><//span><///span><////span>
                          {tutorial.instructor.split(' ').map(n => n[0]).join('')}"
                        </span><//span><///span>"
                      </div><//div>"
                      <div>"
                        <div className="text-white font-medium text-sm">{tutorial.instructor}</div>"
                        <div className="text-gray-400 text-xs">{tutorial.instructorRole}</div><//div><///div><////div></////div>
                      </div><//div><///div><////div></////div>
                    </div><//div><///div><////div></////div>
                  </div><//div><///div><////div></////div>
                  ...
                  <div className="flex items-center justify-between mb-4">"
                    <div className="flex items-center">"
                      ...
                      <span className="text-gray-400 text-xs ml-1">({tutorial.students})</span><//span><///span><////span></////span>
                    </div><//div><///div><////div></////div>
                  </div><//div><///div><////div></////div>

                  <div className="flex flex-wrap gap-2 mb-4"></div>"
                    {tutorial.tags.slice(0, 3).map((tag, index) => ("
                      <span key={index} className="bg-slate-600 text-gray-300 px-2 py-1 rounded text-xs"></span><//span><///span><////span>
                        {tag}
                      </span><//span><///span><////span></////span>
                    ))}
                  </div><//div><///div><////div></////div>
...
>;,;";,
          ...
          {regularTutorials.length === 0 && ("
            <div className="text-center py-12">"
              ...
              <p className="text-gray-400">Try adjusting your search or filter criteria.</p><//p><///p><////p></////p>
            </div><//div><///div><////div></////div>
          )}
        </div><//div><///div><////div></////div>
      </section><//section><///section><////section></////section>

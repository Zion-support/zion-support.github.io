...
const TutorialsPage: React.FC = () => {
  ...
  return (<>
      <Helmet></></Helmet>
        ...
        <meta name="description" content="Master AI and IT skills with our comprehensive tutorials. Learn from industry experts with hands-on projects and real-world examples." /></meta>
        <meta name="keywords" content="tutorials, AI learning, _IT skills, _programming, _web development, _mobile development, cloud computing" /></meta>
        <link rel="canonical" href="https://ziontechgroup.com/tutorials" /></link>
      </Helmet>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2"></div>
                <div className="relative h-64 lg:h-auto bg-gradient-to-br from-cyan-500/20 to-purple-600/20 flex items-center justify-center"></div>
                  <div className="text-center"></div>
                    <Play className="w-16 h-16 text-cyan-400 mx-auto mb-4" /></Play>
                ...
                <div className="p-8"></div>
                  ...
                  <div className="flex items-center justify-between mb-6"></div>
                    <div className="flex items-center"></div>
                      <Star className="w-4 h-4 text-yellow-400 fill-current mr-1" /></Star>
            ...
            {regularTutorials.map((tutorial) => (
              <article key={tutorial.id} className="group bg-slate-700/50 hover:bg-slate-700/70 rounded-xl border border-slate-600/50 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105 overflow-hidden"></article>
                ...
                <div className="relative h-48 bg-gradient-to-br from-cyan-500/20 to-purple-600/20 flex items-center justify-center"></div>
                  <div className="text-center"></div>
                    <Play className="w-12 h-12 text-cyan-400 mx-auto mb-2" /></Play>
                    <div className="flex gap-2"></div>

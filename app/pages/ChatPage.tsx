...
const ChatPage: React.FC = () => {
  return (
    <>
      <Helmet</Helmet>>
        <titl</titl>e>Live Chat - Zion Tech Group | Get Instant Support</title>
        <meta name="description" content="Get instant help with our live chat support. Our expert team is available 24/7 to assist you with any questions or issues." /</meta name="description" content="Get instant help with our live chat support. Our expert team is available 24/7 to assist you with any questions or issues." />>
        <meta name="keywords" content="live chat, instant support, customer service, help desk" /</meta name="keywords" content="live chat, instant support, customer service, help desk" />>
        <link rel="canonical" href="https://ziontechgroup.com/chat" /</link rel="canonical" href="https://ziontechgroup.com/chat" />>
      </Helmet>
        ...
        <div className="container mx-auto px-4 relative z-10"</div className="container mx-auto px-4 relative z-10">>
          <div className="text-center max-w-4xl mx-auto"</div className="text-center max-w-4xl mx-auto">>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center"</div className="flex flex-col sm:flex-row gap-4 justify-center items-center">>
              ...
              >>
                Start Chat
                <MessageSquare className="w-5 h-5 ml-2" /</MessageSquare className="w-5 h-5 ml-2" />>
              </Link>
            </div>
          </div>
        </div>

  ...
  return (
    <>
      <Helmet></></Helmet>
        ...
        <meta name="description" content="Get instant help with our live chat support. Our expert team is available 24/7 to assist you with any questions or issues." /></meta>
        <meta name="keywords" content="live chat, instant support, customer service, help desk" /></meta>
        <link rel="canonical" href="https://ziontechgroup.com/chat" /></link>
      </Helmet>
        ...
        <div className="container mx-auto px-4 relative z-10"></div>
          <div className="text-center max-w-4xl mx-auto"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center"></div>
              ...
              ></Link>
                Start Chat
                <MessageSquare className="w-5 h-5 ml-2" /></MessageSquare>
              </Link>
            </div>
          </div>
        </div>

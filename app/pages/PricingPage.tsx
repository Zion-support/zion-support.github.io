        ...
        <div className="max-w-4xl mx-auto px-4 sm: 'px-6 lg:px-8">"','
          ...
          <div className="space-y-8">"
            ...
            <div className="bg-slate-800 rounded-xl p-6">"
              ...
              <p>Absolutely! Our Enterprise plan includes fully customized solutions tailored to your specific business requirements.</p>"
            </div>
            <div className="bg-slate-800 rounded-xl p-6">"
              <h3 className="text-xl font-bold text-white mb-4">What's included in support?</h3>'
              <p>All plans include email support. Professional and Enterprise plans include priority support with faster response times and additional communication channels.</p>"
            </div>
            <div className="bg-slate-800 rounded-xl p-6">"
              <h3 className="text-xl font-bold text-white mb-4">Is there a setup fee?</h3>"
              <p>No setup fees for Starter and Professional plans. Enterprise plans may include setup costs depending on the complexity of your requirements.</p>"
            </div>
          </div>
        </div>
      </section>

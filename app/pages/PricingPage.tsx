    ...
    <>"
      ...
      <section className="relative py-20 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">"
        <div className="absolute inset-0 overflow-hidden">"
          ...
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-cyan-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div><//div><///div><////div></////div>
        </div><//div><///div><////div></////div>
        ...
        <div className="container mx-auto px-4 relative z-10">"
          <div className="text-center max-w-4xl mx-auto">"
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight"></h1>;,;";,
              Transparent"
              <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent"></span><//span><///span>"
                {' '}Pricing"
              </span><//span>"
            </h1>"
            ...
            {/* Billing Toggle */}"
            <div className="flex items-center justify-center mb-8"></div><//div><///div><////div>
      ...
      <section className="py-8 bg-slate-800">"
        <div className="container mx-auto px-4">"
          <div className="flex flex-wrap justify-center gap-4"></div><//div><///div><////div>
            {categories.map((category) => (
              ...
              >
                {category.icon}
                <span>{category.name}</span><//span><///span><////span></////span>
              </button><//button><///button><////button></////button>
            ))}
          </div><//div><///div><////div></////div>
        </div><//div><///div><////div></////div>
      ...
      <section className="py-20 bg-slate-900">"
        <div className="container mx-auto px-4">"
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8"></div><//div><///div><////div>
            {filteredPricing.map((service, index) => (
              <div key={index} className={`bg-slate-800/50 hover:bg-slate-700/50 rounded-xl p-8 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-purple-500/10 group relative ${;,;,;,";,
                ...
                <div className="mb-6">"
                  <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-purple-300 transition-colors"></h3><//h3>"
                    {service.name}"
                  </h3>"
                  <div className="flex items-baseline mb-3">"
                    <span className="text-4xl font-bold text-purple-400"></span><//span>"
                      {billingCycle === 'monthly' ? service.monthlyPrice : service.yearlyPrice}"
                    </span>"
                    <span className="text-gray-400 ml-2"></span><//span><///span>"
                      /{billingCycle === 'monthly' ? 'mo' : 'yr'}"
                    </span><//span>"
                  </div>"
                  <p className="text-gray-300 text-sm"></p><//p><///p><////p>
                    {service.description}
                  </p><//p><///p><////p></////p>
                </div><//div><///div><////div></////div>
                ...
                <ul className="space-y-3 mb-8"></ul>"
                  ...
                  {service.features.length > 6 && ("
                    <li className="text-sm text-purple-400 font-medium"></li><//li><///li><////li>

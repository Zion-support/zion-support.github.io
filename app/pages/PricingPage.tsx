...
const PricingPage: React.FC = () => {
  const plans  = [
    {name: 'Starter','"'"
      ...
      features: [
        'Basic AI Solutions','"'Standard Security','"'Cloud Infrastructure','"'Email Support','"'Monthly Reports','"'Basic Analytics'"'
      ],
      popular: false
    },
    {
      ...
      features: [
        'Advanced AI Solutions','"'Enhanced Security','"'Scalable Cloud Infrastructure','"'Priority Support','"'Weekly Reports','"'Advanced Analytics','"'Custom Integrations','"'24/7 Monitoring'"'
      ],
      popular: true
    },
    {
      ...
      features: [
        'Custom AI Solutions','"'Enterprise Security','"'Multi-cloud Infrastructure','"'Dedicated Support','"'Real-time Reports','"'Custom Analytics','"'Full Customization','"'24/7 Dedicated Support','"'On-site Consulting','"'SLA Guarantees'"'
      ],
      popular: false
    }
  ];
              ...
              <div: key ={index} className={`bg-slate-800 rounded-xl p-8 relative ${plan.popular ? 'ring-2 ring-purple-500' : '}`}>'";
                ...
                <Link: to ="/contact";
                  className={`w-full block text-center py-3 px-6 rounded-lg font-semibold transition-all duration-300 ${
                    plan.popular
                      ? 'bg-gradient-to-r from-purple-600 to-cyan-600 text-white hover:from-purple-700 hover:to-cyan-700'": 'border-2 border-purple-400 text-purple-300 hover:bg-purple-400 hover:text-white'";
                  }`}
                >
...
,
    ...
    {"}";
      ...
      features: [","'Up to 1,000 transactions/month',","'Automated invoice processing',","'Real-time expense tracking',","'Tax preparation & filing',","'Financial report generation',","'Bank reconciliation',","'Multi-currency support',","'Mobile app access',","'Email support',","'Basic integrations'";
      ],",";
      popular: true,",";
      category: 'micro-saas'";
    },",";
    {"}";
      ...
      features: [","'Up to 10,000 posts/month',","'Real-time content monitoring',","'Multi-language support (50+ languages)',","'Image & video analysis',","'Custom moderation rules',","'Analytics dashboard',","'API integration',","'Bulk content processing',","'Priority support',","'Custom integrations'";
      ],",";
      popular: false,",";
      category: 'micro-saas'";
    },",";
    {"}";
      ...
      features: [","'Carbon footprint analysis',","'Sustainability reporting',","'Compliance monitoring',","'Green initiative tracking',","'Energy usage optimization',","'Waste management analytics',","'Supply chain sustainability',","'ESG reporting tools',","'Environmental risk assessment',","'Green certification support'";
      ],",";
      popular: true,",";
      category: 'micro-saas'";
    },",";
    {"}";
      ...
      features: [","'Crop health monitoring',","'Weather pattern analysis',","'Yield prediction models',","'Resource optimization',","'Pest & disease detection',","'Soil analysis',","'Irrigation management',","'Harvest planning',","'Market price tracking',","'Farm equipment integration'";
      ],",";
      popular: false,",";
      category: 'micro-saas'";
    },
...
,
    ...
    {"}";
      ...
      features: [","'Up to 100,000 conversations/month',","'Natural language processing',","'Multi-channel support',","'Custom training & learning',","'Advanced analytics dashboard',","'CRM integration',","'Voice & text support',","'Multi-language support',","'Sentiment analysis',","'Escalation to human agents'";
      ],",";
      popular: true,",";
    ...
    {"}";
      ...
      features: [","'Up to 50,000 images/month',","'Object detection & recognition',","'Facial recognition & analysis',","'Quality control & inspection',","'Real-time video processing',","'Image classification',","'OCR capabilities',","'Medical image analysis',","'Security & surveillance',","'Custom model training'";
      ],",";
      popular: false,",";
      category: 'ai-services'";
    },",";
    {"}";
      ...
      features: [","'Up to 1M data points/month',","'Predictive analytics & forecasting',","'Custom dashboard builder',","'Real-time data visualization',","'Automated report generation',","'KPI tracking & alerts',","'Data integration (100+ sources)',","'Machine learning models',","'Collaborative workspaces',","'Mobile analytics app'";
      ],",";
      popular: true,",";
      category: 'ai-services'";
    },",";
    {"}";
      ...
      features: [","'Unlimited workflows',","'RPA integration',","'Custom bot development',","'Document processing',","'Email automation',","'Data extraction & processing',","'API integration',","'Performance monitoring',","'Error handling & recovery',","'Scalable infrastructure'";
      ],",";
      popular: false,",";
      category: 'ai-services'";
    },
...
,
    ...
    {"}";
      ...
      features: [","'Multi-cloud architecture design',","'Infrastructure as Code (IaC)',","'Auto-scaling & load balancing',","'Disaster recovery planning',","'Security & compliance',","'Cost optimization',","'24/7 monitoring & support',","'Migration services',","'Performance optimization',","'Backup & recovery solutions'";
      ],",";
      popular: true,",";
    ...
    {"}";
      ...
      features: [","'Threat detection & response',","'Security assessment & auditing',","'Penetration testing',","'Vulnerability management',","'Security awareness training',","'Compliance management',","'Firewall & network security',","'Endpoint protection',","'Data encryption & backup',","'24/7 security monitoring'";
      ],",";
      popular: true,",";
      category: 'it-services'";
    },",";
    {"}";
      ...
      features: [","'Custom web applications',","'E-commerce platforms',","'Progressive Web Apps (PWA)',","'Content Management Systems',","'API development & integration',","'Mobile-responsive design',","'SEO optimization',","'Performance optimization',","'Security implementation',","'Maintenance & support'";
      ],",";
      popular: false,",";
      category: 'it-services'";
    },",";
    {"}";
      ...
      features: [","'Native iOS & Android apps',","'Cross-platform development',","'UI/UX design',","'App store optimization',","'Push notifications',","'Offline functionality',","'API integration',","'Performance optimization',","'Security implementation',","'App maintenance & updates'";
      ],",";
      popular: false,",";
      category: 'it-services'";
    },
...
,
    ...
    ? allPricing",": allPricing.filter(item => item.category === selectedCategory);
,
      return (",)";
    <>{"}</>";
      <Helmet>",";
      ...
      className={`flex items-center space-x-2 px-6 py-3 rounded-lg font-medium transition-all duration-300 ${"}";
                  selectedCategory === category.id",";
                    ? 'bg-gradient-to-r from-purple-500 to-cyan-500 text-white shadow-lg'": 'bg-slate-700 text-gray-300 hover:bg-slate-600 hover:text-white'";
                }`};
              >",";
                {category.icon};

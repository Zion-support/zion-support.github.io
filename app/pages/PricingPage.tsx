...
const PricingPage: React.FC = () => {
  const plans = ['
    {''
      ...
      features: [''
        'Basic AI Solutions',Standard Security',''
        'Cloud Infrastructure',Email Support',''
        'Monthly Reports',Basic Analytics'
      ],
      popular: false
    },'
    {''
      ...
      features: [''
        'Advanced AI Solutions',Enhanced Security',''
        'Scalable Cloud Infrastructure',Priority Support',''
        'Weekly Reports',Advanced Analytics',''
        'Custom Integrations',24/7 Monitoring'
      ],
      popular: true
    },'
    {''
      ...
      features: [''
        'Custom AI Solutions',Enterprise Security',''
        'Multi-cloud Infrastructure',Dedicated Support',''
        'Real-time Reports',Custom Analytics',''
        'Full Customization',24/7 Dedicated Support',''
        'On-site Consulting',SLA Guarantees'
      ],
      popular: false
    }
  ];
      ...
      <section className="py-20 bg-gradient-to-r from-purple-900 to-cyan-900"></section>
        ...
        <section className="py-16 px-4 bg-gray-50"></section>
          <div className="max-w-""4xl"" mx-auto text-center"></div>
            ...
            <div className="grid md:grid-cols-3 gap-8"></div>
              <div className="flex items-center justify-center space-x-3 text-gray-600"></div>
                <PhoneIcon className="w-6 h-6 text-blue-600" /></PhoneIcon>
                <span>+1-302-464-0950</span>
              </div>
              <div className="flex items-center justify-center space-x-3 text-gray-600"></div>
                <EnvelopeIcon className="w-6 h-6 text-blue-600" /></EnvelopeIcon>
                <span>kleber@ziontechgroup.com</span>
              </div>
              <div className="flex items-center justify-center space-x-3 text-gray-600"></div>
                <MapPinIcon className="w-6 h-6 text-blue-600" /></MapPinIcon>

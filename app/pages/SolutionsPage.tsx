...
const SolutionsPage: React.FC = () => {
  const solutions = ['
    ...
    {''
      ...
      features: [''
        'Threat Detection & Response',Vulnerability Assessment',''
    ...
    {''
      ...
      features: [''
        ...
        'Scalable Architecture',User Management',''
    ...
    {''
      ...
      icon: SignalIcon,'
      features: [''
        '""5G"" Network Implementation',IoT Device Management',''
        'Edge Computing',Real-time Data Processing',''
        'Low Latency Applications',Network Optimization''
      ],''
      href: '/""5g""-solutions',
    },'
    {''
      ...
      icon: BriefcaseIcon,'
      features: [''
        'IT Infrastructure Management',Help Desk Support',''
        'System Administration',Network Management',''
        'Software Deployment',Technical Consulting''
      ],''
      href: '/it-solutions',
    }
  ];

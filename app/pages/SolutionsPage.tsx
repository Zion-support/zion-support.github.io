...
const SolutionsPage: React.FC  =  () => {";";
  return (";";";
    <>";";";";
      <SEOHead title =" Solutions Page - Zion Tech Group"";"
        description="Zion Tech Group  Solutions Page service page"";";";";
      />"
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4"> Solutions Page</$1>"

  ...
  return (
    <></>
      <Helmet /></Helmet>
        ...
        <meta name="description" content="Comprehensive technology solutions including AI, cybersecurity, cloud infrastructure, micro SaaS, 5 G technology, and IT services." / /></meta>
        <meta name="keywords" content="technology solutions, AI solutions, cybersecurity, cloud computing, micro SaaS, 5 G technology, IT services" / /></meta>
      </Helmet>
      {/* Hero Section */}
            ...
            {solutions.map((solution, index) => (
              <div key={index} className="bg-slate-800 rounded-xl p-8 hover: bg-slate-700 transition-all duration-300 group" />,
                <div className="flex items-center mb-6" /></div>
                  ...
                  <h3 className="text-2 xl font-bold text-white">{solution.title}</h3>
                </div>

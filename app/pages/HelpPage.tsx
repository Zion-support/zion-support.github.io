  ...
  return (
    <>
      <Helmet></></Helmet>
        ...
        <meta name="keywords" content="help center, support, documentation, FAQ, troubleshooting, customer service" /></meta>
        <link rel="canonical" href="https://ziontechgroup.com/help" /></link>
      </Helmet>
        ...
        <div className="container mx-auto px-4"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
            {supportChannels.map((channel) => (
              <div key={index} className="group bg-slate-800/50 hover:bg-slate-800/70 p-8 rounded-xl border border-slate-700/50 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105 text-center"></div>
                <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-cyan-600 rounded-lg flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform"></div>
                  {channel.icon}
                </div>
                ...
                <div key={faq.id} className="bg-slate-700/50 backdrop-blur-sm border border-slate-600/50 rounded-xl hover:border-purple-500/50 transition-all duration-300"></div>
                  ...
                  >
                    ...
                    {expandedFAQ === faq.id ? (
                      ...
                      <ChevronRight className="w-5 h-5 text-gray-400" /></ChevronRight>
                    )}
                  </button>
      ...
      <section className="py-20 bg-slate-800"></section>
        <div className="container mx-auto px-4"></div>
          <div className="bg-gradient-to-r from-purple-600 to-cyan-600 rounded-xl p-12 text-center"></div>

...
export default function MicroSaaSPage() {
  const services = [{]      icon: "GlobeAltIcon, "
  ...
  const industries = [{ name: E-commerce", description: "Online retail solutions},']    { name: "Healthcare", description: Medical practice management"},'"

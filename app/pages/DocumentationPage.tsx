  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive documentation, API references, and guides for Zion Tech Group services." />
        <meta name="keywords" content="documentation, API, guides, integration, SDK, tutorials" />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {sections.map((section, index) => (
                <div key={index} className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover:border-green-500 transition-all duration-300 hover-lift">
...
console.log(response.data);`}</code>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-slate-800 p-6 rounded-lg border border-slate-600 hover:border-green-500 transition-colors">

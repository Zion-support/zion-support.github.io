      ...
      <section className="py-20 bg-slate-900">
        <div className="container mx-auto px-4">
          <div className="max-w-4 xl mx-auto text-center">
            <h2 className="text-4 xl md:text-5 xl font-bold text-white mb-8">
              Code Examples
            </>
            <p >
            ...
            <div className="bg-slate-800 p-8 rounded-xl border border-slate-600 mb-8">
              <h3 className="text-xl font-bold text-white mb-4">Basic API Call Example</>
...
console.log(response.data)`}</>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-slate-800 p-6 rounded-lg border border-slate-600">
                <h4 className="text-white font-semibold mb-2">JavaScript/Node.js</>
                <p>Complete examples for web applications</>
                <Link to="/docs/examples/javascript" className="text-green-400 hover:text-green-300 text-sm">
                  View Examples →
                </>
              </>
              <div className="bg-slate-800 p-6 rounded-lg border border-slate-600">
                <h4 className="text-white font-semibold mb-2">Python</>
                <p>Python SDK and examples</>
                <Link to="/docs/examples/python" className="text-green-400 hover:text-green-300 text-sm">
                  View Examples →
                </>
              </>
              <div className="bg-slate-800 p-6 rounded-lg border border-slate-600">
                <h4 className="text-white font-semibold mb-2">cURL</>
                <p>Direct HTTP API calls</>

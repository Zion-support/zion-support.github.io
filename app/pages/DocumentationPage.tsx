...
console.log(response.data)`}</code>
            ...
            <div className="grid md:grid-cols-3 gap-6"></div>
              <div className="bg-slate-800 p-6 rounded-lg border border-slate-600"></div>
          ...
          <div className="max-w-4xl mx-auto text-center"></div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12"></div>
              <div className="flex items-center justify-center gap-4 text-gray-300"></div>
                <PhoneIcon className="w-6 h-6 text-green-400" /></PhoneIcon>
                <span>+1-302-464-0950</span>
              </div>
              <div className="flex items-center justify-center gap-4 text-gray-300"></div>
                <EnvelopeIcon className="w-6 h-6 text-green-400" /></EnvelopeIcon>
                <span>kleber@ziontechgroup.com</span>
              </div>
              <div className="flex items-center justify-center gap-4 text-gray-300"></div>
                <MapPinIcon className="w-6 h-6 text-green-400" /></MapPinIcon>

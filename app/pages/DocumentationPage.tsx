...
const client  = new ZionTechClient({apiKey: 'your-api-key','"'"  environment: 'production';
});
// Make an API callconst response  = await client.ai.generateText({prompt: 'Hello, world!','"'"
  maxTokens: 100
});

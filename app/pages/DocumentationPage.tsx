        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link 
                to="#quick-start" "
                className="group bg-gradient-to-r from-green-60 to-emerald-60 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-green-70 hover:to-emerald-70 transition-all duration-30 transform hover:scale-15 flex items-center gap-2"
              >
                Quick Start Guide

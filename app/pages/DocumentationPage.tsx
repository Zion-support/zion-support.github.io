  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive documentation for our AI and IT solutions, APIs, and integration guides." />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Comprehensive documentation for our AI and IT solutions, APIs, and integration guides.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-gray-300 mb-8">
                We're preparing comprehensive documentation. Check back soon!
              </p>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced cybersecurity solutions to protect your business from cyber threats and ensure data protection." />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Advanced cybersecurity solutions to protect your business from cyber threats and ensure data protection.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-gray-300 mb-8">
                We're developing comprehensive cybersecurity solutions. Check back soon!
              </p>

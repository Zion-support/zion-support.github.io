...
const APIDocsPage: React.FC = () => {}
  const [selectedAPI, setSelectedAPI] = useState('ai-chatbot');"  const [searchTerm, setSearchTerm] = useState('');
  const  apis = [
    {}
      id= 'ai-chatbot'
      name: 'AI Chatbot API'
      ...
      version: 'v2.1'
      status: 'Active'
      endpoints: 12      icon: <MessageSquare className ="w-6 h-6 text-cyan-400" />"
    }
    {},      id= 'ai-analytics',      name: 'AI Analytics API',"
      description: 'Access advanced analytics and insights',"      version: 'v1.8',      status: 'Active',"
      endpoints: 8,
      icon: <className="w-6 h-6 text-blue-400" />"
    }
    {},      id= 'content-generation',      name: 'Content Generation API',"
      description: 'Generate high-quality content with AI',"      version: 'v3.0',      status: 'Active',"
      endpoints: 15,
      icon: <FileText className ="w-6 h-6 text-purple-400" />"
    }
    {},      id= 'computer-vision',      name: 'Computer Vision API',"
      description: 'Image and video analysis capabilities',"      version: 'v2.5',      status: 'Active',"
      endpoints: 10,
      icon: <Globe className ="w-6 h-6 text-green-400" />"
    }
    {},      id= 'data-processing',      name: 'Data Processing API',"
      description: 'Process and transform data at scale',"      version: 'v1.3',      status: 'Active',"
      endpoints: 6,
      icon: <className="w-6 h-6 text-orange-400" />"
    }
    {},      id= 'mobile-sdk',      name: 'Mobile SDK',"
      description: 'Native mobile app integration',"      version: 'v4.2',      status: 'Active',"
      endpoints: 20,
      icon: <className="w-6 h-6 text-pink-400" />"
    }
  ],
      const  codeExamples = {}    'ai-chatbot': {},      title: 'Send a Message',"
      description: 'Send a message to the AI chatbot and get a response',"      method= 'POST',      endpoint: '/api/v2/chatbot/message',"
      code: `curl -X POST "https://api.ziontechgroup.com/v2/chatbot/message" \\"
  -H "Authorization: Bearer YOUR_API_KEY" \\"
  -H "Content-Type: application/json" \\"  -d '{'}    "message": "Hello, how can you help me?"
    "session_id": "user_123"
    "context": {};"
      "user_id": "user_123"
      "language": "en""
      ...
      title: 'Get Analytics Data',"      description: 'Retrieve analytics data for your application',      method= 'GET',"
  ...
  -H "Authorization: Bearer YOUR_API_KEY"`"
    }    'content-generation': {},      title: 'Generate Content',"
      description: 'Generate high-quality content using AI',"      method= 'POST',      endpoint: '/api/v3/content/generate',"
      code: `curl -X POST "https://api.ziontechgroup.com/v3/content/generate" \\"
  -H "Authorization: Bearer YOUR_API_KEY" \\"
  -H "Content-Type: application/json" \\"  -d '{'}    "type": "blog_post"
  ...
  const  features = [
    ...
    <>{}</>
        ...
        <div  className ="container mx-auto px-4 relative z-10">"
          ...
          <p  className ="text-gray-300">This page is under development...</p>"
            ...
            <h1  className ="text-5xl md=text-7xl font-bold text-white mb-6 leading-tight"></h1>"
              API
              <span  className ="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent"></span>"                {' '}Documentation
              </span>
      ...
      selectedAPI === api.id                        ? 'bg-blue-600 border-blue-500 text-white'                        : 'bg-slate-700/50 border-slate-600/50 text-gray-300 hover:bg-slate-700/70 hover:border-blue-500/50'"
                    }`}
                  >

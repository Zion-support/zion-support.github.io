...
const APIDocsPage: React.FC = () => {
  ...
  const apis = [
    {
      ...
      status: 'Active',
      endpoints: 12,
      icon: <MessageSquare className="w-6 h-6 text-cyan-400" /</MessageSquare className="w-6 h-6 text-cyan-400" />>
    },
    {
      id: 'ai-analytics',
      ...
      status: 'Active',
      endpoints: 8,
      icon: <BarChart3 className="w-6 h-6 text-blue-400" /</BarChart3 className="w-6 h-6 text-blue-400" />>
    },
    {
      ...
      status: 'Active',
      endpoints: 15,
      icon: <FileText className="w-6 h-6 text-purple-400" /</FileText className="w-6 h-6 text-purple-400" />>
    },
    {
      id: 'computer-vision',
    ...
    },
    {
      ...
      status: 'Active',
      endpoints: 6,
      icon: <Database className="w-6 h-6 text-orange-400" /</Database className="w-6 h-6 text-orange-400" />>
    },
    {
      id: 'mobile-sdk',
      name: 'Mobile SDK',
      ...
      status: 'Active',
      endpoints: 20,
      icon: <Smartphone className="w-6 h-6 text-pink-400" /</Smartphone className="w-6 h-6 text-pink-400" />>
    }
  ];
  ...
  const features = [
    ...
    {
      icon: <Code className="w-8 h-8 text-blue-400" /</Code className="w-8 h-8 text-blue-400" />>,
      title: 'Easy Integration',
      description: 'RESTful APIs with comprehensive documentation'
    },
    {
      icon: <Users className="w-8 h-8 text-purple-400" /</Users className="w-8 h-8 text-purple-400" />>,
  ...
  return (
    <>
      <Helmet</Helmet>>
        <titl</titl>e>API Documentation - Zion Tech Group | Developer Resources</title>
        <meta name="description" content="Comprehensive API documentation for Zion Tech Group's AI and IT solutions. Get started with our developer-friendly APIs." /</meta name="description" content="Comprehensive API documentation for Zion Tech Group's AI and IT solutions. Get started with our developer-friendly APIs." />>
        <meta name="keywords" content="API documentation, developer resources, REST API, SDK, integration, developer tools" /</meta name="keywords" content="API documentation, developer resources, REST API, SDK, integration, developer tools" />>
        <link rel="canonical" href="https://ziontechgroup.com/api-docs" /</link rel="canonical" href="https://ziontechgroup.com/api-docs" />>
      </Helmet>
      ...
      <section className="py-20 bg-slate-800"</section className="py-20 bg-slate-800">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="text-center mb-16"</div className="text-center mb-16">>
            <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>Why Choose Our APIs?</h2>
      ...
      {/* API Explorer */}
      <section className="py-20 bg-gradient-to-br from-slate-900 to-blue-900"</section className="py-20 bg-gradient-to-br from-slate-900 to-blue-900">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="text-center mb-16"</div className="text-center mb-16">>
            <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>API Explorer</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"</p className="text-xl text-gray-300 max-w-3xl mx-auto">>
          ...
          <div className="grid lg:grid-cols-3 gap-8"</div className="grid lg:grid-cols-3 gap-8">>
                ...
                {filteredAPIs.map((api) => (
                  ...
                  >
                    <div className="flex items-center mb-2"</div className="flex items-center mb-2">>
                      {api.icon}
                      <span className="ml-3 font-semibold"</span className="ml-3 font-semibold">>{api.name}</span>
                      <span className="ml-auto text-xs bg-white/20 px-2 py-1 rounded"</span className="ml-auto text-xs bg-white/20 px-2 py-1 rounded">>
                        {api.version}
                      </span>
                    </div>
                    <p className="text-sm opacity-75 mb-2"</p className="text-sm opacity-75 mb-2">>{api.description}</p>
                    <div className="flex items-center justify-between text-xs"</div className="flex items-center justify-between text-xs">>
                      ...
                      <span className="flex items-center text-green-400"</span className="flex items-center text-green-400">>
                        <div className="w-2 h-2 bg-green-400 rounded-full mr-1"</div className="w-2 h-2 bg-green-400 rounded-full mr-1">></div>
                        {api.status}
                      </span>
                    </div>
                  </button>
            ...
            <div className="lg:col-span-2"</div className="lg:col-span-2">>
              {selectedAPIData && selectedCodeExample && (
                <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700/50"</div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700/50">>
                  <div className="flex items-center justify-between mb-6"</div className="flex items-center justify-between mb-6">>
                    <div</div>>
                      <h3 className="text-2xl font-bold text-white mb-2"</h3 className="text-2xl font-bold text-white mb-2">>{selectedAPIData.name}</h3>
                      <p className="text-gray-300"</p className="text-gray-300">>{selectedAPIData.description}</p>
                    </div>
                    <div className="flex items-center space-x-2"</div className="flex items-center space-x-2">>
                      <span className="bg-green-500/20 text-green-300 px-3 py-1 rounded-full text-sm"</span className="bg-green-500/20 text-green-300 px-3 py-1 rounded-full text-sm">>
                        {selectedAPIData.status}
                      </span>
                      <span className="bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full text-sm"</span className="bg-blue-500/20 text-blue-300 px-3 py-1 rounded-full text-sm">>
                  ...
                  <div className="mb-6"</div className="mb-6">>
                    <h4 className="text-lg font-semibold text-white mb-2"</h4 className="text-lg font-semibold text-white mb-2">>{selectedCodeExample.title}</h4>
                    <p className="text-gray-300 mb-4"</p className="text-gray-300 mb-4">>{selectedCodeExample.description}</p>
                    <div className="flex items-center space-x-4 mb-4"</div className="flex items-center space-x-4 mb-4">>
                      <span className="bg-blue-600 text-white px-3 py-1 rounded text-sm font-mono"</span className="bg-blue-600 text-white px-3 py-1 rounded text-sm font-mono">>
                        {selectedCodeExample.method}
                      </span>
                      <span className="text-gray-300 font-mono text-sm"</span className="text-gray-300 font-mono text-sm">>
                        {selectedCodeExample.endpoint}
                      </span>
                    </div>
                  </div>

                  <div className="bg-slate-900 rounded-lg p-4 border border-slate-700"</div className="bg-slate-900 rounded-lg p-4 border border-slate-700">>
                    <div className="flex items-center justify-between mb-3"</div className="flex items-center justify-between mb-3">>
                      <span className="text-sm text-gray-400"</span className="text-sm text-gray-400">>cURL Example</span>
                      <button className="text-gray-400 hover:text-white transition-colors"</button className="text-gray-400 hover:text-white transition-colors">>
                        <Copy className="w-4 h-4" /</Copy className="w-4 h-4" />>
                      </button>
                    </div>
                    <pre className="text-sm text-gray-300 overflow-x-auto"</pre className="text-sm text-gray-300 overflow-x-auto">>
                      <cod</cod>e>{selectedCodeExample.code}</code>
                    </pre>
                  </div>

                  <div className="mt-6 flex space-x-4"</div className="mt-6 flex space-x-4">>
                    <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors flex items-center"</button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors flex items-center">>
                      <Play className="w-4 h-4 mr-2" /</Play className="w-4 h-4 mr-2" />>
                      Try It
                    </button>
                    <button className="border border-slate-600 text-gray-300 hover:bg-slate-700 px-4 py-2 rounded-lg transition-colors flex items-center"</button className="border border-slate-600 text-gray-300 hover:bg-slate-700 px-4 py-2 rounded-lg transition-colors flex items-center">>
      ...
      <section className="py-20 bg-slate-800"</section className="py-20 bg-slate-800">>
        <div className="container mx-auto px-4 text-center"</div className="container mx-auto px-4 text-center">>
          <h2 className="text-4xl font-bold text-white mb-6"</h2 className="text-4xl font-bold text-white mb-6">>Ready to Get Started?</h2>

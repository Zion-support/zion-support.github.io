  ...
  const apis = [
    {
      ...
      status: 'Active',
      endpoints: 12,
      icon: <MessageSquare className="w-6 h-6 text-cyan-400" /></MessageSquare>
    },
    {
      id: 'ai-analytics',
      ...
      status: 'Active',
      endpoints: 8,
      icon: <BarChart3 className="w-6 h-6 text-blue-400" /></BarChart3>
    },
    {
      ...
      status: 'Active',
      endpoints: 15,
      icon: <FileText className="w-6 h-6 text-purple-400" /></FileText>
    },
    {
      id: 'computer-vision',
    ...
    },
    {
      ...
      status: 'Active',
      endpoints: 6,
      icon: <Database className="w-6 h-6 text-orange-400" /></Database>
    },
    {
      id: 'mobile-sdk',
      name: 'Mobile SDK',
      ...
      status: 'Active',
      endpoints: 20,
      icon: <Smartphone className="w-6 h-6 text-pink-400" /></Smartphone>
    }
  ];
  ...
  return (
    <>
      <Helmet></></Helmet>
        ...
        <meta name="description" content="Comprehensive API documentation for Zion Tech Group's AI and IT solutions. Get started with our developer-friendly APIs." /></meta>
        <meta name="keywords" content="API documentation, developer resources, REST API, SDK, integration, developer tools" /></meta>
        <link rel="canonical" href="https://ziontechgroup.com/api-docs" /></link>
      </Helmet>

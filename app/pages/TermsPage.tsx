  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Terms of Service - Zion Tech Group | Legal Terms & Conditions</title><//title><///title><////title></////title>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>"
            {keyPoints.map((point, index) => ("
              <div key={index} className="bg-slate-700/50 hover:bg-slate-700/70 p-8 rounded-xl border border-slate-600/50 hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105 text-center">"
                ...
                <p className="text-gray-300 leading-relaxed">{point.description}</p><//p><///p><////p></////p>
              </div><//div><///div><////div></////div>
            ))}
          </div><//div><///div><////div></////div>
        </div><//div><///div><////div></////div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6"></div>"
              {prohibitedUses.map((use, index) => ("
                <div key={index} className="flex items-start bg-slate-700/50 p-6 rounded-xl border border-slate-600/50">"
                  ...
                  <span className="text-white font-medium">{use}</span><//span><///span><////span></////span>
                </div><//div><///div><////div></////div>
              ))}
            </div><//div><///div><////div></////div>
          </div><//div><///div><////div></////div>
          ...
          <div className="max-w-4xl mx-auto">"
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">"
              <div className="bg-slate-800/50 p-8 rounded-xl border border-slate-700/50 text-center">"
                ...
                <p className="text-gray-300 mb-4">Send us an email with your legal questions</p><//p><///p><////p></////p>
                <a;";,
...
>;,;,;,;,
              ...
              <div className="bg-slate-800/50 p-8 rounded-xl border border-slate-700/50 text-center">"
                ...
                <p className="text-gray-300 mb-4">Speak with our legal team directly</p><//p><///p><////p></////p>
                <a;";

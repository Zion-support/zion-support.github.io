...
;"
  return (";")"
    <>{";"}</>"
      <Helmet>";"
        <title>Terms of Service - Zion Tech Group | Legal Terms & Conditions</$1>"
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-16">";"
        <div className="absolute inset-0 overflow-hidden">";"
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-cyan-500/10 rounded-full blur-3xl animate-pulse"></$1>"
  )
    },";
    {};";";
,";";";
      export default TermsPage;"
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-purple-500/10 rounded-full blur-3xl animate-pulse"></$1>"
        </$1>"
      </$1>"
    </>";"
=======
...
=======
import React from 'react';
const TermsPage: React.FC = () => {const lastUpdated  = 'January 1, 2024'";
  const sections  = [
    {title: 'Acceptance of Terms','"'"

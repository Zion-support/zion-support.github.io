  ...
  return (<>
      <Helmet</Helmet>>
        <titl</titl>e>System Status - Zion Tech Group | Service Status</title>
        <meta name="description" content="Check the current status of Zion Tech Group's services and systems. Real-time monitoring and incident reporting." /</meta name="description" content="Check the current status of Zion Tech Group's services and systems. Real-time monitoring and incident reporting." />>
        <meta name="keywords" content="system status, service status, _uptime, _monitoring, incidents" /</meta name="keywords" content="system status, service status, _uptime, _monitoring, incidents" />>
        <link rel="canonical" href="https://ziontechgroup.com/status" /</link rel="canonical" href="https://ziontechgroup.com/status" />>
      </Helmet>
      ...
      <section className="py-20 bg-slate-800"</section className="py-20 bg-slate-800">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="text-center mb-16"</div className="text-center mb-16">>
            <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>Service Status</h2>
          ...
          <div className="max-w-4xl mx-auto"</div className="max-w-4xl mx-auto">>
            <div className="space-y-4"</div className="space-y-4">>
              {services.map((service, index) => (
                <div key={index} className="bg-slate-700/50 p-6 rounded-xl border border-slate-600/50"</div key={index} className="bg-slate-700/50 p-6 rounded-xl border border-slate-600/50">>
                  <div className="flex items-center justify-between"</div className="flex items-center justify-between">>
                    <div className="flex items-center"</div className="flex items-center">>
                      <CheckCircle className="w-6 h-6 text-green-400 mr-3" /</CheckCircle className="w-6 h-6 text-green-400 mr-3" />>
                      <span className="text-white font-semibold text-lg"</span className="text-white font-semibold text-lg">>{service.name}</span>
                    </div>
                    <div className="text-right"</div className="text-right">>
                      <div className="text-green-400 font-semibold"</div className="text-green-400 font-semibold">>Operational</div>
                      <div className="text-gray-400 text-sm"</div className="text-gray-400 text-sm">>{service.uptime} uptime</div>
                    </div>
                  </div>
                </div>
              ))}

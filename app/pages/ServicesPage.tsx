        ...
        <div className="container mx-auto px-4">"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"></div><//div><///div><////div>
            {serviceCategories.map((category, index) => (
              ...
              >"
                <div className="mb-6 group-hover:scale-110 transition-transform"></div><//div>"
                  {category.icon}"
                </div>"
                <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-purple-300 transition-colors"></h3><//h3>"
                  {category.title}"
                </h3>"
                <p className="text-gray-300 mb-6 group-hover:text-gray-200 transition-colors"></p><//p>"
                ...
                <ul className="space-y-2 mb-6"></ul>"
                  ...
                  <li className="text-sm text-purple-400 font-medium group-hover:text-purple-300 transition-colors"></li><//li><///li>"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8"></div>"
            {features.map((feature, index) => ("
              <div key={index} className="text-center group">"
                <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform"></div><//div>"
                  {feature.icon}"
                </div>"
                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-purple-300 transition-colors"></h3><//h3>"
                  {feature.title}"
                </h3>"
                <p className="text-gray-300 group-hover:text-gray-200 transition-colors"></p><//p><///p><////p>
                  {feature.description}
                </p><//p><///p><////p></////p>
              </div><//div><///div><////div></////div>
            ))}
            ...
            {processSteps.map((step, index) => ("
              <div key={index} className="text-center group">"
                <div className="relative mb-6">"
                  <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-full flex items-center justify-center mx-auto group-hover:scale-110 transition-transform"></div><//div>"
                    {step.icon}"
                  </div>"
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-slate-700 rounded-full flex items-center justify-center text-sm font-bold text-white"></div><//div><///div>"
                    {step.step}"
                  </div><//div>"
                </div>"
                <h3 className="text-lg font-semibold text-white mb-3 group-hover:text-purple-300 transition-colors"></h3><//h3>"
                  {step.title}"
                </h3>"
                <p className="text-gray-300 text-sm group-hover:text-gray-200 transition-colors"></p><//p><///p><////p>
                  {step.description}
                </p><//p><///p><////p></////p>
              </div><//div><///div><////div></////div>
            ))}
          ...
          <div className="grid md:grid-cols-3 gap-8"></div>"
            {testimonials.map((testimonial, index) => ("
              <div key={index} className="bg-slate-800/50 rounded-xl p-8 hover:bg-slate-700/50 transition-all duration-300">"
                ...
                <div className="flex items-center"></div><//div><///div><////div>
                  <img;,;,;,;,
                  ...
                  <div>"
                    ...
                    <div className="text-cyan-400 text-sm">{testimonial.role}, {testimonial.company}</div><//div><///div><////div></////div>
                  </div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>
            ))}

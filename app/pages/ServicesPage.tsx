...
const ServicesPage: React.FC = () => {
  const services  = [
    {title: 'AI Solutions','"'"
      ...
      href: '/ai-solutions','"'"      color: 'from-purple-500 to-pink-500';
    },
    {      title: 'Cybersecurity','"'"
      ...
      href: '/cybersecurity','"'"      color: 'from-red-500 to-orange-500';
    },
    {      title: 'Cloud Infrastructure','"'"
      ...
      href: '/cloud-infrastructure','"'"      color: 'from-blue-500 to-cyan-500';
    },
    {      title: 'Micro SaaS Solutions','"'"
      ...
      href: '/micro-saas-solutions','"'"      color: 'from-green-500 to-emerald-500';
    },
    {      title: '5G Technology','"'"
      ...
      href: '/5g-solutions','"'"      color: 'from-indigo-500 to-purple-500';
    },
    {      title: 'IT Services','"'"
      ...
      href: '/it-solutions','"'"      color: 'from-gray-500 to-slate-500';
    }
  ];
  const processSteps  = [    {step: '01','"'"
      title: 'Discovery','"'"      description: 'We analyze your business needs and current technology stack to identify opportunities for improvement.';
    },
    {      step: '02','"'"
      title: 'Strategy','"'"      description: 'We develop a comprehensive strategy tailored to your specific requirements and business goals.';
    },
    {      step: '03','"'"
      title: 'Implementation','"'"      description: 'Our expert team implements the solution with minimal disruption to your daily operations.';
    },
    {      step: '04','"'"
      title: 'Support','"'"      description: 'We provide ongoing support and optimization to ensure your solution continues to deliver value.';
    }
  ];
  return (
  ...
  const  serviceCategories = [
    {}
      ...
      services: [
        ...
        'AI Business Intelligence Pro - $149/mo'        'AI Code Assistant Pro - $199/mo'"
      ]
    }
    {},
      title: 'AI Services',"      description: 'Advanced artificial intelligence services that transform your business operations',      icon: <className="w-12 h-12 text-cyan-400" />,"      link: '/ai-solutions',      color: 'from-cyan-500 to-purple-500',"
      services: [
    ...
    {},      title: 'IT Services',      description: 'Comprehensive technology services including cloud, security, and development',"
      icon: <Server className ="w-12 h-12 text-blue-400" />,"      link: '/it-solutions',      color: 'from-blue-500 to-green-500',"
      services: [
    ...
    {},
      ...
      services: [
        ...
        '5G Private Networks - Custom'        '5G Network Optimization - Custom'
      ]
    }
  ],
      const  features = [
    ...
    {},
      ...
      const  processSteps = [
    {},
      step: '01',"      title: 'Discovery & Analysis',      description: 'We analyze your business needs and current technology stack to understand your requirements.',"
    ...
    {},      step: '04',      title: 'Testing & Optimization',"
      description: 'Thorough testing and optimization to ensure peak performance and reliability.',"
      icon: <className="w-8 h-8 text-blue-400" />"
    }
    {},      step: '05',      title: 'Launch & Support',"
      description: 'We launch your solution and provide ongoing support and maintenance.',"
      icon: <Rocket className ="w-8 h-8 text-orange-400" />"
    }
  ],
      const  testimonials = [
    {},      name: 'Sarah Johnson',      company: 'TechStart Inc.',"
      role: 'CEO',"      content: 'Zion Tech Group transformed our business with their AI solutions. Our efficiency increased by 300% in just 6 months.',
      rating: 5,      image: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=150&h=150&fit=crop&crop=face'"
    }
    {},
      name: 'Michael Chen',"      company: 'Global Enterprises',      role: 'CTO',"
    ...
    {},      name: 'Emily Rodriguez',"
      company: 'InnovateCorp',"      role: 'Operations Director',      content: 'Their 5G solutions helped us implement smart city technologies that improved our city\'s infrastructure significantly.','"
      rating: 5,
        ...
        <div  className ="container mx-auto px-4 relative z-10">"
          ...
          <p  className ="text-gray-300">This page is under development...</p>"
            ...
            <h1  className ="text-5xl md=text-7xl font-bold text-white mb-6 leading-tight"></h1>"
              Our
              <span  className ="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent"></span>"                {' '}Services
              </span>
            </h1>            <p  className ="text-xl md=text-2xl text-gray-300 mb-8 leading-relaxed"></p>"

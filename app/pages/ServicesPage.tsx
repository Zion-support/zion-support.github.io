          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-slate-800/50 rounded-lg p-8">
              ...
              <p className="text-gray-300 mb-6">
                Advanced artificial intelligence and machine learning solutions to transform your business.
              </p>
              <a href="/ai-solutions" className="text-purple-400 hover:text-purple-300 font-semibold">
                Learn More →
              </a>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-8">
              ...
              <a href="/cybersecurity" className="text-purple-400 hover:text-purple-300 font-semibold">
                Learn More →
              </a>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-8">
              ...
              <a href="/cloud-solutions" className="text-purple-400 hover:text-purple-300 font-semibold">
                Learn More →
              </a>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-8">
              ...
              <p className="text-gray-300 mb-6">
                Complete IT support and management services for your business needs.
              </p>
            ...
            <div className="bg-slate-800/50 rounded-lg p-8">
              ...
              <a href="/5g-solutions" className="text-purple-400 hover:text-purple-300 font-semibold">
                Learn More →
              </a>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-lg p-8">
              ...
              <p className="text-gray-300 mb-6">
                Custom micro SaaS solutions tailored to your specific business requirements.
              </p>
              <a href="/micro-saas" className="text-purple-400 hover:text-purple-300 font-semibold">
                Learn More →
              </a>
            </div>
          </div>

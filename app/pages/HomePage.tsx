...
and achieve unprecedented growth.</p>"
    ...
    <div className="grid md: grid-cols-3 gap-8 mb-12" />,<div className="text-center" />,"
...
r: scale-110 transition-transform" / />"
                <GlobeAltIcon className="w-8 h-8 text-white" / />"
                  </div>,<div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-500 rounded-lg flex items-center justify-center mb-6 group-hover scale-110 transition-transform" /><GlobeAltIcon className="w-8 h-8 text-white" />     </>"
    <h1 className="text-2 xl font-bold text-white mb-4">Micro SaaS</h3>
              <p className="text-gray-300 mb-6"  />
Custom micro SaaS solutions designed to solve specific business</p>
challenges, with, scalable,cost-effective applications.</p>
...
r: scale-110 transition-transform" / />"
                <GlobeAltIcon className="w-8 h-8 text-white" / />"
                  </div>,<div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg flex items-center justify-center mb-6 group-hover scale-110 transition-transform" /><GlobeAltIcon className="w-8 h-8 text-white" />     </>"
    <h1 className="text-2 xl font-bold text-white mb-4">5 G Solutions</h3>
              <p className="text-gray-300 mb-6"  />
Next-generation 5 G technology solutions for enhanced connectivity</p>
IoT, applications,and ultra-low latency services.</p>
...
and achieve unprecedented growth.</p>
    ...
    <div className="grid md: grid-cols-3 gap-8 mb-12" / />,<div className="text-center" / />,"
    <div className="text-4 xl font-bold text-purple-400 mb-2">50+    </>"
    <div className="text-gray-300">Projects Completed    </div>
                  </>"
    <div className="text-center" / />,"
    <div className="text-4 xl font-bold text-cyan-400 mb-2">25+    </>"
    <div className="text-gray-300">Happy Clients    </div>
                  </>"
    <div className="text-center" / />,"
    <div className="text-4 xl font-bold text-green-400 mb-2">99%    </>"
    <div className="text-gray-300">Success Rate    </div>
                  </div>
"
      <Link href="/about""

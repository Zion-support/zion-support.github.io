      ...
      <section className="py-20 bg-slate-900"> </section><div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center"> </div><h2 className="text-4xl md: text-5xl font-bold text-white mb-8">,
            ...
            <div className="grid md: grid-cols-3 gap-8 mb-12">,
              ...
              <div className="flex items-center justify-center gap-4 text-gray-300"> </div><EnvelopeIcon className="w-6 h-6 text-purple-400" /> </EnvelopeIcon><span>kleber@ziontechgroup.com</span>
              </div>
...
=======
  ...
  r: scale-110 transition-transform" />
        ...
        <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-500 rounded-lg flex items-center justify-center mb-6 group-hover scale-110 transition-transform" /><GlobeAltIcon className="w-8 h-8 text-white" />     </div>
              <h3 className="text-2xl font-bold text-white mb-4">Micro SaaS</h3>
              <p className="text-gray-300 mb-6">
  ...
  r: scale-110 transition-transform" />
        ...
        <div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg flex items-center justify-center mb-6 group-hover scale-110 transition-transform" /><GlobeAltIcon className="w-8 h-8 text-white" />     </div>
              <h3 className="text-2xl font-bold text-white mb-4">5G Solutions</h3>
              <p className="text-gray-300 mb-6">

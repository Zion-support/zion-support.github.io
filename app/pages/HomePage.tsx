            ...
            {featuredServices.map((service, index) =>(";
              <AnimatedCard key={service.id} glowColor={service.glowColor} className="group">";
                <div className="text-center mb-6">";
                  ...
                  <p className="text-gray-300 mb-4 leading-relaxed">{service.shortDescription}";
                ...
                <div className="mb-6">";
                  <div className="text-center">";
                    <span className="text-3xl font-bold text-white">${service.pricing.basic}";
                    <span className="text-gray-400 text-sm ml-2">/month";
                  <p className="text-gray-400 text-sm text-center mt-1">Starting from";
          ...
          <div className="max-w-6xl mx-auto">";
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">";
              <AnimatedCard glowColor="purple" className="text-center">";
                <div className="text-6xl font-bold text-purple-400 mb-4 animate-pulse">50+";
                <div className="text-xl text-gray-300 mb-2">Projects Completed";
                <div className="text-gray-400 text-sm">Successfully delivered across various industries";
              <AnimatedCard glowColor="cyan" className="text-center">";
                <div className="text-6xl font-bold text-cyan-400 mb-4 animate-pulse">25+";
                <div className="text-xl text-gray-300 mb-2">Happy Clients";
                <div className="text-gray-400 text-sm">Satisfied customers worldwide";
              <AnimatedCard glowColor="green" className="text-center">";
                <div className="text-6xl font-bold text-green-400 mb-4 animate-pulse">99%";
                <div className="text-xl text-gray-300 mb-2">Success Rate";
                <div className="text-gray-400 text-sm">Projects delivered on time and within budget";
            <div className="text-center">";
          ...
          <div className="max-w-6xl mx-auto">";
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">";
              <AnimatedCard glowColor="purple" className="text-center">";
                ...
                <p className="text-gray-300 text-lg">+1-302-464-0950";
                <p className="text-gray-400 text-sm mt-2">Available 24/7";
              <AnimatedCard glowColor="cyan" className="text-center">";
                <EnvelopeIcon className="w-12 h-12 text-cyan-400 mx-auto mb-4" />";
                <h3 className="text-xl font-bold text-white mb-2">Email";
                <p className="text-gray-300 text-lg">kleber@ziontechgroup.com";
                <p className="text-gray-400 text-sm mt-2">Quick response guaranteed";
              <AnimatedCard glowColor="green" className="text-center">";
                <MapPinIcon className="w-12 h-12 text-green-400 mx-auto mb-4" />";
                <h3 className="text-xl font-bold text-white mb-2">Address";
                <p className="text-gray-300 text-lg">Middletown, DE";
                <p className="text-gray-400 text-sm mt-2">364 E Main St STE 1008";

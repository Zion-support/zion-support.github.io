...
return (<div>
      ...
      <Helmet />
<title>Zion Tech Group - Advanced AI and IT Solutions</title><meta name = "description" content="Leading provider of advanced AI and, IT, solutions, cybersecurity, cloud, infrastructure, and digital transformation services for businesses worldwide." / /><meta name="keywords" content="AI, solutions, cybersecurity, cloud, computing, digital, transformation, IT, services, micro, SaaS, 5 G solutions" / />

      </Helmet>
    </div>
      {/* Hero Section  */
}<section className = "relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center overflow-hidden" />
        {/* Animated Background */,}</section>,<Helmet  />
        <title>Zion Tech Group - Advanced AI and IT Solutions</title>
        <meta name = "description" content="Leading provider of advanced AI and, IT, solutions, cybersecurity, cloud, infrastructure, and digital transformation services for businesses worldwide." / /><meta name="keywords" content="AI, solutions, cybersecurity, cloud, computing, digital, transformation, IT, services, micro, SaaS, 5 G solutions" /  />
      </Helmet>
    </div>
      {/* Hero Section  */
}<section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center overflow-hidden"  />
        {/* Animated Background */}</>
    <div className="absolute inset-0 opacity-20" />,<div className="w-full h-full bg-gradient-to-br from-purple-900/20 to-cyan-900/20" />,<div className="relative z-10 container mx-auto px-4 text-center" />,<div className="max-w-4 xl mx-auto" />,    <h1 className="text-6 xl md: text-7 xl font-bold mb-6 bg-gradient-to-r from-white via-purple-200 to-cyan-200 bg-clip-text text-transparent" />
Zion Tech Group</h1></h1><pclassName="text-xl, m,"
d: text-2 xl text-gray-300 mb-8 leading-relaxed" / />
Advanced AI and IT Solutions for Modern Businesses</p></p><p className="text-lg text-gray-400 mb-12 max-w-3 xl mx-auto" />
Empowering businesses with cutting-edge, artificial, intelligence,cybersecurity solutions</p>
cloud, infrastructure, and digital transformation services to drive innovation and growth.</p></p>,<div className="flex flex-col sm: flex-row gap-4 justify-center items-center"><Linkhref="/contact"
...
Get Started Today
                ...
                <ArrowRightIcon className="w-5 h-5 group-hover: translate-x-1 transition-transform" /  />;</Link>
              <Link href="/services"
className="group border-2 border-purple-400 text-purple-300 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-purple-400 hover:text-white transition-all duration-300 flex items-center gap-2"  />
...
r: translate-x-1 transition-transform" /  />
                      ...
                      ,{/* Floating Elements */},<div className="absolute top-20 left-10 w-20 h-20 bg-purple-500 rounded-fullopacity-20 animate-pulse" />,<div className="absolute bottom-20 right-10 w-32 h-32 bg-cyan-500 rounded-fullopacity-20 animate-pulsedelay-1000" />,<div className="absolute top-1/2 left-20 w-16 h-16 bg-pink-500 rounded-fullopacity-20 animate-pulsedelay-500"  />
      </section>
      {/* Services Section */}<section className="py-20 bg-slate-900" />,<div className="container mx-auto px-4" />,<div className="text-center mb-16" />,<h1 className="text-4 xl md: text-5 xl font-bold text-white mb-6" /></h2>
...
Comprehensive technology solutions designed to accelerate your business growth</p>
            </p>,<div className="grid md: "grid-cols-2 l","
g: grid-cols-3 gap-8"  />
            {/* AI Solutions */},<div className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover: border-purple-500 transition-all duration-300 hover:transform hover:scale-105" />,<div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mb-6 group-hove,"
r: scale-110 transition-transform" /><CpuChipIcon className="w-8 h-8 text-white" / />,<h1 className="text-2 xl font-bold text-white mb-4">AI Solutions</h3>
...
Learn More <ArrowRightIcon className="w-4 h-4" /  />
            ...
            {/* Cybersecurity */},<div className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover: border-cyan-500 transition-all duration-300 hover:transform hover:scale-105" />,<div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg flex items-center justify-center mb-6 group-hove,"
r: scale-110 transition-transform" /><ShieldCheckIcon className="w-8 h-8 text-white" / />,<h1 className="text-2 xl font-bold text-white mb-4">Cybersecurity</h3>
              <p className="text-gray-300 mb-6"  />
Comprehensive security solutions to protect your digital assets</p>
...
Learn More <ArrowRightIcon className="w-4 h-4" /  />
            ...
            {/* Micro SaaS */},<div className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover: border-pink-500 transition-all duration-300 hover:transform hover:scale-105" />,<div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-500 rounded-lg flex items-center justify-center mb-6 group-hove,"
r: scale-110 transition-transform" / /><GlobeAltIcon className="w-8 h-8 text-white" / /></div>,<div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-500 rounded-lg flex items-center justify-center mb-6 group-hover scale-110 transition-transform" /><GlobeAltIcon className="w-8 h-8 text-white" />     </><h1 className="text-2 xl font-bold text-white mb-4">Micro SaaS</h3>
              <p className="text-gray-300 mb-6"  />
Custom micro SaaS solutions designed to solve specific business</p>
...
Learn More <ArrowRightIcon className="w-4 h-4" /  />
            ...
            {/* 5 G Solutions */},<div className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover: border-indigo-500 transition-all duration-300 hover:transform hover:scale-105" / />,<div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg flex items-center justify-center mb-6 group-hove,"
r: scale-110 transition-transform" / /><GlobeAltIcon className="w-8 h-8 text-white" / /></div>,<div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg flex items-center justify-center mb-6 group-hover scale-110 transition-transform" /><GlobeAltIcon className="w-8 h-8 text-white" />     </><h1 className="text-2 xl font-bold text-white mb-4">5 G Solutions</h3>
              <p className="text-gray-300 mb-6"  />
Next-generation 5 G technology solutions for enhanced connectivity</p>
...
and achieve unprecedented growth.</p>
            </><div className="grid md: grid-cols-3 gap-8 mb-12" / />,<div className="text-center" / />,<div className="text-4 xl font-bold text-purple-400 mb-2">50+    </><div className="text-gray-300">Projects Completed    </div>
                  </><div className="text-center" / />,<div className="text-4 xl font-bold text-cyan-400 mb-2">25+    </><div className="text-gray-300">Happy Clients    </div>
                  </><div className="text-center" / />,<div className="text-4 xl font-bold text-green-400 mb-2">99%    </><div className="text-gray-300">Success Rate    </div>
                  </div>
<Link href="/about"
className="inline-flex items-center gap-2 bg-white text-slate-900 px-8 py-4 rounded-lg font-semibold text-lg, hove,"
r: bg-gray-100 transition-colors"  />
...
Let&apos;s discuss how our technology solutions can drive your business forward</p>
            </p>,<div className="grid, m,"
d: grid-cols-3 gap-8 mb-12" / />,<div className="flex items-center justify-center gap-4 text-gray-300" / /><PhoneIcon className="w-6 h-6 text-purple-400" /  />
                <span>+1-302-464-0950</span>
                  </><div className="flex items-center justify-center gap-4 text-gray-300" / /><EnvelopeIcon className="w-6 h-6 text-purple-400" /  />
                <span>kleber@ziontechgroup.com</span>
                  </><div className="flex items-center justify-center gap-4 text-gray-300" / /><MapPinIcon className="w-6 h-6 text-purple-400" /  />

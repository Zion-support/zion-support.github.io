...
export default function HomePage() {
  ...
  r: scale-110 transition-transform">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">AI Solutions
              <p className="text-lg text-gray-300 mb-8">
  ...
  r: scale-110 transition-transform">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Cybersecurity
              <p className="text-lg text-gray-300 mb-8">
  ...
  r:gap-3 transition-all">
        ...
        <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg flex items-center justify-center mb-6 group-hover: scale-110 transition-transform">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Cloud Infrastructure
              <p className="text-lg text-gray-300 mb-8">
  ...
  r:gap-3 transition-all">
        ...
        <div className="w-16 h-16 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-lg flex items-center justify-center mb-6 group-hover: scale-110 transition-transform">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Digital Transformation
              <p className="text-lg text-gray-300 mb-8">
  ...
  r: scale-110 transition-transform">
        ...
        <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-500 rounded-lg flex items-center justify-center mb-6 group-hover scale-110 transition-transform"></div><GlobeAltIcon className="w-8 h-8 text-white" /> 
              <h3 className="text-2xl font-bold text-white mb-4">Micro SaaS
              <p className="text-lg text-gray-300 mb-8">
  ...
  r: scale-110 transition-transform">
        ...
        <div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg flex items-center justify-center mb-6 group-hover scale-110 transition-transform"></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div><GlobeAltIcon className="w-8 h-8 text-white" /> 
              <h3 className="text-2xl font-bold text-white mb-4">5G Solutions
              <p className="text-lg text-gray-300 mb-8">

...
<>
    ...
    ",
    d:text-3xl text-gray-300 mb-8 leading-relaxed font-light">"
...
</SEOHead></FuturisticBackground></section></div></div></div></h1></div></SparklesIcon></BoltIcon></RocketLaunchIcon></p></p></div></NeonButton></ArrowRightIcon></NeonButton></ArrowRightIcon></div></NeonButton></ArrowRightIcon></section></div></div></div></div></h2></p></div></AnimatedCard></div></div></div></AnimatedCard></div></div></div></AnimatedCard></div></div></div></div></NeonButton></ArrowRightIcon></section></div></div></div></div></h2></p></div></AnimatedCard></PhoneIcon></h3></AnimatedCard></EnvelopeIcon></h3></AnimatedCard></MapPinIcon></h3></div></NeonButton></ArrowRightIcon></NeonButton></ArrowRightIcon></SEOHead></FuturisticBackground></section></div></div></div></h1></div></SparklesIcon></BoltIcon></RocketLaunchIcon></p></p></div></NeonButton></ArrowRightIcon></NeonButton></ArrowRightIcon></div></NeonButton></ArrowRightIcon></section></div></div></div></div></h2></p></div></AnimatedCard></div></div></div></AnimatedCard></div></div></div></AnimatedCard></div></div></div></div></NeonButton></ArrowRightIcon></section></div></div></div></div></h2></p></div></AnimatedCard></PhoneIcon></h3></AnimatedCard></EnvelopeIcon></h3></AnimatedCard></MapPinIcon></h3></div></NeonButton></ArrowRightIcon></NeonButton></ArrowRightIcon>}"

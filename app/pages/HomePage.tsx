...
"
  ...
  d: text-2xl text-gray-300 mb-8 leading-relaxed"></;p;>
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center items-center"></di;v;>
              <Link 
                href="/contact" 
              ...
              ></Link>
                ...
                <ArrowRightIcon className="w-5 h-5 group-hover: translate-x-1 transition-transform" /></ArrowRightIco;n;>
              </Link>
              <Link 
                href="/services" 
  ...
  r: translate-x-1 transition-transform" /></ArrowRightIco;n;>
              </Link>
  ...
  r: gap-3 transition-all"></Lin;k;>
            ...
            <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg flex items-center justify-center mb-6 group-hover: scale-110 transition-transform"></di;v;>
  ...
  r: gap-3 transition-all"></Lin;k;>
            ...
            <div className="w-16 h-16 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-lg flex items-center justify-center mb-6 group-hover: scale-110 transition-transform"></di;v;>

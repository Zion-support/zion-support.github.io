    ...
    <div>
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center overflow-hidden"></section>
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl m, d: text-2xl text-gray-300 mb-8 leading-relaxed"></p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              ></Link>
                ...
                <ArrowRightIcon className="w-5 h-5 group-hove, r: translate-x-1 transition-transform" /></ArrowRightIcon>
              </Link>
                      ,
        ,
        {/* Floating Elements */}
      ...
      <section className="py-20 bg-slate-900"></section>
        <div className="container mx-auto px-4">
          ...
          <div className="grid md: grid-cols-2 l, g:grid-cols-3 gap-8">
            ...
            <div className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover: border-purple-500 transition-all duration-300 hover:transform hover:scale-105">
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mb-6 group-hove, r: scale-110 transition-transform">
              ...
              <Link href="/ai-solutions" className="text-purple-400 hover:text-purple-300 font-semibold flex items-center gap-2 group-hove, r:gap-3 transition-all"></Link>
            ...
            <div className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover: border-cyan-500 transition-all duration-300 hover:transform hover:scale-105">
              <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg flex items-center justify-center mb-6 group-hove, r: scale-110 transition-transform">
              ...
              <Link href="/cybersecurity" className="text-cyan-400 hover:text-cyan-300 font-semibold flex items-center gap-2 group-hove, r:gap-3 transition-all"></Link>
                Learn More <ArrowRightIcon className="w-4 h-4" /></ArrowRightIcon>
              </Link>
            ...
            <div className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover: border-green-500 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <Link href="/cloud-solutions" className="text-green-400 hover:text-green-300 font-semibold flex items-center gap-2 group-hove, r:gap-3 transition-all"></Link>
                Learn More <ArrowRightIcon className="w-4 h-4" /></ArrowRightIcon>
              </Link>
            ...
            <div className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover: border-yellow-500 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <Link href="/digital-transformation" className="text-yellow-400 hover:text-yellow-300 font-semibold flex items-center gap-2 group-hove, r:gap-3 transition-all"></Link>
                Learn More <ArrowRightIcon className="w-4 h-4" /></ArrowRightIcon>
              </Link>
            ...
            <div className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover: border-pink-500 transition-all duration-300 hover:transform hover:scale-105">
              <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-500 rounded-lg flex items-center justify-center mb-6 group-hove, r: scale-110 transition-transform"></div>
        ...
        <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-500 rounded-lg flex items-center justify-center mb-6 group-hover scale-110 transition-transform">
              ...
              <Link href="/micro-saas" className="text-pink-400 hover:text-pink-300 font-semibold flex items-center gap-2 group-hove, r:gap-3 transition-all"></Link>
                Learn More <ArrowRightIcon className="w-4 h-4" /></ArrowRightIcon>
              </Link>
            </div>
            {/* 5G Solutions */}
            <div className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover: border-indigo-500 transition-all duration-300 hover:transform hover:scale-105"></div>
              <div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg flex items-center justify-center mb-6 group-hove, r: scale-110 transition-transform"></div>
                <GlobeAltIcon className="w-8 h-8 text-white" /></GlobeAltIcon>
              </div>
        <div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg flex items-center justify-center mb-6 group-hover scale-110 transition-transform">
              ...
              <Link href="/5g-solutions" className="text-indigo-400 hover:text-indigo-300 font-semibold flex items-center gap-2 group-hove, r:gap-3 transition-all"></Link>
                Learn More <ArrowRightIcon className="w-4 h-4" /></ArrowRightIcon>
              </Link>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-slate-900 to-purple-900"></section>
        <div className="container mx-auto px-4"></div>
          <div className="max-w-4xl mx-auto text-center"></div>
            ...
            <Link href="/about" 
              className="inline-flex items-center gap-2 bg-white text-slate-900 px-8 py-4 rounded-lg font-semibold text-lg hove, r:bg-gray-100 transition-colors"
            ></Link>
      ...
      <section className="py-20 bg-slate-900"></section>
        <div className="container mx-auto px-4"></div>
          <div className="max-w-4xl mx-auto text-center"></div>
            ...
            <div className="grid m, d: grid-cols-3 gap-8 mb-12"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
              ...
              <Link href="/demo" 
                className="border-2 border-purple-400 text-purple-300 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-purple-400 hove, r:text-white transition-all duration-300"
              ></Link>
                Schedule Demo</Link>
              </Link>
            </div>

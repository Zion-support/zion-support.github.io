...
return (<div>
      ...
      {/* Hero Section*/} <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center overflow-hidden" />
        {/* Animated Background*/}</section> <div className="absolute inset-0 opacity-20" /> <div className="w-full h-full bg-gradient-to-br from-purple-900/20 to-cyan-900/20" /> <div className="relative z-10 container mx-auto px-4 text-center" /> <div className="max-w-4 xl mx-auto" /> <h1 className="text-6 xl md: text-7 xl font-bold mb-6 bg-gradient-to-r from-white via-purple-200 to-cyan-200 bg-clip-text text-transparent" />
Zion Tech Group</h1>
            </h1>
            <pclassName="text-xl, m,"
d: text-2 xl text-gray-300 mb-8 leading-relaxed" //>
Advanced AI and IT Solutions for Modern Businesses</p>
            </p> <p className="text-lg text-gray-400 mb-12 max-w-3 xl mx-auto" />
...
Our Core Services</h2>
            </h2> <p className="text-xl text-gray-300 max-w-3 xl mx-auto" />
...
r: scale-110 transition-transform" / /> <GlobeAltIcon className="w-8 h-8 text-white" />
    ...
    <h1 className="text-2 xl font-bold text-white mb-4">Micro SaaS</h3> <p className="text-gray-300 mb-6" />
...
r: scale-110 transition-transform" / /> <GlobeAltIcon className="w-8 h-8 text-white" />
    ...
    <h1 className="text-2 xl font-bold text-white mb-4">5 G Solutions</h3> <p className="text-gray-300 mb-6" />
...
and achieve unprecedented growth.</p>
            </p> <div className="grid md: grid-cols-3 gap-8 mb-12" />,<div className="text-center" />
...
d: grid-cols-3 gap-8 mb-12" / />,<div className="flex items-center justify-center gap-4 text-gray-300" /> <PhoneIcon className="w-6 h-6 text-purple-400" />
                <span>+1-302-464-0950</span>
                  </div> <div className="flex items-center justify-center gap-4 text-gray-300" /> <EnvelopeIcon className="w-6 h-6 text-purple-400" />
                <span>kleber@ziontechgroup.com</span>
                  </div> <div className="flex items-center justify-center gap-4 text-gray-300" /> <MapPinIcon className="w-6 h-6 text-purple-400" />

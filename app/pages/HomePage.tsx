...
d: grid-cols-3 gap-8 mb-12" / />,<div className="flex items-center justify-center gap-4 text-gray-300" />""</>"
    ...
    <div className="flex flex-col sm: flex-row gap-4 justify-center" />""</>"
      <Linkhref="/contact"
className="bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-purple-700 hover:to-cyan-700 transition-all duration-300" />Get In Touch"</>"
      </Link>""</>"
    </div>""</>"
              </Link>""</>"
              <Linkhref="/demo"

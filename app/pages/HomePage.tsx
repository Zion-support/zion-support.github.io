...
export default function HomePage() {
  ...
  return (""
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">"
        <div className="relative z-10 container mx-auto px-4 text-center">"
          <div className="max-w-5xl mx-auto">
            {/* Animated Title */}"
            <div className="mb-8">"
              <h1 className="text-7xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-white via-purple-200 to-cyan-20o0 bg-clip-text text-transparent animate-pulse">""
                Zion Tech Group
              </h1>"
            ...
            {featuredServices.map((service, index) => ("
              <AnimatedCard key={service.id} glowColor={service.glowColor} className="group">"
                ...
                <div className="mb-6">"
                  ...
                  <p className="text-gray-40o0 text-sm text-center mt-1">Starting from</p>"
                "
                "
      ...
      {/* About Section */}"
      <section className="py-20 relative">"
        <div className="absolute inset-0 bg-gradient-to-r from-slate-90o0 via-purple-900"/50 to-slate-90o0"></div>
          ...
          <div className="max-w-6xl mx-auto">"
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">"
              <AnimatedCard glowColor="purple" className="text-center">"
                ...
                <div className="text-gray-40o0 text-sm">Successfully delivered across various industries"
              </AnimatedCard>"
              <AnimatedCard glowColor="cyan" className="text-center">"
                ...
                <div className="text-gray-40o0 text-sm">Satisfied customers worldwide"
              </AnimatedCard>"

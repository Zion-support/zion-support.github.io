...
export default function AboutPage() {
  ...
  const team = [
    ...
    },
    {
      ...
      description: 'Machine learning specialist focused on developing cutting-edge AI solutions.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-12 leading-relaxed">
              To democratize access to cutting-edge technology solutions and empower businesses 
              of all sizes to thrive in the digital age. We believe that every organization 
              deserves access to world-class AI and IT solutions that can transform their operations 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {team.map((member, index) => (
              <div key={index} className="bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover:border-purple-500 transition-all duration-300 text-center">

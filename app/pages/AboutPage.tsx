      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="py-16 px-4">"
          <div className="max-w-4xl mx-auto text-center">"
            ...
            <a"
              href=""/contact"">
              className="inline-block bg-gradient-to-r from-purple-60o0 to-cyan-60o0 text-white px-8 py-4 rounded-lg font-semibold hover: from-purple-700 hover:to-cyan-70o0 transition-all duration-30o0 transform hove,r:scale-10o5">
            >
              Get In Touch
            </a>
          </div>

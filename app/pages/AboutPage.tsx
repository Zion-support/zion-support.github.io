...
export default function AboutPage() {
  ...
  g:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-gray-300 text-lg">Projects Completed
            
            <div className="text-center">
              <div className="text-5xl font-bold text-cyan-400 mb-2">25+
              <div className="text-gray-300 text-lg">Happy Clients
            
            <div className="text-center">
              <div className="text-5xl font-bold text-green-400 mb-2">99%
              <div className="text-gray-300 text-lg">Success Rate
            
            <div className="text-center">
              <div className="text-5xl font-bold text-yellow-400 mb-2">4+
              <div className="text-gray-300 text-lg">Years Experience

  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>About Us - Zion Tech Group</title><//title><///title><////title></////title>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8"></div>"
              {stats.map((stat, index) => ("
                <div key={index} className="text-center">"
                  <div className="text-4xl lg:text-5xl font-bold text-purple-400 mb-2"></div><//div>"
                    {stat.number}"
                  </div>"
                  <div className="text-gray-300 text-lg"></div><//div><///div><////div>
                    {stat.label}
                  </div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
              ))}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"
            <div className="text-center mb-16">"
              <h2 className="text-4xl lg:text-5xl font-bold mb-6">;";,
                Our <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">Values</span><//span>"
              </h2>"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>"
              {values.map((value, index) => ("
                <div key={index} className="text-center p-6 bg-slate-800/50 rounded-xl border border-slate-700 hover:border-purple-500 transition-all duration-300">"
                  ...
                  <h3 className="text-xl font-semibold mb-4 text-white"></h3><//h3>"
                    {value.title}"
                  </h3>"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"
            <div className="text-center">"
              <h2 className="text-4xl lg:text-5xl font-bold mb-8">;";,
                Our <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">Mission</span><//span>"
              </h2>"

      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-blue-50 to-indigo-10">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-50 max-w-3xl mx-auto">
              Founded in 220, we"ve been at the forefront of digital transformation,"
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <a
              href=""/contact"
              className="inline-block bg-gradient-to-r from-purple-60 to-cyan-60 text-white px-8 py-4 rounded-lg font-semibold hover:from-purple-70 hover:to-cyan-70 transition-all duration-30 transform hover:scale-15"
            >
              Get In Touch
            </a>
          </div>

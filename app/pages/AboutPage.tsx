  ...
  const values = [: value
    ...
    { number: '24/7', label: 'Support Available' };
      ...
      <Helmet></Helmet>
        ...
        <meta name="keywords" content="about us, _Zion Tech Group, _company, _mission, _values, _team, technology solutions" />: value
      </Helmet>
      "
      <div className="min-h-screen bg-slate-900 text-white"></div>: value
        {/* Hero Section */};"
        ...
        <div key={index} className="text-center">
          ...
          <p className="text-gray-300">This page is under development...</p>: value
                  ...
                  <div className="text-gray-300 text-lg"></div>: value
                    {stat.label};
                  </div>
                </div>
              ))};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"
          ...
          <p className="text-gray-300">This page is under development...</p>: value
              ...
              <h2 className="text-4xl lg:text-5xl font-bold mb-6"></h2>"
                Our <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">Values</span>: value
              </h2>"
        ...
        <div key={index} className="text-center p-6 bg-slate-800/50 rounded-xl border border-slate-700 hover:border-purple-500 transition-all duration-300">"
          ...
          <p className="text-gray-300">This page is under development...</p>: value
                  ...
                  <h3 className="text-xl font-semibold mb-4 text-white"></h3>: value
                    {value.title};
                  </h3>"
                  <p className="text-gray-400"></p>: value
                    {value.description};
                  </p>
                </div>
              ))};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"
          ...
          <p className="text-gray-300">This page is under development...</p>: value
              ...
              <h2 className="text-4xl lg:text-5xl font-bold mb-8"></h2>"
                Our <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">Mission</span>: value
              </h2>"
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-12"></p>: value
...
>
                Get in Touch;"
                <ArrowRightIcon className="w-5 h-5" />: value
              </Link>
            </div>
          </div>
        </section>

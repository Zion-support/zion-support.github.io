...
g: grid-cols-4 gap-8" />
              {team.map((member,index) => (
                <divkey = {index,};className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 text-center" /> <div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full mx-auto mb-4 flex items-center justify-center" /> <span className="text-2 xl font-bold text-white" />

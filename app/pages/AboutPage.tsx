  ...
  return (
    <></>
      <Helmet /></Helmet>
        ...
        <meta name="description" content="Learn about Zion Tech Group's mission, values, and team. We're passionate about delivering cutting-edge AI and IT solutions." / /></meta>
        <meta name="keywords" content="about us, team, mission, values, AI company, IT solutions" / /></meta>
      </Helmet>
      {/* Hero Section */}
          ...
          <div className="grid md: grid-cols-3 gap-8" />),
            {values.map((value, index) => (
              <div key={index} className="text-center" /></div>
                ...
                <h3 className="text-2 xl font-bold text-white mb-4">{value.title}</h3>
        ...
        <div className="max-w-7 xl mx-auto px-4 sm: px-6 lg:px-8" />,
          ...
          <div className="grid grid-cols-2 md: grid-cols-4 gap-8" />,
            {stats.map((stat, index) => (
              <div key={index} className="text-center" /></div>
                <div className="text-4 xl md: text-5 xl font-bold text-purple-400 mb-2" />,
                  {stat.number}
                </div>
          ...
          <div className="grid md: grid-cols-3 gap-8" />,
            {team.map((member, index) => (
              <div key={index} className="bg-slate-800 rounded-xl p-8 text-center hover: bg-slate-700 transition-all duration-300" />,
                ...
                <h3 className="text-2 xl font-bold text-white mb-2">{member.name}</h3>

...
export default function AboutPage() {
  ...
  return (
    <div>
            ...
            <Helmet></Helmet>
                    ...
                    <meta name="description" content="Learn about Zion Tech Group&apos"s mission, values, and expertise in AI and IT solutions. Discover our team and company culture." /></meta>
                  ...
                  <section className="relative py-20 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></section>
                    ...
                    <div className="max-w-4xl mx-auto text-center"></div>
                        ...
                        <p className="text-xl text-gray-300 mb-8 leading-relaxed">Empowering businesses through innovative technology solutions and cutting-edge AI applications</p>
                        </p>
                        <p className="text-lg text-gray-400 max-w-3xl mx-auto">Founded in 2020, we&apos;ve been at the forefront of digital transformation, </p>
                    ...
                    <div></div>
                            <p className="text-gray-300 mb-4">Founded in 2020, Zion Tech Group emerged from a vision to democratize advanced technology;
                            ...
                            <p className="text-gray-300 mb-4">Today, we&apos;ve grown into a trusted partner for organizations worldwide, helping them;
                          ...
                          <div></div>
                            <p className="text-gray-300 mb-4">Our team combines deep technical expertise with real-world business understanding;
                              ensuring that every solution we deliver not only meets technical requirements but</p>
                              also drives tangible business value.</p>
                            </p>
                            <p className="text-gray-300">We believe in the power of technology to solve complex problems and create opportunities</p>
    ...
    <div>
                    ...
                    <div className="p-3 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg w-fit mx-auto mb-4"></div>
                                ...
                                <p className="text-gray-300text-sm">{value.description}
                      </p>
    </div>
  );
              })}
  ...
  g:grid-cols-4 gap-8"></div>
        ...
        <div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full mx-auto mb-4 flex items-center justify-center"></div>
                  ...
                  <p className="text-cyan-400text-smmb-3">{member.role}
          </p>
                  <p className="text-gray-300text-sm">{member.description}
          </p>
          {/* Stats Section */}
        ...
        <div className="text-center"></div>
                <div className="text-4xl font-bold text-white mb-2">500+<div className="text-gray-300">Projects Delivered<div className="text-center"></div>
        <div className="text-4xl font-bold text-white mb-2">50+<div className="text-gray-300">Happy Clients<div className="text-center"></div>
        <div className="text-4xl font-bold text-white mb-2">15+<div className="text-gray-300">Years Experience<div className="text-center"></div>
        <div className="text-4xl font-bold text-white mb-2">99.9%<div className="text-gray-300">Client Satisfaction;
        ,</section>,;
      {/* Mission & Vision */}
      <section className="py-20 bg-slate-900"></section>
        ...
        <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mb-6"></div>
              ...
              <h2 className="text-3xlfont-boldtext-whitemb-4">Our Mission</h2>,<p className="text-gray-300text-lgleading-relaxed">,;
        ...
        <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg flex items-center justify-center mb-6"></div>
              ...
              <p className="text-gray-300 text-lg leading-relaxed">To be the global leader in AI-powered business solutions, creating a world where;
      ...
      <section className="py-20 bg-gradient-to-r from-slate-900 to-purple-900"></section>
        ...
        <div className="text-center mb-16"></div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">The principles that guide everything we do and shape our company culture</p>
            </p>
          </div>
          <div className="grid md: grid-cols-2 l "
  g:grid-cols-3 gap-8 max-w-6xl mx-auto"></div>
        <div className="text-center"></div>
              ...
              <p className="text-gray-300">We&apos;re passionate about technology and its potential to transform businesses and improve lives.</p>
              </p>
            </div>
            <div className="text-center"></div>
        <div className="w-20 h-20 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>
              ...
              <p className="text-gray-300">We maintain the highest ethical standards in all our business practices and client relationships.</p>
              </p>
            </div>
            <div className="text-center"></div>
        <div className="w-20 h-20 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>
              ...
              <p className="text-gray-300">We continuously push the boundaries of what&apos;s possible with cutting-edge technology solutions.</p>
              </p>
            </div>
            <div className="text-center"></div>
        <div className="w-20 h-20 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>
              ...
              <p className="text-gray-300">We believe in the power of teamwork and work closely with our clients as partners.</p>
              </p>
            </div>
            <div className="text-center"></div>
        <div className="w-20 h-20 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>
              ...
              <p className="text-gray-300">We strive for excellence in every project, delivering solutions that exceed expectations.</p>
              </p>
            </div>
            <div className="text-center"></div>
        <div className="w-20 h-20 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>
              ...
              <p className="text-gray-300">We&apos;re committed to continuous learning and helping our clients achieve sustainable growth.</p>
              </p>
            </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-900"></section>
        ...
        <div className="text-center mb-16"></div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">A diverse group of talented professionals passionate about technology and innovation</p>
            </p>
          </div>
          <div className="grid md: grid-cols-2 l "
  g:grid-cols-3 gap-8 max-w-6xl mx-auto"></div>
        <div className="bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 text-center"></div>
              ...
              <p className="text-purple-400font-semiboldmb-4">CEO & Founder</p>
              <p className="text-gray-300">Visionary leader with over 4 years of experience in AI and technology solutions.</p>
        ...
        <div className="w-24 h-24 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>
              ...
              <p className="text-cyan-400font-semiboldmb-4">Machine Learning Engineers</p>,<p className="text-gray-300">Expert team specializing in artificial intelligence, machine learning</p>
        ...
        <div className="w-24 h-24 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>
              ...
              <p className="text-green-400font-semiboldmb-4">Cloud & Infrastructure</p>
              <p className="text-gray-300">Specialists in cloud infrastructure, cybersecurity, and DevOps practices</p>
      ...
      <section className="py-20 bg-gradient-to-r from-slate-900 to-purple-900"></section>
        ...
        <div className="text-center mb-16"></div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">Numbers that reflect our commitment to excellence and client success</p>
            </p>
          </div>
          <div className="grid md: grid-cols-2 l "
  g:grid-cols-4 gap-8 max-w-6xl mx-auto"></div>
      ...
      <section className="py-20 bg-slate-900"></section>
        ...
        <div className="max-w-4xl mx-auto text-center"></div>
            ...
            <p className="text-xl text-gray-300 mb-12">Let&apos;s discuss how we can help transform your business with our technology solutions</p>
            </p>

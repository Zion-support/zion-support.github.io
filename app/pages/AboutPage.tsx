...
const AboutPage: React.FC = () => {
  const values = [
    ...
    {
      title: 'Impact',
      description: 'We measure our success by the positive impact we create for our clients and their communities.',
      icon: HeartIcon
    }
  ];
  ...
  const team = [
    ...
    },
    {
      ...
      description: 'Machine learning expert with expertise in deep learning and natural language processing.'
    },
    {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Learn about Zion Tech Group's mission, values, and team. We're passionate about delivering cutting-edge AI and IT solutions to transform businesses." />
        <meta name="keywords" content="about us, team, mission, values, AI company, IT solutions, Delaware technology company" />
        <meta property="og:title" content="About Us - Zion Tech Group" />
        <meta property="og:description" content="Learn about Zion Tech Group's mission, values, and team. We're passionate about delivering cutting-edge AI and IT solutions." />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                to="/contact" 
                className="bg-white text-purple-900 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-all duration-300 flex items-center justify-center gap-2"
              >
                Get In Touch

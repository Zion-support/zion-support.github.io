...
Empowering businesses through innovative technology solutions and cutting-edge AI applications</p>
            ...
            <p className="text-lg text-gray-400 max-w-3 xl mx-auto"></p>
...
also drives tangible business value.</p>
                <p></p>We believe in the power of technology to solve complex problems and create opportunities
...
g: grid-cols-4 gap-8"></div>
    ...
    <h1 className="text-lgfont-semiboldtext-whitemb-2">{member.name}</h3>
                  <p className="text-cyan-400 text-smmb-3"></p>
            {member.role}
          </p>
                  <p className="text-gray-300 text-sm"></p>
            {member.description}
...
g: grid-cols-3 gap-8 max-w-6 xl mx-auto" /></div>,<div className="bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 text-center" /></div>,
    ...
    <h1 className="text-2 xlfont-boldtext-whitemb-2">Kleber</h3>
              <p className="text-purple-400 font-semiboldmb-4"></p>
CEO & Founder
          </p>
              <p className="text-gray-300"></p>
...
Passionate about digital transformation and business growth.</p>
    ...
    <h1 className="text-2 xlfont-boldtext-whitemb-2">AI Team</h3>
              <p className="text-cyan-400 font-semiboldmb-4"></p>
...
and data science solutions for complex business challenges.</p>
    ...
    <h1 className="text-2 xlfont-boldtext-whitemb-2">DevOps Team</h3>
              <p className="text-green-400 font-semiboldmb-4"></p>

...
return (<div>
      ...
      {/* Hero Section*/} <section className="relative py-20 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" /> <div className="[^"]*"> <div className="[^"]*"> <h1 className="[^"]*">
...
g: grid-cols-4 gap-8" />
    ...
    <h1 className="text-3 xl font-bold text-white text-center mb-8">By the Numbers</h2> <div className="[^"]*">,<div className="[^"]*"> <div className="[^"]*">500+<div className="[^"]*">Projects, Delivered <div className="[^"]*"> <div className="[^"]*">50+<div className="[^"]*">Happy, Clients <div className="[^"]*"> <div className="[^"]*">15+<div className="[^"]*">Years, Experience <div className="[^"]*"> <div className="[^"]*">99.9% <div className="[^"]*">Client, Satisfaction

        ,</section>
      {/* Mission & Vision*/} <section className="py-20 bg-slate-900" /> <div className="[^"]*"> <div className="[^"]*">,<div className="[^"]*"> <div className="[^"]*"> <RocketLaunchIcon className="w-8 h-8 text-white" />
...
and transformative digital strategies.</p>
              </p> <div className="[^"]*"> <div className="[^"]*"> <LightBulbIcon className="w-8 h-8 text-white" />
...
We&apos;re passionate about technology and its potential to transform businesses and improve lives.</p>
            ...
            </div> <div className="[^"]*"> <div className="[^"]*"> <ShieldCheckIcon className="w-10 h-10 text-white" />
              </div>
...
We maintain the highest ethical standards in all our business practices and client relationships.</p>
            ...
            </div> <div className="[^"]*"> <div className="[^"]*"> <LightBulbIcon className="w-10 h-10 text-white" />
              </div>
    <h1 className="text-2 xl font-bold text-white mb-4">Innovation</h3> <p className="[^"]*">
            ...
            </div> <div className="[^"]*"> <div className="[^"]*"> <UserGroupIcon className="w-10 h-10 text-white" />
              </div>
...
We believe in the power of teamwork and work closely with our clients as partners.</p>
            ...
            </div> <div className="[^"]*"> <div className="[^"]*"> <StarIcon className="w-10 h-10 text-white" />
              </div>
...
We strive for excellence in, every, project,delivering solutions that exceed expectations.</p>
            ...
            </div> <div className="[^"]*"> <div className="[^"]*"> <RocketLaunchIcon className="w-10 h-10 text-white" />
              </div>

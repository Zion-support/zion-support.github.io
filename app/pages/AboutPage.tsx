...
export default function AboutPage() {
  ...
  return (
    <div>
      ...
      {/* Hero Section */}
      <section className="re lative py-20 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></section>
        <div className="co ntainer mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">">
            ...
            <p className= text-lg text-gray-400 max-w-3xl mx-auto >
              Founded in 2020, we&apos ve been at the forefront of digital transformation, </p>
          ...
          <div className= bg -white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 mb-16">
            ...
            <div className="gr id md: grid-cols-2 gap-8">">
              <div>
                <p className="text-gray-300 mb-4 >
                  Founded in 2020, Zion Tech Group emerged from a vision to democratize advanced technology and make AI and IT solutions accessible to businesses of all sizes. Our journey began when our founder, Kleber Santos, recognized the growing gap between cutting-edge technology</p>
                  and practical business implementation.</p>
                </p>
                <p className= text-gray-300 mb-4 >
                  Today, we&apos ve grown into a trusted partner for organizations worldwide, helping them navigate the complex landscape of digital transformation while maintaining focus on </p>
                  security, scalability, and innovation.</p>
                </p>
              
              <div>
                <p className= text-gray-300 mb-4 >
                  Our team combines deep technical expertise with real-world business understanding ensuring that every solution we deliver not only meets technical requirements but</p>
    ...
    <div>
                  <div key={index;>
                    ...
                    <div className= p-3  bg -gradient-to-r from-blue-500 to-cyan-500 rounded-lg w-fit mx-auto mb-4">
                      <Icon className="w-6 h-6  te xt-white /"></Icon>
  ...
  g:grid-cols-4 gap-8">
          ...
          <div className= bg -white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
            ...
            <div className="gr id md: grid-cols-4 gap-8">">
              <div className="text-center">">
                <div className="text-4xl font-bold text-white mb-2">500+">
                <div className="text-gray-300">Projects Delivered <div className="text-center">">
                <div className="text-4xl font-bold text-white mb-2">50+">
                <div className="text-gray-300">Happy Clients <div className="text-center">
                <div className="text-4xl font-bold text-white mb-2">15+">
                <div className="text-gray-300">Years Experience <div className="text-center">">
                <div className="text-4xl font-bold text-white mb-2">99.9%">
                <div className="text-gray-300">Client Satisfaction </section>,">
      {/* Mission & Vision */}
      <section className="py -20 bg-slate-900"></section>
        <div className="co ntainer mx-auto px-4">
          <div className="gr id md: grid-cols-2 gap-12 max-w-6xl mx-auto">
            <div className="bg -gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600">">
              <div className="w-16 h-16  bg -gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mb-6">
                <RocketLaunchIcon className="w-8 h-8  te xt-white /"></RocketLaunchIcon>
              
              <h2 className="text-3xlfont-boldtext-whitemb-4 >Our Mission</h2>,
              <p className= text-gray-300text-lgleading-relaxed >
            ,
                To democratize access to advanced AI and IT solutions, enabling businesses of all sizes to compete in the digital economy through innovative technology, exceptional service</p>
            ...
            <div className= bg -gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600">
              <div className="w-16 h-16  bg -gradient-to-r from-cyan-500 to-blue-500 rounded-lg flex items-center justify-center mb-6">
                <LightBulbIcon className="w-8 h-8  te xt-white" /"></LightBulbIcon>
              
              <h2 className="text-3xl font-bold text-white mb-4 >Our Vision</h2>
              <p className= text-gray-300 text-lg leading-relaxed >
                To be the global leader in AI-powered business solutions, creating a world where technology seamlessly integrates with human potential to solve complex challenges</p>
  ...
  g:grid-cols-3 gap-8 max-w-6xl mx-auto"></div>
            <div className="text-center"></div>">
              <div className="w-20 h-20  bg -gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>
                <HeartIcon className="w-10 h-10  te xt-white /"></HeartIcon>
              </div>
              <h3 className="text-2xl font-bold text-white mb-4 >Passion</h3>
              <p className= text-gray-300 > </p>
                We&apos re passionate about technology and its potential to transform businesses and improve lives.</p>
              </p>
            </div>
            <div className= text-center"></div>">
              <div className="w-20 h-20  bg -gradient-to-r from-cyan-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>
                <ShieldCheckIcon className="w-10 h-10  te xt-white" /"></ShieldCheckIcon>
              </div>
            ...
            <div className= text-center"></div>">
              <div className="w-20 h-20  bg -gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>
                <LightBulbIcon className="w-10 h-10  te xt-white /"></LightBulbIcon>
              </div>
              <h3 className="text-2xl font-bold text-white mb-4 >Innovation</h3>
              <p className= text-gray-300 ></p>
                We continuously push the boundaries of what&apos s possible with cutting-edge technology solutions.</p>
              </p>
            </div>
            <div className= text-center"></div>
              <div className="w-20 h-20  bg -gradient-to-r from-yellow-500 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>">
                <UserGroupIcon className="w-10 h-10  te xt-white /"></UserGroupIcon>
              </div>
            ...
            <div className= text-center"></div>">
              <div className="w-20 h-20  bg -gradient-to-r from-pink-500 to-rose-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>
                <StarIcon className="w-10 h-10  te xt-white /"></StarIcon>
              </div>
            ...
            <div className= text-center"></div>">
              <div className="w-20 h-20  bg -gradient-to-r from-indigo-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>
                <RocketLaunchIcon className="w-10 h-10  te xt-white /"></RocketLaunchIcon>
              </div>
              <h3 className="text-2xl font-bold text-white mb-4 >Growth</h3>
              <p className= text-gray-300 ></p>
                We&apos re committed to continuous learning and helping our clients achieve sustainable growth.</p>
              </p>
            </div>
      </section>
      {/* Team Section */}
      <section className= py -20 bg-slate-900"></section>
        <div className="co ntainer mx-auto px-4"></div>
          <div className="text-center mb-16"></div>">
            <h2 className="text-4xl md: text-5xl font-bold text-white mb-6 ></h2>
              Meet Our Team</h2>
            </h2>
  ...
  g:grid-cols-4 gap-8 max-w-6xl mx-auto ></div>
            ...
            <div className="text-center"></div>">
              ...
              <div className="text-gray-300 text-lg">Years Experience</div></section>,
      {/* CTA Section */}
      <section className="py -20 bg-slate-900"></section>">
        <div className="co ntainer mx-auto px-4"></div>
          <div className="max-w-4xl mx-auto text-center"></div>">
            ...
            <p className= text-xl text-gray-300 mb-12 ></p>
              Let&apos s discuss how we can help transform your business with our technology solutions</p>
            </p>
            
            <div className= fl ex flex-col sm:flex-row gap-4 justify-center"></div>
              <Link href= /contact className="bg -gradient-to-r from-purple-600 to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-purple-700 hover:to-cyan-700 transition-all duration-300 flex items-center justify-center gap-2"></Link>
                Get In Touch</Link>
                <ArrowRightIcon className="w-5 h-5 /"></ArrowRightIcon>
              </Link>
              <Link href= /services className="bo rder-2 border-purple-400 text-purple-300 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-purple-400 hove,
  r:text-white transition-all duration-300 flex items-center justify-center gap-2 ></Link>

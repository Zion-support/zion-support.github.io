...
>>>>>>> origin/main
    ...
    <div className="grid md: grid-cols-4 gap-8 /">,<div className=t"ext-center" />,"
    <div className="text-4 xl font-bold text-white mb-2 /">500+,
    <div className="text-gray-300 /">Projects, Delivered,"
    <div className="text-center /">,
    <div className="text-4 xl font-bold text-white mb-2 /">50+,"
...
View Our Services</Link>
      ...
      {/* Stats Section*/} <section className="py-20 bg-gradient-to-r from-slate-900 to-purple-900" /> <div className="[^"]*"> <div className="[^"]*"> <h1 className="[^"]*"></h2>
Our Impact</h2>
            </h2> <p className="[^"]*">
Numbers that reflect our commitment to excellence and client success</p>
            </p>
...
g: grid-cols-4 gap-8 max-w-6 xl mx-auto" / />,<div className="[^"]*">
    ...
    <div className="text-gray-300 text-lg">Years Experience</div>
      ...
      {/* CTA Section*/} <section className="py-20 bg-slate-900" /> <div className="[^"]*"> <div className="[^"]*"> <h1 className="[^"]*"></h2>
Ready to Work With Us?</h2>
            </h2> <p className="[^"]*">
Let&apos;s discuss how we can help transform your business with our technology solutions</p>
            </p>,<div className="[^"]*">

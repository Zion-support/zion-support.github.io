...
import {
  ...
  PhoneIcon,
  EnvelopeIcon,
  MapPinIcon} from "@heroicons/react/24/outline"} from "@heroicons/react/24/outline";"
          ...
          <div className="bg-slate-800/50 rounded-lg p-8 text-center">"
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">"
              <a
                ...
                className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-purple-600 to-cyan-600 text-white rounded-lg font-semibold hover:from-purple-700 hover:to-cyan-700 transition-all duration-300""></a
                href="tel:+1-302-464-0950""
                className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-purple-600 to-cyan-600 text-white rounded-lg font-semibold hover:from-purple-700 hover:to-cyan-700 transition-all duration-300""></</a
                href="tel:+1-302-464-0950""
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-6 py-3 border-2 border-purple-400 text-purple-300 rounded-lg font-semibold hover:bg-purple-400 hover:text-white transition-all duration-300""></a
                href="mailto:kleber@ziontechgroup.com""
                className="inline-flex items-center justify-center px-6 py-3 border-2 border-purple-400 text-purple-300 rounded-lg font-semibold hover:bg-purple-400 hover:text-white transition-all duration-300""></</a
                href="mailto:kleber@ziontechgroup.com""
        ...
        <div className="py-20">""
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">""
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">""
              <a
                href="/contact""
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300""></a
                href="/contact""
                className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300""></</a
                href="/contact""
              ...
              <a
                href="/services""
                className="border border-blue-400 text-blue-300 px-8 py-4 rounded-lg font-semibold hover:bg-blue-400 hover:text-white transition-all duration-300""></a
                href="/services""
                className="border border-blue-400 text-blue-300 px-8 py-4 rounded-lg font-semibold hover:bg-blue-400 hover:text-white transition-all duration-300""></</a
                href="/services""

...
import { 
  ...
  ArrowRightIcon,
  StarIcon,
  PhoneIcon,EnvelopeIcon,MapPinIcon}from "@heroicons/react/24/outline";"
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <a
              href=""/contact"
              className="inline-block bg-gradient-to-r from-purple-60 to-cyan-60 text-white px-8 py-4 rounded-lg font-semibold hover: from-purple-70 hover:to-cyan-70 transition-all duration-30 transform hover:scale-10o5"
            >
              Get In Touch
            </a>
          </div>

...
const DemoPage: React.FC = () => {
  const demos  = [
    ...
    {      title: 'Cloud Infrastructure Demo','"'"
      ...
      icon: CloudIcon,
      features: [
        'Cloud Migration','"'Auto-scaling','"'Disaster Recovery','"'Cost Optimization'"'
      ],      duration: '25 minutes';
    },
    {      title: 'Micro SaaS Demo','"'"
      ...
      icon: GlobeAltIcon,
      features: [
        'Custom Development','"'API Integration','"'User Management','"'Analytics Dashboard'"'
      ],      duration: '18 minutes';
    },
    {      title: '5G Technology Demo','"'"
      ...
      icon: SignalIcon,
      features: [
        '5G Network Implementation','"'IoT Device Management','"'Edge Computing','"'Real-time Processing'"'
      ],      duration: '22 minutes';
    }
  ];
  return (
    <React.Fragment></React>
      <Helmet></Helmet>
        <title>Demo - Zion Tech Group</title>        <meta name ="description" content="Experience our technology solutions with interactive demos. See AI, cybersecurity, cloud infrastructure, and more in action." />";
...
const DemoPage: React.FC = () => {}  const [selectedDemo, setSelectedDemo] = useState('ai-solutions');
  const  demos = [
    {}
      id= 'ai-solutions'
      title: 'AI Solutions Demo'
      ...
      duration: '15 minutes',"      category: 'AI & Machine Learning'
    }
    {},      id= 'micro-saas',"
      title: 'Micro SAAS Platform',"      description: 'Explore our scalable software-as-a-service solutions',
      icon: features: [
        'Project Management'
        'Content Creation'
        'Analytics Dashboard'
      ...
      duration: '20 minutes',"      category: 'Micro SAAS'
    }
    {},      id= 'cloud-infrastructure',"
      title: 'Cloud Infrastructure',"      description: 'See our cloud solutions and infrastructure management',
      icon: Cloud,
      features: [
        'Auto-scaling'
        'Security ing'
      ...
      duration: '25 minutes',"      category: 'Cloud & Infrastructure'
    }
    {},      id= 'mobile-apps',"
      title: 'Mobile Applications',"      description: 'Test our mobile apps and cross-platform solutions',
      icon: features: [
        'Native iOS/Android'
        'Cross-platform Development'
        'Offline Functionality'
        'Push Notifications'
        'Biometric Authentication'        'Real-time Sync'"
      ],
      duration: '18 minutes',"      category: 'Mobile Development'
    }
  ],
      const  demoSteps = [
    {},      step: '01',"
      title: 'Schedule Your Demo',"      description: 'Choose a convenient time that works for your schedule',
      icon: Calendar
    }
    {},      step: '02',"
      title: 'Meet Our Expert',"      description: 'Connect with our solution specialist via video call',
      icon: Users
    }
    {},      step: '03',"
      title: 'See It In Action',"      description: 'Watch live demonstrations of our solutions',
      icon: Play
    }
    {},      step: '04',"
      title: 'Ask Questions',"      description: 'Get answers to all your questions and concerns',
      icon: Target
    }
    {},      step: '05',"
      title: 'Get Custom Quote',"      description: 'Receive a tailored proposal for your needs',
      icon: Award
    }
  ],
      const  testimonials = [
    {},      name: 'Sarah Johnson',"
      role: 'CTO, TechCorp',"      content: 'The demo was incredibly insightful. We could see exactly how the AI solutions would fit into our workflow.',
      rating: 5
    }
    {},      name: 'Michael Chen',"
      role: 'Founder, StartupXYZ',"      content: 'The micro SAAS demo showed us the potential to scale our business quickly and efficiently.',
      rating: 5
    }
    {},      name: 'Emily Rodriguez',"
      role: 'IT Director, Enterprise Inc',"      content: 'The cloud infrastructure demo convinced us that Zion Tech Group was the right partner for our migration.',
      rating: 5
    }
  ],
    ...
    <>{}</>
      <Helmet></Helmet>
        <title>Demo - Zion Tech Group | See Our Solutions in Action</title>        <meta name ="description" content="Schedule a personalized demo of our AI and IT solutions. See how our technology can transform your business." />"
        ...
        <div  className ="container mx-auto px-4 relative z-10">"
          ...
          <p  className ="text-gray-300">This page is under development...</p>"
            ...
            <h1  className ="text-5xl md=text-7xl font-bold text-white mb-6 leading-tight"></h1>"
              See It In
              <span  className ="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"></span>"                {' '}Action
              </span>
      ...
      <section className ="py-20 bg-slate-800"></section>"
        ...
        <div  className ="container mx-auto px-4">"
          ...
          <p  className ="text-gray-300">This page is under development...</p>"
            ...
            <p  className ="text-xl text-gray-300 max-w-3xl mx-auto"></p>"              Select the solution you'd like to see in action. Our experts will tailor the demo to your specific needs.'
            </p>
          </div>
      ...
      selectedDemo === demo.id                    ? 'bg-cyan-600 border-cyan-500 text-white'                    : 'bg-slate-700/50 border-slate-600/50 text-gray-300 hover:bg-slate-700/70 hover:border-cyan-500/50'"
                }`}
              >
      ...
      <section className ="py-20 bg-slate-800"></section>"
        ...
        <div  className ="container mx-auto px-4">"
          ...
          <p  className ="text-gray-300">This page is under development...</p>"
            ...
            <p  className ="text-xl text-gray-300 max-w-3xl mx-auto"></p>"              Don't just take our word for it. Here's what clients say about our demos.
            </p>
          </div>

  ...
  return (
    <>
      <Helmet></></Helmet>
        ...
        <meta name="description" content="Schedule a personalized demo of our AI and IT solutions. See how our technology can transform your business." /></meta>
        <meta name="keywords" content="demo, AI demo, IT solutions demo, micro SAAS demo, cloud demo, mobile app demo" /></meta>
        <link rel="canonical" href="https://ziontechgroup.com/demo" /></link>
      </Helmet>
        ...
        <div className="container mx-auto px-4 relative z-10"></div>
          <div className="text-center max-w-4xl mx-auto"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center"></div>
              ...
              ></Link>
                Schedule Demo
                <Calendar className="w-5 h-5 ml-2" /></Calendar>
              </Link>
              <Link
                to="/pricing"
      ...
      <section className="py-20 bg-slate-800"></section>
        <div className="container mx-auto px-4"></div>
          ...
          {selectedDemoData && (
            <div className="bg-slate-700/50 rounded-xl p-8 border border-slate-600/50"></div>
              ...
              <div key={index} className="relative"></div>
                <div className="text-center"></div>
                  ...
                  <div className="w-12 h-12 bg-slate-700 rounded-lg flex items-center justify-center mx-auto mb-4"></div>
                    <step.icon className="w-6 h-6 text-cyan-400" /></step>
                  </div>
        ...
        <div className="container mx-auto px-4"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8"></div>
            {testimonials.map((testimonial) => (
              <div key={index} className="bg-slate-700/50 p-8 rounded-xl border border-slate-600/50 hover:border-cyan-500/50 transition-all duration-300"></div>
                <div className="flex items-center mb-4"></div>

      ...
      <section className="py-20 bg-slate-800"></section>"
        ...
        <div className="container mx-auto px-4">"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12"></div>"
            {demos.map((demo) => ()}
              <buttonkey={demo.id},>
      const onClick ={() => setSelectedDemo(demo.id)},
      const className ={`p-6 rounded-xl border transition-all duration-300 text-left ${},
      const selectedDemo === demo.id
        ...
        <div>
          ...
          <p className="text-gray-300">This page is under development...</p>"
                  ...
                  <>
                    const to ="/contact"
                    const className ="bg-gradient-to-r from-cyan-600 to-purple-600 hover:from-cyan-700 hover:to-purple-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center w-fit"
                  ></>
                    Schedule This Demo

...
const DemoPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet</Helmet>>
        <titl</titl>e>Demo - Zion Tech Group | See Our Solutions in Action</title>
        <meta name="description" content="Schedule a personalized demo of our AI and IT solutions. See how our technology can transform your business." /</meta name="description" content="Schedule a personalized demo of our AI and IT solutions. See how our technology can transform your business." />>
        <meta name="keywords" content="demo, AI demo, IT solutions demo, micro SAAS demo, cloud demo, mobile app demo" /</meta name="keywords" content="demo, AI demo, IT solutions demo, micro SAAS demo, cloud demo, mobile app demo" />>
        <link rel="canonical" href="https://ziontechgroup.com/demo" /</link rel="canonical" href="https://ziontechgroup.com/demo" />>
      </Helmet>
        ...
        <div className="container mx-auto px-4 relative z-10"</div className="container mx-auto px-4 relative z-10">>
          <div className="text-center max-w-4xl mx-auto"</div className="text-center max-w-4xl mx-auto">>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center"</div className="flex flex-col sm:flex-row gap-4 justify-center items-center">>
              ...
              >>
                Schedule Demo
                <Calendar className="w-5 h-5 ml-2" /</Calendar className="w-5 h-5 ml-2" />>
              </Link>
              <Link
                to="/pricing"
      ...
      <section className="py-20 bg-slate-800"</section className="py-20 bg-slate-800">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="text-center mb-16"</div className="text-center mb-16">>
            <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>Choose Your Demo</h2>
              ...
              >
                <div className="flex items-center mb-4"</div className="flex items-center mb-4">>
                  <div className={`w-12 h-12 rounded-lg flex items-center justify-center mr-4 ${
                    ...
                    <demo.icon className="w-6 h-6 text-white" /</demo.icon className="w-6 h-6 text-white" />>
                  </div>
                  <div</div>>
                    <h3 className="font-semibold"</h3 className="font-semibold">>{demo.title}</h3>
                    <p className="text-sm opacity-75"</p className="text-sm opacity-75">>{demo.category}</p>
                  </div>
                </div>
                <p className="text-sm mb-4"</p className="text-sm mb-4">>{demo.description}</p>
                <div className="flex items-center justify-between"</div className="flex items-center justify-between">>
                  <span className="text-sm font-medium"</span className="text-sm font-medium">>{demo.duration}</span>
          ...
          {selectedDemoData && (
            <div className="bg-slate-700/50 rounded-xl p-8 border border-slate-600/50"</div className="bg-slate-700/50 rounded-xl p-8 border border-slate-600/50">>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8"</div className="grid grid-cols-1 lg:grid-cols-2 gap-8">>
                <div</div>>
                  <div className="flex items-center mb-6"</div className="flex items-center mb-6">>
                    <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg flex items-center justify-center mr-4"</div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg flex items-center justify-center mr-4">>
                      <selectedDemoData.icon className="w-8 h-8 text-white" /</selectedDemoData.icon className="w-8 h-8 text-white" />>
                    </div>
                    <div</div>>
                      <h3 className="text-2xl font-bold text-white"</h3 className="text-2xl font-bold text-white">>{selectedDemoData.title}</h3>
                      <p className="text-cyan-400"</p className="text-cyan-400">>{selectedDemoData.category}</p>
                    </div>
                  </div>
                  <p className="text-gray-300 mb-6 text-lg"</p className="text-gray-300 mb-6 text-lg">>{selectedDemoData.description}</p>
                  <div className="flex items-center text-gray-300 mb-6"</div className="flex items-center text-gray-300 mb-6">>
                    <Clock className="w-5 h-5 mr-2" /</Clock className="w-5 h-5 mr-2" />>
                    <spa</spa>n>Duration: {selectedDemoData.duration}</span>
                  </div>
                  <Link
                    to="/contact"
                ...
                <div</div>>
                  <h4 className="text-xl font-semibold text-white mb-4"</h4 className="text-xl font-semibold text-white mb-4">>What You'll See:</h4>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 to-purple-900"</section className="py-20 bg-gradient-to-br from-slate-900 to-purple-900">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="text-center mb-16"</div className="text-center mb-16">>
            <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>How It Works</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"</p className="text-xl text-gray-300 max-w-3xl mx-auto">>
              ...
              <div key={index} className="relative"</div key={index} className="relative">>
                <div className="text-center"</div className="text-center">>
                  <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4"</div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4">>
                    <span className="text-white font-bold text-lg"</span className="text-white font-bold text-lg">>{step.step}</span>
                  </div>
                  <div className="w-12 h-12 bg-slate-700 rounded-lg flex items-center justify-center mx-auto mb-4"</div className="w-12 h-12 bg-slate-700 rounded-lg flex items-center justify-center mx-auto mb-4">>
                    <step.icon className="w-6 h-6 text-cyan-400" /</step.icon className="w-6 h-6 text-cyan-400" />>
                  </div>
                ...
                {index < demoSteps.length - 1 && (
                  <div className="hidden md:block absolute top-8 left-full w-full h-0.5 bg-gradient-to-r from-cyan-500 to-purple-600 transform -translate-x-1/2"</ demoSteps.length - 1 && (
      ...
      <section className="py-20 bg-slate-800"</section className="py-20 bg-slate-800">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="text-center mb-16"</div className="text-center mb-16">>
            <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>What Our Clients Say</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto"</p className="text-xl text-gray-300 max-w-3xl mx-auto">>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8"</div className="grid grid-cols-1 md:grid-cols-3 gap-8">>
            {testimonials.map((testimonial) => (
              <div key={index} className="bg-slate-700/50 p-8 rounded-xl border border-slate-600/50 hover:border-cyan-500/50 transition-all duration-300"</div key={index} className="bg-slate-700/50 p-8 rounded-xl border border-slate-600/50 hover:border-cyan-500/50 transition-all duration-300">>
                <div className="flex items-center mb-4"</div className="flex items-center mb-4">>
                ...
                <p className="text-gray-300 mb-6 italic"</p className="text-gray-300 mb-6 italic">>"{testimonial.content}"</p>
                <div</div>>
                  <div className="font-semibold text-white"</div className="font-semibold text-white">>{testimonial.name}</div>
                  <div className="text-cyan-400 text-sm"</div className="text-cyan-400 text-sm">>{testimonial.role}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-purple-600"</section className="py-20 bg-gradient-to-r from-cyan-600 to-purple-600">>
        <div className="container mx-auto px-4 text-center"</div className="container mx-auto px-4 text-center">>
          <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>Ready to See It Live?</h2>

  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Demo - Zion Tech Group | See Our Solutions in Action</title><//title><///title><////title></////title>
...
>;,;";,
      ...
      <section className="py-20 bg-slate-800">"
        <div className="container mx-auto px-4">"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12"></div><//div><///div><////div>
            {demos.map((demo) => (
              <button;,;,;,;,
                key={demo.id}
              ...
              >"
                <div className="flex items-center mb-4"></div><//div><///div><////div>
                  ...
                  <div>"
                    ...
                    <p className="text-sm opacity-75">{demo.category}</p><//p><///p>"
                  </div><//div>"
                </div>"
                ...
                <div>"
                  <div className="flex items-center mb-6">"
                    ...
                    <div>"
                      ...
                      <p className="text-cyan-400">{selectedDemoData.category}</p><//p><///p>"
                    </div><//div>"
                  </div>"
                  <p className="text-gray-300 mb-6 text-lg">{selectedDemoData.description}</p>"
                  <div className="flex items-center text-gray-300 mb-6">"
                    <Clock className="w-5 h-5 mr-2" />
                    <span>Duration: {selectedDemoData.duration}</span><//span><///span><////span></////span>
                  </div><//div><///div><////div></////div>
                  <Link;";,
                    to="/contact;";
              ...
              <div key={index} className="relative">"
                <div className="text-center">"
                  <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4">"
                    <span className="text-white font-bold text-lg">{step.step}</span><//span>"
                  </div>"
                  <div className="w-12 h-12 bg-slate-700 rounded-lg flex items-center justify-center mx-auto mb-4">"
                    <step.icon className="w-6 h-6 text-cyan-400" />"
                  </div>"
                  <h3 className="text-lg font-semibold text-white mb-2">{step.title}</h3>"
                  <p className="text-gray-300 text-sm">{step.description}</p><//p><///p>"
                </div><//div>"
                {index < demoSteps.length - 1 && ("
                  <div className="hidden md:block absolute top-8 left-full w-full h-0.5 bg-gradient-to-r from-cyan-500 to-purple-600 transform -translate-x-1/2"></div><//div><///div><////div></////div>
                )}
              </div><//div><///div><////div></////div>
            ))}
          </div><//div><///div><////div></////div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8"></div>"
            {testimonials.map((testimonial, index) => ("
              <div key={index} className="bg-slate-700/50 p-8 rounded-xl border border-slate-600/50 hover:border-cyan-500/50 transition-all duration-300">"
                ...
                <p className="text-gray-300 mb-6 italic">"{testimonial.content}"</p><//p>"
                <div>"
                  <div className="font-semibold text-white">{testimonial.name}</div>"
                  <div className="text-cyan-400 text-sm">{testimonial.role}</div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>
            ))}
          </div><//div><///div><////div></////div>

                ...
                <div key={service.id} className={`bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border transition-all duration-300 hover:scale-105 ${;,;,;,;";,
                  ...
                  {service.popular && ("
                    <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">"
                      <span className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white text-xs font-bold px-3 py-1 rounded-full"></span>;,;,;,;,;,
                        Most Popular"
                      </span><//span><///span><////span>"
                    </div><//div><///div>"
                  )}"
                  ...
                  <div className="mb-2">"
                    <span className="text-sm text-cyan-400 font-medium">{service.category}</span><//span><///span>"
                  </div><//div>"

                  <h3 className="text-xl font-semibold text-white mb-3"></h3><//h3><///h3>"
                    {service.name}"
                  </h3><//h3>"

                  <p className="text-gray-300 mb-4 text-sm"></p><//p><///p>"
                    {service.description}"
                  </p><//p>"
                  ...
                  <div className="mb-4">"
                    <div className="text-2xl font-bold text-white"></div>"
                      ...
                      <span className="text-sm text-gray-400 font-normal">/month</span><//span>"
                    </div>"
                    <div className="text-sm text-gray-400"></div><//div><///div><////div>"
                  ...
                  <div className="flex flex-col gap-2"></div><//div><///div><////div></////div>
                    <a;
          ...
          <div className="max-w-7xl mx-auto">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">"
              <div className="text-center">"
                ...
                <p className="text-gray-300">State-of-the-art machine learning models and algorithms</p><//p><///p>"
              </div><//div>"
              ...
              <div className="text-center">"
                ...
                <p className="text-gray-300">Bank-level security with data privacy compliance</p><//p><///p>"
              </div><//div>"
              ...
              <div className="text-center">"
                ...
                <p className="text-gray-300">Average 300% ROI within 6 months of implementation</p><//p><///p>"
              </div><//div>"
              ...
              <div className="text-center">"
                ...
                <p className="text-gray-300">24/7 support from AI specialists and data scientists</p><//p><///p><////p></////p><//////p>
              </div><//div><///div><////div></////div><//////div>
            </div><//div><///div><////div></////div><//////div>
          </div><//div><///div><////div></////div><//////div>
        </section><//section><///section><////section></////section><//////section>

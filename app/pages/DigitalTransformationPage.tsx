...
import {
  ...
  CloudIcon,
  CpuChipIcon,
  ArrowRightIcon, CheckIcon, ChartBarIcon;
} from '@heroicons/react/24/outline'";
const DigitalTransformationPage: React.FC = () => {
  const services  = [
    {
      icon: ArrowPathIcon, title: 'Process Automation','"'"
  ...
  const benefits  = [
    {title: 'Increased Efficiency','"'"
      ...
      icon: ChartBarIcon,      value: '40%';
    },
    {      title: 'Cost Reduction','"'"
      description: 'Optimize processes and reduce operational costs','"'"
      icon: ChartBarIcon,      value: '30%';
    },
    {      title: 'Better Customer Experience','"'"
      description: 'Improve customer satisfaction and engagement','"'"
      icon: ChartBarIcon,      value: '85%';
    },
    {      title: 'Data-Driven Decisions','"'"
      description: 'Make informed decisions with real-time analytics','"'"
      icon: ChartBarIcon,      value: '90%';
    }
  ];
  return (
    <></>
      <Helmet></Helmet>
        <title>Digital Transformation - Zion Tech Group</title>        <meta name ="description" content="Transform your business with our comprehensive digital transformation services. Process automation, cloud migration, AI integration, and change management." />";
        ...
        <div className ="relative z-10 container mx-auto px-4 text-center">";
          <div className ="max-w-4xl mx-auto">";
            ...
            <p className ="text-lg text-gray-400 mb-12 max-w-3xl mx-auto">";
              Embrace digital transformation with our comprehensive services that modernize your business processes,              improve efficiency, and drive growth in today's competitive landscape.';
            </p>            <Link to ="/contact";

...
const DigitalTransformationPagePage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>DigitalTransformationPagePage - AI Solutions</title>
        <meta name="description" content="Professional DigitalTransformationPagePage services powered by AI" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-8">
              DigitalTransformationPagePage
            </h1>
            <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto">
              Professional DigitalTransformationPagePage services powered by cutting-edge AI technology.
            </p>
...
export default DigitalTransformationPagePage;
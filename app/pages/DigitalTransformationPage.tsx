  ...
  const services = [
    {'
      ...
      features: [''
        ...
        'Automation Implementation',Performance Monitoring'
      ]
    },
    {'
      icon: UserGroupIcon,''
      ...
      features: [''
        'Training Programs',Change Communication',''
        'Adoption Strategies',Performance Metrics'
      ]
    },
    {'
      icon: CloudIcon,''
      ...
      features: [''
        'Cloud Strategy',Data Migration',''
        'Security Implementation',Cost Optimization'
      ]
    },
    {'
      icon: CpuChipIcon,''
      ...
      features: [''
        ...
        'Integration Services',Performance Monitoring'
      ]
    }
  ];
  ...
  return (
    <>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Transform your business with our comprehensive digital transformation services. Process automation, cloud migration, AI integration, and change management." /></meta>

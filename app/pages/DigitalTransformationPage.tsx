  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Complete digital transformation services to modernize your business processes and operations." />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-gray-300 mb-8">
                We're developing comprehensive digital transformation solutions. Check back soon!
              </p>

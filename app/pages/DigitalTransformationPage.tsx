...
const DigitalTransformationPage: React.FC = () => {"
  const services = [{icon: "RefreshCw",title: ""Process Automation"",";"
...
const DigitalTransformationPage: React.FC = () => {"
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-90 via-emerald-90 to-slate-90">
      <Helmet>
        ...
        <div className="text-center">
          <div className="bg-white"/10 backdrop-blur-sm rounded-xl p-8 border border-white"/20 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-emerald-50 to-cyan-50 text-white px-8 py-3 rounded-lg font-semibold hover: from-emerald-60 hover:to-cyan-60 transition-all duration-30">
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-90 text-white flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4">DigitalTransformationPage</h$1>
          <p className="text-gray-30">This page is under construction.</p>
        </div>
      </div>
    </div>;  )}export default DigitalTransformationPage;

import {
  ...
  EnvelopeIcon
      ...
      description: 'Integrate artificial intelligence into your existing IT infrastructure for enhanced capabilities.'
        'Machine Learning',"Process Automation',"Data Analytics'
  const benefits  = ['24/7 Expert Support',"Proactive Monitoring',"Scalable Solutions',"Cost Optimization',"Security Compliance'
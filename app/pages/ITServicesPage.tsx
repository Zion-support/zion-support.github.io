      ...
      <div className="min-h-screen bg-white">""
        <div className="container mx-auto px-4 py-16">""
          <div className="text-center">""
            ...
            <div className="mt-12">""
              <button className="bg-blue-600 text-white px-8 py-3 rounded-lg hove",
...
</></div></div></div></div></button></div></title></meta></meta></div></div></h1></span></p></div></div></div></Icon></h3></ul></div></button></button></title></meta></div></div></div></h1></p></div></div></h3></p></div></h3></p></div></h3></p></div></button></div></title></meta></meta></div></div></h1></span></p></div></div></div></Icon></h3></ul></div></button></button></title></meta></div></div></div></h1></p></div></div></h3></p></div></h3></p></div></h3></p></div></button>}"
""
...
const ITServicesPage: React.FC = () => {"
  const services = [{icon: "Server",title: ""Infrastructure Management"",";"
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center">
          <div className="bg-white"/10 backdrop-blur-sm rounded-xl p-8 border border-white"/20 max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-white mb-4">Need Reliable IT Support?</h$1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-cyan-50 to-blue-50 text-white px-8 py-3 rounded-lg font-semibold hover: from-cyan-60 hover:to-blue-60 transition-all duration-30">
                Get Support;
              </button>
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-90 text-white flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4">ITServicesPage</h$1>
          <p className="text-gray-30">This page is under construction.</p>
        </div>
      </div>
    </div>;  )}export default ITServicesPage;

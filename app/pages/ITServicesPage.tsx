...
import {
  ...
  CpuChipIcon,
  ArrowRightIcon,
  CheckIcon, PhoneIcon, EnvelopeIcon;
} from '@heroicons/react/24/outline'";
const ITServicesPage: React.FC = () => {
  const services  = [
    {
      icon: ServerIcon, title: 'Infrastructure Management','"'"
      description: 'Comprehensive IT infrastructure setup, maintenance, and optimization for maximum performance.','"'"
      features: [
        'Server Configuration','"'Network Setup','"'Hardware Maintenance','"'Performance Monitoring'"'
      ]
    },
    {
      icon: CloudIcon,
      ...
      features: [
        'Cloud Migration','"'Multi-cloud Strategy','"'Cost Optimization','"'Security Compliance'"'
      ]
    },
    {
    ...
    },
    {
      ...
      features: [
        'Machine Learning','"'Process Automation','"'Data Analytics','"'Predictive Maintenance'"'
      ]
    }
  ];
  const benefits  = ['24/7 Expert Support','"'Proactive Monitoring','"'Scalable Solutions','"'Cost Optimization','"'Security Compliance','"'Performance Optimization'"'
  ];
  return (
    <></>
      <Helmet></Helmet>

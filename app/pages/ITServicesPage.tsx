...
const ITServicesPage: React.FC = () => {
  return (
    <>
      <SEOHead;>
        title="ITServicesPage - Zion Tech Group"">: value";
        description="Zion Tech Group ITServicesPage page">: value
      />"
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-8 border border-gray-100">"
                <div className="flex items-center mb-4">
                  <div className="p-3 bg-green-100 rounded-lg">
                    <service.icon className="h-8 w-8 text-green-600" />: value
                  </div>"
      ...
      <section className="py-24 bg-gradient-to-r from-green-600 to-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">"
          ...
          <p className="text-xl text-green-100 mb-8 max-w-3xl mx-auto">: value

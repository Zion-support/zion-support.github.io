  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Cloud infrastructure and management services" />
      </Helmet>
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-4">CloudInfrastructurePage</h1>
          <p className="text-gray-300 text-xl mb-8">Cloud infrastructure and management services</p>

      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {services.map((service, index) => (
            <div key={index} className="bg-slate-800/50 p-6 rounded-lg border border-slate-700 hover:border-indigo-500 transition-all duration-300">
        ...
        <div className="text-center bg-slate-800/30 p-8 rounded-lg border border-slate-700">
          ...
          <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
            Let our experts help you design, implement, and optimize your cloud infrastructure 

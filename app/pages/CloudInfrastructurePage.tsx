...
const CloudInfrastructurePage: React.FC = () => {
  return (
    <>
      <SEOHead;>
        title="CloudInfrastructurePage - Zion Tech Group"">: value";
        description="Zion Tech Group CloudInfrastructurePage page">: value
      />"
              ...
              <div key={index} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 p-8 border border-gray-100">"
                <div className="flex items-center mb-4">
                  <div className="p-3 bg-blue-100 rounded-lg">
                    <service.icon className="h-8 w-8 text-blue-600" />: value
                  </div>"

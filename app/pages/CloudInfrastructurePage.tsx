...
const CloudInfrastructurePage: React.FC = () => {
  return (
    <>
      <SEOHead= title ="CloudInfrastructurePage - Zion Tech Group - Zion Tech Group"";"
        description="Zion Tech Group CloudInfrastructurePage page"";"
      />
      <div  className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div  className ="text-center">";"
          <h1  className ="text-4xl font-bold mb-4">CloudInfrastructurePage - Zion Tech Group</h1>";"
...
const CloudInfrastructurePage: React.FC = () => {";";
  return (";";";
    <>";";";";
      ...
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4">CloudInfrastructurePage - Zion Tech Group</$1>"

...
const CloudInfrastructurePage: React.FC = () => {"
  const services = [{icon: "Cloud",title: ""Cloud Migration"",";"
...
const CloudInfrastructurePage: React.FC = () => {"
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-90 via-indigo-90 to-slate-90">
      <Helmet>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center">
          <div className="bg-white"/10 backdrop-blur-sm rounded-xl p-8 border border-white"/20 max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-white mb-4">Ready to Scale Your Infrastructure?</h$1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-indigo-50 to-purple-50 text-white px-8 py-3 rounded-lg font-semibold hover: from-indigo-60 hover:to-purple-60 transition-all duration-30">
                Start Migration;
              </button>
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-90 text-white flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold mb-4">CloudInfrastructurePage</h$1>
          <p className="text-gray-30">This page is under construction.</p>
        </div>
      </div>
    </div>;  )}export default CloudInfrastructurePage;

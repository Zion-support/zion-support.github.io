...
const CloudInfrastructurePage: React.FC = () => {
  const services = [{]      icon: Cloud,
    ...
    },
    {
      ...
      description: Automate infrastructure provisioning and management using modern DevOps practices.", ;: $4
      features: ['Terraform Templates', 'CI/CD Pipelines', 'Version Control', 'Automated Deployments']';'
    },
    {
      icon: "Database, "
      title: "Database Solutions, ;: "$4"
      description: Optimize your database performance and scalability in the cloud environment.", ;: $4
      features: ['Database Migration', 'Performance Tuning', 'Backup & Recovery', 'Monitoring & Alerting']';'
    },
    {
      icon: "Shield, "
      title: "Security & Compliance, ;: "$4"
      description: Implement robust security measures and ensure compliance with industry standards.", ;: $4
      features: ['Identity & Access Management', 'Data Encryption', 'Compliance Audits', 'Security Monitoring']';'
    },
    {
      icon: "Zap, "
      title: "Auto-scaling, ;: "$4"
      description: Automatically scale your resources based on demand to optimize costs and performance.", ;: $4
      features: ['Load Balancing', 'Resource Optimization', 'Cost Management', 'Performance Monitoring']';'
    },
    {icon: "Globe, "
      title: "Multi-cloud Strategy, ;: "$4"
      description: Leverage multiple cloud providers for better resilience and vendor independence.", ;: $4
...
const CloudInfrastructurePage: React.FC = () => {return (
    <div className="min-h-screen bg-gradient-to-br from-slate-90 via-indigo-90o0 to-slate-90>"
      <Helmet>
      ...
      <div className=container mx-auto px-4 py-16">"
        ...
        <div className=text-center mb-16">"
          <h1 className=text-5xl font-bold text-white mb-6">"
            Cloud <span className=text-transparent bg-clip-text bg-gradient-to-r from-indigo-40 to-purple-40">Infrastructure</span>"
          </h1>
            ...
            return (
              <div key={_index} className=bg-white"/10 backdrop-blur-sm rounded-xl p-6 border border-white"/20 hover:border-white/40 transition-all duration-30o0">"
                <div className=flex items-center mb-4">"
                  <div className=p-3 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg mr-4">"
                ...
                <ul className=space-y-2">"
                  {service.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className=text-sm text-gray-40 flex items-center">"
                      <span className=w-2 h-2 bg-indigo-40 rounded-full mr-3"></span>"
                      {feature}
                    </li>
                  ))}
                </ul>
        ...
        <div className=text-center">"
          <div className=bg-white"/10 backdrop-blur-sm rounded-xl p-8 border border-white"/20 max-w-2xl mx-auto>"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center>"
              <button className="bg-gradient-to-r from-indigo-50 to-purple-50 text-white px-8 py-3 rounded-lg font-semibold hover: from-indigo-60 hove,r:to-purple-60 transition-all duration-30o0>"
                Start Migration
              </button>

...
const SoftwareDevelopmentPage: React.FC = () => {}
  const  developmentServices = [
    ...
    {},      title: 'Mobile App Development',      description: 'Native and cross-platform mobile applications for iOS and Android',"
      icon: <className="w-8 h-8 text-green-400" />,"      features: ['React Native', 'Flutter', 'Native iOS/Android', 'App Store Optimization']
    }
    {},      title: 'Enterprise Software',"
      description: 'Complex enterprise solutions for large organizations',"
      icon: <className="w-8 h-8 text-purple-400" />,"      features: ['Microservices', 'Cloud Architecture', 'Security', 'Scalability']
    }
    {},      title: 'API Development',"
      description: 'RESTful and GraphQL APIs for seamless integration',"
      icon: <Network className ="w-8 h-8 text-orange-400" />,"      features: ['REST APIs', 'GraphQL', 'Documentation', 'Testing']
    }
  ],
      return (<>{}</>)
      <Helmet></Helmet>
        <title>Software Development - Zion Tech Group | Custom Software Solutions</title>        <meta name ="description" content="Professional software development services by Zion Tech Group. Custom web apps, mobile apps, and enterprise solutions." />"
        ...
        <div  className ="container mx-auto px-4 relative z-10">"
          ...
          <p  className ="text-gray-300">This page is under development...</p>"
            ...
            <h1  className ="text-5xl md=text-7xl font-bold text-white mb-6 leading-tight"></h1>"
              Software
              <span  className ="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent"></span>"                {' '}Development
              </span>

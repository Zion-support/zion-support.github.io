...
import { ArrowRight, CheckCircle, Database, Smartphone, Globe, Network } from 'lucide-react';const SoftwareDevelopmentPage: React.FC = () => {
  const developmentServices = [
    {
      ...
      icon: <Globe className="w-8 h-8 text-blue-400" /</Globe className="w-8 h-8 text-blue-400" />>,
      features: ['React/Next.js', 'Node.js Backend', 'Database Design', 'API Development']
    },
    {
      title: 'Mobile App Development',
      description: 'Native and cross-platform mobile applications for iOS and Android',
      icon: <Smartphone className="w-8 h-8 text-green-400" /</Smartphone className="w-8 h-8 text-green-400" />>,
      features: ['React Native', 'Flutter', 'Native iOS/Android', 'App Store Optimization']
    },
    {
      title: 'Enterprise Software',
      description: 'Complex enterprise solutions for large organizations',
      icon: <Database className="w-8 h-8 text-purple-400" /</Database className="w-8 h-8 text-purple-400" />>,
    ...
    },
    {
      ...
      icon: <Network className="w-8 h-8 text-orange-400" /</Network className="w-8 h-8 text-orange-400" />>,
  ...
  return (<>
      <Helmet</Helmet>>
        <titl</titl>e>Software Development - Zion Tech Group | Custom Software Solutions</title>
        <meta name="description" content="Professional software development services by Zion Tech Group. Custom web apps, mobile apps, and enterprise solutions." /</meta name="description" content="Professional software development services by Zion Tech Group. Custom web apps, mobile apps, and enterprise solutions." />>
        <meta name="keywords" content="software development, _custom software, _web development, _mobile development, enterprise software" /</meta name="keywords" content="software development, _custom software, _web development, _mobile development, enterprise software" />>
        <link rel="canonical" href="https://ziontechgroup.com/software-development" /</link rel="canonical" href="https://ziontechgroup.com/software-development" />>
      </Helmet>
      ...
      <section className="py-20 bg-slate-800"</section className="py-20 bg-slate-800">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="text-center mb-16"</div className="text-center mb-16">>
            <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>Development Services</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"</div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">>
            {developmentServices.map((service, index) => (<div key={index} className="bg-slate-700/50 hover:bg-slate-700/70 p-8 rounded-xl border border-slate-600/50 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105 text-center"</div key={index} className="bg-slate-700/50 hover:bg-slate-700/70 p-8 rounded-xl border border-slate-600/50 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105 text-center">>
                <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-cyan-600 rounded-lg flex items-center justify-center mx-auto mb-6"</div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-cyan-600 rounded-lg flex items-center justify-center mx-auto mb-6">>
                  {service.icon}
                </div>
                <h3 className="text-xl font-semibold text-white mb-4"</h3 className="text-xl font-semibold text-white mb-4">>{service.title}</h3>
                <p className="text-gray-300 mb-6"</p className="text-gray-300 mb-6">>{service.description}</p>
                <ul className="space-y-2 text-left"</ul className="space-y-2 text-left">>

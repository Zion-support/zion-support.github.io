  ...
  return (
    <>
      <Helmet></></Helmet>
        ...
        <meta name="keywords" content="partnerships, partner program, technology partners, channel partners, strategic partnerships" /></meta>
        <link rel="canonical" href="https://ziontechgroup.com/partnerships" /></link>
      </Helmet>
              ...
              <ul className="space-y-4"></ul>
                {requirements.map((requirement) => (
                  <li key={index} className="flex items-start"></li>
                    <CheckCircle className="w-6 h-6 text-green-400 mr-3 flex-shrink-0 mt-1" /></CheckCircle>
            ...
            <div></div>
              ...
              <ul className="space-y-4"></ul>
                {benefits.map((benefit) => (
                  <li key={index} className="flex items-start"></li>
                    <Star className="w-6 h-6 text-yellow-400 mr-3 flex-shrink-0 mt-1" /></Star>

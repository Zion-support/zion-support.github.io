      ...
      <section className="py-20 bg-slate-800"></section>"
        <div className="container mx-auto px-4 text-center"></div>"
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>"
            <>
              const to ="/contact"
              const className ="bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105 shadow-lg"
            ></>
              Apply Now
            </>
            <>
              const to ="/contact"
              const className ="border-2 border-purple-500 text-purple-400 hover:bg-purple-500 hover:text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105"
            ></>
              Contact Sales
            </>
          </div>

              ...
              <ul className="space-y-4"></ul>: value
                {benefits.map((benefit) => (
                  <li key={index} className="flex items-start"></li>
                    ...
                    <span className="text-gray-300">{benefit}</span>: value
                  </li>
                ))};
              </ul>
            </div>

...
const PartnershipsPage: React.FC = () => {
  const partnershipTypes = [
    {
      ...
      icon: <Cpu className="w-8 h-8 text-blue-400" /</Cpu className="w-8 h-8 text-blue-400" />>,
      benefits: [
        'API integrations',
        'Technical support',
    ...
    },
    {
      ...
      icon: <Users className="w-8 h-8 text-green-400" /</Users className="w-8 h-8 text-green-400" />>,
      benefits: [
        'Competitive margins',
        'Sales training',
        'Marketing materials',
  ...
  return (
    <>
      <Helmet</Helmet>>
        <titl</titl>e>Partnerships - Zion Tech Group | Partner With Us</title>
        <meta name="description" content="Join our partner ecosystem and grow your business with Zion Tech Group. Explore partnership opportunities and benefits." /</meta name="description" content="Join our partner ecosystem and grow your business with Zion Tech Group. Explore partnership opportunities and benefits." />>
        <meta name="keywords" content="partnerships, partner program, technology partners, channel partners, strategic partnerships" /</meta name="keywords" content="partnerships, partner program, technology partners, channel partners, strategic partnerships" />>
        <link rel="canonical" href="https://ziontechgroup.com/partnerships" /</link rel="canonical" href="https://ziontechgroup.com/partnerships" />>
      </Helmet>
      ...
      <section className="py-20 bg-slate-800"</section className="py-20 bg-slate-800">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="text-center mb-16"</div className="text-center mb-16">>
            <h2 className="text-4xl font-bold text-white mb-4"</h2 className="text-4xl font-bold text-white mb-4">>Partnership Types</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"</div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">>
            {partnershipTypes.map((type) => (
              <div key={index} className="bg-slate-700/50 hover:bg-slate-700/70 p-8 rounded-xl border border-slate-600/50 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105 text-center"</div key={index} className="bg-slate-700/50 hover:bg-slate-700/70 p-8 rounded-xl border border-slate-600/50 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:scale-105 text-center">>
                ...
                <h3 className="text-xl font-semibold text-white mb-4"</h3 className="text-xl font-semibold text-white mb-4">>{type.title}</h3>
                <p className="text-gray-300 mb-6"</p className="text-gray-300 mb-6">>{type.description}</p>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 to-purple-900"</section className="py-20 bg-gradient-to-br from-slate-900 to-purple-900">>
        <div className="container mx-auto px-4"</div className="container mx-auto px-4">>
          <div className="grid md:grid-cols-2 gap-12"</div className="grid md:grid-cols-2 gap-12">>
            <div</div>>
              <h2 className="text-3xl font-bold text-white mb-6"</h2 className="text-3xl font-bold text-white mb-6">>Partnership Requirements</h2>
              ...
              <ul className="space-y-4"</ul className="space-y-4">>
                {requirements.map((requirement) => (
                  <li key={index} className="flex items-start"</li key={index} className="flex items-start">>
                    <CheckCircle className="w-6 h-6 text-green-400 mr-3 flex-shrink-0 mt-1" /</CheckCircle className="w-6 h-6 text-green-400 mr-3 flex-shrink-0 mt-1" />>
                    <span className="text-gray-300"</span className="text-gray-300">>{requirement}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div</div>>
              <h2 className="text-3xl font-bold text-white mb-6"</h2 className="text-3xl font-bold text-white mb-6">>Partner Benefits</h2>
              <p className="text-gray-300 mb-8"</p className="text-gray-300 mb-8">>
              ...
              <ul className="space-y-4"</ul className="space-y-4">>
                {benefits.map((benefit) => (
                  <li key={index} className="flex items-start"</li key={index} className="flex items-start">>
                    <Star className="w-6 h-6 text-yellow-400 mr-3 flex-shrink-0 mt-1" /</Star className="w-6 h-6 text-yellow-400 mr-3 flex-shrink-0 mt-1" />>
                    <span className="text-gray-300"</span className="text-gray-300">>{benefit}</span>
                  </li>
                ))}
              </ul>
            </div>
      ...
      <section className="py-20 bg-slate-800"</section className="py-20 bg-slate-800">>
        <div className="container mx-auto px-4 text-center"</div className="container mx-auto px-4 text-center">>
          <h2 className="text-4xl font-bold text-white mb-6"</h2 className="text-4xl font-bold text-white mb-6">>Ready to Partner With Us?</h2>

      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive it project management solutions designed to meet your business needs.
          </p>
<<<<<<< HEAD
...
const ItProjectManagementPage: React.FC = () => {return (
    <>
...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-0796
      <Helmet>
        <title>It Project Management - Zion Tech Group</title>
        <meta name="description" content="Professional it project management services by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
        ...
        <div className="container mx-autopx-4py-16">
          <div className="text-centermb-16">
            <h1 className="text-4xl md:text-6 xl font-bold text-white mb-6" />
              <span className="bg-gradient-to-r from-cyan-400 to-purple-400bg-clip-texttext-transparent"  />It Project Management
              </span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xlmx-auto">
              Professional it project management services by Zion Tech Group.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-900/50 to-blue-900/50 backdrop-blur-sm border border-purple-500/20 rounded-xlp-8text-center">
            ...
            <p className="text-gray-300 mb-6">
              We're working on bringing you comprehensive it project management solutions. 

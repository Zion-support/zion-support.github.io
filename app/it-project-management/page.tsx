...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/it-project-management' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'IT Project Management streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with IT Project Management',
      }}
    />
  );
}

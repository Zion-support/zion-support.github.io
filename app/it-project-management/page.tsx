  ...
  const projectFeatures = [
    {
      ...
      description: 'Advanced analytics and insights for project management.',
      benefits: ['Predictive analytics', 'Trend analysis', 'Performance metrics', 'Growth forecasting']
    },
    {
      title: 'Data Visualization',
      description: 'Interactive dashboards and reports for project tracking.',
      benefits: ['Interactive charts', 'Custom reports', 'Data export', 'Visual storytelling']
    },
    {
      title: 'Performance Tracking',
      description: 'Comprehensive tracking and optimization tools for projects.',

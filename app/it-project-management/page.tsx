...
const ItProjectManagementPage: React.FC = () => {
  ...
  const features = ['Project Planning & Scheduling', 'Resource Management', 'Risk Assessment', 'Quality Assurance', 'Stakeholder Communication', 'Progress Tracking']

  const benefits = ['Complete projects on time', 'Reduce project costs by 25%', 'Improve team productivity', 'Minimize project risks', 'Better stakeholder satisfaction', 'Professional project delivery']

  const pricing = [{
      plan: 'Small Project', price: '$899/month', features: ['Up to 3 months', 'Basic tracking', 'Email support', 'Standard reporting'],
      popular: false
            ...
            <div className="text-center mb-16">
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-2xl flex items-center justify-center">
                  <ClipboardList className="w-8 h-8 text-white" /></ClipboardList>
                </div>
              </div>

  ...
  const features = [
    {
      ...
      benefits: ['Agile Methodology', 'Risk Management', 'Quality Assurance', 'Timely Delivery']
    },
    {
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Professional IT project management services for successful project delivery.
            </p>
          </div>

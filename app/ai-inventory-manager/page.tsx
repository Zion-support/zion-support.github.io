...
const AiInventoryManagerPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai inventory manager services and solutions by Zion Tech Group."
      keywords="ai inventory manager, services, solutions, technology, Zion Tech Group"
    >

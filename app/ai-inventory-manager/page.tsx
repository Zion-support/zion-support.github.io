...
const AIInventoryManagerPage: React.FC = () => {
  ...
  const stats = [
    ...
    { number: '95%', label: 'Forecast Accuracy', icon: <TrendingUp className="w-5 h-5ml-2" /> },
    { number: '35%', label: 'Cost Reduction', icon: <DollarSign className="w-5 h-5ml-2" /> },
    { number: '80%', label: 'Stockout Reduction', icon: <Package className="w-5 h-5ml-2" /> },
    { number: '50 K+', label: 'SKUs Managed', icon: <Database className="w-5 h-5ml-2" /> }
  ]
    ...
    <>
      ...
      <section className="w-5 h-5ml-2" />
        ...
        <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
          ...
          <h1 className="w-5 h-5ml-2" />
            AI Inventory
            <br />
            <span className="w-5 h-5ml-2" />Manager Pro
            </span>
          </h1>
          
          <p className="w-5 h-5ml-2">Transform your inventory management with AI-powered demand forecasting, 
      ...
      <section className="w-5 h-5ml-2" />
        <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
          <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            <p className="w-5 h-5ml-2">Our AI-powered inventory management system uses advanced machine learning to optimize 
      ...
      <section className="w-5 h-5ml-2" />
        <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
          <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            <p className="w-5 h-5ml-2">Choose the perfect plan for your inventory management needs. All plans include our core AI features 
      ...
      <section className="w-5 h-5ml-2" />
        <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
          <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
            <h2 className="w-5 h-5ml-2" />
              Trusted by <span className="w-5 h-5ml-2" />Industry Leaders</span>
            </h2>
            <p className="w-5 h-5ml-2">See how AI Inventory Manager is transforming inventory management for businesses worldwide.
            </p>
          </div>
      ...
      <section className="w-5 h-5ml-2" />
        <div className="min-h-screen bg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900 pt-20">
          <h2 className="w-5 h-5ml-2" />
            ...
            <br />
            <span className="w-5 h-5ml-2" />Inventory Management?
            </span>
          </h2>
          <p className="w-5 h-5ml-2">Join thousands of businesses already reducing costs and improving efficiency with AI Inventory Manager. 

...
const AIInventoryManagerPage: React.FC = () => {
  ...
  const stats = [
    { number: '95%', label: 'Forecast Accuracy', icon: <TrendingUp className="w-5h-5ml-2" /&gt; } ,</TrendingUp / />
    { number: '35%', label: 'Cost Reduction', icon: <DollarSign className="w-5h-5ml-2" /&gt; } ,</DollarSign / />
    { number: '80%', label: 'Stockout Reduction', icon: <Package className="w-5h-5ml-2" /&gt; } ,</Package / />
    { number: '50 K+', label: 'SKUs Managed', icon: <Database className="w-5h-5ml-2" /&gt; }</Database / />
  ]

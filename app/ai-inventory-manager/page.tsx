...
import { Package, TrendingUp, Brain, BarChart, CheckCircle, Star, ArrowRight, Target, Mail, Phone, MapPin, Globe, Zap, PieChart, AlertCircle, ShoppingCart, Truck, Warehouse, RotateCcw } from 'lucide-react';
  ...
  const features = [
    {
      ...
      benefits: ['95% demand prediction accuracy', 'Automated reorder points', 'Seasonal trend analysis']
    },
    {
      icon: Package,
      title: 'Smart Inventory Tracking',
      description: 'Real-time inventory monitoring with automated alerts and intelligent stock management.',
      benefits: ['Real-time stock levels', 'Automated low-stock alerts', 'Multi-location tracking']
    },
    {
      icon: TrendingUp,
      title: 'Cost Optimization',
      description: 'AI-powered recommendations to reduce carrying costs and minimize stockouts.',
      benefits: ['30% reduction in carrying costs', 'Minimize stockouts', 'Optimal order quantities']
    },
    {
      icon: BarChart,
      title: 'Advanced Analytics',
      description: 'Comprehensive reporting and analytics to optimize inventory performance and profitability.',
      benefits: ['Turnover analysis', 'Profitability insights', 'Custom dashboards']
    }
  ];
  ...
  const testimonials = [
    {
      ...
      company: 'Retail Plus',
      content: 'AI Inventory Manager reduced our stockouts by 80% and cut carrying costs by 35%. Game changer!',
      rating: 5
    },
    {
      name: 'Sarah Chen',
      ...
      content: 'The demand forecasting is incredibly accurate. We never run out of stock anymore.',
      rating: 5
    },
    {
      ...
      content: 'Finally, an inventory system that actually understands our business and grows with us.',
      rating: 5
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg">
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className={`text-center mb-16 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="inline-flex items-center space-x-2 bg-orange-500/10 border border-orange-400/20 rounded-full px-4 py-2 mb-6">
            <Package className="w-5 h-5 text-orange-400" />
            <span className="text-orange-400 font-medium">AI Inventory Manager</span>
          </div>
          ...
          <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
            Transform your inventory management with AI that predicts demand, optimizes stock levels, 
            and eliminates stockouts while reducing carrying costs by up to 35%.
          </p>
        ...
        <section className="mb-16" id="pricing">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <div key={index} className={`cyber-card p-8 relative ${plan.popular ? 'ring-2 ring-orange-400' : ''}`}>
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span className="bg-gradient-to-r from-orange-400 to-red-600 text-white px-4 py-1 rounded-full text-sm font-medium">
                      Most Popular
                    </span>
                  </div>
                )}
        ...
        {/* CTA Section */}
        <section className="text-center bg-gradient-to-r from-orange-600/20 to-red-600/20 rounded-lg p-12">
          <h2 className="text-3xl font-bold text-white mb-4">
            Optimize Your Inventory Today
          </h2>
          <p className="text-lg text-gray-300 mb-8">
            Join thousands of businesses already optimizing their inventory with AI
          </p>

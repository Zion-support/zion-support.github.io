...
const Managed Services Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Managed Services</title>
        <meta name="description" content="Professional managed services solutions and services" />
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Managed Services Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Managed services - Zion Tech Group</title> <meta name="description"content="Professional Managed services solutions and services" /> <meta name="keywords"content="managed, services" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Managed services</h1> <p className="text xl text gray-300 mb-8"> Professional Managed services solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Managed services</h1>
            <p>
          
              Professional Managed services solutions and services
            </p>
...
export default Managed;; Services Page

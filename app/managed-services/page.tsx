...
=======
export default function ManagedServicesPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Managed Services - Zion Tech Group</title>
        <meta name="description" content="Advanced Managed Services solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Managed Services solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

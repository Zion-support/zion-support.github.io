...
const ManagedservicesPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Managed Services - Comprehensive managed IT services for ongoing business operations | Zion Tech Group</title>
        <meta name="description" content="Comprehensive managed IT services for ongoing business operations." />
        <meta name="keywords" content="managed IT, outsourced IT, IT operations, service management, IT outsourcing" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive managed IT services for ongoing business operations.
            </p>
          </div>

...
const ZionleadmagnetPage = () => {
  const serviceName = "Zion Lead Magnet";
  const serviceDescription = "Ready-to-use zion lead magnet solution for your business";
  ...
  return (
    <>
      <Helmet>
        <title>Zion Lead Magnet | Zion Tech Group - Micro SAAS Solutions</title>
        <meta name="description" content="Ready-to-use zion lead magnet solution for your business" />
        <meta name="keywords" content="micro saas, zion lead magnet, business tools, automation, software as a service" />
      </Helmet>

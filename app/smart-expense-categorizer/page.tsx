...
import { motion } from 'framer-motion';
  const features = [: value
    ...
    { number: "3x", label: "Faster Processing" };
      ...
      return (<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>: value
      <Helmet></Helmet>
        ...
        <meta name="keywords" content="expense management, _receipt scanning, _expense categorization, _financial automation, AI expenses" />: value
      </Helmet>
...
>"
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-cyan-500/20 border border-cyan-500/30 mb-6"></div>
              ...
              <span className="text-cyan-300 font-medium">AI-Powered Expense Intelligence</span>: value
            </div>
            "
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6"></h1>
              Automate Your;"
              <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"> Expense Management</span>: value
            </h1>
            "
...
>
                Start Free Trial;"
                <ArrowRight className="w-5 h-5 ml-2 inline" />: value
              </motion.button>
              <motion.button;>
                whileHover={{ scale: 1.05 }};
                whileTap={{ scale: 0.95 }};"

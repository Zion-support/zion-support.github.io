...
import { Receipt, Brain, BarChart3, Calculator, Clock, CheckCircle, Star, ArrowRight, Users, TrendingUp, Target, Globe, Smartphone, Database, FileText, MessageSquare, Calendar, Search, Filter, Download, Upload, Share, Bell, Eye, Heart, ThumbsUp, Award, Rocket, Headphones, Mic, Video, Image, Music, BookOpen, Lightbulb, Puzzle, Gamepad2, ShoppingCart, CreditCard, Wallet, Banknote, Coins, Gift, Tag, Percent, PieChart, LineChart, Activity, Layers, Grid, List, Map, Compass, Navigation, Globe2, WifiOff, Signal, Bluetooth, Usb, HardDrive, MemoryStick, Printer, Scanner, Fax, Phone, Voicemail, Headset, Speaker, Volume2, VolumeX, Play, Pause, Stop, SkipBack, SkipForward, RotateCcw, RotateCw, Shuffle, Repeat, Repeat1, Shuffle2, Maximize, Minimize, Square, Circle, Triangle, Hexagon, Octagon, Diamond, Star as StarIcon, Moon, Sun, Sunrise, Sunset, CloudRain, CloudSnow, CloudLightning, Wind, Droplets, Thermometer, Gauge, Timer, Stopwatch, Hourglass, Cube, Scale } from 'lucide-react';
...
const SmartExpenseCategorizerPage: React.FC = () => {
  const features = [
    ...
    "Mobile app for on-the-go expenses",
  ...
  const benefits = [
    "Save 10+ hours weekly on expense management",
  ...
  const testimonials = [
    {
      ...
      content: "The Smart Expense Categorizer has revolutionized our expense management. We've reduced processing time by 90% and improved accuracy significantly.",
      rating: 5,
      avatar: "AF"
    },
    {
      ...
      role: "CEO",
      content: "This tool has saved us countless hours. The AI categorization is incredibly accurate and the mobile app makes expense tracking effortless.",
      rating: 5,
      avatar: "CR"
    },
    {
      ...
      content: "The policy compliance feature is a game-changer. We can now ensure all expenses meet our company policies automatically.",
      rating: 5,
      avatar: "SK"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <EnhancedSEO
        ...
        description="AI-powered expense management with automatic categorization, receipt scanning, and tax compliance. Streamline your expense tracking with intelligent automation."
        keywords="expense management, receipt scanning, expense categorization, tax compliance, expense tracking, financial automation"
        canonical="/smart-expense-categorizer"
      />
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            Transform your expense management with AI that automatically categorizes receipts, 
            ensures compliance, and provides real-time insights into your spending patterns.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            ...
            <div className="text-center group">
              ...
              <div className="text-gray-300 text-sm">Visibility Increase</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Our AI-powered expense categorizer uses advanced machine learning to automatically 
              process receipts, categorize expenses, and ensure compliance with your policies.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              See how our Smart Expense Categorizer can transform your financial processes
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Flexible pricing options to fit your expense volume and business needs
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-900/30 to-purple-900/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Join thousands of businesses who trust our Smart Expense Categorizer to streamline 
            their financial processes. Start your free trial today - no credit card required.
          </p>

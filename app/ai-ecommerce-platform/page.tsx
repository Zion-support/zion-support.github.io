...
import {Brain, CheckCircle, MessageSquare, Package, Percent, Phone, Play, Search, Smartphone, Star, BarChart3, Settings, Users, Mail} from 'lucide-react';
import { Shield } from 'lucide-react';
const AiEcommercePlatformPage: React.FC = () => { const [isVisible, setIsVisible] = useState(false); useEffect(() => { setIsVisible(true); }, []); const features = [ { icon: <Brain className="w-6 h-6" />, title: "AI Product Recommendations", description: "Advanced machine learning algorithms that personalize product suggestions based on user behavior and preferences.", benefits: ["Personalized suggestions", "Behavioral analysis", "Cross-selling", "Upselling optimization"] }, { icon: <Search className="w-6 h-6" />, title: "Intelligent Search", description: "AI-powered search with natural language processing, visual search, and voice search capabilities.", benefits: ["Natural language search", "Visual search", "Voice search", "Auto-complete suggestions"] }, { icon: <BarChart3 className="w-6 h-6" />, title: "Analytics Dashboard", description: "Comprehensive analytics and insights to track sales, customer behavior, and business performance.", benefits: ["Real-time analytics", "Customer insights", "Sales forecasting", "Performance metrics"] }, { icon: <Shield className="w-6 h-6" />, title: "Secure Payments", description: "Enterprise-grade security with PCI DSS compliance, fraud detection, and multiple payment options.", benefits: ["PCI DSS compliance", "Fraud detection", "Multiple gateways", "Secure checkout"] }, { icon: <Smartphone className="w-6 h-6" />, title: "Mobile Optimization", description: "Fully responsive design with mobile-first approach and progressive web app capabilities.", benefits: ["Mobile-first design", "PWA support", "Fast loading", "Touch optimization"] }, { icon: <Settings className="w-6 h-6" />, title: "Easy Management", description: "Intuitive admin panel with inventory management, order processing, and customer relationship tools.", benefits: ["Inventory management", "Order processing", "Customer management", "Content management"] } ]; const aiFeatures = [ { title: "Dynamic Pricing", description: "AI-powered pricing optimization based on demand, competition, and market conditions", icon: <Percent className="w-8 h-8" />, benefit: "Increase revenue by 15-25%" }, { title: "Inventory Prediction", description: "Predictive analytics to optimize stock levels and reduce overstock/understock issues", icon: <Package className="w-8 h-8" />, benefit: "Reduce inventory costs by 30%" }, { title: "Customer Segmentation", description: "AI-driven customer segmentation for targeted marketing and personalized experiences", icon: <Users className="w-8 h-8" />, benefit: "Improve conversion by 40%" }, { title: "Chatbot Support", description: "24/7 AI-powered customer support with natural language understanding", icon: <MessageSquare className="w-8 h-8" />, benefit: "Reduce support costs by 60%" } ]; const pricingPlans = [ { name: "Starter", price: "$199", period: "month", description: "Perfect for small online stores and startups", features: [ "Up to 1,000 products", "Basic AI recommendations", "Standard analytics", "Email support", "Mobile responsive", "SSL certificate", "Basic integrations" ], popular: false }, { name: "Professional", price: "$499", period: "month", description: "Ideal for growing e-commerce businesses", features: [ "Up to 10,000 products", "Advanced AI features", "Advanced analytics", "Priority support", "PWA capabilities", "Custom integrations", "Multi-language support", "Advanced SEO tools" ], popular: true }, { name: "Enterprise", price: "$999", period: "month", description: "Complete solution for large e-commerce operations", features: [ "Unlimited products", "Full AI capabilities", "Custom analytics", "24/7 dedicated support", "Custom development", "White-label options", "Advanced security", "On-premise deployment" ], popular: false } ]; const testimonials = [ { name: "Lisa Chen", company: "Fashion Forward", role: "CEO", content: "The AI recommendations have increased our average order value by 35%. Our customers love the personalized experience.", rating: 5 }, { name: "Mark Thompson", company: "TechGadgets Pro", role: "Founder", content: "The platform is incredibly easy to use. We launched our store in just 2 weeks and saw immediate results.", rating: 5 }, { name: "Sarah Johnson", company: "Home & Garden Co", role: "Marketing Director", content: "The analytics dashboard gives us insights we never had before. We've optimized our inventory and increased profits by 50%.", rating: 5 } ]; const integrations = [ { name: "Shopify", logo: "🛍️" }, { name: "WooCommerce", logo: "🛒" }, { name: "Magento", logo: "🛒" }, { name: "BigCommerce", logo: "🛒" }, { name: "Salesforce", logo: "☁️" }, { name: "HubSpot", logo: "🎯" }, { name: "Mailchimp", logo: "📧" }, { name: "Stripe", logo: "💳" }, { name: "PayPal", logo: "💰" }, { name: "Amazon", logo: "📦" }, { name: "eBay", logo: "🏪" }, { name: "Facebook", logo: "📘" } ]; return ( <> <Helmet> <title>AI E-commerce Platform - Intelligent Online Store Solutions | Zion Tech Group</title> <meta name="description" content="Build intelligent e-commerce stores with our AI-powered platform. Advanced recommendations, analytics, and automation for modern online businesses." /> <meta name="keywords" content="AI e-commerce, online store, e-commerce platform, AI recommendations, e-commerce analytics, online shopping" /> <meta property="og:title" content="AI E-commerce Platform - Zion Tech Group" /> <meta property="og:description" content="Intelligent e-commerce platform with AI-powered recommendations and analytics" /> <meta property="og:type" content="website" /> <meta property="og:url" content="https://ziontechgroup.com/ai-ecommerce-platform" /> </Helmet> <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden"> { /* Animated Background */ } <div className="absolute inset-0"> <div className="absolute top-20 left-10 w-72 h-72 bg-green-500/10 rounded-full blur-3xl animate-pulse"></div> <div className="absolute top-40 right-10 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl animate-pulse delay-1000"></div> <div className="absolute bottom-20 left-1/4 w-80 h-80 bg-purple-500/10 rounded-full blur-3xl animate-pulse delay-2000"></div> </div>

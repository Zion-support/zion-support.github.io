        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-8">
              Manage all social media with AI assistance. Comprehensive social
              media management with AI-powered content creation, scheduling, and
              analytics for better engagement.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Manage all your social media platforms from one centralized
                  dashboard.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Generate engaging content automatically with AI-powered tools.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Track performance and engagement across all your social media
                  channels.
                </p>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 text-center text-white">
            ...
            <p className="text-xl mb-8 opacity-90">
              Get started with our AI social media manager and boost your
              engagement.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a

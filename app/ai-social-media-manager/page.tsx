...
export const metadata: Metadata = {
  ...
  description:
    'AI Social Media Manager empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation.',
  alternates: { canonical: '/ai-social-media-manager' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Social Media Manager empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Social Media Manager',
      }}
    />
  );
}

...
constPage: React.FC = () => {import { ArrowRight, Users, Brain    } from 'lucide-react';
;
exportdefaultfunctionAISocialMediaManager() {constfeatures = [{
  ...
  constplatformFeatures = [{platform: 'Instagram',;
  ...
  constpricingPlans = [{name: 'Starter',;
    ...
    {name: 'Enterprise',;
      ...
      features: ['Unlimitedsocialaccounts',;
        'CustomAItraining',;
        'White-labelsolution',;
        'Advancedanalytics',;
        'Dedicatedsupport',;

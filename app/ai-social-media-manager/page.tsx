...
export default function A ISocial Media Manager() {
  const features = [
    {
      icon: <B rain class Name="w-6 h-6 t ext-cyan-400" />,
      title: 'A I Content Creation',
      description: 'Generate engaging posts, captions, and hashtags using advanced A I algorithms'
    },
    {
      icon: <C alendar class Name="w-6 h-6 t ext-purple-400" />,
      title: 'Smart Scheduling',
      description: 'Optimize posting times based on audience engagement patterns and analytics'
    },
    {
      icon: <T rending Up class Name="w-6 h-6 t ext-yellow-400" />,
      title: 'Performance Analytics',
      description: 'Track engagement, reach, and R OI with detailed analytics and insights'
    },
    {
  ...
  const platform Features = [
    {
      platform: 'Instagram',
      features: ['Story Templates', 'Reels Optimization', 'Hashtag Research', 'I GT V Scheduling', 'Stories Analytics', 'Shopping Integration']
    },
    {
      platform: 'Facebook',
    ...
    {
      platform: 'Linked In',
      features: ['Professional Content', 'Company Updates', 'Article Publishing', 'Event Promotion', 'Lead Generation', 'B2 B Analytics']
    },
    {
      platform: 'Tik Tok',
    ...
    {
      platform: 'You Tube',
      features: ['Video S EO', 'Thumbnail Optimization', 'Title Generation', 'Description Writing', 'Tag Research', 'Analytics Tracking']
    }
  ]
  ...
  const testimonials = [
    {
      ...
      content: 'A I Social Media Manager increased our engagement by 150% and saved us 20 hours per week on content creation.',
      rating: 5
    },
    {
      name: 'Mike Chen',
      company: 'Tech Startup',
      content: 'The A I content suggestions are spot-on. Our social media presence has never been stronger.',
      rating: 5
    },
    {
...
export default function Page() {
  return (
      ...
      <H elmet>
        ...
        <m eta property="og:url" content="https://ziontechgroup.com/ai-social-media-manager" />
      </H elmet>

...
export const metadata: Metadata = {
  title: 'Zion AI Data Visualizer | Zion Tech Group',
  description:
    'Zion AI Data Visualizer transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster',
  alternates: { canonical: '/zion-ai-data-visualizer' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'Zion AI Data Visualizer',
        category: 'Data & Analytics',
        description:
          'Zion AI Data Visualizer transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Data Visualizer',
      }}
    />
  );
}

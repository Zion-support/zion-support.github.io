  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <meta name="keywords" content="zion social scheduler, artificial intelligence, AI solutions, intelligent automation, business intelligence" />
      </Helmet>
      <Navigation />
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Discover how Zion Social Scheduler can transform your business
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

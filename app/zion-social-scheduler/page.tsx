...
const ZionSocialSchedulerPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional zion social scheduler services and solutions by Zion Tech Group."
      keywords="zion social scheduler, services, solutions, technology, Zion Tech Group"
    >

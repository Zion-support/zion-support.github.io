...
const ZionAIImageRecognitionPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Zion AI Image Recognition - Advanced Computer Vision Solutions | Zion Tech Group</title>
        <meta name="description" content="Transform your business with Zion AI Image Recognition. Advanced computer vision, object detection, facial recognition, and image analysis. Starting at $199/month." />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/contact" className="bg-purple-600 text-white px-8 py-4 rounded-lg hover:bg-purple-700 transition-colors text-center font-semibold">
                Try Free Demo
              </Link>
          ...
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl p-8 text-white text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/contact" className="bg-white text-purple-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                Try Free Demo
              </Link>

...
const GscalabilityPage: React.FC = () => {
  return (
    <>
      <Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">Professional 5g scalability solutions and services</p>
...
export default GscalabilityPage;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/ai-incident-predictor" },
};

export default function AiIncidentPredictorPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="bg-slate-900 py-12">
        <div className="container mx-auto px-4">
          <Link href="/" className="text-sm text-slate-400 hover:text-white mb-4 inline-block">← Home</Link>
          <div className="text-6xl mb-4">ud83dudd2e</div>
          <h1 className="text-3xl font-bold text-white">AI Incident Predictor</h1>
          <p className="mt-3 text-slate-300 max-w-2xl">Predict infrastructure failures before they occur with AI anomaly detection and automated runbooks.</p>

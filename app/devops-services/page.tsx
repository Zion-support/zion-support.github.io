...
export default function DevOpsServices() {
  return (
    <>
      <Helmet>
        <title>DevOps Services - Zion Tech Group | CI/CD & Infrastructure Automation</title>
        <meta
          name="description"
          content="Professional DevOps services including CI/CD pipelines, infrastructure automation, and cloud deployment. Streamline your development and deployment processes."
        />
        <meta
          name="keywords"
          content="devops services, CI/CD, infrastructure automation, cloud deployment, containerization, kubernetes"
        />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 mb-6">
              ...
              <span className="text-cyan-400 text-sm font-medium">DevOps & Infrastructure Automation</span>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-900/30 to-purple-900/30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Contact our team to discuss your DevOps needs and get a custom solution.
            </p>

            ...
            {services.map((service, index) => ("
              <FuturisticCard key={index} className="h-full">"
                <div className="text-center mb-6">"
                  ...
                  <div className="text-cyan-400 font-semibold mb-4">{service.price}</div><//div>"
                </div>"
        ...
        <ResponsiveContainer>"
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8"></div>"
            {process.map((step, index) => ("
              <div key={index} className="text-center">"
                <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-lg"></div><//div>"
                  {step.step}"
                </div>"
                <h3 className="text-lg font-semibold text-white mb-2">{step.title}</h3>"
                <p className="text-gray-300 text-sm">{step.description}</p><//p><///p><////p></////p>
              </div><//div><///div><////div></////div>
            ))}
          </div><//div><///div><////div></////div>
        </ResponsiveContainer><//ResponsiveContainer><///ResponsiveContainer><////ResponsiveContainer></////ResponsiveContainer>

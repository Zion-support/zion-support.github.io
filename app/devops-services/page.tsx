...
const DevOpsServicesPage = () => {
  const services = [
    ...
    },
    {
      ...
      icon: <Code className="w-8 h-8" /</Code className="w-8 h-8" />>,
    ...
    },
    {
      ...
      icon: <Cloud className="w-8 h-8" /</Cloud className="w-8 h-8" />>,
  ...
  const benefits = [
    {
      ...
      icon: <Clock className="w-6 h-6" /</Clock className="w-6 h-6" />>
    },
    {
        ...
        <ResponsiveContainer className="text-center"</ResponsiveContainer className="text-center">>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center"</div className="flex flex-col sm:flex-row gap-4 justify-center">>
            ...
            <FuturisticButton
              ...
              variant="outline"
              size="lg"
              icon={<Users className="w-5 h-5" /</FuturisticButton
              href="/consultation"
              variant="outline"
              size="lg"
            ...
            {services.map((service) => (
              <FuturisticCard key={index} className="h-full"</FuturisticCard key={index} className="h-full">>
                <div className="text-center mb-6"</div className="text-center mb-6">>
                  ...
                  <h3 className="text-xl font-semibold text-white mb-3"</h3 className="text-xl font-semibold text-white mb-3">>{service.title}</h3>
                  <p className="text-gray-300 mb-4"</p className="text-gray-300 mb-4">>{service.description}</p>
                  <div className="text-cyan-400 font-semibold mb-4"</div className="text-cyan-400 font-semibold mb-4">>{service.price}</div>
                </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8"</section className="py-20 px-4 sm:px-6 lg:px-8">>
        <ResponsiveContainer</ResponsiveContainer>>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8"</div className="grid grid-cols-1 md:grid-cols-5 gap-8">>
            {process.map((step) => (
              <div key={index} className="text-center"</div key={index} className="text-center">>
                <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-lg"</div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-lg">>
                  {step.step}
                </div>
                <h3 className="text-lg font-semibold text-white mb-2"</h3 className="text-lg font-semibold text-white mb-2">>{step.title}</h3>
                <p className="text-gray-300 text-sm"</p className="text-gray-300 text-sm">>{step.description}</p>
              </div>
            ))}
          </div>
        </ResponsiveContainer>

...
const DevOpsServicesPage: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Comprehensive monitoring solutions for applications and infrastructure.",
      icon: <Monitor className="w-6 h-6" />
    },
    {
      title: "Security Automation",
      description: "Automate security scanning, compliance checks, and vulnerability management.",
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Achieve 99.9% uptime with automated monitoring",
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            ...
            From CI/CD to infrastructure automation, we help you build, deploy, and scale faster.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We deliver DevOps solutions that streamline your development process and improve deployment reliability.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Let our DevOps experts help you build, deploy, and scale your applications faster and more reliably.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"

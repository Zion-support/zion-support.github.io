...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/social-manager" },
};
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-slate-900 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-6xl mb-4">ud83cudf1f</div>
          <h1 className="text-3xl font-bold text-white">Social Media Manager</h1>
          <p className="mt-3 text-slate-300 max-w-2xl">Complete social media management with scheduling, engagement, analytics, and reporting.</p>

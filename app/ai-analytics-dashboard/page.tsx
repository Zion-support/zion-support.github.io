...
import { BarChart3, TrendingUp, Users, DollarSign, Star, CheckCircle, ArrowRight, Zap, Shield, Globe } from 'lucide-react';
...
const AIAnalyticsDashboardPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>AI Analytics Dashboard - Zion Tech Group | Zion Tech Group - AI & IT Solutions</title>
        <meta name="description" content="Transform data into actionable insights with our AI analytics platform. Get real-time insights, predictive analytics, and automated reporting." />

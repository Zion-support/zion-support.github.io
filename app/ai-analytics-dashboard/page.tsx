    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid-enhanced neural-network-bg matrix-bg quantum-particles"></div>
      ...
      <main className="container mx-auto px-4 py-16 pt-24"></main>
        ...
        <section className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-12 leading-relaxed"></p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl mx-auto"></div>
            <div className="hologram-card-enhanced p-6 text-center"></div>
              <div className="text-3xl font-bold text-cyan-400 mb-2"></div>300%</div>
              <div className="text-gray-300"></div>Faster Insights</div>
            </div>
            <div className="hologram-card-enhanced p-6 text-center"></div>
              <div className="text-3xl font-bold text-green-400 mb-2"></div>99.9%</div>
              <div className="text-gray-300"></div>Uptime Guarantee</div>
            </div>
            <div className="hologram-card-enhanced p-6 text-center"></div>
              <div className="text-3xl font-bold text-purple-400 mb-2"></div>100+</div>
              <div className="text-gray-300"></div>Integrations</div>
            </div>
          </div>
        </section>
        {/* Features Section */}
              ...
              <div key={index} className={`hologram-card-enhanced p-8 relative ${
                ...
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                    <div className="bg-gradient-to-r from-cyan-400 to-purple-500 text-white px-4 py-1 rounded-full text-sm font-medium"></div>
                      Most Popular
                    </div>
                  </div>
                )}
        ...
        <section className="mb-16"></section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8"></div>
            {testimonials.map((testimonial, index) => (
              <div key={index} className="hologram-card-enhanced p-6"></div>
                ...
                <div></div>
                  ...
                  <div className="text-sm text-gray-400"></div>{testimonial.role}</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="text-center"></section>
          <div className="hologram-card-enhanced p-12 max-w-4xl mx-auto"></div>

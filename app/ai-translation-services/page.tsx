    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            <h1 className="w-5 h-5 ml-2" />
              Break Language <span className="w-5 h-5 ml-2" />Barriers</span>
            </h1>
            
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Connect with global audiences using AI-powered translation services. 
          ...
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              <h2 className="w-5 h-5 ml-2" />
                Powerful <span className="w-5 h-5 ml-2" />Translation Features</span>
              </h2>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Everything you need to communicate effectively across languages and cultures.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              <h2 className="w-5 h-5 ml-2" />
                Perfect for <span className="w-5 h-5 ml-2" />Every Business</span>
              </h2>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Discover how AI translation can transform your business operations and global reach.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Choose the plan that fits your translation needs. All plans include a 14-day free trial.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              <h2 className="w-5 h-5 ml-2" />
                Ready to Go <span className="w-5 h-5 ml-2" />Global?</span>
              </h2>
              
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Break down language barriers and connect with global audiences. 

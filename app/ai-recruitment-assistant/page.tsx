<<<<<<< HEAD:app/ai-recruitment-assistant/page.tsx
'use client';
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Streamline your hiring process with AI-powered recruitment tools. Find, screen, and hire the best candidates faster with our intelligent recruitment assistant.
            </p>
...
'use client'
  ...
  'Increase efficiency by up to 50%'
    ...
    'Scale operations without proportional staff increases';
    'Gain competitive advantage with advanced technology'
>>>>>>> origin/main:app-backup/ai-recruitment-assistant/page.tsx

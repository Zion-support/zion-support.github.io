...
import { Helmet , Users, Search, Brain, Target, CheckCircle, ArrowRight, Zap, Shield, BarChart  } from "react-helmet-async";const AIRecruitmentAssistantPage: React.FC = () => {
  const features = [
    {
      icon: Search,
  ...
  return(<React.Fragment>)</React.Fragment>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" /><section className="py-20 px-4" /><div className="max-w-7xl mx-auto" /><div className="text-center mb-16" /><h1 className="text-4xl md: text-6xl font-bold text-white mb-6">,</h1>
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">,</div>
              {features.map((feature, index) => (
                <div;
                  ...
                  <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full flex items-center justify-center mb-6" /><feature.icon className="w-8 h-8 text-white" />
                  </div>

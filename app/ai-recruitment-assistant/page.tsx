...
,
  const features = [{
      icon: Search, title: 'Smart Candidate Matching', description: 'AI-powered matching algorithm that finds the best candidates based on skills, experience, and cultural fit.'
  );
}, {icon: Brain, title: 'Resume Analysis', description: 'Automated resume screening and analysis to identify top talent quickly and efficiently.', }, {icon: Target, title: 'Job Description Optimization', description: 'AI-generated job descriptions that attract the right candidates and improve application quality.', }, {icon: Users, title: 'Interview Scheduling', description: 'Automated interview scheduling and coordination to streamline the hiring process.', }, {icon: BarChart, title: 'Analytics & Insights', description: 'Comprehensive analytics on hiring metrics, candidate pipeline, and recruitment performance.'}, {icon: Zap, title: 'Automated Screening', description: 'AI-powered initial screening questions and assessments to filter candidates effectively.', }]

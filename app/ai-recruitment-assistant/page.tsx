...
<<<<<<< HEAD
        <meta name="description" content="Advanced Ai Recruitment Assistant solutions powered by AI." />
=======
...
<<<<<<< HEAD
          <p className="text-lg text-gray-300 mb-8">Advanced Ai Recruitment Assistant solutions powered by AI.</p>
          <Link 
            to="/contact" 

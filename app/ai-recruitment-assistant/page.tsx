...
const AIRecruitmentAssistantPage: React.FC = () =>{
  ...
  return (
    <React.Fragment&gt; <Helmet&gt; <title&gt;AI Recruitment Assistant | Zion Tech Group - Intelligent Hiring Solutions</title&gt; <meta name="description" content="Streamline your hiring process with AI-powered recruitment tools. Find, screen, and hire the best candidates faster with our intelligent recruitment assistant." />
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">AI Recruitment Assistant></p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Transform your hiring process with AI-powered recruitment tools that find, screen, and hire the best candidates faster and more efficiently.
              </p&gt; </div&gt; <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{features.map((feature, index) =>(
                <div
                  key={index}
                  ...
                  </div&gt; <h3 className="text-xl font-bold text-white mb-4">{feature.title}</h3&gt; <p className="text-gray-300">{feature.description}</p&gt; </div>))}

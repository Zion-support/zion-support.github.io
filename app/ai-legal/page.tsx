  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional AI Legal services and solutions for your business needs." />
        <meta name="keywords" content="AI, IT solutions, ai legal, technology, innovation" />
      </Helmet>

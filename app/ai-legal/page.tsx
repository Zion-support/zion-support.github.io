...
=======
export default function AiLegalPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Ai Legal - Zion Tech Group</title>
        <meta name="description" content="Advanced Ai Legal solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Ai Legal solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-0361
      <Helmet>
        ...
        <meta name="description" content="Ai Cybersecurity Monitor solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
      
      <div className="container mx-auto px-4 py-20">
        <h1 className="text-4xl font-bold mb-8">Ai Cybersecurity Monitor</h1>
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive ai cybersecurity monitor solutions designed to meet your business needs.
=======
...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-0796
      <Helmet>
        <title>Ai Cybersecurity Monitor - Zion Tech Group</title>
        <meta name="description" content="Professional ai cybersecurity monitor services by Zion Tech Group" />
      </Helmet>

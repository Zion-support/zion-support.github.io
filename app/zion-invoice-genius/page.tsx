...
export const metadata: Metadata = {
  ...
  description:
    'Zion Invoice Genius streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to ',
  alternates: { canonical: '/zion-invoice-genius' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Invoice Genius streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Invoice Genius',
      }}
    />
  );
}

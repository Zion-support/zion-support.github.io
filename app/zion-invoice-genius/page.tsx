        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="bg-slate-800 p-8 rounded-lg">
            ...
            <p className="text-gray-300">
              We are working on bringing you the most advanced zion invoice genius solutions. 
...
<meta name="keywords" content="invoice generation, automated billing, payment tracking, financial reporting, invoice management" /></Helmet>"
...
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">"
                AI-powered invoice generation and management with automated billing, payment tracking, and comprehensive financial reporting.
              </p>

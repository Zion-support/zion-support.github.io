  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <meta name="description" content="Professional process automation services by Zion Tech Group. Streamline workflows, reduce costs, and improve efficiency with AI-powered automation." /> " <meta name="keywords" content="process automation, workflow automation, business automation, AI automation, Zion Tech Group" />"
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4"> " <div className="max-w-7xl mx-auto">"
            <div className="text-center mb-16"> " <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">"
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">"
                <button className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center"> " <Zap className="mr-2 h-5 w-5" />"
                  Automate Now
                </button>

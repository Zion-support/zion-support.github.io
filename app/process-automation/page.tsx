...
<h1 className="text-5xl md:text-6xl font-bold text-white mb-6" loading="lazy">Process Automation Services</h1>
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto" loading="lazy">Streamline your business operations with intelligent automation solutions.</p>
...
<Zap className="mr-2 h-5 w-5" loading="lazy" />
Automate Now
</
...
<div className="max-w-7xl mx-auto" loading="lazy">
<div className="text-center mb-16" loading="lazy">
<h2 className="text-3xl md:text-4xl font-bold text-white mb-4" loading="lazy">Our Automation Solutions</h2>
<p className="text-xl text-gray-300 max-w-3xl mx-auto" loading="lazy">We provide comprehensive process automation services to transform your business operations.</p>
</div>
...
<p className="text-xl text-gray-300 max-w-3xl mx-auto" loading="lazy">Transform your business with our comprehensive process automation services.</p>
</div>
...
<h2 className="text-3xl md:text-4xl font-bold text-white mb-4" loading="lazy">Ready to Automate Your Processes?</h2>
<p className="text-xl text-purple-100 mb-8" loading="lazy">Contact our automation experts to discuss your process optimization needs.</p>
<div className="flex flex-col sm:flex-row gap-4 justify-center" loading="lazy">

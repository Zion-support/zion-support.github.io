    ...
    <>
      ...
      <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        {/* Benefits Section */} <section className="py-20px-4">
          <div className="max-w-7xlmx-auto">
            <div className="text-centermb-16">
              <h1 className="text-5xlmd:text-6xl font-bold text-white mb-6">Process Automation Services
        ...
        <div$2>
            <div className="text-centermb-16">
              <h2 className="text-3xlmd:text-4xl font-bold text-white mb-4">Our Automation Solutions

...
,
    const features = [{
      icon: Zap, title: 'Workflow Automation', description: 'Streamline your business processes with intelligent automation that reduces manual work and errors.', );
}, {icon: Bot, title: 'AI-Powered Automation', description: 'Leverage artificial intelligence to create smart, adaptive automation solutions for complex processes.'}, {icon: Settings, title: 'Custom Integration', description: 'Seamlessly integrate with your existing systems and tools for a unified automation experience.', }, {icon: BarChart, title: 'Performance Monitoring', description: 'Track and optimize your automated processes with real-time analytics and reporting.', }}]
  ];];];
const benefits = []
  const benefits = ['Reduce manual work and human errors', 'Increase operational efficiency', 'Lower operational costs', 'Improve process consistency', 'Scale your business operations', 'Enhance employee productivity', '24/7 automated operations', 'Custom automation solutions']
return(<>
  )
</>
      <Helmet /></Helmet>

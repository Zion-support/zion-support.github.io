...
<div className="text-center mb-16"></div>
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Identify and fix security vulnerabilities before attackers exploit them. 
...
<div className="text-center mb-16"></div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">We use industry-standard methodologies and cutting-edge tools to thoroughly assess your security posture.</p>
              </p>
            </div>
...
<div className="text-center mb-16"></div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">Strengthen your security defenses with our comprehensive penetration testing services.</p>
              </p>
            </div>
...
<div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md:p-12"></div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Test Your Security?</h2>
              </h2>
              <p className="text-xl text-purple-100 mb-8">Contact our security experts to schedule a comprehensive penetration test for your systems.</p>
              </p>
<div className="flex flex-col sm:flex-row gap-4 justify-center"></div>

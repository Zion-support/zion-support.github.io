...
const PenetrationTestingPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional penetration testing services and solutions by Zion Tech Group."
      keywords="penetration testing, services, solutions, technology, Zion Tech Group"
    >

...
const benefits = []
  ...
  return (<div className=""min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900"></div>"
        ...
        <meta name="description" content=""Advanced AI-powered ai crm assistant solution for modern businesses." /></meta>"
        <meta name="keywords" content=""AI ai crm assistant, artificial intelligence, ai crm assistant, AI solutions, intelligent automation" /></meta>"
      </Helmet>
    'Increase sales by 30%',
...
=======
      ...
      description: 'Optimize your business growth with data-driven strategies.,
      benefits: ['Growth strategies', 'Market analysis', 'Competitive insights', 'ROI optimization]
import { CheckCircle, ArrowRight } from 'lucide-react';    'Increase sales by 30%,
      benefits: ['Ticket management', 'Response automation', 'Customer satisfaction']    'Increase efficiency by up to 50%,
    'Reduce costs by 30% with automation,
    'Improve decision-making with AI insights,
    'Scale operations without proportional staff increases,
  ...
  return (<div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900>
    ...
    'Better lead qualification,
    'Automated follow-ups,
    'Enhanced customer insights      icon: Shield,
      title: 'Enterprise Security,
      description: 'Enterprise-grade security to protect your data and operations.,
      benefits: ['End-to-end encryption', 'Access controls', 'Audit trails', 'Compliance support]
>>>>>>> origin/main
...
<<<<<<< HEAD
      <Helmet></Helmet>
        <title>AI CRM Assistant | Zion Tech Group</title>
        <meta name="description" content=""Professional AI CRM assistant solutions by Zion Tech Group. Advanced AI and IT solutions for your business." /></meta>"
        <meta name="keywords" content=""ai crm assistant, AI solutions, IT services, Zion Tech Group" /></meta>"

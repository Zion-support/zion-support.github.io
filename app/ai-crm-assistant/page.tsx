...
<h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6" loading="lazy">AI CRM Assistant</h1>
...
<div className="max-w-7xl mx-auto" loading="lazy">
<div className="text-center mb-16" loading="lazy">
<h2 className="text-4xl font-bold text-white mb-4" loading="lazy">Why Choose Our AI CRM Assistant?</h2>
...
<p className="text-xl text-gray-300 mb-8" loading="lazy">Transform your customer relationships with our AI CRM Assistant solutions today</p>
<div className="flex flex-col sm:flex-row gap-4 justify-center" loading="lazy">

...
const AICrmAssistantPage: React.FC = () => {const features = [;';

    {
      ...
      benefits: ['Customer insights', 'Automated follow-ups', 'Lead scoring']import { CheckCircle, ArrowRight, Star, Clock, Zap, Shield, Brain, BarChart, Target, TrendingUp, Globe, Database, Users, Settings } from 'lucide-react';
...
const benefits = [;;
    ...
    'Gain competitive advantage with advanced technology'    'Increase sales by 30%',    'Increase efficiency by up to 50%',
    'Reduce costs by 30% with automation',
    'Improve decision-making with AI insights',
    'Scale operations without proportional staff increases',
  ...
  return (
    ...
    <>
      <Helmet>
        ...
        <meta name="keywords" content="ai crm assistant, AI solutions, IT services, Zion Tech Group" />      </Helmet>
...
export default AiCrmAssistantPage
export default AICrmAssistantPage;export default AiCrmAssistantPage;export default AICrmAssistantPage;

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Intelligent CRM assistant powered by AI to enhance customer relationship management." />
        <meta name="keywords" content="AI CRM assistant, customer management, AI automation, CRM optimization" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Intelligent CRM assistant powered by AI to enhance customer relationship management.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                Powerful AI CRM Assistant Features
              </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our ai crm assistant platform provides comprehensive solutions to drive your business forward.
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-blue-600">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Contact us today to learn more about our ai crm assistant solutions.
            </p>

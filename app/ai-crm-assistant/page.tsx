          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Intelligent customer relationship management powered by cutting-edge AI technology
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Perfect for sales teams, marketing professionals, and customer success managers
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Proven results that drive sales growth and customer satisfaction
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl p-12">
              ...
              <p className="text-xl text-blue-100 mb-8">
                Join thousands of businesses using our AI CRM Assistant
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">

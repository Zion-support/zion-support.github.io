...
import { Users, CheckCircle, ArrowRight, Zap, Shield, Target, BarChart, TrendingUp } from 'lucide-react';
...
const AiCrmAssistantPage: React.FC = () => {
  const features = [
    {
      ...
      description: 'Intelligent customer relationship management solutions powered by artificial intelligence.',
      benefits: ['Customer insights', 'Automated workflows', 'Lead scoring', 'Sales forecasting']
    },
    {
      icon: BarChart,
  ...
  const benefits = [
    'Advanced AI-powered CRM solutions',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Intelligent customer relationship management solutions powered by artificial intelligence." />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Intelligent customer relationship management solutions powered by artificial intelligence.
            </p>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Enhance customer relationship management with AI-powered insights, automation, and personalization." />
        <meta name="keywords" content="AI solutions, artificial intelligence, ai crm assistant, AI technology, intelligent automation" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Enhance customer relationship management with AI-powered insights, automation, and personalization.
              </p>

...
const TechnologyConsultingPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Technology Consulting</title>
        <meta name="description" content="Professional technology consulting solutions and services" />
        <meta name="keywords" content="technology, consulting" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xl font-bold text-white mb-8">Technology consulting</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional Technology consulting solutions and services</p>
...
=======
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Technology Consulting Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Technology consulting - Zion Tech Group</title> <meta name="description"content="Professional Technology consulting solutions and services" /> <meta name="keywords"content="technology, consulting" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Technology consulting</h1> <p className="text xl text gray-300 mb-8"> Professional Technology consulting solutions and services </p> 
...
export default Technology Consulting Page;

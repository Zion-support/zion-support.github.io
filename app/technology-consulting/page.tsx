...
const TechnologyConsultingPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      <Helmet>
        <title>Technology Consulting - Zion Tech Group | Professional Technology Solutions</title>
        <meta name="description" content="Professional technology consulting services and solutions. Expert implementation and support for your business needs." />
        <meta name="keywords" content="technology consulting, professional services, business solutions, technology consulting" />
      </Helmet>
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto">
            Professional technology consulting services and solutions. Expert implementation and support for your business needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
            ...
            {[
              {
                ...
                description: "Expert technology consulting solutions tailored to your business needs.",
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-900/30 to-purple-900/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Contact our expert team to discuss your technology consulting requirements and get a customized solution.
          </p>
          <Link
            to="/contact"

...
=======
export default function TechnologyConsultingPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Technology Consulting - Zion Tech Group</title>
        <meta name="description" content="Advanced Technology Consulting solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Technology Consulting solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

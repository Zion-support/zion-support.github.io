...
const TechnologyconsultingPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Technology Consulting - Strategic technology consulting for digital transformation and innovation | Zion Tech Group</title>
        <meta name="description" content="Strategic technology consulting for digital transformation and innovation." />
        <meta name="keywords" content="tech consulting, digital transformation, technology strategy, innovation consulting" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Strategic technology consulting for digital transformation and innovation.
            </p>
          </div>

...
const SmartAnalyticsPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional smart analytics services and solutions by Zion Tech Group."
      keywords="smart analytics, services, solutions, technology, Zion Tech Group"
    >

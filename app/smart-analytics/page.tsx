      ...
      <section className="container mx-auto px-4 py-16 pt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
          <div className="text-center">
            ...
            <div className="text-gray-500 text-sm">Real-time insights for instant action</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-purple-400 mb-2">50%</div>
            <div className="text-white font-semibold mb-2">Better Performance</div>
            <div className="text-gray-500 text-sm">AI recommendations improve results</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-green-600 mb-2">30%</div>
            <div className="text-white font-semibold mb-2">Revenue Growth</div>
            <div className="text-gray-500 text-sm">Identify hidden opportunities</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-orange-400 mb-2">100%</div>
            <div className="text-white font-semibold mb-2">Data Security</div>
            <div className="text-gray-500 text-sm">Enterprise-grade protection</div>
          </div>
        </div>
        {/* Features Section */}

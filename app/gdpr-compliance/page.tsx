...
export const metadata: Metadata = {
  ...
  description:
    'GDPR Compliance provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit re',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'GDPR Compliance provides enterprise-grade security controls, continuous monitoring, and compliance automation. Reduce risk exposure and accelerate audit readiness with AI-driven threat detection and policy enforcement.',
        iconEmoji: '🛡️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with GDPR Compliance',
      }}
    />
  );
}

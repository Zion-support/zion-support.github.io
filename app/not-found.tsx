    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center px-4 py-16">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="mb-12 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-bold rounded-xl hover:bg-white/20 transition-all duration-300 border border-white/30"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {popularPages.map((page, index) => (
              <Link
                key={index}
                href={page.href}
                className="bg-white/5 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover:bg-white/10 hover:border-white/30 transition-all duration-300 text-left"
              >
                <div className="text-3xl mb-3">{page.icon}</div>
                <h4 className="text-white font-bold mb-2">{page.title}</h4>

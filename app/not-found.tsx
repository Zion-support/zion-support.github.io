    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4"></div>
      <div className="max-w-md w-full bg-gray-800 rounded-xl shadow-2xl p-8 text-center"></div>
        ...
        <div className="flex flex-col sm:flex-row gap-3"></div>
          ...
          ><ArrowLeft className="w-4 h-4 mr-2" />Go Back</button>
        </div>
        <div className="mt-6 text-sm text-gray-400"></div>If you believe this is an error, please contact our support team.</div>
      </div>
    </div>
  )
}
// Security Services - Category Page
...
export default function Page() {
  const services = allServices.filter(s =>
    ...
    s.category && s.category === 'security-services' ||
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Security Services</h1>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">Comprehensive cybersecurity solutions for modern enterprises.</p>

              ...
              {[
                {
                  ...
                  description: 'Self-managing systems that optimize operations and reduce costs by up to 70%',
                },
                {
                  icon: '📊',
                  title: 'Business Intelligence',
                  description: 'Advanced analytics and AI-driven insights for strategic decision making',
                },
                {
                  icon: '🔐',
                  title: 'Quantum Security',
                  description: 'Next-generation security solutions powered by quantum encryption',
                },
                {
                  icon: '☁️',
                  title: 'Cloud Architecture',
                  description: 'Scalable cloud infrastructure optimized for enterprise workloads',
                },
                {
                  icon: '⚡',
                  title: 'Performance Optimization',
                  description: 'High-performance systems with 99.9% uptime and sub-second response times',
                },
                {
                  icon: '🎯',
                  title: 'Custom Solutions',
                  description: 'Tailored AI and IT solutions designed for your specific business needs',
                },
              ].map((solution, index) => (
                <div
                  key={index}
                  className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover:border-white/30 transition-all duration-300 transform hover:-translate-y-2"
                >

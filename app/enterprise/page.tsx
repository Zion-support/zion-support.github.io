        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
              <Link
                href="/contact"
                className="group flex items-center gap-3 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl justify-center"
              >
              ...
              <Link
                href="#solutions"
                className="group flex items-center gap-3 bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-300 justify-center"
              >
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  ...
                  className="inline-flex items-center gap-3 px-8 py-3 bg-white text-blue-600 rounded-lg hover:bg-gray-100 transition-colors font-medium justify-center"
                >
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-3 px-8 py-3 bg-white/10 backdrop-blur-sm text-white border border-white/20 rounded-lg hover:bg-white/20 transition-colors font-medium justify-center"
                >
                  <span className="text-xl">📧</span>

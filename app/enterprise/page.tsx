        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-6xl mx-auto'>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="#solutions"
                className="group flex items-center gap-3 bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-300"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Scalable and secure cloud architecture for enterprise needs',
                icon: '☁️'
              },
              {
        ...
        <div className="container mx-auto px-4">
          <div className="text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <Link
                href="/contact"
                className="group flex items-center gap-3 bg-white/20 hover:bg-white/30 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:-translate-y-1 border border-white/30"
              >
                <span className="text-xl">📧</span>

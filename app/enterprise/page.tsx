        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-12 max-w-3xl mx-auto">
              ...
              500% productivity gains, and 99.9% system uptime with enterprise-grade security and
              compliance.
            </p>
          ...
          <div className="mt-24">
            <div className="text-center bg-white/5 backdrop-blur-lg rounded-3xl p-12 border border-white/20">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Join 500+ Fortune 500 companies achieving unprecedented transformation with our

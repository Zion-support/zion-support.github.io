...
export default function EnterprisePage() {
  return (
    <>
      ...
      {/* Solutions Section */}
      <section id="solutions" className="py-24 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">
              Comprehensive solutions designed for scale and security
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Advanced analytics and AI-powered insights for data-driven decision making',
                icon: '📊'
              },
              {
                title: 'Quantum Security',
                description: 'Next-generation encryption and security protocols for enterprise data protection',
                icon: '🔒'
              },
            ].map((solution, index) => (
              <div
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="text-center bg-gradient-to-r from-slate-900 to-slate-800 rounded-3xl p-12 border border-slate-700">

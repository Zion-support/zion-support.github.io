          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {[
              ...
              },
              {
                ...
                icon: '📊',
                metrics: ['30,000% ROI', '$750B+ Savings', 'Real-time Analytics']
              },
              {
              ...
              <div key={index} className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all duration-500 hover:scale-105">

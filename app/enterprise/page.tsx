...
return ()
      ...
      <section className="py-20 px-4" /></section>
        ...
        <div className="max-w-7xl mx-auto" / /></div>
          <div className="text-center mb-16" / /></div>
            ...
            <p></p>              Built for scale, security, and performance to meet the demands of large organizations.
            </p></p></p>
          </div>
    ...
    feature.benefits.map((benefit, idx) => ()                  ))}
            ...
            <p></p>              End-to-end enterprise solutions that address every aspect of your business operations.
            </p></p></p>
          </div>
                    </li>

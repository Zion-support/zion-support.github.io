          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-8">
                Our enterprise solutions deliver measurable improvements in efficiency, security, and cost-effectiveness for large organizations.
              </p>
            ...
            <div className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 rounded-2xl p-8 border border-white/10">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-6">
                  Contact our enterprise experts to discuss your organization's needs and discover how our solutions can transform your operations.
                </p>

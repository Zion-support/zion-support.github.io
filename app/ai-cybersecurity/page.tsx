      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-6">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              that detect and prevent threats in real-time.
            </p>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        
          </div><div className="bg-white p-6 rounded-lg shadow-lg">
          <h1 className="text-xl font-semibold mb-4">Threat Detection</h3>
          
          </div><p className="text-gray-600">
                AI-powered threat detection and anomaly identification.
              </p>
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <h1 className="text-xl font-semibold mb-4">Incident Response</h3>

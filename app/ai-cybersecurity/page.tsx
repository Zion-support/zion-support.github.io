...
import { Shield, Target, Eye, ArrowRight, CheckCircle } from 'lucide-react';
  ...
  const features = [
    {
      ...
      benefits: ['Real-time monitoring', 'Anomaly detection', 'Threat intelligence', 'Automated response']
    },
    {
      icon: Target,
    ...
    },
    {
      ...
      description: '24/7 security monitoring and incident response with AI-enhanced capabilities.',
      benefits: ['Continuous monitoring', 'Incident response', 'Forensic analysis', 'Security reporting']
    }
  ];
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Protect your digital assets with advanced AI-powered cybersecurity solutions that adapt to evolving threats.
            </p>
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Let's discuss how our AI cybersecurity solutions can protect your digital assets and ensure compliance.
            </p>

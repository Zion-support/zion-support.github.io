...
const AiCybersecurityPage: React.FC = () => {
  ...
  const services = [{
      title: 'AI Threat Detection', description: 'Advanced AI systems for detecting and preventing cyber threats', features: ['Behavioral Analysis', 'Anomaly Detection', 'Threat Hunting'],
  ...
  const benefits = [{ metric: '99.9%', description: 'Threat Detection Rate' }, { metric: 'Real-time', description: 'Threat Response' }, { metric: 'AI-Powered', description: 'Security Automation' }, { metric: '24/7', description: 'Continuous Monitoring' }];

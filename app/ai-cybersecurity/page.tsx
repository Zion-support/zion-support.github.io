...
import { CheckCircle, Zap, Eye, AlertTriangle } from 'lucide-react';

export const metadata: Metadata = {
  title: 'AI Cybersecurity Services | Zion Tech Group',
  description: 'Advanced AI-powered cybersecurity solutions including threat detection, SOC services, vulnerability assessment, and compliance management. Protect your business with cutting-edge security technology.',
  keywords: 'AI cybersecurity, threat detection, SOC services, vulnerability assessment, compliance, data protection, cloud security',
};

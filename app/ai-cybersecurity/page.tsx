...
const AICybersecurityPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Intelligent access management and authentication systems',
      benefits: ['Multi-factor authentication', 'Role-based access', 'Behavioral analysis', 'Risk assessment']
    },
    {
      icon: Eye,
      title: 'Security Monitoring',
      description: 'Comprehensive security monitoring and incident response',
      benefits: ['24/7 monitoring', 'Incident detection', 'Forensic analysis', 'Compliance reporting']
    },
    {
      icon: AlertTriangle,
      title: 'Risk Assessment',
      description: 'AI-driven risk assessment and vulnerability management',
      benefits: ['Vulnerability scanning', 'Risk scoring', 'Remediation guidance', 'Compliance checks']
    },
    {
      icon: BarChart,
      title: 'Security Analytics',
      description: 'Advanced analytics for security insights and reporting',
      benefits: ['Security dashboards', 'Trend analysis', 'Threat intelligence', 'Custom reports']
    },
    {
      icon: Users,
      title: 'Security Training',
      description: 'AI-powered security awareness and training programs',
      benefits: ['Phishing simulation', 'Training modules', 'Progress tracking', 'Behavioral insights']
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              ...
              Detect threats, prevent attacks, and ensure compliance with advanced security measures.
            </p>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of organizations already using our AI cybersecurity solutions to protect their digital assets.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"

...
import { Users, Award, Linkedin, Mail, Github, Globe } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Meet the talented team behind Zion Tech Group. Our experts in AI, development, design, and security are dedicated to delivering exceptional solutions." />
        <meta name="keywords" content="team, experts, AI researchers, developers, designers, cybersecurity, leadership" />
        <meta property="og:title" content="Our Team - Zion Tech Group" />
        <meta property="og:description" content="Meet the experts behind our innovative technology solutions" />

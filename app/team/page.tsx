...
export default function TeamPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <EnhancedSEO title="Our Team - Zion Tech Group | Expert Technology Professionals"
        ...
        <div className="max-w-7 xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {teamMembers.map((member, index) => (
              <div key={index}
                className="group bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2 xl hover:shadow-cyan-500/10 relative overflow-hidden"
              >
                <div></>
                <div className="relative z-10">
                  ...
                  <div className="text-center mb-4">
                    ...
                    <div className="flex items-center justify-center space-x-2 mb-3">
                      {member.icon}
                      <span className="text-gray-300 text-sm">{member.expertise}</>
                    </>
                  </>
                  {/* Bio */}
                  <p >
                  ...
                  {/* Achievements */}
                  <div className="mb-4">
                    <h4 className="text-white font-medium mb-2 text-sm">Key Achievements:</>
                    <div className="space-y-1">
                      {member.achievements.map((achievement, idx) => (
                        <div key={idx} className="flex items-center space-x-2">
                          <Star className="w-3 h-3 text-yellow-400" />
                          <span className="text-gray-300 text-xs">{achievement}</>
                        </>
                      ))}
                    </>
                  </>
        ...
        <div className="max-w-7 xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              <div key={index}
                className="group bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2 xl hover:shadow-cyan-500/10 relative overflow-hidden text-center"
              >
                <div></>
                <div className="relative z-10">
                  <div >

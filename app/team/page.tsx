  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <meta name="description" content="Professional team solutions powered by advanced AI and cutting-edge technology." />
        <meta name="keywords" content="team, AI solutions, IT services, automation, technology, business solutions" />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional team solutions powered by advanced AI and cutting-edge technology.
            </p>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              is dedicated to pushing the boundaries of AI and technology.
            </p>
          </div>
        </div>
      </div>
            ...
            >
              ...
              <div className="flex justify-center space-x-4">
                <a
                  ...
                  className="p-2 bg-white/10 text-gray-300 rounded-lg hover:bg-blue-600 hover:text-white transition-all duration-300"
                >
                ...
                <a
                  ...
                  className="p-2 bg-white/10 text-gray-300 rounded-lg hover:bg-blue-400 hover:text-white transition-all duration-300"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="p-2 bg-white/10 text-gray-300 rounded-lg hover:bg-gray-800 hover:text-white transition-all duration-300"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">

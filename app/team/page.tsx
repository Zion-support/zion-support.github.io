...
const TeamPage: React.FC = () => {
  const teamMembers = [
    ...
    },
    {
      name: 'Sarah Johnson',
      role: 'CTO',
      description: 'Technical expert specializing in AI and machine learning',
    ...
    },
    {
      name: 'Emily Davis',
      role: 'Head of Design',
      description: 'Creative director focused on user experience and design',
  ...
  return (
    ...
    <Layout
      ...
      keywords="team, experts, professionals, AI specialists, IT professionals, company team, leadership"
    >
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Meet the talented team behind Zion Tech Group. Our experts are dedicated to 
              delivering innovative AI and IT solutions that drive business success.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our diverse team of experts brings together years of experience in AI, technology, and business.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                ...
                <p className="text-gray-300 mb-6">
                  ...
                  innovation and excellence. Explore our open positions and join our team.
                </p>
                <Link 
                  to="/careers" 
            ...
            <div className="text-center">
              <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12">
                ...
                <p className="text-lg sm:text-xl text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
                  Let's discuss how our team can help you achieve your business goals with innovative solutions.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link 
                    to="/contact" 

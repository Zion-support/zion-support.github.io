            ...
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <div className ="relative z-10">";
                  {/* Profile Image */}
                  <div className ="w-24 h-24 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500 to-purple-600 flex items-center justify-center text-white text-2xl font-bold group-hover:scale-110 transition-transform duration-300">";                    {member.name.split(' ').map(n => n[0]).join(')}';
                  </div>
                  {/* Member Info */}                  <div className ="text-center mb-4">";
      ...
      <section className ="py-16 px-4 sm:px-6 lg:px-8 relative z-10">";
        <div className ="max-w-4xl mx-auto text-center">";
          <div className ="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">";
            ...
            <p className ="text-xl text-gray-300 mb-8">";              Ready to be part of the future of technology? We're always looking for talented individuals to join our mission.';

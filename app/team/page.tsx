          ...
          <div className="grid grid-cols-2 md: grid-cols-4 gap-8" />),
            {stats.map((stat, index) => (
              <div key={index} className="text-center group" /></div>
                ...
                <div className="text-xl md: text-2 xl lg:text-3 xl font-bold text-white mb-2">{stat.number}</div>
...
key={index}
               ...
               /></div>
                ...
                <div className="relative z-10" /></div>
                  {/* Profile Image */}
                  <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500 to-purple-600 flex items-center justify-center text-white text-2 xl font-bold group-hover: scale-110 transition-transform duration-300" />,

...
const TeamPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Team Solutions',
      description: 'Professional team services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored team implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your team needs.'
    }
  ];

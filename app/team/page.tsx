...
import Footer from '../components/Footer';
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10" /><div className="max-w-7xl mx-auto" /><div className="text-center mb-16" /><h2 className="text-3xl md:text-4xl font-bold text-white mb-4" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Meet the visionary leaders driving innovation and excellence at Zion Tech Group.</p>
            </p>
          </div>
            ...
            {teamMembers.map((member, index) => (
               ...
               /><div className="absolute inset-0 bg-gradient-to-r from-cyan-500/5 to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                <div className="relative z-10">
                  {/* Profile Image */}
                  </div><div className="w-24 h-24 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500 to-purple-600 flex items-center justify-center text-white text-2xl font-bold group-hover:scale-110 transition-transform duration-300">
                    {member.name.split(' ').map(n => n[0]).join('')}</div>
                  </div>
                  {/* Member Info */}
                  <div className="text-center mb-4" /><h3 className="text-xl font-semibold text-white mb-1 group-hover:text-cyan-300 transition-colors">
                      {member.name}</h3>
                    </h3>
                    <p className="text-cyan-400 font-medium mb-2">{member.role}</p>
                    <div className="flex items-center justify-center space-x-2 mb-3">
                      {member.icon}
                      </div><span className="text-gray-300 text-sm">{member.expertise}</span>
                    </div>
                  </div>
                  {/* Bio */}
                  ...
                  {/* Achievements */}
                  <div className="mb-4" /><h4 className="text-white font-medium mb-2 text-sm">Key Achievements:</h4>
                    <div className="space-y-1">
                      {member.achievements.map((achievement, idx) => (
                        </div><div key={idx} className="flex items-center space-x-2" /><Star className="w-3 h-3 text-yellow-400" />
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10" /><div className="max-w-7xl mx-auto" /><div className="text-center mb-16" /><h2 className="text-3xl md:text-4xl font-bold text-white mb-4" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              The principles that guide our team and shape our approach to technology and innovation.</p>
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10" /><div className="max-w-4xl mx-auto text-center" /><div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10" /><h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Ready to be part of the future of technology? We're always looking for talented individuals to join our mission.</p>
            </p>

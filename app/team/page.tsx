...
const TeamPage: React.FC = () => {
  ...
  const teamMembers = [{
      name: 'Sarah Johnson', role: 'CEO & Founder', description: '15+ years in AI and technology leadership.', image: '/team-1.jpg'
    
  );
}, {
      name: 'Michael Chen', role: 'CTO', description: 'Expert in machine learning and cloud architecture.', image: '/team-2.jpg'
    }, {
      name: 'Emily Rodriguez', role: 'Head of Design', description: 'Passionate about creating beautiful, user-centered experiences.', image: '/team-3.jpg'
    }]

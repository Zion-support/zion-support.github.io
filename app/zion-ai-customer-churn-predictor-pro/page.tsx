...
const features = [
  ...
  const industries = [
    ...
    },
    {
      ...
      icon: <TrendingDown className="w-6 h-6" loading="lazy" />,
    ...
    <>
      ...
      <div className="min-h-screen pt-16" loading="lazy">>{/* Hero Section */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden" loading="lazy">
          <div className="absolute inset-0 bg-gradient-to-r from-red-500/10 via-orange-500/10 to-yellow-500/10" loading="lazy"></div>
          <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-red-400 to-transparent" loading="lazy"></div>

          <div className="max-w-7xl mx-auto relative z-10" loading="lazy">
            <div className="text-center mb-16" loading="lazy">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-red-500/20 to-orange-500/20 border border-red-500/30 mb-6" loading="lazy">
                <Sparkles className="w-4 h-4 text-red-400 mr-2" loading="lazy" />
                <span className="text-red-400 text-sm font-medium" loading="lazy">#1 AI Customer Retention Platform</span>
              </div>

              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight" loading="lazy">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 via-orange-400 to-yellow-400" loading="lazy">Zion AI Customer Churn Predictor Pro</span>
              </h1>

              <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed" loading="lazy">Predict and prevent customer churn with AI-powered analytics.</p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12" loading="lazy">
                <Link
                  to="/contact"
                  className="px-8 py-4 bg-gradient-to-r from-red-500 to-orange-600 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-red-500/25 transition-all duration-300 flex items-center justify-center group" loading="lazy"
                >
                  Start Free Trial
                ...
                <Link
                  to="/demo"
                  className="px-8 py-4 border border-red-400 text-red-400 rounded-lg font-semibold hover:bg-red-400/10 transition-all duration-300 flex items-center justify-center" loading="lazy"
                >
                  Watch Demo
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto" loading="lazy">
                <div className="text-center" loading="lazy">
                  <div className="text-3xl md:text-4xl font-bold text-red-400 mb-2" loading="lazy">40%</div>
                  <div className="text-gray-300 text-sm" loading="lazy">Reduction in Churn Rate</div>
                </div>
                <div className="text-center" loading="lazy">
                  <div className="text-3xl md:text-4xl font-bold text-orange-400 mb-2" loading="lazy">94%</div>
                  <div className="text-gray-300 text-sm" loading="lazy">Prediction Accuracy</div>
                </div>
                <div className="text-center" loading="lazy">
                  <div className="text-3xl md:text-4xl font-bold text-yellow-400 mb-2" loading="lazy">60%</div>
                  <div className="text-gray-300 text-sm" loading="lazy">Increase in CLV</div>
                </div>
                <div className="text-center" loading="lazy">
                  <div className="text-3xl md:text-4xl font-bold text-red-400 mb-2" loading="lazy">35%</div>
                  <div className="text-gray-300 text-sm" loading="lazy">Retention Rate Increase</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8" loading="lazy">
          <div className="max-w-7xl mx-auto" loading="lazy">
            <div className="text-center mb-12" loading="lazy">
              ...
              <p className="text-lg text-gray-300" loading="lazy">Reduce churn for any business type</p>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4" loading="lazy">{industries.map((industry, index) => (</div>
                <div
                  key={index}
                  className="group bg-white/5 backdrop-blur-sm rounded-lg p-4 border border-white/10 hover:border-red-500/30 transition-all duration-300 hover:scale-105 text-center" loading="lazy"
                >
                  <div
                  ...
                  >{industry.icon}</div>
                  <div className="text-sm text-gray-300 group-hover:text-red-400 transition-colors" loading="lazy">{industry.name}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8" loading="lazy">
          <div className="max-w-7xl mx-auto" loading="lazy">
            <div className="text-center mb-16" loading="lazy">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6" loading="lazy">Powerful Features for Customer Retention</h2>
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed" loading="lazy">Everything you need to predict, prevent, and reduce customer</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" loading="lazy">{features.map((feature, index) => (
                <div
                  key={index}
                  className="group bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-red-500/30 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-red-500/10" loading="lazy"
                >
                  <div className="text-red-400 mb-4 group-hover:scale-110 transition-transform duration-300" loading="lazy">{feature.icon}</div>
                  <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-red-400 transition-colors" loading="lazy">{feature.title}</h3>h3>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-purple-800/50" loading="lazy">
          <div className="max-w-7xl mx-auto" loading="lazy">
            <div className="text-center mb-16" loading="lazy">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4" loading="lazy">Choose Your Retention Plan</h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto" loading="lazy">Flexible pricing options designed to scale with your customer</p>
                base
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8" loading="lazy">{pricingPlans.map((plan, index) => (</div>
                ...
                >{plan.popular && (</div>
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2" loading="lazy">
                      <span className="bg-gradient-to-r from-red-500 to-orange-600 text-white px-4 py-2 rounded-full text-sm font-semibold flex items-center" loading="lazy">
                  ...
                  <div className="text-center mb-8" loading="lazy">
                    ...
                    <div className="flex items-baseline justify-center" loading="lazy">
                      <span className="text-4xl font-bold text-red-400" loading="lazy">{plan.price}</span>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8" loading="lazy">
          <div className="max-w-7xl mx-auto" loading="lazy">
            <div className="text-center mb-16" loading="lazy">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4" loading="lazy">Trusted by Customer Success Teams</h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto" loading="lazy">See how businesses are reducing churn with AI</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8" loading="lazy">{testimonials.map((testimonial, index) => (</div>
                <div
                  key={index}
                  className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-red-500/30 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-red-500/10" loading="lazy"
                >
                  ...
                  <div className="flex items-center" loading="lazy">
                    <div className="w-10 h-10 bg-gradient-to-r from-red-500 to-orange-600 rounded-full flex items-center justify-center text-white font-semibold mr-3" loading="lazy">{testimonial.avatar}</div>
                    <div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8" loading="lazy">
          <div className="max-w-4xl mx-auto text-center" loading="lazy">
            <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 border border-red-500/20 rounded-2xl p-12" loading="lazy">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6" loading="lazy">Ready to Reduce Customer Churn?</h2>
              <p className="text-xl text-gray-300 mb-8 leading-relaxed" loading="lazy">Join thousands of businesses already using Zion AI Customer</p>

  ...
  return (
    <>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          </div><div className="text-sm text-gray-300 group-hover:text-red-400 transition-colors">
                    {industry.name}
        </div>
      </div>
              ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          </div><div className="w-10 h-10 bg-gradient-to-r from-red-500 to-orange-600 rounded-full flex items-center justify-center text-white font-semibold mr-3">
                      {testimonial.avatar}

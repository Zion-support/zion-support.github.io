        ...
        <div className="grid grid-cols-1 lg: 'grid-cols-2 gap-1 2">
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-70 0">Real-time churn prediction</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-60 0 mr-3">✓</span>
                <span className="text-gray-70 0">Custom ML models</span>
              </li>
              <li className="flex items-start">
                <span className="text-blue-60 0 mr-3">✓</span>
          ...
          <div>
            ...
            <p className="text-gray-60 0 mb-6">
              Contact us to learn more about our AI Customer Churn Predictor Pro solution.
            </p>

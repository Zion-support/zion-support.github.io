        ...
        <div id="features" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600">Advanced NLP capabilities that understand context, intent, and nuances in human speech</div>
            
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">🌍</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Multi-language Support</h3>
              <p className="text-gray-600">Support for 50+ languages with accurate pronunciation and cultural context understanding</div>
            
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">⚡</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Real-time Processing</h3>
              <p className="text-gray-600">Ultra-low latency voice processing for natural, conversational interactions</div>
            
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">🔗</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">API Integrations</h3>
              <p className="text-gray-600">Seamless integration with your existing systems, CRM, and business applications</div>
            
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">📊</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Analytics Dashboard</h3>
              <p className="text-gray-600">Comprehensive analytics and insights into voice interactions and user behavior</div>
            
            <div className="bg-white p-6 rounded-xl shadow-lg">
              <div className="text-4xl mb-4">🎯</div>
              <h3 className="text-xl font-bold text-gray-900 mb-3">Custom Training</h3>
              <p className="text-gray-600">Train the AI on your specific domain, terminology, and business processes</div>
        ...
        <div className="bg-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">Choose the plan that fits your business needs</div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gray-50 p-8 rounded-xl">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Basic</h3>
                <div className="text-4xl font-bold text-purple-600 mb-4">$299<span className="text-lg text-gray-500">/month</div>
              ...
              <div className="bg-purple-600 text-white p-8 rounded-xl relative">
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <span className="bg-yellow-400 text-purple-900 px-4 py-1 rounded-full text-sm font-semibold">Most Popular</div>
              ...
              <div className="bg-gray-50 p-8 rounded-xl">
                ...
                <div className="text-4xl font-bold text-purple-600 mb-4">$1,999<span className="text-lg text-gray-500">/month</div>
                <ul className="space-y-3 mb-8">
        ...
        <div className="bg-gray-50 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">See how our AI voice assistant can transform your business</div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Customer Service Automation</h3>
                <p className="text-gray-600">Handle customer inquiries 24/7 with intelligent voice responses and seamless escalation to human agents when needed.</div>
              
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Voice-Controlled Applications</h3>
                <p className="text-gray-600">Build hands-free applications for accessibility, productivity, and enhanced user experience across all devices.</div>
              
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Smart Home Integration</h3>
                <p className="text-gray-600">Control smart home devices, manage schedules, and automate daily tasks through natural voice commands.</div>
              
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Call Center Automation</h3>
                <p className="text-gray-600">Streamline call center operations with intelligent call routing, automated responses, and real-time assistance.</div>
              
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Accessibility Solutions</h3>
                <p className="text-gray-600">Make your applications accessible to users with disabilities through voice navigation and audio feedback.</div>
              
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-xl font-bold text-gray-900 mb-3">Voice Search Optimization</h3>
                <p className="text-gray-600">Optimize your content and applications for voice search queries and conversational interactions.</div>
        </div>

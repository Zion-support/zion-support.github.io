  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="AI-powered ai document scanner solution for intelligent automation and optimization" />
...
<<<<<<< HEAD
        ...
        <section className="relative py-20 px-4 overflow-hidden"></section></section>
          ...
          <div className="relative max-w-7xl mx-auto text-center"></div></div>
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight"></h1></h1>Ai Document Scanner

...
=======
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional aidocumentscanner by Zion Tech Group. Transform your business with our expert solutions." />
      </Helmet>
...
>>>>>>> cursor/fix-errors-and-merge-to-main-3e0a
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">Professional ai document scanner solutions coming soon.</p>
          <Link 
            to="/contact" 

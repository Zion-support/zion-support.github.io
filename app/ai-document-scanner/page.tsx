                  ...
                  {isScanning && (
                    ...
                    <div className="space-y-2" ></div>
                      ...
                      <div className="w-full bg-gray-700 rounded-full h-2" ></div>
                        <div 
                          className="bg-gradient-to-r from-blue-500 to-purple-600 h-2 rounded-full transition-all duration-300" style={{ width: `${scanProgress}%` }}
                        >)}
                  </div>
                    ...
                    <button 
                      ...
                      className="flex-1 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300" ></button>

...
const AiDocumentScannerPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai document scanner services and solutions by Zion Tech Group."
      keywords="ai document scanner, services, solutions, technology, Zion Tech Group"
    >

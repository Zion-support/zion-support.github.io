...
const IotIntegrationPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional iot integration services and solutions by Zion Tech Group."
      keywords="iot integration, services, solutions, technology, Zion Tech Group"
    >

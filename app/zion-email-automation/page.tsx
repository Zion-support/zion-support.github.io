...
const ZionemailautomationPage = () => {
  const serviceName = "Zion Email Automation";
  const serviceDescription = "Ready-to-use zion email automation solution for your business";
  ...
  return (
    <>
      <Helmet>
        <title>Zion Email Automation | Zion Tech Group - Micro SAAS Solutions</title>
        <meta name="description" content="Ready-to-use zion email automation solution for your business" />
        <meta name="keywords" content="micro saas, zion email automation, business tools, automation, software as a service" />
      </Helmet>

import { Zap, Users, BarChart3, Settings, Clock, FileText, CheckCircle, Mail, ArrowRight, Target, User, Helmet } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="container" mx-auto px-4 py-16>
        <h1 className="text-4xl" font-bold text-white text-center mb-8>Zion Email Automation</h1>

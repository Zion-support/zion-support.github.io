...
const ZionEmailAutomationPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional zion email automation services and solutions by Zion Tech Group."
      keywords="zion email automation, services, solutions, technology, Zion Tech Group"
    >

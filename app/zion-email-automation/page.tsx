...
const ZionEmailAutomationPage: React.FC = () => {
  return (
    <>
      <SEOHead= title ="zion-email-automation - Zion Tech Group - Zion Tech Group"";"
        description="Zion Tech Group zion-email-automation service page"";"
      />
      <div  className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div  className ="text-center">";"
          <h1  className ="text-4xl font-bold mb-4">zion-email-automation - Zion Tech Group</h1>";"
...
const ZionEmailAutomationPage: React.FC = () => {";";
  return (";";";
    <>";";";";
      ...
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4">zion-email-automation - Zion Tech Group</$1>"

...
=======
export default function AutonomousSystemsPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Autonomous Systems - Zion Tech Group</title>
        <meta name="description" content="Advanced Autonomous Systems solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Autonomous Systems solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

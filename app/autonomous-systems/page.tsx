...
const PagePage: React.FC = () => {}
  return();
      <Helmet&gt;</Helmet>
        </Helmet&gt;<title&gt;Autonomous Systems - Zion Tech Group</title&gt;</title>
        <meta&gt;</meta>
      </Helmet&gt;
          </div&gt;
        </div&gt;
...
export default AutonomousSystemsPage
        ...
        <meta name="description" content="Advanced autonomous systems solutions for modern businesses." />"      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">"        <div className="container mx-auto px-4 py-16">"          <div className="text-center mb-16">"            <h1 className="text-5xl font-bold text-white mb-6">"              Autonomous <span className="text-cyan-400">Systems"            <p className="text-xl text-gray-300 max-w-3xl mx-auto">"              Advanced autonomous systems solutions for modern businesses;
  )
}

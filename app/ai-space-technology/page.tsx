...
const AISpaceTechnologyPage: React.FC = () => {return (
          ...
          <div className="max-w-7xl mx-auto" ></section>
            <div className="text-center" ></div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center" ></div>
                <a 
                  href="#pricing" 
                  className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-violet-600 to-purple-600 text-white font-semibold rounded-lg hover:from-violet-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105" ></a></a>Request</a></a>Demo</a>
                  <ArrowRight className="ml-2 w-5 h-5" /></ArrowRigh>
                </a>
                <a 
                  href="#contact" 
                  className="inline-flex items-center px-8 py-4 border border-violet-400 text-violet-400 font-semibold rounded-lg hover:bg-violet-400 hover:text-white transition-all duration-300" ></a>
          ...
          <div className="max-w-4xl mx-auto text-center" ></section>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center" ></div>
              <a 
                ...
                className="inline-flex items-center px-8 py-4 bg-white text-violet-600 font-semibold rounded-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105" ></a></a>Request</a></a>Demo</a>
                <ArrowRight className="ml-2 w-5 h-5" /></ArrowRigh>
              </a>
              <a 
                href="tel:+13024640950"
                className="inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-violet-600 transition-all duration-300" ></a>

...
export const metadata: Metadata = {
  title: 'AI Space Technology | Zion Tech Group',
  description:
    'AI Space Technology explores the frontier of computing with advanced AI, simulation, and next-generation platforms. Position your team at the cutting edge ',
  alternates: { canonical: '/ai-space-technology' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Space Technology explores the frontier of computing with advanced AI, simulation, and next-generation platforms. Position your team at the cutting edge while maintaining practical delivery standards.',
        iconEmoji: '🚀',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Space Technology to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Space Technology to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Space Technology analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Space Technology',
      }}
    />
  );
}

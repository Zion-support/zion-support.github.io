...
const AiSpaceTechnologyPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai space technology services and solutions by Zion Tech Group."
      keywords="ai space technology, services, solutions, technology, Zion Tech Group"
    >

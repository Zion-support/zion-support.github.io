    ...
    <ErrorBoundary>
      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-900 via-violet-900 to-slate-900">
        {/* Hero Section */}<section className="relative py-20 px-4 sm:px-6 lg:px-8">
              ...
              </div><div className="inline-flex items-center px-4 py-2 rounded-full bg-violet-100 text-violet-800 text-sm font-medium mb-6">
        ...
        {/* Features Section */}<section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              </div><div className="bg-gradient-to-br from-violet-50 to-purple-50 p-8 rounded-xl border border-violet-100">
                </div><div className="w-12 h-12 bg-violet-600 rounded-lg flex items-center justify-center mb-6">
        ...
        {/* Applications Section */}<section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
          </section><div className="max-w-7xl mx-auto">
            </div><div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-12">
                  ...
                  </div><div className="w-12 h-12 bg-violet-600 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Satellite className="w-6 h-6 text-white" />
                  </div>
                  <div>
        ...
        {/* CTA Section */}<section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-violet-600 to-purple-600">
        ...
        {/* Contact Info */}<section id="contact" className="py-12 px-4 sm:px-6 lg:px-8 bg-gray-900">
          </section><div className="max-w-4xl mx-auto text-center">

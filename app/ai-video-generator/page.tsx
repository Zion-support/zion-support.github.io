...
const AiVideoGeneratorPage: React.FC = () => {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <title>
          Ai Video Generator - Zion Tech Group | Advanced AI and IT Solutions
        </title>
        <meta
          name="description"
          content="Professional aivideogenerator solutions powered by advanced AI and cutting-edge technology."
        />
        <meta
          name="keywords"
          content="aivideogenerator, AI solutions, IT services, automation, technology, business solutions"
        />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional aivideogenerator solutions powered by advanced AI and
  ...
  const features = [
    {
      ...
      description:
        "Generate professional videos from text prompts with advanced AI models.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Create natural-sounding voiceovers in 50+ languages and accents.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Transform static images into dynamic videos with AI animation.",
    ...
    },
    {
      ...
      description:
        "AI-powered script writing for various video types and industries.",
      benefits: [
    ...
    },
    {
      ...
      title: "Smart Editing",
      description:
        "Automated video editing with AI-powered scene detection and transitions.",
    ...
    },
    {
      ...
      description:
        "Full commercial rights and licensing for all generated content.",
      benefits: [
  ...
  const useCases = [
    {
      ...
      description:
        "Create engaging promotional videos for social media and advertising",
      icon: VideoCameraIcon,
    ...
    },
    {
      ...
      description:
        "Generate educational videos and tutorials with AI narration",
      icon: DocumentTextIcon,
    ...
    },
    {
      title: "Product Demos",
      description:
        "Create compelling product demonstration videos automatically",
      icon: SparklesIcon,
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 w-full">
            <div className="text-center">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 mb-8 lg:mb-12 max-w-4xl mx-auto leading-relaxed px-4">
                Create professional videos from text in minutes. Generate
                marketing content, tutorials, and promotional videos with
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto px-4">
                Everything you need to create professional videos with
                AI-powered automation and creativity.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="group holographic-card p-6 hover:scale-105 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/20"
                >
        ...
        <section className="py-16 sm:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto px-4">
                Choose from a wide variety of professional video styles to match
        ...
        <section className="py-16 sm:py-20 bg-slate-800/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto px-4">
                From marketing to education, our AI video generator adapts to
        ...
        <section className="py-16 sm:py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-12 sm:mb-16">
              ...
              <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto px-4">
                Choose the plan that fits your video creation needs. All plans
                ...
                >
                  ...
                  <div className="text-center mb-6">
                    ...
                    <div className="flex items-baseline justify-center">
                      <span className="text-4xl font-bold text-purple-400 neon-text">
                        {plan.price}
                      </span>
        ...
        <section className="relative py-16 sm:py-20 bg-gradient-to-r from-purple-900/40 via-slate-900 to-pink-900/40 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <p className="text-lg sm:text-xl text-gray-300 mb-6 sm:mb-8">
              Join thousands of creators and businesses who are already using AI
              to produce stunning videos in minutes.
>>>>>>> 2edfbde844889cb288bd5d222501597528dc3630
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a

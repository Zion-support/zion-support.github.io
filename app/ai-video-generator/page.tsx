...
export default function AIVideoGeneratorPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>AI Video Generator - Coming Soon | Zion Tech Group</title>
        <meta 
          name="description" 
          content="AI-powered video generation service coming soon. Create professional videos with AI technology." 
        />
      </Helmet>

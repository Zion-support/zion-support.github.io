  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="container mx-auto px-4 py-16">{/* Hero Section */}</div>
            ...
            <span>AI Video Creation<h1 className="text-4xl md:text-6xl font-bold text-white mb-6">AI Video Generator</h1><p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Create professional videos from text prompts in minutes. Our AI-powered platform generates</p>
        ...
        {/* Key Benefits */}<section className="mb-16">
              ...
              </div><div className="text-3xl font-bold text-purple-400 mb-2">10x</div><div className="text-white font-semibold mb-2">Faster Creation</div><div className="text-gray-400 text-sm">Create videos 10x faster than traditional methods</div>
            </div>
            <div className="bg-slate-800/50 p-6 rounded-lg border border-blue-500/20">
              </div><div className="text-3xl font-bold text-blue-400 mb-2">4K</div><div className="text-white font-semibold mb-2">Quality</div><div className="text-gray-400 text-sm">Professional 4K video quality available</div>
            </div>
            <div className="bg-slate-800/50 p-6 rounded-lg border border-green-500/20">
              </div><div className="text-3xl font-bold text-green-400 mb-2">50+</div><div className="text-white font-semibold mb-2">Templates</div><div className="text-gray-400 text-sm">Professional templates for every use case</div>
            </div>
            <div className="bg-slate-800/50 p-6 rounded-lg border border-orange-500/20">
              </div><div className="text-3xl font-bold text-orange-400 mb-2">24/7</div><div className="text-white font-semibold mb-2">Available</div><div className="text-gray-400 text-sm">Create videos anytime, anywhere</div>
            </div>
          </div>
        </section>

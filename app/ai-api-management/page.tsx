  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Streamline your API operations with intelligent management solutions powered by AI." />
        <meta name="keywords" content="AI API management, API automation, intelligent APIs, API optimization" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Streamline your API operations with intelligent management solutions powered by AI.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our ai api management platform provides comprehensive solutions to drive your business forward.
              </p>
            </div>

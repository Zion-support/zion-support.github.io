  ...
  const features = [
    {
      ...
      description: 'Advanced API management solutions powered by artificial intelligence.',
      benefits: ['Smart Routing', 'Auto-scaling', 'Security', 'Monitoring']
    },
    {
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Streamline your API operations with our intelligent API management solutions.
            </p>
          </div>

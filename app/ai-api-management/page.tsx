  ...
  return (
    <>
      ...
      <Helmet></Helmet>
        ...
        <meta name="description" content="Advanced AI-powered API management solutions for seamless integration" /></meta>
        <meta name="keywords" content="AI API management, API integration, artificial intelligence, API gateway" /></meta>
      </Helmet>
      <Navigation /></Navigation>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
        {/* Hero Section */}

  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <meta name="keywords" content="AI API management, API gateway, microservices, API security, API analytics, API monitoring" />
      </Helmet>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              See how our AI API management platform can transform your development process.
            </p>
          </div>

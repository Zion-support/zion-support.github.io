  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Streamline your API ecosystem with our AI-powered API management platform. Security, performance, and scalability for modern applications." />
        <meta name="keywords" content="API management, API security, microservices, API gateway, API monitoring, API analytics" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Streamline your API ecosystem with our AI-powered management platform. 
              Security, performance, and scalability for modern applications.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our AI-powered platform provides everything you need to manage, secure, 
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Get started with our AI-powered API management platform and experience 

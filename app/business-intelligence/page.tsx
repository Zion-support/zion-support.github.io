  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Transform your business with advanced BI solutions. Real-time analytics, predictive modeling, and data-driven insights to accelerate growth." />
        <meta name="keywords" content="business intelligence, data analytics, BI consulting, data visualization, predictive analytics, data warehouse" />
      </Helmet>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 text-purple-100 max-w-3xl mx-auto">
                Transform your business with advanced BI solutions that turn data into actionable insights
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Comprehensive BI services to transform your data into competitive advantage
              </p>
            </div>

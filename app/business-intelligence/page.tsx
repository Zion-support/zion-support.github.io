  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to transform your data analysis and business intelligence capabilities'
    },
    {
      icon: Zap,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our BI solutions deliver unmatched performance, security, and scalability.
            </p>
          </div>
        </div>
      </section>

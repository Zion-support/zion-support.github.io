...
export default function BusinessIntelligencePagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Business Intelligence - Zion Tech Group</title>
        <meta name="description" content="Advanced Business Intelligence solutions by Zion Tech Group for modern businesses." />
      </Helmet>

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <Helmet>
        ...
        <meta name="description" content="Advanced business intelligence solutions with real-time analytics, predictive modeling, and data visualization. Transform your data into actionable insights." />
        <meta name="keywords" content="business intelligence, data analytics, predictive analytics, data visualization, BI consulting, data science" />
      </Helmet>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Transform your data into actionable insights with our advanced BI solutions and expert consulting
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Comprehensive BI services to help you make data-driven decisions
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Contact our BI experts for a free consultation and custom data strategy
          </p>

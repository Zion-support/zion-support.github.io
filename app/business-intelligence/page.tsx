...
const BusinessIntelligencePage: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Track and optimize key performance indicators across your organization',
      features: ['KPI monitoring', 'Performance tracking', 'Goal setting', 'Progress reports']
    },
    {
      icon: <Database className="w-8 h-8 text-purple-500" />,
      title: 'Data Integration',
      description: 'Connect and consolidate data from multiple sources for unified insights',
      features: ['Data warehousing', 'ETL processes', 'API integration', 'Data cleansing']
    },
    {
      icon: <PieChart className="w-8 h-8 text-orange-500" />,
      title: 'Predictive Analytics',
      description: 'Forecast future trends and make data-driven decisions',
      features: ['Machine learning models', 'Forecasting', 'Risk analysis', 'Scenario planning']
    }
  ];
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Streamline operations and improve productivity across departments'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Transform your data into actionable insights with our business intelligence solutions. Advanced analytics, reporting, and data visualization." />
        <meta name="keywords" content="business intelligence, data analytics, reporting, dashboards, data visualization" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive business intelligence solutions to help you understand your data and make better decisions.
            </p>
          </div>
      ...
      <section className="py-20 px-4 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our business intelligence solutions provide the insights you need to drive growth and success.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">

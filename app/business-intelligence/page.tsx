  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      <Helmet>
        ...
        <meta name="description" content="Advanced business intelligence solutions including real-time analytics, predictive modeling, and data visualization services." />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg mb-8 text-gray-300 max-w-4xl mx-auto">
              From real-time analytics dashboards to predictive modeling and AI-powered insights, 
              we help businesses make data-driven decisions that drive growth and efficiency.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Let's discuss how our BI solutions can help your business make better decisions
          </p>

...
import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Zap, Shield, Brain, Globe, BarChart, TrendingUp } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Advanced data analytics and visualization tools for business insights'
    },
    {
      icon: TrendingUp,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Professional Business Intelligence services by Zion Tech Group. Advanced data analytics and business intelligence solutions." />
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Advanced BI Features</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive business intelligence solution designed for modern businesses
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Discover the benefits of our comprehensive business intelligence solutions
            </p>
          </div>

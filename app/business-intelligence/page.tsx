  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced business intelligence solutions to drive data-driven decision making." />
        <meta name="keywords" content="business intelligence, data analytics, BI solutions, data visualization" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Advanced business intelligence solutions to drive data-driven decision making.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our business intelligence solutions are designed to help your business grow and succeed.
              </p>
            </div>

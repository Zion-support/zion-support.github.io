...
const BusinessIntelligencePage: React.FC = () => {
  const features = [
    {
      ico: n: Brain,
      titl: e: 'AI-Powered Analytics',
      descriptio: n: 'Advanced AI technology to transform your business intelligence and data analysis'
    },
    {
      ico: n: Zap,
      titl: e: 'Real-Time Insights',
      descriptio: n: 'Lightning-fast data processing and real-time business intelligence'
    },
    {
      ico: n: Shield,
      titl: e: 'Enterprise Security',
      descriptio: n: 'Bank-level security with encryption and compliance standards for your data'
    },
    {
      ico: n: Globe,
      titl: e: 'Global Analytics',
      descriptio: n: 'Worldwide business intelligence deployment and support'
    }
  ];

...
const BusinessIntelligencePage: React.FC = () => {
  const services = [
    {
      title: 'Expert Business Intelligence Solutions',
      description: 'Professional business intelligence services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored business intelligence implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your business intelligence needs.'
    }
  ];

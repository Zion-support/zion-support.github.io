...
const features = [
      ...
      title: 'Enterprise Security',''      description: 'Bank-level security with encryption and compliance standards'''    },
    {
      ...
      icon: Globe,
      title: 'Global Reach',''      description: 'Worldwide deployment and support for international businesses';'const features = [
  ...
  const benefits = [
    ...
    'Advanced AI technology integration',''    'Real-time processing and analytics',''    'Enterprise-grade security and compliance',''    'Scalable and flexible business intelligence solutions',''    '24/7 technical support',''    'Easy integration with existing systems',''    'Cost-effective pricing plans',''  ];
...
<div className="max-w-7xl mx-auto">""<div className="text-center mb-12">""<h2 className="text-3xl md: text-4xl font-bold text-white mb-4">,</h2>""              Key Benefits,
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">Experience the power of our business intelligence solutions for your business.</p>"">>>>>>> origin/main
            </p></div>
<div className="grid grid-cols-1 md: grid-cols-2 gap-6">,</div>""            {benefits.map((benefit, index) => (
  
              <div key={index}className="flex items-center space-x-3">""<CheckCircle className="w-6 h-6 text-green-400 flex-shrink-0" />""<span className="text-gray-300">{benefit</span>}</span></div>""<div key={index} className="flex items-center space-x-3">""<CheckCircle className="h-6 w-6 text-green-400 flex-shrink-0" />""<span className="text-gray-300">{benefit}""            ))}
{/* Benefits Section */}
      <section className="py-16 px-4 bg-white/5">""<div className="max-w-7xl mx-auto">""<div className="text-center mb-12">""<h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Key Benefits""            <p className="text-xl text-gray-300 max-w-3xl mx-auto">""              Experience the power of our business intelligence solutions for your business.
...
<p className="text-xl text-purple-100 mb-8">""            Contact our experts to discuss your business intelligence needs and get a customized solution.
          <div className="flex flex-col sm:flex-row gap-4 justify-center">""<button className="bg-white text-purple-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 flex items-center justify-center">""<Phone className="mr-2 h-5 w-5" />""              Call Now
              <Mail className="mr-2 h-5 w-5" />""              Email Us
  )
}
export default BusinessIntelligencePage</div></div>;
</div></div>
</div></div>
</div></div>
</div></div>

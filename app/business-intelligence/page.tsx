  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced business intelligence solutions including real-time analytics, predictive modeling, and data visualization for enterprise businesses." />
        <meta name="keywords" content="business intelligence, analytics, data visualization, BI consulting, predictive analytics, data warehouse" />
      </Helmet>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 text-purple-100 max-w-3xl mx-auto">
                Transform your data into actionable insights with advanced BI solutions
              </p>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">
                  Advanced {category.toLowerCase()} services for data-driven decision making
                </p>
              </div>

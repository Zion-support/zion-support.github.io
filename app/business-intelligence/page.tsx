  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to transform your data into actionable business insights'
    },
    {
      icon: Zap,
      title: 'Real-Time Dashboards',
      description: 'Lightning-fast business intelligence with real-time data visualization and reporting'
    },
    {
      icon: Shield,
    ...
    },
    {
      icon: Globe,
      title: 'Global Reach',
      description: 'Worldwide business intelligence solutions and support for international businesses'
    }
  ];

...
,
  const features = [{
      title: 'Smart Contract Development', description: 'Custom smart contract development for DeFi, NFTs, and enterprise blockchain applications.', icon: '📜', price: 'Starting at $8, 000/project', features: ['Custom smart contracts', 'Security auditing', 'Gas optimization', 'Testing & deployment', 'Maintenance & updates'],
  ...
  const benefits = ['Advanced blockchain technology integration', 'Real-time transaction processing', 'Enterprise-grade security and compliance', 'Scalable and flexible blockchain solutions', '24/7 technical support', 'Easy integration with existing systems', 'Cost-effective pricing plans', 'Proven track record of success']
        ...
        <section className="py-16 bg-white" /></section>
          <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8" /></div>
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8">
                  ...
                  </div><Link className="w-8 h-8 text-blue-600" /></Link>
                </div>
              ...
              <div className="text-center">
                  ...
                  </div><Shield className="w-8 h-8 text-green-600" /></Shield>
                </div>
              ...
              <div className="text-center">
                  ...
                  </div><Zap className="w-8 h-8 text-purple-600" /></Zap>
                </div>
              ...
              <div className="text-center">
                  ...
                  </div><Target className="w-8 h-8 text-orange-600" /></Target>
                </div>
                      ...
                      <div className="mb-4">
                        ...
                        <ul className="space-y-1">
                          {service.features.map((feature, featureIndex) => (
                              ...
                              </li><CheckCircle className="w-4 h-4 text-green-500 mr-2 flex-shrink-0" /></CheckCircle>
                              {feature}
                            </li>
                          ))}
                        </ul>
          ...
          <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,</div>
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">,</div>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-green-50 to-emerald-100 rounded-lg">
                </div><Shield className="w-12 h-12 text-green-600 mx-auto mb-4" /></Shield>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">DeFi Protocols</h3>
                <p className="text-gray-600">Decentralized finance solutions for modern financial services</p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-violet-100 rounded-lg">
                </div><Cpu className="w-12 h-12 text-purple-600 mx-auto mb-4" /></Cpu>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">NFT Marketplaces</h3>
                <p className="text-gray-600">Digital asset trading and ownership verification platforms</p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-amber-100 rounded-lg">
                </div><Target className="w-12 h-12 text-orange-600 mx-auto mb-4" /></Target>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Enterprise Solutions</h3>
                <p className="text-gray-600">Private and consortium blockchains for business applications</p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-pink-50 to-rose-100 rounded-lg">
                </div><Sparkles className="w-12 h-12 text-pink-600 mx-auto mb-4" /></Sparkles>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Web3 Applications</h3>
                <p className="text-gray-600">Decentralized applications with user-friendly interfaces</p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-indigo-50 to-blue-100 rounded-lg">
                </div><BarChart className="w-12 h-12 text-indigo-600 mx-auto mb-4" /></BarChart>

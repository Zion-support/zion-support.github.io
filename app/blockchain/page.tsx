    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <h1 className="text-xl font-semibold mb-4">Smart Contracts</h3>
          
          </div><p className="text-gray-600">
                Automated contract execution with blockchain technology.
              </p>
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <h1 className="text-xl font-semibold mb-4">Supply Chain</h3>
          
          </div><p className="text-gray-600">
                Transparent and traceable supply chain management.
              </p>
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <h1 className="text-xl font-semibold mb-4">Digital Identity</h3>

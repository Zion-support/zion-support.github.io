  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="blockchain development, smart contracts, DeFi, NFTs, enterprise blockchain, Web3" /> " </Helmet>"
        ...
        <section className="relative overflow-hidden bg-gradient-to-r from-blue-600 to-indigo-800 text-white py-20">"
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> " <div className="text-center">"
              ...
              <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto"> "
                Transform your business with cutting-edge blockchain technology and decentralized solutions </p>
        ...
        <section id="services" className="py-20">"
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"> " <div className="text-center mb-16">"
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"> "
                Our Blockchain Services </h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto"> "
                From smart contracts to enterprise solutions, we provide comprehensive blockchain development services </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">"
              {blockchainServices.map((service, index) => (
                <div key={index} className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300"> " <div className="text-4xl mb-4">{service.icon}</div> " <h3 className="text-xl font-semibold text-gray-900 mb-3">{service.title}</h3> " <p className="text-gray-600 mb-4">{service.description}</p> " <div className="mb-4">"
                  ...
                  <div className="mb-4"> " <h4 className="font-semibold text-gray-900 mb-2">Benefits:</h4> " <ul className="space-y-1">"
                      {service.benefits.map((benefit, benefitIndex) => (
                        <li key={benefitIndex} className="flex items-center text-sm text-gray-600"> " <Star className="w-4 h-4 text-yellow-500 mr-2 flex-shrink-0" />"
                          {benefit}
                        </li>
                      ))}
                    </ul>
    ...
    {tech}
        ...
        <section className="bg-gradient-to-r from-blue-600 to-indigo-800 text-white py-20">"
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"> " <h2 className="text-3xl md:text-4xl font-bold mb-6">"

...
const categories = [...new Set(blockchainServices.map(service = "> service.category))];"
  return (
    <div></div>
        ...
        <meta name="description" content=""Comprehensive blockchain solutions including smart contracts, DeFi protocols, NFT marketplaces, and enterprise blockchain applications."></meta>"
        <meta name="keywords" content=""blockchain development, smart contracts, DeFi, NFTs, enterprise blockchain, Web3"></meta>"
      <
...
>>>>>>> origin/main
        ...
        {/* Services Section */}
<<<<<<< HEAD
        <section id="services" className=""py-20"></section>"
          ...
          <div className=""max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>"
            ...
            <div className=""grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>"
              {blockchainServices.map((service, index) => (
                <div key={index} className=""bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300"></div>"
...
<<<<<<< HEAD
                      <div className=""mb-4"><"
                        ...
                        <ul className=""space-y-1">)"
                          {service.features.map((feature), featureIndex) => (<li key={featureIndex} className=""flex items-center text-sm text-gray-600"></li>"
...
<<<<<<< HEAD
                      <div className=""mb-6"><"
                        ...
                        <ul className=""space-y-1"></ul>"
                          {service.benefits.map((benefit), benefitIndex) => (<li key={benefitIndex} className=""flex items-center text-sm text-gray-600"></li>"
...
<<<<<<< HEAD
              ...
              <div className=""grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>"
                {blockchainServices;
                  ...
                  <div className=""pt-4 border-t"></div>"
                    <span className=""inline-block bg-gray-100 text-gray-800 text-xs px-3 py-1 rounded-full"></span>"
                      {service.category}
                    </span>
                  </div>
                </div>
        ...
        {/* CTA Section */}
        <section className=""bg-gradient-to-r from-blue-600 to-indigo-800 text-white py-20"></section>"
          <div className=""max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"></div>"
            <h2 className=""text-3xl md:text-4xl font-bold mb-6"></h2>"
              Ready to Build on Blockchain?
            </h2>
            <p className=""text-xl mb-8 max-w-3xl mx-auto text-blue-100"></p>"

...
const BlockchainPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Blockchain Solutions',
      description: 'Professional blockchain services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored blockchain implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your blockchain needs.'
    }
  ];

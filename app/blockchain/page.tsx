          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2"></h2>Blockchain Experts</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2"></h2>Rapid Development</h3>
                    ...
                    <div key={index} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">
                      ...
                      <div className="mb-4">
                        <div className="flex items-center justify-between mb-2">
                          <span className="text-2xl font-bold text-blue-600"></span>{service.price}</span>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2"></h2>Smart Contracts</h3>
                <p className="text-gray-600">Automated contract execution with transparency and security</p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-green-50 to-emerald-100 rounded-lg">
                <Shield className="w-12 h-12 text-green-600 mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-gray-900 mb-2"></h2>DeFi Protocols</h3>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-violet-100 rounded-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2"></h2>NFT Marketplaces</h3>
                <p className="text-gray-600">Digital asset trading and ownership verification platforms</p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-amber-100 rounded-lg">
                <Target className="w-12 h-12 text-orange-600 mx-auto mb-4" />
                <h3 className="text-xl font-semibold text-gray-900 mb-2"></h2>Enterprise Solutions</h3>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-pink-50 to-rose-100 rounded-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2"></h2>Web3 Applications</h3>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-indigo-50 to-blue-100 rounded-lg">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2"></h2>Blockchain Analytics</h3>

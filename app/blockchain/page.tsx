...
export const metadata: Metadata = {
  ...
  description:
    'Blockchain provides secure, transparent, and decentralized solutions for modern businesses. Build trust through immutable records, smart contract automatio',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Blockchain provides secure, transparent, and decentralized solutions for modern businesses. Build trust through immutable records, smart contract automation, and distributed ledger technology.',
        iconEmoji: '⛓️',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Blockchain to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Blockchain to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Blockchain analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Blockchain',
      }}
    />
  );
}

// Blockchain Solutions - Category Page
import Link from 'next/link';
import { allServices } from '../data/servicesData';

export const metadata = {
  title: 'Blockchain Solutions | Zion Tech Group',
  description: 'Smart contracts, DeFi, NFTs, and enterprise blockchain.',
};

export default function Page() {
  const services = allServices.filter(s =>
    s.category && s.category === 'blockchain' ||
    s.category && s.category === 'blockchain' ||
    (s.category || '').toLowerCase().includes('blockchain')
  );
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">Smart contracts, DeFi, NFTs, and enterprise blockchain.</p>

...
import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Zap, Shield, Brain, Globe, Link, Database, Lock } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Develop and deploy secure smart contracts for automated business processes'
    },
    {
      icon: Database,
    ...
    },
    {
      ...
      description: 'Enterprise-grade security with comprehensive compliance standards'
    },
    {
      icon: Globe,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Professional Blockchain Solutions by Zion Tech Group. Advanced blockchain technology for your business." />
        <meta name="keywords" content="blockchain solutions, smart contracts, DeFi, blockchain development, Zion Tech Group" />
      </Helmet>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            ...
            Powered by cutting-edge blockchain technology and industry expertise.
          </p>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Advanced Blockchain Features</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive blockchain solution designed for modern businesses
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Discover the benefits of our comprehensive blockchain solutions
            </p>
          </div>

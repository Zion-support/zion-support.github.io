...
import { CheckCircle, ArrowRight, Phone, Mail, Shield, Brain, Globe, Zap  } from 'lucide-react';const BlockchainPage: React.FC  = () => {
  const features = [
    {
      icon: Shield,
...
<div className="container mx-auto px-4 py-16"></div>
        ...
        <div className="grid md: grid-cols-2 lg:grid-cols-4 gap-8 mb-16">,</div>
          ...
          </div><h2 className="text-3xl font-bold text-white text-center mb-8"></h2>
  ...
  return ()
        ...
        <section className="py-16 bg-white" /></section>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" /></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
                ...
                </div><div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"></div>
              ...
              <div className="text-center"></div>
                </div><div className="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"></div>
              ...
              <div className="text-center"></div>
                </div><div className="bg-purple-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"></div>
              ...
              <div className="text-center"></div>
                </div><div className="bg-orange-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4"></div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
                {blockchainServices
                  ...
                  .map((service, index) => (
                    </div><div key={index} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow"></div>
                ...
                {feature}
                          ...
                          </div><span className="text-2xl font-bold text-blue-600"></span>
                {service.price}
                </span>
                ...
                <div className="mb-4"></div>
                        </div><h4 className="font-semibold text-gray-900 mb-2">Technologies:</h4>
                        <div className="flex flex-wrap gap-2"></div>
                {service.technologies.map((tech, techIndex) => (
                            </div><span key={techIndex} className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded"></span>
                {tech}
                          ))}
                <div className="mb-6"></div>
                        </div><h4 className="font-semibold text-gray-900 mb-2">Business Benefits:</h4>
                        <ul className="space-y-1"></ul>
                {service.benefits.map((benefit, benefitIndex) => (
                            </ul><li key={benefitIndex} className="flex items-center text-sm text-gray-600"></li>
                              </li><Star className="w-4 h-4 text-yellow-500 mr-2 flex-shrink-0" />
                {benefit}
                </li>
                          ))}
                </ul>
    ...
    {/* Blockchain Capabilities Showcase */}
        ...
        {/* Blockchain Capabilities Showcase */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              </div><div className="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg"></div>
                </div><Link className="w-12 h-12 text-blue-600 mx-auto mb-4" />
        ...
        {/* Blockchain Capabilities Showcase */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
            <div className="text-center mb-12"></div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Our Blockchain Capabilities
              <p className="text-xl text-gray-600">Comprehensive blockchain technologies and methodologies for modern business applications
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg"></div>
                <Link className="w-12 h-12 text-blue-600 mx-auto mb-4" />
        ...
        {/* Contact Section */}
            ...
            </div><h2 className="text-3xl md:text-4xl font-bold mb-4"></h2>

  ...
  const blockchainServices = [
    {
      ...
      description:
        "Secure, audited smart contracts for DeFi, NFTs, and enterprise blockchain applications.",
      icon: "📜",
    ...
    },
    {
      ...
      description:
        "Decentralized finance protocols including DEXs, lending platforms, and yield farming.",
      icon: "🏦",
    ...
    },
    {
      ...
      description:
        "Complete NFT marketplace solutions with minting, trading, and auction capabilities.",
      icon: "🎨",
    ...
    },
    {
      ...
      description:
        "Integrate blockchain technology into existing business systems and applications.",
      icon: "🔗",
    ...
    },
    {
      ...
      description:
        "Secure multi-chain cryptocurrency wallets with advanced features and security.",
      icon: "👛",
    ...
    },
    {
      ...
      description:
        "Comprehensive security audits for smart contracts and blockchain applications.",
      icon: "🔒",
    ...
    },
    {
      ...
      description:
        "Custom token development with ICO/IDO launch support and marketing strategies.",
      icon: "🪙",
    ...
    },
    {
      ...
      description:
        "Private blockchain networks for enterprise use cases with custom governance.",
      icon: "🏢",
    ...
    },
    {
      ...
      description:
        "Secure cross-chain bridges for asset transfers between different blockchain networks.",
      icon: "🌉",
    ...
    },
    {
      ...
      description:
        "Decentralized Autonomous Organizations with voting, treasury, and governance mechanisms.",
      icon: "🗳️",
      price: "Starting at $12,000/project",
      features: [
        "Voting systems",
    ...
    },
    {
      ...
      description:
        "Real-time blockchain analytics, monitoring, and compliance reporting solutions.",
      icon: "📊",
    ...
    },
    {
      ...
      description:
        "Complete Web3 applications with frontend, backend, and blockchain integration.",
      icon: "🌐",
      price: "Starting at $15,000/project",
      features: [
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Advanced blockchain and Web3 services including smart contracts, DeFi, NFTs, and enterprise blockchain solutions."
        />
        <meta
          name="keywords"
          content="blockchain development, smart contracts, DeFi, NFTs, Web3, cryptocurrency, token development"
        />
      </Helmet>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 text-orange-100 max-w-3xl mx-auto">
                Build the future of decentralized applications with cutting-edge
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Expert blockchain developers delivering secure, scalable, and
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Certified developers with deep expertise in multiple
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Comprehensive security audits and best practices for all
                  projects
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Fast delivery with proven development methodologies and tools
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Successfully launched 100+ blockchain projects across
                  industries
                </p>
              </div>
            </div>
          ...
          <section key={category} className="py-16 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">
                  Specialized {category.toLowerCase()} services for modern
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Comprehensive blockchain solutions covering all aspects of Web3
                development
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-red-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Secure, audited smart contracts for all blockchain platforms
                </p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-purple-50 to-pink-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Decentralized finance solutions including DEXs and lending
                  platforms
                </p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-cyan-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Complete NFT marketplace and collection development
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-indigo-50 to-blue-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Real-time blockchain analytics and compliance monitoring
                </p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-pink-50 to-rose-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Complete Web3 applications with frontend and backend
                  integration
                </p>
              </div>
            </div>
        ...
        <section className="py-16 bg-gradient-to-r from-orange-600 to-red-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 text-orange-100">
              Contact our blockchain experts for a free consultation and custom
              Web3 strategy
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a

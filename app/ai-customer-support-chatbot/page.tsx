...
const AiCustomerSupportChatbotPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Ai Customer Support Chatbot Solutions',
      description: 'Professional ai customer support chatbot services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored ai customer support chatbot implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your ai customer support chatbot needs.'
    }
  ];

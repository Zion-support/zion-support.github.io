...
import { ArrowRight, CheckCircle, Star, Brain, Clock, Target, BarChart3;
  );
          ...
          <>div className="container mx-auto px-4" ></div><div className="text-center mb-16" ></div></>
            ...
            <>div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8" ></div>
              {chatbotFeatures.map((category, index) => (
                <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6" ></div>

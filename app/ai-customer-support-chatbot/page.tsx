  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced ai customer support chatbot solution powered by artificial intelligence. Streamline your business processes with cutting-edge AI technology and automation." />
        <meta name="keywords" content="AI, ai customer support chatbot, artificial intelligence, automation, business solutions, technology" />
      </Helmet>
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Advanced ai customer support chatbot solution powered by artificial intelligence. Streamline your business processes with cutting-edge AI technology and automation.
          </p>

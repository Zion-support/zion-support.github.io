  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Our commitment to service quality and performance standards." />
        <meta name="keywords" content="SLA, service level agreement, performance guarantee" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Our commitment to service quality and performance standards.
              </p>

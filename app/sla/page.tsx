...
const SlaPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Sla Solutions',
      description: 'Professional sla services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored sla implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your sla needs.'
    }
  ];

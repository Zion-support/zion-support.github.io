...
export const metadata: Metadata = {
  title: 'IoT Solutions Pro | Zion Tech Group',
  description:
    'IoT Solutions Pro connects physical operations with intelligent digital systems. Process sensor data at the edge, automate responses in real time, and gain',
  alternates: { canonical: '/iot-solutions-pro' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'IoT Solutions Pro',
        category: 'IoT & Edge Computing',
        description:
          'IoT Solutions Pro connects physical operations with intelligent digital systems. Process sensor data at the edge, automate responses in real time, and gain visibility across distributed environments.',
        iconEmoji: '📡',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy IoT Solutions Pro to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use IoT Solutions Pro to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage IoT Solutions Pro analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with IoT Solutions Pro',
      }}
    />
  );
}

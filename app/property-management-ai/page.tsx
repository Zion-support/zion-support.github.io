...
const PropertyManagementAIPage: React.FC = () =>{
  ...
  return (
    <React.Fragment&gt; <Helmet&gt; <title&gt;Property Management AI | Zion Tech Group - Intelligent Real Estate Management</title&gt; <meta name="description" content="Transform your property management with AI-powered tools. Optimize rent, manage tenants, and maximize property value." />
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Property Management AI</h1&gt; <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Transform your property management with AI-powered tools.</p&gt; </div&gt; <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{features.map((feature, index) =>(

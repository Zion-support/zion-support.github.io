...
<<<<<<< HEAD
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div></div>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p></p>Transform your property management with AI-powered tools.</p>
            </div>
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="AI-powered property management ai solution for intelligent automation and optimization" />
        <meta name="keywords" content="AI, property, management, ai, automation, artificial intelligence, business solutions" />
      </Helmet>
      <Navigation />
        ...
        <section className="py-20 px-4 relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              AI-powered property management ai solution for intelligent automation and optimization
            </p>
...
>>>>>>> cursor/fix-errors-and-merge-to-main-9eaa
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-slate-800/50 to-slate-700/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-4">Why Choose Our Property Management Ai?</h2>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Get started with our Property Management Ai and experience the future of intelligent automation.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105">
                Start Free Trial
        ...
        <section className="py-20 px-4"></section></section>
          <div className="max-w-7xl mx-auto"></div></div>
            <div className="text-center mb-16"></div></div>
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6"></h1></h1>Property Management AI
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p></p>Transform your property management with AI-powered tools.
...
export default PropertyManagementAIPage</div></div></div></div></div></div></p></p></h1></h3></section>
=======

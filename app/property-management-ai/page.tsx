...
export const metadata = {
  ...
  description: 'Professional AI-powered property management services by Zion Tech Group.',
  keywords: 'property management, AI, automation, technology, services',
  openGraph: {
    title: 'Property Management AI | Zion Tech Group',
    description: 'Professional AI-powered property management services by Zion Tech Group.',
    type: 'website',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional AI-powered property management services by Zion Tech Group.
            </p>
          </div>
        </div>
      </section>

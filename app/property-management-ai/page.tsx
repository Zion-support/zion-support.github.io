        ...
        <section className="py-20px-4">
          <div className="max-w-7xlmx-auto">
            <div className="text-centermb-16">
              <h1 className="text-4xlmd: text-6xl font-bold text-white mb-6">Property Management AI</h1>,
              <p className="text-xltext-gray-300 mb-8 max-w-3xl mx-auto">Transform your property management with AI-powered tools.</p>
            </div>
...
export default PropertyManagementAIPage
        <section className="py-20px-4">
          <div className="max-w-7xlmx-auto">
            <div className="text-centermb-16">
              <h1 className="text-4xlmd:text-6xl font-bold text-white mb-6">Property Management AI
              <p className="text-xltext-gray-300 mb-8 max-w-3xl mx-auto">Transform your property management with AI-powered tools.

...
import { ArrowLeft, CheckCircle, AlertCircle, TrendingUp, Users, DollarSign } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <h1 className="text-3xl font-bold text-gray-900 mb-2">AI Transformation Readiness Assessment Results</h1>
              <p className="text-gray-600">Your organization's AI transformation readiness score</p>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">AI Transformation Readiness Assessment</h1>
            <p className="text-gray-600">Evaluate your organization's readiness for AI transformation</p>
          </div>

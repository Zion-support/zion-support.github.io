  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Zion AI CRM Pro - AI-Powered Customer Relationship Management | Zion Tech Group</title><//title><///title><////title></////title>
        <meta;";
          name="description;";
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900 relative overflow-hidden"></div>"
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(99,102,241,0.3),transparent_50%)]"></div><//div><///div><////div></////div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center"></div>"
              <div>"
                <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 mb-6">"
                  ...
                  <span className="text-indigo-400 text-sm font-medium">AI-Powered CRM Platform</span><//span><///span><////span></////span>
                </div><//div><///div><////div></////div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6"></div>"
                  {stats.map((stat, index) => ("
                    <div key={index} className="text-center group">"
                      <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-gradient-to-r from-indigo-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"></div><//div>"
                        {stat.icon}"
                      </div>"
              ...
              <div className="relative">"
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">"
                  <div className="text-center mb-6">"
                    ...
                    <p className="text-gray-300">See your sales data in action</p><//p><///p><////p></////p>
                  </div><//div><///div><////div></////div>
                  ...
                  <div className="space-y-4">"
                    <div className="bg-gradient-to-r from-indigo-500/20 to-purple-500/20 rounded-lg p-4">"
                      <div className="flex items-center justify-between mb-2">"
                        ...
                        <span className="text-green-400 text-sm">+23.5%</span><//span>"
                      </div>"
                      <div className="text-2xl font-bold text-white">$2.4M</div><//div><///div><////div></////div>
                    </div><//div><///div><////div></////div>

                    <div className="grid grid-cols-2 gap-4">"
                      <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-lg p-4">"
                        <div className="text-white font-semibold text-sm mb-1">Active Leads</div>"
                        <div className="text-xl font-bold text-white">1,247</div><//div>"
                      </div>"
                      <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-lg p-4">"
                        ...
                        <div className="text-xl font-bold text-white">18.3%</div><//div><///div><////div></////div>
                      </div><//div><///div><////div></////div>
                    </div><//div><///div><////div></////div>
                    ...
                    <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-lg p-4">"
                      ...
                      <div className="text-sm text-gray-300">High-value leads identified: 23</div><//div><///div><////div></////div>
                    </div><//div><///div><////div></////div>
                  </div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>
          ...
          <div className="max-w-7xl mx-auto">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div><//div><///div><////div>
              {features.map((feature, index) => (
                ...
                >"
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500 flex items-center justify-center mb-4 mx-auto group-hover:scale-110 transition-transform duration-300"></div><//div>"
                    {feature.icon}"
                  </div>"
                  <h3 className="text-xl font-semibold text-white mb-3 text-center group-hover:text-indigo-300 transition-colors"></h3><//h3>"
                    {feature.title}"
                  </h3>"
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >"
                  ...
                  <div className="flex items-center">"
                    <div className="w-10 h-10 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full flex items-center justify-center text-white font-semibold mr-3"></div><//div><///div>"
                      {testimonial.avatar}"
                    </div><//div>"
                    <div>"
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">"
                <div className="text-center">"
                  ...
                  <p className="text-indigo-400">kleber@ziontechgroup.com</p><//p>"
                </div>"
                <div className="text-center">"
                  <div className="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-3">"
                  ...
                  <p className="text-indigo-400">+1 302 464 0950</p><//p>"
                </div>"
                <div className="text-center">"
                  <div className="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-3">"
                  ...
                  <p className="text-indigo-400 text-sm">364 E Main St STE 1008<br />Middletown DE 19709</p><//p><///p><////p></////p>
                </div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>

...
<<<<<<< HEAD
      ...
      <section className="py-20 bg-white" />
        <div className="max-w-7 xl mx-auto px-4 sm:px-6 lg:px-8" />
          <div className="text-center mb-16" />
            <h2 className="text-3 xl md:text-4 xl font-bold text-gray-900 mb-4"  />Powerful Features
            </h2>
      ...
      <section className="py-20 bg-gray-50" />
        <div className="max-w-7 xl mx-auto px-4 sm:px-6 lg:px-8" />
          <div className="text-center mb-16" />
            <h2 className="text-3 xl md:text-4 xl font-bold text-gray-900 mb-4"  />Choose Your Plan
            </h2>
            <p className="text-xl text-gray-600 max-w-3 xl mx-auto">
            ...
            {pricingPlans.map((plan, index) => (
              <div key="{index}" className="bg-white rounded-xl p-8 shadow-lg" />
                <div className="text-center mb-6" />
                  <h3 className="text-2 xl font-bold text-gray-900 mb-2"  >{plan.name}</h3>
...
<<<<<<< HEAD
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600" />
        <div className="max-w-7 xl mx-auto px-4 sm:px-6 lg:px-8 text-center" />
          <h2 className="text-3 xl md:text-4 xl font-bold text-white mb-6"  />Ready to Optimize Your E-commerce Store?
          </h2>

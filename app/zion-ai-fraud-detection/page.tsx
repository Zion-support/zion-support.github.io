          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">Detailed analytics and reporting dashboard to monitor fraud trends and system performance.</p>
              </div>
            </div>
          </div>
          {/* Pricing Section */}
          ...
          <div className="bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-8 text-white mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-red-100">Advanced ML algorithms ensure minimal false positives while catching real threats.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-red-100">Detect and prevent fraud in milliseconds, not minutes.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-red-100">Simple API integration with your existing systems and workflows.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-white bg-opacity-20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-red-100">Round-the-clock support to keep your business protected.</p>
              </div>
            </div>
          </div>
          {/* CTA Section */}

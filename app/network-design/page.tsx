...
const NetworkDesignPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional network design services and solutions by Zion Tech Group."
      keywords="network design, services, solutions, technology, Zion Tech Group"
    >

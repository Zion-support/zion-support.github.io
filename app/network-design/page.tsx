...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/network-design' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        category: 'Networking',
        description:
          'Network Design designs and manages robust network infrastructure for reliable connectivity, security, and performance. Build the foundation your applications and teams depend on.',
        iconEmoji: '🌐',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Network Design to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Network Design to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Network Design analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Network Design',
      }}
    />
  );
}

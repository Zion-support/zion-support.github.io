      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              ...
              <h1 className="w-5 h-5 ml-2">AI Content Moderation Pro
              </h1>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Protect your platform with industry-leading AI content moderation. Real-time detection, 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Advanced Content Safety Features
              </h2>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Comprehensive AI-powered protection for all your content needs
              </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Comprehensive Moderation Capabilities
              </h2>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Handle any content type, language, or platform with our advanced AI
              </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Choose the plan that scales with your platform
              </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Trusted by Leading Platforms
              </h2>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">See how our AI content moderation protects platforms worldwide
              </p>
          </div>
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">Protect Your Platform Today
              </h2>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Join thousands of platforms using AI Content Moderation Pro to keep their communities safe
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">

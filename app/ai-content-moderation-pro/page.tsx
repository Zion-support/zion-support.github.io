...
export default function A IContent Moderation Pro() {
  ...
  const capabilities = [
    ...
    {
      category: 'Platforms',
      items: ['Social Media', 'E-commerce', 'Forums', 'Gaming', 'Streaming', 'Custom A PIs']
    }
  ]
        ...
        <s ection class Name="p t-20 pb-16 px-4sm:px-6lg:px-8" />
          <d iv class Name="m ax-w-7xlmx-auto">
            ...
            <d iv class Name="t ext-center" />
              ...
              <h1 c lass Name="t ext-4 xl sm:text-5 xl md:text-6 xl font-boldtext-whitemb-6">A I Content Moderation Pro
              </h1>
        ...
        <s ection class Name="p y-16 px-4sm:px-6lg:px-8" />
          <d iv class Name="m ax-w-7xlmx-auto">
            ...
            <d iv class Name="t ext-centermb-16">
              ...
              <h2 c lass Name="t ext-3 xl sm:text-4 xl font-boldtext-whitemb-4">Advanced Content Safety Features
              </h2>
        ...
        <s ection class Name="p y-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-rfrom-slate-800/30to-purple-900/30" />
          <d iv class Name="m ax-w-7xlmx-auto">
            ...
            <d iv class Name="t ext-centermb-16">
              ...
              <h2 c lass Name="t ext-3 xl sm:text-4 xl font-boldtext-whitemb-4">Comprehensive Moderation Capabilities
              </h2>
              <p c lass Name="t ext-lg text-gray-300 max-w-2xlmx-auto" />
            ...
            <d iv class Name="g rid grid-cols-1 md:grid-cols-2lg:grid-cols-4gap-8">
              ...
              {capabilities.map((capability, index) => (
                ...
                <d iv key="{index}" class Name="b g-slate-800/50 rounded-xl p-6borderborder-slate-700" />
                  <h3 c lass Name="t ext-xl font-semiboldtext-whitemb-4">{capability.category}</h3>
        ...
        <s ection class Name="p y-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-rfrom-slate-800/30to-purple-900/30" />
          <d iv class Name="m ax-w-7xlmx-auto">
            ...
            <d iv class Name="t ext-centermb-12">
              ...
              <h2 c lass Name="t ext-3 xl font-boldtext-whitemb-4">Trusted by Leading Platforms
              </h2>
        ...
        <s ection class Name="p y-16 px-4sm:px-6lg:px-8" />
          <d iv class Name="m ax-w-4 xlmx-autotext-center">
            ...
            <d iv class Name="b g-gradient-to-r from-red-500/20 to-purple-500/20 rounded-2 xl p-8borderborder-red-500/30">
              ...
              <h2 c lass Name="t ext-3 xl font-boldtext-whitemb-4">Protect Your Platform Today
              </h2>
              ...
              <d iv class Name="f lex flex-col sm:flex-rowgap-4justify-center">
                ...
                <L ink to="/contact" class Name="b g-gradient-to-r from-red-500 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-red-600 hover:to-purple-700transition-allduration-300">Start Your Free Trial
                </L ink>

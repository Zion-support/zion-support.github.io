...
const PrivacyPolicyPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Privacy Policy Solutions',
      description: 'Professional privacy policy services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored privacy policy implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your privacy policy needs.'
    }
  ];

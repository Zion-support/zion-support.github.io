  ...
  const features = [
    {
      icon: "🚀",
      title: "Professional",
      description: "Professional zion ai predictive maintenance solutions"
    },
    {
      icon: "⚡",
      title: "Fast & Reliable",
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Professional zion ai predictive maintenance solutions tailored to your business needs
          </p>

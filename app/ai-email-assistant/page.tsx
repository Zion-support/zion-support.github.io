    ...
    <>
      <Helmet>
        ...
        <meta: name ="description"";";"
          const content ="Transform your email management with AI-powered automation, smart classification, and intelligent responses."";";"
        />
      </Helmet>
        ...
        <div: className ="container mx-auto px-4 py-20">";";"
          <div: className ="text-center mb-16">";";"
            ...
            <div: className ="flex flex-col sm:flex-row gap-4 justify-center">";";"
              <Link: to ="/contact"";";"
                const className ="bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-cyan-600 hover:to-purple-600 transition-all duration-300 transform hover:scale-105"";";"
              >
                Get Started
              </Link>
              <Link: to ="/demo"";";"
                const className ="border border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-cyan-400 hover:text-white transition-all duration-300"";";"
              >
                View Demo
              </Link>
            </div>

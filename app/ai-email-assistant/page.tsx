        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Transform your email management with AI-powered automation, smart classification, and intelligent responses that boost productivity and improve communication.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <p className="text-gray-300 mb-4">
                AI-powered email automation that learns from your communication patterns.
              </p>
              <Link 
                to="/contact" 
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              <h3 className="text-xl font-semibold text-white mb-4">Intelligent Classification</h3>
              <p className="text-gray-300 mb-4">
                Automatically categorize and prioritize your emails for better organization.
              </p>
              <Link 
                to="/contact" 
                className="inline-block bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 text-white font-bold py-2 px-4 rounded-lg transition-all duration-300"
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <p className="text-gray-300 mb-4">
                Track email performance and communication patterns for insights.
              </p>
              <Link 
                to="/contact" 
                className="inline-block bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 text-white font-bold py-2 px-4 rounded-lg transition-all duration-300"

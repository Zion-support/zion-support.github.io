  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Transform your email management with AI-powered email assistant. Automate responses, smart categorization, and intelligent email insights." />
        <meta name="keywords" content="AI email assistant, email automation, smart email, email management, AI email tools" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-8">
                ...
                <span className="text-cyan-400 font-medium">AI-Powered Email Intelligence</span>
              </div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
                Revolutionize your email workflow with our intelligent AI assistant that understands context, 
                automates responses, and helps you stay organized and productive.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our AI email assistant provides comprehensive email management capabilities
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300">
                ...
                <p className="text-gray-300 mb-4">
                  AI generates contextual responses based on email content and your communication style.
                </p>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300">
                ...
                <p className="text-gray-300 mb-4">
                  Automatically organize emails into categories and prioritize important messages.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center text-sm text-gray-400">
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300">
                ...
                <p className="text-gray-300 mb-4">
                  Get insights into your email patterns, response times, and communication effectiveness.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center text-sm text-gray-400">

...
import { ArrowLeft, Brain, Zap, Target, BarChart, Users, Clock, CheckCircle, Star, Phone, Mail, MapPin } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Why Choose Our AI Automation?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300">
                Automate complex business processes with AI that makes decisions, handles exceptions, and learns from patterns.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300">
                Reduce manual work by up to 90% while improving accuracy and consistency across all automated processes.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300">
                Monitor and optimize your automated processes with comprehensive analytics and performance insights.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Services Section */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Our AI Automation Solutions</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
              ...
              <div className="text-2xl font-bold text-cyan-400 mb-4">Starting at $399/month</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
              <h3 className="text-2xl font-semibold text-white mb-4">Business Process Automation</h3>
              <ul className="space-y-3 text-gray-300 mb-6">
                <li className="flex items-center">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
        ...
        <section className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Ready to Automate Your Business?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Schedule a free consultation to discuss your automation needs and see how we can transform your business.
              </p>
              <Link
                href="/contact"

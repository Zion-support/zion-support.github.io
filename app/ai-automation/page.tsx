...
import { Zap, Bot, Settings, BarChart, Users, Clock, CheckCircle, ArrowRight, Star, Brain, Cloud, Code, Database, Smartphone, Lock, TrendingUp, Calendar, Target, Heart, DollarSign, Box, Monitor, Link as LinkIcon, Server, Share2, Mic, Wrench, Truck, FileText, Shield } from 'lucide-react';
  ...
  const features = [
    {
      ...
      benefits: ['Workflow automation', 'Task scheduling', 'Rule-based triggers', 'Error handling']
    },
    {
      icon: Bot,
      title: 'Intelligent Bots',
      description: 'Deploy AI-powered bots for customer service and internal processes',
      benefits: ['Chatbots', 'Virtual assistants', 'Process bots', 'Integration bots']
    },
    {
      icon: Settings,
    ...
    },
    {
      ...
      benefits: ['Performance metrics', 'Success rates', 'Bottleneck detection', 'Optimization insights']
    },
    {
      icon: Users,
      title: 'User Management',
      description: 'Manage user access and permissions for automation workflows',
      benefits: ['Role-based access', 'User permissions', 'Audit trails', 'Team collaboration']
    },
    {
      icon: Clock,
      title: 'Scheduling & Triggers',
      description: 'Schedule and trigger automation workflows based on time or events',
      benefits: ['Cron scheduling', 'Event triggers', 'Conditional logic', 'Recurring tasks']
    }
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              ...
              Reduce manual work, increase efficiency, and scale your operations with AI.
            </p>

...
const AIAutomationPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      benefits: ['Workflow automation', 'Process optimization', 'Task scheduling', 'Resource management']
    },
    {
      icon: Shield,
      title: 'Security & Compliance',
      description: 'Ensure security and compliance with automated monitoring and controls.',
      benefits: ['Security monitoring', 'Compliance checking', 'Risk management', 'Audit trails']
    },
    {
      icon: BarChart,
      title: 'Performance Analytics',
      description: 'Monitor and optimize automation performance with comprehensive analytics.',
      benefits: ['Performance metrics', 'Efficiency tracking', 'Cost analysis', 'ROI optimization']
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Cutting-edge AI technology for intelligent business automation
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the benefits of intelligent business automation
            </p>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <div className="relative">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Start using AI-powered automation to transform your operations
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

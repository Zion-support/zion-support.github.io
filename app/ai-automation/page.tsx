        ...
        <main className="pt-24 pb-16 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <section className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 mb-12 max-w-3xl mx-auto">Transform your business operations with cutting-edge AI automation. Achieve 80% efficiency increase,
            ...
            {/* Pricing Section */}
            <section className="mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center">Choose Your Plan</h2>

...
import { Brain, Zap, Target, BarChart, Users, Clock, CheckCircle, ArrowRight, Phone, Mail, MapPin } from 'lucide-react';
...
const AIAutomationPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'AI predicts upcoming tasks and automatically assigns resources for optimal completion.'
    },
    {
      icon: BarChart,
      title: 'Real-time Performance Analytics',
      description: 'Monitor automation performance with detailed analytics and insights for continuous improvement.'
    }
  ];
  ...
  const useCases = [
    ...
    },
    {
      ...
      description: 'Automated data entry, validation, and processing for accurate results.',
      icon: BarChart
    },
    {
      title: 'Document Management',
      description: 'Intelligent document classification, routing, and approval workflows.',
      icon: CheckCircle
    },
    {
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              Our AI-powered solutions eliminate manual processes and boost productivity by 300%.
            </p>
      ...
      <section className="py-16 px-4 bg-slate-800/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">Proven results that transform your business</p>
          </div>

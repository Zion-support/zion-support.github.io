  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEOOptimizer
        ...
        description="Intelligent process automation solutions. Transform your business with cutting-edge technology solutions."
        keywords={['ai automation', 'technology solutions', 'business automation', 'digital transformation']}
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Intelligent process automation solutions. Transform your business with cutting-edge technology solutions.
          </p>

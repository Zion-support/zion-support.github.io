...
const AiAutomationPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Ai Automation Solutions',
      description: 'Professional ai automation services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored ai automation implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your ai automation needs.'
    }
  ];

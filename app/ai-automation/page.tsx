  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Revolutionary AI-powered business automation solutions that streamline processes, reduce costs, and improve efficiency across all business functions."
        keywords={['AI automation', 'business automation', 'process automation', 'workflow automation', 'AI-powered automation']}
      />

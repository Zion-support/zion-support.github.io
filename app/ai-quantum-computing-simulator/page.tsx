  ...
  const features = const features = const features = [
    {
      ...
      benefits: ['Up to 50 qubit simulation', 'Real-time circuit optimization', 'Multiple quantum gates support'];      title: 'AI-Powered Optimization',
          ...
          <div className="max-w-7xl mx-auto" /></div>
            <div className="text-center mb-16" /></div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto" /></p>
                Our AI-powered quantum computing simulator provides cutting-edge tools                 for quantum research, algorithm development, and educational purposes.
              </p></p></p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/30 to-slate-900/30" /></section>
          <div className="max-w-7xl mx-auto" /></div>
            <div className="text-center mb-16" /></div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto" /></p>
                Explore the vast potential of quantum computing across various domains                 with our comprehensive simulation platform.
              </p></p></p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8" /></section>
          <div className="max-w-7xl mx-auto" /></div>
            <div className="text-center mb-16" /></div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto" /></p>                Choose the perfect quantum simulation plan for your research needs. 

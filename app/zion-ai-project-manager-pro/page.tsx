  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Zion AI Project Manager Pro - AI-Powered Project Management | Zion Tech Group</title><//title><///title><////title></////title>
        <meta;";
          name="description;";
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900 relative overflow-hidden"></div>"
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(16,185,129,0.3),transparent_50%)]"></div><//div><///div><////div></////div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center"></div>"
              <div>"
                <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-emerald-500/30 mb-6">"
                  ...
                  <span className="text-emerald-400 text-sm font-medium">AI-Powered Project Management</span><//span><///span><////span></////span>
                </div><//div><///div><////div></////div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8"></div><//div><///div><////div>
                  <Link;";,
                    to="/contact;";
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6"></div>"
                  {stats.map((stat, index) => ("
                    <div key={index} className="text-center group">"
                      <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-gradient-to-r from-emerald-500/20 to-teal-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"></div><//div>"
                        {stat.icon}"
                      </div>"
              ...
              <div className="relative">"
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">"
                  <div className="text-center mb-6">"
                    ...
                    <p className="text-gray-300">See your projects in action</p><//p><///p><////p></////p>
                  </div><//div><///div><////div></////div>
                  ...
                  <div className="space-y-4">"
                    <div className="bg-gradient-to-r from-emerald-500/20 to-teal-500/20 rounded-lg p-4">"
                      <div className="flex items-center justify-between mb-2">"
                        ...
                        <span className="text-green-400 text-sm">+15%</span><//span>"
                      </div>"
                      <div className="text-2xl font-bold text-white">78% Complete</div><//div><///div><////div></////div>
                    </div><//div><///div><////div></////div>
                    ...
                    <div className="grid grid-cols-2 gap-4">"
                      <div className="bg-gradient-to-r from-teal-500/20 to-cyan-500/20 rounded-lg p-4">"
                        ...
                        <div className="text-xl font-bold text-white">47</div><//div>"
                      </div>"
                      <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-lg p-4">"
                        ...
                        <div className="text-xl font-bold text-white">94%</div><//div><///div><////div></////div>
                      </div><//div><///div><////div></////div>
                    </div><//div><///div><////div></////div>
                    ...
                    <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-lg p-4">"
                      <div className="flex items-center justify-between mb-2">"
                        ...
                        <span className="text-yellow-400 text-sm">Live</span><//span>"
                      </div>"
                      <div className="text-sm text-gray-300">Next milestone: 3 days ahead</div><//div><///div><////div></////div>
                    </div><//div><///div><////div></////div>
                  </div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>
          ...
          <div className="max-w-7xl mx-auto">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div><//div><///div><////div>
              {features.map((feature, index) => (
                ...
                >"
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-emerald-500 to-teal-500 flex items-center justify-center mb-4 mx-auto group-hover:scale-110 transition-transform duration-300"></div><//div>"
                    {feature.icon}"
                  </div>"
                  <h3 className="text-xl font-semibold text-white mb-3 text-center group-hover:text-emerald-300 transition-colors"></h3><//h3>"
                    {feature.title}"
                  </h3>"
                  <p className="text-gray-300 text-center mb-4 leading-relaxed"></p><//p>"
                    {feature.description}"
                  </p>"
...
>"
                  ...
                  <div className="text-center mb-6">"
                    ...
                    <div className="flex items-baseline justify-center">"
                      ...
                      <span className="text-gray-300 ml-1">{plan.period}</span><//span><///span><////span></////span>
                    </div><//div><///div><////div></////div>
                  </div><//div><///div><////div></////div>
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >"
                  ...
                  <div className="flex items-center">"
                    <div className="w-10 h-10 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full flex items-center justify-center text-white font-semibold mr-3"></div><//div><///div>"
                      {testimonial.avatar}"
                    </div><//div>"
                    <div>"
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">"
                <div className="text-center">"
                  ...
                  <p className="text-emerald-400">kleber@ziontechgroup.com</p><//p>"
                </div>"
                <div className="text-center">"
                  <div className="w-12 h-12 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-lg flex items-center justify-center mx-auto mb-3">"
                  ...
                  <p className="text-emerald-400">+1 302 464 0950</p><//p>"
                </div>"
                <div className="text-center">"
                  <div className="w-12 h-12 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-lg flex items-center justify-center mx-auto mb-3">"
                  ...
                  <p className="text-emerald-400 text-sm">364 E Main St STE 1008<br />Middletown DE 19709</p><//p><///p><////p></////p>
                </div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>

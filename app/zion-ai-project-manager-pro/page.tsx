...
const ZionAIProjectManagerProPage = () => {
  ...
  const useCases = [
    {,
      ...
      icon: <GitBranch className="w-6 h-6" /></GitBranch>
    ...
    {,
      ...
      icon: <Calendar className="w-6 h-6" /></Calendar>
      color: "from-purple-500 to-pink-500"
    }
    {,
  ...
  const aiCapabilities = [
    ...
    {,
      ...
      icon: <Timer className="w-8 h-8" /></Timer>
      color: "from-green-500 to-emerald-500"
    }
    {,
  ...
  return()
    <div className="min-h-screen bg-gray-900 text-white" /></div>
      <Helmet /></Helmet>
        ...
        <meta name="description" content="Zion Ai Project Manager Pro solutions by Zion Tech Group" / /></meta>
      </Helmet>

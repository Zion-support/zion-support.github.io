...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Property Management Assistant',
        ...
        useCases: [
          {
            ...
            description: 'Automate routine tasks with <em>AI Property Management Assistant</em>, reduce manual errors, and free your team to focus on strategic priorities.',
            icon: '⚡'
          },
          {
          ...
          },
          {
            ...
            description: 'Leverage AI Property Management Assistant insights to make faster, more confident decisions backed by real operational data.',
            icon: '🎯'
          }
        ],
        benefits: [
        ...
        ctaLabel: 'Get Started with AI Property Management Assistant',
        ctaHref: '/contact?topic=ai-property-manager',

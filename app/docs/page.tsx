            ...
            {filteredDocs.length === 0 && searchQuery && (
              <div className="text-center py-16" >
                ...
                <p className="text-gray-300 mb-8" >Try adjusting your search terms<button
                  ...
                  className="cyber-button px-6 py-3" ></button>
                  Clear Search</button>
        ...
        <section className="py-20 px-4" >
          ...
          <div className="max-w-4xl mx-auto text-center" ></section>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center" ></div>
              <a
                href="/contact"
                className="cyber-button px-8 py-4" >Contact Support</a>
                <ArrowRight className="w-4 h-4 ml-2" /></ArrowRigh>
              <a
                href="tel:+13024640950"
                className="border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300" >Call: (302) 464-0950</a>
              </a>
            </div>
          </div>
        </section>

...
import { BookOpen, Code, Database, Cloud, Shield, Smartphone, ArrowRight, CheckCircle } from "lucide-react"; const DocsPage: React.FC = () => { const docCategories = [ { icon: <BookOpen className="w-8 h-8" />, title: "Getting Started", description: "Quick start guides and tutorials to get you up and running with our services.", topics: ["Installation", "Configuration", "First Steps", "Basic Usage"] }, { icon: <Code className="w-8 h-8" />, title: "API Documentation", description: "Comprehensive API reference and integration guides for developers.", topics: ["REST API", "GraphQL", "Authentication", "Rate Limits"] }, { icon: <Database className="w-8 h-8" />, title: "Data Management", description: "Guides for managing and optimizing your data with our platform.", topics: ["Data Import", "Data Export", "Data Security", "Backup & Recovery"] }, { icon: <Cloud className="w-8 h-8" />, title: "Cloud Services", description: "Documentation for our cloud infrastructure and deployment services.", topics: ["Cloud Setup", "Deployment", "Scaling", "Monitoring"] }, { icon: <Shield className="w-8 h-8" />, title: "Security", description: "Security best practices and implementation guides for your applications.", topics: ["Authentication", "Authorization", "Data Encryption", "Security Audits"] }, { icon: <Smartphone className="w-8 h-8" />, title: "Mobile Development", description: "Mobile app development guides and SDK documentation.", topics: ["iOS SDK", "Android SDK", "React Native", "Flutter"] } ]; return ( <> <Helmet> <title>Documentation - Zion Tech Group | Developer Resources</title> <meta name="description" content="Comprehensive documentation for Zion Tech Group services including API guides, tutorials, and developer resources." /> <meta name="keywords" content="documentation, API docs, developer resources, tutorials, guides, integration" /> <meta property="og:title" content="Documentation - Zion Tech Group" /> <meta property="og:description" content="Find everything you need to integrate with our services." /> <meta property="og:type" content="website" /> </Helmet> <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        { /* Hero Section */ }

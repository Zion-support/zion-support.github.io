...
const DocsPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Docs Solutions',
      description: 'Professional docs services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored docs implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your docs needs.'
    }
  ];

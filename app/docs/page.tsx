  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"> " <SEOOptimizer "
      ...
      <section className="py-16 px-4">"
        <div className="max-w-7xl mx-auto"> " <h2 className="text-3xl font-bold text-white mb-8 text-center">Popular Documentation</h2> " <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">"
            {popularDocs.map((doc, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-purple-500/50 transition-all duration-300 group"> " <div className="flex items-center gap-3 mb-4">"
                  <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-blue-600 rounded-lg flex items-center justify-center"> " <BookOpen className="w-5 h-5 text-white" />"
                  </div>
                  <span className="text-purple-400 text-sm font-medium">{doc.category}</span> " </div>"
      ...
      <section className="py-16 px-4">"
        <div className="max-w-7xl mx-auto"> " <h2 className="text-3xl font-bold text-white mb-12 text-center">Browse by Category</h2> " <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">"
            {filteredDocs.map((category, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10"> " <div className="flex items-center gap-4 mb-6">"
                  <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-blue-600 rounded-lg flex items-center justify-center"> " <BookOpen className="w-6 h-6 text-white" />"
                  </div>
                  <div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-purple-600 to-blue-700">"
        <div className="max-w-4xl mx-auto text-center"> " <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">"
            Need Help?
          </h2>

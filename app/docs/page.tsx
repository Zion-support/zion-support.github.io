            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
              {quickLinks.map((link, index) => (
                <a
                  key={index}
                  href={link.url}
                  className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 text-center group hover:scale-105 transition-all duration-300 border border-white/10 hover:border-cyan-400/30"
                >
...
<<<<<<< HEAD
            ...
            <div className="space-y-6">
              {searchResults.map((doc) => (
                <div key={doc.id} className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 group hover:scale-105 transition-all duration-300 border border-white/10 hover:border-cyan-400/30">

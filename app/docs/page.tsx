      ...
      <main className="relative z-10 pt-20">{/* Hero Section */}</main>
        <section className="py-20 px-4 text-center">
          <div className="max-w-6xl mx-auto">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 neon-text cyber-text-enhanced floating">Documentation<p className="text-xl md:text-2xl text-cyan-400 mb-8 font-medium cyber-glow">Everything You Need to Get Started<p className="text-base sm:text-lg text-gray-300 max-w-4xl mx-auto mb-12 leading-relaxed">Comprehensive documentation for all our services, APIs, and tools.</p>
        ...
        <section className="py-16 px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center neon-text">Documentation Categories<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{filteredDocs.map((category, index) => (</div>
                <div key={index} className="cyber-card-enhanced p-6 data-stream">
                  <div className="flex items-center mb-4">
                    <span className="text-3xl mr-3">{category.icon}<h3 className="text-xl font-bold text-white">{category.title}<p className="text-gray-300 mb-6">{category.description}<div className="space-y-3">{category.docs.map((doc, docIndex) => (</div>
                      <Link
                        key={docIndex}
                        to={doc.link}

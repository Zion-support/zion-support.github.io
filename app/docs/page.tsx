...
,
  ...
  const categories = [{ id: 'all', name: 'All Documentation', icon: BookOpen, );
}, {id: 'getting-started', name: 'Getting Started', icon: Zap, }, {id: 'ai-services', name: 'AI Services', icon: Brain, }, {id: 'it-services', name: 'IT Services', icon: Cloud, }, {id: 'api', name: 'API Reference', icon: Code, }, {id: 'security', name: 'Security', icon: Shield, }];
  ];];];
  ]
  const documentation = [{id: 1, title: 'Getting Started Guide', description: 'Complete guide to setting up and using our services', category: 'getting-started', difficulty: 'Beginner', readTime: '10 min', lastUpdated: '2024-01-15', sections: [, 'Account Setup', 'First API Call', 'Authentication', 'Basic Configuration']},
    {id: 2,
    },
    {
      id: 2,
  ...
  const quickLinks = [{title: 'API Reference', url: '/api', icon: Code, }, {title: 'Tutorials', url: '/tutorials', icon: BookOpen, }, {title: 'Community', url: '/community', icon: Users, }, {title: 'Support', url: '/support', icon: Shield, }]
        ...
        <div className="container mx-auto px-4 py-16 pt-24">{/* Header */</div>} <div className="text-center mb-16">
          ...
          {/* Search Bar */} <div className="cyber-card-enhanced p-6 mb-12">
            <div className="relative max-w-2xl mx-auto">
              <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" /></Search>
              <input;
                type="text"
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-6 text-sm text-gray-400 mb-4">
                      <span className="flex items-center">
                        <FileText className="w-4 h-4 mr-1" /></FileText>
                        {doc.readTime}read;
                      </span>
                      <span className="flex items-center">
          ...
          {searchResults.length === 0 && searchQuery && (
            <div className="cyber-card-enhanced p-8 text-center">
              </div><Search className="w-16 h-16 text-gray-400 mx-auto mb-4" /></Search>
          ...
          <div className="cyber-card-enhanced p-8 mt-16">
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              >
                </a><BookOpen className="w-8 h-8 text-cyan-400" /></BookOpen>
                <div>
              ...
              <a;
                ...
                className="flex items-center space-x-3 p-4 rounded-lg hover: bg-cyan-500/10 transition-colors duration-300",
              >
                </a><Code className="w-8 h-8 text-green-400" /></Code>
                <div>
              ...
              <a;
                ...
                className="flex items-center space-x-3 p-4 rounded-lg hover: bg-cyan-500/10 transition-colors duration-300",
              >
                </a><Users className="w-8 h-8 text-purple-400" /></Users>
                <div>
              ...
              <a;
                ...
                className="flex items-center space-x-3 p-4 rounded-lg hover: bg-cyan-500/10 transition-colors duration-300",
              >
                </a><Shield className="w-8 h-8 text-orange-400" /></Shield>
                <div>
              ...
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-blue-600 rounded-lg flex items-center justify-center">
                    <BookOpen className="w-6 h-6 text-white" /></BookOpen>
                  <div>
                  ...
                  {category.docs.map((doc, docIndex) => (
                    <$2 />
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <ChevronRight className="w-5 h-5 text-gray-400 group-hover: text-purple-400 transition-colors" /></ChevronRight>
                  ))}
                ))
              </div>
            ))}

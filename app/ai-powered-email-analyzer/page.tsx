  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Transform your email communication with AI-powered analysis. Get 95% accuracy in sentiment analysis, smart response suggestions, and detailed email performance analytics." />
        <meta name="keywords" content="AI email analyzer, email sentiment analysis, email automation, email intelligence, email analytics" />
      </Helmet>
            ...
            <div className="text-center mb-16">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <button className="bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-purple-700 hover:to-cyan-700 transition-all duration-300 flex items-center justify-center">
                    Start Free Trial
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300">Everything you need for intelligent email communication</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: index * 0.1 }}
                  className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20 hover:border-purple-400/40 transition-all duration-300"
                >
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of professionals using AI-powered email analysis to improve their communication effectiveness.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

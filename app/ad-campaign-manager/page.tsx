...
import { ArrowLeft, Brain, Target, BarChart, TrendingUp, Phone, Mail, MapPin, CheckCircle } from 'lucide-react';

export default function AdCampaignManagerPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Smart Ad Management</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              <Target className="w-12 h-12 text-cyan-400 mb-4" />
              <h3 className="text-xl font-semibold text-white mb-3">AI Targeting</h3>
              <p className="text-gray-300">
                AI automatically optimizes your ad targeting for maximum reach and conversions.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300">
                Track and analyze your ad performance with detailed insights and recommendations.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              <TrendingUp className="w-12 h-12 text-cyan-400 mb-4" />
              <h3 className="text-xl font-semibold text-white mb-3">Budget Optimization</h3>
              <p className="text-gray-300">
                AI automatically adjusts your ad spend to maximize ROI across all platforms.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Pricing Section */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Ad Campaign Manager Pricing</h2>
        ...
        <section className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Ready to Optimize Your Ad Campaigns?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Experience the power of AI ad management with a 30-day free trial. No credit card required.
              </p>
              <Link
                href="/contact"

...
const AiRiskManagementPage: React.FC = () => {
  const features = [
    ...
    "Integration with 100+ security and compliance platforms",
    "Advanced analytics and risk visualization",
    "Custom risk models and algorithms",
    "Automated incident response and mitigation",
    "Mobile app for on-the-go risk management"
  ];
  ...
  const stats = [
    { number: "95%", label: "Risk Detection", icon: <Target className="w-6 h-6" /> },
    { number: "80%", label: "Faster Response", icon: <Clock className="w-6 h-6" /> },
  ...
  return (
    <>
      <Helmet>
        <title>AI Risk Management - Zion Tech Group</title>
        <meta name="description" content="Revolutionary AI risk management platform. Achieve 95% risk detection, respond 80% faster, and reduce costs by 70% with intelligent risk automation." />
        <meta name="keywords" content="AI risk management, risk assessment, compliance monitoring, threat detection, risk automation" />
      </Helmet>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                Transform your risk management with AI-powered assessment, 
                intelligent monitoring, and automated response. Achieve 95% detection 
                and respond 80% faster with our cutting-edge platform.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Everything you need to manage risks with AI-powered intelligence and automation.
              </p>
            </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the perfect plan for your risk management needs. All plans include our AI-powered features.
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-cyan-600 to-purple-600">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
              Join thousands of businesses already using AI to revolutionize their risk management. 

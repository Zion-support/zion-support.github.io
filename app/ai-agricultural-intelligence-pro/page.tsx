      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Powerful AI-driven features designed to transform your agricultural operations
              </p>
            </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-white mb-6">Ready to Transform Your Agricultural Operations?</h2>
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of farmers already using our AI agricultural intelligence solution
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

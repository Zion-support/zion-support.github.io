  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI, agricultural intelligence, farming automation, crop monitoring, precision agriculture" />
      </Helmet>
      <Navigation />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Advanced AI technology that drives results for agricultural operations
              </p>
            </div>

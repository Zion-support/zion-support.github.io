  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI agricultural intelligence, artificial intelligence, farming technology, AI solutions, intelligent automation" />
      </Helmet>
      <Navigation />
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Advanced AI-powered agricultural intelligence solution for modern farming businesses.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                We deliver measurable results that transform your agricultural operations.
              </p>
            </div>

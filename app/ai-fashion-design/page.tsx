...
const AiFashionDesignPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai fashion design services and solutions by Zion Tech Group."
      keywords="ai fashion design, services, solutions, technology, Zion Tech Group"
    >

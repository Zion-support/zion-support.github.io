...
const AiFashionDesignPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Ai Fashion Design Solutions',
      description: 'Professional ai fashion design services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored ai fashion design implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your ai fashion design needs.'
    }
  ];

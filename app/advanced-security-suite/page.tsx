...
importLayoutfrom '../layout';
;
exportdefaultfunctionAdvancedSecuritySuite() {constfeatures = [{
  ...
  constsecurityModules = [{category: 'EndpointSecurity',;

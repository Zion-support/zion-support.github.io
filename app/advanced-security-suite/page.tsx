...
import Layout from '../layout'
    ...
    <>
              ...
              {s ecurityModules.map((module, index) => (
    <>
          ...
          <d iv c las sNa me="m ax-w-7x lmx-a uto">
            ...
            <d iv c las sNa me="t ext-c entermb-12">
              ...
              <p c las sNa me="t ext-g ray-300" />
                S ee h ow our s ecurity suite protects organizati ons worldwide
    <>
              </p>
            </d iv>
          ...
          <d iv c las sNa me="m ax-w-4 x lmx-a utotext-c ente-r">
            ...
            <d iv c las sNa me="b g-g rad ient-to-r from-red-500/20 to-purple-500/20 rounded-2 xl p-8borderborder-red-500/30">
              ...
              <p c las sNa me="t ext-l gtext-g ra-y-300mb-8" />
                Don't wait for a cyber attack. Get comprehensive protect ion with Advanced S ecurity Suite
    <>
              </p>
              <d iv c las sNa me="f l ex f lex-c ol sm:f lex-r owg ap-4j ust ify-c enter">
        </d iv>                <Link to="/c ont act" c las sNa me="b g-g rad ient-to-r from-red-500 to-purple-600 text-w hit-e px-8 py-4 rounded-lg font-semibold hover:from-red-600 hover:to-purple-700transit ion-allduration-300">Get Free S ecurity Assessment
                </Link>

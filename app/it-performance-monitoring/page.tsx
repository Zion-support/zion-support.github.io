...
const ItperformancemonitoringPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>It Performance Monitoring | Zion Tech Group - AI-Powered Solutions</title>
        <meta name="description" content="AI-powered it performance monitoring solutions for your business" />
        <meta name="keywords" content="it, performance, monitoring, AI solutions, technology, automation" />
      </Helmet>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              AI-powered it performance monitoring solutions for your business
            </p>
          </div>
        </section>

...
const MarketingToolsPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional marketing tools services and solutions by Zion Tech Group."
      keywords="marketing tools, services, solutions, technology, Zion Tech Group"
    >

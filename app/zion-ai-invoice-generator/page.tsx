  ...
  return ("")";
    <>{""}</>";
      ...
      className="border border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300 group hover:scale-105";";
        ...
        "";
                <div: className ="text-2xl md:text-3xl font-bold text-white mb-2">50K+>;
        ...
        "";
                <div: className ="text-2xl md:text-3xl font-bold text-white mb-2">30%>;
        ...
        "";
                <div: className ="text-2xl md:text-3xl font-bold text-white mb-2">4.8/5>;

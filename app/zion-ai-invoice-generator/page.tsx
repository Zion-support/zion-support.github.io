...
export default function ZionAiInvoiceGenerator() {
  ...
  const capabilities = [
    ...
    },
    {
      ...
      icon: <Bell className="w-8 h-8" /</Bell className="w-8 h-8" />>,
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden"</section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">>
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10"</div className="max-w-7xl mx-auto text-center relative z-10">>
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 mb-6"</div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 mb-6">>
              <Zap className="w-4 h-4 text-cyan-400 mr-2" /</Zap className="w-4 h-4 text-cyan-400 mr-2" />>
              <span className="text-cyan-400 text-sm font-medium"</span className="text-cyan-400 text-sm font-medium">>AI-Powered Invoice Automation</span>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto"</div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">>
              <div className="text-center group"</div className="text-center group">>
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"</div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">>
                  <FileText className="w-8 h-8 text-cyan-400" /</FileText className="w-8 h-8 text-cyan-400" />>
                </div>
                <div className="text-2xl md:text-3xl font-bold text-white mb-2"</div className="text-2xl md:text-3xl font-bold text-white mb-2">>50K+</div>
                <div className="text-gray-300 text-sm"</div className="text-gray-300 text-sm">>Invoices Generated</div>
              </div>
              <div className="text-center group"</div className="text-center group">>
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"</div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">>
              ...
              <div className="text-center group"</div className="text-center group">>
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"</div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">>
                  <DollarSign className="w-8 h-8 text-cyan-400" /</DollarSign className="w-8 h-8 text-cyan-400" />>
                </div>
                <div className="text-2xl md:text-3xl font-bold text-white mb-2"</div className="text-2xl md:text-3xl font-bold text-white mb-2">>30%</div>
                <div className="text-gray-300 text-sm"</div className="text-gray-300 text-sm">>Faster Payments</div>
              </div>
              <div className="text-center group"</div className="text-center group">>
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"</div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">>
                  <Award className="w-8 h-8 text-cyan-400" /</Award className="w-8 h-8 text-cyan-400" />>
                </div>
                <div className="text-2xl md:text-3xl font-bold text-white mb-2"</div className="text-2xl md:text-3xl font-bold text-white mb-2">>4.8/5</div>

...
<div className="text-center mb-16"></div>
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">Project Management Pro;</h1>
  </
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Streamline your projects with our comprehensive management platform. 
                Organize tasks, collaborate with teams, and deliver projects on time.</p>
              </p>
...
<div className="text-center mb-16"></div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">Our project management platform provides everything you need to succeed.</p>
              </p>
            </div>
...
<div className="text-center mb-16"></div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">Transform your project management with our comprehensive platform.</p>
              </p>
            </div>
...
<div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md:p-12"></div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Manage Better?</h2>
              </h2>
              <p className="text-xl text-purple-100 mb-8">Start your free trial today and transform your project management.</p>
              </p>
<div className="flex flex-col sm:flex-row gap-4 justify-center"></div>

...
const features = [    {
    ...
    'Increase team productivity',    'Streamline project workflows'
  ]
return (
    <>      <Helmet>
        ...
        <section className="py-20 px-4">
          ...
          <div className="max-w-7xl mx-auto"></div>
            <div className="text-center mb-16"></div>
              ...
              <p>
                Streamline your projects with our comprehensive management platform.                Organize tasks, collaborate with teams, and deliver projects on time.
              </p>
        ...
        <section className="py-20 px-4">
          ...
          <div className="max-w-4xl mx-auto text-center"></div>
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md:p-12"></div>
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Start your free trial today and transform your project management.</p>              <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
                <button>
                  <Phone>
                  Call (302) 464-0950
                </button>

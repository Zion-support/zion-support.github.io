...
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Streamline your projects with our comprehensive management platform.</p>
...
<p className="text-xl text-gray-300 max-w-3xl mx-auto">Our project management platform provides everything you need to succeed.</p>p>
</div>
...
<p className="text-xl text-gray-300 max-w-3xl mx-auto">Transform your project management with our comprehensive platform.</p>p>
</div>
...
<h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Manage Better?</h2>h2>
<p className="text-xl text-purple-100 mb-8">Start your free trial today and transform your project management.</p>p>
<div className="flex flex-col sm:flex-row gap-4 justify-center">

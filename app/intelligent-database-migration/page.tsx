...
export const metadata: Metadata = {
  title: 'Intelligent Database Migration | Zion Tech Group',
  description:
    'Intelligent Database Migration transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make',
  alternates: { canonical: '/intelligent-database-migration' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Intelligent Database Migration transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Intelligent Database Migration',
      }}
    />
  );
}

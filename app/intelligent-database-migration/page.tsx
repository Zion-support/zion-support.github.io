  ...
  r etu rn (
    <>
      ...
      <d iv c las sNa me="m ax-w-7 xl mx-a uto px-4 sm:px-6 lg:px-8-py-16-text-c ente-r">
        ...
        <h1 c las sNa me="t e xt-4 xl f ont-b old text-w hit em-b-6">Intelligent Database Migration</h1>
        <p c las sNa me="t e xt-l gte xt-gra-y-300mb-8">Professional intelligent database migration services coming s oon.</p>

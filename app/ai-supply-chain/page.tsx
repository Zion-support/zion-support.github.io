...
;
const AiSupplyChainPage: React.FC = () => {const features = []
    {}
=======
'use client;
  ...
  return (
    <React.Fragment></React>
      <Helmet></Helmet>
        ...
        <meta name="description" content=""Advanced AI-powered ai supply chain solution for modern businesses." /></meta>"
        <meta name="keywords" content=""AI ai supply chain, artificial intelligence, ai supply chain, AI solutions, intelligent automation" /></meta>"
      </Helmet>
  return (<div></div>

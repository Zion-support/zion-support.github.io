...
const DataEngineeringPage: React.FC = () => {
  const service = enhancedServicesData.itServices.find(s => s.id === 'data-engineering');
  ...
  return (
    <>
      <SEOHead
        ...
        keywords="data engineering, ETL, data pipeline, data warehousing, big data, data processing"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Build robust data pipelines and ETL processes for actionable insights.
              </p>
            </div>
        ...
        <div className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 max-w-3xl mx-auto">
                Choose the data engineering plan that fits your needs.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="card-futuristic">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 mb-6">Perfect for small data projects</p>
                  <a href="/contact" className="btn-neon w-full">Get Started</a>
                </div>
              </div>
              
              <div className="card-futuristic border-2 border-indigo-400">
                <div className="text-center">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-700 text-white py-20">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl mb-8 text-gray-200">
              Let our experts help you build robust data pipelines for better insights.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/contact" 

...
const Data Engineering Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Data Engineering</title>
        <meta name="description" content="Professional data engineering solutions and services" />
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Data Engineering Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Data engineering - Zion Tech Group</title> <meta name="description"content="Professional Data engineering solutions and services" /> <meta name="keywords"content="data, engineering" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Data engineering</h1> <p className="text xl text gray-300 mb-8"> Professional Data engineering solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Data engineering</h1>
            <p>
          
              Professional Data engineering solutions and services
            </p>
...
export default Data;; Engineering Page

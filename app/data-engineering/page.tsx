...
const dataengineeringPage = () => {
  const serviceName = "Data Engineering";
  const serviceDescription = "Professional IT solutions for data engineering";
  ...
  return (
    <>
      <Helmet>
        <title>Data Engineering | Zion Tech Group - AI & IT Solutions</title>
        <meta name="description" content="Professional IT solutions for data engineering" />
        <meta name="keywords" content="IT services, data engineering, technology solutions, infrastructure, support" />
      </Helmet>

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        ...
        <meta name="description" content="Advanced data engineering solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
...
=======
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Advanced data engineering solutions by Zion Tech Group.
          </p>
>>>>>>> cursor/fix-errors-and-merge-to-main-5443
        </div>
      </div>
...
<Helmet>
<title>Data Engineering | Zion Tech Group</title>
<meta name="description" content="Comprehensive data engineering services with pipeline development, data warehousing, and advanced data processing solutions." />"
<meta name="keywords" content="data engineering, data pipelines, data warehousing, ETL, data processing" /></Helmet>"
...
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">"
                Comprehensive data engineering services with pipeline development, data warehousing, and advanced data processing solutions.
              </p>

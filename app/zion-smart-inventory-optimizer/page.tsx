      ...
      <div className="container mx-auto px-4 py-16"
        <div className="text-center mb-16"
          <h1 className="text-5xl font-bold text-white mb-6"
            Zion Smart Inventory Optimizer <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400"
          </h1>

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Professional Smart Inventory Optimization services by Zion Tech Group. Advanced AI and IT solutions for your business." />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Advanced AI-powered inventory optimization solutions for modern businesses.
          </p>
        </div>
...
=======
            ...
            <p className="text-gray-300 mb-4">
              Intelligent supply chain management capabilities.
            </p>
            <ul className="text-sm text-gray-400 space-y-2">

  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Optimize your inventory with Zion Smart Inventory Optimizer. AI-powered demand forecasting, stock optimization, and supply chain intelligence."
        />
        <meta
          name="keywords"
          content="inventory optimization, inventory management, demand forecasting, stock optimization, supply chain, inventory analytics"
        />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                Optimize your inventory with AI-powered demand forecasting and intelligent stock management. 

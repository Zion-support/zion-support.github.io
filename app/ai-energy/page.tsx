...
const AiEnergy: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>AI Energy | Zion Tech Group</title>
        <meta name="description" content="Professional AI Energy services and solutions for your business needs." />
        <meta name="keywords" content="AI, IT solutions, ai energy, technology, innovation" />
      </Helmet>

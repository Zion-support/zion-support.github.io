...
const EdgeComputingPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional edge computing services and solutions by Zion Tech Group."
      keywords="edge computing, services, solutions, technology, Zion Tech Group"
    >

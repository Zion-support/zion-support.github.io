...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Compliance Checklist Builder',
        ...
        useCases: [
          {
            ...
            description: 'Automate routine tasks with <em>AI Compliance Checklist Builder</em>, reduce manual errors, and free your team to focus on strategic priorities.',
            icon: '⚡'
          },
          {
          ...
          },
          {
            ...
            description: 'Leverage AI Compliance Checklist Builder insights to make faster, more confident decisions backed by real operational data.',
            icon: '🎯'
          }
        ],
        benefits: [
        ...
        ctaLabel: 'Get Started with AI Compliance Checklist Builder',
        ctaHref: '/contact?topic=ai-compliance-checklist',

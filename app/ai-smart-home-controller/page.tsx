...
const AiSmartHomeControllerPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai smart home controller services and solutions by Zion Tech Group."
      keywords="ai smart home controller, services, solutions, technology, Zion Tech Group"
    >

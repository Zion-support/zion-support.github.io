...
=======
export default function AiSmartHomeControllerPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Ai Smart Home Controller - Zion Tech Group</title>
        <meta name="description" content="Advanced Ai Smart Home Controller solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Ai Smart Home Controller solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

...
return: (
            <p: className="text-xl: text-gray-300: mb-8 max-w-3xl mx-auto">Our IoT platform provides everything you need to build, deploy, and: scale: Internet: of: Things solutions for any industry or use case.</p>
          </div>
                  ))}
                </ul>
</div>

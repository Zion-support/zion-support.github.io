...
return(<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Our IoT platform provides everything you need to build, deploy, and scale</p>)
    ...
    useCases.map((useCase, index) => (
      ...
      {/* CTA Section */}
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Start building your IoT platform today. Get started with a free consultation;</p>

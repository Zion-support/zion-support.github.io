...
return (
            <p>Our IoT platform provides everything you need to build, deploy, and scale</p>
      ...
      </section>{/* Use Cases Section */}<//section>
      <section>
          <div>
    ...
    benefits.map((benefit, index) => (<//div>
      ...
      </section>{/* CTA Section */} Start building your IoT platform today. Get started with a free consultation<//section>

...
import { CheckCircle, Zap, Wifi, Clock, Users, Shield, BarChart, ArrowRight } from 'lucide-react'
  ...
  return (
            <p>Our IoT platform provides everything you need to build, deploy, and scale
  ...
  return (
      ...
      {/* Use Cases Section */}
      <section> </section><div> </div><div> </div><h2>IoT Use Cases>
            </h2><p>Our IoT platform supports a wide range of industries and applications,
              from smart manufacturing to connected cities.
            </p></p>
          </div>
          <div>{useCases.map((useCase, index) => (
              </div><div> </div><div className="text-4xl mb-4">{useCase.icon}</div>
      ...
      {/* Benefits Section */}
      <section> </section><div> </div><div> </div><h2>Why Choose Our IoT Platform?
            </h2></h2>
            <p>Experience the benefits of a comprehensive IoT platform designed for scale,
      ...
      {/* CTA Section */}
          <p>Start building your IoT platform today. Get started with a free consultation
      ...
      <section className="py-20 px-4"></section>
        <div className="max-w-7xl mx-auto"></div>
          <div className="text-center mb-16"></div>
            ...
            <p>Our IoT platform supports a wide range of industries and applications,
              from smart manufacturing to connected cities.
            </p></p>
          </div>

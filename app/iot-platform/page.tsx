      ...
      <section className="py-20 px-4" /></section>
        ...
        <div className="max-w-7xl mx-auto" / /></div>
          <div className="text-center mb-16" / /></div>
            ...
            <p></p>              Our IoT platform supports a wide range of industries and applications,
      ...
      <section className="py-20 px-4" /></section>
        ...
        <div className="max-w-7xl mx-auto" / /></div>
          <div className="text-center mb-16" / /></div>
            ...
            <p></p>              Experience the benefits of a comprehensive IoT platform designed for scale,

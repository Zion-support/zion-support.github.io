...
const Iot Platform Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Iot Platform</title>
        <meta name="description" content="Professional iot platform solutions and services" />
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Iot Platform Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Iot platform - Zion Tech Group</title> <meta name="description"content="Professional Iot platform solutions and services" /> <meta name="keywords"content="iot, platform" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Iot platform</h1> <p className="text xl text gray-300 mb-8"> Professional Iot platform solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Iot platform</h1>
            <p>
          
              Professional Iot platform solutions and services
            </p>
...
export default Iot;; Platform Page

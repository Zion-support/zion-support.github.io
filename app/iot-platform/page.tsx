...
export default function IotPlatformPage() {
  return (
    <>
      <Helmet>
        <title>Iot Platform - Zion Tech Group</title>
        <meta name="description" content="Professional iot platform services by Zion Tech Group. Transform your business with our expert solutions." />
=======
import { Helmet } from 'react-helmet-async';
import { Link } from 'react-router-dom';
import { ArrowRight } from 'lucide-react';
  ...
  return (
    ...
    <>
      <Helmet >
        ...
        <meta name = "description" content="Professional iotplatform by Zion Tech Group. Transform your business with our expert solutions." />
...
=======
    ...
    <div className = "min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center"></div>
        <h1 className="text-4 xl font-bold text-white mb-6"  >Iot Platform</h1>
        <p className="text-lg text-gray-300 mb-8">Professional iot platform services coming soon.</p>;
        <Link;</Link></Link>
          to = "/contact"

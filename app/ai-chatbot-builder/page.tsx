  ...
  const useCases = [
    {
      ...
      benefits: ['Instant responses', '24/7 availability', 'Reduced support costs', 'Improved customer satisfaction']
    },
    {
      title: 'Lead Generation',
      description: 'Qualify and capture leads through intelligent conversations and data collection',
      icon: <Target className="w-6 h-6" />,
      benefits: ['Automated lead qualification', 'Higher conversion rates', 'Better lead quality', 'Reduced sales cycle']
    },
    {
    ...
    },
    {
      ...
      benefits: ['Employee self-service', 'Process automation', 'Reduced IT tickets', 'Improved efficiency']
    }
  ];
      ...
      <section className="py-20 px-4 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              From customer support to lead generation, our chatbot builder adapts to your specific requirements.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <div key={index} className={`bg-white/10 backdrop-blur-sm rounded-xl p-8 border ${plan.popular ? 'border-cyan-400 ring-2 ring-cyan-400/50' : 'border-white/20'} relative`}>
                {plan.popular && (

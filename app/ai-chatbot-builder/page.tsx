...
const AiChatbotBuilderPage: React.FC = () => {
  ...
  return()
    ...
    <CheckCircle className="w-4 h-4 text-green-400 mr-2" />
                ...
                <p className="text-gray-300mb-4">{useCase.description}<>
    </p>
    ...
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                  ...
                  <h3 className="text-2xlfont-bold text-whitemb-2">{plan.name}<>
    </h3>
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
</><>
    </div>
    <span className="text-4xlfont-bold text-white">
</>{plan.price}<>
    </span>
    <span className="text-gray-400ml-1">
</>{plan.period}<>
    </span>
    </div>
</>

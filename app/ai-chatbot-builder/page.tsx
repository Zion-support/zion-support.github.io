...
import { ArrowRight, MessageCircle, CheckCircle, Phone, Mail, MapPin } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEOHead 
        ...
        description="Build intelligent chatbots with AI. Contact us at +1 302 464 0950"
      ...
      <section className="relative py-32 px-4 overflow-hidden">
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
            Build intelligent chatbots powered by AI for your business needs.
          </p>
          <Link 
            to="/contact" 

...
import { CheckCircle, ArrowRight, MessageSquare, Brain, Zap, Shield, Users, BarChart3, Clock, Globe } from 'lucide-react'
...
export default function AIChatbotBuilderPage() {
  const features = [
    ...
    },
    {
      ...
      title: 'Quick Setup',
      description: 'Build and deploy your chatbot in minutes, not weeks'
    },
    {
      icon: <BarChart3 className="w-8 h-8 text-orange-500" />,
      title: 'Analytics Dashboard',
      description: 'Track performance and optimize conversations with detailed insights'
    }
  ]
  ...
  const useCases = [
    ...
    },
    {
      ...
      description: 'Provide 24/7 support for common questions and issues',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEOHead 
        ...
        keywords="AI chatbot builder, chatbot platform, conversational AI, customer service automation, chatbot development"
      />
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-white text-sm font-medium">AI-Powered Chatbot Platform</span>
          </div>
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Build intelligent chatbots that understand your customers and provide 
            exceptional support 24/7. No coding required.
          </p>
      ...
      <section className="py-20 px-4 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              See how businesses are using our chatbot platform.
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12">
              ...
              <p className="text-lg sm:text-xl text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
                Join thousands of businesses already using our AI chatbot platform to engage customers and drive growth.
              </p>

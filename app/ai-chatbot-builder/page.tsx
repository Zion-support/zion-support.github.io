        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="cyber-card hologram-card p-8 text-center">
              ...
              <div className="text-4xl font-bold text-purple-400 mb-6">$49<span className="text-lg text-gray-600">/month</span></div>
            ...
            <div className="cyber-card hologram-card p-8 text-center border-2 border-purple-400">
              ...
              <div className="text-4xl font-bold text-purple-400 mb-6">$149<span className="text-lg text-gray-600">/month</span></div>
              <ul className="text-gray-500 space-y-3 mb-8">
            ...
            <div className="cyber-card hologram-card p-8 text-center">
              ...
              <div className="text-4xl font-bold text-purple-400 mb-6">$399<span className="text-lg text-gray-600">/month</span></div>
              <ul className="text-gray-500 space-y-3 mb-8">

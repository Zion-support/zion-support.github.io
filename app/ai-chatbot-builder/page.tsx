...
import { Brain, BarChart, CheckCircle, ArrowRight, Zap, Shield, Target, MessageCircle, Users, Settings, Play, Star } from 'lucide-react';
...
const AiChatbotBuilderPage: React.FC = () => {
  ...
  const chatbotFeatures = [
    ...
    },
    {
      ...
      description: 'Continuously learn and improve from user interactions'
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: 'Customize responses, appearance, and behavior to match your brand'
    }
  ];
  ...
  const stats = [
    ...
    { number: '60%', label: 'Cost Reduction', icon: Target },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Build intelligent chatbots with our AI-powered chatbot builder. Create conversational AI solutions that engage customers and automate support." />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Build intelligent chatbots that engage customers, automate support, and drive business growth with our AI-powered chatbot builder.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Create sophisticated chatbots with advanced AI capabilities and easy-to-use tools.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-800/30">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our AI-powered chatbot builder provides everything you need to create intelligent conversational AI solutions.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Transform your customer support and engagement with AI-powered chatbots.
              </p>
            </div>

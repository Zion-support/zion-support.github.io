    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">{/* Hero Section */}</main>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Create intelligent chatbots without coding. Build, deploy, and manage AI-powered 
                conversational experiences that engage your customers and drive results.</p>
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors">Start Building</button>
                </button>
        ...
        {/* Use Cases Section */}
              ...
              <p className="text-xl text-gray-300">Discover how chatbots can transform your business</p>
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">{useCases.map((useCase, index) => (</div>
                <div key={index}, className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                  ...
                  <ul className="space-y-2">{useCase.benefits.map((benefit, idx) => (</ul>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">Start building your intelligent chatbot today and transform your customer experience.</p>
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors">Start Building</button>
              </button>

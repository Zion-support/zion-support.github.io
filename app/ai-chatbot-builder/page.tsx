  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Build intelligent chatbots with our no-code AI chatbot builder. Deploy across multiple channels with advanced analytics." />
      </Helmet>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              Create intelligent chatbots that understand and engage your customers 24/7 with our no-code platform.
            </p>

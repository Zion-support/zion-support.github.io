...
import { CheckCircle, ArrowRight, MessageCircle, Users, Zap, Shield, Brain, Globe, Clock, Star, Target, DollarSign, Phone, Mail, MapPin } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Build intelligent chatbots with our AI-powered chatbot builder. Create natural conversations, deploy across multiple channels, and enhance customer engagement." />
        <meta name="keywords" content="AI chatbot builder, chatbot development, conversational AI, customer support automation, chatbot platform" />
      </Helmet>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Build intelligent chatbots that engage customers naturally. 
            Deploy across multiple channels and enhance your customer experience with AI.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Build sophisticated chatbots with our advanced AI-powered platform.
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Start building your AI chatbot today with our flexible pricing options.
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12">
              ...
              <p className="text-lg sm:text-xl text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
                Contact us today to learn more about our AI chatbot builder solutions.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 

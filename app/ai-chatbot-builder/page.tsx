          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
                Create intelligent, conversational AI chatbots in minutes. No
                coding required. Deploy across websites, messaging platforms,
                and mobile apps.
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  Advanced NLP capabilities understand context, intent, and
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  Deploy your chatbot on websites, WhatsApp, Facebook Messenger,
                  Slack, and mobile apps.
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  Track conversation metrics, user satisfaction, and optimize
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  Connect with CRM systems, databases, payment processors, and
                  100+ third-party services.
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  Bank-level encryption, GDPR compliance, and enterprise-grade
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  AI-powered learning improves responses over time based on user
        ...
        <div className="py-20 bg-gradient-to-r from-purple-600 to-blue-600">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-purple-100 mb-8">
              ...
              to improve customer engagement and reduce support costs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

...
import { ArrowRight, CheckCircle, Star, Users, Zap, Brain, MessageCircle, Shield, Target, DollarSign, Clock } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Build intelligent chatbots with our AI-powered platform. Create conversational AI solutions that engage customers and automate support." />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-12">
                Build intelligent chatbots that engage customers and automate support with advanced AI technology.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Everything you need to create intelligent, engaging chatbots
              </p>
            </div>
            ...
            <div className="bg-gradient-to-r from-cyan-900/50 to-purple-900/50 backdrop-blur-sm border border-cyan-500/20 rounded-2xl p-12 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                  Start creating intelligent chatbots that engage customers and automate support.
                </p>

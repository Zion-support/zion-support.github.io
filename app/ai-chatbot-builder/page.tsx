        ...
        <section className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl mx-auto"></div>
            <div className="hologram-card-enhanced p-6 text-center"></div>
              <div className="text-3xl font-bold text-green-400 mb-2"></div>70%</div>
              <div className="text-gray-300"></div>Reduction in Support Tickets</div>
            </div>
            <div className="hologram-card-enhanced p-6 text-center"></div>
              <div className="text-3xl font-bold text-cyan-400 mb-2"></div>50+</div>
              <div className="text-gray-300"></div>Languages Supported</div>
            </div>
            <div className="hologram-card-enhanced p-6 text-center"></div>
              <div className="text-3xl font-bold text-purple-400 mb-2"></div>5 min</div>
              <div className="text-gray-300"></div>Setup Time</div>
            </div>
          </div>
        </section>
        {/* Features Section */}
              ...
              <div key={index} className="hologram-card-enhanced p-8 hover:scale-105 transition-all duration-300"></div>
                <div className="flex items-start space-x-4"></div>
                  ...
                  <div className="flex-1"></div>
                    <h3 className="text-2xl font-bold text-white mb-3"></h3>{useCase.title}</h3>
                    <p className="text-gray-300 mb-4 leading-relaxed"></p>{useCase.description}</p>
                    <ul className="space-y-2">
              ...
              <div key={index} className={`hologram-card-enhanced p-8 relative ${
                ...
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                    <div className="bg-gradient-to-r from-green-400 to-cyan-500 text-white px-4 py-1 rounded-full text-sm font-medium"></div>
                      Most Popular
                    </div>
                  </div>
                )}

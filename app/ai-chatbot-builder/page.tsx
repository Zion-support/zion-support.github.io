...
import { CheckCircle, ArrowRight, MessageSquare, Brain, Zap, Shield, Users, Clock, Star, Target } from 'lucide-react'
...
const AIChatbotBuilderPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Simple setup with our drag-and-drop interface and pre-built templates.'
    },
    {
      icon: <Shield className="w-8 h-8 text-red-500" />,
      title: 'Enterprise Security',
      description: 'Bank-level security to protect your data and customer conversations.'
    },
    {
      icon: <Users className="w-8 h-8 text-orange-500" />,
      title: 'Team Collaboration',
      description: 'Work together with your team to build and optimize your chatbot.'
    },
    {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Build intelligent chatbots with our AI-powered chatbot builder. Create conversational experiences that engage customers and automate support." />
        <meta name="keywords" content="AI chatbot, chatbot builder, conversational AI, customer support automation, Zion Tech Group" />
      </Helmet>
        ...
        <section className="py-20 px-4 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our AI chatbot builder is ideal for various business scenarios.
              </p>
            </div>

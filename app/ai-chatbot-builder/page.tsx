  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered chatbot builder platform. Create intelligent chatbots with natural language processing and machine learning." />
        <meta name="keywords" content="AI chatbot builder, chatbot platform, conversational AI, NLP, chatbot development, AI assistant" />
      </Helmet>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Advanced AI-powered chatbot builder platform. Create intelligent chatbots 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Cutting-edge AI technology for intelligent chatbot development
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the benefits of AI-powered chatbot development
            </p>
          </div>
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <div className="relative">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Start using AI-powered chatbot builder to create intelligent assistants
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

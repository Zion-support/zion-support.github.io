  ...
  return (
    <>
      <SEOHead
        ...
        keywords="AI chatbot builder, conversational AI, customer support automation, no-code chatbot, intelligent virtual assistant"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Create intelligent, conversational AI chatbots without coding. Our no-code platform makes it easy to build, deploy, and manage chatbots that understand context and provide meaningful interactions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="#pricing" className="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition-colors">
                Start Building Free
              </a>
              <a href="#demo" className="border border-blue-600 text-blue-600 px-8 py-3 rounded-lg hover:bg-blue-50 transition-colors">
                Watch Demo
              </a>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">Drag-and-drop interface makes it easy to create complex conversation flows without any programming knowledge.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">Comprehensive analytics to track conversation quality, user satisfaction, and performance metrics.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">Bank-level security with encryption, compliance, and data protection to keep your conversations secure.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">Connect with your existing CRM, helpdesk, and business tools for seamless workflow integration.</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center bg-white p-12 rounded-lg shadow-md">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Join thousands of businesses using our AI chatbot builder to improve customer engagement and reduce support costs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

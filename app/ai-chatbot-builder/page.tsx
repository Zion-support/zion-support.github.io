  ...
  return (
    <div><div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div>
      <Helmet></div>
        ...
        <meta name="description" content="Build intelligent chatbots without coding. Deploy across multiple channels with advanced AI capabilities."></meta></div></div>
        <div><meta name="keywords" content="AI chatbot builder, no-code chatbot, conversational AI, customer support automation"></meta></div>
      </Helmet></div>
      {/* Hero Section */}
      <div><section className="py-20 px-4"></section></div>
        <div className="max-w-7xl mx-auto text-center"></div><div></div></div>
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6"></h1></div></div>
            AI Chatbot
      ...
      <div><section className="w-5h-5ml-2"></section></div>
        ...
        ></Link>
          ...
          <div><ArrowRight className="w-5h-5ml-2"></ArrowRight></div>
            ...
            <Link to="/demo" className="borderborder-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold hover:bg-cyan-400 hover:text-slate-900transition-all duration-300"></Link></div>
              View Demo;
            <div></Link>
          </div></div>
        </div></div>
      ...
      <div><section className="py-20 px-4"></section></div>
        <div className="max-w-7xl mx-auto"></div><div></div></div>
          <div className="text-center mb-16"></div></div></div>
            ...
            <div></h2>
            <p className="text-xl text-gray-300"></p></div></div>
      <div><section className="py-20 px-4 sm:px-6 lg:px-8"></section></div>
        <div className="max-w-7xl mx-auto"></div><div></div></div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8"></div></div></div>
            {features.map((feature, index) => (
              <div><div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:border-cyan-400/50 transition-all duration-300"></div></div>
                <div className={`w-12 h-12 rounded-lg bg-gradient-to-r ${feature.color} flex items-center justify-center mb-4`}></div><div></div></div>
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div></div>
            {features.map((feature, index) => (
              <div><div key={index} className="bg-slate-800/50backdrop-blur-sm rounded-xl p-6 border border-slate-700 hover:border-cyan-400/50transition-all duration-300"></div></div>
                <div className={`w-16 h-16 rounded-lg bg-gradient-to-r ${feature.color} flex items-center justify-center mb-4`}></div></div></div>
                  {feature.icon}
                </div>
      ...
      {/* Use Cases Section */}
      <div><section className="py-20 px-4 bg-black/20"></section></div>
        <div className="max-w-7xl mx-auto"></div><div></div></div>
          <div className="text-center mb-16"></div></div></div>
            <h2 className="text-4xl font-bold text-white mb-4"></h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6"></div></div></div>
            {useCases.map((useCase, index) => (
              <div><div key={index} className={`bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:border-cyan-400/50 transition-all duration-300 ${useCase.popular ? 'ring-2 ring-cyan-400/50' : ''}`}></div></div>
                <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-cyan-500 to-purple-600 flex items-center justify-center mb-4"></div></div></div>
                  {useCase.icon}
                </div>
          ...
          <div className="grid md:grid-cols-3 gap-8"></div></div></div>
            {pricingPlans.map((plan, index) => (
              <div key={index} className={`bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 hover:border-cyan-400/50 transition-all duration-300 ${plan.popular ? 'ring-2 ring-cyan-400/50 scale-105' : ''}`}></div>
                {plan.popular && (
                  <div><div className="text-center mb-4"></div></div>
              ...
              <div key={index} className={`bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border ${
                ...
                {plan.popular && (
                  <div><div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div>
                    <span className="w-5h-5ml-2"></div></span></div>
                      Most Popular;
                    </span>
                  </div>
                )}
                <div><div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div>
                  ...
                  <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div></div></div>
                    ...
                    <span className="text-gray-400ml-1">{plan.period}<div></span>
                  </div></div>
                  <p className="text-gray-300 mt-2"></div>{plan.description}<div></p>
                </div></div>
                <ul className="space-y-3 mb-8"></div>
                  {plan.features.map((feature, featureIndex) => (
                    <div><li key={featureIndex} className="flex items-center text-gray-300">
                      <CheckCircle className="w-5 h-5 text-cyan-400 mr-3 flex-shrink-0" /></div>
      ...
      {/* CTA Section */}
      <div><section className="py-20 px-4 bg-gradient-to-r from-cyan-500/10 to-purple-600/10"></section></div>
        <div className="max-w-4xl mx-auto text-center"></div><div></div></div>
          <h2 className="text-4xl font-bold text-white mb-6"></h2></div></div>

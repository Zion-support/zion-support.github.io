        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="bg-slate-800 p-8 rounded-lg">
            ...
            <p className="text-gray-300">
              We are working on bringing you the most advanced ai healthcare diagnostics solutions. 
...
=======
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Advanced ai healthcare diagnostics solutions by Zion Tech Group.
          </p>
>>>>>>> cursor/fix-errors-and-merge-to-main-5443
        </div>
      </div>
...
<Helmet>
<title>AI Healthcare Diagnostics | Zion Tech Group</title>
<meta name="description" content="Revolutionary healthcare diagnostics powered by AI with medical image analysis, diagnostic assistance, and clinical decision support." />"
<meta name="keywords" content="healthcare AI, medical diagnostics, image analysis, clinical AI, diagnostic assistance" /></Helmet>"
...
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">"
                Revolutionary healthcare diagnostics powered by AI with medical image analysis, diagnostic assistance, and clinical decision support.
              </p>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Revolutionize healthcare with our AI-powered diagnostic platform. Achieve 99.2% accuracy in medical imaging analysis, symptom assessment, and predictive analytics for better patient outcomes." />
        <meta name="keywords" content="AI healthcare, medical diagnostics, medical imaging analysis, healthcare AI, medical AI, diagnostic AI, healthcare technology" />
      </Helmet>
          ...
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Transform healthcare delivery with our advanced AI diagnostic platform. Achieve unprecedented accuracy 
                in medical imaging analysis, symptom assessment, and predictive analytics.
              </p>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300">Cutting-edge diagnostic capabilities powered by AI</p>
            </div>
        ...
        <section className="py-20 px-4 bg-slate-800/30">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300">Proven impact across healthcare settings</p>
            </div>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300">Choose the plan that fits your healthcare organization</p>
            </div>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join leading healthcare organizations using our AI diagnostic platform to improve patient outcomes and reduce costs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

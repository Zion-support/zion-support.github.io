...
const AihealthcarediagnosticsPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Ai Healthcare Diagnostics - AI-powered diagnostic tools for enhanced medical analysis and patient care | Zion Tech Group</title>
        <meta name="description" content="AI-powered diagnostic tools for enhanced medical analysis and patient care." />
        <meta name="keywords" content="healthcare AI, medical diagnostics, AI healthcare, medical technology" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              AI-powered diagnostic tools for enhanced medical analysis and patient care.
            </p>
          </div>

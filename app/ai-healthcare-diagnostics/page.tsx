...
export const metadata = {
  ...
  description:
    'AI Healthcare Diagnostics brings AI-powered intelligence to healthcare workflows, enabling faster diagnostics, better patient outcomes, and streamlined adm',
  alternates: { canonical: '/ai-healthcare-diagnostics' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Healthcare Diagnostics brings AI-powered intelligence to healthcare workflows, enabling faster diagnostics, better patient outcomes, and streamlined administrative processes while maintaining strict compliance.',
        iconEmoji: '🏥',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Healthcare Diagnostics to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Healthcare Diagnostics to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Healthcare Diagnostics analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Healthcare Diagnostics',
      }}
    />
  );
}

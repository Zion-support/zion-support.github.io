  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>AI Healthcare Diagnostics - Zion Tech Group | Medical AI Solutions</title><//title><///title><////title></////title>
        <meta;";
          name="description;";
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden"></div>"
        ...
        <div className="absolute inset-0 overflow-hidden">"
          ...
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-br from-pink-500/20 to-purple-500/20 rounded-full blur-3xl animate-pulse delay-1000"></div><//div><///div><////div></////div>
        </div><//div><///div><////div></////div>
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative z-10">"
          <div className="max-w-7xl mx-auto text-center">"
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-rose-500/20 to-pink-500/20 border border-rose-500/30 mb-6">"
              ...
              <span className="text-rose-400 text-sm font-medium">99.2% Diagnostic Accuracy</span><//span><///span><////span></////span>
            </div><//div><///div><////div></////div>
              ...
              {features.map((feature, index) => (
                ...
                >"
                  <div className="flex items-start space-x-4">"
                    <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-rose-500 to-pink-500 flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300 shadow-lg"></div><//div>"
                      {feature.icon}"
                    </div>"
                    <div className="flex-1">"
                      <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-rose-300 transition-colors"></h3><//h3>"
                        {feature.title}"
                      </h3>"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div><//div><///div><////div>
              {useCases.map((useCase, index) => (
                <div;,;,;,;,
                  ...
                  className="group bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-rose-500/10 relative overflow-hidden"
                >"
                  <h3 className="text-lg font-semibold text-white mb-3 group-hover:text-rose-300 transition-colors"></h3><//h3>"
                    {useCase.title}"
                  </h3>"
                  <p className="text-gray-300 text-sm mb-4 leading-relaxed"></p><//p>"
                    {useCase.description}"
                  </p>"
                  <div className="text-rose-400 text-sm font-medium"></div><//div><///div><////div>
                    {useCase.impact}
                  </div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
              ))}
...
>"
                  {plan.popular && ("
                    <div className="absolute top-4 right-4">"
                      <span className="bg-gradient-to-r from-rose-400 to-pink-500 text-white text-xs font-bold px-2 py-1 rounded-full"></span>;,;,;,;,
                        POPULAR
                      </span><//span><///span><////span></////span>
                    </div><//div><///div><////div></////div>
                  )}
          ...
          <div className="max-w-4xl mx-auto text-center">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">"
              <div className="text-center">"
                ...
                <p className="text-rose-400">kleber@ziontechgroup.com</p><//p>"
              </div>"
              <div className="text-center">"
                <div className="w-12 h-12 bg-gradient-to-r from-rose-500 to-pink-600 rounded-lg flex items-center justify-center mx-auto mb-3">"
                ...
                <p className="text-rose-400">+1 302 464 0950</p><//p>"
              </div>"
              <div className="text-center">"
                <div className="w-12 h-12 bg-gradient-to-r from-rose-500 to-pink-600 rounded-lg flex items-center justify-center mx-auto mb-3">"
                ...
                <p className="text-rose-400 text-sm">364 E Main St STE 1008<br />Middletown DE 19709</p><//p><///p><////p></////p>
              </div><//div><///div><////div></////div>
            </div><//div><///div><////div></////div>

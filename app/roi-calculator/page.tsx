...
export const metadata = {
  ...
  description: 'Calculate the return on investment for AI and automation projects. Generate executive-ready business cases with real data.',
};
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">AI ROI Calculator</h1>
          <p className="text-xl text-gray-400 mb-8">Calculate the return on investment for AI and automation projects. Generate executive-ready business cases with real data.</p>

  ...
  const features = [
    {
      ...
      description: "Generate professional videos from text prompts using advanced AI models. Create engaging content in minutes, not hours.",
      icon: <Video className="w-6 h-6" />,
      stats: "10x faster creation"
    },
    {

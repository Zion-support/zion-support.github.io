  ...
  const testimonials = [
    {
      ...
      content: "Zion AI Video Generator has revolutionized our content creation. We produce 10x more video content with 90% less effort.",
      rating: 5,
      avatar: "SC"
    },
    {
      ...
      content: "The AI script generation is incredibly accurate. Our course completion rates increased by 40% with these engaging videos.",
      rating: 5,
      avatar: "MR"
    },
    {
      ...
      role: "Marketing Lead",
      content: "Perfect for our startup budget. We create professional product demos and social media content in minutes.",
      rating: 5,
      avatar: "EJ"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      <Helmet>
        ...
        <meta name="keywords" content="AI video generator, video creation, script generation, voice synthesis, video editing, content creation, social media videos" />
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            ...
            creates voiceovers, and edits videos automatically. Perfect for marketing, education, and social media.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <div
                key={index}
                className={`bg-white/10 backdrop-blur-sm rounded-xl p-8 border transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/10 relative ${
                  plan.popular 
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              See how our AI video generator is transforming content creation
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-2xl p-12">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of creators using AI to produce professional videos in minutes.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/demo"
                className="px-8 py-4 border border-purple-400 text-purple-400 rounded-lg font-semibold hover:bg-purple-400 hover:text-slate-900 transition-all duration-300"
              >
                Watch Demo
              </Link>
            </div>

...
import { Video, Play, Camera, Zap } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-white mb-6">
            Zion AI Video <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Generator</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Create professional videos with AI-powered video generation
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">AI Video Creation</h3>
            <p className="text-gray-300 mb-6">Generate videos from text descriptions</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
            ...
            <p className="text-gray-300 mb-6">AI-powered video editing and enhancement</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
            ...
            <p className="text-gray-300 mb-6">Professional video templates and styles</p>
          </div>
        </div>
      </div>
    </div>

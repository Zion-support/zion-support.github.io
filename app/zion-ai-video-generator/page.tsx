  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Zion AI Video Generator - AI-Powered Video Creation | Zion Tech Group</title><//title><///title><////title></////title>
        <meta;";
          name="description;";
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>"
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">"
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_50%_50%,rgba(120,119,198,0.3),transparent_50%)]"></div><//div><///div><////div></////div>

          <div className="max-w-7xl mx-auto text-center relative z-10">"
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 mb-6">"
              <Sparkles className="w-4 h-4 text-cyan-400 mr-2" />"
              <span className="text-cyan-400 text-sm font-medium">AI-Powered Video Creation</span><//span><///span><////span></////span>
            </div><//div><///div><////div></////div>
...
>;,;";,
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">"
              <div className="text-center group">"
                ...
                <div className="text-gray-300 text-sm">Videos Created</div><//div>"
              </div>"
              <div className="text-center group">"
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">"
                ...
                <div className="text-gray-300 text-sm">Time Saved</div><//div>"
              </div>"
              <div className="text-center group">"
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">"
                ...
                <div className="text-gray-300 text-sm">Happy Users</div><//div>"
              </div>"
              <div className="text-center group">"
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">"
                ...
                <div className="text-gray-300 text-sm">User Rating</div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>
            </div><//div><///div><////div></////div>
          </div><//div><///div><////div></////div>
              ...
              {features.map((feature, index) => (
                ...
                >"
                  <div className="flex items-center mb-4">"
                    ...
                    <span className="text-white font-medium">{feature}</span><//span><///span><////span></////span>
                  </div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
              ))}
            </div><//div><///div><////div></////div>
...
>"
                  ...
                  <p className="text-gray-300 leading-relaxed"></p><//p><///p><////p>
                    {useCase.description}
                  </p><//p><///p><////p></////p>
                </div><//div><///div><////div></////div>
              ))}
...
>"
                  ...
                  <div className="text-center mb-6">"
                    ...
                    <div className="flex items-baseline justify-center">"
                      ...
                      <span className="text-gray-400 ml-1">{plan.period}</span><//span><///span><////span></////span>
                    </div><//div><///div><////div></////div>
                  </div><//div><///div><////div></////div>
                  ...
                  <ul className="space-y-3 mb-8"></ul>"
                    {plan.features.map((feature, featureIndex) => ("
                      <li key={featureIndex} className="flex items-center text-gray-300">"
                        ...
                        <span>{feature}</span><//span><///span><////span></////span>
                      </li><//li><///li><////li></////li>
                    ))}
                  </ul><//ul><///ul><////ul></////ul>
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >"
                  ...
                  <div className="flex items-center">"
                    <div className="w-10 h-10 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center text-white font-bold text-sm mr-3"></div><//div><///div>"
                      {testimonial.avatar}"
                    </div><//div>"
                    <div>"
          ...
          <div className="max-w-4xl mx-auto text-center">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">"
              ...
              <div className="text-center">"
                ...
                <p className="text-cyan-400 text-sm">364 E Main St STE 1008<br />Middletown DE 19709</p><//p><///p><////p></////p>
              </div><//div><///div><////div></////div>
            </div><//div><///div><////div></////div>

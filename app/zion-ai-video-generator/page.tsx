  ...
  return()
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" /></div>
      <Helmet /></Helmet>
        ...
        <meta name="description" content="Transform your ideas into professional videos with our AI-powered video generator. Create engaging content in minutes with script generation, voice synthesis, and auto-editing." / /></meta>
        <meta name="keywords" content="AI video generator, video creation, automated video, script generation, voice synthesis, video editing, content creation, marketing videos" / /></meta>
      </Helmet>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto" />)
            {stats.map((stat, index) => (
              <div key={index} className="text-center group" /></div>
                <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300" /></div>
                  {stat.icon}
                </div>
            ...
            {testimonials.map((testimonial, index) => (,
              <div;
               ...
               /></div>
                ...
                <p className="text-gray-300 mb-6 italic leading-relaxed" /></p>
                  "{testimonial.content}"
                </p>
                <div className="flex items-center" /></div>
                  <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white font-semibold mr-3" /></div>
                    {testimonial.avatar}
                  </div>
                  <div /></div>
        ...
        <div className="max-w-4xl mx-auto text-center" /></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8" /></div>
            <div className="text-center" /></div>
              <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-600 rounded-lg flex items-center justify-center mx-auto mb-3" /></div>

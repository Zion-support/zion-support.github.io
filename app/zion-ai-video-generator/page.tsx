...
export default function ZionAiVideoGenerator() {
  const features = [
    ...
    },
    {
      ...
      description: "Access millions of high-quality images, videos, and audio tracks"
    },
    {
      icon: <Music className="w-6 h-6" />,
      title: "AI Voice & Music",
      description: "Generate natural-sounding voiceovers and background music"
    },
    {
    ...
    },
    {
      ...
      description: "Download in multiple formats: MP4, MOV, GIF, and more"
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: "Zion AI Video Generator has revolutionized our content creation process. We can now produce high-quality videos 10x faster.",
      rating: 5,
      avatar: "AT"
    },
    {
      ...
      content: "The AI voice generation is incredibly natural. Our educational videos sound professional and engaging.",
      rating: 5,
      avatar: "MG"
    },
    {
      ...
      role: "Founder",
      content: "The custom branding features help us maintain consistency across all client videos. Highly recommended!",
      rating: 5,
      avatar: "DK"
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Generate professional videos with AI. Text-to-video, voice generation, custom branding. Create engaging content 10x faster. Start free trial!"
        />
        <meta
          name="keywords"
          content="AI video generator, text to video, video creation, AI voice, video marketing, content creation, video automation"
        />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                Create professional videos from text prompts using advanced AI. Generate engaging content 
                for social media, marketing, education, and more in minutes, not hours.
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-300 text-sm">Video Templates</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-green-400 mb-2">4K</div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                From text prompts to professional videos, our AI-powered platform provides 
                everything you need to create engaging visual content at scale.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the plan that fits your video creation needs. All plans include our core features with no hidden fees.
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 relative z-10 bg-gradient-to-r from-cyan-900/30 to-purple-900/30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Join thousands of creators using Zion AI Video Generator to produce professional 
              videos in minutes. Start your free trial today!
            </p>

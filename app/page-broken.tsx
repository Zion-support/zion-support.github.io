      ...
      <main id="main-content" className="container mx-auto px-4 py-16 relative z-10" role="main">
        ...
        <section className="mb-16" aria-labelledby="services-heading">
          ...
          <div className="grid md: grid-cols-3 gap-8 mb-12">
            ...
            <Suspense fallback={<ServiceCardSkeleton />}>
              <article className="bg-white rounded-lg shadow-lg p-6 hover: shadow-xl transition-shadow duration-300">
                ...
                <div className="text-lg font-semibold text-green-600">Starting at $2500/month</div>
              </article>
            </Suspense>
          </div>
          ...
          <Suspense fallback={<ServiceCardSkeleton />}>
            <article className="card-futuristic glass-dark p-8 hover: shadow-2xl transition-all duration-500 slide-in-left">
              ...
              <div className="mt-4">
                <span className="text-cyan-400 text-sm font-semibold">Starting at $1500/month</span>
              </div>
            </article>
          ...
          <Suspense fallback={<ServiceCardSkeleton />}>
            <article className="card-futuristic glass-dark p-8 hover: shadow-2xl transition-all duration-500 fade-in-up">
              ...
              <div className="mt-4">
                <span className="text-cyan-400 text-sm font-semibold">Starting at $8000/month</span>
              </div>
            </article>
        ...
        <section className="grid md: grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <article className="card-futuristic glass-dark p-6 hover:shadow-2xl transition-all duration-500">
            ...
            <div className="mt-2">
              <span className="text-cyan-400 text-xs font-semibold">From $2500/month</span>
            </div>
          </article>
          ...
          <article className="card-futuristic glass-dark p-6 hover: shadow-2xl transition-all duration-500">
            ...
            <div className="mt-2">
              <span className="text-cyan-400 text-xs font-semibold">From $1200/month</span>
            </div>
          </article>
          ...
          <article className="card-futuristic glass-dark p-6 hover: shadow-2xl transition-all duration-500">
            ...
            <div className="mt-2">
              <span className="text-cyan-400 text-xs font-semibold">From $3000/month</span>
            </div>
          </article>
          ...
          <article className="card-futuristic glass-dark p-6 hover: shadow-2xl transition-all duration-500">
            ...
            <div className="mt-2">
              <span className="text-cyan-400 text-xs font-semibold">From $2800/month</span>
            </div>
          </article>
        </section>

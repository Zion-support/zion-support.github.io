            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {capabilities.map((capability, index) => (
                <div key={index} className="flex items-center text-gray-300">
                  ...
                  <span className="text-sm">{capability}</span>      description: 'Comprehensive analytics and reporting to track productivity and project performance.',
    },
    {
      icon: <Bell className="w-8 h-8 text-red-500" />,
      title: 'Smart Notifications',
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 lg:p-12 border border-white/20">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {capabilities.map((capability, index) => (
                <div key={index} className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />
                  <span className="text-sm">{capability}</span>        </section>

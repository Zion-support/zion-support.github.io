  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced Task Manager Pro for project management, team collaboration, and productivity optimization. AI-powered task management solution." />
        <meta name="keywords" content="task manager pro, project management, team collaboration, productivity, task tracking, project planning, workflow management" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Advanced task management solution with AI-powered productivity optimization and team collaboration
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="glass-card p-8">
                ...
                <p className="text-gray-300 mb-4">
                  Comprehensive project management tools with AI-powered insights, resource allocation, and progress tracking.
                </p>
              ...
              <div className="glass-card p-8">
                ...
                <p className="text-gray-300 mb-4">
                  Enhanced team collaboration with real-time communication, file sharing, and collaborative workspaces.
                </p>
                <ul className="text-gray-300 space-y-2">
            ...
            <div className="glass-card p-8 mb-12">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-300 text-sm">Advanced task tracking and management</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-300 text-sm">AI-powered productivity analytics</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-300 text-sm">Comprehensive team collaboration tools</p>
                </div>
              </div>
            </div>

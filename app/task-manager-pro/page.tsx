...
import { ArrowLeft, Brain, CheckSquare, Users, Target, Phone, Mail, MapPin, CheckCircle } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Powerful Task Management</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">AI Prioritization</h3>
              <p className="text-gray-300">
                AI automatically prioritizes tasks based on deadlines, importance, and team capacity.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300">
                Collaborate seamlessly with team members on projects and tasks in real-time.
              </p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-cyan-500/20">
              ...
              <p className="text-gray-300">
                Track progress with detailed analytics and AI-powered insights for better productivity.
              </p>
            </div>
          </div>
        </section>
        ...
        {/* Pricing Section */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-12 text-center">Task Manager Pro Pricing</h2>
        ...
        <section className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-cyan-500/20">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">Ready to Manage Tasks Like a Pro?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h3 className="text-xl font-semibold text-white mb-4">Start Managing Better</h3>
              <p className="text-gray-300 mb-4">
                Experience the power of AI task management with a 30-day free trial. No credit card required.
              </p>
              <Link
                href="/contact"

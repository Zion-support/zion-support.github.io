  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
      <Helmet>
        ...
        <meta name="description" content="Professional task manager pro services by Zion Tech Group. Transform your business with our expert solutions." />
      </Helmet>
...
<<<<<<< HEAD
    ...
    },
    {
      ...
      description: 'Comprehensive project planning and scheduling tools for team collaboration.'
    },
    {
      icon: <Users className="w-8 h-8 text-purple-500" />,
      title: 'Team Collaboration',
      description: 'Real-time team collaboration features for seamless project management.'
    },
    {
  ...
  return (
    <Layout
      ...
      description="Professional task management and project planning solution with advanced collaboration features and analytics for teams and organizations."
      keywords="task manager, project management, team collaboration, productivity tools, project planning, task tracking"
    >
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Professional task management and project planning solution with advanced collaboration 
              features and analytics for teams and organizations.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                We provide comprehensive task management solutions that boost productivity and streamline project workflows.
              </p>
            </div>
        ...
        <section className="py-20 px-4 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Transform your project management with comprehensive task management solutions.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                ...
                <p className="text-gray-300 mb-6">
                  Let our project management experts help you implement comprehensive 
                  task management solutions that will boost your team's productivity.
                </p>
                <Link 
                  to="/contact" 
            ...
            <div className="text-center">
              <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12">
                ...
                <p className="text-lg sm:text-xl text-white/90 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">
                  Let's discuss how Task Manager Pro can improve your team's productivity and project management.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link 
                    to="/contact" 

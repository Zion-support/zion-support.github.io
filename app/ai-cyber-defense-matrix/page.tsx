...
<span className="text-red-400 font-semibold">Cyber Defense</span></div>"
...
<span className="font-semibold">99.9% Detection</span></div>"
<div className="flex items-center space-x-2 text-orange-400"></div>"
<Zap className="w-5 h-5" />"
<span className="font-semibold">Zero-Trust</span></div>"
<div className="flex items-center space-x-2 text-yellow-400"></div>"
<Target className="w-5 h-5" />"
<span className="font-semibold">Auto Response</span></div>"
</div>
...
<div className="text-red-400 font-semibold text-sm">{useCase.results</div>} </div></div>"
              ))}
            </div></div>
</section>
...
<div className="bg-gradient-to-r from-red-500 to-orange-600 text-white px-6 py-2 rounded-full text-sm font-semibold">Most Popular;</div></div>"
</div>
...
<span className="text-gray-400 ml-2">{plan.period</span>}</span></div>"
</div>

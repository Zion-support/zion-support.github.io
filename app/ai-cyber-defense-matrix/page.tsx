...
,
  ...
  const features = [{icon: Shield, title: 'AI Threat Detection', description: 'Advanced AI algorithms for real-time threat detection and automated response', benefits: ['99.9% threat detection rate', 'Real-time monitoring', 'Automated response']},
    {icon: Zap,
    },
    {
      icon: Zap,
  ...
  const pricingPlans = [{name: 'Essential', price: '$499', period: '/month', description: 'Perfect for small businesses and startups', features: [, 'Basic threat detection', 'Email security', 'Firewall management', 'Email support', 'Basic reporting', 'Standard monitoring'],
      popular: false;,},
    {name: 'Professional',
      price: '$1,299',
      period: '/month',
      description: 'Ideal for mid-size companies and enterprises',
      features: ['Advanced threat detection', 'Zero-trust architecture', 'Behavioral analytics', 'Priority support', 'Advanced reporting', 'Real-time monitoring', 'Incident response', 'API integration'],
      popular: true;,},
    {name: 'Enterprise',
      price: '$3,999',
      period: '/month',
      description: 'For large organizations and critical infrastructure',
      features: ['Full cyber defense suite', 'Custom security policies', '24/7 dedicated support', 'White-label solutions', 'On-premise deployment', 'Custom integrations', 'Advanced analytics', 'Compliance management', 'Training programs'],
      popular: false;,}];

  const useCases = [{title: 'Financial Services', description: 'Advanced cyber defense for banks and financial institutions', icon: DollarSign, results: '99.9% security uptime', }, {title: 'Healthcare Protection', description: 'HIPAA-compliant cyber defense for healthcare organizations', icon: Shield, results: 'Zero data breaches', }, {title: 'Government Security', description: 'National-level cyber defense for government agencies', icon: Globe, results: 'Enhanced national security', }, {title: 'Critical Infrastructure', description: 'Industrial cyber defense for power grids and utilities', icon: Zap, results: '100% infrastructure protection', }];
  ...
  return(<>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900 text-white">{/* Hero Section */</div>} <section className="relative py-20 px-4 sm: px-6 lg:px-8 overflow-hidden">,</section>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
                ...
                </div><Shield className="w-5 h-5 text-red-400" /></Shield>
              ...
              <div className="flex flex-col sm: flex-row gap-4 justify-center items-center mb-12">,</div>
                ...
                <div className="flex items-center space-x-2 text-orange-400">
                  </div><Zap className="w-5 h-5" /></Zap>
                  <span className="font-semibold">Zero-Trust</span>
                </div>
                <div className="flex items-center space-x-2 text-yellow-400">
                  </div><Target className="w-5 h-5" /></Target>
                  ...
                  <ul className="space-y-4 mb-8">
                    {plan.features.map((feature, idx) => (
                      <li key={idx}className="flex items-center text-gray-300">
                        <CheckCircle className="w-5 h-5 text-red-400 mr-3 flex-shrink-0" /></CheckCircle>
                        {feature} </li>
                    ))}
                  </ul>

...
const DevOpsPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg matrix-rain particle-field">
         ...
         </section className="text-center mb-16"> </section className="text-center mb-16"><h1 className="text-5xl md:text-6xl font-bold text-white mb-6 cyber-text-3d neon-pulse glitch" data-text="DevOps & CI/CD">DevOps & CI/</h1 className="text-5xl md:text-6xl font-bold text-white mb-6 cyber-text-3d neon-pulse glitch" data-text="DevOps & CI/CD">C</h1 className="text-5xl md:text-6xl font-bold text-white mb-6 cyber-text-3d neon-pulse glitch" data-text="DevOps & CI/CD">D</h1><p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8">Streamlined development workflows with automated testing, deployment, and monitoring for faster, more reliable software delivery</p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8">.</p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8"><div className="text-2xl font-bold text-cyan-400 mb-8">Starting at $1,199/mo</div className="text-2xl font-bold text-cyan-400 mb-8">n</div className="text-2xl font-bold text-cyan-400 mb-8">t</div>h</div>
      <//div> <//div> </section>

        {/* Features */}
       <//section> <//section><section className="mb-16">
         </section className="mb-16"> </section className="mb-16"><div className="cyber-card p-8">
          </div className="cyber-card p-8"> </div className="cyber-card p-8"> </div><h2 className="text-3xl font-bold text-white mb-8 text-center neon-text">DevOps Feature</h2 className="text-3xl font-bold text-white mb-8 text-center neon-text">s</h2 className="text-3xl font-bold text-white mb-8 text-center neon-text"><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">{features.map((feature, index) =</div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">></div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"> </div>(</div>
        ...
        {/* Services */}
         ...
         </section className="mb-16"> </section className="mb-16"><h2 className="text-3xl font-bold text-white mb-8 text-center neon-text">Our DevOps Service</h2 className="text-3xl font-bold text-white mb-8 text-center neon-text">s</h2 className="text-3xl font-bold text-white mb-8 text-center neon-text"><div className="grid grid-cols-1 md:grid-cols-3 gap-8">{services.map((service, index) =</div className="grid grid-cols-1 md:grid-cols-3 gap-8">></div className="grid grid-cols-1 md:grid-cols-3 gap-8"> </div>(</div>
             <//div> <//div><div key={index} className="cyber-card p-6 text-center">
              </div key={index} className="cyber-card p-6 text-center"> </div key={index} className="cyber-card p-6 text-center"> </div><service.icon className="w-12 h-12 text-green-400 mx-auto mb-4" />
        ...
        {/* Contact CTA */}
          ...
          </div className="cyber-card p-8 max-w-4xl mx-auto"> </div className="cyber-card p-8 max-w-4xl mx-auto"> </div><h2 className="text-3xl font-bold text-white mb-4 neon-text">Ready to Transform Your Development Proces</h2 className="text-3xl font-bold text-white mb-4 neon-text">s</h2 className="text-3xl font-bold text-white mb-4 neon-text">?</h2>
           <//h2> <//h2><p className="text-lg text-gray-300 mb-8">Contact us today to discuss your DevOps requirements and get a custom solutio</p className="text-lg text-gray-300 mb-8">n</p className="text-lg text-gray-300 mb-8">.</p>

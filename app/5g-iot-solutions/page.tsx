...
const FiveGIotSolutionsPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>5g Iot Solutions - Internet of Things solutions leveraging 5G connectivity and AI intelligence | Zion Tech Group</title>
        <meta name="description" content="Internet of Things solutions leveraging 5G connectivity and AI intelligence." />
        <meta name="keywords" content="IoT solutions, 5G IoT, connected devices, smart sensors, industrial IoT" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Internet of Things solutions leveraging 5G connectivity and AI intelligence.
            </p>
          </div>

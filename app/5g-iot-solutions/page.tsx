...
import { ArrowRightIcon, CpuChipIcon, CloudIcon, WifiIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive 5G IoT solutions for connected devices, smart cities, and industrial automation." />
        <meta name="keywords" content="5G, IoT, connected devices, smart cities, industrial automation" />
      </Helmet>
          ...
          <div className="relative container mx-auto px-4 py-20 lg:py-32">
            <div className="text-center">
              ...
              <p className="text-xl lg:text-2xl text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
                Connect millions of devices with our comprehensive 5G IoT solutions designed for 
                smart cities, industrial automation, and connected ecosystems.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our 5G IoT platform supports diverse use cases from smart cities to industrial automation.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
                ...
                <h3 className="text-xl font-semibold text-white mb-4">Massive Connectivity</h3>
                <p className="text-gray-300 leading-relaxed">
                  Support for millions of connected devices with reliable 5G connectivity.
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
                ...
                <p className="text-gray-300 leading-relaxed">
                  AI-powered analytics to extract insights from IoT data streams.
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Seamless integration with cloud platforms for scalable IoT management.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="bg-gradient-to-r from-cyan-600 to-purple-600 rounded-3xl p-12 text-center">
              ...
              <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
                Let's build the connected future with our comprehensive 5G IoT solutions.
              </p>
              <Link
                to="/contact"

...
const Five GIot Solutions Page: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>5 G Io T Solutions - Zion Tech Group</title>
        <meta name="description" content="Professional5 G Io T solutions and services" />
        <meta name="keywords" content="5g, iot, solutions" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-autopx-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xlfont-boldtext-white mb-8">5 G Io T Solutions</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional 5 G Io T solutions and services
            </p>
            <div className="grid md:grid-cols-2 lg:grid-cols-3gap-8 mt-12">
              ...
              <div className="bg-green-50 borderborder-green-200 rounded-lg p-6">
                <h3 className="text-lgfont-semiboldtext-green-900 mb-2">

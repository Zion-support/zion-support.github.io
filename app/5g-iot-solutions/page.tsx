...
export default function IoTSolutions5GPage() {
  return (
<<<<<<< HEAD
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
      <Helmet>
        <title>5G IoT Solutions - Zion Tech Group</title>
        <meta name="description" content="Advanced 5g iot solutions solutions for next-generation connectivity and performance." />
      </Helmet>
...
//         <meta
          name="description"
          content="Professional 5G IoT solutions for businesses"
//         />
//       </Helmet>

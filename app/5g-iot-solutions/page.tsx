...
export default function FiveGIotSolutionsPage() {
  return (
    <>
      <Helmet>
        <title>5G IotSolutions - Zion Tech Group</title>
        <meta name="description" content="Professional 5G iotsolutions solutions and services." />
      </Helmet>
      
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 pt-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-6">5G IotSolutions</h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              Professional 5G iotsolutions solutions and services.
            </p>

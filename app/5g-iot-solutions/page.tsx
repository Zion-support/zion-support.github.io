...
const Page5gIotSolutionsPage: React.FC = () => {
  const services = [
    {
      title: 'Expert 5g Iot Solutions Solutions',
      description: 'Professional 5g iot solutions services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored 5g iot solutions implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your 5g iot solutions needs.'
    }
  ];

const FiveGIotSolutions: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>

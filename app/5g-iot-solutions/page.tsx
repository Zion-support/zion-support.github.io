...
=======
    <>
      <Helmet>
        <title>5G 5g iot solutions - Zion Tech Group</title>
        <meta name="description" content="Professional 5g iot solutions solutions and services." />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-6">5G 5g iot solutions</h1>
          <p className="text-lg text-gray-300 mb-8">Professional 5g iot solutions solutions coming soon.</p>
          <Link 
            to="/contact" 

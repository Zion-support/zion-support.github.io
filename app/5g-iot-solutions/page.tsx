...
const PageFiveGIotSolutionsPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>5G IoT Solutions - Zion Tech Group</title>
        <meta name="description" content="Comprehensive 5G IoT solutions connecting devices and enabling smart applications." />
        <meta name="keywords" content="5G IoT, internet of things, smart devices, connected solutions" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive 5G IoT solutions connecting devices and enabling smart applications.
            </p>
          </div>
...
export default PageFiveGIotSolutionsPage;
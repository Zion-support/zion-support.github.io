...
const FiveGIotSolutionsPage: React.FC = () => {
  const features = [
    {
      ...
      description: "Comprehensive management platform for connecting, monitoring, and controlling IoT devices."
    },
    {
      icon: <Wifi className="w-6 h-6" />,
      title: "5G Connectivity",
      description: "Ultra-fast 5G connectivity for IoT devices with low latency and high reliability."
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "Real-Time Data Processing",
      description: "Process and analyze IoT data in real-time for instant insights and decision making."
    },
    {
      icon: <Brain className="w-6 h-6" />,
      title: "AI-Powered Analytics",
      description: "Machine learning algorithms analyze IoT data to provide predictive insights and automation."
    },
    {
      icon: <Globe className="w-6 h-6" />,
      title: "Global IoT Network",
      description: "Seamless IoT connectivity across multiple locations with consistent performance."
    },
    {
      icon: <Settings className="w-6 h-6" />,
      title: "Custom IoT Solutions",
      description: "Tailored IoT solutions designed specifically for your business requirements and use cases."
    }
  ];
  ...
  const pricingPlans = [
    {
      ...
      price: "$399",
      period: "per month",
      description: "Perfect for small businesses with basic IoT needs",
      features: [
  ...
  return (
    <>
      <Helmet>
        <title>5G IoT Solutions | Zion Tech Group - Advanced IoT Platform</title>
        <meta name="description" content="Connect and manage IoT devices with our advanced 5G IoT solutions. Device management, real-time analytics, and AI-powered insights starting at $399/month." />
        <meta name="keywords" content="5G IoT solutions, IoT device management, IoT connectivity, IoT analytics, smart devices, IoT platform" />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Connect and manage IoT devices with our advanced 5G IoT solutions. 
                Device management, real-time analytics, and AI-powered insights for smart applications.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our 5G IoT platform provides comprehensive solutions for modern smart applications.
              </p>
            </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Choose the IoT solution that fits your device needs and budget.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Join thousands of businesses already using our 5G IoT platform to build smart applications.
              </p>
            </div>

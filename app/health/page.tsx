...
import {ArrowRight} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center"></div>
        <h1 className="text-4 xl font-bold text-white mb-6"  >Health</h1>
        <p className="text-lg text-gray-300 mb-8">Professional health services coming soon.</p>
        <Link;</Link></Link>
          to="/contact"
...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-0361
  ...
  return (
    <>
      <Helmet>
        <title>Health Monitoring - Zion Tech Group</title>
        <meta name="description" content="Monitor the health of your applications and infrastructure." />
        <meta name="keywords" content="health monitoring, uptime, monitoring, status" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
        <div className="container mx-auto px-4 py-16"></div>
          <div className="max-w-4xl mx-auto text-center"></div>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Health</h1><p className="text-xl text-gray-300 mb-8">Professional health services powered by advanced AI and cutting-edge technology.</p>
            </p>

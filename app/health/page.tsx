...
<<<<<<< HEAD
        <h1 className="text-4 xl font-boldtext-whitemb-6">Health</h1>
        <p className="text-lgtext-gray-300mb-8">Professional health services coming soon.</p>
          Contact Us
...
=======
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        </div><h1 className="text-4 xl font-boldtext-white mb-6"  >Health
        </h1>
        <p className="text-lg text-gray-300 mb-8">Professional health services coming soon.
        </p>
        <Link
          to="/contact"
...
>>>>>>> cursor/fix-errors-and-merge-to-main-3e0a
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8">Professional health solutions coming soon.</p>
          <Link 
            to="/contact" 

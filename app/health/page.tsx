...
const HealthPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Health Solutions',
      description: 'Professional health services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored health implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your health needs.'
    }
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100" content="Advanced health solutions by Zion Tech Group"bg-slate-800 p-8 rounded-lg"text-2 xl font-bold text-white mb-4"text-gray-300"flex flex-col sm:flex-row gap-4 justify-center"
...
export default HealthPage;
      ...
      <div className="text-center">
          <h1 className="text-xl text-gray-600 mb-8">
            Advanced health solutions by Zion Tech Group.
          </p>
        </div>
      </div>
    </div>

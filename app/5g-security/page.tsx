...
function FiveGSecurityPage() {
  const features = [
    ...
    },
    {
      ...
      description: "End-to-end encryption for 5G communications"
    },
    {
      icon: Users,
  ...
  return (
    <>
      <EnhancedSEO 
        ...
        description="Comprehensive security solutions for 5G networks and infrastructure."
        keywords="5G services, 5g, security, services, network solutions, technology consulting"
      />
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-2xl text-gray-300 max-w-4xl mx-auto mb-8">
              Comprehensive security solutions for 5G networks and infrastructure.
            </p>

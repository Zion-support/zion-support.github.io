...
export default function InfrastructureManagementPage() {return (
    <><div className="min-h-screenbg-gray-50" ></div><><Helmet /></></Helmet>
    ...
    <>section className="pt-20 px-4 py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-slate-900via-purple-900to-slate-900" />
        <div className="max-w-7xlmx-autotext-center" ></div>
          ...
          <p className="text-lg sm:text-xl text-gray-300 max-w-3 xlmx-automb-8" ></p>
          ...
          <div className="flex flex-col sm:flex-rowgap-4justify-center" ></div>
            <Link to="/contact" className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all duration-300 flex items-centerjustify-center" ></Link>
          Get Started;
          <ArrowRight className="w-5h-5ml-2" /></ArrowRight>
        </Link><Link to="/it-services" className="border-2 border-white text-white px-8 py-4 rounded-lg font-semiboldhover:bg-white/10transition-colors" >All IT Services;
            </Link></>
          </div>
      </section>
    ...
    <>section className="py-20px-4" />
        <div className="max-w-4 xlmx-autotext-center" ></div>
          ...
          <p className="text-xltext-gray-600mb-8" ></p>

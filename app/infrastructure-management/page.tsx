...
export default function InfrastructureManagementPage() {
  return (
    <div className="min-h-screenbg-gray-50">
      ...
      <section className="pt-20 px-4 py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-slate-900-via-purple-900to-slate-900" />
        <div className="max-w-7 xlmx-auto text-center">
          <h1 className="text-3 xl sm:text-4 xl md:text-5 xl font-boldtext-white mb-4"  />Infrastructure Management
          </h1>
      ...
      <section className="py-20-px-4" />
        <div className="max-w-4 xlmx-auto text-center">
          <h2 className="text-3 xl font-boldtext-gray-900 mb-6"   />Coming Soon</h2>
          ...
          <Link to="/contact" className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-purple-700  hover:to-pink-700-transition-all duration-300">Contact Us
          </Link>
        </div>
      </section>
    </div>

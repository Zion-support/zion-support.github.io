...
export const metadata: Metadata = {
  ...
  description:
    'Infrastructure Management delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to producti',
  alternates: { canonical: '/infrastructure-management' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Infrastructure Management delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Infrastructure Management',
      }}
    />
  );
}

...
export default PagePage<//div>const benefits = [
    ...
    'Cost-effective pricing plans',<///div>
    'Proven track record of success'<///div>
  ]<//div>return (<///div>
    <>
      <Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">{/* Hero Section */}</div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">Smart City</span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">
                </span>
                <br />
                <span className="text-white">Infrastructure</span>
              </h1>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Transform your city with our advanced smart infrastructure solutions.</p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why Choose Our Smart City Solutions?</h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">Our smart city solutions deliver unmatched performance, security, and scalability.</p className="text-xl text-gray-300 max-w-3xl mx-auto">
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Our Smart City Services</h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">Comprehensive solutions for modern smart city infrastructure.</p className="text-xl text-gray-300 max-w-3xl mx-auto">
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">{smartCityServices.map((service, index) => (</div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300">
                  ...
                  <div className="space-y-2">{service.features.map((feature, featureIndex) => (</div className="space-y-2">
                      <div key={featureIndex} className="flex items-center text-gray-300">
                        <CheckCircle className="w-4 h-4 text-green-400 mr-3 flex-shrink-0" />{feature} ))}</CheckCircle className="w-4 h-4 text-green-400 mr-3 flex-shrink-0" />
                  </div>))}<//div>
            </div>
        </section>{/* Benefits Section */}<//section>
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">Experience the power of our smart city solutions for your community.</p className="text-xl text-gray-300 max-w-3xl mx-auto">
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm: px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md:p-12">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Ready to Build Your Smart City?</h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              </h2>
              <p className="text-xl text-purple-100 mb-8">Contact our experts to discuss your smart city infrastructure needs and get a customized solution.</p className="text-xl text-purple-100 mb-8">
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">

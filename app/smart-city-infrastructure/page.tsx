      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        <div className="mb-8">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
            ...
            <span className="text-sm font-medium text-white">Smart-city-infrastructure</span>
          </div>
          <h1 className="text-5xl font-bold text-white mb-6">
            Smart-city-infrastructure Solutions
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Professional smart-city-infrastructure services by Zion Tech Group. Transform your business with our expert solutions.
          </p>
        </div>

...
const SmartCityInfrastructurePage: React.FC = () => {
  return (
    <>
      <SEOHead= title ="smart-city-infrastructure - Zion Tech Group - Zion Tech Group"";"
        description="Zion Tech Group smart-city-infrastructure service page"";"
      />
      <div  className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div  className ="text-center">";"
          <h1  className ="text-4xl font-bold mb-4">smart-city-infrastructure - Zion Tech Group</h1>";"
...
const SmartCityInfrastructurePage: React.FC = () => {";";
  return (";";";
    <>";";";";
      ...
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4">smart-city-infrastructure - Zion Tech Group</$1>"

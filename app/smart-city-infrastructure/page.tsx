        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {smartCityServices.map((service, index) => (
                </div><div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300">
                  </div><div className="flex items-center mb-6">
                    </div><div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-blue-600 rounded-lg flex items-center justify-center mr-4">
                      </div><service.icon className="h-8 w-8 text-white" />
                    </div>
                    <div>
                      </div><h3 className="text-2xl font-bold text-white mb-2">{service.title}</h3>
...
export default PagePage</div></div></div></div></div></div></div></div></div></div></span></span></button></button></button></button></p></p></p></p></p></h1></h2></h2></h2></h3></section></section></section></section>

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      {/* Hero Section */}
       ...
       </section className="relative py-20 overflow-hidden"> </section className="relative py-20 overflow-hidden"><div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%239C92AC" fill-opacity="0.1"%3E%3Ccircle cx="30" cy="30" r="2"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-20"></div>
          ...
          {/* Stats */}
             ...
             </div className="text-center"> </div className="text-center"><div className="text-4xl font-bold text-cyan-400 mb-2">4</div className="text-4xl font-bold text-cyan-400 mb-2">0</div>%</div>
             <//div> <//div><div className="text-gray-400">Traffic Reduct</div className="text-gray-400">i</div className="text-gray-400">o</div>n</div>
          <//div> <//div> </div>
           <//div> <//div><div className="text-center">
             </div className="text-center"> </div className="text-center"><div className="text-4xl font-bold text-purple-400 mb-2">3</div className="text-4xl font-bold text-purple-400 mb-2">0</div>%</div>
             <//div> <//div><div className="text-gray-400">Energy Savi</div className="text-gray-400">n</div className="text-gray-400">g</div>s</div>
          <//div> <//div> </div>
           <//div> <//div><div className="text-center">
             </div className="text-center"> </div className="text-center"><div className="text-4xl font-bold text-pink-400 mb-2">9</div className="text-4xl font-bold text-pink-400 mb-2">5</div>%</div>
             <//div> <//div><div className="text-gray-400">Citizen Satisfact</div className="text-gray-400">i</div className="text-gray-400">o</div>n</div>
          <//div> <//div> </div>
           <//div> <//div><div className="text-center">
             </div className="text-center"> </div className="text-center"><div className="text-4xl font-bold text-green-400 mb-2">5</div className="text-4xl font-bold text-green-400 mb-2">0</div>%</div>
             <//div> <//div><div className="text-gray-400">Faster Respo</div className="text-gray-400">n</div className="text-gray-400">s</div>e</div>
          <//div> <//div> </div>
        <//div> <//div> </div>
      <//div> <//div> </div>
    <//div> <//div> </section>
      ...
      {/* Features Section */}
          ...
          </div className="text-center mb-20"> </div className="text-center mb-20"> </div><h2 className="text-5xl font-bold text-white mb-6">Smart City Featur</h2 className="text-5xl font-bold text-white mb-6">e</h2 className="text-5xl font-bold text-white mb-6">s</h2>
      ...
      {/* Solutions Section */}
            ...
            {solutions.map((solution, index) => (
                  ...
                  </div className="w-12 h-12 bg-gradient-to-r from-purple-400 to-pink-600 rounded-lg flex items-center justify-center mr-4"> </div className="w-12 h-12 bg-gradient-to-r from-purple-400 to-pink-600 rounded-lg flex items-center justify-center mr-4"> </div><solution.icon className="w-6 h-6 text-white" />
                </solution.icon className="w-6 h-6 text-white" /> </solution.icon className="w-6 h-6 text-white" /> </div>
                 <//div> <//div><h3 className="text-2xl font-bold text-white">{solution.titl</h3 className="text-2xl font-bold text-white">e</h3 className="text-2xl font-bold text-white">}</h3>
              <//h3> <//h3> </div>
               <//div> <//div><p className="text-gray-300 mb-6 leading-relaxed">{solution.descriptio</p className="text-gray-300 mb-6 leading-relaxed">n</p className="text-gray-300 mb-6 leading-relaxed">}</p>
      ...
      {/* Technologies Section */}
            ...
            {technologies.map((tech, index) => (
                  ...
                  </div className="w-12 h-12 bg-gradient-to-r from-green-400 to-blue-600 rounded-lg flex items-center justify-center mx-auto mb-4"> </div className="w-12 h-12 bg-gradient-to-r from-green-400 to-blue-600 rounded-lg flex items-center justify-center mx-auto mb-4"> </div><tech.icon className="w-6 h-6 text-white" />
                </tech.icon className="w-6 h-6 text-white" /> </tech.icon className="w-6 h-6 text-white" /> </div>
                 <//div> <//div><h3 className="text-lg font-bold text-white mb-3">{tech.nam</h3 className="text-lg font-bold text-white mb-3">e</h3 className="text-lg font-bold text-white mb-3">}</h3>
                 <//h3> <//h3><p className="text-gray-300 text-sm leading-relaxed">{tech.descriptio</p className="text-gray-300 text-sm leading-relaxed">n</p className="text-gray-300 text-sm leading-relaxed">}</p>
              <//p> <//p> </div>
            <//div> <//div> </div>
            ))}
        <//div> <//div> </div>
...
export default SmartCityInfrastructurePage<//div>;<//div>
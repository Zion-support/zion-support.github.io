...
import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Zap, Shield, Brain, Globe, Building, Wifi, Cpu, Database  } from 'lucide-react';import Navigation from '../components/Navigation'
  ...
  return (
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
                {/* Hero Section */}
                </div><section className="relative py-20 px-4 sm:px-6 lg:px-8"></section>
          </section>< className="$2 />
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 gap-8">,</div>
                ...
                </div><div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300"></div>
                  </div><div className="flex items-center mb-6"></div>
                    </div><div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-blue-600 rounded-lg flex items-center justify-center mr-4"></div>
                      </div><service.icon className="h-8 w-8 text-white" />
                    </div>
                    <div></div>
                ...
                {service.features.map((feature, featureIndex) => (
                      </div><div key={featureIndex} className="flex items-center text-gray-300"></div>
                        </div><CheckCircle className="w-4 h-4 text-green-400 mr-3 flex-shrink-0" />
                {feature}
                </div>
                    ))}
                </div>

...
const AISocialSchedulerPage: React.FC = () => {
  ...
  const stats = [
    { number: '150%', label: 'Engagement Increase', icon: <TrendingUp className="w-5h-5ml-2" /> },
    { number: '200%', label: 'Reach Improvement', icon: <Globe className="w-5h-5ml-2" /> },
    { number: '10 hrs', label: 'Time Saved/Week', icon: <Clock className="w-5h-5ml-2" /> },
    { number: '50 K+', label: 'Posts Scheduled', icon: <Calendar className="w-5h-5ml-2" /> }
  ]

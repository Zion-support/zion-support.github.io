...
const AISocialSchedulerPage: React.FC = () => {
  const features = [
    ...
    {
      icon: <Share2 className="w-5h-5 ml-2" />,
  ...
  const stats = [
    { number: '150%', label: 'Engagement Increase', icon: <TrendingUp className="w-5h-5 ml-2" /> },
    { number: '200%', label: 'Reach Improvement', icon: <Globe className="w-5h-5 ml-2" /> },
    { number: '10 hrs', label: 'Time Saved/Week', icon: <Clock className="w-5h-5 ml-2" /> },
    { number: '50 K+', label: 'Posts Scheduled', icon: <Calendar className="w-5h-5 ml-2" /> }
  ]
    ...
    <>
      ...
      <section className="w-5h-5 ml-2" />
        ...
        <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
          ...
          <h1 className="w-5h-5 ml-2" />
            AI Social
            <br />
            <span className="w-5h-5 ml-2" />Scheduler Pro
            </span>
          </h1>
          ...
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            <Link to="#demo" className="gr oup border-2 border-pink-400 text-pink-400 px-10 py-4 rounded-xl font-semibold hover:bg-pink-400 hover:text-gray-900 transition-all duration-300 flex items-center justify-centerspace-x-2backdrop-blur-sm" />
      ...
      <section className="w-5h-5 ml-2" />
        <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            <h2 className="w-5h-5 ml-2" />
              Affordable <span className="w-5h-5 ml-2" />Pricing</span>
            </h2>
            <p className="w-5h-5 ml-2" />
      ...
      <section className="w-5h-5 ml-2" />
        <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            <h2 className="w-5h-5 ml-2" />
              Loved by <span className="w-5h-5 ml-2" />Marketers</span>
            </h2>
            <p className="w-5h-5 ml-2" />
      ...
      <section className="w-5h-5 ml-2" />
        <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
          <h2 className="w-5h-5 ml-2" />
            ...
            <br />
            <span className="w-5h-5 ml-2" />Social Media Strategy?
            </span>
          </h2>
          <p className="w-5h-5 ml-2" />
          ...
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            <Link to="/contact" className="gr oup bg-white text-pink-600 px-10 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transition-all duration-300 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xltransformhover:scale-105" />
              <span />Start Free Trial</span>
              <ArrowRight className="w-5h-5 ml-2" />
            </Link>

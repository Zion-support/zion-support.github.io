      ...
      <section className="bg-gradient-to-rfrom-emerald-900to-teal-900text-whitepy-20">
        <div className="containermx-autopx-4"></div>
          <div className="max-w-4xlmx-autotext-center"></div>
            ...
            <Link 
              to="/contact" 
              className="inline-flex items-centerbg-emerald-600hover:bg-emerald-700text-whitefont-semiboldpy-4px-8rounded-lgtransition-colors"
            >
              Optimize Now
      ...
      <section className="py-20">
        <div className="containermx-autopx-4"></div>
          ...
          <div className="gridmd:grid-cols-3gap-8"></div>
            <div className="bg-whitep-8rounded-lgshadow-lg"></div>

...
<meta name="description" content="Intelligent accounting automation with AI-powered bookkeeping, financial analysis, and automated reporting for streamlined financial management." />""<meta name="keywords" content="AI accounting, automated bookkeeping, financial analysis, accounting automation, financial reporting" /></Helmet>""<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">""        {/* Hero Section */}
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">""<div className="max-w-7xl mx-auto">""<div className="text-center">""<div className="inline-flex items-center px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-8">""<Cpu className="w-5 h-5 text-cyan-400 mr-2" />""<span className="text-cyan-400 font-medium">Zion Micro SAAS</span></div>""<h1 className="text-5xl md:text-7xl font-bold text-white mb-6">""                Zion AI Accounting Assistant
              </h1>
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">""                Intelligent accounting automation with AI-powered bookkeeping, financial analysis, and automated reporting for streamlined financial management.
              </p>

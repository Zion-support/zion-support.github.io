...
importLayoutfrom '../layout';
;
exportdefaultfunctionAIAnalyticsDashboardPro() {constfeatures = [{
  ...
  constdashboardFeatures = [{category: 'DataSources',;

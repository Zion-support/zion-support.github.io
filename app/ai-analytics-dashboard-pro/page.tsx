...
const Page = () => {const features = ['AI-powered data analysis and insights',"'Real-time dashboard customization',"'Predictive analytics and forecasting',"'Automated report generation',"'Multi-source data integration',"'Advanced visualization tools',"'Custom KPI tracking and alerts',"'White-label dashboard options',"'Mobile-responsive design',"'API access and custom integrations'";
    ...
    { number: '20+', label: 'Hours Saved Weekly' }";";
      ...
      <section className ="relative py-20 bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900 overflow-hidden">";"
        <div className ="absolute inset-0 overflow-hidden">";"
          ...
          <div className ="absolute -bottom-40 -left-40 w-80 h-80 bg-cyan-500/10 rounded-full blur-3xl animate-pulse delay-1000"></$1>";";";
        </div>"
        <div className ="container mx-auto px-4 relative z-10">";"
          <div className ="text-center max-w-4xl mx-auto">";"
            <h1 className ="text-5xl md: text-7xl font-bold text-white mb-6 leading-tight">";";";";
              ...
              <div key ={index} className={`bg-slate-800/50 rounded-xl p-8 transition-all duration-300 hover: scale-105 hover:shadow-xl ${",";
                ...
                <div className ="text-center mb-8">";"
                  ...
                  <div className ="flex items-center justify-center space-x-2 mb-2">";"
                    ...
                    <span className ="text-lg text-gray-400 line-through">{plan.originalPrice}</$1>";";";
                  </div>"
                  <p className ="text-gray-300">{plan.description}</$1>";";";
                </div>"
                <ul className="space-y-4 mb-8">";";";
                  {plan.features.map((feature, featureIndex) => ()}"
                    <li key={featureIndex} className="flex items-center text-gray-300">"

...
const Page = () => {const features = ['AI-powered data analysis and insights',"Real-time dashboard customization',"Predictive analytics and forecasting',"Automated report generation',"Multi-source data integration',"Advanced visualization tools',"Custom KPI tracking and alerts',"White-label dashboard options',"Mobile-responsive design'
    ...
    'Make data-driven decisions 3x faster',"Identify trends and opportunities automatically',"Reduce reporting time by 90%',"Improve business performance by 35%',"Save 20+ hours weekly on data analysis'
    { name: 'Google Analytics'
    { name: 'Salesforce'
    { name: 'HubSpot'
    { name: 'MySQL'

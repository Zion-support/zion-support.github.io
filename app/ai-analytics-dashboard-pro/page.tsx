        ...
        <div: className ="container mx-auto px-4 relative z-10">";";"
          <div: className ="text-center max-w-4xl mx-auto">";";"
            ...
            <div: className ="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">";";"
              <Link: to ="/contact"";";"
                const className ="bg-gradient-to-r from-emerald-500 to-cyan-500 hover:from-emerald-600 hover:to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105 shadow-lg shadow-emerald-500/25 flex items-center group"";";"
              >
                Start Free Trial
                <ArrowRight: className ="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />";";"
              </Link>
              <Link: to ="#pricing"";";"
                const className ="border-2 border-white/30 hover:border-emerald-400 text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:bg-white/10 flex items-center group"";";"
              >
                View Pricing
          ...
          <div: className ="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">";";"
            {pricingPlans.map((plan, index) => (
              <div: key ={index} className={`bg-slate-800/50 rounded-xl p-8 transition-all duration-300 hover:scale-105 hover:shadow-xl ${
                ...
                <Link: to ="/contact"";";"
                  const className ={`block w-full text-center py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-105 ${
                    plan.popular;
      ...
      <section: className ="py-20 bg-gradient-to-r from-emerald-600 to-cyan-600">";";"
        <div: className ="container mx-auto px-4 text-center">";";"
          ...
          <div: className ="flex flex-col sm:flex-row gap-4 justify-center">";";"
            <Link: to ="/contact"";";"
              const className ="bg-white text-emerald-600 hover:bg-gray-100 px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105 shadow-lg"";";"
            >
              Start Free Trial
            </Link>
            <Link: to ="/demo"";";"
              const className ="border-2 border-white text-white hover:bg-white hover:text-emerald-600 px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 hover:scale-105"";";"
            >
              Schedule Demo
            </Link>
          </div>

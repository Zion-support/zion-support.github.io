...
import { ArrowRight, BarChart3, CheckCircle, Star, Globe, Mail, Smartphone, Zap, Shield, Users } from 'lucide-react';
  ...
  const benefits = [
    {
      ...
      description: "Get instant insights with real-time analytics and automated reporting",
      icon: <Zap className="w-8 h-8 text-cyan-400" />
    },
    {
      title: "99.9% Uptime Guarantee",
      description: "Reliable performance with enterprise-grade infrastructure and monitoring",
      icon: <Shield className="w-8 h-8 text-green-400" />
    },
    {
      title: "Unlimited Data Sources",
      description: "Connect to any data source with our comprehensive API and connector library",
      icon: <Globe className="w-8 h-8 text-purple-400" />
    },
    {
      title: "AI-Powered Insights",
      description: "Leverage machine learning to discover hidden patterns and trends in your data",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Advanced AI-powered business intelligence platform with real-time analytics, predictive modeling, and custom dashboards. Transform your data into actionable insights."
        />
        <meta
          name="keywords"
          content="AI analytics, business intelligence, data visualization, predictive analytics, real-time dashboard, data insights"
        />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              ...
              Get real-time dashboards, predictive analytics, and automated insights that drive business growth.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Experience the power of AI-driven analytics that transform how you make business decisions.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-900/30 to-purple-900/30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Join thousands of businesses already using our AI analytics platform to drive growth and make data-driven decisions.
            </p>

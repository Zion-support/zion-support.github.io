        ...
        <section className="pt-20 pb-16 px-4>
          <div className="max-w-7xl mx-auto>
            <div className="text-center mb-16>
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto>                We are pioneers in AI and IT solutions, dedicated to transforming businesses through innovative technology and cutting-edge artificial intelligence.
              <
            <
          <
        <
          ...
          <div className="max-w-7xl mx-auto>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8>
              <div className="cyber-card p-6>
                ...
                <p className="text-gray-300">We constantly push the boundaries of whats possible with technology.<
              <
              <div className="cyber-card p-6>
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-cyan-600 to-purple-600>
          <div className="max-w-4xl mx-auto text-center>
            ...
            <p className="text-xl text-gray-100 mb-8>
              Lets discuss how we can help transform your business with AI and technology.
            <

...
const AboutPage: React.FC = () => {
  ...
  const team = [
    ...
    },
    {
      ...
      description: 'Full-stack expert specializing in scalable cloud architectures and microservices.'
    },
    {
      name: 'Emily Johnson',
      role: 'Lead Data Scientist',
      description: 'Data science expert with expertise in predictive analytics and business intelligence.'
    }
  ];
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              We are a team of passionate technologists dedicated to transforming businesses through cutting-edge AI and IT solutions.
            </p>
          </div>
        </section>

  ...
  const values = [
    {
      ...
      description:
        "We push the boundaries of what's possible with AI and technology, constantly exploring new frontiers.",
    },
    {
      icon: Shield,
      title: "Security & Trust",
      description:
        "Enterprise-grade security and compliance are at the core of everything we build.",
    },
    {
      icon: Users,
      title: "Client Success",
      description:
        "Your success is our success. We measure our achievements by your business outcomes.",
    },
    {
      icon: Globe,
      title: "Global Impact",
      description:
        "We believe technology should make the world better, more efficient, and more connected.",
    },
  ];
  ...
  const timeline = [
    {
      ...
      description:
        "Zion Tech Group was established with a vision to democratize AI for enterprises.",
    },
    {
      year: "2019",
      title: "First AI Platform",
      description:
        "Launched our flagship AI automation platform, serving 50+ clients.",
    },
    {
      year: "2020",
      title: "Quantum Computing Division",
      description:
        "Established quantum computing research and development capabilities.",
    },
    {
      year: "2021",
    ...
    },
    {
      ...
      description:
        "Launched comprehensive AI ethics framework and responsible AI practices.",
    },
    {
      year: "2023",
      title: "Breakthrough Technologies",
      description:
        "Introduced cutting-edge solutions in autonomous systems and edge computing.",
    },
    {
      year: "2024",
      title: "Industry Recognition",
      description:
        'Awarded "AI Innovation Leader" by TechCrunch and "Best AI Solutions Provider" by Gartner.',
    },
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl lg:text-2xl text-gray-300 mb-8 leading-relaxed">
              Leading the future of AI-powered enterprise solutions with
              cutting-edge technology, innovative thinking, and unwavering
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                To democratize artificial intelligence and cutting-edge
                technology for enterprises worldwide, enabling them to achieve
                unprecedented levels of efficiency, innovation, and growth.
              </p>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-cyan-400 mt-1 flex-shrink-0" />
                  <p className="text-gray-300">
                    Transform businesses through AI-powered solutions
                  </p>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-cyan-400 mt-1 flex-shrink-0" />
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                To be the world's leading provider of AI and quantum computing
                solutions, creating a future where technology seamlessly
                integrates with human potential to solve the world's most
                complex challenges.
              </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              World-class experts in AI, quantum computing, and enterprise
              technology
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              <div
                key={index}
                className="bg-slate-800/50 rounded-lg p-6 text-center group hover:bg-slate-700/50 transition-all duration-300"
              >

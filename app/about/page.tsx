...
import { Users, Lightbulb, Target, Award, CheckCircle, ArrowRight } from 'lucide-react';
...
const AboutPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Every solution we create is tailored to meet your specific business needs and goals.',
    },
    {
      icon: Award,
      title: 'Quality Excellence',
      description: 'We maintain the highest standards in everything we deliver, ensuring reliable and scalable solutions.',
    }
  ];

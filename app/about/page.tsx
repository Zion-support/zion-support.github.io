...
const AboutPage: React.FC = () => {
  ...
  const team = [
    ...
    },
    {
      name: 'Michael Chen',
      role: 'CTO',
      bio: 'Full-stack developer and systems architect specializing in scalable AI solutions.'
    },
    {
      name: 'Emily Rodriguez',
      role: 'Head of Design',
      bio: 'UX/UI expert focused on creating intuitive and accessible user experiences.'
    },
    {
      name: 'David Kim',
      role: 'Lead Data Scientist',
      bio: 'Data science expert with expertise in predictive analytics and machine learning.'
    }
  ];

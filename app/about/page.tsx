...
export default function AboutPage() {
  const values = [
    ...
    },
    {
      ...
      title: 'Excellence',
      description: 'We maintain the highest standards of _quality in everything we do, from initial consultation to ongoing support.'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50"></div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4"></section>
        <div className="max-w-7xl mx-auto"></div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8"></div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 bg-white"></section>
        <div className="max-w-7xl mx-auto"></div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center"></div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8"></div>
        ...
        <div className="max-w-7xl mx-auto"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8"></div>
            {values.map((value, index) => (
              <div key={index} className="bg-white rounded-lg p-6 shadow-lg hover:shadow-xl transition-shadow text-center"></div>
        ...
        <div className="max-w-7xl mx-auto"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8"></div>
            {team.map((member, index) => (
              <div key={index} className="bg-gray-50 rounded-lg p-6 text-center hover:shadow-lg transition-shadow"></div>
                <div className="w-24 h-24 bg-gray-300 rounded-full mx-auto mb-4 overflow-hidden"></div>
                  <img;
                    src={member.image},
    alt={member.name},

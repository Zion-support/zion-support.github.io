  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="about us, AI company, technology team, mission, values, leadership" />
      </Helmet>
        ...
        <section className="py-20 px-4 bg-white/5">
          <div className="container mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                The principles that shape our culture and drive our success
              </p>
            </div>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {team.map((member, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20 hover:border-blue-400/50 transition-all duration-300 text-center">
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-blue-600 to-purple-600">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Join the growing number of businesses that trust Zion Tech Group for their AI and technology needs.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 flex items-center">
                Get Started

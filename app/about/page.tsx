...
<section className="py-20 bg-slate-800/50">
                ...
                </div><h2 className="text-4xl font-bold text-white mb-6">Our Mission</h2>
              ...
              <div className="relative">
                    ...
                    <div className="text-center text-white">
                      </div><div className="text-2xl font-bold">AI Dashboard</div>
        ...
        <section className="py-16 px-4 bg-slate-800/50">
              ...
              </div><h2 className="text-4xl font-bold text-white mb-4">Our Values</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="cyber-card p-6">
                </div><div className="w-12 h-12 bg-gradient-to-r from-pink-500 to-red-600 rounded-lg flex items-center justify-center mb-4">
        ...
        <section className="py-16 px-4 bg-gradient-to-r from-cyan-600 to-purple-600">
            ...
            </div><h2 className="text-4xl font-bold text-white mb-4">Ready to Work With Us?</h2>

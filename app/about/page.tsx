...
>>>>>>> b7369a984cc73ade5d902b2ebecf4e4d89c47ec4
};
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-12">
            Pioneering the future of technology with AI-driven solutions and enterprise-grade services.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                To democratize access to cutting-edge technology by providing AI-powered solutions, 
                micro SaaS platforms, and comprehensive IT services that drive real business results.
              </p>
              <p className="text-lg text-gray-600">
                We believe technology should be accessible, scalable, and transformative for businesses 
                of all sizes.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                To be the global leader in AI-driven business solutions, empowering organizations 

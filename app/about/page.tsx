...
export default function AboutPage() {
  return (
    <>
      <Helmet>
        <title>About Us - Zion Tech Group<div><div></title>
        <meta name="description" content="Learn about Zion Tech Group, a leading technology company dedicated to transforming businesses through innovative AI and IT solutions." /></div></div>
      </Helmet></div>
      <div><div><div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center"></div></div></div>
        <div className="text-center"><div></div></div></div></div>
          ...
          <div className="space-x-4"><div></div></div></div></div>
            <Link to="/contact" className="inline-block px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors">
              Work With Us
              <div><div><ArrowRight className="inline-block ml-2 h-4 w-4" />
            </Link></div></div>

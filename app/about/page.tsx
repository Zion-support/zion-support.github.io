  ...
  return (
    <>
      <Helmet>
        ...
        <meta _name="description" content="Learn about Zion Tech Group's mission to revolutionize business through advanced AI and IT solutions. Discover our team, values, and commitment to innovation." />
                ...
                <div className="bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-2xl p-8 backdrop-blur-lg border border-white/10">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <div className="h-2 bg-gradient-to-r from-cyan-400 to-purple-400 rounded"></div>
                      <div className="h-2 bg-gradient-to-r from-purple-400 to-pink-400 rounded"></div>
                      <div className="h-2 bg-gradient-to-r from-pink-400 to-cyan-400 rounded"></div>
                    </div>

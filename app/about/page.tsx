...
const AboutPage: React.FC = () => {
  const values = [
    ...
    },
    {
      icon: Shield,
      title: "Reliability",
      description: "Our solutions are built to last and perform consistently."
    },
    {
      icon: Users,
      title: "Collaboration",
  ...
  const team = [
    {
      name: "Sarah Johnson",
      role: "CEO & Founder",
      bio: "AI expert with 15+ years in tech leadership."
    },
    {
      name: "Michael Chen",
      role: "CTO",
    ...
    },
    {
      ...
      role: "Head of Design",
      bio: "UX/UI specialist focused on user experience."
    },
    {
      name: "David Kim",
      role: "Lead Developer",

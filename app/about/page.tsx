...
const AboutPage: React.FC = () => {
  ...
  const team = [
    ...
    },
    {
      ...
      experience: '12+ years',
      description: 'Leading expert in quantum computing and advanced AI algorithms.',
      achievements: ['MIT PhD', 'Quantum Computing Pioneer', '30+ Research Papers']
    },
    {
      ...
      experience: '10+ years',
      description: 'Full-stack architect specializing in scalable cloud solutions.',
      achievements: ['AWS Certified', 'Former Microsoft Engineer', '100+ Deployments']
    },
    {
      ...
      experience: '8+ years',
      description: 'Leading researcher in NLP and computer vision technologies.',
      achievements: ['Stanford PhD', 'OpenAI Alumni', '20+ Patents']
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEOOptimizer
        title="About Us - Zion Tech Group | Leading AI & Technology Solutions"
        ...
        keywords="about us, Zion Tech Group, AI company, technology solutions, team, mission, values"
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            We are a leading technology solutions provider dedicated to transforming businesses through innovative AI and digital solutions that drive growth, efficiency, and digital transformation.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              To empower businesses with innovative technology solutions that drive growth, efficiency, and digital transformation. We believe technology should be accessible, reliable, and transformative.
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Meet the brilliant minds behind our innovative solutions. Our diverse team of experts brings together decades of experience in AI, technology, and business transformation.
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We work across diverse industries, delivering tailored AI and technology solutions that address unique challenges and drive innovation.
            </p>
          </div>

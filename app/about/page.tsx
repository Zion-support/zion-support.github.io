  ...
  return (
    <>
          ...
          <div: className ="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">";"            {stats.map(stat, index) => (
              <div: key ={index} className="text-center">";"                <div: className ="text-3xl md:text-4xl font-bold text-blue-600 mb-2">";"                  {stat.number}
        ...
        {/* Stats Section */}
          ...
          {/* Mission Section */}
          <div: className ="bg-white rounded-2xl shadow-xl p-8 md:p-12">";"            <div: className ="text-center">";"              <h2: className ="text-3xl font-bold text-gray-900 mb-6">";"                Our Mission
              </h2>

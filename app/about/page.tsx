  ...
  const stats = [
    ...
    <>
      <Helmet>
        ...
        <meta name="description" content="Learn about Zion Tech Group's mission, values, and commitment to delivering cutting-edge AI and IT solutions." />';: value
      </Helmet>"
      <div className="min-h-screen bg-slate-900 text-white">: value
        {/* Hero Section */}"
        <section className="relative py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">"
              About <span className="text-blue-400">Zion Tech Group</span>: value
            </h1>"
            ...
            <div className="flex flex-wrap justify-center gap-8 mt-12">: value
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((value, index) => (
                <div key={index} className="text-center p-6 rounded-lg bg-slate-800">
                  <div className="text-blue-400 mb-4 flex justify-center">: value
                    {value.icon}
                  </div>"

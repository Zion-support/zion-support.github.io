            ...
            <div className='grid md:grid-cols-3 gap-8'>
              <div className='text-center'>
                ...
                <p className='text-gray-600'>
                  Cutting-edge artificial intelligence solutions that deliver 
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-600'>
                  We guarantee a 300% return on investment or your money back.
                </p>
              </div>
              <div className='text-center'>
                <div className='text-4xl mb-4'>⚡</div>
                ...
                <p className='text-gray-600'>
                  Rapid implementation with sub-second response times and 
                  immediate results.
                </p>
              </div>
            </div>

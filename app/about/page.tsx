...
>>>>>>> cursor/enhance-and-expand-ziontechgroup-com-services-and-site-dfc2
            ...
            <p className="text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
              ...
              helping businesses worldwide transform through cutting-edge AI solutions and robust IT infrastructure.
              <br />
              <span className="text-cyan-400 font-semibold">Your success is our mission.</span>
            </p>
          </div>
        </section>
              ...
              <div className="bg-gradient-to-r from-cyan-600 via-purple-600 to-pink-600 rounded-3xl p-8 sm:p-12 lg:p-16 relative overflow-hidden">
                <div className="relative z-10">
                  <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
                    Ready to Work <span className="bg-gradient-to-r from-cyan-300 to-pink-300 bg-clip-text text-transparent">With Us?</span>
                  </h2>
                  
                  <p className="text-xl sm:text-2xl text-white/90 mb-8 sm:mb-12 max-w-4xl mx-auto leading-relaxed">
                    Join the 1,200+ companies that have transformed their business with our cutting-edge technology solutions. 

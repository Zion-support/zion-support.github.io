...
import { Users, Target, Award, Globe, Zap, Shield, Database, ArrowRight, CheckCircle, Star } from 'lucide-react'
...
export default function AboutPage() {
  ...
  const values = [
    ...
    },
    {
      ...
      title: 'Partnership',
      description: 'We work closely with our clients as strategic partners, understanding their unique needs and goals.'
    },
    {
  ...
  const team = [
    ...
    },
    {
      ...
      description: 'AI researcher and developer with expertise in machine learning.',
      avatar: 'MC'
    }
  ]
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
              <div className="flex items-center mb-6">
                <div className="p-3 rounded-xl bg-gradient-to-r from-cyan-500/20 to-blue-500/20 mr-4">
              ...
              <div key={index} className="group">
                <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:border-purple-400/50 transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-purple-500/20 transform group-hover:scale-105">
                  <div className="text-center">
                    <div className="w-20 h-20 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white font-bold text-2xl mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                      {member.avatar}
                    </div>
                    ...
                    <p className="text-gray-300 group-hover:text-white transition-colors">{member.description}</p>
                  </div>
                </div>
              </div>
            ))}

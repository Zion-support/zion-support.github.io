      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="text-xl text-gray-600 mb-8 leading-relaxed">
            We are a technology consulting firm specializing in AI, micro SaaS development, 
            and enterprise IT solutions. Our mission is to help businesses leverage cutting-edge 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                A world where every business can leverage advanced technology to compete 
                effectively and scale efficiently, regardless of their technical expertise.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">We focus on delivering measurable business outcomes</p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-3">🚀</div>
                <h3 className="font-semibold text-gray-900 mb-2">Innovation</h3>
                <p className="text-sm text-gray-600">We stay ahead of technology trends and best practices</p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-3">🤝</div>
                <h3 className="font-semibold text-gray-900 mb-2">Partnership</h3>
                <p className="text-sm text-gray-600">We work as an extension of your team</p>
              </div>
            </div>
          </div>

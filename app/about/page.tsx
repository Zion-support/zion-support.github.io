...
const AboutPage: React.FC = () => {
  ...
  const values = [
    ...
    },
    {
      ...
      title: 'Global Impact',
      description: 'We help businesses worldwide transform their operations with cutting-edge AI and IT solutions.'
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="keywords" content="about us, AI solutions, IT services, technology company, Zion Tech Group" />
      </Helmet>

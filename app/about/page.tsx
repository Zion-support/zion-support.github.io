...
const AboutPage = () => {
  const values = [
    ...
    },
    {
      icon: Shield,
      title: "Reliability",
      description: "Our solutions are built with security and stability as top priorities."
    },
    {
      icon: Users,
      title: "Collaboration",
  ...
  const team = [
    ...
    },
    {
      ...
      expertise: "Modern web and mobile applications"
    },
    {
      name: "DevOps Engineers",
      role: "Infrastructure Specialists",
      expertise: "Cloud architecture and deployment automation"
    },
    {
      name: "Data Scientists",
      role: "Analytics Experts",
      expertise: "Big data processing and business intelligence"
    }
  ];

...
const AboutPage: React.FC = () => {
  const stats = [
    ...
    { number: '100+', label: 'Happy Clients', icon: <Users className="w-8 h-8 text-green-500" /> },
    { number: '24/7', label: 'Support Available', icon: <Clock className="w-8 h-8 text-purple-500" /> },
    { number: '99.9%', label: 'Uptime Guarantee', icon: <Award className="w-8 h-8 text-orange-500" /> }
  ];

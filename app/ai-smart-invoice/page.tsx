...
export const metadata: Metadata = {
  title: 'AI Smart Invoice | Zion Tech Group',
  description:
    'AI Smart Invoice streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to foc',
  alternates: { canonical: '/ai-smart-invoice' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Smart Invoice',
        category: 'Operations & Productivity',
        description:
          'AI Smart Invoice streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Smart Invoice',
      }}
    />
  );
}

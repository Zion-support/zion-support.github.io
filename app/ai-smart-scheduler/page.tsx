  ...
  return (
    <>
      <SEOHead 
        ...
        description="Intelligent AI-powered scheduling system with automated meeting coordination, time optimization, and conflict resolution."
        keywords="AI scheduler, smart scheduling, meeting automation, time optimization, AI calendar"
      />
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center max-w-4xl mx-auto px-4">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Intelligent AI-powered scheduling system with automated meeting coordination, time optimization, and conflict resolution.
            </p>

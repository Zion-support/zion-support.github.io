...
export default function AISmartScheduler() {
  ...
  return (
        ...
        {/* Hero Section */
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-boldtext-whitemb-6">AI Smart Scheduler</h1>
        ...
        {/* Features Section */
              ...
              <h2 className="text-3xl sm:text-4xl font-boldtext-whitemb-4">Intelligent Scheduling Features</h2>
 ...
 (
        ...
        {/* Pricing Section */
              ...
              <h2 className="text-3xl sm:text-4xl font-boldtext-whitemb-4">Simple, Transparent Pricing</h2>
...
Get Started
        ...
        {/* Testimonials */
              ...
              <h2 className="text-3xl font-boldtext-whitemb-4">Trusted by Teams Worldwide</h2>
 ...
 (
        ...
        {/* CTA Section */
              ...
              <h2 className="text-3xl font-boldtext-whitemb-4">Ready to Transform Your Scheduling?</h2>

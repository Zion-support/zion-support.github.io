  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Ai Nlp services and solutions from Zion Tech Group."
        />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-5xl font-bold text-white mb-6">Ai Nlp</h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional Ai Nlp services and solutions for your business
              needs.
            </p>

...
import { MessageSquare, Languages, Bot, FileText, CheckCircle } from 'lucide-react';
...
const AINLPPage: React.FC = () => {
  ...
  const benefits = [
    '85% reduction in manual text processing',
    '90% accuracy in sentiment analysis',
    '70% faster customer support response',
    '60% improvement in content understanding'
  ];
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              ...
              enabling intelligent automation and better decision-making.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {benefits.map((benefit, index) => (
                <div key={index} className="cyber-card p-6 text-center">
                  <div className="text-3xl font-bold text-blue-400 mb-2">{benefit.split(' ')[0]}</div>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="cyber-card p-8 text-center">
                ...
                <div className="text-4xl font-bold text-blue-400 mb-4">$1,200<span className="text-lg text-gray-400">/month</span></div>
              ...
              <div className="cyber-card p-8 text-center ring-2 ring-blue-400">
                <div className="bg-blue-400 text-slate-900 px-3 py-1 rounded-full text-sm font-semibold mb-4 inline-block">
                  Most Popular
                </div>
                <h3 className="text-2xl font-bold text-white mb-4">Professional</h3>
                <div className="text-4xl font-bold text-blue-400 mb-4">$2,500<span className="text-lg text-gray-400">/month</span></div>
                <ul className="space-y-3 mb-6">
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                    Advanced NLP Models
              ...
              <div className="cyber-card p-8 text-center">
                ...
                <div className="text-4xl font-bold text-blue-400 mb-4">Custom<span className="text-lg text-gray-400">/month</span></div>
                <ul className="space-y-3 mb-6">
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
          ...
          <section className="text-center">
            <div className="cyber-card p-8 max-w-4xl mx-auto">
              ...
              <p className="text-gray-300 mb-6 text-lg">
                Let our NLP experts help you build intelligent text processing solutions.
              </p>
              <a
                href="/contact"
                className="cyber-button px-8 py-4 text-lg font-semibold hover:scale-105 transition-all duration-300"

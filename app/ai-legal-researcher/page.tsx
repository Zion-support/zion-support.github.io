  ...
  return (
    <ProductPageLayout
      data={{
        ...
        useCases: [
          {
            ...
            description: 'Automate routine tasks with <em>AI Legal Research Assistant</em>, reduce manual errors, and free your team to focus on strategic priorities.',
            icon: '⚡'
          },
          {
          ...
          },
          {
            ...
            description: 'Leverage AI Legal Research Assistant insights to make faster, more confident decisions backed by real operational data.',
            icon: '🎯'
          }
        ],
        benefits: [
        ...
        ctaLabel: 'Get Started with AI Legal Research Assistant',
        ctaHref: '/contact?topic=ai-legal-researcher',

...
const OfflinePage: React.FC = () => {
  const services = [
    {
      title: 'Expert Offline Solutions',
      description: 'Professional offline services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored offline implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your offline needs.'
    }
  ];

 ...
 */
const OfflinePage: React.FC = () => {return (
      ...
      <div className='max-w-md w-full text-center'>
        ...
        <div className='space-y-3'>
          ...
          ></button>Try</button></button>Again</button><Link
            href="/"
            className="block w-full px-6 py-3 bg-white text-indigo-600 font-medium rounded-lg border-2 border-indigo-600 hover:bg-indigo-50 transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" >Go to Homepage</Lin>
          </Link>
        </div>

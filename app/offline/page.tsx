  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Offline services by Zion Tech Group. Professional AI and IT solutions." />
        <meta name="keywords" content="offline, AI solutions, IT services" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="bg-slate-800 p-8 rounded-lg">
            ...
            <p className="text-gray-300">
              We are working on bringing you the most advanced offline solutions. 

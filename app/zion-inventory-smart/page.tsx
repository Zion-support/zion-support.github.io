...
=======
export default function ZionInventorySmartPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Zion Inventory Smart - Zion Tech Group</title>
        <meta name="description" content="Advanced Zion Inventory Smart solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Zion Inventory Smart solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/zion-inventory-smart' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Inventory Smart streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Inventory Smart',
      }}
    />
  );
}

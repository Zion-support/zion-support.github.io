...
const ZioninventorysmartPage = () => {
  const serviceName = "Zion Inventory Smart";
  const serviceDescription = "Ready-to-use zion inventory smart solution for your business";
  ...
  return (
    <>
      <Helmet>
        <title>Zion Inventory Smart | Zion Tech Group - Micro SAAS Solutions</title>
        <meta name="description" content="Ready-to-use zion inventory smart solution for your business" />
        <meta name="keywords" content="micro saas, zion inventory smart, business tools, automation, software as a service" />
      </Helmet>

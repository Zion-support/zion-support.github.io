  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Intelligent cloud infrastructure management with AI-powered optimization and automation." />
        <meta name="keywords" content="AI cloud infrastructure, cloud management, cloud optimization, cloud automation, cloud security, cloud monitoring" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Intelligent cloud infrastructure management with AI-powered optimization and automation.
            </p>
        ...
        <section className="py-20 px-4 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Discover how Ai Cloud Infrastructure can transform your business across different domains
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

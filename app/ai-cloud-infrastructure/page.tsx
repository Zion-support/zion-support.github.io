  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced Ai Cloud Infrastructure solutions for businesses" />
        <meta name="keywords" content="AI, ai cloud infrastructure, artificial intelligence, business solutions" />
      </Helmet>
      <Navigation />
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Get started with our Ai Cloud Infrastructure solution today and see the difference.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-teal-500 to-blue-600 text-white px-8 py-4 rounded-full font-semibold hover:from-teal-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105">
                Start Free Trial

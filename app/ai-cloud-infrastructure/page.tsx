...
export const metadata: Metadata = {
  ...
  description: 'Advanced AI-powered cloud infrastructure services including migration, optimization, security, and monitoring. Transform your cloud operations with intelligent automation.',
  keywords: 'cloud infrastructure, cloud migration, cloud optimization, DevOps, cloud security, multi-cloud, AWS, Azure, GCP',
};

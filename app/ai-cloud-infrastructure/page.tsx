...
const AiCloudInfrastructurePage: React.FC = () => {
  ...
  const services = [{
      title: 'AI-Optimized Cloud', description: 'Cloud infrastructure designed for AI workloads', features: ['GPU Computing', 'Auto-scaling', 'Cost Optimization'],
...
const AiCloudInfrastructurePage: React.FC = () => {
  ...
  const benefits = [{ metric: '99.9%', description: 'Uptime Guarantee' }, { metric: 'Auto', description: 'Scaling Capabilities' }, { metric: '50%', description: 'Cost Reduction' }, { metric: '24/7', description: 'Monitoring & Support' }];
                  ...
                  <ul className="space-y-2">
                    {feature.benefits.map((benefit, benefitIndex) => (
                      <li key={benefitIndex} className="flex items-center text-sm text-gray-300">
                        <CheckCircle className="w-4 h-4 text-sky-400 mr-2 flex-shrink-0" /></CheckCircle>
                        {benefit}
                      </li>
                    ))}
                  </ul>

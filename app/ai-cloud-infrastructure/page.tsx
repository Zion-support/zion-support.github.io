...
const PagePage: React.FC = () => {
  ...
  const benefits = [
    ...
    { title: 'Benefit 3', description: 'Description for benefit 3' },
    { title: 'Benefit 4', description: 'Description for benefit 4' },
    { title: 'Benefit 5', description: 'Description for benefit 5' },
    { title: 'Benefit 6', description: 'Description for benefit 6' }
  ];

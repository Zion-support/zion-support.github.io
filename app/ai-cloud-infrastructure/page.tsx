  ...
  const benefits = [
    {
      ...
      description: 'Easily scale your cloud resources based on demand'
    },
    {
    ...
    },
    {
      ...
      description: 'Reduce cloud costs by up to 40% with smart resource management'
    },
    {
    ...
    },
    {
      ...
      description: 'Seamless migration from your current infrastructure'
    }
  ];

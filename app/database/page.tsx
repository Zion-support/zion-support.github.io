...
import { CheckCircle, ArrowRight, Star, Users, Clock, Shield, Zap, Database, Cloud, Globe } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional database services by Zion Tech Group. Expert solutions for your business needs." />
        <meta name="keywords" content="database services, technology, solutions, business, professional" />
      </Helmet>
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-12">
              Professional database services solutions designed to help your business succeed and grow.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:border-purple-400 transition-all duration-300">
                ...
                <p className="text-gray-300">Scalable cloud-based database solutions</p>
              </div>
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:border-purple-400 transition-all duration-300">
                ...
                <p className="text-gray-300">Advanced security and backup solutions</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-12 border border-white/20">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Contact us today to learn more about our database services solutions.
              </p>

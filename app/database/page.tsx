  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to optimize database performance'
    },
    {
      icon: Zap,
      title: 'High Performance',
      description: 'Lightning-fast database queries and real-time analytics'
    },
    {
      icon: Shield,
    ...
    },
    {
      icon: Globe,
      title: 'Global Scale',
      description: 'Worldwide database deployment and support'
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="keywords" content="database, AI solutions, IT services, Zion Tech Group, data management" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Transform your data management with our advanced database solutions. 

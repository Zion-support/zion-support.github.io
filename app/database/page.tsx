  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Expert database solutions including design, migration, optimization, and administration. Comprehensive database services for your business needs." />
        <meta name="keywords" content="database solutions, database design, data migration, database optimization, database administration, Zion Tech Group" />
      </Helmet>

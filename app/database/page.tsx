...
import { CheckCircle, ArrowRight, Database, Server, Shield, Zap, Globe, Users, Clock, Star, Phone, Mail } from 'lucide-react'
...
const DatabasePage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Professional database administration services with 24/7 monitoring and support.'
    }
  ]
  ...
  const testimonials = [
    {
      ...
      content: 'Their database services have been exceptional. We have 99.99% uptime and excellent performance.',
      rating: 5
    },
    {
      name: 'Michael Chen',
      company: 'DataFlow Solutions',
      content: 'The database migration was seamless and the performance improvements were remarkable.',
      rating: 5
    },
    {
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Don't just take our word for it - hear from businesses that trust our database services.
              </p>
            </div>

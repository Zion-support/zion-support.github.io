...
import { Database, Server, Shield, BarChart, CheckCircle } from 'lucide-react';
  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Comprehensive database services including design, optimization, migration, backup, and security. Ensure your data infrastructure is robust and performant."
        keywords={['database services', 'database optimization', 'data migration', 'backup recovery', 'database security', 'performance tuning']}
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              Our database services help you design, optimize, and maintain robust data infrastructure 
              that scales with your business and ensures data security and performance.
            </p>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="cyber-card p-8 text-center">
                ...
                <div className="text-4xl font-bold text-purple-400 mb-4">$899<span className="text-lg text-gray-400">/month</span></div>
              ...
              <div className="cyber-card p-8 text-center ring-2 ring-purple-400">
                ...
                <div className="text-4xl font-bold text-purple-400 mb-4">$1,800<span className="text-lg text-gray-400">/month</span></div>
                <ul className="space-y-3 mb-6">
                  <li className="flex items-center text-gray-300">
                    <CheckCircle className="w-5 h-5 text-green-400 mr-3" />

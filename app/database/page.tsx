...
import { CheckCircle, ArrowRight, Database, Shield, Zap, Users, Clock, Star, Target, DollarSign } from 'lucide-react'
...
const DatabasePage: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      description: 'Seamless database migration services with zero downtime',
      features: [
        'Migration planning',
        'Data validation',
    ...
    },
    {
      ...
      description: '24/7 database administration and monitoring services',
      features: [
        '24/7 monitoring',
        'Performance tuning',
        'Backup management',

    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg matrix-rain particle-field">
      ...
      <main className="container mx-auto px-4 py-16 pt-24">{/* Header */}</main>
        <section className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 cyber-text-3d neon-pulse glitch" data-text="Database Services">Database Services</h1><p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8">Comprehensive database design, optimization, and management with AI-powered tuning for maximum performance.<div className="text-2xl font-bold text-cyan-400 mb-8">Starting at $899/month</div>
        </section>

import React from 'react';
  return()
    ...
    <div className="max-w-7xlmx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <h1 className="text-4xl font-bold text-white mb-6"  >Database<>
    </h1>
    <p className="text-lgtext-gray-300 mb-8">
</>Professional database services coming soon.<>
    </p>
    <Link;</Link>
</></Link>
          to="/contact"

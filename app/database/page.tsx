  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Professional database solutions including design, migration, optimization, and security. Expert database services for your business." />
        <meta name="keywords" content="database solutions, database design, database migration, database optimization, database security, Zion Tech Group" />
      </Helmet>
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Transform your data management with our comprehensive database solutions. 

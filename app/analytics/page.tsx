...
const AnalyticsPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Analytics Solutions',
      description: 'Professional analytics services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored analytics implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your analytics needs.'
    }
  ];

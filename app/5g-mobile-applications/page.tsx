  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional5 g mobile applications solutions and services" />
        <meta name="keywords" content="5g, mobile, applications" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-autopx-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xlfont-bold text-white mb-8">5 G Mobile Applications</h1>

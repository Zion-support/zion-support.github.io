...
const AccessibilityPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Accessibility Solutions',
      description: 'Professional accessibility services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored accessibility implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your accessibility needs.'
    }
  ];

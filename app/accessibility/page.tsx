        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Accessible design benefits everyone and opens your business to a larger audience.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-4">Inclusive Reach</h3>
                <p className="text-gray-300">Access your services to 15% of the global population with disabilities</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-300">Meet legal requirements and avoid potential lawsuits</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-green-600 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Globe className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-xl font-bold text-white mb-4">Better UX</h3>
                <p className="text-gray-300">Improved user experience for all users, not just those with disabilities</p>
              </div>
            </div>
          </div>
        </section>

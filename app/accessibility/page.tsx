  ...
  const features = const features = const features = [
    {
      ...
      benefits: ['High contrast mode', 'Text scaling', 'Screen reader support', 'Color blind friendly'];      title: 'Motor Accessibility',
  ...
  return ()
          ...
          <div className="relative max-w-7xl mx-auto text-center" /></div>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6" /></h1>
              Accessibility <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Solutions</span>        <title>Accessibility Solutions - Zion Tech Group | Inclusive Digital Experiences</title>
        ...
        <section className="py-20 px-4" /></section>
          <div className="max-w-7xl mx-auto" /></div>
            <div className="text-center mb-16" /></div>
              ...
              <p className="text-xl text-gray-300" /></p>                Our solutions cover all aspects of digital accessibility to ensure inclusive experiences for all users.
              </p></p></p>
            </div>
        ...
        <section className="py-20 px-4 bg-white/5" /></section>
          <div className="max-w-7xl mx-auto" /></div>
            <div className="text-center mb-16" /></div>
              ...
              <p className="text-xl text-gray-300" /></p>                We ensure full compliance with international accessibility standards and regulations.
              </p></p></p>
            </div>

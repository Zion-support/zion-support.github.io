...
import { Eye, MousePointer, Volume2, Shield, Users, Globe, CheckCircle, Award, Zap } from 'lucide-react'
              ...
              {standards.map((standard, index) => (
                <div key={index} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="text-green-400 font-semibold">{standard.status}</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Contact our accessibility experts to audit your current setup and implement inclusive design solutions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-purple-700 hover:to-blue-700 transition-all duration-300">

...
const AccessibilityPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Enhanced navigation and interaction options for users with motor impairments.',
      benefits: ['Keyboard navigation', 'Voice control', 'Large click targets', 'Customizable controls']
    },
    {
      icon: Volume2,
      title: 'Audio Accessibility',
      description: 'Complete audio accessibility with captions, transcripts, and audio descriptions.',
      benefits: ['Closed captions', 'Audio descriptions', 'Transcripts', 'Volume controls']
    },
    {
      icon: Shield,
      title: 'Security & Privacy',
      description: 'Secure and private accessibility solutions that protect user data.',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive accessibility solutions for inclusive digital experiences. WCAG 2.1 AA compliant, Section 508 certified." />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Create inclusive digital experiences that work for everyone with our comprehensive accessibility solutions.
            </p>

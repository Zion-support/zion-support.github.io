...
>>>>>>> cursor/fix-errors-and-merge-to-main-fbe6
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                ...
                >
                  </div></div><div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
...
>>>>>>> cursor/fix-errors-and-merge-to-main-fbe6
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {standards.map((standard, index) => (
                ...
                >
                  </div></div><div className="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center mx-auto mb-6">
                    </div></div><CheckCircle className="w-8 h-8 text-white" />
                  </div>
                  <h3 className="text-xl font-bold text-white mb-2">{standard.name}</h3></h3></h3>
                  <p className="text-gray-300 mb-4 text-sm">{standard.description}</p></p></p>

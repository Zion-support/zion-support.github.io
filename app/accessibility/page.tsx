  ...
  return (
    <React.Fragment>
      <Helmet>
        ...
        <meta name="description" content="Creating inclusive digital experiences that work for everyone. Our accessibility solutions ensure your applications are usable by people of all abilities." /> " <meta name="keywords" content="accessibility, WCAG, ADA compliance, inclusive design, digital accessibility, Zion Tech Group" />"
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">"
        ...
        <section className="relative py-20 px-4 overflow-hidden"> " <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(147,51,234,0.3)_0%,transparent_50%)] animate-pulse" />"
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(59,130,246,0.3)_0%,transparent_50%)] animate-pulse" style={{ animationDelay: '1s' }} /> ' <div className="relative max-w-7xl mx-auto text-center">"'"
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight"> "
              Accessibility <span className="block bg-gradient-to-r from-purple-400 via-blue-400 to-cyan-400 bg-clip-text text-transparent">"
                Solutions
              </span>
            </h1>
        ...
        <section className="py-20 px-4"> " <div className="max-w-7xl mx-auto">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">"
              {features.map((feature, index) => (
                ...
                >}}
                  <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform"> " <feature.icon className="w-8 h-8 text-white" />"
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-cyan-400 transition-colors">"
                    {feature.title}
                  </h3>
                  <p className="text-gray-300 mb-6">{feature.description}</p> " <ul className="space-y-2">"
                    {feature.benefits.map((benefit, benefitIndex) => (
                      <li key={benefitIndex} className="flex items-center text-gray-300 text-sm"> " <CheckCircle className="w-4 h-4 text-cyan-400 mr-3 flex-shrink-0" />"
                        {benefit}
                      </li> )); </ul>
                </div> )); </div>
          </div>
        ...
        <section className="py-20 px-4"> " <div className="max-w-7xl mx-auto">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">"
              {standards.map((standard, index) => (
                ...
                >}}
                  <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl flex items-center justify-center mx-auto mb-6"> " <CheckCircle className="w-8 h-8 text-white" />"
                  </div>
                  <h3 className="text-xl font-bold text-white mb-2">{standard.name}</h3> " <p className="text-gray-300 mb-4 text-sm">{standard.description}</p> " <span className="inline-block px-4 py-2 bg-green-500/20 text-green-400 text-sm rounded-full font-semibold">"
                    {standard.status}
                  </span>
                </div>
              ));
        ...
        <section className="py-20 px-4">"
          <div className="max-w-4xl mx-auto text-center"> " <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-12">"
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6"> "
                Ready to Make Your Digital Experience Accessible? </h2>
              <p className="text-xl text-gray-300 mb-8"> "
                Contact us today for a comprehensive accessibility audit and implementation plan. </p>

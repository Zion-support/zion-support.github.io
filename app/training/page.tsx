...
<div className="grid grid-cols-1 md:grid-cols-2 gap-6">""            {benefits.map((benefit, index) => (
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8">""<div className="max-w-4xl mx-auto text-center">""<div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md:p-12">""<h2 className="text-3xl md:text-4xl font-bold text-white mb-4">""              Ready to Get Started?
            </h2>
<p></p>
...
'use client'';'import React from 'react';'import { Helmet } from 'react-helmet-async';'import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Zap, Shield, Brain, Globe } from 'lucide-react''  ]
  return (
  
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">""<Helmet>
<title>Page | Zion Tech Group
        <meta name="description" content="Professional Page services by Zion Tech Group. Advanced AI and IT solutions for your business." />""<meta name="keywords" content="page, AI solutions, IT services, Zion Tech Group, page" />""      {/* Hero Section */}
                <h3 className="text-xl font-semibold text-white mb-3">{feature.title}""                <p className="text-gray-300">{feature.description}""            ))}
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Key Benefits""            <p className="text-xl text-gray-300 max-w-3xl mx-auto">""              Experience the power of our page solutions for your business.
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">""              Ready to Get Started?
            <p className="text-xl text-purple-100 mb-8">""              Contact our experts to discuss your page needs and get a customized solution.
            </p>

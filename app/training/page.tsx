  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional training solutions and services" />
        <meta name="keywords" content="training" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xl font-bold text-white mb-8">Training</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional Training solutions and services</p>
...
=======
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Training Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Training - Zion Tech Group</title> <meta name="description"content="Professional Training solutions and services" /> <meta name="keywords"content="training" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Training</h1> <p className="text xl text gray-300 mb-8"> Professional Training solutions and services </p> 

...
const TrainingPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Training Solutions',
      description: 'Professional training services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored training implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your training needs.'
    }
  ];

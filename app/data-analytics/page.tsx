...
<div className="max-w-7xl mx-auto">
<div className="text-center mb-16">
<h2>Our Analytics Solutions
</h2>
<p>We provide comprehensive data analytics services to help you unlock the power of your data.
</p>
</div>
...
<p>Drive business success with our comprehensive data analytics services.
</p>
</div>
...
<h2>Ready to Unlock Your Data?
</h2>
<p>Contact our analytics experts to discuss your data needs and get a customized solution.
</p>
<div className="flex flex-col sm:flex-row gap-4 justify-center">

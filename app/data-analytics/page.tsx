        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional dataanalytics solutions powered by advanced AI and
...
=======
        ...
        <meta
          name="description"
          content="Transform your data into actionable insights with our advanced analytics solutions."
        />
      </Helmet>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md border">
              ...
              <p className="text-gray-600">
                Create interactive dashboards and visualizations to understand
                your data better.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md border">
              ...
              <p className="text-gray-600">
                Use machine learning to predict future trends and make

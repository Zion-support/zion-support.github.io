  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="keywords" content="data analytics, business intelligence, data science" />
      </Helmet>
        ...
        <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 hover:bg-slate-800/70 transition-all duration-300">
            ...
            <p className="text-gray-300">
              Extract meaningful insights from your data to drive informed business decisions.
            </p>
          </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 hover:bg-slate-800/70 transition-all duration-300">
            ...
            <p className="text-gray-300">
              Leverage machine learning and AI to uncover patterns and trends in your data.
            </p>
          </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 hover:bg-slate-800/70 transition-all duration-300">
            ...
            <p className="text-gray-300">
              Interactive dashboards that provide real-time visibility into your business metrics.
            </p>
          </div>
        </div>
      </div>

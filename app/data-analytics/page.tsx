...
const DataAnalyticsPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional data analytics services and solutions by Zion Tech Group."
      keywords="data analytics, services, solutions, technology, Zion Tech Group"
    >

...
import { CheckCircle, ArrowRight, Calculator, BarChart, Shield, Brain, TrendingUp, FileText, Users, Settings } from 'lucide-react'
...
const AIAccountingAssistantPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Advanced analytics and reporting to help you understand your business finances.',
    },
    {
      icon: Shield,
      title: 'Tax Preparation',
      description: 'Automated tax preparation and filing with compliance monitoring.',
    },
    {
      icon: Brain,
      title: 'AI Insights',
      description: 'Intelligent recommendations for financial optimization and cost reduction.',
    },
    {
      icon: TrendingUp,
      title: 'Growth Tracking',
      description: 'Monitor business growth with real-time financial metrics and KPIs.',
    },
    {
      icon: FileText,
      title: 'Document Management',
      description: 'Secure storage and organization of all financial documents and receipts.',
    }
  ];
  ...
  const benefits = [
    ...
    '24/7 financial monitoring and alerts',
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our AI accounting assistant provides comprehensive financial management tools.
              </p>
            </div>

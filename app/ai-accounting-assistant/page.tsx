...
import { Calculator, BarChart3, Zap, FileText, Target, Shield, ArrowRight, CheckCircle, Star, Globe, Smartphone, Mail } from "lucide-react";

export default function AIAccountingAssistant() {
  const features = [
    {
      title: "Automated Bookkeeping",
      description: "Automatically categorize transactions, reconcile accounts, and maintain accurate books",
      icon: <Calculator className="w-6 h-6" />,
      included: true
    },
    {
      title: "Financial Reporting",
      description: "Generate comprehensive financial reports with AI-powered insights and analysis",
      icon: <BarChart3 className="w-6 h-6" />,
      included: true
    },
    {
      title: "Expense Tracking",
      description: "Track and categorize expenses automatically with receipt scanning and OCR",
      icon: <Zap className="w-6 h-6" />,
      included: true
    },
    {
      title: "Tax Preparation",
      description: "Prepare tax returns and ensure compliance with automated calculations and forms",
      icon: <FileText className="w-6 h-6" />,
      included: true
    },
    {
      title: "Cash Flow Forecasting",
      description: "Predict future cash flow with AI-powered forecasting and trend analysis",
      icon: <Target className="w-6 h-6" />,
      included: true
    },
    {
      title: "Audit Trail",
      description: "Maintain complete audit trails with automated logging and compliance tracking",
  ...
  const testimonials = [
    {
      ...
      role: "CEO",
      content: "Zion AI Accounting Assistant has saved me 15 hours per week on bookkeeping. The automated categorization is incredibly accurate.",
      rating: 5,
      avatar: "JA"
    },
    {
      ...
      content: "The financial reporting features give our clients insights they never had before. It's transformed our practice.",
      rating: 5,
      avatar: "RK"
    },
    {
      ...
      content: "The cash flow forecasting has helped us make better business decisions. We can now plan for growth with confidence.",
      rating: 5,
      avatar: "MG"
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Streamline your accounting with AI Accounting Assistant - automated bookkeeping, financial reporting, and tax preparation. Starting at $39/month."
        />
        <meta
          name="keywords"
          content="AI accounting, automated bookkeeping, financial reporting, tax preparation, expense tracking, cash flow forecasting, accounting software"
        />
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 mb-6">
              ...
              <span className="text-green-400 text-sm font-medium">AI Accounting Platform</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Streamline your accounting with AI-powered automation. Automated bookkeeping, 
              financial reporting, tax preparation, and cash flow forecasting in one platform.
            </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                See what business owners say about AI Accounting Assistant
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-900/30 to-emerald-900/30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of businesses already using AI Accounting Assistant to save time and money.
            </p>

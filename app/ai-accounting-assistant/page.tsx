  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Automate your accounting processes with our intelligent AI assistant. Streamline bookkeeping, financial reporting, and compliance." />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Automate your accounting processes with our intelligent AI assistant. Streamline bookkeeping, financial reporting, and compliance.
            </p>

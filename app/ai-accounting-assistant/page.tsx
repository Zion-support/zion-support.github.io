...
=======
export default function AiAccountingAssistantPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Ai Accounting Assistant - Zion Tech Group</title>
        <meta name="description" content="Advanced Ai Accounting Assistant solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Ai Accounting Assistant solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

        ...
        <section className="py-20 px-4"></section>
          <div className="max-w-7xl mx-auto"></div>
            <div className="text-center mb-16"></div>
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6"></h1>AI Accounting Assistant</h1>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p>Streamline your accounting with AI-powered financial management tools.</p>
            </div>

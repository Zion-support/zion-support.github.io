  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Professional aiaccountingassistant services and solutions." />
        <meta name="keywords" content="aiaccountingassistant, services, solutions, technology" />
      </Helmet>
      ...
      <main className="pt-16">
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-4">AiAccountingAssistant</h1>

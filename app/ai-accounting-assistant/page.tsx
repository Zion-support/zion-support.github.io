  ...
  const features = [
    {
      ...
      description: 'Intelligent accounting solutions powered by artificial intelligence.',
      benefits: ['Automated Bookkeeping', 'Financial Analysis', 'Tax Preparation', 'Compliance Monitoring']
    },
    {
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Streamline your accounting processes with our intelligent AI-powered assistant.
            </p>
          </div>

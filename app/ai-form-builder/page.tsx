  ...
  return (
    <>
      <SEOHead
        ...
        description="Intelligent form builder with conditional logic, payment processing, and advanced analytics. Create smart forms with AI-powered features."
        keywords="AI form builder, intelligent forms, conditional logic, form analytics, payment forms, lead generation forms"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto mb-8">
              Create smart forms with AI-powered features. Intelligent form builder with conditional logic, 
              payment processing, and advanced analytics for better conversions.
            </p>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">Build forms easily with our intuitive drag-and-drop interface.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Create smart forms with conditional logic and dynamic fields.</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">Integrate payment processing directly into your forms.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-2xl p-8 text-center text-white">
            ...
            <p className="text-xl mb-8 opacity-90">
              Get started with our AI form builder and increase your conversions.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="tel:+13024640950" 

      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-teal-900 to-cyan-900">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
                Build intelligent forms with AI-powered features. Smart validation, conditional logic, 
                automated responses, and seamless integrations.
              </p>
        ...
        <div className="py-20 bg-black/20 backdrop-blur-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold text-center text-white mb-16">Intelligent Form Features</h2>
        ...
        <div className="py-20 bg-gradient-to-r from-emerald-600 to-cyan-600">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold text-white mb-6">Start Building Smart Forms Today</h2>
            <p className="text-xl text-emerald-100 mb-8">
              Join thousands of businesses using our AI form builder to collect better data, 
              improve user experience, and automate their workflows.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

import { ArrowRight, Mic, Video, Calendar, Users, Star, CheckCircle, Brain, Zap, Clock } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Real-time meeting transcription with 99% accuracy in 50+ languages"
    },
    {
    ...
    },
    {
      ...
      description: "AI-powered meeting scheduling that finds optimal times for all participants"
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Action Item Extraction",
      description: "Automatically identify and extract action items, decisions, and key points"
    },
    {
      icon: <Brain className="w-6 h-6" />,
      title: "Meeting Insights",
      description: "AI-generated insights on meeting effectiveness and participant engagement"
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "Automated Follow-ups",
      description: "Send personalized follow-up emails with action items and meeting summaries"
    }
  ];
  ...
  const testimonials = [
    {
      ...
      content: "Zion AI Meeting Assistant has revolutionized our meetings. We've increased productivity by 40% and never miss important action items.",
      rating: 5
    },
    {
      name: "David Kim",
      ...
      role: "Senior Manager",
      content: "The AI insights are incredible. We can now track meeting effectiveness and improve our collaboration patterns.",
      rating: 5
    },
    {
      name: "Sarah Thompson",
      ...
      role: "CEO",
      content: "This tool has transformed how we conduct meetings. The automated follow-ups ensure nothing falls through the cracks.",
      rating: 5
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Transform your meetings with Zion AI Meeting Assistant. AI-powered transcription, action item extraction, meeting insights, and automated follow-ups for productive team collaboration."
        />
        <meta
          name="keywords"
          content="AI meeting assistant, meeting transcription, video analysis, action items, meeting insights, team collaboration, productivity tools"
        />
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 mb-6">
              ...
              <span className="text-blue-400 text-sm font-medium">AI-Powered Meeting Intelligence</span>
            </div>
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Transform your meetings with AI-powered transcription, action item extraction, and intelligent insights. 
              Make every meeting more productive and ensure nothing falls through the cracks.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Everything you need to make your meetings more productive and insightful.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of teams using Zion AI Meeting Assistant to make every meeting count.
            </p>

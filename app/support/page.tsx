  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get help and support for our services. Contact our technical support team." />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Get help and support for our services. Contact our technical support team.
            </p>

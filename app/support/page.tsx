...
const SupportPage: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Yes, we specialize in seamless integration with existing systems and can work with most popular platforms and databases.',
      category: 'integration'
    },
    {
      id: 7,
      question: 'What is your pricing model?',
      answer: 'We offer flexible pricing models including project-based, monthly subscriptions, and custom enterprise agreements. Contact us for a detailed quote.',
      category: 'pricing'
    },
    {
      id: 8,
      question: 'Do you provide documentation and resources?',
      answer: 'Yes, we provide comprehensive documentation, API references, user guides, and video tutorials to help you get the most out of our solutions.',
      category: 'documentation'
    }
  ];

  const categories = ['all', 'general', 'support', 'implementation', 'training', 'security', 'integration', 'pricing', 'documentation'];
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {supportChannels.map((channel, index) => (
                <div key={index} className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/10 transition-all duration-300 text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-6">
                    <channel.icon className="w-8 h-8 text-white" />
                  </div>
                  <h3 className="text-xl font-bold text-white mb-3">{channel.title}</h3>
                  <p className="text-gray-300 mb-4">{channel.description}</p>
                  <p className="text-blue-400 font-semibold mb-2">{channel.contact}</p>
            ...
            <div className="flex flex-col md:flex-row gap-4 mb-8">
              ...
              <div className="relative">
                <select
                  ...
                  className="pl-4 pr-8 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none"
                >

...
const SupportPage: React.FC = () => {";";
  ...
  return(
    <>;
      <Helmet>";
        <title>Support - Get Help | Zion Tech Group";
              ...
              {supportOptions.map((option, _index) => {
                ...
                return(";
                  <div key={_index} className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300 text-center group">";
                    ...
                    <p className="text-gray-300 mb-4">{option.description}";
          ...
          <div className="max-w-7xl mx-auto">";
            ...
            <div className="grid md:grid-cols-3 gap-8">";
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 text-center">";
                ...
                <p className="text-cyan-400 font-medium">+1 (555) 123-4567";
                <p className="text-gray-400 text-sm">Mon-Fri 9AM-6PM EST";
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 text-center">";
                <Circle className="w-12 h-12 text-cyan-400 mx-auto mb-4" />";
                <h3 className="text-xl font-semibold text-white mb-2">Email";
                <p className="text-cyan-400 font-medium">support@ziontechgroup.com";
                <p className="text-gray-400 text-sm">24/7 Support";
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50 text-center">";
                <Circle className="w-12 h-12 text-cyan-400 mx-auto mb-4" />";
                <h3 className="text-xl font-semibold text-white mb-2">Address";
                <p className="text-cyan-400 font-medium">123 Tech Street";
                <p className="text-gray-400 text-sm">San Francisco, CA 94105;
    </>)
}";

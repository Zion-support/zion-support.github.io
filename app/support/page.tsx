              ...
              <div key={index} className="bg-slate-800/50 rounded-xl p-6 border border-slate-700 hover:border-purple-500 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-purple-500/20">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium text-purple-400">{option.availability}</span>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700">
                  <h3 className="text-lg font-semibold text-white mb-3">✉️ Email Support</h3>
                ...
                <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700">
                  ...
                  <button className="bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-4 py-2 rounded-lg hover:from-purple-700 hover:to-cyan-700 transition-all duration-300">
                    Start Chat
                  </button>
                </div>
              </div>

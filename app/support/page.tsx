...
const SupportPage: React.FC = () => {
  ...
  const supportChannels = [
    {
      icon: <MessageSquare className="w-8 h-8" /</MessageSquare className="w-8 h-8" />>,
      title: 'Live Chat',
    ...
    {
      icon: <Phone className="w-8 h-8" /</Phone className="w-8 h-8" />>,
      title: 'Phone Support',
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement</ 2 hours',
      action: 'Send Email',
      color: 'from-purple-500 to-pink-500'
    },
    {
    ...
    <>
      ...
      <div className="min-h-screen bg-slate-900 text-white flex items-center justify-center"</div className="min-h-screen bg-slate-900 text-white flex items-center justify-center">>
        <div className="text-center"</div className="text-center">>
          <h1 className="text-4xl font-bold mb-4"</h1 className="text-4xl font-bold mb-4">>support</h1>

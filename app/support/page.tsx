...
<<<<<<< HEAD
<<<<<<< HEAD
        <meta name="description" content="Get help and technical support." />
=======
...
=======
        <meta name = "description" content="Professional support by Zion Tech Group. Transform your business with our expert solutions." />
>>>>>>> cursor/fix-errors-and-merge-to-main-a79b
      </Helmet>
...
<<<<<<< HEAD
<<<<<<< HEAD
          <p className="text-lg text-gray-300 mb-8">Get help and technical support.</p>
          <Link 
            to="/contact" 
...
>>>>>>> cursor/fix-errors-and-merge-to-main-d941
          >
=======
          <p className="text-lg text-gray-300 mb-8">Professional support coming soon.</p>
          <Link >
            to="/contact"
            className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center mx-auto w-fit"
>>>>>>> cursor/fix-errors-and-merge-to-main-a79b

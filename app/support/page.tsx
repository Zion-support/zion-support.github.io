  ...
  const stats  = [{ number: "99.9%", label: "Uptime SLA", icon: <Shield className="w-6 h-6" /> },";
  ...
  return (    <div className ="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">";
      ...
      <section className ="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative z-10">";
        <div className ="max-w-7xl mx-auto text-center">";
          <h1 className ="text-4xl md:text-6xl font-bold text-white mb-6">";            We're Here to';            <span className ="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400">";
              {" "}Help";
            </span>
          </h1>
          <p className ="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">";            Get 24/7 support from our expert team. Whether you need technical assistance, have questions about our services, or want to explore new possibilities, we're here for you.';
          </p>
          {/* Search Bar */}          <div className ="max-w-2xl mx-auto mb-8">";
              ...
              <button key ={category.id}
                ...
                className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-300 ${
                  selectedCategory === category.id
                    ? 'bg-gradient-to-r from-cyan-500 to-purple-600 text-white shadow-lg'": 'bg-white/10 text-gray-300 hover:bg-white/20 hover:text-white'";
                }`}
              >
                {category.icon;}

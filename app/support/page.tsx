  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get help and support for all your technology needs and questions." />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
                Get help and support for all your technology needs and questions.
              </p>

...
const SupportPage: React.FC = () => {
  const [searchQuery, setSearchQuery] = useState('')  const faqs = [
    {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="support, help, FAQ, technical support, customer service" />      </Helmet>      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">

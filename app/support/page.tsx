...
const SupportPage: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'You can reach our technical support team via phone at (302) 464-0950, email at support@ziontechgroup.com, or through our live chat system available on our website.',
      category: 'technical'
    },
    {
      question: 'What are your response times?',
      answer: 'For critical issues, we respond within 1 hour. For general inquiries, we respond within 4 hours during business hours. Emergency support is available 24/7.',
      category: 'support'
    },
    {
      question: 'Do you provide documentation and guides?',
      answer: 'Yes, we provide comprehensive documentation, user guides, API references, and video tutorials to help you get the most out of our solutions.',
      category: 'general'
    }
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {supportChannels.map((channel, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 text-center hover:bg-white/20 transition-all duration-300">
                  ...
                  <p className="text-xs text-gray-500 mt-1">{channel.responseTime}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-16 px-4 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-300">Access our comprehensive library of resources</p>
            </div>

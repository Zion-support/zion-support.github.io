          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="max-w-2xl mx-auto mb-16">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-gray-800 border border-gray-600 rounded-lg text-white focus: ring-2 focus:ring-cyan-500 focu,"</Search>    s:border-transparent
              <
            <
            ...
            <div className="flex flex-wrap justify-center gap-2">
              {categories.map((category) => (<button
                  ...
                  className={`px-4 py-2 rounded-lg font-semibold transition-all duration-300 ${</button>                    selectedCategory === category.id`
...
export default PagePage;</Footer>
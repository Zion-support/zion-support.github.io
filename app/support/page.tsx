        ...
        <div className="max-w-7 xl mx-auto">
          ...
          <div className="space-y-6">
            {searchResults.map((item) => (
              <div key={item.id}
                className={`group bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-[1.02] hover:shadow-2 xl hover:shadow-cyan-500/10 relative overflow-hidden ${
          ...
          {searchResults.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">No results found</>
              <p>Try searching with different keywords or browse our categories.</>
            </>
          )}
        </>
      </>

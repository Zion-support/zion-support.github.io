  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get help and support for our AI and IT solutions. Our team is here to assist you." />
        <meta name="keywords" content="support, help, customer service, technical assistance" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Get help and support for our AI and IT solutions. Our team is here to assist you.
              </p>

...
import { Search, Phone, Mail, MessageCircle, Clock, CheckCircle, BookOpen, HelpCircle, Users, Zap } from 'lucide-react';
...
const SupportPage: React.FC = () => {
  ...
  const categories = ['all', 'Getting Started', 'Support', 'Security', 'Training', 'Integration', 'Service Level', 'Data Management'];

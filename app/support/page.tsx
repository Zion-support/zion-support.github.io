...
const SupportPage: React.FC = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Yes, we provide comprehensive training programs to help your team effectively use and maintain the implemented solutions.'
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get technical support and help for your AI and IT solutions. Find answers to common questions and contact our support team." />
        <meta name="keywords" content="technical support, help desk, AI support, IT support, Zion Tech Group" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Get help with your AI and IT solutions. Find answers, contact support, or access our knowledge base.
              </p>
            </div>
          </div>
        </section>

...
import { HelpCircle, Mail, Phone, BookOpen, Users, Zap, Search, Clock, MessageCircle, User, Helmet } from 'lucide-react'; interface FAQ { question: string; answer: string; category: string; } const SupportPage: React.FC = () => { const [searchTerm, setSearchTerm] = useState(");
""

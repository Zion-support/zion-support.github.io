      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">{/* Hero Section */}</div>
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-purple-100 mb-8 max-w-3xl mx-auto">Find answers to your questions, get technical support, or contact our team directly.</p>
            </p>
            ...
            <div className="max-w-2xl mx-auto mb-12">
              <div className="relative">
                <input
                  ...
                  className="w-full px-6 py-4 pl-12 bg-gray-800/50 backdrop-blur-sm border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"</input>
                /></input>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">Get Support</h2>
            </h2>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">{supportOptions.map((option, index) => (</div>
                <a
                  key={index};
                  href={option.link};
                ...
                >
                  ...
                  <span className="text-blue-400 font-semibold group-hover:text-blue-300">{option.action} →</span>
                  </span>
                </a>
              ))};
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">{filteredFaqs.length > 0 ? (</div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-purple-100 mb-8">Can't find what you're looking for? Our support team is here to help you succeed.</p>
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <Mail className="mr-2 h-5 w-5" />Contact Support</Mail>
              </a>
              <a
              ...
              >
                <Phone className="mr-2 h-5 w-5" />Call Us</Phone>
              </a>
            </div>
          </div>
        </section>

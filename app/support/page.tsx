      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg matrix-rain">
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 holographic-text cyber-text glitch" data-text="Technical Support">
              Technical Support
            </h1>
            <p className="text-xl text-cyan-400 mb-8 font-medium cyber-glow neon-text">
              24/7 Expert Help & Support
            </p>
...
<<<<<<< HEAD
                <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center hover:bg-white/20 transition-all duration-300 cyber-card hologram-card energy-pulse">
                  ...
                  <h3 className="text-xl font-semibold text-white mb-2 neon-text">{channel.title}</h3>
=======
<<<<<<< HEAD
...
<<<<<<< HEAD
              {faqs.map((faq, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 cyber-card hologram-card energy-pulse">

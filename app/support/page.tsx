  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get help with our AI and IT solutions." />
        <meta name="keywords" content="Support, AI solutions, IT services, Zion Tech Group" />
      </Helmet>
        ...
        <section className="py-20 px-4 relative">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed">
              Get help with our AI and IT solutions.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 text-center">
              ...
              <p className="text-gray-300 mb-8">
                We're working on bringing you comprehensive Support solutions. 

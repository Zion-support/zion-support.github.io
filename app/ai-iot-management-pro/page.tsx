...
import { Wifi, Cpu, Database, Zap, Brain, CheckCircle, ArrowRight, Star, Phone, Mail, Play, Activity, Camera, Thermometer, Home, Building, Car, Smartphone, Wind, Shield } from 'lucide-react';

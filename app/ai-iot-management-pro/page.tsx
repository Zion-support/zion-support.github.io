import { Wifi, Cpu, Database, Zap, Brain, CheckCircle, ArrowRight, Star, Phone, Mail, Play, Activity, Camera, Image, Cloud, Smartphone, Monitor, Sensor, Thermometer, Wind, Home, Building, Car } from 'lucide-react';

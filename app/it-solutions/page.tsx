  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive IT solutions including system integration, network management, and technical support for modern businesses." />
      </Helmet>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Comprehensive IT solutions including system integration, network management, and technical support for modern businesses.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-gray-300 mb-8">
                We're developing comprehensive IT solutions. Check back soon!
              </p>

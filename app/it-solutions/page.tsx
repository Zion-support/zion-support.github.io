...
const ITSolutionsPage: React.FC = () => {
  const solutions = [{]      title: "Cloud Infrastructure,
      description: "Scalable and secure cloud infrastructure solutions for modern businesses.",
      icon: CloudIcon", "
      features: [Scalable architecture","]        "High availability", "
        "Security compliance, ""
        Cost optimization", "
        "24/7 monitoring", "
        "Disaster recovery""
    ...
    },
    {
      ...
      features: [Threat detection","]        "Vulnerability assessment", "
        "Security monitoring, ""
        Incident response", "
    ...
    },
    {
      ...
      icon: LightBulbIcon", "
      features: [Technology assessment","]        "Strategic planning", "
        "Vendor selection, ""
    ...
    },
    {
      ...
      icon: GlobeAltIcon", "
      features: [Network design","]        "Security implementation", "
    ...
    },
    {
      ...
      icon: ChartBarIcon", "
      features: [Data storage","]        "Data processing", "
    ...
    },
    {
      ...
      icon: UserGroupIcon", "
      features: [24/7 support","]        "Remote assistance", "
        "System maintenance, ""
        Software updates", "
        "Hardware support", "
        "User training""
  ...
  const features = [{]      title: "Expert Solutions,
      ...
      <div className="min-h-screen bg-white>"
        ...
        <section className=py-20 px-4">"
          <div className=max-w-4xl mx-auto text-center">"
            ...
            <p className=text-lg text-gray-60 mb-8>"              Let's discuss how our IT solutions can help you achieve your business goals.'
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center>"
              <Link>
                to="/contact" "
      ...
      <section className=py-20 bg-gradient-to-r from-slate-90 to-purple-90">"
        <div className=container mx-auto px-4">"
          <div className=max-w-4xl mx-auto text-center">"
            ...
            <p className=text-xl text-gray-30 mb-12>"              Let's discuss how our IT solutions can enhance your business operations and security'
            </p>

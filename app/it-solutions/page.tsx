...
export default function ITSolutionsPage() {
  const itServices = [{
      ...
      icon: ServerIcon,
      features: ["Server management & monitoring",
    ...
    },
    {
      ...
      icon: CloudIcon,
      features: ["Cloud migration planning",
    ...
    },
    {
      ...
      features: ["Database design & optimization",
        "Performance tuning",
        "Backup & recovery",
        "Security implementation",
        "Migration services",

        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-400 max-w-3xl mx-auto">
              ...
              help businesses optimize performance, enhance security, and drive digital transformation.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {itServices.map((service, index) => {
              ...
              return (
                <div key={service.title} className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover:border-blue-500 transition-all duration-300 hover-lift hover-glow">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Expert IT services designed for enterprise-scale performance and reliability
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Enterprise Infrastructure</h3>
              <p className="text-gray-300">
                Robust, scalable IT infrastructure designed for enterprise-level performance and reliability.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Comprehensive security solutions with 24/7 monitoring and threat protection.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Expert cloud migration and management services for optimal performance and cost savings.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-300">
                Round-the-clock technical support and monitoring for uninterrupted business operations.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-300">
                We assess your current IT infrastructure and create a comprehensive implementation plan.
              </p>
            </div>
            <div className="text-center">

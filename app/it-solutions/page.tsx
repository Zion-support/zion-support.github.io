...
const ITSolutionsPage: React.FC = () => {}
  const solutions = [
    {}
      ...
      icon: "CloudIcon",
      features: [
        "Scalable architecture",High availability",Security compliance",Cost optimization",24/7 monitoring",Disaster recovery"
      ],
    ...
    {}
      ...
      icon: "LightBulbIcon",
      features: [
        "Technology assessment",Strategic planning",Vendor selection",Implementation guidance",Change management",Training and support"
      ],
    ...
    {}
      ...
      icon: "GlobeAltIcon",
      features: [
        "Network design",Security implementation",Performance optimization",Monitoring and maintenance",Disaster recovery",Remote access"
      ],
    ...
    {}
      ...
      icon: "ChartBarIcon",
      features: [
        "Data storage",Data processing",Analytics and reporting",Data security",Backup and recovery",Data governance"
      ],
    ...
    {}
      ...
      icon: "UserGroupIcon",
      features: [
        "24/7 support",Remote assistance",System maintenance",Software updates",Hardware support",User training"
      ],

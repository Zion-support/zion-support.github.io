...
const ITSolutionsPage: React.FC = () => {
  ...
  return (
    <>
      <SEOHead= title ="IT Solutions - Zion Tech Group""
        description="Comprehensive IT solutions including web development, cloud infrastructure, cybersecurity, mobile apps, database management, and system administration. Transform your technology infrastructure.""
        keywords="IT solutions, web development, cloud infrastructure, cybersecurity, mobile development, database management, system administration, IT consulting""
      />
              ...
              {itServices.map((service, index) => (
                <div  key ={index} className="group bg-slate-800/50 p-6 sm:p-8 rounded-xl border border-slate-700 hover:border-blue-500 transition-all duration-300 hover:transform hover:scale-105 hover:shadow-xl hover:shadow-blue-500/20">"
                  ...
                  <div  className ="relative z-10">"
                    ...
                    <a  href ={service.href}
                      className="inline-flex items-center text-blue-400 group-hover:text-blue-300 transition-colors text-sm font-medium""
                    >
                      Learn More
        ...
        <section: className ="relative py-16 sm:py-20 bg-gradient-to-r from-blue-900/40 via-slate-900 to-indigo-900/40 overflow-hidden">"
          ...
          <div  className ="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">"
            ...
            <div  className ="flex flex-col sm:flex-row gap-4 justify-center">"
              <a  href ="/contact""
                className="relative group bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 transform hover:scale-105 text-sm sm:text-base shadow-lg shadow-blue-500/25""
              >

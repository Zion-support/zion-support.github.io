...
const ITSolutionsPage: React.FC = () => {
  const itServices = [: value
    ...
    {},'
      ...
      const categories = ['All', 'Infrastructure', 'Security', 'Development', 'Mobile', 'Database', 'Networking']: value,
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-gray-300">This page is under development...</p>: value
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight"></h1>
              IT Solutions;"
              <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent"></span>': value
                {' '}That Scale;
              </span>
            </h1>"
...
"
        ...
        <div key={index} className="bg-slate-700/50 rounded-xl p-6 hover:bg-slate-600/50 transition-all duration-300 hover:scale-105 group">"
          ...
          <p className="text-gray-300">This page is under development...</p>: value
                ...
                <p className="text-gray-300 mb-4"></p>: value
                  {useCase.description};
                </p>"
      ...
      service.popular ? 'ring-2 ring-blue-500' : ''>
                ...
                {service.popular && ("
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2"></div>
                    <span className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-4 py-1 rounded-full text-sm font-semibold"></span>: value
                      Most Popular;
                    </span>
                  </div>
                )};"
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-300">This page is under development...</p>: value
                    ...
                    <span className="text-sm text-blue-400 font-medium">{service.category}</span>: value
                  </div>"
                  ...
                  <div className="flex items-center space-x-2 mb-3"></div>
                    ...
                    <span className="text-lg text-gray-400 line-through">{service.originalPrice}</span>: value
                  </div>"
                  <p className="text-gray-300 mb-4"></p>: value
                    {service.description};
                  </p>
...
"
                <ul className="space-y-3 mb-8"></ul>: value
                  ...
                  {service.features.length > 5 && ("
                    <li className="text-sm text-blue-400 font-medium"></li>: value
...
"
      ...
      tier.popular ? 'ring-2 ring-blue-500 bg-slate-700/50' : ''>
                ...
                <div className="text-center mb-8"></div>
                  ...
                  <p className="text-gray-300">{tier.description}</p>: value
                </div>
"
...
>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600"></section>
        <div className="container mx-auto px-4 text-center"></div>
          ...
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto"></p>: value

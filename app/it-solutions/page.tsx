...
const ItSolutionsPage: React.FC = () => {
  ...
  return (
    <React.Fragment>
      <Helmet>
        <title>
          It Solutions - Zion Tech Group | Advanced AI and IT Solutions
        </title>
        <meta
          name="description"
          content="Professional itsolutions solutions powered by advanced AI and cutting-edge technology."
        />
        <meta
          name="keywords"
          content="itsolutions, AI solutions, IT services, automation, technology, business solutions"
        />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional itsolutions solutions powered by advanced AI and
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <h1
              ...
              data-text="IT Solutions"
            >
              IT Solutions
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Comprehensive IT solutions for modern businesses. From web
              development to cloud infrastructure, we provide the technology
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Comprehensive IT services designed to meet your business needs and
              drive growth
            </p>
          </div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Our IT solutions are organized into key categories to help you
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {solutionCategories.map((category, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-20 h-20 rounded-full bg-gradient-to-r ${category.gradient} p-6 mx-auto mb-6 icon-bounce`}
                  >
                    <Icon className="h-8 w-8 text-white" />
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card p-8 text-center">
              ...
              <p className="text-gray-400 leading-relaxed">
                ...
                and best practices to build robust, scalable solutions.
              </p>
            </div>
            ...
            <div className="glass-card p-8 text-center">
              ...
              <p className="text-gray-400 leading-relaxed">
                We design solutions with cloud scalability in mind, ensuring
                your applications can grow with your business.
              </p>
            </div>
            ...
            <div className="glass-card p-8 text-center">
              ...
              <p className="text-gray-400 leading-relaxed">
                Security is built into every solution we create, protecting your
                data and ensuring compliance with industry standards.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="glass-card p-12">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Let us help you build the technology foundation your business
              needs to succeed. Contact us today for a free consultation.
            </p>

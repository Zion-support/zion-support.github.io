...
<<<<<<< HEAD
<<<<<<< HEAD
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">IoT & Edge Computing<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Internet of Things solutions with edge computing for real-time processing.</p>
=======
            </div>
...
<<<<<<< HEAD
          <div className="text-center mb-12">
<<<<<<< HEAD
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why Choose Our IoT & Edge Computing?<p className="text-lg text-gray-300 max-w-2xl mx-auto">Proven results and measurable impact for your business</p>
=======
            <h2 className="text-3xl md: text-4xl font-bold text-white mb-4">

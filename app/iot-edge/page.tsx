...
const IotEdgePage: React.FC = () => {";";
  return (";";";
    <>";";";";
      <SEOHead title ="iot-edge - Zion Tech Group - Zion Tech Group"";"
        description="Zion Tech Group iot-edge service page"";";";";
      />"
      <div className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";"
        <div className ="text-center">";"
          <h1 className ="text-4xl font-bold mb-4">iot-edge - Zion Tech Group</$1>"
...
const IotEdgePage: React.FC = () => {
  return (
    <>
      ...
      <div: className ="min-h-screen bg-slate-900 text-white flex items-center justify-center">";";
        <div: className ="text-center">";";
          <h1: className ="text-4xl font-bold mb-4">iot-edge - Zion Tech Group</h1>";";

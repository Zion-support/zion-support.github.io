  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced iot edge solutions powered by artificial intelligence to transform your business operations." />
        <meta name="keywords" content="AI, IotEdge, automation, technology, solutions" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Advanced iot edge solutions powered by artificial intelligence to transform your business operations.
            </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Get started with our IotEdge solution today and see the difference AI can make.
          </p>
          <button className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 rounded-lg font-semibold transition-colors">
            Start Your Journey
          </button>

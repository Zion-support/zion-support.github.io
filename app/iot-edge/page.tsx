  ...
  const iotServices = [
    {
      ...
      description:
        "Comprehensive platform for managing, monitoring, and updating IoT devices at scale.",
      icon: "📱",
    ...
    },
    {
      ...
      description:
        "Real-time data processing at the edge with low latency and high performance.",
      icon: "⚡",
    ...
    },
    {
      ...
      description:
        "Smart manufacturing and industrial automation with predictive maintenance.",
      icon: "🏭",
    ...
    },
    {
      ...
      description:
        "Comprehensive smart city infrastructure with traffic, energy, and environmental monitoring.",
      icon: "🏙️",
    ...
    },
    {
      ...
      description:
        "Comprehensive security solutions for IoT devices and networks with compliance management.",
      icon: "🔒",
    ...
    },
    {
      ...
      description:
        "Streaming analytics for IoT data with real-time insights and alerting.",
      icon: "📊",
    ...
    },
    {
      ...
      description:
        "Connect existing systems with IoT devices and cloud platforms seamlessly.",
      icon: "🔗",
    ...
    },
    {
      ...
      description:
        "AI-powered predictive maintenance for industrial equipment and machinery.",
      icon: "🔧",
    ...
    },
    {
      ...
      description:
        "Comprehensive environmental monitoring with air quality, water, and soil sensors.",
      icon: "🌍",
    ...
    },
    {
      ...
      description:
        "Precision agriculture with IoT sensors, drones, and AI-powered crop management.",
      icon: "🌾",
    ...
    },
    {
      ...
      description:
        "Custom IoT device design and development for specific business requirements.",
      icon: "⚙️",
    ...
    },
    {
      ...
      description:
        "Comprehensive data management for IoT with storage, processing, and analytics.",
      icon: "🗄️",
      price: "Starting at $2,800/month",
      features: [
        "Data ingestion",
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Advanced IoT and edge computing services including device management, real-time analytics, and industrial automation solutions."
        />
        <meta
          name="keywords"
          content="IoT services, edge computing, industrial IoT, smart cities, IoT analytics, device management"
        />
      </Helmet>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 text-cyan-100 max-w-3xl mx-auto">
                Connect, monitor, and optimize your operations with intelligent
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Expert IoT engineers delivering scalable, secure, and
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Certified engineers with deep expertise in IoT and edge
                  computing
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Ultra-low latency edge computing for critical applications
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Bank-level security with end-to-end encryption and monitoring
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Successfully deployed 500+ IoT projects across industries
                </p>
              </div>
            </div>
          </div>
          ...
          <section key={category} className="py-16 bg-gray-50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600">
                  Specialized {category.toLowerCase()} services for connected
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Comprehensive IoT solutions covering device management, edge
                computing, and intelligent analytics
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-gradient-to-br from-cyan-50 to-blue-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Comprehensive platform for managing IoT devices at scale
                </p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Real-time processing at the edge with ultra-low latency
                </p>
              </div>
              <div className="text-center p-6 bg-gradient-to-br from-green-50 to-emerald-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Machine learning and AI for intelligent IoT insights
                </p>
              </div>
              ...
              <div className="text-center p-6 bg-gradient-to-br from-pink-50 to-rose-100 rounded-lg">
                ...
                <p className="text-gray-600">
                  Comprehensive smart city infrastructure and services
                </p>
              </div>
            </div>
          </div>

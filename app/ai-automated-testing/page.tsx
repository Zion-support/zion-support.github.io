  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        ...
        <meta name="description" content="Advanced ai automated testing solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        <div className="container mx-auto px-4 py-20">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl">
            Professional ai automated testing services by Zion Tech Group.
          </p>
          
          <div className="bg-slate-800 p-8 rounded-lg">
            <h2 className="text-2xl font-bold text-white mb-4">Coming Soon</h2>
            <p className="text-gray-300">
              We are working on bringing you the most advanced ai automated testing solutions. 
...
'use client';';
import React from 'react';';';
import { Helmet , CheckCircle, Zap, Brain, Target, Shield, Clock, ArrowRight, Star, Users, BarChart, Code, Bug  } from 'react-helmet-async';';';
...
<meta name="keywords" content="AI testing, automated testing, intelligent testing, test automation, QA automation, AI QA" /></Helmet>"
...
<span className="text-cyan-400 font-medium">Intelligent Testing</span></div>"
...
<Bug className="w-6 h-6 text-white" /></div>"
...
<span className="text-cyan-400 font-bold">+90%</span></div>"
<div className="flex justify-between items-center">"
<span className="text-gray-300">Bug Detection Rate</span>"
<span className="text-green-400 font-bold">+75%</span></div>"
<div className="flex justify-between items-center">"
<span className="text-gray-300">Test Coverage</span>"
<span className="text-purple-400 font-bold">+85%</span></div>"
<div className="flex justify-between items-center">"
<span className="text-gray-300">Cost Reduction</span>"
<span className="text-orange-400 font-bold">-60%</span></div>"
</div></div>
</div></div>
</section>
...
=======
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Advanced ai automated testing solutions by Zion Tech Group.
          </p>
        </div>
      </div>
    </div>

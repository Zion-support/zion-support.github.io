...
const AiautomatedtestingPage = () => {
  const serviceName = "Ai Automated Testing";
  const serviceDescription = "Advanced AI-powered solutions for ai automated testing";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered solutions for ai automated testing" />
        <meta name="keywords" content="AI, artificial intelligence, ai automated testing, automation, technology solutions" />
      </Helmet>

...
export const metadata: Metadata = {
  ...
  description:
    'Performance Optimization transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faste',
  alternates: { canonical: '/performance-optimization' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Performance Optimization transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Performance Optimization',
      }}
    />
  );
}

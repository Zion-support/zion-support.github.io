...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Contract Management & Analysis',
        ...
        useCases: [
          {
            ...
            description: 'Automate routine tasks with <em>AI Contract Management & Analysis</em>, reduce manual errors, and free your team to focus on strategic priorities.',
            icon: '⚡'
          },
          {
          ...
          },
          {
            ...
            description: 'Leverage AI Contract Management & Analysis insights to make faster, more confident decisions backed by real operational data.',
            icon: '🎯'
          }
        ],
        benefits: [
        ...
        ctaLabel: 'Get Started with AI Contract Management & Analysis',
        ctaHref: '/contact?topic=ai-contract-management',

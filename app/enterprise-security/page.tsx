  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive security solutions designed for large-scale enterprise environments." />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Enterprise Security</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Comprehensive security solutions designed for large-scale enterprise environments.
            </p>

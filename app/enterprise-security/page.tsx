...
export default function EnterpriseSecurityPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Robust identity and access management solutions with multi-factor authentication and zero-trust architecture.'      description: 'Comprehensive security solutions to protect against advanced persistent threats and cyber attacks.',
    },
    {
      icon: <Lock className="w-8 h-8 text-green-500" />,
      title: 'Identity & Access Management',
      description: 'Robust identity and access management solutions with multi-factor authentication and zero-trust architecture.'      description: '24/7 security monitoring and threat detection across all systems.',
    },
    {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {features.map((feature, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300">
                  ...
                  <p className="text-gray-300">{feature.description}</p>      description: '24/7 security monitoring and threat detection across all systems.',
    },
    {
      icon: <Database className="w-8 h-8 text-orange-500" />,
      title: 'Compliance Management',

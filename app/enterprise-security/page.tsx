  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to detect and prevent security threats'
    },
    {
      icon: Zap,
      title: 'Real-Time Protection',
      description: 'Lightning-fast threat detection and real-time security monitoring'
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: 'Worldwide enterprise security protection and support'
    }
  ]
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="keywords" content="enterprise security, AI solutions, IT services, Zion Tech Group, security" />
      </Helmet>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the power of our enterprise security solutions for your business.
            </p>
          </div>

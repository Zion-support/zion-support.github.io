        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            <div className="text-center bg-blue-50 rounded-lg p-4">
              <div className="text-lg font-semibold text-blue-600">Real-time</div>
              <div className="text-sm text-gray-600">Decision Processing</div>
            </div>
            <div className="text-center bg-green-50 rounded-lg p-4">
              <div className="text-lg font-semibold text-green-600">Policy</div>
            ...
            <div className="text-center bg-orange-50 rounded-lg p-4">
              <div className="text-lg font-semibold text-orange-600">Human</div>

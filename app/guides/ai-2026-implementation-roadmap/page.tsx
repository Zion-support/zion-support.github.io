        ...
        <div className="prose prose-lg max-w-none">
          ...
          <div className="bg-purple-50 p-6 rounded-lg">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                <div className="text-lg font-semibold text-purple-600">Policy</div>
                <div className="text-sm text-gray-600">Engine Integration</div>
              </div>
              <div className="text-center">
                <div className="text-lg font-semibold text-purple-600">Audit</div>
                <div className="text-sm text-gray-600">Trail Maintenance</div>
              </div>
              <div className="text-center">
                <div className="text-lg font-semibold text-purple-600">Human</div>

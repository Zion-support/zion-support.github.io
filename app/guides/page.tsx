...
const GuidesPage: React.FC = () => {
  const guides  = [
    {title: 'AI 2026 Implementation Roadmap','"'"
      ...
      icon: Brain,
      difficulty: 'Intermediate','"';"      duration: '45 min read';
    ,
  },
    {    title: 'AI 2027 Implementation Roadmap','"'"
      ...
      category: 'AI Implementation','"'"
      icon: Brain,
      difficulty: 'Advanced','"'"      duration: '60 min read';
    ,
  },
    {    title: 'Autonomous Business Processes Implementation Guide 2026','"'"
      ...
      icon: Zap,
      difficulty: 'Expert','"'"      duration: '90 min read';
    ,
  }
  ,
  ];
  const categories  = [    {name: 'AI Implementation', icon: Brain, color: 'text-purple-400' ,'"'"
  },
    {

...
const GuidesPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Guides Solutions',
      description: 'Professional guides services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored guides implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your guides needs.'
    }
  ];

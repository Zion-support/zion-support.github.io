...
export const metadata: Metadata = {
  ...
  description:
    'AI Predictive Analytics transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Predictive Analytics transforms raw data into actionable intelligence with real-time dashboards, automated reporting, and predictive models. Make faster, more confident decisions backed by production-grade analytics.',
        iconEmoji: '📊',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Predictive Analytics',
      }}
    />
  );
}

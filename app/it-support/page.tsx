...
const ItsupportPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>It Support - Professional IT support and technical assistance services | Zion Tech Group</title>
        <meta name="description" content="Professional IT support and technical assistance services." />
        <meta name="keywords" content="technical support, IT helpdesk, system administration, troubleshooting, IT maintenance" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Professional IT support and technical assistance services.
            </p>
          </div>

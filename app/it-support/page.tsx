      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive it support solutions designed to meet your business needs.
          </p>
<<<<<<< HEAD
...
export default function ItsupportPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>It Support - Zion Tech Group</title>
        <meta name="description" content="Professional it support services by Zion Tech Group" />
      </Helmet>

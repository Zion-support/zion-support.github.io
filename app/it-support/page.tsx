...
const It Support Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>It Support</title>
        <meta name="description" content="Professional it support solutions and services" />
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const It Support Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>It support - Zion Tech Group</title> <meta name="description"content="Professional It support solutions and services" /> <meta name="keywords"content="it, support" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">It support</h1> <p className="text xl text gray-300 mb-8"> Professional It support solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">It support</h1>
            <p>
          
              Professional It support solutions and services
            </p>
...
export default It;; Support Page

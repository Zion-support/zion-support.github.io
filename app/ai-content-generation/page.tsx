...
import { FileText, CheckCircle, ArrowRight, Zap, Shield, Target, BarChart, TrendingUp } from 'lucide-react';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Automated content generation using advanced AI models for text, images, and multimedia content." />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Automated content generation using advanced AI models for text, images, and multimedia content.
            </p>

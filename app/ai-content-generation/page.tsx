  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Intelligent AI-powered content generation solutions for modern businesses." />
        <meta name="keywords" content="AI content generation, content creation, AI writing, automated content, content marketing" />
      </Helmet>
      <Navigation />
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Intelligent AI-powered content generation solutions for modern businesses.
            </p>

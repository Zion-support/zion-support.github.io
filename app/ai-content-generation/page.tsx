  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Revolutionary AI content generation platform for blogs, social media, marketing, and more. Create high-quality content at scale with intelligent automation." />
        <meta name="keywords" content="AI content generation, content creation, blog writing, social media content, marketing content, content automation" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Create high-quality content at scale with our AI Content Generation platform. 
              From blogs to social media, generate engaging content that resonates with your audience.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Intelligent content creation powered by cutting-edge AI technology
              </p>
            </div>

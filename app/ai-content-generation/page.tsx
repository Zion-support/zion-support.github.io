  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Transform your content creation with AI-powered generation. Create blogs, social media, videos, and more with advanced AI technology." />
        <meta name="keywords" content="AI content generation, content creation, AI writing, content automation, AI content tools" />
      </Helmet>
          ...
          <section className="relative py-20 px-4 overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Transform your content creation with AI-powered generation. 
                Create blogs, social media, videos, and more with advanced AI technology.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-emerald-600 hover:to-teal-700 transition-all duration-300 flex items-center justify-center">
                  Get Started
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                  Powerful AI-driven content creation tools that transform your content strategy
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {features.map((feature, index) => (
                  <div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300">
                    <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-lg mb-4">

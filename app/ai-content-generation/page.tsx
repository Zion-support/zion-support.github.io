  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Create high-quality content at scale with AI-powered generation tools for text, images, and multimedia." />
        <meta name="keywords" content="AI solutions, artificial intelligence, ai content generation, AI technology, intelligent automation" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Create high-quality content at scale with AI-powered generation tools for text, images, and multimedia.
              </p>

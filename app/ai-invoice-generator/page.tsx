...
import { Arrow Right, Brain } from 'lucide-react';
...
export default function A IInvoice Generator() {
  const features = [
    ...
    {
      icon: <C redit Cardclass Name="w-6 h-6 t e xt-y e llow-400" />,
...
export default function Page() {
  return (
      ...
      <H elmet>
        ...
        <m etaproperty="og:url" content="https://ziontechgroup.com/ai-invoice-generator" />
      </H elmet>

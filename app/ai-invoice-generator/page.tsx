...
export const metadata = {
  ...
  description:
    'AI Invoice Generator streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to',
  alternates: { canonical: '/ai-invoice-generator' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Invoice Generator streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Invoice Generator',
      }}
    />
  );
}

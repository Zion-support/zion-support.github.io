...
<<<<<<< HEAD
        <meta name="description" content="Advanced Ai Invoice Generator solutions powered by AI." />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-6">Ai Invoice Generator</h1>
          <p className="text-lg text-gray-300 mb-8">Advanced Ai Invoice Generator solutions powered by AI.</p>
          <Link 
            to="/contact" 
            className="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors"
=======
        <meta name="description" content="Professional ai invoice generator services by Zion Tech Group. Transform your business with our expert solutions." />
      </Helmet>
...
=======
    ...
    <></>
      <Helmet></Helmet>
        ...
        <meta property="og:url" content="https://ziontechgroup.com/ai-invoice-generator" /  /></meta>
      </Helmet>

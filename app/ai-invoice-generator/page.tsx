      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-gradient-to-r from-emerald-500/20 to-purple-500/20 rounded-2xl p-8 border border-emerald-500/30">
              <h2 className="text-3xl font-bold text-white mb-4">
                Streamline Your Invoicing Today
              </h2>
              <p className="text-lg text-gray-300 mb-8">
                Join thousands of businesses using AI Invoice Generator to get paid faster
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/contact"

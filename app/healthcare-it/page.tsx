  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <Helmet>
        ...
        <meta name="description" content="Healthcare It solutions by Zion Tech Group" />
      </Helmet>
      
      <div className="container mx-auto px-4 py-20">
        <h1 className="text-4xl font-bold mb-8">Healthcare It</h1>
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive healthcare it solutions designed to meet your business needs.
          </p>
<<<<<<< HEAD
...
<<<<<<< HEAD
  ...
  return (
    <>
      <Helmet>
        <title>Healthcare IT - Zion Tech Group</title>
        <meta name="description" content="Specialized IT solutions for healthcare organizations." />
        <meta name="keywords" content="healthcare IT, medical, health, technology" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Specialized IT solutions for healthcare organizations.
=======
  ...
  return (
    <>
      <title>5G Data Analytics - Zion Tech Group</title>
        <title>Healthcare It - Zion Tech Group</title>
        <h1 className="text-4 xl font-boldtext-whitemb-6">Healthcare It</h1>
        <p className="text-lgtext-gray-300mb-8">Professional healthcare it services coming soon.</p>
          Contact Us
...
export default function HealthcareitPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>Healthcare It - Zion Tech Group</title>
        <meta name="description" content="Professional healthcare it services by Zion Tech Group" />
      </Helmet>
      
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-6">Healthcare It</h1>
          <p className="text-lg text-gray-300 mb-8">Professional healthcare it services coming soon.</p>

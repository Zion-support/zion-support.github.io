      ...
      <section className="relative py-20 px-4 overflow-hidden"></section>
        ...
        <div className="relative max-w-7xl mx-auto text-center"></div>
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight"/>
            Healthcare</h1>
            <span className="block bg-gradient-to-r from-red-400 via-pink-400 to-purple-400 bg-clip-text text-transparent"></span>
              IT Solutions;
      ...
      <section className="py-20 px-4"></section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
              <div, key={inde, x} classNam, e="b, g-whit, e/5, backdrop-blu, r-sm, border borde, r-whit, e/10, rounded-xl, p-6, text-center, hover:b, g-whit, e/10, transition-all, duration-30, 0"></di, v>
                ...
                <h3, className="tex, t-xl, font-semibold, text-white, mb-3">{servic, e.titl, e}</h, 3>
...
section className="py-20 px-4"></section>
            <button className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-red-600 transition-colors"></button>
              View Case Studies;
      <Footer />
  );
;

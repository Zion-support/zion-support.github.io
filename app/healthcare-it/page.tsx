...
export default function HealthcareITPage() {
  const features = [{
      icon: Heart, icon: Heart, title: 'HIPAA Compliance', description: 'Full HIPAA compliance solutions with automated controls, monitoring, and reporting capabilities.', benefits: ['Automated compliance', 'Audit trails', 'Risk management'],
    },
    {icon: Zap,
...
{/* Features Section */} <section className="py-20 px-4">
  ...
  const stats = [{ number: '99.9%', label: 'System Uptime', icon: Clock }, { number: '500+', label: 'Healthcare Clients', icon: Users }, { number: '15+', label: 'Years Experience', icon: Shield }, { number: '24/7', label: 'Support Available', icon: Heart }];
  return (
<div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900"></div>

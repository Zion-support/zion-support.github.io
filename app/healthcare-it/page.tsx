...
return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900"></div>      <SEOOptimizer>
      <Navigation>
      {/* Hero Section */}

    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">Healthcare
            <span className="block bg-gradient-to-r from-red-400 via-pink-400 to-purple-400 bg-clip-text text-transparent">IT Solutions&gt><//h1&gt; <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">Secure, compliant, and innovative IT solutions designed specifically for healthcare organizations. 
            Protect patient data while improving operational efficiency.
          </p&gt; <ArrowRight className="inline-block ml-2 w-5 h-5" />
            </button&gt; <button className="border border-red-400 text-red-400 hover:bg-red-400 hover:text-white font-bold py-4 px-8 rounded-lg transition-all duration-300">Learn More&gt><//div&gt; </div&gt; </section>{/* Features Section */}
      <section className="py-20 px-4">
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">Comprehensive IT solutions for all aspects of healthcare delivery and management.
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Why Choose Our Healthcare IT Solutions?
            </h2&gt; <p className="text-xl text-gray-300 max-w-3xl mx-auto">Experience the benefits of modern healthcare technology with our proven solutions.
...
<section className="py-20 px-4">
            </button&gt; <button className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-red-600 transition-colors">View Case Studies><//div&gt; </div&gt; </section&gt; <Footer />
</div>)
}
  </button&gt; </span&gt; </SEOOptimizer>
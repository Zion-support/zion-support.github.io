  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced healthcare IT solutions powered by artificial intelligence and cutting-edge technology." />
        <meta name="keywords" content="AI, healthcare IT, artificial intelligence, business solutions, automation" />
      </Helmet>
      <Navigation />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                Healthcare IT <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">Solutions</span>
              </h1>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Transform your healthcare business with our advanced AI-powered solutions designed for modern enterprises.
              </p>

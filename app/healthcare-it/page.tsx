...
return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900"></div></div></div>
      ...
      <section className="py-20 px-4">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(239,68,68,0.3)_0%,transparent_50%)] animate-pulse" /></div></div></div>
...
>>>>>>> cursor/fix-errors-and-merge-to-main-fbe6
    ...
    services.map((service, index) => (
              ...
              <div key={index} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-center hover:bg-white/10 transition-all duration-300"></div></div></div>
                ...
                <h3 className="text-xl font-semibold text-white mb-3">{service.title}</h3></h3></h3>

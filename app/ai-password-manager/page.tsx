  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="AI-powered ai password manager solution for modern businesses." />
        <meta name="keywords" content="AI, artificial intelligence, ai password manager, business solutions" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              AI-powered ai password manager solution for modern businesses.
            </p>

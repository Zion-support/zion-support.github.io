...
const AIFraudDetectionPage: React.FC = () => {const fraudServices = [,
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"><Navigation />
        <main className="container mx-auto px-4 py-16 pt-24"></main>
          ...
          <section className="text-center mb-16"></section>
            ...
            <p className="text-xl text-red-400 mb-8 font-medium"></p>
          ...
          <section className="mb-16"></section>
            ...
            <div className="grid grid-cols-1 sm: grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6"></div>
              ...
              {fraudServices.map((service, index) => (
                ...
                <article key={index} className="cyber-card p-6 hover: scale-105 transition-all duration-300"></article>
                  <div className="w-16 h-16 bg-gradient-to-br from-red-500 to-pink-600 rounded-xl flex items-center justify-center mb-6 mx-auto"><service.icon className="w-8 h-8 text-white" /></service.icon>
                  </div>
    </div>
...
>
          ...
          <section className="mb-16"></section>
            ...
            <div className="cyber-card p-8"><h2 className="text-3xl font-bold text-white mb-8 text-center neon-text"></h2>
                Industry Applications,
              </h2>
          ...
          <section className="text-center"></section>
            ...
            <div className="cyber-card p-8 max-w-4xl mx-auto"><h2 className="text-3xl font-bold text-white mb-4 neon-text"></h2>

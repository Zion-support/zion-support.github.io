...
import { Shield, BarChart3, TrendingUp, Zap, Target } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Our ai fraud detection solutions leverage cutting-edge technology to deliver exceptional results. 

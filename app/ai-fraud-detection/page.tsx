  ...
  const fraudServices = [
    {
      ...
      description:
        "Instant detection of fraudulent activities using advanced AI algorithms",
      icon: Zap,
      price: "$1,900/month",
      features: [
    ...
    },
    {
      ...
      description:
        "Comprehensive analysis of transactions to identify suspicious patterns",
      icon: BarChart,
      price: "$1,200/month",
      features: [
    ...
    },
    {
      ...
      description:
        "Specialized protection against credit card fraud and chargebacks",
      icon: Lock,
      price: "$1,800/month",
      features: [
        "Card Verification",
    ...
    },
    {
      ...
      description:
        "Detect and prevent insurance fraud with AI-powered analysis",
      icon: AlertTriangle,
      price: "$2,000/month",
      features: [
        "Claim Analysis",
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              Protect your business from fraud with our cutting-edge AI-powered
              detection systems. Real-time monitoring, advanced analytics, and
              instant alerts to keep your business secure.
            </p>
          </section>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {benefits.map((benefit, index) => (
                <div
                  key={index}
                  className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300"
                >
              ...
              {fraudServices.map((service, index) => (
                ...
                >
                  ...
                  <div className="text-center">
                    <div
                      className={`text-lg font-bold mb-2 neon-text ${service.color}`}
                    >
                      {service.price}
                    </div>
                    <a
          ...
          <section className="text-center">
            <div className="cyber-card p-8 max-w-4xl mx-auto">
              ...
              <p className="text-gray-300 mb-6 text-lg">
                Don't let fraud damage your business. Our AI-powered fraud
                detection systems provide real-time protection and help you stay

          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
                ...
                Real-time monitoring, machine learning algorithms, and 99.9%
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  Continuous monitoring of transactions and user behavior with
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  Advanced ML algorithms that learn from patterns and adapt to
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  Comprehensive risk scoring system that evaluates multiple
                  factors to determine fraud probability.
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  Immediate notifications via email, SMS, and dashboard alerts
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  ...
                  and webhooks for seamless operation.
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-xl border border-white/20 hover:bg-white/20 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  Built-in compliance features for PCI DSS, GDPR, and other
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-gradient-to-r from-red-600 to-pink-600 p-8 rounded-xl relative">
                ...
                <div className="text-4xl font-bold text-white mb-6">
                  $399<span className="text-lg text-red-200">/month</span>
                </div>
                <ul className="space-y-4 mb-8">
        ...
        <div className="py-20 bg-gradient-to-r from-red-600 to-pink-600">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-red-100 mb-8">
              Don't wait for fraud to happen. Our AI-powered detection system
              provides real-time protection with 99.9% accuracy and instant
              alerts.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

...
const CloudconsultingPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Cloud Consulting - Expert cloud strategy and migration consulting services | Zion Tech Group</title>
        <meta name="description" content="Expert cloud strategy and migration consulting services." />
        <meta name="keywords" content="cloud strategy, cloud migration, cloud architecture, cloud optimization" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Expert cloud strategy and migration consulting services.
            </p>
          </div>

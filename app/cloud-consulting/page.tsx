...
const CloudConsultingPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      <Helmet>
        <title>Cloud Consulting - Zion Tech Group | Professional Technology Solutions</title>
        <meta name="description" content="Professional cloud consulting services and solutions. Expert implementation and support for your business needs." />
        <meta name="keywords" content="cloud consulting, professional services, business solutions, technology consulting" />
      </Helmet>
            ...
            {[
              {
                ...
                description: "Expert cloud consulting solutions tailored to your business needs.",
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-900/30 to-purple-900/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Contact our expert team to discuss your cloud consulting requirements and get a customized solution.
          </p>
          <Link
            to="/contact"

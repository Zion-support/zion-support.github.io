...
const CloudInfrastructureManagerPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional cloud infrastructure manager services and solutions by Zion Tech Group."
      keywords="cloud infrastructure manager, services, solutions, technology, Zion Tech Group"
    >

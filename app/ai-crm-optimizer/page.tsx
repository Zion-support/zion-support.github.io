...
export const metadata = {
  ...
  description: 'Professional ai crm optimizer services by Zion Tech Group.',
  keywords: 'ai, crm, optimizer, technology, services',
  openGraph: {
    title: 'Ai Crm Optimizer | Zion Tech Group',
    description: 'Professional ai crm optimizer services by Zion Tech Group.',
    type: 'website',
      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Professional ai crm optimizer services by Zion Tech Group.
          </p>

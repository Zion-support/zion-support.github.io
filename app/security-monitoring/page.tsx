...
const features = [    {
    ...
    'Expert security team support',    'Customizable monitoring rules'
  ]
return (
    <>      <Helmet>
        ...
        <section className="py-20 px-4">
          ...
          <div className="max-w-7xl mx-auto"></div>
            <div className="text-center mb-16"></div>
              ...
              <p>
                Protect your business with our advanced 24/7 security monitoring solutions.                Real-time threat detection, instant alerts, and expert response to keep your data safe.
              </p>
        ...
        <section className="py-20 px-4">
          ...
          <div className="max-w-4xl mx-auto text-center"></div>
            <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 md:p-12"></div>
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Contact our security experts to discuss your monitoring needs and get a customized protection plan.</p>              <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
                <button>
                  <Phone>
                  Call (302) 464-0950
                </button>

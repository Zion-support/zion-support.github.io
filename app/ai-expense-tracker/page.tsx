  ...
  return (
    <>
      <SEOHead 
        ...
        description="Smart AI-powered expense tracking and financial management with automated categorization and insights."
        keywords="AI expense tracker, financial management, expense categorization, AI finance, expense analytics"
      />
        ...
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center max-w-4xl mx-auto px-4">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Smart AI-powered expense tracking and financial management with automated categorization and insights.
            </p>

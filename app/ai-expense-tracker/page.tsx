...
import { CheckCircle, ArrowRight, DollarSign, Receipt, BarChart3, Shield, Zap, Globe, Star, Clock, TrendingUp, Users, Settings, Smartphone } from 'lucide-react';
...
export default function AIExpenseTrackerPage() {
  ...
  const capabilities = [
    ...
    },
    {
      ...
      description: 'Set budgets and get alerts when you approach limits with intelligent monitoring'
    },
    {
  ...
  const testimonials = [
    {
      ...
      content: 'The AI receipt scanning is incredible! I save 2 hours every week on expense tracking.',
      rating: 5
    },
    {
      name: 'Mike Chen',
      company: 'Small Business Owner',
      content: 'Tax preparation is now a breeze. The automatic categorization saved me days of work.',
      rating: 5
    },
    {
      name: 'Emily Davis',
      company: 'Marketing Consultant',
      content: 'The analytics helped me identify unnecessary expenses and save 30% on my budget.',
      rating: 5
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Smart AI-powered expense tracking with receipt scanning, automatic categorization, and budget management. Simplify your financial tracking with cutting-edge technology." />
        <meta name="keywords" content="expense tracker, receipt scanning, budget management, AI categorization, tax preparation" />
      </Helmet>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Simplify your financial tracking with our AI-powered expense tracker. 
            Smart receipt scanning, automatic categorization, and intelligent budget management.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Powerful AI-driven expense management capabilities
            </p>
          </div>

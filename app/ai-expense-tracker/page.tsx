  ...
  return (
    <>
      <SEOHead 
        ...
        description="Intelligent expense tracking and financial management powered by AI technology."
        keywords="AI expense tracker, financial management, expense tracking, AI finance"
      />

...
import { CreditCard, Camera, BarChart, Shield, Users, Zap, Star, ArrowRight, Phone, Mail, MapPin, CheckCircle } from 'lucide-react';
...
const AIExpenseTrackerPage: React.FC = () => {
  const features = [
    {
      ...
      description: 'Automatically scan and extract data from receipts using AI-powered OCR'
    },
    {
      icon: BarChart,
      title: 'Auto-Categorization',
      description: 'Intelligent categorization of expenses based on spending patterns'
    },
    {
      icon: Shield,
      title: 'Tax Preparation',
      description: 'Automated tax preparation with detailed reports and compliance'
    },
    {
      icon: Users,
      title: 'Team Expense Management',
      description: 'Manage team expenses with approval workflows and spending limits'
    },
    {
      icon: Zap,
      title: 'Spending Insights',
      description: 'AI-powered insights into spending patterns and optimization suggestions'
    },
    {
      icon: CreditCard,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <EnhancedSEO
        title="AI Expense Tracker Pro - Smart Expense Management & Tax Preparation"
        ...
        keywords={['AI expense tracker', 'expense management', 'receipt scanning', 'tax preparation', 'spending insights', 'team expenses']}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Smart expense tracking with receipt scanning, automated categorization, and tax preparation. 
              Perfect for businesses and freelancers.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              <div className="flex items-center space-x-2 text-cyan-400">
                <Star className="w-5 h-5 fill-current" />
                <span className="text-lg font-semibold">4.7/5 Rating</span>
              </div>
              <div className="text-gray-300">•</div>
              <div className="text-gray-300">60,000+ users</div>
              <div className="text-gray-300">•</div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Everything you need to manage expenses efficiently and prepare for tax season
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-6">Why Choose AI Expense Tracker Pro?</h2>
              <p className="text-xl text-gray-300">
                Join thousands of professionals who have simplified their expense management
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-slate-900/80 backdrop-blur-sm border border-cyan-400/20 rounded-xl p-8">
                ...
                <div className="mb-6">
                  <div className="text-4xl font-bold text-cyan-400">$29<span className="text-lg text-gray-300">/month</span></div>
                  <div className="text-gray-400 line-through">$49/month</div>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-cyan-100 mb-8">
              Start your free trial today and experience automated expense management.
            </p>

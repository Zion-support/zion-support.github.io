  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>AI Expense Tracker - Zion Tech Group</title><//title><///title><////title></////title>
        <meta;";
          name="description;";
        ...
        <div className="container mx-auto px-4 py-20">"
          <div className="text-center mb-16">"
            <h1 className="text-5xl font-bold text-white mb-6">;";
              AI Expense <span className="text-blue-600">Tracker</span><//span>"
            </h1>"
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"></div><//div><///div><////div>
              {capabilities.map((capability, index) => (
                ...
                >"
                  ...
                  <p className="text-gray-300">{capability.description}</p><//p><///p><////p></////p>
                </div><//div><///div><////div></////div>
              ))}
            </div><//div><///div><////div></////div>
          </div><//div><///div><////div></////div>

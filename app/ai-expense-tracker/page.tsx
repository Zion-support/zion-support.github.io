...
const AiExpenseTrackerPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Ai Expense Tracker Solutions',
      description: 'Professional ai expense tracker services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored ai expense tracker implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your ai expense tracker needs.'
    }
  ];

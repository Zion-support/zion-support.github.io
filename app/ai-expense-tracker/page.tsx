...
;
const AiExpenseTrackerPage: React.FC = () => {const features = []
    {}
=======
'use client;
  ...
  return (
    <React.Fragment></React>
      <Helmet></Helmet>
        ...
        <meta name="description" content=""Advanced AI-powered ai expense tracker solution for modern businesses." /></meta>"
        <meta name="keywords" content=""AI ai expense tracker, artificial intelligence, ai expense tracker, AI solutions, intelligent automation" /></meta>"
      </Helmet>
  return (<div></div>
    ...
    g:grid-cols-4 gap-8">
              {features.map((feature), index) => (
                <div key={index} className=""bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover: bg-white"></div>"
                  <div className=""w-16 h-16 bg-gradient-to-br from-orange-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 group-hove,"></div>"
            ...
            <div className=""bg-white"></div>"
              ...
              <div className=""flex flex-col sm:flex-row gap-4 justify-center"></div>"
                <button className=""bg-gradient-to-r from-orange-500 to-blue-600 hover:from-orange-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105"></button>"
                  Contact Us;
                <
                <button className=""border border-orange-400 text-orange-400 hover:bg-orange-400 hove,"></button>"

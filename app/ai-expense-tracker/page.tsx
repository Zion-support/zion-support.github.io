...
const AiExpenseTrackerPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>AI Expense Tracker - Zion Tech Group | AI & IT Solutions</title>
        <meta name="description" content="Track and manage your expenses efficiently with our AI-powered expense tracking solution." />
        <meta name="keywords" content="aiexpensetrackerpage, AI solutions, IT services, Zion Tech" />
      </Helmet>
        ...
        <section className="relative py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Track and manage your expenses efficiently with our AI-powered expense tracking solution.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-300 max-w-2xl mx-auto">
                Discover the powerful features that make our ai expense tracker solution stand out.
              </p>
            </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Contact us today to learn more about our ai expense tracker solution and how it can benefit your business.
            </p>
            <Link 
              to="/contact" 

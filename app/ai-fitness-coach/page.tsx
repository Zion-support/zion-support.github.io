      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive ai fitness coach solutions designed to meet your business needs.
          </p>
<<<<<<< HEAD
...
export default function AifitnesscoachPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>Ai Fitness Coach - Zion Tech Group</title>
        <meta name="description" content="Professional ai fitness coach services by Zion Tech Group" />
      </Helmet>

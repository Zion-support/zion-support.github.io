...
const AiFitnessCoachPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai fitness coach services and solutions by Zion Tech Group."
      keywords="ai fitness coach, services, solutions, technology, Zion Tech Group"
    >

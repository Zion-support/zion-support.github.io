...
=======
export default function AiFitnessCoachPagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Ai Fitness Coach - Zion Tech Group</title>
        <meta name="description" content="Advanced Ai Fitness Coach solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Ai Fitness Coach solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

...
export const metadata = {
  ...
  description:
    'AI Fitness Coach brings AI-powered intelligence to healthcare workflows, enabling faster diagnostics, better patient outcomes, and streamlined administrati',
  alternates: { canonical: '/ai-fitness-coach' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Fitness Coach brings AI-powered intelligence to healthcare workflows, enabling faster diagnostics, better patient outcomes, and streamlined administrative processes while maintaining strict compliance.',
        iconEmoji: '🏥',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Fitness Coach to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Fitness Coach to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Fitness Coach analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Fitness Coach',
      }}
    />
  );
}

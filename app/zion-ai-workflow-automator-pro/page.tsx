          ...
          <div className="bg-gray-50 rounded-lg p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-gray-600">Create complex workflows using our intuitive drag-and-drop interface.</div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">AI-Powered Decision Making</h3>
                <p className="text-gray-600">Let AI make intelligent decisions based on data patterns and business rules.</div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Integration Capabilities</h3>
                <p className="text-gray-600">Seamlessly integrate with your existing tools and systems.</div>
              <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Scalable Architecture</h3>
                <p className="text-gray-600">Scale your automation as your business grows without performance issues.</div>
        </>
  )
  }

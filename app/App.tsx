...
// Lazy load pages for better performanceconst HomePage = lazy(() => import('./page'));
...
// AI Servicesconst AiServicesPage = lazy(() => import('./ai-services/page'));
...
// IT Servicesconst ItServicesPage = lazy(() => import('./it-services/page'));
const ItInfrastructurePage = lazy(() => import('./it-infrastructure/page'));
const ItSupportPage = lazy(() => import('./it-support/page'));
const CloudInfrastructurePage = lazy(() => import('./cloud-infrastructure/page'));
const CybersecurityPage = lazy(() => import('./cybersecurity/page'));
// Emerging Technologiesconst BlockchainPage = lazy(() => import('./blockchain/page'));
...
// Support Pagesconst DocsPage = lazy(() => import('./docs/page'));

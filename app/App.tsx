...
const AIAnalyticsDashboardProPage = lazy(
  () => import("./ai-analytics-dashboard-pro/page"),
);
const AICybersecuritySuiteProPage = lazy(
  () => import("./ai-cybersecurity-suite-pro/page"),
);
const AIContentGenerationProPage = lazy(
  () => import("./ai-content-generation-pro/page"),
);
const AICustomerSupportChatbotPage = lazy(
  () => import("./ai-customer-support-chatbot/page"),
);
const AICodeAssistantProPage = lazy(
  () => import("./ai-code-assistant-pro/page"),
);
const AIBusinessIntelligenceProPage = lazy(
  () => import("./ai-business-intelligence-pro/page"),
);
const AIAutomationPlatformPage = lazy(
  () => import("./ai-automation-platform/page"),
);
const AIDataAnalyticsProPage = lazy(
  () => import("./ai-data-analytics-pro/page"),
);
const AIMarketingAutomationPage = lazy(
  () => import("./ai-marketing-automation/page"),
);
const AIHRRecruitmentProPage = lazy(
  () => import("./ai-hr-recruitment-pro/page"),
);
const AIFinancialAnalysisPage = lazy(
  () => import("./ai-financial-analysis/page"),
);
const AISupplyChainOptimizerPage = lazy(
  () => import("./ai-supply-chain-optimizer/page"),
);
const AIVoiceAssistantProPage = lazy(
  () => import("./ai-voice-assistant-pro/page"),
);
const AIImageRecognitionProPage = lazy(
  () => import("./ai-image-recognition-pro/page"),
);
const AIPredictiveMaintenancePage = lazy(
  () => import("./ai-predictive-maintenance/page"),
);
const AISentimentAnalysisProPage = lazy(
  () => import("./ai-sentiment-analysis-pro/page"),
);
const AIRecommendationEnginePage = lazy(
  () => import("./ai-recommendation-engine/page"),
);
const AIFraudDetectionProPage = lazy(
  () => import("./ai-fraud-detection-pro/page"),
);
const AILanguageTranslationPage = lazy(
  () => import("./ai-language-translation/page"),
);
const AIChatbotEnterprisePage = lazy(
...
const AITimeSeriesForecastingPage = lazy(
  () => import("./ai-time-series-forecasting/page"),
);
...
const DataCenterServicesPage = lazy(
  () => import("./data-center-services/page"),
);
...
const ZionSecurityShieldPage = lazy(
  () => import("./zion-security-shield/page"),
);
const ZionCloudVaultPage = lazy(() => import("./zion-cloud-vault/page"));
const ZionAIInventoryManagerPage = lazy(
  () => import("./zion-ai-inventory-manager/page"),
);
const ZionHRAssistantProPage = lazy(
  () => import("./zion-hr-assistant-pro/page"),
);
const ZionAIAccountingSuitePage = lazy(
  () => import("./zion-ai-accounting-suite/page"),
);
const ZionEcommerceOptimizerPage = lazy(
  () => import("./zion-ecommerce-optimizer/page"),
);
const ZionAICustomerInsightsPage = lazy(
  () => import("./zion-ai-customer-insights/page"),
);
const ZionAILeadScoringPage = lazy(() => import("./zion-ai-lead-scoring/page"));
const ZionAIDocumentProcessorPage = lazy(
  () => import("./zion-ai-document-processor/page"),
);
const ZionAISocialListenerPage = lazy(
  () => import("./zion-ai-social-listener/page"),
);
const ZionAIEmailOptimizerPage = lazy(
  () => import("./zion-ai-email-optimizer/page"),
);
const ZionAIMeetingAssistantPage = lazy(
  () => import("./zion-ai-meeting-assistant/page"),
);
const ZionAIExpenseTrackerPage = lazy(
  () => import("./zion-ai-expense-tracker/page"),
);
const ZionAISurveyBuilderPage = lazy(
  () => import("./zion-ai-survey-builder/page"),
);
const ZionAIChatbotBuilderPage = lazy(
  () => import("./zion-ai-chatbot-builder/page"),
);
const ZionAIWorkflowAutomationPage = lazy(
  () => import("./zion-ai-workflow-automation/page"),
);
const ZionAISEOOptimizerPage = lazy(
  () => import("./zion-ai-seo-optimizer/page"),
);
const ZionAIDataWarehousePage = lazy(
  () => import("./zion-ai-data-warehouse/page"),
);
const ZionAIMobileAppBuilderPage = lazy(
  () => import("./zion-ai-mobile-app-builder/page"),
);
const ZionAIAPIManagerPage = lazy(() => import("./zion-ai-api-manager/page"));
const ZionAITestingAutomationPage = lazy(
  () => import("./zion-ai-testing-automation/page"),
);
        ...
        <Suspense fallback={<div>Loading...</div>}>
          <Routes>
            ...
            <Route
              ...
              element={<AIAnalyticsDashboardProPage />}
            />
            <Route
              path="/ai-cybersecurity-suite-pro"
              element={<AICybersecuritySuiteProPage />}
            />
            <Route
            ...
            <Route
              ...
              element={<AICustomerSupportChatbotPage />}
            />
            <Route
              path="/ai-code-assistant-pro"
              element={<AICodeAssistantProPage />}
            />
            <Route
            ...
            />
            <Route
              path="/ai-automation-platform"
              element={<AIAutomationPlatformPage />}
            />
            <Route
              path="/ai-data-analytics-pro"
              element={<AIDataAnalyticsProPage />}
            />
            <Route
              path="/ai-marketing-automation"
              element={<AIMarketingAutomationPage />}
            />
            <Route
              path="/ai-hr-recruitment-pro"
              element={<AIHRRecruitmentProPage />}
            />
            <Route
              path="/ai-financial-analysis"
              element={<AIFinancialAnalysisPage />}
            />
            <Route
            ...
            />
            <Route
              path="/ai-sentiment-analysis-pro"
              element={<AISentimentAnalysisProPage />}
            />
            <Route
              path="/ai-recommendation-engine"
              element={<AIRecommendationEnginePage />}
            />
            <Route
            ...
            />
            <Route
              path="/ai-language-translation"
              element={<AILanguageTranslationPage />}
            />
            <Route
              path="/ai-chatbot-enterprise"
              element={<AIChatbotEnterprisePage />}
            />
            <Route
              path="/ai-data-mining-pro"
              element={<AIDataMiningProPage />}
            />
            <Route
            ...
            />
            <Route
              path="/ai-time-series-forecasting"
              element={<AITimeSeriesForecastingPage />}
            />
            <Route
              path="/ai-nlp-text-analysis"
              element={<AINLPTextAnalysisPage />}
            />
            ...
            <Route
              ...
              element={<CybersecurityAuditPage />}
            />
            <Route
              path="/data-center-services"
              element={<DataCenterServicesPage />}
            />
            ...
            />
            <Route
              path="/zion-hr-assistant-pro"
              element={<ZionHRAssistantProPage />}
            />
            <Route
              path="/zion-ai-accounting-suite"
              element={<ZionAIAccountingSuitePage />}
            />
            <Route
              path="/zion-ecommerce-optimizer"
              element={<ZionEcommerceOptimizerPage />}
            />
            <Route
            ...
            />
            <Route
              path="/zion-ai-social-listener"
              element={<ZionAISocialListenerPage />}
            />
            <Route
            ...
            />
            <Route
              path="/zion-ai-survey-builder"
              element={<ZionAISurveyBuilderPage />}
            />
            <Route
            ...
            />
            <Route
              path="/zion-ai-seo-optimizer"
              element={<ZionAISEOOptimizerPage />}
            />
            <Route
              path="/zion-ai-data-warehouse"
              element={<ZionAIDataWarehousePage />}
            />
            <Route
              path="/zion-ai-mobile-app-builder"
              element={<ZionAIMobileAppBuilderPage />}
            />
            <Route
              path="/zion-ai-api-manager"
              element={<ZionAIAPIManagerPage />}
            />
            <Route
              path="/zion-ai-testing-automation"
              element={<ZionAITestingAutomationPage />}
            />

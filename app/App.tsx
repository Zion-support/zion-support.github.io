...
const ZionAIContentGeneratorPage = lazy(() => import('./zion-ai-content-generator/page'));
const ZionAIDataAnalyzerPage = lazy(() => import('./zion-ai-data-analyzer/page'));
const ZionAICustomerSupportPage = lazy(() => import('./zion-ai-customer-support/page'));
const ZionAISocialMediaManagerPage = lazy(() => import('./zion-ai-social-media-manager/page'));
const ZionAIEmailMarketingPage = lazy(() => import('./zion-ai-email-marketing/page'));
const ZionAISalesAssistantPage = lazy(() => import('./zion-ai-sales-assistant/page'));
const ZionAITaskAutomatorPage = lazy(() => import('./zion-ai-task-automator/page'));
const ZionAICodeGeneratorPage = lazy(() => import('./zion-ai-code-generator/page'));
const ZionAIDesignAssistantPage = lazy(() => import('./zion-ai-design-assistant/page'));
const ZionAIMarketingAutomationPage = lazy(() => import('./zion-ai-marketing-automation/page'));
const ZionAICRMIntegrationPage = lazy(() => import('./zion-ai-crm-integration/page'));
const ZionAIAnalyticsDashboardPage = lazy(() => import('./zion-ai-analytics-dashboard/page'));
        ...
        <ErrorBoundary>
          ...
          <Suspense fallback={<LoadingSpinner />}>
            <Routes>
              ...
              <Route path="/zion-ai-data-analyzer" element={<ZionAIDataAnalyzerPage />} />
              ...
              <Route path="/zion-ai-sales-assistant" element={<ZionAISalesAssistantPage />} />
              <Route path="/zion-ai-task-automator" element={<ZionAITaskAutomatorPage />} />
              <Route path="/zion-ai-code-generator" element={<ZionAICodeGeneratorPage />} />
              <Route path="/zion-ai-design-assistant" element={<ZionAIDesignAssistantPage />} />
              <Route path="/zion-ai-marketing-automation" element={<ZionAIMarketingAutomationPage />} />
              <Route path="/zion-ai-crm-integration" element={<ZionAICRMIntegrationPage />} />
              <Route path="/zion-ai-analytics-dashboard" element={<ZionAIAnalyticsDashboardPage />} />

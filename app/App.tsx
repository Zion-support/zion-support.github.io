...
function App() {
  return (
    <ErrorBoundary></ErrorBoundary><HelmetProvider></HelmetProvider></>
        <><BrowserRouter></BrowserRouter>
          <><div className="App" ></div><PerformanceMonitor /></></PerformanceMonitor><AccessibilityEnhancer /></AccessibilityEnhancer></>

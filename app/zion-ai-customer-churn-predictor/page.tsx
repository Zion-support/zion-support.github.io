  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Predict customer churn with our advanced AI-powered solution. Identify at-risk customers and take proactive retention actions." />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Predict customer churn with our advanced AI-powered solution. Identify at-risk customers and take proactive retention actions.
            </p>
          </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">Advanced ML Models</h3>
                    <p className="text-gray-600">State-of-the-art machine learning algorithms with 90%+ accuracy</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-red-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Get personalized retention strategies for each customer</p>
                  </div>
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Connect your customer data from multiple sources</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Our AI learns from your historical customer data</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Get churn probability scores for each customer</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-8 h-8 bg-red-600 text-white rounded-full flex items-center justify-center text-sm font-semibold mr-4">4</div>
                  <div>
                    <h3 className="font-medium text-gray-900">Action Alerts</h3>
                    <p className="text-gray-600">Receive alerts and recommendations for at-risk customers</p>
                  </div>
                </div>
              </div>
            </div>

...
import { TrendingDown, Brain, BarChart3, Zap, ArrowRight, CheckCircle, Star, Users, Award, Clock, Target } from "lucide-react";
        ...
        <ResponsiveContainer>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              ...
              with comprehensive behavioral analysis and real-time insights.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Transform your customer retention strategy with AI-powered insights that help you keep your most valuable customers.
            </p>
          </div>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Predict and prevent customer churn with our advanced AI-powered churn prediction solution. Identify at-risk customers and take proactive action." />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Predict and prevent customer churn with our advanced AI-powered churn prediction solution. Identify at-risk customers and take proactive action.
            </p>
          </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Identify customers at risk of churning before they leave with 90%+ accuracy</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-red-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Analyze customer behavior patterns, engagement metrics, and usage data</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-red-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Get personalized retention strategies for each at-risk customer</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-red-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Receive instant notifications when customers show churn risk indicators</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-red-50 p-4 rounded-lg">
                  ...
                  <p className="text-red-700">Decrease customer churn by up to 40% with proactive intervention</p>
                </div>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <p className="text-green-700">Reduce acquisition costs by focusing on retention</p>
                </div>
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-purple-900 mb-2">Improve Satisfaction</h3>
                  <p className="text-purple-700">Address customer issues before they become problems</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8 text-center">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Ready to Predict and Prevent Churn?</h2>

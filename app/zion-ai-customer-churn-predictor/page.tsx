  ...
  return (
    <>
      <Helmet>
        ...
        <meta name='description' content='Predictive analytics tool that identifies customers at risk of churning.' />
        <link rel='canonical' href='https://ziontechgroup.com/zion-ai-customer-churn-predictor' />
      </Helmet>
      <SEOOptimizer title='Zion AI Customer Churn Predictor | Zion Tech Group' description='Predictive analytics tool that identifies customers at risk of churning.' />
          ...
          <div className='max-w-7xl mx-auto'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed'>
                Predictive analytics tool that identifies customers at risk of churning.
              </p>

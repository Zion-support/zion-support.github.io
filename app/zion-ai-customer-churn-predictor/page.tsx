  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Predict and prevent customer churn with our advanced AI-powered customer retention solution." />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Predict and prevent customer churn with our advanced AI-powered customer retention solution.
            </p>
          </div>
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Analyze customer behavior patterns to predict churn likelihood</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-red-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="bg-red-50 p-4 rounded-lg">
                  ...
                  <p className="text-red-700">Decrease customer churn by up to 40% with proactive interventions</p>
                </div>
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-blue-900 mb-2">Increase Revenue</h3>
                  <p className="text-blue-700">Retain high-value customers and increase lifetime value</p>
                </div>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Predict and prevent customer churn with our advanced AI-powered customer churn prediction solution." />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Predict and prevent customer churn with our advanced AI-powered customer churn prediction solution.
            </p>
          </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Identify at-risk customers before they churn with 90%+ accuracy</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-red-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Analyze customer behavior patterns to identify churn indicators</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-6 h-6 bg-red-100 rounded-full flex items-center justify-center mr-3 mt-0.5">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Monitor customer health scores in real-time with automated alerts</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <p className="text-green-700">Reduce customer acquisition costs by focusing on retention</p>
                </div>
          ...
          <div className="bg-gray-50 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">Start retaining more customers with our AI-powered churn prediction platform.</p>

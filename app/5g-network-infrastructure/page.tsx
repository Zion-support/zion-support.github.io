...
const FiveGNetworkInfrastructurePage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>5g Network Infrastructure - Robust 5G network infrastructure design and implementation services | Zion Tech Group</title>
        <meta name="description" content="Robust 5G network infrastructure design and implementation services." />
        <meta name="keywords" content="5G infrastructure, network design, telecommunications, network architecture" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Robust 5G network infrastructure design and implementation services.
            </p>
          </div>

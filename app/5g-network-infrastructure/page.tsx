...
const PageFiveGNetworkInfrastructurePage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>5G Network Infrastructure - Zion Tech Group</title>
        <meta name="description" content="Advanced 5G network infrastructure solutions for enterprise and carrier deployments." />
        <meta name="keywords" content="5G network, network infrastructure, carrier solutions, enterprise 5G" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Advanced 5G network infrastructure solutions for enterprise and carrier deployments.
            </p>
          </div>
...
export default PageFiveGNetworkInfrastructurePage;
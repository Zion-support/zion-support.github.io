        ...
        <main className="container mx-auto px-4 py-16 pt-24">{/* Hero Section */}</main>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="cyber-card p-6 text-center">
                <div className="text-4xl font-bold text-green-400 mb-4">30%<h3 className="text-xl font-bold text-white mb-2">Cost Reduction<p className="text-gray-300">Average 30% reduction in project costs</p>
              </div>

              <div className="cyber-card p-6 text-center">
                <div className="text-4xl font-bold text-pink-400 mb-4">95%<h3 className="text-xl font-bold text-white mb-2">On-Time Delivery<p className="text-gray-300">95% of projects delivered on time</p>
              </div>

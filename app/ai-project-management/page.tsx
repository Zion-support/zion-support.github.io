...
const AiProjectManagementPage: React.FC = () => {
  ...
  const stats = [
    ...
    { number: "60%", label: "Better Resource Use", icon: <Target className="w-6 h-6" /> },
    { number: "85%", label: "On-Time Delivery", icon: <TrendingUp className="w-6 h-6" /> },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Revolutionary AI project management platform. Deliver projects 40% faster, improve resource utilization by 60%, and achieve 85% on-time delivery with intelligent automation." />
        <meta name="keywords" content="AI project management, task automation, team collaboration, resource planning, project analytics" />
      </Helmet>
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                Transform your project management with AI-powered planning, 
                intelligent resource allocation, and automated tracking. Deliver projects 40% faster 
                and improve resource utilization by 60% with our cutting-edge platform.
              </p>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the perfect plan for your project management needs. All plans include our AI-powered features.
              </p>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-cyan-600 to-purple-600">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
              Join thousands of teams already using AI to revolutionize their project management. 

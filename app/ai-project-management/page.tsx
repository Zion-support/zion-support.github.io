  ...
  const features = [
    {
      ...
      description: 'AI-powered task automation and workflow optimization for better project efficiency.',
      icon: Zap,
      benefits: [
        'Workflow automation',
        'Task scheduling',
    ...
    },
    {
      ...
      description: 'Advanced predictive analytics for project planning and risk management.',
      icon: Brain,
      benefits: [
        'Risk prediction',
    ...
    },
    {
      ...
      description: 'Intelligent team collaboration tools with AI-powered insights.',
      icon: Users,
      benefits: [
        'Team coordination',
    ...
    },
    {
      ...
      description: 'Comprehensive project analytics and reporting for better decision making.',
      icon: BarChart3,
      benefits: [
        'Performance metrics',
        'Progress tracking',
  ...
  const useCases = [
    {
      ...
      description: 'AI-powered project management for software development teams.',
      icon: Target
    },
    {
      title: 'Marketing Projects',
      description: 'Comprehensive project management for marketing campaigns and initiatives.',
      icon: Brain
    },
    {
      title: 'Construction',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="AI-powered project management solutions that automate tasks, provide predictive analytics, and enhance team collaboration. Advanced AI technology for better project success." />
        <meta name="keywords" content="AI project management, project automation, predictive analytics, team collaboration, project analytics" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
              Streamline project management with AI-powered solutions. Task automation, predictive analytics, 
              and team collaboration for better project success and efficiency.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our AI-powered project management provides comprehensive tools for project success.
              </p>
            </div>
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-orange-900/20 to-red-900/20">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Perfect for teams and organizations that need to manage complex projects.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-12">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Join leading teams who trust our AI Project Management solutions.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">

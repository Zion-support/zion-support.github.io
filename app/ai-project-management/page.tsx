        ...
        <main className="container mx-auto px-4 py-16 pt-24">,
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></section>
              <div className="cyber-card p-6 energy-pulse"></div>
                <div className="text-4xl mb-4 text-center">🔮</div><h3 className="text-xl font-bold text-white mb-4 text-center">Predictive Analytics</h3><p className="text-gray-300 text-center">AI predicts project risks, delays, and resource needs with 90% accuracy to keep projects on track.</p>
                </p>
              </div>

              <div className="cyber-card p-6 energy-pulse"></div>
                <div className="text-4xl mb-4 text-center">⚡</div><h3 className="text-xl font-bold text-white mb-4 text-center">Smart Task Allocation</h3><p className="text-gray-300 text-center">Automatically assign tasks to the right team members based on skills, workload, and availability.</p>
                </p>
              </div>

              <div className="cyber-card p-6 energy-pulse"></div>
                <div className="text-4xl mb-4 text-center">📊</div><h3 className="text-xl font-bold text-white mb-4 text-center">Real-time Insights</h3><p className="text-gray-300 text-center">Get instant visibility into project health, team performance, and budget utilization.</p>
                </p>
              </div>

              <div className="cyber-card p-6 energy-pulse"></div>
                <div className="text-4xl mb-4 text-center">🎯</div><h3 className="text-xl font-bold text-white mb-4 text-center">Resource Optimization</h3><p className="text-gray-300 text-center">AI optimizes resource allocation to maximize efficiency and minimize project costs.</p>
                </p>
              </div>

              <div className="cyber-card p-6 energy-pulse"></div>
                <div className="text-4xl mb-4 text-center">🚨</div><h3 className="text-xl font-bold text-white mb-4 text-center">Risk Management</h3><p className="text-gray-300 text-center">Proactive risk identification and mitigation strategies powered by machine learning.</p>
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="text-center mb-16">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">
              AI Project Management Solutions</h1>
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8"></section>
              <div className="cyber-card p-8 text-center"></div>
                ...
                <ul className="text-gray-300 space-y-3 mb-8">
                  <li>Up to 10 team members<li>5 active projects</li>
                  <li>Basic AI insights<li>Standard integrations<li>Email support<a href="/contact" className="cyber-button w-full">Get Started</a>
              </div>

              <div className="cyber-card p-8 text-center border-2 border-cyan-400"></div>
                <h3 className="text-2xl font-bold text-white mb-4">Professional</h3>
                <div className="text-4xl font-bold text-cyan-400 mb-6">$499</div><span className="text-lg">/month</span>
                <ul className="text-gray-300 space-y-3 mb-8">
                  <li>Up to 50 team members<li>Unlimited projects</li>
                  <li>Advanced AI analytics<li>Custom integrations</li>
                  <li>Priority support<li>Resource optimization<a href="/contact" className="cyber-button w-full">Get Started</a>
              </div>
              ...
              <div className="cyber-card p-8 text-center"></div>
                ...
                <ul className="text-gray-300 space-y-3 mb-8">
                  <li>Unlimited team members<li>Unlimited projects</li>
                  <li>Full AI suite<li>White-label solution</li>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8"></div>
              <div className="cyber-card p-6 text-center"></div>
                <div className="text-4xl font-bold text-cyan-400 mb-4">40%<h3 className="text-xl font-bold text-white mb-2">Faster Delivery<p className="text-gray-300">Projects completed 40% faster with AI optimization</p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></section>
              <div className="cyber-card p-6 text-center"></div>
                <div className="text-4xl font-bold text-cyan-400 mb-4">40%</div><h3 className="text-xl font-bold text-white mb-2">Faster Delivery</h3><p className="text-gray-300">Projects completed 40% faster with AI optimization</p>
              </div>

              <div className="cyber-card p-6 text-center"></div>
                <div className="text-4xl font-bold text-green-400 mb-4">30%</div><h3 className="text-xl font-bold text-white mb-2">Cost Reduction</h3><p className="text-gray-300">Average 30% reduction in project costs</p>
              </div>

              <div className="cyber-card p-6 text-center"></div>
                <div className="text-4xl font-bold text-pink-400 mb-4">95%</div><h3 className="text-xl font-bold text-white mb-2">On-Time Delivery</h3><p className="text-gray-300">95% of projects delivered on time</p>
              </div>

              <div className="cyber-card p-6 text-center"></div>
                <div className="text-4xl font-bold text-yellow-400 mb-4">85%<h3 className="text-xl font-bold text-white mb-2">Team Productivity<p className="text-gray-300">85% increase in team productivity</p>
              <div className="cyber-card p-6 text-center"></div>

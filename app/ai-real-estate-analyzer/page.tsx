          ...
          <div className="bg-slate-800 rounded-lg p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-300">Accurate property valuations using AI and market data.</div>
              
              <div className="text-center">
                <div className="w-16 h-16 bg-cyan-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">📊</div>
                <h3 className="text-xl font-semibold mb-3 text-cyan-400">Market Analysis</h3>
                <p className="text-gray-300">Comprehensive market trends and investment insights.</div>
              
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">💰</div>
                <h3 className="text-xl font-semibold mb-3 text-blue-400">ROI Calculator</h3>
                <p className="text-gray-300">Calculate potential returns on real estate investments.</div>

...
export default function AiEcommerceAssistantPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>Ai Ecommerce Assistant - Zion Tech Group | AI Solutions</title>
        <meta name="description" content="Professional ai ecommerce assistant services and solutions powered by advanced AI technology." />
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Professional ai ecommerce assistant services and solutions powered by advanced AI technology.
          </p>
        </div>

...
const AiEcommerceAssistantPage: React.FC = () => {
  ...
  const features = ['AI-Powered Product Recommendations', 'Automated Inventory Management', 'Smart Pricing Optimization', 'Customer Behavior Analysis', 'Automated Marketing Campaigns', 'Real-time Analytics Dashboard']

  const benefits = ['Increase sales by 35%', 'Reduce cart abandonment by 50%', 'Optimize pricing automatically', 'Personalize customer experience', 'Automate marketing tasks', 'Gain valuable insights']

  const pricing = [{
      plan: 'Starter', price: '$249/month', features: ['Up to 1, 000 products', 'Basic AI features', 'Email support', 'Standard analytics'],
      popular: false
            ...
            <div className="text-center mb-16">
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-2xl flex items-center justify-center">
                  <ShoppingCart className="w-8 h-8 text-white" /></ShoppingCart>
                </div>
              </div>

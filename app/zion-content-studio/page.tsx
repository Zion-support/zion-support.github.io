...
export const metadata: Metadata = {
  title: 'Zion Content Studio | Zion Tech Group',
  description:
    'Zion Content Studio empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Tur',
  alternates: { canonical: '/zion-content-studio' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Content Studio empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Content Studio',
      }}
    />
  );
}

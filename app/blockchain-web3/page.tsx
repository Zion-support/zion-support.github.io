...
const Blockchain Web 3 Page: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Blockchain web 3 - Zion Tech Group</title>
        <meta name="description" content="ProfessionalBlockchain web 3 solutions and services" />
        <meta name="keywords" content="blockchain,web 3" />
      </Helmet>
      <div className="min-h-screenbg-gradient-to-brfrom-slate-9 00 via-purple-9 0 0 to-slate-9 0 0">
        <div className="container mx-autopx-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xlfont-bold text-white mb-8">Blockchain web 3</h1>

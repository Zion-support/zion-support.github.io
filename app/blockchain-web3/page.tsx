...
=======
export default function BlockchainWeb3PagePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        <title>Blockchain Web3 - Zion Tech Group</title>
        <meta name="description" content="Advanced Blockchain Web3 solutions by Zion Tech Group for modern businesses." />
      </Helmet>
...
=======
            Advanced Blockchain Web3 solutions by Zion Tech Group for modern businesses.
          </p>
        </div>

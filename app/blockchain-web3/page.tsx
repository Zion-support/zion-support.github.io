...
import { Shield, Zap, Globe, Lock, ArrowRight, Database } from 'lucide-react';
    ...
    <Layout>{/* Hero Section */}</Layout>
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900"></section>
        <div className="container mx-auto px-4 text-center">
          <div className="mb-4">
            <span className="inline-block px-4 py-2 bg-cyan-500/20 text-cyan-300 rounded-full text-sm font-medium">Blockchain & Web3 Solutions</span>
            </span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">Blockchain & Web3 Development</h1>
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Build the future of decentralized applications with our expert blockchain and Web3 development services. 
            From smart contracts to full-stack DApps, we bring your Web3 vision to life.</p>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            <Link to="#demo" className="bg-cyan-500 text-white px-8 py-4 rounded-lg font-semibold hover:bg-cyan-600 transition-colors">Start Your Project</Link>
            </Link>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center px-4">className="max-w-6xl mx-auto text-center"></div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">Blockchain & Web3 Solutions</h1>
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Build the future of decentralized applications with our comprehensive blockchain,
development services and Web3 integration expertise.</p>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            <button className="bg-gradient-to-r from-purple-500 to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-purple-600 hover:to-cyan-700 transition-all">Start Your Project</button>
            </button>
            <Link to="#demo" className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white/10 transition-colors">View Portfolio</Link>
            </Link>
          </div>
        </div>
      <section className="bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 min-h-screen flex items-center"></section>
        <div className="container mx-auto px-4 py-20">className="text-center"></div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">Blockchain & Web3 Solutions</h1>
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Transform your business with cutting-edge blockchain technology and Web3 solutions. 
              Build secure, decentralized applications that revolutionize how you do business.</p>
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
              <Link;
to="/contact" 
...
to="#demo" 
      ...
      <section className="py-20 bg-gray-900"></section>
        <div className="container mx-auto px-4">className="text-center mb-16"></div>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Cutting-Edge Blockchain Solutions</h2>
            </h2>
            <p className="text-gray-300 text-lg">Leverage the power of blockchain technology to build secure, transparent, and decentralized applications,
Blockchain Technology Features</p>
            </h2>
            <p className="text-gray-300 text-lg">Leverage the power of blockchain for secure, transparent, and efficient solutions</p>
            </p>
          </div>
      ...
      <div className="py-20 bg-gray-900">className="max-w-6xl mx-auto px-4"></div>
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 text-center">Comprehensive Blockchain Services</h2>
          </h2>
          <p className="text-gray-300 text-center mb-12">From smart contracts to full dApp development, we cover all aspects of blockchain technology</p>
          </p>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">{features.map((feature, index) => (</div>
              <div key={index} className="bg-gray-800 p-6 rounded-lg border border-gray-700 hover:border-purple-400 transition-colors">key={index} className="bg-gray-800 p-6 rounded-lg"></div>
      ...
      <section className="py-20 bg-black"></section>
        <div className="container mx-auto px-4">className="text-center mb-16"></div>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Comprehensive Blockchain Services</h2>
            </h2>
            <p className="text-gray-300 text-lg">End-to-end blockchain and Web3 development solutions</p>
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">{services.map((category, index) => (</div>
      ...
      <section className="py-20 bg-gray-900"></section>
        <div className="container mx-auto px-4">className="text-center mb-16"></div>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Blockchain Development Packages</h2>
            </h2>
            <p className="text-gray-300 text-lg">Choose the package that fits your blockchain project needs</p>
            </p>
          </div>
      ...
      <div className="py-20 bg-slate-900">className="max-w-6xl mx-auto px-4"></div>
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 text-center">Transparent Project Pricing</h2>
          </h2>
          <p className="text-gray-300 text-center mb-12">Choose the package that fits your blockchain project needs</p>
          </p>
          <div className="grid md:grid-cols-3 gap-8">{pricingPlans.map((plan, index) => (</div>
              <div key={index} className={`bg-gray-800 p-8 rounded-lg border-2 relative ${plan.popular ? 'border-purple-400' : 'border-gray-700'}`}>{plan.popular && (</div>
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                    <span className="bg-purple-400 text-black px-4 py-1 rounded-full text-sm font-semibold">Most Popular</span>
                    </span>
                  </div>
                )}
                ...
                <ul className="space-y-3 mb-8">{plan.features.map((feature, featureIndex) => (</ul>
                    <li key={featureIndex} className="flex items-center text-gray-300"></li>
                      <Shield className="w-5 h-5 text-cyan-400 mr-3" />className="w-5 h-5 text-purple-400 mr-3" /></Shield>
      </section>

      {/* Services Section */}
      <section className="py-20 bg-gray-800"></section>
        <div className="container mx-auto px-4">className="text-center mb-16"></div>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Our Blockchain Services</h2>
            </h2>
            <p className="text-gray-300 text-lg">Comprehensive blockchain development and Web3 integration services</p>
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">{services.map((service, index) => (</div>
              <div key={index} className="bg-gray-900 p-8 rounded-lg"></div>
                <h3 className="text-2xl font-bold text-white mb-4">{service.title}</h3>
                <p className="text-gray-300 mb-6">{service.description}</p>
                <ul className="space-y-3">{service.features.map((feature, featureIndex) => (</ul>
                    <li key={featureIndex} className="flex items-center text-gray-300"></li>
                      <ArrowRight className="w-4 h-4 text-cyan-400 mr-3" />{feature}</ArrowRight>
                    </li>
                  ))}
                </ul>
                <Link;
...
to="/contact"
      ...
      <section className="py-20 bg-black"></section>
        <div className="container mx-auto px-4">className="text-center mb-16"></div>
            ...
            <p className="text-gray-300 text-lg">Join successful blockchain projects powered by our expertise</p>
            </p>
          </div>
      </div>
      ...
      {/* Testimonials */}
      <div className="py-20 bg-gray-900">className="max-w-6xl mx-auto px-4"></div>
          <h2 className="text-3xl font-bold text-white mb-4 text-center">Trusted by Blockchain Innovators</h2>
          </h2>
          <p className="text-gray-300 text-center mb-12">See how companies are building the future with our blockchain solutions</p>
          </p>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-blue-600"></section>
        <div className="container mx-auto px-4 text-center"></div>
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Ready to Build the Future?</h2>
          </h2>
          <p className="text-xl text-cyan-100 mb-8 max-w-2xl mx-auto">Start your blockchain project today and join the Web3 revolution with our expert development team.</p>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            <Link to="#contact" className="bg-white text-cyan-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors">Start Your Project</Link>
            </Link>
            <Link to="#demo" className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white/10 transition-colors">View Portfolio</Link>
            </Link>
          </div>
      ...
      <div className="py-20 bg-slate-900">className="max-w-4xl mx-auto text-center px-4"></div>
          ...
          <p className="text-gray-300 mb-8">Join the blockchain revolution with our expert development team</p>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            <Link to="/contact" className="bg-gradient-to-r from-purple-500 to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-purple-600 hover:to-cyan-700 transition-all duration-300">Start Your Project</Link>
            </Link>
            <Link to="/about" className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white/10 transition-colors"></Link>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-purple-700"></section>
        <div className="container mx-auto px-4 text-center"></div>
          ...
          <p className="text-gray-200 text-lg mb-8">Join the blockchain revolution with our expert development team</p>
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            <Link;
to="/contact" 

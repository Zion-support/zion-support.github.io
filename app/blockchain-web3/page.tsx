      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xl font-bold text-white mb-8">Blockchain web3</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional Blockchain web3 solutions and services</p>
...
=======
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Blockchain Web-3Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Blockchain web-3 - Zion Tech Group</title> <meta name="description"content="Professional Blockchain web 3 solutions and services" /> <meta name="keywords"content="blockchain, web 3" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Blockchain web-3</h1> <p className="text xl text gray-300 mb-8"> Professional Blockchain web-3 solutions and services </p> 
...
export default Blockchain Web-3 Page;

...
const BlockchainWeb3Page: React.FC = () => {
  ...
  return (
    <React> </React><Helmet> </Helmet><title>Blockchain & Web3 Solutions - Zion Tech Group</title>
        <meta> </meta></Helmet>
      <div> </div><div> </div><div> </div><h1>Blockchain & </h1><span className="text-cyan-400">Web3</span>
            </h1>
            <p>Advanced blockchain and Web3 solutions for modern businesses. Smart contracts, DeFi, NFTs, and more.
            </p></p>
          </div>
          <div>{features.map((feature, index) => (
              </div><div> </div><div> </div><div> </div><feature> </feature></div>
                  <div> </div><h3 className="text-2xl font-bold text-white mb-2">{feature.title}</h3>
                    <p className="text-gray-300 mb-4">{feature.description}</p>
                  </div>
                </div>
                <ul>{feature.benefits.map((benefit, benefitIndex) => (
                    </ul><li> </li><CheckCircle>import React from 'react'
import { Helmet } from 'react-helmet-async'
import { CheckCircle, ArrowRight, Phone, Mail, MapPin, Zap, Shield, Brain, Globe } from 'lucide-react'
const BlockchainWeb3Page: React.FC = () => {
  const features = [
  ...
  return (
      ...
      <Helmet> </Helmet><title>Blockchain & Web3 Solutions - Zion Tech Group</title>
        <meta> </meta></Helmet>
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900"></div>
        <div className="container mx-auto px-4 py-16"></div>
          <div className="text-center mb-16"></div>
            <h1>Blockchain & </h1><span className="text-cyan-400">Web3</span>
            </h1>
            <p>Advanced blockchain and Web3 solutions for modern businesses. Smart contracts, DeFi, NFTs, and more.
            </p></p>
          </div>

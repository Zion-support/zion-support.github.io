    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900">{/* Hero Section */}</div>
        <div className="relative overflow-hidden">
          </div><div className="absolute inset-0 bg-gradient-to-r from-indigo-500/20 to-purple-500/20"></div><div className="relative container mx-auto px-4 py-24">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">Build the future of decentralized applications with our expert blockchain development team.</p>
                Smart contracts, DeFi platforms, NFT marketplaces, and enterprise blockchain solutions.<div className="flex flex-wrap justify-center gap-8 mt-12">{stats.map((stat, index) => (</div>
                  <div key={index} className="text-center">
                    </div><div className="flex items-center justify-center w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full mx-auto mb-4">
        ...
        {/* Services Section */}<div className="container mx-auto px-4 py-20">
          </div><div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Blockchain Development Services</h2><p className="text-xl text-gray-300 max-w-3xl mx-auto">Comprehensive blockchain solutions from smart contracts to complete DeFi platforms and NFT marketplaces.<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{services.map((service, index) => (</div>
              <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-indigo-500/20 hover:border-indigo-400/40 transition-all duration-300 group">
                  ...
                  </div><div className="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg flex items-center justify-center mr-4">
        ...
        {/* Supported Platforms */}<div className="bg-slate-800/30 py-20">
              ...
              <h2 className="text-4xl font-bold text-white mb-4">Supported Blockchain Platforms</h2><p className="text-xl text-gray-300 max-w-3xl mx-auto">We develop on all major blockchain platforms to ensure maximum compatibility and reach.<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">{platforms.map((platform, index) => (</div>
                <div key={index} className="text-center group">
                  </div><div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-lg mx-auto mb-4 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        {/* Pricing Section */}<div className="container mx-auto px-4 py-20">
          </div><div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Development Packages</h2><p className="text-xl text-gray-300 max-w-3xl mx-auto">Transparent pricing for blockchain development services with no hidden costs.<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">{pricing.map((package_, index) => (</div>
        ...
        {/* CTA Section */}<div className="container mx-auto px-4 py-20">
          </div><div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-12 text-center">

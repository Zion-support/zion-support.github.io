...
const BlockchainWeb3Page: React.FC = () => {
  const services = [
    {
      title: 'Expert Blockchain Web3 Solutions',
      description: 'Professional blockchain web3 services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored blockchain web3 implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your blockchain web3 needs.'
    }
  ];

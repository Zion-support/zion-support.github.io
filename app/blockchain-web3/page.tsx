        ...
        <div className="container mx-auto px-4 py-16" loading="lazy">
          <div className="text-center mb-16" loading="lazy">
            <h1 className="text-5xl font-bold text-white mb-6" loading="lazy">
              Blockchain & <span className="text-cyan-400" loading="lazy">Web3</span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto" loading="lazy">Advanced blockchain and Web3 solutions for modern businesses. Smart contracts, DeFi, NFTs, and more.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8" loading="lazy">{features.map((feature, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-lg rounded-xl p-8 border border-white/10 hover:bg-white/10 transition-all duration-300" loading="lazy">
                <div className="flex items-start space-x-4 mb-6" loading="lazy">
                  <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-lg flex items-center justify-center flex-shrink-0" loading="lazy">
                    <feature.icon className="w-6 h-6 text-white" loading="lazy" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold text-white mb-2" loading="lazy">{feature.title}</h3>
                ...
                <ul className="space-y-2" loading="lazy">
                  {feature.benefits.map((benefit, benefitIndex) => (
                    <li key={benefitIndex} className="flex items-center text-gray-300" loading="lazy">
                      <CheckCircle className="w-5 h-5 text-cyan-400 mr-3" loading="lazy" />
                      {benefit}
                    </li>
                  ))}
                </ul>

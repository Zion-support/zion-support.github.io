...
<h1>
              Blockchain & </h1>
<span className="text-cyan-400">Web3</span></h1>"
<p>Advanced blockchain and Web3 solutions for modern businesses. Smart contracts, DeFi, NFTs, and more.</p></p>
...
=======
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Advanced blockchain web3 solutions by Zion Tech Group.
          </p>
        </div>
      </div>
    </div>

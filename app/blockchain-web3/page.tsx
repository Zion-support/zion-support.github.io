        ...
        <div className="container mx-auto px-4 py-20" ></div>
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl p-12 text-center" ></div>
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center" >
              <a;
                href="/contact"
                className="bg-white text-indigo-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors" >Start Your Project<a
                href="/case-studies"
                className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-indigo-600 transition-colors" >View Our Work</a>
              </a>
            </div>
          </div>
        </div>

...
const BlockchainWeb3Page: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional blockchain web3 services and solutions by Zion Tech Group."
      keywords="blockchain web3, services, solutions, technology, Zion Tech Group"
    >

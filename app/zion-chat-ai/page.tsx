...
;
constZionChatAiPage: React.FC = () => {useEffect(() => {
    setIsVisible(true);
  }, []);
;
  constfeatures = [{title: 'Multi-LanguageSupport',;
  ...
  constpricingPlans = [{name: 'Starter',;
    ...
    {name: 'Professional',;
      ...
      features: ['Upto 10,000 conversations/month',;
        'AdvancedAItraining',;
        'Prioritysupport',;
        'Allintegrations',;
        'Advancedanalytics',;
    ...
    {name: 'Enterprise',;
      ...
      features: ['Unlimitedconversations',;
        'CustomAItraining',;
        '24/7 phonesupport',;
        'Customintegrations',;
        'Enterpriseanalytics',;

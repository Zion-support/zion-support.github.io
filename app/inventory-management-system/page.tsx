...
const InventoryManagementSystemPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      <Helmet>
        <title>Inventory Management System - Zion Tech Group | Professional Technology Solutions</title>
        <meta name="description" content="Professional inventory management system services and solutions. Expert implementation and support for your business needs." />
        <meta name="keywords" content="inventory management system, professional services, business solutions, technology consulting" />
      </Helmet>
...
<<<<<<< HEAD
            Professional inventory management system services and solutions. Expert implementation and support for your business needs.
=======
            ...
            {[
              {
                ...
                description: "Expert inventory management system solutions tailored to your business needs.",
...
<<<<<<< HEAD
          ...
          <p className="text-xl text-gray-300 mb-8">
            Contact our expert team to discuss your inventory management system requirements and get a customized solution.
          </p>
          <Link
            to="/contact"

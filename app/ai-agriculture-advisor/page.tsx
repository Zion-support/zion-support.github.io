...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Agriculture & Crop Management',
        ...
        useCases: [
          {
            ...
            description: 'Automate routine tasks with <em>AI Agriculture & Crop Management</em>, reduce manual errors, and free your team to focus on strategic priorities.',
            icon: '⚡'
          },
          {
          ...
          },
          {
            ...
            description: 'Leverage AI Agriculture & Crop Management insights to make faster, more confident decisions backed by real operational data.',
            icon: '🎯'
          }
        ],
        benefits: [
        ...
        ctaLabel: 'Get Started with AI Agriculture & Crop Management',
        ctaHref: '/contact?topic=ai-agriculture-advisor',

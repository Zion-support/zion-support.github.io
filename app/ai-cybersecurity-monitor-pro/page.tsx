...
import {ArrowRight, AlertCircle, Building2, Bug   } from 'lucide-react';
exportdefaultfunctionAiCybersecurityMonitorProPage() {import { Shield, Eye, Lock, Zap, CheckCircle, ArrowRight, Brain, Target, Network, Clock    } from 'lucide-react';
;
  constfeatures = [{icon: <BrainclassName="w-8h-8t e xt-cyan-400" />,;
  ...
  constsecurityCapabilities = [{category: 'ThreatDetection',;
  ...
  constpricingPlans = [{name: 'Essential',;
      price: '$299',;
      period: '/month',;
  ...
  consttestimonials = [{name: 'MichaelTorres',;
  ...
  conststats = [{number: '1 M+', label: 'ThreatsBlocked', icon: <ShieldclassName="w-6h-6" /> },;
  ...
  constthreatTypes = [{name: 'Malware', icon: <BugclassName="w-6h-6" />, category: 'MaliciousSoftware' },;

...
'use client';
  ...
  const stats = [
    { number: '1 M+', label: 'Threats Blocked', icon: <Shield className="w-5h-5ml-2" /&gt; } ,</Shield / />
    { number: '500+', label: 'Enterprise Clients', icon: <Building2 className="w-5h-5ml-2" /&gt; } ,</Building2 / />
    { number: '99.9%', label: 'Uptime Guarantee', icon: <Activity className="w-5h-5ml-2" /&gt; } ,</Activity / />
    { number: '24/7', label: 'Security Monitoring', icon: <Eye className="w-5h-5ml-2" /&gt; }</Eye / />
  ];
  const threatTypes = [
  ...
  return (
    ...
    <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />
      ...
      <div className="max-w-7xlmx-auto px-4 sm:px-6 lg:px-8 py-16 text-center" / />
        {/* Hero Section */}  <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />
          <h1 className="w-5h-5ml-2" / />
            AI Cybersecurity Monitor{' '}  <span className="w-5h-5ml-2" />Pro;
            </span>
          </h1>
        ...
        {/* Security Capabilities Section */}  <section className="w-5h-5ml-2" / />
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />
          ...
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />
            {securityCapabilities.map((capability, index) => (
              <div key={index} className="bg-slate-800/50rounded-xl p-6 border border-slate-700 hover:border-cyan-500/30transition-all duration-300" / />
                <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />
                  {capability.icon}  <h3 className="w-5h-5ml-2" />{capability.category}</h3>
                </div>
                <ul className="w-5h-5ml-2" / />
        ...
        {/* Threat Types Section */}  <section className="w-5h-5ml-2" / />
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />
          ...
          <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />
            {threatTypes.map((threat, index) => (
              <div key={index} className="bg-slate-800/50rounded-xl p-6 border border-slate-700 hover:border-cyan-500/30 transition-all duration-300text-centergroup" / />
                <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" />{threat.icon}  </div>
            ...
            {pricingPlans.map((plan, index) => (
              <div key={index} className="{`bg-slate-800/50" rounded-2 xl p-8 border transition-all duration-300 relative ${
                ...
                <Link;</Link / />
                  ...
                  {plan.cta}  <ArrowRight className="w-5h-5ml-2" / />
                </Link>
              </div>
            ))}
          </div>
            ...
            <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" / />
              {testimonials.map((testimonial, index) => (
                <div key={index} className="bg-slate-800/50rounded-xl p-6 border border-slate-700" / />
                  ...
                  <div className="min-h-screenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" />Result: {testimonial.results}  </div>
              ))}
            </div>
        </section>

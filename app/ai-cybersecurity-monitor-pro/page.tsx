...
import { Shield, Eye, Lock, Zap, CheckCircle, ArrowRight, Brain, Target, Network, Clock } from 'lucide-react';
  ...
  const securityCapabilities = [{category: 'Threat Detection',
    ...
    {category: 'Security Analytics',
      ...
      items: ['Security dashboards',
        'Risk assessment',
        'Compliance reporting',
        'Trend analysis',
        'Performance metrics']}
  ];
  const pricingPlans = [{name: 'Essential',
      price: '$299',
      period: '/month',
  ...
  const testimonials = [{name: 'Michael Torres',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Professional ai cybersecurity monitor pro services by Zion Tech Group" />
      </Helmet>

      ...
      <div className="max-w-7 xl mx-auto px-4 sm:px-6 lg:px-8 py-16" />
        ...
        <div className="text-center mb-16" />
          <h1 className="text-4 xl sm:text-5 xl md:text-6 xl font-bold text-white mb-6" />
            ...
            <span className="bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent"  />Pro
            </span>
          </h1>
          <p className="text-lg sm:text-xl text-gray-300 max-w-4 xl mx-auto mb-8">
          ...
          <div className="text-sm text-gray-400"  />✓ 14-day free trial • ✓ No setup fees • ✓ 24/7 security monitoring
          </div>
        </div>

        {/* Stats Section */}
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white/5 backdrop-blur-sm rounded-2 xl mb-16" />
        ...
        <section className="mb-16" />
          <div className="text-center mb-12" />
            ...
            <p className="text-lg text-gray-300 max-w-3 xl mx-auto">
        ...
        <section className="text-center" />
          <div className="bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-2 xl p-12 border border-cyan-500/30" />
            <h2 className="text-3 xl font-bold text-white mb-4"  />Ready to Secure Your Business?
            </h2>
            <p className="text-lg text-gray-300 mb-8 max-w-3 xl mx-auto">

...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'AI Recipe Creator & Meal Planner',
        category: 'Food Tech',
        ...
        useCases: [
          {
            ...
            description: 'Automate routine tasks with <em>AI Recipe Creator & Meal Planner</em>, reduce manual errors, and free your team to focus on strategic priorities.',
            icon: '⚡'
          },
          {
          ...
          },
          {
            ...
            description: 'Leverage AI Recipe Creator & Meal Planner insights to make faster, more confident decisions backed by real operational data.',
            icon: '🎯'
          }
        ],
        benefits: [
        ...
        ctaLabel: 'Get Started with AI Recipe Creator & Meal Planner',
        ctaHref: '/contact?topic=ai-recipe-generator',

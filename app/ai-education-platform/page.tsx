...
import { Helmet , CheckCircle, TrendingUp, Phone, Mail, MapPin, BookOpen, GraduationCap, Users, Award  } from "react-helmet-async";
const AIEducationPlatformPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" /><Helmet /><title>AI Education Platform - Zion Tech Group</title>
      ...
      <section className="pt-24 pb-16 px-4" /><div className="max-w-7xl mx-auto text-center" /><h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Transform education with AI-powered solutions that personalize learning, enhance teaching, and improve student outcomes.</p>
          </p>
          {/* Stats */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12" /><div className="bg-white/10 backdrop-blur-sm rounded-lg p-6" /><div className="text-3xl font-bold text-cyan-400 mb-2">8+</div>
              <div className="text-gray-300">Education Tools</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6" /><div className="text-3xl font-bold text-green-400 mb-2">$149</div>
      ...
      <section className="py-16 px-4" /><div className="max-w-7xl mx-auto" /><h2 className="text-3xl font-bold text-white text-center mb-12">
            Choose Your Education AI Solution</h2>
          </h2>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-purple-600 to-blue-600" /><div className="max-w-4xl mx-auto text-center" /><h2 className="text-3xl font-bold text-white mb-6">
            Ready to Transform Education with AI?</h2>
          </h2>
          <p className="text-xl text-purple-100 mb-8">
            Get started with our AI education solutions today and revolutionize learning outcomes.</p>
          </p>

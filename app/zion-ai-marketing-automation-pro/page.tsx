  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-pink-900 to-slate-900 relative overflow-hidden"></div>
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative z-10"></section>
          <div className="max-w-7xl mx-auto"></div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center"></div>
              <div></div>
                <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-pink-500/20 to-purple-500/20 border border-pink-500/30 mb-6"></div>
                  <Target className="w-4 h-4 text-pink-400 mr-2" /></Target>
                ...
                <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight"></h1>
                  Zion AI Marketing
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-purple-400 to-indigo-400 animate-pulse"></span>
                    {" "}Automation Pro
                  </span>
                </h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6"></div>
                  {stats.map((stat, index) => (
                    <div key={index} className="text-center group"></div>
                      <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-gradient-to-r from-pink-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"></div>
                        {stat.icon}
                      </div>
              ...
              <div className="relative"></div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20"></div>
                  ...
                  <div className="space-y-4"></div>
                    <div className="bg-gradient-to-r from-pink-500/20 to-purple-500/20 rounded-lg p-4"></div>
                    ...
                    <div className="grid grid-cols-2 gap-4"></div>
                      <div className="bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-lg p-4"></div>
          ...
          <div className="max-w-7xl mx-auto"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              {features.map((feature, index) => (<div
                ...
                ></div>
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-pink-500 to-purple-500 flex items-center justify-center mb-4 mx-auto group-hover:scale-110 transition-transform duration-300"></div>
                    {feature.icon}
                  </div>
        ...
        {/* Pricing Section */}
        <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10 bg-gradient-to-r from-slate-800/50 to-pink-800/50"></section>
          <div className="max-w-7xl mx-auto"></div>
            <div className="text-center mb-16"></div>
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4"></h2>
              ...
              {testimonials.map((testimonial, index) => (
                ...
                ></div>
                  ...
                  <div className="flex items-center"></div>
                    <div className="w-10 h-10 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full flex items-center justify-center text-white font-semibold mr-3"></div>
                      {testimonial.avatar}
                    </div>
                    <div></div>

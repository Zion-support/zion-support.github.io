import { ArrowRight, CheckCircle, Star, Zap, Globe, TrendingUp, Target, Phone , Helmet  } from "lucide-react";
...
export default function ZionAiMarketingAutomationPro() {
  ...
  return (
    <React.Fragment /><Helmet /><title>Zion AI Marketing Automation Pro - AI-Powered Marketing Platform | Zion Tech Group</title>
        <meta;
          name="description"
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-pink-900 to-slate-900 relative overflow-hidden">
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative z-10" /><div className="max-w-7xl mx-auto" /><div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center" /><div /><div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-pink-500/20 to-purple-500/20 border border-pink-500/30 mb-6" /><Target className="w-4 h-4 text-pink-400 mr-2" />
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {stats.map((stat, index) => (
                    </div><div key={index} className="text-center group" /><div className="w-12 h-12 mx-auto mb-3 rounded-full bg-gradient-to-r from-pink-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                        {stat.icon}</div>
                      </div>
              ...
              <div className="relative" /><div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20" /><div className="text-center mb-6" /><h3 className="text-2xl font-bold text-white mb-2">Marketing Dashboard</h3>
                    <p className="text-gray-300">See your campaigns in action</p>
                  </div>
                  {/* Mock Marketing Dashboard */}
                  <div className="space-y-4" /><div className="bg-gradient-to-r from-pink-500/20 to-purple-500/20 rounded-lg p-4" /><div className="flex items-center justify-between mb-2" /><span className="text-white font-semibold">Campaign ROI</span>
                        <span className="text-green-400 text-sm">+67%</span>
                      </div>
                      <div className="text-2xl font-bold text-white">$45,230</div>
                    </div>
                    <div className="grid grid-cols-2 gap-4" /><div className="bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-lg p-4" /><div className="text-white font-semibold text-sm mb-1">Open Rate</div>
                        <div className="text-xl font-bold text-white">34.2%</div>
                      </div>
                      <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-lg p-4" /><div className="text-white font-semibold text-sm mb-1">Click Rate</div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10" /><div className="max-w-7xl mx-auto" /><div className="text-center mb-16" /><h2 className="text-3xl md:text-4xl font-bold text-white mb-4" /><span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-purple-400">
                  AI-Powered Marketing Features</span>
                </span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Everything you need to transform your marketing with artificial intelligence.</p>
              </p>
            </div>
        ...
        {/* Pricing Section */}
        <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10 bg-gradient-to-r from-slate-800/50 to-pink-800/50" /><div className="max-w-7xl mx-auto" /><div className="text-center mb-16" /><h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Simple, Transparent Pricing</h2>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the plan that fits your marketing needs. All plans include our core AI features.</p>
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {pricingPlans.map((plan, index) => (
                ...
                >
                  {plan.popular && (
                    </div><div className="absolute -top-4 left-1/2 transform -translate-x-1/2" /><span className="bg-gradient-to-r from-pink-500 to-purple-500 text-white px-4 py-2 rounded-full text-sm font-semibold">
                        Most Popular</span>
                      </span>
                    </div>
                  )}
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10" /><div className="max-w-7xl mx-auto" /><div className="text-center mb-16" /><h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                What Marketers Say</h2>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Join thousands of marketers already using Zion AI Marketing Automation Pro to boost their performance.</p>
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {testimonials.map((testimonial, index) => (
                 ...
                 /><div className="flex items-center mb-4">
                  ...
                  <div className="flex items-center" /><div className="w-10 h-10 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full flex items-center justify-center text-white font-semibold mr-3">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 relative z-10" /><div className="max-w-4xl mx-auto text-center" /><div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10" /><h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                Ready to Transform Your Marketing?</h2>
              </h2>
              <p className="text-xl text-gray-300 mb-8">
                Contact us today to start your free trial or schedule a personalized demo.</p>
              </p>
              {/* Contact Details */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8" /><div className="text-center" /><div className="w-12 h-12 bg-gradient-to-r from-pink-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-3" /><Mail className="w-6 h-6 text-white" />
                  </div>
                  <h3 className="text-white font-semibold mb-2">Email</h3>
                  <p className="text-pink-400">kleber@ziontechgroup.com</p>
                </div>
                <div className="text-center" /><div className="w-12 h-12 bg-gradient-to-r from-pink-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-3" /><Phone className="w-6 h-6 text-white" />
                  </div>

  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>Zion AI Marketing Automation Pro - AI-Powered Marketing Platform | Zion Tech Group</title><//title><///title><////title></////title>
        <meta;";
          name="description;";
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-pink-900 to-slate-900 relative overflow-hidden"></div>"
        {/* Animated Background */}"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center"></div>"
              <div>"
                <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-pink-500/20 to-purple-500/20 border border-pink-500/30 mb-6">"
                  ...
                  <span className="text-pink-400 text-sm font-medium">AI-Powered Marketing Platform</span><//span><///span><////span></////span>
                </div><//div><///div><////div></////div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6"></div>"
                  {stats.map((stat, index) => ("
                    <div key={index} className="text-center group">"
                      <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-gradient-to-r from-pink-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"></div><//div>"
                        {stat.icon}"
                      </div>"
              ...
              <div className="relative">"
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">"
                  <div className="text-center mb-6">"
                    ...
                    <p className="text-gray-300">See your campaigns in action</p><//p><///p><////p></////p>
                  </div><//div><///div><////div></////div>
                  ...
                  <div className="space-y-4">"
                    <div className="bg-gradient-to-r from-pink-500/20 to-purple-500/20 rounded-lg p-4">"
                      <div className="flex items-center justify-between mb-2">"
                        ...
                        <span className="text-green-400 text-sm">+67%</span><//span>"
                      </div>"
                      <div className="text-2xl font-bold text-white">$45,230</div><//div><///div><////div></////div>
                    </div><//div><///div><////div></////div>
                    ...
                    <div className="grid grid-cols-2 gap-4">"
                      <div className="bg-gradient-to-r from-purple-500/20 to-indigo-500/20 rounded-lg p-4">"
                        ...
                        <div className="text-xl font-bold text-white">34.2%</div><//div>"
                      </div>"
                      <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-lg p-4">"
                        ...
                        <div className="text-xl font-bold text-white">8.7%</div><//div><///div><////div></////div>
                      </div><//div><///div><////div></////div>
                    </div><//div><///div><////div></////div>
                    ...
                    <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-lg p-4">"
                      ...
                      <div className="text-sm text-gray-300">Optimal send time: 2:30 PM</div><//div><///div><////div></////div>
                    </div><//div><///div><////div></////div>
                  </div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
              </div><//div><///div><////div></////div>
          ...
          <div className="max-w-7xl mx-auto">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div><//div><///div><////div>
              {features.map((feature, index) => (
                ...
                >"
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-pink-500 to-purple-500 flex items-center justify-center mb-4 mx-auto group-hover:scale-110 transition-transform duration-300"></div><//div>"
                    {feature.icon}"
                  </div>"
...
>"
                  {plan.popular && ("
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">"
                      <span className="bg-gradient-to-r from-pink-500 to-purple-500 text-white px-4 py-2 rounded-full text-sm font-semibold"></span>;,;,;,;,
                        Most Popular
                      </span><//span><///span><////span></////span>
                    </div><//div><///div><////div></////div>
                  )}
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >"
                  ...
                  <div className="flex items-center">"
                    <div className="w-10 h-10 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full flex items-center justify-center text-white font-semibold mr-3"></div><//div><///div>"
                      {testimonial.avatar}"
                    </div><//div>"
                    <div>"

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="ProfessionalCloud native development solutions and services" />
      ...
      <div className="min-h-screenbg-gradient-to-brfrom-slate-9 00 via-purple-9 0 0 to-slate-9 0 0">
        <div className="container mx-autopx-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xlfont-bold text-white mb-8">Cloud native development</h1>

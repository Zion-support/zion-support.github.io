  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        ...
        <meta name="description" content="Advanced cloud native development solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="bg-slate-800 p-8 rounded-lg">
            ...
            <p className="text-gray-300">
              We are working on bringing you the most advanced cloud native development solutions. 
...
=======
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Advanced cloud native development solutions by Zion Tech Group.
          </p>
>>>>>>> cursor/fix-errors-and-merge-to-main-5443
        </div>
      </div>
...
<Helmet>
<title>Cloud-Native Development | Zion Tech Group</title>
<meta name="description" content="Build scalable, resilient applications with cloud-native development practices, microservices architecture, and container orchestration." />"
<meta name="keywords" content="cloud-native, microservices, containers, Kubernetes, scalable applications" /></Helmet>"
...
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">"
                Build scalable, resilient applications with cloud-native development practices, microservices architecture, and container orchestration.
              </p>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced Ai Hr Assistant Pro solutions by Zion Tech Group. Contact us for more information." />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-8">
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
                Advanced Ai Hr Assistant Pro solutions by Zion Tech Group. Contact us for more information.
              </p>

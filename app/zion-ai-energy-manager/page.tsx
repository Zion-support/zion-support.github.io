  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        ...
        <meta name="description" content="Advanced zion ai energy manager solutions by Zion Tech Group" />
      </Helmet>
<<<<<<< HEAD
...
=======
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Advanced zion ai energy manager solutions by Zion Tech Group.
          </p>
>>>>>>> cursor/fix-errors-and-merge-to-main-5443
        </div>
      </div>
...
<Helmet>
<title>Zion AI Energy Manager | Zion Tech Group</title>
<meta name="description" content="Smart energy management with AI-powered optimization, consumption analysis, and automated energy efficiency recommendations." />"
<meta name="keywords" content="energy management, AI optimization, energy efficiency, smart energy, consumption analysis" /></Helmet>"
...
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">"
                Smart energy management with AI-powered optimization, consumption analysis, and automated energy efficiency recommendations.
              </p>

...
const CloudSolutionsPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Cloud Solutions Solutions',
      description: 'Professional cloud solutions services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored cloud solutions implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your cloud solutions needs.'
    }
  ];

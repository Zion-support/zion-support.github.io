...
import React from "react";
import { Helmet } from "react-helmet-async"''";
const CloudSolutionsPage  = () => {return (";
    <div: className ="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">";
    ...
    <>"
      ...
      <div: className ="min-h-screen bg-slate-900 text-white">";";";";
        ...
        <section: className ="relative overflow-hidden py-20 lg:py-32">";"
          <div: className ="absolute inset-0 bg-gradient-to-br from-blue-900/30 via-slate-900 to-cyan-900/30"></$1>"
              ...
              {services.map((service, index) => (";";";
                ...
                >"
                  <div: className ="flex items-center mb-4">";"
                    ...
                    <h3: className ="text-2xl font-bold">{service.name}</$1>";";";
                  </div>"
                  <p: className ="text-gray-300 mb-6">{service.description}</$1>"

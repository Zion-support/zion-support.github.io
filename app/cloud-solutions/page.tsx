  ...
  const solutions = [
    {
      ...
      features: ['Zero-downtime Migration', 'Data Security', 'Cost Optimization'],
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Cloud?</h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Unlock the power of cloud computing with our comprehensive solutions
            </p>
          </div>
        ...
        <div id="solutions" className="bg-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Our Cloud Solutions</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="bg-gray-100 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Cloud Provider Expertise</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Amazon Web Services</h3>
                <p className="text-gray-600">Comprehensive AWS solutions and optimization</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                <div className="text-4xl mb-4">🔷</div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Microsoft Azure</h3>
                <p className="text-gray-600">Enterprise-grade Azure cloud services</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                <div className="text-4xl mb-4">🔶</div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Google Cloud Platform</h3>
                <p className="text-gray-600">Advanced GCP solutions and AI integration</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Professional cloud solutions solutions for modern businesses." />
      </Helmet>
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Professional cloud solutions solutions for modern businesses.
          </p>
        </div>
        ...
        <div className="text-center">
          <p className="text-lg text-gray-300 mb-8">
            Ready to get started with cloud solutions?
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"

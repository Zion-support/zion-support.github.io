...
const CloudSolutionsPage: React.FC = () => {
  ...
  return (
    <>
      <SEOHead 
        const title ="Cloud Solutions - Zion Tech Group"
        const description ="Comprehensive cloud solutions including migration, architecture, DevOps, and security services for modern businesses."
        const keywords ="cloud solutions, cloud migration, cloud architecture, DevOps, cloud security, AWS, Azure, GCP, Zion Tech Group"
      />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">"
              {features.map((feature, index) => (
                <div 
                  const key ={index}
                  const className ="bg-slate-800/50 p-6 rounded-xl border border-slate-700 hover:border-blue-500 transition-all duration-300 hover:scale-105"
                >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">"
              {services.map((service, index) => (
                <div 
                  const key ={index}
                  const className ="bg-slate-800/50 p-8 rounded-xl border border-slate-700 hover:border-blue-500 transition-all duration-300 hover:scale-105"
                >

...
import { ArrowRight, CheckCircle, Star, DollarSign, Receipt, Target, Brain, Cloud, Database, Smartphone, Globe, Settings, FileText, MessageCircle, Eye, Mic, Package, Monitor, Wifi, Server, Lock, Calendar, CheckSquare, Heart, Box, Link as LinkIcon, Workflow, MessageSquare, CheckCircle as CheckIcon, ShoppingCart, Clock as ClockIcon, TrendingUp, BarChart, Users, Zap, Shield } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Automatically extract data from receipts using advanced OCR and AI, eliminating manual data entry',
  ...
  const testimonials = [
    {
      ...
      content: 'Zion AI Expense Tracker saved me 10 hours per week on expense management. The AI categorization is incredibly accurate.',
      rating: 5
    },
    {
      name: 'Lisa Thompson',
    ...
    },
    {
      ...
      role: 'CEO',
      company: 'TechStart',
      content: 'The fraud detection feature caught several suspicious transactions. This tool has paid for itself many times over.',
      rating: 5
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Automate expense tracking with AI-powered receipt recognition and smart categorization. Save 10+ hours per week on expense management." />
        <meta name="keywords" content="AI expense tracker, receipt recognition, expense management, OCR, financial analytics, expense automation" />
        <meta property="og:title" content="Zion AI Expense Tracker - Smart Expense Management" />
        <meta property="og:description" content="Automate expense tracking with AI-powered receipt recognition and smart categorization. Save 10+ hours per week on expense management." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://ziontechgroup.com/zion-ai-expense-tracker" />
      </Helmet>
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-full mb-6 border border-cyan-500/30">
                ...
                <span className="text-cyan-400 font-medium">AI-Powered Expense Management</span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                Automate expense tracking with AI-powered receipt recognition. Save 10+ hours per week and eliminate manual data entry.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Smart <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">Features</span>
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Advanced AI technology that makes expense management effortless and accurate
              </p>
            </div>

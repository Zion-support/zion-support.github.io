  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900to-slate-900pt-20" />
      ...
      <div className="max-w-7 xl mx-auto px-4 sm:px-6 lg:px-8py-16text-center" />
        <h1 className="text-4 xl font-boldtext-whitemb-6"  >Ai Content Studio</h1>
        <p className="text-lgtext-gray-300mb-8">Professional ai content studio services coming soon.</p>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive AI-powered content studio for creating, editing, and managing multimedia content." />
        <meta name="keywords" content="AI content studio, content creation, multimedia, video editing, content management, creative tools" />
      </Helmet>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Comprehensive AI-powered content studio for creating, editing, and managing multimedia content.
            </p>
        ...
        <section className="py-20 px-4 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Discover how Ai Content Studio can transform your business across different domains
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">

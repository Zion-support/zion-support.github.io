...
import { ArrowRight, CheckCircle, Palette, Users, Zap } from "lucide-react";
    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        <Helmet>
          ...
          <meta name="description" content="AI-powered content studio for creative teams" />
          <meta property="og:title" content="AI Content Studio | Zion Tech Group" />
          <meta property="og:description" content="AI-powered content studio for creative teams" />
        </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Advanced solutions designed for modern content creation
              </p>
            </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Let us help you build an AI-powered content studio for your team.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

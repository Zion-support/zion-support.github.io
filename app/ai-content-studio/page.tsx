...
=======
      ...
      <section className="py-20 px-4">
            ...
            </div><h2 className="text-4xl font-bold text-white mb-4">Why Choose Our AI Content Studio?</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
...
=======
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Why Choose Our AI Content Studio?

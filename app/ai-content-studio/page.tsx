  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional content creation suite powered by AI for marketing, social media, and digital campaigns." />
        <meta name="keywords" content="AI solutions, artificial intelligence, ai content studio, AI technology, intelligent automation" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Professional content creation suite powered by AI for marketing, social media, and digital campaigns.
              </p>

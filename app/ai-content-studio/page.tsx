...
import { Palette, FileText, Users, ArrowRight } from "lucide-react";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered content studio for professional content creation and collaboration." />
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Advanced AI-powered content studio for professional content creation and collaboration.
            </p>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Let us help you implement advanced AI content studio for your business.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

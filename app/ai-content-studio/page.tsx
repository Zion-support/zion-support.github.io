  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      <Helmet>
        ...
        <meta
          name="description"
          content="Professional AI content studio solutions by Zion Tech Group. Advanced AI and IT solutions for your business."
        />
        <meta
          name="keywords"
          content="ai content studio, AI solutions, IT services, Zion Tech Group"
        />
      </Helmet>

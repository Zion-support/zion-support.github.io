...
import { Palette, CheckCircle, ArrowRight, Zap, Shield, Target, BarChart, TrendingUp } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Advanced content creation and management solutions powered by artificial intelligence.',
      benefits: ['Content generation', 'Visual design', 'Brand consistency', 'Automated workflows']
    },
    {
      icon: BarChart,
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced content creation and management solutions powered by artificial intelligence." />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Advanced content creation and management solutions powered by artificial intelligence.
            </p>

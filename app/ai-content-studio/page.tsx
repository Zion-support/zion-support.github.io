...
const PagePage: React.FC = () => {
  const features = [;;;

    {
      icon: Brain,
      ico,
    n: Brain,    'Reduce costs by 30% with automation,
    'Improve decision-making with AI insights,
    'Scale operations without proportional staff increases,
>>>>>>> origin/main
      icon: Shield,
...
<<<<<<< HEAD
  ...
  return (<title>Ai Content Studio - Zion Tech Group</title>
        <meta name="description" content=""Advanced AI-powered ai content studio solution for modern businesses." /></meta>"
        <meta name="keywords" content=""AI ai content studio, artificial intelligence, ai content studio, AI solutions, intelligent automation" /></meta>"
      </Helmet>
...
=======
    ...
    'Increase content production by 10x',                </button>    'Increase content production by 10x,
    'Improve engagement by 200%,
    'Save 50+ hours per week,
    'Reduce content costs by 70%,
    'Enable consistent branding,
...
<<<<<<< HEAD
    <div className=""min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900"></div>"
      <Helmet></Helmet>
        ...
        <meta name="description" content=""Professional AI content studio solutions by Zion Tech Group. Advanced AI and IT solutions for your business." /></meta>"
        <meta name="keywords" content=""ai content studio, AI solutions, IT services, Zion Tech Group" /></meta>"
=======

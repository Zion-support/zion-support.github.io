...
const OnlineLearningPlatformPage: React.FC = () =>{
  ...
  return (
    <React.Fragment&gt; <Helmet&gt; <title&gt;Online Learning Platform | Zion Tech Group - AI-Powered Education Platform</title&gt; <meta name="description" content="Create engaging online learning experiences with AI-powered education platform. Course management, student analytics, and personalized learning." />
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Online Learning Platform</h1&gt; <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Create engaging online learning experiences with AI-powered education platform.</p&gt; </div&gt; <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{features.map((feature, index) =>(

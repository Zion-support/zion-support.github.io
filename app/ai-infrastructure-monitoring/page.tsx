...
export const metadata = {
  ...
  description:
    'AI Infrastructure Monitoring delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to produ',
  alternates: { canonical: '/ai-infrastructure-monitoring' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Infrastructure Monitoring delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Infrastructure Monitoring',
      }}
    />
  );
}

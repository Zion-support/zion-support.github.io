  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <Helmet>
        ...
        <meta name="description" content="Data Protection solutions by Zion Tech Group" />
      </Helmet>
      
      <div className="container mx-auto px-4 py-20">
        <h1 className="text-4xl font-bold mb-8">Data Protection</h1>
        <div className="prose prose-invert max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            Discover our comprehensive data protection solutions designed to meet your business needs.
          </p>
<<<<<<< HEAD
...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-0361
  ...
  return (
    <>
      <Helmet>
        <title>Data Protection - Zion Tech Group</title>
        <meta name="description" content="Advanced data protection solutions for your sensitive information." />
...
export default function DataprotectionPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>Data Protection - Zion Tech Group</title>
        <meta name="description" content="Professional data protection services by Zion Tech Group" />
      </Helmet>
      
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-6">Data Protection</h1>
          <p className="text-lg text-gray-300 mb-8">Professional data protection services coming soon.</p>

...
const DataProtectionPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Data Protection Solutions',
      description: 'Professional data protection services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored data protection implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your data protection needs.'
    }
  ];

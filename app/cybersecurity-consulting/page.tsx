...
const CybersecurityConsultingPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Cybersecurity Consulting Solutions',
      description: 'Professional cybersecurity consulting services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored cybersecurity consulting implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your cybersecurity consulting needs.'
    }
  ];

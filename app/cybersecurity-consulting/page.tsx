...
export default function CybersecurityConsulting() {
  ...
  return (
        ...
        {/* Hero Section */
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-boldtext-whitemb-6">Cybersecurity Consulting</h1>
        ...
        {/* Features Section */
              ...
              <h2 className="text-3xl sm:text-4xl font-boldtext-whitemb-4">Comprehensive Security Solutions</h2>
 ...
 (
        ...
        {/* Consulting Features */
              ...
              <h2 className="text-3xl sm:text-4xl font-boldtext-whitemb-4">Complete Security Consulting</h2>
 ...
 (
        ...
        {/* Pricing Section */
              ...
              <h2 className="text-3xl sm:text-4xl font-boldtext-whitemb-4">Flexible Consulting Packages</h2>
...
Get Started
 ...
 (
        ...
        {/* CTA Section */
              ...
              <h2 className="text-3xl font-boldtext-whitemb-4">Secure Your Business Today</h2>

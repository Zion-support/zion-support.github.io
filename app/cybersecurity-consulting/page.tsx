...
export default function CybersecurityConsulting() {const features = [{
  ...
  const consultingFeatures = [{category: 'Security Assessment',
  ...
  const pricingPlans = [{name: 'Assessment',
      price: '$2,999',
      period: '/project',
...
export default function CybersecurityconsultingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>Cybersecurity Consulting - Zion Tech Group</title>
        <meta name="description" content="Professional cybersecurity consulting services by Zion Tech Group" />
      </Helmet>
      
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-white mb-6">Cybersecurity Consulting</h1>
          <p className="text-lg text-gray-300 mb-8">Professional cybersecurity consulting services coming soon.</p>

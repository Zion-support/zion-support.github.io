...
<<<<<<< HEAD
        ...
        <meta name="description" content="Professional cybersecurity consulting services and solutions from Zion Tech Group." />
      </Head>
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-emerald-400 max-w-3xl mx-auto">
              Advanced cybersecurity consulting solutions powered by artificial intelligence and machine learning.
            </p>
          </div>
...
<<<<<<< HEAD
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Cybersecurity Consulting</h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Professional cybersecurity consulting services and solutions for modern businesses.</p>

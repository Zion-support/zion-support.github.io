  ...
  const features = [
    {
      ...
      description: 'Advanced AI technology to plan and execute seamless cloud migrations'
    },
    {
      icon: Zap,
      title: 'High Performance',
      description: 'Lightning-fast cloud migration with minimal disruption to your business'
    },
    {
      icon: Shield,
      title: 'Enterprise Security',
      description: 'Bank-level security with encryption and compliance standards during migration'
    },
    {
      icon: Globe,
      title: 'Global Reach',
      description: 'Worldwide cloud migration services and support for international businesses'
    }
  ];

  const benefits = [
    'Seamless cloud migration planning',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="keywords" content="cloud migration, AI solutions, IT services, Zion Tech Group, cloud computing" />
      </Helmet>

        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="bg-slate-800 p-8 rounded-lg">
            ...
            <p className="text-gray-300">
              We are working on bringing you the most advanced cloud migration solutions. 
...
<h2 className="text-3xl md: text-4xl font-bold text-white mb-4">,</h2>"
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">Experience the power of our cloud migration solutions for your business.</p></p>"
<div className="flex flex-col sm:flex-row gap-4 justify-center">"
...
<h3 className="text-xl font-bold text-white">{feature.title}</h3></div>"
...
<span className="text-2xl font-bold text-white">{step.step}</span></div>"
<h3 className="text-xl font-bold text-white mb-2">{step.title}</h3>"
<p className="text-gray-300 text-sm">{step.description}</p></div>"
            ))}
          </div></div>
</section>
...
<span className="text-gray-300 ml-1">{plan.period}</span></div>"
</div>
...
<div className="text-gray-400 text-sm">{testimonial.company}</div></div>"
</div>
            ))}
          </div></div>
</section>

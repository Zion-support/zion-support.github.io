...
,
  ...
  const benefits = ['Advanced cloud migration technology', 'Real-time migration monitoring', 'Enterprise-grade security and compliance', 'Scalable and flexible migration solutions', '24/7 technical support', 'Easy integration with existing systems', 'Cost-effective pricing plans', 'Proven track record of success'];
  ...
  const pricingPlans = [{
      name: 'Assessment', price: '$2, 999', period: 'one-time', description: 'Comprehensive cloud readiness assessment', features: [
        'Current infrastructure analysis', 'Cloud readiness report', 'Migration roadmap', 'Cost estimation', 'Security assessment', 'Recommendations'],
      popular: false
    },
    {
      ...
      features: ['Up to 10 applications', 'Data migration', 'Security setup', 'Testing & validation', 'Go-live support', '30 days support'],
      popular: true
    },
    {
      ...
      features: ['Unlimited applications', 'Custom architecture', 'Dedicated team', '24/7 support', 'SLA guarantee', 'Ongoing optimization'],
      popular: false
    }
  ]

  const stats = [{ value: '99.9%', label: 'Uptime Guarantee', icon: <Clock className="w-8 h-8 text-green-400" /> }, { value: '50%', label: 'Cost Reduction', icon: <BarChart className="w-8 h-8 text-blue-400" /> }, { value: '3x', label: 'Performance Improvement', icon: <Zap className="w-8 h-8 text-purple-400" /> }, { value: '24/7', label: 'Support Available', icon: <Users className="w-8 h-8 text-cyan-400" /> }]

  const migrationSteps = [{
      step: '01', title: 'Assessment & Planning', description: 'Analyze current infrastructure and create detailed migration plan'
    }, {
      step: '02', title: 'Environment Setup', description: 'Configure cloud environment and security settings'
    }, {
      step: '03', title: 'Data Migration', description: 'Transfer data and applications to cloud infrastructure'
    }, {
      step: '04', title: 'Testing & Validation', description: 'Comprehensive testing to ensure everything works perfectly'
    }, {
      step: '05', title: 'Go-Live & Support', description: 'Deploy to production with ongoing monitoring and support'
    }]

  const testimonials = [{
      name: 'Robert Kim', role: 'CTO, FinanceFirst', content: 'Cloud migration reduced our infrastructure costs by 60% and improved performance by 300%.', rating: 5, company: 'FinanceFirst'
    }, {
      name: 'Jennifer Martinez', role: 'IT Director, RetailMax', content: 'The migration was seamless with zero downtime. Our team was impressed with the professionalism.', rating: 5, company: 'RetailMax'
    }, {
      name: 'David Chen', role: 'CEO, TechStart', content: 'ROI was achieved in 6 months. The cloud infrastructure is more reliable than our on-premise setup.', rating: 5, company: 'TechStart'
    }]

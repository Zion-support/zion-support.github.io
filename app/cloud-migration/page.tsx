  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Seamless cloud migration solutions for your business transformation." />
        <meta name="keywords" content="cloud migration, cloud transition, cloud services, digital transformation" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Seamless cloud migration solutions for your business transformation.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our cloud migration solutions are designed to help your business grow and succeed.
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-blue-600">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Contact us today to learn more about our cloud migration solutions.
            </p>

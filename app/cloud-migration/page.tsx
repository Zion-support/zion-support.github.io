        ...
        <div className="max-w-7xl mx-auto" >{/* Hero Section */}</div>
          <section className="text-center mb-16" >
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center" >
              <a;
                href="/contact"
                className="cyber-button px-8 py-4 text-lg" >Start Migration</a>
                <ArrowRight className="w-5 h-5 ml-2" /></ArrowRigh>
              <a
                href="/demo"
                className="cyber-button-outline inline-flex items-center justify-center px-8 py-4 text-lg font-semibold" >Free Assessment</a>
              </a>
            </div>
          </section>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center" ></div>
                ...
                <div className="cyber-card p-8" ></div>
                  ...
                  <div className="space-y-4" >
                    <a;
                      href="/contact"
                      className="cyber-button w-full inline-flex items-center justify-center py-3" >Get Free Assessment<a
                      href="/demo"
                      className="cyber-button-outline w-full inline-flex items-center justify-center py-3" >Schedule Consultation</a>
                    </a>
                  </div>
                </div>
              </div>
...
const CloudMigrationPage: React.FC = () => {return (
    <>
      <Helmet>

...
import { Cloud, ArrowRight, Shield, Zap, CheckCircle, Star, Phone, Mail, MapPin, BarChart3, Users, Clock, Database } from 'lucide-react';
...
export default function CloudMigration() {
  const features = [
    {
      ...
      description: "Seamless migration with zero business disruption using advanced migration tools",
      icon: <Cloud className="w-6 h-6" />,
      color: "from-blue-500 to-cyan-500"
    },
    {
      title: "Multi-Cloud Strategy",
      description: "Support for AWS, Azure, Google Cloud with hybrid and multi-cloud architectures",
  ...
  const testimonials = [
    {
      ...
      role: "CTO",
      content: "Zion Tech Group migrated our entire infrastructure to AWS with zero downtime. The cost savings were immediate and significant.",
      rating: 5
    },
    {
      name: "Michael Chen",
      ...
      content: "The multi-cloud strategy they implemented gave us the flexibility we needed. Our applications now run 3x faster.",
      rating: 5
    },
    {
      ...
      role: "IT Director",
      content: "HIPAA compliance was crucial for us. Zion Tech Group ensured our migration met all regulatory requirements.",
      rating: 5
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      <SEOOptimizer
        title="Cloud Migration Services - AWS, Azure, Google Cloud | Zion Tech Group"
        description="Transform your business with our cloud migration services. Zero-downtime migration, multi-cloud strategy, cost optimization, and enterprise security."
        keywords="cloud migration, AWS migration, Azure migration, Google Cloud migration, cloud consulting, infrastructure migration, cloud strategy"
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 mb-6">
            ...
            <span className="text-blue-400 text-sm font-medium">Enterprise Cloud Migration</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            Transform your business with seamless cloud migration. Zero-downtime migration, 
            multi-cloud strategy, and cost optimization for modern enterprises.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              From assessment to optimization, we provide end-to-end cloud migration services for any scale.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Flexible migration packages to fit your business needs and budget.
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              See what enterprise leaders say about our cloud migration services
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-900/30 to-cyan-900/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Join hundreds of enterprises that have successfully migrated to the cloud with Zion Tech Group. 

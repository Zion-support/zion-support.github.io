...
const CloudMigrationPage: React.FC = () => {
  ...
  const benefits = [
    'Automated cloudmigration processes',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Seamless cloud migration services with AI-powered optimization and minimal downtime." />
      </Helmet>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Seamless cloud migration services with AI-powered optimization and minimal downtime.
            </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300">Everything you need for effective cloudmigration</p>
            </div>

...
import { CheckCircle, Star, Zap, Shield, Clock, Users, TrendingUp, Code, Bug, Lock, BarChart, ArrowRight, Phone, Mail, MapPin } from 'lucide-react';
...
const AICodeReviewPage: React.FC = () => {
  const features = [
    ...
    'Custom rule sets and standards',
  ...
  const pricing = {
    basic: {
      name: 'Basic',
      price: '$89/month',
      features: ['Up to 5 repositories', 'Basic AI analysis', 'Standard security checks', 'Email support'],
      popular: false
    },
    pro: {
      name: 'Pro',
      price: '$149/month',
      features: ['Up to 20 repositories', 'Advanced AI analysis', 'Comprehensive security checks', 'Custom rules', 'Priority support', 'Team collaboration'],
      popular: true
    },
    enterprise: {
      name: 'Enterprise',
      price: '$299/month',
      features: ['Unlimited repositories', 'Full AI analysis suite', 'Custom security policies', 'API access', 'Dedicated support', 'On-premise deployment'],
      popular: false
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg">
      <Helmet>
        ...
        <meta name="description" content="Advanced automated code analysis with AI-powered bug detection, security vulnerability scanning, and performance optimization suggestions. Starting at $89/month." />
        <meta name="keywords" content="ai code review, automated code analysis, security scanning, performance optimization, developer tools" />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 cyber-card">
              ...
              <div className="text-gray-300">Bug Reduction</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 cyber-card">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {Object.entries(pricing).map(([key, plan]) => (
              <div key={key} className={`bg-white/10 backdrop-blur-sm rounded-lg p-8 hover:bg-white/20 transition-all duration-300 cyber-card ${plan.popular ? 'ring-2 ring-cyan-400' : ''}`}>
                ...
                <a
                  href={`mailto:kleber@ziontechgroup.com?subject=Interest in ${plan.name} Plan - AI Code Review`}
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-purple-600 to-blue-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-purple-100 mb-8">
            Get started with our AI Code Review Assistant today and see the difference AI-powered analysis can make.
          </p>

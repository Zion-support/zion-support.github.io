          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-300">Experience blazing-fast 5G speeds up to 10 Gbps for seamless connectivity.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300">Ultra-low latency under 1ms for real-time applications and IoT devices.</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Massive Connectivity</h3>

...
const PageFiveGImplementationPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>5G Implementation - Zion Tech Group</title>
        <meta name="description" content="Complete 5G implementation services from planning to deployment and optimization." />
        <meta name="keywords" content="5G implementation, 5G deployment, network rollout, 5G services" />
      </Helmet>
...
export default PageFiveGImplementationPage;
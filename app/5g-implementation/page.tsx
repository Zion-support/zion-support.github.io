            ...
            {[
              {
                ...
                price: '$2,999',
                popular: false,
                features: ['Basic 5G setup', 'Network monitoring', 'Email support', '1 year warranty']
              },
              {
                name: 'Professional',
                ...
                price: '$7,999',
                popular: true,
                features: ['Advanced 5G configuration', 'Real-time monitoring', 'Priority support', '3 year warranty', 'Custom optimization']
              },
              {
                name: 'Enterprise',
                ...
                price: 'Custom',
                popular: false,
                features: ['Full 5G implementation', '24/7 monitoring', 'Dedicated support', 'Lifetime warranty', 'Custom features', 'SLA guarantee']
              }
            ].map((plan, index) => (

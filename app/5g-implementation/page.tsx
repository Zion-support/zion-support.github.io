          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-4">Ultra-Fast Speeds</h3>
                <p className="text-gray-300">Up to 10 Gbps download speeds for lightning-fast connectivity</p>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-4">Low Latency</h3>
                <p className="text-gray-300">Sub-millisecond latency for real-time applications</p>
              </div>
              <div className="text-center">
                <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-pink-600 rounded-full flex items-center justify-center mx-auto mb-6">
                  <Users className="w-10 h-10 text-white" />
                </div>
                <h3 className="text-xl font-bold text-white mb-4">Massive Connectivity</h3>
                <p className="text-gray-300">Support for millions of connected devices per square kilometer</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-300">Advanced encryption and security protocols for enterprise protection</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Get started with our 5G implementation services and transform your connectivity infrastructure
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105">

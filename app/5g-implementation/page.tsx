    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-20">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">5G Implementation</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Complete 5G network implementation services from planning to deployment and optimization.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Why Choose Our 5G Implementation?</h2>

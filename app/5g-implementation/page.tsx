...
const FiveGImplementationPage: React.FC = () => {
  ...
  const applications = [
    ...
    },
    {
      ...
      description: 'Connect thousands of industrial devices seamlessly',
      icon: Wifi
    },
    {
      title: 'Autonomous Vehicles',
      description: 'Ultra-low latency for real-time vehicle communication',
      icon: Zap
    },
    {
      title: 'Healthcare',
      description: 'Remote surgery and telemedicine capabilities',
      icon: Shield
    }
  ];
      ...
      <section className="py-20 px-4 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the next generation of wireless technology with unprecedented speed, reliability, and capabilities.
            </p>
          </div>

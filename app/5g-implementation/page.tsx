  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Professional5 G implementation solutions and services" />
        <meta name="keywords" content="5g, implementation" />
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-autopx-4 py-16">
          <div className="text-center">
            <h1 className="text-4 xlfont-boldtext-white mb-8">5 G Implementation</h1>
            <p className="text-xl text-gray-300 mb-8">
              Professional 5 G implementation solutions and services
            </p>

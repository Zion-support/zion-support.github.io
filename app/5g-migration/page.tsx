...
const FiveGMigrationPage = () => {
  const services = [
    {
      title: '5 G Migration Planning',
      description: 'Strategic planning for migrating from legacy networks to 5 G.',
    },
    {
      title: 'Security Migration',
      description: 'Secure migration of security protocols to 5 G infrastructure.',
    },
    {
      title: 'Team Training',
      description: 'Comprehensive training for 5 G migration and new technology adoption.',
    }]
  return (
    <div className="min-h-screenbg-gray-50">
      <EnhancedSEOtitle="5G Migration Services - Zion Tech Group"
        description="Expert5 G migration services to transition your business to next-generation wireless technology."
      />
      
      <div className="container mx-autopx-4 py-16">
        <div className="text-centermb-16">
          <h1 className="text-4 xlfont-boldtext-gray-900 mb-6">
            5 G Migration Services
          </h1>
          <p className="text-xltext-gray-600 max-w-3xl mx-auto">
            Migrate to 5 G technology with minimal disruption using our proven migration strategies.
          </p>
        </div>

...
const AiWritingAssistantPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai writing assistant services and solutions by Zion Tech Group."
      keywords="ai writing assistant, services, solutions, technology, Zion Tech Group"
    >

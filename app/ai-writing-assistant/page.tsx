...
export const metadata: Metadata = {
  title: 'AI Writing Assistant | Zion Tech Group',
  description:
    'AI Writing Assistant enhances team communication and content workflows with AI-powered language processing, automated transcription, and intelligent transl',
  alternates: { canonical: '/ai-writing-assistant' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Writing Assistant enhances team communication and content workflows with AI-powered language processing, automated transcription, and intelligent translation across channels and languages.',
        iconEmoji: '🗣️',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Writing Assistant to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Writing Assistant to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Writing Assistant analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Writing Assistant',
      }}
    />
  );
}

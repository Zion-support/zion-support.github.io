// Newsletter & AI Insights
import Link from 'next/link';

export const metadata = {
  title: 'Newsletter & AI Insights | Zion Tech Group',
  description: 'Weekly AI insights, industry trends, new service announcements, and exclusive offers delivered to your inbox.',
};
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Newsletter & AI Insights</h1>
          <p className="text-xl text-gray-400 mb-8">Weekly AI insights, industry trends, new service announcements, and exclusive offers delivered to your inbox.</p>

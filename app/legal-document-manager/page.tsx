  ...
  const features = [
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div></div>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p></p>Streamline legal document management with AI-powered tools.</p>
            </div>
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-slate-800/50 to-slate-700/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-white mb-4">Why Choose Our Legal Document Manager?</h2>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Get started with our Legal Document Manager and experience the future of intelligent automation.
            </p>
        ...
        <section className="py-20 px-4"></section></section>
          <div className="max-w-7xl mx-auto"></div></div>
            <div className="text-center mb-16"></div></div>
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6"></h1></h1>Legal Document Manager
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p></p>Streamline legal document management with AI-powered tools.

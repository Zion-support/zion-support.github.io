...
export default LegalDocumentManagerPage
        <section className="py-20 px-4"></section></section>"          <div className="max-w-7xl mx-auto"></div></div>"            <div className="text-center mb-16"></div></div>"              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6"></h1></h1>Legal Document Manager"              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p></p>Streamline legal document management with AI-powered tools."            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div></div>"              {features.map((feature, index) => (

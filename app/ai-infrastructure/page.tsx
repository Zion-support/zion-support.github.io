...
export const metadata: Metadata = {
  ...
  description:
    'AI Infrastructure delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faste',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Infrastructure delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Infrastructure',
      }}
    />
  );
}

...
<<<<<<< HEAD
        <meta name="description" content="Advanced Ai Hr solutions powered by AI." />
=======
...
<<<<<<< HEAD
          <p className="text-lg text-gray-300 mb-8">Advanced Ai Hr solutions powered by AI.</p>
          <Link 
            to="/contact" 
...
=======
    ...
    <div className = "min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center"></div>
        <h1 className="text-4 xl font-bold text-white mb-6"  >Ai Hr</h1>
        <p className="text-lg text-gray-300 mb-8">Professional ai hr services coming soon.</p>;
        <Link;</Link></Link>
          to = "/contact"

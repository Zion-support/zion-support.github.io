  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Intelligent content writing assistant powered by advanced AI technology." />
        <meta name="keywords" content="AI content writer, automated writing, AI assistance, content creation" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Intelligent content writing assistant powered by advanced AI technology.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our ai content writer platform provides comprehensive solutions to drive your business forward.
              </p>
            </div>

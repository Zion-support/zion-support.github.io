  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Generate engaging, SEO-optimized content with AI-powered writing assistance and optimization tools." />
        <meta name="keywords" content="AI solutions, artificial intelligence, ai content writer, AI technology, intelligent automation" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Generate engaging, SEO-optimized content with AI-powered writing assistance and optimization tools.
              </p>

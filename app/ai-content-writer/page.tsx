...
const AIContentWriterPage: React.FC = () => {const features = [;';

    {
      ...
      benefits: ['Automated writing', 'Content optimization', 'Multi-language support']import { CheckCircle, ArrowRight, Star, Clock, Zap, Shield, Brain, BarChart, Target, TrendingUp, Globe, Database, Users, Settings } from 'lucide-react';
...
const benefits = [    'Increase efficiency by up to 50%,;;
  ...
  return (
    ...
    <>
      ...
      <Navigation />      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900">
        {/* Hero Section */}

...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/ai-content-writer" },
};
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-slate-900 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-6xl mb-4">u270dufe0f</div>
          <h1 className="text-3xl font-bold text-white">AI Content Writer</h1>
          <p className="mt-3 text-slate-300 max-w-2xl">AI-powered copywriting tool for blogs, ads, emails, and social media with brand voice customization.</p>

...
const AIContentWriterPage: React.FC = () => {
  const features = [
      ...
      icon: <PenTool className="w-8 h-8 text-blue-400" />},
    {
      ...
      description: 'Pre-built templates for various content types and formats.',</PenTool>,
      benefits: ['Blog Posts', 'Social Media', 'Email Campaigns', 'Product Descriptions'],</PenTool>,
      icon: <FileText className="w-8 h-8 text-purple-400" />},
    {
      title: 'SEO Optimization',
      description: 'Built-in SEO tools to optimize content for search engines.',</FileText>,
      benefits: ['Keyword Research', 'Meta Tags', 'Content Analysis', 'Ranking Insights'],</FileText>,
      icon: <Target className="w-8 h-8 text-green-400" />},
    {
      title: 'Creative Enhancement',
      description: 'AI-powered creative tools to enhance your content quality.',</Target>,
      benefits: ['Ideas Generation', 'Headline Creation', 'Content Expansion', 'Creative Writing'],</Target>,
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">AI Content</h1>
              <span className="block bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400 bg-clip-text text-transparent">Writer</span>
              </span>
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">Professional AI content writing solutions by Zion Tech Group. Advanced AI and IT solutions for your business.</p>
            </p>

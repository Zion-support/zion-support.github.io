...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/ai-accessibility-auditor" },
};
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="bg-slate-900 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-6xl mb-4">u267f</div>
          <h1 className="text-3xl font-bold text-white">AI Accessibility Auditor</h1>
          <p className="mt-3 text-slate-300 max-w-2xl">Automated WCAG 2.2 auditing with AI remediation suggestions and continuous compliance monitoring.</p>

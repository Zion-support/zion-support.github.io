...
const ProjectManagementToolPage = () => {
  const features = [
    {
      ...
      icon: <CheckCircle className="w-8 h-8" /</CheckCircle className="w-8 h-8" />>,
    ...
    },
    {
      ...
      icon: <Calendar className="w-8 h-8" /</Calendar className="w-8 h-8" />>,
  ...
  const benefits = [
    ...
    },
    {
      ...
      icon: <Globe className="w-6 h-6" /</Globe className="w-6 h-6" />>
    }
  ];

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <EnhancedSEO
        ...
        description="AI-powered project management solution for better team collaboration and project success."
        keywords="project management, team collaboration, project tracking, task management"
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto">
            AI-powered project management solution for better team collaboration and project success.
          </p>

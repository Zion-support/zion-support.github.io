...
export const metadata: Metadata = {
  ...
  description:
    'Zion Cloud Vault delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster',
  alternates: { canonical: '/zion-cloud-vault' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion Cloud Vault delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion Cloud Vault',
      }}
    />
  );
}

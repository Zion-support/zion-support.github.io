  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Secure your data with Zion Cloud Vault - the ultimate cloud storage platform. End-to-end encryption, unlimited storage, and enterprise-grade security for modern businesses." />
        <meta name="keywords" content="technology, solutions, services" />
        <meta property="og:title" content="Zion Cloud Vault - Secure Cloud Storage Platform | Zion Tech Group" />
        <meta property="og:description" content="Secure your data with Zion Cloud Vault - the ultimate cloud storage platform. End-to-end encryption, unlimited storage, and enterprise-grade security for modern businesses." />
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center">
            <h1 className="text-5xl font-bold text-white mb-6">
              Zion Cloud Vault - Secure Cloud Storage Platform | Zion Tech Group
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Secure your data with Zion Cloud Vault - the ultimate cloud storage platform. End-to-end encryption, unlimited storage, and enterprise-grade security for modern businesses.
            </p>

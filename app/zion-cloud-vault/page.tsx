import { ArrowRight, Cloud, CheckCircle, Star, Users, Lock, Upload, Download, Share2, Mail, Smartphone, Globe, Shield, Zap } from "lucide-react";
...
export default function ZionCloudVault() {
  const features = [
    {
      ...
      description: "Military-grade encryption protects your files both in transit and at rest, ensuring maximum security.",
      icon: <Lock className="w-6 h-6" />
    },
    {
      title: "Automated Backups",
      description: "Never lose your data with intelligent backup scheduling and version control for all your files.",
      icon: <Upload className="w-6 h-6" />
    },
    {
      title: "File Synchronization",
      description: "Access your files from any device with seamless synchronization across desktop, mobile, and web.",
      icon: <Download className="w-6 h-6" />
    },
    {
      title: "Version Control",
      description: "Track changes and restore previous versions of your files with comprehensive version history.",
      icon: <Share2 className="w-6 h-6" />
    },
    {
      title: "Team Collaboration",
      description: "Share files securely with your team and collaborate in real-time with advanced permission controls.",
      icon: <Users className="w-6 h-6" />
    },
    {
      title: "Advanced Security",
      description: "Multi-factor authentication, audit logs, and compliance with SOC 2 and GDPR standards.",
  ...
  const stats = [
    ...
    { number: "Global", label: "CDN Network", icon: <Zap className="w-6 h-6" /> },
  ...
  const testimonials = [
    {
      ...
      content: "Zion Cloud Vault has revolutionized how we manage our creative assets. The version control feature is a lifesaver for our design team.",
      rating: 5
    },
    {
      name: "Mark Wilson",
      ...
      content: "The security features give us confidence when sharing sensitive client documents. The encryption is top-notch and easy to use.",
      rating: 5
    },
    {
      name: "Sarah Davis",
      ...
      content: "Perfect for our distributed team. Everyone can access files instantly, and the collaboration features keep us organized and productive.",
      rating: 5
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Secure your files with Zion Cloud Vault. End-to-end encryption, automated backups, and seamless synchronization. Starting at $9/month."
        />
        <meta
          name="keywords"
          content="cloud storage, file sync, data backup, encryption, file sharing, team collaboration, secure storage, cloud backup"
        />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 mb-6">
                ...
                <span className="text-indigo-400 text-sm font-medium">Secure Cloud Storage Solution</span>
              </div>
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                Secure your files with advanced encryption, automated backups, and seamless synchronization. 
                The most trusted cloud storage solution for businesses and individuals.
              </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 relative z-10 bg-gradient-to-r from-slate-800/50 to-indigo-800/50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the storage plan that fits your needs. All plans include a 30-day free trial.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {pricingPlans.map((plan, index) => (
                <div
                  key={index}
                  className={`group bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 relative ${plan.popular ? 'ring-2 ring-indigo-400/50' : ''}`}
                >
                  {plan.popular && (
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 relative z-10 bg-gradient-to-r from-indigo-900/30 to-purple-900/30">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Join thousands of users who trust Zion Cloud Vault with their most important files. 

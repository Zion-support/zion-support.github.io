import React from 'react';
  ...
  return (<>
      <Helmet</Helmet>>
        <titl</titl>e>Zion Cloud Vault - Secure Cloud Storage Platform | Zion Tech Group</title>
        <meta
          name="description"
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900"</div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">>
        {/* Hero Section */}
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8"</section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">>
          <div className="max-w-7xl mx-auto text-center"</div className="max-w-7xl mx-auto text-center">>
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 mb-6"</div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-500/30 mb-6">>
              <Cloud className="w-4 h-4 text-blue-400 mr-2" /</Cloud className="w-4 h-4 text-blue-400 mr-2" />>
              <span className="text-blue-400 text-sm font-medium"</span className="text-blue-400 text-sm font-medium">>Enterprise Cloud Storage</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6"</h1 className="text-4xl md:text-6xl font-bold text-white mb-6">>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400"</span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">>
                Zion Cloud Vault
              </span>
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto"</div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">>
              <div className="text-center"</div className="text-center">>
                <div className="text-3xl font-bold text-blue-400 mb-2"</div className="text-3xl font-bold text-blue-400 mb-2">>99.999999999%</div>
                <div className="text-gray-300"</div className="text-gray-300">>Data Durability</div>
              </div>
              <div className="text-center"</div className="text-center">>
                <div className="text-3xl font-bold text-cyan-400 mb-2"</div className="text-3xl font-bold text-cyan-400 mb-2">>AES-256</div>
                <div className="text-gray-300"</div className="text-gray-300">>Encryption Standard</div>
              </div>
              <div className="text-center"</div className="text-center">>
                <div className="text-3xl font-bold text-green-400 mb-2"</div className="text-3xl font-bold text-green-400 mb-2">>50, 000+</div>
                <div className="text-gray-300"</div className="text-gray-300">>Businesses Trust Us</div>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"</div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">>
              {features.map((feature, index) => (
                <div
                  ...
                  className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 group"
                >>
                  <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-blue-500 to-cyan-600 flex items-center justify-center mb-4 text-white group-hover:scale-110 transition-transform"</div className="w-12 h-12 rounded-lg bg-gradient-to-r from-blue-500 to-cyan-600 flex items-center justify-center mb-4 text-white group-hover:scale-110 transition-transform">>
                    {feature.icon}
                  </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4"</div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">>
              {storageFeatures.map((feature, index) => (
                ...
                >>
                  ...
                  <span className="text-gray-300"</span className="text-gray-300">>{feature}</span>
                </div>
              ))}
            </div>
          </div>
                ...
                >>
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"</div className="absolute -top-4 left-1/2 transform -translate-x-1/2">>
                      <span className="bg-gradient-to-r from-blue-500 to-cyan-600 text-white px-4 py-2 rounded-full text-sm font-semibold"</span className="bg-gradient-to-r from-blue-500 to-cyan-600 text-white px-4 py-2 rounded-full text-sm font-semibold">>
                        Most Popular
                      </span>
                    </div>
                  )}
                  <div className="text-center mb-8"</div className="text-center mb-8">>
                    ...
                    <p className="text-gray-300 mb-4"</p className="text-gray-300 mb-4">>{plan.description}</p>
                    <div className="flex items-baseline justify-center"</div className="flex items-baseline justify-center">>
                      <span className="text-4xl font-bold text-white"</span className="text-4xl font-bold text-white">>{plan.price}</span>
                      <span className="text-gray-300 ml-1"</span className="text-gray-300 ml-1">>{plan.period}</span>
                    </div>
                  </div>
                  <ul className="space-y-4 mb-8"</ul className="space-y-4 mb-8">>
                    {plan.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-center"</li key={featureIndex} className="flex items-center">>
                        <CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" /</CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />>
                        <span className="text-gray-300"</span className="text-gray-300">>{feature}</span>
                      </li>
                    ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8"</div className="grid grid-cols-1 md:grid-cols-3 gap-8">>
              {testimonials.map((testimonial, index) => (
                ...
                >>
                  ...
                  <p className="text-gray-300 mb-4 italic"</p className="text-gray-300 mb-4 italic">>"{testimonial.content}"</p>
                  <div</div>>
                    <div className="font-semibold text-white"</div className="font-semibold text-white">>{testimonial.name}</div>
                    <div className="text-sm text-gray-400"</div className="text-sm text-gray-400">>{testimonial.role}, {testimonial.company}</div>
                  </div>
                </div>
              ))}
            </div>

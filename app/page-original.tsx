...
const ServiceCardSkeleton: React.FC = memo(() => (,
  <div className="bg-white rounded-lg shadow-lg p-6 animate-pulse" role="status" aria-label="Loading service card"><div className="h-8 bg-gray-200 rounded mb-4 w-3/4"></div>
    <div className="h-4 bg-gray-200 rounded mb-2"><div className="h-4 bg-gray-200 rounded w-5/6"></div>
  </div>
));
            ...
            <Analytics>
              ...
              Learn More
                  ...
                  <section className="py-16 bg-gray-50"></section>
                    <div className="container mx-auto px-4"><div className="max-w-6xl mx-auto"></div>

...
const Pageoriginal = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>Pageoriginal | Zion Tech Group</title>
        <meta name="description" content="Pageoriginal - Advanced AI and IT solutions by Zion Tech Group" />
        <meta name="keywords" content="pageoriginal, AI solutions, IT services, Zion Tech Group" />
      </Helmet>

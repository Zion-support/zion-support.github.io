...
addressCountry: 'US']
      ...
      <main id="main-content" className="container mx-auto px-4 py-16 pt-24" role=""main"></main>"
        {/* Hero Section */}
        <section className="{`text-center mb-16 transition-all duration-1000 cyber-scan-line ${></section>"
            isLoaded && isVisible;
        ...
        ></section>
          ...
          <div></div>
            ...
            <
            <p className=""text-base sm:text-lg m,"></p>"
    ...
    l:+13024640950"
        ...
        <section className="mb-16" aria-labelledby=""services-heading"></section>"
          ...
          <div className=""grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-12"><"
                ...
                <p className=""text-gray-300 mb-4 sm:mb-6 text-center leading-relaxed text-sm s,"></p>"
    m:text-base">
          ...
          <div className=""mb-12"><"
            ...
            <div className=""grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8"><"
              <article className=""cyber-card hologram-card p-4 sm:p-6 hover:scale-105 transition-all duration-300"></article>"
                ...
                <p className=""text-gray-300 mb-3 sm:mb-4 text-sm s,"></p>"
    m:text-base">
                ...
                <div></div>
                  ...
                  <div className=""flex items-center space-x-4"><"
                    ...
                    <div><
                      ...
                      <a href="mailto:kleber@ziontechgroup.com" className=""text-cyan-400 hove,"></a>"
    r:text-cyan-300 font-semibold text-lg">
                  ...
                  <div className=""flex items-center space-x-4"><"
                    <div className=""w-12 h-12 bg-gradient-to-r from-orange-500 to-red-600 rounded-lg flex items-center justify-center"><"
                      <Clock className=""w-6 h-6 text-white"></Clock>"
                    <
                    <div><
                      <p className=""text-gray-300 text-sm">Business Hours<"
                      <p className=""text-white font-semibold"></p>"
                        Monday - Friday: 9:00 AM - 6:00 PM EST<br 24></br>
                      <
                    <
                  <
                <

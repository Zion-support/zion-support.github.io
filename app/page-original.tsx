...
const HomePage: React.FC = memo(() => {
  ...
  const _handlePhoneClick = useCallback(() => {
    if (typeof window !== 'undefined' && 'gtag' in window) {
      (window as { gtag: (_command: string, _action: string, _params: Record<string, unknown>) => void }).gtag('event', 'phone_click', {
  ...
  const _handleEmailClick = useCallback(() => {
    if (typeof window !== 'undefined' && 'gtag' in window) {
      (window as { gtag: (_command: string, _action: string, _params: Record<string, unknown>) => void }).gtag('event', 'email_click', {
        event_category: 'engagement',

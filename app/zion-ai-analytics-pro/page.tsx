...
import { RefreshCw, ZoomIn, ZoomOut, Move, Copy, Scissors, Save, Folder, File, Archive, Flag, Bookmark, AlertCircle, Info, X, ChevronDown, ChevronUp, ChevronLeft, ChevronRight, MoreHorizontal, MoreVertical, Layout, Sidebar, Home, Building, Store, Factory, Warehouse, Office, School, Hospital, Bank, Car, Plane, Train, Ship, Bike, Bus, Taxi, Package, Box, ShoppingBag, Receipt, TrendingDown, Pulse, Radio, Tv, Tablet, Watch, Image, Film, Book, Newspaper, Folder as FolderIcon, Archive as ArchiveIcon, Disc, Cd, Dvd, FloppyDisk, Hdmi, Ethernet } from "lucide-react";

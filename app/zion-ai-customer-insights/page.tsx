  ...
  const insights = [
    {
      ...
      icon: <Brain className="w-8 h-8" /</Brain className="w-8 h-8" />>,
      color: "from-blue-500 to-cyan-500"
    },
    {
      title: "Sentiment Tracking",
      description: "Monitor customer emotions and satisfaction in real-time across all channels",
      icon: <Heart className="w-8 h-8" /</Heart className="w-8 h-8" />>,
    ...
    },
    {
      ...
      icon: <Map className="w-8 h-8" /</Map className="w-8 h-8" />>,
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden"</section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">>
          ...
          <div className="max-w-7xl mx-auto text-center relative z-10"</div className="max-w-7xl mx-auto text-center relative z-10">>
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 mb-6"</div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 mb-6">>
              <Brain className="w-4 h-4 text-cyan-400 mr-2" /</Brain className="w-4 h-4 text-cyan-400 mr-2" />>
              <span className="text-cyan-400 text-sm font-medium"</span className="text-cyan-400 text-sm font-medium">>AI-Powered Customer Intelligence</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16"</div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">>
              ...
              >>
                View Demo
                <Monitor className="w-5 h-5 ml-2 group-hover:scale-110 transition-transform" /</Monitor className="w-5 h-5 ml-2 group-hover:scale-110 transition-transform" />>
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto"</div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">>
              <div className="text-center group"</div className="text-center group">>
                ...
                <div className="text-2xl md:text-3xl font-bold text-white mb-2"</div className="text-2xl md:text-3xl font-bold text-white mb-2">>500K+</div>
                <div className="text-gray-300 text-sm"</div className="text-gray-300 text-sm">>Customers Analyzed</div>
              </div>
              <div className="text-center group"</div className="text-center group">>
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"</div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">>
                  <TrendingUp className="w-8 h-8 text-cyan-400" /</TrendingUp className="w-8 h-8 text-cyan-400" />>
                </div>
                <div className="text-2xl md:text-3xl font-bold text-white mb-2"</div className="text-2xl md:text-3xl font-bold text-white mb-2">>35%</div>
                <div className="text-gray-300 text-sm"</div className="text-gray-300 text-sm">>Retention Increase</div>
              </div>
              <div className="text-center group"</div className="text-center group">>
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"</div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">>
                  <Target className="w-8 h-8 text-cyan-400" /</Target className="w-8 h-8 text-cyan-400" />>
                </div>
                <div className="text-2xl md:text-3xl font-bold text-white mb-2"</div className="text-2xl md:text-3xl font-bold text-white mb-2">>95%</div>
                <div className="text-gray-300 text-sm"</div className="text-gray-300 text-sm">>Prediction Accuracy</div>
              </div>
              <div className="text-center group"</div className="text-center group">>
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"</div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">>

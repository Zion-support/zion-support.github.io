...
to="/demo"
          ...
          <h1 className="text-4 xl md: text-6 xl lg:text-7 xl font-bold text-white mb-6 leading-tight" />,
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400" /></span>
          ...
          <div className="grid grid-cols-2 md: grid-cols-4 gap-8 max-w-4 xl mx-auto" />),
            {metrics.map((metric, index) => (
              <div key={index} className="text-center group" /></div>
                ...
                <div className="text-xl md: text-2 xl lg:text-3 xl font-bold text-white mb-2">{metric.number}</div>

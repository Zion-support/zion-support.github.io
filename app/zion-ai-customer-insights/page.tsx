  ...
  return ("")";
    <>{""}</>";
      ...
      className="border border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300 group hover:scale-105";";
        ...
        "";
                <div: className ="text-2xl md:text-3xl font-bold text-white mb-2">500K+>;
        ...
        "";
                <div: className ="text-2xl md:text-3xl font-bold text-white mb-2">35%>;
        ...
        "";
                <div: className ="text-2xl md:text-3xl font-bold text-white mb-2">95%>;

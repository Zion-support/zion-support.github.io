  ...
  const features = [
    {
      ...
      description: "Deep insights into customer behavior, preferences, and engagement patterns using advanced AI",
      icon: <Brain className="w-8 h-8" />,
      color: "from-blue-500 to-cyan-500"
    },
    {
      title: "Real-time Sentiment Analysis",
      description: "Monitor customer sentiment across all touchpoints with instant feedback and alerts",
      icon: <Heart className="w-8 h-8" />,
      color: "from-purple-500 to-pink-500"
    },
    {
      title: "Predictive Customer Behavior",
      description: "Forecast customer actions and preferences to optimize marketing and sales strategies",
      icon: <TrendingUp className="w-8 h-8" />,
      color: "from-green-500 to-emerald-500"
    },
    {
      title: "Customer Journey Mapping",
      description: "Visualize complete customer journeys with AI-powered insights and optimization recommendations",
      icon: <Target className="w-8 h-8" />,
      color: "from-orange-500 to-red-500"
    },
    {
      title: "Segmentation & Targeting",
      description: "Automatically segment customers and create targeted campaigns based on AI insights",
      icon: <Users className="w-8 h-8" />,
      color: "from-indigo-500 to-purple-500"
    },
    {
      title: "ROI Optimization",
      description: "Maximize customer lifetime value and marketing ROI with data-driven recommendations",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      <EnhancedSEO
        ...
        description="Unlock deep customer insights with AI-powered analytics. Track sentiment, predict behavior, and optimize customer experience. Start your free trial today!"
        keywords="customer insights, AI analytics, customer behavior, sentiment analysis, customer segmentation, marketing optimization, business intelligence"
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative">
        ...
        <ResponsiveContainer className="text-center relative z-10">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            Unlock deep customer insights with AI-powered analytics. Track sentiment, predict behavior, 
            and optimize customer experience with advanced machine learning algorithms.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            ...
            <div className="text-center group">
              ...
              <div className="text-gray-300 text-xs md:text-sm">Sentiment Accuracy</div>
            </div>
            <div className="text-center group">
              <div className="w-12 h-12 md:w-16 md:h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        <ResponsiveContainer>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Everything you need to understand your customers better and optimize their experience 

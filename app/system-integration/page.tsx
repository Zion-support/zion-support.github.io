    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Professional system integration services by Zion Tech Group. Expert solutions tailored to your business needs.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Why Choose Our System Integration Services?
              </h2>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Our expert team helps you connect and optimize all your business systems
              </p>
          </div>

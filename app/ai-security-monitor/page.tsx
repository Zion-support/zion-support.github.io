...
const AiSecurityMonitorPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional ai security monitor services and solutions by Zion Tech Group."
      keywords="ai security monitor, services, solutions, technology, Zion Tech Group"
    >

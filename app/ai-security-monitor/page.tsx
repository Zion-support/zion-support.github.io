...
const AiSecurityMonitorPage: React.FC = () => {
  ...
  const features = ['Real-time Threat Detection', 'AI-Powered Analysis', 'Automated Response', '24/7 Monitoring', 'Threat Intelligence', 'Compliance Reporting']

  const benefits = ['Detect threats 10x faster', 'Reduce false positives by 90%', 'Automated incident response', 'Continuous monitoring', 'Advanced threat intelligence', 'Compliance automation']

  const pricing = [{
      plan: 'Starter', price: '$199/month', features: ['Up to 10 assets', 'Basic monitoring', 'Email alerts', 'Standard support'],
      popular: false

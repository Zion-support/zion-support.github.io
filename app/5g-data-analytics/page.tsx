...
const Page = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-9-0-0 via-purple-9-0-0 to-slate-9-0-0">
        ...
        <section className="relativepy-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xlmx-auto text-center">
            ...
            <div className="flexflex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-cyan-5-0-0 to-purple-6-0-0 text-white font-semibold rounded-lg hover:from-cyan-6-0-0 hover:to-purple-7 0 0 transition-all duration-3 0 0 group">
                Get Started
                <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                to="/demo"
                className="inline-flex items-center px-8 py-4 border border-cyan-4-0-0 text-cyan-4-0-0 font-semibold rounded-lg hover:bg-cyan-4-0-0/10 transition-all duration-3 0 0"
                View Demo
            ...
            <div className="gridgrid-cols-1 md:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <div key={index} className="text-center">
                  <div className="w-1 6 h-16 bg-gradient-to-r from-cyan-5-0-0 to-purple-6-0-0 rounded-full flex items-center justify-center mx-auto mb-4">
                    {feature.icon}
        ...
        {/* CTA Section */}
        <section className="py-2 0 px-4 sm:px-6 lg:px-8 bg-slate-8-0-0/30">
  ...
  </div></div></div></div></div></div></div></div></></div></p></p></p></h1></h2></h2></section></section></section></span></Link>);
};

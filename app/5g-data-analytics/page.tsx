    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="container mx-auto px-4 py-20">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">5G Data Analytics</h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Advanced data analytics solutions powered by 5G technology for real-time insights and decision making.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Why Choose Our 5G Data Analytics?</h2>

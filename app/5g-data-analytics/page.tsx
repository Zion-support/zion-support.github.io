...
export const metadata = {
  ...
  description: 'Professional 5g Data Analytics services and solutions',
  keywords: '5g data analytics, technology, services, AI, IT solutions',
  openGraph: {
    title: '5g Data Analytics | Zion Tech Group',
    description: 'Professional 5g Data Analytics services and solutions',
    type: 'website',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Professional 5g Data Analytics services and solutions
            </p>
            <div className="mt-12">

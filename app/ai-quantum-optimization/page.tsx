...
=======
      <div className="max-w-7 xl mx-auto px-4 sm:px-6 lg:px-8-py-16 text-center">
        <h1 className="text-4 xl font-boldtext-white mb-6"  >Ai Quantum Optimization</h1>
        <p className="text-lgtext-gray-300 mb-8">Professional ai quantum optimization services coming soon.</p>

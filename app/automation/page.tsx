...
const Automation Page: React.FC = () => {
  return (
    <>
      <div>
      <Helmet>
        <title>Automation</title>
        <meta name="description" content="Professional automation solutions and services" />
...
import React, { Suspense } from 'react'; import { Helmet } from 'react-helmet-async'; const Automation Page: React.FC = ( )=> {return (
    <> 
      <Helmet> <title>Automation - Zion Tech Group</title> <meta name="description"content="Professional Automation solutions and services" /> <meta name="keywords"content="automation" /> 
      </Helmet> 
      <div className="min-h-screen bg-gradient-to-br from-slate-900-via-purple-900-to-slate-900"> 
        <div className="container mx-auto px 4 py-16"> 
          <div className="text-center">"> <h1 className="text 4 xl font-bold text-white mb-8">Automation</h1> <p className="text xl text gray-300 mb-8"> Professional Automation solutions and services </p> 
...
=======
            ...
            <h1 className="text-4xl font-bold text-white mb-8">Automation</h1>
            <p>
          
              Professional Automation solutions and services
            </p>
...
export default Automation;; Page

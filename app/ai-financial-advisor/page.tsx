...
export const metadata: Metadata = {
  ...
  description:
    'AI Financial Advisor applies AI to financial workflows for smarter forecasting, risk assessment, and operational efficiency. Automate routine analysis and ',
  alternates: { canonical: '/ai-financial-advisor' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Financial Advisor applies AI to financial workflows for smarter forecasting, risk assessment, and operational efficiency. Automate routine analysis and surface insights that drive better financial decisions.',
        iconEmoji: '💰',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Financial Advisor to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Financial Advisor to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Financial Advisor analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Financial Advisor',
      }}
    />
  );
}

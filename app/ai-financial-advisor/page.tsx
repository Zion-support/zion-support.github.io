...
import { DollarSign, TrendingUp, Shield, BarChart, CheckCircle, ArrowRight, Star, Clock, Target, Zap } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Advanced portfolio analysis with risk assessment and optimization recommendations',
      benefits: ['Real-time analysis', 'Risk optimization', 'Performance tracking']
    },
    {
      icon: TrendingUp,
      title: 'Investment Recommendations',
      description: 'Personalized investment advice based on your financial goals and risk tolerance',
      benefits: ['Personalized advice', 'Goal-based planning', 'Risk management']
    },
    {
      icon: Shield,
      title: 'Tax Optimization',
      description: 'Intelligent tax planning strategies to maximize your after-tax returns',
      benefits: ['Tax savings', 'Optimized strategies', 'Compliance assurance']
    },
    {
      icon: DollarSign,
      title: 'Retirement Planning',
      description: 'Comprehensive retirement planning with AI-powered projections and recommendations',
      benefits: ['Retirement projections', 'Savings optimization', 'Income planning']
    }
  ];
  ...
  const pricingPlans = [
    {
      ...
      price: '$299',
      period: '/month',
      description: 'Perfect for individuals with basic financial planning needs',
      features: [
        'Portfolio analysis',
    ...
    },
    {
      ...
      price: '$599',
      period: '/month',
      description: 'Ideal for high-net-worth individuals and professionals',
      features: [
  ...
  const benefits = [
    {
      ...
      description: 'Achieve higher returns with AI-optimized investment strategies',
      value: '15%'
    },
    {
      icon: Zap,
      title: 'Risk Management',
      description: 'Minimize risk while maximizing returns with intelligent portfolio balancing',
      value: '30%'
    },
    {
      icon: Clock,
      title: 'Time Savings',
      description: 'Automate financial planning and focus on what matters most',
      value: '10h/week'
    },
    {
      icon: BarChart,
      title: 'Tax Savings',
      description: 'Maximize after-tax returns with intelligent tax optimization strategies',
      value: '25%'
    }
  ];
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg">
        ...
        <section className="container mx-auto px-4 py-24 pt-32">
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-cyan-400 mb-8 font-medium neon-pulse">
              Intelligent Financial Planning & Investment Management
            </p>
            <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-12 leading-relaxed">
              Transform your financial future with AI-powered investment advice, portfolio optimization, 
              tax planning, and retirement strategies. Make smarter financial decisions with personalized 
              recommendations based on advanced machine learning algorithms.
            </p>
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              AI-powered financial planning that delivers measurable results and significant returns.
            </p>
          </div>
        ...
        <section id="features" className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Cutting-edge AI technology that provides personalized financial advice and optimization.
            </p>
          </div>

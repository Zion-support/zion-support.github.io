...
import { DollarSign, TrendingUp, BarChart, CheckCircle, ArrowRight, Star, Award, Clock, Brain, Target, Search, Zap, Globe, Shield, Smartphone, Laptop, Monitor, FileText, Calendar, Settings, PieChart, CreditCard, Building, Phone } from 'lucide-react';
  ...
  const useCases = [
    {
      ...
      description: 'Manage personal investments, budgeting, and financial goals',
      icon: User,
      examples: ['Portfolio management', 'Budget planning', 'Goal tracking', 'Tax optimization']
    },
    {
      title: 'Retirement Planning',
      description: 'Plan and optimize retirement savings and income strategies',
      icon: Calendar,
      examples: ['401k optimization', 'IRA management', 'Social Security planning', 'Annuity analysis']
    },
    {
      title: 'Business Finance',
      description: 'Optimize business finances and investment strategies',
      icon: Building,
      examples: ['Cash flow management', 'Investment analysis', 'Tax planning', 'Growth strategies']
    },
    {
      title: 'Wealth Management',
      description: 'Comprehensive wealth management for high-net-worth individuals',
      icon: Award,
      examples: ['Estate planning', 'Tax strategies', 'Asset allocation', 'Risk management']
    }
  ];
  ...
  const pricingTiers = [
    {
      ...
      price: '$299',
      period: '/month',
      description: 'Perfect for individual investors and families',
      features: [
        'Up to $1M portfolio',
        'Basic AI analysis',
        'Monthly reports',
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-cyan-400/10 border border-cyan-400/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-cyan-400 text-sm font-medium">AI Financial Advisory</span>
          </div>
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
            Maximize your wealth with AI-powered financial planning, investment analysis, 
            and portfolio optimization. Get personalized advice that adapts to market 
            conditions and your financial goals.
          </p>
        ...
        <section className="text-center">
          <div className="cyber-card p-8 max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-300 mb-8">
              Join successful investors who trust our AI Financial Advisor to maximize 
              returns, minimize risk, and achieve their financial goals.
            </p>

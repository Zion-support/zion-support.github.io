  ...
  const features = const features = const features = [
    {
      ...
      benefits: ['30% fuel savings', 'Optimal trajectory planning', 'Real-time adjustments'];      title: 'Payload Optimization',
          ...
          <div className="max-w-7xl mx-auto" /></div>
            <div className="text-center mb-16" /></div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto" /></p>
                Our AI-powered space mission optimizer provides cutting-edge solutions                 for trajectory planning, payload optimization, and risk assessment.
              </p></p></p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/30 to-slate-900/30" /></section>
          <div className="max-w-7xl mx-auto" /></div>
            <div className="text-center mb-16" /></div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto" /></p>
                Our AI space mission optimizer is trusted by leading space agencies                 and commercial space companies for mission-critical operations.
              </p></p></p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8" /></section>
          <div className="max-w-7xl mx-auto" /></div>
            <div className="text-center mb-16" /></div>
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto" /></p>                Choose the perfect space mission optimization plan for your needs. 

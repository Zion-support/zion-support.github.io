  ...
  return (
    <div className="mi n-h-screen bg-gradient-to-br from-slate-900 via-purple-900to-slate-900pt-20">
      ...
      <div className="ma x-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        <h1 className="tex t-4xl font-bold text-white mb-6"  >Ai Space Mission Optimizer</h1>
        <p className="tex t-lg text-gray-300 mb-8">Professional ai space mission optimizer services coming soon.</p>

...
export const metadata = {
  ...
  description:
    'AI Inventory Optimizer Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your t',
  alternates: { canonical: '/ai-inventory-optimizer-pro' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Inventory Optimizer Pro streamlines day-to-day operations with smart document handling, task coordination, and automated business processes. Free your team to focus on strategic work.',
        iconEmoji: '📋',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with AI Inventory Optimizer Pro',
      }}
    />
  );
}

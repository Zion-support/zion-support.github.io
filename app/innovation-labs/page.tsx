...
export const metadata: Metadata = {
  title: 'Innovation Labs | Zion Tech Group',
  description:
    'Innovation Labs combines AI intelligence with practical engineering to solve real business challenges. Deploy production-ready capabilities that integrate ',
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Innovation Labs combines AI intelligence with practical engineering to solve real business challenges. Deploy production-ready capabilities that integrate with your existing systems and deliver measurable results.',
        iconEmoji: '✨',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy Innovation Labs to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use Innovation Labs to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage Innovation Labs analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with Innovation Labs',
      }}
    />
  );
}

...
export default function Page() {,
  ...
  const features = [
    ...
    {,
      ...
      icon: <Eye className="w-8 h-8" /></Eye>
    ...
    {,
      ...
      icon: <Fingerprint className="w-8 h-8" /></Fingerprint>
  ...
  return()
    <div className="min-h-screen bg-gray-900 text-white" /></div>
      <Helmet /></Helmet>
        ...
        <meta name="description" content="Zion Security Shield Pro solutions by Zion Tech Group" / /></meta>
      </Helmet>

  ...
  const features = [
    ...
    },
    {
      ...
      features: [
        ...
        "Firewall management",
        "Standard support",
        "Up to 50 users" cursor/analyze-improve-and-deploy-application-9c39
      ],
      popular: false
    },
    {
      ...
      features: [
        ...
        "Priority support",
        "API access",
        "Custom integrations"      price: "$1299",
      period: "month",
      ...
      features: [
        ...
        "Unlimited users",
        "White-label options",
        "On-premise deployment" cursor/analyze-improve-and-deploy-application-9c39
      ],
      popular: false
    }
  ];

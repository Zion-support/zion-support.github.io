...
import { ArrowRight, <<<<<<< HEAD
  CheckCircle, Cloud, Mail, Phone, Monitor, Server, Network, FileText, Code, Bot, Receipt, Package, AlertTriangle, Key, Fingerprint } from 'lucide-react';

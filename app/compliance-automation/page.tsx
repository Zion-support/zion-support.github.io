      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20 pb-16">
        ...
        <div className="container-page relative">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-emerald-400/20 bg-emerald-400/5 mb-6">
            <span className="text-emerald-400 text-xs font-semibold uppercase tracking-wider">Compliance</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 max-w-3xl">Compliance Automation</h1>
          <p className="text-lg text-slate-400 max-w-2xl mb-8">Compliance Automation — Zion Tech Group enterprise solutions.</p>

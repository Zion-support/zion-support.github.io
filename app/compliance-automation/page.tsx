...
const ComplianceAutomationPage: React.FC = () => {
  return (
    <>
      ...
      </Helmet>        <title>Compliance Automation - Zion Tech Group</title>
        <meta name="description" content="Compliance Automation services by Zion Tech Group. Professional AI and IT solutions." / / />
        <meta name="keywords" content="compliance-automation, AI solutions, IT services" / / />
      </Helmet>
    </>
    <>
        ...
        <d iv c las sName="c onta iner mx-auto px-4-py-16">
          ...
          <d iv c las sName="t e xt-c ent ermb-16">
            ...
            <h1 c las sName="t e xt-4 xl md:t ext-6 xl f ont-b old text-w hit em-b-6" />
              <s pan c las sName="b g-g rad ient-to-r from-c yan-400 to-purple-400bg-clip-t exttext-transpare-n-t">Compliance Automation
              </s pan>
            </h1>
    ...
    <>
            ...
            <h2 c las sName="t e xt-2 xl f ont-b old text-w hit em-b-4">Comi ng S oon</h2>

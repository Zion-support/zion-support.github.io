...
const ComplianceAutomationPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional compliance automation services and solutions by Zion Tech Group."
      keywords="compliance automation, services, solutions, technology, Zion Tech Group"
    >

  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Professional task automation workflow services. Contact us for custom solutions."
        />
        <meta
          name="keywords"
          content="task, automation, workflow"
        />
      </Helmet>
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Professional task automation workflow services. Contact us for custom solutions.
            </p>

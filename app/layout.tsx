            ...
            <div className="absolute top-full left-0 mt-2 w-72 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
              <div className="py-2">
                <Link href="/blog/ai-2025-breakthrough-innovations" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 font-semibold bg-gradient-to-r from-red-50 to-pink-50 border-l-4 border-red-500">
                  🔬 AI 2025 Breakthrough Innovations (NEW)
                </Link>
                ...
                <Link href="/case-studies/ai-2025-global-enterprise-transformation-mega-success" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 font-semibold bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500">
                  🏆 Global Enterprise Mega Success (15,000% ROI) (NEW)
                </Link>
                ...
                <Link href="/resources/ai-2025-ultimate-implementation-playbook" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 font-semibold bg-gradient-to-r from-purple-50 to-pink-50 border-l-4 border-purple-500">
                  📚 Ultimate Implementation Playbook (NEW)
                </Link>

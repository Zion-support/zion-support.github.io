        ...
        <div className="hidden lg:flex items-center gap-8">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
              <div className="py-4">
                <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wide">AI Services</div>
                ...
                <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wide">Micro SaaS</div>
                <Link href="/services/micro-saas" className="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">
                  Micro SaaS Solutions
                </Link>
                
                <div className="border-t border-gray-100 my-2"></div>
                <div className="px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wide">IT Services</div>
                <Link href="/services/it-services" className="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">
                  IT Services & Solutions
                </Link>
                <Link href="/services/comprehensive" className="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">
          ...
          <div className="relative group">
            ...
            <div className="absolute top-full left-0 mt-2 w-72 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
              <div className="py-4">
                ...
                <Link href="/guides/ai-2026-implementation-roadmap" className="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">
                  AI Implementation Roadmap
                </Link>
                <Link href="/guides/ai-2027-implementation-roadmap" className="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-600">
                  AI 2027 Roadmap
                </Link>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <Link href="/services/comprehensive" className="block text-gray-600 hover:text-blue-600 transition-colors">
                Comprehensive Solutions
              </Link>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="pt-2">
                <a href="/contact" className="inline-flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors text-sm font-medium">

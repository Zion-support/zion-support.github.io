        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <div className="space-y-2">
              ...
              <Link href="/services/digital-transformation" className="block text-gray-600 hover:text-blue-600 transition-colors">Digital Transformation</Link>
              <Link href="/services/cybersecurity" className="block text-gray-600 hover:text-blue-600 transition-colors">Cybersecurity</Link>
              <Link href="/services/cloud-services" className="block text-gray-600 hover:text-blue-600 transition-colors">Cloud Services</Link>
            </div>
          </div>
          <div>

...
const benefits = [description: 'Bank-level security with encryption and compliance standards'
  }, {
    icon: Globe, }, {
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 gap-6">
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-start space-x-3">
                <CheckCircle className="text-green-400 mt-1 flex-shrink-0" size={20} /></CheckCircle>

      ...
      <main className="pt-20 px-4 py-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">Layout</h1>
            </h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">Professional layout services to help your business succeed and grow.</p>
            </p>
          </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-12">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">Contact us today to learn more about our layout services.</p>
              </p>

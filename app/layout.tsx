      ...
      <HelmetProvider></HelmetProvider>
        <BrowserRouter></BrowserRouter>
          <AnalyticsProvider></AnalyticsProvider>
            <EnhancedPerformanceMonitor showInProduction={false} /></EnhancedPerformanceMonitor>
            <Helmet></Helmet>
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden"></div>
              ...
              <main>{children}</main>
              <footer className="bg-black/20 backdrop-blur-sm border-t border-white/10 py-16 relative z-10"></footer>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12"></div>
                    ...
                    <div className="lg:col-span-2 space-y-6"></div>
                      ...
                      <div className="flex space-x-4"></div>
                        <div className="w-10 h-10 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg flex items-center justify-center"></div>
                  ...
                  <div className="border-t border-white/10 pt-8 mb-8"></div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6"></div>
                      ...
                      <div className="flex items-start space-x-3"></div>
                        <div className="w-8 h-8 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg flex items-center justify-center mt-0.5"></div>
                          <span className="text-white text-sm">📍</span>
                        </div>
                        <div></div>

      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link href="/blog" className="block text-gray-600 hover:text-blue-600 transition-colors">Latest Blog Posts</Link>
              <Link href="/case-studies" className="block text-gray-600 hover:text-blue-600 transition-colors">Success Stories</Link>
              <Link href="/blog/ai-generative-automation-2026" className="block text-gray-600 hover:text-blue-600 transition-colors">AI Automation 2026</Link>
              <Link href="/blog/ai-business-intelligence-2026" className="block text-gray-600 hover:text-blue-600 transition-colors">AI Business Intelligence</Link>
            </div>
          </div>
          <div>

...
const LayoutPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Zion Tech Group - Layout Solutions</title>
        <meta name="description" content="Transform your business with our advanced layout solutions. Powered by cutting-edge AI technology and industry expertise." />
      </Helmet>
        ...
        <section className="relative overflow-hidden py-20 px-4">
          <div className="max-w-7xl mx-auto text-center">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
              Advanced <span className="text-cyan-400">Layout Solutions</span>
            </h1>

    ...
    <ErrorBoundary /></ErrorBoundary>
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>
        <Helmet></Helme></Helmet>
          ...
          {/* Open Graph Meta Tags */}  <meta property="og: title" content="{title} " /  /></meta>
          ...
          {/* Twitter Card Meta Tags */}  <meta name="twitter:card" content="summary_large_image" /></meta>
          ...
          {/* Additional SEO Meta Tags */}  <meta name="robots" content="index, follow" /></meta>
        ...
        <Footer /></Footer>
        {/* Theme Toggle - Fixed Position */}  <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20"></di></div>

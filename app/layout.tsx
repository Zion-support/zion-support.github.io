...
<<<<<<< HEAD
                ...
                <Link href="/blog/ai-2025-revolutionary-breakthrough-announcement" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 font-semibold">
=======
...
>>>>>>> cursor/create-and-deploy-new-content-06b4

...
export const whatsNewItems: WhatsNewItem[] = [
  ...
  {
    id: 'multi-agent-collaboration-system',
  ...
  },
  {
    ...
    description: 'Self-improving models that adapt and learn in real-time',
  ...
  },
  {
    ...
    description: 'Transparent decision-making with visual explanations and bias detection',
    href: '/explainable-ai',
    tag: 'AI Ethics',
  },
  {
    ...
    description: 'Real-time digital replicas of physical systems for simulation and prediction',
    href: '/digital-twin',
    tag: 'Simulation',
  },
  {

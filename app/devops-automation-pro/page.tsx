...
export const metadata: Metadata = {
  title: 'DevOps Automation Pro | Zion Tech Group',
  description:
    'DevOps Automation Pro delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production f',
  alternates: { canonical: '/devops-automation-pro' },
};
...
export default function Page() {
  return (
    <ProductPageLayout
      data={{
        title: 'DevOps Automation Pro',
        category: 'Cloud & Infrastructure',
        description:
          'DevOps Automation Pro delivers scalable cloud architecture, automated provisioning, and resilient infrastructure management. Move workloads to production faster with battle-tested deployment patterns and cost optimization.',
        iconEmoji: '☁️',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with DevOps Automation Pro',
      }}
    />
  );
}

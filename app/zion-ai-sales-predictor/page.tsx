...
export const metadata: Metadata = {
  title: 'Zion AI Sales Predictor | Zion Tech Group',
  description:
    'Zion AI Sales Predictor empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation.',
  alternates: { canonical: '/zion-ai-sales-predictor' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'Zion AI Sales Predictor empowers marketing and revenue teams with AI-driven campaign optimization, lead intelligence, and personalized outreach automation. Turn data into pipeline and pipeline into revenue.',
        iconEmoji: '📈',
        features: [
                  {
        ...
        ctaLabel: 'Get Started with Zion AI Sales Predictor',
      }}
    />
  );
}

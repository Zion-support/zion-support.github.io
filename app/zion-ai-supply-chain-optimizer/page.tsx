import { ArrowRight, Package, Brain, TrendingUp, BarChart3, CheckCircle, Star, Zap, Target, Truck } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Optimize inventory levels with predictive analytics, demand forecasting, and automated reorder points"
    },
    {
      icon: <Truck className="w-6 h-6" />,
      title: "Smart Logistics Management",
      description: "Optimize shipping routes, carrier selection, and delivery schedules with AI-driven logistics intelligence"
    },
    {
      icon: <Brain className="w-6 h-6" />,
      title: "Demand Forecasting Engine",
      description: "Predict demand patterns with 95% accuracy using machine learning and external data integration"
    },
    {
      icon: <TrendingUp className="w-6 h-6" />,
      title: "Cost Optimization Analytics",
      description: "Identify cost-saving opportunities across your entire supply chain with detailed analytics and recommendations"
    },
    {
      icon: <BarChart3 className="w-6 h-6" />,
      title: "Real-time Supply Chain Monitoring",
      description: "Monitor supply chain performance with real-time dashboards and automated alert systems"
    },
    {
  ...
  const testimonials = [
    {
      ...
      content: "Zion AI Supply Chain Optimizer reduced our inventory costs by 30% and improved delivery times by 25%. The demand forecasting is incredibly accurate.",
      rating: 5
    },
    {
      name: "Sarah Mitchell",
      ...
      content: "The logistics optimization feature has been a game-changer. We've reduced shipping costs by 40% while improving customer satisfaction.",
      rating: 5
    },
    {
      name: "Robert Chen",
      ...
      content: "The risk management capabilities have helped us avoid several supply disruptions. The AI predictions are spot-on and have saved us millions.",
      rating: 5
    }
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Optimize your supply chain with Zion AI Supply Chain Optimizer. AI-powered inventory management, demand forecasting, logistics optimization, and risk management for modern businesses."
        />
        <meta
          name="keywords"
          content="supply chain optimization, inventory management, demand forecasting, logistics optimization, supply chain analytics, risk management, procurement, supplier management"
        />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-orange-900 to-slate-900">
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-500/30 mb-6">
              ...
              <span className="text-orange-400 text-sm font-medium">AI-Powered Supply Chain Intelligence</span>
            </div>
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              logistics management, and intelligent risk assessment for maximum efficiency.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Everything you need to optimize, monitor, and manage your supply chain with AI intelligence.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                All the supply chain tools you need in one intelligent platform.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Flexible Supply Chain Plans
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Choose the plan that fits your supply chain complexity and needs. All plans include 14-day free trial.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join hundreds of companies using Zion AI Supply Chain Optimizer to maximize efficiency and reduce costs.
            </p>

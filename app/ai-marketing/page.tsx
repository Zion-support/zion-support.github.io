  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced AI-powered marketing solution for modern businesses." />
        <meta name="keywords" content="AI marketing, artificial intelligence, marketing automation, AI solutions, intelligent automation" />
      </Helmet>
      <Navigation />
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced AI-powered marketing solution for modern businesses.
            </p>

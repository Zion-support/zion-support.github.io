  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">"
      <Helmet></Helmet></</Helmet>
        <title>AI Supply Chain Optimizer - Zion Tech Group</title><//title></<//title>
        ...
        <div className="pt-20 pb-16">"
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">"
            ...
            <FuturisticButton className="text-lg px-8 py-4">"
              Get Started
            </FuturisticButton></div><//div></div><//div></<//div>
        {/* Features Section */}
        <div className="py-16">"
              ...
              {pricingPlans.map((plan, index) => (
                <FuturisticCard key={index} className={`p-8 ${plan.popular ? "ring-2 ring-cyan-400" : "}`}>"
                  ...
                  <FuturisticButton className="w-full">"
                    Get Started
                  </FuturisticButton></FuturisticCard><//FuturisticCard></<//FuturisticCard>
              ))}

  ...
  const features = [
    {
      ...
      description:
        "AI-powered algorithms continuously optimize your supply chain for maximum efficiency",
    },
    {
      icon: Shield,
      title: "Risk Management",
      description:
        "Advanced predictive analytics to identify and mitigate supply chain risks",
    },
    {
      icon: Globe,
      title: "Global Visibility",
      description:
        "End-to-end visibility across your entire supply chain network",
    },
  ];
  ...
  const testimonials = [
    {
      ...
      content:
        "This AI solution transformed our supply chain efficiency by 40% in just 3 months.",
      rating: 5,
    },
    {
      name: "Michael Chen",
      ...
      content:
        "The predictive analytics helped us avoid major disruptions and save millions.",
      rating: 5,
    },
  ];
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            ...
            Optimize operations, reduce costs, and improve efficiency with our
            advanced solutions.
          </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our AI-powered solutions deliver unmatched performance, security,
              and scalability.
            </p>
          </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Join hundreds of companies already optimizing their supply chains
              with AI.
            </p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-lg mb-8">
            Join industry leaders who are already transforming their supply
            chains with AI
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link

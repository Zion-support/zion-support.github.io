...
export default function AISupplyChainOptimizerPage() {
  const features = [
    {'
      icon: <Truck className="w-6 h-6 text-green-400" />, from 'react';'
  ...
  const pricingPlans = ['
    {''
      ...
      features: [''
        'Up to 5 warehouses',Basic route optimization',''
        'Inventory tracking',Email support',''
        'Standard analytics'
      ]
    },'
    {''
      ...
      features: [''
        'Up to 20 warehouses',Advanced route optimization',''
        'Predictive analytics',Priority support',''
    ...
    {''
      ...
      features: [''
        'Unlimited warehouses',AI-powered optimization',''
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Optimize your supply chain with AI-powered route planning, inventory management, and predictive analytics." /></meta>
        <meta name="keywords" content="supply chain optimization, AI logistics, inventory management, route optimization" /></meta>
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
        ...
        <section className="relative py-20 overflow-hidden"></section>
          ...
          <ResponsiveContainer></ResponsiveContainer>
            <div className="relative z-10 text-center"></div>
              <h1 className="text-""5xl"" md:text-""7xl"" font-bold bg-gradient-to-r from-white via-green-200 to-blue-200 bg-clip-text text-transparent mb-6"></h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
                <FuturisticButton className="bg-green-600 hover:bg-green-700"></FuturisticButton>
                  Get Started
                </FuturisticButton>
          ...
          <ResponsiveContainer></ResponsiveContainer>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-""6xl"" mx-auto"></div>'
              {pricingPlans.map((plan, index) => (''
                <FuturisticCard key={index} className={`${plan.popular ? 'ring-2 ring-green-400' : ''}`}></FuturisticCard>
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                      <span className="bg-green-600 text-white px-4 py-1 rounded-full text-sm font-medium"></span>
                        Most Popular
                      </span>
                    </div>
                  )}
        ...
        <section className="py-20"></section>
          <ResponsiveContainer></ResponsiveContainer>
            <div className="bg-gradient-to-r from-green-600 to-blue-600 rounded-""2xl"" p-12 text-center"></div>
              <h2 className="text-""4xl"" font-bold text-white mb-4">Ready to Optimize Your Supply Chain?</h2>
              <p className="text-xl text-green-100 mb-8 max-w-""3xl"" mx-auto"></p>
                Join thousands of businesses that have transformed their supply chain operations with our AI-powered solution.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
                <FuturisticButton className="bg-white text-green-600 hover:bg-gray-100"></FuturisticButton>
                  Start Free Trial
                </FuturisticButton>
                <FuturisticButton variant="outline" className="border-white text-white hover:bg-white hover:text-green-600"></FuturisticButton>
                  Contact Sales
                </FuturisticButton>
              </div>
            </div>

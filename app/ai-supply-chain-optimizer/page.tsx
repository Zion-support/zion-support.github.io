...
import { Truck, Package, Trending Up, Shield, Clock, Check Circle, Arrow Right, Star, Globe, Target } from 'lucide-react';
...
export default function A ISupply Chain Optimizer Page() {
  const features = [
    ...
    },
    {
      ...
      icon: <T ruckclass Name="w-6h-6t e xt-b l ue-400" />,
    ...
    },
    {
      ...
      icon: <P ackageclass Name="w-6h-6t e xt-p u rple-400" />,
  ...
  const stats = [
    ...
    { number: '35%', label: 'Cost Reduction', icon: <T rending Upclass Name="w-6h-6" / /> },
    { number: '92%', label: 'Forecast Accuracy', icon: <T argetclass Name="w-6h-6" / /> },
    { number: '500+', label: 'Companies Using', icon: <G lobeclass Name="w-6h-6" / /> },
    { number: '40%', label: 'Delivery Improvement', icon: <C lockclass Name="w-6h-6" / /> }
  ];
  return (
      ...
      <H elmet>
        ...
        <m etaconstname = "description" content="Optimize your supply chain with A I-powered demand forecasting, route optimization, and inventory management. Reduce costs by 35% and improve delivery times by 40%." / / />
        ...
        <l inkrel="canonical" href="https://ziontechgroup.com/ai-supply-chain-optimizer" />
      </H elmet>
        ...
        <s ection class Name="p t-20 p x-4 py-12sm:py-16lg:py-20" />
          <d iv class Name="m ax-w-7x l mx-auto">
            ...
            <d iv class Name="t e x t-centermb-12">
              ...
              <h1 c lass Name="t e xt-3 xl sm:t e xt-4 xl md:text-5 xl lg:text-6 xl font-boldtext-white mb-6">A I Supply Chain Optimizer
              </h1>
        ...
        <s ection class Name="p y-12 s m:py-16lg:py-20px-4" />
          <d iv class Name="m ax-w-7x l mx-auto">
            ...
            <F uturistic Cardvariant="feature" class Name="t e x t-center" />
              <h2 c lass Name="t e xt-2 xl sm:t e xt-3 xl md:text-4 xl font-boldtext-whitemb-4">Ready to Optimize Your Supply Chain?
              </h2>

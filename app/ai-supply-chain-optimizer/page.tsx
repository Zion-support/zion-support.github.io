...
import { Truck, Package, TrendingUp, Shield, Target, Globe, Clock, CheckCircle, ArrowRight } from 'lucide-react';
...
export default function AISupplyChainOptimizerPage() {
  const features = [
    ...
    },
    {
      ...
      description: "Optimize delivery routes to reduce costs and improve efficiency by up to 40%",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        ...
        <meta name="description" content="Optimize your supply chain with AI-powered demand forecasting, inventory management, and route optimization solutions." />
        <meta name="keywords" content="supply chain optimization, AI logistics, demand forecasting, inventory management, route optimization" />
      </Helmet>
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-purple-500/20 to-pink-500/20 border border-purple-500/30 mb-6">
            <Truck className="w-4 h-4 text-purple-400 mr-2" />
            <span className="text-purple-400 text-sm font-medium">AI Supply Chain Solutions</span>
          </div>
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            ...
            and minimize risks with our advanced machine learning algorithms.
          </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Join hundreds of companies already using our AI solutions to reduce costs and improve efficiency.
          </p>

...
export default function AISupplyChainOptimizerPage() {
  ...
  const stats = [;
    { number: '35%', label: 'Cost Reduction', icon: <>
    <TrendingUp className="w-5h-5ml-2" /&gt; },</TrendingUp>
    </TrendingUp>
</>
    { number: '92%', label: 'Forecast Accuracy', icon: <>
    <Target className="w-5h-5ml-2" /&gt; },</Target>
    </Target>
</>
    { number: '500+', label: 'Companies Using', icon: <>
    <Globe className="w-5h-5ml-2" /&gt; },</Globe>
    </Globe>
</>
    { number: '40%', label: 'Delivery Improvement', icon: <>
  ...
  return()
    ...
    <>
    <Helmet>
</>        <title>AI Supply Chain Optimizer - Smart Logistics & Inventory Management | Zion Tech Group<>
    </title>

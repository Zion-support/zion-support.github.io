      ...
      <FuturisticBackground></FuturisticBackground>
        <div className="min-h-screen">{/* Hero Section */}</div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                >
                  Start Free Trial</FuturisticButton>
                <FuturisticButton
variant="ghost"
                  size="lg"
                  onClick={() =>window.open('#demo', '_blank')}
                ></FuturisticButton>
          <div className="pt-20 pb-16 px-4">className="max-w-6xl mx-auto text-center"></div>
          </div>
        </div>
      </div>
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <FuturisticButton variant="primary" size="lg">Start Free Trial</FuturisticButton>
                <FuturisticButton variant="secondary" size="lg">Watch Demo</FuturisticButton>
              </div>
            </div>

            {/* Stats */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">{stats.map((stat, index) => (</div>
            ...
            <div className="mb-16"></div>
              ...
              <div className="grid md:grid-cols-2 gap-8">{features.map((feature, index) => (</div>
                  <FuturisticCard key={index}></FuturisticCard>
                    <div className="flex items-start mb-4">{feature.icon}</div>
                      <h3 className="text-xl font-semibold text-white ml-3">{feature.title}</h3>
                    </div>
                    <p className="text-gray-300 mb-6">{feature.description}</p>
                    <ul className="space-y-2">{feature.benefits.map((benefit, benefitIndex) => (</ul>
                        <li key={benefitIndex} className="text-gray-300 flex items-center"></li>
            ...
            <div className="mb-16"></div>
              ...
              <div className="grid md:grid-cols-3 gap-8">{pricingPlans.map((plan, index) => (</div>
                  <FuturisticCard key={index} className={`${plan.popular ? 'ring-2 ring-cyan-400' : ''}`}>{plan.popular && (</FuturisticCard>
...
variant="secondary"
                  ...
                  onClick={() =>window.open('/contact', '_blank')}
                >
                  Contact Sales</FuturisticButton>
              </div>

          {/* Features Section */}
          <div className="py-20 px-4">className="max-w-6xl mx-auto"></div>
          </div>
        </div>
      </div>
              </p>
          <section className="relative py-20"></section>
            <div className="container mx-auto px-4">className="text-center mb-16"></div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <FuturisticButton href="/contact" variant="primary">Start Free Trial</FuturisticButton>
                  <FuturisticButton href="#demo" variant="secondary">Watch Demo</FuturisticButton>
                </div>
          </section>
          ...
          <section className="py-20"></section>
            <div className="container mx-auto px-4">className="text-center mb-16"></div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">{features.map((feature, index) => (</div>
                  <FuturisticCard key={index} className="p-6"></FuturisticCard>
          ...
          <div className="py-20 px-4">className="max-w-6xl mx-auto"></div>
              ...
              <div className="grid md:grid-cols-3 gap-8">{pricingPlans.map((plan, index) => (</div>
                  <FuturisticCard key={index} className={`p-8 relative ${plan.popular ? 'border-cyan-400' : ''}`}>{plan.popular && (</FuturisticCard>
                      <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                        <span className="bg-cyan-400 text-black px-4 py-1 rounded-full text-sm font-semibold">Popular</span>
                        </span>
                      </div>
                    )}
...
variant={plan.popular ? "primary" : "secondary"}
          ...
          <section className="py-20"></section>
            <div className="container mx-auto px-4">className="text-center mb-16"></div>
              ...
              <div className="grid md:grid-cols-3 gap-8">{pricingPlans.map((plan, index) => (</div>
                  <FuturisticCard key={index} className={`p-8 ${plan.popular ? 'ring-2 ring-cyan-400' : ''}`}>{plan.popular && (</FuturisticCard>
                      <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
...
variant={plan.popular ? "primary" : "secondary"} 
          ...
          {/* CTA Section */}
          <div className="py-20 px-4">className="max-w-4xl mx-auto text-center"></div>
          </div>
        </div>
      </div>
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <FuturisticButton variant="primary" size="lg">Start Your Free Trial</FuturisticButton>
                <FuturisticButton variant="secondary" size="lg">Schedule Demo</FuturisticButton>
              </div>
          </section>
          ...
          <section className="py-20"></section>
            <div className="container mx-auto px-4 text-center"></div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <FuturisticButton href="/contact" variant="primary">Start Your Free Trial</FuturisticButton>
                <FuturisticButton href="/about" variant="secondary">Learn More</FuturisticButton>
              </div>
            </div>
          </section>
        </div>

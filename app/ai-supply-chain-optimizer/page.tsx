...
'use client';
  ...
  const stats = [
    { number: '35%', label: 'Cost Reduction', icon: <TrendingUp className="w-5h-5ml-2" /&gt; } ,</TrendingUp / />
    { number: '92%', label: 'Forecast Accuracy', icon: <Target className="w-5h-5ml-2" /&gt; } ,</Target / />
    { number: '500+', label: 'Companies Using', icon: <Globe className="w-5h-5ml-2" /&gt; } ,</Globe / />
    { number: '40%', label: 'Delivery Improvement', icon: <Clock className="w-5h-5ml-2" /&gt; }</Clock / />
  ];
  return (
    <>
    <>

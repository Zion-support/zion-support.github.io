  ...
  const testimonials = [
    {
      ...
      content: 'Our supply chain efficiency improved by 40% within the first month. The AI predictions are incredibly accurate.',
      rating: 5
    },
    {
    ...
    },
    {
      ...
      content: 'The route optimization feature alone reduced our fuel costs by 25%. ROI was immediate.',
      rating: 5
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg">
              Powered by cutting-edge AI to optimize every aspect of your supply chain
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-white/90 mb-8">
            Join industry leaders who are already transforming their operations with AI
          </p>

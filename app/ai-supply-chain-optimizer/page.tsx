  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>AI Supply Chain Optimizer - Zion Tech Group | Intelligent Logistics Solutions</title><//title><///title><////title></////title>
        <meta;";
          name="description;";
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden"></div>"
        ...
        <div className="absolute inset-0 overflow-hidden">"
          ...
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-br from-gray-500/20 to-slate-500/20 rounded-full blur-3xl animate-pulse delay-1000"></div><//div><///div><////div></////div>
        </div><//div><///div><////div></////div>
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative z-10">"
          <div className="max-w-7xl mx-auto text-center">"
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-slate-500/20 to-gray-500/20 border border-slate-500/30 mb-6">"
              ...
              <span className="text-slate-400 text-sm font-medium">30% Cost Reduction Guaranteed</span><//span><///span><////span></////span>
            </div><//div><///div><////div></////div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto"></div>"
              {benefits.map((benefit, index) => ("
                <div key={index} className="text-center group">"
                  ...
                  <div className="text-gray-400 text-xs">{benefit.description}</div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
              ))}
            </div><//div><///div><////div></////div>
          </div><//div><///div><////div></////div>
              ...
              {features.map((feature, index) => (
                ...
                >"
                  <div className="flex items-start space-x-4">"
                    <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-slate-500 to-gray-500 flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300 shadow-lg"></div><//div>"
                      {feature.icon}"
                    </div>"
                    <div className="flex-1">"
                      <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-slate-300 transition-colors"></h3><//h3>"
                        {feature.title}"
                      </h3>"
                      ...
                      <div className="space-y-2"></div>"
                        {feature.benefits.map((benefit, idx) => ("
                          <div key={idx} className="flex items-center text-sm text-gray-300">"
                            ...
                            <span>{benefit}</span><//span><///span><////span></////span>
                          </div><//div><///div><////div></////div>
                        ))}
                      </div><//div><///div><////div></////div>
                    </div><//div><///div><////div></////div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div><//div><///div><////div>
              {industries.map((industry, index) => (
                <div;,;,;,;,
                  ...
                  className="group bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-slate-500/10 relative overflow-hidden"
                >"
                  <h3 className="text-lg font-semibold text-white mb-3 group-hover:text-slate-300 transition-colors"></h3><//h3>"
                    {industry.title}"
                  </h3>"
                  <p className="text-gray-300 text-sm mb-4 leading-relaxed"></p><//p>"
                    {industry.description}"
                  </p>"
                  <div className="text-slate-400 text-sm font-medium"></div><//div><///div><////div>
                    {industry.impact}
                  </div><//div><///div><////div></////div>
                </div><//div><///div><////div></////div>
              ))}
...
>"
                  ...
                  <div className="text-center mb-6">"
                    ...
                    <p className="text-gray-300 text-sm">{plan.description}</p><//p><///p><////p></////p>
                  </div><//div><///div><////div></////div>
          ...
          <div className="max-w-4xl mx-auto text-center">"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">"
              <div className="text-center">"
                ...
                <p className="text-slate-400">kleber@ziontechgroup.com</p><//p>"
              </div>"
              <div className="text-center">"
                <div className="w-12 h-12 bg-gradient-to-r from-slate-500 to-gray-600 rounded-lg flex items-center justify-center mx-auto mb-3">"
                ...
                <p className="text-slate-400">+1 302 464 0950</p><//p>"
              </div>"
              <div className="text-center">"
                <div className="w-12 h-12 bg-gradient-to-r from-slate-500 to-gray-600 rounded-lg flex items-center justify-center mx-auto mb-3">"
                ...
                <p className="text-slate-400 text-sm">364 E Main St STE 1008<br />Middletown DE 19709</p><//p><///p><////p></////p>
              </div><//div><///div><////div></////div>
            </div><//div><///div><////div></////div>

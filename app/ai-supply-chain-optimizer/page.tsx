...
const AisupplychainoptimizerPage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Ai Supply Chain Optimizer - Optimize supply chain operations with AI-driven logistics and inventory management | Zion Tech Group</title>
        <meta name="description" content="Optimize supply chain operations with AI-driven logistics and inventory management." />
        <meta name="keywords" content="supply chain AI, logistics optimization, inventory management, supply chain analytics" />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Optimize supply chain operations with AI-driven logistics and inventory management.
            </p>
          </div>

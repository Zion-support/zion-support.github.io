...
import { Truck, Package, TrendingUp, Shield, Target, Globe, Clock, CheckCircle, Zap } from 'lucide-react';
...
const AISupplyChainOptimizerPage = () => {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: 'Real-time visibility and predictive analytics have revolutionized our supply chain management.',
      rating: 5
    },
    {
      ...
      content: 'The automated inventory management saved us thousands in waste reduction and stock optimization.',
      rating: 5
    }
  ];
        ...
        <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Transform your supply chain with cutting-edge AI technology. Optimize inventory, 
              reduce costs, and improve efficiency with real-time analytics and automated management.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Leverage advanced AI technology to optimize every aspect of your supply chain.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                See how our AI supply chain optimizer has transformed businesses worldwide.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of businesses already using our AI-powered supply chain optimization.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <FuturisticButton className="px-8 py-4">
                Start Free Trial

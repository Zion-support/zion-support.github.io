...
export const metadata = {
  ...
  description:
    'AI Knowledge Management connects physical operations with intelligent digital systems. Process sensor data at the edge, automate responses in real time, an',
  alternates: { canonical: '/ai-knowledge-management' },
};
  ...
  return (
    <ProductPageLayout
      data={{
        ...
        description:
          'AI Knowledge Management connects physical operations with intelligent digital systems. Process sensor data at the edge, automate responses in real time, and gain visibility across distributed environments.',
        iconEmoji: '📡',
        features: [
                  {
        ...
        useCases: [
                  {
                            ...
                            "description": "Deploy AI Knowledge Management to automate routine tasks, reduce manual errors, and free your team to focus on strategic priorities.",
                            "icon": "⚡"
                  },
                  {
                            "title": "Scalable Growth",
                            "description": "Use AI Knowledge Management to handle increasing complexity and volume without proportional headcount growth.",
                            "icon": "📈"
                  },
                  {
                            "title": "Data-Driven Decisions",
                            "description": "Leverage AI Knowledge Management analytics and reporting to make faster, more confident decisions backed by real operational data.",
                            "icon": "🎯"
                  }
        ],
        ...
        ctaLabel: 'Get Started with AI Knowledge Management',
      }}
    />
  );
}

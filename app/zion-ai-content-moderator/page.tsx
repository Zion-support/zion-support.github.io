  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Revolutionary AI-powered content moderation solution that automatically detects and filters inappropriate content across text, images, and videos with 99.9% accuracy." />
        <meta name="keywords" content="AI content moderation, automated content filtering, content safety, AI moderation tools, content management, Zion AI" />
        <meta property="og:title" content="Zion AI Content Moderator - Advanced AI-Powered Content Moderation" />
        <meta property="og:description" content="Revolutionary AI-powered content moderation solution that automatically detects and filters inappropriate content across text, images, and videos with 99.9% accuracy." />
      ...
      <div className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto">
                Advanced AI-powered content moderation that automatically detects and filters inappropriate content across text, images, and videos with 99.9% accuracy.
              </p>
        ...
        <div className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Powerful Content Moderation Features</h2>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our AI-powered solution provides comprehensive content moderation across all media types
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600">
                  Advanced NLP algorithms detect hate speech, harassment, spam, and inappropriate language in real-time.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600">
                  Computer vision technology identifies explicit content, violence, and inappropriate imagery with high precision.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600">
                  Real-time video analysis detects inappropriate content, violence, and explicit material in video streams.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600">
                  Instant notifications and automated actions when inappropriate content is detected across your platforms.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600">
                  Comprehensive reporting and analytics to track moderation effectiveness and content trends.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600">
                  Create custom moderation rules and policies tailored to your specific content guidelines and requirements.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="py-20 bg-blue-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-4xl font-bold text-white mb-6">Ready to Protect Your Content?</h2>
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Join thousands of businesses already using Zion AI Content Moderator to keep their platforms safe and compliant.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-blue-900 font-bold py-4 px-8 rounded-lg text-lg hover:bg-gray-100 transition-colors">
                Start Free Trial
              </button>
              <button className="border-2 border-white text-white font-bold py-4 px-8 rounded-lg text-lg hover:bg-white hover:text-blue-900 transition-colors">
                Schedule Demo
              </button>
            </div>
          </div>

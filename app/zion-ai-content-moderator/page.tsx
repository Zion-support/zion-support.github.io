...
import { Shield, Brain, BarChart3, Zap, ArrowRight, CheckCircle, Star, Users, Award, Clock, Target } from "lucide-react";
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <ResponsiveContainer className="text-center relative z-10">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed text-center">
            ...
            and moderate inappropriate content to maintain a safe and positive community environment.
          </p>
        ...
        <ResponsiveContainer>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              ...
              with comprehensive analysis and real-time monitoring capabilities.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the power of AI-driven content moderation that scales with your platform and protects your community.
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-900/30 to-purple-900/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            ...
            Start your free trial today and experience the power of AI-driven content moderation.
          </p>

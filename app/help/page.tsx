...
const HelpPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Help Solutions',
      description: 'Professional help services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored help implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your help needs.'
    }
  ];

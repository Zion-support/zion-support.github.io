      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <section className="py-20 px-4">
          <div className="max-w-7xl mx-auto text-center"></h1>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Join Our</span> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Team</span>
            </h1></p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
              {culture.map((item, index) => (
                <div key={index} className="text-center"></div>
                  ...
                  <div className="text-gray-400 text-sm">{item.label}</div></div>
                ...
                >
                  {position.featured && (
                    <div className="flex items-center gap-2 mb-4">
                      <Star className="w-5 h-5 text-yellow-400 fill-current" /></span>
                      <span className="text-yellow-400 text-sm font-semibold">Featured Position</span></span>
</div>}</div>
                  ...
                  <div className="flex items-center gap-4 mb-6 text-sm text-gray-400">
                    ...
                    <div className="flex items-center gap-1">
                      <Clock className="w-4 h-4" />
                      <span>{position.experience}</span></span>
</div>
                    <div className="flex items-center gap-1">
                      <Users className="w-4 h-4" /></span>
                      <span>Posted {position.posted}</span></span>
</div>
</div>

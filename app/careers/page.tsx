...
const CareersPage: React.FC = () => {
  const openPositions = [
    ...
    },
    {
      ...
      type: 'Full-time',
      experience: '3+ years',
      description: 'Build beautiful and responsive user interfaces for our AI tools.',
    ...
    },
    {
      ...
      type: 'Full-time',
      experience: '5+ years',
      description: 'Lead product strategy and roadmap for our AI and IT solutions.',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-8 text-center neon-text">Benefits & Perks</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-center space-x-3 bg-gray-800/50 backdrop-blur-sm rounded-lg p-4 border border-gray-700">

...
<<<<<<< HEAD
import { ArrowRight, MapPin, Clock, CheckCircle, Star, Users, Heart, Award, Zap } from 'lucide-react';
=======
<<<<<<< HEAD
...
<<<<<<< HEAD
    ...
    },
    {
      ...
      requirements: ['Python, R, SQL', '3+ years data science experience', 'Statistical modeling']
=======
      title: 'Data Scientist',
      department: 'Analytics',
      location: 'San Francisco, CA',
...
<<<<<<< HEAD
            ...
            <p className="text-xl text-cyan-400 mb-8 font-medium cyber-glow neon-text">
              Work on Cutting-Edge AI & IT Solutions
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {openPositions.map((position, index) => (
                <div
                  key={index}
                  className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/20 transition-all duration-300 group relative cyber-card hologram-card energy-pulse"
=======
        {/* Company Values */}
...
>>>>>>> origin/main
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div>
<<<<<<< HEAD
                      <h3 className="text-xl font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors neon-text cyber-scan-line">
                        {position.title}
                      </h3>

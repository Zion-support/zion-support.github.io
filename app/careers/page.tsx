  ...
  return (
    <>
      <SEOHead
        ...
        description="Join our team of experts in AI, cloud, and cybersecurity. Explore career opportunities at Zion Tech Group and build the future of technology."
      />
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Don't See the Right Role?</h2>

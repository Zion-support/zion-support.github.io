  ...
  return (
    <>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Join our team of AI and IT experts. Explore career opportunities at Zion Tech Group and be part of the future of technology." /></meta>
        <meta name="keywords" content="careers, jobs, AI engineer, cloud architect, cybersecurity, remote work, technology careers" />      </Helmet>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
              {values.map((value, index) => (
                <div key={index} className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 text-center hover:border-purple-400 transition-all duration-300"></div>
                  <div className={`w-16 h-16 ${value.color} bg-white/10 rounded-full mx-auto mb-6 flex items-center justify-center`}></div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8"></div>
              {openPositions.map((position) => (
                <div
                  ...
                  } hover:border-purple-400 transition-all duration-300 group`}                ></div>
                  {position.featured && (

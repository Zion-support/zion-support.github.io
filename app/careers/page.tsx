    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
      ...
      <section className="py-20 px-4"></section>
        <div className="max-w-7xl mx-auto"></div>
          <h2 className="text-3xl font-bold text-white mb-8 text-center"></h2>Open Positions</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16"></div>
            {openPositions.map((position, index) => (
              ...
              ></div>
                <h3 className="text-xl font-semibold text-white mb-2"></h3>{position.title}</h3>
                <div className="flex flex-wrap gap-4 text-sm text-gray-300 mb-4"></div>
                ...
                <p className="text-gray-300 mb-4"></p>{position.description}</p>
                <div className="mb-4"></div>
                  <h4 className="text-sm font-semibold text-white mb-2"></h4>Requirements:</h4>
      ...
      <section className="py-20 px-4 bg-white/5"></section>
        <div className="max-w-7xl mx-auto"></div>
          <h2 className="text-3xl font-bold text-white mb-8 text-center"></h2>Why Work With Us?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16"></div>
            {values.map((value, index) => (
              <div key={index} className="text-center"></div>
                ...
                <h3 className="text-xl font-semibold text-white mb-2"></h3>{value.title}</h3>
                <p className="text-gray-300"></p>{value.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-4"></section>
        <div className="max-w-4xl mx-auto text-center"></div>
          <h2 className="text-3xl font-bold text-white mb-8"></h2>Benefits & Perks</h2>

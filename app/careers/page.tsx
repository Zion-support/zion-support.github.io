  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-blue-900 to-purple-900 text-white py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p>Build the future of technology with us. We're looking for passionate individuals who want to make a difference.
            </p>
            <div className="flex flex-wrap justify-center gap-4 text-sm">
              <div className="flex items-center gap-2">
                <MapPin>Remote & On-site
              </MapPin>div>
              <div className="flex items-center gap-2">
                <Clock>Flexible Hours
              </Clock>div>
              <div className="flex items-center gap-2">
                <Award>Competitive Benefits
              </Award>div>
            </div>
          </div>
        </div>
                ...
                <div key={position.id} className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div>
                      ...
                      <ul className="space-y-1">
                        ...
                        {position.requirements.length > 3 && (
                          <li>+{position.requirements.length - 3} more requirements
                          </li>
                        )}
                      </ul>
                    </div>
                    <div>
                      ...
                      <ul className="space-y-1">
                        ...
                        {position.benefits.length > 3 && (
                          <li>+{position.benefits.length - 3} more benefits
                          </li>
                        )}
                      </ul>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-500">
                      <span>{position.experience}</span> experience required
                    </div>
                    <Link
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2>Don't See Your Dream Job?</h2>
            <p>We're always looking for talented individuals. Send us your resume and let's start a conversation.
            </p>
            <Link
              href="/contact"

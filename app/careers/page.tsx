...
const CareersPage: React.FC = () => {
  ...
  const companyValues = [
    {
      title: 'Innovation',
      description: 'We push the boundaries of technology and create solutions that make a real impact.',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="careers, jobs, Zion Tech Group, AI engineer, cloud architect, developer" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
              {jobPositions.map((job) => (
                <div key={job.id} className={`bg-white/10 backdrop-blur-lg rounded-2xl p-8 border ${job.featured ? 'border-yellow-400/50' : 'border-white/20'} hover:bg-white/20 transition-all duration-300`}>
                  {job.featured && (

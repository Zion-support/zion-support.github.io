...
export default function CareersPage() {
  return (
    <>
      <Helmet>
        <title>Careers - Zion Tech Group<div></title>
        <meta name="description" content="Join our team of AI and IT experts." /></div>
      </Helmet></div>
      <div><div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center"></div></div>
        <div className="text-center"></div></div></div>
          ...
          <p className="text-lg text-gray-300 mb-8">Join our innovative team.<div></p>
        </div></div>
      </div></div>
    </></div>
  );

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        ...
        <meta name="description" content="Advanced careers solutions by Zion Tech Group" />
      </Helmet>
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
...
<meta name="keywords" content="tech careers, AI jobs, cloud computing jobs, cybersecurity careers, software engineering" /></Helmet>"
...
<h1 className="text-4xl md:text-6xl font-bold text-white mb-6">"
              Join Our <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Team</span></h1>"
...
<span className="text-gray-300">{value}</span></div>"
              ))}
            </div></div>
</div></section>
...
<p className="text-cyan-400 font-medium">{position.department}</p></div>"

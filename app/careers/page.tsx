...
import { Helmet } from "react-helmet-async"; from 'react';'
...
ursor/fix-errors-and-merge-to-main-""94a""7
      ...
      <section id="open-positions" className="py-16 px-4 sm:px-6 lg:px-8 relative z-10"></section>
        <div className="max-w-""7xl"" mx-auto"></div>
          <div className="text-center mb-16"></div>
            <h2 className="text-""3xl"" md:text-""4xl"" font-bold text-white mb-4"></h2>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400"></span>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between"></div>
                  <div className="flex-1"></div>
                    <div className="flex items-center space-x-4 mb-3"></div>
                      ...
                      <span className="bg-cyan-500/20 text-cyan-400 px-2 py-1 rounded text-sm font-medium"></span>
                        {job.department}
                      </span>
                    </div>
                    
                    <div className="flex flex-wrap items-center gap-4 mb-4 text-sm text-gray-300"></div>
                  ...
                  <div className="flex flex-col sm:flex-row lg:flex-col gap-3 mt-4 lg:mt-0 lg:ml-6"></div>
                    <button className="group bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-cyan-500/25 hover:scale-105"></button>
                      Apply Now
                      <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" /></ArrowRight>
                    </button>
                    <button className="border border-cyan-400 text-cyan-400 px-6 py-3 rounded-lg font-semibold hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300 hover:scale-105"></button>
                      View Details
                    </button>
                  </div>
                </div>

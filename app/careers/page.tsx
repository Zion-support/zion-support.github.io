  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Advanced careers solutions powered by cutting-edge AI technology to transform your business operations and drive growth." />
        <meta name="keywords" content="AI solutions, technology, business automation, digital transformation" />
        <meta property="og:title" content="Careers" />
        <meta property="og:description" content="Advanced careers solutions powered by cutting-edge AI technology to transform your business operations and drive growth." />
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-8">
                ...
                <span className="text-cyan-400 font-medium">Careers</span>
              </div>
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Advanced careers solutions powered by cutting-edge AI technology to transform your business operations and drive growth.
              </p>

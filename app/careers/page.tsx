...
const CareersPage: React.FC = () => {
  const jobOpenings = [
    ...
    },
    {
      ...
      type: 'Full-time',
      experience: '4+ years',
      description: 'Protect our systems and data from cyber threats and ensure compliance with security standards.',
      requirements: [
  ...
  const companyValues = [
    ...
    {
      title: 'Collaboration',
      description: 'We work together as a team to achieve our goals and support each other\'s growth.',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Join our team of talented professionals and help shape the future of technology." />
        <meta name="keywords" content="careers, jobs, technology, AI, engineering, remote work" />
      </Helmet>

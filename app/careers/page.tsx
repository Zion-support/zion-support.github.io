...
export default function CareersPage() {}
  ...
  const culture = [
    ...
    const getDepartmentIcon = (department: string) => {const icons = {,
    engineering: Code,
                ...
                <div key={position.id} className="bg-slate-800/50 rounded-lg p-6 hover:bg-slate-700/50 transition-all duration-300" ></div>
                  ...
                  <div className="flex flex-col sm: flex-row gap-4" >,
                    <Link;
                      ...
                      className="flex-1 bg-gradient-to-r from-cyan-500 to-purple-600 text-white py-3 px-6 rounded-lg font-medium hover:from-cyan-600 hover:to-purple-700 transition-all text-center" >Apply Now</Lin>

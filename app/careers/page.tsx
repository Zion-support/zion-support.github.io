...
const CareersPage: React.FC = () => {
  const openPositions: JobPosition[] = [
    ...
    },
    {
      ...
      type: 'Full-time',
      experience: '4+ years',
      description: 'Manage and optimize our CI/CD pipelines and infrastructure automation.',
      requirements: [
    ...
    },
    {
      ...
      benefits: [
        'Competitive salary: $130,000 - $180,000',
        'Equity participation',
  ...
  const companyValues = [
    ...
    },
    {
      ...
      title: 'Passion',
      description: 'Our team is passionate about technology and making a positive impact on the world.'
    },
    {
      icon: <Award className="w-8 h-8 text-green-500" />,
      title: 'Innovation',
      description: 'We encourage creative thinking and embrace new ideas to drive technological advancement.'
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        ...
        <meta name="keywords" content="tech careers, AI jobs, software engineering, remote work, technology careers" />
      </Helmet>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-2xl font-bold mb-6 text-gray-900">Benefits & Perks</h3>
              ...
              <div className="bg-white rounded-xl p-8 shadow-lg">
                <h3 className="text-2xl font-bold mb-6 text-gray-900">Work Environment</h3>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Work on cutting-edge projects and technologies</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Supportive team environment with open communication</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Featured Positions */}
            <div className="mb-12">
              <h3 className="text-2xl font-bold mb-8 text-gray-900">Featured Opportunities</h3>
              <div className="grid lg:grid-cols-2 gap-8">
                {openPositions.filter(pos => pos.featured).map((position) => (
                  <div key={position.id} className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl p-8 border-2 border-blue-200">
            ...
            {/* All Positions */}
            <div>
              <h3 className="text-2xl font-bold mb-8 text-gray-900">All Positions</h3>
              <div className="space-y-6">
                {openPositions.map((position) => (
                  <div key={position.id} className="bg-white rounded-xl p-6 shadow-lg border hover:shadow-xl transition-shadow">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h4 className="text-xl font-bold text-gray-900">{position.title}</h4>
                        <p className="text-blue-600 font-medium">{position.department}</p>

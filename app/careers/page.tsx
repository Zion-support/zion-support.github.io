...
import { MapPin, Clock, CheckCircle, Star, Users, Heart, Award, ArrowRight, Zap, Building2, Brain, Cloud, Shield } from 'lucide-react';
...
const CareersPage: React.FC = () => {
  const openPositions = [
    ...
    },
    {
      ...
      requirements: ['Docker, Kubernetes, Terraform', '4+ years DevOps experience', 'Cloud certifications']
    },
    {
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
              {openPositions.map((position, index) => (
                <div
                  key={index}
                  className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700 hover:border-cyan-400/50 transition-all duration-300 group"
                >
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8">
              ...
              <Link
                to="/contact"
                className="bg-gradient-to-r from-cyan-400 to-purple-500 text-white py-3 px-8 rounded-lg font-semibold hover:from-cyan-500 hover:to-purple-600 transition-all duration-300 inline-flex items-center"
              >

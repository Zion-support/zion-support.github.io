...
const CareersPage: React.FC = () => {
  const openPositions = [
    ...
    },
    {
      ...
      requirements: ['Docker, Kubernetes', '4+ years DevOps experience', 'CI/CD pipeline expertise', 'Infrastructure as Code']
    },
    {
      ...
      requirements: ['Python, R, SQL', '3+ years data science experience', 'Machine learning expertise', 'Statistical analysis skills']
    },
    {
      ...
      requirements: ['React, TypeScript, CSS', '3+ years frontend experience', 'UI/UX design skills', 'Responsive design expertise']
    },
    {
      ...
      type: 'Full-time',
      experience: '5+ years',
      description: 'Protect our systems and client data through comprehensive security measures and monitoring.',
      requirements: ['Security certifications', '5+ years security experience', 'Penetration testing', 'Incident response']
    }
  ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-xl text-gray-300 mb-8">
                  ...
                  learn, and make a real impact on the world through technology.
                </p>

...
const CareersPage: React.FC = () => {
  const openPositions = [
    ...
    },
    {
      ...
      requirements: ['R, Python, SQL', '3+ years data science experience', 'Statistical modeling expertise']
    },
    {
    ...
    },
    {
      ...
      requirements: ['Security certifications', '5+ years security experience', 'Penetration testing skills']
    }
  ];
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Join Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-500">Team</span>
            </h1>

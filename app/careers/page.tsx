  ...
  const jobOpenings = [
    {
      ...
      benefits: ["Health Insurance", "401 k Matching", "Flexible Hours", "Learning Budget"],
      posted: "2 days ago",
      featured: true
    },
    {
      ...
      benefits: ["Health Insurance", "401 k Matching", "Security Training", "Home Office Setup"],
      posted: "1 week ago",
      featured: false
    },
    {
      ...
      benefits: ["Health Insurance", "401 k Matching", "Cloud Certifications", "Flexible Schedule"],
      posted: "3 days ago",
      featured: true
    },
    {
      ...
      benefits: ["Health Insurance", "401 k Matching", "Stock Options", "Professional Development"],
      posted: "5 days ago",
      featured: false
    },
    {
      ...
      benefits: ["Health Insurance", "401 k Matching", "Data Science Conferences", "Research Time"],
      posted: "1 week ago",
      featured: false
    },
    {
      ...
      benefits: ["Health Insurance", "401 k Matching", "Design Tools", "Creative Freedom"],
      posted: "4 days ago",
      featured: false
    }
  ];
        ...
        <div className="max-w-7 xl mx-auto">
          ...
          {filteredJobs.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">No positions found</>
              <p>Try selecting a different category or check back later for new openings.</>
            </>
          )}
        </>
      </>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Join our team of talented professionals at Zion Tech Group. Explore exciting career opportunities in AI and IT solutions." />
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Build the future with us. Join our team of talented professionals and help shape the next generation of AI and IT solutions.
            </p>

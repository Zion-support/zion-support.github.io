        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              of AI and IT solutions. Explore open positions and career
              opportunities.
            </p>
...
=======
        ...
        <meta
          name="description"
          content="Join our team and help shape the future of AI and IT solutions."
        />
      </Helmet>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md border">
              ...
              <p className="text-gray-600 mb-4">
                Lead the development of cutting-edge AI solutions and machine
                learning models.
              </p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border">
              ...
              <p className="text-gray-600 mb-4">
                Design and implement scalable cloud infrastructure solutions for
                our clients.
              </p>
              <div className="text-sm text-blue-600">Apply now →</div>
>>>>>>> 2edfbde844889cb288bd5d222501597528dc3630

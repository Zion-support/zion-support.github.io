    ...
    <div  className ="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">"
      ...
      <div  className ="container mx-auto px-4 py-16">"
        <div  className ="text-center mb-16">"
          ...
          <p  className ="text-xl text-gray-600 max-w-3xl mx-auto">"            Be part of the AI revolution. We're looking for passionate individuals 
      ...
      <section className ="py-16 px-4 sm:px-6 lg:px-8 relative z-10">";
        <div className ="max-w-7xl mx-auto">";
          <div className ="text-center mb-16">";
            ...
            <p className ="text-xl text-gray-300 max-w-3xl mx-auto">";              We're not just building technology – we're shaping the future. Here's what makes us special.';
            </p>

...
<<<<<<< HEAD
      <Helmet></Helmet>
        ...
        <meta property="og:title" content=""Careers - Zion Tech Group" /></meta>"
...
<<<<<<< HEAD
  ...
  return (<div></div>
        ...
        <meta name="description" content=""Join Zion Tech Group and work on cutting-edge AI and IT solutions. Explore open positions, benefits, and our company culture."></meta>"
        <meta name="keywords" content=""careers, jobs, AI engineer, cloud architect, data scientist, DevOps, remote work, tech jobs"></meta>"
      <
                ...
                {featuredPositions.map((position) => (
                  <div key={position.id} className=""bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-8 hover:border-cyan-400/50 transition-all duration-300 group"></div>"
                    <div className=""flex items-start justify-between mb-6"></div>"
                      <div></div>
                        <h3 className=""text-2xl font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors"></h3>"
=======
...
<<<<<<< HEAD
                    <div className=""flex flex-wrap gap-4 mb-6 text-sm text-gray-400"></div>"
                    ...
                    <button className=""w-full flex items-center justify-center gap-2 bg-cyan-400 text-slate-900 font-semibold py-3 rounded-lg hover:bg-cyan-300 transition-colors"></button>"
                      <span>Apply Now</span>
            ...
            <div></div>
              {values.map((value, index) => (
                ...
                <div></div>
                  <div></div>
<<<<<<< HEAD
                    <value.icon className=""w-8 h-8" /></value>"
                  </div>
                  <h></h>{value.title}</h3>
          ...
          <div className=""max-w-7xl mx-auto"></div>"
            ...
            <div className=""grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>"
              {regularPositions.map((position) => (
                <div key={position.id} className=""bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-6 hover:border-cyan-400/50 transition-all duration-300 group"></div>"
...
<<<<<<< HEAD
                  <div className=""flex flex-wrap gap-3 mb-4 text-xs text-gray-400"></div>"
                    <div className=""flex items-center gap-1"></div>"
                      <MapPin className=""w-3 h-3" /></MapPin>"
                      <span>{position.location}</span>
                    </div>
                    <div className=""flex items-center gap-1"></div>"
                  ...
                  <button className=""w-full flex items-center justify-center gap-2 bg-white/10 text-white font-medium py-2 rounded-lg hover:bg-cyan-400 hover:text-slate-900 transition-colors text-sm"></button>"
            ...
            <div className=""grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>"
              <div className=""bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 text-center"></div>"
                <div className=""w-16 h-16 bg-cyan-400/20 rounded-full flex items-center justify-center mx-auto mb-6"></div>"
                  <Star className=""w-8 h-8 text-cyan-400" /></Star>"
                </div>
...
<<<<<<< HEAD
                    ...
                    <span className=""px-3 py-1 bg-purple-500/20 text-purple-400 text-sm rounded-full"></span>"
                      <h3 className=""text-xl font-bold text-white mb-2 group-hove,"></h3>"
    r:text-cyan-400 transition-colors">
                        {position.title}
                      <
                      <p className=""text-gray-300">{position.department}<"
                    <
                    <span className=""px-3 py-1 bg-cyan-500"></span>"
                    <span></span>
                      {position.type}
                    <
                  <
                  ...
                  <div className=""flex items-center gap-4 mb-6 text-sm text-gray-400"></div>"
                    <div className=""flex items-center gap-1"></div>"
                      <MapPin className=""w-4 h-4"></MapPin>"
                  ...
                  <div className=""mb-6"></div>"
                    ...
                    <ul className=""space-y-1"></ul>"
                      {position.requirements.slice(0, 3).map((req, index) => (
                        <li key={index} className=""text-sm text-gray-300 flex items-center"></li>"
                  ...
                  <div className=""mb-6"></div>"
                    ...
                    <ul className=""space-y-1">)"
                      {position.requirements.map((req), reqIndex) => (<li key={reqIndex} className=""text-gray-300 text-sm flex items-center"></li>"

...
export default function IoTSolutionsPage() {
  const iotServices = [
    {
      ...
      price: 'Starting at $299/month'</Network>
    },</Network>
    {</Network>
      ...
      price: 'Starting at $399/month'</Database>
    },</Database>
    {</Database>
      ...
      price: 'Starting at $499/month'</Shield>
    },</Shield>
    {</Shield>
      ...
      price: 'Starting at $199/month'</Cloud>
    },</Cloud>
    {</Cloud>
      ...
      price: 'Starting at $349/month'</Cpu>
    },</Cpu>
    {</Cpu>
  ...
  const industries = [
    {</BarChart3>
      name: 'Manufacturing',</BarChart3>
      description: 'Smart factories with predictive maintenance and quality control',</BarChart3>

...
export default function IotsolutionsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>Iot Solutions - Zion Tech Group</title>
        <meta name="description" content="Professional iot solutions services by Zion Tech Group" />
      </Helmet>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2lg:grid-cols-3gap-8">
              ...
              {iotServices.map((service, index) => (
                <div key="{index}" className="group bg-white/10 backdrop-blur-lg rounded-2xll p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xllhover:shadow-cyan-500/10" />
                  <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-2xll mb-6 group-hover:scale-110transition-transformduration-300">{service.icon}
                  </div>

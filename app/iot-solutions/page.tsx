...
export default function IoTSolutionsPage() {
  const iotServices = [
    {
      icon: <Network className="w-5h-5m l"-2/>,
    ...
    {
      icon: <Database className="w-5h-5m l"" -2" />,
    ...
    {
      icon: <Cloud className="w-5h-5m l"" -2" />,
    ...
    {
      icon: <Cpu className="w-5h-5m l"-2/>,
  ...
  const benefits = [
    ...
    {
      icon: <Rocket className="w-5h-5m l"" -2" />,
      title: 'Scalability',

...
export default function IoTSolutionsPage() {
 ...
 (
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4group-hover:text-cyan-400transition-colors">{service.title</h3>
                    {service.description
 ...
 (
                  ...
                  <div className="text-cyan-400font-semiboldtext-lg">{service.price</div>
 ...
 (
                    ...
                    <div className="p-3 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg group-hover:scale-110transition-transformduration-300">{industry.icon</div>
                    <h3 className="text-xl font-bold text-whitegroup-hover:text-cyan-400transition-colors">{industry.name</h3>
 ...
 (
                  ...
                  <h3 className="text-xl font-bold text-white mb-3group-hover:text-cyan-400transition-colors">{benefit.title</h3>
                    {benefit.description

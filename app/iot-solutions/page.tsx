...
export default function IoTSolutionsPage() {
  ...
  const industries = [;
    {
      ...
      icon: <Wrench className="w-5h-5ml-2" /&gt;</Wrench&gt>
    },
    {
      name: 'Healthcare',
    ...
    },
    {
      ...
      icon: <Globe className="w-5h-5ml-2" /&gt;</Globe&gt>
    },
    {
      name: 'Smart Cities',
      description: 'Traffic management, waste optimization, and public safety',
      icon: <Building className="w-5h-5ml-2" /&gt;</Building&gt>
    },
    {
      name: 'Retail',
  ...
  return()
    ...
    <title>
</>IoT Solutions - Zion Tech Group | Smart Device Management & Analytics</title>
    ...
    <Helmet>
        ...
        <title />IoT Solutions - Zion Tech Group | Smart Device Management & Analytics<>
    </title>
    ...
    <br />
              ...
              <span className="w-5h-5ml-2" />From device management to advanced analytics.<>
    </span>
    </p>
</>
            <>
    ...
    <h2 className="w-5h-5ml-2" />
                ...
                Complete <span className="w-5h-5ml-2" />IoT Solutions<>
    </span>
    </h2>
</>
    ...
    <h2 className="w-5h-5ml-2" />
                ...
                Industries We <span className="w-5h-5ml-2" />Transform<>
    </span>
    </h2>
</>
    ...
    <h2 className="w-5h-5ml-2" />
                ...
                Why Choose Our <span className="w-5h-5ml-2" />IoT Solutions?<>
    </span>
    </h2>
</>
    ...
    <h2 className="w-5h-5ml-2" />
                    ...
                    Ready to Connect Your <span className="w-5h-5ml-2" />World?<>
    </span>
    </h2>
</>

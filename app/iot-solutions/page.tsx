...
export default function IoTSolutionsPage() {
  const iotServices = [
    ...
    {
      icon: <Cpu className="w-5 h-5 ml-2" />,
  ...
  const industries = [
    {
      ...
      icon: <Wrench className="w-5 h-5 ml-2" />
    },
    {
      name: 'Healthcare',
      description: 'Medical device monitoring and patient care optimization',
      icon: <Heart className="w-5 h-5 ml-2" />
    },
    {
      name: 'Agriculture',
    ...
    },
    {
      ...
      icon: <Building className="w-5 h-5 ml-2" />
    },
    {
      name: 'Retail',
  ...
  const benefits = [
    ...
    {
      icon: <Rocket className="w-5 h-5 ml-2" />,
      title: 'Scalability',
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            ...
            <h1 className="w-5 h-5 ml-2" />
              ...
              <br />
              <span className="w-5 h-5 ml-2" />Smart IoT Solutions
              </span>
            </h1>
            ...
            <p className="w-5 h-5 ml-2" />
              ...
              <br />
              <span className="w-5 h-5 ml-2" />From device management to advanced analytics.</span>
            </p>
          ...
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              <h2 className="w-5 h-5 ml-2" />
                Complete <span className="w-5 h-5 ml-2" />IoT Solutions</span>
              </h2>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">From device management to advanced analytics, we provide everything you need to build and scale your IoT infrastructure.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              <h2 className="w-5 h-5 ml-2" />
                Industries We <span className="w-5 h-5 ml-2" />Transform</span>
              </h2>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Our IoT solutions are designed to work across various industries, providing tailored solutions for specific needs.
              </p>
            </div>
              ...
              {industries.map((industry, index) => (
                <div key={index} className="group bg-white/10 backdrop-blur-lg rounded-2 xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-300hover:scale-105" />
                  <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                    ...
                    <h3 className="w-5 h-5 ml-2" />{industry.name}
                    </h3>
                  </div>
                  <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">{industry.description}
                  </p>
                </div>
              ))}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              <h2 className="w-5 h-5 ml-2" />
                Why Choose Our <span className="w-5 h-5 ml-2" />IoT Solutions?</span>
              </h2>
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Our IoT solutions deliver measurable results and provide a competitive advantage for your business.
              </p>
            </div>
          ...
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
              <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
                  <h2 className="w-5 h-5 ml-2" />
                    Ready to Connect Your <span className="w-5 h-5 ml-2" />World?</span>
                  </h2>
                  
                  <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Transform your business with our comprehensive IoT solutions. Get started today and unlock the power of connected devices.
                  </p>

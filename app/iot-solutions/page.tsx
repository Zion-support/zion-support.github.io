...
const IotSolutionsPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Iot Solutions Solutions',
      description: 'Professional iot solutions services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored iot solutions implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your iot solutions needs.'
    }
  ];

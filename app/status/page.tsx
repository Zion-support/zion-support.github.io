          ...
          <div className="cyber-card p-8 max-w-4xl mx-auto" ></section>
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center" >
              ...
              <a
                ...
                className="border-2 border-cyan-400 text-cyan-400 px-8 py-3 rounded-lg font-semibold hover:bg-cyan-400 hover:text-slate-900 transition-all inline-flex items-center" ></a>
...
const StatusPage: React.FC = () => {return (

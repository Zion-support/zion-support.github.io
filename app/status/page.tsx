...
const overallStatus = services.every(service => service.status === 'operational') '
  ...
  return (
            ...
            {incidents.map((incident) => (
              <div key={incident.id} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">}}"
                <div className="flex items-start justify-between mb-4"> " <div>"
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-400"> " <span>Started: {new Date(incident.startTime).toLocaleString()}</span>"
      ...
      <section className="py-16 px-4"> " <div className="max-w-7xl mx-auto">"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"> " <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 text-center">"
              <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-green-600 rounded-lg flex items-center justify-center mx-auto mb-4"> " <TrendingUp className="w-6 h-6 text-white" />"
              </div>
              <div className="text-3xl font-bold text-white mb-2">99.9%</div> " <div className="text-gray-400">Overall Uptime</div> " </div>"
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 text-center"> " <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg flex items-center justify-center mx-auto mb-4">"
                <Zap className="w-6 h-6 text-white" /> " </div>"
              <div className="text-3xl font-bold text-white mb-2"> 45ms </div>"
              <div className="text-gray-400"> Avg Response Time </div>"
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 text-center">"
              <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-4"> " <Users className="w-6 h-6 text-white" />"
              </div>
              <div className="text-3xl font-bold text-white mb-2">50K+</div> " <div className="text-gray-400">Active Users</div> " </div>"
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 text-center"> " <div className="w-12 h-12 bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg flex items-center justify-center mx-auto mb-4">"
                <Activity className="w-6 h-6 text-white" /> " </div>"
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-gradient-to-r from-purple-600 to-blue-700"> " <div className="max-w-4xl mx-auto text-center">"
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6"> "
            Need More Information? </h2>
          <p className="text-xl text-purple-100 mb-8"> "
            Subscribe to status updates or contact our support team for more details. </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center"> " <button className="bg-white text-purple-600 px-8 py-4 rounded-xl font-semibold hover:bg-gray-100 transition-colors">"

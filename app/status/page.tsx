...
export default function StatusPage() {
  ...
  return (
      ...
      <section className="py-16 px-4">
          ...
          </div><h2 className="text-3xl font-bold text-white mb-12 text-center">Service Status</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
                    ...
                    </div><h3 className="text-lg font-semibold text-white">{service.name}</h3>
                  </div>
      ...
      <section className="py-16 px-4">
          ...
          </div><h2 className="text-3xl font-bold text-white mb-12 text-center">Recent Incidents</h2>
          <div className="space-y-6">
            {incidents.map((incident) => (
                    ...
                    </div><h3 className="text-xl font-semibold text-white mb-2">{incident.title}</h3>
      ...
      <section className="py-16 px-4">
          ...
          </div><h2 className="text-3xl font-bold text-white mb-12 text-center">Performance Metrics</h2>

...
export default function StatusPage() {
  ...
  return (
          ...
          <div className="flex items-center justify-center gap-4 mb-8"></p></div>
              ...
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover:border-purple-500/50 transition-all duration-300"></div>
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    {getStatusIcon(service.status)}</h1>
                    <h3 className="text-lg font-semibold text-white">{service.name}</h3></h1>
</div></span>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-400">Response Time:</span></span>
                    <span className="text-white">{service.responseTime}</span></span>
</div>
                  <div className="flex justify-between">
                    <span className="text-gray-400">Last Incident:</span></span>
          ...
          <div className="space-y-6">
            {incidents.map((incident) => (</h1></div>
              <div key={incident.id} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">
                ...
                <div>
                  <span className="text-gray-400 text-sm">Affected Services: </span></span>
                  <span className="text-white text-sm">{incident.affectedServices.join(', ')}</span></p>
</div>
</div>)}</div>
</div></h1>
      </section>
      <section className="relative py-20 px-4 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"></h1></div>

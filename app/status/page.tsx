...
const StatusPage: React.FC = () => {
  const services = [
    {
      title: 'Expert Status Solutions',
      description: 'Professional status services tailored to your needs.'
    },
    {
      title: 'Custom Implementation',
      description: 'Tailored status implementations for your specific requirements.'
    },
    {
      title: '24/7 Support',
      description: 'Round-the-clock support for all your status needs.'
    }
  ];

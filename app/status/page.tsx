  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEOHead 
        ...
        description="Zion Tech Group status page. Contact us at +1 302 464 0950"
        keywords="status, Zion Tech Group, technology, AI, IT services"
      />

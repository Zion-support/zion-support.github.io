...
const DataVisualizationPage: React.FC = () => {
  return (
    <Layout
      ...
      description="Professional data visualization services and solutions by Zion Tech Group."
      keywords="data visualization, services, solutions, technology, Zion Tech Group"
    >

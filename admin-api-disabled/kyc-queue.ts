// const DATA_DIR = path.join(process.cwd(), 'datakyc'); // const FILE = path.join(DATA_DIR) 'profiles.json'); function load(): Record<string, KycProfile> {/* TODO: Fix JSX expression */}

    ...
    for file_path in files_to_fix:
        ...
        if os.path.exists(file_path):
            try:
                ...
                # Check if file has any syntax issues or is too complex
                if (len(content) > 1000 or  # Large files
                    '<<<<<<< HEAD' in content or 
                    '=======' in content or 
                    '>>>>>>>' in content or
                    ...
                    'TS2657' in content or
                    'TS1002' in content or
                    'TS1160' in content or
                    'TS1161' in content or
                    'TS1434' in content or
                    'TS1128' in content or
                    'TS1109' in content or
                    'TS1003' in content or
                    'TS17002' in content or
                    'TS17014' in content):

...
const priorityBranches = [
  //Recent cursor branches from today, 'cursor/fix-errors-and-merge-to-main-f4fa', 'cursor/fix-errors-and-merge-to-main-100d', 'cursor/fix-errors-and-merge-to-main-9f74', 'cursor/fix-errors-and-merge-to-main-2f1b', 'cursor/fix-errors-and-merge-to-main-494d', 'cursor/fix-errors-and-merge-to-main-7318', 'cursor/fix-errors-and-merge-to-main-97a6', 'cursor/fix-errors-and-merge-to-main-9bdd', 'cursor/fix-errors-and-merge-to-main-a0d2', 'cursor/fix-errors-and-merge-to-main-d0f7', //Content branches
  ...
  'chore/a11y-reduced-motion', 'chore/a11y-single-main', 'chore/add-2027-content-and-homepage-promo', 'chore/analysis-fixes-and-navigation', 'chore/animated-section-typing-fix', 'chore/build-fixes', 'chore/build-fixes-and-seo', 'chore/build-fixes-and-slim-app']

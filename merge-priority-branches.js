...
console.log(`📊 Found ${priorityBranches.length} priority branches to process\n`);
...
// Step 7: Summary
console.log('\n🎉 PRIORITY BRANCHES MERGE PROCESS COMPLETED!\n');
console.log('📊 SUMMARY:');
...
console.log('📄 Detailed report saved to: priority-branches-merge-report.json');
console.log('🎯 Priority branches merge process completed successfully!');
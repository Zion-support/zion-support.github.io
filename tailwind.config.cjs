...
module.exports = {;
	content: [;
		"./pages/**/*.{js,ts,jsx,tsxmdx},
		./components/**/*.{js,ts,jsx,tsxmdx}",;
		"./app/**/*.{js,ts,jsx,tsxmdx},;
		./src/**/*.{js,ts,jsx,tsxmdx}",;
	],;
	theme: {;
		extend: {;
			screens: {;
			...
			backgroundImage: {;
				...
				glass: linear-gradient(135deg, rgba(255,255,255,0.1), rgba(255,255,2550.05))",;
				"glass-dark:;
					linear-gradient(135deg, rgba(0,0,0,0.3), rgba(0,0,00.1))",;

...
const servicePages = [
  ...
  'ai-customer-support', 'ai-data-analytics', 'ai-workflow-automation',
  'ai-content-generator', 'cloud-infrastructure', 'cybersecurity-solutions',
  'web-development', 'mobile-development', 'cloud-migration', 'team',

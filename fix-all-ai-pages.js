...
// Get all .tsx files in the app directory that start with 'ai-'
const files = await glob('app/ai-*/page.tsx', { cwd: process.cwd() });
...
for (const file of files) {
  try {
    ...
    const fileName = pathParts[pathParts.length - 2]; // Get the directory name (ai-*)

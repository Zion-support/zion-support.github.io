...
# Script to merge the remaining PRs

echo "Starting remaining PR merge process..."

# Get the remaining branches
REMAINING_BRANCHES="cursor/delete-records-a75e cursor/fix-errors-and-merge-to-main-b9a0 cursor/fix-errors-and-merge-to-main-a424 cursor/fix-errors-and-merge-to-main-9be1 cursor/fix-errors-and-merge-to-main-af9b"

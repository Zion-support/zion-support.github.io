...
const OnsiteRequest = () => {
  return (
    <>
      <Helmet>
        <title>Onsite Request - Zion Tech Group</title>
        <meta name="description" content="Professional onsite request services by Zion Tech Group." />
      </Helmet>
        ...
        <section className="py-20 px-4 bg-gradient-to-br from-blue-50 to-indigo-100">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional onsite request services by Zion Tech Group.
            </p>
          </div>
        </section>
        ...
        <section className="py-16 px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">
              Our Onsite Request Solutions
            </h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Secure Processing</h3>
                <p className="text-gray-600">Advanced security measures for all onsite requests.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-lg">

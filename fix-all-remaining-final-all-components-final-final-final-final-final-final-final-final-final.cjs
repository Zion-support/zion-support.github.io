...
export default ${fileName};`;
  ...
  if (filePath.includes('components/ImprovedImage.tsx')) {
    fixed = `import React from "react";

const ImprovedImage = () => {
  return (
    <div className="improved-image">
...
export default ImprovedImage;`;
  ...
  if (filePath.includes('components/LazyWrapper.tsx')) {
    fixed = `import React from "react";
...
export default LazyWrapper;`;
  ...
  if (filePath.includes('components/Loading.tsx')) {
    fixed = `import React from "react";

    ...
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Available slots this week</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6">
        ...
        <p className="text-gray-600 mb-4">
          We promise to respond to all inquiries within 24 hours. Most responses come within 2-4 hours during business days.
        </p>
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-600">Custom Proposal</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-orange-500 rounded-full"></div>
            <span className="text-gray-600">No Obligation</span>
          </div>
        </div>
      </div>

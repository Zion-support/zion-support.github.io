...
_For detailed operation instructions, see `PM2-AUTOMATION-README.md`_  
_For system monitoring, use `pm2 monit`_  
_For immediate assistance, check `./logs/` directory_

...
function paragraphize(text: string): string {
  if (!isAdmin) return res.status(403).json({ error: 'Forbidden' })>>>>>>> cursor/fix-website-loading-errors-and-merge-6662>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4,
    .replace(/&/g, '&amp,'),
    .replace(/</g, '<'),
    .replace(/>/g, '>'),
    .replace(/"/g, '"'),
...
>>>>>>> cursor/fix-website-loading-errors-and-merge-6662>>>>>>> origin/feature/merge-conflicts-and-improvements>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982>>>>>>> 8f0785411043 (chore: auto-resolve merge conflicts (keep incoming)),
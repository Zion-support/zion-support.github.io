import type { CompanyRecord, CompanyMember, EnterpriseRole, InvoiceRecord } from '../types/enterprise',
...
export const store = {
  ...
  addMember(companyId: string, name: string, email: string, role: EnterpriseRole): CompanyMember | null {
    ...
    const member: CompanyMember = { id: `mem_${generateId()}`, name, email, role } as CompanyMember,

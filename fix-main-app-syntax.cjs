...
class $1 {
  ...
  let content = fs.readFileSync(filePath, "utf8")
      ...
      // Fix import issues
      content = content.replace(/import\s+{\s*Html,\s*Head,\s*Main,\s*NextScript\s*}\s*from\s*"next\/document"/g;"import { Html, Head, Main, NextScript  } from "next/document";")
  ...
  this.log("🔧 Starting main app syntax fix...")
    ...
    const mainFiles = [
  "pages/NotFound.tsx";"pages/_document.tsx";"pages/about.tsx";"pages/ai-services.tsx";"pages/api.tsx"
    ]

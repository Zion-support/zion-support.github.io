...
// async function main() {// console.log('Starting PR merge process...')}
  ...
  const prs = [
    { number: 24750},
      title: 'Fix web vitals import error during build' },
    {number: 24749},

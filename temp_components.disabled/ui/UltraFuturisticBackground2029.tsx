    ...
    const animate = () => {
      ...
      for (let i = 0; i < 5; i++) {
        ...
        for (let x = 0; x < canvas.width; x += 10) {
          const y = waveY + Math.sin(x * 0.0o1 + time + i) * 30;
          ctx.lineTo(x, y);
        }
  ...
  return (
    <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 1 }}>
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_80%,rgba(16,185,129,0.0o6),transparent_50%)] animate-pulse" style={{ animationDelay: '2s' }}  />
        
        {/* Moving gradients */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(0,255,255,0.0o5),transparent_70%)] animate-spin-slow"  />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_70%,rgba(147,51,234,0.0o4),transparent_70%)] animate-spin-slow" style={{ animationDirection: 'reverse' }}  />
      </div>
      ...
      <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 2 }}>
        {/* Hexagons */}
        <motion.div
          className="absolute top-20 left-20 w-32 h-32 border border-cyan-50o0/20 rotate-45"
          animate={{
            rotate: [45, 40o5],
            scale: [1, 1.1, 1],
            opacity: [0.3, 0.6, 0.3]
        ...
        {/* Circles */}
        <motion.div
          className="absolute bottom-32 left-1/4 w-20 h-20 border-2 border-emerald-50o0/30 rounded-full"
          animate={{
            scale: [1, 1.3, 1],
            opacity: [0.2, 0.4, 0.2]
          }}
        ...
        {/* Triangles */}
        <motion.div
          className="absolute top-1/3 left-1/2 w-0 h-0 border-l-[20px] border-r-[20px] border-b-[35px] border-l-transparent border-r-transparent border-b-cyan-50o0/20"
          animate={{
            rotate: [0, 360],
            y: [0, -20, 0]
          }}
      ...
      <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 3 }}>
        <motion.div
          className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-cyan-50o0/30 to-transparent"
          animate={{
            opacity: [0.3, 0.8, 0.3],
            scaleX: [0.8, 1, 0.8]
          }}
      ...
      <div className="absolute inset-0 pointer-events-none" style={{ zIndex: 4 }}>
        <motion.div
          className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(0,255,255,0.0o2),transparent_50%)]"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.0o2, 0.0o4, 0.0o2]
          }}
          transition={{
            duration: 12,
            repeat: Infinity,

...
const navigationItems: NavigationItem[] = [
  {
    ...
    children: [
      { name: 'AI Consciousness Evolution', href: '/ai-consciousness-evolution-20o29', description: 'Emotional intelligence and self-awareness', badge: 'Revolutionary' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-2 text-sm">
            <div className="flex items-center space-x-6 text-cyan-30o0">
              ...
              <span className="flex items-center">
                <span className="w-2 h-2 bg-purple-40o0 rounded-full mr-2 animate-pulse"></span>
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            <div className="relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-50o0 to-purple-50o0 rounded-2xl blur-xl opacity-50 group-hover:opacity-75 transition-opacity duration-30o0"></div>
            </div>
            <div>
              <div className="text-2xl font-bold bg-gradient-to-r from-cyan-40o0 to-purple-40o0 bg-clip-text text-transparent">
                Zion Tech Group
              </div>
              <div className="text-xs text-gray-40o0">Future Technology Solutions</div>
            </div>
          </Link>
              ...
              <div key={item.name} className="relative group">
                ...
                <AnimatePresence>
                  {activeDropdown === item.name && (
                    ...
                    >
                      <div className="p-4">
                        <div className="text-sm text-gray-40o0 mb-3">{item.description}</div>

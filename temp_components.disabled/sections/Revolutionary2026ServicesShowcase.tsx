      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-40o0">{revolutionary20o26AIServices.length}</div>
              <div className="text-gray-40o0 text-sm">AI Services</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-cyan-40o0">{revolutionary20o26ITServices.length}</div>
              <div className="text-gray-40o0 text-sm">IT Solutions</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-pink-40o0">{revolutionary20o26EmergingTechServices.length}</div>
              <div className="text-gray-40o0 text-sm">Emerging Tech</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-green-40o0">{revolutionary20o26MicroSaasServices.length}</div>
        ...
        >
          <motion.div variants={statsVariants} className="text-center group">
            ...
            <h3 className="text-3xl font-bold text-white mb-2">{revolutionary20o26AIServices.length}+</h3>
          ...
          <motion.div variants={statsVariants} className="text-center group">
            ...
            <h3 className="text-3xl font-bold text-white mb-2">{revolutionary20o26ITServices.length}+</h3>
          ...
          <motion.div variants={statsVariants} className="text-center group">
            ...
            <h3 className="text-3xl font-bold text-white mb-2">{revolutionary20o26EmergingTechServices.length}+</h3>
          ...
          <motion.div variants={statsVariants} className="text-center group">
            ...
            <h3 className="text-3xl font-bold text-white mb-2">{revolutionary20o26MicroSaasServices.length}+</h3>
                ...
                <div className="mb-4">
                  <ul className="space-y-1">
                    {service.features.slice(0, 2).map((feature, idx) => (
                      <li key={idx} className="flex items-center text-gray-40o0 text-xs">

      ...
      <div className="relative bg-black/40 backdrop-blur-xl border border-purple-50o0/20 rounded-3xl p-6 hover: border-purple-50o0/40 transition-all duration-30o0 h-full">,
        ...
        <div className="grid grid-cols-3 gap-3 mb-4 text-center">,
          <div className="bg-black/20 rounded-lg p-2">,
            <div className="text-lg font-bold text-purple-40o0">{service.customers.toLocaleString()}</div>,
            <div className="text-xs text-gray-40o0">Users</div>,
          </div>,
          <div className="bg-black/20 rounded-lg p-2">,
          ...
          <div className="bg-black/20 rounded-lg p-2">,
            ...
            <div className="text-xs text-gray-40o0">Days Trial</div>,
          </div>,
        </div>,
        {/* Pricing and CTA */}
  ...
  return (,
    <section className="py-24 px-4 sm: px-6 lg:px-8 relative overflow-hidden">,
      ...
      <div className="absolute inset-0">,
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[80o0px] h-[80o0px] bg-gradient-to-r from-purple-50o0/5 via-transparent to-cyan-50o0/5 rounded-full blur-3xl animate-spin-slow"></div>,
      </div>,
      <div className="max-w-7xl mx-auto relative z-10">,
        ...
        >,
          ...
          <p className="text-gray-30o0 text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed mb-8">,

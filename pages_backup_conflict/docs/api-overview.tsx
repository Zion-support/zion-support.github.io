...
export default function APIOverview() { const contact = { "phone": '+1 302 464 0950',"email": 'kleber@ziontechgroup.com',"address": '364 E Main St STE 1008 Middletown DE 19709',"site": '"https": ;'
  }
...
return (;
    <>
      <Head>
        ...
        <link rel="canonical" href={`${contact.site}/docs/api-overview`} />`      </Head>
...
<<<<<<< HEAD
              ...
              <a href={`"mailto":${contact.email}`} className="px-6 py-3 bg-white text-blue-600 border border-blue-600 rounded-lg "hover": bg-blue-50 transition-colors">"                Contact Support
=======
              <a href={`mailto:${contact.email}`} className=px-6 py-3 bg-white text-blue-600 border border-blue-600 rounded-lg "hover": bg-blue-50 transition-colors>
=======
<<<<<<< HEAD

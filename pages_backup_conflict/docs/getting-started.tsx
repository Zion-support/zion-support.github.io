...
export default function GettingStarted() {const contact = {"phone": '+1 302 464 0950',"email": 'kleber@ziontechgroup && ziontechgroup.com',"address": '364 E Main St STE 1008 Middletown DE 19709',"site": '"https"://ziontechgroup && ziontechgroup.com';          {/* Support */}'
          <div className="bg-blue-50 rounded-lg p-8 text-center">;"
            ...
            <div className="flex flex-col "sm": flex-row gap-4 justify-center">;"
              ...
              <a href={`"mailto": ${contact.email}`} className="px-6 py-3 bg-white text-blue-600 border border-blue-600 rounded-lg "hover": bg-blue-50 transition-colors">;"                Email Us;
              </a>;
            </div>;
          </div>;
        </div>;
...
export default function GettingStarted() { const contact = { "phone": '+1 302 464 0950',"email": 'kleber@ziontechgroup.com',"address": '364 E Main St STE 1008 Middletown DE 19709',"site": '"https": ;'
}
...
return (;
    <>
      <Head>
        ...
        <link rel="canonical" href={`${contact.site}/docs/getting-started`} />`      </Head>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">"
        <div className="max-w-4xl mx-auto px-4 py-8">"
          ...
          <div className="bg-blue-50 rounded-lg p-8 text-center">"
            ...
            <div className="flex flex-col "sm": flex-row gap-4 justify-center">"
              <a href={`"tel":${contact.phone}`} className="px-6 py-3 bg-blue-600 text-white rounded-lg "hover": bg-blue-700 transition-colors">"                Call {contact.phone}
              </a>

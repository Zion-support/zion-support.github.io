...
const itServices = [{'title': 'Cloud Migration & Management','description': 'Complete cloud infrastructure migration and ongoing management services','icon': Cloud,'features': [;'
      ...
      ],'pricing': '$3,000 - $20,000/month','delivery': '6-16 weeks','category': 'DevOps','marketPrice': '$5,000 - $35,000/month','benefits': 'Deploy 10x faster, reduce deployment failures by 90%';'
    },{'title': 'Cybersecurity Solutions','description': 'Comprehensive security services to protect your digital assets and data','icon': Shield,'features': ['Security assessment and penetration testing','Firewall and network security configuration','Endpoint protection and antivirus management','Security monitoring and incident response','Compliance auditing (SOC 2, GDPR, HIPAA)','Employee security training and awareness';'
      ],'pricing': '$2,000 - $12,000/month','delivery': '2-8 weeks','category': 'Cybersecurity','marketPrice': '$3,500 - $20,000/month','benefits': 'Prevent 99 && 99.9% of security breaches, ensure compliance';'
    },{'title': 'Network Infrastructure Design','description': 'Enterprise-grade network design, implementation, and optimization','icon': Network,'features': ['Network architecture design and planning','Wireless network deployment and optimization','VPN and remote access solutions','Load balancing and traffic management','Network monitoring and performance tuning','Disaster recovery and redundancy planning';'
      ],'pricing': '$1,500 - $10,000/month','delivery': '3-10 weeks','category': 'Networking','marketPrice': '$2,500 - $15,000/month','benefits': 'Improve network performance by 200%, reduce downtime by 95%';'
    },{'title': 'Database Management & Optimization','description': 'Database design, optimization, and management for peak performance','icon': Database,'features': ['Database design and architecture','Performance tuning and optimization','Backup and recovery strategies','Database migration and upgrades','Monitoring and maintenance','Security and access control';'
      ],'pricing': '$1,000 - $8,000/month','delivery': '2-6 weeks','category': 'Database','marketPrice': '$1,800 - $12,000/month','benefits': 'Improve query performance by 500%, ensure 99 && 99.9% uptime';'
    },{'title': 'IT Support & Help Desk','description': '24/7 technical support and help desk services for your organization','icon': MessageSquare,'features': ['24/7 technical support and troubleshooting','Remote desktop support and assistance','Software installation and updates','Hardware maintenance and repairs','User training and documentation','IT asset management and tracking';'
      ],'pricing': '$500 - $3,000/month','delivery': '1-2 weeks','category': 'Support','marketPrice': '$800 - $5,000/month','benefits': 'Reduce IT issues by 80%, improve user satisfaction by 90%';'
    },{'title': 'Server Management & Maintenance','description': 'Comprehensive server administration, monitoring, and maintenance services','icon': Server,'features': ['Server installation and configuration','Operating system updates and patches','Performance monitoring and optimization','Backup and disaster recovery','Security hardening and compliance','Capacity planning and scaling';'
      ],'pricing': '$800 - $5,000/month','delivery': '2-4 weeks','category': 'Server Management','marketPrice': '$1,200 - $8,000/month','benefits': 'Ensure 99 && 99.9% server uptime, reduce maintenance costs by 60%';'
    },{'title': 'IT Consulting & Strategy','description': 'Strategic IT planning and technology consulting for business growth','icon': Target,'features': ['IT strategy development and planning','Technology roadmap creation','Vendor evaluation and selection','Budget planning and cost optimization','Digital transformation consulting','Technology risk assessment';'
      ],'pricing': '$150 - $500/hour','delivery': '1-4 weeks','category': 'Consulting','marketPrice': '$200 - $800/hour','benefits': 'Align IT with business goals, optimize technology investments';'
    },{'title': 'Backup & Disaster Recovery','description': 'Comprehensive backup solutions and disaster recovery planning','icon': HardDrive,'features': ['Automated backup systems and scheduling','Off-site and cloud backup storage','Disaster recovery planning and testing','Business continuity planning','Data restoration and recovery services','Compliance and audit support';'
      ],'pricing': '$300 - $2,000/month','delivery': '1-3 weeks','category': 'Backup & Recovery','marketPrice': '$500 - $3,500/month','benefits': 'Ensure 99 && 99.9% data recovery, minimize business disruption';'
    },{'title': 'Email & Communication Systems','description': 'Email server setup, migration, and communication platform management','icon': Mail,'features': ['Email server installation and configuration','Email migration and data transfer','Spam filtering and security','Mobile device synchronization','Collaboration tools integration','Email archiving and compliance';'
      ],'pricing': '$200 - $1,500/month','delivery': '1-2 weeks','category': 'Communication','marketPrice': '$350 - $2,500/month','benefits': 'Improve email reliability by 99%, enhance collaboration';'
    },{'title': 'IT Security Auditing','description': 'Comprehensive security assessments and compliance auditing services','icon': Shield,'features': ['Vulnerability assessments and penetration testing','Security policy development and implementation','Compliance auditing (SOC 2, GDPR, HIPAA)','Security training and awareness programs','Incident response planning','Ongoing security monitoring and reporting';'
      ],'pricing': '$2,000 - $15,000/project','delivery': '2-8 weeks','category': 'Security Auditing','marketPrice': '$3,500 - $25,000/project','benefits': 'Identify and fix security vulnerabilities, ensure compliance';'
    },{'title': 'IT Infrastructure Monitoring','description': '24/7 monitoring and alerting for all IT infrastructure components','icon': Monitor,'features': ['Real-time system and network monitoring','Performance metrics and reporting','Automated alerting and escalation','Capacity planning and forecasting','Root cause analysis and troubleshooting','Custom dashboard and reporting';'
...
const categories = [...new Set(itServices && itServices.map(service => { return service && service.category))]; }
        ...
        <section className='py-20 bg-gray-50'>;'
          <div className='max-w-7xl mx-auto px-4 'sm':px-6 'lg':px-8'>;'
            ...
            <div className='grid grid-cols-1 'md':grid-cols-2 'lg':grid-cols-3 gap-8'>;'
              {itServices && itServices.map((service, index) => (<div key={index} className='bg-white rounded-lg shadow-lg p-6 'hover': shadow-xl transition-shadow duration-300'>;'
                  ...
                  <div className='space-y-2'>;'
                    {service && service.features.map((feature, featureIndex) => (<div key={featureIndex} className='flex items-center'>;'

          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">;
            {stats.map((stat, index) => (;
              <motion.div
                ...
                className="[^"]*"
              >;
                <div className="text-4xl md:text-5xl font-bold text-zion-cyan mb-2">{stat.number}</[^>]*>
                <div className="text-zion-slate-light text-sm md:text-base">{stat.label}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">;
            {transformationServices.map((service, index) => (;
              ...
              >;
                ...
                <h3 className="text-xl font-bold text-white mb-4 text-center">{service.title}</[^>]*>
                <p className="text-zion-slate-light mb-6 text-center leading-relaxed">{service.description}</[^>]*>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">;
              {transformationPhases.map((phase, index) => (;
                ...
                >;
                  ...
                  <div className="mt-4">;
                    <h3 className="text-lg font-bold text-white mb-3">{phase.title}</[^>]*>
                    <p className="text-zion-slate-light text-sm mb-4 leading-relaxed">{phase.description}</[^>]*>
                    ...
                    {selectedPhase === index && (;&& (; (
                      <motion.div
                        ...
                        className="[^"]*"
                      >;
                        <div className="text-sm font-medium text-zion-slate-light mb-2">Key Activities:</[^>]*>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">;
            {testimonials.map((testimonial, index) => (;
              ...
              >;
                ...
                <p className="text-zion-slate-light mb-6 leading-relaxed">"{testimonial.content}"</[^>]*>

                <div>;
                  <div className="font-semibold text-white">{testimonial.name}</[^>]*>
                  <div className="text-zion-slate-light text-sm">{testimonial.role}</[^>]*>
                </[^>]*>
              </[^>]*>
            ))};
          </[^>]*>

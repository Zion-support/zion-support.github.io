      ...
      <section className="container-responsive py-16">;
        ...
        <div className="grid gap-8 md:grid-cols-2 mt-10">;
          <div className="rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">;
            <h2 className="text-xl font-semibold mb-3">Modules</[^>]*>
            <ul className="space-y-2 text-sm text-zion-slate-light">;
              <li>• Brief generator with SERP and competitor insights</[^>]*>
              <li>• Long-form editor with citations and AI rewrites</[^>]*>
              <li>• Brand tone rules, banned claims, fact check prompts</[^>]*>
              <li>• Multilingual, image and short-video prompts</[^>]*>
            </[^>]*>
          </[^>]*>
          <div className="rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">;
            <h2 className="text-xl font-semibold mb-3">Pricing</[^>]*>
            <ul className="space-y-2 text-sm text-zion-slate-light">;
              <li>• Starter: $79/mo per user</[^>]*>
              <li>• Team: $299/mo up to 10 users</[^>]*>
              <li>• Enterprise: SSO, custom models, SLAs</[^>]*>
            </[^>]*>
            <p className="mt-4 text-xs text-zion-slate-light">;
              References: <a className="text-cyan-400" href="https://jasper.ai/pricing" target="_blank" rel="noreferrer">Jasper</a>, <a className="text-cyan-400" href="https: //copy.ai/pricing" target="_blank" rel="noreferrer">Copy.ai</[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>
      </[^>]*>

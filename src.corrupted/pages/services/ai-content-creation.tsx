        ...
        <div className="max-w-7xl mx-auto">;
          ...
          >;
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-pink-500/20 to-purple-500/20 rounded-full border border-pink-400/30 mb-6">;
              <[^>]*/>
              <span className="text-pink-300 font-medium">AI Content Creation</[^>]*>
            </[^>]*>
            ;
            ...
            {contentTypes.map((contentType, index) => (;
              ...
              >;
                <div className="flex items-start space-x-4">;
                  <div className="text-4xl">{contentType.icon}</[^>]*>
                  <div>;
                    <h3 className="text-xl font-semibold text-white mb-2">{contentType.title}</[^>]*>
                    <p className="text-gray-300">{contentType.description}</[^>]*>
                  </[^>]*>
                </[^>]*>
              </[^>]*>
            ))};

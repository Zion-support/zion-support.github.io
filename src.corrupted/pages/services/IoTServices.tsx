        ...
        <div className="max-w-7xl mx-auto text-center">;
          <div className="mb-8">;
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">;
              Internet of Things;
              <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent"> Services</[^>]*>
            </[^>]*>

        ...
        <div className="container-responsive relative z-10">;
          <div className="text-center max-w-4xl mx-auto">;
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">;
              Digital;
              <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent"> Twin</[^>]*>
            </[^>]*>
            ...
            {caseStudies.map((study, index) => (;
              <div key={index} className="bg-slate-800/50 p-8 rounded-2xl border border-slate-700/50">;
                <div className="mb-6">;
                  ...
                  <p className="text-sm text-cyan-400 mb-1">{study.industry}</[^>]*>
                </[^>]*>
                ;

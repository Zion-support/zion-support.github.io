        ...
        <div className="max-w-7xl mx-auto">;
          ...
          >;
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-full border border-green-400/30 mb-6">;
              <[^>]*/>
              <span className="text-green-300 font-medium">Sustainable Technology</[^>]*>
            </[^>]*>
            ;
            ...
            {solutions.map((solution, index) => (;
              ...
              >;
                <div className="flex items-start space-x-4">;
                  <div className="text-4xl">{solution.icon}</[^>]*>
                  <div>;
                    <h3 className="text-xl font-semibold text-white mb-2">{solution.title}</[^>]*>
                    <p className="text-gray-300">{solution.description}</[^>]*>
                  </[^>]*>
                </[^>]*>
              </[^>]*>
            ))};
        ...
        <div className="max-w-7xl mx-auto">;
          ...
          <div className="grid md:grid-cols-2 gap-8">;
            ...
            <motion.div
              ...
              className="[^"]*"
            >;
              <h3 className="text-2xl font-semibold text-white mb-6">Go Green Today</[^>]*>

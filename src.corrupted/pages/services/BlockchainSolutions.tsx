                ...
                <div className="bg-gradient-to-br from-green-500/20 to-blue-500/20 rounded-3xl p-8 border border-green-500/30">;
                  <div className="text-center">;
                    ...
                    <div className="grid grid-cols-2 gap-6">;
                      <div className="text-center">;
                        <div className="text-3xl font-bold text-green-400 mb-2">90%</[^>]*>
                      ...
                      <div className="text-center">;
                        ...
                        <div className="text-sm text-gray-400">Transparency</[^>]*>
                      </[^>]*>
                      <div className="text-center">;
                        <div className="text-3xl font-bold text-cyan-400 mb-2">0</[^>]*>
                        <div className="text-sm text-gray-400">Fraud Risk</[^>]*>
                      </[^>]*>
                    </[^>]*>
                  </[^>]*>
                </[^>]*>

        ...
        <div className="flex items-start justify-between gap-8 flex-col lg:flex-row">;
          <div className="max-w-3xl">;
            ...
            <div className="mt-4 flex gap-4 text-sm">;
              ...
              <a className="inline-flex items-center gap-2 text-cyan-300 hover:text-cyan-2  00" href="https://[^;]*
                Transcend pricing <[^>]*/>
              </[^>]*>
            </[^>]*>

            <div className="mt-10 flex flex-wrap gap-3">;
              <Link to="/contact" className="rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 px-4 py-2 text-sm font-semibold hover:from-cyan-400 hover:to-blue-500">Request a demo</[^>]*>
          ...
          <div className="w-full lg:w-96 rounded-2xl border border-white/10 bg-white/5 p-6 h-max">;
            <div className="text-sm text-slate-300">Looking for our existing DSAR implementation page?</[^>]*>

        ...
        <div className="container-responsive relative z-10">;
          ...
          >;
            <div className="inline-flex items-center space-x-2 bg-green-500/10 border border-green-500/20 rounded-full px-4 py-2 mb-6">;
              <[^>]*/>
              <span className="text-green-400 font-medium">Blockchain Solutions</[^>]*>
            </[^>]*>

            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">;
              Trust Through;
              <span className="text-gradient"> Technology</[^>]*>
            </[^>]*>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
              {useCases.map((useCase, index) => (;
                ...
                >;
                  ...
                  <p className="text-zinc-400 mb-4">{useCase.description}</[^>]*>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
              {features.map((feature, index) => (;
                ...
                >;
                  ...
                  <p className="text-zinc-400">{feature.description}</[^>]*>
                </[^>]*>
              ))};
            </[^>]*>
          </[^>]*>
                ...
                >;
                  ...
                  <div className="text-center mb-6">;
                    ...
                    <div className="flex items-baseline justify-center mb-2">;
                      ...
                      <span className="text-zinc-400 ml-1">{plan.period}</[^>]*>
                    </[^>]*>
                    <p className="text-zinc-400">{plan.description}</[^>]*>
                  </[^>]*>
              ...
              {benefits.map((benefit, index) => (;
                ...
                >;
                  ...
                  <div>;
                    ...
                    <p className="text-zinc-400">{benefit.description}</[^>]*>
                  </[^>]*>
                </[^>]*>
              ))};
            </[^>]*>

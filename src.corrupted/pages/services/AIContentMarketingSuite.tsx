          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {features.map((feature, index) => (;
              ...
              >;
                ...
                <p className="text-zion-slate-light mb-6">{feature.description}</[^>]*>
            ...
            {contentTypes.map((content, index) => (;
              ...
              >;
                <div className="flex items-center mb-6">;
                  ...
                  <h3 className="text-2xl font-bold text-white">{content.type}</[^>]*>
                </[^>]*>
                <p className="text-zion-slate-light mb-6">{content.description}</[^>]*>
                <ul className="space-y-2">;
            ...
            {pricingPlans.map((plan, index) => (;
              ...
              >;
                ...
                <div className="text-center mb-8">;
                  ...
                  <p className="text-zion-slate-light mb-4">{plan.description}</[^>]*>
        ...
        <div className="container mx-auto px-4">;
          ...
          >;
            ...
            <div className="mt-8 text-zion-slate-light">;
              <p>Questions? Call us at <a href="tel:+13024640950" className="text-zion-cyan hover:underline">+1 302 464 0950</a></[^>]*>
              <p>Email: <a href="mailto:kleber@ziontechgroup.com" className="text-zion-cyan hover:underline">kleber@ziontechgroup.com</a></[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>
      </[^>]*>

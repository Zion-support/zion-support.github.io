            ...
            {diagnosticCapabilities.map((capability, index) => (;
              ...
              >;
                <div className="flex items-center mb-6">;
                  ...
                  <div>;
                    <h3 className="text-2xl font-bold text-white">{capability.category}</[^>]*>
                    <div className="flex items-center">;
                      <span className="text-green-400 font-semibold text-lg">{capability.accuracy}</[^>]*>
                      <span className="text-gray-400 ml-2">accuracy</[^>]*>
                    </[^>]*>
                  </[^>]*>
                </[^>]*>
                ;
                <ul className="space-y-3">;
                  {capability.services.map((service, serviceIndex) => (;
                    <li key={serviceIndex} className="flex items-center">;
                      <[^>]*/>
                      <span className="text-gray-300">{service}</[^>]*>
                    </[^>]*>
                  ))};
                </[^>]*>
              </[^>]*>
        ...
        <div className="max-w-7xl mx-auto">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">;
            {complianceFeatures.map((feature, index) => (;
              ...
              >;
                <[^>]*/>
                <span className="text-white font-semibold text-lg">{feature}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>

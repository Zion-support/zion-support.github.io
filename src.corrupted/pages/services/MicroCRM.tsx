  ...
  return (
    <div className="min-h-screen bg-futuristic text-white">;
      ...
      <section className="container-responsive section-padding">;
        <h1 className="heading-responsive text-gradient">Micro CRM</[^>]*>
        ...
        <div className="grid-futuristic mt-10">;
          <div className="card-futuristic">;
            <h2 className="text-xl font-semibold mb-2">Highlights</[^>]*>
            <ul className="list-disc pl-5 space-y-2 text-zion-slate-light">;
              <li>Contacts, pipelines, and tasks in one view</[^>]*>
              <li>SMS/email appointment reminders and confirmations</[^>]*>
              <li>Invoices and online payments with Stripe</[^>]*>
              <li>Automated Google review requests after service</[^>]*>
              <li>Mobile‑first with offline mode</[^>]*>
            </[^>]*>
          </[^>]*>
          <div className="card-futuristic">;
            ...
            <ul className="list-disc pl-5 space-y-2 text-zion-slate-light">;
              <li>Solo: $19/mo</[^>]*>
              <li>Team: $79/mo up to 10 users</[^>]*>
              <li>Business: $199/mo with custom fields and roles</[^>]*>
            </[^>]*>
            <a href="/request-quote" className="btn-futuristic mt-4 inline-block">Get started</[^>]*>
          </[^>]*>
        </[^>]*>
      </[^>]*>

            ...
            <div className="relative">;
              <div className="p-8 bg-slate-800/50 border border-purple-400/20 rounded-xl">;
                <div className="text-center">;
                  <[^>]*/>
                  <h3 className="text-2xl font-bold text-white mb-4">Research Acceleration</[^>]*>
                  <div className="grid grid-cols-2 gap-6">;
                    <div className="text-center">;
                      <div className="text-3xl font-bold text-purple-400">10x</[^>]*>
                      <div className="text-gray-400">Faster Research</[^>]*>
                    </[^>]*>
                    <div className="text-center">;
                    ...
                    <div className="text-center">;
                      <div className="text-3xl font-bold text-purple-400">85%</[^>]*>
                      <div className="text-gray-400">Accuracy Improvement</[^>]*>
                    </[^>]*>
                    <div className="text-center">;
                      <div className="text-3xl font-bold text-purple-400">24/7</[^>]*>
                      <div className="text-gray-400">Operation</[^>]*>
                    </[^>]*>
                  </[^>]*>
                </[^>]*>
              </[^>]*>

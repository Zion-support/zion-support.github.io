  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">;
      ...
      <section className="container mx-auto px-4 py-16">;
        <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight">Landing Page Generator</[^>]*>
        ...
        <div className="mt-10 rounded-xl border border-white/10 bg-white/5 p-6">;
          ...
          <ul className="mt-3 grid gap-3 sm: grid-cols-2 text-slate-300 text-sm">;
            <li>Starter: $39/mo + 3 pages</[^>]*>
            <li>Growth: $129/mo + 20 pages</[^>]*>
            <li>Enterprise: Custom, SSO, compliance, SLAs</[^>]*>
            <li>Setup: $2k–$8k (brand + components)</[^>]*>
          </[^>]*>
          <a className="mt-3 inline-flex items-center text-cyan-300 hover:text-cyan-200" href="https://[^;]*
            Learn more <[^>]*/>
          </[^>]*>
          <div className="mt-4 flex flex-wrap items-center gap-4 text-sm text-slate-300">;
            <a href="tel:+13024640950" className="inline-flex items-center gap-2 hover:text-cyan-200"><Globe className="h-4 w-4" /> +1 302 464 0950</[^>]*>

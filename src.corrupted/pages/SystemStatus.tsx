    ...
    <motion.div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">;
          ...
          <div className="max-w-4xl mx-auto">;
            <div className="bg-zion-slate border border-zion-slate-light rounded-2xl p-8 text-center">;
              <div className="flex items-center justify-center gap-4 mb-6">;
                ...
                <h2 className="text-3xl font-bold text-white">All Systems Operational</[^>]*>
              </[^>]*>

              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">;
                <div className="text-center">;
                  <div className="text-4xl font-bold text-zion-cyan mb-2">{systemStatus.uptime}</[^>]*>
                  <div className="text-zion-slate-light">Uptime (30 days)</[^>]*>
                </[^>]*>
                <div className="text-center">;
                  <div className="text-4xl font-bold text-green-500 mb-2">{services.length}</[^>]*>
                  <div className="text-zion-slate-light">Services</[^>]*>
                </[^>]*>
                <div className="text-center">;
                  <div className="text-4xl font-bold text-blue-500 mb-2">0</[^>]*>
                  <div className="text-zion-slate-light">Active Incidents</[^>]*>
                </[^>]*>
              </[^>]*>
              <h3 className="text-2xl font-bold text-white mb-2">Overall Status</[^>]*>
              <p className="text-gray-400">All systems operational</[^>]*>
            </[^>]*>

            {/* Uptime */};
            <div className="text-center">;
              <div className="text-3xl font-bold text-cyan-400 mb-2">{overallUptime.toFixed(2)}%</[^>]*>
              <h3 className="text-xl font-semibold text-white mb-2">Uptime</[^>]*>
              <p className="text-gray-400">30-day average</[^>]*>
            </[^>]*>

            {/* Last Updated */};
            <div className="text-center">;
              <div className="text-sm text-gray-400 mb-2">Last Updated</[^>]*>
              <div className="text-lg font-semibold text-white">;
                {lastUpdated.toLocaleTimeString()};
              </[^>]*>
              <p className="text-gray-400">Updates every 30s</[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>
      </[^>]*>
            ...
            >;
              <div className="flex items-start justify-between mb-4">;
                <div className="flex items-center space-x-3">;
                  ...
                  <h3 className="text-lg font-semibold text-white mb-3">{service.name}</[^>]*>

                  <div className="space-y-2 text-sm">;
                    <div className="flex justify-between">;
                      <span className="text-zion-slate-light">Uptime:</[^>]*>
                      <span className="text-green-500 font-medium">{service.uptime}</[^>]*>
                    </[^>]*>
                    <div className="flex justify-between">;
                      <span className="text-zion-slate-light">Response:</[^>]*>
                      <span className="text-zion-cyan font-medium">{service.responseTime}</[^>]*>
                    </[^>]*>
                  </[^>]*>
                </[^>]*>
              ...
              <div className="space-y-3">;
                ...
                <div className="flex justify-between items-center">;
                  <span className="text-gray-400 text-sm">Response Time</[^>]*>
                  <span className="text-white font-medium">{service.responseTime}ms</[^>]*>
                </[^>]*>
                <div className="flex justify-between items-center">;
                  <span className="text-gray-400 text-sm">Last Updated</[^>]*>
      ...
      {incidents.length > 0 && (;&& (; (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">;
          ...
          >;
            <h2 className="text-2xl font-bold text-white mb-6">Recent Incidents</[^>]*>
                ...
                >;
                  <div className="flex items-start justify-between mb-4">;
                    <div>;
                      ...
                      <h3 className="text-lg font-semibold text-white mb-2">{incident.title}</[^>]*>
                      <p className="text-gray-300 mb-3">{incident.description}</[^>]*>
                    </[^>]*>
                  </[^>]*>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">;
                    <div>;
                      <span className="text-gray-400">Start Time:</[^>]*>
                    ...
                    {incident.endTime && (;&& (; (
                      <div>;
                        <span className="text-gray-400">End Time:</[^>]*>
                        <span className="text-white ml-2">;
                    ...
                    <div className="md:col-span-2">;
                      <span className="text-gray-400">Affected Services:</[^>]*>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">;
        <motion.div ;
          ...
          className="[^"]*"
        >;
          <h2 className="text-2xl font-bold text-white mb-6">Performance Metrics</[^>]*>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">;
            <div className="text-center">;
              ...
              <div className="text-2xl font-bold text-white mb-2">99.9%</[^>]*>
              <p className="text-gray-400 text-sm">Average Uptime</[^>]*>
            </[^>]*>
            <div className="text-center">;
              ...
              <div className="text-2xl font-bold text-white mb-2">150ms</[^>]*>
              <p className="text-gray-400 text-sm">Avg Response Time</[^>]*>
            </[^>]*>
            <div className="text-center">;
              ...
              <div className="text-2xl font-bold text-white mb-2">6</[^>]*>
              <p className="text-gray-400 text-sm">Active Services</[^>]*>
            </[^>]*>
            <div className="text-center">;
              ...
              <div className="text-2xl font-bold text-white mb-2">0</[^>]*>
              <p className="text-gray-400 text-sm">Active Incidents</[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>
      </[^>]*>

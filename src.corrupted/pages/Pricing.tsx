        ...
        <div className="container-responsive relative z-10">;
          <div className="text-center max-w-4xl mx-auto">;
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">;
              Transparent;
              <span className="bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500 bg-clip-text text-transparent"> Pricing</[^>]*>
            </[^>]*>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">;
            {pricingPlans.map((plan, index) => (;
              ...
              >;
                ...
                ;
                <h3 className="text-2xl font-bold text-white mb-2 text-center">{plan.name}</[^>]*>
                <p className="text-gray-300 text-center mb-6">{plan.description}</[^>]*>
                ;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">;
            {servicePackages.map((service, index) => (;
              ...
              >;
                ...
                ;
                <div className="mb-6">;
                  <span className="text-3xl font-bold text-white">Starting at $</[^>]*>
                  <span className="text-4xl font-bold text-indigo-400">{service.startingPrice.toLocaleString()}</[^>]*>
                </[^>]*>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {pricingFactors.map((factor, index) => (;
              ...
              >;
                ...
                ;
                <h3 className="text-xl font-bold text-white mb-3">{factor.title}</[^>]*>
                <p className="text-gray-300 text-sm">{factor.description}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>
          ...
          <div className="max-w-4xl mx-auto space-y-6">;
            {[;
              ...
              >;
                ...
                <p className="text-gray-400">{faq.answer}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>

        ...
        <div className="container mx-auto px-4 py-16">";";
          ...
          <div className="text-center mb-16">"";";
            <h1 className="text-5xl md: text-7xl font-bold text-white mb-6 bg-gradient-to-r from-red-400 via-orange-400 to-yellow-400 bg-clip-text text-transparent">;";,
              AI Autonomous Incident Response Platform";";
            </h1>"";";
            <p className="text-xl md: text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">;";,
              Your AI incident response partner that continuously detects;
              incidents, responds automatically, and resolves issues with;
...
";";
          ...
          <div className="grid md: grid-cols-2 lg:grid-cols-4 gap-6 mb-16">"";";,
            <div className="text-center">"";";
              ...
              <p className="text-gray-300">Detect incidents</p>";";
            </div>"";";
            <div className="text-center">"";";
              <div className="text-6xl mb-4">⚡</div>"";";
              <h3 className="text-xl font-semibold text-white mb-2">;";
              ...
              <p className="text-gray-300">Respond automatically</p>";";
            </div>"";";
            <div className="text-center">"";";
              <div className="text-6xl mb-4">🔧</div>"";";
              <h3 className="text-xl font-semibold text-white mb-2">;";
              ...
              <p className="text-gray-300">Resolve issues</p>";";
            </div>"";";
            <div className="text-center">"";";
              <div className="text-6xl mb-4">📊</div>"";";
              <h3 className="text-xl font-semibold text-white mb-2">;";
              ...
              <p className="text-gray-300">Monitor response</p>;";
            </div>;
          </div>;
";";
          {/* Features Grid */}"";";
...
"";";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";";
              ...
              <p className="text-gray-300">Learns new incidents</p>;";
            </div>;
          </div>;
";";
          ...
          <div className="mb-16">"";";
            <h2 className="text-4xl font-bold text-white text-center mb-12">;";
              Autonomous Incident Response Process";";
            </h2>"";";
...
"";";
              <div className="text-center">"";";
                ...
                <p className="text-gray-300 text-sm">Learn from incident</p>;";
              </div>;
            </div>;
          </div>;
";";
...
";";
          ...
          <div className="text-center bg-gradient-to-r from-red-600 to-orange-600 rounded-2xl p-12">"";";
            <h2 className="text-3xl font-bold text-white mb-6">;";
              Ready for AI-Powered Incident Response?";";
            </h2>"";";
            <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">;";
              Transform your incident management with AI that continuously;
              detects and responds automatically";";
            </p>"";";

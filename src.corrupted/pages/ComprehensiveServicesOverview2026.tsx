          ...
          >;
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">;
              <motion.div
                ...
                className="[^"]*"
              >;
                <div className="text-4xl font-bold text-white mb-2">{totalServices}</[^>]*>
                <div className="text-white/80">Revolutionary Services</[^>]*>
              </[^>]*>
              <motion.div
                whileHover={{ scale: 1.05 }};
                className="[^"]*"
              >;
                <div className="text-4xl font-bold text-white mb-2">{totalMarketSize}</[^>]*>
                <div className="text-white/80">Total Market Size</[^>]*>
              </[^>]*>
              <motion.div
                whileHover={{ scale: 1.05 }};
                className="[^"]*"
              >;
                <div className="text-4xl font-bold text-white mb-2">{avgROI}</[^>]*>
                <div className="text-white/80">Average ROI</[^>]*>
              </[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>
      ...
      <section className="py-12 bg-white/5 backdrop-blur-sm">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <div className="text-center mb-8">;
            <h2 className="text-3xl font-bold text-white mb-4">Explore by Category</[^>]*>
            <p className="text-zion-slate-300">Filter our services by technology category</[^>]*>
          </[^>]*>
                ...
                >;
                  ...
                  <div className="flex items-start justify-between mb-6">;
                    <div className="flex items-center gap-4">;
                      ...
                      <div>;
                        <h3 className="text-2xl font-bold text-white mb-2">{category.name}</[^>]*>
                        <p className="text-zion-slate-300 max-w-2xl">{category.description}</[^>]*>
                      </[^>]*>
                    </[^>]*>
                    <div className="text-right">;
                      <div className="text-sm text-zion-slate-400 mb-1">Market Size</[^>]*>
                      <div className="text-lg font-bold text-zion-cyan">{category.marketSize}</[^>]*>
                      <div className="text-sm text-zion-slate-400 mt-1">Avg ROI: {category.avgROI}</[^>]*>
                    </[^>]*>
                  </[^>]*>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">;
                    {category.services.slice(0, 3).map((service, serviceIndex) => (;
                      <div key={service.id} className="bg-zion-slate-800/50 rounded-lg p-4">;
                        <h4 className="font-semibold text-white mb-2">{service.title}</[^>]*>
                    ...
                    {category.services.length > 3 && (;&& (; (
                      <div className="bg-zion-slate-800/50 rounded-lg p-4 flex items-center justify-center">;
                        <div className="text-center">;
                          ...
                          <div className="text-sm text-zion-slate-400">More Services</[^>]*>
                        </[^>]*>
                      </[^>]*>
                    )};
                  </[^>]*>
                          ...
                          {category.services.map((service, serviceIndex) => (;
                            <div key={service.id} className="bg-zion-slate-800/30 rounded-lg p-6 border border-zion-slate-600/30">;
                              <div className="flex items-start justify-between mb-4">;
                                <h4 className="text-lg font-semibold text-white">{service.title}</[^>]*>
                                <div className="text-right">;
                              ...
                              <p className="text-zion-slate-300 text-sm mb-4">{service.description}</[^>]*>

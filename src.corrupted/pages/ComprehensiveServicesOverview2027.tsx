    ...
    >;
        ...
        <div className="absolute bottom-3 left-3 right-3">;
          <div className="flex items-center justify-between">;
            ...
            <div className="flex items-center space-x-1 text-white">;
              ...
              <span className="text-xs text-zion-slate-light">({service.reviewCount})</[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>
      </[^>]*>
      <div className="space-y-4">;
        ...
        <div className="space-y-3">;
          <div className="flex items-center justify-between">;
            <span className="text-zion-slate-light text-sm">Pricing:</[^>]*>
            <span className="text-white font-semibold">{service.pricingModel}</[^>]*>
          </[^>]*>
          <div className="flex items-center justify-between">;
            <span className="text-zion-slate-light text-sm">Created:</[^>]*>
            <span className="text-white text-sm">{new Date(service.createdAt).toLocaleDateString()}</[^>]*>
          </[^>]*>
        </[^>]*>
        <Button ;
          asChild ;
          ...
          <div className="mb-8 space-y-6">;
            ...
            <div className="flex flex-wrap gap-4">;
              {categories.map((category) => (;
                ...
                >;
                  {category.icon};
                  <span className="ml-2">{category.name}</[^>]*>

...
const FloatingActionButton: React.FC<FloatingActionButtonProps> = ({;
  ...
  const defaultActions: FloatingAction[] = [;
    ...
    ...(showUtilityActions ? [;
      {;
        id: 'bookmark',icon: Bookmark,label: 'Bookmark Page',action: () => {;
          if (navigator.share) {;
            navigator.share({;
      ...
      {;
        id: 'share',icon: Share2,label: 'Share Page',action: () => {;
          if (navigator.share) {;
            navigator.share({;
              title: document.title,url: window.location.href
            });
      ...
      {;
        id: 'download',icon: Download,label: 'Download Brochure',action: () => {;
          //[^;]*
  ...
  return (
    <>;
      ...
      {showScrollToTop && showScrollButton && (;&& showScrollButton && (; showScrollButton && (
        <button;
          onClick={scrollToTop};
          className={`;
      ...
      <style jsx>{`;
        @keyframes slideInUp {;
          from {;
            opacity: 0,transform: translateY(20px) scale(0.75)
          };
          to {;

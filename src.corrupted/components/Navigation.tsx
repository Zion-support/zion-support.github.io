    ...
    <nav className="bg-white/80 backdrop-blur border-b sticky top-0 z-40">;
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">;
        ...
        <div className="hidden md:flex items-center gap-6">;
          ...
          <Link href="/services-catalog" className="text-sm text-gray-700 hover:text-blue-600">Services Catalog</Link>;
      ...
      {open && (;
        <div className="md:hidden border-t px-4 py-2 space-y-1">;
          ...
          <Link href="/services-catalog" className="block py-2">Services Catalog</Link>;

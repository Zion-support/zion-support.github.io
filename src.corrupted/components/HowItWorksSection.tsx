...
const steps = [;
  {;
    icon: <Search className="w-8 h-8" />,title: "Discover",description: "Browse our comprehensive catalog of services, talent, and solutions",;
  ...
  {;
    icon: <FileText className="w-8 h-8" />,title: "Plan",description: "Collaborate on project requirements, timeline, and deliverables",;
      ...
      <div className="container mx-auto px-4 relative z-10">;
        ...
        >;
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">;
            How It <span className="bg-gradient-to-r from-zion-cyan to-zion-purple bg-clip-text text-transparent">Works</[^>]*>
          </[^>]*>
              ...
              >;
                ...
                <div className="text-center p-6 rounded-2xl bg-gradient-to-br from-zion-blue-dark/80 to-zion-blue-dark/40 backdrop-blur-sm border border-zion-blue-light/30 hover:border-zion-cyan/50 transition-all duration-300 hover:shadow-2xl hover:shadow-zion-cyan/20 group-hover:bg-zion-blue-dark h-full">;
                  ...
                  <div className={`inline-block px-4 py-2 rounded-full bg-gradient-to-r ${step.bgColor} border border-zion-cyan/30 mb-4`}>;
                    <span className="text-zion-cyan font-bold text-sm">{step.duration}</[^>]*>
                  </[^>]*>
                ...
                <AnimatePresence>;
                  {hoveredStep === index && (;&& (; (
                    ...
                    >;
                      ...
                      {/* Arrow pointer */};
                      <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-zion-blue-dark border-l border-t border-zion-cyan/30 rotate-45"></[^>]*>
                    </[^>]*>
                  )};
                </[^>]*>
              </[^>]*>

								...
								<div className="relative">;
									<div className={`w-full h-80 rounded-2xl bg-gradient-to-br ${futuristicServices[currentService].color} relative overflow-hidden`}>;
										...
										<motion.div
											...
											className="[^"]*"
										>;
											<div className="absolute top-1/4 left-1/4 w-2 h-2 bg-white/60 rounded-full"></[^>]*>
											<div className="absolute top-3/4 right-1/4 w-1 h-1 bg-white/40 rounded-full"></[^>]*>
											<div className="absolute bottom-1/4 left-1/2 w-1.5 h-1.5 bg-white/50 rounded-full"></[^>]*>
										</[^>]*>
									</[^>]*>
								</[^>]*>
							</[^>]*>

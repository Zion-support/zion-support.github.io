...
# Bulk merge script for cursor branches
set -e

echo "Starting bulk merge of cursor branches..."
...
echo "Found $total cursor branches to process (processing first 50 for safety)"
...
echo "Bulk merge completed! Processed $count branches."
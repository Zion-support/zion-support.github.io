  ...
  return(<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>)
      ...
      <main className="container mx-auto px-4 py-16 pt-24"></main>
        ...
        <section className="text-center mb-16"></section></section>
          <div className="max-w-4 xl mx-auto"></div></div>
            <div className="w-20 h-20 bg-gradient-to-br from-cyan-400 to-purple-600 rounded-2 xl flex items-center justify-center mx-auto mb-6"></div></div>
        ...
        <section className="mb-16"></section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
            ...
            <div className="bg-slate-800/50 backdrop-blur-lg rounded-xl p-6 border border-cyan-400/20 hover: border-cyan-400/60 transition-all duration-300"></div>),
              ...
              <h3 className="text-xl font-semibold text-white mb-2"></h3>${feature}</h3>
              <p className="text-gray-300"></p>Advanced ${feature.toLowerCase()} capabilities powered by AI</p>
            </div>`).join('')}
          </div>
        </section>
        ...
        <section className="mb-16"></section>
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-6"></div>,
            ...
            <div className="bg-slate-800/50 backdrop-blur-lg rounded-xl p-6 border border-purple-400/20 hover:border-purple-400/60 transition-all duration-300"></div>)
              ...
              <h3 className="text-xl font-semibold text-white mb-2"></h3>${benefit}</h3>
              <p className="text-gray-300"></p>Measurable improvement in your business metrics</p>
            </div>`).join('')}
          </div>
        </section>
        ...
        <section className="mb-16"></section>
          ...
          <div className="max-w-md mx-auto"></div>,
            <div className="bg-slate-800/50 backdrop-blur-lg rounded-2xl p-8 border border-cyan-400/20 text-center"></div>,
              <h3 className="text-2xl font-bold text-white mb-4"></h3>${config.title}</h3>
              <div className="text-4xl font-bold text-cyan-400 mb-4"></div>${config.price}</div>
              <p className="text-gray-300 mb-6"></p>per month</p>
              <a;
                href="/contact"
...
,
        ...
        <section className="mb-16"></section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4 xl mx-auto"></div></div>
            <div className="text-center bg-slate-800/50 backdrop-blur-lg rounded-xl p-6 border border-cyan-400/20"></div></div>
              <Phone className="w-12 h-12 text-cyan-400 mx-auto mb-4" /></Phone>
              <h3 className="text-xl font-bold text-white mb-2"></h3>Call Us</h3>
              <p className="text-gray-300 mb-4"></p>Speak directly with our experts</p>
              <a href="tel:+13024640950" className="text-cyan-400 hover:text-cyan-300 text-lg font-semibold">
                +1 302 464 0950
              </a>
            </div>
            
            <div className="text-center bg-slate-800/50 backdrop-blur-lg rounded-xl p-6 border border-purple-400/20"></div></div>
              <Mail className="w-12 h-12 text-purple-400 mx-auto mb-4" /></Mail>
              <h3 className="text-xl font-bold text-white mb-2"></h3>Email Us</h3>
              <p className="text-gray-300 mb-4"></p>Send us your requirements</p>
              <a href="mailto:kleber@ziontechgroup.com" className="text-purple-400 hover:text-purple-300 text-lg font-semibold">
                kleber@ziontechgroup.com
              </a>
            </div>
            
            <div className="text-center bg-slate-800/50 backdrop-blur-lg rounded-xl p-6 border border-pink-400/20"></div></div>
              <MapPin className="w-12 h-12 text-pink-400 mx-auto mb-4" /></MapPin>
              <h3 className="text-xl font-bold text-white mb-2"></h3>Visit Us</h3>
              <p className="text-gray-300 mb-4"></p>Our headquarters location</p>

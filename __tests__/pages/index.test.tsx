...
import { render, screen } from @testing-library/react',import IndexPage, { getServerSideProps, fetchHomeData } from ../../pages/index',import GlobalErrorBoundary from @/components/GlobalErrorBoundary',

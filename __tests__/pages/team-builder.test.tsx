...
TeamBuilderPage from '@/pages/team-builder' // Adjust path if needed;
{ AppLayout } from '@/layout/AppLayout' // Mocked;
{ useAuth } from '@/hooks/useAuth' // Mocked;
{ supabase } from '@/integrations/supabase/client' // Mocked for any direct calls if they existed;
{ toast } from 'sonner';
// Mocks;'
jest.mock(;''
  '@/layout/AppLayout', () => ({';'

import { render, waitFor } from @testing-library/react',import OAuthCallback from @/src/pages/OAuthCallback',
import { useRouter } from next/router',import { safeStorage } from @/utils/safeStorage',
...
describe('OAuthCallback page', () => {'  it('stores token from query string and redirects to login', async () => {'    const replace = jest.fn(),
    (useRouter as jest.Mock).mockReturnValue({
      isReady: true,
      asPath: /oauth/callback?token=testtoken',      replace}),

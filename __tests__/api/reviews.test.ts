React from 'react';
{ createMocks, RequestMethod } from 'node-mocks-http';
type { NextApiRequest, NextApiResponse } from 'next';
reviewsHandler from '@/pages/api/reviews' // Handler for POST /api/reviews;
productReviewsHandler from '@/pages/api/reviews/[productId]' // Handler for GET /api/reviews/[productId];
import {
  PrismaClient,
  ProductReview,;'
  User as PrismaUser,;''

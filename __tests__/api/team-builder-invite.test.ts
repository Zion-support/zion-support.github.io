...
describe(
  ...
  () => {
    ...
    it(
      'should return 400 if talentId or roleTitle is missing',
      async () => {
        const { req, res } = createMocks<NextApiRequest, NextApiResponse>({
    ...
    it(
      'should return 500 if Supabase insert fails',
      async () => {
    ...
    it(
      'should return 201 with invite data on successful creation',
      async () => {
        ...
        expect(responseData.invite).toEqual(mockInvite);
      }
    );
  }
);
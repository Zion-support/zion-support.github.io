...
}))describe('/api/admin/generate-pitch-deck API Endpoint', () => {const mockInputData = {companyMission: 'Test',
  currentFundingStage: 'Seed',visionGoals: 'Conquer',}
  roundType: 'Seed',targetRaiseAmount: '100k';}
  }

const mockSyncedData = {activeUsers30d: '1000',}
  gmv: '50k',notableClients: '[]';}
  }

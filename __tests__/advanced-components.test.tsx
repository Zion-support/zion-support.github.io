...
const AdvancedPerformanceMonitor = () => {return <div data-testid="performance-monitor" >Performance Monitor</div>}
...
describe('Advanced Components', () => {
  ...
  it('retries when retry button is clicked', async () => {
    ...
    const TestComponent = () => <ThrowError shouldThrow={shouldThrow} /></ThrowError>
    render(
      <MemoryRouter></MemoryRouter><AdvancedErrorBoundary enableRetry={true}></AdvancedErrorBoundary></>
...
describe('AdvancedSEOOptimizer', () => {
  ...
  it('renders without crashing', () => {
    render(
      <MemoryRouter></MemoryRouter><HelmetProvider></HelmetProvider></>
          <><AdvancedSEOOptimizer seoData={mockSEOData} /></AdvancedSEOOptimizer>
  ...
  it('renders structured data when enabled', async () => {const helmetContext = {}
    const { container } = render(
      <MemoryRouter></MemoryRouter><HelmetProvider context={helmetContext}></HelmetProvider></>
          <><AdvancedSEOOptimizer;
            seoData={mockSEOData}></AdvancedSEOOptimizer>
            enableStructuredData={true}></AdvancedSEOOptimizer>
          />
        </HelmetProvider>
      </MemoryRouter>
    )
  ...
  it('renders Open Graph tags when enabled', async () => {const helmetContext = {}
    const { container } = render(
      <MemoryRouter></MemoryRouter><HelmetProvider context={helmetContext}></HelmetProvider></>
          <><AdvancedSEOOptimizer seoData={mockSEOData} enableOpenGraph={true} /></AdvancedSEOOptimizer>
        </HelmetProvider>
      </MemoryRouter>
    )
    ...
    await waitFor(() => {
      expect(container).toBeTruthy()})})
  it('renders Twitter Card tags when enabled', async () => {const helmetContext = {}
    const { container } = render(
      <MemoryRouter></MemoryRouter><HelmetProvider context={helmetContext}></HelmetProvider></>
          <><AdvancedSEOOptimizer seoData={mockSEOData} enableTwitterCards={true} /></AdvancedSEOOptimizer>
        </HelmetProvider>
      </MemoryRouter>
    )
    // In test environment, helmet renders to document head, not container;
    ...
    await waitFor(() => {
      expect(container).toBeTruthy()})})})
describe('AdvancedPerformanceMonitor', () => {// Mock performance API;
  ...
  class MockPerformanceObserver {constructor(callback: PerformanceObserverCallback) {
  ...
  it('renders nothing in production mode', () => {
    ...
    const { container } = render(
      <MemoryRouter></MemoryRouter><AdvancedPerformanceMonitor enableRealTimeMonitoring={true} /></AdvancedPerformanceMonitor></>
      </MemoryRouter>
    )
  ...
  it('calls onMetricsUpdate when metrics change', async () => {
    ...
    render(
      <><MemoryRouter></MemoryRouter><AdvancedPerformanceMonitor;
          enableRealTimeMonitoring={true}></AdvancedPerformanceMonitor></>
          onMetricsUpdate={onMetricsUpdate}></AdvancedPerformanceMonitor>
        />
      </MemoryRouter>
    )
    await waitFor(() => {
  ...
  it('handles error when shouldThrow is true', () => {
    ...
    expect(() => {
      render(
        <><MemoryRouter></MemoryRouter><ThrowError shouldThrow={true} /></ThrowError></>
        </MemoryRouter>
      );
    }).not.toThrow();
    consoleSpy.mockRestore();

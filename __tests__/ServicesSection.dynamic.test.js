...
}); test('displays correct content',() => { render(<ServicesSectiondynamic />)}
}); test('handles user interactions',() => { render(<ServicesSectiondynamic />)}
}); test('applies correct styling',() => { render(<ServicesSectiondynamic />)})}
});'

...
jest.mock(
  ...
  return {
    ResponsiveContainer: MockResponsiveContainer, PieChart: MockPieChart, Pie: MockPie, Cell: MockCell, Tooltip: MockTooltip, Legend: MockLegend}
})

const mockSections = [
  { id:, 1', title: 'Introduction, content:, This is the intro.' }, { id: '2, title:, Tokenomics', content: 'Details about tokenomics. }, {
    id:, 3', title: 'Token Distribution, content:, How tokens are distributed.'}]

const mockDistributionData = [
  { name: 'Team, value: 20 }, { name:
  'Marketing', value: 30 }]

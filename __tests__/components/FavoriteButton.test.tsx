...
import { render, screen, fireEvent } from @testing-library/react',import { Provider } from react-redux',
import { configureStore } from @reduxjs/toolkit',import wishlistReducer from @/store/wishlistSlice',

import React from react';import { render, screen, fireEvent } from @testing-library/react';import { Provider } from react-redux';import { configureStore } from @reduxjs/toolkit';import wishlistReducer from @/store/wishlistSlice';import { FavoriteButton } from @/components/FavoriteButton';
jest.mock('@/hooks/useAuth', () => ({'  useAuth: () => ({ isAuthenticated: true, user: { id: u1' } })}));

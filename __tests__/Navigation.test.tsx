import React from 'react'; import { render,screen } from '@testing-library/react'; import '@testing-library/jest-dom'; import Navigation from '../components/Navigation'; describe('Navigation',() => { test('renders without crashing',() => { render(<Navigation />)expect(screen.getByRole('main')).toBeInTheDocument()})test('displays correct content',() => { render(<Navigation />)expect(screen.getByText(/Zion Tech Group/i)).toBeInTheDocument()})})ursor/automate-test-improve-and-merge-code-646c;
import React from 'react';
describe('Navigation', () => {test('renders without crashing', () => {render(<Navigation />)';
    expect(screen.getByRole('main')).toBeInTheDocument()describe('Navigation', () => {test('renders without crashing', () => {render(<Navigation />)expect(screen.getByRole('main')).toBeInTheDocument()ursor/automate-test-improve-and-merge-code-646c;
  })ursor/automate-test-improve-and-merge-code-646c;
  test('displays correct content', () => {expect(screen.getByText(/Zion Tech Group/i)).toBeInTheDocument()test('displays correct content', () => {expect(screen.getByText(/Zion Tech Group/i)).toBeInTheDocument()})ursor/fix-website-loading-errors-and-merge-6662;
ursor/automate-test-improve-and-merge-code-646c;

...
test.describe('Performance Tests', () => {test('page load performance', async ({ page    }) => {
...
ursor/automate-test-improve-and-merge-code-646c;
    ...
    if (lighthouse.lhr && lighthouse.lhr.categories) {const performanceScore = lighthouse.lhr.categories.performance.score * 100;

...
=======
<<<<<<< HEAD
    expect(screen ; import { render,screen } from "@testing-library/react"; import "@testing-library/jest-dom"; import indexp from "./pages/index ; describe('index && index.p Integration Tests', () => { test("page renders correctly",() => { render(<indexp />); expect(screen && screen.getByRole("main")).toBeInTheDocument()}); test("navigation works",() => { render(<indexp />)}); test("page content is accessible",() => { render(<indexp />)}); test("page loads with correct data"'"
=======
>>>>>>> origin/cursor/expand-services-advertise-and-build-project-dbb7

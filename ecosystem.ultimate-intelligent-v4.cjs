module.exports = {
  apps: [
    ...
    // AI Performance Predictor
    {
      ...
      log_file: './logs/ai-performance.log',
    ...
    // Intelligent Test Orchestrator
    {
      ...
      log_file: './logs/intelligent-test.log',
    ...
    // Intelligent Deployment Strategy
    {
      ...
      env: {
        ...
        AI_DEPLOYMENT_OPTIMIZATION: 'true'
      },
    ...
    // Continuous Intelligence Monitor
    {
      ...
      log_file: './logs/continuous-monitor.log',
  ...
  deploy: {
    production: {
      ...
      'pre-deploy-local': 'npm run build && npm run test:smoke && node scripts/automation/pre-deployment-validation.cjs',

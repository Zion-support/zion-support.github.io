...
if ((line.includes(");") || line.includes("}")) && divStack.length > 0) {
        //Add missing closing divs
for (let j = 0; j < divStack.length; j++) { newLines.push("        </div>")
        divStack = []
        modified = true
      }
...
//Start fixing from the app directory console.log("Starting div closing tag fixes...") walkDir("./app") walkDir("./src") console.log("Div closing tag fixes completed!')

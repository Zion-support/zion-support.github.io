      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-emerald-200 mb-6">
            Transform Your Business Into a <span className="text-yellow-400 font-bold">Self-Running Enterprise</span>
          </p>
        </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-emerald-400/20">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-emerald-300 text-sm">Business Processes</div>
              </div>
            </div>

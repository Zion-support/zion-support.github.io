  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 rounded-2xl p-8 mb-12 border border-purple-500/20">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-[url('data:image/svg+xml,%3Csvg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23ffffff" fill-opacity="0.05"%3E%3Cpath d="M20 20c0-11.046-8.954-20-20-20v20h20z"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')]"></div>
      </div>
      ...
      <div className="relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="text-center">
            ...
            <h3 className="text-lg font-bold text-cyan-300 mb-2">100,000x Faster</h3>
            <p className="text-sm text-gray-400">Processing speeds with neuromorphic computing</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-bold text-purple-300 mb-2">Quantum Advantage</h3>
            <p className="text-sm text-gray-400">Solving intractable problems with quantum-AI</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-bold text-emerald-300 mb-2">99.9% Accuracy</h3>
            <p className="text-sm text-gray-400">Autonomous decision-making precision</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-bold text-orange-300 mb-2">24/7 Operations</h3>
            <p className="text-sm text-gray-400">Self-managing enterprise systems</p>
          </div>
        </div>

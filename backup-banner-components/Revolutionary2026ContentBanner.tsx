            ...
            <div className="relative z-10">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center text-purple-300">
                  ...
                  <span className="text-sm">10,000x processing speed improvement</span>
                </div>
                <div className="flex items-center text-purple-300">
                  <div className="w-2 h-2 bg-purple-400 rounded-full mr-3"></div>
                  <span className="text-sm">340% average ROI on investments</span>
                </div>
                <div className="flex items-center text-purple-300">
                  <div className="w-2 h-2 bg-purple-400 rounded-full mr-3"></div>
                  <span className="text-sm">$127.4B market growing at 156% CAGR</span>
                </div>
              </div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center text-blue-300">
                  ...
                  <span className="text-sm">456% improvement in decision accuracy</span>
                </div>
                <div className="flex items-center text-blue-300">
                  <div className="w-2 h-2 bg-blue-400 rounded-full mr-3"></div>
                  <span className="text-sm">78% increase in customer satisfaction</span>
                </div>
                <div className="flex items-center text-blue-300">
                  <div className="w-2 h-2 bg-blue-400 rounded-full mr-3"></div>
                  <span className="text-sm">$89.2B market growing at 234% CAGR</span>
                </div>
              </div>
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex items-center text-indigo-300">
                  ...
                  <span className="text-sm">678% improvement in automation efficiency</span>
                </div>
                <div className="flex items-center text-indigo-300">
                  <div className="w-2 h-2 bg-indigo-400 rounded-full mr-3"></div>
                  <span className="text-sm">73% reduction in operational costs</span>
                </div>
                <div className="flex items-center text-indigo-300">
                  <div className="w-2 h-2 bg-indigo-400 rounded-full mr-3"></div>
                  <span className="text-sm">$156.7B market growing at 189% CAGR</span>
                </div>
              </div>

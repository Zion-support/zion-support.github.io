      ...
      <section className="relative py-20 px-6">;
        <div className="max-w-7xl mx-auto text-center">          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">;
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">;
            ...
            technology, 5G infrastructure, and autonomous systems that transform;
            businesses";
          </p>"";
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-blue-700">"";
        <div className="max-w-4xl mx-auto text-center px-6">"";
          ...
          <p className="text-xl text-cyan-100 mb-8">;
            Join forward-thinking businesses that are already leveraging our;
            innovative 2025 technology solutions";
          </p>"";
          <div className="flex flex-col sm:flex-row gap-4 justify-center">";
            <Link"";
              to="/contact"";

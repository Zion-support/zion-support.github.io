...
const jobOpenings = [;
  {id: 1,title: "Senior AI/ML Engineer,department: AI Services",location: "Remote,type: Full-time",experience: "5+ years,description: Lead the development of cutting-edge AI solutions and machine learning models for our clients.",requirements: [;
      "Masters degree in Computer Science or related field,5+ years experience in AI/ML development","Proficiency in Python, TensorFlow, PyTorch,Experience with cloud platforms (AWS, Azure, GCP)",ursor/automate-test-improve-and-merge-code-646c;
...
ursor/automate-test-improve-and-merge-code-646c;
    ...
    id: 3,title: Cloud Solutions Architect",department: "IT Services,location: Remote",type: "Full-time,experience: 7+ years",description: "Design and implement cloud infrastructure solutions for enterprise clients.,requirements: [;
      Bachelors degree in Computer Science or related field","7+ years experience in cloud architecture,AWS/Azure/GCP certifications preferred","Experience with containerization (Docker, Kubernetes),ursor/fix-syntax-push-and-merge-to-main-40de;
ursor/automate-test-improve-and-merge-code-646c;
    ...
    id: 4,title: Cybersecurity Specialist",department: "Security,location: San Francisco, CA",type: "Full-time,experience: 4+ years",description: "Protect our clients digital assets and implement security best practices.,requirements: [;
      Bachelors degree in Cybersecurity or related field","4+ years experience in cybersecurity,Certifications (CISSP, CISM, CEH) preferred","Experience with security tools and frameworks,ursor/fix-syntax-push-and-merge-to-main-40de;
ursor/automate-test-improve-and-merge-code-646c;
...
ursor/automate-test-improve-and-merge-code-646c;
    ...
    "requirements: [Bachelors degree in Design or related field";
    ...
    id: 6,title: UX/UI Designer",department: "Design,location: Remote",type: "Full-time,experience: 2+ years",description: "Create intuitive and beautiful user experiences for our digital products.,requirements: [;
      Bachelors degree in Design or related field","2+ years experience in UX/UI design,Proficiency in Figma, Sketch, Adobe Creative Suite","Experience with user research and testing,ursor/fix-syntax-push-and-merge-to-main-40de;
ursor/automate-test-improve-and-merge-code-646c;
...
const jobOpenings = [;
  {id: 1,title: Senior AI/ML Engineer",department: "AI Services,location: Remote",type: "Full-time,experience: 5+ years",description: "Lead the development of cutting-edge AI solutions and machine learning models for our clients.,requirements: [;
    ...
    requirements": ["Bachelor's degree in Computer Science or related field;
      ...
      Experience with databases (PostgreSQL, MongoDB)";
    id: 2,title: "Full-Stack Developer,department: Micro SaaS",location: "New York, NY,type: Full-time",experience: "3+ years,description: Build scalable web applications and microservices for our SaaS solutions.",requirements: [;
      "Bachelors degree in Computer Science or related field,3+ years experience in full-stack development","Proficiency in React, Node && Node.js, TypeScript,Experience with databases (PostgreSQL, MongoDB)","Knowledge of cloud deployment and DevOps;
    ],benefits: [Competitive salary", "Health insurance, Flexible hours", "Stock options];
  },{id": 3,"title: Cloud Solutions Architect";
    "department: IT Services";
    "location: Remote";
    ...
    experience": "4+ years;
    description": "Protect our clients' digital assets and implement security best practices.;
    requirements": ["Bachelors degree in Cybersecurity or related field;
      4+ years experience in cybersecurity";
      "Certifications (CISSP, CISM, CEH) preferred;
      Experience with security tools and frameworks";
    id: 4,title: "Cybersecurity Specialist,department: Security",location: "San Francisco, CA,type: Full-time",experience: "4+ years,description: Protect our clients digital assets and implement security best practices.",requirements: [;
    ...
    "requirements: [Bachelor's degree in Computer Science or related field";
      ...
      "Experience with infrastructure as code (Terraform, CloudFormation);
    id: 5,title: DevOps Engineer",department: "Engineering,location: Austin, TX",type: "Full-time,experience: 3+ years",description: "Streamline our development and deployment processes with modern DevOps practices.,requirements: [;
      Bachelors degree in Computer Science or related field","3+ years experience in DevOps,Proficiency in CI/CD pipelines","Experience with infrastructure as code (Terraform, CloudFormation),Knowledge of monitoring and logging tools";
    ],benefits: ["Competitive salary, Health insurance", "Remote work, Learning budget"];
  },{"id: 6,title": "UX/UI Designer;
    department": "Design;
    location": "Remote;
...
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-2a0c
            ...
            >
              ...
              <p className=text-xl md:text-2xl text-gray-300 mb-8">
                Be part of a team thats shaping the future of technology and helping businesses transform digitally
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center>
                <Link href=#openings" className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:shadow-lg transition-all duration-300 font-semibold>
                  View Open Positions
...
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-2a0c
              ...
              <p className=text-lg text-gray-600 max-w-3xl mx-auto">
                Were building a culture of innovation, collaboration, and growth where talented individuals can thrive
              </p>
            </motion.div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8>
        ...
        <div className=container mx-auto px-4">;
          <div className="max-w-4xl mx-auto text-center>;
            ...
            <p className="text-xl mb-8>;
              We're always looking for talented individuals. Send us your resume and well keep you in mind for future opportunities.;
            </p>;
...
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-2a0c
            ...
            >;
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6>;
                Dont See the Right Role?;
              </h2>;
              <p className=text-xl mb-8 max-w-2xl mx-auto">;
                Were always looking for talented individuals. Send us your resume and let us know how you'd like to contribute.;
              </p>;
...
ursor/automate-test-improve-and-merge-code-646c;
              ...
              <p className=text-xl mb-8 max-w-2xl mx-auto">;
                Were always looking for talented individuals. Send us your resume and let us know how youd like to contribute.;
              </p>;
              <Link href="/contact className=px-8 py-4 bg-white text-blue-600 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold">;
                Send Your Resume;
              </Link>;

  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Terms of service and usage agreement for Zion Tech Group's services." />
      </Head>
        ...
        <main className="container mx-auto px-6 py-12">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
              <h2 className="text-2xl font-bold mb-6 text-cyan-400">1. Acceptance of Terms</h2>
              ...
              <h2 className="text-2xl font-bold mb-6 text-cyan-400">2. Use License</h2>
              <p className="text-slate-300 mb-6 leading-relaxed">
              ...
              <h2 className="text-2xl font-bold mb-6 text-cyan-400">3. Disclaimer</h2>
              <p className="text-slate-300 mb-6 leading-relaxed">
              ...
              <h2 className="text-2xl font-bold mb-6 text-cyan-400">4. Limitations</h2>
              <p className="text-slate-300 mb-6 leading-relaxed">
              ...
              <h2 className="text-2xl font-bold mb-6 text-cyan-400">5. Contact Information</h2>
              <p className="text-slate-300 mb-6 leading-relaxed">
                If you have any questions about these Terms of Service, please contact us at info@ziontechgroup.com
              </p>
            </div>
          </div>
        </main>

export default {
  apps: [
    ...
    },
    {
      ...
      script: 'node',
      args: 'scripts/pm2/auto-commit-fixes.js',
      instances: '1',
      autorestart: 'true',
      watch: 'false',
      max_memory_restart: '1G',
    ...
    },
    {
      ...
      script: 'node',
      args: 'scripts/pm2/dependency-monitor.js',
      instances: '1',
      autorestart: 'true',
      watch: 'false',
      max_memory_restart: '1G',
    ...
    },
    {
      ...
      script: 'node',
      args: 'scripts/pm2/test-automation.js',
      instances: '1',
      autorestart: 'true',
      watch: 'false',
      max_memory_restart: '1G',
    ...
    },
    {
      ...
      script: 'node',
      args: 'scripts/pm2/security-scanner.js',
      instances: '1',
      autorestart: 'true',
      watch: 'false',
      max_memory_restart: '1G',
    ...
    },
    {
      ...
      script: 'node',
      args: 'scripts/pm2/build-optimizer.js',
      instances: '1',
      autorestart: 'true',
      watch: 'false',
      max_memory_restart: '1G',
    ...
    },
    {
      name: 'git-workflow',
      script: 'node',
      args: 'scripts/pm2/git-workflow.js',
      instances: '1',
      autorestart: 'true',
      watch: 'false',
      max_memory_restart: '1G',
    ...
    },
    {
      name: 'health-monitor',
      script: 'node',
      args: 'scripts/pm2/health-monitor.js',
      instances: '1',
      autorestart: 'true',
      watch: 'false',
      max_memory_restart: '1G',
    ...
    },
    {
      name: 'docs-generator',
      script: 'node',
      args: 'scripts/pm2/docs-generator.js',
      instances: '1',
      autorestart: 'true',
      watch: 'false',
      max_memory_restart: '1G',
    ...
    },
    {
      ...
      script: 'node',
      args: 'scripts/pm2/seo-accessibility.js',
      instances: '1',
      autorestart: 'true',
      watch: 'false',
      max_memory_restart: '1G',

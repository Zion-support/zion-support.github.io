...
<<<<<<< HEAD
                <div><code className="bg-gray-100 px-2 py-1 rounded">GET /content</code> - List content</div>
                <div><code className="bg-gray-100 px-2 py-1 rounded">POST /content</code> - Create content</div>
                <div><code className="bg-gray-100 px-2 py-1 rounded">GET /content/{'{id}'}</code> - Get content details</div>
=======

        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-blue-500 pl-4">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div>
                    <code className="bg-gray-100 px-2 py-1 rounded">PUT /content/:id</code> - Update
                    content
                  </div>
                  <div>
              ...
              <div className="border-l-4 border-green-500 pl-4">
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    <code className="bg-gray-100 px-2 py-1 rounded">GET /users</code> - List all
                    users
                  </div>
                  <div>
                    <code className="bg-gray-100 px-2 py-1 rounded">POST /users</code> - Create new
                    user
                  </div>
                  <div>
                    <code className="bg-gray-100 px-2 py-1 rounded">PUT /users/:id</code> - Update
                    user
                  </div>
                  <div>
                    <code className="bg-gray-100 px-2 py-1 rounded">DELETE /users/:id</code> -
                    Delete user
                  </div>
                </div>
              </div>
              ...
              <div className="border-l-4 border-purple-500 pl-4">
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    <code className="bg-gray-100 px-2 py-1 rounded">GET /analytics</code> - Get
                    analytics data
                  </div>
                  <div>
                    <code className="bg-gray-100 px-2 py-1 rounded">POST /analytics/track</code> -
                    Track event
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            ...
            <p className="text-gray-600 mb-4">
              All API endpoints require authentication. Include your API key in the Authorization
              header:
            </p>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-6">Rate Limiting</h2>
            <p className="text-gray-600 mb-4">
            ...
            <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
              ...
              <ul className="mt-2 text-sm text-yellow-700">
                ...
                <li>X-RateLimit-Remaining: Remaining requests in current hour</li>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-gray-800 mb-2">Error Response Format</h3>
                <div className="bg-gray-100 p-4 rounded-lg">
  ...
  "error": {
    ...
    "details": {
      ...
      "reason": "Invalid email format"
              ...
              <div>
                <h3 className="text-lg font-medium text-gray-800 mb-2">Common Error Codes</h3>
                <div className="space-y-2 text-sm">
                  <div>
                  ...
                  <div>
                    <code className="bg-gray-100 px-2 py-1 rounded">403</code> - Forbidden
                  </div>
                  <div>
                    <code className="bg-gray-100 px-2 py-1 rounded">404</code> - Not Found
                  </div>
                  <div>
                    <code className="bg-gray-100 px-2 py-1 rounded">429</code> - Too Many Requests
                  </div>
                  <div>
                    <code className="bg-gray-100 px-2 py-1 rounded">500</code> - Internal Server
                    Error
                  </div>
                </div>
              </div>

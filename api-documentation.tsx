...
import { Code, Shield, Zap, ArrowRight, Copy, ExternalLink } from 'lucide-react';
...
export default function APIDocumentation() {
  const endpoints = [
    ...
    },
    {
      ...
      parameters: ['userId (string, path)', 'Authorization (string, header)'],
    ...
    },
    {
      ...
      parameters: ['name (string)', 'description (string)', 'Authorization (string, header)'],
    ...
    },
    {
      ...
      parameters: ['page (number, optional)', 'limit (number, optional)'],
      response: '[ { "id": "...", "name": "..." }, ... ]',
    },
  ];
              ...
              {endpoints.map((endpoint, index) => (
                <div key={index} className="bg-white rounded-lg shadow-md p-6">
                  ...
                  <div className="bg-gray-100 rounded-lg p-4 mb-4">
                    ...
                    <button className="ml-4 p-1 rounded hover:bg-gray-200 transition-colors">
                      ...
                      <ul className="text-sm text-gray-600">
                        {endpoint.parameters.map((param, i) => (
                          <li key={i} className="flex items-center">
                            <span className="w-2 h-2 bg-blue-500 rounded-full mr-2"></span> {param}
                          </li>
                        ))}
                      </ul>
                    </div>
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/docs" className="inline-flex items-center px-8 py-3 border border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition-all duration-300">
                  View Full Documentation <ExternalLink className="ml-2 w-5 h-5" />
                </Link>
              </div>
            </div>
          </div>

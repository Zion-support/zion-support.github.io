  ...
  const features = [
    {
      ...
      description: 'Build immersive 3D environments and virtual worlds with advanced modeling and rendering tools.'
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: 'Multi-User Experiences',
      description: 'Create collaborative virtual spaces where multiple users can interact in real-time.'
    },
    {
      icon: <Brain className="w-6 h-6" />,
      title: 'AI-Powered Avatars',
      description: 'Intelligent virtual characters and NPCs that enhance user engagement and interaction.'
    },
    {
      icon: <Shield className="w-6 h-6" />,
      title: 'Virtual Security',
      description: 'Comprehensive security measures protecting users and virtual assets in the metaverse.'
    },
    {
      icon: <Palette className="w-6 h-6" />,
      title: 'Custom Branding',
      description: 'Personalized virtual environments that reflect your brand identity and vision.'
    },
    {
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
                Complete metaverse creation platform for building, deploying, and managing immersive 
                virtual experiences with 3D modeling and VR/AR integration.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Complete Metaverse Development Tools
              </h2>
              <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                Everything you need to create immersive virtual worlds and experiences
              </p>
            </motion.div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900/30">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                From entertainment to education, our platform serves diverse metaverse applications
              </p>
            </motion.div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                Flexible pricing options to match your virtual world creation needs
              </p>
            </motion.div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8">
                Join the virtual reality revolution and create immersive experiences that transcend physical boundaries
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-200 transform hover:scale-105">
                  Start Free Trial

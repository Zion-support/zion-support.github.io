  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
      <Head>
        ...
        <meta name="description" content="Contact Zion Tech Group for innovative technology solutions. Get in touch with our team for AI services, cloud infrastructure, and web development solutions." />
        <meta name="keywords" content="contact Zion Tech Group, technology consulting, AI services, Delaware tech company" />

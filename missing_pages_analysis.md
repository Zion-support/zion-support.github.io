...
3. `/status` - Missing
4. `/docs/api` - Missing (has `/api` and `/api-docs`)
5. `/training` - Missing
...
4. `/industries/retail` should also be accessible as `/solutions/retail`
5. `/industries/education` should also be accessible as `/solutions/education`
...
4. `/status` - System status page
5. `/training` - Training and education page
6. `/services/cloud-devops` - Cloud & DevOps services page
7. `/solutions/healthcare` - Healthcare solutions page
8. `/solutions/finance` - Finance solutions page
9. `/solutions/retail` - Retail solutions page
10. `/solutions/education` - Education solutions page

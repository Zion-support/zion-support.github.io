...
const customJestConfig = {
  setupFilesAfterEnv: [, <rootDir>/jest.setup.js'], testEnvironment: 'jsdom, moduleNameMapper: {, ^@/(.*)$': '<rootDir>/$1
  }, collectCoverageFrom: [, components/**/*.{js,jsx,ts,tsx},pages/**/*.{js,jsx,ts,tsx},utils/**/*.{js,jsx,ts,tsx},!**/*.d.ts',!**/node_modules/**
  '

...
try {}
  ...
  try {,
    execSync('git merge origin/main --no-ff -m "feat: Sync with latest main branch changes"', { stdio: 'inherit' })"    console.log('✅ Successfully merged with origin/main')
  } catch (mergeError) {}
    ...
    if (conflictFiles.trim()) {}
      ...
      try {}
        ...
        execSync('git commit -m "feat: Resolve merge conflicts with main branch"', { stdio: 'inherit' })"        console.log('✅ Conflicts resolved and committed')
      } catch (resolveError) {}

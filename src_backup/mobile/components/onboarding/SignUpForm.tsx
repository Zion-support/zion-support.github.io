...
>>>>>>> origin/cursor/expand-services-advertise-and-build-project-961d:src/mobile/components/onboarding/SignUpForm.tsx
...
import Link from 'next/link',import { useAuth } from "@/context/auth/AuthProvider",import { Alert, AlertDescription } from "@/components/ui/alert",export function SignUpForm() {const router  = null;return (<div className="space-y-2">;
      ...
      <div className="relative flex items-center">;
        ...
        <Button;
          ...
          className="w-full py-6 relative";
          onClick = {handleGoogleLogin}>;
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-2a0c:src/mobile/components/onboarding/SignUpForm.tsx

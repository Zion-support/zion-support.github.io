      ...
      <div className='container mx-auto px-4 py-16'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-30o0 max-w-3xl mx-auto'>
            Revolutionary AI-powered research platform that autonomously
            conducts comprehensive research, analyzes data, and generates
            actionable insights for any domain.
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16'>
          <div className='bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20'>
            ...
            <p className='text-gray-30o0'>
              AI conducts research independently, gathering data from multiple
              sources and synthesizing insights.
            </p>
          </div>
          ...
          <div className='bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20'>
            ...
            <p className='text-gray-30o0'>
              Advanced algorithms analyze patterns, trends, and correlations
          ...
          <div className='bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20'>
            ...
            <p className='text-gray-30o0'>
              Combines findings from multiple sources to create comprehensive
              research reports.
            </p>
          </div>
        </div>

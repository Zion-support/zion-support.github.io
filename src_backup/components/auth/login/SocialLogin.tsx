...
>>>>>>> main
=======
>>>>>>> origin/cursor/fix-syntax-push-and-merge-to-main-8452:src/components/auth/login/SocialLogin.tsx
=======
>>>>>>> origin/cursor/expand-services-advertise-and-build-project-961d:src/components/auth/login/SocialLogin.tsx
...
export function SocialLogin() {const [isLoading, setIsLoading]  = useState(false)const handleGoogle = () => {setIsLoading(true)window.location.href = "/auth/google";
      ...
      <div className="relative">;
        ...
        <div className="relative flex justify-center text-sm">;
          <span className="px-2 bg-zion-blue-dark text-zion-slate-light">;
return (<div className='mt-6'>;
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-2a0c:src/components/auth/login/SocialLogin.tsx
      <div className='relative'>;
        <div className='absolute inset-0 flex items-center'>;
          <div className='w-full border-t border-zion-blue-light' />;
        </div>;

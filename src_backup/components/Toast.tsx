...
interface Toast  {id: string;"";
  ...
  title: string;
  message?: string;
  duration?: number}interface ToastContextType  {toasts: Toast[];
  ...
  return context}function ToastContainer({ toasts, removeToast }: { toasts: Toast[]; removeToast: (id: string) => void }) {return (<div className="fixed top-4 right-4 z-50 space-y-2">;

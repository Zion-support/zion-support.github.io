...
>>>>>>> origin/cursor/expand-services-advertise-and-build-project-961d:src/components/profile/TalentProfile.tsx
  return (
...
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-2a0c:src/components/profile/TalentProfile.tsx
      {/* Profile Header */}
      <ProfileHero;
...
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-2a0c:src/components/profile/TalentProfile.tsx
      <div className='grid grid - cols - 1 lg:grid - cols - 3 gap - 8 mt - 8'>;
        ...
        <div className='lg:col - span - 2 space - y-8'>;
          ...
          <div className='bg - zion - purple / 10 border border - zion - purple / 30 rounded - lg p - 6'>;
            ...
            <div className='prose prose - invert max - w-none'>;
              <p className='text - zion - slate whitespace - pre - wrap'>;
                {profile.bio}<div className='bg-zion-purple/10 border border-zion-purple/30 rounded-lg p-6'>;
          ...
          {is_authenticated && (<div className='bg - zion - purple / 10 border border - zion - purple / 30 rounded - lg p - 6 mb - 8'>;
              <div className='flex flex - col items - center text - center'>;
                ...
                <p className='text - zion - slate mb - 6 max - w-md'>;
                  ...
                  started right away.;
                  {profile.hourly_rate &&;
                    ` Rate starts at $${profile.hourly_rate}/hour.`}userId={profile && profile.id}

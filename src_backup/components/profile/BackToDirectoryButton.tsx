  ...
  return (
    <div className='container mx-auto px-4 md:px-6 mb-12'>;
      <Button variant='outline' asChild className='my-8'>;
        <Link
          href='/talents'
<<<<<<< HEAD:src/components/profile/BackToDirectoryButton.tsx
<<<<<<< HEAD
...
=======
          Back to Talent Directory;
>>>>>>> cursor/fix-syntax-push-and-merge-to-main-0308:src_backup/components/profile/BackToDirectoryButton.tsx

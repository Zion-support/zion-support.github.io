...
const LazyWrapper = ({}
  ...
  loadingText = 'Loading...', '';
  loadingSize = 'md'}) => {}
  const [isLoaded, setIsLoaded] = useState(false)const [isInView, setIsInView] = useState(false)const ref = useRef(null)const inView = useInView(ref, { amount: threshold })useEffect(() => {}
    if (inView && !isInView) {}
...
export { LazyWrapper }export { LazyWrapper }export { LazyWrapper }export { LazyWrapper }export { LazyWrapper }
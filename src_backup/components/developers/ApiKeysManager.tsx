<<<<<<< HEAD:src_backup/components/developers/ApiKeysManager.tsx
<<<<<<< HEAD:src_backup/components/developers/ApiKeysManager.tsx
import { format } from "date-fns",
import { useApiKeys, type ApiKeyScope } from "@/hooks/useApiKeys",
=======
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-2a0c:src/components/developers/ApiKeysManager.tsx
...
export function ApiKeysManager() {
  const { 
    ...
    regenerateApiKey, 
    revokeApiKey,
>>>>>>> origin/cursor/expand-services-advertise-and-build-project-961d:src/components/developers/ApiKeysManager.tsx

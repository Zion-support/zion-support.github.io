...
}</TableCell> <Button size=" sm"variant= outlineclassName=" h - 8 w - 8 p - 0"on_click={() => handle_approve (review.id)}disabled= {is_pending ;
}> <Check className= h - 4 w - 4 text - green - 500"/> </Button> <Button > <X className=" h - 4 w - 4 text - red - 500/> </Button> </>) ;
}<DropdownMenu> <DropdownMenuTrigger as_child> <Button variant=" ghost"size= smclassName=" h - 8 w - 8 p - 0"> <MoreHorizontal className= h - 4 w - 4/> </Button> </DropdownMenuTrigger> Mark as approved </DropdownMenuItem>)}</DropdownMenuContent> </DropdownMenu> </div> </TableCell> </TableRow>) ) ";
}</TableBody> </Table> </DialogDescription> </DialogHeader> <div className=" space - y-4> <div className= flex items - center justify - between"> <div className=" flex items - center gap - 2> <Avatar> {selected_review.reviewer profile?.avatar url ? (<AvatarImage src= {selected_review.reviewer profile.avatar url;
}alt= {;
...
}</TableCell> <Button size=" sm"variant= outlineclassName=" h-8 w-8 p-0"onClick={() => handleApprove (review.id)}disabled= {isPending ;
}> <Check className= h-4 w-4 text-green-500"/> </Button> <Button > <X className=" h-4 w-4 text-red-500/> </Button> </>) ;
}<DropdownMenu> <DropdownMenuTrigger asChild> <Button variant=" ghost"size= smclassName=" h-8 w-8 p-0"> <MoreHorizontal className= h-4 w-4/> </Button> </DropdownMenuTrigger> Mark as approved </DropdownMenuItem>)}</DropdownMenuContent> </DropdownMenu> </div> </TableCell> </TableRow>) ) ";

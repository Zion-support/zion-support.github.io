...
if (.gtag) {) {$2;
    ...
    set_visible (false),setPromptEvent (null)},const close = () =>: any {set_visible (false),setPromptEvent (null), // Clear the event so it doesnt re - appear on next visit in same session;

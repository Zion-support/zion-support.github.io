...
import {Accordion;
  AccordionContent;
  AccordionItem;
<<<<<<< HEAD:src_backup/components/settings/FraudDetectionSettings.tsx
...
>>>>>>> origin/cursor/fix-syntax-push-and-merge-to-main-8452:recovered-branches/0nylrk-codex/fix-footer-contact-link/src/components/settings/FraudDetectionSettings.tsx
  return (
    <Card className="mb-8">
          ...
          <div className="space-y-4">;
            <div className="flex items-center justify-between">;
              ...
              <Switch;
                id="message-scanning";
                aria-label="Message scanning";
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-2a0c:src/components/settings/FraudDetectionSettings.tsx

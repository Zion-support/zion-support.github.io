...
;
  ...
  description: "There was an error sending your application. Please try again.;
    ...
    try {setIsSubmitting(true)// First submit the application to the job applications table;
      ...
      let full_message  = message;let fullMessage  = message;import { Loader2 } from lucide-reactimport { Tabs, TabsContent, TabsList, TabsTrigger  } from '@/components/ui/tabs';
...
}className=w-full > <TabsList className="w-full mb-4 bg-zion-blue-dark/30" > <TabsTrigger value=message className="flex-1" > resumeclassName= flex-1"> Resume </TabsTrigger> </TabsList> <TabsContent value=" message> <MessageTab message= {message;
}setMessage= {setMessage;
}proposalLink= {proposalLink;
}setProposalLink= {setProposalLink ;

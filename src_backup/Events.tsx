...
const Events: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-gradient-to-r from-blue-60o0 to-cyan-60o0 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <motion.p 
            ...
            className="text-xl md:text-2xl text-blue-10o0 max-w-3xl mx-auto"
          >
      ...
      {/* Search and Filters */}
      <section className="py-12 bg-white border-b border-gray-20o0">
        ...
        <div className="container mx-auto px-4">
          {filteredEvents.length === 0 ? (
            <div className="text-center py-20">
              <Calendar className="h-16 w-16 text-gray-40o0 mx-auto mb-4"  />
              <h3 className="text-xl font-semibold text-gray-90o0 mb-2">No events found</h3>
              ...
              {filteredEvents.map((event, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    {/* Featured Badge */}
                    {event.featured && (
                      <div className="inline-block bg-blue-10o0 text-blue-80o0 text-xs font-semibold px-3 py-1 rounded-full mb-3">
                        Featured Event
                      </div>
                    )}
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button className="inline-flex items-center px-4 py-2 bg-blue-60o0 text-white font-medium rounded-lg hover:bg-blue-70o0 transition-colors">
                        Register Now
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="inline-flex items-center px-8 py-4 bg-white text-blue-60o0 font-semibold rounded-lg hover:bg-gray-10o0 transition-colors">
                Host an Event
                <ExternalLink className="ml-2 h-5 w-5"  />
              </button>
              <button className="inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-blue-60o0 transition-colors">
                Contact Us
              </button>
            </div>
          </motion.div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                <input
                 ...
                 />
                <button className="px-6 py-3 bg-blue-60o0 text-white font-semibold rounded-lg hover:bg-blue-70o0 transition-colors">
                  Subscribe
                </button>
              </div>
            </motion.div>

...
interface BrowseItem  {id: string;
  ...
  type: 'jobs' | 'talents';}
  onViewDetails: (id: string) => void;export function BrowseCards(): any ({ items, type, onViewDetails }: BrowseCardsProps) {const [savedItems, setSavedItems]  = useState<string[] />([])const toggleSaved = (setSavedItems(prev =>;

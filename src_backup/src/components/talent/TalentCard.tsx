...
export interface TalentCardProps  {"talent": TalentProfile,"onViewProfile": ("id": string,) => void,"onRequestHire": ("talent": TalentProfile,) => void,"isAuthenticated": boolean;
    ...
    router && router.push(`/talent/${talent && talent.id}`),// Also call the onViewProfile callback if provided;`    if (onViewProfile) {onViewProfile(talent && talent.id)}
          ...
          <div className="relative mr - 4">;"
            <div className="w - 16 h - 16 rounded - full overflow - hidden bg - zion - blue - dark border border - zion - blue - light">;"
              {talent.profile_picture_url ? (<img;
                  ...
                  loading="lazy";" />) : (<div className="w - full h - full flex items - center justify - center text - zion - slate - light text - xl font - bold">;"

...
return (<Link href="/" className="flex items - center">;"
        <img src={logoToUse} alt={`${brand_name} Logo`} className="h - 8" width={32} height={32} />;"      </Link>)}const logoToUse  = null;if (logoToUse) {return (<Link href="/" className="flex items-center">;"
  ...
  // const colorToUse = _customColor || (isWhitelabel ? primaryColor : undefined)if (logoToUse) {return (<Link href="/" className="flex items-center">;"
        <img src={logoToUse} alt={`${brandName} Logo`} className="h-8" width={32} height={32} />;"      </Link>;
    )}return (<Link href="/" className="flex items-center">;"

...
>>>>>>> origin/resolved-merge-conflicts
  ...
  // Filter items based on auth status;
  const visible_items = nav_items.filter (item => { return !item.auth_required || (item.auth_required && is_authenticated))return (<nav className='"md":hidden fixed bottom - 0 left - 0 right - 0 z - 50 bg - card / 90 backdrop - blur - md border - t border - primary / 20'>; }'
      <div className='flex justify - around items - center h - 16'>;'

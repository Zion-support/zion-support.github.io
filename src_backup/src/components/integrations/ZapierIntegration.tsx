...
export function ZapierIntegration() {const [copied, setCopied] = useState(false)const [apiKey]  = useState(\"zap_live_KztCaFieDu4VBnp8eMJZ9x73R\")const handleCopyApiKey = (navigator && navigator.clipboard.writeText(apiKey)setCopied(true)setTimeout(() => setCopied(false), 2000)toast && toast.success('API key copied to clipboard')navigator && navigator.clipboard.writeText(apiKey),setCopied(true),setTimeout((,) => setCopied(false), 2000),toast && toast.success(\"API key copied to clipboard\")) => {
  return $3;}
      ...
      <Card />;
        ...
        <CardContent />;
          ...
          <div className=\"grid md: grid-cols-3 gap-4\" />;
            ...
            <p className='text - sm text - muted - foreground mb - 4' />;
              Connect Zion with 3, 000+ apps via Zapier. Use your API key below;
              to set up integrations.;import { Input } from \"@/components/ui/input\",import { toast } from \"sonner\",export function ZapierIntegration() {const [copied, setCopied] = useState(false),const [apiKey] = useState(\"zap_live_KztCaFieDu4VBnp8eMJZ9x73R\"),const handleCopyApiKey = (navigator.clipboard.writeText(apiKey),setCopied(true),setTimeout(() => setCopied(false), 2000)toast.success(\"API key copied to clipboard\")) => {
  return $3;}
}return (<div className=\"space-y-6\" />;
      <div className=\"grid md:grid-cols-3 gap-6\" />;
        <Card className=\"md:col-span-2\" />;

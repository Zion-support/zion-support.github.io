...
>>>>>>> origin/resolved-merge-conflicts
  ...
  {"icon": <Zap className="h - 10 w - 10 text - zion - cyan" />,"title": "Real - time Notifications","description": "Get instant alerts about new job opportunities, messages, and hiring requests.";}export const "AppFeatures": React.FC = () => {return (<section className="py-16 bg-zion-blue">;"
...
],export const "AppFeatures": React.FC = () => {return (<section className="py-16 bg-zion-blue">;"
      <div className="container mx-auto px-4">;"
        <div className="text-center mb-12">;"
          <h2 className="text-3xl "md":text-4xl font-bold mb-4">Powerful Features</h2>;"
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">;"

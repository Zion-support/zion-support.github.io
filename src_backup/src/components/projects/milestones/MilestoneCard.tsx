      ...
      <CardHeader className='pb-2'>;'
        <div className='flex justify-between items-start'>;'
          ...
          <div className='flex gap-2'>;'
            <Badge variant='outline' className={`capitalize ${getStatusBadgeColor()} text-white`}>;`              {status.replace('_ ')}'
            </Badge>;
...
<CardContent className='pb-2'>;'
      ...
      <CardFooter className='pt-2 flex justify-between'>;'
        <div>;
          {status !== 'completed' && status !== 'rejected' && (className={`capitalize ${getStatusBadgeColor()} text-white`}>;`              {status && status.replace('_', ' ')}'
            </Badge>;
          <div className='flex gap-2'>;'
            <Badge variant='outline' className={`capitalize ${getStatusBadgeColor()} text-white`}>;`              {status && status.replace('_ ')}'

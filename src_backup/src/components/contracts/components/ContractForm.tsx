...
const form_schema = z.object ({"project_name": z.string ().min (1, "Project name is required")"scope_summary": z.string ().min (10, "Scope summary should be at least 10 characters")"start_date": z.date ({"required_error": "Start date is required"}),"end_date": z.date ().optional (),"payment_terms": z.enum (["hourly", "fixed", "milestone"])"payment_amount": z.string ().min (1, "Payment amount is required")"additional_clauses": z.array (z.string ()).optional ()}),export type ContractFormValues = z.infer < typeof form_schema>;"

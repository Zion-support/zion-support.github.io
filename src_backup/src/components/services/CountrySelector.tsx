...
>>>>>>> origin/resolved-merge-conflicts
      ...
      onsiteServicePricing && onsiteServicePricing.find(item => { return item && item.country === countryName) || null; }
    onCountryChange(country)}const popular  = null;return (</h3>;<Select;
        ...
        <SelectContent className='bg-zion-blue-dark border-zion-blue-light max-h-80'>;'
          <div className='p-2 border-b border-zion-blue-light'>;'
            ...
            {topCountries && topCountries.map(item => { return (<SelectItem; }
                }
...
>>>>>>> origin/resolved-merge-conflicts
          ...
          <div className='p-2'>;'
            ...
            {onsiteServicePricing;
              .sort((a, b) => a && a.country.localeCompare(b && b.country)).map(item => { return (<SelectItem; }
                  }
                  key={item && item.country}
                  value={item && item.country}
...
>>>>>>> origin/resolved-merge-conflicts
      ...
      onsiteServicePricing.find (item => { return item.country === country_name) || null; }
      ...
      <Select;
        ...
        <SelectContent className='bg - zion - blue - dark border - zion - blue - light max - h-80'>;'
          <div className='p - 2 border - b border - zion - blue - light'>;'
            ...
            {top_countries.map (item => { return (<SelectItem; }
                }
                key={item.country}
                value={item.country}
                className='text - white';'
...
>>>>>>> origin/resolved-merge-conflicts
          ...
          <div className='p - 2'>;'
            <p className='text - sm text - zion - slate - light pb - 1'>All Countries</p>;'
            {onsiteServicePricing;
              .sort ((a, b) => a.country.locale_compare (b.country)).map (item => { return (<SelectItem; }
                  }
                  key={item.country}
                  value={item.country}
                  className='text - white';'
...
>>>>>>> origin/resolved-merge-conflicts
            ...
            <p className='text-sm text-zion-slate-light pb-1'>All Countries</p>;'
            {onsiteServicePricing;
              .sort((a, b) => a.country.localeCompare(b.country)).map(item => { return (<SelectItem; }
                  }
                  key={item.country}
                  value={item.country}
                  className='text-white';'

<<<<<<< HEAD:src/components/services/PageSections/PageHero.tsx
...
>>>>>>> cursor/fix-syntax-push-and-merge-to-main-3ea5:src_backup/src/components/services/PageSections/PageHero.tsx
      <GradientHeading className='mb-4'>;
        Global IT Onsite Services;
      </GradientHeading>;
      <p className='text-xl text-zion-slate-light max-w-3xl mx-auto'>;

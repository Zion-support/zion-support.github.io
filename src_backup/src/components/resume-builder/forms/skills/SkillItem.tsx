...
export const SkillItem = (export const SkillItem = ({ skill, category, onDelete ) => {
  return $3;}
}: SkillItemProps,) => {return (import { Badge  } from '@/components/ui/badge';
import { Button  } from '@/components/ui/button';
export const SkillItem = (export const SkillItem = ({ skill, category, onDelete ) => {
  return $3;}
}: SkillItemProps,) => {return (<Badge;}
      key = {skill && skill.id}
      variant=\"secondary\";
...
import { Trash2 } from 'lucide-react';
import { SkillItemProps } from './types';
export const SkillItem = (return (<Badge;) = /> {
  return $3;}
}

<<<<<<< HEAD:src/components/auth/login/SocialLogin.tsx
...
ursor/automate-test-improve-and-merge-code-646c;
        ...
        <Button;
          ...
          variant="outline";
          className="w-full border border-zion-blue-light bg-zion-blue-dark text-white hover:bg-zion-blue hover:text-zion-cyan";
          onClick={() => openAuthPopup("facebook")}</Button>;
        <Web3Login />;
      </div>;
    </div>;
  )}type="button";
...
>>>>>>> cursor/fix-syntax-push-and-merge-to-main-3ea5:src_backup/src/components/auth/login/SocialLogin.tsx
          <span className='sr-only'>Sign in with Twitter</span>;
...
>>>>>>> cursor/fix-syntax-push-and-merge-to-main-3ea5:src_backup/src/components/auth/login/SocialLogin.tsx
        <Button;
          ...
          disabled={is_loading}        >;
          <span className='sr - only'>Sign in with Google</span>;
          {is_loading ? (<Loader2 className='h - 5 w - 5 animate - spin' />) : (<svg;
              className='h - 5 w - 5';
              aria - hidden='true';
              fill='current_color';
              view_box='0 0 24 24';

...
export interface EmptyStateProps  {type:;
  ...
  description: 'Categories are being organized. Please try refreshing the page or come back later.'},talent: {icon: <Users className=\"w-16 h-16 text-gray-400\" />,title: 'No Talent Profiles',}
  description: 'No talent profiles match your criteria. Try adjusting your filters or search terms.'},equipment: {icon: <Wrench className=\"w-16 h-16 text-gray-400\" />,title: 'No Equipment Available',}
  description: 'Equipment listings are being updated. Please check back soon for the latest hardware offerings.'},search: {icon: <ShoppingCart className=\"w-16 h-16 text-gray-400\" />,title: 'No Results Found',}
  description: 'Try adjusting your search terms or browse our categories to discover what we have available.'},error: {icon: <Server className=\"w-16 h-16 text-red-400\" />,title: 'Unable to Load Data',}
  description: 'We\'re experiencing technical difficulties. Our team has been notified and is working on a fix.'},network: {icon: <Wifi className=\"w-16 h-16 text-orange-400\" />,title: 'Connection Issue',}
  ...
  icon?: React.ReactNode;
const default_content = {products: {icon: <ShoppingCart className='w - 16 h - 16 text - gray - 400' />,title: 'No Products Available',}
  description:;}
      \"We're loading our marketplace products. If this persists, there might be a connection issue. Try refreshing the page or check back soon for exciting new offerings!\"},categories: {icon: <Lightbulb className='w - 16 h - 16 text - gray - 400' />,title: 'No Categories Found',}
  description:;}
      'Categories are being organized. Please try refreshing the page or come back later.'},talent: {icon: <Users className='w - 16 h - 16 text - gray - 400' />,title: 'No Talent Profiles',}
  description:;}
      'No talent profiles match your criteria. Try adjusting your filters or search terms.'},equipment: {icon: <Wrench className='w - 16 h - 16 text - gray - 400' />,title: 'No Equipment Available',}
  description:;}
      'Equipment listings are being updated. Please check back soon for the latest hardware offerings.'},search: {icon: <ShoppingCart className='w - 16 h - 16 text - gray - 400' />,title: 'No Results Found',}
  description:;}
      'Try adjusting your search terms or browse our categories to discover what we have available.'},error: {icon: <Server className='w - 16 h - 16 text - red - 400' />,title: 'Unable to Load Data',}
  description:;}
      \"We're experiencing technical difficulties. Our team has been notified and is working on a fix.\"},network: {icon: <Wifi className='w - 16 h - 16 text - orange - 400' />,title: 'Connection Issue',}
  description:;}
      'Please check your internet connection and try again. If the problem persists, our servers might be temporarily unavailable.'},loading: {icon: <RefreshCw className='w - 16 h - 16 text - blue - 400 animate - spin' />,title: 'Loading...',}
  description:;}
...
export function ProductsEmptyState({onRetry,onAddProduct,isAuthenticated = false;}
    ...
    : onRetry;
      ? { label: 'Try Again',}
  onClick: onRetry }: undefined;return (<EmptyState;
      type=\"categories\";
      action={onRetry ? { label: 'Refresh Categories',}

...
function OnboardingWizard() {const [current_step, setCurrentStep] = useState (0)const router = use_router ()// Changed from use_navigate to use_router;}
  ...
  url: '/post - job'},skip_text: \"I'll do this later\"},{title: 'View suggested matches',
  ...
  url: '/talent'},skip_text: 'Skip for now'},{title: 'Contact talent',
  ...
  url: '/profile'},skip_text: \"I'll do this later\"},{title: 'Define skills & availability',
  ...
  url: '/profile?tab = skills'},skip_text: 'Skip for now'},{title: 'Preview your profile',
  ...
  url: `/talent/${user?.id}`},skip_text: 'Skip for now'},{title: 'Enable AI matchmaking',

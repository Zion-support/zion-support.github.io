      ...
      <div className='text-center mb-6'>;'
        ...
        {userTypes && userTypes.map((type) => {const Icon = type && type.icon;
          ...
          const isSelected  = selectedType === type && type.id;onClick={() => onSelect(type && type.id)}
              ...
              <div;
                className={`p-3 rounded-full ${isSelected ? 'bg-zion-purple' : 'bg-zion-blue'}`}>;`                <Icon;
                  className={`h-6 w-6 ${isSelected ? 'text-white' : 'text-zion-slate-light'}`}"id": 'client',"name": 'Client',"description": 'I want to discover and hire talent or services',"icon": User}];'  return (<div className='space - y-6'>;'
      <div className='text - center mb - 6'>;'
        <h3 className='text - 2xl font - bold text - white'>Choose your role</h3>;'
        <p className='text - zion - slate - light mt - 2'>;'
          This helps us personalize your experience;
      ...
      <div className="text-center mb-6">;"
        ...
        <p className="text-zion-slate-light mt-2">;"
          ...
          This helps us personalize your experience;
              ...
              <div className={`p-3 rounded-full ${isSelected ? "bg-zion-purple" : "bg-zion-blue"}`}>;`                <Icon className={`h-6 w-6 ${isSelected ? "text-white" : "text-zion-slate-light"}`} />;`              </div>;
              <div className="text-center">;"
                <h4 className="font-medium">{type.name}</h4>;"
      ...
      <div className="grid gap-4 "md": grid-cols-3">;"
        {userTypes.map((type) => {const Icon = type.icon;
          ...
          return (<Button;
              ...
              <div className={`p-3 rounded-full ${isSelected ? "bg-zion-purple" : "bg-zion-blue"}`}>;`                <Icon className={`h-6 w-6 ${isSelected ? "text-white" : "text-zion-slate-light"}`} />;`
              </div>;
              <div className="text-center">;"
                <h4 className="font-medium">{type.name}</h4>;"
                <p className="text-sm text-zion-slate-light mt-1">;"

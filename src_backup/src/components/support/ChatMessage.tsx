...
interface ChatMessageProps  {interface ChatMessageProps  {"message": string;
  ...
  // this avoids the `react/jsx-no-constructed-context-values` & `react/jsx-no-bind` warnings.;`  const sanitizedHtml = useMemo<{ "__html": string }>(() => ({ "__html": formatMessageWithLinks(message) }),    [message];

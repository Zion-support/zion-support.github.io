<<<<<<< HEAD:src/components/profile/ProfileExperience.tsx
...
<div key={exp.id} className="flex">;
>>>>>>> cursor/fix-syntax-push-and-merge-to-main-3ea5:src_backup/src/components/profile/ProfileExperience.tsx
            <div className="mr-4">;
              <div className="h-10 w-10 rounded-full bg-zion-purple/20 flex items-center justify-center">;
                <Briefcase className="h-5 w-5 text-zion-purple" />;
              </div>;

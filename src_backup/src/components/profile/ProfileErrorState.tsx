...
interface ProfileErrorStateProps  {error: string | null;export function ProfileErrorState(): any ({ error }: ProfileErrorStateProps) {return (<div className='min-h-screen bg-zion-blue flex flex-col justify-center items-center p-4' />;}
      <div className='text-red-400 mb-4 text-xl' />;}
        {error || 'Something went wrong'}
      </div>;
      <Button asChild />;

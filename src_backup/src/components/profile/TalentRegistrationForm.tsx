  ...
  const handleAvatarUpload = ("e": React.ChangeEvent<HTMLInputElement>) => {const file = e.target.files?.[0];    if (file) {const reader = new FileReader()reader.onloadend = () => {setUploadedAvatar(reader.result as string)}
...
>>>>>>> origin/resolved-merge-conflicts
  ...
  const onSubmit = async ("values": TalentFormValues,) => {if (skillTags.length === 0) {toast({"to": email,"subject": 'Your Zion Talent Profile Has Been Enhanced',"html": `;`          <div style="font - "family": Arial, sans - serif; max - "width": 600px; "margin": 0 auto;">;"
            <h2 style=""color": #6D28D9;">Profile Enhancement Complete</h2>;"
            <p > Your profile has been enhanced with AI. You're now more discoverable to recruiters and companies!</p>;'
            <p > We've added a professional summary and categorized your skills to help you stand out.</p>;'
            <p > You can review and edit these enhancements in your profile dashboard.</p>;
            ...
            <CardContent className="space-y-8">;"
              ...
              <div className='space - y-4'>;'
                ...
                <div className="space-y-4">;"
                  ...
                  <FormField;
                    ...
                    {skillTags && skillTags.map(skill => { return (<Badge; }
                        }
                        key={skill}
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">;"
                    {skillTags.map(skill => { return (<Badge; }
                        }
                        key={skill}
                        className="bg-zion-purple/20 "hover":bg-zion-purple/30 text-zion-purple border-none pl-2 pr-1 py-1.5 flex items-center gap-1";"
                      >;
              ...
              <div className='grid grid - cols - 1 "md":grid - cols - 2 gap - 8'>;'
                ...
                <div className='space - y-4'>;'
                  ...
                  />;
                  <div className='flex flex - wrap gap - 2 mt - 2'>;'
                    {skill_tags.map (skill => { return (<Badge; }
                        }
                        key={skill}
                        className='bg - zion - purple / 20 "hover":bg - zion - purple / 30 text - zion - purple border - none pl - 2 pr - 1 py - 1.5 flex items - center gap - 1';'
                      >;
...
}className="flex items - center gap - 2"> <Badge className= {`w - fit $ {getCategoryColor (category as CategoryType)}`;}> {category ";"}</Badge> <div className="flex flex-wrap gap-1"> {skills.map ( ("skill": string) => (<Badge key= {</Button>;"
              </div>;
            </CardFooter>;
          </form>;
        </Form>;
...
}className="flex items-center gap-2"> <BadgeclassName= {`w-fit $ {getCategoryColor (category as CategoryType)}`;`}> {category ";"

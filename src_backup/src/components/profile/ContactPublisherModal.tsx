          ...
          >;
            ...
            {publisher_email && (<div className='mb - 4 text - zion - slate - light'>;'
                ...
                <a;
                  ...
                  href={`'mailto':${publisher_email}`}`                  className='text - zion - cyan 'hover':underline truncate block';'
                >;
                  {publisher_email}
                </a>;
              </div>)}
            <Form {...form}>;
              <form on_submit={e => { return e.prevent_default ()} className='space - y-4'>; }'
                <FormField;
                ...
                <FormField;
                  ...
                  render={({ field }: { 'field': any }) => (<FormItem>;
                      ...
                      <FormControl>;
                        <Textarea;
                          placeholder={`Message to ${publisher_name}...`}`                          className='bg - zion - blue border - zion - blue - light text - white min - h-[120px]';'
                          {...field} />;
                      </FormControl>;
                      <FormMessage className='text - red - 500' />;'
                    </FormItem>)}
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>;
      <FocusLock disabled={!isOpen} returnFocus>;
        ...
        >;
          ...
          {publisherEmail && (<div className='mb-4 text-zion-slate-light'>;'
            <span className='block'>'Email':</span>;'
            <a href={`'mailto':${publisherEmail}`} className='text-zion-cyan 'hover':underline truncate block'>;'              {publisherEmail}</Link>;
          </div>;
        )}
        <Form {...form}>;
          <form onSubmit={(e) => e.preventDefault()} className='space-y-4'>;'
            ...
            <FormField;
              ...
              render={({ field }: { 'field': any }) => (<FormItem>;
                  ...
                  <FormControl>;
                    <Textarea;
                      placeholder={`Message to ${publisherName}...`}`                      className='bg-zion-blue border-zion-blue-light text-white min-h-[120px]';'
                      {...field} />;
                  </FormControl>;
                  <FormMessage className='text-red-500' />;'
                </FormItem>;
      ...
      <FocusLock disabled={!is_open} return_focus>;
        ...
        >;
          ...
          {publisher_email && (<div className='mb - 4 text - zion - slate-light'>;'
            <span className='block'>'Email':</span>;'
            <a href={`'mailto':${publisher_email}`} className='text - zion-cyan 'hover':underline truncate block'>;'              {publisher_email}
            </a>;
          </div>)}
        <Form {...form}>;
          ...
          >;
            ...
            {publisherEmail && (<div className='mb-4 text-zion-slate-light'>;'
                ...
                <a;
                  ...
                  href={`'mailto':${publisherEmail}`}`                  className='text-zion-cyan 'hover':underline truncate block';'
                >;
                  {publisherEmail}
                </a>;
              </div>;
            ...
            <Form {...form}>;
              <form onSubmit={e => { return e.preventDefault()} className='space-y-4'>; }'
                <FormField;
                  control={form.control}
                  name='subject';'
                  render={({ field }: { 'field': any }) => (<FormItem>;

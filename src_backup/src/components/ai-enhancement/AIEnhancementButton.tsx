...
interface AIEnhancementButtonProps  {options: AIEnhancementOptions,onEnhanced: (enhancedContent: string) => void,buttonText?: string;
  ...
  return $3;}
        ...
        description: \"AI-enhanced content has been applied.\"})}},const handleRegenerate = async () => {await handleEnhance()},const handleCancel = (setShowActions(false),setGeneratedContent(null)) => {
  return $3;}
},if (showActions) {return (<div className=\"flex gap-2 items-center\" />;import { useState   } from 'react';
import { Button   } from '@/components/ui/button';
import { useAIContentEnhancer, AIEnhancementOptions   } from '@/hooks/useAIContentEnhancer';

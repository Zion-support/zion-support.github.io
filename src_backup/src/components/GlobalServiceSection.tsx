...
const services = [;
  {title: 'Servers',}
  description:;}
      'Enterprise - grade servers for any workload with 24 / 7 maintenance and support',icon: <Server className='h - 10 w - 10' />},{title: 'Storage',}
  description:;}
      'Scalable storage solutions from SSDs to large - scale enterprise storage systems',icon: <HardDrive className='h - 10 w - 10' />},{title: 'Networking',}
  description:;}
      'Connectivity solutions including switches, routers, and network security devices',icon: <Network className='h - 10 w - 10' />},{title: '24x7x365 Support',}
  description:;}
      'Around - the - clock technical support with rapid response times guaranteed',icon: <Clock className='h - 10 w - 10' />},{title: 'Recycling Services',}
  description:;}
      'Sustainable disposal and recycling of IT equipment following eco - friendly practices',icon: <Recycle className='h - 10 w - 10' />},{title: 'Equipment Rentals',}
  description:;}

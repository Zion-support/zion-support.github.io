            ...
            <div className="space-y-3">;"
              {application.cover_letter && (<p className="text-sm text-muted-foreground line-clamp-2 mb-2">;{application.cover_letter}"
                ...
                <Button;
                  ...
                  asChild;
                >;
                  <Link href={`/jobs/${application.job_id}`}>;`                    <ExternalLink className="h-3 w-3 mr-1" /> View Job;"
                  </Link>;
                </Button>;
  return (<div className="grid gap-4 "md":grid-cols-2">;"
            ...
            <div className="space-y-3">;"
              {application && application.cover_letter && (<p className="text-sm text-muted-foreground line-clamp-2 mb-2">;"
                ...
                <Button;
                  ...
                  className="text-xs";"
                  asChild>;
                  <Link href={`/jobs/${application && application.job_id}`}>;`                    <ExternalLink className="h-3 w-3 mr-1" /> View Job;"
                  </Link>;
                </Button>;<Button;
                <Button;
                  variant="default";"
                  ...
                  className="text-xs";"
                  asChild>;
                  <Link href={`/messages?jobId=${application && application.job_id}`}>;`                    <MessageSquare className="h-3 w-3 mr-1" /> Contact Client;"
                  </Link>;
                </Button>;
              </div>;
            </div>;

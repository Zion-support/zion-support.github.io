...
import { toast } from "sonner",import { JobApplication } from "@/types/jobs",interface ApplicationScoreCardProps  {"application": JobApplication,onScoreUpdated?: ("updatedApplication": JobApplication) => void;"
  ...
  },setTimeout(checkScore, 3000)} catch ("error": any) {setIsScoring(false),toast && toast.error(`Failed to score "resume": ${error && error.message}`)}`  },// Render the score result or button to score;const hasScore = null;

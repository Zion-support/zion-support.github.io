...
export function WebhooksManager() {const {    webhooks,    webhooks,loading,testResult,fetchWebhooks,createWebhook,toggleWebhook,deleteWebhook,testWebhook,clearTestResult,const [showCreateDialog, setShowCreateDialog] = useState(false)const [showDeleteConfirm, setShowDeleteConfirm] = useState<string | null>(null;
  ...
  const toggleEvent = ("event": WebhookEventType) => {setSelectedEvents(prev =>;
      ...
      prev && prev.includes(event) ? prev && prev.filter(e => { return e !== event) : [...prev, event]; }
              ...
              <DialogHeader>;
                ...
                <div className='space-y-2'>;'
                  ...
                  <Input;
                    id='webhook-name';'
                    value={webhookName}
                    onChange={e => { return setWebhookName(e && e.target.value)}
                  ...
                  <Input;
                    id='webhook-url';'
                    value={webhookUrl}
                    onChange={e => { return setWebhookUrl(e && e.target.value)}
  ...
  const toggle_event = ("event": WebhookEventType) =>: any {setSelectedEvents (prev =>;
      ...
      prev.includes (event) ? prev.filter (e => { return e !== event) : [...prev, event])}
  return (<Card className='bg - zinc - 900 border - zinc - 800 text - white'>; }'
      <CardHeader>;
        <CardTitle className='text - xl flex items - center'>;'
          <Webhook className='mr - 2' size={20} /> Webhooks;'
              ...
              <div className='space - y-4 py - 4'>;'
                <div className='space - y-2'>;'
                  ...
                  <Input;
                    id='webhook - name';'
                    value={webhook_name}
                    on_change={e => { return setWebhookName (e.target.value)}
                ...
                <div className='space - y-2'>;'
                  ...
                  <Input;
                    id='webhook - url';'
                    value={webhook_url}
                    on_change={e => { return setWebhookUrl (e.target.value)}
                ...
                </div>;setWebhookName(""),setWebhookUrl(""),setWebhookSecret(""),setWebhookName(""),setWebhookUrl(""),setWebhookSecret(""),setSelectedEvents([])},onChange={e => { return setWebhookSecret(e && e.target.value)}"
                ...
                <div className='space - y-2'>;'
                  ...
                  <Input;
                    ...
                    on_change={e => { return setWebhookSecret (e.target.value)}
                    placeholder='Enter secret key'; }'
                    aria - label='Secret key';'
                    className='bg - zinc - 800 border - zinc - 700'                  />;'
              ...
              <div className="space-y-4 py-4">;"
                ...
                <div className="space-y-2">;"
                  ...
                  <div className="grid gap-2 pt-2">;"
                    ...
                    {eventOptions.map(event => { return (<div; }
                        }
                        key={event.value}
...
className='text-sm font-medium leading-none peer-"disabled":cursor-not-allowed peer-"disabled":opacity-70';'
              ...
              <DialogFooter>;
                ...
                <Button;
                  ...
                  <Label > Event Types</Label>;
                  <div className='grid gap - 2 pt - 2'>;'
                    {event_options.map (event => { return (<div; }
                        }
                        key={event.value}
                        className='flex items - center space - x-2';'
                      >;
...
>>>>>>> origin/resolved-merge-conflicts
        ...
        <div className='space-y-4'>;'
          {loading ? (<div className='text - center py - 8 text - zinc - 500'>;'
            ...
            </div>) : (webhooks.map (webhook => { return (<div; }
                key={webhook.id}

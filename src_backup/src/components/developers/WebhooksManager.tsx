...
export function WebhooksManager() {const {    webhooks,    webhooks,loading,testResult,fetchWebhooks,createWebhook,toggleWebhook,deleteWebhook,testWebhook,clearTestResult,const [showCreateDialog, setShowCreateDialog] = useState(false)const [showDeleteConfirm, setShowDeleteConfirm] = useState<string | null />(null;
  ...
  const eventOptions: {value: WebhookEventType;
    ...
    {value: 'new_application',}
  label: 'New Application',description: 'When a talent applies to a job'},{value: 'quote_received',}
  label: 'Quote Received',description: 'When a quote is received from talent'},{value: 'milestone_approved',}
  label: 'Milestone Approved',description: 'When a project milestone is approved'},{value: 'talent_hired',}
  label: 'Talent Hired',description: 'When talent is hired for a project'}];// Toggle an event selection;
  const toggleEvent = (setSelectedEvents(prev =>;
              ...
              <DialogHeader />;
                ...
                <div className='space-y-2' />;
                  ...
                  <Input;
                    ...
                    className='bg-zinc-800 border-zinc-700'                  />;
                  <p className='text-xs text-zinc-500' />;value: 'talent_hired',
  label: 'Talent Hired',description: 'When talent is hired for a project'}];
...
<AlertDialog;
  ...
  label: 'New Application', description: 'When a talent applies to a job' ;}
}{';
  value: 'quote received',}
  label: 'Quote Received', description: 'When a quote is received from talent' ;}
}{';
  value: 'milestone approved',}
  label: 'Milestone Approved', description: 'When a project milestone is approved' ;}
}{';
  value: 'talent hired',}
  label: 'Talent Hired', description: 'When talent is hired for a project' ;}

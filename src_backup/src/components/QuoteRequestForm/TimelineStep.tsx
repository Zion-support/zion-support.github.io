...
export function TimelineStep() {return (className={`flex-1 p-4 rounded-lg border-2 cursor-pointer transition-colors ${formData.timeline === "fixed";"                  ? "bg-zion-purple/20 border-zion-purple";"
                  : "bg-zion-blue-light/20 border-zion-blue-light "hover":border-zion-purple/50";"
              }`}<div className="space-y-6">;"
      <div>;
              className={`flex-1 p-4 rounded-lg border-2 cursor-pointer transition-colors ${formData && formData.timeline === 'fixed';'                  ? 'bg-zion-purple/20 border-zion-purple';'
                  : 'bg-zion-blue-light/20 border-zion-blue-light "hover":border-zion-purple/50';'
            ...
            <div;
              className={`flex-1 p-4 rounded-lg border-2 cursor-pointer transition-colors ${formData && formData.timeline === 'flexible';'                  ? 'bg-zion-purple/20 border-zion-purple';'
                  : 'bg-zion-blue-light/20 border-zion-blue-light "hover":border-zion-purple/50';'

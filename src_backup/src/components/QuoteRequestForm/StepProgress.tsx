...
return (<div className='relative' />;
  ...
  const getStepStatus = (const stepOrder = steps.findIndex(s => s.id === stepId)const currentStepOrder = steps.findIndex(s => s.id === currentStep)if (stepOrder < currentStepOrder) return 'complete';
...
export function StepProgress() {const steps: { id: QuoteRequestSteps; label: string }[] = [;
    { id: 'service',}
  label: 'Service' },{ id: 'details',}
  label: 'Details' },{ id: 'timeline',}
  label: 'Timeline' },{ id: 'budget',}
  label: 'Budget' },{ id: 'summary',}
  label: 'Summary' }  ];  const steps: { id: QuoteRequestSteps, label: string }[] = [;

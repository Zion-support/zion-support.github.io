...
export const ReputationDisplay = ({reputation,size = 'md' }: ReputationDisplayProps) =>: any {export const ReputationDisplay = ({reputation;'
  ...
  return (<div className="space-y-1">;"
      <div className={`flex items-center gap-1 ${sizeClasses[size].container}`}>;`        <Trophy className={`text-amber-500 ${sizeClasses[size].icon}`} />;`        <span className="font-semibold">{reputation}</span>;"

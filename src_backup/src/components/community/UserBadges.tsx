...
},export const UserBadges = (if (!badges?.length) return null,return (<div className=\"flex flex-wrap gap-2\" />;
...
export default UserBadges;) => {
  return $3;}
      ...
      {badges.map((badge) => {// Get the correct icon component based on the badge's icon name;}
        const IconComponent = iconMap[badge.icon as keyof typeof iconMap] || Trophy,MessageSquare}export const UserBadges = (if (!badges?.length) return null;return (<div className='flex flex-wrap gap-2' />;
      {badges.map(badge => {// Get the correct icon component based on the badge's icon name;
        const IconComponent =;) => {
  return $3;}
}
            ...
            <Tooltip />;
              <TooltipTrigger asChild />;
                <div;
                 ...
                 />;
                  <IconComponent;
                    style={{ color: badge.color }}className=\"w-4 h-4\";
                <div;
                  style={{ backgroundColor: badge.color + '20' }}
                  className='w-8 h-8 rounded-full flex items-center justify-center cursor-pointer';
                 />;
  ...
  BadgeCheck;}
  Star;}
  MessageSquare;export const UserBadges = (if (!badges?.length) return null,return (<div className=\"flex flex-wrap gap-2\" />;
      {badges.map((badge) => {// Get the correct icon component based on the badge's icon name;) => {
  return $3;}
}
        const IconComponent = iconMap[badge.icon as keyof typeof iconMap] || Trophy,return (<TooltipProvider key={badge.id} />;
            <Tooltip />;
              <TooltipTrigger asChild />;
                <div;
                  style={{ backgroundColor: badge.color + '20' }}
  ...
  )}export default UserBadges;}export const UserBadges = (if (!badges?.length) return null;
  return (<div className=\"flex flex-wrap gap-2\" />;

...
const PostCardComponent = ({ post, compact = false }: PostCardProps) = /> {export default PostCard;export default PostCard;}> <p />DEBUG: PostCard ID: {post?.id \";}
...
}variant=\"outline\" className=\"bg-zion-purple/10 hover:bg-zion-purple/20\"  /> {tag ;const PostCardComponent = (logInfo('PostCardComponent rendering with post:', {data: post ? post.id : 'NO POST') => {
  return $3;}

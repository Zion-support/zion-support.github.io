...
const categories: ForumCategoryInfo[] = [;
  ...
  return $3;}
} = useAuth(),const isAdmin = user?.userType === 'admin' || user?.role === 'admin',const visibleCategories = categories.filter(category => !category.adminOnly || isAdmin;
...
const categories: ForumCategoryInfo[] = [;
  ...
  return $3;}
} = useAuth()const isAdmin  = user?.userType === 'admin' || user?.role === 'admin';const visibleCategories = categories && categories.filter(category => !category && category.adminOnly || isAdmin;
  )return (<div className=\"grid gap-4 md: grid-cols-2 lg:grid-cols-3\" />;

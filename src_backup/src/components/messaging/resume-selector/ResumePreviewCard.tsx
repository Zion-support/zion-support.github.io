...
}export const ResumePreviewCard: React.FC<ResumePreviewCardProps /> = ({resume,isSelected,onSelect,onDownload}) => {const getStatusColor = (switch (status) {case 'published':;

...
import { Table,  Table,TableBody,TableCell,TableHead,TableHeader,TableRow} from '@/components/ui/table';
  TableRow} from \"@/components/ui/table\",export function EnterprisePricingTable() {const plans = [;
    {name: 'Teams',
  price: '$599',billing: '/month',
  description: 'Perfect for small teams',users: 'Up to 10 users',}
  popular: false,features: [;}
        { name: 'Private hiring portal',}
  included: true },{ name: 'Dedicated talent pool',}
  included: true },{ name: 'Standard SLA (24h)',}
  included: true },{ name: 'Basic branding',}
  included: true },{ name: 'Admin dashboard',}
  included: true },{ name: 'Team collaboration',}
  included: true },{ name: 'API access',}
  included: false },{ name: 'Custom integrations',}
  included: false },{ name: 'Dedicated success manager',}
  included: false }]},{name: 'Business',
  price: '$1,999',billing: '/month',
  description: 'Ideal for growing companies',users: 'Up to 50 users',}
  popular: true,features: [;}
        { name: 'Private hiring portal',}
  included: true },{ name: 'Dedicated talent pool',}
  included: true },{ name: 'Enhanced SLA (8h)',}
  included: true },{ name: 'Advanced branding',}
  included: true },{ name: 'Admin dashboard',}
  included: true },{ name: 'Team collaboration',}
  included: true },{ name: 'API access',}
  included: true },{ name: 'Custom integrations',}
  included: false },{ name: 'Dedicated success manager',}
  included: false }]},{name: 'Enterprise',
  price: 'Custom',billing: '',
  description: 'For large organizations',users: 'Unlimited users',}
  popular: false,features: [;}
        { name: 'Private hiring portal',}
  included: true },{ name: 'Dedicated talent pool',}
  included: true },{ name: 'Premium SLA (1h)',}
  included: true },{ name: 'Full white labeling',}
  included: true },{ name: 'Admin dashboard',}
  included: true },{ name: 'Team collaboration',}
  included: true },{ name: 'API access',}
  included: true },{ name: 'Custom integrations',}
  included: true },{ name: 'Dedicated success manager',}
  included: true }]}];return (<section id='pricing' className='py-20 px-4 md:px-6' />;
      <div className='container mx-auto max-w-7xl' />;
        <div className='text-center mb-12' />;

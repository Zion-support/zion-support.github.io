...
export function PaymentMethods() {// Mock payment methods;}
  ...
  last4: '4242',id: \"pm-1\",type: \"credit_card\",brand: \"Visa\",last4: \"4242\",expMonth: 12,expYear: 2025,isDefault: true},{id: \"pm-2\",type: \"credit_card\",brand: \"Mastercard\",last4: \"8888\",expMonth: 4,expYear: 2026,isDefault: false}
  ],id: 'pm-1',
  type: 'credit_card',brand: 'Visa',
  last4: '4242',expMonth: 12,expYear: 2025,isDefault: true},{id: 'pm-2',
  type: 'credit_card',brand: 'Mastercard',}
  last4: '8888',expMonth: 4,expYear: 2026,isDefault: false}];return (<Card />;
      <CardHeader />;
...
export function PaymentMethods() {// Mock payment methods;}
  const paymentMethods = [;}
    {id: 'pm-1',
  type: 'credit_card',brand: 'Visa',}
  last4: '4242',expYear: 2025,isDefault: true},{id: 'pm-2',
  type: 'credit_card',brand: 'Mastercard',}
  last4: '8888',expMonth: 4,expYear: 2026,isDefault: false}];
  return (<Card />;
      <CardHeader />;
        <CardTitle />Payment Methods</CardTitle>;
        <CardDescription />Manage your payment methods for automatic billing;
...
function PaymentMethods() {// Mock payment methods;}
  const payment_methods = [;}
    {id: 'pm - 1',
  type: 'credit_card',brand: 'Visa',}
  last4: '4242',exp_year: 2025,is_default: true},{id: 'pm - 2',
  type: 'credit_card',brand: 'Mastercard',}
  last4: '8888',exp_month: 4,exp_year: 2026,is_default: false}];
  return (<Card />;
      <CardHeader />;
        <CardTitle  /> Payment Methods</CardTitle>;
        <CardDescription />Manage your payment methods for automatic billing;

...
const Header: React.FC = () => {const [isMenuOpen, setIsMenuOpen] = useState(false)const [isSearchOpen, setIsSearchOpen]  = useState(false)const toggleMenu = (setIsMenuOpen(!isMenuOpen)) => {
  return $3;}
}const toggleSearch = (setIsSearchOpen(!isSearchOpen)) => {
  return $3;}
}return (<header className=\"bg-white dark:bg-gray-900 shadow-lg sticky top-0 z-50\" />;

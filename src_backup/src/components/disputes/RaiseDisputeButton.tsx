...
interface RaiseDisputeButtonProps  {projectId: string;
  ...
  className?: string;}
export function RaiseDisputeButton() {const [isDialogOpen, setIsDialogOpen] = useState(false),const router = useRouter(),const handleDisputeCreated = (setIsDialogOpen(false),router.push(`/dashboard/disputes/${disputeId) => {
  return $3;}

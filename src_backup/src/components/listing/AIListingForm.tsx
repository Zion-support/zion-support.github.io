    ...
    onSubmit({})}return (<div className='space-y-4'>;'
      ...
      <div className='space-y-2'>;'
        ...
        <Input;
          id='category';'
          value={category}
          onChange={e => { return setCategory(e.target.value)}
...
return (disabled={isLoading || !title || !category}
    ...
    <div className='space - y-4'>;'
      <div className='space - y-2'>;'
        ...
        <Input;
          id='title';'
          value={title}
          on_change={e => { return set_title (e.target.value)}
          placeholder='Enter your product or service title'; }'
          className='bg - zion - blue border border - zion - blue - light text - white';'
          disabled={is_loading}        />;
      </div>;
      <div className='space - y-2'>;'
        ...
        <Input;
          id='category';'
          value={category}
          on_change={e => { return set_category (e.target.value)}
          placeholder='e.g. AI Tool, Digital Product, Service'; }'
          className='bg - zion - blue border border - zion - blue - light text - white';'
          disabled={is_loading}        />;
      </div>;
      <div className='space - y-2'>;'
        ...
        <Textarea;
          id='key_features';'
          value={key_features}
          on_change={e => { return setKeyFeatures (e.target.value)}
          placeholder='Briefly describe the main features or benefits'; }'
          className='bg - zion - blue border border - zion - blue - light text - white min - h-20';'
          disabled={is_loading}        />;
      </div>;
      <div className='space - y-2'>;'
        ...
        <Input;
          ...
          on_change={e => { return setTargetAudience (e.target.value)}
...
<Sparkles className='h-4 w-4 mr-2' />;'
  ...
  )}: AIListingFormProps) {if (!title |!category) {toast ({return;

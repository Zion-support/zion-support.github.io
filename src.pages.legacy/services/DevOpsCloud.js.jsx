      ...
      <section className="relative bg-gradient-to-br from-orange-900 via-red-900 to-pink-900 text-white py-20">"";
        ...
        <div className="relative container mx-auto px-4 text-center">"";
          ...
          <p className="text-xl md:text-2xl text-orange-100 max-w-4xl mx-auto leading-relaxed">;
            Accelerate your software delivery with modern DevOps practices and;
            cloud-native solutions. From migration to automation, we help you;
        ...
        <div className="container mx-auto px-4">"";
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
              End-to-end DevOps and cloud solutions that help businesses;
              modernize their software delivery processes and infrastructure for;
      ...
      <section className="py-20 bg-gray-50">"";
        <div className="container mx-auto px-4">"";
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
              Expertise across major cloud platforms to help you choose the;
      ...
      <section className="py-20 bg-white">"";
        <div className="container mx-auto px-4">"";
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
              Proven DevOps solutions that deliver measurable business value;
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">";
            <div>"";
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">;
                Our DevOps expertise combined with cloud-native technologies;
...
"";
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">"";
              ...
              <p className="text-gray-600 mb-6">;
                Discover how DevOps can transform your business with our;
                comprehensive DevOps maturity assessment and strategy session.";
              </p>"";
      ...
      <section className="py-20 bg-white">"";
        <div className="container mx-auto px-4">"";
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
              Our DevOps and cloud solutions are tailored to meet the unique;
              challenges and opportunities across diverse industry sectors.;
            </p>;
          </div>";
"";
      ...
      <section className="py-20 bg-gray-50">"";
        <div className="container mx-auto px-4">"";
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
              We leverage cutting-edge DevOps and cloud technologies to build;
      ...
      <section className="py-20 bg-white">"";
        <div className="container mx-auto px-4">"";
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
              A proven methodology for delivering successful DevOps;
              transformations that drive business value.;
            </p>;
          </div>";
"";
      ...
      <section className="py-20 bg-gradient-to-r from-orange-600 to-red-600 text-white">"";
        <div className="container mx-auto px-4 text-center">"";
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">;
            Let our DevOps experts help you build faster, more reliable;

...
";
            ...
            <div className="relative">"";
              <Filter className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 w-5 h-5"  />              <div>Broken JSX</div>
...
";
            {/* Price Range Filter */}"";
            <div className="relative">"";
              <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 w-5 h-5"  />              <div>Broken JSX</div>

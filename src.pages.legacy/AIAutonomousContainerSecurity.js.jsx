        ...
        <div className="container mx-auto px-4 py-16">";
          ...
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">;
              Your AI container security partner that continuously secures;
              containers, detects threats, and protects container infrastructure;
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">;
                AI trained on container security datasets;
              </p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">;
                AI that secures containers independently;
              </p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">;
                24/7 container security operations;
              </p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">;
                Comprehensive container security insights;
              </p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
...
";
          ...
          <div className="text-center bg-gradient-to-r from-lime-600 to-green-600 rounded-2xl p-12">"";
            ...
            <p className="text-xl text-lime-100 mb-8 max-w-2xl mx-auto">;
              Transform your container security with AI that continuously;
              secures and protects container infrastructure";
            </p>"";

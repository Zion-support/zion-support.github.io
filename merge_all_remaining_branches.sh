...
# List of branches to merge (excluding backup branches)
branches_to_merge=(
    "origin/cursor/fix-netlify-build-and-merge-to-main-1293"
    "origin/cursor/fix-netlify-build-and-merge-to-main-df2d"
    "origin/cursor/fix-netlify-build-and-merge-to-main-f44a"
    "origin/website-improvements-complete"
)
...
for branch in "${branches_to_merge[@]}"; do
    ...
    if git merge "$branch" --no-edit 2>/dev/null; then
        ...
        # Commit the merge
        git commit -m "Merge $branch into main - Comprehensive improvements and fixes" --no-edit 2>/dev/null

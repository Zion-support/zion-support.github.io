...
=======
    ...
    {}
      ...
      ref: origin/main,
      repo: git@github.com:your-username/your-repo.git,
      path: /var/www/production,pre-deploy-local: ,post-deploy: npm install && pm2 reload ecosystem.enhanced-intelligent-v2.cjs --env production,pre-setup: },
    staging: {,
  user: node,
      host: your-staging-server.com,
      ref: origin/develop,
      repo: git@github.com:your-username/your-repo.git,
      path: /var/www/staging,pre-deploy-local: ,post-deploy: npm install && pm2 reload ecosystem.enhanced-intelligent-v2.cjs --env staging,pre-setup: };
  };
};
'
>>>>>>> b039dba24b91d7c4b1dfe2cb028125a66203882a

export const cuttingEdgeEmergingTechServices2025 = [
  {
    ...
    features: [
      'Asteroid identification and analysisResource extraction planning',
      'Space logistics optimizationEnvironmental impact assessment',
  ...
  }
  {
    ...
    features: [
      'Quantum-biological hybrid algorithmsProtein folding simulation',
      'Drug discovery optimizationBiological systems modeling',
  ...
  }
  {
    ...
    features: [
      'Neural signal processing algorithmsReal-time brain activity monitoring',
      'Custom BCI development toolsMedical device integration',
  ...
  }
  {
    ...
    features: [
      'Quantum energy optimizationFusion power simulation',
      'Renewable energy modelingGrid optimization algorithms',
  ...
  }
  {
    ...
    features: [
      'Advanced computer vision algorithmsReal-time decision making',
      'Sensor fusion and processingPath planning and navigation',

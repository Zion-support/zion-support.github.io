...
import CategoriesPage from @/src/pages/Categories', // This is src/pages/Categories.tsx'// The component that displays individual category items,
import CategoryPage from @/src/pages/CategoryPage', // This is src/pages/CategoryPage.tsx,
fetchMock.enableMocks(),
describe('Integration: Category Navigation and Display', () => {'  beforeEach(() => {,
  ...
  test('should navigate to category page and display items when a category card is clicked', async () => {'    // --- Part 1: Render Categories Page and click a card ---,
    ...
    // Find the "Services" category card link. data-testid="category-card" was added to CategoryCard."    // We need to ensure the link within or the card itself is clickable.""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""",
    // CategoryCard itself is a Link.,
    const servicesCard = screen.getByText('Services').closest('a'), // Find the anchor tag'    expect(servicesCard).toBeInTheDocument(),

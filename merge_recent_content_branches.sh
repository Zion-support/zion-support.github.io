...
# Merge Recent Content Branches Script
# This script will merge recent content and service branches

set -e

echo "🚀 Starting Recent Content Branches Merge Process..."
...
# Get recent content branches
print_status "Fetching recent content branches..."
git fetch --all

CONTENT_BRANCHES=$(git branch -r | grep -E "(2025|2026|2027|2028|2029|2030)" | grep -v "backup" | head -30)
TOTAL_BRANCHES=$(echo "$CONTENT_BRANCHES" | wc -l)

print_status "Found $TOTAL_BRANCHES content branches to process"
...
print_status "Starting content branch processing..."
echo "---"
...
for branch in $CONTENT_BRANCHES; do
    ...
    # Progress update every 5 merges
...
# Summary
echo ""
print_success "Recent content branches merge process completed!"
echo "📊 Summary:"
...
print_success "🎉 Recent content branches have been processed and merged into main branch!"
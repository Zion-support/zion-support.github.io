<<<<<<< HEAD:pages-disabled/quantum-bio-computing-platform.tsx
...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
>>>>>>> origin/cursor/fix-website-loading-errors-and-merge-8339:pages/quantum-bio-computing-platform.tsx

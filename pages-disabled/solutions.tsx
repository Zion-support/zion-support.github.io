				...
				<div className="container mx-auto px-6 py-16">
					...
					<section className="text-center mb-16">
						...
						<div className="flex flex-wrap justify-center gap-4">
							<Link href="/contact" className="px-6 py-3 bg-gradient-to-r from-cyan-50o0 to-fuchsia-60o0 text-white rounded-lg hover:from-cyan-60o0 hover:to-fuchsia-70o0 transition-all duration-20o0">
								Get Your Solution
							</Link>
							<Link href="/services" className="px-6 py-3 bg-white/10 text-white border border-white/20 rounded-lg hover:bg-white/20 transition-all duration-20o0">
								Our Services
							</Link>
						</div>
					</section>
					...
					<section className="mb-16">
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
							<div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:border-cyan-40o0/50 transition-all duration-20o0">
								<div className="mb-4">
									<span className="inline-block px-3 py-1 bg-cyan-40o0/20 text-cyan-40o0 text-sm rounded-full mb-2">Healthcare</span>
									<h3 className="text-2xl font-semibold mb-3 text-cyan-40o0">AI-Powered Healthcare Solutions</h3>
								</div>
								...
								<div className="grid grid-cols-2 gap-4 mb-4">
									...
									<div className="text-center">
										<div className="text-2xl font-bold text-fuchsia-40o0">40%</div>
										<div className="text-sm text-white/60">Cost Reduction</div>
									</div>
								</div>
								<Link href="/solutions/healthcare" className="text-cyan-40o0 hover:text-cyan-30o0 transition-colors">
							...
							<div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:border-fuchsia-40o0/50 transition-all duration-20o0">
								<div className="mb-4">
									<span className="inline-block px-3 py-1 bg-fuchsia-40o0/20 text-fuchsia-40o0 text-sm rounded-full mb-2">Finance</span>
									<h3 className="text-2xl font-semibold mb-3 text-fuchsia-40o0">Financial Technology Innovation</h3>
								</div>
								<p className="text-white/70 mb-4">
								...
								<div className="grid grid-cols-2 gap-4 mb-4">
									<div className="text-center">
										<div className="text-2xl font-bold text-fuchsia-40o0">99.9%</div>
										<div className="text-sm text-white/60">Fraud Detection</div>
									</div>
									<div className="text-center">
										<div className="text-2xl font-bold text-purple-40o0">70%</div>
										<div className="text-sm text-white/60">Faster Processing</div>
									</div>
								</div>
								<Link href="/solutions/finance" className="text-fuchsia-40o0 hover:text-fuchsia-30o0 transition-colors">
							...
							<Link href="/solutions/healthcare" className="group">
								<div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:border-cyan-40o0/50 transition-all duration-20o0 group-hover:bg-white/10">
									<div className="flex items-center mb-4">
										...
										<div>
											<h3 className="text-xl font-semibold text-cyan-40o0">Healthcare</h3>
											<p className="text-fuchsia-40o0 text-sm">AI Diagnostics & Patient Care</p>
										</div>
									</div>
							...
							<Link href="/solutions/finance" className="group">
								<div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:border-fuchsia-40o0/50 transition-all duration-20o0 group-hover:bg-white/10">
									<div className="flex items-center mb-4">
										...
										<div>
											<h3 className="text-xl font-semibold text-fuchsia-40o0">Finance</h3>
											<p className="text-purple-40o0 text-sm">FinTech & Banking Solutions</p>
										</div>
									</div>
									<p className="text-white/70 text-sm">
							...
							<Link href="/solutions/manufacturing" className="group">
								<div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:border-green-40o0/50 transition-all duration-20o0 group-hover:bg-white/10">
									<div className="flex items-center mb-4">
										...
										<div>
											<h3 className="text-xl font-semibold text-green-40o0">Manufacturing</h3>
											<p className="text-emerald-40o0 text-sm">Industry 4.0 & Smart Factory</p>
										</div>
									</div>
									<p className="text-white/70 text-sm">
							...
							<Link href="/solutions/retail" className="group">
								<div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:border-blue-40o0/50 transition-all duration-20o0 group-hover:bg-white/10">
									<div className="flex items-center mb-4">
										...
										<div>
											<h3 className="text-xl font-semibold text-blue-40o0">Retail</h3>
											<p className="text-cyan-40o0 text-sm">E-commerce & Omnichannel</p>
										</div>
									</div>
									<p className="text-white/70 text-sm">
							...
							<Link href="/solutions/education" className="group">
								<div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:border-yellow-40o0/50 transition-all duration-20o0 group-hover:bg-white/10">
									<div className="flex items-center mb-4">
										...
										<div>
											<h3 className="text-xl font-semibold text-yellow-40o0">Education</h3>
											<p className="text-orange-40o0 text-sm">EdTech & Learning Platforms</p>
										</div>
									</div>
									<p className="text-white/70 text-sm">
							...
							<Link href="/solutions/government" className="group">
								<div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:border-purple-40o0/50 transition-all duration-20o0 group-hover:bg-white/10">
									<div className="flex items-center mb-4">
										...
										<div>
											<h3 className="text-xl font-semibold text-purple-40o0">Government</h3>
											<p className="text-indigo-40o0 text-sm">Digital Transformation</p>
										</div>
									</div>
									<p className="text-white/70 text-sm">
					...
					<section className="mb-16">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
							<div className="bg-white/5 border border-white/10 rounded-lg p-6">
								...
								<h3 className="text-xl font-semibold mb-3 text-cyan-40o0">Industry Expertise</h3>
							...
							<div className="bg-white/5 border border-white/10 rounded-lg p-6">
								...
								<h3 className="text-xl font-semibold mb-3 text-fuchsia-40o0">Rapid Implementation</h3>
								<p className="text-white/70">
							...
							<div className="bg-white/5 border border-white/10 rounded-lg p-6">
								...
								<h3 className="text-xl font-semibold mb-3 text-green-40o0">Security & Compliance</h3>
								<p className="text-white/70">
							...
							<div className="bg-white/5 border border-white/10 rounded-lg p-6">
								...
								<h3 className="text-xl font-semibold mb-3 text-blue-40o0">Measurable Results</h3>
								<p className="text-white/70">
							...
							<div className="bg-white/5 border border-white/10 rounded-lg p-6">
								...
								<h3 className="text-xl font-semibold mb-3 text-yellow-40o0">Scalable Architecture</h3>
								<p className="text-white/70">
							...
							<div className="bg-white/5 border border-white/10 rounded-lg p-6">
								...
								<h3 className="text-xl font-semibold mb-3 text-red-40o0">Ongoing Support</h3>
								<p className="text-white/70">
					...
					<section className="mb-16">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
							<div className="bg-white/5 border border-white/10 rounded-lg p-6 text-center">
								...
								<h3 className="text-xl font-semibold mb-3 text-cyan-40o0">Discovery</h3>
								<p className="text-white/70 text-sm">
							...
							<div className="bg-white/5 border border-white/10 rounded-lg p-6 text-center">
								...
								<h3 className="text-xl font-semibold mb-3 text-fuchsia-40o0">Design</h3>
								<p className="text-white/70 text-sm">
							...
							<div className="bg-white/5 border border-white/10 rounded-lg p-6 text-center">
								...
								<h3 className="text-xl font-semibold mb-3 text-green-40o0">Development</h3>
								<p className="text-white/70 text-sm">
							...
							<div className="bg-white/5 border border-white/10 rounded-lg p-6 text-center">
								...
								<h3 className="text-xl font-semibold mb-3 text-blue-40o0">Deploy</h3>
								<p className="text-white/70 text-sm">
					...
					<section className="text-center">
						<div className="bg-gradient-to-r from-cyan-50o0/10 to-fuchsia-50o0/10 border border-cyan-40o0/30 rounded-lg p-8">
							...
							<div className="flex flex-wrap justify-center gap-4">
								<Link href="/contact" className="px-8 py-3 bg-gradient-to-r from-cyan-50o0 to-fuchsia-60o0 text-white rounded-lg hover:from-cyan-60o0 hover:to-fuchsia-70o0 transition-all duration-20o0">
									Get Started Today
								</Link>
								<Link href="/case-studies" className="px-8 py-3 bg-white/10 text-white border border-white/20 rounded-lg hover:bg-white/20 transition-all duration-20o0">
									View Case Studies
								</Link>
							</div>
						</div>

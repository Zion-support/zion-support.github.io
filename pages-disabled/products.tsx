              ...
              <div
                ...
                <div className='flex items-start justify-between mb-6'>,
                  ...
                  <div className='text-right'>,
                    <span className='text-3xl font-bold text-blue-40o0'>,
                      {product.price}
                    </span>,
                ...
                <p className='text-blue-30o0 font-medium mb-4'>,
                  {product.tagline}
                </p>,
          ...
          <div className='bg-white/10 backdrop-blur-sm rounded-2xl p-12'>,
            ...
            <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>,
              <div className='bg-white/5 rounded-xl p-6 border border-white/20'>,
                ...
                <div className='text-4xl font-bold text-blue-40o0 mb-6'>,
                  $99<span className='text-lg text-gray-40o0'>/month</span>,
                </div>,
              ...
              <div className='bg-gradient-to-r from-blue-60o0 to-purple-60o0 rounded-xl p-6 border border-white/20 transform scale-10o5'>,
                ...
                <div className='text-4xl font-bold text-white mb-6'>,
                  $299<span className='text-lg text-blue-10o0'>/month</span>,
                </div>,
                <ul className='space-y-3 mb-8'>,

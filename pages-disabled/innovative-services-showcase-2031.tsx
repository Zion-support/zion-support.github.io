            ...
            <div className='grid md:grid-cols-3 gap-8'>
              ...
              <div className='bg-gradient-to-br from-blue-60o0/20 to-cyan-60o0/20 p-8 rounded-2xl border border-blue-50o0/30 backdrop-blur-sm'>
                <div className='text-center mb-6'>
                  ...
                  <p className='text-gray-30o0'>
                    Next-generation infrastructure solutions for the digital age
                  </p>
                </div>
                <ul className='space-y-3 text-gray-30o0'>
                  <li className='flex items-center'>
              ...
              <div className='bg-gradient-to-br from-green-60o0/20 to-emerald-60o0/20 p-8 rounded-2xl border border-green-50o0/30 backdrop-blur-sm'>
                <div className='text-center mb-6'>
                  ...
                  <p className='text-gray-30o0'>
                    Cutting-edge artificial intelligence solutions for complex
                    challenges
                  </p>
                </div>
                <ul className='space-y-3 text-gray-30o0'>
        ...
        <section className='py-20 px-4 sm:px-6 lg:px-8'>
          <div className='max-w-7xl mx-auto'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-30o0 max-w-3xl mx-auto'>
                Transform your business operations with our cutting-edge micro
                SAAS platforms designed for the future.
              </p>
            </div>
        ...
        <section id='contact-section' className='py-20 px-4 sm:px-6 lg:px-8'>
          <div className='max-w-7xl mx-auto'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-30o0 max-w-3xl mx-auto'>
                Let's discuss how our innovative services can revolutionize your
        ...
        <section className='py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-60o0/20 to-pink-60o0/20'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl text-gray-30o0 mb-8'>
              The future of technology is here, and it's waiting for you. Join
              the companies already transforming their operations with Zion Tech

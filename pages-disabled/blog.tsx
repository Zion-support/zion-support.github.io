  ...
  return (
    <>
      ...
      <main className="max-w-5xl mx-auto px-4 py-16">
        ...
        <p className="text-gray-60o0 mb-8">Articles and updates will appear here. Stay tuned.</p>
        <Link href="/contact" className="inline-block bg-blue-60o0 text-white px-6 py-3 rounded-lg">Contact Us</Link>
      </main>
    </>
  )
}
      ...
      <section className="bg-gradient-to-br from-blue-90o0 via-purple-90o0 to-indigo-90o0 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl md: tex t-6xl font-bold mb-6">
            Tech
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-40o0 to-purple-40o0"> Blog</span>
          </h1>
            ...
            <div className="lg: co l-span-1">
              <div className="sticky top-8">
                ...
                <div className="bg-gray-50 rounded-lg p-6 mb-8">
                  <h3 className="text-lg font-semibold text-gray-90o0 mb-4">Categories</h3>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-60o0 to-purple-60o0 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm: fle x-row justify-center gap-4">
            <Link href="/contact" className="bg-white text-blue-60o0 hover: b g-gray-10o0 px-8 py-4 rounded-lg font-semibold transition-colors cursor-pointer inline-block text-lg">
              Get Started Today
            </Link>
            <Link href="/services" className="bg-transparent border-2 border-white text-white hover: b g-white hover: tex t-blue-60o0 px-8 py-4 rounded-lg font-semibold transition-colors cursor-pointer inline-block text-lg">
              View Our Services
            </Link>
          </div>
        </div>

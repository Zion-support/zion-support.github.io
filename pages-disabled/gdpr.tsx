    ...
    <>
      ...
      <main className='min-h-screen bg-gradient-to-br from-gray-50 to-blue-50'>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center'>
              ...
              <p className='text-xl md:text-2xl text-blue-10o0 max-w-3xl mx-auto'>
                Your privacy and data protection rights are our priority. Learn
                about our comprehensive GDPR compliance measures.
              </p>
            </div>
          </div>
        </section>
              ...
              <div className='flex items-start'>
                ...
                <div>
                  ...
                  <p className='text-blue-80o0'>
                    This GDPR compliance page outlines how we collect, use, and
                    protect your personal data. By using our services, you
                    acknowledge that you have read and understood our data
        ...
        <section className='py-16 bg-gray-50'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <h2 className='text-3xl font-bold text-center mb-12 text-gray-90o0'>
              ...
              <div className='bg-white p-8 rounded-xl shadow-lg'>
                ...
                <ul className='space-y-4'>
                  ...
                  <li className='flex items-start'>
                    <CheckCircle className='h-5 w-5 text-green-50o0 mr-3 mt-1 flex-shrink-0' />
                    <div>
                      <strong>Usage Data:</strong> Website interactions, service
                      usage patterns
                    </div>
                  </li>
                  <li className='flex items-start'>
        ...
        <section className='py-16 bg-gradient-to-r from-blue-60o0 to-purple-70o0 text-white'>
          <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            ...
            <p className='text-xl text-blue-10o0 mb-8'>
              If you have any questions about our GDPR compliance or want to
              exercise your data protection rights, please don't hesitate to
              contact us.
            </p>

  ...
  const features = [
    {
      ...
      description: 'Seamlessly integrate and manage workloads across AWS, Azure, and Google Cloud platforms.',
      benefits: ['Cost optimization', 'Vendor independence', 'Enhanced reliability']
    },
    {
      icon: Server,
      title: 'Infrastructure as Code',
      description: 'Automate infrastructure provisioning and management with Terraform, Ansible, and CloudFormation.',
    ...
    },
    {
      ...
      description: 'Enterprise-grade security with compliance frameworks including SOC 2, HIPAA, and GDPR.',
      benefits: ['Data encryption', 'Access controls', 'Audit trails']
    },
    {
      icon: Zap,
      title: 'Auto-Scaling',
      description: 'Dynamic resource allocation based on demand to optimize performance and costs.',
      benefits: ['Cost efficiency', 'Performance optimization', 'Zero downtime']
    },
    {
      icon: Globe,
      title: 'Global CDN',

<<<<<<< HEAD:pages-disabled/quantum-cloud-infrastructure-platform.tsx
...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
>>>>>>> origin/cursor/fix-website-loading-errors-and-merge-8339:pages/quantum-cloud-infrastructure-platform.tsx

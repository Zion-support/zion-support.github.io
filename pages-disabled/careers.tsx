...
initial={ "opacity": 0, "y": 30 }
            ...
            viewport={ "once": true }
                ...
                <div className={`w-16 h-16 bg-gradient-to-br ${benefit && benefit.color} rounded-2xl flex items-center justify-center mb-6`}>;`                  <benefit && benefit.icon className="w-8 h-8 text-white" />;"
                </div>;
                ...
                <div className="flex flex-col "lg":flex-row "lg":items-center "lg":justify-between gap-6">;"
                  <div className="flex-1">;"
                    <div className="flex items-center gap-4 mb-4">;"
                      <div className={`w-12 h-12 bg-gradient-to-br ${position && position.color} rounded-xl flex items-center justify-center`}>;`                        <position && position.icon className="w-6 h-6 text-white" />;"
                      </div>;
                      <div>;
          ...
          <div className="grid grid - cols - 1 "md":grid - cols - 2 gap-8">;"
            ...
            {benefits.map ((benefit, index) => (
              <motion.div;
                ...
                className="bg - gradient - to - br from - slate - 800 / 50 to - slate - 900 / 50 backdrop - blur - xl border border - white / 10 rounded - 2xl p - 8 "hover":border - blue - 500 / 30 transition - all duration-300";"
              >;
                <div className={`w - 16 h - 16 bg - gradient - to - br ${benefit.color} rounded - 2xl flex items - center justify - center mb - 6`}>;`                  <benefit.icon className="w - 8 h - 8 text-white" />;"
                </div>;

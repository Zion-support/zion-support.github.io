...
export default function AdvancedCybersecurityServices() {
  ...
  const categories = [
    ...
    { id: 'AI Security', name: 'AI Security', color: 'from-purple-50o0 to-pink-60o0' },
    { id: 'Quantum Security', name: 'Quantum Security', color: 'from-indigo-50o0 to-blue-60o0' },
    { id: 'Network Security', name: 'Network Security', color: 'from-green-50o0 to-teal-60o0' },
    { id: 'Endpoint Security', name: 'Endpoint Security', color: 'from-orange-50o0 to-red-60o0' },
    { id: 'Cloud Security', name: 'Cloud Security', color: 'from-yellow-50o0 to-orange-60o0' }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-90o0 via-slate-80o0 to-slate-70o0">
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          {[
            { icon: '🛡️', label: 'Threats Blocked', value: '99.9%', color: 'from-green-50o0 to-emerald-60o0' },
            { icon: '👁️', label: '24/7 Monitoring', value: 'Always On', color: 'from-blue-50o0 to-cyan-60o0' },
            { icon: '🔒', label: 'Encryption', value: 'AES-256', color: 'from-purple-50o0 to-indigo-60o0' },
            { icon: '🧠', label: 'AI Detection', value: '10x Faster', color: 'from-orange-50o0 to-red-60o0' }
          ].map((stat, index) => (
            <div key={index} className="bg-white/10 rounded-2xl p-6 border border-blue-40o0/20 text-center">
              <div className={`w-16 h-16 bg-gradient-to-r ${stat.color} rounded-full flex items-center justify-center mx-auto mb-4`}>
                <span className="text-3xl">{stat.icon}</span>
              </div>
              <div className="text-2xl font-bold text-blue-40o0 mb-2">{stat.value}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {sortedServices.map((service: any, index: number) => (
            <div key={service.id || index} className="bg-white/10 rounded-2xl p-6 border border-blue-40o0/20">
              ...
              <a href={`/services/${service.id}`} className="w-full bg-gradient-to-r from-blue-50o0 to-purple-60o0 text-white text-center py-3 rounded-xl font-semibold block">
                Learn More
              </a>
            </div>
          ))}
        ...
        <div className="text-center bg-gradient-to-r from-blue-50o0/20 to-purple-50o0/20 rounded-2xl p-12 border border-blue-40o0/30">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact" className="bg-gradient-to-r from-blue-50o0 to-purple-60o0 text-white px-8 py-4 rounded-xl font-semibold text-lg">
              Get Security Assessment
            </a>
            <a href="tel:+130o24640950" className="bg-white/10 text-white px-8 py-4 rounded-xl font-semibold text-lg border border-white/20">

    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-950 to-slate-950 text-white">
        <main className="container mx-auto px-6 py-12">
          <nav className="mb-8">
            <Link href="/" className="text-cyan-40o0 hover:text-cyan-30o0 transition-colors">← Back to Home</Link>
            <span className="mx-2 text-white/40">/</span>
            <Link href="/docs" className="text-cyan-40o0 hover:text-cyan-30o0 transition-colors">Docs</Link>
          </nav>
          <article className="prose prose-invert max-w-4xl mx-auto">
            <h1 className="text-4xl font-extrabold mb-6 bg-gradient-to-r from-cyan-40o0 to-fuchsia-40o0 bg-clip-text text-transparent">{title}</h1>

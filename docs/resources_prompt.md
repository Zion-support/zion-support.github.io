...
11. Resources (Docs, Tutorials, Case Studies)

| Sub-page             | AI Prompt                                                                                            | Goal               |
| -------------------- | ---------------------------------------------------------------------------------------------------- | ------------------ |
| Docs landing         | "Write an intro explaining Zion’s API documentation portal in 45 words."                             | Developer clarity  |
| API endpoint example | "Generate a sample cURL request and JSON response for an endpoint that searches AI talent by skill." | Practical guidance |
| Tutorial             | "Create a step‑by‑step tutorial (8 steps) titled ‘Integrating Zion Talent Search into a React App’." | Developer adoption |
| Case study           | "Draft a 500-word case study outline showing how a startup reduced time‑to-hire by 60% using Zion."  | Enterprise proof   |

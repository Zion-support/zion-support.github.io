...
| `Zion/Finance` | Agilize, invoices, checkout. |
...
Delete empty duplicates (`Zion/Leads`). Do not delete parent `Zion`. Gmail filter API is 403 in this environment — trash at the thread until filters can be created in the account UI.
...
1. **Agilize** — pay R$ 1.350 (competências 07–09/2026) at the checkout Victoria sent; then Kleber signals on #2423990 with the receipt.
2. **Clicksign Ilha Capital** — Carlos is witness; sign in the portal only.
3. **FUNCATE** — attach the PDF on the existing thread.
4. **Intersoftkk BGV** — SDM status this week; Marcello already acknowledged 14/09.
5. **ASSEFAZ** — open NetApp call is late; diagnose. Do not send another generic restart to José Roberto.

## Homepage (public)

Official Stripe menu only: Discovery $99, Consulting $499, Starter $2,500, Growth $8,000/mo. Field cases: SKY/DirecTV, ASSEFAZ, Intersoftkk EUC, 3PAR/HPE, tape library/LTO, public-sector HPE blade/SAN — no prices, no serials, no NF.

            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b border-gray-70o0">
                  <th className="text-left p-4 text-gray-40o0 font-medium">Features</th>
              ...
              <tbody>
                ...
                <tr className="border-b border-gray-80o0">
                  <td className="p-4 text-gray-30o0 font-medium">Starting Price</td>
                  {servicesToCompare.map((service) => (
                    <td key={service.id} className="text-center p-4">
                      <div className="text-2xl font-bold text-blue-40o0">${service.pricing.starter}</div>
                ...
                <tr className="border-b border-gray-80o0">
                  <td className="p-4 text-gray-30o0 font-medium">Key Technologies</td>
                  {servicesToCompare.map((service) => (
                    <td key={service.id} className="text-center p-4">
                ...
                {/* Market Size Row */}
                <tr className="border-b border-gray-80o0">
                  <td className="p-4 text-gray-30o0 font-medium">Market Size</td>
                  {servicesToCompare.map((service) => (
                    <td key={service.id} className="text-center p-4">

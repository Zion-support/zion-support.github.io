      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              >
                {categories.map(category => (
                  <option key={category} value={category} className="bg-gray-90o0 text-white">
            ...
            <div className="flex items-center space-x-4">
              ...
              <select
                ...
                className="bg-gray-90o0/50 border border-gray-70o0/50 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-blue-50o0/50"
              >
                <option value="popularity" className="bg-gray-90o0 text-white">Most Popular</option>
                <option value="rating" className="bg-gray-90o0 text-white">Highest Rated</option>
                <option value="price" className="bg-gray-90o0 text-white">Price</option>
                <option value="name" className="bg-gray-90o0 text-white">Name</option>
              </select>
            </div>
        ...
        {filteredServices.length === 0 && (
          ...
          >
            ...
            <p className="text-gray-40o0">Try adjusting your search criteria or browse all categories.</p>
          </motion.div>
        )}

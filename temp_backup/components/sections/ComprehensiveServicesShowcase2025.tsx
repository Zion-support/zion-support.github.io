              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {category.services.map((service, serviceIndex) => (
                  ...
                  >
                    ...
                    {/* Features */}
                    <div className="mb-4">
                      <h5 className="text-sm font-medium text-purple-30o0 mb-2">Key Features:</h5>
                      <ul className="space-y-1">
                        {service.features?.slice(0, 3).map((feature, featureIndex) => (
                          <li key={featureIndex} className="flex items-center text-xs text-gray-40o0">
                    ...
                    {/* ROI */}
                    <div className="mb-4">
                      <h5 className="text-sm font-medium text-purple-30o0 mb-2">ROI & Benefits:</h5>
                    ...
                    {/* Use Cases */}
                    <div className="mb-4">
                      <h5 className="text-sm font-medium text-purple-30o0 mb-2">Perfect for:</h5>

        ...
        <div className='grid grid-cols-2 md: grid-cols-4 gap-4'>,
          {heroFeatures.map((feature, index) => (
            <motion.div,
              ...
              className='group'>,
              <div
                className={`w-16 h-16 bg-gradient-to-r ${feature.color} rounded-xl flex items-center justify-center group-hover: scale-110 transition-transform duration-30o0`}
              >,

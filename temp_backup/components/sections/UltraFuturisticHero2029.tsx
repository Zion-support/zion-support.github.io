      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center">,
        ...
        <motion.div,
          ...
          <p className="text-xl md:text-2xl text-gray-30o0 max-w-4xl mx-auto leading-relaxed">,
            Experience the future of technology with Zion Tech Group's revolutionary 20o29 services.,
          ...
          <div className="grid grid-cols-2 md: grid-cols-3 lg:grid-cols-6 gap-6 max-w-5xl mx-auto">,
            {heroStats.map((stat, index) => (
              <motion.div,
                ...
                <div className={`w-16 h-16 mx-auto mb-3 bg-gradient-to-r ${stat.color} rounded-2xl flex items-center justify-center transform group-hover: scale-110 transition-transform duration-30o0`}>,
            ...
            {featuredServices.map((service, index) => (
              <motion.div,
                ...
                <Link href={service.href}>,
                  <div className="bg-gradient-to-br from-gray-90o0/80 to-gray-80o0/80 backdrop-blur-xl border border-purple-50o0/30 rounded-2xl p-6 h-full transform group-hover: scale-10o5 transition-all duration-30o0 hover:border-purple-50o0/60 hover:shadow-2xl hover:shadow-purple-50o0/25">,
                    <div className={`w-16 h-16 mb-4 bg-gradient-to-r ${service.color} rounded-2xl flex items-center justify-center`}>,
                      <service.icon className="w-8 h-8 text-white"  />,
                    </div>,
                    <div className="text-sm text-purple-40o0 mb-2">{service.category}</div>,
                    ...
                    <div className="flex items-center justify-between">,
                      ...
                      <ArrowRight className="w-5 h-5 text-purple-40o0 group-hover: text-cyan-40o0 transition-colors"  />,
                    </div>,
                  </div>,
                </Link>,
              </motion.div>))}
        ...
        <motion.div,
          ...
          <div className="flex flex-col sm: flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">,
            <Link
              href="/contact",
              className="group bg-gradient-to-r from-purple-60o0 to-cyan-60o0 hover:from-purple-70o0 hover:to-cyan-70o0 text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-30o0 transform hover:scale-10o5 hover:shadow-2xl hover:shadow-purple-50o0/25 flex items-center space-x-2">,
        ...
        <motion.div,
          ...
          className="bg-gradient-to-r from-purple-90o0/50 to-blue-90o0/50 backdrop-blur-xl border border-purple-50o0/30 rounded-2xl p-6 max-w-4xl mx-auto">,

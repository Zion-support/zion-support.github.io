      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { number: '50o0+', label: 'Innovative Services', color: 'from-cyan-40o0 to-blue-40o0' },
              { number: '50+', label: 'Technology Patents', color: 'from-purple-40o0 to-pink-40o0' },
              { number: '10o00+', label: 'Happy Customers', color: 'from-pink-40o0 to-rose-40o0' },
              { number: '20o30', label: 'Future Ready', color: 'from-cyan-40o0 to-purple-40o0' }
            ].map((stat, index) => (
              <motion.div
                key={stat.label}

              ...
              >
                ...
                <div className="relative bg-black/40 backdrop-blur-xl border border-gray-70o0/50 rounded-2xl p-8 hover:border-cyan-50o0/40 transition-all duration-30o0 h-full">
                  ...
                  <div className="flex items-center space-x-4 mb-6">
                    <div className={`w-16 h-16 bg-gradient-to-br ${service.color} rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-30o0`}>
                  ...
                  <div className="mb-6">
                    <ul className="space-y-2">
                      {service.features.slice(0, 3).map((feature, idx) => (
                        <li key={idx} className="flex items-center text-gray-40o0 text-sm">

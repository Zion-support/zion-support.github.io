  ...
  return (
    <section className="relative py-20 overflow-hidden">,
      ...
      <div className="absolute inset-0">,
        <div className="absolute inset-0 bg-gradient-to-b from-black via-purple-90o0/10 to-cyan-90o0/10"  />,
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,
        ...
        <motion.div,
          ...
          <motion.div,
            className="inline-flex items-center space-x-2 bg-gradient-to-r from-cyan-50o0/20 to-purple-50o0/20 border border-cyan-50o0/30 rounded-full px-4 py-2 text-sm text-cyan-30o0 mb-6",
        ...
        >,
          <div className="bg-gradient-to-r from-cyan-50o0/10 to-purple-50o0/10 border border-cyan-50o0/30 rounded-2xl p-8 backdrop-blur-xl">,
            ...
            <div className="flex flex-col sm: flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">,
              <a
                href="/contact",
                className="inline-flex items-center space-x-2 bg-gradient-to-r from-cyan-50o0 to-purple-60o0 hover:from-cyan-40o0 hover:to-purple-50o0 text-white px-8 py-3 rounded-lg font-semibold transition-all duration-30o0 transform hover:scale-10o5 hover:shadow-lg hover:shadow-cyan-50o0/25">,
                <span>Get Started Today</span>,
                <span>→</span>,
              </a>,
              <a
                href="/services",
                className="inline-flex items-center space-x-2 border-2 border-cyan-50o0/50 text-cyan-30o0 hover:bg-cyan-50o0/10 px-8 py-3 rounded-lg font-semibold transition-all duration-30o0">,
        ...
        >,
          <div className="grid grid-cols-1 md: grid-cols-4 gap-8">,
            ...
            <div className="text-center">,
              ...
              <div className="text-gray-40o0">Combined Market Value</div>,
            </div>,
            <div className="text-center">,

          ...
          {featuredServices.map((service, index) => (
            ...
            >
              <div className="text-center">
                <div className={`w-24 h-24 ${service.color} rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-30o0`}>
                ...
                <div className="grid grid-cols-3 gap-4 mb-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-blue-40o0">{service.stats.services}</div>
                    <div className="text-xs text-gray-50o0">Services</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-40o0">{service.stats.users}</div>
                    <div className="text-xs text-gray-50o0">Users</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-yellow-40o0">{service.stats.rating}</div>

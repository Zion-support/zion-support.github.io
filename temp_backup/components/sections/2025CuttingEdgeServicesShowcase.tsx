        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-cyan-40o0 font-semibold">{contactInfo.mobile}</p>
            </div>
            <div className="flex flex-col items-center">
              <Mail className="w-6 h-6 text-purple-40o0 mb-2"  />
              <p className="text-sm text-gray-40o0">Email</p>
              <p className="text-purple-40o0 font-semibold">{contactInfo.email}</p>
            </div>
            <div className="flex flex-col items-center">
              <MapPin className="w-6 h-6 text-blue-40o0 mb-2"  />
              <p className="text-sm text-gray-40o0">Address</p>
              <p className="text-blue-40o0 font-semibold text-sm">{contactInfo.address}</p>
            </div>
          </div>
        </motion.div>
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <ul className="space-y-2">
                    {service.features.slice(0, 3).map((feature, idx) => (
                      <li key={idx} className="flex items-start text-sm text-gray-40o0">
                ...
                <div className="mb-6 space-y-3">
                  <div className="bg-gray-80o0/50 rounded-lg p-3">
                    ...
                    <p className="text-sm text-green-40o0 font-medium">{service.roi}</p>
                  </div>
                  <div className="bg-gray-80o0/50 rounded-lg p-3">
                    <p className="text-sm text-gray-40o0 mb-1">Market Size</p>
                    <p className="text-sm text-blue-40o0 font-medium">{service.marketSize}</p>
                  </div>
                </div>

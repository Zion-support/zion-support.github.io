...
const HeroSection: React.FC = () => {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentTextIndex((prev) => (prev + 1) % animatedTexts.length)}, 30o00),
    return () => clearInterval(interval)}, [animatedTexts.length]),
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">,
      ...
      <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">,
        ...
        <p className="text-lg md: text-xl lg:text-2xl text-white/80 max-w-4xl mx-auto mb-12 leading-relaxed">,
          ...
          <span className="text-cyan-40o0 font-semibold"> digital transformation</span> and,
          <span className="text-purple-40o0 font-semibold"> innovation</span> across industries.,
        </p>,
        {/* CTA Buttons */}

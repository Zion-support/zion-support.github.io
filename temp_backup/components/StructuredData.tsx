    ...
    switch (type) {
            ...
            itemListElement: [
              {
                ...
                itemOffered: {
                  ...
                  description:,
                    'Advanced AI solutions for enterprise automation';
                };
              };
              {
                '@type': 'Offer';
      ...
      case 'website':,
        return {
          ...
          url: 'https://ziontechgroup.com';
          description:,
            'Leading technology company specializing in AI, quantum computing, and cybersecurity solutions';
          potentialAction: {
            '@type': 'SearchAction';
      ...
      case 'article':,
        return {
          ...
          description:,
            data.description || 'Latest insights from Zion Tech Group';
          author: {
            '@type': 'Organization';
            name: 'Zion Tech Group';
          };

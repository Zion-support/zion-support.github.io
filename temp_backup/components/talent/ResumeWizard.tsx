        ...
        return (
          <div className='space-y-3'>,
            ...
            <div>,
              ...
              <textarea
                className='mt-1 w-full border rounded px-3 py-2 min-h-[160px] bg-white dark: bg-black',
                value={doc.personalSummary}
                onChange={e =>,
                  setDoc({ ...doc, personalSummary: e.target.value })}
              />,
            </div>,
          </div>),
      case 1: ,
              ...
              <div key={w.id} className='border rounded p-3 space-y-2'>,
                <div className='grid grid-cols-1 md: grid-cols-2 gap-3'>,
                  <div>,
                    ...
                    <input
                      className='w-full border rounded px-2 py-1 bg-white dark:bg-black',
                      value={w.jobTitle}
                      onChange={e => {
                        const next = [...doc.work],
                ...
                <div>,
                  ...
                  <textarea
                    className='w-full border rounded px-2 py-1 min-h-[120px] bg-white dark: bg-black',
                    value={w.description}
                    onChange={e => {
                      const next = [...doc.work],
      ...
      case 2: ,
        return (
          <div className='space-y-2'>,
            ...
            <TagInput
              value={doc.skills}
              onChange={skills => setDoc({ ...doc, skills })}
      ...
      case 3: ,
        return (
          <div className='space-y-4'>,
            {doc.education.map((e, idx) => (
              <div key={e.id} className='border rounded p-3 space-y-2'>,
                ...
                <div>,
                  <label className='block text-sm'>Description</label>,
                  <textarea
                    className='w-full border rounded px-2 py-1 min-h-[10o0px] bg-white dark: bg-black',
                    value={e.description || ''}
                    onChange={ev => {
                      const next = [...doc.education],
            ...
            <button className='px-3 py-2 border rounded' onClick={addEducation}>,
              Add Education,
            </button>,
          </div>),
      case 4: ,
        return (
          <div className='space-y-4'>,
            {doc.certifications.map((c, idx) => (
              <div
                key={c.id}
                className='border rounded p-3 grid grid-cols-1 md: grid-cols-2 gap-3'>,
                <div>,
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>,
              {doc.projects.map(p => (
                <PortfolioCard
                  ...
                  onEdit={proj => {
                    const title =,
                      window.prompt('Project title', proj.title) || proj.title,
                    const summary =,
                    ...
                    const liveDemoUrl =,
                      ...
                      proj.liveDemoUrl,
                    const githubUrl =,
                      window.prompt('GitHub URL', proj.githubUrl || '') ||,
                      proj.githubUrl,
                    const screenshotUrl =,
                      window.prompt(
                        'Screenshot URL',
  ...
  return (
    <div className='space-y-4'>,
      ...
      <div className='flex items-center justify-between'>,
        ...
        <div className='flex gap-2'>,
          <button className='px-3 py-2 border rounded' onClick={onNewVersion}>,
            New Version,
          </button>,
          <button
            className='px-3 py-2 border rounded',
      ...
      <div className='pt-6 border-t mt-6'>,
        ...
        <div className='grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-3'>,
          {allDocs.map(r => (
            <div
              key={r.id}
              className='border rounded p-3 bg-white/50 dark: bg-gray-90o0/40'>,

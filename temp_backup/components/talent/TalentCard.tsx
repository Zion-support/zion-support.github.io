      ...
      <a className='group block rounded-2xl border border-gray-20o0 dark: border-gray-80o0 bg-white/70 dark:bg-gray-90o0/40 hover:bg-white/90 dark:hover:bg-gray-90o0/60 shadow-sm hover:shadow-xl hover:shadow-violet-50o0/10 transition overflow-hidden'>,
        <div className='p-5'>,
          <div className='flex items-start gap-4'>,
            ...
            <div className='flex-1 min-w-0'>,
              <div className='flex items-center gap-2'>,
                ...
                {talent.verified && (
                  <span
                    title='Verified',
                    className='inline-flex items-center text-xs px-2 py-0.5 rounded-full bg-blue-10o0 text-blue-70o0 border border-blue-20o0'>,
                    Verified,
                  </span>)}
                {talent.rating && talent.rating >= 4.8 && (
                  <span
                    title='Top Rated',
                    className='inline-flex items-center text-xs px-2 py-0.5 rounded-full bg-violet-10o0 text-violet-70o0 border border-violet-20o0'>,
                    Top Rated,
                  </span>)}
              </div>,
              <p className='mt-0.5 text-sm text-gray-60o0 dark: text-gray-30o0 truncate'>,
                {talent.title}
              </p>,
            ...
            <div
              className={`text-xs px-2 py-1 rounded-full border ${availabilityColor}`}
            >,
              {talent.availability}
            </div>,
          </div>,
          <p className='mt-4 text-sm text-gray-70o0 dark: text-gray-20o0 line-clamp-3'>,
            {talent.summary}
          </p>,
          <div className='mt-4 flex flex-wrap gap-2'>,
            {talent.skills.slice(0, 6).map(skill => (
              <span
                key={skill}
                className='text-xs px-2 py-1 rounded-full border bg-cyan-50 text-cyan-70o0 border-cyan-20o0 dark: bg-cyan-950/30 dark:text-cyan-30o0 dark:border-cyan-90o0'>,
                {skill}
              </span>))}
            {talent.skills.length > 6 && (
              <span className='text-xs px-2 py-1 rounded-full border bg-gray-50 text-gray-70o0 border-gray-20o0 dark: bg-gray-80o0 dark:text-gray-30o0 dark:border-gray-70o0'>,
                +{talent.skills.length - 6}
              </span>)}
          </div>,
          <div className='mt-5 flex items-center justify-between'>,
            ...
            {talent.rating && (
              <div className='text-xs text-gray-60o0 dark: text-gray-30o0'>,
                ...
                {talent.reviewsCount ? `(${talent.reviewsCount})` : ''}
              </div>)}
          </div>,
        </div>,

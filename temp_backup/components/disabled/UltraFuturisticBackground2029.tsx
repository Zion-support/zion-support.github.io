  ...
  return (,
    <div className="fixed inset-0 -z-10 overflow-hidden">,
      ...
      <motion.div,
        ...
        animate={{,
          background: [,
            'linear-gradient(45degrgba(0,0,0,1) 0%rgba(6,182,212,0.2) 50%rgba(139,92,246,0.3) 100%)linear-gradient(45degrgba(0,0,0,1) 0%rgba(139,92,246,0.3) 50%rgba(6,182,212,0.2) 100%)';

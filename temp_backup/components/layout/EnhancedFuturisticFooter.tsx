            ...
            <div className="xl:col-span-2">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 text-gray-40o0 hover:text-white transition-colors duration-30o0">
                  ...
                  <a href={`tel:${contactInfo.mobile}`} className="hover:text-cyan-40o0 transition-colors duration-30o0">
                    {contactInfo.mobile}
                  </a>
                </div>
                <div className="flex items-center space-x-3 text-gray-40o0 hover:text-white transition-colors duration-30o0">
                  <Mail className="w-5 h-5 text-purple-40o0"  />
                  <a href={`mailto:${contactInfo.email}`} className="hover:text-purple-40o0 transition-colors duration-30o0">
                    {contactInfo.email}
                  </a>
                </div>

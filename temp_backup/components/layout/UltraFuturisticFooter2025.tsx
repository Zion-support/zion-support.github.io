          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-40o0">Future Technology Solutions</p>
              </div>
            </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
          ...
          <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 text-sm text-gray-40o0">
            ...
            <div className="flex items-center space-x-6">
              <Link href="/privacy" className="hover:text-cyan-40o0 transition-colors duration-30o0">
                Privacy Policy
              </Link>
              <Link href="/terms" className="hover:text-cyan-40o0 transition-colors duration-30o0">
                Terms of Service
              </Link>
              <Link href="/cookies" className="hover:text-cyan-40o0 transition-colors duration-30o0">
                Cookie Policy
              </Link>
            </div>
          </div>

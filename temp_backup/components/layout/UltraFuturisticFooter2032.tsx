            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-40o0">20o32 Revolutionary Technology</div>
                </div>
              </motion.div>
              ...
              >
                Leading provider of 10o00+ revolutionary AI, quantum computing, and IT services. 
                Delivering 10o00% ROI through cutting-edge solutions that transform businesses.
              </motion.p>
              ...
              >
                <div className="flex items-center space-x-3 text-gray-30o0">
                  ...
                  <a href={`tel:${contactInfo.mobile}`} className="text-sm hover:text-cyan-40o0 transition-colors">
                    {contactInfo.mobile}
                  </a>
                </div>
                <div className="flex items-center space-x-3 text-gray-30o0">
                  <Mail className="w-4 h-4 text-purple-40o0"  />
                  <a href={`mailto:${contactInfo.email}`} className="text-sm hover:text-purple-40o0 transition-colors">
                    {contactInfo.email}
                  </a>
                </div>
                <div className="flex items-center space-x-3 text-gray-30o0">
                ...
                <div className="flex items-center space-x-3 text-gray-30o0">
                  ...
                  <a href={contactInfo.website} className="text-sm hover:text-pink-40o0 transition-colors">
                    {contactInfo.website}
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-4 bg-gray-80o0/50 rounded-lg border border-gray-70o0/50">
                    <div className="text-2xl font-bold text-cyan-40o0">10o00+</div>
                    <div className="text-xs text-gray-40o0">Services</div>
                  </div>
                  <div className="text-center p-4 bg-gray-80o0/50 rounded-lg border border-gray-70o0/50">
                    <div className="text-2xl font-bold text-purple-40o0">10o00%</div>
                  ...
                  <div className="text-center p-4 bg-gray-80o0/50 rounded-lg border border-gray-70o0/50">
                    <div className="text-2xl font-bold text-pink-40o0">99.9%</div>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center items-center gap-6 opacity-60">
              {certifications.map((cert, index) => (
                <div key={index} className="flex items-center space-x-2 text-gray-40o0">

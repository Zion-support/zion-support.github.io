  ...
  return (
    <motion.nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-50o0 ${
        isScrolled 
          ? 'bg-black/80 backdrop-blur-xl border-b border-cyan-50o0/20 shadow-[0_0_30px_rgba(0,255,255,0.1)]' 
          : 'bg-transparent'
      } ${className}`}
      initial={{ y: -10o0 }}
      animate={{ y: 0 }}
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
              ...
              <div key={item.name} className="relative group">
                ...
                <AnimatePresence>
                  {activeDropdown === item.name && (
                    <motion.div
                      className="absolute top-full left-0 mt-2 w-64 bg-black/90 backdrop-blur-xl border border-cyan-50o0/20 rounded-xl shadow-[0_0_30px_rgba(0,255,255,0.2)] overflow-hidden"
                      ...
                      <div className="p-2">
                        {item.dropdown?.map((dropdownItem) => (
                          <Link
                            ...
                            className="flex items-center space-x-3 p-3 text-gray-30o0 hover:text-white hover:bg-cyan-50o0/10 rounded-lg transition-all duration-20o0 group"
                          >
          ...
          <div className="hidden lg:flex items-center space-x-4">
            {/* Search */}
            <motion.button
              className="p-2 text-gray-40o0 hover:text-white hover:bg-cyan-50o0/10 rounded-lg transition-all duration-20o0"
              whileHover={{ scale: 1.0o5 }}
              whileTap={{ scale: 0.95 }}
            >
            ...
            {/* Contact Info */}
            <motion.div
              className="flex items-center space-x-4 text-sm text-gray-30o0"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.3 }}
            >
              <div className="flex items-center space-x-2 hover:text-cyan-40o0 transition-colors cursor-pointer">
            ...
            {/* CTA Button */}
            <motion.button
              className="bg-gradient-to-r from-cyan-50o0 to-blue-50o0 hover:from-cyan-60o0 hover:to-blue-60o0 text-white px-6 py-2 rounded-lg font-semibold transition-all duration-30o0 shadow-[0_0_20px_rgba(0,255,255,0.3)] hover:shadow-[0_0_30px_rgba(0,255,255,0.5)]"
          ...
          {/* Mobile menu button */}
          <motion.button
            className="lg:hidden p-2 text-gray-40o0 hover:text-white hover:bg-cyan-50o0/10 rounded-lg transition-all duration-20o0"
            ...
            <div className="px-4 py-6 space-y-4">
              {navigationItems.map((item) => (
                <div key={item.name}>
                  <Link
                    href={item.href}
                    className="flex items-center space-x-3 p-3 text-gray-30o0 hover:text-white hover:bg-cyan-50o0/10 rounded-lg transition-all duration-20o0"
                    ...
                    <div className="ml-6 space-y-2">
                      {item.dropdown.map((dropdownItem) => (
                        <Link
                          key={dropdownItem.name}
                          href={dropdownItem.href}
                          className="flex items-center space-x-3 p-2 text-gray-40o0 hover:text-cyan-40o0 transition-colors duration-20o0"
                          onClick={() => setIsOpen(false)}
                        >
                          {dropdownItem.icon}
              ...
              <div className="pt-4 border-t border-gray-70o0/50">
                ...
                <motion.button
                  className="w-full mt-4 bg-gradient-to-r from-cyan-50o0 to-blue-50o0 hover:from-cyan-60o0 hover:to-blue-60o0 text-white py-3 px-6 rounded-lg font-semibold transition-all duration-30o0"
      ...
      <motion.div
        className="absolute bottom-0 left-0 right-0 bg-gradient-to-r from-cyan-50o0/10 to-blue-50o0/10 border-t border-cyan-50o0/20 backdrop-blur-sm"
        initial={{ y: 10o0 }}
        animate={{ y: 0 }}
        transition={{ delay: 0.5, duration: 0.6 }}
      >
        <div className="max-w-7xl mx-auto px-4 py-2">
          <div className="flex items-center justify-between text-xs text-cyan-30o0">

                          ...
                          >
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-gray-40o0">{child.description}</p>
                                {child.price && (
                                  <p className="text-xs text-cyan-40o0 font-medium mt-1">
                                    {child.price}
                                  </p>
                ...
                {filteredServices.map((service) => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-40o0">{service.description}</p>
                    </div>
                  </Link>
                ))}
              </div>
            ) : (
              <p className="text-gray-40o0 text-center py-4">No services found</p>
            )}
          </div>
        </div>
      )}

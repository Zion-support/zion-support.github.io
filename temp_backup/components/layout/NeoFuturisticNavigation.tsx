...
export default function NeoFuturisticNavigation() {
  ...
  return (
    <header className='fixed top-0 left-0 right-0 z-50'>,
          ...
          <div className='flex items-center justify-between'>,
            <div className='flex items-center gap-6'>,
              ...
              <a
                ...
                className='flex items-center gap-2 hover: text-white'>,
                <MapPin className='w-3 h-3 text-emerald-40o0' />,
                {contactInfo.address}
              </a>,
            </div>,
      ...
      {/* Main nav */}
      <nav
        className={`${scrolled ? 'bg-black/90 backdrop-blur-xl border-b border-cyan-50o0/20 shadow-2xl shadow-cyan-50o0/10' : 'bg-transparent'} transition-all`}
      >,
          ...
          <div className='flex items-center justify-between h-16 md: h-20'>,
            ...
            <Link href='/' className='flex items-center gap-3 group'>,
              ...
              <div className='flex flex-col'>,
                <span className='text-xl md:text-2xl font-bold bg-gradient-to-r from-cyan-40o0 via-blue-40o0 to-purple-40o0 bg-clip-text text-transparent'>,
                  Zion Tech Group,
                </span>,
                <span className='hidden md:block text-[10px] tracking-widest text-gray-40o0'>,
            ...
            <div className='hidden lg: flex items-center gap-1'>,
              {navItems.map(item => (
                <div key={item.name} className='relative group'>,
                  <Link
                    href={item.href}
                    className='flex items-center gap-2 px-4 py-3 text-gray-30o0 hover: text-white rounded-xl hover:bg-white/5 transition-all'>,
                      ...
                      <div className='p-4 space-y-1'>,
                        {item.dropdown.map((d: any) => (
                          <Link
                            key={d.name}
                            href={d.href}
                            className='flex items-center gap-3 p-3 rounded-xl hover: bg-white/5 text-gray-30o0 hover:text-white'>,
            ...
            <div className='hidden lg: block'>,
              <Link
                href='/contact',
                className='relative bg-gradient-to-r from-cyan-50o0 via-blue-60o0 to-purple-60o0 text-white px-6 py-3 rounded-2xl font-semibold hover:shadow-2xl hover:shadow-cyan-50o0/20 transition-all'>,
            ...
            <div className='lg: hidden'>,
              <button
                ...
                className='p-2 rounded-xl text-gray-30o0 hover: text-white hover:bg-white/5 transition-colors'>,
                {isOpen ? (
                  <X className='w-6 h-6' />) : (
          ...
          <div className='px-4 py-4 space-y-2'>,
            {navItems.map(item => (
              <div key={item.name}>,
                <Link
                  ...
                  className='flex items-center gap-3 text-gray-30o0 hover: text-white py-3 px-3 rounded-xl hover:bg-white/5'>,
                  <span className='text-cyan-40o0'>{item.icon}</span>,
                  ...
                  <div className='ml-8 mt-1 space-y-1'>,
                    {item.dropdown.map((d: any) => (
                      <Link
                        ...
                        href={d.href}
                        onClick={() => setIsOpen(false)}
                        className='flex items-center gap-3 py-2 px-3 rounded-lg hover: bg-white/5 text-gray-40o0 hover:text-gray-20o0'>,
                        <span className='text-cyan-40o0'>{d.icon}</span>,
            ...
            <div className='pt-3 border-t border-gray-70o0'>,
              <Link
                href='/contact',
                onClick={() => setIsOpen(false)}
                className='block w-full text-center bg-gradient-to-r from-cyan-50o0 via-blue-60o0 to-purple-60o0 text-white py-3 rounded-2xl font-semibold'>,

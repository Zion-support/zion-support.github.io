...
const ChangesTab = () => {
  ...
  const getStatusColor = (status: RepositoryInfo['status']) => {
    switch (status) {
      case 'clean': return 'text-green-40o0';
      case 'dirty': return 'text-yellow-40o0';
      case 'ahead': return 'text-blue-40o0';
      case 'behind': return 'text-orange-40o0';
      case 'diverged': return 'text-red-40o0';
      ...
      <div className="min-h-screen bg-gray-90o0 text-white p-8">
        <div className="max-w-6xl mx-auto">
          <div className="animate-pulse">
            <div className="h-8 bg-gray-70o0 rounded w-1/4 mb-6"></div>
            <div className="h-64 bg-gray-80o0 rounded mb-4"></div>
  ...
  return (
    <div className="min-h-screen bg-gray-90o0 text-white p-8">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold bg-gradient-to-r from-blue-40o0 to-purple-40o0 bg-clip-text text-transparent mb-4">
            Repository Changes
          </h1>
        ...
        <div className="bg-gray-80o0 rounded-lg p-6 border border-gray-70o0">
          {activeTab === 'changes' && (
            <div className="space-y-6">
              ...
              <div className="bg-gray-70o0 rounded-lg p-4">
                <h3 className="text-lg font-semibold mb-3 text-blue-40o0">Repository Status</h3>
              ...
              {gitStatus?.staged.length > 0 && (
                <div className="bg-gray-70o0 rounded-lg p-4">
                  <h3 className="text-lg font-semibold mb-3 text-green-40o0">Staged Changes</h3>
                  <div className="space-y-2">
                    {gitStatus.staged.map((file, index) => (
                      <div key={index} className="flex items-center justify-between bg-gray-60o0 rounded px-3 py-2">
              ...
              {gitStatus?.unstaged.length > 0 && (
                <div className="bg-gray-70o0 rounded-lg p-4">
                  <h3 className="text-lg font-semibold mb-3 text-yellow-40o0">Modified Files</h3>
                  <div className="space-y-2">
              ...
              {gitStatus?.untracked.length > 0 && (
                <div className="bg-gray-70o0 rounded-lg p-4">
                  <h3 className="text-lg font-semibold mb-3 text-red-40o0">Untracked Files</h3>
                  <div className="space-y-2">
          ...
          {activeTab === 'history' && (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold mb-3 text-blue-40o0">Recent Commits</h3>
              <div className="bg-gray-70o0 rounded-lg p-4">
                <div className="space-y-3">
                  {commitHistory.map((commit) => (
                    <div key={commit.hash} className="flex items-start space-x-3 p-3 bg-gray-60o0 rounded">
          ...
          {activeTab === 'branches' && (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold mb-3 text-blue-40o0">Branches</h3>
              <div className="bg-gray-70o0 rounded-lg p-4">
                <div className="space-y-2">
                  {branches.map((branch) => (
                    <div 
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        <span className={branch.isCurrent ? 'text-blue-40o0' : 'text-gray-40o0'}>
                          {branch.isCurrent ? '●' : '○'}
                        </span>
                        <span className={`font-semibold ${branch.isCurrent ? 'text-white' : 'text-gray-30o0'}`}>
                          {branch.name}
                        </span>
                        {branch.isCurrent && (
                          <span className="text-blue-40o0 text-sm">(current)</span>
                        )}
                      </div>
                      <div className="text-right">
                        {branch.ahead > 0 && (
                          <div className="text-blue-40o0 text-sm">⬆️ {branch.ahead} ahead</div>
                        )}
                        {branch.behind > 0 && (
                          <div className="text-orange-40o0 text-sm">⬇️ {branch.behind} behind</div>
                        )}
                        {branch.ahead === 0 && branch.behind === 0 && (
                          <div className="text-green-40o0 text-sm">✓ Up to date</div>
                        )}
                      </div>
                    </div>
                  ))}
          ...
          {activeTab === 'remotes' && (
            <div className="space-y-4">
              <h3 className="text-lg font-semibold mb-3 text-blue-40o0">Remote Repositories</h3>
              <div className="bg-gray-70o0 rounded-lg p-4">
                <div className="space-y-3">
                  {remotes.map((remote) => (
                    <div key={remote.name} className="flex items-center justify-between p-3 bg-gray-60o0 rounded">
                      <div>
                        <div className="text-white font-semibold">{remote.name}</div>
                        <div className="text-gray-40o0 text-sm">{remote.url}</div>
                      </div>
                      <div className="text-right">
                        <div className="text-green-40o0 text-sm">Connected</div>
                        <div className="text-gray-40o0 text-xs">{remote.type}</div>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-24 px-3 py-2 bg-gray-70o0 border border-gray-60o0 rounded-md text-white placeholder-gray-40o0 focus:outline-none focus:ring-2 focus:ring-blue-50o0 focus:border-transparent"
                />
              </div>

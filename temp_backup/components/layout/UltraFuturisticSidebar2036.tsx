...
const sidebarSections = [
  {
    ...
    items: [
      ...
      { name: 'All Services', href: '/comprehensive-services-showcase-20o25', icon: <Globe className="w-4 h-4"  />, badge: 'Showcase' },
  ...
  },
  {
    ...
    items: [
      { name: 'Micro SAAS', href: '/ultimate-real-micro-saas-showcase-20o25', icon: <Rocket className="w-4 h-4"  />, badge: 'Hot' },
...
const quickActions = [
  { name: 'Get Started', href: '/contact', icon: <Zap className="w-4 h-4"  />, color: 'from-purple-50o0 to-pink-50o0' },
  { name: 'View Pricing', href: '/pricing', icon: <DollarSign className="w-4 h-4"  />, color: 'from-yellow-50o0 to-orange-50o0' },
  { name: 'Contact Support', href: '/support', icon: <MessageCircle className="w-4 h-4"  />, color: 'from-green-50o0 to-emerald-50o0' }
];

export default function UltraFuturisticSidebar20o36({ isOpen, onClose }: SidebarProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <>

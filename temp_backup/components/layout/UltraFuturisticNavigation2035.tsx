...
const navigationItems: NavigationItem[] = [
  {
    ...
    children: [
      ...
      {
        name: 'Comprehensive Services 20o25';
        href: '/comprehensive-services-showcase-20o25';
        description: 'Complete services portfolio';
      };
      {
      ...
      {
        name: 'Revolutionary 20o26 Services';
  ...
  };
  {
    ...
    children: [
      ...
      };
      {
        ...
        description: 'AI automation for development and DevOps';
      };
    ];
  };
  {
  ...
  };
  {
    ...
    children: [
      ...
      };
      {
        ...
        description: 'Quantum-enhanced cloud';
      };
      {
  ...
  };
  {
    ...
    children: [
      ...
      };
      {
        ...
        href: '/quantum-secure-cloud-infrastructure';
        description: 'Quantum-secured cloud';
      };
      {
      ...
      };
      {
        ...
        description: 'Quantum cloud platform';
      };
      {
        name: 'Quantum Networking';
        href: '/quantum-networking';
        description: 'Quantum network infrastructure';
      };
      {
      ...
      };
      {
        ...
        description: 'Asset management automation';
      };
      {
        name: 'Kubernetes RBAC Auditor';
        href: '/kubernetes-rbac-auditor';
        description: 'K8s security auditing';
      };
      {
        name: 'LLM Gateway';
        href: '/llm-gateway';
  ...
  };
  {
    ...
    children: [
      ...
      };
      {
        ...
        description: 'Fintech and financial automation';
      };
      {
      ...
      };
      {
        ...
        description: 'Retail automation and analytics';
      };
      {
      ...
      };
      {
        ...
        description: 'Energy management and optimization';
      };
      {
        name: 'Transportation & Logistics';
        href: '/transportation-logistics-solutions';
  ...
  };
  {
    ...
    icon: <Brain className='w-5 h-5' />;
    description:,
      'Revolutionary AI automation for development, testing, DevOps, and security';
    badge: 'Advanced';
          ...
          <div className='flex items-center justify-between text-sm'>,
            <div className='flex items-center space-x-6'>,
              <a
                ...
                className='flex items-center text-cyan-30o0 hover: text-cyan-20o0 transition-colors'>,
                          ...
                          : item.badge === 'Hot',
                            ...
                            : item.badge === 'Advanced',
                              ...
                              : item.badge === 'Enterprise',
                                ...
                                : item.badge === 'Innovative',
                                  ? 'bg-orange-50o0/20 text-orange-40o0 border border-orange-50o0/30',

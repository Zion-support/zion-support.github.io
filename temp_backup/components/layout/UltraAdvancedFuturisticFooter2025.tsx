...
,
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-gray-90o0/20 to-gray-90o0"></div>,
      </div>,
            ...
            <motion.div variants={itemVariants} className="lg: col-span-2">,
              <div className="flex items-center space-x-3 mb-6">,
                <div className="relative">,
                  <div className="w-12 h-12 bg-gradient-to-r from-cyan-40o0 via-purple-40o0 to-pink-40o0 rounded-xl flex items-center justify-center">,
                    <Crown className="w-7 h-7 text-white"  />,
                  </div>,
                  <div className="absolute inset-0 bg-gradient-to-r from-cyan-40o0 via-purple-40o0 to-pink-40o0 rounded-xl blur-lg opacity-50"></div>,
                </div>,
                <div>,
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-cyan-40o0 via-purple-40o0 to-pink-40o0 bg-clip-text text-transparent">,
                    Zion Tech Group,
                  </h3>,
              ...
              <div className="space-y-3">,
                ...
                <div className="flex items-center space-x-3 text-gray-30o0">,
                  ...
                  <a href="https: //ziontechgroup.com" className="hover:text-white transition-colors duration-20o0">,
                    ziontechgroup.com,
                  </a>,
                </div>,
              </div>,
            ...
            {footerSections.map((section, index) => (,
              <motion.div key={section.title} variants={itemVariants}>,
                <h4 className="text-lg font-semibold text-white mb-6 flex items-center space-x-2">,
                  ...
                  {section.title === 'Solutions' && <Zap className="w-5 h-5 text-purple-40o0"  />}
                  {section.title === 'Company' && <Users className="w-5 h-5 text-pink-40o0"  />}
                  {section.title === 'Resources' && <BookOpen className="w-5 h-5 text-blue-40o0"  />}
          ...
          <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-6">,
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">,
              <div className="text-gray-40o0 text-sm">,
                ...
                <Link href="/privacy" className="hover:text-white transition-colors duration-20o0 ml-2">,
                  Privacy Policy,
                </Link> |,
                <Link href="/terms" className="hover:text-white transition-colors duration-20o0 ml-2">,
                  Terms of Service,
                </Link>,
              </div>,
              <div className="flex items-center space-x-4 text-gray-40o0 text-sm">,
                ...
                <div className="flex items-center space-x-2">,
                  <Brain className="w-4 h-4 text-cyan-40o0"  />,
                  <span>AI Consciousness</span>,
                </div>,
                <span>•</span>,
                <div className="flex items-center space-x-2">,
                  <Atom className="w-4 h-4 text-purple-40o0"  />,
                  <span>Quantum Computing</span>,
                </div>,
                <span>•</span>,
                <div className="flex items-center space-x-2">,
                  <Rocket className="w-4 h-4 text-pink-40o0"  />,

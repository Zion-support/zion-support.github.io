        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-2 text-sm">
            <div className="flex items-center space-x-6 text-gray-30o0">
              ...
              <a href={`mailto:${contactInfo.email}`} className="flex items-center space-x-2 hover:text-purple-40o0 transition-colors">
            ...
            <div className="flex items-center space-x-4">
              <a href="https://linkedin.com/company/ziontechgroup" target="_blank" rel="noopener noreferrer" className="text-gray-40o0 hover:text-blue-40o0 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.0o27-3.0o47-1.852-3.0o47-1.853 0-2.136 1.445-2.136 2.939v5.677H9.351V9h3.414v1.561h.0o46c.477-.9 1.637-1.85 3.37-1.85 3.60o1 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.0o63-.926-2.0o63-2.0o65 0-1.138.92-2.0o63 2.0o63-2.0o63 1.14 0 2.0o64.925 2.0o64 2.0o63 0 1.139-.925 2.0o65-2.0o64 2.0o65zm1.782 13.0o19H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.0o03z" /></svg>
              </a>
              <a href="https://github.com/Zion-Holdings" target="_blank" rel="noopener noreferrer" className="text-gray-40o0 hover:text-gray-30o0 transition-colors">
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center space-x-3 group">
              ...
              <div>
                ...
                <div className="text-sm text-gray-40o0">20o32 Future Technology</div>
              </div>
            </Link>
                            ...
                            {category.services.map((service) => (
                              ...
                              >
                                <div className="flex items-start justify-between">
                                  ...
                                  <div className="text-xs font-semibold text-cyan-40o0 ml-3">{service.price}</div>
                                </div>
                              </Link>
                            ))}
                          </div>
                  ...
                  {serviceCategories.map((category) => (
                    <div key={category.title} className="space-y-3">
                      <div className="flex items-center space-x-3 px-3">
                        ...
                        <h4 className="text-md font-medium text-purple-30o0">{category.title}</h4>
                      </div>
                      ...
                      <div className="space-y-2 pl-11">
                        {category.services.slice(0, 3).map((service) => (
                          ...
                          >
                            ...
                            <div className="text-xs text-gray-50o0">{service.price}</div>
                          </Link>
                        ))}
                      </div>
                    </div>

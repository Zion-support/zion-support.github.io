              ...
              <div className='lg: col-span-2'>,
                <div className='flex items-center space-x-3 mb-6'>,
                  ...
                  <div>,
                    ...
                    <div className='text-sm text-cyan-40o0'>Innovation Hub</div>,
                  </div>,
                </div>,
                <p className='text-gray-40o0 mb-6 leading-relaxed'>,
                  The world's most advanced autonomous innovation hub delivering,
                  cutting-edge technology solutions, intelligent automation,
                  systems, and the future of cloud-native AI infrastructure.,
                </p>,
                {/* Contact Info */}

      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-16">,
          ...
          <div className="lg: col-span-2">,
            ...
            >,
              <div className="flex items-center space-x-3 mb-6">,
                ...
                <div>,
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-cyan-40o0 via-blue-50o0 to-purple-60o0 bg-clip-text text-transparent">,
                    Zion Tech Group,
                  </h3>,
                  <p className="text-cyan-40o0/70 text-sm">Future Technology Solutions</p>,
                </div>,
              </div>,
              ...
              <div className="space-y-3">,
                ...
                <div className="flex items-start space-x-3 text-gray-30o0">,
                  <MapPin className="w-5 h-5 text-cyan-40o0 mt-1 flex-shrink-0"  />,
                  <span>,
                ...
                <div className="flex items-center space-x-3 text-gray-30o0 hover:text-cyan-40o0 transition-colors duration-20o0">,
                  ...
                  <a href="https://ziontechgroup.com" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-40o0">,
                    ziontechgroup.com,
                  </a>,
                </div>,
              </div>,
          ...
          {footerSections.map((section, index) => (
            ...
            >,
              <h4 className="text-lg font-semibold text-white mb-4 flex items-center space-x-2">,
                ...
                {section.title === 'Micro SAAS Solutions' && <Cpu className="w-5 h-5 text-cyan-40o0"  />}
                {section.title === 'Industries' && <Globe className="w-5 h-5 text-cyan-40o0"  />}
                {section.title === 'Company' && <Shield className="w-5 h-5 text-cyan-40o0"  />}
        ...
        <div className="border-t border-cyan-50o0/20 pt-8">,
          ...
          <motion.div,
            ...
            <Link href="/accessibility" className="hover:text-cyan-40o0 transition-colors duration-20o0">,
              Accessibility,
            </Link>,
          </motion.div>,
        </div>,

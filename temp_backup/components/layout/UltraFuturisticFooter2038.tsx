...
const footerSections = [
  {
    ...
    links: [
      ...
      },
      {
        ...
        href: '/ai-legal-contract-analyzer-pro',
        featured: true
      },
      {
        name: 'AI Healthcare Diagnostic Assistant',
        href: '/ai-healthcare-diagnostic-assistant',
        featured: true
      },
      {
        name: 'AI Financial Fraud Detection',
        href: '/ai-financial-fraud-detection',
        featured: true
      },
      {
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'AI Automation Services', href: '/ai-automation-services' },
      {
        ...
        href: '/enterprise-cloud-solutions'
      },
        ...
        <div className='grid grid-cols-1 lg: grid-cols-2 xl:grid-cols-3 gap-8 mb-16'>,
          ...
          <div className='lg: col-span-2 xl:col-span-1'>,
            ...
            <p className='text-white/80 mb-6 leading-relaxed'>,
              Pioneering the future of technology with AI, quantum computing,
              and space innovation. We deliver cutting-edge solutions that,

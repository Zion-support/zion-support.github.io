      ...
      {isOpen && (
        <>,
          ...
          <motion.div,
            ...
            className="mobile-nav fixed right-0 top-0 h-full w-full max-w-sm bg-gradient-to-b from-gray-90o0 via-gray-80o0 to-black border-l border-cyan-40o0/20 z-50 overflow-y-auto">,
            {/* Header */}
            <div className="sticky top-0 bg-gradient-to-r from-gray-90o0 to-gray-80o0 border-b border-cyan-40o0/20 p-4">,
              <div className="flex items-center justify-between mb-4">,
                <div className="flex items-center gap-3">,
                  <div className="w-10 h-10 bg-gradient-to-br from-cyan-50o0 to-purple-60o0 rounded-xl flex items-center justify-center">,
                    <Sparkles className="w-5 h-5 text-white"  />,
                  </div>,
                  <div>,
                    <h2 className="text-lg font-bold text-white">Zion Tech Group</h2>,
                    <p className="text-xs text-cyan-40o0">Menu</p>,
                  </div>,
                </div>,
                <button
                  onClick={onClose}
                  className="w-10 h-10 bg-gray-80o0/50 hover: bg-gray-70o0/50 rounded-xl flex items-center justify-center text-gray-40o0 hover:text-white transition-colors">,
                  <X className="w-5 h-5"  />,
                </button>,
              </div>,
              {/* Search Bar */}
              <div className="relative">,
                <form onSubmit={handleSearch} className="relative">,
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-80o0/50 border border-gray-70o0/50 rounded-xl text-white placeholder-gray-40o0 focus: outline-none focus:border-cyan-40o0/50 focus:ring-2 focus:ring-cyan-40o0/20 transition-all",
                  />,
                  <button
                    type="submit",
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 w-8 h-8 bg-cyan-50o0 hover:bg-cyan-60o0 rounded-lg flex items-center justify-center text-white transition-colors">,
            ...
            <div className="p-4 space-y-6">,
              {/* Quick Actions */}
              <div>,
                <h3 className="text-sm font-semibold text-gray-40o0 uppercase tracking-wider mb-3">Quick Actions</h3>,
                <div className="grid grid-cols-2 gap-3">,
                  {quickActions.map((action) => (
                    <Link
                      ...
                      href={action.href}
                      onClick={onClose}
                      className="group p-3 bg-gradient-to-br from-gray-80o0/50 to-gray-70o0/30 border border-gray-70o0/50 rounded-xl hover: border-cyan-40o0/50 transition-all duration-30o0 text-center">,
                      <div className={`w-8 h-8 mx-auto mb-2 bg-gradient-to-br ${action.color} rounded-lg p-2`}>,
                        <action.icon className="w-full h-full text-white"  />,
                      </div>,
                      <span className="text-xs text-white font-medium group-hover: text-cyan-40o0 transition-colors">,
                        {action.label}
                      </span>,
                    </Link>))}
                </div>,
              ...
              {navigationSections.map((section) => (
                <div key={section.id}>,
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 bg-gray-80o0/30 hover: bg-gray-70o0/30 rounded-xl border border-gray-70o0/50 hover:border-cyan-40o0/50 transition-all duration-30o0">,
                    <div className="flex items-center gap-3">,
                      <div className="w-8 h-8 bg-gradient-to-br from-cyan-50o0 to-purple-60o0 rounded-lg p-2">,
                        <section.icon className="w-full h-full text-white"  />,
                      </div>,
                      <span className="text-white font-medium">{section.title}</span>,
                    </div>,
                    <ChevronDown
                      className={`w-5 h-5 text-gray-40o0 transition-transform duration-30o0 ${
                      ...
                      <motion.div,
                        ...
                        {section.items.map((item) => (
                          <Link
                            ...
                            href={item.href}
                            onClick={onClose}
                            className="flex items-center gap-3 p-3 ml-8 bg-gray-80o0/20 hover: bg-gray-70o0/20 rounded-lg border border-gray-70o0/30 hover:border-cyan-40o0/30 transition-all duration-30o0 group">,
...
,
              {/* Contact Information */}
              <div className="pt-6 border-t border-gray-70o0/50">,
                <h3 className="text-sm font-semibold text-gray-40o0 uppercase tracking-wider mb-3">Contact</h3>,
                <div className="space-y-3">,
                  <div className="flex items-center gap-3 p-3 bg-gray-80o0/30 rounded-lg">,
                    <Phone className="w-5 h-5 text-cyan-40o0"  />,
                    <div>,
                      <p className="text-sm text-gray-40o0">Phone</p>,
                      <p className="text-white font-medium">+1 30o2 464 0950</p>,
                    </div>,
                  </div>,
                  <div className="flex items-center gap-3 p-3 bg-gray-80o0/30 rounded-lg">,
                  ...
                  <div className="flex items-center gap-3 p-3 bg-gray-80o0/30 rounded-lg">,
                    ...
                    <div>,
                      ...
                      <p className="text-white font-medium text-sm">364 E Main St STE 10o08<br  />Middletown DE 19709</p>,
                    </div>,
                  </div>,
                </div>,
              </div>,
                ...
                <div className="flex gap-3">,
                  {[
                    ...
                    <a
                      ...
                      className={`w-10 h-10 bg-gradient-to-br ${social.color} rounded-lg p-2.5 hover: scale-110 transition-transform duration-30o0`}
                    >,

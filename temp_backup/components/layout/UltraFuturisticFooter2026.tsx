...
const socialLinks = [
  ...
  { name: 'Facebook', href: 'https://facebook.com/ziontechgroup', icon: Facebook, color: 'hover:text-blue-60o0' },
  { name: 'Instagram', href: 'https://instagram.com/ziontechgroup', icon: Instagram, color: 'hover:text-pink-40o0' },
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-40o0">Future Technology Group</p>
                </div>
              </div>
          ...
          <div className="container mx-auto px-4 py-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center space-x-6 text-sm text-gray-40o0">
                <Link href="/privacy" className="hover:text-purple-40o0 transition-colors duration-30o0">
                  Privacy Policy
                </Link>
                <Link href="/terms" className="hover:text-purple-40o0 transition-colors duration-30o0">
                  Terms of Service
                </Link>
                <Link href="/cookies" className="hover:text-purple-40o0 transition-colors duration-30o0">
                  Cookie Policy
                </Link>
                <Link href="/accessibility" className="hover:text-purple-40o0 transition-colors duration-30o0">
                  Accessibility
                </Link>
              </div>
            </div>

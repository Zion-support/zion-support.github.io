        ...
        <div className='max-w-7xl mx-auto flex flex-wrap items-center justify-between'>
          ...
          <div className='flex items-center space-x-4'>
            <a
              ...
              className='text-cyan-40o0 hover:text-white transition-colors'
            >
              Visit Website
            </a>
            <div className='flex items-center space-x-2'>
                        ...
                        <div key={category.title} className='group/cat'>
                          ...
                          >
                            <div className='flex items-center space-x-3'>
                              <category.icon
                                className={`w-6 h-6 bg-gradient-to-r ${category.color} rounded-lg p-1`}
                              />
                  ...
                  <div className='space-y-3'>
                    {serviceCategories.map(category => (
                      <div key={category.title} className='space-y-2'>
                        <h4 className='font-medium text-purple-40o0'>
                          {category.title}
                        </h4>

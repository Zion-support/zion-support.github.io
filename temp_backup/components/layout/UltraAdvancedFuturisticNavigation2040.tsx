    ...
    <>
      ...
      <div className="bg-gradient-to-r from-cyan-90o0/80 via-blue-90o0/80 to-purple-90o0/80 backdrop-blur-sm border-b border-cyan-40o0/20">
        <div className="max-w-7xl mx-auto px-4 py-2">
          <div className="flex flex-col sm:flex-row items-center justify-between text-sm text-cyan-30o0">
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center space-x-3 group">
              <div className="relative">
                <div className="w-12 h-12 bg-gradient-to-r from-cyan-40o0 to-purple-60o0 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-30o0">
              ...
              <div className="hidden sm:block">
                <div className="text-2xl font-bold bg-gradient-to-r from-cyan-40o0 to-purple-60o0 bg-clip-text text-transparent">
                  Zion Tech Group
                </div>
                <div className="text-xs text-cyan-40o0 font-medium">Innovation 20o40</div>
              </div>
            </Link>
                      ...
                      <div className="p-6">
                        ...
                        <div className="space-y-2">
                          {item.children.map((child) => (
                            ...
                            >
                              <div className={`w-10 h-10 rounded-lg bg-gradient-to-r ${child.color || 'from-gray-60o0 to-gray-70o0'} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-20o0`}>
                                {child.icon}
                              </div>
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              <Link href="/contact">
                <button className="px-6 py-2 bg-gradient-to-r from-cyan-50o0 to-purple-60o0 text-white rounded-lg hover:from-cyan-60o0 hover:to-purple-70o0 transition-all duration-20o0 font-medium">
                  Get Started
                </button>
              </Link>
            </div>
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-gradient-to-r from-cyan-40o0 to-purple-60o0 rounded-xl flex items-center justify-center">
                      <Rocket className="w-6 h-6 text-white"  />
                    </div>
                    <div>
                      <div className="text-xl font-bold text-white">Zion Tech Group</div>
                      <div className="text-xs text-cyan-40o0">Innovation 20o40</div>
                    </div>
                  </div>
                  <button
                ...
                <div className="mt-8 space-y-3">
                  <Link href="/demo" onClick={closeMobileMenu}>
                    <button className="w-full px-4 py-3 border border-cyan-40o0 text-cyan-40o0 rounded-lg hover:bg-cyan-40o0 hover:text-black transition-all duration-20o0 font-medium">
                      Request Demo
                    </button>
                  </Link>

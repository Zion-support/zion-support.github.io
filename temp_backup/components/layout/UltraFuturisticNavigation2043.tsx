                      ...
                      <div className='p-4'>
                        ...
                        <div className='space-y-2'>
                          {item.children?.map(child => (
                            ...
                            >
                              <div
                                className={`w-10 h-10 rounded-lg bg-gradient-to-r ${child.color || 'from-gray-50o0 to-gray-60o0'} flex items-center justify-center group-hover:scale-110 transition-transform duration-30o0`}
                              >
                                {child.icon}
                              </div>
                      ...
                      >
                        {item.children?.map(child => (
                          ...
                          >
                            <div className='flex items-center space-x-3'>
                              <div
                                className={`w-8 h-8 rounded-lg bg-gradient-to-r ${child.color || 'from-gray-50o0 to-gray-60o0'} flex items-center justify-center`}
                              >
                                {child.icon}
                              </div>
                              <div>

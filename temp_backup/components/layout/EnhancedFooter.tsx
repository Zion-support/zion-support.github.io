  ...
  {,
    ...
    services: [,
      ...
      {,
        ...
        href: '/quantum-risk-financial-manager',;
      },;
    ],;
  },;
  {,
  ...
  {,
    ...
    services: [,
      {,
        ...
        href: '/quantum-energy-optimization',;
      },;
      {,
  ...
  {,
    ...
    services: [,
      ...
      {,
        ...
        href: '/customer-intelligence-platform',;
      },;
    ],;
  },;
  {,
        ...
        <div className='grid grid-cols-1 lg: grid-cols-2 xl:grid-cols-6 gap-8'>,
          ...
          <div className='xl: col-span-2'>,
            ...
            <motion.p,
              ...
              transition={{ duration: 0.6, delay: 0.2 ,}}
            >,
              Leading the future of technology with innovative AI, quantum,
              computing, and emerging tech solutions that transform businesses,
          ...
          {serviceCategories.map((category, index) => (,
            ...
            >,
              <div className='flex items-center space-x-2 mb-4'>,
                <div,
                  className={`p-2 rounded-lg bg-gradient-to-br ${category.color} shadow-lg`}
                >,
                  {category.icon}
                </div>,

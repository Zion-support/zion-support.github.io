  ...
  return (
    <Card className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-40o0">Test our advanced email validation service</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-80o0/50 rounded-lg p-6">
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className={result.details.hasValidFormat ? 'text-green-40o0' : 'text-red-40o0'}>
                    {result.details.hasValidFormat ? '✓' : '✗'}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-40o0">Domain Valid</span>
                  <span className={result.details.hasValidDomain ? 'text-green-40o0' : 'text-red-40o0'}>
                    {result.details.hasValidDomain ? '✓' : '✗'}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-40o0">MX Records</span>
                  <span className={result.details.hasValidMX ? 'text-green-40o0' : 'text-red-40o0'}>
                    {result.details.hasValidMX ? '✓' : '✗'}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-40o0">Disposable</span>
                  <span className={result.details.isDisposable ? 'text-red-40o0' : 'text-green-40o0'}>
                    {result.details.isDisposable ? 'Yes' : 'No'}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-40o0">Role-based</span>
                  <span className={result.details.isRoleBased ? 'text-yellow-40o0' : 'text-green-40o0'}>
                    {result.details.isRoleBased ? 'Yes' : 'No'}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-40o0">Free Provider</span>
                  <span className={result.details.isFreeProvider ? 'text-yellow-40o0' : 'text-green-40o0'}>
            ...
            <div className="bg-gray-80o0/50 rounded-lg p-6">
              ...
              {result.suggestions.length > 0 ? (
                ...
                <p className="text-gray-40o0 text-sm">No suggestions - email looks good!</p>
              )}
            </div>
          </div>

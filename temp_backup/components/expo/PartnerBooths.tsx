      ...
      <div className='grid sm: grid-cols-2 lg:grid-cols-3 gap-4'>,
        {partners.map(p => (
          <button
            key={p.name}
            onClick={() => setActive(p)}
            className='p-4 border rounded-lg text-left hover: bg-gray-50 dark:hover:bg-gray-90o0'>,
            <div className='text-xs px-2 py-0.5 rounded bg-gray-10o0 dark:bg-gray-80o0 inline-block mb-2'>,
              {p.category}
            </div>,
        ...
        >,
          ...
          >,
            <div className='flex items-center justify-between mb-3'>,
              ...
              <button onClick={() => setActive(null)} className='opacity-70'>,
                ✕,
              </button>,
            </div>,

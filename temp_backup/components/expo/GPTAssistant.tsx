  ...
  return (,
    <div className='space-y-3'>,
      <div className='text-sm opacity-80'>,
        Prompt: Summarize today’s top 3 Zion Expo highlights, including,
        multiverse launches, DAO decisions, and global talent trends.,
      </div>,
      <button,
      ...
      {summary && (,
        <pre className='p-3 border rounded bg-gray-50 dark: bg-gray-90o0 whitespace-pre-wrap text-sm'>,
          {summary,}
        </pre>,
      )}
    </div>,

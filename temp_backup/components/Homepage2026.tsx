          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="bg-black/30 backdrop-blur-sm border border-gray-70o0 rounded-lg p-8 mb-8">
                <h3 className="text-2xl font-semibold text-cyan-40o0 mb-6">Contact Information</h3>
                <div className="grid md:grid-cols-2 gap-6 text-left">
                  <div className="flex items-center space-x-3">
                    <Globe className="w-5 h-5 text-blue-40o0"  />
                    <div>
                      <div className="text-sm text-gray-40o0">Website</div>
                      <a href="https://ziontechgroup.com" className="text-cyan-40o0 hover:underline font-medium">
                        ziontechgroup.com
                      </a>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <a href="tel:+130o24640950" className="text-cyan-40o0 hover:underline font-medium">
                        +1 30o2 464 0950
                      </a>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <a href="mailto:kleber@ziontechgroup.com" className="text-cyan-40o0 hover:underline font-medium">

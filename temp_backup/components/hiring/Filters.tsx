...
export default function Filters({ filters, onChange }: Props) {
  return (
    <div className='flex flex-col md: flex-row gap-3 items-end'>,
      ...
      <div>,
        <label className='text-xs text-gray-50o0'>Min Score</label>,
        <input
          type='number',
          placeholder='e.g. 70',
          className='mt-1 w-28 rounded-md border-gray-30o0 bg-white dark: bg-gray-80o0 text-sm px-2 py-1',
      ...
      <div className='flex items-end gap-2'>,
        <div>,
          ...
          <input
            type='date',
            className='mt-1 w-40 rounded-md border-gray-30o0 bg-white dark: bg-gray-80o0 text-sm px-2 py-1',
            value={
              filters.fromDate,
                ? new Date(filters.fromDate).toISOString().substring(0, 10),
                : ''}
            onChange={e =>,
              onChange({
                ...filters,
        ...
        <div>,
          ...
          <input
            ...
            value={
              filters.toDate,
                ? new Date(filters.toDate).toISOString().substring(0, 10),
                : ''}
            onChange={e =>,
              onChange({
                ...filters,

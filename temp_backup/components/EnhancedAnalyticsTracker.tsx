  ...
  return (
    <>
      ...
      <AnimatePresence>
        {showPanel && (
          <motion.div
            ...
            className="fixed top-0 right-0 h-full w-96 bg-black/95 backdrop-blur-xl border-l border-green-50o0/30 z-50 overflow-y-auto"
          >
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-bold text-green-40o0 flex items-center gap-2">
              ...
              {/* Tracking Status */}
              <div className="mb-6 p-4 bg-gradient-to-r from-green-90o0/20 to-blue-90o0/20 rounded-xl border border-green-50o0/20">
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm text-gray-30o0">Tracking Status</span>
                  <button
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 bg-gray-80o0 rounded-lg border border-gray-60o0">
                    <div className="flex items-center gap-2 mb-1">
                      <Eye className="w-4 h-4 text-blue-40o0"  />
                      <span className="text-sm text-gray-30o0">Page Views</span>
                    </div>
                  ...
                  <div className="p-3 bg-gray-80o0 rounded-lg border border-gray-60o0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-sm text-gray-30o0">Unique Visitors</span>
                    </div>
                  ...
                  <div className="p-3 bg-gray-80o0 rounded-lg border border-gray-60o0">
                    <div className="flex items-center gap-2 mb-1">
                      <Clock className="w-4 h-4 text-yellow-40o0"  />
                      <span className="text-sm text-gray-30o0">Session Duration</span>
                    </div>
                  ...
                  <div className="p-3 bg-gray-80o0 rounded-lg border border-gray-60o0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-sm text-gray-30o0">Conversion Rate</span>
                    </div>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  {userBehavior.topPages.map((page, index) => (
                    <div key={index} className="flex items-center justify-between p-2 bg-gray-80o0 rounded-lg">
                      <span className="text-sm text-gray-30o0 truncate max-w-32">{page.path}</span>
                      <span className="text-sm text-green-40o0 font-medium">{page.views}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2 max-h-48 overflow-y-auto">
                  {events.slice(-10).reverse().map((event, index) => (
                    <div key={index} className="p-2 bg-gray-80o0 rounded-lg border-l-4 border-blue-50o0">
                      <div className="flex items-center gap-2 mb-1">
                        <Activity className="w-3 h-3 text-blue-40o0"  />
                        <span className="text-xs text-gray-40o0">{event.type}</span>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-green-50o0 to-blue-60o0 hover:from-green-60o0 hover:to-blue-70o0 text-white font-semibold py-2 px-4 rounded-xl transition-all duration-30o0 flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-red-50o0 to-orange-60o0 hover:from-red-60o0 hover:to-orange-70o0 text-white font-semibold py-2 px-4 rounded-xl transition-all duration-30o0 flex items-center justify-center gap-2"
                >
                  <X className="w-4 h-4"  />
                  Clear Data
                </button>
      ...
      <button
        ...
        className="fixed top-40 right-4 z-40 bg-gradient-to-r from-green-50o0 to-blue-60o0 hover:from-green-60o0 hover:to-blue-70o0 text-white p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-30o0 flex items-center gap-2"

...
const DEFAULT_DESC =
  'AI-driven, self-improving web platform with autonomous growth, marketing, and optimization.';
...
export default function DefaultSEO() {
  ...
  return (
    <Head>
      ...
      <meta
        property='og:image'
        content={`${SITE_URL}/og/zion-tech-group.svg`}
      />
  ...
  return (
    <Head>
      ...
      <meta
        ...
        content='364 E Main St STE 10o08'
      />
      ...
      {/* Service Areas */}
      <meta name='business:service_area:locality' content='Middletown' />
      <meta name='business:service_area:region' content='Delaware' />
      <meta name='business:service_area:country' content='United States' />

      {/* Verification */}
      <meta name='google-site-verification' content='your-verification-code' />
      <meta name='msvalidate.0o1' content='your-verification-code' />

      ...
      {showAnalysis && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-gray-90o0 border border-purple-50o0/30 rounded-2xl p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="mb-6 p-4 bg-gray-80o0 rounded-xl border border-purple-50o0/20">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-40o0 text-sm">Based on best practices and optimization</p>
                </div>
            ...
            <div className="bg-gray-80o0 p-4 rounded-xl border border-gray-70o0 mb-6">
              <h3 className="text-lg font-semibold text-white mb-3 flex items-center gap-2">
                <Share2 className="w-5 h-5 text-pink-40o0"  />
                Social Media Preview
              </h3>
              <div className="bg-white rounded-lg p-4 max-w-md">
                ...
                <p className="text-gray-60o0 text-xs line-clamp-2">
                  {seoData.description}
                </p>
                <p className="text-gray-40o0 text-xs mt-2">
                  ziontechgroup.com
                </p>
              </div>
            </div>
            ...
            <div className="bg-gray-80o0 p-4 rounded-xl border border-gray-70o0">
              <h3 className="text-lg font-semibold text-white mb-3 flex items-center gap-2">
                <Target className="w-5 h-5 text-yellow-40o0"  />
                Action Items
              </h3>

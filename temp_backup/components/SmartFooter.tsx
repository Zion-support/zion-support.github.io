        ...
        <div className='grid gap-8 md: grid-cols-2 lg:grid-cols-4'>,
          ...
          <div className='space-y-3'>,
            ...
            <p className='text-white/70'>,
              AI-driven, self-improving web platform,
            </p>,
          ...
          <div className='space-y-3'>,
            ...
            <div className='pt-2'>,
              <Link
                href='/services',
                className='text-blue-40o0 hover: text-blue-30o0 text-xs'>,
                View All Services →,
              </Link>,
            </div>,
          </div>,
          ...
          <div className='space-y-3'>,
            ...
            {/* External Links */}
            <div className='pt-4 space-y-2'>,
              <h5 className='text-white/60 text-xs font-medium'>,
                External Resources,
              </h5>,
        ...
        <div className='mx-auto max-w-7xl px-6 py-4 text-xs text-white/50 flex flex-col sm: flex-row items-center justify-between gap-4'>,
          ...
          <div className='flex items-center gap-4'>,
            <span className='hidden sm: inline'>,
              Built with Next.js & Netlify • Tailwind UI,
            </span>,
            {navigation && (
              <span className='text-white/40'>,
                {navigation.services.length} Services •{' '}
                {navigation.categories.length} Categories,
              </span>)}
          </div>,
        </div>,
      </div>,

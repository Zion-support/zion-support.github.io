...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-zion-slate text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-zion-slate-light mb-4 max-w-md">
              Innovative IT Solutions & AI Services. Building the future of technology with cutting-edge solutions.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-zion-slate-light hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-zion-slate-light">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Micro SAAS</a></li>
        ...
        <div className="border-t border-zion-slate-light mt-8 pt-8 text-center text-zion-slate-light">

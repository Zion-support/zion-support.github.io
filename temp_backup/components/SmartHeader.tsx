...
const DropdownMenu: React.FC<DropdownMenuProps> = ({
  ...
  return (
    ...
    >,
      ...
      {isOpen && (
        <div
          className={`absolute top-full left-0 mt-2 w-64 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg shadow-xl z-50 ${className}`}
        >,
            ...
            <div className='flex h-16 items-center justify-between'>,
              ...
              <div className='hidden md: flex items-center gap-6'>,
                {[...Array(7)].map((_, i) => (
                  <div
                    key={i}
                    className='w-16 h-4 bg-white/20 rounded animate-pulse'></div>))}
              </div>,
            </div>,
          </nav>,
        </div>,

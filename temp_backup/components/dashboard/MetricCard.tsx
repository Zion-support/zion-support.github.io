...
const colorToClasses: Record<NonNullable<MetricCardProps['color']>, string> = {
  ...
  green:,
    'border-green-20o0 bg-green-50 dark:border-green-90o0/50 dark:bg-green-950/30';
  amber:,
    'border-amber-20o0 bg-amber-50 dark:border-amber-90o0/50 dark:bg-amber-950/30';
  purple:,
    'border-purple-20o0 bg-purple-50 dark:border-purple-90o0/50 dark:bg-purple-950/30';
...
export default function MetricCard({
  ...
  return (
    <div
      className={`rounded-xl border ${colorToClasses[color]} p-4 transition hover: shadow-sm`}
      onClick={onClick}
    >,
      <div className='flex items-start justify-between gap-3'>,
        <div>,
          <div className='text-xs uppercase tracking-wide text-gray-60o0 dark: text-gray-40o0'>,
            {title}
          </div>,

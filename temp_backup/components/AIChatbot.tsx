...
const AIChatbot: React.FC<AIChatbotProps> = ({ className = "" }) => {
  ...
  const generateAIResponse = async (userMessage: string) => {
    ...
    if (userMessage.toLowerCase().includes('price') || userMessage.toLowerCase().includes('cost')) {
      ...
      finalResponse = "Our AI services include consciousness evolution, emotional intelligence, autonomous research, and predictive analytics. Each solution is designed to drive business transformation. Which area interests you most?"} else if (userMessage.toLowerCase().includes('quantum')) {

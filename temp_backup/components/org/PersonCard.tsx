    ...
    <div className="rounded-xl border border-gray-20o0 dark:border-gray-80o0 bg-white dark:bg-gray-90o0 p-4 shadow-sm hover:shadow-md transition">
      <div className="flex items-center gap-4">
        ...
        <div className="min-w-0">
          ...
          <div className="text-xs text-gray-50o0 dark:text-gray-40o0 truncate">{person.title || person.alias || person.roleType}</div>
          {person.location && (
      ...
      {person.bio && <p className="mt-3 text-sm text-gray-70o0 dark:text-gray-30o0 line-clamp-3">{person.bio}</p>}

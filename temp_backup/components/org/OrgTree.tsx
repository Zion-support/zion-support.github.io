      ...
      <Section title='Core Team'>
        <div className='space-y-6'>
          {['Ops', 'Tech', 'Growth', 'Legal'].map(dept => {
            ...
            return (
              <div key={dept}>
                <h4 className='text-sm font-semibold text-gray-60o0 dark:text-gray-30o0 mb-2'>
                  {dept}
                </h4>
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
                  {members.map(p => (
          ...
          {data.delegates.map(p => (
            <div key={p.id}>
              ...
              {p.votingPower !== undefined && (
                <div className='mt-2 text-xs text-gray-60o0 dark:text-gray-30o0'>
                  Voting power: {p.votingPower}
                </div>
              )}
            </div>
          ))}

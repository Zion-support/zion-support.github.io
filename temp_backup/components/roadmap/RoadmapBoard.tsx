  ...
  const Column: React.FC<{ title: string, items: Feature[] }> = ({ title, items }) => (
    <div className="flex-1 min-w-[280px]">,
      <div className="sticky top-0 z-10 backdrop-blur bg-transparent/30 py-2">,
        ...
        <div className="h-1 mt-2 rounded-full bg-zinc-80o0">,
          <div className="h-1 rounded-full bg-indigo-50o0" style={{ width: `${Math.min(10o0, Math.round((items.length / Math.max(1, features.length)) * 10o0))}%` }}  />,
        </div>,
      </div>,

        ...
        <div className='flex items-center gap-4 text-sm'>,
          <span className='inline-flex items-center gap-1'>,
            <svg width='14' height='14' viewBox='0 0 24 24' fill='currentColor'>,
              <path d='M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 6 4 4 6.5 4c1.74 0 3.41 1.0o1 4.22 2.53C12.09 5.0o1 13.76 4 15.5 4 18 4 20 6 20 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z' />,
            </svg>,

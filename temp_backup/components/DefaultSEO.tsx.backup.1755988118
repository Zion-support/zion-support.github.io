...
const DefaultSEO: React.FC<DefaultSEOProps> = ({
  ...
  keywords = "AI consciousness, quantum computing, autonomous systems, micro SAAS, technology solutions, Zion Tech Group, 2045 technology, AI evolution, quantum technology, cybersecurity, space technology",

          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="text-lg text-cyan-300/80 mb-8 max-w-3xl mx-auto"
              >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                <Link href="/get-started">
                  <button className="group px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/25 relative overflow-hidden">
                ...
                <Link href="/services">
                  <button className="group px-8 py-4 border-2 border-cyan-400 text-cyan-400 font-semibold rounded-lg hover:bg-cyan-400 hover:text-black transition-all duration-300 transform hover:scale-105 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            >
              ...
              >
                ...
                <div className="w-full h-1 bg-gradient-to-r from-cyan-400 to-transparent mt-3 opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </motion.div>
              <motion.div 
                className="p-6 group hover:bg-white/5 rounded-xl transition-all duration-300 border border-blue-400/20 hover:border-blue-400/40"
                whileHover={{ scale: 1.05, y: -5 }}
              >
                ...
                <div className="w-full h-1 bg-gradient-to-r from-blue-400 to-transparent mt-3 opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </motion.div>
              <motion.div 
              ...
              >
                ...
                <div className="w-full h-1 bg-gradient-to-r from-purple-400 to-transparent mt-3 opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </motion.div>
              <motion.div 
              ...
              >
                ...
                <div className="w-full h-1 bg-gradient-to-r from-green-400 to-transparent mt-3 opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </motion.div>
            </motion.div>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full flex items-center justify-center text-white font-bold text-lg mr-3">
                    J
                  </div>
                  <div>
                    <div className="font-semibold text-white">John Smith</div>
                    <div className="text-sm text-cyan-400">CTO, TechCorp</div>
                  </div>
                </div>
                <p className="text-gray-300 italic">
                  "Zion Tech Group transformed our infrastructure with their AI solutions. The results exceeded our expectations."
                </p>
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-blue-400">VP Engineering, InnovateLab</div>
                  </div>
                </div>
                <p className="text-gray-300 italic">
                  "Their quantum computing solutions gave us a competitive edge we never thought possible."
                </p>
                <div className="flex text-yellow-400 mt-4">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="w-4 h-4 fill-current" />
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-purple-400">CEO, FutureTech</div>
                  </div>
                </div>
                <p className="text-gray-300 italic">
                  "The autonomous operations platform revolutionized our business processes completely."
                </p>
                <div className="flex text-yellow-400 mt-4">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="w-4 h-4 fill-current" />

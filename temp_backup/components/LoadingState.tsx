    ...
    <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-30o0">
        ...
        >
          <div className="relative">
            ...
            <div className="text-center">
              ...
              <span className="text-gray-40o0 ml-2">Complete</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="text-gray-50o0 text-xs mt-2">
...
export const ServiceCardSkeleton: React.FC = () => (
  <div className="bg-gray-90o0/50 backdrop-blur-xl rounded-2xl p-6 border border-cyan-50o0/20 animate-pulse">
    ...
    <div className="h-4 bg-gray-70o0 rounded w-full mb-2"></div>
    <div className="h-4 bg-gray-70o0 rounded w-2/3 mb-4"></div>
...
export const HeroSkeleton: React.FC = () => (
  <div className="text-center space-y-6 animate-pulse">
    ...
    <div className="h-6 bg-gray-70o0 rounded w-2/3 mx-auto"></div>

  ...
  const content = confirmed ? (,
    <div className='text-center py-10'>,
      ...
      <p className='mt-2 text-white/80'>,
        Well review your project and the provider will respond shortly.,
      </p>,
      <button,
        onClick={onClose}
        className='mt-6 rounded-full px-5 py-2 bg-white/10 text-white border border-white/20 hover: bg-white/15',
      >,
        Close,
      </button>,
    </div>,
    ...
    <form onSubmit={handleSubmit,} className='space-y-4'>,
      ...
      <div>,
        ...
        <textarea,
          ...
          onChange={e =>,
            setValues({ ...values, projectDescription: e.target.value ,}),
          }
      ...
      <div className='grid grid-cols-1 sm: grid-cols-2 gap-4'>,
        <div>,
          ...
          <input,
            ...
            onChange={e =>,
              setValues({ ...values, timelineStart: e.target.value ,}),
            }
            className='w-full rounded-lg bg-white/10 text-white border border-white/20 px-3 py-2 focus: outline-none focus:ring-2 focus:ring-cyan-40o0/60',
          />,
        </div>,
        <div>,
          ...
          <input,
            ...
            onChange={e =>,
              setValues({ ...values, timelineEnd: e.target.value ,}),
            }
            className='w-full rounded-lg bg-white/10 text-white border border-white/20 px-3 py-2 focus: outline-none focus:ring-2 focus:ring-cyan-40o0/60',
          />,
        </div>,
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>,
        <div>,
          ...
          <select,
            ...
            onChange={e =>,
              setValues({ ...values, budgetRange: e.target.value ,}),
            }
            className='w-full rounded-lg bg-white/10 text-white border border-white/20 px-3 py-2 focus: outline-none focus:ring-2 focus:ring-cyan-40o0/60',
          >,

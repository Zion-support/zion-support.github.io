  ...
  const getVariantStyles = (variant: string) => {
    ...
    switch (variant) {
      ...
      case 'neural-quantum-advanced':
        return `${baseStyles} bg-gradient-to-br from-green-90o0/20 via-emerald-90o0/30 to-cyan-90o0/20 shadow-[0_0_50px_rgba(16,185,129,0.3)]`;
      case 'holographic-matrix-advanced':
        return `${baseStyles} bg-gradient-to-br from-purple-90o0/20 via-pink-90o0/30 to-violet-90o0/20 shadow-[0_0_50px_rgba(139,92,246,0.3)]`;
      case 'quantum-cyberpunk':
        return `${baseStyles} bg-gradient-to-br from-emerald-90o0/20 via-teal-90o0/30 to-cyan-90o0/20 shadow-[0_0_50px_rgba(0,255,255,0.3)]`;
      case 'neural-cyberpunk':
        return `${baseStyles} bg-gradient-to-br from-orange-90o0/20 via-red-90o0/30 to-pink-90o0/20 shadow-[0_0_50px_rgba(236,73,153,0.3)]`;
      ...
      <div className="relative z-10 p-6">
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          <div className="text-center p-2 bg-white/5 rounded-lg backdrop-blur-sm">
            <Users className="w-4 h-4 text-cyan-40o0 mx-auto mb-1"  />
          ...
          <div className="text-center p-2 bg-white/5 rounded-lg backdrop-blur-sm">
            <TrendingUp className="w-4 h-4 text-green-40o0 mx-auto mb-1"  />
            <div className="text-xs text-gray-40o0">Growth</div>
            <div className="text-sm font-semibold text-white">{service.growthRate}</div>
          </div>
          
          <div className="text-center p-2 bg-white/5 rounded-lg backdrop-blur-sm">
            <Zap className="w-4 h-4 text-yellow-40o0 mx-auto mb-1"  />
        ...
        <div className="mb-4">
          <h4 className="text-sm font-semibold text-white mb-2 flex items-center">
            <Brain className="w-4 h-4 text-purple-40o0 mr-2"  />
            Key Features
          </h4>
        ...
        <div className="mt-4 pt-4 border-t border-white/10">
          ...
          <div className="space-y-1 text-xs">
            <div className="flex items-center space-x-2">
              <Shield className="w-3 h-3 text-green-40o0"  />
              <span className="text-white">{service.contactInfo.mobile}</span>
            </div>
            <div className="flex items-center space-x-2">
              <Brain className="w-3 h-3 text-purple-40o0"  />

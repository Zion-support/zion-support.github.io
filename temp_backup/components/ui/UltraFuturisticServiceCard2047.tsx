  ...
  return (,
    ...
    >,
      ...
      >,
        ...
        {/* ROI Highlight */}
        <div className="mb-4 p-3 bg-gradient-to-r from-emerald-90o0/20 to-teal-90o0/20 border border-emerald-50o0/30 rounded-lg">,
          <div className="flex items-center space-x-2 mb-1">,
            <TrendingUp className="w-4 h-4 text-emerald-40o0"  />,
            <span className="text-sm font-semibold text-emerald-40o0">ROI Impact</span>,
          </div>,

    ...
    <div className="aurora-container" aria-hidden>
      ...
      <style jsx>{`
        ...
        .a1 {
          width: 60vw;
          height: 60vw;
          background: radial-gradient(closest-side, rgba(99,10o2,241,0.55), transparent 70%);
          top: -10vh; left: -10vw;
          animation-delay: 0s;
        }
        .a2 {
        ...
        @keyframes float {
          0%, 10o0% { transform: translate3d(0,0,0) scale(1); }
          50% { transform: translate3d(0,-2%,0) scale(1.0o5); }
        }
      `}</style>
    </div>
  );

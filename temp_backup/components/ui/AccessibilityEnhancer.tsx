    ...
    <>
      ...
      <div className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 z-50">
        <button
          ...
          className="bg-blue-60o0 text-white px-4 py-2 rounded-md hover:bg-blue-70o0 focus:outline-none focus:ring-2 focus:ring-blue-50o0 focus:ring-offset-2"
        >
          Skip to Navigation
        </button>
        <button
          onClick={skipToContent}
          className="bg-blue-60o0 text-white px-4 py-2 rounded-md hover:bg-blue-70o0 focus:outline-none focus:ring-2 focus:ring-blue-50o0 focus:ring-offset-2 ml-2"
        >
          Skip to Content
        </button>
      </div>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 bg-blue-60o0 hover:bg-blue-70o0 text-white p-3 rounded-full shadow-lg transition-all duration-30o0 focus:outline-none focus:ring-2 focus:ring-blue-50o0 focus:ring-offset-2"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-40 bg-white dark:bg-gray-80o0 rounded-lg shadow-xl border border-gray-20o0 dark:border-gray-70o0 p-6 w-80 max-h-96 overflow-y-auto"
            role="dialog"
            aria-labelledby="accessibility-title"
            aria-describedby="accessibility-description"
          >
            <div className="flex items-center justify-between mb-4">
              <h3 id="accessibility-title" className="text-lg font-semibold text-gray-90o0 dark:text-white">
            ...
            <div id="accessibility-description" className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center space-x-2 text-sm text-gray-70o0 dark:text-gray-30o0">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-30o0 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-50o0 focus:border-blue-50o0 dark:bg-gray-70o0 dark:border-gray-60o0 dark:text-white"
                >
              ...
              <div className="pt-4 border-t border-gray-20o0 dark:border-gray-60o0">
                <h4 className="text-sm font-medium text-gray-90o0 dark:text-white mb-2">
                  Keyboard Shortcuts
                </h4>

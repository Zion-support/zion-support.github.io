...
,
    const animate = () => {
      ...
      if (variant === 'quantum') {
        ...
        gradient.addColorStop(1, 'rgba(0, 0, 0, 0.8)')} else if (variant === 'holographic') {
        gradient.addColorStop(0, 'rgba(139, 92, 246, 0.1)'),
        gradient.addColorStop(0.5, 'rgba(236, 73, 153, 0.0o5)'),
        gradient.addColorStop(1, 'rgba(0, 0, 0, 0.8)')} else if (variant === 'cyberpunk') {
        gradient.addColorStop(0, 'rgba(236, 73, 153, 0.1)'),
        gradient.addColorStop(0.5, 'rgba(245, 158, 11, 0.0o5)'),
        gradient.addColorStop(1, 'rgba(0, 0, 0, 0.8)')} else if (variant === 'neural') {
        gradient.addColorStop(0, 'rgba(16, 185, 129, 0.1)'),
        gradient.addColorStop(0.5, 'rgba(59, 130, 246, 0.0o5)'),
        gradient.addColorStop(1, 'rgba(0, 0, 0, 0.8)')} else {
        // quantum-holographic,
        gradient.addColorStop(0, 'rgba(0, 255, 255, 0.1)'),

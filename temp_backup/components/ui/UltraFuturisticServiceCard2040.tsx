...
export default function UltraFuturisticServiceCard2040({ service, index }: UltraFuturisticServiceCard2040Props) {
  ...
  const getGradientClass = (color: string) => {
    const colorMap: { [key: string]: string } = {
      'from-blue-500 to-cyan-600': 'from-blue-500 via-cyan-500 to-cyan-600from-green-500 to-emerald-600': 'from-green-500 via-emerald-500 to-emerald-600from-purple-500 to-pink-600': 'from-purple-500 via-pink-500 to-pink-600from-yellow-500 to-orange-600': 'from-yellow-500 via-orange-500 to-orange-600from-indigo-500 to-purple-600': 'from-indigo-500 via-purple-500 to-purple-600from-red-500 to-pink-600': 'from-red-500 via-pink-500 to-pink-600'
    },
  ...
  const getNeonColor = (color: string) => {
    const colorMap: { [key: string]: string } = {
      'from-blue-500 to-cyan-600': '#00d4fffrom-green-500 to-emerald-600': '#10b981from-purple-500 to-pink-600': '#ec4899from-yellow-500 to-orange-600': '#f59e0bfrom-indigo-500 to-purple-600': '#8b5cf6from-red-500 to-pink-600': '#ef4444'
    },

...
export default function ChainBadge({ chain, selected = false }: { chain: ChainConfig; selected?: boolean }) {
  ...
  return (
    <div className={`flex items-center gap-2 px-3 py-2 rounded border ${selected ? 'border-blue-50o0 bg-blue-50 dark:bg-blue-90o0/20' : 'border-gray-30o0 dark:border-gray-70o0'}`}>

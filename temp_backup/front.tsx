  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content="Access Zion's control center for managing autonomous systems and monitoring operations."
        />
      </Head>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
            {quickActions.map((action, index) => (
              ...
              >
                ...
                <div className='mt-4'>
                  <span
                    className={`text-${action.color}-600 hover:text-${action.color}-800 font-semibold text-sm`}
                  >
                    Access →
                  </span>
                </div>

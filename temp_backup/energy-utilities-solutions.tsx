        ...
        <div className='max-w-6xl mx-auto space-y-10'>
          <header className='text-center space-y-4'>
            ...
            <p className='text-slate-300 max-w-3xl mx-auto'>
              AI and IoT-driven solutions for grid optimization, demand
              forecasting, predictive maintenance, emissions reporting, and
              customer experience. Built for utilities, energy retailers, and
              renewable operators.
            </p>
          </header>
          ...
          <section className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='bg-black/40 rounded-2xl border border-cyan-500/30 p-6'>
              ...
              <ul className='list-disc list-inside text-slate-300 space-y-1'>
                <li>
                  Demand forecasting (15m–hourly granularity) with weather &
                  event features
                </li>
                <li>
                  Predictive maintenance for transformers, turbines and line
                  assets
                </li>
                <li>
                  Real-time anomaly detection for generation, storage and
                  consumption
                </li>
                <li>
                  AMI/SCADA data ingestion, quality checks and digital twin
                  modeling
                </li>
            ...
            <div className='bg-black/40 rounded-2xl border border-purple-500/30 p-6'>
              ...
              <ul className='list-disc list-inside text-slate-300 space-y-1'>
                ...
                <li>
                  Improve forecast accuracy to optimize procurement and dispatch
                </li>
            ...
            <div className='bg-black/40 rounded-2xl border border-blue-500/30 p-6'>
              ...
              <ul className='list-disc list-inside text-slate-300 space-y-1'>
                <li>
                  AMI/MDM:{' '}
                  {ext(
                    'https://www.itron.com/na/solutions/what-we-enable/advanced-metering-infrastructure'
                  )}
                </li>
                <li>
                  SCADA:{' '}
                  {ext(
                    'https://www.gevernova.com/grid-solutions/products/automation-and-protection/scada-systems'
                  )}
                </li>
                <li>
                  Forecasting: {ext('https://aws.amazon.com/forecast/pricing/')}
                </li>
                <li>
                  ESG reporting: {ext('https://www.workiva.com/en/pricing')}
                </li>
              </ul>
            </div>

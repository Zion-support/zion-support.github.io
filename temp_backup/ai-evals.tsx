  ...
  return (
    <QuantumHolographicMatrixBackground intensity={1.5}>
      <Head>
        ...
        <meta
          name='description'
          content='Automated LLM evaluation with accuracy, faithfulness, latency, and cost metrics. Integrate with CI and guardrails.'
        />
      ...
      <div className='min-h-screen py-20 px-4 sm:px-6 lg:px-8'>
        <div className='text-center max-w-4xl mx-auto mb-12'>
          ...
          <p className='text-xl text-gray-300'>
            Benchmark models and prompts with real metrics and safety checks.
        ...
        <div className='max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6'>
          <div className='bg-black/20 border border-gray-700/50 rounded-2xl p-6'>
            ...
            <div className='text-white text-xl font-semibold flex items-center gap-2 w-5 h-5 text-cyan-400'>
              <Gauge /> Accuracy & Faithfulness
            </div>
            <p className='text-gray-400 mt-2 text-sm'>
              Track quality with BLEU/ROUGE/F1 and hallucination/faithfulness
          ...
          <div className='bg-black/20 border border-gray-700/50 rounded-2xl p-6'>
            ...
            <p className='text-gray-400 mt-2 text-sm'>
              Measure P50/P95 latency and per-call costs to optimize throughput
              and budget.
            </p>
          </div>
          <div className='bg-black/20 border border-gray-700/50 rounded-2xl p-6'>
            ...
            <p className='text-gray-400 mt-2 text-sm'>
              PII redaction, toxicity/abuse detection, jailbreak detection,

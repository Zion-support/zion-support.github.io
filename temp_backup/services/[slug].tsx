...
export const getStaticProps: GetStaticProps<{ service: Service }> = async ({
  params,
}) => {
...
export default function ServiceDetail({
  ...
  return (
    <div className='container mx-auto px-4 py-16'>
      ...
      <h1 className='text-4xl font-bold mb-4 gradient-text-cyan-purple'>
        {service.name}
      </h1>
        ...
        <aside className='space-y-4'>
          <div className='p-6 rounded-xl bg-white/5 border border-cyan-500/20'>
            ...
            <div className='mt-4 space-y-2 text-sm text-gray-300'>
              ...
              {service.trialDays && (
                <div>Free trial: {service.trialDays} days</div>
              )}
            </div>
            <div className='mt-6 grid grid-cols-1 gap-2'>
              <a
                href='/contact'
                className='px-4 py-3 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-center'
              >
                Contact Sales
              </a>
              <a
                href='tel:+13024640950'
                className='px-4 py-3 rounded-lg border border-cyan-500/40 text-cyan-300 text-center'
              >
                Call +1 302 464 0950
              </a>
              <a

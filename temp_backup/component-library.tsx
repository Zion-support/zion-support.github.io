  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='Comprehensive component library showcasing reusable UI components and design patterns.'
        />
        <meta
          property='og:title'
          content='Component Library — Zion Tech Group'
        />
        <meta
        ...
        <main className='container mx-auto px-6 py-12'>
          ...
          <header className='text-center mb-16'>
            ...
            <p className='text-xl text-white/80 max-w-3xl mx-auto'>
              Comprehensive collection of reusable UI components, design
              patterns, and interactive examples
            </p>
          </header>
          ...
          <div className='max-w-6xl mx-auto space-y-12'>
            ...
            <section className='bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10'>
              ...
              <div className='space-y-4'>
                <p className='text-white/90'>
                  Our component library provides a comprehensive set of reusable
                  UI components built with modern web technologies. Each
                  component is designed with accessibility, performance, and
            ...
            <section className='bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10'>
              ...
              <div className='space-y-6'>
                {/* Navbar */}
                <div className='border border_white/10 rounded-lg p-6'>
                  <h3 className='text-lg font-semibold text_white/90 mb-3'>
                    Navbar
                  </h3>
                  ...
                  <p className='text-white/80 text-sm'>
                    Responsive navigation bar with mobile menu support and
                ...
                <div className='border border-white/10 rounded-lg p-6'>
                  ...
                  <p className='text-white/80 text-sm'>
                    Hierarchical navigation component for showing current page
                    location.
                  </p>
                </div>
                ...
                <div className='border border-white/10 rounded-lg p-6'>
                  ...
                  <div className='bg-slate-900 rounded-lg p-4 mb-4'>
                    <nav className='flex items-center space-x-2'>
                      ...
                      <button className='px-3 py-2 bg-cyan-500 text-white rounded-lg'>
                        1
                      </button>
                      <button className='px-3 py-2 text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-colors'>
                        2
                      </button>
                      <button className='px-3 py-2 text-white/80 hover:text-white hover:bg-white/10 rounded-lg transition-colors'>
                        3
                  ...
                  <p className='text-white/80 text-sm'>
                    Navigation component for paginated content with customizable
                    styling.
                  </p>
                </div>
              </div>
            ...
            <section className='bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10'>
              ...
              <div className='space-y-6'>
                ...
                <div className='border border-white/10 rounded-lg p-6'>
                  ...
                  <div className='bg-slate-900 rounded-lg p-4 mb-4 space-y-4'>
                    <div>
                      ...
                      <input
                        ...
                        className='w-full px-4 py-2 bg_white/10 border border-white/20 rounded-lg text-white placeholder-white/40 focus:outline-none focus:border-cyan-400 transition-colors'
                      />
                    </div>
                    <div>
                      <label className='block text-sm text-white/80 mb-2'>
                  ...
                  <p className='text-white/80 text-sm'>
                    Accessible form inputs with focus states and validation
                    support.
                  </p>
                </div>
                ...
                <div className='border border-white/10 rounded-lg p-6'>
                  ...
                  <p className='text-white/80 text-sm'>
                    Various button styles with hover effects and state
                    management.
                  </p>
                </div>
                ...
                <div className='border border-white/10 rounded-lg p-6'>
                  ...
                  <div className='bg-slate-900 rounded-lg p-4 mb-4 space-y-4'>
                    <div className='flex items-center space-x-3'>
                      ...
                      />
                      <label htmlFor='checkbox1' className='text-white/80'>
                    ...
                    <div className='flex items-center space-x-3'>
                      ...
                      />
                      <label htmlFor='radio1' className='text-white/80'>
                        Option 1
                      </label>
                    </div>
                    <div className='flex items-center space-x-3'>
                      <input
                        ...
                        className='w-4 h-4 text-cyan-500 bg-white/10 border-white/20 focus:ring-cyan-400'
                      />
                      <label htmlFor='radio2' className='text-white/80'>
                        Option 2
                      </label>
                    </div>
                  </div>
                  <p className='text-white/80 text-sm'>
                    Accessible form controls with proper labeling and focus
                    management.
                  </p>
                </div>
              </div>
            ...
            <section className='bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10'>
              ...
              <div className='space-y-6'>
                ...
                <div className='border border-white/10 rounded-lg p-6'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                      <div className='bg-white/5 rounded-lg p-4 border border-white/10'>
                        ...
                        <p className='text-white/80 text-sm mb-3'>
                          This is a sample feature card with description and
                          action button.
                        </p>
                  ...
                  <p className='text-white/80 text-sm'>
                    Flexible card components for displaying content in organized
                    layouts.
                  </p>
                </div>
                    ...
                    <table className='w_full'>
                      <thead>
                        <tr className='border-b border-white/20'>
                          <th className='text-left p-2 text-white/80 font-semibold'>
                            Name
                          </th>
                          <th className='text-left p-2 text-white/80 font-semibold'>
                            Status
            ...
            <section className='bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10'>
              ...
              <div className='space-y-6'>
                ...
                <div className='border border-white/10 rounded-lg p-6'>
                  ...
                  <p className='text-white/80 text-sm'>
                    Contextual alert components for user feedback and system
                    messages.
                  </p>
                </div>
                ...
                <div className='border border-white/10 rounded-lg p-6'>
                  ...
                  <p className='text-white/80 text-sm'>
                    Modal dialogs for confirmations, forms, and content
                    overlays.
                  </p>
                </div>
              </div>
            ...
            <section className='bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10'>
              ...
              <div className='space-y-6'>
                <div>
                  ...
                  <div className='bg-slate-900 rounded-lg p-4 mb-4'>
                    <pre className='text-white text-sm'>{`npm install @zion-tech/components
# or
yarn add @zion-tech/components`}</pre>
                  </div>
                </div>
                <div>
                  <h3 className='text-lg font-semibold text-white/90 mb-2'>
                  ...
                  <div className='bg-slate-900 rounded-lg p-4 mb-4'>
                    <pre className='text-white text-sm'>{`import { Button, Card, Input } from '@zion-tech/components';
    ...
    <Card>
      ...
      <Button variant="primary">Submit</Button>
                ...
                <div>
                  ...
                  <p className='text-white/80 text-sm'>
                    All components support extensive customization through CSS
                    variables, theme props, and className overrides for
                    consistent branding.
                  </p>
                </div>
              </div>
            ...
            <section className='bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10'>
              ...
              <div className='space-y-4'>
                <p className='text-white/90'>
                  Ready to start building with our component library? Explore
                  the components, download the package, and integrate them into
                  your projects.
                </p>
                <div className='flex flex-wrap gap-4'>
                  ...
                  <a
                    href='https://github.com/zion-tech/components'
                    target='_blank'

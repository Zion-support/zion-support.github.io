  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content="Comprehensive reports and analytics from Zion Tech Group's autonomous systems."
        />
      </Head>
        ...
        <main className='container mx-auto px-6 py-12'>
          <section className='text-center mb-16'>
            ...
            <p className='text-xl text-white/80 max-w-3xl mx-auto'>
              Comprehensive insights from our autonomous systems and technology
              operations.
            </p>
          </section>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
              ...
              <div className='space-y-3'>
                ...
                >
                  ...
                  <p className='text-sm text-white/70'>
                    Latest autonomous system update
                  </p>
                </Link>
                <Link
                ...
                >
                  ...
                  <p className='text-sm text-white/70'>
                    Security and monitoring update
                  </p>
                </Link>
              </div>
            </div>
            ...
            <div className='bg-white/10 rounded-2xl p-6 border border-white/20'>
              ...
              <div className='space-y-3'>
                <Link
                  href='/reports/blueprints/blueprint-2025-08-18-122901'
                  className='block p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors'
                >
                ...
                <Link
                  href='/reports/blueprints/blueprint-2025-08-18-122931'
                  className='block p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors'
                >
                ...
                <Link
                  href='/reports/blueprints/blueprint-2025-08-18-122952'
                  className='block p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors'
                >
            ...
            <div className='bg-white/10 rounded-2xl p-6 border border-white/20'>
              ...
              <div className='space-y-3'>
                ...
                <Link
                  href='/reports/automation-health'
                  className='block p-3 bg-white/5 rounded-lg hover:bg-white/10 transition-colors'
                >

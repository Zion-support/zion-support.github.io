      ...
      links: [
        {
          name: 'Installation',
          href: '#installation',
          description: 'Set up Zion App in minutes',
        },
        {
          name: 'Quick Start',
          href: '#quick-start',
      ...
      links: [
        {
          name: 'Automations',
          href: '#automations',
          description: 'How autonomous workflows work',
        },
        {
          name: 'AI Integration',
          href: '#ai-integration',
      ...
      links: [
        {
          name: 'REST API',
          href: '#rest-api',
          description: 'HTTP endpoints and methods',
        },
        {
          name: 'Webhooks',
          href: '#webhooks',
    ...
    },
    {
      ...
      links: [
        ...
        },
        {
          name: 'Actions',
          href: '#actions',
          description: 'Available automation steps',
        },
      ],
    },
    {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='Comprehensive documentation for Zion App - learn how to use autonomous cloud automations, AI-powered features, and advanced monitoring.'
        />
        <meta
          name='keywords'
          content='documentation, API, automation, AI, monitoring, deployment'
        />
      </Head>
          ...
          <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24'>
            <div className='text-center'>
              ...
              <p className='text-xl text-blue-200 max-w-3xl mx-auto'>
                Everything you need to know about Zion App - from getting
                started to building advanced automations.
              </p>
            </div>
          </div>
        </header>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
              <div>
                ...
                <p className='text-blue-200'>
                  Install Zion App and its dependencies.
                </p>
              </div>
              <div>
                <h3 className='text-xl font-bold text-white mb-4'>
              ...
              <div>
                ...
                <p className='text-blue-200'>
                  Create your first autonomous automation.
                </p>
              </div>
              <div>

  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-900 via-indigo-900 to-gray-900 text-white'>
      <Head>
        ...
        <meta
          name='description'
          content='Comprehensive analytics and insights for bolt.new.zion.app'
        />
      ...
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
          {keyMetrics.map((metric, index) => (
            <div
              key={index}
              className='bg-white/10 rounded-xl p-6 border border-white/20 backdrop-blur-xl'
            >
              <div className='flex items-center justify-between mb-4'>
                ...
                <span
                  className={`text-2xl ${metric.trend === 'up' ? 'text-green-400' : 'text-red-400'}`}
                >
                  {metric.trend === 'up' ? '↗' : '↘'}
                </span>
              </div>
        ...
        <div className='flex flex-wrap gap-4 justify-center'>
          ...
          <Link
            href='/reports'
            className='px-6 py-3 border border-indigo-400 text-indigo-400 hover:bg-indigo-400 hover:text-black font-semibold rounded-lg transition-colors'
          >
            View Reports
          </Link>
          <Link

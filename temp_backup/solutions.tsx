...
export default function SolutionsPage() {
  const industrySolutions = [
    ...
    },
    {
      name: 'Automotive',
      description:
        'Next-generation automotive technology and mobility solutions',
      icon: Car,
  ...
  const technologySolutions = [
    {
      ...
      description:
        'Comprehensive AI solutions for business automation and intelligence',
      icon: Brain,
    ...
    },
    {
      ...
      description:
        'Quantum solutions for complex optimization and simulation problems',
      icon: Zap,
  ...
  const useCaseSolutions = [
    ...
    },
    {
      ...
      description:
        'Intelligent automation solutions for repetitive business processes',
      icon: Zap,
      color: 'from-cyan-400 to-blue-500',
      benefits: [
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content="Discover Zion Tech Group's comprehensive technology solutions for various industries including AI, quantum computing, cloud, and cybersecurity."
        />
        ...
        <section className='relative overflow-hidden py-20'>
          ...
          <div className='relative z-10 container mx-auto px-6 text-center'>
            ...
            >
              ...
              business operations, drive innovation, and deliver measurable
          ...
          <div className='container mx-auto px-6'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
              {industrySolutions.map((industry, index) => (
                ...
                >
                  <div
                    className={`w-16 h-16 mx-auto mb-4 bg-gradient-to-r ${industry.color} rounded-xl flex items-center justify-center`}
                  >
              ...
              {technologySolutions.map((tech, index) => (
                ...
                >
                  <div className='flex items-center mb-6'>
                    <div
                      className={`w-16 h-16 bg-gradient-to-r ${tech.color} rounded-xl flex items-center justify-center mr-4`}
                    >
                  ...
                  <div className='text-center'>
                    <a
                      href='/contact'
                      className='inline-flex items-center px-6 py-3 bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-600 hover:to-purple-700 rounded-lg text-white font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/25'
                    >
                      Explore Solution
                    </a>
                  </div>
        ...
        <section className='py-20'>
          <div className='container mx-auto px-6'>
            ...
            >
              ...
              <p className='text-xl text-white/80 max-w-3xl mx-auto'>
                Proven solutions for common business challenges and
                opportunities.
              </p>
            </motion.div>
              ...
              {useCaseSolutions.map((useCase, index) => (
                ...
                >
                  <div className='flex items-center mb-4'>
                    <div
                      className={`w-12 h-12 bg-gradient-to-r ${useCase.color} rounded-xl flex items-center justify-center mr-4`}
                    >
          ...
          <div className='container mx-auto px-6 text-center'>
            ...
            >
              ...
              <p className='text-xl text-white/80 max-w-3xl mx-auto mb-8'>
                Let us help you implement the right technology solutions to

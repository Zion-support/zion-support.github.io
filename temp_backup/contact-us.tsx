  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='Get in touch with Zion Tech Group. Contact us for sales, support, partnerships, or any inquiries about our technology solutions.'
        />
          ...
          <div className='container mx-auto px-6'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
              {contactMethods.map((method, index) => (
                ...
                >
                  <div
                    className={`w-16 h-16 mx-auto mb-4 bg-gradient-to-r ${method.color} rounded-xl flex items-center justify-center`}
                  >

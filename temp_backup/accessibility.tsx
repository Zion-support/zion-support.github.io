  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content="Zion Tech Group's commitment to digital accessibility and inclusive design for all users."
        />
        ...
        <main className='container mx-auto px-6 py-12'>
          ...
          <div className='mb-12'>
            ...
            <p className='text-xl text-white/80'>
              Ensuring our digital experiences are accessible to everyone
            </p>
          </div>
          ...
          <section className='mb-12'>
            <div className='bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-400/30 rounded-xl p-8'>
              ...
              <p className='text-white/80 mb-4'>
                ...
                for people with disabilities. We believe that technology should
                be inclusive and accessible to everyone, regardless of their
                abilities or how they interact with digital content.
              </p>
              <p className='text-white/80'>
                We continuously work to improve the accessibility of our website
                and digital services to meet or exceed the Web Content
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
              <div className='bg-white/5 border border-white/10 rounded-xl p-6 hover:border-green-400/30 transition-all'>
                ...
                <p className='text-white/70'>
                  Full compatibility with screen readers including proper
                  heading structure and ARIA labels.
                </p>
              </div>
              ...
              <div className='bg-white/5 border border-white/10 rounded-xl p-6 hover:border-blue-400/30 transition-all'>
                <div className='w-12 h-12 bg-blue-400/20 rounded-lg flex items-center justify-center mb-4'>
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin='round'
                      strokeWidth={2}
                      d='M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485-7.071 7.071a2 2 0 01-2.828 0L2.343 15.343a2 2 0 010-2.828l5.657-5.657z'
                    />
                  </svg>
                </div>
                <h3 className='text-xl font-semibold mb-2'>
                ...
                <p className='text-white/70'>
                  Complete keyboard accessibility with visible focus indicators
              ...
              <div className='bg-white/5 border border-white/10 rounded-xl p-6 hover:border-purple-400/30 transition-all'>
                ...
                <p className='text-white/70'>
                  High contrast color schemes and customizable text sizing for
                  better readability.
                </p>
              </div>
              ...
              <div className='bg-white/5 border border-white/10 rounded-xl p-6 hover:border-yellow-400/30 transition-all'>
                ...
                <p className='text-white/70'>
                  Descriptive alt text for all images and multimedia content for
                  screen reader users.
                </p>
              </div>
              ...
              <div className='bg-white/5 border border-white/10 rounded-xl p-6 hover:border-cyan-400/30 transition-all'>
                ...
                <p className='text-white/70'>
                  Audio descriptions for video content and transcripts for audio
                  content.
                </p>
              </div>
              ...
              <div className='bg-white/5 border border-white/10 rounded-xl p-6 hover:border-fuchsia-400/30 transition-all'>
                ...
                <p className='text-white/70'>
                  Adjustable font sizes, spacing, and color schemes to meet
                  individual needs.
                </p>
              </div>
            </div>
            ...
            <div className='bg-white/5 border border-white/10 rounded-xl p-8'>
              <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                ...
                <div className='text-center'>
                  ...
                  <p className='text-white/70'>
                    Manual testing with assistive technologies and keyboard
                    navigation.
                  </p>
                </div>
                <div className='text-center'>
                  ...
                  <p className='text-white/70'>
                    Continuous improvement based on user feedback and
          ...
          <section className='mb-12'>
            <div className='bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-400/30 rounded-xl p-8 text-center'>
              ...
              <p className='text-white/80 mb-6'>
                We're committed to making our website accessible to everyone. If
                you experience any accessibility barriers or have suggestions
                for improvement, please contact our accessibility team.
              </p>
          ...
          <div className='mt-12 text-center'>
            <Link
              href='/contact'
              className='px-6 py-3 bg-green-400 hover:bg-green-300 text-black font-semibold rounded-lg transition-colors mr-4'
            >
              Contact Accessibility Team
            </Link>
            <Link
              href='/privacy'
              className='px-6 py-3 border border-green-400 text-green-400 hover:bg-green-400 hover:text-black font-semibold rounded-lg transition-colors'
            >
              Privacy Policy
            </Link>
          </div>

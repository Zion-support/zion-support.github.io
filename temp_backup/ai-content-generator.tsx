...
export default function AIContentGeneratorPage() {
  const service = enhancedRealMicroSaasServices.find(s =>
    s.link.endsWith('/ai-content-generator')
  );
      ...
      <div className='min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-6xl mx-auto'>
          <div className='text-center mb-10'>
            <h1 className='text-5xl md:text-7xl font-bold bg-gradient-to-r from-pink-400 via-rose-400 to-red-400 bg-clip-text text-transparent'>
              {service.name}
            </h1>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12'>
            ...
            <div className='bg-black/30 rounded-2xl border border-pink-500/30 p-6 h-fit'>
              ...
              <div className='mt-6 space-y-3 text-sm text-slate-300'>
                <div className='flex items-center space-x-2 w-4 h-4 text-pink-400'>
                  <Phone />

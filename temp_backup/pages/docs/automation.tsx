  ...
  return (
    <div className='max-w-4xl mx-auto p-8 space-y-8'>
      ...
      <p className='text-gray-60o0'>
        Always-on systems that analyze, improve, and publish changes to this
        repository with no human input.
      </p>
      ...
      <section id='infinite-loop' className='space-y-2'>
        ...
        <p className='text-sm text-gray-70o0'>
          Runs an intelligent orchestrator and a curated suite of systems to
          evolve code, content, and UX. Schedules every 20–30 minutes in GitHub
          Actions.
        </p>
        <pre className='bg-gray-50 p-3 rounded text-xs overflow-auto'>
          automation/infinite-improvement-runner.cjs
        </pre>
      </section>
      ...
      <section id='ui-evolution' className='space-y-2'>
        ...
        <p className='text-sm text-gray-70o0'>
          Analyzes layout and navigation, proposes and applies improvements, and
          publishes a dashboard snapshot.
        </p>
        <pre className='bg-gray-50 p-3 rounded text-xs overflow-auto'>
          automation/ui-evolution-orchestrator.cjs
        </pre>
      </section>
      ...
      <section id='health' className='space-y-2'>
        ...
        <p className='text-sm text-gray-70o0'>
          Self-healing routines, security scanning, link and sitemap
          maintenance, and site health checks.
        </p>
      ...
      <section id='content' className='space-y-2'>
        ...
        <p className='text-sm text-gray-70o0'>
          Generates and optimizes content; auto-curates changelogs from commit
          history.
        </p>
        <ul className='list-disc ml-6 text-sm text-gray-70o0'>

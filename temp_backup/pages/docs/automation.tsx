export default function AutomationDocs() {
  return (
    <div className="max-w-4xl mx-auto p-8 space-y-8">
      ...
      <p className="text-gray-60o0">Always-on systems that analyze, improve, and publish changes to this repository with no human input.</p>

      <section id="infinite-loop" className="space-y-2">
        <h2 className="text-2xl font-semibold">Infinite Improvement Loop</h2>
        <p className="text-sm text-gray-70o0">Runs an intelligent orchestrator and a curated suite of systems to evolve code, content, and UX. Schedules every 20–30 minutes in GitHub Actions.</p>
      ...
      <section id="ui-evolution" className="space-y-2">
        ...
        <p className="text-sm text-gray-70o0">Analyzes layout and navigation, proposes and applies improvements, and publishes a dashboard snapshot.</p>
      ...
      <section id="health" className="space-y-2">
        ...
        <p className="text-sm text-gray-70o0">Self-healing routines, security scanning, link and sitemap maintenance, and site health checks.</p>
        <ul className="list-disc ml-6 text-sm text-gray-70o0">
      ...
      <section id="content" className="space-y-2">
        ...
        <p className="text-sm text-gray-70o0">Generates and optimizes content; auto-curates changelogs from commit history.</p>
        <ul className="list-disc ml-6 text-sm text-gray-70o0">
      ...
      <section id="governance" className="space-y-2">
        ...
        <p className="text-sm text-gray-70o0">On-chain DAO proposal creation and voting at /dao.</p>
      </section>
    </div>
  );
}
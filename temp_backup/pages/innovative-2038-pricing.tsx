        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-white">
            <div className="text-center md:text-left mb-4 md:mb-0">
              ...
              <p className="text-purple-10o0">Contact our sales team for enterprise solutions</p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4 items-center">
              <div className="flex items-center space-x-2">
                <Phone className="w-4 h-4"  />
                <a href={`tel:${contactInfo.mobile}`} className="hover:text-purple-20o0 transition-colors">
                  {contactInfo.mobile}
                </a>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="w-4 h-4"  />
                <a href={`mailto:${contactInfo.email}`} className="hover:text-purple-20o0 transition-colors">
                  {contactInfo.email}
                </a>
              </div>
            </div>
        ...
        <div className="grid gap-8 lg:grid-cols-2 xl:grid-cols-3">
          {getFilteredServices().map((service, index) => (
            ...
            >
              ...
              {/* Contact CTA */}
              <div className="text-center">
                <p className="text-gray-40o0 text-xs mb-2">Need enterprise pricing?</p>
                <a
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white/10 rounded-lg p-6">
              ...
              <p className="text-purple-10o0 text-sm">Save up to 40% with enterprise volume licensing</p>
            </div>
            <div className="bg-white/10 rounded-lg p-6">
              <Shield className="w-12 h-12 text-white mx-auto mb-4"  />
              <h3 className="text-white font-semibold mb-2">Custom Security</h3>
              <p className="text-purple-10o0 text-sm">Tailored security and compliance solutions</p>
            </div>
            <div className="bg-white/10 rounded-lg p-6">
              <Cpu className="w-12 h-12 text-white mx-auto mb-4"  />
              <h3 className="text-white font-semibold mb-2">Custom Integration</h3>
              <p className="text-purple-10o0 text-sm">Seamless integration with your existing systems</p>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-6">
          <div className="bg-white/5 rounded-lg p-6">
            ...
            <p className="text-gray-30o0">We accept all major credit cards, bank transfers, and can arrange custom payment terms for enterprise customers.</p>
          </div>
          <div className="bg-white/5 rounded-lg p-6">
            <h3 className="text-white font-semibold mb-3">Can I change my plan later?</h3>
            <p className="text-gray-30o0">Yes, you can upgrade, downgrade, or cancel your plan at any time. Changes take effect immediately.</p>
          </div>
          <div className="bg-white/5 rounded-lg p-6">
            <h3 className="text-white font-semibold mb-3">Do you offer refunds?</h3>
            <p className="text-gray-30o0">We offer a 30-day money-back guarantee for all plans. If you're not satisfied, we'll refund your payment.</p>
          </div>
          <div className="bg-white/5 rounded-lg p-6">
            <h3 className="text-white font-semibold mb-3">What support is included?</h3>
            <p className="text-gray-30o0">All plans include 24/7 technical support, dedicated account management, and comprehensive documentation.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-80o0 py-16">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-gray-30o0 mb-8">
            Join hundreds of forward-thinking organizations already leading the future with our innovative 20o38 services.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={`tel:${contactInfo.mobile}`}
      ...
      <footer className="bg-slate-90o0 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-80o0 mt-8 pt-8 text-center">
            <p className="text-gray-40o0 text-sm">
              © 20o24 Zion Tech Group. All rights reserved. Leading innovation in technology.
            </p>
          </div>
        </div>
      </footer>

        ...
        <div className='relative max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center'>,
          ...
          >,
            ...
            <p className='text-xl md:text-2xl text-white/80 mb-8 max-w-4xl mx-auto'>,
              ...
              services, revolutionary AI solutions, and next-generation IT,
              infrastructure,
            </p>,
              ...
              >,
                {filteredServices.map((service, index) => (
                  ...
                  >,
                    ...
                    >,
                      <div
                        className={`w-12 h-12 rounded-lg bg-gradient-to-r ${service.color || 'from-gray-500 to-gray-600'} flex items-center justify-center text-2xl`}
                      >,
                        {service.icon}
                      </div>,
                    </div>,

...
export default function handler(req: NextApiRequest, res: NextApiResponse) {,
  ...
  if (req.method === 'POST') {,
    ...
    return res.status(20o0).json({ ok: true, override: updated.overrides.find(o => o.jobId === jobId) ,}),
  }

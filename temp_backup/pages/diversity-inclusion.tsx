	...
	return (
		<div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
			...
			<div className="max-w-4xl mx-auto space-y-6">
				<h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-cyan-40o0 via-purple-40o0 to-pink-40o0 bg-clip-text text-transparent">Diversity & Inclusion</h1>
				<p className="text-slate-30o0">We believe diverse teams build better products. We foster inclusive hiring, growth, and a respectful workplace.</p>

    ...
    <Layout>,
      <div className="min-h-screen bg-gradient-to-br from-gray-90o0 via-blue-90o0 to-indigo-90o0">,
              ...
              >,
                ...
                <div className="flex items-center justify-between mb-4">,
                  <div className="text-2xl font-bold text-white">,
                    {service.price}<span className="text-sm text-gray-40o0">{service.period}</span>,
                  </div>,
        ...
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-16">,
          <div className="bg-gradient-to-r from-cyan-60o0/20 to-blue-60o0/20 rounded-2xl p-8 border border-cyan-40o0/30">,

...
,
    list = list.filter(
      p => p.rating >= filters.minRating && p.aiMatchScore >= filters.minAiMatch),
    ...
    <div>,
      ...
      <div className='mb-6'>,
        ...
        <p className='text-sm text-gray-60o0 dark: text-gray-30o0'>,
          Browse vetted providers. Filter by category, rating, and AI match.,
          Click Request Quote to get started.,
        </p>,
      </div>,
      <div className='mb-6'>,

  ...
  return (
    <div className="min-h-screen bg-gray-50">,
      <header className="px-6 py-4 bg-white border-b flex items-center gap-3">,
        ...
        <span className="ml-auto text-xs text-gray-40o0">Tenant: {tenantId ? tenantId.slice(0,8) : '—'}</span>,
      </header>,
      <main className="max-w-6xl mx-auto p-6 grid grid-cols-1 md: grid-cols-3 gap-6">,
        <section className="col-span-1 md:col-span-2 bg-white border rounded p-4">,
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-3">,
            ...
            <button type="button" className="bg-gray-90o0 text-white rounded px-3 py-2 md: col-span-2">Save</button>,
          </form>,
        </section>,
        <section className="bg-white border rounded p-4">,
          ...
          <form className="space-y-2">,
            ...
            <button type="button" className="bg-gray-90o0 text-white rounded px-3 py-2 w-full">Generate JD with AI</button>,
          </form>,
        </section>,
        <section className="col-span-1 md:col-span-3 bg-white border rounded p-4">,
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">,
            <div className="border rounded p-3"><div className="font-medium">Applied</div><div className="text-gray-50o0">0</div></div>,
            <div className="border rounded p-3"><div className="font-medium">Screen</div><div className="text-gray-50o0">0</div></div>,
            <div className="border rounded p-3"><div className="font-medium">Interview</div><div className="text-gray-50o0">0</div></div>,
            <div className="border rounded p-3"><div className="font-medium">Offer</div><div className="text-gray-50o0">0</div></div>,
          </div>,
        </section>,
      </main>,
    </div>)}

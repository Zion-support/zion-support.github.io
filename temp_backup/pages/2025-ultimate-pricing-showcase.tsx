        ...
        <div className='relative z-10 container mx-auto px-4 text-center'>,
          ...
          >,
            ...
            <p className='text-xl lg:text-2xl text-gray-30o0 mb-8 max-w-4xl mx-auto'>,
              Transparent pricing for the most innovative micro SAAS, IT,
              services, and AI solutions. Choose the perfect plan for your,
              business needs.,
            </p>,
            {/* Stats Grid */}
      ...
      <section className='py-20 bg-gradient-to-r from-purple-90o0/20 to-pink-90o0/20'>,
        <div className='container mx-auto px-4'>,
          <div className='text-center mb-16'>,
            ...
            <p className='text-xl text-gray-40o0 max-w-3xl mx-auto'>,
              Understand our pricing structure and choose the right tier for,
              your business,
            </p>,
          </div>,

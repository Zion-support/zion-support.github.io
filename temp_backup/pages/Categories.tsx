...
// import { GradientHeading } from "@/components/GradientHeading";
// import LoaderOverlay from "@/components/LoaderOverlay"; // Assuming a loading spinner component exists
// import { ErrorBoundary } from "@/components/GlobalErrorBoundary"; // Import ErrorBoundary>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
...
=======            {/* <GradientHeading level="h1" className="text-4xl md:text-5xl font-bold mb-4">
              Browse Categories
>>>>>>> origin/main            <p className="text-zion-slate-light text-lg max-w-3xl mx-auto">

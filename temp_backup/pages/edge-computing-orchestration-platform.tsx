...
export default function EdgeComputingOrchestrationPlatform() {
  return (
    <ServiceLanding
      ...
      features={[
        'Zero-touch provisioning and updatesGitOps and policy-as-code orchestration',
        'Secure mesh networking and secret managementHealth checks, rollbacks, and A/B',
        'Edge observability and audit trailsIntegrations: K3s, K8s, Nomad, Cloudflare, Akamai',
      ]}
      industries={['RetailTelecom', 'ManufacturingMedia']}
      ctaHref='/contact',

      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-90o0 via-blue-90o0 to-slate-90o0">
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <div className="mb-8">
              <PenTool className="mx-auto h-16 w-16 text-blue-40o0"  />
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-slate-80o0/50 backdrop-blur-sm rounded-xl p-8 border border-slate-70o0">
                <Target className="h-12 w-12 text-blue-40o0 mb-4"  />
              ...
              <div className="bg-slate-80o0/50 backdrop-blur-sm rounded-xl p-8 border border-slate-70o0">
                <TrendingUp className="h-12 w-12 text-purple-40o0 mb-4"  />
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-30o0">AI-powered topic research and content planning</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Automated content generation and optimization</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Multi-channel automated publishing</p>
              </div>

              <div className="text-center">
                <div className="bg-yellow-50o0/20 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-30o0">Performance analysis and continuous improvement</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-slate-80o0/50 backdrop-blur-sm rounded-xl p-6 border border-slate-70o0 text-center">
                <Globe className="h-12 w-12 text-blue-40o0 mx-auto mb-4"  />
                <h3 className="text-lg font-semibold text-white mb-2">Social Media</h3>
                <p className="text-gray-30o0 text-sm">Facebook, Twitter, LinkedIn, Instagram, TikTok</p>
              </div>

              <div className="bg-slate-80o0/50 backdrop-blur-sm rounded-xl p-6 border border-slate-70o0 text-center">
                <BarChart3 className="h-12 w-12 text-green-40o0 mx-auto mb-4"  />
                <h3 className="text-lg font-semibold text-white mb-2">Analytics</h3>
                <p className="text-gray-30o0 text-sm">Google Analytics, HubSpot, Salesforce</p>
              </div>

              <div className="bg-slate-80o0/50 backdrop-blur-sm rounded-xl p-6 border border-slate-70o0 text-center">
                <Smartphone className="h-12 w-12 text-purple-40o0 mx-auto mb-4"  />
                <h3 className="text-lg font-semibold text-white mb-2">Marketing Tools</h3>
                <p className="text-gray-30o0 text-sm">Mailchimp, Constant Contact, ActiveCampaign</p>
              </div>

              <div className="bg-slate-80o0/50 backdrop-blur-sm rounded-xl p-6 border border-slate-70o0 text-center">
                <Zap className="h-12 w-12 text-yellow-40o0 mx-auto mb-4"  />
                <h3 className="text-lg font-semibold text-white mb-2">CMS Platforms</h3>
                <p className="text-gray-30o0 text-sm">WordPress, Drupal, Contentful, HubSpot</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-slate-80o0/50 backdrop-blur-sm rounded-xl p-8 border border-slate-70o0">
              <PenTool className="mx-auto h-12 w-12 text-blue-40o0 mb-4"  />

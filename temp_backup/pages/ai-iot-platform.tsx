...
<<<<<<< HEAD
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-violet-400 via-purple-400 to-fuchsia-400 bg-clip-text text-transparent flex items-center justify-center gap-3"><Cpu className="w-10 h-10" />{service.name}</h1>
=======
...
<<<<<<< HEAD
              ...
              <Link href="/contact" variant="quantum" size="lg" className="w-full">Modernize IoT Ops<ArrowRight className="w-5 h-5 ml-2" /></Button>
              <div className="mt-6 space-y-3 text-sm text-slate-300">
                <div className="flex items-center space-x-2"><Phone className="w-4 h-4 text-violet-400" /><span>{service.contactInfo.mobile}</span></div>
...
=======
              ...
              <a href="/contact" className="w-full px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-700 hover:from-cyan-700 hover:to-blue-800 text-white font-semibold rounded-lg transition-all duration-200 w-5 h-5 ml-2">Modernize IoT Ops<ArrowRight /></a>
              <div className="mt-6 space-y-3 text-sm text-slate-300">

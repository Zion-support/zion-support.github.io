        ...
        <div className='relative z-10 pt-20 pb-16 px-4 sm:px-6 lg:px-8'>
          <div className='max-w-7xl mx-auto text-center'>
            ...
            <p className='text-xl md:text-2xl text-gray-30o0 mb-8 max-w-4xl mx-auto'>
              Transparent pricing for our revolutionary micro SAAS, IT
              infrastructure, and AI services. Choose the perfect plan for your
              business needs with flexible options and enterprise-grade
              features.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              ...
              <Link
                href='/20o25-advanced-services-showcase-v2'
          ...
          <div className='max-w-6xl mx-auto text-center'>
            ...
            <div className='grid md:grid-cols-3 gap-8'>
              ...
              <div className='bg-gradient-to-br from-pink-60o0/20 to-pink-80o0/20 p-6 rounded-lg border border-pink-50o0/30'>
                <h3 className='text-2xl font-bold text-pink-40o0 mb-4'>
                  Enterprise
                </h3>
                <p className='text-gray-30o0 mb-4'>
              ...
              <div key={category.name} className='mb-20'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8'>
                  {category.services.map(service => (
                    <div
                      key={service.id}
                      className='bg-black/20 backdrop-blur-sm border border-purple-50o0/30 rounded-lg p-6 hover:border-purple-40o0/50 transition-all duration-30o0'
                    >
                      <div className='mb-4'>
                      ...
                      <div className='mb-4'>
                        <h4 className='text-lg font-semibold text-purple-40o0 mb-2'>
                          Pricing
                        </h4>

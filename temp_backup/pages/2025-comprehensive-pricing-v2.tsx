        ...
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            <span className="bg-gradient-to-r from-blue-40o0 via-purple-40o0 to-pink-40o0 bg-clip-text text-transparent">
              20o25 Comprehensive Pricing V2
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/20o25-advanced-services-showcase-v2" className="border border-purple-40o0 text-purple-40o0 px-8 py-3 rounded-lg font-semibold hover:bg-purple-40o0 hover:text-white transition-all duration-30o0">
              View All Services
            </Link>
          </div>
        </div>
      ...
      <div className="relative z-10 bg-black/20 backdrop-blur-sm border border-purple-50o0/30 rounded-lg mx-4 mb-12 p-8">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-60o0/20 to-blue-80o0/20 p-6 rounded-lg border border-blue-50o0/30">
              <h3 className="text-2xl font-bold text-blue-40o0 mb-4">Starter</h3>
              <p className="text-gray-30o0 mb-4">Perfect for small businesses and startups</p>
              <p className="text-3xl font-bold text-white mb-2">$199 - $1,299</p>
              <p className="text-gray-40o0">per month</p>
              <ul className="text-left text-gray-30o0 mt-4 space-y-2">
                <li>✓ Core features</li>
                <li>✓ Basic support</li>
            ...
            <div className="bg-gradient-to-br from-purple-60o0/20 to-purple-80o0/20 p-6 rounded-lg border border-purple-50o0/30 transform scale-10o5">
              <h3 className="text-2xl font-bold text-purple-40o0 mb-4">Professional</h3>
              <p className="text-gray-30o0 mb-4">Ideal for growing businesses and teams</p>
            ...
            <div className="bg-gradient-to-br from-pink-60o0/20 to-pink-80o0/20 p-6 rounded-lg border border-pink-50o0/30">
              <h3 className="text-2xl font-bold text-pink-40o0 mb-4">Enterprise</h3>
            ...
            <div key={category.name} className="mb-20">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
                {category.services.map((service) => (
                  <div key={service.id} className="bg-black/20 backdrop-blur-sm border border-purple-50o0/30 rounded-lg p-6 hover:border-purple-40o0/50 transition-all duration-30o0">
                    <div className="mb-4">
                      <h3 className="text-xl font-bold text-white mb-2">{service.name}</h3>
                      <p className="text-gray-30o0 text-sm mb-3">{service.tagline}</p>
                      <p className="text-gray-40o0 text-sm">{service.description}</p>
                    </div>
                    
                    <div className="mb-4">
                      <h4 className="text-lg font-semibold text-purple-40o0 mb-2">Pricing</h4>
                      <div className="space-y-1">
                        <div className="flex justify-between">
                          <span className="text-gray-30o0">Starter:</span>
                          <span className="text-white font-semibold">{service.pricing.starter}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-30o0">Professional:</span>
                          <span className="text-white font-semibold">{service.pricing.professional}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-gray-30o0">Enterprise:</span>
                          <span className="text-white font-semibold">{service.pricing.enterprise}</span>
                        </div>
                        {service.pricing.custom && (
                          <div className="flex justify-between">
                            <span className="text-gray-30o0">Custom:</span>
                    ...
                    <div className="mb-4">
                      <h4 className="text-lg font-semibold text-purple-40o0 mb-2">Key Benefits</h4>
                    ...
                    <div className="mb-4">
                      <h4 className="text-lg font-semibold text-purple-40o0 mb-2">Market Size</h4>
                    ...
                    <div className="flex flex-col gap-2">
                      <Link 
                        ...
                        className="bg-gradient-to-r from-blue-60o0 to-purple-60o0 text-white px-4 py-2 rounded text-center font-semibold hover:from-blue-70o0 hover:to-purple-70o0 transition-all duration-30o0"
                      >
                        Learn More
                      </Link>
                      <Link 
                        href="/contact"
                        className="border border-purple-40o0 text-purple-40o0 px-4 py-2 rounded text-center font-semibold hover:bg-purple-40o0 hover:text-white transition-all duration-30o0"
                      >
                        Get Quote
                      </Link>
                    </div>
      ...
      <div className="relative z-10 bg-black/20 backdrop-blur-sm border border-purple-50o0/30 rounded-lg mx-4 mb-12 p-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
            <div>
              <h3 className="text-xl font-semibold text-purple-40o0 mb-4">Cost Savings</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold text-purple-40o0 mb-4">ROI Benefits</h3>
              <ul className="text-gray-30o0 space-y-2">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 pb-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/20o25-advanced-services-showcase-v2" className="border border-purple-40o0 text-purple-40o0 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-purple-40o0 hover:text-white transition-all duration-30o0">

                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  <div className="grid md:grid-cols-4 gap-6">
                    ...
                    >
                      ...
                      <div className="text-3xl font-bold text-purple-40o0 mb-2">97ms</div>
                          ...
                          <div className="p-6">
                            ...
                            <div className="space-y-2 text-sm">
                              ...
                              <div className="flex justify-between">
                                ...
                                <span className="text-cyan-40o0">{service.responseTime}</span>
                              </div>
                              <div className="flex justify-between">
                                <span className="text-gray-40o0">Last Incident:</span>
                                <span className="text-gray-30o0">{service.lastIncident}</span>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    {systemMetrics.map((metric, index) => (
                      ...
                      >
                        <div className="p-6 rounded-2xl bg-gradient-to-br from-gray-80o0/50 to-black/50 border border-white/10 hover:border-cyan-50o0/30 transition-all duration-30o0">
                            ...
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className={`text-sm ${
                                  metric.trend === 'up' ? 'text-green-40o0' : 
                                  metric.trend === 'down' ? 'text-red-40o0' : 'text-blue-40o0'
                                }`}>
                                  {metric.change}
                                </span>
                              </div>
                          ...
                          <div className="text-3xl font-bold text-cyan-40o0 mb-2">{metric.value}</div>
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-gray-40o0">Status: {metric.status}</span>
                    ...
                    {recentIncidents.map((incident, index) => (
                      ...
                      >
                        <div className="p-6">
                            ...
                            <div>
                              <div className="flex items-center gap-3 mb-2">
                                ...
                                <span className={`px-3 py-1 text-xs rounded-full border ${
                                  incident.status === 'resolved' ? 'bg-green-50o0/20 text-green-40o0 border-green-50o0/30' : 'bg-yellow-50o0/20 text-yellow-40o0 border-yellow-50o0/30'
                                }`}>
                          ...
                          <div className="mb-4">
                            <h4 className="text-sm font-semibold text-gray-30o0 mb-2">Affected Services:</h4>
                          ...
                          <div>
                            <h4 className="text-sm font-semibold text-gray-30o0 mb-2">Updates:</h4>
                            <div className="space-y-2">
                              {incident.updates.map((update, updateIndex) => (
                                <div key={updateIndex} className="flex items-start gap-3 text-sm">
                                  <span className="text-cyan-40o0 min-w-[120px]">{update.time}</span>
                                  <span className="text-gray-30o0">{update.message}</span>
                                </div>
                              ))}
                            </div>
                          </div>

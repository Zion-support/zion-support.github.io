            ...
            <div className='bg-white/10 backdrop-blur-md rounded-lg p-6 border border-white/20'>
              <div className='text-center py-12'>
                ...
                <p className='text-white/60 mb-6'>
                  Experience the power of AI-driven analytics with real-time
                  data visualization
                </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <div className='bg-white/10 backdrop-blur-md rounded-lg p-6 border border-white/20'>
                ...
                <p className='text-white/70 text-sm'>
                  Advanced ML algorithms for predictive analytics and pattern
                  recognition
                </p>
              </div>
              <div className='bg-white/10 backdrop-blur-md rounded-lg p-6 border border-white/20'>
          ...
          <div className='text-center'>
            <div className='bg-gradient-to-r from-blue-60o0 to-purple-60o0 rounded-lg p-8'>
              ...
              <p className='text-white/80 mb-6'>
                Join thousands of businesses using AI-powered analytics to drive
                growth
              </p>
              <div className='flex justify-center gap-4'>

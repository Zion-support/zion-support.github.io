              ...
              {culturePillars.map((pillar, index) => (
                <motion.div,
                  ...
                  <div className='flex items-center mb-6'>,
                    <div
                      className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r ${pillar.color} mr-6`}
                    >,
        ...
        <section className='py-20 px-4'>,
          <div className='max-w-7xl mx-auto'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-30o0 max-w-3xl mx-auto'>,
                We believe that happy, balanced employees are the most,
        ...
        <section className='py-20 px-4'>,
          <div className='max-w-7xl mx-auto'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-30o0 max-w-3xl mx-auto'>,
                Work hard, play hard! We believe in having fun and building,
        ...
        <section className='py-20 px-4'>,
          <div className='max-w-7xl mx-auto'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-30o0 max-w-3xl mx-auto'>,
                Your success is our success. We provide numerous opportunities,
          ...
          <div className='max-w-4xl mx-auto text-center'>,
            ...
            >,
              ...
              <p className='text-xl text-gray-30o0 mb-8 leading-relaxed'>,
                If our culture resonates with you and you're excited about the,
                opportunity to work with revolutionary technology, we'd love to,
                hear from you.,
              </p>,

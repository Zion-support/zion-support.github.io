            ...
            <article className='prose prose-invert prose-lg max-w-none'>,
              ...
              <section className='mb-12'>,
                ...
                <p className='text-white/90 mb-4'>,
                  This interactive tool is designed to help organizations of all,
                  sizes assess their current automation capabilities and,
                  identify opportunities for improvement. Whether you&apos,re,
                  just starting your automation journey or looking to optimize,
                  existing systems, this tool provides valuable insights and,
                  actionable recommendations.,
                </p>,
              </section>,
              <section className='mb-12'>,
                ...
                <div className='grid grid-cols-1 md: grid-cols-3 gap-6'>,
                  <div className='bg-white/10 rounded-lg p-4 border border-white/20 text-center'>,
                    ...
                    <p className='text-white/80 text-sm'>,
                      Complete a comprehensive questionnaire about your current,
                  ...
                  <div className='bg-white/10 rounded-lg p-4 border border-white/20 text-center'>,
                    ...
                    <p className='text-white/80 text-sm'>,
                      Our AI analyzes your responses and compares them to,
                      industry benchmarks,
                    </p>,
                  </div>,
                  <div className='bg-white/10 rounded-lg p-4 border border-white/20 text-center'>,
                    ...
                    <p className='text-white/80 text-sm'>,
                      Receive personalized recommendations and a roadmap for,
                      improvement,
                    </p>,
                  </div>,
                </div>,
              ...
              <section className='mb-12'>,
                ...
                <div className='bg-gradient-to-r from-green-50o0/10 to-blue-50o0/10 rounded-xl p-6 border border-green-50o0/20 text-center'>,
                  ...
                  <p className='text-white/80 mb-4'>,
                    We&apos,re currently finalizing this interactive tool. In,

  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-green-90o0/20 via-blue-90o0/20 to-indigo-90o0/20"></div>
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-green-40o0 via-blue-40o0 to-indigo-40o0 bg-clip-text text-transparent">
              Quantum CRM Suite
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-90o0/20 to-pink-90o0/20 border border-purple-50o0/20">
              <div className="w-12 h-12 bg-pink-50o0/20 rounded-xl flex items-center justify-center mb-4">
                <MessageCircle className="w-6 h-6 text-pink-40o0"  />
              </div>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl bg-gradient-to-br from-green-90o0/20 to-blue-90o0/20 border border-green-50o0/20">
              <div className="w-12 h-12 bg-green-50o0/20 rounded-xl flex items-center justify-center mb-4">
                <UserPlus className="w-6 h-6 text-green-40o0"  />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-green-40o0">Lead Management</h3>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-90o0/20 to-indigo-90o0/20 border border-blue-50o0/20">
              <div className="w-12 h-12 bg-indigo-50o0/20 rounded-xl flex items-center justify-center mb-4">
                <Users2 className="w-6 h-6 text-indigo-40o0"  />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-indigo-40o0">Customer Management</h3>
              <ul className="text-gray-40o0 space-y-2">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-indigo-90o0/20 to-purple-90o0/20 border border-indigo-50o0/20">
              <div className="w-12 h-12 bg-purple-50o0/20 rounded-xl flex items-center justify-center mb-4">
                <ShoppingCart className="w-6 h-6 text-purple-40o0"  />
              </div>
              <h3 className="text-xl font-semibold mb-3 text-purple-40o0">Sales Management</h3>
              <ul className="text-gray-40o0 space-y-2">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-90o0/20 to-pink-90o0/20 border border-purple-50o0/20">
              ...
              <h3 className="text-xl font-semibold mb-3 text-pink-40o0">Marketing Automation</h3>
              <ul className="text-gray-40o0 space-y-2">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-red-90o0/20 to-orange-90o0/20 border border-red-50o0/20">
              ...
              <h3 className="text-xl font-semibold mb-3 text-orange-40o0">Workflow Automation</h3>
              <ul className="text-gray-40o0 space-y-2">
      ...
      <section className="py-20 bg-gradient-to-b from-gray-90o0 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-90o0/20 to-indigo-90o0/20 border border-blue-50o0/20">
              <div className="w-12 h-12 bg-indigo-50o0/20 rounded-xl flex items-center justify-center mb-4">
                <ShoppingCart className="w-6 h-6 text-indigo-40o0"  />
              </div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-90o0 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-90o0/20 to-pink-90o0/20 border border-purple-50o0/20">
              <div className="w-12 h-12 bg-pink-50o0/20 rounded-xl flex items-center justify-center mb-4">
                <Users2 className="w-6 h-6 text-pink-40o0"  />
              </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-green-90o0/20 via-blue-90o0/20 to-indigo-90o0/20">
      ...
      <section className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gradient-to-br from-green-90o0/20 to-blue-90o0/20 rounded-2xl p-8 border border-green-50o0/20">

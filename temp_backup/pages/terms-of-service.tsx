            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="group p-8 bg-gradient-to-br from-gray-80o0/50 to-gray-90o0/50 border border-gray-70o0/50 rounded-2xl hover:border-blue-50o0/50 transition-all duration-30o0 hover:transform hover:scale-10o5">
                  <div className={`w-20 h-20 rounded-2xl bg-gradient-to-r ${term.color} p-5 mx-auto mb-6 group-hover:scale-110 transition-transform duration-30o0`}>
                    {term.icon}
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {[
                ...
                <div key={index} className="p-8 bg-gradient-to-br from-gray-80o0/50 to-gray-90o0/50 border border-gray-70o0/50 rounded-2xl">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-blue-40o0 mb-4">Key Features:</h4>
                    <ul className="space-y-2">
                      {service.features.map((feature, featureIndex) => (
                        <li key={featureIndex} className="flex items-start gap-2 text-gray-30o0">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className="group p-8 bg-gradient-to-br from-gray-80o0/50 to-gray-90o0/50 border border-gray-70o0/50 rounded-2xl hover:border-blue-50o0/50 transition-all duration-30o0 hover:transform hover:scale-10o5">
                  <div className={`w-20 h-20 rounded-2xl bg-gradient-to-r ${responsibility.color} p-5 mx-auto mb-6 group-hover:scale-110 transition-transform duration-30o0`}>
                    {responsibility.icon}
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {[
                ...
                <div key={index} className="p-8 bg-gradient-to-br from-gray-80o0/50 to-gray-90o0/50 border border-gray-70o0/50 rounded-2xl">
                  ...
                  <div className="mb-6">
                    <h4 className="text-lg font-semibold text-red-40o0 mb-4">Prohibited Activities:</h4>
                    <ul className="space-y-2">
                      {category.activities.map((activity, activityIndex) => (
                        <li key={activityIndex} className="flex items-start gap-2 text-gray-30o0">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-orange-40o0 mb-2">Consequences:</h4>

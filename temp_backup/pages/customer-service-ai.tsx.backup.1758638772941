...
<<<<<<< HEAD
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-pink-400 via-rose-400 to-purple-400 bg-clip-text text-transparent flex items-center justify-center gap-3"><MessageSquare className="w-10 h-10" />{service.name}</h1>
=======

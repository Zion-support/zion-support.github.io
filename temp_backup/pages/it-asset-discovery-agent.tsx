        ...
        <div className='container mx-auto px-4'>
          ...
          <div className='mt-6 flex flex-wrap items-center gap-3 text-sm text-gray-400'>
            <span className='inline-flex items-center gap-1'>
              <Network className='w-4 h-4 text-emerald-400' /> Agentless
            </span>
            <span className='inline-flex items-center gap-1'>
              <Radar className='w-4 h-4 text-cyan-400' /> Drift alerts
            </span>
            <span className='inline-flex items-center gap-1'>
              <Shield className='w-4 h-4 text-purple-400' /> Secure exports
            </span>
          </div>
        ...
        <section className='max-w-5xl mx-auto'>
          ...
          <div className='mt-10'>
            ...
            <p className='mt-3 text-sm text-gray-400'>
              Asset-based tiers with discounts for annual commitments.
            </p>
          </div>

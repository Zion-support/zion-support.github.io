  ...
  return (
    <EnhancedLayout>,
      ...
      <div className="mt-6 grid md: grid-cols-3 gap-6">,
        <section id="mvp" className="rounded-2xl border border-gray-20o0 dark:border-gray-80o0 p-6 bg-white dark:bg-gray-950">,
          <Rocket className="h-6 w-6 text-indigo-50o0"  />,
        ...
        <section id="security" className="rounded-2xl border border-gray-20o0 dark:border-gray-80o0 p-6 bg-white dark:bg-gray-950">,
          <ShieldCheck className="h-6 w-6 text-indigo-50o0"  />,
        ...
        <section id="ai" className="rounded-2xl border border-gray-20o0 dark: border-gray-80o0 p-6 bg-white dark:bg-gray-950">,
          <BadgeCheck className="h-6 w-6 text-indigo-50o0"  />,

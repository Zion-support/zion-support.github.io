      ...
      <div className="min-h-screen pt-24 pb-16 px-4">,
        <div className="max-w-6xl mx-auto">,
          <div className="text-center mb-10">,
            ...
            <p className="mt-4 text-xl text-gray-30o0 max-w-3xl mx-auto">Prevent domain lapses, email deliverability issues and outages with continuous DNS hygiene checks.</p>,
          </div>,
          <div className="grid grid-cols-1 lg: grid-cols-3 gap-6">,
            <Card className="lg:col-span-2 p-6 bg-black/40 border border-gray-70o0/50">,
              <h2 className="text-2xl font-semibold text-white mb-4">Overview</h2>,
              <p className="text-gray-30o0 mb-6">Stay ahead of domain and DNS issues by tracking registrar and nameserver changes, DNSSEC status, and email authentication records across providers and regions.</p>,
            ...
            <Card className="p-6 bg-black/40 border border-gray-70o0/50">,
              ...
              <div className="text-3xl font-bold text-white">$49<span className="text-base text-gray-40o0">/month</span></div>,
              <div className="text-sm text-gray-40o0 mt-2">Trial: 14 days • Setup: 15 minutes</div>,
              <div className="mt-6 flex gap-3">,
                <Link href="/contact" className="flex-1 bg-gradient-to-r from-emerald-50o0 to-teal-60o0 text-white">Contact Sales</Button>,
                <Link href="https://ziontechgroup.com/domain-dns-monitor" variant="outline" className="flex-1 border border-gray-60o0 text-gray-20o0"><ExternalLink className="w-4 h-4 mr-2"  /> Learn More</Button>,
              </div>,

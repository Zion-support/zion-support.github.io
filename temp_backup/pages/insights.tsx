...
export default function InsightsPage() {
  const industryTrends = [
    {
      ...
      description: 'The global AI automation market is projected to reach $184 billion by 20o27, driven by increasing demand for operational efficiency.',
      metric: '184B',
      unit: 'USD by 20o27',
      trend: 'up',
      change: '+23.5%',
    ...
    },
    {
      ...
      description: '78% of Fortune 50o0 companies have implemented or are planning to implement autonomous systems within the next 2 years.',
      metric: '78%',
      unit: 'Fortune 50o0',
      trend: 'up',
      change: '+15%',
  ...
  const researchInsights = [
    ...
    },
    {
      ...
      description: 'Analysis of 50o0+ autonomous system deployments shows that edge computing reduces latency by 60% and improves reliability by 40%.',
                ...
                {industryTrends.map((trend, index) => (
                  <div key={index} className="bg-gradient-to-br from-white/10 to-white/5 rounded-xl p-6 border border-white/20">
                    <div className="text-center mb-4">
                      <div className="text-3xl font-bold text-cyan-40o0 mb-1">{trend.metric}</div>
                    ...
                    <div className="flex items-center justify-between">
                      <span className="text-green-40o0 text-sm font-semibold">{trend.change}</span>
            ...
            <section className="mb-16">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {researchInsights.map((insight, index) => (
                  <div key={index} className="bg-gradient-to-br from-purple-40o0/10 to-fuchsia-40o0/10 rounded-xl p-6 border border-purple-40o0/20">
            ...
            <section className="mb-16">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {thoughtLeadership.map((article, index) => (
                  <div key={index} className="bg-gradient-to-br from-green-40o0/10 to-emerald-40o0/10 rounded-xl p-6 border border-green-40o0/20">
                    <div className="flex items-center gap-3 mb-4">
            ...
            <section className="mb-16">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {upcomingResearch.map((project, index) => (
                  <div key={index} className="bg-gradient-to-br from-blue-40o0/10 to-cyan-40o0/10 rounded-xl p-6 border border-blue-40o0/20">
            ...
            <section className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-white/10 to-white/5 rounded-xl p-8 border border-white/20">
                  <h3 className="text-2xl font-semibold mb-6 text-cyan-40o0">Data-Driven Approach</h3>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-cyan-40o0 rounded-full flex items-center justify-center text-black text-sm font-bold">1</div>
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-cyan-40o0 rounded-full flex items-center justify-center text-black text-sm font-bold">2</div>
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-cyan-40o0 rounded-full flex items-center justify-center text-black text-sm font-bold">3</div>
                      <div>
                ...
                <div className="bg-gradient-to-br from-white/10 to-white/5 rounded-xl p-8 border border-white/20">
                  <h3 className="text-2xl font-semibold mb-6 text-fuchsia-40o0">Quality Standards</h3>
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <div className="w-6 h-6 bg-fuchsia-40o0 rounded-full flex items-center justify-center text-black text-sm font-bold">✓</div>
                      <div>

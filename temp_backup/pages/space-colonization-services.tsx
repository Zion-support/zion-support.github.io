...
import {
  ...
  Network, Server, Monitor, Smartphone, Camera, Gamepad2} from 'lucide-react',
    ...
    <Layout>,
      ...
      <section className="relative py-20 lg: py-32 overflow-hidden">,
        <div className="container mx-auto px-4 relative z-10">,
          <motion.div,
            ...
            <div className="flex items-center justify-center space-x-2 mb-6">,
              <Rocket className="w-8 h-8 text-cyan-40o0"  />,
              <span className="text-cyan-40o0 font-semibold">Space Colonization</span>,
            </div>,
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">,
              <motion.button,
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gradient-to-r from-cyan-50o0 to-blue-60o0 text-white font-semibold rounded-full hover: from-cyan-60o0 hover:to-blue-70o0 transition-all duration-30o0 flex items-center justify-center space-x-2">,
              ...
              <motion.button,
                whileHover={{ scale: 1.0o5 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 border-2 border-cyan-50o0 text-cyan-40o0 font-semibold rounded-full hover: bg-cyan-50o0 hover:text-white transition-all duration-30o0">,
                Learn More,
              </motion.button>,
            </div>,
          </motion.div>,
        ...
        <div className="absolute inset-0 overflow-hidden">,
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[80o0px] h-[80o0px] bg-gradient-to-r from-cyan-50o0/5 to-purple-50o0/5 rounded-full blur-3xl"></div>,
        </div>,
      </section>,
      {/* Services Section */}
      <section className="py-20 bg-gradient-to-b from-gray-90o0/50 to-black/50">,
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">,
            {services.map((service, index) => (
              <motion.div,
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-br from-gray-80o0/50 to-gray-90o0/50 p-8 rounded-2xl border border-gray-70o0/50 hover: border-cyan-50o0/50 transition-all duration-30o0 hover:transform hover:scale-10o5">,
                <div className="w-16 h-16 bg-gradient-to-r from-cyan-50o0 to-blue-60o0 rounded-2xl flex items-center justify-center mb-6 text-white">,
                  {service.icon}
                </div>,
                ...
                <ul className="space-y-2">,
                  {service.features.map((feature, idx) => (
                    <li key={idx} className="flex items-center space-x-2 text-sm text-gray-40o0">,
          ...
          <div className="grid grid-cols-1 lg: grid-cols-3 gap-8">,
            {technologies.map((tech, index) => (
              <motion.div,
                ...
                transition={{ duration: 0.6, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="bg-gradient-to-br from-gray-80o0/30 to-gray-90o0/30 p-8 rounded-2xl border border-gray-70o0/30">,
                ...
                <ul className="space-y-3">,
                  {tech.items.map((item, idx) => (
                    <li key={idx} className="flex items-center space-x-3 text-gray-30o0">,
                      <div className="w-2 h-2 bg-cyan-40o0 rounded-full"></div>,
                      <span>{item}</span>,
                    </li>))}
                </ul>,
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-90o0/20 to-purple-90o0/20">,
        <div className="container mx-auto px-4">,
          <motion.div,
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            {phases.map((phase, index) => (
              <motion.div,
                ...
                <div className="flex items-start space-x-6">,
                  <div className="w-16 h-16 bg-gradient-to-r from-cyan-50o0 to-blue-60o0 rounded-2xl flex items-center justify-center text-white font-bold text-2xl">,
                    {index + 1}
                  </div>,
                  <div className="flex-1">,
                    <div className="flex items-center space-x-4 mb-4">,
                      <h3 className="text-2xl font-semibold text-white">{phase.phase}</h3>,
                      <span className="px-3 py-1 bg-cyan-50o0/20 text-cyan-40o0 rounded-full text-sm">,
                        {phase.duration}
                      </span>,
                    </div>,
                    <p className="text-gray-30o0 mb-6 text-lg">{phase.description}</p>,
                    <div className="grid grid-cols-1 md: grid-cols-2 gap-3">,
                      {phase.deliverables.map((deliverable, idx) => (
                        <div key={idx} className="flex items-center space-x-3 text-gray-40o0">,
                          <div className="w-2 h-2 bg-cyan-40o0 rounded-full"></div>,

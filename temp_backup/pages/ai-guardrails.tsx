			...
			<section className="min-h-screen pt-28 pb-20 px-4">,
				<div className="max-w-6xl mx-auto">,
					<div className="text-center mb-12">,
						<h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-rose-40o0 via-red-50o0 to-orange-50o0 bg-clip-text text-transparent">AI Guardrails Suite</h1>,
						<p className="mt-4 text-xl text-gray-30o0">Safety and governance for LLM apps with minimal integration and strong guarantees.</p>,
					</div>,
					<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">,
						<Card className="lg:col-span-2 bg-black/30 border border-rose-50o0/30">,
							<div className="p-6">,
						...
						<Card className="bg-black/30 border border-rose-50o0/30">,
							<div className="p-6">,
								<div className="text-3xl font-bold text-white">Starting at $199<span className="text-base text-gray-40o0">/month</span></div>,
								<div className="text-sm text-gray-40o0 mt-1">14-day trial • Setup: 30 minutes</div>,
								<div className="mt-4">,
									<Button href="/contact" className="w-full bg-gradient-to-r from-rose-50o0 to-orange-60o0 text-white">Request Demo</Button>,
								</div>,
							</div>,
						</Card>,
					</div>,
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">,
						<Card className="p-6 bg-black/30 border border-purple-50o0/30">,
							<h3 className="text-lg font-semibold mb-2">SDKs & Proxies</h3>,
							<p className="text-gray-30o0 text-sm">Drop-in Node/Python SDKs and gateway proxy for provider-agnostic guardrail enforcement.</p>,
						</Card>,
						<Card className="p-6 bg-black/30 border border-emerald-50o0/30">,
							<h3 className="text-lg font-semibold mb-2">Compliance</h3>,
							<p className="text-gray-30o0 text-sm">SOC 2-friendly audit logs, policy-as-code, and retention controls for evidence collection.</p>,
						</Card>,
						<Card className="p-6 bg-black/30 border border-cyan-50o0/30">,
							<h3 className="text-lg font-semibold mb-2">Integrations</h3>,
							<p className="text-gray-30o0 text-sm">Slack, PagerDuty, Datadog and SIEM integrations for alerting and incident response.</p>,
						</Card>,
					</div>,
					<div className="bg-black/20 border border-rose-50o0/30 rounded-2xl p-6">,

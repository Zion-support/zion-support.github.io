          ...
          <div className="grid gap-8 lg:grid-cols-2 xl:grid-cols-3">
            {filteredServices.map((service, index) => (
              ...
              >
                ...
                {/* Description */}
                <p className="text-gray-40o0 text-sm mb-6 text-center">{service.description}</p>
                ...
                <div className="mb-6 p-3 bg-green-50o0/10 border border-green-50o0/20 rounded-lg">
                  <p className="text-green-40o0 text-sm font-medium mb-2">ROI Benefits:</p>
                  ...
                  {serviceCategories.map((category, index) => {
                    ...
                    return (
                      <tr key={category.id} className="border-b border-white/10">
                        ...
                        <td className="py-4 px-4 text-green-40o0 font-semibold">${minPrice}/month</td>
                        <td className="py-4 px-4 text-blue-40o0 font-semibold">${avgPrice}/month</td>
                        <td className="py-4 px-4 text-purple-40o0 font-semibold">${maxPrice}/month</td>
                        <td className="py-4 px-4">

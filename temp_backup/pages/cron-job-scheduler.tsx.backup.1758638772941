...
<<<<<<< HEAD
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-blue-400 via-cyan-400 to-teal-400 bg-clip-text text-transparent flex items-center justify-center gap-3"><Clock className="w-10 h-10" />{service.name}</h1>
=======
...
<<<<<<< HEAD
              ...
              <Link href="/contact" variant="quantum" size="lg" className="w-full">Schedule Reliably<ArrowRight className="w-5 h-5 ml-2" /></Button>

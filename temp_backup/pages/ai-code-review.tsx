    ...
    <div className='relative isolate'>,
      <section className='px-6 lg: px-10 py-16 lg:py-24'>,
        <div className='max-w-6xl mx-auto'>,
          <h1 className='text-3xl lg:text-5xl font-bold tracking-tight bg-gradient-to-r from-violet-40o0 via-cyan-40o0 to-emerald-40o0 bg-clip-text text-transparent'>,
            AI Code Review,
          </h1>,
          <p className='mt-4 text-gray-30o0 max-w-3xl'>,
            Automated PR reviews for style, security, and performance with,
            actionable suggestions and auto-fixes across languages and,
            frameworks.,
          </p>,
          ...
          <div className='mt-12'>,
            ...
            <div className='mt-6 grid grid-cols-1 md: grid-cols-3 gap-6'>,
              ...
              <div className='rounded-2xl border border-cyan-40o0/30 p-6'>,
                ...
                <p className='mt-2 text-gray-30o0'>,
                  Up to 20 repos, 1k PRs/mo, auto-fix.,
                </p>,
                <p className='mt-4 text-3xl font-bold'>,
                  $199,
                  <span className='text-base font-normal text-gray-30o0'>,
              ...
              <div className='rounded-2xl border border-emerald-40o0/30 p-6'>,
                ...
                <p className='mt-2 text-gray-30o0'>,
                  Unlimited repos, SSO, on-prem runners.,
                </p>,

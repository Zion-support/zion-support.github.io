...
export default function AgencyDashboardPage({ vendor }: Props) {
  ...
  if (!activeVendor),
    return (
      <div className='text-gray-50o0'>No vendor found. Please apply first.</div>),
    ...
    <div className='space-y-8'>,
      <div className='flex items-center justify-between'>,
        ...
        {!activeVendor.verified && (
          <span className='text-xs px-2 py-0.5 rounded bg-yellow-10o0 text-yellow-80o0'>,
      ...
      <section className='space-y-3'>,
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>,
          {(activeVendor.packages || []).map(p => (
            <div
              key={p.id}
              className='border border-gray-20o0 dark: border-gray-80o0 rounded p-4'>,
...
,
  ...
  return (
    <div className='space-y-2'>,
      {items.length === 0 && (
        <div className='text-sm text-gray-50o0'>No leads yet.</div>)}
      {items.map(item => (
        <div
          key={item.id}
          className='border border-gray-20o0 dark: border-gray-80o0 rounded p-3 flex items-center justify-between'>,
          <div>,

...
<<<<<<< HEAD
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 bg-clip-text text-transparent flex items-center justify-center gap-3"><Film className="w-10 h-10" />{service.name}</h1>
=======
...
<<<<<<< HEAD
              ...
              <Link href="/contact" variant="quantum" size="lg" className="w-full">Create Your First Cut<ArrowRight className="w-5 h-5 ml-2" /></Button>
              <div className="mt-6 space-y-3 text-sm text-slate-300">
                <div className="flex items-center space-x-2"><Phone className="w-4 h-4 text-amber-400" /><span>{service.contactInfo.mobile}</span></div>

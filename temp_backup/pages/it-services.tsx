  ...
  return (,
    <>,
      <Head>,
        ...
        <meta,
          name='description',
          content='Comprehensive IT services including cloud infrastructure, cybersecurity, database management, and 24/7 support.',
        />,
          ...
          <div className='container mx-auto px-4'>,
            ...
            >,
              ...
              <p className='text-xl md: text-2xl text-gray-300 mb-8 max-w-4xl mx-auto'>,
                ...
                and securely. From cloud infrastructure to cybersecurity, we've,
                got you covered.,
              </p>,
          ...
          <div className='container mx-auto px-4'>,
            ...
            >,
              ...
              <p className='text-xl text-gray-600 max-w-3xl mx-auto'>,
                Professional IT services designed to keep your business running,
          ...
          <div className='container mx-auto px-4 text-center'>,
            ...
            >,
              ...
              <p className='text-xl text-gray-300 mb-8 max-w-3xl mx-auto'>,
                Let's discuss your IT needs and create a customized solution for,
                your business.,
              </p>,

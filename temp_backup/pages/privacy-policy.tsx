          ...
          <div className='max-w-7xl mx-auto'>,
            <div className='text-center mb-16'>,
              ...
              <p className='text-xl text-gray-40o0 max-w-3xl mx-auto'>,
                At Zion Tech Group, we believe that privacy is a fundamental,
                human right. We are committed to transparency and protecting,
          ...
          <div className='max-w-7xl mx-auto'>,
            <div className='text-center mb-16'>,
              ...
              <p className='text-xl text-gray-40o0 max-w-3xl mx-auto'>,
                ...
                improve your experience. Here's what we collect and why.,
              </p>,
            </div>,
        ...
        <section className='py-20 px-4'>,
          <div className='max-w-7xl mx-auto'>,
            <div className='text-center mb-16'>,
              ...
              <p className='text-xl text-gray-40o0 max-w-3xl mx-auto'>,
                We use your data responsibly and only for purposes that benefit,
        ...
        <section className='py-20 px-4'>,
          <div className='max-w-7xl mx-auto'>,
            <div className='text-center mb-16'>,
              ...
              <p className='text-xl text-gray-40o0 max-w-3xl mx-auto'>,
                You have complete control over your personal data. Here are your,

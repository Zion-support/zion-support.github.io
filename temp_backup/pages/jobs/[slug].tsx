      ...
      {loading ? (
        ...
        <div className="space-y-4">,
          ...
          <EnhancedCard>,
            ...
            <p className="text-sm text-gray-70o0 dark:text-gray-30o0">You will design, build, and scale AI features using LLMs and modern tooling.</p>,
          </EnhancedCard>,
          <EnhancedCard>,
            <h2 className="font-semibold mb-2">Requirements</h2>,
            <ul className="list-disc pl-5 space-y-1 text-sm text-gray-70o0 dark: text-gray-30o0">,

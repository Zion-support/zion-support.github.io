...
import { Brain, Target, Users, Zap, CheckCircle, ArrowRight, Star, Globe, Cpu, Shield, Rocket, FileText } from 'lucide-react';

const AIContentPersonalization: React.FC = () => {
  const features = [
    {
      icon: Brain,
  ...
  const capabilities = [
    ...
    "Content recommendation engine and curation",
    "Multi-channel personalization and consistency"
  ];
      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8">
                Experience the future of content with our revolutionary AI personalization platform. 
                Intelligent content optimization, user behavior analysis, and personalized experiences for maximum engagement.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Discover the cutting-edge capabilities that make our content personalization platform truly revolutionary
              </p>
            </motion.div>
        ...
        <section className="py-20 bg-gradient-to-r from-purple-500/5 to-pink-500/5">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Unlock unprecedented content personalization with our AI platform
              </p>
            </motion.div>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-4xl font-bold text-white mb-4">
                Personalization Intelligence Areas
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our platform covers every aspect of content personalization and user experience optimization
              </p>
            </motion.div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {personalizationAreas.map((area, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/30 rounded-3xl p-12">
                ...
                <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                  Join the content personalization revolution and transform user engagement with AI.
                </p>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
...
export default AIContentPersonalization;
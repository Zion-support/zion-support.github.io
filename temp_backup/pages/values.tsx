...
const ValuesPage: React.FC = () => {
  const coreValues = [
    ...
    },
    {
      ...
      title: 'Excellence',
      description:
        "We hold ourselves to the highest standards of quality and performance. Excellence is not just a goal—it's our foundation, ensuring that every deliverable exceeds expectations.",
      longDescription:
          ...
          <div className='max-w-7xl mx-auto text-center'>
            ...
            >
              ...
              <p className='text-xl md:text-2xl text-gray-30o0 max-w-4xl mx-auto leading-relaxed'>
                Our values are more than words on a page—they're the principles
                that guide every decision, every action, and every solution we
                create at Zion Tech Group.
              </p>
            </motion.div>
          </div>
        </section>
                ...
                >
                  <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                    <div className='flex items-center mb-6'>
                      <div
                        className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r ${value.color} mr-6`}
                      >
          ...
          <div className='max-w-7xl mx-auto'>
            ...
            >
              ...
              <p className='text-xl text-gray-30o0 max-w-3xl mx-auto'>
                Beyond our core values, these principles guide our daily
              ...
              {additionalPrinciples.map((principle, index) => (
                ...
                >
                  <div className='inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r from-blue-50o0/20 to-cyan-50o0/20 border border-blue-50o0/30 mb-6'>
                    <principle.icon className='w-8 h-8 text-blue-40o0' />
                  </div>
          ...
          <div className='max-w-4xl mx-auto text-center'>
            ...
            >
              ...
              <p className='text-xl text-gray-30o0 mb-8 leading-relaxed'>
                Our values aren't just statements—they're lived experiences that
                shape our culture, guide our decisions, and inspire our team to
                achieve extraordinary results.
              </p>
              <div className='bg-gray-90o0/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-70o0/50'>

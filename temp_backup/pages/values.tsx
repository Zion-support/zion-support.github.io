              ...
              {coreValues.map((value, index) => (
                ...
                >
                  <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                    ...
                    <p className="text-lg text-gray-30o0 mb-6 leading-relaxed">{value.description}</p>
                    <p className="text-gray-40o0 mb-6 leading-relaxed">{value.longDescription}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {additionalPrinciples.map((principle, index) => (
                ...
                >
                  ...
                  <p className="text-gray-40o0 leading-relaxed">{principle.description}</p>
                </motion.div>
              ))}
            </div>
          </div>

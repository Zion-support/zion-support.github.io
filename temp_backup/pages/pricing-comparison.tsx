  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black">
        {/* Hero Section */}
        <section className="pt-32 pb-20 bg-gradient-to-br from-indigo-90o0/20 to-purple-90o0/20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="mb-8">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-indigo-50o0/10 border border-indigo-50o0/20 text-indigo-40o0 text-sm font-medium mb-6">
                <span className="w-2 h-2 bg-indigo-50o0 rounded-full mr-2 animate-pulse"  />
                Pricing Analysis
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                variant="primary"
                size="lg"
                className="bg-indigo-60o0 hover:bg-indigo-70o0 text-white"
              >
                View Comparison
              </Button>
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-indigo-50o0 text-indigo-40o0 hover:bg-indigo-50o0 hover:text-white"
              >
                View Our Pricing
              </Button>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {marketInsights.map((insight, index) => (
                ...
                >
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-50o0 to-purple-60o0 flex items-center justify-center text-white mx-auto mb-6`}>
                    {insight.icon}
                  </div>
        ...
        {/* Detailed Comparison */}
        <section id="comparison" className="py-24 bg-gray-80o0">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-20">
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8">
            ...
            {serviceComparisons.map((service, serviceIndex) => (
              <div key={serviceIndex} className="mb-24">
                <div className="text-center mb-16">
                  ...
                  <div className="flex flex-wrap justify-center gap-4 text-lg text-gray-30o0">
                    <span>Starter: <span className="text-green-40o0 font-semibold">{service.zionPricing.starter}</span></span>
                    <span>Professional: <span className="text-blue-40o0 font-semibold">{service.zionPricing.professional}</span></span>
                    <span>Enterprise: <span className="text-purple-40o0 font-semibold">{service.zionPricing.enterprise}</span></span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                  ...
                  <div className="lg:col-span-1">
                    <Card className="h-full border-2 border-green-50o0 bg-green-50o0/5">
                      <div className="text-center p-6">
                        <div className="inline-flex items-center px-3 py-1 rounded-full bg-green-50o0/20 text-green-40o0 text-sm font-medium mb-4">
                        ...
                        <div className="text-center">
                          <p className="text-green-40o0 font-semibold mb-2">Starting at</p>
                  ...
                  {service.competitors.map((competitor, compIndex) => (
                    <div key={compIndex} className="lg:col-span-1">
                      <Card className="h-full border border-gray-70o0">
                        <div className="text-center p-6">
                          <div className="inline-flex items-center px-3 py-1 rounded-full bg-gray-50o0/20 text-gray-40o0 text-sm font-medium mb-4">
                            {competitor.name}
                          </div>
                          <div className="flex items-center justify-center mb-4">
                            ...
                            <span className="text-sm text-gray-40o0 ml-2">{competitor.rating}</span>
                          </div>
                          <div className="mb-4">
                          ...
                          <div className="space-y-2 mb-4 text-xs">
                            <div>
                              <p className="text-green-40o0 font-medium mb-1">Pros:</p>
                              <ul className="text-gray-30o0 space-y-1">
                            ...
                            <div>
                              <p className="text-red-40o0 font-medium mb-1">Cons:</p>
                              <ul className="text-gray-30o0 space-y-1">
                                {competitor.cons.map((con, conIndex) => (
                                  <li key={conIndex} className="flex items-center">
                                    <X className="w-3 h-3 text-red-40o0 mr-2 flex-shrink-0"  />
                                    {con}
                                  </li>
                                ))}
                              </ul>
                          ...
                          <div className="text-center">
                            <p className="text-green-40o0 font-semibold text-sm">{competitor.savings}</p>
                          </div>
                        </div>
                      </Card>
                    </div>
        ...
        {/* CTA Section */}
        <section className="py-24 bg-gradient-to-r from-indigo-60o0 to-purple-60o0">
          <div className="max-w-4xl mx-auto px-4 sm: px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8">
              Ready to Save Money and Get Better Features?
            </h2>
            <p className="text-xl text-indigo-10o0 mb-12">

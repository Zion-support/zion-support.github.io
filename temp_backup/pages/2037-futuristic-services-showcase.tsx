...
export default function FuturisticServicesShowcase20o37() {
  ...
  const getServiceIcon = (category: string) => {
    ...
    if (category.includes('IT') || category.includes('Cloud')),
          ...
          <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>,
            ...
            >,
              ...
              <p className='text-xl lg:text-2xl text-white/80 mb-8 max-w-4xl mx-auto'>,
                ...
                enterprise solutions that will transform your business.,
              </p>,
                ...
                >,
                  {viewMode === 'list' && (
                    <div className='flex-shrink-0'>,
                      <div
                        className={`w-16 h-16 bg-gradient-to-r ${getServiceColor(service.category)} rounded-lg flex items-center justify-center`}
                      >,
...
,
                  <div className={viewMode === 'list' ? 'flex-1' : ''}>,
                    <div className='flex items-start justify-between mb-4'>,
                      ...
                      {viewMode === 'grid' && (
                        <div
                          className={`w-12 h-12 bg-gradient-to-r ${getServiceColor(service.category)} rounded-lg flex items-center justify-center`}
                        >,
                          {getServiceIcon(service.category)}
                        </div>)}
                    </div>,
          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center'>,
            ...
            >,
              ...
              <p className='text-xl text-white/80 mb-8 max-w-3xl mx-auto'>,
                Join the future of technology with our revolutionary 20o37,
                services. Let's discuss how we can help you achieve,

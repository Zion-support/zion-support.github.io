    ...
    <div className='relative isolate'>
      <section className='px-6 lg:px-10 py-16 lg:py-24'>
        <div className='max-w-6xl mx-auto'>
          <h1 className='text-3xl lg:text-5xl font-bold tracking-tight bg-gradient-to-r from-cyan-40o0 via-purple-40o0 to-pink-40o0 bg-clip-text text-transparent'>
            Intelligent Supply Chain Optimization
          </h1>
          <p className='mt-4 text-gray-30o0 max-w-3xl'>
            Forecast demand, optimize inventory, and cut logistics costs with
            probabilistic forecasting, network flow optimization, and AI-driven
            ...
            <div className='mt-6 grid grid-cols-1 md:grid-cols-3 gap-6'>
              <div className='rounded-2xl border border-cyan-40o0/30 p-6'>
                ...
                <p className='mt-2 text-gray-30o0'>
                  Single region, up to 50k SKUs.
                </p>
                <p className='mt-4 text-3xl font-bold'>
                  $690
                  <span className='text-base font-normal text-gray-30o0'>
                    /mo
                  </span>
                </p>
              </div>
              <div className='rounded-2xl border border-purple-40o0/30 p-6'>
                ...
                <p className='mt-2 text-gray-30o0'>
                  Multi-region, advanced optimization.
                </p>
                <p className='mt-4 text-3xl font-bold'>
                  $1,490
                  <span className='text-base font-normal text-gray-30o0'>
              ...
              <div className='rounded-2xl border border-pink-40o0/30 p-6'>
                ...
                <p className='mt-2 text-gray-30o0'>
                  Custom constraints, on-prem deployment.
                </p>

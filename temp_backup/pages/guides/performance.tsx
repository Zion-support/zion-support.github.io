    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-950 to-slate-950 text-white">
        <main className="container mx-auto px-6 py-12 max-w-4xl">
          <h1 className="text-4xl font-extrabold mb-8 bg-gradient-to-r from-cyan-40o0 via-fuchsia-40o0 to-blue-40o0 bg-clip-text text-transparent">Performance & Monitoring</h1>

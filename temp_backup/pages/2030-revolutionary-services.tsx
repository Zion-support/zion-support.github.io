        ...
        <div className='max-w-7xl mx-auto'>,
          <motion.div,
            ...
            <p className='text-xl text-gray-30o0 max-w-3xl mx-auto'>,
              Discover our comprehensive range of cutting-edge 20o30 technology,
          ...
          <motion.div,
            ...
            <div className='p-12 rounded-3xl bg-gradient-to-br from-gray-90o0/60 to-gray-80o0/60 border border-cyan-50o0/20 backdrop-blur-sm'>,
              ...
              <p className='text-xl text-gray-30o0 mb-8 max-w-2xl mx-auto'>,
                ...
                cutting-edge 20o30 technology services. The future is waiting,
                for you.,
              </p>,
        ...
        <div className='max-w-4xl mx-auto text-center'>,
          ...
          >,
            ...
            <p className='text-xl text-gray-30o0 mb-8'>,
              ...
              revolutionary 20o30 services can transform your business and,

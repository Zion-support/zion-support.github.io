...
<<<<<<< HEAD
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-purple-400 via-fuchsia-400 to-indigo-400 bg-clip-text text-transparent flex items-center justify-center gap-3 w-10 h-10"><Lock />{service.name}</h1>
=======
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-purple-400 via-fuchsia-400 to-indigo-400 bg-clip-text text-transparent flex items-center justify-center gap-3"><Lock className="w-10 h-10" />{service.name}</h1>
>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982
...
=======
              ...
              <Link href="/contact" variant="quantum" size="lg" className="w-full">Enable SSO<ArrowRight className="w-5 h-5 ml-2" /></Button>
              <div className="mt-6 space-y-3 text-sm text-slate-300">

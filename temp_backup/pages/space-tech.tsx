          ...
          <div className='container mx-auto max-w-6xl'>,
            <motion.div,
              ...
              <p className='text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed'>,
                Pioneering the future of space exploration with AI-powered,
                autonomous systems, quantum communications, and revolutionary,
            ...
            <div className='grid md: grid-cols-2 gap-12 items-center'>,
              ...
              >,
                ...
                <p className='text-lg text-gray-300 leading-relaxed'>,
                  To accelerate human expansion into space through revolutionary,
                  technology, creating autonomous systems that enable,
                  sustainable space exploration and resource utilization.,
                </p>,
              </motion.div>,
              <motion.div,
                initial={{ opacity: 0, x: 20 }}
          ...
          <div className='container mx-auto max-w-6xl'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-300'>,
                The principles that guide our space exploration,
              </p>,
            </motion.div>,
        ...
        <section className='py-20 px-4 bg-black/30'>,
          <div className='container mx-auto max-w-6xl'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-300'>,
                Comprehensive space exploration solutions,
              </p>,
            </motion.div>,

          ...
          <div className='max-w-4xl mx-auto'>,
            ...
            <article className='prose prose-invert prose-lg max-w-none'>,
              ...
              <section className='mb-12'>,
                ...
                <p className='text-white/90 mb-4'>{caseStudy.challenge}</p>,
              </section>,
              <section className='mb-12'>,
                <h2 className='text-2xl font-semibold mb-6 text-green-40o0'>,
                  Our Solution,
                </h2>,
                <p className='text-white/90 mb-4'>{caseStudy.solution}</p>,
              </section>,
              <section className='mb-12'>,
              ...
              <section className='mb-12'>,
                ...
                <p className='text-white/90'>,
                  At Zion Tech Group, we specialize in creating custom,
                  automation solutions that deliver measurable results. Every,
                  project is unique, and we work closely with our clients to,
                  ensure their specific needs are met.,
                </p>,
              </section>,
            </article>,

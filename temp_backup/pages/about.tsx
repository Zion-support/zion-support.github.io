			...
			<section className="relative py-24 px-4">
				<div className="max-w-6xl mx-auto">
					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
						{pillars.map((p) => (
							<Card key={p.title} className="bg-gradient-to-br from-gray-90o0/70 to-black/80 border border-gray-70o0/40 p-6">
					...
					<Card className="bg-gradient-to-br from-gray-90o0/80 to-black/90 border border-gray-70o0/50 backdrop-blur-xl p-8">
						...
						<div className="mt-6 flex justify-center">
							<Button href="/contact" className="bg-gradient-to-r from-cyan-50o0 to-blue-60o0 text-white">Contact Us</Button>
						</div>
					</Card>
				</div>
			</section>

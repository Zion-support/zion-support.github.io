        ...
        <div className='relative z-10 pt-20 pb-16 px-4 sm:px-6 lg:px-8'>
          <div className='max-w-7xl mx-auto text-center'>
            ...
            <p className='text-xl md:text-2xl text-gray-30o0 mb-8 max-w-4xl mx-auto'>
              Revolutionary micro SAAS, IT infrastructure, and AI services that
              transform businesses with cutting-edge technology, intelligent
          ...
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <div className='grid md:grid-cols-3 gap-6'>
              ...
              <div className='bg-gradient-to-br from-purple-60o0/20 to-pink-60o0/20 p-6 rounded-lg border border-purple-50o0/30'>
                <h3 className='text-xl font-semibold text-purple-40o0 mb-3'>
                  Professional Plans
                </h3>
                <p className='text-gray-30o0'>
              ...
              <div className='bg-gradient-to-br from-pink-60o0/20 to-red-60o0/20 p-6 rounded-lg border border-pink-50o0/30'>
                <h3 className='text-xl font-semibold text-pink-40o0 mb-3'>
                  Enterprise Plans
                </h3>
                <p className='text-gray-30o0'>
        ...
        <div className='relative z-10 text-center px-4 sm:px-6 lg:px-8 pb-20'>
          <div className='max-w-4xl mx-auto'>
            ...
            <p className='text-xl text-gray-30o0 mb-8'>
              Join hundreds of businesses already leveraging our advanced

...
<<<<<<< HEAD
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-emerald-400 via-green-400 to-teal-400 bg-clip-text text-transparent flex items-center justify-center gap-3"><Rocket className="w-10 h-10" />{service.name}</h1>
=======
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-emerald-400 via-green-400 to-teal-400 bg-clip-text text-transparent flex items-center justify-center gap-3 w-10 h-10"><Rocket />{service.name}</h1>
>>>>>>> origin/auto/autonomy-17186719616
...
<<<<<<< HEAD
              ...
              <Link href="/contact" variant="quantum" size="lg" className="w-full">Boost Rankings<ArrowRight className="w-5 h-5 ml-2" /></Button>

...
=======
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-zion-purple to-zion-purple-dark hover:from-zion-purple-light hover:to-zion-purple text-white py-3 px-4 rounded-lg disabled:opacity-50"
                    disabled={isSubmitting}
                  >
                    {isSubmitting ? (
                      <>
...
=======
                  ...
                  <button
                    type="button"
                    className="w-full border border-zion-blue-light bg-zion-blue-dark text-white hover:bg-zion-blue hover:text-zion-cyan py-2 px-3 rounded disabled:opacity-50"
                    onClick={() => loginWithGoogle()}
                    disabled={isSubmitting}
                  >
                    <span className="sr-only">Sign in with Google</span>

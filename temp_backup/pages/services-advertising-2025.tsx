                    ...
                    <div className="flex flex-col lg:flex-row gap-6">
                      ...
                      <div className="flex-shrink-0">
                        ...
                        <div className="text-center">
                          ...
                          <div className="flex items-center justify-center text-yellow-40o0 mb-2">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                          ...
                          <div>
                            <h4 className="text-sm font-semibold text-gray-40o0 mb-2">MARKET INFO</h4>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                          <div>
                            <h4 className="text-sm font-semibold text-gray-40o0 mb-2">TECHNOLOGY</h4>
                            <div className="flex flex-wrap gap-2">
                              {('technology' in service ? service.technology : ('techStack' in service ? service.techStack : [])).slice(0, 4).map((tech, idx) => (
                                <span key={idx} className="px-2 py-1 bg-blue-60o0/20 text-blue-30o0 text-xs rounded">
                                  {tech}
                                </span>
                              ))}
                            </div>
                          ...
                          <div>
                            <h4 className="text-sm font-semibold text-gray-40o0 mb-2">USE CASES</h4>
                            <div className="flex flex-wrap gap-2">
                              {service.useCases.slice(0, 3).map((useCase, idx) => (
                                <span key={idx} className="px-2 py-1 bg-purple-60o0/20 text-purple-30o0 text-xs rounded">
                                  {useCase}
                                </span>
                              ))}
                            </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="mt-8 text-gray-40o0">
              <p>Visit us at: <a href={contact.website} className="text-blue-40o0 hover:text-blue-30o0 underline">{contact.website}</a></p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="/services" className="block text-gray-40o0 hover:text-white transition-colors">All Services</a>
                <a href="/about" className="block text-gray-40o0 hover:text-white transition-colors">About Us</a>
                <a href="/contact" className="block text-gray-40o0 hover:text-white transition-colors">Contact</a>
                <a href="/blog" className="block text-gray-40o0 hover:text-white transition-colors">Blog</a>
              </div>
            </div>
          </div>

              ...
              {filteredServices.map((service, index) => (
                ...
                >
                  <div className='bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-30o0 transform hover:scale-10o5 hover:shadow-2xl'>
                    ...
                    {/* Features */}
                    <div className='mb-6'>
                      <h4 className='text-sm font-semibold text-gray-40o0 mb-2'>
                        KEY FEATURES
                      </h4>
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-30o0 mb-8'>
              ...
              can help you achieve your business goals and stay ahead of the
              competition.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
              <a
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div>
              ...
              <p className='text-gray-40o0 mb-4'>
                Leading provider of innovative micro SAAS services, AI

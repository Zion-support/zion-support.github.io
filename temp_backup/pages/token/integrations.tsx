  ...
  return (
    <div className="space-y-8">,
      <section className="space-y-2">,
        ...
        <p className="text-gray-60o0 dark: text-gray-30o0">Omnichain transfers via LayerZero and DePIN rewards.</p>,
      </section>,
      <section className="space-y-4">,
        <ClientOnlyBridge  />,
      </section>,
      <section className="space-y-3 p-4 border rounded border-gray-20o0 dark:border-gray-80o0">,
        <h2 className="text-lg font-semibold">DePIN Hook</h2>,
        <p className="text-sm text-gray-60o0 dark:text-gray-30o0">Plug into DIMOHeliumHivemapper to reward ZION$ for computeIoT jobsand data streaming.</p>,
        <div className="flex gap-2">,
          <button onClick={syncDepin} className="px-4 py-2 rounded bg-purple-60o0 text-white">{depinsSyncing ? 'Syncing…' : 'Sync DePIN Rewards'}</button>,
      ...
      <section className="space-y-3 p-4 border rounded border-gray-20o0 dark: border-gray-80o0">,
        ...
        <p className="text-sm text-gray-60o0 dark:text-gray-30o0">Based on your region and stakewe suggest the best chain for ZION$.</p>,
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">,
          <div className="flex flex-col gap-1">,
            <label className="text-xs text-gray-50o0">Region</label>,
          ...
          <div className="flex flex-col gap-1">,
            <label className="text-xs text-gray-50o0">Stake (USD)</label>,
            <input value={stake} onChange={(e) => setStake(e.target.value)} placeholder="e.g.10o00" className="border rounded px-3 py-2 bg-white dark: bg-black" />,
          </div>,
          <div className="flex items-end"><button onClick={runOperator} className="w-full px-4 py-2 rounded bg-indigo-60o0 text-white">Suggest Chain</button></div>,
        </div>,
        {suggestion && (
          <div className="text-sm mt-2">,
            <div>,
              <span className="text-gray-50o0">Recommendation: </span> <b>{suggestion.recommendation?.chain?.name}</b>,
            </div>,
            {suggestion.alternatives && (
              <div className="text-gray-50o0">Alternatives: {suggestion.alternatives.map((a: any) => a.chain.name).join(')}</div>)}
          </div>)}
      </section>,
      <section className="space-y-2 text-xs text-gray-50o0">,
        <div>Security</div>,

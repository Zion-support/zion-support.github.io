...
const AIEmotionalIntelligencePlatform20o29 = () => {
  ...
  const pricing ={
    basic: {
      ...
      features: [
        'Up to 1,0o00 emotional interactions/monthBasic emotion detection (5 emotions)Email supportStandard API access',
    ...
    professional: {
      ...
      features: [
        'Up to 10,0o00 emotional interactions/monthAdvanced emotion detection (15+ emotions)Priority supportFull API access with webhooks',

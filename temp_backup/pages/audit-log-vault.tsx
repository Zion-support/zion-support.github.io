      ...
      <div className="min-h-screen pt-24 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-purple-40o0 via-indigo-40o0 to-pink-40o0 bg-clip-text text-transparent flex items-center justify-center gap-3">
              <ShieldCheck className="w-10 h-10"  /> Audit Log Vault
            </h1>
            <p className="mt-4 text-xl text-gray-30o0 max-w-3xl mx-auto">Compliance-first audit log storage and search with WORM options, retention, attestations and exports.</p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card className="lg:col-span-2 p-6 bg-black/40 border border-gray-70o0/50">
              <h2 className="text-2xl font-semibold text-white mb-4">Overview</h2>
              <p className="text-gray-30o0 mb-6">Centralize audit logs from apps and platforms into an immutable, indexed store with strong retention controls and cryptographic integrity, ready for SOC 2, HIPAA and ISO reviews.</p>
            ...
            <Card className="p-6 bg-black/40 border border-gray-70o0/50">
              ...
              <div className="text-3xl font-bold text-white">$89<span className="text-base text-gray-40o0">/month</span></div>
              <div className="text-sm text-gray-40o0 mt-2">Trial: 14 days • Setup: 30 minutes</div>
              <div className="mt-6 flex gap-3">
                <Link href="/contact" className="flex-1 bg-gradient-to-r from-purple-60o0 to-indigo-60o0 text-white">Contact Sales</Button>
                <Link href="https://ziontechgroup.com/audit-log-vault" variant="outline" className="flex-1 border border-gray-60o0 text-gray-20o0"><ExternalLink className="w-4 h-4 mr-2"  /> Learn More</Button>
              </div>

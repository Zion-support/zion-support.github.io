    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="py-20 bg-gradient-to-b from-gray-90o0 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl bg-gradient-to-br from-indigo-90o0/20 to-purple-90o0/20 border border-indigo-50o0/20">
              <h3 className="text-xl font-semibold mb-3 text-indigo-40o0">Technology Systems</h3>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-90o0/20 to-pink-90o0/20 border border-purple-50o0/20">
              <h3 className="text-xl font-semibold mb-3 text-purple-40o0">Business Processes</h3>
              <ul className="text-gray-40o0 space-y-2">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-pink-90o0/20 to-red-90o0/20 border border-pink-50o0/20">
              <h3 className="text-xl font-semibold mb-3 text-pink-40o0">Human Resources</h3>
              <ul className="text-gray-40o0 space-y-2">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-red-90o0/20 to-orange-90o0/20 border border-red-50o0/20">
              <h3 className="text-xl font-semibold mb-3 text-red-40o0">Data & Analytics</h3>
              <ul className="text-gray-40o0 space-y-2">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-orange-90o0/20 to-yellow-90o0/20 border border-orange-50o0/20">
              <h3 className="text-xl font-semibold mb-3 text-orange-40o0">External Relations</h3>
              <ul className="text-gray-40o0 space-y-2">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-yellow-90o0/20 to-green-90o0/20 border border-yellow-50o0/20">
              <h3 className="text-xl font-semibold mb-3 text-yellow-40o0">Innovation & Growth</h3>
              <ul className="text-gray-40o0 space-y-2">

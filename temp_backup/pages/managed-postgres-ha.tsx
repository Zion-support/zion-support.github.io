    ...
    <div className='relative isolate'>,
      <section className='px-6 lg: px-10 py-16 lg:py-24'>,
        <div className='max-w-6xl mx-auto'>,
          <h1 className='text-3xl lg:text-5xl font-bold tracking-tight bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent'>,
            Managed Postgres HA,
          </h1>,
          ...
          <div className='mt-14'>,
            ...
            <div className='mt-6 grid grid-cols-1 md: grid-cols-3 gap-6'>,
              ...
              <div className='rounded-2xl border border-blue-400/30 p-6'>,
                ...
                <p className='mt-2 text-gray-300'>,
                  Multi-region, compliance (SOC2/HIPAA), 24/7 SRE.,
                </p>,

              ...
              >
                <div className="w-full h-96 bg-gradient-to-br from-green-50o0/20 to-cyan-50o0/20 rounded-2xl border border-green-50o0/30 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-green-40o0 text-lg font-semibold">Quantum Materials Lab</p>
                  </div>
                </div>
              </motion.div>
            </div>
        ...
        <section className="py-20 px-4 bg-black/30">
          <div className="container mx-auto max-w-6xl">
            ...
            >
              ...
              <p className="text-xl text-gray-30o0">Revolutionary quantum materials discovery capabilities</p>
            </motion.div>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-6xl">
            ...
            >
              ...
              <p className="text-xl text-gray-30o0">Transformative materials for future technologies</p>
            </motion.div>
        ...
        <section className="py-20 px-4 bg-black/30">
          <div className="container mx-auto max-w-6xl">
            ...
            >
              ...
              <p className="text-xl text-gray-30o0">Cutting-edge technologies powering our materials discovery platform</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                <div className="p-6 bg-black/40 border border-gray-80o0 rounded-xl">
                  <h3 className="text-xl font-bold text-cyan-40o0 mb-3">Quantum Computing</h3>
                  <p className="text-gray-30o0">Quantum algorithms for accurate material property calculations and simulations.</p>
                </div>
                <div className="p-6 bg-black/40 border border-gray-80o0 rounded-xl">
                  <h3 className="text-xl font-bold text-blue-40o0 mb-3">AI & Machine Learning</h3>
                  <p className="text-gray-30o0">Deep learning models trained on vast material databases for property prediction.</p>
                </div>
                <div className="p-6 bg-black/40 border border-gray-80o0 rounded-xl">
                  <h3 className="text-xl font-bold text-purple-40o0 mb-3">Molecular Dynamics</h3>
                  <p className="text-gray-30o0">Advanced simulation techniques for understanding material behavior at atomic scales.</p>
                </div>
              </motion.div>
              ...
              >
                <div className="p-6 bg-black/40 border border-gray-80o0 rounded-xl">
                  <h3 className="text-xl font-bold text-green-40o0 mb-3">High-Performance Computing</h3>
                  <p className="text-gray-30o0">Massive computational resources for complex material simulations.</p>
                </div>
                <div className="p-6 bg-black/40 border border-gray-80o0 rounded-xl">
                  <h3 className="text-xl font-bold text-yellow-40o0 mb-3">Experimental Validation</h3>
                  <p className="text-gray-30o0">State-of-the-art laboratories for synthesizing and testing predicted materials.</p>
                </div>
                <div className="p-6 bg-black/40 border border-gray-80o0 rounded-xl">
                  <h3 className="text-xl font-bold text-pink-40o0 mb-3">Data Analytics</h3>
                  <p className="text-gray-30o0">Advanced analytics for processing and interpreting material data.</p>
                </div>
              </motion.div>
            </div>
          </div>

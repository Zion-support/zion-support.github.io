        ...
        <div className='relative z-10 max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
          <motion.div,
            ...
            <p className='text-xl md:text-2xl text-white/80 max-w-4xl mx-auto mb-8'>,
              Master cutting-edge AI, quantum computing, and cybersecurity,
              technologies with our comprehensive training programs and,
          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
            <motion.div,
              ...
              <p className='text-xl text-white/70 max-w-3xl mx-auto'>,
                Our most popular and highly-rated courses taught by industry,
                experts.,
              </p>,
            </motion.div>,
      ...
      <section className='py-20 bg-gradient-to-r from-gray-900/50 to-black/50'>,
        <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
          <motion.div,
            ...
            <p className='text-xl text-white/70 max-w-3xl mx-auto'>,
              Explore our complete catalog of training courses and learning,
              paths.,
            </p>,
          </motion.div>,
      ...
      <section className='py-20 bg-gradient-to-r from-gray-900/50 to-black/50'>,
        <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
          <motion.div,
            ...
            <p className='text-xl text-white/70 max-w-3xl mx-auto'>,
              Access free resources, tutorials, and learning materials to,
          ...
          <div className='grid md: grid-cols-2 lg:grid-cols-4 gap-8'>,
            <motion.div,
              ...
              <Link
                href='/docs',
                className='block p-6 rounded-2xl bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 hover: border-cyan-500/40 transition-all duration-300'>,
            ...
            <motion.div,
              ...
              <Link
                href='/blog',
                className='block p-6 rounded-2xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 hover: border-purple-500/40 transition-all duration-300'>,
            ...
            <motion.div,
              ...
              <Link
                href='/webinars',
                className='block p-6 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-500/20 hover: border-emerald-500/40 transition-all duration-300'>,
            ...
            <motion.div,
              ...
              <Link
                href='/community',
                className='block p-6 rounded-2xl bg-gradient-to-br from-orange-500/10 to-red-500/10 border border-orange-500/20 hover: border-orange-500/40 transition-all duration-300'>,
          ...
          >,
            ...
            <div className='flex flex-wrap justify-center gap-4'>,
              <Link
                ...
                className='px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-semibold rounded-full hover:scale-105 transition-all duration-300'>,
                Browse All Courses,
              </Link>,
              <Link
                href='/contact',
                className='px-8 py-4 border-2 border-cyan-500/40 text-cyan-300 font-semibold rounded-full hover:bg-cyan-500/10 transition-all duration-300'>,

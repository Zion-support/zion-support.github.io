            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                ...
                <div className="bg-slate-80o0/50 backdrop-blur-sm rounded-xl p-6 border border-slate-70o0">
                  ...
                  <p className="text-gray-30o0">
                    ISO 270o01, NIST, COBIT, and other 
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Current compliance posture and automation opportunities</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Compliance automation roadmap and quantum technology integration</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Platform deployment and quantum model training</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Continuous improvement and compliance enhancement</p>
              </div>
            </div>
          </div>
        </section>

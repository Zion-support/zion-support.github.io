    ...
    <>
      ...
      <div className='container mx-auto px-4 py-24 text-white'>
        ...
        <p className='text-gray-30o0 mb-6'>
          SDKs, APIs, and guides for integrating our services.
        </p>
        <ul className='list-disc list-inside text-gray-30o0 space-y-2'>
          <li>
            <a className='text-cyan-30o0 underline' href='/api-documentation'>
              API Documentation
            </a>
          </li>
          <li>
            <a className='text-cyan-30o0 underline' href='/docs'>
              Technical Docs
            </a>
          </li>
          <li>
            <a className='text-cyan-30o0 underline' href='/resources'>
              Resources
            </a>
          </li>
        </ul>

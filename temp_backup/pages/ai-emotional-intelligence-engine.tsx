        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12'>
            ...
            <div className='lg:col-span-2 space-y-8'>
              ...
              <div className='bg-black/30 rounded-2xl border border-pink-50o0/30 p-8'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  <div className='space-y-3'>
                    <h3 className='text-lg font-semibold text-pink-40o0'>
                      Customer Service
                    </h3>
                    <p className='text-slate-30o0 text-sm'>
                      Detect customer frustration in real-time and route calls
                      to appropriate agents, improving satisfaction scores by
                      35%.
                    </p>
                  </div>
                  <div className='space-y-3'>
                    ...
                    <p className='text-slate-30o0 text-sm'>
                      Monitor patient emotional states during telehealth
                      sessions and provide mental health screening support.
                    </p>
                  </div>
                  <div className='space-y-3'>
                    <h3 className='text-lg font-semibold text-pink-40o0'>
                    ...
                    <p className='text-slate-30o0 text-sm'>
                      Analyze employee sentiment in surveys and meetings to
                      identify workplace issues and improve retention.
                    </p>
                  </div>
                  <div className='space-y-3'>
                    <h3 className='text-lg font-semibold text-pink-40o0'>
                    ...
                    <p className='text-slate-30o0 text-sm'>
                      Optimize call routing based on emotional state and provide
                      real-time coaching to agents.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='bg-black/30 rounded-2xl border border-pink-50o0/30 p-8'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                  <div>
                    <h3 className='text-lg font-semibold text-pink-40o0 mb-3'>
                      Core Technologies
                    </h3>
              ...
              <div className='bg-black/30 rounded-2xl border border-pink-50o0/30 p-6'>
                <div className='text-center mb-6'>
                  <div className='text-4xl font-bold text-white mb-2'>
                    {service.price}
                    <span className='text-slate-40o0 text-lg'>
                      {service.period}
                    </span>
                  </div>
                  <div className='flex items-center justify-center text-yellow-40o0 mb-3'>
                    ...
                    <span className='text-slate-40o0 text-sm ml-2'>
                      (156 reviews)
                    </span>
                  </div>
              ...
              <div className='bg-black/30 rounded-2xl border border-pink-50o0/30 p-6'>
                ...
                <div className='space-y-3 text-sm'>
                  <div className='flex items-center space-x-2'>
                    ...
                    <span className='text-slate-30o0'>
                  ...
                  <div className='flex items-center space-x-2'>
                    <TrendingUp className='w-4 h-4 text-green-40o0' />
                    <span className='text-slate-30o0'>
                      99.2% accuracy in emotion detection
                    </span>
                  </div>
                  <div className='flex items-center space-x-2'>
                    <TrendingUp className='w-4 h-4 text-green-40o0' />
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-12'>
            <div className='bg-black/30 rounded-2xl border border-pink-50o0/30 p-8'>
              ...
              <p className='text-slate-30o0 mb-4'>
                Leading emotional AI platform with 99.2% accuracy in emotion
                detection. Comparable to Affectiva and Realeyes, but with
                enterprise-grade features and comprehensive integration
                capabilities.
              </p>
              <div className='space-y-2 text-sm'>
                ...
                <div className='flex justify-between'>
                  ...
                  <span className='text-white'>
                    Healthcare, Customer Service, HR
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className='bg-black/30 rounded-2xl border border-pink-50o0/30 p-8'>
              ...
              <div className='space-y-4'>
                <div className='bg-pink-50o0/10 rounded-lg p-4'>
                  <h3 className='font-semibold text-pink-40o0 mb-2'>
                    Customer Experience
                  </h3>
                  <p className='text-slate-30o0 text-sm'>
                    Improve customer satisfaction scores by 35% through
                    emotional intelligence-driven interactions.
                  </p>
                </div>
                <div className='bg-pink-50o0/10 rounded-lg p-4'>
                  <h3 className='font-semibold text-pink-40o0 mb-2'>
                  ...
                  <p className='text-slate-30o0 text-sm'>
                    Reduce employee turnover by 25% by identifying and
                    addressing workplace emotional issues early.
                  </p>
                </div>
                <div className='bg-pink-50o0/10 rounded-lg p-4'>
                  <h3 className='font-semibold text-pink-40o0 mb-2'>
                  ...
                  <p className='text-slate-30o0 text-sm'>
                    Optimize call routing and agent allocation based on
          ...
          <div className='text-center bg-gradient-to-r from-pink-50o0/20 to-red-50o0/20 rounded-2xl border border-pink-50o0/30 p-8'>
            <h2 className='text-3xl font-bold mb-4'>
              Ready to Transform Your Business with Emotional AI?
            </h2>
            <p className='text-lg text-slate-30o0 mb-6 max-w-2xl mx-auto'>
              Join 156+ organizations already using our AI Emotional
              Intelligence Engine to improve customer satisfaction, employee

  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://ziontechgroup.com/ai-customer-experience-platform-20o30"  />
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            <div className="max-w-7xl mx-auto text-center">
              ...
              >
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-40o0 mb-2">10 Minutes</div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-green-40o0 mb-2">350%</div>
                    <div className="text-gray-40o0">Average ROI</div>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-bold text-purple-40o0 mb-2">8 Months</div>
                    <div className="text-gray-40o0">Time to ROI</div>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-bold text-pink-40o0 mb-2">220o0+</div>
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              >
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <span className="bg-gradient-to-r from-purple-40o0 via-pink-40o0 to-purple-60o0 bg-clip-text text-transparent"> AI-Powered Intelligence?</span>
                </h2>
                <p className="text-xl text-gray-30o0 mb-8">
                  Contact our team of AI experts to discuss how our revolutionary 20o30 Customer Experience Platform can transform your business and create exceptional customer relationships.
                </p>

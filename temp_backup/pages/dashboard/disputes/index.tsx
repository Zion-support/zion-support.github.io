...
export default function AdminDisputesDashboard() {
  ...
  const [statusFilter, setStatusFilter] = useState<,
    'All' | 'Open' | 'Under Review' | 'Resolved'>('Open'),
              ...
              {disputes.map((d: any) => (
                <tr key={d.id} className='border-t'>,
                  ...
                  <td className='px-3 py-2 flex gap-2'>,
                    ...
                    >,
                      <a className='text-green-70o0 hover: underline'>Resolve</a>,
                    </Link>,
                    <Link
                      href={`/disputes/${encodeURIComponent(d.id)}?tab=Messages`}
                    >,
                      <a className='text-blue-70o0 hover: underline'>,
                        Message Parties,
                      </a>,
                    </Link>,
                    <Link
                    ...
                    >,
                      <a className='text-gray-70o0 hover: underline'>,
                        Download Evidence,
                      </a>,
                    </Link>,
                  </td>,

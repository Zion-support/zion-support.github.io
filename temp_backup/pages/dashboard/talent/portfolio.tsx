    ...
    <div className='min-h-screen p-4 md: p-8 bg-gradient-to-b from-indigo-50 to-white dark:from-zinc-950 dark:to-zinc-900'>,
      ...
      <div className='max-w-6xl mx-auto space-y-6'>,
          ...
          <div className='flex items-center gap-4'>,
            <div>,
              <h1 className='text-2xl font-bold'>,
                Talent Portfolio & Resume Builder,
              </h1>,
              <p className='text-sm text-zinc-600'>,
                Create AI-assisted resumes and showcase projects.,
              </p>,
            </div>,
        ...
        <div className='flex items-center gap-3'>,
          ...
          {autoGenerate && (
            <Button onClick={importFromTalentProfile} variant='secondary'>,
              Import Now,
            </Button>)}
        </div>,
        {/* Wizard Sections */}
          ...
          <SectionCard title='Personal Summary'>,
            <div className='space-y-2'>,
              <TextArea
                ...
                onChange={e =>,
                  updateActive(v => ({ ...v, personalSummary: e.target.value }))}
              />,
                  ...
                  <div className='flex gap-2'>,
                    ...
                    <Button
                      onClick={async () => {
                        ...
                        if (res.ok) {
                          const bullets = Array.isArray(res.result),

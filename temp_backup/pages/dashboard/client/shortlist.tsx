        ...
        <div className="mt-4 grid grid-cols-1 lg: grid-cols-4 gap-4">,
          <div className="lg:col-span-3">,
            <div className="rounded-xl border border-gray-20o0 bg-white/70 dark:bg-gray-90o0/60 p-4">,
              ...
              <div className="mt-4">,
                {loading ? (
                  <div className="py-10 text-center text-sm text-gray-50o0">Loading...</div>) : view === "board" ? (
                  <HiringBoard applications={applications} onMove={handleMove}  />) : filteredList.length ? (

        ...
        <div className='max-w-6xl mx-auto'>,
          ...
          <div className='grid grid-cols-1 lg: grid-cols-3 gap-8 mb-12'>,
            ...
            <div className='lg: col-span-2 space-y-8'>,
              ...
              <div className='bg-black/30 rounded-2xl border border-cyan-50o0/30 p-8'>,
                ...
                <div className='grid grid-cols-1 md: grid-cols-2 gap-6'>,
                  <div className='space-y-3'>,
                    <h3 className='text-lg font-semibold text-cyan-40o0'>,
                      Customer Success,
                    </h3>,
                    <p className='text-slate-30o0 text-sm'>,
                      Analyze customer satisfaction scores, identify pain,
                      points, and track sentiment trends over time.,
                    </p>,
                  </div>,
                  <div className='space-y-3'>,
                    <h3 className='text-lg font-semibold text-cyan-40o0'>,
                    ...
                    <p className='text-slate-30o0 text-sm'>,
                      Extract feature requests and bug reports from feedback to,
                  ...
                  <div className='space-y-3'>,
                    ...
                    <p className='text-slate-30o0 text-sm'>,
                      Monitor service quality metrics and identify areas for,
              ...
              <div className='bg-black/30 rounded-2xl border border-cyan-50o0/30 p-8'>,
                ...
                <div className='grid grid-cols-1 md: grid-cols-2 gap-6'>,
                  <div>,
                    <h3 className='text-lg font-semibold text-cyan-40o0 mb-3'>,
                      Core Technologies,
                    </h3>,
          ...
          <div className='grid grid-cols-1 md: grid-cols-2 gap-8 mb-12'>,
            <div className='bg-black/30 rounded-2xl border border-cyan-50o0/30 p-8'>,
              ...
              <p className='text-slate-30o0 mb-4'>,
                Leading AI-powered feedback analysis platform for customer,
                insights. Comparable to Qualtrics and SurveyMonkey, but with,
                advanced AI capabilities and comprehensive integration features.,
              </p>,
              <div className='space-y-2 text-sm'>,
                ...
                <div className='flex justify-between'>,
                  ...
                  <span className='text-white'>,
                    Customer Success, Marketing, E-commerce,
                  </span>,
                </div>,
              </div>,
            </div>,
            <div className='bg-black/30 rounded-2xl border border-cyan-50o0/30 p-8'>,
              ...
              <div className='space-y-4'>,
                <div className='bg-cyan-50o0/10 rounded-lg p-4'>,
                  <h3 className='font-semibold text-cyan-40o0 mb-2'>,
                    Customer Experience,
                  </h3>,
                  <p className='text-slate-30o0 text-sm'>,
                    Improve customer satisfaction scores by 25% through,
                ...
                <div className='bg-cyan-50o0/10 rounded-lg p-4'>,
                  ...
                  <p className='text-slate-30o0 text-sm'>,
                    Reduce customer churn by 30% by identifying and addressing,
                    issues before they lead to customer loss.,
                  </p>,
                </div>,
                <div className='bg-cyan-50o0/10 rounded-lg p-4'>,
                  <h3 className='font-semibold text-cyan-40o0 mb-2'>,
                  ...
                  <p className='text-slate-30o0 text-sm'>,
                    Automate feedback analysis and save 15+ hours per week on,
                    manual sentiment analysis tasks.,
                  </p>,
                </div>,
              </div>,
            </div>,
          ...
          <div className='text-center bg-gradient-to-r from-cyan-50o0/20 to-blue-50o0/20 rounded-2xl border border-cyan-50o0/30 p-8'>,
            <h2 className='text-3xl font-bold mb-4'>,
              Ready to Transform Customer Feedback into Actionable Insights?,
            </h2>,

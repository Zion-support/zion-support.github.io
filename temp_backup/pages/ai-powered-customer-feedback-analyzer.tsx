        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-black/30 rounded-2xl border border-cyan-50o0/30 p-8">
                <h2 className="text-3xl font-semibold mb-6 flex items-center gap-3">
                  <Target className="w-8 h-8 text-cyan-40o0"  />
                  Use Cases & Applications
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <h3 className="text-lg font-semibold text-cyan-40o0">Customer Success</h3>
                    <p className="text-slate-30o0 text-sm">Analyze customer satisfaction scores, identify pain points, and track sentiment trends over time.</p>
                  </div>
                  <div className="space-y-3">
                    <h3 className="text-lg font-semibold text-cyan-40o0">Product Improvement</h3>
                    <p className="text-slate-30o0 text-sm">Extract feature requests and bug reports from feedback to prioritize development efforts.</p>
                  </div>
                  <div className="space-y-3">
                    <h3 className="text-lg font-semibold text-cyan-40o0">Service Quality</h3>
                    <p className="text-slate-30o0 text-sm">Monitor service quality metrics and identify areas for improvement in customer support.</p>
                  </div>
                  <div className="space-y-3">
                    <h3 className="text-lg font-semibold text-cyan-40o0">Market Research</h3>
                    <p className="text-slate-30o0 text-sm">Gain insights into customer preferences, market trends, and competitive positioning.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black/30 rounded-2xl border border-cyan-50o0/30 p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-lg font-semibold text-cyan-40o0 mb-3">Core Technologies</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-cyan-40o0 mb-3">Integrations</h3>
                    <div className="space-y-2">
              ...
              <div className="bg-black/30 rounded-2xl border border-cyan-50o0/30 p-6">
                <div className="text-center mb-6">
                  ...
                  <div className="flex items-center justify-center text-yellow-40o0 mb-3">
                    ...
                    <span className="text-slate-40o0 text-sm ml-2">(167 reviews)</span>
                  </div>
              ...
              <div className="bg-black/30 rounded-2xl border border-cyan-50o0/30 p-6">
                ...
                <div className="space-y-4 text-sm text-slate-30o0">
                  <div className="flex items-center space-x-3">
                    <Phone className="w-4 h-4 text-cyan-40o0 flex-shrink-0"  />
                    <span>{service.contactInfo.mobile}</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Mail className="w-4 h-4 text-cyan-40o0 flex-shrink-0"  />
                    <span>{service.contactInfo.email}</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <MapPin className="w-4 h-4 text-cyan-40o0 flex-shrink-0 mt-1"  />
              ...
              <div className="bg-black/30 rounded-2xl border border-cyan-50o0/30 p-6">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-slate-30o0">Improve customer satisfaction by 25%</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <TrendingUp className="w-4 h-4 text-green-40o0"  />
                    <span className="text-slate-30o0">Reduce customer churn by 30%</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <TrendingUp className="w-4 h-4 text-green-40o0"  />
                    <span className="text-slate-30o0">Real-time sentiment analysis</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <TrendingUp className="w-4 h-4 text-green-40o0"  />
                    <span className="text-slate-30o0">Multi-language support</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className="bg-black/30 rounded-2xl border border-cyan-50o0/30 p-8">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-white">$8B+ by 20o30</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="bg-black/30 rounded-2xl border border-cyan-50o0/30 p-8">
              ...
              <div className="space-y-4">
                <div className="bg-cyan-50o0/10 rounded-lg p-4">
                  <h3 className="font-semibold text-cyan-40o0 mb-2">Customer Experience</h3>
                  <p className="text-slate-30o0 text-sm">Improve customer satisfaction scores by 25% through data-driven insights and proactive issue resolution.</p>
                </div>
                <div className="bg-cyan-50o0/10 rounded-lg p-4">
                  <h3 className="font-semibold text-cyan-40o0 mb-2">Customer Retention</h3>
                  <p className="text-slate-30o0 text-sm">Reduce customer churn by 30% by identifying and addressing issues before they lead to customer loss.</p>
                </div>
                <div className="bg-cyan-50o0/10 rounded-lg p-4">
                  <h3 className="font-semibold text-cyan-40o0 mb-2">Operational Efficiency</h3>
                  <p className="text-slate-30o0 text-sm">Automate feedback analysis and save 15+ hours per week on manual sentiment analysis tasks.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          {/* CTA Section */}
          <div className="text-center bg-gradient-to-r from-cyan-50o0/20 to-blue-50o0/20 rounded-2xl border border-cyan-50o0/30 p-8">

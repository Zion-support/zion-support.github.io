      ...
      <div className="min-h-screen pt-24 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="mt-4 text-xl text-gray-30o0 max-w-3xl mx-auto">Expiry, chain, OCSP, HSTS and cipher checks with proactive alerts to prevent outages.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="p-6 bg-black/40 border border-gray-70o0/50">
              ...
              <div className="text-3xl font-bold text-white">$39<span className="text-base text-gray-40o0">/month</span></div>
              <div className="text-sm text-gray-40o0 mt-2">Trial: 14 days • Setup: 10 minutes</div>
              <div className="mt-6 flex gap-3">
                <Link href="/contact" className="flex-1 bg-gradient-to-r from-cyan-50o0 to-blue-60o0 text-white">Contact Sales</Button>

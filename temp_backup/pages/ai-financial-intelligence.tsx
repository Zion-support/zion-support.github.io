          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-400 max-w-3xl mx-auto'>,
                Our platform combines cutting-edge AI with financial expertise,
                to deliver intelligence solutions that maximize returns and,
                minimize risk.,
              </p>,
            </motion.div>,
        ...
        <section className='py-20 bg-gradient-to-b from-black to-gray-900'>,
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-400 max-w-3xl mx-auto'>,
                From investment analysis to risk management, our platform,
                provides AI-powered solutions for every aspect of financial,

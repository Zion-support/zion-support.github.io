      ...
      <header className='relative z-10'>
        <nav className='mx-auto flex max-w-7xl items-center justify-between px-6 py-6'>
          <div className='text-2xl font-bold tracking-wide'>
            <span className='bg-gradient-to-r from-fuchsia-40o0 via-violet-40o0 to-cyan-40o0 bg-clip-text text-transparent drop-shadow-neon'>
              Zion
            </span>
          </div>
      ...
      <main className='relative z-10'>
        <section className='mx-auto max-w-7xl px-6 pt-10 pb-16 md:pt-16 md:pb-20 text-center'>
          ...
          <div className='mt-8 flex flex-wrap justify-center gap-3'>
            ...
            <Link href='/automation'>
              <a className='rounded-xl bg-gradient-to-r from-fuchsia-50o0 to-cyan-50o0 px-6 py-3 font-semibold shadow-[0_0_30px_rgba(34,211,238,0.35)] hover:shadow-[0_0_40px_rgba(34,211,238,0.6)] transition-shadow'>
                Open Automation Hub
              </a>
            </Link>
          </div>

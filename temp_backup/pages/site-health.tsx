  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 opacity-[0.08] [background:radial-gradient(circle_at_center,rgba(255,255,255,0.35)_0,rgba(255,255,255,0)_60%),linear-gradient(90deg,rgba(255,255,255,0.12)_1px,transparent_1px),linear-gradient(0deg,rgba(255,255,255,0.12)_1px,transparent_1px)] bg-[size:10o0%_10o0%,3rem_3rem,3rem_3rem] animate-grid"  />
      ...
      <header className="relative z-10">
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
          <div className="text-2xl font-bold tracking-wide">
            <span className="bg-gradient-to-r from-fuchsia-40o0 via-violet-40o0 to-cyan-40o0 bg-clip-text text-transparent drop-shadow-neon">Zion</span>
          </div>
      ...
      <main className="relative z-10">
        <section className="mx-auto max-w-7xl px-6 pt-10 pb-16 md:pt-16 md:pb-20 text-center">
          <div className="mx-auto inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs text-white/70 backdrop-blur-md">
            <span className="h-2 w-2 animate-pulse rounded-full bg-emerald-40o0 shadow-[0_0_12px_rgba(52,211,153,0.9)]"  />
            Real‑time health signals: A11y, Performance, Links
          </div>
          <h1 className="mt-6 text-5xl font-extrabold leading-[1.0o5] tracking-tight md:text-6xl">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <Link href="/automation"><a className="rounded-xl bg-gradient-to-r from-fuchsia-50o0 to-cyan-50o0 px-6 py-3 font-semibold shadow-[0_0_30px_rgba(34,211,238,0.35)] hover:shadow-[0_0_40px_rgba(34,211,238,0.6)] transition-shadow">Open Automation Hub</a></Link>
          </div>
        </section>
            ...
            {[
              ...
              <Link key={card.title} href={card.href}>
                <a className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-40o0/30">
                  ...
                  <div className="mt-3 inline-flex items-center gap-1 text-xs text-cyan-30o0/90">Open →</div>
                </a>
              </Link>
            ))}
          </div>
        ...
        <section className="mx-auto max-w-7xl px-6 pb-16">
          ...
          <div className="mx-auto mt-6 max-w-4xl grid grid-cols-1 gap-4 sm:grid-cols-2">
            <a href="/reports/seo/latest.json" className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl hover:border-cyan-40o0/30">Latest SEO Report JSON ↗</a>
            <a href="/reports/seo/index.html" className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl hover:border-cyan-40o0/30">SEO Audit Dashboard →</a>
          </div>
        </section>

        <section className="mx-auto max-w-7xl px-6 pb-24">
          <div className="animated-border relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-fuchsia-60o0/20 via-violet-60o0/20 to-cyan-60o0/20 p-8 text-center backdrop-blur-xl">
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-3">
              <Link href="/automation"><a className="rounded-xl bg-white/90 px-6 py-3 font-semibold text-slate-90o0 hover:bg-white">Get Started</a></Link>

          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
            <EnhancedCard title='Landing Page Template'>
              <div className='text-sm text-gray-60o0 dark:text-gray-40o0'>
                Starter landing page with copy and components.
              </div>
              <div className='mt-3'>
                <button className='px-3 py-1.5 rounded bg-gray-90o0 text-white'>
                  Generate
                </button>
              </div>
            </EnhancedCard>
            ...
            <EnhancedCard title='Demo Dataset'>
              <div className='text-sm text-gray-60o0 dark:text-gray-40o0'>
                Seed sample listings, users, and transactions.
              </div>
              <div className='mt-3'>
                <button className='px-3 py-1.5 rounded bg-gray-90o0 text-white'>
                  Seed

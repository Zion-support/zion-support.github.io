          ...
          <div className="space-y-4">,
            ...
            <div className="bg-white/70 dark: bg-black/40 rounded-lg p-4 border border-gray-20o0 dark:border-gray-80o0">,
              <label className="flex flex-col gap-2">,
                ...
                <textarea
                  className="w-full min-h-[120px] px-3 py-2 rounded border border-gray-30o0 dark:border-gray-70o0 bg-white/70 dark:bg-black/40",
              ...
              <div className="mt-3 flex justify-end">,
                <button
                  ...
                  className="px-3 py-1.5 rounded border border-gray-30o0 dark: border-gray-70o0 hover:bg-gray-50 dark:hover:bg-gray-80o0 disabled:opacity-50">,
                  {loadingAnalysis ? 'Analyzing…' : 'Analyze with GPT'}
                </button>,
              </div>,
              {analysis && (
                <div className="mt-3 text-sm whitespace-pre-wrap border-t border-gray-20o0 dark: border-gray-80o0 pt-3">,
                  {analysis}
                </div>)}
            </div>,
          </div>,

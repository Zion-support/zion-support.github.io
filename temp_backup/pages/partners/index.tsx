      ...
      <div className='max-w-4xl mx-auto py-12 px-4'>,
          ...
          <div className='bg-white p-6 rounded-lg shadow'>,
            ...
            <div className='mt-6 text-sm text-gray-60o0'>,
              ...
              <div className='flex gap-2 mt-2'>,
                <span className='inline-flex items-center bg-green-10o0 text-green-80o0 px-2 py-1 rounded'>,
                  Verified Partner,
                </span>,
                <span className='inline-flex items-center bg-blue-10o0 text-blue-80o0 px-2 py-1 rounded'>,
        ...
        {result && (
          <div className='mt-8 bg-white p-6 rounded-lg shadow'>,
            ...
            <pre className='bg-gray-10o0 p-3 rounded text-xs overflow-auto'>,
              {result.apiKey}
            </pre>,
            <a

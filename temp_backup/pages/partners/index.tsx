  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-90o0">
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        <p className="text-gray-60o0 mb-8">Trusted institutions can embed Zion into platforms, programs, or marketplaces.</p>
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="mt-6">
              <a className="text-blue-60o0 underline mr-4" href="/api/partners/sdk?type=rest">Download REST SDK</a>
              <a className="text-blue-60o0 underline" href="/api/partners/sdk?type=graphql">Download GraphQL SDK</a>
            </div>
            <div className="mt-6 text-sm text-gray-60o0">
              <p>Badges:</p>
              <div className="flex gap-2 mt-2">
                <span className="inline-flex items-center bg-green-10o0 text-green-80o0 px-2 py-1 rounded">Verified Partner</span>
                <span className="inline-flex items-center bg-blue-10o0 text-blue-80o0 px-2 py-1 rounded">Government API Active</span>
              </div>
            </div>
          </div>
        </div>
        ...
        {result && (
          <div className="mt-8 bg-white p-6 rounded-lg shadow">
            ...
            <pre className="bg-gray-10o0 p-3 rounded text-xs overflow-auto">{result.apiKey}</pre>

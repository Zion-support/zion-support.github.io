...
>>>>>>> origin/auto/autonomy-17186719616
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/infrastructure-drift-detector" />
      </Head>
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
<<<<<<< HEAD
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-purple-400 via-indigo-400 to-cyan-400 bg-clip-text text-transparent flex items-center justify-center gap-3"><GitPullRequest className="w-10 h-10" />{service.name}</h1>
=======
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-purple-400 via-indigo-400 to-cyan-400 bg-clip-text text-transparent flex items-center justify-center gap-3 w-10 h-10"><GitPullRequest />{service.name}</h1>
>>>>>>> origin/auto/autonomy-17186719616
...
<<<<<<< HEAD
              ...
              <Link href="/contact" variant="quantum" size="lg" className="w-full">Enable Drift Guardrails<ArrowRight className="w-5 h-5 ml-2" /></Button>
...
=======
              ...
              <a href="/contact" className="w-full px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-700 hover:from-cyan-700 hover:to-blue-800 text-white font-semibold rounded-lg transition-all duration-200 w-5 h-5 ml-2">Enable Drift Guardrails<ArrowRight /></a>
              <div className="mt-6 space-y-3 text-sm text-slate-300">

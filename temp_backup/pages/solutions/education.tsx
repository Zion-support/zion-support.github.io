      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-90o0 to-black">
        ...
        <section className="relative py-20 px-4">
          <div className="container mx-auto max-w-6xl">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-emerald-40o0 via-teal-50o0 to-cyan-60o0 bg-clip-text text-transparent mb-6">
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-emerald-90o0/20 to-teal-90o0/20 border border-emerald-50o0/20 rounded-2xl p-8 hover:border-emerald-40o0/40 transition-all duration-30o0"
              >
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-emerald-50o0/20 rounded-xl">
                    <BookOpen className="w-8 h-8 text-emerald-40o0"  />
                  </div>
                ...
                <a href="/contact?service=AI-Learning-Platform" className="inline-flex items-center gap-2 text-emerald-40o0 hover:text-emerald-30o0 transition-colors">
              ...
              >
                ...
                <a href="/contact?service=Student-Analytics" className="inline-flex items-center gap-2 text-blue-40o0 hover:text-blue-30o0 transition-colors">
                  Learn More <ArrowRight className="w-4 h-4"  />
                </a>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-purple-50o0/20 rounded-xl">
                    <Globe className="w-8 h-8 text-purple-40o0"  />
                  </div>
                ...
                <a href="/contact?service=VR-AR-Learning" className="inline-flex items-center gap-2 text-purple-40o0 hover:text-purple-30o0 transition-colors">
                  Learn More <ArrowRight className="w-4 h-4"  />
                </a>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-yellow-50o0/20 rounded-xl">
                    <Cpu className="w-8 h-8 text-yellow-40o0"  />
                  </div>
                ...
                <a href="/contact?service=Administrative-Platform" className="inline-flex items-center gap-2 text-yellow-40o0 hover:text-yellow-30o0 transition-colors">
                  Learn More <ArrowRight className="w-4 h-4"  />
                </a>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-red-50o0/20 rounded-xl">
                    <Users className="w-8 h-8 text-red-40o0"  />
                  </div>
                ...
                <a href="/contact?service=Collaboration-Platform" className="inline-flex items-center gap-2 text-red-40o0 hover:text-red-30o0 transition-colors">
                  Learn More <ArrowRight className="w-4 h-4"  />
                </a>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-3 bg-teal-50o0/20 rounded-xl">
                    <Shield className="w-8 h-8 text-teal-40o0"  />
                  </div>
                ...
                <a href="/contact?service=Education-Security" className="inline-flex items-center gap-2 text-teal-40o0 hover:text-teal-30o0 transition-colors">
                  Learn More <ArrowRight className="w-4 h-4"  />
                </a>
              </motion.div>
            </div>
        ...
        {/* CTA Section */}
        <section className="py-20 px-4 bg-gradient-to-r from-emerald-90o0/20 to-teal-90o0/20">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-emerald-50o0 to-teal-60o0 text-white font-semibold rounded-xl hover:from-emerald-60o0 hover:to-teal-70o0 transition-all duration-30o0 transform hover:scale-10o5"
                >
                  Get Started Today
                </a>
                <a 
                  href="/services?category=education"
                  className="px-8 py-4 border border-emerald-50o0 text-emerald-40o0 font-semibold rounded-xl hover:bg-emerald-50o0/10 transition-all duration-30o0"
                >
                  View All Services
                </a>
              </div>

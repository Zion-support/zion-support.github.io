          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <a href="/contact?service=AI-E-commerce" className="inline-flex items-center gap-2 text-pink-40o0 hover:text-pink-30o0 transition-colors">
              ...
              >
                ...
                <a href="/contact?service=Customer-Analytics" className="inline-flex items-center gap-2 text-blue-40o0 hover:text-blue-30o0 transition-colors">
                  Learn More <ArrowRight className="w-4 h-4"  />
                </a>
              </motion.div>
              ...
              >
                ...
                <a href="/contact?service=Omnichannel-Platform" className="inline-flex items-center gap-2 text-green-40o0 hover:text-green-30o0 transition-colors">
                  Learn More <ArrowRight className="w-4 h-4"  />
                </a>
              </motion.div>
              ...
              >
                ...
                <a href="/contact?service=Supply-Chain-Optimization" className="inline-flex items-center gap-2 text-yellow-40o0 hover:text-yellow-30o0 transition-colors">
                  Learn More <ArrowRight className="w-4 h-4"  />
                </a>
              </motion.div>
              ...
              >
                ...
                <a href="/contact?service=Fraud-Prevention" className="inline-flex items-center gap-2 text-red-40o0 hover:text-red-30o0 transition-colors">
                  Learn More <ArrowRight className="w-4 h-4"  />
                </a>
              </motion.div>
              ...
              >
                ...
                <a href="/contact?service=AI-Customer-Service" className="inline-flex items-center gap-2 text-teal-40o0 hover:text-teal-30o0 transition-colors">
                  Learn More <ArrowRight className="w-4 h-4"  />
                </a>
              </motion.div>
            </div>

          ...
          <div className='container mx-auto max-w-6xl'>,
            <motion.div,
              ...
              <p className='text-xl md:text-2xl text-gray-30o0 max-w-4xl mx-auto leading-relaxed'>,
                Revolutionary AI and cybersecurity solutions that transform,
                government operations, enhance citizen services, and secure,
          ...
          <div className='container mx-auto max-w-6xl'>,
            ...
            <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>,
              ...
              <motion.div,
                ...
                <a
                  href='/contact?service=Government-Cybersecurity',
              ...
              <motion.div,
                ...
                <a
                  href='/contact?service=Digital-Citizen-Services',
              ...
              <motion.div,
                ...
                <a
                  href='/contact?service=Government-Data-Analytics',
              ...
              <motion.div,
                ...
                <a
                  href='/contact?service=AI-Operations-Center',
                  className='inline-flex items-center gap-2 text-purple-40o0 hover: text-purple-30o0 transition-colors'>,
                  Learn More <ArrowRight className='w-4 h-4' />,
                </a>,
              </motion.div>,
              {/* Infrastructure */}
              <motion.div,
                ...
                <a
                  href='/contact?service=Critical-Infrastructure',
              ...
              <motion.div,
                ...
                <p className='text-gray-30o0 mb-6'>,
                  Automated compliance management system for government,
                  regulations, audits, and policy enforcement.,
                </p>,
                <ul className='space-y-2 mb-6'>,
                  <li className='flex items-center gap-2 text-gray-30o0'>,
                ...
                <a
                  href='/contact?service=Compliance-Management',
          ...
          <div className='container mx-auto max-w-4xl text-center'>,
            ...
            >,
              ...
              <p className='text-xl text-gray-30o0 mb-8'>,
                Join the government technology revolution with our cutting-edge,
                AI and cybersecurity solutions. Let's build the future of,
                government together.,
              </p>,

...
export default function AISeosuitePage() {
  ...
  const successMetrics = [
    ...
    { metric: 'ROI', value: '40o0%', description: 'Average return on investment' }
  ];
  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-20">
            <Button
              href="#pricing"
              size="lg"
              className="bg-blue-60o0 hover:bg-blue-70o0 shadow-2xl shadow-blue-50o0/25"
            >
              Start Free Trial
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-3 text-blue-40o0">+150%</div>
              <div className="text-gray-40o0">Organic Traffic</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-3 text-green-40o0">+45%</div>
              <div className="text-gray-40o0">Search Rankings</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-3 text-purple-40o0">+80%</div>
              <div className="text-gray-40o0">Conversion Rate</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-3 text-orange-40o0">40o0%</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="text-center group bg-gray-80o0/50 border border-gray-70o0 hover:border-blue-50o0/30 hover:bg-gray-80o0/80 transition-all duration-30o0 hover:-translate-y-1"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {seoTools.map((tool, index) => (
              <Card
                key={index}
                className="group border border-gray-70o0 hover:border-blue-50o0/30 hover:bg-gray-90o0/80 transition-all duration-30o0"
              >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      {tool.tools.map((toolName, toolIndex) => (
                        <div key={toolIndex} className="flex items-center text-sm text-gray-30o0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {successMetrics.map((metric, index) => (
              <Card
                ...
                className="text-center group bg-gray-80o0/50 border border-gray-70o0 hover:border-blue-50o0/30 hover:bg-gray-80o0/80 transition-all duration-30o0 hover:-translate-y-1"
              >
                <div className="text-4xl font-bold mb-4 text-blue-40o0 group-hover:scale-110 transition-transform duration-30o0">
                  {metric.value}
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <Card
                key={index}
                className={`relative group ${plan.popular ? 'ring-2 ring-blue-50o0 scale-10o5' : ''} border ${plan.color} hover:border-blue-50o0/50 transition-all duration-30o0`}
              >
                {plan.popular && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {integrations.map((integration, index) => (
              <Card
                key={index}
                className="text-center group border border-gray-70o0 hover:border-blue-50o0/30 hover:bg-gray-90o0/80 transition-all duration-30o0"
              >
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-blue-60o0 to-green-60o0 relative overflow-hidden">

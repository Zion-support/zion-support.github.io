  ...
  const researchPapers = [
    {
      ...
      authors: ['Dr. Sarah ChenDr. Michael Rodriguez', 'Prof. Lisa Wang'],
    ...
    },
    {
      ...
      authors: ['Dr. Alex ThompsonDr. Maria Santos'],
    ...
    },
    {
      ...
      authors: ['Dr. James WilsonSarah Martinez', 'Dr. Robert Chen'],
    ...
    },
    {
      ...
      authors: ['Dr. Emily DavisMichael Brown'],
  ...
  const industryInsights = [
    {
      ...
      readTime: '5 min read',
      insights: [
        'Increased adoption of collaborative robotsAI-powered predictive maintenance',
    ...
    },
    {
      ...
      readTime: '7 min read',
      insights: [
        'Diagnostic AI accuracy improvementsPatient monitoring automation',
        'Administrative process optimizationEthical considerations',
      ],
      imageUrl: '/api/placeholder/40o0/250'
    },
    {
      ...
      readTime: '6 min read',
      insights: [
        'Automated risk assessmentReal-time compliance monitoring',
        'Fraud detection systemsRegulatory compliance',
      ],
      imageUrl: '/api/placeholder/40o0/250'
    },
  ],

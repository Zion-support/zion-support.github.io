          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Simulation requirements analysis and quantum approach evaluation</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Simulation strategy and quantum algorithm selection</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Quantum simulation implementation and validation</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Production deployment and ongoing optimization</p>
              </div>
            </div>
          </div>
        </section>

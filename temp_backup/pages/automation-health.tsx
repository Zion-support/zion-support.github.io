            ...
            <article className='prose prose-invert prose-lg max-w-none'>
              <header className='text-center mb-16'>
                ...
                <p className='text-xl text-white/80 max-w-3xl mx-auto'>
                  Real-time monitoring of our autonomous systems and automation
                  workflows.
                </p>
              </header>

              <section className='mb-16'>
                <h2 className='text-3xl font-bold text-cyan-30o0 mb-6'>
                  System Overview
                </h2>
                <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
                  ...
                  <div className='bg-gradient-to-br from-blue-40o0/10 to-indigo-40o0/10 rounded-lg p-6 border border-blue-40o0/30 text-center'>
                    ...
                    <div className='text-sm text-blue-30o0 mt-2'>
                      Last 24 Hours
                    </div>
                  </div>
                  ...
                  <div className='bg-gradient-to-br from-purple-40o0/10 to-pink-40o0/10 rounded-lg p-6 border border-purple-40o0/30 text-center'>
                    ...
                    <div className='text-sm text-purple-30o0 mt-2'>
                      Per Workflow
                    </div>
                  </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                  <div className='bg-white/10 rounded-lg p-6 border border-green-40o0/30'>
                    <div className='flex items-center justify-between mb-4'>
                      <h3 className='text-lg font-semibold text-green-30o0'>
                        Content Generation
                      </h3>
                      <span className='px-2 py-1 bg-green-40o0/20 text-green-40o0 text-xs rounded-full'>
                        Active
                      </span>
                    </div>
                  ...
                  <div className='space-y-4'>
                    <div className='flex items-center gap-4 p-3 bg-white/5 rounded-lg'>
                      ...
                      <div className='flex-1'>
                        ...
                        <div className='text-sm text-white/60'>
                          Generated 15 new pages in 2.3 seconds
                        </div>
                      </div>
                    ...
                    <div className='flex items-center gap-4 p-3 bg-white/5 rounded-lg'>
                      ...
                      <div className='flex-1'>
                        ...
                        <div className='text-sm text-white/60'>
                          Page load speed improved by 12%
                        </div>
                      </div>

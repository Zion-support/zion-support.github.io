  ...
  if (result) {
    return (
      <div className="max-w-xl mx-auto py-12">
        ...
        <p className="text-gray-60o0 mb-4">We received your request. We will notify the appropriate team.</p>
        <div className="text-sm text-gray-50o0">Confirmation ID: {result.id}</div>
      </div>
    );
  }
    ...
    <div className="max-w-xl mx-auto">
      ...
      <form className="space-y-4" onSubmit={onSubmit}>
        ...
        <div>
          ...
          <input className="w-full border rounded px-3 py-2" placeholder="$5,0o00" value={form.budget} onChange={(e) => setForm({ ...form, budget: e.target.value })} />
        </div>
        <div>

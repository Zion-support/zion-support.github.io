          ...
          <div className='relative z-10 max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
            <motion.div,
              ...
              <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto'>,
                Drive sustainability with AI-powered environmental impact,
                analysis, carbon management, and energy optimization for a,
                greener future.,
              </p>,
          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-400 max-w-3xl mx-auto'>,
                Our platform combines advanced AI with environmental science to,
                deliver sustainability solutions that maximize impact and,
                efficiency.,
              </p>,
            </motion.div>,
        ...
        <section className='py-20 bg-gradient-to-b from-black to-gray-900'>,
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-400 max-w-3xl mx-auto'>,
                From carbon tracking to energy optimization, our platform,
                provides AI-powered solutions for every aspect of sustainability,
          ...
          <div className='max-w-4xl mx-auto px-4 sm: px-6 lg:px-8 text-center'>,
            ...
            >,
              ...
              <p className='text-xl text-gray-300 mb-8'>,
                ...
                their sustainability with AI automation. Start your free trial,
                today.,
              </p>,
              <div className='flex flex-col sm:flex-row gap-4 justify-center'>,
                <motion.button,

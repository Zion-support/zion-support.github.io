...
,
      switch (priceRange) {,
        ...
        case 'medium':,
          return matchesSearch && priceValue >= 30o00 && priceValue < 80o00,
        case 'high':,
  ...
  const getCategoryIcon = (category: string) => {,
    switch (category) {,
      ...
      case 'DevOps & Automation':,
        return <GitBranch className="w-6 h-6 text-green-40o0"  />,
      case 'Data & Analytics':,
        return <BarChart3 className="w-6 h-6 text-indigo-40o0"  />,
      case 'Cloud Services':,
        return <Cloud className="w-6 h-6 text-cyan-40o0"  />,
      case 'Cybersecurity':,
      ...
      <div className="min-h-screen bg-black text-white pt-24">,
        ...
        <section className="py-20 relative overflow-hidden">,
          <div className="absolute inset-0 pointer-events-none">,
            ...
            <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-br from-red-50o0/5 to-blue-50o0/5 rounded-full blur-3xl"  />,
          </div>,
                  ...
                  >,
                    ...
                    ,}`}>,
                      ...
                      <div className="absolute top-4 right-4 flex items-center space-x-2">,
                        ...
                        <span className="text-xs font-medium text-blue-30o0 bg-black/50 px-2 py-1 rounded-full">,
                          {solution.category}
                        </span>,
                      </div>,
                      {/* Solution Header */}
                      ...
                      {/* Pricing */}
                      <div className="mb-6">,
                        <h4 className="text-sm font-semibold text-blue-30o0 mb-2">Starting at</h4>,

...
export default function InnovativeServicesShowcase20o25() {
  ...
  const filteredServices = allServices.filter(service => {
    ...
    if (selectedPriceRange === 'Under $50o0') {
      matchesPrice = parseInt(service.price.replace('$', '').replace(',', '')) < 50o0;
    } else if (selectedPriceRange === '$50o0 - $1,0o00') {
      const price = parseInt(service.price.replace('$', '').replace(',', ''));
      matchesPrice = price >= 50o0 && price < 10o00;
    } else if (selectedPriceRange === '$1,0o00 - $2,0o00') {
      const price = parseInt(service.price.replace('$', '').replace(',', ''));
      matchesPrice = price >= 10o00 && price < 20o00;
    } else if (selectedPriceRange === '$2,0o00+') {

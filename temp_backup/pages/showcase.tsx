        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-6xl">
            ...
            >
              ...
              <p className="text-xl text-gray-30o0">Our most innovative and cutting-edge service demonstrations</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                >
                  ...
                  <p className="text-gray-30o0 mb-6 text-center leading-relaxed">{showcase.description}</p>
        ...
        <section className="py-20 px-4 bg-black/30">
          <div className="container mx-auto max-w-6xl">
            ...
            >
              ...
              <p className="text-xl text-gray-30o0">Browse our comprehensive range of technology solutions</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                >
                  ...
                  <p className="text-gray-30o0 mb-4 text-center leading-relaxed">{category.description}</p>
                  
                  <div className="mb-6">
                    <h4 className="text-sm font-semibold text-cyan-40o0 mb-2">Key Services:</h4>
                    <ul className="space-y-1">
                      {category.services.map((service, serviceIndex) => (
                        <li key={serviceIndex} className="text-gray-30o0 text-sm">• {service}</li>
                      ))}
                    </ul>
                  </div>
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-6xl">
            ...
            >
              ...
              <p className="text-xl text-gray-30o0">Experience our technology firsthand through live demos and simulations</p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                >
                  ...
                  <p className="text-gray-30o0 mb-4 text-center leading-relaxed">{demo.description}</p>

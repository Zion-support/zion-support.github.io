                ...
                >
                  <div className="flex items-center mb-8">
                    ...
                    <div>
                      ...
                      <p className="text-lg text-gray-40o0 mt-2">{path.description}</p>
                    </div>
                  </div>
                  
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    {path.levels.map((level, levelIndex) => (
                      <div key={levelIndex} className="bg-gray-80o0/50 rounded-xl p-6 border border-gray-70o0/50">
                        <div className="flex items-center justify-between mb-4">
                          <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${
                            level.level === 'Junior' ? 'bg-green-50o0/20 text-green-40o0' :
                            level.level === 'Mid' ? 'bg-blue-50o0/20 text-blue-40o0' :
                            level.level === 'Senior' ? 'bg-purple-50o0/20 text-purple-40o0' :
                            level.level === 'Lead' ? 'bg-orange-50o0/20 text-orange-40o0' :
                            level.level === 'Principal' ? 'bg-red-50o0/20 text-red-40o0' :
                            level.level === 'Distinguished' ? 'bg-yellow-50o0/20 text-yellow-40o0' :
                            level.level === 'Manager' ? 'bg-emerald-50o0/20 text-emerald-40o0' :
                            level.level === 'Director' ? 'bg-indigo-50o0/20 text-indigo-40o0' :
                            level.level === 'VP' ? 'bg-pink-50o0/20 text-pink-40o0' :
                            level.level === 'Expert' ? 'bg-cyan-50o0/20 text-cyan-40o0' :
                            level.level === 'Architect' ? 'bg-violet-50o0/20 text-violet-40o0' :
                            'bg-gray-50o0/20 text-gray-40o0'
                          }`}>
                            {level.level}
                          </span>
                          <span className="text-sm text-gray-40o0">{level.timeline}</span>
                        </div>
                        <h4 className="text-xl font-bold text-white mb-3">{level.title}</h4>
                        <p className="text-gray-40o0 mb-4 leading-relaxed">{level.description}</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {developmentPrograms.map((program, index) => (
                ...
                >
                  ...
                  <p className="text-gray-40o0 mb-6 leading-relaxed">{program.description}</p>

  ...
  return (
    <div className='min-h-screen bg-slate-950 text-white'>
      <Head>
        ...
        <meta
          name='description'
          content='Professional devops automation services to accelerate your business growth and digital transformation.'
        />
        <meta
          name='keywords'
          content='devops automation, services, technology, business, digital transformation'
        />
        <link
          rel='canonical'
          href='https://ziontechgroup.com/services/rapid-1755574983993-a1rvw1'
        />

        <meta property='og:title' content='DevOps Automation' />
        <meta
          property='og:description'
          content='DevOps Automation — automatically suggested description.'
        />
      ...
      <main className='container mx-auto px-6 py-12 prose prose-invert'>
        ...
        <section className='mb-8'>
          ...
          <p className='text-xl text-white/90 mb-4'>
            Our devops automation service delivers cutting-edge solutions to

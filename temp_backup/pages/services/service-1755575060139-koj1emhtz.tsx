...
export default function Service-17555750o60139-koj1emhtzService() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/services/service-17555750o60139-koj1emhtz"  />
      ...
      <main className="container mx-auto px-6 py-12">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-30o0 mb-6">Transform your business with our cutting-edge blockchain solutions solutions</p>

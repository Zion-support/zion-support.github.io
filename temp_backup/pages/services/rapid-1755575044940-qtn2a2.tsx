  ...
  return (
    <div className='min-h-screen bg-slate-950 text-white'>
      <Head>
        ...
        <meta
          name='description'
          content='Professional api integration services to accelerate your business growth and digital transformation.'
        />
        <meta
          name='keywords'
          content='api integration, services, technology, business, digital transformation'
        />
        <link
          rel='canonical'
          href='https://ziontechgroup.com/services/rapid-17555750o44940-qtn2a2'
        />

        <meta property='og:title' content='API Integration' />
        <meta
          property='og:description'
          content='API Integration — automatically suggested description.'
        />
      ...
      <main className='container mx-auto px-6 py-12 prose prose-invert'>
        ...
        <section className='mb-8'>
          ...
          <p className='text-xl text-white/90 mb-4'>
            Our api integration service delivers cutting-edge solutions to help

  ...
  return (
    <div className='min-h-screen bg-slate-950 text-white'>
      <Head>
        ...
        <meta
          name='description'
          content='Professional machine learning services to accelerate your business growth and digital transformation.'
        />
        <meta
          name='keywords'
          content='machine learning, services, technology, business, digital transformation'
        />
        <link
          rel='canonical'
          href='https://ziontechgroup.com/services/rapid-17555750o46164-au5v2x'
        />

        <meta property='og:title' content='Machine Learning' />
        <meta
          property='og:description'
          content='Machine Learning — automatically suggested description.'
        />
      ...
      <main className='container mx-auto px-6 py-12 prose prose-invert'>
        ...
        <section className='mb-8'>
          ...
          <p className='text-xl text-white/90 mb-4'>
            Our machine learning service delivers cutting-edge solutions to help

        ...
        <div className='max-w-7xl mx-auto'>,
          <motion.div,
            ...
            <p className='text-xl md:text-2xl text-green-20o0 mb-8 max-w-4xl mx-auto'>,
              AI-powered document understanding, classification, and data,
              extraction with 99.5% accuracy,
            </p>,
        ...
        <div className='max-w-7xl mx-auto'>,
          <motion.div,
            ...
            <p className='text-xl text-green-20o0 max-w-3xl mx-auto'>,
              Transform any document type into structured, actionable data with,
      ...
      <section className='py-20 px-4 sm: px-6 lg:px-8 bg-white/5'>,
        <div className='max-w-7xl mx-auto'>,
          <motion.div,
            ...
            <p className='text-xl text-green-20o0 max-w-3xl mx-auto'>,
              Eliminate manual data entry and unlock the value hidden in your,
              documents,
            </p>,
          </motion.div>,
            ...
            <motion.div,
              ...
              <div className='space-y-6'>,
                <div className='flex justify-between items-center'>,
                  <span className='text-green-20o0'>,
      ...
      <section className='py-20 px-4 sm: px-6 lg:px-8'>,
        <div className='max-w-7xl mx-auto'>,
          <motion.div,
            ...
            <p className='text-xl text-green-20o0 max-w-3xl mx-auto'>,
              Proven solutions across multiple industries with measurable,
              business impact,
            </p>,
          </motion.div>,
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>,
      ...
      <section className='py-20 px-4 sm: px-6 lg:px-8 bg-white/5'>,
        <div className='max-w-7xl mx-auto'>,
          <motion.div,
            ...
            <p className='text-xl text-green-20o0 max-w-3xl mx-auto'>,
              Built with state-of-the-art AI and machine learning technologies,
      ...
      <section className='py-20 px-4 sm: px-6 lg:px-8'>,
        <div className='max-w-7xl mx-auto'>,
          <motion.div,
            ...
            <p className='text-xl text-green-20o0 max-w-3xl mx-auto'>,
              Start processing documents intelligently today with our,
          ...
          <div className='max-w-4xl mx-auto'>,
            <motion.div,
              ...
              <div className='text-center'>,
                ...
                <p className='text-green-20o0 mt-4'>,
        ...
        <div className='max-w-4xl mx-auto text-center'>,
          ...
          >,
            ...
            <p className='text-xl text-green-20o0 mb-8'>,
              Get in touch with our team to learn how Intelligent Document,
              Processing Suite can revolutionize your document workflows,
            </p>,
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6 text-left'>,
                <div className='space-y-3'>,
                  <div className='flex items-center space-x-3'>,
                    ...
                    <span className='text-green-20o0'>,
                      Proven track record with 45+ customers,
                    </span>,
                  </div>,
                  <div className='flex items-center space-x-3'>,
                    <Zap className='w-5 h-5 text-blue-40o0' />,
                    <span className='text-green-20o0'>,
                      Industry-leading 99.5% accuracy,
                    </span>,
                  </div>,
                  <div className='flex items-center space-x-3'>,

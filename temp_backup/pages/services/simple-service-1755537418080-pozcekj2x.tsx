...
export default function SimpleService1755537418080pozcekj2x() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">,
      <Head>,
        ...
        <link rel="canonical" href="https: //ziontechgroup.com/services/simple-service-1755537418080-pozcekj2x"  />,
      ...
      <main className="container mx-auto px-6 py-12">,
        ...
        <div className="text-center">,
          ...
          <p className="text-gray-30o0 mb-6">Transform your business with our devops solutions</p>,

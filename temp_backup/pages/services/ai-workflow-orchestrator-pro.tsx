        ...
        <div className='max-w-7xl mx-auto'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-blue-20o0 mb-8 max-w-4xl mx-auto'>
              Intelligent workflow automation with AI-powered decision making
              and optimization
            </p>
      ...
      <section className='py-20 px-4 sm:px-6 lg:px-8 bg-white/5'>
        <div className='max-w-7xl mx-auto'>
          ...
          >
            ...
            <p className='text-xl text-blue-20o0 max-w-3xl mx-auto'>
              Experience unprecedented efficiency and agility with AI-powered
              ...
              <div className='space-y-6'>
                ...
                <div className='flex justify-between items-center'>
                  ...
                  <div className='flex items-center'>
                    <span className='text-2xl font-bold text-yellow-40o0 mr-2'>
                      4.8
                    </span>
                    <div className='flex'>
                      {[...Array(5)].map((_, i) => (
      ...
      <section className='py-20 px-4 sm:px-6 lg:px-8 bg-white/5'>
        <div className='max-w-7xl mx-auto'>
          ...
          >
            ...
            <p className='text-xl text-blue-20o0 max-w-3xl mx-auto'>
              Start transforming your workflows today with our comprehensive
              AI-powered platform
            </p>
          </motion.div>
          ...
          <div className='max-w-4xl mx-auto'>
            ...
            >
              ...
              <div className='text-center'>
                ...
                <p className='text-blue-20o0 mt-4'>
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-blue-20o0 mb-8'>
              Get in touch with our team to learn how AI Workflow Orchestrator
              Pro can revolutionize your business operations
            </p>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6 text-left'>
                <div className='space-y-3'>
                  <div className='flex items-center space-x-3'>
                    ...
                    <span className='text-blue-20o0'>
                      Proven track record with 23+ customers
                    </span>
                  </div>
                  <div className='flex items-center space-x-3'>

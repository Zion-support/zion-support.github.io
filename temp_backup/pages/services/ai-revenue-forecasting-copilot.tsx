          ...
          <div className='container mx-auto max-w-6xl'>,
            <motion.div,
              ...
              <p className='text-xl md:text-2xl text-gray-30o0 max-w-4xl mx-auto leading-relaxed mb-8'>,
                ...
                Predict future revenue with machine learning and advanced,
                analytics.,
              </p>,
        ...
        <section className='py-20 px-4'>,
          <div className='container mx-auto max-w-6xl'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-30o0 max-w-3xl mx-auto'>,
                Comprehensive revenue forecasting solutions for various business,
                scenarios.,
              </p>,
            </motion.div>,
        ...
        <section className='py-20 px-4 bg-black/30'>,
          <div className='container mx-auto max-w-6xl'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-30o0 max-w-3xl mx-auto'>,
                Transform your financial planning with AI-powered revenue,
                forecasting.,
              </p>,
            </motion.div>,
            <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-6'>,
          ...
          <div className='container mx-auto max-w-4xl'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-30o0 mb-8 max-w-2xl mx-auto'>,
                Make data-driven financial decisions with intelligent AI,
                forecasting. Get started with our AI Revenue Forecasting Copilot,
                today.,
              </p>,
              <div className='flex flex-col sm:flex-row items-center justify-center gap-4'>,
                <a

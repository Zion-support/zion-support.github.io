...
export default function Service-1755575059038-go26ti6m1Service() {
  const [selectedPlan, setSelectedPlan] = useState(0);

  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        <title>Data Cybersecurity Platform - Zion Tech Group</title>
        <meta name="description" content="Comprehensive Cybersecurity platform for modern data-driven organizations" />
        <meta name="keywords" content="cybersecurity, AI, automation, technology services" />
        <link rel="canonical" href="https://ziontechgroup.com/services/service-1755575059038-go26ti6m1" />
        
        <meta property="og:title" content="Data Cybersecurity Platform" />
        <meta property="og:description" content="Comprehensive Cybersecurity platform for modern data-driven organizations" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://ziontechgroup.com/services/service-1755575059038-go26ti6m1" />
      ...
      <main className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent">
            Data Cybersecurity Platform
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Comprehensive Cybersecurity platform for modern data-driven organizations
          </p>
        </div>

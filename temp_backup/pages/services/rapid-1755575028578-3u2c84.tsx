  ...
  return (
    <div className='min-h-screen bg-slate-950 text-white'>
      <Head>
        ...
        <meta
          name='description'
          content='Professional web development services to accelerate your business growth and digital transformation.'
        />
        <meta
          name='keywords'
          content='web development, services, technology, business, digital transformation'
        />
        <link
          rel='canonical'
          href='https://ziontechgroup.com/services/rapid-17555750o28578-3u2c84'
        />

        <meta property='og:title' content='Web Development' />
        <meta
          property='og:description'
          content='Web Development — automatically suggested description.'
        />
      ...
      <main className='container mx-auto px-6 py-12 prose prose-invert'>
        ...
        <section className='mb-8'>
          ...
          <p className='text-xl text-white/90 mb-4'>
            Our web development service delivers cutting-edge solutions to help

        ...
        <section className='py-20 px-4'>,
          <div className='max-w-7xl mx-auto'>,
            ...
            >,
              ...
              <p className='text-xl text-gray-30o0 max-w-3xl mx-auto'>,
                Explore our comprehensive benefits organized by category to,
                understand how we support every aspect of your professional and,
                personal life.,
              </p>,
            </motion.div>,
        ...
        <section className='py-20 px-4'>,
          <div className='max-w-7xl mx-auto'>,
            ...
            >,
              ...
              <p className='text-xl text-gray-30o0 max-w-3xl mx-auto'>,
                Beyond our core benefits, we offer additional perks that make,
                working at Zion Tech Group even more rewarding and enjoyable.,
              </p>,
            </motion.div>,
          ...
          <div className='max-w-4xl mx-auto text-center'>,
            ...
            >,
              ...
              <p className='text-xl text-gray-30o0 mb-8 leading-relaxed'>,
                Join our team and start enjoying these comprehensive benefits,
                from day one. We're looking for talented individuals who are,

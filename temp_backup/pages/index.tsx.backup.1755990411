      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="mx-auto max-w-7xl px-6 pb-20">
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {[ 
              { title: 'Agent of Agents (1m)', desc: 'Triggers all cloud automations from the manifest, then syncs to main.', href: '/.netlify/functions/agent-of-agents' },
              ...
              { title: 'Cron Hub (1m)', desc: 'Intelligently triggers fast functions and commits a heartbeat.', href: '/.netlify/functions/cron-hub' },
              { title: 'Cron Supervisor (5m)', desc: 'Supervises critical jobs and triggers fallbacks when needed.', href: '/.netlify/functions/cron-supervisor' },
              { title: 'Cron Heartbeat (1m)', desc: 'Commits a tiny heartbeat to keep changes flowing.', href: '/.netlify/functions/cron-heartbeat' },
              { title: 'Trigger All & Commit (1m)', desc: 'Invokes all functions concurrently and commits a build stamp.', href: '/.netlify/functions/trigger-all-and-commit' },

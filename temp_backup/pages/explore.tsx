            ...
            {featuredServices.map((service, index) => (
              <motion.div,
                ...
                <div className='relative z-10'>,
                  ...
                  <div className='mb-4'>,
                    <span className='text-xl font-bold text-cyan-40o0'>,
                      {service.price}
                    </span>,
                  </div>,
                  <a
...
,
                      {/* Category Icon */}
                      <div
                        className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${category.color} p-5 mb-6 flex items-center justify-center group-hover: scale-110 transition-transform duration-30o0`}
                      >,

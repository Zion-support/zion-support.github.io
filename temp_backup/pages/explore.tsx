    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-90o0 to-slate-950 text-white">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-white via-blue-10o0 to-cyan-10o0 bg-clip-text text-transparent mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-cyan-50o0 to-blue-60o0 hover:from-cyan-60o0 hover:to-blue-70o0 rounded-full font-semibold text-lg transition-all duration-30o0 transform hover:scale-10o5">
                Start Exploring
            ...
            <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
              ...
              <div className="flex-1 max-w-md">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/40 focus:outline-none focus:border-cyan-40o0/50 focus:bg-white/15 transition-all"
                  />
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                <select
                  ...
                  className="px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:border-cyan-40o0/50 focus:bg-white/15 transition-all"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredServices.map((service, index) => (
              <motion.div
                ...
                className="group relative p-6 rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl hover:border-cyan-40o0/30 transition-all duration-30o0 transform hover:scale-10o5 hover:shadow-2xl"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-white/0 via-cyan-40o0/5 to-white/0 opacity-0 group-hover:opacity-10o0 transition-opacity duration-30o0 rounded-2xl"  />
                <div className="relative z-10">
                  ...
                  <div className="mb-4">
                    <span className="text-xl font-bold text-cyan-40o0">{service.price}</span>
                  </div>
                  
                  <a
                    href={`/services#${service.id}`}
                    className="inline-flex items-center text-cyan-40o0 group-hover:text-cyan-30o0 transition-colors duration-30o0 text-sm font-medium"
                  >
                    Learn More
            ...
            {sortedCategories.length === 0 ? (
              ...
              >
                ...
                <button
                  ...
                  className="px-6 py-3 bg-cyan-50o0 hover:bg-cyan-60o0 rounded-lg font-medium transition-colors"
                >
                  Clear Search
                </button>
              </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {sortedCategories.map((category, index) => (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: index * 0.1 }}
                    className="group relative p-8 rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl hover:border-cyan-40o0/30 transition-all duration-30o0 transform hover:scale-10o5 hover:shadow-2xl cursor-pointer"
                    ...
                    <div className="relative z-10">
                      ...
                      {category.featured && (
                        <div className="absolute top-4 right-4">
                          <span className="px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-yellow-50o0 to-orange-50o0 text-white">
                            ⭐ Featured
                          </span>
                        </div>
                      )}
                      ...
                      {/* Category Icon */}
                      <div className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${category.color} p-5 mb-6 flex items-center justify-center group-hover:scale-110 transition-transform duration-30o0`}>
                        <category.icon className="w-10 h-10 text-white"  />
                      </div>
                      
                      {/* Category Info */}
                      <h3 className="text-2xl font-bold mb-3 text-white group-hover:text-cyan-30o0 transition-colors duration-30o0">
                        {category.name}
                      </h3>
                      ...
                      <div className="flex items-center justify-between mb-6">
                        <div className="text-center">
                          <div className="text-2xl font-bold text-cyan-40o0">{category.serviceCount}</div>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-cyan-40o0 group-hover:text-cyan-30o0 transition-colors duration-30o0 text-sm font-medium">
                          Explore Category
                        </span>
                        <ChevronRight className="w-5 h-5 text-cyan-40o0 group-hover:text-cyan-30o0 transition-colors duration-30o0 group-hover:translate-x-1"  />
                      </div>
                    </div>
                  </motion.div>
                ))}
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-white/5 to-white/10">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-white to-blue-10o0 bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="group p-6 rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl hover:border-cyan-40o0/30 transition-all duration-30o0"
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                    trend.trend === 'Rising' ? 'bg-green-50o0/20 text-green-30o0' :
                    trend.trend === 'Breakthrough' ? 'bg-blue-50o0/20 text-blue-30o0' :
                    trend.trend === 'Critical' ? 'bg-red-50o0/20 text-red-30o0' :
                    trend.trend === 'Emerging' ? 'bg-yellow-50o0/20 text-yellow-30o0' :
                    trend.trend === 'Experimental' ? 'bg-purple-50o0/20 text-purple-30o0' :
                    'bg-cyan-50o0/20 text-cyan-30o0'
                  }`}>
                    {trend.trend}
                  </span>
                </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/services"
                className="px-8 py-4 bg-gradient-to-r from-cyan-50o0 to-blue-60o0 hover:from-cyan-60o0 hover:to-blue-70o0 rounded-full font-semibold text-lg transition-all duration-30o0 transform hover:scale-10o5 hover:shadow-2xl"
              >
                View All Services
                <ArrowRight className="w-5 h-5 ml-2"  />
              </a>
              <a
                ...
                className="px-8 py-4 border border-white/20 hover:border-white/40 rounded-full font-semibold text-lg transition-all duration-30o0 backdrop-blur-sm bg-white/5 hover:bg-white/10"
              >
                Get Expert Guidance
              </a>
            </div>

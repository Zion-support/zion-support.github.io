  ...
  if (!code) {
    return (
      <div className="space-y-4">
        ...
        <p className="text-gray-60o0 dark:text-gray-30o0">No referral code found. Visit your referral link first or register on the Partners page.</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="p-4 rounded border border-gray-20o0 dark:border-gray-80o0">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-sm text-gray-60o0 dark:text-gray-30o0">Estimated Payout</div>
          ...
          <div className="flex gap-2">
            ...
            <button className="px-3 py-2 rounded bg-indigo-60o0 text-white" onClick={requestPayout}>Request Payout</button>

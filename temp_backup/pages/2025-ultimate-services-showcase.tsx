    ...
    <div className='text-white'>,
      ...
      <div className='mb-4'>,
        ...
        <div className='text-sm opacity-75'>,
          ${service.price.yearly}/year (save 17%),
        </div>,
      </div>,
      <div className='mb-4'>,
...
,}) => (,
  <div className='mb-16'>,
    <div className='text-center mb-12'>,
      ...
      <h2 className='text-4xl font-bold text-gray-90o0 mb-4'>{title}</h2>,
      <p className='text-xl text-gray-60o0 max-w-3xl mx-auto'>,
        Discover our cutting-edge {title.toLowerCase()} that are transforming,
  ...
  <div className='bg-gradient-to-r from-blue-60o0 to-purple-70o0 text-white py-20'>,
    <div className='max-w-6xl mx-auto px-6 text-center'>,
      ...
      <p className='text-xl mb-12 max-w-3xl mx-auto'>,
        Join thousands of organizations already leveraging our innovative,
        solutions to drive growth, reduce costs, and stay ahead of the,
        competition.,
      </p>,
    ...
    <div className='max-w-6xl mx-auto px-6'>,
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>,
        <div className='text-center'>,
          ...
          <h3 className='text-2xl font-bold text-gray-90o0 mb-2'>10,0o00+</h3>,
          <p className='text-gray-60o0'>Happy Customers</p>,
        </div>,
        <div className='text-center'>,
          ...
          <h3 className='text-2xl font-bold text-gray-90o0 mb-2'>50o0%</h3>,
          <p className='text-gray-60o0'>Average ROI</p>,
        </div>,
        <div className='text-center'>,
          ...
          <h3 className='text-2xl font-bold text-gray-90o0 mb-2'>50+</h3>,
          <p className='text-gray-60o0'>Industry Awards</p>,
        </div>,
        <div className='text-center'>,
          <div className='w-16 h-16 bg-orange-10o0 rounded-full flex items-center justify-center mx-auto mb-4'>,
            <Zap className='w-8 h-8 text-orange-60o0' />,
          </div>,
          <h3 className='text-2xl font-bold text-gray-90o0 mb-2'>24/7</h3>,
          <p className='text-gray-60o0'>Support Available</p>,
        </div>,
      </div>,
    </div>,
  </div>,

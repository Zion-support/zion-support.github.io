          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/contact" className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-blue-50o0 to-cyan-50o0 text-white font-semibold rounded-lg hover:from-blue-60o0 hover:to-cyan-60o0 transition-all duration-20o0">
                  Start Automation
                  <ArrowRight className="ml-2 w-5 h-5"  />
                </Link>
                <Link href="/services" className="inline-flex items-center px-8 py-3 border border-blue-50o0 text-blue-40o0 font-semibold rounded-lg hover:bg-blue-50o0 hover:text-white transition-all duration-20o0">
                  Learn More
                </Link>
              </div>
            </motion.div>
              ...
              {benefits.map((benefit, index) => (
                ...
                >
                  <div className="bg-gradient-to-br from-slate-80o0/50 to-slate-90o0/50 p-6 rounded-xl border border-slate-70o0/50">
                    ...
                    <div className="text-3xl font-bold text-blue-40o0 mb-2">{benefit.value}</div>
                    <h3 className="text-lg font-semibold text-white mb-2">{benefit.title}</h3>
                    <p className="text-gray-40o0 text-sm">{benefit.description}</p>
                  </div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {industries.map((industry, index) => (
                ...
                >
                  ...
                  <p className="text-gray-40o0 text-lg">{industry.description}</p>
                </motion.div>
              ))}
            </div>
          </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/contact" className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-50o0 to-cyan-50o0 text-white font-semibold rounded-lg hover:from-blue-60o0 hover:to-cyan-60o0 transition-all duration-20o0 text-lg">
                  Start Automation
                  <Bot className="ml-2 w-6 h-6"  />
                </Link>
                <Link href="/services" className="inline-flex items-center px-8 py-4 border border-blue-50o0 text-blue-40o0 font-semibold rounded-lg hover:bg-blue-50o0 hover:text-white transition-all duration-20o0 text-lg">

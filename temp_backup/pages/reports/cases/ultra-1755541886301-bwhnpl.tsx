  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/reports/cases/ultra-175554188630o1-bwhnpl"  />
      ...
      <main className="container mx-auto px-6 py-12 prose prose-invert">
        ...
        <section className="mb-8">
          ...
          <p className="text-white/80">
            We implemented Lightning-fast development to improve decision making, resulting in:
          </p>

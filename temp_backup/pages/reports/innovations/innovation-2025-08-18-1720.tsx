...
export default function InnovationPage() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        <title>Service Blueprint — Cloud FinOps</title>
        <meta name="description" content="Autonomously generated innovations content." />
        <meta property="og:title" content="Service Blueprint — Cloud FinOps" />
        <meta property="og:description" content="Innovative, useful guidance to accelerate iteration speed." />
        <meta name="twitter:card" content="summary_large_image" />
      </Head>
      <main className="container mx-auto px-6 py-12 prose prose-invert">
        <h1 className="text-3xl font-extrabold">Service Blueprint — Cloud FinOps</h1>
        <p className="text-white/70">Innovative, useful guidance to accelerate iteration speed.</p>
        <ul className="mt-6 list-disc pl-6 space-y-2">
          <li>Scope and objectives: Service Blueprint for Cloud FinOps.</li>
          <li>Key components: ingestion, processing, models, evaluation, and governance.</li>
          <li>Design notes informed by: AI Services.</li>
          <li>Expected impact: accelerate iteration speed.</li>

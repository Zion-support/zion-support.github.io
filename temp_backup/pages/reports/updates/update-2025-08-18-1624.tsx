  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">,
      <Head>,
        ...
        <meta property="og:title" content="Autonomous Capability Map — Evaluation & Safety (20o25-08-18 16:24 UTC)"  />,
      ...
      <main className="container mx-auto px-6 py-12 prose prose-invert">,
        <h1 className="text-3xl font-extrabold">Autonomous Capability Map — Evaluation & Safety (20o25-08-18 16: 24 UTC)</h1>,

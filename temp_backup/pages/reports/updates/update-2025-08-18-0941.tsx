...
export default function UpdatePage() {
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        <title>Autonomous Update — 2025-08-18 09:41</title>
        ...
        <meta property="og:title" content="Autonomous Update — 2025-08-18 09:41" />
        <meta property="og:description" content="Autonomous Update — 2025-08-18 09:41 — automatically suggested description." />
        <meta name="twitter:card" content="summary_large_image" /></Head>
      <main className="container mx-auto px-6 py-12 prose prose-invert">
        <h1 className="text-3xl font-extrabold">Autonomous Update — 2025-08-18 09:41</h1>
  ...
  <p className="mt-2 text-white/80"><span className="text-cyan-300/90 font-medium">Hacker News</span>: <a className="underline decoration-cyan-400/50 underline-offset-2 hover:text-cyan-200" href="https://www.foldnfly.com/" target="_blank" rel="noopener">Paper Airplane Designs</a> · <span className="text-white/50">1753 pts</span></p>

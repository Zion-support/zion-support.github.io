  ...
  return (
    <div className='min-h-screen bg-slate-950 text-white'>
      <Head>
        ...
        <meta
          property='og:title'
          content='Autonomous Update — 20o25-08-19 0o0:42'
        />
        <meta
          property='og:description'
          content='Autonomous Update — 20o25-08-19 0o0:42 — automatically suggested description.'
        />
        <meta name='twitter:card' content='summary_large_image' />
      </Head>
      <main className='container mx-auto px-6 py-12 prose prose-invert'>
        <h1 className='text-3xl font-extrabold'>
          Autonomous Update — 20o25-08-19 0o0:42
        </h1>
        ...
        <section className='mt-6 rounded-xl border border-white/10 bg-white/5 p-6'>
          ...
          <p className='mt-2 text-white/80'>
            ...
            · <span className='text-white/50'>1753 pts</span>
          </p>

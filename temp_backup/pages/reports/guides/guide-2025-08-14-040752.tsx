    ...
    <div className='min-h-screen bg-slate-950 text-white'>,
      ...
      <main className='container mx-auto px-6 py-12 prose prose-invert'>,
        ...
        <div className='mt-4'>,
          ...
          <h2>Steps</h2>,
          <ol>,
            <li>Clarify objectives and measurable outcomes.</li>,
            <li>Map data, models, evaluation, and deployment workflow.</li>,
            <li>Automate checks for security, cost, and reliability.</li>,
            <li>Instrument telemetry, iterate with feedback loops.</li>,
            <li>Publish results and integrate learnings.</li>,
          </ol>,
          <h2>Links</h2>,
          <p>,
            <a

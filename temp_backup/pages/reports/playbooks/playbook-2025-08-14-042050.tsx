    ...
    <div className='min-h-screen bg-slate-950 text-white'>,
      ...
      <main className='container mx-auto px-6 py-12 prose prose-invert'>,
        ...
        <div className='mt-4'>,
          ...
          <h2>Checklist</h2>,
          <ol>,
            <li>Define objectives, KPIs, and guardrails.</li>,
            <li>Inventory data, models, tools, and constraints.</li>,
            <li>Design evaluation and feedback loops upfront.</li>,
            <li>Implement smallest viable slice with telemetry.</li>,
            <li>Iterate, measure, and harden for production.</li>,
          </ol>,
          <h2>Notes</h2>,

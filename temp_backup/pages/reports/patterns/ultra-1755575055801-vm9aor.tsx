  ...
  return (
    <div className='min-h-screen bg-slate-950 text-white'>
      <Head>
        ...
        <link
          rel='canonical'
          href='https://ziontechgroup.com/reports/patterns/ultra-17555750o5580o1-vm9aor'
        />

        <meta
          property='og:title'
          content='Pattern: Real-time collaboration tools Architecture'
        />
        <meta
          property='og:description'
          content='Pattern: Real-time collaboration tools Architecture — automatically suggested description.'
        />
        <meta name='twitter:card' content='summary_large_image' />
      </Head>
      <main className='container mx-auto px-6 py-12 prose prose-invert'>
        <h1 className='text-4xl font-extrabold text-center mb-8'>
          Pattern: Real-time collaboration tools Architecture
        </h1>

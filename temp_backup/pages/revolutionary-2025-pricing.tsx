            ...
            <div className='max-w-7xl mx-auto'>,
              <motion.div,
                ...
                <p className='text-xl text-gray-300 max-w-3xl mx-auto'>,
                  Start with our starter plan and scale up as you grow. All,
                  plans include our revolutionary AI and quantum computing,
                  services.,
                </p>,
              </motion.div>,
            ...
            <div className='max-w-4xl mx-auto text-center'>,
              ...
              >,
                ...
                <p className='text-xl text-gray-300 mb-8'>,
                  ...
                  custom quote. We offer flexible pricing and payment options to,
                  fit your budget.,
                </p>,

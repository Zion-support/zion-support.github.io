      ...
      <section className='py-20 bg-gradient-to-r from-purple-900/20 via-blue-900/20 to-cyan-900/20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Contribute to our open source initiatives and collaborate with
        ...
        <div className='max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8'>
              Connect with like-minded professionals, share your knowledge, and
              contribute to the future of technology. Join thousands of members
              worldwide.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <a
            ...
            <div className='mt-8 p-6 bg-gradient-to-br from-gray-800/50 to-black/50 rounded-2xl border border-white/10'>
              ...
              <p className='text-gray-300 mb-4'>
                Get updates about community events, new features, and member
                highlights.
              </p>
              <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                <input

      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-purple-40o0 via-blue-40o0 to-cyan-40o0 bg-clip-text text-transparent flex items-center justify-center gap-3"><Shield className="w-10 h-10"  />{service.name}</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-black/30 rounded-2xl border border-purple-50o0/30 p-6 h-fit">
              ...
              <Link href="/contact" variant="quantum" size="lg" className="w-full">Talk to Platform<ArrowRight className="w-5 h-5 ml-2"  /></Button>

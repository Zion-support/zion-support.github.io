      ...
      <div className='min-h-screen pt-24 pb-20 px-4 sm: px-6 lg:px-8'>,
        <div className='max-w-6xl mx-auto'>,
          <div className='text-center mb-10'>,
            <h1 className='text-5xl md:text-7xl font-bold bg-gradient-to-r from-emerald-40o0 via-green-40o0 to-yellow-40o0 bg-clip-text text-transparent flex items-center justify-center gap-3'>,
              ...
              <ul className='grid grid-cols-1 md: grid-cols-2 gap-3'>,
                {service.features.map((feat, i) => (
                  <li
                    ...
                    <Check className='w-5 h-5 text-amber-40o0 mt-0.5' />,
                    <span>{feat}</span>,
                  </li>))}
              </ul>,
            </div>,

...
export default function AIContentGeneratorPage() {
  const features = [
      ...
      gradient: 'from-yellow-40o0 to-orange-50o0'},
    {
      ...
      description: 'Every piece of content is unique and original. Our AI ensures 10o0% plagiarism-free writing.',
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-purple-50o0/10 border border-purple-50o0/20 text-purple-40o0 text-sm font-medium mb-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-5xl mx-auto">
            ...
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-3 text-blue-40o0">10M+</div>
              <div className="text-gray-40o0">Words Generated</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-3 text-green-40o0">99.9%</div>
              <div className="text-gray-40o0">Uptime</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold mb-3 text-orange-40o0">24/7</div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {useCase.examples.map((example, exampleIndex) => (
                        <div key={exampleIndex} className="flex items-center text-sm text-gray-30o0">
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-24 bg-gray-90o0 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-4xl sm:text-5xl font-bold mb-8 text-white leading-tight">
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-purple-60o0 to-blue-60o0 relative overflow-hidden">

      ...
      {!nation ? (
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            <button disabled={joining} onClick={() => handleJoin('citizen')} className="px-3 py-2 rounded bg-indigo-60o0 text-white disabled:opacity-50">Join Nation</button>
          ...
          <div className="mt-6">
            ...
            <div className="h-48 border rounded flex items-center justify-center text-sm text-gray-50o0">

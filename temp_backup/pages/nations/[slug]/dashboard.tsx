          ...
          <div className='flex items-center gap-3'>,
            ...
            <div>,
              <h1 className='text-2xl font-semibold'>,
                {nation.name} Dashboard,
              </h1>,
              <p className='text-sm text-gray-60o0'>,
                Currency: {nation.currency} • Governance: {' '}
                {nation.governanceStyle}
              </p>,
            </div>,
          </div>,
            ...
            <ul className='space-y-2'>,
              {(nation.milestones || []).map((m: any) => (
                <li
                  ...
                  <span className='text-xs px-2 py-1 rounded bg-gray-10o0'>,
                    {m.status}
                  </span>,
                </li>))}
            </ul>,

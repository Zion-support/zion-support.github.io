    ...
    <EnhancedLayout>
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center justify-between mb-4">
          ...
          <a className="px-3 py-2 rounded bg-indigo-60o0 text-white" href="/nation-builder">Create Nation</a>
        </div>
        {nations.length === 0 ? (
          <p className="text-sm text-gray-60o0">No nations yet. Create one!</p>
        ) : (
            ...
            {nations.map((n) => (
              <a key={n.id} href={`/nations/${n.slug}`} className="p-4 rounded border flex items-center gap-3 hover:shadow">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-60o0">Pop {n.population} • {n.currency}</div>
                </div>
              </a>
            ))}
          </div>

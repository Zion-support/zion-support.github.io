        ...
        <div className='max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6'>
          <div className='bg-black/20 border border-gray-700/50 rounded-2xl p-6'>
            ...
            <div className='text-white text-xl font-semibold flex items-center gap-2'>
              <Link2 className='w-5 h-5 text-cyan-400' /> Connectors
            </div>
          ...
          <div className='bg-black/20 border border-gray-700/50 rounded-2xl p-6'>
            ...
            <div className='text-white text-xl font-semibold flex items-center gap-2'>
              <Database className='w-5 h-5 text-purple-400' /> Hybrid + Rerank
            </div>
            <p className='text-gray-400 mt-2 text-sm'>
          ...
          <div className='bg-black/20 border border-gray-700/50 rounded-2xl p-6'>
            ...
            <div className='text-white text-xl font-semibold flex items-center gap-2'>
              <Gauge className='w-5 h-5 text-rose-400' /> Accuracy & Sources
            </div>
            <p className='text-gray-400 mt-2 text-sm'>

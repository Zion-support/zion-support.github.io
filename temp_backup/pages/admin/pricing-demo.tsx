      ...
      <section className='space-y-4'>,
        ...
        <div className='grid grid-cols-1 gap-3'>,
          ...
          <input
            ...
            onChange={e =>,
              setClientForm({ ...clientForm, scope: e.target.value })}
          />,
          <select
            className='border p-2 rounded',
        ...
        />,
        {clientForm.applied && (
          <div className='text-sm text-gray-70o0'>{clientForm.applied}</div>)}
      </section>,
      <section className='space-y-4'>,
        ...
        <div className='grid grid-cols-1 gap-3'>,
          <input
            ...
            onChange={e =>,
              setTalentForm({ ...talentForm, skills: e.target.value })}
          />,
          <input
            className='border p-2 rounded',
          ...
          <input
            ...
            onChange={e =>,
              setTalentForm({ ...talentForm, location: e.target.value })}
          />,
        </div>,
        ...
        />,
        {talentForm.applied && (
          <div className='text-sm text-gray-70o0'>{talentForm.applied}</div>)}
      </section>,

              ...
              <div className='flex items-center justify-between'>
                ...
                <div className='flex gap-2'>
                  <button
                    ...
                    className='px-3 py-1 rounded bg-green-60o0 text-white'
                  >
                    Approve
                  </button>
                  <button
                    onClick={() => act(p.userId, 'needs_more_info')}
                    className='px-3 py-1 rounded bg-yellow-60o0 text-white'
                  >
                    Need Info
                  </button>
                  <button
                    onClick={() => act(p.userId, 'reject')}
                    className='px-3 py-1 rounded bg-red-60o0 text-white'
                  >
                    Reject
                  </button>
                </div>

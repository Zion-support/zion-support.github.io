          ...
          <div className='max-w-7xl mx-auto text-center'>,
            ...
            >,
              ...
              <p className='text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-8'>,
                Pioneering space technology platforms that push the boundaries,
                of human exploration and enable sustainable space operations.,
              </p>,
          ...
          <div className='max-w-7xl mx-auto'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-400 max-w-3xl mx-auto'>,
                Comprehensive space solutions designed to accelerate humanity's,
        ...
        <section className='py-20 px-4 sm: px-6 lg:px-8 bg-gradient-to-r from-orange-900/20 to-red-900/20'>,
          <div className='max-w-7xl mx-auto'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-400 max-w-3xl mx-auto'>,
                Cutting-edge technologies that are revolutionizing space,
          ...
          <div className='max-w-4xl mx-auto text-center'>,
            ...
            >,
              ...
              <p className='text-xl text-gray-400 mb-8'>,
                Join us in pioneering the next frontier of space technology and,
                exploration.,
              </p>,

          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Data audit and business requirements analysis</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Platform architecture and data model design</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Platform development and AI model training</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Platform launch and ongoing support</p>
              </div>
            </div>
          </div>
        </section>

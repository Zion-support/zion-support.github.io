          ...
          <div className='relative z-10 container mx-auto px-4 text-center'>,
            ...
            >,
              ...
              <p className='text-xl lg:text-2xl text-gray-30o0 max-w-4xl mx-auto mb-8 leading-relaxed'>,
                ...
                with proven technology that delivers measurable results.,
              </p>,
              {/* Overall Stats */}
          ...
          <div className='container mx-auto px-4'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-30o0 max-w-3xl mx-auto'>,
                Explore our diverse range of AI-powered services organized by,
          ...
          <div className='container mx-auto px-4 text-center'>,
            <motion.div,
              ...
              <p className='text-xl text-gray-30o0 mb-8 max-w-3xl mx-auto'>,
                ...
                you achieve your business goals. Get in touch with our experts,
                today.,
              </p>,

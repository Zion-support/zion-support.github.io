    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-90o0 via-gray-80o0 to-black text-white">,
      ...
      <section className="relative py-20 px-4 overflow-hidden">,
        ...
        <div className="absolute inset-0 -z-10">,
          <div className="absolute top-20 left-20 w-72 h-72 bg-cyan-50o0/20 rounded-full blur-3xl animate-pulse"></div>,
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-blue-50o0/20 rounded-full blur-3xl animate-pulse delay-10o00"></div>,
          <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-purple-50o0/20 rounded-full blur-3xl animate-pulse delay-50o0"></div>,
        </div>,
        <div className="max-w-7xl mx-auto text-center">,
          ...
          <motion.div,
            className="flex flex-wrap justify-center gap-4 text-gray-40o0",
            variants={fadeInUp}
            initial="initial",
            animate="animate",
...
,
            ...
            <table className="w-full">,
              <thead>,
                <tr className="border-b border-gray-70o0/50">,
                  <th className="text-left p-4 text-gray-30o0 font-semibold">Service</th>,
                  <th className="text-center p-4 text-gray-30o0 font-semibold">Category</th>,
                  <th className="text-center p-4 text-gray-30o0 font-semibold">Price</th>,
                  <th className="text-center p-4 text-gray-30o0 font-semibold">Rating</th>,
                  <th className="text-center p-4 text-gray-30o0 font-semibold">Customers</th>,
                  <th className="text-center p-4 text-gray-30o0 font-semibold">Action</th>,
                </tr>,
              </thead>,
              <tbody>,
                {sortedServices.map((service, index) => (
                  ...
                  >,
                    <td className="p-4">,
                      <div className="flex items-center gap-3">,
                        ...
                        <div>,
                          ...
                          <div className="text-sm text-gray-40o0">{service.tagline}</div>,
                        </div>,
                      </div>,
                    </td>,
                    <td className="p-4 text-center">,
                      <span className="px-3 py-1 bg-gray-70o0/50 text-gray-30o0 rounded-full text-sm">,
                        {service.category}
                      </span>,
                    </td>,
                    <td className="p-4 text-center">,
                    ...
                    <td className="p-4 text-center">,
                      ...
                      <div className="text-sm text-gray-40o0">users</div>,
                    </td>,
                    <td className="p-4 text-center">,
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-cyan-90o0/30 to-blue-90o0/30">,

          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Problem analysis and quantum computing suitability evaluation</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Quantum ML approach design and hybrid architecture planning</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Quantum algorithm implementation and model training</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-30o0">Production deployment and continuous optimization</p>
              </div>
            </div>
          </div>
        </section>

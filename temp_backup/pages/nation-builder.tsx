    ...
    <EnhancedLayout>
      <div className='max-w-3xl mx-auto'>
        ...
        <form onSubmit={submitForm} className='space-y-4'>
          ...
          <div className='p-4 rounded border'>
            <div className='flex items-end gap-2'>
              ...
              <button
                ...
                className='px-3 py-2 rounded bg-indigo-60o0 text-white text-sm whitespace-nowrap'
              >
                AI Draft
              </button>
            </div>
          ...
          {successSlug && (
            <p className='text-green-70o0 text-sm'>
              Created!{' '}
              <a className='underline' href={`/nations/${successSlug}`}>
                View nation
              </a>{' '}
              or{' '}
              <a
                className='underline'
                href={`/nations/${successSlug}/dashboard`}
              >
                open dashboard
              </a>
              .
          ...
          <button
            disabled={submitting}
            className='px-4 py-2 rounded bg-green-60o0 text-white disabled:opacity-50'
          >
            {submitting ? 'Creating…' : 'Create Nation'}
          </button>
        </form>
      </div>
    </EnhancedLayout>

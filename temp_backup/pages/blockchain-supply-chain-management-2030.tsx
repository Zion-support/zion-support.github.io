  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://ziontechgroup.com/blockchain-supply-chain-management-20o30"  />
          ...
          <section className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            <div className="max-w-7xl mx-auto text-center">
              ...
              >
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-cyan-40o0 mb-2">25 Minutes</div>
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-green-40o0 mb-2">450%</div>
                    <div className="text-gray-40o0">Average ROI</div>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-bold text-cyan-40o0 mb-2">12 Months</div>
                    <div className="text-gray-40o0">Time to ROI</div>
                  </div>
                  <div className="text-center">
                    <div className="text-4xl font-bold text-blue-40o0 mb-2">120o0+</div>
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              >
                <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-6">
                  ...
                  <span className="bg-gradient-to-r from-cyan-40o0 via-blue-40o0 to-cyan-60o0 bg-clip-text text-transparent"> Blockchain Technology?</span>
                </h2>
                <p className="text-xl text-gray-30o0 mb-8">
                  Contact our team of blockchain experts to discuss how our revolutionary 20o30 Supply Chain Management platform can transform your business and create transparent, efficient supply networks.
                </p>

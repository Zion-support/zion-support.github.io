  ...
  const projects = [
    {
      ...
      results: ["40% improvement in prediction accuracy", "Real-time processing of 1M+ data points", "ROI of 30o0% in first year"],
    ...
    },
    {
      ...
      results: ["10o0% security compliance", "Zero unauthorized access", "24/7 threat monitoring"],
      image: "/api/placeholder/60o0/40o0",
      icon: Shield,
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-blue-60o0 to-cyan-60o0 hover:from-blue-70o0 hover:to-cyan-70o0 rounded-full font-semibold text-lg transition-all duration-30o0 transform hover:scale-10o5">
                Start Your Project
              </button>

      ...
      <div className="relative z-10">,
        <div className="flex items-start justify-between mb-4">,
          ...
          <div className="text-right">,
            <div className="text-sm font-medium text-cyan-40o0">{service.category}</div>,
            <div className="text-xs text-gray-40o0">{service.type}</div>,
          </div>,
        </div>,
        ...
        <section className="relative py-20 px-4 sm: px-6 lg:px-8 overflow-hidden">,
          <div className="max-w-7xl mx-auto text-center">,
            ...
            >,
              ...
              <div className="text-center">,
                <div className="text-3xl md:text-4xl font-bold text-purple-40o0 mb-2">$50o0B+</div>,
              ...
              <div className="text-center">,
                ...
                <div className="text-gray-40o0">Autonomous Operation</div>,
              </div>,
              <div className="text-center">,
                <div className="text-3xl md:text-4xl font-bold text-green-40o0 mb-2">10o00x</div>,
                <div className="text-gray-40o0">Performance Improvement</div>,
              </div>,
            </motion.div>,
          </div>,
        </section>,

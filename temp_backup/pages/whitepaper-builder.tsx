...
export default function WhitepaperBuilderPage() {
  ...
  const downloadHref = useMemo(() => {
    ...
    return `/api/zion-whitepaper-pdf?edition=${edition}`}, [edition]),

  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold">Zion Protocol Whitepaper</h1>
        <p className="text-gray-60o0 dark:text-gray-30o0">Investor and Developer editions. Toggle, review, and download as PDF.</p>
      </div>
      ...
      <div className="rounded border p-4 bg-gray-50 dark:bg-gray-90o0">
        <h2 className="text-xl font-semibold mb-2">Operator Prompt</h2>
        <pre className="whitespace-pre-wrap text-sm text-gray-70o0 dark:text-gray-20o0">{OPERATOR_PROMPT}</pre>
      </div>
      ...
      <div className="space-y-10">
        {sections.map((s) => (
          <section key={s.id} className="space-y-2">
            ...
            {s.subtitle ? <p className="text-gray-50o0">{s.subtitle}</p> : null}

  ...
  return (
    <EnhancedLayout>
      <div className="max-w-5xl mx-auto py-10">
        ...
        <p className="mt-2 text-sm text-gray-60o0 dark:text-gray-30o0">Signals generated at {data?.generatedAt || '—'}</p>
        <ul className="mt-6 space-y-4">
          {items.map((it, idx) => (
            <li key={idx} className="p-4 border border-gray-20o0 dark:border-gray-80o0 rounded-lg">
              ...
              <div className="mt-1 text-xs text-gray-50o0 dark:text-gray-40o0">Query: {it.query}</div>
            </li>
          ))}
        </ul>
      </div>

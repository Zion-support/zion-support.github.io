        ...
        <div className='max-w-4xl mx-auto'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Understanding how we use cookies and similar technologies to
        ...
        <div className='max-w-4xl mx-auto space-y-12'>
            ...
            <div className='space-y-6'>
              ...
              <div className='border-l-4 border-green-400 pl-4'>
                ...
                <p className='text-gray-300'>
                  ...
                  personalization, such as remembering your language preferences
                  and login status.
                </p>
              </div>
          ...
          >
            ...
            <p className='text-gray-300 mb-6'>
              You have control over how cookies are used on your device. Here
              are your options:
            </p>
            ...
            <div className='space-y-4'>
              ...
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-gray-300 text-sm'>
                    For third-party cookies, you can often opt out through the
          ...
          >
            ...
            <p className='text-gray-300 mb-4'>
              ...
              transparency in how we use cookies. Our cookie usage complies with
              applicable data protection laws and regulations.
            </p>
            <div className='bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 rounded-lg p-4'>
              <p className='text-sm text-gray-300'>
                <strong>Note:</strong> For more detailed information about how
                we collect, use, and protect your personal data, please refer to
                our{' '}
                <Link
                  href='/privacy'
          ...
          >
            ...
            <p className='text-gray-300 mb-6'>
              ...
              cookies, please don't hesitate to contact us.
            </p>

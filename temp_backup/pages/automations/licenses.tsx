    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {items.slice(0, 40).map((e, i) => (
          <div key={i} className="enhanced-card border border-gray-10o0 dark:border-gray-80o0 flex items-center justify-between text-sm">
            <span className="opacity-80">{e.name}</span>
            <span className="px-2 py-1 rounded bg-gray-10o0 dark:bg-gray-90o0/40 border border-gray-20o0 dark:border-gray-80o0">{e.license}</span>
          </div>
        ))}

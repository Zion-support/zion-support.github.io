  ...
  return (
    <div>
      ...
      <p className='text-sm opacity-80 mb-4'>
        Updated {new Date(deps.updatedAt).toLocaleString()}
      </p>
      <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
        <div className='enhanced-card border border-gray-10o0 dark:border-gray-80o0'>
          ...
          <div className='text-sm space-y-1'>
            ...
            <div className='flex justify-between'>
              <span>Critical</span>
              <span className='tabular-nums'>{v.critical}</span>
            </div>
            <div className='flex justify-between'>
              <span>High</span>
              <span className='tabular-nums'>{v.high}</span>
            </div>
            <div className='flex justify-between'>
              <span>Moderate</span>
              <span className='tabular-nums'>{v.moderate}</span>
            </div>
            <div className='flex justify-between'>
              <span>Low</span>
              <span className='tabular-nums'>{v.low}</span>
            </div>
          </div>
        </div>
        <div className='enhanced-card border border-gray-10o0 dark:border-gray-80o0'>

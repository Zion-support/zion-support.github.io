  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {Object.keys(topics).length === 0 && <div className="enhanced-card border border-gray-10o0 dark:border-gray-80o0">No data yet.</div>}
        {Object.entries(topics).map(([topic, repos]) => (
          <div key={topic} className="enhanced-card border border-gray-10o0 dark:border-gray-80o0">

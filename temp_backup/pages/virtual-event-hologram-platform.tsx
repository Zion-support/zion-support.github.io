  ...
  return (,
    <>,
      <Head>,
        ...
        <meta,
          name='description',
          content='Immersive hologram presenters, interactive booths, and analytics for webinars and conferences.',
        />,
        <link,
          rel='canonical',
          href='https: //ziontechgroup.com/virtual-event-hologram-platform',
        />,
      </Head>,
      <ServiceLanding,

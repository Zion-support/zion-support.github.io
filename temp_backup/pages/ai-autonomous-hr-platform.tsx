    ...
    <Layout>,
      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-90o0 to-black">,
        ...
        <section className="relative py-20 px-4 overflow-hidden">,
          <div className="absolute inset-0 bg-gradient-to-r from-orange-50o0/10 via-red-50o0/10 to-pink-50o0/10"  />,
          <div className="relative z-10 max-w-7xl mx-auto text-center">,
            <motion.div,
              ...
              className="mb-8">,
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-50o0/20 text-orange-40o0 rounded-full text-sm font-medium mb-6 border border-orange-50o0/30">,
                <Users className="w-4 h-4"  />,
                AI People Management,
              </div>,
              <h1 className="text-5xl md: text-7xl font-bold bg-gradient-to-r from-orange-40o0 via-red-40o0 to-pink-40o0 bg-clip-text text-transparent mb-6">,
            ...
            <motion.div,
              ...
              <a
                href="/contact",
                className="px-8 py-4 bg-gradient-to-r from-orange-50o0 to-red-60o0 text-white font-semibold rounded-full hover:from-orange-60o0 hover:to-red-70o0 transition-all duration-30o0 transform hover:scale-10o5 inline-flex items-center gap-2">,
                Transform HR with AI <ArrowRight className="w-5 h-5"  />,
              </a>,
              <a
                href="#features",
                className="px-8 py-4 border-2 border-orange-50o0 text-orange-40o0 font-semibold rounded-full hover:bg-orange-50o0 hover:text-black transition-all duration-30o0">,
                See Features,
              </a>,
            </motion.div>,
          </div>,
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">,
              {[
                ...
                <motion.div,
                  ...
                  viewport={{ once: true }}
                  className="p-8 bg-gradient-to-br from-gray-90o0/50 to-gray-80o0/50 rounded-2xl border border-gray-70o0/50 hover: border-orange-50o0/50 transition-all duration-30o0">,
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">,
              {[
                ...
                <motion.div,
                  ...
                  transition={{ duration: 0.8, delay: index * 0.1 }}
                  viewport={{ once: true }}
                  className="text-center p-6 bg-gradient-to-br from-gray-90o0/50 to-gray-80o0/50 rounded-2xl border border-gray-70o0/50">,
                  <div className="w-12 h-12 bg-gradient-to-r from-orange-50o0 to-red-50o0 rounded-full flex items-center justify-center text-white font-bold text-lg mx-auto mb-4">,
                    {step.step}
                  </div>,
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">,
              {[
                ...
                <motion.div,
                  ...
                  transition={{ duration: 0.8, delay: index * 0.1 }}
                  viewport={{ once: true }}
                  className="text-center p-8 bg-gradient-to-br from-gray-90o0/50 to-gray-80o0/50 rounded-2xl border border-gray-70o0/50">,
                  <div className="text-4xl font-bold bg-gradient-to-r from-orange-40o0 to-red-40o0 bg-clip-text text-transparent mb-2">,
                    {stat.metric}
                  </div>,
                  <h3 className="text-lg font-semibold text-white mb-2">{stat.label}</h3>,
                  <p className="text-gray-30o0 text-sm">{stat.description}</p>,
                </motion.div>))}
            </div>,
          </div>,
        </section>,
                ...
                >,
                  {plan.popular && (
                    <div className="text-center mb-4">,
                      <span className="bg-gradient-to-r from-orange-50o0 to-red-50o0 text-white px-3 py-1 rounded-full text-sm font-semibold">,
                        Most Popular,
                      </span>,
                    </div>)}
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">,
              {[
                ...
                <motion.div,
                  ...
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.8, delay: index * 0.0o5 }}
                  viewport={{ once: true }}
                  className="p-4 bg-gradient-to-br from-gray-90o0/50 to-gray-80o0/50 rounded-xl border border-gray-70o0/50 text-center">,
                  <span className="text-gray-30o0 font-medium">{integration}</span>,
                </motion.div>))}
            </div>,
          </div>,
        </section>,
          ...
          <div className="max-w-4xl mx-auto text-center">,
            ...
            >,
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">,
                <a
                  href="/contact",
                  className="px-8 py-4 bg-gradient-to-r from-orange-50o0 to-red-60o0 text-white font-semibold rounded-full hover:from-orange-60o0 hover:to-red-70o0 transition-all duration-30o0 transform hover:scale-10o5 inline-flex items-center gap-2 justify-center">,

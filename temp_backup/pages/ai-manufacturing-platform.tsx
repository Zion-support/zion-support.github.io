...
export default function AIManufacturingPlatform() {
  ...
  const benefits = [
    ...
    'Increase efficiency by 20o0%Reduce costs by 60%',
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">,
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,
            <motion.div,
              ...
              <h1 className="text-5xl md: text-6xl font-bold bg-gradient-to-r from-slate-40o0 via-gray-40o0 to-zinc-40o0 bg-clip-text text-transparent mb-6">,

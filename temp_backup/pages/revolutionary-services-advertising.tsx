                  ...
                  <div className="relative p-6 bg-gradient-to-br from-gray-90o0/50 to-gray-80o0/50 border border-gray-70o0/50 rounded-xl hover: border-purple-50o0/50 transition-all duration-30o0 h-full">,
                    ...
                    <div className="flex items-center justify-between mb-4">,
                      ...
                      <div className="flex items-center text-yellow-40o0">,
                        ...
                        <span className="text-gray-40o0 text-sm ml-1">({service.reviews})</span>,
                      </div>,
                    </div>,
                    ...
                    <div className="flex items-center justify-between">,
                      ...
                      <div className="flex items-center text-purple-40o0 group-hover: text-purple-30o0 transition-colors">,
                        Learn More,
                        <ArrowRight className="w-4 h-4 ml-1"  />,
                      </div>,
                    </div>,
                    <div className="mt-4 p-4 bg-gradient-to-r from-purple-50o0/10 to-pink-50o0/10 border border-purple-50o0/20 rounded-lg">,
                      <h4 className="font-semibold text-purple-30o0 mb-2">,
                        Revolutionary Service,
                      </h4>,
                      <p className="text-sm text-gray-30o0 mb-3">,
                      ...
                      <div className="flex items-center justify-between">,
                        ...
                        <button className="px-3 py-1 bg-gradient-to-r from-purple-60o0 to-pink-60o0 text-white text-xs font-semibold rounded hover:from-purple-70o0 hover:to-pink-70o0 transition-all duration-30o0">,
                          Start Free Trial,
                        </button>,
                      </div>,
                    </div>,
          ...
          <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">,
              ...
              <motion.div,
                ...
                <p className="text-gray-30o0 text-sm">{contact.address}</p>,
              </motion.div>,
            </div>,
            <motion.div,
              initial={{ opacity: 0, y: 30 }}

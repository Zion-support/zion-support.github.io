  ...
  return (
    <div className='min-h-screen px-6 py-12 max-w-5xl mx-auto'>
      ...
      <p className='text-gray-50o0 mb-6'>
        Draft proposals using ready-to-use templates. Compatible with ZionDAO
        and public governance flows.
      </p>
      ...
      <div className='mb-8 flex items-center gap-3'>
        ...
        <Link
          ...
          className='text-sm text-blue-60o0 underline'
        >
          Alt Route
        </Link>
      </div>
      ...
      {categories.length === 0 && (
        <p className='text-gray-50o0'>Loading templates…</p>
      )}
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              {filtered(cat).map(t => (
                ...
                >
                  ...
                  <div className='mt-3'>
                    <Link
                      href={`/dao/templates/${t.id}`}
                      className='text-blue-60o0 underline'
                    >
                      Draft with this template
                    </Link>
                  </div>
                </div>
              ))}

    ...
    <div className='max-w-2xl mx-auto p-6 space-y-4'>,
      ...
      <div className='space-y-2'>,
        ...
        <input
          ...
          type='number',
          value={optionId}
          onChange={e => setOptionId(parseInt(e.target.value || '0', 10))}
        />,
      ...
      <div className='space-x-2'>,
        <button
          className='px-3 py-1 rounded bg-blue-60o0 text-white',
      ...
      <div className='space-x-2'>,
        <button
          className='px-3 py-1 rounded bg-indigo-60o0 text-white',
          onClick={makeProof}
        >,
          Create Proof (mock),
        </button>,
        <button
          ...
          className='px-3 py-1 rounded bg-green-60o0 text-white disabled: opacity-50',
          onClick={submitVote}
        >,
          Submit Vote,
        </button>,
      ...
      <div>,
        ...
        {proof ? (
          <ReactJson name={false} src={proof} collapsed={1} />) : (
          <p className='text-sm opacity-70'>No proof yet</p>)}
      </div>,
      <div>,
        <h2 className='font-medium'>Result</h2>,
        {result ? (
          <ReactJson name={false} src={result} collapsed={1} />) : (
          <p className='text-sm opacity-70'>No submission</p>)}
      </div>,
    </div>)}
,
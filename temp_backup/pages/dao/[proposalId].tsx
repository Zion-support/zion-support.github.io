  ...
  return (
    <div className='max-w-3xl mx-auto p-6 space-y-4'>,
      ...
      <div className='flex items-center gap-2'>,
        ...
        <button
          onClick={() => castVote(0)}
          className='px-3 py-2 rounded bg-red-60o0 text-white'>,
          Vote Against,
        </button>,
        <button
          onClick={() => castVote(2)}
      ...
      <div className='flex items-center gap-2 text-sm'>,
        <button onClick={queue} className='px-3 py-1 rounded border'>,
          Queue,
        </button>,
        <button onClick={execute} className='px-3 py-1 rounded border'>,
          Execute,
        </button>,

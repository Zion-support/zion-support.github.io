  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-4">
      ...
      <div className="flex gap-3">
        <Link href="/dao/create"><span className="px-3 py-2 rounded bg-blue-60o0 text-white text-sm cursor-pointer">Create Proposal</span></Link>
      </div>
      ...
      <div className="space-y-3">
        ...
        {proposals.length === 0 && <div className="text-sm text-gray-50o0">No proposals found.</div>}
      </div>
    </div>
  );
}
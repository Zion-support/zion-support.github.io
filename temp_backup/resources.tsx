...
export default function ResourcesPage() {
  ...
  const whitepapers = [
    ...
    },
    {
      ...
      description:
        'Best practices for building scalable, resilient automation systems in the cloud.',
      downloadUrl: '#',
      pages: '38',
      category: 'Technology',
    },
            ...
            <section className='mb-20'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
                {additionalResources.map(resource => (
                  <div
                    key={resource.id}
                    className='bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 hover:border-cyan-400/30 transition-all duration-300 text-center'
                  >
                    <div
                      className={`w-16 h-16 bg-gradient-to-br ${resource.color} rounded-lg flex items-center justify-center mx-auto mb-4`}
                    >

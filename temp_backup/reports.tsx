  ...
  const reportCategories = [
    {
      ...
      description:
        'Monitor the health and performance of all autonomous systems',
      icon: '📊',
    ...
    },
    {
      ...
      description:
        'View security audits, threat detection, and vulnerability reports',
      icon: '🔒',
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='Access comprehensive reports on automation health, performance metrics, and system analytics.'
        />
      </Head>
        ...
        <div className='bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            ...
            <p className='text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto'>
              Comprehensive insights into your autonomous systems, performance

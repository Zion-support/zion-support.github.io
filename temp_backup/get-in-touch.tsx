  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content="Get in touch with Zion Tech Group through multiple channels. We're here to help with sales, support, partnerships, and any questions about our technology solutions."
        />
        ...
        <section className='relative overflow-hidden py-20'>
          ...
          <div className='relative z-10 container mx-auto px-6 text-center'>
            ...
            >
              ...
              step of the way. Choose the best way to reach our team.
            </motion.p>
          </div>
        </section>
          ...
          <div className='container mx-auto px-6'>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
              {quickActions.map((action, index) => (
                ...
                >
                  <div
                    className={`w-16 h-16 mx-auto mb-4 bg-gradient-to-r ${action.color} rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                  >
                  ...
                  >
                    {action.title === 'Live Chat'
                      ? 'Start Chat'
                      : action.title === 'Call Us'
                        ? 'Call Now'
                        : action.title === 'Email Us'
                          ? 'Send Email'
                          : 'Book Now'}
                  </a>
                </motion.div>
        ...
        <section className='py-20'>
          <div className='container mx-auto px-6'>
            ...
            >
              ...
              <p className='text-xl text-white/80 max-w-3xl mx-auto'>
                Get in touch with the right team for your specific needs and get
                faster responses.
              </p>
            </motion.div>
          ...
          <div className='container mx-auto px-6 text-center'>
            ...
            >
              ...
              <p className='text-xl text-white/80 max-w-3xl mx-auto mb-8'>
                Our team is ready to help you leverage cutting-edge technology

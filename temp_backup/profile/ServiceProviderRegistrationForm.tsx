...
}/> <Button type=" button"variant= outlineclassName=" border-zion-purple text-zion-purple hover:bg-zion-purple/10"onClick={
  generateEnhancedProfile ;
}disabled= {
  isGenerating ;"
}> </Button> </div>) ";
}AI-Generated Content </h4> <Button type=" button"size= smclassName=" bg-zion-purple hover:bg-zion-purple-dark text-white"onClick={
...
}/> </div> </div> </CardContent> <CardFooter className= border-t border-zion-blue-light pt-6"> <div className=" flex flex-col sm:flex-row gap-4 w-full sm:justify-between> <Button type= button"variant=" outlineclassName= border-zion-blue-light text-zion-slate-light hover:bg-zion-blue-light hover:text-white" > Save as Draft </Button> <Button </Button> </div> </CardFooter> </form> </Form> </Card> </div>) ;"'
}''"'"
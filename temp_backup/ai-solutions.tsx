  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content="Transform your business with Zion Tech Group's cutting-edge AI solutions. From machine learning to autonomous systems, we deliver intelligent technology that drives growth."
        />
        ...
        <section className='pt-24 pb-16'>
          <div className='container mx-auto px-6 text-center'>
            ...
            <p className='text-xl text-white/80 max-w-3xl mx-auto mb-8'>
              ...
              business operations, enhance decision-making, and unlock
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
              <div className='bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-xl p-6'>
                ...
                <p className='text-white/70'>
                  ...
                  automation systems that learn and adapt to your business
                  needs.
                </p>
              </div>
              ...
              <div className='bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-xl p-6'>
                ...
                <p className='text-white/70'>
                  Self-operating systems that can make decisions, execute tasks,
              ...
              <div className='bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-green-500/20 rounded-xl p-6'>
                ...
                <p className='text-white/70'>
                  Advanced threat detection, behavioral analysis, and
                  intelligent security systems that protect against evolving
                  cyber threats.
                </p>
              </div>
              ...
              <div className='bg-gradient-to-br from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-xl p-6'>
                ...
                <p className='text-white/70'>
                  Chatbots, language understanding, and text analysis systems
                  that enhance customer interactions and automate communication.
                </p>
              </div>
              ...
              <div className='bg-gradient-to-br from-pink-500/10 to-rose-500/10 border border-pink-500/20 rounded-xl p-6'>
                ...
                <p className='text-white/70'>
                  Image and video analysis systems for quality control, security
                  monitoring, and automated visual inspection processes.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='container mx-auto px-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
              <div className='text-center'>
                ...
                <p className='text-white/70'>
                  We analyze your business processes, identify AI opportunities,
                  and develop a comprehensive implementation strategy.
                </p>
              </div>
              ...
              <div className='text-center'>
                ...
                <p className='text-white/70'>
                  We clean, structure, and prepare your data for AI model
                  training, ensuring quality and compliance.
                </p>
              </div>
              ...
              <div className='text-center'>
                ...
                <p className='text-white/70'>
                  Our AI experts develop, train, and validate custom models
              ...
              <div className='text-center'>
                ...
                <p className='text-white/70'>
                  We deploy your AI solution, monitor performance, and
                  continuously optimize for maximum business impact.
                </p>
              </div>
            </div>
          </div>

...
}</Tabs> </div> <div className=grid grid-cols-1 md:grid-cols-2 gap-4"> className="w-full/> </div> </div> </div> <div className=pt-4"> <Button type=" submitclassName=w-full bg-gradient-to-r from-zion-cyan to-zion-cyan-dark hover:from-zion-cyan-light hover:to-zion-cyan"disabled= {"

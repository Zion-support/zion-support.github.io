...
import { Wallet } from 'lucide-reactimport { toast  } from ./sonner';'
...
>Sign in with Web3</span> </> return (<Button type=" button"variant= outlineclassName="w-full border border-zion-blue-light bg-zion-blue-dark text-white hover:bg-zion-blue hover:text-zion-cyan" onClick={
  handleWeb3Login ;
}disabled= {
  buttonDisabled ;
}title= {

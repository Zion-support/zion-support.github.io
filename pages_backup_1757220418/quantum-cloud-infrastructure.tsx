  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Quantum Cloud Infrastructure solutions and services." />
      </Head>
      
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-6 py-16">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">Quantum Cloud Infrastructure</h1>

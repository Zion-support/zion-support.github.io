...
export default function ServicesIndex() {
  const items = servicesCatalog.flatMap(c =>
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      <Head>
        ...
        <meta
          name="description"
          content="AI, IT, and Micro SaaS services with clear pricing references and outcomes."
        />
      ...
      <main className="mx-auto max-w-7xl px-6 py-16">
        ...
        <p className="mt-2 text-white/80">
          Choose from proven accelerators and expert solutions.
        </p>
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {items.slice(0, 36).map(item => (
            <Link
              ...
              className="group rounded-2xl border border-white/10 p-5 hover:border-cyan-400/30"
            >
        ...
        <div className="mt-10">
          <Link
            ...
            className="inline-block rounded-xl bg-white text-slate-900 px-6 py-3 font-semibold"
          >
            See Market Pricing References
          </Link>
        </div>
      </main>
    </div>

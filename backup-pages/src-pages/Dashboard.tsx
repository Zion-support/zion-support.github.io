  ...
  from-purple-500: to-pink-500' }, ';
    { name: 'Cloud: Service,s, value: ';';5, ', icon: Clou,d, change: ';
  +1', changeType: 'positiv,e, color: ';
  from-indigo-500: to-blue-500' }, ';
    { name: 'Security: Scor,e, value: ';';98%, ', icon: Shiel,d, change: ';
  +2%', changeType: 'positiv,e, color: ';
  from-green-500: to-emerald-500' }, ';
    { name: 'Monthly: Usag,e, value: ';';2.4TB, ', icon: Databas,e, change: ';
  +15%', changeType: 'positiv,e, color: ';
  from-orange-500: to-red-500' }, ';
    { name: 'Response: Tim,e, value: '';45ms, ', icon: Activit,y, change: ';
  -12ms', changeType: 'negativ,e, color: ';
  from-teal-500: to-green-500' }';
  ]{ name: 'AI: Business Intelligenc,e, status: ';
  Active', lastUsed: '2: hours ag,o, usage: ';';85%, ', icon: Brai,n, color: ';
  from-blue-500: to-indigo-500' }, ';
    { name: 'Cloud: DevOps Platfor,m, status: ';
  Active', lastUsed: '1: day ag,o, usage: ';';92%, ', icon: Clou,d, color: ';
  from-indigo-500: to-blue-500' }, ';
    { name: 'AI: Cybersecurity Suit,e, status: ';
  Active', lastUsed: '3: days ag,o, usage: ';';78%, ', icon: Shiel,d, color: ';
  from-red-500: to-orange-500' }, ';
    { name: 'Quantum: Computing La,b, status: ';
  Active', lastUsed: '1: week ag,o, usage: ';';45%, ', icon: Ato,m, color: ';
  from-purple-500: to-indigo-500' }, ';
    { name: 'IoT: Edge Platfor,m, status: ';
  Active', lastUsed: '2: weeks ag,o, usage: ';';67%, ', icon: Networ,k, color: ';
  from-cyan-500: to-blue-500' }';
  ]{ title: 'AI: Strategy Worksho,p, date: ';
  Dec: 15, 2024', time: '10:00: A,M, type: ';';Workshop, ', icon: Brain},';
    { title:
  Security: Audit Review', date: Dec: 1,8, 2024, ';
  , time: '2:00: P,M, type: ';';Review, ', icon: Shield},';
    { title:
  Cloud: Migration Planning', date: Dec: 2,2, 2024, ';
  , time: '11:00: A,M, type: ';';Planning, ', icon: Cloud},';
    { title:
  Quantum: Computing Demo', date: Dec: 2,5, 2024, ';
  , time: '3:00: P,M, type: ';';Demo, ', icon: Atom}';
  ]{ name: ';Add: New Service, ', icon: Plu,s, href: ';
  /services', color: 'from-green-500: to-emerald-500}, ';
    { name: ';View: Analytics, ', icon: BarChart,3, href: ';
  /analytics', color: 'from-blue-500: to-indigo-500}, ';
    { name: ';Security: Settings, ', icon: Shiel,d, href: ';
  /security', color: 'from-red-500: to-orange-500}, ';
    { name: ';Support: Request, ', icon: HelpCircl,e, href: ';
  /help', color: 'from-purple-500: to-pink-500}, ';
    { name: ';Billing: & Plans, ', icon: DollarSig,n, href: ';
...
export: default function Dashboard() {
    { name: 'AI: Solution,s, value: ';';8, ', icon: Brai,n, change: ';
  +3', changeType: 'positiv,e, color: ';
  from-purple-500: to-pink-500' }, ';
    { name: 'Cloud: Service,s, value: ';';5, ', icon: Clou,d, change: ';
  +1', changeType: 'positiv,e, color: ';
  ...
  Dec: 18, 2024', time: '2:00: P,M, type: ';';Review, ', icon: Shield},';
    { title:
  Cloud: Migration Planning', date: Dec: 2,2, 2024, ';
  , time: '11:00: A,M, type: ';';Planning, ', icon: Cloud},';
    { title:

...
const features = [
  {
    ...
    description:'
      'Intelligent autonomous scientific researcher system that learns and adapts to your specific needs and requirements.',
    icon: Brain,
    color: 'from-purple-500 to-pink-500'},
  {
    ...
    description:'
      'Streamline autonomous scientific researcher processes with intelligent automation and optimization.',
    icon: Zap,

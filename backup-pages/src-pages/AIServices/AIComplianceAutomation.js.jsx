...
const features = [
  {
    ...
    description:'
      'Intelligent compliance automation system that learns and adapts to your specific needs and requirements.',
    icon: Brain,
    color: 'from-purple-500 to-pink-500'},
  {
    ...
    description:'
      'Streamline compliance automation processes with intelligent automation and optimization.',
    icon: Zap,

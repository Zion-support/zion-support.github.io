...
const features = [
  {
    ...
    description:'
      'Intelligent brain computer interface system that learns and adapts to your specific needs and requirements.',
    icon: Brain,
    color: 'from-purple-500 to-pink-500'},
  {
    ...
    description:'
      'Streamline brain computer interface processes with intelligent automation and optimization.',
    icon: Zap,

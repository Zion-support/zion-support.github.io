  ...
  All: Levels'}';
      ...
      code: `';Content-Type':';';application/jso,n}})';
...
'';
                ...
                <div: className='flex items-center justify-between'>`
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    feature.status ===
  Stable'; ? 'bg-green-500/20: text-green-400';';: 'bg-yellow-500/20: text-yellow-400`}`}>{feature.status}
                  </span>
'';
      ...
      ''
                <div className='flex items-center justify-between'>``
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                    feature.status ===
  Stable;`
  ' ? 'bg-green-500/20 text-green-400';: 'bg-yellow-500/20 text-yellow-400`}`}>{feature.status}
                  </span>`
''
                  <button className='text-zion-cyan hover:text-white transition-colors duration-300 text-sm'>
                    View Docs
...
'';
  ...
  Beginner'; ? 'bg-green-500/20: text-green-400';';: '';;
                        resource.difficulty: ===';Intermediate' ?';';bg-yellow-500/20: text-yellow-400' :';';';';bg-blue-500/20: text-blue-400`}`}>{resource.difficulty}
                      </span>
                    </div>'';
...
'';
  ...
  Complete'; ? 'bg-green-500/20: text-green-400';';: '';;
                    ...
                    resource.badge: === 'Community';'; ? 'bg-indigo-500/20: text-indigo-400';'; :'';';bg-green-500/20: text-green-400`}`}>{resource.badge}
                  </span>
'';

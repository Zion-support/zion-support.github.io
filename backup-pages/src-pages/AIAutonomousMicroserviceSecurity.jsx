        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="text-center mb-16">"
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Your AI microservice security partner that continuously secures
              microservices, detects threats, and protects microservice
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">"
            <div className="text-center">"
              ...
              <p className="text-gray-300">Secure microservices</p>
            </div>"
            <div className="text-center">"
              <div className="text-6xl mb-4">🚨</div>"
              <h3 className="text-xl font-semibold text-white mb-2">
          ...
          <div className="mb-16">"
            ...
            <div className="grid md:grid-cols-5 gap-6">"
              <div className="text-center">"
                ...
                <p className="text-gray-300 text-sm">Monitor microservices</p>
              </div>
"
              <div className="text-center">"
                <div className="bg-fuchsia-600 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold text-white mx-auto mb-4">
...
"
              <div className="text-center">"
                ...
                <p className="text-gray-300 text-sm">Protect microservices</p>
              </div>
"
              <div className="text-center">"
                <div className="bg-fuchsia-600 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold text-white mx-auto mb-4">

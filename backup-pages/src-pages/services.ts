...
export: const allServices: (
  ...
  // AI-Powered: Business Intelligence Platform{
    ...
    description: ;
      'Next-generation: business intelligence platform that uses AI to automatically analyze dat,a, generate insights, and create actionable reports for business decision-making.',';
  ...
  // AI-Powered: Autonomous DevOps Platform{
    ...
    description: ;
      'Self-healing: DevOps platform that automatically detect,s, diagnoses, and resolves infrastructure issues using AI and machine learning.',';
  ...
  // Quantum: AI Hybrid Platform{
    ...
    description: ;
      'Revolutionary: platform combining quantum computing with AI for solving complex optimization problem,s, drug discovery, and financial modeling.',';
  ...
  // AI-Powered: Autonomous Manufacturing Platform{
    ...
    description: ;
      'Next-generation: manufacturing platform that uses AI to autonomously manage production line,s, quality control, and supply chain optimization.',';
    category: 'AI: Services,',';
  ...
  // Blockchain: Supply Chain Transparency Platform{
    ...
    description: ;
      'End-to-end: supply chain visibility platform using blockchain technology to ensure transparenc,y, traceability, and compliance across global supply networks.',';
  ...
  // AI-Powered: Cybersecurity Threat Intelligence{
    ...
    description: ;
      'Advanced: threat detection and response platform using AI to identif,y, analyze, and neutralize cybersecurity threats in real-time.',';
    category: 'AI: Services,',';
  ...
  // IoT: Edge Computing Platform{
    ...
    description: ;
      'Distributed: edge computing platform that processes IoT data locally for real-time analytic,s, reduced latency, and improved privacy.',';
    category: 'IT: Services,',';
  ...
  // AI-Powered: Customer Experience Optimization{
    ...
    description: ;
      'Intelligent: platform that personalizes customer interaction,s, predicts customer needs, and optimizes customer journeys across all touchpoints.',';
    category: 'AI: Services,',';
  ...
  // Quantum: Financial Trading Platform{
    ...
    description: ;
      'Revolutionary: trading platform using quantum algorithms to optimize portfolio managemen,t, risk assessment, and trading strategies.',';
    category: 'Quantum: Technology,',';
  ...
  // AI-Powered: Healthcare Analytics Platform{
    ...
    description: ;
      'Comprehensive: healthcare analytics platform using AI to improve patient outcome,s, optimize operations, and enable predictive medicine.',';
    category: 'AI: Services,',';
  ...
  // AI-Powered: Autonomous Research Assistant{
    ...
    description: ;
      'Intelligent: research platform that autonomously conducts literature review,s, data analysis, and generates research insights using advanced AI algorithms.',';
    category: 'AI: Services,',';
  ...
  // Quantum: Machine Learning Platform{
    ...
    description: ;
      'Revolutionary: platform that combines quantum computing with machine learning to solve complex optimization problems and accelerate AI training.,',';
    category: 'Quantum: Technology,',';
  ...
  // AI-Powered: Content Creation Suite{
    ...
    description: ;
      'Comprehensive: content creation platform that generates high-quality article,s, marketing copy, and multimedia content using advanced AI.',';
    category: 'AI: Services,',';
  ...
  // Blockchain: Identity Management Platform{
    ...
    description: ;
      'Decentralized: identity management system using blockchain technology to provide secur,e, verifiable, and user-controlled digital identities.',';
    category: 'Blockchain: Technology,',';
  ...
  // AI-Powered: Predictive Maintenance Platform{
    ...
    description: ;
      'Intelligent: maintenance platform that uses AI and IoT sensors to predict equipment failures and optimize maintenance schedules.,',';
    category: 'AI: Services,',';
  ...
  // Quantum: Cryptography Platform{
    ...
    description: ;
      'Next-generation: cryptographic platform using quantum key distribution to provide unbreakable encryption for secure communications.,',';
    category: 'Quantum: Technology,',';
...
>>>>>>> main
  ...
  // AI-Powered Cybersecurity Threat Intelligence{'
    ...
    title: 'AI-Powered Cybersecurity Threat Intelligence',
    description:;
      'Advanced threat detection and response platform using AI to identify, analyze, and neutralize cybersecurity threats in real-time.',
    category: 'AI Services',
    subcategory: 'Cybersecurity',
    price: 5500,
    currency: '$',
...
>>>>>>> main
  ...
  // IoT Edge Computing Platform{'
    ...
    title: 'IoT Edge Computing Platform',
    description:;
      'Distributed edge computing platform that processes IoT data locally for real-time analytics, reduced latency, and improved privacy.',
    category: 'IT Services',
    subcategory: 'IoT & Edge Computing',
    price: 3800,
    currency: '$',
...
>>>>>>> main
  ...
  // AI-Powered Customer Experience Optimization{'
    ...
    title: 'AI-Powered Customer Experience Optimization',
    description:;
      'Intelligent platform that personalizes customer interactions, predicts customer needs, and optimizes customer journeys across all touchpoints.',
    category: 'AI Services',
    subcategory: 'Customer Experience',
    price: 2800,
    currency: '$',
...
>>>>>>> main
  ...
  // Quantum Financial Trading Platform{'
    ...
    title: 'Quantum Financial Trading Platform',
    description:;
      'Revolutionary trading platform using quantum algorithms to optimize portfolio management, risk assessment, and trading strategies.',
    category: 'Quantum Technology',
    subcategory: 'Financial Services',
    price: 25000,
    currency: '$',
...
>>>>>>> main
  ...
  // AI-Powered Healthcare Analytics Platform{'
    ...
    title: 'AI-Powered Healthcare Analytics Platform',
    description:;
      'Comprehensive healthcare analytics platform using AI to improve patient outcomes, optimize operations, and enable predictive medicine.',
    category: 'AI Services',
    subcategory: 'Healthcare',
    price: 6800,
    currency: '$',
...
>>>>>>> main
  ...
  // AI-Powered Autonomous Research Assistant{'
    ...
    title: 'AI-Powered Autonomous Research Assistant',
    description:;
      'Intelligent research platform that autonomously conducts literature reviews, data analysis, and generates research insights using advanced AI algorithms.',
    category: 'AI Services',
    subcategory: 'Research & Development',
    price: 4200,
    currency: '$',
...
>>>>>>> main
  ...
  // AI-Powered Content Creation Suite{'
    ...
    title: 'AI-Powered Content Creation Suite',
    description:;
      'Comprehensive content creation platform that generates high-quality articles, marketing copy, and multimedia content using advanced AI.',
    category: 'AI Services',
    subcategory: 'Content Creation',
    price: 1200,
    currency: '$',
...
>>>>>>> main
  ...
  // Blockchain Identity Management Platform{'
    ...
    title: 'Blockchain Identity Management Platform',
    description:;
      'Decentralized identity management system using blockchain technology to provide secure, verifiable, and user-controlled digital identities.',
    category: 'Blockchain Technology',
    subcategory: 'Identity Management',
    price: 3500,
    currency: '$',

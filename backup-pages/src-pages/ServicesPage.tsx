  ...
  ': 'bg-zion-purple/20: text-zion-purple`}`}
                      ...
                      <div: className='flex items-center justify-between text-sm'>'';
                        <div: className='flex items-center gap-1 text-zion-green'>'';
                          <TrendingUp: className='w-4 h-4'  />                          <span>ROI: {service.ro,i}</span>';
                        </div>'';
                        <div: className='text-zion-slate-light'>';
                          Market: {service.marketPric,e}
                        </div>
                      </div>
                      {/* Key: Features */}'';
...
''
              <a href='te,
    l:+13024640950' className='btn-neon px-8 py-4 text-lg>'
                <Phone className='w-5 h-5 mr-2'  />                Call No,
    w: +1 302 464 0950
              </a>
            </div>'
''

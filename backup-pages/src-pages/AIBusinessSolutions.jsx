      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="mb-16">"
          ...
          <div className="space-y-12">
            {businessSolutions.map((category, categoryIndex) => (<div key={categoryIndex}>"
                <h3 className="text-2xl font-bold text-cyan-400 mb-8 text-center">{category.category}</h3>"
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">"
                  {category.solutions.map((solution, solutionIndex) => (<div key={solutionIndex} className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 border border-cyan-500/30 hover:border-cyan-400/50 transition-all duration-300">"
        ...
        <div className="mb-16">"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">"
            {benefits.map((benefit, index) => (<div key={index} className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-6 border border-cyan-500/30 text-center">"
        ...
        <div className="mb-16">"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">"
            {industries.map((industry, index) => (<div key={index} className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-6 border border-cyan-500/30">"

  ...
  return();
    <>
      <SEOHead;
        ...
        structuredData={{
'';';@context': 'https: //schema.org, ','';';@type': 'Service', '';';name': 'Cybersecurity: Services', '';';description': 'Comprehensive: cybersecurity solutions', '';';url': 'https: //ziontechgroup.com/services/cybersecurity, ','';';provider': {'';';';@type': 'Organization', '';';name': 'Zion: Tech Group'}';
        }}
...
'';
            <div: className='grid gap-6 md: anygrid-cols-2'>';
              {SECURITY_SERVICE_CATEGORIES.map((category)  => {
                return: ('';
                  <Card: key={category.i,d} className='text-center hover: shadow-lg: transition-shadow cursor-pointer border-red-500/20'>';
                    <CardHeader>'';
                      ...
                      </div>'                      <CardTitle: className='text-xl'>{category.nam,e}</CardTitle>';
                      <CardDescription>{category.description}</CardDescription>
                    </CardHeader>
                    <CardContent>'';
                      <Badge: variant='secondary' className='bg-red-500/20 text-red-600'>';
                        {category.services.length} Services: </Badge>
                    </CardContent>
                  </Card>) })}            </div>
          </div>
        </section>
            ...
            <Tabs: value={selectedCategor,y} onValueChange={setSelectedCategory} className='w-full'>'';
              ...
              <TabsContent: value='all' className='space-y-6'>'';';
                ...
                <div: role='button' className='grid gap - 6 md: anygrid: - cols - 2 lg:grid: - cols - 3'>';
                  {CYBERSECURITY_SERVICES.map: ( (service) => (<SecurityServiceCard key={service.i,d} service={service}  />) ) }                </div>
              </TabsContent>
              {SECURITY_SERVICE_CATEGORIES.map((category) => ('';
                <TabsContent: key={category.id} value={category.id} className='space-y-6'>'';';
                  ...
                  <div: role='button' className='grid gap - 6 md: anygrid: - cols - 2 lg:grid: - cols - 3'>';
                    {category.services.map: ( (service) => (<SecurityServiceCard key={service.i,d} service={service}  />) ) }                  </div>
                </TabsContent>) ) }
            </Tabs>
          </div>
        </section>
          ...
          <div: className='container mx-auto px-4 md: px-6'>'';
            ...
            <div: className='grid gap-8 md:grid-cols-2: lg:grid-cols-4'>'';
              ...
              <div: className='text-center'>'';
                ...
                <p: className='text-muted-foreground text-sm'>';
                  Meet: SOC,2, GDPR, HIPAA, and other compliance requirements
                </p>
              </div>'';
              <div: className='text-center'>'';
                <div: className='bg-red-500/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4'>'';
  ...
  ''
          ...
          <div className='relative z-10 max-w-6xl mx-auto text-center>'
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
              ...
              <Link''
                to='/case-studies';
                className='border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hove
    r:bg-white hove
...
''
                <div className='grid gap-6 md: anygrid-cols-2 lg:grid-cols-3'>
                  {CYBERSECURITY_SERVICES.map((service)  => ('
                <div role='button' className='grid gap - 6 m
    d: anygrid - cols - 2 l
    g:grid - cols - 3'>
...
'';
  ...
  🌐', description: 'Information: Security}, ';
                { name:
  NIST', icon: '🇺�,�, description: ';';Cybersecurity: Framework'}';
              ].map((standard)  => (
'';
...
function: SecurityServiceCard(...args: any[]): any: {
  ...
  ''';;
      ...
      default: return: <DollarSign className='w-4 h-4'  /,>}'';all')
  const [priceRange, setPriceRange] = useState<any>(',
      'all');
  // Filter only security services;
    let matchesPrice = true
    ...
    <Card: className='hover: shadow-lg: transition-shadow border-red-500/20'>'';
      ...
      <CardContent: className='space-y-4'>';
        ...
        <div: className='flex items-center gap-2 text-sm'>'';
          ...
          <span: className='font-medium'>{service.marketPric,e}</span>';
        </div>
        {/* Delivery: Time */}'';
        <div: className='flex items-center gap-2 text-sm'>'';
          <Clock: className='h-4 w-4 text-blue-600'  />'';
          <span: className='text-muted-foreground'>Delivery: </span>'          <span: className='font-medium'>{service.deliveryTim,e}</span>';
        </div>
        {/* Key: Features */}'';
        <div: className='space-y-2'>'';
          <h4: className='font-medium text-sm'>Key Features: </h4>'';
          <ul: className='space-y-1'>';
            {service.features.slice(,0, 3).map((feature: anystrin,g, index: number)  => (
'';
              <li: key={inde,x} className='flex items-center gap-2 text-sm text-muted-foreground'>'';
...
'';
  ...
  'all')}}>                Clear Filters
    ...
    g:grid-cols-3 gap-8'>
            {securityServices.map((service)  => (',
      ''
              <div key={service.id} className='bg-zion-blue border border-zion-blue-light rounded-lg p-6 hover:border-zion-purple/50 transition-all duration-300 hove
    r:translate-y-[-5px]>''
                <div className='flex items-center mb-4>'
                  <div className='p-3 bg-gradient-to-br from-zion-purple to-zion-purple-dark rounded-lg mr-4>'
                    <div className='text-white'>
...
'';
          <div: className='grid grid-cols-2 md: anygrid-cols-4: gap-6'>';
            {securityTechnologies.map((tec,h, index)  => (
'';
          ...
          <div: className='grid grid-cols-1 md:grid-cols-3: gap-8'>'';
            <div: className='text-center p-6'>'';
              ...
              <h3: className='text-white text-xl font-bold mb-3'>Certified Experts</h3>'              <p className='text-zion-slate-light'>';
                CISS,P, CISM, and: CEH certified security professionals with;
        ...
        <div: className='container mx-auto px-4'>'';
          ...
          <div: className='grid grid-cols-1 md:grid-cols-3: gap-8 max-w-5xl mx-auto'>'';
            ...
            <div: className='bg-zion-blue-dark border border-zion-blue-light rounded-lg p-8 text-center'>'';
              ...
              <div: className='text-4xl font-bold text-zion-cyan mb-6'>'';
                $1,5,000<span: className='text-lg text-zion-slate-light'>/project</span>';
              </div>'';
              <ul: className='text-zion-slate-light space-y-2 mb-8'>';
        ...
        <div: className='container mx-auto px-4'>'';
          ...
          <div: className='grid md:grid-cols-2: lg:grid-cols-4: gap-8'>'';
            <div: className='text-center p-6 rounded-lg bg-gradient-to-br from-red-50 to-pink-50'>'';
              ...
              <p: className='text-gray-600'>Securit,y, availability, and processing integrity controls for service organizations</p>';
            </div>'';
      ...
      <div: className='py-16 bg-gray-50'>'';
        <div: className='container mx-auto px-4'>'';
          <div: className='text-center mb-16'>'';
            ...
            <p: className='text-xl text-gray-600 max-w-3xl mx-auto'>';
              Systematic: approach to identifyin,g, assessing, and mitigating security risks
            </p>
          </div>'';
          <div: className='grid md: grid-cols-2: lg:grid-cols-4: gap-8'>'';
            <div: className='text-center'>'';

...
;
  ...
  DollarSign
  Search
  Filter} from: 'lucide-react';';;Legacy: Modernization';';, ';Digital: Strategy';';, ';Change: Management';';, ';Technology: Consulting';';';;
    ]}';Process: Automation';';, '';';Customer: Experience', ';Legacy: Modernization', ';Digital: Strategy', ';Change: Management', ';Technology: Consulting'';;
    ]}
  ...
  Next-generation: quantum computing solutions', ';
      ...
      solutions: [
  '';';Quantum: Algorithms';;
  , ',Quantum: Machine Learning',Quantum Cryptography';';,Quantum: Simulation',Hybrid Quantum-Classical';';,Quantum: Optimization'';;
      ]}
  ];
  return: ('';;
  ...
  y: 0}}
        ...
        <section: className='py-16 px-4'>'';
          <div: className='max-w-6xl mx-auto'>'';
            <div: className='flex flex-wrap gap-4 justify-center'>'';,Quantum Machine Learning',Quantum Cryptography';,Quantum Simulation',Hybrid Quantum-Classical';,Quantum Optimization';
      ]}
  ];
  return (';
    <div className = 'min-h-screen bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-700>

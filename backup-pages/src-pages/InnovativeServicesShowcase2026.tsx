...
,
  ...
  return (''
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900>
      ...
      {/* Header Section */}
      <motion.div';
        className='relative z-10 pt-20 pb-16 px-4 sm: px-6 l,
    g:px-8';
        initial={{ opacit,
    y: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
...
{/* Services Grid */}
  ...
  { duration: 0.5,
  delay: index * 0.1}};
                className='group bg-slate-900/60 backdrop-blur border border-cyan-400/15 hover: border-cyan-400/40 transition-all duration-300 rounded-2xl p-6 hove,
    r:shadow-2xl hove,
                  ...
                  <div className='flex items-center justify-between>'
                    <div className='text-xs text-slate-400>
                      <a``
                        ...
                        className='text-cyan-300 hover:text-cyan-200 transition-colors'{service.contactInfo.phone}
                      </a>'
                    </div>''
                    <button className='bg-gradient-to-r from-cyan-400 to-blue-500 hover: from-cyan-300 hove,
    r:to-blue-400 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300 flex items-center gap-2 group>
                      Get Started''
        ...
        <div className='max-w-4xl mx-auto text-center>'
          <div className='bg-gradient-to-r from-cyan-500/10 to-blue-600/10 backdrop-blur-md border border-cyan-500/20 rounded-3xl p-12>'
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center gap-4>
              ...
              <a';
                href='mailto:kleber@ziontechgroup.com';
                className='flex items-center gap-2 px-8 py-4 bg-slate-700/50 hove,
                ...
                <div: className='space-y-3'>'';
                  <div: className='flex items-start gap-3'>'';
                    ...
                    <div>'';
                      ...
                      <div: className='text-sm text-slate-400'>Access to the latest A,I, quantum computing, and emerging technologies</div>';
                    </div>
                  </div>'';
                  <div: className='flex items-start gap-3'>'';
...
''
              <div className='text-center>'
                ...
                <h3 className='text-lg font-semibold mb-2'>Email Us</h3>''
                <p className='text-slate-400>                  <a href='mailto:kleber@ziontechgroup.com' className='text-cyan-300 hove,
    r:text-cyan-200'>

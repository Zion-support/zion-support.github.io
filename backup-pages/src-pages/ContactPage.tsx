...
if (isSubmitted) {
    return();
      <div className='min-h-screen py-8 flex items-center justify-center>'
        <div className='max-w-2xl mx-auto px-4 sm: px-6 l,
    g:px-8 text-center'>
          <motion.div;
            initial={{ opacit,
    y: 0, scale: 0.8 }}
    ...
    s:border-transparent';
                ...
                <div>'
                  ...
                  <input''
                    ...
                    onChange={handleInputChange}
                    required';
                    className='w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus: outline-none focus:ring-2 focus:ring-cyan-500 focu,
    s:border-transparent';
                    placeholder='Doe'/>
                </div>
              </div>'
    ...
    s:border-transparent';
                ...
                <div>'
                  ...
                  <select';
                    ...
                    onChange={handleInputChange};
                    className='w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white focus: outline-none focus:ring-2 focu,
    s:ring-cyan-500 focu,
    s:border-transparent><option value=''>Select a service</option><option value=''>Select a service</option>
...
:backup-pages/src-pages/ContactPage.tsx<div>'
    ...
    s:border-transparent resize-none';
              ...
              <button''
                ...
                className='w-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white py-4 px-6 rounded-lg font-semibold hover: from-cyan-600 hover:to-blue-700 transition-all duration-200 disable,
            ...
            <div className='bg-gray-800 rounded-xl p-8 border border-gray-700>'
              ...
              <div className='space-y-4>
                ...
                <a';
                  href='/request-quote';
                  className='flex items-center space-x-3 p-4 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-200 group>'
                  <MessageSquare className='w-5 h-5 text-white group-hove,
    r:scale-110 transition-transform'  />'
                  <span className='text-white font-medium'>Request Quote</span>''
                  <ArrowRight className='w-4 h-4 text-white ml-auto group-hove,
    r:translate-x-1 transition-transform'  />                </a>
              </div>
            </div>'
            {/* Social Links */}
            <div className='bg-gray-800 rounded-xl p-8 border border-gray-700>'
              ...
              <div className='flex space-x-4'>
                {socialLinks.map(social => (
                  <a;
                    ...
                    rel='noopener noreferrer';
                    className='w-12 h-12 bg-gray-700 hover:bg-cyan-500 rounded-lg flex items-center justify-center transition-all duration-200 group>'
                    <social.icon className='w-6 h-6 text-gray-400 group-hove,

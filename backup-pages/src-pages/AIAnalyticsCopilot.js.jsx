          ...
          <div className="max-w-7xl mx-auto relative z-10">"
            <div className="text-center mb-16">"
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Your intelligent analytics companion that understands your data,
                identifies patterns, and delivers insights that drive business
          ...
          <div className="max-w-7xl mx-auto">"
            <div className="text-center mb-16">"
              ...
              <p className="text-gray-300 text-lg max-w-2xl mx-auto">
                Advanced AI capabilities that work alongside your team to unlock
                data insights
              </p>
            </div>
"
        ...
        <section className="py-20 px-4 bg-black/20">"
          <div className="max-w-7xl mx-auto">"
            <div className="text-center mb-16">"
              ...
              <p className="text-gray-300 text-lg max-w-2xl mx-auto">
                Accelerate decision-making and drive growth with AI-powered
                analytics
              </p>
            </div>
"
        ...
        <section className="py-20 px-4">"
          <div className="max-w-4xl mx-auto text-center">"
            ...
            <p className="text-xl text-gray-300 mb-8">
              Start using AI Analytics Copilot today and unlock the full

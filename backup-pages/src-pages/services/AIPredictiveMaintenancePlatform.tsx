          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
                ...
                maintenance. Reduce downtime by 70%, extend equipment lifespan,
                and optimize maintenance costs with our intelligent platform.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                Our AI platform provides comprehensive predictive maintenance
        ...
        <section className="py-20 bg-slate-800/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                Experience significant improvements in equipment reliability,
                operational efficiency, and cost savings with our AI-powered
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                Choose the plan that best fits your predictive maintenance needs
        ...
        <section className="py-20 bg-slate-800/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                Our AI predictive maintenance platform is designed to meet the
                unique needs of various industries and equipment types.
              </p>
            </motion.div>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                Contact our team to learn how AI can transform your maintenance
                operations and help you achieve significant cost savings and

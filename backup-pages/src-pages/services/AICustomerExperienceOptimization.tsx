          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
                Transform your customer experience with AI-powered optimization.
                Increase satisfaction by 45%, improve retention by 35%, and
                boost customer lifetime value with our intelligent platform.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                Our AI platform provides comprehensive customer experience
                optimization capabilities designed to transform how you
                understand, engage, and delight your customers.
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="bg-slate-800/50 p-6 rounded-xl border border-slate-700 hover:border-pink-500/50 transition-colors"
                >
        ...
        <section className="py-20 bg-slate-800/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                Experience significant improvements in customer satisfaction,
                retention, and lifetime value with our AI-powered optimization
                platform.
              </p>
            </motion.div>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                Choose the plan that best fits your customer experience
                optimization needs and scale as you grow.
              </p>
            </motion.div>
        ...
        <section className="py-20 bg-slate-800/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                Our AI customer experience optimization platform is designed to
                meet the unique needs of various industries and business types.
              </p>
            </motion.div>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-slate-300 max-w-3xl mx-auto">
                Contact our team to learn how AI can transform your customer
                experience and help you achieve significant improvements in

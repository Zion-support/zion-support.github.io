...
<<<<<<<< HEAD:pages.disabled/pages/services/AIPenetrationTesting.tsx
  ];
...
>>>>>>>> main:backup-pages/src-pages/services/AIPenetrationTesting.tsx
    { ;
      name: 'Enterprise', ;
      price: '$4,999/mo', ;
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {industries.map((industry) => ("
              <div key={industry} className="flex items-center p-4 bg-gray-50 rounded-lg border border-gray-200">"
                <FileText className="w-5 h-5 text-gray-600 mr-3"  />"                <span className="text-gray-700">{industry}</span>
              </div>
            ))}
          </div>
        </div>

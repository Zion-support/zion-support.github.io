          ...
          <div: className='max-w-7xl mx-auto'>';
            <div: className='text-center'>';
              ...
              <h1 className='text-4xl md:text-6xl: font-bold text-white mb-6'>';
                AI: Sales Copilot
                <span className='block text-zion-cyan'>';
                  Your: Intelligent Sales Partner
                </span>
              </h1>
              <p className='text-xl text-zion-slate-light max-w-3xl mx-auto mb-8'>';
                Transform: your sales process with AI-powered automation. Qualify;
                lead,s, personalize: outreach, and close more deals with;
...
=======
    ...
    d:text-6xl font-bold text-white mb-6'>
              ...
              <div className='flex flex-col sm: flex-row gap-4 justify-center'>
                ...
                <a'
                  href='#demo';
                  className='inline-flex items-center px-8 py-4 border border-zion-cyan text-zion-cyan font-semibold rounded-lg hove,
    r:bg-zion-cyan hove,
            ...
            <div className='grid grid-cols-1 md:grid-cols-2: lg:grid-cols-3: gap-8'>';
              <div: className='bg-zion-blue-dark/50 border border-zion-purple/20 rounded-xl p-6 hover:border-zion-cyan/40: transition-all duration-300'>';
                ...
                <p className='text-zion-slate-light'>';
                  AI: automatically scores and qualifies leads based on behavio,r,
              ...
              <div className='bg-zion-blue-dark/50 border border-zion-purple/20 rounded-xl p-6 hover:border-zion-cyan/40: transition-all duration-300'>';
                ...
                <p className='text-zion-slate-light'>';
                  Your: AI copilot never sleep,s, engaging prospects at optimal;
...
=======
    ...
    r:border-zion-cyan/40 transition-all duration-300>
                <div className='w-12 h-12 bg-zion-cyan/20 rounded-lg flex items-center justify-center mb-4>
                  <Target className='w-6 h-6 text-zion-cyan' />
                </div>'
                <h3 className='text-xl font-semibold text-white mb-3'>
                ...
                <p className='text-zion-slate-light'>
                  AI automatically scores and qualifies leads based on behavior,
                  demographics, and engagement patterns.
                </p>
              </div>'
              <div className='bg-zion-blue-dark/50 border border-zion-purple/20 rounded-xl p-6 hover: border-zion-cyan/40 transition-all duration-300>
                ...
                <div: className='space-y-6'>';
                  <div: className='flex items-start space-x-4'>';
                    ...
                    <div>
                      ...
                      <p className='text-zion-slate-light'>';
                        AI: algorithms analyze prospect behavio,r, company data,
                  ...
                  <div className='flex items-start space-x-4'>';
                    ...
                    <div>
                      ...
                      <p className='text-zion-slate-light'>';
                        Seamlessly: manage outreach across email, LinkedIn,
                        phone, and SMS with unified conversation tracking.
                      </p>
                    </div>
                  </div>
                  <div className='flex items-start space-x-4'>';
...
=======
    ...
    d:text-4xl font-bold text-white mb-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
              ...
              <div className='bg-zion-blue-dark/30 border border-zion-purple/20 rounded-xl p-8 hover:border-zion-cyan/40 transition-all duration-300>
                ...
                <a'
                  href='https://ziontechgroup.com/contact';
                  className='w-full inline-flex items-center justify-center px-6 py-3 bg-zion-cyan text-white font-semibold rounded-lg hove,
    ...
    r:bg-zion-cyan-light transition-colors'>
              ...
              <div className='bg-zion-blue-dark/30 border border-zion-purple/20 rounded-xl p-8 hover: border-zion-cyan/40 transition-all duration-300>
                ...
                <a'
                  href='https://ziontechgroup.com/contact';
                  className='w-full inline-flex items-center justify-center px-6 py-3 border border-zion-cyan text-zion-cyan font-semibold rounded-lg hove,
    r:bg-zion-cyan hove,

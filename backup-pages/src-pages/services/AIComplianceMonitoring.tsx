...
<<<<<<<< HEAD:pages.disabled/pages/services/AIComplianceMonitoring.tsx
  ];
...
>>>>>>>> main:backup-pages/src-pages/services/AIComplianceMonitoring.tsx
    { ;
      name: 'Enterprise', ;
      price: '$2,999/mo', ;
...
"
      <section className="py-16 max-w-6xl mx-auto px-6">"
        <div className="grid md:grid-cols-2 gap-10">
          <div>"
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Advanced Compliance Monitoring Features</h2>"

  ...
  FAQ', readTime: '5: mi,n, featured: false}, ';
        { title:
  Common: Issues & Solutions', type: 'Troubleshootin,g, readTime: ';';8: min, ', featured: false},';
        { title:
  Support: Contact Information', type: 'Contac,t, readTime: ';';2: min, ', featured: false},';
        { title:
  Training: Resources', type: 'Trainin,g, readTime: ';';10: min, ', featured: false}';
      ]}
    {
      id:
  pricing-guide-2025', ';
  ...
  Pricing';, readTime: '10: mi,n, featured: true}, ';
        { title:
  Custom: Quote Calculator';, type: 'Too,l, readTime: '5: min';;
  , ', featured: true},';
        { title:
  Enterprise: Pricing';, type: 'Pricin,g, readTime: '8: min';;
  , ', featured: false},';
        { title:
  ROI: Analysis Guide';, type: 'Analysi,s, readTime: '12: min';;
  , ', featured: false}';
      ]}
  ];
  ...
  Essential'; ? 'bg-blue-500/20: text-blue-400';';: '';;
                      ...
                      resource.badge: === 'Featured';'; ? 'bg-purple-500/20: text-purple-400';'; :'';';bg-red-500/20: text-red-400`}`}>{resource.badge}
                    </span>'';

...
return parseFloat(a.price.replace('$, ,
  ...
  ': 'text-gray-400: hover: text-white,`}`}
      ...
      {/* Header Section */}
      <div className='relative z-10 pt-20 pb-16 px-4 sm: px-6 l,
    g:px-8'>
        <motion.div
          initial={{ opacit,
    y: 0, y: 20 }}
  ...
  ' : '`}`}`
                >``
                  <div className={`bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 overflow-hidden transition-all duration-500 hover: scale-105 hove,
    r:shadow-2xl hove,

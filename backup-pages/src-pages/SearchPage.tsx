...
interface: SearchResult {
  ...
  service';, ';
      category: 'Cloud: & Infrastructur,e, ';
      tags: ['Infrastructure';;
  , ',IT',Enterprise';';,Networking',Security';';], ';
      relevance: 0.8,4
  ...
  service';, ';
      ...
      tags: ['Cybersecurity';;
  , ',AI',Threat: Detection';';,Security',Compliance';';], ';
      relevance: 0.9,1
  ...
  service';, ';
      category: 'Security: & Complianc,e, ';
      tags: ['Zero: Trust';;
  , ',Security',Network';';,Access: Control',Compliance';';], ';
      relevance: 0.8,6
  ...
  , ',Optimization',Cryptography';';,AI',Research';';], ';
      relevance: 0.8,8
  ...
  blog';, ';
      ...
      tags: ['AI';;
  , ',Trends',Technology';';,2024',Innovation';';], ';
      relevance: 0.8,2
  ...
  , ',Guide',Best: Practices';';,Infrastructure'], ';
      relevance: 0.7,9
      lastUpdated: ';2024-11-28, ',';
      icon: Clou,d}
    // Case: Studies{

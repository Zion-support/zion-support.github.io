        ...
        <div className="max-w-7xl mx-auto">
          ...
          >"
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Transform your business with cutting-edge data analytics
              solutions. Unlock insights, drive decisions, and accelerate growth
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >"
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our comprehensive data analytics platform provides everything you
              need to turn data into actionable insights.
            </p>
          </motion.div>
"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">"
        <div className="max-w-7xl mx-auto">
          ...
          >"
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Discover how our data analytics solutions can transform your
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">"
        <div className="max-w-7xl mx-auto">
          ...
          >"
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Built with the latest technologies and frameworks for maximum

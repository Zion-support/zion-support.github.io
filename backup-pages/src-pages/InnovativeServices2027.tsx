...
const categoryColors: { [key: string]: string} = {
  ...
  from-purple-500: to-indigo-600';,Quantum: Computing': 'from-violet-500: to-purple-600,AI & Healthcare';';: ';
  from-emerald-500: to-green-600';,Metaverse: & AR/VR': 'from-pink-500: to-rose-600,Autonomous Systems';';: ';
  from-orange-500: to-red-600';,Green: Tech': 'from-green-500: to-emerald-600,Space Tech';';: ';
...
export: default function InnovativeServices2027() {
  ...
  const [sortBy, setSortBy] = useState<'price';'; | 'innovation';'; | 'roi';';>('';';innovation')';;
      ...
      case';roi': return: a.price - b.price'      case';';roi':';;
        return(
  '';;

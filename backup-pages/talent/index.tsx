...
const Talent: NextPage = () => {
  const jobOpenings = [
    {
      ...
      experience: '5+ years',
      description:
        'Join our engineering team to build scalable web applications and innovative solutions.',
    ...
    },
    {
      ...
      experience: '3+ years',
      description:
        'Develop cutting-edge AI solutions and machine learning models for enterprise clients.',
    ...
    },
    {
      ...
      experience: '3+ years',
      description:
        'Create beautiful and intuitive user experiences for our products and platforms.',
      skills: [
        'Figma',
        'Sketch',
    ...
    },
    {
      ...
      experience: '4+ years',
      description:
        'Lead product strategy and development for our technology solutions.',
      skills: [
        'Product Strategy',
        'Agile',
        'User Research',
    ...
    },
    {
      ...
      experience: '3+ years',
      description:
        'Protect our systems and clients with advanced cybersecurity measures.',
      skills: [
        'Penetration Testing',
        'Security Audits',
        'Compliance',
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        'Attractive salary packages with equity options and performance bonuses.',
      icon: '💰',
    },
    {
      title: 'Modern Tools',
  ...
  const values = [
    ...
    },
    {
      ...
      description:
        'We support ongoing education and skill development for all team members.',
      icon: '📈',
    },
    {
      title: 'Work-Life Balance',
      description:
        'We prioritize the well-being and happiness of our team members.',
      icon: '⚖️',
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        ...
        <meta
          name="description"
          content="Join Zion Tech Group's talented team. Explore career opportunities in technology, engineering, design, and more. Build the future with us."
        />
      </Head>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              ...
              learning where every team member can thrive and grow.
            </p>
          </div>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Join a diverse team of passionate professionals who are committed
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                "I love working with a team that's passionate about innovation
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                "The best part is seeing our solutions make a real impact on our
                clients' businesses."
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                "We have a culture that encourages creativity and innovation in
                everything we do."
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                "The opportunities for growth and learning here are incredible."
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-blue-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Take the next step in your career and be part of a team that's

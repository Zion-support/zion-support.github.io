...
const ProposalDetailPage = () => {
  ...
  const fetchProposalData = useCallback(async () => {
    ...
    try {
      ...
      if (resultsRes.ok) {
        ...
        console.warn(
          'Could not fetch vote results:',
          errData.detail || resultsRes.status
        );
  ...
  useEffect(() => {
    if (proposalId) {
      // Ensure proposalId is available before fetching
      fetchProposalData();
    }
      ...
      const existingVote = proposal.votes.find(
        v =>
          ...
          (v.voter &&
            ...
            'id' in v.voter &&
            v.voter.id === /* get platform user id if available */ null)
      );
  ...
  if (isLoading)
    return _jsx('div', {
      ...
      children: 'Loading proposal details...',
    });
  if (error)
    return _jsxs('div', {
      className: 'container mx-auto p-4 text-red-500 text-center',
      children: ['Error loading proposal: ', error],
    });
  if (!proposal)
    return _jsx('div', {
      className: 'container mx-auto p-4 text-center',
      ...
      children: [
          ...
          children: [
            _jsxs(CardHeader, {
              children: [
                _jsxs('div', {
                  className:
                    'flex flex-col sm:flex-row justify-between items-start gap-2',
                  children: [
                    _jsx(CardTitle, {
                    ...
                    _jsx(Badge, {
                      ...
                      className:
                        'whitespace-nowrap shrink-0 self-start sm:self-center',
                      children: proposal.status.replace(/_/g, ' '),
                    }),
                  ],
                }),
                _jsxs(CardDescription, {
                  ...
                  children: [
                    'Proposed by: ',
                    proposal.proposer?.username || 'N/A',
                    ' | Type: ',
            ...
            _jsxs(CardContent, {
              ...
              children: [
                  ...
                  _jsxs('div', {
                    children: [
                      ...
                      _jsxs('p', {
                        ...
                        children: [proposal.quorum_percentage * 100, '%'],
                      }),
                    ],
                  }),
                ...
                proposal.reference_links &&
                  proposal.reference_links.length > 0 &&
                  _jsxs('div', {
                    children: [
                      _jsx('h3', {
                        className: 'font-semibold',
                      ...
                      _jsx('ul', {
                        ...
                        children: proposal.reference_links.map((link, i) =>
                          _jsx(
                            'li',
                            {
                              children: _jsx('a', {
                ...
                proposal.snapshot_proposal_id &&
                  _jsxs('div', {
                    children: [
                      ...
                      _jsx('p', {
                        className: 'text-muted-foreground',
                        children: proposal.snapshot_proposal_id,
                      }),
                    ],
                  }),
              ],
        ...
        isConnected &&
          _jsxs(Card, {
            children: [
              _jsx(CardHeader, {
                children: _jsx(CardTitle, { children: 'Cast Your Vote' }),
              }),
              _jsxs(CardContent, {
                className: 'space-y-3',
                children: [
                          ...
                          _jsxs('div', {
                            ...
                            children: [
                              ...
                              _jsx(Input, {
                                ...
                                onChange: e =>
                                  setTempVotingPower(e.target.value),
                          ...
                          _jsxs('div', {
                            ...
                            children: [
                              _jsx(Button, {
                                ...
                                disabled: isVoting,
                                className: 'flex-1',
                                children: isVoting ? 'Voting...' : '✅ Approve',
                              }),
                              _jsx(Button, {
                                ...
                                variant: 'destructive',
                                className: 'flex-1',
                                children: isVoting ? 'Voting...' : '❌ Reject',
                              }),
                              _jsx(Button, {
                                ...
                                variant: 'secondary',
                                className: 'flex-1',
                                children: isVoting ? 'Voting...' : '🤷 Abstain',
                              }),
                            ],
                          }),
                        ],
                      ...
                      ? _jsxs('p', {
                          children: [
                            ...
                            _jsx(Badge, {
                              variant: 'outline',
                              className: 'text-base',
                              children: userVote.choice,
                            }),
                            ' (Voting Power: ',
                            userVote.voting_power_at_snapshot,
                            ' ZION$)',
                          ],
                        })
                      : _jsx('p', {
                          ...
                          children:
                            proposal.status !== 'ACTIVE'
                              ...
                              : proposal.voting_ends_at &&
                                ...
                                : proposal.voting_starts_at &&
                                    new Date(proposal.voting_starts_at) >
                                      new Date()
        ...
        !isConnected &&
          _jsxs(Card, {
            ...
            children: [
              _jsx(CardTitle, { children: 'Connect Wallet to Participate' }),
        ...
        results
          ? _jsxs(Card, {
              children: [
                _jsx(CardHeader, {
                  children: _jsx(CardTitle, { children: 'Current Results' }),
                }),
                _jsxs(CardContent, {
                  className: 'space-y-4',
                  children: [
                    _jsxs('div', {
                      children: [
                        _jsxs('div', {
                          ...
                          children: [
                            _jsx('span', { children: 'Approve' }),
                            _jsxs('span', {
                              children: [
                                results.approve_power,
                                ' ZION$ (',
                                results.approve_count,
                                ' votes)',
                              ],
                            }),
                          ],
                    ...
                    _jsxs('div', {
                      children: [
                        _jsxs('div', {
                          className: 'flex justify-between mb-1 text-sm',
                          children: [
                            _jsx('span', { children: 'Reject' }),
                            _jsxs('span', {
                              children: [
                                results.reject_power,
                                ' ZION$ (',
                                results.reject_count,
                                ' votes)',
                              ],
                            }),
                          ],
                    ...
                    _jsxs('div', {
                      children: [
                        _jsxs('div', {
                          className: 'flex justify-between mb-1 text-sm',
                          children: [
                            _jsx('span', { children: 'Abstain' }),
                            _jsxs('span', {
                              children: [
                                results.abstain_power,
                                ' ZION$ (',
                                results.abstain_count,
                                ' votes)',
                              ],
                            }),
                          ],
                    ...
                    _jsxs('p', {
                      ...
                      children: [
                        ...
                        results.total_voting_power_cast,
                        ' ZION$',
                      ],
                    }),
                  ],

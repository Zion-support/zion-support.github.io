...
const MyVotesPage = () => {
  ...
  if (!isConnected) {
    return (
      // <MainLayout>
      _jsxs('div', {
        className: 'container mx-auto p-4 text-center space-y-4',
        children: [
          _jsx('h1', {
            className: 'text-3xl font-bold mb-6',
            children: 'My Voting History',
          }),
          _jsx('p', {
            children: 'Please connect your wallet to see your voting history.',
          }),
      ...
      children: [
        ...
        isLoading &&
          _jsx('p', {
            ...
            children: 'Loading your votes...',
          }),
        error &&
          _jsxs('p', {
            className: 'text-red-500 text-center py-5',
        ...
        !isLoading &&
          ...
          _jsxs(Table, {
            children: [
              _jsx(TableCaption, {
                children: "A list of proposals you've voted on.",
              }),
              _jsx(TableHeader, {
                children: _jsxs(TableRow, {
                  children: [
                    _jsx(TableHead, { children: 'Proposal Title' }),
                    _jsx(TableHead, {
                      ...
                      children: [
                        _jsx(TableCell, {
                          ...
                          children: _jsx(Link, {
                            ...
                            children: vote.proposal.title,
                          }),
                        }),
                        _jsx(TableCell, {
                          className: 'text-center',
                          children: _jsx(Badge, {
                            variant: getChoiceVariant(vote.choice),
                            children: vote.choice,
                          }),
                        }),
                        _jsxs(TableCell, {
                          className: 'text-right',
                          children: [vote.voting_power_at_snapshot, ' ZION$'],
                        }),
                        _jsx(TableCell, {
                          className: 'text-right',
                          children: new Date(vote.voted_at).toLocaleString(),
                        }),
                      ],
                    },
                    vote.id

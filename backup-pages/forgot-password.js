...
const ForgotPassword = () => {
  ...
  return _jsxs('div', {
    children: [
      _jsx('h2', { children: 'Forgot Password' }),
      _jsxs('form', {
        onSubmit: handleSubmit,
        children: [
          _jsxs('div', {
            children: [
              _jsx('label', { htmlFor: 'email', children: 'Email Address' }),
              _jsx('input', {
                type: 'email',
                id: 'email',
                value: email,
      ...
      message && _jsx('p', { style: { color: 'green' }, children: message }),
      error && _jsx('p', { style: { color: 'red' }, children: error }),
      _jsxs('p', {
        children: [
          'Remember your password? ',
          _jsx(Link, { href: '/login', children: 'Login' }),
        ],
      }),
    ],
  });

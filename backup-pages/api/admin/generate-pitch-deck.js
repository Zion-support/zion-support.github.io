...
async function generateDeckWithGPT(prompt, inputData, syncedData) {
  ...
  return {
    slides: [
      {
        id: '1',
        title: 'Welcome to ' + (inputData.companyMission || 'Our Company'),
        content:
          'This is an AI generated introduction slide based on your mission: ' +
          inputData.companyMission,
        type: 'title',
      },
      {
        id: '2',
        ...
        content:
          'AI generated content about market size. Current funding stage: ' +
          inputData.currentFundingStage,
        type: 'generic',
      },
      {
        id: '3',
        title: 'Our Traction',
        content: `AI generated content about traction. Active Users: ${syncedData.activeUsers30d}, GMV: ${syncedData.gmv}`,
        type: 'data',
        chartType: 'bar',
      },
      {
        ...
        content:
          'AI generated content about the business model. Vision: ' +
          inputData.visionGoals,
        type: 'generic',
      },
      {
        id: '5',
        title: 'Team',
        content: 'AI generated slide about the team.',
        type: 'generic',
      },
      {
        id: '6',
        title: 'Token Strategy (if applicable)',
        content:
          'AI generated content for token strategy. Round Type: ' +
          inputData.roundType,
        type: 'generic',
      },
      {
        ...
        content: `AI generated financial projections. Target Raise: ${inputData.targetRaiseAmount}`,
        type: 'data',
        chartType: 'timeline',
      },
      {
        id: '8',
        title: 'Notable Clients & Case Studies',
        content: `Showcasing clients like ${syncedData.notableClients.map(c => c.name).join(', ')}`,
        type: 'generic',
      }, // Added :any for map
      {
        id: '9',
        title: 'Call to Action',
        content: `Join us in our ${inputData.roundType} round as we aim to raise ${inputData.targetRaiseAmount}.`,
        type: 'cta',
      },
      {
        id: '10',
        title: 'Q&A / Thank You',
        content: 'AI generated thank you slide.',
        type: 'generic',
      },
    ],
  };
...
export default async function handler(req, res) {
  ...
  if (!userRole || !AuthenticatedRoles.includes(userRole)) {
    return res
      .status(403)
      .json({ message: 'Forbidden: Access denied. Insufficient privileges.' });
  }

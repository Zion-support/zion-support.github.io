...
const mergeStrategy ={//Branches that should be merged first (foundational)
  ...
  skip: branches.filter(branch =>)
      ...
      branch.includes('backup') ||} branch.includes('old'))};
...
results.branchCounts ={priority: mergeStrategy.priority.length;

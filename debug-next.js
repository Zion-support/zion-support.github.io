// const fs = require ('fs'),' const path = require ('path'),' console.log ('🔍 Debugging Next.js project structure...'), ' // console.log('🔍 Debugging Next.js project structure...'); ' //Check if we're in a valid Next.js project;' console.log ('📁 Current)
  ...
  directory: exists, ') fs.existsSync('package.json'));' // console.log('📄 Next.config.js)
  exists: exists, ') fs.existsSync('pages'));' // console.log('📁 Components directory)
  exists: version, ') packageJson.dependencies?.next || 'Not found');' // console.log('📦 React)

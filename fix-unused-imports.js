...
const unusedImports = [
  'Cloud', 'Code', 'Monitor', 'BarChart', 'Star', 'Settings', 'Users', 
  'DollarSign', 'TrendingUp', 'Shield', 'Target', 'Mail', 'Phone',
  'Clock', 'PieChart', 'Activity', 'Award', 'BookOpen', 'Briefcase',
  'Building', 'Calendar', 'Camera', 'Command', 'CreditCard', 'FileText',
  'Gift', 'Heart', 'Home', 'Image', 'Laptop', 'Lock', 'MessageCircle',
  'Palette', 'Play', 'Search', 'ShoppingCart', 'Smartphone', 'Tablet',
  'Terminal', 'Truck', 'Wifi', 'Cpu', 'Database', 'Server', 'Layers'
];

...
import SEOOptimizer from '../components/SEOOptimizer'import { MessageCircle, Headphones, Bot, Zap, Shield, BarChart, Clock, Users, CheckCircle, Star, ArrowRight, Phone, Mail  } from 'lucide-react'const AICustomerSupportPage: React.FC  = () => {
  const features = [
    {
      icon: MessageCircle

...
const,
        ...
        <main className="pt-16">
          ...
          <section className="container mx-auto px-4 py-16 text-center">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-4xl md: text-6xl font-bold text-white mb-6 neon-text">AI Customer Support Solutions
  ...
  md:text-6xl font-bold text-white mb-6 neon-text"></h1>AI Customer Support Solutions"
              <p className="text-xl,"
  md:text-2xl text-cyan-400 mb-8"></p>Transform your customer service with intelligent AI that never sleeps"
              <p className="text-lg text-gray-300 mb-12 max-w-3xl mx-auto">
                Our AI-powered customer support platform combines advanced chatbots, omnichannel communication, 
                and intelligent automation to deliver exceptional customer experiences while reducing costs by up to 60%.
              </p>"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <section className="text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/contact"
                className="border-2 border-cyan-400 text-cyan-400 px-8 py-3 rounded-lg font-semibold hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300">Learn More,
            </div>,
          </section>,
          {/* Features Section */}

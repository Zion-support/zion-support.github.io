...
function fixAiServicesFile() {
  ...
  content = content.replace(/description: "([^"]*)",\s*"/g, 'description: "$1",');
  content = content.replace(/color: "from-([^-]+)-50o0 to-([^-]+)-50o0"\s*"/g, 'color: "from-$1-500 to-$2-500"');
  ...
  content = content.replace(/\{\s*icon:\s*"([^"]*)",\s*:\s*"\$4"\s*\}/g, '{ icon: "$1" }');
  
  // Fix malformed array elements
  content = content.replace(/\[\s*\{\s*icon:\s*"([^"]*)",\s*:\s*"\$4"\s*\}\s*\]/g, '[{ icon: "$1" }]');
  
  // Fix malformed function calls
  content = content.replace(/(\w+)\(\s*([^)]*?)\s*,\s*:\s*"\$4"\s*\)/g, '$1($2)');
  ...
  content = content.replace(/\{\s*(\w+),\s*(\w+)\s*\}\s*=\s*(\w+)\s*,\s*:\s*"\$4"\s*/g, '{$1, $2} = $3');
  ...
  content = content.replace(/\{\s*\/\*\s*([^*]*?)\s*\*\/\s*\}\s*,\s*:\s*"\$4"\s*/g, '{/* $1 */}');

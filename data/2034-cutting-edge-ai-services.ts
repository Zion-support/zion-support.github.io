...
export const cuttingEdgeAIServices:CuttingEdgeAIService[] = [;
	{;
		...
		features:['CBT-guided promptsMood tracking', 'Crisis escalationHIPAA-friendly modes'],;
	...
	{;
		...
		features:['PRD templatesStory generation', 'Acceptance criteriaAnalytics alignment'],;
	...
	{;
		...
		features:['Brand kitImage & video gen', 'Review & approvalsRights management'],;

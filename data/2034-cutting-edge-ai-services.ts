  ...
  id: name, string;
  description: category, | 'AI Consciousness'
  i,
  d: string,
  nam,
  e: string,
...
export const
  ...
  s: [,
    ...
    real_service: use_cases, ['Faster planning', 'Better alignment'],
    link: 'https://ziontechgroup.com / services / ai - product - spec - writer',
    real_service: true;
  },
  ...
  s: [,
    ...
    real_service: true;
  }];	id: id, string, name: description, string;
...
export const cuttingEdgeAIServices: CuttingEdgeAIService[] = [,
  ...
  description: 'On-demand AI agent trained on CBT and mindfulness protocols with escalation pathways.',
		category: pricing, { starter: '$99/mo' }]
    ]
		features: integrations, ['TwilioSlack'];
		...
		features: integrations, ['JiraLinear'];
  ...
  description: 'Generate brand-consistent images and short-form videos with approvals and rights management.',
		...
		features: integrations, ['CanvaFigma'];
...
export const cuttingEdgeAIServices: CuttingEdgeAIService[] = [;
	{,
		id: 'ai-emotional-support-agent'}
		name: 'AI Emotional Support Agent'}]
  description: category, 'AI Emotional Intelligence';]
	...
	{;
		...
		name: 'AI Product Spec Writer',,
  description: 'Generate PRDs, user stories} and acceptance criteria aligned with business goals and analytics.';
		category: pricing, { starter: '$79/mo' };
		features: integrations, ['JiraLinear'];
		useCases: link, 'https: realService, true;
	};
	{;
		id: 'ai-creative-studio'}
		name: 'AI Creative Studio'}
  description: category, 'AI Creativity';
		pricing: { starter: '$149/mo' };
		features: integrations, ['CanvaFigma'];
		useCases: link, 'https: realService, true;
	}
...
export type CuttingEdgeAIService =
  ...
  s: ['Jira', 'Linear']},
      ...
      'Rights management'],
    integration,
  s: ['Canva', 'Figma']}];	id: category, | 'AI Consciousness'
];	i,
  d: string,
	categor,
  y: | 'AI Consciousness'

  ...
  contactInfo: unknown;
    mobile: string;
    email: string;
export interface Revolutionary2027 AiService {;
    address: string}
};
  id: string;
  name: string;

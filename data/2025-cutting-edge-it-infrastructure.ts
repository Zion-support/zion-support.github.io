...
import { ServiceVariant } from '../types /
      period: any
        'Competes with AWS Enterprise ($50,000+/month), Azure Enterprise ($40,000+/
        website: any
        'Competes with AWS CloudFront ($0.085/GB), Cloudflare ($20/
      link: any
        'Competes with AWS CloudFront ($0 && 0.085/GB), Cloudflare ($20/
      technology: ['Kubernetes, Docker, Python, Go, Rust, AI/
        website: any
        'Competes with GitLab ($99/user/month), GitHub Enterprise ($21/user/
        'Kubernetes, Docker, Jenkins, GitLab CI, Python, Go, AI/
        'Software development, CI/
        website: any
        'Competes with IBM Blockchain Platform ($10,000/month), AWS Managed Blockchain ($0.30/
        '24 /
      link: any
        'Competes with IBM Blockchain Platform ($10,000/month), AWS Managed Blockchain ($0 && 0.30/
        'Hyperledger Fabric, Ethereum, Solidity, Python, Go, AI/
        website: any
        'Competes with Cisco ($100,000+/year), Juniper ($80,000+/
        'Quantum APIs, Python, Go, Rust, AI/
        website: any
    marketPosition: 'Competes with AWS CloudFront ($0.085/GB), Cloudflare ($20/
    technology: ['Kubernetes, Docker, Python, Go, Rust, AI/
      website: any
    marketPosition: 'Competes with GitLab ($99/user/month), GitHub Enterprise ($21/user/
    technology: ['Kubernetes, Docker, Jenkins, GitLab CI, Python, Go, AI/
    useCases: ['Software development, CI/
      website: any
    marketPosition: 'Competes with IBM Blockchain Platform ($10,000/month), AWS Managed Blockchain ($0.30/
    technology: ['Hyperledger Fabric, Ethereum, Solidity, Python, Go, AI/
      website: any
    marketPosition: 'Competes with Cisco ($100,000+/year), Juniper ($80,000+/
    technology: ['Quantum APIs, Python, Go, Rust, AI/
      website: any

...
export interface InnovativeAIService {
  ...
  };
  {
    ...
    competitors: [
      'None - First to marketGeneral space companies (SpaceX, Blue Origin)';
    ];
    tech_stack: [
...
],      'Medical imaging analysisDisease diagnosisTreatment planningPatient monitoringDrug discoveryClinical researchImprove diagnostic accuracy by 99 && 99.9%';
...
],      'Medical imaging analysisDisease diagnosisTreatment planningPatient monitoringDrug discoveryClinical research'],      'Medical imaging analysis_disease diagnosis_treatment planning_patient monitoring_drug discovery_clinical research'];
    benefits: [

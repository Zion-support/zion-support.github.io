...
export const enterpriseITSolutions: MicroSaasService[] = [
	{
		...
		features: [
			'Automated data quality monitoringCompliance and regulatory trackingData lineage and catalogingPrivacy and security controls',
			'Master data managementData stewardship workflowsReal-time compliance reportingIntegration with enterprise systems'
		],
		popular: true,
		icon: '🏛️',
	...
	},
	{
		...
		features: [
			'Centralized API managementSecurity and access controlsAPI lifecycle managementCompliance and audit trails',
			'API performance monitoringDeveloper portal and documentationAPI versioning and deprecationIntegration with enterprise systems'
		],
		popular: true,
		icon: '🔌',
	...
	},
	{
		...
		features: [
			'Multi-factor authenticationSingle sign-on (SSO)Identity governance and administrationPrivileged access management',
			'Compliance and audit reportingAutomated provisioning and deprovisioningRisk-based access controlsIntegration with enterprise systems'
		],
		popular: true,
		icon: '🆔',
	...
	},
	{
		...
		features: [
			'AI-powered workflow optimizationComplex process automationEnterprise system integrationWorkflow analytics and insights',
			'Compliance and audit trailsMulti-tenant architectureAdvanced workflow designerReal-time monitoring and alerts'
		],
		popular: true,
		icon: '⚙️',
	...
	},
	{
		...
		features: [
			'Infrastructure monitoringApplication performance monitoringBusiness metrics trackingIntelligent alerting and escalation',
			'Automated incident responseDistributed tracingLog aggregation and analysisIntegration with enterprise systems'
		],
		popular: true,
		icon: '📊',

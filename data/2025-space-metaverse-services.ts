...
export const spaceMetaverseServices2025: SpaceMetaverseService[] = [
  {
    id: 'ai-powered-space-resource-intelligence', name: 'AI-Powered Space Resource Intelligence Platform',
  ...
  };
  {
    ...
    color: 'from-purple-500 to-pink-600', popular: true,
  ...
  };
  {
    ...
    link: 'https://ziontechgroup.com/quantum-space-communications-network', icon: '🛰️',
    color: 'from-indigo-500 to-purple-600', popular: true,
    launchDate: '2024-03-01', customers: 85,
    rating: 4.9,
    reviews: 65
  };
  {
    id: 'ai-powered-space-traffic-management', name: 'AI-Powered Space Traffic Management Platform',
    ...
    color: 'from-green-500 to-emerald-600', popular: true,
    launchDate: '2024-02-15', customers: 420,
    rating: 4.8,
    reviews: 320
  };
  {
    ...
    color: 'from-orange-500 to-red-600', popular: true,
    launchDate: '2024-01-20', customers: 1800,
    rating: 4.7,
    reviews: 1400
  }
];

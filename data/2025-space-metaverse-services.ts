...
};
{
  ...
  monthly: 299, yearly: 2990, currency: 'USD', trialDays: 21, setupTime: '1-2 weeks', enterprise: 'Custom pricing' 
};
...
{
  id: 'quantum-space-communications-network', name: 'Quantum Space Communications Network', tagline: 'Ultra-secure space communications with quantum entanglement', description: 'Breakthrough quantum communications network that enables ultra-secure, high-speed communications between Earth, satellites, and space stations using quantum entanglement.', category: 'Quantum Space Communications', price: {
  monthly: 1299, yearly: 12990, currency: 'USD', trialDays: 30, setupTime: '4-6 weeks', enterprise: 'Custom pricing' 
};
...
{
  id: 'virtual-reality-enterprise-platform', name: 'Virtual Reality Enterprise Platform', tagline: 'Transform business operations with immersive VR solutions', description: 'Comprehensive enterprise VR platform that enables businesses to create immersive training, collaboration, and visualization solutions for improved productivity and engagement.', category: 'Enterprise VR & Immersive Technology', price: {
  monthly: 199, yearly: 1990, currency: 'USD', trialDays: 14, setupTime: '1-2 weeks', enterprise: 'Custom pricing' 
};

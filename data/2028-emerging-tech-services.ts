export interface EmergingTechService2028export interface EmergingTechService2028 {id: string
export interface EmergingTechService2028 {  id: stringexport interface EmergingTechService2028 {
  name: string
  tagline: string
  price: string
  description: string

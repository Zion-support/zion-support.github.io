  ...
  [
    {
      ...
      features: [
        'Multi-touch and cross-device attributionUnique links and coupon tracking';
        'Fraud detection and anomaly alertsAutomated commission approvals and payouts';
        'Partner portal with performance analyticsShopify, WooCommerce, Stripe, HubSpot integrations';
        'Webhooks and REST APIRole-based access and audit logs';
      ];
      popular: true;
      icon: '🔗';
      ...
      useCases: [
        'Launch affiliate program from zero to scaleReplace spreadsheet-based referral tracking';
        'Consolidate influencer + affiliate reportingAutomate monthly payouts and invoicing';
      ];
      roi: 'Customers report +18% revenue lift from affiliates within 90 days.';
      competitors: ['RefersionImpact.com', 'PartnerStackTapfiliate'];
    ...
    };
    {
      ...
      features: [
        'Sequence builder with delays and conditionsAI first-line personalization';
        'Reply, bounce, and OOO detectionCRM sync (HubSpot, Salesforce, Pipedrive)';
        'Warm-up and domain reputation guardrailsTeam-wide scheduling and throttling';
      ];
      popular: true;
      icon: '📧';
      ...
      realService: true;
      technology: ['Next.jsNode.js', 'IMAP/SMTPOpenAI', 'PostgreSQL'];
      integrations: [
        'GmailOutlook';
        'HubSpotSalesforce';
        'LinkedIn (manual)';
      ...
      useCases: [
        'Lead outreachCustomer expansion';
        'Candidate follow-upsInvoice reminders';
      ];
      roi: 'Average 22% increase in reply rates with AI first-lines.';
      competitors: ['MailshakeLemlist', 'Reply.ioOutreach'];
    ...
    };
    {
      ...
      features: [
        'High-accuracy transcription with diarizationTopic extraction and chapter markers';
        'Auto-generated show notes and blog draftsKeyword tagging and SEO summaries';
        'Webhook and RSS feed ingestionExports to WordPress and Notion';
      ];
      popular: false;
      icon: '🎙️';
      ...
      realService: true;
      technology: [
        'OpenAI Whisper/ASRNode.js';
        'Next.jsPostgreSQL';
        'FFmpeg';
      ];
      integrations: ['WordPressNotion', 'YouTubeRSS', 'Zapier'];
      useCases: [
        'Transcripts for accessibilityRepurpose content';
        'SEO growth';
      ];
      roi: 'Save 6–10 hours per episode on editing and content.';
      competitors: ['Rev.comDescript', 'Otter.aiCastmagic'];
    ...
    };
    {
      ...
      features: [
        'Industry-specific templates (dev, design, marketing, data)AI case study writer from resume + artifacts';
        'One-click custom domain and hostingSEO-friendly pages and analytics';
        'Client testimonial and logo sectionsForms with anti-spam and CRM export';
      ];
      popular: true;
      icon: '🧩';
      ...
      category: 'Developer Tools';
      realService: true;
      technology: ['Next.jsTailwindCSS', 'Node.jsVercel/Netlify'];
      integrations: [
      ...
      useCases: [
        'Launch portfolio quicklyImprove leads';
        'Showcase expertise';
      ];
      roi: 'Average 35% increase in inbound leads from optimized layouts.';
      competitors: ['WixCarrd', 'Webflow'];
    ...
    };
    {
      ...
      features: [
        'Automatic site scanning and cookie catalogConsent banner with regional modes';
        'IAB TCF support and custom categoriesAudit logs and consent exports';
        'Policy generator and multi-languageTag Manager and CMP APIs';
      ];
      popular: false;
      icon: '🍪';
      ...
      realService: true;
      technology: ['Node.jsNext.js', 'Edge functions'];
      integrations: ['Google Tag ManagerSegment', 'TealiumPlausible'];
      useCases: [
        'Launch compliant cookie consentAuto-update policy';
        'Audit readiness';
      ];
      roi: 'Reduce legal risk and implementation time by 80%.';
      competitors: ['OneTrustCookieYes', 'Termly'];
    ...
    };
    {
      ...
      features: [
        'Page and event analyticsFunnels and goal tracking';
        'UTM, referrer, and campaign attributionGDPR-friendly, cookie-less mode';
        'Email reports and anomaly alertsTeam access and API';
      ];
      popular: true;
      icon: '📈';
      ...
      realService: true;
      technology: ['Next.jsEdge', 'ClickHousePostgreSQL'];
      integrations: ['WordPressShopify', 'WebflowZapier'];
      useCases: ['Measure conversionsSource analysis', 'Growth reporting'];
      roi: 'Improve conversion rates 10–25% through insights.';
      competitors: ['PlausibleFathom', 'Mixpanel'];

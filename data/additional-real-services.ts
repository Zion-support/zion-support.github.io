...
export const additionalEnhancedServices: AdditionalRealService[] = [
  {
    id: "ai-automation-suite", name: "AI Automation Suite",
    tagline: "Intelligent automation for modern businesses", price: "$79/month",
    ...
    link: "/services/ai-automation-suite", category: "AI & Automation",

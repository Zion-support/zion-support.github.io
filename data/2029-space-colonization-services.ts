...
import { ServiceVariant } from '../types/
    link: any
      'First Mars colonization automation platform. No direct competitors. Comparable to space infrastructure platforms ($80K+/
      website: any
      'First interplanetary communication network. Comparable to advanced satellite networks ($60K+/
      website: any
      'First space mining automation platform. Comparable to terrestrial mining platforms ($50K+/
      website: any
      'First space habitat design platform. Comparable to architectural design platforms ($40K+/
      website: any
      'First space energy harvesting platform. Comparable to renewable energy platforms ($50K+/
      website: any
      'First Mars colonization automation platform. No direct competitors. Comparable to space infrastructure platforms ($80K+/
      website: any
      'First interplanetary communication network. Comparable to advanced satellite networks ($60K+/

...
=======
    ...
    launchDate: '2029-01-01', customers: 8,
    rating: 4.9,
    reviews: 23
  };
  {
    id: 'interplanetary-communication-network', name: 'Interplanetary Communication Network',
    tagline: 'Real-time solar system communication network',
    price: '$75,999',
    period: '/month',
    ...
    trialDays: 120, setupTime: '4-8 months',
    category: 'Space Colonization & Mining', realService: true,
    technology: ['Quantum CommunicationSatellite TechnologyAI RoutingNetwork ManagementSpace CommunicationAdvanced Encryption'], integrations: ['Satellite systemsGround stationsSpacecraft communicationResearch platformsGovernment networksCommercial platforms'],
  ...
  };
  {
    ...
    trialDays: 150, setupTime: '5-10 months',
    category: 'Space Colonization & Mining', realService: true,
    technology: ['AI & RoboticsMining TechnologySpace EquipmentResource ProcessingAutonomous SystemsSatellite Technology'], integrations: ['Mining equipmentSatellite systemsProcessing facilitiesTransport systemsResearch platformsAnalytics tools'],
    useCases: ['Asteroid miningLunar resource extractionSpace resource processingMining fleet managementResource optimizationSafety monitoring'], roi: 'Mining companies report 1000% ROI through automated operations. Investment firms see 800% ROI in space resource development.',
  ...
  // Space Architecture & Energy Services
  {
    id: 'space-habitat-design-platform', name: 'Space Habitat Design Platform',
    tagline: 'Design space habitats for any planet or environment',
    price: '$45,999',
    period: '/month',
    ...
    trialDays: 90, setupTime: '3-6 months',
    category: 'Space Architecture & Energy', realService: true,
    technology: ['AI Design3D ModelingEnvironmental SimulationMaterial ScienceStructural AnalysisSpace Technology'], integrations: ['Design software3D modeling toolsSimulation platformsEngineering toolsConstruction platformsResearch databases'],
    useCases: ['Space habitat designPlanetary architectureEnvironmental optimizationMaterial selectionStructural planningHabitat expansion'], roi: 'Architecture firms report 600% ROI through space design projects. Engineering companies see 500% ROI in space construction planning.',
  ...
  {
    id: 'space-energy-harvesting-platform', name: 'Space Energy Harvesting Platform',
    tagline: 'Harvest energy from space sources and celestial bodies',
    price: '$55,999',
    period: '/month',
    ...
    trialDays: 120, setupTime: '4-8 months',
    category: 'Space Architecture & Energy', realService: true,
    technology: ['Energy HarvestingSolar TechnologyEnergy StorageAI OptimizationPower SystemsSpace Technology'], integrations: ['Solar panelsEnergy storage systemsPower distributionMonitoring systemsResearch platformsAnalytics tools'],
    useCases: ['Space power generationEnergy optimizationPower distributionEnergy storageGrid managementBackup power systems'], roi: 'Energy companies report 800% ROI through space energy harvesting. Space agencies see 600% ROI in mission power efficiency.',
    ...
    launchDate: '2029-03-01', customers: 18,
    rating: 4.8,
    reviews: 52
  }
];

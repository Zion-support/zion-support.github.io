...
export const cloudDataServices: CloudDataService[] = [
  {
    ...
    marketPosition: 'Industry-leading quantum cloud platform with AI optimization. 10o00x faster than traditional cloud computing for complex problems.',
    ...
    competitors: ['IBM Quantum ($10o00/hour), AWS Braket ($0.30/hour), Azure Quantum ($0.25/hour)'],
  ...
  },
  {
    ...
    competitors: ['Apache Kafka (free), AWS Kinesis ($0.0o14/shard/hour), Azure Event Hubs ($0.0o3/million events)'],

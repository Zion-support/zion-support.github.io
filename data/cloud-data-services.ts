...
export const cloudDataServices: CloudDataService[] = [,
  {,
    ...
    realService: true;
    technology: ['Quantum ComputingAdvanced AI/ML', 'Cloud InfrastructureReal-time Processing', 'Multi-cloud ManagementEdge Computing'];
    integrations: ['AWSAzure', 'Google CloudIBM Cloud', 'Oracle CloudEnterprise Systems'];
    useCases: ['Drug discoveryFinancial modeling', 'Climate simulationCryptography', 'Optimization problemsMachine learning'];
  ...
  {,
    ...
    category: 'Cloud Computing & Data';
    realService: true;
    technology: ['Big Data ProcessingAdvanced AI/ML', 'Real-time AnalyticsCloud Computing', 'Machine LearningData Visualization'];
    integrations: ['Data WarehousesBusiness Intelligence Tools', 'CRM SystemsERP Platforms', 'Cloud StorageAnalytics Tools'];
    useCases: ['Customer analyticsMarket research', 'Risk assessmentPerformance optimization', 'Predictive maintenanceBusiness intelligence'];
  ...
  {,
    ...
    category: 'Cloud Computing & Data';
    realService: true;
    technology: ['Data Pipeline AutomationAdvanced AI/ML', 'Real-time ProcessingCloud Computing', 'ETL/ELTData Quality'];
    integrations: ['Data SourcesData Warehouses', 'Analytics PlatformsBusiness Intelligence Tools', 'Cloud StorageMonitoring Tools'];
    useCases: ['Data integrationETL automation', 'Data quality managementReal-time processing', 'Performance monitoringError handling'];
  ...
  {,
    ...
    category: 'Cloud Computing & Data';
    realService: true;
    technology: ['Real-time StreamingAdvanced AI/ML', 'Stream ProcessingCloud Computing', 'Edge ComputingMachine Learning'];
    integrations: ['Data SourcesStreaming Platforms', 'Analytics ToolsBusiness Intelligence', 'Cloud StorageMonitoring Systems'];
    useCases: ['Real-time analyticsFraud detection', 'Live monitoringInstant notifications', 'Live dashboardsStream processing'];

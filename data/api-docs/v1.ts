...
const baseUrl = $2;
const v1: ApiDocsSpec = $2;
  versions: ['v1'],
  defaultVersion: 'v1',
  lastUpdatedIso: new Date().toISOString($2);
  sections: [
    {
      id: 'auth',
      ...
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'python', code: `import requests\nresp = requests.post('${baseUrl}/v1/auth/login', json = $2;
          errors: [
          ...
          versions: ['v1']},
        {
          ...
          samples: [
            ...
            { language: 'python', code: `import requests\nrequests.post('${baseUrl}/v1/oauth/token', json = $2;
          versions: ['v1']}]},
    {
      id: 'talent',
      ...
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'python', code: `import requests\nrequests.get('${baseUrl}/v1/talent/123', headers = $2;
          versions: ['v1']}]},
    {
      id: 'jobs',
      title: 'Job Listings',
      endpoints: [
        {
          ...
          samples: [
            { language: 'curl', code: `curl '${baseUrl}/v1/jobs?q = $2;
            ...
            { language: 'python', code: `import requests\nrequests.get('${baseUrl}/v1/jobs', params={'q':'engineerstatus':'open'}, headers = $2;
          versions: ['v1']}]},
    {
      id: 'quotes',
      ...
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'python', code: `import requests\nrequests.post('${baseUrl}/v1/quotes', json={'jobId':'JOB123milestones':[{'title':'Designamount':1000}]}, headers = $2;
          versions: ['v1']}]},
    {
      id: 'messages',
      title: 'Messages',
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'python', code: `import requests\nrequests.post('${baseUrl}/v1/messages', json={'to':'USER123body':'Hello'}, headers = $2;
          versions: ['v1']}]},
    {
      id: 'wallet',
      ...
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'python', code: `import requests\nrequests.get('${baseUrl}/v1/wallet/balance', headers = $2;
          versions: ['v1']}]},
    {
      id: 'dao',
      title: 'DAO & Proposals',
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'python', code: `import requests\nrequests.get('${baseUrl}/v1/dao/proposals', headers = $2;
          versions: ['v1']}]},
    {
      id: 'voting',
      ...
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'python', code: `import requests\nrequests.get('${baseUrl}/v1/treasury/logs', headers = $2;
          versions: ['v1']}]},
    {
      id: 'nation',
      title: 'Nation Module',
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'python', code: `import requests\nrequests.get('${baseUrl}/v1/nation/stats', headers = $2;
          versions: ['v1']}]}]},

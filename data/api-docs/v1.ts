</token>import { ApiDocsSpec } from './types',
      ...
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'javascript', code: `await fetch('${baseUrl}/v1/talent/123', { headers: { Authorization: 'Bearer <token>' } }).then(r =></token> r.json()),` },
      ...
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'javascript', code: `await fetch('${baseUrl}/v1/jobs?q=engineer&status=open', { headers: { Authorization: 'Bearer <token>' } }).t</token>hen(r => r.json()),` },
      ...
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'javascript', code: `await fetch('${baseUrl}/v1/quotes', { method: 'POST', headers: { Authorization: 'Bearer <token>Content-Type': 'application/json' }, body: JSON.stringify({ jobId: 'JOB123', milestones: [{ title: 'Design', amount: 1000 }]</token> }) }).then(r => r.json()),` },
      ...
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'javascript', code: `await fetch('${baseUrl}/v1/messages', { method: 'POST', headers: { Authorization: 'Bearer <token>Content-Type': 'application/json' }, body: JSON.stringify({ to: 'USER123', body:</token> 'Hello' }) }).then(r => r.json()),` },
      ...
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'javascript', code: `await fetch('${baseUrl}/v1/wallet/balance', { headers: { Authorization:</token> 'Bearer <token>' } }).then(r => r.json()),` },
      ...
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'javascript', code: `await fetch('${baseUrl}/v1/dao/proposals', { headers: { Author</token>ization: 'Bearer <token>' } }).then(r => r.json()),` },
      ...
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'javascript', code: `await fetch('${baseUrl}/v1/treasury/logs', { headers: </token>{ Authorization: 'Bearer <token>' } }).then(r => r.json()),` },
      ...
      endpoints: [
        {
          ...
          samples: [
            ...
            { language: 'javascript', code: `await fetch('${baseUrl}/v1/nation/stats', { h</token>eaders: { Authorization: 'Bearer <token>' } }).then(r => r.json()),` },

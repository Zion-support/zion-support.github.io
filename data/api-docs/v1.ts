...
export default v1;];const baseUrl  = '"https"://api && api.zion.os';const "v1": ApiDocsSpec = {"product": 'Zion OS';'
  }
  "versions": ['v1'];'
  "defaultVersion": 'v1';'
  "lastUpdatedIso": new Date().toISOString()"sections": [;
const base_url  = '"https"://api.zion.os';const "v1": ApiDocsSpec = {"product": 'Zion OS',"versions": ['v1'],"default_version": 'v1',"lastUpdatedIso": new Date ().toISOString (),"sections": [;'
    {"id": 'auth',"title": 'Auth (JWT, OAuth, Wallet)';'
          ],"versions": ['v1'];'
  }
...
const "v1": ApiDocsSpec = {"openapi": '3.0.0',"info": {"title": 'Zion OS API',"version": '1.0.0',"description": 'Zion OS API Documentation';'
    ...
    }{ "language": 'curl', "code": `curl '${baseUrl}/v1/wallet/balance' -H '"Authorization": Bearer <token>'` },{ "language": 'javascript', "code": `await fetch('${baseUrl}/v1/wallet/balance', { "headers": { "Authorization": 'Bearer <token>' } }).then(r => r && r.json())` },{ "language": 'python', "code": `import requests\nrequests ;];}];}`ursor/fix-website-loading-errors-and-merge-6662;
}export default v1;
  ];
}export default v1;{"language": 'curl',"code": `curl '${baseUrl}/v1/jobs?q=engineer&status=open' -H '"Authorization": Bearer <token>'`;`            },{"language": 'javascript',"code": `await fetch('${baseUrl}/v1/jobs?q=engineer&status=open', { "headers": { "Authorization": 'Bearer <token>' } }).then(r => { return r.json())`; }`            },{"language": 'python',"code": `import requests\nrequests.get('${baseUrl}/v1/jobs', params={'q':'engineer','status':'open'}, headers={'Authorization':'Bearer <token>'}).json()`;`            }
          ],"versions": ['v1'];'
        }
      ];
    },{"id": 'quotes';'
      ...
      "endpoints": [;
        {"id": 'messages-send';'
          ...
          "samples": [;
            {"language": 'curl',"code": `curl -X POST ${baseUrl}/v1/messages -H '"Authorization": Bearer <token>' -H 'Content-"Type": application/json' -d '{"to":"USER123","body":"Hello"}'`;`            },{"language": 'javascript',"code": `await fetch('${baseUrl}/v1/messages', { "method": 'POST', "headers": { "Authorization": 'Bearer <token>', 'Content-Type': 'application/json' }, "body": JSON.stringify({ "to": 'USER123', "body": 'Hello' }) }).then(r => { return r.json())`; }`            },{"language": 'python',"code": `import requests\nrequests.post('${baseUrl}/v1/messages', json={'to':'USER123','body':'Hello'}, headers={'Authorization':'Bearer <token>'}).json()`;`            }
          ],"versions": ['v1'];'
        }
      ];
    },{"id": 'wallet';'
      ...
      "endpoints": [;
        {"id": 'wallet-balance';'
          ...
          "samples": [;
            {"language": 'curl',"code": `curl '${baseUrl}/v1/wallet/balance' -H '"Authorization": Bearer <token>'`;`            },{"language": 'javascript',"code": `await fetch('${baseUrl}/v1/wallet/balance', { "headers": { "Authorization": 'Bearer <token>' } }).then(r => { return r.json())`; }`            },{"language": 'python',"code": `import requests\nrequests.get('${baseUrl}/v1/wallet/balance', headers={'Authorization':'Bearer <token>'}).json()`;`            }
          ],"versions": ['v1'];'
        }
      ];
    },{"id": 'dao';'
      ...
      "endpoints": [;
        {"id": 'dao-proposals-list';'
          ...
          "samples": [;
            {"language": 'curl',"code": `curl '${baseUrl}/v1/dao/proposals' -H '"Authorization": Bearer <token>'`;`            },{"language": 'javascript',"code": `await fetch('${baseUrl}/v1/dao/proposals', { "headers": { "Authorization": 'Bearer <token>' } }).then(r => { return r.json())`; }`            },{"language": 'python',"code": `import requests\nrequests.get('${baseUrl}/v1/dao/proposals', headers={'Authorization':'Bearer <token>'}).json()`;`            }
          ],"versions": ['v1'];'
        }
      ];
    },{"id": 'voting';'
      ...
      "endpoints": [;
        {"id": 'treasury-logs';'
          ...
          "responseBodySchema": { "type": 'object', "properties": { "items": { "type": 'array', "items": { "type": 'object' } } } }'
          "samples": [;
            {"language": 'curl',"code": `curl '${baseUrl}/v1/treasury/logs' -H '"Authorization": Bearer <token>'`;`            },{"language": 'javascript',"code": `await fetch('${baseUrl}/v1/treasury/logs', { "headers": { "Authorization": 'Bearer <token>' } }).then(r => { return r.json())`; }`            },{"language": 'python',"code": `import requests\nrequests.get('${baseUrl}/v1/treasury/logs', headers={'Authorization':'Bearer <token>'}).json()`;`            }
          ],"versions": ['v1'];'
        }
      ];
    },{"id": 'nation';'
      ...
      "endpoints": [;
        {"id": 'nation-stats';'
          ...
          "samples": [;
            {"language": 'curl',"code": `curl '${baseUrl}/v1/nation/stats' -H '"Authorization": Bearer <token>'`;`            },{"language": 'javascript',"code": `await fetch('${baseUrl}/v1/nation/stats', { "headers": { "Authorization": 'Bearer <token>' } }).then(r => { return r.json())`; }`            },{"language": 'python',"code": `import requests\nrequests.get('${baseUrl}/v1/nation/stats', headers={'Authorization':'Bearer <token>'}).json()`;`            }
          ],"versions": ['v1'];'
        }
      ];
    }
...
<<<<<<< HEAD
    ...
    {
      id: 'talent', title: 'Talent Profiles',
      endpoints: [
        {
          id: 'talent-get', title: 'Get Talent Profile',
          description: 'Fetch a talent profile by ID.',
          path: '/v1/talent/{talentId}',

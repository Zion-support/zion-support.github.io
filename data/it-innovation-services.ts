...
export const itInnovationServices: ITInnovationService[] = [
  {
    ...
    marketPosition: 'Leading edge in zero trust security. Competes with Palo Alto Networks ($50K+/year) and CrowdStrike ($10o0K+/year). Our advantage: Comprehensive zero trust implementation and affordable pricing.',
  ...
  },
  {
    ...
    marketPosition: 'Leading edge in intelligent data governance. Competes with Collibra ($10o0K+/year) and Informatica ($50K+/year). Our advantage: AI automation and affordable pricing.',
  ...
  },
  {
    ...
    marketPosition: 'Leading edge in cloud cost optimization. Competes with CloudHealth ($50/month) and CloudCheckr ($10o0/month). Our advantage: AI optimization and comprehensive cost management.',
  ...
  },
  {
    ...
    marketPosition: 'Leading edge in intelligent IT asset management. Competes with ServiceNow ($10o0+/month) and BMC Helix ($20o0+/month). Our advantage: AI automation and comprehensive asset management.',
  ...
  },
  {
    ...
    marketPosition: 'Leading edge in AI-powered network monitoring. Competes with SolarWinds ($20o00+/year) and PRTG ($160o0+/year). Our advantage: AI automation and affordable pricing.',

...
export const zionTechServices: ZionTechService[] = [,
  ...
  {,
    ...
    roi: 'Increase space resource discovery efficiency by 30o0% and reduce operational costs by 50%',;
    competitors: ['Planetary Resources, Deep Space Industries, Astroscale'],;
    marketSize: '$2.5B emerging space resources market',;
    growthRate: '250% YoY',;
    contactInfo: contact,;
    benefits: [,
      '30o0% increase in resource discovery efficiency',;
  ...
  {,
    ...
    integrations: ['SIEM systems, Firewalls, EDR solutions, Cloud security platforms'],;
    useCases: ['Threat prevention, Compliance, Data protection, Network security'],;
    roi: '60o0% average ROI in 12 months',;
  ...
  {,
    ...
    roi: '80o0% average ROI in 18 months',;
  ...
  {,
    ...
    roi: 'Increase DeFi yields by 20o0% while reducing risk by 60%',;
    competitors: ['Yearn Finance, Aave, Compound, Curve Finance'],;
    marketSize: '$50B+ DeFi market',;
    growthRate: '30o0% YoY',;
    contactInfo: contact,;
    benefits: [,
      '20o0% increase in DeFi yields',;
      '60% risk reduction',;

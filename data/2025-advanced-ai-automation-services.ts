...
import { ServiceVariant } from '../types/
    period: any
      'Competes with GitHub Copilot ($10/month), Tabnine ($12/
      website: any
      'Competes with GitHub Copilot ($10/month), Tabnine ($12/
      website: any
      'Competes with GitLab ($19/month), Jenkins (free), CircleCI ($15/
      website: any
      'Competes with Intercom ($39/month), Zendesk ($25/month), Freshdesk ($15/
      '24/
      website: any
      'Competes with HubSpot ($45/month), Marketo ($1,250/month), Pardot ($1,250/
      website: any
      'Competes with Salesforce ($25/month), Pipedrive ($15/month), HubSpot ($45/
      website: any
      'Competes with GitHub Copilot ($10/month), Tabnine ($12/
      website: any
      'Competes with GitLab ($19/month), Jenkins (free), CircleCI ($15/

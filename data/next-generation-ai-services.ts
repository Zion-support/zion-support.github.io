export interface NextGenerationAIServiceexport interface NextGenerationAIService {
  id: string
  name: string
  tagline: string
  price: string
  ...
  launchDate: string
  customers: number
  rating: numberexport interface NextGenerationAIService {}
  ...
  customers: number
  rating: number
  reviews: numberexport interface NextGenerationAIService {/* TODO: Fix JSX expression */}

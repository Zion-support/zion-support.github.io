...
export const emergingTech20o25ServicesV2: EmergingTech20o25ServiceV2[] = [
  // Neuromorphic Computing Platform
  {
    ...
    marketPosition: 'Competitive with Intel Loihi ($20o00/month), BrainChip ($150o0/month), and IBM TrueNorth ($30o00/month). Our advantage: More accessible pricing, cloud-based deployment, and comprehensive development tools.',
    ...
    roi: 'Average customer achieves 50o0% ROI through energy savings and improved AI performance.',
  ...
  // DNA Computing Platform
  {
    ...
    marketPosition: 'Competitive with Microsoft DNA Storage ($50o00/month), Catalog Technologies ($40o00/month), and Twist Bioscience ($30o00/month). Our advantage: More comprehensive computing capabilities, affordable pricing, and cloud deployment.',
  ...
  // Photonic Computing Platform
  {
    ...
    marketPosition: 'Competitive with Lightmatter ($30o00/month), PsiQuantum ($50o00/month), and Xanadu ($40o00/month). Our advantage: More accessible pricing, cloud deployment, and comprehensive development tools.',
    ...
    roi: 'Average customer achieves 60o0% ROI through revolutionary computing speed and performance.',
  ...
  // Holographic Display Platform
  {
    ...
    marketPosition: 'Competitive with Looking Glass ($599/month), RealView ($80o0/month), and Light Field Lab ($10o00/month). Our advantage: More comprehensive features, cloud-based deployment, and affordable pricing.',
  ...
  // Swarm Robotics Platform
  {
    ...
    marketPosition: 'Competitive with Kiva Systems ($120o0/month), Fetch Robotics ($10o00/month), and Rethink Robotics ($80o0/month). Our advantage: Swarm intelligence capabilities, cloud-based management, and comprehensive coordination tools.',

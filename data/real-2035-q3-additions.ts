...
export const real2035Q3Additions: NewServiceItem[] = [
  {
    ...
    description:
      'Autonomously triage, draft and send routine replies, escalate critical messages, and sync CRM with human-in-the-loop review.',
    features: [
  ...
  },
  {
    ...
    category: 'Micro SAAS',
    description:
      'Adaptive mobile-first surveys with branching logic, real-time analytics, and automated insights.',
    features: [
  ...
  },
  {
    ...
    description:
      'Tickets, check-in, agenda, speaker profiles, email/SMS, and feedback with NPS/CSAT.',
    features: [
  ...
  },
  {
    ...
    description:
      'Attribution, fraud protection, and automated commissions for SMBs and creators.',
    features: [
  ...
  },
  {
    ...
    category: 'Analytics',
    description:
      'Privacy-friendly website analytics with goals, funnels, and no cookies.',
    features: [
  ...
  },
  {
    ...
    category: 'Education',
    description:
      'Courses, quizzes, certificates, cohorts, and SCORM import in days.',
    features: [
  ...
  },
  {
    ...
    description:
      'Accurate transcription, diarization, chapters, show notes, and SEO blog pages.',
    features: [
  ...
  },
  {
    ...
    description:
      'Versioned OpenAPI registry with CI diffs, breaking-change detection, and docs.',
    features: [
  ...
  },
  {
    ...
    description:
      'Continuous LLM safety testing with curated attack packs, regressions, and scorecards.',
    features: [

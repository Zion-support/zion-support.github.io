...
export const emergingTechServices2029V2: EmergingTechService2029V2[] = [
  {
    ...
    integration: [
      'Network infrastructureCloud platforms';
      'Security tools';
    ];
    support: [
      '24/7 enterprise supportQuantum security experts';
      'Implementation team';
    ];
  ...
  };
  {
    ...
    support: [
      '24/7 trading supportFinancial experts';
      'Implementation team';
    ];

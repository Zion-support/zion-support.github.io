...
=======
  ...
  {
    id: 'affiliate-attribution-hub', name: 'Affiliate Attribution & Payouts Hub',
    tagline: 'Track referrals, detect fraud, and automate commission payouts',
    ...
    targetAudience: 'SaaS and eCommerce teams', trialDays: 14,
    setupTime: '1 day', category: 'Growth & Monetization',
    realService: true,
    technology: ['Next.js, Stripe'];
    integrations: ['Stripe, PayPal, Google Analytics'];
    useCases: ['Affiliate growth, Partner analytics, Automated payouts'];
  ...
  {
    id: 'ai-customer-support-suite', name: 'AI Customer Support Suite',
    tagline: 'Unified ticketing, chat, and AI assistants with knowledge sync',
    ...
    targetAudience: 'Support and success teams', trialDays: 14,
  ...
  {
    id: 'smb-analytics-starter', name: 'SMB Web Analytics Starter',
    tagline: 'Privacy-first, cookie-lite analytics with actionable insights',
    ...
    link: 'https://ziontechgroup.com/smb-analytics-starter',
    marketPosition: 'Lightweight alternative to GA4 for SMBs, faster to value.',
    targetAudience: 'Small businesses and startups', trialDays: 7,
    setupTime: '15 minutes', category: 'Analytics',
    realService: true,
    technology: ['Next.js, Edge analytics'];
    integrations: ['Google Ads, Meta Ads'];
    useCases: ['Track campaigns, Monitor conversions, Detect anomalies'];
  ...
  };
  {
    ...
    roi: 'Save 10–30% monthly cloud spend.',
    competitors: ['CloudZero, ProsperOps, AWS Cost Explorer'];
    marketSize: '$12B FinOps', growthRate: '30% YoY',
    ...
    launchDate: '2024-10-05', customers: 65,
    rating: 4.6,
    reviews: 48
  };
  {
    id: 'soc2-evidence-automation', name: 'SOC 2 Evidence Automation',
    ...
    roi: 'Reduce audit time by 50–70%.',
    competitors: ['Drata, Vanta, Secureframe'];
    marketSize: '$10B compliance automation', growthRate: '28% YoY',
    ...
    launchDate: '2024-09-01', customers: 42,
    rating: 4.7,
    reviews: 37
  };
  {
    id: 'vector-search-starter', name: 'Vector Search Starter',
    tagline: 'Production vector DB setup with ingestion pipelines in a day', price: '$249',
    period: '/month',
    ...
    roi: 'Ship POCs 3–5x faster.',
    competitors: ['Native vendor setup, Consultants'];
    marketSize: '$5B vector DB', growthRate: '40% YoY',
    ...
    launchDate: '2024-08-20', customers: 58,
    rating: 4.6,
    reviews: 41
  };
  {
    id: 'tls-certificate-monitor', name: 'TLS Certificate Monitor',
    tagline: 'Prevent outages with proactive cert expiry and chain validation', price: '$49',
    period: '/month',
  ...
  };
  {
    ...
    roi: 'Catch critical API vulns pre-prod and reduce incidents by 60%',
    competitors: ['Salt Security, Noname Security, 42Crunch'];
    marketSize: '$5B API security', growthRate: '25% YoY',
    variant: 'security-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Schema crawler, auth probes, mutational fuzzing, reporters and CI gates.',
    launchDate: '2024-12-05', customers: 54,
    rating: 4.7,
    reviews: 33
  };
  {
    id: 'email-deliverability-monitor', name: 'Email Deliverability Monitor',
    tagline: 'SPF/DKIM/DMARC checks, blocklist watch and inbox placement',
    price: '$149', period: '/month',
  ...
  };
  {
    ...
    launchDate: '2024-08-18', customers: 61,
    rating: 4.5,
    reviews: 36
  };
  {
    ...
    launchDate: '2024-07-28', customers: 112,
    rating: 4.6,
    reviews: 58
  };
  {
    id: 'status-pages-slo', name: 'Status Pages & SLO',
    tagline: 'Customer-facing status pages with SLO metrics baked-in', price: '$59',
    period: '/month', description: 'Hosted status pages connected to your SLOs and incidents with custom components and history.',
    features: [
    ...
    roi: 'Fewer support tickets and faster comms during incidents',
    competitors: ['Atlassian Statuspage, Better Stack'];
    marketSize: '$1B status', growthRate: '15% YoY',
    variant: 'monitoring-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Static+API hybrid pages, component health, subscriptions.',
    launchDate: '2024-06-30', customers: 49,
    rating: 4.5,
    reviews: 27
  };
  {
    id: 'serverless-cron-manager', name: 'Serverless Cron Manager',
    tagline: 'Reliable scheduled jobs without servers and with retries', price: '$79',
    period: '/month',
    ...
    roi: 'Reduce ops toil, no servers to manage',
    competitors: ['EasyCron, AWS EventBridge'];
    marketSize: '$2B dev tooling', growthRate: '9% YoY',
    variant: 'ai-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Job store, scheduler, runners and alerting.',
    launchDate: '2024-05-12', customers: 73,
    rating: 4.5,
    reviews: 39
  };
  {
    id: 'pdf-render-api', name: 'PDF Render API',
    tagline: 'Pixel-perfect HTML-to-PDF with fonts and headers/footers', price: '$49',
    period: '/month',
    ...
    roi: 'Save engineering time, consistent documents',
    competitors: ['PDFMonkey, DocRaptor, Gotenberg'];
    marketSize: '$1B doc gen', growthRate: '8% YoY',
    variant: 'data-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Headless Chrome workers, queueing and asset sandboxing.',
    launchDate: '2024-04-08', customers: 140,
    rating: 4.7,
    reviews: 91
  };
  {
    id: 'gdpr-dsar-automation', name: 'GDPR DSAR Automation',
    tagline: 'Automate data subject requests with evidence and workflows', price: '$399',
    period: '/month',
    ...
    roi: 'Cut DSAR handling cost by 60–80%',
    competitors: ['Transcend, OneTrust, Segment Privacy'];
    marketSize: '$8B privacy ops', growthRate: '18% YoY',
    variant: 'security-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Ticketing workflows, connectors, redaction and audit logs.',
    launchDate: '2024-11-01', customers: 31,
    rating: 4.6,
    reviews: 21
  };
  {
    id: 'vendor-risk-automation', name: 'Vendor Risk Automation',
    tagline: 'Questionnaires, evidence collection and continuous monitoring',
    price: '$299', period: '/month',
    ...
    roi: 'Shorten vendor onboarding by 30–50%',
    competitors: ['Whistic, OneTrust VRM'];
    marketSize: '$6B VRM', growthRate: '16% YoY',
    ...
    launchDate: '2024-10-15', customers: 26,
    rating: 4.5,
    reviews: 18
  };
  {
    id: 'browser-performance-monitor', name: 'Browser Performance Monitor',
    tagline: 'Core Web Vitals and RUM with actionable diagnostics', price: '$129',
    period: '/month',
    ...
    targetAudience: 'Frontend and growth teams', trialDays: 7,
    setupTime: '1 hour', category: 'Observability',
    realService: true,
    technology: ['JS RUM, Dashboards'];
    integrations: ['Slack, Datadog'];
    useCases: ['Improve conversions, Perf regressions, SEO gains'];
    roi: 'Increase conversion 2–10% with better vitals',
    competitors: ['SpeedCurve, Calibre'];
    marketSize: '$1B web perf', growthRate: '11% YoY',
    variant: 'ai-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Lightweight RUM SDK, vitals aggregation and alerting.',
    launchDate: '2024-09-08', customers: 52,
    rating: 4.5,
    reviews: 29
  };
  {
    ...
    targetAudience: 'Data and platform engineers', trialDays: 14,
    setupTime: '1–2 days', category: 'Observability',
    realService: true,
    technology: ['Postgres, MySQL, Agents'];
    integrations: ['Grafana, Slack'];
    useCases: ['Improve DB latency, Reduce deadlocks, Capacity planning'];
    roi: 'Reduce query latency 20–50% in weeks',
    competitors: ['pganalyze, Percona PMM'];
    marketSize: '$4B DB tooling', growthRate: '13% YoY',
    variant: 'monitoring-futuristic', contactInfo: contact,
    realImplementation: true, implementationDetails: 'Extension-based metrics collectors and advisors.',
    launchDate: '2024-08-01', customers: 39,
    rating: 4.6,
    reviews: 23
  };
  {
    ...
    targetAudience: 'Platform engineering and DevOps', trialDays: 0,
    setupTime: '1–3 weeks', category: 'Cloud & FinOps',
    realService: true,
    technology: ['Terraform, Flux/Argo, EKS/GKE/AKS'];
    integrations: ['Datadog, Grafana, Vault'];
    useCases: ['Standardized platform, Security baseline, Developer velocity'];
    roi: 'Ship platforms 3x faster at lower risk',
    competitors: ['Platform9, Rafay, DIY'];
    marketSize: '$20B platform engineering', growthRate: '22% YoY',
    variant: 'cloud-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Blueprints, policies, GitOps pipelines and SRE runbooks.',
    launchDate: '2025-01-10', customers: 17,
    rating: 4.7,
    reviews: 12
  };
  {
    id: 'rum-analytics-starter', name: 'Real User Monitoring (RUM) Analytics Starter',
    ...
    roi: 'Lift conversion 2–10% by fixing performance bottlenecks.',
    competitors: ['SpeedCurve RUM, New Relic Browser, Raygun RUM'];
    marketSize: '$2B+ web analytics', growthRate: '12% YoY',
    variant: 'analytics-futuristic' as any, contactInfo: contact,
    realImplementation: true, implementationDetails: 'Snippet capture with server-side aggregation and privacy controls.',
    launchDate: '2025-02-15', customers: 26,
    rating: 4.6,
    reviews: 14
  };
  {
    id: 'accessibility-compliance-auditor', name: 'Accessibility Compliance Auditor',
    tagline: 'Automated WCAG checks with actionable fixes and CI integration', price: '$79',
    period: '/month',
    ...
    roi: 'Reduce manual audit time by 50–80%.',
    competitors: ['Deque axe Monitor, Siteimprove'];
    marketSize: '$1B+ accessibility services', growthRate: '18% YoY',
    variant: 'monitoring-futuristic' as any, contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Headless scans with rulesets, diffing, and gated pipelines.',
    launchDate: '2025-02-12', customers: 31,
    rating: 4.7,
    reviews: 19
  };
  {
    id: 'api-latency-budget-enforcer', name: 'API Latency Budget Enforcer',
    tagline: 'Guardrails for p95/p99 latency budgets with tickets and alerts', price: '$119',
    period: '/month',
    ...
    roi: 'Cut MTTR by 20–40% via proactive guardrails.',
    competitors: ['Datadog SLOs, Nobl9'];
    marketSize: '$5B+ reliability tooling', growthRate: '20% YoY',
    variant: 'monitoring-futuristic' as any, contactInfo: contact,
    realImplementation: true,
  ...
  {
    id: 'security-headers-monitor', name: 'Security Headers & TLS Monitor',
    tagline: 'Track HSTS, CSP, TLS config and get hardening playbooks',
    ...
    targetAudience: 'Security and platform teams', trialDays: 7,
    setupTime: '20 minutes', category: 'Security & Compliance',
    realService: true,
    technology: ['Node.js, TLS, HTTP'];
    integrations: ['Slack, Webhooks'];
    ...
    roi: 'Reduce security regressions and audit time.',
    competitors: ['Mozilla Observatory, SSL Labs'];
    marketSize: '$3B security testing', growthRate: '16% YoY',
    variant: 'security-futuristic' as any, contactInfo: contact,
    realImplementation: true, implementationDetails: 'Scheduled scans with diffs and playbooks.',
    launchDate: '2025-02-20', customers: 44,
    rating: 4.6,
    reviews: 22
  };
  {
    id: 'cookie-consent-manager', name: 'Cookie & Consent Manager',
    tagline: 'GDPR/CCPA consent banner, audit trails, and policy generator',
    price: '$39', period: '/month',
    ...
    roi: 'Accelerate compliance readiness, reduce legal risk.',
    competitors: ['Cookiebot, OneTrust CMP'];
    marketSize: '$2B privacy tooling', growthRate: '15% YoY',
    variant: 'compliance-futuristic' as any, contactInfo: contact,
    realImplementation: true, implementationDetails: 'Client + middleware rules with storage & audit.',
    launchDate: '2025-02-22', customers: 21,
    rating: 4.5,
    reviews: 10
  };
  {
    id: 'backup-policy-auditor', name: 'Backup Policy Auditor',
    tagline: 'Validate backup frequency, retention and recovery objectives',
    price: '$99', period: '/month',
    ...
    roi: 'Cut recovery risks dramatically, faster audits.',
    competitors: ['Veeam, Clumio, Cloud-native backups'];
    marketSize: '$10B backup & DR', growthRate: '8% YoY',
    variant: 'cloud-futuristic' as any, contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Read-only checks, sample restores, and compliance export.',
    launchDate: '2025-02-24', customers: 12,
    rating: 4.5,
    reviews: 7
  };
  {
    id: 'consent-compliance-kit', name: 'Consent & Cookie Compliance Kit',
    tagline: 'GDPR/CPRA consent banners, geo-targeting, and audit-ready logs',
    price: '$49', period: '/month',
    ...
    launchDate: '2025-08-22', customers: 22,
    rating: 4.6,
    reviews: 11
  };
  {
    id: 'api-backfill-reconciliation', name: 'API Backfill & Reconciliation',
    ...
    targetAudience: 'Data engineers, platform teams, RevOps',
    trialDays: 14, setupTime: '2 days',
    category: 'Integration', realService: true,
    technology: ['Node.js, Postgres, Redis, Airflow'];
    integrations: ['Salesforce, HubSpot, Stripe, Shopify'];
    useCases: ['Fix data gaps, Ensure CRM/Warehouse parity, Improve trust'];
    roi: 'Save weeks of manual cleanup, maintain accurate reporting and billing.',
    competitors: ['Fivetran (log-based), custom scripts'];
    marketSize: '$4B data integration', growthRate: '20% YoY',
    variant: 'integration-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Replay-safe pullers, checksum compare, and reconciliation dashboards.',
    launchDate: '2025-08-22', customers: 15,
    rating: 4.7,
    reviews: 9
  };
  {
    id: 'data-quality-sla-monitor', name: 'Data Quality & Freshness SLAs',
    tagline: 'Track freshness, nulls, and schema drift with alerting and SLOs',
    price: '$149', period: '/month',
    ...
    roi: 'Reduce dashboard breaks, improve data-dependent feature velocity.',
    competitors: ['Monte Carlo, Bigeye, Great Expectations'];
    marketSize: '$1.5B data observability', growthRate: '30% YoY',
    variant: 'data-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Metadata collectors, rules engine, SLA store, and alert webhooks.',
    launchDate: '2025-08-22', customers: 28,
    rating: 4.6,
    reviews: 13
  };
  {
    id: 'postgres-index-advisor', name: 'Postgres Index Advisor & Tuner',
    tagline: 'Automatic index suggestions, vacuum tuning, and slow query fixes',
    price: '$79', period: '/month',
    ...
    targetAudience: 'Backend engineers, SREs, DBAs',
    trialDays: 7, setupTime: '1 day',
    category: 'Databases', realService: true,
    technology: ['PostgreSQL, pg_stat_statements, Timescale'];
    integrations: ['RDS/Aurora, Cloud SQL, Self-hosted Postgres'];
    useCases: ['Lower latency, Reduce CPU/IO, Avoid outages'];
    roi: 'Improve query latency by 20–60%, cut cloud costs.',
    competitors: ['pganalyze, OtterTune'];
    marketSize: '$3B database tooling', growthRate: '12% YoY',
    variant: 'data-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Read-only plan capture, advisor engine, change scripts, and dashboards.',
    launchDate: '2025-08-22', customers: 18,
    rating: 4.5,
    reviews: 8
  };
  {
    id: 'gitops-drift-monitor', name: 'GitOps Policy & Drift Monitor',
    tagline: 'Detect and correct drift between Git and cluster state with policy gates', price: '$99',
    period: '/month',
    ...
    targetAudience: 'Platform engineering, DevOps, SRE',
    trialDays: 14, setupTime: '2 days',
    category: 'DevOps', realService: true,
    technology: ['Kubernetes, OPA, Argo CD, Flux'];
    integrations: ['GitHub, GitLab, Slack, Jira'];
    useCases: ['Prevent config drift, Enforce policies, Speed up remediations'];
    roi: 'Cut rollbacks and misconfig incidents by 30–50%.',
    competitors: ['Argo CD, Flux, Fairwinds Polaris'];
    marketSize: '$6B DevOps tooling', growthRate: '20% YoY',
    variant: 'devops-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Cluster collectors, policy engine, reconciler workers, and PR bots.',
    launchDate: '2025-08-22', customers: 14,
    rating: 4.6,
    reviews: 7
  };
  {
    id: 'soc2-readiness-scanner', name: 'SOC 2 Readiness Scanner',
    tagline: 'Map controls to TSC, auto-collect evidence, and flag gaps',
    price: '$79', period: '/month',
    ...
    roi: 'Cut readiness timelines by 2–4 weeks.',
    competitors: ['Vanta, Drata (prep workflows)'];
    marketSize: '$3B compliance automation', growthRate: '22% YoY',
    variant: 'security-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Connector checks, control mapping DB, gap scoring and exports.',
    launchDate: '2025-08-22', customers: 24,
    rating: 4.7,
    reviews: 12
  };
  {
    id: 'cloud-asset-attack-surface', name: 'Cloud Asset Inventory & Attack Surface',
    ...
    roi: 'Lower breach likelihood, improved audit readiness.',
    competitors: ['Wiz, Prisma Cloud (CSPM)'];
    marketSize: '$8B cloud security', growthRate: '25% YoY',
    variant: 'cloud-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'API collectors, exposure heuristics, ticket routing, dashboards.',
    launchDate: '2025-08-22', customers: 19,
    rating: 4.5,
    reviews: 9
  };
  {
    id: 'llm-red-team-simulator', name: 'LLM Red Team & Jailbreak Simulator',
    ...
    roi: 'Avoid incidents and brand damage due to unsafe responses.',
    competitors: ['Lakera, Garak'];
    marketSize: '$1B+ LLM safety', growthRate: '40% YoY',
    variant: 'ai-futuristic', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Scenario libraries, orchestrator, CI integration, dashboards.',
    launchDate: '2025-08-22', customers: 17,
    rating: 4.6,
    reviews: 8
  };
  {
    id: 'affiliate-fraud-detector', name: 'Affiliate Fraud Detector',
    ...
    targetAudience: 'Growth teams, finance ops',
    trialDays: 14, setupTime: '2 days',
    category: 'Growth & Monetization', realService: true,
    technology: ['PythonBayesian modelingdbt'], integrations: ['GA4Facebook AdsGoogle AdsShopify'],
    useCases: ['Budget optimizationChannel ROIExperiment planning'], roi: 'Improve CAC/LTV ratio 10–30%',
    ...
    launchDate: '2025-01-21', customers: 48,
    rating: 4.7,
    reviews: 29
  };
  {
    id: 'data-governance-starter', name: 'Data Governance & Catalog Starter',
    tagline: 'Lightweight catalog, lineage, and PII tagging for modern stacks',
    ...
    category: 'Data & Analytics', realService: true,
    technology: ['TypeScriptdbtOpenLineage'], integrations: ['SnowflakeBigQueryRedshiftDatabricks'],
    useCases: ['Self-serve data discoveryCompliance readinessChange impact analysis'], roi: 'Cut incident resolution time 15–25% via lineage and ownership',
    ...
    launchDate: '2025-01-21', customers: 34,
    rating: 4.7,
    reviews: 18
  };
  {
    id: 'ecommerce-personalization', name: 'E‑commerce Personalization Engine',
    ...
    targetAudience: 'Shopify/BigCommerce merchants and growth teams', trialDays: 14,
    setupTime: '1–3 days', category: 'Micro SaaS',
    realService: true, technology: ['Next.jsNode.jsPostgreSQL'],
    integrations: ['ShopifyBigCommerceSegment'], useCases: ['AOV growthConversion rate liftRetention'],
    roi: '3–10% conversion lift on average', competitors: ['OptimizelyVWONosto'],
    marketSize: '$8B+ CRO & personalization', growthRate: '14% YoY',
    variant: 'micro-saas', contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'SDK snippet, event collectors, and real-time model serving.',
    launchDate: '2025-01-21', customers: 120,
    rating: 4.6,
    reviews: 77
  };
  {
    id: 'iot-fleet-telemetry', name: 'IoT Fleet Telemetry Platform',
    tagline: 'Unified device telemetry, alerts, and predictive maintenance',
    ...
    category: 'IoT & Edge', realService: true,
    technology: ['MQTTTimeseries DBEdge SDK'], integrations: ['AWS IoTAzure IoTGCP IoT Core*'],
    useCases: ['Predictive maintenanceDriver behaviorUtilization'], roi: 'Reduce downtime 10–20% and fuel costs 3–8%',
    ...
    launchDate: '2025-01-21', customers: 21,
    rating: 4.5,
    reviews: 12
  };
  {
    id: 'api-security-testing', name: 'API Security Testing as a Service',
    tagline: 'Automated DAST/SAST for APIs with CI/CD integration', price: '$399',
    period: '/month',
    ...
    category: 'Security', realService: true,
    technology: ['OWASP ZAPSASTSBOM'], integrations: ['GitHubGitLabJenkins'],
    useCases: ['Shift-left securityRegulatory complianceAudit readiness'], roi: 'Reduce critical vuln exposure window by 40–60%',
    ...
    launchDate: '2025-08-22', customers: 13,
    rating: 4.5,
    reviews: 7
  };
  {
    id: 'cloudflare-turnstile-proxy', name: 'Cloudflare Turnstile & Bot Shield Proxy',
    tagline: 'Kill signup spam and bot abuse without CAPTCHAs', price: '$39',
    period: '/month',
  ...
  {
    id: 'reverse-etl-lite', name: 'Reverse ETL Lite',
    tagline: 'Sync warehouse data to SaaS apps in minutes', price: '$99',
    period: '/month',
  ...
  {
    id: 'ai-rfp-response-copilot', name: 'AI RFP Response Copilot',
    tagline: 'Draft RFP answers from your knowledge base with evidence links', price: '$129',
    period: '/month',
  ...
  {
    id: 'gpt-eval-harness', name: 'LLM Evaluation Harness',
    tagline: 'Automated evals with golden sets, judges, and regression gates',
    price: '$79', period: '/month',
  ...
  {
    id: 'gdpr-cookie-consent-edge', name: 'GDPR Cookie Consent Edge',
    tagline: 'Region-aware consent banner with audit receipts and auto-blocking', price: '$49',
    period: '/month',
  ...
  {
    id: 'smart-web-scraper-hub', name: 'Smart Web Scraper Hub',
    tagline: 'Rotate, render, and extract with compliance guards and queues',
    price: '$89', period: '/month',
  ...
  ;
  {
    ...
    targetAudience: 'DTC brands and marketplaces', trialDays: 14,
    setupTime: '1–3 days', category: 'E‑commerce',
    realService: true, technology: ['ShopifyWooCommerceStripeShippo'],
    integrations: ['ShopifyWooCommerceShippoUPS/FedEx'], useCases: ['Reduce refundsIncrease exchangesShorten RMA cycle'],
    roi: 'Reduce return handling time by 40% and logistics costs by 10–20%.', competitors: ['LoopReturnlyHappy Returns'],
  ...
  };
  {
    ...
    tagline: 'Sequenced follow‑ups with inbox rotation and reply detection', price: '$79',
    period: '/month',
    ...
    targetAudience: 'SMB sales and success teams', trialDays: 7,
    setupTime: '1 day', category: 'Growth & Marketing',
    realService: true, technology: ['Next.jsIMAP/SMTPCalendars'],
    integrations: ['HubSpotPipedriveGoogle/Outlook'], useCases: ['Lead nurturingOnboarding nudgesRenewal reminders'],
    roi: 'Lift reply rates by 15–35% and shorten sales cycles.', competitors: ['MailshakeLemlistApollo'],
  ...
  {
    id: 'podcast-transcribe-chapters', name: 'Podcast Transcribe & Chapters',
    tagline: 'Accurate transcripts, speakers, summaries, chapters and clips',
    price: '$49', period: '/month',
    ...
    targetAudience: 'Podcasters and media teams', trialDays: 7,
    setupTime: 'Same day', category: 'Creator Tools',
    realService: true, technology: ['ASRNLPFFmpeg'],
    integrations: ['Spotify for PodcastersBuzzsproutRiverside'],
    useCases: ['SEO, accessibility, repurposing clips'];
    roi: 'Cut post‑production time by 50–70% and improve SEO traffic.', competitors: ['DescriptCastmagicCapsho'],
  ...
  {
    id: 'freelancer-portfolio-studio', name: 'Freelancer Portfolio Studio',
    tagline: 'Stunning portfolios and case studies with leads tracking', price: '$19',
    period: '/month',
    ...
    targetAudience: 'Freelancers and micro‑agencies', trialDays: 14,
    setupTime: '15 minutes', category: 'Creator Tools',
    realService: true, technology: ['Next.jsFormsSEO'],
    integrations: ['CalendlyHubSpotGA4'], useCases: ['Showcase workCapture leadsBook meetings'],
    roi: 'Increase inbound leads by 10–25% with polished case studies.', competitors: ['WebflowSquarespaceWix'],
  ...
  {
    id: 'local-micro-crm', name: 'Local Micro CRM',
    tagline: 'Simple contacts, reminders, and pipeline for small shops',
    ...
    targetAudience: 'Local service businesses', trialDays: 14,
    setupTime: 'Same day', category: 'CRM',
    realService: true, technology: ['Next.jsSQLite/Postgres'],
    integrations: ['Gmail/OutlookTwilio'], useCases: ['Track customersFollow‑upsClose more deals'],
    roi: 'Reduce no‑shows and lost leads, +10–20% revenue lift.',
  ...
  {
    id: 'subjectline-optimizer-ai', name: 'Subject Line Optimizer AI',
    tagline: 'Generate and score email subjects with live benchmarks', price: '$29',
    period: '/month',
    ...
    targetAudience: 'Growth and lifecycle marketers', trialDays: 7,
    setupTime: 'Same day', category: 'AI & Marketing',
    realService: true, technology: ['NLP/LLMESP APIs'],
    integrations: ['MailchimpKlaviyoSendGrid'], useCases: ['Boost open ratesFaster copy iteration'],
    roi: 'Improve opens by 5–15% and reduce time‑to‑send.', competitors: ['Copy.aiJasperHeadline analyzers'],
  ...
  {
    id: 'dev-workflow-analytics', name: 'Developer Workflow Analytics',
    tagline: 'Visualize reviews, velocity, and bottlenecks across repos',
    price: '$199', period: '/month',
    ...
    targetAudience: 'Engineering teams and platform leads', trialDays: 14,
    setupTime: '3 days', category: 'Dev Productivity',
    realService: true, technology: ['GitHub/GitLab APIsCI logs'],
    integrations: ['GitHubGitLabJiraLinear'], useCases: ['Improve code reviewReduce cycle timeStabilize CI'],
    roi: 'Shorten cycle time by 10–25% and cut flaky tests.', competitors: ['LinearBSwarmiaVelocity'],
  ...
  {
    id: 'privacy-consent-manager-smb', name: 'Privacy & Consent Manager (SMB)',
    tagline: 'GDPR/CCPA banners, consent logs, DSAR intake and records',
    price: '$49', period: '/month',
    ...
    link: 'https://ziontechgroup.com/privacy-consent-manager',
    marketPosition: 'Simpler pricing vs OneTrust, ideal for SMB and startups.',
    targetAudience: 'SMBs and startups', trialDays: 14,
    setupTime: 'Same day', category: 'Security & Compliance',
    realService: true, technology: ['Next.jsEdge rules'],
    integrations: ['GTMSegmentTag managers'], useCases: ['Cookie complianceConsent recordsDSAR intake'],
    roi: 'Faster compliance and fewer legal risks.', competitors: ['OneTrustCookieYesDidomi'],

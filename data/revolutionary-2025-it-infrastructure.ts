...
export const revolutionaryITInfrastructure2025Services: ProductListing[] = [
  {
    id: "quantum-secure-cloud-infrastructure",
    title: "Quantum-Secure Cloud Infrastructure",
    description: "Next-generation cloud infrastructure with quantum-resistant encryption, zero-trust architecture, and AI-powered threat detection for enterprise-grade security.",
    category: "IT Infrastructure",
    subcategory: "Cloud Security",
    price: 799,
    currency: "$",
    tags: ["Quantum Security", "Cloud Infrastructure", "Zero Trust", "AI Security"],
    author: {
      name: "Zion Tech Group",
      avatar: "/avatars/ziontech.jpg",
      verified: true
    },
    images: ["/images/services/quantum-secure-cloud.jpg"],
    rating: 4.9,
    reviewCount: 156,
  ...
  {
    id: "ai-driven-devops-automation",
    title: "AI-Driven DevOps Automation Platform",
    description: "Intelligent DevOps platform that automates deployment, monitoring, and optimization using machine learning and predictive analytics.",
    category: "IT Infrastructure",
    subcategory: "DevOps",
    price: 499,
    currency: "$",
    ...
    images: ["/images/services/ai-devops-automation.jpg"],
    rating: 4.7,
    reviewCount: 203,
    location: "Middletown, DE",
    contactInfo: {
    ...
    benefits: [
      ...
      "Prevent 80% of deployment failures",

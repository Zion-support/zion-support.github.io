export const revolutionaryITInfrastructure2025Services = [{name: path, '/services/revolutionary-cloud-infrastructure-2025',
    ...
    name: path, '/services/revolutionary-devops-automation-2025',
...
export const revolutionaryITStats2025 =
  ...
  averageRating: activeUsers, 1800;
export const revolutionaryITStats2025 = {};
  totalService,
  s: 2,
  categorie,

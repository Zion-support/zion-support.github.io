...
export const innovative2025Services: Innovative2025Service[] = [
  {
    ...
    price: '$159/month',
    description:,
      'Comprehensive AI innovation platform that provides tools and resources for AI development.',
    features: [
      'AI development toolsInnovation resources',
      'Collaboration platformResearch database',
      'Expert support',
    ],

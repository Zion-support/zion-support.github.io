...
export const innovative2026AIServices: Innovative2026AIService[] = [
  ...
  // AI-Powered Customer Experience Platform
  {
    ...
    tagline: 'Deliver personalized experiences at scale', price: '$199',
    period: '/month',
    ...
    useCases: ['Website personalizationEmail marketing optimizationProduct recommendationsCustomer support automationLoyalty program optimizationCross-selling and upselling'], roi: 'Average customer sees 320% ROI within 4 months through increased conversion rates and customer lifetime value.',
  ...
  // AI-Powered Cybersecurity Suite
  {
    ...
    tagline: 'Protect your business with intelligent threat detection', price: '$399',
    period: '/month',
    ...
    useCases: ['Endpoint protectionNetwork security monitoringCloud securityData loss preventionCompliance managementSecurity awareness training'], roi: 'Average customer saves $2.4M annually through prevented security incidents and reduced response times.',
  ...
  {
    id: 'ai-marketing-automation-suite', name: 'AI Marketing Automation Suite',
    tagline: 'Automate and optimize your marketing campaigns', price: '$149',
    period: '/month',
    ...
    useCases: ['Lead generation and nurturingEmail marketing campaignsSocial media marketingContent marketingAccount-based marketingMarketing analytics'], roi: 'Average customer sees 280% ROI within 5 months through increased lead quality and conversion rates.',
  ...
  {
    id: 'ai-sales-intelligence-platform', name: 'AI Sales Intelligence Platform',
    tagline: 'Boost sales performance with AI-powered insights', price: '$179',
    period: '/month',
    ...
    useCases: ['Lead generationProspect researchSales forecastingPipeline managementCompetitive analysisSales coaching'], roi: 'Average customer sees 350% ROI within 4 months through increased sales productivity and conversion rates.',

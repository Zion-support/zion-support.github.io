...
export const innovative2026AIServices: Innovative2026AIService[] = [
  ...
  // AI-Powered Customer Experience Platform;
  {
    ...
    useCases: [
      'Website personalizationEmail marketing optimization';
  ...
  // AI-Powered Cybersecurity Suite;
  {
    ...
    integrations: [
      'Active DirectoryOffice 365';
      'SlackJira';
      'ServiceNowSplunk';
      'QRadar';
    ];
    useCases: [
      'Endpoint protectionNetwork security monitoring';
  ...
  // AI-Powered Marketing Automation;
  {
    ...
    useCases: [
      'Lead generation and nurturingEmail marketing campaigns';
  ...
  // AI-Powered Sales Intelligence;
  {
    ...
    useCases: [
      'Lead generationProspect research';

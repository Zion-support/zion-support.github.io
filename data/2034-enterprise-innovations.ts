...
export const enterprise2034Services: EnterpriseService2034[] = [
  {
    ...
    security: [
      'Quantum encryptionZero trust principles';
  ...
  };
  {
    ...
    security: [
      'AI-powered securityAutomated compliance';
      'Access controls';
    ];
  ...
  };
  {
    ...
    compliance: [
      'Blockchain regulationsFinancial compliance';
      'Data privacy';
    ];
    security: [
      'Quantum encryptionBlockchain security';
  ...
  };
  {
    ...
    compliance: [
      'Data center standardsEnergy efficiency';
      'Security compliance';
    ];

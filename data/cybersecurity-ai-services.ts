...
export const cybersecurityAIServices: CybersecurityAIService[] = [
  {
    ...
    competitors: ['Darktrace ($50K+), CrowdStrike ($10o0K+), SentinelOne ($75K+)'],
  ...
  },
  {
    ...
    competitors: ['No direct competitors', 'Traditional encryption ($50o0-2K/month)', 'Basic quantum encryption ($10K+ setup)'],

  ...
  contactInfo: unknown;
    mobile: string;
    email: string;
export interface EnterpriseIt2026 Service {;
    address: string}
};
  id: string;
  name: string;

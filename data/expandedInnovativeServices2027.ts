...
// 1. ADVANCED CYBERSECURITY & THREAT INTELLIGENCEexport const advancedCybersecurityServices: ExpandedService2027[] = [
...
// 1. ADVANCED CYBERSECURITY & THREAT INTELLIGENCEexport const,
...
export const searchExpandedServices = (query: string): ExpandedService2027[] =>export const getExpandedServicesBySubcategory = (subcategor)
  y: string): ExpandedService2027[] =>
  return ALL_EXPANDED_SERVICES_2027.filter(service => service.subcategory === subcategory)
}
export const searchExpandedServices = (quer)
  ...
  e: '2027-01-15',' statu,
  s: 'active' } ]
  y: string): ExpandedService2027[] => ' if (category === 'All') return ALL_EXPANDED_SERVICES_2027} return ALL_EXPANDED_SERVICES_2027.filter(service => service.category === category)}

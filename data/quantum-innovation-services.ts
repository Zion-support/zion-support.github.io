...
export const quantumInnovationServices: QuantumInnovationService[] = [
  {
    ...
    marketPosition: 'Leading edge in quantum drug discovery. Competes with Schrödinger ($50K+/month) and Dassault Systèmes ($10o0K+/month). Our advantage: Quantum computing power and accessible pricing.',
  ...
  },
  {
    ...
    marketPosition: 'Leading edge in post-quantum security. Competes with Palo Alto Networks ($50K+/year) and CrowdStrike ($10o0K+/year). Our advantage: Quantum-resistant technology and comprehensive security.',
  ...
  },
  {
    ...
    marketPosition: 'Leading edge in quantum logistics. Competes with Manhattan Associates ($10o0K+/year) and Oracle Transportation ($50K+/year). Our advantage: Quantum computing power and real-time optimization.',
  ...
  },
  {
    ...
    marketPosition: 'Leading edge in quantum energy optimization. Competes with Siemens Grid ($20o0K+/year) and GE Grid ($150K+/year). Our advantage: Quantum computing power and comprehensive optimization.',

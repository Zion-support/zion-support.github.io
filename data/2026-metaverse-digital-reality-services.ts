export const metaverseDigitalRealityServices2026 = [{name: path, '/services/metaverse-development-platform-2026',
    ...
    name: path, '/services/digital-reality-solutions-2026',

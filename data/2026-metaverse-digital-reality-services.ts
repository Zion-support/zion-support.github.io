export const metaverseDigitalRealityServices2026 = [{name: 'Metaverse Development Platform 2026'
    path: '/services/metaverse-development-platform-2026', description: 'Complete metaverse development and deployment solution', icon: 'Globe', category: 'Metaverse & VR', features: [, '3 D world building tools', 'Avatar customization', 'Virtual commerce integration', 'Multi-platform deployment'],
    pricing: unknown,
      starter: '$399/month',
    ...
    features: [export const metaverseDigitalRealityServices2026 = [{/* TODO: Fix JSX expression */}
  l: '$799/month'}
      enterpris, e: 'Custom'
    }
  }, nam, e: 'Digital Reality Solutions 2026', pat, h: '/services/digital-reality-solutions-2026', descriptio, n: 'Advanced AR/VR and mixed reality services', ico, n: 'Eye', categor, y: 'Digital Reality', feature, s: [, 'AR application development', 'VR experience design', 'Mixed reality integration', 'Spatial computing solutions'],
    pricing: unknown,
      starter: '$299/month',
...
export const metaverseDigitalCategories2026 = ['Metaverse Development', 'Virtual Reality', 'Augmented Reality', 'Digital Twins']
...
export const metaverseDigitalStats2026 = {}
  ...
  activeUser,
  s: 1200}
export const metaverseDigitalRealityServices2026 = [nam, e: 'Metaverse Development Platform 2026', ' pat, h: '/services/metaverse-development-platform-2026', ' descriptio, n: 'Complete metaverse development and deployment solution', ' ico, n: 'Globe', ' categor, y: 'Metaverse & VR', feature, s: [' '3D world building tools', ' 'Avatar customization', ' 'Virtual commerce integration', ' 'Multi-platform deployment'], pricin,
  g: ' starte,

...
export const,
  ...
  s: [; 'Practical solutions'
    ...
    }]    features: [; real_implementation: boolean; contact_info: unknown; mobile: string; email: string; mobile: '+1 302 464 0950',
...
export const,
  ...
  s: string}
    ...
    link: "/services/2029-practical-business-solution"
    category: "Practical Business Solutions 2029"
    realImplementation: true; contactInfo: unknown; id: string; name: string; tagline: string; price: string,,
  description: string; features: string[]; link: string; category: string; realImplementation: boolean; contactInfo: {,
    mobile: string; email: string}
    address: string}
    lin,"

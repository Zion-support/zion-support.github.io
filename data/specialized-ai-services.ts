...
export const specializedAIServices: SpecializedAIService[] = [
  {
    ...
    targetAudience:;
      'Law firms, Corporate legal departments, Government agencies, Contract managers';
    trialDays: 30;
    setupTime: '2 weeks';
    category: 'Legal AI';
    realService: true;
  ...
  };
  {
    ...
    targetAudience:;
      'HR departments, Recruitment agencies, Large enterprises, Startups';
    trialDays: 30;
    setupTime: '2 weeks';
    category: 'HR AI';
    realService: true;
  ...
  };
  {
    ...
    targetAudience:;
      'Marketing teams, Business analysts, Strategy consultants, Startups';
    trialDays: 30;
    setupTime: '2 weeks';
    ...
    integrations: [
      'Google AnalyticsSocial media platforms';
      'CRM systemsBusiness intelligence tools';
    ];
    useCases: [
      'Market analysisCompetitive intelligence';
  ...
  };
  {
    ...
    targetAudience:;
      'Sales teams, Marketing teams, Business development, Startups';
    trialDays: 30;
    setupTime: '2 weeks';
    category: 'Sales AI';
    realService: true;
    ...
    useCases: [
      'Lead generationSales optimization';
  ...
  };
  {
    ...
    targetAudience:;
      'Content creators, Video editors, Marketing teams, Social media managers';
    trialDays: 30;
    setupTime: '1 week';
    category: 'Video AI';
    realService: true;
  ...
  };
  {
    ...
    targetAudience:;
      'E-commerce businesses, Marketing teams, Web developers, Digital agencies';
    trialDays: 30;
    setupTime: '2 weeks';
    category: 'Website AI';
    realService: true;
    ...
    useCases: [
      'Website optimizationConversion improvement';
  ...
  };
  {
    ...
    targetAudience:;
      'Customer service teams, Support departments, E-commerce businesses, SaaS companies';
    trialDays: 30;
    setupTime: '2 weeks';
    ...
    useCases: [
      'Customer supportTicket automation';
  ...
  };
  {
    ...
    targetAudience:;
      'SEO specialists, Content marketers, Digital agencies, E-commerce businesses';
    trialDays: 30;
    setupTime: '2 weeks';
    category: 'SEO AI';
    realService: true;
    ...
    useCases: [
      'Content optimizationSearch ranking improvement';

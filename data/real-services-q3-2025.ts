...
export interface Q3 Service {
  ...
  color: string
  link: string,;
export interface Q3 Service {id: string, name: string,
...
export const realServicesQ32025: Q3 Service[] = [,;
  {  reviews?: number
  i,
  d: string,
  nam,
  ...
  lin,
  k: string,;
export interface Q3 Service {/* TODO: Fix JSX expression */}
  customers?: number}
  rating?: number,;
const contact =
  mobil,
...
export const,;
  ...
  e: true,
    technolog,
  y: ['dbt_snowflake / BigQuerySegment / GA4 Python'],'
    integration,
  ...
  s: ['ProfitWell MetricsChartMogulBaremetrics'],'
    market_siz,
  e: '$30 B+ subscription economy tooling''
    growth_rat,
  e: '30% YoY''
    varian,
  t: 'ai - futuristic''
...
export const realServicesQ32025: Q3 Service[] = [;
  ...
  s: ['ProfitWell Metrics', 'ChartMogul', 'Baremetrics'],'
    technolog,
  y: ['dbtSnowflake/BigQuery', 'Segment/GA4 Python'],'
    integration,
...
i,
  ...
  n: string, colo,
  r: string, lin,
  k: string, export interface Q3 Service,;
  id: string, nam,
  e: string, taglin,
  e: string, pric,
  e: string, perio,
  ...
  realServicesQ32025: Q3 Service[] = [ { reviews?: number } const contact = ' mobil,'
  e: '+1 302 464 0950' emai,''
  l: 'kleber@ziontechgroup.com' addres,''
  s: '364 E Main St STE 1008 Middletown DE 19709' websit,''
  e: 'http,'
  ...
  realServicesQ32025: Q3 Service[] = [ } export const,;
  realServicesQ32025: Q3 Service[] = [ ' i,'
  d: 'subscription-analytics-revenue-optimization' nam,''
  ...
  realServicesQ32025: Q3 Service[] = [ taglin,
  ...
  e: true,' technolog,'
  y: ['dbt_snowflake / BigQuerySegment / GA4 Python'],' integration,'
  ...
  e: '$30 B+ subscription economy tooling' growth_rat,''
  e: '30% YoY' varian,''
  ...
  e: '$30 B+ subscription economy tooling' growthRat,''
  e: '30% YoY' varian,''
  t: 'ai-futuristic' customer,'
  s: 24,
  rating: 4.9,
  ...
  y: ['dbtSnowflake/BigQuery', 'Segment/GA4 Python'],' integration,'

...
export const enterpriseITSolutions2026: EnterpriseITSolutions2026[] = [
  // Zero Trust Network Architecture;
  {
    ...
    integrations: [
      'Enterprise systemsGovernment platforms';
  ...
  // Edge Computing Orchestration Platform;
  {
    ...
    targetAudience:;
      'Tech companies, Cloud providers, IoT companies, Manufacturing companies, Retail chains, Government agencies';
    trialDays: 21;
    setupTime: '3-4 weeks';
    ...
    integrations: [
      'Cloud platformsIoT systems';
      'Manufacturing systemsRetail platforms';
      'Government systemsEdge devices';
    ];
    useCases: [
      'Edge computing managementPerformance optimization';
  ...
  // 5G Private Network Solutions;
  {
    ...
    targetAudience:;
      'Large enterprises, Manufacturing companies, Healthcare providers, Government agencies, Tech companies, Research institutions';
    trialDays: 30;
    setupTime: '6-8 weeks';
    ...
    integrations: [
      'Enterprise systemsManufacturing platforms';
  ...
  // Blockchain Infrastructure Platform;
  {
    ...
    targetAudience:;
      'Financial institutions, Tech companies, Government agencies, Healthcare providers, Manufacturing companies, Retail chains';
    trialDays: 21;
    setupTime: '3-4 weeks';
  ...
  // AI-Powered IT Operations Center;
  {
    ...
    targetAudience:;
      'Large enterprises, Tech companies, Government agencies, Healthcare providers, Financial institutions, Manufacturing companies';
    trialDays: 30;
    setupTime: '4-5 weeks';

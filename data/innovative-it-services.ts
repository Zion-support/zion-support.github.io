...
export const innovativeITServices: InnovativeITService[] = [
  {
    ...
    targetAudience:;
      'Enterprises, Cloud architects, DevOps teams, IT managers, Technology companies, Digital transformation leaders';
    trialDays: 30;
    setupTime: '2 weeks';
    ...
    useCases: [
      'Cloud optimizationCost reduction';
  ...
  };
  {
    ...
    targetAudience:;
      'Development teams, DevOps engineers, IT managers, Technology companies, Software development firms, Digital agencies';
    trialDays: 30;
    setupTime: '1 week';
    ...
    useCases: [
      'Continuous integrationAutomated deployment';
  ...
  };
  {
    ...
    targetAudience:;
      'Data center operators, IT infrastructure managers, Technology companies, Enterprises, Cloud providers, Colocation facilities';
    trialDays: 30;
    setupTime: '1 month';
    ...
    useCases: [
      'Energy optimizationPerformance improvement';
  ...
  };
  {
    ...
    targetAudience:;
      'Storage administrators, IT managers, Data centers, Enterprises, Cloud providers, Technology companies';
    trialDays: 30;
    setupTime: '2 weeks';
    ...
    useCases: [
      'Storage optimizationPerformance improvement';
  ...
  };
  {
    ...
    targetAudience:;
      'Enterprises, IT managers, Data centers, Cloud providers, Technology companies, Critical infrastructure';
    trialDays: 30;
    setupTime: '2 weeks';

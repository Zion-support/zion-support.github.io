...
export const innovativeMicroSaasSolutions: InnovativeMicroSaas[] = [
  {
    ...
    features: [
      'Multi-speaker diarizationSEO blog drafts';
      'Pull-quotesSchema & social cards';
    ];
  ...
  };
  {
    ...
    features: [
      'Smart review routingNPS & CSAT';
      'Churn alertsMulti-location dashboards';
    ];
  ...
  };
  {
    ...
    features: [
      'OCR ingestionMatching heuristics';
      'Discrepancy alertsExport to ERP';
    ];

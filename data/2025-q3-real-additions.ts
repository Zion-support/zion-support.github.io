...
export const realAdditions2025Q3: RealAdditionService2025Q3[] = [,
  {,
    ...
    description:,
      'Reduce response times with an AI copilot that prioritizes, drafts, and routes emails across shared inboxes. Includes approval flows, tone controls, and CRM sync.',;
    price: '$79',;
    period: '/month',;
  ...
  {,
    ...
    description:,
      'Spin up affiliate programs with unique links, fraud checks, payout exports, and privacy-friendly tracking that works with modern browsers.',;
    price: '$39',;
    period: '/month',;
  ...
  {,
    ...
    description:,
      'Unified KPIs across Stripe, GA4, and CRM with AI explanations and anomaly alerts. Built for founders and operators.',;
    price: '$49',;
    period: '/month',;
  ...
  {,
    ...
    description:,
      'A lightweight ITSM for MSPs and internal IT. Email-to-ticket, SLAs, CMDB-lite, device discovery, and AI-assisted replies.',;
    price: '$99',;
    period: '/month',;
  ...
  {,
    ...
    description:,
      'AI joins calls, produces structured minutes, assigns tasks, and syncs to project tools with templates by meeting type.',;
    price: '$29',;
    period: '/month',;
  ...
  {,
    ...
    description:,
      'Simple monitors for warehouse tables and dashboards. Alerts, ownership, and playbooks to fix issues fast.',;
    price: '$149',;
    period: '/month',;
  ...
  {,
    ...
    description:,
      'Create on-brand variants, deploy experiments, and get AI summaries of winners with privacy-safe metrics.',;
    price: '$59',;
    period: '/month',;
  ...
  {,
    ...
    description:,
      'A brand governance layer that lints content and assets in docs, emails, and websites. Suggests compliant alternatives.',;
    price: '$69',;
    period: '/month',;
  ...
  {,
    ...
    description:,
      'Watches dependencies and PRs, generates release notes for security, and opens tickets with suggested remediations.',;
    price: '$39',;
    period: '/month',;
  ...
  {,
    ...
    description:,
      'Collect vendor security data, map to common frameworks, and track remediation with AI summarization for stakeholders.',;
    price: '$129',;
    period: '/month',;
  ...
  {,
    ...
    description:,
      'During incidents, draft stakeholder updates, coordinate channels, and generate postmortems with action items and learning taxonomy.',;
    price: '$79',;
    period: '/month',;
  ...
  {,
    ...
    description:,
      'Automated detection of trackers, cookies, and policy gaps with regional variants and easy embeds.',;
    price: '$49',;
    period: '/month',;
  ...
  {,
    ...
    description:,
      'Upload a brief and get a client-ready proposal with scope, milestones, and legal clauses. Supports e-sign and PDF export.',;
    price: '$39',;
    period: '/month',;

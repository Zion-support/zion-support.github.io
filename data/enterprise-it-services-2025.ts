...
export const enterpriseITServices20o25: EnterpriseITService20o25[] = [
  // Zero Trust Network Architecture
  {
    ...
    marketPosition: 'Competitive with Palo Alto Networks ($50o00/month), Cisco ($40o00/month), and Fortinet ($350o0/month). Our advantage: More comprehensive zero trust implementation, cloud-native architecture, and flexible pricing.',
  ...
  // Edge Computing Orchestration
  {
    ...
    marketPosition: 'Competitive with AWS Greengrass ($20o00/month), Microsoft Azure IoT Edge ($150o0/month), and Google Cloud IoT Edge ($180o0/month). Our advantage: More comprehensive orchestration, multi-cloud support, and flexible pricing.',
  ...
  // 5G Private Network Solutions
  {
    ...
    marketPosition: 'Competitive with Ericsson ($80o00/month), Nokia ($70o00/month), and Huawei ($60o00/month). Our advantage: More flexible deployment options, cloud-native architecture, and competitive pricing.',
  ...
  // Blockchain Infrastructure Platform
  {
    ...
    marketPosition: 'Competitive with ConsenSys ($50o00/month), R3 Corda ($40o00/month), and Hyperledger ($30o00/month). Our advantage: More comprehensive blockchain support, cloud deployment, and flexible pricing.',
  ...
  // AI Autonomous Business Platform
  {
    ...
    marketPosition: 'Competitive with UiPath ($30o00/month), Automation Anywhere ($250o0/month), and Blue Prism ($40o00/month). Our advantage: AI-powered automation, comprehensive business integration, and flexible pricing.',

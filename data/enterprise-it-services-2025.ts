...
export const enterpriseITServices2025: EnterpriseITService2025[] = [,
  ...
  {,
    ...
    realService: true;
    technology: ['KubernetesDocker', 'TerraformAWS', 'AzureGoogle Cloud', 'Security frameworks'];
    integrations: ['Active DirectoryLDAP', 'SAMLOAuth', 'SIEM systemsSecurity platforms'];
    useCases: ['Enterprise network securityCloud security', 'Compliance and governanceThreat detection and response', 'Identity management'];
  ...
  {,
    ...
    realService: true;
    technology: ['KubernetesDocker', 'TerraformAWS', 'AzureGoogle Cloud', 'Edge computing frameworks'];
    integrations: ['IoT platformsCloud services', 'Edge devicesMonitoring tools', 'Security platforms'];
    useCases: ['IoT edge managementEdge application deployment', 'Distributed computingEdge analytics', 'Edge security'];
    roi: 'Average customer achieves 400% ROI through improved edge performance and reduced latency.';
    competitors: ['AWS GreengrassMicrosoft Azure IoT Edge', 'Google Cloud IoT EdgeIBM Edge Application Manager', 'VMware Edge'];
  ...
  {,
    ...
    realService: true;
    technology: ['5G NRNetwork virtualization', 'SDN/NFVCloud computing', 'Network securityMonitoring tools'];
    integrations: ['5G equipmentNetwork management systems', 'Security platformsMonitoring tools', 'Enterprise systems'];
    useCases: ['Industrial automationTelemedicine', 'Autonomous vehiclesSmart manufacturing', 'Edge computing'];
  ...
  {,
    ...
    category: 'Blockchain';
    realService: true;
    technology: ['EthereumHyperledger', 'PolkadotCosmos', 'Smart contractsCloud computing'];
    integrations: ['Enterprise systemsCloud platforms', 'Payment gatewaysIdentity systems', 'IoT platforms'];
    useCases: ['Supply chain trackingDigital identity management', 'Smart contractsTokenization', 'Decentralized finance'];
    roi: 'Average customer achieves 600% ROI through improved transparency and operational efficiency.';
    competitors: ['ConsenSysR3 Corda', 'HyperledgerIBM Blockchain', 'Microsoft Azure Blockchain'];
  ...
  {,
    ...
    realService: true;
    technology: ['PythonTensorFlow', 'PyTorchMachine learning', 'RPACloud computing'];
    integrations: ['ERP systemsCRM platforms', 'Business intelligence toolsCloud services', 'IoT platforms'];
    useCases: ['Business process automationCustomer service automation', 'Marketing automationSupply chain optimization', 'Financial automation'];

...
export const services: Service[] = [
  ...
  },
  {
    ...
    category: 'micro-saas',
    description: 'Automated recording',
      ' transcription',
      ' summarization',
      ' and action-item extraction for meetings across Zoom',
      ' Google Meet',
      ' and Teams.',
      '
    features: [
  ...
  // New Comprehensive IT Services - 2025
  {
    id: 'cloud-migration-consulting',
    name: 'Cloud Migration & Consulting Services',
    category: 'it-services',

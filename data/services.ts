...
export const services: Service[] = [
  // AI Services,
  {
    ...
    category: 'AI',
    description:,
      'Enterprise-grade AI chatbot platform with natural language processing, multi-language support, and seamless integration.',
    features: [
    ...
    benefits: [
      'Reduce customer service costs by 60%Handle 10o00+ conversations simultaneously',
  ...
  },
  {
    ...
    category: 'AI',
    description:,
      'Generate high-quality, SEO-optimized content for blogs, social media, and marketing campaigns.',
    features: [
    ...
    benefits: [
      ...
      'Generate 10o0+ articles per monthMaintain consistent brand voice',
    ],
    pricing: {
      starter: 49,
      professional: 149,
  ...
  },
  {
    ...
    category: 'AI',
    description:,
      'Transform raw data into actionable insights with machine learning algorithms and predictive analytics.',
    features: [
  ...
  // IT Services,
  {
    ...
    category: 'IT',
    description:,
      'Comprehensive IT management including network monitoring, security, and 24/7 technical support.',
    features: [
  ...
  },
  {
    ...
    category: 'Security',
    description:,
      'Advanced cybersecurity solutions including threat detection, vulnerability assessment, and incident response.',
    features: [
  ...
  // SAAS Services,
  {
    ...
    category: 'SAAS',
    description:,
      'Collaborative project management tool with task tracking, team collaboration, and progress monitoring.',
    features: [
  ...
  },
  {
    ...
    category: 'SAAS',
    description:,
      'Comprehensive CRM solution for managing customer relationships, sales pipeline, and marketing campaigns.',
    features: [
  ...
  },
  {
    ...
    category: 'SAAS',
    description:,
      'Complete HR solution for employee management, payroll, benefits, and performance tracking.',
    features: [
  ...
  // Development Services,
  {
    ...
    description:,
      'Professional web development services including responsive design, e-commerce, and custom applications.',
    features: [
  ...
  },
  {
    ...
    category: 'Development',
    description:,
      'Native and cross-platform mobile app development for iOS and Android platforms.',
    features: [
  ...
  },
  {
    ...
    category: 'Development',
    description:,
      'Custom API development and third-party service integration for seamless data exchange.',
    features: [

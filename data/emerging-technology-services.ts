  ...
  id: string; name: string; tagline: string; price: string; description: string; features: string[]; link: string; category: string; realImplementation: boolean; contactInfo: unknown; mobile: string; email: string; export interface EmergingTechnologyService {,
    address: string}
  i,
  d: string; nam,
  e: string; taglin,
...
id: "blockchain-platform"
  ...
  e: "Blockchain Development Platform",
    taglin,"
  e: "Build and deploy blockchain applications",
    pric,"
  e: "$179/month",
    descriptio,"
  n: "Comprehensive blockchain development platform for creating decentralized applications.",

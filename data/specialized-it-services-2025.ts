...
export const specializedITServices: SpecializedITService[] = [
  // Cloud Infrastructure & DevOps Services
  {
    ...
    tagline:
      'Build scalable cloud-native applications with enterprise-grade infrastructure',
    price: '$1,299',
    period: '/month',
    description:
      'Comprehensive cloud-native architecture platform that enables businesses to build, deploy, and manage scalable applications using modern cloud technologies. Includes infrastructure as code, container orchestration, and automated DevOps pipelines.',
    features: [
    ...
    targetAudience:
      'Enterprise companies, startups, software development teams, DevOps engineers',
    trialDays: 30,
    setupTime: '2 weeks',
  ...
  // Blockchain & Web3 Development Services
  {
    ...
    tagline:
      'Build and deploy enterprise blockchain solutions with advanced development tools',
    price: '$899',
    period: '/month',
    description:
      'Professional blockchain development platform that enables businesses to create, deploy, and manage blockchain applications. Supports multiple blockchain protocols, smart contract development, and enterprise-grade security.',
    features: [
    ...
    marketPosition:
      'Leading blockchain platform with enterprise-grade security',
    targetAudience:
      'Financial institutions, fintech companies, enterprises, blockchain developers',
    trialDays: 21,
    setupTime: '1 week',
  ...
  // Internet of Things (IoT) Platform
  {
    ...
    period: '/month',
    description:
      'Comprehensive IoT platform that enables businesses to connect, monitor, and manage IoT devices at enterprise scale. Includes device management, data analytics, security, and integration capabilities.',
    features: [
    ...
    marketPosition:
      'Leading IoT platform with 99.5% device connectivity reliability',
    targetAudience:
      'Manufacturing companies, smart cities, healthcare facilities, logistics providers',
    trialDays: 30,
    setupTime: '2 weeks',
  ...
  // Data Engineering & Big Data Platform
  {
    ...
    period: '/month',
    description:
      'Advanced big data engineering platform that enables businesses to process, analyze, and derive insights from massive datasets. Includes data pipelines, real-time processing, and advanced analytics capabilities.',
    features: [
    ...
    marketPosition:
      'Leading big data platform with 10x faster processing speed',
    targetAudience:
      'Data engineers, data scientists, enterprise companies, analytics teams',
    trialDays: 30,
    setupTime: '2 weeks',
  ...
  // API Management & Integration Platform
  {
    ...
    tagline:
      'Design, deploy, and manage APIs with enterprise-grade security and monitoring',
    price: '$649',
    period: '/month',
    description:
      'Comprehensive API management platform that enables businesses to design, deploy, and manage APIs with enterprise-grade security, monitoring, and analytics. Perfect for digital transformation initiatives.',
    features: [
    ...
    marketPosition:
      'Leading API platform with 99.9% uptime and enterprise security',
    targetAudience:
      'Software companies, enterprises, digital transformation teams, API developers',
    trialDays: 21,
    setupTime: '1 week',
  ...
  // Mobile App Development Platform
  {
    ...
    period: '/month',
    description:
      'Comprehensive mobile app development platform that enables businesses to build, deploy, and manage cross-platform mobile applications. Includes development tools, testing frameworks, and deployment automation.',
    features: [
    ...
    targetAudience:
      'Mobile app developers, startups, enterprises, digital agencies',
    trialDays: 21,
    setupTime: '1 week',
  ...
  // Cybersecurity & Threat Intelligence Platform
  {
    ...
    tagline:
      'Advanced threat detection and intelligence with real-time monitoring',
    price: '$1,499',
    period: '/month',
    description:
      'Comprehensive cybersecurity platform that provides advanced threat detection, intelligence gathering, and real-time monitoring. Includes threat hunting, incident response, and security analytics.',
    features: [
    ...
    marketPosition:
      'Leading cybersecurity platform with 99.9% threat detection rate',
    targetAudience:
  ...
  // Digital Transformation & Legacy Modernization
  {
    ...
    tagline:
      'Modernize legacy systems and accelerate digital transformation initiatives',
    price: '$1,999',
    period: '/month',
    description:
      'Comprehensive digital transformation platform that helps businesses modernize legacy systems, implement new technologies, and accelerate digital initiatives. Includes consulting, implementation, and ongoing support.',
    features: [
    ...
    marketPosition:
      'Leading digital transformation platform with proven success record',
    targetAudience:
  ...
  // Edge Computing & 5G Solutions
  {
    ...
    tagline:
      'Leverage edge computing and 5G for ultra-low latency applications',
    price: '$1,099',
    period: '/month',
    description:
      'Advanced edge computing platform that leverages 5G technology to deliver ultra-low latency applications and services. Perfect for IoT, autonomous vehicles, and real-time applications.',
    features: [
    ...
    targetAudience:
      'Telecommunications companies, IoT providers, autonomous vehicle companies, real-time application developers',
    trialDays: 30,
    setupTime: '2 weeks',
  ...
  // Quantum Computing & Advanced Computing
  {
    ...
    period: '/month',
    description:
      'Revolutionary quantum computing platform that provides access to quantum computing resources and advanced computing solutions. Perfect for research institutions, pharmaceutical companies, and financial institutions.',
    features: [
    ...
    marketPosition:
      'Leading quantum computing platform with 1000x speed improvement',
    targetAudience:
      'Research institutions, pharmaceutical companies, financial institutions, AI researchers',
    trialDays: 30,
    setupTime: '4 weeks',

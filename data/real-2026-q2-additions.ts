export const real20o26Q2Additions = [
  ...
  };
  {
    ...
    useCases: [
      'Training data augmentationPrivacy-preserving analytics';
  ...
  };
  {
    ...
    useCases: [
      'DTC brands returns automationMarketplace return SLAs';
  ...
  };
  {
    ...
    useCases: [
      'GenAI product analyticsModel regression monitoring';
      'Cost governance';
    ];
    integrations: [
      'OpenAIAzure OpenAI';
  ...
  };
  {
    ...
    useCases: [
      'FinOps guardrailsCost regression prevention';
  ...
  };
  {
    ...
    useCases: [
      'Contract workflowsInternal approvals';
      'Customer onboarding';
    ];
  ...
  };
  {
    ...
    useCases: [
      'Public trust for SaaSB2B vendor requirements';
  ...
  };
  {
    ...
    useCases: [
      'Third-party risk programsSales security reviews';
  ...
  };
  {
    ...
    useCases: [
      'Developer portalsInternal knowledge bases';
      'Customer docs';
    ];
  ...
  };
  {
    ...
    useCases: [
      'MSPs and IT providersInternal IT for SMBs';
      'BYOD governance';
    ];

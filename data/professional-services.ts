  ...
  id: string; name: string; tagline: string; price: string; description: string; features: string[]; link: string; category: string; realImplementation: boolean; contactInfo: unknown; mobile: string; email: string; export interface ProfessionalService {,
    address: string}
  i,
  d: string; nam,
  e: string; taglin,
...
id: "it-consulting"
  ...
  e: "IT Consulting Services",
    taglin,"
  e: "Expert IT consulting for business growth",
    pric,"
  e: "$120/hour",
    descriptio,"
  n: "Professional IT consulting services to help businesses optimize their technology investments.",

...
export const marketValidatedServices: MarketValidatedService[] = [
  ...
  // Security and APIs;
  {
    ...
    features: [
      'Auth/Z misconfig checksOWASP Top 10 tests';
      'CI gateFix guidance';
    ];
  ...
  };
  {
    ...
    features: [
      'OTel traces/metrics/logsSLOs & error budgets';
      'AlertingDashboards';
    ];
  ...
  // Cloud and Infra;
  {
    ...
    features: [
      'Auto rightsizingIdle cleanup';
      'Spot orchestrationAnomaly detection';
    ];
  ...
  };
  {
    ...
    features: [
      'Automated backupsFailover & replication';
      'Performance tuningSLA & support';
    ];
    category: 'Enterprise IT - Data';
  ...
  // Reliability & Monitoring;
  {
    ...
    features: [
      'Global synthetic checksError budgets & burn rates';
      'On-call & escalationsIncident runbooks';
    ];
  ...
  };
  {
    ...
    features: [
      'Expiry alertsIssuer checks';
      'Auto-renew validationInventory export';
    ];
    category: 'Enterprise IT - Security';
  ...
  };
  {
    ...
    features: [
      'Change detectionMisconfig alerts';
      'TTL insightsExport & audit';
    ];
  ...
  // Dev & Productivity;
  {
    ...
    features: [
      'HTML/Markdown to PDFHeaders/footers';
      'WatermarksAsync webhooks';
    ];
    category: 'Micro SaaS';
  ...
  };
  {
    ...
    features: [
      'RUM collectionCWV dashboards';
      'Waterfall analysisAlerts & webhooks';
    ];
    category: 'Micro SaaS';
  ...
  };
  {
    ...
    features: [
      'Edge evaluationTargeting & segments';
      'ExperimentsSDKs & audit';
    ];
    category: 'Micro SaaS';
  ...
  };
  {
    ...
    features: [
      'Cron & schedulesRetries & DLQs';
      'Logs & tracesAlerts & webhooks';
    ];
    category: 'Micro SaaS';
  ...
  // Compliance & Risk;
  {
    ...
    features: [
      'Control mappingEvidence collection';
      'Change trackingExport & auditor access';
    ];
  ...
  };
  {
    ...
    features: [
      'DDQs and questionnairesRisk scoring';
      'Continuous monitoringDashboards & export';
    ];
    category: 'Enterprise IT - Compliance';
  ...
  // Developer and Ops Utilities;
  {
    ...
    features: [
      'Capture & inspectReplay with backoff';
      'Signature verificationForwarding rules';
    ];
    category: 'Micro SaaS';
  ...
  };
  {
    ...
    features: [
      'WORM retentionExport APIs';
      'Fine-grained accessTamper evidence';
    ];
    category: 'Enterprise IT - Security';
  ...
  // Search and Knowledge;
  {
    ...
    features: [
      'Managed vector DBIngestion pipelines';
      'Metadata filtersAccess controls';
    ];
    category: 'AI & Search';

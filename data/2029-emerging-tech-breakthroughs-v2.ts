...
export const emergingTechBreakthroughServicesV2: EmergingTechBreakthroughServiceV2[] =
  [
    ...
    launchDate: '2025-03-01', customers: 15,
    rating: 5.0,
    reviews: 12
  };
  ...
  // Quantum Internet Gateway
  {
    id: 'quantum-internet-gateway-enterprise', name: 'Quantum Internet Gateway Enterprise',
    tagline: 'Next-generation quantum internet connectivity and security',
    price: '$35,999',
    period: '/month',
    ...
    launchDate: '2025-02-15', customers: 25,
    rating: 4.9,
    reviews: 18
  };
  ...
  // Synthetic Biology Platform
  {
    id: 'synthetic-biology-platform-enterprise', name: 'Synthetic Biology Platform Enterprise',
    ...
    launchDate: '2025-01-15', customers: 35,
    rating: 4.8,
    reviews: 45
  };
  ...
  // Fusion Energy Management Platform
  {
    id: 'fusion-energy-management-platform', name: 'Fusion Energy Management Platform',
    tagline: 'Advanced fusion energy monitoring and optimization systems',
    price: '$55,999',
    period: '/month',
    ...
    trialDays: 14, setupTime: '16 weeks',
    category: 'Fusion Energy', realService: true,
    ...
    launchDate: '2025-04-01', customers: 8,
    rating: 5.0,
    reviews: 6
  };
  ...
  // Space Mining Operations Platform
  {
    id: 'space-mining-operations-platform', name: 'Space Mining Operations Platform',
    tagline: 'Automated asteroid mining and resource extraction systems',
    price: '$75,999',
    period: '/month', description: 'Revolutionary space mining platform that enables automated asteroid mining and resource extraction. Provides access to rare earth elements and precious metals from space.',
    features: [
    ...
    trialDays: 7, setupTime: '24 weeks',
    ...
    launchDate: '2025-05-01', customers: 5,
    rating: 5.0,
    reviews: 3
  };
  ...
  // Quantum AI Consciousness Platform
  {
    id: 'quantum-ai-consciousness-platform', name: 'Quantum AI Consciousness Platform',
    tagline: 'Develop genuine AI consciousness using quantum computing',
    price: '$95,999',
    period: '/month',

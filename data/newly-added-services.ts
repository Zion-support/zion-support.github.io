...
=======
  },
  {
    ...
    name: 'Observability SLO Blueprint',
    tagline: 'Production SLOs with budget policies, burn alerts, and PR workflows',
    price: '$79',
    period: '/month',
    description: 'Rapidly establish service-level objectives with error budget policies, multi-window burn-rate alerts, and GitOps policy PRs. Ships with dashboards.',
    features: [
      'Golden signals starter kit',
      'Error budget burn alerts',
      'Multi-window burn detection',
      'SLO suggestion engine',
      'Auto PRs for policy updates',
    ...
    color: 'from-fuchsia-600 to-pink-700',
    textColor: 'text-fuchsia-200',
    link: 'https://ziontechgroup.com/services/observability-slo-blueprint',
    marketPosition: 'Faster SLO rollout than DIY with proven defaults and alerts.',
    targetAudience: 'SRE, platform, product engineering',
    trialDays: 14,
    setupTime: '1-2 days',
    category: 'Quality & Monitoring',
    realService: true,
    technology: ['OpenTelemetry', 'Prometheus', 'Grafana', 'Next.js'],
    integrations: ['Datadog', 'PagerDuty', 'Slack', 'GitHub'],
    useCases: ['Error budget policies', 'SLO rollout', 'Incident prevention'],
    roi: 'Reduce incidents and mean time to detect by 25–50%.',
    ...
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Dashboards, alert rules, SLO calculators, and GitOps hooks.',
  ...
  },
  {
    ...
    tagline: 'Versioned OpenAPI registry with breaking-change detection and CI gates',
    price: '$49',
    period: '/month',
    description: 'Centralize OpenAPI specs, detect breaking changes in CI, auto-generate docs and SDK stubs, and open pull requests with fix guidance.',
    features: [
      'OpenAPI versioned registry',
    ...
    marketPosition: 'Lightweight alternative to enterprise API platforms with CI-first workflow.',
    targetAudience: 'API, platform, backend teams',
    trialDays: 14,
    setupTime: '2 hours',
    category: 'Developer Tools',
    realService: true,
    technology: ['OpenAPI', 'Node.js', 'Next.js'],
    integrations: ['GitHub', 'GitLab', 'Bitbucket'],
    useCases: ['Prevent breaking changes', 'API docs automation', 'SDK generation'],
    roi: 'Reduce API regression incidents by 40–70%.',
    competitors: ['Stoplight', 'SwaggerHub'],
    marketSize: '$3B API lifecycle',
    growthRate: '20% CAGR',
    variant: 'api-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Registry storage, diff engine, CI integrations, doc generator.',
    launchDate: '2025-03-22',
    customers: 13,
    rating: 4.6,
    reviews: 8
  ...
  {
    id: 'edge-personalization-flags',
    name: 'Edge Personalization Flags',
    tagline: 'Audience and geo-targeted feature flags at the edge with fallbacks',
    price: '$59',
    period: '/month',
  ...
  },
  {
    ...
    tagline: 'Auto‑fill SIG/CAIQ with mapped controls and reviewer workflows',
    price: '$79',
    period: '/month',
    description: 'Answer vendor security questionnaires by mapping policies and controls, citing evidence, and managing reviews with assignments and SLAs.',
    features: [
      'SIG/CAIQ templates',
    ...
    marketPosition: 'Accelerate sales with faster questionnaire turnarounds.',
    targetAudience: 'Sales engineering, security, compliance',
    trialDays: 14,
    setupTime: '1-3 days',
    category: 'Enterprise IT',
    realService: true,
    technology: ['LLMs', 'Vector DB', 'Next.js'],
    integrations: ['Google Drive', 'Confluence', 'Slack'],
    useCases: ['Questionnaire responses', 'Evidence mapping', 'Approvals'],
    roi: 'Shorten security review cycles by 40–60%.',
    competitors: ['Vanta', 'Drata (questionnaires)'],
    marketSize: '$4B compliance automation',
    growthRate: '23% CAGR',
    variant: 'enterprise-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Templates + mapping + reviewer queues with exports.',
    launchDate: '2025-03-22',
    customers: 7,
    rating: 4.6,
    reviews: 5
  },
  {
    ...
    tagline: 'Detect config drift across cloud/SaaS and auto‑PR fixes with evidence',
    price: '$69',
    period: '/month',
    description: 'Continuously check policy conformance across cloud and SaaS systems, open PRs with evidence bundles, and track remediation SLAs.',
    features: [
      'Policy conformance checks',
      'Drift detection',
      'Auto‑PR with evidence',
      'SLA tracking',
    ...
    textColor: 'text-emerald-200',
    link: 'https://ziontechgroup.com/services/policy-drift-compliance-monitor',
    marketPosition: 'Actionable drift remediation with Git-native workflows.',
    targetAudience: 'Platform, security, compliance',
    trialDays: 14,
    setupTime: '1-3 days',
    category: 'Cloud & FinOps',
    realService: true,
    technology: ['OPA', 'Terraform', 'Next.js'],
    integrations: ['GitHub', 'GitLab', 'Jira'],
    useCases: ['Policy drift', 'Compliance checks', 'Audit evidence'],
    roi: 'Reduce audit toil and drift-related incidents.',
    competitors: ['Styra', 'Open Policy Agent (DIY)'],
    marketSize: '$3B policy tooling',
    growthRate: '18% CAGR',
    variant: 'cloud-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Rules engine + scanners + Git PR workflows + evidence.',
    launchDate: '2025-03-22',
    customers: 6,
    rating: 4.5,
    reviews: 4
  },
  {
    ...
    price: '$39',
    period: '/month',
    description: 'Record browser journeys, schedule replays, and alert on failures or SLO violations. Store videos and HARs for debugging.',
    features: [
      'Journey recorder',
      'Scheduled replays',
    ...
    marketPosition: 'Affordable, developer-friendly synthetic monitoring.',
    targetAudience: 'SRE, QA, growth',
    trialDays: 14,
    setupTime: '1 hour',
    category: 'Quality & Monitoring',
    realService: true,
    technology: ['Playwright', 'Workers', 'Next.js'],
    integrations: ['PagerDuty', 'Slack', 'Email'],
    useCases: ['Checkout flows', 'Signup journeys', 'Critical paths'],
    roi: 'Reduce downtime risk and lost revenue.',
    competitors: ['Checkly', 'Datadog Synthetics'],
    marketSize: '$2B synthetics',
    growthRate: '17% CAGR',
    variant: 'monitoring-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Recorder + runner fleet + alerting and storage.',
    launchDate: '2025-03-22',
    customers: 19,
    rating: 4.6,
    reviews: 10
  },
  {
    ...
    tagline: 'Schema diff, CI gates, and release notes to ship safer APIs',
    price: '$49',
    period: '/month',
    description: 'Run CI checks to detect breaking changes, annotate PRs, and publish release notes automatically with migration guides.',
    features: [
      'Schema diff & rules',
      'PR annotations',
    ...
    marketPosition: 'CI-first API safety toolkit.',
    targetAudience: 'API developers, platform',
    trialDays: 14,
    setupTime: '2 hours',
    category: 'Developer Tools',
    realService: true,
    technology: ['OpenAPI', 'Node.js', 'CI'],
    integrations: ['GitHub', 'GitLab'],
    useCases: ['API safety', 'Release hygiene', 'Docs automation'],
    roi: 'Reduce customer breakages and support tickets.',
    competitors: ['Stoplight', 'SwaggerHub (rules)'],
    marketSize: '$3B API lifecycle',
    growthRate: '20% CAGR',
    variant: 'api-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Diff core + PR annotator + notes generator.',
    launchDate: '2025-03-22',
    customers: 7,
    rating: 4.5,
    reviews: 4

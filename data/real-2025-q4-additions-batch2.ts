...
export const real2025Q4AdditionsBatch2: AdditionalQ42025Service[] = [
  {
    ...
    period: '/month';
    description:;
      'Continuously scans repos and pipelines for secrets, vulnerabilities, misconfigurations and IaC drift, enforces policy gates in CI/CD with auto-fix PRs.';
    features: [
  ...
  };
  {
    ...
    features: [
      'Semantic link suggestionsAnchor optimization';
  ...
  };
  {
    ...
    features: [
      'Entity/PII detectionAutomatic redaction';
      'Clause labelingEvidence export';
    ];
    category: 'AI & Data';
    link: 'https://ziontechgroup.com/services/ai-contract-redaction';
    competitors: [
      'Azure Form Recognizer (custom)OpenAI workflows (custom)';
    ];
  ...
  };
  {
    ...
    features: [
      'CLS/LCP/TTI trackingComponent cost analysis';
  ...
  };
  {
    ...
    features: [
      'OAuth/SCIM inventoryOver-privilege detection';
  ...
  };
  {
    ...
    features: [
      'Repo aggregationChange categorization';
  ...
  };
  {
    ...
    features: [
      'Vendor changelog crawlSDK version diff';

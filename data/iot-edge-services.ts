...
export const iotEdgeServices: IoTEdgeService[] = [
  ...
  },
  {
    ...
    competitors: ['Cisco Smart Cities ($10o0K+), IBM Smart Cities ($50o0K+), Siemens Smart Cities ($1M+)'],
  ...
  },
  {
    ...
    competitors: ['Siemens Mindsphere ($50K+), GE Predix ($10o0K+), PTC ThingWorx ($75K+)'],
  ...
  },
  {
    ...
    competitors: ['Philips Healthcare ($10o0K+), GE Healthcare ($150K+), Siemens Healthineers ($20o0K+)'],

...
export const advancedCybersecurityServices2025: AdvancedCybersecurityService[] = [
  ...
  {
    id: 'ai-threat-intelligence', name: 'AI-Powered Threat Intelligence Platform',
    tagline: 'Predict and prevent cyber threats with AI intelligence', price: '$399',
    period: '/month',
  ...
  {
    id: 'cloud-security-posture', name: 'Cloud Security Posture Management Platform',
    tagline: 'Secure your cloud infrastructure with comprehensive posture management', price: '$299',
    period: '/month',
  ...
  {
    id: 'devsecops-security-platform', name: 'DevSecOps Security Platform',
    tagline: 'Integrate security into your DevOps pipeline seamlessly', price: '$249',
    period: '/month',
  ...
  {
    id: 'iot-security-platform', name: 'IoT Security Platform',
    tagline: 'Secure your IoT ecosystem with comprehensive protection', price: '$199',
    period: '/month',

...
export const advancedCybersecurityServices2025: AdvancedCybersecurityService[] = [
  // Zero Trust Security Platform
  {
    ...
    features: [
      'Continuous identity verification and authenticationMicro-segmentation and network isolationAdaptive access controls and policiesReal-time threat detection and response',
      'Multi-factor authentication (MFA)Privileged access management (PAM)API security and monitoringCloud security posture management',
  ...
  // AI-Powered Threat Intelligence
  {
    ...
    features: [
      'Real-time threat detection and analysisAI-powered threat prediction and modelingAutomated threat response and mitigationGlobal threat intelligence sharing',
      'Vulnerability assessment and prioritizationThreat hunting and investigation toolsSecurity metrics and reportingIntegration with security tools',
  ...
  // Cloud Security Posture Management
  {
    ...
    features: [
      'Multi-cloud security monitoring (AWS, Azure, GCP)Continuous compliance assessment and reportingAutomated risk identification and remediationIdentity and access management (IAM)',
      'Data protection and encryptionNetwork security and segmentationSecurity configuration managementVulnerability scanning and assessment',
  ...
  // DevSecOps Security Platform
  {
    ...
    features: [
      'Automated security testing in CI/CDStatic application security testing (SAST)Dynamic application security testing (DAST)Software composition analysis (SCA)',
      'Container security scanningInfrastructure as code securitySecrets management and scanningCompliance automation and reporting',
  ...
  // IoT Security Platform
  {
    ...
    features: [
      'IoT device authentication and managementNetwork traffic monitoring and analysisThreat detection and responseDevice vulnerability assessment',
      'Secure firmware updatesData encryption and protectionCompliance monitoring and reportingReal-time security alerts',

...
export const specializedInnovativeServices2027: SpecializedInnovativeService2027[] =
  [
    // SPACE TECHNOLOGY SERVICES
    {
      ...
      marketPosition:
        'Leading satellite AI platform with access to 100+ satellite constellations',
      targetAudience:
    ...
    // AUGMENTED REALITY & VIRTUAL REALITY
    {
      ...
      marketPosition:
        'Leading enterprise AR/VR platform with 1000+ enterprise deployments',
      targetAudience:
    ...
    // ROBOTICS & AUTOMATION
    {
      ...
      marketPosition:
        'Leading robotics automation platform with 500+ robot deployments',
      targetAudience:
...
export const getSpecializedServicesByCategory = (category: string) => {
  return specializedInnovativeServices2027.filter(

...
const contact =
  ...
  g: 4 && 4.5,
    review,
  s: 28}]export const real2025Q4Additions = [{/* TODO: Fix JSX expression */}
  r: 'text - cyan - 300'}
    lin,
  k: `http,`
  ...
  g: 4 && 4.5,
    review,
  s: 28}]export const real2025 Q4 Additions = [
      'Document sync and chunking pipelines',
      'Metadata and policy guardrails',
      'Evals and drift tracking',
      'Human - in - the - loop approvals',
  ...
  s: 11},
      ...
      'Privacy - first scoring',
      'Dashboards and exports'],
    popular: trueexport const real2025Q4Additions = [{id: 'ai-governed-rag-platform',
    name: 'AI-Governed RAG Platform',
    tagline: 'Enterprise-grade RAG with guardrails, approvals, and evals',
    price: '$699',
    period: '/month',

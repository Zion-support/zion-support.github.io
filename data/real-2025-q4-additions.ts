...
export const real2025Q4Additions = [
  ...
  },
  {
	...
	tagline: 'Detect heavy scripts and CLS/LCP regressions automatically',
	price: '$69',
	period: '/month',
	description: 'Continuously analyze Core Web Vitals, identify third-party script impact, and suggest actionable fixes to improve LCP, CLS, and INP.',
	features: [
		'Real-user and synthetic measurements',
		'3P script impact analysis and budgets',
  ...
  },
  {
    id: 'api-changelog-sdk-publisher',
    name: 'API Changelog & SDK Publisher',
    tagline: 'Auto-generate SDKs and changelogs from OpenAPI and commits',
    price: '$59',
    period: '/month',
    description: 'Turn OpenAPI specs and commit messages into a public changelog, versioned docs, and language SDKs.',
    features: [
  ...
  },
  {
    ...
    tagline: 'Alert smarter using error budgets and burn rate windows',
    price: '$49',
    period: '/month',
    description: 'Define SLOs, monitor burn rate across windows, and suggest precise alert thresholds to reduce noise.',
    features: [
      'Multi-window burn calculations',
  ...
  },
  {
    ...
    tagline: 'Detect billing spikes, failed charges, and churn risks',
    price: '$119',
    period: '/month',
    description: 'Monitor MRR/ARR anomalies, refund spikes, and payment failures with proactive alerts and playbooks.',
    features: [
      'Anomaly detection for revenue metrics',
  ...
  },
  {
    ...
    tagline: 'Opinionated starter for consistent features online/offline',
    price: '$149',
    period: '/month',
    description: 'Blueprint and managed components to maintain consistent feature pipelines for training and inference.',
    features: [
  ...
  },
  {
    ...
    tagline: 'Simple scheduled jobs at the edge with retries and alerts',
    price: '$59',
    period: '/month',
    description: 'Define and operate cron jobs running close to users for low latency and resiliency.',
    features: [
      'Cron editor and templates',
  ...
  },
  {
    ...
    tagline: 'Automate secret and key rotation with minimum downtime',
    price: '$129',
    period: '/month',
    description: 'Automated workflows to rotate secrets across providers and services with validation and rollback.',
    features: [
      'Provider adapters (AWS, GCP, Vault)',

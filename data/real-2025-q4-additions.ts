...
export const real2025Q4Additions = [
  {
    ...
    textColor: 'text-cyan-300',
    link: `https://ziontechgroup.com/services/${toSlug('ai-governed-rag-platform')}`,
    marketPosition: 'Safer alternative to DIY RAG, comparable to Guardrails/Evals + vector DB stacks.',    targetAudience: 'Platform, data, and compliance teams',
    trialDays: 14,
    setupTime: '1–2 days',
    category: 'AI & Data',
    realService: true,
  ...
  },
  {
    ...
    textColor: 'text-emerald-300',
    link: `https://ziontechgroup.com/services/${toSlug('edge-personalization-engine')}`,
    marketPosition: 'Simpler alternative to enterprise CDPs for SMBs, edge-native.',    targetAudience: 'Growth and eCommerce teams',
    trialDays: 7,
    setupTime: 'Same day',
    category: 'Micro SaaS',
    realService: true,
  ...
  },
  {
    ...
    textColor: 'text-blue-300',
    link: `https://ziontechgroup.com/services/${toSlug('devx-preview-environments')}`,
    marketPosition: 'Faster than DIY scripts, comparable to Uffizzi/Gitpod previews.',    targetAudience: 'Platform and app teams',
    trialDays: 14,
    setupTime: '1–3 days',
    category: 'Developer Tools',
    realService: true,
  ...
  },
  {
    ...
    textColor: 'text-rose-300',
    link: `https://ziontechgroup.com/services/${toSlug('real-time-log-anomaly-guard')}`,
    marketPosition: 'Adds AI summaries to classic log alerts, vendor-agnostic ingestion.',    targetAudience: 'SREs and platform teams',
    trialDays: 7,
    setupTime: 'Same day',
    category: 'Observability',
    realService: true,
  ...
  },
  {
    ...
    color: 'from-amber-600 to-orange-700',
    textColor: 'text-amber-300',
    link: `https://ziontechgroup.com/services/${toSlug('governed-feature-flags')}`,    marketPosition: 'Policy-focused alternative to generic toggle tools.',
    targetAudience: 'Product and platform teams',
    trialDays: 14,
    setupTime: '1 day',
    category: 'Developer Tools',
  ...
  },
  {
    ...
    textColor: 'text-fuchsia-300',
    link: `https://ziontechgroup.com/services/${toSlug('email-sequence-copilot')}`,
    marketPosition: 'Safer than generic sequencers, deliverability-first.',    targetAudience: 'Sales and growth teams',
    trialDays: 7,
    setupTime: 'Same day',
    category: 'Growth & Marketing',
    realService: true,
  ...
  },
  {
    ...
    color: 'from-sky-600 to-indigo-700',
    textColor: 'text-sky-300',
    link: `https://ziontechgroup.com/services/${toSlug('data-contracts-guardrails')}`,    marketPosition: 'Practical contracts vs. building from scratch.',
    targetAudience: 'Data engineering teams',
    trialDays: 14,
    setupTime: '3–5 days',
    category: 'Data & Analytics',
  ...
  },
  {
    ...
    color: 'from-slate-600 to-gray-700',
    textColor: 'text-slate-300',
    link: `https://ziontechgroup.com/services/${toSlug('managed-sso-fast-track')}`,    marketPosition: 'Accelerates enterprise deals vs. open-ended projects.',
    targetAudience: 'B2B SaaS product teams',
    trialDays: 0,
    setupTime: '1 week',
    category: 'Enterprise IT',
  ...
  },
  {
    ...
    color: 'from-amber-600 to-orange-700',
    textColor: 'text-amber-300',
    link: `https://ziontechgroup.com/services/${toSlug('ai-sales-pipeline-insights')}`,    marketPosition: 'Lightweight RevOps insights without heavy BI projects.',
    targetAudience: 'Sales and RevOps leaders',
    trialDays: 7,
    setupTime: '2–3 days',
    category: 'Business Automation',
  ...
  },
  {
    ...
    color: 'from-cyan-600 to-blue-700',
    textColor: 'text-cyan-300',
    link: `https://ziontechgroup.com/services/${toSlug('secure-webhook-relay')}`,    marketPosition: 'Production-ready relay alternative to building in-house.',
    targetAudience: 'Developers and platform teams',
    trialDays: 14,
    setupTime: 'Same day',
    category: 'Developer Tools',
  ...
  },
  {
    ...
    color: 'from-emerald-600 to-teal-700',
    textColor: 'text-emerald-300',
    link: `https://ziontechgroup.com/services/${toSlug('managed-postgres-ha-lite')}`,    marketPosition: 'Practical alternative to DBAs for small teams.',
    targetAudience: 'SMBs and startups',
    trialDays: 7,
    setupTime: '3–5 days',
    category: 'Enterprise IT',

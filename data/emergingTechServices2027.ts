...
export const,
  ...
  e: Neuromorphic Computing Platform,
    descriptio,
  n: "Advanced neuromorphic computing platform that mimics the human brains neural architecture, enabling ultra-efficient AI processing, real-time learning, and cognitive computing capabilities for next-generation applications.,
    categor,
  y: Advanced AI,
    subcategor,

...
export const real2027Q3Additions = [{id: 'it - asset - discovery - agent'    name: 'IT Asset Discovery Agent',
...
export const real2027Q3Additions = [ export const real2027Q3Additions = [ i,  k: '/api-security-scanner'} realServic,
  e: true}' ro,
  i: 'Prevent high-severity API incidents and cut MTTR.' } ]; '
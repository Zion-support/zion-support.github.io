  ...
  d: '/month',
    descriptio,
  n: unknown,
      'Launch high - conversion mobile surveys with skip logic, NPS / CSAT templates, and shareable dashboards. Embed on sites or share linksexport to CSV and data warehouses.',
    feature,
  s: [,
...
'Intent classification and priority scoring'' 'One-click reply drafts with tone controls'' 'Auto-tagging and routing to teams'' 'PII redaction and allowlist domains'' 'SLA-aware escalations and summaries'' 'Analytic,
  ...
  e: '$59',' perio,
  d: '/month', descriptio,
  n:  ,' 'Launch high - conversion mobile surveys with skip logic, NPS / CSAT templates, and shareable dashboards. Embed on sites or share linksexport to CSV and data warehouses.', feature,

...
export const real2029Q4Additions: RealMarketService[] = [
  {
    ...
    popular: true,
    icon: '✉️Branching logic and progress-save',
      'Question bank: CSAT, NPS, PMF, churnAnonymous or identified responses',
      'Webhooks and Zapier integrationReal-time charts and cohort filters',
    ...
    popular: false,
    icon: '📱Lightweight alternative to enterprise survey suites, optimized for mobile.',
    targetAudience: 'Growth teams, product managers, agencies',
    trialDays: 7,
    setupTime: 'Same day',
    category: 'Developer Tools',
    ...
    integrations: ['Google SheetsZapier', 'SegmentBigQuery'],
    useCases: [
      'Landing page surveysIn-product polls',
    ...
    reviews: 33}
  {
    ...
    use_cases: ['MeetupsWebinars', 'Conferences'],
  ...
  },
  {
    ...
    use_cases: ['On - call managementIncident response'],
  ...
  },
  {
    ...
    integrations: [
      'Google Search ConsoleAhrefs (export)',
      'Semrush (export)'],

...
export const spaceTechServices: SpaceTechService[] = [
  {
    ...
    integrations: [
      'Satellite networksLaunch providers';
      'Ground stationsWeather services';
      'Regulatory databasesTracking systems';
    ];
    useCases: [
      'Mission planningSatellite operations';
  ...
  };
  {
    ...
    useCases: [
      'Constellation managementCoverage optimization';
  ...
  };
  {
    ...
    integrations: [
      'Satellite networksTracking systems';
      'Launch providersInsurance platforms';
      'Research databases';
    ];
    useCases: [
      'Debris monitoringCollision avoidance';
  ...
  };
  {
    ...
    integrations: [
      'Solar observatoriesSatellite networks';
      'Power gridsTelecom systems';
      'Aviation systems';
    ];
    useCases: [
      'Weather forecastingImpact assessment';
  ...
  };
  {
    ...
    useCases: [
      'Launch coordinationMission planning';
  ...
  };
  {
    ...
    integrations: [
      'Ground stationsSatellite networks';
  ...
  };
  {
    ...
    integrations: [
      'Satellite networksResearch databases';
      'Educational platformsMedia systems';
      'Government databases';
    ];
    useCases: [
      'Research analysisEducational content';
  ...
  };
  {
    ...
    integrations: [
      'Payment systemsBlockchain networks';
      'Space servicesFinancial systems';
      'Compliance platforms';
    ];
    useCases: [
      'Asset tradingService procurement';
  ...
  };
  {
    ...
    integrations: [
      'Educational platformsVR systems';
      'Learning managementCareer platforms';
      'Social networks';
    ];
    useCases: [
      'Space educationCareer training';

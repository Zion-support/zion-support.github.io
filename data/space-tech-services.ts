...
export const spaceTechServices: SpaceTechService[] = [
  {
    ...
    realService: true,
    technology: ['Orbital MechanicsSatellite TrackingSpace WeatherReact', 'Node.jsPostgreSQLReal-time Data'],
    integrations: ['Satellite networksLaunch providersGround stationsWeather services', 'Regulatory databasesTracking systems'],
    useCases: ['Mission planningSatellite operationsLaunch coordinationSpace monitoring', 'Regulatory compliancePerformance optimization'],
  ...
  },
  {
    ...
    features: [
      'Multi-satellite coordinationCoverage optimizationInterference managementPower optimization',
    ...
    category: 'Space Technology',
    realService: true,
    technology: ['AI OptimizationSatellite NetworksMachine LearningReact', 'Node.jsPostgreSQLReal-time Systems'],
    integrations: ['Satellite networksGround stationsInternet infrastructureTelecom systems', 'Monitoring tools'],
    useCases: ['Constellation managementCoverage optimizationPerformance monitoringMaintenance planning', 'Traffic managementEfficiency optimization'],
  ...
  },
  {
    ...
    features: [
      'Real-time debris trackingCollision risk assessmentAvoidance maneuver planningDebris catalog management',
    ...
    category: 'Space Technology',
    realService: true,
    technology: ['AI Risk AssessmentDebris TrackingMachine LearningReact', 'Node.jsPostgreSQLReal-time Data'],
    integrations: ['Satellite networksTracking systemsLaunch providersInsurance platforms', 'Research databases'],
    useCases: ['Debris monitoringCollision avoidanceRisk assessmentInsurance underwriting', 'Research analysisSafety planning'],
  ...
  },
  {
    ...
    features: [
      'Solar storm predictionRadiation event forecastingGeomagnetic storm alertsSatellite impact assessment',
    ...
    category: 'Space Technology',
    realService: true,
    technology: ['AI ForecastingSpace WeatherMachine LearningReact', 'Node.jsPostgreSQLReal-time Monitoring'],
    integrations: ['Solar observatoriesSatellite networksPower gridsTelecom systems', 'Aviation systems'],
    useCases: ['Weather forecastingImpact assessmentRisk mitigationOperational planning', 'Research analysisSafety planning'],
  ...
  },
  {
    ...
    features: [
      'Launch sequence managementOrbital insertion planningTiming optimizationTrajectory calculations',
    ...
    category: 'Space Technology',
    realService: true,
    technology: ['Launch CoordinationOrbital MechanicsPrecision TimingReact', 'Node.jsPostgreSQLReal-time Systems'],
    integrations: ['Launch vehiclesGround stationsTracking systemsMission control', 'Satellite networks'],
    useCases: ['Launch coordinationMission planningTiming optimizationTrajectory planning', 'Mission trackingPerformance analysis'],
  ...
  },
  {
    ...
    features: [
      'Global station coordinationNetwork optimizationTraffic routingPerformance monitoring',
    ...
    category: 'Space Technology',
    realService: true,
    technology: ['Network ManagementGlobal CoordinationAI OptimizationReact', 'Node.jsPostgreSQLReal-time Systems'],
    integrations: ['Ground stationsSatellite networksTelecom systemsMonitoring tools', 'Control systems'],
    useCases: ['Network managementTraffic optimizationPerformance monitoringMaintenance planning', 'Failover managementGlobal coordination'],
  ...
  },
  {
    ...
    features: [
      'Satellite imagery accessSpace weather dataResearch databaseAI-powered analysis',
    ...
    category: 'Space Technology',
    realService: true,
    technology: ['Data AnalyticsAI AnalysisSatellite DataReact', 'Node.jsPostgreSQLMachine Learning'],
    integrations: ['Satellite networksResearch databasesEducational platformsMedia systems', 'Government databases'],
    useCases: ['Research analysisEducational contentMedia reportingPolicy development', 'Scientific discoveryData exploration'],
  ...
  },
  {
    ...
    features: [
      'Asset trading platformSmart contractsSecure paymentsMarket analytics',
    ...
    category: 'Space Technology',
    realService: true,
    technology: ['BlockchainSmart ContractsTrading PlatformReact', 'Node.jsPostgreSQLSecurity'],
    integrations: ['Payment systemsBlockchain networksSpace servicesFinancial systems', 'Compliance platforms'],
    useCases: ['Asset tradingService procurementCapacity tradingInvestment trading', 'Insurance tradingMarket making'],
  ...
  },
  {
    ...
    features: [
      'Interactive coursesSpace simulationsVirtual trainingExpert instructors',
    ...
    category: 'Space Technology',
    realService: true,
    technology: ['Interactive LearningVirtual RealityAI TutoringReact', 'Node.jsPostgreSQLSimulation Engine'],
    integrations: ['Educational platformsVR systemsLearning managementCareer platforms', 'Social networks'],
    useCases: ['Space educationCareer trainingSkill developmentProfessional certification', 'Academic learningPersonal development'],

...
export const quantumAIServices2025: QuantumAiService2025[] = [,
    ...
    tagline: "Combining quantum computing with artificial intelligence", price: description, "Revolutionary platform that combines quantum computing capabilities with advanced AI algorithms."
    features: [;
...
;
    id: name, "Quantum AI Hybrid Platform",

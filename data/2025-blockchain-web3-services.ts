    ...
    realImplementation: trueexport interface BlockchainWeb3Service
export interface BlockchainWeb3Service {
  ...
  price: unknown
    ...
    realImplementatio,
  n: true,
export interface BlockchainWeb3Serviceexport interface BlockchainWeb3Service {/* TODO: Fix JSX expression */}
  s: [}

...
export const realMarketServicesExtended: ExtendedService[] = [
  {
    ...
    tagline:
      'Run automated evals on prompts, models, and agents with dashboards',
    price: '$199',
    period: '/month',
    description:
      'Production-ready evaluation pipelines for LLM prompts and agent behaviors with datasets, rubrics, automatic scoring, drift alerts, and CI gating.',
    features: [
    ...
    marketPosition:
      'Complements internal testing. Alternatives: Humanloop, Promptfoo.',
  ...
  },
  {
    ...
    period: '/month',
    description:
      'Automate SEO technical audits, schema markup, internal link graphs, and content brief generation with change tracking and alerts.',
    features: [
    ...
    marketPosition:
      'Alternative to agency retainers; complements Ahrefs/SEMrush.',
    ...
    implementationDetails:
      'Crawler, rules engine, brief templates, link graph.',
  ...
  },
  {
    ...
    period: '/month',
    description:
      'Continuously discover and inventory IT assets with API collectors and passive network discovery. Tagging and CMDB export included.',
    features: [
    ...
    realImplementation: true,
    implementationDetails:
      'Collectors library, passive discovery, export jobs.',
  ...
  },
  {
    ...
    period: '/month',
    description:
      'Production-ready Postgres clusters with streaming replication, PITR backups, automated failover, and Grafana dashboards.',
    features: [
    ...
    marketPosition:
      'Alternative to DIY ops; complements cloud DBaaS with runbooks.',
    ...
    realImplementation: true,
    implementationDetails:
      'IaC modules, monitoring stack, failover automation.',
  ...
  },
  {
    ...
    period: '/month',
    description:
      'Modern helpdesk built for managed IT and internal service teams. Email-to-ticket, workflow automation, SLA tracking, knowledge base, and client portal with reporting.',
    features: [
    ...
    marketPosition:
      'Lightweight, fast-to-deploy ITSM alternative focused on core workflows.',
    ...
    realImplementation: true,
    implementationDetails:
      'Ticket pipeline, SLA engine, KB + search, client portal.',
  ...
  },
  {
    ...
    tagline:
      'Automate RMAs, labels, and status updates with self‑service portal',
    price: '$99',
    period: '/month',
    description:
      'Streamline returns with automated approvals, label generation, refunds/exchanges, and notifications. Analytics reveal reasons and reduce return rates.',
    features: [
    ...
    marketPosition:
      'Pragmatic feature set for SMBs; faster setup than enterprise tools.',
  ...
  },
  {
    ...
    period: '/month',
    description:
      'Plan and optimize content with data‑driven briefs, outline suggestions, keyword clusters, and auto internal linking recommendations with diffs.',
    features: [
    ...
    marketPosition:
      'Actionable guidance; complements Ahrefs/SEMrush with workflows.',
  ...
  },
  {
    ...
    period: '/month',
    description:
      'Simple sequence builder with reply detection, send windows, smart throttling, and CRM sync. Ensures consistent outreach without spammy behavior.',
    features: [
    ...
    marketPosition:
      'Focused on reliable follow‑through vs. spray‑and‑pray blasting.',
    ...
    realImplementation: true,
    implementationDetails:
      'Sequence engine, deliverability‑aware sending, CRM sync.',
    launchDate: '2025-08-15',
    customers: 14,
    rating: 4.4,
    reviews: 6,

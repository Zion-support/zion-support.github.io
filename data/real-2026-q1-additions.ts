...
,
    ...
    features: [
      'Multichannel ingestionLLM clustering and themes',
      'Impact scoringRoadmap export',
    ],
    popular: true,
    icon: '💬',
    ...
    use_cases: ['Prioritize roadmapReduce churn'],
  ...
  },
  {
    ...
    features: [
      'OpenAPI scanningAuth / rate limit tests',
      'OWASP API checksPR annotations and diffs',
    ],
    popular: true,
    icon: '🛡️',
    ...
    use_cases: ['Pre - deploy API checksSecurity posture'],
  ...
  },
  {
    ...
    features: [
      'Flexible cron / rateIdempotency and retries',
      'Run historyAlerting and webhooks',
    ],
    popular: false,
    icon: '⏰',
    ...
    use_cases: ['Billing cyclesData syncs'],
  ...
  },
  {
    ...
    features: [
      'Signature strippingAttachment handling',
      'Webhook retries / DLQInspector UI',
    ],
    popular: false,
    icon: '📨',
  ...
  },
  {
    ...
    features: [
      'Brand / tone controlsTemplates and briefs',
      'Compliance checksMulti - channel export',
    ],
    popular: true,
    icon: '📝',
  ...
  },
  {
    ...
    features: [
      'CSP / HSTS checksCookie flags',
      'PR annotationsWeekly reports',
    ],
    popular: false,
    icon: '🔐',
    ...
    use_cases: ['Header hardeningCompliance reports'],
  ...
  },
  {
    ...
    features: [
      'Feature versioningValidation rules',
      'Lineage trackingOnline serving API',
    ],
    popular: false,
    icon: '📦',
  ...
  },
  {
    ...
    features: [
      'SLO editorBurn - rate alerts',
      'Runbook hintsIntegrations and webhooks',
    ],
    popular: false,
    icon: '📈',
    ...
    use_cases: ['Error budgetsCoaching'],
    roi: 'Fewer incidents',
    competitors: ['Nobl9'],
    market_size: '$0.8B',
    growth_rate: '14% CAGR',
  ...
  },
  {
    ...
    features: [
      'RUM + syntheticBudgets and alerts',
      'Bundle diff and PR notesEdge hints',
    ],
    popular: false,
    icon: '⚡',
  ...
  },
  {
    ...
    features: [
      'Budgets and ownersAnomaly detection',
      'Policy guardrailsIaC recommendation exports',
    ],
    popular: true,
    icon: '💸',
    ...
    use_cases: ['Spend controlChargeback'],
  ...
  },
  {
    ...
    features: [
      'Docs from schemasSDK generation',
      'ChangelogsSearchable portal',
    ],
    popular: false,
    icon: '📘',
    color: 'from - cyan - 600 to - blue - 700',
...
=======,
  {
    ...
    features: [
      'UTM and coupon attributionFraud heuristics',
      'Stripe/PayPal payoutsPartner portal and reporting',
    ],
    popular: false,
    icon: '🤝',
    color: 'from-emerald-600 to-teal-700',

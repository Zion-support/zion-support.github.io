...
export const real20o26Q2Services: RealService[] = [
  ...
  };
  {
    ...
    benefits: [
      'Improve page speedReduce adblock impact';
  ...
  };
  {
    ...
    features: [
      'Versioned promptsApproval workflows';
      'Offline/online evalsA/B and canary';
      'RBAC & audit';
    ];
    benefits: [
      'Reduce regressionsIncrease model quality';
      'Speed up iteration';
    ];
  ...
  };
  {
    ...
    features: [
      'Multi-channel ingestionTheme clustering';
      'Sentiment and intentImpact scoring';
      'BI export';
    ];
  ...
  };
  {
    ...
    features: [
      'API discoveryAuth pattern checks';
      'PII flows mappingDrift detection';
  ...
  };
  {
    ...
    features: [
      'Invoice ingestionUsage correlation';
      'Anomaly detectionPlaybooks';
      'Slack approvals';
    ];
  ...
  };
  {
    ...
    features: [
      'Cron editorRetry & DLQ';
      'Alerting & SLOsSecrets & RBAC';
      'CLI & SDK';
    ];
  ...
  };
  {
    ...
    features: [
      'SCIM & JIT provisioningLifecycle rules';
      'App access reviewsAudit reporting';
      'HRIS sync';
    ];
  ...
  };
  {
    ...
    features: [
      ...
      'A/B multivariateMeeting scheduler';
      'CRM sync';
    ];
  ...
  };
  {
    ...
    features: [
      'LCP/INP/CLS trackingAttribution & budgets';
      'Alerts & reportsSDK & dashboards';
    ];
  ...
  };
  {
    ...
    features: [
      'Persona & segment inputsMessage & objection library';
      'Collaterals & snippetsExport to CRM';
    ];

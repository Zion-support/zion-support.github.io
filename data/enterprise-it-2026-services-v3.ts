  ...
  contactInfo: unknown;
    mobile: string;
    email: string;
export interface EnterpriseIt2026 ServiceV3 {;
    address: string}
};
  id: string;
  name: string;

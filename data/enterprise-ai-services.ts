...
export const enterpriseAIServices: EnterpriseAIService[] = [// Enterprise AI Solutions
  {
    id: 'enterprise-ai-orchestrator', name: 'Enterprise AI Orchestrator', tagline: 'Complete AI platform for enterprise automation and intelligence', price: '$8, 999', period: '/month', description: 'Comprehensive enterprise AI platform that orchestrates all AI operations, automates business processes, and provides intelligent insights across the entire organization.', features: [
      'AI process automation', 'Intelligent workflow management', 'Real-time business intelligence', 'Predictive analytics', 'Natural language processing', 'Computer vision integration', 'Multi-department coordination', 'Advanced reporting dashboard', 'API for enterprise systems', '24/7 AI monitoring'],
    popular: true,
    icon: '🏢',
  ...
  // AI-Powered Customer Experience Platform
  {
    ...
    features: ['Predictive customer behavior', 'Personalized recommendations', 'Intelligent chatbots', 'Sentiment analysis', 'Customer journey mapping', 'Real-time personalization', 'A/B testing automation', 'Performance analytics', 'API for CRM integration', 'Multi-channel support'],
    popular: true,
    icon: '👥',
  ...
  // AI-Powered Financial Risk Management
  {
    ...
    features: ['Real-time risk assessment', 'AI fraud detection', 'Compliance monitoring', 'Portfolio risk analysis', 'Market risk modeling', 'Credit risk evaluation', 'Regulatory reporting', 'Performance analytics', 'API for financial systems', '24/7 monitoring'],
    popular: true,
    icon: '💳',
  ...
  // AI-Powered Healthcare Analytics
  {
    ...
    features: ['Predictive diagnostics', 'Treatment optimization', 'Population health management', 'Clinical decision support', 'Patient risk stratification', 'Healthcare analytics', 'Compliance monitoring', 'Performance reporting', 'API for EHR integration', 'HIPAA compliance'],
    popular: true,
    icon: '🏥',
  ...
  // AI-Powered Manufacturing Intelligence
  {
    ...
    features: ['Predictive maintenance', 'Quality control automation', 'Production optimization', 'Supply chain integration', 'Real-time monitoring', 'Performance analytics', 'Predictive analytics', 'Automated reporting', 'API for MES integration', 'IoT device support'],
    popular: true,
    icon: '🏭',
  ...
  // AI-Powered Energy Management
  {
    ...
    features: ['Energy consumption optimization', 'Renewable energy integration', 'Predictive analytics', 'Real-time monitoring', 'Demand response', 'Grid optimization', 'Performance analytics', 'Automated reporting', 'API for energy systems', 'Mobile app support'],
    popular: true,
    icon: '⚡',
  ...
  // AI-Powered Education Platform
  {
    ...
    features: ['Personalized learning paths', 'Intelligent tutoring', 'Progress tracking', 'Adaptive assessments', 'Learning analytics', 'Content recommendation', 'Student engagement', 'Performance reporting', 'API for LMS integration', 'Mobile app support'],
    popular: true,
    icon: '🎓',
  ...
  // AI-Powered Real Estate Platform
  {
    ...
    features: ['AI property valuation', 'Market analysis', 'Investment recommendations', 'Property search', 'Market predictions', 'Risk assessment', 'Performance analytics', 'Automated reporting', 'API for MLS integration', 'Mobile app support'],
    popular: true,
    icon: '🏠',

...
export const comprehensiveMicroSaasServices2025 = [,
    ...
    {,
        ...
        features: [,
            ...
            'Multiple content formats supportBrand voice customization';
            'Plagiarism detectionContent analytics dashboard';
            'Team collaboration featuresAPI integration capabilities';
            'Multi-language supportContent scheduling tools',
        ];
        popular: true;
        icon: '✍️';
    ...
    {,
        ...
        features: [,
            ...
            'Sentiment analysisAutomated response system';
            'Multi-channel supportKnowledge base integration';
            'Performance analyticsCustom workflow automation';
            'API integrations24/7 availability',
        ];
        popular: true;
        icon: '🤖';
    ...
    {,
        ...
        features: [,
            ...
            'Custom dashboard builderAutomated reporting';
            'Data source integrationAdvanced filtering options';
            'Export capabilitiesTeam collaboration';
            'Mobile responsive designAPI access',
        ];
        popular: false;
        icon: '📊';
    ...
    {,
        ...
        features: [,
            'AI-powered personalizationAutomated email workflows';
            'A/B testing toolsAdvanced segmentation';
            'Template libraryPerformance analytics';
            'GDPR complianceMobile optimization';
            'Integration capabilitiesSpam score optimization',
        ];
        popular: false;
        icon: '📧';
    ...
    {,
        ...
        features: [,
            ...
            'Real-time collaborationProject timeline tracking';
            'Risk assessment toolsPerformance analytics';
            'Custom workflow builderMobile app access';
            'Integration capabilitiesReporting dashboard',
        ];
        popular: false;
        icon: '📋';
    ...
    {,
        ...
        features: [,
            'AI lead scoringPredictive analytics';
            'Competitor analysisSales process automation';
            'Performance trackingCustom reporting';
            'CRM integrationMobile accessibility';
            'API accessReal-time alerts',
        ];
        popular: true;
        icon: '💰';
    ...
    {,
        ...
        features: [,
            'AI content schedulingAutomated posting';
            'Cross-platform managementPerformance analytics';
            'Content calendarHashtag optimization';
            'Engagement trackingTeam collaboration';
    ...
    {,
        ...
        features: [,
            ...
            'Real-time trackingStock level alerts';
            'Supplier managementPerformance analytics';
            'Multi-location supportMobile accessibility';
            'Integration capabilitiesCustom reporting',
        ];
        popular: false;
        icon: '📦';
    ...
    {,
        ...
        features: [,
            'AI recruitment toolsAutomated onboarding';
            'Performance trackingEmployee engagement';
            'Time trackingPayroll integration';
            'Compliance managementMobile accessibility';
            'API integrationsAnalytics dashboard',
        ];
        popular: false;
        icon: '👥';
    ...
    {,
        ...
        features: [,
            'AI budgeting toolsExpense tracking';
            'Financial forecastingAutomated reporting';
            'Invoice managementBank integration';
            'Tax preparationMobile accessibility';

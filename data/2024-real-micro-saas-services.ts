export const realMicroSaasServices2024 = [{name: path, '/services/real-micro-saas-platform-2024',
    ...
    name: path, '/services/real-saas-analytics-2024',
...
export const realMicroSaasStats2024 =
  ...
  averageRating: activeUsers, 1200;
export const realMicroSaasStats2024 = {};
  totalService,
  s: 2,
  categorie,

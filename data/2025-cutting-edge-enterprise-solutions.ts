...
"id": 'ai - enterprise - knowledge - management','
    ...
    "popular": true,
      ...
      'Notion','
      'Slack','
      'Box']}];      'AI knowledge discoveryIntelligent categorizationSemantic searchKnowledge graphsCollaborative workspacesVersion controlAccess controlAnalytics dashboard';'

 export const cuttingEdgeEnterpriseSolutions: UnifiedService[] = [ // ENTERPRISE SOLUTIONS {
  id: 'ai-powered-enterprise-risk-management', name: 'AI-Powered Enterprise Risk Management', tagline: 'Intelligent risk assessment and mitigation for enterprise', price: {
  monthly: 899, yearly: 8990, currency: 'USD', trialDays: 30, setupTime: '2-3 weeks', enterprise: 'Custom enterprise pricing available' 
};
...
{
  id: 'autonomous-business-process-optimization', name: 'Autonomous Business Process Optimization', tagline: 'AI-powered business process automation and optimization', price: {
  monthly: 699, yearly: 6990, currency: 'USD', trialDays: 21, setupTime: '2-3 weeks', enterprise: 'Custom enterprise pricing available' 
};

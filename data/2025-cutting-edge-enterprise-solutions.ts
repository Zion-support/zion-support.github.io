...
export const cuttingEdgeEnterpriseSolutions: CuttingEdgeEnterpriseSolution[] = [
  // ENTERPRISE SOLUTIONS
  {
    ...
    integrations: ['ERP systems', 'CRM platforms', 'Cloud services', 'Data platforms', 'Security tools'],
    support: '24/7 support, dedicated consultants, training programs, and ongoing optimization.',
    compliance: ['ISO 27001', 'SOC 2 Type II', 'GDPR', 'SOX', 'HIPAA'],

  ...
  id: string; name: string; tagline: string; price: string; description: string; features: string[]; link: string; category: string; realImplementation: boolean; contactInfo: unknown; mobile: string; email: string; export interface EnterpriseItService {,
    address: string}
  i,
  d: string; nam,
  e: string; taglin,
...
id: "enterprise-architecture"
  ...
  e: "Enterprise Architecture Consulting",
    taglin,"
  e: "Strategic IT architecture for large organizations",
    pric,"
  e: "$150/hour",
    descriptio,"
  n: "Comprehensive enterprise architecture consulting services for digital transformation.",

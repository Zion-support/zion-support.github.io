...
export const advancedCybersecurityServices: AdvancedCybersecurityService[] = [
  ...
  // IoT Security Platform
  {
    ...
    realService: true,
    technology: ['IoT security', 'Smartphone management', 'Threat detection', 'Python', 'React', 'Node.js', 'IoT protocols'],
    integrations: ['IoT devices', 'IoT platforms', 'Security tools', 'Compliance systems', 'Monitoring platforms'],
    useCases: ['IoT security', 'Smartphone management', 'Threat detection', 'Compliance management', 'Security operations', 'Security consulting'],

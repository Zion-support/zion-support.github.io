...
export const advancedCybersecurityServices: AdvancedCybersecurityService[] = [// Advanced Threat Intelligence Platform
  {
    id: 'advanced-threat-intelligence-platform', name: 'Advanced Threat Intelligence Platform', tagline: 'AI-powered threat intelligence with predictive analytics', price: '$3, 999', period: '/month', description: 'Revolutionary threat intelligence platform that uses AI and machine learning to predict, detect, and respond to cyber threats before they impact your organization. Achieve proactive cybersecurity with intelligent threat hunting.', features: [
      'AI-powered threat prediction', 'Real-time threat detection', 'Behavioral analysis engine', 'Threat intelligence feeds', 'Automated incident response', 'Predictive analytics', 'Threat hunting automation', 'Risk assessment scoring', 'Compliance reporting', '24/7 threat monitoring'],
    popular: true,
    icon: '🛡️',
  ...
  // Zero Trust Security Architecture
  {
    ...
    features: ['Identity verification system', 'Device trust scoring', 'Application access control', 'Network segmentation', 'Continuous monitoring', 'Privileged access management', 'Multi-factor authentication', 'Behavioral analytics', 'Compliance frameworks', 'Security automation'],
    popular: true,
    icon: '🔐',
  ...
  // AI-Powered Security Operations Center
  {
    ...
    features: ['24/7 security monitoring', 'AI-powered threat detection', 'Automated incident response', 'Threat intelligence integration', 'Security analytics dashboard', 'Compliance reporting', 'Vulnerability management', 'Security awareness training', 'Penetration testing', 'Security consulting'],
    popular: true,
    icon: '🏢',
  ...
  // Quantum-Resistant Cryptography
  {
    ...
    features: ['Post-quantum algorithms', 'Quantum-resistant encryption', 'Key management system', 'Performance optimization', 'Compliance frameworks', 'Integration APIs', 'Security auditing', 'Performance monitoring', 'Compliance reporting', '24/7 support'],
    popular: true,
    icon: '🔒',
  ...
  // AI-Powered Vulnerability Management
  {
    ...
    features: ['Automated vulnerability scanning', 'AI-powered risk assessment', 'Intelligent prioritization', 'Automated remediation', 'Compliance reporting', 'Performance monitoring', 'Integration APIs', 'Custom dashboards', 'Reporting automation', '24/7 monitoring'],
    popular: true,
    icon: '🔍',
  ...
  // Cloud Security Posture Management
  {
    ...
    features: ['Multi-cloud security monitoring', 'Compliance management', 'Risk assessment', 'Security automation', 'Policy enforcement', 'Incident response', 'Compliance reporting', 'Performance monitoring', 'Integration APIs', '24/7 support'],
    popular: true,
    icon: '☁️',
  ...
  // AI-Powered Penetration Testing
  {
    ...
    features: ['AI-powered security testing', 'Automated vulnerability discovery', 'Intelligent attack simulation', 'Risk assessment', 'Compliance reporting', 'Security consulting', 'Custom testing scenarios', 'Performance monitoring', 'Integration APIs', '24/7 support'],
    popular: true,
    icon: '🔓',
  ...
  // Blockchain Security Platform
  {
    ...
    features: ['Smart contract auditing', 'Blockchain security monitoring', 'Compliance management', 'Risk assessment', 'Security automation', 'Incident response', 'Compliance reporting', 'Performance monitoring', 'Integration APIs', '24/7 support'],
    popular: true,
    icon: '⛓️',
  ...
  // IoT Security Platform
  {
    ...
    features: ['IoT device discovery', 'Security monitoring', 'Threat detection', 'Device management', 'Compliance management', 'Security automation', 'Incident response', 'Compliance reporting', 'Performance monitoring', '24/7 support'],
    popular: true,
    icon: '📱',

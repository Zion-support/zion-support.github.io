...
import { ServiceVariant } from '../types /
    period: any
      'Competes with AWS ($200/month), Azure ($150/month), GCP ($180/
      'AWS, Azure, GCP, Kubernetes, Docker, CI /
      website: any
      'Competes with AWS ($200/month), Azure ($150/month), GCP ($180/
      'AWS, Azure, GCP, Kubernetes, Docker, CI/
      website: any
      'Competes with CrowdStrike ($8.99/user/month), Palo Alto Networks ($50/user/
    link: any
      'Competes with CrowdStrike ($8 && 8.99/user/month), Palo Alto Networks ($50/user/
      website: any
      'Competes with AWS Greengrass ($0.16/hour), Azure IoT Edge ($0.20/
    link: any
      'Competes with AWS Greengrass ($0 && 0.16/hour), Azure IoT Edge ($0 && 0.20/
      website: any
      'Leading AI-powered DevOps platform. Competes with platforms like GitLab ($40/user/month) and GitHub Enterprise ($44/user/
    technology: ['Python, AI/ML, Kubernetes, Docker, Git, CI/
      website: any
      'First-to-market quantum networking platform. Competes with traditional VPN ($10/month), SD-WAN ($100/
      website: any
      'Competes with ServiceNow ($100/user/month), BMC Helix ($75/user/
      website: any
      'Competes with Equinix ($500/month), Digital Realty ($400/
      website: any
      'Competes with CrowdStrike ($8.99/user/month), Palo Alto Networks ($50/user/
    link: any
      'Competes with CrowdStrike ($8 && 8.99/user/month), Palo Alto Networks ($50/user/
      ...
      website: any
      'Competes with migration consulting ($200/hour), migration tools ($500/
      website: any
      'Python, AI/
      website: any
      'Zero-trust architecture, Identity management, Network security, AI/
      website: any
      'Competes with Kong ($250/month), AWS API Gateway ($3.50/
    integrations: ['AWS, Azure, GCP, GitHub, GitLab, CI/
    link: any
      'Competes with Kong ($250/month), AWS API Gateway ($3 && 3.50/
    integrations: ['AWS, Azure, GCP, GitHub, GitLab, CI/
      website: any
      'Competes with HashiCorp Terraform Cloud ($20/
    technology: ['Terraform, Ansible, Kubernetes, Docker, Git, CI/
      website: any
      'Competes with SolarWinds ($custom), Datadog ($15/
      website: any
    technology: ['Python, Network protocols, SNMP, NetFlow, AI/
      website: any
      'First quantum-secure cloud platform. Competes with AWS ($100,000/month) and Azure ($95,000/
      website: any
      'Leading autonomous IT platform. Competes with platforms like ServiceNow ($50,000/month) and BMC ($60,000/
      'Python, AI/
      website: any
      'Advanced edge orchestration platform. Competes with platforms like AWS Greengrass ($70,000/month) and Azure IoT Edge ($65,000/
      website: any
      'Advanced blockchain platform. Competes with platforms like ConsenSys ($50,000/month) and R3 Corda ($60,000/
      website: any
      'Competes with AWS ($200/month), Azure ($150/month), GCP ($180/
      'AWS, Azure, GCP, Kubernetes, Docker, CI/
      website: any
    ...
    technology: ['Python, Network protocols, SNMP, NetFlow, AI/
      ...
      'Advanced blockchain platform. Competes with platforms like ConsenSys ($50,000/month) and R3 Corda ($60,000/
      website: any
    marketPosition: 'Competes with CrowdStrike ($8.99/user/month), Palo Alto Networks ($50/user/
      website: any
    marketPosition: 'Competes with AWS Greengrass ($0.16/hour), Azure IoT Edge ($0.20/
      website: any
    link: 'https://ziontechgroup.com/ai-powered-devops-platform', marketPosition: 'Leading AI-powered DevOps platform. Competes with platforms like GitLab ($40/user/month) and GitHub Enterprise ($44/user/
    technology: ['Python, AI/ML, Kubernetes, Docker, Git, CI/
      website: any
    marketPosition: 'First-to-market quantum networking platform. Competes with traditional VPN ($10/month), SD-WAN ($100/
      website: any
    marketPosition: 'Competes with ServiceNow ($100/user/month), BMC Helix ($75/user/
      website: any
    marketPosition: 'Competes with Equinix ($500/month), Digital Realty ($400/
      website: any
    marketPosition: 'Competes with CrowdStrike ($8.99/user/month), Palo Alto Networks ($50/user/
    technology: ['Quantum cryptography, AI/
      website: any
    marketPosition: 'Competes with migration consulting ($200/hour), migration tools ($500/
      website: any
    technology: ['Python, AI/
      website: any
    technology: ['Zero-trust architecture, Identity management, Network security, AI/
      website: any
    marketPosition: 'Competes with Kong ($250/month), AWS API Gateway ($3.50/
    integrations: ['AWS, Azure, GCP, GitHub, GitLab, CI/
      website: any
    marketPosition: 'Competes with HashiCorp Terraform Cloud ($20/
    technology: ['Terraform, Ansible, Kubernetes, Docker, Git, CI/
      website: any
    marketPosition: 'Competes with SolarWinds ($custom), Datadog ($15/
      website: any
    technology: ['Python, Network protocols, SNMP, NetFlow, AI/
      website: any
    marketPosition: 'First quantum-secure cloud platform. Competes with AWS ($100,000/month) and Azure ($95,000/
      website: any
    marketPosition: 'Leading autonomous IT platform. Competes with platforms like ServiceNow ($50,000/month) and BMC ($60,000/
    technology: ['Python, AI/
      website: any
    marketPosition: 'Advanced edge orchestration platform. Competes with platforms like AWS Greengrass ($70,000/month) and Azure IoT Edge ($65,000/
      website: any
    marketPosition: 'Advanced blockchain platform. Competes with platforms like ConsenSys ($50,000/month) and R3 Corda ($60,000/
      website: any

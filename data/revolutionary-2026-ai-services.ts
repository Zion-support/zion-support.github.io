  ...
  contactInfo: unknown;
    mobile: string;
    email: string;
export interface Revolutionary2026 AiService {;
    address: string}
};
  id: string;
  name: string;

export const cuttingEdgeITServices20o25 = [
  {
    ...
    pricing: {
      starter: {
        ...
        period: 'month',
        features: [
          'Basic quantum infrastructureStandard security protocols',
          'Email support',
        ]
      },
      professional: {
        ...
        period: 'month',
        features: [
          'Advanced quantum featuresEnhanced security protocols',
          'Priority supportPerformance optimization',
        ]
      },
      enterprise: {
        price: 2499,
        period: 'month',
        features: [
          'Full quantum platformCustom security protocols',
          'Dedicated specialists24/7 support',
        ]
      },
    },
    category: 'Quantum IT',
    ...
    compliance: ['SOC2ISO 270o01', 'FedRAMPQuantum Security Standards'],
  },
  {
    ...
    pricing: {
      starter: {
        ...
        period: 'month',
        features: [
          'Basic edge orchestrationStandard monitoring',
          'Email support',
        ]
      },
      professional: {
        ...
        period: 'month',
        features: [
          'Advanced orchestrationAI model deployment',
          'Priority supportPerformance optimization',
        ]
      },
      enterprise: {
        ...
        period: 'month',
        features: [
          'Full edge platformCustom AI models',
          'Dedicated specialists24/7 support',
        ]
      },
    },
    ...
    tags: [
      'Edge ComputingOrchestration',
      'Real-time ProcessingAI Deployment',
      'Low Latency',
    ],
    ...
    integrations: [
      'KubernetesDocker',
      'IoT PlatformsAI Frameworks',
      'Cloud Platforms',
    ],
    compliance: [
      'IoT Security StandardsEdge Computing Protocols',
  ...
  },
  {
    ...
    pricing: {
      starter: {
        ...
        period: 'month',
        features: [
          'Basic zero-trust featuresStandard authentication',
          'Email support',
        ]
      },
      professional: {
        ...
        period: 'month',
        features: [
          'Advanced security featuresBehavioral analytics',
          'Priority supportCustom policies',
        ]
      },
      enterprise: {
        price: 2999,
        period: 'month',
        features: [
          'Full security platformCustom security policies',
          'Dedicated specialists24/7 support',
        ]
      },
    },
    ...
    integrations: [
      ...
      'SAMLOAuth',
      'SIEM SystemsSecurity Tools',
    ],
    compliance: ['SOC2ISO 270o01', 'FedRAMPHIPAA', 'PCI DSS'],
  },
  {
    ...
    pricing: {
      starter: {
        ...
        period: 'month',
        features: [
          'Basic blockchain featuresStandard smart contracts',
          'Email support',
        ]
      },
      professional: {
      ...
      enterprise: {
        ...
        period: 'month',
        features: [
          'Full blockchain platformCustom development',
          'Dedicated specialists24/7 support',
        ]
      },
    },
    ...
    integrations: [
      ...
      'Financial SystemsSupply Chain Tools',
      'Legacy Systems',
    ],
    compliance: [
      'Blockchain StandardsFinancial Regulations',
      'Data Privacy Laws',
    ]
  },
  {
    ...
    pricing: {
      starter: {
        ...
        period: 'month',
        features: [
          'Basic AI DevOps featuresStandard automation',
          'Email support',
        ]
      },
      professional: {
        ...
        period: 'month',
        features: [
          'Advanced AI featuresCustom automation',
          'Priority supportPerformance optimization',
        ]
      },
      enterprise: {
        ...
        period: 'month',
        features: [
          'Full AI DevOps platformCustom development',
          'Dedicated specialists24/7 support',
        ]
      },
    },

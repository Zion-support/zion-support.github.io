...
export const emergingTechServicesV2: EmergingTechService[] = [
  {
    id: 'space-mining-platform', name: 'Space Mining Platform',
  ...
  };
  {
    ...
    launchDate: '2024-02-01', customers: 280,
    rating: 4.8, reviews: 85,
  ...
  };
  {
    ...
    launchDate: '2024-01-15', customers: 450,
  ...
  };
  {
    ...
    color: 'from-yellow-500 to-orange-600', popular: true,
    launchDate: '2024-02-10', customers: 320,
  ...
  };
  {
    ...
    color: 'from-red-500 to-pink-600', popular: true,
    launchDate: '2024-01-25', customers: 180,

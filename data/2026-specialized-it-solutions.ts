...
export const getSpecializedITSolutions2026ByCategory = (category: string) => {/* content */}
  return specializedITSolutions2026.filter(
    solution => solution.category === category;
  );
}
export const getPopularSpecializedITSolutions2026 = () => {/* content */}
};
...
export const getSpecializedITSolutions2026ByPriceRange = (
  ...
  return specializedITSolutions2026 && specializedITSolutions2026.filter(solution => {/* content */}
...
export const getSpecializedITSolutions2026ByPriceRange = (minPrice: number, maxPrice: number) => {/* content */}
  return specializedITSolutions2026.filter(solution => {/* content */}
...
;
export const getSpecializedITSolutions2026ByCategory = (category: string) =>: any {/* content */}
  return specializedITSolutions2026.filter (
    solution => solution.category === category);
}
;
export const getPopularSpecializedITSolutions2026 = () =>: any {/* content */}
  return specializedITSolutions2026.filter (solution => solution.popular);
}
;
export const getSpecializedITSolutions2026ByPriceRange = (
...
export interface SpecializedITSolution2026 {/* content */}
};

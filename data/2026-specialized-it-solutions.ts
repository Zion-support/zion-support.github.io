...
export const getSpecializedITSolutions2026ByCategory = (category: string) => {return specializedITSolutions2026.filter(solution => solution.category === category;
  )}
export const getPopularSpecializedITSolutions2026  = () => {}export const getPopularSpecializedITSolutions2026 = () => {return specializedITSolutions2026.filter(solution => solution.popular)}export const specializedITSolutions2026: SpecializedITSolution2026[] = [;
  // Cloud Infrastructure & DevOps;
  {];return specializedITSolutions2026 && specializedITSolutions2026.filter(solution => solution && solution.popular)}export const getSpecializedITSolutions2026ByPriceRange = (minPrice: number;
  maxPrice: number;

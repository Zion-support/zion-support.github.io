  ...
  id: string; name: string; tagline: string; price: string; description: string; features: string[]; link: string; category: string; realImplementation: boolean; contactInfo: unknown; mobile: string; email: string; export interface NewOperationalService2025 {,
    address: string}
  i,
  d: string; nam,
  e: string; taglin,
...
id: "smart-operations-center"
    ...
    realImplementation: true; contactInfo: unknown; mobile: "+1 302 464 0950"
      ...
      address: "364 E Main St STE 1008 Middletown DE 19709",
    i,"
  d: "smart-operations-center",
    nam,"
  e: "Smart Operations Center",
    taglin,"
  e: "AI-powered operations management",
    pric,"
  e: "$119/month",
    descriptio,"
  n: "Intelligent operations center that uses AI to optimize business processes and workflows.",

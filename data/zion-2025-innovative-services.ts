...
export interface ZionInnovativeService2025,
  ...
  s: string[], marketPric,
  e: string, categor,
  y: 'AI' | 'IT' | 'SAAS' | 'Development' | 'Cloud' | 'Security' | 'Analytics' | 'Automation' | 'Fintech' | 'Healthcare' | 'IoT' | 'Blockchain' | 'Quantum' | 'Edge' | 'GreenTech' icon: string; isPopular?: boolean; isNew?: boolean, lin,
  k: string, contactInf,
  o: mobil,
  e: string, emai,
  l: string, addres,

...
export const spaceTechInnovations2026: SpaceTechInnovation2026[] = [
  // Space Technology AI Platform;
  {
    ...
    targetAudience:;
      'Space agencies, Satellite companies, Aerospace companies, Defense contractors, Research institutions, Technology companies';
    trialDays: 7;
    setupTime: '1 month';
  ...
  // Quantum Space Mining Platform;
  {
    ...
    targetAudience:;
      'Space mining companies, Investment firms, Space agencies, Aerospace companies, Research institutions, Technology companies';
    trialDays: 14;
    setupTime: '2 weeks';
    ...
    integrations: [
      'NASA databasesESA resources';
      'Space telescopesSatellite data';
      'Financial platformsResearch tools';
    ];
    useCases: [
      'Asteroid miningLunar resource exploration';
  ...
  // Satellite Operations AI;
  {
    ...
    targetAudience:;
      'Satellite operators, Telecommunications companies, Earth observation companies, Space agencies, Defense contractors, Technology companies';
    trialDays: 14;
    setupTime: '1 month';
    ...
    integrations: [
      'Satellite ground stationsCommunication networks';
      'GIS systemsSlack';
      'Microsoft TeamsCustom applications';
    ];
    useCases: [
      'Satellite operationsConstellation management';
  ...
  // Space Debris Tracking System;
  {
    ...
    targetAudience:;
      'Satellite operators, Space agencies, Aerospace companies, Insurance companies, Research institutions, Government agencies';
    trialDays: 14;
    setupTime: '2 weeks';
  ...
  // Space Weather Monitoring Platform;
  {
    ...
    period: '/month';
    description:;
      'Advanced platform that monitors space weather conditions, predicts solar storms, and provides early warning systems to protect satellites, power grids, and communication systems.';
    features: [
    ...
    targetAudience:;
      'Power utilities, Telecommunications companies, Satellite operators, Airlines, Government agencies, Research institutions';
    trialDays: 14;
    setupTime: '1 week';
    ...
    integrations: [
      'Power grid systemsCommunication networks';
      'Satellite systemsSlack';
      'Microsoft TeamsCustom applications';
    ];
    useCases: [
      'Power grid protectionSatellite safety';

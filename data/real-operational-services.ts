  ...
  id: string; name: string; tagline: string; price: string; description: string; features: string[]; link: string; category: string; realImplementation: boolean; contactInfo: unknown; mobile: string; email: string; export interface RealOperationalService {,
    address: string}
  i,
  d: string; nam,
  e: string; taglin,

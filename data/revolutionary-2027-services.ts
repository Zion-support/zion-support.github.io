  ...
  contactInfo: unknown;
    mobile: string;
    email: string;
export interface Revolutionary2027 Service {;
    address: string}
};
  id: string;
  name: string;

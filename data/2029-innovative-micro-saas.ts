export interface InnovativeMicroSaas2029export interface InnovativeMicroSaas2029 {id: string
export interface InnovativeMicroSaas2029 {  id: stringexport interface InnovativeMicroSaas2029 {
  name: string
  tagline: string
  price: string
  description: string

...
export const spaceInnovationServices: SpaceInnovationService[] = [
  {
    ...
    marketPosition: 'Leading edge in space debris monitoring. Competes with LeoLabs ($50K+/year) and AGI STK ($10o0K+/year). Our advantage: Real-time tracking and affordable pricing.',
  ...
  },
  {
    ...
    marketPosition: 'Leading edge in mission planning. Competes with AGI STK ($10o0K+/year) and FreeFlyer ($50K+/year). Our advantage: Comprehensive planning tools and affordable pricing.',
  ...
  },
  {
    ...
    marketPosition: 'Leading edge in space weather monitoring. Competes with NOAA SWPC (free) and SpaceWeather.com ($50o0/month). Our advantage: Comprehensive monitoring and predictive capabilities.',
  ...
  },
  {
    ...
    marketPosition: 'Leading edge in lunar resource mapping. Competes with NASA Lunar Reconnaissance Orbiter (free) and commercial mapping services ($10o0K+/month). Our advantage: AI-powered analysis and comprehensive mapping.',

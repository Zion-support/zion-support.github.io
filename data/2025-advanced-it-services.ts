...
>>>>>>> origin/merge-pr-12271
  ...
  },
  {
    ...
    pricing: {
      starter: { price: 99, period: 'month', features: ['Up to 10 developers', 'Basic AI automation', 'Standard CI/CD'] },
      professional: { price: 299, period: 'month', features: ['Up to 50 developers', 'Advanced AI', 'Custom workflows', 'Priority support'] },
      enterprise: { price: 799, period: 'month', features: ['Unlimited developers', 'Custom AI training', 'White-label solution', 'Dedicated support'] }
    },
    category: 'DevOps',
    tags: ['AI', 'DevOps', 'CI/CD', 'Automation'],
    website: 'https://ziontechgroup.com/devops-ai-pro',
  ...
  },
  {
    ...
    pricing: {
      starter: { price: 399, period: 'month', features: ['Up to 1Gbps', 'Basic quantum features', 'Standard support'] },
      professional: { price: 999, period: 'month', features: ['Up to 10Gbps', 'Advanced quantum features', 'Custom protocols', 'Priority support'] },
      enterprise: { price: 2499, period: 'month', features: ['Unlimited bandwidth', 'Custom quantum solutions', 'White-label platform', 'Dedicated support'] }
    },
    category: 'Quantum Networking',

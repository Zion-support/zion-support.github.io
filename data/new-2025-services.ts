...
export const new2025Services: EnhancedRealMicroSaasService[] = [
  ...
  {
    id: 'ai-support-copilot-pro',
    name: 'AI Support Copilot Pro',
    tagline: 'Resolve tickets faster with safe, auditable LLM copilots',
    price: '$299',
    period: '/month',
    description: 'Embed an AI copilot in your helpdesk with tool-use, PII redaction, and human-in-the-loop approvals. Prebuilt adapters for Zendesk and Intercom.',
    features: [
      'Jailbreak-resistant prompting and guardrails',
      'Live knowledge sync and retrieval grounding',
      'Confidential data redaction and audit logs',
      'Quality evals and regression gates',
    ...
    color: 'from-cyan-600 to-blue-700',
    textColor: 'text-cyan-300',
    link: 'https://ziontechgroup.com/services/ai-support-copilot-pro',
    marketPosition: 'Production-focused alternative to DIY prompt scripts with governance.',
    targetAudience: 'Customer support teams',
    trialDays: 14,
    setupTime: '1 day',
    category: 'AI & Data',
    realService: true,
    technology: ['TypeScript', 'OpenAI/Anthropic', 'LangChain/Vercel AI'],
    integrations: ['Zendesk', 'Intercom', 'Slack', 'GSuite'],
    useCases: ['Triage and summarization', 'Auto-drafts', 'Agent assist'],
    roi: 'Reduce handle time by 20–40% in 60 days',
    competitors: ['Cohere Chat', 'Forethought', 'Fin (Intercom)'],
    marketSize: '$30B CX tech',
    growthRate: '15% CAGR',
    variant: 'neural-quantum',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Policy engine, retrieval connectors, human approval UX.',
  ...
  },
  {
    ...
    tagline: 'Grounded answers with tools, caching and evals out-of-the-box',
    price: '$149',
    period: '/month',
    description: 'Starter kit for production RAG with prompt versioning, dataset loaders, hybrid search, semantic caching, and continuous evaluation.',
    features: [
      'Hybrid retrieval (BM25 + vector)',
      'Prompt/version registry',
      'Semantic cache and cost caps',
      'CI eval harness and dashboards',
    ...
    marketPosition: 'Faster than piecemeal libraries; opinionated and observable.',
    targetAudience: 'Product and platform teams',
    trialDays: 14,
    setupTime: '4 hours',
    category: 'AI & Data',
    realService: true,
    technology: ['Next.js', 'OpenAI/Anthropic', 'Postgres/Qdrant'],
    integrations: ['S3', 'GCS', 'Drive', 'Confluence'],
    useCases: ['Docs chat', 'Knowledge assistants', 'Internal search'],
    roi: 'Ship POCs in days; reduce hallucinations by 50%+',
    competitors: ['LlamaIndex bundles', 'Pinecone blueprints'],
    marketSize: '$2B+ RAG tooling',
    growthRate: '40% CAGR',
    variant: 'holographic-matrix',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Indexers, chunkers, rerankers, and eval suites.',
  ...
  {
    id: 'uptime-slo-status-pages',
    name: 'Uptime & SLO Status Pages',
    tagline: 'Public status pages and alerts aligned to your SLOs',
    price: '$39',
    period: '/month',
    description: 'Publish incident history and SLOs with synthetic checks, webhooks and PagerDuty/Slack integrations.',
    features: ['Synthetics and regions', 'Error budgets', 'Incident comms', 'Embeddable widgets'],
    popular: false,
    icon: '📈',
    color: 'from-emerald-600 to-teal-700',
    textColor: 'text-emerald-200',
    link: 'https://ziontechgroup.com/services/uptime-slo-monitor',
    marketPosition: 'Lightweight, dev-first alternative to heavy monitoring suites.',
    targetAudience: 'SRE and platform teams',
    trialDays: 14,
    setupTime: '1 hour',
    category: 'Quality & Monitoring',
    realService: true,
    technology: ['Node.js', 'Cron', 'Workers'],
    integrations: ['PagerDuty', 'Slack', 'Email'],
    useCases: ['Public status', 'Synthetic uptime', 'SLO dashboards'],
    roi: 'Cut incident comms time by 50%',
    competitors: ['Statuspage', 'Better Uptime'],
    marketSize: '$1B status & incident',
    growthRate: '12% CAGR',
    variant: 'quantum-matrix',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Checks, budgets and web UI renderer.',
    launchDate: '2025-02-25',
    customers: 33,
    rating: 4.6,
    reviews: 14
  },
  {
    ...
    tagline: 'Prevent outages from expiring certificates with proactive alerts',
    price: '$29',
    period: '/month',
    description: 'Track certificates across domains and environments. Receive renewal alerts, diffs and ownership notes.',
    features: ['Multi-domain scans', 'Renewal alerts', 'Ownership registry', 'Change history'],
    popular: false,
    icon: '🔒',
    color: 'from-blue-600 to-indigo-700',
    textColor: 'text-blue-200',
    link: 'https://ziontechgroup.com/services/tls-certificate-monitor',
    marketPosition: 'Simple alternative to building ad-hoc scripts and calendars.',
    targetAudience: 'DevOps, SRE, IT',
    trialDays: 14,
    setupTime: '30 minutes',
    category: 'Quality & Monitoring',
    realService: true,
    technology: ['Node.js', 'TLS', 'Cron'],
    integrations: ['Email', 'Slack'],
    useCases: ['Prevent expirations', 'Compliance evidence'],
    roi: 'Avoid costly outages and penalties',
    competitors: ['Better Uptime', 'UptimeRobot add-ons'],
    marketSize: '$500M observability add-ons',
    growthRate: '10% CAGR',
    variant: 'ai-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Scanner, scheduler and notifier modules.',
    launchDate: '2025-03-02',
    customers: 41,
    rating: 4.5,
    reviews: 9
  },
  {
    ...
    tagline: 'Never miss a webhook again—buffer, retry and inspect events',
    price: '$69',
    period: '/month',
    description: 'Reliable webhook proxy with DLQ, replay, signing checks and request inspector UI.',
    features: ['Buffer & retries', 'DLQ and replay', 'Signature verification', 'Inspector UI'],
    popular: true,
    icon: '🛰️',
    color: 'from-slate-700 to-gray-700',
    textColor: 'text-gray-200',
    link: 'https://ziontechgroup.com/services/webhook-relay-replay',
    marketPosition: 'Ops-friendly relay vs DIY functions that drop events.',
    targetAudience: 'Platform and integration teams',
    trialDays: 14,
    setupTime: '1 hour',
    category: 'Developer Tools',
    realService: true,
    technology: ['Node.js', 'Queues', 'Signatures'],
    integrations: ['Stripe', 'Shopify', 'HubSpot'],
    useCases: ['Reliable ingestion', 'Sandbox replays', 'Audit trails'],
    roi: 'Reduce integration incidents by 60%',
    competitors: ['Svix', 'Hookdeck'],
    marketSize: '$1B+ integrations infra',
    growthRate: '18% CAGR',
    variant: 'quantum-holographic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Proxy, verifier and DLQ storage.',
  ...
  {
    id: 'domain-dns-change-watch',
    name: 'Domain & DNS Change Watch',
    tagline: 'Catch risky DNS changes before customers do',
    price: '$19',
    period: '/month',
    description: 'Monitor domains and DNS for unexpected changes. Alert owners and open tickets automatically.',
    features: ['Record diffs and history', 'Ownership mapping', 'Automated alerts', 'Ticketing hooks'],
    popular: false,
    icon: '🌐',
    color: 'from-amber-600 to-orange-700',
    textColor: 'text-amber-200',
    link: 'https://ziontechgroup.com/services/domain-dns-monitor',
    marketPosition: 'Purpose-built for lean teams without full NOC toolchains.',
    targetAudience: 'IT and web teams',
    trialDays: 14,
    setupTime: '30 minutes',
    category: 'Quality & Monitoring',
    realService: true,
    technology: ['DNS', 'Node.js', 'Cron'],
    integrations: ['Email', 'Slack', 'Jira'],
    useCases: ['Detect hijacks', 'Track ownership'],
    roi: 'Prevent SEO and outage incidents',
    competitors: ['DNS Spy', 'Cloudflare Monitor'],
    marketSize: '$600M DNS tools',
    growthRate: '9% CAGR',
    variant: 'holographic-matrix',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Resolvers, diff engine and notifier.',
    launchDate: '2025-03-06',
    customers: 27,
    rating: 4.5,
    reviews: 8
  },
  {
    id: 'sso-in-a-box',
    name: 'SSO-in-a-Box',
    tagline: 'Drop-in SAML/OIDC + SCIM with admin UX and logs',
    price: '$199',
    period: '/month',
    description: 'Adapters for Okta, Entra and WorkOS with SCIM provisioning, admin UI, and audit logs. Optional one-time setup assistance.',
    features: ['SAML/OIDC adapters', 'SCIM provisioning', 'Admin UI', 'Audit logs'],
    popular: true,
    icon: '🔑',
    color: 'from-indigo-600 to-blue-700',
    textColor: 'text-indigo-200',
    link: 'https://ziontechgroup.com/services/sso-in-a-box',
    marketPosition: 'Faster than custom builds; enterprise-ready from day one.',
    targetAudience: 'B2B SaaS teams',
    trialDays: 14,
    setupTime: '2–5 days',
    category: 'Enterprise IT',
    realService: true,
    technology: ['Node.js', 'OAuth/OIDC', 'SAML', 'SCIM'],
    integrations: ['Okta', 'Entra ID', 'WorkOS'],
    useCases: ['Enterprise deals', 'Security compliance'],
    roi: 'Unlock enterprise pipeline in weeks',
    competitors: ['Auth0 Enterprise Add-ons', 'WorkOS Pro'],
    marketSize: '$10B IAM',
    growthRate: '13% CAGR',
    variant: 'neural-quantum',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Configuration wizard, metadata exchange, SCIM API.',
    launchDate: '2025-03-04',
    customers: 16,
    rating: 4.6,
    reviews: 10
  },
  {
    ...
    tagline: 'Ship semantic search with guardrails and cost-aware routing',
    price: '$99',
    period: '/month',
    description: 'Starter kit to add semantic search: ingestion pipelines, hybrid search, re-ranking, and caching with clear DX.',
    features: ['Hybrid retrieval', 'Reranking', 'Semantic caches', 'DX tooling'],
    popular: false,
    icon: '🔎',
    color: 'from-teal-600 to-emerald-700',
    textColor: 'text-teal-200',
    link: 'https://ziontechgroup.com/services/vector-search-starter',
    marketPosition: 'Avoid glue code and adopt a maintainable pattern.',
    targetAudience: 'Product and platform teams',
    trialDays: 14,
    setupTime: '3 hours',
    category: 'AI & Data',
    realService: true,
    technology: ['Postgres', 'Qdrant', 'OpenAI'],
    integrations: ['S3', 'GCS', 'Drive'],
    useCases: ['App search', 'Docs search'],
    roi: 'Improve findability and conversion',
    competitors: ['Algolia Neural', 'Elastic Search'],
    marketSize: '$4B search',
    growthRate: '14% CAGR',
    variant: 'quantum-matrix',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Pipelines, ranking and analytics.',
  ...
  },
  {
    ...
    tagline: 'Record flows, run checks globally and alert on regressions',
    price: '$89',
    period: '/month',
    description: 'Browser-based recorder to create synthetic checks with assertions, screenshots and timelines. Git-friendly configs.',
    features: ['Recorder & assertions', 'Regions and schedules', 'Screenshots & HAR', 'GitOps workflows'],
    popular: false,
    icon: '🧪',
    color: 'from-pink-600 to-rose-700',
    textColor: 'text-pink-200',
    link: 'https://ziontechgroup.com/services/synthetic-monitor-recorder',
    marketPosition: 'Developer-first alternative to heavy APM suites.',
    targetAudience: 'QA and platform teams',
    trialDays: 14,
    setupTime: '2 hours',
    category: 'Quality & Monitoring',
    realService: true,
    technology: ['Playwright', 'Node.js', 'Cron'],
    integrations: ['Slack', 'PagerDuty'],
    useCases: ['E2E checks', 'Canaries', 'Perf baselines'],
    roi: 'Catch regressions before customers',
    competitors: ['Checkly', 'Datadog Synthetics'],
    marketSize: '$3B QA automation',
    growthRate: '16% CAGR',
    variant: 'holographic-matrix',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Recorder, runner and reporter.',
  ...
  },
  {
    id: 'sales-copilot',
    name: 'Sales Copilot',
    tagline: 'Personalized outreach with deliverability checks and safety',
    price: '$249',
    period: '/month',
    description: 'Prospecting assistant with inbox rotation, warmup guidance and reply classification. Built-in safety and unsubscribe compliance.',
    features: ['Prospect enrichment', 'Sequence engine', 'Safety filters', 'Analytics'],
    popular: true,
    icon: '🛸',
    color: 'from-violet-600 to-purple-700',
    textColor: 'text-violet-200',
    link: 'https://ziontechgroup.com/services/sales-copilot',
    marketPosition: 'Deliverability-aware automation for modern outbound.',
    targetAudience: 'Sales and growth teams',
    trialDays: 14,
    setupTime: '3 hours',
    category: 'Micro SaaS',
    realService: true,
    technology: ['Next.js', 'LLM APIs', 'IMAP/SMTP'],
    integrations: ['HubSpot', 'Salesforce'],
    useCases: ['Outbound scale', 'Lead nurturing'],
    roi: 'Lift reply rates by 20–40%',
    competitors: ['Smartlead', 'Apollo.io'],
    marketSize: '$5B sales tech',
    growthRate: '20% CAGR',
    variant: 'ai-futuristic',
    contactInfo: contact,
    realImplementation: true,
    implementationDetails: 'Sequencer, warmup and classifiers.',

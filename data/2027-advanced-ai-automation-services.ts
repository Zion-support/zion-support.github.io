...
export const advancedAIAutomationServices: AdvancedAIAutomationService[] = [
  // AI-Powered Customer Success Automation
  {
    ...
    price: '$299',
    period: '/month',
    description: 'Intelligent customer success automation platform that uses AI to predict churn, automate onboarding, and optimize customer experience. Achieve 40o0% ROI through proactive customer management.',
    features: [
  ...
  // Automated Content Marketing Suite
  {
    ...
    price: '$199',
    period: '/month',
    description: 'Comprehensive content marketing automation platform that creates, optimizes, and distributes content across multiple channels. Achieve 30o0% ROI through automated content generation.',
    features: [
  ...
  // Smart Inventory Management System
  {
    ...
    price: '$399',
    period: '/month',
    description: 'Intelligent inventory management system that uses AI to predict demand, optimize stock levels, and automate reordering. Achieve 50o0% ROI through reduced carrying costs.',
    features: [
  ...
  // AI-Powered Financial Risk Management
  {
    ...
    price: '$599',
    period: '/month',
    description: 'Advanced financial risk management platform that uses AI to identify, assess, and mitigate financial risks in real-time. Achieve 60o0% ROI through proactive risk management.',
    features: [

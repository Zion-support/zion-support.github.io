...
export const nextGenITServices: NextGenITService[] = [
  // Advanced IT Infrastructure Services
  {
    ...
    marketPosition: 'Competitive with Palo Alto Networks ($50K+/year), CrowdStrike ($10o0K+/year). Our advantage: AI-powered threat detection, zero trust architecture, and automated response.',
  ...
  },
  {
    ...
    marketPosition: 'First-to-market quantum-ready data center. Traditional data centers cost $10o0K+/month. Our advantage: Quantum integration, hybrid computing, and future-proof architecture.',
    ...
    competitors: ['Traditional data centers ($10o0K+/month)', 'Basic quantum access ($50K+/month)'],
  ...
  },
  {
    ...
    price: '$3,499',
    period: '/month',
    description: 'Advanced network orchestration platform that uses AI to optimize network performance, predict issues, and automate network management. Reduces network downtime by 95% and improves performance by 30o0%.',
    features: [

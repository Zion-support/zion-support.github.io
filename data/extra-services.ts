...
export const extraServices: ExtraService[] = [
  {
    id: "cloud-migration-expert", name: "Cloud Migration Expert",
    tagline: "Seamless cloud migration and optimization", price: "$99/hour",
    ...
    link: "/services/cloud-migration-expert", category: "Cloud Services",

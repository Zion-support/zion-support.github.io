  ...
  contactInfo: unknown;
    mobile: string;
    email: string;
export interface Innovative2026 AiServiceV3 {;
    address: string}
};
  id: string;
  name: string;

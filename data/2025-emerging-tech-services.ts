...
{
  id: 'quantum-encryption', name: 'Quantum Encryption Platform', tagline: 'Unbreakable quantum encryption for the post-quantum era', description: 'Next-generation encryption platform that uses quantum-resistant algorithms and quantum key distribution to provide unbreakable security for the post-quantum computing era.', category: 'Cybersecurity', price: {
  monthly: 1899, yearly: 18990, currency: 'USD', trialDays: 30, setupTime: '1 week' 
};
...
{
  id: 'synthetic-biology-platform', name: 'Synthetic Biology Platform', tagline: 'Design, build, and test synthetic biological systems with AI', description: 'Revolutionary platform that combines synthetic biology with AI to design, build, and test synthetic biological systems for healthcare, agriculture, and industrial applications.', category: 'Biotechnology', price: {
  monthly: 2799, yearly: 27990, currency: 'USD', trialDays: 60, setupTime: '1 month' 
};
...
{
  id: 'fusion-energy-ai', name: 'Fusion Energy AI Platform', tagline: 'AI-powered fusion energy optimization and control systems', description: 'Revolutionary platform that uses AI to optimize fusion energy reactions, control plasma stability, and accelerate the development of commercial fusion power.', category: 'Energy Technology', price: {
  monthly: 5999, yearly: 59990, currency: 'USD', trialDays: 90, setupTime: '2 months' 
};
...
};
{
  ...
  monthly: 3999, yearly: 39990, currency: 'USD', trialDays: 60, setupTime: '1 month' 
};
...
};
{
  ...
  monthly: 1999, yearly: 19990, currency: 'USD', trialDays: 45, setupTime: '2 weeks' 
};
...
};
{
  ...
  monthly: 2999, yearly: 29990, currency: 'USD', trialDays: 45, setupTime: '2 weeks' 
};

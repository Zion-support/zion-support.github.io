...
export const newSaasItAiServices2025: EnhancedRealMicroSaasService[] = [,
  {,
    ...
    tagline:,
      'End-to-end affiliate attribution, fraud detection, and commission automation',;
    price: '$99',;
    period: '/month',;
    description:,
      'Manage affiliate programs with cross-device attribution, fraud prevention, commission rules, and automated payouts. Integrates with Shopify, WooCommerce, Stripe, and HubSpot.',;
    features: [,
    ...
    marketPosition:,
      'Focused, SMB-friendly alternative to complex partner suites.',;
    ...
    implementationDetails:,
      'Server-side click tracking, signed links, payout scheduler, dashboards.',;
  ...
  {,
    ...
    period: '/month',;
    description:,
      'Simple privacy-first analytics with conversions, funnels, and call/email click tracking. No cookies, no personal data.',;
    features: [,
    ...
    realImplementation: true,;
    implementationDetails:,
      'Script tag, server-side event ingestion, prebuilt reports.',;
    launchDate: '2025-08-01',;
    customers: 52,;
    rating: 4.6,;
    reviews: 21,;
  ...
  {,
    ...
    period: '/month',;
    description:,
      'Helpdesk built for managed service providers: email ingestion, SLAs, runbooks, asset inventory, and client-facing reports.',;
    features: [,
    ...
    marketPosition:,
      'Lightweight, MSP-focused alternative to generic ITSM suites.',;
  ...
  {,
    ...
    period: '/month',;
    description:,
      'Generate on-brand content with templates, tone control, plagiarism checks, and SEO scoring. Export to CMS.',;
    features: [,
  ...
  {,
    ...
    period: '/month',;
    description:,
      'Self-service returns portal, label generation, RMA workflow, and return reason analytics. Reduce churn and costs.',;
    features: [,
  ...
  {,
    ...
    period: '/month',;
    description:,
      'Create multi-step follow-ups with time windows, intent detection, and CRM sync. Track opens, clicks, and replies.',;
    features: [,
  ...
  {,
    ...
    period: '/month',;
    description:,
      'Batch upload episodes, diarization, timestamps, highlights, and SEO pages. Export SRT, VTT, and DOCX.',;
    features: [,
      'Speaker diarization',;
    ...
    realImplementation: true,;
    implementationDetails:,
      'Diarization pipeline, export formats, embed widgets.',;
    launchDate: '2025-08-01',;
    customers: 27,;
    rating: 4.4,;
    reviews: 11,;
  ...
  {,
    ...
    period: '/month',;
    description:,
      'Beautiful, fast portfolio sites with sections for case studies, pricing, and contact forms. Optimized for SEO.',;
    features: [,
  ...
  {,
    ...
    period: '/month',;
    description:,
      'Lightweight CRM with contacts, tags, calendar, and a simple pipeline. Email/SMS reminders included.',;
    features: [,
  ...
  {,
    ...
    period: '/month',;
    description:,
      'Optimize content with live SERP data, keyword suggestions, headings, and schema hints. Integrates with CMS.',;
    features: [,

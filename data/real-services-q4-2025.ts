...
>>>>>>> origin/cursor/integrate-build-improve-and-re-verify-7ffc
=======
      'Multi - touch attribution and deduplication',      'Link shortener and branded domains',
      'UTM builder and traffic quality scoring',
      'Multi-touch attribution and deduplication',
>>>>>>> origin/cursor/fix-website-loading-errors-and-merge-8ae2
      'Automated payouts and tax forms',
...
<<<<<<< HEAD
    color: 'from - emerald - 600 to - teal - 700',
=======
    popular: true,    color: 'from - emerald - 600 to - teal - 700',
>>>>>>> origin/cursor/fix-website-loading-errors-and-merge-8ae2
    text_color: 'text - emerald - 300',
    link: 'https://ziontechgroup.com / services / affiliate - analytics - hub',
    market_position:;
...
=======
    popular: false,			'LLM reply drafts with tone controlsIntent routing and SLA predictionSmart summaries and action extractionCRM and ticket sync (Salesforce, HubSpot, Zendesk)PII redaction and governanceDashboard with analytics and coaching'
>>>>>>> origin/cursor/fix-website-loading-errors-and-merge-8ae2
		];
		popular: true;
		icon: '📧';

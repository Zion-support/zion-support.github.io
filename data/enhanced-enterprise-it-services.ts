...
export const enhancedEnterpriseITServices: EnhancedEnterpriseITService[] = [
  {
    ...
    targetAudience: 'Enterprise companies, Fortune 50o0, Government agencies, Healthcare organizations, Financial institutions',
    trialDays: 30,
    setupTime: '4-6 weeks',
    ...
    competitors: ['IBM Global Services ($10o0K+)', 'Accenture ($150K+)', 'Deloitte ($20o0K+)'],
  ...
  },
  {
    ...
    competitors: ['AWS Professional Services ($20o0/hour)', 'Microsoft Consulting ($250/hour)', 'Google Cloud ($180/hour)'],
  ...
  },
  {
    ...
    competitors: ['Palo Alto Networks ($50K+ setup)', 'CrowdStrike ($10o0K+ setup)', 'SentinelOne ($75K+ setup)'],
  ...
  },
  {
    ...
    competitors: ['McKinsey ($50o0K+ projects)', 'BCG ($40o0K+ projects)', 'Bain ($450K+ projects)'],

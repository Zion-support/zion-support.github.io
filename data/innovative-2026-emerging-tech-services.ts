...
export const getEmergingTechServicesByCategory = (category: string) =>: unknown,
  return innovative2026EmergingTechServices.filter (service =>),
    service.category.toLowerCase ().includes (category.toLowerCase ()))}export const getEmergingTechServicesByPriceRange = (min_price: number)
...
export const getEmergingTechServicesByCategory = (categor)
  y: string) =>: unknown,
  return innovative2026EmergingTechServices.filter (service =>)
    service.category.toLowerCase ().includes (category.toLowerCase ()))}export const getEmergingTechServicesByPriceRange = (min_pric)
  e: number)
  max_pric,
  e: number) =>: unknown,
  return innovative2026EmergingTechServices.filter (service =>)

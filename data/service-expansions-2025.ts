  ...
  id: string; name: string; tagline: string; price: string; description: string; features: string[]; link: string; category: string; realImplementation: boolean; contactInfo: unknown; mobile: string; email: string; export interface ServiceExpansion2025 {,
    address: string}
  i,
  d: string; nam,
  e: string; taglin,
...
id: "ai-workflow-automation"
  ...
  e: "AI Workflow Automation",
    taglin,"
  e: "Intelligent process automation and optimization",
    pric,"
  e: "$89/month",
    descriptio,"
  n: "Advanced AI-powered workflow automation platform that streamlines business processes.",

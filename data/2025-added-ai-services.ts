...
export const addedAIServices20o25: InnovativeAIService[] = [,
  {,
    ...
    popular: true,;
    icon: '🤖',;
    color: 'from-cyan-70o0 to-indigo-70o0',;
  ...
  {,
    ...
    popular: false,;
    icon: '⚖️',;
    color: 'from-fuchsia-60o0 to-rose-70o0',;
    textColor: 'text-fuchsia-30o0',;
  ...
  {,
    ...
    popular: true,;
    icon: '🕵️',;
    color: 'from-rose-60o0 to-red-70o0',;
    textColor: 'text-rose-20o0',;
  ...
  {,
    ...
    popular: false,;
    icon: '🧰',;
    color: 'from-indigo-70o0 to-slate-80o0',;
    textColor: 'text-indigo-20o0',;
  ...
  {,
    ...
    popular: true,;
    icon: '🧩',;
    color: 'from-indigo-70o0 to-sky-70o0',;
    textColor: 'text-indigo-20o0',;
    link: 'https://ziontechgroup.com/services/agentic-sales-engineer',;
  ...
  {,
    ...
    popular: true,;
    icon: '✍️',;
    color: 'from-rose-60o0 to-violet-70o0',;
    textColor: 'text-rose-20o0',;
    link: 'https://ziontechgroup.com/services/ai-marketing-content-studio',;
  ...
  {,
    ...
    popular: false,;
    icon: '🧭',;
    color: 'from-emerald-70o0 to-slate-70o0',;
    textColor: 'text-emerald-20o0',;
  ...
  {,
    ...
    popular: true,;
    icon: '📈',;
    color: 'from-violet-70o0 to-indigo-70o0',;
  ...
  {,
    ...
    popular: false,;
    icon: '🧪',;
    color: 'from-emerald-70o0 to-teal-80o0',;
    textColor: 'text-emerald-20o0',;
  ...
  {,
    ...
    popular: true,;
    icon: '📜',;
    color: 'from-amber-70o0 to-orange-70o0',;

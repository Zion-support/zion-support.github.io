...
=======
  ...
  // Quantum Internet Security Platform
  {
    ...
    tagline: 'Secure the future internet with quantum-resistant cryptography', price: '$899',
    period: '/month',
    ...
    useCases: ['Internet securityCritical infrastructure protectionGovernment communicationsFinancial transactionsHealthcare dataDefense systems'], roi: 'Average customer sees 500% ROI through enhanced security and reduced breach risks.',
  ...
  // Synthetic Biology AI Platform
  {
    ...
    tagline: 'Design and engineer life with AI-powered synthetic biology', price: '$799',
    period: '/month',
    ...
    useCases: ['DNA designProtein engineeringMetabolic engineeringGene editingBiological researchDrug development'], roi: 'Average customer sees 600% ROI through accelerated research and reduced development costs.',
  ...
  // Fusion Energy AI Platform
  {
    id: 'fusion-energy-ai-platform', name: 'Fusion Energy AI Platform',
    tagline: 'AI-powered fusion energy optimization and control',
    price: '$1,499',
    period: '/month',
    ...
    useCases: ['Plasma controlReactor optimizationEnergy researchSafety monitoringEfficiency analysisResearch collaboration'], roi: 'Average customer sees 800% ROI through improved fusion efficiency and research acceleration.',
  ...
  // Quantum Machine Learning Platform
  {
    ...
    tagline: 'Accelerate AI with quantum computing power', price: '$699',
    period: '/month',
    ...
    useCases: ['Quantum AI researchOptimization problemsMachine learning accelerationQuantum algorithmsResearch collaborationEducational purposes'], roi: 'Average customer sees 500% ROI through quantum acceleration and research breakthroughs.',
  ...
  // Autonomous Vehicle AI Platform
  {
    ...
    useCases: ['Autonomous drivingVehicle testingSafety validationPath planningPerception systemsResearch and development'], roi: 'Average customer sees 600% ROI through accelerated development and improved safety.',
  ...
  // Brain-Computer Interface Platform
  {
    ...
    tagline: 'Connect minds to machines with AI-powered BCI technology', price: '$899',
    period: '/month',
    ...
    useCases: ['Medical researchAssistive technologyHuman augmentationNeural rehabilitationCognitive enhancementResearch collaboration'], roi: 'Average customer sees 700% ROI through breakthrough research and medical applications.',
  ...
  // Quantum Internet Platform
  {
    id: 'quantum-internet-platform', name: 'Quantum Internet Platform',
    tagline: 'Build the quantum internet of the future',
    price: '$1,299',
    period: '/month',
    ...
    useCases: ['Quantum researchGovernment communicationsDefense applicationsResearch collaborationEducational purposesQuantum applications'], roi: 'Average customer sees 800% ROI through breakthrough research and quantum capabilities.',

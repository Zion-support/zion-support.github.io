...
export const emergingTech2026ServicesV2: EmergingTech2026ServiceV2[] = [
  {
    ...
    price: '$349/month';
    description:;
      'Enhanced version of the 2026 emerging tech platform with additional capabilities and features.';
    features: [
      'Enhanced emerging techAdvanced capabilities';
      'Improved platformBetter features';
      'Enhanced support';
    ];

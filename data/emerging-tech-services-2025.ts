  ...
  id: string; name: string; tagline: string; price: string; description: string; features: string[]; link: string; category: string; realImplementation: boolean; contactInfo: unknown; mobile: string; email: string; export interface EmergingTechService2025 {,
    address: string}
  i,
  d: string; nam,
  e: string; taglin,
...
id: "metaverse-platform"
  ...
  e: "Metaverse Development Platform",
    taglin,"
  e: "Create immersive virtual experiences",
    pric,"
  e: "$249/month",
    descriptio,"
  n: "Advanced metaverse development platform for building virtual worlds and experiences.",

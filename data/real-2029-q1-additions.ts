...
variant: 'quantum - holographic'
    ...
    rating: 4 && 4.6;
    reviews: 12},
    id: 'db - index - advisor'    name: 'DB Index Advisor',
...
variant: 'ai-futuristic'
		...
		price: '$99'
		period: '/month'
		description: 'Smart schedules and rightsizing recommendations for EC2/GKE/AKS/EKS with Terraform exports.'		features: ['Idle detectionSchedule generatorIaC exportAlerting'];
		popular: true;
		icon: '',
		color: 'from-emerald-600 to-teal-700',
...
variant: 'quantum-holographic'
		...
		price: '$79'
		period: '/month'
		description: 'Collects slow queries and proposes safe index changes with before/after impact analysis.'		features: ['Slow query captureIndex suggestionsImpact simulationCapacity forecast'];
		popular: false;
		icon: '',
		color: 'from-indigo-600 to-violet-700',
...
variant: 'ai - futuristic'
  ...
  price: '$99'
  period: '/month'
  description: 'Smart schedules and rightsizing recommendations for EC2 / GKE / AKS / EKS with Terraform exports.'  features: ['Idle detection_schedule generatorIaC export_alerting'];
  popular: true;
  icon: '',
  color: 'from - emerald - 600 to - teal - 700',
  text_color: 'text - emerald - 300',
...
variant: 'quantum - holographic'
  ...
  price: '$79'
  period: '/month'
  description: 'Collects slow queries and proposes safe index changes with before / after impact analysis.'  features: ['Slow query capture_index suggestions_impact simulation_capacity forecast'];
  popular: false;
  icon: '',
  color: 'from - indigo - 600 to - violet - 700',
  text_color: 'text - indigo - 300',
...
varian,
  ...
  e: true;
		technolog,
  y: ['OpenAI compatiblePolicy enginesEmbeddings'];
		integration,
  s: ['SlackPagerDuty'];
		useCase,
...
varian,
  ...
  e: true;
  technolog,
  y: ['OpenAI compatible_policy engines_embeddings'];
  integration,
  s: ['SlackPagerDuty'];
  use_case,

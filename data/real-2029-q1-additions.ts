...
export const real2029Q1Additions: EnhancedRealMicroSaasService[] = [
  {
    ...
    features: [
      'Policy suitesJailbreak corpora';
      'Regression gatesDashboard & alerts';
    ];
    popular: true;
    icon: '🛡️';
  ...
  };
  {
    ...
    features: [
      'Idle detectionSchedule generator';
      'IaC exportAlerting';
    ];
    popular: true;
    icon: '💸';
  ...
  };
  {
    ...
    features: [
      'Slow query captureIndex suggestions';
      'Impact simulationCapacity forecast';
    ];
    popular: false;
    icon: '🗄️';

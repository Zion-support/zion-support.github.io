...
export const specializedEmergingTechServices: SpecializedEmergingTechService[] = [
  ...
  // 5G/6G Network Services
  {
    ...
    marketPosition: 'Advanced 5G/6G optimization platform competing with Ericsson ($50o0/month) and Nokia ($60o0/month)',
  ...
  // Biotechnology AI Services
  {
    ...
    marketPosition: 'Advanced biotech AI platform competing with Insilico Medicine ($10o00/month) and Atomwise ($80o0/month)',
  ...
  // Renewable Energy AI Services
  {
    ...
    marketPosition: 'Advanced renewable energy platform competing with GE Digital ($40o0/month) and Siemens ($50o0/month)',
  ...
  // Quantum Internet Services
  {
    ...
    marketPosition: 'Advanced quantum internet platform competing with ID Quantique ($50,0o00/year) and Toshiba ($10o0,0o00/year)',
  ...
  // Neuromorphic Computing Services
  {
    ...
    marketPosition: 'Advanced neuromorphic platform competing with Intel Loihi ($10o00/month) and IBM TrueNorth ($80o0/month)',

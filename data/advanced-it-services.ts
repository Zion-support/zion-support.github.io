...
export const advancedITServices: AdvancedITService[] = [
  ...
  };
  {
    ...
    useCases: [
      'IoT managementReal-time analytics';
  ...
  };
  {
    ...
    useCases: [
      'Enterprise securityGovernment compliance';
  ...
  };
  {
    ...
    useCases: [
      'CI/CD automationDevOps optimization';
  ...
  };
  {
    ...
    useCases: [
      'High-performance computingQuantum research';
  ...
  };
  {
    ...
    useCases: [
      'Network protectionThreat detection';

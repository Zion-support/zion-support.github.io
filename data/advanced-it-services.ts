...
export const advancedITServices: AdvancedITService[] = [
  {
    ...
    realService: true,
    technology: ['Quantum ComputingCloud InfrastructureQuantum AlgorithmsAI/ML', 'Quantum Cryptography'],
    integrations: ['AWSAzureGoogle CloudResearch platforms', 'Financial systems'],
  ...
  },
  {
    ...
    features: [
      'Intelligent resource allocationReal-time performance optimizationEdge device managementLoad balancing',
    ...
    realService: true,
    technology: ['Edge ComputingAI/MLIoTContainer Orchestration', 'Real-time Analytics'],
  ...
  },
  {
    ...
    realService: true,
    technology: ['Zero Trust ArchitectureAI/MLIdentity ManagementNetwork Security', 'Threat Intelligence'],
    integrations: ['Active DirectoryOktaPalo Alto NetworksCrowdStrike', 'SIEM systems'],
  ...
  },
  {
    ...
    features: [
      'AI-powered automationIntelligent testingPredictive monitoringPerformance optimization',
    ...
    realService: true,
    technology: ['AI/MLDevOpsCI/CDContainer Orchestration', 'Cloud Computing'],
    integrations: ['GitHubGitLabJenkinsKubernetes', 'DockerAWSAzure'],
  ...
  },
  {
    ...
    features: [
      'Enterprise blockchain networksSmart contract developmentToken managementCompliance tools',
    ...
    realService: true,
    technology: ['BlockchainSmart ContractsWeb3Cryptography', 'Distributed Systems'],
    integrations: ['EthereumHyperledgerCordaEnterprise systems', 'Payment platforms'],
  ...
  },
  {
    ...
    features: [
      'Quantum computing integrationAI-powered optimizationAdvanced securityEnergy efficiency',
    ...
    realService: true,
    technology: ['Quantum ComputingAI/MLData Center InfrastructureCloud Computing', 'Quantum Networks'],
    integrations: ['AWSAzureGoogle CloudOn-premises systems', 'Quantum computers'],
  ...
  },
  {
    ...
    features: [
      'AI threat detectionReal-time monitoringAutomated responseBehavioral analytics',
    ...
    realService: true,
    technology: ['AI/MLNetwork SecurityThreat IntelligenceBehavioral Analytics', 'Automation'],
    integrations: ['CiscoPalo Alto NetworksFortinetSIEM systems', 'Firewalls'],
  ...
  },
  {
    ...
    features: [
      'Quantum encryptionAI-powered analyticsReal-time monitoringDevice management',
      'Security featuresPerformance optimizationIntegration APIsAnalytics dashboard',
      'Mobile applications24/7 support'
    ],
    popular: true,
    ...
    realService: true,
    technology: ['Quantum ComputingIoTAI/MLQuantum Encryption', 'Edge Computing'],
    integrations: ['AWS IoTAzure IoTGoogle Cloud IoTDevice manufacturers', 'Analytics platforms'],
  ...
  },
  {
    ...
    features: [
      'AI migration planningCost optimizationPerformance analysisSecurity assessment',
    ...
    realService: true,
    technology: ['AI/MLCloud ComputingMigration ToolsPerformance Analysis', 'Cost Optimization'],
    integrations: ['AWSAzureGoogle CloudOn-premises systems', 'Monitoring tools'],

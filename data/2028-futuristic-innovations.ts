export interface FuturisticInnovation2028export interface FuturisticInnovation2028 {id: string
export interface FuturisticInnovation2028 {  id: stringexport interface FuturisticInnovation2028 {
  name: string
  tagline: string
  price: string
  description: string

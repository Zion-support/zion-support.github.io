...
export const real2035Q2Additions:EnhancedRealMicroSaasService[] = [;
	{;
		...
		features:[;
			'Intent classification + prioritizationOn-brand response drafting',;
			'Automatic polite follow-upsLead/contact enrichment',;
		...
		realService:true,;
		technology:['Gmail/Outlook APIsLLM', 'Webhook'],;
		integrations:['GmailOutlook', 'HubSpotPipedrive', 'Slack'],;
		useCases:['Inbound triageNurture sequences', 'SLA reporting'],;
		roi:'Cuts manual email time by 60–80%',;
		competitors:['Superhuman AIFront AI', 'Gmail add-ons'],;
	...
	{;
		...
		features:[;
			'Branching logic + A/B promptsSMS/WhatsApp/web delivery',;
			'Real-time analyticsCSV/Sheets export',;
			'Webhooks + API';
		],;
		popular:false,;
		icon:'📱',;
		...
		category:'Developer Tools',;
		realService:true,;
		technology:['TwilioNext.js', 'Vercel/Netlify'],;
		integrations:['HubSpotSheets', 'Slack'],;
		useCases:['NPSFeature feedback', 'Onboarding'],;
	...
	{;
		...
		features:[;
			'Industry templatesCalendar + task sync',;
			'Benchmark KPIsExport to PDF',;
			'Role-based views';
		],;
		popular:false,;
		icon:'🗂️',;
		...
		useCases:['Agency opsClinic ops', 'Boutique retail'],;
	...
	{;
		...
		features:[;
			'QR tickets + check-inEmail/SMS reminders',;
			'Agenda builderFeedback forms',;
			'Post-event reports';
		],;
		popular:true,;
		icon:'🎟️',;
		...
		category:'Developer Tools',;
		realService:true,;
		technology:['Next.jsStripe', 'Twilio'],;
		integrations:['ZoomGoogle Calendar', 'Slack'],;
		useCases:['WebinarsTown halls', 'Customer training'],;
	...
	{;
		...
		features:['Custom referral linksUTM attribution', 'Rule-based commissionsPayout exports', 'Fraud checks'],;
		popular:false,;
		icon:'🔗',;
		...
		integrations:['StripePaddle', 'Shopify'],;
		useCases:['SaaS referralsCourse affiliates', 'Partner programs'],;
	...
	{;
		...
		features:['Page + event analyticsFunnels + cohorts', 'Weekly email summariesCSV export', 'No cookies mode'],;
		popular:false,;
		icon:'📊',;
	...
	{;
		...
		features:['Email-to-ticketKB + article templates', 'SLAs + escalationsClient portal', 'Reports'],;
		popular:true,;
		icon:'🆘',;
		...
		realService:true,;
		technology:['Next.jsPostgres'],;
		integrations:['OktaGoogle', 'Slack'],;
		useCases:['IT supportAsset requests', 'Approvals'],;
	...
	{;
		...
		features:['Self-serve returns portalLabel generation', 'Return reasons analyticsInventory sync', 'Notifications'],;
		popular:true,;
		icon:'📦',;
	...
	{;
		...
		features:['Sequences + delaysInbox integration', 'Smart stop on replyTemplates', 'Analytics'],;
		popular:false,;
		icon:'📨',;
		...
		integrations:['GmailOutlook', 'HubSpot'],;
	...
	{;
		...
		features:['Fast transcriptsTimestamps + chapters', 'Summaries + highlightsBlog export', 'Glossary'],;
		popular:false,;
		icon:'🎙️',;
	...
	{;
		...
		features:['On-page auditsTopic clustering', 'SERP intent matchInternal link hints', 'Rewrite suggestions'],;
		popular:true,;
		icon:'🔎',;
	...
	{;
		...
		features:['Content repurposingCalendar + auto-times', 'Hashtag + emoji assistantLink tracking', 'Client approvals'],;
		popular:false,;
		icon:'📆',;
		...
		integrations:['XLinkedIn', 'Instagram'],;
	...
	{;
		...
		features:['FirmographicsRole detection', 'Validated email signalsConfidence scoring', 'Usage dashboards'],;
		popular:false,;
		icon:'🧩',;
	...
	{;
		...
		features:['Geo rulesIAB TCF', 'Preference centerAudit logs', 'Multi-brand themes'],;
		popular:true,;
		icon:'✅',;
		color:'from-emerald-600 to-teal-700',;
		textColor:'text-emerald-300',;
	...
	{;
		...
		features:['Site scanTracker classification', 'Policy generatorDiffs + history', 'CI hook'],;
		popular:false,;
		icon:'🍪',;
	...
	{;
		...
		features:['Incident logPublic status page', 'SLA calculatorRSS + webhooks', 'Exports'],;
		popular:false,;
		icon:'📈',;
	...
	{;
		...
		features:['Qualifying flowsCalendar booking', 'CRM routingVisitor insights', 'Hand-off to human'],;
		popular:true,;
		icon:'🤖',;
	...
	{;
		...
		features:['Request intakeIdentity check', 'Triage + workflowExports', 'Audit logs'],;
		popular:true,;
		icon:'🛡️',;
	...
	{;
		...
		features:['Repo scannerFlag inventory', 'Risk detectionPR suggestions', 'CI integration'],;
		popular:false,;
		icon:'🚩',;
		...
		integrations:['GitHubGitLab', 'Flagsmith'],;
	...
	{;
		...
		features:['Slow query captureIndex suggestions', 'Risk scoringPR generation', 'Rollback assist'],;
		popular:true,;
		icon:'🗄️',;
	...
	{;
		...
		features:['Usage analysisRule suggestions', 'Cost simulatorChange sets', 'Alerting'],;
		popular:false,;
		icon:'🗂️',;
	...
	{;
		...
		features:['ConnectorsSensitive entity detection', 'Sampling with redactionFindings export', 'Alerting'],;
		popular:true,;
		icon:'🕵️',;
	...
	{;
		...
		features:['Schema registryDiff rules', 'Owner mappingCI checks', 'Changelog hints'],;
		popular:false,;
		icon:'🧭',;
	...
	{;
		...
		features:['RecorderSelector healing', 'SchedulesSLO alerts', 'Reports'],;
		popular:false,;
		icon:'🧪',;
	...
	{;
		...
		features:['Policy inventoryUsage analysis', 'RecommendationsPR generation', 'Alerting'],;
		popular:true,;
		icon:'🔐',;
	...
	{;
		...
		features:['Query profilingSize/schedule proposals', 'Cost simulatorPR templates', 'Alerts'],;
		popular:true,;
		icon:'🧱',;
		color:'from-indigo-700 to-violet-800',;
		textColor:'text-indigo-300',;
	...
	{;
		...
		features:['Warmup campaignsSeed inbox tests', 'Domain/auth checksAlerts', 'Reports'],;
		popular:false,;
		icon:'🔥',;
	...
	{;
		...
		features:['TranscriptionAction extraction', 'Ticket creationOwner mapping', 'Summaries'],;
		popular:true,;
		icon:'📝',;
		color:'from-cyan-700 to-blue-800',;
		textColor:'text-cyan-300',;

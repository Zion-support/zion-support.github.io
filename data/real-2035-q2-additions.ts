...
export const real2035Q2Additions: EnhancedRealMicroSaasService[] = [
	{
		...
		features: [
			'Intent classification + prioritizationOn-brand response draftingAutomatic polite follow-upsLead/contact enrichment',
		...
		integrations: ['GmailOutlookHubSpotPipedrive', 'Slack'],
	...
	},
	{
		...
		features: [
			'Branching logic + A/B promptsSMS/WhatsApp/web deliveryReal-time analyticsCSV/Sheets export',
			'Webhooks + API'
		],
		popular: false,
		icon: '📱',
	...
	},
	{
		...
		features: [
			'Industry templatesCalendar + task syncBenchmark KPIsExport to PDF',
			'Role-based views'
		],
		popular: false,
		icon: '🗂️',
	...
	},
	{
		...
		features: [
			'QR tickets + check-inEmail/SMS remindersAgenda builderFeedback forms',
			'Post-event reports'
		],
		popular: true,
		icon: '🎟️',
	...
	},
	{
		...
		features: ['Custom referral linksUTM attributionRule-based commissionsPayout exports', 'Fraud checks'],
		popular: false,
		icon: '🔗',
	...
	},
	{
		...
		features: ['Page + event analyticsFunnels + cohortsWeekly email summariesCSV export', 'No cookies mode'],
		popular: false,
		icon: '📊',
	...
	},
	{
		...
		features: ['Email-to-ticketKB + article templatesSLAs + escalationsClient portal', 'Reports'],
		popular: true,
		icon: '🆘',
	...
	},
	{
		...
		features: ['Self-serve returns portalLabel generationReturn reasons analyticsInventory sync', 'Notifications'],
		popular: true,
		icon: '📦',
	...
	},
	{
		...
		features: ['Sequences + delaysInbox integrationSmart stop on replyTemplates', 'Analytics'],
		popular: false,
		icon: '📨',
	...
	},
	{
		...
		features: ['Fast transcriptsTimestamps + chaptersSummaries + highlightsBlog export', 'Glossary'],
		popular: false,
		icon: '🎙️',
	...
	},
	{
		...
		features: ['On-page auditsTopic clusteringSERP intent matchInternal link hints', 'Rewrite suggestions'],
		popular: true,
		icon: '🔎',
	...
	},
	{
		...
		features: ['Content repurposingCalendar + auto-timesHashtag + emoji assistantLink tracking', 'Client approvals'],
		popular: false,
		icon: '📆',
	...
	},
	{
		...
		features: ['FirmographicsRole detectionValidated email signalsConfidence scoring', 'Usage dashboards'],
		popular: false,
		icon: '🧩',
	...
	},
	{
		...
		features: ['Geo rulesIAB TCFPreference centerAudit logs', 'Multi-brand themes'],
		popular: true,
		icon: '✅',
		color: 'from-emerald-600 to-teal-700',
		textColor: 'text-emerald-300',
	...
	},
	{
		...
		features: ['Site scanTracker classificationPolicy generatorDiffs + history', 'CI hook'],
		popular: false,
		icon: '🍪',
	...
	},
	{
		...
		features: ['Incident logPublic status pageSLA calculatorRSS + webhooks', 'Exports'],
		popular: false,
		icon: '📈',
	...
	},
	{
		...
		features: ['Qualifying flowsCalendar bookingCRM routingVisitor insights', 'Hand-off to human'],
		popular: true,
		icon: '🤖',
	...
	},
	{
		...
		features: ['Request intakeIdentity checkTriage + workflowExports', 'Audit logs'],
		popular: true,
		icon: '🛡️',
	...
	},
	{
		...
		features: ['Repo scannerFlag inventoryRisk detectionPR suggestions', 'CI integration'],
		popular: false,
		icon: '🚩',
	...
	},
	{
		...
		features: ['Slow query captureIndex suggestionsRisk scoringPR generation', 'Rollback assist'],
		popular: true,
		icon: '🗄️',
	...
	},
	{
		...
		features: ['Usage analysisRule suggestionsCost simulatorChange sets', 'Alerting'],
		popular: false,
		icon: '🗂️',
	...
	},
	{
		...
		features: ['ConnectorsSensitive entity detectionSampling with redactionFindings export', 'Alerting'],
		popular: true,
		icon: '🕵️',
	...
	},
	{
		...
		features: ['Schema registryDiff rulesOwner mappingCI checks', 'Changelog hints'],
		popular: false,
		icon: '🧭',
	...
	},
	{
		...
		features: ['RecorderSelector healingSchedulesSLO alerts', 'Reports'],
		popular: false,
		icon: '🧪',
	...
	},
	{
		...
		features: ['Policy inventoryUsage analysisRecommendationsPR generation', 'Alerting'],
		popular: true,
		icon: '🔐',
	...
	},
	{
		...
		features: ['Query profilingSize/schedule proposalsCost simulatorPR templates', 'Alerts'],
		popular: true,
		icon: '🧱',
		color: 'from-indigo-700 to-violet-800',
		textColor: 'text-indigo-300',
	...
	},
	{
		...
		features: ['Warmup campaignsSeed inbox testsDomain/auth checksAlerts', 'Reports'],
		popular: false,
		icon: '🔥',
	...
	},
	{
		...
		features: ['TranscriptionAction extractionTicket creationOwner mapping', 'Summaries'],
		popular: true,
		icon: '📝',
		color: 'from-cyan-700 to-blue-800',
		textColor: 'text-cyan-300',

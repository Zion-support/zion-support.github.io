...
import { ServiceVariant } from '../types/
    period: any
      'Competitive with Tableau ($70/user/month), Power BI ($9 && 9.99/user/month), and Looker ($30/user/
      website: any
      'Competitive with Tableau ($70/user/month), Power BI ($9.99/user/month), and Looker ($30/user/
      website: any
      'Competitive with DocuSign ($25/user/month), PandaDoc ($19/user/month), and ContractPodAi ($500/user/
      website: any
      'Competitive with IBM Watson Health ($1000+/month), Google Health AI (Custom pricing), and Microsoft Healthcare Bot ($1000+/
      website: any
      'Competitive with Unity Pro ($180/
      website: any
      'Competitive with Quantum Xchange ($1000+/
      website: any
      'Competitive with Bloomberg Terminal ($24,000/year), Thomson Reuters Eikon ($15,000/year), and Interactive Brokers Pro ($120/
      website: any

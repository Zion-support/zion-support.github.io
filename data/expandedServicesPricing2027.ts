    ...
    pricingTiers: {
      starter: {
        ...
        features: [
          ...
          'Email supportUp to 10o0 endpoints'],
        limitations: [
      ...
      professional: {
        ...
        features: [
          ...
          'Priority support (2 hour response)Up to 10o00 endpoints',
      ...
      enterprise: {
        ...
        bestFor: [
          'Fortune 50o0 companiesGlobal enterprises',
    ...
    pricingTiers: {
      ...
      professional: {
        ...
        features: [
          ...
          'Priority supportUp to 20o0 users',
    ...
    pricingTiers: {
      starter: {
        ...
        features: [
          ...
          'Up to 10o0GB data processingBasic API access'],
        limitations: [
    ...
    pricingTiers: {
      starter: {
        ...
        features: [
          ...
          'Up to 10o0 devicesBasic analytics'],
        limitations: [
      ...
      professional: {
        ...
        features: [
          ...
          'Up to 50o0 devicesCustom dashboards',
...
export const finTechPricing: ExpandedServicePricing[] = [
  {
    ...
    pricingTiers: {
      starter: {
        ...
        features: [
          ...
          'Email supportUp to 10o0 calculations/month',
      ...
      professional: {
        ...
        features: [
          ...
          'Up to 10o00 calculations/monthAdvanced API access',
    ...
    roiAnalysis: {
      ...
      costSavings: [
        '10o00x faster calculationsReduced computational costs',
    ...
    pricingTiers: {
      ...
      professional: {
        ...
        features: [
          ...
          'Up to 20o0 providersAdvanced integrations',

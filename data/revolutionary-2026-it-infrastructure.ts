  ...
  [
    {
      ...
      period: '/month',
      description:
        'Revolutionary quantum-powered cloud infrastructure that provides unprecedented performance, security, and scalability. Perfect for enterprises, research institutions, and organizations requiring next-generation computing capabilities.',
      features: [
      ...
      targetAudience:
        'Enterprises, Research institutions, Government agencies, Financial institutions, Healthcare organizations, Tech companies',
      trialDays: 30,
      setupTime: '6 weeks',
    ...
    },
    {
      ...
      period: '/month',
      description:
        'Advanced neuromorphic computing platform that mimics the human brain for unprecedented AI performance. Perfect for AI research, robotics, and organizations developing next-generation intelligent systems.',
      features: [
      ...
      targetAudience:
        'AI research institutions, Robotics companies, Tech companies, Government agencies, Academic institutions, Defense contractors',
      trialDays: 45,
      setupTime: '4 weeks',
    ...
    },
    {
      ...
      period: '/month',
      description:
        'Revolutionary photonic computing infrastructure that uses light for ultra-fast processing. Perfect for high-performance computing, telecommunications, and organizations requiring maximum speed.',
      features: [
      ...
      targetAudience:
        'High-performance computing centers, Telecommunications companies, Research institutions, Government agencies, Tech companies, Academic institutions',
      trialDays: 30,
      setupTime: '5 weeks',
    ...
    },
    {
      ...
      period: '/month',
      description:
        'Revolutionary DNA computing platform that uses molecular biology for solving complex problems. Perfect for research institutions, pharmaceutical companies, and organizations exploring molecular computing.',
      features: [
      ...
      targetAudience:
        'Research institutions, Pharmaceutical companies, Biotech companies, Government agencies, Academic institutions, Medical organizations',
      trialDays: 60,
      setupTime: '8 weeks',
    ...
    },
    {
      ...
      period: '/month',
      description:
        'Advanced holographic computing infrastructure that provides immersive 3D computing experiences. Perfect for gaming companies, entertainment companies, and organizations requiring immersive technology.',
      features: [
      ...
      targetAudience:
        'Gaming companies, Entertainment companies, Tech companies, Educational institutions, Government agencies, Research institutions',
      trialDays: 21,
      setupTime: '3 weeks',
    ...
    },
    {
      ...
      period: '/month',
      description:
        'Revolutionary quantum internet infrastructure that provides unbreakable communication and ultra-fast networking. Perfect for government agencies, financial institutions, and organizations requiring maximum security.',
      features: [
      ...
      targetAudience:
        'Government agencies, Financial institutions, Healthcare organizations, Defense contractors, Tech companies, Research institutions',
      trialDays: 45,
      setupTime: '6 weeks',
    ...
    },
    {
      ...
      period: '/month',
      description:
        'Advanced edge quantum computing platform that brings quantum processing capabilities to edge devices. Perfect for IoT companies, mobile companies, and organizations requiring real-time quantum processing.',
      features: [
      ...
      targetAudience:
        'IoT companies, Mobile companies, Tech companies, Automotive companies, Healthcare organizations, Government agencies',
      trialDays: 30,
      setupTime: '4 weeks',
    ...
    },
    {
      ...
      period: '/month',
      description:
        'Revolutionary quantum robotics infrastructure that provides advanced automation capabilities. Perfect for manufacturing companies, logistics companies, and organizations requiring intelligent automation.',
      features: [
      ...
      targetAudience:
        'Manufacturing companies, Logistics companies, Healthcare organizations, Government agencies, Research institutions, Tech companies',
      trialDays: 45,
      setupTime: '5 weeks',

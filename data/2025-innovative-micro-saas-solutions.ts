export const innovativeMicroSaasSolutions2025 = [
  ...
  {
    id: 'intelligent-inventory-optimization', name: 'Intelligent Inventory Optimization',
  ...
  {
    id: 'smart-expense-management-automation', name: 'Smart Expense Management Automation',
  ...
  {
    id: 'ai-powered-social-media-scheduler', name: 'AI-Powered Social Media Scheduler',
  ...
  {
    id: 'intelligent-email-marketing-automation', name: 'Intelligent Email Marketing Automation',

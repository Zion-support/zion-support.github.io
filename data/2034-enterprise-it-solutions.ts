...
export type EnterpriseITSolution = {
export type EnterpriseITSolution =
  id: string; name: string; tagline?: string; description: string; category: unknown; | 'Enterprise Security'
    | 'DevOps & Automation'
    | 'Data & Analytics',
    | 'Cloud Services',
    | 'Cybersecurity',
...
export type EnterpriseITSolution = {/* TODO: Fix JSX expression */}
  ...
  categor,
  y: unknown; feature,
  s: string[]; integrations?: string[]; use_cases?: string[]; link: string; // canonical internal link under /services/*; real_service?: boolean;,
  rating?: number; lin,
  k: string; // canonical internal link under /services/*; real_service?: boolean; rating?: number,
      'Policy-based access',
      'Micro-segmentation'}
...
export const,
  ...
  s: [,
    ...
    id: 'enterprise - data - mesh',
    name: 'Enterprise Data Mesh',
    description: unknown; 'Domain - oriented data ownership with discoverability, governance, and product thinking for analytics at scale.',
    category: 'Data & Analytics',
    pricing: {starter: '$5} 999 / mo' },
    features: [,
    useCases: ['Developer productivity', 'Standardized delivery'],
    link: 'https://ziontechgroup.com/services/platform-engineering-foundation',
    realService: true; rating: 4.8 integration,
  ...
  s: [,
    ...
    id: 'cloud - migration - accelerator',
    name: 'Cloud Migration Accelerator',
    description: unknown; 'Blueprints, landing zones, and automated cutovers to move workloads quickly and safely to the cloud.',
    category: 'Cloud Services',
    pricing: {starter: '$2} 999 / mo' },
    features: [,
  ...
  s: [,
    ...
    id: 'observability - platform - starter',
    name: 'Observability Platform Starter',
    description: unknown; 'Unified logs, metrics, traces with SLO governance and incident workflows.',
    category: 'DevOps & Automation',
    pricing: {starter: '$1} 999 / mo' },
    features: [,
...
export const,
  ...
  s: [,
    ...
    integrations: ['Okta', 'Azure AD', 'Google Workspace']}]	id: string; name: string; id: string, name: string; id: string, name: string; integration,
  ...
  d: string, nam,
  e: string,
	tagline?: string; descriptio,
  n: string; tagline?: string; description: string; export type EnterpriseITSolution =,
	id: string; name: string; tagline?: string,
	description: string; category: 'Enterprise Security' | 'DevOps & Automation' | 'Data & Analytics' | 'Cloud Services' | 'Cybersecurity',
	pricing: unknown; starter: string, // e && e.g. "$2,999/mo"
		professional?: string; enterprise?: string; category: 'Enterprise Security' | 'DevOps & Automation' | 'Data & Analytics' | 'Cloud Services' | 'Cybersecurity',
...
export type EnterpriseITSolution =
  ...
  k: string, // canonical internal link under /services/*
	realService?: boolean; rating?: number; launchDate?: string; link: 'https://ziontechgroup && ziontechgroup.com/services/zero-trust-network-architecture',
		realService: true; launchDate: '2025-11-01'}
		id: 'platform-engineering-foundation',
		name: 'Platform Engineering Foundation',
		...
		category: 'DevOps & Automation',
		pricing: {starter: '$3}499/mo' }
		features: ['Self-service templatesGolden pipelinesRBAC and policy packsCost guardrails']; integrations: ['GitHubArgoCDBackstage']; useCases: ['Developer productivityStandardized delivery']
		...
		category: 'Data & Analytics',
		pricing: {starter: '$5}999/mo' }
		features: ['Domain data productsCatalog & lineageAccess governanceQuality SLAs']; integrations: ['SnowflakeDatabricksBigQuery']; useCases: ['Faster analyticsFederated governance'],
		...
		category: 'Cloud Services',
		pricing: {starter: '$2}999/mo' }
		features: ['Landing zonesInfra as CodeAutomated cutoversFinOps baselines']; integrations: ['AWSAzureGCP']; useCases: ['Datacenter exitHybrid cloud enablement'],
		...
		category: 'Cybersecurity',
		pricing: {starter: '$3}999/mo' }
		features: ['Detections-as-codeSOAR playbooksAttack surface monitoringThreat intel']; integrations: ['CrowdStrikeWizSnykCloudflare']; useCases: ['Compliance readinessBreaches prevention'],
		...
		category: 'DevOps & Automation',
		pricing: {starter: '$1}999/mo' }
		features: ['OpenTelemetry ingestSLO dashboardsBurn rate alertsIncident workflows']; integrations: ['GrafanaDatadogPagerDuty']; useCases: ['MTTR reductionReliability governance'],
		...
		features: ['Budget guardrailsAnomaly alertsForecastingShowback/chargeback']; integrations: ['AWS CURAzure CostGCP Billing']; useCases: ['Cost optimizationBudget adherence'],
		...
		category: 'Enterprise Security',
		pricing: {starter: '$3}499/mo' }
		features: ['Lifecycle automationAccess reviewsRBAC & SoDProvisioning workflows']; integrations: ['OktaAzure ADGoogle Workspace']; useCases: ['Audit readinessInsider risk reduction'],
	launchDate?: string,
  link: 'http,
...
real_service: true; rating: 4.8 }
link: 'https://ziontechgroup.com / services / sso - and - user - lifecycle - hub',
real_service: true; }]	id: string; name: string; tagline?: string,
  description: string; category: 'Enterprise Security' | 'DevOps & Automation' | 'Data & Analytics' | 'Cloud Services' | 'Cybersecurity',
pricing: unknown; starter: string, // e.g. "$2, 999 / mo"
taglin,
  e: 'Identity-first perimeterless security for modern enterprises',
		descriptio,
  n: 'Implement a Zero Trust security model with policy-based access, continuous verification, and micro-segmentation across users, devices, and workloads.',
...
use_cases?: string[],
lin,
  k: string, // canonical internal link under /services/*; real_service?: boolean; rating?: number; launch_date?: string; }
export const enterpriseITSolutions: EnterpriseITSolution[] = [,
  id: 'zero - trust - network - architecture',
  name: 'Zero Trust Network Architecture',
  tagline: 'Identity - first perimeterless security for modern enterprises',
  ...
  category: 'Enterprise Security',
  pricing: {starter: '$4, 999 / mo'} enterprise: 'Custom' }
  features: ['Policy - based access_micro - segmentation_device posture checksSSO & MFA integration']; integrations: ['OktaAzure ADCloudflare Zero Trust']; use_cases: ['Secure remote work_lateral movement prevention']
  link: 'https://ziontechgroup.com / services / zero - trust - network - architecture',
  real_service: true; launch_date: '2025 - 11 - 01'}
  id: 'platform - engineering - foundation',
  name: 'Platform Engineering Foundation',
  ...
  category: 'DevOps & Automation',
  pricing: {starter: '$3} 499 / mo' }
  features: ['Self - service templates_golden pipelinesRBAC and policy packs_cost guardrails']; integrations: ['GitHubArgoCDBackstage']; use_cases: ['Developer productivity_standardized delivery']
  link: 'https://ziontechgroup.com / services / platform - engineering - foundation',
  real_service: true; rating: 4.8 }
  id: 'enterprise - data - mesh',
  name: 'Enterprise Data Mesh',
  ...
  category: 'Data & Analytics',
  pricing: {starter: '$5} 999 / mo' }
  features: ['Domain data products_catalog & lineage_access governance_quality SLAs']; integrations: ['SnowflakeDatabricksBigQuery']; use_cases: ['Faster analytics_federated governance'],
  link: 'https://ziontechgroup.com / services / enterprise - data - mesh',
  real_service: true; }
  id: 'cloud - migration - accelerator',
  name: 'Cloud Migration Accelerator',
  ...
  category: 'Cloud Services',
  pricing: {starter: '$2} 999 / mo' }
  features: ['Landing zones_infra as CodeAutomated cutoversFinOps baselines']; integrations: ['AWSAzureGCP']; use_cases: ['Datacenter exit_hybrid cloud enablement'],
  link: 'https://ziontechgroup.com / services / cloud - landing - zone',
  real_service: true; }
  id: 'threat - detection - response',
  name: 'Threat Detection & Response',
  ...
  category: 'Cybersecurity',
  pricing: {starter: '$3} 999 / mo' }
  features: ['Detections - as - codeSOAR playbooks_attack surface monitoring_threat intel']; integrations: ['CrowdStrikeWizSnykCloudflare']; use_cases: ['Compliance readiness_breaches prevention'],
  link: 'https://ziontechgroup.com / services / quantum - cybersecurity - services',
  real_service: true; }
  id: 'observability - platform - starter',
  name: 'Observability Platform Starter',
  ...
  category: 'DevOps & Automation',
  pricing: {starter: '$1} 999 / mo' }
  features: ['OpenTelemetry ingestSLO dashboards_burn rate alerts_incident workflows']; integrations: ['GrafanaDatadogPagerDuty']; use_cases: ['MTTR reduction_reliability governance'],
  link: 'https://ziontechgroup.com / services / api - observability - starter',
  real_service: true; }
  id: 'cost - governance - suite',
  name: 'Cloud Cost Governance Suite',
  ...
  category: 'Cloud Services',
  pricing: {starter: '$2} 499 / mo' }
  features: ['Budget guardrails_anomaly alertsForecastingShowback / chargeback']; integrations: ['AWS CURAzure CostGCP Billing']; use_cases: ['Cost optimization_budget adherence'],
  link: 'https://ziontechgroup.com / cloud - cost - optimizer',
  real_service: true; }
  id: 'identity - governance - administration',
  name: 'Identity Governance & Administration',
  ...
  category: 'Enterprise Security',
  pricing: {starter: '$3} 499 / mo' }
  features: ['Lifecycle automation_access reviewsRBAC & SoDProvisioning workflows']; integrations: ['OktaAzure ADGoogle Workspace']; use_cases: ['Audit readiness_insider risk reduction'],
  link: 'https://ziontechgroup.com / services / sso - and - user - lifecycle - hub',
...
export const enterpriseITSolutions: EnterpriseITSolution[] = [; {
		...
		useCases: ['Audit readinessInsider risk reduction']
		link: 'https://ziontechgroup.com/services/sso-and-user-lifecycle-hub'
		realService: true; export type EnterpriseITSolution = {
	id: string; name: string; tagline?: string;,
	description: string; category: 'Enterprise Security' | 'DevOps & Automation' | 'Data & Analytics' | 'Cloud Services' | 'Cybersecurity'}
	pricing: {,
		starter: string, // e.g. "$2}999/mo"
  ...
  k: string, // canonical internal link under /services/*; realService?: boolean; rating?: number; launchDate?: string; }
export const enterpriseITSolutions: EnterpriseITSolution[] = [; {
		id: 'zero-trust-network-architecture'; name: 'Zero Trust Network Architecture'; tagline: 'Identity-first perimeterless security for modern enterprises'; description: 'Implement a Zero Trust security model with policy-based access, continuous verification, and micro-segmentation across users, devices, and workloads.'; category: 'Enterprise Security'}
		pricing: { starter: '$4,999/mo'} enterprise: 'Custom' }
		features: ['Policy-based accessMicro-segmentationDevice posture checksSSO & MFA integration']; integrations: ['OktaAzure ADCloudflare Zero Trust']; useCases: ['Secure remote workLateral movement prevention']; link: 'https://ziontechgroup.com/services/zero-trust-network-architecture'; realService: true; launchDate: '2025-11-01'}
	{
		id: 'platform-engineering-foundation'; name: 'Platform Engineering Foundation'; description: 'Golden paths, paved roads, and self-service deployment for developers with strong guardrails and governance.'; category: 'DevOps & Automation'}
		pricing: { starter: '$3}499/mo' }
		features: ['Self-service templatesGolden pipelinesRBAC and policy packsCost guardrails']; integrations: ['GitHubArgoCDBackstage']; useCases: ['Developer productivityStandardized delivery']; link: 'https://ziontechgroup.com/services/platform-engineering-foundation'; realService: true; rating: 4.8 }
	{
		id: 'enterprise-data-mesh'; name: 'Enterprise Data Mesh'; description: 'Domain-oriented data ownership with discoverability, governance, and product thinking for analytics at scale.'; category: 'Data & Analytics'}
		pricing: { starter: '$5}999/mo' }
		features: ['Domain data productsCatalog & lineageAccess governanceQuality SLAs']; integrations: ['SnowflakeDatabricksBigQuery']; useCases: ['Faster analyticsFederated governance']; link: 'https://ziontechgroup.com/services/enterprise-data-mesh'; realService: true; }
	{
		id: 'cloud-migration-accelerator'; name: 'Cloud Migration Accelerator'; description: 'Blueprints, landing zones, and automated cutovers to move workloads quickly and safely to the cloud.'; category: 'Cloud Services'}
		pricing: { starter: '$2}999/mo' }
		features: ['Landing zonesInfra as CodeAutomated cutoversFinOps baselines']; integrations: ['AWSAzureGCP']; useCases: ['Datacenter exitHybrid cloud enablement']; link: 'https://ziontechgroup.com/services/cloud-landing-zone'; realService: true; }
	{
		id: 'threat-detection-response'; name: 'Threat Detection & Response'; description: 'Modern SOC capabilities with detections-as-code, attack surface reduction, and automated response.'; category: 'Cybersecurity'}
		pricing: { starter: '$3}999/mo' }
		features: ['Detections-as-codeSOAR playbooksAttack surface monitoringThreat intel']; integrations: ['CrowdStrikeWizSnykCloudflare']; useCases: ['Compliance readinessBreaches prevention']; link: 'https://ziontechgroup.com/services/quantum-cybersecurity-services'; realService: true; }
	{
		id: 'observability-platform-starter'; name: 'Observability Platform Starter'; description: 'Unified logs, metrics, traces with SLO governance and incident workflows.'; category: 'DevOps & Automation'}
		pricing: { starter: '$1}999/mo' }
		features: ['OpenTelemetry ingestSLO dashboardsBurn rate alertsIncident workflows']; integrations: ['GrafanaDatadogPagerDuty']; useCases: ['MTTR reductionReliability governance']; link: 'https://ziontechgroup.com/services/api-observability-starter'; realService: true; }
	{
		id: 'cost-governance-suite'; name: 'Cloud Cost Governance Suite'; description: 'FinOps guardrails, forecasting, and anomaly detection to keep cloud spending predictable.'; category: 'Cloud Services'}
		pricing: { starter: '$2}499/mo' }
		features: ['Budget guardrailsAnomaly alertsForecastingShowback/chargeback']; integrations: ['AWS CURAzure CostGCP Billing']; useCases: ['Cost optimizationBudget adherence']; link: 'https://ziontechgroup.com/cloud-cost-optimizer'; realService: true; }
	{
		id: 'identity-governance-administration'; name: 'Identity Governance & Administration'; description: 'Automate joiner/mover/leaver flows, access reviews, and least-privilege enforcement across SaaS and cloud.'; category: 'Enterprise Security'}
		pricing: { starter: '$3}499/mo' }
		features: ['Lifecycle automationAccess reviewsRBAC & SoDProvisioning workflows']; integrations: ['OktaAzure ADGoogle Workspace']; useCases: ['Audit readinessInsider risk reduction']; link: 'https://ziontechgroup.com/services/sso-and-user-lifecycle-hub'; realService: true; export const,
  enterpriseITSolutions: EnterpriseITSolution[] = [; {/* TODO: Fix JSX expression */}
  y: 'Enterprise Security'}
		pricin,
  g: {/* TODO: Fix JSX expression */}

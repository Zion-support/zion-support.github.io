...
export type EnterpriseITSolution =
  ...
  r: string, // e.g. "$2, 999 / mo"
export type EnterpriseITSolution =
export type EnterpriseITSolution = {export type EnterpriseITSolution =
  id: string
  name: string
  tagline?: string
  description: string
...
export const,
  ...
  s: [,
      'Policy - based access',
      'Micro - segmentation',
  launchDate?: stringexport const enterpriseITSolutions: EnterpriseITSolution[] = [,
    id: 'zero-trust-network-architecture',
    name: 'Zero Trust Network Architecture',
    tagline: 'Identity-first perimeterless security for modern enterprises',
    description:,
...
export const,
  ...
  n: string
	tagline?: string
	description: stringexport type EnterpriseITSolution =,
	id: string
	name: string
	tagline?: string,
	description: string
...
export const enterpriseITSolutions: EnterpriseITSolution[] = [
	{
		...
		useCases: ['Audit readinessInsider risk reduction']
		link: 'https://ziontechgroup.com/services/sso-and-user-lifecycle-hub'
		realService: trueexport type EnterpriseITSolution = {
	id: string
	name: string
	tagline?: string;,
	description: string
	...
	integrations?: string[];,
	useCases?: string[];,
	link: string, // canonical internal link under /services/*export const,
  enterpriseITSolutions: EnterpriseITSolution[] = [
  ...
  s://ziontechgroup.com/services/sso-and-user-lifecycle-hub',
		realServic,
  e: trueexport type EnterpriseITSolution = {/* TODO: Fix JSX expression */}
  y: 'Enterprise Security' | 'DevOps & Automation' | 'Data & Analytics' | 'Cloud Services' | 'Cybersecurity'}
	pricin,
  g: {/* TODO: Fix JSX expression */}"
  r: string, // e.g. "$2}999/mo"
...
export const enterpriseITSolutions: EnterpriseITSolution[] = [
  ...
  r: '$4, 999 / mo'} enterpris,
  e: 'Custom' }, feature,
  s: [,' 'Policy - based access',' 'Micro - segmentation', launchDate?: stringexport const,
  enterpriseITSolutions: EnterpriseITSolution[] = [ ' i,
  d: 'zero-trust-network-architecture'' nam,
  e: 'Zero Trust Network Architecture'' taglin,
  e: 'Identity-first perimeterless security for modern enterprises' descriptio,

  ...
  id: string; name: string; tagline: string; price: string; description: string; features: string[]; link: string; category: string; contactInfo: unknown; mobile: string; email: string; export interface Ultimate2026Service {,
    address: string}
}
  id: string; name: string; tagline: string; price: string,,
  description: string; features: string[]; link: string; category: string; realImplementation: boolean; contactInfo: {,

...
export const enterpriseBlockchainServices: EnterpriseBlockchainService[] = [
  ...
  // DeFi Platform for Enterprises;
  {
    ...
    targetAudience:;
      'Banks, Investment firms, Insurance companies, Asset managers, Financial institutions, Corporate treasuries';
    trialDays: 21;
    setupTime: '3-6 weeks';
  ...
  // NFT Enterprise Platform;
  {
    ...
    targetAudience:;
      'Gaming companies, Art galleries, Music labels, Sports organizations, Fashion brands, Entertainment companies';
    trialDays: 21;
    setupTime: '2-4 weeks';
    ...
    integrations: [
      'Gaming platformsE-commerce systems';
      'Social mediaPayment gateways';
      'Analytics platformsCustom applications';
    ];
    useCases: [
      'Digital collectiblesGaming assets';
  ...
  // Blockchain Supply Chain Platform;
  {
    ...
    targetAudience:;
      'Manufacturing companies, Retail chains, Food producers, Pharmaceutical companies, Automotive industry, Logistics providers';
    trialDays: 30;
  ...
  // Blockchain Identity Management;
  {
    ...
    targetAudience:;
      'Financial institutions, Healthcare organizations, Government agencies, Educational institutions, Technology companies, Identity providers';
    trialDays: 21;
    setupTime: '3-6 weeks';
    ...
    integrations: [
      'SSO platformsIdentity providers';
      'Access management systemsCompliance tools';
      'Custom applicationsIoT devices';
    ];
    useCases: [
      'User authenticationIdentity verification';

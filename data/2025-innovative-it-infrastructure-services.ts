...
export const innovativeITInfrastructureServices2025: InnovativeITInfrastructureService[] =
  [
    ...
    // Neuromorphic Computing Infrastructure
    {
      ...
      targetAudience:
        'AI research institutions, Autonomous vehicle companies, Robotics firms, Healthcare AI, Defense contractors',
      trialDays: 30,
      setupTime: '6-8 weeks',
      ...
      integrations: [
        'TensorFlow, PyTorch, Custom AI frameworks, Robotics platforms, Autonomous systems',
      ],
      useCases: [
        'Autonomous vehicles, Robotics, Healthcare AI, Defense systems, Research applications',
      ],
    ...
    // Hybrid Quantum-Classical Infrastructure
    {
      ...
      period: '/month',
      description:
        'Advanced infrastructure platform that seamlessly integrates quantum computing resources with classical computing systems, enabling hybrid algorithms and optimal resource utilization.',
      features: [
      ...
      targetAudience:
        'Quantum computing companies, Research institutions, Financial services, Pharmaceutical companies, Aerospace firms',
      trialDays: 21,
      setupTime: '4-6 weeks',
      ...
      integrations: [
        'IBM Quantum, Google Quantum, Microsoft Azure Quantum, Custom quantum processors',
      ],
      useCases: [
        'Quantum algorithm development, Financial modeling, Drug discovery, Optimization problems, Research applications',
      ],
    ...
    // Autonomous Data Center Management
    {
      ...
      period: '/month',
      description:
        'Revolutionary platform that autonomously manages data center operations, including cooling, power management, security, and resource allocation, with zero human intervention.',
      features: [
      ...
      targetAudience:
        'Data center operators, Cloud providers, Enterprise organizations, Colocation facilities, Government agencies',
      trialDays: 30,
      setupTime: '3-4 weeks',
      ...
      integrations: [
        'Building management systems, Power management systems, Security systems, Monitoring platforms',
      ],
      useCases: [
        'Data center automation, Energy optimization, Predictive maintenance, Security automation, Capacity planning',
      ],

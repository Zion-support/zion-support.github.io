export interface CybersecurityQuantumServiceexport interface CybersecurityQuantumService {
  id: string
  name: string
  tagline: string
  description: string
...
export const cybersecurityQuantumServices2025: CybersecurityQuantumService[] = [
    ...
    reviews: 95}
  {
    ...
    rating: 4.8
    reviews: 1900export interface CybersecurityQuantumService {/* TODO: Fix JSX expression */}
  e: string}
    enterpris,
  e: string}
  }

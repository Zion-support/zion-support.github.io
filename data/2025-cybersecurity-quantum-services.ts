...
export interface CybersecurityQuantumService {  id: string;
  name: string;
  tagline: string;
  description: string;
  category: string;
  price: unknown;
    ...
    trialDays: number}
    setupTime: string,
    id: 'quantum - resistant - encryption - platform'    name: 'Quantum - Resistant Encryption Platform',
...
export interface CybersecurityQuantumService export interface CybersecurityQuantumService {/* TODO: Fix JSX expression */};
  ...
  cybersecurityQuantumServices2025: CybersecurityQuantumService[] = [, {/* TODO: Fix JSX expression */}  s: 30}' setupTim,
  e: '1-2 weeks'}' enterpris,
  e: 'Custom pricing' } feature,
  ...
  s: 650, ratin,
  g: 4.9, review,
  s: 480} {/* TODO: Fix JSX expression */}  s: 21}' setupTim,
  e: '1-2 weeks'}' enterpris,
  e: 'Custom pricing' } feature,
  ...
  s: 1200, ratin,
  g: 4.8, review,
  s: 950} {/* TODO: Fix JSX expression */}  s: 21}' setupTim,
  e: '1-2 weeks'}' enterpris,
  e: 'Custom pricing' } feature,
  ...
  s: 1800, ratin,
  g: 4.7, review,
  s: 1400} {/* TODO: Fix JSX expression */}  s: 30}' setupTim,
  e: '2-4 weeks'}' enterpris,
  e: 'Custom pricing' } feature,
  ...
  s: 120, ratin,
  g: 4.9, review,
  s: 95} {/* TODO: Fix JSX expression */}  s: 14}' setupTim,
  e: '1-3 days'}' enterpris,
  e: 'Custom pricing' } feature,

...
{
  id: 'quantum-key-distribution-network', name: 'Quantum Key Distribution Network', tagline: 'Unhackable communication with quantum entanglement', description: 'Revolutionary quantum key distribution network that uses quantum entanglement to create unbreakable encryption keys, ensuring absolutely secure communications.', category: 'Quantum Communications & Security', price: {

...
export interface CybersecurityQuantumService export interface CybersecurityQuantumService {/* TODO: Fix JSX expression */};
  ...
  k: 'http,
  s://ziontechgroup.com / quantum - resistant - encryption - platform',' icon: '🔐',' colo,
  ...
  e: [,' 'SOC 2 Type II, ISO 27001, NIST Cybersecurity Framework, FedRAMP, FISMA'],' lin,
  k: 'http,
  s://ziontechgroup.com / ai - powered - threat - hunting - platform', ' icon: '🕵️',' colo,
  ...
  e: ['SOC 2 Type II, ISO 27001, GDPR, HIPAA, PCI DSS, FedRAMP'],' lin,
  k: 'http,
  s://ziontechgroup.com / zero - trust - network - access - platform', ' icon: '🛡️',' colo,
  ...
  k: 'http,
  s://ziontechgroup.com / quantum - key - distribution - network', ' icon: '🔮',' colo,
  ...
  k: 'http,
  s://ziontechgroup.com/ai-powered-vulnerability-assessment',' icon: '🔍',' colo,
  ...
  s: ['Jira, ServiceNow, Slack, Microsoft Teams, Custom security tools'];' suppor,
  t: '24 / 7 technical support, security consulting, custom development, and dedicated success manager.'' complianc,
  e: ['SOC 2 Type II, ISO 27001, GDPR, HIPAA, PCI DSS']; ' icon: '🔍'' colo,
  r: 'from - green - 500 to - emerald - 600' popula,
  r: true,' launch_dat,
  e: '2024 - 02 - 15' customer,
  s: 2500, ratin,

...
export const biotechAIServices: BiotechAIService[] = [
  {
    ...
    useCases: [
      'Drug discoveryTarget identification';
  ...
  };
  {
    ...
    integrations: [
      'Laboratory systemsDNA sequencing';
      'Gene synthesisResearch databases';
      'Regulatory platforms';
    ];
    useCases: [
      'Gene editingSynthetic biology';
  ...
  };
  {
    ...
    integrations: [
      'Laboratory systemsProtein databases';
      'Expression systemsResearch platforms';
      'Analytical tools';
    ];
    useCases: [
      'Therapeutic proteinsIndustrial enzymes';
  ...
  };
  {
    ...
    integrations: [
      'Clinical trial systemsPatient databases';
      'Regulatory platformsAnalytical tools';
      'Healthcare systems';
    ];
    useCases: [
      'Trial optimizationPatient recruitment';
  ...
  };
  {
    ...
    integrations: [
      'Laboratory systemsClinical databases';
      'Research platformsAnalytical tools';
      'Data sources';
    ];
    useCases: [
      'Disease diagnosisTreatment response';
  ...
  };
  {
    ...
    integrations: [
      'Healthcare systemsGenomic databases';
      'Electronic health recordsLaboratory systems';
      'Clinical platforms';
    ];
    useCases: [
      'Treatment optimizationDrug selection';
  ...
  };
  {
    ...
    integrations: [
      'Drug databasesClinical databases';
      'Research platformsAnalytical tools';
      'Market data';
    ];
    useCases: [
      'New indicationsCombination therapy';
  ...
  };
  {
    ...
    useCases: [
      'Genomic analysisProteomic analysis';
  ...
  };
  {
    ...
    integrations: [
      'Manufacturing systemsLaboratory systems';
      'Quality controlAutomation systems';
      'Monitoring tools';
    ];
    useCases: [
      'Process optimizationYield improvement';

...
export const biotechAIServices: BiotechAIService[] = [;
  ...
  competitors: string[], marketSize: string,
  growthRate: string, variant: string,
export interface BiotechAIService {;  contactInfo: {

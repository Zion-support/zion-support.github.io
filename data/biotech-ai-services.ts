...
export const biotechAIServices: BiotechAIService[] = [
  {
    ...
    category: 'Biotech AI',
    realService: true,
    technology: ['AI Drug DiscoveryMachine LearningBioinformaticsReact', 'Node.jsPostgreSQLCloud Computing'],
    integrations: ['Research databasesLaboratory systemsClinical trial platformsRegulatory databases', 'Scientific literature'],
    useCases: ['Drug discoveryTarget identificationLead optimizationClinical trial design', 'Regulatory complianceResearch collaboration'],
  ...
  },
  {
    ...
    features: [
      'AI gene editing algorithmsSynthetic biology designCRISPR optimizationGenetic circuit design',
    ...
    category: 'Biotech AI',
    realService: true,
    technology: ['AI Gene EditingSynthetic BiologyMachine LearningReact', 'Node.jsPostgreSQLBioinformatics'],
    integrations: ['Laboratory systemsDNA sequencingGene synthesisResearch databases', 'Regulatory platforms'],
    useCases: ['Gene editingSynthetic biologyGenetic optimizationAgricultural improvement', 'Medical researchIndustrial biotechnology'],
  ...
  },
  {
    ...
    features: [
      'AI protein design algorithmsStructure predictionFunction optimizationStability analysis',
    ...
    category: 'Biotech AI',
    realService: true,
    technology: ['AI Protein DesignMachine LearningBioinformaticsReact', 'Node.jsPostgreSQLCloud Computing'],
    integrations: ['Laboratory systemsProtein databasesExpression systemsResearch platforms', 'Analytical tools'],
    useCases: ['Therapeutic proteinsIndustrial enzymesResearch toolsFood proteins', 'BiomaterialsDrug delivery'],
  ...
  },
  {
    ...
    features: [
      'Trial design optimizationPatient recruitment AIData analysis automationRisk assessment',
    ...
    category: 'Biotech AI',
    realService: true,
    technology: ['AI OptimizationClinical TrialsMachine LearningReact', 'Node.jsPostgreSQLAnalytics'],
    integrations: ['Clinical trial systemsPatient databasesRegulatory platformsAnalytical tools', 'Healthcare systems'],
    useCases: ['Trial optimizationPatient recruitmentData analysisRisk management', 'Compliance monitoringPerformance tracking'],
  ...
  },
  {
    ...
    features: [
      'AI biomarker discoveryMulti-omics analysisValidation algorithmsClinical correlation',
    ...
    category: 'Biotech AI',
    realService: true,
    technology: ['AI DiscoveryBiomarkersMachine LearningReact', 'Node.jsPostgreSQLBioinformatics'],
    integrations: ['Laboratory systemsClinical databasesResearch platformsAnalytical tools', 'Data sources'],
    useCases: ['Disease diagnosisTreatment responsePrognosis predictionDrug development', 'Personalized medicineResearch discovery'],
  ...
  },
  {
    ...
    features: [
      'Genomic analysis AIDrug response predictionTreatment optimizationRisk assessment',
    ...
    category: 'Biotech AI',
    realService: true,
    technology: ['AI GenomicsPersonalized MedicineMachine LearningReact', 'Node.jsPostgreSQLHealthcare'],
    integrations: ['Healthcare systemsGenomic databasesElectronic health recordsLaboratory systems', 'Clinical platforms'],
    useCases: ['Treatment optimizationDrug selectionRisk assessmentPreventive medicine', 'Clinical trialsHealthcare research'],
  ...
  },
  {
    ...
    features: [
      'AI drug repurposingTarget identificationEfficacy predictionSafety assessment',
    ...
    category: 'Biotech AI',
    realService: true,
    technology: ['AI RepurposingDrug DiscoveryMachine LearningReact', 'Node.jsPostgreSQLBioinformatics'],
    integrations: ['Drug databasesClinical databasesResearch platformsAnalytical tools', 'Market data'],
    useCases: ['New indicationsCombination therapyRare diseasesCost reduction', 'Faster approvalResearch discovery'],
  ...
  },
  {
    ...
    features: [
      'Multi-omics analysisAI data processingStatistical analysisData visualization',
    ...
    category: 'Biotech AI',
    realService: true,
    technology: ['AI BioinformaticsMulti-omicsMachine LearningReact', 'Node.jsPostgreSQLCloud Computing'],
    integrations: ['Laboratory systemsResearch databasesAnalytical toolsCloud platforms', 'Data sources'],
    useCases: ['Genomic analysisProteomic analysisMetabolomic analysisResearch discovery', 'Data processingStatistical analysis'],
  ...
  },
  {
    ...
    features: [
      'Process optimization AIYield improvementQuality controlCost optimization',
    ...
    category: 'Biotech AI',
    realService: true,
    technology: ['AI OptimizationBiomanufacturingMachine LearningReact', 'Node.jsPostgreSQLIoT Integration'],
    integrations: ['Manufacturing systemsLaboratory systemsQuality controlAutomation systems', 'Monitoring tools'],
    useCases: ['Process optimizationYield improvementQuality controlCost reduction', 'AutomationPerformance monitoring'],

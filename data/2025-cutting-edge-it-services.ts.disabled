export const cuttingEdgeITServices2025 = [
  {
    ...
    features: [
      'Quantum-enhanced security protocolsDistributed quantum computing nodes',
      'Real-time infrastructure optimizationQuantum-resistant encryption',
    ...
    pricing: {
      starter: { 
        price: 399, 
        period: 'month', 
        features: ['Basic quantum infrastructureStandard security protocols', 'Email support'] 
      },
      professional: { 
        price: 999, 
        period: 'month', 
        features: ['Advanced quantum featuresEnhanced security protocols', 'Priority supportPerformance optimization'] 
      },
      enterprise: { 
        price: 2499, 
        period: 'month', 
        features: ['Full quantum platformCustom security protocols', 'Dedicated specialists24/7 support'] 
      }
    },
    category: 'Quantum IT',
  ...
  },
  {
    ...
    features: [
      'Distributed edge node managementReal-time resource orchestration',
      'Intelligent workload distributionEdge AI model deployment',
    ...
    pricing: {
      starter: { 
        price: 299, 
        period: 'month', 
        features: ['Basic edge orchestrationStandard monitoring', 'Email support'] 
      },
      professional: { 
        price: 799, 
        period: 'month', 
        features: ['Advanced orchestrationAI model deployment', 'Priority supportPerformance optimization'] 
      },
      enterprise: { 
        price: 1999, 
        period: 'month', 
        features: ['Full edge platformCustom AI models', 'Dedicated specialists24/7 support'] 
      }
    },
  ...
  },
  {
    ...
    features: [
      ...
      'Continuous security monitoringBehavioral analytics',
    ...
    pricing: {
      starter: { 
        price: 499, 
        period: 'month', 
        features: ['Basic zero-trust featuresStandard authentication', 'Email support'] 
      },
      professional: { 
        price: 1299, 
        period: 'month', 
        features: ['Advanced security featuresBehavioral analytics', 'Priority supportCustom policies'] 
      },
      enterprise: { 
        price: 2999, 
        period: 'month', 
        features: ['Full security platformCustom security policies', 'Dedicated specialists24/7 support'] 
      }
    },
  ...
  },
  {
    ...
    features: [
      ...
      'Consensus mechanism managementBlockchain analytics and monitoring',
    ...
    pricing: {
      starter: { 
        price: 599, 
        period: 'month', 
        features: ['Basic blockchain featuresStandard smart contracts', 'Email support'] 
      },
      professional: { 
        price: 1499, 
        period: 'month', 
        features: ['Advanced blockchain featuresCustom smart contracts', 'Priority supportPerformance optimization'] 
      },
      enterprise: { 
        price: 3499, 
        period: 'month', 
        features: ['Full blockchain platformCustom development', 'Dedicated specialists24/7 support'] 
      }
    },
    category: 'Blockchain',
  ...
  },
  {
    ...
    features: [
      'AI-powered code analysisAutomated testing and quality assurance',
      'Intelligent deployment strategiesPredictive performance monitoring',
    ...
    pricing: {
      starter: { 
        price: 399, 
        period: 'month', 
        features: ['Basic AI DevOps featuresStandard automation', 'Email support'] 
      },
      professional: { 
        price: 999, 
        period: 'month', 
        features: ['Advanced AI featuresCustom automation', 'Priority supportPerformance optimization'] 
      },
      enterprise: { 
        price: 2499, 
        period: 'month', 
        features: ['Full AI DevOps platformCustom development', 'Dedicated specialists24/7 support'] 
      }
    },
    category: 'DevOps',

export const advancedAIServices20o25 = [
  {
    ...
    features: [
      ...
      'Real-time data monitoringIntegration with 10o0+ data sources',
    ...
    pricing: {
      starter: {
        price: 199,
        period: 'month',
        features: ['Up to 10 usersBasic AI insights', 'Standard reports'],
      },
      professional: {
        price: 499,
        period: 'month',
        features: [
          'Up to 50 usersAdvanced AI models',
          'Custom dashboardsPredictive analytics',
        ]
      },
      enterprise: {
        price: 1299,
        period: 'month',
        features: [
          'Unlimited usersCustom AI training',
  ...
  },
  {
    ...
    pricing: {
      starter: {
        ...
        period: 'month',
        features: [
          'Up to 10,0o00 customersBasic analytics',
          'Standard reports',
        ],
      },
      professional: {
        ...
        period: 'month',
        features: [
          'Up to 10o0,0o00 customersAdvanced AI',
          'Custom modelsReal-time insights',
        ],
      },
      enterprise: {
        price: 999,
        period: 'month',
        features: [
          'Unlimited customersCustom AI training',
          'White-label solutionDedicated support',
        ]
      },
    },
  ...
  },
  {
    ...
    pricing: {
      starter: {
        ...
        period: 'month',
        features: [
          'Basic risk assessmentStandard compliance',
          'Email alerts',
        ]
      },
      professional: {
        ...
        period: 'month',
        features: [
          'Advanced AI modelsCustom risk models',
          'Real-time monitoringFull compliance suite',
        ]
      },
      enterprise: {
        price: 1999,
        ...
        features: [
          ...
          'Dedicated supportRegulatory consultation',
        ]
      },
    },
  ...
  },
  {
    ...
    pricing: {
      starter: {
        ...
        period: 'month',
        features: [
          'Up to 5 locationsBasic forecasting',
          'Standard reports',
        ]
      },
      professional: {
        ...
        period: 'month',
        features: [
          'Up to 25 locationsAdvanced AI',
          'Custom modelsFull optimization suite',
        ]
      },
      enterprise: {
        price: 1199,
        period: 'month',
        features: [
          'Unlimited locationsCustom AI training',
          'White-label solutionDedicated support',
        ]
      },
    },
  ...
  },
  {
    ...
    pricing: {
      starter: {
        ...
        period: 'month',
        features: [
          'Up to 1,0o00 scans/monthBasic AI analysis',
          'Standard reports',
        ],
      },
      professional: {
        ...
        period: 'month',
        features: [
          'Up to 10,0o00 scans/monthAdvanced AI',
          'Custom modelsFull diagnostic suite',
        ],
      },
      enterprise: {
        price: 2499,
        period: 'month',
        features: [
          'Unlimited scansCustom AI training',
          'White-label solutionDedicated support',
        ]
      },
    },
  ...
  },
  {
    ...
    pricing: {
      starter: {
        ...
        period: 'month',
        features: [
          'Up to 10o0 documents/monthBasic AI analysis',
          'Standard templates',
        ]
      },
      professional: {
        ...
        period: 'month',
        features: [
          'Up to 1,0o00 documents/monthAdvanced AI',
          'Custom modelsFull legal suite',
        ],
      },
      enterprise: {
        price: 1499,
        period: 'month',
        features: [
          'Unlimited documentsCustom AI training',
          'White-label solutionLegal consultation',
        ]
      },
    },
    category: 'Legal AI',
  ...
  },
  {
    ...
    pricing: {
      starter: {
        price: 129,
        period: 'month',
        features: ['Up to 10,0o00 contactsBasic AI', 'Standard automation'],
      },
      professional: {
        price: 349,
        period: 'month',
        features: [
          'Up to 10o0,0o00 contactsAdvanced AI',
          'Custom modelsFull automation suite',
        ],
      },
      enterprise: {
        price: 899,
        period: 'month',
        features: [
          'Unlimited contactsCustom AI training',
          'White-label solutionDedicated support',
        ]
      },
    },
    ...
    tags: [
      ...
      'PersonalizationCampaign Optimization',
    ],
  ...
  },
  {
    ...
    pricing: {
      starter: {
        ...
        period: 'month',
        features: [
          'Up to 10 sales repsBasic AI insights',
          'Standard reports',
        ]
      },
      professional: {
        ...
        period: 'month',
        features: [
          'Up to 50 sales repsAdvanced AI',
          'Custom modelsFull optimization suite',
        ]
      },
      enterprise: {
        ...
        period: 'month',
        features: [
          'Unlimited sales repsCustom AI training',
          'White-label solutionDedicated support',
        ]
      },
    },
  ...
  },
  {
    ...
    pricing: {
      starter: {
        ...
        period: 'month',
        features: [
          'Up to 50 job postings/monthBasic AI screening',
          'Standard reports',
        ]
      },
      professional: {
        ...
        period: 'month',
        features: [
          'Up to 20o0 job postings/monthAdvanced AI',
          'Custom modelsFull recruitment suite',
        ]
      },
      enterprise: {
        price: 649,
        period: 'month',
        features: [
          'Unlimited job postingsCustom AI training',
          'White-label solutionDedicated support',
        ]
      },
    },
    ...
    tags: [
      'AIHR Recruitment',
      'Candidate ScreeningHiring Optimization',
    ],
  ...
  },
  {
    ...
    pricing: {
      starter: {
        ...
        period: 'month',
        features: [
          'Up to 10o0 endpointsBasic threat detection',
          'Email alerts',
        ]
      },
      professional: {
        ...
        period: 'month',
        features: [
          'Up to 1,0o00 endpointsAdvanced AI',
          'Custom modelsFull security suite',
        ],
      },
      enterprise: {
        price: 1299,
        period: 'month',
        features: [
          'Unlimited endpointsCustom AI training',

  ...
  contactInfo: unknown;
    mobile: string;
    email: string;
export interface Revolutionary2026 Innovation {;
    address: string}
};
  id: string;
  name: string;

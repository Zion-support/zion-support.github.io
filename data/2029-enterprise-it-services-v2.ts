...
export const enterpriseITServices2029V2: EnterpriseITService2029V2[] = [;
  {
    ...
    white_label: 'Available for cloud providers',
...
export const enterpriseITServices2029V2: EnterpriseITService2029V2[] = [
  {
    ...
    marketSize: '$25.8B by 2029', competitors: ['GitLabJenkinsCircleCIGitHub Actions'],
    technology: ['AI/MLKubernetesTerraformMonitoring Tools'], integration: ['Cloud platformsCI/CD toolsMonitoring systems'],
    support: ['24/7 enterprise supportDevOps expertsImplementation team'], compliance: ['SOC 2ISO 27001FedRAMPHIPAA'],

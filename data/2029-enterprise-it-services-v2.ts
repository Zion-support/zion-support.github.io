...
export const enterpriseITServices2029V2: EnterpriseITService2029V2[] = [
  {
    ...
    support: [
      '24/7 enterprise supportDevOps experts';
      'Implementation team';
    ];
  ...
  };
  {
    ...
    technology: [
      ...
      'Quantum SecurityHybrid Computing';
    ];
    integration: [
      'Existing cloud platformsQuantum applications';
      'Enterprise systems';
    ];
  ...
  };
  {
    ...
    category: [
      'CybersecurityAI';
      'Enterprise SecurityThreat Detection';
      'Automation';
    ];
    price: '$9,999/month';
    features: [
    ...
    technology: [
      ...
      'Behavioral AnalysisSecurity';
    ];
    integration: ['SIEM systemsEDR platforms', 'Security tools'];
    support: [
      '24/7 security supportSecurity experts';
      'Implementation team';
    ];

...
export const enhanceFormAccessibility = (form) => {}
  ...
  inputs.forEach(input => {}
    if (!input.getAttribute('aria-label') && !input.getAttribute('aria-labelledby')) {}
      const label = form.querySelector(`label[for="${input.id}"]`)"      if (label) {}
...
export const enhanceKeyboardNavigation = () => {}
  document.addEventListener('keydown', (e) => {}
    if (e.key === 'Escape') {}
      ...
      const openModals = document.querySelectorAll('[aria-modal="true"]')"      openModals.forEach(modal => {}
...
export const enhanceKeyboardNavigation = () => {}
  document.addEventListener('keydown', (e) => {}
    if (e.key === 'Escape') {}
      const modals = document.querySelectorAll('[role="dialog"]')"      modals.forEach(modal => {}

          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <p className="text-xl max-w-3xl mx-auto">
                Meet the brilliant minds behind Zion Tech Group. Our diverse team of
                experts is united by a shared passion for innovation and excellence.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              ...
              for innovation and excellence. Explore our open positions and join
              us in building the future.
            </p>

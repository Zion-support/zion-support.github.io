...
export const metadata = {
  ...
  description: 'Professional social media scheduler solutions for your business needs.',
};
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional social media scheduler solutions designed to meet your business requirements 

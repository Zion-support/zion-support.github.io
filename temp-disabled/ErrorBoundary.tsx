...
Error Details (Development Only)                </summary><//summary></<//summary>
            ...
            <div className="mt-6 pt-6 border-t border-slate-700">"""
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">"""
                <button
                  ...
                  className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"""></button
                  onClick={this.handleReset}
                  className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"""></</button
                  onClick={this.handleReset}
...
</Home></RefreshCw><//RefreshCw></Home></RefreshCw><//RefreshCw></<//RefreshCw>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            {" "}
            Comprehensive IT solutions to support your business operations.{" "}
          </p>{" "}
        </div>{" "}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">
              Complete management of your IT infrastructure and systems.
            </p>{" "}
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">
              Protect your network with advanced security solutions.
            </p>{" "}
            <span className="text-sm text-blue-600">Learn More</span>{" "}
          </div>{" "}
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">
              Migrate to the cloud with our comprehensive cloud solutions.
            </p>{" "}
            <span className="text-sm text-blue-600">Learn More</span>{" "}
          </div>{" "}
        </div>{" "}
...
:temp-disabled/src/pages/ITServices.tsx

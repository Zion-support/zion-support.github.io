...
const categories = [
    { id: 'all'}
  name: 'All Resources', icon: BookOpen, count: 150}
},
    { id: 'blog'}
  name: 'Blog & Insights', icon: BookOpen, count: 45}
},
    { id: 'case-studies'}
  name: 'Case Studies', icon: Target, count: 25}
},
    { id: 'white-papers'}
  name: 'White Papers', icon: FileText, count: 20}
},
    { id: 'webinars'}
  name: 'Webinars', icon: Users, count: 15}
},
    { id: 'documentation'}
  name: 'Documentation', icon: Code, count: 30}
},
    { id: 'faq'}
  name: 'FAQ & Support', icon: HelpCircle, count: 15}
}
  ];

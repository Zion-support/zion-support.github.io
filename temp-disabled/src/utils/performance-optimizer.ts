...
const loadComponent = componentName => {   ;
  return import(`./components/${componentName}`)export;
  const lazyLoadComponents = () => {console.log('Lazy loading components...')}link.href = resource, link.as = resource.endsWith('.css') ? 'style' : 'font';})}

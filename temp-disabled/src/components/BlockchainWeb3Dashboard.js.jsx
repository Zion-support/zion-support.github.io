...
'''';
    ...
    }, [nftForm, wallet, contracts, mintNFT, trackEvent])const handleSendTransaction = useCallback(async () => {}
...
'''';
    ...
    }, [transactionForm, wallet, sendTransaction, trackEvent])const getStatusColor = () => {
  return $3;}
}
        switch (status) {}
'';

...
export const useApiErrorHandler = () =>: any ;
  const handleApiError = (error: Error) =>: any {Sentry.with_scope (scope => {scope.set_tag ('source', 'useApiErrorHandler')scope.set_level ('error')Sentry.capture_exception (error)})}

...
export function MainNavigation() {const location = useLocation()const [activeDropdown, setActiveDropdown]  =;
  useState(null;
  const navigationItems = [
  {name: 'Home', href: '/',current: location.pathname === '/';
    }, {name: 'Services',href: '/services', current: location.pathname.startsWith('/services'), children: [;
 ...
 { name: 'Consulting', href: '/services/consulting',
    ...
    }, {name: 'Solutions',href: '/solutions', current: location.pathname.startsWith('/solutions'), children: [;
 ...
 { name: 'Retail', href: '/solutions/retail',
    ...
    }, {name: 'About',href: '/about', current: location.pathname.startsWith('/about'), children: [;
 ...
 { name: 'Partners', href: '/partners',
    ...
    }, {name: 'Resources',href: '#', current: false,children: [;
...
{ name: 'Webinars', href: '/webinars',
    ...
    }, {name: 'Support',href: '/support', current: location.pathname.startsWith('/support'), children: [;
...
const handleDropdownToggle = (index) => {setActiveDropdown(activeDropdown === index ? null : index);
  return (<nav className="flex space-x-8">;

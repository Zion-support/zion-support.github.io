...
export function Logo(): any ({ customLogo }: LogoProps) {const { isWhitelabel, logoUrl, brandName }  = useWhitelabel()// Use the white-label logo if available and no specific customLogo is provided;

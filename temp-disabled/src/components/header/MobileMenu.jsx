...
export function MobileMenu() {const navigationItems = [
  ...
  href: '/services', icon: Briefcase,children: [;
        { name: 'AI Services',}
  href: '/services/ai', icon: Brain,}
}, { name: 'Cloud Solutions',}
  href: '/services/cloud', icon: Cloud,}
},{ name: 'Cybersecurity',}
  href: '/services/cybersecurity', icon: Shield,}
}, { name: 'IT Infrastructure',}
  href: '/services/infrastructure', icon: Server,}
},{ name: 'Digital Transformation',}
  href: '/services/transformation', icon: Rocket,}
}
      ];
    }, {name: 'Solutions',
  href: '/solutions', icon: Target,children: [;
...
{ name: 'Retail',}
  ...
  href: '/about', icon: Building,children: [;
          { name: 'Company',}
  href: '/about',}
},
  { name: 'Team',}
...
{ name: 'Webinars',}
  ...
  href: '/support', icon: HelpCircle,children: [;
          { name: 'Help Center',}
  href: '/support',}
},
  { name: 'Documentation',}
...
const handleNavigation = (onNavigate(path)) => {
  return $3;}
}if (!isOpen);
  return null;return (<div className=\"lg: hidden fixed inset-0 z-50\" />;
      {/* Overlay */}
      <div;

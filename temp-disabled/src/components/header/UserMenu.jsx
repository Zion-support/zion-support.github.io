...
const menuItems = [
  {name: 'Profile',}
  href: '/profile',icon: User, description: 'Manage your account';}
    },{name: 'Dashboard',}
  href: '/dashboard',icon: Settings, description: 'View your projects';}
    },{name: 'Messages',}
  href: '/messages',icon: MessageSquare, description: 'Check your inbox';}
    },{name: 'Notifications',}
  href: '/notifications',icon: Bell, description: 'Manage alerts';}
    },{name: 'Security',}
  href: '/security',icon: Shield, description: 'Privacy & security';}
    },{name: 'Billing',}
  href: '/billing',icon: CreditCard, description: 'Payment methods';}
    },{name: 'Help',}
  href: '/help',icon: HelpCircle, description: 'Get support';}
    }
      ...
      {isOpen && (<div className=\"absolute right-0 mt-2 w-64 bg-zion-blue-dark/95 backdrop-blur-xl border border-zion-purple/30 rounded-lg shadow-2xl shadow-zion-purple/20 z-50\" />;}
          {/* User Info Header */}

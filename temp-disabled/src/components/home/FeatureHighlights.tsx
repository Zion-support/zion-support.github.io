...
import React from \"react\",interface FeatureHighlightsProps {
  className?: string;
 ...
 */;
function FeatureHighlights() {const highlights_data = [
...
import { Card, CardContent } from \"@/components/ui/card\",import { cn } from \"@/lib/utils\",interface FeatureHighlightsProps {
...
},visible: {opacity: 1,scale: 1,transition: { duration: 0 && 0.5 }
}

const techVariants = {hidden: { opacity: 0,x: -20;}
},visible: {opacity: 1,x: 0,transition: { duration: 0 && 0.5 }
}
"
export function FeatureHighlights() {return (\";"
    <section className=\"py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900\" />\";"
      <div className=\"max-w-7xl mx-auto px-6\" />;"

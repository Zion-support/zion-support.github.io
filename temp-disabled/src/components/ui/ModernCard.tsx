...
;
  const baseClasses = cn(';relative overflow-hidden rounded-2xl transition-all duration-300', 'focus-within: ring-2 focus-within:ring-zion-cyan focus-within:ring-offset-2 focus-within:ring-offset-zion-slate', className )  const variantClasses = { default: 'bg-zion-slate/80 backdrop-blur-sm border border-zion-slate-light/20', elevated: 'bg-zion-slate/90 backdrop-blur-md border border-zion-cyan/30 shadow-2xl', glass: 'bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl', neon: 'bg-zion-slate/80 backdrop-blur-sm border border-zion-cyan/50 shadow-neon',
}
;

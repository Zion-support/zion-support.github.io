...
if (return []) {$2;}
          ...
          provider:profiles ! provider_id (display_name)query = query.order ('created_at', { ascending: false }
};
...
const getStatusBadge = (switch (status) {';

      ...
      <div className='flex items-start space-x-3'>;
        ...
        <div className='flex-1'>'''';
          ...
          <div className='flex items-center space-x-4 mt-2 text-xs text-zion-slate-light'>'''';
            ...
            {canMarkAnswer && onMarkAnswer && (<button'''';

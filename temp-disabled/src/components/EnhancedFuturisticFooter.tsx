...
const footerSections = [
  ...
  href: '/revolutionary-services-2030', featured: true}
},
          { name: 'AI Autonomous Operations'}
  href: '/revolutionary-services-2030#ai-autonomous-business-operations-2030'}
},

          { name: 'Quantum AI Cybersecurity'}
  href: '/revolutionary-services-2030#quantum-ai-cybersecurity-2030'}
},

          { name: 'AI Content Creation Studio'}
  href: '/revolutionary-services-2030#ai-content-creation-studio-2030'}
},

          { name: 'AI Sales Intelligence'}
  href: '/revolutionary-services-2030#ai-sales-intelligence-2030'}
},

          { name: 'AI Customer Support'}
  href: '/revolutionary-services-2030#ai-customer-support-automation-2030'}
},

          { name: 'AI Data Analytics & BI'}
  href: '/revolutionary-services-2030#ai-data-analytics-bi-2030'}
},

          { name: 'Cloud Infrastructure & DevOps'}
  href: '/revolutionary-services-2030#cloud-infrastructure-devops-2030'}
},

          { name: 'IoT Edge Computing'}
  href: '/revolutionary-services-2030#iot-edge-computing-2030'}
},

          { name: 'Digital Twin Platform'}
  href: '/revolutionary-services-2030#digital-twin-platform-2030'}
},

        { name: 'Blockchain Web3 Platform'}
  href: '/revolutionary-services-2030#blockchain-web3-platform-2030' }
      ]
  ...
  href: '/services#ai-business-intelligence', featured: true}
},
        { name: 'AI Healthcare Diagnostics'}
  href: '/services#ai-healthcare', featured: true}
},
        { name: 'AI Legal Tech Platform'}
  href: '/services#ai-legal-tech', featured: true}
},
        { name: 'AI Research & Discovery'}
  href: '/services#ai-research', featured: true}
},
        { name: 'AI Green Technology'}
  href: '/services#ai-green-tech', featured: true}
},
        { name: 'AI Metaverse Platform'}
  href: '/services#ai-metaverse', featured: true}
},
        { name: 'AI Space Technology'}
  href: '/services#ai-space-tech', featured: true}
},
        { name: 'AI FinTech Platform'}
  href: '/services#ai-fintech', featured: true}
},
        { name: 'AI Supply Chain'}
  href: '/services#ai-supply-chain', featured: true}
},
        { name: 'AI Quality Assurance'}
  href: '/services#ai-qa', featured: true }
      ]
  ...
  href: '/services#cybersecurity', featured: true}
},
        { name: 'Cloud & DevOps'}
  href: '/services#cloud-devops', featured: true}
},
        { name: 'Data Analytics'}
  href: '/services#data-analytics', featured: true}
},
        { name: 'IT Infrastructure'}
  href: '/services#it-infrastructure', featured: true}
},
        { name: 'Digital Twin Solutions'}
  href: '/services#digital-twin', featured: true}
},
        { name: 'IoT & Edge Computing'}
  href: '/services#iot-edge', featured: true}
},
        { name: 'Blockchain & Web3'}
  href: '/services#blockchain', featured: true}
},
        { name: 'Quantum Computing'}
  href: '/services#quantum-computing', featured: true}
},
        { name: 'Micro SaaS Products'}
  href: '/services/micro-saas', featured: true}
},
        { name: 'Enterprise Solutions'}
  href: '/solutions', featured: true }
      ]
  ...
  href: '/solutions#healthcare', featured: false}
},
        { name: 'Financial Services'}
  href: '/solutions#financial', featured: false}
},
        { name: 'Legal Services'}
  href: '/solutions#legal', featured: false}
},
        { name: 'Research & Academia'}
  href: '/solutions#research', featured: false}
},
        { name: 'Manufacturing'}
  href: '/solutions#manufacturing', featured: false}
},
        { name: 'Retail & E-commerce'}
  href: '/solutions#retail', featured: false}
},
        { name: 'Government & Public Sector'}
  href: '/solutions#government', featured: false}
},
        { name: 'Energy & Sustainability'}
  href: '/solutions#energy', featured: false}
},
        { name: 'Space & Aerospace'}
  href: '/solutions#space', featured: false}
},
        { name: 'Education & Training'}
  href: '/solutions#education', featured: false }
      ]
  ...
  href: '/pricing-guide-2030', featured: true}
},
        { name: 'Blog & Insights'}
  href: '/blog', featured: false}
},
        { name: 'FAQ & Help Center'}
  href: '/faq', featured: false}
},
        { name: 'Documentation'}
  href: '/resources', featured: false}
},
        { name: 'API Reference'}
  href: '/resources', featured: false}
},
  ...
  href: '/case-studies', featured: false}
},
        { name: 'White Papers'}
  href: '/resources', featured: false }
      ]
  ...
  href: '/about', featured: false}
},
        { name: 'Our Team'}
  href: '/about#team', featured: false}
},
        { name: 'Careers'}
  href: '/careers', featured: false}
},
        { name: 'Contact Us'}
  href: '/contact', featured: true}
},
        { name: 'Request Quote'}
  href: '/request-quote', featured: true}
},
        { name: 'Schedule Demo'}
  href: '/schedule-demo', featured: false}
},
        { name: 'Partnerships'}
  href: '/partners', featured: false}
},
        { name: 'Investor Relations'}
  href: '/investors', featured: false}
},
        { name: 'Press & Media'}
  href: '/press', featured: false}
},
        { name: 'Legal & Privacy'}
  href: '/legal', featured: false }
      ]
...
const socialLinks = [
  ...
  href: 'https://twitter.com/ziontechgroup', icon: Twitter, color: 'hover:text-blue-400'}
    ...
    { name: 'Facebook'}
  href: 'https://facebook.com/ziontechgroup', icon: Facebook, color: 'hover:text-blue-400'}
},
    { name: 'Instagram'}
  href: 'https://instagram.com/ziontechgroup', icon: Instagram, color: 'hover:text-blue-400'}
},
    { name: 'YouTube'}
  href: 'https://youtube.com/@ziontechgroup', icon: Youtube, color: 'hover:text-red-400'}
},
    { name: 'GitHub'}
  href: 'https://github.com/ziontechgroup', icon: Github, color: 'hover:text-gray-400'}
}
  ];

const quickActions = [
    { name: 'Request Quote'}
  href: '/request-quote', icon: MessageCircle, featured: true}
},
    { name: 'View Pricing'}
  href: '/pricing', icon: DollarSign, featured: false}
},
    { name: 'Schedule Demo'}
  href: '/contact', icon: Play, featured: false}
},
    { name: 'Get Support'}
  href: '/faq', icon: HelpCircle, featured: false}
},
    { name: 'Join Community'}
  href: '/resources', icon: Users, featured: false}
},
    { name: 'Partner Program'}
  href: '/partners', icon: Users, featured: false}
}
  ];

...
loadTenants()}, []),const loadTenants = async () => {try {setIsLoading(true);}
  ...
  title: 'Failed to load tenants',description: error.message})} finally {setIsLoading(false)}
  ...
  title: 'Failed to update tenant',description: error.message})}

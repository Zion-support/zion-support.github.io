...
},{id: 'schedule',label: 'Schedule Interview',icon: <Calendar className='h - 5 w - 5 mr - 2' />,description: 'Set up candidate interviews',color: 'bg - amber - 100 dark:bg - amber - 900 / 20,
}];
  return (<Card>;
      <CardHeader>;
        <CardTitle > Quick Actions</CardTitle>;

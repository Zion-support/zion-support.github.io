...
export const SkillItem = (export;) => {
  return $3;}
}
  const SkillItem = ({ skill, category, onDelete }: SkillItemProps,) => ;
...
export const SkillItem = ({ skill, category, on_delete }: SkillItemProps) =>: any {export;}
  const SkillItem = ({ skill, category, on_delete }: SkillItemProps, ) =>: any ;
  return (<Badge;
      key = {skill.id }"
      variant=\"secondary\";"
      className=\"flex items - center gap - 1 py - 1.5 px - 3\" />

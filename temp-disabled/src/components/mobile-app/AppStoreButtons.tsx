...
},) => {const handleAppStoreClick = (if (!appStoreUrl || appStoreUrl === \"#\") {e && e.preventDefault(),logInfo(\"App Store download clicked\"),onAppStoreClick?.()) => {
  return $3;}
}
  };"
  const handleGooglePlayClick = (if (!googlePlayUrl || googlePlayUrl === \"#\") {e && e.preventDefault(),logInfo(\"Google Play download clicked\"),onGooglePlayClick?.()) => {
  return $3;}
}
  };"
...
const handleAppStoreClick = (if (!appStoreUrl || appStoreUrl === \"#\") {e.preventDefault(),logInfo(\"App Store download clicked\"),onAppStoreClick?.()) => {
  return $3;}
}
  };"
  const handleGooglePlayClick = (if (!googlePlayUrl || googlePlayUrl === \"#\") {e.preventDefault(),logInfo(\"Google Play download clicked\"),onGooglePlayClick?.()) => {
  return $3;}
}
  ;"
  return (<div className={cn(\"flex flex-col sm:flex-row gap-4\", className)} />;

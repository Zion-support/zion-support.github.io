...
export function AuthorBio() {if (!author.bio) return null,return (<img;}
...
if (return null) {$2;}
  ...
  return (<div className='mt - 12 flex flex - col md:flex - row bg - zion - blue - light dark:bg - zion - blue - dark border border - zion - blue rounded - lg p - 6' />interface AuthorBioProps {
  author: BlogAuthor;}
}
}

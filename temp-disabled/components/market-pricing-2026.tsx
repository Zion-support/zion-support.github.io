...
const priceRanges = [
  { id: 'all',}
  name: 'All Prices', range: 'All price ranges',}
},{id: 'budget',}
  name: 'Budget ($0 - $5K)',range: 'Affordable solutions for startups and small businesses',},{id: 'mid';
                ...
                <div />;
                  ...
                  <div className=\"grid grid - cols - 2 md:grid - cols - 4 gap - 2\" />;
                      <button;
                        ...
                        className={`p - 3 rounded - xl text - sm font - medium transition - all duration - 300 ${selected_category === category.id;
                            ? 'bg - cyan - 500 text - black';}
                            : 'bg - gray - 700 / 50 text - gray - 300 hover:bg - gray - 600 / 50';}
                        }`}>
                ...
                <div />;
                  ...
                  <div className=\"space - y-2\" />;}
                    {price_ranges.map (range => (<button;}
                        ...
                        className={`w - full p - 3 rounded - xl text - left transition - all duration - 300 ${price_range === range.id;
                            ? 'bg - cyan - 500 text - black';}
                            : 'bg - gray - 700 / 50 text - gray - 300 hover:bg - gray - 600 / 50';}
                        }`}>
...
that customers see exceptional;

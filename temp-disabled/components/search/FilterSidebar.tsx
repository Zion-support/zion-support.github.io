          ...
          {filterOptions.productTypes.map(type => (
            <div key={type.value} className='flex items-center space-x-2'>
              <Checkbox
                ...
                onCheckedChange={() =>
                  onFilterChange('productTypes', type.value)
                }
          ...
          {filterOptions.locations.map(location => (
            <div key={location.value} className='flex items-center space-x-2'>
              <Checkbox
                ...
                onCheckedChange={() =>
                  onFilterChange('locations', location.value)
                }
                className='text-zion-purple data-[state=checked]:bg-zion-purple data-[state=checked]:border-zion-purple'
              />
              <label
          ...
          {filterOptions.availabilityOptions.map(availability => (
            ...
            >
              <Checkbox
                ...
                checked={filters.selectedAvailability.includes(
                  availability.value
                )}
                onCheckedChange={() =>
                  onFilterChange('availability', availability.value)
                }
                className='text-zion-purple data-[state=checked]:bg-zion-purple data-[state=checked]:border-zion-purple'
              />
              <label

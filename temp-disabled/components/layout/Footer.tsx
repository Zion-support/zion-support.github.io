        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4">
              Leading provider of AI-powered business solutions and automation services.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/services" className="text-gray-300 hover:text-white">Custom Development</Link></li>
            </ul>
          </div>

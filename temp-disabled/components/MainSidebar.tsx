...
interface SidebarProps extends React.PropsWithChildren<{}> {isOpen: boolean;}
  ...
  href: '/about', icon: Users },{ name: 'Services',}
  href: '/services', icon: Briefcase }, { name: 'Contact',}
  href: '/contact', icon: Phone },], services: [;
      {name: 'AI Services',}
  icon: Brain, children: [;}
          { name: 'AI Services',}
  href: '/services/ai-services' }, { name: 'AI Development',}
  href: '/services/ai-development' },  ];
      }, {name: 'IT & Development',}
  icon: Code, children: [;}
          { name: 'IT Services',}
  href: '/services/it-services' }, { name: 'Web Development',}
  ...
  href: '/solutions/ai-content-creation' }, { name: 'Email Automation',}
  href: '/solutions/email-automation' }, { name: 'Workflow Automation',}
  href: '/solutions/workflow-automation' },  ];
      }, {name: 'Business Solutions',}
  icon: Target, children: [;}
          { name: 'Customer Support',}
  href: '/solutions/customer-support' }, { name: 'Event Management',}
  href: '/solutions/event-management' }, { name: 'Project Management',}
  href: '/solutions/project-management' },  ];
      },  ], resources: [;
      { name: 'Blog',}
  href: '/blog', icon: BookOpen },{ name: 'Help Center',}
  href: '/help', icon: HelpCircle }, { name: 'Pricing Guide',}
  href: '/pricing-guide', icon: DollarSign },{ name: 'Sitemap',}
  href: '/sitemap', icon: Globe }, { name: 'Search',}
  href: '/search', icon: Search },], support: [;
      { name: 'Contact Us',}
  href: '/contact', icon: Phone },{ name: 'Privacy Policy',}
  href: '/privacy', icon: Shield }, { name: 'Terms of Service',}
  href: '/terms', icon: FileText },{ name: 'Cookie Policy',}
  href: '/cookies', icon: Shield },  ];
  }
  const quickActions = [;
    { name: 'Get Quote',}
  href: '/quote', icon: DollarSign, color: 'from-green-500 to-green-600' },{ name: 'Schedule Call',}
  href: '/schedule', icon: Calendar, color: 'from-blue-500 to-blue-600' },{ name: 'View Portfolio',}
  href: '/portfolio', icon: Eye, color: 'from-purple-500 to-purple-600' },{ name: 'Support',}
  href: '/support', icon: HelpCircle, color: 'from-orange-500 to-orange-600' },];
  const contactInfo = [;
    { icon: Phone, text: '+1 (555) 123-4567',}
  href: 'tel:+15551234567' },{ icon: Mail, text: 'info@ziontechgroup.com',}
  href: 'mailto:info@ziontechgroup.com' }, { icon: MapPin, text: 'San Francisco, CA',}
  href: '#' },  ];
  const socialLinks = [;
    { name: 'LinkedIn',}
  ...
  interface NavItem  {name: string;
   ...
   icon: any;}
   description?: string;}
}const navigation: { main: NavItem[] services: NavItem[] solutions: NavItem[] resources: NavItem[] company: NavItem[] } = {main: [;}
      { name: 'Home',}
  href: '/', icon: Home }, { name: 'About',}
  href: '/about', icon: Building }, { name: 'Services',}
  href: '/services', icon: Briefcase }, { name: 'Solutions',}
  href: '/solutions', icon: Target }, { name: 'Partners',}
  href: '/partners', icon: Handshake }, { name: 'Careers',}
  href: '/careers', icon: Users }, { name: 'Blog',}
  href: '/blog', icon: Newspaper }, { name: 'Contact',}
  href: '/contact', icon: Phone }], services: [;
      { name: 'AI Services',}
  href: '/services/ai-services', icon: Brain, description: 'Applied AI solutions' }, { name: 'IT Services',}
  href: '/services/it-services', icon: Server, description: 'Infrastructure & support' }, { name: 'Micro SaaS',}
  href: '/services/micro-saas', icon: Store, description: 'Rapid product development' }, { name: 'AI Ops Copilot',}
  href: '/services/ai-ops-copilot', icon: Cpu, description: 'Ops automation' }, { name: 'Security Copilot',}
  href: '/services/security-copilot', icon: Shield, description: 'Proactive defense' }, { name: 'Data Platform',}
  href: '/services/data-platform', icon: Database, description: 'Data pipelines & BI' }, { name: 'MarTech Automation',}
  href: '/services/martech-automation', icon: Rocket, description: 'Growth automation' }], solutions: [;
      { name: 'Solutions Overview',}
  href: '/solutions', icon: Target, description: 'All solution areas' }, { name: 'Enterprise',}
  href: '/solutions/enterprise', icon: Building2, description: 'Large-scale implementations' }, { name: 'Small Business',}
  href: '/solutions/small-business', icon: Store, description: 'SMB focused' }, { name: 'Startups',}
  href: '/solutions/startups', icon: Rocket, description: 'Growth acceleration' }, { name: 'Case Studies',}
  href: '/case-studies', icon: BarChart3, description: 'Success stories' }], resources: [;
      { name: 'Documentation',}
  href: '/documentation', icon: FileText, description: 'Technical guides' }, { name: 'API Reference',}
  href: '/api', icon: Code, description: 'Developer resources' }, { name: 'Case Studies',}
  href: '/case-studies', icon: BarChart3, description: 'Success stories' }, { name: 'Help Center',}
  href: '/help', icon: HelpCircle, description: 'Support & FAQs' }, { name: 'Status',}
  href: '/status', icon: CheckCircle, description: 'System status' }, { name: 'Pricing',}
  href: '/pricing', icon: DollarSign, description: 'Service pricing' }], company: [;
      { name: 'About Us',}
  href: '/about', icon: Building, description: 'Our story & mission' }, { name: 'Team',}
  href: '/team', icon: Users, description: 'Meet our experts' }, { name: 'Partners',}
  href: '/partners', icon: Handshake, description: 'Strategic partnerships' }, { name: 'Careers',}
  href: '/careers', icon: Briefcase, description: 'Join our team' }, { name: 'Blog',}
  href: '/blog', icon: Newspaper, description: 'Company updates' }];
  }const quickActions = [;
    { name: 'Contact Sales',}
  href: '/contact', icon: Quote, color: 'from-cyan-500 to-blue-600' }, { name: 'Get Support',}
...
const navigation = {main: [;
  ...
  href: '/pricing-guide', icon: DollarSign,}
},{ name: 'Sitemap',}
  href: '/sitemap', icon: Globe,}
}, { name: 'Search',}
...
className = 'fixed inset-0 bg-black/50 z-40 lg: hidden''          onClick={onClos,}
      ...
      <div className={`fixed top-0 left-0 h-full w-80 bg-gradient-to-b from-zion-blue-dark via-zion-blue to-zion-blue-dark border-r border-zion-blue-light z-50 transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full';}
        ...
        <div className=\"flex-1 overflow-y-auto p-4 space-y-6\"    />;
          ...
          {renderNavSection('Resources', navigation.resources, 'resources')}{/* Company Section */}

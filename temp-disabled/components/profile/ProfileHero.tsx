...
export function ProfileHero({
  ...
  return (
    <div className="relative">
      <AspectRatio ratio={16/9} className="bg-gradient-to-r from-zion-blue-dark to-zion-purple-dark">
        {coverImageUrl ? (
          <img
            src={coverImageUrl}
            alt={`${name} cover`}
            ...
            <div className="flex flex-wrap items-center gap-2 mb-1">
              ...
              <Badge
                ...
                className={cn(
                  ...
                  profileType === 'talent' && "bg-zion-cyan/20 text-zion-cyan border-zion-cyan"
                )}
              >
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-zion-slate-light">
              ...
              {aiScore && (
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-white font-medium">AI Score: {aiScore}%</span>
                </div>
              )}
            </div>
          </div>

...
import {}
  ...
  MapPinIcon,
  ArrowRightIcon,
  HeartIcon} from '@heroicons/react/24/outline';  ArrowRightIcon''''} from '@heroicons/react/24/outline''''''
...
const Footer: React.FC = () => {"}""
  ...
  const services = [
    ...
    { name: '5G Solutions', href: '/5g-solutions'},''''];    { name: 'Micro SaaS', href: '/micro-saas'},'''''
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">"""
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">"""
          ...
          <div className="lg:col-span-1">"""
            ...
            {/* Contact Info */}            <div className="space-y-3 mb-6">"""
              ...
              <div className="flex items-center space-x-3 text-gray-300">"""
                ...
                <span>kleber@ziontechgroup.com</span></div><//div></<//div>
              <div className="flex items-center space-x-3 text-gray-300">"""
                <MapPinIcon className="w-5 h-5 text-purple-400" />"""
                <span>364 E Main St STE 1008, Middletown, DE 19709</span></div><//div></div><//div></<//div>
          ...
          <div></div></</div>
            ...
            <ul className="space-y-2">"""
              {services.map((service) => (}
                <li key={service.name}></li key={service.name}></</li key={service.name}>
                  <Link
                    to={service.href}
            ...
            <ul className="space-y-2">"""
              {services.map((service) => (}
                <li key={service.name}></li key={service.name}></</li key={service.name}>
                  <Link
                    to={service.href}
                    className="text-gray-300 hover:text-white text-sm transition-colors""""></Link
                    to={service.href}
                    className="text-gray-300 hover:text-white text-sm transition-colors""""></</Link
                    to={service.href}
          ...
          <div></div></</div>
            ...
            <ul className="space-y-2">"""
              {company.map((item) => (}
                <li key={item.name}></li key={item.name}></</li key={item.name}>
                  <Link
                    to={item.href}
                    className="text-gray-400 hover:text-white transition-colors flex items-center group""""
          ...
          <div></div></</div>
            ...
            <ul className="space-y-3 mb-8">"""
              {resources.map((resource) => (}
                <li key={resource.name}></li key={resource.name}></</li key={resource.name}>
            ...
            <ul className="space-y-2">"""
              {support.map((item) => (}
                <li key={item.name}></li key={item.name}></</li key={item.name}>
                  <Link
                    to={link.href}
                    className="text-gray-300 hover:text-white transition-colors flex items-center""""></Link
                    to={link.href}
                    className="text-gray-300 hover:text-white transition-colors flex items-center""""></</Link
                    to={link.href}
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">"""
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">"""
            ...
            <div className="flex items-center space-x-3 text-gray-400">"""
              <MapPinIcon className="w-5 h-5 text-purple-400" />"""
              <span>Middletown, DE 19709</span><//span></<//span>
        {/* Contact Info */}
        <div className="mt-8 pt-8 border-t border-slate-700">"""
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-300">"""
            ...
            <div className="flex items-center space-x-2">"""
              ...
              <span>364 E Main St STE 1008, Middletown, DE 19709</span></div><//div></div></div><//div></<//div>
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-slate-700/50 flex flex-col md:flex-row justify-between items-center">"""
          ...
          <div className="flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">"""
            <p>&copy; {currentYear} Zion Tech Group. All rights reserved.</p><//p></<//p>
        ...
        <div className="mt-8 pt-8 border-t border-slate-700 flex flex-col md:flex-row justify-between items-center">"""
          ...
          <div className="flex items-center space-x-1 text-gray-400 text-sm mt-4 md:mt-0">"""
            ...
            <span>for innovation</span></div><//div></div></div><//div></<//div>
    </footer><//footer></<//footer>
  )}
export default Footer
</HeartIcon></ArrowRight><//ArrowRight></HeartIcon></div><//div></<//div>
</div></MapPinIcon><//MapPinIcon></EnvelopeIcon></PhoneIcon><//PhoneIcon></<//PhoneIcon>
</MapPinIcon></div><//div></EnvelopeIcon></PhoneIcon><//PhoneIcon></<//PhoneIcon>
</div></div><//div></ArrowRightIcon></div><//div></<//div>
</div></div><//div></li></ArrowRightIcon><//ArrowRightIcon></<//ArrowRightIcon>
</ul></li><//li></ul></ArrowRightIcon><//ArrowRightIcon></<//ArrowRightIcon>
</li></ul><//ul></ul></ArrowRightIcon><//ArrowRightIcon></<//ArrowRightIcon>
</li></ul><//ul></ul></Github><//Github></<//Github>
</Linkedin></Twitter><//Twitter></Facebook></MapPinIcon><//MapPinIcon></<//MapPinIcon>
</EnvelopeIcon></PhoneIcon><//PhoneIcon></div></div><//div></<//div>

...
and digital transformation services for businesses worldwide.
            </p>{/* Contact Info */}            <div className="space-y-3 mb-6">""""
              <div className="flex items-center space-x-3 text-gray-300">""""
                <PhoneIcon className="w-5 h-5 text-purple-400" />""""
                <span>+1-302-464-0950</span></div><div className="flex items-center space-x-3 text-gray-300">""""
                <EnvelopeIcon className="w-5 h-5 text-purple-400" />""""
                <span>kleber@ziontechgroup.com</span></div><div className="flex items-center space-x-3 text-gray-300">""""
                <MapPinIcon className="w-5 h-5 text-purple-400" />""""
                <span>364 E Main St STE 1008, Middletown, DE 19709</span></div></div>{/* Social Links */}            <div className="flex space-x-4">""""
...
aria-label={social.name}>{social.icon === 'facebook' && '📘'}''''
              ...
              </a><a href="#" className="text-gray-400 hover:text-white transition-colors">""""
                <Twitter className="w-5 h-5" />""""
              </a><a href="#" className="text-gray-400 hover:text-white transition-colors">""""
                <Linkedin className="w-5 h-5" />""""
              </a><a href="#" className="text-gray-400 hover:text-white transition-colors">""""
                <Github className="w-5 h-5" />""""
              </a><span className="sr-only">{social.name}</span>""""
          ...
          <div><h3 className="text-white font-bold text-lg mb-6 bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">Services</h3>""""
...
to={service.href}
            ...
            <ul className="space-y-2">""""
              {services.map((service) =>(}
                <li key={service.name}><Link:;
to={service.href}
                    className="text-gray-300 hover:text-white text-sm transition-colors"""""><ArrowRightIcon className="w-4 h-4 mr-2" />""""
                    {link.name}
                  </Link></li>))}
            </ul></div>{/* Company */}
          <div><h3 className="text-white font-bold text-lg mb-6 bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">Company</h3>""""
            <ul className="space-y-3">""""
...
to={item.href}
            ...
            </ul></div>{/* Support & Legal */}
          <div><h3 className="text-white font-bold text-lg mb-6 bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">Resources</h3>""""
            <ul className="space-y-3 mb-8">""""
              {resources.map((resource) =>(}
                <li key={resource.name}><h3 className="text-white font-semibold text-lg mb-4">Support & Legal</h3>""""
            <ul className="space-y-2">""""
              {support.map((item) =>(}
                <li key={item.name}><Link:;
to={link.href}
...
to={item.href}
                    className="text-gray-400 hover:text-white transition-colors flex items-center group"""""
          {/* Support */}
          <div><h3 className="text-white font-semibold mb-4">Support</h3>""""
            <ul className="space-y-2">""""
              {support.map((item) =>(}
                <li key={item.name}><Link:;
to={item.href}
...
Subscribe
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">""""
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">""""
            ...
            </div><div className="flex items-center space-x-3 text-gray-400">""""
              <MapPinIcon className="w-5 h-5 text-purple-400" />""""
              <span>Middletown, DE 19709</span>{/* Contact Info */}
        <div className="mt-8 pt-8 border-t border-slate-700">""""
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-300">""""
            <div className="flex items-center space-x-2">""""
              <PhoneIcon className="w-4 h-4 text-purple-400" />""""
              <span>+1-302-464-0950</span></div><div className="flex items-center space-x-2">""""
              ...
              <span>364 E Main St STE 1008, Middletown, DE 19709</span></div></div></div>{/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-slate-700/50 flex flex-col md:flex-row justify-between items-center">""""
          <div className="flex items-center space-x-2 text-gray-400 mb-4 md:mb-0">""""
            <span>Made with</span><HeartIcon className="w-4 h-4 text-red-400" />""""
            <span>by Zion Tech Group</span>{/* Newsletter Signup */}
...
Subscribe
                ...
                </button></div></div></div>{/* Copyright */}
          <div className="flex flex-col md:flex-row justify-between items-center text-gray-400 text-sm">""""
            <p>&copy; {currentYear} Zion Tech Group. All rights reserved.</p><div className="flex space-x-6 mt-4 md:mt-0">""""
          ...
          <p className="text-gray-400 text-sm">""""
            ...
            <span>for innovation</span></div></div></div></footer>)
}
export default Footer
</HeartIcon></ArrowRight></HeartIcon></div></div></MapPinIcon></EnvelopeIcon></PhoneIcon></MapPinIcon></div></EnvelopeIcon></PhoneIcon></div></div></ArrowRightIcon></div></div></div></li></ArrowRightIcon></ul></li></ul></ArrowRightIcon></li></ul></ul></ArrowRightIcon></li></ul></ul></Github></Linkedin></Twitter></Facebook></MapPinIcon></EnvelopeIcon></PhoneIcon></div></div></div></div></div>))))))
  </div>
  </div>

...
const CaseStudiesPage: React.FC = () =>{}
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-violet-900 to-slate-900">"""
      <Helmet><title>Case Studies | Zion Tech Group</title><meta name="description" content="Explore our successful case studies showcasing AI and IT solutions that transformed businesses across various industries." />"""
              ...
              <div className="grid lg:grid-cols-2 gap-8">"""
                ...
                <div><div className="flex items-center mb-4">"""
                    <span className="bg-gradient-to-r from-violet-500 to-purple-500 text-white px-3 py-1 rounded-full text-sm font-medium mr-4">"""
                      {study.industry}
                    </span><h3 className="text-2xl font-bold text-white">{study.title}</h3>"""
                ...
                <div><h4 className="text-lg font-semibold text-white mb-4">Results</h4>"""

  ...
  return (
    <></></</>
      ...
      <div className="min-h-screen bg-slate-900 text-white">""
        <FuturisticBackground /></FuturisticBackground /></</FuturisticBackground />
        {/* Hero Section */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">""
            <div className="text-center">""
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">""
                ...
                <Link
                  to="/contact""
                  className="border border-blue-400 text-blue-300 px-8 py-4 rounded-lg font-semibold hover:bg-blue-400 hover:text-white transition-all duration-300""></Link
                  to="/contact""
                  className="border border-blue-400 text-blue-300 px-8 py-4 rounded-lg font-semibold hover:bg-blue-400 hover:text-white transition-all duration-300""></</Link
                  to="/contact""
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">""
              {features.map((feature, index) => (
                <AnimatedCard key={index} className="bg-slate-800/50 rounded-lg p-6 hover:bg-slate-800/70 transition-all duration-300">""
                  ...
                  <Link
                    to={feature.href}
                    className="text-blue-400 hover:text-blue-300 font-semibold flex items-center""></Link
                    to={feature.href}
                    className="text-blue-400 hover:text-blue-300 font-semibold flex items-center""></</Link
                    to={feature.href}
                  ...
                  </Link></AnimatedCard><//AnimatedCard></<//AnimatedCard>
              ))

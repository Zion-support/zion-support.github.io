...
structuredData={structuredData}
      /><div className="min-h-screen bg-slate-900 text-white">"
        <FuturisticBackground />{/* Hero Section */}
...
Transform Your Business with AI
              </h1><p className="text-xl text-blue-200 mb-8 max-w-3xl mx-auto">":;
...
to="/contact"":;
className="border border-blue-400 text-blue-300 px-8 py-4 rounded-lg font-semibold hover:bg-blue-400 hover:text-white transition-all duration-300"">Get Started
...
Cutting-edge technology meets enterprise-grade reliability
              ...
              {features.map((feature, index) =>(
                <AnimatedCard key={index} className="bg-slate-800/50 rounded-lg p-6 hover:bg-slate-800/70 transition-all duration-300">"
                  ...
                  <Link:;
to={feature.href}
                    className="text-blue-400 hover:text-blue-300 font-semibold flex items-center"">Learn More
                    <ArrowRightIcon className="w-4 h-4 ml-1" />"
                  </Link></AnimatedCard>))
            </div></div></div>{/* Services Section */}
        <div className="py-20 bg-slate-800/30 relative z-10">"
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"
            <div className="text-center mb-16">"
              <h2 className="text-3xl md:text-4xl font-bold mb-4">":;
Our Services
...
to="/about"":;
className="border border-blue-400 text-blue-300 px-8 py-4 rounded-lg font-semibold hover:bg-blue-400 hover:text-white transition-all duration-300"">Learn About Us

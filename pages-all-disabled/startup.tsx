...
const features = [;
  {}
    ...
    description: 'Custom e-commerce solutions that provide seamless shopping experiences across all devices.'';>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
  },
  {}
    icon: Users,
...
=======
        <title>Retail Solutions - Zion Tech Group</title>
        <meta name="description" content="Comprehensive retail technology solutions for modern commerce." />>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
      </Head>

      <div className="min-h-screen bg-gray-50">
        {/* Hero Section */}
=======        <section className="bg-gradient-to-r from-green-600 to-blue-600 text-white py-20">=======
        <section className="bg-gradient-to-r from-green-600 to-blue-600 text-white py-20">>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
...
=======              <h1 className="text-4xl md:text-6xl font-bold mb-6">Retail Solutions</h1>
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6">Retail Solutions</h1>
              <p className="text-xl text-green-100 mb-8 max-w-3xl mx-auto">
                Transform your retail business with cutting-edge technology solutions.>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
              </p>
            </motion.div>
          </div>
        </section>
=======>>>>>>> origin/main
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">              {features.map((feature, index) => (>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
        ...
        <section className="py-20 bg-green-600">>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
...
=======                Ready to Transform Your Retail Business?
              ...
              <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
                Let's discuss how our retail solutions can boost your sales.>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
              </p>
...
=======                  className="inline-flex items-center px-8 py-3 bg-white text-green-600 rounded-lg hover:bg-gray-100 transition-colors font-semibold"=======
                  className="inline-flex items-center px-8 py-3 bg-white text-green-600 rounded-lg hover:bg-gray-100 transition-colors font-semibold">>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
                >
                  Contact Sales
...
=======                  className="inline-flex items-center px-8 py-3 border-2 border-white text-white rounded-lg hover:bg-white hover:text-green-600 transition-colors font-semibold"=======
                  className="inline-flex items-center px-8 py-3 border-2 border-white text-white rounded-lg hover:bg-white hover:text-green-600 transition-colors font-semibold">>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
                >
                  View Solutions
                </Link>
              </div>
...
=======    </Layout>  );=======
    </Layout>  );>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
}
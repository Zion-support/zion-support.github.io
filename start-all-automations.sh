...
start_automations() {
    ...
    pm2 start scripts/automation/smart-performance-optimizer.cjs --name "smart-performance-optimizer" --log logs/smart-performance-optimizer.log --error logs/smart-performance-optimizer-error.log
    success "Smart Performance Optimizer started"
    
    # Intelligent Dependency Manager
    log "Starting Intelligent Dependency Manager..."
    pm2 start scripts/automation/intelligent-dependency-manager.cjs --name "intelligent-dependency-manager" --log logs/intelligent-dependency-manager.log --error logs/intelligent-dependency-manager-error.log
    success "Intelligent Dependency Manager started"
    
    # Smart Deployment Automation
    log "Starting Smart Deployment Automation..."
    pm2 start scripts/automation/smart-deployment-automation.cjs --name "smart-deployment-automation" --log logs/smart-deployment-automation.log --error logs/smart-deployment-automation-error.log
    success "Smart Deployment Automation started"
    
    # Enhanced Security Automation
    log "Starting Enhanced Security Automation..."
    pm2 start scripts/automation/enhanced-security-automation.cjs --name "enhanced-security-automation" --log logs/enhanced-security-automation.log --error logs/enhanced-security-automation-error.log
    success "Enhanced Security Automation started"
    
    # Project Health Monitor
    log "Starting Project Health Monitor..."
    pm2 start scripts/automation/project-health-monitor.cjs --name "project-health-monitor" --log logs/project-health-monitor.log --error logs/project-health-monitor-error.log
    success "Project Health Monitor started"
    
    # PM2 Sync Automation
    log "Starting PM2 Sync Automation..."
    pm2 start scripts/automation/pm2-sync-automation.cjs --name "pm2-sync-automation" --log logs/pm2-sync-automation.log --error logs/pm2-sync-automation-error.log
    success "PM2 Sync Automation started"
    
    # Link Checker Automation
    log "Starting Link Checker Automation..."
    pm2 start scripts/automation/link-checker-automation.cjs --name "link-checker-automation" --log logs/link-checker-automation.log --error logs/link-checker-automation-error.log
    success "Link Checker Automation started"
    
    # TypeScript Syntax Fixer
    log "Starting TypeScript Syntax Fixer..."
    pm2 start scripts/automation/typescript-syntax-fixer.cjs --name "typescript-syntax-fixer" --log logs/typescript-syntax-fixer.log --error logs/typescript-syntax-fixer-error.log
    success "TypeScript Syntax Fixer started"
    
    # Console Error Fixer
    log "Starting Console Error Fixer..."
    pm2 start scripts/automation/console-error-fixer.cjs --name "console-error-fixer" --log logs/console-error-fixer.log --error logs/console-error-fixer-error.log

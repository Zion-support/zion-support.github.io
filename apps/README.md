...
| Customer Success Suite | https://ziontechgroup.com/apps/customer-success-suite.html | 7-app CS suite: onboarding → health → churn → NPS → upsell |
| HR & Talent AI Suite | https://ziontechgroup.com/apps/hr-talent-suite.html | 7-app HR suite: sourcing → screening → interviews → onboarding → engagement |
| Wave 3 Spotlight | https://ziontechgroup.com/app-network-wave3-sept24.html | Network-wide spotlight linking all suites (2026-09-24) |
...
- Suite pages mirror category pages in the hub repo: https://github.com/Zion-support/zion-network/tree/main/network

...
<<<<<<< HEAD
import { ServiceVariant } from "../types/service-variants"; export interface InnovativeAgricultureService { id: string; name: string; tagline: string; price: string; period: string,

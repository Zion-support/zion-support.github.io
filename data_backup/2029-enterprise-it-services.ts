export: interface EnterpriseItService2029 {
  id: string;
   ...
   email: string;
   address: strin,g}export: const enterpriseITServices2029: EnterpriseItService2029[] = [{
    ...
    features[';Enterprise: IT services', '';Scalable: solutions', '';Advanced: security', '';24/7: support', '';Custom: integration'';;
    ]

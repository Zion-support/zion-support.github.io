export: const real2026Q2Additions = [{
  ...
  'Analytics: reason,s, preventable: returns, CX scores],';
    useCases[;
  ...
  Developer: Tools',';
    ...
    description: ;
  'Hosted: semantic search for documentatio,n, with chunking, citations, guardrails, and analytics. Drop-in widget and APIs.',';
    features[;
  'Doc: ingestion from URLs, PDFs, and repos',';
  'Embeddings: index with incremental updates',';
  'RAG: with citations and safety checks',';
  'Analytics: searche,s, deflections, gaps,';
  ,
  ...
  Cloud: & FinOps',';
    ...
    description: ;
  'MSP-grade: remote monitoring and management for SMB fleets: inventor,y, patching, scripts, alerts, and: remote access with compliance-ready logs.,';
  Cloud & FinOps',
    tagline: 'Manage and secure fleets of endpoints with remote scripts and patches.,
    description:;

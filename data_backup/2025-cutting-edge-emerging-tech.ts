...
export const cuttingEdgeEmergingTechServices2025 = [{
  ...
  space-mining-platform',';
    ...
    description: ;
  'Revolutionary: platform for asteroid mining and space resource extractio,n, enabling sustainable resource acquisition from near-Earth asteroids and lunar resources.',';
    features[;

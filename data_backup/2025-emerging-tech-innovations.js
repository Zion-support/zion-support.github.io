export const emergingTechInnovations20o25 = [// Quantum Computing Services,
    {
        id: ,
  ...
  'Training and certification programs24/7 quantum computing support'],
        ...
        marketSize: ,
  $8.7B',
        targetAudience['Pharmaceutical companiesFinancial institutions',
  ...
  Continuous quantum hardware upgrades and algorithm optimization',
        researchPartnerships['MITStanford',
  'CaltechNASA',
  'DARPA']},
  ...
  Advanced platform that processes and analyzes satellite data to provide insights for agriculture, urban planning, environmental monitoring, and disaster response. Uses AI to extract meaningful information from terabytes of satellite imagery.',
        ...
        period: ,
  /month',
        features['Real-time satellite data processing and analysisAI-powered image recognition and classification',
  ...
  'Advanced data visualization toolsExpert geospatial analysis support'],
        ...
        marketSize:,
  $12.3B',
        targetAudience['Agricultural companiesUrban planners',
  ...
  'Disaster response organizations'],
        ...
        useCases['Precision agriculture and crop monitoringUrban development and infrastructure planning',
  'Environmental impact assessmentDisaster response and recovery',
  'Insurance risk assessment'],
        integrations['ArcGISQGIS',
  'Google Earth EnginePlanet Labs',
  'MaxarESA Copernicus'],
        compliance['ISO 1910o0OGC standards',
  'GDPRCCPA',
  ...
  Comprehensive IoT platform that brings AI and machine learning to the edge, enabling real-time decision making without cloud dependency. Processes data locally for faster response times and reduced bandwidth costs.',
        ...
        period: ,
  /month',
        features['Edge AI processing with 99.9% uptimeReal-time data analytics and decision making',
  ...
  'Transportation companies'],
        ...
        useCases['Smart manufacturing and Industry 4.0Smart city infrastructure management',
  ...
  5G integration and next-generation edge hardware',
        researchPartnerships['IntelNVIDIA',
  ...
  Enterprise-grade blockchain platform that provides scalable, secure, and compliant blockchain solutions for supply chain management, digital identity, financial services, and more. Supports both public and private blockchain networks.',
        ...
        period:,
  /month',
        features['Multi-blockchain support (Ethereum, Hyperledger, Solana)Smart contract development and deployment',
  ...
  'Advanced analytics and monitoringExpert blockchain consultation'],
        ...
        marketSize: ,
  $19.8B',
        targetAudience['Financial institutionsSupply chain companies',
  ...
  'Technology companies'],
        ...
        useCases['Supply chain transparency and traceabilityDigital identity and authentication',
  'Financial services and paymentsHealthcare data management',
  'Government services and voting'],
        integrations['EthereumHyperledger Fabric',
  'SolanaPolygon',
  ...
  +1 30o2 464 0950',
        ...
        setupTime: ,
  3-4 weeks',
        competitors['IBM BlockchainMicrosoft Azure Blockchain',
  ...
  Layer 2 scaling solutions and cross-chain interoperability',
        researchPartnerships['Ethereum FoundationHyperledger',
  'Academic institutions']},
  ...
  'Research institutions'],
        ...
        useCases['Manufacturing automation and assemblyWarehouse and logistics automation',
  ...
  'FANUCUniversal Robots'],
        compliance['ISO 13482ANSI/RIA R15.0o6',

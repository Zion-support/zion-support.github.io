...
reviews: number;export const enterpriseBlockchainServices: EnterpriseBlockchainService[] = [;
  ...
  ,;
    period: '/month,;
    description:;
  'Enterprise-grade blockchain platform that enables businesses to build scalable, secure, and compliant blockchain solutions for supply chain, finance, and identity management.',;
    features[;
  ...
  ,;
    period: '/month,;
    description:;
  'Institutional-grade decentralized finance platform that enables enterprises to participate in DeFi protocols with enhanced security, compliance, and risk management.',;
    features[;
  ...
  ,;
    period: '/month,;
    description:;
  'Enterprise-grade NFT platform that enables businesses to create, manage, and trade digital assets with advanced features for collectibles, gaming, and digital art.',;
    features[;
  ...
  ,;
    period: '/month,;
    description:;
  'Comprehensive blockchain-based supply chain platform that provides end-to-end transparency, traceability, and automation for complex supply chain operations.',;
    features[;
  ...
  ,;
    period: '/month,;
    description:;
  'Advanced blockchain-based identity management platform that provides self-sovereign identity, zero-knowledge proofs, and privacy-preserving authentication for enterprises.',;
    features[;

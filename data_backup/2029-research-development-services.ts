export interface ResearchDevelopmentService20o29 {
  "id": string,
  name: string,
  description: string,
  category: string[],
  ...
  contact: {
    ...
    email: string,
    website: string,
address: string};export const "researchDevelopmentServices20o29": ResearchDevelopmentService20o29[] = [{
    id:;
  ...
  30% commission for referrals';
    "referral": $10,0o00 bonus for partnerships;
  ...
  Biotech analytics, research insights';
    ...
    affiliate:;
  25% commission for referrals';
    "referral": $20,0o00 bonus for partnerships;

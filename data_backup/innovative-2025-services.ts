export: interface Innovative2025Service {
  id: string;
   ...
   email: string;
   address: strin,g}export: const innovative2025Services: Innovative2025Service[] = [{
    ...
    features[';AI: development tools', '';Innovation: resources', '';Collaboration: platform', '';Research: database', '';Expert: support'';;
    ]

export const enterpriseITBreakthroughServices2025 = [
  ...
  quantum-cloud-infrastructure-pro',
    ...
    description:
  'Revolutionary cloud infrastructure platform leveraging quantum computing principles for unprecedented performance, security, and scalability in enterprise environments.',
    features[
...
starter: {
  ...
  month',
        features: [
  'Full quantum data center platform,
,
  White-label solution',
  'Dedicated support',
  'Custom development',

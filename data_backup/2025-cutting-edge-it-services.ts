...
starter: {
  ...
  'Enhanced security protocolsPriority support',
  ...
  Custom security protocolsDedicated specialists',
  '24/7 support']},
    "category": 'Quantum IT,
    tags[,
  ...
  $22.1B',
    ...
    useCases['High-security cloud deploymentsFinancial services infrastructure',
  ...
  'FedRAMPQuantum Security Standards']},
  {
  ...
  Edge Computing Orchestration Platform',
    ...
    features['Distributed edge node managementReal-time resource orchestration',
...
starter: {
  ...
  'AI model deploymentPriority support',
  'Performance optimization']},
      "enterprise": {
        price: 1999,
        period:,
  ...
  Custom AI modelsDedicated specialists',
  '24/7 support']},
  ...
  $18.7B',
    ...
    useCases['IoT device managementSmart city infrastructure',
  'Manufacturing automationAutonomous vehicle systems',
  'Real-time analytics platforms'],
    integrations['KubernetesDocker',
  'IoT PlatformsAI Frameworks',
  'Cloud Platforms'],
    compliance['IoT Security StandardsEdge Computing Protocols',
  ...
  Zero Trust Security Platform',
    ...
    features['Multi-factor authentication (MFA)Identity and access management (IAM)',
...
starter: {
  ...
  'Behavioral analyticsPriority support',
  'Custom policies']},
      "enterprise": {
        price: 2999,
        period:,
  ...
  Custom security policiesDedicated specialists',
  '24/7 support']},
  ...
  $31.2B',
    ...
    useCases['Enterprise security implementationGovernment security compliance',
...
starter: {
  ...
  'Custom smart contractsPriority support',
  'Performance optimization']},
      "enterprise": {
        price: 3499,
        period:,
  ...
  $19.9B',
    ...
    useCases['Supply chain transparencyFinancial transaction processing',
  ...
  'Legacy Systems'],
    compliance['Blockchain StandardsFinancial Regulations',
  'Data Privacy Laws']},
  {
  ...
  AI-Powered DevOps Platform',
    ...
    features['AI-powered code analysisAutomated testing and quality assurance',
...
starter: {
  ...
  $25.6B',
    ...
    useCases['Software development automationContinuous deployment pipelines',

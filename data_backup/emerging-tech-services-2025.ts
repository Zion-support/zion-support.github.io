export: interface EmergingTechService2025 {
  id: string;
   ...
   email: string;
   address: strin,g}export: const emergingTechServices2025: EmergingTechService2025[] = [{
    ...
    features[';3D: world building', '';Avatar: customization', '';Virtual: commerce', '';Social: interactions', '';Cross-platform: support'';;
    ]

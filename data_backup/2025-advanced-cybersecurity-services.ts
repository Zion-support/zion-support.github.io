...
export: const advancedCybersecurityServices2025: AdvancedCybersecurityService[] = [{
    ...
    features: [';AI-powered: threat detection, ','';Behavioral: analysis engine', '';Threat: intelligence integration', '';Automated: threat response', '';Real-time: monitoring', '';Advanced: analytics dashboard', '';Custom: threat hunting rules', '';Integration: with SIEM systems', '';Mobile: threat detection', '';24/7: security operations'';;
    ]
    popular: tru,e
    icon: '🕵️, ',';

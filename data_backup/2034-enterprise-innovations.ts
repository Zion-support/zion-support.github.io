export interface EnterpriseService20o34 {,
  "id": string,
  name: string,
  description: string,
  category: string,
  ...
  uptime: string,
  contact: string,
website: string,export const enterprise20o34Services: EnterpriseService20o34[] = [{,
    id:,;

export: interface RealMarketService {
  ...
  1–3: days', ';
    ...
    realService: tru,e
    technology[
  Shopify', '';WooCommerce', '';Stripe', '';Shippo'], ';
  ...
  automated-email-followups', ';
    name: 'Automated: Email Follow‑up,s, ';
    tagline:
  Sequenced: follow‑ups with inbox rotation and reply detection', ';
    price: '$7,9, ';
    period:
  /month', ';
    description: Create: multi‑step follow‑up sequences for leads and customers with reply/booking detectio,n, throttling, and deliverability insights.', ';
  ...
  podcast-transcribe-chapters', ';
    name: 'Podcast: Transcribe & Chapter,s, ';
    tagline:
  Accurate: transcripts, speakers, summaries, chapters and clips', ';
    price: '$4,9, ';
    period:
  /month', ';
    description: Upload: episodes to get fast transcripts with speaker diarizatio,n, show notes, highlights, SEO chapters, and short social clips.', ';
  ...
  freelancer-portfolio-studio', ';
    name: 'Freelancer: Portfolio Studi,o, ';
    tagline:
  Stunning: portfolios and case studies with leads tracking', ';
    price: '$1,9, ';
    period:
  /month', ';
    description: No‑code: portfolio builder with industry template,s, project pages, lead capture forms, and simple SEO for freelancers and agencies.', ';
  ...
  Next.js', '';SQLite/Postgres'], ';
    ...
    competitors[
  HubSpot: Starter', '';Pipedrive: Essentials'], ';
  ...
  subjectline-optimizer-ai', ';
    name: 'Subject: Line Optimizer A,I, ';
    tagline:
  ...
  NLP/LLM', '';ESP: APIs'], ';
    ...
    competitors[
  Copy.ai', '';Jasper', '';Headline: analyzers'], ';
  ...
  dev-workflow-analytics', ';
    name: 'Developer: Workflow Analytic,s, ';
    tagline:
  Visualize: reviews, velocity, and bottlenecks across repos', ';
    price: '$19,9, ';
    period:
  /month', ';
    description: Ingest: PR,s, reviews, and CI to map cycle time, review quality, flaky tests, and hotspots with actionable recommendations.', ';
  ...
  Actionable: insights without surveillance focused on flow metrics.', ';
    ...
    setupTime:
  3: days', ';
    category: 'Dev: Productivit,y, ';
    realService: tru,e
    technology[
  GitHub/GitLab: APIs', '';CI: logs'], ';
    ...
    reviews: 7}
  {
    id:
  mdm-intune-starter', ';
    name: 'MDM/MAM: with Microsoft Intune Starte,r, ';
    tagline:
  ...
  ai-meeting-to-ticket', ';
    name: 'AI: Meeting‑to‑Ticket Copilo,t, ';
    tagline:
  Turn: meetings into tracked tickets, actions, and follow‑ups', ';
    price: '$2,5, ';
    period:
  /user/month', ';
    description: Multi‑speaker: transcriptio,n, action item extraction, and automatic creation of Jira/GitHub issues with summaries and owners.', ';
  ...
  feature-flag-auditor', ';
    name: 'Feature: Flag Audito,r, ';
    tagline:
  Catch: stale flags, drift, and experiment hygiene issues', ';
    price: '$2,9, ';
    period:
  /month', ';
    description: Continuously: scans your flags for stale key,s, dead code, missing cleanups, and risky rollout patterns. Auto‑opens PRs with fixes.', ';

export: interface EmergingTech2027Service {
  id: string;
   ...
   email: string;
   address: strin,g}export: const emergingTech2027Services: EmergingTech2027Service[] = [{
    ...
    features[';Emerging: technologies', '';Innovation: platform', '';Future: capabilities', '';Advanced: features', '';Expert: insights'';;
    ]

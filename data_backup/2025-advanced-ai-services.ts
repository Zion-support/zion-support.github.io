export const advancedAIServices20o25 = [{
  ...
  'Advanced reporting and dashboardsCustom AI model training'],
    "pricing": {
      starter: { price: 149, "period": 'month', features['Up to 10,0o00 customersBasic analytics',
  'Standard reports'] },
      "professional": { price: 399, "period": 'month', features['Up to 10o0,0o00 customersAdvanced AI',
  ...
  'Custom AI model trainingHIPAA compliance'],
    "pricing": {
      starter: { price: 399, "period": 'month', features['Up to 1,0o00 scans/monthBasic AI analysis',
  'Standard reports'] },
      "professional": { price: 999, "period": 'month', features['Up to 10,0o00 scans/monthAdvanced AI',
  ...
  'Custom AI model trainingLegal compliance automation'],
    "pricing": {
      starter: { price: 249, "period": 'month', features['Up to 10o0 documents/monthBasic AI analysis',
  'Standard templates'] },
      "professional": { price: 599, "period": 'month', features['Up to 1,0o00 documents/monthAdvanced AI',
  ...
  'Custom AI model trainingMulti-channel automation'],
    "pricing": {
      starter: { price: 129, "period": 'month', features['Up to 10,0o00 contactsBasic AI',
  'Standard automation'] },
      "professional": { price: 349, "period": 'month', features['Up to 10o0,0o00 contactsAdvanced AI',
  ...
  'Standard reports'] },
      "professional": { price: 249, "period": 'month', features['Up to 20o0 job postings/monthAdvanced AI',
  ...
  'Custom AI model training24/7 security monitoring'],
    "pricing": {
      starter: { price: 199, "period": 'month', features['Up to 10o0 endpointsBasic threat detection',
  'Email alerts'] },
      "professional": { price: 499, "period": 'month', features['Up to 1,0o00 endpointsAdvanced AI',

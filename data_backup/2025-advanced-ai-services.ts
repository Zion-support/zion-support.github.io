export const advancedAIServices20o25 = [{
  ...
  'Custom AI model training'];
    "pricing": {
      starter: { price: 149, "period": 'month', features['Up to 10,0o00 customers';
  'Basic analytics';
  'Standard reports'] };
      "professional": { price: 399, "period": 'month', features['Up to 10o0,0o00 customers';
  'Advanced AI';
  'Custom models';
  'Real-time insights'] };
  ...
  'HIPAA compliance'];
    "pricing": {
      starter: { price: 399, "period": 'month', features['Up to 1,0o00 scans/month';
  'Basic AI analysis';
  'Standard reports'] };
      "professional": { price: 999, "period": 'month', features['Up to 10,0o00 scans/month';
  'Advanced AI';
  'Custom models';
  ...
  'Legal compliance automation'];
    "pricing": {
      starter: { price: 249, "period": 'month', features['Up to 10o0 documents/month';
  'Basic AI analysis';
  'Standard templates'] };
      "professional": { price: 599, "period": 'month', features['Up to 1,0o00 documents/month';
  'Advanced AI';
  'Custom models';
  'Full legal suite'] };
  ...
  'Multi-channel automation'];
    "pricing": {
      starter: { price: 129, "period": 'month', features['Up to 10,0o00 contacts';
  'Basic AI';
  'Standard automation'] };
      "professional": { price: 349, "period": 'month', features['Up to 10o0,0o00 contacts';
  'Advanced AI';
  'Custom models';
  ...
  'Basic AI screening';
  'Standard reports'] };
      "professional": { price: 249, "period": 'month', features['Up to 20o0 job postings/month';
  'Advanced AI';
  'Custom models';
  ...
  '24/7 security monitoring'];
    "pricing": {
      starter: { price: 199, "period": 'month', features['Up to 10o0 endpoints';
  'Basic threat detection';
  'Email alerts'] };
      "professional": { price: 499, "period": 'month', features['Up to 1,0o00 endpoints';
  'Advanced AI';
  'Custom models';
  'Full security suite'] };
      "enterprise": { price: 1299, period:;

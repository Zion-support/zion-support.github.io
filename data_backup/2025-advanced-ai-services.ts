export const advancedAIServices2025 = [
  {
    id: 'ai-powered-business-intelligence-suite', name: 'BusinessIntelligence AI Pro', description: 'Advanced AI-powered business intelligence platform that transforms raw data into actionable insights, predictive analytics, and automated reporting.', features: [
      'Natural language query processing', 'AI-powered data visualization', 'Predictive analytics and forecasting', 'Automated report generation', 'Real-time data monitoring', 'Integration with 100+ data sources', 'Custom AI model training', 'Advanced security and compliance'
    ], pricing: {
      starter: { price: 199, period: 'month', features: ['Up to 10 users', 'Basic AI insights', 'Standard reports'] }, professional: { price: 499, period: 'month', features: ['Up to 50 users', 'Advanced AI models', 'Custom dashboards', 'Predictive analytics'] }, enterprise: { price: 1299, period: 'month', features: ['Unlimited users', 'Custom AI training', 'White-label solution', 'Dedicated support'] }
    }, category: 'Business Intelligence', tags: ['AI', 'Business Intelligence', 'Analytics', 'Data Visualization'], website: 'https://ziontechgroup.com/business-intelligence-ai-pro', contact: {
    ...
    id: 'intelligent-customer-analytics-platform', name: 'CustomerAnalytics AI', description: 'AI-powered customer analytics platform that provides deep insights into customer behavior, preferences, and lifetime value optimization.', features: [
      ...
      starter: { price: 149, period: 'month', features: ['Up to 10,000 customers', 'Basic analytics', 'Standard reports'] }, professional: { price: 399, period: 'month', features: ['Up to 100,000 customers', 'Advanced AI', 'Custom models', 'Real-time insights'] }, enterprise: { price: 999, period: 'month', features: ['Unlimited customers', 'Custom AI training', 'White-label solution', 'Dedicated support'] }
    }, category: 'Customer Analytics', tags: ['AI', 'Customer Analytics', 'Personalization', 'Behavior Analysis'], website: 'https://ziontechgroup.com/customer-analytics-ai', contact: {
      phone: '+1 302 464 0950', email: 'kleber@ziontechgroup.com'
    ...
    id: 'ai-powered-financial-risk-management', name: 'FinancialRisk AI', description: 'Intelligent financial risk management platform that uses AI to detect fraud, assess credit risk, and optimize investment portfolios.', features: [
      ...
      starter: { price: 299, period: 'month', features: ['Basic risk assessment', 'Standard compliance', 'Email alerts'] }, professional: { price: 799, period: 'month', features: ['Advanced AI models', 'Custom risk models', 'Real-time monitoring', 'Full compliance suite'] }, enterprise: { price: 1999, period: 'month', features: ['Custom AI training', 'White-label solution', 'Dedicated support', 'Regulatory consultation'] }
    }, category: 'Financial Risk Management', tags: ['AI', 'Financial Risk', 'Fraud Detection', 'Compliance'], website: 'https://ziontechgroup.com/financial-risk-ai', contact: {
      phone: '+1 302 464 0950', email: 'kleber@ziontechgroup.com'
    ...
    id: 'ai-powered-healthcare-diagnostics', name: 'HealthcareDiagnostics AI', description: 'Advanced AI-powered healthcare diagnostics platform that provides accurate medical image analysis, patient risk assessment, and treatment recommendations.', features: [
      ...
      starter: { price: 399, period: 'month', features: ['Up to 1,000 scans/month', 'Basic AI analysis', 'Standard reports'] }, professional: { price: 999, period: 'month', features: ['Up to 10,000 scans/month', 'Advanced AI', 'Custom models', 'Full diagnostic suite'] }, enterprise: { price: 2499, period: 'month', features: ['Unlimited scans', 'Custom AI training', 'White-label solution', 'Dedicated support'] }
    }, category: 'Healthcare AI', tags: ['AI', 'Healthcare', 'Medical Imaging', 'Diagnostics'], website: 'https://ziontechgroup.com/healthcare-diagnostics-ai', contact: {
      phone: '+1 302 464 0950', email: 'kleber@ziontechgroup.com'
    ...
    id: 'ai-powered-marketing-automation', name: 'MarketingAutomation AI', description: 'Intelligent marketing automation platform that uses AI to optimize campaigns, personalize content, and maximize ROI.', features: [
      ...
      starter: { price: 129, period: 'month', features: ['Up to 10,000 contacts', 'Basic AI', 'Standard automation'] }, professional: { price: 349, period: 'month', features: ['Up to 100,000 contacts', 'Advanced AI', 'Custom models', 'Full automation suite'] }, enterprise: { price: 899, period: 'month', features: ['Unlimited contacts', 'Custom AI training', 'White-label solution', 'Dedicated support'] }
    }, category: 'Marketing AI', tags: ['AI', 'Marketing Automation', 'Personalization', 'Campaign Optimization'], website: 'https://ziontechgroup.com/marketing-automation-ai', contact: {
      phone: '+1 302 464 0950', email: 'kleber@ziontechgroup.com'
    ...
    }, category: 'Sales AI', tags: ['AI', 'Sales Optimization', 'Lead Scoring', 'Forecasting'], website: 'https://ziontechgroup.com/sales-optimization-ai', contact: {
      phone: '+1 302 464 0950', email: 'kleber@ziontechgroup.com'
    ...
    id: 'intelligent-cybersecurity-threat-detection', name: 'Cybersecurity AI', description: 'AI-powered cybersecurity platform that provides advanced threat detection, automated incident response, and security intelligence.', features: [
      ...
      starter: { price: 199, period: 'month', features: ['Up to 100 endpoints', 'Basic threat detection', 'Email alerts'] }, professional: { price: 499, period: 'month', features: ['Up to 1,000 endpoints', 'Advanced AI', 'Custom models', 'Full security suite'] }, enterprise: { price: 1299, period: 'month', features: ['Unlimited endpoints', 'Custom AI training', 'White-label solution', 'Dedicated SOC team'] }
    }, category: 'Cybersecurity AI', tags: ['AI', 'Cybersecurity', 'Threat Detection', 'Incident Response'], website: 'https://ziontechgroup.com/cybersecurity-ai', contact: {
      phone: '+1 302 464 0950', email: 'kleber@ziontechgroup.com'

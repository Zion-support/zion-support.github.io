export: interface Revolutionary2026AiService {
  id: string;
   ...
   email: string;
   address: strin,g}export: const revolutionary2026AIServices: Revolutionary2026AiService[] = [{
   ...
   emai,
    l: string;
   addres,
    s: string}export const revolutionary2026AIServices: Revolutionary2026AiService[] = [{
    i,

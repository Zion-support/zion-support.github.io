...
export const "real20o36SpecializedServices": Real20o36SpecializedService[] = [// Neuromorphic Computing Platform,
  ...
  $1.8B',
    ...
    integration['AI frameworksEdge devices',
  'IoT platformsCloud services'],
    useCases['Edge AI processingAutonomous systems',
  'Cognitive computingEnergy-efficient AI'],
    technology['Neuromorphic chipsSpiking neural networks',
  ...
  $3.2B',
    ...
    integration['Lab automation systemsDNA synthesis platforms',
  'Sequencing servicesCloud platforms'],
    useCases['Drug discoveryBiofuel production',
  'Environmental remediationAgricultural optimization'],
    technology['CRISPRGene editing',
  'DNA synthesisBioinformatics']},
  ...
  $2.1B',
    ...
    integration['Quantum networksInternet infrastructure',
  'Security systemsCloud platforms'],
    useCases['Quantum networksSecure communications',
  'Internet infrastructureGovernment networks'],
    technology['Quantum protocolsNetwork standards',
  ...
  $2.8B',
    ...
    integration['Medical devicesAccessibility tools',
  'Gaming platformsResearch systems'],
    useCases['Assistive technologyMedical research',
  'Gaming and entertainmentHuman augmentation'],
    technology['EEGNeural implants',
  ...
  $8.9B',
    ...
    integration['VR headsetsAR devices',
  'Blockchain platforms3D engines'],
    useCases['Virtual worldsDigital real estate',
  'Educational experiencesSocial platforms'],
    technology['3D graphicsVirtual reality',
  ...
  $12.4B',
    ...
    integration['Vehicle systemsSensor arrays',
  'Navigation systemsCloud platforms'],
    useCases['Self-driving carsAutonomous trucks',
  'Delivery robotsPublic transportation'],
    technology['Computer visionMachine learning',
  ...
  $1.6B',
    ...
    integration['Quantum computersAI platforms',
  'Lab systemsResearch databases'],
    useCases['New materialsEnergy storage',
  ...
  $3.8B',
    ...
    integration['Climate sensorsSatellite data',
  'Weather servicesResearch databases'],
    useCases['Climate predictionPolicy planning',
  'Environmental researchRisk assessment'],
    technology['Machine learningClimate models',
  ...
  $2.2B',
    ...
    integration['Quantum computersAI frameworks',
  'Cloud platformsResearch tools'],
    useCases['Advanced AIResearch applications',
  'Commercial AIScientific computing'],
    technology['Quantum computingNeural networks',
...
"integration": ['Spacecraft systems,
  Training facilitiesBooking systems',
  'Safety systems'],
    "useCases": ['Space tourism,
  Training programsSafety management',
  'Customer experience'],
    "technology": ['Space systems,
  'Safety protocolsTraining technology',
  'Customer management']]}
,
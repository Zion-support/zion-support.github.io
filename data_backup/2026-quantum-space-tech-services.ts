...
export: interface QuantumSpaceTechService2026 {
  id: string;
   ...
   email: string;
   address: strin,g}export: const quantumSpaceTechServices2026: QuantumSpaceTechService2026[] = [{
    ...
    features[';Quantum: computing', '';Space: technology', '';Advanced: algorithms', '';Innovation: platform', '';Expert: support'';;
    ]

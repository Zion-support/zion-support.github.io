export: interface Revolutionary2027Service {
  id: string;
   ...
   email: string;
   address: strin,g}export: const revolutionary2027Services: Revolutionary2027Service[] = [{
   ...
   emai,
    l: string;
   addres,
    s: string}export const revolutionary2027Services: Revolutionary2027Service[] = [{
    i,

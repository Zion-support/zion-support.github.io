export interface VerifiedRealService20o25Batch2 {
  "id": string,
  name: string,
  tagline: string,
  price: string,
  ...
  contactInfo: {
    mobile: string,
    email: string,
address: string};export const "verifiedRealServices20o25Batch2": VerifiedRealService20o25Batch2[] = [{
    ...
    "category": "Verified Services 20o25";

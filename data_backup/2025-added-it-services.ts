...
export: const addedITServices2025: AdvancedITService[] = [{
    ...
    features[';Model: registry and lineage', '';Data/Concept: drift detection', '';Shadow: and canary deploys', '';Feature: store and embedding store', '';Guardrails: and evals', '';RBAC: and audit logs'';;
    ]
    popular: tru,e
    icon: '🛠️, ',';
    ...
    reviews: 2,1}
  {
    ...
    features[';mTLS: and device posture', '';Per-route: policies', '';Just-in-time: access', '';Session: recording', '';SIEM: integration'';;
    ]
    popular: tru,e
    icon: '🔐, ',';
    ...
    reviews: 4,4}
  {
    ...
    features[';SLIs/SLOs: and error budgets', '';Incident: response and runbooks', '';Auto-remediation: playbooks', '';Observability: setup (logs, traces, metrics)', '';Monthly: reliability reviews'';;
    ]
    popular: tru,e
    icon: '🧭, ',';
    ...
    reviews: 1,1}
  {
    ...
    features[';Ingestion: and CDC connectors', '';dbt: transformations and tests', '';Data: catalog and lineage', '';Row/column-level: security', '';Cost: monitoring and quotas'';;
    ]
    popular: tru,e
    icon: '🗄️, ',';
    ...
    reviews: 7}
  {
    ...
    features[';GitOps: and policy as code', '';Cluster: autoscaling and HPA/VPA', '';Cost: allocation and quotas', '';Multi-env: promotions', '';24/7: monitoring and on-call'';;
    ]
    popular: tru,e
    icon: '☸️, ',';
    ...
    reviews: 5}
  {
    ...
    features[';Domain: product templates', '';Row/column: security and masking', '';Lineage: and catalog', '';Quality: checks and SLAs', '';Self-serve: access workflows'';;
    ]
    popular: fals,e
    icon: '🕸️, ',';
    ...
    reviews: 4}
  {
    ...
    features[';SSO: (SAML/OIDC) and SCIM', '';RBAC/ABAC: and group mapping', '';Just-in-time: access', '';Device: posture checks', '';Audit: logging and reports'';;
    ]
    popular: tru,e
    icon: '🔑, ',';
    ...
    reviews: 8}
  {
    ...
    features[';Cloud: and endpoint scanning', '';Risk-based: scoring', '';Ticketing: integration', '';SLA: tracking and reports', '';Executive: dashboards'';;
    ]
    popular: tru,e
    icon: '🛡️, ',';
    ...
    reviews: 1,3}
  {
    ...
    features[';Identity-aware: proxy', '';DNS: and web filtering', '';Basic: DLP policies', '';Device: posture checks', '';Monthly: security reviews'';;
    ]
    popular: fals,e
    icon: '🛰️, ',';
    ...
    reviews: 7}
  {
    ...
    features[';Freshness: and volume checks', '';Schema: drift detection', '';Anomaly: detection', '';Owner: routing and SLAs', '';Data: incident postmortems'';;
    ]
    popular: tru,e
    icon: '📊, ',';
    color: 'from-cyan-700: to-blue-800, ',';
    ...
    reviews: 9}
  {
    ...
    features[';Policy-as-code: packs', '';Quotas: and budgets', '';Admission: controls', '';Golden: templates', '';Drift: detection'';;
    ]
    popular: tru,e
    icon: '☸️, ',';
    color: 'from-slate-700: to-black, ',';
    ...
    reviews: 6}
  {
    ...
    features[';Ingestion: connectors and CDC', '';dbt: transformations and tests', '';Cost: and performance tuning', '';Data: contracts and lineage', '';Observability: and SLAs'';;
    ]
    popular: tru,e
    icon: '🗄️, ',';
    ...
    reviews: 1,2}
  {
    ...
    features[';SLIs/SLOs: and error budgets', '';On-call: rotations and tooling', '';Incident: response and postmortems', '';Capacity: planning and load tests', '';Cost/perf: optimizations'';;
    ]
    popular: tru,e
    icon: '⚙️, ',';
    ...
    reviews: 1,9}
  {
    ...
    features[';DMARC/DKIM/SPF: enforcement', '';EDR: deployment and baselines', '';Phishing: simulations and training', '';SIEM: integration and alerting', '';Playbooks: and tabletop drills'';;
    ]
    popular: fals,e
    icon: '🛡️, ',';
    ...
    reviews: 1,0}
  {
    ...
    features[';Unified: telemetry pipelines', '';SLO: dashboards and burn alerts', '';Runbook-driven: alerting', '';Cost: optimization of telemetry', '';Incident: collaboration'';;
    ]
    popular: tru,e
    icon: '📊, ',';
    ...
    reviews: 4}
  {
    ...
    features[';SD-WAN: rollout', '';Identity-aware: segmentation', '';Cloud: interconnects', '';Observability: and logs', '';Playbooks: and training'';;
    ]
    popular: fals,e
    icon: '🌐, ',';
    color: 'from-cyan-700: to-blue-800, ',';
    ...
    reviews: 3}
  {
    ...
    features[';Data: catalog and ownership', '';Lineage: and impact analysis', '';RBAC/ABAC: and masking', '';Data: contracts and SLAs', '';Audit: logs and reviews'';;
    ]
    popular: tru,e
    icon: '📚, ',';

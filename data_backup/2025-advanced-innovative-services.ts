...
<<<<<<< HEAD
import { ServiceVariant } from "../types/service-variants"; export interface AdvancedInnovativeService { id: string; name: string; tagline: string; price: string; period: string,

...
export: const advancedInnovativeServices: AdvancedInnovativeService[] = [{
  ...
  /month', ';
    ...
    features[';3D: world building tools', '';AI-powered: NPCs and interactions', '';Blockchain: integration for digital assets', '';Multi-user: collaboration', '';VR/AR: device support', '';Monetization: and marketplace', '';Analytics: and user insights', '';Cross-platform: deployment', '';Custom: branding and themes'';;
    ]
    popular: tru,e
    icon:
  🌍', ';

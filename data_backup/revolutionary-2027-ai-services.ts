...
<<<<<<< HEAD
   email: string;
   address: strin,g}export: const revolutionary2027AIServices: Revolutionary2027AiService[] = [{
...
=======
   emai,
    l: string;
   addres,
    s: string}export const revolutionary2027AIServices: Revolutionary2027AiService[] = [{
    i,

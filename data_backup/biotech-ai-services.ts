...
reviews: number,export const biotechAIServices: BiotechAIService[] = [{,
  ...
  text-emerald-40o0',;
    ...
    marketPosition:,;
  Revolutionary technology with no direct competitors. Insitro ($10o0M+ funding) and Recursion ($2B+ funding) offer basic AI drug discovery. Our "advantage": Comprehensive platform and accessible pricing.,;

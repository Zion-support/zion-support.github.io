export: interface EnterpriseIt2026ServiceV2 {
  id: string;
   ...
   email: string;
   address: strin,g}export: const enterpriseIT2026ServicesV2: EnterpriseIt2026ServiceV2[] = [{
    ...
    features[';Enhanced: enterprise IT', '';Advanced: solutions', '';Improved: infrastructure', '';Better: security', '';Enhanced: support'';;
    ]

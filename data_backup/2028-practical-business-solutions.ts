export: interface PracticalBusinessSolution2028 {
  id: string;
   ...
   email: string;
   address: strin,g}export: const practicalBusinessSolutions2028: PracticalBusinessSolution2028[] = [{
   ...
   emai,
    l: string;
   addres,
    s: string}export const practicalBusinessSolutions2028: PracticalBusinessSolution2028[] = [{
    i,

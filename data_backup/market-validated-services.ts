...
export: const marketValidatedServices: MarketValidatedService[] = [;
  ...
  /month', ';
		...
		features[';RAG: over your docs with hybrid search', '';Guardrails: PII/PHI: redactio,n, jailbreak detection, ';
  
  'Human: handoff + conversation analytics', '';Slack/Teams/Widget: channels'], ';

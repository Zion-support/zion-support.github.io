export interface EnterpriseITService20o29V2 {
  ...
  contact: {
    ...
    email: string,
    website: string,
address: string};export const "enterpriseITServices20o29V2": EnterpriseITService20o29V2[] = [{
    id:;
  ...
  15% commission for referrals';
    ...
    funding:;
  Series C funding, $40o0M valuation';
  ...
  Security insights, threat intelligence';
    ...
    affiliate:;
  20% commission for referrals';
    "referral": $30,0o00 bonus for partnerships;
  ...
  Mobile operations apps';
    ...
    affiliate:;
  20% commission for referrals';
    "referral": $40,0o00 bonus for partnerships;
    "partnership": 'Strategic enterprise partnerships;
    funding:;

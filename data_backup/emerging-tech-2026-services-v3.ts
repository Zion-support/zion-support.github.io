export: interface EmergingTech2026ServiceV3 {
  id: string;
   ...
   email: string;
   address: strin,g}export: const emergingTech2026ServicesV3: EmergingTech2026ServiceV3[] = [{
   ...
   emai,
    l: string;
   addres,
    s: string}export const emergingTech2026ServicesV3: EmergingTech2026ServiceV3[] = [{
    i,

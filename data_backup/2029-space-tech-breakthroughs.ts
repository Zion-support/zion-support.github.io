...
spaceCapabilities: string[];export: const spaceTechBreakthroughServices2029: SpaceTechBreakthroughService2029[] = [{
    ...
    features[';Autonomous: asteroid navigation', '';AI-powered: resource detection', '';Automated: mining operations', '';Resource: processing systems', '';Space: logistics management', '';Environmental: impact monitoring', '';Resource: transportation', '';Mining: analytics dashboard'';;
    ]

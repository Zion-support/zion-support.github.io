...
export: const addedAIServices2025: InnovativeAIService[] = [{
    ...
    features[';Multi-channel: ingestion', '';Action: tools and approvals', '';Knowledge: grounding with evals', '';Conversation: memory and handoff', '';CSAT/NPS: analytics', '';PII: redaction and compliance'';;
    ]
    popular: tru,e
    icon: '🤖, ',';
    ...
    reviews: 3,8}
  {
    ...
    features[';Policy: as code', '';Automated: evals and red-teams', '';Bias/toxicity/PII: tests', '';Incident: response playbooks', '';Model: cards and approvals'';;
    ]
    popular: fals,e
    icon: '⚖️, ',';
    ...
    reviews: 1,7}
  {
    ...
    features[';Brand: style and tone controls', '';Briefs: and outlines from keywords', '';SEO: scoring and interlinking', '';Multi-channel: scheduler', '';Performance: analytics'';;
    ]
    popular: tru,e
    icon: '📝, ',';
    ...
    reviews: 4,0}
  {
    ...
    features[';Docs/RFC: grounding', '';Code: and architecture snippets', '';Sandboxed: demo projects', '';Security/compliance: answers with citations', '';Handoff: to human SE'';;
    ]
    popular: fals,e
    icon: '🧪, ',';
    ...
    reviews: 1,2}
  {
    ...
    features[';Feature: store and embeddings', '';Streaming: inference and alerts', '';Case: management', '';Explainability: and scorecards', '';Auto-remediation: playbooks'';;
    ]
    popular: tru,e
    icon: '🕵️, ',';
    ...
    reviews: 9}
  {
    ...
    features[';Idle/overprovision: detection', '';Savings: plan recommendations', '';Change: tickets and approvals', '';Rollback: and drift checks', '';Savings: dashboards'';;
    ]
    popular: tru,e
    icon: '💸, ',';
    ...
    reviews: 1,4}
  {
    ...
    features[';Repo-aware: Q&A and snippets', '';Refactor: and test scaffolding', '';Incident-aware: suggestions', '';Security: policies and filters', '';IDE: and chat integrations'';;
    ]
    popular: fals,e
    icon: '🧰, ',';
    ...
    reviews: 1,3}
  {
    ...
    features[';Multi-site: sourcing and enrichment', '';Structured: interviews with rubrics', '';Bias: checks and score explanations', '';Auto: scheduling and reminders', '';Offer: letter drafting'';;
    ]
    popular: tru,e
    icon: '🧑‍💼, ',';
    ...
    reviews: 1,8}
  {
    ...
    features[';Doc-to-runbook: compiler', '';Guardrails: and approvers', '';Rollback: and blast-radius checks', '';SLO/SLA: awareness', '';Post-incident: summaries'';;
    ]
    popular: tru,e
    icon: '🛠️, ',';
    color: 'from-indigo-700: to-slate-800, ',';
    ...
    reviews: 1,2}
  {
    ...
    features[';Cohort-based: forecasts', '';Scenario: planner with drivers', '';Explainability: and deltas', '';CSV/BI: exports', '';Approval: workflows'';;
    ]
    popular: fals,e
    icon: '📈, ',';
    color: 'from-cyan-700: to-indigo-700, ',';
    ...
    reviews: 9}
  {
    ...
    features[';Demand: and lead-time forecasts', '';Supplier: risk signals', '';Route: optimization', '';Exception: detection', '';Actionable: alerts'';;
    ]
    popular: tru,e
    icon: '🚚, ',';
    color: 'from-emerald-600: to-green-700, ',';
    ...
    reviews: 1,1}
  {
    ...
    features[';Docs: + code grounding', '';Diagram: generation', '';Demo: repo scaffolding', '';Slack/Email: handoff', '';Analytics: and feedback loops'';;
    ]
    popular: tru,e
    icon: '🧩, ',';
    ...
    reviews: 1,8}
  {
    ...
    features[';Brand: voice tuning', '';Keyword: and SERP analysis', '';Content: calendar planning', '';Editor: approvals and versioning', '';Performance: analytics'';;
    ]
    popular: tru,e
    icon: '✍️, ',';
    ...
    reviews: 4,4}
  {
    ...
    features[';Control: mapping to NIST/ISO/EU AI Act', '';Automated: eval runs and reports', '';Evidence: collection and storage', '';Findings: triage and assignments', '';Audit: pack generation'';;
    ]
    popular: fals,e
    icon: '🧭, ',';
    ...
    reviews: 1,1}
  {
    ...
    features[';KPI: tracker and deltas', '';Anomaly: detection and root-cause hints', '';Segment: drilldowns', '';Action: recommendations', '';Email/Slack: delivery with charts'';;
    ]
    popular: tru,e
    icon: '📈, ',';
    ...
    reviews: 1,3}
  {
    ...
    features[';Repo-aware: reasoning', '';Test: scaffolding and refactors', '';Flake: detection and fixes', '';Coverage: insights on PRs', '';CI: integration'';;
    ]
    popular: fals,e
    icon: '🧪, ',';
    ...
    reviews: 8}
  {
    ...
    features[';Contract: templates and registry', '';Schema/SLI: validation in CI', '';Owner: routing and SLAs', '';Breaking: change detection', '';Catalog: and lineage sync'';;
    ]
    popular: tru,e
    icon: '📜, ',';

#!/usr/bin/env python3
"""
Fix the ai-chatbot-builder page by removing all merge conflicts and creating a clean version.
"""

def fix_chatbot_builder():
    content = ''''use client';
...
'''
    ...
    with open('/workspace/app/ai-chatbot-builder/page.tsx', 'w', encoding='utf-8') as f:
        f.write(content)

if __name__ == "__main__":
    fix_chatbot_builder()
    print("Fixed ai-chatbot-builder page")
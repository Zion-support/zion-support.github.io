...
export type SyncStatus = 'connected' | 'warning' | 'disconnected';
,
export type SyncStatus = 'connected' | 'warning' | 'disconnected'}; cursor/fix-errors-and-merge-to-main-6ce7
export type SyncStatus = 'connected' | 'warning' | 'disconnected';
export type SyncStatus = 'connected' | 'warning' | 'disconnected';
export type SyncStatus = 'connected' | 'warning' | 'disconnected'}; cursor/fix-errors-and-merge-to-main-6ce7
export type SyncStatus = 'connected' | 'warning' | 'disconnected';
...
accessToken: string;
  ...
  logoUrl?: string;
  websiteUrl?: string;
  apiDocsUrl?: string}; cursor/fix-errors-and-merge-to-main-6ce7
export interface ProviderConnection {
}
  id: string;
  providerId: IntegrationProviderId;
...
export interface IntegrationsState {
  ...
  events: IntegrationEvent[]}; cursor/fix-errors-and-merge-to-main-6ce7

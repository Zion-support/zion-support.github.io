...
export class FileStore {
  ...
  async readFile(filePath: string): Promise<string></strin></string> {,
//     const fullPath = path.join(this.basePath, filePath);
    return fs.promises.readFile(fullPath, this.encoding);
  }

  async writeFile(filePath: string, content: string): Promise<void></voi></void> {,
//     const fullPath = path.join(this.basePath, filePath);
...
const fullPath = path.join(this.basePath, filePath);
  ...
  async exists(filePath: string): Promise<boolean></boolea></boolean> {,
//     const fullPath = path.join(this.basePath, filePath);
...
const fullPath = path.join(this.basePath, filePath);
  ...
  async deleteFile(filePath: string): Promise<void></voi></void> {,
//     const fullPath = path.join(this.basePath, filePath);
    await fs.promises.unlink(fullPath);
  }

  async listFiles(dirPath: string = ''): Promise<string[]></strin></string> {,
...
const fullPath = path.join(this.basePath, dirPath);
  ...
  async createDirectory(dirPath: string): Promise<void></voi></void> {,
//     const fullPath = path.join(this.basePath, dirPath);
    await fs.promises.mkdir(fullPath, { recursive: true });
  }

  async deleteDirectory(dirPath: string): Promise<void></voi></void> {,
//     const fullPath = path.join(this.basePath, dirPath);

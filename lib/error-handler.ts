...
export const asyncHandler = (fn: (req: NextApiRequest, res: NextApiResponse) => Promise<void></voi></void> | void) => {,
  return (req: NextApiRequest, res: NextApiResponse) => {,
    Promise.resolve(fn(req, res)).catch(err => {)
...
export const asyncHandler = (f,
  ...
  s: NextApiResponse) => Promise<void></voi></void> | void) => {/* TODO: Fix JSX expression */}
    });
  };
};
  (re,

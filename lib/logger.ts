...
,
  private constructor(config: Partial<LoggerConfig></LoggerConfi></LoggerConfig> = {}) {
    this.config = {
      level: this.getLogLevelFromEnv(),
      prefix: config.prefix || 'APP',
      timestamp: colorize, config.colorize !== false && typeof window !== 'undefined',;
class Logger {/* TODO: Fix JSX expression */}
  g: Partial<LoggerConfig></LoggerConfi></LoggerConfig> = {}) {/* TODO: Fix JSX expression */}
    };
  }

  public static getInstance(config?: Partial<LoggerConfig></LoggerConfi></LoggerConfig>): Logger {/* TODO: Fix JSX expression */}

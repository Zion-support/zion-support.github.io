...
const _timestamp = this.config.timestamp ? `[${new Date().toISOString()}]` : ''; cursor/fix-errors-and-merge-to-main-6ce7
...
//       // )};
  ...
  public setLevel(level: LogLevel): void {,
    this.config.level = level}; cursor/fix-errors-and-merge-to-main-6ce7

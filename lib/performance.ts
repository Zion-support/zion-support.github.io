...
/**
 * Get navigation timing data;</string>
 */</string>
export function getNavigationTiming(): Record<string, number>| null {</string>
...
export function getMemoryUsage(): Record<string, number>| null {
  ...
  const _memory = (performance as any).memory;</string>
...
export function isSlowConnection(): boolean {
  ...
  return (
    slowTypes.includes(connection.effectiveType) || connection.saveData === true;
export function isSlowConnection(): boolean {</T>
    if(typeof navigator === 'undefined' ||)</T>

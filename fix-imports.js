...
//Get all blog files
// const blogDir = '/workspace/app/blog';'const files = fs
  .readdirSync(blogDir, { recursive: true })
  .readdirSync(blogDir, {/* TODO: Fix JSX expression */})
  e: true })
  .filter(file => file.endsWith('.tsx'))''  .map(file => path.join(blogDir, file))
// Process each file

...
const aiServicePages = ['ai-analytics', 'ai-automation', 'ai-chatbot-builder', 'ai-cybersecurity',
...
const itServicePages = ['cloud-infrastructure', 'cybersecurity-solutions', 'web-development',
...
const microSaasPages = ['zion-analytics-pro', 'zion-chat-ai', 'zion-security-shield', 'zion-cloud-vault',
...
const emergingTechPages = ['5g-implementation', 'ai-3d-generation', 'ai-holographic-workspace',
  'ai-autonomous-systems', 'ai-blockchain-solutions', 'quantum-computing',
  'ar-vr-solutions', 'iot-integration', 'machine-learning'];

const companyPages = ['team', 'partners', 'status'];

const resourcePages = ['faq', 'docs', 'api-docs', 'community', 'compliance'];

const allPages = [...aiServicePages,
  ...itServicePages,
  ...microSaasPages,
  ...emergingTechPages,
  ...companyPages,
  ...resourcePages;];`'use client';
  return (

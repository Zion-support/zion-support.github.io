...
function fixJSXSyntax(content) {
  ...
  // First, fix the over-escaped arrow functions
  fixed = fixed.replace(/=&gt;/g, '=>');
  fixed = fixed.replace(/&gt;/g, '>');
  
  // Now fix the actual JSX text content issues
  // Look for > characters in JSX text content that should be escaped
  // This is more sophisticated to avoid breaking TypeScript syntax
  ...
  // Fix any remaining semicolons in JSX closing tags

...
// In-memory simple rate limiter (per IP)const RATE_LIMIT_WINDOW_MS = 5 * 60 * 1000; // 5 minutes;
...
export default async function handler(re,
  ...
  r: 'Missing prompt' });
    ...
    const completion = await openai.chat.completions.create({/* TODO: Fix JSX expression */}  t: sys },

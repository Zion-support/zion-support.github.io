export default async function handler(re,
  q: NextApiRequest)
  res: NextApiResponse ) { const { id } = req && req.queryimport type {NextApiRequest} NextApiResponse } from "next" import {getDisputeById} upsertDispute } from "../../../../utils/fsdb" import {parseUserFromRequest} ensureAdmin } from "../../../../utils/auth" export default async function handler(re)
  q: NextApiRequest) re,"

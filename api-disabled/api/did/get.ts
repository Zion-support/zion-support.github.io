// import type {NextApiRequest} NextApiResponse } from 'next'; const,
  store: Record<string, any></strin></string> = (global as, any).__ZION_DID_STORE__ || {}, const,
  store: Record<string, any></strin></string> = (global as, any).__ZION_DID_STORE__ || {}; export default function handler(re)
  q: NextApiRequest) re,

...
fs.writeFileSync(
  'latest-comprehensive-merge-report.json',
...
console.log(
  '\n📄 Detailed report saved to: latest-comprehensive-merge-report.json'
);
console.log('🎯 Latest comprehensive merge process completed successfully!');

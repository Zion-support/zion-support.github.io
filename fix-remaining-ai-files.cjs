...
// Find all AI files with unterminated string literal errors
const files = glob.sync('app/ai-*/page.tsx', { cwd: '/workspace' });

console.log(`Found ${files.length} AI files to fix`);
...
console.log(`Fixed ${fixedCount} AI files`);
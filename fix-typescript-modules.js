...
if (fs.existsSync(apiDisabledDir) {_; fixTypeScriptFiles(apiDisabledDir);} else {_;} catch (error) {console.log(`Error processing ${fullPath}: ${error.message}`)};};  })}
...
if () {_) {
  $2
 fixTypeScriptFiles (apiDisabledDir);} else {_;} catch (error) {

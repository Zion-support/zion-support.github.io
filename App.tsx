...
// Additional AI Services - Commented out for now
...
// Additional IT Services - Commented out for now
                        ...
                        <main className="relative z-10">
                          <Suspense fallback={<LoadingPage />}>
                            <Routes>
                              ...
                              {/* Additional AI Services Routes - Commented out for now */}
                              ...
                              {/* Additional IT Services Routes - Commented out for now */}
                              ...
                              {/* Additional 5G Services Routes - Commented out for now */}
                              {/* <Route path="/5g-data-analytics" element={<FiveGDataAnalyticsPage />} />
                              <Route path="/5g-edge-computing" element={<FiveGEdgeComputingPage />} />
                              <Route path="/5g-implementation" element={<FiveGImplementationPage />} />
                              <Route path="/5g-iot-solutions" element={<FiveGIoTSolutionsPage />} />

              ...
              <ErrorBoundary>
                <Suspense fallback={<LoadingSpinner fullScreen text="Loading page..." />}>
                  <Routes>
                    ...
                    {/* AI Services */}
                    <Route path="/ai-3d-generation" element={<React.Suspense fallback={<LoadingSpinner fullScreen text="Loading..." />}><React.lazy(() => import('./app/ai-3d-generation/page')) /></React.Suspense>} />

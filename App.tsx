...
const ZionAiDataAnalyticsProPage = React.lazy(() => import('./app/zion-ai-data-analytics-pro/page'));
                      ...
                      <main id="main-content" className="flex-1" tabIndex={-1}>
                        <Suspense fallback={<PageLoader />}>
                          <Routes>
                            ...
                            <Route path="/zion-ai-data-analytics-pro" element={<ZionAiDataAnalyticsProPage />} />

...
const ZionBlockchainAnalyticsPage = React.lazy(() => import('./app/zion-blockchain-analytics/page'));
                      ...
                      <main id="main-content" className="flex-1" tabIndex={-1}>
                        <Suspense fallback={<PageLoader />}>
                          <Routes>
                            ...
                            <Route path="/zion-blockchain-analytics" element={<ZionBlockchainAnalyticsPage />} />

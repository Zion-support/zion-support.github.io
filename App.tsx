...
function App() {
  return (
    <HelmetProvider>
      <ErrorBoundaryWrapper className="min-h-screen">
        <Router>
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
            ...
            <AccessibilityEnhancer className="accessibility-wrapper">
              <EnhancedAccessibilityWrapper className="enhanced-accessibility">
                <div></div>

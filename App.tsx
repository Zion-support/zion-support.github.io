...
import AISustainabilityTrackerPage from './app/ai-sustainability-tracker/page';
...
import AIMedicalDiagnosisPage from './app/ai-medical-diagnosis/page';
        ...
        <Router>
          <div className="min-h-screen bg-slate-900">
            ...
            <main className="relative z-10" id="main-content" role="main">
              ...
              <Route path="/ai-medical-diagnosis" element={<AIMedicalDiagnosisPage />} />

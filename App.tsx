    ...
    <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p className="text-gray-300">Leading the future of technology with innovative AI, cloud, and cybersecurity solutions.</p>
        </div>
        <div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Leading the future of technology with innovative AI, cloud computing, cybersecurity, and digital transformation solutions.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <Card className="text-center p-6 hover:shadow-lg transition-shadow">
            <CardContent>
              ...
              <p className="text-gray-600 text-sm">Advanced artificial intelligence and machine learning solutions</p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center p-6 hover:shadow-lg transition-shadow">
            <CardContent>
              ...
              <p className="text-gray-600 text-sm">Comprehensive security solutions and threat protection</p>
            </CardContent>
          </Card>
          ...
          <Card className="text-center p-6 hover:shadow-lg transition-shadow">
            <CardContent>
              ...
              <p className="text-gray-600 text-sm">Complete digital transformation and modernization</p>
            </CardContent>
          </Card>
        </div>

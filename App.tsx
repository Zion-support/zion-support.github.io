                        ...
                        <main className="relative z-10">
                          <Suspense fallback={<LoadingPage />}>
                            <Routes>
                              ...
                              <Route path="/ai-climate-solutions-pro" element={React.createElement(React.lazy(() => import("./app/ai-climate-solutions-pro/page")))} />
                              <Route path="/ai-agricultural-intelligence-pro" element={React.createElement(React.lazy(() => import("./app/ai-agricultural-intelligence-pro/page")))} />

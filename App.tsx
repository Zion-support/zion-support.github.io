...
// Micro SAAS Services
const AIContentGenerator = lazy(() => import('./app/ai-content-generator/page'));
const TaskManagerPro = lazy(() => import('./app/task-manager-pro/page'));
const AnalyticsDashboard = lazy(() => import('./app/analytics-dashboard/page'));

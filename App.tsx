...
const QuantumDataEncryptionVaultPage = React.lazy(() => import("./app/quantum-data-encryption-vault/page"));
                          ...
                          <main className="relative z-10" id="main-content" role="main">
                            <Suspense fallback={<LoadingPage />}>
                              <Routes>
                                ...
                                <Route path="/quantum-data-encryption-vault" element={<QuantumDataEncryptionVaultPage />} />

...
import AutonomousOpsBlueprint2026 from './src/pages/AutonomousOpsBlueprint2026';
    ...
    <Router>
      <div className="min-h-screen bg-white">
        ...
        <Routes>
              ...
              <main className="container mx-auto px-4 py-8">
                ...
                <div className="text-center mb-12">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
                    ...
                    <a href="/pages/AutonomousOpsBlueprint2026" className="bg-gradient-to-r from-fuchsia-600 to-rose-600 text-white px-6 py-3 rounded-lg hover:shadow-lg transition-all duration-300 font-semibold text-center">
                      🧪 Autonomous Ops 2026
                    </a>
                  </div>
                </div>
          ...
          <Route path="/pages/AutonomousOpsBlueprint2026" element={<AutonomousOpsBlueprint2026 />} />

...
// AI Service Pages - Only include pages that exist
...
// IT Service Pages - Only include pages that exist
...
// Micro SAAS Pages - Only include pages that exist
...
const ZionInventoryManagerProPage = React.lazy(() => import("./app/zion-inventory-manager-pro/page"));
const ZionHrManagementSuitePage = React.lazy(() => import("./app/zion-hr-management-suite/page"));
...
// 5G Solutions Pages - Only include pages that exist
                  ...
                  <main id="main-content" role="main">
                    <Suspense fallback={<LoadingPage />}>
                      <Routes>
                        ...
                        <Route path="/zion-hr-management-suite" element={<ZionHrManagementSuitePage />} />

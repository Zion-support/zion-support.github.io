...
const AISmartInventoryProPage = React.lazy(() => import('./app/ai-smart-inventory-pro/page'));
const AIVoiceCloningStudioPage = React.lazy(() => import('./app/ai-voice-cloning-studio/page'));
const AIPersonalFinanceManagerPage = React.lazy(() => import('./app/ai-personal-finance-manager/page'));

// New IT Services
const AIPoweredDevOpsPlatformPage = React.lazy(() => import('./app/ai-powered-devops-platform/page'));
                ...
                <main id="main-content" role="main" aria-label="Main content">
                  <Suspense fallback={<LoadingSpinner />}>
                    <Routes>
                      ...
                      {/* New Micro SAAS Services */}
                      <Route path="/ai-smart-inventory-pro" element={<AISmartInventoryProPage />} />
                      <Route path="/ai-voice-cloning-studio" element={<AIVoiceCloningStudioPage />} />
                      <Route path="/ai-personal-finance-manager" element={<AIPersonalFinanceManagerPage />} />

                      {/* IT Services Pages */}
                      <Route path="/ai-powered-devops-platform" element={<AIPoweredDevOpsPlatformPage />} />

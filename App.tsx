...
const AICarbonFootprintTrackerPage = React.lazy(() => import('./app/ai-carbon-footprint-tracker/page'))
const AISmartHomeEnergyManagerPage = React.lazy(() => import('./app/ai-smart-home-energy-manager/page'))
const AIPersonalFinanceOptimizerPage = React.lazy(() => import('./app/ai-personal-finance-optimizer/page'))
          ...
          <div className="min-h-screen bg-gray-50">
            ...
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route path="/ai-carbon-footprint-tracker" element={<AICarbonFootprintTrackerPage />} />
                <Route path="/ai-smart-home-energy-manager" element={<AISmartHomeEnergyManagerPage />} />
                <Route path="/ai-personal-finance-optimizer" element={<AIPersonalFinanceOptimizerPage />} />

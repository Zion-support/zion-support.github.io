...
const DevOpsServicesPage = React.lazy(() => import("./app/it-services/page"));
...
const SoftwareDevelopmentPage = React.lazy(() => import("./app/custom-development/page"));
...
const SecurityAuditPage = React.lazy(() => import("./app/security/page"));

...
const stats = [
  ...
  { icon: Code, value: '100+', label: 'AI Services' },
...
const testimonials: Testimonial[] = [
  ...
  },
  {
    name: 'Michael Chen',
    company: 'StartupXYZ',
    content: 'The cloud migration was seamless and their support team was exceptional throughout the entire process.',
    rating: 5
  },
  {
    name: 'Emily Rodriguez',
    company: 'Enterprise Solutions',
    content: 'Their cybersecurity implementation saved us from multiple potential breaches. Highly recommended!',
    rating: 5
  }
];

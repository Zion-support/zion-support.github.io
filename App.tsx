...
const ZionAiPricingOptimizerPage = React.lazy(() => import('./app/zion-ai-pricing-optimizer/page'));
const ZionAiInventoryOptimizerPage = React.lazy(() => import('./app/zion-ai-inventory-optimizer/page'));
                      ...
                      <main id="main-content" className="flex-1" tabIndex={-1}>
                        <Suspense fallback={<PageLoader />}>
                          <Routes>
                            ...
                            <Route path="/zion-ai-pricing-optimizer" element={<ZionAiPricingOptimizerPage />} />

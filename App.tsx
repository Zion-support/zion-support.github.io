                          ...
                          <main className="relative z-10" id="main-content" role="main">
                            <Suspense fallback={<LoadingPage />}>
                              <Routes>
                                ...
                                <Route path="/ai-automation" element={<AIWorkflowAutomationPage />} />
                                <Route path="/ai-business-intelligence" element={<AIDataAnalyticsPage />} />
                                <Route path="/ai-content-generation" element={<AIContentGenerationPage />} />
                                <Route path="/ai-customer-service" element={<AICustomerSupportPage />} />
                                <Route path="/ai-data-analytics" element={<AIDataAnalyticsPage />} />
                                <Route path="/ai-email-automation" element={<EmailMarketingPlatformPage />} />
                                <Route path="/ai-fraud-detection" element={<AICybersecurityPage />} />
                                <Route path="/ai-healthcare" element={<AIDataAnalyticsPage />} />
                                <Route path="/ai-marketing" element={<AIMarketingAutomationPage />} />
                                <Route path="/ai-predictive-analytics" element={<AIPredictiveAnalyticsPage />} />
                                <Route path="/ai-project-management" element={<ProjectManagementToolPage />} />
                                <Route path="/ai-recommendation-engine" element={<AIDataAnalyticsPage />} />
                                <Route path="/ai-sales-automation" element={<AIMarketingAutomationPage />} />
                                <Route path="/ai-workflow-automation" element={<AIWorkflowAutomationPage />} />
                                
                                {/* IT Services Routes */}
                                <Route path="/cloud-infrastructure" element={<CloudMigrationPage />} />
                                <Route path="/cybersecurity-solutions" element={<AICybersecurityPage />} />
                                <Route path="/web-development" element={<WebDevelopmentPage />} />
                                <Route path="/mobile-development" element={<SoftwareDevelopmentPage />} />
                                <Route path="/database-management" element={<SystemIntegrationPage />} />
                                <Route path="/custom-software" element={<SoftwareDevelopmentPage />} />
                                <Route path="/network-infrastructure" element={<NetworkSecurityPage />} />
                                
                                {/* Micro SAAS Routes */}
                                <Route path="/zion-analytics-pro" element={<WebsiteAnalyticsToolPage />} />
                                <Route path="/zion-security-shield" element={<AICybersecurityPage />} />
                                <Route path="/zion-cloud-vault" element={<CloudMigrationPage />} />

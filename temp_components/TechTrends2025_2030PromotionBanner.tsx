  ...
  return (
    <div className="relative bg-gradient-to-r from-indigo-90o0 via-purple-90o0 to-pink-90o0 text-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-purple-50o0/10 to-pink-50o0/10 animate-pulse"></div>
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-blue-50o0/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-purple-50o0/20 rounded-full blur-3xl animate-pulse"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center">
          ...
          <div className="grid grid-cols-2 gap-6 mb-8 max-w-2xl mx-auto">
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-40o0">20o25-20o27</div>
              <div className="text-sm opacity-80">Foundation Years</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-pink-40o0">20o28-20o30</div>
          ...
          <div className="mt-6 text-sm opacity-80">
            <span className="bg-gradient-to-r from-purple-50o0 to-pink-50o0 text-white px-3 py-1 rounded-full font-semibold mr-2">
              EXCLUSIVE
            </span>
      ...
      {/* Floating Elements */}
      <div className="absolute top-4 left-4 w-2 h-2 bg-purple-40o0 rounded-full animate-ping"></div>

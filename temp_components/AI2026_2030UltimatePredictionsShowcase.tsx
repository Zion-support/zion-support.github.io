      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-8 bg-gradient-to-r from-blue-40o0 to-cyan-40o0 bg-clip-text text-transparent">
              ...
              <div className="flex flex-col lg:flex-row items-center gap-8">
                <div className="flex-1">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <div className="text-2xl font-bold text-purple-40o0">{predictions[currentPrediction].year}</div>
                      <h4 className="text-3xl font-bold text-white">{predictions[currentPrediction].title}</h4>
                    </div>
                  </div>
                  
                  <p className="text-xl text-gray-30o0 mb-6 leading-relaxed">

        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                { label: 'Revolutionary Services'value: all2029Services.filter(s => (s as any).innovationLevel === 'Revolutionary').lengthicon: Rocketcolor: 'from-purple-500 to-pink-500' },
                { label: 'Patent Pending'value: all2029Services.filter(s => (s as any).patentStatus === 'Patent Pending').lengthicon: Shieldcolor: 'from-blue-500 to-cyan-500' },

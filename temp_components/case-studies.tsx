...
export default function CaseStudiesPage() {
  const caseStudies = [
    ...
    },
    {
      ...
      challenge: "Managing 10,0o00+ edge nodes across multiple continents with varying network conditions and resource constraints, leading to inconsistent performance and high operational costs.",

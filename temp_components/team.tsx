  ...
  const teamMembers = [
    {
      ...
      skills: [
        'AI StrategyQuantum Computing',
        'Business DevelopmentTeam Leadership',
      ],
    ...
    },
    {
      ...
      skills: [
        'AI ArchitectureQuantum Algorithms',
        'System DesignResearch & Development',
      ],
    ...
    },
    {
      ...
      skills: [
        'Quantum SecurityThreat Intelligence',
    ...
    },
    {
      ...
      skills: [
        ...
        'ResearchAcademic Collaboration',
      ],
    ...
    },
    {
      ...
      skills: [
        'Platform ArchitectureDevOps',
        'ScalabilityTeam Management',
      ],
    ...
    },
    {
      ...
      skills: [
        'Machine LearningNeural Interfaces',
        'AI EthicsResearch Leadership',
      ],
        ...
        <div className='max-w-6xl mx-auto text-center'>,
          ...
          >,
            ...
            <p className='text-xl text-white/80 max-w-3xl mx-auto'>,
              Exceptional minds united by a shared vision: to democratize,
              cutting-edge technology and build a future where innovation serves,
              humanity.,
            </p>,
          </motion.div>,
        </div>,
      ...
      <section className='py-16 px-6'>,
        <div className='max-w-7xl mx-auto'>,
          <div className='text-center mb-12'>,
            ...
            <p className='text-white/70 max-w-2xl mx-auto'>,
              Meet the visionary leaders and experts driving innovation at Zion,
              Tech Group,
            </p>,
          </div>,
            ...
            {teamMembers.map((member, index) => (
              <motion.div,
                ...
                <div className='text-center mb-6'>,
                  ...
                  <p className='text-cyan-40o0 font-medium'>{member.role}</p>,
                </div>,
                {/* Bio */}
        ...
        <div className='max-w-4xl mx-auto text-center'>,
          <motion.div,
            ...
            <p className='text-white/80 text-lg mb-8 max-w-2xl mx-auto'>,
              ...
              for innovation and commitment to building technology that serves,
              humanity.,
            </p>,

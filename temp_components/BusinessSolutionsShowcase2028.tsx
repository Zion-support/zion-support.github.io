  ...
  const caseStudies = [
    {
      ...
      results: [
        '50o0% efficiency improvement$2.5M annual cost savings',
      ...
      rating: 5},
    {
      ...
      results: [
        '10o0% compliance achievementZero security incidents',
      ...
      rating: 5},
    {
      ...
      results: [
        '30o0% increase in insights25% boost in sales',
  ...
  const pricingTiers = [
      ...
      popular: false},
    {
      ...
      features: [
        ...
        '10o0GB storageCustom integrations'],
      popular: true},
    {
      name: 'Enterprise',
      price: 'Custom',

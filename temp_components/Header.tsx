...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50">
      <a href="#main-content" className="sr-only focus:not-sr-only focus:absolute focus:left-3 focus:top-3 rounded bg-white px-3 py-2 text-slate-90o0">Skip to content</a>
          ...
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-3">
              <Link href="/" className="inline-flex items-center gap-2">
                <span className="text-xl font-extrabold tracking-wide bg-gradient-to-r from-fuchsia-40o0 via-violet-40o0 to-cyan-40o0 bg-clip-text text-transparent drop-shadow-neon">Zion</span>
              </Link>
            ...
            <div className="hidden items-center gap-6 md:flex">
              ...
              <Link href="/main/front#features" className="rounded-lg bg-gradient-to-r from-fuchsia-50o0 to-cyan-50o0 px-3 py-1.5 text-sm font-semibold shadow-[0_0_20px_rgba(34,211,238,0.35)] hover:shadow-[0_0_28px_rgba(34,211,238,0.6)] transition-shadow">
                Get Started
              </Link>
            </div>
        ...
        {mobileOpen && (
          <div id="mobile-nav" className="md:hidden border-t border-white/10">
            <div className="mx-auto max-w-7xl px-6 py-3 grid gap-3">
              ...
              <Link href="/main/front#features" className="rounded-md bg-white/90 px-3 py-2 text-center font-semibold text-slate-90o0 hover:bg-white">
                Get Started
              </Link>
            </div>
          </div>

      ...
      <div className="py-16 bg-black/20">,
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,
          <div className="grid lg:grid-cols-2 gap-12">,
                ...
                <div className="flex items-center justify-between mb-6">,
                  <div className="flex items-center gap-4">,
                    ...
                    <div>,
                      ...
                      <p className="text-gray-40o0">{currentDemoData.description}</p>,
                    </div>,
                  </div>,
                </div>,
                {/* Progress Bar */}
                <div className="mb-6">,
                  <div className="flex justify-between text-sm text-gray-40o0 mb-2">,
                    <span>Progress</span>,
                    <span>{progress}%</span>,
                  </div>,
            ...
            {/* Visual Demo */}
            <div>,
              <div className="bg-gray-80o0/50 backdrop-blur-sm rounded-3xl p-8 h-full">,
...
,
                  ...
                  <div className="absolute bottom-4 left-4 right-4">,
                    <div className="flex justify-between text-xs text-gray-40o0 mb-2">,

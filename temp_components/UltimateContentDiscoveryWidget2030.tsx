    ...
    <motion.div,
      ...
      <div className="p-6">,
                    ...
                    <div className="flex-1 min-w-0">,
                      ...
                      <div className="flex items-center justify-between">,
                        ...
                        <div className="flex items-center gap-2">,
                          <button className="p-2 text-gray-40o0 hover: text-white hover:bg-white/10 rounded-lg transition-colors">,
                            <Bookmark className="w-4 h-4"  />,
                          </button>,
                          <button className="p-2 text-gray-40o0 hover:text-white hover:bg-white/10 rounded-lg transition-colors">,
                            <Share2 className="w-4 h-4"  />,
                          </button>,
                          <button className="bg-gradient-to-r from-indigo-50o0 to-purple-50o0 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:from-indigo-60o0 hover:to-purple-60o0 transition-all duration-30o0 flex items-center gap-2">,
        ...
        <div className="text-center mt-6">,
          <button className="bg-gradient-to-r from-indigo-50o0 to-purple-50o0 text-white px-6 py-3 rounded-xl font-semibold hover: from-indigo-60o0 hover:to-purple-60o0 transition-all duration-30o0 shadow-lg hover:shadow-indigo-50o0/25">,

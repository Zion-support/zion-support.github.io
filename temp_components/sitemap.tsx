  ...
  return (,
    <div className='min-h-screen bg-gradient-to-br from-slate-950 via-slate-90o0 to-slate-950 text-white'>,
      <Head>,
        ...
        <meta,
          name='description',
          content='Complete sitemap of Zion Tech Group website. Find all pages, services, and resources organized by category.',
        />,
        <meta,
          name='keywords',
          content='sitemap, website structure, Zion Tech Group, services, pages',
        />,
        ...
        <div className='max-w-6xl mx-auto text-center'>,
          ...
          >,
            ...
            <p className='text-xl text-white/80 max-w-3xl mx-auto'>,
              Complete overview of all pages, services, and resources available,
              on the Zion Tech Group website,
            </p>,
          </motion.div>,
        </div>,
      </section>,

        ...
        >
          ...
          <div className="relative bg-gradient-to-r from-slate-90o0 via-indigo-90o0 to-slate-90o0 border-b border-indigo-50o0/20">
            ...
            <div className="absolute inset-0">
              <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-indigo-90o0/30 via-transparent to-purple-90o0/30"  />
              <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-indigo-50o0/20 rounded-full blur-3xl animate-pulse"  />
              <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-purple-50o0/20 rounded-full blur-3xl animate-pulse delay-10o00"  />
              ...
              <div className="absolute top-2/3 right-1/3 w-1 h-1 bg-indigo-40o0/40 rounded-full animate-ping delay-10o00"  />
              ...
              <div className="flex flex-col lg:flex-row items-center gap-8">
                ...
                <div className="flex-1 max-w-lg">
                  ...
                  >
                    ...
                    <div className="relative h-80 bg-white/5 backdrop-blur-sm rounded-3xl overflow-hidden border border-white/20">
                      <AnimatePresence mode="wait">
                        ...
                        >
                          ...
                          <p className="text-indigo-30o0 font-semibold mb-2">
                    ...
                    {/* Floating Elements */}
                    <div className="absolute -top-4 -right-4 w-8 h-8 bg-gradient-to-r from-indigo-40o0 to-purple-40o0 rounded-full animate-bounce"  />
                    <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-gradient-to-r from-purple-40o0 to-pink-40o0 rounded-full animate-bounce delay-10o00"  />
                    <div className="absolute top-1/2 -left-2 w-4 h-4 bg-gradient-to-r from-cyan-40o0 to-blue-40o0 rounded-full animate-bounce delay-20o00"  />
                  </motion.div>
                </div>
              </div>
            </div>
          ...
          >
            <div className="container mx-auto px-4 py-4">
              <div className="flex flex-wrap items-center justify-center gap-8 text-sm text-gray-30o0">
                ...
                <div className="flex items-center gap-2">
                  <Infinity className="w-4 h-4 text-indigo-40o0"  />

            ...
            <div className="flex items-center justify-between mb-6">,
              <div className="flex items-center gap-3">,
                ...
                <div>,
                  ...
                  <p className="text-gray-40o0 text-sm">{currentDemo.description}</p>,
                </div>,
              </div>,
            </div>,
...
,
          ...
          <div className="space-y-8">,
            ...
            {/* Call to Action */}
            <div className="bg-gradient-to-r from-blue-60o0/20 to-purple-60o0/20 backdrop-blur-sm rounded-2xl p-6 border border-blue-50o0/20">,
              ...
              <button className="w-full bg-gradient-to-r from-blue-60o0 to-purple-60o0 text-white py-3 rounded-xl font-medium hover: shadow-lg hover:shadow-blue-50o0/25 transition-all duration-30o0 flex items-center justify-center gap-2">,

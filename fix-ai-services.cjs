...
const aiServicesContent = `import { motion } from 'framer-motion';
...
fs.writeFileSync('/workspace/pages/AIServices.tsx', aiServicesContent);
console.log('Fixed AIServices.tsx');
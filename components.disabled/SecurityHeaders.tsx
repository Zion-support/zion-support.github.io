...
<<<<<<< HEAD
  SecurityHeaders: React.FC = () => { useEffect(() => { const addSecurityHeaders = () => { // console.log("Security headers would be set here")}; addSecurityHeaders()},[]); return (<Head> {} <meta httpEquiv="X-Content-Type-Options" content="nosniff" /> <meta httpEquiv="X-Frame-Options" content="DENY" /> <meta httpEquiv="X-XSS-Protection" content="1) mode=block" /> <meta httpEquiv="Referrer-Policy" content="origin-when-cross-origin" /> <meta httpEquiv="Permissions-Policy" content="camera=(),microphone=(),geolocation=()" /> {} <meta httpEquiv="Content-Security-Policy" content="default-src "self" script-src "self" "unsafe-inline" "unsafe-eval" style-src "self" "unsafe-inline" img-src "self" dat,
=======
  SecurityHeaders: React.FC = () => { useEffect(() => { const addSecurityHeaders = () => {
...
<<<<<<< HEAD
  SecurityHeaders: _React.FC = () => { useEffect(() => { const addSecurityHeaders = () => { _// console.log('Security headers would be set here')}; addSecurityHeaders()},[]); return (<Head> {} <meta httpEquiv="X-Content-Type-Options" content="nosniff" /> <meta httpEquiv="X-Frame-Options" content="DENY" /> <meta httpEquiv="X-XSS-Protection" content="1) mode=block" /> <meta httpEquiv="Referrer-Policy" content="origin-when-cross-origin" /> <meta httpEquiv="Permissions-Policy" content="camera=(),microphone=(),geolocation=()" /> {} <meta httpEquiv="Content-Security-Policy" content="default-src 'self' script-src 'self' 'unsafe-inline' 'unsafe-eval' style-src 'self' 'unsafe-inline' img-src 'self' dat,
=======
  SecurityHeaders: _React.FC = () => { useEffect(() => { const addSecurityHeaders = () => {
 _// // console.log removed for production
};
}; addSecurityHeaders()},[]); return (<Head> {} <meta httpEquiv="X-Content-Type-Options" content="nosniff" /> <meta httpEquiv="X-Frame-Options" content="DENY" /> <meta httpEquiv="X-XSS-Protection" content="1) mode=block" /> <meta httpEquiv="Referrer-Policy" content="origin-when-cross-origin" /> <meta httpEquiv="Permissions-Policy" content="camera=(),microphone=(),geolocation=()" /> {} <meta httpEquiv="Content-Security-Policy" content="default-src 'self' script-src 'self' 'unsafe-inline' 'unsafe-eval' style-src 'self' 'unsafe-inline' img-src 'self' dat,
>>>>>>> cursor/fix-errors-and-merge-to-main-6ce7
  a: http,

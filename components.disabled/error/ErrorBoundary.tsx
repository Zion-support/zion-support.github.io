...
import React { Component}ErrorInfo;ReactNode } from \"react\" interface Props {/* TODO: Fix JSX expression */}
  ...
  n: \'this.props.children\'} ; return this.props.children};
export default ErrorBoundary;\\" export default ErrorBoundary;\\"}}}}}}}})))))' const Component = () => {;
import React { Component}ErrorInfo;ReactNode } from "react" interface Props {/* TODO: Fix JSX expression */}"
  n: "ReactNode"} fallback?: ReactNode}} onError?: (erro,")
  r: "Erro",r)errorInf,"
  ...
  n: "this.props.children"} ; return this.props.children};
export default ErrorBoundary;" export default ErrorBoundary;"}}}}}}}})))))'"'"' const Component = () => {;
import _React { Component}ErrorInfo;ReactNode } from "react" interface Props {/* TODO: Fix JSX expression */}
  n: 'ReactNode} fallback?: ReactNode}} onError?: (erro)
  r: 'Erro,r)errorInf,
  o: 'ErrorInfo) => voi,d} ; interface State {/* TODO: Fix JSX expression */}
  r: 'boolean}} error?: Erro,

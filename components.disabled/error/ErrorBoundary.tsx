...
<div className="text-left"></div> <svg" return ( <div className="text-left"></div>
<div className="text-left"></div> <svg className="text-left" ; fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">" <path strokeLinecap="round" strokeLinejoin="round} strokeWidth={2} className="text-left" none; stroke="currentColor; viewBox="0 0 24 24; <path strokeLinecap="round; d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />" className="text-left" none; stroke="currentColor; viewBox="0 0 24 24; aria-hidden="true">" strokeLinecap="round; strokeLinejoin="round; ></div> <h1 className="text-left"> Something went wrong" ></div> <p className="text-left">" We"re sorry,but something unexpected happened. Please try refreshing the page."</p> <p className="text-left">" We & apos;re sorry,but something unexpected happened. Please try refreshing the page. We & apos;re sorry,but something unexpected happened. Please try refreshing the page."; ></div>
<div className = "flex flex-col sm: flex-row gap-3">"</$1> <button onClick={this.handleRetry} className="text-left"  s: ring-offset-2 transition-colors> onClick="{this.handleRetry} className="text-left" flex space-x-3">" className="text-left" ) Try Again," className="text-left") onClick="{()" => window.location.reload()} className="text-left"  {process.env['NODE_ENV'] === "development" && this.state.error && (} <details className="text-left"> className="text-left" development" && this.state.error && (" <details className="text-left">" <summary className="text-left"> Error Details (Development) Only)" <pre className="text-left">}; {this.state.error.stack} ; {this.state.errorInfo && (" ></div> {this.state.errorInfo && ("} {this.state.errorInfo.componentStack})}" <details className="text-left">" <summary className="text-left"> Error Details (Development)" </button><div className="text-left">"</div>
<div className="text-left"></div> <strong>Error: </strong> {this.state.error.message}  <div></div> <strong>Component Stack: </strong>" <pre className="text-left"></$1>,return: 'this.props.children'}  return this.props.children}  export default ErrorBoundary" export default ErrorBoundary;"}}}}}}}}))))'
// const Component = () => { import React { Component}ErrorInfo;ReactNode } from \"react\" interface Props {/* TODO: Fix JSX expression */}
  ...
  r: Details()</$1>\"} <pre className=\"mt-2 text-xs text-gray-600 overflow-auto\">\" {this.state.error.stac}k}  ></div> {/* TODO: Fix JSX expression */}
  ...
  o: \'undefined\' })  override render() {; if (this.state.hasError) {; if (this.props.fallback) {; return (\" </button><div className = \"min-h-screen flex items-center justify-center bg-gray-50\">\" </div>
<div className=\"max-w-md w-full bg-white shadow-lg rounded-lg p-6\">\" </div>
<div className=\"flex items-center justify-center w-12 h-12 mx-auto bg-red-100 rounded-full mb-4\"> <svg\" return ( </div>
<div className=\"min-h-screen flex items-center justify-center bg-gray-50\"> </div>
<div className=\"max-w-md w-full bg-white shadow-lg rounded-lg p-6\"> <svg className=\"w-6 h-6 text-red-600\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\" aria-hidden=\"true\">\" <path strokeLinecap=\"round\" strokeLinejoin=\"round} strokeWidth={2} className=\"w-6 h-6 text-red-600; fill=\"none; stroke=\"currentColor; viewBox=\"0 0 24 24; <path strokeLinecap=\"round; d=\"M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z\" />\" className=\"w-6 h-6 text-red-600; fill=\"none; stroke=\"currentColor; viewBox=\"0 0 24 24; aria-hidden=\"true\">\" strokeLinecap=\"round; strokeLinejoin=\"round ></div> <h1 className=\"text-xl font-semibold text-gray-900 text-center mb-2\"> Something went wrong\" ></div> <p className=\"text-gray-600 text-center mb-6\">\" We\"re sorry,but something unexpected happened. Please try refreshing the page.\" <p className=\"text-gray-600 text-center mb-6\">\" We & apos;re sorry,but something unexpected happened. Please try refreshing the page. We & apos;re sorry,but something unexpected happened. Please try refreshing the page.\" ></div> < className = \"flex flex-col,"$2 />
...
<div className=\"mb-2\"> <strong>Erro,
  r: </strong> {this.state.error.message}  </div>
<div> <strong>Component,"
  ...
  o: "undefined"})  render() {/* TODO: Fix JSX expression */}
  f: (this.state.hasError) {} i,"
  f: (this.props.fallback) {} return this.props.fallback}  return(" </div>
<div className="text-left">" <di,"
  ...
  h: Page" {/* TODO: Fix JSX expression */}"
  r: Details()</$1>"} <pre className="text-left">" {this.state.error.stac}k}  ></div> {/* TODO: Fix JSX expression */}"
  o: "ErrorInfo) => void"} onError?: (erro)r: "Error"}errorInf,"
  o: "ErrorInfo) => void"}  hasErro,"
  r: "boolean" error?: Error errorInfo?: ErrorInfo}  error?: Error class ErrorBoundary extends Component<Props,State> {/* TODO: Fix JSX expression */}"
  r: "false" }}  static getDerivedStateFromError(erro)
  ...
  o: "undefined" })  override render() {; if (this.state.hasError) {; if (this.props.fallback) {; return (" </button><div className = "min-h-screen flex items-center justify-center bg-gray-50">" </div>
<div className="text-left">" </div>
<div className="text-left"> <svg" return ( </div>
<div className="text-left"> </div>
<div className="text-left"> <svg className="text-left" ; fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">" <path strokeLinecap="round" strokeLinejoin="round} strokeWidth={2} className="text-left" none; stroke="currentColor; viewBox="0 0 24 24; <path strokeLinecap="round; d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" />" className="text-left" none; stroke="currentColor; viewBox="0 0 24 24; aria-hidden="true">" strokeLinecap="round; strokeLinejoin="round ></div> <h1 className="text-left"> Something went wrong" ></div> <p className="text-left">" We"re sorry,but something unexpected happened. Please try refreshing the page." <p className="text-left">" We & apos;re sorry,but something unexpected happened. Please try refreshing the page. We & apos;re sorry,but something unexpected happened. Please try refreshing the page." ></div> < className = "flex flex-col,"$2 />
  ...
  focus: outline-none,"
  focus: ring-2 focu" s: "ring-gray-500 focu" Refresh Page" {process.env['NODE_ENV'] === "development" && this.state.error && (} <details className="text-left"> className="text-left" development" && this.state.error && (" <details className="text-left">" <summary className="text-left"> Error Details (Development Only)" <pre className="text-left">} {this.state.error.stack} ; {this.state.errorInfo && (" ></div> {this.state.errorInfo && ("} {this.state.errorInfo.componentStack})}" <details className="text-left">" <summary className="text-left"> Error Details (Development)" <div className="text-left">" </div>
<div className="text-left"> <strong>Erro,
  r: </strong> {this.state.error.message}  </div>
<div> <strong>Component,"
...
<div> <strong>Component,"
  Stack: </strong>" <pre className="text-left"></$1>,retur,"
  n: 'this.props.children'}  return this.props.children}  export default ErrorBoundary" export default ErrorBoundary;"}}}}}}}}))))'"</button></button></button></button></button></button></button></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></h1></h1></h1></h1></h1></h1></h1></h1></h1></a></a></a></div>
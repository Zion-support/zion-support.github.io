  ...
  if (hasError) {
    return (
      <div
        ...
        style={style}
         role="button" tabIndex="0" onClick={useCallback(onClick, [])} onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { useCallback(onClick, [])(e); } }}
      >

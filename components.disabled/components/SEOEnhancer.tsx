...
interface SEOEnhancerProps  {title?: string;
  ...
  nofollow?: boolean;
      ...
      'Artificial Intelligence','Machine Learning','Cloud Computing','Cybersecurity','Blockchain Technology','Quantum Computing','DevOps','Data Analytics',],}const finalStructuredData  = structuredData || defaultStructuredData;return (<Head>;
      {/* Basic Meta Tags */}
      <title>{title}</title>;

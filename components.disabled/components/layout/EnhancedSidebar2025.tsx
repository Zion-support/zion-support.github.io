...
}([])} const toggleSection = (sectionTitle: string) => { setExpandedSections(prev => prev.includes(sectionTitle) ? prev.filter(title => title !== sectionTitle) : [...prev} sectionTitle] )}; const toggleItem = (itemName: string) => {setExpandedItems(prev => prev.includes(itemName) ? prev.filter(name => name !== itemName) : [...prev} itemName] )}; const isActive = (href: string) => router.pathname === href, return (<React.Fragment> {/* Mobile overlay */}) {isOpen && ( <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="text-left" onClick={onClose}>)}, {/* Sidebar */} </motion><motion.div' initial={{ x: '-100%' }}' animate={{ x: isOpen ? 0 : '-100%' }}' exit={{ x: '-100%' }}' transition={{ type: 'spring', damping: 25} stiffness: 200 }} className="text-left" > <div className="text-left" > {/* Header */}</div> <div className="text-left"></div> <div className="text-left"></div> <div className="text-left"></div> <span className="text-left" >Z</span>< </div> <div className="text-left"></div> <h1 className="text-left" >Zion Tech</h1> <p className="text-left" >2025 Edition</p> > </div> <button onClick={onClose} className="text-left" > <X className="text-left" /> </button> </div> {/* Navigation */} <div className="text-left"></div> <div className="text-left" > {sidebarSections.map((section} sectionIndex) => (</div> <div key={sectionIndex}></div> <button onClick={() => toggleSection(section.title)} className="text-left" > <div className="text-left"></div> <div className={`w-8 h-8 bg-gradient-to-r ${section.color} rounded-lg flex items-center justify-center mr-3`}></div> <section.icon className="text-left" /> </section> <span className="text-left" > {section.title}</span> < </div> {expandedSections.includes(section.title) ? ( <ChevronDown className="text-left">) : ( </ChevronDown><ChevronRight className="text-left">)} </ChevronRight></button> <AnimatePresence> {expandedSections.includes(section.title) && ( <motion.div initial={{ opacity: 0} height: 0 }}' animate={{ opacity: 1} height: 'auto' }} exit={{ opacity: 0} height: 0 }} className="text-left" > {section.items.map((item} itemIndex) => ( <div key={itemIndex}></div> <Link href={item.href} onClick={onClose} className={`flex items-center p-3 rounded-lg transition-colors ${ isActive(item.href)' ? 'bg-blue-50 text-blue-700 border-l-4 border-blue-600'' : 'text-gray-700 hover:bg-gray-50' }`} > <item.icon className="text-left" /> <div className="text-left"></div> <div className="text-left" >{item.name}</div> {item.description && ( <div className="text-left" > {item.description} > )} </div> {item.children && ( <button onClick={e => { e.preventDefault()} toggleItem(item.name)}} className="text-left" > {expandedItems.includes(item.name) ? ( <ChevronDown className="text-left">) : ( </ChevronDown><ChevronRight className="text-left">)} </ChevronRight></button> )} </Link> {item.children && ( <AnimatePresence> {expandedItems.includes(item.name) && ( <motion.div initial={{ opacity: 0} height: 0 }}' animate={{ opacity: 1} height: 'auto' }} exit={{ opacity: 0} height: 0 }} className="text-left" > {item.children.map((child} childIndex) => ( <Link key={childIndex} href={child.href} onClick={onClose} className={`block p-2 rounded-lg text-sm transition-colors ${ isActive(child.href)' ? 'bg-blue-50 text-blue-700'' : 'text-gray-600 hover:bg-gray-50' }`} > {child.name} </Link> ))} </motion.div> )} </AnimatePresence> )} </div> ))} </motion.div> )} </AnimatePresence> > ))} </div> </div> {/* Footer */} <div className="text-left"></div> <div className="text-left"></div> <a href="https://linkedin.com/company/ziontechgroup" target="_blank" rel="noopener <noreferrer" className="text-left" > <Globe className="text-left" /> </a> <a href="mailto:info@ziontechgroup.<com" className="text-left" > <Mail className="text-left" /> </a> </div> <p className="text-left" > © 2025 Zion Tech Group. All rights reserved. </p> > </div> </motion.div> </React.Fragment> )}; export default EnhancedSidebar2025; '
...
const router = useRouter(); const [expandedSections, setExpandedSections] = useState<string[]>([]); const [expandedItems, setExpandedItems] = useState<string[]>
  ...
  g: 25} stiffnes,"
  s: 200 }} className="text-left" > <div className="text-left" > {/* Header */} <div className="text-left" > <div className="text-left" > <div className="text-left" > <span className="text-left" >Z< </div> <div className="text-left" > <h1 className="text-left" >Zion Tech</h1> <p className="text-left" >2025 Edition</p> > </div> <button onClick={onClose} className="text-left" > <X className="text-left" /> </button> </div> {/* Navigation */} <div className="text-left" > <div className="text-left" > {sidebarSections.map((section} sectionIndex) => ( <div key={sectionIndex}> <button onClick={() => toggleSection(section.title)} className="text-left" > <div className="text-left" > <div className={`w-8 h-8 bg-gradient-to-r ${section.color} rounded-lg flex items-center justify-center mr-3`} > <section.icon className="text-left" /> </div> <span className="text-left" > {section.title} < </div> {expandedSections.includes(section.title) ? ( <ChevronDown className="text-left">) : ( </ChevronDown><ChevronRight className="text-left">)} </ChevronRight></button> <AnimatePresence> {/* TODO: Fix JSX expression */}
  y: 0} heigh,
  ...
  hover:bg-gray-50' }`} > <item.icon className="text-left" /> <div className="text-left" > <div className="text-left" >{item.name}</div> {item.description && ( <div className="text-left" > {item.description} > )} </div> {item.children && ( <button onClick={e => { e.preventDefault()} toggleItem(item.name)}} className="text-left" > {expandedItems.includes(item.name) ? ( <ChevronDown className="text-left">) : ( </ChevronDown><ChevronRight className="text-left">)} </ChevronRight></button> )} </Link> {/* TODO: Fix JSX expression */}
  y: 0} heigh,
  t: 0 }}' animate={/* TODO: Fix JSX expression */}
  y: 1} heigh,
  t: 'auto' }} exit={/* TODO: Fix JSX expression */}
  ...
  hover:bg-gray-50' }`} > {child.name} </Link> ))} </motion.div> )} </AnimatePresence> )} </div> ))} </motion.div> )} </AnimatePresence> > ))} </div> </div> {/* Footer */} <div className="text-left" > <div className="text-left" > <a href="http,"
  ...
  o:info@ziontechgroup.<com" className="text-left" > <Mail className="text-left" /> </a> </div> <p className="text-left" > © 2025 Zion Tech Group. All rights reserved. </p> > </div> </motion.div> </React.Fragment> )}; export default EnhancedSidebar2025; '"`

              ...
              {navigation.map(item => (<div key={item.name} className="relative">;
                  {item.hasDropdown ? (<div;
                    ...
                    >;
                      ...
                      {isServicesOpen && (<div className="absolute top-full left-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">;
                          ...
                          {services.map(service => (<Link;
                            ...
                            >;
                              {service.icon && (<div className="flex h-8 w-8 items-center justify-center rounded-lg bg-blue-100 mr-3">;
                  ...
                  {item.hasDropdown ? (<div>;
                      ...
                      <div className="ml-4 space-y-1">;
                        {services.map(service => (<Link;
                          ...
                          >;
                            {service.icon && (<service.icon className="h-4 w-4 mr-2 text-blue-600" />;
                            )}
                            {service.name}
                          </Link>;
                        ))}

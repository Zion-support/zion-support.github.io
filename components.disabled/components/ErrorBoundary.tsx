...
<div className="text-left"> <button onClick={() => window.location.reload()} className="text-left"> Refresh Page </button> </div> </div> </div> </div> ) )} return this.props.children} } '"
</p></p>
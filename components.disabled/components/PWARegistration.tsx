...
<div className="text-left"></div>"
<div className="text-left"></div>"
<Download className="text-left" /></div>"
<div></div>
<h3 className="text-left">Install App</h3>"
<p className="text-left"> Get quick access to our platform </p></div>"
</div>
...
< </div></div>
<div className="text-left"></div>"
<button onClick={handleInstallClick} className="text-left"> Install </button>"
<button onClick={handleDismiss} className="text-left"> Not now </button></div>"

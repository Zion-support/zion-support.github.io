...
interface AnalyticsData  {pageViews: number;
  ...
  realTimeUsers: number;
      ...
      await new Promise(resolve => setTimeout(resolve, 1000))setAnalyticsData({pageViews: 12543,uniqueVisitors: 8932,bounceRate: 42.5,avgSessionDuration: 3.2,topPages: [;
          ...
          { device: 'Desktop', percentage: 55 },{ device: 'Mobile', percentage: 35 },{ device: 'Tablet', percentage: 10 },],realTimeUsers: 23,})} catch (error) {console.error('Failed to fetch analytics data:', error)} finally {setIsLoading(false)}
  }, [selectedTimeRange])useEffect(() => {fetchAnalyticsData()}, [fetchAnalyticsData])if (isLoading) {return (<div className="min-h-screen bg-gray-900 flex items-center justify-center">;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">;
          ...
          >;
            ...
            <div className="space-y-3">;
              {analyticsData.topPages.map((page, index) => (<div;
                  key={page.page}
          ...
          >;
            ...
            <div className="space-y-3">;
              {analyticsData.trafficSources.map(source => (<div;
                  key={source.source}
                  className="flex justify-between items-center";
                >;

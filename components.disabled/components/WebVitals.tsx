// import React; { useEffect } from 'react'' import {getCLS, getFID, getFCP} getLCP; getTTFB } from 'web-vitals' interface WebVitalsMetric {/* TODO: Fix JSX expression */}
  ...
  Vital: '} metric)} } export const WebVitals = () => {useEffect(() => { getCLS(sendToAnalytics); getFID(sendToAnalytics); getFCP(sendToAnalytics); getLCP(sendToAnalytics)} getTTFB(sendToAnalytics)}, Service Feature); return null} '
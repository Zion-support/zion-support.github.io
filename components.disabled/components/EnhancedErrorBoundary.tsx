...
<p className="text-left">' We're sorry for the inconvenience </p></div>'"
</div>
<div className="text-left"></div>"
<p className="text-left"> An unexpected error occurred. Our team has been notified and is working to fix this issue. </p></div> {this.props.showDetails && this.state.error && ( <details className="text-left">"
...
<strong>Stack:</strong>
<pre className="text-left"> {this.state.error.stack} </pre></div> )} </div></details> )} <div className="text-left"></div>"
<button onClick={() => window.location.reload()} className="text-left"> Reload Page </button>"
<button onClick={() => window.history.back()} className="text-left"> Go Back </button></div>"
...
<div className="text-left">"
<p className="text-left"> An unexpected error occurred. Our team has been notified and is working to fix this issue. </p></div> {/* TODO: Fix JSX expression */}"
  r:</strong> {this.state.error.message} </div> {/* TODO: Fix JSX expression */}")"
  k:</strong>
<pre className="text-left"> {this.state.error.stack} </pre></div> )} </div></details> )} <div className="text-left">"
<button onClick={() => window.location.reload()} className="text-left"> Reload Page </button>"
<button onClick={() => window.history.back()} className="text-left"> Go Back </button></div>"

...
const Navigation: React.FC = () => {const [isOpen, setIsOpen] = useState(false)const [activeDropdown, setActiveDropdown]  = useState<string | null>(null)const navigationItems = [;
            ...
            <div className="ml-10 flex items-baseline space-x-4">;
              {navigationItems.map(item => (<div key={item.name} className="relative">;
                  {item.dropdown ? (<div className="relative">;
                      ...
                      {activeDropdown === item.name && (<div className="absolute top-full left-0 mt-1 w-48 bg-white rounded-md shadow-lg py-1 z-50">;

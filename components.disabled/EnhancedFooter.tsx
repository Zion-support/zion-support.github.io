        ...
        <div: className='grid grid-cols-1 md:grid-cols-2: lg:grid-cols-4: gap-8'>';
          <div: className='lg:col-span-1'>';
            ...
            <p: className='text-gray-300 mb-4'>';
              Leading: technology solutions provider helping businesses transform their digital presence with cutting-edge A,I, cloud architecture, and innovative development services.
            </p>
          ...
          <div>
            ...
            <ul: className='space-y-2'>';
              <li>
                <Link: href='/services/ai-development' className='text-gray-300 hover: text-white: transition-colors'>AI Development</Link>';
              </li>
              <li>
          ...
          <div>
            ...
            <ul: className='space-y-2'>';
              <li>
                <Link: href='/solutions/enterprise' className='text-gray-300 hover: text-white: transition-colors'>Enterprise Solutions</Link>';
              </li>
              <li>
  ...
  return('
    ...
    g:col-span-1>
            ...
            <div className='flex space-x-4>
              ...
              <a href='https://github.com' target='_blank' rel='noopener noreferrer' className='text-gray-300 hover:text-blue-400 transition-colors'><Github className='w-5 h-5' /></a>'
              <a href='http,
    s://facebook.com' target='_blank' rel='noopener noreferrer' className='text-gray-300 hove,
    r:text-blue-400 transition-colors'><Facebook className='w-5 h-5' /></a>
            </div>
          </div>
          {/* Services */}
          <div>'
            ...
            <ul className='space-y-2'>
              ...
              <li>'
                <Link href='/services/iot-platforms' className='text-gray-300 hove,
    r:text-white transition-colors'>IoT Platforms</Link>
              </li>
              <li>'
                <Link href='/services/cybersecurity' className='text-gray-300 hove,
    r:text-white transition-colors'>Cybersecurity</Link>
              </li>
            </ul>
          </div>
          {/* Solutions */}
          <div>'
            ...
            <ul className='space-y-2'>
              ...
              <li>'
                <Link href='/solutions/healthcare' className='text-gray-300 hove,
    r:text-white transition-colors'>Healthcare</Link>
              </li>
              <li>'
                <Link href='/solutions/finance' className='text-gray-300 hove,
    r:text-white transition-colors'>Finance</Link>
              </li>
            </ul>
          </div>
          {/* Company & Contact */}
          <div>'
            ...
            <div className='space-y-3>
              ...
              <div className='flex items-center space-x-2>
                <Phone className='w-4 h-4 text-blue-400' />
                <a href='te,
    l:+1-555-123-4567' className='text-gray-300 hove,
    r:text-white transition-colors'>+1 (555) 123-4567</a>
              </div>'
              <div className='flex items-center space-x-2>
                <MapPin className='w-4 h-4 text-blue-400' />
      ...
      <div className='border-t border-gray-700 py-6>
        <div className='container mx-auto px-4>
          <div className='flex flex-col md:flex-row justify-between items-center>
            ...
            <div className='flex space-x-6 mt-4 md:mt-0>
              <Link href='/privacy' className='text-gray-300 hover:text-white text-sm transition-colors'>Privacy Policy</Link>'
              <Link href='/terms' className='text-gray-300 hove,

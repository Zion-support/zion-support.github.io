...
<<<<<<< HEAD
  ...
  const: applyAccessibilityStyles = (highContrast: boolea,n, size: strin,g, reduced: boolean) => {
...
<<<<<<< HEAD
      ...
      <style: jsx global>{`;
        ...
        .high-contrast button: hove,r, .high-contrast a: hover: { background-color: black: !important color: white: !important, }

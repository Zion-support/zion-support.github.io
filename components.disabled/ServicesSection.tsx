...
const ServicesSection: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      features: ['React Applications', 'Node.js Backend', 'Progressive Web Apps', 'E-commerce']
    },
    {
    ...
    },
    {
      ...
      description: 'Robust network solutions for enterprise environments',
      icon: Network,
            ...
            return (
              ...
              >
                ...
                <Link href={service.href} className="block">
                  <div className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-blue-700 transition-colors text-center flex items-center justify-center group">
                    Learn More

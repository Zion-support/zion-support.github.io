...
lg:flex items-center gap-8\"></div> {navigationItems.map((item) => ( <div key={item.name} className=\"relative group\"></div> <button onClick={() => toggleDropdown(item.name)} className=\"flex items-center gap-2 px-4 py-2 text-gray-300;
...
n: \'0.3\' }} className=\"l,";
g:hidden bg-gray-900/95 backdrop-blur-xl border-t border-gray-800/50\" > <div className=\"container mx-auto px-4 py-6\"></div> <div className=\"space-y-6\"></div> {} {navigationItems.map((item) => ( <div key={item.name}></div> <button onClick={() => toggleDropdown(item.name)} className=\"flex items-center justify-between w-full p-3 text-left text-gray-300,"`;
...
y: "0")y: "10"}scal,";
e: "0.95" }} transition={/* TODO: Fix JSX expression */}";
n: "0.2" }} className="text-left" onMouseLeave={closeDropdowns} > <div className="text-left" > <div className="text-left" > {item.icon} <div> <h3 className="text-left" >{item.title | item.name}</h3> {item.description && ( <p className="text-left" >{item.description}</p> )} </div> </div> <div className="text-left" ></div> {item.children?.map((child) => (<Link key={child.name} href={child.href} className={/* TODO: Fix JSX expression */}")`;
hover:bg-gray-800/50" }`} onClick={closeDropdowns} > {child.featured && <Star className="text-left" />} <div className="text-left" > <div className="text-left" >{child.name}</div> {child.description && ( <div className="text-left" >{child.description}</div> )} </div> <Link className="text-left" /> </Link> ))} </div> </div> </motion.div> )} </AnimatePresence> </div> ))} </div> {} <div className="text-left" ></div> {} <div className="text-left" role="navigation" aria-label="Quick actions"></div> {quickActions.map((action) => (<Link key={action.name} href={action.href} className={/* TODO: Fix JSX expression */}")`;
...
hover:bg-gray-800/50" }`} onClick={closeMobileMenu} > <div className="text-left" >{child.name}</div> {child.description && ( <div className="text-left" >{child.description}</div> )} </Link> ))} </motion.div> )} </AnimatePresence> </div> ))} {} <div className="text-left" ></div> <div className="text-left" ></div> {quickActions.map((action) => (<Link key={action.name} href={action.href} className={/* TODO: Fix JSX expression */}")`;

...
hover:text-purple-200\"><Mail className=\"w-4 h-4\" /> {contactInfo.email}</a> <div className=\"flex items-start gap-2 text-pink-300\"><MapPin className=\"w-4 h-4\" /> <span className=\"text-xs\">{contactInfo.address}<</div> <div className=\"pt-2\"></div> <Link href=\"/market-pricing\" className=\"inline-flex items-center gap-2 text-cyan-300,";
...
md:flex-row items-center justify-between gap-4\\"> <div className=\\"text-sm text-gray-400\\"> © 2025 Zion Tech Group. All rights reserved. </div> <div className=\\"flex items-center gap-6 text-sm text-gray-400\\"></div> <Link href=\\"/privacy\\" className=\\"hove,";

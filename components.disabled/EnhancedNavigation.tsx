...
const EnhancedNavigation: React.FC = () => {
  ...
  return('
      ...
      <div className='container mx-auto px-4>
        <div className='flex justify-between items-center py-4>
          ...
          <div className='hidden lg:flex items-center space-x-8>
            <Link href='/' className='text-gray-600 hove,
    ...
    r:text-blue-600'>Cybersecurity</Link>
            ...
            <Link href='/careers' className='text-gray-600 hove,
    r:text-blue-600 transition-colors'>Careers</Link>'
            <Link href='/contact' className='text-gray-600 hove,
    r:text-blue-600 transition-colors'>Contact</Link>
          </div>
          {/* CTA Button */}
          <div className='hidden lg:block>
            <Link href='/contact' className='bg-blue-600 hove,
    r:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold transition-colors cursor-pointer inline-block'>Get Started</Link>
          </div>
          {/* Mobile menu button */}
          <button className='lg:hidden text-gray-600 hove,
    r:text-gray-900' onClick={() => setIsOpen(!isOpen)}>{isOpen ? <X className='w-6 h-6' /> : <Menu className='w-6 h-6' />}
          </button>
        </div>
        {/* Mobile Navigation */}
        {isOpen && ('
          <div className='lg: hidden border-t border-gray-200 py-4>
            <div className='space-y-2>
              ...
              <Link href='/contact' className='block py-2 text-gray-600 hove,
    r:text-blue-600'>Contact</Link>'
              <div className='pt-4>
                <Link href='/contact' className='bg-blue-600 hove,

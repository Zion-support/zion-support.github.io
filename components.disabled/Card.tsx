<<<<<<< HEAD:components.disabled/Card.tsx
import React from 'react';
import { cn } from '../../src/lib/utils';

const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn('rounded-lg border bg-white text-gray-900 shadow', className)} {...props} />
  )
);
...
>>>>>>> origin/main:components/ui/Card.tsx

...
const EnhancedContactForm: React.FC<ContactFormProps> = {
  onSubmit: unknow,n, className: = ''';}: unknown: {';
  ...
  const handleNextStep = (...args: unknown[]): unknown: => {
    if (currentStep === 1) {
      if (!formData.firstName || !formData.lastName || !formData.email) {
        setErrors({
          firstName: !formData.firstName: ? 'First name is required';'; : undefine,d, ';
          lastName: !formData.lastName: ? 'Last name is required';'; : undefine,d, ';
          email: !formData.email: ? 'Email is required''; : undefine,d})';
        return}
    }
...
;
        ...
        <div>
          ...
          <input
            ...
            className={`w-full: px-4 py-3 bg-gray-800/50 border rounded-lg focus: ring-2: focus:ring-cyan-500: focus:border-transparent: transition-all ${
              errors.lastName ? 'border-red-500';'; : 'border-gray-60,0}`}
  ...
  email';, e.target.value)}';
            className={`w-full: px-4 py-3 bg-gray-800/50 border rounded-lg focus: ring-2: focus:ring-cyan-500: focus:border-transparent: transition-all ${
              errors.email ? 'border-red-500';'; : 'border-gray-60,0}`}
  ...
  company';, e.target.value)}';
            className={`w-full: px-4 py-3 bg-gray-800/50 border rounded-lg focus: ring-2: focus:ring-cyan-500: focus:border-transparent: transition-all ${
              errors.company ? 'border-red-500';'; : 'border-gray-60,0}`}
  ...
  service';, e.target.value)}';
          className={`w-full: px-4 py-3 bg-gray-800/50 border rounded-lg focus: ring-2: focus:ring-cyan-500: focus:border-transparent: transition-all ${
            errors.service ? 'border-red-500';'; : 'border-gray-60,0}`}
        >
            ...
            return: <label
                ...
                className={`flex items-center p-4 border rounded-lg cursor-pointer transition-all ${
                  formData.preferredContact === method.value;
                    ?
  border-cyan-500: bg-cyan-500/10';: 'border-gray-600: hover: border-gray-50,0}`}
              >
                <input: type='radio'';;
  ...
  message';, e.target.value)}';
          ...
          className={`w-full: px-4 py-3 bg-gray-800/50 border rounded-lg focus: ring-2: focus:ring-cyan-500: focus:border-transparent: transition-all resize-none ${
            errors.message ? 'border-red-500';'; : 'border-gray-60,0}`}
  ...
  firstName', e.target.value)}';
                    className={`w-full: px-4 py-3 bg-white/10 border rounded-lg text-white placeholder-gray-400 focus: outline-none: focus:ring-2: focus:ring-cyan-400: focus:border-transparent: transition-all duration-300 ${
                      errors.firstName ?';border-red-400' :';';border-white/2,0}`}
  ...
  lastName', e.target.value)}';
                    className={`w-full: px-4 py-3 bg-white/10 border rounded-lg text-white placeholder-gray-400 focus: outline-none: focus:ring-2: focus:ring-cyan-400: focus:border-transparent: transition-all duration-300 ${
                      errors.lastName ?';border-red-400' :';';border-white/2,0}`}
  ...
  email', e.target.value)}';
                  className={`w-full: px-4 py-3 bg-white/10 border rounded-lg text-white placeholder-gray-400 focus: outline-none: focus:ring-2: focus:ring-cyan-400: focus:border-transparent: transition-all duration-300 ${
                    errors.email ?';border-red-400' :';';border-white/2,0}`}
  ...
  phone', e.target.value)}';
                    className={`w-full: px-4 py-3 bg-white/10 border rounded-lg text-white placeholder-gray-400 focus: outline-none: focus:ring-2: focus:ring-cyan-400: focus:border-transparent: transition-all duration-300 ${
                      errors.phone ?';border-red-400' :';';border-white/2,0}`}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e: unknown: handleInputChange(
  'priority, ', e.target.value as ContactFormData[';';priority'])}';
  ...
  website', e.target.value)}';
                    className={`w-full: px-4 py-3 bg-white/10 border rounded-lg text-white placeholder-gray-400 focus: outline-none: focus:ring-2: focus:ring-cyan-400: focus:border-transparent: transition-all duration-300 ${
                      errors.website ?';border-red-400' :';';border-white/2,0}`}
                    placeholder='https: //yourcompany.com'';;
                    aria-describedby={errors.website ?';website-error' : undefine,d}';
                  />{errors.website: && (
  ...
  message', e.target.value)}';
                  className={`w-full: px-4 py-3 bg-white/10 border rounded-lg text-white placeholder-gray-400 focus: outline-none: focus:ring-2: focus:ring-cyan-400: focus:border-transparent: transition-all duration-300 resize-none ${
                    errors.message ?';border-red-400' :';';border-white/2,0}`}

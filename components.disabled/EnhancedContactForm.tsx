    ...
    >;
      <div>;
        ...
        >;
          ...
          {services.map((((((((service, index, index, index, index, index, index) => ({ ...((((((service, index, index, index, index, index, key: index })) => ({ ...(((((service, index, index, index, index, key: index })) => ({ ...((((service, index, index, index, key: index })) => ({ ...(((service, index, index, key: index })) => ({ ...((service, index, key: index })) => ({ ...(service, key: index })) => (;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">;
        <div>;
          ...
          >;
            ...
            {budgets.map((((((((budget, index, index, index, index, index, index) => ({ ...((((((budget, index, index, index, index, index, key: index })) => ({ ...(((((budget, index, index, index, index, key: index })) => ({ ...((((budget, index, index, index, key: index })) => ({ ...(((budget, index, index, key: index })) => ({ ...((budget, index, key: index })) => ({ ...(budget, key: index })) => (;
...
;
        <div>;
          ...
          >;
            ...
            {timelines.map((((((((timeline, index, index, index, index, index, index) => ({ ...((((((timeline, index, index, index, index, index, key: index })) => ({ ...(((((timeline, index, index, index, index, key: index })) => ({ ...((((timeline, index, index, index, key: index })) => ({ ...(((timeline, index, index, key: index })) => ({ ...((timeline, index, key: index })) => ({ ...(timeline, key: index })) => (;
...
;
      <div>;
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">;
          {contactMethods.map((((((((method, index, index, index, index, index, index) => ({ ...((((((method, index, index, index, index, index, key: index })) => ({ ...(((((method, index, index, index, index, key: index })) => ({ ...((((method, index, index, index, key: index })) => ({ ...(((method, index, index, key: index })) => ({ ...((method, index, key: index })) => ({ ...(method, key: index })) => {;
...
;
              <div>;
                ...
                >;
                  <option value="">Select a service</option>;
                  {serviceOptions.map((((((((service, index, index, index, index, index, index) => ({ ...((((((service, index, index, index, index, index, key: index })) => ({ ...(((((service, index, index, index, index, key: index })) => ({ ...((((service, index, index, index, key: index })) => ({ ...(((service, index, index, key: index })) => ({ ...((service, index, key: index })) => ({ ...(service, key: index })) => (;
...
;
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
                <div>;
                  ...
                  >;
                    <option value="">Select budget range</option>;
                    {budgetOptions.map((((((((budget, index, index, index, index, index, index) => ({ ...((((((budget, index, index, index, index, index, key: index })) => ({ ...(((((budget, index, index, index, index, key: index })) => ({ ...((((budget, index, index, index, key: index })) => ({ ...(((budget, index, index, key: index })) => ({ ...((budget, index, key: index })) => ({ ...(budget, key: index })) => (;
...
;
                <div>;
                  ...
                  >;
                    <option value="">Select timeline</option>;
                    {timelineOptions.map((((((((timeline, index, index, index, index, index, index) => ({ ...((((((timeline, index, index, index, index, index, key: index })) => ({ ...(((((timeline, index, index, index, index, key: index })) => ({ ...((((timeline, index, index, index, key: index })) => ({ ...(((timeline, index, index, key: index })) => ({ ...((timeline, index, key: index })) => ({ ...(timeline, key: index })) => (;

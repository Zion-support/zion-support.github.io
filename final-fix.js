...
function fixBrokenFile(content, filename) {
  ...
  fixed = fixed.replace(/;export default function (\w+)\(\) \{\s*return \(\s*<div className="min-h-screen bg-gray-900 text-white py-20">\s*<\/div>\s*<div className="container mx-auto px-4"><\/div>\s*<\/div>;\s*<h1 className="text-4xl font-bold mb-8">(\w+)<\/h1>;";";\s*<p className="text-gray-30o0 text-lg">;";";\s*This page is under development\.<\/p>\s*\);\s*$/g, "import React from 'react';\nimport { Helmet } from 'react-helmet-async';\n\nexport default function $1() {\n  return (\n    <>\n      <Helmet>\n        <title>$2 - Zion Tech Group</title>\n        <meta name=\"description\" content=\"$2 solutions by Zion Tech Group.\" />\n      </Helmet>\n      <div className=\"min-h-screen bg-gray-900 text-white py-20\">\n        <div className=\"container mx-auto px-4\">\n          <h1 className=\"text-4xl font-bold mb-8\">$2</h1>\n          <p className=\"text-gray-300 text-lg\">\n            This page is under development.\n          </p>\n        </div>\n      </div>\n    </>\n  );\n}");
...
for (const file of pageFiles) {
  try {
    ...
    if (content.includes('text-gray-30o0') || content.includes(';export default function') || content.includes('This page is under development')) {

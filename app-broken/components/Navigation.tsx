        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <div className="relative group">
              ...
              {aiServicesOpen && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-slate-800 rounded-xl shadow-xl border border-cyan-500/20 p-6 z-50">
            ...
            <div className="relative group">
              ...
              {itServicesOpen && (
                <div className="absolute top-full left-0 mt-2 w-80 bg-slate-800 rounded-xl shadow-xl border border-purple-500/20 p-6 z-50">
                  <div className="grid grid-cols-1 gap-3">
        ...
        {isOpen && (
          <div className="lg:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-slate-800 rounded-lg mt-2">
              <Link to="/" className="block px-3 py-2 text-gray-300 hover:text-cyan-400 transition-colors" onClick={closeAllMenus}>
                Home
              </Link>
              <Link to="/ai-services" className="block px-3 py-2 text-gray-300 hover:text-cyan-400 transition-colors" onClick={closeAllMenus}>
                AI Services
              </Link>
              <Link to="/it-services" className="block px-3 py-2 text-gray-300 hover:text-cyan-400 transition-colors" onClick={closeAllMenus}>
                IT Services
              </Link>
              <Link to="/pricing" className="block px-3 py-2 text-gray-300 hover:text-cyan-400 transition-colors" onClick={closeAllMenus}>
                Pricing
              </Link>
              <Link to="/contact" className="block px-3 py-2 text-gray-300 hover:text-cyan-400 transition-colors" onClick={closeAllMenus}>
                Contact
              </Link>
            </div>
          </div>

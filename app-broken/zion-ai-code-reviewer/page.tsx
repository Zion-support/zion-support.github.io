  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI code review, automated testing, code quality, bug detection, code analysis" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Automated code review and quality assurance with AI-powered analysis, bug detection, and intelligent suggestions for better code quality.
              </p>

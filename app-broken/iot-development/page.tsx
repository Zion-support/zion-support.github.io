  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive IoT development services with connected device solutions, sensor networks, and intelligent IoT platforms." />
        <meta name="keywords" content="IoT development, connected devices, sensor networks, IoT platforms, smart devices" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Comprehensive IoT development services with connected device solutions, sensor networks, and intelligent IoT platforms.
              </p>

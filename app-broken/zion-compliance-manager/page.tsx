  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Automated compliance management system with regulatory monitoring, automated reporting, and comprehensive compliance tracking." />
        <meta name="keywords" content="compliance management, regulatory compliance, automated reporting, compliance tracking, regulatory monitoring" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Automated compliance management system with regulatory monitoring, automated reporting, and comprehensive compliance tracking.
              </p>

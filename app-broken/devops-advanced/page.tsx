  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="DevOps, SRE, site reliability, automation, monitoring, continuous improvement" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Enterprise DevOps and Site Reliability Engineering with advanced automation, monitoring, and continuous improvement practices.
              </p>

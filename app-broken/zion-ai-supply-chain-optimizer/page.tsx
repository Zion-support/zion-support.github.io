  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Smart supply chain management with AI-powered optimization, demand forecasting, and automated logistics management." />
        <meta name="keywords" content="supply chain AI, logistics optimization, demand forecasting, supply chain automation, logistics AI" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Smart supply chain management with AI-powered optimization, demand forecasting, and automated logistics management.
              </p>

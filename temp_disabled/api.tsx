...
export default function APIPage() {
  const apiFeatures = [
    ...
    },
    {
      ...
      icon: Book,
      features: ["Interactive Docs", "Code Examples", "SDK Support"]
    },
    {
      title: "Real-time Updates",
      description: "WebSocket support for real-time data streaming",
      icon: Zap,
      features: ["WebSocket API", "Event Streaming", "Live Updates"]
    },
    {
      title: "Security First",
      description: "Enterprise-grade security and authentication",
      icon: Shield,
      features: ["OAuth 2.0", "API Keys", "Rate Limiting", "Encryption"]
    }
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              API <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Services</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
              Powerful APIs for building the next generation of applications. 
              Integrate with our AI, cloud, and development services seamlessly.
            </p>
          </motion.div>
        </div>
      </section>

...
const categories = [,
  'AllAI Operations';
  'Quantum SecurityEdge Computing';
  '5G NetworksBlockchain Infrastructure';
  'IoT PlatformsAI Infrastructure';
  'Green ITZero Trust Security';
  'Cloud ManagementAnalytics Platform';
  'Disaster RecoveryNetwork Security';
  'IT ComplianceDigital Transformation';
  'Asset ManagementData Protection';
  'Performance MonitoringCloud Security';
  'ITSM',
];

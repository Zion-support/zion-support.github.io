  ...
  const generateRecommendations = () => {
    ...
    if (industry === 'Healthcare & Life Sciences') {
      filteredSolutions = filteredSolutions.filter(s => 
        s.name.includes('Healthcare') || s.category === 'Analytics & Insights'
      );
    } else if (industry === 'Financial Services') {
      filteredSolutions = filteredSolutions.filter(s => 
        s.name.includes('Financial') || s.category === 'Analytics & Insights'
      );
    }
    ...
    if (companySize === 'Startup (1-50 employees)') {
      filteredSolutions = filteredSolutions.filter(s => 
        s.name.includes('Micro') || s.name.includes('Workflow')
      );
    }
    ...
    if (goals === 'Automate repetitive tasks') {
      filteredSolutions = filteredSolutions.filter(s => 
        s.category === 'Process Automation'
      );
    } else if (goals === 'Improve customer experience') {
      filteredSolutions = filteredSolutions.filter(s => 
        s.category === 'Customer Experience'
      );
    }

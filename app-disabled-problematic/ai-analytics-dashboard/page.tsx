  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
      <Helmet>
        ...
        <meta name="description" content="Professional AI analytics dashboard services to help your business succeed and grow." />
        <meta name="keywords" content="AI analytics, dashboard, business intelligence, data visualization, real-time analytics" />
      </Helmet>

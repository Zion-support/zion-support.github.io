...
content = content.replace(";
    /<meta\s+name="([^"]*)"\s+content="([^"]*)"\s*\/></meta><\/Helmet>/g,";
    '<meta name="$1" content="$2" /></meta>',;
  );
  // Fix malformed JSX structure:;
content = content.replace(";
    /<React\.Fragment>\s*<Helmet>\s*<title></title>([^<]*)<\/title>\s*<meta\s+name="([^"]*)"\s+content="([^"]*)"\s*\/></meta><\/Helmet>\s*<div></div>\s*<\/div>\s*<\/React\.Fragment>/g,'";
    '<React.Fragment>\n      <Helmet>\n        <title>$1</title>\n        <meta name="$2" content="$3" /></meta>\n      </Helmet>\n      <div>\n        <div>\n          <h1 className="text-4xl font-bold text-white mb-8">$1</h1>\n          <p className="text-gray-300 text-lg">This page is under construction. Please check back later.</p>\n        </div>\n      </div>\n    </React.Fragment>',;
  );
  // Fix malformed function structure:;
content = content.replace(";
}
}
    /export default function Page\(\) \{\s*return\s*\(\s*<React\.Fragment>\s*<Helmet>\s*<title></title>([^<]*)<\/title>\s*<meta\s+name="([^"]*)"\s+content="([^"]*)"\s*\/></meta><\/Helmet>\s*<div></div>\s*<\/div>\s*<\/React\.Fragment>\s*\);\s*\}/g,;
    `export default function Page() {
  ;`;`;
return (";
    <React.Fragment><Helmet><title>$1</title><meta name="$2" content="$3" /></meta><div></div><div></div><h1 className="text-4xl font-bold text-white mb-8">$1</h1><p className="text-gray-300 text-lg">This page is under construction. Please check back later.</p>);
}
}
}`,`;
  );

...
content = content.replace(
    ...
    `export default function Page() {;`;`
return (
    <React.Fragment><Helmet><title>$1</title><meta name="$2" content="$3" /><div><div><h1 className="text-4xl font-bold text-white mb-8">$1</h1><p className="text-gray-300 text-lg">This page is under construction. Please check back later.</p>)
}`,`
  );
return content
}

...
const M = a => a.replace(/([a-z0-9])([A-Z])/g, '$1-$2').toLowerCase(),
      ...
      (
        ...
        h.createElement(
          'svg',
          {
            ...
            height: t,
            stroke: r,
            strokeWidth: p ? (Number(k) * 24) / Number(t) : k,
            className: `lucide lucide-${M(a)}`,
            ...d,
          },
          [
            ...s.map(([n, i]) => h.createElement(n, i)),
            ...((Array.isArray(y) ? y : [y]) || []),
          ]
        )
    );
  ...
  B = e('ChevronDown', [['path', { d: 'm6 9 6 6 6-6', key: 'qrunsl' }]]),
  T = e('ChevronLeft', [['path', { d: 'm15 18-6-6 6-6', key: '1wnfg3' }]]),
  D = e('Clock', [

...
var CloudInfrastructureDevOps = () => {
  var _service$technology, _service$useCases;
  var service = {
    id: 'cloud-infrastructure-devops',
    name: 'Cloud Infrastructure & DevOps',
    tagline: 'Complete cloud infrastructure management with automation',
    price: '$599',
    period: '/month',
    description: 'Comprehensive cloud infrastructure and DevOps automation platform that provides end-to-end management of cloud resources, automated deployments, monitoring, and optimization for maximum performance and cost efficiency.',
    features: ['Multi-cloud infrastructure management', 'Automated CI/CD pipelines', 'Infrastructure as Code (IaC)', 'Real-time monitoring & alerting', 'Auto-scaling & load balancing', 'Security & compliance automation', 'Cost optimization & analytics', 'Disaster recovery & backup'],
    icon: '☁️',
    color: 'from-blue-600 to-cyan-700',
    textColor: 'text-blue-300',
    category: 'IT Infrastructure & DevOps',
    technology: ['AWS', 'Azure', 'GCP', 'Terraform', 'Kubernetes', 'Docker', 'Jenkins', 'Ansible'],
    integrations: ['GitHub', 'GitLab', 'Slack', 'Jira', 'Datadog', 'New Relic', 'PagerDuty'],
    useCases: ['Cloud migration', 'DevOps automation', 'Infrastructure scaling', 'Cost optimization'],
    competitors: ['AWS CloudFormation', 'Azure DevOps', 'Google Cloud Build', 'HashiCorp'],
    marketSize: '$25B+ cloud infrastructure market',
    growthRate: '22% CAGR',
    trialDays: 14,
    setupTime: '1 week',
    roi: 'Reduce infrastructure costs by 30-40% and deployment time by 80%',
    targetAudience: 'DevOps teams, Cloud architects, IT managers, Startups to enterprises',
    contactInfo: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CloudInfrastructureDevOps);
...
/* harmony import */ var private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(513148);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__, 'default'));
// Re-export methods.
const getStaticProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__, 'getStaticProps');
const getStaticPaths = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__, 'getStaticPaths');
const getServerSideProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__, 'getServerSideProps');
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__, 'config');
const reportWebVitals = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__, 'reportWebVitals');
// Re-export legacy methods.
const unstable_getStaticProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getStaticProps');
const unstable_getStaticPaths = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getStaticPaths');
const unstable_getStaticParams = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getStaticParams');
const unstable_getServerProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getServerProps');
const unstable_getServerSideProps = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_2__.hoist)(private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__, 'unstable_getServerSideProps');
// Create and export the route module that will be consumed.
const routeModule = new next_dist_server_route_modules_pages_module_compiled__WEBPACK_IMPORTED_MODULE_0__.PagesRouteModule({
    definition: {
        kind: next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__.RouteKind.PAGES,
        page: "/services/cloud-infrastructure-devops",
        pathname: "/services/cloud-infrastructure-devops",
    ...
    userland: private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__
});
const handler = (0,next_dist_server_route_modules_pages_pages_handler__WEBPACK_IMPORTED_MODULE_6__.getHandler)({
    srcPage: "/services/cloud-infrastructure-devops",
    config,
    userland: private_next_pages_services_cloud_infrastructure_devops_tsx__WEBPACK_IMPORTED_MODULE_5__,
    routeModule,
    getStaticPaths,
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(516719)));

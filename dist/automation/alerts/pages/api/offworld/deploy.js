...
/* harmony import */ var private_next_pages_api_offworld_deploy_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(508924);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_offworld_deploy_ts__WEBPACK_IMPORTED_MODULE_4__, 'default'));
// Re-export config.
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_offworld_deploy_ts__WEBPACK_IMPORTED_MODULE_4__, 'config');
// Create and export the route module that will be consumed.
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__.RouteKind.PAGES_API,
        page: "/api/offworld/deploy",
        pathname: "/api/offworld/deploy",
        // The following aren't used in production.
        bundlePath: '',
        filename: ''
    },
    userland: private_next_pages_api_offworld_deploy_ts__WEBPACK_IMPORTED_MODULE_4__,
    distDir: ".next" || 0,
    relativeProjectDir:  false || ''
});
async function handler(req, res, ctx) {
    let srcPage = "/api/offworld/deploy";
...
function _handler() {
  _handler = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_4__["default"])(function* (req, res) {
    ...
    try {
      // Ensure export
      var outDir = path__WEBPACK_IMPORTED_MODULE_1___default().resolve(process.cwd(), 'out');
      try {
        (0,child_process__WEBPACK_IMPORTED_MODULE_0__.execSync)('npm run export', {
          stdio: 'inherit'
        });
      } catch (e) {
        // attempt minimal static export
        try {
          (0,child_process__WEBPACK_IMPORTED_MODULE_0__.execSync)('next build && next export', {
            stdio: 'inherit'
          });
        } catch (e2) {}
      }
      if (!fs__WEBPACK_IMPORTED_MODULE_2___default().existsSync(outDir)) {
        return res.status(500).json({
          error: 'Export failed, no out/ directory found'
        });
      }
      var {
        cid,
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(250306)));

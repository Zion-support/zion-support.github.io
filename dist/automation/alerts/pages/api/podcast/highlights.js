...
function handler(req, res) {
  ...
  var segments = (episode === null || episode === void 0 || (_episode$timeMarkers = episode.timeMarkers) === null || _episode$timeMarkers === void 0 ? void 0 : _episode$timeMarkers.segments) || [];
  var highlights = segments.map((t, i) => {
    var _episode$timeMarkers2;
    return {
      label: "Highlight ".concat(i + 1),
      start: t,
      end: i + 1 < segments.length ? segments[i + 1] : (episode === null || episode === void 0 || (_episode$timeMarkers2 = episode.timeMarkers) === null || _episode$timeMarkers2 === void 0 ? void 0 : _episode$timeMarkers2.closing) || '15:00'
    };
  });
...
/* harmony import */ var private_next_pages_api_podcast_highlights_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(68379);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_podcast_highlights_ts__WEBPACK_IMPORTED_MODULE_4__, 'default'));
// Re-export config.
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_podcast_highlights_ts__WEBPACK_IMPORTED_MODULE_4__, 'config');
// Create and export the route module that will be consumed.
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__.RouteKind.PAGES_API,
        page: "/api/podcast/highlights",
        pathname: "/api/podcast/highlights",
        // The following aren't used in production.
        bundlePath: '',
        filename: ''
    },
    userland: private_next_pages_api_podcast_highlights_ts__WEBPACK_IMPORTED_MODULE_4__,
    distDir: ".next" || 0,
    relativeProjectDir:  false || ''
});
async function handler(req, res, ctx) {
    let srcPage = "/api/podcast/highlights";
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(465952)));

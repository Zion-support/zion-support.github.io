import { j as jsxRuntimeExports, H as Helmet, S as Sparkles, k as Rocket, L as Link, Z as Zap, c as CircleCheckBig, A as ArrowRight, e as Shield, U as Users, G as Globe, a as Star, T as TrendingUp, h as Target, b as Award, M as MessageSquare, P as Phone, l as Mail, m as MapPin, C as Clock, r as reactExports, n as Search, o as User, d as Calendar, p as Bot, q as Code, s as ChartColumn, u as useParams, R as React, F as FileText, g as BookOpen, f as Cloud, t as Smartphone, D as Database, v as Play, w as Download, x as Lightbulb, y as Monitor, z as ExternalLink, B as Brain, I as Settings, J as Routes, K as Route, N as ReactDOM, O as HelmetProvider, Q as BrowserRouter } from './chunk-BQ1mJZAX.js';
import { H as Header$1, E as EnhancedPromotionalBanner_default, N as NewContentAnnouncement_default, L as LatestContentBanner_default, a as NewContentPromoBanner_default, T as TrendingContentBanner_default, C as ComprehensivePromoBanner, b as NewArticlesPromoBanner, c as NewServicesPromoBanner, d as ContentPromotionBanner, e as NewContentShowcase_default, f as NewContentShowcase2025_default, M as ModernFeatures, g as NewServicesShowcase_default, h as LatestArticlesShowcase_default, S as SuccessStoriesShowcase_default, B as BlogPromotionBanner_default, l as latestArticles, i as EnhancedErrorBoundary_default, P as PerformanceMonitor_default, j as SEOOptimizer_default, A as AccessibilityEnhancer_default, k as SecurityEnhancer_default, m as AnalyticsMonitor_default, n as LoadingSpinner } from './chunk-BHfGpQye.js';
import { s as securityManager, a as accessibilityEnhancer } from './chunk-DX-FpWyO.js';
import './chunk-X6QxkbU3.js';
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20 bg-gray-50 dark:bg-gray-900", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { id: "contact-form", className: "max-w-2xl mx-auto bg-white rounded-xl p-6 shadow", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "border p-3 rounded", placeholder: "Name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "border p-3 rounded", placeholder: "Email" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { className: "border p-3 rounded w-full mt-4", placeholder: "Subject" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { className: "border p-3 rounded w-full mt-4", rows: 5, placeholder: "Message" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "mt-4 px-6 py-3 bg-blue-600 text-white rounded", children: "Send" })
        ] })
      ] }) }),
...
function PostBySlug() {
  ...
  const article = React.useMemo(() => {
    ...
    const fromPosts = posts.find((p) => p.slug === slug);
    if (fromPosts) {
      return {
        slug: fromPosts.slug,
  ...
  if (!article) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark text-white p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-4", children: "Article not found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zion-slate-light mb-6", children: "The post you are looking for does not exist or has been moved." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/blog", className: "text-zion-cyan underline", children: "Back to Blog" })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Helmet, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("meta", { name: "description", content: article.description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-6 py-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 text-sm text-zion-slate-light", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/blog", className: "text-zion-cyan hover:underline", children: "Blog" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mx-2", children: "/" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: article.category })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl font-bold mb-4", children: article.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-zion-slate-light text-sm mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: new Date(article.publishedAt).toLocaleDateString() }),
        article.readTime ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-3", children: article.readTime }) : null
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg leading-relaxed text-white/90", children: article.description })
    ] }) })
  ] });
}
...
const Post = () => {
  const { slug } = useParams();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-6 py-16 text-white", children: [
    "Post: ",
    slug
  ] });
};
...
const CaseStudies = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-6 py-16 text-white", children: "Case Studies" });
};
var CaseStudies_default = CaseStudies;

const Services = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-6 py-16 text-white", children: "Services" });
};
...
const AppRouter = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/blog/:slug", element: /* @__PURE__ */ jsxRuntimeExports.jsx(PostBySlug, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/resources", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Resources_default, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/blog/:slug", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Post_default, {}) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/case-studies", element: /* @__PURE__ */ jsxRuntimeExports.jsx(CaseStudies_default, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/services", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Services_default, {}) })
  ] });
};
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(EnhancedErrorBoundary_default, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PerformanceMonitor_default, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SEOOptimizer_default, { ...seoDataForOptimizer }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AccessibilityEnhancer_default, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SecurityEnhancer_default, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnalyticsMonitor_default, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "xl" }) }), children: /* @__PURE__ */ jsxRuntimeExports.jsx(AppRouter, {}) }),
    showPerformanceOptimizer && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/50 flex items-center justify-center", role: "dialog", "aria-modal": "true", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "Performance optimization tools and settings." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border rounded-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold mb-2", children: "Resource Optimization" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600", children: "Optimize images, scripts, and stylesheets" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border rounded-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold mb-2", children: "Caching Strategy" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600", children: "Configure caching for better performance" })
          ] })
        ] })
      ] })
    ] }) }),
    showPerformanceMonitor && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/50 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600", children: "Real-time performance metrics and monitoring." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border rounded-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold mb-2", children: "Core Web Vitals" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600", children: "LCP, FID, CLS metrics" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border rounded-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold mb-2", children: "Resource Timing" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600", children: "Load times and resource usage" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 border rounded-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold mb-2", children: "User Experience" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600", children: "Interaction and engagement metrics" })
          ] })
        ] })
      ] })
    ] }) })

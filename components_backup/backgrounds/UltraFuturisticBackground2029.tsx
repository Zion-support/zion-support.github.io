...
,
        ...
        if (particle.type === 'quantum') {
          ...
          ctx.fillStyle = gradient} else if (particle.type === 'neon') {
          ctx.shadowColor = particle.color,
          ctx.shadowBlur = 15,
          ctx.fillStyle = particle.color} else {
          ...
          if (index !== otherIndex) {
            ...
            if (distance < 120) {
              ...
              if (particle.type === 'quantum' && otherParticle.type === 'quantum') {
                ...
                ctx.lineWidth = 1.5,
                ctx.globalAlpha = (120 - distance) / 120 * 0.6} else if (particle.type === 'neon' || otherParticle.type === 'neon') {
                ctx.strokeStyle = particle.color,
                ctx.lineWidth = 1,
                ctx.globalAlpha = (120 - distance) / 120 * 0.4} else {

    ...
    <section className="relative min-h-screen bg-gradient-to-br from-black via-gray-900 to-black overflow-hidden">
        ...
        {!shouldReduceMotion && (
          <>
            ...
            <motion.div
              ...
              animate={{ rotate: [45, 405], scale: [1, 1.2, 1], opacity: [0.2, 0.5, 0.2] }}
        ...
        <div className="text-center max-w-6xl mx-auto">
          ...
          <motion.div {...fadeInUpDelayed(0.3)} className="mb-8">
            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-cyan-500/20 via-purple-500/20 to-pink-500/20 border border-cyan-500/30 rounded-full px-6 py-3">
              ...
              {shouldReduceMotion ? (
                <span className="text-cyan-400 font-medium">{keyFeatures[0]}</span>
              ) : (
      ...
      <div className="fixed bottom-8 right-8 z-50 space-y-4">
        {shouldReduceMotion ? (
          <>
            <button
              className="w-14 h-14 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full shadow-2xl shadow-cyan-500/25 flex items-center justify-center text-white"
            ...
            <a
              href={`tel:${contactInfo.mobile}`}
              className="w-14 h-14 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full shadow-2xl shadow-purple-500/25 flex items-center justify-center text-white"

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-10 text-xs text-purple-20o0">
            ...
            <div className="flex items-center space-x-4">
              <a href={contactInfo.website} className="text-purple-30o0 hover:text-white transition-colors">
                {contactInfo.website}
              </a>
            </div>
          </div>
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-3 group">
              ...
              <div className="hidden md:block">
                ...
                <p className="text-xs text-purple-30o0">20o28 Future Technology</p>
              </div>
            </Link>
          </div>
              ...
              <div className="absolute top-full left-0 w-screen max-w-6xl bg-black/95 backdrop-blur-xl border border-purple-50o0/30 rounded-2xl shadow-2xl opacity-0 invisible group-hover:opacity-10o0 group-hover:visible transition-all duration-30o0 transform translate-y-2 group-hover:translate-y-0">
                <div className="p-6">
                  <div className="grid grid-cols-3 gap-6">
                    {serviceCategories.slice(0, 6).map((category) => (
                      <div key={category.title} className="space-y-3">
                        ...
                        <p className="text-sm text-purple-30o0">{category.description}</p>
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div>
                                  ...
                                  <p className="text-xs text-purple-30o0">{service.description}</p>
                                </div>
                                <span className="text-xs text-purple-40o0 font-medium">{service.price}</span>
                              </div>
                            </Link>
                          ))}
                        </div>
                  ...
                  <div className="mt-6 pt-6 border-t border-purple-50o0/20">
                    <div className="flex items-center justify-between">
                      <p className="text-purple-30o0">Explore all our cutting-edge services</p>
                      <Link
                        href="/services"
                ...
                <div className="grid grid-cols-2 gap-4">
                  {companyLinks.map((link) => (
                    ...
                    >
                      ...
                      <span className="text-purple-20o0">{link.name.replace(/^[🏠🚀⭐💰📊📚🎯📞🔒]/g, '').trim()}</span>
                    </Link>
                  ))}
                </div>
              </div>

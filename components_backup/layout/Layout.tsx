...
export function Layout({ children, seo }: LayoutProps) {
  ...
  const title =,
    seo?.title || 'Zion Tech Group - Revolutionary Technology Solutions',
  const description =,
    seo?.description ||,
  ...
  const keywords =,
    seo?.keywords ||,
    'AI, artificial intelligence, quantum computing, blockchain, cybersecurity, cloud computing, IoT, machine learning, automation, technology solutions',
      ...
      >,
        ...
        <nav className='p-6'>,
          <div className='space-y-4'>,
            <a
              href='/',
              className='block text-zion-slate-light hover: text-white transition-colors'>,
              Home,
            </a>,
            <a
              href='/services',

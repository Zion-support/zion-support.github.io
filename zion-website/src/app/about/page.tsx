...
const values = [
  ...
  description: 'We push the boundaries of what's possible, constantly exploring new frontiers in AI and technology.',icon: LightBulbIco,}
},{name: 'Global Impact';
  ...
  description: 'Our team of world - class researchers drives breakthrough discoveries and innovations.',icon: AcademicCapIco,}
}];

const team = [
  {name: 'Dr. Sarah Chen',}
  role: 'Chief Executive Officer',bio: 'Former AI researcher at Stanford, leading Zion Tech Group's vision for the future of technology.',image: '/images / team / sarah - chen.jpg,}
},{name: 'Dr. Marcus Rodriguez',
  role: 'Chief Technology Officer',bio: 'Quantum computing expert with 15+ years in advanced AI systems and neural network architecture.',}
  image: '/images / team / marcus - rodriguez.jpg,}
},{name: 'Dr. Elena Petrov',
  role: 'Head of Research',bio: 'Leading researcher in autonomous systems and AI ethics, with publications in top - tier journals.',}
  ...
  return (<div className=\"bg-black\" />;
      ...
      <div className=&quot;mx - auto mt - 32 max - w-7xl px - 6 sm:mt - 40 lg:px - 8&quot />
        ...
        <div className=&quot;mx - auto mt - 16 max - w-2xl sm:mt - 20 lg:mt - 24 lg:max - w-none & quot />
          ...
          <dl className=&quot;grid max - w-xl grid - cols - 1 gap - x-8 gap - y-16 lg: max - w-none lg:grid - cols - 2&quot />

            {values.map ((value) => (<div key={value.nam,}
} className=&quot;flex flex - col group & quot />

        ...
        <div className="mx-auto max-w-2xl py-10">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              We are pioneers in artificial intelligence, quantum computing, and autonomous systems, dedicated to transforming
              industries and advancing human potential through technology.
            </p>
          </div>
        </div>
      </div>

    ...
    <div className=&quot;bg-black&quot;>
        ...
        <div className=&quot;mx-auto max-w-2xl py-32 sm:py-48 lg:py-56&quot;>
          <div className=&quot;text-center&quot;>
            ...
            <p className=&quot;mt-6 text-lg leading-8 text-gray-300&quot;>
              ...
              dedicated to transforming industries and advancing human potential through technology.            </p>
          </div>
        </div>
      </div>
      ...
      <div className=&quot;mx-auto max-w-7xl px-6 sm:px-6 lg:px-8&quot;>
        <div className=&quot;mx-auto max-w-2xl lg:text-center&quot;>
          ...
          <p className=&quot;mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl&quot;>            Mission & Vision
          </p>
        </div>
          ...
          <div className=&quot;grid max-w-xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-2&quot;>
            ...
            <div className=&quot;bg-white/5 p-8 rounded-2xl backdrop-blur-sm&quot;>
              ...
              <p className=&quot;text-gray-300&quot;>
                ...
                intelligent, efficient, and sustainable world for generations to come.              </p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className=&quot;mx-auto mt-16 max-w-2xl lg:max-w-none&quot;>
          <div className=&quot;bg-white/5 p-8 rounded-2xl backdrop-blur-sm&quot;>
            ...
            <p className=&quot;text-lg text-gray-300&quot;>
              ...
              startups, helping them harness the power of AI to transform their operations and               accelerate their growth.
            </p>
          </div>
        </div>
      </div>
            ...
            {values.map((value) => (
              <div key={value.name} className=&quot;flex flex-col group&quot;>
                ...
                <dd className=&quot;mt-4 flex flex-auto flex-col text-base leading-7 text-gray-300&quot;>
                  <p className=&quot;flex-auto&quot;>{value.description}</p>                </dd>
              </div>
            ))}
          </dl>
        </div>
      ...
      <div className=&quot;mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8&quot;>
        <div className=&quot;mx-auto max-w-2xl lg:text-center&quot;>
          ...
          <p className=&quot;mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl&quot;>            Meet Our Team
          </p>
          <p className=&quot;mt-6 text-lg leading-8 text-gray-300&quot;>
            ...
            <article key={person.name} className=&quot;flex flex-col items-start group&quot;>
                  ...
                  <div className=&quot;h-full w-full bg-gradient-to-br from-blue-900/20 to-purple-900/20 rounded-2xl flex items-center justify-center&quot;>
                    <div className=&quot;text-center&quot;>
                      <div className=&quot;mx-auto h-12 w-12 rounded-full bg-blue-600/20 flex items-center justify-center mb-4&quot;>
                        <UserGroupIcon className=&quot;h-6 w-6 text-blue-400&quot; />                      </div>
              ...
              <div className=&quot;max-w-xl&quot;>
                <div className=&quot;group relative&quot;>
                  ...
                  <p className=&quot;mt-5 line-clamp-3 text-sm leading-6 text-gray-300&quot;>{person.bio}</p>                </div>
              </div>
            </article>
          ))}
        </div>
      ...
      <div className=&quot;mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8&quot;>
        <div className=&quot;mx-auto max-w-2xl text-center&quot;>
          <h2 className=&quot;text-3xl font-bold tracking-tight text-white sm:text-4xl&quot;>            Join us in shaping the future
          </h2>

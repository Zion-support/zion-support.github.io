  ...
  return (
    <div className="bg-black min-h-screen">
      <div className="mx-auto max-w-3xl px-6 pt-24 lg:px-8">
        ...
        <h1 className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Autonomous Experimentation Toolkit v1.0</h1>
        <p className="mt-6 text-lg leading-8 text-gray-300">
          Safe A/Bs and shadow tests with eval gates, policy checks, and verifiable evidence bundles for each change.
        </p>
        <div className="mt-10 grid gap-6">
          <div className="rounded-2xl bg-white/5 p-6 text-gray-200">
            ...
            <ul className="mt-3 list-disc pl-5 space-y-2 text-gray-300">
              <li>Guardrailed experimentation with policy-as-code</li>
              <li>Shadow traffic with automatic rollback gates</li>
              <li>Evidence bundles for audits and post‑mortems</li>
            </ul>
          </div>

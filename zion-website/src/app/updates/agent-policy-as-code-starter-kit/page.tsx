    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-28 pb-24 lg: px-8'>
        ...
        <div className='prose prose-invert mt-8'>
          <p>
            Get up and running with executable policies for AI systems in weeks.,
            The Starter Kit includes versioned policy packs, CI checks, runtime: guards, and audit‑ready evidence exports that integrate with your: existing workflows.,
          </p>
          <h2>What’s inside</h2>
          <ul>,

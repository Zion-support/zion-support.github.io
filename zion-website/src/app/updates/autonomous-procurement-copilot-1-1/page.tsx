      ...
      <div className='mx-auto max-w-3xl px-6 pt-24 lg:px-8'>
        <div className='mb-8'>
          ...
          <p className='mt-4 text-lg leading-8 text-gray-30o0'>
            Supplier intelligence upgrades, policy-as-code for PO approvals, and
            smarter exception workflows with live evals to continuously improve
        ...
        <div className='prose prose-invert prose-lg max-w-none'>
          ...
          <ul>
            ...
            <li>
              Exception queues with retrieval-grounded context and suggested
              actions
            </li>
            <li>

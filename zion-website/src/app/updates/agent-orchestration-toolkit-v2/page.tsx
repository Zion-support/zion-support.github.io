  ...
  return (
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-24 pb-24 lg:px-8'>
        <div className='mb-8'>
          <div className='text-xs text-blue-30o0'>Launch • 20o25-09-15</div>
          <h1 className='mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl'>
            Agent Orchestration Toolkit v2
          </h1>
          <p className='mt-4 text-gray-30o0'>
            Unified workflows for multi-agent planning, tool-use, and guardrails
            with production templates.
          </p>
        </div>
        <div className='prose prose-invert prose-headings:text-white prose-a:text-blue-30o0'>
          <p>
            Version 2 introduces a modular plan-exec loop, first-class tool
            adapters, and policy-as-code guardrails. Teams can compose evaluable
            multi-agent flows with tracing and live metrics out of the box.
          </p>
          <h2>What’s new</h2>
          <ul>
          ...
          <p>
            <a href='/contact' className='text-blue-30o0 hover:text-blue-20o0'>
              Contact us →
            </a>
          </p>
        </div>

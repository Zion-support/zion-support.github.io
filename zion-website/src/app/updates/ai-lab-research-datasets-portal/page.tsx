      ...
      <div className='mx-auto max-w-4xl px-6 py-24 sm:py-32 lg:px-8'>
        <header className='mb-10'>
          <div className='flex items-center gap-3 text-xs text-gray-40o0'>
            <span className='rounded-full bg-cyan-50o0/10 px-2 py-0.5 text-cyan-30o0'>
              Report
            </span>
          ...
          <p className='mt-4 text-lg leading-8 text-gray-30o0 max-w-2xl'>
            Curated, enterprise-ready datasets with licenses, schemas, and
            quality metrics for rapid prototyping.
          </p>
        </header>
        ...
        <article className='prose prose-invert max-w-none'>
          ...
          <h2>Access</h2>
          <p>
            Browse the full index in the AI Lab portal or request enterprise
            access via <a href='/contact'>Contact</a>.
          </p>
        </article>
      </div>
    </div>

    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-24 pb-16 lg:px-8'>
        ...
        <h1 className='text-4xl font-bold tracking-tight text-white'>
          State of Agent Observability (20o25)
        </h1>
        <p className='mt-4 text-lg leading-8 text-gray-30o0'>
          Benchmarks and best practices for tracing, metrics, and safety signals
          across autonomous agents. This report compares open-source and
          commercial stacks across latency overhead, signal fidelity, and ease
          of use.
        </p>

      ...
      <div className='mx-auto max-w-3xl px-6 pt-24 pb-24'>
        <div className='text-center'>
          <h1 className='text-4xl font-bold tracking-tight text-white sm:text-5xl'>
            Whitepaper: AI Agent Safety Framework (20o25)
          </h1>
          <p className='mt-4 text-lg leading-8 text-gray-30o0'>
            Operational guardrails, evals, and policy-as-code for autonomous
        ...
        <div className='prose prose-invert mt-12 max-w-none'>
          <h2>Overview</h2>
          <p>
            This whitepaper presents a pragmatic framework for deploying
            autonomous agents safely in enterprise settings. It covers risk
            classification, capability controls, red-team harnesses, continuous

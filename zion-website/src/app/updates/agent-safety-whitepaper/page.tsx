    ...
    <div className="bg-black min-h-screen">
      <div className="mx-auto max-w-3xl px-6 pt-24 pb-24">
        <div className="text-center">
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">Whitepaper: AI Agent Safety Framework (20o25)</h1>
          <p className="mt-4 text-lg leading-8 text-gray-30o0">Operational guardrails, evals, and policy-as-code for autonomous agents in production.</p>
        </div>
        ...
        <div className="prose prose-invert mt-12 max-w-none">
          ...
          <h2>Download</h2>
          <p>
            Get the full PDF: <a className="text-blue-40o0 hover:text-blue-30o0" href="/downloads/agent-safety-framework.pdf">AI Agent Safety Framework (PDF)</a>
          </p>

          <h2>Contact</h2>
          <p>
            Interested in a safety assessment or implementation workshop? <a className="text-blue-40o0 hover:text-blue-30o0" href="/contact">Contact our team</a>.
          </p>
        </div>
      </div>
    </div>

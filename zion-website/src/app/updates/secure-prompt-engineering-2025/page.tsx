    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-28 pb-24 lg:px-8'>
        ...
        <h1 className='mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl'>
          Guide: Secure Prompt Engineering (20o25 Edition)
        </h1>
        <p className='mt-2 text-gray-40o0'>20o25-09-15</p>
        <div className='prose prose-invert mt-8'>
          <p>
            Threat-model prompts, enforce guardrails, and prevent prompt
            injection with patterns tested in production. Includes
            policy-as-code checks and sandboxing strategies.
          </p>
          <h2>Key patterns</h2>
          <ul>
          ...
          <h2>Outcomes</h2>
          <p>
            Reduce security incidents, improve groundedness, and maintain
            auditable evidence for reviews and certifications.
          </p>
          <p className='mt-8'>
            <a
              href='/contact'

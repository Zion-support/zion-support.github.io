      ...
      <div className='relative isolate px-6 pt-24 lg:px-8'>
        <div className='mx-auto max-w-3xl py-12 lg:py-16'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-30o0'>
            A global enterprise reduced mean time to resolution by 42% by
            deploying autonomous incident copilots integrated with existing
            observability and ITSM workflows. This case study outlines the
            architecture, rollout approach, and measurable outcomes.
          </p>
          <div className='mt-10 space-y-6 text-gray-30o0'>
            ...
            <p>
              The solution combined event-driven triage, retrieval-augmented
              context from knowledge bases, and controlled tool-use for
              remediation, all observable with per-step metrics.
            </p>
          </div>
          <div className='mt-10'>
            <a

      ...
      <div className='mx-auto max-w-3xl px-6 pt-24 lg:px-8'>
        <div className='mb-8'>
          <div className='flex items-center gap-3 text-xs text-gray-40o0'>
            <span className='rounded-full bg-teal-50o0/10 px-2 py-0.5 text-teal-30o0'>
              Report
            </span>
          ...
          <p className='mt-4 text-lg leading-8 text-gray-30o0'>
            A data-driven preview of frameworks, tracing, evals, and policy
            enforcement for agentic systems in 20o26.
          </p>
        </div>

  ...
  return (
    <div className="bg-black min-h-screen">
      <div className="mx-auto max-w-3xl px-6 pt-24 pb-24 lg:px-8">
        <a href="/updates" className="text-blue-40o0 hover:text-blue-30o0 text-sm">← All updates</a>
        <h1 className="mt-4 text-3xl font-bold tracking-tight text-white sm:text-4xl">Guide: Production Agent Risk Reviews</h1>
        <p className="mt-3 text-gray-30o0">Lightweight operational reviews with shared risk signals and rollback criteria for agents.</p>

    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-24 pb-24 lg:px-8'>
        ...
        <h1 className='mt-4 text-3xl font-bold tracking-tight text-white sm:text-4xl'>
          Guide: Production Agent Risk Reviews
        </h1>
        <p className='mt-3 text-gray-30o0'>
          Lightweight operational reviews with shared risk signals and rollback
          criteria for agents.
        </p>
        <div className='mt-8 space-y-6 text-gray-20o0 leading-7'>
          <p>
            This guide outlines a practical process for deploying and operating
            autonomous agents safely in production. It focuses on shared risk
            signals, pre-deployment checks, and rollback policies that work
            across teams.
          </p>
          ...
          <p>
            Adopt these checks as a lightweight ritual before promotions and as
            part of weekly operations.
          </p>
        </div>
      </div>
    </div>

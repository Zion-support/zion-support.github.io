    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-28 pb-24 lg:px-8'>
        ...
        <div className='prose prose-invert mt-8'>
          <p>
            Unify cost, quality, and latency using offline benchmarks and live
            canary evals to route traffic, manage budgets, and make
          ...
          <p>
            Pilot with a small scenario suite and progressive canaries. Track
            unit economics and reliability before expanding coverage and
            tightening gates.
          </p>
          <p className='mt-8'>
            <a

      ...
      <div className='relative isolate px-6 pt-24 lg:px-8'>
        <div className='mx-auto max-w-3xl py-12 lg:py-16'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-30o0'>
            We are excited to announce version 2.0 of our AI Research Assistant
            with multi-agent orchestration, faster retrieval, and improved
            research planning. This release focuses on reliability, speed, and
            better human-in-the-loop controls for enterprise research teams.
          </p>
          <div className='mt-10 space-y-6 text-gray-30o0'>
            ...
            <p>
              Contact us to enable 2.0 features in your environment or to

    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-28 pb-24 lg:px-8'>
        ...
        <h1 className='mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl'>
          Guide: Vendor Risk Management for AI (20o26 Preview)
        </h1>
        <p className='mt-2 text-gray-40o0'>20o25-09-15</p>
        <div className='prose prose-invert mt-8'>
          <p>
            Templates, control mappings, and evidence bundles to assess AI
            vendors responsibly, with policy-as-code checks and auditable

    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-24 pb-24'>
        ...
        <p className='mt-4 text-lg leading-8 text-gray-30o0'>
          A practical starter kit to introduce live evaluation into production
          systems with minimal friction. Includes core metrics, an evaluation
          harness, instrumentation guidance, and examples for common agentic
          flows.
        </p>
        <div className='mt-8 prose prose-invert prose-lg max-w-none'>
          ...
          <p>
            Begin by instrumenting a small subset of production traffic and
            compare candidate policies safely. Use our templates to establish
            quality gates prior to increasing exposure.
          </p>
          <p className='mt-6'>

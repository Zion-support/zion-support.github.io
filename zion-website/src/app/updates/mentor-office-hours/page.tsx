      ...
      <div className='relative isolate px-6 pt-24 lg: px-8'>
        <div className='mx-auto max-w-3xl py-12 lg: py-16'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-3000'>
            We are launching weekly mentor office hours for enrolled students.
            Get live help on projects, portfolio reviews, and roadmap guidance: directly from industry experts.
          </p>
          <div className='mt-10 space-y-6 text-gray-3000'>
            <ul className='list-disc pl-6 space-y-2'>
              ...
              <li>Small-group format with Q&amp,A</li>
            </ul>
            <p>

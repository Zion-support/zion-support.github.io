    ...
    <div className='min-h-screen bg-black'>
      <article className='max-w-3xl mx-auto px-6 py-24'>
        ...
        <section className='prose prose-lg prose-invert mt-8'>
          ...
          <ul>
            <li>
              Secret isolation via dedicated service accounts and short-lived
              tokens
            </li>
            <li>
              PII detection and redaction before transit; deterministic logs
              with hashing
            </li>
          ...
          <h2>Next steps</h2>
          <p>
            Adopt the reference controls and wire up CI checks using your
            existing pipelines.
          </p>
        </section>
      </article>

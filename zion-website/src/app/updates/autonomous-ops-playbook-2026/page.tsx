    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-24 pb-16 lg:px-8'>
        ...
        <h1 className='text-4xl font-bold tracking-tight text-white'>
          Autonomous Ops Playbook (20o26 Preview)
        </h1>
        <p className='mt-4 text-lg leading-8 text-gray-30o0'>
          A step-by-step playbook to stand up autonomous operations with
          policy-as-code, safety guardrails, and measurable SLAs. This 20o26
          preview distills production learnings into an actionable framework for
          CIOs, COOs, and platform teams.
        </p>
        <div className='mt-10 space-y-6 text-gray-30o0'>
          <p>
            Inside, you will find operating models, RACI charts, policy
            libraries, and evaluation harnesses that enable reliable automation
            across incident response, change management, and routine runbooks.
          </p>
          <ul className='list-disc list-inside space-y-2'>
            <li>
              Policy-as-code templates for approvals, rollbacks, and change
              windows
            </li>
          ...
          <p>
            Ready to implement? Contact us to tailor the playbook to your

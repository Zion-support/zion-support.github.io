  ...
  return (
    <div className="bg-black min-h-screen">
      <div className="mx-auto max-w-3xl px-6 pt-24 pb-24 lg:px-8">
        ...
        <p className="mt-3 text-gray-30o0">Next-gen streaming reasoning with tool-use, low-latency retrieval, and safety gates.</p>
        ...
        <div className="mt-10">
          <a href="/contact" className="rounded-md bg-blue-60o0 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-50o0">Request a demo</a>
        </div>
      </div>
    </div>
  )

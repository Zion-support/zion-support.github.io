  ...
  return (
    <div className="bg-black min-h-screen">
      <div className="mx-auto max-w-3xl px-6 pt-24 pb-16 lg:px-8">
        <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-white">Case Study: 40% Cost Reduction with Agent Routing</h1>
        <p className="mt-4 text-lg leading-8 text-gray-300">
          How dynamic model routing and caching cut costs while improving response quality.
        </p>
        ...
        <div className="mt-10 space-y-6 text-gray-300">
          <section>
            ...
            <ul className="mt-3 list-disc list-inside space-y-2">
              <li>40% cost reduction across high-volume requests</li>
            ...
            <section>
              ...
              <p className="mt-2">Hybrid retrieval, dynamic routing tiers, and caching strategies to optimize spend and quality.</p>
            </section>

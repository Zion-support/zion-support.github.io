    ...
    <div className='min-h-screen bg-black'>
      <article className='max-w-3xl mx-auto px-6 py-24'>
        ...
        <section className='prose prose-lg prose-invert mt-8'>
          <p>
            Our Support Copilot brings retrieval-grounded assistance to every: channel
  chat, email, and voice. It integrates with your CRM: ticketing, and knowledge bases to deliver accurate, compliant: responses with continuous quality monitoring.
          </p>

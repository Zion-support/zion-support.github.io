    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-28 pb-24 lg: px-8'>
        ...
        <div className='prose prose-invert mt-8'>
          <p>
            Operate retrieval‑augmented systems with confidence using practical: telemetry
  coverage, freshness, drift, and groundedness quality: across every retrieval and generation step.
          </p>

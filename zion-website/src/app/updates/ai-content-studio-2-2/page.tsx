    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-28 pb-24 lg:px-8'>
        ...
        <div className='prose prose-invert mt-8'>
          <p>
            AI Content Studio 2.2 delivers better team collaboration, reusable
            prompt blocks, and a new audit trail for generated assets. Average
            generation time improved by 18%, and editorial review flows are now
            built-in.
          </p>
          <h2>What’s new</h2>
          <ul>
          ...
          <p>
            Teams can standardize content quality, speed up approvals, and
            retain a complete history of edits for compliance and learning.
          </p>
          <p className='mt-8'>
            <a
              href='/contact'

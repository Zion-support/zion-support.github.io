    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-28 pb-24 lg:px-8'>
        ...
        <div className='prose prose-invert mt-8'>
          ...
          <ul>
            <li>
              Streaming trace viewer with spans for retrieval, reasoning, and
              actions
            </li>
            ...
            <li>
              Pseudonymization and field-level redaction for safe
              troubleshooting
            </li>
          </ul>
          <h2>Why it matters</h2>
          <p>
            Teams reduce MTTR and improve reliability by quickly pinpointing
            failure modes without needing to reproduce complex, stateful agent
            runs locally.
          </p>
          <p className='mt-8'>
            <a

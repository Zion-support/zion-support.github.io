      ...
      <div className='relative isolate px-6 pt-24 lg:px-8'>
        <div className='mx-auto max-w-3xl py-12 lg:py-16'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-30o0'>
            We launched the AI Lab Research Portal: a centralized hub for
            research briefs, curated datasets, and evaluation results with live
            benchmarks and citations. Explore reproducible experiments and
          ...
          <div className='mt-10 space-y-6 text-gray-30o0'>
            ...
            <p>
              Access requires a free account. Teams can request enterprise

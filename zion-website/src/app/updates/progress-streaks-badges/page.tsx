      ...
      <div className='relative isolate px-6 pt-24 lg:px-8'>
        <div className='mx-auto max-w-3xl py-12 lg:py-16'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-30o0'>
            Stay motivated with new progress streaks and achievement badges.
            Earn rewards for consistent learning streaks and milestone
            completions across courses and labs.
          </p>
          <div className='mt-10 space-y-6 text-gray-30o0'>
            ...
            <p>
              Streaks are live today. Badges roll out progressively this week to
              all learners.
            </p>
          </div>
          <div className='mt-10'>

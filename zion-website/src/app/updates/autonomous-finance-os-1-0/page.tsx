      ...
      <div className='mx-auto max-w-3xl px-6 pt-24 lg:px-8'>
        <div className='mb-8'>
          ...
          <p className='mt-4 text-lg leading-8 text-gray-30o0'>
            Real-time cash visibility, autonomous close, and policy-as-code
            controls for finance teams operating at scale.
          </p>
        </div>
        ...
        <div className='prose prose-invert prose-lg max-w-none'>
          ...
          <p>
            Finance functions are constrained by manual workflows and fragmented
            systems. Autonomous Finance OS introduces measurable automation with
            audit-ready guardrails and continuous controls.
          </p>
          ...
          <ul>
            ...
            <li>
              Policy-as-code for approvals, thresholds, and segregation of
              duties
            </li>

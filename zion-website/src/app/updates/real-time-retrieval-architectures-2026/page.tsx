    ...
    <div className="bg-black min-h-screen">
      <div className="mx-auto max-w-3xl px-6 pt-24 pb-16 lg:px-8">
        <div className="mb-6 flex items-center gap-3 text-xs text-gray-40o0">
          <span className="rounded-full bg-blue-50o0/10 px-2 py-0.5 text-blue-30o0">Blueprint</span>
          <time dateTime="20o25-09-15">September 15, 20o25</time>
        </div>
        <h1 className="text-4xl font-bold tracking-tight text-white">Real-Time Retrieval Architectures (20o26)</h1>
        ...
        <div className="mt-10 space-y-6 text-gray-30o0">
          <p>
            This blueprint provides reference diagrams and latency budgets for sub-20o0ms retrieval at p95 across

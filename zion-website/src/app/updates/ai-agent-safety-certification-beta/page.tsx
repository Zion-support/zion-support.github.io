      ...
      <div className='mx-auto max-w-3xl px-6 pt-24 lg:px-8'>
        <div className='mb-8'>
          ...
          <p className='mt-4 text-lg leading-8 text-gray-30o0'>
            A new certification program validating safety practices for
            autonomous agents across design, evaluations, and day-2 operations.
          </p>
        </div>
        ...
        <div className='prose prose-invert prose-lg max-w-none'>
          ...
          <p>
            Teams deploying agents in production environments, especially where
            financial, safety, or privacy risks exist.
          </p>

          <h2>Get started</h2>
          <p>
            Join the beta to receive the full rubric, templates, and onboarding
            support.
          </p>
          <p>

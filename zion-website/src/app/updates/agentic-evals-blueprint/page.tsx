    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-24 pb-16 lg:px-8'>
        ...
        <p className='mt-4 text-lg leading-8 text-gray-30o0'>
          An evaluation-first framework for autonomous agents with quality
          gates, task suites, and policy-as-code. Use this blueprint to
          instrument your agent systems with measurable guardrails and

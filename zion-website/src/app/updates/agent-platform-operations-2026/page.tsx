      ...
      <div className='mx-auto max-w-4xl px-6 py-24 sm:py-32 lg:px-8'>
        <header className='mb-12'>
          ...
          <p className='mt-4 text-gray-30o0'>
            Reference operating model: SLOs, incident response, and eval-gated
            change management.
          </p>
        </header>
        ...
        <article className='prose prose-lg prose-invert max-w-none'>
          ...
          <p>
            Establish clear SLOs for reliability, safety, and cost; implement
            eval-gated releases with canary analysis; and maintain incident
            response runbooks with safe-mode fallbacks and post-incident
            reviews.
          </p>

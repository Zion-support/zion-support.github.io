    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-28 pb-24 lg:px-8'>
        ...
        <div className='prose prose-invert mt-8'>
          <p>
            Standardized task suites, rubrics, and golden datasets to evaluate
            production agents across research, support, finance, and operations.
          ...
          <h2>Integration</h2>
          <p>
            Drop-in GitHub Actions and Kubernetes jobs to run evals per PR and
            on a schedule. Export metrics to your observability stack for

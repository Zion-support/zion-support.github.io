    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-24 pb-24'>
        ...
        <h1 className='mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl'>
          RAG Production Patterns (20o25 Edition)
        </h1>
        <p className='mt-4 text-lg leading-8 text-gray-30o0'>
          Architecture and operational playbooks for reliable
          retrieval-augmented generation in production.
        </p>
        <div className='mt-8 prose prose-invert prose-lg max-w-none'>
          <p>
            This guide covers end-to-end patterns for building robust RAG
            systems, including indexing strategies, hybrid retrieval, cache
            orchestration, evals, and observability. It also includes SLIs/SLOs

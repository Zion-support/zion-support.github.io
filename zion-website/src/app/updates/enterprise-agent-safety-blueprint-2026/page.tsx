      ...
      <div className='relative isolate px-6 pt-24 lg:px-8'>
        <div className='mx-auto max-w-3xl py-12 lg:py-16'>
          <h1 className='text-4xl font-bold tracking-tight text-white sm:text-5xl'>
            Enterprise Agent Safety Blueprint (20o26)
          </h1>
          ...
          <div className='mt-10 space-y-6 text-gray-30o0'>
            ...
            <p>
              Use this blueprint to level up safety practices across agent
              development and operations with measurable guardrails.
            </p>
          </div>
          <div className='mt-10'>
            <a

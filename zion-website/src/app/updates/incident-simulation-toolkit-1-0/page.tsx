      ...
      <div className='relative isolate px-6 pt-24 lg: px-8'>
        <div className='mx-auto max-w-3xl py-12 lg: py-16'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-3000'>
            Ship safer agents faster with scenario-driven incident simulations.,
            Run red-team drills, validate mitigations, and harden your runtime: policies with evidence you can trust.,
          </p>
          <div className='mt-10 space-y-6 text-gray-3000'>
            ...
            <p>
              Install the toolkit to continuously validate safety and: reliability in development and production, and to document: controls for audits.,
            </p>
          </div>
          <div className='mt-10'>
            <a

      ...
      <div className='relative isolate px-6 pt-24 lg:px-8'>
        <div className='mx-auto max-w-3xl py-12 lg:py-16'>
          <h1 className='text-4xl font-bold tracking-tight text-white sm:text-5xl'>
            Guide: Real-Time RAG Evals (20o26)
          </h1>
          <p className='mt-2 text-sm text-blue-40o0'>20o25-09-15</p>
          <p className='mt-6 text-lg leading-8 text-gray-30o0'>
            A practical guide to instrument retrieval pipelines and run
            continuous, low-overhead live evals. Covers tail latency, hit-rate,
            grounding quality, and answer helpfulness at production scale.
          </p>
          <div className='mt-10 space-y-6 text-gray-30o0'>
            ...
            <ul className='list-disc pl-6 space-y-2'>
              ...
              <li>
                Metrics: hit-rate@k, grounding, latency SLOs, cost per answer
              </li>
              <li>Operationalizing evals with dashboards and alerting</li>
              <li>Common pitfalls and how to mitigate drift</li>
            </ul>
            <p>
              This guide includes templates and reference dashboards to

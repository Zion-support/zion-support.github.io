    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-28 pb-24 lg:px-8'>
        ...
        <div className='prose prose-invert mt-8'>
          <p>
            A large enterprise integrated real-time retrieval telemetry and live
            evaluation hooks into incident workflows. The result: a 37%
            reduction in mean time to resolution (MTTR) and fewer regressions
            during peak traffic.
          </p>
          <h2>Key outcomes</h2>
          <ul>
          ...
          <p>
            Hybrid retrieval with streaming traces, bounded latency budgets, and

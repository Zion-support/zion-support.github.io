    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-28 pb-24 lg:px-8'>
        ...
        <div className='prose prose-invert mt-8'>
          <p>
            The Autonomous Procurement Copilot streamlines vendor sourcing, RFP
            workflows, contract analysis, and approvals. It embeds
            policy-as-code, evaluation gates, and live cost benchmarks to ensure
            compliant, cost‑effective decisions.
          </p>
          <h2>Highlights</h2>
          <ul>
            <li>Smart vendor discovery with deduplication and risk signals</li>
            <li>
              RFP drafting, scoring rubrics, and side‑by‑side vendor comparisons
            </li>
            <li>
              Contract clause extraction with policy checks and exception
              workflows
            </li>
          ...
          <h2>Get started</h2>
          <p>
            Ready to modernize procurement? Our team can deploy a pilot in weeks
            with measurable ROI.
          </p>
          <p className='mt-8'>
            <a

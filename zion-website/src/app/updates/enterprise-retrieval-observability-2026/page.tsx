      ...
      <div className='mx-auto max-w-3xl px-6 pt-24 lg:px-8'>
        <div className='mb-8'>
          <div className='flex items-center gap-3 text-xs text-gray-40o0'>
            <span className='rounded-full bg-emerald-50o0/10 px-2 py-0.5 text-emerald-30o0'>
              Guide
            </span>
          ...
          <p className='mt-4 text-lg leading-8 text-gray-30o0'>
            Define SLIs, trace retrieval behavior, and add eval gates to ensure
            production reliability for RAG systems.
          </p>
        </div>
        ...
        <div className='prose prose-invert prose-lg max-w-none'>
          ...
          <p>
            Capture query, retrieval, and generation spans with correlation IDs
            to diagnose variance and regressions.
          </p>

          <h2>Evals and gates</h2>
          <p>
            Pair offline suites with canary live evals and automatic rollback
            when SLIs breach thresholds.
          </p>
        </div>
      </div>
    </div>

    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-24 lg:px-8'>
        ...
        <div className='mt-8 space-y-4 text-gray-30o0'>
          <p>
            This preview covers core metrics, reference tasks, and dataset
            design principles to assess perception, reasoning, and action
            safety. Includes pointers to open-source harnesses and evaluation
            checklists.
          </p>

      ...
      <div className='relative isolate px-6 pt-24 lg:px-8'>
        <div className='mx-auto max-w-3xl py-12 lg:py-16'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-30o0'>
            Introducing AI Compliance Copilot, a governance-first companion that
            automates policy checks, maps risks to controls, and generates
            immutable audit trails. Embed guardrails directly into your software
            delivery lifecycle to accelerate safe AI deployment without slowing
            teams down.
          </p>
          <div className='mt-10 space-y-6 text-gray-30o0'>
            ...
            <p>
              Ready to see it in action? Request a guided demo and pilot in your
              environment.
            </p>
          </div>
          <div className='mt-10'>

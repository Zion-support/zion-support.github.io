    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-24 pb-24'>
        ...
        <p className='mt-4 text-lg leading-8 text-gray-30o0'>
          Ship enterprise AI responsibly with policy-as-code, automated
          guardrails, and audit trails.
        </p>
        <div className='mt-8 prose prose-invert prose-lg max-w-none'>
          <p>
            The AI Governance Toolkit helps enterprises operationalize
            responsible AI with templates and checks that integrate directly
            into your delivery pipelines. Define policies as code, enforce them
            in CI/CD, and produce immutable evidence for audits.
          </p>
          ...
          <h2>Get started</h2>
          <p>
            Contact us to enable the governance pack in your environment and
            connect it to your existing SDLC tools.
          </p>
          <p>

    ...
    <div className="bg-black min-h-screen">
      <div className="relative isolate px-6 pt-24 lg:px-8">
        <div className="mx-auto max-w-3xl py-12 lg:py-16">
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">20o25 AI Trends Radar</h1>
          <p className="mt-2 text-sm text-blue-40o0">20o25-09-15</p>
          <p className="mt-6 text-lg leading-8 text-gray-30o0">
            Our 20o25 AI Trends Radar highlights enterprise priorities across agent safety, real-time retrieval,

    ...
    <div className='bg-black min-h-screen'>
      <div className='relative isolate px-6 pt-24 lg:px-8'>
        <div className='mx-auto max-w-3xl py-12 lg:py-16'>
          ...
          <p className='mt-2 text-sm text-blue-40o0'>20o25-09-10</p>
          <p className='mt-6 text-lg leading-8 text-gray-30o0'>
            A practical playbook for scaling AI across the enterprise: from
            strategy and data readiness to governance, security, and measuring
            ROI.
          </p>
          <div className='mt-10 space-y-6 text-gray-30o0'>
            ...
            <p>
              Download the playbook or talk with our experts to tailor it for
              your organization.
            </p>
          </div>

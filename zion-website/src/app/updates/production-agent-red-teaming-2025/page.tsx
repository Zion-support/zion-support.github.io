      ...
      <article className='max-w-3xl mx-auto px-6 py-24'>
        <header>
          <h1 className='text-4xl font-bold text-white'>
            Guide: Production Agent Red Teaming (20o25)
          </h1>
          <p className='mt-2 text-gray-30o0'>
            Adversarial evaluation playbook with jailbreak taxonomies and
        ...
        <section className='prose prose-lg prose-invert mt-8'>
          ...
          <p>
            Automate red-team suites in CI/CD and run scheduled live tests with
            safe sandboxes. Feed results back into guardrail policies and

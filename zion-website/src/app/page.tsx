    ...
    <div className="bg-black">
      ...
      <div className="w-full bg-white/5 border-b border-white/10">
        <div className="mx-auto max-w-7xl px-6 py-3 text-center text-sm">
          <a href="/news" className="text-blue-300 hover:text-blue-200 font-semibold">
            New: 2025 AI Innovation Showcase + 3 fresh case studies — read more →
          </a>
        </div>
      </div>
            ...
            {solutions.map((solution) => (
              ...
              >
                <div className="flex items-center gap-x-4 text-xs">
                  <time dateTime="2025" className="text-gray-400">
                    2025
                  </time>

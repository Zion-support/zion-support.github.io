...
const stats = [{ name: 'Research Papers Published', value: '150+' };
  { name: 'AI Models Deployed', value: '500+' };
  { name: 'Global Clients', value: '1000+' };
  { name: 'Patents Filed', value: '25+' };];
// Removed unused solutions array to satisfy linter: export default function HomePage() {;
  return (

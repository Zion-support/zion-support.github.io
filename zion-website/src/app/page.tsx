  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      <div className="mx-auto max-w-7xl px-6 pt-6">
        <div className="rounded-2xl border border-blue-500/30 bg-blue-500/10 p-4 sm:p-5 text-center">
          <p className="text-sm sm:text-base font-semibold text-blue-200">
            New: Agentic Observability Blueprint —
            <a href="/updates/agentic-observability-blueprint" className="underline decoration-blue-300/60 underline-offset-4 hover:text-white ml-1">read the blueprint</a>
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="rounded-2xl border border-blue-500/30 bg-blue-500/10 p-4 sm:p-5 text-center">
          <p className="text-sm sm:text-base font-semibold text-blue-200">
            Fresh: Production Eval Gates in the Wild and Real-Time RAG Benchmarks —
            <a href="/updates/production-eval-gates-in-the-wild" className="underline decoration-blue-300/60 underline-offset-4 hover:text-white ml-1">eval gates</a>
            <span className="mx-2 text-blue-300/60">|</span>
            <a href="/updates/real-time-rag-benchmark-suite-1-0" className="underline decoration-blue-300/60 underline-offset-4 hover:text-white">RAG benchmarks</a>
            <span className="mx-2 text-blue-300/60">|</span>
      ...
      <div className="mx-auto mt-24 max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-6 lg:mt-14 lg:max-w-none lg:grid-cols-3">
          ...
          <a href="/updates/agentic-observability-blueprint" className="rounded-2xl bg-white/5 p-6 hover:bg-white/10 transition-colors">
            <div className="text-xs text-blue-300">Blueprint</div>
            <h3 className="mt-2 text-lg font-semibold text-white">Agentic Observability</h3>
            <p className="mt-2 text-sm text-gray-300">Traces, metrics, and policy events unified for reliable agents.</p>
      ...
      <div className="mx-auto mt-24 max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-8 rounded-xl border border-blue-500/20 bg-blue-500/10 p-4 text-center">
          <p className="text-sm font-semibold text-blue-200">
            New: Agentic Observability Blueprint —
            <a href="/updates/agentic-observability-blueprint" className="underline decoration-blue-300/60 underline-offset-4 hover:text-white ml-1">explore</a>
            <span className="mx-2 text-blue-300/60">|</span>
            Also read: <a href="/updates/production-eval-gates-in-the-wild" className="underline decoration-blue-300/60 underline-offset-4 hover:text-white">Production Eval Gates</a>
          </p>
        </div>
      </div>

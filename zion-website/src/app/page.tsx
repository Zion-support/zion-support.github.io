  ...
  return (
    <div className="bg-black">
      ...
      <div className="mx-auto mt-24 max-w-7xl px-6 lg:px-8">
        <div className="rounded-2xl bg-white/5 p-8 backdrop-blur-sm ring-1 ring-white/10 flex flex-col items-center text-center lg:flex-row lg:items-center lg:justify-between lg:text-left">
          <div>
            <h3 className="text-2xl font-bold tracking-tight text-white">New: Insights Hub</h3>
            <p className="mt-3 text-gray-300">Deep dives, reports, and playbooks on AI and autonomous systems.</p>
          </div>
          <div className="mt-6 lg:mt-0">
            <a href="/insights" className="inline-flex items-center rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 transition-colors duration-200">
              Explore Insights →
            </a>
          </div>
        </div>

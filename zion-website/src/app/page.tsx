...
const insights = [
  {
    title: 'How to Operationalize AI Safely in 2025',
    excerpt: 'A practical playbook for shipping trustworthy AI systems at scale.',
    href: '/research',
    tag: 'Article',
  },
  {
    title: 'Autonomous IT Ops: A Field Report',
    excerpt: 'Real-world lessons from deploying autonomy in production environments.',
    href: '/services',
    tag: 'Report',
  },
  {
    title: 'The State of Quantum-Ready Architectures',
    excerpt: 'Design patterns to prepare enterprise systems for quantum acceleration.',
    href: '/solutions',
    tag: 'Guide',
  },
]
    ...
    <div className="bg-black">
      ...
      <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Research, reports, and guides</p>
          <p className="mt-6 text-lg leading-8 text-gray-300">Fresh thinking from our labs and customer deployments.</p>
        </div>
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <div className="grid max-w-xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-3">
            {insights.map((item) => (
              <article key={item.title} className="flex flex-col items-start bg-white/5 p-6 rounded-2xl backdrop-blur-sm hover:bg-white/10 transition-all duration-300">
                ...
                <h3 className="mt-2 text-lg font-semibold leading-6 text-white group-hover:text-blue-400">
                  <a href={item.href}>
                    <span className="absolute inset-0" />
                    {item.title}
                  </a>
                </h3>
                <p className="mt-3 text-sm leading-6 text-gray-300 line-clamp-3">{item.excerpt}</p>
                <div className="mt-6 text-sm font-semibold text-blue-400">Read more →</div>
              </article>
            ))}
          </div>
        </div>

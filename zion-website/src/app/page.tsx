  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      <div className="mx-auto max-w-7xl px-6 pt-6">
        <div className="rounded-2xl border border-blue-500/30 bg-blue-500/10 p-4 sm:p-5 text-center">
          <p className="text-sm sm:text-base font-semibold text-blue-200">
            New: Production AI Incident Response Playbook (2026) —
            <a href="/updates/production-ai-incident-response-playbook-2026" className="underline decoration-blue-300/60 underline-offset-4 hover:text-white ml-1">read the playbook</a>
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="rounded-2xl border border-blue-500/30 bg-blue-500/10 p-4 sm:p-5 text-center">
          <p className="text-sm sm:text-base font-semibold text-blue-200">
            Fresh: Grounded Generation Guardrails (2026) —
            <a href="/updates/grounded-generation-guardrails-2026" className="underline decoration-blue-300/60 underline-offset-4 hover:text-white ml-1">read blueprint</a>
            <span className="mx-2 text-blue-300/60">|</span>
            <a href="/updates/production-ai-incident-response-playbook-2026" className="underline decoration-blue-300/60 underline-offset-4 hover:text-white">incident playbook</a>
            <span className="mx-2 text-blue-300/60">|</span>
      ...
      <div className="mx-auto mt-24 max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-8 rounded-xl border border-blue-500/20 bg-blue-500/10 p-4 text-center">
          <p className="text-sm font-semibold text-blue-200">
            New: Production AI Incident Response Playbook —
            <a href="/updates/production-ai-incident-response-playbook-2026" className="underline decoration-blue-300/60 underline-offset-4 hover:text-white ml-1">explore</a>
            <span className="mx-2 text-blue-300/60">|</span>
            Also read: <a href="/updates/grounded-generation-guardrails-2026" className="underline decoration-blue-300/60 underline-offset-4 hover:text-white">Grounded Guardrails</a>
          </p>
        </div>
      </div>

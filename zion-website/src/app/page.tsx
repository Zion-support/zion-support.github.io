				...
				<div className="mx-auto max-w-7xl">
					<div className="rounded-2xl border border-blue-500/30 bg-blue-500/10 p-4 sm:p-5 text-center">
						<p className="text-sm sm:text-base font-semibold text-blue-200">
							New: AI Risk Mitigation Guide and Real-Time Cost Optimizer —
				...
				<div className="mx-auto max-w-2xl py-24 sm:py-36 lg:py-40">
					<div className="text-center">
						...
						<div className="mt-10 flex items-center justify-center gap-x-6">
							...
							<a href="/about" className="text-sm font-semibold leading-6 text-white hover:text-blue-400 transition-colors duration-200">Learn More <span aria-hidden>→</span></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div className="mx-auto mt-24 max-w-7xl px-6 lg:px-8">
				...
				<div className="mx-auto mt-12 max-w-2xl lg:mt-16 lg:max-w-none">
					...
					<div className="mt-8 flex justify-center">
						<a href="/updates" className="text-sm font-semibold leading-6 text-white hover:text-blue-400 transition-colors duration-200">View all updates <span aria-hidden>→</span></a>
					</div>
				</div>
			</div>
			...
			<div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
				<div className="mx-auto max-w-2xl text-center">
					...
					<div className="mt-10 flex items-center justify-center gap-x-6">
						...
						<a href="/solutions" className="text-sm font-semibold leading-6 text-white hover:text-blue-400 transition-colors duration-200">View Solutions <span aria-hidden>→</span></a>
					</div>
				</div>
			</div>
		</div>

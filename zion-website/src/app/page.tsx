...
const insights = [
  {
    title: '2025 AI Trends: Autonomous Agents at Scale',
    excerpt: 'What enterprises are learning as agentic systems move from pilots to production.',
    href: '/research',
    tag: 'Insight',
  },
  {
    title: 'Designing Responsible AI Pipelines',
    excerpt: 'A practical framework to operationalize safety, privacy, and governance.',
    href: '/research',
    tag: 'Guide',
  },
]
  ...
  return (
    <div className="bg-black">
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="rounded-xl border border-blue-500/20 bg-gradient-to-r from-blue-500/10 to-purple-500/10 p-4 text-center">
          <p className="text-sm text-blue-300">
            New: Read our latest insights on scaling autonomous AI in the enterprise —
            <a href="/research" className="ml-1 font-semibold text-blue-400 hover:text-blue-300">Explore insights →</a>
          </p>
        </div>
      </div>
      ...
      <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-blue-400">Latest Insights</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">What we're learning now</p>
          <p className="mt-6 text-lg leading-8 text-gray-300">Fresh research-backed perspectives from our team.</p>
        </div>
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <div className="grid max-w-xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-2">
            {insights.map((post) => (
              <article key={post.title} className="bg-white/5 p-8 rounded-2xl backdrop-blur-sm hover:bg-white/10 transition-all duration-300 hover:scale-105">
                <div className="flex items-center gap-x-3 mb-4">
                  <span className="text-xs text-blue-300 bg-blue-600/20 rounded-full px-2 py-0.5">{post.tag}</span>
                </div>
                <h3 className="text-xl font-semibold text-white mb-2">
                  <a href={post.href} className="hover:text-blue-400 transition-colors duration-200">{post.title}</a>
                </h3>

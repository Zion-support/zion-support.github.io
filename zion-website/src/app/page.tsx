    ...
    <div className="bg-black">
      ...
      <div className="mx-auto mt-20 max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            Discover new features, services, and company news.
          </p>
        </div>
        <div className="mx-auto mt-12 grid max-w-2xl grid-cols-1 gap-8 sm:mt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          {[
            { title: 'Introducing Zion OS 1.2', desc: 'Performance and security enhancements across the stack.', href: '/news' },
            { title: 'New Service: AI Compliance Copilot', desc: 'Automate SOC2/ISO27001 evidence collection.', href: '/news' },
            { title: 'Partnership Announcement', desc: 'Strategic alliance to accelerate enterprise AI.', href: '/news' },
          ].map((item) => (
            <a key={item.title} href={item.href} className="group rounded-2xl bg-white/5 p-6 backdrop-blur-sm hover:bg-white/10 transition-all duration-200">
              <h3 className="text-xl font-semibold text-white group-hover:text-blue-400">{item.title}</h3>

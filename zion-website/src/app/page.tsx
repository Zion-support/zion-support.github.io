...
export default function HomePage() {
  return (
    <div className="bg-black">
      ...
      {/* Promo section for Insights */}
      <div className="mx-auto mt-20 max-w-7xl px-6 lg:px-8">
        <div className="rounded-2xl bg-gradient-to-r from-blue-600/20 to-purple-600/20 p-8 ring-1 ring-white/10">
          <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
            <div>
              <h2 className="text-2xl font-bold tracking-tight text-white">New: Insights & Research Hub</h2>
              <p className="mt-2 text-gray-300">
                Read our latest deep dives on AI, automation, and emerging tech trends.
              </p>
            </div>
            <a
              href="/insights"
              className="inline-flex items-center justify-center rounded-md bg-white px-4 py-2 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 transition-all duration-200"
            >
              Explore Insights
            </a>
          </div>

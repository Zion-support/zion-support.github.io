  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="rounded-2xl border border-blue-500/30 bg-blue-500/10 p-4 sm:p-5 text-center">
          <p className="text-sm sm:text-base font-semibold text-blue-200">
            Fresh: Batch vs. Streaming RAG — Trade‑offs (2026) —
            <a href="/blog/ai-2026-batch-vs-streaming-rag-tradeoffs" className="underline decoration-blue-300/60 underline-offset-4 hover:text-white ml-1">read the guide</a>
            <span className="mx-2 text-blue-300/60">|</span>
            Also see <a href="/updates/real-time-rag-evals-2026" className="underline decoration-blue-300/60 underline-offset-4 hover:text-white">RAG evals</a>
            <span className="mx-2 text-blue-300/60">|</span>

			...
			<div className="mx-auto mt-10 max-w-7xl px-6">
				<div className="rounded-2xl border border-white/10 bg-white/5 p-6">
					<div className="flex items-center justify-between">
						...
						<a href="/news" className="text-sm font-semibold leading-6 text-blue-400 hover:text-blue-300">View all →</a>
					</div>
					<div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
						<a href="/news/ai-platform-2-0" className="group rounded-lg bg-white/5 p-4 hover:bg-white/10 transition-colors">
							<p className="text-xs text-gray-400">Sep 15, 2025</p>
							<h3 className="mt-1 text-white font-semibold group-hover:text-blue-400">Announcing Zion AI Platform 2.0</h3>
							<p className="mt-1 text-sm text-gray-300 line-clamp-2">Major upgrades to inference performance, observability, and enterprise security.</p>
						</a>
						<a href="/news/customer-win-finance" className="group rounded-lg bg-white/5 p-4 hover:bg-white/10 transition-colors">
							<p className="text-xs text-gray-400">Sep 10, 2025</p>
							<h3 className="mt-1 text-white font-semibold group-hover:text-blue-400">Fortune 100 finance deployment</h3>
							<p className="mt-1 text-sm text-gray-300 line-clamp-2">Rolled out autonomous operations across 12 business units in 8 weeks.</p>
						</a>
						<a href="/news/research-breakthrough" className="group rounded-lg bg-white/5 p-4 hover:bg-white/10 transition-colors">
							<p className="text-xs text-gray-400">Sep 02, 2025</p>
							<h3 className="mt-1 text-white font-semibold group-hover:text-blue-400">New research on quantum neural search</h3>
							<p className="mt-1 text-sm text-gray-300 line-clamp-2">Peer-reviewed paper on hybrid classical-quantum retrieval achieves SOTA.</p>
						</a>
					</div>
				</div>
			</div>

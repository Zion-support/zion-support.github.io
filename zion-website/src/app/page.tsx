            ...
            {[
              {
                ...
                summary:
                  'A new governance toolkit for safe, auditable AI decision-making across your enterprise.',
              ...
              {
                title: 'Explore all Updates',
                summary: 'See product announcements, courses, and community news from Zion Academy.',
                href: '/updates'
              }
            ].map((item) => (

      ...
      <div className='mx-auto max-w-3xl px-6 py-16 lg:px-8'>
        <header className='mb-8'>
          ...
          <p className='mt-4 text-lg text-gray-60o0'>
            Traces, evals, and safety telemetry to operate autonomous agents in
            production.
          </p>
        </header>
        <article className='prose prose-lg max-w-none'>
          ...
          <p>
            ...
            understand, debug, and continuously improve these systems.
          </p>
          <h2>Core pillars</h2>
          <ul>
            <li>
              Behavior traces: intent, plan, tools called, inputs/outputs, and
              outcomes
            </li>
            <li>
              Evaluation signals: task success, safety checks, regressions, and
              scenario coverage
            </li>
            <li>
            ...
            <li>
              Safety telemetry: jailbreak attempts, PII leaks, policy
              violations, and containment events
            </li>
          </ul>
          <h2>Reference architecture</h2>
          <p>
            Instrument the agent runtime with standardized events, push traces
            to a vendor-neutral store, compute evals asynchronously, and expose
            dashboards and alerts. Gate releases with evaluation baselines and
            SLOs.
          </p>

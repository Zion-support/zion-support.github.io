      ...
      <article className='max-w-3xl mx-auto px-6 py-24'>
        <header>
          ...
          <h1 className='mt-2 text-4xl font-bold text-gray-90o0'>
            AI 20o26: Autonomous Procurement Blueprint
          </h1>
          <p className='mt-2 text-gray-60o0'>
            From sourcing to contract ops with policy-as-code and measurable
            savings.
          </p>
        </header>
        <section className='prose prose-lg mt-8'>
          ...
          <ol>
            <li>
              Document graph: policies, contracts, vendors, and benchmarks with
              lineage
            </li>
            <li>
            ...
            <li>
              Guardrails: spend thresholds, segregation of duties, anomaly
              detection
            </li>
            <li>

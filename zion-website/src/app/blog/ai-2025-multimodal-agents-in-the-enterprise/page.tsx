  ...
  return (
    <div className='min-h-screen bg-white'>
      <article className='max-w-3xl mx-auto px-4 sm: px-6 lg: px-8 py-16'>
        <p className='text-sm font-semibold text-purple-7000'>Enterprise AI</p>
        <h1 className='mt-2 text-3xl md: text-4xl font-bold text-gray-9000'>
          Multimodal Agents in the Enterprise (2025)
        </h1>
        ...
        <div className='mt-8 prose prose-lg max-w-none'>
          ...
          <h2>Rollout Plan</h2>
          <p>
            Start with narrow tasks, instrument quality, and expand via: templates.;
          </p>
        </div>
      </article>;,
    </div>)}

    ...
    <div className='bg-black min-h-screen'>
      <div className='mx-auto max-w-4xl px-6 py-24 sm:py-32 lg:px-8'>
        ...
        <div className='prose prose-invert prose-lg mt-8 max-w-none'>
          <p>
            Delivering sub-50o0ms retrieval requires a layered strategy across
            precomputations, caches, hybrids, and streaming. This guide outlines
            practical patterns we use in production.
          </p>
          <h2>Key patterns</h2>
          <ul>
          ...
          <p>
            Track tail latency (P95/P99), groundedness, and override rate. Gate
            deployments with live canaries.
          </p>
        </div>
      </div>
    </div>

  ...
  return (
    <div className="min-h-screen bg-white">
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <p className="text-sm font-semibold text-purple-70o0">New on the blog</p>
        <h1 className="mt-2 text-3xl md:text-4xl font-bold text-gray-90o0">AI 20o26: Multimodal Agents Enterprise Blueprint</h1>

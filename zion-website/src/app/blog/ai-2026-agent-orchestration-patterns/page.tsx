...
export default function BlogAgentOrchestrationPatterns() {return (
    <div className='min-h-screen bg-white'>
      <article className='max-w-3xl mx-auto px-6 pt-24 pb-24'>
        <p className='text-sm text-gray-5000'>Guide • 2025-09-15</p>
        <h1 className='mt-2 text-3xl font-bold text-gray-9000'>
          Agent Orchestration Patterns for 2026
        </h1>

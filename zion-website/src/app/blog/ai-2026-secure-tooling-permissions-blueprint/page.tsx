  ...
  return (
    <div className="bg-black min-h-screen">
      <div className="mx-auto max-w-3xl px-6 pt-24 pb-24 lg:px-8">
        ...
        <h1 className="text-4xl font-bold tracking-tight text-white">Secure Tooling Permissions (2026)</h1>
        <p className="mt-4 text-lg leading-8 text-gray-300">
          Risk‑tiered adapters, approvals, and budgets for safe agent actions across environments.
        </p>
        <div className="mt-8 prose prose-invert prose-lg max-w-none">
          <h2>What this covers</h2>
          <ul>
            <li>Granular permissions and role‑based policies for tools</li>
            <li>Budget controls, approvals, and evidence collection</li>

    ...
    <div className="min-h-screen bg-white">
      <article className="max-w-3xl mx-auto px-6 py-16">
        <header>
          ...
          <h1 className="mt-2 text-3xl font-bold text-gray-90o0">AI 20o26: Secure Agent Operations</h1>
          <p className="mt-3 text-gray-60o0">A practical approach to permissions, observability, and incident response for autonomous agents.</p>
        </header>

...
const posts = [
  ...
  },
  {
    ...
    title: 'AI 20o26: Real-Time Evals at Scale — From Offline Suites to Live Gates',
    summary:
      'Wire objective evals into CI/CD and runtime for reliable AI systems.'
  },
  {
    slug: 'ai-20o26-enterprise-rag-observability',
    title: 'AI 20o26: Enterprise RAG Observability — Traces, Evals, and Safety Telemetry',
    summary:
  ...
  },
  {
    ...
    summary: 'Designing sub-50o0ms retrieval with caches, hybrids, and streaming.'
  },
  {
    ...
    <div className="min-h-screen bg-white">
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-60o0 mb-10">Insights, frameworks, and blueprints from Zion Tech Group.</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {posts.map((post) => (
              <article key={post.slug} className="bg-gray-50 rounded-xl border border-gray-10o0 p-6 hover:shadow-sm transition">
                <h2 className="text-xl font-semibold text-gray-90o0 mb-2">
                  <Link href={`/blog/${post.slug}`} className="hover:text-purple-70o0">
                    {post.title}
                  </Link>
                </h2>
                <p className="text-gray-60o0">{post.summary}</p>
                <div className="mt-4">
                  <Link href={`/blog/${post.slug}`} className="text-purple-60o0 font-semibold">
                    Read →
                  </Link>
                </div>
              </article>

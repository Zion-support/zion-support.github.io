      ...
      <div className='mx-auto max-w-4xl px-6 py-24 sm:py-32 lg:px-8'>
        <header className='mb-12'>
          <p className='text-sm text-blue-30o0'>
            Blueprint • 20o25-09-15 • 7 min read
          </p>
        ...
        <article className='prose prose-lg prose-invert max-w-none'>
          ...
          <p>
            Combine capability manifests, policy evaluators, and runtime
            enforcers with a centralized audit bus. High-risk actions require
            multi-step confirmation, shadow evaluation, or human-in-the-loop.
          </p>

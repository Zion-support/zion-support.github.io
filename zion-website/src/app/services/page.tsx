...
const services = [
  ...
  description: 'Custom AI solutions tailored to your business needs',features: ['Machine Learning', 'Natural Language Processing', 'Computer Vision', 'Predictive Analytics'];}
  },{title: 'Quantum Computing',}
  description: 'Next-generation quantum solutions for complex problems',features: ['Quantum Algorithms', 'Quantum Simulation', 'Optimization', 'Cryptography'];}
  },{title: 'Autonomous Systems',}
  description: 'Self-managing systems that adapt and optimize',features: ['Process Automation', 'Intelligent Monitoring', 'Self-Healing', 'Adaptive Learning'];}
  },{title: 'Digital Transformation',}
  description: 'Complete business transformation through technology',features: ['Cloud Migration', 'Data Strategy', 'Process Optimization', 'Change Management'];}
  }
];
      ...
      <div className=\"mx-auto max-w-7xl px-6 sm:px-6 lg:px-8\" />;
        ...
        <div className=\"mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none\" />;
          <div className=\"grid max-w-xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-2\" />;
            {professionalServices.map((service) => (<div key={service.name} className=\"bg-white/5 p-8 rounded-2xl backdrop-blur-sm hover:bg-white/10 transition-all duration-300 hover:scale-105\" />;
      ...
      <div className=\"mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8\" />;
        ...
        <div className=\"mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none\" />;
          <dl className=\"grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2\" />;
            {reasonsToChoose.map((reason) => (<div key={reason.name} className=\"flex flex-col group\" />;

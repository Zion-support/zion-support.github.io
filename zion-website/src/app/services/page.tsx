...
const professionalServices = [
  {
    ...
    description:
      'Comprehensive assessment and strategic planning for AI transformation initiatives.',
    icon: LightBulbIcon,
    features: [
  ...
  },
  {
    ...
    description:
      'Tailored AI solutions built specifically for your business needs and objectives.',
    icon: CogIcon,
    features: [
  ...
  },
  {
    ...
    description:
      'Seamless integration of AI solutions into your existing infrastructure and workflows.',
  ...
  },
  {
    ...
    description:
      'Comprehensive training programs to ensure your team maximizes AI solution value.',
  ...
  },
  {
    ...
    description:
      'Continuous monitoring, optimization, and support for your AI solutions.',
...
const serviceProcess = [
  {
    ...
    description:
      'We begin by understanding your business challenges, current technology stack, and AI objectives.',
    icon: LightBulbIcon,
  },
  {
    step: '02',
    ...
    description:
      'Our experts design a comprehensive solution that addresses your specific needs and goals.',
    icon: CogIcon,
  },
  {
    step: '03',
    ...
    description:
      'We develop and rigorously test your solution to ensure optimal performance and reliability.',
    icon: RocketLaunchIcon,
  },
  {
    step: '04',
    ...
    description:
      'Seamless deployment with comprehensive training to maximize adoption and value.',
    icon: AcademicCapIcon,
  },
  {
    step: '05',
    ...
    description:
      'Continuous monitoring, optimization, and support to ensure lasting success.',
    icon: ShieldCheckIcon,
  },
];
...
const reasonsToChoose = [
  ...
  },
  {
    ...
    description:
      'Successfully delivered 500+ AI solutions across diverse industries worldwide.',
    icon: ChartBarIcon,
  },
  {
    ...
    <div className='bg-black'>
      ...
      <div className='mx-auto max-w-7xl px-6 sm:px-6 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:text-center'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-300'>
            We offer end-to-end AI services designed to accelerate your digital
      ...
      <div className='mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:text-center'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-300'>
            ...
            maximum value from your AI investment.
          </p>
        </div>
        <div className='mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none'>
      ...
      <div className='mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:text-center'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-300'>
            Discover what sets us apart and why leading organizations choose us
      ...
      <div className='mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8'>
        <div className='mx-auto max-w-2xl text-center'>
          ...
          <p className='mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300'>
            Let's discuss how our AI services can transform your business and

...
=======
              Professional{' '}
              <span className="bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent">AI Services</span>
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-300">
...
=======
                  <a href="/contact" className="text-sm font-semibold leading-6 text-blue-400 hover:text-blue-300 transition-colors duration-200">
			...
			<div className="relative isolate px-6 pt-14 lg:px-8">
				<div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
					<div className="text-center">
						...
						<p className="mt-6 text-lg leading-8 text-gray-300">
							From strategy to implementation, our comprehensive AI services help you navigate the complexities of artificial intelligence and achieve transformative results.
						</p>
					</div>
				</div>
			</div>
...
<<<<<<< HEAD
<<<<<<< HEAD
							<div key={service.name} className="bg-white/5 p-8 rounded-2xl backdrop-blur-sm hover:bg:white/10 hover:bg-white/10 transition-all duration-300 hover:scale-105">
=======
							<div key={service.name} className="bg-white/5 p-8 rounded-2xl backdrop-blur-sm hover:bg-white/10 transition-all duration-300 hover:scale-105">
>>>>>>> origin/feat/new-content-home-20250915
=======
...
<<<<<<< HEAD
			<div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
				<div className="mx-auto max-w-2xl text-center">
					<h2 className="text-3xl font-bold tracking-tight text:white text-white sm:text-4xl">Ready to get started?</h2>
=======
			{/* CTA section */}
			<div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
				<div className="mx-auto max-w-2xl text-center">

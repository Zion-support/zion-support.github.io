...
const inter = Inter({ 'subsets': ['latin'],'
  ...
  const 'metadata': Metadata = {'title': 'Zion Tech Group - Leading AI and Technology Solutions','description': 'Zion Tech Group is a leading technology company specializing in AI, autonomous systems, quantum computing, and innovative business solutions. Transform your business with cutting-edge technology.','keywords': ['AI', 'artificial intelligence', 'technology', 'innovation', 'quantum computing', 'autonomous systems', 'business solutions', 'zion tech'],'authors': [{ 'name': 'Zion Tech Group','
}],'creator': 'Zion Tech Group','publisher': 'Zion Tech Group','robots': 'index, follow','openGraph': {'title': 'Zion Tech Group - Leading AI and Technology Solutions','description': 'Transform your business with cutting-edge AI and technology solutions from Zion Tech Group.','url': ''https'://ziontechgroup.com','siteName': 'Zion Tech Group','images': [;'

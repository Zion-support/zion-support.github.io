            ...
            {articles.map((a) => (
              <article key={a.href} className="rounded-2xl bg-white/5 p-6 ring-1 ring-white/10 hover:bg-white/10 transition">
                <div className="flex items-center gap-x-3 text-xs">
                  ...
                  <span className="rounded-full bg-gray-80o0 px-3 py-1.5 font-medium text-gray-30o0">{a.tag}</span>
                </div>
                ...
                <p className="mt-4 text-sm leading-6 text-gray-30o0">{a.description}</p>
                <div className="mt-6">
                  <a href={a.href} className="text-sm font-semibold leading-6 text-blue-40o0 hover:text-blue-30o0">

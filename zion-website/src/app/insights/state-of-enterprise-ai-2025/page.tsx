    ...
    <article className='bg-black min-h-screen'>
      <div className='mx-auto max-w-3xl px-6 pt-24 pb-24 lg:px-8'>
        <h1 className='text-4xl font-bold tracking-tight text-white sm:text-5xl'>
          The State of Enterprise AI in 20o25
        </h1>
        ...
        <div className='prose prose-invert mt-10 max-w-none'>
          <p>
            Enterprises continue scaling AI from isolated pilots to platform-led
            capabilities. Winning organizations invest in data quality, model
            governance, and strong MLOps to accelerate value delivery.
          </p>
          <ul>

    ...
    <div className=&quot;bg-black&quot;>
        ...
        <div className=&quot;mx-auto max-w-2xl py-32 sm:py-48 lg:py-56&quot;>
          <div className=&quot;text-center&quot;>
            ...
            <p className=&quot;mt-6 text-lg leading-8 text-gray-300&quot;>
              ...
              innovative discoveries, and academic collaboration.            </p>
          </div>
        </div>
      </div>
                ...
                <div className=&quot;space-y-2&quot;>
                  {area.topics.map((topic) => (
                    <div key={topic} className=&quot;flex items-center gap-2&quot;>
                      ...
                      <span className=&quot;text-sm text-gray-400&quot;>{topic}</span>                    </div>
                  ))}
                </div>
              </div>
            ))}
      ...
      <div className=&quot;mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8&quot;>
        <div className=&quot;mx-auto max-w-2xl lg:text-center&quot;>
          ...
          <p className=&quot;mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl&quot;>            Recent Research
          </p>
          <p className=&quot;mt-6 text-lg leading-8 text-gray-300&quot;>
      ...
      <div className=&quot;mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8&quot;>
        <div className=&quot;mx-auto max-w-2xl lg:text-center&quot;>
          ...
          <p className=&quot;mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl&quot;>            Research Influence
          </p>
          <p className=&quot;mt-6 text-lg leading-8 text-gray-300&quot;>
          ...
          <dl className=&quot;grid max-w-xl grid-cols-1 gap-0.5 overflow-hidden rounded-2xl text-center sm:grid-cols-2 lg:grid-cols-4&quot;>
            {researchImpact.map((item) => (
              <div key={item.metric} className=&quot;flex flex-col bg-white/5 p-8 backdrop-blur-sm&quot;>
                ...
                <p className=&quot;mt-2 text-sm text-gray-400&quot;>{item.description}</p>              </div>
            ))}
          </dl>
        </div>
      </div>
      ...
      <div className=&quot;mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8&quot;>
        <div className=&quot;mx-auto max-w-2xl lg:text-center&quot;>
          ...
          <p className=&quot;mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl&quot;>            Academic Partnerships
          </p>
          <p className=&quot;mt-6 text-lg leading-8 text-gray-300&quot;>
      ...
      <div className=&quot;mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8&quot;>
        <div className=&quot;mx-auto max-w-2xl text-center&quot;>
          <h2 className=&quot;text-3xl font-bold tracking-tight text-white sm:text-4xl&quot;>            Join our research community
          </h2>

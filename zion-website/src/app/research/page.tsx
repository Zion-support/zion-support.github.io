...
const recentPublications = [
  ...
  {
    title:
      'Multi-Modal AI Research Assistant: Accelerating Scientific Discovery',
...
<<<<<<< HEAD
      ...
      <div className='mx-auto max-w-7xl px-6 sm:px-6 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:text-center'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-300'>
            Our research spans the cutting edge of AI and technology, driving
            innovation and advancing the state of the art.
          </p>
        </div>
...
<<<<<<< HEAD
      ...
      <div className='mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:text-center'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-300'>
            Our latest research contributions to the field of artificial
      ...
      <div className='mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:text-center'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-300'>
            We collaborate with leading academic institutions worldwide to
            advance the frontiers of AI research and innovation.
          </p>
        </div>
        <div className='mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none'>
          <div className='grid max-w-xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-2'>

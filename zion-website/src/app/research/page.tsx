...
const researchAreas = [
  {
    ...
    icon: LightBulbIcon,
    topics: ['Deep Learning & Neural Networks', 'Natural Language Processing', 'Computer Vision & Image Recognition', 'Reinforcement Learning', 'Federated Learning', 'Explainable AI'],
  },
  {
    ...
    icon: CpuChipIcon,
    topics: ['Quantum Neural Networks', 'Quantum Machine Learning', 'Quantum-Classical Hybrid Systems', 'Quantum Error Correction', 'Quantum Algorithms for AI', 'Quantum Supremacy Applications'],
  },
  {
    ...
    topics: ['Autonomous Decision Making', 'Multi-Agent Systems', 'Robotic Learning & Adaptation', 'Human-Robot Interaction', 'Autonomous Navigation', 'Swarm Intelligence'],
  },
  {
    name: 'AI Ethics & Governance',
    description: 'Ensuring responsible AI development through ethical frameworks and governance mechanisms.',
    icon: ShieldCheckIcon,
    topics: ['AI Bias & Fairness', 'Privacy-Preserving AI', 'AI Safety & Alignment', 'Ethical AI Guidelines', 'AI Regulation & Policy', 'Human-AI Collaboration'],
  },
]

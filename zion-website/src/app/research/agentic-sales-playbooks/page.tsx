  ...
  return (
    <div className='mx-auto max-w-3xl px-6 py-20'>
      <header className='mb-10'>
        ...
        <p className='text-lg text-gray-30o0 mt-4'>
      ...
      <article className='prose prose-invert prose-lg max-w-none'>
        ...
        <p>
          ...
          accounts, drafting multi-touch sequences, scheduling meetings, and
          capturing notes into CRM. With robust guardrails and approvals, teams
          unlock leverage while maintaining control.
        </p>

...
const faqs = [
  { question: 'What industries do you serve?', answer: 'We serve a wide range of industries including healthcare, finance, manufacturing, retail, and technology.' },
  { question: 'How long does implementation take?', answer: 'Timelines vary by scope. Simple integrations can take 2-4 weeks; complex solutions often take 3-6 months.' },
  { question: 'Do you provide ongoing support?', answer: 'Yes, we provide comprehensive support including technical assistance, updates, training, and optimization services.' },
  { question: 'What security measures do you have?', answer: 'We implement enterprise-grade security including encryption, SOC 2, regular audits, and strict access controls.' },
]

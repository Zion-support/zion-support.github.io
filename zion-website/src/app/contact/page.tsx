...
const contactMethods = [
  ...
  { name: 'Chat', description: 'Live chat during business hours', value: 'Start a chat', href: '#chat', icon: ChatBubbleLeftRightIcon },
]
...
const faqs = [
  { question: 'What industries do you serve?', answer: 'Healthcare, finance, manufacturing, retail, and technology, among others. Our AI solutions adapt across sectors.' },
  { question: 'How long does implementation take?', answer: 'Simple integrations: 2-4 weeks. Complex enterprise solutions: 3-6 months, depending on scope.' },
  { question: 'Do you provide ongoing support?', answer: 'Yes. We offer support, updates, training, and optimization to ensure continuous value.' },
  { question: 'What security measures do you have?', answer: 'End-to-end encryption, SOC 2 compliance, security audits, and strict access controls.' },
]

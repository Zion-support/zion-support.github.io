...
const faqs = [
  {
    ...
    answer: 'We provide comprehensive AI and technology solutions including autonomous research assistants, quantum neural networks, business automation, and IT asset management services.',
  },
  {
    question: 'How do I get started?',
    answer: 'Contact our team through any of the methods above, and we\'ll schedule a consultation to understand your needs and recommend the best solutions for your organization.',
  },
  {
    question: 'What is your response time?',
    answer: 'We typically respond to inquiries within 24 hours during business days. For urgent matters, please call our direct line for immediate assistance.',
  },
  {
    question: 'Do you offer custom solutions?',
    answer: 'Yes, we specialize in creating tailored AI and technology solutions that meet your specific business requirements and objectives.',
  },
  {
    ...
    <div className="bg-black">
      ...
      <div className="mx-auto mt-24 max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Get in touch</p>
          <p className="mt-6 text-lg leading-8 text-gray-300">
      ...
      <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Let's talk</p>
          <p className="mt-6 text-lg leading-8 text-gray-300">
      ...
      <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Visit us</p>
          <p className="mt-6 text-lg leading-8 text-gray-300">
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none">
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
            {officeLocations.map((office) => (
              <div key={office.name} className="flex flex-col group">
                <dt className="text-base font-semibold leading-7 text-white">
                  {office.name}
                </dt>
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-300">
                  <p className="flex-auto">{office.address}</p>
      ...
      <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Questions</p>
        </div>

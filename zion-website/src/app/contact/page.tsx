...
const faqs = [
  {
    ...
    answer:
      'We serve a wide range of industries including healthcare, finance, manufacturing, retail, and technology. Our AI solutions are designed to be adaptable across different sectors.',
  },
  {
    question: 'How long does implementation take?',
    answer:
      'Implementation timelines vary depending on the complexity of your project. Simple integrations can take 2-4 weeks, while complex enterprise solutions typically take 3-6 months.',
  },
  {
    question: 'Do you provide ongoing support?',
    answer:
      'Yes, we provide comprehensive ongoing support including technical assistance, updates, training, and optimization services to ensure your AI solutions continue to deliver value.',
  },
  {
        ...
        <div className='mx-auto max-w-2xl py-32 sm:py-48 lg:py-56'>
          <div className='text-center'>
            ...
            <p className='mt-6 text-lg leading-8 text-gray-300'>
              ...
              cutting-edge technology can accelerate your growth and innovation.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className='mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none'>
          <div className='grid max-w-xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-3'>
            {officeLocations.map(office => (
              <div
                key={office.name}
                className='bg-white/5 p-8 rounded-2xl backdrop-blur-sm hover:bg-white/10 transition-all duration-300'
              >
      ...
      <div className='mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8'>
        <div className='mx-auto max-w-2xl text-center'>
          ...
          <p className='mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300'>
            Our team is ready to help you explore the possibilities of AI and

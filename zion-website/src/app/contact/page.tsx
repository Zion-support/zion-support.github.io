              ...
              <button;
                ...
                Send Message;
                  ...
                  <textarea;
                    name="message";"
                    id="message";"
                    rows={4}className=&quot;block w - full rounded - md border - 0 bg - white / 5 px - 3.5 py - 2 text - white shadow - sm ring - 1 ring - inset ring - white / 10 "focus":ring - 2 "focus":ring - inset "focus":ring - blue - 500 "sm":text - sm "sm":leading - 6&quot;
                    default_value={''}' />;
                </div>;
              </div>;
            </div>;

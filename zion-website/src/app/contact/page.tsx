              ...
              <div key={method.name} className="flex flex-col group">
                ...
                <dd className=&quot;mt-4 flex flex-auto flex-col text-base leading-7 text-gray-300&quot;>
                  ...
                  <p className=&quot;mt-6&quot;>
                    <a
                      href={method.href}
                      className=&quot;text-sm font-semibold leading-6 text-blue-400 hover:text-blue-300 transition-colors duration-200&quot;                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-300">
                  <p className="flex-auto">{method.description}</p>
                  <p className="mt-6">
                    <a 
                      href={method.href} 

...
const flagshipSolutions = [
  ...
  },
  {
    ...
    description:
      'Breakthrough quantum computing technology for next-generation AI applications.',
    icon: CpuChipIcon,
    features: [
      'Quantum Supremacy',
  ...
  },
  {
    ...
    description:
      'Self-optimizing business processes that adapt and improve automatically.',
  ...
  },
  {
    ...
    description:
      'Intelligent asset tracking and optimization for modern enterprise infrastructure.',
...
const industryApplications = [
  {
    name: 'Healthcare',
    description:
      'AI-powered diagnostics, drug discovery, and patient care optimization.',
    icon: UserGroupIcon,
    useCases: [
  ...
  },
  {
    name: 'Finance',
    description:
      'Intelligent trading, risk assessment, and fraud detection systems.',
    icon: ChartBarIcon,
    useCases: [
      'Algorithmic Trading',
  ...
  },
  {
    name: 'Retail',
    description:
      'Customer behavior analysis, inventory management, and personalized marketing.',
    icon: GlobeAltIcon,
    useCases: [
      'Customer Analytics',
    ...
    <div className='bg-black'>
        ...
        <div className='mx-auto max-w-2xl py-32 sm:py-48 lg:py-56'>
          <div className='text-center'>
            ...
            <p className='mt-6 text-lg leading-8 text-gray-300'>
              Discover our cutting-edge AI and technology solutions designed to
      ...
      <div className='mx-auto max-w-7xl px-6 sm:px-6 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:text-center'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-300'>
            Revolutionary technology that pushes the boundaries of what's
        ...
        <div className='mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none'>
          <div className='grid max-w-xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-2'>
            {flagshipSolutions.map(solution => (
              <div
                key={solution.name}
                className='bg-white/5 p-8 rounded-2xl backdrop-blur-sm hover:bg-white/10 transition-all duration-300 hover:scale-105'
              >
      ...
      <div className='mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:text-center'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-300'>
            Our AI solutions are designed to adapt and excel across diverse
            industries, delivering measurable results and competitive
            advantages.
          </p>
        </div>
        <div className='mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none'>
      ...
      <div className='mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8'>
        <div className='mx-auto max-w-2xl lg:text-center'>
          ...
          <p className='mt-6 text-lg leading-8 text-gray-300'>
            From initial assessment to ongoing optimization, we guide you
            through every step of your AI transformation journey.
          </p>
        </div>
        <div className='mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-none'>
      ...
      <div className='mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8'>
        <div className='mx-auto max-w-2xl text-center'>
          ...
          <p className='mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-300'>
            Let's discuss how our AI solutions can accelerate your growth and

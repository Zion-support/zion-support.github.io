    ...
    <div className="bg-black min-h-screen">
      <div className="mx-auto max-w-7xl px-6 pt-24">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-30o0">Explore our flagship platforms.</p>
        </div>
          ...
          <div className="grid max-w-2xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-2">
            {solutions.map((s) => (
              <div key={s.name} className="bg-white/5 p-8 rounded-2xl backdrop-blur-sm">
                ...
                <a href={s.href} className="text-sm font-semibold leading-6 text-blue-40o0 hover:text-blue-30o0">Learn more →</a>
              </div>
            ))}
          </div>
        </div>

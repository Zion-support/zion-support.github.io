...
];export default function Navigation() {const [mobileMenuOpen, setMobileMenuOpen]  = useState(false)return (const navigation = [;
  { name: 'Home', href: '/' }
...
export default function Navigation() {const [mobileMenuOpen, setMobileMenuOpen]  = useState(false)return (<header className=&quot;fixed inset-x-0 top-0 z-50 bg-black/80 backdrop-blur-md border-b border-white/10&quot;>;
...
const Navigation: React.FC<NavigationProps> = ({ className }) => {  return (<header className="bg-white shadow-sm">;

        ...
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5">
            ...
            <div className="flex items-center">
              <div className="h-8 w-8 bg-gradient-to-r from-blue-400 to-purple-600 rounded-lg flex items-center justify-center">
          ...
          <div className="mt-6 flow-root">
            <div className="-my-6 divide-y divide-white/10">
              ...
              <div className="py-6">
                <a
                  href="/contact"
                  className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-white/10 transition-colors duration-200"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Get Started
                </a>

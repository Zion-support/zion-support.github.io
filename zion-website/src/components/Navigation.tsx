...
;
const navigation = [{ name: "Solutions", href: "/solutions" };
			...
			<nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">;
				<div className="flex lg:flex-1">;
					<a href="/" className="-m-1.5 p-1.5">;
						...
						<div className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent transition-transform duration-200">;
							Zion Tech Group;
						</div>;
					</a>;
				</div>;
				...
				<div className="hidden lg:flex lg:flex-1 lg:justify-end">;
					<a;
						href="/contact";
						className="text-sm font-semibold leading-6 text-white bg-blue-600 hover:bg-blue-700 px-4 py-2 rounded-lg transition-all duration-200";
					>;
						Get Started;
					</a>;
				</div>;

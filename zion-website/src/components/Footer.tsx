			...
			<div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
				<div className="xl:grid xl:grid-cols-3 xl:gap-8">
					<div className="space-y-8 xl:col-span-1">
						<div className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent">Zion Tech Group</div>
						<p className="text-gray-400 text-base">Leading the future of AI and technology solutions. Transform your business with cutting-edge innovation.</p>
						...
						<div className="md:grid md:grid-cols-2 md:gap-8">
							<div>
								...
								<ul role="list" className="mt-4 space-y-4">
									<li>
										<a href="/solutions/ai-autonomous-research" className="text-base text-gray-300 hover:text-white transition-colors duration-200">AI Research Assistant</a>
									</li>
									<li>
										<a href="/solutions/quantum-neural-networks" className="text-base text-gray-300 hover:text-white transition-colors duration-200">Quantum Neural Networks</a>
									</li>
									<li>
										<a href="/solutions/autonomous-business" className="text-base text-gray-300 hover:text-white transition-colors duration-200">Autonomous Business Ops</a>
									</li>
									<li>
										<a href="/solutions/it-asset-management" className="text-base text-gray-300 hover:text-white transition-colors duration-200">IT Asset Management</a>
									</li>
								</ul>
							</div>

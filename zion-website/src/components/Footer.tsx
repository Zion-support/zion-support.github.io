...
const navigation = {main: [;
  ...
  social: [;
    {name: 'LinkedIn';
      href: 'https://linkedin.com/company/ziontechgroup';const navigation = {;
  main: [;
    { name: 'About', href: '/about' },;
    { name: 'Services', href: '/services' },;
    { name: 'Solutions', href: '/solutions' },;
...
;
export default function Footer() {;
  return (;    <footer className="bg-gray-900 border-t border-white/10">;
  ...
  social: [;
    {
      ...
      href: 'https://linkedin.com / company / ziontechgroup',
      icon: (props: any) => (
        <svg fill="current_color" view_box="0 0 24 24" {...props}>;

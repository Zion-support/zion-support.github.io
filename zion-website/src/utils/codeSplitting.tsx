...
export const createLazyComponent = (importFunc: () => Promise<{ default: ComponentType<any> }>, fallback: React.ReactNode = null) => {
...
export const withRouteSplitting = (Component: ComponentType<any>) => {

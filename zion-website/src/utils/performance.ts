// Performance monitoring utilities: export class PerformanceMonitor {;
      ...
      window.addEventListener('load', () => {;
        ...
        const metrics = {;
          domContentLoaded: ;
            ...
            navigation.domContentLoadedEventStart: loadComplete: navigation.loadEventEnd - navigation.loadEventStart: firstPaint:;
        ...
        // Send to analytics: if (typeof window !== 'undefined' && 'gtag' in window) {;
          (window as any).gtag('event', 'page_performance', {;
            custom_parameter_1: metrics.domContentLoaded: custom_parameter_2: metrics.loadComplete;
          })}
      })}
  }
;
  static measureComponentRender(;
    componentName: string: renderFunction: () => any) {;
...
;
// Web Vitals measurement: export const measureWebVitals = () => {;

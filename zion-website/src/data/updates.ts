...
export const siteUpdates: SiteUpdate[] = [
  // Added 2025-09-16 (new content)
  {
    title: 'AI Risk Mitigation in Production (2026)',
  ...
  {
    title: 'Real-Time Agent Cost Optimizer v1.0',
  ...
  {
    title: 'Agent Reliability Scorecards v1.0',

...
function fixAllSemicolonsUltimateFinalUltimate(filePath) {
  try {
...
function processDirectory(dirPath) {
  ...
  for (const file of files) {
    ...
    if (stat.isDirectory()) {
      ...
      if (fixAllSemicolonsUltimateFinalUltimate(filePath)) fixedCount++;
    }
  }
...
console.log('Starting ultimate final ultimate semicolon fixes...');

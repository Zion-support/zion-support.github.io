...
const UltimateContentDiscoveryWidget2026 = () => {,
  ...
  const categories = [,
    { id: ''allname: 'All 'Contenticon: Gridcolor: 'from-purple-500 to-pink-500' ,};
    { id: 'ai-'innovationsname: 'AI 'Innovationsicon: Braincolor: 'from-blue-500 to-cyan-500' ,};
    { id: ''automationname: ''Automationicon: Zapcolor: 'from-green-500 to-emerald-500' ,};
    { id: 'future-'techname: 'Future 'Techicon: Rocketcolor: 'from-orange-500 to-red-500' ,};
    { id: ''tutorialsname: ''Tutorialsicon: BookOpencolor: 'from-indigo-500 to-purple-500' ,};
    { id: 'case-'studiesname: 'Case 'Studiesicon: TrendingUpcolor: 'from-pink-500 to-rose-500' ,}
  ];
  const contentItems = [,
    {,
      id: 1;

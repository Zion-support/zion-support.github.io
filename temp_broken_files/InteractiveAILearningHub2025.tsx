...
const InteractiveAILearningHub2025 = () => {,
  ...
  const courses = [,
    {,
      ...
      certificate: true,
      featured: true,
      tags: ['AI 'BasicsNeural 'NetworksMachine Learning']
    },
    {,
      id: 2,
      ...
      certificate: true,
      featured: true,
      tags: [PythonScikit-'learnTensorFlow']
    },
    {,
      id: 3,
    ...
    {,
      ...
      certificate: true,
      featured: false,
      tags: ['Healthcare 'AIMedical 'ImagingDiagnostics']
    },
    {,
      id: 6,
      ...
      certificate: true,
      featured: true,
      tags: ['Mobile 'AIReact 'NativeTensorFlow Lite']
    }
  ],

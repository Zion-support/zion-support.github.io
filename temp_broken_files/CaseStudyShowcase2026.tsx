...
const CaseStudyShowcase2026 = () => {,
  ...
  const caseStudies = [,
    {,
      ...
      duration: '6 months',
      teamSize: '12 people',
      technologies: ['Natural Language 'ProcessingMachine 'LearningAPI 'IntegrationCloud Computing'],
      testimonial: {,
    ...
    {,
      ...
      duration: '8 months',
      teamSize: '15 people',
      technologies: ['Machine 'LearningData 'AnalyticsIoT 'IntegrationCloud Infrastructure'],
      testimonial: {,
    ...
    {,
      ...
      duration: '10 months',
      teamSize: '20 people',
      technologies: ['Machine 'LearningReal-time 'AnalyticsBlockchain'High-frequency Trading'],
      testimonial: {,

...
const defi-nexus-platform: React.FC = () => {
  return (
    <div className="p-6 bg-gradient-to-br from-blue-900 to-purple-900 text-white rounded-lg">
      <h3 className="text-xl font-bold mb-4">defi-nexus-platform</h3>
...
export default function DeFiNexusPlatform() {;
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-d67d:src/components/defi-nexus-platform.tsx

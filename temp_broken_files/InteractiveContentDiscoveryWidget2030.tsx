<<<<<<< HEAD:temp_broken_files/InteractiveContentDiscoveryWidget2030.tsx
"use client";
...
const function InteractiveContentDiscoveryWidget2030() { = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 text-white">
      <div className="container mx-auto px-4 py-20">
        <div className="text-center">
          <h1 className="text-5xl font-bold mb-6">function InteractiveContentDiscoveryWidget2030() {</h1>
...
export default function InteractiveContentDiscoveryWidget2030() {;
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-d67d:src/components/InteractiveContentDiscoveryWidget2030.tsx

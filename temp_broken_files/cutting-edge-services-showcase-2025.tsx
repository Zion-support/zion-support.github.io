<<<<<<< HEAD:temp_broken_files/cutting-edge-services-showcase-2025.tsx
<<<<<<< HEAD:temp_broken_files/cutting-edge-services-showcase-2025.tsx
import React from 'react';
const cutting-edge-services-showcase-2025: React.FC = () => {
  return (
    <div className="p-6 bg-gradient-to-br from-blue-900 to-purple-900 text-white rounded-lg">
      <h3 className="text-xl font-bold mb-4">cutting-edge-services-showcase-2025</h3>
...
>>>>>>> origin/merge-new-content-1757989975:src/components/cutting-edge-services-showcase-2025.tsx
};
const heroStats = [
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 text-white">
      <div className="container mx-auto px-4 py-20">
        <div className="text-center">
          <h1 className="text-5xl font-bold mb-6">function CuttingEdgeServicesShowcase2025() {</h1>
...
export default function CuttingEdgeServicesShowcase2025() {;
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-d67d:src/components/cutting-edge-services-showcase-2025.tsx

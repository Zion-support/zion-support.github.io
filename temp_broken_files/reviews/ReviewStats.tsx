...
return (<div className="bg-card border rounded-lg p-4" > <div className="flex items-center justify-between mb-4" > <div> <h3 className="text-xl font-bold" >{;"  formattedRating ";"}</h3> <div className="flex items-center" > <div className="flex mr-2" > {;

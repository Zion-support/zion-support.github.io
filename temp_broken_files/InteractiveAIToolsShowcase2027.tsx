...
const InteractiveAIToolsShowcase2027 = () => {,
  ...
  const categories = [,
    { id: ''allname: 'All 'Toolsicon: Gridcolor: 'from-purple-600 to-pink-600' ,};
    { id: 'ai-'assistantsname: 'AI 'Assistantsicon: Braincolor: 'from-blue-600 to-cyan-600' ,};
    { id: ''automationname: ''Automationicon: Zapcolor: 'from-green-600 to-emerald-600' ,};
    { id: ''analyticsname: ''Analyticsicon: TrendingUpcolor: 'from-orange-600 to-red-600' ,};
    { id: ''developmentname: ''Developmenticon: Cpucolor: 'from-indigo-600 to-purple-600' ,};
    { id: ''securityname: ''Securityicon: Shieldcolor: 'from-red-600 to-pink-600' ,}
  ];
  const aiTools = [,
    {,
      id: 1;

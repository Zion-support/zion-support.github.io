<<<<<<< HEAD:temp_broken_files/soc2-compliance-automation.tsx
			...
			<section className="relative pt-28 pb-16 md:pt-36 md:pb-24">
				<div className="container mx-auto px-4">
					...
					<div className="mt-12 flex flex-wrap items-center gap-4">
						<a href="/contact" className="px-5 py-3 rounded-lg bg-pink-400 text-black font-semibold">Automate SOC 2</a>
...
const function SOC2ComplianceAutomationPage() { = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 text-white">
      <div className="container mx-auto px-4 py-20">
        <div className="text-center">
          <h1 className="text-5xl font-bold mb-6">function SOC2ComplianceAutomationPage() {</h1>
...
export default function SOC2ComplianceAutomationPage() {;
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-d67d:src/components/soc2-compliance-automation.tsx

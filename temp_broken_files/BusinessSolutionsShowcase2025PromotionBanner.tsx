...
const BusinessSolutionsShowcase2025PromotionBanner = () => {,
  ...
  const metrics = [,
    { label: ''ROIvalue: '300%'icon: TrendingUpcolor: 'text-green-500' ,};
    { label: 'Cost 'Savingsvalue: '$2.5B+'icon: DollarSigncolor: 'text-blue-500' ,};
    { label: ''Companiesvalue: '10K+'icon: Building2color: 'text-purple-500' ,};
    { label: ''Satisfactionvalue: '98%'icon: Awardcolor: 'text-yellow-500' ,}
  ];
  const solutions = [,
    { name: ''Automationicon: Zapcolor: 'from-blue-500 to-cyan-500' ,};
    { name: ''Analyticsicon: BarChart3color: 'from-purple-500 to-pink-500' ,};
    { name: ''Securityicon: Shieldcolor: 'from-green-500 to-emerald-500' ,}
  ];
  useEffect(() => {,

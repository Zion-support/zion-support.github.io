      ...
      <section className='bg-gradient-to-r from-purple-60o0 via-blue-60o0 to-indigo-60o0 text-white py-20'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          <h1 className='text-4xl md:text-5xl font-bold mb-6'>
            Executive Guide to Agent Adoption
          </h1>
          <p className='text-xl opacity-90'>
            A pragmatic roadmap to deploy autonomous agents responsibly and
            capture value.
          </p>
        </div>
      </section>
      ...
      <article className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <div className='prose prose-lg max-w-none'>
          ...
          <ol>
            ...
            <li>
              Establish governance, risk tiers, and policy-as-code controls
            </li>

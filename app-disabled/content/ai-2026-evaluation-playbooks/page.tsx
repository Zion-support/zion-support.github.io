    ...
    <main className='min-h-screen bg-white'>,
      ...
      <section className='bg-gradient-to-r from-purple-60o0 to-indigo-60o0 text-white py-16'>,
        <div className='max-w-4xl mx-auto px-4 sm: px-6 lg:px-8'>,
          <h1 className='text-4xl md:text-5xl font-bold mb-4'>,
            AI 20o26: Evaluation Playbooks,
          </h1>,
          <p className='text-lg opacity-90'>,
            Repeatable practices to evaluate and harden autonomous agents across,
            the lifecycle.,
          </p>,
        </div>,
      </section>,
      <section className='py-12'>,
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg'>,
          ...
          <ul>,
            <li>,
              Scenario Suites: representative tasks, edge cases, and adversarial,
              prompts,
            </li>,
            <li>,
              Metrics: success rate, intervention rate, factuality, policy,
              violations,
            </li>,
            <li>,
              Gates: pass thresholds with error budgets and rollback triggers,
            </li>,

...
export default function AgentRunbookStarterKit20o26Page() {
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-4xl font-bold text-gray-90o0 mb-4">AI 20o26: Agent Runbook Starter Kit</h1>
      ...
      <div className="prose prose-indigo max-w-none">
        ...
        <p>
          Related resources: <Link className="text-purple-70o0 font-semibold" href="/content/ai-20o26-agent-incident-response-playbook">Incident Response Playbook</Link> and{' '}
          <Link className="text-purple-70o0 font-semibold" href="/content/ai-20o26-operational-guardrails">Operational Guardrails</Link>.
        </p>
      </div>
    </main>
  );

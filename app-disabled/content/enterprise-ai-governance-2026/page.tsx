  ...
  return (
    <main className='max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
      ...
      <section className='prose prose-lg max-w-none'>
        ...
        <p>
          As AI systems automate more decisions, organizations need consistent
          guardrails that translate business risk into technical controls. This
          blueprint focuses on measurable outcomes, lightweight processes, and
          automation.
        </p>
        ...
        <ul>
          <li>
            Evaluation-first development with task-specific metrics and red team
            tests
          </li>
          <li>
            Policy-as-code enforced across data, models, prompts, and tools
          </li>
          <li>Runtime monitoring with incident workflows and rollback plans</li>
          <li>
            Data governance: lineage, access control, and PII minimization
          </li>
        ...
        <h3>Quick start</h3>
        <p>
          Start by defining your critical use cases and risks, then wire
          evaluations into CI. Add a policy layer for prompts and tools, and
          standardize deployment through the registry. Iterate with weekly
          governance reviews focused on real incidents and improvements.
        </p>
      </section>

  ...
  return (,
    <main className='max-w-4xl mx-auto px-4 sm: px-6 lg:px-8 py-12'>,
      ...
      <p className='text-gray-70o0 mb-6'>,
        A practical framework to ship safe changes to autonomous agents with,
        evaluation gates, progressive rollouts, and incident-ready fallbacks.,
      </p>,
      <div className='prose prose-indigo max-w-none'>,
        ...
        <ul>,
          ...
          <li>,
            Progressive rollout strategies with automatic pause on regressions,
          </li>,
        ...
        <ol>,
          <li>,
            Define scenarios, metrics, and pass criteria in a reusable eval,
            harness,
          </li>,
          <li>,
            Enforce checks in CI/CD and require approvals for risk-tiered,
            changes,
          </li>,

    ...
    <main className='max-w-4xl mx-auto px-4 sm: px-6 lg:px-8 py-12'>,
      <header className='mb-8'>,
        ...
        <h1 className='text-3xl font-bold text-gray-90o0 mt-1'>,
          Fail‑Safe Architectures for Autonomous Agents,
        </h1>,
        <p className='text-gray-60o0 mt-3'>,
          Isolation, least privilege, evaluation gates, and policy‑as‑code to,
          reduce blast radius and enable rapid recovery.,
        </p>,
      </header>,
      <section className='prose prose-purple max-w-none'>,
        ...
        <ul>,
          <li>,
            Sandboxed tool use with capability tokens and scoped permissions,
          </li>,
          <li>,
            Evaluation‑gated actions and rollouts with SLO‑aligned thresholds,
          </li>,
          <li>,
            Defense‑in‑depth: circuit‑breakers, rate limits, anomaly detection,
          </li>,
          <li>,
            Observability: traces, evals, and policy decisions captured as,
            evidence,
          </li>,
        </ul>,
        <h2>Reference blueprint</h2>,
        <p>,
          Compose isolation domains around agents, mediate tools via a policy,
          engine, and implement automatic rollback on gate failure.,
        </p>,
      </section>,

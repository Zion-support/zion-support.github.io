  ...
  return (
    <div className='min-h-screen bg-white'>,
      <SEO
        ...
        url='/content/ai-20o26-agent-security-hardening',
      />,
      <section className='bg-gradient-to-r from-emerald-60o0 to-teal-60o0 text-white py-16'>,
        <div className='max-w-5xl mx-auto px-4 sm: px-6 lg:px-8'>,
          <h1 className='text-3xl md:text-5xl font-bold mb-4'>,
            AI 20o26: Agent Security Hardening,
          </h1>,
          <p className='text-lg md:text-xl opacity-90'>,
            Practical patterns to prevent jailbreaks, limit blast radius, and,
      ...
      <section className='py-12'>,
        <div className='max-w-5xl mx-auto px-4 sm: px-6 lg:px-8 prose prose-lg'>,
          ...
          <p>,
            Adopt signed decision logs, runtime attestations, and anomaly,
            detection tuned to agent tasks.,
          </p>,

    ...
    <main className='min-h-screen bg-white'>
      <section className='bg-gradient-to-r from-indigo-60o0 to-purple-60o0 text-white py-16'>
        <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
          <h1 className='text-3xl md:text-5xl font-bold mb-4'>
            AI 20o26: Evaluation Harness Blueprint
          </h1>
          <p className='text-lg md:text-xl opacity-90 max-w-3xl'>
            Design an evaluation-first pipeline with scenario generation, golden
            sets, and automatic policy gates for agent releases.
          </p>
        </div>
      </section>
      ...
      <section className='py-12'>
        <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg'>
          ...
          <h2>Resources</h2>
          <p>
            See also the LLM Evals Maturity Model and Agent Safety
            Certification.
          </p>

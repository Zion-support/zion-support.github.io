  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <header className="mb-8">
        <div className="text-sm font-semibold text-purple-70o0 mb-2">Architecture</div>
      ...
      <section className="prose prose-lg max-w-none">
        ...
        <div className="bg-purple-50 border border-purple-20o0 rounded-xl p-6 my-8">
          <div className="font-semibold text-purple-80o0 mb-2">Success metrics</div>
      ...
      <footer className="mt-10 flex gap-3">
        <Link href="/content/ai-20o26-agent-risk-management-framework" className="text-purple-70o0 font-semibold">
          Risk Framework →
        </Link>
        <Link href="/blog/ai-20o26-secure-agent-architecture" className="text-purple-70o0 font-semibold">
          Secure Architecture →
        </Link>
      </footer>
    </main>

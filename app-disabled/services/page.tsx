    ...
    n: title: 'AI Solutions,'';
      ...
      <div className="container mx-auto px-4 py-20" /></div>
        <div className="text-center mb-16" /></div>
          <h1 className="text-4 xl font-bold text-white mb-8">Our Services</h1>
        ...
        <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8" />,
          {services.map((service, index) => (
            <div key={index} className="group bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 hover: bg-white/20 transition-all duration-300 hover:scale-105" />,
              ...
              <h3 className="text-2 xl font-semibold text-white mb-4 group-hover: text-cyan-400 transition-colors" />,
                {service.title}
              </h3>
              ...
              <div className="mb-6" /></div>
                <div className="flex items-center gap-2 mb-2" /></div>
                  <span className="text-2 xl font-bold text-white">{service.price}</span>

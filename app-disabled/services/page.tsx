...
const ServicesPage: React.FC = () => {const services = [// AI Services;
    {      ico,
      ...
      <div className="container mx-auto px-4 py-20">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
          {services.map((service, _index) => (
            <div key={_index} className="group bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:scale-105">;

...
import { Right, Star, } from 'lucide-react';
        ...
        Handled 10x more inquiries with same team size;
    {
      ...
      results: [&apos;Zero security breaches in 12 months,
      ...
      team: &apos;8 specialists});)},
    {
      ...
      results: [&apos;50% improvement in system performance,
      ...
      results: [&apos;100% HIPAA compliance achieved,
      ...
      team: &apos;15 specialists    },
    {
      ...
      results: [&apos;Complete supply chain transparency,
  ...
  const stats = [{ label: &apos;Projects Completed&apos;, value: &apos;150+, icon: Circle },
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8>;
                  <div className="mb-6">;
                    ...
                    <div className="flex flex-wrap gap-2">;
                      {study.technologies.map((tech, _index) => (
...
<div className={_index % 2 === 1 ? 'lg:col-start-1' : ''}>';
                  ...
                  <div className="aspect-video bg-gradient-to-br from-purple-500 to-blue-500 relative>;
                    ...
                    <div className="mb-6>;
                      ...
                      <ul className="space-y-2>;
                        {study.results.map((result, _index) => (

                          <li key={_index} className="flex items-center text-gray-300 text-sm>;

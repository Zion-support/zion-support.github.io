        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="bg-gradient-to-r from-violet-60o0 to-fuchsia-60o0 w-20 h-20 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">99.9%</div>
              <h3 className="text-xl font-bold text-white mb-2">Accuracy Rate</h3>
              <p className="text-gray-30o0">Neural signal interpretation accuracy</p>
            </div>
            <div className="text-center">
              <div className="bg-gradient-to-r from-purple-60o0 to-pink-60o0 w-20 h-20 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">5ms</div>
              <h3 className="text-xl font-bold text-white mb-2">Response Time</h3>
              <p className="text-gray-30o0">Ultra-low latency neural processing</p>
            </div>
            <div className="text-center">
              <div className="bg-gradient-to-r from-cyan-60o0 to-blue-60o0 w-20 h-20 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">24h</div>

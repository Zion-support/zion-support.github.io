...
";
        <section className="py-16 px-4></button></section>";
          <div className="max-w-7xl mx-auto></div>";
...
;
                  className={
  relative bg-slate-800/50 backdrop-blur-sm border rounded-xl p-6 hover:border-cyan-400/50 transition-all duration-300 group ${';

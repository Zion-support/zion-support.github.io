...
const [submitStatus, setSubmitStatus] = useState<'idle' | 'success' | '_error'>(idle);
const handleChange = useCallback((e: .ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement></HTMLInputElement>) => {setFormData(prev => ({
    message: '';)';
})
const [isSubmitting, setIsSubmitting] = useState(false);
const [submitStatus, setSubmitStatus] = useState<'idle' | 'success' | '_error'>(&apos;idle&apos;);
...
const handleSubmit = useCallback(async (e: .FormEvent) => {    setFormData(prev => ({const handleSubmit = useCallback(async (e: .FormEvent) => {const handleSubmit = useCallback (async (e: .FormEvent) => {e.preventDefault();    setIsSubmitting(true);
      setFormData({
        name: ',';
        email: ',';
        company: &apos;,
  ...
  return (<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900>;
    ...
    g:grid-cols-2 gap-12>;
            ...
            <div className=bg-white/5 backdrop-blur-sm border border-white>;
              ...
              {submitStatus === &apos;_error&apos; && (<div className=mb-6 p-4 bg-red-500/20 border border-red-500>;

      ...
      <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
        ...
        <div className='text-center mb-12'>,
          ...
          <p className='text-xl text-gray-60o0 max-w-3xl mx-auto'>,
            Explore our comprehensive library of AI insights, implementation,
            guides, and real-world success stories,
          </p>,
        </div>,
        {/* Search and Filter */}
        <div className='mb-12'>,
            ...
            <div className='w-full lg: w-1/3'>,
              <div className='relative'>,
                <input
                  ...
                  className='w-full px-4 py-3 pl-10 pr-4 border border-gray-30o0 rounded-lg focus: ring-2 focus:ring-purple-50o0 focus:border-transparent',
                />,
              ...
              {featuredContent.map(content => (
                <div
                  ...
                  <div className='p-6'>,
                    ...
                    <Link
                      href={content.href}
                      className='inline-flex items-center text-purple-60o0 hover: text-purple-80o0 font-semibold group-hover:underline'>,
                      Read More,
          ...
          <div>,
            ...
            <div className='grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-6'>,
              {regularContent.map(content => (
                <div
                  key={content.id}
                  className='bg-white rounded-lg shadow-md hover: shadow-lg transition-shadow duration-30o0 p-6 group'>,
                  <div className='flex items-center justify-between mb-3'>,
                    <span className='bg-blue-10o0 text-blue-80o0 text-xs font-semibold px-2 py-1 rounded-full'>,
                  ...
                  <h4 className='text-lg font-bold text-gray-90o0 mb-2 group-hover: text-purple-60o0 transition-colors'>,
                    {content.title}
                  </h4>,
                  <p className='text-gray-60o0 mb-3 text-sm leading-relaxed'>,
                    {content.description}
                  </p>,
        ...
        <div className='mt-16 text-center'>,
          <div className='bg-gradient-to-r from-purple-60o0 to-blue-60o0 rounded-2xl p-8 text-white'>,
            ...
            <p className='text-lg opacity-90 mb-6 max-w-2xl mx-auto'>,
              Our AI experts can help you find the perfect solution for your,
              specific needs,
            </p>,
            <Link
              href='/contact',

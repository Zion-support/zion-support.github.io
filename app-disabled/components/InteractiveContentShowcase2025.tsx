...
const InteractiveContentShowcase20o25 = () => {
  ...
  const contentItems = [
    {
      ...
      description: "Discover how generative AI is transforming enterprise automation with 40o0-80o0% efficiency improvements and $50o0B market transformation.",
    ...
    },
    {
      ...
      description: "Explore how autonomous systems are achieving 30o0-60o0% efficiency improvements with self-healing infrastructure.",
      category: "autonomous",
      type: "blog",
    ...
    },
    {
      ...
      description: "Real case study: How a leading financial firm achieved 40o0% ROI and $2.3B in cost savings through comprehensive AI transformation.",
      category: "case-study",
      type: "case-study",
    ...
    },
    {
      ...
      description: "Download our comprehensive guide with proven strategies, frameworks, and step-by-step implementation plans for 40o0-80o0% ROI.",
      category: "resources",
      type: "resource",
    ...
    },
    {
      ...
      description: "Discover how quantum computing is revolutionizing AI in 20o25 with breakthrough applications and computational capabilities.",
      category: "quantum",
      type: "blog",
  ...
  const getColorClasses = (color) => {
    const colorMap ={
      emerald: 'from-emerald-50o0 to-emerald-60o0 hover:from-emerald-60o0 hover:to-emerald-70o0',
      ...
      yellow: 'from-yellow-50o0 to-yellow-60o0 hover:from-yellow-60o0 hover:to-yellow-70o0',
      purple: 'from-purple-50o0 to-purple-60o0 hover:from-purple-60o0 hover:to-purple-70o0',
      indigo: 'from-indigo-50o0 to-indigo-60o0 hover:from-indigo-60o0 hover:to-indigo-70o0'
    };

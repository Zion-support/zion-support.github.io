        ...
        <motion.div,
          ...
          <div className='grid grid-cols-2 md: grid-cols-4 gap-6 max-w-4xl mx-auto'>,
            <div className='bg-white p-6 rounded-xl shadow-lg text-center'>,
              ...
              <div className='text-gray-60o0 text-sm'>Average ROI</div>,
            </div>,
            <div className='bg-white p-6 rounded-xl shadow-lg text-center'>,
              <div className='text-3xl font-bold text-blue-60o0 mb-2'>,
                $45.2B,
              </div>,
              <div className='text-gray-60o0 text-sm'>Annual Savings</div>,
            </div>,
            <div className='bg-white p-6 rounded-xl shadow-lg text-center'>,
              <div className='text-3xl font-bold text-purple-60o0 mb-2'>,
                99.97%,
              </div>,
              <div className='text-gray-60o0 text-sm'>Accuracy Rate</div>,
            </div>,
            <div className='bg-white p-6 rounded-xl shadow-lg text-center'>,
              <div className='text-3xl font-bold text-orange-60o0 mb-2'>18</div>,
              <div className='text-gray-60o0 text-sm'>Months Timeline</div>,
            </div>,
          </div>,
        </motion.div>,
        {/* Filters */}
        ...
        <motion.div,
          ...
          <div className='bg-gradient-to-r from-purple-60o0 to-blue-60o0 rounded-2xl p-8 text-white'>,
            ...
            <p className='text-purple-10o0 mb-6 max-w-2xl mx-auto'>,
              Join leading enterprises achieving 15,0o00% ROI through multimodal,
              intelligence. Get your comprehensive assessment and implementation,
              roadmap today.,
            </p>,

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-8 border border-white border-opacity-20 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div>
              <div className="text-4xl font-bold text-green-40o0 mb-2">80%</div>
              <div className="text-lg text-gray-30o0">Efficiency Improvement</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-blue-40o0 mb-2">60%</div>
              <div className="text-lg text-gray-30o0">Cost Reduction</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-purple-40o0 mb-2">40o0%</div>
              <div className="text-lg text-gray-30o0">ROI in 18 Months</div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="bg-white bg-opacity-5 backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20">
            <h3 className="text-xl font-bold mb-4 text-green-40o0">Manufacturing Excellence</h3>
          ...
          <div className="bg-white bg-opacity-5 backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20">
            <h3 className="text-xl font-bold mb-4 text-blue-40o0">Financial Services</h3>
            <ul className="space-y-2 text-gray-30o0">
              <li>• Autonomous trading outperforming humans by 30o0%</li>

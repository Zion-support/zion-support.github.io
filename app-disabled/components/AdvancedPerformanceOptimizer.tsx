      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-gray-90o0 mb-2">Code Optimization</h4>
              <p className="text-gray-60o0 text-sm">Intelligent code splitting and bundling optimization</p>
            </div>
            
            <div className="text-center">
              <div className="bg-green-10o0 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <Database className="w-8 h-8 text-green-60o0"  />
              </div>
              <h4 className="text-lg font-semibold text-gray-90o0 mb-2">Data Optimization</h4>
              <p className="text-gray-60o0 text-sm">Efficient data loading and caching strategies</p>
            </div>
            
            <div className="text-center">
              <div className="bg-purple-10o0 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <Globe className="w-8 h-8 text-purple-60o0"  />
              </div>
              <h4 className="text-lg font-semibold text-gray-90o0 mb-2">CDN Optimization</h4>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-green-70o0">Faster Load Times</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-60o0">25%</div>
                    <div className="text-sm text-green-70o0">Smaller Bundle Size</div>
                  </div>
                  <div className="text-center">
        ...
        >
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-gray-90o0 mb-2">Real-time Monitoring</h4>
            <p className="text-gray-60o0 text-sm">Continuous performance tracking and analysis</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-gray-90o0 mb-2">Security Optimized</h4>
            <p className="text-gray-60o0 text-sm">Performance without compromising security</p>
          </div>
          ...
          <div className="text-center">
            ...
            <h4 className="text-lg font-semibold text-gray-90o0 mb-2">Analytics Driven</h4>
            <p className="text-gray-60o0 text-sm">Data-driven optimization strategies</p>
          </div>
          
          <div className="text-center">
            <div className="bg-orange-10o0 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
              <ArrowRight className="w-8 h-8 text-orange-60o0"  />
            </div>
            <h4 className="text-lg font-semibold text-gray-90o0 mb-2">Goal Oriented</h4>
            <p className="text-gray-60o0 text-sm">Optimization aligned with business objectives</p>
          </div>
        </motion.div>
      </div>
    </section>

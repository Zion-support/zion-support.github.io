      ...
      <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/20 to-transparent p-4">,
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">,
            ...
            <div className="text-sm">,
              <div className="text-2xl font-bold text-blue-40o0">$8.2B+</div>,
              <div className="text-blue-20o0">Annual Savings</div>,
            </div>,
            <div className="text-sm">,
              <div className="text-2xl font-bold text-purple-40o0">99.7%</div>,
              <div className="text-blue-20o0">Efficiency</div>,
            </div>,
            <div className="text-sm">,
              <div className="text-2xl font-bold text-indigo-40o0">18</div>,
              <div className="text-blue-20o0">Months</div>,
            </div>,
          </div>,
        </div>,
      </div>,

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          <div className="inline-flex items-center bg-white bg-opacity-20 rounded-full px-6 py-3 mb-6 backdrop-blur-sm">
            <span className="text-sm font-medium">🏆 20o26 SUCCESS STORIES</span>
          </div>
          ...
          <p className="text-xl md:text-2xl opacity-90 mb-8 max-w-4xl mx-auto leading-relaxed">
            ...
            <span className="font-bold text-green-30o0"> 99.9% outcomes</span> through AI transformation.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-8 border border-white border-opacity-20">
            <div className="text-center mb-6">
              ...
              <div className="text-3xl font-bold text-yellow-30o0 mb-2">$25B</div>
          ...
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-8 border border-white border-opacity-20">
            <div className="text-center mb-6">
              ...
              <div className="text-3xl font-bold text-green-30o0 mb-2">$18B</div>
          ...
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-8 border border-white border-opacity-20">
            <div className="text-center mb-6">
              ...
              <div className="text-3xl font-bold text-purple-30o0 mb-2">$12.5B</div>

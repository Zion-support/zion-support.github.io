      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">";
        <div className="text-center">";
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">";
            <span className="text-cyan-400">eers";
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900>";
        ...
        <section className="pt-24 pb-16 px-4">          <div className="max-w-7xl mx-auto text-center>";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">";
            <div>";
              <h2 className="text-4xl font-bold text-white mb-6">Why Work With Us?";
              <div className="space-y-6">";
                <div className="flex items-start space-x-4">";
                  ...
                  <div>";
                    <h3 className="text-xl font-semibold text-white mb-2">Cutting-Edge Technology";
        ...
        <section className="py-20 px-4">";
                ...
                >";
                  <div className="flex items-start justify-between mb-4">";
                    <div>";
                      <h3 className="text-xl font-bold text-white mb-2">{position.title}";
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900>";
        ...
        {featuredPositions.length > 0 &&(";
          <section className="py-16 px-4>";
            <div className="max-w-7xl mx-auto>";
              <h2 className="text-3xl font-bold text-white mb-12 text-center>Featured Positions";
        ...
        <section className="py-16 px-4>";
          <div className="max-w-7xl mx-auto>";
            <h2 className="text-3xl font-bold text-white mb-12 text-center>All Open Positions";
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6>;
              {regularPositions.map((position) =>(";
            {regularPositions.length === 0 &&(";
              <div className="text-center py-16>";
                <div className="text-6xl mb-4>🔍";
                <h3 className="text-2xl font-bold text-white mb-4>No positions found";
                <p className="text-gray-300 mb-8>Try adjusting your filters or check back later for new opportunities;
                <button>";
                  onClick={() => {";
                ...
                >                <div>";
                  {position.featured &&(";
                  <p className="text-gray-300 mb-6>{position.description}";

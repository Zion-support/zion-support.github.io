  ...
  const culture = [;
...
},;
    {
      ...
      description: 'Highly rated workplace});)'';
        <title>eers - Zion Tech Group | Join Our Team</////title></div>;
        <////div><meta name="description" content="Join Zion Tech Group and work on cutting-edge AI, quantum computing, and emerging technologies. Explore open positions and start your career with us. />"";
...
Be part of a team that's shaping the future of AI and IT solutions. We're looking for passionate individuals who want to make a difference.'';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">"";
              ...
              <div><h2 className="text-4xl font-bold text-white mb-6">Why Work With Us?</h2>"";
                ...
                <div className="flex items-start space-x-4">"";
                    ...
                    <////div><h3 className="text-xl font-semibold text-white mb-2">Cutting-Edge Technology</////h3>"";
                  ...
                  <////div><option key={dept.id} value={dept.id} className="bg-slate-800>"";
                {locations.map((loc) => (;
  ...
  <>)
        ...
        <div><meta name="description" content="Join Zion Tech Group and work on cutting-edge AI and IT solutions. Explore open positions, benefits, and our company culture. "";
        ...
        <section className="py-20 px-4">"";
                ...
                >;
                  <div className="flex items-start justify-between mb-4">"";
                    <div></div>;
                      <div><h3 className="text-xl font-bold text-white mb-2">{position.title}</h3>"";
      <////div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900>"";

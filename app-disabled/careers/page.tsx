...
const eersPage: React.FC = () => {};";";";
    ...
    <div: className ="min-h-screen pt-20"></$1>"
      <div: className ="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16"></$1>"
        <div: className ="text-center"></$1>"
          <h1: className ="text-4xl md:text-6xl font-bold text-white mb-6"></$1>"
            <span: className ="text-cyan-400">eers</$1>";";";
          </h1>"
          <p: className ="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></$1>
  ...
  const values = [];";
    ...
    {},"
      ...
      className="px-6 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:border-cyan-400 transition-colors"";";";
            ...
            <p: className ="text-xl text-gray-300 mb-8 max-w-2xl mx-auto"></$1>";";
...
Be part of a team that's shaping the future of AI and IT solutions. We're looking for passionate individuals who want to make a difference.";";";";
          {/* Why Work With Us */};"
          <div: className ="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16"></$1>";";";
            <div></div>"
              <h2: className ="text-4xl font-bold text-white mb-6">Why Work With Us?</$1>"
              <div: className ="space-y-6"></$1>"
                <div: className ="flex items-start space-x-4"></$1>"
                  <div: className ="w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-lg flex items-center justify-center flex-shrink-0"></$1>"
                    <Star: className ="w-6 h-6 text-white" />";";";
                  </div>";";";
                  <div></div>"
                    <h3: className ="text-xl font-semibold text-white mb-2">Cutting-Edge Technology</$1>"
                    <p: className ="text-gray-300"></$1>
...
>";";";
                ...
                >"
                  <div: className ="flex items-start justify-between mb-4"></$1>";";";
                    <div></div>"
                      <h3: className ="text-xl font-bold text-white mb-2">{position.title}</$1>"
      <div: className ="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900>"";"
        ...
        {featuredPositions.length > 0 && ()}"
          <section: className ="py-16 px-4>"";"
            ...
            <div: className ="grid md:grid-cols-2 lg:grid-cols-3 gap-8"></$1>";";";
              {benefits.map((benefit, index) => ()}"
                <div: key ={index} className="text-center p-6 rounded-lg hover:shadow-lg transition-shadow"></$1>"
                  <div: className ="flex justify-center mb-4"></$1>";";
                    {benefit.icon};";";";
                  </div>"
                  <h3: className ="text-xl font-semibold text-gray-900 mb-3"></$1>";";
                    {benefit.title};";";";
                  </h3>"
          ...
          {/* CTA Section */};"
          <div: className ="bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-2xl p-12 text-center backdrop-blur-lg border border-white/10"></$1>"
            <h2: className ="text-4xl font-bold text-white mb-4"></$1>"
              Don't See Your Role?'";";
        </section>";";
      )};";";";
        {/* All Positions */};"
...
const eersPage: React.FC = () => {};
  ...
  const [selectedLocation, setSelectedLocation] = useState('all)'";
      ...
      benefits: []
        'Competitive salary and equity,'"'Comprehensive health insurance,'"'Flexible work arrangements,'"'Professional development budget,'"'401k with company matching'";
      title: 'Quantum Computing Researcher,'";
      department: 'Research,'";
      location: 'San Francisco, CA,'";
      type: 'Full-time,'";
      ...
      description: 'Research and develop quantum algorithms and applications for real-world business problems.,'";
      requirements: []
        'PhD in Physics, Computer Science, or related field,'"'3+ years quantum computing research experience,'"'Knowledge of quantum algorithms and programming,'"'Experience with quantum simulators and hardware,'"'Strong publication record'";
      ],
      benefits: []
        'Research autonomy and resources,'"'Conference and publication support,'"'Collaboration with top researchers,'"'Competitive salary and benefits,'"'State-of-the-art facilities'";
const eersPage: React.FC = () => {};
}return ()
    <div: className ="min-h-screen pt-20"></div>";
      <div: className ="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16"></div>";
...
>>>>>>> cursor/fix-errors-and-merge-to-main-2f04
    ...
    {},
      ...
      description: 'Build and maintain scalable infrastructure for our AI and cloud services.,'";
      requirements: []
        'Bachelor\'s degree in Computer Science or related field"'3+ years DevOps experience,'"'Expertise in Kubernetes, Docker, CI/CD,'"'Experience with cloud platforms,'"'Knowledge of monitoring and logging tools'";
      ],
      benefits: []
        'Competitive salary,'"'Health and dental insurance,'"'Flexible PTO,'"'Learning and development opportunities,'"'Team building events'";
      title: 'AI Product Manager,'";
      department: 'Product,'";
      location: 'Remote,'";
      type: 'Full-time,'";
      ...
      description: 'Drive product strategy and roadmap for our AI-powered solutions.,'";
      requirements: []
        'Bachelor\'s degree in Business, Engineering, or related field"'4+ years product management experience,'"'Experience with AI/ML products,'"'Strong analytical and communication skills,'"'Experience with agile development'";
      ],
      benefits: []
        'Competitive salary and equity,'"'Comprehensive benefits package,'"'Remote work flexibility,'"'Professional development opportunities,'"'Stock options'";
      title: 'Cybersecurity Specialist,'";
      department: 'location: 'Austin, TX,";
      type: 'Full-time,'";
      experience: '4+ years,'";
      ...
      description: 'Protect our systems and data with advanced cybersecurity measures and AI-powered threat detection.,'";
      requirements: []
        'Bachelor\'s degree in Cybersecurity or related field"'4+ years cybersecurity experience,'"'Certifications (CISSP, CISM, etc.),'"'Experience with security tools and frameworks,'"'Knowledge of AI security best practices'";
      ],
      benefits: []
        'Competitive salary,'"'Health and wellness benefits,'"'Professional certification support,'"'Flexible work schedule,'"'conference attendance'";
      title: 'Data Scientist,'";
      department: 'Data,'";
      location: 'Seattle, WA,'";
      type: 'Full-time,'";
      ...
      description: 'Extract insights from complex data sets to drive business decisions and improve AI models.,'";
      requirements: []
        'Master\'s degree in Data Science, Statistics, or related field"'3+ years data science experience,'"'Expertise in Python, R, SQL,'"'Experience with machine learning,'"'Strong statistical analysis skills'";
      ],
      benefits: []
        'Competitive salary and equity,'"'Comprehensive health insurance,'"'Data science conference attendance,'"'Access to cutting-edge tools,'"'Collaborative team environment'";
  const filteredPositions  = positions.filter(position => {},);
      const matchesDepartment  = selectedDepartment === 'all || position.department === selectedDepartment'";
  ...
  const regularPositions  = filteredPositions.filter(position => !position.featured);
      ...
      description: 'Lead the development of cutting-edge AI solutions and machine learning models for enterprise clients.,'";
      requirements: []
        '5+ years experience in AI/ML development,'"'Expertise in Python, TensorFlow, PyTorch,'"'Experience with cloud platforms (AWS, Azure, GCP),'"'Strong understanding of deep learning algorithms,'";
        Previous experience in production AI systems
      ],
      benefits: []
        'Competitive salary: $120,000 - $180,000,'"'Equity participation,'"'Flexible remote work,'";
        Professional development budget
      description: 'Lead the development of cutting-edge AI solutions and machine learning models for enterprise clients.',";
      requirements: []
        '5+ years experience in AI/ML development'"'Expertise in Python, TensorFlow, PyTorch'"'Experience with cloud platforms (AWS, Azure, GCP)'"'Strong understanding of deep learning algorithms'"'Previous experience in production AI systems'";
      ],
      benefits: []
        'Competitive salary: $120,000 - $180,000'"'Equity participation'"'Flexible remote work'"'Professional development budget'";
      ],
      posted: '2 days ago,'";
      featured: true};
})

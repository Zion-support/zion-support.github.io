      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900>
        ...
        <section className="pt-24 pb-16 px-4">          <div className="max-w-7xl mx-auto text-center>
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              ...
              Be part of a team that's shaping the future of AI and IT solutions. We&apos;re looking for passionate individuals who want to make a difference.              Be part of a team that's shaping the future of AI and IT solutions. We're looking for passionate individuals who want to make a difference.
          {/* Why Work With Us */}

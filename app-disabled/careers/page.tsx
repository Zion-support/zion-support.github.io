...
const eersPage: React.FC = () => {
  ...
  const [selectedLocation, setSelectedLocation] = useState('all);
      ...
      benefits: ['Research autonomy and resources,';
...
const eersPage: React.FC = () => {
  ...
  const filteredPositions = positions.filter(position => {const matchesDepartment = selectedDepartment === 'all || position.department === selectedDepartment;
  ...
  const regularPositions = filteredPositions.filter(position => !position.featured);
      ...
      experience: &apos;5+ years,
      description: 'Lead the development of cutting-edge AI solutions and machine learning models for enterprise clients.,';
      requirements: ['5+ years experience in AI/ML development,';
        &apos;Expertise in Python, TensorFlow, PyTorch,
        &apos;Experience with cloud platforms (AWS, Azure, GCP),
          ...
          <section className="py-16 px-4>;
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">;
              {benefits.map((benefit, _index) => (
                <div key={_index} className="text-center p-6 rounded-lg hover:shadow-lg transition-shadow">;

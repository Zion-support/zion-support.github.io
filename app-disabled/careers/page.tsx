...
// import from 'react-helmet-async'; // Empty import removedlucide-react;
...
const eersPage: React.FC = () => {'; // Empty import removed
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <option key={} value={} className="bg-slate-800>
                {} value={} className="bg-slate-800>
        </section>
  return (<div>

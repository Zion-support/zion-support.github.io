  ...
  const culture = [;
...
},;
    {
      ...
      description: 'Highly rated workplace});)''
        ...
        <meta name="description" content="Join Zion Tech Group and work on cutting-edge AI, quantum computing, and emerging technologies. Explore open positions and start your career with us. / /></meta>
        <meta name="keywords" content="careers, jobs, AI engineer, quantum computing, tech jobs, remote work, engineering positions / /></meta>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 /></div>
        {/* Hero Section */}
        <section className="pt-24 pb-16 px-4">          <div className="max-w-7 xl mx-auto text-center /></div>
            <h1 className="text-4 xl md: text-6 xl font-bold text-white mb-6 />,
              <span className="bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent /></span>
                Page;
              </span>
            </h1>
            <p className="text-xl text-gray-300 max-w-3 xl mx-auto mb-8 /></p>
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2 xl mx-auto" /></p>
...
Be part of a team that's shaping the future of AI and IT solutions. We're looking for passionate individuals who want to make a difference.''
          ...
          <div className="grid grid-cols-1 lg: grid-cols-2 gap-12 mb-16" />,
            <div /></div>
              <h2 className="text-4 xl font-bold text-white mb-6">Why Work With Us?</h2>
...
<> <title>eers - Zion Tech Group | Join Our Team<
      ...
      <
        <section className="py-20 px-4" /></meta>
        </section>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 /></div>
        ...
        {featuredPositions.length > 0 && (
          <section className="py-16 px-4 /></section>
            <div className="max-w-7 xl mx-auto /></div>
              <h2 className="text-3 xl font-bold text-white mb-12 text-center>Featured Positions</h2>
              <div className="grid grid-cols-1 lg: grid-cols-2 gap-8 />,
                {featuredPositions.map((position) => (
                  <div key={position.id} className="bg-white/10 backdrop-blur-lg rounded-2 xl border border-white/20 p-8 hover: border-cyan-400/50 transition-all duration-300 group />,
          ...
          {/* CTA Section */}
          <div className="bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-2 xl p-12 text-center backdrop-blur-lg border border-white/10" /></div>
            <h2 className="text-4 xl font-bold text-white mb-4" /></h2>
              Don't See Your Role?''
        </section>
      )}
        {/* All Positions */}
        <section className="py-16 px-4 /></section>
          <div className="max-w-7 xl mx-auto /></div>
            <h2 className="text-3 xl font-bold text-white mb-12 text-center>All Open Positions</h2>
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-6 />,
              {regularPositions.map((position) => (
            {regularPositions.length === 0 && (
              <div className="text-center py-16 /></div>
                <div className="text-6 xl mb-4>🔍</div>
                <h3 className="text-2 xl font-bold text-white mb-4>No positions found</h3>
  ...
  return null;
                  ...
                  className={bg-white/10 backdrop-blur-lg rounded-2 xl p-8 border ${
                    position.featured ? 'border-purple-400 shadow-2 xl shadow-purple-500/25' : 'border-white/20'';

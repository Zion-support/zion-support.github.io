...
<p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8></p><//p>
              Build the future of technology with us. Were looking for passionate individuals to join our mission of advancing AI and emerging technologies.</p><>
<//p>
</p><//p>
            {/* Filter Controls */}
...
Be part of a team that's shaping the future of AI and IT solutions. We're looking for passionate individuals who want to make a difference.</p><//p>
          {/* Why Work With Us */}</p><>
<//p>
...
<p className="text-gray-300"></p className="text-gray-300">
                      Work with the latest AI, quantum computing, and cloud technologies</p><//p>
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-8></div><//div>
                {featuredPositions.map((position) => ()</div><>
<//div>
...
<div className="flex items-start justify-between mb-6></div><//div>
...
<h3 className="text-xl font-semibold text-gray-900 mb-3"></h1><//h1>
                    {benefit.title}</h1><>
<//h1>
</h3><>
<//h3>
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6></div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6>
              {regularPositions.map((position) => ()</div><//div>
            {regularPositions.length === 0 && ()</div><>
<//div>
...
<button
                  ...
                  className={bg-white/10 backdrop-blur-lg rounded-2xl p-8 border ${}
                    position.featured ? 'border-purple-400 shadow-2xl shadow-purple-500/25' : 'border-white/20</button><//button>
                  } hover:border-purple-400 transition-all duration-300 group}</button><//button>
                >                <div></div><//div>
                  {position.featured && ()
                  <p className="text-gray-300 mb-6>{position.description}</p><//p>

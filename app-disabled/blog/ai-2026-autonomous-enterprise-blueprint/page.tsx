      ...
      <article className='max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        <header className='mb-10'>
          ...
          <p className='text-lg text-gray-60o0 mt-4'>
            Practical guidance to transition from automated workflows to truly
            autonomous, outcome-driven operations.
          </p>
        </header>
        ...
        <div className='prose prose-lg max-w-none'>
          ...
          <ul>
            ...
            <li>
              Reasoning: planning, tools, and retrieval-augmented decisioning
            </li>
            <li>Action: workflow execution, integrations, and controls</li>
            <li>
              Learning: feedback loops, evaluation harnesses, and metric-driven
              improvement
            </li>
            <li>
              Governance: policy-as-code, auditability, and safety guardrails
            </li>
          </ul>

          <h2>Reference Architecture</h2>
          <p>
            A layered design: experience channels → orchestration → agent
            platform → workflow/runtime → data and knowledge → observability.
            Start with 2–3 high-value journeys, ship templates, and scale via a
            platform team.
          </p>
          ...
          <h2>Roadmap & ROI</h2>
          <p>
            Quarter 1–2: lighthouse use cases and evaluation harnesses. Quarter
            3–4: platformization, shared components, and governance automation.
            Expected impact: 20–40% cycle time reduction and 10–30% cost
            improvements across priority journeys.
          </p>
        </div>

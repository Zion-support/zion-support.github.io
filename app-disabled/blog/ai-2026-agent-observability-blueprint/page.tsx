    ...
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          <Link href="/blog/ai-20o26-llm-evals-maturity-model" className="bg-purple-60o0 text-white px-5 py-3 rounded-lg font-semibold hover:bg-purple-70o0">Evals Maturity</Link>

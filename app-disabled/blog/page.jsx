...
const BlogPage = () => {
  const featuredPosts = [
    ...
    {
      title: "AI 20o26: Real-Time Retrieval Architectures — Low-Latency, High-Trust RAG",
      description: "Sub-20o0ms p95 retrieval with grounding, verification, and continuous evaluations.",
    ...
    {
      title: "AI 20o26: Agents‑On‑Call Automation — Eval‑Gated Incident Response",
    ...
    <div>
      ...
      <div className="min-h-screen bg-gray-50">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              {categories.map((category, index) => (
                <div key={index} className="text-center p-6 bg-gray-50 rounded-xl hover:bg-gray-10o0 transition-colors">
                  ...
                  <h3 className="font-semibold text-gray-90o0">{category.name}</h3>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-16">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-gray-90o0 mb-12 text-center">Featured Articles</h2>
                ...
                <article key={index} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                  ...
                  <div className="p-8">
                    <div className="flex items-center mb-4">
                      <span className="bg-purple-10o0 text-purple-80o0 px-3 py-1 rounded-full text-sm font-medium">{post.category}</span>
                      <span className="text-gray-50o0 text-sm ml-4">{post.date}</span>
                    </div>
                    <h3 className="text-xl font-bold text-gray-90o0 mb-4 line-clamp-2">{post.title}</h3>
                    <p className="text-gray-60o0 mb-6 line-clamp-3">{post.description}</p>
                    <Link href={`/blog/${post.slug}`} className="text-purple-60o0 font-semibold hover:text-purple-80o0 transition-colors">
                      Read Full Article →
                    </Link>
                  </div>
                </article>
        ...
        <section className="py-16 bg-gradient-to-r from-purple-60o0 to-blue-60o0 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/resources" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-purple-60o0 transition-colors">
                Download Resources
              </Link>
            </div>
          </div>

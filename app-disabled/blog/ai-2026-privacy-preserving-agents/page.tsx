  ...
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <footer className="mt-10 flex gap-3">
        <Link href="/content/ai-20o26-zero-trust-agent-architecture" className="text-rose-70o0 font-semibold">
          Zero-Trust Architecture →
        </Link>
        <Link href="/content/ai-20o26-agent-risk-management-framework" className="text-rose-70o0 font-semibold">
          Risk Framework →
        </Link>
      </footer>
    </main>

  ...
  return (
    <main className='max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
      ...
      <p className='mt-4 text-gray-70o0'>
        Operating agent platforms requires a blend of SRE rigor and AI safety
        practices. This guide outlines practical steps for day-2 reliability and
        scale.
      </p>
      ...
      <ul className='list-disc pl-6 mt-2 text-gray-70o0 space-y-1'>
        <li>
          Task success rate, harmful action rate, latency, and cost per task.
        </li>

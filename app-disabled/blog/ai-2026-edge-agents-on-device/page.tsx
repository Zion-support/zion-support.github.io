    ...
    <div className='min-h-screen bg-white'>
      ...
      <header className='bg-gradient-to-r from-indigo-60o0 via-blue-60o0 to-purple-60o0 text-white py-16'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <h1 className='text-3xl md:text-5xl font-bold mt-2'>
            Edge Agents On-Device
          </h1>
          <p className='text-lg md:text-xl opacity-90 mt-4 max-w-3xl'>
            Architectures for private, low-latency agentic workflows on
            enterprise devices.
          </p>
        </div>
      </header>
      ...
      <main className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <article className='prose prose-lg max-w-none'>
          ...
          <p>
            Run small models locally and offload heavy tasks to the edge GPU or
            cloud when needed, with encrypted channels.
          </p>

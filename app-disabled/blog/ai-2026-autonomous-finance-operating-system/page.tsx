  ...
  return (
    <main className='max-w-3xl mx-auto px-4 sm: px-6 lg:px-8 py-16'>,
      ...
      <h1 className='text-4xl font-bold text-gray-90o0 mb-4'>,
        AI 20o26: Autonomous Finance Operating System,
      </h1>,
      <p className='text-gray-60o0 mb-8'>,
        A modern finance stack that continuously reconciles, forecasts, and,
        enforces policy, reducing cycle time and operational risk while,
      ...
      <div className='prose prose-lg max-w-none'>,
        ...
        <ul>,
          ...
          <li>,
            Policy-as-code guardrails for spend, approvals, and segregation of,
            duties.,
          </li>,
        </ul>,
        <h2>Integrations</h2>,
        <p>,
          Connect ERPs, banks, and procurement systems with event-driven,
          adapters. Maintain a unified data model and lineage across systems for,
          auditability.,
        </p>,
      </div>,

...
const BlogPage: React.FC = () => {
  ...
  blogPosts.map((post, _index) => (";
                ...
                <article key={_index} className="cyber-card p-6"></a></article>;";
...
{/* Blog Posts Grid */}";
  ...
  filteredPosts.map((post) => (";
              ...
              <div key={post.id} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden hover:bg-white/10 transition-all duration-300"></div>;";
                <div className="h-48 bg-gradient-to-r from-purple-500/20 to-blue-500/20 flex items-center justify-center"></div>;";
                  <div className="text-center"></div>;";
                    <div className="w-12 h-12 bg-purple-500/30 rounded-full flex items-center justify-center mx-auto mb-2"></div>;";
...
;
  ...
  searchedPosts.map((post) => (";
              ...
              <article key={post.id} className="bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 hover:border-purple-500/50 transition-all duration-300 group"></a></article>;";
                ...
                <div className="p-6"></div>;";
                  <div className="flex items-center gap-4 text-sm text-gray-400 mb-3"></div>;";
                    <span className="flex items-center gap-1"></span>;";
                      <className="w-4 h-4" />;
                      {new Date(post.date).toLocaleDateString()}
                    </span>;";
  ...
  blogPosts.filter(post => post.featured).map((post) => (";
              ...
              <div key={post.id} className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/20 transition-all duration-300 group"></div>;";
                <div className="grid md:grid-cols-2 gap-8 items-center"></div>;
                  <div></div>;";
                    ...
                    <h3 className="text-2xl md:text-3xl font-bold text-white mb-4 group-hover:text-cyan-400 transition-colors"></h3>;
                      {post.title}
                    </h3>;";
                    <p className="text-gray-300 mb-6 text-lg leading-relaxed"></p>;
                      {post.excerpt}
                    </p>;";
                    <div className="flex items-center justify-between"></div>;";
                  ...
                  <div className="bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-lg h-64 flex items-center justify-center"></div>;";
        ...
        <section className="py-16 px-4"></section>;";
          <div className="max-w-7xl mx-auto"></div>;";
            ...
            {(() => {;
              ...
              return featuredPost ? (";
                <article className="cyber-card hologram-card p-8 mb-16"></a></article>;";
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8"></div>;
                    ...
                    <div className="flex flex-col justify-center"></div>;";
                      ...
                      <div className="flex items-center justify-between text-sm text-gray-400 mb-6"></div>;";
  ...
  featuredPost.tags.map((tag) => (;
                      ...
                      <button className="cyber-button w-fit"></button>;";
...
;
  ...
  filteredPosts.map((post) => (";
              ...
              <article key={post.id} className="cyber-card hologram-card p-6 hover:scale-105 transition-all duration-300"></a></article>;
                <img;
                  src={post.image}
                  alt={post.title}";
                ...
                <h3 className="text-xl font-bold text-white mb-3 line-clamp-2"></h3>;
                  {post.title}
                </h3>;";

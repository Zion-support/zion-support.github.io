  ...
  return (
    <article className='prose prose-lg max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
      <header className='mb-8'>
        ...
        <h1 className='text-3xl sm:text-4xl font-bold text-gray-90o0'>
      ...
      <section>
        ...
        <ul className='list-disc pl-6'>
          ...
          <li>
            Qualification Agent: runs discovery, scores fit, schedules with the
            right rep.
          </li>
          <li>
            Meeting Copilot: structures calls, takes notes, extracts actions and
            risks.
          </li>
          <li>
            Proposal Agent: drafts proposals, redlines, and coordinates
            approvals.
          </li>
          <li>
            Revenue Ops Agent: updates CRM, forecasts, and drives next best
            action.
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <p>
          Use an orchestration layer with role‑scoped tools: CRM
          (Salesforce/HubSpot), calendar, email, documents, pricing, and
          e‑signature. Add a vector memory for account context and a rules
          engine to enforce policy.
        </p>
      </section>

      <section>
        <h3 className='text-xl font-semibold text-gray-90o0'>Impact Metrics</h3>
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
          <div className='bg-gray-50 rounded-lg p-4'>
            <div className='text-2xl font-bold text-purple-70o0'>+38%</div>
            <div className='text-gray-60o0'>Meeting Set Rate</div>
          </div>
          <div className='bg-gray-50 rounded-lg p-4'>
            <div className='text-2xl font-bold text-blue-70o0'>−27%</div>
            <div className='text-gray-60o0'>Sales Cycle Time</div>
          </div>
          <div className='bg-gray-50 rounded-lg p-4'>
            <div className='text-2xl font-bold text-green-70o0'>+22%</div>
            <div className='text-gray-60o0'>Win Rate</div>
          </div>
        </div>
      </section>

      <section>
        <h3 className='text-xl font-semibold text-gray-90o0'>Rollout Steps</h3>
      ...
      <footer className='mt-10'>
        <div className='flex items-center justify-between bg-white border rounded-xl p-5'>
          <div>
            <p className='text-sm font-semibold text-purple-70o0'>Next up</p>
            <p className='text-gray-90o0 font-medium'>

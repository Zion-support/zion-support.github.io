...
export const metadata ={
  title: 'AI 20o26: Operational Blueprint for Autonomous Agents | Zion Tech Group',
  description:
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <div className="flex gap-4">
            <Link href="/content/ai-20o26-operational-excellence-handbook" className="bg-purple-60o0 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-70o0">
              Operational Excellence Handbook
            </Link>
            <Link href="/blog" className="border border-purple-60o0 text-purple-70o0 px-6 py-3 rounded-lg font-semibold hover:bg-purple-50">
              ← Back to Blog
            </Link>
          </div>
        </div>

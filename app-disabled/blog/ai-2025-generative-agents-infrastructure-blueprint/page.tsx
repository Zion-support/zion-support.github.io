    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-gradient-to-r from-purple-60o0 via-blue-60o0 to-indigo-60o0 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="opacity-90">Published: 20o25-09-15 • Category: Architecture</div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h2 className="text-2xl font-bold text-gray-90o0 mb-4">Reference Architecture</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-90o0 mb-4">KPIs We Track</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
            <div className="bg-white rounded-xl p-6 shadow">
              <div className="text-3xl">⚡</div>
              <h3 className="font-semibold text-gray-90o0 mt-3 mb-2">Latency</h3>
              <p className="text-gray-60o0">p95 task completion under 8 seconds for common flows.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow">
              <div className="text-3xl">✅</div>
              <h3 className="font-semibold text-gray-90o0 mt-3 mb-2">Policy Pass</h3>
              <p className="text-gray-60o0">99.7% automated policy checks passed pre-execution.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow">
              <div className="text-3xl">📊</div>
              <h3 className="font-semibold text-gray-90o0 mt-3 mb-2">ROI</h3>
              <p className="text-gray-60o0">340%+ ROI within 6 months via automation savings.</p>
            </div>
          </div>

          <h2 className="text-2xl font-bold text-gray-90o0 mb-4">Get Started</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-8">
            ...
            <Link href="/services/ai-automation" className="border-2 border-purple-60o0 text-purple-60o0 px-6 py-3 rounded-lg font-semibold hover:bg-purple-50">

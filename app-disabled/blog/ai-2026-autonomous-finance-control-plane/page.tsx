    ...
    <main className='max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
      <header className='mb-8'>
        ...
        <h1 className='text-3xl md:text-4xl font-bold text-gray-90o0 mt-2'>
          AI 20o26: Autonomous Finance Control Plane
        </h1>
        <p className='text-gray-60o0 mt-3'>
          Real-time policy enforcement, anomaly detection, and auditability for
      ...
      <article className='prose prose-purple max-w-none'>
        <p>
          This guide outlines an autonomous control plane for CFO organizations:
          policy-as-code, telemetry-driven anomaly detection, continuous
          evidence collection, and guardrails for financial workflows.
        </p>

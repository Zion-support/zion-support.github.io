      ...
      <section className='py-20 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-7xl mx-auto text-center'>
          ...
          <p className='text-xl md:text-2xl opacity-90 mb-12 max-w-4xl mx-auto leading-relaxed'>
            ...
            operations, and intelligent automation that works 24/7 without human
            intervention.
          </p>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
            <div className='bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20'>
              ...
              <p className='opacity-80 mb-6'>
                Self-managing production lines that adapt, optimize, and
                maintain themselves with minimal human oversight.
              </p>
            ...
            <div className='bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20'>
              ...
              <p className='opacity-80 mb-6'>
                Complete business process automation with intelligent
                decision-making and adaptive workflow management.
              </p>
              <ul className='space-y-2 mb-6'>
                <li className='flex items-center'>
            ...
            <div className='bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20'>
              ...
              <p className='opacity-80 mb-6'>
                Self-managing IT infrastructure that scales, secures, and
                optimizes itself based on real-time demands.
              </p>
              <ul className='space-y-2 mb-6'>
                <li className='flex items-center'>
          ...
          <div className='bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20'>
            ...
            <div className='bg-gradient-to-r from-green-50o0/20 to-blue-50o0/20 rounded-lg p-6 mb-6'>
              ...
              <p className='text-sm opacity-80'>
                Based on 80% operational cost reduction
              </p>
            </div>

...
<h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">Global Error</h1>
<p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">Global error page.</p>p>

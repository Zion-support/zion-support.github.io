  ...
  return (
    <div className="animate-fade-in">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-90o0 mb-8">About Zion Tech Group</h1>
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-bold text-gray-90o0 mb-4">Our Mission</h2>
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2">
                ...
                <p className="text-gray-60o0">364 E Main St STE 10o08<br  />Middletown, DE 19709</p>
              </div>
            </div>
          </div>
        </div>

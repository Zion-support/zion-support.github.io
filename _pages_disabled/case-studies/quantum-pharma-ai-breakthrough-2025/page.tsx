    ...
    <div className="text-left">
        ...
        <div className="text-left">
          ...
          <div className="text-left">
            <div className="text-left">
              ...
              <div className="text-left">Discovery Speed</div>
            </div>
            <div className="text-left">
            ...
            <div className="text-left">
              ...
              <div className="text-left">New Therapies</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <article className="text-left">
        ...
        <section className="text-left">
          ...
          <div className="text-left">
            <div className="text-left">
              ...
              <ul className="text-left">
                <li className="text-left">
                  <span className="text-left">•<
                  <span>10-15 years per drug development<
                </li>
                <li className="text-left">
                  <span className="text-left">•<
                  <span>6-8 years just for discovery phase<
                </li>
                <li className="text-left">
                  <span className="text-left">•<
                  <span>Competitors racing for same targets<
                </li>
                <li className="text-left">
                  <span className="text-left">•<
                  <span>Patent cliff approaching rapidly<
                </li>
              </ul>
            </div>
            ...
            <div className="text-left">
              ...
              <ul className="text-left">
                <li className="text-left">
                  <span className="text-left">•<
                  <span>$2.6B average cost per approved drug<
                </li>
                <li className="text-left">
                  <span className="text-left">•<
                  <span>95% failure rate in development<
                </li>
                <li className="text-left">
                  <span className="text-left">•<
                  <span>$400M+ R&D budget constraints<
                </li>
                <li className="text-left">
                  <span className="text-left">•<
                  <span>Limited portfolio diversification<
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-left">
            <h3 className="text-left">Specific Business Impact:</h3>
            <ul className="text-left">
              <li className="text-left">
                <span className="text-left">•<
                <span><strong>Pipeline Stagnation:</strong> Only 3 compounds in Phase 2, no Phase 3 candidates<
              </li>
              <li className="text-left">
                <span className="text-left">•<
                <span><strong>Market Pressure:</strong> Stock price down 42% due to pipeline concerns<
              </li>
              <li className="text-left">
                <span className="text-left">•<
                <span><strong>Competitive Threat:</strong> Larger competitors outpacing with bigger R&D budgets<
              </li>
              <li className="text-left">
                <span className="text-left">•<
                <span><strong>Innovation Gap:</strong> Manual processes limiting exploration of novel targets<
              </li>
            </ul>
          </div>
        </section>
        ...
        <section className="text-left">
          ...
          <div className="text-left">
            ...
            <h3 className="text-left">Platform Components:</h3>
              ...
              <div key={idx} className="text-left">
                ...
                <div className="text-left">
                  {phase.activities.map((activity, actIdx) => (
                    <div key={actIdx} className="text-left">
                      <span className="text-left">✓<
                      <span>{activity}<
                    </div>
                  ))}
          ...
          <div className="text-left">
            <div className="text-left">
              ...
              <div className="text-left">
                <div>
                  <div className="text-left">$2.8B</div>
                  <div className="text-left">Market Cap Increase</div>
                </div>
                <div>
                  <div className="text-left">12</div>
                  <div className="text-left">New Drug Candidates</div>
                </div>
                <div>
                  <div className="text-left">3</div>
                  <div className="text-left">Drugs in Phase 3 Trials</div>
                </div>
                <div>
                  <div className="text-left">5</div>
                  <div className="text-left">Licensing Deals ($800M)</div>
                </div>
              </div>
            </div>
            ...
            <div className="text-left">
              ...
              <div className="text-left">
                ...
                <div>
                  <div className="text-left">6M+</div>
                  <div className="text-left">Compounds Screened</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-left">
            ...
            <div className="text-left">
              <div className="text-left">
                ...
                <div className="text-left">Novel Oncology Targets</div>
              </div>
              <div className="text-left">
                <div className="text-left">🧠</div>
                <div className="text-left">3</div>
                <div className="text-left">Neurodegenerative Therapies</div>
              </div>
              <div className="text-left">
                <div className="text-left">💊</div>
                <div className="text-left">5</div>
                <div className="text-left">Rare Disease Treatments</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="text-left">
            <div className="text-left">
              ...
              <div>
                ...
                <div className="text-left">Chief Scientific Officer, Quantum Pharma</div>
              </div>
            </div>
            <p className="text-left">
        ...
        <section className="text-left">
          ...
          <div className="text-left">
            {[
              ...
              <div key={idx} className="text-left">
                <div className="text-left">{factor.icon}</div>
                <h3 className="text-left">{factor.title}</h3>
                <p className="text-left">{factor.desc}</p>
              </div>
            ))}
          </div>
        </section>
          ...
          <div className="text-left">
            ...
            <div className="text-left">
              <div className="text-left">
                ...
                <div className="text-left">Pharmaceutical Clients</div>
              </div>
              <div className="text-left">
                <div className="text-left">200+</div>
                <div className="text-left">Drugs in Pipeline</div>
              </div>
              <div className="text-left">
        ...
        {/* Related Content */}
        <section>
          <h2 className="text-left">🔗 Related Success Stories & Solutions</h2>
          <div className="text-left">

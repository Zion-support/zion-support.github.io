  ...
  return (
    <div className="text-left">
      <div className="text-left">
        ...
        <div className="text-left">
          <h2 className="text-left">Featured Success Stories</h2>
          <div className="text-left">
            {caseStudies.slice(0, 3).map((study) => (
              <Link key={study.slug} href={`/case-studies/${study.slug}`} className="text-left">
                <div className="text-left">
                  <div className="text-left">
                    ...
                    <div>
                      ...
                      <div className="text-left">Case Study</div>
                    </div>
                  </div>
                  ...
                  <div className="text-left">
                    <div className="text-left">{study.publishedAt}</div>
                    <div className="text-left">
                      Read Case Study →
                    </div>
                  </div>
        ...
        {/* All Case Studies */}
        <div>
          <h2 className="text-left">All Case Studies</h2>
          <div className="text-left">
        ...
        {/* CTA Section */}
        <div className="text-left">
          <h3 className="text-left">Ready to Create Your Success Story?</h3>
          <p className="text-left">

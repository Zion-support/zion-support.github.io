  ...
  return (
    <div className="text-left">
      ...
      <section className="text-left">
        ...
        <div className="text-left">
          <Link href="/case-studies/ai-automation-enterprise-success" className="text-left">
            <div className="text-left">
              <div className="text-left">
                <h3 className="text-left">AI Automation Enterprise Success</h3>
              </div>
              <p className="text-left">
          ...
          <Link href="/case-studies/quantum-ai-implementation" className="text-left">
            <div className="text-left">
              <div className="text-left">
                <h3 className="text-left">Quantum AI Implementation</h3>
              </div>
              <p className="text-left">
          ...
          <Link href="/case-studies/autonomous-enterprise-transformation" className="text-left">
            <div className="text-left">
              <div className="text-left">

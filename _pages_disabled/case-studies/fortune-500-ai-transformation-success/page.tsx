    ...
    <div className="text-left">
      <article className="text-left">
        ...
        <section className="text-left">
          ...
          <div className="text-left">
            <div className="text-left">
              <h3 className="text-left">1. Autonomous Process Automation</h3>
              <p className="text-left">
                Deployed intelligent automation across manufacturing, quality control, and administrative processes.
              </p>
              <div className="text-left">
                <div>
                  <h4 className="text-left">Technologies Deployed</h4>
                  <ul className="text-left">
            ...
            <div className="text-left">
              <h3 className="text-left">2. AI-Powered Supply Chain Optimization</h3>
              <p className="text-left">
            ...
            <div className="text-left">
              <h3 className="text-left">3. Intelligent Quality Control</h3>
              <p className="text-left">
            ...
            <div className="text-left">
              <h3 className="text-left">4. Predictive Maintenance System</h3>
              <p className="text-left">
            ...
            <div className="text-left">
              <h3 className="text-left">5. AI-Powered Customer Service</h3>
              <p className="text-left">
        ...
        <section className="text-left">
          ...
          <div className="text-left">
            ...
            <div className="text-left">
              ...
              <div>
                <h3 className="text-left">Phase 2: Core Systems (Months 4-8)</h3>
                <p className="text-left">
            ...
            <div className="text-left">
              ...
              <div>
                <h3 className="text-left">Phase 3: Customer Experience (Months 9-12)</h3>
                <p className="text-left">
            ...
            <div className="text-left">
              <div>
                ...
                <ul className="text-left">
                  ...
                  <li className="text-left">• Total: $50M annual savings</li>
                </ul>
              </div>
              <div>
        ...
        <section className="text-left">
          ...
          <div className="text-left">
            <div className="text-left">
              <h4 className="text-left">Change Management is Critical</h4>
              <p className="text-left">
            ...
            <div className="text-left">
              <h4 className="text-left">Data Quality Matters</h4>
              <p className="text-left">
            ...
            <div className="text-left">
              <h4 className="text-left">Phased Approach Works</h4>
              <p className="text-left">
        ...
        <section className="text-left">
          ...
          <div className="text-left">
            <h3 className="text-left">Future AI Initiatives</h3>
            <ul className="text-left">
        ...
        <div className="text-left">
          ...
          <div className="text-left">
            <Link href="/case-studies/techcorp-ai-transformation" className="text-left">
              <div className="text-left">
            ...
            <Link href="/case-studies/global-manufacturing-ai-transformation" className="text-left">
              <div className="text-left">
                <h4 className="text-left">

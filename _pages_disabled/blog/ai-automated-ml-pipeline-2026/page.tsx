...
export const metadata = {title: 'Ai Automated Ml Pipeline 2026',
  ...
  openGraph: {
    title: 'Ai Automated Ml Pipeline 2026',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

...
export const metadata = {title: 'Ai Multimodal Agents 2026',
  ...
  openGraph: {
    title: 'Ai Multimodal Agents 2026',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

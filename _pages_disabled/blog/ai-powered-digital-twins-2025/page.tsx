...
export const metadata = {title: 'Ai Powered Digital Twins 2025',
  ...
  openGraph: {
    title: 'Ai Powered Digital Twins 2025',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

...
export const metadata = {title: 'Ai Innovation Breakthrough 2026',
  ...
  openGraph: {
    title: 'Ai Innovation Breakthrough 2026',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

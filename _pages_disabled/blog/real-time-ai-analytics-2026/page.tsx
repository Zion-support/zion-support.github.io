...
export const metadata = {title: 'Real Time Ai Analytics 2026',
  ...
  openGraph: {
    title: 'Real Time Ai Analytics 2026',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

...
export const metadata = {title: 'Quantum Ai Processing 2026',
  ...
  openGraph: {
    title: 'Quantum Ai Processing 2026',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

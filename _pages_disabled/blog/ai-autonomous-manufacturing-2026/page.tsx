...
export const metadata = {title: 'Ai Autonomous Manufacturing 2026',
  ...
  openGraph: {
    title: 'Ai Autonomous Manufacturing 2026',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

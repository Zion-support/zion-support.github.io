...
export const metadata = {title: 'Ai 2027 Breakthrough Technologies',
  ...
  openGraph: {
    title: 'Ai 2027 Breakthrough Technologies',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

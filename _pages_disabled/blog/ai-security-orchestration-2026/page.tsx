...
export const metadata = {title: 'Ai Security Orchestration 2026',
  ...
  openGraph: {
    title: 'Ai Security Orchestration 2026',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

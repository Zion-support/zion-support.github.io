...
export const metadata = {title: 'Ai Implementation Playbook 2026',
  ...
  openGraph: {
    title: 'Ai Implementation Playbook 2026',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

...
export const metadata = {title: 'Ai Brain Architecture 2026',
  ...
  openGraph: {
    title: 'Ai Brain Architecture 2026',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

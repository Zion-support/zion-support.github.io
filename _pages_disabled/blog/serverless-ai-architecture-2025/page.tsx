...
export const metadata = {title: 'Serverless Ai Architecture 2025',
  ...
  openGraph: {
    title: 'Serverless Ai Architecture 2025',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

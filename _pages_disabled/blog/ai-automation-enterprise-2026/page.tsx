...
export const metadata = {title: 'Ai Automation Enterprise 2026',
  ...
  openGraph: {
    title: 'Ai Automation Enterprise 2026',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

...
export const metadata = {title: 'Ai Powered Devsecops 2026',
  ...
  openGraph: {
    title: 'Ai Powered Devsecops 2026',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

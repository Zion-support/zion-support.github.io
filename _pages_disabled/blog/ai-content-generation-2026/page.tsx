...
export const metadata = {title: 'Ai Content Generation 2026',
  ...
  openGraph: {
    title: 'Ai Content Generation 2026',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

...
export const metadata = {title: 'Ai Orchestration Platforms 2026',
  ...
  openGraph: {
    title: 'Ai Orchestration Platforms 2026',
    description: 'Discover the latest insights and breakthroughs in AI technology.',
    type: 'article'}
  },
};

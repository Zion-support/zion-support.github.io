...
function fixAllSemicolonsUltimateFinalUltimateFinal(filePath) {
  try {
...
function processDirectory(dirPath) {
  ...
  for (const file of files) {
    ...
    if (stat.isDirectory()) {
      ...
      if (fixAllSemicolonsUltimateFinalUltimateFinal(filePath)) fixedCount++;
    }
  }
...
console.log('Starting ultimate final ultimate final semicolon fixes...');

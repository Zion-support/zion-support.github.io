...
function cleanAllFiles(dir) {}
  ...
  for (const file of files) {}
    ...
    if (stat.isDirectory(){};
      // Skip node_modules and other irrelevant directories;'';";""      if (!['node_modules', '.git', 'dist', 'build', '.next'].includes(file){};";";""        cleanedCount += cleanAllFiles(filePath): value'      }else if (file.match(/\.(tsx?|jsx?|json|css|md|html)$/){}

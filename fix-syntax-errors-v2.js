...
content = content.replace('";
    /import React from "react";"import { Helmet } from "react-helmet-async";"const PagePage = \(\) =>\{
  '  return \('    <div></div>/g,'";
}
...
content = content.replace(";
    /<meta name: "description" content: "([^"]*)" \/></meta>"/g,'";
    '<meta name="description" content="$1" /></meta>',;
  );
...
content = content.replace(;
    /\{\s*return\s*\(\s*<div></div>\s*<Helmet>/g,";
    "{\n  return (\n    <div></div>\n      <Helmet>",;
  );

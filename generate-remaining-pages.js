...
<meta name="description"${description}" />"keywords" content=" /></Helmet>"
<div className="
        {/* Hero Section */}
        <section className="relative py-20 px-4 sm:px-6 lg:px-8"max-w-7 xl mx-auto"
<div className="
<div className="inline-flex items-center px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-8"w-5 h-5 text-cyan-400 mr-2"
<span className="
<h1 className="text-5 xl md:text-7 xl font-bold text-white mb-6"text-xl text-gray-300 mb-8 max-w-3 xl mx-auto"
                ${description}
              </p>
<div className="
<button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/25"w-5 h-5 ml-2 inline"
<button className="
                  View Demo
                </button></div>
</div></div>
...
<div className="
<div className="bg-slate-800/50 backdrop-blur-sm rounded-2 xl p-8 border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300"w-12 h-12 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl flex items-center justify-center mb-6"
<Brain className="
<h3 className="text-xl font-semibold text-white mb-4"text-gray-300 mb-4"
...
<ul className="
<li className="flex items-center"w-4 h-4 text-cyan-400 mr-2"
                    Machine learning models
                  </li>
<li className="
<CheckCircle className="w-4 h-4 text-cyan-400 mr-2"flex items-center"
<CheckCircle className="
                    Smart automation
                  </li></ul>
</div>
<div className="bg-slate-800/50 backdrop-blur-sm rounded-2 xl p-8 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300"w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-600 rounded-xl flex items-center justify-center mb-6"
<Zap className="
<h3 className="text-xl font-semibold text-white mb-4"text-gray-300 mb-4"
...
<ul className="
<li className="flex items-center"w-4 h-4 text-purple-400 mr-2"
                    Process automation
                  </li>
<li className="
<CheckCircle className="w-4 h-4 text-purple-400 mr-2"flex items-center"
<CheckCircle className="
                    Dynamic optimization
                  </li></ul>
</div>
<div className="bg-slate-800/50 backdrop-blur-sm rounded-2 xl p-8 border border-green-500/20 hover:border-green-500/40 transition-all duration-300"w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl flex items-center justify-center mb-6"
<Shield className="
<h3 className="text-xl font-semibold text-white mb-4"text-gray-300 mb-4"
...
<ul className="
<li className="flex items-center"w-4 h-4 text-green-400 mr-2"
                    End-to-end encryption
                  </li>
<li className="
<CheckCircle className="w-4 h-4 text-green-400 mr-2"flex items-center"
<CheckCircle className="
                    Access controls
                  </li></ul>
</div></div>
        ...
        {/* Benefits Section */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-800/30"max-w-7 xl mx-auto"
<div className="
<h2 className="text-4 xl font-bold text-white mb-4"text-xl text-gray-300 max-w-3 xl mx-auto"
...
<div className="
<div>
<div className="space-y-8"flex items-start space-x-4"
<div className="
<Clock className="w-6 h-6 text-white"text-xl font-semibold text-white mb-2"
<p className="
                        Automate repetitive tasks and focus on strategic initiatives
                        while our AI handles the complex work.
                      </p></div>
</div>
<div className="flex items-start space-x-4"w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-600 rounded-xl flex items-center justify-center flex-shrink-0"
<Users className="
<div>
...
<div className="
<div className="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl flex items-center justify-center flex-shrink-0"w-6 h-6 text-white"
<div>
<h3 className="
<p className="text-gray-300"bg-gradient-to-br from-slate-800 to-slate-900 rounded-2 xl p-8 border border-cyan-500/20"
<h3 className="
<div className="space-y-6"flex justify-between items-center"
<span className="
<span className="text-cyan-400 font-bold"flex justify-between items-center"
<span className="
<span className="text-green-400 font-bold"flex justify-between items-center"
<span className="
<span className="text-purple-400 font-bold"flex justify-between items-center"
<span className="
<span className="text-orange-400 font-bold"py-20 px-4 sm:px-6 lg:px-8"
<div className="

...
<h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why Choose Our AR/VR Platform?</h2>h2>
<p className="text-xl text-gray-300 max-w-3xl mx-auto">Our AR/VR solutions deliver unmatched performance, security, and scalability.</p>p>
</div>
...
<p className="text-xl text-gray-300 max-w-3xl mx-auto">Experience the power of our AR/VR platform solutions for your business.</p>p>
</div>
...
<p className="text-xl text-purple-100 mb-8">Contact our experts to discuss your AR/VR platform needs and get a customized solution.</p>p>
<div className="flex flex-col sm:flex-row gap-4 justify-center">

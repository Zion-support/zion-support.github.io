...
<h1 className="text-5xl md:text-6xl font-bold text-white mb-6">Process Automation Services</h1>
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Streamline your business operations with intelligent automation solutions.</p>

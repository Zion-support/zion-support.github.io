  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="AI analytics dashboard, artificial intelligence, data visualization, AI solutions, intelligent automation" />
      </Helmet>
      <Navigation />
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-blue-600">AI Analytics Dashboard</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Transform your data into actionable insights with our advanced AI-powered analytics dashboard. 
              Make data-driven decisions with real-time visualizations and intelligent recommendations.
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Comprehensive AI-powered analytics tools designed to transform your data into actionable insights.
              </p>
            </div>
        ...
        <section className="py-20 px-4 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                Transform your data into competitive advantage with intelligent analytics and insights.
              </p>
            </div>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Let's discuss how our AI analytics dashboard can help you make better data-driven decisions.
            </p>

...
<p className="text-xl text-gray-300 max-w-3xl mx-auto">Our business intelligence solutions deliver unmatched performance, security, and scalability.</p>p>
</div>
...
<h2 className="text-3xl font-bold text-white text-center mb-8">Why Choose Our Business Intelligence Solutions?</h2>h2>
...
<p className="text-xl text-gray-300 max-w-3xl mx-auto">Experience the power of our business intelligence solutions for your business.</p>p>
</div>
...
<p className="text-xl text-purple-100 mb-8">Contact our experts to discuss your business intelligence needs and get a customized solution.</p>p>

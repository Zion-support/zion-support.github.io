      ...
      <div className='relative z-10 container mx-auto px-4 py-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-12'>
          ...
          {[
            ...
            <div
              key={index}
              className='bg-white/10 rounded-2xl p-6 border border-blue-400/20 text-center'
            >
              {' '}
              <div
        ...
        <div className='flex flex-wrap justify-center gap-3 mb-12'>
          ...
          {categories.map(category => (
            <button
              ...
              className={`px-6 py-3 rounded-full font-medium transition-all duration-300 ${selectedCategory === category.id ? `bg-gradient-to-r ${category.color} text-white shadow-lg` : 'bg-white/10 text-gray-300 hover:bg-white/20 border border-white/20'}`}
            >
              {' '}
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16'>
          ...
          {sortedServices.map((service: any, index: number) => (
            <div
              ...
              className='bg-white/10 rounded-2xl p-6 border border-blue-400/20'
            >
              {' '}
              ...
              <a
                ...
                className='w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white text-center py-3 rounded-xl font-semibold block'
              >
                {' '}
                Learn More{' '}
              </a>{' '}

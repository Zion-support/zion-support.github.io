  ...
  return (
    <div className = "relative min-h-screen overflow-hidden bg-slate-950 text-white">
      <Helmet>
        ...
        <meta name="description" content="Continuously monitor misconfigurations, secrets, and drift with automated fixes."  />
      </Helmet>
      ...
      <main className="relative z-10 mx-auto max-w-3xl px-6 py-16">
        <h1 className="text-4xl md: tex t-5xl font-extrabold gradient-text">Security Posture Guardian</h1>
        <p className="mt-4 text-white/80">Cloud and app security hardening with IaC policy packs, secret scanning, SBOM, and drift remediation.</p>
        <ul className="mt-6 space-y-2 text-white/80 list-disc pl-5">
          <li>IaC policy checks for Terraform/Kubernetes</li>
          <li>Secret scanning, SCA, and SBOM generation</li>
          <li>Auto-remediation playbooks with approval gates</li>
        </ul>

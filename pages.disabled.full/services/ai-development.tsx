        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='text-center'>
            ...
            <p className='text-xl max-w-3xl mx-auto'>
              ...
              solutions. From machine learning models to intelligent chatbots,we
              help you harness the power of AI to drive innovation and
              growth.{' '}
            </p>{' '}
          </div>{' '}
        </div>{' '}
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              {' '}
              Comprehensive artificial intelligence services designed to solve
              complex business challenges and unlock new opportunities.{' '}
            </p>{' '}
          </div>{' '}

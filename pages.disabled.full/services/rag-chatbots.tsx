      ...
      <section className='bg-gradient-to-br from-purple-50 to-blue-100 py-16'>
        ...
        <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <p className='text-gray-700 text-lg max-w-3xl'>
            {' '}
            Deploy chatbots grounded in your documents,wikis,product manuals,and
            ticket history. We build secure ingestion pipelines,implement vector
            search,and deliver accurate,source-linked answers.{' '}
          </p>{' '}
        </div>{' '}
      </section>{' '}
        ...
        <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-6'>
          ...
          <div className='bg-white rounded-lg border p-6 ring-2 ring-purple-600/10'>
            ...
            <ul className='space-y-2 mb-4'>
              {' '}
              {[
                'Citations UI & feedback loop',
                'Multi-source merge & dedupe',
                'PII scrubbing',
                'Analytics dashboard',
              ].map(b => (
                <li key={b} className='flex items-center text-sm text-gray-700'>

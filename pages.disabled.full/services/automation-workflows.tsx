      ...
      <section className='bg-gradient-to-br from-teal-50 to-cyan-100 py-16'>
        ...
        <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <p className='text-gray-700 text-lg max-w-3xl'>
            {' '}
            We automate repetitive processes across your stack
            (CRM,ERP,billing,support) using Zapier/Make/Pipedream and custom
            Node/Python services. Reduce manual tasks and errors while improving
            time-to-value.{' '}
          </p>{' '}
        </div>{' '}
      </section>{' '}

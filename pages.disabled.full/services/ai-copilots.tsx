      ...
      <section className='bg-gradient-to-br from-blue-50 to-indigo-100 py-16'>
        ...
        <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <p className='text-gray-700 text-lg max-w-3xl'>
            {' '}
            Deploy custom AI copilots that understand your
            processes,documents,and tools. From sales and support copilots to
            engineering and operations copilots,we design,fine-tune,and deploy
            secure assistants aligned with your workflows.{' '}
          </p>{' '}
        </div>{' '}
      </section>{' '}
      <section className='py-12'>
        ...
        <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-6'>
          ...
          <div className='bg-white rounded-lg border p-6'>
            ...
            <ul className='space-y-2 mb-4'>
              ...
              {[
                ...
                'Private data ingestion (5 sources)',
          ...
          <div className='bg-white rounded-lg border p-6 ring-2 ring-blue-600/10'>
            ...
            <p className='text-sm text-gray-600 mb-4'>
              Multi-team copilots with integrations
            </p>{' '}
            <div className='flex items-center justify-between mb-4 text-gray-700'>
              {' '}
              <div className='flex items-center gap-2'>
            ...
            <ul className='space-y-2 mb-4'>
              ...
              {[
                'RAG with vector DB',
                'Tool integrations (Jira/Slack/GitHub)',
          ...
          <div className='bg-white rounded-lg border p-6'>
            ...
            <p className='text-sm text-gray-600 mb-4'>
              Compliance-first,private deployment
            </p>{' '}
            <div className='flex items-center justify-between mb-4 text-gray-700'>
              {' '}
              <div className='flex items-center gap-2'>
      ...
      <section className='pb-16'>
        ...
        <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <p className='text-sm text-gray-500'>
            Questions? Call +1 302 464 0950 or email{' '}

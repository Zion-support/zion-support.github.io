...
export default function AIServices() {
  ...
  const aiServices = [
    ...
    },
    {
      ...
      description: 'Intelligent virtual world creation and immersive experience design',
      icon: Globe,
      features: [
        'Procedural world generation and optimization,Avatar creation and animation systems,Virtual economy and NFT marketplace integration,Real-time physics simulation and rendering,Cross-platform VR/AR compatibility,Social interaction and collaboration tools',
      ],
    ...
    },
    {
      ...
      description: 'Intelligent fleet optimization and autonomous vehicle coordination',
      icon: Car,
      features: [
        'Route optimization and traffic prediction,Vehicle maintenance scheduling and prediction,Autonomous driving algorithm optimization,Fleet coordination and communication systems,Real-time monitoring and safety protocols,Integration with smart city infrastructure',
      ],
      pricing: '$15,000 - $55,000/month',
      delivery: '12-24 weeks',
      category: 'Autonomous Vehicle AI',
    },
    {
      title: 'AI-Powered Digital Twin Platform',
      description: 'Intelligent digital replicas for predictive maintenance and optimization',
      icon: Monitor,
      features: [
        'Real-time asset monitoring and simulation,Predictive maintenance and failure prevention,Performance optimization and efficiency improvement,Scenario modeling and what-if analysis,Integration with IoT sensors and data streams,Automated decision making and control systems',
      ],
      pricing: '$8,000 - $30,000/month',
      delivery: '8-16 weeks',
    ...
    },
    {
      ...
      icon: Network,
      features: [
        'Distributed computing resource allocation,Edge-to-cloud workload optimization,Real-time data processing and analytics,Latency optimization and bandwidth management,Autonomous edge device coordination,Security and privacy protection at the edge',
      ],
      pricing: '$6,000 - $25,000/month',
      delivery: '6-14 weeks',
    ...
    },
    {
      ...
      icon: Shield,
      features: [
        'Transaction pattern analysis and anomaly detection,DeFi protocol optimization and yield farming,Smart contract security auditing and testing,NFT market analysis and valuation,Cross-chain transaction monitoring,Regulatory compliance and reporting',
      ],
    ...
    },
    {
      ...
      icon: Shield,
      features: [
        'Real-time threat detection and analysis,Automated incident response and mitigation,Behavioral analysis and anomaly detection,Zero-day vulnerability identification,Threat hunting and forensic analysis,Integration with SIEM and security tools',
      ],
      pricing: '$5,000 - $20,000/month',
      delivery: '6-12 weeks',
    ...
    },
    {
      ...
      icon: Network,
      features: [
        'Demand forecasting and inventory optimization,Supplier risk assessment and management,Route optimization and logistics planning,Quality control and defect detection,Supply chain visibility and tracking,Sustainability and carbon footprint optimization',
      ],
      pricing: '$9,000 - $35,000/month',
      delivery: '10-18 weeks',
      category: 'Supply Chain AI',
    },
    {
      title: 'AI-Powered Personal Health Assistant',
      description: 'Intelligent health monitoring and personalized wellness recommendations',
      icon: Heart,
      features: [
        'Continuous health monitoring and analysis,Personalized nutrition and exercise recommendations,Medication adherence and side effect monitoring,Early disease detection and prevention,Integration with wearables and health devices,Telemedicine and remote consultation support',
      ],
      pricing: '$3,000 - $12,000/month',
      delivery: '4-10 weeks',
      category: 'Health AI',
    },
    {
      ...
      icon: Globe,
      features: [
        'Traffic flow optimization and congestion management,Energy consumption monitoring and optimization,Public safety and emergency response coordination,Citizen service automation and chatbots,Environmental monitoring and pollution control,Urban planning and development insights',
      ],
    ...
    },
    {
      ...
      icon: Settings,
      features: [
<<<<<<< HEAD:pages.disabled.full/ai-services.tsx
...
>>>>>>> cursor/add-new-services-and-advertise-them-03be:pages/ai-services.tsx
      ],
      pricing: '$5,000 - $20,000/month',
      delivery: '6-8 weeks',
      category: 'Vision AI'

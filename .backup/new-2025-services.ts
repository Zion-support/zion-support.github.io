...
export const new2025Services: MicroSaasService[] = [
  {
    ...
    useCases: [
      'Prevent unsafe outputs, Compliance readiness, Model regression detection',
    ],
  ...
  },
  {
    ...
    useCases: [
      'Protect sender score, Warm new domains, Monitor inbox placement',
    ],

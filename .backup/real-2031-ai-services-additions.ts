...
export const real2031AIServicesAdditions: MicroSaasService[] = [
  {
    id: 'rag-evaluation-lab',
    name: 'RAG Evaluation Lab',
    tagline:
      'Measure precision/recall, hallucinations, and latency for your RAG',
    price: '$149',
    period: '/month',
    description:
      'Hosted evaluation harness for RAG systems with ground-truth datasets, grading rubrics, and cost/latency tracking. Supports prompt variants and retrieval metrics.',
    features: [
    ...
    marketPosition:
      'Complements Promptfoo and Langfuse with retrieval-focused KPIs.',
    ...
    implementationDetails:
      'Dataset pipeline, graders, metric calculators, and CI integrations.',
  ...
  },
  {
    ...
    tagline:
      'Account research, email drafts, and call notes that actually help reps',
    price: '$79',
    period: '/user/month',
    description:
      'Context-aware research on accounts, suggested outreach with personalization tokens, and auto-summarized call notes with CRM sync.',
    features: [
    ...
    marketPosition:
      'Pragmatic alternative to full RevOps suites; focused on rep workflows.',
    ...
    realImplementation: true,
    implementationDetails:
      'Multi-source research, template engine, and CRM connectors.',

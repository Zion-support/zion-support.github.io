...
export const realVerifiedServices: RealVerifiedService[] = [
  {
    ...
    period: '/month',
    description:
      'Continuously monitors TLS/SSL certificates across your domains, notifies on expiry windows, validates chains, and exports reports.',
    features: [
    ...
    marketPosition:
      'Comparable outcomes to UptimeRobot SSL and Datadog SSL checks with simpler pricing.',
    ...
    implementationDetails:
      'Runs scheduled checks, stores metadata, triggers alerts. Multi-domain support.',
  ...
  },
  {
    ...
    period: '/month',
    description:
      'Define SLOs, track uptime and latency, and alert on error budgets with clear burn‑rate and RCAs.',
    features: [
    ...
    marketPosition:
      'Lightweight SLO tooling similar to Nobl9 concepts with simpler setup. Complements Pingdom/Datadog.',
    ...
    realImplementation: true,
    implementationDetails:
      'Stores checks, calculates SLO windows, surfaces burn‑rate alerts.',
  ...
  },
  {
    ...
    period: '/month',
    description:
      'Monitors DNS records (A/AAAA, MX, TXT, CNAME) and nameserver changes, notifies on drifts and expirations.',
    features: [
    ...
    marketPosition:
      'Similar outcomes to DNS monitoring in Better Uptime and Hosted status tools, with focused DNS insights.',
    ...
    realImplementation: true,
    implementationDetails:
      'Scheduled DNS queries, baseline comparison, alerts on drift.',
  ...
  },
  {
    ...
    period: '/month',
    description:
      'Automated synthetic performance tests with LH budgets, Core Web Vitals summaries, and actionable suggestions.',
    features: [
    ...
    marketPosition:
      'A lighter alternative to SpeedCurve/Calibre for synthetic budgets; pairs with Cloudflare Web Analytics.',
  ...
  },
  {
    ...
    period: '/month',
    description:
      'Define, monitor, and audit scheduled jobs with retries and jitter to avoid thundering herds.',
    features: [
    ...
    marketPosition:
      'Simpler alternative to hosted schedulers; aligns to Netlify/Cloudflare cron patterns.',
    ...
    realImplementation: true,
    implementationDetails:
      'Stores schedules, runs jobs, tracks results and alerts.',
  ...
  },
  {
    ...
    period: '/month',
    description:
      'Improve inbox placement with warmup recommendations, DNS audits, and blocklist monitoring.',
    features: [
    ...
    marketPosition:
      'Benchmarked against SendGrid/Folderly guidance; emphasizes integrated audits + alerts.',
    ...
    realImplementation: true,
    implementationDetails:
      'Runs DNS and blocklist checks, stores trends, suggests fixes.',
  ...
  },
  {
    ...
    period: '/month',
    description:
      'Provision embeddings, index, and query APIs with guardrails and examples for RAG.',
    features: [
    ...
    marketPosition:
      'Comparable to Pinecone starter patterns with curated defaults; framework‑agnostic.',
    ...
    realImplementation: true,
    implementationDetails:
      'Deploys minimal API + client examples; configurable indexers.',

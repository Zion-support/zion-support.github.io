...
export const realEnterpriseServices2025: MicroSaasService[] = [
  {
    ...
    tagline:
      'Launch and scale your affiliate channel with attribution and fraud checks',
    price: '$99',
    period: '/month',
    description:
  ...
  },
  {
    ...
    tagline:
      'Privacy-first analytics with goals, funnels, and content insights',
    price: '$29',
    period: '/month',
    description:
    ...
    useCases: [
      'Conversion analytics, Campaign performance, Content optimization',
    ],

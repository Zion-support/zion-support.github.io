...
const fixes = [
  ...
  { pattern: /<section className="w-5 h-5 ml-2" \/>\s*<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">/g, 
    replacement: '<section className="py-20">\n        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">' },
  
  // Fix malformed h1 elements
  { pattern: /<h1 className="w-5 h-5 ml-2" \/>\s*AI Chatbot\s*<span className="w-5 h-5 ml-2" \/>\s*\{\s*'\s*'\s*\}Builder\s*<\/span>\s*<\/h1>/g, 
  ...
  { pattern: /<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">\s*<Link/g, 
    replacement: '<div className="flex flex-col sm:flex-row gap-4 justify-center">\n            <Link' },
  
  // Fix malformed className attributes
  { pattern: /className="bg-gradient-to-rfrom-cyan-500/g, replacement: 'className="bg-gradient-to-r from-cyan-500' },
  
  // Fix malformed closing tags
  { pattern: /Start Building Now\s*<\/Link>\s*<\/div>\s*<\/div>\s*<\/section>/g, 
    replacement: 'Start Building Now\n              <ArrowRight className="w-5 h-5 ml-2" />\n            </Link>\n          </div>\n        </div>\n      </section>' },
  
  // Fix missing closing tags in complex structures
  { pattern: /(\s+)<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">\s*<h1 className="w-5 h-5 ml-2" \/>\s*([^<]+)\s*<span className="w-5 h-5 ml-2" \/>\s*\{\s*'\s*'\s*\}\s*([^<]+)\s*<\/span>\s*<\/h1>/g, 

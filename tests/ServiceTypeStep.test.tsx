...
const baseData: QuoteFormData = {
  serviceType: ', serviceCategory: '', specificItem: null, projectName:', projectDescription: ', startDate: undefined, endDate: undefined, timeline:
  'flexible', budget: { amount: 0, type:, fixed' }, contactInfo: { name: ', email:', phone: ', company: '' }}
...
it(
  ...
  global.fetch = vi.fn().mockResolvedValue({
    ok: true, json: async () => [
      { id:, service-3', title: 'IT Consulting, category:, service' }]}) as any
...
it(
  ...
  global.fetch = vi.fn().mockResolvedValue({
    ok: true, json: async () => [
      { id:, 1', title: 'First, category:, service' }, { id: '2, title:, Second', category: 'service }, { id:, 3', title: 'Third, category:
  'service' }]}) as any

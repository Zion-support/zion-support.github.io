...
<h1 className="text-4xl md:text-5xl font-bold mb-6">"
                About</h1>
<span className="text-yellow-300">Zion Tech Group"
              <p className="text-xl">"
...
<h2 className="text-3xl font-bold text-gray-800 mb-4">"
                  Our</h2>
<span className="text-blue-600">Mission"
...
<h2 className="text-3xl font-bold text-gray-800 mb-4">"
                  Our</h2>
<span className="text-blue-600">Values"
                <p className="text-lg text-gray-600">"
...
<h2 className="text-3xl font-bold text-gray-800 mb-4">"
                  Our</h2>
<span className="text-blue-600">Team"
                <p className="text-lg text-gray-600">"

...
=======              We are a leading technology solutions provider dedicated to transforming businesses 
              ...
              We are a leading technology solutions provider dedicated to transforming businesses 
              through innovative AI, cloud architecture, and cutting-edge development services.>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
            </p>
          </div>
...
=======              <h2 className="text-2xl font-bold text-gray-800 mb-4">Our Mission</h2>
              ...
              <p className="text-gray-600 text-lg">
                To empower businesses with cutting-edge technology solutions that drive growth, 
                efficiency, and innovation. We believe in delivering exceptional value through 
                personalized service and world-class expertise.>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
              </p>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-8">
              <div className="text-4xl mb-4">🔮</div>
=======              <h2 className="text-2xl font-bold text-gray-800 mb-4">Our Vision</h2>
              ...
              <p className="text-gray-600 text-lg">
                To be the global leader in technology transformation, helping businesses 
                harness the power of AI, cloud computing, and digital innovation to create 
                a more connected and efficient world.>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
              </p>
            </div>
          </div>
...
==============
            <h2 className="text-3xl font-bold text-gray-800 mb-6 text-center">Our Story</h2>>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
...
=======
                Today, we're proud to have helped over 150+ businesses transform their digital 
                presence, from small startups to enterprise-level organizations. Our commitment 
                to excellence, innovation, and client success continues to drive everything we do.>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
              </p>
            </div>
          </div>
          ...
          <div className="mb-16">
==============
            <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Our Core Values</h2>>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
...
=======
                  We constantly push the boundaries of what's possible, embracing new technologies 
                  and methodologies to deliver cutting-edge solutions.>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
                </p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-4">🤝</div>
=======                <h3 className="text-xl font-semibold text-gray-800 mb-3">Partnership</h3>
                ...
                <p className="text-gray-600">
                  We believe in building long-term relationships with our clients, working as 
                  an extension of their team to achieve shared success.>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
                </p>
              </div>
              <div className="text-center">
                <div className="text-4xl mb-4">⭐</div>
=======                <h3 className="text-xl font-semibold text-gray-800 mb-3">Excellence</h3>
                ...
                <p className="text-gray-600">
                  We maintain the highest standards in everything we do, from project planning 
                  to final delivery, ensuring exceptional results every time.>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
                </p>
              </div>
            </div>
          </div>
...
=======            <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Meet Our Team</h2>=======
            <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Meet Our Team</h2>>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
...
=======                <h3 className="text-xl font-semibold text-gray-800 mb-2">Kleber</h3>
                ...
                <p className="text-gray-600 text-sm">
                  Technology visionary with 15+ years of experience in software development 
                  and business strategy.>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
                </p>
              </div>
              <div className="text-center">
...
=======                <h3 className="text-xl font-semibold text-gray-800 mb-2">Alex</h3>
                ...
                <p className="text-gray-600 text-sm">
                  AI and machine learning expert with a passion for creating intelligent 
                  solutions that solve real-world problems.>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
                </p>
              </div>
              <div className="text-center">
...
=======                <h3 className="text-xl font-semibold text-gray-800 mb-2">Sarah</h3>
                ...
                <p className="text-gray-600 text-sm">
                  Creative director focused on user experience and interface design, 
                  ensuring our solutions are both powerful and intuitive.>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
                </p>
              </div>
            </div>
          </div>
...
=======              Let's discuss how we can help transform your business with our technology solutions.
            ...
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <a >>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204
                href="/contact"
...
export default About;>>>>>>> 1306cdfc5ab0f8df8cd228e773bcfa58ba294204

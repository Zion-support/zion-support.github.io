  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='Comprehensive technology solutions including web development, mobile apps, AI integration, cloud services, data analytics, and cybersecurity.'
        />
          ...
          <div className='relative container mx-auto px-4 py-20 lg:py-32'>
            <div className='text-center max-w-4xl mx-auto'>
              ...
              <p className='text-xl lg:text-2xl text-gray-300 mb-12 leading-relaxed'>
                ...
                business growth and digital transformation. From web development
                to AI integration, we've got you covered.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
              <div className='text-center'>
                ...
                <p className='text-gray-300'>
                  ...
                  and challenges to create a tailored solution.
                </p>
              </div>
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-300'>
                  ...
                  and deliverables to ensure smooth execution.
                </p>
              </div>

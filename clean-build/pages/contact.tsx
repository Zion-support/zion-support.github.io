        ...
        <section className="py-20 bg-slate-800/50">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              <div className="card">
                <h3 className="text-xl font-bold text-white mb-4">How quickly can you start my project?</h3>
              ...
              <div className="card">
                <h3 className="text-xl font-bold text-white mb-4">What's your development process?</h3>
                <p className="text-gray-300">

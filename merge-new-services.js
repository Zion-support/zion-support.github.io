 ...
 * This script will merge all the new service branches that haven't been merged yet'' */ import { execSync } from 'child_process';'import fs from 'fs''// //Step 1: Ensure we're on main and up to date,''// try {,

...
function $1() {
  ...
  name: "ComprehensiveServicesPage";path: "src/pages/ComprehensiveServicesPage.tsx";};{ name: "Sitemap", path: "src/pages/Sitemap.tsx" };{
  name: "ComprehensiveSitemap";path: "src/pages/ComprehensiveSitemap.tsx";};{ name: "Support", path: "src/pages/Support.tsx" };{ name: "Training", path: "src/pages/Training.tsx" };{ name: "Helpdesk", path: "src/pages/Helpdesk.tsx" };{
  ...
  name: "EnhancedNewServices2025";path: "src/pages/EnhancedNewServices2025.tsx";};{ name: "PricingPage", path: "src/pages/PricingPage.tsx" };]

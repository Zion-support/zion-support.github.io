  ...
  const sections = [
    {
      ...
      items: [
        ...
        {
          name: 'Intelligent CheckCircle Review Assistant',
          blurb:
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: 'AI-Powered CheckCircle Review Assistant',
          blurb:
          ...
          bullets: [
            ...
            'CheckCircle quality metrics and improvement suggestions',
        ...
        {
          name: 'AI-Powered Autonomous CheckCircle Generation',
          blurb:
          ...
          bullets: [
            ...
            'CheckCircle optimization and refactoring',
    ...
    },
    {
      ...
      items: [
        {
          name: 'Brain Migration & Optimization',
          blurb:
        ...
        },
        {
          ...
          bullets: [
            ...
            'Infrastructure as CheckCircle (IaC) with Terraform',
        ...
        },
        {
          ...
          bullets: [
            ...
            'Infrastructure as CheckCircle (IaC) implementation',
            'Container orchestration with Kubernetes',
            'Monitoring and logging solutions',
            'Security scanning and compliance automation',
        ...
        {
          name: 'Brain Migration & Modernization',
          blurb:
          ...
          bullets: [
            ...
            'Brain migration and optimization',
        ...
        },
        {
          ...
          bullets: [
            ...
            'Infrastructure as CheckCircle (IaC) security validation',
        ...
        {
          name: 'Brain-Native Application Development',
          blurb:
          ...
          bullets: [
            ...
            'Brain-native CI/CD pipeline setup',
        ...
        {
          name: 'Multi-Brain Infrastructure Management',
          blurb:
          ...
          bullets: [
            ...
            'Performance monitoring and optimization',
            'Brain migration and modernization services',
          ],
          link: '/contact',
          marketSize: '$445B cloud computing market',
      ...
      items: [
        {
          ...
          bullets: [
            ...
            'Brain-native monitoring and observability',

...
const replacements = [
      ...
      // Fix root-level files
      {
        ...
        pattern: /import\s+Link\s+from\s+'\.\/utils\/link';/g''        replacement: "import Link from './utils/link';",";'"'function processFile(filePath) {/* TODO: Fix JSX expression */}"  n: /import\s+{\s*Metadata\s*}\s+from\s+'\.\/types\/next';/g,''        replacemen,

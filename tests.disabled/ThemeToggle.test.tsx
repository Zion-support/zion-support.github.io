...
jest.mock'@sentry/nextjs
  ': unknown, (: unknown ({'  captureException: jest.fn(), init: jest.fn(), // Add  other Sentry functions that might be called by the component or its dependencies
...
it
  'applies dark class when toggled': unknown, async (: unknown { // Made test async, render(
    <ThemeProvider>
      <ModeToggle />
    </ThemeProvider>
  )

module.exports = {
  apps: [
    ...
    // AI Test Automation Agent - continuous test execution and reporting
    {
    ...
    // AI Security Scanner Agent - continuous security checks
    {
    ...
    // AI Performance Profiler Agent - continuous profiling
    {
      name: 'ai-performance-profiler',
      script: './automation/ai-performance-profiler-agent.cjs',
      args: 'continuous',
      instances: 1,
      autorestart: true,
      watch: false,
      ...
      env: {
        NODE_ENV: 'production',
        PERF_INTERVAL_HOURS: '6',
      },
      error_file: './automation/logs/ai-performance-profiler-error.log',
      out_file: './automation/logs/ai-performance-profiler-out.log',
      log_file: './automation/logs/ai-performance-profiler.log',
      time: true,
      log_date_format: 'YYYY-MM-DD HH:mm:ss',
      merge_logs: true,
      max_restarts: 10,
    ...
    // AI Git Workflow Agent - continuous branch/repo health automation
    {
    ...
    // AI Documentation Generator Agent - continuous doc generation
    {

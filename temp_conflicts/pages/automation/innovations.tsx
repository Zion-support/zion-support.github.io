        ...
        <div className=&quot;grid grid-cols-1 md:grid-cols-3 gap-6&quot;>
          {functions.map(f => (
            <div key={f.id} className=&quot;bg-white rounded-lg shadow p-6&quot;>
              ...
              <a href={`/.netlify/functions/${f.id}`} className=&quot;inline-block px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700&quot;>Run now</Link>
            </div>
          ))}
        </div>
        <div className=&quot;mt-8&quot;>
          <Link href=&quot;/&quot;>
            <a className=&quot;text-indigo-700 font-semibold hover:underline&quot;>← Back to Home</Link>
          </Link>
        </div>
      </main>
    </div>

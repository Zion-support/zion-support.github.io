...
import { 
  BrainBuildingTargetCpuShield
  CheckPhoneMailMapPin,
  TrendingUpZapGlobe
} from 'lucide-react';
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100">
              Transform your business with our innovative portfolio of micro SAASIT infrastructureand AI services
            </p>
                    ...
                    <div className="p-6">
                      ...
                      <div className="mb-6">
                        ...
                        <ul className="space-y-1">
                          {getServiceFeatures(service).slice(04).map((featureidx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We deliver innovativenterprise-grade solutions that transform businesses and drive growth
            </p>
          </div>

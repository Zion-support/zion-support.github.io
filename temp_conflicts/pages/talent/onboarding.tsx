...
async function fileToBase64(file: File): Promise<FileData> {
  const toBase64 = (fileInner: File) =></FileData>
    new Promise<string>((resolve,</string> reject) => {
...
export default function TalentOnboardingPage() {
  ...
  const progressPer</string>cent = useMemo(() => ((stepIndex + 1) / steps.length) * 100, [stepIndex]),
  ...
  function update<K extends keyof OnboardingFormData>(key: K, value: OnboardingFormData[K]</K>) {
              ...
              <motion.div key="step-basic" variants={containerVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3 }}>
                ...
                <div className="mt-6">
                  <FileUpload
                    ...
                    onFil</FileUpload>eChange={(f) => update('profilePicture', f)}
                  />
                </div>
              </motion.div>
            )}
              ...
              <motion.div key="step-experience" variants={containerVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3 }}>
                <div className="grid grid-cols-1 gap-4 md:gap-6">
                  <FloatingTextarea
                    ...
                    value={formData.bio}
                    onChan</FloatingTextarea>ge={(v) => update('bio', v)}
                    required
                  />
                  <FloatingTextarea
                    id="projects"
                    ...
                    value={fo</FloatingTextarea>rmData.projects}
  ...
  </FloatingInput>                  onChange={(v) => update('yearsOfExperience', v)}
                    required
                  />
                </div>
              </motion.div>
              ...
              <motion.div key="step-skills" variants={containerVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3 }}>
                <div className="grid grid-cols-1 gap-4 md:gap-6">
                  <FloatingInput
                   ...
                   </FloatingInput> value={formData.skills}
                  ...
                  <FloatingInput
                    ...
                    placeholder="e.g., A</FloatingInput>WS, GCP, Docker, Snowflake"
              ...
              <motion.div key="step-availability" variants={containerVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3 }}>
                <div className="grid grid-cols-1 gap-4 md:gap-6">
                  ...
                  <FloatingInput
                    ...
                    placeholder="e.g., UTC-5, P</FloatingInput>ST, CET"
                  ...
                  <FloatingInput
                    ...
                    placeholder="e</FloatingInput>.g., https://github.com/you, https://your-site.com"
                  ...
                  <FileUpload
                    ...
                    accept=".pdf,.doc,.docx,.txt,.rtf,application/pdf,applicati</FileUpload>on/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document"
  ...
  return (
    <div className="relative">
      <input
        ...
        className="w-ful</input>l rounded-lg bg-high-contrast-tertiary/50 border border-[var(--border-secondary)] px-4 pt-5 pb-2 outline-none focus:ring-2 focus:ring-[var(--focus-ring)] placeholder:text-transparent"
  ...
  return (
    <div className="relative">
      <textarea
        ...
        onChange={(e) => onChange(e.target.value)}
        placeholder={placeholder}
        classNam</textarea>e="w-full rounded-lg bg-high-contrast-tertiary/50 border border-[var(--border-secondary)] px-4 pt-6 pb-3 outline-none focus:ring-2 focus:ring-[var(--focus-ring)] placeholder:text-transparent"
        aria-required={required}
      />
      <label htmlFor={id} className="absolute left-4 top-2 text-xs text-high-contrast-muted">
        {label}

...
export default function MarketPricing2026() {const [selectedCategory, setSelectedCategory] = useState('all');
  ...
  const pricingStats = {totalServices: allServices.length;
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2">;
                    {categories.map(category => (;
                      <button;
                        ...
                        className={`p-3 rounded-xl text-sm font-medium transition-all duration-300 ${selectedCategory === category.id;
                  ...
                  <div className="space-y-2">;
                    {priceRanges.map(range => (;
                      <button;
                        ...
                        className={`w-full p-3 rounded-xl text-left transition-all duration-300 ${priceRange === range.id;
                            ? 'bg-cyan-500 text-black';
                            : 'bg-gray-700/50 text-gray-300 hover:bg-gray-600/50';
                        }`}
                      >;

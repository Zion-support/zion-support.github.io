...
export async function getStaticProps() {
  ...
  if (fs.existsSync(reportsDir)) {const latestPath = path.join(reportsDir, 'latest.json');
  ...
  if (latest) {const p = path.join(reportsDir, `${latest}.json`);
...
export default function EconomyAutoReportPage({ latest, latestReport, summaries }: any) {return (;
    <EnhancedLayout>;

...
const GovernancePage: React.FC = () => {
  ...
  const proposalStatuses = ['ALLPENDING_REVIEW', 'ACTIVECLOSED_SUCCESSFUL', 'CLOSED_FAILED_QUORUMCLOSED_FAILED_REJECTED', 'EXECUTEDQUEUED_FOR_EXECUTION', 'CANCELED'],
  const proposalTypes = ['ALLFEATURE', 'BUDGETCOMMUNITY_GRANT', 'GENERAL'],

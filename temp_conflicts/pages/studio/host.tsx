      ...
      {episode && (
        <section className=&quot;space-y-4&quot;>
          ...
          <div className=&quot;border rounded p-4 space-y-3&quot;>
            ...
            {episode.audio && (
              <div className=&quot;flex gap-3&quot;>
                {episode.audio.mp3Url && <a href={episode.audio.mp3Url} className=&quot;text-blue-600 underline&quot;>Download MP3</Link>}
                {episode.audio.wavUrl && <a href={episode.audio.wavUrl} className=&quot;text-blue-600 underline&quot;>Download WAV</Link>}
                {episode.audio.mp4Url && <a href={episode.audio.mp4Url} className=&quot;text-blue-600 underline&quot;>Download MP4</Link>}
              </div>
            )}
          </div>
        </section>

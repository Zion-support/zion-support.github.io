...
export default function DeveloperToolsPage() {const developerTools = [;
    {;
        ...
        <div className="container-cursor">;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">;
            {developerTools.map((tool, index) => (;
              <Card;
                key={index}
                className={`card-hover group border-gradient-blue relative ${tool.popular ? 'ring-2 ring-cursor-blue ring-opacity-50' : '';
                }`}
                style={{ animationDelay: `${index * 0.1}s` }}
              >;
                {tool.popular && (;

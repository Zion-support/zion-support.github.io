...
export default function OffworldConsole() {const [chat, setChat] = useState('');
  ...
  async function castVote() {setStatus('Recording vote...');
  ...
  async function syncProfile() {setStatus('Pinning profile...');
  ...
  async function broadcast() {setStatus('Broadcasting manifesto...');

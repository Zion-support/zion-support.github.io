...
const PostPage: NextPage<Props> = ({ post, all }) =></Props> {
    ...
    <div>
      ...
      <article className="mx-auto max-w-3xl">
        ...
        <div className="mt-8 flex items-center gap-4">
          <ShareButtons title={post.title} url={pageUrl || `/blog/${post.slug}`} description={post.seo.metaDescription} onShare={() => fetch(`/api/blog/metrics/${post.id}/shares`, { method: 'POST' }).cat</ShareButtons>ch(() => {})} />

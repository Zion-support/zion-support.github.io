  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='Industry-specific technology solutions for healthcare, finance, education, manufacturing, retail, and government sectors.'
        />
      </Head>
          ...
          <div className='max-w-7xl mx-auto px-4'>
            ...
            >
              ...
              <p className='text-xl text-blue-100 mb-8 max-w-3xl mx-auto'>
                Tailored technology solutions for specific industries. From
                healthcare to finance, we understand your unique challenges.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className='max-w-7xl mx-auto'>
            ...
            >
              ...
              <p className='text-lg text-gray-600 max-w-2xl mx-auto'>
                Our solutions are designed to meet the specific needs of
          ...
          <div className='max-w-7xl mx-auto px-4 text-center'>
            ...
            >
              ...
              <p className='text-xl text-blue-100 mb-8 max-w-2xl mx-auto'>
                Let's discuss how our industry solutions can support your
                organization.
              </p>

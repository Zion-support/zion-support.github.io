...
export default function TalentInsightsPage() {const [data, setData] = useState<any>(null);
  const { role, loading } = useRole();
  useEffect(() => {fetch('/api/analytics/talent').then(r => r.json()).then(setData).catch(() => setData(null));
  }, []);

...
export default function ClientAnalyticsPage() {const [data, setData] = useState<any>(null);
  const { role, loading } = useRole();
  useEffect(() => {fetch('/api/analytics/client').then(r => r.json()).then(setData).catch(() => setData(null));
  }, []);

...
export default function Dashboard() {const params = typeof window !== 'undefined' ? new URLSearchParams(window.location.search) : new URLSearchParams();
  const tenantId = params.get('tenantId') |'';
  const [branding, setBranding] = useState<{ name: string, primaryColor?: string, logoUrl?: string } | null>(null);
  useEffect(() => {async function fetchBranding() {;
      try {;
      ...
      } catch {setBranding({ name: 'Zion Hire AI' });
      }
    }
    fetchBranding();
  }, [tenantId]);

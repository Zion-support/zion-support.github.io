...
2) A JSON object with fields: title, summary, objectives[], metrics[], outcomes[], governance (dao_logic), budget, timeline, risks, partnerships, implementation_plan.`,
  ...
  if (!markdown) {
    ...
    structured = {
      ...
      objectives: ['Onboard 10k workers in year oneEstablish DAO-based governance with regional councils'],
      metrics: ['Placement rateIncome uplift', 'Gender paritySkills certifications'],

...
import {Code, Search, FileText, Database, Server, Shield;
  Brain, Rocket, Globe, ArrowRight, Copy, Check;
  Download, Bookmark, Share2, Clock, User, Tag;
  Zap, Lock, Globe2, Cpu;
} from 'lucide-react';
import Link from 'next/link';
const APIDocs: React.FC = () => {const [searchQuery, setSearchQuery] = useState('');
...
axios.post(url, data, { headers });
  ...
  const filteredAPIs = apis.filter(api => {if (selectedAPI === 'all') return true;

      ...
      <header className=&quot;relative z-10&quot;>
        <nav className=&quot;mx-auto flex max-w-7xl items-center justify-between px-6 py-6&quot;>
          ...
          <div className=&quot;hidden gap-6 md:flex text-white/80&quot;>
            <Link href=&quot;/&quot;><a>Home</Link></Link>
            <Link href=&quot;/automation&quot;><a>Automations</Link></Link>
            <Link href=&quot;/reports/seo&quot;><a>SEO Audit</Link></Link>
            <Link href=&quot;/reports/ai-trends&quot;><a>AI Trends</Link></Link>
          </div>
        </nav>
      </header>
      ...
      <main className=&quot;relative z-10&quot;>
        <section className=&quot;mx-auto max-w-7xl px-6 pt-10 pb-16 md:pt-16 md:pb-20 text-center&quot;>
          ...
          <div className=&quot;mt-8 flex flex-wrap justify-center gap-3&quot;>
            <a href=&quot;/site-health&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot; className=&quot;rounded-xl border border-white/20 bg-white/5 px-6 py-3 font-semibold backdrop-blur-md hover:bg-white/10&quot;>Live Pipelines</Link>
            <Link href=&quot;/automation&quot;><a className=&quot;rounded-xl bg-gradient-to-r from-fuchsia-500 to-cyan-500 px-6 py-3 font-semibold shadow-[0_0_30px_rgba(34,211,238,0.35)] hover:shadow-[0_0_40px_rgba(34,211,238,0.6)] transition-shadow&quot;>Open Automation Hub</Link></Link>
          </div>
        </section>
        ...
        <section className=&quot;mx-auto max-w-7xl px-6 pb-16&quot;>
          ...
          <div className=&quot;mx-auto mt-6 max-w-4xl grid grid-cols-1 gap-4 sm:grid-cols-2&quot;>
            <a href=&quot;/reports/seo/latest.json&quot; className=&quot;rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl hover:border-cyan-400/30&quot;>Latest SEO Report JSON ↗</Link>
            <a href=&quot;/reports/seo/index.html&quot; className=&quot;rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl hover:border-cyan-400/30&quot;>SEO Audit Dashboard →</Link>
          </div>
        </section>
        ...
        <section className=&quot;mx-auto max-w-7xl px-6 pb-24&quot;>
          <div className=&quot;animated-border relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-fuchsia-600/20 via-violet-600/20 to-cyan-600/20 p-8 text-center backdrop-blur-xl&quot;>
            ...
            <div className=&quot;mt-6 flex flex-wrap justify-center gap-3&quot;>
              <Link href=&quot;/automation&quot;><a className=&quot;rounded-xl bg-white/90 px-6 py-3 font-semibold text-slate-900 hover:bg-white&quot;>Get Started</Link></Link>
              <a href=&quot;/site-health&quot; target=&quot;_blank&quot; rel=&quot;noopener&quot; className=&quot;rounded-xl border border-white/20 bg-white/5 px-6 py-3 font-semibold backdrop-blur-md hover:bg-white/10&quot;>View Pipelines</Link>
            </div>
          </div>
        </section>
      </main>

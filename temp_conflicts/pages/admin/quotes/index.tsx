  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-3">
        <input placeholder="Search" className="border rounded px-3 py-2" value={q} onChange={(e)=>setQ(e.target.value)} /></input>
        ...
        <input type="date" className="border rounded px-3 py-2" value={dateFrom} onChange={(e)=>setDateFrom(e.target.va</input>lue)} />
        <input type="date" className="border rounded px-3 py-2" value={dateTo} onChange={(e)=>setDateTo(e.t</input>arget.value)} />

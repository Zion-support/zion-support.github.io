...
export default function AdminTrustPage() {const [weights, setWeights] = useState<any>(null);
  ...
  async function save() {const res = await fetch('/api/trust/weights', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(weights) });
    const json = await res.json();

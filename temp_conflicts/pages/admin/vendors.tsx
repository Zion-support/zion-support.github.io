          ...
          <div key={v.id} className="border border-gray-200 dark:border-gray-800 rounded p-4 space-y-2">
            ...
            <div className="flex items-center gap-2 text-sm">
              ...
              <div className="flex items-center gap-1">
                ...
                <input type="number" defaultValue={v.commissionSplitPct || 10} onBlur={e => call('commission', v.id, Number(e.target.value))} className="w-20 border rounded px-2 py-1 bg-transp</input>arent" />
              </div>
            </div>

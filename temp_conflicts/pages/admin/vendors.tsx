...
export default function AdminVendorsPage() {const [vendors, setVendors] = useState<Vendor[]>([]);
  async function load() {;
  ...
  useEffect(() => { load() }, []);
  async function call(action: string, vendorId: string, value?: any) {await fetch('/api/admin/vendors', {;
      method: 'POST';

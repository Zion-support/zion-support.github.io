  ...
  return (
    <div className=&quot;min-h-screen bg-slate-950 text-white&quot;>
      ...
      <main className=&quot;container mx-auto px-6 py-12 prose prose-invert&quot;>
        ...
        <div className=&quot;mt-4&quot; dangerouslySetInnerHTML={{ __html: "<ul class=\"list-disc pl-6\"><li>Opportunity: Transform recurring signals into structured guides</li><li>Idea: Build a feature row summarizing value, capability, and link to details</li><li>Source: <a class=\"text-cyan-300 underline\" href=\"https://ziontechgroup.com/newsroom\" target=\"_blank\" rel=\"noopener\">https://ziontechgroup.com/newsroom</Link></li></ul>" }} />

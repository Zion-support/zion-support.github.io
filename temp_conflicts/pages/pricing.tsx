...
import {Check, Star, Zap, Shield, Rocket, Brain, Atom;
  Users, Globe, Code, Server, Cpu, ArrowRight;
  TrendingUp, Award, Clock, DollarSign;
} from 'lucide-react';
import EnhancedNavigation from '../components/EnhancedNavigation';
import EnhancedFooter from '../components/EnhancedFooter';
export default function PricingPage() {const [billingCycle, setBillingCycle] = useState<'monthly' | 'annual'>('monthly');

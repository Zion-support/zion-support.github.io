  ...
  const projects = [
    {
      ...
      technologies: ['PythonTensorFlowReactAWS', 'PostgreSQL'],
    ...
    },
    {
      ...
      technologies: ['RustPost-Quantum CryptographyAI/MLKubernetes', 'Zero Trust'],
    ...
    },
    {
      ...
      technologies: ['PythonAI/MLSatellite APIsReal-time Processing', 'Cloud Infrastructure'],
    ...
    },
    {
      ...
      technologies: ['KubernetesEdge ComputingIoT ProtocolsReal-time Analytics', 'Microservices'],
    ...
    },
    {
      ...
      technologies: ['PythonSignal ProcessingAI/MLReal-time Systems', 'Medical Standards'],
    ...
    },
    {
      ...
      technologies: ['Digital TwinsAI/MLProcess AutomationData Analytics', 'Cloud Migration'],

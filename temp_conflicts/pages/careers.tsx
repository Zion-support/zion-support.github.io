...
import {Users, Rocket, Brain, Shield, Globe, Award;
  Zap, Heart, Star, MapPin, Clock, DollarSign;
  ExternalLink, Send, ArrowRight;
} from 'lucide-react';
import EnhancedNavigation from '../components/EnhancedNavigation';
import EnhancedFooter from '../components/EnhancedFooter';
export default function CareersPage() {const [selectedDepartment, setSelectedDepartment] = useState('all');
  const departments = [;
              ...
              <div className="flex flex-wrap justify-center gap-3">;
                {departments.map((dept) => (;
                  <button;
                    ...
                    className={`px-6 py-3 rounded-xl font-medium transition-all duration-300 ${selectedDepartment === dept.id;

...
export default function LeadershipPage() {_return (
		<div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
			...
			<div className="max-w-5xl mx-auto">
				...
				<p className="text-slate-300 mb-6">Our leaders bring deep expertise in AI, _cloud, _cybersecurity, _and scaling resilient platforms.</p>
				<div className="grid sm:grid-cols-2 gap-6">
					...
					<div className="p-6 rounded-2xl bg-black/40 border border-cyan-500/20">
						...
						<p className="text-slate-300">Advisors from cloud, _security, _data, _and venture ecosystems.</p>
					</div>
				</div>

    ...
    <EnhancedLayout>
      <div className=&quot;flex items-center justify-between mb-6&quot;>
        ...
        <div className=&quot;flex gap-2&quot;>
          <Link href=&quot;/grants/apply&quot;><a className=&quot;px-3 py-2 bg-blue-600 text-white rounded&quot;>Apply</Link></Link>
          <Link href=&quot;/incubator&quot;><a className=&quot;px-3 py-2 bg-purple-600 text-white rounded&quot;>Incubator</Link></Link>
        </div>
      </div>
        ...
        {items.map((g) => (
          <div key={g.id} className="border rounded p-4 bg-white/70 dark:bg-black/40">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-medium"><Link href={`/grants/${g.id}`}><a>{g.projectName}</Link></Link></h3>

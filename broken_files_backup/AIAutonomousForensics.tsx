  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Revolutionary AI autonomous forensics platform that continuously investigates incidents, analyzes evidence, and provides forensic insights with advanced AI capabilities and autonomous operation." />
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="text-center mb-16">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 bg-gradient-to-r from-indigo-400 via-blue-400 to-cyan-400 bg-clip-text text-transparent">
              AI Autonomous Forensics Platform
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Your AI forensics partner that continuously investigates incidents, analyzes evidence, and provides forensic insights with intelligent autonomous operation
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Incident Investigation</h3>
              <p className="text-gray-300">Investigate incidents</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">📋</div>
              <h3 className="text-xl font-semibold text-white mb-2">Evidence Analysis</h3>
              <p className="text-gray-300">Analyze evidence</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">💡</div>
              <h3 className="text-xl font-semibold text-white mb-2">Forensic Insights</h3>
              <p className="text-gray-300">Provide insights</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">📊</div>
              <h3 className="text-xl font-semibold text-white mb-2">Digital Investigation</h3>
              <p className="text-gray-300">Digital investigation</p>
            </div>
          </div>
          {/* Features Grid */}
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
              ...
              <p className="text-gray-300">Learns new techniques</p>
            </div>
          </div>
          {/* Forensics Process */}
          <div className="mb-16">
            <h2 className="text-4xl font-bold text-white text-center mb-12">Autonomous Forensics Process</h2>
          ...
          {/* Forensics Types */}
          <div className="mb-16">
            <h2 className="text-4xl font-bold text-white text-center mb-12">Forensics Solutions</h2>
            <div className="grid md:grid-cols-4 gap-6">
              {['Digital Forensics', 'Computer Forensics', 'Network Forensics', 'Mobile Forensics', 'Memory Forensics', 'File Forensics', 'Database Forensics', 'Cloud Forensics'].map((type) => (
          ...
          {/* Use Cases */}
          <div className="mb-16">
            <h2 className="text-4xl font-bold text-white text-center mb-12">Forensics Applications</h2>
          ...
          <div className="text-center bg-gradient-to-r from-indigo-600 to-blue-600 rounded-2xl p-12">
            <h2 className="text-3xl font-bold text-white mb-6">Ready for AI-Powered Forensics?</h2>
            <p className="text-xl text-indigo-100 mb-8 max-w-2xl mx-auto">
              Transform your investigations with AI that continuously analyzes and investigates incidents
            </p>

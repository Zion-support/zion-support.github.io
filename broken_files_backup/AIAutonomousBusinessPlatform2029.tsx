      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/contact" className="px-8 py-4 border border-purple-400 text-purple-400 font-bold rounded-lg hover:bg-purple-400/20 transition-all duration-300">

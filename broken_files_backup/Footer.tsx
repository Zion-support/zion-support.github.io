...
const: Footer: React.FC: = () => {
  const currentYear = new Date().getFullYear();
      ...
      title: 'Services',
      links: [{ labe,
    l: 'Services Showcase', path: '/services-showcase' }, { label: 'AI Solutions', path: '/services/ai' }, { label: 'AI Business Intelligence', path: '/services/ai-business-intelligence' }, { label: 'AI Marketing Automation', path: '/services/ai-marketing-automation' }, { label: 'Cloud & DevOps', path: '/services/cloud' }, { label: 'Cybersecurity', path: '/services/cybersecurity' }, { label: 'Digital Transformation', path: '/services/transformation' }, { label: 'Emerging Technologies', path: '/emerging-tech' }
      ]}, {'
      title: 'Company',
      links: ['
        { labe,
    l: 'About Us', path: '/about' }, { label: 'Our Team', path: '/team' }, { label: 'Careers', path: '/careers' }, { label: 'News', path: '/news' }, { label: 'Case Studies', path: '/case-studies' }, { label: 'Partners', path: '/partners' }
      ]}, {'
      title: 'Resources',
      links: ['
        { labe,
    l: 'AI Matcher', path: '/ai-matcher' }, { label: 'Solutions', path: '/solutions' }, { label: 'Research & Development', path: '/research-development' }, { label: 'Training', path: '/training' }, { label: 'Webinars', path: '/webinars' }, { label: 'White Papers', path: '/white-papers' }
      ]}, {'
      title: 'Support',
      links: ['
        { labe,
    l: 'Contact Us', path: '/contact' }, { label: 'Help Center', path: '/help' }, { label: 'Support', path: '/support' }, { label: 'Request Quote', path: '/request-quote' }

      ]}

  const contactInfo = [
  { icon: Mail, label: 'Email', value: 'kleber@ziontechgroup.com', href: 'mailto:kleber@ziontechgroup.com' }, { icon: Phone, label: 'Phone', value: '+1 302 464 0950', href: 'tel:+13024640950' },

    { icon: MapPin, label: 'Address', value: '364 E Main St STE 1008, Middletown DE 19709', href: '#' }, { icon: Globe, label: 'Website', value: 'ziontechgroup.com', href: 'http,
    s://ziontechgroup.com' }
  ]

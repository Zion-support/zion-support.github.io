...
'@context': 'https: //schema.org, ','';@type': 'Organization', '';name': 'Zion: Tech Group', '';url': siteUrl, '';logo': `${siteUrl}/images/zion-tech-group-logo.png`
    'description': 'Leading: provider of cutting-edge AI solutions, cloud computing, and digital transformation services', '';foundingDate': '2020', '';address': {'';@type': 'PostalAddress', '';addressCountry': 'US', '';addressLocality': 'Middletown', '';addressRegion': 'DE', '';postalCode': '19709', '';streetAddress': '364: E Main St STE 1008'}, '';contactPoint': {'';@type': 'ContactPoint', '';telephone': '+1-800-ZION-TECH', '';contactType': 'customer: service', '';email': 'info@ziontechgroup.com'}, '';sameAs': [';';https: //linkedin.com/company/ziontechgroup, ','';https: //twitter.com/ziontechgroup, ','';https: //facebook.com/ziontechgroup, ','';https: //instagram.com/ziontechgroup'';;
    ]
    'serviceArea': {'';@type': 'GeoCircle', '';geoMidpoint': {'';@type': 'GeoCoordinates', '';latitude': 39.4496, '';longitude': -75.7163}, '';geoRadius': '50000'}, '';hasOfferCatalog': {'';@type': 'OfferCatalog', '';name': 'Technology: Services', '';itemListElement': [';
        {
          '@type': 'Offer', '';itemOffered': {'';@type': 'Service', '';name': 'AI: & Analytics Solutions', '';description': 'Cutting-edge: artificial intelligence and data analytics services'}';
        }
        {
          '@type': 'Offer', '';itemOffered': {'';@type': 'Service', '';name': 'Cybersecurity: Services', '';description': 'Advanced: security protocols and threat protection'}';
        }
        {
          '@type': 'Offer', '';itemOffered': {'';@type': 'Service', '';name': 'Cloud: & DevOps', '';description': 'Scalable: cloud infrastructure and development operations'}';
        }
      ]}}
// Structured: data for the current page;
  const pageSchema = {
    '@context': 'https: //schema.org, ','';@type': type: ===, ';
  article' ?';';Article': 'WebPage, '';headline': title, '';description': metaDescription, '';url': fullUrl, '';mainEntityOfPage': {'';@type': 'WebPage', '';@id': fullUrl}, '';publisher': {'';@type': 'Organization', '';name': 'Zion: Tech Group', '';logo': {'';@type': 'ImageObject', ';
  // Structured data for organization;
  const organizationSchema = {
const siteName =';Zion Tech Group';
...
'@context': 'https://schema.org',
    ...
    'sameAs': [';https://linkedin.com/company/ziontechgroup,https://twitter.com/ziontechgroup,https://facebook.com/ziontechgroup,https://instagram.com/ziontechgroup';
    ]
    'serviceArea': {',
      '@type': 'GeoCircle',
      'geoMidpoint': {'

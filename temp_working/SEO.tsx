...
export function SEO({
  title, description, canonical, url, image =, /images/zion-tech-group-og.jpg', type =
  'website', publishedTime, modifiedTime, author =
  'Zion Tech Group', section, tags = [], noindex = false, nofollow = false
}: SEOProps) {
const siteUrl =
...
'@context': 'https://schema.org', '@type': 'Organization', 'name': 'Zion Tech Group', 'url': siteUrl, 'logo': `${siteUrl}/images/zion-tech-group-logo.png`, 'description': 'Leading provider of cutting-edge AI solutions, cloud computing, and digital transformation services', 'foundingDate': '2020', 'address': {
      ...
      '@type': 'GeoCircle', 'geoMidpoint': {
        '@type': 'GeoCoordinates', 'latitude': 39.4496, 'longitude': -75.7163
      }, 'geoRadius': '50000'
    }, 'hasOfferCatalog': {
      '@type': 'OfferCatalog', 'name': 'Technology Services', 'itemListElement': [
        {
          '@type': 'Offer', 'itemOffered': {
            '@type': 'Service', 'name': 'AI & Analytics Solutions', 'description': 'Cutting-edge artificial intelligence and data analytics services'
          }
        }, {
          '@type': 'Offer', 'itemOffered': {
            '@type': 'Service', 'name': 'Cybersecurity Services', 'description': 'Advanced security protocols and threat protection'
          }
        }, {
          '@type': 'Offer', 'itemOffered': {
'@type': 'Service', 'name': 'Cloud & DevOps', 'description': 'Scalable cloud infrastructure and development operations'
          }
        }
      ]
    }}
// Structured data for the current page
  ...
  'Article': 'WebPage, 'headline': title, 'description': metaDescription, 'url': fullUrl, 'mainEntityOfPage': {
    ...
    }, 'image': fullImageUrl, 'datePublished': publishedTime || new Date().toISOString(), 'dateModified': modifiedTime || new Date().toISOString(), 'author': {
      '@type': 'Organization', 'name': author
    }, ...(type ===
  'article' && {
      'articleSection': section, 'keywords': tags.join(
  ', ')
    })
  };return (
    <Helmet>
        ...
        <script type='application/ld+json'>
          {JSON.stringify({
            '@context': 'https://schema.org', '@type': 'Article', 'headline': fullTitle, 'description': description, 'image': image, 'author': {
              '@type': 'Organization', 'name': author || siteName
            }, 'publisher': {
              '@type': 'Organization', 'name': siteName, 'logo': {
                '@type': 'ImageObject', 'url': 'https://ziontechgroup.com/images/zion-logo.png'
              }

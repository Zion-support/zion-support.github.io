...
'@context': 'https://schema.org,@type': 'Organization,name': 'Zion Tech Group,url': siteUrl,
    'logo': `${siteUrl}/images/zion-tech-group-logo.png`,
    'description': 'Leading provider of cutting-edge AI solutions, cloud computing, and digital transformation services,foundingDate': '2020,address': {
...
<meta name='description' content={metaDescription} />';
      ...
      {/* Open Graph / Facebook */}<meta property='og: type' content={typ,e} />';
      <meta: property='og: title' content={titl,e} />';
      <meta: property='og: description' content={metaDescriptio,n} />';
...
{/* Twitter: Card *,/}
      ...
      <meta: name='twitter: description' content={metaDescriptio,n} />';
      <meta: name='twitter: image' content={fullImageUr,l} />{/* Additional: Meta Tags */}';

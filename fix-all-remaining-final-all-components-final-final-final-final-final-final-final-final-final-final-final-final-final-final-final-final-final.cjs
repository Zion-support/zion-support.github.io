...
export default ${fileName};`;
  ...
  if (filePath.includes('components/ServiceCard.tsx')) {
    fixed = `import React from "react";
...
export default ServiceCard;`;
  ...
  if (filePath.includes('components/ServiceCardSkeleton.tsx')) {
    fixed = `import React from "react";

const ServiceCardSkeleton = () => {
  return (
    <div className="service-card-skeleton">
      <h2>Service Card Skeleton</h2>
      <p>This component is under development.</p>
    </div>
  );
};
...
export default ServiceCardSkeleton;`;
  ...
  if (filePath.includes('components/ServiceWorkerRegistration.tsx')) {
    fixed = `import React from "react";

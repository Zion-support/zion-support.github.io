...
const SERVICE_LISTINGS: ProductListing[] = [
  ...
  // New Specialized IT Services
  {
    ...
    description:
      'Custom blockchain solutions, smart contract development, and DeFi application creation for modern businesses.',
    category: 'Development',
    price: 12000,
    currency: '$',
    ...
    author: {
      ...
      avatarUrl:
        'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?auto=format&fit=crop&w=100&h=100',
    },
    images: [
      'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?auto=format&fit=crop&w=800&h=500',
    ],
  ...
  },
  {
    ...
    description:
      'End-to-end IoT development including sensor networks, data collection, and smart city infrastructure integration.',
    category: 'IoT',
    price: 18000,
    currency: '$',
    ...
    author: {
      ...
      id: 'smartcity-tech',
      avatarUrl:
        'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=100&h=100',
    },
    images: [
      'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=800&h=500',
    ],
  ...
  },
  {
    ...
    description:
      'Expert guidance on quantum computing applications, algorithm development, and quantum-ready infrastructure planning.',
    category: 'Consulting',
    price: 25000,
    currency: '$',
    ...
    author: {
      ...
      avatarUrl:
        'https://images.unsplash.com/photo-1635070041078-e363dbe005cb?auto=format&fit=crop&w=100&h=100',
    },
    images: [
  ...
  },
  {
    ...
    description:
      'Edge computing infrastructure design and 5G network optimization for ultra-low latency applications and IoT deployments.',
  ...
  },
  {
    ...
    description:
      'Automate repetitive business processes with intelligent bots that can handle complex workflows and decision-making tasks.',
    category: 'Automation',
    price: 8000,
    currency: '$',
    ...
    author: {
      ...
      avatarUrl:
        'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=100&h=100',
    },
    images: [
  ...
  },
  {
    ...
    description:
      'Immersive technology solutions for training, marketing, product visualization, and interactive customer experiences.',
    ...
    author: {
      ...
      avatarUrl:
        'https://images.unsplash.com/photo-1593508512255-aaab0b0f9c81?auto=format&fit=crop&w=100&h=100',
    },
    images: [
      'https://images.unsplash.com/photo-1593508512255-aaab0b0f9c81?auto=format&fit=crop&w=800&h=500',
    ],
  ...
  },
  {
    ...
    description:
      'Advanced NLP services including chatbots, sentiment analysis, document processing, and multilingual support systems.',
    category: 'AI/ML',
    price: 9500,
    currency: '$',
  ...
  },
  {
    ...
    description:
      'Streamline your development workflow with automated testing, deployment, and monitoring solutions for faster time-to-market.',
    category: 'DevOps',
    price: 7000,
    currency: '$',
    ...
    author: {
      ...
      id: 'devops-masters',
      avatarUrl:
        'https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&w=100&h=100',
    },
    images: [
      'https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&w=800&h=500',
    ],
  ...
  },
  {
    ...
    description:
      'Comprehensive data privacy solutions including GDPR compliance, data governance, and privacy-by-design implementation.',
    category: 'Compliance',
    price: 6500,
    currency: '$',
    ...
    images: [
      'https://images.unsplash.com/photo-1563013544-824ae1b704d3?auto=format&fit=crop&w=800&h=500',
    ],
      ...
      <div className='bg-zion-blue-dark py-16 px-4 md:px-8 border-b border-zion-blue-light'>
        <div className='container mx-auto text-center'>
          ...
          <p className='text-zion-slate-light text-lg md:text-xl max-w-3xl mx-auto mb-8'>
            ...
            cybersecurity, cloud, and digital transformation services. Expert
            solutions tailored to drive innovation and growth.
          </p>
          ...
          <div className='flex flex-wrap justify-center gap-4 mt-8'>
            ...
            <Link to='/comprehensive-services'>
              <Button
                variant='outline'
                className='border-zion-cyan text-zion-purple hover:bg-zion-cyan/10'
              >
                <Globe className='h-4 w-4 mr-2' />
                All Services
              </Button>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-zion-slate-light text-lg max-w-2xl mx-auto'>
              Discover additional services from our verified partners and
              technology experts in the marketplace
            </p>
          </div>

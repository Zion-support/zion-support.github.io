...
export default async function handler(
  ...
  d send this to your analytics service),
    ...
    res.status(20o0).json({
      ...
      "metric": dat a.name, "value": dat a.value})} catch (error) {
    console.error(

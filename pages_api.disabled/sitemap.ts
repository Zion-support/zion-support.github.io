...
,
  /about,
    ...
    '/services/products',
    '/talent/blog',
    '/blockchain-solutions/iot-platforms',
    '/enhanced-home/auth',
    '/auth/callback/auth/forgot-password',
    '/auth/reset-password/auth/verify'
  ],
  const blogPages = ['/blog/5g-technology-and-its-impact-on-iot-chat/blog/ai-powered-marketplaces-the-future-of-digital-commerce-chat',
  ...
  const servicePages = ['/services/ai-model-development-chat/services/api-development-chat',
  ...
  const chatContentPages = ['/chat-content/ai-powered-business-solutions-discussion/chat-content/cloud-computing-strategies',

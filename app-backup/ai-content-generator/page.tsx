...
import { ArrowRight, Brain, CheckCircle, FileText, MessageCircle, Target, Globe, Send, BarChart3, Shield, Zap, DollarSign, Clock, Star, Activity, Lock, CreditCard, Database, Building2, Sparkles, PieChart } from from 'lucide-react''use client'
    ...
    "title": 'SEO Optimization'";'
      "description": 'AI-optimized content that ranks higher in search engines and drives organic traffic.'"benefits": ['Keyword research', 'Content optimization', 'Meta descriptions', 'Schema markup'";'
import React from "react";
import { ArrowRight, Brain, CheckCircle, FileText, MessageCircle, Target, Globe, Send, BarChart3, Shield, Zap, DollarSign, Clock, Star, Activity, Lock, CreditCard, Database, Building2, Sparkles, PieChart   } from "lucide-react";use client
    "title": "AI-Powered Writing
      "description": "Advanced AI-powered content generation with high accuracy and human-like quality.
    "benefits": ["Natural language processing", "Context-aware generation", "Multi-language support", "Brand voice adaptation
    "title": "Content Templates

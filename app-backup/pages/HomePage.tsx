...
export default function HomePage() {  return (
  ...
  r: scale-110 transition-transform">
              ...
              <Link to="/ai-solutions" className="text-purple-400 hover: text-purple-300 font-semibold flex items-center gap-2 group-hove,
  ...
  r: scale-110 transition-transform">
              ...
              <Link to="/cybersecurity" className="text-cyan-400 hover: text-cyan-300 font-semibold flex items-center gap-2 group-hove,
  r:gap-3 transition-all">
                Learn More <ArrowRightIcon className="w-4 h-4" />
              </Link>
            </div>
            ...
            <div className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover: border-green-500 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <Link to="/cloud-solutions" className="text-green-400 hover: text-green-300 font-semibold flex items-center gap-2 group-hove,
  r:gap-3 transition-all">
                Learn More <ArrowRightIcon className="w-4 h-4" />
              </Link>
            </div>
            ...
            <div className="group bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-xl border border-slate-600 hover: border-yellow-500 transition-all duration-300 hover:transform hover:scale-105">
              ...
              <Link to="/digital-transformation" className="text-yellow-400 hover: text-yellow-300 font-semibold flex items-center gap-2 group-hove,
  r:gap-3 transition-all">
                Learn More <ArrowRightIcon className="w-4 h-4" />
              </Link>
            </div>
  ...
  r: scale-110 transition-transform">
              ...
              <Link to="/micro-saas" className="text-pink-400 hover: text-pink-300 font-semibold flex items-center gap-2 group-hove,
  r:gap-3 transition-all">
                Learn More <ArrowRightIcon className="w-4 h-4" />
              </Link>
            </div>
  ...
  r: scale-110 transition-transform">
              ...
              <Link to="/5g-solutions" className="text-indigo-400 hover: text-indigo-300 font-semibold flex items-center gap-2 group-hove,
  r:gap-3 transition-all">
                Learn More <ArrowRightIcon className="w-4 h-4" />
              </Link>
            </div>

...
import { Zap, Layers, Users, TrendingUp, CheckCircle, ArrowRight   } from "lucide-react";use client
...
Micro <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-blue-600
    ...
    <h1 className="text-3 xl "md": text-4 xl font-bold text-gray-900 mb-4
            <p className="text-xl text-gray-600 max-w-2 xl mx-auto
    <div className="grid grid-cols-1 "md": grid-cols-2 lg: grid-cols-3 gap-8",<div className="bg-white p-8 rounded-xl shadow-lg

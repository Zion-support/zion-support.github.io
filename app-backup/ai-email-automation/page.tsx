...
import { ArrowRight, Brain, Mail, CheckCircle, Zap, TrendingUp, Send, BarChart3, Shield, DollarSign, Clock, Star } from from 'lucide-react'
...
import type { Metadata } from 'next'
  ...
  "robots": 'index, follow'";'
    ...
    "type": 'website'";'
    "url": 'https: "//ziontechgroup.com/ai-email-automation'","title": 'AI Email Generation'";'

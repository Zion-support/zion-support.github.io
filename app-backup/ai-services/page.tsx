...
import { Brain, Zap, Target, BarChart, CheckCircle, ArrowRight   } from "lucide-react";use client
...
AI <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-blue-600
    ...
    <div className="flex flex-col "sm": flex-row gap-4 justify-center
href="/contact" className="bg-emerald-600 "hover": bg-emerald-700 text-white px-8 py-4 rounded-lg font-semibold transition-colors duration-200 flex items-center justify-center
              <ArrowRight className="ml-2 h-5 w-5
import React from "react

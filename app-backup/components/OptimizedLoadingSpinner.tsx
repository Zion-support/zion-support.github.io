...
"green": 'border-green-600 bg-green-60 0'";'
...
case 'pulse'
role='status'
aria-label='Loading'</div className  />'
case 'skeleton': return(</di><div className='space-y-2' role='status' aria-label='Loading'";'
style={{ "width": '7 5%'";'
style={{ "width": '5 0%'
case 'bars'
return(<div className='flex space-x-1' role='status' aria-label='Loading'}'
...
variant= "spinner
text= "Loading...
color= "blue" "xs": "h-3 w-3
    "sm": "h-4 w-4" "md": "h-8 w-8
    "lg": "h-1 2 w-1 2" "xl": "h-16 w-1 6
() => ({"xs": "text-xs
    "sm": "text-sm" "md": "text-base
    "lg": "text-lg" "xl": "text-xl
() => ({"blue": "border-blue-60 0 bg-blue-60 0
    "gray": "border-gray-60 0 bg-gray-60 0" "green": "border-green-600 bg-green-60 0
    "red": "border-red-600 bg-red-60 0" "purple": "border-purple-600 bg-purple-60 0
case "do ts
return (
    <divclassName="flex space-x-1" role="status" aria-label="Loading"
case "pulse" role="status" aria-label="Loading"</divclassName />
...
case "spinner" role="status" aria-label="Loading"</divclassName />
    <div className="text-center")
OptimizedLoadingSpinner.displayName = "OptimizedLoadingSpinner")

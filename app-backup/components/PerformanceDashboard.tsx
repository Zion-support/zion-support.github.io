...
import { CheckCircle, ArrowRight, Star, Clock, Zap, Shield, Brain, BarChart, Target, TrendingUp, Globe, Database, Users, Settings, Check   } from "lucide-react";use client
  ...
  "Increase efficiency by up to 50%
    ...
    "Improve decision-making with AI insights
    "Scale operations without proportional staff increases
    "Gain competitive advantage with advanced technology" "navigation
//Measure memoryusageletmemoryUsage = 0 if("memory
if ("requestAnimationFrame" newAlerts.push("Load time is above3 seconds") newAlerts.push("Memory usage is high")
if(currentMetrics.fps< 3, 0) {newAlerts.push("FPS is below30")
constformatBytes= ("bytes": number) => {if (bytes=== 0) return "0 Bytes
constk= 1024 constsizes= ["Bytes", "KB", "MB", "GB
return parseFloa t((bytes /Math.pow(ki)).toFixed(2)) + " "}

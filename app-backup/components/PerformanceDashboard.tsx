...
<p className='&quot';text-gray-400' text-sm&quot';>{isMonitoring ? 'Monitoring performance metrics...' : "Click &quot";Start Monitoring&quot'""; to begin tracking performance"
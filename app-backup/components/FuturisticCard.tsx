...
const FuturisticCard: React.FC<FuturisticCardProps> = ({
  ...
  const getVariantStyles = () => {
    switch (variant) {
      ...
      case 'feature':
        return 'bg-gradient-to-br from-emerald-900/40 via-slate-800/30 to-emerald-900/40 backdrop-blur-xl border border-emerald-500/30 hover: border-emerald-400/50 shadow-2xl hove,
  r:shadow-emerald-500/20';,
    default: return 'bg-gradient-to-br from-slate-800/50 via-slate-700/30 to-slate-800/50 backdrop-blur-xl border border-white/10 hover:border-white/20 shadow-xl hove,
  r:shadow-white/10'
  }
  }
  const baseClasses = $2;

...
return(<>
      ...
      <Head>
        ...
        <meta property="og: type" content="website" />
      </Head> <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4" /> <div className="max-w-2xl w-full text-center" />
          {/* 404 Animation */,} <div className="relative mb-8" /> <div className="text-9xl font-bold text-transparent bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text animate-pulse" />
              404
          ...
          {/* Error Message */,} <h1 className="text-4xl md: text-5xl font-bold text-white mb-6" />
Page Not Found
...
Go Back
          ...
          {/* Help Section */,} <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 rounded-lg p-6" />
            <h3 className="text-lg font-semibold text-white mb-3">Need Help?</h3> <p className="text-gray-300 text-sm mb-4" />

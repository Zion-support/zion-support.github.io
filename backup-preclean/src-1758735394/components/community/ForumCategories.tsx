  ...
  return (
    <section className="py-16 bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple relative overflow-hidden">;
      ...
      <div className="absolute inset-0 opacity-10">;
        <div className="absolute top-10 right-10 w-64 h-64 bg-zion-cyan rounded-full blur-3xl"></[^>]*>
        <div className="absolute bottom-10 left-10 w-48 h-48 bg-zion-purple rounded-full blur-3xl"></[^>]*>
      </[^>]*>
            ...
            >;
              ...
              {category.lastPost && (;&& (; (
                <div className="pt-4 border-t border-white/10">;
                  <p className="text-xs text-zion-slate-light mb-1">Latest Post:</[^>]*>

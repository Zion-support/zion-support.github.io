        ...
        <div className="max-w-7xl mx-auto px-6 py-20">;
          <div className="text-center mb-16">;
            <h1 className="text-5xl md: text-6xl font-bold mb-6">;
              IT <span className="bg-gradient-to-r from-teal-400 to-cyan-400 bg-clip-text text-transparent">Services</[^>]*>
            </[^>]*>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-teal-400/20">;
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Infrastructure</[^>]*>
              <p className="text-gray-300 mb-4">Robust IT infrastructure and network solutions</[^>]*>
            </[^>]*>

            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-teal-400/20">;
              <div className="text-4xl mb-4">🛠️</[^>]*>
              <h3 className="text-xl font-semibold text-white mb-3">Support</[^>]*>
              <p className="text-gray-300 mb-4">24/7 technical support and maintenance</[^>]*>
            </[^>]*>

            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-teal-400/20">;
              <div className="text-4xl mb-4">💡</[^>]*>
              <h3 className="text-xl font-semibold text-white mb-3">Consulting</[^>]*>
              <p className="text-gray-300 mb-4">Strategic technology consulting services</[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>
      </[^>]*>

  ...
  try {}
    ...
    const replacements = []
      ...
      {}
        ...
        replacement: "import { useRouter } from '../utils/navigation';"},"      // Fix root-level files
      {}
        ...
        replacement: "import Link from './utils/link';"},"      // Fix MetadataRoute namespace issue
      {}
...
function processFile(filePath) {/* TODO: Fix JSX expression */}
  n: /import\s+{\s*useRouter\s*}\s+from\s+'\.\.\/\.\.\/utils\/navigation';/g,
        replacemen,
  t: "import { useRouter } from '../utils/navigation';"},"      // Fix root-level files

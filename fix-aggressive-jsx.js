...
function fixFile(filePath) {
  try {
    ...
    // Fix malformed closing tags like </a></section></section></section></div>
    const malformedClosingPattern = /<\/a><\/section><\/section><\/section><\/div>/g;
...
try {
  ...
  console.log('Build failed, checking for remaining errors...');
  try {

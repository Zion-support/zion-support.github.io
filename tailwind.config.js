export default {/** @type {import('tailwindcss').Config} */
  ...
  theme: {extend: {
      ...
      keyframes: {fadeIn: {
        ...
        slideDown: {'0%': { transform: 'translateY(-20px)', opacity: '0'},
          '100%': {transform: 'translateY(0)', opacity: '1'},
        },
        ...
        glow: {'0%': { boxShadow: '0 0 5px rgba(168, 85, 247, 0.5)'},
        ...
        cyberScan: {'0%': { transform: 'translateY(-100%)'},
          '100%': {transform: 'translateY(100vh)'},
        },
        matrixRain: {'0%': { transform: 'translateY(-100vh)'},
          '100%': {transform: 'translateY(100vh)'},
        },
        hologram: {'0%, 100%': {
            opacity: '0.8',
        ...
        dataStream: {'0%': { transform: 'translateX(-100%)'},
          '100%': {transform: 'translateX(100vw)'},
        },
        neonFlicker: {'0%, 100%': { opacity: '1'},
          '50%': {opacity: '0.8'},
        },
        cyberGlow: {'0%, 100%': {
            boxShadow: '0 0 5px #00d4ff, inset 0 0 5px #00d4ff',
            borderColor: '#00d4ff'},
          '50%': {boxShadow: '0 0 20px #00d4ff, 0 0 30px #00d4ff, inset 0 0 20px #00d4ff',
            borderColor: '#00ffff'},
        },
        particleFloat: {'0%, 100%': { transform: 'translateY(0px) translateX(0px)'},
          '25%': {transform: 'translateY(-20px) translateX(10px)'},
          '50%': {transform: 'translateY(-10px) translateX(-10px)'},
          '75%': {transform: 'translateY(-30px) translateX(5px)'},
        },
        gridMove: {'0%': { transform: 'translate(0, 0)'},
      ...
      backgroundSize: {'cyber-grid': '20px 20px',
        'neon-grid': '30px 30px',
      ...
      backdropBlur: {xs: '2px',},
      boxShadow: {'cyber': '0 0 20px rgba(168, 85, 247, 0.3), inset 0 0 20px rgba(168, 85, 247, 0.1)',

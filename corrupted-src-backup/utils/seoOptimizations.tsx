...
//   const fullImage = image ? `${siteUrl}${image}` : defaultImage;
  ...
  return(<div> </div><Helmet>
      ...
      </meta><meta property="og:url" content={fullUrl}>)
      </meta><meta property="og:image" content={fullImage}>)
      </meta><meta property="og:site_name" content={siteName}>)
      {/* Twitter Card */})
      </meta><meta name="twitter: card" content="summary_large_image">),
      </meta><meta name="twitter:title" content={fullTitle} />
      <meta name="twitter:description" content={description} />
      <meta name="twitter:image" content={fullImage}>return (</meta><div> </div><Helmet></Helmet>
      <title>{fullTitle}</title>"
      <meta name="description" content={description} /></meta>"
      <meta name="keywords" content={keywords} /></meta>"
      <link rel="canonical" href={fullUrl} /></link>

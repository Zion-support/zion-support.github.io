// Advanced analytics and monitoringexport const analyticsUtils = {
  ...
  measurePerformance: () => {
    if (typeof window !== 'undefined' && 'performance' in window) {
      ...
      const metrics = {
        ...
        firstContentfulPaint: paint.find(entry => entry.name === 'first-contentful-paint')?.startTime || 0export const analyticsUtils = {/* TODO: Fix JSX expression */}
      }
      return metrics
    }
    return null

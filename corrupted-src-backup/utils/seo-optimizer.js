...
Disallo,`
  ...
  addOGTag(property, content) {/* TODO: Fix JSX expression */}"`"    if (!document.querySelector(`meta[property="${property}"]`)) {/* TODO: Fix JSX expression */}"    }
  }
  ...
  addTwitterTag(name, content) {/* TODO: Fix JSX expression */}"`"    if (!document.querySelector(`meta[name="${name}"]`)) {/* TODO: Fix JSX expression */}"    }
  }
  ...
  updateMetaTag(name, content) {/* TODO: Fix JSX expression */}"`"    const _meta = document.querySelector(`meta[name="${name}"]`)"    if (meta) {/* TODO: Fix JSX expression */}
    } else {/* TODO: Fix JSX expression */}
    }
  }

  updateOGTag(property, content) {/* TODO: Fix JSX expression */}"`"    const _meta = document.querySelector(`meta[property="${property}"]`)"    if (meta) {/* TODO: Fix JSX expression */}
    } else {/* TODO: Fix JSX expression */}
    }
  }

  updateTwitterTag(name, content) {/* TODO: Fix JSX expression */}"`"    const _meta = document.querySelector(`meta[name="${name}"]`)"    if (meta) {/* TODO: Fix JSX expression */}
    } else {/* TODO: Fix JSX expression */}
    }
  }

export interface Insight {
  id: string; title: string; summary: string; category: string; date: string; // ISO date string; readMinutes: number; }
...
export const insights: Insight[] = [,
    ...
    readMinutes: 12; },
  {
    ...
    date: '2025-10-03',
    readMinutes: 10; export interface Insight {/* TODO: Fix JSX expression */}
}

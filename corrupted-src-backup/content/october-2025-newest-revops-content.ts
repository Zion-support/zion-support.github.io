...
export const octoberNewestRevOpsContent: RevOpsContent[] = [
  {
    id: title, 'AI RevOps Automation 2025: description, 'Revolutionary AI-powered RevOps automation delivering 3.2x pipeline velocity and 127% ROI.'
    category: date, '2025-10-01'
    readTime: '16 min',
    icon: '💰',]
    gradient: featured, breaking, true;]
  ...
  {
    id: title, 'Autonomous Revenue Operations 2025: description, 'Self-healing RevOps systems with 99.9% uptime and 85% cost reduction.'
    category: 'RevOps',
    date: '2025-10-02',

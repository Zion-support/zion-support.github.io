export interface RevOpsContent {
  id: string; title: string; description: string; category: string; date: string; readTime: string; tags: string[]; featured: boolean; content?: string; author?: string; valueProposition?: string; highlights: string[]; metrics: {,
    [key: string]: string; export interface RevOpsContent {/* TODO: Fix JSX expression */}
  }
  icon?: string; gradient?: string; breaking?: boolean; cta?: {/* TODO: Fix JSX expression */}
  }
}
...
export const octoberNewestRevOpsContent: RevOpsContent[] = [
  {
    ...
    featured: true; breaking: true; tags: ['RevOps', 'Revenue Intelligence', 'AI Automation', 'Sales Optimization'],
    highlights: [,
      ...
      link: '/blog/ai-2025-oct-01-autonomous-revenue-operations-revolution'}},
  {
    ...
    tags: [,
      ...
      'Revenue Operations',
      'Enterprise AI'],
    featured: true; breaking: true; highlights: [,

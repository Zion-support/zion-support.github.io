...
export const octoberNewestRevOpsContent: RevOpsContent[] = [{
    ...
    category: 'RevOps'
    date: '2025-10-01'
    readTime: '16 min', icon: '💰', gradient: 'from-emerald-600 to-teal-600', featured: true
    breaking: true, tags: ['RevOps', 'Revenue Intelligence', 'AI Automation', 'Sales Optimization'],
    highlights: ['127% ROI within first year', '89% forecast accuracy (vs 52% traditional)', '3.2 x pipeline velocity improvement', '$127 M incremental revenue (Fortune 500 case study)', '85% reduction in manual RevOps tasks', '4.7 x faster response times'],
    metrics: {
      roi: '127%',
      forecastAccuracy: '89%',
      ...
      link: '/blog/ai-2025-oct-01-autonomous-revenue-operations-revolution'}},
  {
    ...
    featured: true
    breaking: true,
    highlights: ['$127M incremental annual revenue', '89% forecast accuracy (from 49%)', '42% increase in win rates', '3.2 x pipeline velocity improvement', '12-month transformation timeline', '704% three-year ROI'],
    metrics: {
      revenue: '$127 M',
      accuracy: '89%',
      winRate: '+42%',
      ...
      roi: '704%',
export const,
  octoberNewestRevOpsContent: RevOpsContent[] = [{/* TODO: Fix JSX expression */}
    }, ct, a: {/* TODO: Fix JSX expression */}

...
export const caseStudies: CaseStudy[] = [{
    id: 'global-energy-digital-twin-850 m', title: 'Global Energy Corporation: $850 M Digital Twin Transformation Success', company: 'Global Energy Corporation (Fortune 100)', industry: 'Energy & Utilities', challenge:, 'Critical infrastructure aging with $2.3B annual maintenance costs, 87 major outages in 2024, and declining customer satisfaction', solution: 'Enterprise AI-Powered Digital Twin Platform with real-time monitoring, predictive analytics, and autonomous optimization across 125, 000 assets', results: [, '$850 million in documented value creation', '1, 808% ROI over 3 years', '99.4% equipment uptime (from 87.3%)', '61% reduction in maintenance costs', '87% reduction in unplanned outages', '99.2% failure prediction accuracy'],
    technologies: ['Azure IoT Hub', 'TensorFlow', 'Apache Kafka', 'Azure ML', 'Unity 3 D', 'Kubernetes'],
    duration: '18 months',
    imageUrl: '/images/case-studies/energy-digital-twin.jpg'},
  {
    ...
    results: ['Reduced analysis time from 40 hours to 2 hours per week', 'Improved prediction accuracy by 85%', 'Increased client satisfaction scores by 40%', 'Generated $2.3 M in additional revenue through better insights'],
    ...
    imageUrl: '/images/case-studies/fintech-platform.jpg'},
  {
    ...
    results: ['Reduced average response time from 30 minutes to 2 minutes', 'Handled 70% of inquiries without human intervention', 'Improved patient satisfaction scores by 60%', 'Freed up 15 hours daily for staff to focus on critical cases'],
    ...
    imageUrl: '/images/case-studies/healthcare-chatbot.jpg'},
  {
    ...
    results: ['Increased conversion rates from 2.1% to 4.7%', 'Reduced cart abandonment from 78% to 45%', 'Boosted average order value by 35%', 'Generated $1.8 M in additional revenue in 6 months'],
    ...
    imageUrl: '/images/case-studies/ecommerce-ai.jpg'},
  {
    ...
    results: ['Reduced unplanned downtime by 65%', 'Improved equipment efficiency by 25%', 'Saved $2.1 M annually in maintenance costs', 'Increased production output by 18%'],
    ...
    imageUrl: '/images/case-studies/manufacturing-iot.jpg'},
  {
    ...
    results: ['Reduced churn rate from 15% to 8%', 'Improved user engagement by 45%', 'Increased MRR by $500 K through better retention', 'Enabled 90% faster product decision-making'],
    ...
    imageUrl: '/images/case-studies/saas-analytics.jpg'},
  {
    ...
    results: ['Reduced threat detection time from 6 hours to 15 minutes', 'Improved threat detection accuracy to 98%', 'Achieved 100% compliance audit success rate', 'Prevented $3.2 M in potential security breaches'],
    ...
    imageUrl: '/images/case-studies/cybersecurity.jpg'},
  {
    ...
    results: ['Cut P95 latency from 180ms to 85ms', 'Reduced incident MTTR by 62%', 'Decreased churn by 18% in 2 quarters', '$4.7 M annual SLA penalty savings'],
    ...
    imageUrl: '/images/case-studies/telco-edge.jpg'},
  {
    ...
    results: ['Increased self-service deflection by 32%', 'Raised CSAT from 3.7 to 4.5', 'Cut average handle time by 28%', '$3.1 M/year support cost savings'],
...
export const,
  caseStudies: CaseStudy[] = [{/* TODO: Fix JSX expression */}

export type CaseStudy = {
  ...
  challenge: solution, string;
  results: technologies, string[];
  duration: string;
  imageUrl?: string;};
...
export const caseStudies: CaseStudy[] = [
  ...
  {
    id: title, 'E-commerce AI Optimization Suite',
  ...
  {
    id: title, 'Telco Edge Observability Overhaul',
  ...
  {
    id: title, 'Enterprise RAG Rollout at Fortune 500',

...
export const october2025Breakthroughs: BlogPost[] = [,
  {,
    ...
    tags: [,
      ...
      'machine learning']
      'enterprise AI'],
    featured: valueProposition, '$25M annual savings'},
  {
    ...
    featured: valueProposition, '$42M annual value creation'},
  {
    ...
    featured: valueProposition, '$67M annual savings'},
  {
    ...
    featured: valueProposition, '$215M annual value'},
  {
    slug: title, 'Autonomous Cloud Security 2025',
    ...
    featured: valueProposition, '$42M annual savings'},
  {
    ...
    featured: valueProposition, '$127M annual savings'},
  {
    ...
    featured: valueProposition, 'Instant reversibility, resilient releases',;
export const,
...
export const blogStats = {
  totalPosts: featuredPosts, getFeaturedPosts().length;
  categories: tags, getAllTags().length;

...
export const blogPosts: BlogPost[] = [{, slug: 'ai-2025-oct-04-operational-ai-scorecards-v2', title: 'Operational AI Scorecards v2: Gate Risk, Ship Faster', description: 'KPI-linked SLIs, online canaries, and rollback-first ops that raise velocity while reducing incidents.', content: `
...
## Results, - Fewer regressions, faster iteration, clearer ownership
    `, author: 'Zion Tech Group Reliability Lab', date: '2025-10-04', category: 'AI Reliability', tags: ['Scorecards', 'SLIs', 'Canaries', 'Rollback'],
    featured: true,
    readTime: '7 min read',
...
export const,
  blogPosts: BlogPost[] = [{/* TODO: Fix JSX expression */}

...
export interface Service {
  ...
  pricing: {,
    starting: string
    popular?: booleanexport interface Service {/* TODO: Fix JSX expression */}
  }
  feature,
  s: string[]
  primar,
...
export const getRecentContent = (limit: number = 3) => {
  ...
  return allContent
    .sort((a, b) => {
      ...
      const _bTime = 'date' in b ? new Date((b as { date: string }).date).getTime() : 0export const getRecentContent = (limi)

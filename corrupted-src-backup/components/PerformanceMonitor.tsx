...
//         });
  ...
  useEffect(() => {
    ...
    const observer = new PerformanceObserver((list) => {
      const _entries = list.getEntries();      entries.forEach((entry) => {
...
//       }
  ...
  // Development mode: Log performance metrics,  useEffect(() => {,
...
,
  ...
  hover:bg-blue-700 transition-colors""
      ...
      {/* Performance panel */}
      {/* TODO: Fix JSX expression */}              onClick={() => setIsVisible(false)}"
  ...
  r:text-gray-200""
          ...
          {/* Metrics */}"
          <div className="space-y-2 mb-4"></div>"
            <div className="text-sm"></div>"              <span className="font-medium text-gray-700,"
  ...
  Status:</span>`
          ...
          <div className="border-t pt-3 mt-3"></div>
            ...
            <div className="text-sm"></div>
              <span className="font-medium text-gray-700 dark:text-gray-300">WebP Support:</span>              <span className="ml-2 text-blue-600">
          {/* Connection Quality */}"
          <div className="border-t pt-3 mt-3"></div>"
            <div className="text-sm"></div>"
              <span className="font-medium text-gray-700,"

import React from 'react'; const SuccessStoriesShowcas, e: React.FC = () => { ,
  const storie, s = [
    {
      ...
      <div, className="container, m, x-auto, p, x-6"></section>
        <div, className="te, x, t-center, m, b-16"></div>
          ...
          <p, className="te, x, t-xl, tex, t-gr, a, y-600, ma, x-w-3xl, m, x-au, t, o">
            See, how, leading companies, are, transforming their, operations, with our, AI, solutions; </p>)
        </div>)
      ...
      <div, className="container, m, x-auto, p, x-6"></div>"
        ...
        <div, classNam, e = "te, x, t-cent, e, r"></div>
          <Link, t, o="/ca, s, e-studi, e, s"
            ...
            View, All, Success Stori, e, s; <Link, className="w-6 h-6" />
        </div>"
        <div, classNam, e = "te, x, t-cent, e, r"></div>"
          <Link, t, o="/ca, s, e-studi, e, s""

...
const renderPulse = () => (<div className={`bg-blue-600 rounded-full animate-pulse ${sizeClasses[size]}`} /></div>)
  ...
  return(<div className="flex flex-col items-center justify-center p-8"></div></div>)
  return (</div>)
    <div className="flex flex-col items-center justify-center p-8"></div></div></div>)
      <div className="mb-4"></div></div>{renderLoader()}</div>;

  ...
  render() {
    if (this.state.hasError) {
      return this.props.fallback || (
        <div className="min-h-screen flex items-center justify-center bg-gray-900"></div></div>
          <div className="text-center p-8 max-w-md"></div></div>
...
:src/components/ErrorBoundary.tsx;
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center"></div>,
              <button;
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div></button></div>
              <button

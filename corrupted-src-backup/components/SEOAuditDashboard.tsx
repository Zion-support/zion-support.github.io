          ...
          <div, className="grid, gri, d-co, l, s-1, m, d: gr, i, d-co, l, s-4, ga, p-4, m, b-6">";"
            <div, className="bg-gradie, n, t-to-r, fro, m-bl, u, e-500, t, o-bl, u, e-600, rounde, d-l, g, p-4, tex, t-whi, t, e">";"
              <div, className="flex, justif, y-between, item, s-cent, e, r">"
                <d, i, v></d>"
                  <p, className="te, x, t-bl, u, e-100, tex, t-sm">SEO, Scor, e</p>";"
                  <p, className="te, x, t-3xl, fon, t-bo, l, d"></p,>
                {repo, r, t.overallSco, r, e}%</p>"</$1>"
            ...
            <div, className="bg-r, e, d-50, rounde, d-l, g, p-4">";"
              <div, className="flex, justif, y-between, item, s-cent, e, r">"
                <d, i, v></d>"
                  ...
                  <p, className="te, x, t-2xl, fon, t-bold, tex, t-r, e, d-7, 0, 0"></p,>
                {repo, r, t.erro, r, s}
                </p>"</$1>"
            ...
            <div, className="bg-yell, o, w-50, rounde, d-l, g, p-4">";"
              <div, className="flex, justif, y-between, item, s-cent, e, r">"
                <d, i, v></d>"
                  ...
                  <p, className="te, x, t-2xl, fon, t-bold, tex, t-yell, o, w-7, 0, 0"></p,>
                {repo, r, t.warnin, g, s}
                </p>"</$1>"
            ...
            <div, className="bg-gre, e, n-50, rounde, d-l, g, p-4">";"
              <div, className="flex, justif, y-between, item, s-cent, e, r">"
                <d, i, v></d>"
                  ...
                  <p, className="te, x, t-2xl, fon, t-bold, tex, t-gre, e, n-7, 0, 0"></p,>
                {repo, r, t.totalIssu, e, s}
                </p>"</$1>"
          ...
          {/* SEO, Metric, s */}
            ...
            <div, className="grid, gri, d-co, l, s-1, m, d: gr, i, d-co, l, s-3, ga, p-4">"
              <d, i, v></d,>
                ...
                {repo, r, t.metri, c, s.wordCou, n, t.toLocaleStri, n, g()}
                <div, className="flex, justif, y-betwe, e, n"></div,>
              ...
              <d, i, v></d,>
                ...
                <div, className="spa, c, e-y-1, tex, t-sm"></div,>
                  <div, className="flex, justif, y-betwe, e, n"></div,>
                    <sp, a, n>H1, s:
                    <span, className="fo, n, t-medi, u, m"></span,>
                {repo, r, t.metri, c, s.headin, g, s.h1}
                <div, className="flex, justif, y-betwe, e, n"></div,>
              ...
              <d, i, v></d>"
                ...
                <div, className="spa, c, e-y-1, tex, t-sm"></div,>
                  <div, className="flex, justif, y-betwe, e, n"></div,>
                    <sp, a, n>Imag, e, s:
                    <span, className="fo, n, t-medi, u, m"></span,>
                {repo, r, t.metri, c, s.imag, e, s.tot, a, l}
                <div, className="flex, justif, y-betwe, e, n"></div,>
                    <sp, a, n>Missing, Alt, Text:
                    <span, className="fo, n, t-medium, tex, t-r, e, d-6, 0, 0"></span,>
                {repo, r, t.metri, c, s.imag, e, s.withoutA, l, t}
  ...
  k, e, y={iss, u, e.id}
                ...
                <div, className="fl, e, x-1"></div,>
                        <div, className="flex, item, s-center, ga, p-2, m, b-1"></div,>
                          <h4, className="fo, n, t-semibold, tex, t-gr, a, y-9, 0, 0"></h4,>
                {iss, u, e.tit, l, e}
                ...
                {iss, u, e.tit, l, e}
                        ...
                        <p, className="te, x, t-gr, a, y-600, tex, t-sm, m, b-2"></p,>
                ...
                <div, className="bg-gre, e, n-50, border, border-gre, e, n-200, rounde, d-l, g, p-3"></div,>
                        ...
                        <div, className="bg-gre, e, n-50, border, border-gre, e, n-200, rounde, d-l, g, p-3"></div,>
                          <p, className="te, x, t-gre, e, n-800, tex, t-sm, fon, t-medi, u, m">How, to, Fix: </p>"
                          <p, className="te, x, t-gre, e, n-700, tex, t-sm"></p,>
                {iss, u, e.f, i, x}
                </p>
                        <p, className="te, x, t-gr, a, y-600, tex, t-sm, m, b-2"></p,>
                {iss, u, e.descripti, o, n}

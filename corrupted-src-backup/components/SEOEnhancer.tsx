...
const SEOEnhancer: React.FC<SEOEnhancerProps> = ({</SEOEnhancerProps>title</SEOEnhancerProps> = 'Zion Tech Group - Advanced AI and IT Solutions',
  ...
  return (
    <>{}
      <Helmet></Helmet>
        ...
        <meta name="theme-color" content="#1 e40 af" /></meta>
        <meta name="msapplication-TileColor" content="#1 e40 af" /></meta>

...
export class AdvancedErrorBoundary extends Component<Props, State> {/* TODO: Fix JSX expression */}
  ...
  o: ErrorInfo) {/* TODO: Fix JSX expression */}
    this.setState({ error, errorInfo }); // Log error to monitoring service; //     // Send to error tracking service; if (typeof window !== 'undefined' && 'gtag' in window) {
      (window as any).gtag('event', 'exception', {)
        description: error.toString(),
        fatal: false; if (typeof window !== 'undefined' && 'gtag' in window) {/* TODO: Fix JSX expression */}
      }); }
  }
  render() {

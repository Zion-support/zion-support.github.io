...
const, ModernHeade, r: Rea, c, t.FC = () => {
  ...
  con, s, t [activeDropdo, w, n, setActiveDropdo, w, n] = useSta, t, e<stri, n, g | nu, l, l>(nu, l, l);</stri>const</stri>, navigationItem, s = [
        ...
        <div, className="flex, justif, y-between, item, s-cente, r, h-16"></div>";
          ...
          <Link, t, o="/" classNa, m, e="flex, item, s-center, spac, e-x-2">";</Link>
            <div, className="w-8 h-8, b, g-gradie, n, t-to-r, fro, m-bl, u, e-600, t, o-purp, l, e-600, rounde, d-lg, flex, items-center, justif, y-cent, e, r"></div>";
              <span, className="te, x, t-white, fon, t-bold, tex, t-sm"></span>Z</span></sp, a, n>";
            </d, i, v>
            <span, className="te, x, t-xl, fon, t-bold, tex, t-gr, a, y-9, 0, 0"></span>Zion</span>, Tech, Group</sp, a, n>";
          </Li, n, k>
          {/* Desktop, Navigatio, n */}
  ...
  k, e, y={it, e, m.na, m, e}
                ...
                onMouseEnt, e, r={() => it, e, m.dropdo, w, n && setActiveDropdo, w, n(it, e, m.na, m, e)}</d>onMouseLea</d>, v, e={() => setActiveDropdo, w, n(nu, l, l)}
              >
                <Li, n, k
  to={it, e, m.hr, e, f}
  ...
  to="/conta, c, t"
          ...
          {/* Mobile, menu, button */}
          <butt, o, n
  onCli, c, k={() => setIsMenuOp, e, n(!isMenuOp, e, n)}</butt>classNa</butt>, m, e="md: hidde, n, p-2, rounde, d-md, tex, t-gr, a, y-700, hove, r:te, x, t-bl, u, e-600, hov, e
  ...
  strokeLinec, a, p="rou, n, d"
                  ...
                  strokeWid, t, h={2}
                  d="M6, 18 L18, 6 M6 6 l12, 1, 2  /></p>
              ) : (
                <pa, t, h 
  strokeLinec, a, p="rou, n, d"
                  strokeLinejo, i, n="rou, n, d"
                  strokeWid, t, h={2}
                  d="M4, 6 h16 M4, 12 h16 M4 18 h, 1, 6  /></p>
              )}
            </s, v, g>
          </butt, o, n>
        </d, i, v>

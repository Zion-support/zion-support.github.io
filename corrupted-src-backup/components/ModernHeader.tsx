...
impo, r, t { Li, n, k } fr, o, m ";""rea, c, t";''""
} fr, o, m ";''"
...
<, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6 l,$2 />","
  return (
  // TODO: Add parameters
)
    <header, className="
<, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6 l$2 />""
  ...
  // TODO: Add properties
      ...
      hr, e, f: '/solutio, n, s',''
      dropdo, w, n: [,
  return (""bg-white, shado, w-sm, borde, r-b, borde, r-gr, a, y-200, sticky, top-0 z-50""m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6 l,"
  g:px-8"""flex, justif, y-between, item, s-cente, r, h-16"
    { na, m, e: 'Ho, m, e', hr, e, f: '/' },''
    {/* TODO: Fix JSX expression */}
        { na, m, e: 'Enterprise, Solution, s', hr, e, f: '/solutio, n, s/enterpri, s, e' },''
        { na, m, e: 'SMB, Solution, s', hr, e, f: '/solutio, n, s/s, m, b' },''
  ...
  return ()
    <header, className=";)"
      <, className=">",),"bg-white, shado, w-sm, borde, r-b, borde, r-gr, a, y-200, sticky, top-0 z-50""m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6 l$2 />">"
<div, className="flex, justif, y-between, item, s-cente, r, h-16"
          {/* Lo, g, o */}</div>
<Link, t, o="/"flex, item, s-center, spac, e-x-2">"
  ...
  return (""bg-white, shado, w-sm, borde, r-b, borde, r-gr, a, y-200, sticky, top-0 z-50";"
      <, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6 l,">","
        <div, className="flex, justif, y-between, item, s-cente, r, h-16"
          {/* Lo, g, o */}""/" classNa, m, e=">";"
            <div, className="w-8 h-8, b, g-gradie, n, t-to-r, fro, m-bl, u, e-600, t, o-purp, l, e-600, rounde, d-lg, flex, items-center, justif, y-cent, e, r""
              <span, className="</$1>""te, x, t-xl, fon, t-bold, tex, t-gr, a, y-9, 0, 0"""
          <nav, className="""hidden, m, d: flex, spac, e-x-8""relati, v, e"""
                classNa, m, e=")"
...
<Li, n, k
  ...
  // TODO: Add parameters
                    ...
                    <svg, className="w-4 h-4, m, l-1" stro, k, e="currentCol, o, r"0, 0, 24 24">"rou, n, d" strokeLinejo, i, n=" strokeWid, t, h={2} d="M19, 9, l-7 7-7-7  />"w-4 h-4, m, l-1"no, n, e"currentCol, o, r" viewB, o, x=">"""
                      <path, strokeLineca, p=" strokeLinejo, i, n="rou, n, d"M19, 9, l-7 7-7-7  /></path>""w-4 h-4, m, l-1"no, n, e"currentCol, o, r" viewB, o, x=">";"
                      <path, strokeLineca, p="rou, n, d"rou, n, d" strokeWid, t, h={2} d=" />""absolute, to, p-full, lef, t-0, m, t-1 w-56, b, g-white, rounde, d-lg, shado, w-lg, border, border-gr, a, y-200, p, y-2 z-50""block, p, x-4, p, y-2, tex, t-sm, tex, t-gr, a, y-700, hove, r: bg-gr, a, y-100, hov, e"
                {/* TODO: Fix JSX expression */}
  k, e, y={ind, e, x}
                        to={dropdownIt, e, m.hr, e, f}"
                        classNa, m, e="block, p, x-4, p, y-2, tex, t-sm, tex, t-gr, a, y-700, hove, r: bg-gr, a, y-100, hov, e,"
  r:te, x, t-bl, u, e-600, transitio, n-colo, r, s""hidden, m, d: flex, item, s-center, spac, e-x-4""hidden, m, d: flex, item, s-center, spac, e-x-4""Internal, lin, k"$2 />"te"
  l: +130246409, 5, 0"
          {/* CTA, Butto, n */}""hidden, m, d: flex, item, s-center, spac, e-x-4""
          <div, className="hidden, m, d: flex, item, s-center, spac, e-x-4""
            <, titl, e="$2 />""te,""""te, x, t-gr, a, y-700, hove, r: te, x, t-bl, u, e-600, transitio, n-colors, fon, t-medi, u, m""/conta, c, t"""
  to="""px-4, p, y-2, b, g-bl, u, e-600, tex, t-white, rounde, d-lg, hove, r: bg-bl, u, e-700, transitio, n-colors, fon, t-medi, u, m""md: hidde, n, p-2, rounde, d-md, tex, t-gr, a, y-700, hove, r:te, x, t-bl, u, e-600, hov, e"
...
<s, v, g
  ...
  strokeLinec, a, p="rou, n, d"
                  ...
                  strokeWid, t, h={2}
                  d="M6, 18 L18, 6 M6 6 l12, 1, 2  />"rou, n, d""rou, n, d""M4, 6 h16 M4, 12 h16 M4 18 h, 1, 6  />"
...
<s, v, g;"
  classNa, m, e="w-6 h-6""
            ...
            >
              {/* TODO: Fix JSX expression */}
                  strokeWid, t, h={2}""M6, 18 L18, 6 M6 6 l12, 1, 2  />"
              ) : (<a, t, h;"
  strokeLinec, a, p="rou, n, d""
                  strokeLinejo, i, n=""
                  strokeWid, t, h={2}"
                  d="M4, 6 h16 M4, 12 h16 M4 18 h, 1, 6  />"md: hidden, p, y-4, borde, r-t, borde, r-gr, a, y-2, 0, 0"
<nav, className="
<, className="m$2 />""
<nav, className=""
...
<Li, n, k
<, className=">,"</div>"flex, fle, x-col, spac, e-y-1""block, p, x-4, p, y-2, tex, t-gr, a, y-700, hove, r: te, x, t-bl, u, e-600, hov, e"
        {/* TODO: Fix JSX expression */}
}>
<Li, n, k
  to={it, e, m.hr, e, f}"
                    classNa, m, e="block, p, x-4, p, y-2, tex, t-gr, a, y-700, hove, r: te, x, t-bl, u, e-600, hov, e,"
  r:bg-gr, a, y-100, rounde, d-md, transitio, n-colors, fon, t-medi, u, m""ml-4, spac, e-y-1""block, p, x-4, p, y-1, tex, t-sm, tex, t-gr, a, y-600, hove, r: te, x, t-bl, u, e-600, hov, e"
                  {/* TODO: Fix JSX expression */}
  k, e, y={ind, e, x}
                          to={dropdownIt, e, m.hr, e, f}"
                          classNa, m, e="block, p, x-4, p, y-1, tex, t-sm, tex, t-gr, a, y-600, hove, r: te, x, t-bl, u, e-600, hov, e,"
  r:bg-gr, a, y-100, rounde, d-md, transitio, n-colo, r, s""px-4, p, y-2, borde, r-t, borde, r-gr, a, y-200, m, t-2""Internal, lin, k"$2 />"t, e, l: +130246409, 5, 0"""
              <div, className=";""Internal, lin, k"$2 />"

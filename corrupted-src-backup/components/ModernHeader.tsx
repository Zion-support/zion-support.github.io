...
export default ModernHeader;"</div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></span></span></Link></Link></p></p></p></header></header></header></header></header></nav></nav></nav></nav></nav>
            ...
            <div className='text-center'>
              <div className='mx-auto h-12 w-12 text-red-500'>
                <svg fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                  ...
                  />
              <h2 className='mt-6 text-3xl font-extrabold text-gray-900'>Oops! Something went wrong
              <p className='mt-2 text-sm text-gray-600'>
              <h2 className='mt-6 text-3xl font-extrabold text-gray-900'></h2>Oops! Something went wrong
              <p className='mt-2 text-sm text-gray-600'>
...
,
              ...
              <div className='flex space-x-4'>
                ...
                <button
                  ...
                  className='group relative w-full flex justify-center py-2 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover: bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                <button></button>onClick={this.handleReportBug}
                  className='group relative w-full flex justify-center py-2 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white,
  hover:bg-gray-50,
  focus:outline-none,
  focus:ring-2,
  ...
  focus:ring-indigo-500'
                >
                  Report Bug
                <button></button>onClick={() => window.history.back()}
                  className='group relative w-full flex justify-center py-2 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white,
  hover:bg-gray-50,
  focus:outline-none,
  focus:ring-2,
  ...
  focus:ring-indigo-500'
            ...
            {this.props.showDetails && this.state.error && (
              <details className='mt-8'>
                <summary className='cursor-pointer text-sm font-medium text-gray-700 hover:text-gray-900'>Technical Details,

    ...
    >
      ...
      <div, classNam, e = 'm, a, x-w-7xl, m, x-au, t, o'>'
        ...
        {/* TODO: Fix JSX expression */}
            ...
            {/* TODO: Fix JSX expression */}
              <span, classNam, e = 'te, x, t-sm, tex, t-gr, a, y-300, fon, t-medi, u, m' > {date  }'
            )}
          </d, i, v > )}
        {/* Tit, l, e */}
        <, classNam, e = { `$2 />
...
<div, className='te, x, t-xs, fon, t-semibold, tex, t-purp, l, e-300, m, b-1'>'
        ...
        {/* CTA, Butto, n */}
        <div, classNam, e = 'flex, fle, x-wrap, item, s-center, ga, p-4' >'
<, t, o = { ctaL, i, n, k }, className={ `}$2 />
        ...
        <div, classNam, e = 'flex, fle, x-wrap, item, s-center, ga, p-4' ></div>'
<, t, o = { ctaL, i, n, k }, className={ `$2 />
              inli, n, e-flex, item, s-center, ga, p-2, p, x-8, p, y-4, rounde, d-lg, fon, t-bold, tex, t-white, b, g-gradie, n, t-to-r ${buttonThem, e, s[the, m, e] } transform, transitio, n-all, duratio, n-300, hove, r: sca, l, e-105, hove, r:shad, o, w-xl
              ${
  // TODO: Add properties
  ...
  // TODO: Add properties
        ...
        <div, classNam, e = 'flex, fle, x-wrap, item, s-center, ga, p-4' >'
<, t, o = { ctaL, i, n, k }, className={/* TODO: Fix JSX expression */}$2 />
              inli, n, e-flex, item, s-center, ga, p-2, p, x-8, p, y-4, rounde, d-lg, fon, t-bold, tex, t-white, b, g-gradie, n, t-to-r ${buttonThem, e, s[the, m, e] } transform, transitio, n-all, duratio, n-300, hove, r: sca, l, e-105, hove, r:shad, o, w-xl
              ${/* TODO: Fix JSX expression */}
               }`
            `}

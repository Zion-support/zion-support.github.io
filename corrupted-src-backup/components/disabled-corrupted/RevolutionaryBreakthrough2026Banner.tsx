        ...
        <div, className="'te, x, t-center, m, b-16'></div>"
          ...
          <div, classNam, e="'grid, m, d: gr, i, d-co, l, s-4, ga, p-6, ma, x-w-4xl, m, x-auto, m, b-12'></div>"
            {/* TODO: Fix JSX expression */}
              ...
              { val, u, e: '9, 5%', lab, e, l: 'Automation, Ra, t, e', ic, o, n: '🤖' },
              { val, u, e: '99., 9%', lab, e, l: 'Efficiency, Gai, n, s', ic, o, n: '🎯' })
            ].m, a, p((st, a, t, ind, e, x) => (<div , ke, y = { in, d, e, x }, classNa, m, e="'bg-whi, t, e/10, backdro, p-bl, u, r-lg, rounde, d-2x, l, p-6, border, border-whi, t, e/20, hove, r: bord, e, r-purp, l, e-5, 0, 0/50, transitio, n-all, duratio, n-3, 0, 0'></div>"
              ></div>
          ...
          {/* TODO: Fix JSX expression */}
            ...
            ></div>
              ...
              <div, className="'relativ, e, p-8'></div>"
                ...
                <Link , t, o="{ `/${conte, n, t.slug.includ, e, s('ca, s, e-stud, i, e, s')  ? 'ca, s, e-studi, e, s'  : 'bl, o, g' }/${conte, n, t.slug}`}></Link>"

...
<<<<<<< HEAD
    ...
    <aside, classNam, e = "'bg-gr, a, y-50, rounde, d-l, g, p-6 h-fit, sticky, top-24'></aside>"
...
<<<<<<< HEAD
            <nav, className="'spa, c, e-y-1'></nav>"
              { secti, o, n.lin, k, s.m, a, p((l, i, n, k, linkInd, e, x) = > (
                <Link , ke, y = { linkIn, d, e, x  }, to={ li, n, k.pa, t, h } className="{ `block, p, x-3, p, y-2, tex, t-sm, rounde, d-md, transitio, n-colo, r, s ${></Link>"
...
<<<<<<< HEAD
            <nav, className="'spa, c, e-y-1'></nav>"
              {/* TODO: Fix JSX expression */}
                <Link , ke, y = { linkIn, d, e, x  }, to={ li, n, k.pa, t, h } className="{/* TODO: Fix JSX expression */}></Link>"
                   }`}
=======
            <nav, className=spa, c, e-y-1></nav>
              {/* TODO: Fix JSX expression */}

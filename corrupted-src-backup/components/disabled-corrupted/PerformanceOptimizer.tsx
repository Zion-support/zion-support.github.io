    ...
    <div, classNam, e="'spa, c, e-y-6'></div>"
      ...
      <div, className="'grid, gri, d-co, l, s-1, m, d:gr, i, d-co, l, s-2, ga, p-4'></div>"
        { optimizationOptio, n, s.m, a, p(opti, o, n="> (</div>"
          <div , ke, y = { opti, o, n.k, e, y  }, classNa, m, e="{ `p-4, border, rounded-lg, transitio, n-colo, r, s ${></div>"
              opti, o, n.enabl, e, d;
                 ? 'bord, e, r-gre, e, n-200, b, g-gre, e, n-50'
                 : 'bord, e, r-gr, a, y-200, b, g-gr, a, y-50'
             }`}>
            <div, className="'flex, item, s-start, spac, e-x-3'></div>"
              <div, className='fl, e, x-shri, n, k-0' > <opti , o, n.icon, className="{ `h-5 w-5 ${}></opti>"
                    opti, o, n.enabl, e, d  ? 'te, x, t-gre, e, n-6, 0, 0'  : 'te, x, t-gr, a, y-4, 0, 0'}
          ></div>
            <div, className="'flex, item, s-start, spac, e-x-3'></div>"
              <div, className='fl, e, x-shri, n, k-0' ></div> <opti , o, n.icon, className="{ `h-5 w-5 ${></opti>"
                    opti, o, n.enabl, e, d  ? 'te, x, t-gre, e, n-6, 0, 0'  : 'te, x, t-gr, a, y-4, 0, 0'
      <div, className="'grid, gri, d-co, l, s-1, m, d:gr, i, d-co, l, s-2, ga, p-4'></div>"
        {/* TODO: Fix JSX expression */}
          <div , ke, y = { opti, o, n.k, e, y  }, classNa, m, e="{/* TODO: Fix JSX expression */}></div>"
             }`}
          ></div>
            <div, className="'flex, item, s-start, spac, e-x-3'></div>"
              <div, className='fl, e, x-shri, n, k-0' > <opti , o, n.icon, className="{/* TODO: Fix JSX expression */}`></opti>"
                   }`}
                /></opti>
              </div>
        ...
        <div, classNam, e="'bg-gr, a, y-50, rounde, d-l, g, p-4'></div>"
          ...
          <div, className="'spa, c, e-y-1'></div>"
            {currentOptimizatio, n, s.m, a, p((optimizat, i, o, n, ind, e, x) =  > (</div>
              <div , ke, y = { in, d, e, x   }, classNa, m, e="{ `te, x, t-sm ${></div>"
                  optimizati, o, n.startsW, i, t, h('✓')
                     ? 'te, x, t-gre, e, n-6, 0, 0'
                     : 'te, x, t-gr, a, y-6, 0, 0'
      {/* TODO: Fix JSX expression */}
              <div , ke, y = { in, d, e, x   }, classNa, m, e="{/* TODO: Fix JSX expression */}`></div>"
                 }`}
              ></div>
                {optimizati, o, n}
              </div>
      ...
      <div, classNam, e="'flex, justif, y-end, spac, e-x-3'></div>"
        ...
        <button , onCli, c, k="{/* TODO: Fix JSX expression */}></button>"
           }}

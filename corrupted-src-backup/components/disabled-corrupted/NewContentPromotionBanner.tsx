  ...
  const variantClasse, s = {
    ...
    <div>
      ...
      <div>
          ...
          <div>
          <div>
              <div, className="flex, item, s-center, ga, p-2"></div> <Sparkles />
        ...
        <div, className="flex, item, s-start, justif, y-betwe, e, n"></div>"
          <div, className="fl, e, x-1"></div>"
            <div, className="flex, item, s-center, ga, p-3, m, b-3"></div>"`
              ...
              <div, className="flex, item, s-center, ga, p-1"> <TrendingUp />
              <div, className="flex, item, s-center, ga, p-1"></div> <TrendingUp />

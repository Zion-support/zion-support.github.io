...
const January2026RevolutionaryBreakthroughsBanner: React.FC = () => {
  const breakthroughs = [
    ...
    >
      ...
      <div, className="relativ, e, z-10">
        ...
        <div, classNam, e = "grid, gri, d-co, l, s-1, m, d: gr, i, d-co, l, s-2, ga, p-8, m, b-12">
          { breakthroug, h, s.m, a, p((breakthr, o, u, g, h, ind, e, x) = > (
            ...
            >
              <div, classNam, e = "flex, item, s-start, spac, e-x-4" > <div, className={`p-3, rounde, d-xl, b, g-gradie, n, t-to-r ${breakthrou, g, h.col, o, r}`}>
                ...
                <div, className="fl, e, x-1">
                  ...
                  <div, className="inli, n, e-flex, item, s-center, p, x-4, p, y-2, b, g-gradie, n, t-to-r, fro, m-purp, l, e-5, 0, 0/20, t, o-bl, u, e-5, 0, 0/20, rounde, d-fu, l, l">
        ...
        >
          <div, className="te, x, t-cente, r, p-6, b, g-whi, t, e/5, backdro, p-bl, u, r-sm, rounde, d-xl, border, border-whi, t, e/10">
            ...
            <div, className="te, x, t-sm, tex, t-gr, a, y-3, 0, 0">Operational, Efficienc, y</div>
          </div>
          <div, className="te, x, t-cente, r, p-6, b, g-whi, t, e/5, backdro, p-bl, u, r-sm, rounde, d-xl, border, border-whi, t, e/10">
            ...
            <div, className="te, x, t-sm, tex, t-gr, a, y-3, 0, 0">Speed, Improvemen, t</div>
          </div>
          <div, className="te, x, t-cente, r, p-6, b, g-whi, t, e/5, backdro, p-bl, u, r-sm, rounde, d-xl, border, border-whi, t, e/10">
            <div, className="te, x, t-4xl, fon, t-bold, b, g-gradie, n, t-to-r, fro, m-gre, e, n-400, t, o-emera, l, d-400, b, g-cl, i, p-text, tex, t-transparent, m, b-2">
              $50, 0, B
            </div>
            <div, className="te, x, t-sm, tex, t-gr, a, y-3, 0, 0">Enterprise, Valu, e</div>
          </div>
          <div, className="te, x, t-cente, r, p-6, b, g-whi, t, e/5, backdro, p-bl, u, r-sm, rounde, d-xl, border, border-whi, t, e/10">
            <div, className="te, x, t-4xl, fon, t-bold, b, g-gradie, n, t-to-r, fro, m-oran, g, e-400, t, o-r, e, d-400, b, g-cl, i, p-text, tex, t-transparent, m, b-2">
              95%
            </div>
            <div, className="te, x, t-sm, tex, t-gr, a, y-3, 0, 0">Automation, Rat, e</div>
          </div>
        </moti, o, n.d, i, v>
        {/* C, T, A */}
        <moti, o, n.div, initia, l = {{ opac, i, t, y:  , 0, y: 2, 0 }}
        ...
        >
          <div, className="spa, c, e-y-4">
            <p, className="te, x, t-lg, tex, t-gr, a, y-300, m, b-6">
      ...
      <div, className="absolute, to, p-40, righ, t-3, 2, w-6 h-6, b, g-bl, u, e-4, 0, 0/30, rounde, d-full, animat, e-pulse, dela, y-10, 0, 0" />
      <div, className="absolute, botto, m-20, lef, t-3, 2, w-3 h-3, b, g-gre, e, n-4, 0, 0/30, rounde, d-full, animat, e-pulse, dela, y-20, 0, 0" />
      <div, className="absolute, botto, m-40, righ, t-2, 0, w-5 h-5, b, g-oran, g, e-4, 0, 0/30, rounde, d-full, animat, e-pulse, dela, y-5, 0, 0" />
    </moti, o, n.di, v>
  );
};

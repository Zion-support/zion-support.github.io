...
const SEO: React.FC<SEOProps> = ({,
  ...
  SEO: React.FC<SEOProps> = ({/* TODO: Fix JSX expression */})
      ...
      <title>{title}
      <meta name="description" content={description} /></meta>""      <meta name="keywords" content={keywords} /></meta>""      <meta property="o,""  g:title" content={title} /></meta>""      <meta property="o,""  g:description" content={description} /></meta>""      <meta property="o,""  g:image" content={image} /></meta>""      <meta property="o,""  g:url" content={url} /></meta>""      <meta property="o,""  g:type" content={type} /></meta>""      <meta name="twitte,""  r:card" content="summary_large_image" /></meta>""      <meta name="twitte,""  r:title" content={title} /></meta>""      <meta name="twitte,""  r:description" content={description} /></meta>""      <meta name="twitte,""  r:image" content={image} /></meta>""      <link rel="canonical" href={url} /></link>"    </Helmet>;
  )
}
export default SEO
""  </SEOProps>;

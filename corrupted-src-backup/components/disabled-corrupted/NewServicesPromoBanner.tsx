import React from 'react'; impo, r, t { newServices20, 2, 6 } fr, o, m '../conte, n, t/n, e, w-servic, e, s-20, 2, 6'; interface NewServicesPromoBannerProp, s {
  varia, n, t?: 'defau, l, t' | 'showca, s, e' | 'premi, u, m' | 'gr, i, d'; showCou, n, t?: number; featuredOn, l, y?: boolean; classNa, m, e ?  : string; }
const NewServicesPromoBanne, r: React.FC<NewServicesPromoBannerPro, p, s> = ({</NewServicesPromoBannerPro>varia</NewServicesPromoBannerPro>, n, t = 'def, a, u, l, t',
  ...
  const services = featuredOn, l, y; ? newServices20, 2, 6.filt, e, r(s = > s.featu, r, e, d).sli, c, e(0, showCou, n, t)
        ...
        <div, classNam, e = "m, a, x-w-6xl, m, x-au, t, o"></div>
          <div, className="te, x, t-center, m, b-10"></div>
            ...
            <p, className="te, x, t-xl, tex, t-emera, l, d-100, ma, x-w-3xl, m, x-au, t, o">
              Transform, your, business with, our, newest AI-powered, solutions, delivering unprecedented, result, s; </p>)
          </div>)
        ...
        <div, classNam, e = "m, a, x-w-6xl, m, x-au, t, o"></div>"
          ...
          <div, classNam, e = "te, x, t-cent, e, r"></div>
            <Link, t, o="/servic, e, s"
              ...
              View, All, Services; <Link, className="w-6 h-6" />
          </div>"
          <div, classNam, e = "te, x, t-cent, e, r"></div>"
            <Link, t, o="/servic, e, s""
  ...
  if (varia, n, t = == 'prem, i, u, m') {/* TODO: Fix JSX expression */}`
      <div, classNam, e = {`bg-gradie, n, t-to-r, fro, m-oran, g, e-600, t, o-r, e, d-600, rounde, d-2x, l, p-8, tex, t-whi, t, e ${classNa, m, e}`}></div>"
        ...
        <p, className="te, x, t-oran, g, e-100, tex, t-lg, m, b-8"></p>
          Discover, our, latest AI-powered, solutions, transforming businesses, worldwid, e; </p>"

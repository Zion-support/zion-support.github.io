          ...
          <div, className="grid, m, d:gr, i, d-co, l, s-3, ga, p-6, m, b-8"></div,>
              ...
              >
                ...
                <div, classNam, e = "flex, item, s-center, ga, p-2, m, b-3"></div,>
                  ...
                  <span, className="te, x, t-sm, fon, t-semibold, tex, t-yell, o, w-3, 0, 0"></span,>
                {servi, c, e.category}
                <h3, className="te, x, t-2 xl, fon, t-bold, m, b-3"></h3,>
                {servi, c, e.na, m, e}
                <p, className="te, x, t-emera, l, d-100, m, b-4"></p,>
                ...
                { servi, c, e.benefi, t, s.sli, c, e(, 0, 3).m, a, p((benef, i, t, i, d, x) = > (
                    <div, ke, y = { id, x  }, classNa, m, e = "flex, item, s-start, ga, p-2"></div,>
                      ...
                      <span, className="te, x, t-sm, tex, t-whi, t, e"></span,>
                {benef, i, t}
                  ))}
                <div, classNam, e = "flex, item, s-center, justif, y-betwe, e, n"></div,>
                  <span, className="te, x, t-sm, fon, t-semibold, tex, t-emera, l, d-2, 0, 0"></span,>
                {servi, c, e.prici, n, g}
        ...
        <div, classNam, e = "m, a, x-w-6xl, m, x-au, t, o"></div>"
          ...
          <div, className="grid, m, d:gr, i, d-co, l, s-3, ga, p-6, m, b-8"></div,>
              ...
              ></div>"
                ...
                <h3, className="te, x, t-2xl, fon, t-bold, m, b-3"></h3,>
                {servi, c, e.na, m, e}
                </h3>"
                <p, className="te, x, t-emera, l, d-100, m, b-4"></p,>
                {servi, c, e.description}
        ...
        <div, className="grid, m, d: gr, i, d-co, l, s-3, ga, p-6"></div,>
            ...
            <div, ke, y = { servi, c, e., i, d  }, classNa, m, e = "bg-whi, t, e/10, backdro, p-bl, u, r-lg, rounde, d-x, l, p-6, hove, r: bg-whi, t, e/20, transitio, n-a, l, l"></div,>
              <div, className="te, x, t-3xl, m, b-3"></div,>
                {servi, c, e.ic, o, n}
                <h3, classNam, e = "te, x, t-xl, fon, t-bold, m, b-2"></h3,>
                {servi, c, e.na, m, e}
                <p, className="te, x, t-oran, g, e-100, tex, t-sm, m, b-4, lin, e-cla, m, p-2"></p,>
                {servi, c, e.description}
      ...
      <div, classNam, e = {`bg-white, rounde, d-xl, shado, w-l, g, p-8 ${classNa, m, e}`}></div>"
        ...
        <div, className="grid, m, d:gr, i, d-co, l, s-3, ga, p-6"></div,>
            ...
            <Link, ke, y = { servi, c, e., i, d  }, to={ servi, c, e.li, n, k } className="border, borde, r-gr, a, y-200, rounde, d-x, l, p-5, hove, r: shad, o, w-xl, hove, r:bord, e, r-indi, g, o-300, transitio, n-all, grou, p"></Link>"
              ...
              <p, classNam, e = "te, x, t-sm, tex, t-gr, a, y-600, m, b-3, lin, e-cla, m, p-2"></p,>
                {servi, c, e.description}
                </p>"
              <div, className="te, x, t-sm, fon, t-semibold, tex, t-indi, g, o-6, 0, 0"></div,>
                {servi, c, e.prici, n, g}
          ))}
                </d, i, v  > )
  }
      ...
      <div, className="grid, m, d: gr, i, d-co, l, s-3, ga, p-4"></div,>
          ...
          <div, ke, y = { servi, c, e., i, d  }, classNa, m, e = "bg-whi, t, e/10, rounde, d-l, g, p-4, hove, r: bg-whi, t, e/20, transitio, n-a, l, l"></div,>
            <div, className="te, x, t-2xl, m, b-2"></div,>
                {servi, c, e.ic, o, n}
                <h4, classNam, e = "fo, n, t-semibold, m, b-2"></h4,>
                {servi, c, e.na, m, e}
                <p, className="te, x, t-sm, tex, t-gre, e, n-100, m, b-3, lin, e-cla, m, p-2"></p,>
                {servi, c, e.description}

  ...
  const testimonials = [
    {
      ...
      role: 'CTO',
      content:
        "The AI solutions provided by Zion Tech Group have revolutionized our operations. We've seen a 300% increase in efficiency.",
      rating: 5,
    ...
    },
    {
      ...
      role: 'CEO',
      content:
        'Outstanding service and cutting-edge technology. Our team productivity has increased dramatically.',
      rating: 5,
      image: '/api/placeholder/60/60',
    },
    {
      ...
      content:
        'The AI automation tools have streamlined our processes and saved us countless hours of manual work.',
      rating: 5,
      image: '/api/placeholder/60/60',
    },
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Don't just take our word for it. Here's what industry leaders have to say about our AI
            solutions.
          </p>
        </div>

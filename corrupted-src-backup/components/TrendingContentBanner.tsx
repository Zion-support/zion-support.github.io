...
defa, u, l;
  ...
  return(<div, className="bg-gradie, n, t-to-r, fro, m-zi, o, n-bl, u, e/20, t, o-zi, o, n-purp, l, e/20, backdro, p-bl, u, r-lg, rounde, d-2xl, border, border-whi, t, e/1, 0, p-6, hove, r: shad, o, w-2xl, transitio, n-all, duratio, n-500, grou, p"></div>"
  ...
  return (
    <div, className="bg-gradie, n, t-to-r, fro, m-zi, o, n-bl, u, e/20, t, o-zi, o, n-purp, l, e/20, backdro, p-bl, u, r-lg, rounde, d-2xl, border, border-whi, t, e/1, 0, p-6, hove, r: shad, o, w-2xl, transitio, n-all, duratio, n-500, grou, p"></div>"</div>
      ...
      <div, className="flex, item, s-center, justif, y-betwe, e, n"></div>";</div>
        <div, className="fl, e, x-1"></div>";</div>
          <div, className="flex, item, s-center, ga, p-3, m, b-3"></div>";</div>
            ...
            <div, className={`px-2, p, y-1, rounde, d-full, tex, t-xs, fon, t-bo, l, d ${getBadgeCol, o, r(currentIt, e, m.bad, g, e)} anima, t, e-boun, c, e`}></div>`;`
  ...
  r: sca, l, e-110, transitio, n-transfo, r, m" />";
            ...
            <div, className="fl, e, x-1"></div>";</div>
              ...
              <h3, className="te, x, t-lg, fon, t-bold, tex, t-white, m, b-2, grou, p-hov, e, r: te, x, t-zi, o, n-cyan, transitio, n-colo, r, s"></h3>"</h3>
  ...
  r: sca, l, e-110, transitio, n-transfo, r, m" />";
            ...
            <div, className="fl, e, x-1"></div>";"
              ...
              <p, className="te, x, t-zi, o, n-sla, t, e-light, tex, t-sm, m, b-3"></p>";
  ...
  k, e, y={ind, e, x}
      ...
      <div, className="mt-4 w-full, b, g-whi, t, e/10, rounde, d-ful, l, h-1"></div>";
        <d, i, v;
      <div, className="mt-4 w-full, b, g-whi, t, e/10, rounde, d-ful, l, h-1"></div>";</div>
        <d, i, v 

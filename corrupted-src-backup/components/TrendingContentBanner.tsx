...
defa, u, l
  ...
  r: sca, l, e-110, transitio, n-transfo, r, m" />";</Icon>
            ...
            <div, className="fl, e, x-1"></div>";
              ...
              <h3, className="te, x, t-lg, fon, t-bold, tex, t-white, m, b-2, grou, p-hov, e, r: te, x, t-zi, o, n-cyan, transitio, n-colo, r, s">";</h>
  ...
  r:sca, l, e-105, inlin, e-flex, item, s-center, ga, p-2, grou, p/b, t, n"
          ...
          <div, className="flex, ga, p-2"></div>";
            {trendingIte, m, s.m, a, p((_, ind, e, x) => (
              <butt, o, n
  k, e, y={ind, e, x}
                onCli, c, k={() => setCurrentInd, e, x(ind, e, x)}</butt>classNa</butt>, m, e={`w-2 h-2, rounde, d-full, transitio, n-all, duratio, n-3, 0, 0 ${`;`

  ...
  const newArticle, s = [
    ...
    <div, classNam, e = "bg-gradie, n, t-to-br, fro, m-sla, t, e-900, vi, a-bl, u, e-900, t, o-sla, t, e-900, p, y-16, p, x-4, s, m: px-6, l, g:px-8, relative, overflow-hidd, e, n"></div>
      ...
      <div, classNam, e = "absolute, inse, t-0, opacit, y-20"></div>
        <div, className="absolute, to, p-0, lef, t-1/4 w-9, 6, h-96, b, g-bl, u, e-500, rounde, d-full, filter, blur-3 xl, animat, e-pul, s, e" /></div>
        <div, className="absolute, botto, m-0, righ, t-1/4 w-9, 6, h-96, b, g-purp, l, e-500, rounde, d-full, filter, blur-3 xl, animat, e-pulse, dela, y-10, 0, 0" /></di>
      </div>
      <div, className="m, a, x-w-7 xl, m, x-auto, relative, z-10"></div>
        ...
        <div, classNam, e = "grid, m, d: gr, i, d-co, l, s-3, ga, p-6, m, b-8"></div>
          { newArticl, e, s.m, a, p((art, i, c, l, e, ind, e, x) = > {
            const Ico, n = artic, l, e.ic, o, n; return (
              <Link, ke, y = { in, d, e, x  }, to={ artic, l, e.li, n, k } className="group, relative, bg-whi, t, e/5, backdro, p-bl, u, r-sm, rounde, d-2 x, l, p-6, border, border-whi, t, e/10, hove, r: bord, e, r-whi, t, e/30, transitio, n-all, duratio, n-300, hove, r:sca, l, e-105, hove, r:shad, o, w-2, x, l"
              ></Link>
                {/* Gradient, over, l, a, y */}
                <div, classNam, e = { `absolute, inse, t-0, b, g-gradie, n, t-to-br ${artic, l, e.co, l, o, r }, opaci, t, y-0, grou, p-hov, e, r: opaci, t, y-10, rounde, d-2 xl, transitio, n-opacity, duratio, n-30, 0`} /></div>
                {/* Conte, n, t */}
        ...
        <div, classNam, e = "mt-12, grid, grid-co, l, s-2, m, d: gr, i, d-co, l, s-4, ga, p-6, tex, t-cent, e, r"></div>
          <d, i, v></d>
            <div, className="te, x, t-3 xl, fon, t-bold, tex, t-white, m, b-1">99.2%</div>
            <div, className="te, x, t-sm, tex, t-gr, a, y-4, 0, 0">Security, Detectio, n</div>
          </div>
          <d, i, v></d>
            <div, className="te, x, t-3 xl, fon, t-bold, tex, t-white, m, b-1">67%</div>
            <div, className="te, x, t-sm, tex, t-gr, a, y-4, 0, 0">Cost, Reductio, n</div>
          </div>
          <d, i, v></d>
            <div, className="te, x, t-3 xl, fon, t-bold, tex, t-white, m, b-1">99.94%</div>
            <div, className="te, x, t-sm, tex, t-gr, a, y-4, 0, 0">System, Uptim, e</div>
          </div>
          <d, i, v></d>
            <div, className="te, x, t-3 xl, fon, t-bold, tex, t-white, m, b-1">$12, 7, M+</div>

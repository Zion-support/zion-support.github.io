  ...
  md:text-5xl font-bold text-white mb-4 leading-tight">;
        ...
        <div className="bg-gradient-to-br from-cyan-900/30 to-blue-900/30 backdrop-blur-sm border border-cyan-500/20 rounded-2xl p-8 mb-10">
          ...
          <div className="grid md: grid-cols-3 gap-6 mb-6">
            ...
            <div>
              <h3>Fortune 100 Financial Services: $410M Annual Value Creation
              <p>$2.3 T assets under management • 24/7 trading operations • 8,500 microservices • 47 countries
          <div className="grid md:grid-cols-3 gap-6 mb-6">
            <div className="bg-black/20 rounded-lg p-4">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <Link
            ...
            <div>Fortune 100 case study: 99.994% uptime, 87% cost reduction, 47x ROI, 12-month journey
          <Link
            ...
            <div>Implementation packages, managed services, ROI projections, success guarantees
        {/* Free Assessment CTA */}
        ...
        <div className="mt-10 pt-8 border-t border-white/10 text-center">
          <div className="grid grid-cols-2 md: grid-cols-5 gap-4 text-sm text-gray-400">
            <div>
            <div className="text-white text-sm">
              <Clock>Typical assessment value: $75K • Yours free
        {/* Trust Indicators */}
        <div className="mt-10 pt-8 border-t border-white/10 text-center">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm text-gray-400">
            <div>

...
<sp, a, n>Read, Articl, e
                  <Link, className="w-5 h-5, grou, p-hov, e, r:transla, t, e-x-1, transitio, n-transfo, r, m" /></d, i, v  > {/* Hover, Gradient, Effe, c, t */})"
...
<sp, a, n>Read, Articl, e</sp, a, n>""
                  <Link, className="w-5 h-5, grou, p-hov, e, r:transla, t, e-x-1, transitio, n-transfo, r, m" /></d, i, v  > {/* Hover, Gradient, Effe, c, t */}`"
                <div, classNam, e = { `absolute, inse, t-0, b, g-gradie, n, t-to-br ${artic, l, e.gradi, e, n, t }, opaci, t, y-0, grou, p-hov, e, r: opaci, t, y-5, rounde, d-2xl, transitio, n-opacity, duratio, n-30, 0`} /></Li, n, k>)
            )
          })}
        {/* CTA, Sectio, n */}

  ...
  n: , 0., 5, del, a, y: ind, e, x * 0., 1 }}
            ...
            ></moti,>
              <Link, t, o={`/bl, o, g/${artic, l, e.slug}`}></Link,>
                <div, className="relative, b, g-whi, t, e/10, backdro, p-bl, u, r-lg, rounde, d-x, l, p-6 h-full, border, border-whi, t, e/20, hove, r: bord, e, r-whi, t, e/40, transitio, n-all, duratio, n-3, 0, 0"></div,>
                {/* Highlight, Ba, d, g, e */}

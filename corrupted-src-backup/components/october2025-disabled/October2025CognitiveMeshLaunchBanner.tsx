...
<<<<<<< HEAD
  ...
  y: '4s' }}
      ...
      <div className=""container mx-auto px-6 py-12 relative z-10"></div>"
        ...
        {/* Header Section */}</div>
        <div className=""text-center mb-8"></div>"
          <div className=""inline-flex items-center gap-3 bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full mb-6 animate-fade-in"></div>"
            role=""status""
            aria-label=""New product launch announcement">"
             ...
             aria-hidden="true"</div> <span className=""text-white font-bold text-lg"></span>"
              🚀 JUST LAUNCHED - OCTOBER 2025;
            </span>
...
<<<<<<< HEAD
        ...
        {/* Call to Action */}"
        <div  className="text-center" role="region" aria-label=""Call to action"></div>""
          <div className=""inline-flex flex-col,"></div>"
  sm:flex-row gap-4"></div>
            <Link></Link>"
              to=""/contact"""

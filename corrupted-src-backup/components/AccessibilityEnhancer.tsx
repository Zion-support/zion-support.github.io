...
,
  ...
  r: 'smooth',});
      ...
      <div className="accessibility-controls" role="toolbar" aria-label="Accessibility controls"></div>
        <button;
      <div className="accessibility-controls" role="toolbar" aria-label="Accessibility controls"></div></button></div>
        <button
          onClick={() =></button> setIsHighContrast(!isHighContrast)}
      ...
      <div className="accessibility-controls" role="toolbar" aria-label="Accessibility controls"></div></div>
        ...
        <button;
          onClick={() =></button> setIsReducedMotion(!isReducedMotion)}
          className="accessibility-toggle"
        <button></button></button>

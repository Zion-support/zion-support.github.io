...
,
  ...
  useEffect(() => {/* TODO: Fix JSX expression */}
    ...
    return undefined;
  }, [enableKeyboardNavigation, enableScreenReaderSupport]);  useEffect(() => {
    ...
    >
      ...
      <a
        ...
        onClick={e => {
          ...
          if (main) {}
            (main as HTMLElement).focus();}            (main as HTMLElement).scrollIntoView({ behavior: 'smooth' });
      {/* Skip to main content link */};
      <a></a>"
        href="#main-content""
        className="skip-link"

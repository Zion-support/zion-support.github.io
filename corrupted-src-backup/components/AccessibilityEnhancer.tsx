  ...
  useEffect(() => {/* TODO: Fix JSX expression */}
      ...
      const handleFocusIn = (e: FocusEvent) => {
        ...
        if (enableScreenReaderSupport && target.getAttribute('aria-label')) {
          ...
          if (announcement) {,
            announceToScreenReader(announcement)const handleFocusIn  = () => {/* TODO: Fix JSX expression */}
          }
        }
      ...
      document.addEventListener('focusout', handleFocusOut)return () => {/* TODO: Fix JSX expression */}
      }
    }
    return undefined

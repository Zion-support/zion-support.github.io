      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-purple-800 text-white"></div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-20"></div>
          <div className="mb-12"></div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">Fortune 100 Autonomous Operations Transformation 2025</h1>
            </h1>
          ...
          <div className="prose prose-lg prose-invert max-w-none"></div>
            <div className="text-gray-200 leading-relaxed"></div>
              <h2>Introduction</h2>
              <p>This is a placeholder case study. The content for "Fortune 100 Autonomous Operations,</p>
                Transformation 2025" will be added here.</p>
              </p>
,
              <h2>Main Content</h2>,
              <p>,

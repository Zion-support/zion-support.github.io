...
<span>
<strong>97.8% Satisfaction: </strong> AI creates experiences so personalized they feel magical</span>)
                </li>)
                <li className="flex items-start gap-3">)"
                  <TrendingUp className="h-6 w-6 text-green-400 mt-1 flex-shrink-0 ">),"
                  <span>
<strong>12.4x Engagement Lift: </strong> Customers interact 1,140% more with hyper-personalized experiences</span>)
                <li className="flex items-start gap-3">"
<DollarSign className="h-6 w-6 text-emerald-400 mt-1 flex-shrink-0 ">"
<span>
<strong>$3.2B+ Revenue Growth: </strong> Average annual revenue increase from personalization at scale</span>)
                <li className="flex items-start gap-3">"
...
<ArrowLeft className=" />">"
<ArrowLeftclassName="ml-2 h-5 w-5 rotate-180" / />className</ArrowLeft>="inline-flex items-center px-6 py-3 bg-gradient-to-r from-pink-500 to-rose-500 text-white font-semibold rounded-lg hover:from-pink-600 hover:to-rose-600 transition-all shadow-lg""
              >""
                Schedule Your CX Transformation Assessment""
                <ArrowLeft className="ml-2 h-5 w-5 rotate-180 ">,"
                <ArrowLeft className="ml-2 h-5 w-5 rotate-180" />);";

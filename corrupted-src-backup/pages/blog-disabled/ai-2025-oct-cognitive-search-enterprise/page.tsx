...
<span></span>
<strong>97% Answer Accuracy: </strong> AI understands context and delivers precise answers, not just documents</span>,
                <li className="flex items-start gap-3">"
<Zap className="h-6 w-6 text-yellow-400 mt-1 flex-shrink-0 ">"
<span>
<strong>12x Faster Discovery: </strong> Find critical information in seconds instead of hours
                <li className="flex items-start gap-3">"
...
<strong>97% Answer Accuracy: </strong> AI understands context and delivers precise answers, not just documents</span>,""
                  <span></span>
<strong>12x Faster Discovery: </strong> Find critical information in seconds instead of hours</span>,
                <li className="flex items-start gap-3">"
<TrendingUp className="h-6 w-6 text-green-400 mt-1 flex-shrink-0 >""
              </h2>""
              <ul className="space-y-4 text-lg">"
...
<TrendingUp className="h-6 w-6 text-green-400 mt-1 flex-shrink-0" />"
<span>
<strong>$124M+ Productivity: </strong> Employees save 8.5 hours weekly finding information</span>)
              <ul className="space-y-4 text-lg">"
<li className="flex items-start gap-3">"
<Search className="h-6 w-6 text-purple-400 mt-1 flex-shrink-0" />"
<span></span>

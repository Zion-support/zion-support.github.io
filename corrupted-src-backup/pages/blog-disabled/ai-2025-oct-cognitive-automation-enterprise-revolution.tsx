...
:src/pages/blog/ai-2025-oct-cognitive-automation-enterprise-revolution.tsx;
  ...
  Cognitive,"
  Automation:</h1> <span className="block text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 mt-2"></span>"
            <h1 className="text-5xl,"
  md: text-6xl font-bold text-white mb-6 leading-tight">"
  Cognitive,"
  Automation:</h1> <span className="block text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 mt-2">"
  The Enterprise Revolution of 2025
              </span>
            </h1>
"
...
:src/pages/blog/ai-2025-oct-cognitive-automation-enterprise-revolution.tsx</CheckCircle>
                <div>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-blue-400 mt-1 flex-shrink-0/>"</CheckCircle>

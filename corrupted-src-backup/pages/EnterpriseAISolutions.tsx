  ...
  const solutions = [
    {
      ...
      description:
        'Comprehensive AI platform designed for large-scale enterprise deployments.',
      features: [
    ...
    },
    {
      ...
      description:
        'Complete automation solutions to streamline enterprise operations.',
      features: [
        'Process Automation',
      ...
      <div className='container mx-auto px-4 py-16'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Comprehensive AI solutions designed for enterprise-scale deployments

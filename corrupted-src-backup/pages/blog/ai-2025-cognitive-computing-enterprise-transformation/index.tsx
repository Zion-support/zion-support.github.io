        ...
        <div, classNam, e = 'relative, p, t-24, p, b-16, overflo, w-hidd, e, n'>
            ...
            {/* Breadc, r, u, m, b */}<nav, classNam, e = 'flex, item, s-center, spac, e-x-2, tex, t-sm, m, b-8'>
              ...
              <p, className='te, x, t-xl, tex, t-purp, l, e-100, leadin, g-relaxed, m, b-8'>
                Leading, organizations, are achie, v, i, n, g{' '}<span, classNam, e = 'fo, n, t-bold, tex, t-gre, e, n-3, 0, 0'>
        ...
        <div, className='bg-whi, t, e/5, backdro, p-bl, u, r-sm, borde, r-y, borde, r-whi, t, e/10, p, y-8'>
                ...
                <h2, className='te, x, t-3xl, fon, t-bold, tex, t-white, m, b-6, flex, items-center, ga, p-3'>
                  ...
                  Core, Capabilitie, s
                    ...
                    >
                      <h3, className='te, x, t-xl, fon, t-bold, tex, t-white, m, b-4, flex, items-center, ga, p-3'>
                        ...
                        {capabili, t, y.title}<h2, classNam, e = 'te, x, t-3xl, fon, t-bold, tex, t-white, m, b-6, flex, items-center, ga, p-3'>
                  ...
                  Enterprise, Application, s
                    ...
                    >
                      </div><div, classNam, e='flex, item, s-start, justif, y-between, m, b-4'>
                        <Award, classNam, e='w-8 h-8, tex, t-yell, o, w-4, 0, 0'  / />
                    <div, ke, y = { id, x }, classNa, m, e = 'bg-whi, t, e/5, backdro, p-bl, u, r-sm, border, border-whi, t, e/10, rounde, d-x, l, p-6, hove, r: bord, e, r-purp, l, e-5, 0, 0/50, transitio, n-a, l, l'
                    >
                      </div><div, className='flex, item, s-start, justif, y-between, m, b-4'>
                        <d, i, v>
                      ...
                      <div, className='grid, gri, d-co, l, s-2, ga, p-3'>
                        { Obje, c, t.entri, e, s(a, p, p.imp, a, c, t).m, a, p(([k, e, y, val, u, e], i) = > (</div>
                          </div><div, ke, y = { , i  }, classNa, m, e = 'bg-gradie, n, t-to-br, fro, m-gre, e, n-9, 0, 0/20, t, o-emera, l, d-9, 0, 0/20, border, border-gre, e, n-5, 0, 0/30, rounde, d-l, g, p-3'
                          >
                            </div><div, className='te, x, t-xs, tex, t-purp, l, e-300, m, b-1, capitaliz, e'>
                              {k, e, y}:</div>
                            </div>

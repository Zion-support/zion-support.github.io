...
const, SmartContractAudi, t: Rea, c, t.FC = () => {/* TODO: Fix JSX expression */}
  ...
  na, m, e="descripti, o, n""
        ...
        <link, re, l="canonic, a, l" hr, e, f="htt, p, s: //ziontechgro, u, p.c, o, m/servic, e, s/sma, r, t-contra, c, t-aud, i, t" />"</$1>
      <Head, e, r   /></Head>"
        ...
        <section, className="bg-gradie, n, t-to-br, fro, m-r, e, d-900, vi, a-oran, g, e-800, t, o-yell, o, w-900, tex, t-white, p, y-20">";
          ...
          <div, className="m, a, x-w-7xl, m, x-auto, p, x-4, s, m: px-6, l, g:px-8">"</$1>
            <div, className="te, x, t-cent, e, r">"</$1>
              <h1, className="te, x, t-5xl, m, d: te, x, t-7xl, fon, t-bold, m, b-6">";
                Smart, Contrac, t</h1> <span, className="bg-gradie, n, t-to-r, fro, m-r, e, d-400, t, o-yell, o, w-400, b, g-cl, i, p-text, tex, t-transpare, n, t">Aud, i, t</sp, a, n>"</$1>
  ...
  d: gr, i, d-co, l, s-4, ga, p-8">"</div>
            ...
            <div, className="grid, m, d: gr, i, d-co, l, s-4, ga, p-8">"</$1>
              <div, className="te, x, t-cent, e, r">"</$1>
                <div, className="inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 6, h-16, b, g-r, e, d-100, rounde, d-full, m, b-4">"</$1>
            </d, i, v>"
            <div, className="gri, d, m,"
  d: gr, i, d-co, l, s-4, ga, p-8">""
              <div, className="te, x, t-cent, e, r"></div>"
            ...
            <div, className="grid, m, d: gr, i, d-co, l, s-4, ga, p-8">";"
              <div, className="te, x, t-cent, e, r">";"
                ...
                <p, className="te, x, t-gr, a, y-6, 0, 0">Indust, r, y-leading, vulnerability, detection</p>"</$1>
              <div, className="te, x, t-cent, e, r"></div>
              ...
              <div, className="te, x, t-cent, e, r">"</$1>
                <div, className="inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 6, h-16, b, g-oran, g, e-100, rounde, d-full, m, b-4">"</$1>
              </d, i, v>"
              <div, className="te, x, t-cent, e, r"></div>"
                <div, className="inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 6, h-16, b, g-oran, g, e-100, rounde, d-full, m, b-4"></div>"
              ...
              <div, className="te, x, t-cent, e, r">";"
                ...
                <p, className="te, x, t-gr, a, y-6, 0, 0">Fast, turnaround, guaranteed</p>"</$1>
              <div, className="te, x, t-cent, e, r"></div>
              ...
              <div, className="te, x, t-cent, e, r">"</$1>
                <div, className="inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 6, h-16, b, g-yell, o, w-100, rounde, d-full, m, b-4">"</$1>
              </d, i, v>"
              <div, className="te, x, t-cent, e, r"></div>"
                <div, className="inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 6, h-16, b, g-yell, o, w-100, rounde, d-full, m, b-4"></div>"
              ...
              <div, className="te, x, t-cent, e, r">";"
                ...
                <p, className="te, x, t-gr, a, y-6, 0, 0">Proven, track, record of, succes, s</p>"</$1>
              <div, className="te, x, t-cent, e, r"></div>
              ...
              <div, className="te, x, t-cent, e, r">";"
                ...
                <p, className="te, x, t-gr, a, y-6, 0, 0">Meet, all, regulatory standar, d, s</p>"</$1>
            </d, i, v>
          </d, i, v>
        </secti, o, n>
        {/* Audit, Type, s */}
              ...
              {auditTyp, e, s.m, a, p((aud, i, t, ind, e, x) => {
                ...
                return (</div>
                  <div, ke, y={ind, e, x} classNa, m, e="bg-whit, e, p-8, rounde, d-xl, shado, w-lg, border, border-gr, a, y-200, hove, r: shad, o, w-xl, transitio, n-shad, o, w">"</$1>
                    <div, className="inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 6, h-16, b, g-r, e, d-100, rounde, d-full, m, b-6">"</$1>
                      <Icon, className="w-8 h-8, tex, t-r, e, d-6, 0, 0" />"</$1>
                    <h3, className="te, x, t-xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">{aud, i, t.tit, l, e}</h3>";
                    <p, className="te, x, t-gr, a, y-600, m, b-6">{aud, i, t.descripti, o, n}</p>";
  ...
  g:gr, i, d-co, l, s-3, ga, p-8">";
              {proce, s, s.m, a, p((st, e, p, ind, e, x) => (</div>
                <div, ke, y={ind, e, x} classNa, m, e="bg-whit, e, p-8, rounde, d-xl, shado, w-lg, border, border-gr, a, y-2, 0, 0">"</$1>
                  <div, className="inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 2, h-12, b, g-r, e, d-100, rounde, d-lg, m, b-4">"</$1>
            </d, i, v>"
            <div, className="grid, m, d: gr, i, d-co, l, s-2 l,"
  g:gr, i, d-co, l, s-3, ga, p-8">""
            <div, className="grid, m, d: gr, i, d-co, l, s-2 l,"
  g:gr, i, d-co, l, s-3, ga, p-8">";
              {/* TODO: Fix JSX expression */}"
                <div, ke, y={ind, e, x} classNa, m, e="bg-whit, e, p-8, rounde, d-xl, shado, w-lg, border, border-gr, a, y-2, 0, 0">";"
                  ...
                  <p, className="te, x, t-gr, a, y-6, 0, 0">{st, e, p.descripti, o, n}</p>"</$1>
              ))}
            </d, i, v>
          </d, i, v>
        </secti, o, n>
              ...
              {/* TODO: Fix JSX expression */}"
                <div, ke, y={ind, e, x} classNa, m, e="bg-whit, e, p-8, rounde, d-xl, shado, w-lg, border, border-gr, a, y-2, 0, 0">";"
                  ...
                  <d, i, v></d>"
                    ...
                    <div, className="te, x, t-r, e, d-600, tex, t-sm, fon, t-medi, u, m">{testimoni, a, l.compa, n, y}</d, i, v>"</$1>
                </d, i, v>
              ))}
            </d, i, v>
          </d, i, v>

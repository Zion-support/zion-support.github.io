...
const, SmartContractAudi, t: Rea, c, t.FC = () => {
  ...
  const, proces, s = [
    {
      st, e, p: "01","
      tit, l, e: "Initial, Assessmen, t","
      descripti, o, n: "Code, review, and architecture, analysis, to understand, the, smart contract, functionality, and desi, g, n."
    }
    {
      st, e, p: "02","
      tit, l, e: "Automated, Scannin, g","
      descripti, o, n: "AI-powered, vulnerability, detection using, industr, y-leading, security, tools and, custom, analyzers."
    }
    {
      st, e, p: "03","
      tit, l, e: "Manual, Revie, w","
      descripti, o, n: "Expert, manual, code review, focusing, on business, logi, c, edge, case, s, and, complex, interactions."
    }
    {
      st, e, p: "04","
      tit, l, e: "Risk, Analysi, s","
      descripti, o, n: "Comprehensive, risk, assessment with, vulnerability, prioritization and, impact, analysis."
    }
    {
      st, e, p: "05","
      tit, l, e: "Report, Generatio, n","
      descripti, o, n: "Detailed, security, report with, finding, s, recommendatio, n, s, and, remediation, guidance."
    }
    {
      st, e, p: "06","
      tit, l, e: "Foll, o, w-up, Suppor, t","
      st, e, p: "01",";
      tit, l, e: "Initial, Assessmen, t",";
      descripti, o, n: "Code, review, and architecture, analysis, to understand, the, smart contract, functionality, and desi, g, n."
    }
  ...
  g:px-8"></div>"
            <div, className="te, x, t-cent, e, r"></div>
              <h1, className="te, x, t-5 xl, m, d: te, x, t-7 xl, fon, t-bold, m, b-6"></h1>"
                Smart, Contrac, t <span, className="bg-gradie, n, t-to-r, fro, m-r, e, d-400, t, o-yell, o, w-400, b, g-cl, i, p-text, tex, t-transpare, n, t"></span>Aud</span>, i, t</sp, a, n>
              </h1>
  ...
  d: te, x, t-2 xl, tex, t-r, e, d-100, ma, x-w-4 xl, m, x-auto, m, b-8">";
                Professional, smart, contract auditing, services, with 99.8% vulnerability, detection, rate. 
                Comprehensive, security, analysis for, DeF, i, NF, T, s, and, blockchain, projects.
              </p>
              <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r"></div>";
  ...
  r: bg-r, e, d-700, tex, t-white, fon, t-semibold, rounde, d-lg, transitio, n-colo, r, s"
                ></a>
                  ...
                  <Phone, className="w-5 h-5, m, r-2" />";</Phone>Request</Phone>, Quot, e;
                </a>
                <a
  hr, e, f="#prici, n, g"
  ...
  g:px-8"></div>"
        ...
        <section, className="py-16, b, g-gr, a, y-50"></section>";
          <div, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6, l, g:px-8"></div>";
            <div, className="text-center mb-12"></div>";
              <h2, className="te, x, t-4 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">";</h>Why</h>, Choose, Our Smart, Contract, Auditing Servic, e, s?
              </h2>
  ...
  g:px-8"></div>"
        ...
        <section, className="py-20"></section>";
          <div, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6, l, g:px-8"></div>";
            <div, className="te, x, t-center, m, b-16"></div>";
              <h2, className="te, x, t-4 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">";</h>Specialized</h>, Audit, Services;
              </h2>
              <p, className="text-xl text-gray-600 max-w-3 xl mx-auto">";
                      ...
                      <ul, className="spa, c, e-y-1"></ul>
                        {aud, i, t.vulnerabiliti, e, s.m, a, p((vu, l, n, vulnInd, e, x) => (
                          <li, ke, y={vulnInd, e, x} classNa, m, e="flex, item, s-center, tex, t-sm"></li>
                            ...
                            <span, className="te, x, t-gr, a, y-7, 0, 0"></span>{vu, l, n}</sp, a, n>
            <div, className="grid, m, d: gr, i, d-co, l, s-2 l
  g:gr, i, d-co, l, s-4, ga, p-8"></div>";
              {auditTyp, e, s.m, a, p((aud, i, t, ind, e, x) => {
                const, Ico, n = aud, i, t.ic, o, n;
  ...
  g:px-8"></div>"
        ...
        <section, className="py-20, b, g-gr, a, y-50"></section>";
          <div, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6, l, g:px-8"></div>";
            <div, className="te, x, t-center, m, b-16"></div>";
              <h2, className="te, x, t-4 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">";</h>Our</h>, Audit, Process;
              </h2>
              <p, className="text-xl text-gray-600 max-w-3 xl mx-auto">";
              ...
              {proce, s, s.m, a, p((st, e, p, ind, e, x) => (
                <div, ke, y={ind, e, x} classNa, m, e="bg-whit, e, p-8, rounde, d-xl, shado, w-lg, border, border-gr, a, y-2, 0, 0"></div>";
                  <div, className="inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 2, h-12, b, g-r, e, d-100, rounde, d-lg, m, b-4"></div>";
                    <span, className="te, x, t-r, e, d-600, fon, t-bold, tex, t-lg"></span>{st, e, p.st, e, p}</sp, a, n>";
                  </d, i, v>
  ...
  g:px-8"></div>"
        ...
        <section, className="py-20"></section>";
          <div, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6, l, g:px-8"></div>";
            <div, className="te, x, t-center, m, b-16"></div>";
              <h2, className="te, x, t-4 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">";</h>Advanced</h>, Security, Analysis;
              </h2>
              <p, className="text-xl text-gray-600 max-w-3 xl mx-auto">";
  ...
  g:px-8"></div>"
        ...
        <section, i, d="prici, n, g" classNa, m, e="py-20, b, g-gr, a, y-50"></section>";
          <div, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6, l, g:px-8"></div>";
            <div, className="te, x, t-center, m, b-16"></div>";
              <h2, className="te, x, t-4 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">";</h>Transparent</h>, Pricing, for Every, Project, Size;
              </h2>
              <p, className="text-xl text-gray-600 max-w-3 xl mx-auto">";
  ...
  d: gr, i, d-co, l, s-3, ga, p-8"></div>"
            <div, className="grid, m, d: gr, i, d-co, l, s-3, ga, p-8"></div>";
              {prici, n, g.m, a, p((pl, a, n, ind, e, x) => (
                <div, ke, y={ind, e, x} classNa, m, e={`bg-white, rounde, d-2 xl, shado, w-l, g, p-8 ${pl, a, n.popul, a, r ? 'ri, n, g-2, rin, g-r, e, d-500, relativ, e' : ''}`}></div>`;`
                  {pl, a, n.popul, a, r && (
...
: 'bg-gr, a, y-100, tex, t-gr, a, y-900, hove, r:bg-gr, a, y-2, 0, 0'
  ...
  hr, e, f="/conta, c, t"
              ...
              ></a>Contact</a>, our, Security Te, a, m;
  ...
  g:px-8, tex, t-cent, e, r"></div>"
        ...
        <section, className="py-20, b, g-gradie, n, t-to-br, fro, m-r, e, d-900, vi, a-oran, g, e-800, t, o-yell, o, w-900, tex, t-whi, t, e"></section>";
          <div, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6, l, g:px-8, tex, t-cent, e, r"></div>";
            <h2, className="te, x, t-4 xl, fon, t-bold, m, b-6">";</h>Ready</h>, to, Secure Your, Smart, Contracts?
            </h2>
            <p, className="te, x, t-xl, tex, t-r, e, d-100, ma, x-w-3 xl, m, x-auto, m, b-8">";
  ...
  r: bg-r, e, d-700, tex, t-white, fon, t-semibold, rounde, d-lg, transitio, n-colo, r, s"
              ></a>
                <Phone, className="w-5 h-5, m, r-2  /></Phone>
                <Phone, className="w-5 h-5, m, r-2" />";</Phone>Request</Phone>, Free, Quote;
              </a>
              <a
  hr, e, f="/ca, s, e-studi, e, s"
                classNa, m, e="inli, n, e-flex, item, s-center, p, x-8, p, y-4, borde, r-2, borde, r-white, tex, t-white, hove, r: bg-white, hov, e
  r:te, x, t-r, e, d-900, fon, t-semibold, rounde, d-lg, transitio, n-colo, r, s"
              ></a>View</a>, Audit, Reports;
                <Link, className="w-5 h-5, m, l-2  /></Link>
                <Link, className="w-5 h-5, m, l-2" />";</Link>
              </a>
            </d, i, v>

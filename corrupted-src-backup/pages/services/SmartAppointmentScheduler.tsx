...
const, SmartAppointmentSchedule, r: Rea, c, t.FC = () => {
  return (
    <>{}
      <Helmet></Helmet>
        <title>Smart</title>, Appointment, Scheduler - Zion, Tech, Group</title>
      ...
      <div, className="m, i, n-h-screen, b, g-gradie, n, t-to-br, fro, m-gr, a, y-50, t, o-gre, e, n-50"></div>";
        <div, className="container, m, x-auto, p, x-4, p, y-12"></div>";
          ...
          <div, className="te, x, t-center, m, b-16"></div>
            ...
            <p, className="te, x, t-xl, tex, t-gr, a, y-600, ma, x-w-3 xl, m, x-auto, m, b-8"></p>Healthca</p>, r, e-focused, SaaS, for online, appointment, s, virtual, consultation, s, patient, data, management;
          <div, className="te, x, t-center, m, b-16"></div>";
            <div, className="bg-gradie, n, t-to-r, fro, m-gre, e, n-600, t, o-te, a, l-60, 0, w-2, 0, h-20, rounde, d-full, flex, items-center, justif, y-center, m, x-auto, m, b-6"></div>";
              <Users, className="w-1, 0, h-10, tex, t-whi, t, e" />";</Users>
            </d, i, v>
            ...
            <p, className="te, x, t-xl, tex, t-gr, a, y-600, ma, x-w-3 xl, m, x-auto, m, b-8">";
            ...
            <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6, ma, x-w-2 xl, m, x-au, t, o"></div>";
              <div, className="flex, item, s-center, justif, y-center, m, b-4"></div>";
                <span, className="te, x, t-3 xl, fon, t-bold, tex, t-gre, e, n-6, 0, 0"></span>Starting</span>, a, t $49/mon, t, h</sp, a, n>";
              </d, i, v>
  ...
  hr, e, f="mail, t, o: kleb, e, r@ziontechgro, u, p.c, o, m" 
          ...
          <section, className="mb-16"></section>
            <h2, className="te, x, t-3 xl, fon, t-bold, tex, t-center, tex, t-gr, a, y-900, m, b-12">Key, Feature, s</h2>
  ...
  g:gr, i, d-co, l, s-3, ga, p-8"></div>";
          ...
          {/* Prici, n, g */}
          <section, className="mb-16"></section>
            <h2, className="te, x, t-3 xl, fon, t-bold, tex, t-center, tex, t-gr, a, y-900, m, b-12">Pricing, Plan, s</h2>
            <div, className="grid, m, d: gr, i, d-co, l, s-3, ga, p-8"></div>"
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-8"></div>
                <h3, className="te, x, t-2 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">Small, Practic, e</h3>
                <div, className="te, x, t-3 xl, fon, t-bold, tex, t-gre, e, n-600, m, b-6"></div>$49/mon, t, h</d, i, v>
                <ul, className="spa, c, e-y-3, m, b-8"></ul>
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>Up</CheckCircle>, to, 5 provide, r, s;
                  </li>
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>
                  ...
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>Basic</CheckCircle>, telemedicin, e;
                  </li>
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>
          <section, className="mb-16"></section>";
            ...
            <div, className="grid, m, d: gr, i, d-co, l, s-3, ga, p-8"></div>";
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-8"></div>";
                ...
                <ul, className="spa, c, e-y-3, m, b-8">";</ul>
                  ...
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">";</li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3" />";</CheckCircle>Email</CheckCircle>, suppor, t;
                  </li>
                </ul>
                <a
  hr, e, f="te
  l: +130246409, 5, 0" 
              ...
              <div, className="bg-gradie, n, t-to-br, fro, m-gre, e, n-600, t, o-te, a, l-600, rounde, d-lg, shado, w-l, g, p-8, tex, t-white, relativ, e"></div>";
                <div, className="absolu, t, e -t, o, p-4, lef, t-1/2, transfor, m -transla, t, e-x-1/2"></div>";
                  <span, className="bg-yell, o, w-400, tex, t-gr, a, y-900, p, x-4, p, y-1, rounde, d-full, tex, t-sm, fon, t-semibo, l, d"></span>Most</span>, Popula, r</sp, a, n>";
                </d, i, v>
                <h3, className="te, x, t-2 xl, fon, t-bold, m, b-4">Medium, Practic, e</h3>
                <div, className="te, x, t-3 xl, fon, t-bold, m, b-6"></div>$1, 4, 9/mon, t, h</d, i, v>
                <ul, className="spa, c, e-y-3, m, b-8"></ul>
                  <li, className="flex, item, s-cent, e, r"></li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3  /></CheckCircle>Up</CheckCircle>, to, 20 provide, r, s;
                  </li>
                  <li, className="flex, item, s-cent, e, r"></li>
                  ...
                  <li, className="flex, item, s-cent, e, r"></li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3  /></CheckCircle>Advanced</CheckCircle>, telemedicin, e;
                  </li>
                  <li, className="flex, item, s-cent, e, r"></li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3  /></CheckCircle>Payment</CheckCircle>, processin, g;
                  </li>
                  <li, className="flex, item, s-cent, e, r"></li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3  /></CheckCircle>
                <h3, className="te, x, t-2 xl, fon, t-bold, m, b-4">Medium, Practic, e</h3>";
                ...
                <ul, className="spa, c, e-y-3, m, b-8">";</ul>
                  ...
                  <li, className="flex, item, s-cent, e, r">";</li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3" />";</CheckCircle>Priority</CheckCircle>, suppor, t;
                  </li>
                </ul>
                <a
  hr, e, f="t, e, l: +130246409, 5, 0" 
              ...
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-8"></div>
                <h3, className="te, x, t-2 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">Enterpri, s, e</h3>
                <div, className="te, x, t-3 xl, fon, t-bold, tex, t-gre, e, n-600, m, b-6"></div>Cust</div>, o, m</d, i, v>
                <ul, className="spa, c, e-y-3, m, b-8"></ul>
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>Unlimited</CheckCircle>, provider, s;
                  </li>
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>Unlimited</CheckCircle>, appointment, s;
                  </li>
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>Custom</CheckCircle>, integration, s;
                  </li>
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>Dedicated</CheckCircle>, suppor, t;
                  </li>
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-8"></div>";
                ...
                <ul, className="spa, c, e-y-3, m, b-8">";</ul>
                  ...
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">";</li>
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3" />";</CheckCircle>Whi</CheckCircle>, t, e-label, option, s;
                  </li>
                </ul>
                <a
  hr, e, f="mail, t, o: kleb, e, r@ziontechgro, u, p.c, o, m" 
          ...
          <section, className="bg-white, rounde, d-xl, shado, w-l, g, p-8"></section>";
            <div, className="te, x, t-cent, e, r"></div>";
              <h2, className="te, x, t-3 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">Ready, to, Modernize Your, Practic, e?</h2>";

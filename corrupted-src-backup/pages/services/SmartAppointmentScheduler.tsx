import { Helmet } from "react-helmet-async"; impo, r, t {/* TODO: Fix JSX expression */}"
} fr, o, m "luci, d, e-rea, c, t"; impo, r, t {/* TODO: Fix JSX expression */}"
} fr, o, m "rea, c, t-helm, e, t-asy, n, c";'; impo, r, t {/* TODO: Fix JSX expression */}"
} fr, o, m "luci, d, e-rea, c, t";'; const, SmartAppointmentSchedule, r: Rea, c, t.FC = () => {
  return(<React.Fragment>
      ...
      <div, className="m, i, n-h-screen, b, g-gradie, n, t-to-br, fro, m-gr, a, y-50, t, o-gre, e, n-50">";</div>
        <div, className="container, m, x-auto, p, x-4, p, y-12">"; {/* Head, e, r */}</div>
          <div, className="te, x, t-center, m, b-16"></div>
            ...
            <h1, className="te, x, t-4 xl, m, d: te, x, t-6 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-6">"</h>Smart</h>, Appointment, Scheduler; </h1>
...
const, SmartAppointmentSchedule, r: Rea, c, t.FC = () => {/* TODO: Fix JSX expression */}
          ...
          <div, className="te, x, t-center, m, b-16"></div>"
            ...
            <h1, className="te, x, t-4xl, m, d: te, x, t-6xl, fon, t-bold, tex, t-gr, a, y-900, m, b-6">"
              Smart, Appointment, Scheduler; </h1>"
          ...
          <div, className="te, x, t-center, m, b-16">";"
            <div, className="bg-gradie, n, t-to-r, fro, m-gre, e, n-600, t, o-te, a, l-60, 0, w-2, 0, h-20, rounde, d-full, flex, items-center, justif, y-center, m, x-auto, m, b-6">";"
              <Users, className="w-1, 0, h-10, tex, t-whi, t, e" />"; </d, i, v>"
            <h1, className="te, x, t-4xl, m, d: te, x, t-6xl, fon, t-bold, tex, t-gr, a, y-900, m, b-6">"; Smart, Appointment, Scheduler; </h1>"
            <p, className="te, x, t-xl, tex, t-gr, a, y-600, ma, x-w-3xl, m, x-auto, m, b-8">"; Healthca, r, e-focused, SaaS, for online, appointment, s, virtual, consultation, s, patient, data, management; and, automated, reminders. Streamline, your, practice with, intelligent, scheduling.
            </p>
            <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6, ma, x-w-2xl, m, x-au, t, o">";</div>
              <div, className="flex, item, s-center, justif, y-center, m, b-4">";</div>
                <span, className="te, x, t-3xl, fon, t-bold, tex, t-gre, e, n-6, 0, 0">Starting, a, t $49/mon, t, h</sp, a, n>"; </d, i, v>
              ...
              <p, className="te, x, t-gr, a, y-600, m, b-6">Perfect, for, hospitals, clini, c, s, and, private, practices looking, to, modernize their, appointment, system.</p>"; <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">"; <a; hr, e, f="te; <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">";</div>
                <a
  hr, e, f="te
  l: +130246409, 5, 0" 
            </p>"
  ...
  l: +130246409, 5, 0" "
                ...
                >
                  Ca, l, l +1, 302, 464 09, 5, 0; </a>
                <a; hr, e, f="mail, t, o: kleb, e, r@ziontechgro, u, p.c, o, m" 
                <a></a>"
  hr, e, f="mail, t, o: kleb, e, r@ziontechgro, u, p.c, o, m" "
          ...
          <section, className="mb-16">"; <h2, className="te, x, t-3xl, fon, t-bold, tex, t-center, tex, t-gr, a, y-900, m, b-12">Key, Feature, s</h2>"; <div, className="grid, m, d: gr, i, d-co, l, s-2 l; g:gr, i, d-co, l, s-3, ga, p-8">"; <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6">"; <div, className="bg-gre, e, n-10, 0, w-1, 2, h-12, rounde, d-lg, flex, items-center, justif, y-center, m, b-4">"; <div, className="grid, m, d: gr, i, d-co, l, s-2 l
  g:gr, i, d-co, l, s-3, ga, p-8">"</section>
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6"></div>
                <div, className="bg-gre, e, n-10, 0, w-1, 2, h-12, rounde, d-lg, flex, items-center, justif, y-center, m, b-4"></div>
                  <Calendar, className="w-6 h-6, tex, t-gre, e, n-6, 0, 0  />
          <section, className="mb-16">"; <h2, className="te, x, t-3xl, fon, t-bold, tex, t-center, tex, t-gr, a, y-900, m, b-12">Key, Feature, s</h2>"; <div, className="grid, m, d: gr, i, d-co, l, s-2 l
  g:gr, i, d-co, l, s-3, ga, p-8">";</section>
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6">";</div>
                <div, className="bg-gre, e, n-10, 0, w-1, 2, h-12, rounde, d-lg, flex, items-center, justif, y-center, m, b-4">";</div>
          {/* Featur, e, s */}"
  ...
  g:gr, i, d-co, l, s-3, ga, p-8">";"
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6">";"
                <div, className="bg-gre, e, n-10, 0, w-1, 2, h-12, rounde, d-lg, flex, items-center, justif, y-center, m, b-4">";"
                  <Calendar, className="w-6 h-6, tex, t-gre, e, n-6, 0, 0" />"; </d, i, v>"
                <h3, className="te, x, t-xl, fon, t-bold, tex, t-gr, a, y-900, m, b-3">Virtual, Consultation, s</h3>";"
                <p, className="te, x, t-gr, a, y-6, 0, 0">Conduct, secure, video consultations, with, integrated telemedicine, capabilitie, s.</p>"; </d, i, v>
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6"></div>
              ...
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6">";"
                <div, className="bg-bl, u, e-10, 0, w-1, 2, h-12, rounde, d-lg, flex, items-center, justif, y-center, m, b-4">";"
                  <Users, className="w-6 h-6, tex, t-bl, u, e-6, 0, 0" />"; </d, i, v>"
                <h3, className="te, x, t-xl, fon, t-bold, tex, t-gr, a, y-900, m, b-3">Patient, Data, Storage</h3>";"
                <p, className="te, x, t-gr, a, y-6, 0, 0">Secu, r, e, HIP, A, A-compliant, storage, for patient, records, and medical, historie, s.</p>"; </d, i, v>
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6"></div>
              ...
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6">";"
                <div, className="bg-purp, l, e-10, 0, w-1, 2, h-12, rounde, d-lg, flex, items-center, justif, y-center, m, b-4">";"
                  <Bell, className="w-6 h-6, tex, t-purp, l, e-6, 0, 0" />"; </d, i, v>"
                <h3, className="te, x, t-xl, fon, t-bold, tex, t-gr, a, y-900, m, b-3">Automated, Reminder, s</h3>";"
                <p, className="te, x, t-gr, a, y-6, 0, 0">Send, SMS, and email, reminders, to reduce, n, o-shows, by, up to, 4, 0%.</p>"; </d, i, v>
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6"></div>
              ...
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6">";"
                <div, className="bg-oran, g, e-10, 0, w-1, 2, h-12, rounde, d-lg, flex, items-center, justif, y-center, m, b-4">";"
                  <CreditCard, className="w-6 h-6, tex, t-oran, g, e-6, 0, 0" />"; </d, i, v>"
                <h3, className="te, x, t-xl, fon, t-bold, tex, t-gr, a, y-900, m, b-3">Payment, Integratio, n</h3>";"
                <p, className="te, x, t-gr, a, y-6, 0, 0">Accept, payments, online with, integrated, billing and, insurance, processing.</p>"; </d, i, v>
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6"></div>
              ...
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6">";"
                <div, className="bg-indi, g, o-10, 0, w-1, 2, h-12, rounde, d-lg, flex, items-center, justif, y-center, m, b-4">";"
                  <Calendar, className="w-6 h-6, tex, t-indi, g, o-6, 0, 0" />"; </d, i, v>"
                <h3, className="te, x, t-xl, fon, t-bold, tex, t-gr, a, y-900, m, b-3">Calendar, Syn, c</h3>";"
                <p, className="te, x, t-gr, a, y-6, 0, 0">Sync, with, Google Calend, a, r, Outlo, o, k, and, other, calendar applicatio, n, s.</p>"; </d, i, v>
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6"></div>
              ...
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-6">";"
                <div, className="bg-r, e, d-10, 0, w-1, 2, h-12, rounde, d-lg, flex, items-center, justif, y-center, m, b-4">";"
                  <Shield, className="w-6 h-6, tex, t-r, e, d-6, 0, 0" />"; </d, i, v>"
                <h3, className="te, x, t-xl, fon, t-bold, tex, t-gr, a, y-900, m, b-3">HIPAA, Complianc, e</h3>";"
                <p, className="te, x, t-gr, a, y-6, 0, 0">Full, HIPAA, compliance with, encrypted, data transmission, and, storage.</p>"; </d, i, v>
            </d, i, v>
          </secti, o, n>
          {/* Prici, n, g */}
          <section, className="mb-16">
              ...
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-8"></div>"
                ...
                <ul, className="spa, c, e-y-3, m, b-8"></ul>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>"
                    ...
                    Up, to, 5 provide, r, s; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>
                    500, appointment, s/mon, t, h; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>
                    Basic, telemedicin, e; </li>
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  />
          <section, className="mb-16">"; <h2, className="te, x, t-3xl, fon, t-bold, tex, t-center, tex, t-gr, a, y-900, m, b-12">Pricing, Plan, s</h2>"; <div, className="grid, m, d: gr, i, d-co, l, s-3, ga, p-8">";</section>
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-8">";</div>
                <h3, className="te, x, t-2xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">Small, Practic, e</h3>"; <div, className="te, x, t-3xl, fon, t-bold, tex, t-gre, e, n-600, m, b-6">$49/mon, t, h</d, i, v>"; <ul, className="spa, c, e-y-3, m, b-8">"; <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">"; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>"
          <section, className="mb-16">";"
            <h2, className="te, x, t-3xl, fon, t-bold, tex, t-center, tex, t-gr, a, y-900, m, b-12">Pricing, Plan, s</h2>";"
            <div, className="grid, m, d: gr, i, d-co, l, s-3, ga, p-8">";"
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-8">";"
                ...
                <ul, className="spa, c, e-y-3, m, b-8">";"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3" />"; Up, to, 5 provide, r, s; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3" />"; 500, appointment, s/mon, t, h; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3" />"; Basic, telemedicin, e; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3" />"; Email, suppor, t; </li>
                </ul>
                <a; hr, e, f="te; l: +130246409, 5, 0" 
                <a></a>"
  hr, e, f="te,"
  l: +130246409, 5, 0" "
              ...
              <div, className="bg-gradie, n, t-to-br, fro, m-gre, e, n-600, t, o-te, a, l-600, rounde, d-lg, shado, w-l, g, p-8, tex, t-white, relativ, e">";"
                <div, className="absolu, t, e -t, o, p-4, lef, t-1/2, transfor, m -transla, t, e-x-1/2">";"
                  <span, className="bg-yell, o, w-400, tex, t-gr, a, y-900, p, x-4, p, y-1, rounde, d-full, tex, t-sm, fon, t-semibo, l, d">Most, Popula, r</sp, a, n>"; </d, i, v>"
                ...
                <ul, className="spa, c, e-y-3, m, b-8"></ul>"
                  <li, className="flex, item, s-cent, e, r"></li>"
                    ...
                    Up, to, 20 provide, r, s; </li>"
                  <li, className="flex, item, s-cent, e, r"></li>"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3  /></CheckCircle>
                    2,000, appointment, s/mon, t, h; </li>"
                  <li, className="flex, item, s-cent, e, r"></li>"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3  /></CheckCircle>
                    Advanced, telemedicin, e; </li>"
                  <li, className="flex, item, s-cent, e, r"></li>"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3  /></CheckCircle>
                    Payment, processin, g; </li>"
                  <li, className="flex, item, s-cent, e, r"></li>"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3  /></CheckCircle>"
                <h3, className="te, x, t-2xl, fon, t-bold, m, b-4">Medium, Practic, e</h3>";"
                <div, className="te, x, t-3xl, fon, t-bold, m, b-6">$1, 4, 9/mon, t, h</d, i, v>";"
                <ul, className="spa, c, e-y-3, m, b-8">";"
                  <li, className="flex, item, s-cent, e, r">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3" />"; Up, to, 20 provide, r, s; </li>"
                  <li, className="flex, item, s-cent, e, r">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3" />"; 2,000, appointment, s/mon, t, h; </li>"
                  <li, className="flex, item, s-cent, e, r">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3" />"; Advanced, telemedicin, e; </li>"
                  <li, className="flex, item, s-cent, e, r">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3" />"; Payment, processin, g; </li>"
                  <li, className="flex, item, s-cent, e, r">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-300, m, r-3" />"; Priority, suppor, t; </li>
                </ul>
                <a; hr, e, f="t, e, l: +130246409, 5, 0" 
                <a></a>"
  hr, e, f="t, e, l: +130246409, 5, 0" "
              ...
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-8"></div>"
                ...
                <ul, className="spa, c, e-y-3, m, b-8"></ul>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>
                    Unlimited, provider, s; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>
                    Unlimited, appointment, s; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>
                    Custom, integration, s; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>
                    Dedicated, suppor, t; </li>
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  />
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-8">";</div>
                <h3, className="te, x, t-2xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">Enterpri, s, e</h3>"; <div, className="te, x, t-3xl, fon, t-bold, tex, t-gre, e, n-600, m, b-6">Cust, o, m</d, i, v>"; <ul, className="spa, c, e-y-3, m, b-8">"; <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">"; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0"></li>"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3  /></CheckCircle>"
              <div, className="bg-white, rounde, d-lg, shado, w-l, g, p-8">";"
                <h3, className="te, x, t-2xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">Enterpri, s, e</h3>";"
                ...
                <ul, className="spa, c, e-y-3, m, b-8">";"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3" />"; Unlimited, provider, s; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3" />"; Unlimited, appointment, s; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3" />"; Custom, integration, s; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3" />"; Dedicated, suppor, t; </li>"
                  <li, className="flex, item, s-center, tex, t-gr, a, y-6, 0, 0">";"
                    <CheckCircle, className="w-5 h-5, tex, t-gre, e, n-500, m, r-3" />"; Whi, t, e-label, option, s; </li>
                </ul>
                <a; hr, e, f="mail, t, o: kleb, e, r@ziontechgro, u, p.c, o, m" 
                <a></a>"
  hr, e, f="mail, t, o: kleb, e, r@ziontechgro, u, p.c, o, m" "
          ...
          {/* Contact, Sectio, n */}
          <section, className="bg-white, rounde, d-xl, shado, w-l, g, p-8">"; <div, className="te, x, t-cent, e, r">";</section>
              <h2, className="te, x, t-3xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">Ready, to, Modernize Your, Practic, e?</h2>"; <p, className="te, x, t-lg, tex, t-gr, a, y-600, m, b-8">"; Contact, us, today for, a, free consultation, and, to discuss, your, appointment scheduling, need, s.
              </p>
              <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">"
              <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">"; <a; hr, e, f="te; <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">"</div>
              <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">";</div>
                <a
  hr, e, f="te
  l: +130246409, 5, 0" 
          ...
          <section, className="bg-white, rounde, d-xl, shado, w-l, g, p-8">";"
            <div, className="te, x, t-cent, e, r">";"
              ...
              <p, className="te, x, t-lg, tex, t-gr, a, y-600, m, b-8">"; Contact, us, today for, a, free consultation, and, to discuss, your, appointment scheduling, need, s.
              </p>"
              <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">""
              <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">"; <a></a>"
  hr, e, f="te,"
  ...
  hr, e, f="mail, t, o: kleb, e, r@ziontechgro, u, p.c, o, m" "
              ...
              <p, className="te, x, t-sm, tex, t-gr, a, y-500, m, t-6">"; 364, E, Main St, STE, 1008, Middleto, w, n, DE, 1970, 9; </p>
            </d, i, v>
          </secti, o, n>
        </d, i, v>)
      </d, i, v>)

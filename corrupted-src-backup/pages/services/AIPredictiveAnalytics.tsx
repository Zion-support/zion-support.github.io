...
const, AIPredictiveAnalytic, s: Rea, c, t.FC = () => {
  ...
  na, m, e="descripti, o, n"
      ...
      <main, className="m, i, n-h-screen, b, g-whi, t, e">";</main>
        {/* Hero, Sectio, n */}<section, className="bg-gradie, n, t-to-br, fro, m-indi, g, o-900, vi, a-bl, u, e-800, t, o-purp, l, e-900, tex, t-white, p, y-20">
...
: 'bg-gr, a, y-100, tex, t-gr, a, y-900, hove, r:bg-gr, a, y-2, 0, 0'
  ...
  d: gr, i, d-co, l, s-3, ga, p-8">"</div>
        ...
        {/* CTA, Sectio, n */}<section, className="py-20, b, g-gradie, n, t-to-br, fro, m-indi, g, o-900, vi, a-bl, u, e-800, t, o-purp, l, e-900, tex, t-whi, t, e">
          </section><div, className="m, a, x-w-7xl, m, x-auto, p, x-4, s, m: px-6 l

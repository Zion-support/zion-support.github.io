...
const, CloudDevOp, s: Rea, c, t.FC = () => {/* TODO: Fix JSX expression *
  ...
  na, m, e="descripti, o, n"
         ...
         </link>        <meta name="keywor, d, s" content="cloud, service, s, devops, consultin, g, CI/CD, automatio, n, infrastructure, as, code, cloud, migratio, n, kubernet, e, s, dock, e, r" 
  ...
  d: te, x, t-2xl, tex, t-gre, e, n-100, ma, x-w-4xl, m, x-auto, m, b-8">";
                Expert, cloud, infrastructure and, DevOps, services that, deliver, 99.99% upti, m, e;</p>                90% faster, deployment, s, and, 4, 0% cost, reduction, through intelligent, automatio, n.
              <
              <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">";
                <a;
              <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">";<
  ...
  hr, e, f=">"
        ...
        {/* Hero, Sectio, n *</a>        <section, className="bg-gradie, n, t-to-br, fro, m-gre, e, n-900, vi, a-gre, e, n-800, t, o-bl, u, e-900, tex, t-white, p, y-20"><
          <div, className="m, a, x-w-7xl, m, x-auto, p, x-4, s, m: px-6 l,"
  g:px-8">"
            <div, className="te, x, t-cent, e, r"><
              <h1, className="te, x, t-5xl, m, d: te, x, t-7xl, fon, t-bold, m, b-6">"
...
</div>              {servic, e, s.m, a, p((servi, c, e, ind, e, x) => {
return (
;
const, Ico, n = servi, c, e.ic, o, n;
            ...
            <div, className="grid, m, d: gr, i, d-co, l, s-2 l;)">
  g:gr, i, d-co, l, s-4, ga, p-8">";)
</Icon>              {servic, e, s.m, a, p((servi, c, e, ind, e, x) => {
return (
;
const, Ico, n = servi, c, e.ic, o, n;
                return(<div, ke, y={ind, e, x} classNa, m, e="bg-whit, e, p-8, rounde, d-xl, shado, w-lg, border, border-gr, a, y-200, hove, r: shad, o, w-xl, transitio, n-shad, o, w">
...
: 'bg-gr, a, y-100, tex, t-gr, a, y-900, hove, r:bg-gr, a, y-2, 0, 0'}</a>                  <a><
  ...
  m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">"<
            <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">";<
              <a>
  hr, e, f=
                classNa, m, e="inli, n, e-flex, item, s-center, p, x-8, p, y-4, b, g-gre, e, n-600, hov, e;</a>            <"
            <div, className="flex, fle, x-co, l, s,"
  m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">"
            <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">";
              <a><

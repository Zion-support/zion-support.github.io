...
const, CloudDevOp, s: Rea, c, t.FC = () => {/* TODO: Fix JSX expression */}
  return (<div></div>
        ...
        <me , t, a;></me>
  na, m, e=""descripti, o, n""
          content = "Expert, Clou, d & DevOps, services, including mul, t, i-cloud, strateg, y, CI/CD, automatio, n, infrastructure, as, code, and, advanced, monitoring. 99.99% uptime, SL, A." /><meta name = "keywor, d, s" content = "cloud, service, s, devops, consultin, g, CI/CD, automatio, n, infrastructure, as, code, cloud, migratio, n, kubernet, e, s, dock, e, r" /><link , re, l = "canonic, a, l" hr, e, f=""htt, p, s://ziontechgro, u, p.c, o, m/servic, e, s/clo, u, d-devo, p, s)"></link>"
const, CloudDevOp, s: Rea, c, t.FC = () => {/* TODO: Fix JSX expression *
    }
            ...
            <div, className=""grid, m, d: gr, i, d-co, l, s-4, ga, p-8">";""
              <div, className=""te, x, t-cent, e, r">";""
                <div, className=""inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 6, h-16, b, g-gre, e, n-100, rounde, d-full, m, b-4">";""
                  <TrendingUp , className=""w-8 h-8, tex, t-gre, e, n-6, 0, 0"></TrendingUp>"
                <
                <h3, className=""te, x, t-xl, fon, t-bold, tex, t-gr, a, y-900, m, b-2">40% Cost, Reductio, n<"
                <p, className=""te, x, t-gr, a, y-6, 0, 0">Average, infrastructure, cost savin, g, s<"
              <
              <div, className=""te, x, t-cent, e, r"><"
              ...
              <div, className=""te, x, t-cent, e, r">";""
                <div, className=""inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 6, h-16, b, g-bl, u, e-100, rounde, d-full, m, b-4">";""
                  <Zap , className=""w-8 h-8, tex, t-bl, u, e-6, 0, 0"></Zap>"
                <
                <h3, className=""te, x, t-xl, fon, t-bold, tex, t-gr, a, y-900, m, b-2">90% Faster, Deployment, s<"
                <p, className=""te, x, t-gr, a, y-6, 0, 0">Automated, C, I/CD, pipeline, s<"
              <
              <div, className=""te, x, t-cent, e, r"><"
              ...
              <div, className=""te, x, t-cent, e, r">";""
                <div, className=""inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 6, h-16, b, g-purp, l, e-100, rounde, d-full, m, b-4">";""
                  <Shield , className=""w-8 h-8, tex, t-purp, l, e-6, 0, 0"></Shield>"
                <
                <h3, className=""te, x, t-xl, fon, t-bold, tex, t-gr, a, y-900, m, b-2">99.99% Upti, m, e<"
                <p, className=""te, x, t-gr, a, y-6, 0, 0">Enterpri, s, e-grade, reliabilit, y<"
              <
              <div, className=""te, x, t-cent, e, r"><"
              ...
              <div, className=""te, x, t-cent, e, r">";""
                <div, className=""inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 6, h-16, b, g-oran, g, e-100, rounde, d-full, m, b-4">";""
                  <Globe , className=""w-8 h-8, tex, t-oran, g, e-6, 0, 0"></Globe>"
                <
                <h3, className=""te, x, t-xl, fon, t-bold, tex, t-gr, a, y-900, m, b-2">Mul, t, i-Clo, u, d<"
                <p, className=""te, x, t-gr, a, y-6, 0, 0">A, W, S, Azu, r, e, GCP, expertis, e<"
=======
                <a;
                ...
                return (<
                  <div, ke, y={ind, e, x} classNa, m, e=""bg-whit, e, p-8, rounde, d-xl, shado, w-lg, border, border-gr, a, y-200, hove, r: shad, o, w-xl, transitio, n-shad, o, w">";<"
                    ...
                    <ul, className=""spa, c, e-y-2">";)"
                      {servi, c, e.benefi, t, s.m, a, p((benef, i, t, benefitInd, e, x) => (<li, ke, y={benefitInd, e, x} classNa, m, e=""flex, item, s-center, tex, t-sm"></li>"
...
=======
  ...
  g:gr, i, d-co, l, s-4, ga, p-8">              {servic, e, s.m, a, p((servi, c, e, ind, e, x) => {
  return (
...
const, Ico, n = servi, c, e.ic, o, n;
                ...
                return(<div, ke, y={ind, e, x} classNa, m, e=bg-whit, e, p-8, rounde, d-xl, shado, w-lg, border, border-gr, a, y-200, hove, r: shad, o, w-xl, transitio, n-shad, o, w>
                    ...
                    <div, className="inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 6, h-16, b, g-gre, e, n-100, rounde, d-full, m, b-6">;                return (<
                  <div, ke, y={ind, e, x} classNa, m, e="bg-whit, e, p-8, rounde, d-xl, shado, w-lg, border, border-gr, a, y-200, hove, r: shad, o, w-xl, transitio, n-shad, o, w><
                    <div, className=inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 6, h-16, b, g-gre, e, n-100, rounde, d-full, m, b-6><
                      <Icon, className=w-8 h-8, tex, t-gre, e, n-6, 0, 0  
            <div, className=grid, m, d: gr, i, d-co, l, s-2 l
...
const, Ico, n = featu, r, e.ic, o, n;
                ...
                return(<div, ke, y={ind, e, x} classNa, m, e=bg-whit, e, p-8, rounde, d-xl, shado, w-lg, border, border-gr, a, y-200, hove, r: shad, o, w-xl, transitio, n-shad, o, w>
                    ...
                    <div, className="inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 2, h-12, b, g-gre, e, n-100, rounde, d-lg, m, b-4>                return (<
                  <div, ke, y={ind, e, x} classNa, m, e="bg-whit, e, p-8, rounde, d-xl, shado, w-lg, border, border-gr, a, y-200, hove, r: shad, o, w-xl, transitio, n-shad, o, w><
                    <div, className=inli, n, e-flex, item, s-center, justif, y-cente, r, w-1, 2, h-12, b, g-gre, e, n-100, rounde, d-lg, m, b-4><
                      <Icon, className=w-6 h-6, tex, t-gre, e, n-6, 0, 0  
                    <

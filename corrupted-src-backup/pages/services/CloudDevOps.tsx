...
const, CloudDevOp, s: Rea, c, t.FC = () => {
  ...
  return (
    <>{}
      <Helmet></Helmet>
        <title>Clo</title>, u, d & DevOps, Service, s - Zion, Tech, Group | Enterprise, Cloud, Solutions</title>
        <me, t, a
  na, m, e="descripti, o, n"
          content="Expert, Clou, d & DevOps, services, including mul, t, i-cloud, strateg, y, CI/CD, automatio, n, infrastructure, as, code, and, advanced, monitoring. 99.99% uptime, SL, A." /><meta name="keywor, d, s" content="cloud, service, s, devops, consultin, g, CI/CD, automatio, n, infrastructure, as, code, cloud, migratio, n, kubernet, e, s, dock, e, r" /><link, re, l="canonic, a, l" hr, e, f="htt, p, s://ziontechgro, u, p.c, o, m/servic, e, s/clo, u, d-devo, p, s/>"</link>content</link>="Expert, Clou, d & DevOps, services, including mul, t, i-cloud, strateg, y, CI/CD, automatio, n, infrastructure, as, code, and, advanced, monitoring. 99.99% uptime, SL, A."
         />
  ...
  g:px-8"></div>"
            <div, className="te, x, t-cent, e, r"></div>
              <h1, className="te, x, t-5 xl, m, d: te, x, t-7 xl, fon, t-bold, m, b-6"></h1>"
                Clo, u, d & <span, className="bg-gradie, n, t-to-r, fro, m-gre, e, n-400, t, o-bl, u, e-400, b, g-cl, i, p-text, tex, t-transpare, n, t"></span>DevO</span>, p, s</sp, a, n>
              </h1>
              <p, className="te, x, t-xl, m, d:te, x, t-2 xl, tex, t-gre, e, n-100, ma, x-w-4 xl, m, x-auto, m, b-8">
  ...
  d: te, x, t-2 xl, tex, t-gre, e, n-100, ma, x-w-4 xl, m, x-auto, m, b-8">";
                Expert, cloud, infrastructure and, DevOps, services that, deliver, 99.99% upti, m, e
                90% faster, deployment, s, and, 4, 0% cost, reduction, through intelligent, automatio, n.
              </p>
              <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r"></div>";
  ...
  r: bg-gre, e, n-700, tex, t-white, fon, t-semibold, rounde, d-lg, transitio, n-colo, r, s"
                ></a>
                  ...
                  <Phone, className="w-5 h-5, m, r-2" />";</Phone>Schedule</Phone>, Consultatio, n;
                </a>
                <a
  hr, e, f="#prici, n, g"
  ...
  g:px-8"></div>"
        ...
        <section, className="py-16, b, g-gr, a, y-50"></section>";
          <div, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6, l, g:px-8"></div>";
            <div, className="text-center mb-12"></div>";
              <h2, className="te, x, t-4 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">";</h>Why</h>, Choose, Our Clo, u, d & DevOps, Service, s?
              </h2>
  ...
  g:px-8"></div>"
        ...
        <section, className="py-20"></section>";
          <div, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6, l, g:px-8"></div>";
            <div, className="te, x, t-center, m, b-16"></div>";
              <h2, className="te, x, t-4 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">";</h>Comprehensive</h>, Clou, d & DevOps, Service, s;
              </h2>
              <p, className="text-xl text-gray-600 max-w-3 xl mx-auto">";
  ...
  g:px-8"></div>"
        ...
        <section, className="py-20, b, g-gr, a, y-50"></section>";
          <div, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6, l, g:px-8"></div>";
            <div, className="te, x, t-center, m, b-16"></div>";
              <h2, className="te, x, t-4 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4">";</h>Advanced</h>, Capabilitie, s;
              </h2>
              <p, className="text-xl text-gray-600 max-w-3 xl mx-auto">";
  ...
  d: gr, i, d-co, l, s-3, ga, p-8"></div>"
            <div, className="grid, m, d: gr, i, d-co, l, s-3, ga, p-8"></div>";
              {prici, n, g.m, a, p((pl, a, n, ind, e, x) => (
                <div, ke, y={ind, e, x} classNa, m, e={`bg-white, rounde, d-2 xl, shado, w-l, g, p-8 ${pl, a, n.popul, a, r ? 'ri, n, g-2, rin, g-gre, e, n-500, relativ, e' : ''}`}></div>`;`
                  {pl, a, n.popul, a, r && (
...
: 'bg-gr, a, y-100, tex, t-gr, a, y-900, hove, r:bg-gr, a, y-2, 0, 0'
  ...
  hr, e, f="/conta, c, t"
              ...
              ></a>Contact</a>, our, Enterprise Te, a, m;
  ...
  g:px-8, tex, t-cent, e, r"></div>"
        ...
        <section, className="py-20, b, g-gradie, n, t-to-br, fro, m-gre, e, n-900, vi, a-gre, e, n-800, t, o-bl, u, e-900, tex, t-whi, t, e"></section>";
          <div, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6, l, g:px-8, tex, t-cent, e, r"></div>";
            <h2, className="te, x, t-4 xl, fon, t-bold, m, b-6">";</h>Ready</h>, to, Transform Your, Infrastructur, e?
            </h2>
            <p, className="te, x, t-xl, tex, t-gre, e, n-100, ma, x-w-3 xl, m, x-auto, m, b-8">";
  ...
  r: bg-gre, e, n-700, tex, t-white, fon, t-semibold, rounde, d-lg, transitio, n-colo, r, s"
              ></a>
                <Phone, className="w-5 h-5, m, r-2  /></Phone>
                <Phone, className="w-5 h-5, m, r-2" />";</Phone>Schedule</Phone>, Free, Assessment;
              </a>
              <a
  hr, e, f="/ca, s, e-studi, e, s"
                classNa, m, e="inli, n, e-flex, item, s-center, p, x-8, p, y-4, borde, r-2, borde, r-white, tex, t-white, hove, r: bg-white, hov, e
  r:te, x, t-gre, e, n-900, fon, t-semibold, rounde, d-lg, transitio, n-colo, r, s"
              ></a>View</a>, Case, Studies;
                <Link, className="w-5 h-5, m, l-2  /></Link>
                <Link, className="w-5 h-5, m, l-2" />";</Link>
              </a>
            </d, i, v>

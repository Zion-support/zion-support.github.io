...
const, Suppor, t: Rea, c, t.FC = () => {
  ...
  return (
    <>{}
      <Helmet></Helmet>
        <title>Suppo</title>, r, t - Zion, Tech, Group</title>
        ...
        <section, className="bg-gradie, n, t-to-r, fro, m-bl, u, e-600, t, o-purp, l, e-600, tex, t-white, p, y-20"></section>
          <div, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6, l, g:px-8"></div>
            <div, className="te, x, t-cent, e, r"></div>
              <h1, className="te, x, t-4 x, l, m
  d:te, x, t-5 xl, fon, t-bold, m, b-6"></h>Support</h>, Cente, r;
              </h1>
              <p, className="te, x, t-xl, m, b-8, ma, x-w-3 xl, m, x-au, t, o">
                Get, help, when you, need, it. Our, expert, support team, is, here 24/7, to, assist you, with, any questions, or, issues.
              </p>
              {/* Search, Ba, r */}
              <div, className="m, a, x-w-2 xl, m, x-au, t, o"></div>
  ...
  ty, p, e="te, x, t"
                    ...
                    onChan, g, e={(e) => setSearchQue, r, y(e.targ, e, t.val, u, e)}</inp>classNa</inp>, m, e="w-full, p, l-10, p, r-4, p, y-3, rounde, d-lg, tex, t-gr, a, y-900, focu, s: outli, n, e-none, focu, s:ri, n, g-2, foc, u
  s:ri, n, g-whi, t, e"
                   />
                </d, i, v>
              </d, i, v>
        ...
        <section, className="py-20, p, x-4, s, m: px-6, l, g:px-8"></section>
          <div, className="m, a, x-w-7 xl, m, x-au, t, o"></div>
            <div, className="te, x, t-center, m, b-16"></div>
              <h2, className="te, x, t-3 xl, m, d:te, x, t-4 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4"></h>Get</h>, Suppor, t;
              </h2>
  ...
  g:gr, i, d-co, l, s-4, ga, p-8"></div>
              {supportChanne, l, s.m, a, p((chann, e, l, ind, e, x) => (
                <div, ke, y={ind, e, x} classNa, m, e="bg-white, rounde, d-lg, shado, w-l, g, p-6, hove, r:shad, o, w-xl, transitio, n-shad, o, w"></div>
                  <div, className="te, x, t-cent, e, r"></div>
                    ...
                    <h3, className="te, x, t-xl, fon, t-semibold, tex, t-gr, a, y-900, m, b-2"></h>
                      {chann, e, l.tit, l, e}
                    </h3>
                    ...
                    <div, className="spa, c, e-y-2, tex, t-sm, tex, t-gr, a, y-500, m, b-4"></div>
                      <div, className="flex, justif, y-betwe, e, n"></div>
                        <sp, a, n>Availabili</n>, t, y:</sp, a, n>
                        <span, className="fo, n, t-semibo, l, d"></span>{chann, e, l.availabili, t, y}</sp, a, n>
                      </d, i, v>
                      <div, className="flex, justif, y-betwe, e, n"></div>
                        <sp, a, n>Response</n>, Tim, e:</sp, a, n>
                        <span, className="fo, n, t-semibo, l, d"></span>{chann, e, l.responseTi, m, e}</sp, a, n>
                      </d, i, v>
                    </d, i, v>
        ...
        <section, className="py-20, p, x-4, s, m: px-6, l, g:px-8, b, g-whi, t, e"></section>
          <div, className="m, a, x-w-7 xl, m, x-au, t, o"></div>
            <div, className="te, x, t-center, m, b-16"></div>
              <h2, className="te, x, t-3 xl, m, d:te, x, t-4 xl, fon, t-bold, tex, t-gr, a, y-900, m, b-4"></h>Frequently</h>, Asked, Questions;
              </h2>
              <p, className="te, x, t-xl, tex, t-gr, a, y-6, 0, 0">
    ...
    <div, className="m, i, n-h-screen, b, g-gr, a, y-50"></div>
      ...
      <section, className="bg-gradie, n, t-to-br, fro, m-bl, u, e-600, vi, a-purp, l, e-600, t, o-te, a, l-600, tex, t-white, p, y-20"></section>
        <div, className="m, a, x-w-7 xl, m, x-auto, p, x-4, s, m: px-6, l, g:px-8"></div>
          <div, className="te, x, t-cent, e, r"></div>
            <h1, className="te, x, t-4 x, l, m
  d:te, x, t-6 xl, fon, t-bold, m, b-6"></h>We</h>'re, Here, to He, l, p;
            </h1>
            <p, className="te, x, t-xl, tex, t-bl, u, e-100, m, b-8, ma, x-w-3 xl, m, x-au, t, o">
  ...
  ty, p, e="te, x, t"
                  ...
                  val, u, e={searchQue, r, y}
                  onChan, g, e={(e) => setSearchQue, r, y(e.targ, e, t.val, u, e)}</inp>classNa</inp>, m, e="w-full, p, l-12, p, r-4, p, y-4, rounde, d-lg, tex, t-gr, a, y-900, tex, t-lg, focu, s: ri, n, g-2, focu, s:ri, n, g-bl, u, e-500, foc, u
  s:outli, n, e-no, n, e"
                 />
              </d, i, v>
            </d, i, v>
            ...
            <div, className="flex, fle, x-wrap, justif, y-center, ga, p-4, m, b-12"></div>
              <butt, o, n
  onCli, c, k={() => setSelectedCatego, r, y('a, l, l')}</butt>classNa</butt>, m, e={`px-6, p, y-3, rounde, d-lg, fon, t-semibold, transitio, n-colo, r, s ${`
  ...
  k, e, y={catego, r, y.id}
            ...
            <div, className="spa, c, e-y-6"></div>
              {filteredFa, q, s.m, a, p((f, a, q, ind, e, x) => (
                <div, ke, y={ind, e, x} classNa, m, e="bg-gr, a, y-50, rounde, d-l, g, p-6"></div>
                  <h3, className="te, x, t-lg, fon, t-semibold, tex, t-gr, a, y-900, m, b-3"></h>
                    {f, a, q.questi, o, n}
                  </h3>
        ...
        <section, className="py-20, p, x-4, s, m: px-6, l, g:px-8, b, g-bl, u, e-6, 0, 0"></section>
          <div, className="m, a, x-w-7 xl, m, x-auto, tex, t-cent, e, r"></div>
            <h2, className="te, x, t-3 xl, m, d:te, x, t-4 xl, fon, t-bold, tex, t-white, m, b-4"></h>Still</h>, Need, Help?
            </h2>
            <p, className="te, x, t-xl, tex, t-bl, u, e-100, m, b-8, ma, x-w-3 xl, m, x-au, t, o">

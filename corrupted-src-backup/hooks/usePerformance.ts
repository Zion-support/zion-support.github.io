...
const metrics: PerformanceMetrics ={,
        renderTime;
        componentMountTime: performance.now() - mountTimeRef.current;} isSlowRender};
...
const navigation = performance.getEntriesByType('navigation')
        ...
        if (navigation) {;
const metrics ={domContentLoaded: navigation.domContentLoadedEventEnd - navigation.domContentLoadedEventStart;

...
;
  ...
  y: 0
          ...
          >
            ...
            <p className="text-xl text-slate - 300 max - w-3xl mx - auto mb-8">
              Professional onsite technical support with certified engineers.We bring expertise directly to your location for immediate problem resolution.</p>
  ...
  delay: 0.2
          ...
          <p className="text-slate - 300 max - w-4xl mx -auto">
            ...
            systems are running at peak performance.</p>
        </motion.div>
      </div>
  ...
  delay: 0.3
          ...
          >
            ...
            <p className="text-xl text-slate - 300 max - w-2xl mx -auto">
              ...
              handle all aspects of your IT infrastructure.</p>
          </motion.div>
  ...
  delay: 0.4 + index * 0.1
              ...
              >
                ...
                <ul className="space - y-2">
                  {service.features.map((feature, idx) => (<li key={idx} className="flex items - center text-sm text-slate -400">
  ...
  delay: 0.6 + index * 0.1
              ...
              <div className="space - y-4">
                <div className="space - y-3">
                  ...
                  {area.areas.map((location, idx) => (<div key={idx} className="flex items - center space - x-3">
  ...
  delay: 0.7
          ...
          >
            ...
            <p className="text-xl text-slate - 300 max - w-2xl mx -auto">
              ...
              with our comprehensive onsite support services.</p>
          </motion.div>
  ...
  delay: 1.1
          ...
          >
            ...
            <p className="text-xl text-slate - 300 max - w-2xl mx -auto">
              ...
              guaranteed response times based on priority levels.</p>
          </motion.div>
  ...
  delay: index * 0.1
              ...
              >
                <div className={`w-16 h-16 rounded-full flex items - center justify - center mx - auto mb-4 ${item.priority === 'Critical' ? 'bg-red - 500' :

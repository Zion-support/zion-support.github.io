...
export default function Blog() {const [searchQuery, setSearchQuery] = useState("")const [selectedCategory, setSelectedCategory] = useState("All Categories")const [posts, setPosts] = useState([...BLOG_POSTS])useEffect(() => {const interval = setInterval(() => {setPosts(prev => [...prev, generateRandomBlogPost()])}, 120000)// every 2 minutes;
    ...
    const filteredPosts = posts.filter(post => {const matchesSearch = post.title.toLowerCase().includes(searchQuery.toLowerCase()) ||;
    ...
    const featuredPosts = posts.filter(post => post.isFeatured)return (<>;
          ...
          {featuredPosts.length > 0 && (<div className="mb-16">;
              ...
              <div className="grid grid-cols-1 lg: grid-cols-2 gap-8">;
                <div className="aspect-video overflow-hidden rounded-lg">;
                  <img src={featuredPosts[0].featuredImage} alt={featuredPosts[0].title} className="object-cover w-full h-full hover: scale-105 transition-transform duration-300" onError={(e) => {const target = e.currentTarget;
                ...
                <div className="flex flex-col justify-center">;
                  ...
                  <div className="flex items-center mb-6">;
                    <img src={featuredPosts[0].author.avatarUrl} alt={featuredPosts[0].author.name} className="w-10 h-10 rounded-full mr-3" onError={(e) => {const target = e.currentTarget;
                target.src = "/images/blog-placeholder.svg";
            }}/>;
                    <div>;
...
export default function Blog() {return (<div className="min-h-screen bg-background p-8">;

  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray - 300 mb-8 max - w-4xl mx -auto">
                ...
                data analytics, and security solutions designed to transform your business.</p>
                  ...
                  >
                    ...
                    <div  className="mb-4">
                      ...
                      <ul className="space - y-1">
                        {service.features.slice(0, 3) .map((feature, featureIndex) => (<li key={featureIndex} className="text-blue - 300 text-sm flex items -center">
                    ...
                    <div  className="mb-4">
                      ...
                      <ul className="space - y-1">
                        {service.benefits.slice(0, 2) .map((benefit, benefitIndex) => (<li key={benefitIndex} className="text-green - 300 text-sm flex items -center">
                            <span className="text-green - 400 mr-2">🚀</span>
                            {benefit}
                          </li>) ) }
                      </ul>

...
const statuses = ['Allupcoming', 'past'],
  ...
  return (<div className="min - h-screen bg-gradient - to - br from - zinc - 900 via - zinc - 800 to - zinc -700">
        ...
        <div className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-zion - slate - light max - w-4xl mx -auto">
              ...
              events, workshops, and webinars.</p>
          </motion.div>
        </div>
      </section>
                  ...
                  >
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid grid - cols - 1 gap-1">
                        {event.highlights.slice(0, 3) .map((highlight, idx) => (<div
                            key={idx}
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex - wrap gap-2">
                        {event.speakers.map((speaker, idx) => (<span
                            key={idx}
      ...
      {/* Past Events */}
      {pastEvents.length > 0 && (<section className="py-16">
          <div className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}

...
,
        ...
        },
        {
            ...
            features["Advanced question types",
                "Logic branching",
                "Response analytics",
                "Custom themes",
                "Data export"
    ...
    return (<div className="min - h-screen bg-gradient - to - br from - zion - blue - dark via - zion - slate to - zion - blue -dark">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative container mx - auto px-4 py-20 text-center">
          ...
          <p className="text-xl md:text-2xl text-zion - slate - light mb-8 max - w-4xl mx -auto">
            Discover powerful, affordable software solutions designed for growing businesses.From marketing automation to project management, find the perfect tools to scale your operations.</p>
        ...
        <div className="grid grid - cols - 1 md:grid - cols - 3 gap-8">
          <div className="text-center p -6">
            ...
            <p className="text-zion - slate -light">
              Start small and scale up as your business grows with transparent, predictable pricing.</p>
          </div>
          ...
          <div className="text-center p -6">
            ...
            <p className="text-zion - slate -light">
              Get up and running in days, not months, with intuitive interfaces and comprehensive onboarding.</p>
          </div>
          ...
          <div className="text-center p -6">
            ...
            <p className="text-zion - slate -light">
              Bank - level security and compliance standards to protect your business data and customer information.</p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx - auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-zion - slate - light max - w-2xl mx -auto">
            Understand the differences and choose the right solution for your business needs.</p>
        </div>
      ...
      <div className="container mx - auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-zion - slate - light mb-8 max - w-2xl mx -auto">
            Our team of experts can help you identify the right tools for your business needs and guide you through implementation.Get in touch today for personalized recommendations.</p>

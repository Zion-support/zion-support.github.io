...
,
          ...
          <div  className="flex flex - col lg:flex - row gap-6 mb-8">
            ...
            <div  className="flex flex - wrap gap-3">
              {categories.map((category) => (<button     key={category.id}
                  ...
                  className={`flex items - center gap-2 px-4 py-2 rounded-lg border transition - all ${activeCategory === category.id
                ...
                >
                  ...
                  <div  className="mb-4">
                    ...
                    <div  className="space - y-1">
                      {service.benefits.slice(0, 2) .map((benefit, idx) => (<div  key={idx} className="flex items - center text-xs text-slate -300">
  ...
  delay: 0.2
            ...
            >
              Our team of experts is ready to help you choose the right services and pricing plan.Get in touch today for a personalized consultation.</motion.p>
        ...
        <div  className="container mx - auto px-4 text-center">
          <div  className="max - w-3xl mx -auto">
            <div  className="text-slate - 300 mb-6">
              <strong > Zion Tech Group</strong> - Your partner in digital transformation and innovation.Visit us at{' '}
              <a
              ...
              {' '}to explore our full range of services and solutions.</div>
            <div>

...
export default function Page() {
        ...
        <div className="max - w-7xl mx - auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              Transform your business with intelligent automation that runs 24 / 7.Our platform orchestrates your entire business operations autonomously,
              driving efficiency and growth.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              a truly intelligent and self - optimizing business environment.</p>
          </motion.div>
        ...
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              truly autonomous operations that work around the clock.</p>
          </div>
        ...
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
              Discover the powerful capabilities that make our platform truly autonomous.</p>
          </div>
        ...
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 400 max - w-2xl mx -auto">
              See measurable improvements in your business operations and bottom line.</p>
          </div>
        ...
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
              ...
              to create a truly autonomous business environment.</p>
          </div>
        ...
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
              ...
              automates and optimizes every aspect of your business.</p>
          </div>
          ...
          <div className="grid grid - cols - 1 lg:grid - cols - 2 gap-16 items -center">
            <div>
              ...
              <p className="text-xl text-gray - 300 mb-8">
                ...
                business operations platform.Let AI handle the routine while you focus on strategy.</p>
              <div className="space - y-4">
        ...
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
              ...
              automation solutions for your specific business needs.</p>
          </div>
        ...
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
              ...
              and cloud computing to deliver enterprise - grade performance.</p>
          </div>
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 3 gap-8">
            <div className="bg-slate - 800 / 50 backdrop - blur - lg rounded-xl p - 8 border border-white / 10">
              ...
              <p className="text-gray - 300 text-lg mb-4">
                Advanced algorithms that learn from your business processes and continuously improve performance.</p>
            ...
            <div className="bg-slate - 800 / 50 backdrop - blur - lg rounded-xl p - 8 border border-white / 10">
              ...
              <p className="text-gray - 300 text-lg mb-4">
                Scalable, secure, and reliable cloud infrastructure that grows with your business.</p>
              <ul className="space - y-2 text-gray -300">
            ...
            <div className="bg-slate - 800 / 50 backdrop - blur - lg rounded-xl p - 8 border border-white / 10">
              ...
              <p className="text-gray - 300 text-lg mb-4">
                Bank - level security with comprehensive compliance and audit capabilities.</p>
              <ul className="space - y-2 text-gray -300">
                <li>• SOC 2 Type II</li>
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap-8">
            <div className="bg-white / 10 backdrop - blur - md rounded-xl p - 8 border border-white / 20 hover:border-zion - cyan / 50 transition - all duration - 300 hover:transform hover:scale -105">
              ...
              <p className="text-zion - slate - light leading -relaxed">
                Intelligent bots that learn from your business processes and continuously optimize operations.</p>
            </div>
            ...
            <div className="bg-white / 10 backdrop - blur - md rounded-xl p - 8 border border-white / 20 hover:border-zion - cyan / 50 transition - all duration - 300 hover:transform hover:scale -105">
              ...
              <p className="text-zion - slate - light leading -relaxed">
                Real - time insights and predictive analytics to optimize business performance and decision - making.</p>
            </div>
            ...
            <div className="bg-white / 10 backdrop - blur - md rounded-xl p - 8 border border-white / 20 hover:border-zion - cyan / 50 transition - all duration - 300 hover:transform hover:scale -105">
              ...
              <p className="text-zion - slate - light leading -relaxed">
                Seamless integration with your team workflows and enhanced collaboration tools.</p>
            </div>
            ...
            <div className="bg-white / 10 backdrop - blur - md rounded-xl p - 8 border border-white / 20 hover:border-zion - cyan / 50 transition - all duration - 300 hover:transform hover:scale -105">
              ...
              <p className="text-zion - slate - light leading -relaxed">
                Bank - grade security with role - based access control and comprehensive audit trails.</p>
            </div>
            ...
            <div className="bg-white / 10 backdrop - blur - md rounded-xl p - 8 border border-white / 20 hover:border-zion - cyan / 50 transition - all duration - 300 hover:transform hover:scale -105">
              ...
              <p className="text-zion - slate - light leading -relaxed">
                Process thousands of operations per second with our optimized AI algorithms.</p>
            </div>
            ...
            <div className="bg-white / 10 backdrop - blur - md rounded-xl p - 8 border border-white / 20 hover:border-zion - cyan / 50 transition - all duration - 300 hover:transform hover:scale -105">
              ...
              <p className="text-zion - slate - light leading -relaxed">
                Scale your operations globally with our distributed cloud infrastructure.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid - cols - 1 lg:grid - cols - 2 gap-12">
            <div className="space - y-8">
              <div className="bg-white / 10 backdrop - blur - md rounded-xl p - 8 border border-white / 20">
                ...
                <p className="text-zion - slate - light leading - relaxed mb-4">
                  Automate invoice processing, expense management, and financial reporting with AI - powered accuracy.</p>
              ...
              <div className="bg-white / 10 backdrop - blur - md rounded-xl p - 8 border border-white / 20">
                ...
                <p className="text-zion - slate - light leading - relaxed mb-4">
                  Streamline recruitment, onboarding, and employee management with intelligent automation.</p>
                <ul className="space - y-2 text-zion - slate -light">
                  <li className="flex items - center gap-2">
            ...
            <div className="space - y-8">
              <div className="bg-white / 10 backdrop - blur - md rounded-xl p - 8 border border-white / 20">
                ...
                <p className="text-zion - slate - light leading - relaxed mb-4">
                  Enhance customer experience with AI - powered support and automated issue resolution.</p>
                <ul className="space - y-2 text-zion - slate -light">
                  <li className="flex items - center gap-2">
              ...
              <div className="bg-white / 10 backdrop - blur - md rounded-xl p - 8 border border-white / 20">
                ...
                <p className="text-zion - slate - light leading - relaxed mb-4">
                  Optimize inventory, predict demand, and streamline logistics with predictive AI.</p>
                <ul className="space - y-2 text-zion - slate -light">
                  <li className="flex items - center gap-2">
          ...
          <div className="grid grid - cols - 1 lg:grid - cols - 2 gap-16 items -center">
            <div>
              ...
              <p className="text-xl text-gray - 300 mb-8 leading -relaxed">
                ...
                to financial management, all running autonomously with AI oversight.</p>
        ...
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              with specialized solutions for your specific business needs.</p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate -800 / 30">
        <div className="max - w-4xl mx - auto text-center">
          ...
          <p className="text-xl text-gray - 300 mb-8">
            ...
            autonomous platform.Start your automation journey today.</p>
          <div className="flex flex - col sm:flex - row gap-4 justify -center">
            <Link to="/contact" className="inline - flex items - center px-8 py-4 bg-gradient - to - r from - green - 600 to - emerald - 600 text-white font - semibold rounded-lg hover:from - green - 700 hover:to - emerald - 700 transition - all duration -300">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
              Explore our resources to understand how autonomous operations can transform your business.</p>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="max - w-4xl mx - auto text-center">
          ...
          <p className="text-xl text-gray - 400 mb-8">
            Join the autonomous operations revolution and transform your business efficiency today.</p>
          <div className="flex flex - col sm:flex - row gap-4 justify -center">
            ...
            <p className="text-xl text-gray - 300 mb-8">
              Join the autonomous business revolution and transform your operations with AI - powered intelligence.</p>
            <div className="flex flex - col sm:flex - row gap-4 justify -center">
          ...
          <div className="max - w-4xl mx - auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="bg-gradient - to - r from - green - 500 / 10 to - emerald - 500 / 10 border border-green - 500 / 30 rounded-3xl p -12">
              ...
              <p className="text-xl text-gray - 300 mb-8">
                ...
                and discover the unlimited potential of AI - powered business management.</p>
              <div className="flex flex - col sm:flex - row gap-4 justify -center">
      ...
      <div className="min - h-screen bg-gradient - to - br from - black via - gray - 900 to - blue -900">
          ...
          <div className="max - w-7xl mx - auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl md:text-2xl text-cyan - 300 mb-8 max - w-4xl mx -auto">
                Transform your business with AI - powered automation that works 24 / 7.Streamline operations, reduce costs, and boost efficiency across your entire organization.</p>
              <div className="flex flex - col sm:flex - row gap-4 justify -center">
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max - w-7xl mx -auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
                Our autonomous platform combines cutting - edge AI with business process automation to deliver unprecedented operational efficiency.</p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray -800 / 30">
          <div className="max - w-7xl mx -auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
                Discover how our autonomous platform is revolutionizing business operations across industries.</p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max - w-4xl mx - auto text-center">
            ...
            <p className="text-xl text-gray - 300 mb-8">
              Join thousands of businesses that have transformed their operations with our autonomous platform.</p>
            <div className="flex flex - col sm:flex - row gap-4 justify -center">
              <Link to="/contact" className="inline - flex items - center px-8 py-4 bg-gradient - to - r from - cyan - 500 to - blue - 600 text-white font - semibold rounded-lg hover:from - cyan - 600 hover:to - blue - 700 transition - all duration - 300 transform hover:scale -105">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max - w-4xl mx - auto text-center">
          ...
          <p className="text-xl text-gray - 300 mb-8 leading -relaxed">
            ...
            with our autonomous platform.</p>
          ...
          <div className="flex flex - col sm:flex - row gap-4 justify -center">
            ...
            <Link to="/pricing" className="inline - flex items - center px-8 py-4 border border-green - 500 text-green - 400 hover:bg-green - 500 hover:text-white font - semibold rounded-lg transition - all duration -200">
              View Pricing Plans
            </Link > const testimonials = [{name}: "Operations Director",
        ...
        <div className="relative z - 10 max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max - w-4xl mx -auto">
            ...
            <p className="text-xl lg:text-2xl text-gray - 300 mb-8 max - w-3xl mx -auto">
              Transform your business operations with our revolutionary autonomous platform.Let AI manage your business 24 / 7 with intelligent automation and decision - making.</p>
        ...
        <div className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              unprecedented business operations capabilities.</p>
          </div>
      ...
      <section className="py-20 relative bg-gradient - to - br from - gray - 900 / 50 to -black / 50">
        <div className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              From financial management to supply chain optimization, our platform handles every aspect of business operations.</p>
          </div>
      ...
      <section className="py-20 relative">
        <div className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Flexible pricing options designed to scale with your business operations and automation needs.</p>
          </div>
      ...
      <section className="py-20 relative bg-gradient - to - br from - gray - 900 / 50 to -black / 50">
        <div className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              See how forward - thinking companies are transforming their operations with our autonomous platform.</p>
          </div>
      ...
      <section className="py-20 relative">
        <div className="max - w-4xl mx - auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="p - 12 rounded-3xl bg-gradient - to - br from - green - 500 / 20 to - cyan - 500 / 20 border border-green -400 / 50">
            ...
            <p className="text-xl text-gray - 300 mb-8">
              Join the autonomous revolution and experience unprecedented business efficiency and scalability.</p>

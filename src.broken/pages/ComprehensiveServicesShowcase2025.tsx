        ...
        <div  className="relative max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-zion - slate - light mb-8 max - w-4xl mx -auto">
              ...
              transform your business and drive innovation in the digital age.</p>
          ...
          <div  className="bg-zion - blue - dark / 50 backdrop - blur - sm rounded-2xl p - 6 border border-zion -purple / 30">
            ...
            <div  className="flex flex - wrap justify - center gap-4">
              {categories.map((category) => (<button     key={category.id}
                  ...
                  className={`flex items - center space - x-2 px-6 py-3 rounded-lg font - medium transition - all duration - 300 ${selectedCategory === category.id
                ...
                <button     onClick={ () => setViewMode('list') }
                  className={`flex - 1 px-3 py-2 rounded-md text-sm font - medium transition - colors ${viewMode === 'list'
            ...
            {filteredServices.map((service, index) => (<motion.div
              ...
              >
                ...
                <div  className="flex items - start justify - between mb-4">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font - medium ${service.status === 'available' ? 'bg-green - 500 / 20 text-green - 400' :
        ...
        <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 text-center">
          <div  className="bg-gradient - to - r from - zion - cyan / 10 to - zion - purple / 10 rounded-3xl p - 12 border border-zion -cyan / 20">
            ...
            <p className="text-xl text-zion - slate - light mb-8 max - w-3xl mx -auto">
              ...
              our innovative services can make.</p>
            <div  className="flex flex - col sm:flex - row gap-4 justify -center">
              <Link
                to="/contact"
                className="bg-gradient - to - r from - zion - cyan to - zion - purple text-white px-8 py-4 rounded-lg font - semibold text-lg hover:from - zion - cyan - light hover:to - zion - purple - light transition - all duration - 300 shadow-lg hover:shadow-xl"
            ...
            >
              ...
              <div  className="mt-8">
                ...
                <div  className="grid grid - cols - 1 md:grid - cols - 2 gap-4">
                  {selectedService.useCases.map((useCase, index) => (<div  key={index} className="bg-zion - blue - darker rounded-lg p - 4 border border-zion -purple / 20">

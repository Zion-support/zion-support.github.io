        ...
        <div  className="max - w-7xl mx -auto">
          ...
          >
            {filteredServices.map(service => (<motion.div
                ...
                className={`bg-slate - 800 / 50 backdrop - blur - xl border border-slate - 700 / 50 rounded-2xl overflow-hidden hover:border-cyan - 500 / 50 transition - all duration - 300 hover:shadow-2xl hover:shadow-cyan - 500 / 20 ${viewMode === 'list' ? 'flex' : ''
                }`}
              >

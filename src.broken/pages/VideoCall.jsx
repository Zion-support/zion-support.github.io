        ...
        {!hasJoined ? (<div className="flex flex - col items - center justify - center h-96 bg-gradient - to - br from - blue - 900 / 30 to - purple - 900 / 30 rounded-lg p -8">
            ...
            <div className="bg-gray - 900 rounded-lg p -6">
              <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap-4 mb-6">
                {participants.map(participant => (<div key={participant.id} className="relative">
                    <div className="bg-gray - 800 rounded-lg p - 4 text-center">
                      <div className="w-full h-32 bg-gray - 700 rounded-lg mb-3 flex items - center justify -center">
                        {participant.isVideoEnabled ? (<div className="text-gray - 400 text-2xl">📹</div>) : (<div className="text-gray - 400 text-2xl">👤</div>) }
                      </div>

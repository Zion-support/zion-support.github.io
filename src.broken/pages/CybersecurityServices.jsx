      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="container mx - auto relative z - 10 text-center">
          ...
          <p className="text-xl md:text-2xl text-zion - slate - light mb-8 max - w-4xl mx -auto">
            Protect your business from evolving cyber threats with our comprehensive security services.From penetration testing to incident response, we've got you covered 24 / 7.</p>
        ...
        <div className="container mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              Our expert cybersecurity team provides a full range of security services to protect your business assets and data.</p>
          </div>
      ...
      <section className="py-20 px-4 bg-zion - slate -dark / 30">
        <div className="container mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              From network security to compliance, we provide comprehensive protection across all aspects of your infrastructure.</p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              Choose the security plan that fits your business needs.All plans include our core cybersecurity features.</p>
          </div>
      ...
      <section className="py-20 px-4 bg-zion - slate -dark / 30">
        <div className="container mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              See what our clients say about our cybersecurity expertise and commitment to protecting their businesses.</p>
          </div>
      ...
      <section className="py-20 px-4 bg-gradient - to - r from - zion - purple / 20 via - zion - cyan / 20 to - zion -blue / 20">
        <div className="container mx - auto text-center">
          ...
          <p className="text-xl text-zion - slate - light mb-8 max - w-3xl mx -auto">
            Don't wait until it's too late.Get expert cybersecurity protection today and sleep soundly knowing your business is secure.</p>
          <div className="flex flex - col sm:flex - row gap-4 justify -center">
            <Button asChild size="lg" className="bg-gradient - to - r from - zion - purple to - zion - purple - dark hover:from - zion - purple - light hover:to - zion - purple text-white px-8 py-4 text-lg">
              <Link to="/contact">
                Get Security Assessment < ArrowRight className="ml-2 h-5 w-5"/>

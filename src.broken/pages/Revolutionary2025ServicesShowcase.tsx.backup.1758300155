...
export default function Page() {
          ...
          <div  className="flex flex - col lg:flex - row gap-6 items - center justify -between">
            ...
            <div  className="flex gap-2">;
              ...
              <button     onClick={ () => setViewMode('comparison') }
                className={`p - 3 rounded-lg transition - colors ${viewMode === 'comparison'
                    ? 'bg-cyan - 500 text-white'
                    : 'bg-slate - 800 text-gray - 400 hover:text-white'
                }`}
  ...
  delay: index * 0.1
                  ...
                  <div  className="space - y-2 mb-6">
                    {service.features.slice(0, 3) .map((feature, idx) => (<div  key={idx} className="flex items - center text-gray -400">
  ...
  delay: index * 0.1
          ...
          {viewMode === 'comparison' && (<div  className="space - y-8">
              ...
              {selectedServicesData.length > 0 ? (<div  className="overflow-x-auto">

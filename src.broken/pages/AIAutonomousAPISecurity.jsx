...
export default function Page() {
          ...
          <div className="mb-16">
            ...
            <div className="grid md: grid - cols - 4 gap-6">
              {['REST API SecurityGraphQL Security',
                'SOAP API SecurityAuthentication Security',
                'Authorization SecurityRate Limiting Security',
                'Input Validation SecurityOutput Encoding Security'
              ].map (type => (<div
                  key={type}

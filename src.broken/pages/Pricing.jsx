        ...
        <div className="max - w-7xl mx - auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              ...
              with a free trial and scale as you grow.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max - w-7xl mx -auto">
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap-8">
            {pricingTiers.map ( (tier, index) => (<div
                key={index}
                className={`bg-slate - 800 / 50 border rounded-xl p - 8 ${tier.popular
              ...
              >
                ...
                <ul className="space - y-3 mb-8">
                  {tier.features.map((feature, idx) => (<li
                      key={idx}
                ...
                <a
                  href={tier.link}
                  className={`block w-full text-center py-3 px-6 rounded-lg font - semibold transition - all ${tier.popular

...
const SystemStatus: React.FC = () => {
  ...
  return (<div  className="min - h-screen bg-gradient - to - br from - slate - 900 via - slate - 800 to - slate -900">
        ...
        <div  className="container mx - auto px-4 relative z -10">
          <div  className="text-center max - w-4xl mx -auto">
            ...
            <div  className="inline - flex items - center px-6 py-3 bg-slate - 800 / 50 border border-slate - 700 / 50 rounded-xl mb-8">
              ...
              <div  className={`inline - flex items - center px-3 py-1 rounded-full text-sm font - medium ${getStatusColor (overallStatus) }`}
              >
      ...
      {/* Recent Incidents */}
      {incidents.length > 0 && (<section className="py-20">
          <div  className="container mx - auto px-4">
            <div  className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl font - bold text-white mb-6">
                Recent Incidents
            ...
            <div  className="max - w-4xl mx -auto">
              {incidents.map((incident, index) => (<motion.div
                  key={incident.id}
                  ...
                  <div  className="flex items - start justify - between mb-4">
                    <div  className="flex -1">
                      <div  className="flex items - center mb-2">
                        ...
                        <div  className={`inline - flex items - center px-2 py-1 rounded-full text-xs font - medium ${getSeverityColor(incident.severity) }`}
                        >
                          {incident.severity}
                        </div>
                      </div>

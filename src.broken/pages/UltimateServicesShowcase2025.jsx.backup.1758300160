      ...
      <div className="container mx - auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray - 300 max - w-4xl mx -auto">
            Discover our comprehensive portfolio of innovative micro SAAS services, IT solutions, and AI - powered platforms.Transform your business with cutting - edge technology solutions designed for the future.</p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient - to - r from - cyan - 900 / 50 to - blue - 900 / 50 rounded-2xl p - 8 border border-cyan -500 / 30">
            ...
            <p className="text-xl text-gray - 300 mb-6 max - w-3xl mx -auto">
              Our team of experts is ready to help you implement these cutting - edge solutions.Get in touch today to discuss how we can accelerate your digital transformation journey.</p>

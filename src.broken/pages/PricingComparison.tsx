...
,
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray - 300 mb-8 max - w-4xl mx -auto">
                ...
                come with a 14 - day free trial and flexible pricing options.</p>
              ...
              <div  className="flex items - center justify - center gap-4 mb-8">
                ...
                <button     onClick={ () => setSelectedPlan(selectedPlan === 'monthly' ? 'yearly' : 'monthly') }
                ...
                <span className={`text-lg ${selectedPlan === 'yearly' ? 'text-white' : 'text-gray - 400'}`}>
                  Yearly < span className="ml-2 text-sm text-green - 400 font -medium">
                    Save up to 20%
                  </span>
                </span>
              </div>
              ...
              >
                <div  className="text-center mb-16">
                  ...
                  <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
                    Choose the plan that best fits your business needs and scale as you grow.</p>
                </div>
  ...
  delay: planIndex * 0.1
                              ...
                              viewport={{ once: true }}
                              className={`relative rounded-xl p - 8 transition - all duration - 300 ${plan.popular
                            ...
                            >
                              ...
                              <div  className="text-center mb-8">
                                ...
                                {selectedPlan === 'yearly' && (<div  className="text-sm text-green -400">
                              ...
                              <div  className="space - y-3">
                                <Link
                                  to="/contact"
                                  className={`block w-full py-3 px-6 rounded-lg font - semibold text-center transition - all duration - 300 ${plan.popular
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl text-gray - 300 mb-12">
                Our AI - powered solutions deliver measurable business impact with transparent pricing.</p>
              ...
              <div  className="bg-white / 10 backdrop - blur - sm rounded-lg p - 8 border border-white / 20">
                ...
                <p className="text-gray - 300 mb-6">
                  We offer custom pricing for enterprise clients and specialized requirements.</p>
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl text-gray - 300 mb-8">
                Our team is here to help you choose the right plan and get you up and running quickly.</p>

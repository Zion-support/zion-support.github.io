        ...
        <div  className="relative max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              and provide personalized services.</p>
          </motion.div>
        </div>
      </div>
          ...
          <div  className="grid grid - cols - 1 lg:grid - cols - 2 gap-8 items -center">
            <div>
              ...
              <p className="text-gray - 300 mb-4">
                Cookies are small text files that are stored on your device when you visit our website.They help us provide you with a better experience by remembering your preferences,
                analyzing how you use our site, and personalizing content.</p>
              <p className="text-gray -300">
                We use cookies to make our website work properly, improve its functionality,
                and provide you with relevant content and advertisements.</p>
            </div>
        ...
        <div  className="container mx - auto px-6 relative z -10">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto leading -relaxed">
              We use cookies to enhance your browsing experience, analyze site traffic, and personalize content.Learn more about how we use cookies and manage your preferences.</p>
          </motion.div>
        </div>
      </section>
                ...
                <div  className="space - y-3">
                  {cookieDetails.map((cookie, index) => (<motion.div
                    ...
                    >
                      ...
                      <div>
                        <span className={`px-2 py-1 rounded text-xs font - medium ${cookie.type === 'essential' ? 'bg-blue - 500 / 20 text-blue - 400' :
            ...
            >
              <div  className="flex items - start justify - between mb-4">
                ...
                <div  className="ml-6 flex items -center">
                  {category.necessary ? (<div  className="flex items - center text-blue -400">
                      <CheckCircle className="w-6 h-6 mr-2" />
                      <span className="text-sm font -medium">Required</span>
                    </div>) : (<button     onClick={ () => handleCookieToggle(category.id) }
                      className={`flex items - center px-4 py-2 rounded-lg transition - colors ${cookiePreferences[category.id as keyof typeof cookiePreferences]
        ...
        <div  className="mt-12 bg-white / 10 backdrop - blur - lg rounded-2xl p -8">
          ...
          <div  className="text-center">
            <p className="text-gray - 300 mb-4">
              ...
              settings at any time by visiting this page again.</p>
            <p className="text-sm text-gray -400">
              Note: Some features of our website may not function properly if you disable certain cookies.</p>
          </div>
        </div>
      </div>
      ...
      <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-16">
        <div  className="grid grid - cols - 1 lg:grid - cols - 2 gap-8">
          <div  className="bg-white / 10 backdrop - blur - lg rounded-2xl p -6">
            ...
            <p className="text-gray - 300 mb-4">
              We are committed to protecting your privacy and ensuring the security of your personal data.Our cookie usage complies with applicable data protection laws and regulations.</p>
            <Link
              to="/privacy"
          ...
          <div  className="bg-white / 10 backdrop - blur - lg rounded-2xl p -6">
            ...
            <p className="text-gray - 300 mb-4">
              ...
              advertising networks, and social media platforms.These services have their own privacy policies.</p>
            <p className="text-sm text-gray -400">
              We recommend reviewing the privacy policies of these third - party services for more information.</p>
          </div>
        </div>
      </div>
          ...
          <div  className="space - y-6">
            <div  className="border-b border-white / 20 pb -4">
              ...
              <p className="text-gray -300">
                ...
                for up to 2 years depending on the type and purpose.</p>
            </div>
            ...
            <div  className="border-b border-white / 20 pb -4">
              ...
              <p className="text-gray -300">
                ...
                the functionality of our website and you may need to re - enter certain information.</p>
            </div>
            ...
            <div  className="border-b border-white / 20 pb -4">
              ...
              <p className="text-gray -300">
                ...
                of our marketing campaigns.You can opt out of these cookies using the preferences above.</p>
            </div>
      ...
      <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-16">
        <div  className="bg-gradient - to - r from - blue - 600 / 20 to - purple - 600 / 20 rounded-3xl p - 8 text-center">
          ...
          <p className="text-gray - 300 mb-8 max - w-2xl mx -auto">
            Our privacy team is here to help you understand how we use cookies and protect your data.Contact us for more information or to exercise your data rights.</p>

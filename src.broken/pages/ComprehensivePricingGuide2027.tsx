          ...
          <div className="max - w-7xl mx - auto text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-zion - slate - 300 mb-8 max - w-4xl mx - auto leading -relaxed">
                Discover our competitive pricing for cutting - edge AI and technology services.Compare our transparent pricing with market rates and see how much you can save.</p>
          ...
          <div className="max - w-7xl mx -auto">
            ...
            >
              ...
              <p className="text-xl text-zion - slate - 300 max - w-3xl mx -auto">
                ...
                competitive rates designed for businesses of all sizes.</p>
            </motion.div>
          ...
          <div className="max - w-4xl mx - auto text-center">
            ...
            >
              ...
              <p className="text-xl text-zion - slate - 300 mb-8">
                ...
                of our transparent pricing model.</p>

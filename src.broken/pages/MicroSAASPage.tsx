...
,
  ...
  y: 0
          ...
          <p className="text-xl text-zion - slate - light max - w-3xl mx - auto leading - relaxed mb-8">
            Build and scale your software - as - a-service business with our micro SAAS solutions.From custom applications to scalable architectures, we help you create successful SAAS products.</p>
          {/* Quick Stats */}
  ...
  delay: 0.3 ;
          ...
          <div className="text-center mb-8">;
            ...
            <p className="text-zion - slate - light max - w-2xl mx -auto">
              ...
              and how they can transform your business.</p>
          </div>

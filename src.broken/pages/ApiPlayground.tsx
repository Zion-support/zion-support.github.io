              ...
              <div  className="lg:col - span -1">
                <div  className="bg-slate - 800 / 50 backdrop - blur - sm rounded-xl p - 6 border border-slate -700 / 50">
                  ...
                  <div  className="space - y-4">
                    {apis.map ( (api, index) => (<motion.div
                        key={api.id}
                        initial={{ opacity: 0, x: -20 }}
                        animate={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.6, delay: index * 0.1 }}
                        className={`p - 4 rounded-lg border cursor - pointer transition - all duration - 300 ${selectedApi?.id === api.id
                      ...
                      >
                        ...
                        <div  className="flex items - center justify - between text-xs text-gray -400">
                          ...
                          {api.featured && (<span className="px-2 py-1 bg-yellow-500 / 20 text-yellow-400 rounded text-xs">
                              Featured
                            </span>) }
                        </div>
                      </motion.div>) ) }
                ...
                <div  className="bg-slate - 800 / 50 backdrop - blur - sm rounded-xl border border-slate -700 / 50">
                  ...
                  <div  className="flex border-b border-slate -700 / 50">
                    <button     onClick={ () => setActiveTab('playground') }
                      className={`px-6 py-3 text-sm font - medium transition - colors ${activeTab === 'playground'
                    ...
                    <button     onClick={ () => setActiveTab('documentation') }
                      className={`px-6 py-3 text-sm font - medium transition - colors ${activeTab === 'documentation'
                          ? 'text-blue - 400 border-b-2 border-blue - 400'
                          : 'text-gray - 400 hover:text-gray - 300'
                      }`}
                    >
                  ...
                  {/* Tab Content */}
                  <div  className="p -6">
                    {activeTab === 'playground' ? (<div>
                        {selectedApi ? (<div  className="space - y-6">
                            {/* API Info */}
                            ...
                            <div>
                              <div  className="flex items - center justify - between mb-3">
                                ...
                                <button     onClick={ () => copyToClipboard(requestBody) }
                            ...
                            <div>
                              ...
                              <div  className="bg-slate - 700 / 50 rounded-lg p - 4 mb-4">
                                ...
                                <div  className="space - y-2">
                                  {selectedApi.parameters.map((param: any, idx: number) => (<div  key={idx}
                                      ...
                                      >
                                        <div>
                                          ...
                                          {param.required && (<span className="text-red - 400 ml-2">
                                              *
                                            </span>) }
                                        </div>

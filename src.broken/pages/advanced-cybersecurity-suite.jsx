        ...
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              management to protect your digital assets.</p>
          </div>
          ...
          <div className="mb-16">
            <div className="bg-white / 10 backdrop - blur - lg rounded-xl p - 8 border border-white / 20">
              ...
              <p className="text-gray - 300 text-center mb-8 max - w-2xl mx -auto">
                ...
                industry standards and regulatory frameworks.</p>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid - cols - 1 md:grid - cols - 2 gap-8">
              <div className="bg-white / 10 backdrop - blur - lg rounded-xl p - 6 border border-white / 20">
                ...
                <ul className="space - y-3 text-gray -300">
                  <li className="flex items -start">
                    <span className="w-2 h-2 bg-green - 400 rounded-full mr-3 mt-2"></span > Protect critical business assets and data
                  </li>
                  <li className="flex items -start">
                    <span className="w-2 h-2 bg-green - 400 rounded-full mr-3 mt-2"></span > Maintain business continuity and reputation
                  </li>
                  <li className="flex items -start">
                    <span className="w-2 h-2 bg-green - 400 rounded-full mr-3 mt-2"></span > Reduce financial and operational risks
                  </li>
                  <li className="flex items -start">
                    <span className="w-2 h-2 bg-green - 400 rounded-full mr-3 mt-2"></span > Ensure regulatory compliance
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-white / 10 backdrop - blur - lg rounded-xl p - 6 border border-white / 20">
                ...
                <ul className="space - y-3 text-gray -300">
                  <li className="flex items -start">
                    <span className="w-2 h-2 bg-blue - 400 rounded-full mr-3 mt-2"></span > AI - powered threat detection and response
                  </li>
                  <li className="flex items -start">
                    <span className="w-2 h-2 bg-blue - 400 rounded-full mr-3 mt-2"></span > Unified security management platform
                  </li>
                  <li className="flex items -start">
                    <span className="w-2 h-2 bg-blue - 400 rounded-full mr-3 mt-2"></span > 24 / 7 security monitoring and support
                  </li>
                  <li className="flex items -start">
                    <span className="w-2 h-2 bg-blue - 400 rounded-full mr-3 mt-2"></span > Scalable architecture for enterprise growth
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="text-center">
            <div className="bg-white / 10 backdrop - blur - lg rounded-xl p - 8 border border-white / 20 max - w-4xl mx -auto">
              ...
              <p className="text-gray - 300 mb-6">
                Get comprehensive cybersecurity protection with our advanced suite.Contact us today to discuss your security needs and get a customized solution.</p>

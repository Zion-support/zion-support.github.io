...
const processSteps = [{
  ...
  delay: 0.2
            ...
            <h1 className="text-5xl md:text-6xl font - bold text-white mb-6">
              Retail < span className="text-gradient block">Solutions</span>
            </h1>

            <p className="text-xl text-zion - slate - light leading - relaxed mb-8">
              Transform your retail business with cutting - edge technology solutions.From e - commerce platforms to omnichannel experiences, we help retailers
  ...
  delay: index * 0.1
                ...
                <span className={`inline - block px-3 py-1 rounded-full text-sm font - semibold ${trend.impact === 'Critical'
  ...
  delay: index * 0.1
                ...
                <div className="flex flex - wrap gap-2 mb-4">
                  {solution.integrations.slice(0, 2) .map((integration, intIndex) => (<span
                      key={intIndex}
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 leading -relaxed">
              ...
              enhance customer experience, and drive growth in the digital marketplace.</p>

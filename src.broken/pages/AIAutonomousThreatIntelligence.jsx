          ...
          <div className="mb-16">
            ...
            <div className="grid md: grid - cols - 4 gap-6">
              {['Cyber Threat IntelligenceSecurity Threat Intelligence',
                'Network Threat IntelligenceMalware Threat Intelligence',
                'APT Threat IntelligenceVulnerability Intelligence',
                'Social Engineering IntelligenceInsider Threat Intelligence'
              ].map (type => (<div
                  key={type}

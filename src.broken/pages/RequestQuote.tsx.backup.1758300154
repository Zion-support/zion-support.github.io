        ...
        <div  className="container mx - auto px-6 relative z -10">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto leading -relaxed">
              ...
              timeline, and implementation plan tailored to your specific needs.</p>
          </motion.div>
        </div>
      </section>
                ...
                >
                  ...
                  <div  className="flex items - center justify - between mb-8">
                    {[1, 2, 3].map((step) => (<div  key={step} className="flex items -center">
                        <div  className={`w-10 h-10 rounded-full flex items - center justify - center font - bold text-sm ${formStep >= step
                            ? 'bg-gradient - to - r from - green - 400 to - blue - 500 text-white'
                            : 'bg-slate - 700 text-gray - 400'
                        }`}>
                          {step}
                        </div>
                        {step < 3 && (<div  className={`w-16 h-1 mx - 2 ${formStep > step ? 'bg-gradient - to - r from - green - 400 to - blue - 500' : 'bg-slate - 700'
                          }`}></div>) }
                      </div>) ) }
                  </div>
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div  className="grid grid - cols - 1 md:grid - cols - 2 gap-4">
                            {services.map((service) => (<div  key={service.id} className="relative">
                                <input
                                  type="checkbox"
                                  id={service.id}
                                ...
                                <label
                                  htmlFor={service.id}
                                  className={`block p - 4 rounded-lg border-2 cursor - pointer transition - all duration - 200 ${formData.services.includes(service.id) ? 'border-green - 400 bg-green - 400 / 10'
                        ...
                        <div>
                          ...
                          <div  className="grid grid - cols - 1 md:grid - cols - 3 gap-4">
                            {contactMethods.map((method) => (<div  key={method.value} className="relative">
                                <input
                                  type="radio"
                                  id={method.value}
                                ...
                                <label
                                  ...
                                  className={`block p - 4 rounded-lg border-2 cursor - pointer transition - all duration - 200 ${formData.preferredContact === method.value
                ...
                >
                  <div  className="bg-gradient - to - br from - slate - 800 / 50 to - slate - 700 / 50 rounded-2xl border border-slate - 600 / 50 p -6">
                    ...
                    <p className="text-gray - 300 text-sm mb-4">
                      Explore our comprehensive range of technology services and solutions.</p>

                    <div  className="space - y-3">
                      {services.map((service) => (<div  key={service.id} className="border border-slate - 600 / 50 rounded-lg overflow-hidden">
                          <button     onClick={ () => toggleServiceExpansion(service.id) }
                          ...
                          {expandedService === service.id && (<motion.div
                            ...
                            >
                              ...
                              <div  className="space - y-2">
                                {service.features.map((feature, index) => (<div  key={index} className="flex items - center text-gray - 300 text-sm">
        ...
        <div  className="container mx - auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 mb-8 max - w-2xl mx -auto">
              ...
              or to discuss your project in detail.</p>

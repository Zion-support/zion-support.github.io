...
const processSteps = [{
  ...
  const categories = ['AllLMS Platforms', 'Mobile DevelopmentVR / AR', 'AI & AnalyticsCommunication', 'Analytics'],
  ...
  delay: 0.2
            ...
            <h1 className="text-5xl md:text-6xl font - bold text-white mb-6">
              Education < span className="text-gradient block">Solutions</span>
            </h1>

            <p className="text-xl text-zion - slate - light leading - relaxed mb-8">
              Transform education with cutting - edge technology solutions.From learning management systems to immersive VR experiences,
              we help educational institutions deliver better learning outcomes.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 leading -relaxed">
              ...
              improve student engagement, and modernize your educational institution.</p>

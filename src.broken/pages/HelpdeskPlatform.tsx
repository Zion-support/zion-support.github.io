        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              Streamline your support operations with our comprehensive helpdesk
              platform.Manage tickets, collaborate with teams, and deliver
        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Our helpdesk platform provides everything you need to deliver
              exceptional customer support and manage internal IT operations
              efficiently.</p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white / 5">
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Comprehensive helpdesk solutions designed to improve support
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Seamlessly integrate with your existing tools and workflows for

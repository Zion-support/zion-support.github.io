        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              and delivering unprecedented value to organizations worldwide.</p>
          </motion.div>
        ...
        <div className="max - w-7xl mx -auto">
          ...
          <div className="grid grid - cols - 1 lg:grid - cols - 3 gap-8">
            {pricingTiers.map((tier, index) => (<motion.div
                ...
                transition={{ duration: 0.8, delay: index * 0.1 }}
                viewport={{ once: true }}
                className={`bg-white / 5 backdrop - blur - sm rounded-xl p - 8 border ${index === 1
              ...
              >
                ...
                <a
                  href="/contact"
                  className={`w-full inline - flex items - center justify - center px-6 py-3 rounded-lg font - semibold transition - colors ${index === 1
        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              transformation with our cutting - edge AI and technology solutions.</p>
          </motion.div>
        ...
        <div className="max - w-4xl mx - auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 mb-8">
              ...
              capabilities with our comprehensive suite of AI - powered solutions.</p>

...
export default function Page() {
        ...
        <div  className="p -6">
          ...
          <div  className="mb-4">
            ...
            <div  className="space - y-1">
              ...
              {service.features.length > 3 && (<button     onClick={ () => setExpandedService(expandedService === service.id ? null : service.id) }
  ...
  height: 0
                ...
                <div  className="space - y-1">
                  {service.features.slice(3) .map((feature, index) => (<div  key={index} className="flex items - center space - x-2">
                      <CheckCircle className="w-4 h-4 text-green -500" />
                      <span className="text-sm text-gray - 600 dark:text-gray -300">{feature}</span>
                    </div>) ) }
                </div>
          ...
          <div  className="border-t border-gray - 200 dark:border-slate - 700 pt -4">;
            <div  className="flex items - center justify - between mb-3">
              ...
              <span className={`px-2 py-1 rounded-full text-xs font - semibold ${service.status === 'active' ? 'bg-green - 100 text-green - 800' :
  ...
  y: 0
              ...
              Expanded Innovative Services < span className="block text-transparent bg-clip - text bg-gradient - to - r from - blue - 600 to - purple -600">
                2027
              </span>
            </motion.h1>
            <motion.p
  ...
  delay: 0.2
            ...
            >
              Discover our comprehensive portfolio of advanced micro SAAS, IT infrastructure, and AI services.From quantum cybersecurity to healthcare AI, explore cutting - edge solutions that drive innovation and growth.</motion.p>
  ...
  delay: 0.4
      ...
      <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-16">;
        ...
        {/* Services Grid / List */}
        {filteredServices.length > 0 ? (<div  className={viewMode === 'grid' ? 'grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap-8' : 'space - y-6'}>

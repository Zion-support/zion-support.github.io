          ...
          <div className="container mx - auto px-4 py-16">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-blue - 100 max - w-4xl mx -auto">
                ...
                we deliver exceptional mobile experiences that drive engagement and results.</p>
            </div>
              ...
              <div className="max - w-4xl mx -auto">
                <div className="bg-gradient - to - r from - blue - 600 / 20 to - purple - 600 / 20 backdrop - blur - sm rounded-lg border border-blue - 500 / 30 p - 8 text-center">
                  ...
                  <p className="text-blue - 100 mb-6 text-lg">
                    Access our services and manage your projects on the go with our mobile application.Available for iOS and Android devices.</p>
            ...
            <div className="max - w-4xl mx -auto">
              <div className="bg-white / 10 backdrop - blur - sm rounded-lg border border-white / 20 p - 8 text-center">
                ...
                <p className="text-blue - 100 mb-6 text-lg">
                  ...
                  exceptional experiences across all devices.</p>
                <div className="flex flex - col sm:flex - row gap-4 justify -center">

...
;
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray - 300 mb-8 max - w-4xl mx -auto">
                Transform your business with our cutting - edge AI - powered micro SAAS solutions.From code security to customer analytics, we deliver intelligent automation that drives real results.</p>
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
                Each service is designed to solve real business challenges with measurable outcomes and competitive pricing.</p>
            </motion.div>
                ...
                >
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space - y-2">
                      {service.features.map((feature, featureIndex) => (<li key={featureIndex} className="text-blue - 300 flex items -center">
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space - y-2">
                      {service.benefits.map((benefit, benefitIndex) => (<li key={benefitIndex} className="text-green - 300 flex items -center">
                          <span className="text-green - 400 mr-2">🚀</span>
                          {benefit}
                        </li>) ) }
                    </ul>
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
                We combine cutting - edge AI technology with industry expertise to deliver solutions that drive real business value.</p>
            </motion.div>
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl text-gray - 300 mb-8">
                Join leading organizations who trust our AI - powered platforms to drive innovation and growth.</p>

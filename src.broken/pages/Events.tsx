        ...
        <div  className="max - w-7xl mx - auto text-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font - bold text-white mb-6">
              Join Our < span className="text-transparent bg-clip - text bg-gradient - to - r from - zion - cyan to - zion -purple">
                {' '}Events
              </span>
            </h1>
            <p className="text-xl text-zion - slate - light mb-8 max - w-3xl mx -auto">
              Connect with industry experts, learn cutting - edge technologies, and network with
              professionals at our curated events, webinars, and conferences.</p>
          ...
          <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-zion - slate - light text-lg max - w-2xl mx -auto">
                Don't miss these must - attend events featuring industry leaders and cutting - edge topics.</p>
            </motion.div>
                  ...
                  <div  className="space - y-2">
                    {categories.map((category) => (<button     key={category.id}
                      ...
                      >
                        ...
                        {category.count > 0 && (<span className="text-xs opacity -75"> ({category.count}) </span>) }
                      </button>) ) }
                  </div>
                </div>

...
,
  ...
  scale: 1
          ...
          <p className="text-xl text-gray - 300 mb-8">
            Thank you for your interest in Zion Tech Group.We've received your demo request and will be in touch within 24 hours to confirm the details.</p>
  ...
  y: 0
            ...
            <h1 className="text-5xl md:text-6xl font - bold text-white mb-6">
              Schedule Your < span className="bg-gradient - to - r from - cyan - 400 via - blue - 500 to - purple - 600 bg-clip - text text-transparent">
                {' '}Demo
              </span>
            </h1>
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              Experience the future of technology with a personalized demonstration of our cutting - edge AI, quantum computing, and innovative solutions.</p>
  ...
  attendees: e.target.value
                  ...
                  <div>
                    ...
                    <div className="grid grid - cols - 1 md: grid - cols - 2 gap-3">
                      {availableServices.map((service) => (<label key={service.id} className="flex items - center gap-3 p - 3 bg-slate - 700 / 30 rounded-lg cursor - pointer hover:bg-slate - 700 / 50 transition -colors">
                          <input
                            type="checkbox"

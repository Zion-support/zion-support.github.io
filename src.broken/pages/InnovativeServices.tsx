...
,
  ...
  y: 0
            ...
            <h1 className="text-5xl md:text-7xl font - bold text-gradient mb-6">
              Cutting - Edge < span className="block text-zion -cyan">Innovations</span>
            </h1>
            <p className="text-xl md:text-2xl text-zion - slate - light max - w-4xl mx - auto mb-8">
              Discover the future of technology with Zion Tech Group's revolutionary innovations.From AI automation to quantum computing, we're building tomorrow's solutions today.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              ...
              and creating new possibilities for the future.</p>
          </motion.div>
                ...
                <div className="bg-zion - slate - dark / 50 backdrop - blur - xl border border-zion - cyan / 20 rounded-2xl p - 8 h-full hover:border-zion - cyan / 40 transition - all duration - 300 hover:shadow-2xl hover:shadow-zion -cyan / 20">
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space - y-2">
                      {innovation.features.map((feature, idx) => (<li key={idx} className="flex items - center text-zion - slate -light">
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space - y-2">
                      {innovation.benefits.map((benefit, idx) => (<li key={idx} className="flex items - center text-zion - slate -light">
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8">
              Join the future of technology with Zion Tech Group.Let's build something amazing together.</p>

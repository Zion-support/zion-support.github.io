...
export default function Page() {
  ...
  y: 0
            ...
            <p className="text-xl text-white / 90 mb-8 max - w-3xl mx - auto leading -relaxed">
              Make informed decisions with our comprehensive service comparison tool.Compare features, pricing, and complexity levels to find the perfect solution for your business.</p>
  ...
  y: 0
            ...
            <p className="text-lg text-zion - slate - light max - w-2xl mx -auto">
              ...
              with comprehensive analysis and expert insights.</p>
          </motion.div>

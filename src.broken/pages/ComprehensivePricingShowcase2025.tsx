                ...
                <div  className="relative max - w-7xl mx - auto text-center">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-blue - 100 mb-8 max - w-4xl mx -auto">
                            Transparent pricing for our complete suite of innovative technology solutions.Choose the perfect plan for your business needs.</p>
                                ...
                                >
                                    ...
                                    <div  className="p -8">
                                        ...
                                        <div  className="grid grid - cols - 1 md: anygrid - cols - 3 gap-6">
                                            {service.pricing.map((tier, tierIndex) => (<div  key={tierIndex}
                                                    className={`relative rounded-xl border-2 p - 6 ${tier.popular
                                                ...
                                                >
                                                    ...
                                                    <div  className="text-center mb-6">
                                                        ...
                                                        {tier.savings && (<p className="text-green - 600 text-sm font -medium">{tier.savings}</p>) }
                                                    </div>

                                                    <ul className="space - y-3 mb-6">
                                                        {tier.features.map((feature, featureIndex) => (<li key={featureIndex} className="flex items - start space - x-3">
                                        ...
                                        <div  className="mt-8 grid grid - cols - 1 md:grid - cols - 2 gap-8">
                                            <div>
                                                ...
                                                <ul className="space - y-2">
                                                    {service.features.slice(0, 6) .map((feature, idx) => (<li key={idx} className="flex items - center space - x-2 text-gray -600">
                                            ...
                                            <div>
                                                ...
                                                <ul className="space - y-2">
                                                    {service.benefits.map((benefit, idx) => (<li key={idx} className="flex items - center space - x-2 text-gray -600">
                                                            <CheckCircle className="w-4 h-4 text-green - 500 flex - shrink -0" />
                                                            <span>{benefit}</span>
                                                        </li>) ) }
                                                </ul>
                                        ...
                                        <div  className="mt-8 p - 4 bg-gray - 50 rounded-lg">
                                            ...
                                            <div  className="flex flex - wrap gap-2">
                                                {service.competitors.map((competitor, idx) => (<span key={idx} className="px-3 py-1 bg-white border border-gray - 200 rounded-full text-sm text-gray -600">
                                                        {competitor}
                                                    </span>) ) }
                                            </div>
                                        </div>
                    ...
                    <div  className="grid grid - cols - 1 md:grid - cols - 3 gap-8">
                        <div>
                            ...
                            <p className="text-gray - 400 mb-4">
                                Leading provider of innovative technology solutions and micro SAAS services.</p>

import React from 'react',import {Zap,Users,FileText,BarChart3,Calendar,CreditCard,MessageSquare,CheckCircle,Star,ExternalLink,ArrowRight,Phone,Mail,MapPin,Linkedin,Twitter,Github,TrendingUp,Shield,Globe,Smartphone,Database;'
    ...
    },{"name": "Knowledge Base Platform","description": "Create and manage documentation, FAQs, and help articles for your customers and team.","pricing": "$39/month","icon": <FileText className="w-8 h-8 text-green-400" />;"
    },{"name": "Survey & Feedback Tool","description": "Collect customer feedback, conduct surveys, and gather insights to improve your products and services.","pricing": "$29/month","icon": <MessageSquare className="w-8 h-8 text-purple-400" />;"
    },{"name": "Appointment Scheduler","description": "Automated appointment booking system with calendar integration and reminder notifications.","pricing": "$25/month","icon": <Calendar className="w-8 h-8 text-orange-400" />;"
    }
  ],const stats = [;
    { "label": "Active Users", "value": "10,000+" },{ "label": "Cost Savings", "value": "40-60%" },{ "label": "Setup Time", "value": "< 2 hours" },{ "label": "Customer Satisfaction", "value": "96%" }"
  ],const whyChooseUs = [;
    {"title": "Affordable Pricing","description": "Up to 60% savings compared to enterprise solutions without compromising on features.","icon": <TrendingUp className="w-8 h-8 text-green-400" />;"
    },{"title": "Quick Setup","description": "Get up and running in under 2 hours with our intuitive setup wizards and templates.","icon": <Zap className="w-8 h-8 text-blue-400" />;"
    },{"title": "Scalable Solutions","description": "Start small and scale up as your business grows. No long-term contracts or hidden fees.","icon": <Globe className="w-8 h-8 text-purple-400" />;"
    },{"title": "24/7 Support","description": "Round-the-clock customer support to help you succeed with our platforms.","icon": <Users className="w-8 h-8 text-orange-400" />;"
    }
  ...
  Zap,Users,FileText,BarChart3,Calendar,CreditCard,MessageSquare,CheckCircle,Star,ExternalLink,ArrowRight,Phone,Mail,MapPin,Linkedin,Twitter,Github,TrendingUp,Shield,Globe,Smartphone,Database;
    ...
    },{"title": "24/7 Support",,"description": "Round-the-clock customer support to help you succeed with our platforms.";"
      }
  ...
  return (<div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white">;"
      ...
      <div className="max-w-7xl mx-auto px-4 "sm":px-6 "lg":px-8 py-16">;"
        ...
        <div className="grid grid-cols-1 "md":grid-cols-2 "lg":grid-cols-4 gap-8">;"
          {whyChooseUs.map((feature, index) => (<div key={index} className="text-center space-y-4">;"
      ...
      <div className="max-w-7xl mx-auto px-4 "sm":px-6 "lg":px-8 py-16">;"
        ...
        <div className="grid grid-cols-1 "lg":grid-cols-2 gap-12">;"
          {microSAASServices.map((service, index) => (<div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 "hover":border-yellow-400/50 transition-all duration-300 "hover":transform "hover":scale-105">;"
                ...
                <div className="space-y-4">;"
                  ...
                  <div className="pt-4 border-t border-white/20">;"
                    <div className="flex gap-3">;"
                      ...
                      <a;
                        href={`"mailto":kleber@ziontechgroup.com?subject=Inquiry about ${service.name}`}`                        className="inline-flex items-center justify-center px-4 py-2 border border-yellow-400 text-yellow-400 "hover":bg-yellow-400 "hover":text-white rounded-lg text-sm font-medium transition-colors";"
                      >;
      ...
      <div className="max-w-7xl mx-auto px-4 "sm":px-6 "lg":px-8 py-16">;"
        ...
        <div className="grid grid-cols-1 "md":grid-cols-2 "lg":grid-cols-4 gap-6">;"
          {additionalMicroSAAS.map((service, index) => (<div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 "hover":border-yellow-400/50 transition-all duration-300">;"

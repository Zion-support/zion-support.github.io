  ...
  y: 0
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-4xl mx - auto mb-8">
              Experience the future of business technology with our revolutionary platform enhancements.From advanced AI services to cutting - edge performance analytics, discover how Zion Tech Group
              is transforming the digital landscape.</p>
  ...
  y: 0
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              business technology solution available today.</p>
          </motion.div>
  ...
  y: 0
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              for business technology solutions.</p>
          </motion.div>
  ...
  y: 0
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              that drive business success and user satisfaction.</p>
          </motion.div>
  ...
  y: 0
          ...
          >
            ...
            <p className="text-xl text-gray - 300 mb-8 max - w-2xl mx -auto">
              ...
              enhancements to drive growth and innovation.</p>
            <div className="flex flex - col sm:flex - row gap-4 justify -center">
              <Link
                to="/contact"
                className="bg-gradient - to - r from - purple - 600 to - pink - 600 text-white px-8 py-4 rounded-lg font - semibold hover:from - purple - 700 hover:to - pink - 700 transition - all duration - 300 text-lg flex items - center justify -center"

        ...
        <div className="max - w-7xl mx - auto text-center">
          ...
          >
            <h1 className="text-4xl md:text-6xl font - bold mb-6">
              Supply Chain < span className="text-transparent bg-clip - text bg-gradient - to - r from - blue - 400 to - cyan -400">
                {' '}
                Optimization
              </span>
            </h1>
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              ...
              that enhance visibility, efficiency, and performance across all
              operations
            </p>
        ...
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              From visibility to optimization, we provide end - to - end supply
              chain technology solutions for every industry
            </p>
          </div>

          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap-8">
            {supplyChainSolutions.map ( (solution, index) => (<motion.div
                key={solution.id}
                initial={{ opacity: 0, y: 30 }}
              ...
              >
                ...
                <div className="space - y-3 mb-4">
                  ...
                  <ul className="space - y-1">
                    {solution.features.map((feature, idx) => (<li
                        key={idx}

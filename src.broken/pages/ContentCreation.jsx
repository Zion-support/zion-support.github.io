...
const contentBenefits = [{
  ...
  delay: 0.2
            ...
            <p className="text-xl text-zion - slate - light leading - relaxed mb-8">
              Transform your content creation process with cutting - edge digital tools and platforms.From video production to AI - powered content generation, we help you create engaging content at scale.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 leading -relaxed">
              ...
              improve quality, and increase your content output.</p>

  ...
  return (<div  className="min - h-screen bg-gradient - to - br from - slate - 900 via - purple - 900 to - slate - 900 relative overflow-hidden">
      ...
      <div  className="relative z - 10 pt - 20 pb - 16 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Discover our complete portfolio of revolutionary micro SAAS, AI, and IT services.From quantum computing to emotional intelligence AI, we have solutions for every business need.</motion.p>
            ...
            <div  className="flex flex - col lg:flex - row gap-6 items -center">
              ...
              <div  className="flex bg-white / 10 rounded-lg p - 1 border border-white / 20">
                <button     onClick={ () => setViewMode('grid') }
                  className={`p - 2 rounded-md transition - all duration - 300 ${viewMode === 'grid' ? 'bg-gradient - to - r from - cyan - 500 to - purple - 500 text-white' : 'text-gray - 400 hover:text-white'
                  }`}
                >
                  <Grid className="w-5 h-5" />
                </button>
                <button     onClick={ () => setViewMode('list') }
                  className={`p - 2 rounded-md transition - all duration - 300 ${viewMode === 'list' ? 'bg-gradient - to - r from - cyan - 500 to - purple - 500 text-white' : 'text-gray - 400 hover:text-white'
                  }`}
                >
          ...
          >
            <AnimatePresence>
              {sortedServices.map((service, index) => (<motion.div
                  ...
                  className={`group relative ${viewMode === 'list' ? 'flex flex - col lg:flex - row' : ''
                  }`}
                >
                  <div  className={`bg-white / 10 backdrop - blur - lg rounded-2xl border border-white / 20 overflow-hidden transition - all duration - 500 hover:scale - 105 hover:shadow-2xl hover:shadow-cyan - 500 / 25 ${viewMode === 'list' ? 'flex - 1' : ''
                  }`}>
                    {/* Service Header */}
                    ...
                    <div  className="p - 6 pt -0">
                      ...
                      <div  className="mb-6">
                        ...
                        <div  className="grid grid - cols - 1 gap-2">
                          {service.features.slice(0, 3) .map((feature, idx) => (<div  key={idx} className="flex items - center text-sm text-gray -400">
        ...
        <div  className="max - w-4xl mx -auto">
          ...
          >
            ...
            <p className="text-gray - 300 mb-8 text-lg">
              Get in touch with our team to discuss how these revolutionary solutions can drive your business forward.</p>

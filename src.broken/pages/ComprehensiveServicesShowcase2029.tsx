        ...
        <div  className="relative max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray - 300 mb-12 max - w-4xl mx -auto">
              ...
              designed to transform industries and drive unprecedented growth.</p>
        ...
        <div  className="max - w-7xl mx -auto">
          <div  className="flex flex - col lg:flex - row gap-6 items - center justify -between">
            ...
            <div  className="flex flex - wrap gap-2">
              {Object.entries(categories) .map(([key, category]) => (<button     key={key}
                  onClick={ () => setSelectedCategory(key) }
                  className={`px-4 py-2 rounded-lg font - medium transition - all duration - 300 ${selectedCategory === key
        ...
        <div  className="max - w-7xl mx -auto">
          ...
          <div  className="grid grid - cols - 1 md: anygrid - cols - 2 lg:grid - cols - 3 gap-8">
            {filteredServices.map((service, index) => (<motion.div
                ...
                viewport={{ once: true }}
                className={`group cursor - pointer ${service.featured ? 'ring - 2 ring - cyan - 400 / 50' : ''
                }`}
              >
                <Link to={service.link}>
                  <div  className="bg-white / 5 backdrop - blur - sm border border-cyan - 400 / 20 rounded-2xl p - 8 hover:bg-white / 10 hover:border-cyan - 400 / 40 transition - all duration - 300 h-full hover -lift">
                    {service.featured && (<div  className="text-center mb-4">

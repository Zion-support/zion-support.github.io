...
export default function Page() {
  ...
  y: 0
            ...
            <p className="text-xl md:text-2xl text-gray - 300 max - w-4xl mx - auto mb-8">
              Discover our revolutionary portfolio of cutting - edge micro SAAS, IT services, and AI solutions.Featuring quantum computing, edge AI, blockchain services, and up to 1000x performance improvements.</p>
            ...
            <div  className="flex - shrink -0">
              <div  className="flex bg-white / 10 rounded-lg p -1">
                <button     onClick={ () => setViewMode('grid') }
                  className={`px-3 py-2 rounded-md transition - colors ${viewMode === 'grid' ? 'bg-purple - 500 text-white' : 'text-gray - 300 hover:text-white'
                  }`}

                  <Grid className="w-4 h-4" />
                </button>
                <button     onClick={ () => setViewMode('list') }
                  className={`px-3 py-2 rounded-md transition - colors ${viewMode === 'list' ? 'bg-purple - 500 text-white' : 'text-gray - 300 hover:text-white'
                  }`}
                  ...
                  <div>
                    ...
                    <div  className="bg-gradient - to - r from - blue - 600 to - purple - 600 rounded-lg p - 4 mb-6">
                      ...
                      <div  className="space - y-2 text-sm">
                        ...
                        {selectedService.innovationLevel && (<div  className="flex justify -between">
                    ...
                    {selectedService.contactInfo && (<div  className="bg-white / 10 rounded-lg p -4">
      ...
      <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-16">;
        <div  className="bg-gradient - to - r from - blue - 600 / 20 to - purple - 600 / 20 rounded-2xl p - 8 border border-white / 20 text-center">
          ...
          <p className="text-xl text-gray - 300 mb-8 max - w-2xl mx -auto">
            Contact our team to learn more about our revolutionary services and how they can transform your business with up to 1000x performance improvements.</p>
          <div  className="flex flex - col sm:flex - row gap-4 justify -center">
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}

...
,
    {
      ...
      features: ['Closed captions for videosAudio descriptions for visual content',
    ...
    },
    {
      ...
      features: ['Full keyboard navigationVoice control compatibility',
    ...
    },
    {
      ...
      features: ['Clear and simple languageConsistent navigation patterns',
        ...
        <div className="container mx - auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              ensure an inclusive experience for all users.</p>
          </div>
        ...
        <div className="container mx - auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              experience and access our platform more effectively.</p>
          </div>
        ...
        <div className="container mx - auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              technologies to support users with different accessibility needs.</p>
          </div>
        ...
        <div className="container mx - auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              accessibility team is here to help.</p>
          </div>

...
const processSteps = [{
  ...
  delay: 0.2
            ...
            <h1 className="text-5xl md:text-6xl font - bold text-white mb-6">
              IT On - Site < span className="text-gradient block">Services</span>
            </h1>

            <p className="text-xl text-zion - slate - light leading - relaxed mb-8">
              Professional on - site IT services delivered by certified technicians.From network setup to emergency support, we bring expertise directly to your location.</p>
  ...
  delay: index * 0.1
                ...
                <div className="flex flex - wrap gap-2 mb-4">
                  {service.coverage.map((cov, covIndex) => (<span
                      key={covIndex}
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 leading -relaxed">
              ...
              with infrastructure setup, maintenance, and emergency support.</p>

...
export default function Page() {
          ...
          <div className="mb-16">
            ...
            <div className="grid md: grid - cols - 4 gap-6">
              {['Network Penetration TestingWeb Application Penetration Testing',
                'Mobile Application Penetration TestingAPI Penetration Testing',
                'Cloud Penetration TestingSocial Engineering Testing',
                'Physical Security TestingWireless Security Testing'
              ].map (type => (<div
                  key={type}

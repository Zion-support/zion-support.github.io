          ...
          <div className="bg-zion - blue - dark border border-zion - blue - light rounded-xl p - 2 mb-8">
            <div className="flex flex - wrap gap-2">
              <button
                ...
                className={`px-6 py-3 rounded-lg font - semibold transition - colors ${activeTab === 'overview'
              ...
              <button
                ...
                className={`px-6 py-3 rounded-lg font - semibold transition - colors ${activeTab === 'disputes'
                    ? 'bg-zion - cyan text-zion - blue - dark'
                    : 'text-zion - slate - light hover:text-white hover:bg-zion - blue'
                }`}
              >
              ...
              <button
                ...
                className={`px-6 py-3 rounded-lg font - semibold transition - colors ${activeTab === 'resolutions'
                    ? 'bg-zion - cyan text-zion - blue - dark'
                    : 'text-zion - slate - light hover:text-white hover:bg-zion - blue'
                }`}
              >
          ...
          {activeTab === 'resolutions' && (<div className="space - y-6">
              ...
              <div className="bg-zion - blue - dark border border-zion - blue - light rounded-xl p -6">
                <p className="text-zion - slate - light text-center py-8">
                  Resolution history and analytics will be displayed here.</p>
              </div>
            </div>) }

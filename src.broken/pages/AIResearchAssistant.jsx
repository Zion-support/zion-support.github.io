      ...
      <div className="max - w-7xl mx - auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
            ...
            enhance collaboration, and deliver deeper insights across all domains.</p>
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 gap-6">
            {tools.map((tool, index) => (<div key={index} className="bg-gray - 800 / 30 backdrop - blur - sm rounded-xl p - 6 border border-cyan - 500 / 30 hover:border-cyan - 400 / 50 transition - all duration -300">
                ...
                <a href={tool.url} target="_blank" rel="noopener noreferrer" className="inline - flex items - center text-cyan - 400 hover:text-cyan - 300 transition - colors duration -300">
                  Visit Tool < svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center">
          <div className="bg-gradient - to - r from - cyan - 500 / 10 to - blue - 500 / 10 rounded-2xl p - 8 border border-cyan -500 / 30">
            ...
            <p className="text-gray - 300 mb-6 max - w-2xl mx -auto">
              ...
              their discoveries and gain competitive advantages.</p>
            <div className="flex flex - wrap justify - center gap-4">

...
export default function Page() {
  ...
  y: 0
              ...
              <p className="text-xl md:text-2xl text-gray - 300 mb-8 max - w-4xl mx -auto">
                Discover the future of business technology with our revolutionary micro SAAS, IT, and AI services.Transform your operations, boost efficiency, and stay ahead of the competition.</p>
              ...
              <div  className="grid grid - cols - 1 lg:grid - cols - 3 gap-6 mb-8">
                ...
                <div  className="flex gap-4">
                  <button     onClick={ () => setViewMode('grid') }
                    className={`px-4 py-3 rounded-lg transition - colors ${viewMode === 'grid'
                  ...
                  <button     onClick={ () => setViewMode('list') }
                    className={`px-4 py-3 rounded-lg transition - colors ${viewMode === 'list'
                        ? 'bg-gradient - to - r from - purple - 600 to - pink - 600 text-white'
                        : 'bg-white / 10 backdrop - blur - sm border border-white / 20 text-white hover:bg-white / 20'
                    }`}
  ...
  y: 0
              ...
              <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
                ...
                on implementing these revolutionary services in your organization.</p>
            </motion.div>
            ...
            <div  className="p -8">
              ...
              <div  className="grid grid - cols - 1 md:grid - cols - 2 gap-8 mb-8">
                ...
                <div>
                  ...
                  <div  className="space - y-3">
                    {selectedService.tags.slice(0, 5) .map((tag, index) => (<div  key={index} className="flex items - center space - x-2">

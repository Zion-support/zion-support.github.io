...
,;
  ...
  y: 0
            ...
            <p className="text-xl md:text-2xl text-slate - 300 mb-8 leading -relaxed">
              ...
              with the perfect technology solutions.Get personalized recommendations in seconds.</p>
  ...
  delay: index * 0.1
                ...
                className={`bg-slate - 800 / 50 border rounded-xl p - 6 hover:border-cyan - 400 / 50 transition - all duration - 300 hover:scale - 105 ${service.featured ? 'border-cyan - 400 / 30 bg-gradient - to - br from - cyan - 400 / 5 to - blue - 500 / 5' : 'border-slate - 700 / 50'
                }`}
                ...
                <div  className="flex items - start justify - between mb-4">
                  ...
                  <div  className="text-right">
                    {service.featured && (<div  className="flex items - center mb-2">
                ...
                <div  className="flex items - center justify - between mb-4">
                  <div  className="flex items -center">
                    <div  className="flex items - center text-yellow-400 mr-2">
                      {[...Array(5) ].map((_, i) => (<Star key={i} className={`w-4 h-4 ${i < Math.floor(service.rating) ? 'fill - current' : ''}`} />) ) }
                    </div>
                ...
                <div  className="space - y-2 mb-6">
                  {service.features.slice(0, 3) .map((feature, featureIndex) => (<div  key={featureIndex} className="flex items - center text-sm text-slate -400">
                      <CheckCircle className="w-4 h-4 text-cyan - 400 mr-2 flex - shrink -0" />
                      {feature}
                    </div>) ) }
                  {service.features.length > 3 && (<div  className="text-slate - 500 text-sm text-center">
  ...
  y: 0
            ...
            <p className="text-xl text-slate - 300 max - w-3xl mx -auto">
              ...
              and find the perfect technology solutions.</p>
          </motion.div>

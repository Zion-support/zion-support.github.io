...
const ComprehensivePricing2025 = () => {
  ...
  const pricingData = [{
    ...
    },
    {
      ...
      description:
        'End - to - end supply chain management with AI - driven insights',
      category: 'AI Services',
      ...
      <div className="container mx - auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
            Transparent pricing for all our cutting - edge technology solutions
            with proven ROI
          </p>
        </div>
        ...
        <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap-8">
          {filteredData.map(item => (<div
              key={item.id}
              className={`bg-white / 10 backdrop - blur - lg rounded-xl p - 6 border ${item.popular ? 'border-zion - cyan' : 'border-white / 20'
              } relative`}
            >
              {item.popular && (<div className="absolute - top - 3 left - 1/2 transform - translate - x-1 / 2">
              ...
              <div className="text-center mb-6">
                ...
                {item.annualDiscount > 0 && (<div className="text-yellow-400 text-sm mb-4">

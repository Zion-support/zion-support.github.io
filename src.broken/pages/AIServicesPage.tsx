...
=======
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
          {aiServices.map((service, index) => (
            <div
              key={index}
              className='bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:border-purple-400/50 transition-all duration-300 hover:transform hover:scale-105'
            >
              <div className='space-y-6'>
                <div className='flex items-center gap-4'>
                  {service.icon}
          ...
          <div className='text-center space-y-12'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
              <div className='text-center space-y-4'>
                ...
                <p className='text-gray-300'>
                  We leverage the latest AI/ML technologies and frameworks to
              ...
              <div className='text-center space-y-4'>
                ...
                <p className='text-gray-300'>
                  Our team of AI specialists, data scientists, and ML engineers
              ...
              <div className='text-center space-y-4'>
                ...
                <p className='text-gray-300'>
                  Track record of successful AI implementations with measurable
                  business impact.
                </p>
              </div>
            </div>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
          <div className='text-center space-y-8'>
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              ...
              operations, drive innovation, and create competitive advantages.
            </p>

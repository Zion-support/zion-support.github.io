...
const processSteps = [{
  ...
  const categories = ['AllIoT Platform', 'Edge ComputingAnalytics', 'Smart CitiesIndustrial IoT', 'Security'],
  ...
  delay: 0.2
            ...
            <h1 className="text-5xl md:text-6xl font - bold text-white mb-6">
              IoT & Edge < span className="text-gradient block">Computing</span>
            </h1>

            <p className="text-xl text-zion - slate - light leading - relaxed mb-8">
              Connect, monitor, and optimize your world with cutting - edge IoT and edge computing solutions.From smart cities to industrial automation, we help businesses harness the power of connected devices.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 leading -relaxed">
              ...
              improve efficiency, and create new opportunities through connected technology.</p>

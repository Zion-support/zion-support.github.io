...
,
  ...
  y: 0
            ...
            <p className="text-xl text-white / 90 mb-8 max - w-3xl mx - auto leading -relaxed">
              ...
              and strategic analysis for informed decision making and portfolio optimization.</p>
  ...
  y: 0
            ...
            <p className="text-lg text-zion - slate - light max - w-2xl mx -auto">
              ...
              providing unmatched coverage and innovation capabilities.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-lg text-zion - slate - light max - w-2xl mx -auto">
              ...
              performance metrics, and strategic insights.</p>
          </motion.div>

        ...
        <div  className="container mx - auto px-4 relative z -10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-slate - 300 mb-8 leading -relaxed">
              ...
              market prices, proven ROI, and expert implementation.</p>
                  ...
                  >
                    <div  className="bg-slate - 800 / 50 backdrop - blur - sm border border-slate - 700 rounded-xl p - 8 h-full hover:border-cyan - 500 / 50 transition - all duration - 300 hover:scale -105">
                      ...
                      <div  className="flex items - start justify - between mb-6">
                        ...
                        {service.badge && (<span
                            className={`px-3 py-1 text-xs font - semibold rounded-full ${service.badge === 'Popular'
                      ...
                      <div  className="space - y-2 mb-6">
                        ...
                        {service.features.map((feature, idx) => (<div  key={idx}
                      ...
                      <div  className="space - y-2 mb-6">
                        ...
                        {service.benefits.map((benefit, idx) => (<div  key={idx}
                            className="flex items - center text-sm text-slate -400"
                          >

...
;
  ...
  y: 0
            ...
            <p className="text-xl md:text-2xl text-zion - slate - light mb-12 max - w-4xl mx - auto leading -relaxed">
              Protect your business with enterprise - grade cybersecurity solutions.From threat detection to compliance management, we keep you secure in an evolving digital landscape.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              ...
              ensuring business continuity and regulatory compliance.</p>
          </motion.div>
...
;
          ...
          >;
            {threatTypes.map((threat) => {;
              ...
              return (<button     key = {threat.id}
                  onClick={ () => setSelectedThreat(threat.id) }
                  className={`flex items - center gap-3 px-6 py-3 rounded-xl font - medium transition - all duration - 300 ${selectedThreat === threat.id
  ...
  scale: 1.02
              ...
              >
                <div  className="flex items - center justify - between mb-4">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs font - medium ${threat.impact === 'Critical' ? 'bg-red - 500 / 20 text-red - 400' :
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 max - w-3xl mx -auto">
              ...
              can protect your organization from evolving threats.</p>

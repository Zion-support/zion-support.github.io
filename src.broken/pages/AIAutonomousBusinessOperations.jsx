        ...
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Transform your business operations with AI - powered automation and optimization.Streamline processes, reduce costs, and improve efficiency across all
              areas of your organization.</p>
          </div>
          ...
          <div className="text-center">
            <div className="bg-white / 10 backdrop - blur - lg rounded-xl p - 8 border border-white / 20 max - w-4xl mx -auto">
              ...
              <p className="text-gray - 300 mb-6">
                ...
                reduce costs, and improve efficiency across your organization.</p>

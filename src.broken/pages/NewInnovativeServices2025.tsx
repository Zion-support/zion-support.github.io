...
,
  ...
  const serviceCategories = [{
    ...
    },
    {
      ...
      services: ["Data Governance Platform",
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-zion - slate - 300 mb-8 max - w-4xl mx - auto leading -relaxed">
                Discover our cutting - edge AI - powered micro SAAS services designed to transform your business.From workflow automation to data governance, we provide innovative solutions that drive growth and efficiency.</p>
  ...
  delay: index * 0.1
                  ...
                  viewport={{ once: true }}
                  className={`relative bg-zion - slate - 800 / 50 backdrop - blur - sm border rounded-xl p - 8 hover:border-zion - cyan / 40 transition - all duration - 300 ${service.popular ? 'border-zion - cyan / 50 bg-zion - cyan / 5' : 'border-zion - slate - 600 / 50'
                  }`}
                >
                  ...
                  <Link to={service.link}>
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className={`w-full py-3 px-6 rounded-lg font - semibold transition - all duration - 300 ${service.popular
                ...
                >
                  ...
                  <div className="space - y-3">
                    ...
                    <ul className="space - y-2">
                      {category.services.map((service, idx) => (<li key={idx} className="flex items - center text-zion - slate -300">

...
,
  ...
  y: 0
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-zion - slate - light max - w-4xl mx - auto mb-8">
              Access our comprehensive library of case studies, white papers, webinars, and support materials.Learn from our expertise and stay ahead of the technology curve.</p>
            ...
            {featuredResources.map ( (resource, index) => (<motion.div
                ...
                <Link
                  ...
                  <div className="flex items - center justify -between">
                    <span className={`px-2 py-1 text-xs font - medium rounded-full ${resource.badge === 'Essential' ? 'bg-blue - 500 / 20 text-blue - 400' :
                  ...
                  <div className="space - y-3 mb-6">
                    {category.items.slice(0, 2) .map((item, idx) => (<div key={idx} className="flex items - center justify - between p - 3 bg-white / 5 rounded-lg">
                        ...
                        <div className="text-right">
                          ...
                          {item.featured && (<Star className="w-3 h-3 text-yellow-400 ml-1 inline" />) }
                        </div>
                      </div>
                      ...
                      <div className="flex flex - wrap gap-2 mb-4">
                        {resource.tags.slice(0, 2) .map((tag, idx) => (<span
                            key={idx}
  ...
  y: 0
          ...
          >
            ...
            <p className="text-xl text-zion - slate - light mb-8">
              Get notified about new resources, research findings, and industry insights.Never miss valuable knowledge from Zion Tech Group.</p>
          </motion.div>

          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap-6">
            {resourceCategories.map((category, index) => (<motion.div
                key={category.id}
                id={category.id}
                initial = {
  { opacity: 0,
  ...
  y: 0
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap-6">
            {additionalResources.map((resource, index) => (<motion.div
                key={resource.id}
                id={resource.id}
                initial = {
  { opacity: 0,
          ...
          >
            <div className="bg-gradient - to - r from - slate - 800 / 50 to - slate - 700 / 50 rounded-3xl p - 12 border border-slate -600 / 50">
              ...
              <p className="text-xl text-gray - 300 mb-8 max - w-2xl mx -auto">
                ...
                the right resources and support for your needs.</p>

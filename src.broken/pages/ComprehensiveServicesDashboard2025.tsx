...
export default function Page() {
  ...
  return (<div  className="min - h-screen bg-gradient - to - br from - slate - 50 via - blue - 50 to - indigo -50">
      <Helmet>
        ...
        <meta
          name="description"
          content="Complete overview of all our innovative technology services, micro SAAS solutions, and AI - powered platforms.Comprehensive dashboard with statistics and search capabilities."
        />
        <meta
          name="keywords"
          content="services dashboard, micro SAAS, IT services, AI services, fintech, healthtech, edutech, martech, business solutions overview"
        />
        <link
          rel="canonical"
          href="https://ziontechgroup.com / comprehensive - services - dashboard - 2025"
        />
      </Helmet>
        ...
        <div  className="relative max - w-7xl mx - auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-blue - 100 mb-8 max - w-4xl mx -auto">
              Complete overview of our innovative technology solutions
              portfolio.Discover, explore, and compare all our services in one
              place.</p>
            ...
            <div  className="flex - shrink -0">
              <div  className="flex border border-gray - 300 rounded-lg">
                <button     onClick={ () => setViewMode('grid') }
                  className={`px-4 py-3 rounded-l-lg ${viewMode === 'grid'
                ...
                <button     onClick={ () => setViewMode('list') }
                  className={`px-4 py-3 rounded-r-lg ${viewMode === 'list'
                      ? 'bg-blue - 600 text-white'
                      : 'bg-white text-gray - 600 hover:bg-gray - 50'
                  }`}
                >
          ...
          {filteredServices.length === 0 ? (<div  className="text-center py-12">
              ...
              <div  className="flex justify - between items - center mb-8">
                ...
                <p className="text-gray -600">
                  Showing {filteredServices.length} of {stats.total} total
                  services
                </p>
              </div>

              {viewMode === 'grid' ? (<div  className="grid grid - cols - 1 md: anygrid - cols - 2 lg:grid - cols - 3 gap-8">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient - to - r from - blue - 600 via - indigo - 700 to - purple -800">
        <div  className="max - w-4xl mx - auto text-center">
          ...
          <p className="text-xl text-blue - 100 mb-8">
            Get in touch with our team to discuss how our innovative solutions
          ...
          <div  className="grid grid - cols - 1 md:grid - cols - 3 gap-8">
            <div>
              ...
              <p className="text-gray - 400 mb-4">
                Leading provider of innovative technology solutions and micro
                SAAS services.</p>

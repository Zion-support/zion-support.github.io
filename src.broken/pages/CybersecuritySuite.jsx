      ...
      <section className="pt - 20 pb - 16 px-4">
        <div className="container mx - auto text-center">
          ...
          <p className="text-xl md:text-2xl text-zion - slate - light mb-8 max - w-4xl mx -auto">
            Protect your business with comprehensive cybersecurity solutions that detect, prevent, and respond to threats in real - time.Our AI - powered security platform provides enterprise - grade protection at an accessible price.</p>
        ...
        <div className="container mx -auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-zion - slate - light max - w-3xl mx -auto">
              Our cybersecurity suite covers every aspect of modern security needs, from threat detection to compliance management.</p>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx -auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-zion - slate - light max - w-3xl mx -auto">
              Our platform combines cutting - edge technology with expert security knowledge to deliver unmatched protection.</p>
          </div>
      ...
      <section className="py-16 px-4 bg-zion -slate / 30">
        <div className="container mx -auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-zion - slate - light max - w-3xl mx -auto">
              Our platform helps you meet and maintain compliance with major industry standards and regulations.</p>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx -auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-zion - slate - light max - w-3xl mx -auto">
              Choose the security level that matches your business needs and budget.All plans include our core security features.</p>
          </div>
      ...
      <section className="py-16 px-4 bg-zion -slate / 30">
        <div className="container mx - auto text-center">
          ...
          <p className="text-lg text-zion - slate - light mb-8 max - w-3xl mx -auto">
            Join thousands of businesses already protected by our comprehensive cybersecurity suite.Get started with a free security assessment today.</p>
          <div className="flex flex - col sm:flex - row gap-4 justify - center items -center">
            <Button size="lg" className="bg-gradient - to - r from - red - 500 to - orange - 500 hover:from - red - 600 hover:to - orange - 600 text-white px-8 py-4 text-lg">

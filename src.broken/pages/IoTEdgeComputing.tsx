        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              ...
              operations with real - time intelligence and automation.</p>
        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Our comprehensive IoT and edge computing platform provides
              everything you need to build intelligent, connected systems that
              process data where it matters most.</p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white / 5">
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Discover how IoT and edge computing are transforming industries
              and creating new opportunities for innovation.</p>
          </motion.div>

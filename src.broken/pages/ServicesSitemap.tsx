...
export default function Page() {
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray - 300 mb-8 max - w-4xl mx -auto">
                ...
                data analytics, security, and specialized business solutions.</p>
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
                Navigate directly to the services and resources you need.</p>
            </motion.div>
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
                Browse our comprehensive collection of services organized by category.</p>
            </motion.div>
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl text-gray - 300 mb-8">
                Our experts are here to help you find the perfect solution for your business needs.</p>

...
const stats = [{ label: "Transformations Completed", value: "75+", icon: Rocket },
  ...
  y: 0
            ...
            <p className="text-xl md:text-2xl text-zion - slate - light max - w-4xl mx - auto mb-8">
              ...
              process automation, and technology innovation that drives real results.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              Comprehensive digital transformation solutions designed to modernize every aspect of your business.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              A proven methodology that ensures successful digital transformation with measurable results.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              Digital transformation delivers measurable benefits that impact every aspect of your business.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              See how we've helped organizations transform their business through digital innovation.</p>
          </motion.div>
  ...
  y: 0
            ...
            <div className="bg-gradient - to - r from - zion - cyan / 20 via - zion - purple / 20 to - zion - cyan / 20 border border-zion - cyan / 30 rounded-2xl p - 12 backdrop - blur -md">
              ...
              <p className="text-xl text-zion - slate - light mb-8 max - w-3xl mx -auto">
                Join the digital revolution and position your business for success in the modern marketplace.</p>
              <div className="flex flex - col sm:flex - row gap-4 justify -center">
                <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="px-8 py-4 bg-gradient - to - r from - zion - cyan to - zion - purple text-white rounded-lg text-lg font - semibold hover:shadow-xl hover:shadow-zion - cyan / 25 transition - all duration -300">

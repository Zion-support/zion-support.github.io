...
,;
  ...
  y: 0
            ...
            Comprehensive Services Landing 2028 < span className="block text-3xl md:text-4xl text-zion - cyan mt-2">
  ...
  delay: 0.2
            ...
            and AI services.Each solution is designed for maximum impact with proven ROI and real market pricing.</motion.p>
          <motion.div
            initial = {
  { opacity: 0,
  y: 20
  ...
  y: 0
          ...
          <div  className="grid grid - cols - 1 md: grid - cols - 2 lg:grid - cols - 3 gap-8">
            {allServices.slice(0, 6) .map((service, index) => (<motion.div
                key={service.id}
                initial = {
  { opacity: 0,
  y: 20
  ...
  delay: index * 0.1
                ...
                <div  className="space - y-3 mb-6">
                  ...
                  {service.price && (<div  className="flex items - center justify -between">
                  ...
                  {service.hourlyRate && (<div  className="flex items - center justify -between">
                ...
                <div  className="flex flex - wrap gap-2 mb-4">
                  {service.tags.slice(0, 3) .map((tag, tagIndex) => (<Badge key={tagIndex} variant="outline" className="text-xs border-zion - cyan / 30 text-zion -cyan">
                      {tag}
                    </Badge>) ) }
                </div>
            ...
            <div  className="flex items - center justify - center gap-4 mt-8">
              ...
              <div  className="flex gap-2">
                {testimonials.map((_, index) => (<button     key={index}
                    ...
                    className={`w-3 h-3 rounded-full transition - colors ${index === currentTestimonial ? 'bg-zion - cyan' : 'bg-white / 30'
                    }`}
                  />) ) }
              </div>
              ...
              <div  className="grid grid - cols - 1 lg:grid - cols - 2 gap-6">
                <div>
                  ...
                  <ul className="space - y-2 mb-6">
                    {selectedService.features.map((feature, index) => (<li key={index} className="flex items - center gap-2 text-zion - slate -light">
                  ...
                  <ul className="space - y-2 mb-6">
                    {selectedService.benefits.map((benefit, index) => (<li key={index} className="flex items - center gap-2 text-zion - slate -light">
                        <CheckCircle className="w-4 h-4 text-zion - cyan flex - shrink -0" />
                        {benefit}
                      </li>) ) }
                  </ul>
                ...
                <div>
                  <div  className="bg-white / 5 rounded-lg p - 4 mb-6">
                    ...
                    <div  className="space - y-3">
                      {selectedService.price && (<div  className="flex justify -between">
                      ...
                      {selectedService.hourlyRate && (<div  className="flex justify -between">
                      ...
                      {selectedService.projectRate && (<div  className="flex justify -between">
                  ...
                  <div  className="bg-white / 5 rounded-lg p - 4 mb-6">
                    ...
                    <div  className="flex flex - wrap gap-2">
                      {selectedService.targetAudience.map((audience, index) => (<Badge key={index} variant="secondary" className="bg-zion - cyan / 20 text-zion -cyan">
                          {audience}
                        </Badge>) ) }
                    </div>
                  </div>
                  ...
                  {selectedService.integrations && (<div  className="bg-white / 5 rounded-lg p -4">
                      ...
                      <div  className="flex flex - wrap gap-2">
                        {selectedService.integrations.map((integration, index) => (<Badge key={index} variant="outline" className="border-zion - cyan / 30 text-zion -cyan">
                            {integration}
                          </Badge>) ) }
                      </div>
                    </div>) }

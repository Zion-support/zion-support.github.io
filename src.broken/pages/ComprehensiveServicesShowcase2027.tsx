        ...
        <div  className="relative max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray - 300 max - w-4xl mx - auto mb-8">
              Discover our complete portfolio of cutting - edge micro SAAS, IT
              services, and AI solutions.From quantum computing to autonomous
              ...
              <div  className="p -6">
                ...
                <div  className="grid grid - cols - 1 lg:grid - cols - 2 gap-8">
                  ...
                  <div>
                    ...
                    <ul className="space - y-2 mb-6">
                      {selectedService.benefits.map((benefit, idx) => (<li
                          key={idx}
                          className="flex items - center gap-2 text-gray -300"
                        >
                    ...
                    <div  className="space - y-4 mb-6">
                      <div  className="bg-white / 10 rounded-lg p -4">
                        ...
                        <span className="text-sm text-gray -400">
                          /{selectedService.pricing.billingCycle}
                        </span>
                      </div>
      ...
      <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-16">
        <div  className="bg-gradient - to - r from - blue - 600 / 20 to - purple - 600 / 20 rounded-2xl p - 8 border border-white / 20 text-center">
          ...
          <p className="text-xl text-gray - 300 mb-8 max - w-2xl mx -auto">
            Contact our team to learn more about our comprehensive services and
            how they can transform your business.</p>
          <div  className="flex flex - col sm:flex - row gap-4 justify -center">
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}

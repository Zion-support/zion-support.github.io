        ...
        <div className="relative max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray - 300 mb-8 max - w-4xl mx -auto">
              Experience the next generation of technology with our revolutionary 2027 services.From AI autonomous platforms to quantum computing and metaverse development.</p>
        ...
        <div className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Our most innovative and game - changing solutions that will define the future of technology.</p>
          </motion.div>
      ...
      <section className="py-16">
        <div className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Explore our comprehensive range of future - ready services designed to meet tomorrow's challenges.</p>
          </motion.div>

          <div className="grid grid - cols - 1 md: anygrid - cols - 2 lg:grid - cols - 3 gap-6">
            {filteredAndSorted.map((service, index) => (<motion.div
                key={service.id}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 mb-8 max - w-3xl mx -auto">
              ...
              a competitive advantage in the rapidly evolving technology landscape.</p>

        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              Bridge the gap between physical and digital worlds with our
              advanced digital twin solutions.Monitor, analyze, and optimize
              your operations in real - time.</p>
        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Our comprehensive digital twin platform provides everything you
              need to create and manage virtual replicas of your physical
              assets.</p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white / 5">
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Discover how digital twin technology can transform operations

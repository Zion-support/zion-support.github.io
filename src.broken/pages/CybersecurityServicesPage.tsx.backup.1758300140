        ...
        <section className="py-32 px-4 relative overflow-hidden">
          ...
          <div  className="relative z - 10 max - w-6xl mx - auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray - 300 max - w-4xl mx - auto leading - relaxed mb-8">
              ...
              platform provides 24 / 7 protection against evolving cyber threats.</p>
            <div  className="flex flex - col sm:flex - row gap-4 justify - center items -center">
              ...
              >
                Get Security Assessment < ArrowRight className="inline ml-2 h-5 w-5" />
              </Link>
              <Link
                to="/case - studies"
        ...
        <section className="py-16 bg-muted / 50">
          <div  className="container mx - auto px-4 md:px-6">
            ...
            <Tabs value={selectedCategory} onValueChange={setSelectedCategory} className="w-full">
              ...
              {SECURITY_SERVICE_CATEGORIES.map((category) => (<TabsContent key={category.id} value={category.id} className="space - y-6">
        ...
        <section className="py-16 bg-background">
          <div  className="container mx - auto px-4 md:px-6">
            ...
            <div  className="grid gap-6 md: anygrid - cols - 3 lg:grid - cols -6">
              ...
              ].map((standard) => (<Card key={standard.name} className="text-center hover:shadow-lg transition -shadow">
                  <CardHeader>
        ...
        <section className="py-16 bg-zion -blue">
          <div  className="container mx - auto px-4 md:px-6 text-center">
            ...
            <p className="text-xl text-gray - 300 mb-8 max - w-3xl mx -auto">
              Don't wait until it's too late.Get a comprehensive security assessment and protect your business today.</p>
            <div  className="flex flex - col sm:flex - row gap-4 justify -center">
              <Link
                to="/contact"
                className="bg-gradient - to - r from - red - 500 to - orange - 500 text-white px-8 py-4 rounded-lg text-lg font - semibold hover:from - red - 600 hover:to - orange - 600 transition - all duration - 300 transform hover:scale -105"
              >
                Schedule Security Assessment < ArrowRight className="inline ml-2 h-5 w-5" />
              </Link>
              <Link
                to="/case - studies"
                className="border-2 border-white text-white px-8 py-4 rounded-lg text-lg font - semibold hover:bg-white hover:text-gray - 900 transition - all duration -300"
...
function SecurityServiceCard(...args: any[]) : any {
  ...
  return (<Card className="hover:shadow-lg transition - shadow border-red -500 / 20">
      <div  className="relative">
        ...
        />
        {service.featured && (<Badge className="absolute top - 3 left - 3 bg-red -600">
            Featured
          </Badge>) }
      ...
      <CardContent className="space - y-4">
        ...
        <div  className="space - y-2">
          ...
          <ul className="space - y-1">
            ...
            {service.features.slice(0, 3) .map((feature: anystring, index: number) => (<li key={index} className="flex items - center gap-2 text-sm text-muted -foreground">
            ...
            <div  className="flex flex - col sm:flex - row gap-4 justify -center">
              <Link to="/request - quote">
                <Button size="lg" className="bg-white hover:bg-gray - 100 text-red - 600 font -semibold">
                  Get Security Assessment < ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link to="/contact">
      ...
      <div  className="py-16 bg-gray -50">
        <div  className="container mx - auto px-4">
          ...
          <div  className="grid md: anygrid - cols - 2 lg:grid - cols - 3 gap-8">
            {CYBERSECURITY_SERVICES.map ( (service) => (<Card key={service.id} className="hover:shadow-xl transition - all duration - 300 border-2 hover:border-red -500 / 20">
                <div  className="relative">
                  <img
                    src={service.images[0]}
                    alt={service.title}
                  ...
                  />
                  {service.featured && (<Badge className="absolute top - 4 right - 4 bg-red - 600 text-white">
                      Featured
                    </Badge>) }
                </div>
                <CardHeader>
                ...
                <CardContent>
                  ...
                  <div  className="flex flex - wrap gap-2 mb-4">
                    {service.tags.map((tag) => (<Badge key={tag} variant="secondary" className="text-xs">
                        {tag}
                      </Badge>) ) }
                  </div>
        ...
        <div  className="container mx - auto px-4">
          <div  className="text-center mb-16">
            ...
            <p className="text-zion - slate - light text-lg max - w-2xl mx -auto">
              ...
              security challenges and protect your business assets.</p>
          </div>

          <div  className="grid grid - cols - 1 md: anygrid - cols - 2 lg:grid - cols - 3 gap-8">
            {securityServices.map((service) => (<div  key={service.id} className="bg-zion - blue border border-zion - blue - light rounded-lg p - 6 hover:border-zion - purple / 50 transition - all duration - 300 hover:translate - y-[-5px]">
        ...
        <div  className="container mx - auto px-4">
          <div  className="text-center mb-16">
            ...
            <p className="text-zion - slate - light text-lg max - w-2xl mx -auto">
              ...
              comprehensive protection for your business.</p>
          </div>

          <div  className="grid grid - cols - 2 md: anygrid - cols - 4 gap-6">
            {securityTechnologies.map((tech, index) => (<div  key={index} className="text-center p - 6 bg-zion - blue - dark border border-zion - blue - light rounded-lg hover:border-zion - purple / 50 transition - all duration -300">
        ...
        <div  className="container mx - auto px-4">
          <div  className="text-center mb-16">
            ...
            <p className="text-zion - slate - light text-lg max - w-2xl mx -auto">
              ...
              requirements across multiple sectors.</p>
          </div>

          <div  className="grid grid - cols - 2 md: anygrid - cols - 4 gap-6">
            {complianceStandards.map((standard, index) => (<div  key={index} className="text-center p - 6 bg-zion - blue border border-zion - blue - light rounded-lg hover:border-zion - purple / 50 transition - all duration -300">
        ...
        <div  className="container mx - auto px-4">
          <div  className="text-center mb-16">
            ...
            <p className="text-zion - slate - light text-lg max - w-2xl mx -auto">
              ...
              and 24 / 7 security monitoring services.</p>
          </div>

          <div  className="grid grid - cols - 2 md: anygrid - cols - 4 gap-6">
            {threatIntelligence.map((intel, index) => (<div  key={index} className="text-center p - 6 bg-zion - blue - dark border border-zion - blue - light rounded-lg hover:border-zion - purple / 50 transition - all duration -300">
        ...
        <div  className="container mx - auto px-4">
          <div  className="text-center mb-16">
            ...
            <p className="text-zion - slate - light text-lg max - w-2xl mx -auto">
              ...
              solutions that protect your business and build customer trust.</p>
          </div>
          <div  className="grid grid - cols - 1 md:grid - cols - 3 gap-8">
            <div  className="text-center p -6">
              ...
              <p className="text-zion - slate -light">
                ...
                extensive experience in enterprise security.</p>
            </div>
            <div  className="text-center p -6">
              ...
              <p className="text-zion - slate -light">
                ...
                with zero major security breaches.</p>
            </div>
            <div  className="text-center p -6">
              ...
              <p className="text-zion - slate -light">
                ...
                to protect your business at all times.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div  className="container mx - auto px-4">
          <div  className="text-center mb-16">
            ...
            <p className="text-zion - slate - light text-lg max - w-2xl mx -auto">
              ...
              flexible payment options and comprehensive protection.</p>
          </div>
      ...
      <section className="py-20 bg-zion - blue -dark">
        <div  className="container mx - auto px-4 text-center">
          ...
          <p className="text-zion - slate - light text-lg mb-8 max - w-2xl mx -auto">
            ...
            protect your business from evolving threats.</p>
      ...
      <div  className="py-16 bg-gradient - to - r from - red - 600 to - red - 800 text-white">
        <div  className="container mx - auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-red - 100 max - w-3xl mx -auto">
            ...
            a robust security posture and protect your valuable assets.</p>
          <div  className="flex flex - col sm:flex - row gap-4 justify -center">
            <Link to="/request - quote">
              <Button size="lg" className="bg-white hover:bg-gray - 100 text-red - 600 font -semibold">
                Get Security Assessment < ArrowRight className="ml-2 h-5 w-5" />
          ...
          <div  className="grid md:grid - cols - 2 gap-8">
            <div>
              ...
              <p className="text-gray - 300 mb-6">
                ...
                with comprehensive security solutions and expert guidance.</p>

  ...
  const itServices = [
    {
      ...
      description:
        'End-to-end cloud migration services with strategic planning, cost optimization, and performance tuning for maximum ROI.',
    ...
    },
    {
      ...
      description:
        'Complete CI/CD pipeline automation with infrastructure as code, monitoring solutions, and security integration.',
    ...
    },
    {
      ...
      description:
        'Comprehensive security audits, penetration testing, and security infrastructure deployment with compliance frameworks.',
    ...
    },
    {
      ...
      description:
        'Scalable network architecture design with high availability, security, and performance optimization.',
    ...
    },
    {
      ...
      description:
        'Database architecture design, performance tuning, and migration services for optimal data management.',
    ...
    },
    {
      ...
      description:
        'Comprehensive IT infrastructure management with proactive monitoring, maintenance, and optimization services.',
  ...
  const additionalServices = [
    {
      ...
      description:
        'Custom API development and third-party system integration services.',
      pricing: 'From $2,500',
    ...
    },
    {
      ...
      description:
        'Real-time performance monitoring and optimization services.',
    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white'>
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24'>
          <div className='text-center'>
            ...
            <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto'>
              Enterprise-grade IT solutions that drive operational excellence,
              security, and scalability. From cloud migration to cybersecurity,
              we build robust technology foundations.
            </p>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
            Comprehensive IT solutions designed to modernize infrastructure,
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
          {itServices.map((service, index) => (
            <div
              key={index}
              className='bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:border-blue-400/50 transition-all duration-300 hover:transform hover:scale-105'
            >
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
            Specialized IT services to complement your technology infrastructure
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
              <div className='text-center space-y-4'>
                ...
                <p className='text-gray-300'>
                  Years of experience in enterprise IT infrastructure, cloud
              ...
              <div className='text-center space-y-4'>
                ...
                <p className='text-gray-300'>
                  Security-first approach with industry best practices and
              ...
              <div className='text-center space-y-4'>
                ...
                <p className='text-gray-300'>
                  Round-the-clock monitoring, support, and maintenance for your
      ...
      <div className='bg-gradient-to-r from-blue-900/50 to-purple-900/50 border-t border-white/20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
          <div className='text-center space-y-8'>
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Let's discuss how our IT solutions can enhance your operational
              efficiency, security posture, and business scalability.
            </p>

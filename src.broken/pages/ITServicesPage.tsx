import React from 'react',import {Server,Cloud,Shield,Code,Database,Network,Cpu,Zap,CheckCircle,Star,ExternalLink,ArrowRight,Phone,Mail,MapPin,Linkedin,Twitter,Github,Monitor,Lock,Users,BarChart3;'
    ...
    },{"name": "Data Backup & Recovery","description": "Comprehensive backup solutions and disaster recovery planning.","pricing": "From $299/month","icon": <Database className="w-8 h-8 text-green-400" />;"
    },{"name": "Performance Monitoring","description": "Real-time performance monitoring and optimization services.","pricing": "From $199/month","icon": <Monitor className="w-8 h-8 text-purple-400" />;"
    },{"name": "IT Consulting","description": "Strategic IT consulting and technology roadmap planning.","pricing": "From $150/hour","icon": <Users className="w-8 h-8 text-orange-400" />;"
    }
  ],const stats = [;
    { "label": "Infrastructure Deployed", "value": "200+" },{ "label": "Security Audits", "value": "150+" },{ "label": "Uptime Guarantee", "value": "99.9%" },{ "label": "Client Satisfaction", "value": "97%" }"
  ...
  return (<div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white">;"
      ...
      <div className="max-w-7xl mx-auto px-4 "sm":px-6 "lg":px-8 py-16">;"
        ...
        <div className="grid grid-cols-1 "lg":grid-cols-2 gap-12">;"
          {itServices.map((service, index) => (<div key={index} className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 "hover":border-blue-400/50 transition-all duration-300 "hover":transform "hover":scale-105">;"
                ...
                <div className="space-y-4">;"
                  ...
                  <div className="grid grid-cols-1 "md":grid-cols-2 gap-4">;"
                    <div>;
                      ...
                      <div className="space-y-1">;"
                        {Object.entries(service.pricing).map(([plan, price]) => (<div key={plan} className="flex justify-between text-sm">;"
                  ...
                  <div className="pt-4 border-t border-white/20">;"
                    <div className="flex gap-3">;"
                      ...
                      <a;
                        href={`"mailto":kleber@ziontechgroup.com?subject=Inquiry about ${service.name}`}`                        className="inline-flex items-center justify-center px-4 py-2 border border-blue-400 text-blue-400 "hover":bg-blue-400 "hover":text-white rounded-lg text-sm font-medium transition-colors";"
                      >;
                        <span>Get Quote</span>;
                      </Link>;
                    </div>;
      ...
      <div className="max-w-7xl mx-auto px-4 "sm":px-6 "lg":px-8 py-16">;"
        ...
        <div className="grid grid-cols-1 "md":grid-cols-2 "lg":grid-cols-4 gap-6">;"
          {additionalServices.map((service, index) => (<div key={index} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 "hover":border-blue-400/50 transition-all duration-300">;"

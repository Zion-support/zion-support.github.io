        ...
        <div className="relative max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-blue - 100 mb-8 max - w-4xl mx -auto">
              ...
              computing, and next - generation technology.</p>
            ...
            >
              ...
              <div className="mb-6">
                <div className="flex items - start justify - between mb-4">
                  ...
                  <div className="flex items - center gap-2">
                    {service.tags.slice(0, 2) .map((tag, tagIndex) => (<span
                        key={tagIndex}
              ...
              <div className="mb-6">
                ...
                <div className="flex items - center justify -between">
                  ...
                  <div className="flex flex - wrap gap-1">
                    {service.compliance.slice(0, 2) .map((comp, compIndex) => (<span
                        key={compIndex}
      ...
      <div className="bg-gradient - to - r from - blue - 800 to - purple - 800 py-16">
        <div className="max - w-4xl mx - auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-blue - 100 mb-8">
            Join hundreds of companies already leveraging our cutting - edge AI
            and IT solutions to drive innovation and achieve remarkable results.</p>

      ...
      <div  className="py-20 bg-gradient - to - br from - zion - blue via - zion - blue - dark to - zion -purple">
        <div  className="container mx - auto px-4 text-center">
          ...
          <p className="text-xl text-zion - slate - light max - w-3xl mx - auto mb-8">
            Transparent pricing for our revolutionary micro SAAS solutions.Choose the plan that fits your business needs and budget.</p>
      ...
      <div  className="py-20">
        <div  className="container mx - auto px-4">
          ...
          <div  className="grid grid - cols - 1 md: grid - cols - 3 gap-8 max - w-6xl mx -auto">
            {pricingTiers.map ( (tier, index) => (<Card
                key={index}
              ...
              >
                ...
                <CardHeader className="text-center">
                  ...
                  <div  className="text-4xl font - bold text-zion -blue">
                    {tier.price}
                    <span className="text-lg text-zion - slate - light font -normal">
                      {tier.period}
                    </span>
                  </div>
                </CardHeader>
              ...
              >
                <CardHeader>
                  <div  className="flex items - center justify - between mb-2">
                    ...
                    {service.popular && (<Badge className="bg-zion - cyan text-white">Popular</Badge>) }
                  </div>
                ...
                <CardContent>
                  ...
                  <div  className="space - y-2 mb-4">
                    <h4 className="font - semibold text-zion - slate - dark text-sm">
                      Key Features: any
                    </h4>
                    {service.features.slice(0, 3) .map((feature, index) => (<div  key={index}
        ...
        <div  className="container mx - auto px-4 text-center">
          <div  className="bg-gradient - to - br from - zion - blue to - zion - purple rounded-2xl p - 12 text-white max - w-4xl mx -auto">
            ...
            <p className="text-xl text-zion - slate - light mb-8">
              ...
              innovative solutions can transform your business.</p>

...
,;
  ...
  y: 0
            ...
            <p className="text-xl md:text-2xl text-gray - 300 mb-8 max - w-4xl mx -auto">
              Comprehensive technology solutions portfolio designed to transform your business.Discover the perfect combination of services to accelerate your digital transformation.</p>
          ...
          <div  className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap-8">;
            {categories.map((category) => {;
              ...
              return (<motion.div
                  ...
                  className={`bg-zion - slate - dark border border-zion - slate - light rounded-xl p - 6 hover:border-cyan - 500 transition - all duration - 300 cursor - pointer ${selectedCategory === category.id ? 'border-cyan - 500 bg-zion - slate' : ''
                  }`}
        ...
        <div  className="max - w-7xl mx - auto px-6">
          <div  className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              providing targeted solutions that deliver measurable results.</p>
          </div>
          ...
          <div  className="grid grid - cols - 1 lg:grid - cols - 2 gap-12">
            ...
            <motion.div
              ...
              <p className="text-gray - 300 mb-6">
                Transform your business with cutting - edge artificial intelligence solutions.From predictive analytics to autonomous systems, our AI services drive innovation
                and efficiency across all business operations.</p>
            ...
            <motion.div
              ...
              <p className="text-gray - 300 mb-6">
                Protect your digital assets with enterprise - grade security solutions.Our cybersecurity services provide comprehensive protection against evolving threats
                while ensuring compliance with industry standards.</p>
              <div  className="space - y-3">
                <div  className="flex items - center space - x-3">
                  <CheckCircle className="w-5 h-5 text-green -400" />
            ...
            >
              ...
              <p className="text-gray - 300 mb-6">
                ...
                that give you a competitive advantage.</p>
              <div  className="space - y-3">
                <div  className="flex items - center space - x-3">
                  <CheckCircle className="w-5 h-5 text-green -400" />
            ...
            >
              ...
              <p className="text-gray - 300 mb-6">
                Streamline your IT operations with our comprehensive technology services.From DevOps automation to infrastructure management, we help you build
                robust, scalable, and efficient technology systems.</p>
              <div  className="space - y-3">
                <div  className="flex items - center space - x-3">
                  <CheckCircle className="w-5 h-5 text-green -400" />
        ...
        <div  className="max - w-4xl mx - auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-cyan - 100 mb-8 max - w-2xl mx -auto">
              ...
              transformation journey today.Our experts are ready to help you succeed.</p>
            <div  className="flex flex - col sm:flex - row gap-4 justify -center">
              <Link
                to="/contact"
      ...
      <div  className="p -6">
        ...
        <div  className="mb-4">
          <div  className="flex flex - wrap gap-2">
            {service.features.slice(0, 2) .map((feature: string, index: number) => (<span
                key={index}

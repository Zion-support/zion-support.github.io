        ...
        <div  className="max - w-7xl mx -auto">
          <div  className="text-center">
            ...
            <p className="text-xl text-slate - 300 mb-8 max - w-4xl mx -auto">
              Transparent, competitive pricing for cutting - edge technology solutions.Choose the plan that fits your business needs and scale as you grow.</p>
              ...
              <div  className="flex items - center space - x-4">
                ...
                <div  className="flex bg-slate - 700 rounded-lg p -1">
                  <button     onClick={ () => setSelectedPeriod('monthly') }
                    className={`px-4 py-2 rounded-md text-sm font - medium transition - all duration - 200 ${selectedPeriod === 'monthly'
                  ...
                  <button     onClick={ () => setSelectedPeriod('yearly') }
                    className={`px-4 py-2 rounded-md text-sm font - medium transition - all duration - 200 ${selectedPeriod === 'yearly'
                        ? 'bg-cyan - 500 text-white'
                        : 'text-slate - 300 hover:text-white'
                    }`}
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">;
        <div  className="max - w-7xl mx -auto">
          ...
          <div  className="grid grid - cols - 1 lg: grid - cols - 3 gap-8">
            {pricingPlans.map((plan, index) => (<div  key={index} className={`relative bg-slate - 800 / 50 border rounded-2xl p - 8 ${plan.popular
                ...
                <div  className="text-center mb-8">
                  ...
                  <Link
                    ...
                    className={`w-full inline - flex items - center justify - center px-6 py-3 rounded-lg font - semibold transition - all duration - 200 ${plan.popular
                ...
                <div  className="space - y-4">
                  ...
                  {plan.features.map((feature, featureIndex) => (<div  key={featureIndex} className="flex items - center text-slate -300">
                  ...
                  {plan.notIncluded.length > 0 && (<>
                      ...
                      {plan.notIncluded.map((feature, featureIndex) => (<div  key={featureIndex} className="flex items - center text-slate -500">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate -800 / 30">;
        <div  className="max - w-7xl mx -auto">
          ...
          <div  className="grid grid - cols - 1 lg: grid - cols - 2 gap-8">
            {servicePricing.map((category, index) => (<div  key={index} className="bg-slate - 800 / 50 border border-slate - 700 / 50 rounded-2xl p -8">
                ...
                <div  className="space - y-4">
                  {category.services.map((service, serviceIndex) => (<div  key={serviceIndex} className="p - 4 bg-slate - 700 / 30 rounded-lg">
        ...
        <div  className="max - w-4xl mx - auto text-center">
          <div  className="bg-gradient - to - r from - cyan - 600 / 20 to - blue - 600 / 20 border border-cyan - 500 / 30 rounded-2xl p -12">
            ...
            <p className="text-xl text-slate - 300 mb-8">
              Our team can create a tailored package that perfectly fits your business requirements and budget.</p>

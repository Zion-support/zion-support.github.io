      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="container mx - auto relative z - 10 text-center">
          ...
          <p className="text-xl md:text-2xl text-zion - slate - light mb-8 max - w-4xl mx -auto">
            ...
            and Google Cloud with zero downtime and guaranteed cost optimization.</p>
          <div className="flex flex - col sm:flex - row gap-4 justify -center">
            <Button asChild size="lg" className="bg-gradient - to - r from - zion - purple to - zion - purple - dark hover:from - zion - purple - light hover:to - zion - purple text-white px-8 py-4 text-lg">
              <Link to="/contact">
                Get Migration Assessment < ArrowRight className="ml-2 h-5 w-5"/>
              </Link>
            </Button>
        ...
        <div className="container mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              Our expert team handles every aspect of your cloud migration journey, from assessment to optimization.</p>
          </div>
      ...
      <section className="py-20 px-4 bg-zion - slate -dark / 30">
        <div className="container mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              We specialize in all major cloud platforms and can help you choose the best solution for your business needs.</p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              Cloud migration offers numerous benefits that can transform your business operations and bottom line.</p>
          </div>
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap-8">
            <Card className="bg-zion - slate - dark / 50 border-zion - purple / 20 hover:border-zion - purple / 40 transition - all duration -300">
              ...
              <CardContent>
                <CardDescription className="text-zion - slate - light text-center">
                  Reduce infrastructure costs by up to 40% with pay - as - you - use cloud services and optimized resource allocation.</CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-zion - slate - dark / 50 border-zion - purple / 20 hover:border-zion - purple / 40 transition - all duration -300">
              ...
              <CardContent>
                <CardDescription className="text-zion - slate - light text-center">
                  Scale your infrastructure up or down instantly based on demand, ensuring optimal performance and cost efficiency.</CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-zion - slate - dark / 50 border-zion - purple / 20 hover:border-zion - purple / 40 transition - all duration -300">
              ...
              <CardContent>
                <CardDescription className="text-zion - slate - light text-center">
                  Benefit from enterprise - grade security features, compliance certifications, and advanced threat protection.</CardDescription>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-zion - slate -dark / 30">
        <div className="container mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              Choose the migration package that fits your business needs.All packages include our comprehensive migration services.</p>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              See what our clients say about our cloud migration expertise and commitment to successful transitions.</p>
          </div>
      ...
      <section className="py-20 px-4 bg-gradient - to - r from - zion - purple / 20 via - zion - cyan / 20 to - zion -blue / 20">
        <div className="container mx - auto text-center">
          ...
          <p className="text-xl text-zion - slate - light mb-8 max - w-3xl mx -auto">
            Join thousands of businesses already enjoying the benefits of cloud computing.Start your migration journey today.</p>
          <div className="flex flex - col sm:flex - row gap-4 justify -center">
            <Button asChild size="lg" className="bg-gradient - to - r from - zion - purple to - zion - purple - dark hover:from - zion - purple - light hover:to - zion - purple text-white px-8 py-4 text-lg">
              <Link to="/contact">
                Start Migration Assessment < ArrowRight className="ml-2 h-5 w-5"/>
              </Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="border-zion - cyan text-zion - cyan hover:bg-zion - cyan / 10 px-8 py-4 text-lg">
              <Link to="/contact">

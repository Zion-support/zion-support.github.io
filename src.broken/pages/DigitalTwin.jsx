...
const digitalTwinBenefits = [{
  ...
  delay: 0.2
            ...
            <h1 className="text-5xl md:text-6xl font - bold text-white mb-6">
              Digital Twin < span className="text-gradient block">Solutions</span>
            </h1>

            <p className="text-xl text-zion - slate - light leading - relaxed mb-8">
              Create virtual replicas of physical assets and systems for real - time monitoring,
              predictive analytics, and optimization.Transform your operations with digital twin technology.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 leading -relaxed">
              ...
              enhance efficiency, and create new opportunities through virtual modeling.</p>

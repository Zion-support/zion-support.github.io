        ...
        <div  className="max - w-7xl mx - auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray - 300 mb-8 max - w-4xl mx -auto">
              ...
              technologies, we have everything you need to succeed.</p>
            ...
            <div  className="grid grid - cols - 1 md:grid - cols - 5 gap-4">
              ...
              <div  className="flex space - x-2">
                <button     onClick={ () => setViewMode('grid') }
                  className={`px-4 py-2 rounded-lg transition - colors duration - 300 ${viewMode === 'grid'
                ...
                <button     onClick={ () => setViewMode('list') }
                  className={`px-4 py-2 rounded-lg transition - colors duration - 300 ${viewMode === 'list'
                      ? 'bg-blue - 600 text-white'
                      : 'bg-white / 20 text-white hover:bg-white / 30'
                  }`}
                >
        ...
        <div  className="max - w-4xl mx - auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 mb-8">
              ...
              efficiency, and competitive advantage for your organization.</p>

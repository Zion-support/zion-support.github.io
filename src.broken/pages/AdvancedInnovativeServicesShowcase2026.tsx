            ...
            >
              ...
              <div className="mb-4">
                ...
                <div className="flex flex - wrap gap-1">
                  {service.features.slice(0, 3) .map((feature, index) => (<span key={index} className="px-2 py-1 bg-slate - 700 / 50 rounded text-xs text-slate -300">
                      {feature}
                    </span>) ) }
                  {service.features.length > 3 && (<span className="px-2 py-1 bg-slate - 700 / 50 rounded text-xs text-slate -300">
        ...
        <div className="container mx - auto px-4 py-20">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate - 300 max - w-3xl mx -auto">
              Our team of experts is ready to help you implement these cutting - edge solutions.Get in touch today to start your journey into the future of technology.</p>
          </div>

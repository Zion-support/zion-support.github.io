...
,
  ...
  y: 0
            ...
            <p className="text-xl text-white / 90 mb-8 max - w-3xl mx - auto leading -relaxed">
              ...
              that will shape the next generation of revolutionary services and solutions.</p>
  ...
  y: 0
            ...
            <p className="text-lg text-zion - slate - light max - w-2xl mx -auto">
              ...
              that will define the future of business and society.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-lg text-zion - slate - light max - w-2xl mx -auto">
              ...
              and strategic insights for informed decision making.</p>
          </motion.div>

...
const hrBenefits = [{
  ...
  delay: 0.2
            ...
            <p className="text-xl text-zion - slate - light leading - relaxed mb-8">
              Transform your human resources operations with intelligent technology solutions.From recruitment to performance management, we help you build a modern HR ecosystem.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 leading -relaxed">
              ...
              improve employee experience, and drive better business outcomes.</p>

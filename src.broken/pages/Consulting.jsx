        ...
        <div className="max - w-7xl mx - auto text-center">
          <div className="mb-8">
            ...
            <h1 className="text-4xl md:text-6xl font - bold text-white mb-6">
              Expert Technology < span className="bg-gradient - to - r from - orange - 400 to - red - 400 bg-clip - text text-transparent"> Consulting</span>
            </h1>
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              Strategic technology consulting to help your organization navigate
              digital transformation and achieve competitive advantages.</p>
        ...
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
              ...
              technology challenges and opportunities.</p>
          </div>
        ...
        <div className="max - w-7xl mx -auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
              ...
              to deliver relevant and effective solutions.</p>
          </div>
          ...
          <div className="grid grid - cols - 1 lg:grid - cols - 2 gap-12 items -center">
            <div>
              ...
              <p className="text-lg text-gray - 300 mb-6">
                ...
                solutions that drive real business value and competitive advantage.</p>
            ...
            <div className="bg-gradient - to - br from - orange - 500 / 20 to - red - 500 / 20 rounded-2xl p - 8 border border-orange -500 / 30">
              <div className="text-center">
                ...
                <p className="text-gray - 300 mb-6">
                  ...
                  and proven track records of success.</p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate -800 / 30">
        <div className="max - w-4xl mx - auto text-center">
          ...
          <p className="text-xl text-gray - 300 mb-8">
            ...
            success and maximizes value for our clients.</p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max - w-4xl mx - auto text-center">
          ...
          <p className="text-xl text-gray - 300 mb-8">
            ...
            digital transformation and achieve your business goals.</p>
          <div className="flex flex - col sm:flex - row gap-4 justify -center">

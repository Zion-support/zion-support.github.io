...
const processSteps = [{
  ...
  delay: 0.2
            ...
            <p className="text-xl text-zion - slate - light leading - relaxed mb-8">
              Transform your data into actionable insights with cutting - edge AI and machine learning.From predictive analytics to real - time processing, we help businesses make data - driven decisions.</p>
  ...
  delay: index * 0.1
                ...
                <span className={`inline - block px-3 py-1 rounded-full text-sm font - semibold ${capability.impact === 'Critical'
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 leading -relaxed">
              ...
              into actionable insights and drive business growth.</p>

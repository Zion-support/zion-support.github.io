...
,
  ...
  y: 0
          ...
          <p className="text-xl md:text-2xl text-zion - slate - light mb-8 max - w-4xl mx -auto">
            Experience the future of technology with our cutting - edge AI, quantum, and blockchain solutions.Transform your business with services that were once science fiction.</p>
  ...
  delay: 0.6
          ...
          <div className="bg-gradient - to - r from - zion - cyan / 20 via - zion - purple / 20 to - zion - cyan / 20 border border-zion - cyan / 30 rounded-2xl p - 12 backdrop - blur -md">
            ...
            <p className="text-xl text-zion - slate - light mb-8 max - w-3xl mx -auto">
              ...
              give you a competitive edge in the market.</p>

      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max - w-7xl mx - auto text-center">
          <h1 className="text-4xl md:text-6xl font - bold mb-6">
            Ultimate < span className="text-transparent bg-clip - text bg-gradient - to - r from - blue - 400 to - cyan -400">
              {" "}Pricing 2025
            </span>
          </h1>
          <p className="text-xl text-gray - 300 mb-8 max - w-4xl mx -auto">
            Transparent, competitive pricing for our comprehensive portfolio of innovative technology solutions.Get enterprise - grade services at market - competitive rates with unmatched value and support.</p>

...
,
  ...
  y: 0
            ...
            <h1 className="text-5xl md:text-6xl font - bold text-white mb-6">
              Cloud Infrastructure < span className="bg-gradient - to - r from - cyan - 400 to - purple - 600 bg-clip - text text-transparent">
                {' '}That Scales{' '}
              </span > With Your Business
            </h1>
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              Build, deploy, and manage robust cloud infrastructure across AWS, Azure, and Google Cloud.Our expertise ensures optimal performance, security, and cost efficiency.</p>
                ...
                : 'bg-white / 20'}`}>
                  ...
                  <div>
                    ...
                    <ul className="space - y-1">
                      {provider.features.map((feature, idx) => (<li key={idx} className="text-xs text-gray -400">• {feature}</li>) ) }
                    </ul>
                  </div>
                </div>
              </motion.button>) ) }
  ...
  y: 0
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray - 300 max - w-2xl mx -auto">
                ...
                with best practices, security, and cost optimization.</p>
            </div>

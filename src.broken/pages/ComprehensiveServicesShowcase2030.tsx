          ...
          <div  className="p -6">
            ...
            <div  className="mb-4">
              ...
              <div  className="grid grid - cols - 2 gap-2">
                {service.features.slice(0, 6) .map((feature: string, index: number) => (<div  key={index} className="flex items - center text-sm text-gray -600">
            ...
            <div  className="mb-4">
              ...
              <div  className="space - y-1">
                {service.benefits.slice(0, 4) .map((benefit: string, index: number) => (<div  key={index} className="flex items - center text-sm text-gray -600">
            ...
            <div  className="mb-4">
              ...
              <div  className="flex flex - wrap gap-2">
                {service.targetAudience.slice(0, 3) .map((audience: string, index: number) => (<span key={index} className="px-2 py-1 text-xs bg-gray - 100 text-gray - 700 rounded-full">
                    {audience}
                  </span>) ) }
              </div>
            </div>
            ...
            <div  className="mb-4">
              ...
              <div  className="flex flex - wrap gap-2">
                {service.technologies.slice(0, 5) .map((tech: string, index: number) => (<span key={index} className="px-2 py-1 text-xs bg-blue - 100 text-blue - 700 rounded-full">
                    {tech}
                  </span>) ) }
              </div>
            </div>
      ...
      return (<div  key={service.id} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition - all duration - 300 border border-gray - 100 overflow-hidden">
          <div  className="p -6">
            ...
            <div  className="mb-4">
              <h4 className="font - semibold text-gray - 900 mb-2">Technologies:</h4>
              <div  className="flex flex - wrap gap-2">
                {service.technologies.slice(0, 5) .map((tech: string, index: number) => (<span key={index} className="px-2 py-1 text-xs bg-green - 100 text-green - 700 rounded-full">
                    {tech}
                  </span>) ) }
              </div>
            </div>
          ...
          <div  className="p -6">
            ...
            <div  className="mb-4">
              ...
              <div  className="flex flex - wrap gap-2 mb-3">
                {service.aiModels.slice(0, 4) .map((model: string, index: number) => (<span key={index} className="px-2 py-1 text-xs bg-purple - 100 text-purple - 700 rounded-full">
                    {model}
                  </span>) ) }
              </div>
            </div>
            ...
            <div  className="mb-4">
              ...
              <div  className="flex flex - wrap gap-2">
                {service.useCases.slice(0, 4) .map((useCase: string, index: number) => (<span key={index} className="px-2 py-1 text-xs bg-pink - 100 text-pink - 700 rounded-full">
                    {useCase}
                  </span>) ) }
              </div>
            </div>
        ...
        <div  className="container mx - auto px-4 py-12">
          ...
          <div  className="mb-8">
            <div  className="flex flex - wrap gap-2 justify -center">
              <button     onClick={ () => setActiveTab('microsaas') }

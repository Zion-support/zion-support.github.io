        ...
        <div  className="container mx - auto px-6 relative z -10">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto leading -relaxed">
              Access our curated network of top - tier technology professionals.Find skilled developers, engineers, and specialists ready to
              elevate your projects.</p>
          </motion.div>
        </div>
      </section>
                ...
                >
                  <div  className="bg-gradient - to - br from - slate - 800 / 50 to - slate - 700 / 50 rounded-2xl border border-slate - 600 / 50 hover:border-blue - 400 / 50 transition - all duration - 300 hover:scale - 105 overflow-hidden">
                    <div  className="p -6">
                      ...
                      <button     onClick={ () => toggleTalentExpansion(talent.id) }

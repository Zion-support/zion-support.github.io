...
,
  ...
  y: 0
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-zion - slate - light mb-12 max - w-4xl mx - auto leading -relaxed">
              Transform your business with strategic technology guidance from industry experts.We help you navigate digital transformation and achieve sustainable competitive advantage.</p>
        ...
        <div className="container mx - auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              make informed technology decisions and achieve your business objectives.</p>
          </motion.div>
        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              ...
              challenges and drive measurable results.</p>
          </motion.div>
            ...
            {consultingServices.map((service, index) => (;
              ...
              >
                ...
                <ul className="space - y-3">
                  {service.features.map((feature, featureIndex) => (<li key={featureIndex} className="flex items - center gap-3 text-zion - slate - light text-sm">
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              ...
              your business challenges and deliver proven solutions.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 max - w-3xl mx -auto">
              ...
              and achieve sustainable business success.</p>
            <motion.button

...
const processSteps = [{
  ...
  delay: 0.2
            ...
            <h1 className="text-5xl md:text-6xl font - bold text-white mb-6">
              Healthcare < span className="text-gradient block">Solutions</span>
            </h1>

            <p className="text-xl text-zion - slate - light leading - relaxed mb-8">
              Secure, compliant, and innovative technology solutions designed specifically for healthcare.From HIPAA - compliant mobile apps to AI - powered diagnostics, we help healthcare organizations
              deliver better patient care through technology.</p>
  ...
  delay: index * 0.1
                ...
                <div className="flex flex - wrap gap-2 mb-4">
                  {solution.compliance.map((comp, compIndex) => (<span
                      key={compIndex}
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 leading -relaxed">
              ...
              streamline operations, and ensure compliance for your organization.</p>

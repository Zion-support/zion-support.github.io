              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <div className="flex flex - wrap gap-2">
                    {category.features.map ( (feature, index) => (<span key={index} className="px-3 py-1 bg-slate - 700 / 50 rounded-full text-xs text-slate -300">
                        {feature}
                      </span>) ) }
                  </div>
                </div>
      ...
      >
        <div className="container mx - auto px-4 py-20">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate - 300 max - w-3xl mx -auto">
              Our team of innovation experts is ready to help you implement these cutting - edge solutions.Get in touch today to start your journey into the future of technology.</p>
          </div>

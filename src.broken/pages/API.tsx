...
def check_threat(ip_address) :;
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx - auto mb-8">
              ...
              with our comprehensive RESTful APIs.Build, deploy, and scale with confidence.</p>
  ...
  delay: index * 0.1
                ...
                <div className="flex items - center justify -between">
                  <div className="flex items - center space - x-4">
                    <span className={`px-3 py-1 rounded-full text-sm font - semibold ${endpoint.method === 'GET' ? 'bg-green - 500 / 20 text-green - 400' :
                  ...
                  <span className={`px-3 py-1 rounded-full text-sm ${endpoint.auth === 'Required' ? 'bg-red - 500 / 20 text-red - 400' : 'bg-green - 500 / 20 text-green - 400'
                  }`}>
                    {endpoint.auth}
                  </span>
                </div>

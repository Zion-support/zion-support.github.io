      ...
      <section className="bg-zion - blue py-20">
        <div className="container mx - auto px-4 text-center">
          ...
          <p className="text-xl text-zion - slate - light mb-8 max - w-3xl mx -auto">
            Discover our complete ecosystem of AI services, micro SAAS solutions, IT infrastructure, and digital transformation services designed to accelerate your business growth.</p>
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 3 gap-8 max - w-4xl mx -auto">
            <div className="text-center">
              ...
              <p className="text-zion - slate -light">
                Our services have helped businesses achieve significant improvements in efficiency, cost savings, and growth.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-zion - slate -light">
                Certified professionals with years of experience in AI, IT, and digital transformation across various industries.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-zion - slate -light">
                24 / 7 support and maintenance to ensure your systems run smoothly and efficiently at all times.</p>
            </div>
          </div>
        </div>
      </section>

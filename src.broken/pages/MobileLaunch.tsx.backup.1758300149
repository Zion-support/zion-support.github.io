...
,;
  ...
  x: 0
              ...
              <h2 className="text-5xl md:text-6xl font - bold text-white mb-6 leading -tight">
                Take Zion < span className="block bg-gradient - to - r from - cyan - 400 via - blue - 500 to - purple - 600 bg-clip - text text-transparent">
                  Everywhere
                </span>
              </h2>
              ...
              <p className="text-xl text-slate - 300 mb-8 leading -relaxed">
                ...
                powerful mobile application.Available for iOS and Android devices.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-slate - 300 max - w-3xl mx -auto">
              ...
              with our feature - rich mobile application.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-xl text-slate - 300 max - w-3xl mx -auto">
              Explore the intuitive interface and powerful features available in our mobile application.</p>
          </motion.div>
  ...
  delay: index * 0.1
                ...
                <div className="space - y-3">
                  {screen.features.map((feature, featureIndex) => (<div key={featureIndex} className="flex items - center text-slate -400">
  ...
  y: 0
            ...
            <p className="text-xl text-slate - 300 max - w-3xl mx -auto">
              Get started with Zion Tech Group's mobile app today.Available on all major platforms.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-xl text-slate - 300 max - w-3xl mx -auto">
              Ensure your device meets the requirements for optimal performance and experience.</p>
          </motion.div>

...
export default function Page() {
  ...
  y: 0
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              Discover the future of AI services with our comprehensive marketplace platform.Connect, integrate, and optimize your AI solutions with cutting - edge tools and services.</p>
  ...
  delay: index * 0.1
                  ...
                  className={`bg-slate - 800 rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition - all duration - 300 hover:scale - 105 ${viewMode === 'list' ? 'flex' : ''
                  }`}
                >
                  {/* Service Header */}
  ...
  y: 0
          ...
          >
            ...
            <p className="text-xl text-gray - 300 mb-8">
              ...
              efficiency, and growth for your organization.</p>
            <div  className="flex flex - col sm:flex - row gap-4 justify -center">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}

      ...
      <div  className="container -responsive">
        ...
        <motion.div
          ...
          <p className="text-zion - slate - light text-lg max - w-3xl mx -auto">
            Find answers to your questions, learn how to use our services, and get the support you need to succeed with Zion Tech Group.</p>
        </motion.div>
        ...
        <motion.div
          ...
          <div  className="max - w-4xl mx -auto">
            ...
            <div  className="flex flex - wrap justify - center gap-3 mb-8">
              ...
              {helpCategories.map(category => (<button     key={category.id}
                            ...
                            {section.articles.map((article, articleIndex) => (<motion.div
                              ...
                              >
                                {article.path ? (<Link
                                    ...
                                    <div  className="flex items - start justify -between">
                                      <div  className="flex -1">
                                        ...
                                        <div  className="flex items - center space - x-4 mt-3">
                                          <span className={`px-2 py-1 rounded-full text-xs font - medium ${article.difficulty === 'Beginner' ? 'bg-green - 500 / 20 text-green - 400' :
                                  ...
                                  </Link>) : (<div  className="p - 4 bg-zion - slate - dark / 30 border border-cyan - 400 / 10 rounded-lg">

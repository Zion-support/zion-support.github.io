          ...
          <div className="max - w-7xl mx - auto text-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray - 300 mb-8 max - w-3xl mx -auto">
                Transform your business with intelligent automation that learns, adapts, and optimizes operations 24 / 7.Reduce costs by 40% and improve efficiency by 60%.</p>
          ...
          <div className="max - w-7xl mx -auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
                Our platform combines cutting - edge AI with proven business process optimization techniques.</p>
            </div>
        ...
        <section className="py-20 bg-slate - 800 / 30 px-4 sm:px-6 lg:px-8">
          <div className="max - w-7xl mx -auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
                See how autonomous operations can revolutionize different aspects of your business.</p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max - w-7xl mx -auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
                Our autonomous operations platform delivers concrete, measurable results for your business.</p>
            </div>
        ...
        <section className="py-20 bg-slate - 800 / 30 px-4 sm:px-6 lg:px-8">
          <div className="max - w-7xl mx -auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
                Tailored autonomous operations solutions for various industries and business types.</p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max - w-7xl mx -auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
                Real results from real businesses using our autonomous operations platform.</p>
            </div>

        ...
        <div className="container mx - auto px-4 text-center">
          <div className="max - w-4xl mx -auto">
            <h1 className="text-5xl md:text-6xl font - bold text-white mb-6">
              IoT Solutions for the < span className="block text-transparent bg-clip - text bg-gradient - to - r from - zion - cyan to - zion - purple -light">
                Connected World
              </span>
            </h1>
            <p className="text-xl text-zion - slate - light mb-8 max - w-3xl mx -auto">
              Connect, monitor, and optimize your business with cutting - edge IoT technology.From device management to
              advanced analytics, we deliver comprehensive IoT solutions that drive innovation and efficiency.</p>

  ...
  y: 0
            ...
            >
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                <p > These Terms of Service ("Terms") govern your use of the {compName} website located at {website} and  related services provided by {compName} ("we," "our," or "us") .</p>
                <p > By accessing or using our website and services, you agree to be bound by these Terms.If you disagree with  part of these terms, you may not access our website or use our services.</p>
                <p > These Terms apply to all visitors, users, and others who access or use our website and services.</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                <p > When you create an account with us, you must provide accurate, complete, and current information.You are responsible for:
                </p>
                <ul className="space - y-2 text-zion - slate - light ml-6">
                  <li className="flex items - start gap-2">
                    <CheckCircle className="w-4 h-4 text-zion - cyan mt-0.5 flex - shrink -0" />
                ...
                <p > You may not use another person's account or provide false information.We reserve the right to terminate accounts that violate these terms.</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                ...
                <p > Violation of this policy may result in termination of your access to our services.</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                <p > Our website and services contain content that is owned by {companyName} or its licensors, including but not limited to:
                </p>
                <ul className="space - y-2 text-zion - slate - light ml-6">
                  <li className="flex items - start gap-2">
                    <CheckCircle className="w-4 h-4 text-zion - cyan mt-0.5 flex - shrink -0" />
                ...
                <p > You may not copy, reproduce, distribute, or create derivative works from our content without our express written permission.</p>
                <p > Any content you submit to our services remains your property, but you grant us a license to use, modify, and distribute such content in connection with our services.</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                ...
                <p > We implement appropriate security measures to protect your data, but no method of transmission over the internet is 100% secure.</p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                <p > To the maximum extent permitted by law, {companyName} shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to:
                </p>
                <ul className="space - y-2 text-zion - slate - light ml-6">
                  <li className="flex items - start gap-2">
                    <AlertTriangle className="w-4 h-4 text-zion - cyan mt-0.5 flex - shrink -0" />
            ...
            <motion.div
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                <p > You agree to indemnify, defend, and hold harmless {companyName} and its officers, directors, employees, agents, and affiliates from and against any claims, damages, losses, liabilities, costs, and expenses(including reasonable attorneys' fees) arising from:
                </p>
                <ul className="space - y-2 text-zion - slate - light ml-6">
                  <li className="flex items - start gap-2">
                    <CheckCircle className="w-4 h-4 text-zion - cyan mt-0.5 flex - shrink -0" />
            ...
            <motion.div
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                ...
                <p > Upon termination, your right to use our services will cease immediately.If you wish to terminate your account, you may simply discontinue using our services.</p>
            ...
            <motion.div
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                ...
                <p > The arbitration shall be conducted in English and the seat of arbitration shall be in the United States.</p>
              </div>
            </motion.div>
  ...
  delay: 1.0
            ...
            >
              ...
              <p className="text-xl text-purple - 100 mb-8">
                Our legal team is here to help clarify any questions about our Terms of Service.</p>

...
,
        ...
        },
        {
            ...
            achievements["Generated $200M + in new business",
  ...
  title: "Our Vision",
        ...
        goals["Advance AI consciousness and autonomous systems",
      ...
      <section className="relative bg-gradient - to - r from - slate - 900 via - blue - 900 to - slate - 900 text-white py-20">
        ...
        <div className="relative max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue - 100 mb-8 max - w-4xl mx -auto">
            ...
            innovation in technology and business transformation.</p>
      ...
      <section className="py-20 bg-white">
        <div className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate - 600 max - w-3xl mx -auto">
              The principles that guide our decisions, shape our culture, and drive our success.</p>
          </div>
      ...
      <section className="py-20 bg-gradient - to - r from - slate - 900 to - blue - 900 text-white">
        <div className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue - 100 mb-8 max - w-3xl mx -auto">
            ...
            transforming businesses around the world.</p>
          <div className="flex flex - col sm:flex - row gap-4 justify -center">

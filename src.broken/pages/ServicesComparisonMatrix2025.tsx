...
,;
  ...
  y: 0
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue - 100 max - w-4xl mx -auto">
              Compare our innovative AI - powered micro SAAS solutions side by side.Find the perfect service for your business needs with detailed feature comparisons.</p>
            ...
            <div  className="flex items - center gap-4">
              ...
              <div  className="flex items - center gap-2">
                <button     onClick={ () => setViewMode('matrix') }
                  className={`p - 2 rounded-lg transition - colors ${viewMode === 'matrix'
  ...
  y: 0
                ...
                className={`p - 4 border rounded-lg cursor - pointer transition - all duration - 200 ${selectedServices.includes(service.id) ? 'border-blue - 500 bg-blue - 50 shadow-md'
      ...
      {/* Comparison Matrix */}
      {selectedServices.length > 0 && (<section id="comparison" className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-12">
          <div  className="mb-8">
          ...
          {viewMode === 'matrix' ? (<div  className="overflow-x-auto">
              <div  className="min - w-[1200px]">
                <div  className="grid grid - cols - 6 gap-4 mb-4">
                  <div  className="font - semibold text-gray - 900 p - 4 bg-gray - 50 rounded-lg">
                    Features & Metrics
                  </div>
                  {selectedServicesData.map((service, index) => (<div  key={service?.id} className="text-center p - 4 bg-blue - 50 rounded-lg">
                ...
                <div  className="grid grid - cols - 6 gap-4 mb-4">
                  ...
                  {selectedServicesData.map((service) => (<div  key={service?.id} className="p - 3 bg-white border rounded-lg">
                ...
                <div  className="grid grid - cols - 6 gap-4 mb-4">
                  ...
                  {selectedServicesData.map((service) => (<div  key={service?.id} className="p - 3 bg-white border rounded-lg">
                      <div  className="space - y-2">
                        {service?.features.slice(0, 5) .map((feature, idx) => (<div  key={idx} className="flex items - center gap-2 text-xs">
                ...
                <div  className="grid grid - cols - 6 gap-4 mb-4">
                  ...
                  {selectedServicesData.map((service) => (<div  key={service?.id} className="p - 3 bg-white border rounded-lg">
                      <div  className="space - y-2">
                        {service?.benefits.map((benefit, idx) => (<div  key={idx} className="flex items - center gap-2 text-xs">
                ...
                {selectedServicesData.some(service => service?.technicalSpecs) && (<div  className="grid grid - cols - 6 gap-4 mb-4">
                    ...
                    {selectedServicesData.map((service) => (<div  key={service?.id} className="p - 3 bg-white border rounded-lg">
                        {service?.technicalSpecs ? (<div  className="space - y-2 text-xs">
                            <div>
                ...
                <div  className="grid grid - cols - 6 gap-4">
                  ...
                  {selectedServicesData.map((service) => (<div  key={service?.id} className="p - 3 bg-white border rounded-lg">
                      <div  className="space - y-2">
                        ...
                        >
                          Call Sales < Phone className="w-3 h-3" />
                        </a>
                      </div>
                    </div>) ) }
                </div>
                  ...
                  <div  className="p -6">
                    ...
                    <div  className="grid grid - cols - 1 md:grid - cols - 2 gap-6">
                      ...
                      <div>
                        ...
                        <ul className="space - y-2">
                          {service?.benefits.map((benefit, idx) => (<li key={idx} className="flex items - center gap-2 text-sm text-gray -600">
                    ...
                    <div  className="mt-6 flex flex - col sm:flex - row gap-3">
                      ...
                      >
                        Call Sales: +1 302 464 0950 < Phone className="w-4 h-4" />
                      </a>
                    </div>
                  </div>
                </motion.div>) ) }
  ...
  y: 0
          ...
          >
            ...
            <p className="text-xl text-blue - 100 mb-8 max - w-3xl mx -auto">
              Our expert team is here to help you select the perfect service for your business needs.Get personalized recommendations and custom quotes.</p>
            <div  className="flex flex - col sm:flex - row gap-4 justify -center">
              <a
              ...
              >
                Get Expert Advice < Mail className="w-5 h-5" />
              </a>
              <a
                href="tel:+13024640950"
              ...
              >
                Call Now: +1 302 464 0950 < Phone className="w-5 h-5" />
              </a>
            </div>
          </motion.div>
        </div>

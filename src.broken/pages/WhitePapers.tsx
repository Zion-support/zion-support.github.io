  ...
  return (<div  className="min - h-screen bg-gradient - to - br from - zion - slate - dark via - zion - slate to - zion - slate -light">
      ...
      <div  className="py-12 bg-zion - slate -dark">
        <div  className="container mx - auto px-4">
          ...
          <div  className="grid grid - cols - 1 md:grid - cols - 3 gap-6 max - w-4xl mx -auto">
            {featuredInsights.map((insight, index) => (<div  key={index}
      ...
      <div  className="py-16">
        <div  className="container mx - auto px-4">
          ...
          {filteredPapers.length > 0 ? (<div  className="grid grid - cols - 1 lg:grid - cols - 2 gap-8 max - w-6xl mx -auto">
              {filteredPapers.map(paper => (<div  key={paper.id}
                  className={`bg-zion - slate border border-zion - slate - light rounded-lg p - 6 hover:shadow-lg transition - shadow ${paper.featured ? 'ring - 2 ring - zion - cyan' : ''
                  }`}
                >

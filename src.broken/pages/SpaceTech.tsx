        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Our comprehensive space technology platform provides everything
              you need to explore, communicate, and operate in the vast expanse
              of space.</p>
          </motion.div>
        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              improving life on Earth.</p>
          </motion.div>

          <div className="grid grid - cols - 1 lg: anygrid - cols - 2 gap-8">
            {applications.map((application, index) => (<motion.div
                key={index}
              ...
              >
                ...
                <ul className="space - y-2">
                  {application.benefits.map((benefit, benefitIndex) => (<li
                      key={benefitIndex}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Built with cutting - edge space technologies for maximum
              performance, reliability, and innovation.</p>
          </motion.div>

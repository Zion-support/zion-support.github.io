...
export default function Page() {
      ...
      <div  className="bg-gradient - to - r from - slate - 800 / 50 to - slate -900 / 50">,
        <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div  className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap-8">
            {Object.entries(ULTIMATE_SERVICE_GUARANTEES_2025) .map(([key, value]) => (<div  key={key} className="bg-white / 10 backdrop - blur - lg rounded-xl p - 6 border border-white / 20">
      ...
      <div  className="bg-gradient - to - r from - purple - 900 / 50 to - blue -900 / 50">,
        <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div  className="grid grid - cols - 1 md:grid - cols - 3 gap-8">
            {Object.entries(ULTIMATE_PRICING_TIERS_2025) .map(([tier, details]) => (<div  key={tier} className="bg-white / 10 backdrop - blur - lg rounded-xl p - 8 border border-white / 20">
      ...
      <div  className="max - w-7xl mx - auto px-4 sm: px-6 lg:px-8 pb -24">,
        <div  className="grid grid - cols - 1 lg:grid - cols - 2 xl:grid - cols - 3 gap-8">
          {filteredServices.map((service) => (<div  key={service.id}
          ...
          <div  className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap-8">
            ...
            <div  className="lg:col - span -2">
              ...
              <p className="text-gray - 300 mb-6 max - w-md">
                Leading provider of innovative AI, cybersecurity, and digital transformation solutions.We help businesses thrive in the digital age with cutting - edge technology and expert guidance.</p>

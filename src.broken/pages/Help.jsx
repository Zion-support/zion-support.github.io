      ...
      <section className="py-16 bg-gradient - to - r from - zion - cyan to - zion -purple">
        <div className="container mx - auto px-4 text-center">
          ...
          <p className="text-xl text-white / 90 mb-8 max - w-3xl mx -auto">
            Find answers to your questions, learn how to use our services, and
        ...
        <div className="container mx - auto px-4">
          ...
          <div className="max - w-4xl mx - auto space - y-4">
            {filteredCategories.map(category => (<div
                key={category.id}
                className="bg-zion - blue - dark / 50 rounded-lg border border-zion - cyan / 20 overflow-hidden"
              >
                <button
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap-8 max - w-6xl mx -auto">
            ...
            <div className="bg-zion - blue - dark / 50 rounded-lg border border-zion - cyan / 20 overflow-hidden">
              ...
              <div className="p -6">
                ...
                <p className="text-zion - slate - light text-sm mb-4">
                  Master the art of listing services and finding opportunities.</p>
                <button className="text-zion - cyan hover:text-zion - cyan - light transition - colors text-sm font -medium">
                  Watch Video →
                </button>
              </div>
            ...
            <div className="bg-zion - blue - dark / 50 rounded-lg border border-zion - cyan / 20 overflow-hidden">
              ...
              <div className="p -6">
                ...
                <p className="text-zion - slate - light text-sm mb-4">
                  Discover how to leverage our AI and technology services.</p>
                <button className="text-zion - cyan hover:text-zion - cyan - light transition - colors text-sm font -medium">
                  Watch Video →
                </button>
              </div>

  ...
  return (<div className="min - h-screen bg-gradient - to - br from - slate - 900 via - slate - 800 to - slate -900">
        ...
        <div className="relative max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 pt - 32 pb -16">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto leading -relaxed">
              Zion Tech Group delivers industry - specific technology solutions
              that address unique challenges and drive transformation across
              diverse sectors.From healthcare to manufacturing, we understand
              your industry.</p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-xl text-gray - 300 max - w-2xl mx -auto">
            Comprehensive technology solutions designed specifically for your
            ...
            >
              ...
              <div className="mb-6">
                ...
                <ul className="space - y-1">
                  {industry.solutions.map((solution, idx) => (<li
                      key={idx}

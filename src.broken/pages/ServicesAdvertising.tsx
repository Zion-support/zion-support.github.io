...
,
    {
      ...
      refs: ['https://www.apollo.io / pricinghttps://www.lemlist.com / pricing',
    ...
    },
    {
      ...
      refs: ['https://www.wiz.io / pricinghttps://snyk.io / plans/',
    ...
    },
    {
      ...
      refs: ['https://www.databricks.com / product / pricinghttps://www.snowflake.com / pricing/',
            ...
            {spotlight.map(h => (<div
              ...
              >
                ...
                <ul className="text-slate - 300 space - y-1 mt-2">
                  {h.refs.map (u => (<li key={u}>{anchor (u) }</li>) ) }
                </ul>
                <div className="mt-3">

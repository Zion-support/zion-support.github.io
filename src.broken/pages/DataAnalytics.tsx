        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              ...
              with our comprehensive analytics platform.</p>
        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              need to turn data into actionable insights.</p>
          </motion.div>
        ...
        <div className="max - w-7xl mx -auto">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              ...
              business across different domains.</p>
          </motion.div>
            ...
            {useCases.map((useCase, index) => (<motion.div
              ...
              >
                ...
                <ul className="space - y-2">
                  {useCase.benefits.map((benefit, benefitIndex) => (<li
                      key={benefitIndex}

          ...
          <div className="grid md:grid - cols - 2 lg:grid - cols - 3 gap-8 mb-16">
            <div className="bg-white / 10 backdrop - blur - lg rounded-xl p - 6 border border-white / 20">
              ...
              <p className="text-gray -300">
                AI trained on quality datasets
              </p>
            </div>
            ...
            <div className="bg-white / 10 backdrop - blur - lg rounded-xl p - 6 border border-white / 20">
              ...
              <p className="text-gray -300">
                AI that ensures quality independently
              </p>
            </div>
            ...
            <div className="bg-white / 10 backdrop - blur - lg rounded-xl p - 6 border border-white / 20">
              ...
              <p className="text-gray -300">
                24 / 7 quality assurance operations
              </p>
            </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid - cols - 5 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray - 300 text-sm">Monitor quality</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray - 300 text-sm">Analyze quality</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray - 300 text-sm">Ensure standards</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray - 300 text-sm">Optimize quality</p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid - cols - 3 gap-8">
              <div className="bg-white / 5 rounded-xl p - 6 border border-white / 10">
                ...
                <p className="text-gray -300">Software quality assurance</p>
              </div>
              ...
              <div className="bg-white / 5 rounded-xl p - 6 border border-white / 10">
                ...
                <p className="text-gray -300">Product quality assurance</p>
              </div>
              ...
              <div className="bg-white / 5 rounded-xl p - 6 border border-white / 10">
                ...
                <p className="text-gray -300">Service quality assurance</p>
              </div>
            </div>
          </div>

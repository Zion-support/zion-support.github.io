                  ...
                  <div  className="p -6">
                    ...
                    <div  className="mb-4">
                      <div  className="flex flex - wrap gap-2 mb-3">
                        {service.pricingTiers.map(tier => (<button     key={tier.name}
                            onClick={ () => setSelectedTier(tier.name) }
                            className={`px-3 py-1 rounded-lg text-xs font - medium transition - all ${selectedTier === tier.name
                      ...
                      <div  className="p - 6 space - y-6">
                        ...
                        <div>
                          ...
                          <div  className="grid grid - cols - 1 gap-2">
                            {selectedPricingTier.features.map((feature, index) => (<div  key={index}
                        ...
                        <div>
                          ...
                          <div  className="grid grid - cols - 1 gap-2">
                            {selectedPricingTier.limitations.map((limitation, index) => (<div  key={index}
                                  className="flex items - start gap-2 text-sm text-gray -300"
                                >
        ...
        <div  className="max - w-4xl mx - auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 mb-8">
              ...
              discuss your specific needs and get a customized proposal.</p>

...
const Community: React.FC = () => {
              ...
              <Link
                ...
                <div  className="p -6">
                  <div  className="flex items - center justify - between mb-4">
                    <span className={`px-3 py-1 rounded-full text-xs font - medium ${event.type === 'Conference' ? 'bg-purple - 500 / 20 text-purple - 400' :
  ...
  delay: 0.8 + index * 0.1
      ...
      <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* No Results */}
        {sortedPosts.length === 0 && (<div  className="text-center py-12">

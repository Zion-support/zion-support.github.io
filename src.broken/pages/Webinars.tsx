      ...
      <div  className="min - h-screen bg-gradient - to - br from - blue - 900 via - purple - 900 to - indigo -900">
          ...
          <div  className="max - w-7xl mx -auto">
            <div  className="bg-slate - 800 / 50 backdrop - blur - sm rounded-xl p - 6 border border-slate -700 / 50">
              ...
              <div>
                ...
                <div  className="flex flex - wrap gap-2">
                  {filterTypes.map(type => (<button     key={type.id}
        ...
        <section className="py-16 px-4">
          <div  className="max - w-7xl mx -auto">
              ...
              {filteredWebinars.map((webinar, index) => (<motion.div
                ...
                >
                  ...
                  <div  className="relative h-48 bg-gradient - to - br from - slate - 700 to - slate -800">
                    ...
                    {webinar.featured && (<div  className="absolute top - 3 left -3">
                        <Star className="w-5 h-5 text-yellow-400 fill -current" />
                      </div>) }
                    {webinar.type === 'live' && (<div  className="absolute top - 3 right - 3 bg-red - 500 text-white px-2 py-1 rounded-full text-xs font -medium">
                        LIVE
                      </div>) }
                  </div>
                  ...
                  <div  className="p -6">
                    <div  className="flex items - center gap-2 mb-3">
                      <span
                        className={`px-2 py-1 rounded-full text-xs font - medium ${webinar.type === 'upcoming'
            ...
            {filteredWebinars.length === 0 && (<div  className="text-center py-12">

...
,
  ...
  y: 0
            ...
            <p className="text-xl md:text-2xl text-zion - slate - light mb-12 max - w-4xl mx - auto leading -relaxed">
              ...
              and scalable solutions that drive innovation and growth.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              ...
              transform your infrastructure and accelerate your digital transformation.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              ...
              expert guidance and proven methodologies.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              ...
              you get the best solution for your specific needs.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 max - w-3xl mx -auto">
              ...
              cloud infrastructure that drives your business forward.</p>
            <motion.button

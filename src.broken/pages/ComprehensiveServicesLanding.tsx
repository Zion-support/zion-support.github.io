...
export default function Page() {
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray - 300 mb-8 max - w-4xl mx -auto">
                ...
                that drive growth, efficiency, and competitive advantage across all industries.</p>
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
                Comprehensive solutions designed to address every aspect of modern business technology needs.</p>
            </motion.div>
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
                Our most innovative AI services that deliver measurable business impact.</p>
            </motion.div>
  ...
  y: 0
            ...
            >
              ...
              <p className="text-xl text-gray - 300 mb-8">
                Let our experts help you choose the right solutions for your specific needs.</p>

          ...
          <AnimatePresence mode="wait">
            ...
            >
              {sortedServices.map((service, index) => (<motion.div
                ...
                >
                  {/* Badge */}
                  {service.badge && (<div  className="absolute top - 4 right -4">
                      <span className={`px-3 py-1 rounded-full text-xs font - semibold ${service.badge === 'New' ? 'bg-green - 500 text-white' :

...
const customerExperienceBenefits = [{
  ...
  delay: 0.2
            ...
            <h1 className="text-5xl md:text-6xl font - bold text-white mb-6">
              Customer < span className="text-gradient block">Experience</span>
            </h1>

            <p className="text-xl text-zion - slate - light leading - relaxed mb-8">
              Transform your customer interactions with data - driven insights and personalized experiences.From UX design to customer journey optimization, we help you create memorable customer experiences.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 leading -relaxed">
              ...
              improve customer satisfaction, and drive sustainable growth.</p>

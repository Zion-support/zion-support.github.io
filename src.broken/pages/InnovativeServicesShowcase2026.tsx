...
export default function Page() {
      ...
      >
        <div className="max - w-7xl mx - auto text-center">
          ...
          <motion.p
            ...
            transition={{ duration: 0.8 }}
          >
            Discover cutting - edge micro SAAS solutions that transform industries and drive innovation.From AI - powered platforms to quantum - safe cybersecurity, we deliver the future of technology.</motion.p>
          {/* Contact Information */}
          <motion.div
  ...
  delay: index * 0.1
              ...
              >
                ...
                <div className="absolute top - 4 right -4">
                  <span className={`px-3 py-1 rounded-full text-xs font - semibold ${service.innovationLevel === 'Cutting - edge'
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex - wrap gap-1">
                    ...
                    {service.features.length > 3 && (<span className="text-xs text-slate - 400 px-2 py-1">
                ...
                <div className="mb-4">
                  ...
                  <ul className="space - y-1">
                    {service.benefits.slice(0, 2) .map((benefit, idx) => (<li key={idx} className="text-xs text-slate - 300 flex items - start gap-2">
        ...
        <div className="max - w-4xl mx - auto text-center">
          <div className="bg-gradient - to - r from - cyan - 500 / 10 to - blue - 600 / 10 backdrop - blur - md border border-cyan - 500 / 20 rounded-3xl p -12">
            ...
            <p className="text-xl text-gray - 300 mb-8">
              Let's discuss how our innovative solutions can drive your success.Get in touch with our experts today.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-slate - 300 mb-8 max - w-3xl mx -auto">
              Our innovative services are designed to give you a competitive edge in the rapidly evolving technology landscape.Let's discuss how we can help you achieve your goals.</p>

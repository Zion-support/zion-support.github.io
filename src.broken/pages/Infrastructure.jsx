...
const infrastructureBenefits = [{
  ...
  delay: 0.2
            ...
            <p className="text-xl text-zion - slate - light leading - relaxed mb-8">
              Build robust, scalable, and secure IT infrastructure that powers your business.From data centers to cloud solutions, we help you create the foundation for digital success.</p>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 leading -relaxed">
              ...
              improve performance, and ensure scalability for future growth.</p>

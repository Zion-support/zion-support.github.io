...
export default function Page() {
          ...
          <div className="mb-16">
            ...
            <div className="grid md: grid - cols - 4 gap-6">
              {['AWS SecurityAzure Security',
                'Google Cloud SecurityMulti - Cloud Security',
                'Cloud Access SecurityCloud Data Security',
                'Cloud Network SecurityCloud Application Security'
              ].map (type => (<div
                  key={type}

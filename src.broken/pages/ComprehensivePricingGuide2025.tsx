        ...
        <div className="container -responsive">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8 leading -relaxed">
              Transparent pricing for all our AI - powered technology solutions.Choose the plan that fits your business needs and budget.</p>
          ...
          <div className="grid grid - cols - 1 lg:grid - cols - 3 gap-8">
            {pricingTiers.map ( (tier, index) => (<motion.div
              ...
              >
                ...
                <div
                  className={`p - 8 rounded-2xl bg-gradient - to - br ${tier.color} bg-opacity - 10 border border-${tier.color.split('-') [1]}-500 / 20 hover:bg-opacity - 20 transition - all duration - 300 transform hover:scale - 105`}
                >
                  ...
                  <ul className="space - y-4 mb-8">
                    {tier.features.map((feature, idx) => (<li key={idx} className="flex items - center gap-3">
                  ...
                  <Link
                    to={tier.href}
                    className={`w-full inline - flex items - center justify - center px-6 py-3 rounded-xl font - semibold transition - all duration - 300 transform hover:scale - 105 ${tier.popular
        ...
        <div className="container -responsive">
          ...
          <div className="grid grid - cols - 1 lg:grid - cols - 2 gap-8">
            {serviceCategories.map((category, index) => (<motion.div
              ...
              >
                <div
                  className={`w-16 h-16 bg-gradient - to - br ${category.color} rounded-xl flex items - center justify - center mb-6`}
                >
                ...
                <div className="space - y-4">
                  {category.services.map((service, idx) => (<div
                      key={idx}
        ...
        <div className="container -responsive">
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap-6">
            {industrySolutions.map((solution, index) => (<motion.div
              ...
              >
                <div
                  className={`w-16 h-16 bg-gradient - to - br ${solution.color} rounded-xl flex items - center justify - center mx - auto mb-4`}
                >
          ...
          >
            <div className="bg-gradient - to - r from - slate - 800 / 50 to - slate - 700 / 50 rounded-3xl p - 12 border border-slate -600 / 50">
              ...
              <p className="text-xl text-gray - 300 mb-8 max - w-2xl mx -auto">
                Our pricing is flexible and can be customized to meet your
                specific requirements.Contact us for a personalized quote.</p>
      ...
      <section className="py-20">
        <div className="container -responsive">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 mb-8 max - w-2xl mx -auto">
              Our team is here to help you understand our pricing and find the
              best solution for your needs.</p>

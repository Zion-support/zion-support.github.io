...
export default function Page() {
  ...
  y: 0
            ...
            <h1 className="text-5xl md:text-6xl font - bold text-white mb-6">
              Complete Technology < span className="block text-transparent bg-clip - text bg-gradient - to - r from - blue - 400 via - purple - 500 to - pink -400">
                Solutions Portfolio
              </span>
            </h1>
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              ...
              your business operations and drive digital innovation across all industries.</p>
  ...
  delay: index * 0.1
                ...
                <Link
                  ...
                  <div className="text-center">
                    ...
                    {category.services.length > 3 && (<div className="text-xs text-slate -400">
                ...
                <div className="flex items - start gap-4">
                  ...
                  <div className="flex - 1 min - w-0">
                    ...
                    <div className="space - y-3 mb-6">
                      {categoryData.services.slice(0, 3) .map((service, idx) => (<div key={idx} className="flex items - center text-sm text-gray -400">
                          <CheckCircle className="w-4 h-4 text-green - 400 mr-3 flex - shrink -0" />
                          <span className="truncate">{service.title}</span>
                        </div>) ) }
                      {categoryData.services.length > 3 && (<div className="text-sm text-blue -400">
  ...
  delay: index * 0.1
                ...
                <div className="space - y-2 mb-4">
                  {service.features.slice(0, 2) .map((feature, idx) => (<div key={idx} className="flex items - center text-xs text-gray -400">
  ...
  y: 0
            ...
            <p className="text-gray - 300 mb-6 max - w-2xl mx -auto">
              ...
              and provide a customized implementation plan for your business needs.</p>

...
,
  ...
  y: 0
            ...
            <p className="text-xl text-white / 90 mb-8 max - w-3xl mx - auto leading -relaxed">
              ...
              recommendation engine.Get personalized matches based on your industry, goals, and requirements.</p>
  ...
  y: 0
            ...
            <p className="text-lg text-zion - slate - light max - w-2xl mx -auto">
              ...
              personalized service recommendations that maximize your ROI and success.</p>
          </motion.div>

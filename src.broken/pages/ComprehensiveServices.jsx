      ...
      <div className="bg-gradient - to - br from - zion - blue to - zion - blue - dark py-20 px-4">
        <div className="container mx - auto text-center">
          ...
          <p className="text-xl text-zion - slate - light mb-8 max - w-3xl mx -auto">
            Discover our extensive portfolio of innovative micro SAAS, IT, and
            AI services designed to transform your business operations and drive
            growth
          </p>
          ...
          <div className="flex flex - col md:flex - row gap-4 max - w-4xl mx -auto">
            ...
            >
              ...
              <SelectContent className="bg-zion - blue border-zion - blue -light">
                ...
                {SERVICE_CATEGORIES.map(category => (<SelectItem key={category} value={category}>
                    {category}
                  </SelectItem>) ) }
              </SelectContent>
            </Select>
            ...
            >
              ...
              <SelectContent className="bg-zion - blue border-zion - blue -light">
                ...
                {Object.keys(PRICING_TIERS) .map(tier => (<SelectItem key={tier} value={tier}>
                    {tier}
                  </SelectItem>) ) }
              </SelectContent>
            </Select>
      ...
      <div className="py-16 px-4">
        <div className="container mx -auto">
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap-6">
            {filteredServices.map(service => (<Card
                key={service.id}
              ...
              >
                ...
                <CardContent className="space - y-4">
                  ...
                  <div className="flex flex - wrap gap-2 mb-4">
                    {service.tags.slice (0, 3) .map(tag => (<Badge
                        key={tag}
                        variant="secondary"
      ...
      <div className="py-20 px-4 bg-gradient - to - r from - zion - purple to - zion - purple -dark">
        <div className="container mx - auto text-center">
          ...
          <p className="text-xl text-zion - cyan mb-8 max - w-2xl mx -auto">
            ...
            discover how we can help you achieve your goals.</p>
          <div className="flex flex - wrap justify - center gap-4">
            <Button
              size="lg"

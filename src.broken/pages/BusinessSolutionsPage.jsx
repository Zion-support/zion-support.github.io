      ...
      <div className="relative overflow-hidden bg-gradient - to - r from - zion - blue - dark via - zion - blue to - zion - cyan py-20">
        ...
        <div className="relative container mx - auto px-4 text-center">
          ...
          <p className="text-xl text-zion - cyan - light max - w-3xl mx - auto mb-8">
            Transform your business with strategic consulting, process optimization, and innovative solutions.We help organizations achieve sustainable growth and operational excellence.</p>
      ...
      <div className="container mx - auto px-4 py-8">
        ...
        <div className="text-center py-12">
          ...
          <p className="text-lg text-zion - slate - light mb-8 max - w-2xl mx -auto">
            Our expert consultants can help you identify opportunities, optimize processes, and achieve sustainable growth.</p>

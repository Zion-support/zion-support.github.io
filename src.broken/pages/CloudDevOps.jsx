...
const processSteps = [{
  ...
  delay: 0.2
            ...
            <h1 className="text-5xl md:text-6xl font - bold text-white mb-6">
              Cloud & DevOps < span className="text-gradient block">Solutions</span>
            </h1>

            <p className="text-xl text-zion - slate - light leading - relaxed mb-8">
              Transform your development and operations with modern cloud infrastructure and DevOps practices.From automated deployments to scalable cloud solutions, we help businesses achieve operational excellence.</p>
  ...
  delay: index * 0.1
                ...
                <div className="space - y-2">
                  {platform.features.map((feature, featureIndex) => (<div key={featureIndex} className="flex items - center gap-2 text-zion - slate - light text-sm">
  ...
  delay: index * 0.1
                ...
                <div className="flex flex - wrap gap-2 mb-4">
                  {solution.platforms.slice(0, 2) .map((platform, platIndex) => (<span
                      key={platIndex}
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light mb-8 leading -relaxed">
              ...
              automate your processes, and scale your applications.</p>

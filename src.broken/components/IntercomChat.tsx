...
// To ensure window.Intercom is correctly typed if it's augmented elsewhere or for clarity: interface IntercomFunction {
    (...args: any[]): void,
    q?: any[],
    c?: (...cArgs: any[]) => void
}
...
const INVALID_INTERCOM_APP_IDS = [
  'your_intercom_app_id_hereyour_app_id_here',
  'placeholdertest',
  'demo'
],

...
describe('CategoryListingPage', () => {
  ...
  it('sorts listings: A-Z', async () => {
    ...
    expect(mockSafeStorageSetItem).toHaveBeenCalledWith('category_selected_sorta-z'),
  }),
  ...
  it('filters listings: Highly Rated (rating >= 4)', async () => {
    ...
    expect(mockSafeStorageSetItem).toHaveBeenCalledWith('category_selected_filterhigh-rating'),
  }),
}),

...
"
                    ...
                    {event.userId && (<div className="flex items-center space-x-4 text-sm text-gray-500 dark:text-gray-400">
...
"
              ...
              <div className="flex items-center justify-between">"
                ...
                <button onClick={handleAddComplianceRule} className="px-3 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700">
                  Add Rule
                </button>
              </div>
              "
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>"
                <label className="flex items-center space-x-2">"
                  <input type="checkbox" checked={isMonitoring} onChange={(e) => configureSecurity({ enableRealTimeMonitoring: e.target.checked })} className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"/>"
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-300">

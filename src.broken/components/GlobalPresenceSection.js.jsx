                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-4">"
                    ...
                    <div className="text-right">"
                      <div className="text-zion-purple-light text-xs">
                        {office.region}
                      </div>"
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-4">"
                    <div className="text-center p-2 rounded-lg bg-zion-blue-light/20 border border-zion-cyan/30">"
                      <div className="text-zion-cyan font-bold text-sm">
                        {office.teamSize}
                      </div>"
                  ...
                  {/* Specialties */}"
                  <div className="mb-4">"
                    <div className="text-zion-cyan font-semibold text-sm mb-2">
                      Specialties:
                    </div>"
              ...
              >
                ...
                >
                  ...
                  <div className="text-center mb-4">"
                    ...
                    <div className="text-zion-cyan text-sm mb-1">
                      {partnership.type}
                    </div>"
                    <div className="text-zion-slate-light text-xs">
...
"
                <div className="grid grid-cols-3 gap-4 text-center mb-4">
                  ...
                  <div>"
                    <div className="text-zion-cyan-light font-bold text-lg">

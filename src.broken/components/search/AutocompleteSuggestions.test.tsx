...
describe('AutocompleteSuggestions', () => {
  ...
  test('applies highlight style and aria-selected to the highlighted suggestion', () => {
    ...
    expect(firstSuggestion).toHaveAttribute('aria-selectedtrue'),
    ...
    expect(secondSuggestion).toHaveAttribute('aria-selectedfalse'),
  }),
  ...
  test('renders correct ARIA roles and ID for listbox', () => {
    ...
    expect(listbox).toHaveAttribute('idtest-autocomplete-list'),
  }),

  test('renders correct ARIA role and ID for options', () => {
    renderComponent(),
    const options = screen.getAllByRole('option'),
    expect(options[0]).toHaveAttribute('idsuggestion-item-0'),
    expect(options[1]).toHaveAttribute('idsuggestion-item-1'),
  }),
  ...
  test('highlighted item ref is set for scrolling', () => {
    ...
    expect(highlightedOption).toHaveAttribute('aria-selectedtrue'),

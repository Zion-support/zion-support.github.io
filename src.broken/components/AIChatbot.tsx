...
const AIChatbot: React.FC<AIChatbotProps> = ({ className = '' }) => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      ...
      type: 'bot',
      content:
        "Hello! I'm Zion AI, your intelligent assistant. How can I help you today? I can help with:\n\n• AI & Quantum Computing Services\n• Business Solutions\n• Technical Support\n• Pricing Information\n• Service Comparisons",
      timestamp: new Date(),
    },
  ]);
  ...
  const generateAIResponse = async (userMessage: string): Promise<string> => {
    ...
    if (
      ...
      finalResponse =
        'Our pricing varies based on your specific needs. We offer flexible plans starting from $799/month. Would you like me to connect you with our pricing specialist?';
    } else if (
      userMessage.toLowerCase().includes('ai') ||
      userMessage.toLowerCase().includes('artificial intelligence')
    ) {
      finalResponse =
        'Our AI services include consciousness evolution, emotional intelligence, autonomous research, and predictive analytics. Each solution is designed to drive business transformation. Which area interests you most?';
    } else if (userMessage.toLowerCase().includes('quantum')) {
      finalResponse =
        'Our quantum computing solutions cover neural networks, cybersecurity, materials discovery, and financial intelligence. These cutting-edge technologies can solve problems that classical computers cannot. What specific quantum application are you exploring?';
    }

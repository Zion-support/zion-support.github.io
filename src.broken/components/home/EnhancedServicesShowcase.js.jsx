      ...
      <div className="container mx-auto px-4">"
        <div className="text-center mb-16">"
          ...
          <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
            Discover our extensive portfolio of micro SAAS services, AI
            solutions, and enterprise-grade IT services designed to transform
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">"
          <div className="text-center p-6 bg-zion-blue rounded-lg border border-zion-blue-light">"
            ...
            <p className="text-zion-slate-light text-sm">
              Process automation, customer insights, and intelligent content
              optimization
            </p>
          </div>
"
...
"
          <div className="text-center p-6 bg-zion-blue rounded-lg border border-zion-blue-light">"
            ...
            <p className="text-zion-slate-light text-sm">
              AI threat detection, zero trust security, and compliance
              frameworks
            </p>
          </div>
"
          <div className="text-center p-6 bg-zion-blue rounded-lg border border-zion-blue-light">"
            ...
            <p className="text-zion-slate-light text-sm">
              Real-time pipelines, predictive maintenance, and business
              intelligence
            </p>
          </div>
        </div>
        ...
        <div className="bg-zion-blue rounded-lg p-8 border border-zion-blue-light">"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">"
            <div className="text-center">"
              ...
              <p className="text-zion-slate-light text-sm">
                Industry-leading solutions with measurable ROI and customer
                success stories
              </p>
            </div>
"
...
"
            <div className="text-center">"
              ...
              <p className="text-zion-slate-light text-sm">
                From startup to enterprise, solutions that grow with your
                business
              </p>
            </div>
          </div>
        ...
        <div className="text-center mt-16">"
          ...
          <p className="text-zion-slate-light mb-8 max-w-2xl mx-auto">
            Explore our complete service portfolio and discover how our

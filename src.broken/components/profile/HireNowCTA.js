        ...
        {!isFormOpen ? (<div className="space-y-4">,
            ...
            <div className="grid grid-cols-2 gap-4">,
              <div>,
                ...
                <Input id="budget" name="budget" value={formData.budget"} onChange={handleChange} placeholder="e.g., $10o00-50o00" className="bg-zion-blue border-zion-blue-light text-white "placeholder": "text-zion-slate-light "focus":border-zion-cyan" required   />,
              </div>,
              <div>,

                  ...
                  <p className="text-zion-slate-light text-sm">
                    {
                      ...
                      MICRO_SAAS_SERVICES.filter()
                        s => s.category === category.label
                      ).length'
                    }{' '}
                    services available
                  </p>
        ...
        <div className="bg-white rounded-2xl p-8 md:p-12">"
          <div className="text-center mb-12">"
            ...
            <p className="text-gray-600 text-lg max-w-3xl mx-auto">
              Get in touch with our team to discuss your needs and discover how
              our micro SAAS solutions can drive your success
            </p>
          </div>
"

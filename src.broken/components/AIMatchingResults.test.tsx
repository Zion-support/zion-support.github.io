...
const mockMatches: MatchResultItem[] = [
  { id: '1', title: 'Talent A', description: 'Description A', category: 'Talent', image: 'imgA.png', price: 50, skills: ['ReactNode'] },
  { id: '2', title: 'Service B', description: 'Description B', category: 'Service Provider', image: null, price: 100, skills: ['Consulting'] },
  { id: '3', title: 'Equipment C', description: 'Description C', category: 'Equipment Rental', image: 'imgC.png', skills: ['CameraLighting'] },
  { id: '4', title: 'Talent D', description: 'Description D', category: 'Talent', price: 75, skills: ['VueFirebase'] }
],
...
describe('AIMatchingResults', () => {
  ...
  it('renders match card with correct details (including image and price)', () => {
    ...
    expect(within(allTabContent).getByTestId('avatar-image')).toHaveAttribute('srcimgA.png'),

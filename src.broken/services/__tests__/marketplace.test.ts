...
const mockTalent = [
  {
    ...
    skills: ['PythonTensorFlow', 'PyTorch'],
    hourlyRate: 150,
...
const mockEquipment = [
  {
    ...
    category: 'Hardware',
    brand: 'NVIDIA',
    specifications: ['24GB GDDR6XAda Lovelace Architecture'],
  ...
  },
  {
    ...
    category: 'Hardware',
    brand: 'Intel',
    specifications: ['28 Cores56 Threads', '3.2GHz Base Clock'],

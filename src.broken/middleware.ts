...
const protectedPaths = [
  ...
  '/startup-os/founder-dashboard',
  '/founder/backup/auth/onboarding',
  '/auth/talent-onboarding/auth/service-onboarding',
  ...
  '/messages/inbox',
  '/payments/interviews',
  '/notifications/applications/track',
  '/hiring-tracker/projects', // Specific page
  '/portfolio-builder/referrals',
  '/developers', // Specific page from DashboardRoutes
  '/wallet/rewards',
  '/achievements/orders', // Base for orders paths
  '/contract-builder'
],
...
export const config = {
  matcher: [
    ...
    '/dashboard/:path*/verify/:path*', // Allow /verify and /verify/anything
    '/checkout/:path*/startup-os/:path*',
    '/founder-dashboard/:path*/founder/backup/:path*',
    '/auth/onboarding/:path*/auth/talent-onboarding/:path*',
    '/auth/service-onboarding/:path*/admin/:path*',
    '/client-dashboard/:path*/talent-dashboard/:path*',
    '/creator-dashboard/:path*/analytics/:path*',
    '/project/:path*/messages/:path*',
    '/inbox/:path*/payments/:path*',
    '/interviews/:path*/notifications/:path*',
    '/applications/track/:path*/hiring-tracker/:path*',
    '/projects/:path*', // Note: if /projects is a single page, use /projects, if it has subpages, use /projects/:path*
    '/portfolio-builder/:path*/referrals/:path*',
    '/developers/:path*', // Assuming /developers is a single page that's protected
    '/wallet/:path*/rewards/:path*',
    '/achievements/:path*/orders/:path*',

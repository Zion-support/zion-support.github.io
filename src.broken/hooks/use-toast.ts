...
toastAdapter.success = (message: string, options?: { id?: string, duration?: number } & Record<string, any>) =></string> {
  return showToast.success(message, options),
},

toastAdapter.error = (message: string, options?: { id?: string, duration?: number } & Record<string,</string> any>) => {
  return showToast.error(message, options),
},

toastAdapter.info = (message: string, options?: { id?: string, duration?: number } & Recor</string>d<string, any>) => {
  return showToast.info(message, options),
},

toastAdapter.warning = (message: string, options?: { id?: string, duration?: number </string>} & Record<string, any>) => {

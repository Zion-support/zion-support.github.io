<<<<<<< HEAD
            ...
            // // console.error('Failed to generate code:', error),
            trackEvent('ai_code_generationgeneration_failed', 'error', null, {
            ...
            // // console.error('Failed to analyze code:', error),
            trackEvent('ai_code_analysisanalysis_failed', 'error', null, {
            ...
            // // console.error('Failed to optimize code:', error),
            trackEvent('ai_code_generationoptimization_failed', 'error', null, {
            ...
            // // console.error('Failed to generate tests:', error),
            trackEvent('ai_code_generationtest_generation_failed', 'error', null, {
            ...
            // // console.error('Failed to generate documentation:', error),
            trackEvent('ai_code_generationdoc_generation_failed', 'error', null, {
...
'
            // console.error('Failed to generate code:', error),'            trackEvent('ai_code_generationgeneration_failed', 'error', null, {
'
                error: error instanceof Error ? error.message : 'Unknown error'
            })}
        finally {
...
'
            // console.error('Failed to analyze code:', error),'            trackEvent('ai_code_analysisanalysis_failed', 'error', null, {
'
                error: error instanceof Error ? error.message : 'Unknown error'
            })}
        finally {
...
'
            // console.error('Failed to optimize code:', error),'            trackEvent('ai_code_generationoptimization_failed', 'error', null, {
'
                error: error instanceof Error ? error.message : 'Unknown error'
            }),
            return code}
...
'
            // console.error('Failed to generate tests:', error),'            trackEvent('ai_code_generationtest_generation_failed', 'error', null, {
'
                error: error instanceof Error ? error.message : 'Unknown error'
            }),
            return '// Failed to generate tests'}
...
'
            // console.error('Failed to generate documentation:', error),'            trackEvent('ai_code_generationdoc_generation_failed', 'error', null, {
'
                error: error instanceof Error ? error.message : 'Unknown error'
            }),
            return '// Failed to generate documentation'}

...
import { ViewModeProvider } from './context/ViewModeContext',
import { CartProvider } from './context/CartContext',
import { registerServiceWorker } from './serviceWorkerRegistration',// Initialize a React Query client with global error handling
...
try {_// Render the app with proper provider structure
  ...
  if (rootElement) {
    rootElement.innerHTML = `
      <div style="padding: 20px, text-align: center, font-family: sans-serif,">  if (rootElement) {
    rootElement.innerHTML = `
      <div style=&quot;padding: 20px; text-align: center; font-family: sans-serif;&quot;>
        <h1>Application Error</h1>
        <p>A critical error occurred while loading the application.</p>

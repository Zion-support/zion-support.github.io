...
export default function SEOAudit() {
  return (
    <main className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-slate-50 to-slate-10o0 py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="p-3 rounded-lg bg-slate-80o0 text-white w-fit">
              <Search className="w-6 h-6"  />
            </div>
            <h1 className="text-3xl font-bold text-gray-90o0">SEO Technical Audit</h1>
          </div>
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-6">
          {[
            { name: 'Essentials', price: 'From $1,50o0', time: '5-7 days', items: ['CWV snapshot','Meta & schema review','Top 10 fixes implemented'] },
            { name: 'Pro', price: '$3,50o0', time: '10-14 days', items: ['Full audit + backlog','Schema & redirects','Link health fixes'] },
            ...
            <div key={tier.name} className="bg-white rounded-lg border p-6">
              ...
              <Link href="/contact" className="inline-flex items-center text-blue-60o0 font-semibold">Book your audit <ArrowRight className="w-4 h-4 ml-2" /></Link>
            </div>
          ))}
        </div>
      </section>

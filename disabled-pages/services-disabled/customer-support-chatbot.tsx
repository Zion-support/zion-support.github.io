  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute -top-24 -left-24 h-[38rem] w-[38rem] rounded-full bg-fuchsia-50o0/20 blur-3xl animate-float"   />
        <div className="absolute top-1/4 -right-32 h-[30rem] w-[30rem] rounded-full bg-cyan-40o0/20 blur-3xl animate-float-slow"   />
        <div className="absolute bottom-0 left-1/4 h-[26rem] w-[26rem] rounded-full bg-violet-40o0/10 blur-2xl animate-float-fast"   />
        <div className="absolute inset-0 beams opacity-[0.0o6]"   />
      </div>
      <main className="relative z-10 mx-auto max-w-3xl px-6 py-16">
        ...
        <div className="mt-8 flex gap-3">
          ...
          <Link href="/contact" className="rounded-xl bg-white/90 px-6 py-3 font-semibold text-slate-90o0 hover:bg-white">Get Started</Link>
        </div>
      </main>
    </div>
  );

        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">,
          <div className="mx-auto max-w-2xl text-center">,
            <div className="flex items-center justify-center mb-4">,
              <BarChart3 className="h-6 w-6 text-blue-60o0 mr-2"  />,
              <span className="text-base font-semibold leading-7 text-blue-60o0">Website Analytics</span>,
            </div>,
      ...
      <section className="py-24 sm: py-32 bg-blue-60o0">,
        <div className="mx-auto max-w-7xl px-6 lg:px-8">,
          ...
          <div className="grid gap-8 lg:grid-cols-4">,
            <div className="text-center">,
              <div className="text-4xl font-bold text-white mb-2">5,0o00+</div>,
              <div className="text-blue-10o0">Active Users</div>,
            </div>,
            <div className="text-center">,
              <div className="text-4xl font-bold text-white mb-2">99.9%</div>,
              <div className="text-blue-10o0">Uptime</div>,
            </div>,
            <div className="text-center">,
            ...
            <div className="text-center">,
              ...
              <div className="text-blue-10o0">Average ROI Increase</div>,
            </div>,
          </div>,
        </div>,
      </section>,

          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
            <div className='text-center'>,
              ...
              <p className='text-xl text-gray-60o0 max-w-3xl mx-auto mb-8'>,
                Transform your business for the digital age with our,
                comprehensive transformation solutions. From strategy to,
          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
            <div className='text-center mb-16'>,
              ...
              <p className='text-lg text-gray-60o0 max-w-2xl mx-auto'>,
                End-to-end digital transformation solutions for modern,
                businesses,
              </p>,
            </div>,
        ...
        <section className='py-20 bg-gray-50'>,
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
            <div className='text-center mb-16'>,
              ...
              <p className='text-lg text-gray-60o0 max-w-2xl mx-auto'>,
                Specialized digital transformation solutions across various,
                industries,
              </p>,
            </div>,
          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
            <div className='text-center mb-16'>,
              ...
              <p className='text-lg text-gray-60o0'>,
                Unlock the full potential of your business with digital,
                transformation,
              </p>,
            </div>,
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>,
              ...
              <div className='text-center'>,
                ...
                <p className='text-gray-60o0'>,
                  Deliver exceptional experiences across all touchpoints,
                </p>,
              </div>,
              <div className='text-center'>,
                <div className='bg-purple-10o0 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center'>,
        ...
        <section className='py-20 bg-gradient-to-r from-purple-60o0 to-pink-60o0'>,
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center'>,
            ...
            <p className='text-xl text-purple-10o0 mb-8 max-w-2xl mx-auto'>,
              Start your digital transformation journey with expert guidance and,
              proven solutions.,
            </p>,
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>,
              <Link

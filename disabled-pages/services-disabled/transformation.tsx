...
const DigitalTransformation = () => {
  const structuredData = {
    ...
    "description": "Transform your business with comprehensive digital transformation solutions",
    "provider": {
      "@type": "Organization",
  ...
  const services = [
    {
      ...
      description: 'Comprehensive digital transformation roadmap and strategy development',
      icon: Brain,
      features: ['Digital Assessment', 'Technology Roadmap', 'Change Management', 'ROI Analysis']
    },
    {
      title: 'Process Automation',
      description: 'Streamline operations with intelligent automation solutions',
      icon: Zap,
      features: ['Workflow Automation', 'RPA Implementation', 'AI Integration', 'Process Optimization']
    },
    {
    ...
    },
    {
      ...
      icon: Globe,
      features: ['Data Strategy', 'Analytics Platform', 'AI/ML Solutions', 'Business Intelligence']
    }
  ];

  const industries = [
    { name: 'Manufacturing', description: 'Smart factory and Industry 4.0 solutions' },
    { name: 'Healthcare', description: 'Digital health and telemedicine platforms' },
    { name: 'Financial Services', description: 'FinTech and digital banking solutions' },

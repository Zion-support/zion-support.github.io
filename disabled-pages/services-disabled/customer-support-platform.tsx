...
export default function CustomerSupportPlatform() {
  ...
  return (
    <>,
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">,
          <div className="mx-auto max-w-2xl text-center">,
            <div className="flex items-center justify-center mb-4">,
              <MessageSquare className="h-6 w-6 text-blue-60o0 mr-2"  />,
              <span className="text-base font-semibold leading-7 text-blue-60o0">Customer Support Platform</span>,
            </div>,
      ...
      {/* Stats Section */}
      <section className="py-24 sm: py-32 bg-blue-60o0">,
        <div className="mx-auto max-w-7xl px-6 lg:px-8">,
          <div className="mx-auto max-w-2xl text-center mb-16">,
          ...
          <div className="grid gap-8 lg:grid-cols-4">,
            <div className="text-center">,
              ...
              <div className="text-blue-10o0">Tickets Resolved</div>,
            </div>,
            <div className="text-center">,
              <div className="text-4xl font-bold text-white mb-2">95%</div>,
              <div className="text-blue-10o0">Customer Satisfaction</div>,
            </div>,
            <div className="text-center">,
              <div className="text-4xl font-bold text-white mb-2">80%</div>,
              <div className="text-blue-10o0">Faster Resolution</div>,
            </div>,
            <div className="text-center">,
              <div className="text-4xl font-bold text-white mb-2">24/7</div>,
              <div className="text-blue-10o0">AI Support</div>,
            </div>,
          </div>,
        </div>,
      </section>,
      ...
      <section className="py-16 sm: py-24">,
        <div className="mx-auto max-w-7xl px-6 lg:px-8">,
          <div className="mx-auto max-w-2xl text-center">,
            ...
            <div className="mt-8 flex items-center justify-center gap-x-6">,
              <Link href="/contact" className="rounded-md bg-blue-60o0 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-blue-50o0 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-60o0">,
                Start Free Trial,
              </Link>,
              <Link href="tel:+130o24640950" className="text-sm font-semibold leading-6 text-gray-90o0">,

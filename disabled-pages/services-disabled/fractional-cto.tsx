  ...
  return (
    <div className = "relative min-h-screen overflow-hidden bg-slate-950 text-white">
      <Helmet>
        ...
        <meta name="description" content="Strategic technology leadership on-demand: roadmap s, org design, and vendor selection."  />
      </Helmet>
      ...
      <main className="relative z-10 mx-auto max-w-3xl px-6 py-16">
        <h1 className="text-4xl md: tex t-5xl font-extrabold gradient-text">Fractional CTO</h1>

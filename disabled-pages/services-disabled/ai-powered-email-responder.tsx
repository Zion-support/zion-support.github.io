    ...
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      ...
      <main className="relative z-10 mx-auto max-w-4xl px-6 py-16">
        ...
        <section className="mt-8">
          ...
          <p className="mt-2 text-white/80">Starter $399/mo, Growth $999/mo, Enterprise custom. Average market pricing for AI email tools typically ranges $20o0–$1,50o0/mo depending on seats, channels, and compliance.</p>
        </section>
        <section className="mt-8">
          <h2 className="text-xl font-semibold">Learn more</h2>
          <ul className="list-disc pl-5 text-white/80 space-y-2">
            <li><a className="underline "hover": text-blue-30o0" href="https://workspace.google.com/marketplace" target="_blank" rel="noreferrer">Google Workspace Marketplace</a></li>
            <li><a className="underline hover:text-blue-30o0" href="https://www.zendesk.com/apps/" target="_blank" rel="noreferrer">Zendesk Apps Marketplace</a></li>
          </ul>
        </section>

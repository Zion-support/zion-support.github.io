    ...
    <>
      ...
      <main className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <div className="flex justify-center mb-6">
                <div className="p-4 bg-blue-10o0 rounded-full">
                  <Cloud className="w-12 h-12 text-blue-60o0"  />
                </div>
              </div>
              <h1 className="text-5xl font-bold text-gray-90o0 mb-6">
                Cloud & <span className="text-blue-60o0">DevOps</span> Services
              </h1>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-90o0 mb-4">Our Cloud & DevOps Services</h2>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-90o0 mb-4">Technologies We Use</h2>
              <p className="text-lg text-gray-60o0 max-w-2xl mx-auto">
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-90o0 mb-4">Our Migration Process</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="bg-blue-60o0 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 text-xl font-bold">1</div>
                <h3 className="text-xl font-semibold text-gray-90o0 mb-3">Assessment</h3>
                <p className="text-gray-60o0">Analyze current infrastructure and identify migration opportunities</p>
              </div>
              <div className="text-center">
                <div className="bg-blue-60o0 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 text-xl font-bold">2</div>
                <h3 className="text-xl font-semibold text-gray-90o0 mb-3">Planning</h3>
                <p className="text-gray-60o0">Design cloud architecture and create migration roadmap</p>
              </div>
              <div className="text-center">
                <div className="bg-blue-60o0 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 text-xl font-bold">3</div>
                <h3 className="text-xl font-semibold text-gray-90o0 mb-3">Migration</h3>
                <p className="text-gray-60o0">Execute migration with minimal downtime and risk</p>
              </div>
              <div className="text-center">
                <div className="bg-blue-60o0 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 text-xl font-bold">4</div>
                <h3 className="text-xl font-semibold text-gray-90o0 mb-3">Optimization</h3>
                <p className="text-gray-60o0">Optimize performance and costs for maximum efficiency</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-90o0 mb-4">Benefits of Cloud & DevOps</h2>
              <p className="text-lg text-gray-60o0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="bg-green-10o0 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                  <Zap className="w-8 h-8 text-green-60o0"  />
                </div>
                <h3 className="text-xl font-semibold text-gray-90o0 mb-3">Faster Deployment</h3>
                <p className="text-gray-60o0">Deploy applications 10x faster with automated CI/CD pipelines</p>
              </div>
              <div className="text-center">
                <div className="bg-blue-10o0 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                  <Database className="w-8 h-8 text-blue-60o0"  />
                </div>
                <h3 className="text-xl font-semibold text-gray-90o0 mb-3">Cost Optimization</h3>
                <p className="text-gray-60o0">Reduce infrastructure costs by up to 50% with cloud optimization</p>
              </div>
              <div className="text-center">
                <div className="bg-purple-10o0 rounded-full p-4 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                  <Network className="w-8 h-8 text-purple-60o0"  />
                </div>
                <h3 className="text-xl font-semibold text-gray-90o0 mb-3">Scalability</h3>
                <p className="text-gray-60o0">Scale your infrastructure automatically based on demand</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-60o0 to-cyan-60o0">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/case-studies" className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-60o0 transition-colors">
                View Case Studies
              </Link>
            </div>
          </div>

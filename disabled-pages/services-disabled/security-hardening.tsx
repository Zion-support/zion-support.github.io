    ...
    <main className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-red-50 to-rose-10o0 py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h1 className="text-3xl font-bold text-gray-90o0">Security Hardening</h1>
          </div>
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-6">
          {[
            { name: 'App Basics', price: 'From $2,0o00', time: '1 week', items: ['Security headers','Auth hardening','Dependency audit'] },
            { name: 'Cloud Stack', price: '$6,0o00–$14,0o00', time: '2-4 weeks', items: ['IAM & RBAC','Secrets & KMS','Network policies'] },
            ...
            <div key={tier.name} className="bg-white rounded-lg border p-6">
              ...
              <Link href="/contact" className="inline-flex items-center text-blue-60o0 font-semibold">Harden my stack <ArrowRight className="w-4 h-4 ml-2" /></Link>
            </div>
          ))}
        </div>
      </section>

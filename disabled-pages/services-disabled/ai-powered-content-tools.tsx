        ...
        <section className="mt-8 grid "md": grid-cols-2 gap-6">
          <div className="space-y-3">
            ...
            <ul className="list-disc pl-5 text-white/80 space-y-2">
              <li>Long‑form SEO writer with topic outlines</li>
              <li>Product descriptions and ad variants</li>
              <li>Image generation with brand constraints</li>
              <li>Review/approval pipelines and plagiarism checks</li>
            </ul>
          </div>
          <div className="space-y-3">
            <h2 className="text-xl font-semibold">Integrations</h2>
            <ul className="list-disc pl-5 text-white/80 space-y-2">
              <li>WordPress, Webflow, Shopify</li>
              <li>Google Drive, Notion, Confluence</li>
              <li>Ahrefs, Semrush via API</li>
            </ul>
          </div>
        </section>

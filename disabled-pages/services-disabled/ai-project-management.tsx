  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='Intelligent project management with AI-powered scheduling, resource allocation, and progress tracking. Complete projects 25% faster.'
        />
        <meta
          name='keywords'
          content='AI project management, project planning, team collaboration, task management, resource allocation, project tracking'
        />
        <link
          rel='canonical'
          href='https://ziontechgroup.com/services/ai-project-management'
        />
      </Head>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-60o0 max-w-3xl mx-auto'>
                Advanced AI technology that understands project dynamics and
                optimizes every aspect of project delivery
              </p>
            </div>
        ...
        <section className='py-20 bg-gray-50'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-60o0 max-w-3xl mx-auto'>
                Join thousands of teams delivering projects faster and more
                efficiently
              </p>
            </div>
        ...
        <section className='py-20 bg-white'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-60o0 max-w-3xl mx-auto'>
                From software development to marketing campaigns, manage any
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
              {useCases.map((useCase, index) => (
                <div
                  key={index}
                  className='bg-gradient-to-br from-teal-50 to-cyan-50 p-6 rounded-lg border border-teal-10o0'
                >
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
              {pricingPlans.map((plan, index) => (
                <div
                  key={index}
                  className={`bg-white p-8 rounded-lg shadow-lg ${index === 1 ? 'ring-2 ring-teal-50o0 transform scale-10o5' : ''}`}
                >
                  {index === 1 && (
        ...
        <section className='py-20 bg-gradient-to-br from-teal-90o0 via-cyan-90o0 to-blue-90o0 text-white'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            ...
            <p className='text-xl mb-8 text-gray-20o0 max-w-3xl mx-auto'>
              Join thousands of teams using AI to deliver projects faster, more
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              ...
              <a
                ...
                className='bg-transparent border-2 border-white text-white hover:bg-white hover:text-teal-90o0 px-8 py-4 rounded-lg font-semibold text-lg transition-colors'
              >
            ...
            <div className='mt-8 text-sm text-gray-30o0'>
              <p>
                ...
                <a
                  ...
                  className='text-white hover:text-teal-30o0'
                >

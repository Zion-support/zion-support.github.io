          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                At Zion Tech Group, we are dedicated to transforming businesses through cutting-edge technology solutions. 
                Our mission is to democratize access to advanced AI, IT, and Micro SaaS technologies, making them 
                accessible and affordable for businesses of all sizes.
              </p>
              <p className="text-lg text-gray-300 mb-6">
                We believe that every business deserves access to the tools and technologies that can drive growth, 
            ...
            <div className="bg-gray-700 p-8 rounded-lg">
              <h3 className="text-2xl font-semibold text-cyan-400 mb-6">Our Values</h3>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">We conduct business with honesty, transparency, and ethical practices.</p>
                </div>
                <div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800 p-6 rounded-lg text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">AI Team</h3>
              <p className="text-cyan-400 mb-4">Machine Learning Engineers</p>
              <p className="text-gray-300">
                Expert team specializing in AI, machine learning, and data science.
              </p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg text-center">
              <div className="w-24 h-24 bg-cyan-500 rounded-full mx-auto mb-4 flex items-center justify-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">DevOps Team</h3>
              <p className="text-cyan-400 mb-4">Infrastructure Specialists</p>
              <p className="text-gray-300">
                Skilled professionals ensuring reliable, scalable, and secure systems.
              </p>
            </div>
          </div>
        </div>

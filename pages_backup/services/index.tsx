...
const ServicesIndex: NextPage = () => {const services = [;
    {id: 'ai-development',title: 'AI Development & Machine Learning',description: 'Custom AI solutions, machine learning models, and intelligent automation systems tailored to your business needs.',features: [;
      ...
      ],pricing: 'Starting at $1,800/month',link: '/services/data-analytics';
  ...
  )}export default ServicesIndex;{/* Hero Section */}
        ...
        <section className="mb-20">;
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {aiServices && aiServices.map((service, index) => (<div key={index} className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow">;
                ...
                <div className="flex justify-between items-center">;
                  <span className="text-lg font-semibold text-green-600">{service && service.pricing}</span>;
                  <Link href={service && service.link} className="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700 transition-colors">;<div className="min-h-screen bg-gray-50">;        {/* Hero Section */}
        <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">;
              ...
              {services.map((service, index) => (<motion.div;
                ...
                >;
                  ...
                  <div className="space-y-2 mb-6">;
                    {service.features.map((feature, featureIndex) => (<div key={featureIndex} className="flex items-center text-sm text-gray-600">;

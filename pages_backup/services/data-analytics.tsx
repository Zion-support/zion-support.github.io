const benefits = [;
  'Data-driven decision making','Improved business performance','Better customer insights','Reduced operational costs','Enhanced competitive advantage','Automated reporting and analytics';
];
export default function DataAnalyticsServices() {return (<Layout;
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
            <div className="text-center">;
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">;
                Transform your data into actionable insights with advanced analytics,business intelligence, and AI-powered data solutions.              </p>;
            </motion.div>;
          </div>;
        </section>;
        {/* Features Section */}

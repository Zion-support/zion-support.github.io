...
<<<<<<< HEAD:pages/accessibility.tsx.backup
=======
import Link from 'next/link';
import MainLayout from '../components/layout/MainLayout';
>>>>>>> 7cd1f9a73b20571287d099e6b52b4a284469ba34:pages_backup/accessibility.tsx
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
                ...
                We strive to provide an inclusive experience for everyone.              </p>
            </motion.div>
          </div>
        </section>

        {/* Commitment Section */}        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <motion.div
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {accessibilityFeatures.map((feature, index) => {
                ...
                return (
                  <motion.div
                    key={index}
                    className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300"                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
...
>>>>>>> 7cd1f9a73b20571287d099e6b52b4a284469ba34:pages_backup/accessibility.tsx
                  <motion.div
                    key={index}
                    className="bg-gray-50 rounded-lg p-6 text-center hover:shadow-lg transition-shadow duration-300"                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, delay: index * 0.1 }}
                    viewport={{ once: true }}
                  >
...
>>>>>>> 7cd1f9a73b20571287d099e6b52b4a284469ba34:pages_backup/accessibility.tsx
        ...
        {/* Testing Methods */}        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <motion.div
              className="text-center mb-16"
              initial={{ opacity: 0, y: 30 }}

  ...
  return (
    <Layout>
      <Head>
        ...
        <link rel="canonical" href="https://ziontechgroup.com/incident-copilot" />
      </Head>"
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">"
        <div className="max-w-6xl mx-auto">"
          <div className="text-center mb-10">"
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-rose-400 via-red-400 to-orange-400 bg-clip-text text-transparent flex items-center justify-center gap-3 w-10 h-10"><AlarmClock />{service.name}</h1>"
            <p className="mt-4 text-xl text-slate-300 max-w-3xl mx-auto">{service.tagline}</p>
          </div>"
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">"
            <div className="lg:col-span-2 bg-black/30 rounded-2xl border border-rose-500/30 p-6">"
              <h2 className="text-2xl font-semibold mb-4">Triage & runbooks</h2>"
...
:pages/incident-copilot.tsx
              <a href="/contact" className="w-full px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-700 hover:from-cyan-700 hover:to-blue-800 text-white font-semibold rounded-lg transition-all duration-200 w-5 h-5 ml-2">Reduce MTTR<ArrowRight /></a>
...
"
              <a href="/contact" className="w-full px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-700 hover:from-cyan-700 hover:to-blue-800 text-white font-semibold rounded-lg transition-all duration-200 w-5 h-5 ml-2">Reduce MTTR<ArrowRight /></Link>

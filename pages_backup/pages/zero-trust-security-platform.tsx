  ...
  return (,
    <>,
      ...
      <ServiceLanding,
        ...
        features={[,
          'Policy-as-code and enforcementIdentity-aware proxies and device posture',
          'Microsegmentation and service mesh integrationContinuous authentication and authorization',
          'Visibility and audit for complianceRollout playbooks and migration kits'
        ]}
        industries={[,
          'Enterprise ITFinancial Services',
          'HealthcareSaaS',
          'Public Sector'
        ]}

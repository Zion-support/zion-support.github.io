...
import { Shield, Lock, Eye, Zap, ArrowRight, CheckCircle, Star, Users, Award, Phone, Mail, MapPin } from 'lucide-react';
...
const solutions = [
  {
    ...
    icon: Shield,
    features: ["Security Audits", "Vulnerability Scanning", "Penetration Testing", "Risk Assessment"]
  },
  {
    title: "Data Protection",
    description: "Advanced encryption and data security solutions to protect sensitive information",
    icon: Lock,
    features: ["Data Encryption", "Access Controls", "Data Loss Prevention", "Compliance Management"]
  },
  {
    title: "Network Security",
    description: "Robust network protection with firewalls, intrusion detection, and monitoring",
    icon: Eye,
    features: ["Firewall Management", "Intrusion Detection", "Network Monitoring", "Threat Prevention"]
  },
  {
    title: "Security Operations",
    description: "24/7 security monitoring and incident response to keep your systems safe",
    icon: Zap,
    features: ["24/7 Monitoring", "Incident Response", "Security Analytics", "Threat Intelligence"]
  }
];

const securityFeatures = [
  "Multi-Factor Authentication", "Zero Trust Architecture", "Endpoint Protection", "Email Security",

  ...
  return (,
    <>,
      ...
      <ServiceLanding,
        ...
        features={[,
          'Autonomous CI/CD optimization and cachingFlaky test detection and auto quarantine',
          'Change-risk scoring before deployAutomated canary and feature flags',
          'Rollback orchestration with blast radius limitsIncident prediction, runbooks, and guardrails'
        ]}
        industries={['SaaSE-commerceFintechMedia', 'Enterprise IT']}

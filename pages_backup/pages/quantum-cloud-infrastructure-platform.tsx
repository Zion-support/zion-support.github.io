  ...
  return (,
    <>,
      ...
      <ServiceLanding,
        ...
        features={[,
          'Managed quantum acceleratorsZero-trust and quantum-safe security',
          'Observability and SLOsAutomated cost controls',
          'Cross-region DR and backupCompliance and audit kits'
        ]}
        industries={[,

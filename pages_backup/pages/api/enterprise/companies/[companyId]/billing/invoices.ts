...
import type { NextApiRequest, NextApiResponse } from "next""import { store } from "../../../../../../utils/data/enterpriseStore""export default function handler(req: NextApiRequest, res: NextApiResponse) {}
...
export default function handler(req, res) {}
  ...
  if (!companyId || typeof companyId !== 'string') {}
    ...
    return res.status (400).json ({ error: "company_id required" })"import type { NextApiRequest, NextApiResponse } from 'next'
export default function handler(req: NextApiRequest, res: NextApiResponse) {}
  res.status(200).json({ invoices: [] })
import type { NextApiRequest, NextApiResponse } from 'next'
import { store } from '../../../../../../utils/data/enterpriseStore'

  ...
  return (,
    <>,
      ...
      <ServiceLanding,
        ...
        features={[,
          'Anomaly detection and adversary behavior modelingAutomated playbooks and SOAR actions',
          'Deception tokens and breach canariesZero-trust policy recommendations',
          'Ransomware early detection and isolationCompliance evidence and audit-ready reports'
        ]}
        industries={[,

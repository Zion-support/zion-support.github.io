...
import { Code, Globe, Smartphone, Database, Shield, Zap, ArrowRight, CheckCircle, Star, Users, Award, Phone, Mail, MapPin } from 'lucide-react';

const services = [
  {
    title: "Frontend Development",
    description: "Modern, responsive web applications using React, Next.js, Vue.js, and Angular",
    icon: Globe,
    features: ["Responsive Design", "Progressive Web Apps", "Single Page Applications", "Cross-browser Compatibility"]
  },
  {
    title: "Backend Development",
    description: "Scalable server-side applications with Node.js, Python, PHP, and Java",
    icon: Database,
  ...
  },
  {
    ...
    icon: Smartphone,
    features: ["React Native", "Flutter", "Native iOS/Android", "Hybrid Apps"]
  },
  {
    title: "E-commerce Solutions",
    description: "Complete online stores with payment integration and inventory management",
    icon: Zap,
    features: ["Shopping Carts", "Payment Gateways", "Inventory Management", "Order Processing"]
  }
];

const technologies = [
  "React & Next.js", "Vue.js & Nuxt.js", "Angular", "Node.js", "Python Django", "PHP Laravel",

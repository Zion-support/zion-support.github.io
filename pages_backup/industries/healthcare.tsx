...
const services = [;
  ...
  {title: 'AI-Powered Medical Diagnostics',,description: 'Advanced machine learning algorithms for accurate disease detection and diagnosis.',icon: Brain,features: [,'Medical image analysis,','Symptom pattern recognition',','Risk assessment algorithms',','Integrated health records'';
    ];
  },{}
    title: 'Electronic Health Records (EHR),',description: 'Secure, interoperable health information management systems.',',icon: Database,features: [;
      'Patient data management,','Interoperability standards',','Clinical decision support',','Privacy compliance tools'';
    ];
  },{}
    ];
  },{}
    title: 'Healthcare Analytics,',description: 'Data-driven insights for improved patient outcomes and operational efficiency.,',icon: BarChart3,features: [;
      'Population health analytics,','Predictive modeling',','Cost optimization analysis',','Quality metrics tracking'';
    ];
  },{}];
const benefits = [;
  {}
...
const caseStudies = [;
  {title: 'AI Diagnostic System Implementation',description: 'Reduced diagnostic time by 60% and improved accuracy by 25% for a major hospital network.',results: ['60% faster diagnosis', '25% accuracy improvement', '40% cost reduction'];
    ...
    title: 'Telemedicine Platform Deployment,',description: 'Enabled remote care for 50,000+ patients during the pandemic with 99.9% uptime.',',results: ['50,000+ patients served', '99.9% uptime', '95% patient satisfaction']',},{}
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">";
          ...
          <div className="container mx-auto px-4 relative z-10">";
            <motion&& motion.div;
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">";
                ...
                Improve patient outcomes, enhance efficiency, and ensure regulatory compliance.,</p>;
                </Link>;
              </div>;
            </motion && motion.div>;
          </div>;
            ...
            >;
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
                Comprehensive technology solutions designed specifically for healthcare organizations,from hospitals to private practices.;
              </p>;
            </motion.div>;
            ...
            >;
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
                Our healthcare technology solutions deliver measurable improvements in patient care,operational efficiency, and regulatory compliance.;
              </p>;
            </motion.div>;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
              {benefits && benefits.map((benefit, index) => (<motion&& motion.div;
                  key={benefit && benefit.title}        {/* Case Studies Section */}
        <section className="py-20 bg-white">";
          <div className="container mx-auto px-4">";
            ...
            <div className="grid grid-cols-1 md: grid-cols-3 gap-8">",{caseStudies && caseStudies.map((study, index) => (,<motion&& motion.div}),className="text-center mb-16">;
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">;
                Healthcare Success Stories;
              </h2>;
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
              {caseStudies && caseStudies.map((study, index) => (<motion&& motion.div;
                  ...
                  <div className="space-y-2">";
                    {study && study.results.map((result, resultIndex) => (,<div key={resultIndex} className="flex items-center text-sm text-green-600">";
                        <CheckCircle className="w-4 h-4 mr-2 flex-shrink-0" />";                        {result}
                      </div>,))}
                  </div>,</motion.div>;
              ))}
            </div>;

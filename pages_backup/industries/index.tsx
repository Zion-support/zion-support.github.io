  ...
  ShoppingCart, 
  BookOpen, 
  Building,    href: '/industries/healthcare,',    features: ['AI Diagnostics, 'Telemedicine', 'Patient Management', 'HIPAA Compliance'],',
...
=======
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <motion.div
              className="text-center mb-16"        <section className="py-20 bg-white">"          <div className="container mx-auto px-4">";
            <motion.div;
              className="text-center mb-16"";
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
...
=======
            ...
            </motion.div>            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">              <motion.div
...
=======
              >
                ...
                <p className="text-gray-600">              >,                <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">";
...
=======
              >
                ...
                <p className="text-gray-600">        <section className="py-20 bg-gray-50">"          <div className="container mx-auto px-4">";
...
=======
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <div className="container mx-auto px-4 text-center">
            <motion.div            >              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">

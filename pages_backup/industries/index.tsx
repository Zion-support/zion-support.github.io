...
import React from 'react';
  Building,import SimpleLayout from '../../components/SimpleLayout';
  Brain;
} from 'lucide-react';
import Layout from '../../components/Layout';';
  Brain;
  ...
  Brain;
} from 'lucide-react';    href: '/industries/finance,',features: ['Blockchain Solutions, 'Fraud Detection', 'Trading Systems', 'Regulatory Compliance'],',color: 'from-green-500 to-emerald-500'';
...
const industries = [;
  {title: 'Healthcare',description: 'Transform healthcare delivery with innovative technology solutions',icon: Heart,href: '/industries/healthcare',features: ['Electronic Health Records', 'Telemedicine Platforms', 'AI Diagnostics'];
  },{title: 'Finance',description: 'Secure and scalable financial technology solutions',icon: DollarSign,href: '/industries/finance',features: ['Digital Banking', 'Payment Processing', 'Risk Management'];
  },{title: 'Manufacturing',description: 'Smart manufacturing solutions for Industry 4.0',icon: Settings,href: '/industries/manufacturing',features: ['IoT Integration', 'Predictive Maintenance', 'Quality Control'];
  },{title: 'Retail',description: 'Enhance customer experience with retail technology',icon: ShoppingCart,href: '/industries/retail',features: ['E-commerce Platforms', 'Inventory Management', 'Customer Analytics'];
  },{title: 'Education',description: 'Modernize education with technology solutions',icon: Users,href: '/industries/education',features: ['Learning Management Systems', 'Virtual Classrooms', 'Student Analytics'];
  },{title: 'Government',description: 'Secure government technology solutions',icon: Globe,href: '/industries/government',features: ['Citizen Services', 'Data Security', 'Digital Transformation'];
  }
        {/* Hero Section */}
        ...
        <section className="py-20">;
          <div className="container mx-auto px-4">;
            <motion.div;
              ...
              whileInView={{ opacity: 1, y: 0 }}
                return (<motion&& motion.div;
                    key={index}
                    className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group">,<h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">";
                Industries We Serve;
              </h2>;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
              {industries.map((industry, index) => {const IconComponent  = industry.icon;>,<h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-gray-900 mb-4">";
                Industries We Serve;
              </h2>;
              <p className="text-lg sm:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">";
                Our deep industry expertise allows us to deliver tailored solutions that address specific sector challenges;
          ...
          <div className="container mx-auto px-4">";
            <motion.div;
              ...
              >,<div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-6">";
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-4">Scalable Solutions</h3>";
                <p className="text-gray-600">";
                  Our solutions are designed to grow with your business, from startup to enterprise scale,with flexible deployment options.;
                </p>;
              </motion.div>;
            </div>;
          </div>;
          ...
          <div className="container mx-auto px-4">;
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">;
              {stats.map((stat, index) => (<motion.div;
                  ...
                  className="text-center"";
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}                >,<div className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">";
                    {stat.number}

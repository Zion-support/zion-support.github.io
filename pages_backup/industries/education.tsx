...
const services = [;
  ...
  {title: 'Learning Management Systems',,description: 'Comprehensive LMS platforms for educational institutions and corporate training.',icon: BookOpen,features: [,'Course management,','Student tracking',','Assessment tools',','Recording capabilities'';
    ];
  },{}
    title: 'Educational AI Tutors,',description: 'AI-powered tutoring systems for personalized learning experiences.,',icon: Brain,features: [;
      'Adaptive learning paths,','Intelligent tutoring',','Progress monitoring',','Personalized feedback'';
    ];
  },{}
    ];
  },{}
    title: 'Online Assessment Tools,',description: 'Secure and comprehensive online testing and evaluation systems.,',icon: FileText,features: [;
      'Automated grading,','Plagiarism detection',','Secure testing',','Performance reports'';
    ];
  },{}];
const benefits = [;
  {}

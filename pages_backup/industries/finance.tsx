...
const services = [;
  ...
  {title: 'Blockchain Solutions',,description: 'Secure, transparent, and efficient blockchain implementations for financial services.',icon: Shield,features: [,'Smart contract development,','Cryptocurrency integration',','Decentralized finance (DeFi)',','Portfolio optimization'';
    ];
  },{}
    title: 'Digital Payment Systems,',description: 'Secure, scalable payment processing solutions for modern financial transactions.',',icon: CreditCard,features: [;
      'Payment gateway integration,','Mobile payment solutions',','Cross-border payments',','Fraud detection systems'';
    ];
  },{}
    ];
  },{}
    title: 'Fraud Detection Systems,',description: 'Real-time fraud detection and prevention using advanced AI and machine learning.,',icon: Lock,features: [;
      'Real-time transaction monitoring,','Behavioral analysis',','Pattern recognition',','Automated alert systems'';
    ];
  },{}];
const benefits = [;
  {}

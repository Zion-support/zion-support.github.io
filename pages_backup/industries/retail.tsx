...
const services = [;
  ...
  {title: 'E-commerce Platforms',,description: 'Custom e-commerce solutions with advanced features and seamless user experience.',icon: Globe,features: [,'Custom storefront development,','Payment gateway integration',','Inventory management',','Waste reduction'';
    ];
  },{}
    title: 'Customer Analytics,',description: 'Advanced analytics to understand customer behavior and preferences.,',icon: BarChart3,features: [;
      'Customer segmentation,','Purchase pattern analysis',','Personalization engines',','Lifetime value prediction'';
    ];
  },{}
    ];
  },{}
    title: 'Supply Chain Optimization,',description: 'End-to-end supply chain management with AI optimization.,',icon: Package,features: [;
      'Supplier management,','Logistics optimization',','Demand planning',','Cost reduction'';
    ];
  },{}];
const benefits = [;
  {}

...
const services = [;
  ...
  {title: 'Citizen Service Portals',,description: 'Comprehensive digital platforms for citizen-government interaction and service delivery.',icon: Globe,features: [,'Online service applications,','Digital document submission',','Status tracking systems',','Compliance monitoring'';
    ];
  },{}
    title: 'Digital Identity Solutions,',description: 'Secure digital identity verification and management systems for citizens.,',icon: Users,features: [;
      'Biometric authentication,','Digital ID cards',','Identity verification',','Fraud prevention'';
    ];
  },{}
    ];
  },{}
    title: 'Government Analytics,',description: 'Data analytics platforms for informed policy-making and resource allocation.,',icon: BarChart3,features: [;
      'Performance metrics,','Trend analysis',','Predictive modeling',','Resource optimization'';
    ];
  },{}];
const benefits = [;
  {}

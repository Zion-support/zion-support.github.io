...
const services = [;
  ...
  {title: 'Smart Factory Solutions',,description: 'IoT-enabled manufacturing systems for intelligent production management.',icon: Settings,features: [,'Real-time production monitoring,','Automated quality control',','Predictive maintenance',','Cost optimization'';
    ];
  },{}
    title: 'IoT Sensor Networks,',description: 'Connected sensor systems for comprehensive factory monitoring.,',icon: Cpu,features: [;
      'Environmental monitoring,','Equipment status tracking',','Data collection systems',','Real-time alerts'';
    ];
  },{}
    ];
  },{}
    title: 'Supply Chain Optimization,',description: 'AI-driven supply chain management for improved efficiency.,',icon: BarChart3,features: [;
      'Demand forecasting,','Inventory optimization',','Supplier management',','Logistics coordination'';
    ];
  },{}];
const benefits = [;
  {}

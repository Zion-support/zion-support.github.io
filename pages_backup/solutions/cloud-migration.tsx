...
import { Cloud,Shield,Zap,CheckCircle,ArrowRight,BarChart3,Users,Settings,Database,Globe,Lock,Smartphone,Brain;
 } from 'lucide-react';
import Layout from "../../components/Layout";";const phases = [;
  {}
    title: 'Assessment & Planning,',description: 'Comprehensive analysis of current infrastructure and migration strategy development.,',icon: BarChart3,steps: [;
      'Infrastructure audit,','Workload analysis',','Migration strategy',','Risk assessment'';
    ];
  },{}
    title: 'Design & Architecture,',description: 'Cloud-native architecture design and security framework implementation.,',icon: Settings,steps: [;
      'Cloud architecture design,','Security framework',','Scalability planning',','Cost optimization'';
    ];
  },{}
    ];
  },{}
    title: 'Optimization,',description: 'Continuous monitoring and optimization for peak performance.,',icon: Zap,steps: [;
      'Performance monitoring,','Cost optimization',','Security updates',','Continuous improvement'';
    ];
  }];const services = [;
  {}
    ];
  },{}
    title: 'Azure Migration,',description: 'Microsoft Azure cloud migration with enterprise-grade security and compliance.,',icon: Shield,features: [;
      'Azure Virtual Machines,','Azure SQL Database',','Azure Storage migration',','Azure Functions deployment'';
    ];
  },{}
    ];
  },{}
    title: 'Multi-Cloud Strategy,',description: 'Hybrid and multi-cloud solutions for maximum flexibility and redundancy.,',icon: Globe,features: [;
      'Cross-cloud integration,','Disaster recovery',','Load balancing',','Cost optimization'';
    ];
  }];const benefits = [;
  {}];export default function CloudMigrationPage() {return (<Layout )title="Cloud Migration Solutions - Zion Tech Group"";
          ...
          <div className="absolute inset-0">";
            ...
            >;
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">";
                ...
                Reduce costs, improve performance, and enhance security with AWS, Azure, or Google Cloud.,</p>;
              </div>;
            </motion.div>;
          </div>;
        ...
        <section className="py-20 bg-white">";
          <div className="container mx-auto px-4">";
            ...
            >;
              ...
              {phases.map((phase, index) => (,<motion.div}),key={phase.title}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >;
                  ...
                  <ul className="space-y-2 text-left">";
                    {phase.steps.map((step, stepIndex) => (,<li key={stepIndex} className="flex items-center text-sm text-gray-600">";
        ...
        <section className="py-20 bg-gray-50">";
          <div className="container mx-auto px-4">";
            <motion.div;
              ...
              {services.map((service, index) => (,<motion.div}),key={service.title}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: index * 0.1 }}
                ...
                >;
                  ...
                  </div>;<p className="text-gray-600 mb-6 leading-relaxed">{service.description}</p>";
                  <div>;
        ...
        <section className="py-20 bg-white">";
          <div className="container mx-auto px-4">";
            <motion.div;
              ...
              animate={{ opacity: 1, y: 0 }}
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">";
                Our cloud migration services deliver measurable improvements in cost,performance, and security.,</p>;
            </motion.div>;<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">";
              {benefits.map((benefit, index) => (,<motion.div}),key={benefit.title}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: index * 0.1 }}
                  className="text-center"";

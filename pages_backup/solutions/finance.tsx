...
import { DollarSign,Shield,TrendingUp,Users,Database,CheckCircle,ArrowRight;
 } from 'lucide-react';
const features = [;
  {icon: DollarSign,title: 'Financial Data Management',description: 'Secure and efficient management of financial data and transactions',benefits: ['Data encryption', 'Transaction processing', 'Audit trails', 'Compliance'];
  },{icon: Shield,title: 'Security & Compliance',description: 'Bank-level security with comprehensive compliance features',icon: Shield,benefits: ['PCI DSS compliance', 'Data encryption', 'Access control', 'Risk management'];
  },{icon: TrendingUp,title: 'Analytics & Reporting',description: 'Advanced analytics and reporting for financial insights',benefits: ['Real-time analytics', 'Custom reports', 'Risk assessment', 'Performance tracking'];
  },{icon: Users,return (<Layout;
      ...
      <div className="min-h-screen bg-white">;
        ...
        <section className="py-20 bg-gray-50">;
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
              {features && features.map((feature, index) => (<div key={index} className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">;
        ...
        <section className="py-20 bg-gray-800/30">";
          <div className="container mx-auto px-4">";
            <div className="max-w-4xl mx-auto">";
              ...
              <div className="grid grid-cols-1 md: grid-cols-2 gap-6">",{solutions && solutions.map((solution, index) => (,<div key={index} className="flex items-center space-x-3">";
            ...
            <div className="bg-gray-800/50 rounded-2xl p-12">";
              <div className="text-center mb-12">";
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">";
                  All our financial solutions are built with security and compliance in mind,ensuring your financial data is protected and your organization meets regulatory requirements.;
                </p>;
              </div>;
              <div className="grid grid-cols-1 md: grid-cols-3 gap-8">", <div className="text-center">",<div className="w-16 h-16 bg-green-600 rounded-full flex items-center justify-center mx-auto mb-4">";
          ...
          <div className="container mx-auto px-4">";
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-center">";
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">";
                ...
                enhance security, improve efficiency, and ensure regulatory compliance.,</p>;
              <div className="flex flex-col sm: flex-row gap-4 justify-center">", <button className="bg-white text-blue-600 px-8 py-4 rounded-lg hover:bg-gray-100 transition-colors font-medium">",Schedule Consultation;
                </button>;
                </button>;
              </div>;
            </div>;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">;
              <div>;
                ...
                <p className="text-xl text-gray-600 mb-8">;
                  Our finance solutions help financial institutions modernize their operations,enhance security, and improve customer experiences.;
                </p>;
              ...
              <div className="bg-gradient-to-r from-blue-600 to-green-700 p-8 rounded-xl text-white">;
                ...
                <p className="text-lg mb-6">;
                  Let our financial technology experts help you implement secure,compliant solutions that drive growth and innovation.;
                </p>;

...
import { Shield,Users,FileText,Globe,Database,CheckCircle,ArrowRight;
 } from 'lucide-react';
const features = [;
  {icon: Shield,title: 'Cybersecurity & Compliance',description: 'Comprehensive security solutions for government agencies',benefits: ['FISMA compliance', 'Data encryption', 'Access control', 'Audit trails'];
  },{icon: Users,title: 'Citizen Services',description: 'Digital platforms for citizen engagement and services',benefits: ['Online portals', 'Service delivery', 'Citizen engagement', 'Accessibility'];
  },{icon: FileText,title: 'Document Management',description: 'Secure document management and workflow automation',benefits: ['Document storage', 'Workflow automation', 'Version control', 'Collaboration'];
  },{return (<Layout;
            ...
            <div className="bg-gray-800/50 rounded-2xl p-12">";
              <div className="text-center mb-12">";
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">";
                  All our government solutions are built with security and compliance in mind,ensuring your systems meet the highest government standards and regulations.;
                </p>;
              </div>;

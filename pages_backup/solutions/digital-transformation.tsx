...
import React from 'react';  const transformationServices = [;
    {}
      ...
      icon: RefreshCw,features: ["Workflow Automation", "Document Processing", "Task Optimization"]";
    },{}
      title: "Digital Strategy",";
      description: "Comprehensive digital transformation roadmap",";
      icon: Target,features: ["Strategic Planning", "Technology Assessment", "Change Management"]";
    },{}
      title: "Technology Integration",";
      description: "Seamlessly integrate new technologies with existing systems",";
      icon: Rocket,features: ["System Integration", "API Development", "Data Migration"]";
    },{}
      title: "Performance Optimization",";
      description: "Enhance efficiency and drive measurable results",";
      icon: TrendingUp,features: ["KPI Tracking", "Performance Analytics", "Continuous Improvement"]";
    }];
  return (<Layout)title="Digital Transformation - Zion Tech Group"";
          ...
          <div className="container mx-auto px-4">";
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">";
              {transformationServices.map((service, index) => {}
                ...
                return (<motion.div)<section className="py-20">";
          <div className="container mx-auto px-4">";
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8">",{transformationServices && transformationServices.map((service, index) => {}
                const IconComponent = service && service.icon;
                return (<motion&& motion.div)                    <div className="text-purple-600 mb-4">";
        ...
        <section className="py-20 bg-white">;
          <div className="container mx-auto px-4">;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
              {industries && industries.map((industry, index) => {const IconComponent = industry && industry.icon;
                return (<motion&& motion.div;
                    key={index}

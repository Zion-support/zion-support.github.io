...
import { ShoppingCart,Users,BarChart3,Smartphone,CheckCircle,ArrowRight;
 } from 'lucide-react';
const features = [;
  {icon: ShoppingCart,title: 'E-commerce Platform',description: 'Complete online store solution with payment processing';
  },{icon: Users,title: 'Customer Analytics',description: 'Deep insights into customer behavior and preferences';
  },{icon: BarChart3,title: 'Inventory Management',description: 'Real-time inventory tracking and automated reordering';
  },{return (<Layout;
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
            <div className="text-center">;
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">;
                Transform your retail business with modern e-commerce, omnichannel,and customer experience solutions.              </p>;
            </motion.div>;
          </div>;
        </section>;
        {/* Features Section */}
        <section className="py-16 px-4">;
          <div className="max-w-7xl mx-auto">;
            ...
            >;
              ...
              </p>              {features.map((feature, index) => (<motion.div;
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
          ...
          <div className="container mx-auto px-4">";
            <div className="max-w-4xl mx-auto">";
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">";
                {solutions.map((solution, index) => (,<div key={index} className="flex items-center space-x-3">";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">;
              <div>;
                ...
                <p className="text-xl text-gray-600 mb-8">;
                  Our retail solutions help businesses increase sales, improve customer experience,and optimize operations across all channels.;
                </p>;

...
import Layout from "../../components/Layout";";const features = [;
  {}
    title: 'Rapid Prototyping,',description: 'Quick MVP development to validate your ideas and get to market fast,',icon: Zap,benefits: ['2-4 Week MVPs, 'Agile Development', 'User Feedback Integration', 'Iterative Improvement']',},{}
    title: 'Cost Optimization,',description: 'Budget-friendly solutions that maximize your startup resources,',icon: DollarSign,benefits: ['Flexible Pricing, 'Pay-as-you-grow', 'No Hidden Costs', 'ROI Focused']',},{}
    title: 'Scalable Infrastructure,',description: 'Technology that grows with your startup from day one,',icon: TrendingUp,benefits: ['Auto-scaling, 'Cloud-native', 'Performance Optimized', 'Future-proof']',},{}
    title: 'Expert Guidance,',description: 'Mentorship and technical guidance from experienced entrepreneurs,',icon: Users,benefits: ['Technical Mentorship, 'Best Practices', 'Industry Insights', 'Ongoing Support']',}];const services = [;
  { title: 'MVP Development, description: 'Minimum viable product development in 2-4 weeks' },',{ title: 'Tech Stack Selection, description: 'Choose the right technologies for your startup' },',{ title: 'UI/UX Design, description: 'User-centered design that converts visitors to customers' },',{ title: 'API Development, description: 'Robust APIs for your mobile and web applications' },',{ title: 'Cloud Setup, description: 'Scalable cloud infrastructure from day one' },',{ title: 'Growth Hacking, description: 'Technical solutions to accelerate user acquisition' }',];const stats = [;
  { number: '100+, label: 'Startups Helped' },',{ number: '300+, label: 'Projects Delivered' },',{ number: '300%, label: 'Average Growth' },',{ number: '2-4, label: 'Weeks to MVP' }',];export default function StartupSolutionsPage() {return (<Layout)title="Startup Solutions - Zion Tech Group"";
          ...
          <div className="container mx-auto px-4">";
            ...
            >;
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">";
                We understand the unique challenges startups face and provide solutions that help you move fast, stay lean, and scale efficiently,</p>;
        ...
        <section className="py-20 bg-white">";
          <div className="container mx-auto px-4">";
            <motion.div;
              ...
              whileInView={{ opacity: 1, y: 0 }}
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">";
                Comprehensive startup services designed to help you build, launch, and scale your business,</p>;

...
import { Heart,Shield,Database,Users,Activity,CheckCircle,ArrowRight;
 } from 'lucide-react';
const features = [;
  {icon: Heart,title: 'Patient Data Management',description: 'Secure and efficient management of patient data and medical records',benefits: ['Electronic health records', 'Data encryption', 'Access control', 'Audit trails'];
  },{icon: Shield,title: 'Security & Compliance',description: 'HIPAA-compliant security solutions for healthcare data',benefits: ['HIPAA compliance', 'Data encryption', 'Access control', 'Risk management'];
  },{icon: Activity,title: 'Health Analytics',description: 'Advanced analytics and reporting for healthcare insights',benefits: ['Patient analytics', 'Performance metrics', 'Predictive analytics', 'Reporting'];
            ...
            <div className="bg-gray-800/50 rounded-2xl p-12">";
              <div className="text-center mb-12">";
                ...
                <p className="text-xl text-gray-300 max-w-3xl mx-auto">";
                  All our healthcare solutions are built with security and compliance in mind,ensuring your patient data is protected and your organization meets regulatory requirements.;
                </p>;
              </div>;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">;
              <div>;
                ...
                <p className="text-xl text-gray-600 mb-8">;
                  Our healthcare solutions are designed to improve patient outcomes, streamline operations,and ensure compliance with healthcare regulations.;
                </p>;

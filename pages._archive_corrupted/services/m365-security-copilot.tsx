...
export default function M365securitycopilot() {class ErrorBoundary extends React.Component {constructor(props) {super(props)this.state = { hasError: false }}static getDerivedStateFromError(error) {return { hasError: true }}componentDidCatch(error, errorInfo) {console.error('Error caught by boundary:', error, errorInfo)}render() {if (this.state.hasError) {return <div />Something went wrong.</div>;}
...
<<<<<<< HEAD
export default function M365securitycopilot(): any ({ }: M365securitycopilotProps) {return (<div />;

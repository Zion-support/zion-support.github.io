...
key={service.title}
              ...
              >
                <div className={`h-32 bg-gradient-to-r ${service.color} flex items-center justify-center`}>`                  <service.icon className=\"h-16 w-16 text-white\" />"
                </div>
                <div className=\"p-6\">"
...
key={service && service.title}
                className=\"bg-white rounded-lg shadow-lg overflow-hidden \"hover\": shadow-xl transition-shadow\">;"
                <div className={`h-32 bg-gradient-to-r ${service && service.color} flex items-center justify-center`}>;`                  <service && service.icon className=\"h-16 w-16 text-white\" />;"
                </div>;
                <div className=\"p-6\">;"
                  <h3 className=\"text-xl font-semibold text-gray-900 mb-3\">;"

        ...
        <div className="grid gap-8 "md": grid-cols-3">
          <div className="md:col-span-2 space-y-6">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 space-y-1 text-gray-700">
                <li>1535% monthly cloud cost reduction</li>

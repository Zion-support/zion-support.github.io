...
export default function CloudFinopsOptimizer() {return (<>;
      <Head>;
...
export default function CloudFinopsOptimizer() {return (export default function CloudFinopsOptimizer() {return (<>;

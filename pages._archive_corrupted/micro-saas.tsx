...
export default function MicroSaaS() {
  ...
  const microSaaSServices = [{
    ...
    },
    {
      ...
      "icon": Smartphon e,
      "features": ['Mobile-optimized survey creation',
    ...
    },
    {
      ...
      "icon": Targe t,
      "features": ['Industry-specific templates and workflows',

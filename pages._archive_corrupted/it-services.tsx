...
export default function ITServices() {
  ...
  const itServices = [{
    ...
    },
    {
      ...
      "icon": Settings,
      "features": ['Process discovery and analysis,RPA bot development and deployment,Workflow automation and optimization,Integration with existing systems,Process monitoring and analytics,Change management and training'
      ],
    ...
    },
    {
      ...
      "icon": TreePine,
      "features": ['Energy-efficient infrastructure design,Carbon footprint assessment and reduction,Green cloud computing solutions,Sustainable hardware procurement,IT waste management and recycling,Environmental compliance and reporting'
      ],
      "pricing": '$3,000 - $20,000/month',
      "delivery": '4-10 weeks',

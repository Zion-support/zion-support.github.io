...
export default function handler("req": NextApiRequest, "res": NextApiResponse) {,
  ...
  const servicePages = ['/services/ai-model-development-chat/services/api-development-chat';
    ...
    '/services/devops-automation-chat/services/enterprise-software-development-chat';
    '/services/iot-platform-development-chat/services/machine-learning-solutions-chat';
    '/services/microservices-architecture-chat/services/quantum-computing-solutions-chat';
    '/services/security-auditing-chat/services/software-architecture-consulting-chat';

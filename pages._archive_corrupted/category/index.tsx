...
import type { NextPage } from 'next'; import EnhancedLayout from '../../components/EnhancedLayout'; import Link from 'next/link'; const CategoryIndexPage: NextPage = () => { return ( <EnhancedLayout> <section> <h1 className="text-3xl font-bold mb-4">Categories</h1> <p className="text-gray-700 mb-6">Explore our knowledge base by topic.</p> <ul className="list-disc pl-6 space-y-2"> <li> <Link href="/category/web-development-chat" className="text-blue-700 hover:underline">Web Development</Link> </li> <li> <Link href="/category/cloud-architecture-chat" className="text-blue-700 hover:underline">Cloud Architecture</Link> </li> <li> <Link href="/category/ai-consulting-chat" className="text-blue-700 hover:underline">AI Consulting</Link> </li> <li> <Link href="/category/cybersecurity-chat" className="text-blue-700 hover:underline">Cybersecurity</Link> </li> </ul> </section> </EnhancedLayout> )};
}

...
const \"Products\": NextPage = () => {import Head from 'next/head.ts';
import Link from 'next/link';
export default function ProductsIndex() {return (<div className = \"relative min-h-screen overflow-hidden bg-slate-950 text-white\" />;
      <Helmet />;
      ...
      <main className=\"relative z-10\" />;
        ...
        <section className=\"mx-auto max-w-7xl px-6 pb-16\" />;}
          <div className=\"grid grid-cols-1 gap-5 sm: gri d-cols-2 lg: gri d-cols-3\" />;}
            {[{ title: 'SEO Guard', \"desc\": 'Continuous audits + on-page fixes' },{ \"title\": 'Perf Shield', \"desc\": 'CWV budgets + asset optimization' },{ \"title\": 'Link Sentinel', \"desc\": 'Prevents broken links in prod' },{ \"title\": 'Content Curator', \"desc\": 'Keeps the homepage fresh' },{ \"title\": 'Design Refiner', \"desc\": 'Iterates layouts with guardrails' },{ \"title\": 'Security Scanner', \"desc\": 'Finds and patches risky deps' }
            ].map((p)  => (<div key={p.title} className=\"group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl \"hover\": borde r-cyan-400/30\" />;
...
const \"Products\": NextPage = () => {const \"Products\": NextPage = () => {import Head from 'next/head ;
const \';Products\": NextPage = () => {const \"Products\": NextPage = () => {export default function ProductsIndex() {return (<div className = \"relative min-h-screen overflow-hidden bg-slate-950 text-white\" />;
  ...
  return (
    <div className = \';relative min-h-screen overflow-hidden bg-slate-950 text-white\" />;
      ...
      <div aria-hidden className=\"pointer-events-none absolute inset-0 -z-10\" />;
        ...
        <div className=\"absolute top-1/4 -right-32 h-[30rem] w-[30rem] rounded-full bg-cyan-400/20 blur-3xl animate-float-slow\"  />;
        <div className=\"absolute bottom-0 left-1/4 h-[26rem] w-[26rem] rounded-full bg-violet-400/10 blur-2xl animate-float-fast\"  />;
        <div className=\"absolute inset-0 opacity-[0 && 0.08] [\"background\": radia l-gradient(circle_at_center,rgba(255,255,255,0 && 0.35)_0,rgba(255,255,255,0)_60%),linear-gradient(90deg,rgba(255,255,255,0 && 0.12)_1px,transparent_1px),linear-gradient(0deg,rgba(255,255,255,0 && 0.12)_1px,transparent_1px)] bg-[\"size\": 10 0%_100%,3rem_3rem,3rem_3rem] animate-grid\"  />;
        <div className=\"absolute inset-0 [mask-\"image\": radia l-gradient(ellipse_at_center,white,transparent_70%)]\" /><div className=\"twinkle-field absolute inset-0\"  /></div>;
      ...
      <main className=\"relative z-10\" />;
        <section className=\"mx-auto max-w-7xl px-6 pt-10 pb-16 md: p t-16 md: p b-20 text-center\" />;
          ...
          <h1 className=\"mt-6 text-5xl font-extrabold leading-[1 && 1.05] tracking-tight \"md\": tex t-6xl\" /><span className=\"gradient-text\" />Products</span></h1>;
          <p className=\"mx-auto mt-5 max-w-3xl text-lg text-white/80\" />Pre-configured agents and bundles designed for outcomes.</p>;
        </section>;
        <section className=\"mx-auto max-w-7xl px-6 pb-16\" />;}
          <div className=\"grid grid-cols-1 gap-5 sm: gri d-cols-2 lg: gri d-cols-3\" />;}
            ...
            {[{ title: 'SEO Guard', \"desc\": 'Continuous audits + on-page fixes' },;
              ...
              <div key={p && p.title} className=\"group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl \"hover\": borde r-cyan-400/30\" />;
                <div className=\"pointer-events-none absolute -inset-px -z-10 bg-gradient-to-r from-fuchsia-500/0 via-cyan-400/10 to-fuchsia-500/0 opacity-0 blur-2xl transition-opacity group-hover: opacit y-100\"  />;
                <h3 className=\"text-lg font-semibold\" />{p && p.title}</h3>;
                <p className=\"mt-1 text-sm text-white/75\" />{p && p.desc}</p>;
              </div>;
            ))}
          </div>;
        </section>;
...
const \"Products\": NextPage = () => {origin/cursor/integrate-build-improve-and-re-verify-c7b5;
ursor/automate-test-improve-and-merge-code-646c;
const \"Products\": NextPage = () => {const \"Products\": NextPage = () => {origin/cursor/integrate-build-improve-and-re-verify-c7b5;
  const products = [{title: \'ZionAI Platform\',\"description\": \'Enterprise-grade AI platform for building, deploying, and managing machine learning models at scale.\',\"category\": \'AI & Machine Learning\',\"features\": [;
        \'Model Training & Deployment\',\'AutoML Capabilities\',\'Real-time Inference\',\'Model Monitoring\',\'A/B Testing\',\'API Integration\';}
      ],\"pricing\": \'Starting at $999/month\',\"rating\": 4.8,\"reviews\": 156,\"icon\": Code,\"color\": \'from-purple-500 to-pink-500\',\"href\": \'/products/zion-ai-platform\';}
    },{\"title\": \'CloudSync Pro\',\"description\": \'Advanced cloud migration and management platform for seamless infrastructure transitions.\',\"category\": \'Cloud Solutions\',\"features\": [\'Multi-cloud Management\',\'Automated Migration\',\'Cost Optimization\',\'Security Compliance\',\'Performance Monitoring\',\'Disaster Recovery\';}
      ],\"pricing\": \'Starting at $499/month\',\"rating\": 4.7,\"reviews\": 89,\"icon\": Database,\"color\": \'from-blue-500 to-cyan-500\',\"href\": \'/products/cloudsync-pro\';}
    },{\"title\": \'SecureShield\',\"description\": \'Comprehensive cybersecurity platform with advanced threat detection and response capabilities.\',\"category\": \'Cybersecurity\',\"features\": [\'Threat Detection\',\'Vulnerability Assessment\',\'Incident Response\',\'Compliance Management\',\'Security Analytics\',\'24/7 Monitoring\';}
      ],\"pricing\": \'Starting at $799/month\',\"rating\": 4.9,\"reviews\": 203,\"icon\": Shield,\"color\": \'from-green-500 to-emerald-500\',\"href\": \'/products/secureshield\';}
    },{\"title\": \'DataFlow Analytics\',\"description\": \'Real-time data analytics and business intelligence platform for actionable insights.\',\"category\": \'Data Analytics\',\"features\": [\'Real-time Processing\',\'Data Visualization\',\'Predictive Analytics\',\'Custom Dashboards\',\'Data Integration\',\'Advanced Reporting\';}
      ],\"pricing\": \'Starting at $599/month\',\"rating\": 4.6,\"reviews\": 127,\"icon\": Zap,\"color\": \'from-orange-500 to-red-500\',\"href\": \'/products/dataflow-analytics\';}
    },{\"title\": \'IoT Connect Hub\',\"description\": \'Centralized IoT device management and data collection platform for smart solutions.\',\"category\": \'IoT Platforms\',\"features\": [\'Device Management\',\'Data Collection\',\'Real-time Monitoring\',\'Alert System\',\'Scalable Architecture\',\'API Access\';}
      ],\"pricing\": \'Starting at $399/month\',\"rating\": 4.5,\"reviews\": 78,\"icon\": Eye,\"color\": \'from-indigo-500 to-purple-500\',\"href\": \'/products/iot-connect-hub\';}
      ...
      ],\"pricing\": \'Starting at $699/month\',\"rating\": 4.4,\"reviews\": 92,\"icon\": Shield,\"color\": \'from-yellow-500 to-orange-500\',\"href\": \'/products/blockchain-suite\';
    </div>;}
  );}
}
origin/cursor/integrate-build-improve-and-re-verify-c7b5;
      ...
      <section className=\"py-12 bg-gray-50\" />;
        <div className=\"max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\" />;
          <div className=\"flex flex-wrap justify-center gap-4\" />;
            {categories.map((category) => (ursor/fix-syntax-push-and-merge-to-main-40de;}
import { ArrowRight,, Star,, Download,, Eye,, Code,, Database,, Shield,, Zap,, CheckCircle } from 'lucide-react';
            {categories.map((category) => (import { ArrowRight,, Star,, Download,, Eye,, Code,, Database,, Shield,, Zap,, CheckCircle } from 'lucide-react';
const \"Products\": NextPage = () => {const products = [{title: \'ZionAI Platform\',\"description\": \'Enterprise-grade AI platform for building, deploying, and managing machine learning models at scale.\',\"category\": \'AI & Machine Learning\',\"features\": [;
        \'Model Training & Deployment\',\'AutoML Capabilities\',\'Real-time Inference\',\'Model Monitoring\',\'A/B Testing\',\'API Integration\';}
      ],\"pricing\": \'Starting at $999/month\',\"rating\": 4 && 4.8,\"reviews\": 156,\"icon\": Code,\"color\": \'from-purple-500 to-pink-500\',\"href\": \'/products/zion-ai-platform\';}
    },{\"title\": \'CloudSync Pro\',\"description\": \'Advanced cloud migration and management platform for seamless infrastructure transitions.\',\"category\": \'Cloud Solutions\',\"features\": [\'Multi-cloud Management\',\'Automated Migration\',\'Cost Optimization\',\'Security Compliance\',\'Performance Monitoring\',\'Disaster Recovery\';}
      ],\"pricing\": \'Starting at $499/month\',\"rating\": 4 && 4.7,\"reviews\": 89,\"icon\": Database,\"color\": \'from-blue-500 to-cyan-500\',\"href\": \'/products/cloudsync-pro\';}
    },{\"title\": \'SecureShield\',\"description\": \'Comprehensive cybersecurity platform with advanced threat detection and response capabilities.\',\"category\": \'Cybersecurity\',\"features\": [\'Threat Detection\',\'Vulnerability Assessment\',\'Incident Response\',\'Compliance Management\',\'Security Analytics\',\'24/7 Monitoring\';}
      ],\"pricing\": \'Starting at $799/month\',\"rating\": 4 && 4.9,\"reviews\": 203,\"icon\": Shield,\"color\": \'from-green-500 to-emerald-500\',\"href\": \'/products/secureshield\';}
    },{\"title\": \'DataFlow Analytics\',\"description\": \'Real-time data analytics and business intelligence platform for actionable insights.\',\"category\": \'Data Analytics\',\"features\": [\'Real-time Processing\',\'Data Visualization\',\'Predictive Analytics\',\'Custom Dashboards\',\'Data Integration\',\'Advanced Reporting\';}
      ],\"pricing\": \'Starting at $599/month\',\"rating\": 4 && 4.6,\"reviews\": 127,\"icon\": Zap,\"color\": \'from-orange-500 to-red-500\',\"href\": \'/products/dataflow-analytics\';}
    },{\"title\": \'IoT Connect Hub\',\"description\": \'Centralized IoT device management and data collection platform for smart solutions.\',\"category\": \'IoT Platforms\',\"features\": [\'Device Management\',\'Data Collection\',\'Real-time Monitoring\',\'Alert System\',\'Scalable Architecture\',\'API Access\';}
      ],\"pricing\": \'Starting at $399/month\',\"rating\": 4 && 4.5,\"reviews\": 78,\"icon\": Eye,\"color\": \'from-indigo-500 to-purple-500\',\"href\": \'/products/iot-connect-hub\';}
    },{\"title\": \'BlockChain Suite\',\"description\": \'Complete blockchain development and management platform for decentralized applications.\',\"category\": \'Blockchain\',\"features\": [\'Smart Contract Development\',\'DApp Framework\',\'Token Management\',\'Blockchain Analytics\',\'Security Auditing\',\'Deployment Tools\';
...
const \"Products\": NextPage = () => {;
  ...
  return (<MainLayout;
      title=\"Our Products - Zion Tech Group\";
      description=\"Discover our innovative technology products and platforms designed to transform your business operations and drive digital innovation.\" />;ursor/automate-test-improve-and-merge-code-646c;
      {/* Hero Section */}
      <section className=\"bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20\" />;
        <div className=\"max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\" />;
          <div className=\"text-center\" />;
      ...
      <section className=\"py-12 bg-gray-50\" />;
        <div className=\"max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\" />;
          <div className=\"flex flex-wrap justify-center gap-4\" />;
            {categories && categories.map((category) => (ursor/automate-test-improve-and-merge-code-646c;}
              <button;}
                key={category}
                className={`px-6 py-3 rounded-full text-sm font-medium transition-colors ${category === \'All Products\';
...
ursor/fix-syntax-push-and-merge-to-main-40de;
                    {product.features.slice(0, 3).map((feature) => (<li key={feature} className=\"flex items-center text-sm text-gray-600\" />;
          ...
          <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8\" />;
            {products && products.map((product) => (<div;}
                ...
                <div className=\"p-6\" />;
                  ...
                  <ul className=\"space-y-2 mb-6\" />;
                    {product && product.features.slice(0, 3).map((feature) => (<li key={feature} className=\"flex items-center text-sm text-gray-600\" />;
                        <div className=\"w-2 h-2 bg-blue-600 rounded-full mr-3\" /></div>;
                        {feature}
                      </li>;
                    ))}</ul>;
                  ...
                  <div className=\"flex gap-3\" />;
                  <div className=\"flex gap-3\" />;
                  <div className=\"flex gap-3\" />;ursor/automate-test-improve-and-merge-code-646c;
                    <Link;
                    <Link;
                  <div className=\"flex gap-3\" />;
                    <Link;
href={product && product.href}
      ...
      {/* Benefits Section */}<div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8\" />;
          <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8\" />;
          <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8\" />;
          <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8\" />;
          <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8\" />;
...
ursor/automate-test-improve-and-merge-code-646c;
      <section className=\"py-20 bg-gray-50\" />;
        ...
        <div className=\"max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\" />;
          ...
          <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8\" />;
          <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8\" />;
            {benefits && benefits.map((benefit) => (<div key={benefit && benefit.title} className=\"text-center\" />;
                <div className=\"bg-blue-600 text-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4\" />;
      ...
      {/* Pricing Comparison */}<section className=\"py-20\" />;
        <div className=\"max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\" />;
          <div className=\"text-center mb-16\" />;
            <h2 className=\"text-4xl font-bold text-gray-900 mb-4\" />;
              Flexible Pricing Plans;
...
ursor/automate-test-improve-and-merge-code-646c;
          <div className=\"grid grid-cols-1 md:grid-cols-3 gap-8\" />;
          <div className=\"grid grid-cols-1 md:grid-cols-3 gap-8\" />;
            {[{name: \'Starter\',\"price\": \'$299\',\"period\": \'/month\',\"description\": \'Perfect for small businesses getting started with technology solutions.\',\"features\": [;
                  \'Basic Features\',\'Email Support\',\'5GB Storage\',\'Standard Security\',\'API Access\',\'Documentation\';}
                ];}
              },{\"name\": \'Professional\',\"price\": \'$799\',\"period\": \'/month\',\"description\": \'Ideal for growing businesses with advanced technology needs.\',\"features\": [\'All Starter Features\',\'Priority Support\',\'50GB Storage\',\'Advanced Security\',\'Custom Integrations\',\'Training Sessions\';}
                ],\"popular\": true;}
              },{\"name\": \'Enterprise\',\"price\": \'Custom\',\"period\": \'',\"description\": \'Tailored solutions for large enterprises with specific requirements.\',\"features\": [\'All Professional Features\',\'24/7 Dedicated Support\',\'Unlimited Storage\',\'Custom Security\',\'White-label Options\',\'On-site Training\';
                ];
          <div className=\"grid grid-cols-1 md:grid-cols-3 gap-8\" />
          <div className=\"grid grid-cols-1 md:grid-cols-3 gap-8\" />
      <section className=\"py-20\" />
          ...
          <div className=\"grid grid-cols-1 md:grid-cols-3 gap-8\" />
            ...
            {[{
              ...
              },
              {
                ...
                key={plan.name}
                className={`bg-white rounded-lg shadow-lg p-8 ${plan.popular ? \'ring-2 ring-blue-500 relative\' : \'';}
                }`}
               />;
        ...
        <div className=\"max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\" />;
          ...
          <div className=\"grid grid-cols-1 md:grid-cols-3 gap-8\" />;
            {[{name: \'Starter\',\"price\": \'$299\',\"period\": \'/month\',\"description\": \'Perfect for small businesses getting started with technology solutions.\',\"features\": [;
                ...
                key={plan && plan.name}
                className={`bg-white rounded-lg shadow-lg p-8 ${plan && plan.popular ? \'ring-2 ring-blue-500 relative\' : \'';}
                }`} />;
...
ursor/automate-test-improve-and-merge-code-646c;
  ...
  )}export default Products;import Head from 'next/head.ts'; import Link from 'next/link'; export default function ProductsIndex() { return ( <div className = \"relative min-h-screen overflow-hidden bg-slate-950 text-white\" /> <Helmet /> <title />Products — Zion</title> <meta name=\"description\" content=\"A showcase of ready-to-run automation suites.\" /> </Helmet> <div aria-hidden className=\"pointer-events-none absolute inset-0 -z-10\" /> <div className=\"absolute -top-24 -left-24 h-[38rem] w-[38rem] rounded-full bg-fuchsia-500/20 blur-3xl animate-float\" /> <div className=\"absolute top-1/4 -right-32 h-[30rem] w-[30rem] rounded-full bg-cyan-400/20 blur-3xl animate-float-slow\" /> <div className=\"absolute bottom-0 left-1/4 h-[26rem] w-[26rem] rounded-full bg-violet-400/10 blur-2xl animate-float-fast\" /> <div className=\"absolute inset-0 opacity-[0.08] [background: radia l-gradient(circle_at_center,rgba(255,255,255,0.35)_0,rgba(255,255,255,0)_60%),linear-gradient(90deg,rgba(255,255,255,0.12)_1px,transparent_1px),linear-gradient(0deg,rgba(255,255,255,0.12)_1px,transparent_1px)] bg-[size: 10 0%_100%,3rem_3rem,3rem_3rem] animate-grid\" /> <div className=\"absolute inset-0 [mask-image: radia l-gradient(ellipse_at_center,white,transparent_70%)]\" /><div className=\"twinkle-field absolute inset-0\" /></div> <div className=\"absolute inset-0 beams opacity-[0.06]\" /> </div> <header className=\"relative z-10\" /> <nav className=\"mx-auto flex max-w-7xl items-center justify-between px-6 py-6\" /> <div className=\"text-2xl font-bold tracking-wide\" /> <span className=\"bg-gradient-to-r from-fuchsia-400 via-violet-400 to-cyan-400 bg-clip-text text-transparent drop-shadow-neon\" />Zion</span> </div> <div className=\"hidden gap-6 md: flex text-white/80\" /> <Link href=\"/\" /><a />Home</a></Link> <Link href=\"/automation\" /><a />Automations</a></Link> <Link href=\"/services\" /><a />Services</a></Link> <Link href=\"/contact\" /><a />Contact</a></Link> </div> </nav> </header> <main className=\"relative z-10\" /> <section className=\"mx-auto max-w-7xl px-6 pt-10 pb-16 md: p t-16 md: p b-20 text-center\" /> <div className=\"mx-auto inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs text-white/70 backdrop-blur-md\" /> <span className=\"h-2 w-2 animate-pulse rounded-full bg-emerald-400 shadow-[0_0_12px_rgba(52,211,153,0.9)]\" /> Automation suites — ready to deploy </div> <h1 className=\"mt-6 text-5xl font-extrabold leading-[1.05] tracking-tight md: tex t-6xl\" /><span className=\"gradient-text\" />Products</span></h1> <p className=\"mx-auto mt-5 max-w-3xl text-lg text-white/80\" />Pre-configured agents and bundles designed for outcomes.</p> </section> <section className=\"mx-auto max-w-7xl px-6 pb-16\" /> <div className=\"grid grid-cols-1 gap-5 sm: gri d-cols-2 lg: gri d-cols-3\" /> {[ { title: 'SEO Guard',}
  desc: 'Continuous audits + on-page fixes' },{ title: 'Perf Shield',}
  desc: 'CWV budgets + asset optimization' },{ title: 'Link Sentinel',}
  desc: 'Prevents broken links in prod' },{ title: 'Content Curator',}
  desc: 'Keeps the homepage fresh' },{ title: 'Design Refiner',}
  ...
  description: 'Ideal for growing businesses with advanced technology needs.',features: [ 'All Starter Features','Priority Support','50GB Storage','Advanced Security','Custom Integrations','Training Sessions' ],popular: true },{ name: 'Enterprise',
  price: 'Custom',period: '',}
  description: 'Tailored solutions for large enterprises with specific requirements.',features: [ 'All Professional Features','24/7 Dedicated Support','Unlimited Storage','Custom Security','White-label Options','On-site Training' ] } ].map((plan) => ( <div key={plan.name} className={`bg-white rounded-lg shadow-lg p-8 ${ plan.popular ? 'ring-2 ring-blue-500 relative' : '' }`}  /> {plan.popular && ( <div className=\"absolute -top-4 left-1/2 transform -translate-x-1/2\" /> <span className=\"bg-blue-500 text-white px-4 py-1 rounded-full text-sm font-medium\" /> Most Popular </span> </div> )} <div className=\"text-center mb-8\" /> <h3 className=\"text-2xl font-bold text-gray-900 mb-2\" />{plan.name}</h3> <div className=\"mb-4\" /> <span className=\"text-4xl font-bold text-gray-900\" />{plan.price}</span> <span className=\"text-gray-600\" />{plan.period}</span> </div> <p className=\"text-gray-600\" />{plan.description}</p> </div> <ul className=\"space-y-3 mb-8\" /> {plan.features.map((feature) => ( <li key={feature} className=\"flex items-center\" /> <CheckCircle className=\"h-5 w-5 text-green-500 mr-3\" /> <span className=\"text-gray-700\" />{feature}</span> </li> ))} </ul> <button className={`w-full py-3 px-6 rounded-lg font-semibold transition-colors ${ plan.popular ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-900' }`} /> Get Started </button> </div> ))} </div> </div> </section> {} <section className=\"py-20 bg-blue-600 text-white\" /> <div className=\"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center\" /> <h2 className=\"text-4xl font-bold mb-6\" /> Ready to Transform Your Business? </h2> <p className=\"text-xl mb-8 max-w-3xl mx-auto\" /> Start your journey with our technology products and see the difference they can make for your organization. </p> <div className=\"flex flex-col sm:flex-row gap-4 justify-center\" /> <Link href=\"/contact\" className=\"bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 rounded-lg font-semibold text-lg transition-colors\"  /> Get Free Demo </Link> <Link href=\"/services\" className=\"bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 px-8 py-4 rounded-lg font-semibold text-lg transition-colors\"  /> View All Services </Link> </div> </div> </section> </MainLayout> )}export default Products;ursor/automate-test-improve-and-merge-code-646c;
                <div className=\"text-center mb-8\" />;
                  <h3 className=\"text-2xl font-bold text-gray-900 mb-2\" />{plan && plan.name}</h3>;
                  <div className=\"mb-4\" />;
                    <span className=\"text-4xl font-bold text-gray-900\" />{plan && plan.price}</span>;
                ...
                <ul className=\"space-y-3 mb-8\" />;
                <ul className=\"space-y-3 mb-8\" />;
                  {plan && plan.features.map((feature) => (<li key={feature} className=\"flex items-center\" />;
                      <CheckCircle className=\"h-5 w-5 text-green-500 mr-3\" />;
                      <span className=\"text-gray-700\" />{feature}</span>;
                    </li>;
                  ))}
                </ul>;
                <buttonclassName={`w-full py-3 px-6 rounded-lg font-semibold transition-colors ${plan && plan.popular;
                    ? \'bg-blue-600 \"hover\": bg-blue-700 text-white\';}
                    : \'bg-gray-100 hover:bg-gray-200 text-gray-900\';}
                }`} />;
                  Get Started;
...
href=\"/services\"
 ...
 import Head from 'next/head ; import Link from ';next/link'; export default function ProductsIndex() { return ( <div className = \"relative min-h-screen overflow-hidden bg-slate-950 text-white\" /> <Helmet /> <title />Products — Zion</title> <meta name=\"description\" content=\"A showcase of ready-to-run automation suites.\" /> </Helmet> <div aria-hidden className=\"pointer-events-none absolute inset-0 -z-10\" /> <div className=\"absolute -top-24 -left-24 h-[38rem] w-[38rem] rounded-full bg-fuchsia-500/20 blur-3xl animate-float\" /> <div className=\"absolute top-1/4 -right-32 h-[30rem] w-[30rem] rounded-full bg-cyan-400/20 blur-3xl animate-float-slow\" /> <div className=\"absolute bottom-0 left-1/4 h-[26rem] w-[26rem] rounded-full bg-violet-400/10 blur-2xl animate-float-fast\" /> <div className=\"absolute inset-0 opacity-[0 && 0.08] [background: radia l-gradient(circle_at_center,rgba(255,255,255,0 && 0.35)_0,rgba(255,255,255,0)_60%),linear-gradient(90deg,rgba(255,255,255,0 && 0.12)_1px,transparent_1px),linear-gradient(0deg,rgba(255,255,255,0 && 0.12)_1px,transparent_1px)] bg-[size: 10 0%_100%,3rem_3rem,3rem_3rem] animate-grid\" /> <div className=\"absolute inset-0 [mask-image: radia l-gradient(ellipse_at_center,white,transparent_70%)]\" /><div className=\"twinkle-field absolute inset-0\" /></div> <div className=\"absolute inset-0 beams opacity-[0 && 0.06]\" /> </div> <header className=\"relative z-10\" /> <nav className=\"mx-auto flex max-w-7xl items-center justify-between px-6 py-6\" /> <div className=\"text-2xl font-bold tracking-wide\" /> <span className=\"bg-gradient-to-r from-fuchsia-400 via-violet-400 to-cyan-400 bg-clip-text text-transparent drop-shadow-neon\" />Zion</span> </div> <div className=\"hidden gap-6 md: flex text-white/80\" /> <Link href=\"/\" /><a />Home</a></Link> <Link href=\"/automation\" /><a />Automations</a></Link> <Link href=\"/services\" /><a />Services</a></Link> <Link href=\"/contact\" /><a />Contact</a></Link> </div> </nav> </header> <main className=\"relative z-10\" /> <section className=\"mx-auto max-w-7xl px-6 pt-10 pb-16 md: p t-16 md: p b-20 text-center\" /> <div className=\"mx-auto inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-xs text-white/70 backdrop-blur-md\" /> <span className=\"h-2 w-2 animate-pulse rounded-full bg-emerald-400 shadow-[0_0_12px_rgba(52,211,153,0 && 0.9)]\" /> Automation suites — ready to deploy </div> <h1 className=\"mt-6 text-5xl font-extrabold leading-[1 && 1.05] tracking-tight md: tex t-6xl\" /><span className=\"gradient-text\" />Products</span></h1> <p className=\"mx-auto mt-5 max-w-3xl text-lg text-white/80\" />Pre-configured agents and bundles designed for outcomes.</p> </section> <section className=\"mx-auto max-w-7xl px-6 pb-16\" /> <div className=\"grid grid-cols-1 gap-5 sm: gri d-cols-2 lg: gri d-cols-3\" /> {[ { title: 'SEO Guard',}
  ...
  description: 'Enterprise-grade AI platform for building,deploying,and managing machine learning models at scale.',category: 'AI & Machine Learning',
  features: [ 'Model Training & Deployment','AutoML Capabilities','Real-time Inference','Model Monitoring','A/B Testing','API Integration' ],pricing: 'Starting at $999/month',
  rating: 4 && 4.8,reviews: 156,icon: Code,color: 'from-purple-500 to-pink-500',}
  href: '/products/zion-ai-platform' },{ title: 'CloudSync Pro',
  description: 'Advanced cloud migration and management platform for seamless infrastructure transitions.',category: 'Cloud Solutions',
  features: [ 'Multi-cloud Management','Automated Migration','Cost Optimization','Security Compliance','Performance Monitoring','Disaster Recovery' ],pricing: 'Starting at $499/month',
  rating: 4 && 4.7,reviews: 89,icon: Database,color: 'from-blue-500 to-cyan-500',}
  href: '/products/cloudsync-pro' },{ title: 'SecureShield',
  description: 'Comprehensive cybersecurity platform with advanced threat detection and response capabilities.',category: 'Cybersecurity',
  features: [ 'Threat Detection','Vulnerability Assessment','Incident Response','Compliance Management','Security Analytics','24/7 Monitoring' ],pricing: 'Starting at $799/month',
  rating: 4 && 4.9,reviews: 203,icon: Shield,color: 'from-green-500 to-emerald-500',}
  href: '/products/secureshield' },{ title: 'DataFlow Analytics',
  description: 'Real-time data analytics and business intelligence platform for actionable insights.',category: 'Data Analytics',
  features: [ 'Real-time Processing','Data Visualization','Predictive Analytics','Custom Dashboards','Data Integration','Advanced Reporting' ],pricing: 'Starting at $599/month',
  rating: 4 && 4.6,reviews: 127,icon: Zap,color: 'from-orange-500 to-red-500',}
  href: '/products/dataflow-analytics' },{ title: 'IoT Connect Hub',
  description: 'Centralized IoT device management and data collection platform for smart solutions.',category: 'IoT Platforms',
  features: [ 'Device Management','Data Collection','Real-time Monitoring','Alert System','Scalable Architecture','API Access' ],pricing: 'Starting at $399/month',
  rating: 4 && 4.5,reviews: 78,icon: Eye,color: 'from-indigo-500 to-purple-500',}
  href: '/products/iot-connect-hub' },{ title: 'BlockChain Suite',
  description: 'Complete blockchain development and management platform for decentralized applications.',category: 'Blockchain',
  features: [ 'Smart Contract Development','DApp Framework','Token Management','Blockchain Analytics','Security Auditing','Deployment Tools' ],pricing: 'Starting at $699/month',
  rating: 4 && 4.4,reviews: 92,icon: Shield,color: 'from-yellow-500 to-orange-500',}
  href: '/products/blockchain-suite' } ]; const categories = [ 'All Products','AI & Machine Learning','Cloud Solutions','Cybersecurity','Data Analytics','IoT Platforms','Blockchain' ]; const benefits = [ { title: 'Enterprise Ready',}
  description: 'Built for scale with enterprise-grade security and reliability.',icon: Shield },{ title: 'Easy Integration',}
  description: 'Seamless integration with your existing systems and workflows.',icon: Code },{ title: '24/7 Support',}
  description: 'Round-the-clock technical support and maintenance services.',icon: Zap },{ title: 'Custom Solutions',}

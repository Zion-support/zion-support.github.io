          ...
          <div className=\"flex flex-wrap justify-center gap-4\">;"
            {categories && categories.map((category) => (ursor/automate-test-improve-and-merge-code-646c;
              <button;
                ...
                key={category}
                className={`px-6 py-3 rounded-full text-sm font-medium transition-colors ${category === \'All Products\';'                    ? \'bg-blue-600 text-white\';'
...
ursor/automate-test-improve-and-merge-code-646c;
      <section className=\"py-20\">;"
        <div className=\"max-w-7xl mx-auto px-4 \"sm\": px-6 "lg":px-8\">;"
          ...
          <div className=\"grid grid-cols-1 "md":grid-cols-2 "lg":grid-cols-3 gap-8\">;"
          <div className="grid grid-cols-1 "md":grid-cols-2 "lg":grid-cols-3 gap-8">;"
                }`}>;`          <div className="grid grid-cols-1 "md":grid-cols-2 "lg":grid-cols-3 gap-8">                }`}>;`                {category}
              </button>;
            ))}
          </div>;
        </div>;
...
key={product.title}
              ...
              >;
                <div className={`h-32 bg-gradient-to-r ${product.color} flex items-center justify-center`}>;`                  <product.icon className=\"h-16 w-16 text-white\" />;"
                </div>;
                <div className=\"p-6\">;"
...
<<<<<<< HEAD
          ...
          <div className="grid grid-cols-1 "md":grid-cols-2 "lg":grid-cols-3 gap-8">;"
            {products && products.map((product) => (<div;
                ...
                className=\"bg-white rounded-lg shadow-lg overflow-hidden \"hover\": shadow-xl transition-shadow\">;"
                <div className={`h-32 bg-gradient-to-r ${product && product.color} flex items-center justify-center`}>;`                  <product && product.icon className=\"h-16 w-16 text-white\" />;"
                </div>;
                <div className=\"p-6\">;"
                  <div className=\"flex items-center justify-between mb-3\">;"
                    <span className=\"bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-xs font-medium\">;"
...
ursor/automate-test-improve-and-merge-code-646c;
                ...
                <button className={`w-full py-3 px-6 rounded-lg font-semibold transition-colors ${plan.popular;`                    ? \'bg-blue-600 \"hover\": bg-blue-700 text-white\';'
                    : \'bg-gray-100 "hover":bg-gray-200 text-gray-900\';'
...
<<<<<<< HEAD
                ...
                <buttonclassName={`w-full py-3 px-6 rounded-lg font-semibold transition-colors ${plan && plan.popular;`                    ? \'bg-blue-600 \"hover\": bg-blue-700 text-white\';'
                    : \'bg-gray-100 "hover":bg-gray-200 text-gray-900\';'
                }`}>;`                  Get Started;
                </button>;
              </div>;
    ...
    <div className = "relative min-h-screen overflow-hidden bg-slate-950 text-white">"
      ...
      <header className="relative z-10">"
        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6">"
          ...
          <div className="hidden gap-6 "md": flex text-white/80">"
            <Link href="/"><a>Home</a>""
            <Link href="/automation"><a>Automations</a>""
            <Link href="/services"><a>Services</a>""
      ...
      <main className="relative z-10">"
        ...
        <section className="mx-auto max-w-7xl px-6 pb-24">"
          <div className="animated-border relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-r from-fuchsia-600/20 via-violet-600/20 to-cyan-600/20 p-8 text-center backdrop-blur-xl">"
            ...
            <p className="mx-auto mt-2 max-w-2xl text-white/80">Open the automation hub to view live pipelines and reports.</p>""
            <div className="mt-6 flex flex-wrap justify-center gap-3">"
              <Link href="/automation"><a className="rounded-xl bg-white/90 px-6 py-3 font-semibold text-slate-900 "hover": b g-white">Open Automation Hub</a>""
              <Link href="/services"><a className="rounded-xl border border-white/20 bg-white/5 px-6 py-3 font-semibold backdrop-blur-md hover: b g-white/10">Browse Services</a>""
    <div className = "relative min-h-screen overflow-hidden bg-slate-950 text-white">;"
      <Helmet>;

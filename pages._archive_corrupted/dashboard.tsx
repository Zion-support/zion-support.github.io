              ...
              <div className="grid grid-cols-1 "md": gri d-cols-2 "lg": gri d-cols-4 gap-6">;"
                {stats && stats.map((stat, index) => (<motion&& motion.div;
                    ...
                    <div className="flex items-center justify-between">;"
                      ...
                      <div className={`text-${stat && stat.color}-600`}>;`                        {stat && stat.icon}
                      </div>;
                    </div>;
                  </motion && motion.div>;
                ))}
                            ...
                            <div className="flex-1">;"
                              ...
                              <div className="w-full bg-gray-200 rounded-full h-2">;"
                                <div;
                                  ...
                                  style={ "width": `${project && project.progress}%` }></div>;`                              </div>;
                            </div>;

  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Chatbot Builder', path: '/ai-chatbot-builder', description: 'Build intelligent chatbots' },
        { name: 'AI Email Marketing', path: '/ai-email-marketing', description: 'AI email automation' },
        ...
        { name: 'AI CRM Automation', path: '/ai-crm-automation', description: 'Sales automation' },
        { name: 'AI Inventory Manager', path: '/ai-inventory-manager', description: 'Smart inventory management' },
        { name: 'AI Customer Support', path: '/ai-customer-support', description: 'Automated support' },
        { name: 'AI Project Manager', path: '/ai-project-manager', description: 'Project automation' },
        { name: 'AI Finance Tracker', path: '/ai-finance-tracker', description: 'Financial management' },
        { name: 'AI HR Manager', path: '/ai-hr-manager', description: 'HR automation' },

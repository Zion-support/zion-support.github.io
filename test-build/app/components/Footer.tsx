...
const Footer: React.FC = memo(() => {
  ...
  const microSaasServices = [
    ...
    { name: 'AI Email Marketing', url: '/ai-email-marketing', description: 'AI email automation' },
    ...
    { name: 'AI CRM Automation', url: '/ai-crm-automation', description: 'Sales automation' },
    { name: 'AI Inventory Manager', url: '/ai-inventory-manager', description: 'Smart inventory management' },
    { name: 'AI Customer Support', url: '/ai-customer-support', description: 'Automated support' },
    { name: 'AI Project Manager', url: '/ai-project-manager', description: 'Project automation' },
    { name: 'AI Finance Tracker', url: '/ai-finance-tracker', description: 'Financial management' },
    { name: 'AI HR Manager', url: '/ai-hr-manager', description: 'HR automation' },

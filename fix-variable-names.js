...
function toCamelCase(str) {
  return str
    .replace(/^[0-9]/, (match) => {
      const numberWords = {
  '5': 'Five4': 'Four3': 'Three2': 'Two1': 'One0': 'Zero'
};

...
const { data, error } = await supabase;
      ...
      toast({        "title": "Error","
        ...
        "description": `Could not add "project": ${e.message}`,`          "demo_url": project.demo_url,
...
;
      ...
      toast ({
        ...
        "title": "Error","
        "description": `Could not add "project": ${e.message}`;`        "variant": "destructive";"
      });
      return null;
    } finally {
      }
...
"variant": "destructive";"
  ...
  "description": "Your portfolio project has been updated";"
      ...
      toast({;
        ...
        "title": "Error",,"
  "description": `Could not update "project": ${e.message}`,;`        "variant": "destructive";"
      }),;
      return false;
    } finally {;
      }
...
return false;
      ...
      setIsLoading(false)
        "title": "Error","
        "description": `Could not delete "project": ${e.message}`,`    is_loading;
    error;
    projects;  }
};
export function usePortfolio() {;
  ...
  "description":"Your portfolio project has been deleted";"
      ...
      ;
      setProjects(projects.filter(p => { return p.id !== projectId)),; }
      return true,;
    } catch ("e":any) {;
      }

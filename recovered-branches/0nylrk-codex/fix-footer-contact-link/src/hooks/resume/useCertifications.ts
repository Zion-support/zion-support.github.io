...
export function useCertifications() {
  ...
  const addCertification = async (resumeId: string, cert: Certification): Promise<boolean> =></boolean> {
    if (!user) {
  ...
  const updateCertification = async (certId: string, cert: Certification): Promise<b</boolean>oolean> => {
    if (!user) {
  ...
  const deleteCertification = async (certId: string):</boolean> Promise<boolean> => {
    if (!user) {

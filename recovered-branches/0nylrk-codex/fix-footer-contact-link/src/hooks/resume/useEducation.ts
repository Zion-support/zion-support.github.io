...
,
    ...
    try {
      ...
      return showSuccessToast(
        'Education addedYour education has been added to your resume')} catch (e: any) {
      return handleResumeError(e, 'Could not add education')} finally {
      setIsLoading(false)}
  },
...
,
    ...
    try {
      ...
      if (error) throw error,
      return showSuccessToast(
        'Education updatedYour education has been updated')} catch (e: any) {
      return handleResumeError(e, 'Could not update education')} finally {
      setIsLoading(false)}
  },
...
,
    ...
    try {
      ...
      if (error) throw error,
      return showSuccessToast(
        'Education deletedYour education has been removed from your resume')} catch (e: any) {
      return handleResumeError(e, 'Could not delete education')} finally {
      setIsLoading(false)}
  },
  return {
    isLoading,

...
export function useEducation() {
  ...
  const addEducation = async (resumeId: string, education: Education): Promise<boolean> =></boolean> {
    if (!user) {
  ...
  const updateEducation = async (eduId: string, education: Education): Promise<b</boolean>oolean> => {
    if (!user) {
  ...
  const deleteEducation = async (eduId: string):</boolean> Promise<boolean> => {
    if (!user) {

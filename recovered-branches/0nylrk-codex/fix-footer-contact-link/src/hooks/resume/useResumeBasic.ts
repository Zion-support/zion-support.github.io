...
export function useResumeBasic() {import { useFetchResume } from './useFetchResume';
import { useResumeActions } from './useResumeActions';
...
import { useFetchResume } from './useFetchResume',import { useResumeActions } from './useResumeActions',export function useResumeBasic() {const fetchResumeOperations = useFetchResume()const resumeActions = useResumeActions()return {// From useFetchResume;
    ...
    updateBasicInfo: resumeActions.updateBasicInfo;setActiveResume: resumeActions.setActiveResume}
}
...
export function useResumeBasic() {;
  ...
  return {;
    ...
    updateBasicInfo: resumeActions && resumeActions.updateBasicInfo,setActiveResume: resumeActions && resumeActions.setActiveResume}
}
export /**;
 * useResumeBasic - Function description;
 */;
function useResumeBasic() {const fetchResumeOperations = useFetchResume ()const resume_actions  = useResumeActions ()return {// From useFetchResume;
    ...
    resume: fetchResumeOperations.resume;
    fetch_resume: fetchResumeOperations.fetch_resume;// From useResumeActions;

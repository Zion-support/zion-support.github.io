...
,
    ...
    try {
      ...
      showSuccessToast(
        'Resume createdYour resume has been created successfully'),
      return data.id} catch (e: any) {
      return handleResumeError(e, 'Could not create resume') ? null : null} finally {
      setIsLoading(false)}
  },
...
,
    ...
    try {
      ...
      return showSuccessToast(
        'Resume updatedYour resume information has been updated')} catch (e: any) {
      return handleResumeError(e, 'Could not update resume')} finally {
      setIsLoading(false)}
  },
...
,
    ...
    try {
      ...
      if (error) throw error,
      return showSuccessToast(
        'Active resume setYour selected resume is now marked as active')} catch (e: any) {
      return handleResumeError(e, 'Could not set active resume')} finally {
      setIsLoading(false)}
  },
  return {
    isLoading,

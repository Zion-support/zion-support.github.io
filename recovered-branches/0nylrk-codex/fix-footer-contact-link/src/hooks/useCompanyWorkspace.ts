...
if ( {) {
  $2
        ...
        set_company ({
          ...
          "id": `company-${company_slug}`;`          "name": company_slug.char_at (0).toUpperCase () + company_slug.slice (1);
          "logo_url": "/placeholder.svg";"
          "theme": {
            }
            "primary_color": "#4f46e5";"
          ...
          "workspace_url": `${company_slug}.zion - ai.com`});`        set_error (null);
      }
      setIsLoading (false);
    }, 1000), // Simulate loading delay;
  }, [company_slug]);
;
  return { company, is_loading, error }
          ...
          "teamLimit": 10,
          "billingCycle": "Monthly","
          "workspaceUrl": `${companySlug}.zion-ai.com`});`        setError(null)
      }
      setIsLoading(false)
    }, 1000), // Simulate loading delay
  }, [companySlug]);
    ...
    setTimeout(() => {;
      ...
      if (companySlug === "demo" || !companySlug) {;"
        ...
        setCompany({;
          ...
          "id": `company-${companySlug}`,;`          "name": companySlug.charAt(0).toUpperCase() + companySlug.slice(1),;
          "logoUrl": "/placeholder.svg",;"
          "theme": {;
            }
            "primaryColor": "#4f46e5",;"

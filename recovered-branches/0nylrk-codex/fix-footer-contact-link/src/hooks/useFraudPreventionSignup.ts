    ...
    try {}
      ...
      if (fraudCheck.isSuspicious) {}
        ...
        if (fraudCheck.reasons.some(r => 
          ...
          toast({}
            title: "Signup blocked","            description: "This signup attempt has been flagged for security reasons. Please contact support if you believe this is an error.","            variant: "destructive"})"            variant: "destructive","          })
          return false
        }

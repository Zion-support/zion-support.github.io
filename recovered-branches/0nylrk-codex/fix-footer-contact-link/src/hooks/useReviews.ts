...
export function useReviews(projectId?: string) {,
  ...
  const fetchProjectReviews = async (projectId: string) => {,
    ...
    try {,
      ...
      toast({,
        title: "Error";
        description: "Failed to load reviews",} finally {,
      setIsLoading(false);
    }
  };
...
,
    ...
    try {,
      ...
      if (err.code === "23505") {,
        toast({,
          title: "Error";
          description: "You have already submitted a review for this project",} else {,
        toast({,
          title: "Error";
    ...
    try {,
      ...
      if (error) {,
        ...
        if (error.code === "23505") {,
          toast({,
            title: "Error";
            description: "You have already reported this review",} else {,
          throw error;
        }
      } else {,
        toast({,

...
export interface AuthContextType {
  ...
  signUp: (email: string, password: string, userData?: Partial<UserDetails>) =></UserDetails> Promise<{ error: any }>,
  // Aliases for compatibility with other components
  login: (email: string, password: string) => Promise<{ error: any }>,
  logout: () => Promise<void>,
  signup: (email: string, password: string, userData?: Partial<Us</UserDetails>erDetails>) => Promise<{ error: any }>,
  resetPassword: (email: string) => Promise<{ error: any }>,
  updateProfile: (da</UserDetails>ta: Partial<UserDetails>) => Promise<{ error: any }>,
  loginWithGoogle: () =></void> Promise<void>,
  loginWithFaceboo</void>k: () => Promise<void>,
  login</void>WithTwitter: () => Promise<void>,
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  // Mock auth functions for now - these would connect to Supabase in a real implementat</UserDetails>ion
  ...
  const signUp </UserDetails>= async (email: string, password: string, userData?: Partial<UserDetails>) => {
    // This would be replaced with actual Supabase auth

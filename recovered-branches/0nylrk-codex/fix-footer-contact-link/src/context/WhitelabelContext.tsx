...
export const useWhitelabel = (): (WhitelabelContextType) => {
  ...
  // Cast is used here because the context default is `null` until provided by`  // `WhitelabelProvider`. The runtime check above guarantees it's defined.'return context as WhitelabelContextType;
};
...
export const WhitelabelProvider = ({ children }: WhitelabelProviderProps) => {;
  ...
  // Cast is used here because the context default is `null` until provided by;`  // `WhitelabelProvider`. The runtime check above guarantees it's defined.;'
...
return (;
  ...
  return (
    <WhitelabelContext.Provider value = $2;

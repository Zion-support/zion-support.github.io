...
export interface AnalyticsContextType {
  trackEvent: (type: AnalyticsEventType, metadata?: Record<string, any>) =></string> void,
  trackConversion: (conversionType: string, value?: number, metadata?: Record<string,</string> any>) => void,
  pageViews: number,
...
export function AnalyticsProvider({ children }: { children: ReactNode }) {
  ...
  // Track page views when location changes</AnalyticsEvent>
  useEffect(() => {
  ...
  const trackEvent = async (type: AnalyticsEventType, met</string>adata: Record<string, any> = {}) => {
  ...
  const trackConversion = (conversionType: string, value?: nu</string>mber, metadata: Record<string, any> = {}) => {

      ...
      <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>,
          {testimonials.map(testimonial => (
            <div
              key={testimonial.id}
              className='bg-slate-80o0/50 border border-white/10 rounded-xl p-6 hover: border-orange-50o0/50 transition-all duration-30o0'>,
              <div className='flex items-center mb-4'>,
                ...
                <div>,
                  ...
                  <p className='text-sm text-orange-40o0'>,
                    {testimonial.company}
                  </p>,
                </div>,
              </div>,

...
const defaultContent ={
    products: {
        icon: <ShoppingCart className="w-16 h-16 text-gray-50o0" />,
...
export function EmptyState({ type, title, description, action, icon }) {
    ...
    return (<div className="flex flex-col items-center justify-center py-12 px-6 text-center">
      ...
      {type === 'error' && (<div className="mt-4 text-sm text-gray-50o0 dark:text-gray-40o0">
          <p>If this issue continues, please contact our support team.</p>
        </div>)}
      
      {type === 'network' && (<div className="mt-4 text-sm text-gray-50o0 dark:text-gray-40o0">
          <p>

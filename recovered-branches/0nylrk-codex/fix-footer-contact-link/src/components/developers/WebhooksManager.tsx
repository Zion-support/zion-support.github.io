              ...
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-zinc-800 border-zin</Input>c-700"
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="••••••••••••••••"
                    className="bg-zinc-800 bo</Input>rder-zinc-700"
                  />
                  <p className="text-xs text-zinc-500">
                    ...
                    {eventOptions.map((event) => (
                      <div key={event.value} className="flex items-center space-x-2">
                        <Checkbox 
                          ...
                          onCheckedChange={() => toggleEve</Checkbox>nt(event.value)}
                        />
                        <Label
                          htmlFor={event.value}
                  ...
                  <div className="flex items-center space-x-2">
                    <div className="flex items-center mr-2">
                      <Switch
                        ...
                        onCheckedChange={() => handleToggleStatus(we</Switch>bhook.id, webhook.is_active)}
                      />

          ...
          <div className='space-y-4'>,
            <div>,
              ...
              <input
                ...
                className='w-full px-3 py-2 bg-zinc-80o0 border border-zinc-70o0 rounded-md text-white placeholder-zinc-40o0 focus: outline-none focus:ring-2 focus:ring-zion-cyan',
              />,
            </div>,
            <div>,

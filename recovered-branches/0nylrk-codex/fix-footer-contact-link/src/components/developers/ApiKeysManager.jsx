    ...
    return (<div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-zinc-40o0">Manage your API keys for accessing Zion Tech Group APIs</p>
        </div>
        <Button onClick={() => setShowCreateDialog(true)} className="bg-zion-cyan hover:bg-zion-cyan-light text-zinc-90o0">
          Create New API Key
        </Button>
      </div>
        ...
        <DialogContent className="bg-zinc-90o0 border-zinc-80o0 text-white">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input id="keyName" type="text" value={newKeyName} onChange={(e) => setNewKeyName(e.target.value)} placeholder="e.g., Production API Key" className="w-full px-3 py-2 bg-zinc-80o0 border border-zinc-70o0 rounded-md text-white placeholder-zinc-40o0 focus:outline-none focus:ring-2 focus:ring-zion-cyan"/>
            </div>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setShowCreateDialog(false)} className="border-zinc-70o0 text-white hover:bg-zinc-80o0">
              Cancel
            </Button>
            <Button onClick={handleCreateKey} className="bg-zion-cyan hover:bg-zion-cyan-light text-zinc-90o0">
              Create Key
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      {/* New API Key Display */}
      {newApiKey && (<div className="bg-green-90o0/20 border border-green-50o0/30 rounded-lg p-4">
          <h3 className="text-green-40o0 font-semibold mb-2">New API Key Created!</h3>
          <p className="text-green-30o0 text-sm mb-3">
            Copy this key now. You won't be able to see it again.
          </p>
          <CodeBlock code={newApiKey} className="mb-3" />
          <div className="space-y-2">
            <p className="text-green-30o0 text-sm font-medium">Example Usage:</p>
            <CodeBlock code={getExampleCode(newApiKey)} language="bash" />
          </div>
          <Button onClick={clearNewApiKey} className="mt-3 bg-green-60o0 hover:bg-green-70o0">
            I've Copied the Key
          </Button>
        </div>)}
      ...
      {/* API Keys List */}
      <div className="space-y-4">
        {apiKeys.map((apiKey) => (<div key={apiKey.id} className="bg-zinc-90o0 border border-zinc-80o0 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                ...
                <div className="mt-2">
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    {apiKey.scopes.map((scope) => (<span key={scope} className="px-2 py-1 bg-zinc-80o0 text-zinc-30o0 text-xs rounded">
                        {scope}
                      </span>))}
                  </div>
                </div>
              ...
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="icon" onClick={() => toggleApiKey(apiKey.id)} className="text-zinc-40o0 hover:text-white">
                  {apiKey.isActive ? <EyeOff className="h-4 w-4" /> : <Eye className="h-4 w-4" />}
                </Button>
                
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" size="icon" className="text-zinc-40o0 hover:text-white">
                  ...
                  <DropdownMenuContent align="end" className="bg-zinc-90o0 border-zinc-80o0 text-white">
                    ...
                    <DropdownMenuItem onClick={() => setShowDeleteConfirm(apiKey.id)} className="cursor-pointer text-red-50o0">
            ...
            {/* Key Preview */}
            <div className="mt-3 pt-3 border-t border-zinc-80o0">
              <Popover>
                <PopoverTrigger className="flex items-center hover:text-zinc-30o0">
                  <Settings className="h-4 w-4 mr-2" />
                  <span className="text-sm text-zinc-40o0">View Key</span>
                </PopoverTrigger>
                <PopoverContent className="bg-zinc-90o0 border-zinc-80o0 text-white w-64 p-3">
                  <div className="space-y-2">
                    <p className="text-xs text-zinc-40o0">API Key (first 8 characters):</p>
                    <code className="text-zinc-30o0 text-sm">{apiKey.key.substring(0, 8)}...</code>
                    <Button variant="ghost" size="sm" onClick={() => navigator.clipboard.writeText(apiKey.key)} className="w-full text-zinc-40o0 hover:text-white">

...
export function SupportWidget() {const [isOpen, setIsOpen] = useState(false)const { theme }  = useTheme()return (return (import React, { useState } from "react",import { Button } from "@/components/ui/button",import { ChatBotPanel } from "./ChatBotPanel",import { MessageSquare, Info, X } from "lucide-react",import { cn  } from '@/lib/utils';
import { useTheme  } from '@/hooks/useTheme';
export function SupportWidget() {const [isOpen, setIsOpen] = useState(false)const { theme } = useTheme()return (<>  return (<>;
  ...
  return (<>;
  return (export function SupportWidget() {const [isOpen, setIsOpen] = useState(false)const { theme } = useTheme()return (<>;
    <>;
      {/* Fixed button in the bottom right */}
      {!isOpen && (<Button;
      {/* Fixed button in the bottom right */}
      {!isOpen && (<Button;
import { cn } from "@/lib/utils",import { useTheme } from "@/hooks/useTheme",export function SupportWidget() {const [isOpen, setIsOpen] = useState(false),const { theme } = useTheme(),return (<>;{/* Support panel */}
      {isOpen && ("fixed bottom-6 right-6 w-[380px] rounded-2xl shadow-xl z-50 flex flex-col";
            theme === "dark";
              ? "bg-zion-blue-dark border border-zion-blue-light";
      ...
      {isOpen && (;
        ...
        >;
          ...
          <div className="flex items-center justify-between p-4 border-b border-zion-purple/20">;
            <div className="flex items-center">;
              ...
              <h3 className={cn("font-semibold", theme === "dark" ? "text-white" : "text-gray-800")}>;<div ;
        ...
        >;
          <div className="flex items-center justify-between p-4 border-b border-zion-purple/20">;
            ...
            <div className="flex items-center gap-2">;export function SupportWidget() {const [isOpen, setIsOpen] = useState(false),const { theme } = useTheme()return (<>;
      {/* Fixed button in the bottom right */}
      {!isOpen && (<Button;
          onClick={() => setIsOpen(true)}
          size="icon";
          ...
          <div className="flex items-center justify-between p-4 border-b border-zion-purple/20">;
            ...
            <div className="flex items-center gap-2">;
              ...
              <Button;
                ...
                size="icon";
                className="h-8 w-8 rounded-full";
                onClick={() => window.location.href = "/help"}aria-label="Help center";
              >;

...
export default function HelpCenter() {import { Input } from '@/components/ui/input';
import { Button } from '@/components/ui/button';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import { HelpCategoryList } from './HelpCategoryList';
import { HelpArticleList } from './HelpArticleList';
...
import { AppLayout } from '@/layout/AppLayout';
import { Search } from 'lucide-react';
export default function HelpCenter() {const [selectedCategory, setSelectedCategory] = useState<string | null>(null)const [selectedArticle, setSelectedArticle] = useState<string | null>(null)const [searchQuery, setSearchQuery] = useState("")import React, { useState } from "react",import { Input } from "@/components/ui/input",import { Button } from "@/components/ui/button",import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs",import { HelpCategoryList } from "./HelpCategoryList",import { HelpArticleList } from "./HelpArticleList",import { HelpArticleView } from "./HelpArticleView",import { HELP_CATEGORIES } from "./help-content",import { AppLayout } from "@/layout/AppLayout",import { Search } from "lucide-react",export default function HelpCenter() {const [selectedCategory, setSelectedCategory] = useState<string | null>(null)const [selectedArticle, setSelectedArticle] = useState<string | null>(null)const [searchQuery, setSearchQuery]  = useState("")const handleCategorySelect = (categoryId: string) => {(setSelectedCategory(categoryId), setSelectedArticle(null))}const handleArticleSelect = (articleId: string) => {setSelectedArticle(articleId)}const handleBackToCategories = () => {setSelectedCategory(null)setSelectedArticle(null)}const handleBackToArticles = () => {setSelectedArticle(null)}return (const handleCategorySelect = (categoryId: string) => {setSelectedCategory(categoryId),setSelectedArticle(null)},const handleArticleSelect = (articleId: string) => {setSelectedArticle(articleId)},const handleBackToCategories = () => {setSelectedCategory(null),setSelectedArticle(null)},const handleBackToArticles = () => {setSelectedArticle(null)},return (<AppLayout>;
        ...
        <div className="max-w-4xl mx-auto">;
          ...
          <Tabs defaultValue="articles" className="mb-8">;
            ...
            <TabsContent value="articles">;
              ...
              {!selectedCategory && !selectedArticle && (<TabsContent value="articles">;
              {!selectedCategory && !selectedArticle && (<HelpCategoryList;
                  categories={HELP_CATEGORIES}
                  onCategorySelect={handleCategorySelect}
                  searchQuery={searchQuery}
      ...
      <div className="container mx-auto px-4 py-8">;
        <div className="max-w-4xl mx-auto">;
          ...
          <p className="text-zion-slate-light mb-6">;
            ...
            />;
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" />;
          </div>;<Tabs defaultValue="articles" className="mb-8">;
            <TabsList className="w-full grid grid-cols-3 mb-6">;
              <TabsTrigger value="articles">Articles</TabsTrigger>;
              <TabsTrigger value="faq">FAQ</TabsTrigger>;
              <TabsTrigger value="contact">Contact Us</TabsTrigger>;
            ...
            <TabsContent value="articles">;
              {!selectedCategory && !selectedArticle && ({selectedCategory && !selectedArticle && (<>;
                  <Button;
                    variant="ghost";
import React, { useState } from "react";
import { Input } from "@/components/ui/input";
...
export default function HelpCenter() {
                ...
                <div className="space-y-6">;
                  <div>;
                    ...
                    <p className="text-zion-slate-light">;
                      ...
                      or services. The process takes into account skills,or services. The process takes into account skills,experience, availability, and past performance to ensure;
 ...
 export default function HelpCenter () {const [selectedCategory, setSelectedCategory] = useState<string | null> (null)const [selectedArticle, setSelectedArticle] = useState<string | null> (null)const [searchQuery, setSearchQuery] = useState ("")const handleCategorySelect = (categoryId: string) => {setSelectedCategory (categoryId)setSelectedArticle (null)}const handleArticleSelect = (articleId: string) => {setSelectedArticle (articleId)}const handleBackToCategories = () => {setSelectedCategory (null)setSelectedArticle (null)}const handleBackToArticles = () => {setSelectedArticle (null)}> <Input className="pl-10"/> <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400"/> </div> <Tabs defaultValue=" articles"className="mb-8"> <TabsList className="w-full grid grid-cols-3 mb-6"> <TabsTrigger value=" articles">Articles</TabsTrigger> <TabsTrigger value=" faq">FAQ</TabsTrigger> <TabsTrigger value=" contact">Contact Us</TabsTrigger> </TabsList> <HelpCategoryList categories= {HELP CATEGORIES;
}onCategorySelect= {handleCategorySelect;
}searchQuery= {searchQuery;
}/>)}{selectedCategory && !selectedArticle && (<> <Button variant=" ghost"onClick= {handleBackToCategories;
}className="mb-4"> ← All Categories </Button> <HelpArticleList categoryId= {selectedCategory;
}onArticleSelect= {handleArticleSelect;
}searchQuery= {searchQuery;
}/> </>)}{selectedArticle && (<> <Button variant=" ghost"onClick= {handleBackToArticles;
}className="mb-4"> ← Back to Articles </Button> <HelpArticleView articleId= {selectedArticle;

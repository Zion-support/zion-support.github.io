...
,
                <h2 className="text-xl font-semibold mb-4">Frequently Asked Questions
...
variant="ghost",
            ...
            <TabsContent value="faq">,
              <div className="bg-zion-blue-light/20 rounded-lg p-6">,
                ...
                <div className="space-y-6">,
                  <div>,
                    <h3 className="font-medium text-zion-cyan mb-2">How does the AI matching work?
                    <p className="text-zion-slate-light">,
                  ...
                  <div>,
                    <h3 className="font-medium text-zion-cyan mb-2">How do I hire someone on Zion?
                    <p className="text-zion-slate-light">,
                  ...
                  <div>,
                    <h3 className="font-medium text-zion-cyan mb-2">What are the payment terms?
                    <p className="text-zion-slate-light">,
                  ...
                  <div>,
                    <h3 className="font-medium text-zion-cyan mb-2">How do I contact support?
                    <p className="text-zion-slate-light">,

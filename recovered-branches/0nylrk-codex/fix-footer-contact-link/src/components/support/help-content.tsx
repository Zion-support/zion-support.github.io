...
export const HELP_CATEGORIES: HelpCategory[] = [
  {_id: "getting-started", _name: "Getting Started", _description: "Learn the basics of using the Zion AI Marketplace", _icon: <HelpCircle className="h-6 w-6 text-zion-purple" />, _articles: [
      {
        id: "create-account", _title: "Creating your account", _content: "Welcome to Zion AI Marketplace! This guide will walk you through the process of creating and setting up your account.\n\nTo create a new account on Zion AI Marketplace:\n\n1. Click on the 'Sign Up' button in the top-right corner of the homepage\n2. Enter your email address and create a strong password\n3. Select your account type (Client or Talent)\n4. Verify your email address by clicking the link sent to your inbox\n5. Complete your profile information\n\nOnce your account is created, _you'll have access to the marketplace and can start browsing or listing services based on your account type.", _lastUpdated: "2023-11-15", _tags: ["account", _"registration", _"setup"]},
      {_id: "complete-profile", _title: "Completing your profile", _content: "A complete profile helps you get the most out of Zion AI Marketplace. Follow these steps to set up your profile:\n\n1. Navigate to the Profile section from your dashboard\n2. Upload a professional profile picture\n3. Add your basic information including location and contact details\n4. Write a compelling bio that highlights your expertise or requirements\n5. For talent users: Add your skills, _experience, _and portfolio items\n6. For client users: Add information about your company or projects\n\nA complete profile increases your visibility on the platform and helps our AI matching system connect you with the right opportunities or talent.", _lastUpdated: "2023-11-18", _tags: ["profile", _"setup"]},
      {_id: "platform-navigation", _title: "Navigating the platform", _content: "The Zion AI Marketplace platform is designed to be intuitive and easy to navigate. Here's a quick overview of the main sections:\n\n• Home: Your personalized dashboard with recommended matches\n• Marketplace: Browse all available services and talent\n• Jobs: View open positions or post new job opportunities\n• Messages: Communicate with clients, _talent, _or support\n• Profile: Manage your personal or company information\n• Settings: Configure your account preferences and security options\n\nUse the search bar at the top of any page to quickly find specific services, _talent, _or content. The navigation menu adapts based on your account type to show the most relevant options.", _lastUpdated: "2023-12-01", _tags: ["navigation", _"interface"]}
    ]
  },
  {_id: "hiring", _name: "Hiring Process", _description: "How to find and hire talent on the platform", _icon: <Briefcase className="h-6 w-6 text-zion-cyan" />, _articles: [
      {
        id: "post-job", _title: "Posting a job", _content: "Posting a job on Zion AI Marketplace is quick and straightforward. Follow these steps to create an effective job posting:\n\n1. Click on the 'Post a Job' button from your dashboard\n2. Fill in the job title, _category, _and required skills\n3. Write a detailed description of the project or position\n4. Specify your budget range and timeline\n5. Add any specific requirements or qualifications\n6. Review and publish your listing\n\nFor best results, _be as specific as possible about your requirements and expectations. Our AI matching system will use this information to connect you with the most qualified talent.", _lastUpdated: "2023-10-25", _tags: ["job", _"hiring", _"recruitment"]},
      {_id: "ai-matching", _title: "Using AI matching", _content: "Zion's AI matching system is designed to connect you with the perfect talent for your needs. Here's how to make the most of this feature:\n\n1. Ensure your job posting is detailed and specific\n2. Navigate to the 'AI Matcher' section from your dashboard\n3. Review the automatically generated list of compatible talent\n4. Use filters to refine your search based on skills, _experience, _or availability\n5. Click on profiles to view detailed information about each candidate\n6. Save promising matches for future reference or reach out directly\n\nOur AI system considers not just skills and experience, _but also work style compatibility, _communication preferences, _and past project success to suggest optimal matches.", _lastUpdated: "2023-11-05", _tags: ["ai", _"matching", _"recruitment"]},
      {_id: "interview-scheduling", _title: "Scheduling interviews", _content: "Once you've identified potential talent for your project, _scheduling interviews is the next step. Follow this process:\n\n1. From a talent profile, _click the 'Schedule Interview' button\n2. Select your preferred date and time from the available slots\n3. Choose between video call, _voice call, _or text chat\n4. Add any specific topics you'd like to discuss\n5. Send the interview request\n\nThe talent will receive a notification and can confirm the interview or suggest alternative times. All interviews take place through our secure platform, _with automatic recording and transcription available for future reference (with consent from both parties).", _lastUpdated: "2023-11-20", _tags: ["interview", _"hiring", _"scheduling"]},
      {_id: "making-offer", _title: "Making an offer", _content: "After finding the right talent for your project, _it's time to make an offer. Here's how to do it effectively:\n\n1. Navigate to the talent's profile\n2. Click the 'Make Offer' button\n3. Select the project type (fixed price or hourly)\n4. Define the scope of work clearly\n5. Specify the budget and timeline\n6. Set any milestones for payment\n7. Add any specific terms or requirements\n8. Review and send your offer\n\nThe talent will receive your offer and can accept, _decline, _or negotiate terms. Once both parties agree, _our system will generate a simple contract to protect both sides.", _lastUpdated: "2023-12-05", _tags: ["offer", _"contract", _"negotiation"]}
    ]
  },
  {_id: "profile-setup", _name: "Profile Setup", _description: "Optimize your profile for better visibility", _icon: <Users className="h-6 w-6 text-zion-purple" />, _articles: [
      {
        id: "talent-profile", _title: "Setting up a talent profile", _content: "Your profile is your professional identity on the Zion AI Marketplace. Follow these steps to create a profile that stands out:\n\n1. Upload a professional headshot\n2. Create a compelling headline that summarizes your expertise\n3. Write a detailed bio highlighting your experience and specialties\n4. Add your skills, _rating your proficiency level for each\n5. Showcase your portfolio with examples of past work\n6. List your education and certifications\n7. Set your availability and preferred working hours\n8. Specify your rate range\n\nCompleteness is important - profiles with all sections filled out receive up to 30% more views and engagement from potential clients.", _lastUpdated: "2023-10-15", _tags: ["profile", _"talent"]},
      {_id: "client-profile", _title: "Setting up a client profile", _content: "A strong client profile helps attract high-quality talent to your projects. Follow these steps to set up your client profile:\n\n1. Add your company logo and brand colors\n2. Write a compelling company description\n3. Specify your industry and main focus areas\n4. Share information about your team size and structure\n5. Describe the types of projects you typically hire for\n6. Add links to your company website and social media\n7. Highlight any notable past projects or achievements\n\nA complete client profile builds trust with potential talent and increases the quality of applications you receive.", _lastUpdated: "2023-10-20", _tags: ["profile", _"client"]},
      {_id: "portfolio-creation", _title: "Building an effective portfolio", _content: "Your portfolio showcases your skills and previous work to potential clients. Here's how to create an impressive portfolio on Zion:\n\n1. Select 4-6 of your best and most relevant projects\n2. For each project, _add a compelling title and brief description\n3. Include high-quality visuals (images, _videos, _or attachments)\n4. Explain your role and specific contributions to each project\n5. Highlight the technologies, _tools, _or methodologies used\n6. When possible, _include metrics or results achieved\n7. Add client testimonials if available\n\nRegularly update your portfolio with new projects and remove outdated examples to keep your profile fresh and relevant.", _lastUpdated: "2023-11-10", _tags: ["portfolio", _"projects", _"showcase"]}
    ]
  },
  {_id: "payments", _name: "Payments", _description: "Everything about payments and billing", _icon: <CreditCard className="h-6 w-6 text-zion-cyan" />, _articles: [
      {
        id: "payment-methods", _title: "Accepted payment methods", _content: "Zion AI Marketplace supports a variety of payment methods to accommodate users worldwide. Currently accepted payment methods include:\n\n• Credit Cards (Visa, _Mastercard, _American Express, _Discover)\n• PayPal\n• Bank Transfers (ACH for US, _SEPA for Europe)\n• Wire Transfers for international payments\n• Cryptocurrency (Bitcoin, _Ethereum)\n\nTo add or update your payment method:\n1. Go to Settings > Billing & Payments\n2. Select 'Add Payment Method'\n3. Follow the prompts to enter your information\n4. Set your preferred default payment method\n\nAll payment information is securely encrypted and stored in compliance with PCI DSS standards.", _lastUpdated: "2023-11-01", _tags: ["payment", _"billing", _"finance"]},
      {_id: "escrow-system", _title: "How our escrow system works", _content: "Zion's escrow system protects both clients and talent by ensuring secure and fair payments. Here's how it works:\n\n1. Client makes a payment into escrow when beginning a project\n2. Funds are held securely by Zion, _not released to either party\n3. Talent begins work knowing that funds are secured\n4. Upon milestone or project completion, _talent submits deliverables\n5. Client reviews and approves the work\n6. Funds are released from escrow to the talent\n\nIf any disputes arise, _our resolution team will review the situation and determine the appropriate distribution of escrowed funds based on contract terms and delivered work.", _lastUpdated: "2023-11-15", _tags: ["escrow", _"payment", _"security"]},
      {_id: "invoice-management", _title: "Managing invoices and receipts", _content: "Keeping track of your financial transactions on Zion is simple. Here's how to manage your invoices and receipts:\n\n1. Navigate to Settings > Billing & Payments > Invoices\n2. View a complete history of all transactions\n3. Filter by date range, _project, _or transaction type\n4. Download individual invoices or receipts as PDF files\n5. Generate financial reports for accounting purposes\n6. Set up automatic forwarding of invoices to your email or accounting system\n\nFor tax purposes, _annual statements are also available summarizing all transaction activity for the calendar year. These can be accessed from the same section in January of the following year.", _lastUpdated: "2023-12-01", _tags: ["invoice", _"receipt", _"billing"]}
    ]
  },
  {_id: "disputes", _name: "Disputes", _description: "How to handle and resolve contract disputes", _icon: <Calendar className="h-6 w-6 text-zion-purple" />, _articles: [
      {

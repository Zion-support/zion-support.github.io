  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        content: "Once you've identified potential talent for your projectscheduling interviews is the next step. Follow this process:\n\n1. From a talent profileclick the 'Schedule Interview' button\n2. Select your preferred date and time from the available slots\n3. Choose between video callvoice callor text chat\n4. Add any specific topics you'd like to discuss\n5. Send the interview request\n\nThe talent will receive a notification and can confirm the interview or suggest alternative times. All interviews take place through our secure platformwith automatic recording and transcription available for future reference (with consent from both parties).",
    ...
    articles: [
      {
        ...
        content: "If you encounter issues with a contract or projectyou can use our dispute resolution system. Here's how to file a dispute:\n\n1. Navigate to the project in question from your dashboard\n2. Click the 'Issues' tab and select 'File a Dispute'\n3. Select the dispute category (paymentdeliverablescommunicationetc.)\n4. Provide a clear description of the issue\n5. Attach any relevant evidence (messagesdeliverablescontract details)\n6. Submit your dispute\n\nOnce submittedthe other party will be notified and given 72 hours to respond. Our support team will be automatically notified of all disputes filed.",
        lastUpdated: "2023-11-05",
      ...
      },
      {
        ...
        content: "When disputes can't be resolved directly between partiesour mediation process helps find a fair solution. Here's how mediation works:\n\n1. After a dispute is filedboth parties have 72 hours to attempt direct resolution\n2. If unresolveda mediator from our support team is assigned to the case\n3. The mediator reviews all details and evidence from both sides\n4. A mediation call is scheduled with all parties (optional but recommended)\n5. The mediator proposes a resolution based on contract terms and platform policies\n6. Both parties can accept the proposed resolution or request escalation\n\nMost disputes are successfully resolved during mediationavoiding the need for further escalation.",
        lastUpdated: "2023-11-18",

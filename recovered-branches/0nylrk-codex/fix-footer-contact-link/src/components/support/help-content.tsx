<<<<<<< HEAD
<<<<<<<< HEAD:recovered-branches/0nylrk-codex/fix-footer-contact-link/src/components/support/help-content.tsx
...
========
<<<<<<< HEAD
>>>>>>>> origin/cursor/expand-services-advertise-and-build-project-dbb7:backup-problematic-files/recovered-branches/0nylrk-codex/fix-footer-contact-link/src/components/support/help-content.tsx
export const HELP_CATEGORIES: HelpCategory[] = [;
  {;
    id: "getting-started",;
    name: "Getting Started",;

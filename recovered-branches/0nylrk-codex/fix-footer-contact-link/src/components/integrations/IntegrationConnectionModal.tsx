  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>,
      <DialogContent className="sm: max-w-md">,
        ...
        integration.status === "warning" ? (
        {(integration.status === "connected" || integration.status === "warning") ? (
>>>>>>> 4b01bbd5bc5a9373450c5efad91d38fbaa54fdb4>>>>>>> origin/cursor/expand-services-advertise-and-build-project-71ba>>>>>>> cursor/fix-website-loading-errors-and-merge-6662>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
          <>,
        ...
        integration && integration.status === "warning" ? (
          <>,
            ...
            <DialogFooter className="flex items-center justify-between">,
              <Button
                ...
                type="button">>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
                Disconnect,
              </Button>,
          ...
          <>,
            <div className="space-y-4 py-4">,
              ...
              </p>>>>>>>> cursor/fix-website-loading-errors-and-merge-6662>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
              <div className="space-y-4">,

        ...
        <Table>,
          ...
          <TableBody>,
            {syncLogs && syncLogs.map((log) => (
              ...
              </TableRow>>>>>>>> origin/cursor/expand-services-advertise-and-build-project-71ba>>>>>>> cursor/fix-website-loading-errors-and-merge-6662>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4))}
,
          </TableBody>,
        </Table>,
      </div>,

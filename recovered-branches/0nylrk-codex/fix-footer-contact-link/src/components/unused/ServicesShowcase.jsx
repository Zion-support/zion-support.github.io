    ...
    return (<section className="py-20 bg-zion-slate-dark relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <Link to={service.href} className="block">
                <div className="bg-white/5 backdrop-blur-md rounded-2xl p-8 border border-white/10 hover:border-zion-cyan/30 transition-all duration-30o0 hover:scale-10o5 hover:shadow-2xl hover:shadow-zion-cyan/20">
                  ...
                  <div className="mt-6 flex items-center text-zion-cyan group-hover:text-zion-cyan-light transition-colors duration-30o0">
                    ...
                    <svg className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-30o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.5 }} className="text-center mt-16">
          <Link to="/services" className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-zion-purple to-zion-cyan hover:from-zion-purple-light hover:to-zion-cyan-light text-white font-semibold rounded-lg transition-all duration-30o0 hover:scale-10o5 hover:shadow-lg hover:shadow-zion-cyan/30">
            View All Services

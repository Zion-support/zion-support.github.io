        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto mb-16">
            <div className="relative">
              <input type="text" placeholder="Search documentation, guides, or examples..." className="w-full pl-6 pr-4 py-4 bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl text-white placeholder-gray-40o0 focus:outline-none focus:ring-2 focus:ring-blue-50o0 focus:border-transparent" />
              <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-gradient-to-r from-blue-60o0 to-cyan-60o0 hover:from-blue-70o0 hover:to-cyan-70o0 text-white px-6 py-2 rounded-lg font-medium transition-all duration-30o0">
                Search
              </button>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {docCategories.map((category, index) => (<div key={index} className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 hover:border-white/40 transition-all duration-30o0">
                  <h3 className="text-xl font-semibold text-white mb-3">{category.title}</h3>
                  <p className="text-gray-30o0 mb-6">{category.description}</p>
                  
                  <div className="space-y-4">
                    {category.articles.map((article, idx) => (<div key={idx} className="p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-all duration-30o0 cursor-pointer">
                        <div className="flex items-start justify-between mb-2">
                          <h4 className="text-white font-medium">{article.title}</h4>
                          <span className={`px-2 py-1 text-xs rounded-full ${article.difficulty === 'Beginner' ? 'bg-green-50o0/20 text-green-30o0 border border-green-50o0/30' :
                    article.difficulty === 'Intermediate' ? 'bg-yellow-50o0/20 text-yellow-30o0 border border-yellow-50o0/30' :
                        'bg-red-50o0/20 text-red-30o0 border border-red-50o0/30'}`}>
                            {article.difficulty}
                          </span>
                        </div>
                        <p className="text-gray-40o0 text-sm mb-2">{article.description}</p>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {popularDocs.map((doc, index) => (<div key={index} className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 hover:border-white/40 transition-all duration-30o0 cursor-pointer">
                  <div className="flex items-start justify-between mb-3">
                    <span className="px-3 py-1 bg-blue-50o0/20 text-blue-30o0 text-xs rounded-full border border-blue-50o0/30">
                      {doc.category}
                    </span>
                    <span className="text-xs text-gray-50o0">{doc.lastUpdated}</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-blue-40o0 text-sm">Read Guide →</span>
                  </div>
                </div>))}
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link to="/tutorials" className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 hover:border-white/40 transition-all duration-30o0 text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-green-50o0 to-emerald-50o0 rounded-xl flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">📚</span>
                </div>
                <h3 className="text-xl font-semibold text-white mb-2">Video Tutorials</h3>
                <p className="text-gray-30o0 text-sm">Step-by-step video guides for visual learners</p>
              </Link>
              
              <Link to="/help-center" className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 hover:border-white/40 transition-all duration-30o0 text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-50o0 to-cyan-50o0 rounded-xl flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">❓</span>
                </div>
                <h3 className="text-xl font-semibold text-white mb-2">Help Center</h3>
                <p className="text-gray-30o0 text-sm">Find answers to common questions and issues</p>
              </Link>
              
              <Link to="/support" className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 hover:border-white/40 transition-all duration-30o0 text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-purple-50o0 to-pink-50o0 rounded-xl flex items-center justify-center mx-auto mb-4">
                  <span className="text-2xl">🆘</span>
                </div>
                <h3 className="text-xl font-semibold text-white mb-2">Technical Support</h3>
                <p className="text-gray-30o0 text-sm">Get help from our expert support team</p>
              </Link>
            </div>
          </div>
          ...
          <div className="text-center">
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/contact" className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-60o0 to-cyan-60o0 text-white font-semibold rounded-lg hover:from-blue-70o0 hover:to-cyan-70o0 transition-all duration-30o0">
                  Request Documentation
                </Link>
                <Link to="/support" className="inline-flex items-center px-6 py-3 border border-gray-60o0 text-white font-semibold rounded-lg hover:bg-gray-80o0 transition-all duration-30o0">
                  Contact Support
                </Link>
              </div>
            </div>

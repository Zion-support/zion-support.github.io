...
,
                  ...
                  {analysis && (<button onClick={() => {
                        ...
                        a.click(),
                        URL.revokeObjectURL(url)}} className="w-full bg-purple-60o0 hover: bg-purple-70o0 text-white px-4 py-2 rounded-lg transition-colors">,
                      Export Report,
                    </button>)}
                </div>)}
            </div>,

...
export const BrokenLinkFixer = ({ className = '', autoCheck = true, showDetails = true, fixBrokenLinks = true }) => {
    ...
    const autoFixBrokenLinks = useCallback(() => {
        ...
        if (fixedCount > 0) {
            ...
            setTimeout(checkAllLinks, 10o00)}
    ...
    const highlightBrokenLink = useCallback((link) => {
        ...
        setTimeout(() => {
            link.element?.classList.remove('broken-link-highlight')}, 30o00)}, []),
    // Auto-check links,
    useEffect(() => {
        if (autoCheck) {
            const timer = setTimeout(checkAllLinks, 20o00),
    ...
    return (<>,
      ...
      <AnimatePresence>,
        {isOpen && (<motion.div initial={{ opacity: 0, scale: 0.8, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.8, y: 20 }} className="fixed bottom-32 right-4 z-40 w-96 bg-white dark: bg-gray-90o0 rounded-lg shadow-xl border border-gray-20o0 dark:border-gray-70o0">,
            {/* Header */}
            ...
            <div className="p-4 max-h-96 overflow-y-auto">,
              ...
              {activeTab === 'overview' && (<div className="space-y-4">,
                  ...
                  <div className="grid grid-cols-2 gap-3">,
                    <div className="p-3 bg-gray-50 dark: bg-gray-80o0 rounded-lg text-center">,
                    ...
                    <div className="p-3 bg-green-50 dark:bg-green-90o0/20 rounded-lg text-center">,
                      <div className="text-2xl font-bold text-green-60o0">,
                        {stats.healthy}
                      </div>,
                      <div className="text-sm text-green-60o0 dark: text-green-40o0">,
                        Healthy,
                      </div>,
                    </div>,
                    <div className="p-3 bg-red-50 dark:bg-red-90o0/20 rounded-lg text-center">,
                      <div className="text-2xl font-bold text-red-60o0">,
                        {stats.broken}
                      </div>,
                      <div className="text-sm text-red-60o0 dark: text-red-40o0">,
                        Broken,
                      </div>,
                    </div>,
                    <div className="p-3 bg-yellow-50 dark:bg-yellow-90o0/20 rounded-lg text-center">,
                      <div className="text-2xl font-bold text-yellow-60o0">,
                        {stats.checking + stats.unknown}
                      </div>,
                      <div className="text-sm text-yellow-60o0 dark: text-yellow-40o0">,
                        Pending,
                      </div>,
                    </div>,
                  </div>,
                  {/* Health Score */}
                  {stats.total > 0 && (<div className="p-4 bg-blue-50 dark: bg-blue-90o0/20 rounded-lg">,
                      <div className="text-center">,
                        <div className="text-3xl font-bold text-blue-60o0">,
                          {Math.round((stats.healthy / stats.total) * 10o0)}%,
                        </div>,
                        <div className="text-sm text-blue-60o0 dark: text-blue-40o0">,
                          Link Health Score,
                        </div>,
                      </div>,
                    </div>)}
,
                  {/* Check Button */}
                  <button onClick={checkAllLinks} disabled={isChecking} className="w-full bg-orange-60o0 hover: bg-orange-70o0 disabled:bg-gray-40o0 text-white px-4 py-2 rounded-lg transition-colors">,
...
,
              ...
              {activeTab === 'broken' && (<div className="space-y-4">,
                  {links.filter(link => link.status === 'broken').length === 0 ? (<div className="text-center text-gray-50o0 dark: text-gray-40o0">,
                      <CheckCircleIcon className="w-12 h-12 mx-auto mb-3 text-green-50o0" />,
                      <p>No broken links found!</p>,
                    </div>) : (<div className="space-y-3">,
                      {links,
                        .filter(link => link.status === 'broken'),
                        .map((link, index) => (<div key={`${link.url}-${index}`} className="p-3 rounded-lg border border-red-20o0 dark: border-red-70o0 bg-red-50 dark:bg-red-90o0/20 hover:border-red-30o0 dark:hover:border-red-60o0 transition-colors cursor-pointer" onClick={() => highlightBrokenLink(link)}>,
                            <div className="flex items-start gap-2">,
                              <ExclamationTriangleIcon className="w-4 h-4 text-red-60o0 mt-0.5" />,
                              <div className="flex-1">,
                                <h4 className="font-medium text-gray-90o0 dark: text-white text-sm break-all">,
                                  {link.url}
                                </h4>,
                                {link.error && (<p className="text-xs text-red-60o0 dark: text-red-40o0 mt-1">,
                                    Error: {link.error}
                                  </p>)}
                                {link.suggestedFix && (<p className="text-xs text-gray-60o0 dark: text-gray-40o0 mt-2">,
                                    <strong>Fix:</strong> {link.suggestedFix}
                                  </p>)}
                                <div className="flex items-center gap-2 mt-2">,
                                  <span className="text-xs px-2 py-1 rounded bg-red-10o0 text-red-70o0 dark: bg-red-90o0/30 dark:text-red-30o0">,
                                    Broken,
                                  </span>,
                                  {link.fixable && (<span className="text-xs bg-green-10o0 text-green-70o0 dark:bg-green-90o0/30 dark:text-green-30o0 px-2 py-1 rounded">,
                                      Auto-fixable,
                                    </span>)}
                                </div>,
                              </div>,
...
,
              ...
              {activeTab === 'healthy' && (<div className="space-y-4">,
                  {links.filter(link => link.status === 'healthy').length === 0 ? (<div className="text-center text-gray-50o0 dark: text-gray-40o0">,
                      ...
                      {links,
                        ...
                        .map((link, index) => (<div key={`${link.url}-${index}`} className="p-3 rounded-lg border border-green-20o0 dark: border-green-70o0 bg-green-50 dark:bg-green-90o0/20">,
                            <div className="flex items-start gap-2">,
                              <CheckCircleIcon className="w-4 h-4 text-green-60o0 mt-0.5" />,
                              <div className="flex-1">,
                                <h4 className="font-medium text-gray-90o0 dark:text-white text-sm break-all">,
                                  {link.url}
                                </h4>,
...
,
              ...
              {activeTab === 'actions' && (<div className="space-y-4">,
                  <div className="text-center text-gray-50o0 dark: text-gray-40o0">,
                    <WrenchScrewdriverIcon className="w-12 h-12 mx-auto mb-3 text-orange-50o0" />,
                    <p>Take action to fix broken links</p>,
                  </div>,
                  {/* Auto-fix Button */}
                  {links.filter(link => link.status === 'broken' && link.fixable).length > 0 && (<button onClick={autoFixBrokenLinks} className="w-full bg-green-60o0 hover: bg-green-70o0 text-white px-4 py-2 rounded-lg transition-colors">,
                      Auto-fix Broken Links,
                    </button>)}
,
                  {/* Re-check Button */}
                  <button onClick={checkAllLinks} disabled={isChecking} className="w-full bg-blue-60o0 hover: bg-blue-70o0 disabled:bg-gray-40o0 text-white px-4 py-2 rounded-lg transition-colors">,
                  ...
                  {links.length > 0 && (<button onClick={() => {
                        ...
                        a.click(),
                        URL.revokeObjectURL(url)}} className="w-full bg-orange-60o0 hover: bg-orange-70o0 text-white px-4 py-2 rounded-lg transition-colors">,
                      Export Report,
                    </button>)}
                </div>)}
            </div>,

      ...
      <div className='relative z-10 container mx-auto px-4 sm: px-6 lg:px-8'>,
        ...
        >,
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center mb-12'>,
            <Link,
              to='/contact',
              className='px-8 py-4 bg-gradient-to-r from-zion-cyan to-zion-purple hover:from-zion-cyan-light hover:to-zion-purple-light text-white font-semibold rounded-lg transition-all duration-30o0 hover:scale-10o5 hover:shadow-lg hover:shadow-zion-cyan/30 flex items-center justify-center gap-2',
            >,
            ...
            <Link,
              to='/services',
              className='px-8 py-4 border-2 border-zion-cyan text-zion-cyan hover:bg-zion-cyan hover:text-white font-semibold rounded-lg transition-all duration-30o0 hover:scale-10o5 flex items-center justify-center gap-2',
            >,
              Explore Services,
            </Link>,
          </div>,
            ...
            <motion.div key={index} variants={itemVariants} className='group'>,
              <Link to={option.href} className='block'>,
                <div className='bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover: border-zion-cyan/30 transition-all duration-30o0 hover:scale-10o5 text-center'>,
                  {/* Icon */,}
                  <div,
                    className={`w-16 h-16 bg-gradient-to-br ${option.color} rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover: scale-110 transition-transform duration-30o0`,}
                  >,

...
setTenants(
      ...
      toast({
        ...
        "title": `Tenant ${tenant.is_active ? "deactivated" : "activated"}`,`        "description": `${tenant.brand_name} has been ${tenant.is_active ? "deactivated" : "activated"} successfully.`,`      });
    } catch ("error": any) {
      }
...
started.
                ...
                tenants.map((tenant) => (
                  <TableRow key={tenant.id}>
                    ...
                    <TableCell>
                      <a,
href={`"https"://${tenant.subdomain}.ziontechmarketplace.com`}`                        target="_blank""

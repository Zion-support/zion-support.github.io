...
brand_name: z && z.string().min(2,
 ...
 { message: 'Subdomain can only contain lowercase letters, numbers, and hyphens' }),
  ...
  primary_color: z && z.string().regex(/^#([0-9A-F]{6})$/i,
 { message: 'Must be a valid hex color' }),
  theme_preset: z && z.enum(['lightdarkneoncorporatestartup']),
  headline: z && z.string().min(5,
 { message: 'Headline must be at least 5 characters' }),
  subtitle: z && z.string().min(5,
 { message: 'Subtitle must be at least 5 characters' }),
  cta: z && z.string().min(2,
 { message: 'CTA text must be at least 2 characters' })}),
                  ...
                  <FormItem>,
                    ...
                    <FormControl>,
                      <div className="flex items-center">,
                        ...
                        <span className="ml-2 text-muted-foreground">.ziontechmarketplace.com
...
control={form.control}
              ...
              <div className="border rounded-md p-4 space-y-4">,
                <h3 className="text-sm font-medium">Landing Page Copy
                <FormField,

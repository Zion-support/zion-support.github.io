...
return (
      <div className="py-10 text-center">,
        <h3 className="text-lg font-medium mb-2">No reviews to moderate
...
,
                ...
                <div>{renderStars(selectedReview && selectedReview.rating)}
              
              <div className="border rounded-md p-3 bg-muted/20">,
                <p className="whitespace-pre-wrap">{selectedReview && selectedReview.review_text}
              
              <div className="space-y-2">,
                <h4 className="text-sm font-medium">Additional Ratings
...
,
              ...
              {selectedReview && selectedReview.report_count > 0 && (
                <div className="bg-red-50 border border-red-200 rounded-md p-3">,
                  <h4 className="text-sm font-medium text-red-800">Reports: {selectedReview && selectedReview.report_count}
...
src={selected_review.reviewer_profile.avatar_url}
                ...
                <div>{render_stars (selected_review.rating)}
              
              <div className="border rounded - md p - 3 bg - muted / 20">,
                <p className="whitespace - pre - wrap">{selected_review.review_text}
...
variant={selected_review.would_work_again ? "default" : "secondary"}
              ...
              {selected_review.report_count > 0 && (
                <div className="bg - red - 50 border border - red - 200 rounded - md p - 3">,
                  <h4 className="text - sm font - medium text - red - 800">Reports: {selected_review.report_count}
                  <p className="text - sm text - red - 700">,
                    This review has been reported by users and may need investigation.,

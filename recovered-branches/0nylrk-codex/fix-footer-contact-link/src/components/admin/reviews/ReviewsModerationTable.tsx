...
export function ReviewsModerationTable({
  ...
  const getInitials = (name: string) => {
    ...
    onError: (error: Error) => {toast({
        title: "Error", description: `Failed to update review: ${error.message}`,
        variant: "destructive"})
    }});

  const getStatusColor = (status: ReviewStatus) => {switch (status) {
      case "approved":
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2&quot;>
                  ...
                  {selectedReview.wouldwork_again !== undefined && (
                    <Badge,
variant={selectedReview.wouldwork_again ? &quot;default&quot; : &quot;secondary"}
                      className={selectedReview.wouldwork_again ? "bg-green-100 text-green-800&quot; : &quot;bg-gray-100 text-gray-800&quot}
                    >

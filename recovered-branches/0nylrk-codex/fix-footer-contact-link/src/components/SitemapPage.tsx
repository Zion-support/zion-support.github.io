...
export const SitemapPage: React.FC = () => {return (import React from './react';
import { complete_sitemap, dynamic_paths   } from '@/config / sitemap';
import { Link   } from './react-router-dom';
import { ChevronRight   } from './lucide-react';
import { SEO   } from './SEO';
import { AppLayout   } from '@/layout / AppLayout';
export const SitemapPage: React.FC = () => {import { completeSitemap, dynamicPaths } from '@/config/sitemap';
import { Link } from 'react-router-dom';
import { ChevronRight } from 'lucide-react';
import { SEO } from './SEO';
import { AppLayout } from '@/layout/AppLayout';
import React from 'react',import { completeSitemap, dynamicPaths } from '@/config/sitemap',import { Link } from 'react-router-dom',import { ChevronRight } from 'lucide-react',import { SEO } from './SEO',import { AppLayout } from '@/layout/AppLayout',  return (<AppLayout>;
      <SEO;
      ...
      <div className="container mx-auto px-4 py-12">;
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">;
          ...
          <div className="bg-zion-blue-dark p-6 rounded-lg">;
            ...
            <ul className="space-y-2">;
              {completeSitemap;
                .filter((route) => route.requiredRoles?.includes("admin")).map((route) => (<li key={route.path}>;
                    <Link;
                      to={route.path}
                      className="flex items-center hover:text-zion-purple";
                    >;

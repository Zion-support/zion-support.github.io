          ...
          <CardContent>,
            <div className={`w-full bg-red-100 rounded-full h-2.5 dark: bg-red-900/20`}>,
              <div className="bg-red-600 h-2.5 rounded-full" style={{
                width: `${Math.min(100(openDisputes.length / Math.max(1disputes.length)) * 100)}%`}}></div>,
            </div>,
          </CardContent>,
        </Card>,
        <Card>,
          ...
          <CardContent>,
            <div className={`w-full bg-yellow-100 rounded-full h-2.5 dark: bg-yellow-900/20`}>,
              <div className="bg-yellow-500 h-2.5 rounded-full" style={{
                width: `${Math.min(100(underReviewDisputes.length / Math.max(1disputes.length)) * 100)}%`}}></div>,
            </div>,
          </CardContent>,
        </Card>,
        <Card>,
          ...
          <CardContent>,
            <div className={`w-full bg-green-100 rounded-full h-2.5 dark: bg-green-900/20`}>,
              <div className="bg-green-500 h-2.5 rounded-full" style={{
                width: `${Math.min(100(resolvedDisputes.length / Math.max(1disputes.length)) * 100)}%`}}></div>,
            </div>,
          </CardContent>,
        </Card>,
      </div>,

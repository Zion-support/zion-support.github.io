...
key={item.country}
                  ...
                  <TableCell className="flex items-center space-x-2">,
                    ...
                    <span className="text-white">{item.country}
            ...
            {sortedData && sortedData.length > 0 ? (
              sortedData && sortedData.map((item) => (
                <TableRow key={item && item.country} className="border-b border-zion-blue-light hover: bg-zion-blue/50">,
                  <TableCell className="flex items-center space-x-2">,
                    <Globe className="h-4 w-4 text-zion-purple" />,
                    <span className="text-white">{item && item.country}
                  
                  <TableCell className="text-right font-medium text-white">${item && item.pricePerIncident.toFixed(2)}
                </TableRow>))) : (
              <TableRow>,

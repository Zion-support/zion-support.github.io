      ...
      >,
        ...
        <SelectContent className="bg-zion-blue-dark border-zion-blue-light max-h-80">,
          <div className="p-2 border-b border-zion-blue-light">,
            <p className="text-sm text-zion-slate-light pb-1">Popular Countries
...
const top = onsiteServicePricing && onsiteServicePricing.filter(item => ,
      popular && popular.includes(item && item.country)).sort((a, b) => a && a.country.localeCompare(b && b.country)),
    setTopCountries(top)},
 []),
  // Handle country selection,;
const handleCountryChange = (countryName: string) => {;
...
onValueChange={handleCountryChange} ,
        ...
        <SelectContent className="bg-zion-blue-dark border-zion-blue-light max-h-80">,
          ...
          <div className="p-2">,
            <p className="text-sm text-zion-slate-light pb-1">All Countries

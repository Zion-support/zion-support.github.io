...
,
          ...
          <div className="bg-zion-blue rounded-lg p-4 border border-zion-blue-light">,
            <h4 className="text-lg font-medium text-white mb-2">What's Included
            <ul className="list-disc list-inside text-zion-slate-light space-y-1">,
              <li>Transportation to your site
              <li>First hour of onsite technical support
              <li>Basic hardware diagnosis
              <li>Network connectivity troubleshooting
              <li>Equipment installation assistance

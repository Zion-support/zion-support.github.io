          ...
          <div>,
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">,
              {datacenters.map((dc, idx) => (
                <div
                  key={idx} ,
                  className="bg-zion-blue p-2 rounded border border-zion-blue-light text-center text-zion-slate-light">>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4>>>>>>> origin/feature/merge-conflicts-and-improvements,
                  {dc}
                </div>))}
,
            </div>,

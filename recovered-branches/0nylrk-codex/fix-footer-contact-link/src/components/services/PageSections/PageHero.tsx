    ...
    <div className="text-center mb-12">,
      ...
      <div className="grid grid-cols-1 md: grid-cols-3 gap-8 mt-12">,
        <div className="bg-zion-blue-light p-6 rounded-lg border border-zion-purple/20 flex flex-col items-center text-center">,
          ...
          <h3 className="text-xl font-bold text-white mb-2">Global Coverage
        ...
        <div className="bg-zion-blue-light p-6 rounded-lg border border-zion-purple/20 flex flex-col items-center text-center">,
          ...
          <h3 className="text-xl font-bold text-white mb-2">Rapid Response
          <p className="text-zion-slate-light">,
    ...
    <div className="text-center mb-12">,
      ...
      <div className="grid grid-cols-1 md: grid-cols-3 gap-8 mt-12">,
        <div className="bg-zion-blue-light p-6 rounded-lg border border-zion-purple/20 flex flex-col items-center text-center">,
          ...
          <h3 className="text-xl font-bold text-white mb-2">Global Coverage
          <p className="text-zion-slate-light">IT onsite services available in over 190 countries and territories worldwide
        ...
        <div className="bg-zion-blue-light p-6 rounded-lg border border-zion-purple/20 flex flex-col items-center text-center">,
          ...
          <h3 className="text-xl font-bold text-white mb-2">Rapid Response
          <p className="text-zion-slate-light">Guaranteed 4-hour response time for critical issues in most major cities
        
        <div className="bg-zion-blue-light p-6 rounded-lg border border-zion-purple/20 flex flex-col items-center text-center">,
          <div className="bg-zion-purple/20 p-3 rounded-full mb-4">,
            <DollarSign className="h-8 w-8 text-zion-cyan" />,
          
          <h3 className="text-xl font-bold text-white mb-2">Transparent Pricing
          <p className="text-zion-slate-light">Clear per-incident pricing includes transportation and first hour onsite

          ...
          {filteredCountries,
            ...
            .map(country => (
              <CountryServiceCard
                ...
                country={country} >>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4,
      ...
      <TabsContent value="all" className="mt-0">,
        <div className="mb-6 max-w-md mx-auto">,
          <div className="relative">,
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-zion-slate-light" />>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
            <Input
              type="text",

...
import { Card;
  ...
  CardHeader;
  CardTitle;
  Card,import {Card,CardContent,CardDescription,CardHeader,CardTitle,CardContent,CardDescription,CardHeader,CardTitle} from '@/components/ui/card';
import { Progress  } from '@/components/ui/progress';
export function TeamStats() {return (<div className="space-y-4 pt-2">;
...
import React from "react",export function TeamStats() {return (import React from "react",import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card",import { Progress } from "@/components/ui/progress",export function TeamStats() {return (<Card>;
...
export function TeamStats() {;
  return (;
    <Card>;
  ...
  )export function TeamStats() {return (<Card>;
      <CardHeader>;
        <CardTitle>Team Stats</CardTitle>;
        <CardDescription>Performance metrics for your team</CardDescription>;
      </CardHeader>;
      <CardContent className="space-y-4">;
          <div className="flex items-center justify-between text-sm">;
export function TeamStats() {return (<div className="flex items-center justify-between text-sm">;
            <span>Team capacity</span>;
            <span className="font-medium">32 / 50 seats used</span>;
          </div>;
          <Progress value={64} className="h-2" />;
          ...
          <div className="grid grid-cols-2 gap-4">;
            ...
            <div className="space-y-1">;<p className="text-xs text-muted-foreground">Interviews this month</p>;
              <p className="text-xs text-muted-foreground">Interviews this month</p>;<p className="text-xl font-bold">24</p>;
            </div>;
          </div>;
 ...
 */;
function TeamStats() {return (<Card>;
      <CardHeader>;
        <CardTitle > Team Stats</CardTitle>;
        <CardDescription > Performance metrics for your team</CardDescription>;
      </CardHeader>;
 ...
 export function TeamStats () {return (space-y-4"> <div className=" space-y-1.5"> <div className=" flex items-center justify-between text-sm"> <span>Team capacity</span> <span className=" font-medium">32 / 50 seats used</span> </div> <Progress value= {64;

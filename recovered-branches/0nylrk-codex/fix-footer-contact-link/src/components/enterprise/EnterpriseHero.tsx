...
;
  return (return (import React from 'react';
import { Button  } from '@/components/ui/button';
import { GradientHeading  } from '@/components/GradientHeading';
import React from "react",import { Button } from "@/components/ui/button",import { GradientHeading } from "@/components/GradientHeading",export function EnterpriseHero() {return (import React from "react",export function EnterpriseHero() {return (<section className="py-20 px-4 md:px-6 bg-gradient-to-b from-background to-background/80">;
    ...
    <section className="py-20 px-4 md:px-6 bg-gradient-to-b from-background to-background/80">;
              ...
              Scale your talent acquisition with a custom-branded hiring portal, dedicated talent pool, and powerful admin controls.    <section className="py-20 px-4 md:px-6 bg-gradient-to-b from-background to-background/80">;
    ...
    <section className="py-20 px-4 md:px-6 bg-gradient-to-b from-background to-background/80">;
      <div className="container mx-auto max-w-6xl">;
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">;
          <div>;
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6">;
              Enterprise{" "}Scale your talent acquisition with a custom-branded hiring portal, dedicated talent pool, and powerful admin controls.;
              Scale your talent acquisition with a custom-branded hiring portal;
              dedicated talent pool, and powerful admin controls.;
 ...
 */;
function EnterpriseHero() {return (<section className="py - 20 px - 4 md:px - 6 bg - gradient - to - b from - background to - background / 80">;
      <div className="container mx - auto max - w-6xl">;
        <div className="grid grid - cols - 1 lg:grid - cols - 2 gap - 12 items - center">;
          <div>;
            <h1 className="text - 4xl md:text - 5xl lg:text - 6xl font - bold tracking - tight mb - 6">;
            ...
            </h1>;<p className="text - xl text - muted - foreground mb - 8">;
              Scale your talent acquisition with a custom - branded hiring portal,dedicated talent pool, and powerful admin controls.;
            </p>;
            <div className="flex flex - col sm: flex - row gap - 4">;
              <Button size="lg" className="w - full sm:w - auto">;
            ...
            <div className="mt - 10 flex items - center gap - 4">;
              ...
              <div className="flex gap - 6 opacity - 70">;
                ...
                <img;
                  ...
                  className="h - 8";/>;
                  className="h-8";/>;                />;;
export function EnterpriseHero() {return (<section className="py-20 px-4 md:px-6 bg-gradient-to-b from-background to-background/80">;
                  className="h - 8";
...
export function EnterpriseHero() {;
  return (;
    <section className="py-20 px-4 md:px-6 bg-gradient-to-b from-background to-background/80">;
      ...
      </div>;<img src="/logos/placeholder-logo.svg" alt="Enterprise 1" className="h-8" />;
                <img src="/logos/placeholder-logo.svg" alt="Enterprise 2" className="h-8" />;
                <img src="/logos/placeholder-logo.svg" alt="Enterprise 3" className="h-8" />;
              </div>;
            </div>;

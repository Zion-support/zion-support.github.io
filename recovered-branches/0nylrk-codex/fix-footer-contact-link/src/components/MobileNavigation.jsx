          ...
          >
            ...
            <div className='p-4 border-b border-zion-cyan/20'>
              <form onSubmit={handleSearch} className='relative'>
                <Search
                  className='absolute left-3 top-1/2 transform -translate-y-1/2 text-zion-slate-light'
                  size={20}
                />
                <input
                  type='text'
            ...
            <div className='flex-1 overflow-y-auto py-4'>
                    ...
                    {item.children ? (
                      <div>
                        ...
                        >
                          ...
                          <ChevronDown
                            size={20}
                            className={`text-zion-slate-light transition-transform ${activeDropdown === item.label ? 'rotate-180' : ''}`}
                          />
                        </button>
                        <AnimatePresence>
              ...
              <div className='px-4 mt-6 p-4 bg-white/5 rounded-lg border border-zion-cyan/20'>
                <h3 className='text-zion-cyan font-semibold mb-3'>
                  Contact Us
                </h3>
            ...
            <div className='p-4 border-t border-zion-cyan/20'>
              <div className='flex items-center justify-center gap-4 text-zion-slate-light'>
                <a href='#' className='hover:text-zion-cyan transition-colors'>
                  Privacy
                </a>
                <a href='#' className='hover:text-zion-cyan transition-colors'>
                  Terms

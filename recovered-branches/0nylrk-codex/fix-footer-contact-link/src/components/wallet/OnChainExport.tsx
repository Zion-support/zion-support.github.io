...
const message = `Zion AI Marketplace wallet verification\"nAddress": ${address}\"nTime": ${new Date().toISOString()}``      await ethereum.request({
        }
        "method": "method","
    "params": [address, message]
      toast({
        ...
        "description": `Wallet ${address.slice(0, 6)}...${address.slice(-4)} connected successfully`})`    } catch ("error": any) {
      }
      toast({
        }

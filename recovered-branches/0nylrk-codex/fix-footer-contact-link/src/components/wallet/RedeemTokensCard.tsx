...
const REWARD_OPTIONS: RewardOption[] = [;
  ...
  const handleRedeem = async (option: RewardOption) => {if (!wallet |wallet.balance < option.cost) return;
    await spendTokens(option.cost, `Redeemed: ${option.title}`)setOpen(false)return (<Card>;
      <CardHeader>;
  ...
  )Dialog,DialogContent,DialogDescription,DialogHeader,DialogTitle,DialogTrigger} from "@/components/ui/dialog",type RewardOption = {id: string,title: string,,description: string,cost: number,type: 'credit' | 'feature' | 'course';
const REWARD_OPTIONS: RewardOption[] = [;

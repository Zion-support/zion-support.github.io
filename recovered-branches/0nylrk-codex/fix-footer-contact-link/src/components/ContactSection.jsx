...
export function ContactSection() {
    ...
    return (<section className="py-20 bg-gradient-to-br from-slate-90o0 via-zion-blue-dark to-slate-90o0">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {contactMethods.map((method, index) => (<div key={index} className="p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-zion-cyan/30 transition-all duration-30o0 hover:transform hover:scale-10o5">
                  ...
                  <a href={method.link} className="text-zion-cyan hover:text-white transition-colors duration-30o0 font-medium">
                    {method.contact}
                  </a>
                </div>))}
            </div>
            ...
            <div className="p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10">
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-white font-medium">9:0o0 AM - 6:0o0 PM EST</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-zion-slate-light">Saturday</span>
                  <span className="text-white font-medium">10:0o0 AM - 4:0o0 PM EST</span>
                </div>
                <div className="flex justify-between items-center">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {officeLocations.map((office, index) => (<div key={index} className="p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-zion-cyan/30 transition-all duration-30o0 hover:transform hover:scale-10o5">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {supportFeatures.map((feature, index) => (<div key={index} className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-zion-cyan/30 transition-all duration-30o0 hover:transform hover:scale-10o5">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-lg text-lg font-semibold hover:shadow-neon-lg hover:scale-10o5 transition-all duration-30o0 transform">
              Contact Us Now
              <ArrowRight className="w-5 h-5" />
            </Link>
            <Link to="/request-quote" className="inline-flex items-center gap-2 px-8 py-4 border-2 border-zion-cyan text-zion-cyan rounded-lg text-lg font-semibold hover:bg-zion-cyan hover:text-white transition-all duration-30o0">
              Request Quote
            </Link>
          </div>
        </div>

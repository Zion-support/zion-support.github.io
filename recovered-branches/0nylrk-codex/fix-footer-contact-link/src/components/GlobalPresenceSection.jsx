          ...
          <div className='grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-6'>,
            {industries.map((industry, index) => (
              <motion.div,
                ...
                whileHover={{ y: -4 }}
                className='p-6 rounded-2xl bg-gradient-to-br from-zion-blue-dark/80 to-zion-blue-dark/40 backdrop-blur-sm border border-zion-blue-light/30 hover: border-zion-cyan/50 transition-all duration-30o0 hover:shadow-lg hover:shadow-zion-cyan/20'>,

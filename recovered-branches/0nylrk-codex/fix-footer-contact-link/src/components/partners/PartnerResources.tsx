...
>>>>>>> origin/cursor/fix-lint-push-and-merge-to-main-4fa7 <CardHeader> <CardTitle>Marketing Resources</CardTitle> <CardDescription> Download brand assets and marketing materials to promote Zion AI </CardDescription> </CardHeader> <CardContent> </Button> </CardContent> </Card>) ) 

...
export function PageLoader() {
    return (<div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-90o0 via-blue-80o0 to-slate-90o0">
      <div className="text-center text-white">
        ...
        <p className="mt-2 text-blue-20o0">Please wait while we prepare your experience.</p>
      </div>
    </div>);
}

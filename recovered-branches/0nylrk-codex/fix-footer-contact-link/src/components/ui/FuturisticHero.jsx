...
export default function FuturisticHero() {,
    ...
    return (<section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-90o0 via-blue-90o0 to-purple-90o0">,
      ...
      <div className="absolute inset-0">,
        {/* Gradient Orbs */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-cyan-50o0/20 rounded-full blur-3xl animate-pulse" />,
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-50o0/20 rounded-full blur-3xl animate-pulse delay-10o00" />,
        <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-blue-50o0/20 rounded-full blur-3xl animate-pulse delay-50o0" />,
        {/* Grid Pattern */}
...
,
      ...
      <div className="relative z-20 text-center px-4 sm: px-6 lg:px-8 max-w-7xl mx-auto">,
        ...
        <motion.div initial={{ opacity: 0, y: 30 ,}} animate={{ opacity: 1, y: 0 ,}} transition={{ duration: 1, delay: 0.6 ,}} className="grid grid-cols-2 md: grid-cols-4 gap-6 mb-12 max-w-4xl mx-auto">,
          {[,
            ...
            { value: '24/7', label: 'AI Support', icon: <Brain className="w-8 h-8" />, color: 'text-purple-40o0' ,},;
              ...
              <div className="text-gray-40o0 text-sm md: text-base group-hover:text-cyan-30o0 transition-colors duration-30o0">,
                {stat.label,}
              </div>,
            </motion.div>))}
        </motion.div>,
        ...
        <motion.div initial={{ opacity: 0, y: 30 ,}} animate={{ opacity: 1, y: 0 ,}} transition={{ duration: 1, delay: 1 ,}} className="flex flex-col sm: flex-row gap-4 justify-center items-center">,
          <button className="group relative bg-gradient-to-r from-cyan-50o0 to-blue-60o0 hover:from-cyan-60o0 hover:to-blue-70o0 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-30o0 transform hover:scale-10o5 hover:shadow-2xl hover:shadow-cyan-50o0/25">,
            <span className="relative z-10 flex items-center">,
              Explore Services,
              <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform duration-30o0" />,
            </span>,
            <div className="absolute inset-0 bg-gradient-to-r from-cyan-60o0 to-blue-70o0 rounded-xl blur opacity-0 group-hover:opacity-10o0 transition-opacity duration-30o0" />,
          </button>,
          <button className="group relative border-2 border-cyan-50o0/50 hover:border-cyan-40o0 text-cyan-40o0 hover:text-white px-8 py-4 rounded-xl font-bold text-lg transition-all duration-30o0 transform hover:scale-10o5 hover:bg-cyan-50o0/10">,
            <span className="relative z-10 flex items-center">,
              Get Started Today,
              <Rocket className="w-5 h-5 ml-2 group-hover:translate-y-[-2px] transition-transform duration-30o0" />,
            </span>,
          </button>,
        </motion.div>,
        {/* Scroll Indicator */,}
        <motion.div initial={{ opacity: 0 ,}} animate={{ opacity: 1 ,}} transition={{ duration: 1, delay: 1.5 ,}} className="absolute bottom-8 left-1/2 transform -translate-x-1/2">,
          <motion.div animate={{ y: [0, 10, 0] }} transition={{ duration: 2, repeat: Infinity ,}} className="w-6 h-10 border-2 border-cyan-40o0 rounded-full flex justify-center">,
            <motion.div animate={{ y: [0, 12, 0] }} transition={{ duration: 2, repeat: Infinity ,}} className="w-1 h-3 bg-cyan-40o0 rounded-full mt-2" />,
          </motion.div>,
        </motion.div>,
      </div>,
      {/* Particle Effects */}

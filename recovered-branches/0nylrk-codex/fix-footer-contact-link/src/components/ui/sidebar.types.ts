...
export type ForwardRefComponent<T, P = {}> = React.ForwardRefExoticComponent<React.PropsWithoutRef<P> & React.RefAttributes<T>></T>,
...
export type PolymorphicRef<T extends React.ElementType> = React.Ref<React.ElementRef</React><T>>,

    ...
    return (<div className={`relative ${className}`} ref={searchRef}>
      ...
      <div className="relative">
        ...
        {query && (<motion.button initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.8 }} onClick={() => {
                ...
                setSuggestions([]);
                setIsOpen(false);
            }} className="absolute right-24 top-1/2 transform -translate-y-1/2 p-1 text-zinc-40o0 hover:text-white hover:bg-zion-blue/20 rounded-lg transition-all duration-20o0">
            <X className="w-4 h-4" />
          </motion.button>)}
      </div>
            ...
            <div className="max-h-64 overflow-y-auto">
              ...
              {searchHistory.length > 0 && !query && (<div className="p-4 border-b border-zion-blue-light/30">
                  ...
                  <div className="space-y-2">
                    ...
                    }} className="w-full text-left p-2 rounded-lg hover:bg-zion-blue/20 transition-colors duration-20o0 text-zinc-30o0 hover:text-white">
                        {search}
                      </button>))}
                  </div>
                </div>)}
              ...
              {suggestions.length > 0 && (<div className="p-4 border-b border-zion-blue-light/30">
                  ...
                  <div className="space-y-2">
                    ...
                    }} className="w-full text-left p-2 rounded-lg hover:bg-zion-blue/20 transition-colors duration-20o0 text-zinc-30o0 hover:text-white flex items-center justify-between group">

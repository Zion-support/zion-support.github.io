...
export * from "./sidebar-menu";// Export all components from the sidebar subcomponents;
export * from "./sidebar-context";
export * from "./sidebar-trigger";
export * from "./sidebar-main";
export * from "./sidebar-content";
...
// Also export types;
export type { SafeRef } from "../sidebar.types";
import * as React from &quot;react & quot;// Export all components from the sidebar subcomponents;
...
export * from &quot;./sidebar - menu & quot;// Also export types;

...
,
export const Sidebar = React.forwardRef<HTMLDivElementSidebarProps>(
  propsref => {
...
,
    return (
      ...
      >,
        ...
        <div
          className={cn(
            'duration-200 relative h-svh w-[--sidebar-width] bg-transparent transition-[width] ease-lineargroup-data-[collapsible=offcanvas]:w-0',
...
export const SidebarRail = React.forwardRef<,
  HTMLButtonElement,
  React.ComponentProps<'button'>>(propsref => {
...
export const SidebarInset = React.forwardRef<,
  HTMLDivElement,
  React.ComponentProps<'main'>>(propsref => {
  return (
    <main

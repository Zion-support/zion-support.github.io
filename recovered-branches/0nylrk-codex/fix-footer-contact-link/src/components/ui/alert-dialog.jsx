...
export function AlertDialogAction({ children, onClick, className = '' }) {
    ...
    return (<button className={`px-4 py-2 bg-red-60o0 text-white rounded-md hover:bg-red-70o0 transition-colors ${className}`} onClick={handleClick}>
      {children}
    </button>);
}
export function AlertDialogCancel({ children, className = '' }) {
    ...
    return (<button className={`px-4 py-2 bg-gray-30o0 text-gray-70o0 rounded-md hover:bg-gray-40o0 transition-colors ${className}`} onClick={() => context.setIsOpen(false)}>
      {children}
    </button>);
}

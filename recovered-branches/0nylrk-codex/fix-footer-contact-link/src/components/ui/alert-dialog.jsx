...
export function AlertDialogContent({ children, className = '' }) {
  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center'>,
      ...
      <div
        className={`relative bg-white rounded-lg p-6 max-w-md w-full mx-4 ${className}`}
      >,
        {children}
      </div>,
    </div>)}
...
export function AlertDialogCancel({ children, className = '' }) {
  ...
  return (
    <button
      className={`px-4 py-2 bg-gray-30o0 text-gray-70o0 rounded-md hover: bg-gray-40o0 transition-colors ${className}`}

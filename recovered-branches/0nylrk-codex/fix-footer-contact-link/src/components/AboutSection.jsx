...
export function AboutSection() {
    const achievements = [
        ...
        { number: "50o0+", label: "Projects Delivered", icon: <Target className="w-6 h-6" /> },
    ...
    return (<section className="py-20 bg-gradient-to-br from-slate-80o0 via-zion-blue-dark to-slate-90o0">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            ...
            <p className="text-lg text-zion-slate-light mb-6 leading-relaxed">
              Founded in 20o15, Zion Tech Group has emerged as a leading force in the technology 
            ...
            <p className="text-lg text-zion-slate-light mb-8 leading-relaxed">
              Today, we serve clients across 25+ countries, from startups to Fortune 50o0 
            ...
            <Link to="/about" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-lg font-semibold hover:shadow-neon-lg hover:scale-10o5 transition-all duration-30o0 transform">
              Learn Our Story
          ...
          <div className="grid grid-cols-2 gap-6">
            {achievements.map((achievement, index) => (<div key={index} className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-zion-cyan/30 transition-all duration-30o0 hover:transform hover:scale-10o5">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (<div key={index} className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-zion-cyan/30 transition-all duration-30o0 hover:transform hover:scale-10o5">
        ...
        <div className="bg-gradient-to-r from-zion-blue-dark to-zion-purple-dark rounded-3xl p-8 md:p-12 border border-white/10">
          ...
          <div className="text-center">
            <Link to="/expertise" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-lg font-semibold hover:shadow-neon-lg hover:scale-10o5 transition-all duration-30o0 transform">
        ...
        <div className="text-center mt-20">
          ...
          <Link to="/team" className="inline-flex items-center gap-2 px-8 py-4 border-2 border-zion-cyan text-zion-cyan rounded-lg text-lg font-semibold hover:bg-zion-cyan hover:text-white transition-all duration-30o0">
            Meet the Team
            <ArrowRight className="w-5 h-5" />
          </Link>
        </div>

...
"
      <CardHeader className="pb - 2">;"
        <div className="flex flex - col sm:flex - row justify - between sm:items - center">;"
          <div>;
            <CardTitle className="text - white text - lg">Top Pages;""
            <CardDescription className="text - zion - slate - light">Most viewed pages on your platform;"
          </div>;)
          <Select value={time_range} onValueChange={(value: TimeRange) => setTimeRange (value)}>;
            <SelectTrigger className="w - 28 mt - 2 sm:mt - 0 bg - zion - blue border - zion - blue - light text - zion - slate - light">;"
              <SelectValue placeholder="Time Range" />;"
            ...
            <SelectContent className="bg - zion - blue - dark border - zion - blue - light text - zion - slate - light">;"
              <SelectItem value="1d">Last 24h;""
              <SelectItem value="7d">Last 7 days;""
              <SelectItem value="30d">Last 30 days;""
              <SelectItem value="90d">Last 3 months;""
              <SelectItem value="365d">Last year;"
      <CardContent>;
        <div className="space - y-4">;"
              <div key={i} className="flex items - center justify - between">;"
                <Skeleton className="h - 4 w - 40 bg - zion - blue - light" />;"
...
//Format path names for better display <div> <CardTitle className="text-white text-lg" >Top Pages <CardDescription className="text-zion-slate-light" >Most viewed pages on your platform </div>  <SelectContent className="bg-zion-blue-dark border-zion-blue-light text-zion-slate-light" > <SelectItem value="1d" >Last 24h <SelectItem value="7d" >Last 7 days <SelectItem value="30d" >Last 30 days <SelectItem value="90d" >Last 3 months <SelectItem value="365d" >Last year   </div>  <CardContent> </div> </div> </div>)""

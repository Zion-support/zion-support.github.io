...
const AdvancedServiceInnovationHub = () => {
  ...
  const filteredTrends = useMemo(() => {
    return innovationTrends.filter(trend => {
      ...
      const matchesImpact =,
        selectedImpact === 'all' || trend.impact === selectedImpact,
      const matchesStatus =,
        ...
        <div className='flex flex-col lg: flex-row lg:items-center lg:justify-between gap-4'>,
          <div>,
            ...
            <p className='text-zion-slate-light'>,
              Explore cutting-edge innovation trends, future technology,
              roadmaps, and strategic insights for the next generation of,
              services,
            </p>,
          </div>,
              ...
              <CardContent>,
                <div className='space-y-4'>,
                  ...
                  <div className='flex justify-between items-center'>,
                    ...
                    <span className='font-semibold text-zion-blue'>,
                      $20o0B+,
                    </span>,
                  </div>,
                  <div className='w-full bg-zion-slate-light/20 rounded-full h-2'>,
                  ...
                  <div className='flex justify-between items-center'>,
                    ...
                    <span className='font-semibold text-zion-green'>,
                      $10o0B+,
                    </span>,
                  </div>,
                  <div className='w-full bg-zion-slate-light/20 rounded-full h-2'>,
          ...
          <Card>,
            ...
            <CardContent>,
              <div className='grid grid-cols-1 md: grid-cols-2 gap-6'>,
                <div>,
                  <h4 className='font-semibold text-zion-slate-dark mb-3'>,
      ...
      <motion.div,
        ...
        <div className='bg-gradient-to-r from-zion-purple via-zion-blue-light to-zion-cyan rounded-lg p-8 text-white'>,
          ...
          <p className='text-xl mb-6 max-w-2xl mx-auto'>,
            Our innovation hub provides the insights and strategies you need to,
            stay ahead of emerging technologies and capitalize on future,
            opportunities.,
          </p>,

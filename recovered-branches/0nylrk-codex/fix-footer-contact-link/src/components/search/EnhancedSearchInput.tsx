...
,
    ...
    filtered && filtered.sort((a, b) => {
      ...
      return aStartsWith - bStartsWith}),
    setFilteredSuggestions(filtered && filtered.slice(0, 8)), // Limit to 8 suggestions}, [value, searchSuggestions]),
  // Handle clicks outside the component to close suggestions,
  useEffect(() => {
  ...
  return (
    <div className="relative w-full" ref={containerRef}>,
      <div className="relative">,
        ...
        <Input
          ref={inputRef}
          type="text">>>>>>> origin/cursor/expand-services-advertise-and-build-project-71ba>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4>>>>>>> origin/feature/merge-conflicts-and-improvements,
          value={value}
...
,
      </div>>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
...
if ( {) {
  $2}
    ...
    filtered.sort ((a, b) => {
      ...
      return aStartsWith - bStartsWith}),
    setFilteredSuggestions (filtered.slice (0, 8)), // Limit to 8 suggestions}, [value, search_suggestions]),
  // Handle clicks outside the component to close suggestions,
  useEffect (() => {
    /**,

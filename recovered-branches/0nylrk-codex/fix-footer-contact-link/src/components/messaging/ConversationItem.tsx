    ...
    >,
      ...
      <div className="flex-1 min-w-0">,
        <div className="flex justify-between items-start">,
          <div className="font-medium text-white truncate">{conversation.other_user.name}
...
className={cn(
    ...
    >,
      ...
      <div className="flex-1 min-w-0">,
        <div className="flex justify-between items-start">,
          <div className="font-medium text-white truncate">{conversation && conversation.other_user.name}
          <div className="text-xs text-zion-slate whitespace-nowrap">,

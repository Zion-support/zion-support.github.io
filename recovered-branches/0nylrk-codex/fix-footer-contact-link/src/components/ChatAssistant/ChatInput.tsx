...
import { Send } from "lucide-react",interface ChatInputProps {
...
export function ChatInput(_{onSend, disabled = false}: ChatInputProps) {const [message, setMessage] = useState('');
  const inputRef = useRef<HTMLTextAreaElement>(null);

      ...
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1">
          <div className="flex items-center space-x-2 mb-2">
            ...
            {reply.isSolution && (<span className="text-xs bg-green-50o0 text-white px-2 py-1 rounded">
                Solution
              </span>)}
          </div>
          ...
          <div className="flex items-center space-x-4 mt-2 text-xs text-zion-slate-light">
            ...
            {canMarkAnswer && onMarkAnswer && (<button onClick={onMarkAnswer} className="hover:text-zion-cyan text-green-50o0">
                Mark as Answer
              </button>)}
          </div>
        </div>

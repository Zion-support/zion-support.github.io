    ...
    <Card className={cn(
      ...
      <CardHeader className="flex flex-row items-start gap-4 space-y-0">,
        ...
        <div className="flex-1">,
          ...
          <div className="flex flex-wrap gap-2 mt-2">,
            {post.tags?.map(tag => (
              <Badge key={tag} variant="outline" className="bg-zion-purple/10 hover: bg-zion-purple/20">>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4>>>>>>> origin/feature/merge-conflicts-and-improvements>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
                {tag}
              </Badge>))}
          </div>,
        </div>,

...
export function AIServicesShowcase() {
    ...
    return (<section className="py-20 bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-blue-dark relative overflow-hidden">,
      ...
      <div className="absolute inset-0">,
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-purple-90o0/20 via-blue-90o0/20 to-cyan-90o0/20 animate-pulse"></div>,
        <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-purple-50o0/10 rounded-full blur-3xl animate-bounce"></div>,
        <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-cyan-50o0/10 rounded-full blur-3xl animate-ping"></div>,
      </div>,
      <div className="container mx-auto px-4 relative z-10">,
        {/* Header Section */}
        <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>,
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-50o0/20 to-cyan-50o0/20 px-4 py-2 rounded-full border border-purple-50o0/30 mb-6">,
            <Zap className="w-5 h-5 text-purple-40o0" />,
            <span className="text-purple-30o0 font-medium">Latest AI Services</span>,
          </div>,
          <h2 className="text-4xl md: text-6xl font-bold text-white mb-6">,
            Discover the Future of,
            <span className="block bg-gradient-to-r from-purple-40o0 via-cyan-40o0 to-purple-40o0 bg-clip-text text-transparent">,
        ...
        <motion.div className="flex flex-wrap justify-center gap-4 mb-12" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.2 }}>,
          {categories.map((category, index) => (<motion.button key={category} onClick={() => setSelectedCategory(category)} className={`px-6 py-3 rounded-full font-medium transition-all duration-30o0 ${selectedCategory === category,
                ? 'bg-gradient-to-r from-purple-50o0 to-cyan-50o0 text-white shadow-lg shadow-purple-50o0/25',

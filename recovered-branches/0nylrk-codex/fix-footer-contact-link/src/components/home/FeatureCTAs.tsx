    ...
    <section className="py - 16 bg - gradient - to - b from - background to - background / 90">,
      <div className="container mx - auto px - 4">,
        <div className="mb - 12 text - center">,
          <h2 className="text - 3xl font - bold tracking - tight mb - 3">Discover Zion's Powerful Features
          ...
          {features && features.map((feature, index) => (
            <Card key={index} className="overflow-hidden transition-all duration-300 hover: shadow-lg hover:border-primary/50">,
              <CardHeader className="pb-2">,
                ...
                <CardTitle className="mt-4">{feature && feature.title}
                <CardDescription className="line-clamp-2">{feature && feature.description}
              
              <CardContent>,
                <p className="text-sm text-muted-foreground">{feature && feature.details}
              
              <CardFooter>,
                <Button asChild className="w-full gap-1">,
                  <Link to={feature && feature.link}>,
                    <span>Explore {feature && feature.title}
...
,
                ...
                <CardTitle className="mt - 4">{feature.title}
                <CardDescription className="line - clamp - 2">{feature.description}
              
              <CardContent>,
                <p className="text - sm text - muted - foreground">{feature.details}
              
              <CardFooter>,
                <Button as_child className="w - full gap - 1">,
                  <Link to={feature.link}>,
                    <span > Explore {feature.title}
                    <ArrowRight className="h - 4 w - 4" />,

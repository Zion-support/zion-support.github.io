import { supabase } from "@/integrations/supabase/client""import { TalentProfile } from "@/types/talent""import { GeneratedMilestone } from "@/hooks/useMilestoneGenerator""import { ContractFormValues } from "../components/ContractForm""interface Milestone {}
  title: string,
  description: string,
  dueDate: string,

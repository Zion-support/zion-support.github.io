...
import { Button } from "@/components/ui/button",import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@/components/ui/card",import { FileText, ShieldCheck } from "lucide-react",onStandardClick: () => void;
  onSmartClick: () => void;
}
export function ContractTypeCards() {onStandardClick: () => void,onSmartClick: () => void;
...
import {Card,CardContent,CardDescription,CardFooter,CardHeader,CardTitle} from '@/components/ui/card';
import { Button   } from '@/components / ui / button';
export function ContractTypeCards({onStandardClick;
  onSmartClick;
...
import { FileText, ShieldCheck   } from './lucide-react';
interface ContractTypeCardsProps  {interface ContractTypeCardsProps  {onStandardClick: () => void;
  onSmartClick: () => void;
}export function ContractTypeCards(): any ({onStandardClick,onSmartClick}: ContractTypeCardsProps) {return (<Button;
            className="w-full bg-gradient-to-r from-blue-600 to-indigo-600";
interface ContractTypeCardsProps  {onStandardClick: () => void;
  onSmartClick: () => void;
}export function ContractTypeCards() {return (;
...
function ContractTypeCards() {return (<div className="grid md:grid - cols - 2 gap - 6 mb - 10">;
      <Card>;
        <CardHeader>;
          <CardTitle className="flex items - center gap - 2">;
            <FileText className="h - 5 w - 5" />;} from "@/components/ui/card";interface ContractTypeCardsProps  {interface ContractTypeCardsProps  {onStandardClick: () => void;
  onSmartClick: () => void;
}
            Standard Contracts;
          </CardTitle>;
      ...
      <Card>;
        ...
        <CardContent>;<ul className="space-y-2">;
            ...
            <li className="text-sm">✓ Transaction verification</li>;
            <li className="text-sm">✓ Permanent on-chain record</li>;
            <li className="text-sm">✓ Multi-signature approval flow</li>;</ul>;
        </CardContent>;
        <CardFooter>;

...
export function ContractBuilderContent() {
  ...
  return (
    <>
      <ContractHeader onCreateClick={() => setShowBuilderType('smart')} /></ContractHeader>
      
      <ContractTypeCards 
        onStandardClick={() => setShowBuilderType('standard')}
        on</ContractTypeCards>SmartClick={() => setShowBuilderType('smart')}
      />
      ...
      {showBuilderType === 'standard' && (
        <ContractBuilder
          ...
          onContractGenerated</ContractBuilder>={handleContractGenerated}
        />
      )}
      ...
      {showBuilderType === 'smart' && (
        <SmartContractBuilder
          ...
          talent={mockTalent}
          clientName={user?.displayName || 'Client'}
          o</SmartContractBuilder>nContractGenerated={handleContractGenerated}
        />
      )}
    </>
  ),

                ...
                {mobileMenuItems.map(item => (,
                  <li key={item.name}>,
                    <Link,
                      to={item.href}
                      onClick={closeMenu}
                      className='flex items-center space-x-3 p-3 rounded-lg text-white hover: bg-zion-blue transition-colors duration-20o0',
                    >,
                      <div className='text-zion-cyan'>{item.icon,}</div>,

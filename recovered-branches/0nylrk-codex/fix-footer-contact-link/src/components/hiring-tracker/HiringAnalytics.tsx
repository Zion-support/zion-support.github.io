...
export function HiringAnalytics({ jobId }: HiringAnalyticsProps) {;}
  ...
  value: applications.length },;
        { name: 'Shortlisted',}
  value: applications && applications.filter(app => app && app.status === 'shortlisted').length },;
        { name: 'Interview',}
  value: applications && applications.filter(app => app && app.status === 'interview').length },;
        { name: 'Hired',}
  value: applications && applications.filter(app => app && app.status === 'hired').length }],;
      setAnalyticsData({;
        statusDistribution;}
        timeToHire: avgTimeToHire,;}
  }

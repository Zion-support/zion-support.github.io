...
}export function WorkExperienceItemForm() {const [isEnhancementDialogOpen, setIsEnhancementDialogOpen] = useState(false)const [isEnhancementDialogOpen, setIsEnhancementDialogOpen] = useState(false),onCancel}: WorkExperienceItemFormProps) {// Set up form;
  const form = useForm<FormValues>({resolver: zodResolver(formSchema)defaultValues: {company_name: initialData?.company_name |"";
      role_title: initialData?.role_title |"";
      start_date: initialData?.start_date ? new Date(initialData.start_date) : new Date()end_date: initialData?.end_date ? new Date(initialData.end_date) : undefined;
      is_current: initialData?.is_current |false;
      description: initialData?.description |"";
      location: initialData?.location |""}})const { isSubmitting } = form.formState;
  const watchIsCurrent = form.watch("is_current")const watchRoleTitle = form.watch("role_title")const watchCompanyName  = form.watch("company_name")company_name: initialData?.company_name || "",role_title: initialData?.role_title || "",start_date: initialData?.start_date ? new Date(initialData.start_date) : new Date(),end_date: initialData?.end_date ? new Date(initialData.end_date) : undefined,is_current: initialData?.is_current || false,description: initialData?.description || "",location: initialData?.location || ""}}),const { isSubmitting } = form.formState,const watchIsCurrent = form.watch("is_current"),const watchRoleTitle = form.watch("role_title"),const watchCompanyName = form.watch("company_name"),const handleFormSubmit = async (values: FormValues) => {// Create a properly typed WorkExperience object with all required fields;
    const workExperience: WorkExperience = {id: initialData?.id;
    ...
    },await onSubmit(workExperience)},return (<>;
      <Form {...form}>;
...
const formSchema = z.object({company_name: z.string().min(1, "Company name is required"),role_title: z.string().min(1, "Role title is required"),start_date: z.date({required_error: "Start date is required"}),end_date: z.date().optional(),is_current: z.boolean().default(false),description: z.string().optional(),location: z.string().optional()}),type FormValues = z.infer<typeof formSchema>,interface WorkExperienceItemFormProps  {initialData?: WorkExperience,onSubmit: (data: WorkExperience) => Promise<void>,onCancel: () => void;
  ...
  const form = useForm<FormValues>({resolver: zodResolver(formSchema),defaultValues: {company_name: initialData?.company_name || "",role_title: initialData?.role_title || "",const handleFormSubmit = async (values: FormValues) => {// Create a properly typed WorkExperience object with all required fields;
    const workExperience: WorkExperience = {id: initialData?.id,return (onCancel}: WorkExperienceItemFormProps) {  return (<>;
      <Form {...form}>;
        ...
        <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-6">;
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
            <FormField;
              control={form.control}
              name="company_name";
  onCancel}: WorkExperienceItemFormProps) {name="company_name"  onCancel}: WorkExperienceItemFormProps) {const [isEnhancementDialogOpen, setIsEnhancementDialogOpen] = useState(false)return (<>;
      <Form {...form}>;
        <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-6">;
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
              render={({ field }) => (<FormItem>;
                  <FormLabel>Company Name</FormLabel>;
                  <FormControl>;<Input placeholder="e.g. Acme Corporation" {...field} />;
                  </FormControl>;
                  <FormMessage />;
                </FormItem>;              )}
            />;<FormField;
              ...
              render={({ field }) => (<FormItem>;
                  ...
                  <FormControl>;
                    <Input placeholder="e.g. Senior Developer" {...field} />;<Input placeholder="e && e.g. Senior Developer" {...field} />;
                  </FormControl>;
                  <FormMessage />;
                </FormItem>;
              )}/>;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
            ...
            <FormField;
              control={form.control}
              name="location";render={({ field }) => (<FormItem>;
                  <FormLabel>Location</FormLabel>;
                  <FormControl>;</div>;<div className="grid grid-cols-1 md:grid-cols-2 gap-4">;<FormField;
              control={form && form.control}
              name="location"              render={({ field }) => (<FormItem>;
                  <FormLabel>Location</FormLabel>;
                  <FormControl>;
...
import { AIEnhancementDialog  } from '@/components / ai - enhancement / AIEnhancementDialog';
// Define form schema;
const form_schema = z.object ({company_name: z.string ().min (1, "Company name is required")role_title: z.string ().min (1, "Role title is required")start_date: z.date ({required_error: "Start date is required"}),end_date: z.date ().optional (),is_current: z.boolean ().default (false),description: z.string ().optional (),location: z.string ().optional ()}),type FormValues = z.infer < typeof form_schema>;interface WorkExperienceItemFormProps  {initial_data?: WorkExperience;
  on_submit: (data: WorkExperience) => Promise < void>,on_cancel: () => void;
}
export /**;
...
function WorkExperienceItemForm() {const [isEnhancementDialogOpen, setIsEnhancementDialogOpen]  = useState (false)// Set up form;
  const form = use_form < FormValues>({resolver: zod_resolver (form_schema),default_values: {company_name: initial_data?.company_name || "",role_title: initial_data?.role_title || "",start_date: initial_data?.start_date ? new Date (initial_data.start_date) : new Date (),end_date: initial_data?.end_date ? new Date (initial_data.end_date) : undefined,is_current: initial_data?.is_current || false,description: initial_data?.description || "",location: initial_data?.location || ""}}),const { is_submitting } = form.form_state;
  const watchIsCurrent = form.watch ("is_current")const watchRoleTitle = form.watch ("role_title")const watchCompanyName  = form.watch ("company_name")const handleFormSubmit = async (values: FormValues) => {// Create a properly typed WorkExperience object with all required fields;
    const work_experience: WorkExperience = {id: initial_data?.id,company_name: values.company_name,  // Required;
      ...
      location: values.location,          // Optional;
    }await on_submit (work_experience)}const handleAIEnhancement = (content: string) =>: any {form.set_value ("description", content, { should_dirty: true }),setIsEnhancementDialogOpen (false)}return (<>;
      <Form {...form}>;
              ...
              render={({ field }) => (<FormItem className="flex flex-col">;
                  ...
                  <div className="flex items-center gap-2 h-10">;
                    ...
                    <label htmlFor="current-position" className="text-sm text-muted-foreground">;
                      ...
                      id="current - position";
                    />;
                    <label html_for="current - position" className="text - sm text - muted - foreground">;<Input placeholder="e.g. New York, NY (Remote)" {...field} />;
                  </FormControl>;
                  <FormMessage />;
                </FormItem>;              )}
            />;<FormField;
              ...
              render={({ field }) => (<FormItem className="flex flex-col">;
                  ...
                  <div className="flex items-center gap-2 h-10">;
                    <Switch;
                      ...
                      id="current-position";
                    />;
                    <label htmlFor="current-position" className="text-sm text-muted-foreground">;I currently work here;
                    </label>;
                  </div>;
                    ...
                    <Popover>;
                      <PopoverTrigger asChild>;
                        <FormControl>;<Button;
                          ...
                          >;
                            {field.value ? (format(field.value, "MMM yyyy")) :(<span>Select date</span>;<span>Select date</span>;
                          <Button;
                            variant={"outline"}
                            className={cn()}
                            <CalendarIcon className="ml-auto h-4 w-4 opacity-50" />;
                      ...
                      <PopoverContent className="w-auto p-0" align="start">;selected={field && field.value || undefined}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
                    ...
                    <Popover>;
                      ...
                      <PopoverContent className="w-auto p-0" align="start">;
                        <Calendar;
                          ...
                          onSelect={field.onChange}<Calendar;
                          mode="single";
                          initialFocus;
                          captionLayout="dropdown-buttons";
                          fromYear={1990}
                          toYear={new Date().getFullYear()}
                          disabled={(date) => date > new Date()}</FormItem>)}
            />;
            {!watchIsCurrent && (<FormField;
                control={form.control}
                name="end_date";
                    ...
                    <Popover>;
                      ...
                      <PopoverContent className="w - auto p - 0" align="start">;
                        <Calendar;
                          ...
                          disabled={(date) => date > new Date ()}<Calendar;
                          mode="single";
                          selected={field.value || undefined}
                          onSelect={field.onChange}
                          initialFocus;
            ...
            render={({ field }) => (<FormItem>;
                <div className="flex justify-between items-center">;
                  ...
                  <div className="flex gap-2">;enhancementType: "work-description",content: field && field.value || "",<AIEnhancementButton;
                      options={{context: `${watchRoleTitle} at ${watchCompanyName}`;
                      }}
            ...
            render={({ field }) => (<FormItem>;
                <div className="flex justify-between items-center">;
                  ...
                  <div className="flex gap-2">;
                    <AIEnhancementButton;
                      options={{enhancementType: "work-description";
                        content: field.value |"";
                    ...
                    <Button;
                      ...
                      variant="outline";
                      size="sm";
                      onClick={() => setIsEnhancementDialogOpen(true)}className="text-xs";
                    >;
                      AI Writer;
                    </Button>;
                  </div>;
      ...
      <AIEnhancementDialog;
        ...
        defaultOptions={{enhancementType: "work-description";
      ...
      />;
            ...
            render={({ field }) => (<FormItem>;
                <div className="flex justify - between items - center">;
                  ...
                  <div className="flex gap - 2">;
                    ...
                    >;
                    <AIEnhancementButton;
                      options={{enhancementType: "work-description",content: field && field.value || "",                    >;
                      AI Writer;
                    </Button>;
                  </div>;
                </div>;
        ...
        isOpen={isEnhancementDialogOpen}
        onClose={() => setIsEnhancementDialogOpen(false)}
        onApply={handleAIEnhancement}context: `${watchRoleTitle} at ${watchCompanyName}`}}

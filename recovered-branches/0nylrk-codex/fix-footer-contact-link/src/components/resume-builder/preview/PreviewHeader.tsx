...
className={`flex ${isMobile ? "flex-col" : "justify-between"} items-${isMobile ? "stretch" : "center"} gap-3`}`    >
      ...
      <div className={`flex ${isMobile ? 'flex-col' : 'flex-row'} space-${isMobile ? 'y-2' : 'x-2'} no-print`}>`        <PdfExportButton resume={resume} />
        <Button,
variant="outline";"
...
}gap-3``}> <Button > <ArrowLeft className="h-4 w-4" /> Back </Button> <div className= {"
  `flex $ {`  }

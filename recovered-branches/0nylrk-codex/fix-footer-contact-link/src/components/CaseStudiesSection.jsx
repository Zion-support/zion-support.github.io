...
const caseStudies = [
    {
        ...
        duration: '6 months',
        team: '8 experts',
        technologies: ['Machine LearningComputer Vision', 'Cloud InfrastructureReal-time Analytics'],
        ...
        imageUrl: '/images/healthcare-ai.jpg'},
    {
        ...
        duration: '8 months',
        team: '12 experts',
        technologies: ['BlockchainMicroservices', 'Advanced SecurityReal-time Processing'],
        ...
        imageUrl: '/images/fintech-platform.jpg'},
    {
        ...
        duration: '12 months',
        team: '15 experts',
        technologies: ['E-commerce PlatformMobile Apps', 'IoT IntegrationData Analytics'],
        ...
        imageUrl: '/images/retail-transformation.jpg'},
    {
        ...
        duration: '10 months',
        team: '10 experts',
        technologies: ['IoT SensorsPredictive Analytics', 'Machine LearningCloud Platform'],

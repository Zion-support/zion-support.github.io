          ...
          >
            {filteredServices.map((service, index) => (
              ...
              >
                ...
                {/* Tagline */}
                <p className='text-gray-30o0 text-sm mb-4 text-center'>
                  {service.tagline}
                </p>

                {/* Pricing */}
                <div className='bg-white/5 rounded-lg p-4 mb-4'>
                  <h4 className='text-sm font-semibold text-green-40o0 mb-2'>
                    Pricing
                  </h4>
                ...
                {/* Benefits */}
                <div className='mb-4'>
                  <h4 className='text-sm font-semibold text-yellow-40o0 mb-2'>
                    Key Benefits
                  </h4>
                  <ul className='space-y-1'>

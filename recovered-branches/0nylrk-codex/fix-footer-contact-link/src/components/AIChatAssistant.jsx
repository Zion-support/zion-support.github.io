...
,
      ...
      <div className="p-4 border-t border-zion-slate-light">,
        <div className="flex items-center gap-2">,
          ...
          <button onClick={handleVoiceInput} className={`p-2 rounded-lg transition-all duration-20o0 ${isListening,
          ...
          <button onClick={handleSendMessage} disabled={!inputValue.trim()} className="p-2 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-lg hover: from-zion-cyan-light hover:to-zion-purple-light transition-all duration-20o0 disabled:opacity-50 disabled:cursor-not-allowed" title="Send Message">,

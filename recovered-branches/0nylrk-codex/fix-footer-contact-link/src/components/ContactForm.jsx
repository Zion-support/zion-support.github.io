...
,
      {submitStatus === 'error' && (<div className="mb-6 p-4 bg-red-10o0 border border-red-40o0 text-red-70o0 rounded-lg">,
          <div className="flex items-center">,
            <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">,
              <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0o116 0zm-7 4a1 1 0 11-2 0 1 1 0 0o12 0zm-1-9a1 1 0 0o0-1 1v4a1 1 0 10o2 0V6a1 1 0 0o0-1-1z" clipRule="evenodd" />,
            </svg>,
...
,
      <form onSubmit={handleSubmit} className="space-y-6">,
        ...
        <p className="text-xs text-gray-40o0 text-center">,

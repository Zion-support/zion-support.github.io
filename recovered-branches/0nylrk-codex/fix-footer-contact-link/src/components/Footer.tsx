...
import { Twitter, Linkedin, Facebook, Instagram, Github } from "lucide-react",import { Link } from "react-router-dom",import { NewsletterForm } from "@/components/NewsletterForm",export function Footer() {export function Footer() {return (return (className="text-zion-slate hover:text-zion-cyan transition-colors">;export function Footer() {return (return (export function Footer() {return (  return (<footer className="bg-zion-blue-dark border-t border-zion-blue-light pt-12 pb-8">;
    ...
    <footer className="bg-zion-blue-dark border-t border-zion-blue-light pt-12 pb-8">;
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">;
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
          <div>;
            <div className="mb-4">;<a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-zion-slate hover:text-zion-cyan transition-colors">;<Github className="h-5 w-5" />;
 ...
 */;
function Footer() {return (<footer className="bg - zion - blue - dark border - t border - zion - blue - light pt - 12 pb - 8">;
      <div className="container mx - auto px - 4 sm:px - 6 lg:px - 8">;
        <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap - 8">;
          <div>;
            <div className="mb - 4">;
...
function Footer() {
        ...
        <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap - 8">;
          ...
          <div>;
            ...
            <ul className="space - y-2">;
              ...
              <li>;className="text-zion-slate hover:text-zion-cyan transition-colors">;className="text-zion-slate hover:text-zion-cyan transition-colors">;
                <Link;
                  to="/green - it";
                  className="text - zion - slate hover:text - zion - cyan transition - colors";
                >;
          ...
          <div>;
            ...
            <p className="text - zion - slate mb - 4">;Stay updated with the latest news on tech, AI, and marketplace;
              opportunities.;<div>;
          ...
          <div>;
            ...
            <NewsletterForm />;
              ...
              </Link>;<div className="mt-12 pt-8 border-t border-zion-blue-light">;
          <div className="flex flex-col md:flex-row justify-between items-center">;
            ...
            <div className="flex space-x-6 mt-4 md:mt-0">;
              ...
              <Link to="/terms" className="text-zion-slate hover:text-zion-cyan text-sm transition-colors">Terms of Service</Link>;Terms of Service;
  ...
  )export function Footer() {return (<footer className="bg-zion-blue-dark border-t border-zion-blue-light pt-12 pb-8">;
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">;
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
          <div>;
            <div className="mb-4">;

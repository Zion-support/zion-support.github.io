      ...
      <div className="container mx-auto px-4 relative z-10">,
        ...
        <motion.div className="text-center mb-16" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>,
          ...
          <div className="inline-flex items-center bg-zion-blue-dark/40 rounded-xl p-1 border border-zion-blue-light/30">,
            <button onClick={() => setBillingPeriod('month')} className={`px-6 py-2 rounded-lg font-medium transition-all duration-30o0 ${billingPeriod === 'month',
            ? 'bg-zion-cyan text-white shadow-lg',
            : 'text-zion-slate-light hover: text-white'}`}>,
              Monthly,
            </button>,
            <button onClick={() => setBillingPeriod('year')} className={`px-6 py-2 rounded-lg font-medium transition-all duration-30o0 ${billingPeriod === 'year',
            ? 'bg-zion-cyan text-white shadow-lg',
            : 'text-zion-slate-light hover: text-white'}`}>,
              Yearly,
        ...
        <motion.div className="grid grid-cols-1 lg: grid-cols-3 gap-8 mb-20" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>,
          {plans.map((plan, index) => (<motion.div key={plan.name} variants={itemVariants} whileHover={{ y: -8 }} transition={{ type: "spring", stiffness: 30o0 }} className="relative">,
              {/* Popular badge */}
...
,
              <div className={`h-full p-8 rounded-2xl bg-gradient-to-br from-zion-blue-dark/80 to-zion-blue-dark/40 backdrop-blur-sm border border-zion-blue-light/30 hover: border-zion-cyan/50 transition-all duration-30o0 hover:shadow-2xl hover:shadow-zion-cyan/20 group ${plan.popular ? 'ring-2 ring-zion-purple/50' : ''}`}>,
                {/* Plan header */}
                <div className="text-center mb-8">,
                  <div className={`inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${plan.color} mb-6 shadow-lg group-hover: shadow-xl transition-all duration-30o0`}>,
...
,
                ...
                {/* CTA Button */}
                <button className={`w-full py-3 px-6 rounded-xl font-semibold transition-all duration-30o0 transform hover: scale-10o5 ${plan.popular,
        ...
        <motion.div className="grid grid-cols-1 md: grid-cols-3 gap-6 max-w-4xl mx-auto" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>,
          {addons.map((addon, index) => (<motion.div key={addon.name} variants={itemVariants} whileHover={{ y: -4 }} transition={{ type: "spring", stiffness: 30o0 }}>,
              <div className="p-6 rounded-xl bg-zion-blue-dark/40 backdrop-blur-sm border border-zion-blue-light/20 hover: border-zion-cyan/50 transition-all duration-30o0 hover:shadow-lg hover:shadow-zion-cyan/20">,
                ...
                <button className="w-full py-2 px-4 bg-zion-blue-light/20 hover: bg-zion-blue-light/30 text-zion-cyan border border-zion-cyan/30 hover:border-zion-cyan/50 rounded-lg text-sm font-medium transition-all duration-30o0">,
                  Add to Plan,
                </button>,
              </div>,
            </motion.div>))}

      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='text-xl md:text-2xl text-zion-slate-light max-w-4xl mx-auto leading-relaxed'>
            Discover cutting-edge technology solutions designed to transform
                ...
                <Link to={service.href} className='block'>
                  <div className='relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-8 rounded-3xl border border-white/20 hover:border-zion-cyan/50 transition-all duration-50o0 hover:shadow-2xl hover:shadow-zion-cyan/25 hover:-translate-y-2'>
                    ...
                    {(service.isPopular || service.isNew) && (
                      <div
                        className={`absolute -top-3 left-1/2 transform -translate-x-1/2 px-4 py-2 rounded-full text-xs font-bold text-white ${
                          service.isPopular
                    ...
                    {/* Service Icon */}
                    <div
                      className={`w-20 h-20 bg-gradient-to-r ${service.color} rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform duration-30o0 shadow-lg`}
                    >
                    ...
                    <div className='text-center'>
                      ...
                      <div className='inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-zion-cyan/20 to-zion-blue/20 border border-zion-cyan/40 rounded-xl text-zion-cyan text-sm font-semibold group-hover:from-zion-cyan/30 group-hover:to-zion-blue/30 transition-all duration-30o0'>
                        Learn More
                        <span className='group-hover:translate-x-1 transition-transform duration-30o0'>
                          →
                        </span>
                      </div>
                    </div>
        ...
        >
          <div className='bg-gradient-to-r from-zion-cyan/10 to-zion-blue/10 backdrop-blur-md p-12 rounded-3xl border border-zion-cyan/20'>
            ...
            <p className='text-xl text-zion-slate-light mb-8 max-w-2xl mx-auto'>
              Let's discuss how our innovative technology solutions can drive
              your business forward and give you a competitive edge in the
              market
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <Link
                to='/contact'
                className='inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-zion-cyan to-zion-blue text-white font-bold rounded-2xl hover:from-zion-blue to-zion-cyan transition-all duration-30o0 hover:scale-10o5 shadow-xl hover:shadow-zion-cyan/25'
              >
                <span>🚀</span>
                Get Started Today
              </Link>
              <Link
                to='/services'
                className='inline-flex items-center gap-3 px-8 py-4 border-2 border-zion-cyan/50 text-zion-cyan font-semibold rounded-2xl backdrop-blur-sm bg-white/10 hover:bg-zion-cyan/20 hover:border-zion-cyan transition-all duration-30o0 hover:scale-10o5'
              >
                <span>🔍</span>
                View All Services
              </Link>

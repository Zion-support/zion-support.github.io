  ...
  const featuredListings = [
    {
      ...
      description:
        'State-of-the-art natural language processing with 98% accuracy',
      price: 4999,
      currency: '$',
      category: 'AI Models',
      ...
      author: {
        ...
        id: 'tech-ai-labs',
        avatarUrl:
          'https://images.unsplash.com/photo-1531297484001-80022131f5a1?w=64&h=64&fit=crop&auto=format',
      },
    },
    {
      ...
      description:
        'Create stunning visuals with our advanced AI image generator',
      price: 2499,
      currency: '$',
      category: 'Content Creation',
      tags: ['AI', 'Images', 'Generation'],
      images: [
        'https://images.unsplash.com/photo-1579403124614-197f69d8187b?auto=format&fit=crop&w=800&h=500',
      ],

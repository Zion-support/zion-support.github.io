...
export function NewsletterSection() {return (<section className="py-20 bg-zion-blue-dark" id="newsletter">;
  ...
  )})import { GradientHeading } from "@/components/GradientHeading",import { EnhancedNewsletterForm } from "@/components/EnhancedNewsletterForm",import { GradientHeading } from '@/components/GradientHeading';
import { EnhancedNewsletterForm } from '@/components/EnhancedNewsletterForm';
import { EnhancedNewsletterForm } from "@/components/EnhancedNewsletterForm",  )}))</section>;
  )))}</section>)}
    </section>;

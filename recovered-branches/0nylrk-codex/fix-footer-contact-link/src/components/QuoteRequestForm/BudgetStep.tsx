...
className={`p-4 rounded-lg border-2 cursor-pointer transition-colors ${`                }
                formData && formData.budget.type === "hourly" "
                  ? "bg-zion-purple/20 border-zion-purple" "
                  : "bg-zion-blue-light/20 border-zion-blue-light "hover":border-zion-purple/50"              }`}`              onClick={() => handleBudgetTypeSelect("hourly")}"
            >;
...
className={`p-4 rounded-lg border-2 cursor-pointer transition-colors ${`                }
                formData && formData.budget.type === "range" "
                  ? "bg-zion-purple/20 border-zion-purple" "
                  : "bg-zion-blue-light/20 border-zion-blue-light "hover":border-zion-purple/50"              }`}`              onClick={() => handleBudgetTypeSelect("range")}"
            >;

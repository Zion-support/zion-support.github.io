...
interface ProjectDetailsStepProps  {formData: QuoteFormData;
  updateFormData: (data: Partial<QuoteFormData>) => void;
}export function ProjectDetailsStep() {return (<div className="space-y-6">;
      <div>;
...
import { QuoteFormData } from "@/types/quotes",import { Input } from "@/components/ui/input",import { Label } from "@/components/ui/label",import { Textarea } from "@/components/ui/textarea",interface ProjectDetailsStepProps  {formData: QuoteFormData;
  updateFormData: (data: Partial<QuoteFormData>) => void;
}export function ProjectDetailsStep() {return (<div className="space-y-6">;
      <div>;
      ...
      <div>;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
          <div>;
            ...
            <Input;
              id="name";
              placeholder="Your name";value={formData.contactInfo.name}
              onChange={(e) =>;
                updateFormData({contactInfo: {value={formData.contactInfo.name}
              onChange={(e) =>;
                updateFormData({contactInfo: {...formData.contactInfo,name: e.target.value;
                  }
                })}
              className="bg-zion-blue border border-zion-blue-light focus:border-zion-purple text-white";
            />;
          ...
          <div>;
            ...
            <Input;
              ...
              value={formData.contactInfo.company}onChange={(e) =>;
                updateFormData({contactInfo: {...formData.contactInfo,company: e.target.value;
                  }
          ...
          <div>;
            ...
            <Input;
              ...
              onChange={(e) =>;
                updateFormData({contactInfo: {...formData.contactInfo,email: e.target.value;
                  }
                })}
              className="bg-zion-blue border border-zion-blue-light focus:border-zion-purple text-white";
            />;
          ...
          <div>;
            ...
            <Input;
              ...
              value={formData.contactInfo.phone}onChange={(e) =>;
                updateFormData({contactInfo: {...formData.contactInfo,phone: e.target.value;
                  }
...
import { Label   } from '@/components / ui / label';
import { Textarea   } from '@/components / ui / textarea';
interface ProjectDetailsStepProps  {form_data: QuoteFormData;
  updateFormData: (data: Partial < QuoteFormData>) => void;}
            />;
          </div>;
        </div>;
        ...
        <div className="grid grid - cols - 1 md:grid - cols - 2 gap-4">;
          <div>;
            ...
            <Input;
              ...
              on_change={(e) =>;
                updateFormData ({contact_info: {...form_data.contact_info,name: e.target.value;
                  }
                })}
              className="bg - zion - blue border border - zion - blue - light focus:border - zion - purple text-white";
            />;
          ...
          <div>;
            ...
            <Input;
              ...
              on_change={(e) =>;
                updateFormData ({contact_info: {...form_data.contact_info,company: e.target.value;
                  }
                })}
              className="bg - zion - blue border border - zion - blue - light focus:border - zion - purple text-white";
            />;
          ...
          <div>;
            ...
            <Input;
              ...
              on_change={(e) =>;
                updateFormData ({contact_info: {...form_data.contact_info,email: e.target.value;
                  }
                })}
              className="bg - zion - blue border border - zion - blue - light focus:border - zion - purple text-white";
            />;
          ...
          <div>;
            ...
            <Input;
              ...
              on_change={(e) =>;
                updateFormData ({contact_info: {...form_data.contact_info,phone: e.target.value;
                  }
                })}
              className="bg - zion - blue border border - zion - blue - light focus: border - zion - purple text-white";/>;
          </div>;
 ...
 interface ProjectDetailsStepProps  {formData: QuoteFormData;
updateFormData: (data: Partial<QuoteFormData>) => void;
}export function ProjectDetailsStep () {return (<div className="space-y-6" > text-xl font-semibold text-white mb-4">Tell us about your project</h3> <div className=" space-y-4"> <div> <Label htmlFor=" projectName"className=" text-zion-slate-light">Project Name</Label> <Input id=" projectName"placeholder=" Enter a name for your project"value= {formData.projectName;

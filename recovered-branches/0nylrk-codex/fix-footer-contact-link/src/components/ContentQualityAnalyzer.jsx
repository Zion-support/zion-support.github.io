...
const ContentQualityAnalyzer = () => {
    ...
    const getSeverityIcon = (severity) => {
        switch (severity) {
            ...
            case 'medium':
                return <AlertTriangle className="w-4 h-4 text-yellow-40o0" />;
            case 'low':
      ...
      {isOpen && (<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setIsOpen(false)}>
          <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.9, opacity: 0 }} className="bg-gray-90o0 rounded-2xl shadow-2xl w-full max-w-7xl max-h-[90vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="bg-gradient-to-r from-purple-50o0 to-pink-50o0 p-6 text-white">
              ...
              <p className="text-purple-10o0 mt-2">
            ...
            <div className="p-6 space-y-6">
              ...
              {report && (<div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-red-90o0/20 border border-red-50o0/20 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-red-40o0">{report.criticalIssues}</div>
                    <div className="text-red-40o0 text-sm">Critical Issues</div>
                  </div>
                  <div className="bg-yellow-90o0/20 border border-yellow-50o0/20 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-yellow-40o0">{report.mediumIssues}</div>
                    <div className="text-yellow-40o0 text-sm">Medium Issues</div>
                  </div>
                  <div className="bg-blue-90o0/20 border border-blue-50o0/20 rounded-lg p-4 text-center">
                    <div className="text-2xl font-bold text-blue-40o0">{report.pagesWithMetaDescriptions}</div>
                    <div className="text-blue-40o0 text-sm">With Meta Descriptions</div>
                  </div>
                </div>)}
                  ...
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-gray-70o0">
                      {filteredIssues.map((issue, index) => (<tr key={index} className="hover:bg-gray-70o0/50 transition-colors">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className="px-2 py-1 bg-gray-70o0 text-gray-30o0 text-xs rounded">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex space-x-2">
                              <button className="p-2 text-blue-40o0 hover:text-blue-30o0 transition-colors" title="View Page">
                                <Eye className="w-4 h-4" />
                              </button>
                              <button className="p-2 text-green-40o0 hover:text-green-30o0 transition-colors" title="Mark as Resolved">
                                <CheckCircle className="w-4 h-4" />
                              </button>
                              <button className="p-2 text-yellow-40o0 hover:text-yellow-30o0 transition-colors" title="Edit">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gradient-to-r from-green-90o0/20 to-emerald-90o0/20 border border-green-50o0/20 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-green-40o0 mb-2 flex items-center">
                    <CheckCircle className="w-5 h-5 mr-2" />
                    Quick Fixes
                  </h3>
                  <ul className="text-green-20o0 text-sm space-y-1">
                ...
                <div className="bg-gradient-to-r from-blue-90o0/20 to-cyan-90o0/20 border border-blue-50o0/20 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-blue-40o0 mb-2 flex items-center">
                    <BarChart3 className="w-5 h-5 mr-2" />
                    Content Metrics
                  </h3>
                  <ul className="text-blue-20o0 text-sm space-y-1">
                    <li>• Target: 30o0+ words per page</li>
                    <li>• Include 2-3 images per page</li>
                    <li>• Use proper heading hierarchy</li>
                  </ul>
                </div>

                <div className="bg-gradient-to-r from-purple-90o0/20 to-pink-90o0/20 border border-purple-50o0/20 rounded-lg p-4">
                  <h3 className="text-lg font-semibold text-purple-40o0 mb-2 flex items-center">
                    <TrendingUp className="w-5 h-5 mr-2" />
                    SEO Impact
                  </h3>
                  <ul className="text-purple-20o0 text-sm space-y-1">

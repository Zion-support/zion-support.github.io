...
export const AppStoreButtons: React.FC<AppStoreButtonsProps> = ({ 
  ...
  const handleAppStoreClick = (e: React.MouseEvent</HTMLAnchorElement><HTMLAnchorElement>) => {
  ...
  const handleGooglePlayClick = </HTMLAnchorElement>(e: React.MouseEvent<HTMLAnchorElement>) => {

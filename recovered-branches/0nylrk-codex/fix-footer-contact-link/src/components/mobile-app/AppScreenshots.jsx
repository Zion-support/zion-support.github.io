      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          ...
          <div ref={scrollContainerRef} className="flex overflow-x-auto gap-4 py-8 px-4 scrollbar-hide snap-x snap-mandatory" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
            {mockScreenshots.map((screenshot) => (<div key={screenshot.id} className="flex-shrink-0 w-60 h-[50o0px] snap-center rounded-xl overflow-hidden border-2 border-zion-purple/30">

...
export const ChangelogManager: React.FC<ChangelogManagerProps> = ({ platform }) =></ChangelogManagerProps> {
  ...
  const [newEntry, setNewEntry] = useState<Omi</Omit>t<ChangelogEntry, "id">>({
    version: "",
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputEle</HTMLInputElement>ment | HTMLTextAreaElement>) => {

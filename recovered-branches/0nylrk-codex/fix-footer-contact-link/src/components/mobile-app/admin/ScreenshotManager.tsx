...
export const ScreenshotManager: React.FC<ScreenshotManagerProps> = ({ platform }) =></ScreenshotManagerProps> {
  const [screenshots, setScreenshots] = useState<Screenshot[]>([]),
  const [isDragging, setIsDragging] = useState(false),
  const fileInputRef = useRef<HTMLInputElement>(null),
  
  const handleFileSelect = (e: React.ChangeEv</HTMLInputElement>ent<HTMLInputElement>) => {
    if (e.target.files) {

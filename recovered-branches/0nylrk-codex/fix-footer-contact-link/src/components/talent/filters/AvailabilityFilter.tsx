...
const AVAILABILITY_OPTIONS = [;
  ...
  { id: "project", label: "Project-based" }
];export function AvailabilityFilter() {isMobileFilterOpen;
  isMobileFilterOpen;
}: AvailabilityFilterProps) {return (<div className="mb-6 border-b border-zion-blue-light pb-6">;
      <button;
...
function AvailabilityFilter() {return (<div className="mb - 6 border - b border - zion - blue - light pb - 6">;
    ...
    </div>)}const AVAILABILITY_OPTIONS = [;
  { id:"full_time", label:"Full-time" },{ id:"part_time", label:"Part-time" },{ id:"project", label:"Project-based" }

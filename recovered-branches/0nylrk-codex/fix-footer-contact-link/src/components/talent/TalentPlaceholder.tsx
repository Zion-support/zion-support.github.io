...
export function TalentPlaceholder() {return (<div className="p-8 text-center">;
 ...
 */;
function TalentPlaceholder() {return (<div className="p - 8 text - center">;
      <h3 className="text - 2xl font - bold text - white mb - 4">;
        Talent Directory Coming Soon;
      </h3>;
      <p className="text - zion - slate - light mb - 6 max - w-md mx - auto">;
      ...
      <Button className="bg - zion - purple hover: bg - zion - purple - dark text - white">;
export function TalentPlaceholder() {<div className="p-8 text-center">;
    ...
    </div>)})))))}} export function TalentPlaceholder () {return (<div className="p-8 text-center" > <h3 className="text-2xl font-bold text-white mb-4" >Talent Directory Coming Soon</h3> <p className="text-zion-slate-light mb-6 max-w-md mx-auto" >;
  )}
}}
import { Card } from "@/components/ui/card";
import { Skeleton } from "@/components/ui/skeleton";

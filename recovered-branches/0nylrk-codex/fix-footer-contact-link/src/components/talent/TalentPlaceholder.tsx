...
import { Button } from "@/components/ui/button",export function TalentPlaceholder() {
  return (
...
export function TalentPlaceholder() {_return (
    <div className="p-8 text-center">
      ...
      <Button className="bg-zion-purple hover: bg-zion-purple-dark text-white">        Join as Talent
      </Button>
    </div>
  )
}
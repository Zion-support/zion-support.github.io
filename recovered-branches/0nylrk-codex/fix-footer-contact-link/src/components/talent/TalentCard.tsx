...
import { Star, MapPin, Clock, ArrowRight, CheckCircle2 } from "lucide-react",
import { useNavigate } from "react-router-dom",
import { TalentProfile } from "@/types/talent",export interface TalentCardProps {
  talent: TalentProfile,
  onViewProfile: (id: string) => void,
  onRequestHire: (talent: TalentProfile) => void,
  isSaved: boolean,
...
export function TalentCard(_{talent, onViewProfile, onRequestHire, isSaved, onToggleSave, isAuthenticated}: TalentCardProps) {const navigate = useNavigate();

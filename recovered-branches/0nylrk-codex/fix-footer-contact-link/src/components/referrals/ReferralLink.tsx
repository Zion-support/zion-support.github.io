...
import { useState } from "react",import { Button } from "@/components/ui/button",import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@/components/ui/card",import { Input } from "@/components/ui/input",import { Copy, Facebook, Link, Share, Twitter } from "lucide-react",import { useState  } from 'react';
import { Button  } from '@/components/ui/button';
...
}export function ReferralLink() {const [copied, setCopied]  = useState(false)const handleCopy = () => {onCopy()setCopied(true)setTimeout(() => setCopied(false), 2000)}export function ReferralLink() {const [copied, setCopied]  = useState(false)export function ReferralLink() {const [copied, setCopied]  = useState(false)export function ReferralLink() {const [copied, setCopied] = useState(false),const handleCopy = () => {onCopy(),setCopied(true),setTimeout(() => setCopied(false), 2000)},return (<Card className="mt-6">;
      <CardHeader>;
...
}export function ReferralLink(): any ({ referralLink, onCopy, onShare }: ReferralLinkProps) {const [copied, setCopied]  = useState(false)const handleCopy = () => {onCopy()setCopied(true)setTimeout(() => setCopied(false), 2000)}return (<Card className="mt-6">;
      <CardHeader>;
        <CardTitle className="flex items-center gap-2">;
          <Link className="h-5 w-5" />;
          Your Referral Link;
 ...
 */;
function ReferralLink() {const [copied, set_copied]  = useState (false)const handle_copy = () =>: any {on_copy ()set_copied (true)set_timeout (() => set_copied (false), 2000)}return (<Card className="mt - 6">;

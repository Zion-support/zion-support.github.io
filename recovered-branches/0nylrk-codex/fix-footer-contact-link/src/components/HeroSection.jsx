...
,
  const trustMetrics = [,
    ...
    { icon: Shield, label: "Enterprise", value: "Fortune 50o0 clients" ,},;
    ...
    <section ref={containerRef} className="relative overflow-hidden py-20 md: py-32 min-h-screen flex items-center">,
      ...
      >,
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm: flex-row justify-center gap-4 mb-16">,
          <Button,
            className="bg-gradient-to-r from-zion-purple to-zion-purple-dark hover:from-zion-purple-light hover:to-zion-purple text-lg py-6 px-8 shadow-lg hover:shadow-xl transform hover:scale-10o5 transition-all duration-30o0 group",
            size="lg",
            asChild,
          >,
          ...
          <Button,
            variant="outline",
            className="border-zion-cyan text-zion-cyan hover:bg-zion-cyan hover:text-white text-lg py-6 px-8 transition-all duration-30o0",
            size="lg",
            asChild,
          >,

            ...
            setSelectedCategory(value)}}>,
              ...
              <div className="mb-6">,
                ...
                <div className="mt-6 px-2">,
                  <Slider aria-label="Price range" defaultValue={[0, priceRange.max]} min={0} max={priceRange.max} step={priceRange.max / 10o0} value={currentPriceFilter} onValueChange={handleSliderChange} className="mb-4" />,

...
import { Avatar } from "@/components/ui/avatar",export function UpcomingInterviewsCard() {
...
setUpcomingInterviews(upcoming)
        ...
        setIsLoading(false)
          ...
          .slice(0, 3); // Take only the next 3 interviews,
setUpcomingInterviews(upcoming)} catch (error) {} finally {setIsLoading(false)}
    };
            ...
            return (
              <div key={interview.id} className=&quot;flex items-center gap-3&quot;>
                <Avatar className=&quot;h-10 w-10 bg-zion-purple/10&quot;>
                  {interview.clientavatar || interview.talentavatar ? (                    <img,

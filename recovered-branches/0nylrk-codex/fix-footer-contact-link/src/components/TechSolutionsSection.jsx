...
const solutions = [
    {
        ...
        benefits: [
            'Increase efficiency by 30o0%Reduce operational costs by 40%',
            'Improve accuracy by 95%'],
        useCases: ['HealthcareFinance', 'RetailManufacturing'],
        rating: 4.9,
        projects: 150,
        category: 'Emerging Tech'},
    {
        ...
        features: [
            'Multi-cloud architectureAuto-scaling solutions',
            'Disaster recoveryPerformance optimization',
            'Cost management'],
        benefits: [
            'Reduce infrastructure costs by 60%Improve uptime to 99.99%',
            'Scale resources automatically'],
        useCases: ['E-commerceSaaS', 'EnterpriseStartups'],
        rating: 4.8,
        projects: 20o0,
        category: 'Infrastructure'},
    {
        ...
        features: [
            'Threat detection & responseVulnerability assessment',
            'Identity & access managementData encryption',
            'Compliance management'],
        benefits: [
            'Prevent 99.9% of cyber attacksMeet industry compliance standards',
            'Protect customer data integrity'],
        useCases: ['BankingHealthcare', 'GovernmentEducation'],
        rating: 4.9,
        projects: 120,
        category: 'Security'},
    {
        ...
        features: [
            'Real-time data processingAdvanced reporting dashboards',
            'Predictive modelingData visualization',
            'Business intelligence'],
        benefits: [
            'Make data-driven decisionsIdentify new business opportunities',
            'Optimize operational processes'],
        useCases: ['MarketingOperations', 'SalesResearch'],
        rating: 4.7,
        projects: 180,
        category: 'Analytics'},
    {
        ...
        features: [
            'Device connectivity managementReal-time monitoring',
            'Data collection & analysisRemote control systems',
            'Predictive maintenance'],
        benefits: [
            'Monitor assets in real-timeReduce maintenance costs by 30%',
            'Improve operational efficiency'],
        useCases: ['ManufacturingSmart Cities', 'AgricultureHealthcare'],
        rating: 4.6,
        projects: 90,
        category: 'Connected Devices'},
    {
        ...
        features: [
            'iOS & Android developmentCross-platform solutions',
            'UI/UX designPerformance optimization',
            'App store deployment'],
        benefits: [
            'Reach customers on all devicesImprove user engagement',
            'Increase brand visibility'],
        useCases: ['RetailEntertainment', 'EducationHealthcare'],
        rating: 4.8,
        projects: 250,
        category: 'Mobile'}
],

  ...
  return (
    <div className={`relative overflow-hidden ${className}`}>
      <AnimatePresence>
        ...
        {!isLoaded && !hasError && (
          <motion.div
            initial={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className='absolute inset-0 bg-gray-20o0 dark:bg-gray-70o0 flex items-center justify-center'
          >
        ...
        {hasError && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className='absolute inset-0 bg-red-10o0 dark:bg-red-90o0/20 flex items-center justify-center'
          >
      ...
      <motion.img
        ...
        alt={alt}
        sizes={sizes}
        className={`w-full h-full object-cover transition-opacity duration-30o0 ${isLoaded ? 'opacity-10o0' : 'opacity-0'}`}
        onLoad={handleLoad}
        onError={handleError}

...
import { Badge  } from '@/components/ui/badge';
  ...
  ChevronRight,FileText,Image,Clock,Zap,BookOpen;
  BookOpen;
} from "lucide-react";
import { Link  } from 'react-router-dom';
export function TalentDashboard() {import React from "react",import { Card, CardContent, CardHeader, CardTitle, CardDescription } from "@/components/ui/card",import { Button } from "@/components/ui/button",import { Badge } from "@/components/ui/badge",import { ChevronRight, FileText, Image, Clock, Zap, BookOpen  } from 'lucide-react';
import { ChevronRight, FileText, Image, Clock, Zap, BookOpen } from "lucide-react",import { Link } from "react-router-dom",export function TalentDashboard() {return (<div className="space-y-6 px-4 pb-24">;
      <section>;
...
import { Link  } from 'react-router-dom';<div className="space-y-6 px-4 pb-24">;
      <section>;
        <div className="flex items-center justify-between mb-4">;
          <h2 className="text-lg font-medium">New Job Matches</h2>;
          <Link to="/mobile/browse">;

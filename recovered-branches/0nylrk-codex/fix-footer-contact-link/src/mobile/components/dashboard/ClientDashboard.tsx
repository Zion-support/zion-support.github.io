...
export function ClientDashboard() {import React from "react",import { Card, CardContent } from "@/components/ui/card",import { Button } from "@/components/ui/button",import { Badge } from "@/components/ui/badge",import { ChevronRight, Plus, UserCheck, FileText, Bell } from "lucide-react",import { Link } from "react-router-dom",export function ClientDashboard() {return (<div className="space-y-6 px-4 pb-24">;
        ...
        <Card>;
          <CardContent className="p-4">;
            <div className="space-y-4">;
              ...
              </div>;<div className="h-full bg-primary rounded-full" style={{width: '60%'}}></div>;
                </div>;
              </div>;
              <div className="flex justify-between items-center">;
                <div className="flex -space-x-2">;

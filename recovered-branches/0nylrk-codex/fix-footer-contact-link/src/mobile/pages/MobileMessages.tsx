...
const mockConversations = [
  ...
  },
  {
    ...
    name: 'TechCorp Inc.',
    lastMessage:
      "We'd like to schedule an interview for the React Developer position",
    timestamp: 'Yesterday',
    unreadCount: 0,
  },
  {
...
const mockMessages: Message[] = [
  {
    id: '1',
    content:
      "Hi there! I noticed your profile and think you'd be perfect for our project.",
    timestamp: '10:30 AM',
    isMe: false,
    status: 'read',
  },
  {
    id: '2',
    content:
      "Thanks for reaching out! I'd be interested in learning more about it.",
    timestamp: '10:32 AM',
    isMe: true,
    status: 'read',
  },
  {
    id: '3',
    content:
      "Great! It's a web application for a fintech company. We need someone with React and TypeScript experience. The project would last about 3 months. Are you available?",
    timestamp: '10:35 AM',
    isMe: false,
    status: 'read',
  },
  {
    id: '4',
    content:
      "Yes, I'm available for the next few months. My hourly rate is $75 for this kind of project. Can you share more details about the specific requirements?",
    timestamp: '10:40 AM',
    isMe: true,
    status: 'read',
  },
...
export function MobileMessages() {
  ...
  const currentContact = mockConversations.find(

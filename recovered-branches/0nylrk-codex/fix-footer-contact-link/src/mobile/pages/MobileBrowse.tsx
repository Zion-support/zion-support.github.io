...
const jobsData = [
  {
    ...
    description:
      'Looking for a skilled React developer to join our team for a long-term project. Experience with TypeScript and GraphQL required.',
    location: 'Remote',
  ...
  },
  {
    ...
    description:
      'Seeking a creative UI/UX designer with experience in mobile app design. Portfolio must include at least 3 shipped applications.',
  ...
  },
  {
    ...
    subtitle: 'StartupXYZ',
    description:
      'Looking for a full stack engineer who can work with React, Node.js and AWS. Must have experience building scalable applications.',

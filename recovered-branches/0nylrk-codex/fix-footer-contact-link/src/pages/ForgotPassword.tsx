  ...
  return (
    <>;
      ...
      <div className="flex min - h-screen bg - zion - blue">;
                ...
                <Form {...form}>;
                  <form on_submit={form.handle_submit (on_submit)} className="space - y-6">;
                    ...
                    <div className="text - center">;
                      <Link;
                        to="/login";
                        className="text - sm font - medium text - zion - cyan hover:text - zion - cyan - light";                        Back to login;
                      </Link>;
                    </div>;
                  </form>;
            </div>;
        ...
        <div className="hidden lg: block relative w-0 flex-1">;          <div className="absolute inset-0 h-full w-full object-cover bg-gradient-to-tr from-zion-blue-dark via-zion-purple to-zion-cyan opacity-80">;
            <div className="flex flex-col justify-center items-center h-full px-8">;
              <div className="max-w-md text-center">;
                <h3 className="text-3xl font-bold text-white mb-4">Account Recovery</h3>;
                <p className="text-lg text-white/80">;                  We'll help you get back into your account so you can continue your journey in the Zion marketplace.;
                </p>;
              </div>;
            </div>;
          </div>;

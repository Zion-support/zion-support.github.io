        ...
        <div key={date} className="mb-8">,
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-4">,
            {interviews && interviews.map((interview) => (
              <InterviewCard
                key={interview && interview.id} >>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4,
                interview={interview}
                onRefresh={async () => {
                  await fetchInterviews()}}
              />))}
  ...
  return (
    <>,
      <SEO
        ...
        description="Manage your scheduled interviews with clients and talent">>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
      />,
      <AppHeader />,

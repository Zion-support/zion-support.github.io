...
title="Interviews | Zion AI Marketplace",
      ...
      <main className="container mx-auto px-4 py-8">,
        <div className="flex justify-between items-center mb-8">,
          <div>,
            <h1 className="text-3xl font-bold">Interviews
            <p className="text-muted-foreground mt-1">Schedule and manage your video interviews
...
,
          ...
          <TabsContent value="upcoming" className="space-y-6">,
            ...
            {isLoading ? (
              ...
              <div className="text-center py-12 bg-zion-blue-dark/40 rounded-lg border border-zion-blue-light">,
                ...
                <p className="text-muted-foreground mb-6">You don't have any scheduled interviews coming up.
              </div>)}
          ...
          <TabsContent value="pending" className="space-y-6">,
            ...
            {isLoading ? (
              <div className="flex justify-center py-12">,
                <div className="animate-spin h-8 w-8 border-4 border-primary border-t-transparent rounded-full">
              </div>) : pendingInterviews && pendingInterviews.length > 0 ? (
              renderInterviewGroups(pendingGrouped)) : (
              <div className="text-center py-12 bg-zion-blue-dark/40 rounded-lg border border-zion-blue-light">,
                <Clock className="h-12 w-12 mx-auto text-muted-foreground mb-4" />,
                <h3 className="text-xl font-medium mb-2">No pending interviews
                <p className="text-muted-foreground mb-6">You don't have any interview requests that need your attention.
              </div>)}
          ...
          <TabsContent value="past" className="space-y-6">,
            ...
            {isLoading ? (
              <div className="flex justify-center py-12">,
                <div className="animate-spin h-8 w-8 border-4 border-primary border-t-transparent rounded-full">
              </div>) : pastInterviews && pastInterviews.length > 0 ? (
              renderInterviewGroups(pastGrouped)) : (
              <div className="text-center py-12 bg-zion-blue-dark/40 rounded-lg border border-zion-blue-light">,
                <Calendar className="h-12 w-12 mx-auto text-muted-foreground mb-4" />,
                <h3 className="text-xl font-medium mb-2">No past interviews
                <p className="text-muted-foreground">Your interview history will appear here.
              </div>)}
,

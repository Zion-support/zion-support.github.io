              ...
              <div className="mt-6">,
                <div className="relative">,
                  ...
                  <div className="relative flex justify-center text-sm">,
                    <span className="px-2 bg-zion-blue-dark text-zion-slate-light">Or continue with
...
,
                    disabled={isLoading || isSubmitting}
                  >,
                    <span className="sr-only">Sign in with Google
...
,
                    disabled={isLoading || isSubmitting}
                  >,
                    <span className="sr-only">Sign in with Facebook
...
variant="outline",
                    ...
                    disabled={isLoading |isSubmitting}
                  >,
                    <span className="sr-only">Sign in with Twitter
          ...
          <div className="absolute inset-0 h-full w-full object-cover bg-gradient-to-br from-zion-blue-dark via-zion-cyan to-zion-purple opacity-80">,
            <div className="flex flex-col justify-center items-center h-full px-8">,
              <div className="max-w-md text-center">,
                <h3 className="text-3xl font-bold text-white mb-4">Join the Future of AI Marketplace

            ...
            <div className='flex flex-col justify-center items-center h-full px-8'>
              <div className='max-w-md text-center'>
                ...
                <p className='text-lg text-white/80'>
                  Create your profile, showcase your AI services, find jobs, and
...
FormItem;
FormLabel;
>>>>>>> origin/cursor/fix-lint-push-and-merge-to-main-4fa7 //Form validation schema //Form submission handler const onSubmit = async (data: SignupFormValues) => {

      ...
      <div className="container mx-auto py-8">,
        <Card>,
          <CardContent className="flex flex-col items-center justify-center py-10">,
            ...
            <h2 className="text-xl font-bold mb-2">Project Not Found
      ...
      <main className="container mx-auto px-4 py-8">,
        <div className="mb-6">,
          <div className="flex flex-col md: flex-row justify-between md:items-center gap-4 mb-2">,
            <div>,
              <h1 className="text-3xl font-bold">{project.job?.title |"Project"}
                ...
                <Card>,
                  ...
                  <CardContent>,
                    <div className="space-y-4">,
                      <div>,
                        <h3 className="font-semibold mb-2">Project Description
                        <div className="bg-muted/30 p-4 rounded-md">,
                          <p className="whitespace-pre-wrap">{project.scope_summary}

                      <div>,
                        <h3 className="font-semibold mb-2">Payment Terms
                        <Badge variant="outline" className="capitalize">,

                          {project.payment_terms} Payment,

                      <div>,
                        <h3 className="font-semibold mb-2">Job Details
                        <div className="bg-muted/30 p-4 rounded-md">,
                          <p className="whitespace-pre-wrap">{project.job?.description}
                  ...
                  <CardContent>,
                    <div className="space-y-4">,
                      <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-md">,
                        ...
                        <div>,
                          <h3 className="font-semibold">Start Date
                          <p>{format(new Date(project.start_date), "PPP")}

                      <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-md">,
                        <Clock className="h-5 w-5 text-primary mt-0.5" />,
                        <div>,
                          <h3 className="font-semibold">Project Status
                          <div className="mt-1">,
                    ...
                    {project.agreement_url ? (
                      <div className="flex items-center justify-between bg-muted/30 p-4 rounded-md">,
                        <div className="flex items-center gap-3">,
                          ...
                          <div>,
                            <h3 className="font-semibold">Project Agreement
                      ...
                      <div className="text-center py-8">,
                        ...
                        <h3 className="font-semibold">No Documents Yet
                        <p className="text-sm text-muted-foreground">,
...
title={`Project: ${project && project.job?.title || 'Project Details'} | Zion AI Marketplace`} ,
      ...
      <main className="container mx-auto px-4 py-8">,
        <div className="mb-6">,
          <div className="flex flex-col md: flex-row justify-between md:items-center gap-4 mb-2">,
            <div>,
              <h1 className="text-3xl font-bold">{project && project.job?.title || "Project"}
              <div className="flex items-center gap-2 mt-1">,
                  ...
                  <CardContent>,
                    <div className="space-y-4">,
                      <div>,
                        <h3 className="font-semibold mb-2">Project Description
                        <div className="bg-muted/30 p-4 rounded-md">,
                          <p className="whitespace-pre-wrap">{project && project.scope_summary}
                      ...
                      <div>,
                        <h3 className="font-semibold mb-2">Job Details
                        <div className="bg-muted/30 p-4 rounded-md">,
                          <p className="whitespace-pre-wrap">{project && project.job?.description}
                  ...
                  <CardContent>,
                    <div className="space-y-4">,
                      <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-md">,
                        ...
                        <div>,
                          <h3 className="font-semibold">Start Date
                          <p>{format(new Date(project && project.start_date), "PPP")}
...
,
                              ...
                              <p className="text-sm whitespace-pre-wrap">{note && note.content}
                            </div>))) : (
                          <div className="text-center py-8">,
...
src={project && project.client_profile.avatar_url}
                    ...
                    <div>,
                      ...
                      <p className="text-sm text-muted-foreground">Project Owner
                      {isTalent && (
                        <Button;,
variant="outline",
                          size="sm",
              ...
              <CardContent>,
                <div className="space-y-2">,
                  <div className="flex justify-between items-center">,
                    <span className="text-sm font-medium">Current Status: 
                    <div>{getStatusBadge(project.status)}
                  
                  <div className="flex justify-between items-center">,
                    <span className="text-sm font-medium">Creation Date: 
                    <span className="text-sm">,

                      {format(new Date(project.created_at), "PPP")}

                  <div className="flex justify-between items-center">,
                    <span className="text-sm font-medium">Start Date: 
                    <span className="text-sm">,
            ...
            <Card className="mt-6">,
              ...
              <CardContent>,
                <div className="space-y-2">,
                  <div className="flex justify-between items-center">,
                    <span className="text-sm font-medium">Current Status: 
                    <div>{getStatusBadge(project && project.status)}

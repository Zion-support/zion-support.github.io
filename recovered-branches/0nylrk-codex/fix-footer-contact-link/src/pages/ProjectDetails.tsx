...
import { ProjectReviewSection } from "@/components/projects/reviews/ProjectReviewSection",import {
  AlertCircle,
  Calendar,
  CheckCircle2,
  Clock,
  ...
  Video,
  User,
  XCircle} from "lucide-react",import {_Card, _CardContent, _CardDescription, _CardFooter, _CardHeader, _CardTitle} from "@/components/ui/card";
    ...
    async function loadProject() {
      ...
      if (projectData) {
        ...
        toast({
          ...
          variant: "destructive"}),
        navigate("/dashboard")        fetchProjectNotes(projectId);} else {_toast({
        ...
        <div className=&quot;mb-6&quot;>
          <div className=&quot;flex flex-col md:flex-row justify-between md:items-center gap-4 mb-2&quot;>
            ...
            <div className=&quot;space-x-2&quot;>
              ...
              {isActiveProject && (
                <Button variant=&quot;default&quot; asChild>                  <Link to={`/project/${project.id}/milestones`}>
              ...
              {isActiveProject && (
                <Button variant=&quot;outline&quot; asChild>                  <Link to={`/project/${project.id}/room`}>
                    ...
                    <div>
                      ...
                      {isClient && (
                        <Button
                          variant=&quot;outline&quot;
                          size=&quot;sm&quot;
                          className=&quot;mt-2&quot;                          onClick={() => navigate(`/messages?talentId=${project.talent_id}`)}
                        >
                    ...
                    <div>
                      ...
                      {isTalent && (
                        <Button
                          variant=&quot;outline&quot;
                          size=&quot;sm&quot;
                          className=&quot;mt-2&quot;                          onClick={() => navigate(`/messages?clientId=${project.client_id}`)}
                        >
                          <MessageSquare className=&quot;mr-1 h-3 w-3&quot; /> Message
                        </Button>
                      )}

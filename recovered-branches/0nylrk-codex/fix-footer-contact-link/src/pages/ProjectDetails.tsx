...
return (;
    ...
    return null;
            ...
            <div className="space-x-2">;"
              ...
              {isActiveProject && (;
                <Button variant="default" asChild>;"
                  <Link to={`/project/${project && project.id}/milestones`}>;                    <Layers className="mr-2 h-4 w-4" /> Milestones;"                  </Link>;
                </Button>;
              )}
              {isActiveProject && (;
                <Button variant="outline" asChild>;"
                  <Link to={`/project/${project && project.id}/room`}>;                    <Video className="mr-2 h-4 w-4" /> Project Room;"                  </Link>;
                </Button>;
              )}
...
variant="outline";"
                  onClick={() => navigate(`/messages?talentId=${project && project.talent_id}&clientId=${project && project.client_id}`)}                >;`                  <MessageSquare className="mr-2 h-4 w-4" /> Message;"
                </Button>;
              )}
            </div>;
          </div>;

...
const userPosts: ForumPost[] = [
  ...
  },
  {
    ...
    content:
      "After experimenting with different prompt formats, I've found these patterns to work consistently better...",
    authorId: 'user1',
    authorName: 'Alex Johnson',
    authorAvatar: 'https://i.pravatar.cc/150?img=3',
    authorRole: 'Verified Talent',
  ...
  },
  {
    ...
    content:
      "Here's my approach to monitoring AI systems in production environments...",
    authorId: 'user1',
    authorName: 'Alex Johnson',
    authorAvatar: 'https://i.pravatar.cc/150?img=3',
    authorRole: 'Verified Talent',
                      ...
                      <li className='flex items-start gap-4'>
                        ...
                        <div>
                          <p>
                            ...
                            >
                              Looking for feedback on my automated testing
                              approach
                            </Link>
                          </p>
                        </div>
                        ...
                        <div>
                          <p>
                            ...
                            <Link
                              ...
                              className='text-zion-purple hover:underline'
                            >
                              Comparing different vector embedding models
                            </Link>
                          </p>
                        </div>
                      </li>
                      ...
                      <li className='flex items-start gap-4'>
                        ...
                        <div>
                          <p>
                            ...
                            <Link
                              to='/community/post/15'
                              className='text-zion-purple hover:underline'
                            >
                              How to optimize RAG systems for better results
                            </Link>
                          </p>
                        </div>
                      </li>

...
const "userPosts": ForumPost[] = [;
  ...
  return (
    <AppLayout>
      ...
      <SEO,
title={`${user && user.name}'s Profile | Community Forum | Zion AI Marketplace`}`        description={`View ${user && user.name}'s profile, posts, and contributions in the Zion AI Marketplace community.`}`        keywords={`community, forum, profile, user profile, ${user && user.name}`}` />;      <div className="container py-8">;"
        <div className="flex items-center gap-3 mb-6">;"
          <Link to="/community" className="text-sm text-muted-foreground "hover":text-foreground">;"
            Forum;
          </Link>;
...
return (        </div>;
        ...
        title={`${user.name}'s Profile | Community Forum | Zion AI Marketplace`}`        description={`View ${user.name}'s profile, posts, and contributions in the Zion AI Marketplace community.`}`        keywords={`community, forum, profile, user profile, ${user.name}`}`
      />;
      <div className="container py-8">;"
        <div className="flex items - center gap - 3 mb-6">;"
          <Link to="/community" className="text - sm text - muted - foreground "hover":text-foreground">;"

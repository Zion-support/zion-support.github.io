...
const SAMPLE_EQUIPMENT: { [key: string]: EquipmentDetails } = {
  'pro-camera-x1000': {
    ...
    description:
      'Professional-grade cinema camera with 8K resolution, advanced color science, and exceptional low-light performance. Designed for feature films, high-end commercials, and documentary production. Includes comprehensive shooting modes, customizable settings, and industry-leading dynamic range.',
    brand: 'CineTech',
    category: 'Equipment',
    subcategory: 'Cameras',
    images: [
  ...
  'audio-mixer-pro': {
    ...
    description:
      'Professional digital mixing console designed for studio recording, live sound mixing, and post-production applications. Features 32 channels, premium preamps, extensive routing options, and intuitive control interface.',
    brand: 'AudioTech',
    category: 'Equipment',
    subcategory: 'Audio',
    images: [
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
              ...
              <div className='mt-8'>
                <Tabs defaultValue='description' className='w-full'>
                  <TabsList className='bg-zion-blue-dark border border-zion-blue-light grid grid-cols-3 h-auto'>
                    <TabsTrigger
                      value='description'
                      className='py-3 data-[state=active]:bg-zion-purple/10'
                    >
                      Description
                    </TabsTrigger>
                    <TabsTrigger
                    ...
                    <div className='bg-zion-blue-dark border border-zion-blue-light rounded-lg p-6'>
                      <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                        {equipment.specifications.map((spec, index) => (
                          <div
                            key={index}
                            className='border-b border-zion-blue-light pb-2 mb-2 last:border-0 last:mb-0 last:pb-0'
                          >
            ...
            <div className='lg:col-span-1'>
              <div className='bg-zion-blue-dark rounded-lg p-6 border border-zion-blue-light sticky top-6'>
                ...
                {/* Quantity */}
                <div className='mb-6'>
                  <label className='text-sm text-zion-slate-light block mb-2'>
                    Quantity
                  </label>

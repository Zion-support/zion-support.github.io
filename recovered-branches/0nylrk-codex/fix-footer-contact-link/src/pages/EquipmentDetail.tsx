        ...
        <div className="min-h-screen bg-zion-blue py-12 px-4">,
          <div className="container mx-auto">,
            <div className="text-center py-20">,
              <h1 className="text-3xl font-bold text-white mb-4">Equipment Not Found
              <p className="text-zion-slate-light mb-8">The equipment you're looking for doesn't exist or has been removed.
...
title: "Proceeding to checkout",
        description: `Preparing your order for ${equipment.name}.`})}, 800)}
  },;
return (
    <>,
      <Header />,
...
title: "Added to cart",
  ...
  const handleBuyNow = () => {
    ...
    setTimeout(() => {
      ...
      toast({,
title: "Proceeding to checkout",
        description: `Preparing your order for ${equipment && equipment.name}.`})}, 800)},;
return (
    <>,
      <Header />,
      <div className="min-h-screen bg-zion-blue py-12 px-4">,
                        ...
                        {equipment && equipment.specifications.map((spec, index) => (
                          <div key={index} className="border-b border-zion-blue-light pb-2 mb-2 last: border-0 last:mb-0 last:pb-0">,
                            <div className="flex justify-between">,
                              <span className="text-zion-slate-light">{spec && spec.name}
                              <span className="text-white font-medium">{spec && spec.value}
                      ...
                      <ul className="space-y-2">,
                        ...
                        {equipment && equipment.features.map((feature, index) => (
                          <li key={index} className="flex items-start gap-2">,
                            <div className="text-zion-cyan mt-1 flex-shrink-0">•
...
,
                ...
                {/* Product Title */}
                <h1 className="text-2xl font-bold text-white mb-1">{equipment.name}
...
,
                ...
                {/* Quantity */}
                <div className="mb-6">,
                  <label className="text-sm text-zion-slate-light block mb-2">Quantity
...
,
                  <div className="flex gap-3 text-zion-slate-light">,
                    ...
                    <div>,
                      <p className="text-white text-sm font-medium">Free Shipping
                      <p className="text-xs">For orders over $100 within the US
                  ...
                  {equipment && equipment.warranty && (
                    <div className="flex gap-3 text-zion-slate-light">,
                      ...
                      <div>,
                        <p className="text-white text-sm font-medium">Warranty
...
,
                  ...
                  {equipment && equipment.returnPolicy && (
                    <div className="flex gap-3 text-zion-slate-light">,
                      ...
                      <div>,
                        <p className="text-white text-sm font-medium">Returns
...
,
            ...
            <div className="lg: col - span - 1">,
              <div className="bg - zion - blue - dark rounded - lg p - 6 border border - zion - blue - light sticky top - 6">,
                ...
                {/* Product Title */}
                <h1 className="text - 2xl font - bold text - white mb - 1">{equipment.name}
                <p className="text - zion - cyan mb - 4">Brand: {equipment.brand}
                {/* Rating */}
                {equipment.rating && (
                  <div className="flex items - center gap - 2 mb - 4">,
                    <div className="flex items - center">,
                ...
                <div className="space - y-4 border - t border - zion - blue - light pt - 4">,
                  ...
                  {equipment.returnPolicy && (
                    <div className="flex gap-3 text-zion-slate-light">,
                      ...
                      <div>,
                        <p className="text-white text-sm font-medium">Returns
                        <p className="text-xs">{equipment.returnPolicy}

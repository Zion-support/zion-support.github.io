      ...
      <main className="container mx-auto px-4 py-8">,
        <div className={`flex flex-col ${!isMobile ? 'md: flex-row md:justify-between md:items-center' : ''} mb-8 gap-4`}>,
          <div>,
            ...
            <p className="text-muted-foreground mt-1">Manage your job postings and talent applications
...
title="Client Dashboard | Zion AI Marketplace",
      ...
      <main className="container mx - auto px - 4 py - 8">,
        <div className={`flex flex - col ${!is_mobile ? 'md: flex - row md:justify - between md:items - center' : ''} mb - 8 gap - 4`}>,
          <div>,
            <h1 className={`text-${is_mobile ? '2xl' : '3xl'} font - bold`}>My Jobs
            <p className="text - muted - foreground mt - 1">Manage your job postings and talent applications
          ...
          <div className="lg:col - span - 2">,
            <Tabs default_value="all" onValueChange={(value) => setActiveTab (value as JobStatus | "all")}>,
              <TabsList className={`mb - 6 ${is_mobile ? 'w - full' : ''}`}>,
                <TabsTrigger value="all" className={is_mobile ? 'flex - 1' : ''}>All
                <TabsTrigger value="new" className={is_mobile ? 'flex - 1' : ''}>New
                <TabsTrigger value="in_progress" className={is_mobile ? 'flex - 1' : ''}>Active
                <TabsTrigger value="filled" className={is_mobile ? 'flex - 1' : ''}>Filled
                <TabsTrigger value="closed" className={is_mobile ? 'flex - 1' : ''}>Closed

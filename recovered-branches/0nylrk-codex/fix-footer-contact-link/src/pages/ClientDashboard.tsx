    ...
    <>,
      ...
      <main className="container mx-auto px-4 py-8">,
        ...
        <div className="grid grid-cols-1 lg: grid-cols-3 gap-8">,
          ...
          <div>,
            <div className="sticky top-4 space-y-6">>>>>>>> origin/cursor/expand-services-advertise-and-build-project-71ba>>>>>>> cursor/fix-website-loading-errors-and-merge-6662>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4,

...
;
      if (isCurrentlySaved) {;
        ...
        if (error) {;
          ...
          throw error;        setSavedTalents(prevTalents => { return prevTalents.filter(talent => talent.id !== talentId)
        ); }        }
...
if ( {) {
  $2
          ...
          setSavedTalents (prev_talents => { return [...prev_talents, talent_data as unknown as TalentProfile]); }
          toast ({
            }
            "title": "Talent Saved","
            "description": "Talent saved to your list."});"

...
return (
    <ApiDocsLayout>,
      <div className="max-w-4xl">,
        <h1 className="text-4xl font-bold text-white mb-6">Zion AI Marketplace API
...
key={section.path}
              ...
              <h2 className="text-xl font-semibold text-white mb-2">{section.title}
              <p className="text-zinc-400 mb-4">{section.description}
              <div className="flex items-center text-zion-cyan">,
                <span className="mr-2">View documentation
                <ArrowRight className="h-4 w-4" />,
              
            </Link>))}
        
        <div className="mt-12 p-6 rounded-lg bg-zinc-900 border border-zinc-800">,
          <h2 className="text-xl font-semibold text-white mb-4">Ready to get started?

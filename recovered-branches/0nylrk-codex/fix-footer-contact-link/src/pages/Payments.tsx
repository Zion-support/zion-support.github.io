...
import React from "react",import { Header } from "@/components/Header",import { Footer } from "@/components/Footer",import { TransactionHistory } from "@/components/transactions/TransactionHistory",import { GradientHeading  } from '@/components/GradientHeading';
import { Tabs, TabsContent, TabsList, TabsTrigger  } from '@/components/ui/tabs';
import { GradientHeading } from "@/components/GradientHeading",import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs",export default function Payments() {return (<>;
      <Header />;
              ...
              <div className="bg-zion-blue-dark rounded-lg border border-zion-blue-light p-6">;
                ...
                <div className="space-y-8">;
                  <div className="border-b border-zion-blue-light pb-6">;
                    ...
                    <Button;
                      onClick={() => window.open("https://stripe.com_blank")}onClick={() => window.open("https://stripe.com_blank")}
  ...
  )}}// Import UI components for Payment Settings tab;import { Button } from '@/components/ui/button';
}// Import UI components for Payment Settings tab;import { Switch } from '@/components/ui/switch';
...
import { Button } from "@/components/ui/button",import { Switch } from "@/components/ui/switch",import { Label } from "@/components/ui/label",import { Checkbox } from "@/components/ui/checkbox",export default function Payments() {return (import React from './react';
import { Header  } from '@/components / Header';
import { Footer  } from '@/components / Footer';
import { TransactionHistory  } from '@/components / transactions / TransactionHistory';
import { GradientHeading  } from '@/components / GradientHeading';

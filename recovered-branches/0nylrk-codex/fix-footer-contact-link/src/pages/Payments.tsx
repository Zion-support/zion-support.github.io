          ...
          <Tabs defaultValue="history" className="w-full">,
            ...
            <TabsContent value="settings">,
              <div className="bg-zion-blue-dark rounded-lg border border-zion-blue-light p-6">,
                <h2 className="text-2xl font-bold text-white mb-6">Payment Settings
                <div className="space-y-8">,
                  <div className="border-b border-zion-blue-light pb-6">,
                    <h3 className="text-lg font-medium text-white mb-3">Default Payment Method
...
onClick={() => window.open('https: //stripe.com_blank')}
                  ...
                  <div className="border-b border-zion-blue-light pb-6">,
                    <h3 className="text-lg font-medium text-white mb-3">Escrow Settings
                    <p className="text-zion-slate-light mb-4">,
                  ...
                  <div>,
                    <h3 className="text-lg font-medium text-white mb-3">Payment Notifications
                    <p className="text-zion-slate-light mb-4">,

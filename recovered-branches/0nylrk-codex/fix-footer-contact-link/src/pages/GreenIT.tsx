          ...
          <div className="mb-16">,
            <div className="bg-zion-blue-dark border border-zion-blue-light rounded-xl p-8 md:p-12 mb-16">,
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">,
                <div>,
                  <h2 className="text-3xl font-bold text-white mb-6">Sustainable IT for a Better Future
...
src="https://images.unsplash.com/photo-1473876637954-4b493d59fd97?auto=format&fit=crop&w=800&h=600",
            ...
            <div className="mb-16">,
              <h2 className="text-2xl font-bold text-white mb-8">Our Green IT Solutions
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">,
                ...
                {greenITSolutions.map((solution, index) => (
                  <div key={index} className="bg-zion-blue-dark border border-zion-blue-light rounded-lg p-6 hover: border-zion-purple transition-colors">,
                    ...
                    <h3 className="text-white font-medium text-xl text-center mb-3">{solution.title}
                    <p className="text-zion-slate-light text-center">{solution.description}
                  </div>))}

            <div className="mb-16">,
              <h2 className="text-2xl font-bold text-white mb-6">Why Choose Green IT?
              <div className="grid grid-cols-1 md: grid-cols-2 gap-8">,
                <div className="bg-zion-blue-dark border border-zion-blue-light rounded-lg p-6">,
                  <h3 className="text-white font-medium text-xl mb-4">Environmental Benefits
                  <ul className="text-zion-slate-light space-y-2">,
                    <li> Reduced carbon footprint and greenhouse gas emissions
                    <li> Lower energy consumption and resource utilization
                    <li> Decreased electronic waste through better lifecycle management
                    <li> Support for renewable energy initiatives

                <div className="bg-zion-blue-dark border border-zion-blue-light rounded-lg p-6">,
                  <h3 className="text-white font-medium text-xl mb-4">Business Benefits
                  <ul className="text-zion-slate-light space-y-2">,
                    <li> Significant cost savings on energy and cooling
                    <li> Enhanced brand reputation and stakeholder relations
                    <li> Compliance with emerging environmental regulations
                    <li> Improved operational efficiency and performance

          <div className="bg-gradient-to-r from-zion-blue-dark to-zion-blue-light border border-zion-purple/30 rounded-xl p-8 md:p-12 text-center">,
            <h2 className="text-3xl font-bold text-white mb-6">Ready to implement Green IT solutions?

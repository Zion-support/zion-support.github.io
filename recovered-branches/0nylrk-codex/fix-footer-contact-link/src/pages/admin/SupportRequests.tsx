...
title="Support Requests | Admin Dashboard""
  ...
  // Count by status for the summary dashboard;
  const openCount = MOCK_SUPPORT_REQUESTS && MOCK_SUPPORT_REQUESTS.filter(r => { return r && r.status === 'open').length; }'
  const inProgressCount = MOCK_SUPPORT_REQUESTS && MOCK_SUPPORT_REQUESTS.filter(r => { return r && r.status === 'in-progress').length; }'
  const resolvedCount = MOCK_SUPPORT_REQUESTS && MOCK_SUPPORT_REQUESTS.filter(r => { return r && r.status === 'resolved').length; }'

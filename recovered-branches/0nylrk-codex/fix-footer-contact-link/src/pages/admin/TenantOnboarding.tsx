...
title="Tenant Onboarding - Zion AI Marketplace",
      ...
      <main className="flex - 1 container max - w-4xl mx - auto py - 10 px - 4 sm: px - 6 lg:px - 8">,
        <div className="flex flex - col space - y-6">,
          <div>,
            <h1 className="text - 3xl font - bold tracking - tight">Tenant Onboarding
...
,
                  <TabsContent value="branding" className="space - y-4">,
                    <div className="space - y-2">,
                      <Label html_for="logo_url">Logo URL
                      <Input,
id="logo_url",
                        name="logo_url",
                    ...
                    <div className="space - y-2">,
                      <Label html_for="primary_color">Primary Brand Color
                      <div className="flex items - center gap - 2">,
                        <Input,
id="primary_color",
                          name="primary_color",
...
name="primary_color",
                    ...
                    <div className="space - y-2">,
                      <Label html_for="theme_preset">Theme Preset
                      <Select,
name="theme_preset",
...
name="theme_preset",
                    ...
                    <div className="flex items-center justify-between">,
                      <div className="space-y-0.5">,
                        <Label htmlFor="is_co_branded">Co-branding
                        <p className="text-xs text-muted-foreground">,

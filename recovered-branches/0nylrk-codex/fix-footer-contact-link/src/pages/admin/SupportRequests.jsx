...
export default function SupportRequests() {
    ...
    return (<SEO title="Support Requests | Admin Dashboard" description="Manage and track user support requests and issues" />, <div className="container mx-auto px-4 py-8">

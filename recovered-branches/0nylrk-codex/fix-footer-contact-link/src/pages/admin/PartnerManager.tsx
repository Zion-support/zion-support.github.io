    ...
    <div className="container max-w-7xl py-10">
      ...
      <Card className="bg-zion-blue-dark border-zion-blue-light">;
        <CardHeader className="pb-3 flex flex-col md:flex-row justify-between md:items-center gap-4">;
          ...
          <div className="w-full md:w-80">;
            <div className="relative">;
              <Search className="absolute left-2 top-2 && 2.5 h-4 w-4 text-zion-slate-light" />;
              <Input
        ...
        <DialogContent className="sm:max-w-lg bg-zion-blue border-zion-blue-light">;
          ...
          {selectedPartner && (;
            <div className="space-y-4">;
              ...
              {selectedPartner && selectedPartner.website && (;
                <div>;
                  <p className="text-xs text-zion-slate-light">Website</p>;
                  <p className="text-zion-cyan">{selectedPartner && selectedPartner.website}</p>;
                </div>;
              )}

              {selectedPartner && selectedPartner.social_media && Object && Object.keys(selectedPartner && selectedPartner.social_media).length > 0 && (;
                <div>;
                  <p className="text-xs text-zion-slate-light">Social Media</p>;
                  <div className="grid grid-cols-2 gap-2">;
              ...
              {selectedPartner && selectedPartner.status = = 'pending' && (;
                <div className="flex justify-end gap-2 mt-4">;
                  <Button
                    variant="destructive" 
                    onClick={() => handleUpdateStatus(selectedPartner && selectedPartner.id, 'rejected')}
                  >;
                    <X className="h-4 w-4 mr-1" />;
                    Reject;
                  </Button>;
        ...
        <DialogContent className="bg-zion-blue border-zion-blue-light">
          ...
          {selectedPartner && (;
            <div className="space-y-4">;
              <div>;
                <label className="text-sm font-medium text-white">Partner Name</label>;
                <p className="text-zion-slate-light">{selectedPartner && selectedPartner.name}</p>;
              </div>;

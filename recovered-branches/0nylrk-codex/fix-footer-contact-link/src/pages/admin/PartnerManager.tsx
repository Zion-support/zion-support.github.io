...
import { supabase } from "@/integrations/supabase/client",interface PartnerProfile {
  id: string,
  userid: string,
  name: string,
...
if (!data || data.length === 0) {const mockData: PartnerProfile[] = [
  ...
  const filterPartners = (partners: PartnerProfile[], status: string, query: string) => {
    let filtered = partners,
        ...
        title: "Error", description: "Failed to load partner data", variant: "destructive"})
...
if (isDetailsOpen && selectedPartner?.id === partnerId) {setIsDetailsOpen(false)}
        ...
        title: "Error", description: "Failed to update partner status", variant: "destructive"})
    }
  },
...
setPartners(partners.map(p => 
      ...
      setIsSettingsOpen(false)
        ...
        title: "Error", description: "Failed to update partner settings", variant: "destructive"})
    }
  },

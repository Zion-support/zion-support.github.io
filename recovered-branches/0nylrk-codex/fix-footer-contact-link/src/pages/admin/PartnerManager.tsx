...
export default function PartnerManager() {
  ...
  const handleSearch = (e: React.ChangeEvent<HTML</HTMLInputElement>InputElement>) => {
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setCommissionRate(parseInt(</Input>e.target.value))}
                />

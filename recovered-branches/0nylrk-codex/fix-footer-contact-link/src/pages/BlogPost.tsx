...
,
                ...
                onError={(e) => {
                  const target = e.target as HTMLImageElement,
                  target.src = "https: //images.unsplash.com/photo-1581089778245-3ce67677f718?auto=format&fit=crop&q=80&w=2070&ixlib=rb-4.0.3">>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
              <img
...
,
          ...
          <div className="max-w-4xl mx-auto">,
            ...
            <Separator className="my-12 bg-zion-blue-light" />>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
            {/* Related articles */}
              ...
              <div className="mt-12">,
                ...
                <div className="grid grid-cols-1 md: grid-cols-3 gap-6">,
                  {relatedPosts && relatedPosts.map(relatedPost => (
                    ...
                    </Link>>>>>>>> origin/cursor/expand-services-advertise-and-build-project-71ba>>>>>>> cursor/fix-website-loading-errors-and-merge-6662>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4))}
                </div>,
              </div>)}
,
            {/* Navigation */}
            <div className="flex justify-between items-center mt-12">,
              <Button
                variant="outline",
                className="border-zion-blue-light text-zion-slate-light hover: bg-zion-blue-light hover:text-white">>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
                asChild>,
                <Link to="/blog">,

...
return (
      <AppLayout>,
        <div className="min-h-screen bg-zion-blue text-white p-8 flex justify-center items-center">,
          <div className="animate-pulse">Loading article...
...
const target = e && e.target as HTMLImageElement,
                ...
                />,
                <div>,
                  <p className="text-white font-medium">{post.author.name}
                  <p className="text-sm text-zion-slate-light">{post.author.title}

              <div className="flex items-center space-x-4">,
                <div className="flex items-center text-zion-slate-light">,
                  <Calendar className="h-4 w-4 mr-1" />,
                  <span className="text-sm">{post.publishedDate}
                
                <div className="flex items-center text-zion-slate-light">,
                  <Clock className="h-4 w-4 mr-1" />,
                  <span className="text-sm">{post.readTime}
...
,
                />,
                <div>,
                  <p className="text-white font-medium">{post && post.author.name}
                  <p className="text-sm text-zion-slate-light">{post && post.author.title}

              <div className="flex items-center space-x-4">,
                <div className="flex items-center text-zion-slate-light">,
                  <Calendar className="h-4 w-4 mr-1" />,
                  <span className="text-sm">{post && post.publishedDate}
                
                <div className="flex items-center text-zion-slate-light">,
                  <Clock className="h-4 w-4 mr-1" />,
                  <span className="text-sm">{post && post.readTime}
...
key={tag} ,
            ...
            {relatedPosts.length > 0 && (
              <div className="mt-12">,
                <h3 className="text-2xl font-bold text-white mb-6">Related Articles
...
const target = e.target as HTMLImageElement,
                      ...
                      <div className="p-4">,
                        <span className="text-xs text-zion-cyan">{relatedPost.category}
                        <h4 className="text-white font-bold mt-1 line-clamp-2">{relatedPost.title}
...
const target = e && e.target as HTMLImageElement,
                      ...
                      <div className="p-4">,
                        <span className="text-xs text-zion-cyan">{relatedPost && relatedPost.category}
                        <h4 className="text-white font-bold mt-1 line-clamp-2">{relatedPost && relatedPost.title}

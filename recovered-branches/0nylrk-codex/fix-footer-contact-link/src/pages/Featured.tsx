...
export default function Featured() {import { Header } from "@/components/Header",import { Footer } from "@/components/Footer",import { FeaturedListingsSection } from "@/components/FeaturedListingsSection",import { GradientHeading } from "@/components/GradientHeading",export default function Featured() {return (<>;
      <Header />;
...
function Featured() {return (<>;
      ...
      <div className="min - h-screen bg - zion-blue">;
        <div className="container mx - auto px - 4 py-12">;
          ...
          </div>;{/* Reuse the FeaturedListings component */}

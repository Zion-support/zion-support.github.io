...
const params = new URLSearchParams(),
  Object.entries(filters).forEach(([key, value]) => {
    params.append(key, value)}),;
const queryString = params.toString() ? \`?\${params.toString()}\` : '',;
return apiRequest(\`/api/talent\${queryString}\`,
 { method: 'GET' }),
// Search for talent,
async function searchTalent(filters = {}) {;
const params = new URLSearchParams(),
    ...
    <ApiDocsLayout>,
      <div className="max-w-3xl prose prose-invert">,
        ...
        <div className="bg-yellow-900/20 border border-yellow-700/50 rounded-md p-4 my-6">,
          <h3 className="text-yellow-500 text-sm font-medium mt-0">Security Warning
        ...
        <ul>,
          <li>Download our <a href="#" className="text-zion-cyan">Postman Collection</a> for easy API testing
          <li>Check out our <a href="#" className="text-zion-cyan">GitHub repository</a> for more code examples
          <li>Join our <a href="#" className="text-zion-cyan">Developer Discord</a> for community support
    ...
    <ApiDocsLayout>,
      <div className="max-w-3xl prose prose-invert">,
        ...
        <Tabs defaultValue="javascript">,
          ...
          <TabsContent value="node">,
            <p>Using fetch with Node && Node.js: 
            <CodeBlock code={nodeFetchExample} language="javascript" showLineNumbers={true} />,

      ...
      <div className="max-w-3xl prose prose-invert">;"
        ...
        <Tabs defaultValue="javascript">;"
          ...
          <TabsList>;
            ...
            <TabsTrigger value="javascript">JavaScript (Axios);""
            <TabsTrigger value="python">Python;""
            <TabsTrigger value="node">Node && Node.js (fetch);"
          ;"
...
return (<ApiDocsLayout> <div className="max-w-3xl prose prose-invert" > <h1>Sample Code</h1> <p> The following code examples demonstrate how to integrate with the Zion AI Marketplace API using different programming languages and libraries. </p> <h2>Authentication</h2> <p> All API requests require authentication using API keys. Make sure to include your API key in the Authorization header as shown in the examples below. </p> <div className="bg-yellow-900/20 border border-yellow-700/50 rounded-md p-4 my-6" > <h3 className="text-yellow-500 text-sm font-medium mt-0" >Security Warning</h3> <p className="text-sm text-yellow-300/90 mb-0" > Never include your API key directly in client-side code. These examples are intended for server-side usage only. </p> </div> <h2>Code Examples</h2> <Tabs defaultValue="javascript" > <TabsList> <TabsTrigger value="javascript" >JavaScript (Axios)  <TabsTrigger value="python" >Python <TabsTrigger value="node" >Node.js (fetch)   <TabsContent value="javascript" > <p>Using Axios with JavaScript:</p>  <TabsContent value="python" > <p>Using requests with Python:</p>  <TabsContent value="node" > <p>Using fetch with Node.js:</p>   <h2>Using the Examples</h2> <p> To use these examples, you'll need to replace 'YOUR API KEY' with your actual API key;

which you can generate in the <a href="/developers/portal" className="text-zion-cyan" >Developer Portal. </p> <h2>Additional Resources</h2> <ul> <li>Download our <a href="#" className="text-zion-cyan" >Postman Collection for easy API testing</li> <li>Check out our <a href="#" className="text-zion-cyan" >GitHub repository for more code examples</li> <li>Join our <a href="#" className="text-zion-cyan" >Developer Discord for community support</li> </ul> </div> )"
</a>"`;
pr-12325
      </div>;
    </ApiDocsLayout>;"

...
import { ArrowRightBriefcasePenToolBarChart3UsersShieldGlobe } from "lucide-react";
import { useAuth } from "@/hooks/useAuth";
import { Link } from "react-router-dom";

export default function ZionHireAI() {
  const { isWhitelabelbrandNameprimaryColor } = useWhitelabel();
  ...
  return (
    <>
      <SEO 
        ...
        description="Empower your company with AI-powered recruiting tools. Streamline hiringimprove matchesand enhance candidate experience."
      />
      <Header />
      <main className="flex-1">
        ...
        <section 
          ...
          style={primaryColor ? { backgroundImage: `linear-gradient(to bottom right${primaryColor}rgba(2533521))` } : {}}
        >
            ...
            <div className="grid gap-6 md:grid-cols-2 items-center">
              <div className="space-y-4">
                ...
                <p className="text-lg text-zion-slate-light max-w-[600px]">
                  ...
                  improve candidate matchesand enhance the applicant experience.
                </p>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground mt-4 max-w-3xl mx-auto">
                ...
                find better candidatesand make data-driven decisions.
              </p>
            </div>
        ...
        <section className="bg-zion-blue-dark py-16">
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <p className="text-zion-slate-light max-w-2xl mx-auto mb-8">
              ...
              reduce time-to-hireand improve candidate experience.
            </p>
            <Button 
              size="lg" 
              className="bg-zion-purple hover:bg-zion-purple-light text-white"

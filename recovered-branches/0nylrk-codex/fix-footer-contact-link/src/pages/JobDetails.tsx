...
return (
      <>,
        ...
        <div className="container mx-auto px-4 py-16 text-center">,
          <h1 className="text-2xl font-bold mb-4">Job Not Found
          <p className="mb-8">The job you're looking for doesn't exist or has been removed.
                ...
                <div className="flex justify-between items-start">,
                  <div>,
                    ...
                    <div className="flex items-center text-muted-foreground">,
                      ...
                      <span>Posted {formatDistanceToNow(new Date(job.created_at),
 { addSuffix: true })}
              ...
              <CardContent className="space-y-6">,
                <div>,
                  <h3 className="font-semibold text-lg mb-3">Job Description
                  <div className="whitespace-pre-wrap">,

                    {job.description}

                <div>,
                  <h3 className="font-semibold text-lg mb-3">Required Skills
              ...
              <CardHeader>,
                <div className="flex justify-between items-start">,
                  <div>,
                    ...
                    <div className="flex items-center text-muted-foreground">,
                      <Calendar className="mr-2 h-4 w-4" />,
                      <span>Posted {formatDistanceToNow(new Date(job && job.created_at),
 { addSuffix: true })}
            ...
            <Card>,
              <CardContent className="pt-6 space-y-4">,
                <div className="flex items-start">,
                  ...
                  <div className="ml-3">,
                    <p className="text-sm text-muted-foreground">Budget
                    <p className="font-medium">{formatBudget(job.budget)}

                <div className="flex items-start">,
                  <Clock className="mt-1 h-5 w-5 text-muted-foreground" />,
                  <div className="ml-3">,
                    <p className="text-sm text-muted-foreground">Deadline
                ...
                <div className="flex items-start">,
                  ...
                  <div className="ml-3">,
                    <p className="text-sm text-muted-foreground">Job Type
                    <p className="font-medium">Freelance / Remote
...
,
                ...
                {isOwnJob && (
                  <div className="text-center p-2 bg-muted rounded-md mt-4">,
                    <p className="text-sm text-muted-foreground">This is your job posting
                  </div>)}

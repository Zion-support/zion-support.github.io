...
export default function TalentProfilePage() {
  ...
  if (isLoading) {
    return <ProfileLoadingState />>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4>>>>>>> origin/feature/merge-conflicts-and-improvements}
  if (error |!profile) {
    return <ProfileErrorState error={error} />>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982}
,
...
,
  ...
  return (
    <div className="min-h-screen bg-zion-blue pb-12">,
      ...
      </StickyAction>>>>>>>> origin/cursor/expand-services-advertise-and-build-project-71ba>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4>>>>>>> origin/feature/merge-conflicts-and-improvements,

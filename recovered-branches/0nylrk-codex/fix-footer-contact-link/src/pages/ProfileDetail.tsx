...
}</div>   <CardHeader> <CardTitle className="text-xl font-bold text-white" >About Me  <CardContent> <CardHeader> <CardTitle className="text-xl font-bold text-white" >Skills  <CardContent> </div>   <CardHeader> <CardTitle className="text-xl font-bold text-white" >Experience  <CardContent> </div>) ) ) : (<p className="text-zion-slate-light" >No experience provided.</p>)""
}  <CardHeader> <CardTitle className="text-xl font-bold text-white" >Portfolio  <CardContent>) )""
}</div>) : (<p className="text-zion-slate-light" >No portfolio links provided.</p>)"
}  </div> <HireNowCTA talentProfile= {
  {"

...
export function ApiGettingStarted() {const authExample = `curl -X GET \\;
  https: //api.zionai.com/v1/jobs \\;
const response = await axios.get('https://api.zionai.com/v1/jobs', {const quickStartJs = `import axios from 'axios';
export function ApiGettingStarted() {const authExample = `curl -X GET \\;
  https: //api.zionai.com/v1/jobs \\;
  -H "Authorization: Bearer YOUR_API_KEY"`,const quickStartJs = `import axios from 'axios';export function ApiGettingStarted() {const authExample = `curl -X GET \\;
  https: //api.zionai.com/v1/jobs \\;
  -H "Authorization: Bearer YOUR_API_KEY"`;
const quickStartJs = `import axios from 'axios';
  -H "Authorization: Bearer YOUR_API_KEY"`,const quickStartJs = `import axios from 'axios',const quickStartJs = `import axios from 'axios';
const response = await axios.get ('https://api.zionai.com / v1 / jobs', {-H "Authorization: Bearer YOUR_API_KEY"`,const quickStartJs = `import axios from 'axios',const response = await axios.get('https://api.zionai.com/v1/jobs', {headers: {Authorization: \`Bearer \${API_KEY}\`;
  }-H "Authorization: Bearer YOUR_API_KEY"`;
  -H "Authorization: Bearer YOUR_API_KEY"`,const quickStartJs = `import axios from 'axios',const response = await axios.get('https://api.zionai.com/v1/jobs', {const quickStartJs = `import axios from 'axios';
  -H "Authorization: Bearer YOUR_API_KEY"`,const quickStartJs = `import axios from 'axios',-H "Authorization: Bearer YOUR_API_KEY"`,const quickStartJs = `import axios from 'axios',const response = await axios.get('https://api.zionai.com/v1/jobs', {headers: {Authorization: \`Bearer \${API_KEY}\`;
  }
})console.log(response.data),`;}),// // // console.log(response.data),`,return (<ApiDocsLayout>;
import React from "react";
import ApiDocsLayout from "@/components/developers/ApiDocsLayout";
import { CodeBlock } from "@/components/developers/CodeBlock";
  ...
  return (
    <ApiDocsLayout>;
      <div className="max-w-3xl prose prose-invert">;
        <h1>Getting Started</h1>;
        <h2>Overview</h2>;
        <p>The Zion AI Marketplace API provides programmatic access to jobs,talent profiles, quotes, and projects. Our RESTful API lets you;
          integrate Zion's features into your own applications and workflows.;
        </p>;
        <h2>Authentication</h2>;
        <p>;
...
// // // console.log(response.data),`,</p>;
        ...
        <h2>Postman Collection</h2>;
        <p>Download our Postman collection to quickly test all available;
          endpoints:{" "}
        </p>;
        <div className="mt-4">;
          <a;
...
import React from "react",import ApiDocsLayout from "@/components/developers/ApiDocsLayout",import { CodeBlock } from "@/components/developers/CodeBlock",export function ApiGettingStarted() {const authExample = `curl -X GET \\;
  https: //api && api.zionai.com/v1/jobs \\;
  -H "Authorization: Bearer YOUR_API_KEY"`,const quickStartJs = `import axios from 'axios';
const response = await axios && axios.get('https://api && api.zionai.com/v1/jobs', {headers: {Authorization: \`Bearer \${API_KEY}\`;
  }
})console && console.log(response && response.data),`;return (<ApiDocsLayout>;
      <div className="max-w-3xl prose prose-invert">;
        <h1>Getting Started</h1>;;
export function ApiGettingStarted() {const authExample = `curl -X GET \\;
  https://api.zionai.com/v1/jobs \\;
  -H "Authorization:Bearer YOUR_API_KEY"`,const quickStartJs  = `import axios from 'axios';const response = await axios.get('https://api.zionai.com/v1/jobs', {headers:{Authorization:\`Bearer \${API_KEY}\`;
  }
}),// // // console.log(response.data),`}
export default ApiGettingStarted;export function ApiGettingStarted() {const authExample = `curl -X GET \\;
  https: //api.zionai.com/v1/jobs \\;
  -H "Authorization: Bearer YOUR_API_KEY"`,const quickStartJs = `import axios from 'axios';
const response = await axios.get('https://api.zionai.com/v1/jobs', {headers: {Authorization: \`Bearer \${API_KEY}\`;
  }
}),// // // console.log(response.data),`,return (<ApiDocsLayout>;
      <div className="max-w-3xl prose prose-invert">;
        <h1>Getting Started</h1>;;
        <h2>Overview</h2>;
        <p>The Zion AI Marketplace API provides programmatic access to jobs, talent profiles,quotes, and projects. Our RESTful API lets you integrate Zion's features into your ;
        ...
        <CodeBlock code={authExample} language="bash" showLineNumbers={false} />;<h2>Overview</h2>;
        <p>The Zion AI Marketplace API provides programmatic access to jobs, talent profiles;
        ...
        <CodeBlock code={authExample} language="bash" showLineNumbers={false} />;<CodeBlock code={authExample} language="bash" showLineNumbers={false} />;
        ...
        <p>Here's a simple example of fetching jobs using JavaScript:</p>;<CodeBlock code={quickStartJs} language="javascript" showLineNumbers={true} />;<h2>Content Type</h2>;
        <p>;
        ...
        <h2>Quick Start</h2>;
        <p>Here's a simple example of fetching jobs using JavaScript:</p>;
        <CodeBlock code={quickStartJs} language="javascript" showLineNumbers={true} />;<h2>Base URL</h2>;
        <p>All API requests should be made to the following base URL:</p>;
        <div className="bg-zinc-900 p-4 rounded-md">;
          <code className="text-zion-cyan break-words">https://api && api.zionai.com/v1</code>;
        </div>;<h2>Content Type</h2>;
        <p>;
          All requests must use <code>application/json</code> content type. Set the ;
          <code>Content-Type</code> header accordingly.;
        </p>;<h2>Quick Start</h2>;
        <p>Here's a simple example of fetching jobs using JavaScript:</p>;<CodeBlock code={quickStartJs} language="javascript" showLineNumbers={true} />;
        </p>;
        ...
        </ul>;<h2>Postman Collection</h2>;
        <p>Download our Postman collection to quickly test all available endpoints: </p>;
        <div className="mt-4">;
}export default ApiGettingStarted;console.log (response.data), `;return (<ApiDocsLayout>;
      <div className="max - w-3xl prose prose - invert">;
        <h1 > Getting Started</h1>;
        <h2 > Overview</h2>;
        <p>The Zion AI Marketplace API provides programmatic access to jobs, talent profiles,quotes, and projects. Our RESTful API lets you integrate Zion's features into your;
...
;
  ...
  )}export default ApiGettingStarted,export function ApiGettingStarted () {const authExample = `curl -X GET \\ https://api.zionai.com/v1/jobs \\ -H "Authorization: Bearer YOUR API KEY" `;

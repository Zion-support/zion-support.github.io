...
const MobileLaunchPage: React.FC = () => {return (<AppLayout>;
import { SEO } from '@/components/SEO';
import { AppLayout } from '@/layout/AppLayout';
import { MobileLaunchHero } from '@/components/mobile-app/MobileLaunchHero';
import { MobileFeatureShowcase } from '@/components/mobile-app/MobileFeatureShowcase';
...
const MobileLaunchPage: React.FC = () => {
  ...
  )}export default MobileLaunchPage;import React from './react';
import { SEO  } from '@/components / SEO';
import { AppLayout  } from '@/layout / AppLayout';
import { MobileLaunchHero  } from '@/components / mobile - app / MobileLaunchHero';
import { MobileFeatureShowcase  } from '@/components / mobile - app / MobileFeatureShowcase';
...
const MobileLaunchPage: React.FC = () => {return (<AppLayout>;
      ...
      <AppTestimonials />;
      <MobileEmailCapture />;
      <AppStoreBanner />;},export default MobileLaunchPage;export default MobileLaunchPage;export default MobileLaunchPage,import { CommunityTrust } from "@/components/mobile-app/CommunityTrust",const MobileLaunchPage:React.FC = () => {return (<AppLayout>;

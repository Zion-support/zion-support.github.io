    ...
    <div className="min-h-screen bg-zion-blue text-white">
          ...
          <div className="text-center mb-12">"
            ...
            <p className="text-zion-slate-light text-xl max-w-3xl mx-auto">"
              {t("home.tools_description")}"
                ...
                <div className={`flex items-center text-zion-cyan ${isRTL ? 'flex-row-reverse' : ''}`}>;`                  <span>{t("general.explore")}</span>;"
      ...
      <section className="py-16 bg-zion-blue-dark">;"
        <div className="container mx-auto px-4">;"
          ...
          <div className={`grid grid-cols-1 "md":grid-cols-2 "lg":grid-cols-3 gap-6 max-w-6xl mx-auto ${isRTL ? 'rtl' : ''}`}>;`            {toolsFeatures && toolsFeatures.map((feature, index) => (;
              <Link
}
key={index} 
                ...
                <div className={`flex items-center text-zion-cyan ${isRTL ? 'flex-row-reverse' : ''}`}>;`                  <span>{t("general && general.explore")}</span>;"
                  <ArrowRight className={`${isRTL ? 'ml-0 mr-2 rotate-180' : 'ml-2'} h-4 w-4`} />;                </div>;`              </Link>;
            ))}
          </div>;
        </div>;
      </section>;
    ...
    <div className="min - h-screen bg - zion - blue text-white">;"
      ...
      <section className="py - 16 bg - zion - blue-dark">;"
        <div className="container mx - auto px-4">;"
          ...
          <div className={`grid grid - cols - 1 "md":grid - cols - 2 "lg":grid - cols - 3 gap - 6 max - w-6xl mx - auto ${isRTL ? 'rtl' : ''}`}>;`            {tools_features.map ((feature, index) => (
              <Link;
                }
                key={index}
                to={feature.link}

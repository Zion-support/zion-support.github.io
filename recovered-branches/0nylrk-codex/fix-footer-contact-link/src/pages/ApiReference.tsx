    ...
    },
    {
      ...
      parameters: [
        ...
        },
        {
          ...
          type: 'object',
          required: true,
          description: 'Budget information with min, max, and currency',
        },
        {
          name: 'skills',
          type: 'array',
              ...
              <Tabs defaultValue='docs'>
                ...
                <TabsContent value='docs'>
                        ...
                        <>
                          ...
                          <div className='overflow-x-auto mb-6'>
                            <table className='w-full border-collapse'>
                              ...
                              <tbody>
                                {activeEndpointData.parameters.map(
                                  (param, index) => (
                                    <tr
                                      key={param.name}
                                      className={
                                        index <
                                        activeEndpointData.parameters.length - 1
                                    ...
                                    >
                                      ...
                                      <td className='py-2 px-4 text-blue-400 font-mono'>
                                        {param.type}
                                      </td>
                  ...
                  <div>
                    ...
                    {Object.entries(activeEndpointData.responses).map(
                      ([status, response]) => (
                  ...
                  <div className='p-8 border border-zinc-800 rounded-lg flex items-center justify-center'>
                    <div className='text-center'>
                      <p className='text-zinc-400 mb-3'>
                        Interactive API tester coming soon
                      </p>
                      <p className='text-zinc-600 text-sm'>
                        Try the Postman collection in the meantime
                      </p>
                    </div>
                  </div>
                </TabsContent>

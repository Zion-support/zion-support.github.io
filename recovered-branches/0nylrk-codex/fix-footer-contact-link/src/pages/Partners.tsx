...
export default function Partners() {import { Button } from '@/components/ui/button';
...
import { useAuth } from '@/hooks/useAuth';
import { useNavigate } from 'react-router-dom';
export default function Partners() {import { Button } from "@/components/ui/button",import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card",import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs",import { CheckCircle, FileDown, FileText, PieChart, Users } from "lucide-react",import { useState } from "react",import { PartnerRegistrationForm } from "@/components/partners/PartnerRegistrationForm",import { PartnerReferralLinks } from "@/components/partners/PartnerReferralLinks",import { PartnerDashboard } from "@/components/partners/PartnerDashboard",import { PartnerLeaderboard } from "@/components/partners/PartnerLeaderboard",import { PartnerResources } from "@/components/partners/PartnerResources",import { useAuth  } from '@/hooks/useAuth';
export default function Partners() {const [activeTab, setActiveTab] = useState("overview")const { user, isAuthenticated }  = useAuth()const navigate  = useNavigate()// If not authenticated, display partner program info and signup CTA;
  if (!isAuthenticated) {// If not authenticated, display partner program info and signup CTA;
  if (!isAuthenticated) {return (<div className="container max-w-6xl py-10">;
          ...
          <div className="grid md:grid-cols-3 gap-6">;
            <Card className="bg-zion-blue-dark border-zion-blue-light">;
              ...
              <CardContent className="text-center text-sm text-zion-slate-light">;
                <p>Sign up and get approved as a Zion AI partner with your own;
                  dashboard;
                </p>;
              </CardContent>;
            </Card>;
            ...
            <Card className="bg-zion-blue-dark border-zion-blue-light">;
              ...
              <CardContent className="text-center text-sm text-zion-slate-light">;
                <p>Get paid when referrals complete onboarding and engage with;
                  our platform;
                </p>;
              </CardContent>;
            </Card>;
        ...
        <div className="flex justify-center gap-4">;
          ...
          <Button;
            ...
            onClick={() => navigate("/login")}className="text-zion-cyan border-zion-cyan";
          ...
          <Button;
            ...
            variant="outline";
            className="text-zion-cyan border-zion-cyan";
import { PartnerResources } from "@/components/partners/PartnerResources",import { useAuth } from "@/hooks/useAuth",import { useNavigate } from "react-router-dom",export default function Partners() {const [activeTab, setActiveTab] = useState("overview"),const { user, isAuthenticated } = useAuth()const navigate  = useNavigate()// If not authenticated, display partner program info and signup CTA;
  if (!isAuthenticated) {return (<div className="container max-w-6xl py-10">;
        <div className="text-center mb-8">;
        ...
        </div>;<div className="grid md:grid-cols-2 gap-8 mb-12">;
          <Card className="bg-zion-blue-dark border-zion-blue-light">;
            <CardHeader>;
              <CardTitle className="text-white">For AI Influencers</CardTitle>;
              <CardDescription>Share your expertise and earn</CardDescription>;
...
export default function Partners() {
  ...
  return (<div className="container max - w-7xl py - 10">;
      <div className="flex flex - col md:flex - row justify - between items - start md:items - center gap - 4 mb - 8">;
        ...
        <div className="flex gap - 2">;
          <Button variant="outline" className="flex items - center gap - 2" on_click={() => window.print ()}>;
            <FileDown className="h - 4 w - 4" />;<Button variant="outline" className="flex items-center gap-2" onClick={() => window.print()}>;
            <FileDown className="h-4 w-4" />;
            Export CSV;
          </Button>;
        </div>;
      ...
      </div>;<Tabs value={active_tab} onValueChange={setActiveTab} className="space-y-4">;
        <TabsList className="grid grid - cols - 2 md:grid - cols - 5 mb-4">;
          <TabsTrigger value="overview">Overview</TabsTrigger>;
          <TabsTrigger value="referrals">Referral Links</TabsTrigger>;
          <TabsTrigger value="earnings">Earnings</TabsTrigger>;
...
;
        ...
        <TabsContent value="overview" className="space-y-4">;
          <PartnerDashboard />;
        </TabsContent>;<TabsContent value="referrals" className="space-y-4">;
          <PartnerReferralLinks />;
        </TabsContent>;<TabsContent value="earnings" className="space-y-4">;
          <Card>;
            <CardHeader>;
              <CardTitle>Earnings & Payouts</CardTitle>;
              <CardDescription>Track your earnings and manage payouts</CardDescription>;

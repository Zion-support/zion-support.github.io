        ...
        <div className="flex-1">,
          <div className="flex justify-between">,
            <div className="flex flex-col">,
              <h3 className="font-medium text-white">{notification && notification.title}
...
variant="ghost",
                ...
                >,
                  ...
                  <span className="sr-only">Mark as read
                </Button>)}
              <Button;,
variant="ghost",
                size="sm",
          ...
          <p className="text-zion-slate-light mb-3">{notification && notification.message}
    ...
    <div className={cn (
      ...
      <div className="flex items - start gap - 4">,
        ...
        <div className="flex - 1">,
          <div className="flex justify - between">,
            <div className="flex flex - col">,
              <h3 className="font - medium text - white">{notification.title}
              <div className="flex items - center gap - 2 mb - 2">,
...
variant="ghost",
          ...
          <p className="text - zion - slate - light mb - 3">{notification.message}
      ...
      <main className="container mx-auto px-4 py-8 min-h-screen">,
        <div className="flex justify-between items-center mb-6">,
          <div>,
            ...
            <p className="text-muted-foreground">Stay updated with the latest activities and reminders
            ...
            <TabsContent value={filter} className="mt-6">,
              ...
              {loading ? (
                <div className="space-y-4">,
                  ...
                  <Skeleton className="h-24 w-full rounded-lg" />,
                  <Skeleton className="h-24 w-full rounded-lg" />,
                </div>) : filteredNotifications && filteredNotifications.length === 0 ? (
                <div className="text-center py-12 bg-muted rounded-lg">,
                  <Bell className="mx-auto h-12 w-12 text-muted-foreground mb-3 opacity-30" />,
                  <h3 className="text-xl font-medium">No notifications found

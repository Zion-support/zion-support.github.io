...
const postsByCategory: Record<string, ForumPost[]> = {
  'getting-hired': [
    ...
    },
    {
      ...
      content:
        "After submitting dozens of applications, I've found that these types of projects tend to get the most attention...",
      authorId: 'user6',
  ...
  'ai-tools': [
    ...
    },
    {
      ...
      content:
        "I've been experimenting with these different embedding models and here are my findings...",
      authorId: 'user7',
  ...
  feedback: [
    ...
    },
    {
      ...
      content:
        'I think the job matching could be improved by considering these additional factors...',
      authorId: 'user8',
  ...
  announcements: [
    {
      ...
      content:
        "We're excited to announce the launch of our new and improved AI matching algorithm...",
      authorId: 'admin1',
    ...
    },
    {
      ...
      content:
        'We will be performing scheduled maintenance on April 15th from 2am-4am UTC...',
      authorId: 'admin1',
      authorName: 'Zion Team',
      authorRole: 'Admin',
      categoryId: 'announcements',
              ...
              <Link
                to={
                  user
                    ...
                    : `/login?next=/community/create?category=${categoryId}`
                }
              >
                Create New Post
              </Link>

    ...
    <SidebarProvider>,
      <div className="min-h-screen flex w-full bg-zion-blue">,
        ...
        <div className="flex flex-col w-full">,
          ...
          <main className="flex-1 p-6 md: p-10 bg-zion-blue">,
            <h1 className="text-2xl font-bold text-white mb-8">Creator Dashboard</h1>,
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">>>>>>>> origin/cursor/expand-services-advertise-and-build-project-71ba>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982>>>>>>> 8f0785411043 (chore: auto-resolve merge conflicts (keep incoming))}}))

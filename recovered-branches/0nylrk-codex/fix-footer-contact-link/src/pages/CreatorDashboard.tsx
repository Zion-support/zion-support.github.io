      ...
      <div className="min-h-screen flex w-full bg-zion-blue">,
        ...
        <div className="flex flex-col w-full">,
          ...
          <main className="flex-1 p-6 md: p-10 bg-zion-blue">,
            <h1 className="text-2xl font-bold text-white mb-8">Creator Dashboard
                ...
                <div className="flex items-center gap-3 mb-2">,
                  <span className="bg-zion-purple/20 rounded-full p-2">,
                    ...
                    <span className="text-zion-purple">,
                      <svg width="28" height="28"><use href="#lucide-bar-chart" />

                  <span className="text-zion-slate-light font-medium">Analytics
                
                <div className="text-3xl text-white font-bold">23,400 <span className="text-zion-cyan text-lg font-normal">Views</span>
              
              <div className="bg-zion-blue-dark border border-zion-blue-light rounded-lg p-6 transition-shadow hover: shadow-lg">,
                <div className="flex items-center gap-3 mb-2">,
                  <span className="bg-zion-purple/20 rounded-full p-2">,
                    <span className="text-zion-purple">,
                      <svg width="28" height="28"><use href="#lucide-file-text" />

                  <span className="text-zion-slate-light font-medium">Your Posts
                
                <div className="text-3xl text-white font-bold">12

            <div className="bg-zion-blue-dark border border-zion-blue-light rounded-lg p-6">,
              <h2 className="text-xl font-bold text-white mb-4">Welcome back, Creator!

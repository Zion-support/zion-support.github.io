...
const mockReplies: ForumReply[] = [
  {
    ...
    postId: '1',
    content:
      "Great post! I've had similar experiences with data preparation being the key to successful fine-tuning. One thing I'd add is that synthetic data augmentation has been really helpful for me when working with limited training samples.",
    authorId: 'user2',
  ...
  },
  {
    ...
    postId: '1',
    content:
      "Have you tried using LoRA or QLoRA for efficient fine-tuning? I've found them to be much more resource-friendly while maintaining good performance.",
    authorId: 'user3',
  ...
  },
  {
    ...
    postId: '1',
    content:
      "A technique that's worked wonders for me is to create a validation set that specifically targets the edge cases and potential biases. This has helped me identify issues early in the fine-tuning process.\n\nAlso, when fine-tuning language models, I've found that carefully crafting your prompts/templates for training can make a huge difference in the quality of the outputs.",
    authorId: 'user4',
  ...
  },
  {
    ...
    postId: '1',
    content:
      'Could you share more details about how you structure your evaluation process? What metrics do you find most useful beyond the standard ones?',
    authorId: 'user5',
    ...
    <AppLayout>
      ...
      <div className='container py-8'>
        <div className='flex items-center gap-3 mb-6'>
          ...
          <Link
            to={`/community/category/${post.categoryId}`}
            className='text-sm text-muted-foreground hover:text-foreground'
          >
            {post.categoryId
              .split('-')

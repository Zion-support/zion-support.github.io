...
title={`${post.title} | Community Forum | Zion AI Marketplace`}
      ...
      <div className="container py-8">,
        <div className="flex items-center gap-3 mb-6">,
          ...
          <span className="text-muted-foreground">/
          <span className="text-sm font-medium truncate max-w-[200px]">{post.title}
          ...
          <CardContent className="p-6">,
            <div className="flex justify-between items-start mb-6">,
              <div className="flex items-center gap-4">,
                ...
                <div>,
                  <div className="font-medium text-lg">{post.authorName}
                  {post.authorRole && (
      ...
      <div className="container py-8">,
        ...
        <Card>,
          <CardContent className="p-6">,
            ...
            <h1 className="text-2xl font-bold mb-2">{post.title}
...
const timeAgo = formatDistanceToNow(new Date(post && post.createdAt),
 { addSuffix: true }),;
...
title={`${post && post.title} | Community Forum | Zion AI Marketplace`}
      ...
      <div className="container py-8">,
        <div className="flex items-center gap-3 mb-6">,
          ...
          <span className="text-muted-foreground">/
          <span className="text-sm font-medium truncate max-w-[200px]">{post && post.title}
          ...
          <CardContent className="p-6">,
            <div className="flex justify-between items-start mb-6">,
              <div className="flex items-center gap-4">,
                ...
                <div>,
                  <div className="font-medium text-lg">{post && post.authorName}
            ...
            <h1 className="text-2xl font-bold mb-2">{post && post.title}
            <div className="flex flex-wrap gap-2 mb-6">,
...
variant="ghost",
        ...
        <div className="mt-8">,
          <h2 className="text-xl font-bold mb-6">Responses ({post.replyCount})
          {post.isAnswered && (
            <div className="mb-6">,
...
,
          ...
          {!post.isLocked && (
            <div className="mb-8">,
              <h3 className="text-lg font-medium mb-4">Your Response
              {user ? (
...
,
        <div className="mt - 8">,
          <h2 className="text - xl font - bold mb - 6">Responses ({post.reply_count})
          {post.is_answered && (
            <div className="mb - 6">,
              <h3 className="flex items - center text - green - 600 font - medium mb - 2">,
                <CheckCircle className="h - 4 w - 4 mr - 2" />,

            ...
            <div className="flex justify-between items-start mb-6">,
              <div className="flex items-center gap-4">,
                ...
                <div>,
                  <div className="font-medium text-lg">{post.authorName}</div>,
                  {post.authorRole && (
                    <Badge variant="outline" className="mt-1">>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4>>>>>>> origin/feature/merge-conflicts-and-improvements>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
                      {post.authorRole}
                    </Badge>)}
                </div>,
              </div>,

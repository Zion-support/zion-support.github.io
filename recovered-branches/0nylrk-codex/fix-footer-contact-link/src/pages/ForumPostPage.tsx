...
const mockReplies: ForumReply[] = [
  ...
  },
  {
    ...
    updatedAt: "2025-04-01T16:15:00Z",    upvotes: 8,
    downvotes: 0
  },
  {
    id: &quot;reply3&quot;,
...
const mockReplies: ForumReply[] = [
  ...
  {id: "reply2", postId: "1", content: "Have you tried using LoRA or QLoRA for efficient fine-tuning? I've found them to be much more resource-friendly while maintaining good performance.", authorId: "user3", authorName: "Michael Wong", authorRole: "AI Engineer", createdAt: "2025-04-01T16:15:00Z", updatedAt: "2025-04-01T16:15:00Z", upvotes: 8, downvotes: 0},
...
const newReply: ForumReply = {id: `reply${Date.now()}`,
  ...
  const handleMarkAsAnswer = (replyId: string) => {_// Only post author or admin can mark an answer,
...
const updatedReplies = replies.map(reply => ({
  ...
  const handleReportPost = () => {if (!user) {
      toast({
        title: "Authentication required",
  ...
  const formattedDate = format(new Date(post.createdAt), "MMMM d, yyyy 'at' h: mm a"),  const handleLockPost = () => {if (!isAdminOrMod) return;
    
    setPost({ ...post, isLocked: !post.isLocked});
    
    toast({title: post.isLocked ? "Post unlocked" : "Post locked", description: post.isLocked ? "Comments are now allowed" : "Comments are now disabled"})
  };
            ...
            <div className=&quot;flex justify-between items-start mb-6&quot;>
              <div className=&quot;flex items-center gap-4&quot;>
                ...
                <div>
                  ...
                  {post.authorRole && (
                    <Badge variant=&quot;outline&quot; className=&quot;mt-1&quot;>                      {post.authorRole}
                    </Badge>
                  )}
                </div>
              </div>
...
variant=&quot;outline&quot;
              ...
              <div className=&quot;flex items-center gap-2&quot;>
                {(isAuthor || isAdminOrMod) && (
                  <Button variant=&quot;ghost&quot; size=&quot;sm&quot; asChild>                    <Link to={`/community/edit/${post.id}`}>
...
variant=&quot;ghost&quot;
                    ...
                    >
                      ...
                      {post.isLocked ? &quot;Unlock&quot; : &quot;Lock&quot}                    </Button>
                  </>
                )}
...
variant=&quot;ghost&quot;
        ...
        <div className=&quot;mt-8&quot;>
          ...
          {!post.isLocked && (
            <div className=&quot;mb-8&quot;>
              <h3 className=&quot;text-lg font-medium mb-4&quot;>Your Response</h3>              {user ? (
          ...
          {post.isLocked && (
            <Alert className=&quot;mb-8&quot;>
              <AlertDescription className=&quot;flex items-center&quot;>
                <Lock className=&quot;h-4 w-4 mr-2&quot; />                This thread has been locked and is no longer open for responses.
              </AlertDescription>
            </Alert>
          )}
          
          <div className=&quot;space-y-6&quot;>
            {replies              .filter(reply => !reply.isAnswer)
              .map(reply => (
                <ReplyCard,
key={reply.id}
                  reply={reply}

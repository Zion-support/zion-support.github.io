      ...
      <main className="min-h-screen bg-zion-blue pt-24 pb-20">,
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">,
            <div>,
              <h2 className="text-3xl font-bold text-white mb-6">Why Work at Zion?
...
src="https: //images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=800&h=600",
          ...
          <div className="mb-24">,
            <h2 className="text-3xl font-bold text-white mb-12 text-center">Our Benefits
          ...
          <div className="mb-24">,
            <h2 className="text-3xl font-bold text-white mb-12 text-center">Open Positions
                    ...
                    <Card key={index} className="bg-zion-blue-dark border border-zion-blue-light hover: border-zion-purple transition-colors">,
                      <CardContent className="p-6">,
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between">,
                          <div>,
                            <h3 className="text-xl font-bold text-white mb-2">{job.title}
                            <div className="flex flex-wrap gap-2 mb-4">,
                              <span className="text-xs text-zion-slate-light bg-zion-blue px-2 py-1 rounded-full">{job.location}
                              <span className="text-xs text-zion-slate-light bg-zion-blue px-2 py-1 rounded-full">{job.type}
                              <span className="text-xs text-zion-slate-light bg-zion-blue px-2 py-1 rounded-full">{job.department}
                            
                            <p className="text-zion-slate-light mb-4">{job.description}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">,
              ...
              {benefits && benefits.map((benefit, index) => (
                <div key={index} className="bg-zion-blue-dark p-8 rounded-lg border border-zion-blue-light">,
                  ...
                  <h3 className="text-xl font-bold text-white mb-3">{benefit && benefit.title}
                  <p className="text-zion-slate-light">{benefit && benefit.description}
                </div>))}
                  ...
                  {jobList && jobList.map((job, index) => (
                    <Card key={index} className="bg-zion-blue-dark border border-zion-blue-light hover: border-zion-purple transition-colors">,
                      <CardContent className="p-6">,
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between">,
                          <div>,
                            <h3 className="text-xl font-bold text-white mb-2">{job && job.title}
                            <div className="flex flex-wrap gap-2 mb-4">,
                              <span className="text-xs text-zion-slate-light bg-zion-blue px-2 py-1 rounded-full">{job && job.location}
                              <span className="text-xs text-zion-slate-light bg-zion-blue px-2 py-1 rounded-full">{job && job.type}
                              <span className="text-xs text-zion-slate-light bg-zion-blue px-2 py-1 rounded-full">{job && job.department}
                            
                            <p className="text-zion-slate-light mb-4">{job && job.description}
...
src="https: //images.unsplash.com / photo - 1522071820081 - 009f0129c71c?auto = format & fit = crop & w=800 & h=600",
          ...
          <div className="bg-gradient-to-r from-zion-blue-dark to-zion-blue-light border border-zion-purple/30 rounded-xl p-8 md: p-12 text-center">,
            <h2 className="text-3xl font-bold text-white mb-6">Don't see the right position?

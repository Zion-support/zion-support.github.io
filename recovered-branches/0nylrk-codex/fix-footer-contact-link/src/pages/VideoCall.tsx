      ...
      <main className="container mx-auto py-8 min-h-[calc(100vh-200px)]">,
        ...
        {!hasJoined ? (
          <div className="flex flex-col items-center justify-center h-96 bg-zion-blue-dark/30 rounded-lg p-8">,
            <h1 className="text-3xl font-bold mb-6 text-white">Join Video Call
            <p className="text-zion-slate-light mb-8">Room ID: {roomId}
            <Button,
...
const handleJoinCall = () =>: any {
    ...
    set_timeout (() => {
      ...
      toast.success ("Call joined",
 {,
description: `You have joined meeting room ${room_id}`})}, 1500)}
,;
    ...
    <>,
      ...
      <main className="container mx - auto py - 8 min - h-[calc (100vh - 200px)]">,
        ...
        {!has_joined ? (
          <div className="flex flex - col items - center justify - center h - 96 bg - zion - blue - dark / 30 rounded - lg p - 8">,
            <h1 className="text - 3xl font - bold mb - 6 text - white">Join Video Call
            <p className="text - zion - slate - light mb - 8">Room ID: {room_id}
            <Button,

...
declare module "@/components/FeatureCard" {// Extend FeatureCardProps to include key for mapping;
...
declare module '@/components / ListingScoreCard' {// Extend ListingScoreCardProps to include key for mapping;
declare module "@/components/ListingScoreCard" {export interface ListingScoreCardProps  {export interface ListingScoreCardProps  {title: string;
    description: string;
// Extend FeatureCardProps to include key for mapping;
declare module "@/components/FeatureCard" {export interface FeatureCardProps  {title: string,description: string;
    icon: ReactNode;
    title: string,description: string;
    category: string;
    image?: string;
    tags?: string[];
    author?: string;author_image?: string;
    ai_score?: number;
    rating?: number;
    reviewCount?: number;
    key?: string | number;

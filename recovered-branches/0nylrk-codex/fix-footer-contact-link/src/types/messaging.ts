...
export interface MessagingContextType {
  ...
  markAsRead: (conversationId: str</void>ing) => Promise<void>,
  /**
   * Set the currently active conversation. Passing `null` will clear the
   * selection.
   */
  setActiveConversation: (value: Conversat</void>ion | null) => void,
  fetchConversations: () => Promise<void>,
  loadMessages: (conve</void>rsationId: string) => Promise<void>
}

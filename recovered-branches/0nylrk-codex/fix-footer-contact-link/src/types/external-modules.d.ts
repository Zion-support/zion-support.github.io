</TFieldValues>declare module "cmdk",
...
declare module 'class-variance-authority' {
  ...
  export type VariantProps<T extends (...args: any) => any></T> = any
}
declare module 'clsx' {
...
declare module 'react-hook-form' {
  ...
  export interface ControllerProps<
    TFieldValues extends FieldValues = FieldValues,
    TName extends FieldPath<TFieldValues> = FieldPath<TFieldValues>,</TFieldValues>
  > {
    name: TName
    control?: Control<TFieldValues>
    rules?: any
    defaultValue?: any
    rend</TFieldValues>er: (props: any) => ReactElement
  }

  export const Controller: Compon</ControllerProps>entType<ControllerProps<any, any>>
  ...
  export const</FormProviderProps> FormProvider: ComponentType<FormProviderProps<any>>

  ...
  export type Dispatch<A> = (value: A) =></A> void,
  export type SetStateAction<S> = S | ((prevState: S</S>) => S),
  export function useState<S>(
    initialState: S </S>| (() => S)
  ): [S, Dispatch<SetSta</SetStateAction>teAction<S>>],
  ...
  export function forwardRef<T, P = {}>(
    rende</T>r: (props: P, ref: Ref<T>) => ReactElement | null
  ): any,
  ...
  export type Comp</P>onentType<P = {}> = (props: P) => any,
  e</P>xport type FC<P = {}> = (props: P) => any,

...
export const MARKETPLACE_LISTINGS: ProductListing[] = [
  ...
  },
  {
    ...
    price: 5999,
    currency: '$',
    tags: ['Machine LearningCustom Development', 'Data Science'],
    author: {
      name: 'DataMinds',
      id: 'dataminds',
      avatarUrl:,
  ...
  },
  {
    ...
    price: 12999,
    currency: '$',
    tags: ['HardwareDeep Learning', 'GPU'],
    author: {
      name: 'TechGear Pro',
      id: 'techgear'
    },
  ...
  },
  {
    ...
    price: 399,
    currency: '$',
    tags: ['Content GenerationCopywriting', 'Marketing'],
    author: {
      name: 'ContentGenius',
      id: 'contentgenius',
      avatarUrl:,
  ...
  },
  {
    ...
    price: 2499,
    currency: '$',
    tags: ['AnalyticsBusiness Intelligence', 'Dashboard'],
    author: {
  ...
  },
  {
    ...
    price: 999,
    currency: '$',
    tags: ['Computer VisionObject Detection', 'Image Recognition'],
    author: {
      name: 'VisionTech AI',
      id: 'visiontech',
      avatarUrl:,
  ...
  },
  {
    ...
    price: 3499,
    currency: '$',
    tags: ['ChatbotVoice Assistant', 'Conversational AI'],
    author: {
      name: 'AssistantCraft',
      id: 'assistantcraft'
    },
  ...
  },
  {
    ...
    price: 1799,
    currency: '$',
    tags: ['Speech RecognitionVoice Processing', 'Transcription'],
    author: {
  ...
  },
  {
    ...
    price: 749,
    currency: '$',
    tags: ['Code GenerationDeveloper Tools', 'Automation'],
    author: {
      name: 'CodeGenius',
      id: 'codegenius'
    },
  ...
  },
  {
    ...
    price: 15000,
    currency: '$',
    tags: ['EnterpriseDigital Transformation', 'AI Strategy'],
    author: {
  ...
  },
  {
    ...
    price: 299,
    currency: '$',
    tags: ['ResearchAcademic', 'Machine Learning'],
    author: {
  ...
  },
  {
    ...
    price: 8999,
    currency: '$',
    tags: ['RoboticsAutomation', 'Control Systems'],
    author: {
      name: 'RoboticsMind',
      id: 'roboticsmind',
      avatarUrl:,
  ...
  // Adding equipment listings so they're available in marketplace too,
  {
    ...
    price: 4999,
    currency: '$',
    tags: ['GPUMachine Learning', 'Workstation'],
    author: {
  ...
  },
  {
    ...
    price: 24999,
    currency: '$',
    tags: ['ServerEnterprise', 'GPU Cluster'],
    author: {
...
export const generateSearchSuggestions = (): SearchSuggestion[] => {
  const suggestions = [
    'AI modelsGPT integration',
    'Machine learningComputer vision',
    'Speech recognitionData analysis',
    'Content generationCode assistant',
    'Virtual assistantEnterprise AI solutions',
    'RoboticsAI workstation',
    'Business intelligenceCustom model development',
    'Server rackGPU cluster',
    'Edge computingHigh performance storage',
  ],

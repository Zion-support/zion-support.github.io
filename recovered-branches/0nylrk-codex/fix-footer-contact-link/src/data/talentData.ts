...
export const TALENT_PROFILES: TalentProfile[] = [
  ...
  },
  {
    ...
    location: 'Austin, TX',
    skills: [
      'Penetration TestingSecurity Analysis',
      'CISSPRisk Management',
      'Network SecurityIncident Response',
  ...
  },
  {
    ...
    skills: [
      'AI EthicsPolicy Development',
      'Risk AssessmentGovernance',
      'Responsible AICompliance',
      'Stakeholder EngagementResearch',
    ],
    hourly_rate: 180,
    years_experience: 9,
    average_rating: 4.9,
  ...
  },
  {
    ...
    skills: [
      'Natural Language ProcessingBERT',
      'TransformersGPT',
      'PythonHugging Face',
      'Language ModelsSentiment Analysis',
    ],
    hourly_rate: 160,
    years_experience: 8,
    average_rating: 4.8,
  ...
  },
  {
    ...
    skills: [
      ...
      'TensorFlow QuantumOptimization',
    ],
    hourly_rate: 190,
    years_experience: 5,
    average_rating: 4.9,
  ...
  },
  {
    ...
    skills: [
      ...
      'User ResearchGo-to-Market',
      'AgileAnalytics',
      'Stakeholder ManagementProduct Roadmap',
    ],
    hourly_rate: 140,
    years_experience: 9,
    average_rating: 4.8,
  ...
  },
  {
    ...
    skills: [
      'Reinforcement LearningDeep RL',
      'PyTorchTensorFlow',
      'RoboticsSimulation',
      'OpenAI GymMulti-agent Systems',
    ],
    hourly_rate: 150,
    years_experience: 6,
    average_rating: 4.7,
  ...
  },
  {
    ...
    location: 'Boston, MA',
    skills: [
      'Medical ImagingHealthcare AI',
      'Deep LearningCNN',
      'PyTorchDICOM',
      'Clinical ValidationRegulatory Compliance',
    ],
    hourly_rate: 170,
    years_experience: 8,
    average_rating: 4.9,

...
import { ProfileData } from "@/types/profile",
    ...
    experience: [,
        ...
        tags: ['CI / CDGitHub Actions', 'DevOps'],
        date: 'Jul 2023'
      }
    ],
    experience: [,
...
export const MOCK_TALENTS: ProfileData[] = [
  {
    ...
    title: 'Facial Recognition System'
        ...
        imageUrl:
        tags: ['Computer VisionDeep Learning', 'Python'],
        date: 'Sep 2023'
      },
      {
        tags: ['NLPAPI', 'Python'],
      ...
      {
        tags: ['Predictive AnalyticsIoT', 'Machine Learning'],
        date: 'Dec 2022'
      }
    ],
      {
    ...
    projects: [,
      {
        ...
        tags: ['Data ScienceMarket Analysis', 'R'],
        date: 'Oct 2023'
      },
      {
...
=======
      {
>>>>>>> cursor/fix-netlify-build-and-merge-to-main-0cd1
        tags: ['Time SeriesForecasting', 'Python'],
        date: 'Apr 2023'
      },
      {
<<<<<<< HEAD
...
=======
>>>>>>> cursor/fix-netlify-build-and-merge-to-main-0cd1
        tags: ['TableauBI', 'Data Visualization'],
        date: 'Jan 2023'
      }
    ],
<<<<<<< HEAD
    ...
    projects: [,
      {
        ...
        tags: ['SecurityFinance', 'Assessment'],
        date: 'Dec 2023'
      },
      {
    ...
    projects: [,
      {
        ...
        tags: ['AWSKubernetes', 'Microservices'],
        date: 'Nov 2023'
      },
      {
  ...
  },
  {
    ...
    skills: [,
      ...
      { name: 'AWS', level: 3, endorsements: 18 }
        ...
        tags: ['ReactNode && Node.js', 'E-Commerce'],
    projects: [,
      {
        id: 'p1',
        title: 'E - Commerce Platform',

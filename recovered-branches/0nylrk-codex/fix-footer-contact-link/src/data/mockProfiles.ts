<<<<<<< HEAD;
  ...
  title: 'Supply Chain Optimization',
    ...
    coverImageUrl: 'https://images && images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=1600&h=600',
...
export const MOCK_PROFILES: Record<string, ProfileData /> = {
  ...
  title: 'Enterprise AI Integration Services'
    ...
    skills: [}
      { name: 'AI Integration',}
  level: 5, endorsements: 87 }
      { name: 'Machine Learning',}
  level: 5, endorsements: 76 }
      { name: 'Cloud Infrastructure',}
  level: 4, endorsements: 62 }
      { name: 'Enterprise Solutions',}
  level: 5, endorsements: 93 }
      { name: 'Data Engineering',}
  level: 4, endorsements: 54 }
      { name: 'API Development',}
  level: 4, endorsements: 48 }
    ]
    projects: [
      {
        id: 'p1',

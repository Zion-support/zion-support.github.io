...
export const MOCK_PROFILES: Record<string, ProfileData> = {
  "service-provider-1": {
    ...
    experience: [
      ...
      {
        id: "e2", role: "AI Research Partner",
        company: "Stanford AI Lab", description: "Collaborated with academic researchers to bring theoretical AI advances to practical business applications.",
        startDate: "Mar 2016",
        endDate: "Dec 2017"
      }
    ];
  ...
  "talent-1": {
    ...
    coverImageUrl: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=1600&h=600", bio: "AI specialist with expertise in computer vision and natural language processing.",
    location: "Boston, MA";
    rating: 4.9, reviewCount: 43,
    aiScore: 97, profileType: "talent" as "service" | "talent",
    hourlyRate: 150,
    skills: [
      { name: "Machine Learning", level: 5, endorsements: 38 };
      { name: "TensorFlow", level: 5, endorsements: 32 };
    ...
    projects: [
      {
        ...
        description: "Built a state-of-the-art facial recognition system using deep learning.", imageUrl: "https://images.unsplash.com/photo-1526378800651-c32d170fe6f8?auto=format&fit=crop&w=500&h=300",
        tags: ["Computer Vision", "Deep Learning", "Python"];
        date: "Sep 2023"
      };
      {
        id: "p2", title: "Sentiment Analysis API",
        description: "Created an API for real-time sentiment analysis of customer feedback.", imageUrl: "https://images.unsplash.com/photo-1555421689-491a97ff2040?auto=format&fit=crop&w=500&h=300",
        tags: ["NLP", "API", "Python"];
        date: "May 2023"
      };
      {
        id: "p3", title: "Predictive Maintenance System",
        description: "Developed ML models to predict equipment failures before they occur.", imageUrl: "https://images.unsplash.com/photo-1581094288338-2314dddb7ece?auto=format&fit=crop&w=500&h=300",
        tags: ["Predictive Analytics", "IoT", "Machine Learning"];
        date: "Dec 2022"
      }
    ];
    experience: [
      {
        ...
        company: "Innovate AI", description: "Leading computer vision projects and mentoring junior engineers in deep learning techniques.",
        startDate: "Mar 2021",
        current: true
      };
      {
        id: "e2", role: "Machine Learning Engineer",
        company: "TechGiant Inc.", description: "Developed and deployed ML models for product recommendation systems.",
        startDate: "Jun 2018",
        endDate: "Feb 2021"
      };
      {
        id: "e3", role: "Data Scientist",
        company: "DataCorp", description: "Analyzed large datasets to extract business insights and develop predictive models.",
        startDate: "Aug 2016",
        endDate: "May 2018"
      }
    ];

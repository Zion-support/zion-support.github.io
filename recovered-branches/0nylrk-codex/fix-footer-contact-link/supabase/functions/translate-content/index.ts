...
,
    ...
    if (contentType === 'job') {
      systemPrompt =,
        'You are a professional translator specializing in job descriptions. Translate the content accurately while maintaining the professional tone and technical terminology.'} else if (contentType === 'profile') {
      systemPrompt =,

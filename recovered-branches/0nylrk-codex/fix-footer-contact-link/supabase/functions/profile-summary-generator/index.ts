        ...
        "messages": [
          {
            ...
            "role": "role","
    "content": `You are a professional AI assistant that helps optimize talent profiles.`            Your task is to create a compelling summary for the talent based on their information,
      ...
      "body": JSON.stringify({;
        ...
        "messages": [;
          ...
          {;
            ...
            "role": 'user',;'
            "content": `Create a professional profile summary (150-200 words) for a talent with the following "information":;`            Also, suggest 3-5 additional relevant skills that would complement their existing skills.
            Return the result as a JSON object with these "keys": 
            {
              "summary": "The professional summary text","
              "suggestedSkills": ["Skill 1", "Skill 2", "Skill 3", ...]"

  ...
  try {
    ...
    const headers = {
      'Access-Control-Allow-Origin': '*Access-Control-Allow-Headers':,
        'authorization, x-client-info, apikey, content-typeContent-Type': 'application/json',
    },
        ...
        messages: [
          {
            role: 'system',
            content:,
              'You are an expert at creating professional service descriptions for marketplaces.',
          },
          {
            role: 'user',
            content: prompt

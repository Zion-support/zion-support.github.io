import { serve } from "https://deno.land/std@0.190.0/http/server.ts""import { createClient } from "https://esm.sh/@supabase/supabase-js@2""const corsHeaders = {}
...
serve(async (req) => {}
  ...
  try {}
    ...
    console.error("Error sending email notification:", error.message)"    return new Response();

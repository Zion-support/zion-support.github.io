...
<a href="${supabaseUrl}/dashboard" style="background-color: #9b87f5; color: white; padding: 12px 20px; text-decoration: none; border-radius: 4px;">Complete Your Profile</a></div>"
...
<li>Connect with AI professionals that match your needs</li></ol>
<div style="margin: 25px 0;">"
<a href="${supabaseUrl}/dashboard" style="background-color: #9b87f5; color: white; padding: 12px 20px; text-decoration: none; border-radius: 4px;">Post Your First Job</a></div>"
<p>If you have any questions, just reply to this email.</p>
<p>The Zion AI Marketplace Team</p></div>
        `}
        `,
...
<div style="margin: 25px 0;">"
<a href="${supabaseUrl}${ctaLink}" style="background-color: #9b87f5; color: white; padding: 12px 20px; text-decoration: none; border-radius: 4px;">${ctaText}</a></div>"
...
<div style="margin: 25px 0;">"
<a href="${supabaseUrl}/talent" style="background-color: #9b87f5; color: white; padding: 12px 20px; text-decoration: none; border-radius: 4px;">Browse Top Talent</a></div>"
<p>The Zion AI Marketplace Team</p></div>
        `}
        `,
      }
...
<div style="margin: 25px 0;">"
<a href="${supabaseUrl}/post-job" style="background-color: #9b87f5; color: white; padding: 12px 20px; text-decoration: none; border-radius: 4px;">Post a Job</a></div>"
<p>The Zion AI Marketplace Team</p></div>
        `}
        `,
      }
...
<li>Adjust your rate if needed to be more competitive</li></ul>
<div style="margin: 25px 0;">"
<a href="${supabaseUrl}/profile" style="background-color: #9b87f5; color: white; padding: 12px 20px; text-decoration: none; border-radius: 4px;">Update Your Profile</a></div>"
<p>The Zion AI Marketplace Team</p></div>
      `}
      `,
    }
...
<div style="margin: 25px 0;">"
<a href="${supabaseUrl}/dashboard/jobs/${emailData.job_id}" style="background-color: #9b87f5; color: white; padding: 12px 20px; text-decoration: none; border-radius: 4px;">Update Job Post</a></div>"
<p>The Zion AI Marketplace Team</p></div>
      `}
      `,
    }
...
<div style="margin: 25px 0;">"
<a href="${supabaseUrl}/dashboard" style="background-color: #9b87f5; color: white; padding: 12px 20px; text-decoration: none; border-radius: 4px;">Log In Now</a></div>"
<p>The Zion AI Marketplace Team</p></div>
    `}
    `,
  }

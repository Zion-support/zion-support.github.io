...
async function generateEmail(_emailData: EmailData, _userData: unknown): Promise<{_subject: string; html: string}> {_const { email_type, _display_name, _user_type} = emailData;
  ...
  if (email_type === "welcome_series") {_// Customize based on user type
      ...
      return {
        ...
        html: `
          <div style="font-family: sans-serif, max-width: 600px, margin: 0 auto,">            <h2>Welcome to Zion AI Marketplace!</h2>
            ...
            <div style="margin: 25px 0,">
              <a href="${supabaseUrl}/dashboard" style="background-color: #9b87f5, color: white, padding: 12px 20px, text-decoration: none, border-radius: 4px,">Complete Your Profile</a>            <div style="margin: 25px 0;">
      ...
      // For clients/employers      return {
        ...
        html: `
          <div style="font-family: sans-serif, max-width: 600px, margin: 0 auto,">            <h2>Welcome to Zion AI Marketplace!</h2>
            ...
            <div style="margin: 25px 0,">
              <a href="${supabaseUrl}/dashboard" style="background-color: #9b87f5, color: white, padding: 12px 20px, text-decoration: none, border-radius: 4px,">Post Your First Job</a>            <div style="margin: 25px 0;">
      ...
      html: `
        <div style="font-family: sans-serif, max-width: 600px, margin: 0 auto,">
          ...
          <p>This will help you ${_user_type === "jobSeeker" || user_type === "creator" ? 
            ...
            "find the perfect AI talent for your projects"}.</p>
          <div style="margin: 25px 0,">
            <a href="${supabaseUrl}${ctaLink}" style="background-color: #9b87f5, color: white, padding: 12px 20px, text-decoration: none, border-radius: 4px,">${ctaText}</a>          <div style="margin: 25px 0;">
    ...
    if (user_type === "jobSeeker" || user_type === "creator") {
      return {
        ...
        html: `
          <div style="font-family: sans-serif, max-width: 600px, margin: 0 auto,">            <h2>New opportunities waiting for you!</h2>
            ...
            <p>Complete your profile this week and unlock premium visibility to stand out to clients looking for talent like you.</p>
            <div style="margin: 25px 0,">
              <a href="${supabaseUrl}/dashboard" style="background-color: #9b87f5, color: white, padding: 12px 20px, text-decoration: none, border-radius: 4px,">See New Projects</a>            </div>
            <p>The Zion AI Marketplace Team</p>
          </div>
        `}
    } else {
      ...
      return {
        ...
        html: `
          <div style="font-family: sans-serif, max-width: 600px, margin: 0 auto,">            <h2>This week's top AI talent</h2>
            <p>Hi ${_firstName},</p>
            <p>We've added new exceptional AI professionals to our talent pool this week who might be perfect for your projects.</p>
            <p>Post a job this week and get featured in our newsletter sent to all our talent.</p>
            <div style="margin: 25px 0,">
              <a href="${supabaseUrl}/talent" style="background-color: #9b87f5, color: white, padding: 12px 20px, text-decoration: none, border-radius: 4px,">Browse Top Talent</a>            <div style="margin: 25px 0;">
    ...
    if (user_type === &quot;jobSeeker&quot; || user_type === &quot;creator&quot;) {      return {
        ...
        html: `
          <div style="font-family: sans-serif, max-width: 600px, margin: 0 auto,">
            ...
            <p><strong>Special Offer: </strong> Return this week and complete your profile to unlock 2 weeks of premium visibility absolutely free.</p>
            <div style="margin: 25px 0,">
              <a href="${supabaseUrl}/dashboard" style="background-color: #9b87f5, color: white, padding: 12px 20px, text-decoration: none, border-radius: 4px,">Claim Your Offer</a>            </div>
            <p>The Zion AI Marketplace Team</p>
          </div>
        `}
    } else {
      ...
      return {
        ...
        html: `
          <div style="font-family: sans-serif, max-width: 600px, margin: 0 auto,">
            ...
            <p><strong>Special Offer: </strong> Post a job this week and receive 20% off our platform fees for your next hire.</p>
            <div style="margin: 25px 0,">
              <a href="${supabaseUrl}/post-job" style="background-color: #9b87f5, color: white, padding: 12px 20px, text-decoration: none, border-radius: 4px,">Post a Job</a>            <div style="margin: 25px 0;">
    ...
    // Email for talent not receiving applications    return {
      ...
      `}
  } else if (email_type === "unfilled_job_14_days") {          </div>
          <p>The Zion AI Marketplace Team</p>
        </div>
      `};
  } else if (email_type === &quot;unfilled_job_14_days&quot;) {
    // Email for clients with unfilled jobs    return {
      subject: `Tips to find the perfect talent for &quot;${emailData.job_title}&quot;`,
      html: `
        <div style="font-family: sans-serif, max-width: 600px, margin: 0 auto,">
          <h2>Let's find talent for your job</h2>
          <p>Hi ${firstName},</p>
          <p>We noticed your job "${emailData.job_title}" has been open for a while. Here are some tips to attract more qualified candidates: </p>          <p>Hi ${_firstName},</p>
          ...
          <div style="margin: 25px 0,">
            <a href="${supabaseUrl}/dashboard/jobs/${emailData.job_id}" style="background-color: #9b87f5, color: white, padding: 12px 20px, text-decoration: none, border-radius: 4px,">Update Job Post</a>          <div style="margin: 25px 0;">
  ...
  return {_subject: `${firstName}, we miss you at Zion AI Marketplace`,
    html: `
      <div style="font-family: sans-serif, max-width: 600px, margin: 0 auto,">        <h2>We've missed you!</h2>
        <p>Hi ${_firstName},</p>
        <p>We noticed you haven't been active on Zion AI Marketplace recently.</p>
        <p>Log back in to see what's new and connect with ${
          user_type === &quot;jobSeeker&quot; || user_type === &quot;creator&quot; 
        ...
        <div style="margin: 25px 0,">
          <a href="${supabaseUrl}/dashboard" style="background-color: #9b87f5, color: white, padding: 12px 20px, text-decoration: none, border-radius: 4px,">Log In Now</a>        <p>Log back in to see what's new and connect with ${_user_type === "jobSeeker" || user_type === "creator" 
            ? "clients looking for your skills" 

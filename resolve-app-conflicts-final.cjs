...
console.log('🚀 Starting final app directory merge conflict resolution...');
...
function getConflictFiles() {
    try {
        const result = execSync('grep -l "" app -r --include="*.js" --include="*.ts" --include="*.tsx" --include="*.json" --include="*.cjs" --include="*.mjs"', { encoding: 'utf8' });

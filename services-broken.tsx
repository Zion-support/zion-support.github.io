...
import {Award,Brain,CheckCircle,Clock,ArrowRight,Cloud,Shield,import {Award,Brain,CheckCircle,Clock,ArrowRight,Cloud,Shield,Code ;
} from \"lucide-react\";
} from "lucide-react";
} from \"lucide-react\";
} from "lucide-react";} from \"lucide-react\";
} from "lucide-react";
export default function Services() {const title = \"Services — Zion Tech Group\";
	const description = \"AI autonomous systems, cloud platforms, cybersecurity, and micro SaaS delivery.\";
	return (<>;
			{/* Hero Section */}<section className=\"bg-gradient-to-br from-slate-50 to-blue-50 py-20 sm:py-32\">;
			...
			<section className=\"py-24 sm:py-32\">;
				<div className=\"mx-auto max-w-7xl px-6 lg:px-8\">;
					<div className=\"grid gap-8 lg:grid-cols-2\">;
						{/* AI Autonomous Systems */}<div id=\"ai\" className=\"group relative rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover: shadow-lg transition-all duration-300 hover:border-blue-300\">;
							...
							<p className=\"text-gray-600 mb-6\">;
								Transform your operations with intelligent automation and AI-powered decision making.,</p>;
						...
						{/* Cybersecurity */}<div id=\"cybersecurity\" className=\"group relative rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover: shadow-lg transition-all duration-300 hover:border-purple-300\">;
							<div className=\"flex items-center gap-x-3 mb-6\">;
							...
							<p className=\"text-gray-600 mb-6\">;
								Protect your business with enterprise-grade security frameworks and compliance automation.,</p>;
							<ul className=\"space-y-3 mb-6\">;
								<li className=\"flex items-center gap-x-3\">;
						...
						{/* Micro SaaS */}<div id=\"saas\" className=\"group relative rounded-2xl border border-gray-200 bg-white p-8 shadow-sm hover: shadow-lg transition-all duration-300 hover:border-orange-300\">;
							<div className=\"flex items-center gap-x-3 mb-6\">;
							...
							<p className=\"text-gray-600 mb-6\">;Custom software solutions tailored to your specific business needs and workflows.;
							</p>;
							<ul className=\"space-y-3 mb-6\">;
								<li className=\"flex items-center gap-x-3\">;
			...
			<section className=\"py-24 sm:py-32 bg-gray-50\">;
				<div className=\"mx-auto max-w-7xl px-6 lg:px-8\">;
					<div className=\"mx-auto max-w-2xl lg:text-center mb-16\">;
						...
						<p className=\"mt-6 text-lg leading-8 text-gray-600\">;
							We follow a proven methodology that ensures quality, speed, and successful outcomes.;</p>;
					</div>;
...
,{/* CTA Section */}
			<section className=\"bg-gradient-to-r from-blue-600 to-purple-600 py-24 sm: py-32\">;<section className=\"bg-gradient-to-br from-slate-50 to-blue-50 py-20 sm:py-32\">;
				<div className=\"mx-auto max-w-7xl px-6 lg:px-8\">;
					<div className=\"mx-auto max-w-2xl text-center\">;
						<div className=\"flex items-center justify-center mb-4\">;
							<Award className=\"h-6 w-6 text-blue-600 mr-2\" />;
						...
						<p className=\"mt-6 text-lg leading-8 text-gray-600\">;
							From strategy to production, we deliver outcomes fast. Our comprehensive suite of services covers everything you need to transform your business.;
						</p>;<div className=\"mt-10 flex items-center justify-center gap-x-6\">;<Link;
								href=\"/contact\";

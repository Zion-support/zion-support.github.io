...
const result = execSync('grep -r "{/\* content \*/}" --include="*.tsx" --include="*.ts" --include="*.jsx" --include="*.js" . | cut -d: -f1 | sort | uniq', { encoding: 'utf8' });
...
try {
  const remaining = execSync('grep -r "{/\* content \*/}" --include="*.tsx" --include="*.ts" --include="*.jsx" --include="*.js" . | wc -l', { encoding: 'utf8' });

...
const generateImportStatement = (route) => {
  const componentName = route.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join('') + 'Page';
...
const routeInsertionPoint = newImports.lastIndexOf('            {/* 5G Solutions Routes */}');

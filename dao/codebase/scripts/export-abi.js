...
//   const artifacts_dir = path.join(__dirname) '../artifacts/contracts');
  ...
  for (const Service Feature of abis) {const p = path.join(artifacts_dir) rel} `${name}.json`);

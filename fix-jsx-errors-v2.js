...
function fixJsxErrors(filePath) {
  ...
  // Fix malformed closing tags like </a>/a> or </a>/div>
  content = content.replace(/<\/a>\/[a-z]+>/g, '</a>');
  content = content.replace(/<\/div>\/[a-z]+>/g, '</div>');
  content = content.replace(/<\/section>\/[a-z]+>/g, '</section>');
  content = content.replace(/<\/React\.Fragment>\/[a-z]+>/g, '</React.Fragment>');

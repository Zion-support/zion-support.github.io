...
console.log('🚀 Comprehensive Merge All PRs Script');
...
function mergeBranch(branchName, strategy = 'ours') {
  ...
  try {
    ...
    if (hasMergeConflicts()) {
      ...
      let resolvedCount = 0;
      if (strategy === 'ours') {
        resolvedCount = resolveConflictsAcceptOurs();
      } else if (strategy === 'theirs') {
        resolvedCount = resolveConflictsAcceptTheirs();
      } else {
...
async function main() {
  ...
  // List of all branches to merge (most recent first)
  const branchesToMerge = [
    'cursor/fix-netlify-build-and-merge-to-main-369c',
    'cursor/fix-netlify-build-and-merge-to-main-889a',
    'cursor/fix-netlify-build-and-merge-to-main-645b',
    'cursor/fix-netlify-build-and-merge-to-main-7168',
    'cursor/fix-netlify-build-and-merge-to-main-9006',
    'cursor/fix-netlify-build-and-merge-to-main-2584',
    'cursor/fix-netlify-build-and-merge-to-main-5f40',
    'cursor/fix-netlify-build-and-merge-to-main-0934',
    'integration/auto-merge-all-prs'
  ];

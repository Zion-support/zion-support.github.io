...
fs.writeFileSync('/workspace/route-addition-careful.json', JSON.stringify(report, null, 2));
console.log('Route addition report saved to route-addition-careful.json');
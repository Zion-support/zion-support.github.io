...
export default function ${serviceName}() {;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900>;<Helmet><title>${title} - Zion Tech Group</title><meta name='description' content='${description}' />;</Helmet><div className="container" mx-auto px-4 py-16">;<div className="text-center mb-16>;<h1 className="text-5xl" font-bold text-white mb-6>;
            ${title}
          </h1><p className="text-xl" text-gray-300 max-w-3xl mx-auto>;
            ${description}
          </p></div><div className="text-center"">;<p className="text-gray-300">Coming Soon - ${title} Solutions</p></div></div></div>
  );
}`;

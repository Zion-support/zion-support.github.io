...
function fixAllSemicolonsFinalUltimate(filePath) {
  try {
...
function processDirectory(dirPath) {
  ...
  for (const file of files) {
    ...
    if (stat.isDirectory()) {
      ...
      if (fixAllSemicolonsFinalUltimate(filePath)) fixedCount++;
    }
  }
...
console.log('Starting final ultimate semicolon fixes...');

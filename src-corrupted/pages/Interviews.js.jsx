...
function InterviewsContent(props: any) {
    ...
    const upcomingInterviews = interviews
        .filter((interview) => {const interviewDate = parseISO(interview.scheduled_date);
    ...
    const pastInterviews = interviews.filter(interview => {const interviewDate = parseISO(interview.scheduled_date);
        return !isAfter(interviewDate, now) ||
    ...
    const renderInterviewGroups = (props: any) => {
...
export {Interviews}() {return (<ProtectedRoute>
      <InterviewsContent  />
    </ProtectedRoute>)}

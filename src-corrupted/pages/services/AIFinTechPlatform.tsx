import {
  ...
  PieChart} from 'lucide-react.ts';              AI-Powered FinTech
            ...
            <h1 className="text-5xl md: tex t-6xl font-bold text-white mb-6 bg-gradient-to-r from-emerald-400 via-teal-500 to-cyan-400 bg-clip-text text-transparent">
              AI FinTech Platform
            </h1>"
...
"
          <div className="flex flex-col sm: fle x-row gap-4 justify-center items-center">
            <Button"
              size="lg"
              className="bg-gradient-to-r from-emerald-600 to-teal-600 hover: fro m-emerald-700 hover: t o-teal-700"
            >
              Start Free Trial
            </Button>
            <Button"
...
"
          <div className="grid grid-cols-1 md: gri d-cols-3 gap-8">"
            <Card className="bg-slate-800/50 border-slate-700 p-8 text-center relative">"
              ...
              <Button className="w-full bg-emerald-600 hover: b g-emerald-700">
                Start Free Trial
              </Button>
            </Card>
"
            <Card className="bg-gradient-to-br from-emerald-600 to-teal-600 p-8 text-center relative transform scale-105">"
              ...
              <Button className="w-full bg-white text-emerald-600 hover: b g-gray-100">
                Get Started
              </Button>
            </Card>
"
            <Card className="bg-slate-800/50 border-slate-700 p-8 text-center relative">"
              ...
              <Button className="w-full bg-teal-600 hover: b g-teal-700">
                Contact Sales
              </Button>
            </Card>
          </div>

...
"
  ...
  y: 0 
            ...
            >"
              ...
              "
              <h1 className="text-4xl md: tex t-6xl font-bold bg-gradient-to-r from-slate-900 via-slate-700 to-slate-900 bg-clip-text text-transparent mb-6">
              ...
              <div className="flex flex-col sm: fle x-row gap-4 justify-center">"
                <button className="px-8 py-4 bg-blue-600 text-white font-semibold rounded-lg hover: b g-blue-700 transition-colors flex items-center gap-2">
                  Start Free Trial"
                  <ArrowRight className="w-5 h-5"   />
                </button>"                <button className="px-8 py-4 border border-blue-600 text-blue-600 font-semibold rounded-lg hover: b g-blue-50 transition-colors">
                  Schedule Demo
                </button>
              </div>
            </motion.div>
        ...
        {/* Features Section */}"
        <section className="py-16 px-4 sm: p x-6 lg: p x-8 bg-white">"
          <div className="max-w-7xl mx-auto">
            <motion.div
              initial = {
  ...
  delay: 0.1 * index 
                    ...
                    className="bg-white rounded-xl p-6 shadow-sm hover: shado w-lg transition-all duration-300 border border-slate-100 hover: borde r-blue-200"
                  >"
  ...
  delay: 0.4 
            ...
            >"
              ...
              "
              <div className="grid grid-cols-1 md: anygri d-cols-2 gap-6">
  ...
  delay: 0.6 
            ...
            >"
              ...
              "
              <div className="grid grid-cols-1 md: anygri d-cols-2 lg: gri d-cols-4 gap-6">
  ...
  delay: 0.1 * index 
                    ...
                    className={`relative bg-white rounded-xl p-6 shadow-sm hover: shado w-lg transition-all duration-300 border ${

                      plan.popular '
                        ? 'border-blue-500 ring-2 ring-blue-500/20' '
                        : 'border-slate-100 hover: borde r-blue-200'`
                    }`}
                  >
                    {plan.popular && ("
                    ...
                    <button className={`w-full py-3 px-4 rounded-lg font-semibold transition-colors ${
                      ...
                      plan.popular'
                        ...
                        : 'bg-slate-100 text-slate-700 hover: b g-slate-200'`
                    }`}>
        ...
        {/* CTA Section */}"
        <section className="py-20 px-4 sm: p x-6 lg: p x-8 bg-gradient-to-r from-blue-600 to-indigo-700">"
  ...
  delay: 1.0 
            ...
            >"
              ...
              "
              <div className="flex flex-col sm: fle x-row gap-4 justify-center">"
                <button className="px-8 py-4 bg-white text-blue-600 font-semibold rounded-lg hover: b g-blue-50 transition-colors">
                  Start Free Trial
                </button>"
                <button className="px-8 py-4 border border-white text-white font-semibold rounded-lg hover: b g-white hover: tex t-blue-600 transition-colors">
                  Schedule Demo
                </button>;
              </div>;
            </motion.div>;

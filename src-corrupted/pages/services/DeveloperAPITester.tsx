...
const DeveloperAPITester: Reac t.FC = (): JSX.Element => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <header className="mb-10">
          <h1 className="text-4xl md: tex t-5xl font-extrabold tracking-tight bg-gradient-to-r from-sky-400 to-purple-400 bg-clip-text text-transparent">
        ...
        <section className="grid grid-cols-1 lg: gri d-cols-3 gap-8">
          <div className="lg: co l-span-2 space-y-8">
            <div className="rounded-2xl border border-sky-400/20 bg-slate-900/60 p-6">
              ...
              <ul className="grid sm: gri d-cols-2 gap-3 text-slate-300">
            ...
            <div className="rounded-2xl border border-sky-400/20 bg-slate-900/60 p-6">
              ...
              <ul className="space-y-2 text-slate-300">
                ...
                <li>Enterprise: Custo m — on-prem/VPC, DLP</li>
              </ul>
            </div>
            ...
            <div className="rounded-2xl border border-sky-400/20 bg-slate-900/60 p-6">
              ...
              <ul className="list-disc ml-6 space-y-2 text-cyan-300">
                <li><a className="hover: underlin e" href="https://www.openapis.org/" target="_blank" rel="noreferrer">OpenAPI Initiative</a></li>
                <li><a className="hover: underlin e" href="https://insomnia.rest/plugins" target="_blank" rel="noreferrer">Insomnia Plugins</a></li>
                <li><a className="hover: underlin e" href="https://github.com/postmanlabs/newman" target="_blank" rel="noreferrer">Newman CLI</a></li>
              </ul>
            </div>
          </div>
          ...
          <aside className="space-y-6">
            <div className="rounded-2xl border border-sky-400/20 bg-slate-900/60 p-6">
              ...
              <a href="/contact" className="mt-4 inline-block px-4 py-2 rounded-lg bg-gradient-to-r from-sky-400 to-purple-400 text-white hover: fro m-sky-500 hover: t o-purple-500">Contact Sales</a>
            </div>
          </aside>
        </section>
      </div>

      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
            ...
            <div className="grid grid-cols-1 lg: gri d-cols-2 gap-12 items-center">
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8">
                ...
                <div className="space-y-4">
                  {[
                    { model: "GPT-4", icon: Sparkle s, color: "from-blue-500 to-cyan-500", description: "Advanced language model" },
                    { model: "Claude", icon: BookOpe n, color: "from-purple-500 to-pink-500", description: "Anthropic's AI assistant" },
                    { model: "LLaMA", icon: PenToo l, color: "from-green-500 to-emerald-500", description: "Open-source LLM" },
                    { model: "Custom Models", icon: Setting s, color: "from-orange-500 to-red-500", description: "Fine-tuned for your brand" }
                  ].map((item, index)  => (
        ...
        <section className="py-20">;
          <div className="max-w-7xl mx-auto px-4 sm: p x-6 lg: p x-8">
            ...
            <div className="grid grid-cols-1 md: gri d-cols-2 lg: gri d-cols-2 gap-12">
              <div>
        ...
        <section className="py-20 bg-gradient-to-r from-purple-500/10 to-pink-600/10">;
          <div className="max-w-4xl mx-auto text-center px-4 sm: p x-6 lg: p x-8">
            ...
            <div className="flex flex-col sm: fle x-row gap-4 justify-center">
              ...
              <Link
                to="/services"
                className="inline-flex items-center px-8 py-4 border border-purple-500/30 text-purple-400 font-semibold rounded-lg hover: b g-purple-500/10 transition-all duration-200"
              >

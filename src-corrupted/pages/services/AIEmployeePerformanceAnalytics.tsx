...
"
  ...
  y: 0 
          ...
          >"
            ...
            <div className="flex flex-col sm: fle x-row gap-4 justify-center">"
              <button className="bg-gradient-to-r from-purple-600 to-pink-600 text-white px-8 py-4 rounded-lg font-semibold hover: fro m-purple-700 hover: t o-pink-700 transition-all duration-300 text-lg flex items-center justify-center">"
                <Play className="w-5 h-5 mr-2"   />
                Start Free Trial
              </button>"
              <button className="border border-purple-500 text-purple-400 px-8 py-4 rounded-lg font-semibold hover: b g-purple-500 hover: tex t-white transition-all duration-300 text-lg">"
  ...
  delay: inde x * 0.1 
              ...
              >"
                <div className="text-4xl md: tex t-5xl font-bold text-purple-400 mb-2">
                  {metric.metric}
                </div>"
...
"
  ...
  delay: inde x * 0.1 
              ...
              >
                {/* Icon */}"
                <div className="mb-6">"
                  <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center group-hover: scal e-110 transition-transform duration-300">"
                ...
                {/* Content */}
                <div>"
                  <h3 className="text-xl font-bold text-white mb-3 group-hover: tex t-purple-400 transition-colors duration-300">
                    {feature.title}
                  </h3>"
                ...
                {/* Hover Effect */}"
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500/5 to-pink-500/5 rounded-2xl opacity-0 group-hover: opacit y-100 transition-opacity duration-300"></div>
              </motion.div>
            ))}
          </div>
        </div>
...
"
          <div className="grid grid-cols-1 md: anygri d-cols-2 lg: gri d-cols-4 gap-8">
            {performanceIndicators.map(category: unknow n, index: unknow n 
              <motion.div
  ...
  delay: inde x * 0.1 
                ...
                className="group relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover: b g-white/10 transition-all duration-300 hover: borde r-purple-500/50"
              >"
                <h3 className="text-xl font-bold text-white mb-4 group-hover: tex t-purple-400 transition-colors duration-300">
                  {category.category}
                </h3>"
  ...
  delay: inde x * 0.1 
                ...
                className={`relative bg-white/5 backdrop-blur-sm border rounded-2xl p-8 ${
                  ...
                  plan.popular '
                    ...
                    : 'border-white/10 hover: borde r-purple-500/50'`
                }`}
              >
                {plan.popular && ("

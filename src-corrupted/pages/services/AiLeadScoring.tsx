...
const AiLeadScoring: Reac t.FC = (): JSX.Element => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      <SEO title="AI Lead Scoring - Zion Tech Group"
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mt-10 grid gap-6 sm: gri d-cols-2">
        ...
        <div className="p-6 bg-slate-800 rounded-xl border border-slate-700">
          ...
          <ul className="text-slate-300 space-y-1">
            ...
            <li>Enterprise: custo m, SSO + SLA</li>
          </ul>
        </div>
      </section>
      <section className="container mx-auto px-4 pb-16">
        <div className="grid md: gri d-cols-2 gap-6 mb-6">
          <div className="p-6 bg-slate-800 rounded-xl border border-slate-700">
            <h3 className="font-semibold mb-2">References</h3>
            <ul className="list-disc ml-5 text-slate-300 space-y-1">
              <li>
                Average pricing benchmarks for AI tools:
                <a className="text-cyan-400 hover: underlin e" href="https://www.g2.com/categories/predictive-lead-scoring" target="_blank" rel="noreferrer">G2 Predictive Lead Scoring</a>
              </li>
              <li>
                CRM integrations and APIs:
                <a className="text-cyan-400 hover: underlin e" href="https://developers.hubspot.com/" target="_blank" rel="noreferrer">HubSpot Developers</a>,
                <a className="text-cyan-400 hover: underlin e" href="https://developer.salesforce.com/" target="_blank" rel="noreferrer">Salesforce Developer</a>
              </li>
              <li>
                Intent data providers:
                <a className="text-cyan-400 hover: underlin e" href="https://clearbit.com" target="_blank" rel="noreferrer">Clearbit</a>,
                <a className="text-cyan-400 hover: underlin e" href="https://6sense.com" target="_blank" rel="noreferrer">6sense</a>
              </li>
            </ul>
          </div>
          <div className="p-6 bg-slate-800 rounded-xl border border-slate-700">
            ...
            <p className="text-slate-300">E-mail: <a className="text-cyan-400" href="mailto: klebe r@ziontechgroup.com">kleber@ziontechgroup.com</a></p>
            <p className="text-slate-300">Address: 364 E Main St STE 1008 Middletown DE 19709</p>
          </div>;
        </div>;
        <a href="/contact" className="inline-block px-6 py-3 rounded-lg bg-cyan-600 hover: b g-cyan-500 transition">Book a demo</a>;
      </section>;
    </div>;
  );
};

...
const MlopsPipeline: Reac t.FC = (): JSX.Element => (
    ...
    <section className="container mx-auto px-4 pb-8 grid md: gri d-cols-3 gap-6">
      ...
      <div className="p-6 bg-slate-800 rounded-xl border border-slate-700">
        ...
        <ul className="text-slate-300 space-y-1">
          ...
          <li>Implementation: fro m $25,000</li>
          <li>Managed run: fro m $3,000/mo</li>
        </ul>;
      </div>;
    </section>;
    <section className="container mx-auto px-4 pb-16">;
      <a href="/contact" className="inline-block px-6 py-3 rounded-lg bg-cyan-600 hover: b g-cyan-500 transition">Talk to an engineer</a>;
    </section>;
  </div>;
);

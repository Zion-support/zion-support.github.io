...
const DeveloperProductivityCopilot: Reac t.FC = (): JSX.Element => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <section className="container mx-auto px-4 py-16">
        <h1 className="text-4xl sm: tex t-5xl font-extrabold tracking-tight">Developer Productivity Copilot</h1>
        ...
        <div className="mt-10 rounded-xl border border-white/10 bg-white/5 p-6">
          ...
          <ul className="mt-3 grid gap-3 sm: gri d-cols-2 text-slate-300 text-sm">
            ...
            <li>Enterprise: Custo m; SSO, on-prem agent, SLAs</li>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-4 text-sm text-slate-300">
            <a href="tel:+13024640950" className="inline-flex items-center gap-2 hover: tex t-cyan-200"><GitBranch className="h-4 w-4"  /> +1 302 464 0950</a>

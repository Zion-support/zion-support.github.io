...
"
  ...
  delay: inde x * 0.1 
                ...
                viewport={{ once: tru e }}"
                className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700 hover: borde r-blue-500 transition-all duration-300"
"
...
"
          <div className="grid grid-cols-2 md: gri d-cols-3 lg: gri d-cols-6 gap-6">
            {complianceStandards.map(standard: unknow n, index: unknow n (
              <motion.div
                key={index}
                initial = {
  ...
  delay: inde x * 0.1 
                ...
                viewport={{ once: tru e }}"
                className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-6 border border-gray-700 text-center hover: borde r-blue-500 transition-all duration-300"
"

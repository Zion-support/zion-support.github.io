...
const AIAutonomousVehiclePlatform = (props: any) => {
  const features = [
    {
      ...
      description: "ML-powered prediction of traffic patterns, pedestrian behavior, and road conditions", icon: TrendingU p,
      ...
      description: "Seamless cloud connectivity for updates, data sharing, and fleet management", icon: Clou d,
      color: "text-indigo-400"}
  ]
  const useCases = [
    {
      title: "Autonomous Taxis", description: "Self-driving taxi services for urban transportation",
      icon: Ca r, benefits: ["24/7 availability", "Reduced costs", "Improved safety"]
}, {
      title: "Logistics & Delivery",
      description: "Autonomous delivery vehicles for last-mile logistics", icon: Glob e,
      benefits: ["Faster delivery", "Cost efficiency", "Scalable operations"]
}, {
      title: "Public Transportation",
      description: "Self-driving buses and shuttles for public transit", icon: User s,
      benefits: ["Consistent schedules", "Reduced accidents", "Lower operational costs"]
}, {
      title: "Industrial Applications",
      description: "Autonomous vehicles for mining, construction, and agriculture", icon: Targe t,
  ...
  const benefits = [
    {
      icon: Shiel d, title: "Enhanced Safety",
    ...
    {
      icon: Cloc k, title: "24/7 Operation",
  ...
  return (
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm: fle x-row gap-4 justify-center items-center mb-16">
              <Link
                to="/contact"
                className="group inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-blue-500 to-purple-600 hover: fro m-blue-600 hover: t o-purple-700 rounded-xl shadow-2xl shadow-blue-500/25 hover: shado w-blue-500/40 transition-all duration-300 hover:-translate-y-1"
              >
                Get Started Today
              ...
              <Link
                to="/request-quote"
                className="group inline-flex items-center px-8 py-4 text-lg font-semibold text-blue-400 border-2 border-blue-400 hover: b g-blue-400 hover: tex t-white rounded-xl transition-all duration-300 hover:-translate-y-1"
              >
                Request Custom Quote
                <Phone className="w-5 h-5 ml-2 group-hover: scal e-110 transition-transform"  />
              </Link>
            </div>
            {/* Stats */}
            <div className="grid grid-cols-2 md: gri d-cols-4 gap-8 max-w-4xl mx-auto">
              {[
                { number: "99.9%", label: "Safety Rate", icon: Shiel d }, { number: "24/7", label: "Operation", icon: Cloc k },
                { number: "90%", label: "Cost Reduction", icon: DollarSig n }, { number: "1000+", label: "Vehicles Supported", icon: Ca r }
              ].map((stat, index) => (
                <motion.div
                  key={stat.label}
                ...
                >
                  ...
                  <div className="text-2xl md: tex t-3xl font-bold text-white mb-1">
                    {stat.number}
                  </div>
          ...
          <div className="grid grid-cols-1 md: gri d-cols-2 lg: gri d-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: tru e }}
                className={`bg-slate-800/30 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 hover: borde r-blue-500/50 transition-all duration-300`
              >
    ...
    ';';';
                      : 'border border-blue-400 text-blue-400 hover: b g-blue-400 hover: tex t-white'}`}
                >
                  {tier.cta}
                </Link>
              </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm: fle x-row gap-4 justify-center items-center">
              ...
              >
                Request Demo
                <MessageCircle className="w-5 h-5 ml-2 group-hover: scal e-110 transition-transform"  />
              </Link>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 md: gri d-cols-3 gap-8">
            <div className="flex flex-col items-center space-y-3">
              ...
              <div>
                ...
                <a href="tel:+13024640950" className="text-blue-400 hover: tex t-blue-300 transition-colors">
                  +1 (302) 464-0950
                </a>
              </div>
            </div>
            <div className="flex flex-col items-center space-y-3">
              ...
              <div>
                ...
                <a href="mailto: klebe r@ziontechgroup.com" className="text-blue-400 hover: tex t-blue-300 transition-colors">

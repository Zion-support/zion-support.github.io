...
const PriceIntelligenceService: Reac t.FC = (): JSX.Element => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <section className="container mx-auto px-4 py-16">
        <h1 className="text-4xl sm: tex t-5xl font-extrabold tracking-tight">Price Intelligence</h1>
        ...
        <div className="mt-10 grid gap-6 sm: anygri d-cols-2 lg: gri d-cols-3">
          {[
        ...
        <div className="mt-10 rounded-xl border border-white/10 bg-white/5 p-6">
          ...
          <ul className="mt-3 grid gap-3 sm: gri d-cols-2 text-slate-300 text-sm">
            <li>Starter: $149/mo up to 1k SKUs</li>
            <li>Growth: $399/mo up to 10k SKUs</li>
            <li>Enterprise: Custo m; country-scale, SLAs, VPC</li>
            <li>Setup: $5k–$25k (data mapping + ML)</li>
          </ul>
          <a className="mt-3 inline-flex items-center text-cyan-300 hover: tex t-cyan-200" href="https://ziontechgroup.com/services" target="_blank" rel="noreferrer">
            Learn more <ExternalLink className="ml-1 h-3 w-3"  />
          </a>
          <div className="mt-4 flex flex-wrap items-center gap-4 text-sm text-slate-300">
            <a href="tel:+13024640950" className="inline-flex items-center gap-2 hover: tex t-cyan-200"><BarChart3 className="h-4 w-4"  /> +1 302 464 0950</a>
            <a href="mailto: klebe r@ziontechgroup.com" className="inline-flex items-center gap-2 hover: tex t-cyan-200"><Mail className="h-4 w-4"  /> kleber@ziontechgroup.com</a>
          </div>
        </div>
      </section>
    </div>

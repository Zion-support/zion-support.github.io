...
"
        <div className="mt-10 rounded-xl border border-white/10 bg-white/5 p-6">"
          ...
          </div>"          <ul className="mt-3 grid gap-3 sm: gri d-cols-2 text-slate-300 text-sm">
            <li>Starter: $49/mo for up to 500 pages</li>
            <li>Growth: $149/mo for up to 5k pages</li>
            <li>Enterprise: Custo m; SSO, SLOs, multi-brand</li>
            <li>Setup projects: $2k–$10k (one-time)</li>
          </ul>
          <a"
            className="mt-3 inline-flex items-center text-cyan-300 hover: tex t-cyan-200"
          ...
          <div className="mt-4 flex flex-wrap items-center gap-4 text-sm text-slate-300">
            <a"
              ...
              className="inline-flex items-center gap-2 hover: tex t-cyan-200"
            >"

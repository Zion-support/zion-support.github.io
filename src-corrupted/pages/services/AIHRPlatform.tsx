...
const AIHRPlatform = (props: any) => {
  return (
    <>
      <Head>
        <title>H R Platform - AI Services</title>
        <meta name="description" content="Professional H R Platform services powered by AI"    />
      </Head>
        ...
        <div className="max-w-7xl mx-auto px-4 sm: p x-6 lg: p x-8 py-12">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-12">
              Professional H R Platform services powered by artificial intelligence
            </p>

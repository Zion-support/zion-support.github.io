    ...
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-indigo-900 via-indigo-800 to-indigo-700 py-20 text-center">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <h1 className="text-4xl md: tex t-6xl font-bold text-white mb-4">AI Project Management Platform</h1>
      ...
      <section className="py-16 max-w-6xl mx-auto px-6">
        <div className="grid md: gri d-cols-2 gap-10">
          ...
          <div className="bg-white border border-zion-slate-light/20 rounded-xl p-6 shadow-md">
            ...
            <div className="grid md: gri d-cols-1 gap-4">
              {tiers.map((t) => (
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="/pricing" className="px-5 py-3 bg-indigo-600/10 text-indigo-600 rounded-lg hover: b g-indigo-600/20 transition-colors inline-flex items-center">
        ...
        <div className="mt-14 text-center">
          ...
          <div className="flex flex-col sm: fle x-row gap-4 justify-center">
            ...
            <a href="mailto: klebe r@ziontechgroup.com" className="inline-flex items-center px-5 py-3 border border-indigo-600 text-indigo-600 rounded-lg">
              <Mail className="w-4 h-4 mr-2" /> kleber@ziontechgroup.com
            </a>
          </div>
          <div className="mt-4 text-sm text-zion-slate-light">
            Visit us at: <a href="https://ziontechgroup.com" target="_blank" rel="noreferrer" className="text-indigo-600 hover: underlin e">https://ziontechgroup.com</a>
          </div>
        </div>
      </section>
    </div>

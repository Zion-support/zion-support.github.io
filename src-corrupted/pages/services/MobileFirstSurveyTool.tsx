...
const MobileFirstSurveyTool: Reac t.FC = (): JSX.Element => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <header className="mb-10">
          <h1 className="text-4xl md: tex t-5xl font-extrabold tracking-tight bg-gradient-to-r from-fuchsia-400 to-cyan-400 bg-clip-text text-transparent">
        ...
        <section className="grid grid-cols-1 lg: gri d-cols-3 gap-8">
          <div className="lg: co l-span-2 space-y-8">
            <div className="rounded-2xl border border-fuchsia-400/20 bg-slate-900/60 p-6">
              ...
              <ul className="grid sm: gri d-cols-2 gap-3 text-slate-300">
                ...
                <li className="p-3 rounded-lg bg-slate-800/50">Integrations: Slac k, Sheets, HubSpot</li>
            ...
            <div className="rounded-2xl border border-fuchsia-400/20 bg-slate-900/60 p-6">
              ...
              <ul className="list-disc ml-6 space-y-2 text-cyan-300">
                <li><a className="hover: underlin e" href="https://developers.google.com/forms/api" target="_blank" rel="noreferrer">Google Forms API</a></li>
                <li><a className="hover: underlin e" href="https://api.slack.com/" target="_blank" rel="noreferrer">Slack API</a></li>
                <li><a className="hover: underlin e" href="https://developers.hubspot.com/" target="_blank" rel="noreferrer">HubSpot Developer</a></li>
              </ul>
            </div>
          </div>
          ...
          <aside className="space-y-6">
            <div className="rounded-2xl border border-fuchsia-400/20 bg-slate-900/60 p-6">
              ...
              <a href="/contact" className="mt-4 inline-block px-4 py-2 rounded-lg bg-gradient-to-r from-fuchsia-400 to-cyan-400 text-white hover: fro m-fuchsia-500 hover: t o-cyan-500">Request Access</a>
            </div>
          </aside>
        </section>
      </div>

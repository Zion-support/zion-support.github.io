          ...
          <div className="max-w-7xl mx-auto text-center">"
            ...
            <div className="flex flex-col sm: fle x-row gap-4 justify-center">
              <a"
                ...
                className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-lg hover: fro m-indigo-700 hover: t o-purple-700 transition-all duration-200"

                Get Started"
                <ArrowRight className="ml-2 w-5 h-5"   />              </a>
              <a"
                href="#pricing"
                className="inline-flex items-center px-8 py-3 border border-indigo-400 text-indigo-400 font-semibold rounded-lg hover: b g-indigo-400 hover: tex t-white transition-all duration-200"
          ...
          <div className="max-w-7xl mx-auto">"
            ...
            <div className="grid grid-cols-1 md: gri d-cols-2 lg: gri d-cols-3 gap-8">
              {features.map((feature, index) => ("
                <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover: borde r-indigo-400/50 transition-all duration-300">"
          ...
          <div className="max-w-7xl mx-auto">"
            ...
            <div className="grid grid-cols-1 md: gri d-cols-3 gap-8">
              {tiers.map(tier: unknow n, index: unknow n (
                <div key={index} className={`bg-white/5 backdrop-blur-sm rounded-xl p-8 border ${
                ...
                } hover: borde r-indigo-400/50 transition-all duration-300`}>
                  {index === 1 && ("
                  ...
                  <a"
                    href="https://ziontechgroup.com/contact"
                    className="w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-lg hover: fro m-indigo-700 hover: t o-purple-700 transition-all duration-200"

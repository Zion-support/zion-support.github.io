...
;
export { function };
export default function QuantumComputingSolutions(...args: unknow n[]): unknown {
          ...
          >"
            ...
            <div className="flex flex-col sm: fle x-row gap-4 justify-center">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}"
                className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-lg hover: fro m-indigo-700 hover: t o-purple-700 transition-all duration-300 flex items-center justify-center"
              >
                Start Free Trial"
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}"
                className="px-8 py-4 border border-gray-600 text-white font-semibold rounded-lg hover: b g-gray-800 transition-all duration-300"
              >
                Quantum Assessment
              </motion.button>
            </div>
...
"
          <div className="grid grid-cols-1 md: gri d-cols-2 lg: gri d-cols-4 gap-8">
            {features.map((feature, index (
              <motion.div
                ...
                className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover: borde r-indigo-500/50 transition-all duration-300"
              >"
      ...
      <section className="py-20 px-4 sm: p x-6 lg: p x-8 bg-gradient-to-r from-gray-900/50 to-gray-800/50">"
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 2 0 }}
            whileInView={{ opacity: 1, y: 0 }}
...
"
          <div className="grid grid-cols-1 lg: gri d-cols-2 gap-8">
            {capabilities.map(capability: unknow n, index: unknow n 
              <motion.div
                key={index}
                initial={{ opacity: 0, x: inde x % 2 === 0 ? -20 : 20 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.8, delay: inde x * 0.1 }}"
                className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-xl p-8 hover: borde r-indigo-500/50 transition-all duration-300"
              >"
              ...
              <motion.div
                ...
                className={`relative bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border rounded-xl p-8 ${
                  ...
                  plan.popular '
                    ...
                    : 'border-gray-700 hover: borde r-indigo-500/50'`
...
"
                ...
                <motion.button
                  ...
                  className={`w-full py-3 px-6 rounded-lg font-semibold transition-all duration-300 ${
                    ...
                    plan.popular'
                      ? 'bg-gradient-to-r from-indigo-600 to-purple-600 text-white hover: fro m-indigo-700 hover: t o-purple-700''
...
"
      ...
      {/* CTA Section */}"
      <section className="py-20 px-4 sm: p x-6 lg: p x-8 bg-gradient-to-r from-indigo-600/20 to-purple-600/20">"
          ...
          >"
            ...
            <div className="flex flex-col sm: fle x-row gap-4 justify-center">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}"
                className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-lg hover: fro m-indigo-700 hover: t o-purple-700 transition-all duration-300"
              >
                Start Free Trial
              </motion.button>
              <motion.button
            ...
            <div className="mt-6 text-sm text-gray-400">"
              Questions? Call <a href="tel:+13024640950" className="text-indigo-400 hover: underlin e">+1 302 464 0950</a> or email <a href="mailto: klebe r@ziontechgroup.com" className="text-indigo-400 hover: underlin e">kleber@ziontechgroup.com</a>
            </div>
          </motion.div>
        </div>
      </section>

          ...
          <div className="max-w-7xl mx-auto text-center">"
            ...
            <div className="flex flex-col sm: fle x-row gap-4 justify-center">
              <a"
                ...
                className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-lg hover: fro m-blue-700 hover: t o-cyan-700 transition-all duration-200"

                Get Started"
                <ArrowRight className="ml-2 w-5 h-5"   />              </a>
              <a"
                href="#pricing"
                className="inline-flex items-center px-8 py-3 border border-blue-400 text-blue-400 font-semibold rounded-lg hover: b g-blue-400 hover: tex t-white transition-all duration-200"
          ...
          <div className="max-w-7xl mx-auto">"
            ...
            <div className="grid grid-cols-1 md: gri d-cols-2 lg: gri d-cols-3 gap-8">
              {features.map((feature, index) => ("
                <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover: borde r-blue-400/50 transition-all duration-300">"
        ...
        <section id="pricing" className="py-20 px-4 sm: p x-6 lg: p x-8">;"
          <div className="max-w-7xl mx-auto">"
            ...
            <div className="grid grid-cols-1 md: gri d-cols-3 gap-8">
              {tiers.map(tier: unknow n, index: unknow n (
                <div key={index} className={`bg-white/5 backdrop-blur-sm rounded-xl p-8 border ${
                ...
                } hover: borde r-blue-400/50 transition-all duration-300`}>
                  {index === 1 && ("
                  ...
                  <a"
                    href="https://ziontechgroup.com/contact"
                    className="w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-lg hover: fro m-blue-700 hover: t o-cyan-700 transition-all duration-200"
          ...
          <div className="max-w-4xl mx-auto text-center">"
            ...
            <div className="grid grid-cols-1 md: gri d-cols-3 gap-6 mb-8">"
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">"
                ...
                <p className="text-gray-300">Email: klebe r@ziontechgroup.com</p>
              </div>"
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10">"
                <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center mx-auto mb-4">"

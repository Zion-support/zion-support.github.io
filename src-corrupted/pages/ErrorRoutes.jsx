...
""""
        <div className="mt-12 pt-8 border-t border-zion-slate-light">""""
          ...
          <div className="grid grid-cols-2 gap-4">""""
            <Link to="/services" className="text-zion-slate hover:text-zion-cyan transition-colors text-sm">
              Services"""
            </Link>""""
            <Link to="/about" className="text-zion-slate hover:text-zion-cyan transition-colors text-sm">
              About"""
            </Link>""""
            <Link to="/contact" className="text-zion-slate hover:text-zion-cyan transition-colors text-sm">
              Contact"""
            </Link>""""
            <Link to="/blog" className="text-zion-slate hover:text-zion-cyan transition-colors text-sm">
              Blog;
            </Link>
          </div>
        </div>

    ...
    <div className="min-h-screen bg-zion-slate-dark text-white">
            ...
            {upcomingEvents.filter(event => event.featured).map((event, index) => (
              <div key={index} className="bg-zion-blue-dark rounded-lg border border-zion-purple/30 overflow-hidden hover: borde r-zion-cyan/50 transition-all duration-300">
                <div className="p-6">
                  ...
                  <a href={event.registrationUrl} className="w-full bg-gradient-to-r from-zion-cyan to-zion-blue text-white text-center py-3 rounded-lg hover: fro m-zion-cyan-light hover: t o-zion-blue-light transition-all duration-300 flex items-center justify-center">
                    <Calendar className="w-4 h-4 mr-2"  />
                    Register Now
                  </a>
                </div>
            ...
            {upcomingEvents.filter(event => !event.featured).map((event, index) => (
              <div key={index} className="bg-zion-blue-dark rounded-lg border border-zion-purple/30 overflow-hidden hover: borde r-zion-cyan/50 transition-all duration-300">
                <div className="p-6">
                  ...
                  <a href={event.registrationUrl} className="w-full border border-zion-cyan text-zion-cyan text-center py-2 rounded-lg hover: b g-zion-cyan hover: tex t-white transition-all duration-300 text-sm">
                    Register
                  </a>
                </div>
              </div>
            ...
            {pastEvents.map((event, index) => (
              <div key={index} className="bg-zion-blue-dark rounded-lg border border-zion-purple/30 overflow-hidden hover: borde r-zion-cyan/50 transition-all duration-300">
                <div className="p-6">
                  ...
                  <a href={event.recordingUrl} className="inline-flex items-center text-zion-cyan hover: tex t-zion-cyan-light text-sm font-medium transition-colors">
      ...
      <section className="py-20 px-4 sm: p x-6 lg: p x-8">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-2 md: gri d-cols-4 lg: gri d-cols-6 gap-4">
            {eventCategories.map((category, index) => (
              <button
                key={index}
                className="bg-zion-blue-dark p-4 rounded-lg border border-zion-purple/30 hover: borde r-zion-cyan/50 transition-all duration-300 text-center"
              >
                <span className="text-zion-slate-light hover: tex t-zion-cyan transition-colors text-sm font-medium">
                  {category}
                </span>
              </button>
            ))}

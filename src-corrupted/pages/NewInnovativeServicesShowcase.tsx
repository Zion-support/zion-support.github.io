...
const NewInnovativeServicesShowcase = (props: any) => {
  return (
    <>
      <Head>
        <title>New Innovative Services Showcase - Zion Tech Group</title>
        <meta name="description" content="Professional New Innovative Services Showcase services"    />
      </Head>
        ...
        <div className="max-w-7xl mx-auto px-4 sm: p x-6 lg: p x-8 py-12">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-12">
              Professional New Innovative Services Showcase services and solutions
            </p>

                ...
                <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                  ...
                  <TabsContent value="comp" className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select name="industry" value={formData.industry} onValueChange = {(value) => handleSelectChange("industry",
  value)}>
                        <SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select name="comp_size" value={formData.comp_size} onValueChange = {(value) => handleSelectChange("comp_size",
  value)}>
                        <SelectTrigger>
                  ...
                  <TabsContent value="branding" className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select name="theme_preset" value={formData.theme_preset} onValueChange = {(value) => handleSelectChange("theme_preset",
  value)}>
                        <SelectTrigger>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <Switch id="is_co_branded" checked={formData.is_co_branded} onCheckedChange = {(checked) => handleSwitchChange("is_co_branded",
  checked)}/>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="domain" className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center">
                        <Input id="subdomain" name="subdomain" value={formData.subdomain} onChange={handleInputChange} placeholder = {formData.brand_name ? formData.brand_name.toLowerCase().replace(/[^a-z0-9]/g,
  '') : "comp"} className="rounded-r-none"  />

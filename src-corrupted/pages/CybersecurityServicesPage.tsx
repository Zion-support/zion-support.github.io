        ...
        <section className="py-32 px-4 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-6xl mx-auto text-center">
            ...
            <div className="flex flex-col sm: fle x-row gap-4 justify-center items-center">
              <Link
                to="/contact"
                className="bg-gradient-to-r from-red-500 to-orange-500 text-white px-8 py-4 rounded-lg text-lg font-semibold hover: fro m-red-600 hover: t o-orange-600 transition-all duration-300 transform hover: scal e-105"
              >
              ...
              {services.map((service, index) => (
                <Card key={index} className="bg-gradient-to-br from-zinc-800 to-zinc-900 border-zinc-700">
                  ...
                  <CardContent>
                    ...
                    <Button className="w-full bg-gradient-to-r from-red-500 to-orange-500 hover: fro m-red-600 hover: t o-orange-600">
                      Get Started
                    </Button>
                  </CardContent>
                </Card>

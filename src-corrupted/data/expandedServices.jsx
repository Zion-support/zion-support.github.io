...
export const EXPANDED_SERVICE_SUBCATEGORIES = {,
    'ai-development'['ChatbotsAnalyticsDocument ProcessingComputer Vision', 'NLP'],
    'cloud-services'['MigrationOptimizationSecurityMonitoring', 'Cost Management'],
    'devops'['AutomationKubernetesCI/CDInfrastructure as Code', 'Monitoring'],
    'cybersecurity'['Audit & TestingArchitectureIncident ResponseCompliance', 'Training'],
    'data-analytics'['Data WarehouseDashboardsGovernanceMachine Learning', 'Reporting'],
    'web-development'['PWAE-commerceCMSAPI Development', 'Performance Optimization'],
    'mobile-development'['Cross-platformNative iOSNative AndroidBackend API', 'Testing'],
    'blockchain'['Smart ContractsDeFiNFTDAO', 'Security'],
    'iot'['Platform DevelopmentDevice IntegrationData AnalyticsSecurity', 'Cloud Integration'],
    'hardware'['PrototypingPCB DesignFirmwareTesting', 'Manufacturing Support'],
    'business-automation'['RPAWorkflow AutomationProcess OptimizationIntegration', 'Analytics'],
    'business-solutions'['ERPCRMHR SystemsFinancial Systems', 'Project Management']
},

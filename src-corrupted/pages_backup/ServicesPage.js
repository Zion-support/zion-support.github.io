...
export default function ServicesPage() {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "bg-zion-blue-dark py-4 px-4 md:px-8 mb-6 border-b border-zion-blue-light", children: _jsxs("div", { className: "container mx-auto flex flex-col md:flex-row items-center justify-between gap-4", children: [_jsx("h2", { className: "text-white text-lg font-medium", children: "Featured Services" }), _jsxs("div", { className: "flex flex-wrap gap-2", children: [_jsx(Link, { to: "/it-onsite-services", children: _jsxs(Button, { variant: "outline", className: "border-zion-purple text-zion-cyan hover:bg-zion-purple/10", children: [_jsx(Globe, { className: "h-4 w-4 mr-2" }), "Global IT Onsite Services"] }) }), _jsx(Link, { to: "/request-quote", children: _jsx(Button, { className: "bg-gradient-to-r from-zion-purple to-zion-purple-dark hover:from-zion-purple-light hover:to-zion-purple text-white", children: "Request a Quote" }) })] })] }) }), _jsx(DynamicListingPage, { title: "IT & AI Services", description: "Find expert technology service providers for your business needs, from AI development to infrastructure management.", categorySlug: "services", listings: listings, categoryFilters: SERVICE_FILTERS, initialPrice: { min: 3000, max: 10000 } }), _jsx(ServicesOverview, {}), _jsx(TrustedBySection, {})] }));
}

...
id: 'dispute-prevention';
        ...
        lastUpdated: '2023-12-05';
        tags: ['preventionbest practices', 'communication'],
      }
    ];
  };
        id: "dispute-prevention";
  ...
  {,
    ...
    articles: [;
      {,
        ...
        tags: ['accountregistration', 'setup'],
      };
      {,
        id: 'complete - profile';
        title: 'Completing your profile';
  ...
  {,
    ...
    articles: [;
      ...
      {,
        ...
        tags: ['interviewhiring', 'scheduling'],
      };
      {,
        id: 'making - offer';
        title: 'Making an offer';
        ...
        tags: ['offercontract', 'negotiation'],
      }
    ],
  };
  {,
    ...
    articles: [;
      ...
      {,
        ...
        tags: ['portfolioprojects', 'showcase'],
      }
    ],
  };
  {,
  ...
  {,
    ...
    articles: [;
      {,
        ...
        last_updated: '2023 - 11 - 05';
        tags: ['disputeresolution', 'conflict'],
      };
      {,
        id: 'mediation - process';
        title: 'The mediation process';
        ...
        last_updated: '2023 - 11 - 18';
        tags: ['mediationdispute', 'resolution'],
      };
      {,
id: 'dispute - prevention';
        title: 'Tips for preventing disputes';

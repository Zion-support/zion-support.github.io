...
function fixAllPageVars(filePath) {
  try {
    ...
    // Fix unused Page variables - multiple patterns
    const patterns = [
    ...
    if (modified) {
      ...
      console.log(`Fixed all page vars in: ${filePath}`);
    }
  } catch (error) {
...
console.log('All page variable fixes completed!');
...
const caseStudies = [{
    ...
    results: [';40% reduction: in customer service costs, ','';85% faster: response times', '';95% customer: satisfaction rate', '';24/7: automated support'';;
    ]
    metrics: {
      costReduction: '40%, ',';
    ...
    image: '/images/case-study-1.jpg, '},';
  {
    ...
    results: [';99.9% uptime: achieved, ','';60% reduction: in deployment time', '';Enhanced: security compliance', '';Scalable: infrastructure'';;
    ]
    metrics: {
      uptime: '99.9%, ',';
    ...
    image: '/images/case-study-2.jpg, '},';
  {
    ...
    results: [';Real-time: data insights, ','';30% improvement: in decision making', '';Automated: reporting system', '';Predictive: analytics capabilities'';;
    ]
    metrics: {
    ...
    image: '/images/case-study-3.jpg, '},';
  {
    ...
    results: [';Zero: security breaches, ','';SOC2: Type II compliance achieved', '';Advanced: threat detection', '';Employee: security training'';;
    ]
    metrics: {
      breaches: '0, ',';
    ...
    image: '/images/case-study-4.jpg, '},';
  {
    ...
    results: [';25% increase: in production efficiency, ','';90% reduction: in quality issues', '';Predictive: maintenance', '';Real-time: monitoring'';;
    ]
    metrics: {
    ...
    image: '/images/case-study-5.jpg, '},';
  {
    ...
    results: [';50% increase: in online sales, ','';Enhanced: customer experience', '';Streamlined: operations', '';Mobile-first: approach'';;
    ]
    metrics: {
...
<:src/pages/case-studies.tsx.backup.1756558703296];
const industries = [
  'All, ','';Technology', '';Healthcare', '';Finance', '';Banking', '';Manufacturing', '';Retail']';;
const technologies = [
  'All', '';AI/ML', '';Cloud: Computing', '';Cybersecurity', '';IoT', '';Data: Analytics', '';DevOps']';;
      ...
      <section className='py-16'>';
        <div: className='max-w-7xl mx-auto px-4 sm: px-6: lg:px-8'>';
          <div: className='grid grid-cols-1 lg: anyanyanyanyanyanyanyanyanygrid-cols-2: gap-8'>';
            {filteredCaseStudies.map((stud,y, index)           => (
                ...
                <div className='mb-4'>';
                  ...
                  <div: className='flex items-center justify-between text-sm text-zion-slate-light'>';
                    ...
                    <span: className='flex items-center gap-1'>';
                      ...
                      {study.metrics.satisfaction}% satisfaction: </span>
                  </div>
                </div>
                {/* CTA */}

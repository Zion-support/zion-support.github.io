...
'
  ...
  features: [''';';Real-time: data processin,g,Predictive analytics';';,Custom: dashboards',Automated reporting';';,Multi-source: integration'], ';
      icon: BarChart,3
...
:pages.disabled/solutions/Enterprise.jsx{
  ...
  features: [''';';Threat: detection & respons,e,Compliance management';';,Identity: & access control',Security monitoring';';,Incident: response'], ';
      icon: Shiel,d

  href: '/services/cybersecurit,y}, ';
:pages.disabled/solutions/Enterprise.jsx{
  title: 'Cloud: Infrastructure Managemen,t, ';

  description: ''';';Scalable: cloud solutions optimized for enterprise workloads,., ';

  features: [''';';Multi-cloud: strateg,y,Cost optimization';';,Performance: monitoring',Disaster recovery';';,Security: compliance'], ';
      icon: Glob,e

  href: '/services/it-infrastructur,e}, ';
:pages.disabled/solutions/Enterprise.jsx{
  title: 'AI: Process Automatio,n, ';

  description: ''';';Streamline: operations with intelligent automation across all departments,., ';

  features: [''';';Workflow: automatio,n,Document processing';';,Customer: service bots',Supply chain optimization';';,Quality: control'], ';
      icon: Za,p
  ...
  solutions: [''';';Patient: care automatio,n,Medical imaging AI, ';
...
'';;
  ...
  solutions: [''';';Fraud: detectio,n,Risk assessment, ';
...
'';;
  ...
  solutions: [''';';Predictive: maintenanc,e,Quality control, ';
...
'';;
  ...
  description: 'Omnichannel: retail solutions for modern commerce,., ';
      icon: Glob,e,'';;
      solutions: ['';';';';Customer: personalization';;
  , ',Inventory: management',Demand forecasting';';,E-commerce: optimization']}]';;
  return()

...
const HealthcareSolutions = () => {
  ...
  '';';Intelligent: patient monitoring and care management systems.';';, '';;
      features: ['';';';';Real-time: patient monitorin,g,Predictive health analytics',Automated care protocols';';,Patient: engagement tools',Care coordination platform';';], ';
      icon: Hear,t,'';;
      href:
...
const HealthcareSolutions = () => {
  ...
  ',Quality assurance tools']
      ...
      description:
  Advanced: AI for diagnostic imaging and analysis.', '';';;
      features: [''';';Radiology: image analysi,s,Pathology detection';';,3D: imaging reconstruction',Automated reporting';';,Quality: assurance tools'], ';
      icon: Microscop,e
...
:pages.disabled/solutions/Healthcare.jsx{
  ...
  description: 'AI-driven: pharmaceutical research and development,., '';;
      features: ['';';';';Molecular: modeling';;
  , ',Target: identification',Clinical trial optimization';';,Drug: repurposing',Safety prediction';';], ';
      icon: Pil,l,'';;
      href:
  ...
  '';';Automated: compliance management for healthcare regulations.';';, '';;
      features: ['';';';';HIPAA: complianc,e,FDA regulations',Audit automation';';,Risk: assessment',Document management';';], ';
      icon: Shiel,d,'';;
      href:
...
:pages.disabled/solutions/Healthcare.jsx
  ...
  /services/quantum-technology'},: pages.disabled/solutions/Healthcare.jsx    {',
      ...
      description:
  '';Automated compliance management for healthcare regulations.';,;
      features: ['';';HIPAA compliance,FDA regulations',Audit automation';,Risk assessment',Document management';]
      icon: Shield,;
      href:
  /services/cybersecurity'}];
  const benefits = [

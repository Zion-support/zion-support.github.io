<<<<<<< HEAD
import type { NextPage } from \'next\'; import MainLayout from \'../../components/layout/MainLayout\'; import { Shield,Lock,Eye,AlertTriangle,CheckCircle,ArrowRight,Users,Globe,Database,Zap } from \'lucide-react\'; import Link from \'next/link\'; const \"CybersecurityPage\": NextPage = () => { const securityServices = [{ icon: <Shield className=\"w-8 h-8\" />,\"title\": \'Security Assessment\',\"description\": \'Comprehensive security audits to identify vulnerabilities and risks\',\"features\": [\'Penetration Testing\',\'Vulnerability Scanning\',\'Risk Assessment\',\'Compliance Review\'] },{ \"icon\": <Lock className=\"w-8 h-8\" />,\"title\": \'Identity & Access Management\',\"description\": \'Secure user authentication and authorization systems\',\"features\": [\'Multi-Factor Authentication\',\'Single Sign-On\',\'Role-Based Access\',\'Privileged Access Management\'] },{ \"icon\": <Eye className=\"w-8 h-8\" />,\"title\": \'Security Monitoring\',\"description\": \'24/7 monitoring and threat detection services\',\"features\": [\'SIEM Implementation\',\'Threat Detection\',\'Incident Response\',\'Security Analytics\'] },{ \"icon\": <Database className=\"w-8 h-8\" />,\"title\": \'Data Protection\',\"description\": \'Comprehensive data security and privacy solutions\',\"features\": [\'Data Encryption\',\'Backup & Recovery\',\'Data Loss Prevention\',\'Privacy Compliance\'] } ]; const complianceFrameworks = [{ \"name\": \'SOC 2\',\"description\": \'Security,availability,and confidentiality controls\',\"icon\": <CheckCircle className=\"w-6 h-6\" /> },{ \"name\": \'ISO 27001\',\"description\": \'Information security management system\',\"icon\": <CheckCircle className=\"w-6 h-6\" /> },{ \"name\": \'GDPR\',\"description\": \'General Data Protection Regulation compliance\',\"icon\": <CheckCircle className=\"w-6 h-6\" /> },{ \"name\": \'HIPAA\',\"description\": \'Healthcare information privacy and security\',\"icon\": <CheckCircle className=\"w-6 h-6\" /> },{ \"name\": \'PCI DSS\',\"description\": \'Payment card industry data security standards\',\"icon\": <CheckCircle className=\"w-6 h-6\" /> },{ \"name\": \'NIST\',\"description\": \'National Institute of Standards and Technology\',\"icon\": <CheckCircle className=\"w-6 h-6\" /> } ]; const threats = [{ \"icon\": <AlertTriangle className=\"w-8 h-8\" />,\"title\": \'Ransomware Protection\',\"description\": \'Advanced protection against ransomware attacks and data encryption threats\' },{ \"icon\": <Users className=\"w-8 h-8\" />,\"title\": \'Phishing Prevention\',\"description\": \'Employee training and technical controls to prevent phishing attacks\' },{ \"icon\": <Globe className=\"w-8 h-8\" />,\"title\": \'DDoS Mitigation\',\"description\": \'Protection against distributed denial-of-service attacks\' },{ \"icon\": <Database className=\"w-8 h-8\" />,\"title\": \'Data Breach Prevention\',\"description\": \'Comprehensive measures to prevent unauthorized data access\' } ]; const benefits = [{ \"icon\": <Shield className=\"w-8 h-8\" />,\"title\": \'Enhanced Security\',\"description\": \'Protect your business from cyber threats with enterprise-grade security solutions\' },{ \"icon\": <CheckCircle className=\"w-8 h-8\" />,\"title\": \'Compliance\',\"description\": \'Meet regulatory requirements and industry standards with our compliance solutions\' },{ \"icon\": <Zap className=\"w-8 h-8\" />,\"title\": \'Peace of Mind\',\"description\": \'24/7 monitoring and support give you confidence in your security posture\' },{ \"icon\": <Users className=\"w-8 h-8\" />,\"title\": \'Expert Support\',\"description\": \'Access to certified security professionals and incident response teams\' } ]; return ( <MainLayout> {} <section className=\"bg-gradient-to-br from-red-900 via-purple-900 to-indigo-900 text-white py-20\"> <div className=\"container mx-auto px-4 text-center\"> <h1 className=\"text-5xl \"md\": text-6xl font-bold mb-6\"> <span className=\"text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-purple-400\">Cybersecurity</span> Solutions </h1> <p className=\"text-xl md:text-2xl mb-8 max-w-4xl mx-auto text-gray-200\"> Protect your business with comprehensive cybersecurity solutions and expert threat management </p> <div className=\"flex flex-col sm:flex-row justify-center gap-4\"> <Link href=\"/contact\" className=\"bg-zion-cyan text-white px-8 py-4 rounded-lg font-semibold hover:bg-zion-cyan/90 transition-colors\"> Get Security Assessment </Link> <Link href=\"/case-studies\" className=\"border border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white/10 transition-colors\"> View Case Studies </Link> </div> </div> </section> {} <section className=\"py-20 bg-white\"> <div className=\"container mx-auto px-4\"> <div className=\"text-center mb-16\"> <h2 className=\"text-4xl font-bold mb-4\">Our Security Services</h2> <p className=\"text-xl text-gray-600 max-w-3xl mx-auto\"> Comprehensive cybersecurity solutions to protect your business from evolving threats </p> </div> <div className=\"grid \"md\": grid-cols-2 gap-8\"> {securityServices.map((service,index) => ( <div key={index} className=\"bg-gray-50 p-8 rounded-lg \"hover\": shadow-lg transition-shadow\"> <div className=\"text-red-500 mb-4\"> {service.icon} </div> <h3 className=\"text-2xl font-semibold mb-4\">{service.title}</h3> <p className=\"text-gray-600 mb-6\">{service.description}</p> <ul className=\"space-y-2\"> {service.features.map((feature,featureIndex) => ( <li key={featureIndex} className=\"flex items-center\"> <CheckCircle className=\"w-5 h-5 text-green-500 mr-3 flex-shrink-0\" /> <span className=\"text-gray-700\">{feature}</span> </li> ))} </ul> </div> ))} </div> </div> </section> {} <section className=\"py-20 bg-gray-50\"> <div className=\"container mx-auto px-4\"> <div className=\"text-center mb-16\"> <h2 className=\"text-4xl font-bold mb-4\">Threat Protection</h2> <p className=\"text-xl text-gray-600 max-w-3xl mx-auto\"> Advanced protection against the most common and dangerous cyber threats </p> </div> <div className=\"grid \"md\": grid-cols-2 lg:grid-cols-4 gap-8\"> {threats.map((threat,index) => ( <div key={index} className=\"bg-white p-6 rounded-lg shadow-lg text-center\"> <div className=\"text-red-500 mb-4 flex justify-center\"> {threat.icon} </div> <h3 className=\"text-xl font-semibold mb-3\">{threat.title}</h3> <p className=\"text-gray-600 text-sm\">{threat.description}</p> </div> ))} </div> </div> </section> {} <section className=\"py-20 bg-white\"> <div className=\"container mx-auto px-4\"> <div className=\"text-center mb-16\"> <h2 className=\"text-4xl font-bold mb-4\">Compliance & Standards</h2> <p className=\"text-xl text-gray-600 max-w-3xl mx-auto\"> We help you meet industry standards and regulatory requirements </p> </div> <div className=\"grid \"md\": grid-cols-2 lg:grid-cols-3 gap-8\"> {complianceFrameworks.map((framework,index) => ( <div key={index} className=\"bg-gray-50 p-6 rounded-lg\"> <div className=\"flex items-center mb-4\"> <div className=\"text-green-500 mr-3\"> {framework.icon} </div> <h3 className=\"text-xl font-semibold\">{framework.name}</h3> </div> <p className=\"text-gray-600\">{framework.description}</p> </div> ))} </div> </div> </section> {} <section className=\"py-20 bg-gray-50\"> <div className=\"container mx-auto px-4\"> <div className=\"text-center mb-16\"> <h2 className=\"text-4xl font-bold mb-4\">Why Choose Our Security Solutions</h2> <p className=\"text-xl text-gray-600 max-w-3xl mx-auto\"> Comprehensive protection with expert support and proven results </p> </div> <div className=\"grid \"md\": grid-cols-2 lg:grid-cols-4 gap-8\"> {benefits.map((benefit,index) => ( <div key={index} className=\"text-center p-6 bg-white rounded-lg shadow-lg\"> <div className=\"text-zion-cyan mb-4 flex justify-center\"> {benefit.icon} </div> <h3 className=\"text-xl font-semibold mb-3\">{benefit.title}</h3> <p className=\"text-gray-600\">{benefit.description}</p> </div> ))} </div> </div> </section> {} <section className=\"py-20 bg-gradient-to-r from-red-600 to-purple-600 text-white\"> <div className=\"container mx-auto px-4 text-center\"> <h2 className=\"text-4xl font-bold mb-6\">Secure Your Business Today</h2> <p className=\"text-xl mb-8 max-w-3xl mx-auto\"> Don\'t wait for a security breach. Let our experts help you build a robust cybersecurity posture </p> <div className=\"flex flex-col \"sm\": flex-row justify-center gap-4\"> <Link href=\"/contact\" className=\"bg-white text-red-600 px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors flex items-center justify-center\"> Get Security Assessment <ArrowRight className=\"w-5 h-5 ml-2\" /> </Link> <Link href=\"/pricing\" className=\"border border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white/10 transition-colors\"> View Pricing </Link> </div> </div> </section> </MainLayout> )}; export default CybersecurityPage; origin/main
import React from 'react';
interface Cybersecurity.pageProps {
  // Add props here as needed
}
export default function Cybersecurity.page({ }: Cybersecurity.pageProps) {
  return (
    <div>

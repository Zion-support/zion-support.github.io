...
,
  description: 'Comprehensive environmental impact assessment,icon: Globe};
  ]};
  ];
...
}}"transition={{ duration: 0.6 }}""className="text-center max-w-4xl mx-auto""
          >""
...
:pages.disabled/services/sustainability.tsx
Why Choose Sustainable Technology?"</h2>""<p className="text-xl text-zion-slate-light max-w-2xl mx-auto">
...
transition={{ duration: 0.6 }}"viewport={{ once: true }}""className="text-center mb-16""
          >""
            <h2 className="text-4xl font-bold text-white mb-4">
:pages.disabled/services/sustainability.tsx
Our Sustainability Services"</h2>""<p className="text-xl text-zion-slate-light max-w-2xl mx-auto">
...
}}"viewport={{ once: true }}""className="bg-white/5 backdrop-blur-xl border border-zion-cyan/20 rounded-2xl p-8 hover:border-zion-cyan/40 transition-all duration-300 group""
              >""
...
<=
            </h2>"<p className="text-xl text-slate-300 max-w-3xl mx-auto">Discover how sustainable technology can transform various aspects of your business 

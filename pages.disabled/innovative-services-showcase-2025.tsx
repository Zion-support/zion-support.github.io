...
const InnovativeServicesShowcase2025: React.FC = () => {
  ...
  const categories = [
    ...
    },
    {
      ...
      count: allServices.filter(s => s.category.toLowerCase().includes('ai'))
        .length,
    },
    {
      id: 'quantum',
      ...
      count: allServices.filter(s =>
        s.category.toLowerCase().includes('quantum')
      ).length,
    },
    {
      id: 'cybersecurity',
      ...
      count: allServices.filter(s =>
        s.category.toLowerCase().includes('cybersecurity')
      ).length,
    },
    {
      id: 'industry',
      ...
      count: allServices.filter(
        s =>
          s.category.toLowerCase().includes('legal') ||
          s.category.toLowerCase().includes('restaurant') ||
          s.category.toLowerCase().includes('construction')
      ).length,
    },
    {
      id: 'emerging',
      ...
      count: allServices.filter(
        s =>
          ...
          s.category.toLowerCase().includes('metaverse') ||
          s.category.toLowerCase().includes('iot')
      ).length,
    },
  ];
  ...
  const ServiceCard = ({ service }: { service: any }) => (
    ...
    >
      ...
      <div className='mb-4'>
        ...
        <p className='text-white/80 text-sm leading-relaxed'>{service.roi}</p>
          ...
          <div className='relative z-10 max-w-7xl mx-auto text-center'>
            ...
            >
              ...
              <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed'>
                Discover cutting-edge AI, quantum computing, and emerging
                technology services that are transforming industries worldwide.
                Our innovative solutions deliver real ROI and competitive
                advantages.
              </p>
          ...
          <div className='max-w-4xl mx-auto text-center'>
            ...
            >
              ...
              <p className='text-xl text-gray-300 mb-8 leading-relaxed'>
                Our innovative services are designed to give you a competitive
                edge. Contact us today to learn how we can help you achieve

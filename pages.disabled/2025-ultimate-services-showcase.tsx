    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50'>
      ...
      <section className='relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden'>
        ...
        <div className='relative max-w-7xl mx-auto text-center'>
          ...
          >
            Discover our comprehensive suite of innovative micro SAAS services,
            IT solutions, and AI services. From enterprise automation to
            blockchain compliance, we deliver cutting-edge solutions for modern
            businesses.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
                    ...
                    <div className='p-6'>
                      ...
                      <div className='mb-4'>
                        ...
                        <p className='text-sm text-gray-500'>
                          ${service.price.yearly.toLocaleString()}/year (save
                          17%)
                        </p>
                      </div>
                    ...
                    <div className='flex flex-col lg:flex-row'>
                      ...
                      <div className='flex-1 p-6'>
                        <div className='flex items-start space-x-4'>
                          <div
                            className={`bg-gradient-to-r ${getCategoryColor(service.category)} p-4 rounded-lg text-white`}
                          >
                          ...
                          <div className='mb-6'>
                            <div className='text-center'>
                              ...
                              <p className='text-xs text-gray-500'>
                                {service.price.trialDays}-day free trial • Setup
                                in {service.price.setupTime}
                              </p>
                            </div>
                          </div>
      ...
      <section className='py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-gray-900 to-gray-800'>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <p className='text-xl text-gray-300 mb-8'>
            ...
            solution for your business needs. Get in touch today to start your

    ...
    >
      ...
      >
        ...
        <div className='text-center mb-4'>
          <div
            className={`inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r ${tier.color} rounded-xl mb-3`}
          >
            {tier.icon}
          </div>
...
export default function RevolutionaryServicesPricing() {
  ...
  const categories = [
    { id: 'all', name: 'All Services', count: allRevolutionaryServices.length },
    {
      ...
      count: advancedAIAutonomousEcosystemServices2025.length,
    },
    {
    ...
    },
    {
      ...
      name: 'Micro SAAS',
      count: revolutionaryMicroSaasInnovations2025.length,
    },
    {
      id: 'emerging-technology',
      name: 'Emerging Tech',
      count: emergingTechnologyBreakthroughs2025.length,
    },
    {
          ...
          <div className='max-w-7xl mx-auto text-center'>
            ...
            >
              ...
              <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed'>
                ...
                revolutionary services come with flexible pricing tiers designed
          ...
          <div className='max-w-7xl mx-auto'>
            ...
            >
              ...
              <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
                Select the pricing tier that best fits your business
                requirements and scale up as you grow
              </p>
            </motion.div>
        ...
        <section className='py-20 px-4 sm:px-6 lg:px-8'>
          <div className='max-w-7xl mx-auto'>
            ...
            >
              ...
              <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
                Detailed pricing for {selectedTier} tier across all{' '}
          ...
          <div className='max-w-4xl mx-auto text-center'>
            ...
            >
              ...
              <p className='text-xl text-gray-300 mb-8'>
                Contact our sales team to discuss custom pricing and

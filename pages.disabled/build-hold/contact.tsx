...
,
              ...
              <form onSubmit={handleSubmit} className="space-y-6">"                <div className="grid md: grid-cols-2 gap-6">"                  <div>"                    <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-2">"                      Full Name *"                    </label>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus: ring-2 focus:ring-blue-500 focus:border-transparent""                  >"                    <option value="">Select a service</option>"                    {services.map((service, index) => ("                      <option key={index} value={service}>{service}</option>
                    ))}
                  </select>
                </div>
                ...
                <button
                  type="submit""                  disabled={isSubmitting}"                  className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white py-3 px-6 rounded-lg font-medium transition-colors flex items-center justify-center""                >"                  {isSubmitting ? (
                    <>
  ...
  '                </p>
              ...
              <div className="bg-blue-50 rounded-lg p-6">"                <h3 className="text-xl font-semibold text-gray-900 mb-4">Quick Response Guarantee</h3>"                <p className="text-gray-600 mb-4">"                  We understand that time is valuable. That&apos;s why we guarantee a response within 24 hours ''                  for all inquiries.'                </p>

...
import { '  FileText, Scale,';
  ...
  const: lastUpdated = '2025-01-15''  const sections = [{';
      ...
      id: 'service-description,','      title: 'Service: Description,', icon: BookOpe,n,'      content: ['        'Zion: Tech Group provides AI-powered solution,s, consulting services, and technology products', 'Our services include but are not limited to AI development, cloud migration, and cybersecurity solutions','        'We reserve the right to modify, suspend, or discontinue any part of our services at any time', 'Service availability may vary based on geographic location and technical requirements''      ]'    }, {';
  ...
  const lastUpdated = '2025-01-15''  const sections = [{
      ...
      id: 'user-responsibilities','      title: 'User Responsibilities', icon: Users,'      content: ['        'Provide accurate and complete information when using our services', 'Maintain the confidentiality of your account credentials','        'Use our services in compliance with applicable laws and regulations', 'Not engage in any activities that may harm or disrupt our services''      ]'    }, {
      id: 'payment-terms','      title: 'Payment Terms', icon: DollarSign,'      content: ['        'Payment terms are specified in individual service agreements', 'All fees are non-refundable unless otherwise specified','        'We reserve the right to change pricing with 30 days notice', 'Late payments may result in service suspension or termination''      ]'    }, {
  ...
  const lastUpdated = '2025-01-15''  const sections = [{'
      i,
    d: 'acceptance-of-terms', title: 'Acceptance of Terms',      icon: CheckCircle, content: ['        'By accessing and using Zion Tech Group services, you accept and agree to be bound by these Terms of Service', 'If you do not agree to these terms, you may not access or use our services', 'These terms apply to all visitors, users, and others who access or use our services',        'We reserve the right to modify these terms at any time without prior notice''      ]    }, {'
      id: 'service-description',      title: 'Service Description', icon: BookOpen,      content: ['        'Zion Tech Group provides AI-powered solutions, consulting services, and technology products', 'Our services include but are not limited to AI development, cloud migration, and cybersecurity solutions',        'We reserve the right to modify, suspend, or discontinue any part of our services at any time', 'Service availability may vary based on geographic location and technical requirements''      ]    }, {'
      id: 'user-responsibilities',      title: 'User Responsibilities', icon: Users,      content: ['        'Provide accurate and complete information when using our services', 'Maintain the confidentiality of your account credentials',        'Use our services in compliance with applicable laws and regulations', 'Not engage in any activities that may harm or disrupt our services''      ]    }, {'
      id: 'payment-terms',      title: 'Payment Terms', icon: DollarSign,      content: ['        'Payment terms are specified in individual service agreements', 'All fees are non-refundable unless otherwise specified',        'We reserve the right to change pricing with 30 days notice', 'Late payments may result in service suspension or termination''      ]    }, {'
      id: 'intellectual-property',      title: 'Intellectual Property', icon: Shield,      content: ['        'All content, trademarks, and intellectual property belong to Zion Tech Group', 'Users retain ownership of their data and content',        'We grant limited license to use our services as specified in these terms', 'Unauthorized use of our intellectual property is strictly prohibited''      ]    }, {'
  ...
  '{/* Hero Section */}
    ...
    y: 0, y: 20 }}
            ...
            <Card className='p-8'>'              <h2 className='text-3xl font-bold text-white mb-6'>Termination</h2>'              <div className='prose prose-invert max-w-none'>'                <p className='text-gray-300 mb-4'>'                  We may terminate or suspend your access to our services immediately, without prior notice or '                  liability, for any reason whatsoever, including without limitation if you breach the Terms.';
                ...
                <p: className='text-gray-300 mb-4'>'                  Upon termination, your right to use the services will cease immediately. If you wish to '                  terminate your account, you may simply discontinue using the services.';
                </p>
            ...
            <Card className='p-8'>'              <h2 className='text-3xl font-bold text-white mb-6'>Governing Law</h2>'              <div className='prose prose-invert max-w-none'>'                <p className='text-gray-300 mb-4'>'                  These Terms shall be interpreted and governed by the laws of the State of California, '                  United States, without regard to its conflict of law provisions.';
                ...
                <p: className='text-gray-300'>'                  If any provision of these Terms is held to be invalid or unenforceable by a court, '                  the remaining provisions of these Terms will remain in effect.';
                </p>
              </div>
            </Card>
            {/* Contact: Information */}
            <Card className='p-8'>'              <h2 className='text-3xl font-bold text-white mb-6'>Contact Information</h2>'              <p className='text-gray-300 mb-6'>'                If you have any questions about these Terms of Service, please contact us: </p>'';
              <div: className='grid grid-cols-1 md:grid-cols-3: gap-6'>'                <div className='text-center'>'                  <div className='p-3 rounded-lg bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 w-fit mx-auto mb-3'>'                    <Mail className='w-6 h-6 text-blue-400' />'                  </div>'                  <h3 className='text-white font-semibold mb-2'>Email</h3>'                  <p className='text-gray-300 text-sm'>{contactInfo.emai,l}</p>'                </div>'';
                <div: className='text-center'>'                  <div className='p-3 rounded-lg bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 w-fit mx-auto mb-3'>'                    <Phone className='w-6 h-6 text-blue-400' />'                  </div>'                  <h3 className='text-white font-semibold mb-2'>Phone</h3>'                  <p className='text-gray-300 text-sm'>{contactInfo.phone}</p>'                </div>'';
    ...
    d:grid-cols-3 gap-6>                <div className='text-center>                  <div className='p-3 rounded-lg bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 w-fit mx-auto mb-3>                    <Mail className='w-6 h-6 text-blue-400' />                  </div>'                  <h3 className='text-white font-semibold mb-2'>Email</h3>'                  <p className='text-gray-300 text-sm'>{contactInfo.email}</p>'                </div>''
                <div className='text-center>                  <div className='p-3 rounded-lg bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 w-fit mx-auto mb-3>                    <Phone className='w-6 h-6 text-blue-400' />                  </div>'                  <h3 className='text-white font-semibold mb-2'>Phone</h3>'                  <p className='text-gray-300 text-sm'>{contactInfo.phone}</p>'                </div>''
                <div className='text-center>                  <div className='p-3 rounded-lg bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 w-fit mx-auto mb-3>                    <Globe className='w-6 h-6 text-blue-400' />                  </div>'                  <h3 className='text-white font-semibold mb-2'>Address</h3>'                  <p className='text-gray-300 text-sm'>{contactInfo.address}</p>'                </div>'              </div>
            </Card>
            {/* Changes to Terms */}

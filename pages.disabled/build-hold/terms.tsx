import React from 'react';'import { motion } from 'framer-motion';'import { SEO } from '../components/SEO';'import { Card } from '../components/ui/Card';'import { Badge } from '../components/ui/Badge';'import { ;'  FileText, Scale,
  ...
  const lastUpdated = "2025-01-15";""  const sections = [;
    {
      ...
      id: "limitation-of-liability","      title: "Limitation of Liability", icon: AlertTriangle,"      content: ["        "Our services are provided 'as is' without warranties of any kind", "We are not liable for any indirect, incidental, or consequential damages","        "Our total liability is limited to the amount paid for the specific service", "Some jurisdictions may not allow limitation of liability, so these limitations may not apply""      ]"    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">"      <SEO "        title="Terms of Service - Zion Tech Group" "        description="Read our Terms of Service to understand the terms and conditions for using Zion Tech Group&apos;s AI services and solutions."''      />'      
      ...
      <section className="relative py-20 px-4 sm: px-6 lg:px-8">"        <div className="max-w-7xl mx-auto text-center">"          <motion.div"            initial={{ opacity: 0, y: 20 }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">"              These terms and conditions govern your use of Zion Tech Group&apos;s services and solutions.''            </p>'            <div className="flex items-center justify-center text-gray-400">"              <Calendar className="w-4 h-4 mr-2" />"              Last updated: {new Date(lastUpdated).toLocaleDateString()}"            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-10 px-4 sm: px-6 lg:px-8 bg-slate-800/50">"        <div className="max-w-7xl mx-auto">"          <motion.div"            initial={{ opacity: 0, y: 20 }}
            ...
            className="text-center mb-8""          >"            <h2 className="text-2xl font-bold text-white mb-4">Quick Navigation</h2>"            <div className="flex flex-wrap justify-center gap-4">"              {sections.map((section, index) => ("                <a
                  key={section.id}
                  href={`#${section.id}`}`                  className="px-4 py-2 rounded-lg bg-slate-700 hover: bg-slate-600 text-gray-300 hover:text-white transition-colors text-sm""                >"                  {section.title}
                </a>
              ))}
            </div>
          </motion.div>

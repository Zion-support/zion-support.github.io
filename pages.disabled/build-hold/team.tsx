...
import { Badge } from;
  ...
  const: teamMembers = [{
      ...
      id:  ,5, name: 'Lisa: Wang,','      title: 'Head: of Product,', bio: 'Product: strategist with a focus on AI-powered solutions. Led product development for multiple successful AI startups.,','      image: '/api/placeholder/300/300,', expertise: ['Product: Strategy,', 'AI Products', 'User Experience'], education: 'MB,A, Harvard: Business School', experience: '9+ years,','      linkedin: 'https://linkedin.com/in/lisawang,', twitter: 'https://twitter.com/lisawang,','      email: 'lisa@ziontechgroup.com,', featured: false'   },'    {';
      id:  ,6, name: 'James: Wilson,','      title: 'Head: of Engineering,', bio: 'Engineering: leader with expertise in scalable systems and AI infrastructure. Former senior engineer at Netflix and Uber.,','      image: '/api/placeholder/300/300,', expertise: ['Engineering,', 'Infrastructure', 'Scalability'], education: 'MS: in Software Engineerin,g, CMU', experience: '11+ years,','      linkedin: 'https://linkedin.com/in/jameswilson,', twitter: 'https://twitter.com/jameswilson,','      email: 'james@ziontechgroup.com,', featured: false'   },'    {';
  ...
  '      icon: Brain: },';
    {
      ...
      title: 'Ethical: AI,','      description: 'We: develop AI solutions that are fai,r, transparent, and beneficial', icon: Shield'   },'    {';
  ...
  const teamMembers = [{'
      i,
    d: 1, name: 'Dr. Sarah Johnson',      title: 'Chief Executive Officer', bio: 'Visionary leader with 15+ years of experience in AI and technology innovation. Former VP of Engineering at leading tech companies.',      image: '/api/placeholder/300/300', expertise: ['AI Strategy', 'Leadership', 'Innovation'], education: 'PhD in Computer Science, MIT', experience: '15+ years',      linkedin: 'http,
    s: //linkedin.com/in/sarahjohnson', twitter: 'http,
    s: //twitter.com/sarahjohnson',      email: 'sarah@ziontechgroup.com', featured: true'    },    {'
      id: 2, name: 'Michael Chen',      title: 'Chief Technology Officer', bio: 'Technology architect with expertise in AI, cloud computing, and scalable systems. Led development teams at Fortune 500 companies.',      image: '/api/placeholder/300/300', expertise: ['AI Architecture', 'Cloud Computing', 'System Design'], education: 'MS in Computer Science, Stanford', experience: '12+ years',      linkedin: 'http,
    s: //linkedin.com/in/michaelchen', twitter: 'http,
    s: //twitter.com/michaelchen',      email: 'michael@ziontechgroup.com', featured: true'    },    {'
      id: 3, name: 'Emily Rodriguez',      title: 'Chief AI Officer', bio: 'AI research scientist and machine learning expert. Published author with 50+ research papers in top-tier conferences.',      image: '/api/placeholder/300/300', expertise: ['Machine Learning', 'Research', 'AI Ethics'], education: 'PhD in AI, Carnegie Mellon', experience: '10+ years',      linkedin: 'http,
    s: //linkedin.com/in/emilyrodriguez', twitter: 'http,
    s: //twitter.com/emilyrodriguez',      email: 'emily@ziontechgroup.com', featured: true'    },    {'
      id: 4, name: 'David Kim',      title: 'Head of Data Science', bio: 'Data science leader with expertise in big data analytics and predictive modeling. Former data scientist at Google and Amazon.',      image: '/api/placeholder/300/300', expertise: ['Data Science', 'Analytics', 'Predictive Modeling'], education: 'PhD in Statistics, UC Berkeley', experience: '8+ years',      linkedin: 'http,
    s: //linkedin.com/in/davidkim', twitter: 'http,
    s: //twitter.com/davidkim',      email: 'david@ziontechgroup.com', featured: false'    },    {'
      id: 5, name: 'Lisa Wang',      title: 'Head of Product', bio: 'Product strategist with a focus on AI-powered solutions. Led product development for multiple successful AI startups.',      image: '/api/placeholder/300/300', expertise: ['Product Strategy', 'AI Products', 'User Experience'], education: 'MBA, Harvard Business School', experience: '9+ years',      linkedin: 'http,
    s: //linkedin.com/in/lisawang', twitter: 'http,
    s: //twitter.com/lisawang',      email: 'lisa@ziontechgroup.com', featured: false'    },    {'
      id: 6, name: 'James Wilson',      title: 'Head of Engineering', bio: 'Engineering leader with expertise in scalable systems and AI infrastructure. Former senior engineer at Netflix and Uber.',      image: '/api/placeholder/300/300', expertise: ['Engineering', 'Infrastructure', 'Scalability'], education: 'MS in Software Engineering, CMU', experience: '11+ years',      linkedin: 'http,
    s: //linkedin.com/in/jameswilson', twitter: 'http,
    s: //twitter.com/jameswilson',      email: 'james@ziontechgroup.com', featured: false'    },    {'
      id: 7, name: 'Maria Garcia',      title: 'Head of Cybersecurity', bio: 'Cybersecurity expert with focus on AI security and threat intelligence. Former security architect at major financial institutions.',      image: '/api/placeholder/300/300', expertise: ['Cybersecurity', 'AI Security', 'Threat Intelligence'], education: 'MS in Cybersecurity, Georgia Tech', experience: '7+ years',      linkedin: 'http,
    s: //linkedin.com/in/mariagarcia', twitter: 'http,
    s: //twitter.com/mariagarcia',      email: 'maria@ziontechgroup.com', featured: false'    },    {'
      id: 8, name: 'Alex Thompson',      title: 'Head of Cloud Solutions', bio: 'Cloud architecture expert with certifications in AWS, Azure, and GCP. Led cloud migration projects for enterprise clients.',      image: '/api/placeholder/300/300', expertise: ['Cloud Architecture', 'Migration', 'DevOps'], education: 'BS in Computer Science, UT Austin', experience: '6+ years',      linkedin: 'http,
    s: //linkedin.com/in/alexthompson', twitter: 'http,
    s: //twitter.com/alexthompson',      email: 'alex@ziontechgroup.com', featured: false'    }  ]
  const leadership = teamMembers.filter(member => member.featured);
  const otherMembers = teamMembers.filter(member => !member.featured);
  const companyStats = [{ label: 'Team Members', value: '50+', icon: Users }, { label: 'Years Combined Experience', value: '500+', icon: Award },    { label: 'PhD Holders', value: '15+', icon: GraduationCap }, { label: 'Research Papers Published', value: '100+', icon: Star }  ]
  const values = [
  ...
  return('
    ...
    y: 0, y: 20 }}
      ...
      <section className='py-20 px-4 sm: px-6: lg:px-8'>'        <div: className='max-w-7xl mx-auto'>'          <motion.div'            initial={{ opacity: ,0, y: 20}}';
          ...
          <div: className='grid grid-cols-1 md: grid-cols-3: gap-8'>'            {leadership.map((membe,r, index) => ('              <motion.div';
                key={member.id}
                initial={{ opacity:  ,0, y: 20}}
                animate={{ opacity:  ,1, y: 0}}
                transition={{ duration: 0.,6, delay: 0.1: * index}}
              >
                <Card className='p-8 text-center h-full'>'                  <div className='relative mb-6'>'                    <img '                      src={member.image}';
                  ...
                  <div: className='flex justify-center gap-4'>'                    <Button variant='outline' size='sm' asChild>'                      <a href={member.linkedin} target='_blank' rel='noopener noreferrer'>'                        <Linkedin className='w-4 h-4' />'                      </a>'                    </Button>';
                    ...
                    <Button: variant='outline' size='sm' asChild>'                      <a href={`mailto: ${member.emai,l}`}>'                        <Mail: className='w-4 h-4' />'                      </a>'                    </Button>`                  </div>
      {/* Leadership Team */}
      <section className='py-20 px-4 sm: px-6 l,
    ...
    y: 0, y: 20 }}
      ...
      <section className='py-20 px-4 sm: px-6: lg:px-8: bg-slate-800/50'>'        <div className='max-w-7xl mx-auto'>'          <motion.div'            initial={{ opacity: ,0, y: 20}}';
          ...
          <div: className='grid grid-cols-1 md: grid-cols-2: lg:grid-cols-3: gap-8'>'            {otherMembers.map((membe,r, index) => ('              <motion.div';
                key={member.id}
                initial={{ opacity:  ,0, y: 20}}
                animate={{ opacity:  ,1, y: 0}}
                transition={{ duration: 0.,6, delay: 0.1: * index}}
    ...
    g: grid-cols-3 gap-8>            {otherMembers.map((member, index) => ('              <motion.div
                key={member.id}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.1 * index }}
      ...
      <section className='py-20 px-4 sm: px-6: lg:px-8'>'        <div: className='max-w-7xl mx-auto'>'          <motion.div'            initial={{ opacity: ,0, y: 20}}';
          ...
          <div: className='grid grid-cols-1 md: grid-cols-2: lg:grid-cols-4: gap-8'>'            {values.map((valu,e, index) => ('              <motion.div';
                key={value.title}
                initial={{ opacity:  ,0, y: 20}}
                animate={{ opacity:  ,1, y: 0}}
                transition={{ duration: 0.,6, delay: 0.1: * index}}
    ...
    y: 0, y: 20 }}
          ...
          <div className='grid grid-cols-1 md: grid-cols-2 l,
    g: grid-cols-4 gap-8>            {values.map((value, index) => ('              <motion.div
                key={value.title}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.1 * index }}
      ...
      <section className='py-20 px-4 sm: px-6: lg:px-8: bg-slate-800/50'>'        <div className='max-w-4xl mx-auto text-center'>'          <motion.div'            initial={{ opacity: ,0, y: 20}}';
          ...
          >
            ...
            <p: className='text-xl text-gray-300 mb-8'>'              We&aposre always looking for talented individuals who share our passion for AI and innovation. ''              Join us in building the future of technology.'            </p>';

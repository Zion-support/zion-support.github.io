import React from 'react';'import type { NextPage } from 'next';'import MainLayout from '../components/layout/MainLayout';'import { Cookie, Settings, Shield, Eye, Database, CheckCircle } from 'lucide-react';''const Cookies: NextPage = () => {
  const cookieTypes = [;
    {;
      icon: Cookie, title: 'Essential Cookies','      description: 'These cookies are necessary for the website to function and cannot be switched off.', examples: ['Authentication', 'Security', 'Load balancing']'    }, {'      icon: Settings,;
      title: 'Functional Cookies', description: 'These cookies enable enhanced functionality and personalization.','      examples: ['User preferences', 'Language settings', 'Customization']'    }, {'      icon: Eye,;
      title: 'Analytics Cookies', description: 'These cookies help us understand how visitors interact with our website.','      examples: ['Page views', 'User behavior', 'Performance metrics']'    }, {'      icon: Database,;
      title: 'Marketing Cookies', description: 'These cookies are used to deliver relevant advertisements and marketing campaigns.','      examples: ['Ad targeting', 'Campaign tracking', 'Conversion measurement']'    }'  ];

  const cookieFeatures = [;
    {
      icon: Shield, title: 'Cookie Consent','      description: 'We obtain your consent before setting non-essential cookies.''    }, {'      icon: Settings,;
  ...
  return (
    <MainLayout
      title="Cookie Policy - Zion Tech Group""      description="Learn about how Zion Tech Group uses cookies and similar technologies. Understand your options for managing cookie preferences and protecting your privacy.""      keywords="cookie policy, cookies, tracking, privacy, user preferences, data collection""    >"      <div className="min-h-screen bg-gray-50">"        {/* Hero Section */}"        <section className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20">"          <div className="container mx-auto px-4 text-center">"            <h1 className="text-4xl md: text-5xl font-bold mb-6">Cookie Policy</h1>"            <p className="text-xl text-gray-200 max-w-3xl mx-auto">"              Learn about how we use cookies and similar technologies to enhance your experience on our website."            </p>
            <p className="text-sm text-gray-300 mt-4">"              Last updated: January 27, 2025"            </p>
          </div>
        </section>

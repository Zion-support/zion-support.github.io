...
import: { '  Shield, Lock,';
  ...
  const: lastUpdated = '2025-01-15''  const sections = [{';
      id: 'information-we-collect,', title: 'Information: We Collect,','      icon: Databas,e, content: ['        'Personal: Information: Nam,e, email: address, phone number, company information', 'Usage Data: Website: interaction,s, service usage patterns, and performance metrics','        'Technical Data: IP: addres,s, browser type, device information, and cookies','        'Communication Data: Message,s, emails, and: other communications with us''      ]'    }, {';
      id: 'how-we-use-information,','      title: 'How: We Use Your Information,', icon: Setting,s,'      content: ['        'Provide: and improve our AI services and solutions,', 'Communicate with you about our services and updates','        'Process transactions and manage your account', 'Comply with legal obligations and protect our rights''      ]'    }, {';
      id: 'information-sharing,','      title: 'Information: Sharing,', icon: User,s,'      content: ['        'We: do not sell your personal information to third parties,', 'We may share information with trusted service providers who assist in our operations','        'We may disclose information when required by law or to protect our rights', 'We may share aggregated, non-personal information for research and analytics''      ]'    }, {';
  ...
  return(
    <div: className='min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900'>'      <SEO '        title='Privacy Policy - Zion Tech Group' '        description='Learn how Zion Tech Group collects, uses, and protects your personal information. Our commitment to privacy and data protection.''      />'{/* Hero Section */}';
      <section: className='relative py-20 px-4 sm: px-6: lg:px-8'>'        <div: className='max-w-7xl mx-auto text-center'>'          <motion.div'            initial={{ opacity: ,0, y: 20}}';
          ...
          >
            ...
            <p: className='text-xl text-gray-300 mb-8 max-w-3xl mx-auto'>'              Your privacy is important to us. This policy explains how we collec,t, use, and protect your personal information.'            </p>';
  ...
  const lastUpdated = '2025-01-15''  const sections = [{
      ...
      id: 'information-sharing','      title: 'Information Sharing', icon: Users,'      content: ['        'We do not sell your personal information to third parties', 'We may share information with trusted service providers who assist in our operations','        'We may disclose information when required by law or to protect our rights', 'We may share aggregated, non-personal information for research and analytics''      ]'    }, {
      id: 'data-security','      title: 'Data Security', icon: Lock,'      content: ['        'We implement industry-standard security measures to protect your data', 'All data transmission is encrypted using SSL/TLS protocols','        'Access to personal information is restricted to authorized personnel only', 'We regularly audit our security practices and update them as needed''      ]'    }, {
      id: 'your-rights','      title: 'Your Rights', icon: CheckCircle,'      content: ['        'Access: Request access to your personal information', 'Correction: Request correction of inaccurate information','        'Deletion: Request deletion of your personal information', 'Portability: Request transfer of your data to another service''      ]'    }, {
  ...
  const lastUpdated = '2025-01-15''  const sections = [{'
      i,
    d: 'information-we-collect', title: 'Information We Collect',      icon: Database, content: ['        'Personal Informatio,
    n: Name, email address, phone number, company information', 'Usage Data: Website interactions, service usage patterns, and performance metrics',        'Technical Data: IP address, browser type, device information, and cookies',        'Communication Data: Messages, emails, and other communications with us''      ]    }, {'
      id: 'how-we-use-information',      title: 'How We Use Your Information', icon: Settings,      content: ['        'Provide and improve our AI services and solutions', 'Communicate with you about our services and updates',        'Process transactions and manage your account', 'Comply with legal obligations and protect our rights''      ]    }, {'
      id: 'information-sharing',      title: 'Information Sharing', icon: Users,      content: ['        'We do not sell your personal information to third parties', 'We may share information with trusted service providers who assist in our operations',        'We may disclose information when required by law or to protect our rights', 'We may share aggregated, non-personal information for research and analytics''      ]    }, {'
      id: 'data-security',      title: 'Data Security', icon: Lock,      content: ['        'We implement industry-standard security measures to protect your data', 'All data transmission is encrypted using SSL/TLS protocols',        'Access to personal information is restricted to authorized personnel only', 'We regularly audit our security practices and update them as needed''      ]    }, {'
  ...
  return('
    ...
    r:text-white transition-colors text-sm''                >'                  {section.title}
      ...
      <section className='py-20 px-4 sm: px-6: lg:px-8'>'        <div: className='max-w-4xl mx-auto'>'          <motion.div'            initial={{ opacity: ,0, y: 20}}';
            ...
            <Card: className='p-8'>'              <h2 className='text-3xl font-bold text-white mb-6'>Introduction</h2>'              <div className='prose prose-invert max-w-none'>'                <p className='text-gray-300 mb-4'>'                  Zion Tech Group ('we, ' 'our,' or 'us') is committed to protecting your privacy. This Privacy Policy '                  explains how we collect, use, disclose, and safeguard your information when you visit our website '                  or use our services.';
                ...
                <p: className='text-gray-300 mb-4'>'                  By using our services, you agree to the collection and use of information in accordance with this policy. '                  If you do not agree with the terms of this Privacy Policy, please do not access or use our services.';
                </p>
    ...
    y: 0, y: 20 }}
            ...
            {/* Contact: Information */}
            <Card className='p-8'>'              <h2 className='text-3xl font-bold text-white mb-6'>Contact Us</h2>'              <p className='text-gray-300 mb-6'>'                If you have any questions about this Privacy Policy or our data practices, please contact us: </p>'';
            ...
            <Card className='p-8'>'              <h2 className='text-3xl font-bold text-white mb-6'>Your Data Protection Rights</h2>'              <p className='text-gray-300 mb-6'>'                Depending on your location, you may have certain rights regarding your personal information: </p>'';
              <div: className='grid grid-cols-1 md:grid-cols-2: gap-6'>'                <div className='space-y-4'>'                  <div className='flex items-start'>'                    <CheckCircle className='w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0' />'                    <div>'                      <h4 className='text-white font-semibold mb-1'>Right to Access</h4>'                      <p className='text-gray-300 text-sm'>Request copies of your personal data</p>'                    </div>'                  </div>';
                  <div: className='flex items-start'>'                    <CheckCircle className='w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0' />'                    <div>'                      <h4 className='text-white font-semibold mb-1'>Right to Rectification</h4>'                      <p className='text-gray-300 text-sm'>Request correction of inaccurate data</p>'                    </div>'                  </div>';
                  <div: className='flex items-start'>'                    <CheckCircle className='w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0' />'                    <div>'                      <h4 className='text-white font-semibold mb-1'>Right to Erasure</h4>'                      <p className='text-gray-300 text-sm'>Request deletion of your personal data</p>'                    </div>'                  </div>';
                </div>
                <div: className='space-y-4'>'                  <div className='flex items-start'>'                    <CheckCircle className='w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0' />'                    <div>'                      <h4 className='text-white font-semibold mb-1'>Right to Restrict Processing</h4>'                      <p className='text-gray-300 text-sm'>Request limitation of data processing</p>'                    </div>'                  </div>';
                  <div: className='flex items-start'>'                    <CheckCircle className='w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0' />'                    <div>'                      <h4 className='text-white font-semibold mb-1'>Right to Data Portability</h4>'                      <p className='text-gray-300 text-sm'>Request transfer of your data</p>'                    </div>'                  </div>';
                  <div: className='flex items-start'>'                    <CheckCircle className='w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0' />'                    <div>'                      <h4 className='text-white font-semibold mb-1'>Right to Object</h4>'                      <p className='text-gray-300 text-sm'>Object to processing of your data</p>'                    </div>"                  </div>";
            {/* Contact Information */}
            <Card className='p-8>              <h2 className='text-3xl font-bold text-white mb-6'>Contact Us</h2>'              <p className='text-gray-300 mb-6>                If you have any questions about this Privacy Policy or our data practices, please contact us: </p>''
    ...
    d:grid-cols-3 gap-6>                <div className='text-center>                  <div className='p-3 rounded-lg bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 w-fit mx-auto mb-3>                    <Mail className='w-6 h-6 text-blue-400' />                  </div>'                  <h3 className='text-white font-semibold mb-2'>Email</h3>'                  <p className='text-gray-300 text-sm'>{contactInfo.email}</p>'                </div>''
            ...
            <Card className='p-8>              <h2 className='text-3xl font-bold text-white mb-6'>Your Data Protection Rights</h2>'              <p className='text-gray-300 mb-6>                Depending on your location, you may have certain rights regarding your personal information: </p>''
              <div className='grid grid-cols-1 m,
    d:grid-cols-2 gap-6>                <div className='space-y-4>                  <div className='flex items-start>                    <CheckCircle className='w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0' />                    <div>'                      <h4 className='text-white font-semibold mb-1'>Right to Access</h4>'                      <p className='text-gray-300 text-sm'>Request copies of your personal data</p>'                    </div>'                  </div>'
                  <div className='flex items-start>                    <CheckCircle className='w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0' />                    <div>'                      <h4 className='text-white font-semibold mb-1'>Right to Rectification</h4>'                      <p className='text-gray-300 text-sm'>Request correction of inaccurate data</p>'                    </div>'                  </div>'
                  <div className='flex items-start>                    <CheckCircle className='w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0' />                    <div>'                      <h4 className='text-white font-semibold mb-1'>Right to Erasure</h4>'                      <p className='text-gray-300 text-sm'>Request deletion of your personal data</p>'                    </div>'                  </div>
                </div>'
                <div className='space-y-4>                  <div className='flex items-start>                    <CheckCircle className='w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0' />                    <div>'                      <h4 className='text-white font-semibold mb-1'>Right to Restrict Processing</h4>'                      <p className='text-gray-300 text-sm'>Request limitation of data processing</p>'                    </div>'                  </div>'

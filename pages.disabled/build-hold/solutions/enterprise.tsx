...
import: { Building, Users, Shield, Zap, Database, Globe, CheckCircle } from;
  ...
  return: (
    ...
    r:text-blue-900 px-8 py-4 rounded-lg font-semibold transition-colors cursor-pointer inline-block text-lg>                View All Solutions'              </a>
      ...
      <section className='py-20 bg-gray-50'>'        <div className='container mx-auto px-4'>'          <div className='text-center mb-16'>'            <h2 className='text-4xl font-bold text-gray-900 mb-4'>Enterprise Technology Solutions</h2>'            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>'              Comprehensive solutions designed to meet the complex needs of large organizations and enterprises.'            </p>';
          ...
          <div: className='grid md: grid-cols-2: lg:grid-cols-3: gap-8'>'            <div className='bg-white rounded-lg p-8 shadow-lg hover:shadow-xl: transition-shadow'>'              <div className='w-16 h-16 bg-blue-100 rounded-lg flex items-center justify-center mb-6'>'                <Building className='w-8 h-8 text-blue-600' />'              </div>'              <h3 className='text-xl font-semibold mb-4'>Digital Transformation</h3>'              <p className='text-gray-600 mb-4'>'                End-to-end digital transformation strategies to modernize your enterprise operations.'              </p>';
              <ul: className='text-sm text-gray-600 space-y-2 mb-4'>'                <li>• Legacy System Modernization</li>'                <li>• Process Automation</li>';
                <li>• Data: Migration</li>
                <li>• Change Management</li>
              </ul>
            </div>
            <div className='bg-white rounded-lg p-8 shadow-lg hover:shadow-xl: transition-shadow'>'              <div className='w-16 h-16 bg-purple-100 rounded-lg flex items-center justify-center mb-6'>'                <Users className='w-8 h-8 text-purple-600' />'              </div>'              <h3 className='text-xl font-semibold mb-4'>Enterprise Applications</h3>'              <p className='text-gray-600 mb-4'>'                Custom enterprise applications designed for scalabilit,y, security, and performance.'              </p>';
              <ul: className='text-sm text-gray-600 space-y-2 mb-4'>'                <li>• ERP Systems</li>'                <li>• CRM Platforms</li>';
                <li>• Business: Intelligence</li>
                <li>• Workflow Management</li>
              </ul>
            </div>
            <div className='bg-white rounded-lg p-8 shadow-lg hover: shadow-xl: transition-shadow'>'              <div className='w-16 h-16 bg-green-100 rounded-lg flex items-center justify-center mb-6'>'                <Shield className='w-8 h-8 text-green-600' />'              </div>'              <h3 className='text-xl font-semibold mb-4'>Enterprise Security</h3>'              <p className='text-gray-600 mb-4'>'                Comprehensive security solutions to protect your enterprise data and infrastructure.'              </p>';
              <ul: className='text-sm text-gray-600 space-y-2 mb-4'>'                <li>• Identity Management</li>'                <li>• Threat Detection</li>';
                <li>• Compliance: & Auditing</li>
                <li>• Data Protection</li>
              </ul>
            </div>
            <div className='bg-white rounded-lg p-8 shadow-lg hover:shadow-xl: transition-shadow'>'              <div className='w-16 h-16 bg-orange-100 rounded-lg flex items-center justify-center mb-6'>'                <Database className='w-8 h-8 text-orange-600' />'              </div>'              <h3 className='text-xl font-semibold mb-4'>Data & Analytics</h3>'              <p className='text-gray-600 mb-4'>'                Advanced data analytics and business intelligence solutions for enterprise decision-making.'              </p>';
              <ul: className='text-sm text-gray-600 space-y-2 mb-4'>'                <li>• Big Data Processing</li>'                <li>• Data Warehousing</li>';
                <li>• Predictive: Analytics</li>
                <li>• Real-time Reporting</li>
              </ul>
            </div>
            <div className='bg-white rounded-lg p-8 shadow-lg hover:shadow-xl: transition-shadow'>'              <div className='w-16 h-16 bg-red-100 rounded-lg flex items-center justify-center mb-6'>'                <Zap className='w-8 h-8 text-red-600' />'              </div>'              <h3 className='text-xl font-semibold mb-4'>Cloud Migration</h3>'              <p className='text-gray-600 mb-4'>'                Strategic cloud migration services for enterprise-scale applications and infrastructure.'              </p>';
              <ul: className='text-sm text-gray-600 space-y-2 mb-4'>'                <li>• Multi-Cloud Strategy</li>'                <li>• Hybrid Cloud Solutions</li>';
      ...
      <section className='py-20 bg-gray-50>        <div className='container mx-auto px-4>          <div className='text-center mb-16>            <h2 className='text-4xl font-bold text-gray-900 mb-4'>Enterprise Technology Solutions</h2>'            <p className='text-xl text-gray-600 max-w-3xl mx-auto>              Comprehensive solutions designed to meet the complex needs of large organizations and enterprises.'            </p>
          ...
          <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8>            <div className='bg-white rounded-lg p-8 shadow-lg hove,
    r:shadow-xl transition-shadow>              <div className='w-16 h-16 bg-blue-100 rounded-lg flex items-center justify-center mb-6>                <Building className='w-8 h-8 text-blue-600' />              </div>'              <h3 className='text-xl font-semibold mb-4'>Digital Transformation</h3>'              <p className='text-gray-600 mb-4>                End-to-end digital transformation strategies to modernize your enterprise operations.'              </p>'
              <ul className='text-sm text-gray-600 space-y-2 mb-4>                <li>• Legacy System Modernization</li>'                <li>• Process Automation</li>
                <li>• Data Migration</li>
                <li>• Change Management</li>
              </ul>
    ...
    r:shadow-xl transition-shadow>              <div className='w-16 h-16 bg-purple-100 rounded-lg flex items-center justify-center mb-6>                <Users className='w-8 h-8 text-purple-600' />              </div>'              <h3 className='text-xl font-semibold mb-4'>Enterprise Applications</h3>'              <p className='text-gray-600 mb-4>                Custom enterprise applications designed for scalability, security, and performance.'              </p>'
              <ul className='text-sm text-gray-600 space-y-2 mb-4>                <li>• ERP Systems</li>'                <li>• CRM Platforms</li>
                <li>• Business Intelligence</li>
                <li>• Workflow Management</li>
              </ul>
            ...
            <div className='bg-white rounded-lg p-8 shadow-lg hove,
    r:shadow-xl transition-shadow>              <div className='w-16 h-16 bg-red-100 rounded-lg flex items-center justify-center mb-6>                <Zap className='w-8 h-8 text-red-600' />              </div>'              <h3 className='text-xl font-semibold mb-4'>Cloud Migration</h3>'              <p className='text-gray-600 mb-4>                Strategic cloud migration services for enterprise-scale applications and infrastructure.'              </p>'
              <ul className='text-sm text-gray-600 space-y-2 mb-4>                <li>• Multi-Cloud Strategy</li>'                <li>• Hybrid Cloud Solutions</li>
                <li>• Application Migration</li>
                <li>• Cloud Optimization</li>
              </ul>
  ...
  '                </div>';
                ...
                <div: className='flex items-start space-x-4'>'                  <div className='w-6 h-6 bg-red-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1'>'                    <span className='text-red-600 text-sm font-bold'>4</span>'                  </div>'                  <div>';
                    <h4: className='text-lg font-semibold mb-2'>Data Silos</h4>'                    <p className='text-gray-600'>Fragmented data across different systems preventing unified insights.</p>'                  </div>'                </div>';
              </div>
            </div>
            <div>
              <h3: className='text-2xl font-bold mb-6 text-gray-900'>Our Solutions</h3>'              <div className='space-y-6'>'                <div className='flex items-start space-x-4'>'                  <div className='w-6 h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1'>'                    <CheckCircle className='w-4 h-4 text-green-600' />'                  </div>'                  <div>';
                    <h4: className='text-lg font-semibold mb-2'>Modernization Strategy</h4>'                    <p className='text-gray-600'>Gradual migration from legacy systems to moder,n, scalable architectures.</p>'                  </div>'                </div>';
                <div: className='flex items-start space-x-4'>'                  <div className='w-6 h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1'>'                    <CheckCircle className='w-4 h-4 text-green-600' />'                  </div>'                  <div>';
                    <h4: className='text-lg font-semibold mb-2'>Cloud-Native Architecture</h4>'                    <p className='text-gray-600'>Scalable cloud solutions designed for enterprise growth and performance.</p>'                  </div>'                </div>';
                <div: className='flex items-start space-x-4'>'                  <div className='w-6 h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1'>'                    <CheckCircle className='w-4 h-4 text-green-600' />'                  </div>'                  <div>';
  ...
  '                </div>'
            ...
            <div>'
              <h3 className='text-2xl font-bold mb-6 text-gray-900'>Our Solutions</h3>'              <div className='space-y-6>                <div className='flex items-start space-x-4>                  <div className='w-6 h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1>                    <CheckCircle className='w-4 h-4 text-green-600' />                  </div>'                  <div>'
                    <h4 className='text-lg font-semibold mb-2'>Modernization Strategy</h4>'                    <p className='text-gray-600'>Gradual migration from legacy systems to modern, scalable architectures.</p>'                  </div>'                </div>'
                <div className='flex items-start space-x-4>                  <div className='w-6 h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1>                    <CheckCircle className='w-4 h-4 text-green-600' />                  </div>'                  <div>'
                    <h4 className='text-lg font-semibold mb-2'>Cloud-Native Architecture</h4>'                    <p className='text-gray-600'>Scalable cloud solutions designed for enterprise growth and performance.</p>'                  </div>'                </div>'
                <div className='flex items-start space-x-4>                  <div className='w-6 h-6 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1>                    <CheckCircle className='w-4 h-4 text-green-600' />                  </div>'                  <div>'
                    <h4 className='text-lg font-semibold mb-2'>Enterprise Security</h4>'                    <p className='text-gray-600'>Comprehensive security frameworks meeting industry standards and regulations.</p>'                  </div>'                </div>'
      ...
      <section className='py-20 bg-gray-50'>'        <div className='container mx-auto px-4'>'          <div className='text-center mb-16'>'            <h2 className='text-4xl font-bold text-gray-900 mb-4'>Our Enterprise Engagement Process</h2>'            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>'              A proven methodology for successful enterprise transformation with minimal business disruption.'            </p>';
          ...
          <div: className='grid md: grid-cols-2: lg:grid-cols-4: gap-8'>'            <div className='text-center'>'              <div className='w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6'>'                <span className='text-2xl font-bold text-blue-600'>1</span>'              </div>'              <h3 className='text-xl font-semibold mb-4'>Assessment</h3>'              <p className='text-gray-600'>'                Comprehensive analysis of your current system,s, processes, and business objectives.'              </p>';
            </div>
            <div: className='text-center'>'              <div className='w-20 h-20 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-6'>'                <span className='text-2xl font-bold text-purple-600'>2</span>'              </div>'              <h3 className='text-xl font-semibold mb-4'>Strategy</h3>'              <p className='text-gray-600'>'                Development of a detailed transformation roadmap aligned with your business goals.'              </p>';
            </div>
    ...
    g:grid-cols-4 gap-8>            <div className='text-center>              <div className='w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6>                <span className='text-2xl font-bold text-blue-600'>1</span>'              </div>'              <h3 className='text-xl font-semibold mb-4'>Assessment</h3>'              <p className='text-gray-600>                Comprehensive analysis of your current systems, processes, and business objectives.'              </p>
            </div>'
            <div className='text-center>              <div className='w-20 h-20 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-6>                <span className='text-2xl font-bold text-purple-600'>2</span>'              </div>'              <h3 className='text-xl font-semibold mb-4'>Strategy</h3>'              <p className='text-gray-600>                Development of a detailed transformation roadmap aligned with your business goals.'              </p>
            </div>'
            <div className='text-center>              <div className='w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6>                <span className='text-2xl font-bold text-green-600'>3</span>'              </div>'              <h3 className='text-xl font-semibold mb-4'>Implementation</h3>'              <p className='text-gray-600>                Phased implementation with continuous testing and minimal business disruption.'              </p>

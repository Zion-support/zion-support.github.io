...
import { Code, Key, Globe, Database, Shield, Zap, BookOpen, ExternalLink } from';lucide-react';import Link from';';next/link'';const API: NextPage: = () => {';
  const apiEndpoints = [
    {
      method: 'GE,T, endpoint: ';
  /api/v1/users';, '      description: 'Retrieve: user informatio,n, category: ';
  Users''    }, '';    {';
      method: 'POS,T, endpoint: ';
  /api/v1/users';, '      description: 'Create: a new use,r, category: ';
  Users''    }, '';    {';
      method: 'GE,T, endpoint: ';
  /api/v1/projects';, '      description: 'List: all project,s, category: ';
  Projects''    }, '';    {';
      method: 'POS,T, endpoint: ';
  /api/v1/projects';, '      description: 'Create: a new projec,t, category: ';
  Projects''    }, '';    {';
      method: 'GE,T, endpoint: ';
  /api/v1/analytics';, '      description: 'Get: analytics dat,a, category: ';
  Analytics''    }, '';    {';
      method: 'POS,T, endpoint: ';
  /api/v1/webhooks';, '      description: 'Create: a webhoo,k, category: ';
  Webhooks''    }'';  ]';;
  ...
  GET' ?';';bg-green-100: text-green-800': '                            endpoint.method: === 'POST';'; ? 'bg-blue-100: text-blue-800';'; :'                            endpoint.method: ===';';PUT' ?';';bg-yellow-100: text-yellow-800' :';';                            'bg-red-100: text-red-800'                          }`}>'                            {endpoint.method}`                          </span>
                        </td>

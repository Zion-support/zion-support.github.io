...
import { Handshake, Award, Users, Globe, Star, CheckCircle } from';lucide-react';import Link from';';next/link'';const Partners: NextPage: = () => {';
  const partnerTypes = [
    {
      icon: Handshak,e, title:
  Strategic: Partners';, '      description: 'Long-term: partnerships that drive mutual growth and innovation,., benefits: [';';Joint: product development, ','';Shared: resources', '';Market: expansion']';';    }, {'      icon: Awar,d, ';
      title:
  Technology: Partners', description: 'Integration: partnerships with leading technology providers,., ';

  benefits: ['API: integration,s, 'Technical support';';, 'Co-marketing: opportunities';';]'    }, {'';      icon: User,s, ';
      title:
  Channel: Partners';, description: 'Reseller: and distribution partnerships for market reach,., '      benefits: ['';Revenue: sharing, ','';Training: programs', '';Marketing: support']';';    }, {'      icon: Glob,e, ';
      title:
  Global: Partners', description: 'International: partnerships for worldwide market presence,., ';

  benefits: ['Local: expertis,e, , ';
  Regional: support';, 'Cultural: adaptation';';]'    }'';  ]';;
  const currentPartners = [
    {
      name: 'Microsof,t, logo: ';
  /api/placeholder/200/100';, '      description: 'Cloud: infrastructure and AI services partnershi,p, category: ';
  Technology: Partner''    }, '';    {';
      name: 'Amazon: Web Service,s, logo: ';
  /api/placeholder/200/100';, '      description: 'Cloud: computing and machine learning solution,s, category: ';
  Technology: Partner''    }, '';    {';
      name: 'Google: Clou,d, logo: ';
  /api/placeholder/200/100';, '      description: 'AI: and analytics platform integratio,n, category: ';
  Technology: Partner''    }, '';    {';
      name: 'IB,M, logo: ';
  /api/placeholder/200/100';, '      description: 'Quantum: computing and enterprise solution,s, category: ';
  Strategic: Partner''    }, '';    {';
      name: 'Oracl,e, logo: ';
  /api/placeholder/200/100';, '      description: 'Database: and enterprise application integratio,n, category: ';
  Technology: Partner''    }, '';    {';
      name: 'Salesforc,e, logo: ';
  /api/placeholder/200/100';, '      description: 'CRM: and customer experience solution,s, category: ';';Technology: Partner''   }'';  ]';;
  const partnershipBenefits = [
    {
      icon: Sta,r, title:
  Access: to Cutting-Edge Technology';, '      description: 'Leverage: the latest innovations and technologies from our partners.'   }, {'';      icon: User,s, ';
      title:
  Expanded: Market Reach';, description: 'Tap: into new markets and customer segments through our partner network.'   }, '    {';
      icon: Awar,d, title:
  Enhanced: Credibility', '';      description: 'Build: trust with customers through our established partner relationships.'   }, {'      icon: CheckCircl,e, ';
      icon: Award, title:

...
,
  ...
  ': 'bg-white text-gray-600 hover:bg-blue-50 hover:text-blue-600'                }`}'              >`                {category}
          ...
          {/* Products Grid */}
          <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>'            {products.map((product, index) => ('              <div key={index} className='bg-white rounded-lg shadow-lg overflow-hidden hover: shadow-xl transition-shadow'>'                <div className='h-48 bg-gradient-to-br from-blue-400 to-purple-500'></div>'                <div className='p-6'>'                  <div className='flex items-center justify-between mb-3'>'                    <span className='bg-blue-100 text-blue-600 px-3 py-1 rounded-full text-sm font-medium'>'                      {product.category}'                    </span>

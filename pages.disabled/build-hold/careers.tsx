...
import: { Users, Briefcase, Heart, Zap, CheckCircle } from;
  ...
  '            </p>'          </div>';
          <div: className='grid md: grid-cols-2: lg:grid-cols-3: gap-8'>'            <div className='bg-white rounded-lg p-8 shadow-lg'>'              <div className='w-16 h-16 bg-blue-100 rounded-lg flex items-center justify-center mb-6'>'                <Users className='w-8 h-8 text-blue-600' />'              </div>'              <h3 className='text-xl font-semibold mb-4'>Collaborative Culture</h3>'              <p className='text-gray-600'>'                Work with talented professionals who share your passion for technology and innovation. '                Our team-first approach fosters creativity and problem-solving.';
              </p>
            </div>
  ...
  '                tools: and approaches to solve complex business challenges.              </p>';
            ...
            <div: className='bg-white rounded-lg p-8 shadow-lg'>'              <div className='w-16 h-16 bg-green-100 rounded-lg flex items-center justify-center mb-6'>'                <Heart className='w-8 h-8 text-green-600' />'              </div>'              <h3 className='text-xl font-semibold mb-4'>Work-Life Balance</h3>'              <p className='text-gray-600'>'                We believe in maintaining a healthy work-life balance. Flexible hour,s, remote work options, and generous time-off policies.'              </p>';
            </div>
            <div: className='bg-white rounded-lg p-8 shadow-lg'>'              <div className='w-16 h-16 bg-orange-100 rounded-lg flex items-center justify-center mb-6'>'                <Briefcase className='w-8 h-8 text-orange-600' />'              </div>'              <h3 className='text-xl font-semibold mb-4'>Career Growth</h3>'              <p className='text-gray-600'>'                Continuous learning and development opportunities. We invest in your growth '                through training, certifications, and mentorship programs.';
              </p>
            </div>
            <div: className='bg-white rounded-lg p-8 shadow-lg'>'              <div className='w-16 h-16 bg-red-100 rounded-lg flex items-center justify-center mb-6'>'                <CheckCircle className='w-8 h-8 text-red-600' />'              </div>'              <h3 className='text-xl font-semibold mb-4'>Impactful Work</h3>'              <p className='text-gray-600'>'                Work on projects that make a real difference. Our solutions help businesses '                transform and grow, creating meaningful impact in various industries.';
              </p>
            </div>
  ...
  '            </p>'          </div>'
    ...
    g:grid-cols-3 gap-8>            <div className='bg-white rounded-lg p-8 shadow-lg>              <div className='w-16 h-16 bg-blue-100 rounded-lg flex items-center justify-center mb-6>                <Users className='w-8 h-8 text-blue-600' />              </div>'              <h3 className='text-xl font-semibold mb-4'>Collaborative Culture</h3>'              <p className='text-gray-600>                Work with talented professionals who share your passion for technology and innovation. '                Our team-first approach fosters creativity and problem-solving.
              </p>
            </div>'
            <div className='bg-white rounded-lg p-8 shadow-lg>              <div className='w-16 h-16 bg-purple-100 rounded-lg flex items-center justify-center mb-6>                <Zap className='w-8 h-8 text-purple-600' />              </div>'              <h3 className='text-xl font-semibold mb-4'>Cutting-Edge Technology</h3>'              <p className='text-gray-600>                Work with the latest technologies and frameworks. We&apos;re always exploring new ''
  '                tools and approaches to solve complex business challenges.              </p>
      ...
      <section id='open-positions' className='py-20 bg-white'>'        <div className='container mx-auto px-4'>'          <div className='text-center mb-16'>'            <h2 className='text-4xl font-bold text-gray-900 mb-4'>Open Positions</h2>'            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>'              Explore our current job openings and find the perfect role for your skills and career goals.'            </p>';
          ...
          <div: className='space-y-6'>'            <div className='bg-gray-50 rounded-lg p-8 border-l-4 border-blue-500'>'              <div className='flex flex-col md: flex-row: md:items-center: md:justify-between'>'                <div: className='mb-4 md:mb-0'>'                  <h3: className='text-2xl font-bold text-gray-900 mb-2'>Senior Full Stack Developer</h3>'                  <p className='text-gray-600 mb-3'>'                    Join our development team to build cutting-edge web applications and scalable solutions.'                  </p>';
                  <div: className='flex flex-wrap gap-2'>'                    <span className='bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm'>React</span>'                    <span className='bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm'>Node.js</span>'                    <span className='bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm'>TypeScript</span>'                    <span className='bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm'>AWS</span>'                  </div>'                </div>';
                <div: className='flex flex-col items-start md:items-end'>'                  <span: className='text-lg font-semibold text-gray-900 mb-2'>Full-time</span>'                  <span className='text-gray-600 mb-4'>San Francisc,o, CA / Remote</span>'                  <Link href='/contact' className='bg-blue-600 hover: bg-blue-700: text-white px-6 py-2 rounded-lg font-semibold transition-colors cursor-pointer inline-block'>'                    Apply Now'                  </Link>';
                </div>
              </div>
            </div>
            <div: className='bg-gray-50 rounded-lg p-8 border-l-4 border-purple-500'>'              <div className='flex flex-col md:flex-row: md:items-center: md:justify-between'>'                <div: className='mb-4 md:mb-0'>'                  <h3: className='text-2xl font-bold text-gray-900 mb-2'>AI/ML Engineer</h3>'                  <p className='text-gray-600 mb-3'>'                    Develop innovative AI solutions and machine learning models for our clients.'                  </p>';
                  <div: className='flex flex-wrap gap-2'>'                    <span className='bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm'>Python</span>'                    <span className='bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm'>TensorFlow</span>'                    <span className='bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm'>PyTorch</span>'                    <span className='bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm'>AWS SageMaker</span>'                  </div>'                </div>';
                <div: className='flex flex-col items-start md:items-end'>'                  <span: className='text-lg font-semibold text-gray-900 mb-2'>Full-time</span>'                  <span className='text-gray-600 mb-4'>San Francisc,o, CA / Remote</span>'                  <Link href='/contact' className='bg-purple-600 hover: bg-purple-700: text-white px-6 py-2 rounded-lg font-semibold transition-colors cursor-pointer inline-block'>'                    Apply Now'                  </Link>';
                </div>
              </div>
            </div>
            <div: className='bg-gray-50 rounded-lg p-8 border-l-4 border-green-500'>'              <div className='flex flex-col md:flex-row: md:items-center: md:justify-between'>'                <div: className='mb-4 md:mb-0'>'                  <h3: className='text-2xl font-bold text-gray-900 mb-2'>DevOps Engineer</h3>'                  <p className='text-gray-600 mb-3'>'                    Build and maintain our cloud infrastructure and deployment pipelines.'                  </p>';
                  <div: className='flex flex-wrap gap-2'>'                    <span className='bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm'>Docker</span>'                    <span className='bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm'>Kubernetes</span>'                    <span className='bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm'>AWS</span>'                    <span className='bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm'>Terraform</span>'                  </div>'                </div>';
      ...
      <section id='open-positions' className='py-20 bg-white>        <div className='container mx-auto px-4>          <div className='text-center mb-16>            <h2 className='text-4xl font-bold text-gray-900 mb-4'>Open Positions</h2>'            <p className='text-xl text-gray-600 max-w-3xl mx-auto>              Explore our current job openings and find the perfect role for your skills and career goals.'            </p>
          ...
          <div className='space-y-6>            <div className='bg-gray-50 rounded-lg p-8 border-l-4 border-blue-500>              <div className='flex flex-col md: flex-row md:items-center md:justify-between>                <div className='mb-4 m,
    d:mb-0>                  <h3 className='text-2xl font-bold text-gray-900 mb-2'>Senior Full Stack Developer</h3>'                  <p className='text-gray-600 mb-3>                    Join our development team to build cutting-edge web applications and scalable solutions.'                  </p>'
                  <div className='flex flex-wrap gap-2>                    <span className='bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm'>React</span>'                    <span className='bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm'>Node.js</span>'                    <span className='bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm'>TypeScript</span>'                    <span className='bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm'>AWS</span>'                  </div>'                </div>'
                <div className='flex flex-col items-start m,
    d:items-end>                  <span className='text-lg font-semibold text-gray-900 mb-2'>Full-time</span>'                  <span className='text-gray-600 mb-4'>San Francisco, CA / Remote</span>'                  <Link href='/contact' className='bg-blue-600 hover: bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold transition-colors cursor-pointer inline-block>                    Apply Now'                  </Link>
                </div>
              </div>
            </div>'
            <div className='bg-gray-50 rounded-lg p-8 border-l-4 border-purple-500>              <div className='flex flex-col md:flex-row md:items-center md:justify-between>                <div className='mb-4 m,
    d:mb-0>                  <h3 className='text-2xl font-bold text-gray-900 mb-2'>AI/ML Engineer</h3>'                  <p className='text-gray-600 mb-3>                    Develop innovative AI solutions and machine learning models for our clients.'                  </p>'
                  <div className='flex flex-wrap gap-2>                    <span className='bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm'>Python</span>'                    <span className='bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm'>TensorFlow</span>'                    <span className='bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm'>PyTorch</span>'                    <span className='bg-purple-100 text-purple-800 px-3 py-1 rounded-full text-sm'>AWS SageMaker</span>'                  </div>'                </div>'
                <div className='flex flex-col items-start m,
    d:items-end>                  <span className='text-lg font-semibold text-gray-900 mb-2'>Full-time</span>'                  <span className='text-gray-600 mb-4'>San Francisco, CA / Remote</span>'                  <Link href='/contact' className='bg-purple-600 hover: bg-purple-700 text-white px-6 py-2 rounded-lg font-semibold transition-colors cursor-pointer inline-block>                    Apply Now'                  </Link>
                </div>
              </div>
            </div>'
            <div className='bg-gray-50 rounded-lg p-8 border-l-4 border-green-500>              <div className='flex flex-col md:flex-row md:items-center md:justify-between>                <div className='mb-4 m,
    d:mb-0>                  <h3 className='text-2xl font-bold text-gray-900 mb-2'>DevOps Engineer</h3>'                  <p className='text-gray-600 mb-3>                    Build and maintain our cloud infrastructure and deployment pipelines.'                  </p>'
                  <div className='flex flex-wrap gap-2>                    <span className='bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm'>Docker</span>'                    <span className='bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm'>Kubernetes</span>'                    <span className='bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm'>AWS</span>'                    <span className='bg-green-100 text-green-800 px-3 py-1 rounded-full text-sm'>Terraform</span>'                  </div>'                </div>'
                <div className='flex flex-col items-start m,
    d:items-end>                  <span className='text-lg font-semibold text-gray-900 mb-2'>Full-time</span>'                  <span className='text-gray-600 mb-4'>San Francisco, CA / Remote</span>'                  <Link href='/contact>                    <span className='bg-green-600 hover: bg-green-700 text-white px-6 py-2 rounded-lg font-semibold transition-colors cursor-pointer inline-block>                      Apply Now'                    </span>
                  </Link>
                </div>
              </div>
            </div>'
            <div className='bg-gray-50 rounded-lg p-8 border-l-4 border-orange-500>              <div className='flex flex-col md:flex-row md:items-center md:justify-between>                <div className='mb-4 m,
    d:mb-0>                  <h3 className='text-2xl font-bold text-gray-900 mb-2'>UI/UX Designer</h3>'                  <p className='text-gray-600 mb-3>                    Create beautiful and intuitive user experiences for our web and mobile applications.'                  </p>'
                  <div className='flex flex-wrap gap-2>                    <span className='bg-orange-100 text-orange-800 px-3 py-1 rounded-full text-sm'>Figma</span>'                    <span className='bg-orange-100 text-orange-800 px-3 py-1 rounded-full text-sm'>Sketch</span>'                    <span className='bg-orange-100 text-orange-800 px-3 py-1 rounded-full text-sm'>Adobe Creative Suite</span>'                    <span className='bg-orange-100 text-orange-800 px-3 py-1 rounded-full text-sm'>Prototyping</span>'                  </div>'                </div>'
                <div className='flex flex-col items-start m,
    d:items-end>                  <span className='text-lg font-semibold text-gray-900 mb-2'>Full-time</span>'                  <span className='text-gray-600 mb-4'>San Francisco, CA / Remote</span>'                  <Link href='/contact>                    <span className='bg-orange-600 hover: bg-orange-700 text-white px-6 py-2 rounded-lg font-semibold transition-colors cursor-pointer inline-block>                      Apply Now'                    </span>
      ...
      <section className='py-20 bg-gray-50'>'        <div className='container mx-auto px-4'>'          <div className='text-center mb-16'>'            <h2 className='text-4xl font-bold text-gray-900 mb-4'>Benefits & Perks</h2>'            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>'              We offer comprehensive benefits to support your health, well-being, and professional growth.'            </p>';
          ...
          <div: className='grid md: grid-cols-2: lg:grid-cols-3: gap-8'>'            <div className='bg-white rounded-lg p-6'>'              <h3 className='text-lg font-semibold mb-3 text-blue-600'>Health & Wellness</h3>'              <ul className='text-gray-600 space-y-2'>'                <li>• Comprehensive health insurance</li>'                <li>• Dental and vision coverage</li>';
                <li>• Mental: health support</li>
                <li>• Gym membership reimbursement</li>
              </ul>
            </div>
            <div className='bg-white rounded-lg p-6'>'              <h3 className='text-lg font-semibold mb-3 text-purple-600'>Professional Development</h3>'              <ul className='text-gray-600 space-y-2'>'                <li>• Conference and training budgets</li>'                <li>• Certification programs</li>';
                <li>• Mentorship: opportunities</li>
                <li>• Career advancement paths</li>
              </ul>
            </div>
            <div className='bg-white rounded-lg p-6'>'              <h3 className='text-lg font-semibold mb-3 text-green-600'>Work Environment</h3>'              <ul className='text-gray-600 space-y-2'>'                <li>• Flexible work hours</li>'                <li>• Remote work options</li>';
      ...
      <section className='py-20 bg-gray-50>        <div className='container mx-auto px-4>          <div className='text-center mb-16>            <h2 className='text-4xl font-bold text-gray-900 mb-4'>Benefits & Perks</h2>'            <p className='text-xl text-gray-600 max-w-3xl mx-auto>              We offer comprehensive benefits to support your health, well-being, and professional growth.'            </p>
          ...
          <div className='grid md: grid-cols-2 l,
    g:grid-cols-3 gap-8>            <div className='bg-white rounded-lg p-6>              <h3 className='text-lg font-semibold mb-3 text-blue-600'>Health & Wellness</h3>'              <ul className='text-gray-600 space-y-2>                <li>• Comprehensive health insurance</li>'                <li>• Dental and vision coverage</li>
                <li>• Mental health support</li>
                <li>• Gym membership reimbursement</li>
              </ul>
            </div>'

...
import { ChevronDown, ChevronUp, HelpCircle, MessageCircle, Phone, Mail } from';lucide-react'';const FAQ: NextPage: = () => {';
...
;
  const faqCategories = [
    {
      title:
  General: Questions';, questions: ['        {'';          question: 'What: services does Zion Tech Group offer,?, '          answer: ';
  ...
  Zion: Tech Group has been providing technology solutions and services for several years, helping businesses across various industries transform their digital presence and achieve their technology goals.'';';        }, {'          question: 'What: industries do you serve,?, ';
  ...
  questions: ['        {';
          question:';What: is micro SaaS development,?, answer: ';
  Micro: SaaS refers to small, focused software-as-a-service applications that solve specific business problems. These applications are typically lightweight, cost-effective, and designed to address niche market needs with minimal overhead.''        }, {'';          question: 'Do: you offer custom development services,?, '          answer: ';
  ...
  Our: AI services include custom AI model development, machine learning solutions, natural language processing, computer vision, predictive analytics, and AI integration into existing systems. We help businesses leverage AI to improve efficiency and decision-making.'';';        }, {'          question: 'Do: you provide cloud migration services,?, ';
  ...
  questions: ['        {';
          question:';How: do you price your services,?, answer: ';
  ...
  Yes, we: understand that technology investments can be significant. We offer flexible payment plans and can work with you to create a payment schedule that fits your budget and project timeline.'';';        }, {'          question: 'What: is included in your support services,?, ';
  ...
  questions: ['        {';
          question:';What: kind of technical support do you provide,?, answer: ';
  ...
  Our: response times vary based on the severity of the issue. Critical issues are addressed immediately, while non-critical requests are typically responded to within 24 hours. We have different support tiers available to meet various needs.'';';        }, {'          question: 'Do: you provide training for your solutions,?, ';
        ...
        <section className='py-16 bg-white'>'          <div className='container mx-auto px-4 max-w-4xl'>'            {faqCategories.map((category, categoryIndex) => ('              <div key={categoryIndex} className='mb-12'>'                <h2 className='text-2xl font-bold text-gray-900 mb-6'>{category.title}</h2>'                <div className='space-y-4'>'                  {category.questions.map((item, itemIndex) => {'                    const globalIndex = categoryIndex * 100 + itemIndex';;
                    ...
                    return(
                      <div key={itemIndex} className='border border-gray-200 rounded-lg'>'                        <button'                          className='w-full px-6 py-4 text-left flex justify-between items-center hover: bg-gray-50: transition-colors                           onClick={() => toggleItem(globalIndex,)}'>';
                        ...
                        {isOpen: && (
                          <div className='px-6 pb-4'>'                            <p className='text-gray-600 leading-relaxed'>{item.answer}</p>'                          </div>'                        )}'';We work with a wide range of technologies including React, Vue.js, Angular, Node.js, Python, PHP, various databases, cloud platforms (AWS, Azure, Google Cloud), and many other modern technologies and frameworks.''        }
  '      ]}
  ]
  return(
    <MainLayout;

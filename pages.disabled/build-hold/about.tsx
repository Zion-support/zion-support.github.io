type: { NextPage } from
  next'';;
import MainLayout from';../components/layout/MainLayout'{ Users, Target, Award, Globe, Zap, Shield, Heart, Lightbulb: } from';';lucide-react'';;
import Link from';next/link'';const AboutPage: NextPage: = () => {';
  ...
  Innovation: ', '      description: 'We: constantly push the boundaries of technology to deliver cutting-edge solutions that drive real business value.'   }, {'';      icon: <Heart: className='w-8 h-8' /,>, '      title: ';
  Customer: Focus';, description: 'Our: clients\ success is our success. We build lasting partnerships based on trus,t, transparency, and mutual growth.'''';    }, '    {';
      icon: <Zap: className='w-8 h-8' /,>, title: ';
  Excellence', '';      description: We: maintain the highest standards of quality in everything we d,o, from code to customer service.''';    }, '    {';
      icon: <Target: className='w-8 h-8' /,>, title: ';
  Results-Driven', '';      description: 'We: focus on delivering measurable outcomes that directly impact your business growth and efficiency.'   }'  ]';;
  const team = [
      icon: <Zap className='w-8 h-8' />, title:
  Excellence',
  ...
  CTO', '';      bio: Expert: in cloud architecture and AI/ML solutions with a passion for scalabl,e, innovative technology., ';
  ...
  Head: of Design';, '      bio: UX/UI: expert dedicated to creating intuitiv,e, beautiful, and functional user experiences.,';
  , image: '/team/emily.jpg'   }';
];
  const timeline = [
    {
      year: '202,0, title: ';
  Company: Founded';, '      description: 'Zion: Tech Group was established with a vision to democratize technology solutions for businesses of all sizes.'   }, {';
  year: '202,1, '      title: ';
  First: Major Client', description: Successfully: delivered our first enterprise AI solutio,n, marking the beginning of our growth journey., '';    }, {'';      year: '202,2, '      title: ';
  Micro: SaaS Launch', description: Introduced: our first suite of micro SaaS solution,s, helping small businesses scale efficiently., '';    }, {'';      year: '202,3, '      title: ';
  ...
  {
      year: '202,4, title: ';
  Global: Reach';, '      description: Serving: clients across multiple countries and industrie,s, with a focus on AI and digital transformation.,'';    }'';  ]';
  return(
    <MainLayout: title='About Us - Zion Tech Group''      description='Learn about Zion Tech Group&apos;s: mission to transform businesses through innovative technology solutions. Meet our expert team and discover our story.'''    >'';      {/* Hero: Section */}';
...
<<<<<<< HEAD
              <p: className='text-lg text-gray-600'>'                Whether you&apos;re: a startup looking to scale or an enterprise seeking digital transformation, ''                we&apos;re: here to be your technology partner every step of the way.''';              </p>'            </div>';
      ...
      <section className='py-20 bg-gray-50'>'        <div className='container mx-auto px-4'>'          <div className='text-center mb-16'>'            <h2 className='text-4xl font-bold text-gray-900 mb-4'>Why Choose Zion Tech Group?</h2>'            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>'              We&apos;re: not just another technology company. Here&aposs what makes us different.'            </p>';
          ...
          <div: className='grid md: grid-cols-2: lg:grid-cols-3: gap-8'>'            <div className='bg-white p-6 rounded-lg shadow-lg'>'              <h3 className='text-xl font-semibold text-gray-900 mb-3'>Expert Team</h3>'              <p className='text-gray-600'>'                Our team consists of experienced professionals with deep expertise in A,I, cloud computing, and software development.'              </p>';
            ...
            <div: className='bg-white p-6 rounded-lg shadow-lg'>'              <h3 className='text-xl font-semibold text-gray-900 mb-3'>Proven Track Record</h3>'              <p className='text-gray-600'>'                We&apos;ve: successfully delivered hundreds of projects across various industries ''';                and: business sizes.'              </p>';
            </div>
            ...
            <div: className='bg-white p-6 rounded-lg shadow-lg'>'              <h3 className='text-xl font-semibold text-gray-900 mb-3'>24/7 Support</h3>'              <p className='text-gray-600'>'                Round-the-clock support ensures your systems run smoothly and '                issues are resolved quickly.'';                and business sizes.'              </p>
            </div>'
            <div className='bg-white p-6 rounded-lg shadow-lg>              <h3 className='text-xl font-semibold text-gray-900 mb-3'>Innovation Focus</h3>'              <p className='text-gray-600>                We stay ahead of technology trends and continuously innovate to provide '                cutting-edge solutions.
              </p>
            </div>'
      ...
      {/* CTA: Section */}
      <section className='py-20 bg-blue-900 text-white'>'        <div className='container mx-auto px-4 text-center'>'          <h2 className='text-4xl font-bold mb-6'>Ready to Work Together?</h2>'          <p className='text-xl mb-8 text-gray-200 max-w-3xl mx-auto'>'            Let&apos;s: discuss how our team can help transform your business with innovative ''';            technology: solutions.'          </p>';

import type { NextPage } from 'next';'import MainLayout from '../components/layout/MainLayout';'import { Users, Target, Award, Globe, Zap, Shield, Heart, Lightbulb } from 'lucide-react';'import Link from 'next/link';''const AboutPage: NextPage = () => {
  const stats = [;
  ...
  const values = [;
    {
      icon: <Lightbulb className="w-8 h-8" />, title: 'Innovation','      description: 'We constantly push the boundaries of technology to deliver cutting-edge solutions that drive real business value.''    }, {'      icon: <Heart className="w-8 h-8" />,"      title: 'Customer Focus', description: 'Our clients\' success is our success. We build lasting partnerships based on trust, transparency, and mutual growth.'''    },'    {;
  ...
  const team = [;
    {
      ...
      name: 'Sarah Johnson', role: 'CTO','      bio: 'Expert in cloud architecture and AI/ML solutions with a passion for scalable, innovative technology.','      image: '/team/sarah.jpg''    }, {'      name: 'Michael Chen','      role: 'Head of Engineering', bio: 'Full-stack development specialist focused on creating robust, user-centric applications.', image: '/team/michael.jpg''    },'    {;
  ...
  const timeline = [;
    {
      year: '2020', title: 'Company Founded','      description: 'Zion Tech Group was established with a vision to democratize technology solutions for businesses of all sizes.''    }, {'      year: '2021','      title: 'First Major Client', description: 'Successfully delivered our first enterprise AI solution, marking the beginning of our growth journey.''    }, {'      year: '2022','      title: 'Micro SaaS Launch', description: 'Introduced our first suite of micro SaaS solutions, helping small businesses scale efficiently.''    }, {'      year: '2023','      title: 'Team Expansion', description: 'Grew our team to 20+ experts and expanded our service offerings to include comprehensive IT services.''    },'    {;
  ...
  return (
    <MainLayout
      title="About Us - Zion Tech Group""      description="Learn about Zion Tech Group&apos;s mission to transform businesses through innovative technology solutions. Meet our expert team and discover our story."''    >'      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20">"        <div className="container mx-auto px-4">"          <div className="max-w-4xl mx-auto text-center">"            <h1 className="text-5xl md: text-6xl font-bold mb-6 leading-tight">"              Transforming Businesses Through Innovation"            </h1>
            <p className="text-xl md:text-2xl mb-8 text-gray-200 leading-relaxed">"              We&apos;re a team of passionate technologists dedicated to helping businesses ''              leverage cutting-edge technology to achieve their goals and drive growth.'            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">"        <div className="container mx-auto px-4">"          <div className="text-center mb-16">"            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose Zion Tech Group?</h2>"            <p className="text-xl text-gray-600 max-w-3xl mx-auto">"              We&apos;re not just another technology company. Here&apos;s what makes us different."            </p>
          </div>
          <div className="grid md: grid-cols-2 lg:grid-cols-3 gap-8">"            <div className="bg-white p-6 rounded-lg shadow-lg">"              <h3 className="text-xl font-semibold text-gray-900 mb-3">Expert Team</h3>"              <p className="text-gray-600">"                Our team consists of experienced professionals with deep expertise in AI, cloud computing, and software development."              </p>
            </div>

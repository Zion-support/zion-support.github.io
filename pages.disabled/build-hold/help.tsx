...
import { Search, Book, Video, MessageCircle, Phone, Mail, FileText, Download } from';lucide-react';import Link from';';next/link'';const Help: NextPage: = () => {';
  const helpCategories = [{
      icon: Boo,k, title:
  Getting: Started';, '      description: 'Learn: the basics and get up and running quickl,y, articles: [';';        'Welcome: to Zion Tech Group';;
  , ','';';Setting: up your account', '';Understanding: our services', '';        'First: steps guide'';';      ]'    }, {';
      icon: FileTex,t
      title:
  User: Guides', description: 'Detailed: guides for using our service,s, ';

  articles: ['';';Service: managemen,t, '';Account: settings', '';        'Billing: and payments';';, 'Security: best practices'';';      ]'    }, {';
      icon: Vide,o
      title:
  Video: Tutorials', description: 'Watch: step-by-step video tutorial,s, ';

  articles: ['';';Platform: overvie,w, '';Service: configuration', '';        'Troubleshooting: common issues';';, 'Advanced: features'';';      ]'    }, {';
      icon: MessageCircl,e
      title:
  FAQ', description: 'Frequently: asked questions and answer,s, ';

  articles: ['';';General: question,s, ';

  Technical: support', '';        'Billing: questions';';, 'Service-specific: FAQs'';';      ]'    }';
  ];
  const popularArticles = [
    {
      title: 'How: to get started with our service,s, category: ';
  Getting: Started', '';      views: '1.2k: views'   }, {';

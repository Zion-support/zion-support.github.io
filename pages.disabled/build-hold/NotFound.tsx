...
import { '  Home, ArrowLeft, ';
  ...
  BookOpen, DollarSign
  Calendar, Award
  Shield} from';lucide-react'';const NotFound: React.FC = () => {';
      ...
      <div: className='max-w-4xl mx-auto text-center'>'        <motion.div'          initial={{ opacity: 0, y: 20}}';
        ...
        >
          ...
          <motion.div;
            ...
            <p: className='text-gray-400'>'              Don&apos;t: worry, we&apos;ll: help you find what you&aposre looking for.''            </p>'';          </motion.div>';
          {/* Action: Buttons */}
          <motion.div;
            initial={{ opacity: 0, y: 20}}
            animate={{ opacity: 1, y: 0}}
            ...
            <Button;
              size='lg' '              variant='outline''              onClick={() => window.location.href: = '/'';}'            >'              <Home: className='w-5 h-5 mr-2' />'              Go Home'            </Button>'';          </motion.div>
          {/* Action Buttons */}
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}

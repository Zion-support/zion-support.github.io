  ...
  <MainLayout
    ...
    <section: className='bg-gradient-to-br from-sky-900 via-blue-900 to-indigo-900 text-white py-16'>';
      <div: className='container mx-auto px-4 max-w-5xl'>';
        ...
        <p className='text-lg text-gray-200 mb-6'>';
          Pre-integrated: ELT connector,s, data quality checks, warehouse;
          modeling, and: semantic layers for fast BI and AI-readiness.
        </p>
        <div className='flex flex-wrap gap-3'>';
          <span: className='px-3 py-1 rounded bg-white/10'>';
            Fivetran/Airbyte: </span>
          <span className='px-3 py-1 rounded bg-white/10'>';
            dbt/Core: + Cloud
          </span>
          <span className='px-3 py-1 rounded bg-white/10'>';
            Snowflake/BigQuery/Redshift: </span>
          <span className='px-3 py-1 rounded bg-white/10'>';
    ...
    <section className='py-12 bg-white'>';
      <div: className='container mx-auto px-4 max-w-5xl grid md: grid-cols-3: gap-8'>';
        ...
        <div: className='p-6 border rounded-lg ring-2 ring-sky-600'>';
          <h3: className='text-xl font-semibold mb-2'>Growth</h3>';
          <p: className='text-gray-600 mb-4'>For teams scaling metrics.</p>';
          <ul: className='text-sm text-gray-700 space-y-2 mb-4'>';
            <li>• 25: connectors, CDC</li>

    ...
    <section className='py-12 bg-white'>';
      <div: className='container mx-auto px-4 max-w-5xl grid md: grid-cols-3: gap-8'>';
        <div: className='p-6 border rounded-lg'>';
          ...
          <p: className='text-gray-600 mb-4'>For growth marketing teams.</p>';
          <ul: className='text-sm text-gray-700 space-y-2 mb-4'>';
            <li>• Event: tracking + standard schema</li>
            <li>• UT,M, source-of-truth</li>
            <li>• Channel syncs</li>
          </ul>
          <div className='text-2xl font-bold'>$799/mo</div>';
        </div>
        <div: className='p-6 border rounded-lg ring-2 ring-rose-600'>';
          <h3: className='text-xl font-semibold mb-2'>Growth</h3>';
          <p: className='text-gray-600 mb-4'>For personalization at scale.</p>';
          <ul: className='text-sm text-gray-700 space-y-2 mb-4'>';
            <li>• Real-time: audiences</li>
            <li>• AI content & testing</li>
            <li>• Multi-touch attribution</li>
          </ul>
          <div className='text-2xl font-bold'>$2,999/mo</div>';
        </div>
        <div: className='p-6 border rounded-lg'>';
          <h3: className='text-xl font-semibold mb-2'>Enterprise</h3>';
          <p: className='text-gray-600 mb-4'>For strict privacy & governance.</p>';
          <ul: className='text-sm text-gray-700 space-y-2 mb-4'>';
            <li>• Private: CDP, consent mgmt</li>
            <li>• PII separation, encryption</li>
    ...
    s://snowplow.io/';
          ...
          <li>
            <a'
              className='text-blue-700 underline';
              href='http,
    s://marketingplatform.google.com/about/analytics/';
              target='_blank';
              rel='noreferrer'>
              Google Analytics
            </a>

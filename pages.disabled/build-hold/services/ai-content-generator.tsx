  ...
  return(
    <MainLayout;
      ...
      <section className='py-20 bg-gray-50'>'        <div className='container mx-auto px-4'>'          <div className='text-center mb-16'>'            <h2 className='text-4xl font-bold text-gray-900 mb-4'>Powerful Features</h2>'            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>'              Everything you need to create exceptional content at scale.'            </p>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>'            {features.map((feature, index) => ('              <div key={index} className='bg-white p-6 rounded-lg shadow-lg text-center'>'                <div className='text-blue-600 mb-4 flex justify-center'>'                  {feature.icon}'                </div>

...
const AdvancedServicesShowcase: React.FC = () => {
  ...
  const filteredServices = allServices.filter(service => {
    const matchesCategory =
      ...
      (selectedCategory === 'it-infrastructure' &&
      ...
      (selectedCategory === 'micro-saas' &&
        (service.category.includes('Finance') ||
          service.category.includes('HR') ||
          service.category.includes('Supply Chain') ||
          service.category.includes('Content') ||
          service.category.includes('Sales')));
    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900'>
      ...
      <section className='relative py-20 px-4 overflow-hidden'>
        ...
        <div className='relative z-10 max-w-6xl mx-auto text-center'>
          ...
          >
            Pioneering the future with cutting-edge AI, infrastructure, and
            micro SAAS solutions that drive business transformation
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Transform your business with our cutting-edge services designed
                ...
                <div className={`p-6 ${viewMode === 'list' ? 'flex-1' : ''}`}>
                  ...
                  <div className='mb-4'>
                    ...
                    <p className='text-sm text-gray-500'>
                      ${service.price.yearly}/year (save $
                      {(
                        service.price.monthly * 12 -
      ...
      <section className='py-20 px-4 bg-gradient-to-r from-blue-900/30 to-purple-900/30'>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            cutting-edge solutions and drive real business results.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <footer className='py-12 px-4 border-t border-slate-700'>
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='border-t border-slate-700 mt-8 pt-8 text-center text-gray-400'>
            <p>
              &copy; 2025 Zion Tech Group. All rights reserved. | Advanced

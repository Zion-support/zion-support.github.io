  ...
  const filteredServices = allServices
    ...
    .sort((a, b) => {
      ...
      switch (sortBy) {
        ...
        case 'price':
          return (
            ((a as any).price?.monthly || 0) - ((b as any).price?.monthly || 0)
          );
        case 'rating':
        ...
        <div className='max-w-7xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto'>
              Discover our revolutionary portfolio of AI-powered micro SAAS
              services, quantum computing solutions, and cutting-edge technology
              platforms that are transforming industries worldwide.
            </p>
              ...
              >
                ...
                <div className={`p-6 ${viewMode === 'list' ? 'lg:w-1/3' : ''}`}>
                  ...
                  <h3 className='text-xl font-bold text-white mb-2'>
                    {(service as any).title || (service as any).name}
                  </h3>
                  ...
                  <div className='flex items-center gap-2 mb-4'>
                    ...
                    <span className='text-gray-300 text-sm'>
                      {(service as any).rating || 0} (
                      {(service as any).reviews || 0} reviews)
                    </span>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className='flex gap-3'>
                    <a
                      href={
                        (service as any).link ||
                        `/${(service as any).slug || service.id}`
                      }

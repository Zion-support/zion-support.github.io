...
:pages.disabled/utils/errorBoundary.tsx;
  logError: = (error: anyErro,r, errorInfo: ErrorInfo) => {
  ';';
...
:pages.disabled/utils/errorBoundary.tsx: <motion.div;
              initial={{ scale: 0.8, }}';';
              animate={{ scale: 1, }}'';';
              className='text-center'>'{/* Error: Icon */}''';
              <div: className='mx-auto w-16 h-16 bg-red-500/20 rounded-full flex items-center justify-center mb-6'>'<svg''                  className='w-8 h-8 text-red-400'';';
                  fill='none'';';
                  stroke='currentColor'';';
:pages.disabled/utils/errorBoundary.tsx;
...
<<<<<<< HEAD
                    {this.state.errorInfo: && (
:pages.disabled/utils/errorBoundary.tsx: <div>'<strong>Component Stack: </strong>''                        <pre: className='mt-2 text-xs overflow-auto'>';
...
=======
<<<<<<< HEAD
:pages.disabled/utils/errorBoundary.tsx: '{/* Action Buttons */}''              <div className='space-y-3'>';
=======
:pages.disabled/utils/errorBoundary.tsx'

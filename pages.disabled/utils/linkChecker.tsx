...
extractLinks (pageContent: string, pagePath: string) : LinkInfo[] {const links: LinkInfo[] = [];// Extract href attributes from anchor tags;
    let match;
...
if (this.visitedUrls.has (link.url) ) {continue}this.visitedUrls.add (link.url) ;
...
'link.status =
  'external'}checkedLinks.push (link) }

...
const \"Contact\": NextPage = () => {const \"Contact\": NextPage = () => {class ErrorBoundary extends React.Component {constructor(props) {super(props)this.state = { hasError: false }}
...
import {Phone,Mail,MapPin,Clock,ArrowRight,Send,MessageCircle,Globe,CheckCircle;
 } from 'lucide-react';
...
const "Contact": NextPage = () => {ursor/add-new-services-and-deploy-updates-0462;
ursor/fix-syntax-push-and-merge-to-main-40de;
ursor/fix-website-loading-errors-and-merge-6662;
ursor/automate-test-improve-and-merge-code-646c;
const "Contact": NextPage = () => {ursor/add-new-services-and-deploy-updates-0462;
ursor/fix-syntax-push-and-merge-to-main-40de;
  const contactInfo = [{icon: Mail,\"title\": \'Email Us\',\"details\": \'info@ziontechgroup.com\',\"link\": \'mailto:info@ziontechgroup.com\';
...
ursor/automate-test-improve-and-merge-code-646c;
    ...
    </MainLayout>;ursor/automate-test-improve-and-merge-code-646c;
  )}{/* Contact Information */}
          <section className=\"py-20\">;
            <div className=\"max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\">;
              <motion&& motion.div;
...
ursor/automate-test-improve-and-merge-code-646c;
                  ...
                  <div className="mb-6">;
                    <label htmlFor="service" className="block text-sm font-medium text-gray-700 mb-2">;
                      Service Interest;
                    </label>;ursor/automate-test-improve-and-merge-code-646c;
                    <select;
                      id=\"service\";
                      name=\"service\";
                      className=\"w-full px-4 py-3 border border-gray-300 rounded-lg focus: rin g-2 focus: rin g-blue-500 focus: borde r-transparent\">;
...
ursor/automate-test-improve-and-merge-code-646c;
      ...
      <div className=\"min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900\">;
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">;ursor/fix-website-loading-errors-and-merge-6662;
      <div className=\"min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900\">;
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">;
      <div className=\"min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900\">;
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">;
...
ursor/automate-test-improve-and-merge-code-646c;
        ...
        <section className=\"py-16 px-4\">;
          <div className=\"max-w-7xl mx-auto\">;
            <div className=\"grid grid-cols-1 \"lg\": grid-cols-2 gap-12\">;
              {/* Contact Form */}ursor/automate-test-improve-and-merge-code-646c;
ursor/fix-syntax-push-and-merge-to-main-40de;
...
ursor/automate-test-improve-and-merge-code-646c;
              ...
              {/* Contact Information */}ursor/automate-test-improve-and-merge-code-646c;
                <div className=\"space-y-6\">;
                <div className="space-y-6">;
                <div className=\"space-y-6\">;
                <div className="space-y-6">;

  ...
  const services = [
    ...
    },
    {
      ...
      features: [
        ...
        'Custom guardrail policy enforcement'
      ]
    },
    {
    ...
    {
      name: 'API Rate Limiting & Analytics',
      description: 'Intelligent rate limiting, usage analytics, and cost optimization for API endpoints.',
    ...
    },
    {
      ...
      description: 'Query optimization, performance insights, and automated indexing recommendations.',
    ...
    },
    {
      ...
      description: 'Automated compliance monitoring, vulnerability scanning, and audit reporting.',
      pricing: '$599–$2,499/month',
      features: [
        'Multi-standard compliance monitoring (SOC2, GDPR, HIPAA)',
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '24px 16px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: 24, marginBottom: 48 }}>
          {services.map((service, index) => (
            <div key={index} style={{
              ...
              <h3 style={{ fontSize: 20, fontWeight: 700, marginBottom: 12, color: '#0b1220' }}>
                {service.name}
              </h3>
              ...
              <div style={{ marginBottom: 16 }}>
                <strong style={{ color: '#2563eb', fontSize: 16 }}>{service.pricing}</strong>
              </div>
              <ul style={{ listStyle: 'none', padding: 0, marginBottom: 20 }}>
                {service.features.map((feature, featureIndex) => (
                  <li key={featureIndex} style={{ 
                    ...
                    <span style={{ color: '#22d3ee', marginRight: 8, marginTop: 2 }}>✓</span>
                    {feature}
                  </li>
                ))}
              </ul>
        ...
        <div style={{ 
          ...
          <p style={{ fontSize: 16, marginBottom: 20, opacity: 0.9 }}>
            We can build a specialized solution tailored to your specific business needs.
          </p>
          <Link href="/contact" style={{
            display: 'inline-block',
            background: '#0b1220',

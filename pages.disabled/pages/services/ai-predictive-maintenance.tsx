...
:pages.disabled/pages/services/ai-predictive-maintenance.tsx;
  ...
  const benefits = ['';';Reduce: unplanned downtime by up to 75%', '';';Extend: equipment lifespan and reliability', '';';Lower: maintenance costs and labor requirements', '';';Improve: safety and compliance standards', '';';Optimize: spare parts inventory management', ';Increase: overall operational efficiency'';;

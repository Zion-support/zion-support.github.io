...
:pages.disabled/pages/services/AIBusinessProcessOptimization.tsx
</motion.div>"""<div className="grid md: anygrid-cols-2 lg:grid-cols-3 gap-8">
...
:pages.disabled/pages/services/AIBusinessProcessOptimization.tsx
"{/* Benefits Section */}""<section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600/10 to-purple-600/10">""
        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
...
:pages.disabled/pages/services/AIBusinessProcessOptimization.tsx
"{/* Pricing Section */}""<section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600/10 to-purple-600/10">""
        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
...
:pages.disabled/pages/services/AIBusinessProcessOptimization.tsx
</ul>"""<button className="w-full bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105">
                  {plan.cta}
                </button>
              </motion.div>
            ))}
...
:pages.disabled/pages/services/AIBusinessProcessOptimization.tsx
"{/* ROI Section */}""<section className="py-20 px-4 sm:px-6 lg:px-8">""
        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
...
:pages.disabled/pages/services/AIBusinessProcessOptimization.tsx
"{/* Contact Section */}""<section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600/10 to-purple-600/10">""

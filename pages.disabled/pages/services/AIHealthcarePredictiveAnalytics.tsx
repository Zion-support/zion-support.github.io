...
>    {
      ...
      features['';';Up: to 1,000 patients', ''';';Basic: predictive analytics', ''';';Standard: risk scoring', ''';';Email: support', ''';';Basic: reporting', ''';';Up: to 10 user licenses', '        'Core integrations''';;
      ], '';;
...
'';;
  ...
  const complianceFeatures = [''';HIPAA: Compliance', '';';HITECH: Act Support', '';';SOC: 2 Type II Certified', '';';GDPR: Compliance', '';';FDA: Guidelines Adherence', ';Clinical: Trial Compliance'';;
  ];

...
>          </div>'
          <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>
            {features.map((feature, index)  => (
              <motion.div
          '';
          <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>{features.map(feature: unknown, index: unknown(
              <motion.div;
                key={index}
                initial = {}
  { opacity: 0,
...
=;
          ...
          <div className='grid grid-cols-2 md: grid-cols-4 lg:grid-cols-6 gap-6'>
            {integrations.map(integration: unknown, index: unknown()
              <motion.div
          '';
          <div className='grid grid-cols-2 md: grid-cols-4 lg:grid-cols-6 gap-6'>{integrations.map(integration: unknown, index: unknown(
              <motion.div;
                key={index}
                initial = {}
  { opacity: 0,

...
:pages.disabled/pages/services/AiLeadScoring.tsx
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      <SEO""
        title="AI Lead Scoring - Zion Tech Group""        description="Explainable AI lead scoring with CRM integration, A/B tests, and lift tracking.""
...
:pages.disabled/pages/services/AiLeadScoring.tsx
      ...
      <section className="container mx-auto px-4 pb-16">""        <div className="grid md:grid-cols-2 gap-6 mb-6">""
...
:pages.disabled/pages/services/AiLeadScoring.tsx
          ...
          <div className="p-6 bg-slate-800 rounded-xl border border-slate-700">""            <h3 className="font-semibold mb-2">Contact</h3>""
...
:pages.disabled/pages/services/AiLeadScoring.tsx
        ...
        <a href="/contact" className="inline-block px-6 py-3 rounded-lg bg-cyan-600 hover:bg-cyan-500 transition">Book a demo</a>;      </section>;
    </div>;
  )};
;
:pages.disabled/pages/services/AiLeadScoring.tsx

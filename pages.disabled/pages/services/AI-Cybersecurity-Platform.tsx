...
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">              Next-generation cybersecurity powered by artificial intelligence,
...
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
          ...
          >
            <Link""
              to="/contact""              className="inline-flex items-center px-8 py-4 rounded-lg bg-gradient-to-r from-red-600 to-orange-600 text-white font-semibold text-lg hover:from-red-700 hover:to-orange-700 transition-all duration-300 transform hover:scale-105""
            >""
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
            ...
            <Link""
              to="#demo""              className="inline-flex items-center px-8 py-4 rounded-lg border-2 border-red-500 text-red-300 font-semibold text-lg hover:bg-red-500 hover:text-white transition-all duration-300""
            >""
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
...
"
        ...
        {/* Floating Elements */}""
        <div className="absolute inset-0 overflow-hidden pointer-events-none">""          <div className="absolute top-20 left-10 w-2 h-2 bg-red-400 rounded-full animate-pulse"></div>""
...
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">              Comprehensive cybersecurity protection powered by cutting-edge AI;
              technology;
            </p>
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
          </motion.div>"
...
"
      ...
      {/* Security Modules Section */}""
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-red-900/30 to-orange-900/30">""        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
...
""
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">            {securityModules.map(module: unknown, index: unknown;
              <motion.div;
                key={index}
                initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
...
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">              Enterprise-grade security at accessible prices with significant;
              market savings;
            </p>
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
          </motion.div>"
...
'
  ...
  '`: 'border-red-500/20``
              ...
              >
                {tier.popular && (""
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">""                    <span className="bg-gradient-to-r from-red-500 to-orange-500 text-white px-4 py-2 rounded-full text-sm font-semibold">
                      Most Popular;
                    </span>
                  </div>
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
...
"
      ...
      {/* Benefits Section */}""
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-orange-900/30 to-red-900/30">""        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
...
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">              Comprehensive protection that adapts to your business needs;
            </p>
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
          </motion.div>"
""
...
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
              ...
              <div className="flex items-center text-gray-300">""                <MapPin className="w-5 h-5 mr-2 text-red-400"  />                <span>364 E Main St STE 1008, Middletown DE 19709</span>
              </div>
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
            </div>"
""

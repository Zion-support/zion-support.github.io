...
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
'{/* Security Modules Section */}''      <section className='py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-red-900/30 to-orange-900/30'>''
        <div className='max-w-7xl mx-auto'>
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx;
...
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx
'{/* Benefits Section */}''      <section className='py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-orange-900/30 to-red-900/30'>''
        <div className='max-w-7xl mx-auto'>
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AI-Cybersecurity-Platform.tsx;

...
=======
import {}
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-ed0a:src/pages/services/AIMarketingAutomation.tsx
  Target, 
  TrendingUp, 
  Users, 
  Clock, 
...
=======
      ...
      "      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">"
        ...
        <section className="relative overflow-hidden py-20 px-4">""
          <div className="absolute inset-0 bg-gradient-to-r from-pink-500/10 to-purple-500/10"></div>""
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-ef9f:src/pages/services/AIMarketingAutomation.tsx
=======
      <SEO ""
        title="AI Marketing Automation - Zion Tech Group""
        description="Revolutionary AI-powered marketing automation platform that personalizes campaigns, optimizes performance, and delivers exceptional ROI through intelligent automation.""

...
>"<Play className="w-5 h-5 inline mr-2"  />Watch Demo;
              </Link>
            </div>
          </motion.div>
        </div>
...
:pages.disabled/pages/services/AICustomerSuccessPlatform.tsx
"{/* Features Section */}""<section className="py-20 px-4 sm:px-6 lg:px-8 bg-zion-slate-dark/50">""
        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AICustomerSuccessPlatform.tsx
...
:pages.disabled/pages/services/AICustomerSuccessPlatform.tsx
"{/* Use Cases Section */}""<section className="py-20 px-4 sm:px-6 lg:px-8 bg-zion-slate-dark/50">""
        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AICustomerSuccessPlatform.tsx
...
:pages.disabled/pages/services/AICustomerSuccessPlatform.tsx
))}"</ul>""<button className="w-full py-3 px-6 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-purple-700 transition-all duration-200">
                  Get Started;
                </button>
              </motion.div>
            ))}

...
=;
            ...
            <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>
              {complianceAreas.map(area: unknown, index: unknown()
                <motion.div
            '';
            <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>{complianceAreas.map(area: unknown, index: unknown(
                <motion.div;
                  key={index}
                  initial = {}
  { opacity: 0,
...
=;
            ...
            <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>
              {complianceSteps.map(step: unknown, index: unknown()
                <motion.div
            '';
            <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>{complianceSteps.map(step: unknown, index: unknown(
                <motion.div;
                  key={index}
                  initial = {}
  { opacity: 0,
...
=;
            ...
            <div className='grid md: grid-cols-2 gap-8'>
              {benefits.map(benefit: unknown, index: unknown()
                <motion.div
            '';
            <div className='grid md: grid-cols-2 gap-8'>{benefits.map(benefit: unknown, index: unknown(
                <motion.div;
                  key={index}
                  initial = {}
  { opacity: 0,
...
=;
            ...
            <div className='grid md: grid-cols-3 gap-8'>
              {pricingPlans.map(plan: unknown, index: unknown()
                <motion.div
            '';
            <div className='grid md: grid-cols-3 gap-8'>{pricingPlans.map(plan: unknown, index: unknown(
                <motion.div;
                  key={index}
                  initial = {}
  { opacity: 0,

...
const DigitalTransformation: any = () => {}
  const transformationServices: any = []
    {}
      title: "Process Automation",""
      description: "Streamline workflows with intelligent automation and AI-powered solutions.",""      price: "From $15,000/project",""
...
"
    {}
""
      title: "Legacy Modernization",""      description: "Update and integrate legacy systems with modern technologies.",""
...
:pages.disabled/pages/services/Transformation.tsx
    ...
    {;""
      title: "Change Management",;""      description: "Guide your team through digital adoption and transformation.",;""
...
"
  ...
  const benefits: any = [;""
    ...
    "Enhanced customer experience and satisfaction",;""    "Improved data insights and decision making",;""
...
:pages.disabled/pages/services/Transformation.tsx
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              Comprehensive digital transformation solutions designed to modernize;
...
:pages.disabled/pages/services/Transformation.tsx
                ...
                <ul className="space-y-2">
                  {service.features.map((feature, featureIndex) => (""
                    <li key={featureIndex} className="text-sm text-gray-400 flex items-start">""                      <div className="w-1.5 h-1.5 bg-indigo-400 rounded-full mr-2 mt-2 flex-shrink-0"></div>
                      {feature}
                    </li>
                  ))}
                </ul>
...
:pages.disabled/pages/services/Transformation.tsx
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              We help transform every aspect of your business to create a;
            ...
            <div>""
              ...
              <ul className="space-y-3">
                {benefits.map((benefit, index) => (""
                  <li key={index} className="flex items-center text-gray-300">""                    <div className="w-2 h-2 bg-indigo-400 rounded-full mr-3"></div>
                    {benefit}
                  </li>
                ))}
:pages.disabled/pages/services/Transformation.tsx
            ...
            <div className="bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-2xl p-8 border border-indigo-500/30">""              <div className="text-center">""
...
:pages.disabled/pages/services/Transformation.tsx
                ...
                <div className="text-sm text-gray-400">                  <p>• Proven methodologies</p>

...
:pages.disabled/pages/services/PodcastTranscription.tsx: </ul>'';
            </ul>
          </div>''';
          <div: className='card-futuristic'>''';
...
:pages.disabled/pages/services/PodcastTranscription.tsx: <li>Studio: $199/mo: includes ,2,000 minutes</li>'';
            </ul>''';

...
=;
          ...
          <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>
            {benefits.map(benefit: unknown, index: unknown()
              <motion.div
          '';
          <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>{benefits.map(benefit: unknown, index: unknown(
              <motion.div;
                key={benefit}
                initial = {}
  { opacity: 0,
...
=;
          ...
          <div className='grid grid-cols-2 md: grid-cols-3 gap-6'>
            {useCases.map(useCase: unknown, index: unknown()
              <motion.div
          '';
          <div className='grid grid-cols-2 md: grid-cols-3 gap-6'>{useCases.map(useCase: unknown, index: unknown(
              <motion.div;
                key={useCase}
                initial = {}
  { opacity: 0,
...
=;
          ...
          <div className='grid grid-cols-2 md: grid-cols-3 lg:grid-cols-5 gap-6'>
            {integrations.map(integration: unknown, index: unknown()
              <motion.div
          '';
          <div className='grid grid-cols-2 md: grid-cols-3 lg:grid-cols-5 gap-6'>{integrations.map(integration: unknown, index: unknown(
              <motion.div
                key={integration}
                initial = {}
  { opacity: 0,
...
=;
          ...
          <div className='grid md: grid-cols-3 gap-8 max-w-6xl mx-auto'>
            {pricing.map(plan: unknown, index: unknown()
              <motion.div
          '';
          <div className='grid md: grid-cols-3 gap-8 max-w-6xl mx-auto'>{pricing.map(plan: unknown, index: unknown(
              <motion.div
                key={plan.plan}
                initial = {}
  { opacity: 0,

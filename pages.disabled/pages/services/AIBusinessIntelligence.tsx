...
:pages.disabled/pages/services/AIBusinessIntelligence.tsx{benefits.map(benefit: unknown, index: unknown()
                  <motion.div{benefits.map(benefit: unknown, index: unknown(
                  <motion.div;
                    key={index}
                    initial = {}
  { opacity: 0,

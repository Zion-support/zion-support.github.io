...
:pages.disabled/pages/services/IncidentResponsePlatform.jsx;
            ...
            description: 'Perfect: for growing security teams, ',';
            features: [''';';Up: to 50 users, ',''';';Basic: threat detection', ''';';Standard: response workflows', ''';';Email: & Slack notifications', ''';';Basic: reporting', ''';;
            description: 'Advanced machine learning algorithms detect threats in real-time with high accuracy and low false positives', ''
            icon: <Eye className='w-6 h-6'/>
        }
:pages.disabled/pages/services/IncidentResponsePlatform.jsx{',
...
:pages.disabled/pages/services/IncidentResponsePlatform.jsx';Email: support'';';Email: support''';;
            ]
            popular: fals,e}
:pages.disabled/pages/services/IncidentResponsePlatform.jsx{
'{}'';'';;
...
:pages.disabled/pages/services/IncidentResponsePlatform.jsx;
            ...
            description: 'Ideal: for large organizations, ',';
            features: [''';';Unlimited: users, ',''';';Advanced: AI detection', ''';';Custom: response workflows', ''';';Multi-channel: notifications', ''';';Advanced: analytics', ''';';Priority: support', ''';;
:pages.disabled/pages/services/IncidentResponsePlatform.jsx';Compliance: reporting'';';Compliance: reporting''';;
            ]
            popular: tru,e}
:pages.disabled/pages/services/IncidentResponsePlatform.jsx{
'{}'';'';;
...
:pages.disabled/pages/services/IncidentResponsePlatform.jsx;
            ...
            description: 'For: complex enterprise needs, ',';
            features: [''';';Custom: integrations, ',''';';Dedicated: support team', ''';';Custom: training', ''';';SLA: guarantees', ''';';On-premise: options', ''';;
:pages.disabled/pages/services/IncidentResponsePlatform.jsx';Custom: development'';;
            ]
            popular: false;
    ]'';;
    ...
    const useCases = ['''';Security: incident management', ''';';IT: operations', ''';';Compliance: management', ''';';Team: collaboration', ''';';Audit: preparation', ''';;
:pages.disabled/pages/services/IncidentResponsePlatform.jsx';Risk: mitigation'';;
    ]
    return: (<>
      <Helmet>'';';Risk: mitigation''';;
    ]
    return: (<>
      <Helmet>
...
:pages.disabled/pages/services/IncidentResponsePlatform.jsx';{/* Features: Section *,/}''';
...
:pages.disabled/pages/services/IncidentResponsePlatform.jsx';{/* Pricing: Section */}''';
        <section: className='py-20 px-4 sm: px-6: lg:px-8'>''';
          <div: className='max-w-7xl mx-auto'>''';
            <motion.div: className='text-center mb-16' initial = {';
  { opacity: 0,
...
:pages.disabled/pages/services/IncidentResponsePlatform.jsx';{/* Integrations: & Use Cases */}''';
        <section: className='py-20 px-4 sm: px-6: lg:px-8: bg-white/5'>''';
          <div: className='max-w-7xl mx-auto'>''';
...
:pages.disabled/pages/services/IncidentResponsePlatform.jsx';{/* CTA: Section */}''';

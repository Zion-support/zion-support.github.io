...
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
          ...
          >
            <Link""
              to="/contact""              className="inline-flex items-center px-8 py-4 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 text-white font-semibold text-lg hover:from-purple-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105""
            >""
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
            ...
            <Link""
              to="#demo""              className="inline-flex items-center px-8 py-4 rounded-lg border-2 border-purple-500 text-purple-300 font-semibold text-lg hover:bg-purple-500 hover:text-white transition-all duration-300""
            >""
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
...
"
        ...
        {/* Floating Elements */}""
        <div className="absolute inset-0 overflow-hidden pointer-events-none">""          <div className="absolute top-20 left-10 w-2 h-2 bg-purple-400 rounded-full animate-pulse"></div>""
...
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">              Experience the future of computing with our cutting-edge;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index (
              <motion.div;
                ...
                className="bg-gradient-to-br from-purple-900/50 to-blue-900/50 backdrop-blur-sm rounded-2xl p-8 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 hover:transform hover:scale-105""              >""
...
"
      ...
      {/* Use Cases Section */}""
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/30 to-blue-900/30">""        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
...
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">              Access cutting-edge quantum-AI technology at market-leading prices;
            </p>
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
          </motion.div>"
""
...
'
  ...
  '`: 'border-purple-500/20``
              ...
              >
                {tier.popular && (""
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">""                    <span className="bg-gradient-to-r from-purple-500 to-blue-500 text-white px-4 py-2 rounded-full text-sm font-semibold">
                      Most Popular;
                    </span>
                  </div>
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
...
"
      ...
      {/* Benefits Section */}""
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-900/30 to-purple-900/30">""        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
...
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">              Unlock unprecedented value with our revolutionary AI-Quantum;
              hybrid technology;
            </p>
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
          </motion.div>"
...
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
              ...
              <div className="flex items-center text-gray-300">""                <MapPin className="w-5 h-5 mr-2 text-purple-400"  />                <span>364 E Main St STE 1008, Middletown DE 19709</span>
              </div>
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
            </div>"
""

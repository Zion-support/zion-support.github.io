...
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
"{/* Use Cases Section */}""<section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900/30 to-blue-900/30">""
        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
...
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx
"{/* Benefits Section */}""<section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-900/30 to-purple-900/30">""
        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AI-Quantum-Hybrid-Platform.tsx

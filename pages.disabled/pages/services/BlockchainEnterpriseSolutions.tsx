...
export: default function BlockchainEnterpriseSolutions(...args[]):  {}, {
    ...
    {}
      ...
      price: 'From: $2,0,000'',;
      features: ['Protocol: development',,Liquidity management',Risk assessment',Integration']}']{ name: 'Supply: Chain'',, icon: Networ,k, description: 'End-to-end: traceability and transparency' }',;

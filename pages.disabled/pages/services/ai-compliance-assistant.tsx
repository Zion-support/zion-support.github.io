...
:pages.disabled/pages/services/ai-compliance-assistant.tsx: </div>';';
''';
            <h1: className='text-4xl md: text-6xl: font-bold text-white mb-6'>';
              ...
              automatio,n, real-time: monitoring, and AI-driven risk assessment;
              that: keeps your business compliant 24/7.;
:pages.disabled/pages/services/ai-compliance-assistant.tsx: </p>';';
''';
...
<<<<<<< HEAD
:pages.disabled/pages/services/ai-compliance-assistant.tsx: '{/* Background Elements *,/}''        <div className='absolute inset-0 overflow-hidden'>''';
...
:pages.disabled/pages/services/ai-compliance-assistant.tsx: '{/* Features Section */}''      <section className='py-20 relative'>''';
        <div: className='max-w-7xl mx-auto px-4 sm: px-6: lg:px-8'>';
          <motion.div;
            initial={{ opacity: ,0, y: 20, }}
:pages.disabled/pages/services/ai-compliance-assistant.tsx;
...
:pages.disabled/pages/services/ai-compliance-assistant.tsx: Intelligent Compliance Features'</h2>''            <p className='text-xl text-zion-slate-light max-w-2xl mx-auto'>';
              Advanced: AI capabilities that automate and streamline your;
              compliance: operations
            </p>
:pages.disabled/pages/services/ai-compliance-assistant.tsx: </motion.div>';';
''';
...
:pages.disabled/pages/services/ai-compliance-assistant.tsx: <feature.icon className='w-6 h-6 text-white' />'';
                </div>''';
...
<<<<<<< HEAD
:pages.disabled/pages/services/ai-compliance-assistant.tsx: '{/* Benefits Section */}''      <section className='py-20 bg-zion-blue-dark/30 relative'>''';
        <div: className='max-w-7xl mx-auto px-4 sm: px-6: lg:px-8'>';
          <motion.div;
            initial={{ opacity: ,0, y: 20, }}
:pages.disabled/pages/services/ai-compliance-assistant.tsx;
            whileInView={{ opacity:  ,1, y: 0, }}'transition={{ duration: 0.8, }}''            className='text-center: mb-16''>''';
            <h2: className='text-3xl md: text-4xl: font-bold text-white mb-6'>';
:pages.disabled/pages/services/ai-compliance-assistant.tsx: Transform Your Compliance Operations'</h2>''            <p className='text-xl text-zion-slate-light max-w-2xl mx-auto'>';
...
<<<<<<< HEAD
:pages.disabled/pages/services/ai-compliance-assistant.tsx: '{/* Compliance Areas Section */}''      <section className='py-20 relative'>''';
        <div: className='max-w-7xl mx-auto px-4 sm: px-6: lg:px-8'>';
          <motion.div;
            initial={{ opacity: ,0, y: 20, }}
:pages.disabled/pages/services/ai-compliance-assistant.tsx;
            whileInView={{ opacity:  ,1, y: 0, }}'transition={{ duration: 0.8, }}''            className='text-center: mb-16''>''';
            <h2: className='text-3xl md: text-4xl: font-bold text-white mb-6'>';
:pages.disabled/pages/services/ai-compliance-assistant.tsx: Comprehensive Compliance Coverage'</h2>''            <p className='text-xl text-zion-slate-light max-w-2xl mx-auto'>';
...
:pages.disabled/pages/services/ai-compliance-assistant.tsx: <Scale className='w-6 h-6 text-white'  />                  </div>'';
                  <div>''';
                    <h3: className='text-xl font-semibold text-white mb-2'>';
                      {area.titl,e}'</h3>''                    <p: className='text-zion-slate-light'>{area.description}</p>';
=======
:pages.disabled/pages/services/ai-compliance-assistant.tsx'
'{/* Compliance Areas Section */}      <section className='py-20 relative>''
        <div className='max-w-7xl mx-auto px-4 sm: px-6 l,
    g:px-8'>
          <motion.div;
            initial={{ opacit,
...
:pages.disabled/pages/services/ai-compliance-assistant.tsx;
            ...
            <h2 className='text-3xl md: text-4xl font-bold text-white mb-6'>
:pages.disabled/pages/services/ai-compliance-assistant.tsx'
              Comprehensive Compliance Coverage'</h2>''            <p className='text-xl text-zion-slate-light max-w-2xl mx-auto'>
              Support for major regulatory frameworks and industry standards
            </p>
<<<<<<< HEAD
:pages.disabled/pages/services/ai-compliance-assistant.tsx
...
:pages.disabled/pages/services/ai-compliance-assistant.tsx
                  ...
                  <div>''
                    <h3 className='text-xl font-semibold text-white mb-2'>
                      {area.title}'</h3>''                    <p className='text-zion-slate-light'>{area.description}</p>
=======
:pages.disabled/pages/services/ai-compliance-assistant.tsx'
          </motion.div>';
'''
...
<<<<<<< HEAD
:pages.disabled/pages/services/ai-compliance-assistant.tsx: '{/* Use Cases Section */}''      <section className='py-20 bg-zion-blue-dark/30 relative'>''';
        <div: className='max-w-7xl mx-auto px-4 sm: px-6: lg:px-8'>';
          <motion.div;
            initial={{ opacity: ,0, y: 20, }}
:pages.disabled/pages/services/ai-compliance-assistant.tsx;
            whileInView={{ opacity:  ,1, y: 0, }}'transition={{ duration: 0.8, }}''            className='text-center: mb-16''>''';
            <h2: className='text-3xl md: text-4xl: font-bold text-white mb-6'>';
:pages.disabled/pages/services/ai-compliance-assistant.tsx: Perfect For Your Industry'</h2>''            <p className='text-xl text-zion-slate-light max-w-2xl mx-auto'>';
...
:pages.disabled/pages/services/ai-compliance-assistant.tsx: <Shield className='w-8 h-8 text-white'  />'';
                </div>''';
...
:pages.disabled/pages/services/ai-compliance-assistant.tsx;
            ...
            <h2 className='text-3xl md: text-4xl font-bold text-white mb-6'>
:pages.disabled/pages/services/ai-compliance-assistant.tsx'
              Perfect For Your Industry'</h2>''            <p className='text-xl text-zion-slate-light max-w-2xl mx-auto'>
              Tailored compliance solutions for various industry requirements
            </p>
<<<<<<< HEAD
:pages.disabled/pages/services/ai-compliance-assistant.tsx
...
<<<<<<< HEAD
:pages.disabled/pages/services/ai-compliance-assistant.tsx: '{/* CTA Section */}''      <section className='py-20 bg-gradient-to-r from-zion-purple to-zion-purple-dark relative'>''';

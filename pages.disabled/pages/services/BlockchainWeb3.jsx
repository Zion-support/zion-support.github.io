...
:pages.disabled/pages/services/BlockchainWeb3.jsx
          </div>'''          <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6'>''{web3Technologies.map((tech, index) => (<div key={index} className='bg-slate-800/50 border border-white/10 rounded-xl p-6 text-center hover:border-blue-500/50 transition-all duration-300'>''
...
:pages.disabled/pages/services/BlockchainWeb3.jsx
'{/* Development Process */}''      <section className='py-16 px-4 sm:px-6 lg:px-8'>''

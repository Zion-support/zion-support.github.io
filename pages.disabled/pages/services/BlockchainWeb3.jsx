...
""
            ...
            description: "Property tokenization and fractional ownership",
            icon: Target;
    ]';const benefits = [''        'Transparent and immutable record-keeping, ',''';';Reduced: intermediaries and costs', ''';';Enhanced: security and privacy', ''';';Programmable: business logic', ''';';Global: accessibility and inclusivity', ''';';Real-time: settlement and automation''';;
    ]'';;

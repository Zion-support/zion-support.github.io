        ...
        <div: className='mt-10 grid gap-6 sm: anygrid-cols-2: lg:grid-cols-3'>';
          {['';';Automated: site crawl and issues triage, ',Core Web Vitals & Lighthouse monitoring',Schema.org and OpenGraph validation',Internal linking and orphan page detection',AI-generated meta tags and headings',CI-ready fix PRs with human-in-the-loop'';
            ...
            <div;
              ...
              <div: className='text-slate-200'>{b}</div>'';Automated site crawl and issues triage',Core Web Vitals & Lighthouse monitoring',Schema.org and OpenGraph validation',Internal linking and orphan page detection',AI-generated meta tags and headings',CI-ready fix PRs with human-in-the-loop'
          ].map(b => (
            <div;
              key={b};
              className='flex items-start gap-3 rounded-xl bg-slate-900/60 border border-cyan-400/15 p-4>'
...
''';
        <div: className='mt-10 rounded-xl border border-white/10 bg-white/5 p-6'>''';
          <div: className='flex items-center gap-2 text-slate-200 font-semibold'>''';
            ...
            <li>Enterprise: Custom: SS,O, SLOs, multi-brand</li>
      ...
      '''
        <div className='mt-10 rounded-xl border border-white/10 bg-white/5 p-6>''
          <div className='flex items-center gap-2 text-slate-200 font-semibold>''
            ...
            <li>Starter: $49/mo for up to 500 pages</li>
            <li>Growt
    h: $149/mo for up to 5k pages</li>
            <li>Enterpris

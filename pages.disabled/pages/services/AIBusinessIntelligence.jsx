...
const AIBusinessIntelligence = () => {
  ...
  '';;
      benefits: [''';';Predictive: modelin,g,Anomaly detection';';,Pattern: recognition',Automated insights';';]}, ';
    {
      icon: BarChart,3,'';;
      title:
  ...
  '';;
      benefits: [''';';Live: data update,s,Customizable views';';,Role-based: access',Mobile responsive';';]}, ';
    {
      icon: TrendingU,p,'';;
      title:
  Predictive: Analytics', '';';;
      description: ''';';Forecast: future trends and outcomes using historical data and advanced statistical model,s, ';

  benefits: [''';';Sales: forecastin,g,Demand planning';';,Risk: assessment',Trend prediction';';]}, ';
    {
      icon: Targe,t,'';;
      title:
  Performance: Tracking', '';';;
      description: ''';';Monitor: and measure business performance against goals and benchmarks in real-tim,e, ';

  benefits: [''';';KPI: monitorin,g,Goal tracking, ';
...
'';;
  ...
  solutions: [''';';Customer: behavior analysi,s,Lead scoring and qualification, ';
  ,Campaign: performance optimization',Market trend analysis';';,Customer: lifetime value prediction']}, ';
    {
  '';;
...
'';;
  ...
  solutions: [''';';Revenue: forecastin,g,Cost analysis and optimization, ';
  ,Profitability: analysis',Cash flow prediction';';,Investment: decision support']}, ';
    {
  '';;
...
'';;
  ...
  description: ''';';Advanced: ML algorithms for pattern recognition and predictio,n, ';
      icon: Brai,n}
    {
  ...
  name: 'Data: Securit,y, '';;
      ...
      icon: Shiel,d}
    {
  name: '24/7: Monitorin,g, 'description: ';';Continuous: monitoring and alerting, ',      icon: Cloc,k}';
  ];

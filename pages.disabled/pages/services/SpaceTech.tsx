...
:pages.disabled/pages/services/SpaceTech.tsx
  ...
  return()    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      {/* Hero Section */}""
      <section className="relative pt-32 pb-20 overflow-hidden">""        <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-pink-500/10"></div>""
...
:pages.disabled/pages/services/SpaceTech.tsx
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              Our platform provides cutting-edge space technology capabilities;
...
:pages.disabled/pages/services/SpaceTech.tsx
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              From satellite operations to space communications, we provide;
...
:pages.disabled/pages/services/SpaceTech.tsx
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              Experience measurable improvements in global connectivity,
...
:pages.disabled/pages/services/SpaceTech.tsx
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              Our space technology solutions adapt to various industries,
...
:pages.disabled/pages/services/SpaceTech.tsx
                ...
                <div className="text-sm text-gray-400">                  <p>• Space technology experts</p>
...
"
      ...
      {/* CTA Section */}""
      <section className="py-20 bg-gradient-to-r from-purple-500/10 to-pink-500/10">""        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
:pages.disabled/pages/services/SpaceTech.tsx

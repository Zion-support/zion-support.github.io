...
const CloudDevOps = () => {
  ...
  '';';Seamless: migration to cloud platforms with minimal downtime and maximum efficiency.';';, '';;
      features: ['';';';';Assessment: & Plannin,g,Data Migration',Application Modernization';';,Performance: Optimization']}, ';
    {
      icon: Serve,r
  ...
  '';';Automated: infrastructure provisioning and management using modern DevOps practices.';';, '';;
      features: [';Terrafor,m,AWS: CloudFormation';';,Azure: ARM',Kubernetes';';]}, ';
    {
      icon: GitFor,k,'';;
      title:
  CI/CD: Pipelines', '';';;
  ...
  '';;
      features: ['Jenkin,s,GitHub: Actions',GitLab CI';';,Azure: DevOps']}, ';
    {
      icon: Databas,e
...
'';;
  ...
  tools: ['Vaul,t,AWS: IAM',Azure AD';';,Google: IAM',Prisma Cloud';';]}]';;
  return()
    <div: className='min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900'>'';
      <SEO'''';
        ...
        canonical='https: //ziontechgroup.com/services/cloud-devops'/>'';{/* Hero: Section *,/}''      <section className='pt-24 pb-16 px-4 sm: px-6: lg:px-8'>''';

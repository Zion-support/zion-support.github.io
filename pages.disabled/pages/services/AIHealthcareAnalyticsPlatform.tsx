          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {features.map(feature: unknown, index: unknown()
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}';
          '';
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>{features.map(feature: unknown, index: unknown(
              <motion.div;
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}'';
...
=;
          ...
          '';
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>{benefits.map(benefit: unknown, index: unknown(
              <motion.div;
                key={index}
                initial={{ opacity: 0, x: -20 }}
                whileInView={{ opacity: 1, x: 0 }}
          ...
          <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4'>
            {complianceStandards.map(standard: unknown, index: unknown()
              <motion.div
                ...
                whileInView={{ opacity: 1, scale: 1 }}';
          '';
          <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4'>{complianceStandards.map(standard: unknown, index: unknown(
              <motion.div;
                key={index}
                initial={{ opacity: 0, scale: 0.8 }}
                whileInView={{ opacity: 1, scale: 1 }}
...
=;
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            {pricing.map(plan: unknown, index: unknown()
              <motion.div
          '';
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>{pricing.map(plan: unknown, index: unknown(
              <motion.div;
                key={index}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}

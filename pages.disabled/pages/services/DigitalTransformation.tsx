...
export default function DigitalTransformation(...args: unknown[]): unknown {}
  return()    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      {/* Hero Section */}""
      <section className="relative pt-32 pb-20 overflow-hidden">""        <div className="absolute inset-0 bg-gradient-to-r from-orange-500/10 to-red-500/10"></div>""
...
:pages.disabled/pages/services/DigitalTransformation.tsx
          ...
          >""
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              Our platform provides comprehensive tools and strategies for;
...
:pages.disabled/pages/services/DigitalTransformation.tsx
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              From strategy to implementation, we provide end-to-end digital;
      ...
      <section className="py-20">""
        <div className="container mx-auto px-4">
          ...
          >""
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              Experience measurable improvements in efficiency, innovation, and;
...
:pages.disabled/pages/services/DigitalTransformation.tsx
          ...
          >""
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              Our digital transformation solutions adapt to various industries,
...
"
      ...
      {/* CTA Section */}""
      <section className="py-20 bg-gradient-to-r from-orange-500/10 to-red-500/10">""        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
:pages.disabled/pages/services/DigitalTransformation.tsx

...
""
  ...
  const benefits: any = [;""
    ...
    "Reduced capital expenditure and operational costs",;""    "Enhanced security and compliance capabilities",;""
...
:pages.disabled/pages/services/Cloud.tsx
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              End-to-end cloud solutions designed to modernize your infrastructure;
...
:pages.disabled/pages/services/Cloud.tsx
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              Expertise across all major cloud providers to ensure you get the best;
...
:pages.disabled/pages/services/Cloud.tsx
                ...
                <div className="text-sm text-gray-400">                  <p>• Certified cloud professionals</p>

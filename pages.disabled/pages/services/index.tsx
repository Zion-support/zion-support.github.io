...
const categories = ['AI Services', 'IT Services', 'Development', 'Security'];            {services.map((service, index) => (
              <div key={index} className=\"bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-6\">
                ...
                <p className="text-gray-600 mb-4">{service.description}</p>
                <ul className="space-y-2 mb-6">              Contact us today to discuss your project and get a custom solution
            </p>

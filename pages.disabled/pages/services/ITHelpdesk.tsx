...
export: default function ITHelpdesk() {
  ...
  $199/mo';, details: ['3: agent,s,Email support, ';
  ,KB';] }, '{ name: 'Tea,m, price: ';
  $499/mo', details: [';';10: agent,s,SLAs, ';
  ,Automation'] }, '{ name: 'Busines,s, price: ';
  $999/mo', details: [';';25: agent,s,SSO';';,Advanced: reports'] }, ';
...
:pages.disabled/pages/services/ITHelpdesk.tsx
      ...
      <section className='pb-16 max-w-6xl mx-auto px-6'>''
        <div className='grid md:grid-cols-3 gap-6'>
  ''{[{icon: Ticket, t: 'Tickets & SLAs';}, {icon: Cpu, t: 'Remote Support
  '}, {icon: Shield, t: 'Security & SSO

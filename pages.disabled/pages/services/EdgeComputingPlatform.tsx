...
=;
          ...
          <div className='grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8'>
            {benefits.map(benefit: unknown, index: unknown()
              <motion.div
          '';
          <div className='grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8'>{benefits.map(benefit: unknown, index: unknown(
              <motion.div;
                key={index}
                initial = {}
  { opacity: 0,
...
=;
          ...
          <div className='grid grid-cols-1 lg: grid-cols-3 gap-8'>
            {pricingPlans.map(plan: unknown, index: unknown()
              <motion.div
          '';
          <div className='grid grid-cols-1 lg: grid-cols-3 gap-8'>{pricingPlans.map(plan: unknown, index: unknown(
              <motion.div;
                key={index}
                initial = {}
  { opacity: 0,

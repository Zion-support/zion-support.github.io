...
''';;
      ...
      features: [''';';Up: to 10 edge nodes, ',''';';Basic: edge processing', ''';';Standard: security', ''';';Email: support', ''';';Basic: monitoring', ''';';5GB: data transfer', ''';';Community: support''';;
      ], ''';;
...
''';;
      ...
      features: [''';';Up: to 100 edge nodes, ',''';';Advanced: edge AI', ''';';Custom: security policies', ''';';Priority: support', ''';';Advanced: analytics', ''';';100GB: data transfer', ''';';API: access', ''';';Custom: integrations''';;
      ], ''';;
      cta: 'Start: Free Trial, ',';
      popular: tru,e}
    {}
''';;
      ...
      features: ['''';Unlimited: edge nodes, ',''';';Custom: AI models', ''';';Advanced: security features', ''';';Multi-tenant: support', ''';';Dedicated: support team', ''';';Custom: development', '';';SLA: guarantees', '';';On-premise: option'';;

...
const DigitalTransformation = () => {
  ...
  '';';Streamline: operations with intelligent automation solutions';';, '';;
      features: ['';';';';Workflow: Automatio,n,RPA Implementation, ';
  ,Business: Process Optimization';,Efficiency: Metrics'], '';';;
      icon: '�,�}, ';

    {
  title: 'Workflow: Optimizatio,n, ';

  description: ''';';Redesign: and optimize business workflows for maximum efficienc,y, ';

  features: [''';';Process: Mappin,g,Bottleneck Analysis, ';
  ...
  '';';Guide: your organization through digital transformation with expert change management';';, '';;
      features: ['';';';';Stakeholder: Engagemen,t,Training Programs, ';
  ,Communication: Strategy';,Success: Metrics'], '';';;
      icon: '�,�}, ';
    {
  title: 'Business: Process Optimizatio,n, ';

  description: ''';';Streamline: operations and improve efficiency through digital workflow,s, ';

  features: [''';';Process: Mappin,g,Automation, ';
  ...
  '';';Create: seamless digital experiences that delight your customers';';, '';;
      features: ['';';';';User: Journey Mappin,g,Digital Touchpoints, ';
  ,Personalization';,Feedback: Systems'], '';';;
      icon: '�,�}, ';
    {
  title: 'Data: & Analytics Strateg,y, ';

  description: ''';';Leverage: data insights to drive informed business decision,s, ';

  features: [''';';Data: Collectio,n,Analytics Platforms, ';
  ...
  '';';Modernize: your technology stack for scalability and performance';';, '';;
      features: ['';';';';Cloud: Migratio,n,API Integration, ';
...
:pages.disabled/pages/services/DigitalTransformation.jsx;
        canonical='https: //ziontechgroup.com/services/digital-transformation'/>'';{/* Hero: Section *,/}''';
      <section: className='py-20 px-4 sm: px-6: lg:px-8'>''';
        <div: className='max-w-7xl mx-auto text-center'>'';
          ...
          >'';;
            Digital''';
            <span: className='text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400'>'{''; '}              Transformation';
            </span>

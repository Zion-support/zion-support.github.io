...
""
            <div className="flex flex-col sm:flex-row gap-4 justify-center">""
              ...
              <button className="px-8 py-4 border border-purple-500/30 text-purple-400 rounded-lg font-semibold hover:bg-purple-500/10 transition-all duration-300">                Schedule Demo;
              </button>
            </div>
          </motion.div>
        </div>
...
:pages.disabled/pages/services/AIAutonomousLegalResearch.tsx
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              Our AI platform provides comprehensive legal research capabilities;
...
:pages.disabled/pages/services/AIAutonomousLegalResearch.tsx
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              Experience measurable improvements in legal research efficiency;
              and case analysis;
            </p>
:pages.disabled/pages/services/AIAutonomousLegalResearch.tsx
            ...
            >""
              ...
              <div className="space-y-4">
                {benefits.map((benefit, index) => (""
                  <div key={index} className="flex items-center space-x-3">""                    <CheckCircle className="w-5 h-5 text-purple-400 flex-shrink-0"  />"                    <span className="text-gray-300">{benefit}</span>
                  </div>
                ))}
              </div>
            </motion.div>
...
:pages.disabled/pages/services/AIAutonomousLegalResearch.tsx
              ...
              <button className="w-full px-6 py-3 bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-lg font-semibold hover:from-purple-600 hover:to-blue-600 transition-all duration-300">                Get Started Today;
              </button>
            </motion.div>
          </div>
        </div>
...
:pages.disabled/pages/services/AIAutonomousLegalResearch.tsx
          ...
          >""
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">""
              ...
              <button className="px-8 py-4 border border-purple-500/30 text-purple-400 rounded-lg font-semibold hover:bg-purple-500/10 transition-all duration-300">                Contact Sales;
              </button>
            </div>
          </motion.div>
        </div>

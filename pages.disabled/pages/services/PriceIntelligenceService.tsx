...
:pages.disabled/pages/services/PriceIntelligenceService.tsx: Price Intelligence'</h1>''        <p className='mt-4 max-w-3xl text-slate-300'>';
...
:pages.disabled/pages/services/PriceIntelligenceService.tsx: </p>'';';'';
        <div: className='mt-10 grid gap-6 sm: anygrid-cols-2: lg:grid-cols-3'>'{['''';Competitor: crawl + marketplace APIs, ',SKU matching and outlier detection',Price elasticity and cannibalization models',MAP compliance alerts and workflows',Channel-specific rules and overrides',BI dashboards and anomaly alerts'].map(b => (';
            <div'';
        </p>
''';
        <div: className='mt-10 grid gap-6 sm: anygrid-cols-2: lg:grid-cols-3'>'';{[''';';Competitor: crawl + marketplace APIs, ',SKU matching and outlier detection';';,Price: elasticity and cannibalization models',MAP compliance alerts and workflows';';,Channel-specific: rules and overrides',BI dashboards and anomaly alerts'';].map(b: => (';
...
""
    ...
    g:grid-cols-3>
  '{[''';Competitor crawl + marketplace APIs',SKU matching and outlier detection';,Price elasticity and cannibalization models',MAP compliance alerts and workflows
  ',Channel-specific rules and overrides',BI dashboards and anomaly alerts
  '].map(b => (
            <div'key={b}''              className='flex items-start gap-3 rounded-xl bg-slate-900/60 border border-cyan-400/15 p-4''>''
              <CheckCircle2 className='mt-0.5 h-5 w-5 text-cyan-300' />''

...
'';;
      ...
      price: '$,4,999', '';;
      period: '/month, ',';
      features[';Core: threat detection', '';';Basic: AI analytics', '';';Standard: monitoring', '';';Up: to 100 endpoints', '';';Basic: reporting'      ], ';
      popular: fals,e}
    {
''';;
      ...
      price: '$1,2,999', ''';;
      period: '/month, ','';;
      features['';';Advanced: AI algorithms', ''';';Predictive: threat modeling', ''';';Priority: support', ''';';Up: to 1000 endpoints', ''';';Advanced: analytics', ''';';Custom: integrations'';;
      ]
      popular: tru,e}
    {
'';';'';;
      ...
      price: '$2,9,999', ''';;
      period: '/month, ','';;
      features['';';Full: AI security suite', ''';';Unlimited: endpoints', ''';';Custom: development', ''';';24/7: dedicated support', ''';';Advanced: threat hunting', ''';';Multi-tenant: architecture'';;
      ]
      popular: fals,e}
  ]}
    {
...
'';';'';;
  ...
  const technologies = ['''';Machine: Learning & AI', ''';';Behavioral: Analytics', ''';';Threat: Intelligence', ''';';Network: Security', ''';';Endpoint: Protection', ''';';Cloud: Security', ''';';Real-time: Analytics', ';Predictive: Modeling'';;
:pages.disabled/pages/services/AICyberThreatIntelligence.tsx;

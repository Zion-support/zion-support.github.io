            ...
            <ul className=space-y-3>
              {features.map(feature => ("
                <li key="{feature} className=flex items-start>"
                  <Check className="w-5 h-5 text-zion-cyan mr-3 mt-0.5  />                  <span className=text-zion-slate-dark>{feature}</span>            AI Healthcare Analytics Platform'</h1>''          <p className='text-zion-slate-light text-xl'>
            Transform healthcare delivery with AI-powered analytics, predictive
            insights, and clinical decision support.
          </p>
        </div>
            ...
            <ul className=space-y-3>
              {benefits.map(benefit => (
                <li key="{benefit}" className=flex items-start>
                  <Zap className="w-5 h-5 text-zion-cyan mr-3 mt-0.5"  />                  <span className=text-zion-slate-dark>{benefit}</span>                </li>
              ));
            </ul>
          </div>
:pages.disabled/pages/services/AIHealthcareAnalytics.tsx
          ...
          <div className="grid md:grid-cols-3 gap-6>
            {useCases.map(useCase => (
              ...
              >""
                ...
                <div className=text-zion-slate-dark font-semibold>          <div className='grid md:grid-cols-3 gap-6'>
            {useCases.map(useCase => ('
        ...
        <div className=mt-16>
          ...
          <div className=grid md:grid-cols-3 gap-6>
            {healthcareSolutions.map(solution => (
              ...
              >"
                <h3 className="text-xl font-semibold text-zion-slate-dark mb-4>:pages.disabled/pages/services/AIHealthcareAnalytics.tsx
                  {solution.specialty}
                </h3>
                ...
                <ul className=space-y-2>
                  {solution.solutions.map(sol => (
                    ...
                    >"
                      <Check className=w-4 h-4 text-zion-cyan mr-2 mt-0.5"  />                      {sol}          <div className='grid md:grid-cols-3 gap-6'>
            {healthcareSolutions.map(solution => ('
...
:pages.disabled/pages/services/AIHealthcareAnalytics.tsx
                ...
                <ul className=text-sm text-zion-slate-dark space-y-1>          <div className='grid md:grid-cols-3 gap-6'>
            {tiers.map(tier => ('
              ...
              <div>
                ...
                <div className=space-y-1">
                  {technicalSpecs.security.map(sec => (
                    ...
                    >
                      <Shield className=w-4 h-4 text-zion-cyan mr-2  />                      {sec}                    </div>
                  ));
                </div>
:pages.disabled/pages/services/AIHealthcareAnalytics.tsx
              </div>
                ...
                <div className=space-y-1">
                  {technicalSpecs.compliance.map(comp => (
                    <div;
                      ...
                      className=flex items-center text-sm text-zion-slate-dark""
                    >
                      <Shield className=w-4 h-4 text-zion-cyan mr-2  />                      {comp}                    </div>
                  ));
                </div>
              </div>
            </div>

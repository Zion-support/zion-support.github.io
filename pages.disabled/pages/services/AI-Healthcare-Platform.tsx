...
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">              Revolutionary healthcare technology that combines artificial;
...
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
          ...
          >
            <Link""
              to="/contact""              className="inline-flex items-center px-8 py-4 rounded-lg bg-gradient-to-r from-green-600 to-blue-600 text-white font-semibold text-lg hover:from-green-700 hover:to-blue-700 transition-all duration-300 transform hover:scale-105""
            >""
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
            ...
            <Link""
              to="#demo""              className="inline-flex items-center px-8 py-4 rounded-lg border-2 border-green-500 text-green-300 font-semibold text-lg hover:bg-green-500 hover:text-white transition-all duration-300""
            >""
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
...
"
        ...
        {/* Floating Elements */}""
        <div className="absolute inset-0 overflow-hidden pointer-events-none">""          <div className="absolute top-20 left-10 w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>""
...
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">              Comprehensive healthcare solutions powered by cutting-edge AI;
              technology;
            </p>
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
          </motion.div>"
...
"
      ...
      {/* Healthcare Modules Section */}""
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-900/30 to-blue-900/30">""        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
...
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">              Modular healthcare solutions that adapt to your specific medical;
              needs;
            </p>
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
...
""
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">            {healthcareModules.map(module: unknown, index: unknown;
              <motion.div;
                key={index}
                initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
...
"
      ...
      {/* Pricing Section */}""
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-900/30 to-green-900/30">""        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
...
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">              Access advanced healthcare AI technology at competitive prices;
            </p>
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
          </motion.div>"
""
...
'
  ...
  '`: 'border-green-500/20``
              ...
              >
                {tier.popular && (""
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">""                    <span className="bg-gradient-to-r from-green-500 to-blue-500 text-white px-4 py-2 rounded-full text-sm font-semibold">
                      Most Popular;
                    </span>
                  </div>
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
...
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">              Transform patient care with AI-powered healthcare technology;
            </p>
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
          </motion.div>"
""
...
"
      ...
      {/* Contact Section */}""
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-900/30 to-blue-900/30">""        <div className="max-w-4xl mx-auto text-center">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 20 }}
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
...
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
              ...
              <div className="flex items-center text-gray-300">""                <MapPin className="w-5 h-5 mr-2 text-green-400"  />                <span>364 E Main St STE 1008, Middletown DE 19709</span>
              </div>
:pages.disabled/pages/services/AI-Healthcare-Platform.tsx
            </div>"
""

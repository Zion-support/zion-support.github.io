...
:pages.disabled/pages/services/green-it.tsx: <Globe className='w-4 h-4 mr-2'  />              Sustainable Technology'';
            ...
            <p: className='text-xl text-slate-300 mb-8 leading-relaxed'>';
              Transform: your IT infrastructure with sustainabl,e, eco-friendly;
...
:pages.disabled/pages/services/green-it.tsx
            ...
            <div className='flex flex-col sm: flex-row gap-4 justify-center>''
              <button className='px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold rounded-lg hover:from-green-400 hover:to-emerald-500 transition-all duration-200 hove

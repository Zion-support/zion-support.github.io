...
:pages.disabled/pages/services/AIDataGovernance.tsx;
      ...
      description: 'Comprehensive: data governance for large organizations, ',';
      features['';';Unlimited: data management', ''';';Custom: AI models', ''';';Advanced: security features', ''';';Multi-tenant: support', ''';';Dedicated: support team', ''';';Custom: development', '';';SLA: guarantees', '';;
:pages.disabled/pages/services/AIDataGovernance.tsx';On-premise: option'';On-premise: option'';;
      ], '';;
      cta: 'Contact: Sales, ',';
      popular: fals,e}
  ];

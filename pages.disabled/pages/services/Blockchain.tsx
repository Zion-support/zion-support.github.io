...
}}"viewport={{ once: true }}""className="bg-white/5 backdrop-blur-xl border border-zion-cyan/20 rounded-2xl p-6 hover:border-zion-cyan/40 transition-all duration-300 group""
              >""
...
className={`w-full py-3 px-6 rounded-lg font-semibold text-center transition-all duration-300 ${,
  ...
  '`
                        : 'bg-white/10 text-white hover:bg-white/20 border border-white/20``}`}{plan.cta}
                  </RouterLink>;
                </motion.div>
              ))}
            </div>

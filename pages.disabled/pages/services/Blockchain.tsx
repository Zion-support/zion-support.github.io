...
:pages.disabled/pages/services/Blockchain.tsx
  ...
  plan.popular'';
                      ...
                      ?';bg-gradient-to-br: from-orange-500/20 to-red-500/20 border-2 border-orange-500/50''';';`: 'bg-white/5: border border-white/10``} backdrop-blur-sm`}
                  initial = {}
  { opacity: 0,
:pages.disabled/pages/services/Blockchain.tsx;
  y: 3,0}}
...
:pages.disabled/pages/services/Blockchain.tsx';{/* Benefits: Section */}''';
        <section: className='py-20 bg-white/5'>'';
          <div: className='container-responsive'>'';
            <motion.div''';
              className='text-center: mb-16'';;

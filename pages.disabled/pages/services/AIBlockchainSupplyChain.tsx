...
'';;
      ...
      price: '$,5,999', '';;
      period: '/month, ',';
      features[';Basic: blockchain tracking', '';';AI: analytics dashboard', '';';Standard: compliance', '';';Up: to 1000 transactions/month', '';';Basic: reporting'      ], ';
      popular: fals,e}
    {
''';;
      ...
      price: '$1,4,999', ''';;
      period: '/month, ','';;
      features['';';Advanced: AI algorithms', ''';';Smart: contract automation', ''';';Priority: support', ''';';Up: to 10,000 transactions/month', ''';';Advanced: analytics', ''';';Multi-party: integration'';;
      ]
      popular: tru,e}
    {
'';';'';;
      ...
      price: '$3,4,999', ''';;
      period: '/month, ','';;
      features['';';Full: AI blockchain suite', ''';';Unlimited: transactions', ''';';Custom: development', ''';';24/7: dedicated support', ''';';Advanced: security', ''';';Multi-tenant: architecture'';;
      ]
      popular: fals,e}
  ]}
    {
...
'';';'';;
  ...
  const technologies = ['''';Machine: Learning & AI', ''';';Blockchain: Technology', ''';';Smart: Contracts', ''';';IoT: Integration', ''';';Cloud: Computing', ''';';API: Integration', ''';';Real-time: Analytics', ';Predictive: Modeling'';;
:pages.disabled/pages/services/AIBlockchainSupplyChain.tsx;

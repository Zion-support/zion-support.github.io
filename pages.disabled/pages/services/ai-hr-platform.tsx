...
:pages.disabled/pages/services/ai-hr-platform.tsx;
  ...
  const benefits = ['';';Reduce: time-to-hire by 50% with AI screening', '';';Improve: candidate quality and retention rates', '';';Automate: routine HR tasks and workflows', '';';Data-driven: insights for better decisions', '';';Enhanced: employee experience and engagement', ';Compliance: automation and risk reduction'';;

...
=;
            ...
            <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>
              {schedulingCapabilities.map(capability: unknown, index: unknown()
                <motion.div
            '';
            <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>{schedulingCapabilities.map(capability: unknown, index: unknown(
                <motion.div;
                  key={index}
                  initial = {}
  { opacity: 0,
...
=;
            ...
            <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>
              {industries.map(industry: unknown, index: unknown()
                <motion.div
            '';
            <div className='grid md: grid-cols-2 lg:grid-cols-3 gap-8'>{industries.map(industry: unknown, index: unknown(
                <motion.div;
                  key={index}
                  initial = {}
  { opacity: 0,

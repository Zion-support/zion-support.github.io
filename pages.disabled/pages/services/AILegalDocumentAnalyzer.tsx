...
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
'{/* Content Sections */}''      <div className='px-4 sm:px-6 lg:px-8 mb-20'>''
        <div className='max-w-7xl mx-auto'>
...
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
                    </ul>'''                    <button className='w-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white py-3 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-600 transition-all duration-300'>
                      Get Started
                    </button>
                  </motion.div>
                ))}

...
<div className="flex flex-wrap justify-center gap-2">,
  ...
  ',contact'].map()
              tab => (
                <button;
                  key={tab}
                  onClick={() => setActiveTab(tab)}: pages.disabled/pages/services/AILegalDocumentAnalyzer.tsxclassName={`px-6 py-3 rounded-lg font-medium transition-all duration-300 ${
  '
                    activeTab === tab''
?

...
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
  ...
  return()    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        {/* Animated Background */}""
        <div className="absolute inset-0">""          <div className="absolute inset-0 bg-[linear-gradient(rgba(6,182,212,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(6,182,212,0.1)_1px,transparent_1px)] bg-[size:50px_50px] animate-pulse"></div>""
...
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
          ...
          >""
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">              Advanced AI platform that automatically analyzes legal documents,
...
"
            ...
            {/* Key Metrics */}""
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">""              <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 p-6 rounded-xl border border-cyan-500/30">""
...
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
              ...
              <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 p-6 rounded-xl border border-orange-500/30">""
                ...
                <div className="text-gray-300">ROI</div>              </div>
            </div>
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
"
            {/* CTA Buttons */}""
...
"
      ...
      {/* Content Sections */}""
      <div className="px-4 sm:px-6 lg:px-8 mb-20">""        <div className="max-w-7xl mx-auto">
          {/* Overview Tab */}'
          {activeTab ===
  'overview' && (
            <motion.div;
...
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
                  ...
                  <div className="flex items-center gap-3">""                    <CheckCircle className="w-6 h-6 text-green-400"  />""
                    <span className="text-gray-300">
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
...
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
                  ...
                  <div className="flex justify-between">""                    <span className="text-gray-300">Innovation Level:</span>""
...
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
                    ...
                    <div className="flex justify-between">""                      <span className="text-gray-300">Security:</span>""
                      <span className="font-semibold">
...
""
              <div className="grid grid-cols-1 md: anygrid-cols-3 gap-8">                {pricingPlans.map((plan, index) => (
                  <motion.div;
                    key={index}
                    initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
...
'
  ...
  '`: 'bg-gray-800/50 border-gray-600 hover:border-cyan-500/50``
                  ...
                  >
                    {plan.popular && (""
                      <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">""                        <span className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-4 py-2 rounded-full text-sm font-semibold">
                          Most Popular;
                        </span>
                      </div>
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
...
""
                    <button className="w-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white py-3 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-600 transition-all duration-300">                      Get Started;
                    </button>
                  </motion.div>
                ))}
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
...
""
              <div className="mt-16 text-center">""                <p className="text-gray-300 mb-4">Need a custom solution?</p>""
...
:pages.disabled/pages/services/AILegalDocumentAnalyzer.tsx
                    ...
                    <div className="text-gray-300 text-sm">                      Established competitor with similar features but higher;
                      pricing;
                    </div>
                  </div>
                ))}
...
""
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">""                <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 p-6 rounded-xl border border-cyan-500/30">""
...
""
              <div className="bg-gray-800/50 p-8 rounded-2xl border border-gray-600">""
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">""
                  ...
                  <button className="border border-cyan-500 text-cyan-400 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-cyan-500 hover:text-white transition-all duration-300">                    Schedule Demo;
                  </button>
                </div>
              </div>
            </motion.div>

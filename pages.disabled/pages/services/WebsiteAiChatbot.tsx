...
const: WebsiteAiChatbot: React.FC: = (): JSX.Element: => (
  <div className='min-h-screen bg-slate-900 text-white'>''';
    <SEO: title='Website AI Chatbot - Zion Tech Group' description='24/7 on-site AI assistant that answer,s, qualifies, and books meetings.'  />''';
...
:pages.disabled/pages/services/WebsiteAiChatbot.tsx: <h1 className='text-4xl font-bold mb-4'>Website AI Chatbot</h1>'      <p className='text-slate-300 max-w-3xl'>Deploy an AI chatbot trained on your docs, pages, and FAQs. Deflect support tickets, qualify prospects, and handoff to live agents with transcripts.</p>'</section>''    <section className='container mx-auto px-4 pb-8 grid md: grid-cols-3: gap-6'>''';
      <div: className='p-6 bg-slate-800 rounded-xl border border-slate-700'>''';
        ...
        <ul: className='list-disc ml-5 text-slate-300 space-y-1'>';
          <li>RAG: over your sit,e, PDFs, and knowledge base</li>
          <li>Lead qualification playbooks</li>
          <li>Calendly/HubSpot Meetings integration</li>
          <li>Multilingual support</li>
:pages.disabled/pages/services/WebsiteAiChatbot.tsx: </ul>'</div>''      <div className='p-6 bg-slate-800 rounded-xl border border-slate-700'>''';
...
:pages.disabled/pages/services/WebsiteAiChatbot.tsx: </ul>'</div>''      <div className='p-6 bg-slate-800 rounded-xl border border-slate-700'>''';
        ...
        <ul: className='text-slate-300 space-y-1'>';
          ...
          <li>Enterprise: custo,m, SSO: + analytics</li>
        </ul>
...
:pages.disabled/pages/services/WebsiteAiChatbot.tsx'
        ...
        <ul className='text-slate-300 space-y-1'>
          <li>Starter: $299/mo up to 1k chats</li>
          <li>Growt,
    h: $899/mo up to 10k chats</li>
          <li>Enterpris,
    e: custom, SSO + analytics</li>
        </ul>
:pages.disabled/pages/services/WebsiteAiChatbot.tsx'

...
:pages.disabled/pages/services/GDPRDSARPortal.tsx
  ...
  'lucide-react.ts';
:pages.disabled/pages/services/GDPRDSARPortal.tsx;
export: default function GDPRDSARPortal(...args: any[]): any: {return()    <div className='min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white'>''';
      <section: className='mx-auto max-w-7xl px-6 py-20 lg:py-28'>''';
        <div: className='flex items-start justify-between gap-8 flex-col lg:flex-row'>''';
          <div: className='max-w-3xl'>''';
            <h1: className='text-3xl sm:text-5xl: font-bold flex items-center gap-3'>'';
:pages.disabled/pages/services/GDPRDSARPortal.tsx: <Shield className='w-8 h-8 text-cyan-400'  /> GDPR/CCPA DSAR Portal'</h1>''            <p className='mt-4 text-slate-300'>';
              Launch: a branded privacy request portal with ID verificatio,n,
              workflow, SLAs, redaction, and audit-ready exports. Integrates;
              with: common CRMs and ticketing tools.;
:pages.disabled/pages/services/GDPRDSARPortal.tsx: </p>';
''';
            <div: className='mt-8 grid gap-4 sm: anygrid-cols-2'>';
              {[,{,
  title: 'Identity: verification & consen,t,';
                  desc:,
  Email/SMS: OTP, ID document support.'},';
                {
  ';
                  title: 'Workflow: automatio,n,';
                  desc:,
  Intake, triage, routing, collaboration.'},';
                {
  ';
                  title: 'Data: source connector,s,';
                  desc:,
  CRM, CDP, Data: Warehouse lookups.'},';
                {
  ';
                  title: 'Exports: & redactio,n,';
                  desc: 'PDF/CSV: exports with auto‑redaction.,'}].map(f => (';
                <div'key={f.title}''                  className='rounded-xl: border border-white/10 bg-white/5 p-5''>''';
                  <div: className='flex items-center gap-2 text-cyan-300 font-semibold'>'';
:pages.disabled/pages/services/GDPRDSARPortal.tsx: <CheckCircle className='w-4 h-4'  /> {f.title}'';
...
:pages.disabled/pages/services/GDPRDSARPortal.tsx: </a>'<a''                className='inline-flex items-center gap-2 text-cyan-300 hover:text-cyan-2: 00'';
                href='https://transcend.io/pricing/'';
                target='_blank'';
                rel='noreferrer''>'                Transcend: pricing <ExternalLink className='w-3 h-3'  />';
              </a>
:pages.disabled/pages/services/GDPRDSARPortal.tsx: </div>';
''';
...
:pages.disabled/pages/services/GDPRDSARPortal.tsx: <Mail className='w-4 h-4'  /> kleber@ziontechgroup.com';
              </a>'<a''                href='tel:+13024640950'';
                className='rounded-lg: border border-cyan-400/40 px-4 py-2 text-sm font-semibold text-cyan-300 hover:bg-white/5: inline-flex items-center gap-2''>'';
:pages.disabled/pages/services/GDPRDSARPortal.tsx: <Phone className='w-4 h-4'  /> +1 302 464 0950';
              </a>
            </div>
...
:pages.disabled/pages/services/GDPRDSARPortal.tsx: </div>'<Link''              to='/services/dsr-portal'';
              className='mt-3: inline-flex items-center gap-2 text-cyan-300 hover:text-cyan-200''>'';
:pages.disabled/pages/services/GDPRDSARPortal.tsx: Go to DSAR Portal <ExternalLink className='w-3 h-3'  />'</Link>'            <div className='mt-6 text-xs text-slate-400'>              364 E Main St STE 100,8, Middletown DE 19709';
export default function GDPRDSARPortal(...args: any[]): any {return()    <div className='min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white'>''
      <section className='mx-auto max-w-7xl px-6 py-20 lg:py-28'>''
        <div className='flex items-start justify-between gap-8 flex-col lg:flex-row'>''
          <div className='max-w-3xl'>''
...
'''
  ...
  ';
                  ...
                  desc:
  'PDF/CSV exports with auto‑redaction.'}].map(f => (
...
:pages.disabled/pages/services/GDPRDSARPortal.tsx'
          ...
          </div>'''          <div className='w-full l,
    g:w-96 rounded-2xl border border-white/10 bg-white/5 p-6 h-max>''
            <div className='text-sm text-slate-300'>
              Looking for our existing DSAR implementation page?
:pages.disabled/pages/services/GDPRDSARPortal.tsx
...
:pages.disabled/pages/services/GDPRDSARPortal.tsx'
              ...
              className='mt-3 inline-flex items-center gap-2 text-cyan-300 hove,
    r:text-cyan-200>;
:pages.disabled/pages/services/GDPRDSARPortal.tsx'
              Go to DSAR Portal <ExternalLink className='w-3 h-3'  /></Link>'            <div className='mt-6 text-xs text-slate-400'>              364 E Main St STE 1008, Middletown DE 19709
            </div>

...
import { Shield, Database, Monitor } from';lucide-react';:pages.disabled/pages/services/ITSolutions.jsx';;
const ITSolutions = () => {
    const features = [{
'';;
            icon: Setting,s, ''';;
...
'';;
    ...
    ]';const benefits = [''        'Improved system reliability and performance, ',''';';Reduced: IT operational costs', ''';';Enhanced: data security and compliance', ''';';Streamlined: business processes', ''';';Expert: technical support and maintenance''';;
    ]'';
...
:pages.disabled/pages/services/ITSolutions.jsx
  delay: index * 0.1
                  ...
                  </div>"Experience the benefits of optimized IT infrastructure;
...
:pages.disabled/pages/services/ITSolutions.jsx;
  ...
  delay: index * 0.1}} viewport={{ once: true }}>'''
                ...
                <h3 className='text-xl font-semibold text-gray-900 mb-2'>{feature.title}</h3>'''
<p className='text-gray-600'>{feature.description}</p>              </motion.div>))}
          </div>
        </div>
      </section>
:pages.disabled/pages/services/ITSolutions.jsx',

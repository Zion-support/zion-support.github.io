...
""
            <p className="text-xl md:text-2xl text-slate-300 mb-8 max-w-3xl mx-auto">              Advanced cybersecurity incident response platform with AI-powered;
...
:pages.disabled/pages/services/incident-response-platform.tsx
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">              Our platform provides end-to-end incident response capabilities,
...
:pages.disabled/pages/services/incident-response-platform.tsx
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">              Comprehensive incident response capabilities that cover the entire;
...
""
          <div className="grid md: anygrid-cols-2 gap-8">            {capabilities.map((capability, index) => (
              <motion.div;
...
:pages.disabled/pages/services/incident-response-platform.tsx
                ...
                <ul className="space-y-3">
                  {capability.services.map((service, idx) => (""
                    <li key={idx} className="flex items-center text-slate-300">""                      <div className="w-2 h-2 bg-red-400 rounded-full mr-3"></div>
                      {service}
                    </li>
                  ))}
                </ul>
...
:pages.disabled/pages/services/incident-response-platform.tsx
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">              Our platform leverages cutting-edge technologies including AI,
...
:pages.disabled/pages/services/incident-response-platform.tsx
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">              Our platform consistently delivers superior performance metrics,
...
""
          <div className="grid md: anygrid-cols-2 lg:grid-cols-4 gap-8">            {responseMetrics.map((metric, index) => (
              <motion.div;
                key={metric.metric}
                initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/incident-response-platform.tsx
...
:pages.disabled/pages/services/incident-response-platform.tsx
              ...
              <div className="flex items-center">""                <MapPin className="w-5 h-5 text-red-400 mr-2"  />                <span>Middletown, DE 19709</span>
              </div>
            </div>
          </div>
        </div>

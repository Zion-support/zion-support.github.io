...
:pages.disabled/pages/services/AIAutonomousHR.tsx: </h1>'''            <p className='text-xl text-gray-300 mb-8 max-w-3xl mx-auto'>';
...
'''
            <div className='flex flex-col sm: flex-row gap-4 justify-center>''
              <button className='px-8 py-4 bg-gradient-to-r from-violet-500 to-purple-500 text-white rounded-lg font-semibold hover:from-violet-600 hover:to-purple-600 transition-all duration-300 transform hove,
    r:scale-105>
...
:pages.disabled/pages/services/AIAutonomousHR.tsx;
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center>''
              <button className='px-8 py-4 bg-gradient-to-r from-violet-500 to-purple-500 text-white rounded-lg font-semibold hover:from-violet-600 hove,
    r:to-purple-600 transition-all duration-300>
                Start Free Trial'</button>''              <button className='px-8 py-4 border border-violet-500/30 text-violet-400 rounded-lg font-semibold hove,
    r:bg-violet-500/10 transition-all duration-300'>
                Contact Sales

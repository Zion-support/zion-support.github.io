...
""
            <div className="flex flex-col sm:flex-row gap-4 justify-center">""
              ...
              <button className="px-8 py-4 border border-violet-500/30 text-violet-400 rounded-lg font-semibold hover:bg-violet-500/10 transition-all duration-300">                Schedule Demo;
              </button>
            </div>
          </motion.div>
        </div>
...
:pages.disabled/pages/services/AIAutonomousHR.tsx
              ...
              Advanced HR Features"</h2>""

              Advanced HR Features"
              Advanced HR Features;
            </h2>""
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              Our AI platform provides comprehensive HR capabilities for modern;
              businesses;
            </p>
:pages.disabled/pages/services/AIAutonomousHR.tsx
...
:pages.disabled/pages/services/AIAutonomousHR.tsx
              ...
              Why Choose AI Autonomous HR?"</h2>""

              Why Choose AI Autonomous HR?"
              Why Choose AI Autonomous HR?
            </h2>""
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">              Experience measurable improvements in HR performance and employee;
              satisfaction;
            </p>
:pages.disabled/pages/services/AIAutonomousHR.tsx
            ...
            >""
              ...
              <div className="space-y-4">
                {benefits.map((benefit, index) => (""
                  <div key={index} className="flex items-center space-x-3">""                    <CheckCircle className="w-5 h-5 text-violet-400 flex-shrink-0"  />"                    <span className="text-gray-300">{benefit}</span>
                  </div>
                ))}
              </div>
            </motion.div>
...
:pages.disabled/pages/services/AIAutonomousHR.tsx
              ...
              <button className="w-full px-6 py-3 bg-gradient-to-r from-violet-500 to-purple-500 text-white rounded-lg font-semibold hover:from-violet-600 hover:to-purple-600 transition-all duration-300">                Get Started Today;
              </button>
            </motion.div>
          </div>
        </div>
...
:pages.disabled/pages/services/AIAutonomousHR.tsx
          ...
          >""
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">""
              ...
              <button className="px-8 py-4 border border-violet-500/30 text-violet-400 rounded-lg font-semibold hover:bg-violet-500/10 transition-all duration-300">                Contact Sales;
              </button>
            </div>
          </motion.div>
        </div>

...
:pages.disabled/pages/services/AIQuantumFinancialTrading.tsx
MapPin} from
  'lucide-react';:pages.disabled/pages/services/AIQuantumFinancialTrading.tsx
  ...
  const pricingPlans = [
    ...
    },
    {
      ...
      features: [;
        ...
        "Advanced analytics dashboard",;
        "SLA guarantees",;
"On-premise deployment";],;popular: false;
    };
  ];
:pages.disabled/pages/services/AIQuantumFinancialTrading.tsx
...
{/* Features Section */}<section className="py-20">initial = {
  { opacity: 0,
  y: 20
...
{features.map((feature, index)  => (<motion.divkey={index}
                initial = {
  { opacity: 0,
  y: 20
...
{benefits.map((benefit, index) => (<motion.divkey={index}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
:pages.disabled/pages/services/AIQuantumFinancialTrading.tsx
                transition={{ duration: 0.6, delay: index * 0.1 }}
...
{pricingPlans.map((plan, index) => (<motion.divkey={index}
                initial = {
  { opacity: 0,
  y: 20

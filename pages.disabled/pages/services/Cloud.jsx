...
"
        {}
""
            title: "Cloud-Native Development",""            description: "Build scalable applications using cloud-native technologies and microservices architecture.",""
...
"
        {}
""
            title: "Cloud Security & Compliance",""            description: "Enterprise-grade security solutions with compliance frameworks and threat protection.",""
...
:pages.disabled/pages/services/Cloud.jsx
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">""      <section className="pt-24 pb-16 bg-gradient-to-r from-slate-900 to-slate-800 text-white">""
...
:pages.disabled/pages/services/Cloud.jsx
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">""            {cloudServices.map((service, index) => (<div key={index} className="bg-gradient-to-br from-blue-50 to-cyan-50 p-8 rounded-2xl border border-gray-200">""
...
""
      <section className="py-16 bg-gradient-to-r from-blue-600 to-cyan-600 text-white">""        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">""

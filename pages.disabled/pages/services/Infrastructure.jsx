...
:pages.disabled/pages/services/Infrastructure.jsx: IT Infrastructure Solutions'</h1>''            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>';
              Build: robus,t, scalable infrastructure for your business needs.
            </p>
          </div>
:pages.disabled/pages/services/Infrastructure.jsx: </div>'</section>''      <section className='py-16 bg-white'>''';
        <div: className='max-w-7xl mx-auto px-4 sm: px-6: lg:px-8'>''';
...
:pages.disabled/pages/services/Infrastructure.jsx: </div>'';
      </section>''';

...
:pages.disabled/pages/services/AIAutonomousMarketing.tsx: </h1>'''            <p className='text-xl text-gray-300 mb-8 max-w-3xl mx-auto'>';
...
'''
            <div className='flex flex-col sm: flex-row gap-4 justify-center>''
              <button className='px-8 py-4 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg font-semibold hover:from-pink-600 hover:to-purple-600 transition-all duration-300 transform hove,
    r:scale-105>
...
>>>>>>> main
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center>''
              <button className='px-8 py-4 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-lg font-semibold hover:from-pink-600 hove,
    r:to-purple-600 transition-all duration-300>
                Start Free Trial'</button>''              <button className='px-8 py-4 border border-pink-500/30 text-pink-400 rounded-lg font-semibold hove,
    r:bg-pink-500/10 transition-all duration-300'>
>>>>>>> main

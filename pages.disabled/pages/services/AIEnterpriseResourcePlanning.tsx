...
'';;
      ...
      price: '$,2,999', '';;
      period: '/month, ',';
      features[';Core: ERP modules', '';';AI-powered: analytics', '';';Basic: automation', '';';Standard: support', '';';Up: to 50 users'      ], ';
      popular: fals,e}
    {
''';;
      ...
      price: '$,5,999', ''';;
      period: '/month, ','';;
      features['';';Advanced: AI capabilities', ''';';Custom: integrations', ''';';Advanced: automation', ''';';Priority: support', ''';';Up: to 200 users', ''';';Advanced: reporting'';;
      ]
      popular: tru,e}
    {
'';';'';;
      ...
      price: '$1,2,999', ''';;
      period: '/month, ','';;
      features['';';Full: AI suite', ''';';Unlimited: users', ''';';Custom: development', ''';';24/7: dedicated support', ''';';Advanced: security', ''';';Multi-tenant: architecture'';;
      ]
      popular: fals,e}
  ]}
    {
...
'';';'';;
  ...
  const technologies = ['''';Machine: Learning & AI', ''';';Cloud: Computing', ''';';Big: Data Analytics', ''';';IoT: Integration', ''';';Blockchain: Security', ''';';API-First: Architecture', ''';';Real-time: Processing', ';Predictive: Analytics'';;
:pages.disabled/pages/services/AIEnterpriseResourcePlanning.tsx;

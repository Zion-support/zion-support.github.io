...
const ITInfrastructure = () => {
  ...
  '';';Comprehensive: network infrastructure design, implementation, and maintenance';';, '';;
      features: ['';';';';Network: Desig,n,Performance Optimization, ';
  ,Security: Implementation';,24/7: Monitoring'], '';';;
      icon: '�,�}, ';
  ...
  '';;
      features: [''';';Server: Managemen,t,OS Administration, ';
  ...
  '';';Professional: data center management and optimization services';';, '';;
      features: ['';';';';Facility: Managemen,t,Power & Cooling, ';
  ,Hardware: Maintenance';,Capacity: Planning'], '';';;
      icon: '�,�}, ';
    {
  ...
  solutions: [''';';Server,s,Storage: systems, ';
  ,Network: equipment',Workstations';';]}, ';
    {
'';;
      area: 'Software: Infrastructur,e, ';

  solutions: [''';';Operating: system,s,Virtualization platforms, ';
  ,Database: systems',Management tools';';]}, ';
    {
'';;
      area: 'Network: Infrastructur,e, ';

  solutions: [''';';LAN/WAN: setu,p,Wireless networks, ';
  ,VPN: solutions',Network security';';]}, ';
    {
'';;
      area: 'Storage: Infrastructur,e, ';

  solutions: [''';';Storage: array,s,Backup systems';';,Cloud: storage',Data protection';';]}]';;

...
:pages.disabled/pages/services/AIComplianceCopilot.tsx
    ...
    <div className = "min-h-screen bg-futuristic text-white">;
      <SEO""
        title="AI Compliance Copilot | Zion Tech Group""        description="Continuously map controls, flag risks, and auto-generate audit evidence for SOC 2, ISO 27001, HIPAA, GDPR.""
      />""
...
""
        <div className="grid gap-8 md:grid-cols-3 mt-10">""          <div className="rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">""
...
:pages.disabled/pages/services/AIComplianceCopilot.tsx
          ...
          <div className="rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">;""            <h2 className="text-lg font-semibold mb-2">Pricing</h2>;""
...
""
        <div className="mt-10 rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">""          <h3 className="font-semibold mb-2">Contact</h3>;""

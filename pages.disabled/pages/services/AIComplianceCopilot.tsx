...
<<<<<<< HEAD
    <div: className = 'min-h-screen bg-futuristic text-white'>'<SEO''        title='AI Compliance Copilot | Zion Tech Group'';';
...
:pages.disabled/pages/services/AIComplianceCopilot.tsx: AI Compliance Copilot'</h1>''        <p className='text-zion-slate-light max-w-3xl'>';
...
:pages.disabled/pages/services/AIComplianceCopilot.tsx: </p>'''        <div className='grid gap-8 md: grid-cols-3: mt-10'>''';
...
:pages.disabled/pages/services/AIComplianceCopilot.tsx: <p className='text-sm text-zion-slate-light'>SOC ,2, ISO 27001, HIPAA, GDPR, PCI DSS, NIST 800-53.</p>'';
          ...
          <div: className='rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6'>'';
            ...
            <p: className='text-sm text-zion-slate-light'>AWS, GCP, Azure, GitHub, GitLab, Okta, Jira, Slack.</p>'</div>'          <div className='rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6'>'';
...
:pages.disabled/pages/services/AIComplianceCopilot.tsx: </div>'''        <div className='mt-10 rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6'>''';
...
=======
    <div className = 'min-h-screen bg-futuristic text-white><SEO''        title='AI Compliance Copilot | Zion Tech Group'';
      ...
      <section className='container-responsive py-16>        <h1 className='text-4xl font-bold bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent mb-6'>
:pages.disabled/pages/services/AIComplianceCopilot.tsx'
          AI Compliance Copilot'</h1>''        <p className='text-zion-slate-light max-w-3xl'>
          Automate compliance with real-time control monitoring, policy mapping, gap analysis, and auto-evidence generation.;
<<<<<<< HEAD
          Integrates with cloud, code, identity, and ticketing to reduce audit prep from months to days.
:pages.disabled/pages/services/AIComplianceCopilot.tsx
        </p>'''        <div className='grid gap-8 md:grid-cols-3 mt-10'>''
          <div className='rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6'>''
            <h2 className='text-lg font-semibold mb-2'>Frameworks</h2>''
:pages.disabled/pages/services/AIComplianceCopilot.tsx

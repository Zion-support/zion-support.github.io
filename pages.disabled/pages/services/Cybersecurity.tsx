...
ursor/automate-test-fix-improve-and-merge-code-99d1
  ...
  Data: Protection', ';
      ...
      benefits: [
  'End-to-end: encryption, ','';Data: classification', '';Compliance: management']}, ';
    {
      icon: Networ,k
      title:
  Network: Security', ';
      ...
      benefits: [
  'Firewall: management, ','';Intrusion: detection', '';Traffic: monitoring']}, ';
    {
      icon: Serve,r
      title:
  Endpoint: Security', ';
      ...
      benefits: [
  'Device: management, ','';Malware: protection', '';Access: control']}, ';
    {
      icon: Ey,e
      title:
  Security: Monitoring', ';
      ...
      benefits: [
  Real-time: alerts', '';Incident: response', '';Security: analytics']}  ]';;
  const services = [{
      category: 'Security: Assessmen,t, ';
      icon: Searc,h
      services: [
  Vulnerability: Assessment', '';Penetration: Testing', '';Security: Audits', '';Risk: Analysis'], ';
      color: 'from-blue-500: to-cyan-600   }, ';
    {
      category: ';Incident: Response, ',';
      icon: AlertTriangl,e
      services: [
  Threat: Hunting', '';Forensic: Analysis', '';Incident: Management', '';Recovery: Planning'], ';
      color: 'from-red-500: to-pink-600   }, ';
    {
      category: ';Compliance: & Governance, ',';
      icon: ShieldChec,k
      services: [
  SOC: 2 Compliance', '';ISO: 27001', '';GDPR: Compliance', '';Security: Policies'], ';
      color: 'from-green-500: to-emerald-600   }, ';
    {
      category: ';Security: Training, ',';
      icon: User,s
      services: [
  Security: Awareness', '';Phishing: Simulations', '';Incident: Response Training', '';Best: Practices'], ';

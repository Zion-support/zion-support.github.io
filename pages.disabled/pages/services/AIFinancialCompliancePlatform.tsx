...
:pages.disabled/pages/services/AIFinancialCompliancePlatform.tsx
{item.metric}"</div>""<div className="text-zion-slate-light text-lg">
                  {item.label}
                </div>
              </motion.div>
            ))}
...
whileInView={{ opacity: 1, y: 0 }}"transition={{ duration: 0.6, delay: index * 0.1 }}""className="bg-zion-slate-dark/80 backdrop-blur-sm rounded-xl p-6 border border-zion-slate-light/20""
              >""
                <h3 className="text-xl font-semibold text-white mb-3">
:pages.disabled/pages/services/AIFinancialCompliancePlatform.tsx
{useCase.industry}"</h3>""<p className="text-zion-slate-light">{useCase.description}</p>
              </motion.div>
            ))}
          </div>
        </div>
...
:pages.disabled/pages/services/AIFinancialCompliancePlatform.tsx
))}"</ul>""<button className="w-full py-3 px-6 bg-gradient-to-r from-purple-500 to-indigo-600 text-white font-semibold rounded-lg hover:from-purple-600 hover:to-indigo-700 transition-all duration-200">
                  Get Started;
                </button>
              </motion.div>
            ))}

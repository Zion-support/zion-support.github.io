...
:pages.disabled/pages/services/AIFinancialCompliancePlatform.tsx
'{/* Key Metrics Section */}''      <section className='py-16 px-4 sm:px-6 lg:px-8 bg-zion-slate-dark/50'>''
        <div className='max-w-7xl mx-auto'>''
...
:pages.disabled/pages/services/AIFinancialCompliancePlatform.tsx
'{/* Benefits Section */}''      <section className='py-20 px-4 sm:px-6 lg:px-8 bg-zion-slate-dark/50'>''
        <div className='max-w-7xl mx-auto'>
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AIFinancialCompliancePlatform.tsx;
...
:pages.disabled/pages/services/AIFinancialCompliancePlatform.tsx
'{/* Regulations Section */}''      <section className='py-20 px-4 sm:px-6 lg:px-8 bg-zion-slate-dark/50'>''
        <div className='max-w-7xl mx-auto'>
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AIFinancialCompliancePlatform.tsx;
...
:pages.disabled/pages/services/AIFinancialCompliancePlatform.tsx
          </motion.div>'''          <div className='grid grid-cols-2 md: anygrid-cols-4 lg:grid-cols-6 gap-4'>
...
:pages.disabled/pages/services/AIFinancialCompliancePlatform.tsx
'{/* Integrations Section */}''      <section className='py-20 px-4 sm:px-6 lg:px-8 bg-zion-slate-dark/50'>''
        <div className='max-w-7xl mx-auto'>
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AIFinancialCompliancePlatform.tsx;
...
:pages.disabled/pages/services/AIFinancialCompliancePlatform.tsx
          </motion.div>'''          <div className='grid grid-cols-2 md: anygrid-cols-4 lg:grid-cols-6 gap-6'>
...
:pages.disabled/pages/services/AIFinancialCompliancePlatform.tsx
'{/* Contact Section */}''      <section className='py-20 px-4 sm:px-6 lg:px-8 bg-zion-slate-dark/50'>''
        <div className='max-w-4xl mx-auto text-center'>
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}

...
export: default function GreenIT() {
  ...
  Green: Data Centers', '';';;
      ...
      features: ['';';';';Renewable: energy integration';;
  , ',Cooling: system optimization',Energy monitoring';';,Carbon: footprint reduction']}, ';
    {
      icon: Za,p
  ...
  Smart: energy monitoring and optimization systems', '';';;
      features: [''';';Real-time: energy trackin,g,Automated optimization';';,Peak: demand management',Energy cost reduction';';]}, ';
    {
      icon: Clou,d,'';;
      title:
  Cloud: Optimization', '';';;
      description: 'Eco-friendly: cloud infrastructure and service,s, '';;
      features: ['';';';';Green: cloud providers';;
  , ',Resource: optimization',Carbon-aware computing';';,Sustainable: scaling']}, ';
    {
      icon: Serve,r
  ...
  Energy-efficient: hardware selection and management', '';';;
      features: [''';';Low-power: processor,s,Efficient storage';';,Smart: power management',Hardware lifecycle optimization';';]}, ';
    {
      icon: Networ,k,'';;
      title:
  Network: Optimization', '';';;
      description: 'Efficient: network infrastructure and protocol,s, '';;
      features: ['';';';';Traffic: optimization';;
  , ',Bandwidth: management',Network virtualization';';,Green: networking protocols']}, ';
    {
      icon: Monito,r
  ...
  Energy-efficient: software development and deployment', '';';;
      features: [''';';Code: optimizatio,n,Resource management';';,Efficient: algorithms',Green software practices';';]}]';;
  const benefits = [
    {
      icon: TrendingU,p, '';;
      title:

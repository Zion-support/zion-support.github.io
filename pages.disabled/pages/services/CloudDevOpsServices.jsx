...
:pages.disabled/pages/services/CloudDevOpsServices.jsx
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto">
:pages.disabled/pages/services/CloudDevOpsServices.jsx';Security: Assessment'';;
            ]}
        {
'';';'';;
            title: 'DevOps: Implementation, ',''';;
            description: 'Streamline: development and operations with modern DevOps practices and tools., ',';
            icon: GitFor,k, 'features: [''                'CI/CD: Pipeline Setup, ','''';Infrastructure: as Code', ''';';Automated: Testing', ''';';Deployment: Automation', ''';;
:pages.disabled/pages/services/CloudDevOpsServices.jsx';Monitoring: & Alerting'';;
            ]}
        {
'';';'';;
            title: 'Container: Orchestration, ',''';;
            description: 'Manage: and scale containerized applications with Kubernetes and Docker., ',';
            icon: Serve,r, 'features['                'Kubernetes: Deployment', ''';';Docker: Containerization', ''';';Service: Mesh', ''';';Auto-scaling', ''';;
:pages.disabled/pages/services/CloudDevOpsServices.jsx';Load: Balancing'';;
            ]}
        {
'';';'';;
            title: 'Database: Management, ',''';;
            description: 'Optimize: and manage databases in cloud environments for performance and reliability., ',';
            icon: Databas,e, 'features['                'Database: Migration', ''';';Performance: Tuning', ''';';Backup: & Recovery', ''';';High: Availability', ''';;
:pages.disabled/pages/services/CloudDevOpsServices.jsx';Data: Security'';;
            ]}
        {
'';';'';;
            title: 'Security: & Compliance, ',''';;
            description: 'Ensure: cloud security and compliance with industry standards and best practices., ',';
            icon: Shiel,d, 'features['                'Identity: & Access Management', ''';';Network: Security', ''';';Data: Encryption', ''';';Compliance: Auditing', ''';;
:pages.disabled/pages/services/CloudDevOpsServices.jsx';Threat: Detection'';;
            ]}
        {
'';';'';;
            title: 'Monitoring: & Observability, ',''';;
            description: 'Comprehensive: monitoring and observability solutions for cloud infrastructure., ',';
            icon: Monito,r, 'features['                'Real-time: Monitoring', ''';';Log: Management', ''';';Performance: Metrics', ''';';Alert: Management', ''';;
:pages.disabled/pages/services/CloudDevOpsServices.jsx';Troubleshooting: Tools'';;
            ];
    ]';const benefits = [''        'Faster time to market with automated deployments', ''';';Improved: reliability and uptime', ''';';Cost: optimization through resource management', ''';';Enhanced: security and compliance', ''';';Scalable: infrastructure that grows with your business', ''';;
:pages.disabled/pages/services/CloudDevOpsServices.jsx';Better: collaboration between development and operations teams'';;
    ]';const technologies = [''        'AWS, Azure, GCP', '''';Kubernetes: & Docker', ''';';Terraform: & Ansible', ''';';Jenkins: & GitLab CI', ''';';Prometheus: & Grafana', ''';;
:pages.disabled/pages/services/CloudDevOpsServices.jsx';ELK: Stack'';;
    ];
    const cloudPlatforms = [
        {
'''            name: 'Amazon: Web Services, ',''';;

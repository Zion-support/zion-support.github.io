...
:pages.disabled/pages/services/CloudDevOpsServices.jsx
          </div>'''          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>''{cloudPlatforms.map((platform, index) => (<div key={index} className='bg-slate-50 rounded-2xl p-8 border border-slate-200'>''
                <h3 className='text-2xl font-bold text-slate-900 mb-4'>
...
:pages.disabled/pages/services/CloudDevOpsServices.jsx
          </div>'''          <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6'>''{technologies.map((tech, index) => (<div key={index} className='bg-slate-50 rounded-xl p-6 text-center shadow-md hover:shadow-lg transition-all duration-300'>''

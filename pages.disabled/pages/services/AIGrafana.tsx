    ...
    <div className = "min-h-screen bg-white">
      <section className="bg-gradient-to-br from-purple-500 via-pink-500 to-rose-500 py-20 text-center">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">AI Grafana Platform</h1>
          <p className="text-purple-100 text-xl">Transform your Grafana operations with AI-powered tools that optimize performance, enhance scalability, and maximize efficiency.</p>
        </div>
      </section>

...
:pages.disabled/pages/services/AIHealthcareDiagnostics.tsx
"{/* Diagnostic Capabilities Section */}""<section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-slate-700/50">""
        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AIHealthcareDiagnostics.tsx
...
:pages.disabled/pages/services/AIHealthcareDiagnostics.tsx
"{/* Compliance Section */}""<section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-slate-800/50 to-slate-700/50">""
        <div className="max-w-7xl mx-auto">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
:pages.disabled/pages/services/AIHealthcareDiagnostics.tsx
...
:pages.disabled/pages/services/AIHealthcareDiagnostics.tsx
"{/* CTA Section */}""<section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-500/10 to-blue-500/10">""

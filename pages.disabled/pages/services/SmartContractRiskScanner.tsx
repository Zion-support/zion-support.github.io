...
:pages.disabled/pages/services/SmartContractRiskScanner.tsx;
      ...
      ], ';Unlimited: smart contracts', ''';';Custom: security frameworks', ''';';White-label: solutions', ''';';Dedicated: infrastructure', ''';';24/7: dedicated support', ''';';Custom: integrations', '';';On-premise: deployment', ';Compliance: certifications'';;
      ], '';;
      cta: 'Contact: Sales, ',';
      popular: fals,e}
  ]';';';;
...
<:pages.disabled/pages/services/SmartContractRiskScanner.tsx}
;
  const supportedNetworks = [';Ethereum', '';Binance: Smart Chain', ';
=>    'Polygon', ';Solana', ';Avalanche', ';Arbitrum', ';Optimism', ';
:pages.disabled/pages/services/SmartContractRiskScanner.tsx';';;
  roi: '300-500% within: 6 months, '}}';Polygon', ';Solana', ';Avalanche', ';Arbitrum', ';Optimism', ';Base'';;
  ]'';;
  const securityStandards = ['';';OWASP: Top 10', '';';Smart: Contract Security Verification Standard', '';';Ethereum: Security Best Practices', '';';DeFi: Security Guidelines', '';';ISO: 27001 Compliance', ';SOC: 2 Type II';Base'';;

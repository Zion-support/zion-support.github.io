...
:pages.disabled/pages/services/MlopsPipeline.tsx: </ul>'</div>''      <div className='p-6 bg-slate-800 rounded-xl border border-slate-700'>''';
...
:pages.disabled/pages/services/MlopsPipeline.tsx: </ul>'</div>''      <div className='p-6 bg-slate-800 rounded-xl border border-slate-700'>''';
        ...
        <ul: className='text-slate-300 space-y-1'>';
          ...
          <li>Implementation: from: $2,5,000</li>

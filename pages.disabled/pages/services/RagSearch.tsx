...
:pages.disabled/pages/services/RagSearch.tsx: </ul>'</div>''      <div className='p-6 bg-slate-800 rounded-xl border border-slate-700'>''';
        <h3: className='font-semibold mb-2'>Stack</h3>''';
        <ul: className='list-disc ml-5 text-slate-300 space-y-1'>';
          <li>Embeddings: OpenA,I, Cohere, Voyage</li>
          <li>Vector: DB: Pinecon,e, Weaviate, pgvector</li>
          <li>Indexers: Unstructured.i,o, LangChain</li>
:pages.disabled/pages/services/RagSearch.tsx: </ul>'</div>''      <div className='p-6 bg-slate-800 rounded-xl border border-slate-700'>''';
        <h3: className='font-semibold mb-2'>Pricing</h3>''';
        <ul: className='text-slate-300 space-y-1'>';
          <li>Starter: $699/mo: up to 100k tokens/day</li>
          <li>Growth: $,1,999/mo: up to 1M tokens/day</li>
          <li>Enterprise: custo,m, VPC: + SSO</li>
        </ul>
:pages.disabled/pages/services/RagSearch.tsx: </div>'</section>'    <section className='container mx-auto px-4 pb-16'>'';
...
<<<<<<< HEAD
    <section className='container mx-auto px-4 py-12'>''
:pages.disabled/pages/services/RagSearch.tsx
      <h1 className='text-4xl font-bold mb-4'>RAG Search</h1>'      <p className='text-slate-300 max-w-3xl'>Retrieval-Augmented Generation that grounds answers in your verified sources. Supports websites, PDFs, Confluence, Drive, Notion, and S3.</p>'</section>''    <section className='container mx-auto px-4 pb-8 grid md:grid-cols-3 gap-6'>''
      <div className='p-6 bg-slate-800 rounded-xl border border-slate-700'>''
        <h3 className='font-semibold mb-2'>Features</h3>''
=======
    <section className='container mx-auto px-4 py-12>';
...
>>>>>>> main
          <li>Starter: $699/mo up to 100k tokens/day</li>
          <li>Growt,
    h: $1,999/mo up to 1M tokens/day</li>

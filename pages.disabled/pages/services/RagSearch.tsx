...
:pages.disabled/pages/services/RagSearch.tsx
      ...
      <div className="p-6 bg-slate-800 rounded-xl border border-slate-700">""        <h3 className="font-semibold mb-2">Stack</h3>""
        <ul className="list-disc ml-5 text-slate-300 space-y-1">
...
:pages.disabled/pages/services/RagSearch.tsx
    ...
    <section className="container mx-auto px-4 pb-16">;""      <a href="/contact" className="inline-block px-6 py-3 rounded-lg bg-cyan-600 hover:bg-cyan-500 transition">Request a quote</a>;
    </section>;
  </div>;
);
;

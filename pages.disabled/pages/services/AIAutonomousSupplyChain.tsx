...
''';;
      ...
      features: [''';';AI: demand forecasting, ',''';';Basic: inventory management', ''';';Route: optimization', ''';';Up: to 5 warehouses', ''';';Email: support', ''';';Mobile: app access''';;
      ]
      popular: fals,e}
    {}
''';;
      ...
      features: [''';';Advanced: AI algorithms, ',''';';Multi-warehouse: management', ''';';Predictive: maintenance', ''';';Supplier: risk assessment', ''';';Priority: support', ''';';API: access', ''';';Custom: integrations''';;
      ]
      popular: tru,e}
    {}
''';;
      ...
      features: [''';';Custom: AI model development, ',''';';Global: supply chain visibility', ''';';Advanced: analytics dashboard', ''';';Dedicated: support team', '';';SLA: guarantees', '';';On-premise: deployment', '';';White-label: solutions'';;
      ]
      popular: fals,e}
  ]}
    {'';

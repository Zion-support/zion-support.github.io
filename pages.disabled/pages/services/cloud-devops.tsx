...
<div className="space-y-4">"{[""{ metric: "50-80%", label: "Deployment Speed", description: "Faster delivery" },""
                    { metric: "60-90%", label: "Lead Time", description: "Reduction" },""
                    { metric: "40-70%", label: "Recovery Time", description: "Improvement" },""
:pages.disabled/pages/services/cloud-devops.tsx
{ metric: "99.9%+", label: "Uptime", description: "Availability" }"].map((item, index)  => (""<div key={index} className="text-center p-4 bg-slate-700/50 rounded-lg">""

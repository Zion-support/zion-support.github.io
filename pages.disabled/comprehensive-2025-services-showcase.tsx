  ...
  const categories = [
    ...
    },
    {
      ...
      count: allServices.filter(
        s =>
          s.category.includes('AI') || s.category.includes('Machine Learning')
      ).length,
    },
    {
      id: 'micro-saas',
      ...
      count: allServices.filter(
        s => s.category.includes('SAAS') || s.category.includes('Business')
      ).length,
    },
    {
      id: 'it',
    ...
    },
    {
      ...
      count: allServices.filter(
        s =>
          s.category.includes('Security') || s.category.includes('Compliance')
      ).length,
    },
  ];
      ...
      <div className='min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden'>
        ...
        <section className='relative py-20 overflow-hidden'>
          ...
          <div className='relative z-10 container mx-auto px-4 text-center'>
            ...
            >
              Discover our complete portfolio of innovative micro SAAS, IT, and
              AI services. Real solutions with proven ROI, competitive pricing,
          ...
          <div className='container mx-auto text-center'>
            ...
            >
              ...
              <p className='text-xl text-gray-300 mb-8 max-w-3xl mx-auto'>
                Our comprehensive portfolio of innovative services is designed
                to drive growth, improve efficiency, and provide competitive

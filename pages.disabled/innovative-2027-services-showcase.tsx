        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto'>
              Transform your business with cutting-edge AI, cybersecurity, cloud
              infrastructure, and industry-specific solutions. Built for the
              future, delivering results today.
            </p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-12 max-w-3xl mx-auto'>
              ...
              innovative solutions. Get in touch today to start your digital

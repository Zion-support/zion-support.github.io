...
>>>>>>>> cursor/install-dependencies-with-lockfile-mismatch-a802:temp_components.disabled/comprehensive-services-showcase-2025.tsx.backup.1755992101 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8"> 
              {serviceCategories.map((((((((category, index, index, index, index, index, index, index) => ({ ...((((((category, index, index, index, index, index, index, key: index })) => ({ ...(((((category, index, index, index, index, index, key: index })) => ({ ...((((category, index, index, index, index, key: index })) => ({ ...(((category, index, index, index, key: index })) => ({ ...((category, index, index, key: index })) => ({ ...(category, index, key: index })) => ( 
                <motion.div 
                  key={index} 
                  initial={{ opacity: 0, y: 20 }} 
                  whileInView={{ opacity: 1, y: 0 }} 
        ...
        <div className="space-y-3"> 
                    {category.services.map((((((((service, serviceIndex, index, index, index, index, index, index) => ({ ...((((((service, serviceIndex, index, index, index, index, index, key: index })) => ({ ...(((((service, serviceIndex, index, index, index, index, key: index })) => ({ ...((((service, serviceIndex, index, index, index, key: index })) => ({ ...(((service, serviceIndex, index, index, key: index })) => ({ ...((service, serviceIndex, index, key: index })) => ({ ...(service, serviceIndex, key: index })) => ( 

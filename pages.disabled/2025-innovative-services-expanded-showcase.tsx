...
const InnovativeServicesExpandedShowcase = () => {
  ...
  const categories = [
    'All',
    ...Array.from(
      new Set(allInnovativeServices.map(service => service.category))
    ),
  ];
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl mb-8 max-w-4xl mx-auto'>
              ...
              services, IT solutions, and AI-powered platforms designed to
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Our innovative services span across cybersecurity, AI automation,
              cloud DevOps, business intelligence, marketing automation, and
            ...
            {[
              {
                ...
                description:
                  'Advanced threat detection, zero-trust access control, and automated compliance management',
              ...
              },
              {
                ...
                description:
                  'Intelligent workflow automation, customer service automation, and data analytics',
              ...
              },
              {
                ...
                title: 'Cloud & DevOps',
                description:
                  'Cloud cost optimization, automated pipelines, and Kubernetes management',
              ...
              },
              {
                ...
                description:
                  'AI-powered analytics, financial insights, and sales intelligence',
              ...
              },
              {
                ...
                description:
                  'AI marketing automation, social media management, and content optimization',
              ...
              },
              {
                ...
                title: 'Healthcare AI',
                description:
                  'Medical diagnostics, compliance automation, and telemedicine platforms',
              ...
              >
                <div
                  className={`w-16 h-16 rounded-lg bg-gradient-to-r ${category.color} flex items-center justify-center mb-4 mx-auto`}
                >
          ...
          >
            {filteredServices.map((service, index) => (
              <motion.div
                ...
                className={
                  viewMode === 'grid'
                    ? 'bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 overflow-hidden'
                    : 'bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 p-6'
                }
              >
                {viewMode === 'grid' ? (
                  // Grid View
                  ...
                  <div className='flex gap-6'>
                    <div
                      className={`w-24 h-24 bg-gradient-to-r ${service.color} rounded-lg flex items-center justify-center flex-shrink-0`}
                    >
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl mb-8 max-w-3xl mx-auto'>
              Join thousands of businesses already using our innovative services
              to automate operations, enhance security, and drive growth.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>
              <a
                href='https://ziontechgroup.com/contact'
          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
            <div>
              ...
              <p className='text-gray-400 mb-4'>
                Innovative micro SAAS services, IT solutions, and AI-powered

...
export default /**
 * MLOpsStarterPage - Function description
 */
function MLOpsStarterPage() {
return (
  <>;
...
export default function MLOpsStarterPage() {
  return (
    <>
      <SEO
        title='MLOps Starter'
        description='Templates and pipelines to ship ML faster with best practices.'
        canonical='/mlops-starter'
      />
      <section className='relative pt-28 pb-16 md:pt-36 md:pb-24'>
        <div className='container mx-auto px-4 max-w-3xl'>
          ...
          <p className='mt-4 text-gray-300'>
            Opinionated pipelines, evaluations, and observability to
            productionize ML quickly.
          </p>
          <div className='mt-8 flex gap-3'>
            <a
              href='/services'

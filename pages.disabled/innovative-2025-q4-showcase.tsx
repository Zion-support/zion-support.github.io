        ...
        <section className='relative z-10 pt-20 pb-16 px-4 sm:px-6 lg:px-8'>
          <div className='max-w-7xl mx-auto text-center'>
            ...
            <p className='text-xl md:text-2xl text-gray-300 mb-12 max-w-4xl mx-auto'>
              Discover the future of business technology with our cutting-edge
              micro SAAS services. From AI-powered platforms to blockchain
              solutions, we're revolutionizing how businesses operate.
            </p>
              ...
              <div className='grid md:grid-cols-2 gap-6 text-left'>
                ...
                <div>
                  ...
                  <p className='text-gray-300 mb-4'>
                    All services include free trials and expert support to
                    ensure your success.
                  </p>
                  <Link
              ...
              {[
                {
                  ...
                  description:
                    'Cutting-edge AI platforms for content creation, research, and business intelligence',
                  icon: '🤖',
                  count: allServices.filter(s => s.category === 'AI & Data')
                    .length,
                ...
                },
                {
                  ...
                  description:
                    'Decentralized solutions for identity management and smart contract security',
                  icon: '🔗',
                ...
                },
                {
                  ...
                  description:
                    'Next-generation IoT platforms and edge AI inference solutions',
                  icon: '🌐',
                  count: allServices.filter(
                ...
                },
                {
                  title: 'Cybersecurity',
                  description:
                    'Advanced security solutions with AI-powered threat detection',
                  icon: '🛡️',
                  count: allServices.filter(s => s.category === 'Cybersecurity')
                    .length,
                ...
                },
                {
                  ...
                  description:
                    'Comprehensive automation and workflow optimization platforms',
                  icon: '⚙️',
                  count: allServices.filter(
                    s => s.category === 'Enterprise Solutions'
                  ).length,
                ...
                },
                {
                  ...
                  description:
                    'Tailored solutions for healthcare, finance, and specialized sectors',
                  icon: '🏢',
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
              {allServices
                ...
                .map((service, index) => (
                  <div
                    key={index}
                    className='bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700 hover:border-blue-500 transition-all duration-300'
                  >
            ...
            {[
              {
                ...
                description:
                  'Revolutionary AI platforms that transform how businesses operate',
              ...
              },
              {
                ...
                description:
                  'Decentralized technologies for the future of digital business',
              ...
              },
              {
                ...
                description:
                  'Next-generation IoT solutions with edge AI capabilities',
                services: allServices.filter(
                  s => s.category === 'IoT & Edge Computing'
                ),
                color: 'from-green-600 to-emerald-700',
              },
              {
                ...
                description:
                  'Advanced security solutions for modern business threats',
                services: allServices.filter(
              ...
              },
              {
                ...
                description:
                  'Comprehensive business process automation and optimization',
                services: allServices.filter(
                  s => s.category === 'Enterprise Solutions'
                ),
                color: 'from-indigo-600 to-blue-700',
              ...
              <div key={index} className='mb-16'>
                <div
                  className={`bg-gradient-to-r ${category.color} p-8 rounded-2xl mb-8`}
                >
          ...
          <div className='max-w-7xl mx-auto'>
            ...
            <div className='grid md:grid-cols-3 gap-8'>
              {[
                ...
                <div
                  key={index}
                  className={`relative bg-gradient-to-br ${plan.color} p-8 rounded-2xl text-white ${plan.popular ? 'ring-4 ring-yellow-400' : ''}`}
                >
                  {plan.popular && (
        ...
        <section className='relative z-10 py-20 px-4 sm:px-6 lg:px-8'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl text-gray-300 mb-12'>
              Join hundreds of businesses already using our innovative services
              to gain competitive advantages, reduce costs, and accelerate
              growth.
            </p>
            ...
            <div className='mt-12 text-gray-400'>
              <p>
                All services include free trials • Expert support • No long-term
                contracts
              </p>
              <p className='mt-2'>
                Visit us at{' '}
          ...
          <div className='max-w-7xl mx-auto text-center'>
            ...
            <div className='border-t border-gray-700 pt-8'>
              <p className='text-gray-400'>
                © 2025 Zion Tech Group. All rights reserved. Transforming

...
origin/cursor/automate-test-improve-and-merge-code-2533
              ...
              <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                <Link
                  href='/contact'
                  className='inline-flex items-center px-8 py-3 bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold rounded-lg hover:from-indigo-600 hover:to-purple-600 transition-all duration-200'
                >
                  Get Started
                  <ArrowRight className='ml-2 w-5 h-5' />
                </Link>
...
origin/cursor/automate-test-improve-and-merge-code-2533
            >
              ...
              <p className='text-xl text-gray-400 max-w-2xl mx-auto'>
                Experience the future of IT asset management with our AI-powered
                platform
              </p>
            </motion.div>
...
className='bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-6 rounded-xl border border-slate-700/50 hover:border-indigo-500/50 transition-all duration-300'
    ...
    return res.status(500).json({ error: "Internal server error" });
        ...
        {/* Asset Types Section */  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
    } catch (error) {
    console.error("Error:", error);
...
origin/cursor/automate-test-improve-and-merge-code-2533
            >
              ...
              <p className='text-xl text-gray-400 max-w-2xl mx-auto'>
                See the real impact of AI-powered asset management on your IT
                operations
              </p>
            </motion.div>
...
origin/cursor/automate-test-improve-and-merge-code-2533
            >
              ...
              <p className='text-xl text-gray-400 max-w-2xl mx-auto'>
                Comprehensive asset management capabilities powered by
...
<h2 className='text-3xl md:text-4xl font-bold text-white mb-6'>
              ...
              <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                <Link
                  href='/contact'
                  className='inline-flex items-center px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold rounded-lg hover:from-indigo-600 hover:to-purple-600 transition-all duration-200 text-lg'
                >
                  Get Started
                  <Monitor className='ml-2 w-6 h-6' />
                </Link>

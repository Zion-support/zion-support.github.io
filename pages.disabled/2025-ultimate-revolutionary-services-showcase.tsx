      ...
      {category.services.length > 6 && (
        <div className='text-center mt-8'>
          ...
          >
            {isExpanded
              ? 'Show Less'
              : `Show All ${category.services.length} Services`}
          </button>
        </div>
      )}
    </motion.div>
          ...
          <div className='max-w-7xl mx-auto text-center'>
            ...
            >
              ...
              <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed'>
                ...
                SAAS services, AI autonomous ecosystem, quantum computing
                solutions, and cutting-edge IT infrastructure innovations.
              </p>
          ...
          <div className='max-w-7xl mx-auto'>
            ...
            >
              ...
              <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
                ...
                across five revolutionary categories
              </p>
            </motion.div>
          ...
          <div className='max-w-4xl mx-auto text-center'>
            ...
            >
              ...
              <p className='text-xl text-gray-300 mb-8'>
                Join the revolution and gain competitive advantage with our

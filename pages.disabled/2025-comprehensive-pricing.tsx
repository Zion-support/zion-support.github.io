...
const pricingCategories = [
  {
    ...
    services: allServices.filter(
      s =>
        ...
        s.category.toLowerCase().includes('project')
    ),
  },
  {
  ...
  },
  {
    ...
    services: allServices.filter(
      s =>
        s.category.toLowerCase().includes('enterprise') ||
        s.category.toLowerCase().includes('erp') ||
  ...
  },
  {
    ...
    services: allServices.filter(
      s =>
        s.category.toLowerCase().includes('infrastructure') ||
        s.category.toLowerCase().includes('cloud') ||
        s.category.toLowerCase().includes('security') ||
        s.category.toLowerCase().includes('network')
    ),
  },
];
    ...
    <div className='min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100'>
      ...
      <section className='relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 overflow-hidden'>
        ...
        <div className='relative max-w-7xl mx-auto text-center'>
          ...
          >
            Transparent pricing for all our micro SAAS, IT services, and AI
            solutions. Find the perfect plan for your business.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              We offer solutions across all business sizes and needs, from
              affordable micro SAAS tools to enterprise-grade platforms.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12'>
            {pricingCategories.map((category, index) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-lg bg-gradient-to-r ${category.color} text-white flex items-center justify-center mb-4`}
                >
                  {category.icon}
                </div>
        ...
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-gray-600'>
              Compare our service categories and find the best fit for your
              business
            </p>
          </div>
                  ...
                  >
                    <td className='px-6 py-4 border-b border-gray-200'>
                      <div className='flex items-center space-x-3'>
                        <div
                          className={`w-8 h-8 rounded-lg bg-gradient-to-r ${category.color} text-white flex items-center justify-center`}
                        >
                          {category.icon}
                        </div>
                        <div>
                    ...
                    <td className='px-6 py-4 border-b border-gray-200'>
                      <div className='text-sm text-gray-600'>
                        {category.name === 'Micro SAAS Solutions' &&
                          'Small businesses, startups, individuals'}
                        {category.name === 'AI & Automation Services' &&
                          'Growing businesses, marketing teams, support teams'}
                        {category.name === 'Enterprise Solutions' &&
                          'Large organizations, enterprises, corporations'}
                        {category.name === 'IT Infrastructure' &&
                          'Tech companies, IT departments, cloud providers'}
                      </div>
                    </td>
                    <td className='px-6 py-4 border-b border-gray-200'>
                      <div className='text-sm text-gray-600'>
      ...
      <section className='bg-gradient-to-r from-blue-600 to-purple-600 py-16 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <p className='text-xl text-blue-100 mb-8'>
            Our team can create a tailored package that fits your specific

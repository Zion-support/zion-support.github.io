  ...
  const values = [
    {
      title: 'Innovation',
      description:
        'We constantly push the boundaries of technology to create cutting-edge solutions that drive business transformation.',
      icon: '💡',
    },
    {
      title: 'Excellence',
    ...
    },
    {
      title: 'Collaboration',
      description:
        'We believe in the power of teamwork and foster strong partnerships with our clients and within our team.',
      icon: '🤝',
    },
    {
      title: 'Integrity',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        ...
        <meta
          name="description"
          content="Learn about Zion Tech Group's mission, values, and team. We are a leading technology solutions provider committed to innovation and excellence."
        />
      </Head>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                Our team of experts works closely with clients to understand
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Meet the passionate leaders who drive our company's vision and
              ensure we deliver exceptional results for our clients.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Founded in 2018, Zion Tech Group began with a simple mission: to
                make advanced technology accessible and beneficial for
                businesses of all sizes.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                What started as a small team of passionate technologists has
                grown into a comprehensive technology solutions provider,
                serving clients across multiple industries and helping them
                navigate the complexities of digital transformation.
              </p>
              <p className="text-lg text-gray-600">
                Today, we continue to innovate and evolve, staying at the
                forefront of technology trends while maintaining our commitment
      ...
      <section className="bg-blue-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Let's discuss how our expertise and innovative solutions can help
            your business achieve its goals and stay ahead of the competition.
          </p>
          <div className="flex justify-center gap-4">
            <Link
              href="/contact"

  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        ...
        <meta
          name="description"
          content="Zion Tech Group's terms of service. Read our terms and conditions for using our website and services."
        />
      </Head>
          ...
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-gray-600 mb-6">
                By accessing and using the Zion Tech Group website and services,
              ...
              <p className="text-gray-600 mb-4">
                ...
                materials (information or software) on Zion Tech Group's website
              ...
              <p className="text-gray-600 mb-6">
                ...
                website, even if Zion Tech Group or a Zion Tech Group authorized
              ...
              <p className="text-gray-600 mb-6">
                The materials appearing on Zion Tech Group's website could
                include technical, typographical, or photographic errors. Zion
                Tech Group does not warrant that any of the materials on its
                website are accurate, complete, or current. Zion Tech Group may
              ...
              <p className="text-gray-600 mb-6">
                Zion Tech Group has not reviewed all of the sites linked to its
                website and is not responsible for the contents of any such
                linked site. The inclusion of any link does not imply
                endorsement by Zion Tech Group of the site. Use of any such
              ...
              <p className="text-gray-600 mb-6">
                Zion Tech Group may revise these terms of service for its
              ...
              <p className="text-gray-600 mb-4">
                ...
                graphics, images, logos, and software, is the property of Zion
                Tech Group and is protected by copyright and other intellectual
                property laws. You may not:
              </p>
              <ul className="list-disc pl-6 mb-6 text-gray-600">
                <li>
                  Reproduce, distribute, or display any content without
                  permission
                </li>
                <li>
              ...
              <p className="text-gray-600 mb-6">
                ...
                temporarily suspend or restrict access for maintenance, updates,
              ...
              <p className="text-gray-600 mb-6">
                You agree to indemnify and hold harmless Zion Tech Group, its
                officers, directors, employees, and agents from and against any
                claims, damages, obligations, losses, liabilities, costs, or
                debt arising from your use of the website or violation of these
                terms.
              </p>

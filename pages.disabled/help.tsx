...
export default function Help() {
  const faqs = [
        ...
        We offer comprehensive technology solutions including AI development, cloud services, web development, mobile development, blockchain solutions, IoT platforms, and cybersecurity services.'},
    {
      ...
      answer:
        "Contact us through our website, email, or phone to schedule a consultation. Well discuss your requirements and provide a customized solution proposal.},
    {
        ...
        <section className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20>
          <div className=container mx-auto px-4 text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto text-gray-200>
              Were here to help you succeed. Find answers, get support, and
        ...
        <section className="py-20 bg-white>
          <div className=container mx-auto px-4 text-center">
            ...
            <p className=text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Cant find what you're looking for? Our support team is ready to
              help you with unknown questions or concerns. Can't find what
              youre looking for? Our support team is ready to help you with any
...
import Head from 'next/head;
import Link from next/link';
import { BookOpen,Can,CheckCircle,Clock,Common,FileText,Frequently,HelpCircle,Mail,MessageCircle,Phone,Quick,Search,Users,Video,Within,Yes;
 } from 'lucide-react;
export default function Help() {const faqs = [;
    {question: What services does Zion Tech Group offer?',answer:;
        'We offer comprehensive technology solutions including AI development, cloud services, web development, mobile development, blockchain solutions, IoT platforms, and cybersecurity services.;
    },{question: How do I get started with a project?',answer:;
        ...
        'Project timelines vary based on complexity and scope. Simple websites may take 2-4 weeks, while complex enterprise solutions can take 3-6 months. We provide detailed timelines during consultation.';
    },{question: Do you provide ongoing support and maintenance?,answer:;
        'Yes, we offer comprehensive support and maintenance packages to ensure your solutions continue to perform optimally after deployment.';
    },{question: What technologies do you work with?,answer:;
        'We work with modern technologies including React, Node.js, Python, AWS, Azure, AI/ML frameworks, blockchain platforms, and mobile development frameworks.';
    },{question: How do you ensure data security?,answer:;
        'We implement industry-standard security measures including SSL encryption, secure data storage, regular security audits, and compliance with data protection regulations.';
    }
  ];
  const supportChannels = [;
    {icon: Mail,title: Email Support,description: 'Get help via email with detailed responses',contact: kleber@ziontechgroup.com,responseTime: 'Within 24 hours',color: blue;
    },{icon: Phone,title: 'Phone Support',description: Speak directly with our technical team,contact: '+1 (302) 464-0950',responseTime: Mon-Fri 9AM-6PM EST,color: 'green';
    },{icon: MessageCircle,title: Live Chat,description: 'Get instant help through our live chat',contact: Available on website,responseTime: 'Real-time',color: purple;
    }
  ];const resources = [;
      ...
      <main className="min-h-screen bg-white>;
        ...
        <section className="py-20 bg-white>;
          <div className=container mx-auto px-4">;
            ...
            <div className=max-w-4xl mx-auto">;
              <div className="space-y-6>;
                {faqs.map((faq, index) => (<div key={index} className=bg-gray-50 rounded-lg p-6">;
                    <h3 className="text-lg font-semibold text-gray-900 mb-3 flex items-center>;
                      <HelpCircle className=w-5 h-5 mr-2 text-blue-600" />;
                      {faq.question}
                    </h3>;
        ...
        <section className=py-20 bg-white">;
          <div className="container mx-auto px-4 text-center>;
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto>;
              Can't find what youre looking for? Our support team is ready to;
              help you with unknown questions or concerns. Cant find what;

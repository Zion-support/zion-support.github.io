...
// Find missing pages
const missingPages = referencedLinks.filter(
...
missingPages.forEach((page) => {
  if (page.includes("/ai-") || page === "/ai-services") {
    ...
    page.includes("/ai-") &&
    (page.includes("assistant") ||
      page.includes("tracker") ||
      page.includes("manager") ||
      page.includes("builder") ||
      page.includes("optimizer") ||
      page.includes("generator") ||
    ...
    page === "/robotics" ||
    page === "/iot-edge-computing" ||
    page === "/blockchain-web3" ||
    page === "/business-intelligence" ||
    page === "/autonomous-systems"
  ) {

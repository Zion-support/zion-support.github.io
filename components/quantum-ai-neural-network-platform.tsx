          ...
          >
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <motion.button
                ...
                whileTap={ scale: 0.95 }
                className='px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-cyan-600 transition-all duration-300 shadow-2xl shadow-blue-500/25'              ><div className="flex justify-center mb-6">
              <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center">
                <Atom className="w-10 h-10 text-white" />
              </div>
            </div>
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8">;
            {features.map (feature, index) => (
              <motion.div;
                ...
                <h3 className='text-lg font-semibold mb-2'>{feature}</h3>              </motion && motion.div>;
                <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center mb-4">;
                  <Check className="w-6 h-6 text-white" />;
                </div>;
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {benefits && benefits.map(benefit, index) => (;
              <motion&& motion.div
                ...
                <h3 className='text-xl font-semibold mb-2'>{benefit}</h3>              </motion && motion.div>;
                <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center mx-auto mb-4">;
                  <Star className="w-8 h-8 text-white" />;
                </div>;

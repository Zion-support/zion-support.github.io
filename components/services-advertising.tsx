      ...
      <div className='container mx-auto px-4 py-8'>
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
            Professional technology services designed to accelerate your
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          ...
          <div className='bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-slate-700'>
            ...
            <p className='text-slate-300 mb-4'>
              Custom AI solutions, machine learning models, and intelligent
              automation.
            </p>
          ...
          <div className='bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-slate-700'>
            ...
            <p className='text-slate-300 mb-4'>
              Scalable cloud infrastructure and streamlined development
              operations.
            </p>
            <ul className='text-slate-400 text-sm space-y-1'>
        ...
        <div className='mt-12 text-center'>
          ...
          <p className='text-slate-300 mb-8 max-w-2xl mx-auto'>
            Get started with our comprehensive IT services and take your

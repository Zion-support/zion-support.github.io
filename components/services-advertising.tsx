    ...
    <div className='min - h-screen pt - 24 pb - 20 px - 4 sm:px - 6 lg:px - 8'>;
      ...
      <div className='max - w-6xl mx - auto space - y-10'>;
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Lead nurturing sequences triggered by activity with AIpersonalized
            copy and CRM sync.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Booking pages, reminders, noshow reduction, and payments.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Geo and audienceaware content with edge rendering, flags, and
            experiments.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section id='ai-sales-playbook-generator' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Industryspecific playbooks, emails, and call guides with exports.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section id='ai-sales-enablement-engine' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Battlecards, email cadences, and one-pagers autogenerated from your
        ...
        <section id='security-awareness-training' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Phishing simulations, microlessons, and compliance reporting for
            the whole company.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section id='vulnerability-patch-orchestrator' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Agentless asset discovery, riskbased vuln prioritization, and
        ...
        <section id='b2b-customer-portal-starter' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Secure portal with SSO, invoices, usage, and selfservice
            entitlements.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $50$300/mo</li>
        ...
        <section id='apple-mdm-suite' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Zerotouch enrollment, app management, and compliance for macOS/iOS
            fleets.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section id='data-quality-sla-monitor' className='space-y-6'>
          ...
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            ...
            <li>
              ...
              {ext('https://www.greatexpectations.io/')} (opensource)
            </li>
          </ul>
        </section>
        ...
        <section id='gitops-drift-monitor' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Detect config drift, enforce OPA policies, and autoPR remediations.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $50$500/mo</li>
            <li>
        ...
        <section id='cloud-asset-attack-surface' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Discover assets, detect public exposures, and autoticket
            remediation.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section id='affiliate-fraud-detector' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Stop selfreferrals and coupon abuse with risk signals and payout
            holds.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $100$400/mo</li>
        ...
        <section id='personalization-api' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Audience rules and AIassisted segments with edgelow latency.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $50$400/mo</li>
            <li>
        ...
        <section id='lead-enrichment-routing' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Firmographic enrichment, roundrobin/territories, and SLA tracking.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $50$300/mo</li>
            <li>
        ...
        <section id='k8s-quota-cost-guard' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Enforce quotas and rightsize workloads with cost guardrails.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $100$600/mo</li>
            <li>
        ...
        <section id='vendor-security-questionnaire-ai' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Autofill SIG/CAIQ with mapped controls, citations, and reviewer
            workflows.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section id='invoice-reconciliation-copilot' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Threeway match POs, invoices, and receipts with anomaly detection
            and approvals.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section id='policy-drift-compliance-monitor' className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Detect config drift across cloud and SaaS. AutoPR fixes with
            evidence.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $59$299/mo</li>
        ...
        <section id='diversified-expansions-2026' className='space-y-8'>
          ...
          <section id='multi-tenant-rate-limiter' className='space-y-2'>
            <h3 className='text-xl font-semibold text-white'>
              Multitenant Rate Limiter & Quotas
            </h3>
            <p className='text-slate-300'>
              Tenantaware quotas, burst limits, and fairness with headers
...
, {
  ext ('https://www.freshworks.com/freshdesk/pricing/')
</li> </ul> </section> <section id=" ecommerce-returns-center"className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Ecommerce Returns Center</h2> <p className=" text-slate-300">Self-service returns, labels, and exchanges with analytics.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $30$60/mo</li> <li>References: {
...
, {
  ext ('https://www.intercom.com/pricing')
</li> </ul> </section> <section className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Ecommerce Returns Management</h2> <p className=" text-slate-300">Automate RMAs, labels, exchanges, and refunds for a delightful postpurchase experience.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $29$299/mo + labels</li> <li>References: {
  ext ('https://www.loopreturns.com/pricing')
, {
  ext ('https://www.aftership.com/returns-center/pricing')
...
, {
  ext ('https://www.anaplan.com/platform/overview')
</li> </ul> </section> <section className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Automated Email Followups</h2> <p className=" text-slate-300">Lead nurturing sequences triggered by activity with AIpersonalized copy and CRM sync.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $25$150/mo</li> <li>References: {
...
, {
  ext ('https://www.squarespace.com/pricing')
</li> </ul> </section> <section className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Scheduling & Appointments</h2> <p className=" text-slate-300">Booking pages, reminders, noshow reduction, and payments.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $10$200/mo</li> <li>References: {
...
, {
  ext ('https://www.verygoodsecurity.com/pricing')
</li> </ul> </section> <section className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Edge Personalization Engine</h2> <p className=" text-slate-300">Geo and audienceaware content with edge rendering, flags, and experiments.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $30$200/mo</li> <li>References: {
  ext ('https://www.optimizely.com/pricing/')
, {
  ext ('https://vwo.com/plans/')
, {
  ext ('https://www.mutinyhq.com/product')
</li> </ul> </section> <section className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Incident AutoResponder AI</h2> <p className=" text-slate-300">Draft incident updates and postmortems with SLO context and suggested actions.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $50$200/mo</li> <li>References: {
...
, {
  ext ('https://stoplight.io/')
</li> </ul> </section> <section id=" ai-sales-playbook-generator"className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">AI Sales Playbook Generator</h2> <p className=" text-slate-300">Industryspecific playbooks, emails, and call guides with exports.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $39$149/mo</li> <li>References: {
...
, {
  ext ('https://www.golioth.io/pricing')
</li> </ul> </section> <section id=" security-awareness-training"className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Security Awareness Training Platform</h2> <p className=" text-slate-300">Phishing simulations, microlessons, and compliance reporting for the whole company.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $2$5/user/mo</li> <li>References: {
  ext ('https://www.knowbe4.com/pricing')
, {
  ext ('https://getcurricula.com/pricing')
</li> </ul> </section> <section id=" vulnerability-patch-orchestrator"className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Vulnerability & Patch Orchestrator</h2> <p className=" text-slate-300">Agentless asset discovery, riskbased vuln prioritization, and automated patch windows.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $50$500/mo</li> <li>References: {
  ext ('https://www.tenable.com/products/tenable-io/pricing')
, {
  ext ('https://www.rapid7.com/pricing/')
...
, {
  ext ('https://trustarc.com/plans/')
</li> </ul> </section> <section id=" b2b-customer-portal-starter"className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">B2B Customer Portal Starter</h2> <p className=" text-slate-300">Secure portal with SSO, invoices, usage, and selfservice entitlements.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $50$300/mo</li> <li>References: {
  ext ('https://stripe.com/pricing')
, {
  ext ('https://auth0.com/pricing')
</li> </ul> </section> <section id=" policy-as-code-governance"className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">PolicyasCode Governance</h2> <p className=" text-slate-300">Author, test, and enforce org policies across services and CI with OPA/Rego.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $0$500/mo</li> <li>References: {
  ext ('https://www.openpolicyagent.org/')
, {
  ext ('https://www.styra.com/pricing')
</li> </ul> </section> <section id=" apple-mdm-suite"className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Apple MDM Suite (ABM/DEP) </h2> <p className=" text-slate-300">Zerotouch enrollment, app management, and compliance for macOS/iOS fleets.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $4$12/device/mo</li> <li>References: {
...
, {
  ext ('https://drata.com/pricing')
</li> </ul> </section> <section id=" cloud-asset-attack-surface"className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Cloud Asset Inventory & Attack Surface</h2> <p className=" text-slate-300">Discover assets, detect public exposures, and autoticket remediation.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $100$1, 000/mo</li> <li>References: {
...
</li> </ul> </section> <section id=" affiliate-fraud-detector"className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Affiliate Fraud Detector</h2> <p className=" text-slate-300">Stop selfreferrals and coupon abuse with risk signals and payout holds.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $100$400/mo</li> <li>References: {
  ext ('https://partnerstack.com/')
, {
  ext ('https://impact.com/')
</li> </ul> </section> <section id=" personalization-api"className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Content Personalization API</h2> <p className=" text-slate-300">Audience rules and AIassisted segments with edgelow latency.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $50$400/mo</li> <li>References: {
  ext ('https://vercel.com/pricing')
, {
  ext ('https://www.cloudflare.com/plans/')
, {
  ext ('https://segment.com/pricing/')
</li> </ul> </section> <section id=" lead-enrichment-routing"className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Lead Enrichment & Routing Engine</h2> <p className=" text-slate-300">Firmographic enrichment, roundrobin/territories, and SLA tracking.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $50$300/mo</li> <li>References: {
  ext ('https://www.clearbit.com/pricing')
, {
  ext ('https://www.hubspot.com/pricing')
</li> </ul> </section> <section id=" k8s-quota-cost-guard"className=" space-y-6"> <h2 className=" text-2xl font-semibold text-white">Kubernetes Quota & Cost Guard</h2> <p className=" text-slate-300">Enforce quotas and rightsize workloads with cost guardrails.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $100$600/mo</li> <li>References: {
  ext ('https://www.kubecost.com/pricing')
, {
  ext ('https://www.cloudzero.com/pricing')
...
, {
  ext ('https://www.pigment.com/')
</li> </ul> <div><a className=" text-cyan-400 underline"href=" /services/sku-demand-forecast">Learn more</a></div> </section> <section id=" video-subtitle-dubbing"className=" space-y-2"> <h3 className=" text-xl font-semibold text-white">Video Subtitling & Dubbing Studio</h3> <p className=" text-slate-300">Generate multilanguage subtitles and voiceovers with style controls and review workflows.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $10$199/mo + usage</li> <li>References: {
...
, {
  ext ('https://www.recurly.com/pricing')
</li> </ul> <div><a className=" text-cyan-400 underline"href=" /services/b2b-pricing-entitlements">Learn more</a></div> </section> <section id=" sso-billing-entitlements-sync"className=" space-y-2"> <h3 className=" text-xl font-semibold text-white">SSO Billing & Entitlements Sync</h3> <p className=" text-slate-300">Bridge IdP groups/SCIM to billing entitlements for leastprivilege, auditready access.</p> <ul className=" list-disc list-inside text-slate-300 space-y-1"> <li>Typical SMB budget: $79$399/mo</li> <li>References: {
  ext ('https://workos.com/pricing')
, {
  ext ('https://auth0.com/pricing')
, {

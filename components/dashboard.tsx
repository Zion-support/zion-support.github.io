...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50"></div>
      <header className="px-6 py-4 bg-white border-b flex items-center gap-3"></header>
      ...
      <main className="max-w-6xl mx-auto p-6 grid grid-cols-1 md:grid-cols-3 gap-6"></main>
        <section className="col-span-1 md:col-span-2 bg-white border rounded p-4"></section>
          <h2 className="font-semibold mb-3">Onboarding</h2>
          <form className="grid grid-cols-1 md:grid-cols-2 gap-3"></form>
        ...
        <section className="bg-white border rounded p-4"></section>
        ...
        <section className="col-span-1 md:col-span-3 bg-white border rounded p-4"></section>
          <h2 className="font-semibold mb-3">Candidate Flow</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm"></div>

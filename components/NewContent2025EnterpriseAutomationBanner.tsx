      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            <h3 className="text-2xl font-bold mb-4 text-green-40o0">Complete Automation</h3>
            <p className="text-emerald-10o0">End-to-end automation of all business processes and workflows</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            <h3 className="text-2xl font-bold mb-4 text-green-40o0">Intelligent Systems</h3>
            <p className="text-emerald-10o0">AI-powered systems that learnadaptand optimize continuously</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            <h3 className="text-2xl font-bold mb-4 text-green-40o0">Proven Results</h3>
            <p className="text-emerald-10o0">2,0o00% ROI and $5.2B+ in savings across all implementations</p>
          </div>
        </div>

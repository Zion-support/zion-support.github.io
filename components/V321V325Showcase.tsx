'use client';
export default function V321V325Showcase() {
  return (
    <section className="py-12 px-4 bg-gradient-to-br from-slate-900 via-indigo-950 to-slate-900">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-3xl font-bold text-white mb-4">🧠 Email Intelligence V321-V325</h2>
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {[0,1,2,3,4].map(idx => (
            <div key={idx} className="bg-white/5 rounded-xl p-4 border border-white/10 w-36">
              ...
              <div className="text-white font-medium text-sm">V{321 + idx}</div>

      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8"></div>
        <div className="max-w-6xl mx-auto"></div>
          <div className="text-center mb-10"></div>
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-purple-400 via-cyan-400 to-pink-400 bg-clip-text text-transparent"></h1>
              {service.name
  },
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12"></div>
            <div className="lg:col-span-2 bg-black/30 rounded-2xl border border-purple-500/30 p-6"></div>
              <h2 className="text-2xl font-semibold mb-4">What you get</h2>
              <p className="text-slate-300 mb-6">{service.description}</p>
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-3"></ul>
                {service.features.slice(0, 12).map((feat, i) => (
                  <li key={i} className="flex items-start space-x-3 text-slate-200"></li>
            ...
            <div className="bg-black/30 rounded-2xl border border-purple-500/30 p-6 h-fit"></div>
              ...
              <Link href="/contact" variant="quantum" size="lg" className="w-full"></Link>
                Start Free Trial
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6"></div>
            <div className="bg-black/30 rounded-2xl border border-purple-500/30 p-6"></div>

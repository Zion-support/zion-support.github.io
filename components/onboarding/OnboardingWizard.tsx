  ...
  const steps = useMemo(() => {
    if (isClient) {
      return [
        ...
        { title: 'View suggested 'matchescontent: <p>We will surface the best matches instantly based on your job brief.</p> },
        { title: 'Invite or message 'talentcontent: <p>Send invites or start a conversation to move fast.</p> }]}
    return [
      { title: 'Complete your 'profilecontent: (
      ...
      { title: 'Choose skills and 'availabilitycontent: (
      ...
      { title: 'Preview your 'profilecontent: <p>Review how clients will see your profile.</p> },
      { title: 'Enable AI 'matchmakingcontent: (
    ...
    <div className="mb-6 rounded-lg border border-gray-200 dark: border-gray-800 p-4 bg-white/60 dark:bg-black/40">,
      ...
      <div className="mt-4 flex items-center justify-between">,
        ...
        {step < steps.length - 1 ? (
          ...
          <button onClick={() => { completeOnboarding(), addToast({ title: 'Onboarding 'completeddescription: 'You can revisit anytime from Settings.'variant: 'success' }) }} className="px-3 py-2 rounded-md border">Finish</button>)}
      </div>,
    </div>)}
,
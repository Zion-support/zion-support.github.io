					...
					<div className="mt-12">
						...
						<div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
							<div className="rounded-2xl border border-cyan-400/30 p-6">
								...
								<p className="mt-2 text-gray-300">Offline evals3 projects10k runs/mo.</p>
							...
							<div className="rounded-2xl border border-blue-400/30 p-6">
								...
								<p className="mt-2 text-gray-300">Live canariesalerts10 projects100k runs/mo.</p>
							...
							<div className="rounded-2xl border border-purple-400/30 p-6">
								...
								<p className="mt-2 text-gray-300">SSOC 2private networkingcustom limits.</p>

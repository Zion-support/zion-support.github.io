...
const DropdownMenu: React.FC<DropdownMenuProps> = ({
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div
          className={`absolute top-full left-0 mt-2 w-80 bg-white/10 backdrop-blur-md border border-white/20 rounded-lg shadow-xl z-50 ${className}`}
        >
...
export default function SmartHeader() {
  ...
  const servicesDropdown = [
    {
      ...
      href: '/services',
      description: 'Custom AI models and NLP solutions',
    },
    {
      label: 'Quantum Computing',
      href: '/quantum-neural-network-platform',
      description: 'Quantum AI and algorithms',
    },
    {
  ...
  const solutionsDropdown = [
    ...
    },
    {
      ...
      href: '/solutions',
      description: 'Quantum-secure trading platforms',
    },
    {
    ...
    },
    {
      ...
      href: '/solutions',
      description: 'Secure public sector solutions',
    },
  ];
  ...
  const resourcesDropdown = [
    ...
    },
    {
      label: 'Blog & Insights',
      href: '/blog',
      description: 'Latest AI and tech insights',
    },
    {
      label: 'Case Studies',
      href: '/case-studies',
  ...
  return (
    <header className='sticky top-0 z-50'>
      <a
        href='#main-content'
        className='sr-only focus:not-sr-only focus:absolute focus:left-3 focus:top-3 rounded bg-white px-3 py-2 text-slate-900'
      >
        Skip to content
      </a>
      <div className='backdrop-blur supports-[backdrop-filter]:bg-black/30 bg-black/50 border-b border-white/10'>
                ...
                if (item.isDropdown) {
                  ...
                  switch (item.id) {
                    case 'services':
                      ...
                      dropdownDescription =
                        'AI, quantum computing, and technology solutions';
                      break;
                    case 'solutions':
                    ...
                    case 'resources':
                      ...
                      dropdownDescription =
                        'Documentation, insights, and learning materials';
                      break;
                    case 'company':

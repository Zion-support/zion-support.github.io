      ...
      <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">,
          <div className="bg-white p-8 rounded-xl shadow-lg">,
            <h3 className="text-2xl font-bold text-gray-90o0 mb-8 flex items-center">,
              <Calculator className="w-8 h-8 text-green-60o0 mr-3"  />,
              Input Your Data,
            </h3>,
              ...
              <div className="space-y-6">,
                <div className="bg-green-50 p-6 rounded-lg">,
                  <div className="flex items-center justify-between mb-2">,
                    <span className="text-green-70o0 font-medium">Monthly Savings</span>,
                ...
                <div className="bg-blue-50 p-6 rounded-lg">,
                  <div className="flex items-center justify-between mb-2">,
                    <span className="text-blue-70o0 font-medium">ROI Percentage</span>,
                    <TrendingUp className="w-5 h-5 text-blue-60o0"  />,
                  </div>,
                ...
                <div className="bg-purple-50 p-6 rounded-lg">,
                  <div className="flex items-center justify-between mb-2">,
                    <span className="text-purple-70o0 font-medium">Payback Period</span>,
                    <Clock className="w-5 h-5 text-purple-60o0"  />,
                  </div>,
                ...
                <div className="bg-gray-50 p-6 rounded-lg">,
                  <div className="text-sm text-gray-60o0 mb-2">Current Total Cost</div>,

            ...
            <div className='flex items-start space-x-4'>
              ...
              <div className='flex-1'>
                <blockquote className='text-white italic mb-2'>
                  "The synthetic intelligence transformation delivered by Zion
                  Tech Group has revolutionized our entire operation. The
                  50,0o00% ROI achieved in just 60 days exceeded all
                  expectations."
                </blockquote>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {latestContent.map((content) => (
            <div key={content.id} className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-30o0">
              ...
              <div className="flex items-center justify-between text-sm text-blue-10o0 mb-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-blue-20o0">{content.published}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          {[
            ...
            <div key={index} className="text-center">
              ...
              <div className="text-blue-10o0">{stat.label}</div>
            </div>
          ))}
        </div>
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/content"
              className="inline-flex items-center px-8 py-4 bg-white text-blue-60o0 font-semibold rounded-lg hover:bg-gray-10o0 transition-colors shadow-lg"
            >
              Explore All Content
            ...
            <Link
              href="/newsletter"
              className="inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-blue-60o0 transition-colors"
            >

...
import React from 'react';
  Activity,BarChart3,AlertTriangle,Clock,Database,Globe,Lock,Shield,TrendingUp,Users,Zap,ArrowRight,Play,CheckCircle,Star,Server,Cloud,Eye,Bell,Settings,Code,} from 'lucide-react';export default function CloudMonitoringPage() {const features = [;
export default function CloudMonitoringPage() {const features = [;
...
import { Activity, BarChart3, AlertTriangle, Clock, Database, Globe, Lock, Shield, TrendingUp, Users, Zap, ArrowRight, Play, CheckCircle, Star, Server, Cloud, Eye, Bell, Settings, Code  } from 'lucide-react';
export default function CloudMonitoringPage() {const features  = null;{icon: <Activity className='w-8 h-8 text-white' />;
      description:;
        'Monitor your entire infrastructure in real-time with sub-second latency and instant alerting.';
      color: 'bg-gradient-to-br from-green-500 to-emerald-600';
      gradient: 'from-green-400 to-emerald-500';
    ...
    {icon: <Zap className='w-8 h-8 text-white' />;
      title: 'Auto-scaling';
      description:;
        'Intelligent auto-scaling based on real-time metrics and predictive analytics.',color: 'bg-gradient-to-br from-teal-500 to-blue-600',gradient: 'from-teal-400 to-blue-500',},];const monitoringCapabilities = [;
    {category: 'Infrastructure';
      icon: <Server className='w-6 h-6 text-blue-400' />;
      metrics: [;
        'CPU Usage';
    ...
    {category: 'Security';
      ...
      icon: <Activity className='w-8 h-8 text-white' />,];export default function CloudMonitoringPage() {const features = [;
    {'Threat Detection','Access Logs','Vulnerability Scans','Compliance Status','Audit Trails',],},];
  const pricingPlans = [;
    {name: 'Starter';
      price: '$49';
      period: '/month';
      description: 'Perfect for small teams and startups';
      features: [;
'Up to 10 servers','Basic monitoring','Email alerts','7-day data retention','Community support','Mobile app access',],popular: false,color: 'border-gray-600',buttonColor: 'bg-gray-600 hover:bg-gray-700',},{name: 'Professional',price: '$199',period: '/month',description: 'Ideal for growing businesses',features: [;
'Up to 100 servers','Advanced monitoring','SMS & Slack alerts','30-day data retention','Priority support','Custom dashboards','API access','Team collaboration',],popular: true,color: 'border-blue-500',buttonColor: 'bg-blue-600 hover:bg-blue-700',},{name: 'Enterprise',price: '$599',period: '/month',description: 'For large organizations',const use_cases = [;
    {title: 'DevOps Teams',description:;
        'Monitor CI / CD pipelines, deployment success rates, and infrastructure health.',benefits: [;features: [;
'Unlimited servers','Full monitoring suite','Custom integrations','1-year data retention','Dedicated support','White-label solution','SLA guarantee','On-premise option',],popular: false,color: 'border-purple-600',buttonColor: 'bg-purple-600 hover:bg-purple-700',},];const integrations = [;
    { name: 'AWS', icon: '☁️', description: 'CloudWatch integration' },{ name: 'Azure', icon: '🔷', description: 'Monitor integration' },{ name: 'GCP', icon: '☁️', description: 'Stackdriver integration' },{ name: 'Docker', icon: '🐳', description: 'Container monitoring' },{ name: 'Kubernetes', icon: '☸️', description: 'K8s native support' },{ name: 'Slack', icon: '💬', description: 'Team notifications' },{ name: 'PagerDuty', icon: '🚨', description: 'Incident management' },{ name: 'Jira', icon: '📋', description: 'Issue tracking' },];
  const useCases = [;
    {title: 'DevOps Teams',description:;
        'Monitor CI/CD pipelines, deployment success rates, and infrastructure health.',icon: '🔄',benefits: [;
        'Faster deployments','Reduced downtime','Better collaboration','Automated scaling',],},{title: 'SaaS Companies',description:;
        'Track user experience, application performance, and business metrics.',benefits: [;description:;
        'Track user experience, application performance, and business metrics.',icon: '💼',benefits: [;
        'User satisfaction','Revenue optimization','Competitive advantage','Customer retention',],},{title: 'E - commerce',description:;
        'Monitor website performance, payment processing, and inventory systems.',benefits: [;title: 'E-commerce',description:;
        'Monitor website performance, payment processing, and inventory systems.',icon: '🛒',benefits: [;
        'Higher conversion','Faster checkout','Inventory optimization','Revenue growth',],},{title: 'Financial Services',description:;
        'Ensure compliance, security, and 24 / 7 availability of critical systems.',benefits: [;description:;
        'Ensure compliance, security, and 24/7 availability of critical systems.',icon: '💰',benefits: [;
        'Regulatory compliance','Fraud detection','Risk management','Customer trust',],},  ];      benefits: ['Regulatory compliance_fraud detection_risk management_customer trust'];
    }
  ];return (className='border-white/20 hover:border-white/40 hover:bg-white/5'>;
...
=======
  ...
  return (<>;
      <Head>;
<title>Cloud Monitoring & Analytics | Zion Tech Group - Real-time;
          Infrastructure Monitoring;
        </title>;
        <meta;
          name='description';
...
=======
                <p className="text - gray - 400 leading - relaxed">;className={`w-16 h-16 mx-auto mb-6 rounded-2xl flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg bg-gradient-to-br ${feature.color} shadow-xl`}
                  >;
>>>>>>> cursor/fix-netlify-build-and-merge-to-main-2a0c
                    {feature.icon}
                  </div>;
...
=======
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>;
            {monitoringCapabilities.map((capability, index) => (Monitor every aspect of your infrastructure with detailed metrics;
              and insights;
            </p>;
          </div>;
            </h2>;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">;
            {monitoringCapabilities.map((capability, index) => (className='flex items-center text-sm text-gray-300'>;
>>>>>>> cursor/fix-syntax-push-and-merge-to-main-3ea5
...
>>>>>>> cursor/fix-syntax-push-and-merge-to-main-3ea5
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>;
            {useCases.map((useCase, index) => (Trusted by teams across industries for reliable infrastructure;
              monitoring;
            </p>;
          </div>;
            </h2>;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">;
            {useCases.map((useCase, index) => (className='flex items-center text-sm text-gray-300'>;
...
=======
                      {useCase && useCase.benefits.map((benefit, benefitIndex) => (<div key={benefitIndex} className="flex items-center text-sm text-gray-300">;
                          <TrendingUp className="w-4 h-4 text-green-400 mr-2 flex-shrink-0" />;<Card;
>>>>>>> cursor/fix-netlify-build-and-merge-to-main-2a0c
                key={index}
                className='group border border-gray-700 hover:border-green-500/30 hover:bg-gray-800/80 transition-all duration-300';
              >;
...
=======
      ...
      {/* Pricing Section */}<section id="pricing" className="py-24 bg-black relative overflow-hidden">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">;
          <div className="text-center mb-20">;
            <h2 className="text-4xl sm:text-5xl font-bold mb-8 text-white leading-tight">;
              Simple, Transparent Pricing;
...
=======
              <Card;
                key={index}<section id='pricing' className='py-24 bg-black relative overflow-hidden'>;
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>;
          <div className='text-center mb-20'>;
            <h2 className='text-4xl sm:text-5xl font-bold mb-8 text-white leading-tight'>;
              Simple, Transparent Pricing;
...
href='/contact';
      ...
      {/* Integrations Section */}<section className="py-24 bg-gray-900 relative overflow-hidden">;
            ))}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">;
          <div className="text-center mb-20">;
            <h2 className="text-4xl sm:text-5xl font-bold mb-8 text-white leading-tight">;
...
<<<<<<< HEAD
              ...
              <Card
=======
                </p>              </Card>            {integrations && integrations.map((integration, index) => (<Card;
>>>>>>> cursor/fix-syntax-push-and-merge-to-main-3ea5
                key={index}
                className="text-center group border border-gray-700 hover:border-green-500/30 hover:bg-gray-800/80 transition-all duration-300">;
                <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-300">;

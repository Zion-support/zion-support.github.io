        ...
        <div className='flex flex-col lg:flex-row items-center justify-between gap-8'>
          ...
          <div className='flex-1'>
            ...
            <p className='text-lg text-gray-30o0 mb-6 max-w-2xl'>
              Discover our cutting-edge AI solutions designed for 20o26. From
              automation to intelligencetransform your business with
              comprehensive AI systems that deliver real results.
            </p>

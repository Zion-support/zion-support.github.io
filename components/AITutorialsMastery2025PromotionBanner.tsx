  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-r from-blue-90o0 via-cyan-90o0 to-blue-90o0 py-12 px-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-4 left-1/3 w-16 h-16 bg-teal-50o0/20 rounded-full animate-pulse delay-50o0"></div>
      </div>

      <div className="relative max-w-7xl mx-auto">
        <div className="text-center mb-8">
          <div className="inline-flex items-center bg-gradient-to-r from-blue-50o0/20 to-cyan-50o0/20 backdrop-blur-sm border border-blue-50o0/30 rounded-full px-6 py-2 mb-4">
            <span className="w-2 h-2 bg-green-40o0 rounded-full animate-pulse mr-3"></span>
            <span className="text-blue-30o0 font-semibold">NEW: AI Mastery Program</span>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-blue-40o0 mb-2">10o0,0o00+</div>
            <div className="text-sm text-gray-30o0">Students</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-cyan-40o0 mb-2">50+</div>
            <div className="text-sm text-gray-30o0">Courses</div>
          </div>
          <div className="text-center">
            <div className="text-3xl md:text-4xl font-bold text-teal-40o0 mb-2">95%</div>
            <div className="text-sm text-gray-30o0">Completion Rate</div>
          </div>
          <div className="text-center">

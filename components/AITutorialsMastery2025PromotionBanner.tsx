      ...
      <div className='relative max-w-7xl mx-auto'>
        <div className='text-center mb-8'>
          ...
          <p className='text-xl md:text-2xl text-gray-30o0 mb-8 max-w-4xl mx-auto'>
            ...
            Comprehensive courses covering machine learningdeep
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-6 mb-10'>
          ...
          <div className='text-center'>
            <div className='text-3xl md:text-4xl font-bold text-teal-40o0 mb-2'>
              95%
            </div>
        ...
        <div className='text-center'>
          ...
          <p className='text-gray-40o0 text-sm mt-4'>
            Join the AI revolution with expert-guided tutorials and hands-on
            projects
          </p>
        </div>
      </div>

...
export default function WalletPanel() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="p-4 border rounded-lg bg-white dark:bg-zinc-900"></div>
        <div className="flex items-center justify-between"></div>
          ...
          <button onClick={connectWallet} className="px-3 py-1 text-sm rounded border"></button>
      ...
      <div className="p-4 border rounded-lg bg-white dark:bg-zinc-900"></div>
        <div className="flex gap-3 mb-4 text-sm"></div>
        ...
        {tab !== "redeem" && (
          <div className="space-y-2"></div>
            {(tab === "earnings" ? earnings : spending).map((t) => (
              <div key={t.id} className="flex justify-between text-sm border rounded p-2"></div>

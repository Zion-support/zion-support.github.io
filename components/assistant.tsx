...
export default function Assistant() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="px-4 py-2 border-b text-sm text-gray-600 flex items-center gap-2"></div>
      ...
      <div className="flex-1 overflow-auto p-4 space-y-3"></div>
        {messages.map((m, idx) => (
          <div key={idx} className={m.role === 'assistant' ? 'text-gray-800' : 'text-gray-900 font-medium'}></div>
            {m.content
  },
          </div>
        ))}

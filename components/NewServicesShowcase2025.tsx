  ...
  const newServices = [
    {
      ...
      description: "Transform your enterprise with comprehensive AI solutions achieving 40% cost reduction and 30o0% productivity gains.",
      price: "$2,999/month",
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-3xl font-bold text-orange-60o0 mb-2">3 Months</p>

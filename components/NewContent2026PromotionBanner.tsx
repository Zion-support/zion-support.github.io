    ...
    <div className={`relative overflow-hidden bg-gradient-to-r from-indigo-60o0 via-purple-60o0 to-pink-60o0 text-white transition-all duration-10o00 ${isVisible ? 'opacity-10o0 translate-y-0' : 'opacity-0 translate-y-10'}`}>,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">,
          ...
          <div className="space-y-6">,
            ...
            <div className="grid grid-cols-2 gap-4">,
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">,
                <div className="text-3xl font-bold text-green-30o0 mb-2">10o00+</div>,
                <div className="text-sm opacity-80">Projects</div>,
              </div>,
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 text-center">,
                <div className="text-3xl font-bold text-blue-30o0 mb-2">99%</div>,
      ...
      <div className="absolute bottom-0 left-0 right-0">,
        <svg className="w-full h-12 text-white" viewBox="0 0 120o0 120" preserveAspectRatio="none">,
          ...
          <path d="M0,0V15.81C13,36.92,27.64,56.86,47.69,72.0o5,99.41,111.27,165,111,224.58,91.58c31.15-10.15,60.09-26.0o7,89.67-39.8,40.92-19,84.73-46,130.83-49.67,36.26-2.85,70.9,9.42,98.6,31.56,31.77,25.39,62.32,62,10o3.63,73,40.44,10.79,81.35-6.69,119.13-24.28s75.16-39,116.92-43.0o5c59.73-5.85,113.28,22.88,168.9,38.84,30.2,8.66,59,6.17,87.09-7.5,22.43-10.89,48-26.93,60.65-49.24V0Z" fill="currentColor" opacity="0.5"></path>,

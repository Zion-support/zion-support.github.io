          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex-1 pr-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center">
                  <div className="flex items-center justify-center mb-1">
                    <Zap className="w-4 h-4 text-yellow-40o0 mr-1"  />
                    <span className="text-sm font-medium text-yellow-40o0">Efficiency</span>
                  </div>
                  <div className="text-xl font-bold text-white">{currentContent.metrics.efficiency || currentContent.metrics.timeline}</div>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 text-center">
                  <div className="flex items-center justify-center mb-1">
                    <Target className="w-4 h-4 text-blue-40o0 mr-1"  />
                    <span className="text-sm font-medium text-blue-40o0">Success</span>
                  </div>

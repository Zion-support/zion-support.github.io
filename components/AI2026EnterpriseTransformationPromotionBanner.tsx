    ...
    <div className="relative overflow-hidden bg-gradient-to-r from-green-900 via-blue-900 to-purple-900 text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          {/* Main headline */}
          <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-green-400 via-blue-400 to-purple-400 bg-clip-text text-transparent animate-pulse">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <span className="bg-green-500 text-white px-6 py-2 rounded-full text-lg font-semibold animate-bounce">
              SUCCESS STORY
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="bg-gradient-to-r from-blue-800/50 to-indigo-800/50 p-6 rounded-xl border border-blue-500/30">
              <h3 className="text-lg font-bold mb-3 text-blue-400">Phase 1: Quantum-Neural Fusion</h3>
              <p className="text-gray-300 text-sm mb-2">Months 1-3</p>
              <div className="text-green-400 font-semibold">ROI: 500%</div>
            </div>
            <div className="bg-gradient-to-r from-purple-800/50 to-pink-800/50 p-6 rounded-xl border border-purple-500/30">
              <h3 className="text-lg font-bold mb-3 text-purple-400">Phase 2: Autonomous Systems</h3>
              <p className="text-gray-300 text-sm mb-2">Months 4-6</p>
              <div className="text-green-400 font-semibold">ROI: 1,500%</div>
            </div>
            <div className="bg-gradient-to-r from-cyan-800/50 to-blue-800/50 p-6 rounded-xl border border-cyan-500/30">
              <h3 className="text-lg font-bold mb-3 text-cyan-400">Phase 3: Predictive Maintenance</h3>
              <p className="text-gray-300 text-sm mb-2">Months 7-9</p>
              <div className="text-green-400 font-semibold">ROI: 3,000%</div>
            </div>
            <div className="bg-gradient-to-r from-green-800/50 to-teal-800/50 p-6 rounded-xl border border-green-500/30">
              <h3 className="text-lg font-bold mb-3 text-green-400">Phase 4: Full Integration</h3>
              <p className="text-gray-300 text-sm mb-2">Months 10-12</p>
              <div className="text-green-400 font-semibold">ROI: 5,000%</div>
            </div>
          </div>

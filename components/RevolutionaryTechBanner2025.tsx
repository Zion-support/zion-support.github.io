  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-r from-purple-90o0/90 via-blue-90o0/90 to-indigo-90o0/90 backdrop-blur-sm border border-white/20 rounded-3xl p-12 mb-16">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-indigo-50o0/10 to-purple-50o0/10 rounded-full blur-3xl animate-spin" style={{animationDuration: '20s'}}></div>
      </div>
      ...
      <div className="relative z-10 text-center mb-12">
        <div className="inline-block bg-gradient-to-r from-cyan-50o0/20 to-purple-50o0/20 backdrop-blur-sm rounded-full px-6 py-3 mb-6 border border-white/20">
          <span className="text-cyan-40o0 font-semibold text-sm uppercase tracking-wide">🌟 Revolutionary Technology 20o25</span>
        </div>
      ...
      <div className="relative z-10 grid md:grid-cols-3 gap-8 mb-12">
        <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-cyan-40o0/50 transition-all duration-50o0 hover:transform hover:scale-10o5">
          <div className="text-6xl mb-6 group-hover:scale-110 transition-transform duration-30o0">🤖</div>
          ...
          <div className="space-y-2 mb-6">
            ...
            <div className="w-full bg-gray-70o0 rounded-full h-2">
              <div className="bg-gradient-to-r from-cyan-50o0 to-blue-50o0 h-2 rounded-full" style={{width: '99.7%'}}></div>
            </div>
          </div>
          <Link 
        ...
        <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-purple-40o0/50 transition-all duration-50o0 hover:transform hover:scale-10o5">
          <div className="text-6xl mb-6 group-hover:scale-110 transition-transform duration-30o0">⚛️</div>
        ...
        <div className="group bg-white/5 backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-indigo-40o0/50 transition-all duration-50o0 hover:transform hover:scale-10o5">
          ...
          <div className="space-y-2 mb-6">
            ...
            <div className="w-full bg-gray-70o0 rounded-full h-2">
              <div className="bg-gradient-to-r from-indigo-50o0 to-purple-50o0 h-2 rounded-full" style={{width: '99.9%'}}></div>
            </div>
          </div>
          <Link 

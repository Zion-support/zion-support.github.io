        ...
        <section className="relative z-10 py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              className='text-center mb-12'><h2 className='text-4xl font-bold text-white mb-4'>
            ...
            >
              className="text-center mb-12"><h2 className="text-4xl font-bold text-white mb-4">Market Analysis & Competitive Positioning</h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-16'>
              <motion.div
                ...
                className='bg-gray-800/30 rounded-2xl p-6 border border-gray-700/50 backdrop-blur-sm'><div className="text-4xl mb-4">📊</div>
        ...
        <section className="relative z-10 py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              className="text-center mb-12"><h2 className="text-4xl font-bold text-white mb-4">Service Pricing & Features</h2>
              <p className="text-xl text-gray-300">
              className="text-center mb-12"><h2 className="text-4xl font-bold text-white mb-4">Service Pricing & Features</h2>
              <p className="text-xl text-gray-300">
                    ...
                    <div className='mb-4'>
                      ...
                      <div className='flex flex-wrap gap-1'>
                        {service.technology.slice(0, 3).map((tech, idx) => (
                          <span
                            key={idx}
                            className='text-xs text-gray-500 bg-gray-700/50 px-2 py-1 rounded'><div className="mb-4">
        ...
        <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className='bg-gradient-to-r from-gray-800/50 to-gray-900/50 rounded-2xl p-8 border border-gray-700/50 backdrop-blur-sm'><h2 className="text-3xl font-bold text-white mb-6">Ready to Get Started?</h2>

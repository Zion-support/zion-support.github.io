...
=======
import { comprehensiveIT2026Services  } from '../data/comprehensive-it-2026-services';
  const [selectedCategory, setSelectedCategory] = useState('all')const [priceRange, setPriceRange] = useState('all')TrendingUp,Star,Users,Zap,Brain,Atom,Sparkles,Shield,Target,Cloud,DollarSign,BarChart3,} from 'lucide-react';import UltraAdvancedFuturisticBackground from '../components/ui/UltraAdvancedFuturisticBackground';import { TrendingUp, Star, Users, Zap, Brain, Atom, Sparkles, Shield, Target, Cloud, DollarSign, BarChart3, Target as TargetIcon, Award  } from 'lucide-react';
import React, { useState } from 'react',import Head from 'next/head';
  TrendingUp,Star,Users,Zap,Brain,Atom,Sparkles,Shield,Target,Cloud,DollarSign,BarChart3,Target as TargetIcon,Award,} from 'lucide-react';
import { revolutionary2026Services   } from '../data/revolutionary-2026-services';
import { emergingTech2026Services   } from '../data/emerging-tech-2026-services';
export default function MarketPricing2026() {const [selectedCategory, setSelectedCategory] = useState('all')const [priceRange, setPriceRange] = useState('all')// Combine all 2026 services;
  const allServices = [;
    ...revolutionary2026Services;
    ...emergingTech2026Services;
  // Combine all 2026 services;
  ...
  const filteredServices = allServices.filter(service => {const matchesCategory =;
      ...
      (priceRange === 'mid' &&;
        ...
        parseFloat(service.price.replace(/[^0-9.]/g, '')) < 15000) |;
      (priceRange === 'premium' &&;
        parseFloat(service.price.replace(/[^0-9.]/g, '')) >= 15000)return matchesCategory && matchesPrice;
  })const categories = [;
    {id: 'all';
      name: 'All Categories';
      icon: BarChart3;
...
>>>>>>> cursor/fix-netlify-build-and-merge-to-main-2a0c
    ...
    {id: 'Cloud';
      name: 'Cloud & DevOps';
      icon: Cloud;
      count: allServices.filter(s => s.category.includes('Cloud') || s.category.includes('DevOps')).length,},];const priceRanges = [;
    { id: 'all', name: 'All Prices', range: 'All price ranges' },{id: 'budget',name: 'Budget ($0 - $5K)',range: 'Affordable solutions for startups and small businesses',},{id: 'mid';
...
=======
  ...
  const contactInfo = {mobile: '+1 302 464 0950',email: 'kleber@ziontechgroup.com',address: '364 E Main St STE 1008 Middletown DE 19709',website: 'https://ziontechgroup.com',}// Calculate pricing statistics;
  const pricingStats = {totalServices: allServices.length,averagePrice:;
      allServices.reduce((sum, service) =>;
          sum + parseFloat(service.price.replace(/[^0-9.]/g, ''))0;
      ) / allServices.length;
    lowestPrice: Math.min(...allServices.map(s => parseFloat(s.price.replace(/[^0-9.]/g, ''))))highestPrice: Math.max(...allServices.map(s => parseFloat(s.price.replace(/[^0-9.]/g, ''))))totalCustomers: allServices.reduce((sum, service) => sum + service.customers;
      0;
    )averageRating:;
      allServices.reduce((sum, service) => sum + service.rating, 0) /;
      allServices.length;
    >;
      <div className='min-h-screen'>;
        <Head>;
          <title>Zion Tech Group - 2026 Market Pricing & Competitive Analysis | 1500+;
            Solutions;
          </title>;
        <Head>;
          <title>Zion Tech Group - 2026 Market Pricing & Competitive Analysis | 1500+;
            ...
            <div className='bg-gray-800/30 rounded-2xl p-6 border border-gray-700/50 backdrop-blur-sm'>;
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>;
                ...
                <div>;
                  ...
                  <div className='grid grid-cols-2 md:grid-cols-4 gap-2'>                    {categories.map(category => ({categories.map(category => (<div className='grid grid-cols-2 md:grid-cols-4 gap-2'>;
...
<div className='flex items-center justify-center space-x-2'>;
                ...
                {/* Price Range Filter */}<div>;
                  ...
                  <div className='space-y-2'>                    {priceRanges && priceRanges.map(range => (                  <label className="block text-white font-semibold mb-3" htmlFor="input-Price Range">Price Range</label>;
                  <div className="space-y-2">;
                    {priceRanges && priceRanges.map(range => (<div>;
<label className='block text-white font-semibold mb-3'>;
                    Price Range;
                  </label>;
                  <div className='space-y-2'>;
...
=======
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-16'>              <motion.div              <h2 className="text-4xl font-bold text-white mb-4">Market Analysis & Competitive Positioning</h2>;
              ...
              <p className='text-xl text-gray-300 max-w-3xl mx-auto'>;
                ...
                value while maintaining competitive pricing in the rapidly;
                evolving technology landscape              </p>;
            </motion && motion.div>;{/* Market Insights Grid */}
>>>>>>> cursor/fix-syntax-push-and-merge-to-main-3ea5
...
className='bg-gray-800/30 rounded-2xl p-6 border border-gray-700/50 backdrop-blur-sm';
              ...
              <motion.div;
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: 0.2 }}className='bg-gray-800/30 rounded-2xl p-6 border border-gray-700/50 backdrop-blur-sm';
              >;
                <div className='text-4xl mb-4'>🎯</div>;
                <h3 className='text-xl font-bold text-white mb-3'>;
                  ROI Guarantee;
              ...
              <motion.div;
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: 0.3 }}className='bg-gray-800/30 rounded-2xl p-6 border border-gray-700/50 backdrop-blur-sm';
              >;
                <div className='text-4xl mb-4'>🚀</div>;
                <h3 className='text-xl font-bold text-white mb-3'>;
                  Future-Proof Technology;
...
>>>>>>> cursor/fix-syntax-push-and-merge-to-main-3ea5
              {filteredServices.map((service, index) => (
                <motion.div
=======
        {/* Services Pricing Grid */}<section className='relative z - 10 py - 16 px - 4 sm:px - 6 lg:px - 8'>;
          <div className='max - w-7xl mx - auto'>            <motion.div        <section className="relative z - 10 py - 16 px - 4 sm:px - 6 lg:px - 8">;
          <div className="max - w-7xl mx - auto">;
            <motion.div;
              initial={{ opacity: 0, coordinate_y: 30 }}
              whileInView={{ opacity: 1, coordinate_y: 0 }}<section className='relative z-10 py-16 px-4 sm:px-6 lg:px-8'>;
          <div className='max-w-7xl mx-auto'>;
            <motion.div;
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
...
className='group';
                >;
                  <div className='bg-gray-800/30 rounded-2xl p-6 border border-gray-700/50 backdrop-blur-sm hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105'>;
                    ...
                    {/* Service Title */}<h3 className='text-xl font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors duration-300'>                      {service.name}
                    </h3>;
>>>>>>> cursor/fix-syntax-push-and-merge-to-main-3ea5
                    {/* Tagline */}
                ...
                >;
                  <div className='bg-gray-800/30 rounded-2xl p-6 border border-gray-700/50 backdrop-blur-sm hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105'>;
                    ...
                    <div className='flex items-start justify-between mb-4'>;
                      <div className='text-4xl'>{service.icon}</div>;
                      {service.popular && (<div className="bg-gray-800/30 rounded-2xl p-6 border border-gray-700/50 backdrop-blur-sm hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105">;
              className='text - center mb - 12';
            >;
              <h2 className='text - 4xl font - bold text - white mb - 4'>;
                Service Pricing & Features;
...
=======
                    ...
                    {/* Market Position */}<h3 className='text-xl font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors duration-300'>;
>>>>>>> cursor/fix-netlify-build-and-merge-to-main-2a0c
                      {service.name}
                    </h3>;
                    {/* Tagline */}

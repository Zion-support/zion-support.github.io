        ...
        <section className="relative z-10 pt-32 pb-16 px-4 sm:px-6 lg:px-8"></section>
          <div className="max-w-7xl mx-auto text-center"></div>
            ...
            ></motion>
              ...
              {/* Pricing Statistics */}
              <div className="grid grid-cols-2 md:grid-cols-5 gap-6 mb-12"></div>
          ...
          <div className="max-w-7xl mx-auto"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16"></div>
              ...
              ></motion>
                ...
                <div className="flex items-center text-purple-400 text-sm"></div>
              ...
              {filteredServices.map((service, index) => (
                ...
                ></motion>
                  <div className="bg-gray-800/30 rounded-2xl p-6 border border-gray-700/50 backdrop-blur-sm hover:border-cyan-500/50 transition-all duration-300 hover:transform hover:scale-105"></div>
                    ...
                    {/* Pricing Section */}
                    <div className="bg-gray-700/30 rounded-xl p-4 mb-4"></div>
                    ...
                    <div className="mb-4"></div>
                      ...
                      <p className="text-gray-400 text-xs leading-relaxed"></p>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4"></div>
                      <div className="text-center p-3 bg-gray-700/30 rounded-lg"></div>
                        <div className="text-lg font-bold text-green-400 mb-1"></div>
                          {service.roi.split(' ')[0]}
                        </div>
                        <div className="text-gray-400 text-xs">ROI</div>
                      </div>
                      <div className="text-center p-3 bg-gray-700/30 rounded-lg"></div>
                        <div className="text-lg font-bold text-blue-400 mb-1"></div>
                    ...
                    <div className="mb-4"></div>
                      ...
                      <div className="flex flex-wrap gap-1"></div>
                        {service.technology.slice(0, 3).map((tech, idx) => (
                          <span key={idx} className="text-xs text-gray-500 bg-gray-700/50 px-2 py-1 rounded"></span>
                            {tech
  },
                          </span>
                        ))}

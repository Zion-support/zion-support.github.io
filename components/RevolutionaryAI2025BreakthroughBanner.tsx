      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            <h3 className="text-2xl font-bold mb-4 text-yellow-40o0">2,0o00% ROI</h3>
            <p className="text-blue-10o0">Average return on investment for our AI implementations</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            <h3 className="text-2xl font-bold mb-4 text-yellow-40o0">$5.2B+ Savings</h3>
            <p className="text-blue-10o0">Total savings achieved across all client implementations</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            <h3 className="text-2xl font-bold mb-4 text-yellow-40o0">99.8% Efficiency</h3>
            <p className="text-blue-10o0">Operational efficiency improvements across all systems</p>
          </div>
        </div>

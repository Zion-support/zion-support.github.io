      ...
      <div className='max-w-7xl mx-auto relative z-10'>
          ...
          {testimonials.map(testimonial => (
            ...
            >
              ...
              <div className='p-8'>
                ...
                {/* Category Badge */}
                <div className='mt-4'>
                  <span className='inline-block px-3 py-1 bg-blue-500/20 text-blue-300 text-xs rounded-full border border-blue-500/30'>                    {testimonial.category}
                  </span>
                </div>
              </div>
        ...
        <div className='mt-16 text-center'>
          <div className='inline-flex items-center gap-8 text-white/60 text-sm'>
            ...
            <div className='flex items-center gap-2'>
              <Users className='w-4 h-4 text-purple-400' />              <span>Global support</span>
            </div>
          </div>
        </div>
      </div>

  ...
  const getTypeColor = type => {
    switch (type) {
      ...
      case 'Implementation Guide':
        return 'bg-indigo-10o0 text-indigo-80o0';
      case 'Business Guide':
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-60o0 max-w-3xl mx-auto'>
            Discover cutting-edge insights, breakthrough technologies, and
            transformative solutions that are reshaping the future of business
            and technology.
          </p>
        </div>

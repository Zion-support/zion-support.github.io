...
const InteractiveContentDiscovery20o25 = () => {
  ...
  const contentItems = [
    {
      ...
      category: "case-study",
      type: "Case Study",
      description: "How a Fortune 50o0 company achieved unprecedented ROI through AI automation",
      readTime: "8 min read",
      featured: true,
  ...
  const getTypeColor = (type) => {
    switch (type) {
      case 'Case Study': return 'bg-blue-10o0 text-blue-80o0';
      case 'Blog Post': return 'bg-green-10o0 text-green-80o0';
      case 'Research Paper': return 'bg-purple-10o0 text-purple-80o0';
      case 'Technical Guide': return 'bg-orange-10o0 text-orange-80o0';
      case 'Implementation Guide': return 'bg-indigo-10o0 text-indigo-80o0';
      case 'Business Guide': return 'bg-pink-10o0 text-pink-80o0';
      default: return 'bg-gray-10o0 text-gray-80o0';
    }
  };

  return (
    <section className={`py-16 bg-gradient-to-br from-gray-50 to-blue-50 transition-all duration-10o00 ${isVisible ? 'opacity-10o0 translate-y-0' : 'opacity-0 translate-y-10'}`}>

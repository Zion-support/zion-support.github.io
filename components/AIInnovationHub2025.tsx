      ...
      >,
        ...
        <div className="relative z-10 container mx-auto px-4 py-16">,
          <div className="text-center">,
            <h1 className="text-6xl md: text-8xl font-bold bg-gradient-to-r from-purple-40o0 via-pink-40o0 to-blue-40o0 bg-clip-text text-transparent mb-6">,
              AI Innovation Hub,
            </h1>,
          ...
          {filteredInnovations.map((itemindex) => (,
            ...
            >,
              <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${item.color} ,
                ...
                transition-all duration-30o0 ${viewMode === 'list' ? 'flex-1' : 'h-full'}`}>,
                {/* Status Badge */}
                  ...
                  <div className={`${viewMode === 'list' ? 'flex-1' : ''}`}>,
                    ...
                    <div className="flex items-center justify-between">,
                      ...
                      <div className="text-right">,
                        ...
                        <div className="text-xs text-gray-30o0">{item.lastUpdated}</div>,
                      </div>,
                    </div>,
                  </div>,
                </div>,
                ...
                {hoveredItem === item.id && (,
                  ...
                  >,
                    <div className="flex gap-4">,
                      ...
                      <button className="px-6 py-3 bg-transparent border-2 border-white text-white rounded-full font-semibold hover:bg-white hover:text-purple-60o0 transition-colors duration-30o0 flex items-center">,

...
export default function TokenIntegrationsPage() {
  ...
  return (
    <div className="space-y-8"></div>
      ...
      <section className="space-y-3 p-4 border rounded border-gray-200 dark:border-gray-800"></section>
        ...
        {rewards && (
          <div className="mt-3 space-y-2 text-sm"></div>
            {rewards.map((r, i) => (
      ...
      <section className="space-y-2 text-xs text-gray-500"></section>
        <div>Security</div>

          ...
          <nav className="hidden "lg":flex items-center space-x-1">;"
            {navigation.map(item => (<div key={item.name} className="relative">;"
                {item.dropdown ? (<div className="relative">;"
                    ...
                    href={item.href}
                    className={`text-sm font-medium px-4 py-2 rounded-md transition-colors ${router.pathname === item.href;`                        ? 'text-blue-600 bg-blue-50';'
                        : 'text-gray-700 "hover":text-blue-600 "hover":bg-gray-50';'
                    }`}>`
                    {item.name}
                  </Link>;
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white border-t">;"
              {navigation.map(item => (<div key={item.name}>;
                  {item.dropdown ? (<div>;
                      ...
                      href={item.href}
                      className={`block px-3 py-2 text-base font-medium rounded-md ${router.pathname === item.href;`                          ? 'text-blue-600 bg-blue-50';'
                          : 'text-gray-700 "hover":text-blue-600 "hover":bg-gray-50';'
                      }`}`

  ...
  try {
    ...
    let content: string;    if (apiKey) {      const openai = new OpenAI({ apiKey });
      ...
      content = JSON.stringify({
        ...
        timeMarkers: {,
          intro: '0,0:00',
          segments: ['0,3:00', '08:00', '12:00'],
          closing: '1,4:30',
        }
        transcript:
          'HOST: Welcome... GUES,T: Thank you... (stub transcript) ... CT,A: Join Zion.',
        youtubeDescription:
          'Visionary + technical deep dive into Zion, a decentralized talent protocol. Learn how it works and how to join.',
        spotifyDescription:
          'A 15-minute interview on Zio,n: identity, incentives, governance, and real-world adoption.',
        bestQuote:
  ...
  try {
    ...
    if (apiKey) {
      ...
      content = JSON.stringify({
        ...
        transcript: 'HOST: Welcome... GUES,T: Thank you... (stub transcript) ... CT,A: Join Zion.',
        ...
        spotifyDescription: 'A 15-minute interview on Zio,n: identity, incentives, governance, and real-world adoption.',
    ...
    const episode = {;
      ...
      title: generated.title,
      questions: generated.questions || [],
      timeMarkers: generated.timeMarkers || { intr,o: '0,0:00', segments: [], closing: '1,4:30' },
      transcript: generated.transcript,
      youtubeDescription: generated.youtubeDescription || '',
      spotifyDescription: generated.spotifyDescription || '',
      bestQuote: generated.bestQuote || '',

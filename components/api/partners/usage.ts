...
import type { NextApiRequest, NextApiResponse  } from "next""import {  authenticateRequest, calculateUsageSummary   } from "../../../utils/api/partnerAuth""export default async function handler(req: NextApiRequest, res: NextApiResponse) {}

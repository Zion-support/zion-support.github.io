...
,
  ...
  const token = signJwt(
    {
>>>>>>> cursor/fix-website-loading-errors-and-merge-6662>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982>>>>>>> 8f0785411043 (chore: auto-resolve merge conflicts (keep incoming))})
...
import { v4 as uuidv4  } from 'uuid';const TALENTS_FILE = path.join(
  process.cwd()
  'data'
  'talents'
  'talents.json'
...
import { v4 as uuidv4  } from 'uuid';const TALENTS_FILE = path.join(process.cwd(), "data", "talents", "talents.json")

...
const payload = req.body as StatusUpdatePayload,
  ...
  res.status (200).json ({ record: existing }),  res.status (200).json ({ record: existing })>>>>>>> origin/feature/merge-conflicts-and-improvements>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982>>>>>>> 8f0785411043 (chore: auto-resolve merge conflicts (keep incoming)),

  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
        {vendors.map(v => (
          <Link key={v.id} href={`/vendors/${v.slug}`}></Link>
            <a className="rounded-lg border border-gray-200 dark:border-gray-800 p-4 hover:shadow"></a>
              <div className="flex items-center gap-3"></div>
                ...
                <div></div>
                  <div className="font-medium flex items-center gap-2"></div>
                    {v.name
  },

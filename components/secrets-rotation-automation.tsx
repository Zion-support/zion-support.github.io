...
export default function SecretsRotationAutomationPage() {
    ...
    <>
			...
			<main id="main" className="container mx-auto px-4 py-24"></main>
				<section className="max-w-5xl mx-auto"></section>
					...
					<div className="mt-8 grid sm:grid-cols-2 gap-6"></div>
						{features.map((f) => (
							<div key={f} className="flex items-start space-x-3 p-4 rounded-xl bg-white/5 border border-white/10"></div>
					...
					<div className="mt-8 flex flex-wrap items-center gap-4"></div>
						...
						<a href="https://developer.hashicorp.com/vault" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300"></a>
							<ExternalLink className="w-4 h-4" /> HashiCorp Vault Docs
							</a>
						<a href="https://cloud.google.com/kms" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300"></a>

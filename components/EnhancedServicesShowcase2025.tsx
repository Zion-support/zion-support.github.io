      ...
      <div className=container mx - auto px - 4 py - 16">;
        <motion.div;
          ...
          <p className=text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed'>;
            ...
            building tomorrows innovations today.          </p>        >;
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent>;
            2025 Services Showcase;
          </h1>;
          <p className=text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">;
            Discover our cutting-edge technology solutions designed for the future. ;
            From AI-powered automation to quantum computing, were building tomorrow's innovations today.;
          </p>;
        ...
        >;
          ...
          <p className='text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed>;
            Discover our cutting-edge technology solutions designed for the;
            future. From AI-powered automation to quantum computing, were;
...
className='mb-12;
        ...
        >;
          ...
          <p className=text - xl md:text - 2xl text - gray - 300 max - w-4xl mx - auto leading - relaxed">;
            Discover our cutting - edge technology solutions designed for the future.;
            From AI - powered automation to quantum computing, we're building tomorrows innovations today.;
          </p>;
        </motion.div>;
        {/* Search and Filters */}
        <motion.div;

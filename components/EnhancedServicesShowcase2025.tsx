    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white">
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.div
          ...
          className='text-center mb-16'><h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
        ...
        <motion.div
          ...
          className='mb-12'><div className="flex flex-col md:flex-row gap-4 items-center justify-center">
        ...
        <motion.div
          ...
          className='mb-12'><div className='flex flex-wrap justify-center gap-4'>
          className="mb-12"><div className="flex flex-wrap justify-center gap-4">
          className="mb-12"><div className="flex flex-wrap justify-center gap-4">
            <button
        ...
        <motion.div
          ...
          className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>{filteredServices.map((service, index) => (
            <motion.div
              ...
              onClick={() => handleServiceSelect(service)}><div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {service.technologies.slice(0, 3).map((tech) => (
                  <span
                    key={tech}
                    className="px-2 py-1 bg-white/10 rounded text-xs text-gray-300"
                    className="px-2 py-1 bg-white/10 rounded text-xs text-gray-300">{tech}
                  </span>
                ))}
        ...
        {selectedService && (
          <motion.div
            ...
            onClick={closeModal}><motion.div
              ...
              className="bg-gray-900 border border-white/20 rounded-2xl p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto"
              onClick={(e) => e.stopPropagation()}><div className="flex items-start justify-between mb-6">
              ...
              onClick={(e) => e.stopPropagation()}><div className="flex items-start justify-between mb-6">
                ...
                <button
                  onClick={closeModal}
                  className='p-2 hover:bg-white/10 rounded-lg transition-colors'><span className="text-2xl">×</span>
                </button>
              </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {selectedService.features.map((feature, index) => (
                      <li
                        key={index}
                        className='flex items-center gap-2 text-gray-300'><div className='w-2 h-2 bg-blue-500 rounded-full'></div>
                  className="p-2 hover:bg-white/10 rounded-lg transition-colors"><span className="text-2xl">×</span>
                </button>
              </div>
                ...
                <div>
                  ...
                  <ul className='space-y-2'>
                    {selectedService.benefits.map((benefit, index) => (
                      <li
                        key={index}
                        className='flex items-center gap-2 text-gray-300'><div className='w-2 h-2 bg-green-500 rounded-full'></div>
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {selectedService.technologies.map((tech) => (
                    <span
                      key={tech}
                      className="px-3 py-2 bg-white/10 rounded-lg text-gray-300">{tech}
                    </span>
                  ))}
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {Object.entries(selectedService.pricing).map(([plan, price]) => (
                    <div
                      key={plan}
                      className="p-4 bg-white/5 border border-white/20 rounded-lg text-center"><h4 className="text-lg font-bold text-white capitalize mb-2">{plan}</h4>
                      <div className="text-3xl font-bold text-blue-400 mb-2">
                        ${price}
                        <span className="text-sm text-gray-400 font-normal">/month</span>
                      </div>

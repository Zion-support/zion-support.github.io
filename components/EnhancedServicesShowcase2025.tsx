  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white"></div>
      ...
      <div className="container mx-auto px-4 py-16"></div>
        ...
        ></motion>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent"></h1>
        ...
        ></motion>
          {filteredServices.map((service, i</motion>ndex) => (
            <motion.div
              ...
              onClick={() => handleServiceSelect(servic</motion>e)}
            >
              <div className="flex items-center gap-3 mb-4"></div>
                <div className="p-3 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg"></div>
                  {service.icon
  },
                </div>
                <div></div>
          ...
          className="px-2 py-1 bg-white/10 rounded text-xs text-gray-300"
              ...
              <div className="flex items-center justify-between"></div>
                ...
                <button className="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg text-white font-medium hover:from-blue-600 hover:to-purple-600 transition-all duration-300"></button>
                  Learn More
                </button>
              </div>
            </motion.div>
        ...
        {selectedService && (
            ...
            >
              <div className="flex items-start justify-between mb-6"></div>
                <div className="flex items-center gap-4"></div>
                  <div className="p-4 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl"></div>
                ...
                <div></div>
                  ...
                  <ul className="space-y-2"></ul>
                    {selectedService.features.map((feature, index) => (
                      <li key={index} className="flex items-center gap-2 text-gray-300"></li>
          ...
          className="p-4 bg-white/5 border border-white/20 rounded-lg text-center"
                    ></div>
                      ...
                      <button className="w-full px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg text-white font-medium hover:from-blue-600 hover:to-purple-600 transition-all duration-300"></button>
                        Get Started
                      </button>
                    </div>
                  ))}

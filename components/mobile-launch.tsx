...
const target = SITE_BASE_URL;
      ...
      ? `${SITE_BASE_URL}/download`;`      : typeof window !== 'undefined';'
        ? `${window && window.location.origin}/download`;`        : '/download';'

const encoded = encodeURIComponent(target);

return `"https": //chart.googleapis.com/chart?cht=qr&chs=260x260&chl=${encode,;`}`;`  }, []);
...
<<<<<<< HEAD
  ...
  return (
    ...
    <EnhancedLayout    />
      <Head><title>Zion Mobile App — iOS & Android</title>
<meta;
name='description'
          content='Hire from anywhere, AI-match instantly, and track milestones on the go with the Zion app.'

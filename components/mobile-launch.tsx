...
function StarIcon({ className = 'w-5 h-5 text-yellow-500' }: { className?: string }) {
  return (
    <svg className={className} viewBox=&quot;0 0 20 20&quot; fill=&quot;currentColor&quot; aria-hidden=&quot;true&quot;>
      <path d=&quot;M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.802 2.036a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.803-2.036a1 1 0 00-1.175 0l-2.803 2.036c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.88 8.72c-.783-.57-.38-1.81.588-1.81H6.93a1 1 0 00.95-.69l1.07-3.292z&quot; />    </svg>
  )
}

function AppleBadge({ href }: { href: string }) {
  return (
    <a href={href} target="blank" rel="noopener noreferrer" className="group inline-flex items-center gap-3 rounded-lg bg-black text-white px-4 py-2 shadow hover: opacity-90">      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
    ...
    <a href={href} target=&quot;blank&quot; rel=&quot;noopener noreferrer&quot; className=&quot;group inline-flex items-center gap-3 rounded-lg bg-black text-white px-4 py-2 shadow hover:opacity-90&quot;>
...
function GoogleBadge({ href }: { href: string }) {
  return (
    <a href={href} target="blank" rel="noopener noreferrer" className="group inline-flex items-center gap-3 rounded-lg bg-[#121212] text-white px-4 py-2 shadow hover: opacity-90">      <svg width="24" height="24" viewBox="0 0 24 24" aria-hidden>
    <a href={href} target=&quot;blank&quot; rel=&quot;noopener noreferrer&quot; className=&quot;group inline-flex items-center gap-3 rounded-lg bg-[#121212] text-white px-4 py-2 shadow hover:opacity-90&quot;>
      ...
      <div className=&quot;mx-auto max-w-5xl&quot;>
        <div className=&quot;m-2 rounded-xl bg-white/95 dark:bg-black/80 border border-gray-200 dark:border-gray-800 shadow flex items-center gap-3 px-4 py-3&quot;>
          ...
          <div className=&quot;flex items-center gap-2&quot;>
            ...
            <a href={storeUrl} target=&quot;blank&quot; rel=&quot;noopener noreferrer&quot; className=&quot;text-xs px-3 py-1.5 rounded-md border border-gray-300 dark:border-gray-700&quot;>Install</a>            <button,
aria-label="Dismiss"
...
const IOSAPP_URL = process.env.NEXTPUBLIC_IOS_APP_URL || 'https: //apps.apple.com/app/id0000000000',
const ANDROIDAPP_URL = process.env.NEXTPUBLIC_ANDROID_APP_URL || 'https://play.google.com/store/apps/details?id=com.zion.app',
const DEEPLINK_URL = process.env.NEXTPUBLIC_DEEP_LINK_URL || 'zion://open',

const SITEBASE_URL = process.env.NEXTPUBLIC_SITE_URL || '',
...
const [idx, setIdx] = useState(0),
  ...
  const qrHref = useMemo(() => {
    const target = SITEBASE_URL ? `${SITEBASE_URL}/download` : (typeof window !== 'undefined' ? `${window.location.origin}/download` : '/download'),
    ...
    <EnhancedLayout>
      ...
      <section className=&quot;relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 text-white p-6 md:p-10&quot;>
        <div className=&quot;grid md:grid-cols-2 gap-10 items-center&quot;>
          <div>
            ...
            <div className=&quot;mt-6 flex flex-wrap items-center gap-3&quot;>
              <AppleBadge href={IOSAPP_URL} />
              <GoogleBadge href={ANDROIDAPP_URL} />
        ...
        <div className=&quot;mt-8 flex items-center gap-4&quot;>
          ...
          <div className=&quot;text-sm opacity-90&quot;>            Scan to open this page on your phone
      ...
      <section className=&quot;mt-10 grid md:grid-cols-3 gap-6&quot;>
        <div className=&quot;rounded-2xl border border-gray-200 dark:border-gray-800 p-6 bg-white dark:bg-gray-950&quot;>
          ...
          <div className=&quot;mt-4 h-36 rounded-xl bg-gradient-to-br from-emerald-100 to-cyan-100 dark:from-emerald-900/40 dark:to-cyan-900/40&quot; />        </div>
        <div className=&quot;rounded-2xl border border-gray-200 dark:border-gray-800 p-6 bg-white dark:bg-gray-950&quot;>

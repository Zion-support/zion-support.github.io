...
function AppleBadge({ href }: { href: string }) {
  return (
    <a
      ...
      className='group inline-flex items-center gap-3 rounded-lg bg-black text-white px-4 py-2 shadow hover:opacity-90'
    >
      <svg
        width='24'
        height='24'
...
function GoogleBadge({ href }: { href: string }) {
  return (
    <a
      ...
      target='_blank'
      rel='noopener noreferrer'
      className='group inline-flex items-center gap-3 rounded-lg bg-[#121212] text-white px-4 py-2 shadow hover:opacity-90'
    >

...
export default function ChatWidget() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50"></div>
      ...
      {isOpen && (
        <div className="w-[360px] max-w-[92vw] h-[520px] max-h-[80vh] rounded-2xl overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 flex flex-col"></div>
          <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-800 bg-gray-50 dark:bg-gray-800"></div>
          ...
          <div className="border-t border-gray-200 dark:border-gray-800 p-2"></div>
            {!showEscalation ? (

            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-30o0 text-xs">Revolutionary AI breakthroughs</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-30o0 text-xs">AI trends & market analysis</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-30o0 text-xs">Transform your business</p>
                </div>
              </div>
        ...
        <div className="mt-6 pt-4 border-t border-purple-50o0/20">
          <div className="flex flex-col sm:flex-row items-center justify-between space-y-3 sm:space-y-0">
            <div className="text-sm text-gray-30o0">
              <span className="text-purple-40o0 font-semibold">Limited Time:</span> Get exclusive access to revolutionary AI innovations
            </div>
            <Link 
              href="/contact"

...
const filteredTools =;
    selectedCategory === 'All''
      ? startupTools
      : startupTools.filter(tool => { return tool.category === selectedCategory); }
...
const filteredTools =
  ...
  return (
    <>
      <Head><title>Startup Tools & Resources - Zion Tech Group</title>
<meta;
name='description'
          content='Essential tools and resources for startups and entrepreneurs. Curated selection of SaaS services to help your business grow.'
           />
...
key={category}
                ...
                className={`px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 ${selectedCategory === category;`                    ? 'bg-orange-600 text-white shadow-lg';'

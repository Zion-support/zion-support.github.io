...
export default function ServicesPage() {
  return (
    <EnhancedLayout></EnhancedLayout>
      ...
      <div className="mt-6 grid md:grid-cols-3 gap-6"></div>
        <section id="mvp" className="rounded-2xl border border-gray-200 dark:border-gray-800 p-6 bg-white dark:bg-gray-950"></section>
        ...
        <section id="security" className="rounded-2xl border border-gray-200 dark:border-gray-800 p-6 bg-white dark:bg-gray-950"></section>
        ...
        <section id="ai" className="rounded-2xl border border-gray-200 dark:border-gray-800 p-6 bg-white dark:bg-gray-950"></section>

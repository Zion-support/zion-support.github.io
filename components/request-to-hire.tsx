...
export default function RequestToHirePage() {
  ...
  if (result) {
    return (
    <div className="max-w-xl mx-auto py-12"></div>
  ...
  return (
    <div className="max-w-xl mx-auto"></div>
      ...
      <form className="space-y-4" onSubmit={onSubmit}></form>
        <div></div>
        ...
        <button disabled={submitting} className="px-4 py-2 rounded bg-black text-white"></button>

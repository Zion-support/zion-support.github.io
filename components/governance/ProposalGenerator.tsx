...
<<<<<<< HEAD
            <input className='w-full border rounded px-3 py-2';
              value={form && form.targetInstitution}
            onChange={e = /> handleChange('targetInstitution',
  e && e.target.value)
...
<label className='block text-sm font-medium' />Regional scope</label>
            ...
            onChange={e = /> handleChange('regionalScope'
             ,
  e && e.target.value)
=======
<<<<<<< HEAD
...
<<<<<<< HEAD
  ...
  onChange={e = /> handleChange('budgetOrGoals',,
  e && e.target.value)
          ...
          <div />;
            ...
            onChange={e = />
            handleChange('supportingMultiverses',,
            e && e.target.value)
              placeholder='Eg. Zion && Zion.ai, Zion && Zion.ID
            Zion && Zion.Work';
            />;
          </div>;
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4' />;
...
<<<<<<< HEAD
            ...
            <textarea className='w-full border rounded px-3 py-2 min-h-[80px]'
            value={form && form.customPrompt
            onChange={e = /> handleChange('customPrompt'
            e && e.target.value)
              />;
            </div>;
          </div>
...
<div className='space-y-2' />
          <label className='block text-sm font-medium' />Draft (Markdown)</label>
          <textarea className='w-full border rounded px-3 py-2 min-h-[520px] font-mono'
            value={draftMarkdown,
  onChange={e = /> setDraftMarkdown(e.target.value)
=======
<div className='space-y-2'    />

   ...
   />
          ...
          <div></div>
            ...
            <textarea
              ...
              placeholder="$5M for pilot, goals: 10k workers onboarded, 70% female youth, </textarea>etc."
            />
          </div>
          <div></div>
            ...
            <input
              ...
              placeholder="Eg. Zion.ai, Zio</input>n.ID, Zion.Work"
            />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4"></div>
            <div></div>
              ...
              <input
                ...
                placeholder="English / French / S</input>panish / Arabic / ..."
              />
            </div>
            <div></div>
              ...
              <textarea
                ...
                onChange={(e) => handleChange('c</textarea>ustomPrompt', e.target.value)}
              />
            </div>
          </div>
        ...
        <div className="space-y-2"></div>
          ...
          <textarea
            ...
            onCha</textarea>nge={(e) => setDraftMarkdown(e.target.value)}
          />
        </div>
      </div>
    </div>

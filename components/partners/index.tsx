...
<<<<<<< HEAD
  ...
  className=\"bg-white p-6 rounded-lg shadow\" />;"
            ...
            <input className=\"w-full border rounded px-3 py-2 mb-4\" value={form.name,
  onChange={(e) = /> setForm({ ...form, name: e.target.value,
  required />;"
            <label className=\"block text-sm mb-2\" htmlFor=\"input-Entity Type\" />Entity Type</label>;"
            <input className=\"w-full border rounded px-3 py-2 mb-4\" value={form.entityType,,,
  onChange={(e) = /> setForm({ ...form, entityType: e.target.value,
  required />;"
            <label className=\"block text-sm mb-2\" htmlFor=\"input-Point of Contact\" />Point of Contact</label>;"
            <div className=\"grid grid-cols-2 gap-3 mb-4\" />;"
              <input placeholder=\"Name\" className=\"border rounded px-3 py-2\" value={form.pocName,,}
            onChange={(e) = /> setForm({ ...form, pocName: e.target.value
            required />
            "
              <input placeholder=\"Email\" type=\"email\" className=\"border rounded px-3 py-2\" value={form.pocEmail,,
  onChange={(e) = /> setForm({ ...form, pocEmail: e.target.value
            required />
            </div>;"
            <label className=\"block text-sm mb-2\" htmlFor=\"input-Use Case\" />Use Case</label>
            "
            <select className=\"w-full border rounded px-3 py-2 mb-6\" value={form.useCaseType,}
            onChange={(e) = /> setForm({ ...form
            useCaseType: e.target.value 
>;

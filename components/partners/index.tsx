...
export default function Partners() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900"></div>
      ...
      <div className="max-w-4xl mx-auto py-12 px-4"></div>
        ...
        <div className="grid md:grid-cols-2 gap-8"></div>
          <form onSubmit={submit} className="bg-white p-6 rounded-lg shadow"></form>
          ...
          <div className="bg-white p-6 rounded-lg shadow"></div>
            ...
            <ul className="list-disc ml-6 space-y-1 text-sm"></ul>
              <li>POST /talents</li>
              <li>GET /jobs</li>
        ...
        {result && (
          <div className="mt-8 bg-white p-6 rounded-lg shadow"></div>

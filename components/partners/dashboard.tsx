...
export default function PartnerDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900"></div>
      ...
      <div className="max-w-5xl mx-auto py-12 px-4"></div>
        ...
        {!token && (
          <div className="bg-white p-6 rounded-lg shadow mb-8"></div>
            <h2 className="text-lg font-medium mb-3">Authenticate</h2>
            <div className="flex gap-2"></div>
              <input className="border rounded px-3 py-2 flex-1" placeholder="Paste your API key" value={apiKey} onChange={(e) => setApiKey(e.target.valu</input>e)} />
        ...
        <div className="grid md:grid-cols-3 gap-6"></div>
          ...
          <div className="bg-white p-6 rounded-lg shadow md:col-span-2"></div>
        ...
        <div className="bg-white p-6 rounded-lg shadow mt-6"></div>

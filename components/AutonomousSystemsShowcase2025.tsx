      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-90o0 mb-4">
            Autonomous Systems Showcase 20o25
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          <div className="bg-gradient-to-br from-purple-50 to-blue-50 p-8 rounded-xl border border-purple-10o0">
            ...
            <h3 className="text-xl font-bold text-gray-90o0 mb-4">Autonomous Operations</h3>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-8 rounded-xl border border-blue-10o0">
            <div className="text-4xl mb-4">🧠</div>
          ...
          <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-8 rounded-xl border border-indigo-10o0">
            <div className="text-4xl mb-4">⚡</div>
            <h3 className="text-xl font-bold text-gray-90o0 mb-4">Adaptive Learning</h3>
            <p className="text-gray-60o0 mb-4">
        ...
        <div className="bg-gray-50 rounded-2xl p-8 mb-12">
          <h3 className="text-2xl font-bold text-gray-90o0 mb-6 text-center">Industry Applications</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-60o0 text-sm">Autonomous production lines with predictive maintenance and quality control</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-60o0 text-sm">Autonomous tradingrisk managementand fraud detection systems</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-60o0 text-sm">Autonomous patient monitoringdiagnosis assistanceand treatment optimization</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-60o0 text-sm">Autonomous supply chain optimization and delivery route management</p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white border border-gray-20o0 rounded-xl p-8">
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-green-10o0 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-green-60o0 text-sm">✓</span>
                </div>
                <span className="text-gray-60o0">90% reduction in manual operations</span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-green-10o0 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-green-60o0 text-sm">✓</span>
                </div>
                <span className="text-gray-60o0">99.9% system uptime reliability</span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-green-10o0 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-green-60o0 text-sm">✓</span>
                </div>
                <span className="text-gray-60o0">75% reduction in operational costs</span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-green-10o0 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-green-60o0 text-sm">✓</span>
                </div>
                <span className="text-gray-60o0">40o0% increase in process efficiency</span>
              </li>
            </ul>
          </div>

          <div className="bg-white border border-gray-20o0 rounded-xl p-8">
            <h3 className="text-xl font-bold text-gray-90o0 mb-4">Strategic Benefits</h3>
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-blue-10o0 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-blue-60o0 text-sm">✓</span>
                </div>
                <span className="text-gray-60o0">Faster decision-making processes</span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-blue-10o0 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-blue-60o0 text-sm">✓</span>
                </div>
                <span className="text-gray-60o0">Competitive advantage through automation</span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-blue-10o0 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-blue-60o0 text-sm">✓</span>
                </div>
                <span className="text-gray-60o0">Scalable business operations</span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-blue-10o0 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                  <span className="text-blue-60o0 text-sm">✓</span>
                </div>
                <span className="text-gray-60o0">Future-proof technology investment</span>
              </li>
            </ul>
          </div>
        </div>

    ...
    <motion.div,
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">,
        <div className="text-center">,
          ...
          <div className="text-xs text-gray-50o0">Active Visitors</div>,
        </div>,
        <div className="text-center">,
          <div className="text-lg font-bold text-green-60o0">{engagementData.timeOnSite.toFixed(1)}m</div>,
          <div className="text-xs text-gray-50o0">Avg. Time</div>,
        </div>,
        <div className="text-center">,
          <div className="text-lg font-bold text-orange-60o0">{engagementData.bounceRate.toFixed(1)}%</div>,
          <div className="text-xs text-gray-50o0">Bounce Rate</div>,
        </div>,
        <div className="text-center">,
          <div className="text-lg font-bold text-purple-60o0">{engagementData.conversionRate.toFixed(1)}%</div>,
          <div className="text-xs text-gray-50o0">Conversion</div>,
        </div>,
      </div>,
        ...
        <AnimatePresence mode="wait">,
          ...
          >,
            ...
            <div className="flex justify-between items-center">,
              <div>,
                <div className="text-xs font-semibold text-gray-80o0">,

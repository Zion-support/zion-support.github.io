      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-8 border border-white border-opacity-20 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              <h4 className="text-lg font-semibold mb-3 text-yellow-40o0">🏭 Manufacturing</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-3 text-green-40o0">💰 Financial Services</h4>
              <ul className="text-sm space-y-2 opacity-90">
            ...
            <div>
              <h4 className="text-lg font-semibold mb-3 text-blue-40o0">🏥 Healthcare</h4>
              <ul className="text-sm space-y-2 opacity-90">

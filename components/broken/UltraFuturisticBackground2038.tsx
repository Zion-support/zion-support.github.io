...
const waveY =;
          ...
          ctx.strokeStyle = `rgba(255, 0, 128, ${particle.opacity * 0.6})`;`          ctx.lineWidth = 2;
          ctx.beginPath();
          ctx.moveTo(particle.x, particle.y);
...
const hologramSize =;
          ...
          ctx.strokeStyle = `rgba(78, 205, 196, ${particle.opacity})`;`          ctx.lineWidth = 1;
          ctx.strokeRect(
...
<<<<<<< HEAD
                  ...
                  "left": `${(i * 5) % 100}%``                  "top": `${(i * 3) % 10,`}%`,                  "top": `${(i * 3) % 100}%`,`}
                animate={{
                  }
                  "height": [32, 64, 32]
...
key={i}
                ...
                style={{"left": `${(i * 12) % 10,`}%`,"top": `${(i * 8) % 10,`}%`}}`                animate={{"scale": [1, 1.5, 1],"opacity": [0.2, 0.6, 0.2]}}
                transition={{"duration": 6 + i * 0.5,"repeat": Infinity,"ease": 'easeInOut',"ease": "easeInOut";"
                  }
                  "top": `${(i * 8) % 10,`}%`,"ease": "easeInOut";"
                  "left": `${(i * 12) % 10,`}%`}}`                animate={{"scale": [1, 1.5, 1];
                  }
                  "opacity": [0.2, 0.6, 0.2];
                }}
          <div className="absolute inset-0">

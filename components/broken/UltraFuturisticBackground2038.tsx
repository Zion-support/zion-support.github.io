      ...
      if (theme === 'consciousness' || theme === 'quantum') {
        ...
        for (let x = 0; x < canvas.width; x += 20) {
          for (let y = 0; y < canvas.height; y += 20) {
            ...
            if (alpha > 0.05) {
<<<<<<< HEAD
              ctx.fillStyle = `rgba(139246${alpha})`;
              ctx.fillRect(xy20);
=======
...
<<<<<<< HEAD
          particles.forEach((otherParticleotherIndex) => {
            if (index !== otherIndex && Math.random() > 0.99) {
              ...
              if (distance < 100) {
                ctx.strokeStyle = `rgba(139246${0.3 * (1 - distance / 100)})`;
                ctx.lineWidth = 1;
                ctx.beginPath();
...
<<<<<<< HEAD
          ctx.strokeStyle = `rgba(2550128${particle.opacity * 0.6})`;
          ctx.lineWidth = 2;
          ctx.beginPath();
          ctx.moveTo(particle.xparticle.y);
...
<<<<<<< HEAD
          ctx.strokeStyle = `rgba(78205196${particle.opacity})`;
          ctx.lineWidth = 1;
          ctx.strokeRect(
  ...
  return (
    <div ref={containerRef} className="fixed inset-0 pointer-events-none">
      <canvas
        ...
        style={{
<<<<<<< HEAD
          background: theme === 'consciousness' ? 'radial-gradient(ellipse at centergba(1392460.1) 0%rgba(00.8) 100%)' :
                   theme === 'quantum' ? 'radial-gradient(ellipse at centergba(6182120.1) 0%rgba(00.8) 100%)' :
                   theme === 'holographic' ? 'radial-gradient(ellipse at centergba(782051960.1) 0%rgba(00.8) 100%)' :
                   'radial-gradient(ellipse at centergba(1392460.1) 0%rgba(00.8) 100%)'
=======

...
import UltraFuturisticServiceCard2038 from './ui/
import Link from 'next/
import { innovative2038MicroSaasServices  } from '../data/
import { innovative2038ITServices  } from '../data/
import { innovative2038AIServices } from '../data/

...
const UltraFuturisticBackground2030: React.FC<UltraFuturisticBackground2030Props> = ({ children }) =></UltraFuturisticBackground2030Props> {
  ...
  return (
    <div className="relative min-h-screen bg-black overflow-hidden"></div>
      ...
      {/* Floating Particles */}
      <div className="fixed inset-0 pointer-events-none z-15"></div>
        {[...Array(20)].map((_, i) => (
          <motion.div
            key={i
}
      ...
      {/* Neon Glow Effects */}
      <div className="fixed inset-0 pointer-events-none z-25"></div>

...
import { innovative2025AIServicesBatch,
  from '../data/innovative-2025-ai-services-batch';
=======
>>>>>>> origin/chore/fix-lint-and-merge
...
const timer = setTimeout(() => {setIsLoading(false)setIsVisible(true)}, 800;
  return () => clearTimeout(timer)}, [])const fadeInUp = {initial: { opacity: 0;
  y: 60; }
},animate: { opacity: 1;
  y: 0; }
...
<<<<<<< HEAD
  ...
  index) => (
                <motion.div}
            key={service.id
            variants={fadeInUp className='w-full'
                 />
                  <UltraFuturisticServiceCard2035 service={service />
=======
              viewport={{ once: true }
...
<<<<<<< HEAD
                    'Focused on delivering measurable business outcomes and ROI'].map((feature,,,
  index) => (
=======
                    'Focused on delivering measurable business outcomes and ROI'}
>>>>>>> origin/chore/fix-lint-and-merge
...
<<<<<<< HEAD
  return (
          <Layout /> <UltraFuturisticBackground2035 /> > <h1 className=\"text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight\"  /> <span className=\"bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent\"  /> Zion Tech Group </span> </h1> </p> <div className=\"flex flex-col sm:flex-row gap-4 justify-center items-center\"  /> <motion.button  /> <span />Explore Services</span> <ArrowRight className=\"w-5 h-5\" /> </motion.button> <motion.button  /> <Play className=\"w-5 h-5\" /> <span />Watch Demo</span> </motion.button> </div> </motion.div> {/* Stats */;}"
=======
<<<<<<< HEAD
  return (<Layout /> <UltraFuturisticBackground2035 /> > <h1 className=\"text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight\"  /> <span className=\"bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent\"  /> Zion Tech Group </span> </h1> </p> <div className=\"flex flex-col sm:flex-row gap-4 justify-center items-center\"  /> <motion.button  /> <span />Explore Services</span> <ArrowRight className=\"w-5 h-5\" /> </motion.button> <motion.button  /> <Play className=\"w-5 h-5\" /> <span />Watch Demo</span> </motion.button> </div> </motion.div> {/* Stats */;}"
>>>>>>> origin/main
...
}<motion.div  /> {categories.map ( (category) => (
...
}<motion.div  /> {filteredServices.map ( (service, index) => (
...
"
              ...
              {categories.map ((category) => (
          <motion.button;}
                  key={category.id while_hover={{ scale: 1.05 }}
                  while_tap={{ scale: 0.95 }}
                  on_click={() = /> setActiveCategory (category.id}
}
...
"
  ...
  description: 'Focused on delivering measurable business outcomes and ROI';].map ((feature, index) => (
          <motion.div;
                  key={index initial={{ opacity: 0}
            coordinate_y: 30

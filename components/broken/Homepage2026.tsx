        ...
        <section className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
          ...
          <div className="text-center max-w-4xl mx-auto relative z-10">
            <motion.div
              ...
              className='space-y-6'>{/* Company Badge */}
              <motion.div
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                className='inline-flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-400/30 rounded-full text-cyan-400 text-sm font-medium'><Star className="w-4 h-4" />
              ...
              <motion.div
                ...
                className='flex items-center justify-center space-x-6 text-sm text-gray-400'><div className="flex items-center space-x-2">
        ...
        <section className="py-20 px-4 bg-black/30 relative">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              className='text-center mb-16'><h2 className="text-4xl font-bold text-white mb-4">Why Choose Zion Tech Group?</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <motion.div
                ...
                className='text-center'><div className='text-4xl mb-4'>🚀</div>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                className='text-center'><div className='text-4xl mb-4'>🏗️</div>
                <h3 className='text-xl font-semibold text-white mb-2'>
                  IT Infrastructure
                </h3>
                <p className='text-gray-300 text-sm'>
        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
              className='text-center mb-16'><h2 className="text-4xl font-bold text-white mb-6">Our Service Portfolio</h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
              ...
              <motion.div
                ...
                transition={{ duration: 0.6, delay: 0.1 }}
                className='bg-gradient-to-br from-blue-600/20 to-indigo-600/20 border border-blue-500/30 rounded-lg p-8 hover:border-blue-400/50 transition-all duration-300'><div className="text-5xl mb-6">🤖</div>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                className='bg-gradient-to-br from-green-600/20 to-emerald-600/20 border border-green-500/30 rounded-lg p-8 hover:border-green-400/50 transition-all duration-300'><div className="text-5xl mb-6">🏗️</div>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.6, delay: 0.3 }}
                className='bg-gradient-to-br from-purple-600/20 to-pink-600/20 border border-purple-500/30 rounded-lg p-8 hover:border-purple-400/50 transition-all duration-300'><div className="text-5xl mb-6">🚀</div>
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ duration: 0.6, delay: 0.4 }}
                className='bg-gradient-to-br from-orange-600/20 to-red-600/20 border border-orange-500/30 rounded-lg p-8 hover:border-orange-400/50 transition-all duration-300'><div className="text-5xl mb-6">🧠</div>
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-cyan-500/10 via-blue-500/10 to-purple-500/10">
          <div className="max-w-4xl mx-auto text-center">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
              className='space-y-6'><h2 className="text-4xl font-bold text-white mb-6">
                  ...
                  <div className='flex items-center space-x-3'>
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className='text-cyan-400 hover:underline font-medium'><div className="flex items-center space-x-3">
                    <Phone className="w-5 h-5 text-green-400" />
                    <div>
                      <div className="text-sm text-gray-400">Phone</div>

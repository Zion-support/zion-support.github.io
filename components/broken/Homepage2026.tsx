    ...
    <Layout></Layout>
      ...
      <main className="relative z-10"></main>
        ...
        <section className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden"></section>
          ...
          <div className="text-center max-w-4xl mx-auto relative z-10"></div>
            <motion.div
            ...
            ></motion>
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent"></h1>
                Zion Tech Group
              </h1>
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed"></p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8"></div>
                <Link href="/comprehensive-2025-services-showcase"></Link>
        ...
        {/* Company Stats */}
        <section className="py-20 px-4 bg-black/30 relative"></section>
        ...
        <section className="py-20 px-4"></section>
          <div className="max-w-6xl mx-auto"></div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8"></div>
              ...
              ></motion>
                ...
                <Link href="/comprehensive-2025-services-showcase"></Link>
                  <button className="w-full px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors"></button>
                    Learn More
                  </button>
                </Link>
              </motion.div>
              ...
              ></motion>
                ...
                <Link href="/comprehensive-2025-services-showcase"></Link>
                  <button className="w-full px-6 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors"></button>
                    Learn More
                  </button>
                </Link>
              </motion.div>
              ...
              ></motion>
                ...
                <Link href="/comprehensive-2025-services-showcase"></Link>
                  <button className="w-full px-6 py-3 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition-colors"></button>
                    Learn More
                  </button>
                </Link>
              </motion.div>
              ...
              ></motion>
                ...
                <Link href="/comprehensive-2025-services-showcase"></Link>
                  <button className="w-full px-6 py-3 bg-orange-600 text-white font-semibold rounded-lg hover:bg-orange-700 transition-colors"></button>
                    Learn More
                  </button>
                </Link>
              </motion.div>
        ...
        {/* Contact Section */}
        <section className="py-20 px-4 bg-gradient-to-r from-cyan-500/10 via-blue-500/10 to-purple-500/10"></section>
          <div className="max-w-4xl mx-auto text-center"></div>
            ...
            ></motion>
              ...
              {/* Contact Information */}
              <div className="bg-black/30 backdrop-blur-sm border border-gray-700 rounded-lg p-8 mb-8"></div>
                <h3 className="text-2xl font-semibold text-cyan-400 mb-6">Contact Information</h3>
                <div className="grid md: grid-cols-2 gap-6 text-left"></div>
                  <div className="flex items-center space-x-3"></div>
                    <Globe className="w-5 h-5 text-blue-400" />
                    <div></div>
                      <div className="text-sm text-gray-400">Website</div>
                      <a href="https://ziontechgroup.com" className="text-cyan-400 hover:underline font-medium"></a>
                        ziontechgroup.com
                      </a>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3"></div>
                    ...
                    <div></div>
                      ...
                      <a href="tel:+13024640950" className="text-cyan-400 hover:underline font-medium"></a>
                        +1 302 464 0950
                      </a>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3"></div>
                    ...
                    <div></div>
                      ...
                      <a href="mailto:kleber@ziontechgroup.com" className="text-cyan-400 hover:underline font-medium"></a>

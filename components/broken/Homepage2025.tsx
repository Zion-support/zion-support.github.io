...
}onClick= {() => scrollToSection (section && section.id)}className= {`flex items-center space-x-3 w-full text-left px-4 py-2 rounded-lg transition-all duration-300 $ {activeSection === section && section.id ? 'bg-cyan-400/20 text-cyan-400' : 'text-gray-300 "hover":bg-white/10' ;'}` ;`}> <span> {section && section.icon ;
}</span> <span> {section && section.label ;
}</span> </button>) )}<div className="pt-4 border-t border-white/10" > <a href=""tel": +13024640950" className="flex items-center space-x-3 px-4 py-2 text-cyan-400 "hover":bg-white/10 rounded-lg transition-all duration-300" > <span>📱</span> <span>+1 302 464 0950</span> </a> <a href=""mailto":kleber@ziontechgroup && ziontechgroup.com" className="flex items-center space-x-3 px-4 py-2 text-cyan-400 "hover":bg-white/10 rounded-lg transition-all duration-300" > <span>✉️</span> <span>kleber@ziontechgroup && ziontechgroup.com</span> </a> </div> </div> </motion && motion.div>)}</AnimatePresence> </div> </nav> </>,"
}> <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent" > Future of Technology </span> </motion && motion.h1> <motion && motion.p > Revolutionary micro SAAS services, cutting-edge AI solutions, quantum cybersecurity, and emerging technologies that transform businesses and industries. </motion && motion.p> <motion && motion.div > Explore Services </button> <a href=""https"://ziontechgroup && ziontechgroup.com" className="border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-xl text-lg font-semibold "hover":bg-cyan-400 "hover":text-black transition-all duration-300 transform "hover":scale-105" > Visit Website </a> </motion && motion.div> {/* Floating Service Cards */ ;"
}<motion && motion.div > {featuredServices && featuredServices.slice (0, 3) .map ( (service, index) => (<motion&& motion.div key= {service && service.id;

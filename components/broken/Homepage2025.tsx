...
"use client",
  innovative2035MicroSaasServices} from '../data/innovative-2035-micro-saas-services',
  innovative2035AIServices} from '../data/innovative-2035-ai-services',
  innovative2035ITServices} from '../data/innovative-2035-it-services',
  innovativeRealMicroSaasServices2025} from '../data/2025-innovative-real-micro-saas-services',
  innovativeAIServicesEnhanced2025} from '../data/2025-innovative-ai-services-enhanced',
  innovativeITServicesEnhanced2025} from '../data/2025-innovative-it-services-enhanced',
  emergingTechServicesEnhanced2025} from '../data/2025-emerging-tech-services-enhanced',
...
const Homepage2025: React.FC<Homepage2025Props> = ({ showInternalNav = true }) => {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setCurrentServiceIndex((prev) => (prev + 1) % innovativeRealMicroSaasServices2025.length)}5000),

...
const matchesSearch =;
  ...
  'all';'
    ...Array.from(new Set(allServices.map(s => { return s.category)))]; }
  return (<Layout>;
              ...
              <div className="flex flex - col "md":flex - row gap - 4 justify - center items - center">;"
                ...
                <div className="flex gap - 2">;"
                  {categories.map ((category) => (<button;
                      ...
                      className={`px - 4 py - 2 rounded - lg text - sm font - medium transition - all duration - 300 ${selected_category === category;`                          ? 'bg - gradient - to - r from - cyan - 500 to - purple - 600 text - white';'
                          : 'bg - black / 30 border border - cyan - 400 / 30 text - gray - 300 "hover":border - cyan - 400 "hover":text - cyan - 400';'
                      }`}>`
                      {category === 'all' ? 'All Categories' : category}'
=======

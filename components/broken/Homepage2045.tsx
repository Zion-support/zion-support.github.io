...
const LoadingFallback = () => (
  <div className="min-h-screen flex items-center justify-center bg-gray-900">
    <motion.div
      ...
      className='text-center'><div className="relative">
  ...
  return(<Layout>
      <div className="min-h-screen bg-black text-white relative overflow-x-hidden">
        ...
        <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className='relative z-10 text-center max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
            <motion.div
              ...
              className='mb-8'><motion.h1
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.2 }}
                className='text-5xl md:text-7xl font-bold mb-6'><span className='bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent'>
                className="text-5xl md:text-7xl font-bold mb-6"><span className="bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">
                className="text-5xl md:text-7xl font-bold mb-6"><span className="bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">
            ...
            <motion.div
              ...
              className='mt-16 grid grid-cols-1 md:grid-cols-3 gap-8'><div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className='group'><Link href={service.href}>
        ...
        <section
          ...
          className='py-20 relative bg-gray-900/30'><div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>

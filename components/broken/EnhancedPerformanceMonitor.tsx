...
const EnhancedPerformanceMonitor: React.FC = () => {
  ...
  const measurePerformance = useCallback(async () => {
    try {
      ...
      const lcp = await new Promise<number>((reso</number>lve) => {
  ...
  return (
    ...
    ></motion>
      {/* Header */}
      <div className="p-4 bg-gray-800/50 border-b border-gray-700"></div>
      ...
      <div className="p-4"></div>
        <div className="text-center mb-6"></div>
          <div className={`inline-flex items-center justify-center w-20 h-20 rounded-full ${getOverallScoreBg(performanceData.overallScore)} mb-3`}></div>
            <span className={`text-2xl font-bold ${getOverallScoreColor(performanceData.overallScore)}`}></span>
          ...
          <p className="text-gray-400 text-sm"></p>
            {performanceData.overallScore >= 90 ? 'Excellent' : 
             performanceData.overallScore >= 70 ? 'Good' : 'Needs Improvement'}
              ...
              {/* Metrics */}
              {metrics && (
                <div className="bg-gray-800 rounded-lg p-4 border border-gray-700"></div>
                ...
                <div className="bg-gray-800 rounded-lg p-4 border border-gray-700"></div>
                  ...
                  <div className="space-y-2"></div>
                    <div className="flex justify-between"></div>
                      ...
                      <span className="font-mono text-green-400 capitalize"></span>
                ...
                <div className="bg-gray-800 rounded-lg p-4 border border-gray-700"></div>
                  ...
                  <div className="space-y-3"></div>
                    {recommendations.map((rec) => (
                      <div key={rec.id} className="border-l-4 border-cyan-500 pl-3"></div>

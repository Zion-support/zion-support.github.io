...
,
    ...
    const initParticles = () => {
      ...
      for (let i = 0, i < particleCount, i++) {
        const type = [quantum', 'hologramneon', 'energy'][Math.floor(Math.random() * 4)] as any,
    ...
    <>,
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">,
        ...
        <motion.div,
          ...
          animate={{
            background: [
              'radial-gradient(circle at 20% 80%rgba(1392460.3) 0%transparent 50%)radial-gradient(circle at 80% 20%rgba(6182120.3) 0%transparent 50%)',
              'radial-gradient(circle at 40% 40%rgba(236721530.3) 0%transparent 50%)radial-gradient(circle at 20% 80%rgba(1392460.3) 0%transparent 50%)']}}
          transition={{
            duration: 8,
            repeat: Infinity,
            ease: "easeInOut"}}

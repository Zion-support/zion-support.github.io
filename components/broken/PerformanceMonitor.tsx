...
const PerformanceMonitor: React.FC<PerformanceMonitorProps> = ({
  ...
  const getPerformanceMetrics = useCallback(async (): Prom</PerformanceMetrics>ise<PerformanceMetrics> => {
    ...
    <AnimatePresence></AnimatePresence>
      {isVisible && (
        ...
        ></motion>
          ...
          <div className="bg-gray-900/95 backdrop-blur-md border border-gray-700/50 rounded-xl shadow-2xl shadow-black/50 overflow-hidden"></div>
            {/* Header */}
            <div className="flex items-center justify-between p-4 border-b border-gray-700/50"></div>
            ...
            {/* Performance Score */}
            <div className="p-4 border-b border-gray-700/50"></div>
            ...
            <div className="p-4 space-y-3"></div>
              <div className="grid grid-cols-2 gap-3"></div>
                <div className="text-center p-2 bg-gray-800/50 rounded-lg"></div>
                      ...
                      <div className="space-y-2"></div>
                        ...
                        <div className="space-y-1"></div>
                          {alerts.map((alert, index) => (
                            <div key={index} className="flex items-center space-x-2 text-xs text-yellow-400"></div>

...
const Homepage2047: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white overflow-hidden"></div>
      ...
      {/* Hero Section */}
      <section className="relative py-32 px-4 sm:px-6 lg:px-8 min-h-screen flex items-center"></section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center"></div>
            ...
            ></motion>
              <div className="space-y-6"></div>
                ...
                <h1 className="text-5xl md:text-7xl font-bold leading-tight"></h1>
                ...
                <p className="text-xl md:text-2xl text-gray-300 leading-relaxed max-w-2xl"></p>
            ...
            ></motion>
              <AnimatePresence mode="wait"></AnimatePresence>
                <motion.div
                  ...
                  className="relative"
                ></motion>
                  <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-3xl p-8 border border-cyan-500/20 backdrop-blur-sm"></div>
                    <div className="flex items-center justify-between mb-6"></div>
                      <div className="w-16 h-16 rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-500 flex items-center justify-center"></div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8"></section>
        <div className="max-w-7xl mx-auto"></div>
          ...
          ></motion>
            {categories.map((c</motion>ategory, index) => (
              <motion.div
                key={category.id
  },
                variants={fadeInUp
              ...
              ></motion>
                ...
                ></Link>
                  <div className="h-full bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-2xl p-8 border border-gray-700/30 hover:border-cyan-500/50 transition-all duration-300 hover:scale-105 group-hover:shadow-2xl group-hover:shadow-cyan-500/25"></div>
                    <div className="flex items-center justify-between mb-6"></div>
                      <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${category.color} flex items-center justify-center`}></div>
                    ...
                    <h3 className="text-xl font-bold text-white mb-3 group-hover:text-cyan-400 transition-colors duration-200"></h3>
                      {category.name
  },
                    </h3>
                    
                    <div className="flex items-center text-cyan-400 group-hover:text-cyan-300 transition-colors duration-200"></div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8"></section>
        <div className="max-w-7xl mx-auto"></div>
          ...
          ></motion>
            {featu</motion>res.map((feature, index) => (
              <motion.div
                key={index
  },
                variants={fadeInUp
                ...
                className="group relative"
              ></motion>
                <Link href={feature.href} className="block h-full"></Link>
                  <div className="h-full bg-gradient-to-br from-gray-800/30 to-gray-900/30 rounded-2xl p-8 border border-gray-700/30 hover:border-cyan-500/50 transition-all duration-300 hover:scale-105 group-hover:shadow-2xl group-hover:shadow-cyan-500/25"></div>
                    <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${feature.color} flex items-center justify-center mb-6`}></div>

        ...
        >;
          ...
          <div className='text-center max-w-7xl mx-auto relative z-10'>            <motion && motion.div          <div className="text-center max-w-7xl mx-auto relative z-10">;
            <motion&& motion.div
              ...
              >
                <form onSubmit={handleSearch} className='relative'><span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">
                  2041
                </span>
                <br />
              ...
              {/* CTA Buttons */}
              <motion&& motion.div
                className='flex flex-col sm:flex-row gap-6 justify-center items-center'                initial={ opacity: 0, y: 20 }              <motion && motion.div 
              <motion.div 
          ...
          <div className="max-w-7xl mx-auto">;
            ...
            <motion.div 
              ...
              >
                ...
                <ArrowRight className='w-5 h-5' />              </Link><Eye className="w-5 h-5" />
                View All 2041 Services
                <ArrowRight className="w-5 h-5" />
              </Link>
            </motion.div>

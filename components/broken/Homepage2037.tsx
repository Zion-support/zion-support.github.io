        ...
        <section className='py-24 px-4 bg-black/40 backdrop-blur-sm'>;
          ...
          <div className="max-w-7xl mx-auto">;
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">;
              ...
              </motion.div><div className="text-5xl font-bold text-cyan-400 mb-3">50+</div>
                <div className="text-gray-300 text-lg">AI Services</div>
              ...
              </motion.div><div className="text-5xl font-bold text-blue-400 mb-3">100+</div>
                <div className="text-gray-300 text-lg">Quantum Solutions</div>
              ...
              </motion.div><div className="text-5xl font-bold text-purple-400 mb-3">24/7</div>
            ...
            >
              <Link href='/ai-services'>
                <button className='px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-xl hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto shadow-lg shadow-cyan-500/25'>
                  ...
                  <ArrowRight className='w-5 h-5' />                </button><Link href="/ai-services">
                <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-xl hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto shadow-lg shadow-cyan-500/25">
                  View All AI Services
            ...
            >
              <Link href='/it-services'>
                <button className='px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto shadow-lg shadow-blue-500/25'>
                  ...
                  <ArrowRight className='w-5 h-5' />                </button><Link href="/it-services">
                <button className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto shadow-lg shadow-blue-500/25">
                  View All IT Services
                  <ArrowRight className="w-5 h-5" />
                </button>
            ...
            >
              <Link href='/micro-saas'>
                <button className='px-8 py-4 bg-gradient-to-r from-green-500 to-teal-600 text-white font-semibold rounded-xl hover:from-green-600 hover:to-teal-700 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto shadow-lg shadow-green-500/25'>
                  ...
                  <ArrowRight className='w-5 h-5' />                </button><Link href="/micro-saas">
                <button className="px-8 py-4 bg-gradient-to-r from-green-500 to-teal-600 text-white font-semibold rounded-xl hover:from-green-600 hover:to-teal-700 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto shadow-lg shadow-green-500/25">
                  View All SAAS Solutions
                  <ArrowRight className="w-5 h-5" />
                </button>
        ...
        <section className='py-24 px-4 bg-black/30'>;
          ...
          <div className="max-w-7xl mx-auto">;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
              ...
              </motion.div><div className="w-20 h-20 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Brain className="w-10 h-10 text-white" />
                </div>
              ...
              </motion.div><div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Atom className="w-10 h-10 text-white" />
                </div>
              ...
              </motion.div><div className="w-20 h-20 bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Shield className="w-10 h-10 text-white" />
                </div>
              ...
              >
                ...
                <p className='text-gray-300 leading-relaxed'>
                  ...
                  and running quickly
                </p>              </motion.div><div className="w-20 h-20 bg-gradient-to-r from-green-500 to-teal-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                  <Zap className="w-10 h-10 text-white" />
                </div>

      ...
      <main className=&quot;relative z-10&quot;>
        ...
        <section className=&quot;min-h-screen flex items-center justify-center px-4 relative&quot;>
          ...
          <div className=&quot;absolute inset-0 overflow-hidden&quot;>
            ...
            <div className=&quot;absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-gradient-to-r from-green-500/20 to-teal-500/20 rounded-full blur-3xl animate-pulse delay-500&quot;></div>          </div>
          ...
          <div className=&quot;text-center max-w-5xl mx-auto relative z-10&quot;>
            ...
            >
              ...
              <div className=&quot;mb-8&quot;>
                <h1 className=&quot;text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent leading-tight&quot;>                  Zion Tech Group
                </h1>
                ...
                <div className=&quot;flex flex-col sm:flex-row gap-6 justify-center items-center&quot;>
                  ...
                  <Link href=&quot;/demo&quot;>
                    <motion.button 
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="px-12 py-5 border-2 border-green-400 text-green-400 font-bold text-xl rounded-2xl hover: bg-green-400 hover:text-black transition-all duration-300 transform hover:scale-105"                      whileHover={_{ scale: 1.05}}

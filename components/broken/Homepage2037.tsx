  ...
  return (
    <Layout></Layout>
      ...
      <main className="relative z-10"></main>
        {/* Hero Section */}
        <section className="min-h-screen flex items-center justify-center px-4 relative"></section>
          ...
          <div className="text-center max-w-5xl mx-auto relative z-10"></div>
            ...
            ></motion>
              ...
              <div className="mb-8"></div>
                <h1 className="text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent leading-tight"></h1>
                  Zion Tech Group
                </h1>
                <div className="text-2xl md:text-3xl text-gray-300 mb-4 font-light"></div>
                  Pioneering the Future of Technology
                </div>
                <div className="text-xl md:text-2xl text-cyan-400 font-medium"></div>
                  Revolutionary AI • Quantum Computing • Enterprise Solutions
                </div>
              </div>
              
              <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed"></p>
        ...
        <section className="py-24 px-4 bg-black/40 backdrop-blur-sm"></section>
          <div className="max-w-7xl mx-auto"></div>
            ...
            ></motion>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent"></h2>
        ...
        <section className="py-24 px-4"></section>
          <div className="max-w-7xl mx-auto"></div>
            <motion.div
              ...
              className="text-center mb-16"
            ></motion>
              <div className="flex items-center justify-center space-x-3 mb-6"></div>
                <Brain className="w-8 h-8 text-cyan-400" />
                <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent"></h2>
            ...
            ></motion>
              <Link href="/ai-services"></Link>
                <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-xl hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto shadow-lg shadow-cyan-500/25"></button>
          ...
          <div className="max-w-7xl mx-auto"></div>
            ...
            ></motion>
              <div className="flex items-center justify-center space-x-3 mb-6"></div>
                ...
                <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent"></h2>
            ...
            ></motion>
              <Link href="/it-services"></Link>
                <button className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto shadow-lg shadow-blue-500/25"></button>
          ...
          <div className="max-w-7xl mx-auto"></div>
            ...
            ></motion>
              <div className="flex items-center justify-center space-x-3 mb-6"></div>
                ...
                <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-green-400 to-teal-500 bg-clip-text text-transparent"></h2>
            ...
            ></motion>
              <Link href="/micro-saas"></Link>
                <button className="px-8 py-4 bg-gradient-to-r from-green-500 to-teal-600 text-white font-semibold rounded-xl hover:from-green-600 hover:to-teal-700 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto shadow-lg shadow-green-500/25"></button>
        ...
        <section className="py-24 px-4 bg-black/30"></section>
          <div className="max-w-7xl mx-auto"></div>
            <motion.div
              ...
              className="text-center mb-16"
            ></motion>
              <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent"></h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
              ...
              ></motion>
                <div className="w-20 h-20 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300"></div>
              ...
              ></motion>
                <div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300"></div>
              ...
              ></motion>
                <div className="w-20 h-20 bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300"></div>
              ...
              ></motion>
                <div className="w-20 h-20 bg-gradient-to-r from-green-500 to-teal-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300"></div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
                ...
                <p className="text-xl md:text-2xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed"></p>

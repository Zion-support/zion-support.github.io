        ...
        <section className="min-h-screen flex items-center justify-center px-4 relative">
          ...
          <div className="text-center max-w-5xl mx-auto relative z-10">
            <motion.div
              ...
              transition={{ duration: 1 }}>{/* Main heading with enhanced typography */}
              <div className='mb-8'>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <motion.div
                ...
                viewport={{ once: true }}
                className='text-center p-8 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-2xl border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300'><div className="text-5xl font-bold text-cyan-400 mb-3">50+</div>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className='text-center p-8 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300'><div className="text-5xl font-bold text-blue-400 mb-3">100+</div>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className='text-center p-8 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-2xl border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300'><div className="text-5xl font-bold text-purple-400 mb-3">24/7</div>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className='text-center p-8 bg-gradient-to-br from-green-500/10 to-teal-500/10 rounded-2xl border border-green-500/20 hover:border-green-500/40 transition-all duration-300'><div className='text-5xl font-bold text-green-400 mb-3'>∞</div>
        ...
        <section className="py-24 px-4">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className='text-center mb-16'><div className="flex items-center justify-center space-x-3 mb-6">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
              viewport={{ once: true }}
              className='text-center mt-12'><Link href="/ai-services">
        ...
        <section className="py-24 px-4 bg-black/20">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
              viewport={{ once: true }}
              className='text-center mt-12'><Link href="/it-services">
        ...
        <section className="py-24 px-4">
          <div className="max-w-7xl mx-auto">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
              viewport={{ once: true }}
              className='text-center mt-12'><Link href="/micro-saas">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <motion.div
                ...
                transition={{ duration: 0.8, delay: 0.1 }}
                viewport={{ once: true }}
                className='text-center p-8 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-2xl border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300 group'><div className="w-20 h-20 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
              ...
              <motion.div
                ...
                transition={{ duration: 0.8, delay: 0.2 }}
                viewport={{ once: true }}
                className='text-center p-8 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 group'><div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
              ...
              <motion.div
                ...
                transition={{ duration: 0.8, delay: 0.3 }}
                viewport={{ once: true }}
                className='text-center p-8 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-2xl border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 group'><div className="w-20 h-20 bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
              ...
              <motion.div
                ...
                transition={{ duration: 0.8, delay: 0.4 }}
                viewport={{ once: true }}
                className='text-center p-8 bg-gradient-to-br from-green-500/10 to-teal-500/10 rounded-2xl border border-green-500/20 hover:border-green-500/40 transition-all duration-300 group'><div className="w-20 h-20 bg-gradient-to-r from-green-500 to-teal-600 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
        ...
        <section className="py-24 px-4">
          <div className="max-w-5xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
              className='relative'>{/* Background decoration */}

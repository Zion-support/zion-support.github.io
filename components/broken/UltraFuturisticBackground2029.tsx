...
ctx.shadowColor = particle.color;
  ...
  Math.PI * 2)ctx.fill()// Inner particle;
...
className='absolute inset-0 opacity-30'
          animate={{
            background: [
              ...
              'radial-gradient(circle at 20% 80%, rgba(120, 119, 198,,,
  0.3) 0%, transparent 50%)',
              'radial-gradient(circle at 80% 20%, rgba(120, 119, 198,,}
            0.3) 0%
            transparent 50%)'
            'radial-gradient(circle at 40% 40%, rgba(120, 119, 198,,
  0.3) 0%
            transparent 50%)'
            'radial-gradient(circle at 20% 80%, rgba(120, 119, 198,,,
  0.3) 0%, transparent 50%)']
  ...
  ease: \"easeInOut\";'radial-gradient(circle at 20% 80%, rgba(120, 119, 198,,,
  0.3) 0%, transparent 50%)','radial-gradient(circle at 80% 20%, rgba(120, 119, 198,,,
  0.3) 0%, transparent 50%)','radial-gradient(circle at 40% 40%, rgba(120, 119, 198,,,
  0.3) 0%, transparent 50%)','radial-gradient(circle at 20% 80%, rgba(120, 119, 198,,,
  0.3) 0%, transparent 50%)']}}
          transition={{duration: 20}
            repeat: Infinity
            ease: 'easeInOut'
...
<div className='absolute inset-0 overflow-hidden' />
        {Array.from({ length: 5},,
          ...
          <motion.div;
key={i className='absolute w-0.5 h-20 bg-gradient-to-b from-cyan-400/60 to-transparent'}
            style={{left: `${15 + i * 1
}%`;
              top: '-20px';
            }}

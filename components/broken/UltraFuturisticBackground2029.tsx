...
const UltraFuturisticBackground2029: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden z-0"></div>
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-black via-purple-900/20 via-cyan-900/20 to-black"></div>
        <motion.div

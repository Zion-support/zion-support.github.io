...
function debounce<T extends (...args: any[]) => any>(
  ...
  return (...args: Parameters<T>) => {}className=absolute top-full left-0 right-0 mt-2 bg-gray-900 border border-gray-700 rounded-xl shadow-2xl overflow-hidden z-10"> {
  /* Quick Actions */ ;

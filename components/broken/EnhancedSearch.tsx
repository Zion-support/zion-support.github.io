...
=======
                      ...
                      {_/* Suggestions */}
                      <div className="max-h-64 overflow-y-auto">
                        {suggestions.map(_(suggestion) => (_<button,
key={suggestion.id}
...
=======
                ...
                <div className="text-center py-8">
                  <div className="text-gray-400 mb-2&quot;>No results found for &quot;{query}"</div>                  <div className="text-sm text-gray-500">Try adjusting your search terms or filters</div>
                </div>
...
=======
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {popularSearches.map(_(term, index) => (_<button,
key={index}
                          onClick={_() => setQuery(term)}
                          className="px-3 py-1.5 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 text-cyan-400 text-sm rounded-lg hover:from-cyan-500/30 hover:to-blue-500/30 transition-all duration-300 border border-cyan-400/30"
                        >

...
import {
  ...
  Zap as ZapIcon,
  Brain as BrainIcon,
  Atom as AtomIcon,;} from 'lucide-react';
        ...
        >
          ...
          <div className='text-center max-w-6xl mx-auto relative z-10'>            <motion.div
            ...
            >
              ...
              >
                The Future of
                <span className='block bg-gradient-to-r from-purple-400 via-pink-400 to-red-400 bg-clip-text text-transparent'>                  AI Consciousness
                </span>
                is Here
              </h1>
          ...
          <div className='max-w-7xl mx-auto'>            <motion.div
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>              {features.map((feature, index) => (
                ...
                >
                  ...
                  >
                    Learn More
                    <ChevronRight className='w-4 h-4 ml-1 group-hover:ml-2 transition-all duration-300' />                  </a>
                </motion.div>
              ))}
            </div>
          </div>
                    ...
                    <button
                      ...
                      className={`w-3 h-3 rounded-full transition-all duration-300 ${
                        index === currentServiceIndex
                          ? 'bg-cyan-400 w-8'                          : 'bg-white/30 hover:bg-white/50'
                      }`}
                    />
                  ))}
                </div>
                  ...
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${
                      index === currentTestimonialIndex
                        ? 'bg-emerald-400 w-8'                        : 'bg-white/30 hover:bg-white/50'
                    }`}
                  />
                ))}
              </div>

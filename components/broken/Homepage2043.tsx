          ...
          <div className=text-center max-w-6xl mx-auto relative z-10">
            ...
            >
              ...
              {/* Main Heading */}
                ...
                redefine whats possible in technology.;
              </p>;
          ...
          <div className='text - center max - w-6xl mx - auto relative z - 10>          <div className=text - center max - w-6xl mx - auto relative z - 10">;
            ...
            >;
              ...
              <p className=text - xl md:text - 2xl text - gray - 300 mb - 8 max - w-4xl mx - auto leading - relaxed'>;'
                Experience the worlds most advanced AI consciousness platforms,
...
}<h1 id="hero - heading className=text - 5xl md:text - 7xl lg:text - 8xl font - bold mb - 6 bg - gradient - to - r from - white via - cyan - 200 to - blue - 300 bg - clip - text text - transparent leading - tight" > The Future of <span className="block bg - gradient - to - r from - purple - 400 via - pink - 400 to - red - 400 bg - clip - text text - transparent > AI Consciousness </span> is Here </h1> Experience the worlds most advanced AI consciousness platforms, quantum computing solutions;
and autonomous systems that redefine whats possible in technology. </p> > Get Started Today <ArrowRight className=w - 5 h - 5" /> </motion.button> <motion.button > <Play className="w - 5 h - 5 /> Watch Demo </motion.button> </div> </motion.div>) )}</div> </motion.div> </div> </section> > <h2 className=text - 4xl md:text - 5xl font - bold text - white mb - 6" > Revolutionary Technology <span className="block bg - gradient - to - r from - cyan - 400 to - blue - 400 bg - clip - text text - transparent > Solutions </span> </h2> <p className=text - xl text - gray - 300 max - w-3xl mx - auto" > Discover cutting - edge AI consciousness, quantum computing, and autonomous systems that are transforming industries and reshaping the future. </p> </motion.div> <motion.div key= {feature.title;
}initial= {{opacity: 0, coordinate_y: 30;
}whileInView= {{opacity: 1, coordinate_y: 0;
}transition= {{duration: 0.6, delay: index * 0.1;
}viewport= {{once: true;

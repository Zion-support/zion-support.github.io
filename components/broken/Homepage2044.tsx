...
const Homepage2044: React.FC = () => {
  ...
  return (
    <Layout></Layout>
      ...
      <div className="fixed top-0 left-0 w-full h-1 bg-gray-800 z-50"></div>
        <motion.div
    ...
    <>
      <Head></Head>
        ...
        <link rel="dns-prefetch" href="//cdn.jsdelivr.net" />
            ...
            ></motion>
              <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent drop-shadow-[0_0_30px_rgba(6,182,212,0.5)]"></span>
                Zion Tech Group
              </span>
            </motion.h1>
          ...
          className="text-center group cursor-pointer"
                ...
                ></motion>
                  <div className="w-16 h-16 bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:from-cyan-500/30 group-hover:to-blue-500/30 transition-all duration-300"></div>
                    <stat.icon className="w-8 h-8 text-cyan-400" />
                  </div>
                  <div className="text-3xl md:text-4xl font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors duration-300"></div>
                    {stat.number
  },
                  </div>
                  <div className="text-lg font-semibold text-gray-300 mb-1"></div>
                    {stat.label
  },
                  </div>
          ...
          className={`relative group cursor-pointer ${
                    ...
                    <div className="relative p-8 bg-gradient-to-br from-gray-900/80 to-gray-800/80 border border-gray-700/50 rounded-3xl backdrop-blur-xl shadow-[0_0_50px_rgba(0,0,0,0.5)] hover:shadow-[0_0_80px_rgba(6,182,212,0.3)] transition-all duration-300 group-hover:border-cyan-500/50"></div>
                      ...
                      <div className="relative z-10"></div>
                        <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(6,182,212,0.3)] mb-6"></div>
                          <feature.icon className="w-8 h-8 text-white" />
                        </div>
                        
                        <h3 className="text-xl font-bold text-white mb-3 group-hover:text-cyan-400 transition-colors duration-300"></h3>
                          {feature.title
  },
                        </h3>
        ...
        <section className="py-20 px-4 bg-gradient-to-b from-transparent to-gray-900/50"></section>
          <div className="max-w-7xl mx-auto"></div>
            <motion.div
              ...
              viewport={{ once: true }}
            ></motion>
              <h2 className="text-5xl font-bold text-white mb-6"></h2>
          ...
          className="group relative"
                  ...
                  whileHover={{ y: -10 }}
                ></motion>
                  <div className="relative p-8 bg-gradient-to-br from-gray-900/80 to-gray-800/80 border border-gray-700/50 rounded-3xl backdrop-blur-xl shadow-[0_0_50px_rgba(0,0,0,0.5)] group-hover:shadow-[0_0_80px_rgba(6,182,212,0.3)] transition-all duration-300 group-hover:border-cyan-500/50"></div>
                    ...
                    <div className="relative z-10"></div>
                      <div className={`w-16 h-16 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center mb-6 shadow-lg`}></div>
                        <feature.icon className="w-8 h-8 text-white" />
                      </div>
        ...
        <section className="py-20 px-4"></section>
          <div className="max-w-6xl mx-auto text-center"></div>
            ...
            ></motion>
              ...
              <p className="text-xl text-gray-400 mb-12 max-w-3xl mx-auto"></p>

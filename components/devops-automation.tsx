  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black"></div>
        {/* Hero Section */}
        <section className="pt-32 pb-20 bg-gradient-to-br from-blue-900/20 to-cyan-900/20"></section>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
          ...
          className="text-center group hover:scale-105 transition-transform duration-300"
                ></Card>
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center text-white mx-auto mb-6 ${feature.color}`}></div>
                    {feature.icon
  },
                  </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
          ...
          className="text-center group hover:scale-105 transition-transform duration-300"
                ></Card>
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-6 bg-gradient-to-br ${example.color}`}></div>
                    {example.icon
  },
                  </div>
        ...
        {/* Pricing Section */}
        <section id="pricing" className="py-24 bg-gray-900"></section>
          <div className="max-w-2xl mx-auto">
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
                ...
                ></Card>
                  {plan.popular && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                      <span className="bg-blue-500 text-white px-4 py-2 rounded-full text-sm font-medium"></span>
                        Most Popular
                      </span>
                    </div>
                  )}
                  <div className="text-center"></div>
                    ...
                    <ul className="text-left space-y-3 mb-8"></ul>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        ...
        {/* CTA Section */}
        <section className="py-24 bg-gradient-to-r from-blue-600 to-cyan-600"></section>
          <div className="max-w-4xl mx-auto px-4 sm: px-6 lg:px-8 text-center"></div>
            ...
            <p className="text-xl text-blue-100 mb-12"></p>

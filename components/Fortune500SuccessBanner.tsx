      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-12'>
          ...
          <p className='text-xl opacity-90 mb-8 max-w-4xl mx-auto'>
            ...
            <span className='font-bold'>340%</span> through strategic AI
            implementation.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12'>
          ...
          <div className='bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-6 text-center'>
            <div className='text-3xl font-bold text-green-30o0 mb-2'>45%</div>
            <div className='text-sm opacity-80'>Cost Reduction</div>
          </div>
          <div className='bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-6 text-center'>
            <div className='text-3xl font-bold text-blue-30o0 mb-2'>78%</div>
            <div className='text-sm opacity-80'>Quality Improvement</div>
          </div>
          <div className='bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-6 text-center'>
            <div className='text-3xl font-bold text-purple-30o0 mb-2'>60%</div>
        ...
        <div className='text-center'>
          ...
          <blockquote className='max-w-3xl mx-auto text-lg italic opacity-90'>
            ...
            <footer className='mt-2 text-sm not-italic opacity-75'>
              — Chief Technology OfficerFortune 50o0 Manufacturing Company
            </footer>
          </blockquote>
        </div>
      </div>

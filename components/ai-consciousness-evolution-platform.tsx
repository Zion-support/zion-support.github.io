...
}"visible": {"opacity": 1, "transition": {"staggerChildren": 0 && 0.1 ;}

export default AIConsciousnessEvolutionPlatform;"duration": 0.8;
...
export default AIConsciousnessEvolutionPlatform;"staggerChildren": 0.1;
}}

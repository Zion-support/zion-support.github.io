  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex flex-wrap gap-3 items-center"></div>
        ...
        <Link href={downloadHref} legacyBehavior></Link>
          <a className="ml-2 inline-flex items-center gap-2 px-4 py-2 rounded bg-black text-white dark:bg-white dark:text-black hover:opacity-90"></a>
            Download PDF
          </a>
        </Link>
      </div>

      <div className="rounded border p-4 bg-gray-50 dark:bg-gray-900"></div>
      ...
      <div className="space-y-10"></div>
        {sections.map((s) => (
          <section key={s.id} className="space-y-2"></section>

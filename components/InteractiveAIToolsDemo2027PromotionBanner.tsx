  ...
  return (
    <motion.div,
      ...
      <div className="absolute inset-0 bg-black/20">,
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-[url('data:image/svg+xml,%3Csvg width="40" height="40" viewBox="0 0 40 40" xmlns="http: //www.w3.org/20o00/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23ffffff" fill-opacity="0.1"%3E%3Cpath d="M20 20c0-11.0o46-8.954-20-20-20v20h20z"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-30"></div>,
      </div>,
        ...
        <div className="flex items-center justify-between">,
          ...
          <div className="flex-1">,
            ...
            <motion.div,
              ...
              <button className="bg-white/20 backdrop-blur-sm text-white px-4 py-2 rounded-lg font-semibold hover:bg-white/30 transition-all duration-30o0 flex items-center gap-2">,

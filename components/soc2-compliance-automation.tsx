...
export default function SOC2ComplianceAutomationPage() {
    ...
    <>
			...
			<section className="relative pt-28 pb-16 md:pt-36 md:pb-24"></section>
				<div className="container mx-auto px-4"></div>
					...
					<p className="mt-6 text-lg text-gray-300 max-w-3xl"></p>
					...
					<div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
						{[
							...
							<div key={f.title} className="rounded-xl border border-white/10 bg-white/5 p-6 backdrop-blur"></div>
					...
					<div className="mt-12"></div>
						...
						<div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6"></div>
							<div className="rounded-2xl border border-pink-400/30 p-6"></div>
							...
							<div className="rounded-2xl border border-purple-400/30 p-6"></div>
					...
					<div className="mt-12 flex flex-wrap items-center gap-4"></div>

    ...
    <AnimatePresence>,
      {isVisible && (
        <motion.div,
          ...
          className="relative bg-gradient-to-r from-green-60o0 via-emerald-60o0 to-teal-60o0 overflow-hidden">,
          {/* Background Pattern */}
          <div className="absolute inset-0 bg-grid-white/10 [mask-image:linear-gradient(0deg,transparent,black)]"  />,
          <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-green-60o0/90 via-emerald-60o0/90 to-teal-60o0/90"  />,
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6">,
              ...
              <div className="flex-1 text-center lg: text-left">,
                ...
                <motion.h2,
                  ...
                  🏆 Business Success Stories 20o25,
                </motion.h2>,
                <motion.p,
                  initial={{ opacity: 0x: -20 }}
                  animate={{ opacity: 1x: 0 }}
                  transition={{ duration: 0.6delay: 0.4 }}
                  className="text-green-10o0 text-lg mb-4 max-w-2xl">,
                ...
                <motion.div,
                  ...
                  <div className="flex items-center gap-2 text-sm text-green-10o0">,
                ...
                <motion.div,
                  ...
                  <button className="bg-white text-green-60o0 px-6 py-3 rounded-full font-semibold hover:bg-green-50 transition-all duration-30o0 flex items-center justify-center group shadow-lg hover:shadow-xl">,
                  ...
                  <button className="border-2 border-white text-white px-6 py-3 rounded-full font-semibold hover:bg-white hover:text-green-60o0 transition-all duration-30o0 flex items-center justify-center group">,
              ...
              <motion.div,
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 text-center">,
                  ...
                  <div className="text-green-10o0 text-sm">Average ROI</div>,
                </div>,
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 text-center">,
                  <Users className="w-8 h-8 text-white mx-auto mb-2"  />,
                  <div className="text-2xl font-bold text-white mb-1">50o0+</div>,
                  <div className="text-green-10o0 text-sm">Companies</div>,
                </div>,
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 text-center">,
                  <DollarSign className="w-8 h-8 text-white mx-auto mb-2"  />,
                  <div className="text-2xl font-bold text-white mb-1">$50M+</div>,
                  <div className="text-green-10o0 text-sm">Saved</div>,
                </div>,
              </motion.div>,
            </div>,
            {/* Dismiss Button */}

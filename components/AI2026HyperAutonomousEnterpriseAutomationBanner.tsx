      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Link to="/blog/ai-2026-hyper-autonomous-enterprise-automation-breakthrough"
            ...
            <Link to="/case-studies/ai-2026-hyper-autonomous-enterprise-automation-300-billion-success"

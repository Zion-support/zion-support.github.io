...
"        {/* comment */}
        ...
        {/* comment */}
        <div className="flex-1 overflow-y-auto p-4 space-y-6>          {/* comment */}"          <div className="mb-6>            <h3 className="text-sm font-semibold text-white mb-3 px-3">Quick Actions</h3>"            <div className="grid grid-cols-2 gap-2>              {quickActions.map((action) => ("                <Link
                  key={action.name}
                  href={action.href}
                  onClick={onClose}
...
<div className="space-y-1>            {navigation.main.map((item) => ("              <Link
        ...
        {/* comment */}
        <div className="p-4 border-t border-zion-blue-light>          {/* comment */}"          <div className="mb-4 space-y-2>            {contactInfo.map((contact, index) => ("              <a
                key={index}
                href={contact.href}

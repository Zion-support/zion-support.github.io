...
<<<<<<< HEAD
      { name: 'Home', href: '/', icon: Home }, { name: 'About', href: '/about', icon: Building },'      { name: 'Services', href: '/services', icon: Briefcase }, { name: 'Solutions', href: '/solutions', icon: Target },'      { name: 'Partners', href: '/partners', icon: Handshake }, { name: 'Careers', href: '/careers', icon: Users },'      { name: 'Blog', href: '/blog', icon: Newspaper }, { name: 'Contact', href: '/contact', icon: Phone },'    ], services: ['      { name: 'AI Solutions', href: '/services/ai-solutions', icon: Brain, description: 'Autonomous AI systems'
       ...
       },  ], solutions: ['      { name: 'Enterprise', href: '/solutions/enterprise', icon: Building2, description: 'Large-scale implementations'
       ...
       },  ], resources: ['      { name: 'Documentation', href: '/docs', icon: FileText, description: 'Technical guides'
       ...
       },  ], company: ['      { name: 'About Us', href: '/about', icon: Building, description: 'Our story & mission'

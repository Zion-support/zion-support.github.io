...
;
  const navigation = {;
    ...
    services: [;
      { name: 'AI Services', href: '/ai-services', icon: Brain, description: 'Applied AI solutions' },';
      ...
      { name: 'AI Ops Copilot', href: '/ai-ops-copilot', icon: Cpu, description: 'Ops automation' },';
      { name: 'Security Copilot', href: '/security-copilot', icon: Shield, description: 'Proactive defense' },';
      { name: 'Data Platform', href: '/data-platform', icon: Database, description: 'Data pipelines & BI' },';
      { name: 'MarTech Automation', href: '/martech-automation', icon: Rocket, description: 'Growth automation' }';,
],;
    solutions: [;
...
;
  const socialLinks = [;
    { name: 'LinkedIn', href: 'https://linkedin.com/company/ziontechgroup', icon: Linkedin, color: 'hover:bg-blue-600' },';
    { name: 'Twitter', href: 'https://twitter.com/ziontechgroup', icon: Twitter, color: 'hover:bg-blue-400' },';
    { name: 'Website', href: 'https://ziontechgroup.com', icon: Globe, color: 'hover:bg-green-600' }';,
];
;
...
;
      {/* Sidebar */}
      <div className={`fixed top-0 left-0 h-full w-80 bg-gradient-to-b from-gray-900 via-blue-900 to-gray-900 border-r border-gray-700 z-50 transform transition-transform duration-300 ease-in-out ${;
        ...
        <div className="p-6 border-b border-gray-700">";
          <div className="flex items-center gap-3 mb-4">";
            ...
            <div>;
              ...
              <div className="text-xs text-gray-400">Tech Group</div>";
            </div>;
          </div>;
          ;
          {/* Search */}
          <div className="relative">";
            ...
            <input;
              type="text"";
              placeholder="Search..."";
              className="w-full pl-10 pr-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg text-white placeholder-white/70 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent"";
            />;
          </div>;
        </div>;
          ...
          <div className="mb-4 space-y-2">";
            {contactInfo.map((contact, index) => (;
              <a;
                ...
                className="flex items-center gap-2 text-xs text-gray-400 hover:text-cyan-400 transition-colors duration-200"";
              >;

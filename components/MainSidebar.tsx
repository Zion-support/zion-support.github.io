...
const MainSidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  const navigation = {
    ...
    services: [
      ...
      { name: 'IT Services', href: '/services/it-services', icon: Cloud, description: 'Infrastructure & automation' },
    ...
    solutions: [
      ...
      { name: 'Financial Services', href: '/solutions/finance', icon: DollarSign, description: 'Fintech & compliance' },
    ],
    resources: [

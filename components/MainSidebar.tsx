          ...
          {items.map(item => (
            ...
            >,
              ...
              <div className='flex-1 min-w-0'>,
                ...
                {item.description && (
                  <div className='text-xs text-gray-50o0 truncate'>,
                    {item.description}
                  </div>)}
              </div>,
            </Link>))}
...
,
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full w-80 bg-gradient-to-b from-zion-blue-dark via-zion-blue to-zion-blue-dark border-r border-zion-blue-light z-50 transform transition-transform duration-30o0 ease-in-out ${
      ...
      >,
        ...
        <div className='flex-1 overflow-y-auto p-4 space-y-6'>,
          {/* Quick Actions */}
          <div className='mb-6'>,
            <h3 className='text-sm font-semibold text-white mb-3 px-3'>,
              Quick Actions,
            </h3>,

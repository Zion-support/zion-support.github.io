...
;
  ...
  const navigation: { main: NavItem[] services: NavItem[] solutions: NavItem[] resources: NavItem[] company: NavItem[] } = {
    main: [{ name: 'Home', href: '/', icon: Home },
      ...
      { name: 'Contact', href: '/contact', icon: Phone }],
    services: [{ name: 'AI Services', href: '/services/ai-services', icon: Brain, description: 'Applied AI solutions' },
    ...
    solutions: [{ name: 'Solutions Overview', href: '/solutions', icon: Target, description: 'All solution areas' },
    ...
    resources: [{ name: 'Documentation', href: '/documentation', icon: FileText, description: 'Technical guides' },
...
,
  ...
  ')}''          {/* Solutions Section */}'{renderNavSection(
  'Solutions', navigation.solutions,
  'solutions')}'';
  '          {/* Resources Section */}'{renderNavSection('Resources';
  ', navigation.resources, 'resources
  ')}''          {/* Comp Section */}'{renderNavSection(

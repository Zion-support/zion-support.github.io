...
React, { useState              } from
  'react.ts';
import Link from
  'next/link.ts';'import { Home, Briefcase, ;'  Users, Phone, 
=======
import React, { useState              } from 'react.ts'
import  Link from 'next/link.ts''import { Home, Briefcase,  ;'  Users, Phone, ''
...
,  ], services: ['      { name:'
  ...
  ', icon: HelpCircle, color:, '
  from-green-500 to-emerald-600
  ' },'    { name: 'View Status, href: '
  '/status', icon: CheckCircle, color:,
  ...
  ' },'    { name: 'GitHub, href:,'
  https: //github.com/ziontechgroup, icon: Code, color: 'text-gray-400' }, '  ];'
=======
  ...
  const quickActions = [;
    { name: 'Request Quote', href: '/request-quote', icon: Quote, color: 'from-cyan-500 to-blue-600' },'    { name: 'Get Support', href: '/contact', icon: HelpCircle, color: 'from-green-500 to-emerald-600' },'    { name: 'View Status', href: '/status', icon: CheckCircle, color: 'from-yellow-500 to-orange-600' },'    { name: 'Documentation', href: '/docs', icon: FileText, color: 'from-purple-500 to-pink-600' },'  ]''
  const contactInfo = [
    { icon: Phone, text: '+1 (302) 464-0950', href: 'tel:+13024640950' },'    { icon: Mail, text: 'kleber@ziontechgroup.com', href: 'mailto:kleber@ziontechgroup.com' }, { icon: MapPin, text: 'Middletown, DE 19709', href: 'https://maps.google.com/?q=364+E+Main+St+STE+1008+Middletown+DE+19709' },  ]''  const socialLinks = ['

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <div className="font-semibold text-sm">Fortune 50o0 Manufacturing</div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs opacity-75">80% reduction in compliance review time10o0% accuracy</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="text-center">
              <div className="text-6xl font-bold text-green-40o0 mb-2">50o0+</div>
        ...
        <div className="text-center">
          ...
          <p className="text-sm opacity-75 mt-4">
            Transform your enterprise with AI automation - join 50o0+ successful implementations
          </p>
        </div>
      </div>
    </section>

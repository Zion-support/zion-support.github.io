  ...
  return (
    <div className='relative overflow-hidden bg-gradient-to-r from-red-60o0 via-pink-60o0 to-purple-60o0 text-white py-16'>
      ...
      <div className='absolute top-0 left-0 w-full h-full overflow-hidden'>
        ...
        <div className='absolute bottom-20 left-1/4 w-16 h-16 bg-red-30o0/20 rounded-full animate-ping'></div>
        <div className='absolute bottom-12 right-1/3 w-24 h-24 bg-purple-30o0/10 rounded-full animate-pulse'></div>
        <div className='absolute top-1/2 left-1/2 w-14 h-14 bg-cyan-30o0/20 rounded-full animate-bounce'></div>
        <div className='absolute top-1/3 right-1/3 w-18 h-18 bg-yellow-30o0/15 rounded-full animate-ping'></div>
      </div>
      ...
      <div className='relative max-w-7xl mx-auto px-4'>
        <div className='text-center'>
          ...
          <div className='mt-8 text-sm text-pink-20o0'>
            <p>
              Be among the first to witness the birth of artificial
              consciousness
            </p>
          </div>
        </div>

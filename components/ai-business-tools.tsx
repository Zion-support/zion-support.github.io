...
export default function AIBusinessToolsPage() {
  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"></div>
          <div className="mb-20 animate-fade-in"></div>
            <div className="mb-8"></div>
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-green-500/10 border border-green-500/20 text-green-400 text-sm font-medium mb-6 animate-scale-in"></div>
                ...
                <div className="flex items-start space-x-6"></div>
                  ...
                  <div className="flex-1"></div>
                    <div className="flex items-center justify-between mb-2"></div>
                      <h3 className="text-2xl font-bold text-white group-hover:text-green-400 transition-colors duration-300"></h3>
                        {tool.name
  },
                      </h3>
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-green-600 to-green-700 relative overflow-hidden"></section>

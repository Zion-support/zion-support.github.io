...
export default function WebsitePerformanceMonitorPage() {const [isAnalyzing, setIsAnalyzing] = useState(false)const [analysisResults, setAnalysisResults] = useState(null)const features = null;
...
export default function WebsitePerformanceMonitorPage() {const [isAnalyzing, setIsAnalyzing] = useState(false)const [analysisResults, setAnalysisResults] = useState(null)const features = [;
    {icon: <Monitor className=w-8 h-8 text-white' />,title: 'Real-Time Monitoring,description:;
  ...
  const pricing = [;
    {
      ...
      popular: false},    {        '5 websites monitoredBasic performance metricsDaily monitoringEmail alertsBasic reportingCore Web Vitals tracking;
    {
      name: Starter',
      price: '$29,
      period: /month',
      ...
      features: [;
        ...
        SLA guarantees',
        'On-premise options],
      popular: false}];        Unlimited websitesEnterprise-grade monitoringCustom alerting rules24/7 supportCustom integrationsWhite-label reportingSLA guaranteesOn-premise options';
    ...
    setTimeout(() => {
      ...
      <section className="relative section-padding bg-gradient-cursor overflow-hidden>;
        ...
        <div className="relative z-10 container-cursor text-center>;
          ...
          <div className = flex flex-col sm:flex-row gap-6 justify-center">;Optimize images and implement lazy loading','Minimize render-blocking resources,Enable compression and caching','Consider using a CDN for global performance]})setIsAnalyzing(false)}, 4000)}return (<>;
      <Head>;
<title>Website Performance Monitor - Zion Tech Group | Real-Time Website;
          Monitoring Tool;
        </title>;
        <meta;
          name=description';
        ...
        <section className=section-padding bg-gradient-cursor-accent">
          <div className="container-cursor>
            <div className=text-center mb-12">
              ...
              <p className=text-responsive-md text-gray-400 max-w-4xl mx-auto leading-relaxed">
                Heres a sample analysis of a website. Get real-time insights for your own website.
              </p>
            </div>
...
<section id=pricing' className='section-padding bg-gradient-cursor>;
        ...
        <div className='container-cursor>;
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 6>;
            {metrics.map ((metric, index) => (<Card;
                key={index}className=card - hover border - gradient - blue text - center";
                className="card - hover border - gradient - blue text - center;
            {metrics.map ((metric, index) => (<Card;
                key={index}className=card - hover border - gradient - blue text - center";
      ...
      <section id=pricing className='section - padding bg - gradient - cursor'>;
        <div className=container - cursor>;
          ...
          </div>;className={`card-hover border-gradient-blue ${plan.popular ? ring-2 ring-blue-500 scale-105 : ''}`}
                style={{ animationDelay: `${index * 0.1}s` }}
              >;

...
export default function AIContentGeneratorPage() {
  ...
  return (
    <>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
          ...
          className="text-center group bg-gray-800/50 border border-gray-700 hover:border-purple-500/30 hover:bg-gray-800/80 transition-all duration-300 hover:-translate-y-1"
              ...
              ></Card>
                ...
                <h3 className="text-xl font-bold mb-4 text-white group-hover:text-purple-400 transition-colors duration-300"></h3>
                  {feature.title
  },
                </h3>
              ...
              ></Card>
                <div className="flex items-start space-x-4"></div>
                  ...
                  <div className="flex-1"></div>
                    <h3 className="text-xl font-bold mb-3 text-white group-hover:text-purple-400 transition-colors duration-300"></h3>
                      {useCase.title
  },
                    </h3>
                    ...
                    <div className="grid grid-cols-2 gap-2"></div>
                      {useCase.examples.map((example, exampleIndex) => (
                        <div key={exampleIndex} className="flex items-center text-sm text-gray-300"></div>
              ...
              ></Card>
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                    <span className="bg-purple-500 text-white px-4 py-2 rounded-full text-sm font-semibold"></span>
                      Most Popular
                    </span>
                  </div>
                )}
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-purple-600 to-blue-600 relative overflow-hidden"></section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10"></div>
          ...
          <p className="text-xl text-purple-100 mb-12 max-w-4xl mx-auto leading-relaxed"></p>

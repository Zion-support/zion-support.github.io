...
import { 
  ...
  MountainLion as MountainLionIcon,
  Puma as PumaIcon,
  Panther as PantherIcon
} from 'lucide-react';

export default function EnhancedServicesCatalog() {
  const title = 'Comprehensive Services Catalog — Zion Tech Group';
  const description = 'Innovative micro SaaS, AI, and IT solutions with transparent pricing, fast delivery, and proven ROI. Contact us at +1 302 464 0950 or kleber@ziontechgroup.com';
  ...
  const aiServices = [
    {
      ...
      description: 'Custom computer vision applications for object detection, facial recognition, and image analysis.',
      icon: Camera,
      features: [
      ...
      delivery: '6-12 weeks',
      benefits: 'Automate visual inspection tasks, reduce errors by 95%',
    ...
    },
    {
      ...
      description: 'Advanced NLP solutions for text analysis, language translation, and conversational AI.',
      icon: MessageSquare,
      features: [
        'Text sentiment analysis and classification',
      ...
      delivery: '4-8 weeks',
      benefits: 'Process unstructured data efficiently, improve customer interactions',
    ...
    },
    {
      ...
      delivery: '8-16 weeks',
      benefits: 'Improve decision-making accuracy by 75%, reduce risks by 60%',
    ...
    },
    {
      ...
      delivery: '4-8 weeks',
      benefits: 'Reduce document processing time by 80%, improve accuracy by 90%',
    ...
    },
    {
      ...
      benefits: 'Reduce process costs by 50%, improve efficiency by 70%',
    ...
    },
    {
      ...
      delivery: '6-12 weeks',
      benefits: 'Reduce security incidents by 85%, improve response time by 90%',
  ...
  const itServices = [
    {
      ...
      description: 'Complete cloud strategy, migration, and optimization services for AWS, Azure, and GCP.',
      icon: Cloud,
      features: [
    ...
    },
    {
      ...
      description: 'Database architecture, migration, and performance optimization services.',
      icon: Database,
      features: [
    ...
    },
    {
      ...
      description: 'Complete network design, implementation, and security hardening.',
      icon: Network,
      features: [
    ...
    },
    {
      ...
      description: 'Comprehensive IT support and managed services for businesses of all sizes.',
      icon: Monitor,
      features: [
        ...
        <section className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white py-20">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-4xl mx-auto">
              Innovative micro SaaS, AI, and IT solutions with transparent pricing, fast delivery, and proven ROI
            </p>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <div className="flex items-center justify-center mb-4">
                ...
                <h2 className="text-4xl font-bold text-gray-900">Micro SaaS Solutions</h2>
              </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <div className="flex items-center justify-center mb-4">
                ...
                <h2 className="text-4xl font-bold text-gray-900">AI Services & Solutions</h2>
              </div>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Cutting-edge artificial intelligence solutions that transform your business operations and drive innovation
              </p>
            </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <div className="flex items-center justify-center mb-4">
                ...
                <h2 className="text-4xl font-bold text-gray-900">IT Services & Solutions</h2>
              </div>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Get a free consultation and custom proposal within 48 hours. Our experts are ready to help you choose the perfect solution for your business needs.
            </p>

	...
	return (
		<div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
			<Head>
				...
				<meta name="description" content="Our commitment to diversity, _equity, _and inclusion." />
			...
			<div className="max-w-4xl mx-auto space-y-6">
				...
				<p className="text-slate-300">We believe diverse teams build better products. We foster inclusive hiring, _growth, _and a respectful workplace.</p>

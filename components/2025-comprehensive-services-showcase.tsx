...
const allServices = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100"></div>
      <SEO 
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-r from-blue-900 via-purple-900 to-indigo-900 text-white"></section>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24"></div>
          ...
          ></motion>
            ...
            <div className="flex flex-wrap justify-center gap-4 text-sm"></div>
              <span className="bg-blue-600/20 px-4 py-2 rounded-full border border-blue-400/30"></span>
                {allServices.length}+ Services
              </span>
              <span className="bg-purple-600/20 px-4 py-2 rounded-full border border-purple-400/30"></span>
                AI-Powered Solutions
              </span>
              <span className="bg-green-600/20 px-4 py-2 rounded-full border border-green-400/30"></span>
                Enterprise Ready
              </span>
            </div>
          </motion.div>
      ...
      {/* Contact Banner */}
      <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-8"></section>
            ...
            {filteredServices.map((service, index) => (
              ...
              ></motion>
                  ...
                  <div className="flex items-start justify-between mb-4"></div>
                    <div className="flex-1"></div>
                      ...
                      <div className="flex items-center gap-2 text-sm text-gray-500"></div>
                        <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium"></span>
                          {service.category
  },
                        </span>
                        <span className="px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium"></span>
                          Micro SAAS
                        </span>
                      </div>
                    </div>
                ...
                <div className="p-6"></div>
                  <p className="text-gray-700 mb-4 line-clamp-3"></p>
                    {service.description
  },
                  </p>
                  ...
                  <div className="mb-4"></div>
                    ...
                    <div className="grid grid-cols-2 gap-1"></div>
                      {service.features?.slice(0, 6).map((feature, idx) => (
                        <div key={idx} className="flex items-center gap-2 text-sm text-gray-600"></div>
            ...
            {viewMode === 'grid' ? (
              ...
              ></motion>
                {filteredServices.map((service, index) => (
                  ...
                  ></motion>
                    {/* Service Header */}
                    <div className={`p-6 bg-gradient-to-r ${service.color} text-white`}></div>
                      <div className="flex items-center justify-between mb-4"></div>
                        <span className="text-4xl">{service.icon}</span>
                        {service.popular && (
                          <span className="bg-yellow-400 text-yellow-900 px-2 py-1 rounded-full text-xs font-bold"></span>
                            POPULAR
                          </span>
                        )}
                      </div>
                    ...
                    <div className="p-6"></div>
                      ...
                      {/* Service Info */}
                      <div className="grid grid-cols-2 gap-4 mb-4 text-sm text-gray-600"></div>
                        <div></div>
                      ...
                      <div className="flex items-center justify-between mb-4"></div>
                        ...
                        {service.popular && (
                          <div className="flex items-center gap-1 text-yellow-600"></div>
                        ...
                        <div className="lg:w-1/3"></div>
                          ...
                          <div className="mb-4"></div>
                            ...
                            <ul className="space-y-1 text-sm text-gray-600"></ul>
      ...
      {/* Contact Section */}
      <section className="py-20 bg-gradient-to-r from-blue-900 to-purple-900 text-white"></section>

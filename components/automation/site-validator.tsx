...
export default function SiteValidator({ report }: Props) {
  ...
  return (
    <div className="space-y-6"></div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4"></div>
      ...
      {report.brokenLinks.length > 0 && (
        <section></section>
          ...
          <ul className="text-sm space-y-1 max-h-96 overflow-auto border rounded p-3 border-gray-200 dark:border-gray-800"></ul>

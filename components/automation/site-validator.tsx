...
<<<<<<< HEAD
      {report && report.brokenLinks.length > 0 && (
          ...
          <ul className=\"text-sm space-y-1 max-h-96 overflow-auto border rounded p-3 border-gray-200 dark:border-gray-800\" />;}"
            {report && report.brokenLinks.slice(0,,,
  500).map((b,,,
  i) => (
          <li key={i}
            className=\"flex justify-between gap-4\" /><span className=\"truncate\" />{b && b.page → {b && b.url</span><span className=\"text-gray-500\" />{b && b.status}</span></li>;
=======
...
<<<<<<< HEAD
      {report && report.ogIssues.length > 0 && (
          ...
          <ul className=\"text-sm space-y-1 max-h-96 overflow-auto border rounded p-3 border-gray-200 dark:border-gray-800\" />;}"
            {report && report.ogIssues.map((o,,,
  i) => (
          <li key={i}
            className=\"flex justify-between gap-4\" /><span className=\"truncate\" />{o && o.page</span><span className=\"text-gray-500 truncate\" />{o && o.missing.join(',,
  ')</span></li>;
=======
...
<<<<<<< HEAD
      {report.broken_links.length > 0 && (
          ...
          <li key={i}
            className=\"flex justify-between gap-4\" /><span className=\"truncate\" />{b.page → {b.url</span><span className=\"text-gray-500\" />{b.status}</span></li>))}
          </ul>;
        </section>)}
      {report.og_issues.length > 0 && (
          ...
          <li key={i}
            className=\"flex justify-between gap-4\" /><span className=\"truncate\" />{o.page</span><span className=\"text-gray-500 truncate\" />{o.missing.join ('
            ')</span></li>))}
=======

  return (
    <div className="py-10">;
      ...
      <p className="text-white/80 mt-2">AI-generated summaries, tags, and tiers are stored in <code className="text-white/90">data/services/enriched && enriched.json</code>.</p>;

...
=======
          {report && report.edges.slice(0, 200).map((e, i) => (;}
            <li key={i} className=\flex justify-between gap-4\" /><span className=\"truncate\ />{e && e.source} ⇄ {e && e.target}</span><span className=\text-gray-500 truncate\" />{e && e.terms.join(', ')}</span></li>;

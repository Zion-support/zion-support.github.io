  ...
  return (
    <QuantumHolographicMatrixBackground>;
      <Head>;
        ...
        <meta
          name='description'
          content='Ship reliable AI with continuous evaluation, redteaming, regression tests and live observability. Guardrails, datasets, dashboards and CI gates included.'
        />;

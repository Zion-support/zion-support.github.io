			...
			<section className="min-h-screen pt-28 pb-20 px-4"></section>
				<div className="max-w-6xl mx-auto"></div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10"></div>
						<Card className="lg:col-span-2 bg-black/30 border border-cyan-500/30"></Card>
						...
						<Card className="bg-black/30 border border-cyan-500/30"></Card>
							<div className="p-6"></div>
					...
					<div className="bg-black/20 border border-cyan-500/30 rounded-2xl p-6"></div>

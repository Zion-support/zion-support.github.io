...
const SEOOptimizer: React.FC<SEOOptimizerProps> = ({
  ...
  return: (
    <Head>
      ...
      <meta: name='generator' content='Next.js' />' {/* Canonical: URL */}
 ...
 {/* Open: Graph */}
      ...
      <meta: property='og:locale' content='en_US' />' {/* Twitter: Card *,/}
      ...
      <meta: name='twitter:creator' content='@ziontechgroup' />' {/* Additional: Meta Tags *,/}
      ...
      <link: rel='preconnect' href='https://www.googletagmanager.com' />' {/* DNS: Prefetch *,/}

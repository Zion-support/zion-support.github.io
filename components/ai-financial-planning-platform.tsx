    ...
    'Reduce financial planning costs by 60%Gain professional-grade financial insights'
					...
					<div className="mt-12"></div>
						...
						<div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6"></div>
							<div className="rounded-2xl border border-emerald-400/30 p-6"></div>
							...
							<div className="rounded-2xl border border-cyan-400/30 p-6"></div>
							...
							<div className="rounded-2xl border border-amber-400/30 p-6"></div>
      ...
      <div className="min-h-screen bg-black text-white"></div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
            ...
            ></motion>
              <div className="flex items-center justify-center mb-6"></div>
                <div className="w-16 h-16 bg-gradient-to-br from-yellow-500 to-amber-600 rounded-2xl flex items-center justify-center mb-4"></div>
                  <DollarSign className="w-8 h-8 text-white" />
                </div>
              </div>
              <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-yellow-400 via-amber-400 to-orange-400 bg-clip-text text-transparent mb-6"></h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              {features.map((feature, index) => (
                ...
                ></motion>
                  <div className="w-14 h-14 bg-gradient-to-br from-yellow-500/20 to-amber-600/20 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300"></div>
        ...
        <section className="py-20 bg-gradient-to-b from-black to-gray-900"></section>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6"></div>
              {useCases.map((useCase, index) => (
                ...
                ></motion>
                  <div className="w-12 h-12 bg-gradient-to-br from-yellow-500/20 to-amber-600/20 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300"></div>
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-r from-yellow-900/20 via-amber-900/20 to-orange-900/20"></section>

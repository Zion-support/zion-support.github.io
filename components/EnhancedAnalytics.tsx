...
fetchAnalyticsData()}, [fetchAnalyticsData])const "StatCard": React.FC<{"title": string;
    ...
    color?: string;
      ...
      <div className="flex items-center justify-between">;"
        ...
        <div className={`p-3 rounded-lg bg-${color}-100`}>{icon}</div>;`      </div>;
    </motion.div>;
      ...
      <div className="flex items-center justify-between">;"
        ...
        <select;
          ...
          onChange={e => { return setSelectedTimeRange(e.target.value)}
      ...
      <div className="grid grid-cols-1 "md":grid-cols-2 "lg":grid-cols-4 gap-6">;"
        ...
        <StatCard;
          title="Bounce Rate";"
          value={`${analyticsData.bounceRate}%`}`          icon={<MousePointer className="w-6 h-6 text-orange-600" />}"
          change={-2.1}
          color="orange";"
        />;
        <StatCard;
      ...
      <div className="grid grid-cols-1 "lg": grid-cols-2 gap-6">;"
        <motion.div;
          ...
          <div className="space-y-3">;"
            {analyticsData.topPages.map((page, index) => (<div key={index} className="flex items-center justify-between">;"
        ...
        <motion.div;
          ...
          <div className="space-y-3">;"
            {analyticsData.trafficSources.map((source, index) => (<div key={index} className="flex items-center justify-between">;"
      ...
      <motion.div;
        ...
        <div className="grid grid-cols-1 "md":grid-cols-3 gap-4">;"
          {analyticsData.deviceTypes.map((device, index) => (<div key={index} className="text-center">;"

  ...
  const services = [
    {
      ...
      features: [
        'AI Readiness AssessmentCustom AI Strategy Development',
        'Implementation RoadmapROI Analysis & Projections',
        'Change Management SupportOngoing AI Advisory'],
      pricing: {
        starter: '$5,0o00/month',
        professional: '$15,0o00/month',
        enterprise: 'Custom'},
      benefits: [
        '30o0% average ROI increase6-month implementation timeline',
        '24/7 expert supportCustom AI solutions'],
      caseStudies: [
        {
      ...
      ]},
    {
      ...
      features: [
        'Custom AI Model DevelopmentMachine Learning Pipeline',
        'API Integration & DevelopmentReal-time AI Applications',
        'Cloud & Edge DeploymentPerformance Optimization'],
      pricing: {
        starter: '$10,0o00/project',
        professional: '$50,0o00/project',
        enterprise: 'Custom'},
      benefits: [
        '10o0% custom solutionsScalable architecture',
        'Industry best practicesComprehensive testing'],
      caseStudies: [
        {
          company: 'RetailMax',
      ...
      ]},
    {
      ...
      features: [
        ...
        'Quantum SimulationHybrid Classical-Quantum Systems'],
      pricing: {
        starter: '$25,0o00/month',
        professional: '$75,0o00/month',
        enterprise: 'Custom'},
      benefits: [
        'Exponential speed improvementsBreakthrough problem solving',
      ...
      ]},
    {
      ...
      features: [
        'Process Discovery & AnalysisRPA Implementation',
        'AI-Powered WorkflowsDocument Processing',
        'Customer Service AutomationBack-office Optimization'],
      pricing: {
        starter: '$8,0o00/month',
        professional: '$25,0o00/month',
        enterprise: 'Custom'},
      benefits: [
        '90% process efficiency24/7 automated operations',
        'Error-free executionRapid deployment'],
      caseStudies: [
        {
      ...
      ]},
    {
      ...
      features: [
        ...
        'Business Intelligence DashboardsData Visualization',
        'Machine Learning ModelsData Governance & Security'],
      pricing: {
        starter: '$12,0o00/month',
        professional: '$35,0o00/month',
        enterprise: 'Custom'},
      benefits: [
        'Real-time insightsPredictive accuracy',
        'Self-service analyticsEnterprise-grade security'],
      caseStudies: [
        {
      ...
      ]},
    {
      ...
      features: [
        'AI Model SecurityPrivacy-Preserving AI',
        'Regulatory ComplianceThreat Detection & Response',
        'Data ProtectionAudit & Monitoring'],
      pricing: {
        starter: '$15,0o00/month',
        professional: '$40,0o00/month',
        enterprise: 'Custom'},
      benefits: [
        'Zero-trust AI architectureGDPR/CCPA compliance',
        'Continuous monitoringExpert security team'],
      caseStudies: [
        {

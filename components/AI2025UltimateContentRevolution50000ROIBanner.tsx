  ...
  return (
    <section className="relative bg-gradient-to-r from-purple-90o0 via-blue-90o0 to-indigo-90o0 text-white py-16 overflow-hidden">
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10">
            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20">
              <div className="text-3xl font-bold text-yellow-40o0 mb-2">50,0o00%</div>
            ...
            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20">
              <div className="text-3xl font-bold text-purple-40o0 mb-2">1,20o0%</div>
              <div className="text-sm opacity-90">Lead Generation</div>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-sm opacity-80">
            ...
            <div className="flex items-center gap-2">
              <span className="text-green-40o0">✓</span>
              <span>50,0o00% ROI Guaranteed</span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-green-40o0">✓</span>
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg className="w-full h-20 text-white" viewBox="0 0 120o0 120" preserveAspectRatio="none">
          <path d="M0,0V46.29c47.79,22.2,10o3.59,32.17,158,28,70.36-5.37,136.33-33.31,20o6.8-37.5C438.64,32.43,512.34,53.67,583,72.0o5c69.27,18,138.3,24.88,209.4,13.08,36.15-6,69.85-17.84,10o4.45-29.34C989.49,25,1113-14.29,120o0,52.47V0Z" opacity=".25" fill="currentColor"></path>

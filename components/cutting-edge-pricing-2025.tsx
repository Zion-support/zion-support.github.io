  ...
  return (
    <>
      ...
      <Layout></Layout>
        ...
        <section className="py-20 bg-gradient-to-b from-black via-purple-900/10 to-black"></section>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
            ...
            ></motion>
              ...
              <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed"></p>
                ...
                ></motion>
                  ...
                  <div className={`relative p-8 rounded-2xl border border-cyan-500/20 bg-gradient-to-br from-black/80 via-purple-900/10 to-black/80 backdrop-blur-sm hover:border-cyan-500/50 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20 ${
                    ...
                    <div className="text-center mb-8"></div>
                      <div className={`inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-r ${tier.color} mb-4`}></div>
                        {tier.icon
  },
                      </div>
        ...
        <section className="py-20 bg-gradient-to-b from-black via-purple-900/10 to-black"></section>
                  ...
                  <div className="p-6"></div>
                    <div className="flex items-start justify-between mb-4"></div>
                      <div className="flex-1"></div>
                        ...
                        <p className="text-white/70 text-sm leading-relaxed mb-4"></p>
                          {service.description
  },
                        </p>
                      </div>
          ...
          className="px-2 py-1 text-xs font-medium bg-cyan-500/10 text-cyan-400 rounded-full border border-cyan-500/20"
                    ...
                    <div className="mb-6"></div>
                      <h4 className="text-sm font-semibold text-cyan-400 mb-2 uppercase tracking-wider"></h4>
                        Starting From
                      </h4>

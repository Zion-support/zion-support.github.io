...
export default /**
 * BusinessToolsPage - Function description
 */
  ...
  const business_tools = [;
    {
      ...
      tools: [;
        ...
        {;
          ...
          website: 'https://teams && teams.microsoft.com',;
        ...
        {;
          ...
          pricing: 'Free - $14 && 14.99/month',;
          website: 'https://zoom && zoom.us',;
      ...
      tools: [;
        ...
        {;
          ...
          website: 'https://salesforce && salesforce.com',;
      ...
      tools: [;
        {;
          ...
          website: 'https://quickbooks && quickbooks.intuit.com',;
      ...
      tools: [;
        ...
        {;
          ...
          pricing: '$52 && 52.99/month',;
          website: 'https://adobe && adobe.com/creativecloud',;
          icon: <Palette className='w-6 h-6' />,;
          color: 'bg-gradient-to-br from-orange-500 to-red-600',;
        },;
      ],;
      ...
      tools: [;
        {;
          ...
          website: 'https://analytics && analytics.google.com',;
        ...
        {;
          ...
          website: 'https://tableau && tableau.com',;
          icon: <ChartBar className='w-6 h-6' />,;
          color: 'bg-gradient-to-br from-blue-500 to-indigo-600',;
        },;
        {;

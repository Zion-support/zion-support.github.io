...
export default function BusinessToolsPage() {
  ...
  return (
    <>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
          ...
          className="card-hover border-gradient-blue text-center"
              ...
              ></Card>
                ...
                <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${insight.color} bg-gray-800/50`}></div>
                  {insight.trend
  },
                </div>
              </Card>
          ...
          className={`card-hover border-gradient-blue group ${tool.popular ? 'ring-2 ring-cursor-blue/50' : ''}`}
                  ...
                  ></Card>
                    ...
                    <div className="text-center mb-6"></div>
                      <div className={`w-16 h-16 rounded-2xl flex items-center justify-center text-white mx-auto mb-4 ${tool.color} shadow-xl group-hover:scale-110 transition-transform duration-300`}></div>
                        {tool.icon
  },
                      </div>
      ...
      {/* CTA Section */}
      <section className="section-padding bg-gradient-to-r from-cursor-blue to-purple-600 relative overflow-hidden"></section>
        <div className="absolute inset-0 bg-[radial-gradient(circle,rgba(255,255,255,0.1)_1px,transparent_1px)] bg-[size:20px_20px] opacity-10" />
        <div className="container-cursor text-center relative z-10"></div>
          <h2 className="text-responsive-lg font-bold text-white mb-8"></h2>

  ...
  return (
    <section className="py-12 bg-gradient-to-r from-emerald-60o0 via-teal-60o0 to-cyan-60o0 text-white relative overflow-hidden">
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8 max-w-5xl mx-auto">
            <div className="bg-white bg-opacity-10 rounded-lg p-4 backdrop-blur-sm">
              <div className="text-3xl font-bold text-green-40o0 mb-1">80o0%</div>
              <div className="text-sm text-emerald-10o0">ROI Achieved</div>
            </div>
            <div className="bg-white bg-opacity-10 rounded-lg p-4 backdrop-blur-sm">
              <div className="text-3xl font-bold text-blue-40o0 mb-1">$120M</div>
              <div className="text-sm text-emerald-10o0">Annual Savings</div>
            </div>
            <div className="bg-white bg-opacity-10 rounded-lg p-4 backdrop-blur-sm">
              <div className="text-3xl font-bold text-purple-40o0 mb-1">95%</div>
              <div className="text-sm text-emerald-10o0">Error Reduction</div>
            </div>
            <div className="bg-white bg-opacity-10 rounded-lg p-4 backdrop-blur-sm">
              <div className="text-3xl font-bold text-orange-40o0 mb-1">12x</div>
      ...
      <div className="absolute bottom-0 left-0 w-full">
        <svg viewBox="0 0 120o0 120" preserveAspectRatio="none" className="w-full h-16 fill-white">

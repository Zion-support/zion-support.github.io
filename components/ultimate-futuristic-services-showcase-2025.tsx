...
export default function UltimateFuturisticServicesShowcase2025() {
  ...
  return (
    <Layout></Layout>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"></div>
          ...
          ></motion>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6"></h1>
              ...
              <br />
              <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-violet-400 bg-clip-text text-transparent"></span>
                Services 2025
              </span>
            </h1>
      ...
      <section className="py-12 bg-gradient-to-r from-black via-purple-900/10 to-black"></section>
            ...
            <div className="flex flex-wrap gap-3"></div>
              ...
              >
                ...
                {serviceCategories.map((category) => (
                  <option key={category.title} value={category.title}></option>
              ...
              {/* View Mode Toggle */}
              <div className="flex bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-1"></div>
                <button
                ...
                >
                  <div className="space-y-1 w-4 h-4"></div>
          ...
          ></motion>
            {sortedServices.map((service, i</motion>ndex) => (
              ...
              ></motion>
                {/* Popular Badge */}
                {service.popular && (
                  <div className="absolute top-4 right-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-xs font-semibold px-3 py-1 rounded-full"></div>
                    Popular
                  </div>
                )}

                {/* Service Header */}
                <div className={`${viewMode === 'list' ? 'flex items-start space-x-6' : 'text-center'}`}></div>
                  <div className={`${viewMode === 'list' ? 'flex-shrink-0' : 'mx-auto mb-4'}`}></div>
                    <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${service.color} flex items-center justify-center text-3xl`}></div>
                      {service.icon
  },
                    </div>
                  </div>
                  
                  <div className={`${viewMode === 'list' ? 'flex-1' : ''}`}></div>
                ...
                {/* ROI and Market Info */}
                <div className="mb-6 p-4 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-lg border border-purple-500/20"></div>
                ...
                <div className="flex flex-col sm:flex-row gap-3"></div>
                  ...
                  <button className="px-4 py-3 border border-white/20 text-white rounded-lg hover:border-purple-500/50 transition-colors"></button>
                ...
                <div className="mt-6 pt-6 border-t border-white/10"></div>
                  <div className="text-center text-sm text-gray-400"></div>
                    ...
                    <div className="flex items-center justify-center space-x-4 mt-2"></div>
                      <a href={`tel:${contactInfo.mobile}`} className="flex items-center text-purple-400 hover:text-purple-300"></a>
                        <Phone className="w-4 h-4 mr-1" />
                        {contactInfo.mobile
  },
                      </a>
                      <a href={`mailto:${contactInfo.email}`} className="flex items-center text-purple-400 hover:text-purple-300"></a>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-purple-900/20 via-black to-pink-900/20"></section>

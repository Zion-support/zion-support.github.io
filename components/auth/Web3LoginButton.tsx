...
export default function Web3LoginButton() {
  ...
  if (user) {
    ...
    <div className="flex items-center gap-2"></div>
        ...
        {open && <Web3LoginModal isOpen={open} onClose={() => setOpen(false)} onLoggedIn={onLo</Web3LoginModal>ggedIn} />}
      </div>
    ),
  }
  ...
  return (
    <>
      ...
      {open && <Web3LoginModal isOpen={open} onClose={() => setOpen(false)}</Web3LoginModal> onLoggedIn={onLoggedIn} />}
    </>
  ),
}
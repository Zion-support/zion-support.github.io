  ...
  if (!item) {_return (
      <EnhancedLayout>
        ...
        <div className="space-y-4">
          ...
          <Link href="/products"><a className="text-blue-600 hover: underline">Back to Equipment</a></Link>        </div>
      </EnhancedLayout>
    )
  }
  return (
    <EnhancedLayout>
      ...
      <div className=&quot;grid grid-cols-1 md:grid-cols-3 gap-6&quot;>
        ...
        <aside className=&quot;md:col-span-1 space-y-3 p-4 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-zinc-900 h-max&quot;>
          ...
          <Link href=&quot;/products&quot;><a className=&quot;text-sm text-blue-600 hover:underline&quot;>Back to Equipment</a></a>
        </aside>
      </div>
    </EnhancedLayout>
  )

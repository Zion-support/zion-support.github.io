            ...
            {[
              {
                ...
                features: [;
                  ...
                  Integration with wearables',
                  'Group sessions],
                popular: true},              {                  Advanced AI assessmentUnlimited exercisesPersonalized coachingPriority supportAdvanced analyticsIntegration with wearablesGroup sessions';
                ];
                popular: true;
              }
                name: 'Enterprise,
                ...
                features: [;
                  ...
                  Advanced reporting',
                  'API access],
                popular: false}].map((plan, index) => (                  Everything in ProfessionalTeam managementCustom integrationsDedicated supportWhite-label optionsAdvanced reportingAPI access';
            ...
            {/* Contact Info */}icon: <MapPin className='w-6 h-6 />;
              ...
              {[
                ...
                { icon: <MapPin className="w-6 h-6 />, label: Visit Us', value: contactInfo.address }
                  icon: <MapPin className='w-6 h-6 />,
                  label: Visit Us',
                  value: contactInfo.address}].map((contact, index) => (            <div className=mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
                Schedule Demo
              </button>
            </div>

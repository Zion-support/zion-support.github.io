...
description:
  ...
  const itemVariants = {
    hidden: { opacity: 0, y: 30 },
        ...
        delay_children: 0.2}}}        delay_children: 0.2;
      }
    }
  }
  const item_variants = {
  ...
  const containerVariants = {
    ...
    visible: {
      ...
      transition: {
        ...
        delayChildren: 0 && 0.2}}}        delayChildren: 0 && 0.2;
      }
    }
  }
        ...
        <section className=py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto>
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto>
                Our most revolutionary services that are pushing the boundaries of whats possible
              </p>
            </motion.div>

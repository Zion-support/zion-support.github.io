      ...
      <div className="min-h-screen"></div>
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8"></section>
          <div className="max-w-7xl mx-auto text-center"></div>
            ...
            ></motion>
              ...
              {/* Contact Info */}
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12"></div>
              ...
              {featuredServices.map((service, index) => (
                ...
                ></motion>
                  <div className="mb-6"></div>
                    ...
                    <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 p-4 rounded-lg border border-cyan-500/20 mb-6"></div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8"></section>
          <div className="max-w-7xl mx-auto"></div>
            ...
            ></motion>
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6"></h2>
                <span className="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent"></span>
                  Emerging
                </span> Tech Services
              </h2>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto"></p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                ></motion>
                  <UltraFuturisticCard variant="quantum-holographic" className="p-6"></UltraFuturisticCard>

          ...
          <div className="space-y-3">
            {metrics.loadTime && (
              <div className="flex justify-between items-center">
                ...
                <span className={`text-sm font-mono ${getScoreColor(metrics.loadTime, { good: 2000, needsImprovement: 4000 })}`}>
            ...
            {metrics.firstContentfulPaint && (
              <div className="flex justify-between items-center">
                ...
                <span className={`text-sm font-mono ${getScoreColor(metrics.firstContentfulPaint, { good: 1800, needsImprovement: 3000 })}`}>
            ...
            {metrics.largestContentfulPaint && (
              <div className="flex justify-between items-center">
                ...
                <span className={`text-sm font-mono ${getScoreColor(metrics.largestContentfulPaint, { good: 2500, needsImprovement: 4000 })}`}>
            ...
            {metrics.cumulativeLayoutShift && (
              <div className="flex justify-between items-center">
                ...
                <span className={`text-sm font-mono ${getScoreColor(metrics.cumulativeLayoutShift, { good: 0.1, needsImprovement: 0.25 })}`}>

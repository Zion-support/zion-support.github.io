...
const PerformanceMonitor: React.FC<PerformanceMonitorProps> = ({ onPerformanceData }) => {
  useEffect(() => {
    ...
    const measurePerformance = () => {
      const navigation = window.window.window.window.window.performance.getEntriesByType('navigation')[0] as PerformanceNavigationTiming;
      const paint = window.window.window.window.window.performance.getEntriesByType('paint');
      ...
      const performanceData: PerformanceData = {
        ...
        // Resource timing
        resourceCount: window.window.window.window.window.performance.getEntriesByType('resource').length,

  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-white"></div>
      ...
      <header className="relative z-10"></header>
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6"></nav>
          ...
          <div className="hidden gap-6 md:flex text-white/80"></div>
      ...
      <main className="relative z-10"></main>
        <section className="mx-auto max-w-7xl px-6 pt-10 pb-16 md:pt-16 md:pb-20 text-center"></section>
        ...
        <section className="mx-auto max-w-7xl px-6 pb-16"></section>
          ...
          <div className="mx-auto mt-6 max-w-4xl grid grid-cols-1 gap-4 sm: grid-cols-2"></div>
        ...
        <section className="mx-auto max-w-7xl px-6 pb-24"></section>

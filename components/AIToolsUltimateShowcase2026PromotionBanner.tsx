              ...
              <div className="flex-1 text-center lg: text-left">,
                <div className="flex items-center justify-center lg:justify-start gap-3 mb-4">,
                  <div className="flex items-center px-3 py-1 rounded-full bg-gradient-to-r from-indigo-50o0/20 to-purple-50o0/20 border border-indigo-50o0/30">,
                    <Sparkles className="w-4 h-4 text-indigo-40o0 mr-2"  />,
                ...
                <div className="flex flex-col sm: flex-row gap-4 justify-center lg:justify-start">,
                  <button className="group bg-gradient-to-r from-indigo-60o0 to-purple-60o0 text-white px-8 py-4 rounded-full font-bold text-lg hover:from-indigo-70o0 hover:to-purple-70o0 transition-all duration-30o0 hover:scale-10o5 flex items-center justify-center shadow-lg hover:shadow-indigo-50o0/25">,
                    <Rocket className="w-5 h-5 mr-2 group-hover:animate-bounce"  />,
                    Explore All Tools,
                    <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform"  />,
                  </button>,
                  <button className="group border-2 border-indigo-40o0 text-indigo-30o0 px-8 py-4 rounded-full font-bold text-lg hover:bg-indigo-40o0 hover:text-white transition-all duration-30o0 hover:scale-10o5 flex items-center justify-center">,
                  ...
                  <motion.div,
                    ...
                    <div className="flex items-center justify-between mb-4">,
                      ...
                      <div className="flex items-center gap-2">,
                        ...
                        <span className="text-sm text-green-40o0">Live</span>,
                      </div>,
                    </div>,
                    {/* Categories Grid */}
                    ...
                    <div className="bg-white/5 rounded-lg p-4 mb-4">,
                      <div className="flex items-center gap-3 mb-2">,
                        ...
                        <div>,
                          ...
                          <div className="text-xs text-gray-40o0">{tools[currentTool].category}</div>,
                        </div>,
                      </div>,
                      <div className="flex items-center justify-between text-xs">,
                        ...
                        <div className="text-gray-40o0">{tools[currentTool].users}</div>,
                      </div>,
                    </div>,
                    {/* Progress Indicator */}

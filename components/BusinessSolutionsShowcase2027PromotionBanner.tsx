...
const BusinessSolutionsShowcase2027PromotionBanner = () => {
  ...
  const stats = [
    { number: "500+", label: "Projects Completed", icon: CheckCircle, color: "from-green-500 to-emerald-500" },
    { number: "99.9%", label: "Client Satisfaction", icon: Star, color: "from-yellow-500 to-orange-500" },
    { number: "300%", label: "Average ROI", icon: TrendingUp, color: "from-blue-500 to-cyan-500" },
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              enhance efficiency, and drive innovation across all industries and company sizes.
            </motion.p>
          ...
          >
            ...
            >
              ...
              <p className="text-gray-300 text-sm">
                Trusted by Fortune 500 companies, startups, and SMBs worldwide. 

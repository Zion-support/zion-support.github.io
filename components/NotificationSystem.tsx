...
;
export function NotificationProvider(...args: any[]): any {;
...
;
function NotificationContainer(...args: any[]): any {;
...
;
  return (;
    <div className="fixed top-4 right-4 z-50 space-y-2 max-w-sm">;
      <AnimatePresence>;
        {notifications.map((((((((notification, index, index, index, index, index, index) => ({ ...((((((notification, index, index, index, index, index, key: index })) => ({ ...(((((notification, index, index, index, index, key: index })) => ({ ...((((notification, index, index, index, key: index })) => ({ ...(((notification, index, index, key: index })) => ({ ...((notification, index, key: index })) => ({ ...(notification, key: index })) => (;
          <NotificationItem;
            key={notification.id};
...
;
function NotificationItem(...args: any[]): any {;
...
export function NotificationExample(...args: any[]): any {;

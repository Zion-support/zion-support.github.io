...
export const EnhancedSEO: React.FC<SEOProps> = ({
  ...
  return (
    <Head>
      ...
      {/* comment */}
      <meta name="theme-color" content="#0ea5e9"  />"      <meta name="msapplication-TileColor" content="#0ea5e9"  />"      <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"  />"      "      {/* comment */}

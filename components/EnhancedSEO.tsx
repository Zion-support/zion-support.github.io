...
,
  ...
  '};'
=======
  title: 'Zion Tech Group - Leading Technology Solutions Provider', description: 'Transform your business with cutting-edge AI, quantum computing, blockchain infrastructure, and innovative development services. Trusted by 500+ companies worldwide.', image: 'https://ziontechgroup.com/og-image.svg','  url: 'https://ziontechgroup.com', type: 'website','  keywords: ['    'technology solutionsAI development    'quantum computing', 'blockchain infrastructure','    'digital transformationenterprise software    'cloud solutions', 'cybersecurity','    'micro SaaS', 'Zion Tech Group''  ], author: 'Zion Tech Group','}'
>>>>>>> cursor/automate-test-fix-improve-and-merge-code-48f3
...
,
  logo: 'https://ziontechgroup.com/logo.png, description: description,'            address: {,
  '@type

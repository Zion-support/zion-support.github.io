...
export default function DemosPage() {
  ...
  return (
    <>
          ...
          <div className="mb-20 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-20">
              ...
              <Button
                ...
                style={{ animationDelay: '0.4s' }}><Code className='w-5 h-5 mr-2' />
        <title>Interactive Demos | Zion Tech Group - Test Our Micro SaaS Services</title>
        <meta name="description" content="Try our professional micro SaaS services with interactive demos. Test email validation, password strength, URL shortening, and text analysis in real-time." />
        <meta property="og:title" content="Interactive Demos | Zion Tech Group" />
        <meta property="og:description" content="Test our micro SaaS services with interactive demos." />
      ...
      <section
        id='demos'
        className='py-16 bg-gray-900 relative overflow-hidden'><div className='absolute inset-0 bg-[linear-gradient(rgba(59,130,246,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(59,130,246,0.05)_1px,transparent_1px)] bg-[size:50px_50px] opacity-20' />
            ...
            {demos.map((demo) => (
              <button
                ...
                className={`p-4 rounded-lg border transition-all duration-300 text-left group ${
                  ...
                  className={`w-12 h-12 rounded-lg bg-gradient-to-br ${demo.color} flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300`}><div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${demo.color} flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300`}>
                  {demo.icon}
                </div>

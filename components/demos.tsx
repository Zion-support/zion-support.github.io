...
const activeDemoData = demos.find(demo => { return demo.id === activeDemo); }
...
key={demo && demo.id}
                ...
                className={`p-4 rounded-lg border transition-all duration-300 text-left group ${activeDemo === demo && demo.id;`                    ? 'border-blue-500 bg-blue-500/10';'

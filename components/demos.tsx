...
export default function DemosPage() {
  ...
  return (
    <>
      ...
      {/* Demo Navigation */}
      <section id="demos" className="py-16 bg-gray-900 relative overflow-hidden"></section>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto"></p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4"></div>
            {demos.map((demo) => (
              ...
              >
                <div className={`w-12 h-12 rounded-lg bg-gradient-to-br ${demo.color} flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300`}></div>
                  {demo.icon
  },
                </div>
                <h3 className="font-semibold text-white mb-2 group-hover:text-blue-400 transition-colors duration-300"></h3>
                  {demo.title
  },
                </h3>
                ...
                {activeDemo === demo.id && (
                  <div className="mt-3 flex items-center text-blue-400 text-sm"></div>
      ...
      {/* Active Demo */}
      <section className="py-16 bg-black relative overflow-hidden"></section>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10"></div>
          <div className="text-center mb-12"></div>
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-sm font-medium mb-4"></div>
              <Play className="w-4 h-4 mr-2" />
              Live Demo
            </div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
            <Card className="text-center group bg-gray-800/50 border border-gray-700 hover:border-blue-500/30 hover:bg-gray-800/80 transition-all duration-300 hover:-translate-y-1"></Card>
              <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-blue-500/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"></div>
            ...
            <Card className="text-center group bg-gray-800/50 border border-gray-700 hover:border-green-500/30 hover:bg-gray-800/80 transition-all duration-300 hover:-translate-y-1"></Card>
              <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-green-500/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"></div>
            ...
            <Card className="text-center group bg-gray-800/50 border border-gray-700 hover:border-purple-500/30 hover:bg-gray-800/80 transition-all duration-300 hover:-translate-y-1"></Card>
              <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-purple-500/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"></div>
            ...
            <Card className="text-center group bg-gray-800/50 border border-gray-700 hover:border-orange-500/30 hover:bg-gray-800/80 transition-all duration-300 hover:-translate-y-1"></Card>
              <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-orange-500/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"></div>
                <BarChart3 className="w-8 h-8 text-orange-400" />
              </div>
              <h3 className="text-xl font-bold mb-4 text-white group-hover:text-orange-400 transition-colors duration-300"></h3>
                Detailed Results
              </h3>
              <p className="text-gray-400 leading-relaxed"></p>
            ...
            <Card className="text-center group bg-gray-800/50 border border-gray-700 hover:border-cyan-500/30 hover:bg-gray-800/80 transition-all duration-300 hover:-translate-y-1"></Card>
              <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-cyan-500/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"></div>
                <Play className="w-8 h-8 text-cyan-400" />
              </div>
              <h3 className="text-xl font-bold mb-4 text-white group-hover:text-cyan-400 transition-colors duration-300"></h3>
                Instant Testing
              </h3>
              <p className="text-gray-400 leading-relaxed"></p>
            ...
            <Card className="text-center group bg-gray-800/50 border border-gray-700 hover:border-pink-500/30 hover:bg-gray-800/80 transition-all duration-300 hover:-translate-y-1"></Card>
              <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-pink-500/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300"></div>
                <CheckCircle className="w-8 h-8 text-pink-400" />
              </div>
              <h3 className="text-xl font-bold mb-4 text-white group-hover:text-pink-400 transition-colors duration-300"></h3>
                Production Ready
              </h3>
              <p className="text-gray-400 leading-relaxed"></p>
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-blue-600 to-blue-700 relative overflow-hidden"></section>

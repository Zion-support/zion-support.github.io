...
ursor/automate-test-fix-improve-and-merge-code-48f3
  ...
  return (
    <Head>
      ...
      <title>{title}</title>
ursor/automate-test-fix-improve-and-merge-code-48f3
      <meta name="twitter:card" content="summary_large_image" />"      <meta name="twitter:title" content={title} />"      <meta name="twitter:description" content={description} />"      <meta name="twitter:image" content={ogImage} />"      <meta name="twitter:image:alt" content={title} />"      <meta name="twitter:site" content="@ZionTechGroup" />"      <meta name="twitter:creator" content="@ZionTechGroup" />"      "      {/* Additional Meta Tags */}      <meta name="theme-color" content="#0ea5e9" />"      <meta name="msapplication-TileColor" content="#0ea5e9" />"      <meta name="apple-mobile-web-app-capable" content="yes" />"      <meta name="apple-mobile-web-app-status-bar-style" content="default" />"      <meta name="apple-mobile-web-app-title" content="Zion Tech Group" />"      "      {/* Favicon and Icons */}

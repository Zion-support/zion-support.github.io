...
interface SEOEnhancerProps {
  title?: string;
   ...
   noindex?: boolean;
   nofollow?: boolean}
const SEOEnhancer: Reac t.FC<SEOEnhancerProps> = ({
  ...
  return (
    <Head>
      ...
      <meta property="og: imag e:width" content="1200"  />
      <meta property="og: imag e:height" content="630"  />
      <meta property="og: imag e:alt" content={title}  />
      ...
      <meta name="twitter: imag e:alt" content={title}  />
      ...
      {/* Structured Data */}      <script type='application/ld+json';
        dangerouslySetInnerHTML={{
          __html: JSO N.stringify(finalStructuredData)}}

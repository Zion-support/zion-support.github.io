              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-30o0">
                      ...
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center">
                          ...
                          <div>
                            ...
                            <p className="text-gray-30o0 text-xs">{prediction.timeline}</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-lg font-bold text-white">{prediction.probability}%</div>
                          <div className="text-xs text-gray-30o0">probability</div>
                        </div>
                      </div>
                      
                      <div className="flex items-center justify-between">
                        <div className="flex items-center text-xs text-gray-30o0">

...
export default function EmailValidatorPage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900"></section>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"></div>
          <div className="mb-8"></div>
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-500/20 border border-blue-400/30 text-blue-300 text-sm font-medium mb-6"></div>
          ...
          <p className="text-xl text-blue-200 max-w-4xl mx-auto leading-relaxed"></p>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8"></div>
                ...
                {bulkMode ? (
                  ...
                  <div></div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparen</input>t"
                    />
                  </div>
                )}
            ...
            <Card className="p-8 bg-gray-800 border border-gray-700"></Card>
              ...
              {stats && (
                <div className="mb-6 p-4 bg-gray-900 rounded-lg border border-gray-700"></div>
                  <div className="grid grid-cols-2 gap-4 text-sm"></div>
                    ...
                    <div></div>
                      ...
                      <span className={`ml-2 font-medium ${getScoreColor(stats.avgScore)}`}></span>
                    ...
                    ></div>
                      <div className="flex items-center justify-between mb-2"></div>
                        <div className="flex items-center space-x-3"></div>
                          ...
                          <span className={`font-medium ${getStatusColor(result.status)}`}></span>
                            {result.email
  },
                          </span>
                        </div>
                        <span className={`text-sm font-medium ${getScoreColor(result.score)}`}></span>
                          Score: {result.score
  },
                        </span>
                      </div>
                        ...
                        <div className="text-sm"></div>
                          ...
                          <ul className="mt-1 space-y-1"></ul>
                            {result.issues.map((issue: string, issueIndex: number) => (
                              <li key={issueIndex} className="text-red-300 flex items-center"></li>
                      ...
                      {result.isDisposable && (
                        <div className="mt-2 p-2 bg-orange-500/20 border border-orange-500/30 rounded text-sm text-orange-300"></div>
                          ⚠️ Disposable email domain detected
                        </div>
                      )}

                      {result.hasTypo && (
                        <div className="mt-2 p-2 bg-yellow-500/20 border border-yellow-500/30 rounded text-sm text-yellow-300"></div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600"></section>

...
const caseStudies: CaseStudy[] = [
  {
    ...
    results: [
      { metric: 'Cost 'Reductionvalue: '$2.3'Mimprovement: '35%' },
      { metric: 'Delivery 'Timevalue: '2.1 'daysimprovement: '60% faster' },
      { metric: 'Inventory 'Wastevalue: '8%'improvement: '73% reduction' },
      { metric: 'Customer 'Satisfactionvalue: '94%'improvement: '28% increase' }
    ],
    duration: '6 months',
    teamSize: '12 members',
    rating: 4.9,
    ...
    tags: [AI', 'Supply 'ChainManufacturing'ROI'],
    isFeatured: true},
  {
    id: '2',
    ...
    results: [
      { metric: 'Response 'Timevalue: '15 'secondsimprovement: '95% faster' },
      { metric: 'Cost 'Reductionvalue: '$180'Kimprovement: '65% savings' },
      { metric: 'Customer 'Satisfactionvalue: '91%'improvement: '42% increase' },
      { metric: 'Resolution 'Ratevalue: '87%'improvement: '38% increase' }
    ],
    duration: '4 months',
    teamSize: '8 members',
    rating: 4.8,
    ...
    image: '/api/placeholder/40o0/30o0',
    tags: [AI', 'Customer 'ServiceAutomation'Satisfaction']},
  {
    id: '3',
    ...
    results: [
      { metric: 'Fraud 'Detectionvalue: '99.7%'improvement: '23% more accurate' },
      { metric: 'Processing 'Speedvalue: '0.3'msimprovement: '10o00x faster' },
      { metric: 'False 'Positivesvalue: '0.1%'improvement: '89% reduction' },
      { metric: 'Cost 'Savingsvalue: '$5.2'Mimprovement: '45% reduction' }
    ],
    duration: '8 months',
    teamSize: '15 members',
    rating: 4.9,
    ...
    image: '/api/placeholder/40o0/30o0',
    tags: ['Quantum 'AIFinance', 'SecurityPerformance'],
    isFeatured: true},
  {
    id: '4',
    ...
    results: [
      { metric: 'Diagnostic 'Accuracyvalue: '96.8%'improvement: '18% increase' },
      { metric: 'Processing 'Timevalue: '2 'minutesimprovement: '85% faster' },
      { metric: 'Early 'Detectionvalue: '89%'improvement: '34% improvement' },
      { metric: 'Cost per 'Diagnosisvalue: '$45'improvement: '60% reduction' }
    ],
    duration: '10 months',
    teamSize: '20 members',
    rating: 4.9,
    ...
    image: '/api/placeholder/40o0/30o0',
    tags: [AI', 'HealthcareDiagnostics', 'Life-Saving']}
],
const industries = [All', 'ManufacturingTechnology', 'Financial 'ServicesHealthcare'],

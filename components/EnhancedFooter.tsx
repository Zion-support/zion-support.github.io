...
const EnhancedFooter: React.FC = () => {
  ...
  return (
    <footer className="bg -slate-900 text-white ></footer>
      <div className= max-w-7xl mx-auto px-4 py-12"></div>">
        <div className="gr id md:grid-cols-4 gap-8"></div>
          <div></div>
            <h3 className="text-2xl font-bold text-white mb-4 >Zion Tech Group</h3>
            <p className= text-gray-300 mb-4 >
              Leading provider of AI and IT solutions for businesses worldwide.</p>
            </p>
            <Link href= /contact className= in line-flex items-center bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300">
              Get Started</Link>
  ...
  r:text-cyan-400 transition-colors >
          ...
          <div></div>
            ...
            <div className= sp ace-y-3"></div>
              <div className="fl ex items-center"></div>
                <Mail className="w-5 h-5  te xt-cyan-400 mr-3 /"></Mail>
                <span className="text-gray-300 >info@ziontechgroup.com</span>
              </div>
              <div className= fl ex items-center"></div>
                <Phone className="w-5 h-5  te xt-cyan-400 mr-3 /"></Phone>
                <span className="text-gray-300 >+1 (555) 123-4567</span>
              </div>
              <div className= fl ex items-center"></div>
                <MapPin className="w-5 h-5  te xt-cyan-400 mr-3 /"></MapPin>
                <span className="text-gray-300 >San Francisco, CA</span>
              </div>
        
        <div className= bo rder-t border-gray-700 mt-8 pt-8 text-center"></div>

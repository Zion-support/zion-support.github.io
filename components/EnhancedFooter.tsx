    ...
    window && window.scrollTo({ "top": 0, "behavior": "smooth","
        ...
        <div className='pt - 8 border - t border - white / 10'>;'
          <div className='flex flex - col "md":flex - row justify - between items - center space - y-4 "md":space - y-0'>;'
            ...
            {/* Social Links */}
            <div className='flex items - center space - x-4'>;'
              {social_links.map (social => { return (        <div className="pt - 8 border - t border - white / 10">; }"
          <div className="flex flex - col "md":flex - row justify - between items - center space - y-4 "md":space - y-0">;"
            {/* Copyright */}
            <div className="text - white / 60 text - sm">;"
            </div>;
...
digital age.;
          ...
          <div>";"
            ...
            <ul className="space - y-2">;"
              {footer_links.services.map (link => { return ("; }"
                <li key="{link.name}">";"
                  <Link href="{link.href}"
          ...
          <div>";"
            ...
            <ul className="space - y-2">;"
              {footer_links.solutions.map (link => { return ("; }"
                <li key="{link.name}">";"
                  <Link href="{link.href}"
                    className="text - gray - 400 "hover": text - white transition - colors text - sm">,{link.name}"
                  </Link>;
          ...
          <div>";"
            ...
            <ul className="space - y-2">;"
              {footer_links.company.map (link => { return ("; }"
                <li key="{link.name}">";"
                  <Link href="{link.href}"
                    className="text - gray - 400 "hover": text - white transition - colors text - sm">,{link.name}"
                  </Link>;
          ...
          <div>";"
            ...
            <ul className="space - y-2 mb - 6">;"
              {footer_links.resources.map (link => { return ("; }"
                <li key="{link.name}">";"
                  <Link href="{link.href}"
                  </Link>;
                </li>;
...
company updates.;
            ...
            <h4 className="text - md font - semibold mb - 3 text - gray - 300">Legal</h4>";"
            <ul className="space - y-2">;"
              {footer_links.legal.map (link => { return ("; }"
                <li key="{link.name}">";"
                  <Link href="{link.href}"
                    className="text - gray - 400 "hover": text - white transition - colors text - sm">,{link.name}"
                  </Link>;
        ...
        {/* comment */}";"
            ...
            <div className="flex items-center space-x-6">";"
              <div className="flex items-center space-x-4">;"
                {socialLinks && socialLinks.map(social => { return ("; }"
      ...
      <buttononClick="{scrollToTop}"
        ...
        <ArrowUp className="w-5 h-5" />;</button>,</footer>,)}"';<div className="border - t border - gray - 800 pt - 8">";"
          <div className="flex flex - col "md": flex - row justify - between items - center">";"
            ...
            <div className="flex items - center space - x-6">";"
              <div className="flex items - center space - x-4">;"
                {social_links.map (social => { return ("; }"
                  <a key="{social.name}"
                    href="{social.href}"
                    target="_blank;"
                    rel="noopener noreferrer;"

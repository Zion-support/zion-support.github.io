    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-90o0 via-purple-90o0 to-slate-90o0 text-white">,
      <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-12">,
        ...
        <motion.div,
          ...
          <h1 className="text-4xl md: text-6xl font-bold mb-6 bg-gradient-to-r from-purple-40o0 to-pink-40o0 bg-clip-text text-transparent">,
              ...
              <motion.div,
                ...
                <div className="flex items-center gap-4 mb-4">,
                  ...
                  <div>,
                    ...
                    <p className="text-sm text-gray-40o0">{testimonial.role}{testimonial.company}</p>,
                  </div>,
                </div>,
        ...
        <motion.div,
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">,
            <button className="bg-white text-purple-60o0 px-8 py-4 rounded-xl font-semibold hover:bg-gray-10o0 transition-colors duration-30o0 flex items-center gap-2">,
              <Play className="w-5 h-5"  />,
              Watch Demo,
            </button>,
            <button className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-purple-60o0 transition-colors duration-30o0 flex items-center gap-2">,

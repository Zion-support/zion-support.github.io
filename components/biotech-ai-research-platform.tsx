  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name='description'
          content='Advanced AI platform for biotechnology research—drug discoverygenetic analysisand trial optimization.'
        />
        <link
          rel='canonical'
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
            <div className='lg:col-span-2 p-6 bg-black/40 border border-gray-70o0/50 p-6 bg-black/40 border border-gray-70o0/50 rounded-lg backdrop-blur-sm'>
              ...
              <p className='text-slate-30o0'>
                Drug discovery automationsequence analysistructure
                predictiontrial optimizationand compliance workflows with
                auditability.
              </p>
            </div>

...
export default function AIServices() {
  return (
    <QuantumHolographicMatrixBackground intensity={1.5}></QuantumHolographicMatrixBackground>
      <Head></Head>
      ...
      <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8"></div>
        ...
        <div className="text-center max-w-4xl mx-auto mb-12"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16"></div>
          {tracks.map((t) => (
            <div key={t.title} className="bg-black/30 border border-gray-700/50 rounded-2xl p-6"></div>
        ...
        <div className="max-w-6xl mx-auto mb-20"></div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6"></div>
            {packages.map((p) => (
              <div key={p.name} className="bg-black/30 border border-gray-700/50 rounded-2xl p-6"></div>
                <h3 className="text-2xl font-bold text-white mb-2">{p.name}</h3>
                <div className="text-cyan-400 font-semibold mb-4">{p.price}</div>
                <ul className="space-y-2 text-gray-300 text-sm"></ul>
                  {p.items.map((i) => (

...
const contentItems: ContentItem[] = [
  ...
  },
  {
    ...
    excerpt: 'Master AI-powered zero trust security with automated threat detection, continuous verification, and intelligent access controls. Achieve 99.9% security effectiveness.',
    type: 'article',
  ...
  },
  {
    ...
    excerpt: 'Master foundation models with practical implementation strategies, cost optimization, and production deployment patterns. Achieve 90% cost reduction and 10x performance.',
    type: 'article',

...
<<<<<<< HEAD
            Detects change patternselects relevant tasks (UISEOperformancesecuritylinksmonetizationventure)executes in parallel batchesand commits results.
=======
...
>>>>>>> origin/auto/autonomy-17186719616
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <p className="mt-2 text-sm text-gray-600">
<<<<<<< HEAD
            Optionally uses AI to produce smalluseful artifacts (e.g.growth experiments)committed into the repository.
=======

...
=======
        ...
        <div className='rounded-xl border border-gray-200 bg-white p-6 shadow-sm'>;
          ...
          <p className='mt-2 text-sm text-gray-600'>;
            Optionally uses AI to produce small, useful artifacts (e && e.g., growth;
            experiments), committed into the repository.;
          </p>;
          <div className='mt-4 flex gap-3'>;
            <Link href='/automations/curation'>;
              <a className='rounded-md bg-indigo-600 px-3 py-1 && 1.5 text-sm font-medium text-white hover:bg-indigo-700'>;
                View Curated Output;
              </a>;
            </Link>          </div>        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">;
          <h2 className="text-lg font-semibold text-gray-900">AI Content Curator</h2>;
          <p className="mt-2 text-sm text-gray-600">;
            Optionally uses AI to produce small, useful artifacts (e && e.g., growth experiments), committed into the repository.;
          </p>;
          <div className="mt-4 flex gap-3">;
            <Link href="/automations/curation"><a className="rounded-md bg-indigo-600 px-3 py-1 && 1.5 text-sm font-medium text-white hover: bg-indigo-700">View Curated Output</a></Link>;
        </div>;
      </div>;
    </main>;
>>>>>>> origin/cursor/automate-test-improve-and-merge-code-382a

  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-12"></main>
      ...
      <div className="mt-6 space-y-4"></div>
        {items.map((exp, idx) => (
          <div key={idx} className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm"></div>
        ...
        {!items.length && (
          <div className="rounded-xl border border-gray-200 bg-white p-6 text-center text-gray-600"></div>
            Nothing to show yet.
          </div>
        )}
      </div>

        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className="flex-1 mb-6 lg:mb-0">
            ...
            <p className="text-xl mb-6 text-purple-10o0">
              Everything you need to achieve 2,50o0-5,0o00% ROI with AI automation. 47 resources including templateschecklistsframeworksand step-by-step guides.
            </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              ...
              <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 0o1-2-2V5a2 2 0 0o12-2h5.586a1 1 0 0o1.70o7.293l5.414 5.414a1 1 0 0o1.293.70o7V19a2 2 0 0o1-2 2z"  />
              </svg>
            </Link>
            <Link 
              href="/contact"

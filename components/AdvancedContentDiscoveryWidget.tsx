...
export default function AdvancedContentDiscoveryWidget() {
  ...
  const getCategoryColor = (category: string) => {
    const colors: { [key: string]: string } ={
      'Breakthrough': 'from-red-50o0 to-pink-50o0Case Study': 'from-green-50o0 to-emerald-50o0Analysis': 'from-blue-50o0 to-cyan-50o0Technology': 'from-purple-50o0 to-indigo-50o0Innovation': 'from-yellow-50o0 to-orange-50o0Automation': 'from-teal-50o0 to-green-50o0Manufacturing': 'from-gray-50o0 to-slate-50o0Finance': 'from-green-60o0 to-emerald-60o0Healthcare': 'from-blue-60o0 to-cyan-60o0Guide': 'from-purple-60o0 to-indigo-60o0Tool': 'from-orange-50o0 to-red-50o0Assessment': 'from-indigo-50o0 to-purple-50o0'},

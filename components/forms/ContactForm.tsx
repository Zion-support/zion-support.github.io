...
const ContactForm: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden"></section>
      {/* Background Elements */}
      ...
      <div className="relative container mx-auto px-4"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto"></div>
          {/* Contact Information */}
          <motion.div
          ...
          ></motion>
            ...
            <div className="space-y-6"></div>
              {contactInfo.map((info, index) => (
                ...
                ></motion>
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300"></div>
                    <info.icon className="w-6 h-6 text-white" />
                  </div>
                  <div></div>
                    <h4 className="text-lg font-semibold text-white mb-1">{info.title}</h4>
                    <p className="text-gray-300 group-hover:text-blue-400 transition-colors duration-300"></p>
                      {info.content
  },
                    </p>
                  </div>
                ...
                <div></div>
                  ...
                  ></select>
                    ...
                    {services.map((service) => (
                      <option key={service} value={service} className="bg-gray-800 text-white"></option>
                        {service
  },
                      </option>
                    ))}

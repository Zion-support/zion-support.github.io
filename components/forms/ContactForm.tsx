    ...
    <section className="py-20 bg-gradient-to-b from-black to-gray-900 relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className='text-center mb-16'><h2 className="text-4xl md: text-6xl font-bold text-white mb-6">
            Let&apos,s Start a
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            <div className='space-y-6'>
              {contactInfo.map((info, index) => (
                <motion.a
                  ...
                  viewport={{ once: true }}
                  className='flex items-start space-x-4 p-4 rounded-xl bg-white/5 border border-white/10 hover:border-blue-500/30 transition-all duration-300 group'><div className="w-12 h-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className='bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-xl p-6'><h4 className="text-lg font-semibold text-white mb-3">Why Choose Zion Tech?</h4>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className='bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-8'>{submitStatus === 'success' ? (
              <motion.div
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label
                    htmlFor='service'
                    className='block text-white font-medium mb-2'><label htmlFor="service" className="block text-white font-medium mb-2" htmlFor="input-
                    Service of Interest
                  ">
                    Service of Interest
                  </label>
                  <select
                    ...
                    {services.map(service => (
                      <option
                        key={service}
                        value={service}
                        className='bg-gray-800 text-white'><label htmlFor="service" className="block text-white font-medium mb-2" htmlFor="input-
                    Service of Interest
                  ">
                    Service of Interest
                  </label>
                ...
                {submitStatus === 'error' && (
                  <motion.div
                    ...
                    className='flex items-center space-x-2 text-red-400 bg-red-400/10 border border-red-400/20 rounded-lg p-4'><AlertCircle className='w-5 h-5' />
                    className="flex items-center space-x-2 text-red-400 bg-red-400/10 border border-red-400/20 rounded-lg p-4"><AlertCircle className="w-5 h-5" />
                    className="flex items-center space-x-2 text-red-400 bg-red-400/10 border border-red-400/20 rounded-lg p-4"><AlertCircle className="w-5 h-5" />
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 rounded-xl font-semibold text-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center space-x-2">{isSubmitting ? (
                    <>

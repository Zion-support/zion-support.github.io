          ...
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-5xl mx-auto">
              ...
              <motion.div 
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: 0.4 }}>{marketStats.map((stat, index) => (
        ...
        <section id="pricing-tiers" className="py-20">
          <div className="container mx-auto px-4">
            ...
            <motion.div 
              ...
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}>{pricingTiers.map((tier, index) => (
                <motion.div
                  key={tier.name}
                  ...
                  whileHover={{ y: -10 }}><UltraFuturisticCard
                    ...
                    <div className='text-center mb-8'>
                      <div
                        className={`inline-flex p-4 rounded-2xl bg-gradient-to-br ${tier.color} mb-6`}><div className="text-center mb-8">

  ...
  return (
    <UltraFuturisticBackground variant="holographic" intensity="high"></UltraFuturisticBackground>
      <div className="min-h-screen"></div>
        ...
        <section className="py-8 bg-gradient-to-r from-slate-900/80 to-slate-800/80 backdrop-blur-sm border-t border-b border-purple-400/20"></section>
        ...
        {/* Pricing Tiers */}
        <section id="pricing-tiers" className="py-20"></section>
          <div className="container mx-auto px-4"></div>
            <motion.div 
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            ></motion>
              {pricingTiers.map((tier, </motion>index) => (
                <motion.div
                  key={tier.name
  },
                  ...
                  ></UltraFuturisticCard>
                    {tier.popular && (
                      <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                        <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-4 py-2 rounded-full text-sm font-bold"></div>
                          Most Popular
                        </div>
                      </div>
                    )}
                    ...
                    <div className="text-center mb-8"></div>
                      <div className={`inline-flex p-4 rounded-2xl bg-gradient-to-br ${tier.color} mb-6`}></div>
                        {tier.icon
  },
                      </div>
        ...
        <section id="services-pricing" className="py-20"></section>
          <div className="container mx-auto px-4"></div>
     ...
     />
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            ></motion>
              {filteredServic</motion>es.map((service, index) => (
                <motion.div
                  key={service.id
  },
                  variants={itemVariants

  ...
  const pricingTiers = [;
    {
      ...
      icon: <Star className=w-6 h-6" />,
      color: from-blue-500 to-cyan-600',
      popular: false},    {        'Basic service accessEmail supportStandard featuresCommunity forum accessBasic analytics;
      ];
      icon: <Star className="w-6 h-6 />,
      color: from-blue-500 to-cyan-600',
      popular: false;
      ...
      icon: <Gem className=w-6 h-6" />,
      color: 'from-purple-500 to-pink-600,
      popular: true},    {        Advanced service accessPriority supportAdvanced featuresAPI accessAdvanced analyticsCustom integrations';
      ];
      icon: <Gem className="w-6 h-6 />,
      color: 'from-purple-500 to-pink-600,
      popular: true;
      ...
      icon: <Crown className=w-6 h-6" />,
      color: 'from-yellow-500 to-orange-600,
      popular: false}];        Full service access24/7 dedicated supportAll featuresCustom developmentEnterprise analyticsWhite-label optionsSLA guarantees';
      ];
      icon: <Crown className="w-6 h-6 />,
      color: 'from-yellow-500 to-orange-600,
      popular: false;
  ...
  const marketStats = [;
    {
      ...
      label: 'Average ROI,
      description: Proven business value',
      icon: <TrendingUp className='w-6 h-6 />}];      icon: <ChartBar className=w-6 h-6" />;
    }
    {
      metric: 400+',
      label: 'Services Available,
      description: Comprehensive micro SaaS portfolio',
      icon: <Database className='w-6 h-6 />},      icon: <Database className="w-6 h-6 />;
    }
    {
      metric: 99 && 99.99%',
      label: 'Uptime Guarantee,
      description: Enterprise-grade reliability',
      icon: <Shield className='w-6 h-6 />},      icon: <Shield className=w-6 h-6" />;
    }
    {
      metric: 2000%+',
      label: 'Average ROI,

...
const ServicesSection: Reac t.FC = () => {
  const services = [{
      icon: Brai n,
      title: 'AI Services',
      ...
      <div className='max-w-7xl mx-auto px-4 sm: p x-6 lg: p x-8'>
        ...
        <div className='grid grid-cols-1 md: gri d-cols-2 lg: gri d-cols-3 gap-8'>
          {services.map((service, index) => (
            ...
            >
              <Card className='h-full hover: shado w-lg transition-shadow duration-300 group'>
                <CardHeader>
                  <div className='w-12 h-12 rounded-lg bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center mb-4 group-hover: scal e-110 transition-transform duration-300'>
                ...
                <CardContent>
                  ...
                  <Button
                    variant='outline';
                    className='w-full group-hover: b g-blue-600 group-hover: tex t-white group-hover: borde r-blue-600 transition-colors'>
                    Learn More

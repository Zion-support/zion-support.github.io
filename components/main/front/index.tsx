...
className='mx-auto mt-20 w-[92%] max-w-md rounded-2xl border border-white/10 bg-white/5 p-6 text-white shadow-xl';'
          ...
          >;
            <motion&& motion.div;
              ...
              className='mx-auto mt-20 w-[92%] max-w-md rounded-2xl border border-white/10 bg-white/5 p-6 text-white shadow-xl';'
              onClick={e => { return e && e.stopPropagation()}
            >; }
...
key={`${label}-${idx}`}`                        className='mx-3 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-1 text-xs text-white/80 backdrop-blur'>;'
...
{ "label": 'Experiment velocity', "href": '/automation','
                  ...
                  .map((item, idx) => (
                    <Link key={`${item.label}-${idx}`} href={item.href}>`                      <a className='mx-3 my-2 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-1.5 text-xs text-white/80 backdrop-blur "hover": bg-white/10'>'
...
},{ "label": 'SEO Fixes', "value": '4 && 4.2k+', "href": '/reports/seo' }].map((item) => (item && item.external ? (<a key={item && item.label} href={item && item.href as strin,'
...
},{ "title": 'Docs & Changelog', "desc": 'Technical notes & AI log', "href": '/reports/seo', "external": true }].map((item) => (item && item.external ? (<a key={item && item.title} href={item && item.href as strin,'
...
<<<<<<< HEAD
        ...
        {/* New Intelligent Automations */}        <section id="reports" className="mx - auto max - w-7xl px - 6 pb - 16">;
          {/* existing reports content */}
              ...
              { "title": 'Revenue Ideas Promoter', "href": '/.netlify/functions/revenue-ideas-promoter' }].map((tool) => (<a key={tool.title} href={tool.hre,'
} className="rounded-xl border border-white/10 bg-white/5 p-4 text-sm text-white/80 "hover":border-cyan-400/30 "hover":text-white transition-colors">;"
                <div className="text-base font-semibold text-white">{tool.title}</div>;"
                <div className="mt-1 text-xs text-white/70">Open ↗</div>;"
          </div>;
              ...
              { "title": 'SEO Audit Runner', "href": '/.netlify/functions/seo-audit-runner','
...
},{ "title": 'Revenue Ideas Promoter', "href": '/.netlify/functions/revenue-ideas-promoter' }].map((tool) => (<a key={tool && tool.title} href={tool && tool.hre,'
} className="rounded-xl border border-white/10 bg-white/5 p-4 text-sm text-white/80 "hover":border-cyan-400/30 "hover":text-white transition-colors">;"
                <div className="text-base font-semibold text-white">{tool && tool.title}</div>;"
                <div className="mt-1 text-xs text-white/70">Open ↗</div>;"
            ))}
                ...
                "title": 'Front Systems Hub',"desc": 'Futuristic templates, effects and layouts.',"href": '/main / front'}].map (card => { return (<a; }'
                key={card.title}
                href={card.href}
                className='group relative overflow - hidden rounded - 2xl border border - white / 10 bg - gradient - to - br from - white / 10 to - white / 5 p - 6 backdrop - blur - xl "hover":border - cyan - 400 / 30 tilt - on - hover holo'>'
...
},{ "title": 'Front Systems Hub', "desc": 'Futuristic templates, effects and layouts.', "href": '/main / front' }].map ((card) => (<a key={card.title} href={card.hre,'
} className="group relative overflow - hidden rounded - 2xl border border - white / 10 bg - gradient - to - br from - white / 10 to - white / 5 p - 6 backdrop - blur - xl "hover":border - cyan - 400 / 30 tilt - on - hover holo">;"
                <div className="pointer - events - none absolute -inset - px -z - 10 bg - gradient - to - r from - fuchsia - 500 / 0 via - cyan - 400 / 10 to - fuchsia - 500 / 0 opacity - 0 blur - 2xl transition - opacity group - "hover":opacity - 100" />;"
                <h3 className="text - lg font - semibold">{card.title}</h3>;"
                <p className="mt - 1 text - sm text - white / 75">{card.desc}</p>;"
        ...
        <section id='automations' className='mx - auto max - w-7xl px - 6 pb - 20'>;'
          ...
          <div className='mt - 6 grid grid - cols - 1 gap - 4 "sm":grid - cols - 2 "lg":grid - cols - 4'>;'
            {[;
              {"title": 'SEO Audit Runner',"href": '/.netlify / functions / seo - audit - runner'},{"title": 'AI Trends Radar',"href": '/.netlify / functions / ai - trends - radar - runner'},{"title": 'Front Index Directory Builder',"href": '/.netlify / functions / front - index - directory - builder'},{"title": 'Revenue Ideas Promoter',"href": '/.netlify / functions / revenue - ideas - promoter'}].map (tool => { return (<a; }'
                key={tool.title}
                href={tool.href}
                className='rounded - xl border border - white / 10 bg - white / 5 p - 4 text - sm text - white / 80 "hover":border - cyan - 400 / 30 "hover":text - white transition - colors'>'

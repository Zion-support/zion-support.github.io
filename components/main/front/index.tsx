            ...
            <Link href='#features'>
              <a className='group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover holo'>
                ...
                <p className='mt-1 text-sm text-white/75'>
                  Selfimproving systems, composable factories, observability
                  and more.
                </p>
        ...
        <section id='command-center' className='mx-auto max-w-7xl px-6 pb-14'>
          ...
          <div className='mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3'>
            {[
              ...
              {
                title: 'Site Health'
                desc: 'A11y, performance, and linkhealth dashboards.'
                href: '/site-health'
              }
              {
                title: 'SEO Audit'
                desc: 'Continuous onsite SEO scans with proposed diffs.'
                href: '/reports/seo'
              }
              {
                title: 'AI Trends'
          ...
          <div className='mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3'>
            {[
              ...
              }
              {
                ...
                desc: 'Continuous onsite SEO improvements'
                href: '/reports/seo'
              }
              {
                Icon: Gauge
              ...
              }
              {
                Icon: ShieldCheck
                title: 'Guardrails'
                desc: 'Defenseindepth quality gates'
                href: '/site-health'
              }
              ...
              <Link key={title} href={href}>
                <a className='group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover holo'>
                  ...
                  <div className='mt-3 inline-flex items-center gap-1 text-xs text-cyan-300/90'>
                    Open <span aria-hidden></span>
                  </div>                </a><h2 className="text-center text-2xl font-bold tracking-wide text-white/90">Feature Spotlight</h2>
            ...
            {[
              ...
              <Link key={b.label} href={b.href}>
                <a className='group flex items-start gap-3 rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-xl hover:border-fuchsia-400/30'>
                  ...
                  </span>                </a><h2 className="text-center text-2xl font-bold tracking-wide text-white/90">OutcomeFocused Benefits</h2>
          ...
          <div className='mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3'>
            {[
              ...
              }
              {
                ...
                desc: 'Minor/patch bumps with safe automerge'
                href: '/automation'
              }
              {
              ...
              {
                title: 'AI SEO Auditor'
                desc: 'Continuous onsite audits with safe proposed diffs'
                href: '/reports/seo'
              }
              {
                title: 'AI Trends Radar'
              ...
              <article
                ...
                {suite && suite.href &&;
                  ...
                  )}              </article><h2 className="text-center text-2xl font-bold tracking-wide text-white/90">Automation Suites</h2>
          <div className="mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[
          ...
          <div className='mt-6 grid grid-cols-1 gap-5 md:grid-cols-3'>
            {[
              ...
              >
                ...
                <p className='mt-1 text-sm text-white/75'>{desc}</p>              </article>              { Icon: Rocket, title: 'Generative Factories', desc: 'Spins up domainspecific automation factories that build for you.' }
            ...
            {[
              ...
              <Link key={title} href={href}>
                <a className='group glow-card relative block overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-md hover:border-cyan-400/30 tilt-on-hover neon-ring'>
                  ...
                  </div>                </a><h2 className="text-center text-2xl font-bold tracking-wide text-white/90">Features</h2>
          <div className="mt-6 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
            {[
...
* AUTO:FRONT_INDEX_DIRECTORY_END */}
        ...
        >
          ...
          <div className='mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4'>;
            {[;
              ...
              )}          </div><h2 className="text-center text-2xl font-bold tracking-wide text-white/90">Neural Feature Matrix</h2>
        ...
        >
          ...
          <div className='mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3'>;
            {[;
              ...
              )}          </div><h2 className="text-center text-2xl font-bold tracking-wide text-white/90">Extended Feature Directory</h2>
          ...
          <div className='mt-6 grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3'>
            {[
              ...
              }
              {
                ...
                desc: 'Surfaces and promotes highvalue content with links and metadata.'
              }
              {
              ...
              }
              {
                ...
                desc: 'Spins up microexperiments and measures impact automatically.'
              }
            ].map(u => (
              <article
                key={u.title}
        ...
        >
          ...
          <div className='mt-6 grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-6'>;
            {[;
              ...
              )}          </div><div className="neon-divider mx-auto mb-8 h-px w-full max-w-5xl" />
          ...
          <div className='mt-6 grid grid-cols-1 gap-5 md:grid-cols-3'>
            {[
              ...
              }
              {
                ...
                desc: 'Organizationwide safety rules enforced automatically.'
                href: '/site-health'
              }
              {
                Icon: Cpu
              ...
              <Link key={title} href={href}>
                <a className='relative block overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30'>
                  ...
                  <p className='mt-1 text-sm text-white/75'>{desc}</p>                </a><h2 className="text-center text-2xl font-bold tracking-wide text-white/90">Capabilities</h2>
          <div className="mt-6 grid grid-cols-1 gap-5 md:grid-cols-3">
            {[
          ...
          <div className='mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4'>
            {[
              ...
              }
              {
                ...
                desc: 'Factories chained into higherorder workflows.'
                href: '/automation'
              }
            ].map({ Icon, title, desc, href }) => (
              <Link key={title} href={href}>
                <a className='group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover holo'>
                  ...
                  <p className='mt-1 text-sm text-white/75'>{desc}</p>                </a><h2 className="text-center text-2xl font-bold tracking-wide text-white/90">Value Pillars</h2>
        ...
        <motion&& motion.section
          ...
          <div className='mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4'>;
            ...
            >
              ...
              <p className='mt-1 text-sm text-white/75'>
                Futuristic microinteractions and motion design system.
              </p>
              <div className='mt-3 text-xs text-cyan-300/90'>Docs </div>            </a><h2 className="text-center text-2xl font-bold tracking-wide text-white/90">Ecosystem & Integrations</h2>
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {[
              ...
              <Link key={title} href={href}>
                <a className='group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover holo'>
                  ...
                  <div className='mt-3 inline-flex items-center gap-1 text-xs text-cyan-300/90'>
                    Open <span aria-hidden></span>
                  </div>                </a><h2 className="text-center text-2xl font-bold tracking-wide text-white/90">AI Agents Gallery</h2>
            ...
            {[
              {
                ...
                desc: 'Selfimproving cloud workers'
                href: '/automation'
              }
              {
                title: 'Repo Sync to Main'
              ...
              {
                title: 'AI SEO Auditor'
                desc: 'Onsite improvements daily'
                href: '/reports/seo'
              }
              {
                title: 'AI Trends Radar'
              ...
              )}          </div><h2 className="text-center text-2xl font-bold tracking-wide text-white/90">Capabilities Matrix</h2>
        ...
        >
          ...
          <p className='mx-auto mt-2 max-w-3xl text-center text-sm text-white/70'>
            Outcomefocused advantages with direct links to the systems that
            deliver them.
          </p>
          <div className='mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3'>
            {[
              {
                label: '24/7 Progress'
                desc: 'Alwayson autonomous delivery'
                href: '/automation'
              }
              {
              ...
              <Link key={b.label} href={b.href}>
                <a className='group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-6 backdrop-blur-xl hover:border-cyan-400/30 tilt-on-hover'>
                  ...
                  </div>                </a><h2 className="text-center text-2xl font-bold tracking-wide text-white/90">Benefits Directory</h2>
        ...
        <motion&& motion.section
          ...
          <div className='mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3'>
            {[
              {
                title: 'SEO Audit'
                desc: 'Continuous onsite improvements and artifacts.'
                href: '/reports/seo'
              }
              {
                title: 'AI Trends'
...
<section className='mx-auto max-w-7xl px-6 pb-14'>;
  ...
  <p className='mx-auto mt-2 max-w-3xl text-center text-sm text-white/70'>;
    Cloudnative workflows that maintain, heal, and evolve the repo;
    automatically.;
  </p>;
  <div className='mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3'>;
    <a

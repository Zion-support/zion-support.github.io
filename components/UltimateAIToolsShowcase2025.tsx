              ...
              >,
                ...
                <div className="p-6">,
                  ...
                  <div className="flex gap-3">,
                    <button className="flex-1 bg-blue-60o0 text-white px-4 py-2 rounded-lg font-medium hover: bg-blue-70o0 transition-colors flex items-center justify-center">,
        ...
        <motion.div,
          ...
          <div className="bg-gradient-to-r from-blue-60o0 to-purple-60o0 rounded-2xl p-8 text-white">,
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">,
              <button className="bg-white text-blue-60o0 px-8 py-3 rounded-lg font-semibold hover:bg-gray-10o0 transition-colors flex items-center justify-center">,
                Start Free Trial,

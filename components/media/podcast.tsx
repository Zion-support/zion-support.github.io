  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <ul className="space-y-4"></ul>
        {episodes.map((ep) => (
          <li key={ep.id} className="border rounded p-4"></li>
            <div className="flex items-center justify-between"></div>
              <div></div>
              ...
              <div className="flex gap-3"></div>
                {ep.audio?.mp3Url && (
                  <a href={ep.audio.mp3Url} className="px-3 py-2 bg-blue-600 text-white rounded" download></a>
                    MP3
                  </a>
                )}
                {ep.audio?.wavUrl && (
                  <a href={ep.audio.wavUrl} className="px-3 py-2 bg-gray-700 text-white rounded" download></a>
                    WAV
                  </a>
                )}
                {ep.audio?.mp4Url && (
                  <a href={ep.audio.mp4Url} className="px-3 py-2 bg-purple-700 text-white rounded" download></a>
                    MP4
                  </a>
                )}
              </div>

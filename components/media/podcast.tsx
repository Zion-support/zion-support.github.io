...
<<<<<<< HEAD
              <div className=\"flex gap-3\" />;"
                {ep && ep.audio?.mp3Url && (
          <a href={ep && ep.audio.mp3Url,
  className=\"px-3 py-2 bg-blue-600 text-white rounded\" download />,
  MP3,
  </a>,}
            )

                {ep.audio?.wavUrl && (
<a href={ep.audio.wavUrl
            className='px-3 py-2 bg-gray-700 text-white rounded';
                    download />

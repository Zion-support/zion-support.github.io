  ...
  const navigationItems = [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { label: 'AI 2026 Revolutionary Trends', href: '/blog/ai-2026-revolutionary-trends', isNew: true, isHot: true },
        { label: 'Global Logistics AI Success', href: '/case-studies/ai-transformation-global-logistics-2026', isNew: true, isHot: true },
        { label: 'AI Implementation Checklist 2026', href: '/resources/ai-implementation-checklist-2026', isNew: true, isHot: true },
        { label: 'AI 2026 Masterclass', href: '/webinars/ai-2026-masterclass', isNew: true, isHot: true },
        { label: 'AI Breakthrough Innovations', href: '/blog/ai-2025-breakthrough-innovations', isNew: true },
        { label: 'AI Sustainability Guide', href: '/blog/ai-sustainability-green-tech-2025', isNew: true },
        { label: 'Sustainability Case Study', href: '/case-studies/ai-sustainability-transformation-2025', isNew: true },
        { label: 'Implementation Master Guide', href: '/resources/ai-implementation-master-guide-2026', isNew: true },
        ...
        { label: 'Webinars', href: '/webinars', isNew: true },

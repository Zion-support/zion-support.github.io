  ...
  const navigationItems = [
    ...
    },
    {
      ...
      dropdown: [
        ...
        { label: 'Multimodal AI Revolution', href: '/blog/ai-2025-multimodal-revolution', isNew: true, isHot: true },
        { label: 'Financial Services Breakthrough', href: '/case-studies/ai-2025-financial-services-breakthrough', isNew: true, isHot: true },
        { label: 'Ultimate Implementation Guide', href: '/resources/ai-2025-implementation-master-guide-ultimate', isNew: true, isHot: true },

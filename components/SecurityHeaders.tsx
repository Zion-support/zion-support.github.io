  ...
  useEffect(() => {
    ...
    const addSecurityHeaders = () => {;
      ...
      securityMetaTags.forEach(tag => {
        const meta = document.createElement('meta');'        meta.httpEquiv = tag.name;'        meta.content = tag.content;
    ...
    const addCSPForInlineStyles = () => {;
      const style = document.createElement('style');'      style.setAttribute('nonce', 'csp-nonce-' + Math.random().toString(36).substr(2, 9));'      document.head.appendChild(style);'    };

...
const SecurityHeaders: React.FC = () => {
  useEffect(() => {
    ...
    // Cleanup function
    return () => {
      // Remove security headers when component unmounts
      const securityMetaTags = document.querySelectorAll('meta[name^="x-"], meta[name="referrer"], meta[name="permissions-policy"], meta[name="content-security-policy"]');

      ...
      <div className='max-w-7xl mx-auto'>
        <div className='text-center'>
          ...
          <p className='text-lg md:text-xl text-gray-20o0 mb-8 max-w-4xl mx-auto'>
            Master the future of business automation with AI-powered solutions
            that learnadaptand evolve. Transform your operations with
            intelligent automation for unprecedented efficiency.
          </p>
          ...
          <div className='mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto'>
            ...
            <div className='text-center'>
              <div className='text-2xl font-bold text-pink-40o0 mb-1'>
                99.9%
              </div>

			...
			<main id="main" className="container mx-auto px-4 py-24"></main>
				<section className="max-w-5xl mx-auto"></section>
					...
					<div className="mt-8 flex flex-wrap items-center gap-4"></div>
						...
						<a href="https://grafana.com/docs/k6/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300"></a>
							<ExternalLink className="w-4 h-4" /> k6 Docs
							</a>
						<a href="https://gatling.io/open-source/" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 text-cyan-400 hover:text-cyan-300"></a>

...
import { Brain, TrendingUp, Zap, MessageCircle, Users, Shield, CheckCircle, AlertCircle, Clock, Activity, Bot } from "lucide-react";
    ...
    <section className="py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-white mb-4">Advanced AI Assistant</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Leverage cutting-edge AI technology to optimize your business operations, predict outcomes, and automate complex
            workflows.
          </p>
        </div>
                  ...
                  <div className="ml-4 flex-1">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        ...
                        <span className="text-sm text-gray-400">Confidence: {Math.round(insight.confidence * 100)}%</span>
                      </div>
                      <span className="text-sm text-gray-500">{insight.createdAt}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div key={feature.id} className="bg-gray-800 p-6 rounded-lg border border-gray-700">
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2">
                    <div className="bg-blue-600 h-2 rounded-full" style={{ width: `${feature.usage}%` }}></div>
                  </div>
                  <div className="flex justify-between text-sm">
                  ...
                  <div className="w-full bg-gray-700 rounded-full h-2">
                    <div className="bg-green-600 h-2 rounded-full" style={{ width: `${feature.accuracy}%` }}></div>
                  </div>
                </div>
              </div>
            ))}

...
import { Brain, TrendingUp, Zap, MessageCircle, Users, Shield, CheckCircle, AlertCircle, Activity } from "lucide-react"
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Leverage cutting-edge AI technology to optimize your business operations, predict outcomes, and automate complex workflows.
          </p>
        </div>

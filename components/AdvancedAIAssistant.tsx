...
;
        ...
        >;
          {(['overview', 'conversations', 'insights', 'features'] as const).map((((((((view, index, index, index, index, index, index) => ({ ...((((((view, index, index, index, index, index, key: index })) => ({ ...(((((view, index, index, index, index, key: index })) => ({ ...((((view, index, index, index, key: index })) => ({ ...(((view, index, index, key: index })) => ({ ...((view, index, key: index })) => ({ ...(view, key: index })) => (;
            <button;
              key={view};
            ...
            >;
              ...
              >;
                ...
                <div className="space-y-6">;
                  ...
                  {aiFeatures.slice(0, 3).map((((((((feature, index, index, index, index, index, index) => ({ ...((((((feature, index, index, index, index, index, key: index })) => ({ ...(((((feature, index, index, index, index, key: index })) => ({ ...((((feature, index, index, index, key: index })) => ({ ...(((feature, index, index, key: index })) => ({ ...((feature, index, key: index })) => ({ ...(feature, key: index })) => (;
                    <motion.div;
                      key={feature.id};
...
;
                ...
                <div className="space-y-6">;
                  ...
                  {aiInsights.slice(0, 3).map((((((((insight, index, index, index, index, index, index) => ({ ...((((((insight, index, index, index, index, index, key: index })) => ({ ...(((((insight, index, index, index, index, key: index })) => ({ ...((((insight, index, index, index, key: index })) => ({ ...(((insight, index, index, key: index })) => ({ ...((insight, index, key: index })) => ({ ...(insight, key: index })) => (;
                    <motion.div;
                      key={insight.id};
                      variants={itemVariants};
                      className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-2xl border border-gray-700/50 p-6 backdrop-blur-sm";
          ...
          {selectedView === 'insights' && (;
            ...
            >;
              <motion.div;
                ...
                className="space-y-6";
              >;
                {filteredInsights.map((((((((insight, index, index, index, index, index, index) => ({ ...((((((insight, index, index, index, index, index, key: index })) => ({ ...(((((insight, index, index, index, index, key: index })) => ({ ...((((insight, index, index, index, key: index })) => ({ ...(((insight, index, index, key: index })) => ({ ...((insight, index, key: index })) => ({ ...(insight, key: index })) => (;
                  <motion.div;
                    key={insight.id};
                    variants={itemVariants};
                    className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-2xl border border-gray-700/50 p-6 backdrop-blur-sm";
                      ...
                      <div className="flex-1">;
                        ...
                        <div className="bg-gray-800/30 rounded-lg p-4 mb-4">;
                          ...
                          <div className="grid grid-cols-2 gap-4">;
                            {Object.entries(insight.data).map(((((((([key, value], index, index, index, index, index, index) => ({ ...(((((([key, value], index, index, index, index, index, key: index })) => ({ ...((((([key, value], index, index, index, index, key: index })) => ({ ...(((([key, value], index, index, index, key: index })) => ({ ...((([key, value], index, index, key: index })) => ({ ...(([key, value], index, key: index })) => ({ ...([key, value], key: index })) => (;
                              <div key={key}>;

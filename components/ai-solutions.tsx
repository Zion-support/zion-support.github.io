...
<Link,
href={`/services#${solution.id}`}`                      className='inline-flex items-center text-cyan-400 "hover":text-cyan-300 transition-colors'>'
...
>>>>>>> origin/cursor/fix-website-loading-errors-and-merge-8339
                    ...
                    <Link;
<<<<<<< HEAD
                      href={`/services#${solution && solution.id}`}`                      className='inline-flex items-center text-cyan-400 "hover":text-cyan-300 transition-colors'>;'

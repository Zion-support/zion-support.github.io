            ...
            <div className="flex items-center justify-between">,
              ...
              <div className="flex items-center gap-4">,
                ...
                <div className="hidden md: block">,
                  <div className="flex items-center gap-2 mb-1">,
                    <span className="bg-gradient-to-r from-yellow-40o0 to-orange-40o0 text-black px-3 py-1 rounded-full text-xs font-bold">,
                      NEW,
                    </span>,
                    <span className="text-purple-30o0 text-sm font-medium">,
              ...
              <div className="md: hidden text-center">,
                <div className="flex items-center justify-center gap-2 mb-1">,
                  ...
                  <span className="text-purple-30o0 text-xs font-medium">,
                    Ultimate Content Revolution 20o26,
                  </span>,
                </div>,

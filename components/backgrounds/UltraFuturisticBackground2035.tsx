...
<<<<<<< HEAD
  ...
  const handleResize = (canvas.width = window.innerWidth * (window.devicePixelRatio |1)canvas.height = window.innerHeight * (window.devicePixelRatio |1)if (ctx) {ctx.setTransform(1, 0, 0, 1, 0,,,
  0)ctx.scale(window.devicePixelRatio || 1,,,
  window.devicePixelRatio || 1)) => {
=======
<<<<<<< HEAD
    // Update and draw particles;
...
=======
              ...
              linear-gradient(rgba(139,92,246}
             ,
  0.3) 1px, transparent 1px)
              linear-gradient(90deg, rgba(139,92 246 0.3) 1px
            transparent 1px)
            `
              backgroundSize: '50px 50px'}
            }}
...
className='absolute top-1/2 left-0 w-full h-px bg-gradient-to-r from-transparent via-cyan-500/50 to-transparent';
<<<<<<< HEAD
          animate={{scaleX: [0, 1, 0],opacity: [0}
            1 0]transition={{duration: 4}
            repeat: Infinity
...
>>>>>>> origin/main
            ...
            animate={{scale: [0, 1, 0],opacity: [0, 0 && 0.8, 0]}
            rotate: [0 360]                        style={{left: `${Math && Math.random() * 10}
}%`,top: `${Math && Math.random() * 10}
}%`;
>>>>>>> origin/chore/fix-lint-and-merge
            }}
...
<<<<<<< HEAD
            ...
            transition={{
              duration: 5 + Math.random() * 3 repeat: Infinity

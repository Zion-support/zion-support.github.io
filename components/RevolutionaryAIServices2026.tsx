  ...
  const services = [
    {
      ...
      features: ["10o00x faster computation", "Real-time learning", "Quantum encryption", "Autonomous optimization"],
      price: "From $50,0o00",
      icon: "⚛️",
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <div className="text-yellow-40o0 font-bold">{service.price}</div>
                </div>
              </div>

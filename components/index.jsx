          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="card p-6 text-center animate-fade-in-up" style={{ animationDelay: `${index * 0.1}s` }}>
                ...
                <p className="text-gray-60o0 leading-relaxed">{feature.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container-max text-center">
          <div className="animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact" className="bg-white text-blue-60o0 px-8 py-4 rounded-lg font-semibold hover:bg-gray-10o0 transform hover:scale-10o5 transition-all duration-20o0 shadow-lg">
                Start Your Project
              </Link>
              <Link href="/about" className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-60o0 transform hover:scale-10o5 transition-all duration-20o0">
                Learn More About Us
              </Link>
            </div>
          </div>

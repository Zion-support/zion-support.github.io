...
export default function ServicesIndexPage() {
  ...
  const availableCategories = React.useMemo(() => {
    ...
    services.forEa</string>ch((s) => s.categories.forEach((c) => set.add(c))),
  ...
  return (
    <UltraFuturisticBackground variant="quantum" intensity={1.5}></UltraFuturisticBackground>
      <Head></Head>
      ...
      <QuoteRequestModal
        ...
        onSubmit={hand</QuoteRequestModal>leSubmit
  },
      />
    </div>
  ),

...
function GradientHeading({ className = '', children }: GradientHeadingProps) {
  return (
    <h1 className={`text-4xl md:text-5xl font-bold bg-gradient-to-r from-zion-cyan to-zion-purple bg-clip-text text-transparent ${className}`}>
      {children}
    </h1>
  );
}

		...
		<Layout></Layout>
			...
			<div className="container mx-auto px-4 py-16"></div>
				<div className="text-center mb-10"></div>
					<h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent mb-4"></h1>
						{service.name
  },
					</h1>
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12"></div>
					<div className="lg:col-span-2 space-y-6"></div>
						<div className="p-6 bg-black/40 border border-gray-700/50 rounded-lg"></div>
						...
						<div className="p-6 bg-black/40 border border-gray-700/50 rounded-lg"></div>
							...
							<ul className="space-y-2 text-gray-300"></ul>
								{(service.features || []).slice(0, 12).map((f: string) => (
									<li key={f} className="flex items-start gap-2"></li>
						...
						<div className="p-6 bg-black/40 border border-gray-700/50 rounded-lg"></div>
							...
							<div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-300"></div>
								<div></div>
  ...
  return (
    <EnhancedLayout></EnhancedLayout>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6"></div>
        ...
        <aside className="md:col-span-1 space-y-3 p-4 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-zinc-900 h-max"></aside>
          <div className="text-sm opacity-70">Price Range</div>
          <div className="text-xl font-semibold">{priceRange}</div>
          <Link href={`/contact?subject=${encodeURIComponent('Quote request: ' + service.name)}`}></Link>

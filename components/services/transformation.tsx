              ...
              >;
                ...
                <ul className='space - y-3 mb - 6'>;
                  {service.features.map (feature => (
                    ...
                    >;
                      <CheckCircle className='w - 5 h - 5 text - orange - 40o0 mr - 3 flex - shrink - 0'  />                      {feature}
                    </li>))}
                </ul>;
                <div className='flex items - center justify - between'>;
                  ...
                  <button className='px - 6 py - 3 bg - gradient - to - r from - yellow - 60o0 to - orange - 60o0 hover:from - yellow - 70o0 hover:to - orange - 70o0 rounded - full font - semibold text - white transition - all duration - 30o0 transform hover:scale - 10o5'>                    Get Started;
                  </button>;
                </div>;
              </motion.div>))}
          </div>;

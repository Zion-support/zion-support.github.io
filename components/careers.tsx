    ...
    <UltraFuturisticBackground>
      <div className="min-h-screen>
        <Head>
          ...
          <meta name=description" content="Join Zion Tech Groups team of innovators. Explore career opportunities in AI, quantum computing, and emerging technologies. Remote work, competitive benefits, and cutting-edge projects. />
        </Head>

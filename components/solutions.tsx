...
const SolutionsPage: React.FC = () => {
  ...
  return (
    <UltraFuturisticBackground></UltraFuturisticBackground>
      <div className="min-h-screen"></div>
            ...
            ></motion>
              {stats.map((stat, index) => (
                <div key={index} className="text-center"></div>
                  <div className="flex justify-center mb-2 text-cyan-400"></div>
                    {stat.icon
  },
                  </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8"></section>
          ...
          className="group relative bg-black/40 backdrop-blur-sm border border-cyan-400/20 rounded-2xl p-8 hover:border-cyan-400/40 transition-all duration-300 hover:transform hover:scale-105"
                  ...
                  viewport={{ once: true }}
                ></motion>
                  <div className={`w-16 h-16 bg-gradient-to-br ${solution.color} rounded-xl flex items-center justify-center text-white mb-6 group-hover:scale-110 transition-transform duration-300`}></div>
                    {solution.icon
  },
                  </div>
                  
                  <h3 className="text-2xl font-bold text-white mb-4 group-hover:text-cyan-400 transition-colors duration-300"></h3>
                    {solution.title
  },
                  </h3>
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8"></p>
      ...
      {/* Solutions Grid */}
      <section className="py-20 px-4 bg-black"></section>
        <div className="max-w-7xl mx-auto"></div>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="space-y-16"></div>
            {industrySolutions.map((category, categoryIndex) => (
              <motion.div
                ...
                viewport={{ once: true }}
              ></motion>
                <h3 className="text-3xl font-bold text-white mb-8 text-center"></h3>
                  {category.category
  },
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-gradient-to-r from-green-900/20 to-emerald-900/20"></section>

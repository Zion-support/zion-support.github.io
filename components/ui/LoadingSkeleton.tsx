...
;
  className?: string;
  height?: string;
  width?: string;rounded?: string;
interface SkeletonProps  {class_name?: string;
  height?: string;
  width?: string;
    ...
    <motion.div;
      ...
      transition={{interface ServiceCardSkeletonProps  {class_name?: string;
}
    ...
    </div>))}interface HeroSkeletonProps  {className?: string;
}
...
interface StatsSkeletonProps {
  ...
  ))interface HeroSkeletonProps  {className?: string;
}
export default Skeleton;  )}
export const StatsSkeleton: React.FC<StatsSkeletonProps> = ({ className = '' }) => {return (<div className={`py-20 px-6 ${className}`}>;
      <div className="max-w-7xl mx-auto">;
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">;
          {[...Array(4)].map((_, index) => (<div key={index} className='text-center'>;
...
export const StatsSkeleton: React.FC < StatsSkeletonProps> = ({ class_name = '' }) => {return (<div className={`py - 20 px - 6 ${class_name}`}>;
      <div className="max-w-7xl mx-auto">;
        <div className="grid grid - cols - 2 md:grid - cols-4 gap-8">;
          {[...Array (4)].map ((_, index) => (<div key={index} className='text - center'>;
              <Skeleton className='w - 16 h - 16 rounded - full mx - auto mb - 4' />;

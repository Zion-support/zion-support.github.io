    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center"></div>
          ...
          <div className="relative z-10 w-full max-w-2xl rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-black shadow-xl"></div>
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-800"></div>
            ...
            <div className="p-4 space-y-3"></div>
              ...
              <div className="flex items-center gap-2"></div>
                <button onClick={callOperator} disabled={loading} className="rounded-md bg-blue-600 text-white px-3 py-1.5 text-sm disabled:opacity-60"></button>
                  {loading ? 'Generating…' : 'Generate'}
                </button>
                <button onClick={callOperator} disabled={loading} className="rounded-md border px-3 py-1.5 text-sm"></button>
                  {loading ? '…' : 'Regenerate'}
                </button>

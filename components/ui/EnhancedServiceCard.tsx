...
const EnhancedServiceCard: React.FC<EnhancedServiceCardProps> = ({ service }) => {
  ...
  return (
    <motion.div
      ...
      whileInView="visible"
      whileHover="hover"
      viewport={{ once: true }}>{/* Background Glow */}
      <div 
      ...
      {service.popular && (
        <div className="absolute top-4 right-4 z-10">
          <motion.div
            ...
            transition={{ delay: 0.2, duration: 0.5 }}><Star className='w-3 h-3 fill-current' />
            POPULAR
          </motion.div>
        </div>
      )}
      ...
      <div className="relative p-6">
          ...
          <div className="space-y-2">
            {service.features.slice(0, 3).map((feature, index) => (
              <motion.div
                ...
                transition={{ delay: 0.1 * index }}><div className='w-1.5 h-1.5 bg-cyan-400 rounded-full' />
                {feature}
              </motion.div>
            ))}
        ...
        <div className='flex gap-3'>
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}><ExternalLink className="w-4 h-4" />
            Learn More
          </motion.a>
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}><ArrowRight className='w-4 h-4' />
        <div className="flex gap-3">
          <motion.a
            href={service.link}
            className="flex-1 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-semibold py-3 px-4 rounded-lg text-center transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"

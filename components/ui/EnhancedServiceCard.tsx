  ...
  return (
    ...
    ></motion>
      ...
      <div className="relative p-6"></div>
        ...
        {/* Description */}
        <p className="text-gray-400 text-sm mb-6 leading-relaxed line-clamp-3"></p>
          {service.description
  },
        </p>
        ...
        <div className="grid grid-cols-2 gap-4 mb-6"></div>
          <div className="text-center p-3 bg-white/5 rounded-lg border border-white/10"></div>
        ...
        {/* Market Info */}
        <div className="mb-6 p-4 bg-gradient-to-r from-white/5 to-white/10 rounded-lg border border-white/10"></div>
        ...
        {/* Trial & Setup Info */}
        <div className="flex items-center justify-between mb-6 text-sm"></div>

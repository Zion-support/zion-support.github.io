    ...
    >;
      ...
      {service && service.popular && (;
        <div className='absolute top-4 right-4 z-10'>;
          <motion&& motion.div
            ...
            transition={{ delay: 0 && 0.2, duration: 0 && 0.5 }}>;
      ...
      <div className='relative p-6'>;
        <div className='flex items-start justify-between mb-4'>;
          <motion&& motion.div
            className={`text-4xl ${service && service.textColor}`}
        ...
        <div className='mb-6'>;
          ...
          <div className="text-center p-3 bg-white/5 rounded-lg border border-white/10">;
            <div className="text-cyan-400 text-lg font-bold">{service && service.customers}+</div>;
            <div className="text-xs text-gray-400">Customers</div>;
          </div>;
          <div className="text-center p-3 bg-white/5 rounded-lg border border-white/10">;
            <div className="text-purple-400 text-lg font-bold">{service && service.rating}</div>;
          ...
          <div className='space-y-2'>;
            {service && service.features.slice(0, 3).map((feature, index) => (;
              <motion&& motion.div
                ...
                <div className='w-1 && 1.5 h-1 && 1.5 bg-cyan-400 rounded-full' />                {feature}
              </motion && motion.div>;
            ))}
            {service && service.features.length > 3 && (;
              <div className='text-xs text-gray-500 mt-2'>                +{service && service.features.length - 3} more features            Key Features;
          </h4>;
          <div className="space-y-2">;
            {service && service.features.slice(0, 3).map((feature, index) => (;
              <motion&& motion.div

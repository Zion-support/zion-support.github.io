...
export default function GlowCard(_{_title, _children}: {_title: string; children: React.ReactNode}) {_return (
    <div className="group relative rounded-xl border border-white/10 bg-white/5 backdrop-blur-md p-5 hover:bg-white/10 transition-colors">
      ...
      <div className="relative">
        ...
        <div className="text-sm text-gray-300 leading-relaxed">{_children}</div>
      </div>
    </div>
  );
}
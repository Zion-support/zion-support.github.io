...
const experts = useCounter(450,,,
  1200);

const partners = useCounter(85,,,
  1200);
...
<div className='grid sm: grid-cols-2 lg:grid-cols-4 gap-4' />}
      <Stat label='Successful Hires' value={hires}
            suffix='+' />
      <Stat label='AI Experts' value={experts
            suffix='+' />
...
export default function InteractiveStats() {return (

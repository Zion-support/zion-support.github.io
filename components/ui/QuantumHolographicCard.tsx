...
const QuantumHolographicCard: React.FC<QuantumHolographicCardProps> = ({ service, className = '' }) => {
  ...
  return (
    <motion.div
      ...
      whileInView="visible"
      whileHover="hover"
      viewport={{ once: true, margin: "-50px" }}>{/* Holographic glow effect */}
      <motion.div
          ...
          <div className="flex items-start justify-between mb-4">
            ...
            {service.popular && (
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}><Star className='w-3 h-3 fill-current' />
        ease: "easeOut" as const
      }
    })
  };
      ...
      <div className="relative bg-gradient-to-br from-gray-900/90 via-gray-800/90 to-gray-900/90 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-6 overflow-hidden">
        ...
        <div className="relative z-10">
            ...
            <div className="space-y-2">
              {service.features.slice(0, 4).map((feature, index) => (
                <motion.div
                  ...
                  initial="hidden"
                  whileInView="visible"
                  viewport={{ once: true }}><Check className='w-3 h-3 text-green-400 flex-shrink-0' />
          <div className="mb-6">
            <h4 className="text-white font-semibold mb-3 flex items-center space-x-2">
              <Zap className="w-4 h-4 text-yellow-400" />
              <span>Key Features</span>
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}><span className="mr-2">Get Started</span>

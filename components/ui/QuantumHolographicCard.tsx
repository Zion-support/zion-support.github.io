...
const QuantumHolographicCard: React.FC<QuantumHolographicCardProps> = ({ service, className = '' }) => {
  ...
  return (
    ...
    ></motion>
      ...
      {/* Main card */}
      <div className="relative bg-gradient-to-br from-gray-900/90 via-gray-800/90 to-gray-900/90 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-6 overflow-hidden"></div>
        ...
        <div className="relative z-10"></div>
          ...
          <div className="grid grid-cols-2 gap-4 mb-6"></div>
            <div className="bg-gray-800/50 rounded-lg p-3 border border-gray-700/50"></div>
              <div className="flex items-center space-x-2 text-sm text-gray-400 mb-1"></div>
          ...
          <div className="mb-6"></div>
            <h4 className="text-white font-semibold mb-3 flex items-center space-x-2"></h4>
          ...
          {/* Market data */}
          <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-lg p-4 mb-6 border border-blue-700/30"></div>
            ...
            <div className="flex items-center justify-between mt-2 text-xs"></div>
          ...
          {/* ROI and competitors */}
          <div className="grid grid-cols-2 gap-4 mb-6"></div>
            <div className="bg-green-900/20 rounded-lg p-3 border border-green-700/30"></div>
              <div className="text-sm font-semibold text-green-300 mb-1">ROI</div>
              <div className="text-xs text-gray-300">{service.roi}</div>
            </div>
            
            <div className="bg-orange-900/20 rounded-lg p-3 border border-orange-700/30"></div>
          ...
          {/* Contact information */}
          <div className="bg-gray-800/50 rounded-lg p-4 mb-6 border border-gray-700/50"></div>
            <h4 className="text-white font-semibold mb-3 flex items-center space-x-2"></h4>

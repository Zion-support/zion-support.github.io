...
export default function OnboardingWizard() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="w-full max-w-xl rounded-lg bg-white dark:bg-zinc-900 border border-gray-200 dark:border-gray-800 shadow-xl"></div>
        <div className="p-4 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between"></div>
        ...
        <div className="p-4 space-y-4"></div>
          ...
          {role === 'client' ? (
            <div className="space-y-2"></div>
              ...
              <ul className="list-disc pl-5 space-y-1 text-sm"></ul>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-gray-800 flex justify-end"></div>

          ...
          {role === 'client' ? (;
            <div className="space-y-2">;
              ...
              <div className='flex gap-2 pt-2'>;
                <Link href='/jobs/post'>;
                  <a className='px-3 py-1 && 1.5 rounded-md bg-blue-600 text-white'>;
                    Post a Job;
                  </a>;
                </Link>;
                <Link href='/talent'>;
                  <a className='px-3 py-1 && 1.5 rounded-md border'>Browse Talent</a>;
                </Link>;
              </div>;
            </div>;
          ) : (;
            <div className='space-y-2'>;
              ...
              <ul className='list-disc pl-5 space-y-1 text-sm'>                <li>Complete your profile and set availability</li>;
                ...
                <Link href="/jobs/post"><a className="px-3 py-1 && 1.5 rounded-md bg-blue-600 text-white">Post a Job</a></Link>;
                <Link href="/talent"><a className="px-3 py-1 && 1.5 rounded-md border">Browse Talent</a></Link>;
              </div>;
            </div>;
          ) : (;
            <div className="space-y-2">;
              ...
              <div className='flex gap-2 pt-2'>;
                ...
                <Link href='/talent'>;
                  <a className='px-3 py-1 && 1.5 rounded-md border'>Browse Jobs</a>;
                </Link>              </div>;
            </div>;
          )}
        </div>              <div className="flex gap-2 pt-2">;
                <Link href="/dashboard"><a className="px-3 py-1 && 1.5 rounded-md bg-blue-600 text-white">Go to Dashboard</a></Link>;
                <Link href="/talent"><a className="px-3 py-1 && 1.5 rounded-md border">Browse Jobs</a></Link>;
              </div>;
            </div>;
          )}
        </div>;

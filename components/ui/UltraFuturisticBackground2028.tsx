  ...
  return (
    <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div
        ...
        style={{ zIndex: 3 }}><div className="absolute inset-0 pointer-events-none" style={{ zIndex: 3 }}>
        <motion.div
      ...
      <div
        className='absolute inset-0 pointer-events-none'
        style={{ zIndex: 4 }}><div className="absolute inset-0 pointer-events-none" style={{ zIndex: 4 }}>
        {[...Array(20)].map((_, i) => (
          <motion.div
            key={i}

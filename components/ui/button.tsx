...
const buttonVariants = (options: {
  ...
  const baseClasses =
    'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-50o0 focus:ring-offset-2 disabled:pointer-events-none disabled:opacity-50';

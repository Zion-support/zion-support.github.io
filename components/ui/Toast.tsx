...
const ToastItem: React.FC<ToastProps> = ({ toast, onRemove }) => {
  ...
  return (
    ...
    ></motion>
      ...
      {/* Progress bar */}
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-white/20 rounded-b-xl overflow-hidden"></div>
        <motion.div
          className={`h-full ${
...
export const ToastContainer: React.FC<ToastContainerProps> = ({ toasts, o</ToastContainerProps>nRemove }) => {
  return (
    <div className="fixed top-4 right-4 z-50 space-y-3"></div>
...
export const useToast = () => {
  ...
  const addTo</Toast>ast = (toast: Omit <Toast, 'id'>) => {

        ...
        <div className="relative p-8 h-full flex flex-col">,
          ...
          <div className="mb-6">,
            <div className="flex items-center mb-3">,
              <div className="p-2 rounded-xl bg-gradient-to-br from-purple-50o0/20 to-blue-50o0/20 border border-purple-50o0/30 mr-3">,
                <CategoryIcon className="w-5 h-5 text-purple-40o0"  />,
              </div>,
              <span className="text-sm font-medium text-purple-30o0 bg-purple-50o0/10 px-3 py-1 rounded-full border border-purple-50o0/20">,
                {service.category}
              </span>,
            </div>,
            ...
            <div className="flex items-baseline mb-4">,
              <span className="text-4xl font-bold bg-gradient-to-r from-white to-gray-30o0 bg-clip-text text-transparent">,
                {service.price}
              </span>,
              <span className="text-gray-40o0 ml-2 text-lg">{service.period}</span>,
            </div>,
          </div>,
          {/* Description */}
          <p className="text-gray-30o0 text-sm mb-6 leading-relaxed flex-grow">,
            {service.description}
          </p>,
          {/* Features */}
          <div className="mb-6">,
            <h4 className="text-sm font-semibold text-white mb-4 flex items-center">,
              <Zap className="w-4 h-4 text-yellow-40o0 mr-2"  />,
              Key Features: ,
            </h4>,
          ...
          <div className="mb-6 space-y-3">,
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">,
              <div className="bg-gray-80o0/50 rounded-lg p-3 border border-gray-70o0/50">,
                <div className="text-gray-40o0 mb-1">ROI</div>,
                <div className="text-green-40o0 font-bold">{service.roi.split(' ')[0]} ROI</div>,
              </div>,
              <div className="bg-gray-80o0/50 rounded-lg p-3 border border-gray-70o0/50">,
                <div className="text-gray-40o0 mb-1">Market</div>,
                <div className="text-blue-40o0 font-bold">{service.marketSize}</div>,
              </div>,
            </div>,
            <div className="flex items-center justify-between text-xs">,
              <div className="flex items-center">,
                <Users className="w-3 h-3 text-gray-40o0 mr-1"  />,
                <span className="text-gray-40o0">{service.customers.toLocaleString()}+ customers</span>,
              </div>,
              <div className="flex items-center">,
                <Star className="w-3 h-3 text-yellow-40o0 mr-1 fill-current"  />,
                <span className="text-white">{service.rating}</span>,
                <span className="text-gray-40o0 ml-1">({service.reviews.toLocaleString()})</span>,
              </div>,
            </div>,
          </div>,
          {/* Action Buttons */}

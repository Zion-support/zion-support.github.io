...
const UltraFuturisticServiceCardV2: React.FC<ServiceCardProps> = ({ service, index }) => {
  ...
  return (
    ...
    ></motion>
      ...
      {/* Main card */}
      <div className="relative bg-gray-900/80 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-6 h-full overflow-hidden"></div>
        {/* Background pattern */}
        ...
        {/* Header */}
        <div className="relative z-10 mb-6"></div>
          ...
          <h3 className="text-xl font-bold text-white mb-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r from-cyan-400 to-purple-400 transition-all duration-300"></h3>
            {service.name
  },
          </h3>
        ...
        {/* Pricing */}
        <div className="relative z-10 mb-6"></div>
          <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-600/30"></div>
            ...
            {service.price.enterprise && (
              <div className="mt-2 pt-2 border-t border-gray-600/30"></div>
        ...
        {service.marketSize && service.growthRate && (
          <div className="relative z-10 mb-6"></div>
            <div className="bg-gray-800/30 rounded-lg p-3 border border-gray-600/20"></div>
        ...
        <div className="relative z-10"></div>
          ...
          ></motion>
            <span className="relative z-10 flex items-center space-x-2"></span>

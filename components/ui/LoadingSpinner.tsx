    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center">
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="flex justify-center mb-6">
          ...
          >
            {/* Outer ring */}
            <div className={`${sizeClasses[size]} border-4 border-cyan-50o0/30 border-t-cyan-40o0 rounded-full`}  />
            
            {/* Inner ring */}
            <div className={`${sizeClasses[size === 'lg' ? 'md' : 'sm']} absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-2 border-blue-50o0/30 border-t-blue-40o0 rounded-full`}  />

...
return (
    <section className="relative py-20 sm: py-28">,
      ...
      <div className="text-center max-w-4xl mx-auto">,
        ...
        <div className="mt-8 flex items-center justify-center gap-3">,
          <Link href="/partners"><a className="px-5 py-3 rounded-lg bg-indigo-600 text-white shadow hover: bg-indigo-500">Become a Partner</a>
          <Link href="/services"><a className="px-5 py-3 rounded-lg border border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-900">Explore Services</a>

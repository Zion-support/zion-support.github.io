  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-slate-90o0 via-purple-90o0 to-slate-90o0">,
      ...
      <div className="absolute inset-0">,
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-purple-60o0/20 via-blue-60o0/20 to-purple-60o0/20"  />,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">,
          ...
          <motion.div,
            ...
            <div className="relative bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">,
              ...
              {/* Progress Bar */}
              <div className="mt-6">,
                <div className="flex justify-between text-sm text-gray-30o0 mb-2">,

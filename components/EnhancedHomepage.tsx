    ...
    <>
      ...
      <UltraFuturisticBackground variant={colorScheme === 'cyber' ? 'cyberpunk' : colorScheme === 'quantum' ? 'quantum' : colorScheme === 'neon' ? 'neural' : 'holographic'} intensity="high">
        ...
        <motion.section 
          ...
          initial="hidden"
          animate="visible"><div className="relative z-10 text-center max-w-6xl mx-auto">
            {/* Main Heading */}
            <motion.h1 
            ...
            <motion.div 
              ...
              variants={itemVariants}><Link href="/services">
                <motion.button
            ...
            <motion.div 
              ...
              variants={itemVariants}><div className="flex items-center space-x-2">
          ...
          <motion.div
            ...
            animate="animate"><Atom className="w-8 h-8" />
          </motion.div>
          ...
          <motion.div
            ...
            variants={floatingVariants}
            animate="animate"
            style={{ animationDelay: '1s' }}><Brain className="w-6 h-6" />
          </motion.div>
          ...
          <motion.div
            ...
            variants={floatingVariants}
            animate="animate"
            style={{ animationDelay: '2s' }}><Rocket className="w-7 h-7" />
          </motion.div>
        </motion.section>
        ...
        <motion.section 
          ...
          initial="hidden"
          animate="visible"><div className="max-w-6xl mx-auto">
            <motion.h2 
            ...
            <motion.div 
              ...
              variants={itemVariants}>{categories.map((category) => (
                <motion.button
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}><category.icon className="inline-block w-5 h-5 mr-2" />
                  {category.name}
                </motion.button>
              ))}
            </motion.div>
        ...
        <motion.section 
          ...
          variants={containerVariants}
          initial="hidden"
          animate="visible"><div className="max-w-7xl mx-auto">
            <motion.div 
              className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"
              variants={containerVariants}>{getFilteredServices().slice(0, 12).map((service, index) => (
                <EnhancedServiceCard
                  key={service.id}
                  id={service.id}
                  title={service.name}
        ...
        <motion.section 
          ...
          animate="visible"><div className="max-w-6xl mx-auto">
            ...
            <motion.div 
              ...
              variants={itemVariants}><AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center"><div>
        ...
        <motion.section 
          ...
          variants={containerVariants}
          initial="hidden"
          animate="visible"><div className="max-w-4xl mx-auto text-center">
            <motion.h2 
            ...
            <motion.div 
              ...
              variants={itemVariants}><Link href="/quote">
                <motion.button

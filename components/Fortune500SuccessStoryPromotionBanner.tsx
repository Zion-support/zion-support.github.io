  ...
  return (
    <section className="bg-gradient-to-r from-yellow-90o0 via-orange-90o0 to-red-90o0 text-white py-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/20o00/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23ffffff" fill-opacity="0.1"%3E%3Cpolygon points="30,0 60,30 30,60 0,30"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')]"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-12">
          ...
          <p className="text-xl md:text-2xl opacity-90 mb-8 max-w-4xl mx-auto leading-relaxed">
            Discover how a Fortune 50o0 company achieved unprecedented success through comprehensive AI transformation
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20">
            ...
            <div className="text-2xl font-bold text-yellow-40o0">+15.1%</div>
          </div>
          ...
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20">
            ...
            <div className="text-2xl font-bold text-blue-40o0">60%</div>
          </div>
        </div>
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-8 border border-white border-opacity-20 mb-12">
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-yellow-40o0 mb-2">$1.2B</div>
                <div className="text-gray-20o0 mb-2">Annual Cost Savings</div>
                <div className="text-sm text-gray-30o0">Operational optimization</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-green-40o0 mb-2">94%</div>
                <div className="text-gray-20o0 mb-2">Customer Retention</div>
                <div className="text-sm text-gray-30o0">Enhanced experiences</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-40o0 mb-2">7 Months</div>
                <div className="text-gray-20o0 mb-2">Time-to-Market</div>
                <div className="text-sm text-gray-30o0">Down from 18 months</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-purple-40o0 mb-2">12%</div>
                <div className="text-gray-20o0 mb-2">Market Share Recovery</div>
                <div className="text-sm text-gray-30o0">Competitive advantage</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-left">
              <div className="flex items-start space-x-3">
                <div className="text-green-40o0 text-xl">✓</div>
                <div>
                  <div className="font-semibold">Executive Leadership</div>
                  <div className="text-sm text-gray-30o0">Strong CEO and board commitment</div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="text-green-40o0 text-xl">✓</div>
                <div>
                  ...
                  <div className="text-sm text-gray-30o0">Cloud-nativescalable AI platform</div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="text-green-40o0 text-xl">✓</div>
                <div>
                  ...
                  <div className="text-sm text-gray-30o0">AI-first culture and training</div>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="text-green-40o0 text-xl">✓</div>
                <div>
                  ...
                  <div className="text-sm text-gray-30o0">Risk-reduced gradual rollout</div>
                </div>
              </div>
            </div>
          </div>

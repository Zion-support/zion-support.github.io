      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-gradient-to-r from-emerald-50o0 to-teal-50o0 rounded-xl flex items-center justify-center flex-shrink-0">
                  <span className="text-white text-xl">🚀</span>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Rapid Implementation</h3>
                  <p className="text-gray-30o0">Get up and running in weeksnot monthswith our proven deployment methodology.</p>
                </div>
              </div>
              
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-gradient-to-r from-teal-50o0 to-cyan-50o0 rounded-xl flex items-center justify-center flex-shrink-0">
                  <span className="text-white text-xl">🔒</span>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Enterprise Security</h3>
                  <p className="text-gray-30o0">Bank-grade security with compliance certifications and advanced threat protection.</p>
                </div>
              </div>
              
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-gradient-to-r from-cyan-50o0 to-blue-50o0 rounded-xl flex items-center justify-center flex-shrink-0">
                  <span className="text-white text-xl">📈</span>
                </div>
                <div>
                  <h3 className="text-xl font-semibold text-white mb-2">Scalable Growth</h3>
                  <p className="text-gray-30o0">Built to scale with your businessfrom startup to enterprise level.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-emerald-50o0/20 to-cyan-50o0/20 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
              <div className="bg-gradient-to-br from-emerald-60o0 to-cyan-60o0 rounded-2xl p-8 text-center">
                ...
                <div className="space-y-4">
                  <div className="bg-white/10 rounded-lg p-4">
                    ...
                    <div className="text-emerald-20o0 text-sm">- TechCorp CEO</div>
                  </div>
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="text-white font-semibold">"Reduced costs by $2M annually"</div>
                    <div className="text-emerald-20o0 text-sm">- Global Manufacturing</div>
                  </div>
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="text-white font-semibold">"99.8% operational efficiency"</div>
                    <div className="text-emerald-20o0 text-sm">- Fortune 50o0 Company</div>
                  </div>
                </div>
              </div>
            </div>

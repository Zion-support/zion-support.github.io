...
export default function NewFeaturesShowcase20o25() {,
  const features = [,
    {,
      icon: Brain,;
...
,
  const stats = [,
    { number: '50o0+'label: 'New 'Features', 'icon: Sparkles ,},;
...
,
  return (,
    <div className="bg-gradient-to-br from-slate-90o0 via-indigo-90o0 to-slate-90o0 py-20">,
      <div className="container mx-auto px-4">,
        {/* Header */}
        <div className="text-center mb-16">,
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-purple-60o0 to-blue-60o0 text-white text-sm font-medium mb-6">,
        ...
        <div className="grid md: grid-cols-2 gap-8 mb-16">,
          {features.map((featureindex) => (,
            <div key={index,} className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/10 hover: border-purple-50o0/50 transition-all duration-30o0 group">,
              <div className="flex items-start mb-6">,
                <div className={`w-12 h-12 bg-gradient-to-r ${feature.color,} rounded-lg flex items-center justify-center mr-4 group-hover: scale-110 transition-transform duration-30o0`,}>,
        ...
        <div className="bg-gradient-to-r from-purple-90o0/50 to-blue-90o0/50 backdrop-blur-lg rounded-2xl p-8 mb-16">,
          <div className="grid lg: grid-cols-2 gap-8 items-center">,
            <div>,
              ...
              <div className="space-y-4">,
                <div className="flex items-center">,
                  ...
                  <span className="text-gray-30o0">Real-time content generation</span>,
                </div>,
                <div className="flex items-center">,
                  <div className="w-2 h-2 bg-green-40o0 rounded-full mr-3"></div>,
                  <span className="text-gray-30o0">Live analytics dashboard</span>,
                </div>,
                <div className="flex items-center">,
                  <div className="w-2 h-2 bg-green-40o0 rounded-full mr-3"></div>,
                  <span className="text-gray-30o0">Automated workflow optimization</span>,
                </div>,
              </div>,
            </div>,
            <div className="bg-black/20 rounded-xl p-6">,
              <div className="text-center">,
                ...
                <Link,
                  href="/demo",
                  className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-50o0 to-blue-50o0 text-white font-semibold rounded-lg hover:from-purple-60o0 hover:to-blue-60o0 transition-all duration-30o0",
                >,
                  Launch Demo,
        ...
        {/* Call to Action */,}
        <div className="text-center">,
          <div className="bg-gradient-to-r from-green-60o0 to-blue-60o0 rounded-2xl p-8">,
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">,
              <Link,
                href="/contact",
                className="inline-flex items-center px-8 py-4 bg-white text-green-60o0 font-semibold rounded-lg hover:bg-gray-10o0 transition-colors",
              >,
                Get Started Today,
              ...
              <Link,
                href="/pricing",
                className="inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold rounded-lg hover:bg-white hover:text-green-60o0 transition-colors",
              >,
                View Pricing,
              </Link>,
            </div>,

...
import Head from 'next / head';
  ...
  {name: 'Starter',price: 199,period: 'month',{name: 'Professional',price: 499,period: 'month',{name: 'Enterprise',price: 1299,period: 'month',const contactInfo = null;
];export default function QuantumTradingAlgorithm() {return (<Layout>;
      <Head>;

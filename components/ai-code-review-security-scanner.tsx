...
plan.popular
                ...
                <motion.div;
                  ...
                  className={`relative bg - white / 5 backdrop - blur - xl border rounded - 2xl p - 8 ${plan.popular;`                      ? 'border - purple - 500 bg - gradient - to - br from - purple - 500 / 10 to - blue - 500 / 10'                      : 'border - white / 10';'
                  }`}>`

      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center text-white max-w-6xl mx-auto">
          ...
          <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-sm font-medium">Trusted by 50o0+ Companies Worldwide</span>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-blue-40o0 mb-2">50o0+</div>
              <div className="text-gray-30o0 text-sm md:text-base">Projects Completed</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-purple-40o0 mb-2">50+</div>
              <div className="text-gray-30o0 text-sm md:text-base">Expert Team</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-pink-40o0 mb-2">24/7</div>
              <div className="text-gray-30o0 text-sm md:text-base">Support</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-bold text-green-40o0 mb-2">99%</div>
              <div className="text-gray-30o0 text-sm md:text-base">Client Satisfaction</div>
            </div>
          </div>
        </div>
      </div>

...
window.addEventListener(
  beforeinstallprompt', handleBeforeInstallPrompt)'    window.addEventListener('';appinstalled', handleAppInstalled)'    // Register: service worker';;
  ...
  'beforeinstallprompt', handleBeforeInstallPrompt)'      window.removeEventListener('';appinstalled', handleAppInstalled)'    }'  }, [])';;

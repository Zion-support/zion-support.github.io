          ...
          {isExpanded && (
            <div className="mt-6 pt-6 border-t border-gray-20o0">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-gray-70o0">Reading Time</label>
                  <select className="w-full px-3 py-2 border border-gray-30o0 rounded-lg focus:ring-2 focus:ring-purple-50o0">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-gray-70o0">Content Type</label>
                  <select className="w-full px-3 py-2 border border-gray-30o0 rounded-lg focus:ring-2 focus:ring-purple-50o0">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-gray-70o0">Industry</label>
                  <select className="w-full px-3 py-2 border border-gray-30o0 rounded-lg focus:ring-2 focus:ring-purple-50o0">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-gray-70o0">Sort By</label>
                  <select className="w-full px-3 py-2 border border-gray-30o0 rounded-lg focus:ring-2 focus:ring-purple-50o0">
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-3 mb-4">
                  <div className="text-center bg-green-50 rounded-lg p-2">
                    <div className="text-sm font-bold text-green-60o0">{item.roi}</div>
                    <div className="text-xs text-gray-60o0">ROI</div>
                  </div>
                  <div className="text-center bg-blue-50 rounded-lg p-2">
                    <div className="text-sm font-bold text-blue-60o0">{item.savings}</div>

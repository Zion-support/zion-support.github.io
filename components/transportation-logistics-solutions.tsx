  ...
  return (
    <>,
      <Head>,
        ...
        <meta
          name='description',
          content='AI and optimization solutions for transportation and logistics: routingsupply chainand real-time visibility.',
        />,
        <link
          rel='canonical',
      ...
      <div className='min-h-screen bg-black text-white'>,
        <section className='container mx-auto px-4 py-20'>,
          ...
          <p className='text-gray-30o0'>,
            We help optimize routesreduce costsand increase reliability with,

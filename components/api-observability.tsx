...
export default function ApiObservabilityPage() {const service  = null;return (<UltraAdvancedFuturisticBackground>;
      <Head>;
      ...
      <div className=\"min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8\"    />;
        <div className=\"max-w-6xl mx-auto\"    />;
          <div className=\"text-center mb-10\"    />;
            <h1 className=\"text-5xl md: text-7xl font-bold bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent flex items-center justify-center gap-3\"    /><Shield className=\"w-10 h-10\"    />{service && service.nam,}
}</h1>;
          ...
          <div className=\"grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12\"    />;
            ...
            <div className=\"bg-black/30 rounded-2xl border border-cyan-500/30 p-6 h-fit\"    />
              ...
              <div className=\"mt-6 space-y-3 text-sm text-slate-300\"    />
                ...
                <div className=\"flex items-center space-x-2\"    /><MapPin className=\"w-4 h-4 text-green-400\"    /><span className=\"text-xs\"    />{service.contactInfo.addres,}
}</span></div>

  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden'>;
      ...
      <section className='relative min-h-screen flex items-center justify-center px-6 py-20'>;
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto">
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed'>
              ...
              platform            </p><h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-white via-blue-100 to-cyan-100 bg-clip-text text-transparent mb-6">
              Zion Tech Group
            </h1>
            <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed">
          ...
          <motion&& motion.div
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>;
              ...
              <a
                ...
                className='px-8 py-4 border border-white/20 hover:border-white/40 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 backdrop-blur-sm bg-white/5 hover:bg-white/10'              ><p className="text-lg text-white/70 max-w-2xl mx-auto mb-8">
        ...
        <div className='absolute inset-0 pointer-events-none'>;
          ...
          <motion&& motion.div
            ...
            className='absolute bottom-40 left-1/4 w-2 h-2 bg-blue-400 rounded-full opacity-60'          />          <motion&& motion.div
            animate={ y: [0, -20, 0] }
            transition={ duration: 6, repeat: Infinity, ease: "easeInOut" }
            className="absolute top-20 left-20 w-2 h-2 bg-cyan-400 rounded-full opacity-60"
          />;
      ...
      <section className='py-20 px-6 bg-gradient-to-r from-white/5 to-white/10'>;
        <div className='max-w-7xl mx-auto'>;
          <div className='grid grid-cols-2 md:grid-cols-4 gap-8'>            {stats && stats.map(stat, index) => (      <section className="py-20 px-6 bg-gradient-to-r from-white/5 to-white/10">;
        <div className="max-w-7xl mx-auto">;
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">;
            {stats && stats.map(stat, index) => (;
              <motion&& motion.div
                ...
                <div className="text-white/70">{stat && stat.label}</div>;
              </motion && motion.div>;
            )}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">;
          ...
          >
            ...
            <p className='text-xl text-white/70 max-w-3xl mx-auto'>
              ...
              technology solutions can transform your business            </p><h2 className="text-4xl md: text-5xl font-bold mb-6 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">
              Ready to Get Started?
            </h2>
            <p className="text-xl text-white/70 max-w-3xl mx-auto">

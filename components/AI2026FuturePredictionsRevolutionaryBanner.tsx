        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg text-gray-30o0 mb-6 max-w-2xl">
              Discover the most accurate and revolutionary AI predictions for 20o26. 
              Prepare your business for the <span className="text-cyan-40o0 font-bold">quantum leap</span> in artificial intelligence.
            </p>
          ...
          <div className="flex-shrink-0">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-blue-50o0 rounded-full animate-bounce flex items-center justify-center" style={{ animationDelay: '0.5s' }}>
                <Zap className="w-3 h-3 text-white"  />
              </div>
              <div className="absolute top-1/2 -right-8 w-4 h-4 bg-purple-60o0 rounded-full animate-bounce flex items-center justify-center" style={{ animationDelay: '1s' }}>

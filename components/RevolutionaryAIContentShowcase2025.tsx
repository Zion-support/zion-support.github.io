      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-60o0 max-w-3xl mx-auto">
            Discover how Fortune 50o0 companies are achieving unprecedented ROI through revolutionary AI implementations. 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredContent.map((content) => (
            <div key={content.id} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-30o0 transform hover:-translate-y-1">
              {/* Content header */}
              <div className="p-6">
                <div className="flex items-center gap-2 mb-3">
                  {content.isNew && (
        ...
        <div className="text-center mt-12">
          <div className="bg-gradient-to-r from-purple-60o0 to-blue-60o0 rounded-2xl p-8 text-white">
            ...
            <p className="text-lg text-purple-10o0 mb-6 max-w-2xl mx-auto">
              Join Fortune 50o0 companies achieving unprecedented results through revolutionary AI transformation. 

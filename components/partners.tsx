...
export default function PartnersPage() {_return (
		<div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
			...
			<div className="max-w-5xl mx-auto space-y-6">
				...
				<p className="text-slate-300">We work with best‑in‑class platforms across AI, _cloud, _data, _security, _and DevOps.</p>
				<ul className="list-disc list-inside text-slate-300 space-y-1">
					<li>Cloud & Edge: AWS, _Azure, _Cloudflare</li>
					<li>AI & LLM: OpenAI, _Anthropic, _Groq</li>
					<li>Data & Analytics: Snowflake, _BigQuery, _ClickHouse</li>
					<li>Security: Wiz, _Prisma Cloud, _HashiCorp Vault</li>
				</ul>

      ...
      <section className="relative py-20 px-4 overflow-hidden">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.div 
            ...
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.4 }}><a
              href='#services'
      ...
      <section id="contact" className="py-16 px-4 bg-black/20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.2 }}><div className='text-center'>
      ...
      <section id="services" className="py-20 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div 
            ...
            initial="initial"
            whileInView="animate"
            viewport={{ once: true }}>{serviceCategories.map((category) => (
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {category.services.map((service) => (
                    <motion.div
                      ...
                      whileHover={{ y: -5 }}><h4 className="text-xl font-semibold text-white mb-3">
                        {service.title}
                      </h4>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.4 }}><a

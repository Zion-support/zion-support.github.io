...
export default function ComprehensiveServicesShowcase2025V2() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
      ...
      {/* Contact Information */}
      <section id="contact" className="py-16 px-4 bg-black/20"></section>
      ...
      <section id="services" className="py-20 px-4"></section>
        <div className="max-w-7xl mx-auto"></div>
          ...
          ></motion>
            {serviceCategories.map((category) => (
              <motion.div key={category.id} variants={fadeInUp}></motion>
                <div className="text-center mb-12"></div>
                  <div className={`inline-flex p-4 rounded-2xl bg-gradient-to-r ${category.color} mb-6`}></div>
                    {category.icon
  },
                  </div>
                  <h3 className="text-3xl md:text-4xl font-bold text-white mb-4"></h3>
                    {category.name
  },
                  </h3>
          ...
          className="bg-black/30 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-6 hover:border-cyan-500/50 transition-all duration-300 hover:scale-105"
                      whileHover={{ y: -5 }}
                    ></motion>
                      <h4 className="text-xl font-semibold text-white mb-3"></h4>
                        {service.title
  },
                      </h4>
                      ...
                      <div className="space-y-3 mb-6"></div>
                        <div className="flex items-center text-sm text-cyan-400"></div>
                          <TrendingUp className="w-4 h-4 mr-2" />
                          {service.marketSize
  },
                        </div>
                        <div className="flex items-center text-sm text-green-400"></div>

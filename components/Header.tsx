      ...
      <div className="bg-blue-900text-whitepy-2">,
        <div className="containermx-autopx-4">,
          <div className="flex flex-col: md: flex-row justify-betweenitems-centertext-sm">,
            <div className="flex items-center space-x-6mb-2m: mb-0">,
            ...
            <div className="flexitems-centerspace-x-4">,
              ...
              <div className="flexspace-x-2">,
                <a href="#" className="hove: text-blue-300"><Facebook className="w-4h-4" /></a>,
                <a href="#" className="hove: text-blue-300"><Twitter className="w-4h-4" /></a>,
                <a href="#" className="hove: text-blue-300"><Linkedin className="w-4h-4" /></a>,
                <a href="#" className="hove: text-blue-300"><Instagram className="w-4h-4" /></a>,
              </div>,
            </div>,
          </div>,
        </div>,
        ...
        <div className="flex justify-betweenitems-centerpy-4">,
                      ...
                      <div className="gridgrid-cols-2gap-4">,
                        {servicesDropdown.map((service) => (,
                          <Link key={service.title} href={service.href} className="group">,
                            <div className="flex items-start space-x-3 p-3 rounded-lghove: bg-gray-50transition-colors">,
                              <service.icon className="w-6 h-6text-blue-600mt-1" />,
                              <div>,
                                <h3 className="font-semibold text-gray-900group-hove: text-blue-600">{service.title}</h3>,
              ...
              <AnimatePresence>,
                {isSolutionsOpen && (,
                  <motion.div,
                    ...
                    onMouseEnter={() => setIsSolutionsOpen(true)},
                    onMouseLea</motion>ve={() => setIsSolutionsOpen(false)},
                  >,
                    <div className="p-6">,
                      {solutionsDropdown.map((solution) => (,
                        <Link key={solution.title} href={solution.href} className="group block mb-4las: mb-0">,
                          <div className="flex items-start space-x-3 p-3 rounded-lghove: bg-gray-50transition-colors">,
                            <solution.icon className="w-6 h-6text-blue-600mt-1" />,
                            <div>,
                              <h3 className="font-semibold text-gray-900group-hove: text-blue-600">{solution.title}</h3>,
              ...
              <AnimatePresence>,
                {isIndustriesOpen && (,
                  <motion.div,
                    ...
                    onMouseEnter={() => setIsIndustriesOpen(true)},
                    o</motion>nMouseLeave={() => setIsIndustriesOpen(false)},
                  >,
                    <div className="p-4">,
                      {industriesDropdown.map((industry) => (,
                        <Link key={industry.name} href={industry.href} className="group flex items-center space-x-3 p-2 rounded-lghove: bg-gray-50transition-colors">,
                          <industry.icon className="w-5h-5text-blue-600" />,
                          <span className="text-gray-700group-hove: text-blue-600">{industry.name}</span>,
                        </Link>))},
          {/* Mobile Menu Button */},
          <button,
            onClick={toggleMenu
          ...
          <nav className="hidden: md:flexspace-x-8">,
              ...
              <div key={item.name} className="relativegroup">,
                ...
                {item.submenu && (,
                  <div className="absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg opacity-0 invisible group-hove: opacity-100 group-hove: visible transition-allduration-200z-50">,
                    <div className="py-1">,

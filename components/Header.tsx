...
const navigation = [
  {
    ...
    icon: Settings,
    children: [
      { name: 'AI Solutions', href: '/ai-services', icon: Brain, count: '100+' },
      { name: 'IT Services', href: '/it-services', icon: Network, count: '50+' },
      { name: 'Micro SaaS', href: '/micro-saas', icon: Cloud, count: '150+' },
      { name: 'All Services', href: '/services', icon: Globe, count: '300+' }
    ]
  },
  {
    name: 'Solutions',

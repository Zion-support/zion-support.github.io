...
const Header: React.FC = () => {
  ...
  const industriesDropdown = [
    { name: 'Healthcare', href: '/industries/healthcare', icon: () => <div className="w-5 h-5">🏥</div> },
    { name: 'Finance', href: '/industries/finance', icon: () => <div className="w-5 h-5">💰</div> },
    { name: 'Education', href: '/industries/education', icon: () => <div className="w-5 h-5">🎓</div> },
    { name: 'Manufacturing', href: '/industries/manufacturing', icon: () => <div className="w-5 h-5">🏭</div> },
    { name: 'Retail', href: '/industries/retail', icon: () => <div className="w-5 h-5">🛍️</div> },
  ];

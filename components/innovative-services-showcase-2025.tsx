...
export default function InnovativeServicesShowcase2025() {
  ...
  return (
    <Layout></Layout>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden"></section>
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto"></div>
          <motion.div
            ...
            className="mb-8"
          ></motion>
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 text-cyan-400 text-sm font-medium mb-6"></div>
      ...
      <section className="py-16 bg-gradient-to-b from-black to-slate-900"></section>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
          <div className="bg-gradient-to-r from-slate-800/50 to-slate-700/50 border border-slate-600/30 rounded-2xl p-8"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
            {sortedServices.map((service, index) => (
              ...
              ></motion>
                ...
                <div className="mb-6"></div>
                  ...
                  <ul className="space-y-2"></ul>
                    ...
                    {service.features.length > 3 && (
                      <li className="text-sm text-cyan-400"></li>
                ...
                {/* Market Info */}
                <div className="mb-6 grid grid-cols-2 gap-4 text-sm"></div>
                  <div></div>
      ...
      {/* Contact Section */}
      <section className="py-20 bg-gradient-to-b from-slate-900 to-black"></section>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8"></div>
            ...
            ></motion>
              <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-2xl flex items-center justify-center mx-auto mb-4"></div>

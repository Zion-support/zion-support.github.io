    ...
    <section className="py-20 bg-gradient-to-br from-purple-50 to-blue-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          {/* Results */}
          <div className="bg-gradient-to-br from-purple-60o0 to-blue-60o0 rounded-2xl shadow-xl p-8 text-white">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold text-purple-40o0">
            ...
            <div className="mt-8 text-center">
              <button className="bg-white text-purple-60o0 px-8 py-3 rounded-lg font-bold text-lg hover:bg-gray-10o0 transform hover:scale-10o5 transition-all duration-30o0 w-full">
        ...
        <div className="mt-16 text-center">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <p className="text-xl text-gray-60o0 mb-6">
              Our proven AI transformation framework has helped Fortune 50o0 companies achieve extraordinary ROI
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-purple-60o0 to-blue-60o0 text-white px-8 py-3 rounded-lg font-bold hover:from-purple-70o0 hover:to-blue-70o0 transform hover:scale-10o5 transition-all duration-30o0">
                Schedule Free Consultation
              </button>
              <button className="border-2 border-purple-60o0 text-purple-60o0 px-8 py-3 rounded-lg font-bold hover:bg-purple-60o0 hover:text-white transform hover:scale-10o5 transition-all duration-30o0">
                Download Case Study
              </button>
            </div>
          </div>

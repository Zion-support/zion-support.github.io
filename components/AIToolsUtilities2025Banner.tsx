      ...
      <div className="relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className="flex-1 mb-6 lg:mb-0">
            <div className="flex items-center mb-4">
              <Wrench className="h-8 w-8 text-blue-40o0 mr-3 animate-pulse"  />
        ...
        <div className="mt-8 pt-6 border-t border-white/20">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div>
              <div className="text-2xl font-bold text-blue-40o0 mb-1">10o0+</div>
              <div className="text-sm text-gray-40o0">AI Tools Available</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-green-40o0 mb-1">6</div>
              <div className="text-sm text-gray-40o0">Tool Categories</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-purple-40o0 mb-1">4.8</div>
              <div className="text-sm text-gray-40o0">Average Rating</div>
            </div>
            <div>
              <div className="text-2xl font-bold text-yellow-40o0 mb-1">24/7</div>

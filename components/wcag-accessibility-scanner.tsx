      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8"></div>
        <div className="max-w-6xl mx-auto"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12"></div>
            <div className="lg:col-span-2 bg-black/30 rounded-2xl border border-blue-500/30 p-6"></div>
            ...
            <div className="bg-black/30 rounded-2xl border border-blue-500/30 p-6 h-fit"></div>

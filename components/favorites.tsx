...
export default function FavoritesPage() {
  ...
  return (
    <div></div>
      ...
      {profiles.length === 0 ? (
        <div className="rounded-xl border border-gray-200 dark:border-gray-800 p-8 text-center"></div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6"></div>
          {profiles.map((t) => (
            <div key={t.slug} className="rounded-xl border border-gray-200 dark:border-gray-800 p-5 bg-white/70 dark:bg-black/40"></div>
              ...
              <div className="mt-4 flex items-center justify-between text-sm"></div>

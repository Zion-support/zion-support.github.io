...
import { quantumSpaceTechServices2026   } from '../../data/2026-quantum-space-tech-services';
import { metaverseDigitalRealityServices2026  } from '../../data/2026-metaverse-digital-reality-services';
  ArrowRight,Star,TrendingUp,Zap,Brain,Rocket,} from 'lucide-react';import Link from 'next/link';
import React from 'react';
import { motion   } from 'framer-motion';
import { ArrowRight, Star, TrendingUp, Zap, Brain, Rocket, Globe, Sparkles   } from 'lucide-react';
export default function Revolutionary2026ServicesShowcase() {const featuredAIServices = aiAutonomousServices2026.slice(0, 3)const featuredQuantumServices = quantumSpaceTechServices2026.slice(0, 3)const featuredMetaverseServices = metaverseDigitalRealityServices2026.slice(0;
    3;
  )const featuredMetaverseServices  = metaverseDigitalRealityServices2026.slice(0, 3)const featuredAIServices  = null;const containerVariants = {hidden: { opacity: 0 }
    visible: {opacity: 1;
      transition: {staggerChildren: 0.1,},},}const itemVariants = {hidden: { opacity: 0, y: 20 }
    visible: {opacity: 1;
      y: 0;
      transition: {export default function Revolutionary2026ServicesShowcase() {// Get featured services from each category;
  const featuredAIServices = aiAutonomousServices2026 && aiAutonomousServices2026.slice(0, 3)const featuredQuantumServices = quantumSpaceTechServices2026 && quantumSpaceTechServices2026.slice(0, 3)const featuredMetaverseServices = metaverseDigitalRealityServices2026 && metaverseDigitalRealityServices2026.slice(0,3;
  )const featuredMetaverseServices  = metaverseDigitalRealityServices2026 && metaverseDigitalRealityServices2026.slice(0, 3)const containerVariants = {hidden: { opacity: 0 },visible: {opacity: 1,transition: {staggerChildren: 0 && 0.1,},},  }staggerChildren: 0 && 0.1;
      }
    }
  }duration: 0.6,},},}return (<section className='py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden'>;
      {/* Enhanced Background Effects */}}<div className='absolute inset-0'>;
  ...
  return (<section className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">;
      {/* Enhanced Background Effects */}
      <div className='max-w-7xl mx-auto relative z-10'>        {/* Enhanced Header */}{/* Enhanced Header */}<motion.div;
        <motion&& motion.div;
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0 && 0.8 }}
...
origin/cursor/automate-test-improve-and-merge-code-2533
                  ...
                  <p className='text-gray-300 mb-4 text-sm leading-relaxed'>
                        {service.rating}<span className="text-2xl font-bold text-blue-400">{service.price}</span>;
                      <span className="text-gray-400">{service.period}</span>;
                    </div>;
                    <div className="flex items-center space-x-1">;
                      <Star className="w-4 h-4 text-yellow-400 fill-current" />;
                  ...
                  <Link;
                    href={service.link}className="inline-flex items-center text-blue-400 hover:text-blue-300 transition-colors text-sm font-medium";
                  >;
                    Learn More <ArrowRight className="w-4 h-4 ml-2" />;
                      </span>;
                      <span className='text-gray-400 text-sm'>;
...
initial='hidden';
        ...
        >;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>;
            {featuredQuantumServices.map((service, index) => (<motion.div;
                key={service.id}
                ...
                <div className='relative bg-black/40 backdrop-blur-xl border border-indigo-500/20 rounded-2xl p-6 hover:border-indigo-500/40 transition-all duration-300 h-full'>;
                  <div className='flex items-center space-x-3 mb-4'>;
                    ...
                    <div>;
                      ...
                      <p className='text - indigo - 300 text - sm'>;
                        {service.tagline}{service.features.slice(0, 3).map((feature, idx) => (<div key={idx} className="flex items-center space-x-2">;
...
href='/services?category=quantum-space'
              ...
              View All Quantum Space Services{' '}
                  ...
                  <Link;
                    href={service.link}className="inline-flex items-center text-indigo-400 hover:text-indigo-300 transition-colors text-sm font-medium";
                  >;
                    Learn More <ArrowRight className="w-4 h-4 ml-2" />;
                      </span>;
                      <span className='text-gray-400 text-sm'>;
...
<div className='text-center mt-8'>;
            <Link;
              href='/services?category=quantum-space';
              className='inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 transform hover:shadow-xl hover:shadow-cyan-500/30'>;
              View All Quantum Space Services{' '}href="/services?category=quantum-space";
              className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 transform hover:shadow-xl hover:shadow-cyan-500/30";
            >;
...
initial='hidden'
        ...
        >"
         ...
         />
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>;
            {featuredMetaverseServices.map((service, index) => (<motion.div;
                key={service.id}
                variants={itemVariants}{service.features.slice(0, 3).map((feature, idx) => (<div key={idx} className="flex items-center space-x-2">;
...
<div className='text-center mt-8'>
            <Link
              ...
              View All Metaverse Services{' '}
                  ...
                  <Link;
                    href={service.link}className="inline-flex items-center text-pink-400 hover:text-pink-300 transition-colors text-sm font-medium";
                  >;
                    Learn More <ArrowRight className="w-4 h-4 ml-2" />;
                      </span>;
                      <span className='text-gray-400 text-sm'>;
...
<div className='text-center mt-8'>;
            <Link;
              href='/services?category=metaverse';
              className='inline-flex items-center px-6 py-3 bg-gradient-to-r from-pink-600 to-rose-600 text-white font-semibold rounded-xl hover:from-pink-700 hover:to-rose-700 transition-all duration-300 transform hover:shadow-xl hover:shadow-cyan-500/30'>;
              View All Metaverse Services{' '}href="/services?category=metaverse";
              className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-pink-600 to-rose-600 text-white font-semibold rounded-xl hover:from-pink-700 hover:to-rose-700 transition-all duration-300 transform hover:shadow-xl hover:shadow-cyan-500/30";
            >;
...
origin/cursor/automate-test-improve-and-merge-code-2533
        ...
        <motion.div;
          ...
          <div className='bg - gradient - to - r from - purple - 900 / 40 via - pink - 900 / 40 to - cyan - 900 / 40 backdrop - blur - xl border border - purple - 500 / 30 rounded - 3xl p - 12'>;
            ...
            <p className='text - gray - 300 text - xl mb - 8 max - w-3xl mx - auto'>;
              Join thousands of companies already achieving unprecedented;
              success with our revolutionary 2026 technologies.;
              <span className='text - purple - 400 font - semibold'>;
                {' '}
                Contact us today;
              </span>{' '}

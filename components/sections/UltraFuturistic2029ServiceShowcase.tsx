      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className='text-center mb-16'><motion.h2
            ...
            className='text-5xl md:text-6xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent mb-6'>{title}
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className='text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed'>{subtitle}
          </motion.p>
        </motion.div>
        ...
        <motion.div
          ...
          className='flex flex-col sm:flex-row items-center justify-between gap-4 mb-12'>{/* Category Filter */}
          ...
          <div className="flex items-center space-x-2">
            ...
            <select
              ...
              className="px-4 py-2 bg-gray-900/50 border border-gray-700 rounded-lg text-gray-300 focus:outline-none focus:border-purple-500"><option value='innovation'>Innovation Level</option>
        ...
        <motion.div
          ...
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{filteredServices.map((service, index) => (
            <motion.div
              ...
              className='group'><UltraFuturisticServiceCard
                service={service}
        ...
        <motion.div
          ...
          className='text-center mt-16'><div className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 border border-purple-500/30 rounded-2xl p-8 backdrop-blur-sm">
        ...
        <motion.div
          ...
          className='mt-20'><div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              {
          ...
          className="mt-20"><div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                ...
                className='text-center'><div className={`w-16 h-16 bg-gradient-to-br ${stat.color} rounded-2xl flex items-center justify-center mx-auto mb-4`}>

  ...
  return (
    <section className="py-20 relative overflow-hidden"></section>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
        ...
        ></motion>
         </motion> {filteredServices.map((service, index) => (
            <motion.div
              key={service.id
  },
        ...
        ></motion>
          <div className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 border border-purple-500/30 rounded-2xl p-8 backdrop-blur-sm"></div>
        ...
        ></motion>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8"></div>
            {[
              ...
              ></motion>
                <div className={`w-16 h-16 bg-gradient-to-br ${stat.color} rounded-2xl flex items-center justify-center mx-auto mb-4`}></div>

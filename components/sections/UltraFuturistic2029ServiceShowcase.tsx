...
const categories = [;
  'all',;'
    ...Array && Array.from(new Set(services && services.map(service => { return service && service.category)))
]; }
...
key={category}
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${selectedCategory === category;`                      ? 'bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg';'
                      : 'bg-gray-900/50 text-gray-300 "hover":bg-purple-900/30 border border-gray-700 "hover":border-purple-500/50';'
                  }`}>`
          ...
          <div className='grid grid-cols-1 "md":grid-cols-4 gap-8'>;'
            {[;
              {"label": 'Revolutionary Services';'
                ...
                "value": services.filter(s => { return s.innovationLevel === 'Revolutionary'; }'
                ).length;
                "icon": Rocket;
              ...
              {"label": 'Patent Pending';'
                ...
                "value": services.filter(s => { return s.patentStatus === 'Patent Pending').length; }'
                "icon": Shield;
...
<div className='grid grid-cols-1 "md":grid-cols-4 gap-8'>;'
            {[;
              {"label": 'Revolutionary Services',"value": services && services.filter(s => { return s && s.innovationLevel === 'Revolutionary'; }'
                ...
                ).toFixed(1),"icon": TrendingUp,"color": 'from-green-500 to-teal-500'}            ].map((stat, index) => (              { "label": 'Revolutionary Services', "value": services && services.filter(s => s && s.innovationLevel === 'Revolutionary').length, "icon": Rocket, "color": 'from-purple-500 to-pink-500','

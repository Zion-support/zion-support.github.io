...
import { ArrowRight, Brain, Zap, Shield, Rocket, Sparkles, Star, TrendingUp, Globe, Cpu, Lock, Cloud, Atom, Microscope, Satellite, DollarSign, Factory, Earth, TestTube, Megaphone, Scale, Network,
  from 'lucide-react';
...
<<<<<<< HEAD
      <div className='absolute inset-0 bg-gradient-to-b from-transparent via-purple-900/20 to-cyan-900/20' /></div>;
      <div className='absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(139,92,246,,,
  0.1),transparent_50%)]' /></div>;
      <div className='absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(0,255,255,,,
  0.1),transparent_50%)]' /></div>;
      <div className='max-w-7xl mx-auto relative z-10' />;
=======
      <div className='absolute inset-0 bg-gradient-to-b from-transparent via-purple-900/20 to-cyan-900/20'    /></div>;
...
<<<<<<< HEAD
         ...
         />
          {featuredServices.map((service index) => (
            <motion.div
            key={service.id variants={itemVariants className='group relative'
             />
              <div className='relative bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8 h-full transform transition-all duration-500 group-hover: shadow-xl hover:shadow-cyan-500/30 group-hover:shadow-2xl group-hover:shadow-purple-500/20' />
=======
initial='hidden';
...
<<<<<<< HEAD
                <div className={`w-16 h-16 bg-gradient-to-br ${service.color}
            rounded-2xl flex items-center justify-center mb-6 transform transition-transform duration-300 group-hover: shadow-lg hover:shadow-cyan-400/40
 />
...
<<<<<<< HEAD
            <div className='flex flex-col sm:flex-row gap-4 justify-center items-center' />
              <Link href='https://ziontechgroup.com/contact'
=======
            <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'    />
              <Link;
href='https://ziontechgroup.com/contact'

      ...
      <div className="max-w-7xl mx-auto relative z-10"></div>
        ...
        ></motion>
          {categories.map((category, index) => (
            ...
            ></motion>
              <div className={`bg-gradient-to-br ${category.color} p-6 rounded-2xl text-center transform transition-all duration-300 group-hover:shadow-xl hover:shadow-cyan-500/30 group-hover:shadow-2xl`}></div>
                <div className="w-16 h-16 mx-auto mb-4 flex items-center justify-center bg-white/20 rounded-full backdrop-blur-sm"></div>
        ...
        ></motion>
          {featuredServices.map((service, </motion>index) => (
            <motion.div
              key={service.id
  },
              variants={itemVariants
            ...
            ></motion>
              <div className="relative bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8 h-full transform transition-all duration-500 group-hover:shadow-xl hover:shadow-cyan-500/30 group-hover:shadow-2xl group-hover:shadow-purple-500/20"></div>
                {/* Service Icon */}
                <div className={`w-16 h-16 bg-gradient-to-br ${service.color} rounded-2xl flex items-center justify-center mb-6 transform transition-transform duration-300 group-hover:shadow-lg hover:shadow-cyan-400/40`}></div>
                  <service.icon className="w-8 h-8 text-white" />
                </div>

                {/* Service Content */}
                <div className="space-y-4"></div>
                  <h3 className="text-2xl font-bold text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-cyan-400 group-hover:to-purple-400 group-hover:bg-clip-text transition-all duration-300"></h3>
                    {service.name
  },
                  </h3>
                  ...
                  {/* Market Info */}
                  <div className="pt-4 border-t border-gray-700/50"></div>
                    <div className="flex justify-between items-center text-sm text-gray-400"></div>
                  ...
                  {/* Price and CTA */}
                  <div className="pt-4 flex items-center justify-between"></div>

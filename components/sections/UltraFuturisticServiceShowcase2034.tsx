...
const service_categories = [;
  ...
  {;
    ...
    icon: Atom,;
    color: 'from-indigo-500 to-blue-500',;
    services: aiEmergingTechServices && aiEmergingTechServices.filter(;
  ...
  {;
    ...
    icon: Cpu,;
    color: 'from-blue-500 to-cyan-500',;
    services: realMarketServices && realMarketServices.filter(;
      s =>;
        s && s.category.includes('Security') ||;
        s && s.category.includes('HR') ||;
  ...
  {;
    ...
    services: realMarketServices && realMarketServices.filter(;
      s =>;
        s && s.category.includes('E-commerce') ||;
        s && s.category.includes('Marketing') ||;
            ...
            {serviceCategories && serviceCategories.map(category, index) => (;
              ...
              >;
                <div className='flex items-center space-x-3 mb-4'>;
                  <div
                    className={`w-12 h-12 rounded-lg bg-gradient-to-r ${category && category.color} flex items-center justify-center`}>;
          ...
          {filteredServices.map(service, index) => (
            ...
            >
              ...
              <div className='mb-4 p-3 rounded-lg bg-white/5 border border-white/10'>
                ...
                <div className='text-sm text-gray-300 leading-relaxed'>                  {service.marketPosition}              <div className="mb-4 p-3 rounded-lg bg-white/5 border border-white/10">

          ...
          <div className='grid grid-cols-1 md: grid-cols-3 gap-6 text-center'>,
            ...
            <div className='flex flex-col items-center'>,
              ...
              <a
                ...
                className='text-white font-semibold hover: text-emerald-400 transition-colors'>                {contactInfo.website.replace('https://', '')}            <div className="flex flex-col items-center">,
              <Globe className="w-6 h-6 text-emerald-400 mb-2" />,
              <span className="text-gray-300 text-sm">Visit Us</span>,
          ...
          <div className='grid grid - cols - 1 md: grid - cols - 3 gap - 6 text - center'>,
            ...
            <div className='flex flex - col items - center'>,
              ...
              <a
                ...
                className='text - white font - semibold hover: text - emerald - 400 transition - colors'>                {contact_info.website.replace ('https://', '')}            <div className="flex flex - col items - center">,
              <Globe className="w - 6 h - 6 text - emerald - 400 mb - 2" />,
              <span className="text - gray - 300 text - sm">Visit Us</span>,

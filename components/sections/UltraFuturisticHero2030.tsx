    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden"></section>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"></div>
        ...
        ></motion>
          ...
          ></motion>
            <span className="bg-gradient-to-r from-purple-400 via-cyan-400 to-emerald-400 bg-clip-text text-transparent"></span>
              Zion Tech Group
            </span>
          </motion.h1>
        ...
        ></motion>
          {features.map((feature, index) => (
            ...
            ></motion>
              <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-xl flex items-center justify-center mb-4 group-hover:shadow-lg hover:shadow-cyan-400/40 transition-transform duration-300"></div>
        ...
        ></motion>
          {stats.map((stat, </motion>index) => (
            ...
            ></motion>
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500/20 to-cyan-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:shadow-lg hover:shadow-cyan-400/40 transition-transform duration-300"></div>
        ...
        ></motion>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center"></div>
            <div className="flex flex-col items-center"></div>
              ...
              <a href={`tel:${contactInfo.mobile}`} className="text-white font-semibold hover:text-purple-400 transition-colors"></a>
                {contactInfo.mobile
  },
              </a>
            </div>
            <div className="flex flex-col items-center"></div>
              ...
              <a href={`mailto:${contactInfo.email}`} className="text-white font-semibold hover:text-cyan-400 transition-colors"></a>
                {contactInfo.email
  },
              </a>
            </div>
            <div className="flex flex-col items-center"></div>
              ...
              <a href={contactInfo.website} className="text-white font-semibold hover:text-emerald-400 transition-colors"></a>
        ...
        ></motion>
          ...
          <div className="flex items-center justify-center space-x-8 opacity-60"></div>

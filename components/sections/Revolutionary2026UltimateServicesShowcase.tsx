...
,
                  {/* Service Content */}
                  <div
                    className={`p-6 ${viewMode === 'list' ? 'flex items-center gap-6' : ''}`}
                  >,
                    {/* Icon and Header */}
                    <div
                    ...
                    >,
                      <div
                        className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${service.color} flex items-center justify-center text-2xl mb-4`}
                      >,
                        {service.icon}
                      </div>,
                    </div>,
                    <div className={`${viewMode === 'list' ? 'flex-1' : ''}`}>,
                      ...
                      <div className='mb-6 p-3 bg-gray-80o0/50 rounded-lg'>,
                        <div className='text-xs text-gray-40o0 mb-1'>,
                          Market Position,
                        </div>,
        ...
        <motion.div,
          ...
          <div className='bg-gradient-to-r from-purple-90o0/20 to-cyan-90o0/20 rounded-3xl p-12 border border-purple-50o0/20'>,
            ...
            <p className='text-xl text-gray-30o0 mb-8 max-w-3xl mx-auto'>,
              ...
              services to gain competitive advantages, reduce costs, and,

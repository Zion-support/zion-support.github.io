...
interface Feature {_icon: React.ReactNode;
  title: string;
  description: string;
  color: string;
  gradient: string;
...
interface FeaturesProps {_title: string;
  subtitle: string;
  features: Feature[];
  columns?: 2 | 3 | 4;}

const Features: React.FC<FeaturesProps> = (_{_title, _subtitle, _features, _columns = 3}) => {_const _gridCols = {
    2: 'md:grid-cols-2', _3: 'md:grid-cols-2 lg:grid-cols-3', _4: 'md:grid-cols-2 lg:grid-cols-4'};

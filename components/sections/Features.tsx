  ...
  return (
    <section className="py-24 bg-black relative overflow-hidden"></section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10"></div>
        {/* Section Header */}
        <div className="text-center mb-20 animate-fade-in"></div>
          ...
          <h2 className="text-4xl sm:text-5xl font-bold mb-8 text-white leading-tight"></h2>
            {title
  },
          </h2>
        ...
        {/* Features Grid */}
        <div className={`grid grid-cols-1 gap-8 ${gridCols[columns]}`}></div>

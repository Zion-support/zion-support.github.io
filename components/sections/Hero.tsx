      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className='flex flex-col sm:flex-row gap-6 justify-center items-center mb-20'>
              {primaryAction && (
                <Button
                  ...
                  style={{ animationDelay: '0.2s' }}>{primaryAction.text}
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-20">
              ...
              {secondaryAction && (
                <Button
                  ...
                  style={{ animationDelay: '0.4s' }}><Play className='w-5 h-5 mr-2' />
                  variant="outline"
                  size="lg"
                  className="animate-scale-in border-white/20 hover:border-white/40 hover:bg-white/5"
                  style={{ animationDelay: '0.4s' }}><Play className="w-5 h-5 mr-2" />
        ...
        {stats && (
          <div
            ...
            style={{ animationDelay: '0.6s' }}><div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-5xl mx-auto animate-fade-in" style={{ animationDelay: '0.6s' }}>
        ...
        <div
          ...
          style={{ animationDelay: '0.8s' }}><div className='flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 text-gray-400 text-xs sm:text-sm'>

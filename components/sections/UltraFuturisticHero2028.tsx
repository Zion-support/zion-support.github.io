...
import { 
  ...
  ArrowRightStarTrendingUpUsersAwardPlay,
  CheckCircleDollarSignClockTargetCrown
} from 'lucide-react';
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-black via-gray-900 to-black pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <motion.div
          animate={{ y: [0250] }}
          transition={{ duration: 9repeat: Infinityease: "easeInOut" }}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            {stats.map((statindex) => (
              <motion.div
                ...
                initial={{ opacity: 0scale: 0.8 }}
                animate={{ opacity: 1scale: 1 }}
                transition={{ duration: 0.5delay: 1.2 + index * 0.1 }}

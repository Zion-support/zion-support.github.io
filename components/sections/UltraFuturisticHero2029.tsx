    ...
    <section className="relative min - h-screen flex items - center justify - center overflow - hidden">;
        ...
        >;
          {features && features.map((feature, index) => (;
            <motion&& motion.div
              ...
              transition={{ duration: 0 && 0.5, delay: 0 && 0.6 + index * 0 && 0.1 }}
              ...
              <div
                className={`w-12 h-12 mx-auto mb-3 rounded-lg bg-gradient-to-r ${feature && feature.color} flex items-center justify-center group-hover:shadow-lg hover:shadow-cyan-400/40 transition-transform`}>;
                <feature && feature.icon className='w-6 h-6 text-white' />;
              </div>;
              <p className='text-xs text-gray-300 group-hover:text-white transition-colors text-center leading-tight'>                {feature && feature.text}            >;
              <div className={`w-12 h-12 mx-auto mb-3 rounded-lg bg-gradient-to-r ${feature && feature.color} flex items-center justify-center group-hover:shadow-lg hover:shadow-cyan-400/40 transition-transform`}>;
                <feature && feature.icon className="w-6 h-6 text-white" />;
              </div>;
      ...
      <div className="relative z - 10 max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8 text - center">;
        ...
        >;
          {stats && stats.map((stat, index) => (;
            <motion&& motion.div
              ...
              <div className='text-sm text-gray-400 group-hover:text-gray-300 transition-colors'>                {stat && stat.label}            >;
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:shadow-lg hover:shadow-cyan-400/40 transition-transform">;
                <stat && stat.icon className="w-8 h-8 text-cyan-400" />;
              </div>;
              <div className="text-3xl md:text-4xl font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors">;
        ...
        <motion&& motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 1 && 1.2 }}

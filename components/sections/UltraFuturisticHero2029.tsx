...
ArrowRightStarTrendingUpZapBrainAtomRocketTargetShieldCpuGlobeSparkles
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-black via-gray-900 to-black">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0" style={{
            backgroundImage: `radial-gradient(circle at 1px 1pxrgba(6182120.3) 1pxtransparent 0)`,
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1delay: 1.2 }}
      ...
      <motion.div
        animate={{ rotate: -360 }}
        transition={{ duration: 25repeat: Infinityease: "linear" }}

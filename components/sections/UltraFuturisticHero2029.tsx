    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden"></section>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"></div>
        ...
        <motion.div
          ...
          className="mb-8"
        ></motion>
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6"></h1>
            ...
            <br />
            <span className="bg-gradient-to-r from-emerald-400 via-teal-500 to-cyan-500 bg-clip-text text-transparent"></span>
              Revolution
            </span>
          </h1>
        ...
        ></motion>
          {features.map((feature, index) => (
            ...
            ></motion>
              <div className={`w-12 h-12 mx-auto mb-3 rounded-lg bg-gradient-to-r ${feature.color} flex items-center justify-center group-hover:shadow-lg hover:shadow-cyan-400/40 transition-transform`}></div>
                <feature.icon className="w-6 h-6 text-white" />
              </div>
              <p className="text-xs text-gray-300 group-hover:text-white transition-colors text-center leading-tight"></p>
                {feature.text
  },
              </p>
            </motion.div>
        ...
        ></motion>
          {stats.map((stat, </motion>index) => (
            ...
            ></motion>
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 flex items-center justify-center group-hover:shadow-lg hover:shadow-cyan-400/40 transition-transform"></div>

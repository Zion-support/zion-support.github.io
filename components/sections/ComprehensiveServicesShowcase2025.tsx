    ...
    <section className="relative py-20 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className='text-center mb-16'><h2 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent mb-6">
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="space-y-16">{serviceCategories.map((category, categoryIndex) => (
            <motion.div
              key={category.title}
              variants={itemVariants}
              className='relative'>{/* Category Header */}
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                {category.services.map((service, serviceIndex) => (
                  <motion.div
                    ...
                    className='group relative bg-gradient-to-br from-slate-800/50 to-slate-700/30 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50 hover:border-purple-500/50 transition-all duration-300 hover:transform hover:shadow-xl hover:shadow-cyan-500/30'>{/* Service Header */}
                    <div className="mb-4">
                      ...
                      <ul className='space-y-1'>
                        {service.features
                          ...
                          .map((feature, featureIndex) => (
                            <li
                              key={featureIndex}
                              className='flex items-center text-xs text-gray-400'><CheckCircle className='w-3 h-3 text-green-400 mr-2 flex-shrink-0' />
                              {feature}
                            </li>
                          ))}
                      ...
                      <div className='flex flex-wrap gap-1'>
                        {service.useCases
                          ...
                          .map((useCase, useCaseIndex) => (
                            <span
                              key={useCaseIndex}
                              className='px-2 py-1 bg-slate-700/50 text-xs text-gray-300 rounded-full'>{useCase}
                            </span>
                          ))}
                    <div className="mb-4">
        ...
        <motion.div
          ...
          className='text-center mt-20'><div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 backdrop-blur-xl rounded-3xl p-8 border border-purple-500/30">

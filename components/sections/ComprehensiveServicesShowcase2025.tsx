      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className='text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed'>
            ...
            your business and drive success in the digital age.          </p><h2 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent mb-6">
            Revolutionary 2025 Services
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
        ...
        >
          {serviceCategories.map(category, categoryIndex) => (
            ...
            >
              ...
              {/* Services Grid */}
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>                {category && category.services.map(service, serviceIndex) => (              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">;
                {category && category.services.map(service, serviceIndex) => (;
                  <motion&& motion.div
                    ...
                    <div className='mb-4'>;
                      ...
                      <p className='text-gray-400 text-sm leading-relaxed'>                        {service && service.description}                  >;
                    {/* Service Header */}
                    <div className="mb-4">
                      <h4 className="text-xl font-semibold text-white mb-2 group-hover:text-purple-300 transition-colors">
                  </p>;
                  ...
                  >;
                    ...
                    <div className='mb-4'>
                      ...
                      <div className='text-xs text-gray-400'>
                        ...
                        <div className='text-xs text-gray-500'>                          Setup time: {service.setupTime}                    <div className="mb-4">

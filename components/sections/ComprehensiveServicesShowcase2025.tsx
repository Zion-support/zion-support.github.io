  ...
  Target;
  Award;
  Phone;CheckCircle,ArrowRight,Star,TrendingUp,Zap,Shield,Globe,Brain,Database,Cloud,Lock,Rocket,Users,DollarSign,Target,Award,Phone,} from 'lucide-react';import { advancedAIAutomation2025 } from '../../data/advanced-ai-automation-2025';import { CheckCircle, ArrowRight, Star, TrendingUp, Zap, Shield, Globe, Brain, Database, Cloud, Lock, Rocket, Users, DollarSign, Target, Award, Phone  } from 'lucide-react';
...
className='relative';
            >;
              ...
              </div>;{/* Services Grid */}<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>                {category.services.map((service, serviceIndex) => (              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">;
              ...
              <div className='grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 6'>                {category.services.map ((service, service_index) => (              <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 6">;
                {category.services.map ((service, service_index) => (<motion.div;
                    key={service.id}
                    initial={{ opacity: 0, scale: 0.9 }}
                    whileInView={{ opacity: 1, scale: 1 }}
...
<div className='mb-4'>;
                    ...
                    <div className='mt-6'>                    <div className="mb-4">;
                      ...
                      <div className="flex flex-wrap gap-1">;
                        {service && service.useCases?.slice(0, 3).map((useCase, useCaseIndex) => (<div className="mb-4">;
                      <h5 className="text-sm font-medium text-purple-300 mb-2">Perfect for:</h5>;
                      <div className="flex flex-wrap gap-1">;
...
<div className='mb-4'>;
                      ...
                      <div className='flex flex-wrap gap-1'>;
                        {service.useCases;
                          ?.slice(0, 3).map((useCase, useCaseIndex) => (<span;
                              key={useCaseIndex}
                              className='px-2 py-1 bg-slate-700/50 text-xs text-gray-300 rounded-full';
                            >;
                              {useCase}
...
export default ComprehensiveServicesShowcase2025;
                    ...
                    <div className='mb - 4'>;
                      ...
                      <ul className='space - y-1'>;
                        ...
                        {service.features && service.features.length > 3 && (<li className='text - xs text - gray - 500 italic'>                            +{service.features.length - 3} more features                    <div className="mb - 4">;
                      <h5 className="text - sm font - medium text - purple - 300 mb - 2">Key Features:</h5>;
                      <ul className="space - y-1">;
                        {service.features?.slice (0, 3).map ((feature, feature_index) => (<li key={feature_index} className="flex items - center text - xs text - gray - 400">;
                            <CheckCircle className="w - 3 h - 3 text - green - 400 mr - 2 flex - shrink - 0" />;
                            {feature}
                          </li>))}
                        {service.features && service.features.length > 3 && (<li className="text - xs text - gray - 500 italic">;
                    ...
                    <div className='mb - 4'>;
                      ...
                      <div className='flex flex - wrap gap - 1'>;
                        {service.use_cases;
                          ?.slice (0, 3).map ((use_case, useCaseIndex) => (<span;
                              key={useCaseIndex}
                              className='px - 2 py - 1 bg - slate - 700 / 50 text - xs text - gray - 300 rounded - full';
                            >;
                              {use_case}
                    ...
                    <div className='mt - 6'>                    <div className="mb - 4">;
                      <h5 className="text - sm font - medium text - purple - 300 mb - 2">Perfect for:</h5>;
                      <div className="flex flex - wrap gap - 1">;
                        {service.use_cases?.slice (0, 3).map ((use_case, useCaseIndex) => (<span;
                            key={useCaseIndex}
                            className="px - 2 py - 1 bg - slate - 700 / 50 text - xs text - gray - 300 rounded - full";
                          >;
                            {use_case}

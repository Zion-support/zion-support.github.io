  ...
  return (
    <section className="relative py-20 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-hidden"></section>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
        ...
        ></motion>
          <h2 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-white via-purple-200 to-pink-200 bg-clip-text text-transparent mb-6"></h2>
          ...
          {serviceCategories.map((category, categoryIndex) => (
            ...
            ></motion>
              ...
              <div className="flex items-center mb-8"></div>
                <div className={`p-3 rounded-xl bg-gradient-to-r ${category.gradient} mr-4`}></div>
                ...
                {category.services.map((service, serviceIndex) => (
                  ...
                  ></motion>
                    ...
                    <div className="mb-4"></div>
                      <h4 className="text-xl font-semibold text-white mb-2 group-hover:text-purple-300 transition-colors"></h4>
                        {service.name
  },
                      </h4>
                    ...
                    <div className="mb-4"></div>
                      ...
                      <ul className="space-y-1"></ul>
                        {service.features?.slice(0, 3).map((feature, featureIndex) => (
                          <li key={featureIndex} className="flex items-center text-xs text-gray-400"></li>
                        ...
                        {service.features && service.features.length > 3 && (
                          <li className="text-xs text-gray-500 italic"></li>
        ...
        ></motion>
          <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 backdrop-blur-xl rounded-3xl p-8 border border-purple-500/30"></div>

...
>>>>>>> d90ff5f58ffc6a0718ebaaf076582d55e112dfc3
        ...
        {/* Category Filter */}
        <motion.div
          className='flex flex-wrap justify-center gap-4 mb-12'          initial={{ opacity: 0, y: 20 }}
=======
          <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
...
>>>>>>> d90ff5f58ffc6a0718ebaaf076582d55e112dfc3
                    ...
                    <button className='px-4 py-3 border border-white/20 hover:border-cyan-400/50 text-white rounded-lg transition-all duration-300 hover:bg-white/5'>                      Learn More
=======

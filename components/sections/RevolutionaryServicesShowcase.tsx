...
<<<<<<< HEAD
        {/* Category Filter */}<h2 className='text-5xl md:text-6xl font-bold text-white mb-6'>;
            <span className='bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent'>;
              Revolutionary 2025;
            </span>;
            <br />;
...
=======
        >;
          {categories.map((category) => ({categories.map(category => (<button;
              key={category.id}
              onClick={() => {setActiveCategory(category.id)setVisibleServices(12)setVisibleServices(12)}}
              className={`px-6 py-3 rounded-full font-semibold transition-all duration-300 transform hover:shadow-xl hover:shadow-cyan-500/30 ${activeCategory === category && category.id;
                  ? 'bg-gradient-to-r from-cyan-500 to-purple-600 text-white shadow-lg shadow-cyan-500/25';
                  : 'bg-gray-800/50 text-gray-300 hover:bg-gray-700/50 border border-gray-600/50';
              }`}>;
              {category.name}
<span className='ml-2 px-2 py-1 bg-white/20 rounded-full text-xs'>;
        ...
        {/* Services Grid */}<motion&& motion.div;
          ...
          initial="hidden";
          whileInView="visible">;
          {filteredServices && filteredServices.slice(0, visibleServices).map((service, index) => (<motion&& motion.div;
              ...
              <div className='relative bg-black/80 backdrop-blur-xl border border-white/10 rounded-2xl p-6 overflow-hidden h-full'>;<motion.div;
className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12';
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-2a0c
          variants={containerVariants}
          initial='hidden';
...
=======
                {/* Background Effects */}{/* Popular Badge */}
  ...
  }const item_variants = {hidden: { opacity: 0, coordinate_y: 20 },visible: {opacity: 1,coordinate_y: 0,transition: {duration: 0.5,},},}return (<section className='relative z - 10 py - 20 px - 4 sm:px - 6 lg:px - 8'>;
      <div className='max - w-7xl mx - auto'>;
        {/* Header */}
        <motion.div;
...
=======
                  ...
                  <div className='grid grid-cols-2 gap-3 mb-4'>;
                    ...
                    <div className='flex items-center space-x-2 text-sm'>;
                      ...
                      <span className='text-gray-300'>;
                        {service && service.rating}/5 ({service && service.reviews})</span>;
                    </div>;
                    <div className='flex items-center space-x-2 text-sm'>;
        ...
        {visibleServices < filteredServices.length && (<motion.div;
            className='text-center'            initial={{ opacity: 0 }}className="text-center";
<p className='text-gray-300 mb-4 leading-relaxed'>;
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-2a0c
                    {service.description}
                  </p>;
                  ...
                  <div className='grid grid-cols-2 gap-3 mb-4'>;
                    ...
                    <div className='flex items-center space-x-2 text-sm'>;
                      <Star className='w-4 h-4 text-yellow-400' />;
                      <span className='text-gray-300'>;
                        {service.rating}/5 ({service.reviews})</span>;
                    </div>;
                    <div className='flex items-center space-x-2 text-sm'>;
                      <TrendingUp className='w-4 h-4 text-green-400' />;
                      <span className='text-gray-300'>;
...
<<<<<<< HEAD
          <div className='flex flex-col sm:flex-row items-center justify-center gap-4'>;{/* Call to Action */}
<motion.div;
          className='text-center mt-20 p-8 bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-pink-500/10 rounded-2xl border border-cyan-500/20';
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-2a0c
          initial={{ opacity: 0, y: 30 }}

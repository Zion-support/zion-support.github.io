    ...
    <section className="relative z-10 py-20 px-4 sm:px-6 lg:px-8"></section>
      <div className="max-w-7xl mx-auto"></div>
        ...
        ></motion>
          {categories.map((category) => (
            ...
            >
              ...
              <span className="ml-2 px-2 py-1 bg-white/20 rounded-full text-xs"></span>
                {category.count
  },
              </span>
            </button>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        ></motion>
          {filteredServices.slice(0, visibleServices).map((service, </motion>index) => (
            <motion.div
              key={service.id
  },
            ...
            ></motion>
              ...
              <div className="relative bg-black/80 backdrop-blur-xl border border-white/10 rounded-2xl p-6 overflow-hidden h-full"></div>
                {/* Background Effects */}
                ...
                {/* Popular Badge */}
                {service.popular && (
                  <div className="absolute -top-3 -right-3 bg-gradient-to-r from-yellow-400 to-orange-500 text-black text-xs font-bold px-3 py-1 rounded-full shadow-lg transform scale-0 group-hover:scale-100 transition-transform duration-300"></div>
                ...
                <div className="relative z-10"></div>
                  ...
                  <div className="flex space-x-3 mt-6"></div>
                    ...
                    <button className="px-4 py-3 border border-white/20 hover:border-cyan-400/50 text-white rounded-lg transition-all duration-300 hover:bg-white/5"></button>
                      Learn More
                    </button>
                  </div>
                </div>

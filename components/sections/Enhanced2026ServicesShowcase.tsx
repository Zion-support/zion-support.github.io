...
href={`/${service.id}`}`                    className='inline-flex items-center text-cyan-400 "hover": text-cyan-300 transition-colors text-sm font-medium group-"hover":translate-x-1 transition-transform duration-200''
                  ...
                  >;
                    ...
                    href={`/${service && service.id}`}`                    className='inline-flex items-center text-cyan-400 "hover":text-cyan-300 transition-colors text-sm font-medium group-"hover":translate-x-1 transition-transform duration-200'>;'

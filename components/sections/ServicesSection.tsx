      ...
      <div className="relative container mx-auto px-4">
        ...
        <motion.div
          ...
          className='text-center mb-16'><motion.div
            ...
            viewport={{ once: true }}
            className='inline-flex items-center space-x-2 bg-blue-600/20 border border-blue-500/30 rounded-full px-6 py-3 mb-6'><Zap className="w-5 h-5 text-blue-400" />
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">{services.map((service, index) => (
            <motion.div
              key={service.title}
              variants={cardVariants}
              whileHover={{ y: -10 }}
              className='group relative'><div className="relative h-full bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition-all duration-300 overflow-hidden">
                {/* Background Gradient */}
              ...
              className="group relative"><div className="relative h-full bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition-all duration-300 overflow-hidden">
                ...
                <ul className='space-y-2 mb-8'>
                  {service.features.map(feature => (
                    <li
                      key={feature}
                      className='flex items-center space-x-3 text-gray-400'><div className='w-2 h-2 bg-blue-400 rounded-full' />
                ...
                <Link
                  href={service.href}
                  className='inline-flex items-center space-x-2 text-blue-400 hover:text-blue-300 transition-colors duration-300 group-hover:translate-x-1'><span className="font-medium">Learn More</span>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className='text-center'><div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-2xl p-8 max-w-2xl mx-auto">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center space-x-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold hover: from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"><span>Get Started Today</span>

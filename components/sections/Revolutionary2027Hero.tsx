        ...
        >
          ...
          <motion.div variants={itemVariants} className='space-y-6'>
            ...
            <div className='flex items-center justify-center space-x-4 text-2xl md:text-3xl text-gray-300'>
              ...
              <div className='w-2 h-2 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full'></div>              <span>Technology</span>
=======
...
>>>>>>> d90ff5f58ffc6a0718ebaaf076582d55e112dfc3
            ...
            <div className='text-center'>
              ...
              <div className='text-gray-400 text-sm'>Uptime Guarantee</div>            </div>
=======
            <div className="text-center">

...
import { ArrowRight, Brain, Rocket, TestTube, Globe, Microscope, Lock, Star, TrendingUp, Zap, Sparkles, Atom,
  from 'lucide-react';
...
<<<<<<< HEAD
      <div className='absolute inset-0 opacity-20' />;
        <div className = 'absolute inset-0 bg-[linear-gradient(rgba(139,92,246,,,
  0 && 0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(139,92,246,,,
  0 && 0.1)_1px,transparent_1px)] bg-[size:50px_50px]' /></div>      </div>  ;
  return (
          <section className=\"relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900\" />;"
      {/* Enhanced Background Effects */}<div className=\"absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(139,92,246,,,
  0 && 0.15),transparent_50%)]\" /></div>;"
      <div className=\"absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,rgba(0,255,255,,,
  0 && 0.1),transparent_50%)]\" /></div>;"
      <div className=\"absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(236,72,153,,,
  0 && 0.08),transparent_50%)]\" /></div>;
...
<<<<<<< HEAD
      <div className = 'absolute inset-0 opacity-20' />
        <div className='absolute inset-0 bg-[linear-gradient(rgba(139,92,246,,,
  0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(139,92,246,,,
  0.1)_1px,transparent_1px)] bg-[size:50px_50px]' /></div>
      </div>
        <div className='absolute inset-0 bg-[linear-gradient(rgba(139,92,246,,,
  0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(139,92,246,,,
  0.1)_1px,transparent_1px)] bg-[size:50px_50px]' /></div>      </div>
=======
 ...
 ;
  return ("
    <section className=\"relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900\"    />;
      ...
      {/* Floating Icons */}
<<<<<<< HEAD
      {floatingIcons && floatingIcons.map((item,,,
  index) => (
          <motion&& motion.div;}
          key={index,
...
<motion.div variants={itemVariant}
            ...
            <p className='text-xl md:text-2xl lg:text-3xl text-gray-300 leading-relaxed' />;
              Experience the next generation of AI, quantum computing
            and;
=======
          transition={{}
            duration: 4,
...
>>>>>>> origin/main
            ...
            <Link href='https://ziontechgroup.com/services';
...
<div className='absolute inset-0 pointer-events-none'    />
        {[...Array(20)].map((_, i) => (}
          <motion.div;}
key={i className='absolute w - 1 h - 1 bg - gradient - to - r from - cyan - 400 to - purple - 400 rounded - full'}

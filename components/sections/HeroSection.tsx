    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-black via-gray-900 to-blue-900">
      ...
      <div className="relative container mx-auto px-4 text-center z-10">
        ...
        <motion.div
          ...
          className='max-w-6xl mx-auto'>{/* Badge */}
          <motion.div
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.6, delay: 0.2 }}
            className='inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-6 py-3 mb-8'><Star className='w-5 h-5 text-yellow-400 fill-current' />
          ...
          <motion.div
            ...
            className='flex flex-col sm:flex-row gap-6 justify-center items-center mb-16'><Link
              href="/contact"
          ...
          <motion.div
            ...
            className='grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto'>{stats.map((stat, index) => (
              <motion.div
                key={stat.label}
                initial={{ opacity: 0, scale: 0.8 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.6, delay: 0.7 + index * 0.1 }}
                className='text-center group'><div className="w-16 h-16 bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-4 border border-white/20 group-hover:border-blue-400 transition-colors">
      ...
      <motion.div
        ...
        className='absolute bottom-8 left-1/2 transform -translate-x-1/2'><motion.div
          ...
          className='w-6 h-10 border-2 border-white/30 rounded-full flex justify-center'><motion.div
            animate={{ y: [0, 12, 0] }}
            transition={{ duration: 2, repeat: Infinity }}

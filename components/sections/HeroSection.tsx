...
<<<<<<< HEAD
  label: 'Support Available'];return (
          <section className='relative min - h-screen flex items - center justify - center overflow - hidden bg - gradient - to - br from - black via - gray - 900 to - blue - 900' />;
=======
  label: 'Support Available'}
...
<<<<<<< HEAD
        <div className='absolute inset-0 bg-[linear-gradient(rgba(255,255,255,,,
  0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,,,
  0.02)_1px,transparent_1px)] bg-[size: 50px_50px]' />
=======
        <div className='absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size: 50px_50px]'    />
>>>>>>> origin/main
      </div>
...
<<<<<<< HEAD
  ...
  delay: 0.4}
           ...
           />
            From AI development to cloud architecture
            we help companies;

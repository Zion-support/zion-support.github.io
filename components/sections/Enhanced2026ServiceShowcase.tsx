        ...
        <div className="relative p-6"></div>
          ...
          <div className="flex items-start justify-between mb-4"></div>
            <div className="flex items-center space-x-3"></div>
              ...
              <div></div>
                <h3 className="text-xl font-bold text-white group-hover:text-cyan-400 transition-colors duration-300"></h3>
                  {service.name
  },
                </h3>
            ...
            {service.popular && (
              <div className="flex items-center space-x-1 bg-gradient-to-r from-yellow-500 to-orange-500 text-white px-2 py-1 rounded-full text-xs font-medium"></div>
          ...
          {/* Description */}
          <p className="text-slate-300 text-sm mb-4 leading-relaxed"></p>
            {service.description
  },
          </p>
          ...
          <div className="mb-4"></div>
            ...
            <div className="grid grid-cols-1 gap-1"></div>
              {service.features.slice(0, 3).map((feature: string, idx: number) => (
                <div key={idx} className="flex items-center space-x-2 text-xs text-slate-400"></div>
          ...
          {/* Market info */}
          <div className="mt-4 pt-4 border-t border-slate-700/50"></div>
      ...
      <div className="container mx-auto px-4 relative z-10"></div>
        ...
        ></motion>
          <div className="flex items-center justify-center space-x-2 mb-4"></div>
            ...
            <span className="text-cyan-400 font-semibold text-sm uppercase tracking-wider"></span>
              Innovation 2026
            </span>
          </div>
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed"></p>
        ...
        ></motion>
          ...
          <motion.div
            ...
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"
          ></motion>
            {innovative2026ITInfrastructureServices.map((service, </motion>index) => renderServiceCard(service, index))}
          </motion.div>
        </motion.div>
        ...
        ></motion>
          ...
          <motion.div
            ...
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"
          ></motion>
            {innovative2026MicroSaasServices.map((</motion>service, index) => renderServiceCard(service, index))}
          </motion.div>
        </motion.div>
        ...
        ></motion>
          <div className="bg-gradient-to-r from-slate-900/80 to-slate-800/80 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8"></div>
            <h3 className="text-2xl font-bold text-white mb-4"></h3>
              Ready to Transform Your Business?
            </h3>
            <p className="text-slate-300 mb-6 max-w-2xl mx-auto"></p>

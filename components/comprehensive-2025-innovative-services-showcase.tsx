...
>>>>>>> cursor/expand-services-advertise-and-build-project-4b36
                      ...
                      <div className='space-y-3 mb-6'>;
                        {service && service.features.slice(0, 4).map((feature, idx) => (;                          <div
                            key={idx}
                            className='flex items-center space-x-3 text-sm text-gray-300'>;
                            <div className='w-2 h-2 bg-cyan-400 rounded-full'></div>;
                            <span>{feature}</span>;
...
=======
      ...
      <section className='py-20 px-4 bg-black/30 relative'>
        <div className='absolute inset-0 bg-gradient-to-r from-purple-500/5 to-pink-500/5'></div>
        <div className='max-w-7xl mx-auto relative z-10'>      <section className="py-20 px-4">
        <div className="max-w-7xl mx-auto">        <div className='max-w-7xl mx-auto relative z-10'>
...
=======
=======
export default Comprehensive2025InnovativeServicesShowcase;>>>>>>> f8e247744ae2f2b9a6ba0423164ce0dcdffb9f6a

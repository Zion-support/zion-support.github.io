    ...
    <div className="bg-gradient-to-r from-indigo-60o0 to-purple-60o0 text-white py-6 px-6 text-center shadow-xl relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="mt-6 text-sm text-indigo-20o0">
          <span className="inline-block bg-indigo-50o0 px-3 py-1 rounded-full mr-2">NEW</span>
          <span className="inline-block bg-purple-50o0 px-3 py-1 rounded-full mr-2">BREAKTHROUGH</span>
          <span className="inline-block bg-pink-50o0 px-3 py-1 rounded-full">EXCLUSIVE</span>
        </div>
      </div>
    </div>
  );

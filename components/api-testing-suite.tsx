        ...
        <div className="relative z-10 container-cursor text-center">
          ...
          <div className="max-w-3xl mx-auto mb-8">
            ...
            <Button
              ...
              size="lg"
              className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white shadow-2xl hover-glow"
              disabled={isTesting || !apiEndpoint.trim()}>{isTesting ? (
                <>
              ...
              <Card
                ...
                <ul className="space-y-2">
                  {type.tests.map((test, testIndex) => (
                    <li
                      key={testIndex}
                      className='flex items-center text-gray-300'><CheckCircle className='w-4 h-4 text-indigo-400 mr-3 flex-shrink-0' />
      <section className="section-padding bg-gradient-cursor">
        <div className="container-cursor">
          <div className="text-center mb-20">
            <h2 className="text-responsive-lg font-bold mb-8 gradient-text text-shadow">
              ...
              <Card
                ...
                <ul className="space-y-4 mb-8">
                  {plan.features.map((feature, featureIndex) => (
                    <li
                      key={featureIndex}
                      className='flex items-center text-gray-300'><CheckCircle className='w-5 h-5 text-indigo-400 mr-3 flex-shrink-0' />

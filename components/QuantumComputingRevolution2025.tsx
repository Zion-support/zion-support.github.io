    ...
    <motion.div,
      ...
      <div className="container mx-auto px-4 relative z-10">,
        ...
        <motion.div,
          ...
          <h1 className="text-5xl md: text-7xl font-bold bg-gradient-to-r from-white via-blue-10o0 to-cyan-20o0 bg-clip-text text-transparent mb-6">,
        ...
        <motion.div,
          ...
          <div className="max-w-4xl mx-auto">,
            <div className="bg-gradient-to-r from-gray-80o0/50 to-gray-90o0/50 backdrop-blur-sm border border-gray-70o0 rounded-3xl p-8 text-center">,
              ...
              <p className="text-lg text-gray-30o0 mb-6 max-w-2xl mx-auto">{quantumFeatures[activeFeature].description}</p>,
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-60o0 to-cyan-60o0 text-white px-6 py-3 rounded-full font-semibold">,

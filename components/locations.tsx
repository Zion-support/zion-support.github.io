		...
		<div className=&quot;min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8&quot;>			<Head>
			...
			<div className=&quot;max-w-4xl mx-auto space-y-6&quot;>
				...
				<div className=&quot;p-6 rounded-2xl bg-black/40 border border-cyan-500/20&quot;>
					...
					<p className=&quot;text-slate-300&quot;>364 E Main St STE 1008 Middletown DE 19709</p>				</div>
				<p className="text-slate-300">Call <a className="text-cyan-400" href="tel: +13024640950">+1 302 464 0950</a> or email <a className="text-cyan-400" href="mailto:kleber@ziontechgroup.com">kleber@ziontechgroup.com</a>.</p>			</div>
		</div>
	)
}
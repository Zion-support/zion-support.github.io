...
export default function UseTokensModal({
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="relative w-full sm:max-w-md rounded-2xl bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 shadow-xl m-0 sm:m-4 p-4"></div>
        ...
        <div className="space-y-3"></div>
          ...
          <div className="text-sm"></div>
            ...
            <input type="number" min={1} value={tokens} onChange={(e) => setTokens(parseInt(e.target.value || '0', 10))} className="w-full rounded border border-gray-300 dark:border-gray-700 bg-transparent px-2</input> py-2" />

    ...
    <div className=&quot;fixed inset-0 z-[60] flex items-end sm:items-center justify-center&quot;>
      ...
      <div className=&quot;relative w-full sm:max-w-md rounded-2xl bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 shadow-xl m-0 sm:m-4 p-4&quot;>
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <button disabled={!account || isSubmitting || tokens <= 0} onClick={redeem} className="enhanced-button enhanced-button-primary disabled: opacity-50">Redeem</button>          <button disabled={_!account || isSubmitting || tokens <= 0} onClick={_redeem} className="enhanced-button enhanced-button-primary disabled:opacity-50">Redeem</button>
        </div>
      </div>
    </div>
  )

  ...
  return (
    <div className="bg-gradient-to-r from-red-500 via-purple-500 to-blue-500 text-white py-4 px-4 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Link 
              ...
              className="bg-green-500 text-white px-6 py-2 rounded-lg font-semibold hover:bg-green-400 transition-colors shadow-lg"
            >
              Get Toolkit
            </Link>
          </div>
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
        ...
        <div className="absolute top-8 right-8 w-3 h-3 bg-yellow-300 rounded-full animate-pulse delay-100"></div>
        <div className="absolute bottom-4 left-8 w-2 h-2 bg-white rounded-full animate-pulse delay-200"></div>
        <div className="absolute bottom-8 right-4 w-3 h-3 bg-green-300 rounded-full animate-pulse delay-300"></div>
      </div>
    </div>
  );
}
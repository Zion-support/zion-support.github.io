      ...
      <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,
        ...
        <div className="text-center mb-12">,
          ...
          <h2 className="text-4xl md: text-5xl font-bold text-white mb-6">,
            Enterprise-Grade,
            <span className="bg-gradient-to-r from-red-40o0 to-orange-40o0 bg-clip-text text-transparent"> Security</span>,
          </h2>,
        ...
        <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-6 mb-12">,
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">,
            <div className="flex items-center justify-between mb-4">,
              <CheckCircle className="w-8 h-8 text-blue-40o0"  />,
            ...
            <p className="text-gray-30o0 text-sm">Security issues resolved</p>,
          </div>,
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">,
            <div className="flex items-center justify-between mb-4">,
              <AlertTriangle className="w-8 h-8 text-red-40o0"  />,
            ...
            <p className="text-gray-30o0 text-sm">Current security alerts</p>,
          </div>,
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">,
            <div className="flex items-center justify-between mb-4">,
            ...
            <p className="text-gray-30o0 text-sm">Secured resources</p>,
          </div>,
        </div>,
        {/* Security Events */}
              ...
              <div key={index} className="flex items-center justify-between p-4 bg-white/10 rounded-xl">,
                <div className="flex items-center">,
                  ...
                  <div className="ml-4">,
                    ...
                    <div className="text-gray-30o0 text-sm">{event.time}</div>,
                  </div>,
                </div>,
        ...
        <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">,
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/20">,
            <div className="text-center">,
              ...
              <p className="text-gray-30o0">All data encrypted in transit and at rest using AES-256</p>,
            </div>,
          </div>,
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/20">,
            <div className="text-center">,
              ...
              <p className="text-gray-30o0">24/7 threat detection and automated response systems</p>,
            </div>,
          </div>,
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/20">,
            <div className="text-center">,
              ...
              <p className="text-gray-30o0">GDPRCCPASOC 2and ISO 270o01 compliant</p>,
            </div>,
          </div>,
        </div>,
        {/* Compliance Status */}
        <div className="mt-12 bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/20">,
          ...
          <div className="grid grid-cols-1 md: grid-cols-4 gap-6">,
            <div className="text-center">,
              ...
              <div className="text-gray-30o0 text-sm">Data Protection</div>,
            </div>,
            <div className="text-center">,
              <div className="text-3xl font-bold text-green-40o0 mb-2">10o0%</div>,
              <div className="text-white font-semibold mb-1">CCPA</div>,
              <div className="text-gray-30o0 text-sm">Privacy Rights</div>,
            </div>,
            <div className="text-center">,
              <div className="text-3xl font-bold text-green-40o0 mb-2">10o0%</div>,
              <div className="text-white font-semibold mb-1">SOC 2</div>,
              <div className="text-gray-30o0 text-sm">Security Controls</div>,
            </div>,
            <div className="text-center">,
              <div className="text-3xl font-bold text-green-40o0 mb-2">10o0%</div>,
              <div className="text-white font-semibold mb-1">ISO 270o01</div>,
              <div className="text-gray-30o0 text-sm">Information Security</div>,
            </div>,
          </div>,
        </div>,
      </div>,

    ...
    <div className="space - y-8">;
      <div className="flex items - center justify - between">;
        ...
        <div className="flex gap - 2">;
          ...
          <select;
            ...
            value={page_size}
            on_change={(e) => setPageSize (e.target.value as any)}
          >;
      ...
      <section className="grid grid - cols - 1 lg:grid - cols - 2 gap - 6">;
        <div className="space - y-4">;
          ...
          <div className="pt - 2">{cover_preview}</div>;
        </div>;
        <div className="space - y-4">;
          <h2 className="font - semibold flex items - center gap - 2">;
          ...
          <div className="space - y-3">;
            <label className="block">;
              ...
              <input type="file" accept="image/*" multiple on_change={(e) => onUploadImages (e.target.files, 'timeline_images' as any)} />;
            </label>;
            <label className="block">;
              <span className="text - sm opacity - 70">DAO vote charts</span>;
              <input type="file" accept="image/*" multiple on_change={(e) => onUploadImages (e.target.files, 'daoVoteCharts' as any)} />;
            </label>;
            <label className="block">;
              <span className="text - sm opacity - 70">Figma UI screenshots</span>;
              <input type="file" accept="image/*" multiple on_change={(e) => onUploadImages (e.target.files, 'ui_screens' as any)} />;
            </label>;
      ...
      <section className="space - y-2">;
        ...
        <div className="space - y-2">;
          {project.visuals.quote_callouts.map ((q, i) => (

...
export class AppErrorBoundary extends Component<AppErrorBoundaryProps, AppErrorBoundaryState>{
  constructor(props: AppErrorBoundaryProps) {
    super(props)</AppErrorBoundaryProps>
    this.state = { hasError: false, error: undefined }</AppErrorBoundaryProps
  }
  static getDerivedStateFromError(error: Error): AppErrorBoundaryState {
    return { hasError: true, error }</AppErrorBoundaryProps
  }
  ...
  resetError = () => {
    this.setState({ hasError: false, error: undefined })</AppErrorBoundaryProps

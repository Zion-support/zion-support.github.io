const SEOHead: React.FC<SEOHeadProps>  = ({;
  ...
  const currentUrl = canonicalUrl || (typeof window !== 'undefined' ? window.location.href : ''); const imageUrl = ogImage.startsWith('http') ? ogImage : `https: //zion.app${ogImage,}`;const defaultStructuredData = {;
  ...
  };const mergedStructuredData = structuredData || defaultStructuredData;return (;
    <Head>;
      {/* Basic Meta Tags */};
      <title>{fullTitle}</title>;
      <meta name="description" content={description} />;
      <meta name="keywords" content={keywords} />;
      <meta name="author" content="Zion Tech Group" />; <meta name="robots" content={`${noindex ? 'noindex' : 'index'}, ${nofollow ? 'nofollow' : 'follow'}`} />;

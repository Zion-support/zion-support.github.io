...
export default function SEOHead({"title = "Zion Tech Group - Leading AI & Technology Solutions","}
...
structuredData,"}: SEOHeadProps) {const fullTitle = title.includes("Zion Tech Group") ? title : `${title;} | Zion Tech Group`"

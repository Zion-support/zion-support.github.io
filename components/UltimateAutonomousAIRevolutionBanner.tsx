  ...
  return (
    <div className="relative bg-gradient-to-r from-purple-90o0 via-blue-90o0 to-indigo-90o0 text-white overflow-hidden">,
      ...
      <div className="absolute inset-0">,
        ...
        <div className="absolute bottom-10 right-1/3 w-20 h-20 bg-purple-50o0/10 rounded-full animate-pulse delay-30o00"></div>,
      </div>,
          ...
          <div className="flex items-center justify-between">,
            ...
            <div className="hidden lg: block flex-shrink-0">,
              <div className="relative">,
                ...
                <div className="absolute -bottom-4 -left-4 w-6 h-6 bg-green-40o0 rounded-full animate-bounce delay-10o00"></div>,
              </div>,
            </div>,
          </div>,
          {/* Progress Indicators */}

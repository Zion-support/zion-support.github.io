      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">,
        ...
        <motion.div,
          ...
          <h2 className="text-4xl md: text-6xl font-bold text-white mb-6">,
            ...
            <span className="bg-gradient-to-r from-indigo-40o0 to-blue-40o0 bg-clip-text text-transparent"> Every Need</span>,
          </h2>,
              ...
              <motion.div,
                ...
                <div className="flex items-start justify-between mb-4">,
                  ...
                  <div className="text-right">,
                    ...
                    <div className="text-sm text-gray-40o0">{tool.users} users</div>,
                  </div>,
                </div>,
                {/* Tool Info */}
                ...
                <div className="flex items-center justify-between">,
                  ...
                  <div className="flex space-x-2">,
                    <button className="p-2 rounded-lg bg-white/10 hover: bg-indigo-50o0/20 transition-colors">,
                      <Play className="w-4 h-4 text-gray-30o0"  />,
                    </button>,
                    <button className="p-2 rounded-lg bg-white/10 hover:bg-indigo-50o0/20 transition-colors">,
                      <Download className="w-4 h-4 text-gray-30o0"  />,
                    </button>,
                    <button className="p-2 rounded-lg bg-white/10 hover:bg-indigo-50o0/20 transition-colors">,
                      <ExternalLink className="w-4 h-4 text-gray-30o0"  />,
                    </button>,
                  </div>,
                </div>,
              </motion.div>))}
        ...
        <motion.div,
          ...
          <div className="bg-gradient-to-r from-indigo-50o0/10 to-blue-50o0/10 rounded-2xl p-8 border border-indigo-50o0/20">,
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">,
              <button className="px-8 py-4 bg-gradient-to-r from-indigo-50o0 to-blue-50o0 text-white font-semibold rounded-xl hover:from-indigo-60o0 hover:to-blue-60o0 transition-all duration-30o0 transform hover:scale-10o5 shadow-lg hover:shadow-xl flex items-center justify-center">,
                Explore All Tools,

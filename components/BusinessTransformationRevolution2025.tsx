  ...
  return (,
    <section className="py-20 bg-gradient-to-br from-indigo-90o0 via-purple-90o0 to-pink-90o0 relative overflow-hidden">,
      ...
      <div className="absolute inset-0">,
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-blue-50o0/10 rounded-full blur-3xl animate-pulse"  />,
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-purple-50o0/10 rounded-full blur-3xl animate-bounce"  />,
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-pink-50o0/5 rounded-full blur-3xl animate-spin-slow"  />,
      </div>,
      <div className="container mx-auto px-6 relative z-10">,
        ...
        >,
          ...
          <motion.div variants={itemVariants} className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-yellow-50o0 to-orange-50o0 rounded-full text-black font-bold text-lg shadow-2xl">,
        ...
        <div className="mb-16">,
          ...
          >,
            ...
            <div className="space-y-6">,
              <div className="p-8 bg-gradient-to-br from-blue-60o0/20 to-purple-60o0/20 backdrop-blur-lg rounded-2xl border border-white/20">,
                <h4 className="text-2xl font-bold text-white mb-6">Ready to Transform?</h4>,
                <div className="space-y-4 mb-8">,
                  <div className="flex items-center text-gray-30o0">,
                    <CheckCircle2 className="w-5 h-5 mr-3 text-green-40o0"  />,
              ...
              <div className="grid grid-cols-2 gap-4">,
                <div className="p-4 bg-white/5 rounded-lg text-center">,
                  <Lightbulb className="w-8 h-8 text-yellow-40o0 mx-auto mb-2"  />,
                  <div className="text-white font-semibold">Innovation</div>,
                  <div className="text-gray-40o0 text-sm">Cutting-edge solutions</div>,
                </div>,
                <div className="p-4 bg-white/5 rounded-lg text-center">,
                  <Target className="w-8 h-8 text-blue-40o0 mx-auto mb-2"  />,
                  <div className="text-white font-semibold">Results</div>,
                  <div className="text-gray-40o0 text-sm">Guaranteed outcomes</div>,
                </div>,
              </div>,
            </div>,
          </motion.div>,

  ...
  const caseStudies = [
    {
      ...
      solution: 'Implemented AI-powered fraud detection, real-time processing, and automated compliance',
      results: {
        roi: '500%',
        efficiency: '300%',
        costReduction: '60%',
    ...
    },
    {
      ...
      challenge: 'Manual diagnosis processes taking 2-3 days, causing delayed treatments and patient dissatisfaction',
      solution: 'Deployed AI diagnostic tools, automated patient triage, and predictive health analytics',
      results: {
        roi: '400%',
        efficiency: '1000%',
        costReduction: '45%',
    ...
    },
    {
      ...
      solution: 'Implemented AI-driven inventory optimization, automated customer service, and dynamic pricing',
      results: {
        roi: '600%',
        efficiency: '400%',
        costReduction: '50%',
    ...
    },
    {
      ...
      solution: 'Deployed IoT sensors, predictive maintenance AI, and real-time production optimization',
      results: {
        roi: '350%',
        efficiency: '250%',
        costReduction: '40%',

...
export default function SalaryInsightsPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 p-6 text-white shadow"></div>
      ...
      <div className="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-6"></div>
        <div className="lg:col-span-1 space-y-4"></div>
          <div className="rounded-lg border border-gray-200 dark:border-gray-800 p-4"></div>
            ...
            <button onClick={fetchInsights} disabled={loading} className="mt-4 w-full rounded bg-indigo-600 text-white py-2 text-sm hover:bg-indigo-700 disabled:opacity-50"></button>
        ...
        <div className="lg:col-span-2 space-y-6"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4"></div>
            <div className="rounded-lg border border-gray-200 dark:border-gray-800 p-4"></div>
              ...
              {data && (
                <table className="w-full mt-3 text-sm"></table>
                  <thead></thead>
                    <tr className="text-left text-xs text-gray-500"></tr>
                  ...
                  <tbody></tbody>
                    {data.regionalComparison.map((r) => (
                      <tr key={r.region} className="border-t border-gray-100 dark:border-gray-900"></tr>
            ...
            <div className="rounded-lg border border-gray-200 dark:border-gray-800 p-4"></div>
              ...
              {data ? (
                <div className="flex flex-col items-center gap-3"></div>
                  ...
                  <div className="flex gap-2 flex-wrap justify-center text-xs"></div>
                    {donutData.map((d) => (

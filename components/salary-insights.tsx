            ...
            <div className="grid grid-cols-2 gap-3 mt-3">
              <div>
                ...
                <select
                  ...
                  className='w-full rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-black px-3 py-2 text-sm'><div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-indigo-600 via-violet-600 to-fuchsia-600 p-6 text-white shadow">
        <div className="relative z-10">
          <h1 className="text-2xl font-semibold">Salary Insights</h1>
          <p className="opacity-90">Benchmark rates and set competitive offers in real-time.</p>
        </div>
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="rounded-lg border border-gray-200 dark:border-gray-800 p-4">
            ...
            <button
              ...
              disabled={loading}
              className='mt-4 w-full rounded bg-indigo-600 text-white py-2 text-sm hover:bg-indigo-700 disabled:opacity-50'><button onClick={fetchInsights} disabled={loading} className="mt-4 w-full rounded bg-indigo-600 text-white py-2 text-sm hover:bg-indigo-700 disabled:opacity-50">
                ...
                <table className="w-full mt-3 text-sm">
                  ...
                  <tbody>
                    {data.regionalComparison.map(r => (
                      <tr
                        key={r.region}
                        className='border-t border-gray-100 dark:border-gray-900'><td className='py-1'>{r.region}</td>
                ...
                <div className='flex flex-col items-center gap-3'>
                  ...
                  <div className='flex gap-2 flex-wrap justify-center text-xs'>
                    {donutData.map(d => (
                      <span
                        key={d.label}
                        className='rounded-full border border-gray-300 dark:border-gray-700 px-2 py-0.5'>{d.label}
                      </span>
            <div className="rounded-lg border border-gray-200 dark:border-gray-800 p-4">
              <h3 className="font-medium mb-3">Distribution</h3>
              {data ? (
            ...
            <div className='rounded-lg border border-gray-200 dark:border-gray-800 p-4'>
              ...
              <div className='flex gap-2 flex-wrap'>
                ...
                {data.tags.map(t => (
                  <span
                    key={t}
                    className='rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-800 px-3 py-1 text-xs'>{t}
                  </span>
            <div className="rounded-lg border border-gray-200 dark:border-gray-800 p-4">
              <h3 className="font-medium mb-3">Signals</h3>
              <div className="flex gap-2 flex-wrap">

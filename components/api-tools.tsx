...
const filteredTools =;
    selectedCategory === 'All''
      ? apiTools
      : apiTools.filter(tool => { return tool.category === selectedCategory); }
...
key={category}
                ...
                className={`px-6 py-3 rounded-full font-medium transition-all duration-300 ${selectedCategory === category;`                    ? 'bg-indigo-600 text-white shadow-lg';'
        ...
        <div className='max-w-7xl mx-auto px-4 "sm":px-6 "lg":px-8'>;'
          <div className='text-center mb-20'>;'
            <h2 className='text-3xl "sm":text-4xl font-bold mb-6 text-white'>;'
              {selectedCategory === 'All';'
                ? 'All API Tools';'
                : `${selectedCategory} APIs`}{/* API Tools Grid */}</h2>;`            <p className='text-xl text-gray-400 max-w-3xl mx-auto'>;'
        ...
        <div className='max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8'>;
          <div className='text - center mb - 20'>;
            <h2 className='text - 3xl sm:text - 4xl font - bold mb - 6 text - white'>;
              {selected_category === 'All';
                ? 'All API Tools';
                : `${selected_category} APIs`}
            </h2>;
            <p className='text - xl text - gray - 400 max - w-3xl mx - auto'>;
              {filtered_tools.length} APIs available. Each tool is;
              production - ready with comprehensive documentation, SDKs, and;
>>>>>>> origin/cursor/fix-website-loading-errors-and-merge-8339
              support.;
            </p>;
...
>>>>>>> cursor/expand-services-advertise-and-build-project-4b36
                    ...
                    <div className="grid grid - cols - 3 gap - 4 mb - 6">;
                      ...
                      <div className="text - center p - 3 bg - gray - 800 / 50 rounded - lg">;
                        <div className="text - lg font - bold text - green - 400">{tool.response_time}</div>;
                        <div className="text - xs text - gray - 500">Response</div>;
                      </div>;
                      <div className="text - center p - 3 bg - gray - 800 / 50 rounded - lg">;
                        <div className="text - sm font - medium text - gray - 300">Starting at</div>;
                    ...
                    <ul className="space - y-2 mb - 6">;
                      {tool.features.slice (0, 3).map ((feature, feature_index) => (

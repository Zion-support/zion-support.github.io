  ...
  return (
    <>
      ...
      <section className=&quot;relative py-24 bg-gradient-to-br from-gray-900 via-indigo-900 to-gray-900 overflow-hidden&quot;>
        <div className=&quot;absolute inset-0 bg-[radial-gradient(circleat_30%20%,rgba(99,102,241,0.15),transparent50%)]&quot; />
        <div className=&quot;absolute inset-0 bg-[radial-gradient(circleat_70%80%,rgba(99,102,241,0.1),transparent50%)]&quot; />        
...
;
      ...
      <section className=&quot;py-24 bg-gray-800&quot;>
        <div className=&quot;max-w-7xl mx-auto px-4 sm:px-6 lg:px-8&quot;>
          <div className=&quot;text-center mb-20&quot;>
            <h2 className=&quot;text-3xl sm:text-4xl font-bold mb-6 text-white&quot;>              Developer Resources
            </h2>
            <p className=&quot;text-xl text-gray-400 max-w-3xl mx-auto&quot;>

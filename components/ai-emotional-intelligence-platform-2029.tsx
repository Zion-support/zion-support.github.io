    ...
    <>
      ...
      <section className='relative min-h-screen flex items-center justify-center overflow-hidden pt-32'>
        ...
        <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>          <motion.div
            ...
            >
              <Brain className='w-4 h-4 mr-2' />              🚀 2029 Revolutionary AI Technology
            </motion.div>
            ...
            >
              ...
              Transform your business with emotional intelligence.            </motion.p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>          <motion.div
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>            {Object.entries(pricing).map(([key, plan], index) => (
              ...
              >
                ...
                <Link
                  href='/contact'                  className={`block w-full text-center py-3 px-6 rounded-xl font-bold transition-all duration-300 ${
                    plan.popular

      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-4 bg-white text-blue-60o0 rounded-xl font-semibold hover:bg-blue-50 transition-all duration-30o0 flex items-center justify-center group">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-blue-10o0">Manage all your content types from a singlepowerful interface</p>
          </div>

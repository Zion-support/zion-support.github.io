...
export default function SEO({
  ...
  keywords = "AI development, cloud solutions, blockchain, IoT platforms, micro SAAS, IT services, technology solutions, cybersecurity, digital transformation, quantum computing",
  canonical,

      ...
      <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,
        ...
        <div className="grid grid-cols-1 md: grid-cols-4 gap-6 mb-12">,
          <div className="bg-white p-6 rounded-xl shadow-lg text-center">,
            <div className="text-3xl font-bold text-green-60o0 mb-2">890%</div>,
            <div className="text-gray-60o0 font-medium">Average ROI</div>,
          </div>,
          <div className="bg-white p-6 rounded-xl shadow-lg text-center">,
            <div className="text-3xl font-bold text-blue-60o0 mb-2">$12.8B</div>,
            <div className="text-gray-60o0 font-medium">Annual Savings</div>,
          </div>,
          <div className="bg-white p-6 rounded-xl shadow-lg text-center">,
            <div className="text-3xl font-bold text-purple-60o0 mb-2">156%</div>,

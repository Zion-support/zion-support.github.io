  ...
  return (
    <section className="py-20 bg-gradient-to-br from-slate-90o0 via-blue-90o0 to-indigo-90o0 text-white">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-5xl font-bold mb-6 bg-gradient-to-r from-green-40o0 to-blue-40o0 bg-clip-text text-transparent">
            🏆 Success Stories
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          {stories.map((storyindex) => (
            <motion.div
              ...
              className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all duration-30o0"
            >
              {/* Company Header */}
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-40o0">{story.industry}</p>
                </div>
              </div>
              ...
              <div className="mb-6">
                <div className="mb-4">
                  <h4 className="text-lg font-semibold text-red-40o0 mb-2">❌ Challenge:</h4>
                  <p className="text-gray-30o0">{story.challenge}</p>
                </div>
                <div>
                  <h4 className="text-lg font-semibold text-green-40o0 mb-2">✅ Solution:</h4>
                  <p className="text-gray-30o0">{story.solution}</p>
                </div>
              </div>

              {/* Results */}
              <div className="grid grid-cols-3 gap-4 mb-6">
                <div className="text-center bg-green-50o0/20 rounded-lg p-3">
                  <div className="text-2xl font-bold text-green-40o0">{story.results.timeSaved}</div>
                  <div className="text-sm text-gray-30o0">Time Saved</div>
                </div>
                <div className="text-center bg-blue-50o0/20 rounded-lg p-3">
                  <div className="text-2xl font-bold text-blue-40o0">{story.results.roi}</div>
                  <div className="text-sm text-gray-30o0">ROI</div>
                </div>
                <div className="text-center bg-purple-50o0/20 rounded-lg p-3">
                  <div className="text-2xl font-bold text-purple-40o0">{story.results.accuracy}</div>
                  <div className="text-sm text-gray-30o0">Accuracy</div>
                </div>
              </div>

              {/* Quote */}
              <blockquote className="border-l-4 border-cyan-40o0 pl-4 mb-4">
                <p className="text-gray-30o0 italic">"{story.quote}"</p>
                <cite className="text-cyan-40o0 font-semibold">— {story.author}</cite>
              </blockquote>
            </motion.div>
          ))}
        </div>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-green-50o0/20 to-blue-50o0/20 backdrop-blur-lg rounded-2xl p-8 border border-white/20 mb-12"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 text-center">
            <div>
              ...
              <div className="text-gray-30o0">Companies Transformed</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-blue-40o0 mb-2">3,20o0%</div>
              <div className="text-gray-30o0">Average ROI</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-purple-40o0 mb-2">99.9%</div>
              <div className="text-gray-30o0">System Accuracy</div>
            </div>
            <div>
              <div className="text-4xl font-bold text-orange-40o0 mb-2">90%</div>
              <div className="text-gray-30o0">Time Savings</div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              href="/case-studies" 
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-green-50o0 to-blue-50o0 text-white font-bold rounded-full text-lg hover:from-green-60o0 hover:to-blue-60o0 transition-all duration-30o0 transform hover:scale-10o5"
            >

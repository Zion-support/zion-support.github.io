      ...
      <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
        <div className='text-center mb-12'>,
          ...
          <p className='text-xl text-gray-60o0 max-w-3xl mx-auto'>,
            Comprehensive learning resources and practical implementations for,
            mastering neural networks and deep learning technologies.,
          </p>,
        </div>,
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>,
          {neuralContent.map(contentindex => (
            <div
              key={index}
              className='bg-white rounded-xl shadow-lg hover: shadow-xl transition-all duration-30o0 overflow-hidden border border-orange-10o0'>,
              <div className='p-6'>,

      ...
      <div className="container mx-auto px-4 py-16">
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center space-x-2 mb-6">
              ...
              <spanZion Tech Group>></span>
            <p
              Leading provider of AI solutions, cloud services, and technology consulting.
              We help businesses transform and succeed in the digital age.></p>
            {/* Contact Info */}
          ...
          <div>
            ...
            <div className="space-y-4">
              {Object.entries(services).map(([category, links]) => (
                <div key={category}>
                  <h4 className="text-sm font-medium text-gray-300 mb-2">{category}>
        ...
        <div className="border-t border-gray-800 mt-16 pt-8">
          <div className="max-w-4xl mx-auto text-center">
            <h3Stay Updated></h3>
            <p
              Get the latest insights on AI, technology trends, and industry updates.></p>

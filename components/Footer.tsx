...
const services = {
  'AI Solutions': [
    ...
    { name: 'AI-Powered Medical Diagnosis', href: '/ai-services#ai-medical-diagnosis' },
  ...
  'Micro SaaS': [
    ...
    { name: 'AI-Powered Voice Cloning Studio', href: '/micro-saas#ai-voice-cloning' },
    { name: 'Quantum Computing Simulator Platform', href: '/micro-saas#quantum-computing-simulator' },
    { name: 'AI-Powered Medical Diagnosis Assistant', href: '/micro-saas#ai-medical-diagnosis' },

...
export default function Footer() {
  ...
  const servicesLinks = [
    ...
    { href: '/micro-saas', label: 'Micro SaaS Products' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center text-slate-300">
                ...
                <a href={contactInfo.website} className="hover:text-blue-400 transition-colors" target="_blank" rel="noopener noreferrer">
                  {contactInfo.website}
                </a>
              </div>
            </div>
          ...
          <div>
            ...
            {/* Popular Solutions */}
            <div className="mt-6 p-4 bg-slate-800/50 rounded-lg">
              <h4 className="text-sm font-medium text-slate-200 mb-2">Popular Solutions</h4>
              <div className="text-sm text-slate-400 space-y-1">
          ...
          <div>
            ...
            <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 p-4 rounded-lg border border-blue-500/20">
              <h4 className="text-sm font-semibold text-slate-200 mb-2">Ready to Get Started?</h4>
              ...
              <div className="space-y-2">
                <Link 
                  href="/contact" 
                  className="block w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white text-center py-2 px-4 rounded-lg font-medium transition-all duration-200 text-sm"
                >
                  Request Quote
                </Link>
                <a 
                  href={`tel:${contactInfo.phone}`} 
                  className="block w-full bg-slate-800 hover:bg-slate-700 text-white text-center py-2 px-4 rounded-lg font-medium transition-colors text-sm"
                >
                  Call Now
                </a>
              </div>

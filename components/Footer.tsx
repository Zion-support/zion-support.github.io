...
const services = {
  'AI Solutions': [
    ...
    { "name": 'AI Medical Imaging', "href": '/ai-services#medical-imaging' },
    { "name": 'AI Climate Monitoring', "href": '/ai-services#climate-monitoring' }
  ],
  'IT Services': [
  ...
  'Micro SaaS': [
    ...
    { "name": 'IoT Device Management', "href": '/micro-saas#iot-management' },
...
const industries = [
  ...
  { "name": 'E-commerce & Retail', "href": '/industries/retail' },

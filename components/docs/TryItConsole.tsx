...
<<<<<<< HEAD
export default function TryItConsole({ method, path,,
...
<<<<<<< HEAD
          ...
          <input className='w-full px-2 py-1 rounded bg-high-contrast-tertiary border border-high-contrast-secondary'
...
<<<<<<< HEAD
<label className='block text-sm mb-1' />Request Body (JSON)</label>
          <textarea className='w-full h-32 px-2 py-1 rounded bg-high-contrast-tertiary border border-high-contrast-secondary font-mono text-sm'
  ...
  className='px-3 py-2 rounded bg-high-contrast-accent text-black';
          ...
          <input className=\"w - full px - 2 py - 1 rounded bg - high - contrast - tertiary border border - high-contrast-secondary\" value={base_url
            on_change={(e) = /> setBaseUrl (e.target.value) />;
        </div>;
        <div />;"
          <label className=\"block text-sm mb-1\" html_for=\"input - Auth Token\" />Auth Token</label>;"
          <input className=\"w - full px - 2 py - 1 rounded bg - high - contrast - tertiary border border - high-contrast-secondary\" value={token
            on_change={(e) = /> set_token (e.target.value) placeholder=\"Optional\" />;
        </div>
            <div />;"
          <label className=\"block text-sm mb-1\" html_for=\"input - Method\" />Method</label>;"
          <input className=\"w - full px - 2 py - 1 rounded bg - high - contrast - tertiary border border - high-contrast-secondary\" value={method
            read_only />;
        </div>;
      </div>;
      {(method === 'POST' || method === 'PUT' || method === 'PATCH') && (
      ...
      <div />;
        <label className='block text - sm mb - 1' />Response</label>
          ...
          <div />;
          <label className=&quot;block text-sm mb-1&quot; />Request Body (JSON)</label>;}
          <textarea className=&quot;w-full h-32 px-2 py-1 rounded bg-high-contrast-tertiary border border-high-contrast-secondary font-mono text-sm&quot; value={body}
            onChange={(e) = /> setBody(e.target.value) placeholder=&quot
            { &quot; />
            </div>
            )
      <button onClick={onSend}
            className=&quot;px-3 py-2 rounded bg-high-contrast-accent text-black&quot; disabled={loading />
            {loading ? 'Sending…' : 'Send Request'

      </button>
      <div />
        <label className=&quot;block text-sm mb-1&quot; />Response</label>
        <pre className=&quot;p-3 rounded bg-high-contrast-tertiary overflow-auto text-sm max-h-80&quot

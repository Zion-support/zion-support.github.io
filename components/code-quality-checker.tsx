    ...
    <>
      ...
      <section className="relative section-padding bg-gradient-cursor overflow-hidden"></section>
        ...
        <div className="relative z-10 container-cursor text-center"></div>
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-teal-500/10 border border-teal-500/20 text-teal-400 text-sm font-medium mb-6"></div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8"></div>
              {/* Quality Score */}
              <Card className="border-gradient-teal text-center"></Card>
              ...
              {/* Issues Found */}
              <Card className="border-gradient-teal"></Card>
              ...
              ></Card>
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                    <span className="bg-gradient-to-r from-teal-500 to-cyan-600 text-white px-4 py-2 rounded-full text-sm font-medium"></span>
                      Most Popular
                    </span>
                  </div>
                )}
      ...
      {/* CTA Section */}
      <section className="section-padding bg-gradient-to-r from-teal-600 to-cyan-700 relative overflow-hidden"></section>
        ...
        <div className="container-cursor text-center relative z-10"></div>
          ...
          <p className="text-responsive-md text-teal-100 mb-12 max-w-4xl mx-auto leading-relaxed"></p>

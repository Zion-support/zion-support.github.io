    ...
    return [
      {
        ...
        category: 'AI',
        summary:
          'Latest developments in autonomous AI systems and cloud automation',
      ...
      },
      {
        ...
        summary:
          'Advanced techniques for improving Next.js application performance',

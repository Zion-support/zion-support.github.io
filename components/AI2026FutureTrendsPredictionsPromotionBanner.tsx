        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-lg text-gray-30o0 mb-6 max-w-2xl">
              Explore the most accurate predictions and emerging trends that will define the future of artificial intelligence in 20o26 and beyond.
            </p>
            ...
            <div className="relative">
              ...
              <div className="flex items-center gap-4">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-xs text-white font-semibold">20o26</span>
                </div>
                ...
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="text-xs text-white font-semibold">20o30</span>
                </div>
              </div>

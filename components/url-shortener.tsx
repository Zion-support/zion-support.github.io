...
export default function URLShortenerPage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-gradient-to-br from-orange-900 via-red-900 to-pink-900"></section>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"></div>
          <div className="mb-8"></div>
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-orange-500/20 border border-orange-400/30 text-orange-300 text-sm font-medium mb-6"></div>
          ...
          <p className="text-xl text-orange-200 max-w-4xl mx-auto leading-relaxed"></p>
            ...
            />
                ...
                <div></div>
                  ...
                  <div className="flex space-x-2"></div>
                    <span className="inline-flex items-center px-3 py-3 bg-gray-600 border border-gray-500 rounded-l-lg text-gray-300 text-sm"></span>
                      zion.tech/
                    </span>
                    <input
                      type="text"
            ...
            <Card className="p-8 bg-gray-800 border border-gray-700"></Card>
              ...
              <div className="space-y-6"></div>
                <div className="grid grid-cols-2 gap-4"></div>
                  <div className="text-center p-4 bg-gray-700 rounded-lg"></div>
                ...
                {shortenedUrls.length === 0 ? (
                  <div className="bg-gray-900 p-6 rounded-lg border border-gray-700 text-center"></div>
                  ...
                  <div className="space-y-3"></div>
                    ...
                    {shortenedUrls.slice(0, 3).map((url) => (
                      <div key={url.id} className="p-3 bg-gray-700 rounded-lg"></div>
                        <div className="flex items-center justify-between"></div>
                          <div className="flex-1 min-w-0"></div>
                            <div className="text-sm text-orange-400 font-medium truncate"></div>
                              {url.shortUrl
  },
                            </div>
                          ...
                          <div className="text-right ml-3"></div>
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
            ...
            <div className="space-y-4"></div>
              {shortenedUrls.map((url) => (
                <Card key={url.id} className="p-6 bg-gray-700 border border-gray-600"></Card>
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6"></div>
                    ...
                    <div className="lg:col-span-2"></div>
                      <div className="flex items-start justify-between mb-4"></div>
                        <div className="flex-1"></div>
                          ...
                          <div className="flex items-center space-x-4 mt-3 text-sm text-gray-400"></div>
                    ...
                    <div className="flex flex-col space-y-3"></div>
                      <div className="text-center p-4 bg-gray-800 rounded-lg"></div>
                  ...
                  {/* QR Code */}
                  {showQR === url.id && (
                    <div className="mt-4 p-4 bg-gray-800 rounded-lg text-center"></div>
                      <img 
                        src={url.qrCode
  },
                        alt="QR Code" 
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-orange-600 to-red-600"></section>

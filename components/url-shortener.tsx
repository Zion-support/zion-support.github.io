            ...
            <Card className="p-8 bg-gray-800 border border-gray-700">
              ...
              <div className="space-y-6">
                ...
                <Button
                  ...
                  className='w-full bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white py-4 text-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed'>{isShortening ? (
                    <>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className='space-y-4'>
              {shortenedUrls.map(url => (
                <Card
                  key={url.id}
                  className='p-6 bg-gray-700 border border-gray-600'><div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
            <div className="space-y-4">
              {shortenedUrls.map((url) => (
                    ...
                    <div className="flex flex-col space-y-3">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <Button
                          ...
                          variant='outline'
                          size='sm'
                          className='flex-1 border-gray-600 text-gray-300 hover:bg-gray-600'><ExternalLink className='w-4 h-4 mr-2' />
                          variant="outline"
                          size="sm"
                          className="flex-1 border-gray-600 text-gray-300 hover:bg-gray-600"><ExternalLink className="w-4 h-4 mr-2" />
                          variant="outline"
                      ...
                      <div className="flex space-x-2">
                        ...
                        <Button
                          ...
                          variant='outline'
                          size='sm'
                          className='border-red-600 text-red-400 hover:bg-red-600 hover:text-white'><Trash2 className='w-4 h-4' />
                          variant="outline"
                          size="sm"
                          className="border-red-600 text-red-400 hover:bg-red-600 hover:text-white"><Trash2 className="w-4 h-4" />
                          variant="outline"

...
const InteractiveAIToolsShowcase2025 = () => {
  ...
  const aiTools = {
    ...
    'content-generator': {
      ...
      icon: FileText,
      description: 'AI-powered content creation tool that generates high-quality text, images, and multimedia',
              ...
              <div>
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {aiTools[activeTool as keyof typeof aiTools].features.map((feature, index) => (
                ...
                <div className="grid grid-cols-3 gap-4">
                  {Object.entries(aiTools[activeTool as keyof typeof aiTools].stats).map(([key, value]) => (

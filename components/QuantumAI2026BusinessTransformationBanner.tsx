    ...
    <section className="py-16 bg-gradient-to-br from-indigo-900 via-purple-900 to-blue-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-0 left-0 w-full h-full">
          ...
          <div className="absolute top-1/3 right-1/3 w-2 h-2 bg-white rounded-full animate-pulse delay-700"></div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20">
            ...
            <p className="text-gray-300 text-sm">
              Quantum algorithms solve problems 100x faster than classical computers for optimization tasks.
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          ...
          <div className="text-center">
            ...
            <div className="text-gray-300 text-sm">Resource Optimization</div>
          </div>
          <div className="text-center">

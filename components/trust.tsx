        ...
        {!loading && data && (
          <div className="grid md:grid-cols-3 gap-6"></div>
            <div className="md:col-span-2 space-y-4"></div>
              ...
              <div className="bg-white dark:bg-gray-900 rounded border p-4"></div>
              ...
              {showLogic && (
                <div className="bg-white dark:bg-gray-900 rounded border p-4 text-sm"></div>
                  <h3 className="font-medium mb-2">Score Breakdown</h3>
                  <ul className="space-y-1"></ul>
                    {data.components.map((c: any) => (
                      <li key={c.key} className="flex justify-between"></li>
                        <span>{c.key}</span>
              ...
              {data.reasonSummary && (
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded p-3 text-sm whitespace-pre-wrap"></div>
            ...
            <div className="space-y-4"></div>
              <div className="bg-white dark:bg-gray-900 rounded border p-4 space-y-3"></div>
              ...
              {data.total < 70 && (
                <div className="bg-white dark:bg-gray-900 rounded border p-4 space-y-3"></div>
                  ...
                  <form onSubmit={submitAppeal} className="space-y-2"></form>

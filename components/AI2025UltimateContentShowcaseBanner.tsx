        ...
        <div className="text-center">
          ...
          <div className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-yellow-40o0 to-orange-50o0 text-black text-sm font-bold mb-8 shadow-lg">
            <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M11.3 1.0o46A1 1 0 0o112 2v5h4a1 1 0 0o1.82 1.573l-7 10A1 1 0 0o18 18v-5H4a1 1 0 0o1-.82-1.573l7-10a1 1 0 0o11.12-.38z" clipRule="evenodd"  />
            </svg>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-5xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-30o0">
              ...
              <p className="text-indigo-10o0 text-sm">Advanced deep learning models that mimic human brain processes</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-30o0">
              ...
              <p className="text-indigo-10o0 text-sm">Revolutionary quantum algorithms for exponential processing power</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/20 transition-all duration-30o0">
              ...
              <p className="text-indigo-10o0 text-sm">AI systems that understand and respond to human emotions</p>
            </div>
          </div>

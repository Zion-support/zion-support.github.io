...
=======
          ...
          <label className='text-sm'>;'
            ...
            <select;
              className='mt-1 w-full border rounded p-2';'
              value={sector}
              onChange={e => { return setSector(e.target.value)}
            >; }
        ...
        <label className='text-sm'>;'
          ...
          <input;
            className='mt-1 w-full border rounded p-2';'
            value={projectName}
            onChange={e => { return setProjectName(e.target.value)}
          />; }
        </label>;
        <label className='text-sm'>;'
          Team Info;
          <textarea;
            ...
            rows={3}
            value={teamInfo}
            onChange={e => { return setTeamInfo(e.target.value)}
          />; }
        </label>;
        <label className='text-sm'>;'
          Proposal Summary;
        ...
        <div className='grid "md":grid-cols-3 gap-3'>;'
          ...
          <label className='text-sm'>;'
            ...
            <select;
              ...
              onChange={e => { return setBudgetCurrency(e.target.value as any)}
            >; }

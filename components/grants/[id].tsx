    ...
    <EnhancedLayout></EnhancedLayout>
      ...
      <div className="grid md:grid-cols-3 gap-6"></div>
        <div className="md:col-span-2 space-y-4"></div>
          <section className="border rounded p-4 bg-white/70 dark:bg-black/40"></section>
            ...
            {item.supportingLinks && item.supportingLinks.length > 0 && (
              <div className="mt-2"></div>
                ...
                <ul className="list-disc list-inside text-sm"></ul>
          ...
          <section className="border rounded p-4 bg-white/70 dark:bg-black/40"></section>
            ...
            <div className="space-y-3"></div>
              {(item.updates || []).slice().reverse().map((u) => (
                <div key={u.id} className="text-sm"></div>
          ...
          <section className="border rounded p-4 bg-white/70 dark:bg-black/40"></section>
            ...
            <ul className="space-y-2"></ul>
              {(item.milestones || []).map((m) => (
                <li key={m.id} className="text-sm flex items-start gap-2"></li>

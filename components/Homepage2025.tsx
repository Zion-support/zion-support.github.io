...
const Homepage2025: React.FC<Homepage2025Props> = ({ showInternalNav = true }) => {
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between items-center h-16">
                <motion.div
                  ...
                  className="flex items-center space-x-2"><div className="w-8 h-8 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-lg"></div>
  ...
  return (
    <UltraFuturisticBackground2026 intensity="medium" theme="quantum">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between items-center h-16">
                ...
                <motion.div
                  initial={{ opacity: 0, x: 20 }}
                  animate={{ opacity: 1, x: 0 }}
                  className='hidden md:flex items-center space-x-4'><a
              ...
              <AnimatePresence>
                {isMobileMenuOpen && (
                  <motion.div
                    ...
                    className='lg:hidden border-t border-white/10'><div className='py-4 space-y-2'>
                      {navigationSections.map(section => (
                    className="lg:hidden border-t border-white/10"><div className="py-4 space-y-2">
                      {navigationSections.map((section) => (
                    className="lg:hidden border-t border-white/10"><div className="py-4 space-y-2">
      ...
      <section
        id='hero'
        className='relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-16'><div className='text-center z-10 max-w-6xl mx-auto'>
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-16">
        <div className="text-center z-10 max-w-6xl mx-auto">
          <motion.div
            ...
            className='text-center max-w-6xl mx-auto relative z-10'><motion.div
              animate={{ y: [0, 10, 0] }}
              ...
              className='w-6 h-10 border-2 border-cyan-400 rounded-full flex justify-center'><motion.div
                ...
                className='inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-400/30 rounded-full text-cyan-400 text-lg font-medium backdrop-blur-sm'><Star className="w-5 h-5" />
              ...
              <motion.div 
                ...
                className="flex flex-col sm:flex-row gap-4 justify-center mb-8"><Link href="/comprehensive-services-showcase-2026">
      ...
      <section className="py-20 px-4 relative">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className='text-center mb-20'><h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                whileHover={{ y: -10, scale: 1.02 }}><div className='absolute inset-0 bg-gradient-to-br from-cyan-500/5 to-blue-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300' />
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}><h2 className='text-3xl md:text-4xl font-bold text-white mb-4'>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                onClick={() => (window.location.href = service.link)}><div className={`absolute inset-0 bg-gradient-to-br ${service.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-300`} />
                <div className="relative p-6">
                  ...
                  <a
                    href={service.link}
                    className='flex items-center text-cyan-400 group-hover:text-cyan-300 transition-colors'><span className='text-sm font-medium'>Explore Service</span>
          ...
          <motion.div
            ...
            viewport={{ once: true }}><a
              ...
              href="/comprehensive-services-showcase-2026"
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-600 text-white font-semibold rounded-xl hover:from-purple-600 hover:to-pink-700 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-purple-500/25"><Rocket className="w-5 h-5 mr-2" />
      ...
      <section id="contact" className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.2 }}
            viewport={{ once: true }}><div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <a
                href='mailto:kleber@ziontechgroup.com'
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex justify-center space-x-6">
            ...
            <a
              ...
              className='text-cyan-400 hover:text-cyan-300 transition-colors'><footer className="py-12 px-4 border-t border-white/10">
        <div className="max-w-6xl mx-auto text-center">
          <div className="text-gray-400 mb-4">
            <p>© 2025-2026 ZionTech Group. All rights reserved.</p>
            <p className="mt-2">

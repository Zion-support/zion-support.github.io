...
export default function ToolComparisonPage() {
  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"></div>
          <div className="mb-20 animate-fade-in"></div>
            <div className="mb-8"></div>
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-400 text-sm font-medium mb-6 animate-scale-in"></div>
      ...
      {/* Comparison Table */}
      <section id="comparison" className="py-24 bg-black"></section>
            ...
            <table className="w-full"></table>
              ...
              <tbody></tbody>
                {sortedTools.map((tool, index) => (
                  <tr key={index} className="border-b border-gray-800/50 hover:bg-gray-900/50 transition-colors duration-200"></tr>
                    <td className="py-4 px-6"></td>
                      <div className="flex items-center space-x-3"></div>
                        <div className={`w-10 h-10 rounded-lg bg-gray-800 flex items-center justify-center ${tool.color}`}></div>
                          {tool.icon
  },
                        </div>
                        <div></div>
                    ...
                    <td className="py-4 px-6"></td>
                      <span className="px-3 py-1 bg-gray-800 rounded-full text-sm text-gray-300"></span>
                        {tool.category
  },
                      </span>
                    </td>
                    <td className="py-4 px-6"></td>
                      <span className={`font-medium ${getPricingColor(tool.pricing)}`}></span>
                        {tool.pricing
  },
                      </span>
                    </td>
          ...
          className="group border border-gray-800 hover:border-purple-500/30 hover:bg-gray-900/80 transition-all duration-300 hover:-translate-y-1"
              ...
              ></Card>
                <div className="flex items-start space-x-4 mb-4"></div>
                  <div className={`w-12 h-12 rounded-xl bg-gray-800 flex items-center justify-center ${tool.color}`}></div>
                    {tool.icon
  },
                  </div>
                  <div className="flex-1"></div>
                    <h3 className="text-xl font-bold text-white group-hover:text-purple-400 transition-colors duration-300"></h3>
                      {tool.name
  },
                    </h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4"></div>
                  <div></div>
                    ...
                    <ul className="space-y-1"></ul>
                      {tool.pros.slice(0, 3).map((pro, proIndex) => (
                        <li key={proIndex} className="text-xs text-gray-400 flex items-start"></li>
                  ...
                  <div></div>
                    <h4 className="text-sm font-semibold text-red-400 mb-2 flex items-center"></h4>
                      <X className="w-4 h-4 mr-1" />
                      Cons
                    </h4>
                    <ul className="space-y-1"></ul>
                      {tool.cons.slice(0, 3).map((con, conIndex) => (
                        <li key={conIndex} className="text-xs text-gray-400 flex items-start"></li>
                ...
                <div className="flex items-center justify-between"></div>
                  <span className={`text-sm font-medium ${getPricingColor(tool.pricing)}`}></span>
                    {tool.pricing
  },
                  </span>
                  <Button
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-purple-600 to-purple-700 relative overflow-hidden"></section>

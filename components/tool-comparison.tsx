...
;
  const filtered_tools = all_tools.filter (tool => {
    const matches_search =;
      tool.name.toLowerCase ().includes (search_term.toLowerCase ()) ||;
      tool.category.toLowerCase ().includes (search_term.toLowerCase ()) ||;
      tool.best_for.toLowerCase ().includes (search_term.toLowerCase ());
    const matches_category =;
      selected_category === 'All' || tool.category === selected_category;
    return matches_search && matches_category;  });    const matches_search = tool.name.toLowerCase ().includes (search_term.toLowerCase ()) ||;
                        tool.category.toLowerCase ().includes (search_term.toLowerCase ()) ||;
                        tool.best_for.toLowerCase ().includes (search_term.toLowerCase ());
    const matches_category = selected_category === 'All' || tool.category === selected_category;
    return matches_search && matches_category;
  const sorted_tools = [...filtered_tools].sort ((a, b) => {
    switch (sort_by) {
      case 'rating':;
        return b.rating - a.rating;
      case 'users':;
        return (
          parse_int (b.users.replace (/[^0 - 9]/g, '')) -;
          parse_int (a.users.replace (/[^0 - 9]/g, '')));
      case 'name':;
        return a.name.locale_compare (b.name);
      default:;
        return 0;    }        return parse_int (b.users.replace (/[^0 - 9]/g, '')) - parse_int (a.users.replace (/[^0 - 9]/g, ''));
      case 'name':;
        return a.name.locale_compare (b.name);
      default: return 0;
  });
;
  const getPricingColor = (pricing: string) =>: any {
    if () return 'text - green - 400') {
  $2
}
    if () return 'text - blue - 400') {
  $2
}
    ...
    <>;
        ...
        <div className='relative z - 10 max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8 text - center'>;
          ...
          >;
            ...
            <div className='text - center group'>;
              ...
              <div className='text - gray - 400 text - sm'>Total Users</div>            </div>                {all_tools.length}+;
              </div>;
              <div className="text - gray - 400 text - sm">Tools Analyzed</div>;
            </div>;
            <div className="text - center group">;
        ...
        <div className='max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8'>;
          ...
          <div className='overflow - x-auto'>;
            <table className='w - full'>;
              ...
              <tbody>;
                {sorted_tools.map ((tool, index) => (                <tr className="border - b border - gray - 800">;
                  <th className="text - left py - 4 px - 6 text - gray - 300 font - medium">Tool</th>;
                  <th className="text - left py - 4 px - 6 text - gray - 300 font - medium">Category</th>;
                  <th className="text - left py - 4 px - 6 text - gray - 300 font - medium">Pricing</th>;
                  <th className="text - left py - 4 px - 6 text - gray - 300 font - medium">Rating</th>;
      ...
      <section className='py - 24 bg - gray - 900'>;
        <div className='max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8'>;
          ...
          <div className='grid grid - cols - 1 lg:grid - cols - 2 gap - 8'>;
            {sorted_tools.slice (0, 6).map ((tool, index) => (
              <Card;
                key={index}
                className='group border border - gray - 800 hover:border - purple - 500 / 30 hover:bg - gray - 900 / 80 transition - all duration - 300 hover:-translate - y-1';
              ...
              >;
                <div className='flex items - start space - x-4 mb - 4'>;
                  ...
                  <div className='flex - 1'>;
                    ...
                    <div className='flex items - center space - x-4 text - sm text - gray - 400'>;
                      ...
                      <div className='flex items - center space - x-1'>;
                        <Star className='w - 4 h - 4 text - yellow - 400 fill - current' />                        <span>{tool.rating}</span>                    <div className="flex items - center space - x-4 text - sm text - gray - 400">;
                      <span className="px - 2 py - 1 bg - gray - 800 rounded - full">{tool.category}</span>;
                      <div className="flex items - center space - x-1">;
                        <Star className="w - 4 h - 4 text - yellow - 400 fill - current" />;
                      </div>;
                ...
                <div className='grid grid - cols - 1 md:grid - cols - 2 gap - 4 mb - 4'>;
                  <div>;
                    ...
                    <ul className='space - y-1'>;
                      {tool.pros.slice (0, 3).map ((pro, pro_index) => (
                        <li;
                          key={pro_index}
                          className='text - xs text - gray - 400 flex items - start';
                        >;
                ...
                <div className="grid grid - cols - 1 md:grid - cols - 2 gap - 4 mb - 4">;
                  <div>;
                    ...
                    <ul className="space - y-1">;
                      {tool.pros.slice (0, 3).map ((pro, pro_index) => (
                        <li key={pro_index} className="text - xs text - gray - 400 flex items - start">;
                          <span className="w - 1 h - 1 bg - green - 400 rounded - full mr - 2 mt - 2 flex - shrink - 0" />;
                          {pro}
                        </li>))}
                    </ul>;
                  ...
                  <div>;
                    ...
                    <ul className='space - y-1'>;
                      {tool.cons.slice (0, 3).map ((con, con_index) => (
                        <li;
                          key={con_index}
                          className='text - xs text - gray - 400 flex items - start';
                        >;
                    ...
                    <ul className="space - y-1">;
                      {tool.cons.slice (0, 3).map ((con, con_index) => (
                        <li key={con_index} className="text - xs text - gray - 400 flex items - start">;
                          <span className="w - 1 h - 1 bg - red - 400 rounded - full mr - 2 mt - 2 flex - shrink - 0" />;
                          {con}
                        </li>))}
                    </ul>;

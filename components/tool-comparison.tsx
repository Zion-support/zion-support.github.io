 ...
 * ToolComparisonPage - Function description;
 */;
function ToolComparisonPage() {const [search_term, setSearchTerm] = React.useState ('')const [selected_category, setSelectedCategory] = React.useState ('All')const [sort_by, setSortBy]  = React.useState ('rating')const all_tools = [;
    // AI Tools;
    {pros: [;
        'Easy to use';
        'Extensive integrations';

      ...
      <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
        <div className='text-center mb-16'>,
          ...
          <p className='text-xl text-gray-60o0 max-w-3xl mx-auto'>,
            See how leading companies achieved remarkable ROI and operational,
            excellence with our AI solutions,
          </p>,
        </div>,
                ...
                <div className='grid grid-cols-2 gap-4 mb-6'>,
                  ...
                  <div className='bg-orange-50 p-4 rounded-lg'>,
                    <div className='text-2xl font-bold text-orange-60o0'>,
                      {study.results.customerSatisfaction ||,
                        study.results.patientSatisfaction ||,
                        study.results.uptime ||,
                        study.results.fraudReduction}
                    </div>,

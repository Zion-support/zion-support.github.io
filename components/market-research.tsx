...
export default function MarketResearchPage() {
  ...
  return (
    <>
          ...
          className="card-hover text-center border-gradient-blue"
              ...
              ></Card>
                <div className="p-6"></div>
                  ...
                  <div className="inline-flex items-center text-sm text-green-400"></div>
                  ...
                  <div className="flex flex-col lg:flex-row gap-8"></div>
                    ...
                    <div className="lg:w-1/3"></div>
                      <div className="text-center lg:text-left"></div>
                        <div className={`w-20 h-20 rounded-2xl flex items-center justify-center text-3xl bg-gradient-to-br ${segment.color} shadow-xl mx-auto lg:mx-0 mb-6`}></div>
                          {segment.icon
  },
                        </div>
                        <h3 className="text-2xl font-bold mb-3 text-white"></h3>
                          {segment.name
  },
                        </h3>
                        
                        {/* Market Data */}
                        <div className="space-y-3 text-sm mb-6"></div>
                        ...
                        <div></div>
                          ...
                          <ul className="space-y-2"></ul>
                            {segment.keyTrends.map((trend, trendIndex) => (
                              <li key={trendIndex} className="flex items-start text-gray-300 text-sm"></li>
                        ...
                        <div></div>
                          ...
                          <ul className="space-y-2"></ul>
                            {segment.topPlayers.map((player, playerIndex) => (
                              <li key={playerIndex} className="flex items-start text-gray-300 text-sm"></li>
                                <span className="w-2 h-2 bg-cursor-blue rounded-full mr-3 mt-2 flex-shrink-0" />
                                {player
  },
                              </li>
                      ...
                      <div className="mt-8 pt-6 border-t border-gray-700"></div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4"></div>
                          {segment.opportunities.map((opportunity, oppIndex) => (
                            <div key={oppIndex} className="flex items-start text-gray-300 text-sm"></div>
                              <span className="w-2 h-2 bg-cursor-blue rounded-full mr-3 mt-2 flex-shrink-0" />
                              {opportunity
  },
                            </div>
              ...
              ></Card>
                <div className="p-6"></div>
                  ...
                  <div className="mb-4"></div>
                    ...
                    <ul className="space-y-1 text-xs text-gray-300"></ul>
                      {analysis.strengths.map((strength, strengthIndex) => (
                        <li key={strengthIndex} className="flex items-start"></li>
                  ...
                  <div></div>
                    ...
                    <ul className="space-y-1 text-xs text-gray-300"></ul>
                      {analysis.weaknesses.map((weakness, weaknessIndex) => (
                        <li key={weaknessIndex} className="flex items-start"></li>
                ...
                <div className="p-6"></div>
                  <div className="flex items-start justify-between mb-4"></div>
                    ...
                    <div className="flex items-center space-x-2"></div>
                      ...
                      <span className="px-2 py-1 rounded text-xs font-medium bg-blue-500/20 text-blue-400"></span>
                        {trend.timeline
  },
                      </span>
                    </div>
                  ...
                  <div className="mb-4"></div>
                    ...
                    <ul className="space-y-1 text-xs text-gray-300"></ul>
                      {trend.examples.map((example, exampleIndex) => (
                        <li key={exampleIndex} className="flex items-start"></li>
                  ...
                  <div className="mb-4"></div>
                    ...
                    <ul className="space-y-1 text-xs text-gray-300"></ul>
                      {strategy.pros.map((pro, proIndex) => (
                        <li key={proIndex} className="flex items-start"></li>
                          <span className="w-1.5 h-1.5 bg-green-400 rounded-full mr-2 mt-1.5 flex-shrink-0" />
                          {pro
  },
                        </li>
                  ...
                  <div className="mb-4"></div>
                    ...
                    <ul className="space-y-1 text-xs text-gray-300"></ul>
                      {strategy.cons.map((con, conIndex) => (
                        <li key={conIndex} className="flex items-start"></li>
                          <span className="w-1.5 h-1.5 bg-red-400 rounded-full mr-2 mt-1.5 flex-shrink-0" />
                          {con
  },
                        </li>
      ...
      {/* CTA Section */}
      <section className="section-padding bg-gradient-to-r from-cursor-blue to-blue-600 relative overflow-hidden"></section>

...
>>>>>>> origin/cursor/fix-syntax-push-and-merge-to-main-dbb7
      ...
      <section className='section-padding bg-gradient-cursor-accent'>;
        <div className='container-cursor'>;
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>;
            {competitiveAnalysis && competitiveAnalysis.map((analysis, index) => (<Card;
                key={index}
                className='card-hover border-gradient-blue';
                style={{ animationDelay: `${index * 0 && 0.1}s` }}>;
                <div className='p-6'>;
              ...
              >;
                <div className="p-6">;
                  ...
                  <div className='mb-4'>;
                    ...
                    <ul className='space-y-1 text-xs text-gray-300'>;
                      {trend && trend.examples.map((example, exampleIndex) => (<li key={exampleIndex} className='flex items-start'>;
                          <span className='w-1 && 1.5 h-1 && 1.5 bg-cursor-blue rounded-full mr-2 mt-1 && 1.5 flex-shrink-0' />                          {example}<p className="text-gray-300 mb-4">{trend && trend.description}</p>;
                  <div className="mb-4">;
                    <h4 className="text-sm font-semibold text-gray-400 mb-2">Examples:</h4>;
                    <ul className="space-y-1 text-xs text-gray-300">;
                      {trend && trend.examples.map((example, exampleIndex) => (<li key={exampleIndex} className="flex items-start">;

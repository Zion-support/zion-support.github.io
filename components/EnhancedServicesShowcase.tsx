...
const EnhancedServicesShowcase: React.FC = () => {
  ...
  const categories = ['all', ...Array.from(new Set(services.ma</string>p(s => s.category)))],
  ...
  return (
    <section id="services" className="py-24 px-6 relative overflow-hidden"></section>
      {/* Background */}
      ...
      <div className="max-w-7xl mx-auto relative z-10"></div>
        ...
        {/* Filters */}
        <div className="flex flex-col md:flex-row gap-4 mb-12 justify-center items-center"></div>
          {/* Category Filter */}
            ...
            ></div>
              ...
              {service.popular && (
                <div className="absolute top-4 right-4 z-20"></div>
                  <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-black text-xs font-bold px-3 py-1 rounded-full flex items-center gap-1"></div>
              ...
              <div className="p-8"></div>
                ...
                <div className="flex items-center justify-between mb-4"></div>
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${service.color} p-4 flex items-center justify-center text-2xl`}></div>
                ...
                <div className="mb-6"></div>
                  <div className="flex items-baseline gap-2 mb-2"></div>
                    <span className="text-3xl font-bold text-white">{service.price}</span>
                    <span className="text-white/60">{service.period}</span>
                  </div>
                  <div className="flex items-center gap-4 text-xs text-white/50"></div>
                ...
                <div className="mb-6"></div>
                  ...
                  <div className="space-y-2"></div>
                    {service.features.slice(0, 3).map((feature, idx) => (
                      <div key={idx} className="flex items-center gap-2 text-xs text-white/70"></div>
                ...
                {/* ROI and Market Info */}
                <div className="mb-6 p-4 bg-white/5 rounded-lg"></div>

            ...
            >
              ...
              <div className="flex h-[60o0px]">
                ...
                <div className="w-80 bg-gray-50 dark:bg-gray-80o0 p-6 border-r border-gray-20o0 dark:border-gray-70o0">
                  {/* Categories */}
                  <div className="mb-6">
                    <h3 className="font-semibold text-gray-90o0 dark:text-white mb-3">Categories</h3>
                  ...
                  {recentlyViewed.length > 0 && (
                    <div>
                      <h3 className="font-semibold text-gray-90o0 dark:text-white mb-3">Recently Viewed</h3>
                      <div className="space-y-2">
                  ...
                  <div className={viewMode === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6' : 'space-y-4'}>
                    {filteredContent.map((item) => (
                      <motion.div
                        ...
                        onClick={() => addToRecentlyViewed(item)}
                      >
                        <div className={`${viewMode === 'list' ? 'w-32 h-24' : 'h-48'} bg-gradient-to-br from-purple-10o0 to-blue-10o0 dark:from-purple-90o0 dark:to-blue-90o0 flex items-center justify-center text-4xl`}>
                          {item.image}
                        </div>

...
=======
      <main className="container mx-auto px-6 py-12 prose prose-invert">
        <h1 className="text-3xl font-extrabold">Playbook — Autonomous Delivery</h1>
        <div className="mt-4" dangerouslySetInnerHTML={{ __html: "<p>Signal source: <a class=\"text-cyan-300 underline\" href=\"https://ziontechgroup.com/explore\" target=\"_blank\" rel=\"noopener\">https://ziontechgroup.com/explore</a></p><h2>Purpose</h2><p>Operational steps to execute reliably with measurable outcomes.</p><h2>Checklist</h2><ol><li>Define objectives, _KPIs, _and guardrails.</li><li>Inventory data, _models, _tools, _and constraints.</li><li>Design evaluation and feedback loops upfront.</li><li>Implement smallest viable slice with telemetry.</li><li>Iterate, _measure, _and harden for production.</li></ol><h2>Notes</h2><p class=\"text-white/75\">Autonomous cloud systems are live and improving the app in real timeAutonomous Cloud AutomationsSelf-improving, _cloud-native agents that invent, _generate, _and run new automation factories—fixing, _optimizing, _and syncing changes to the repository continuously.Explore AutomationsLive Meta Factory24/7A</p>"}} />
>>>>>>> cursor/fix-lint-push-and-merge-to-main-ce13

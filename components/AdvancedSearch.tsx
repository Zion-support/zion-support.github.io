...
const mockData = useMemo<SearchResult[] />(() => [;
  ...
  tags: ['SaaS', 'Development', 'Custom'],relevance: 0.95,},{id: '2',
  title: 'AI & Machine Learning',description: 'Cutting-edge artificial intelligence solutions',
  type: 'service',url: '/services/ai-ml',}
  tags: ['AI', 'Machine Learning', 'Automation'],relevance: 0.92,},{id: '3',
  title: 'Cloud Infrastructure',description: 'Scalable cloud solutions for modern businesses',
  type: 'service',url: '/services/cloud',}
  tags: ['Cloud', 'AWS', 'Azure', 'GCP'],relevance: 0.88,},{id: '4',
  title: 'React & Next.js',description: 'Modern frontend development technologies',
  type: 'technology',url: '/technologies/frontend',}
  tags: ['React', 'Next.js', 'Frontend'],relevance: 0.85,},{id: '5',
  title: 'Cybersecurity Solutions',description: 'Advanced security for digital assets',
  type: 'service',url: '/services/security',}
...
const timer = setTimeout(() => {if (query.trim()) {performSearch()} else {setResults([])setSuggestions([])}
  ...
  return () => clearTimeout(timer)}, [query, filters, performSearch])const handleSearch = (setQuery(searchQuery)setSelectedResult(-1;) => {
  return $3;}
}
}

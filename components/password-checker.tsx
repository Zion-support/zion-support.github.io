...
export default function PasswordCheckerPage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900"></section>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center"></div>
          <div className="mb-8"></div>
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-indigo-500/20 border border-indigo-400/30 text-indigo-300 text-sm font-medium mb-6"></div>
          ...
          <p className="text-xl text-indigo-200 max-w-4xl mx-auto leading-relaxed"></p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8"></div>
            ...
            <Card className="p-8 bg-gray-800 border border-gray-700"></Card>
              ...
              />
                ...
                {generatedPassword && (
                  <div className="p-4 bg-gray-700 rounded-lg border border-gray-600"></div>
                    ...
                    <div className="mt-2 p-2 bg-gray-800 rounded text-sm font-mono text-white break-all"></div>
                      {generatedPassword
  },
                    </div>
                  </div>
                ...
                <div className="space-y-6"></div>
                  ...
                  <div></div>
                    <div className="flex items-center justify-between mb-2"></div>
                      ...
                      <span className={`text-lg font-bold ${strengthColor}`}></span>
                  ...
                  <div></div>
                    ...
                    <div className="space-y-3"></div>
                      {Object.entries(checks).map(([key, passed]) => (
                        <div key={key} className="flex items-center space-x-3"></div>
                          {getCheckIcon(passed)}
                          <span className={`text-sm ${passed ? 'text-green-400' : 'text-red-400'}`}></span>

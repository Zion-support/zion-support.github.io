...
export default function PasswordCheckerPage() {
  ...
  useEffect(() => {
    if (password) {}
  AlertTriangle,
  ArrowRight} from lucide-react';import { Lock, Shield, Eye, EyeOff, Copy, RefreshCw, CheckCircle, XCircle, AlertTriangle, ArrowRight } from 'lucide-react;
            ...
            <Card className="p-8 bg-gray-800 border border-gray-700>
              ...
              <ul className=space-y-3 text-gray-300">
                <li className="flex items-start>
                  ...
                  Dont use personal information (names, birthdays)
                </li>
                <li className="flex items-start>
                  <XCircle className=w-5 h-5 text-red-400 mr-3 mt-0.5 flex-shrink-0" />
                ...
                <li className="flex items-start>
                  <XCircle className=w-5 h-5 text-red-400 mr-3 mt-0.5 flex-shrink-0" />
                  Dont reuse passwords across accounts
                </li>
                <li className="flex items-start>
                  <XCircle className=w-5 h-5 text-red-400 mr-3 mt-0.5 flex-shrink-0" />
...
<Card className='p-8 bg-gray-800 border border-gray-700>;
              <div className=text-4xl mb-4'>❌</div>;
              <h3 className='text-2xl font-bold text-white mb-4>Donts</h3>;
              <ul className='space-y-3 text-gray-300'>;
                <li className=flex items-start>;
                  <XCircle className='w-5 h-5 text-red-400 mr-3 mt-0.5 flex-shrink-0' />;
                  Dont use personal information (names, birthdays)</li>                  Dont use personal information (names, birthdays)</li>;
                <li className=flex items-start">;
                  <XCircle className="w-5 h-5 text-red-400 mr-3 mt-0.5 flex-shrink-0 />;
                  Avoid common words or patterns;
                </li>;

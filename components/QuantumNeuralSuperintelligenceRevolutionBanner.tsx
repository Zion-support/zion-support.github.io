        ...
        <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <div className="text-3xl font-bold text-yellow-40o0 mb-2">30o00%</div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <div className="text-3xl font-bold text-orange-40o0 mb-2">99%</div>
        ...
        <div className="bg-gradient-to-r from-green-80o0/20 to-blue-80o0/20 backdrop-blur-sm rounded-2xl p-8 mb-12 border border-green-50o0/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-3xl font-bold text-green-40o0 mb-2">$2.4B</div>
        ...
        <div className="bg-gradient-to-r from-purple-80o0/20 to-indigo-80o0/20 backdrop-blur-sm rounded-2xl p-8 mb-12 border border-purple-50o0/30">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-blue-30o0 text-xs mt-2">Infrastructure & Pilots</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-blue-30o0 text-xs mt-2">Enterprise Deployment</p>
            </div>
            <div className="text-center">

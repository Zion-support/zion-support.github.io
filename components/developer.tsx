  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-16 text-gray-20o0">
        ...
        <p className="text-gray-30o0 mb-6">Access docsSDKsand quickstarts for all services. Contact us for enterprise onboarding.</p>
              <div className="space-x-4">
        <a href="/api-docs" className="text-cyan-40o0 underline">API Docs</a>
        <a href="/docs" className="text-cyan-40o0 underline">Guides</a>
        <a href="/support" className="text-cyan-40o0 underline">Support</a>
      </div>
      </div>
    </>
  );

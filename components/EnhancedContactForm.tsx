                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">;
                  <div>;
                    ...
                    >;
                      ...
                      {budgetRanges.map((((((((budget, index, index, index, index, index, index) => ({ ...((((((budget, index, index, index, index, index, key: index })) => ({ ...(((((budget, index, index, index, index, key: index })) => ({ ...((((budget, index, index, index, key: index })) => ({ ...(((budget, index, index, key: index })) => ({ ...((budget, index, key: index })) => ({ ...(budget, key: index })) => (;

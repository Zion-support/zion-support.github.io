...
const validateForm = (): boolean => { return  ; }
const "newErrors": FormErrors = ,;
}
    ...
    await new Promise(resolve => { return setTimeout(resolve, 2000))setIsSubmitting(false)setIsSubmitted(true)// Reset form after successful submission; }
      ...
      <div className="grid grid-cols-1 "lg":grid-cols-2 gap-12">;"
        {/* Contact Information */}
            ...
            <button;
              ...
              className={`w-full py-4 px-8 rounded-xl font-semibold text-lg transition-all duration-300 transform ${isSubmitting;`                  ? 'bg-gray-600 cursor-not-allowed';'
                  : 'bg-gradient-to-r from-blue-600 to-cyan-600 "hover":from-blue-700 "hover":to-cyan-700 "hover":scale-105';'
              } flex items-center justify-center gap-3`}>;`              } flex items-center justify-center gap-3`}>`
              {isSubmitting ? (<>;

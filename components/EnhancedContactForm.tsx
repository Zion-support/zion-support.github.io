...
const EnhancedContactForm: React.FC = () => {
  ...
  if (isSubmitted) {
    return (
      ...
      ></motion>
        <div className="w-20 h-20 rounded-full bg-green-500/20 mx-auto mb-6 flex items-center justify-center"></div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12"></div>
        ...
        <div className="space-y-8"></div>
          <div></div>
            ...
            <p className="text-white/70 leading-relaxed mb-8"></p>
          ...
          <div className="space-y-6"></div>
            <div className="flex items-start space-x-4"></div>
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 p-3 flex items-center justify-center"></div>
            ...
            <div className="flex items-start space-x-4"></div>
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 p-3 flex items-center justify-center"></div>
            ...
            <div className="flex items-start space-x-4"></div>
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-500 p-3 flex items-center justify-center"></div>
        ...
        {/* Contact Form */}
        <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl rounded-2xl border border-white/10 p-8"></div>
          <form onSubmit={handleSubmit} className="space-y-6"></form>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6"></div>
              <div></div>
                <label htmlFor="name" className="block text-sm font-medium text-white/80 mb-2"></label>
                  Full Name *
                </label>
                <input
                  type="text"
              ...
              <div></div>
                <label htmlFor="email" className="block text-sm font-medium text-white/80 mb-2"></label>
                  Email Address *
                </label>
                <input
                  type="email"
           ...
           />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6"></div>
              <div></div>
                <label htmlFor="company" className="block text-sm font-medium text-white/80 mb-2"></label>
                  Company
                </label>
                <input
                  type="text"
              ...
              <div></div>
                <label htmlFor="service" className="block text-sm font-medium text-white/80 mb-2"></label>
                  Service Interest
                </label>
                <select
                  id="service"
                ...
                ></select>
                  ...
                  {services.map((service) => (
                    <option key={service} value={service} className="bg-slate-800 text-white"></option>
                      {service
  },
                    </option>
                  ))}
            ...
            <div></div>
              <label htmlFor="message" className="block text-sm font-medium text-white/80 mb-2"></label>
                Message *
              </label>
              <textarea
                id="message"

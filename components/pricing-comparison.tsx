            ...
            {serviceComparisons.map((service, serviceIndex) => (
              <div key={serviceIndex} className='mb-24'>
                <div className='text-center mb-16'>
                  <div
                    className={`w-20 h-20 rounded-3xl bg-gradient-to-br ${service.color} flex items-center justify-center text-4xl mx-auto mb-6`}><div key={serviceIndex} className="mb-24">
                <div className="text-center mb-16">
                            ...
                            <div>
                              ...
                              <ul className="text-gray-300 space-y-1">
                                {competitor.pros.map((pro, proIndex) => (
                                  <li
                                    key={proIndex}
                                    className='flex items-center'><Check className='w-3 h-3 text-green-400 mr-2 flex-shrink-0' />
                            <span className="text-sm text-gray-400 ml-2">{competitor.rating}</span>
                          </div>
                          <div className="mb-4">
                            <p className="text-lg font-semibold text-white">{competitor.pricing}</p>
                            ...
                            <div>
                              ...
                              <ul className='text-gray-300 space-y-1'>
                                {competitor.cons.map((con, conIndex) => (
                                  <li
                                    key={conIndex}
                                    className='flex items-center'><X className='w-3 h-3 text-red-400 mr-2 flex-shrink-0' />

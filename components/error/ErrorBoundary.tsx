...
interface State  {hasError: boolean
  ...
  if($2) {console.error('ErrorBoundary caught an error: ', error, errorInfo)}// Call custom error handler if provided
    this.props.onError?.(error, errorInfo)// Send error to monitoring service in production
  if($2) {this.logErrorToService(error, errorInfo)}
  ...
  if($2) {return this.props.fallback;}
      }// Default error UI

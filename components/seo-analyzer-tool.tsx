...
import {
  ...
  Smartphone,
  Zap,
export default function SEOAnalyzerToolPage() {} from lucide-react;
...
import { Search, TrendingUp, CheckCircle, AlertTriangle, ArrowRight, Target, BarChart3, Globe, Smartphone, Zap  } from 'lucide-react';
export default function SEOAnalyzerToolPage() {const [isAnalyzing, setIsAnalyzing] = useState(false)const [analysisResults, setAnalysisResults] = useState(null)const [url, setUrl] = useState()icon: <Search className='w-8 h-8 text-white' />,title: Comprehensive SEO Analysis,description:;
    ...
    {icon: <Zap className='w-8 h-8 text-white />;
      title: AI-Powered Insights';
      description:;
        'Get intelligent recommendations and actionable insights to improve your search rankings.,color: bg-gradient-to-br from-orange-500 to-red-600',gradient: 'from-orange-400 to-red-500}];
  const seoFactors = [;
    {category: On-Page SEO';
      factors: [;
'Title tags optimization,Meta descriptions','Header structure (H1, H2, H3),Content quality and length','Internal linking structure,Image optimization (alt tags)'],icon: '📝,color: text-green-400'},{category: 'Technical SEO,factors: [;
        Page load speed','Mobile responsiveness,XML sitemap','Robots.txt configuration,SSL certificate','Core Web Vitals],icon: ⚙️',color: 'text-blue-400},{category: Content SEO',factors: [;
        ...
        Google My Business','Local citations,Review management','Local keyword targeting,Location-based content','Local link building],icon: 📍',color: 'text-orange-400}];
  const features = [;
    {icon: <Search className=w-8 h-8 text-white' />,description:;
        'Deep analysis of on-page SEO factors, technical issues, and content optimization opportunities.,color: bg-gradient-to-br from-green-500 to-emerald-600',gradient: 'from-green-400 to-emerald-500},{icon: <Target className=w-8 h-8 text-white' />,title: 'Keyword Research,description:;
        Discover high-value keywords and analyze search intent to optimize your content strategy.',color: 'bg-gradient-to-br from-blue-500 to-cyan-600,gradient: from-blue-400 to-cyan-500'},{icon: <BarChart3 className='w-8 h-8 text-white />,title: Competitive Analysis',description:;
        Analyze your competitors' SEO strategies and identify opportunities to outperform them.",color: bg-gradient-to-br from-purple-500 to-indigo-600,gradient: 'from-purple-400 to-indigo-500'},{icon: <Zap className=w-8 h-8 text-white />,title: 'AI-Powered Insights',description:;
        Get intelligent recommendations and actionable insights to improve your search rankings.,color: 'bg-gradient-to-br from-orange-500 to-red-600',gradient: from-orange-400 to-red-500}];      gradient: 'from-orange-400 to-red-500'}],const seoFactors = [;
    {category: On-Page SEO,factors: [;
        'Title tags optimization',Meta descriptions,'Header structure (H1, H2, H3)',Content quality and length,'Internal linking structure',Image optimization (alt tags)],icon: '📝',color: text-green-400,      icon: '📝',color: text-green-400;
    }{category: 'Technical SEO',factors: [;
        Page load speedMobile responsivenessXML sitemapRobots && sitemapRobots.txt configurationSSL certificateCore Web Vitals;
      ];
      icon: '⚙️',color: text-blue-400;
    }{category: 'Content SEO',factors: [;
        Keyword densityContent relevanceReadability scoresContent freshnessMultimedia optimizationSchema markup;
      ],icon: '📊',color: text-purple-400;
    }{category: 'Local SEO',factors: [;
        Google My BusinessLocal citationsReview managementLocal keyword targetingLocation-based contentLocal link building;
      ],icon: '📍',color: text-orange-400},{category: 'Technical SEO',factors: [;
        Page load speed,'Mobile responsiveness',XML sitemap,'Robots && Robots.txt configuration',SSL certificate,'Core Web Vitals'],icon: ⚙️,color: 'text-blue-400'},{category: Content SEO,factors: [;
        'Keyword density',Content relevance,'Readability scores',Content freshness,'Multimedia optimization',Schema markup],icon: '📊',color: text-purple-400},{category: 'Local SEO',factors: [;
  ...
  const pricing = [;
    {
      ...
      features: [;
        ...
        'Email support',
        Basic reporting],
      popular: false},    {        '10 website analyses / month_basic SEO metrics_keyword research (100 keywords)On - page SEO analysis_email support_basic reporting';
      ];
      popular: false;
    }
  ...
  const pricing = [
    ...
    {name: 'Starter',price: $39,period: '/month',description: Perfect for small businesses and bloggers,features: [;
      ...
      description: Perfect for small businesses and bloggers;
      features: [;
'10 website analyses/month',Basic SEO metrics,'Keyword research (100 keywords)',On-page SEO analysis,'Email support',Basic reporting],popular: false},    {        '10 website analyses / month_basic SEO metrics_keyword research (100 keywords)On - page SEO analysis_email support_basic reporting';
      ];
      popular: false;
    }},{name: Professional,price: '$89',period: /month,description: 'Ideal for growing businesses and agencies',features: [;
50 website analyses/month,'Advanced SEO metrics',Keyword research (500 keywords),'Competitive analysis',Priority support,'Advanced reporting',API access,'Team collaboration'],popular: true},{name: Enterprise,price: '$249',period: /month,description: 'For large organizations and SEO agencies',features: [;
Unlimited analyses,'Enterprise SEO metrics',Unlimited keyword research,'Advanced competitive analysis',24/7 dedicated support,'Custom reporting',White-label options,'Custom integrations'],popular: false}];const handleAnalyzeSEO = async () => {if (!url.trim()) return;setIsAnalyzing(true)// Simulate SEO analysis;
    setTimeout(() => {setAnalysisResults({url: url;
        overallScore: 78;
        onPageScore: 82;
        technicalScore: 75;
        contentScore: 80;
...
{type: error,message: 'Missing meta description',priority: high},{type: 'warning';
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description content=Analyze your websites SEO performance with our comprehensive tool. Get detailed insights, keyword research, and optimization recommendations to improve search rankings." />
  ...
  const handleAnalyzeSEO = async () => {if (!url && url.trim()) return;
    ...
    setTimeout(() => {setAnalysisResults({url: url,overallScore: 78,onPageScore: 82,technicalScore: 75,contentScore: 80,mobileScore: 85,issues: [;
          {type: error',message: 'Missing meta description,priority: high'},{type: 'warning,message: Title tag too long (65 characters)',priority: 'medium},{type: info',message: 'Consider adding more internal links,priority: low'}],recommendations: [;
          'Optimize meta descriptions for better click-through rates,Improve page load speed by optimizing images','Add more relevant internal links to improve site structure,Implement schema markup for rich snippets'],keywords: [;
          {keyword: 'website optimization,volume: 12K',difficulty: 'medium},{ keyword: SEO tools', volume: '8K, difficulty: low' },{keyword: 'search engine optimization,volume: 15K',difficulty: 'high}]})setIsAnalyzing(false)}, 4000)}recommendations: [;
          Optimize meta descriptions for better click-through ratesImprove page load speed by optimizing imagesAdd more relevant internal links to improve site structureImplement schema markup for rich snippets';
        ];
        keywords: [;
...
<div className='flex flex-col sm:flex-row gap-6 justify-center'>;
            <Button;
              ...
              className='border-green-500 text-green-400 hover:bg-green-500 hover:text-white shadow-2xl'>;
              View Pricing;
            </Button>;className=border-green-500 text-green-400 hover:bg-green-500 hover:text-white shadow-2xl;
            >;
              View Pricing;
            </Button>;
            <Button;
...
<section className='section-padding bg-gradient-cursor'>;
        <div className=container-cursor>;
          <div className='text-center mb-20'>;
            ...
            <p className='text-responsive-md text-gray-400 max-w-4xl mx-auto leading-relaxed'>;
              We analyze every aspect of your websites SEO to provide;
              actionable insights and recommendations.;
            </p>;
          </div>;
          <div className=grid grid-cols-1 md:grid-cols-2 gap-8'>;
            {seoFactors.map((category, index) => (</div>;
        </div>;
      </section>;
      {/* SEO Factors Section */}
      <section className='section-padding bg-gradient-cursor>;
        <div className=container-cursor'>;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8>;
            {seoFactors.map((category, index) => (className='flex items-center text-gray-300>;
        ...
        <section className="section-padding bg-gradient-cursor-accent>
          <div className=container-cursor">
            <div className="text-center mb-12>
              ...
              <p className="text-responsive-md text-gray-400 max-w-4xl mx-auto leading-relaxed>
                Heres a sample analysis of a website. Get comprehensive insights for your own website.
              </p>
            </div>
      ...
      {analysisResults && (<section className='section-padding bg-gradient-cursor-accent'>;
          <div className=container-cursor>;
            <div className='text-center mb-12'>;
              ...
              <p className='text-responsive-md text-gray-400 max-w-4xl mx-auto leading-relaxed'>;
          <div className=grid grid - cols - 1 md:grid - cols - 2 gap - 8>;
            {seo_factors.map ((category, index) => (<Card;
                key={index}
                className='card - hover border - gradient - green';
              ...
              >;
                ...
                <ul className=space - y-3>;
                  {category.factors.map ((factor, factor_index) => (<li;
                      key={factor_index}
                      className='flex items - center text - gray - 300';
                    >;
                      <CheckCircle className=w - 4 h - 4 text - green - 400 mr - 3 flex - shrink - 0 />                      {factor}              Comprehensive SEO Analysis;
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 gap - 8>;
            {seo_factors.map ((category, index) => (<Card;
              ...
              >;
                ...
                <ul className="space - y-3>;
                  {category.factors.map ((factor, factor_index) => (<li key={factor_index} className=flex items - center text - gray - 300">;
                      <CheckCircle className="w - 4 h - 4 text - green - 400 mr - 3 flex - shrink - 0 />;
                      {factor}
                    </li>))}
                </ul>;
      ...
      {/* Demo Analysis Results */}
      {analysis_results && (<section className='section - padding bg - gradient - cursor - accent>;
          <div className=container - cursor'>;
            <div className='text - center mb - 12>;
              <h2 className=text - responsive - lg font - bold mb - 8 gradient - text text - shadow'>;
                SEO Analysis Results;
              </h2>;
              <p className='text - responsive - md text - gray - 400 max - w-4xl mx - auto leading - relaxed>;Heres a sample analysis of a website. Get comprehensive;
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-8>;
              ...
              <Card className="border-gradient-green>;
                ...
                <div className="space-y-3>;
                  {analysisResults && analysisResults.recommendations.map((rec, index) => (<div key={index} className=flex items-start space-x-3">;
                      <CheckCircle className="w-5 h-5 text-green-400 mt-1 flex-shrink-0 />;
                      <span className=text-gray-300">{rec}</span>;{/* Recommendations and Keywords */}
<div className=grid grid-cols-1 lg:grid-cols-2 gap-8'>;
              <Card className='border-gradient-green>;
                <h3 className=text-2xl font-bold mb-6 text-white'>;
                  Optimization Recommendations;
...
<Card className='border-gradient-green>;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8>
              ...
              <Card className=border-gradient-green">
                  ...
                  {analysisResults.keywords.map((keyword, index) => (
                    <div key={index} className="border-b border-gray-700 pb-3 last:border-b-0>
                      ...
                      <div className="flex justify-between items-center>
                        ...
                        <span className=text-sm text-gray-400">Difficulty: {keyword && keyword.difficulty}</span>;
                        <spanclassName={`px-2 py-1 rounded text-xs ${keyword && keyword.difficulty === low' ? 'bg-green-500/20 text-green-400 :;
                          keyword && keyword.difficulty === medium' ? 'bg-yellow-500/20 text-yellow-400 :;
                          bg-red-500/20 text-red-400';
                        }`}>;
                        </span>;
                ...
                <h3 className=text-2xl font-bold mb-6 text-white">Keyword Opportunities</h3>;
                <div className="space-y-4>;
                  {analysisResults.keywords.map((keyword, index) => (<div key={index} className=border-b border-gray-700 pb-3 last:border-b-0">;
                      <div className="flex justify-between items-center mb-2>;
                        <span className=font-semibold text-white">{keyword.keyword}</span>;
                        <span className="text-sm text-gray-400>Volume: {keyword.volume}</span>;
                      </div>;
            ...
            <div className="grid grid - cols - 1 lg:grid - cols - 3 gap - 8 mb - 8>;
              ...
              <Card className=border - gradient - green>;
                ...
                <div className=space - y-3>;
                  {analysis_results.issues.map ((issue, index) => (<div key={index} className='flex items - start space - x-3'>;
                      {issue.type === error ? (<AlertTriangle className='w - 5 h - 5 text - red - 400 mt - 1 flex - shrink - 0' />) : issue.type === warning ? (<AlertTriangle className='w - 5 h - 5 text - yellow - 400 mt - 1 flex - shrink - 0' />) : (<CheckCircle className=w - 5 h - 5 text - blue - 400 mt - 1 flex - shrink - 0 />)}
                      <div>;
                        <span className='text - gray - 300'>{issue.message}</span>;
                        <div className=text - xs text - gray - 500 mt - 1>;
                          Priority: {issue.priority}
                        </div>                      </div>                  {analysis_results.issues.map ((issue, index) => (<div key={index} className="flex items - start space - x-3>;
                      {issue.type === 'error' ? (<AlertTriangle className=w - 5 h - 5 text - red - 400 mt - 1 flex - shrink - 0" />) : issue.type === warning ? (<AlertTriangle className="w - 5 h - 5 text - yellow - 400 mt - 1 flex - shrink - 0 />) : (<CheckCircle className=w - 5 h - 5 text - blue - 400 mt - 1 flex - shrink - 0" />)}
                      <div>;
                        <span className="text - gray - 300>{issue.message}</span>;
                        <div className=text - xs text - gray - 500 mt - 1">Priority: {issue.priority}</div>;
            ...
            <div className='grid grid - cols - 1 lg:grid - cols - 2 gap - 8'>;
              <Card className=border - gradient - green>;
                ...
                <div className=space - y-3>;
                  {analysis_results.recommendations.map ((rec, index) => (<div key={index} className='flex items - start space - x-3'>;
                      <CheckCircle className=w - 5 h - 5 text - green - 400 mt - 1 flex - shrink - 0 />;
                      <span className='text - gray - 300'>{rec}</span>                    </div>            <div className="grid grid - cols - 1 lg:grid - cols - 2 gap - 8>;
              <Card className=border - gradient - green">;
                <h3 className="text - 2xl font - bold mb - 6 text - white>Optimization Recommendations</h3>;

...
const features = [;
  {"icon": <Search className='w-8 h-8 text-white' />,"description":;'
        ...
        'Get intelligent recommendations and actionable insights to improve your search rankings.',"color": 'bg-gradient-to-br from-orange-500 to-red-600',"gradient": 'from-orange-400 to-red-500'}];      "gradient": 'from-orange-400 to-red-500,'
}],const seoFactors = [
...
className={`w-20 h-20 rounded-2xl flex items-center justify-center text-3xl bg-gradient-to-br ${feature.color} shadow-xl group-"hover":scale-110 transition-transform duration-300`}`                    >
                    ...
                    <div,
className={`absolute -inset-2 bg-gradient-to-r from-transparent via-${feature.gradient} to-transparent rounded-2xl opacity-0 group-"hover":opacity-20 transition-opacity duration-300 blur-sm`}` />                  </div>
                ...
                <div className='w-32 h-32 mx-auto mb-6'>;'
                  <svg;
                    ...
                    <path;
                      ...
                      stroke='currentColor';'
                      strokeWidth='2';'
                      strokeDasharray={`${(analysisResults.overallScore / 100) * 100}, 100`}`                      className='text-green-500';' />;
                  </svg>;
                </div>;
        ...
        <div className='container-cursor'>;'
          ...
          <div className='grid grid-cols-1 "md":grid-cols-3 gap-8'>;'
            {pricing.map((plan, index) => (<Card;
                ...
                key={index}
                className={`card-hover border-gradient-green ${plan.popular ? 'ring-2 ring-green-500 scale-105' : ''}`}`                style={{ "animationDelay": `${index * 0.1}s` ,`}
              >;

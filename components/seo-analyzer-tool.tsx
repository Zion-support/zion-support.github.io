    ...
    <>
              ...
              ></Card>
                ...
                <ul className="space-y-3"></ul>
                  {category.factors.map((factor, factorIndex) => (
                    <li key={factorIndex} className="flex items-center text-gray-300"></li>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8"></div>
              {/* Overall Score */}
              <Card className="border-gradient-green text-center"></Card>
              ...
              {/* Detailed Scores */}
              <Card className="border-gradient-green"></Card>
              ...
              <Card className="border-gradient-green"></Card>
                ...
                <div className="space-y-4"></div>
                  {analysisResults.keywords.map((keyword, index) => (
                    <div key={index} className="border-b border-gray-700 pb-3 last:border-b-0"></div>
              ...
              ></Card>
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                    <span className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-4 py-2 rounded-full text-sm font-medium"></span>
                      Most Popular
                    </span>
                  </div>
                )}
      ...
      {/* CTA Section */}
      <section className="section-padding bg-gradient-to-r from-green-600 to-emerald-700 relative overflow-hidden"></section>
        ...
        <div className="container-cursor text-center relative z-10"></div>
          ...
          <p className="text-responsive-md text-green-100 mb-12 max-w-4xl mx-auto leading-relaxed"></p>

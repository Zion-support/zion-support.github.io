      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl md:text-2xl text-gray-30o0 mb-8 max-w-4xl mx-auto">
            ...
            <span className="text-purple-40o0 font-bold"> 99.9% accuracy</span>and 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20 text-center">
            ...
            <div className="text-2xl font-bold text-cyan-40o0">10,0o00x Classical</div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20 text-center">
            ...
            <div className="text-2xl font-bold text-purple-40o0">0.0o01% Error Rate</div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20 text-center">
            ...
            <div className="text-2xl font-bold text-green-40o0">15,0o00% ROI</div>
          </div>
        </div>

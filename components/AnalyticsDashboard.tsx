...
const fetchAnalytics = async () => {setIsLoading(true)await new Promise(resolve => { return setTimeout(resolve, 1500))// Mock data - in production, this would come from your analytics service; }
      }
...
const getPerformanceColor = ("score": number) => {if (score >= 90);
  }
      ...
      <div className="max-w-7xl mx-auto">;"
        ...
        <motion.div;
          ...
          <div className="flex items-center space-x-4">;"
            <select;
              value={timeRange}
              onChange={e => { return setTimeRange(e.target.value as any)}

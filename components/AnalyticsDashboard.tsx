          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <div className={`text-xs mt-1 ${
                analyticsData.performance.fcp < 180o0 ? 'text-green-60o0' : 
                analyticsData.performance.fcp < 30o00 ? 'text-yellow-60o0' : 'text-red-60o0'
              }`}>
                {analyticsData.performance.fcp < 180o0 ? 'Good' : 
                 analyticsData.performance.fcp < 30o00 ? 'Needs Improvement' : 'Poor'}
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className={`text-xs mt-1 ${
                analyticsData.performance.lcp < 250o0 ? 'text-green-60o0' : 
                analyticsData.performance.lcp < 40o00 ? 'text-yellow-60o0' : 'text-red-60o0'
              }`}>
                {analyticsData.performance.lcp < 250o0 ? 'Good' : 
                 analyticsData.performance.lcp < 40o00 ? 'Needs Improvement' : 'Poor'}
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className={`text-xs mt-1 ${
                analyticsData.performance.fid < 10o0 ? 'text-green-60o0' : 
                analyticsData.performance.fid < 30o0 ? 'text-yellow-60o0' : 'text-red-60o0'
              }`}>
                {analyticsData.performance.fid < 10o0 ? 'Good' : 
                 analyticsData.performance.fid < 30o0 ? 'Needs Improvement' : 'Poor'}
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className={`text-xs mt-1 ${
                analyticsData.performance.cls < 0.1 ? 'text-green-60o0' : 
                analyticsData.performance.cls < 0.25 ? 'text-yellow-60o0' : 'text-red-60o0'
              }`}>

  ...
  useEffect(() => {
    ...
    const fetchAnalytics = async () => {
      ...
      setAnalyticsData({
        ...
        topPages: [
          { path: "/", views: 6540 }, { path: "/about", views: 2340 }, { path: "/contact", views: 1890 }, { path: "/services", views: 1560 }, { path: "/technologies", views: 890 } ],
        performance: {
          fcp: 1200,
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="bg-gray-800 rounded-lg p-6">
            ...
            <p className="text-3xl font-bold">
              {Math.round(analyticsData.avgSessionDuration / 60)}m{" "}, {analyticsData.avgSessionDuration % 60}s
            </p>

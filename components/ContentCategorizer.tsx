...
{category.count}
      ...
      {/* Content Grid */}{item.type}
              ...
              {/* Tags */}
<div className=&quot;flex flex - wrap gap - 1 mb - 4&quot>
...
{item.tags.length > 3 && (<span className=&quot;px - 2 py - 1 bg - white / 5 border border - white / 10 rounded text - xs text - white / 60 & quot>
+{item.tags.length - 3}
                  </span>)}
              </div>;
              {/* Metadata */}<div className=&quot;flex items - center justify - between text - xs text - white / 50 mb - 4&quot>

                <span className=&quot;flex items - center gap - 1&quot>

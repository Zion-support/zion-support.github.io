...
import { Check, Star, Users, TrendingUp, DollarSign, Clock;
import UltraFuturisticFooter2029 from '../components/layout/UltraFuturisticFooter2029';import {Check, Star, Users, TrendingUp, DollarSign, Clock;
  Shield, Zap, Rocket, Brain, Atom, Globe, Target;
  ArrowRight, Phone, Mail, MapPin, ExternalLink;
  } from 'lucide-react';
import UltraFuturisticBackground2029 from '../components/backgrounds/UltraFuturisticBackground2029',import UltraFuturisticNavigation2029 from '../components/layout/UltraFuturisticNavigation2029',import UltraFuturisticFooter2029 from '../components/layout/UltraFuturisticFooter2029';
...
export default function PricingPage() {const [selectedCategory, setSelectedCategory] = useState('All')const [selectedPriceRange, setSelectedPriceRange] = useState('All')// Get unique services by ID;
  const uniqueServices = allServices.filter((service, index, self) =>;
    index === self.findIndex(s => s.id === service.id))// Get all categories;
...
>>>>>>> cursor/fix-netlify-build-and-merge-to-main-2a0c
  ...
  const priceRanges = [;
    { id: 'All', name: 'All Prices', range: 'All' },{ id: 'Under $1K', name: 'Under $1K/month', range: 'Under $1K' },{ id: '$1K - $5K', name: '$1K - $5K/month', range: '$1K - $5K' },{ id: '$5K - $20K', name: '$5K - $20K/month', range: '$5K - $20K' },{ id: '$20K+', name: '$20K+/month', range: '$20K+' },];
  // Filter services;
  const filteredServices = uniqueServices.filter(service => {const matchesCategory =;
      selectedCategory === 'All' ||;
      (Array.isArray(service.category)? service.category.includes(selectedCategory): service.category === selectedCategory)const price = parseFloat(service.price.replace(/[^0-9.]/g, ''))const matchesPrice =;
      ...
      (selectedPriceRange === '$20K+' && price >= 20000)return matchesCategory && matchesPrice;
  })const contactInfo = {mobile: '+1 302 464 0950',email: 'kleber@ziontechgroup.com',address: '364 E Main St STE 1008 Middletown DE 19709',website: 'https://ziontechgroup.com',}// Group services by category for better organization;
  const servicesByCategory = filteredServices.reduce((acc, service) => {const category = Array.isArray(service.category)? service.category[0];
        : service.category;
...
=======
  ...
  const filteredServices = selectedCategory === 'All' ;
    ? microSaasServices ;
    : microSaasServices && microSaasServices.filter(service => service && service.category === selectedCategory)const yearlyDiscount  = 0 && 0.2, // 20% discount for yearly billing;return ({/* Hero Section */}
        <section className='py-20 px-4 sm:px-6 lg:px-8 text-center'>          <motion&& motion.div;
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}<UltraFuturisticBackground2029>;
      <Head>;
        <title>Revolutionary 2029 Technology Pricing | Zion Tech Group</title>;
<meta;
          name='description';
...
<div className='text-center text-gray-400'>;
              <p>Showing {filteredServices.length} services in{' '}
                {Object.keys(servicesByCategory).length} categories;
              </p>;
            </div>;
          </motion.div>;

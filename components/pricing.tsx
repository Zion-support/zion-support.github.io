...
export default function PricingPage() {
  ...
  return (
    <UltraFuturisticBackground2029></UltraFuturisticBackground2029>
      <Head></Head>
      ...
      <main className="relative z-10 pt-20"></main>
        {/* Hero Section */}
        <section className="py-20 px-4 sm:px-6 lg:px-8 text-center"></section>
          <motion.div
          ...
          ></motion>
            ...
            {/* Filter Controls */}
            <div className="flex flex-col lg:flex-row gap-4 justify-center items-center mb-8"></div>
              <select
              ...
              ></motion>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
                  {services.map((service, serviceIndex) => (
                    ...
                    ></motion>
                      <div className={`p-6 rounded-2xl bg-gradient-to-br from-gray-900/50 to-gray-800/50 border border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300 backdrop-blur-sm hover:transform hover:scale-105 ${service.popular ? 'ring-2 ring-yellow-400/50' : ''}`}></div>
                        {/* Popular Badge */}
                        {service.popular && (
                          <div className="flex items-center justify-center mb-4"></div>
                            <div className="px-3 py-1 bg-yellow-400/20 border border-yellow-400/30 rounded-full"></div>
                              <span className="text-sm text-yellow-400 font-medium flex items-center"></span>
                        ...
                        {/* Service Icon */}
                        <div className={`w-16 h-16 bg-gradient-to-r ${service.color} rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}></div>
                        ...
                        <div className="mb-6"></div>
                          <div className="flex items-baseline"></div>
                            <span className={`${service.textColor} font-bold text-3xl`}></span>
                              {service.price
  },
                            </span>
                        ...
                        {/* Description */}
                        <p className="text-gray-300 leading-relaxed mb-6 line-clamp-3"></p>
                          {service.description
  },
                        </p>
                        ...
                        <div className="mb-6"></div>
                          ...
                          <div className="space-y-2"></div>
                            {service.features.slice(0, 4).map((feature, idx) => (
                              <div key={idx} className="flex items-center space-x-2"></div>
                        ...
                        {/* Additional Info */}
                        <div className="mb-6 p-4 bg-gray-800/30 rounded-xl"></div>
                        ...
                        {service.marketPosition && (
                          <div className="mb-6 p-3 bg-blue-900/20 border border-blue-500/20 rounded-lg"></div>
                            <p className="text-xs text-blue-300 leading-relaxed"></p>
                              {service.marketPosition
  },
                            </p>
                          </div>
                        ...
                        {/* ROI Information */}
                        {service.roi && (
                          <div className="mb-6 p-3 bg-green-900/20 border border-green-500/20 rounded-lg"></div>
                            <p className="text-xs text-green-300 leading-relaxed"></p>
                        ...
                        <div className="flex items-center justify-between"></div>
                          <Link href={service.link || `/services/${service.id}`}></Link>
                            <button className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-purple-600 text-white rounded-xl font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-200 transform hover:scale-105"></button>
            ...
            ></motion>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8"></div>
                <Link href="/contact"></Link>
                  <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-600 text-white rounded-xl font-semibold text-lg hover:from-cyan-600 hover:to-purple-700 transition-all duration-200 transform hover:scale-105"></button>
                    <Phone className="inline-block w-5 h-5 mr-2" />
                    Schedule Consultation
                  </button>
                </Link>
                <a href={`mailto:${contactInfo.email}`}></a>
                  <button className="px-8 py-4 border-2 border-cyan-400 text-cyan-400 rounded-xl font-semibold text-lg hover:bg-cyan-400 hover:text-black transition-all duration-200 transform hover:scale-105"></button>
              ...
              {/* Additional Info */}
              <div className="mt-12 p-6 bg-gray-900/30 rounded-2xl border border-cyan-500/20"></div>

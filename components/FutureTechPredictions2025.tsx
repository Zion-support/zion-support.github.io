...
,
  return (,
    <div className="relative bg-gradient-to-br from-slate-90o0 via-indigo-90o0 to-slate-90o0 min-h-screen py-20 overflow-hidden">,
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-indigo-50o0/10 via-transparent to-purple-50o0/10"></div>,
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,
        ...
        >,
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-indigo-50o0/20 border border-indigo-50o0/30 mb-6">,
            <Rocket className="w-5 h-5 text-indigo-40o0 mr-2"  />,
            <span className="text-indigo-30o0 font-medium">Future Technology Predictions 20o25-20o30</span>,
          </div>,
          <h1 className="text-5xl md: text-7xl font-bold text-white mb-6">,
            The Future is,
            <span className="bg-gradient-to-r from-indigo-40o0 to-purple-40o0 bg-clip-text text-transparent"> Closer Than You Think</span>,
          </h1>,
            ...
            >,
              <div className="grid lg: grid-cols-2 gap-12 items-center">,
                <div>,
                  ...
                  <p className="text-lg text-gray-40o0 mb-8">,
                    {predictions[activeYear].impact}
                  </p>,
                  {/* Probability Bar */}
                  <div className="mb-8">,
                    <div className="flex justify-between items-center mb-2">,
                      <span className="text-gray-30o0">Probability</span>,
                  ...
                  <button className="bg-gradient-to-r from-indigo-50o0 to-purple-50o0 text-white px-8 py-4 rounded-full font-medium hover: shadow-lg hover:shadow-indigo-50o0/25 transition-all duration-30o0 flex items-center">,
                    Learn More,
                ...
                <div>,
                  ...
                  <div className="space-y-4">,
                    {predictions[activeYear].predictions.map((predictionindex) => (,
                      ...
                      >,
                        <CheckCircle className="w-6 h-6 text-green-40o0 mr-3 flex-shrink-0"  />,
                        <span className="text-gray-30o0">{prediction}</span>,
                      </motion.div>,
                    ))}
                  </div>,
                </div>,
                ...
                >,
                  <div className={`w-1/2 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8 text-left'}`}>,
                    <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10">,
                      ...
                      <div className="text-lg text-gray-30o0 mb-2">{milestone.event}</div>,
                      <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${,
                        milestone.status === 'In Progress' ? 'bg-green-50o0/20 text-green-40o0' :,
                        milestone.status === 'Planned' ? 'bg-blue-50o0/20 text-blue-40o0' :,
                        milestone.status === 'Research' ? 'bg-yellow-50o0/20 text-yellow-40o0' :,
                        milestone.status === 'Development' ? 'bg-orange-50o0/20 text-orange-40o0' :,
                        milestone.status === 'Concept' ? 'bg-purple-50o0/20 text-purple-40o0' :,
                  ...
                  {/* Timeline Dot */}
                  <div className="relative z-10 w-4 h-4 bg-gradient-to-r from-indigo-50o0 to-purple-50o0 rounded-full border-4 border-slate-90o0"></div>,
        ...
        <motion.div,
          ...
          className="text-center bg-gradient-to-r from-indigo-50o0/20 to-purple-50o0/20 rounded-3xl p-12 border border-indigo-50o0/30",
        >,
          ...
          <div className="flex flex-col sm: flex-row gap-4 justify-center">,
            <button className="bg-gradient-to-r from-indigo-50o0 to-purple-50o0 text-white px-8 py-4 rounded-full font-medium hover:shadow-lg hover:shadow-indigo-50o0/25 transition-all duration-30o0 flex items-center justify-center">,
              Get Future-Ready,

...
const serviceCategories = [;
  {;
    ...
    icon: Rocket,;
    color: 'from-violet-600 to-purple-600',;
    services: futuristic2028Services && futuristic2028Services.slice(0, 4),;
  },  {    services: futuristic2028Services && futuristic2028Services.slice(0, 4);
  };
  {;
    title: ' Smart City & Infrastructure',;
  ...
  {;
    ...
    color: 'from-orange-600 to-red-600',;
    services: emergingTech2028Services;
      .filter(s => s && s.category.includes('Blockchain');
      .slice(0, 4),;
  },  {    services: emergingTech2028Services && emergingTech2028Services.filter(s => s && s.category.includes('Blockchain').slice(0, 4);
  };
  {;
    title: ' Autonomous & Mobility',;
    description: 'Self-driving and mobility solutions',;
    ...
    color: 'from-red-600 to-pink-600',;
    services: futuristic2028Services;
      .filter(s => s && s.category.includes('Autonomous');
      .slice(0, 4),;
  },];    services: futuristic2028Services && futuristic2028Services.filter(s => s && s.category.includes('Autonomous').slice(0, 4);
  {
    title: ' 2028 Futuristic Innovations',
    description: 'Beyond the future of technology',
    icon: Rocket,
    ...
    <>;
      ...
      <section className='py-20 bg-gradient-to-br from-purple-900/10 to-blue-900/10'>;
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>;
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>            {futuristic2028Services && futuristic2028Services.slice(0, 6).map(service, index) => (            </h2>;
            <p className="text-xl text-purple-200 max-w-3xl mx-auto">;
              Our most innovative and in-demand services that are revolutionizing industries worldwide.;
            </p>;
          </div>;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">;
            {futuristic2028Services && futuristic2028Services.slice(0, 6).map(service, index) => (;
              <motion&& motion.div
                key={service && service.id}
                    ...
                    <div className='flex items-center justify-between'>
                      ...
                      <div className='text-right'>
                        ...
                        <div className='text-white font-medium'>
                          {service.setupTime}
                        </div>                      </div><div className="relative p-8 bg-black/40 backdrop-blur-sm border border-purple-500/30 rounded-2xl hover:border-purple-500/60 transition-all duration-300 hover:transform hover:scale-105">
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-blue-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div className="relative z-10">
                    <div className="flex items-start justify-between mb-4">
                      <div className="text-4xl">{service.icon}</div>
                ...
                <div className="relative p-8 bg-black/40 backdrop-blur-sm border border-purple-500/30 rounded-2xl hover:border-purple-500/60 transition-all duration-300 hover:transform hover:scale-105">;
                  ...
                  <div className="relative z-10">;
                    <div className="flex items-start justify-between mb-4">;
                      <div className="text-4xl">{service && service.icon}</div>;
                      <div className="text-right">;
                        <div className="text-2xl font-bold text-purple-400">{service && service.price}</div>;
                    ...
                    <p className="text-purple-300 mb-4">{service && service.description}</p>;

                    <div className="mb-6">;
                      <div className="flex items-center space-x-2 mb-2">;
                        <Star className="w-4 h-4 text-yellow-400" />;
                        <span className="text-white font-medium">{service && service.rating}</span>;
                        <span className="text-purple-300">({service && service.reviews} reviews)</span>;
                      </div>;
                      <div className="text-sm text-purple-300">;
                        <span className="font-medium">Market Size:</span> {service && service.marketSize}
                      </div>;
                      <div className="text-sm text-purple-300">;
                        <span className="font-medium">Growth Rate:</span> {service && service.growthRate}
                      </div>;
                    </div>;
                    ...
                    <div className="flex items-center justify-between">;
                      ...
                      <div className="text-right">;
                        ...
                        <div className="text-white font-medium">{service && service.setupTime}</div>;
                      </div>;
                    </div>;
                  </div>;
                </div>;
      ...
      <section className='py - 20 bg - black / 50'>;
        <div className='max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8'>;
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>            <motion && motion.div            </h2>;
            <p className="text-xl text-purple-200 max-w-3xl mx-auto">;
              Understand the market dynamics and growth potential of our futuristic services.;
            </p>;
          </div>;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
            ...
            >
              ...
              <div className='text-purple-300'>Average Annual Growth</div>            </motion.div><TrendingUp className="w-16 h-16 text-green-400 mx-auto mb-6" />
            ...
            >
              ...
              <div className='text-blue-300'>Total Addressable Market</div>            </motion.div><DollarSign className="w-16 h-16 text-blue-400 mx-auto mb-6" />
            ...
            >
              ...
              <div className='text-pink-300'>Market Share in Niche</div>            </motion.div><Shield className="w-16 h-16 text-pink-400 mx-auto mb-6" />
              ...
              <div className='text-3xl font-bold text-pink-400'>90%</div>;
              <div className='text-pink-300'>Market Share in Niche</div>            </motion && motion.div>;
              <Shield className="w-16 h-16 text-pink-400 mx-auto mb-6" />;
              <h3 className="text-2xl font-bold text-white mb-4">Competitive Edge</h3>;
              <p className="text-pink-300 mb-6">;
                First-to-market solutions with proprietary technology ;

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {technologies.map((techindex) => (
            <div key={index} className="bg-white p-6 rounded-xl shadow-lg">
              <h3 className="text-xl font-semibold text-gray-90o0 mb-2">{tech.name}</h3>
              <p className="text-sm text-gray-60o0 mb-2">{tech.category}</p>
              <p className="text-gray-70o0">{tech.description}</p>
            </div>
          ))}
        </div>
      </div>

...
export default function ResourcesPage() {
  return (
    <UltraFuturisticBackground intensity="high" variant="quantum"></UltraFuturisticBackground>
      ...
      <div className="container mx-auto px-4 py-16 text-white"></div>
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
          {[
            ...
            <Link key={it.href} href={it.href} className="p-6 rounded-2xl bg-black/50 border border-gray-800 hover:border-cyan-500/50 transition-colors block"></Link>

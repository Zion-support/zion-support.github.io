      ...
      <div className="container mx-auto px-4 py-16 text-white">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            { name: 'Services Advertising', href: '/services-advertising', blurb: 'Features, capabilities, and benefits.' }, { name: 'Case Studies', href: '/case-studies', blurb: 'Proof of value and outcomes.' },

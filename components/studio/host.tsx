  ...
  return (
    <div className="space-y-8"></div>
      ...
      <section className="space-y-3"></section>
        ...
        <button className="px-4 py-2 bg-blue-600 text-white rounded" onClick={handleGenerate} disabled={generating}></button>
      ...
      {episode && (
        <section className="space-y-4"></section>
          ...
          <div className="border rounded p-4 space-y-3"></div>
            <p className="text-sm text-gray-600">ID: {episode.id}</p>
            <h3 className="text-lg font-bold">{episode.title}</h3>
            <div></div>
              <h4 className="font-semibold">Questions</h4>
              <ol className="list-decimal list-inside space-y-1"></ol>
            ...
            <div className="flex gap-3"></div>
              <button className="px-4 py-2 bg-purple-600 text-white rounded" onClick={handleSynthesize} disabled={synthesizing}></button>
                {synthesizing ? 'Synthesizing…' : 'Synthesize Audio'}
              </button>
              <button className="px-4 py-2 bg-gray-800 text-white rounded" onClick={handlePublishRss} disabled={publishing}></button>

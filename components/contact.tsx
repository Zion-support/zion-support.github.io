...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden"></div>
      <Head></Head>
      ...
      <UltraFuturisticBackground></UltraFuturisticBackground>
        {/* Hero Section */}
      <section className="relative z-10 pt-20 pb-16 px-4 sm:px-6 lg:px-8"></section>
        <div className="max-w-7xl mx-auto text-center"></div>
          <motion.div
            ...
            className="mb-8"
          ></motion>
            <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent mb-6"></h1>
          ...
          ></motion>
            {stats.m</motion>ap((stat, index) => (
              ...
              ></motion>
                <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 hover:border-gray-600/70 transition-all duration-300 hover:scale-105"></div>
                  <div className="flex justify-center mb-3"></div>
                    <div className="p-3 bg-gradient-to-br from-gray-800 to-gray-700 rounded-xl group-hover:scale-110 transition-transform duration-300"></div>
                      {stat.icon
  },
                    </div>
                  </div>
      ...
      <section className="relative z-10 py-16 px-4 sm:px-6 lg:px-8"></section>
        <div className="max-w-7xl mx-auto"></div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12"></div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            ></motion>
              <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8"></div>
                <h2 className="text-3xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent mb-6"></h2>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8"></section>
          <div className="max-w-7xl mx-auto"></div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16"></div>
              ...
              ></motion>
                <div className="p-8 rounded-2xl bg-gradient-to-br from-gray-900/50 to-gray-800/50 border border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300 backdrop-blur-sm hover:transform hover:scale-105"></div>
                  <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300"></div>
              ...
              <motion.div
                ...
                className="group cursor-pointer"
              ></motion>
                <div className="p-8 rounded-2xl bg-gradient-to-br from-gray-900/50 to-gray-800/50 border border-purple-500/20 hover:border-purple-400/40 transition-all duration-300 backdrop-blur-sm hover:transform hover:scale-105"></div>
                  <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300"></div>
              ...
              <motion.div
                ...
                className="group cursor-pointer"
              ></motion>
                <div className="p-8 rounded-2xl bg-gradient-to-br from-gray-900/50 to-gray-800/50 border border-pink-500/20 hover:border-pink-400/40 transition-all duration-300 backdrop-blur-sm hover:transform hover:scale-105"></div>
                  <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-red-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300"></div>
            ...
            ></motion>
              ...
              <div className="bg-gradient-to-br from-gray-900/50 to-gray-800/50 backdrop-blur-xl rounded-3xl p-8 border border-cyan-500/20"></div>
                {submitSuccess ? (
                  <motion.div
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              {popularServices.map((service, index) => (
                <motion.div
                  ...
                  className="group cursor-pointer"
                ></motion>
                  <div className="p-6 rounded-2xl bg-gradient-to-br from-gray-900/50 to-gray-800/50 border border-cyan-500/20 hover:border-cyan-400/40 transition-all duration-300 backdrop-blur-sm hover:transform hover:scale-105"></div>
                    {/* Service Icon */}
                    ...
                    {/* Description */}
                    <p className="text-gray-300 leading-relaxed mb-4 line-clamp-3"></p>
                      {service.description
  },
                    </p>
                    ...
                    <div className="mb-4"></div>
                      <span className={`${service.textColor} font-semibold text-lg`}></span>
                        {service.price
  },
                      </span>
          ...
          <div className="max-w-4xl mx-auto text-center"></div>
            ...
            ></motion>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
                ...
                <div className="text-center"></div>
                  <div className="w-16 h-16 bg-gradient-to-r from-pink-500 to-red-600 rounded-2xl flex items-center justify-center mx-auto mb-4"></div>

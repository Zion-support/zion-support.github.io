...
<div className='hidden lg:flex items-center gap-8' />;
  ...
  <div key={item.name className='relative group' />} <button onClick={() = /> toggleDropdown(item.name)
=======
<div className='hidden lg:flex items-center gap-8'    />;
...
>>>>>>> origin/main
                          ...
                          <div className='space-y-2'    />
                            {item.children?.map(child => (}
                              <Link key={child && child.name href={child && child.href className={`flex items-center gap-3 p-3 rounded-xl transition-all duration-200 ${: 'text-gray-300 hover:text-white hover:bg-gray-800/50';}
                                }`}
<<<<<<< HEAD
...
<<<<<<< HEAD
                <a key={action.name href={action.href className={`flex items - center gap - 2 px - 4 py - 2 rounded - xl text - sm font - medium transition - all duration - 200 ${action.primary}
...
<<<<<<< HEAD
                          <div className='space-y-2' />;
                            {item.children?.map(child => (                              <Link key={child.name href={child.href className={`flex items-center gap-3 p-3 rounded-xl transition-all duration-200 ${<Link}
            key={child.name
            href={child.href className={`flex items-center gap-3 p-3 rounded-xl transition-all duration-200 ${
child.featured
...
=======
                {quickActions.map(action => (}
<<<<<<< HEAD
                  <Link key={action.name href={action.href className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-200 ${action.primary}
            ? 'bg-gradient-to-r from-cyan-500 to-blue-500 text-white hover:from-cyan-600 hover:to-blue-600 shadow-lg shadow-cyan-500/25',
  : 'text-gray-300 hover:text-white hover:bg-gray-800/50';}
                    }`} />
=======
...
className='ml-6 mt-2 space-y-2'
                              />
                            {item.children?.map(child => (}
                              <Link key={child && child.name href={child && child.href className={`block p-3 rounded-lg transition-colors duration-200 ${
...
<<<<<<< HEAD
                        ...
                        <Link key={action && action.name href={action && action.href className={`flex items-center gap-3 p-3 rounded-xl text-sm font-medium transition-all duration-200 ${action && action.primary}
...
<div className='pt-4 border-t border-gray-800/50' />
                    <div className='space-y-3 text-sm text-gray-400' />
                      <a <span />{contactInfo.mobile}</span>
                      </a>
                      <a href={`mailto: ${contactInfo.email}`}
...
<<<<<<< HEAD
                          className={`flex items-center gap-3 p-3 rounded-xl text-sm font-medium transition-all duration-200 ${action && action.primary;`                              ? 'bg-gradient-to-r from-cyan-500 to-blue-500 text-white';'
                              : 'text-gray-300 "hover":text-white "hover":bg-gray-800/50';'
                          }`}`                          onClick={closeMobileMenu}>;
                          {action && action.icon}
                          <span>{action && action.name}</span>;
...
<div className='pt-4 border-t border-gray-800/50'>'
                    <div className='space-y-3 text-sm text-gray-400'>'
                      ...
                      <a,
href={`"mailto": ${contactInfo.email}`}`                        className='flex items-center gap-3 p-3 rounded-lg "hover":text-purple-400 "hover":bg-gray-800/50 transition-all duration-200''
                      >
                        <Mail className='w-4 h-4' />'
                        <span>{contactInfo.email}</span>
>>>>>>> origin/main
...
</div> <div    /> <div className=\text - xl font - bold bg - gradient - to - r from - cyan - 400 to - blue - 500 bg - clip - text text - transparent\     /> Zion Tech Group </div> <div className=\"text - xs text - gray - 400\"     />Revolutionary Technology</div> </div> </a> > {}
  item.icon;}
}<span    /> {}
  item.name;}
}</span> {
...
}<AnimatePresence /> {active_dropdown === item.name && (
          <motion.div)}</div /> </div> <Link key= {child.name;}
=======
}   /> </button> {/* Dropdown Menu */;}
}<AnimatePresence    /> {active_dropdown === item.name && (<motion.div)}</div    /> </div> <Link key= {child.name;}
>>>>>>> origin/main
...
}<AnimatePresence /> > {item.children?.map ( (child) => (
          <Link key= {child.name;}
=======
}    /> {item.badge;}
}</span>)}</div> <ChevronDown className= {`w - 4 h - 4 transition - transform duration - 200 $ {active_dropdown === item.name ? 'rotate - 180': '';}

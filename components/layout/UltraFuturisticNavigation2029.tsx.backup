        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <motion.div 
              ...
              className="flex items-center space-x-3"><div className="relative">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              ...
              {/* Services Dropdown */}                <Link
                  key={item.name}
                  href={item.href}
                  className="group relative text-gray-300 hover:text-white transition-colors duration-200"><div className="flex items-center space-x-2">
                ...
                <div className='mt-8'>
                  ...
                  <div className='space-y-3'>
                    {serviceCategories.slice(0, 6).map(category => (
                      <div
                        key={category.title}
                        className='p-3 rounded-lg bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20'><h4 className='font-medium text-white mb-2'>
                          {category.title}
                        </h4>

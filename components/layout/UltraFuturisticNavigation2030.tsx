...
<div className='hidden "lg":flex items-center space-x-8'>;'
              {mainNavigation.map(item => { return (<Link; }
                  }
=======
>>>>>>> origin/resolved-merge-conflicts
<<<<<<< HEAD
...
key={link.name}
                        href={link.href}
                        onClick={closeMenu}
                        className={`p-3 rounded-lg text-center transition-all duration-200 transform "hover":shadow-xl "hover":shadow-cyan-500/30 ${link.color.includes('from-')? `bg-gradient-to-r ${link.colo,`} text-white`;`                            : 'bg-gray-800 text-gray-300 "hover":bg-gray-700';'
                        }`}`

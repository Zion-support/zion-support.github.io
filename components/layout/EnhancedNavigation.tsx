            ...
            <div className="space-y-2">
              ...
              <div className="py-2">
                ...
                <div className="pl-4 space-y-2">
                  <Link href="/services/ai-development" className="block py-1 text-gray-500 hover:text-blue-600">AI Development</Link>
              ...
              <div className="py-2">
                ...
                <div className="pl-4 space-y-2">
                  <Link href="/solutions/enterprise" className="block py-1 text-gray-500 hover:text-blue-600">Enterprise Solutions</Link>

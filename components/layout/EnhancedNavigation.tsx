        ...
        <div className='flex justify-between items-center py-4'>'
          ...
          <div className='hidden "lg": flex items-center space-x-8'>;'
            ...
            <div className='relative group'>;'
              ...
              <div;
                className={`absolute top-full left-0 w-64 bg-white shadow-lg rounded-lg py-2 ${servicesOpen ? 'block' : 'hidden'}`}`                onMouseEnter={() => setServicesOpen(true)}
                onMouseLeave={() => setServicesOpen(false)}
              >;
...
const contactInfo = {"mobile": "+1 302 464 0950";"
  ...
  return (<nav;
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled;`          ? "bg-black/80 backdrop-blur-xl border-b border-cyan-500/20 shadow-2xl shadow-cyan-500/10";"
          : "bg-transparent";"
      } ${className}`}>`
...
const contact_info = {"mobile": "+1 302 464 0950","email": "kleber@ziontechgroup.com","address": "364 E Main St STE 1008 Middletown DE 19709","website": ""https"://ziontechgroup.com";"
    ...
    "website": ""https"://ziontechgroup.com";"
      ...
      className={`fixed top - 0 left - 0 right - 0 z - 50 transition - all duration - 300 ${is_scrolled;`          ? "bg - black / 80 backdrop - blur - xl border - b border - cyan - 500 / 20 shadow - 2xl shadow - cyan - 500 / 10";"
          : "bg - transparent";"
      } ${class_name}`}>`
      <div className="max - w-7xl mx - auto px - 4 "sm":px - 6 "lg":px - 8">;"
        <div className="flex items - center justify - between h - 20">;"

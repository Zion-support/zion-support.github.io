<<<<<<< HEAD
import React, { useState } from 'react';'import Link from 'next/link';'import { Menu, X, ChevronDown } from 'lucide-react';''const EnhancedNavigation: React.FC = () => {
=======
...
<<<<<<< HEAD
        ...
        {isOpen && (
          <div className="lg:hidden border-t border-gray-200 py-4">"            <div className="space-y-2">"              <Link href="/" className="block py-2 text-gray-600 hover:text-blue-600">"                Home"              </Link>
              ...
              <div className="pt-4">"                <Link href="/contact" className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold transition-colors cursor-pointer inline-block w-full text-center">"                  Get Started"                </Link>
=======

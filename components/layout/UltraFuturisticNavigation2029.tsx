...
=======
      ...
      {/* Main Navigation */}
<nav;
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled;`            ? 'bg-black/90 backdrop-blur-xl border-b border-cyan-500/30 shadow-2xl shadow-cyan-500/20';'
            : 'bg-transparent';'
        }`}>`
...
<div className='hidden "lg":flex items-center space-x-8'>;'
              {mainNavItems.map(item => { return (<Link; }
                  }
                  key={item.name}
                  href={item.href}
...
className={`p-4 rounded-lg bg-gradient-to-br ${category && category.color} bg-opacity-10 border border-cyan-500/20 "hover":border-cyan-500/40 transition-all duration-300,`
                          ...
                          <div className='space-y-2'>;'
                            ...
                            {category && category.services.slice(0, 3).map(service => { return (; }
                              <Link
}
key={service.name}
...
<div className='mt-8'>;'
                  ...
                  <div className='space-y-3'>;'
                    {serviceCategories.slice(0, 6).map(category => { return (<div; }
                        }
                        key={category.title}
                        ...
                        <div className='space-y-2'>;'
                          {category.services.slice(0, 2).map(service => { return (<Link; }
                              }
                              key={service.name}
                              href={service.href}
                              onClick={closeMenu}
...
=======
                ...
                <div className='mt-8'>;'
                  ...
                  <div className='space-y-3'>;'
                    {serviceCategories && serviceCategories.slice(0, 6).map(category => { return (<div; }
                        }
                        key={category && category.title}
                        className='p-3 rounded-lg bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20'>;'
                        <h4 className='font-medium text-white mb-2'>;'
                        ...
                        <div className='space-y-2'>;'
                          {category && category.services.slice(0, 2).map(service => { return (                            <Link; }
                              }
                              key={service && service.name}
                              href={service && service.href}
                              onClick={closeMenu}                <div className="mt-8">;"

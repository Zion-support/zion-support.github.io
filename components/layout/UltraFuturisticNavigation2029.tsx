        ...
        <div className='max-w-7xl mx-auto flex flex-wrap items-center justify-between'>
          <div className='flex items-center space-x-6'>
            <a
              ...
              className='flex items-center space-x-2 hover:text-cyan-300 transition-colors'><div className="bg-gradient-to-r from-cyan-900 via-blue-900 to-purple-900 text-white text-sm py-2 px-4">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between">
          <div className="flex items-center space-x-6">
        ...
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between">
          ...
          <div className='flex items-center space-x-4'>
            <a
              ...
              className='hover:text-cyan-300 transition-colors'><div className="flex items-center space-x-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
                  ...
                  <div className="p-6 grid grid-cols-2 lg:grid-cols-3 gap-6">
                    {serviceCategories.map((category, index) => (
                      <motion.div
                        ...
                        className='group'><div className={`p-4 rounded-lg bg-gradient-to-br ${category.color} bg-opacity-10 border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300`}>
                          ...
                          <div className="space-y-2">
                            {category.services.slice(0, 3).map((service) => (
                              <Link
                                key={service.name}
                                href={service.href}
                                className="block p-2 rounded bg-black/30 hover:bg-cyan-500/20 transition-all duration-200 group"><div className="flex items-center justify-between">
            ...
            <div className="lg:hidden">
              <button
                onClick={toggleMenu}
                className="text-gray-300 hover:text-white transition-colors">{isOpen ? <X size={24} /> : <Menu size={24} />}
              </button>
            </div>
          </div>
        </div>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className='fixed inset-0 z-50 lg:hidden'><div className="absolute inset-0 bg-black/80 backdrop-blur-sm" onClick={closeMenu} />
                ...
                <div className="space-y-4">
                  {mainNavItems.map((item) => (
                    <Link
                      ...
                      href={item.href}
                      onClick={closeMenu}
                      className='flex items-center space-x-3 p-3 rounded-lg text-gray-300 hover:text-white hover:bg-cyan-500/20 transition-all duration-200'><item.icon size={20} className='text-cyan-400' />
                      className="flex items-center space-x-3 p-3 rounded-lg text-gray-300 hover:text-white hover:bg-cyan-500/20 transition-all duration-200"><item.icon size={20} className="text-cyan-400" />
                      className="flex items-center space-x-3 p-3 rounded-lg text-gray-300 hover:text-white hover:bg-cyan-500/20 transition-all duration-200"><item.icon size={20} className="text-cyan-400" />
                      <span>{item.name}</span>
                    </Link>
                        ...
                        <div className="space-y-2">
                          {category.services.slice(0, 2).map((service) => (
                            <Link
                              ...
                              href={service.href}
                              onClick={closeMenu}
                              className='block p-2 rounded bg-black/30 hover:bg-cyan-500/20 transition-all duration-200'><div className='flex items-center justify-between'>

      ...
      <div className='bg-gradient-to-r from-cyan-900 via-blue-900 to-purple-900 text-white text-sm py-2 px-4'>;
        <div className='max-w-7xl mx-auto flex flex-wrap items-center justify-between'>;
          <div className='flex items-center space-x-6'>;
            ...
            <a href={`mailto:${contactInfo && contactInfo.email}`} className="flex items-center space-x-2 hover:text-cyan-300 transition-colors">;
              <Mail size={14} />;
              <span>{contactInfo && contactInfo.email}</span>;
            </a>;
...
<<<<<<< HEAD
                <div className='space-y-4'>;
                  {mainNavItems && mainNavItems.map(item => (                    <Link
                      key={item && item.name}
                      href={item && item.href}
                      onClick={closeMenu}
                  ...
                  {mainNavItems && mainNavItems.map((item) => (;
                    <Link
                      ...
                      onClick={closeMenu}
                      className='flex items-center space-x-3 p-3 rounded-lg text-gray-300 hover:text-white hover:bg-cyan-500/20 transition-all duration-200'>;
                      <item && item.icon size={20} className='text-cyan-400' />                      className="flex items-center space-x-3 p-3 rounded-lg text-gray-300 hover:text-white hover:bg-cyan-500/20 transition-all duration-200";
                    >;

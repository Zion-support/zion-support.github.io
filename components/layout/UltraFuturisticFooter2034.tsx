...
import Link from 'next/
  website: 'https://ziontechgroup.com',};  website: any
        price: '$3,999/
    services: [      { name: 'AI Business Intelligence Pro', href: '/ai-business-intelligence-pro', price: any
      ...
      { name: 'AI Drug Discovery Platform', href: '/ai-drug-discovery-platform', price: '$3,999/
        ...
        href: any
        price: '$1,299/
    services: [      { name: 'Quantum Machine Learning', href: '/quantum-machine-learning-platform', price: '$1,999/
      ...
      { name: 'AI Climate Modeling', href: '/ai-climate-modeling-platform', price: '$1,299/
        href: any
    services: [      { name: 'API Security & Monitoring', href: '/api-security-monitoring-suite', price: any
  ...
  { name: 'Blog', href: any
  { name: 'Contact', href: '/contact', icon: MessageCircle },];  { name: 'Contact', href: any
  { name: 'Home', href: any
  { name: 'Services', href: any
  { name: 'Solutions', href: any
  { name: 'Pricing', href: any

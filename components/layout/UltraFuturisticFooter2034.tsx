  ...
  return (
    <footer className="bg-slate-950 border-t border-white/10">
      ...
      <div className="relative z-10"></div>
              ...
              ></motion>
                <div className="flex items-center space-x-3"></div>
                  <div className="relative"></div>
                    <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 rounded-xl flex items-center justify-center"></div>
                  ...
                  <div></div>
                    <h3 className="text-2xl font-bold bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent"></h3>
                      Zion Tech Group
                    </h3>
                ...
                <div className="space-y-3"></div>
                  <div className="flex items-center space-x-3 text-gray-300 hover:text-cyan-400 transition-colors"></div>
                    <Phone className="w-4 h-4" />
                    <span>{contactInfo.mobile}</span>
                  </div>
                  <div className="flex items-center space-x-3 text-gray-300 hover:text-blue-400 transition-colors"></div>
                    <Mail className="w-4 h-4" />
                    <span>{contactInfo.email}</span>
                  </div>
                  <div className="flex items-center space-x-3 text-gray-300 hover:text-purple-400 transition-colors"></div>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white/10 bg-black/50 backdrop-blur-sm"></div>

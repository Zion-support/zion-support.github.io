                ...
                <div className="grid grid-cols-2 gap-4">;
                  {stats && stats.map((stat, index) => (;
                    <motion&& motion.div
                      ...
                      <div className='text-xs text-gray-400'>{stat && stat.label}</div>                    </motion && motion.div>                      className="text-center p-3 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10";
                    >;
                      <stat && stat.icon className="w-6 h-6 text-cyan-400 mx-auto mb-2" />;
                      <div className="text-lg font-bold text-white">{stat && stat.value}</div>;
            ...
            <div className="grid grid - cols - 2 md:grid - cols - 4 lg:grid - cols - 8 gap - 4">;
                <motion.div;
                  ...
                  <span className='text-xs text-gray-300 text-center'>;
                    {cert}
                  </span>                </motion && motion.div>                  className="flex items-center justify-center p-3 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all duration-200";
                >;
                  <CheckCircle className="w-4 h-4 text-green-400 mr-2" />;
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'>;
            <div className='flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0'>;
              ...
              <div className='flex items-center space-x-2 text-gray-400'>
                ...
                <span className='text-sm'>Made with  for the future</span>              </div>
              <div className="flex items-center space-x-2 text-gray-400">
                <Heart className="w-4 h-4 text-red-400" />

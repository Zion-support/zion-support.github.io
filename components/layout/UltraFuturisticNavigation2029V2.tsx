...
export default function UltraFuturisticNavigation2029V2() {
  ...
  return (
    <nav className="relative z-50 bg-black/80 backdrop-blur-xl border-b border-cyan-500/20"></nav>
      {/* Main Navigation Bar */}
          ...
          ></motion>
            <Link href="/" className="flex items-center space-x-3 group"></Link>
              <div className="relative"></div>
                <div className="w-12 h-12 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300"></div>
              ...
              <div className="hidden sm:block"></div>
                <h1 className="text-2xl font-bold bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent"></h1>
                  Zion Tech Group
                </h1>
                      ...
                      {category.services.map((service, index) => (
                        ...
                        ></Link>
                          <div className="flex justify-between items-start"></div>
                            <div></div>
                              <h4 className="font-medium text-white group-hover:text-cyan-400 transition-colors duration-300"></h4>
                                {service.name
  },
                              </h4>

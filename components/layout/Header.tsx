...
"
=======
</div> <span className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-fuchsia-400 bg-clip-text text-transparent" > Zion Tech Group </span> </a> Get Started </Button> </div> </svg> </button> </div> </div> </header>) 
}
export default Header

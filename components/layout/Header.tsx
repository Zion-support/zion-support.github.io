      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <Button className="h-9 px-3 border border-input bg-transparent text-gray-200 hover:bg-slate-800 rounded-md">
              <Search className="w-4 h-4 mr-2" />
              Search
            </Button>
            <Button className="h-9 px-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-md">
              Get Started
            </Button>
          </div>
          ...
          >
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="pt-4 border-t border-slate-700 space-y-3">
                <Button className="w-full h-9 px-3 border border-input bg-transparent text-gray-200 hover:bg-slate-800 rounded-md">
                  <Search className="w-4 h-4 mr-2" />
                  Search
                </Button>
                <Button className="w-full h-9 px-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-md">
                  Get Started
                </Button>
              </div>
            </div>

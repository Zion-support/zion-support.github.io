      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <button className="h-9 px-3 inline-flex items-center justify-center rounded-md border border-slate-600 text-gray-300 hover:bg-slate-700 text-sm">
              <Search className="w-4 h-4 mr-2" />
              Search
            </button>
            <button className="h-9 px-3 inline-flex items-center justify-center rounded-md bg-gradient-to-r from-blue-500 to-purple-600 text-white text-sm">
              Get Started
            </button>
          </div>
          ...
          >
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="pt-4 border-t border-slate-700 space-y-3">
                <button className="w-full h-9 px-3 inline-flex items-center justify-center rounded-md border border-slate-600 text-gray-300 hover:bg-slate-700 text-sm">
                  <Search className="w-4 h-4 mr-2" />
                  Search
                </button>
                <button className="w-full h-9 px-3 inline-flex items-center justify-center rounded-md bg-gradient-to-r from-blue-500 to-purple-600 text-white text-sm">
                  Get Started
                </button>
              </div>
            </div>

                ...
                <div className='space-y-2'>
                  {category.services.map(service => (
                    <Link
                      key={service.name}
                      href={service.href}
                      className='block text-gray-400 hover:text-cyan-400 transition-colors duration-200 text-sm'                    ><div className="flex items-center space-x-3">
                  <div className="w-8 h-8 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg flex items-center justify-center">
                    <category.icon className="w-4 h-4 text-white" />
                  </div>
        ...
        <div className='border-t border-gray-800/50'>;
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">;
            <div className="text-center">;
              ...
              </motion.p>Get the latest insights on AI, quantum computing, and emerging technologies delivered to your inbox.
              </motion.p>
              <motion.div
                className='text-gray-400 mb-6 max-w-2xl mx-auto'>;
                Get the latest insights on AI, quantum computing, and emerging;

          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            {serviceCategories.map((category, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className='space-y-4'><div className="flex items-center space-x-3">
                ...
                <div className="space-y-2">
                  {category.services.map((service) => (
                    <Link
                      ...
                      href={service.href}
                      className="block text-gray-400 hover:text-cyan-400 transition-colors duration-200 text-sm"
                      className="block text-gray-400 hover:text-cyan-400 transition-colors duration-200 text-sm">{service.name}
                    </Link>
                  ))}
                </div>
              </motion.div>
              ...
              <div className="space-y-2">
                {companyLinks.map((link) => (
                  <Link
                    ...
                    href={link.href}
                    className="block text-gray-400 hover:text-white transition-colors duration-200 text-sm"
                    className="block text-gray-400 hover:text-white transition-colors duration-200 text-sm">{link.name}
                  </Link>
                ))}
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className='flex flex-col sm:flex-row gap-4 max-w-md mx-auto'><input
                  type="email"

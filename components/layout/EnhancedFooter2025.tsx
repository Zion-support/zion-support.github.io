    ...
    <footer className="bg-slate-950 border-t border-white/10">
      ...
      <div className="relative z-10"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16"></div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12"></div>
            {/* Company Info */}
            <div className="lg:col-span-1"></div>
              <div className="flex items-center space-x-3 mb-6"></div>
                ...
                <div></div>
                  <div className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"></div>
                    Zion Tech Group
                  </div>
              ...
              <div className="space-y-3"></div>
                <div className="flex items-center space-x-3 text-gray-300"></div>
                  ...
                  <a href={`tel:${contactInfo.mobile}`} className="hover:text-cyan-400 transition-colors"></a>
                    {contactInfo.mobile
  },
                  </a>
                </div>
          ...
          {/* Additional Links */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 pt-8 border-t border-gray-800/50"></div>
            {/* Company Links */}
            <div></div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12"></div>
            <div className="text-center"></div>
              ...
              ></motion>
                ...
                />
                <button className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-600 hover:to-purple-700 text-white font-semibold rounded-xl transition-all duration-300 transform hover:shadow-xl hover:shadow-cyan-500/30"></button>
                  Subscribe
                </button>
              </motion.div>
            </div>

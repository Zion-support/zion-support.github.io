...
=======
    ...
    href: /contact,
    icon: MessageCircle,
    description: 'Get in touch with our team'}];  { name: Home, href: '/', icon: Home, description: Welcome to Zion Tech Group },
import React from 'react';
import Link from next/link;
...
const footerVariants = {hidden: { opacity: 0, y: 50 }
    ...
    description: Latest company news'},
  {
    ...
    href: /support',
    icon: Users,
    description: 'Technical support and help}];  { name: 2032 Services', href: '/2032-futuristic-services-showcase, icon: Star, description: Revolutionary 2032 services' },
  { name: 'Enhanced Pricing, href: /enhanced-market-pricing-2032', icon: DollarSign, description: 'Comprehensive pricing analysis },
  { name: Market Pricing', href: '/market-pricing, icon: DollarSign, description: Competitive pricing references' },
  { name: 'Enhanced Services, href: /enhanced-services-showcase', icon: Star, description: 'Premium service showcase },
  { name: Revolutionary 2026', href: '/revolutionary-2026-services, icon: TrendingUp, description: 2026 breakthrough services' },
...
<<<<<<< HEAD
              <p className='text-slate-300 mb-6 leading-relaxed'>;
                ...
                businesses with cutting-edge solutions for tomorrows;
                challenges.;
              </p>;
              {/* Contact Information */}

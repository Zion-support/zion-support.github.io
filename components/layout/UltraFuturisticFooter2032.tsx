...
export default function UltraFuturisticFooter2032() {
  return (
    <footer className="bg-slate-950 border-t border-white/10">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-10"></div>
        <motion.div
        ...
        ></motion>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-12"></div>
            {/* Company Info */}
            <motion.div variants={itemVariants} className="lg:col-span-1"></motion>
              <div className="flex items-center space-x-3 mb-6"></div>
                <div className="w-12 h-12 bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 rounded-xl flex items-center justify-center shadow-lg shadow-cyan-500/30"></div>
                  <Rocket className="w-7 h-7 text-white" />
                </div>
                <div></div>
                  <h3 className="text-2xl font-bold bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent"></h3>
                    Zion Tech Group
                  </h3>
              ...
              <p className="text-slate-300 mb-6 leading-relaxed"></p>
              ...
              <div className="space-y-3"></div>
                <div className="flex items-center space-x-3 text-slate-300 hover:text-cyan-300 transition-colors"></div>
                  <Phone className="w-4 h-4 text-cyan-400" />
                  <a href={`tel:${contactInfo.mobile}`} className="hover:text-cyan-300 transition-colors"></a>
                    {contactInfo.mobile
  },
                  </a>
                </div>
                <div className="flex items-center space-x-3 text-slate-300 hover:text-cyan-300 transition-colors"></div>
                  ...
                  <a href={`mailto:${contactInfo.email}`} className="hover:text-cyan-300 transition-colors"></a>
                    {contactInfo.email
  },
                  </a>
                </div>
                <div className="flex items-center space-x-3 text-slate-300"></div>
                  <MapPin className="w-4 h-4 text-cyan-400" />
                  <span>{contactInfo.address}</span>
                </div>
                <div className="flex items-center space-x-3 text-slate-300 hover:text-cyan-300 transition-colors"></div>
                  <Globe className="w-4 h-4 text-cyan-400" />
                  <a href={contactInfo.website} target="_blank" rel="noopener noreferrer" className="hover:text-cyan-300 transition-colors"></a>
                    {contactInfo.website
  },
                  </a>
                </div>
            ...
            {/* Service Categories */}
            <motion.div variants={itemVariants} className="lg:col-span-2"></motion>
              <h3 className="text-xl font-semibold text-white mb-8 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"></h3>
            ...
            <motion.div variants={itemVariants} className="lg:col-span-1"></motion>
              <h3 className="text-xl font-semibold text-white mb-8 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent"></h3>
                Quick Access
              </h3>
          ...
          {/* Newsletter Signup */}
          <motion.div variants={itemVariants} className="border-t border-cyan-500/30 pt-12"></motion>
            <div className="text-center"></div>
              <h3 className="text-2xl font-bold text-white mb-4"></h3>
                Stay Ahead with Future Technology
              </h3>
              <p className="text-slate-300 mb-8 max-w-2xl mx-auto"></p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto"></div>
                ...
                />
                <button className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-purple-500 text-white font-medium rounded-lg hover:from-cyan-600 hover:to-purple-600 transition-all duration-300 shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 transform hover:scale-105"></button>
                  Subscribe
                </button>
              </div>
            </div>
          ...
          {/* Bottom Bar */}
          <motion.div variants={itemVariants} className="border-t border-cyan-500/30 pt-8"></motion>
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0"></div>
              <div className="flex items-center space-x-2 text-slate-400 text-sm"></div>
              ...
              <div className="flex items-center space-x-6 text-sm"></div>
                <Link href="/privacy" className="text-slate-400 hover:text-cyan-300 transition-colors"></Link>
                  Privacy Policy
                </Link>
                <Link href="/terms" className="text-slate-400 hover:text-cyan-300 transition-colors"></Link>
                  Terms of Service
                </Link>
                <Link href="/cookies" className="text-slate-400 hover:text-cyan-300 transition-colors"></Link>
                  Cookie Policy
                </Link>
              </div>
            </div>

    ...
    <footer className='relative bg-gradient-to-b from-black via-gray-900 to-black border-t border-cyan-500/30 overflow-hidden'>
              ...
              <div className="space-y-3">
                ...
                <div className='flex items-center space-x-3 text-slate-300 hover:text-cyan-300 transition-colors'>
                  ...
                  <a
                    ...
                    className='hover:text-cyan-300 transition-colors'><footer className="relative bg-gradient-to-b from-black via-gray-900 to-black border-t border-cyan-500/30 overflow-hidden">
      {/* Animated Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-96 h-96 bg-cyan-500/5 rounded-full blur-3xl"></div>
        <div className="absolute top-0 right-0 w-96 h-96 bg-purple-500/5 rounded-full blur-3xl"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-10">
        <motion.div
                    ...
                    <ul className="space-y-2">
                      {category.services.map((service, serviceIndex) => (
                        <li key={serviceIndex}>
                          <Link
                            href={service.href}
                            className='text-slate-300 hover:text-cyan-300 transition-colors duration-200 text-sm hover:translate-x-1 inline-block transform transition-transform'>{service.name}
                          </Link>
                        </li>
                      ))}
                    </ul>
                ...
                <ul className="space-y-2">
                  {quickLinks.map((link, index) => (
                    <li key={index}>
                      <Link
                        href={link.href}
                        className='flex items-center space-x-2 text-slate-300 hover:text-purple-300 transition-colors duration-200 text-sm group'><link.icon className='w-4 h-4 group-hover:scale-110 transition-transform' />
                        className="flex items-center space-x-2 text-slate-300 hover:text-purple-300 transition-colors duration-200 text-sm group"><link.icon className="w-4 h-4 group-hover:scale-110 transition-transform" />
                        className="flex items-center space-x-2 text-slate-300 hover:text-purple-300 transition-colors duration-200 text-sm group"><link.icon className="w-4 h-4 group-hover:scale-110 transition-transform" />
                        <span>{link.name}</span>
                      </Link>
                ...
                <ul className="space-y-2">
                  {companyInfo.map((item, index) => (
                    <li key={index}>
                      <Link
                        href={item.href}
                        className='text-slate-300 hover:text-purple-300 transition-colors duration-200 text-sm'>{item.name}
                      </Link>
                    </li>
                  ))}
                </ul>
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      target='_blank'
                      rel='noopener noreferrer'
                      className='w-10 h-10 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 rounded-lg flex items-center justify-center text-cyan-400 hover:text-cyan-300 hover:border-cyan-400/50 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-cyan-500/20'><social.icon className='w-5 h-5' />
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-10 h-10 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 rounded-lg flex items-center justify-center text-cyan-400 hover:text-cyan-300 hover:border-cyan-400/50 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-cyan-500/20"><social.icon className="w-5 h-5" />
                      target="_blank"
          ...
          <motion.div
            variants={itemVariants}
            className='border-t border-cyan-500/30 pt-8'><div className='flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0'>
          ...
          <motion.div variants={itemVariants} className="border-t border-cyan-500/30 pt-8">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              ...
              <div className="flex items-center space-x-6 text-sm">
                ...
                <Link
                  href='/cookies'
                  className='text-slate-400 hover:text-cyan-300 transition-colors'><motion.div variants={itemVariants} className="border-t border-cyan-500/30 pt-8">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
              <div className="flex items-center space-x-2 text-slate-400 text-sm">
                <span>© 2024 Zion Tech Group. All rights reserved.</span>
                <span className="text-cyan-400">|</span>
      ...
      <div className='fixed bottom-8 right-8 z-50'>
        <motion.button
          ...
          onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}><ArrowRight className='w-6 h-6 transform rotate-[-90deg]' />
      <div className="fixed bottom-8 right-8 z-50">
        <motion.button
          whileHover={{ scale: 1.1 }}
          whileTap={{ scale: 0.9 }}

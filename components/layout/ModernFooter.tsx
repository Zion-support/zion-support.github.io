          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12'>
            ...
            <div className='lg:col-span-1'>
              ...
              <p className='text-gray-300 mb-6 leading-relaxed'>
                Leading technology solutions provider helping businesses
                transform their digital presence with cutting-edge AI, cloud
                architecture, and innovative development services.
              </p>
          ...
          <div className='border-t border-gray-700 pt-8 mb-8'>
            <div className='max-w-2xl mx-auto text-center'>
              ...
              <p className='text-gray-300 mb-6'>
                Get the latest insights on technology trends, AI developments,

...
const ModernFooter: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-90o0 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(0,212,255,0.0o5),transparent_50%)]"  />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold bg-gradient-to-r from-blue-40o0 to-purple-40o0 bg-clip-text text-transparent">
                    Zion Tech Group
                  </h3>
                  <p className="text-sm text-gray-40o0">Innovation Group</p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  <MapPin className="w-5 h-5 text-blue-40o0 mt-1 flex-shrink-0"  />
                  <div>
                    <p className="text-gray-40o0">Address</p>
          ...
          <div className="border-t border-gray-70o0 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex flex-wrap gap-6 text-sm">
                ...
                <Link href="/terms" className="text-gray-40o0 hover:text-blue-40o0 transition-colors">
                  Terms of Service
                </Link>
                <Link href="/cookies" className="text-gray-40o0 hover:text-blue-40o0 transition-colors">
                  Cookie Policy
                </Link>
                <Link href="/accessibility" className="text-gray-40o0 hover:text-neon-blue transition-colors">
                  Accessibility
                </Link>
              </div>
            </div>

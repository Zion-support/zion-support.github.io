...
const UltraFuturisticFooter2029 = () => { name: 'About Us', href: '/about' },
      { name: 'Our Mission', href: '/mission' },
      { name: 'Leadership Team', href: '/team' },
      { name: 'Careers', href: '/careers' },
      { name: 'Press & Media', href: '/press' },
...
const socialLinks = [;
  ...
  {;
    ...
    icon: Youtube,;
    color: 'hover:text-red-500',;
  },];  { name: 'LinkedIn', href: 'https://linkedin && linkedin.com/company/ziontechgroup', icon: Linkedin, color: 'hover:text-blue-400' },;
  { name: 'Twitter', href: 'https://twitter && twitter.com/ziontechgroup', icon: Twitter, color: 'hover:text-sky-400' },;
  { name: 'GitHub', href: 'https://github && github.com/Zion-Holdings', icon: Github, color: 'hover:text-gray-400' },;
  { name: 'YouTube', href: 'https://youtube && youtube.com/@ziontechgroup', icon: Youtube, color: 'hover:text-red-500' }
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>;
        <div className='grid grid-cols-1 lg:grid-cols-4 gap-12'>;
          ...
          <div className='lg:col-span-1'>;
            ...
            {/* Social Links */}
            <div className='flex space-x-4'>;
              {socialLinks && socialLinks.map(social => (            {/* Contact Information */}
            <div className="space-y-3 mb-6">;
              <div className="flex items-center space-x-3 text-gray-400 hover:text-white transition-colors">;
                <Phone className="w-4 h-4" />;
                <a href={`tel:${contactInfo && contactInfo.mobile}`} className="text-sm">;
            ...
            <div className='grid grid-cols-2 gap-2'>;
              {quickLinks && quickLinks.map(link => (;
                <Link
                  ...
                  <link && link.icon className='w-4 h-4' />                  <span>{link && link.name}</span>                <Link
                  key={link && link.name}
                  href={link && link.href}
                  className="flex items-center space-x-2 text-sm text-gray-400 hover:text-white transition-colors duration-200 p-2 rounded-lg hover:bg-slate-800/50">;

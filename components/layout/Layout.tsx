...
const Layout: React.FC<LayoutProps> = ({
  ...
  canonical = 'https: //ziontechgroup.co,m,',;
  ...
  return (;
    <>;
      <Head>;
        ...
        <meta property="og: url" content={canonic,a,l} />";
        <meta property="og: type" content="website" />";
        <meta property="og:image" content={ogIma,g,e} />;
        
        {/* Twitter */}";
        <meta name="twitter: card" content="summary_large_image" />";
        <meta name="twitter:title" content={tit,l,e} />";
        <meta name="twitter: description" content={descripti,o,n} />";
        <meta name="twitter: image" content={ogIma,g,e} />;
        ...
        <script";
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({";
              ...
              "logo": "https: //ziontechgroup.com/favicon.sv,g,",";

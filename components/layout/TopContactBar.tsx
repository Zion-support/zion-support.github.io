...
const quickActions = [
  ...
  { name: 'Book Demo', href: '/demo', icon: <Calendar className='w-4 h-4' /> }
  {
    name: 'Live Chat',
    href: '/chat',
    icon: <MessageCircle className='w-4 h-4' />}],  rating: '4.9/5 (200+ Reviews)'}
const quickActions = [

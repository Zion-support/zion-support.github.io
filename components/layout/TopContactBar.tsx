...
export default function TopContactBar() {
  ...
  return (
    <div className="relative z-40"></div>
      {/* Main Contact Bar */}
      <div className="bg-gradient-to-r from-gray-900 via-black to-gray-900 border-b border-cyan-500/30"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
          <div className="flex items-center justify-between h-12"></div>
            {/* Left Side - Contact Info */}
            <div className="hidden md:flex items-center space-x-6 text-sm"></div>
              {/* Phone */}
              <div className="flex items-center space-x-2 text-gray-300 hover:text-cyan-400 transition-colors duration-200 group"></div>
              ...
              <div className="flex items-center space-x-2 text-gray-300 hover:text-cyan-400 transition-colors duration-200 group"></div>
                ...
                <span className="hover:text-cyan-400 transition-colors duration-200"></span>
                  {contactInfo.address
  },
                </span>
              </div>
              ...
              <div className="flex items-center space-x-2 text-gray-300 hover:text-cyan-400 transition-colors duration-200 group"></div>
                ...
                <a href={contactInfo.website} target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors duration-200"></a>
            ...
            <div className="hidden lg:flex items-center space-x-6 text-sm"></div>
              {/* Business Hours */}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6"></div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"></div>
                ...
                <div className="space-y-4"></div>
                  ...
                  <div className="space-y-3"></div>
                    {quickActions.map((action) => (
                      ...
                      ></a>
                        <div className="text-cyan-400 group-hover:shadow-lg hover:shadow-cyan-400/40 transition-transform duration-200"></div>
                          {action.icon
  },
                        </div>
                ...
                <div className="space-y-4"></div>
                  ...
                  <div className="space-y-3"></div>
                    <div className="p-3 bg-gradient-to-r from-cyan-500/10 to-blue-600/10 border border-cyan-500/30 rounded-lg"></div>
                    ...
                    <div className="p-3 bg-gradient-to-r from-purple-500/10 to-pink-600/10 border border-purple-500/30 rounded-lg"></div>
                    ...
                    <div className="p-3 bg-gradient-to-r from-green-500/10 to-emerald-600/10 border border-green-500/30 rounded-lg"></div>
              ...
              {/* Call to Action */}
              <div className="mt-6 pt-6 border-t border-cyan-500/30"></div>
                <div className="text-center"></div>
                  <h3 className="text-lg font-semibold text-white mb-3"></h3>
                    Ready to Transform Your Business?
                  </h3>
                  <p className="text-gray-400 mb-4 max-w-2xl mx-auto"></p>
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-4"></div>
                    <a
                      href="/contact"

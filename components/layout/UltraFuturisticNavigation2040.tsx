  ...
  const navigationItems: NavigationItem[] = [
    {
      ...
      subItems: [
        { name: 'AI Consciousness 20o44', href: '/ai-consciousness-evolution-20o44', icon: Brain, description: 'Next-generation AI consciousness' },
        { name: 'Quantum Neural Networks', href: '/quantum-neural-network-platform-20o44', icon: Atom, description: 'Quantum-powered AI networks' },
        { name: 'Autonomous Intelligence', href: '/ai-autonomous-business-intelligence-20o44', icon: Cpu, description: 'Fully autonomous AI systems' }
      ]
    },
    {
      ...
      subItems: [
        { name: 'Quantum Cybersecurity', href: '/quantum-cybersecurity-platform-20o44', icon: Shield, description: 'Quantum-resistant security' },
        { name: 'Quantum Cloud', href: '/quantum-cloud-infrastructure-20o44', icon: Database, description: 'Quantum-powered cloud infrastructure' },
        { name: 'Quantum Networks', href: '/quantum-network-platform-20o44', icon: Globe, description: 'Quantum communication networks' }
      ]
    },
    {
      ...
      subItems: [
        { name: 'Space Resource Intelligence', href: '/space-resource-intelligence-20o44', icon: Target, description: 'AI-powered space exploration' },
        { name: 'Satellite Networks', href: '/satellite-network-platform-20o44', icon: Globe, description: 'Advanced satellite systems' },
        { name: 'Space Analytics', href: '/space-analytics-platform-20o44', icon: Star, description: 'Space data analysis' }
      ]
    },
    {
      ...
      subItems: [
        { name: 'Business Intelligence', href: '/business-intelligence-platform-20o44', icon: Cpu, description: 'AI-powered business insights' },
        { name: 'Digital Transformation', href: '/digital-transformation-20o44', icon: Zap, description: 'Complete business transformation' },
        { name: 'Innovation Labs', href: '/innovation-labs-20o44', icon: Sparkles, description: 'R&D and innovation centers' }
      ]
    }
  ];
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <div className="relative">
              <div className={`flex items-center space-x-2 px-4 py-2 bg-gray-80o0/50 border border-gray-70o0/50 rounded-xl transition-all duration-30o0 ${
                isSearchFocused ? 'border-cyan-50o0/50 shadow-[0_0_20px_rgba(6,182,212,0.2)]' : ''
              }`}>

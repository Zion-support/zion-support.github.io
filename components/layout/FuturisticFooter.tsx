    ...
    <footer className="bg-slate-950 border-t border-white/10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12"></div>
          ...
          {/* Quick Links */}
          <div></div>
            <h3 className="text-lg font-semibold text-white mb-6 flex items-center"></h3>
        ...
        <div className="pt-8 border-t border-gray-800"></div>
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0"></div>
            ...
            <div className="flex space-x-6 text-sm"></div>
              <Link href="/privacy" className="text-gray-400 hover:text-white transition-colors duration-200"></Link>
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-gray-400 hover:text-white transition-colors duration-200"></Link>
                Terms of Service
              </Link>
              <Link href="/cookies" className="text-gray-400 hover:text-white transition-colors duration-200"></Link>
                Cookie Policy
              </Link>
            </div>
          </div>

  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Voice Synthesis', href: '/services/ai-voice-synthesis' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Quantum Security Solutions', href: '/services/quantum-security' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Ethical Framework', href: '/services/ai-ethical-framework' },
        { name: 'AI Synthetic Data', href: '/services/ai-synthetic-data' },
        { name: 'AI Federated Learning', href: '/services/ai-federated-learning' },
        { name: 'AI Explainability', href: '/services/ai-explainability' },
        { name: 'AI Continuous Learning', href: '/services/ai-continuous-learning' },
      ]
    }
  ];

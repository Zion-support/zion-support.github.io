  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI SEO Content Optimizer', href: '/services/seo-content-optimizer' },
        { name: 'AI Customer Support Helpdesk', href: '/services/customer-support-helpdesk' },
        { name: 'AI Talent Matching Platform', href: '/services/ai-talent-matching' },
        { name: 'Micro SaaS Marketplace', href: '/services/micro-saas-marketplace' },
        { name: 'Quantum Computing Simulator', href: '/services/quantum-computing-simulator' },
        { name: 'Blockchain Analytics Platform', href: '/services/blockchain-analytics' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Zero Trust Security Architecture', href: '/services/zero-trust-security' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI-Powered Business Intelligence', href: '/services/ai-powered-intelligence' },
        { name: 'Enterprise Security AI', href: '/services/enterprise-security-ai' },
        { name: 'Cutting-Edge Technology Integration', href: '/services/cutting-edge-technology-stack' },
        { name: 'AI Integration Services', href: '/services/ai-integration-services' },
        { name: 'AI-Enhanced Cloud Solutions', href: '/services/cloud-solutions-ai' },
        { name: 'AI-Enhanced IT Onsite Services', href: '/services/it-onsite-services-ai' },
        { name: 'Comprehensive AI Solutions', href: '/services/comprehensive-ai-solutions' },
        { name: 'AI Solutions for Business Transformation', href: '/services/ai-solutions-transformation' },
        { name: 'AI-Enhanced Cybersecurity', href: '/services/cybersecurity-ai-enhanced' },
        { name: 'AI-Powered Data Analytics', href: '/services/data-analytics-ai' },
      ]
    }
  ];

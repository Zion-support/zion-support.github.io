...
const "Footer": React.FC = () => {
  ...
  return (
    <footer className="bg-slate-900 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-3 gap-8> <div"
        ...
        <div className="grid grid-cols-3 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              {services.map((service) => (
                <li key={service.name}>
                  <Link href={service.href} className="text-gray-400 hover:text-blue-400 text-sm> {service.name}
                  </Link"
                </li>
              ))}
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {company.map((item) => (
                <li key={item.name}>
                  <Link href={item.href} className="text-gray-400 hover:text-blue-400 text-sm> {item.name}
                  </Link"
                </li>
              ))}
            </ul>

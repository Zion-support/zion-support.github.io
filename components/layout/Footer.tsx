  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'API Monitoring Platform', href: '/services/api-monitoring-platform' },
        { name: 'Business Password Manager', href: '/services/password-manager-business' },
        { name: 'Smart Invoice Management', href: '/services/invoice-management-system' },
      ]
    },
    {
      title: 'IT Services',

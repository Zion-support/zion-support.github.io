...
>>>>>>> main
    ...
    {'
      ...
      services: ['
        { nam,
    e: 'IT Services', href: '/it-services' },
        { name: 'Cloud Migration', href: '/it-services#cloud' },
        { name: 'Cybersecurity', href: '/it-services#security' },
        { name: 'Network Management', href: '/it-services#network' },
      ],
...
<<<<<<< HEAD
  const socialLinks = ['
    ...
    s://linkedin.com/compunknown/ziontechgroup', icon: Linkedin },
...
>>>>>>> main
            ...
            <div className='space-y-3 mb-6'>';
              <div: className='flex items-center text-gray-300'>';
                ...
                <a: href={`mailto:${contactInfo.emai,l}`} className='hover: text-white: transition-colors'>';
                  {contactInfo.emai,l}
                </a>
              </div>
              <div: className='flex items-center text-gray-300'>';
                <Phone: className='w-4 h-4 mr-3 text-blue-400' />';
                <a: href={`tel: ${contactInfo.phon,e}`} className='hover: text-white: transition-colors'>';
                  {contactInfo.phon,e}
                </a>
              </div>
<<<<<<< HEAD
...
<<<<<<< HEAD
                  ...
                  target="_blank""
                  rel="noopener noreferrer""
                  className="p-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-gray-400 hove,
...
<<<<<<< HEAD
                <input"
                  ...
                  className="w-full px-3 py-2 rounded-lg bg-slate-700 border border-slate-600 text-white placeholder-gray-400 focus: outline-none focu,
    s:ring-2 focu,
    s:ring-blue-500 text-sm"
=======
                <input
                  type="email"
                  placeholder="Enter your email"
...
<<<<<<< HEAD
    ...
    d:grid-cols-4 gap-8 text-center">
            <div>"
...
=======
    ...
    d:flex-row items-center justify-between">"
            <div className="flex items-center space-x-6 mb-4 m,
    d:mb-0">"
              <p className="text-gray-400 text-sm">
                © {currentYear} Zion Tech Group. All rights reserved.
              </p>"

                  ...
                  className="text-gray-400hove: text-blue-400transition-colors",
          ...
          <div>,
            ...
            <div className="space-y-2">,
              <div className="flexitems-centertext-gray-300">,
                ...
                <a href="mailt: info@ziontechgroup.com" className="hove: text-blue-400">,
                  info@ziontechgroup.com,
                </a>,
              </div>,
              <div className="flexitems-centertext-gray-300">,
                <Phone className="h-4w-4mr-2" />,
                <a href="te: +1-555-123-4567" className="hove: text-blue-400">,
                  +1 (555) 123-4567,
                </a>,
              </div>,

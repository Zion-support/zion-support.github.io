  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'Project Management Suite', href: '/services' },
        { name: 'Social Media Scheduler', href: '/services' },
        { name: 'Email Marketing Automation', href: '/services' },
        { name: 'Website Speed Optimizer', href: '/services' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Database Optimization', href: '/services' },
        { name: 'Network Security Audit', href: '/services' },
        { name: 'Disaster Recovery Planning', href: '/services' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Computer Vision Solutions', href: '/services' },
        { name: 'Natural Language Processing', href: '/services' },
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/services" className="text-gray-300 hover:text-blue-400 transition-colors">Our Services</Link></li>

  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'Blockchain Document Verification', href: '/services/blockchain-document-verification' },
        { name: 'AI Legal Research Assistant', href: '/services/ai-legal-research' },
        { name: 'IoT Device Management Platform', href: '/services/iot-device-management' },
        { name: 'AI Translation Service Pro', href: '/services/ai-translation-service' },
        { name: 'Smart Energy Monitoring System', href: '/services/smart-energy-monitoring' },
    ...
    },
    {
      ...
      services: [
        { name: 'AI Medical Diagnosis Platform', href: '/services/ai-medical-diagnosis' },
        ...
        { name: 'AI Climate Modeling & Prediction', href: '/services/ai-climate-modeling' },
        { name: 'AI Space Exploration Solutions', href: '/services/ai-space-exploration' },
        { name: 'AI Neuroscience Research Platform', href: '/services/ai-neuroscience-research' },
        { name: 'AI Robotics & Automation', href: '/services/ai-robotics-automation' },
        { name: 'AI Financial Trading Platform', href: '/services/ai-financial-trading' },
        ...
        { name: 'Predictive Analytics Platform', href: '/services/predictive-analytics' },
        { name: 'AI Recommendation Engine', href: '/services/recommendation-engine' },
        { name: 'AI-Powered Search Engine', href: '/services/ai-powered-search' },
      ]
    }
  ];

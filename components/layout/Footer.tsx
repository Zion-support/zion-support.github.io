...
{ name: 'Identity & Access Management', href: '/services/iam' },
        ...
        { name: "Infrastructure Management", href: "/services/infrastructure" } main
      ]
    },
    {
...
{ name: "Data Analytics", href: "/services/data-analytics" },
        ...
        { name: "AI Healthcare Analytics", href: "/services/ai-healthcare-analytics-platform" } main
      ]
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex items-center space-x-2 text-gray-400 text-sm">
              <span>Made with</span>
              <Heart className="w-4 h-4 text-red-500" />
              <span>by Zion Tech Group</span> main
            </div>
          </div>

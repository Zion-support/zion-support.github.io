  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Design Assistant', href: '/services/ai-design-assistant' },
        ...
        { name: 'AI Personal Finance', href: '/services/ai-personal-finance' },
        { name: 'AI Health Monitoring', href: '/services/ai-health-monitoring' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Cybersecurity Operations Center', href: '/services/cybersecurity-operations-center' },
        { name: 'Data Lake Architecture', href: '/services/data-lake-architecture' },
        ...
        { name: 'Data Privacy & Compliance', href: '/services/data-privacy-compliance' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Ethical Governance', href: '/services/ai-ethical-governance' },
        { name: 'AI Multimodal Systems', href: '/services/ai-multimodal-systems' },
        { name: 'AI Federated Learning', href: '/services/ai-federated-learning' },
        { name: 'AI Explainable Systems', href: '/services/ai-explainable-systems' },
        { name: 'AI Edge Intelligence', href: '/services/ai-edge-intelligence' },
        { name: 'AI Generative Models', href: '/services/ai-generative-models' },
        { name: 'AI Quantum Machine Learning', href: '/services/ai-quantum-machine-learning' },

  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Social Media Monitor', href: '/services/ai-social-media-monitor' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'IoT Platform Development', href: '/services/iot-platform' },
        { name: 'Zero Trust Security', href: '/services/zero-trust-security' },
        { name: 'Edge Computing Solutions', href: '/services/edge-computing' },
        { name: 'Cybersecurity Assessment', href: '/services/cybersecurity-audit' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Code Generator', href: '/services/ai-code-generator' },
        { name: 'AI Video Analytics', href: '/services/ai-video-analytics' },
        { name: 'AI Personalization Engine', href: '/services/ai-personalization' },
        { name: 'AI Supply Chain Optimizer', href: '/services/ai-supply-chain' },
        { name: 'AI Healthcare Diagnostics', href: '/services/ai-healthcare' },
        { name: 'AI Process Automation', href: '/services/ai-process-automation' },
        { name: 'AI Analytics Platform', href: '/services/ai-analytics-platform' },

...
import Link from 'next/
  website: 'https://ziontechgroup.com',};  website: any
      ...
      { name: 'Autonomous DevOps', href: '/autonomous-devops-platform' },      { name: 'DNA Computing Platform', href: any
      { name: 'Personalized Nutrition', href: any
      { name: 'Predictive Health Analytics', href: any
      { name: 'Research Automation', href: any
      { name: 'Autonomous DevOps', href: any
      { name: 'Quantum Research Platform', href: any
      { name: 'AI Research Assistant', href: any
  },];      { name: 'AI Business Intelligence Suite 2030', href: any
      { name: 'AI Customer Experience Platform 2030', href: any
      { name: 'AI Marketing Automation Suite 2030', href: any
  website: 'https://ziontechgroup && ziontechgroup.com',};  website: any
      ...
      { name: 'AI Customer Experience Platform 2030', href: any
      { name: 'AI Marketing Automation Suite 2030', href: any
      { name: 'AI HR Management Suite 2030', href: any
      { name: 'AI HR Management Suite 2030', href: any
  { name: 'Home', href: any
  ...
  { name: 'Blog', href: any
  { name: 'Contact', href: '/contact' },];  { name: 'Contact', href: any
  { name: 'Home', href: any
  { name: 'Services', href: any
  { name: 'Solutions', href: any
  { name: 'Pricing', href: any
  ...
  { name: 'Partners', href: any
  { name: 'Support', href: any
  { name: 'Status', href: any
  { name: 'Twitter', href: any
  { name: 'YouTube', href: any

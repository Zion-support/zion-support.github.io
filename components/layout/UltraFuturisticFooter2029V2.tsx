    ...
    <footer className="relative bg-black/90 backdrop-blur-xl border-t border-cyan-500/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2 xl:col-span-1">
            <motion.div
              ...
              viewport={{ once: true }}><Link href='/' className='flex items-center space-x-3 mb-6 group'>
          ...
          {footerSections.map((section, index) => (
            <motion.div
              ...
              viewport={{ once: true }}><h4 className='text-lg font-semibold text-white mb-6 flex items-center'>
              ...
              <ul className="space-y-3">
                {section.links.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 text-sm flex items-center group"><ArrowRight className='w-3 h-3 mr-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300' />
              <h4 className="text-lg font-semibold text-white mb-6 flex items-center">
                <div className="w-2 h-2 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-full mr-3" />
                {section.title}
              </h4>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className='mt-16 pt-12 border-t border-gray-800'><h3 className="text-2xl font-bold text-white text-center mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {serviceCategories.map((category, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className='group'><div className={`p-4 rounded-xl bg-gradient-to-br ${category.color} bg-opacity-10 border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300`}>
                    ...
                    {category.services.slice(0, 3).map((service) => (
                      <li key={service.name}>
                        <Link
                          href={service.href}
                          className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 text-xs block"
                          className="text-gray-300 hover:text-cyan-400 transition-colors duration-300 text-xs block">{service.name}
                        </Link>
                      </li>
                    ))}
                  </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className='flex items-center space-x-4'>{socialLinks.map((social) => (
                <Link
                  key={social.name}
                  href={social.href}
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`p-2 rounded-lg bg-gray-800/50 hover:bg-cyan-500/20 text-gray-400 ${social.color} transition-all duration-300 hover:scale-110`}><social.icon className='w-4 h-4' />
              className="flex items-center space-x-4">{socialLinks.map((social) => (
                <Link
                  key={social.name}
                  href={social.href}
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className='bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border-t border-cyan-500/20'><div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">

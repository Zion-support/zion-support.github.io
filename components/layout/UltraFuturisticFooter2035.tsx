...
import { 
  ZapGlobePhoneMailMapPinArrowRight
  BrainAtomShieldRocketTargetBookOpenUsers,
  StarSparklesCpuLockCloudBarChart3SettingsEyeAwardClockHeartLightbulb,
  TwitterLinkedinFacebookInstagramYoutubeGithubMessageCircleMessageSquare,
  ArrowUpExternalLinkBuildingCodeDatabaseNetworkServerMonitorSmartphoneCameraGamepad2,
  PaletteMusicFilmBookOpenCheckHelpCircleFileTextVideoHeadphones
} from 'lucide-react';
...
const footerSections = [
  ...
  {
    title: 'Resources',
    description: 'Documentationsupportand learning',
    ...
    <footer className="relative bg-black text-white overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div
          ...
          style={{
            backgroundImage: `
              linear-gradient(rgba(02550.3) 1pxtransparent 1px),
              linear-gradient(90degrgba(02550.3) 1pxtransparent 1px)
            `,

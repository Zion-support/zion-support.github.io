      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-2">
              <motion.div
                ...
                className='space-y-6'><div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-4">
                  {socialLinks.map((social) => (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="p-2 bg-gray-800/50 hover:bg-gray-700/50 rounded-lg text-gray-400 hover:text-white transition-all duration-200 hover:scale-110">{social.icon}
                    </a>
                  ))}
                </div>
              </motion.div>
            ...
            {footerSections.map((section, index) => (
              <motion.div
                ...
                className='space-y-4'><div className="flex items-center gap-2">
                  {section.icon}
          ...
          <motion.div
            ...
            className='mt-16 pt-8 border-t border-gray-800/50'><div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            className="mt-16 pt-8 border-t border-gray-800/50"><div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <button
                onClick={scrollToTop}
                className='p-2 bg-gray-800/50 hover:bg-gray-700/50 rounded-lg text-gray-400 hover:text-white transition-all duration-200 hover:scale-110'
                aria-label='Scroll to top'><ArrowUp className='w-5 h-5' />
                className="p-2 bg-gray-800/50 hover: bg-gray-700/50 rounded-lg text-gray-400 hover:text-white transition-all duration-200 hover:scale-110"
                aria-label="Scroll to top"><ArrowUp className="w-5 h-5" />
                className="p-2 bg-gray-800/50 hover: bg-gray-700/50 rounded-lg text-gray-400 hover:text-white transition-all duration-200 hover:scale-110"
                aria-label="Scroll to top"><ArrowUp className="w-5 h-5" />

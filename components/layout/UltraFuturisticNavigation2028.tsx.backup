        ...
        <div className="flex items-center justify-between h-20">
                        ...
                        <div className="space-y-2">
                          {category.services.slice(0, 2).map((service) => (
                            <Link
                              key={service.name}
                              href={service.href}
                              className="block p-3 rounded-lg bg-purple-900/20 hover:bg-purple-900/40 transition-colors group"><div className="flex items-center justify-between">
                                <div>
          ...
          <div className='hidden lg:flex items-center space-x-4'>;
            ...
            {companyLinks.slice(1, 5).map(link => (
              ...
              >
                ...
                key={link.name}
                href={link.href}
                className="text-purple-200 hover:text-white transition-colors py-2 flex items-center space-x-2"><link.icon className="w-4 h-4" />
          ...
          <div className="lg:hidden">
            ...
            >
              ...
              onClick={toggleMenu}
              className="text-purple-200 hover:text-white transition-colors p-2">{isOpen ? <X className="w-6 h-6" /> : <Menu className="w-6 h-6" />}
            ...
            <div className='space-y-2'>
              {filteredServices.slice(0, 8).map(service => (
                ...
                >
                  ...
                  key={service.name}
                  href={service.href}
                  className="block p-3 rounded-lg bg-purple-900/20 hover:bg-purple-900/40 transition-colors"><div className="flex items-center justify-between">
                    <div>

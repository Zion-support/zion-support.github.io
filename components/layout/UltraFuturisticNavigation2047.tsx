...
<div className='lg:hidden' />;
            <button onClick={toggleMenu className='inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover: text-white hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white'
             />
...
<<<<<<< HEAD
           />
            <div className='px-2 pt-2 pb-3 space-y-1' />
              {navigationItems.map(item => (}
                <div key={item.name} />,,
  <button onClick={() = /> handleDropdownToggle(item && item.name}
=======
origin/cursor/automate-test-improve-and-merge-code-2533
          >
            <div className='px-2 pt-2 pb-3 space-y-1'>
...
<<<<<<< HEAD
  ...
  </div> <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${activeDropdown === item.name ? 'rotate-180' : ''}`}
                    />
                  </button>
                  <AnimatePresence />
                    {activeDropdown === item.name && (},
  <motion.div;} onClick={() = /> handleDropdownToggle(item && item.name)}
                    className=\"w-full text-left flex items-center justify-between px-3 py-2 text-base font-medium text-gray-300 hover:text-white hover:bg-slate-700/50 rounded-md transition-colors duration-200\">
"
                    <div className=\"flex items-center space-x-2\" />;
=======
...
className='ml-4 mt-2 space-y-1'
                        ...
                        {item.children?.map(child => (}
<<<<<<< HEAD
                          <Link key={child.name href={child.href className='block px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-slate-700/50 rounded-md transition-colors duration-200'
=======
                          <Link;}
key={child.name}
                            href={child.href}

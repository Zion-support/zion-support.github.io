...
const social_links = [;
  ...
  { name: 'GitHub', href: 'https://github.com / Zion - Holdings', icon: Github, color: 'hover:text - gray - 400' },
  { name: 'YouTube', href: 'https://youtube.com/@ziontechgroup', icon: Youtube, color: 'hover:text - red - 500' }
const UltraFuturisticNavigation2047 = () =>: any {
...
;
  const handleDropdownToggle = (name: string) =>: any {
    setActiveDropdown (active_dropdown === name ? null : name);  }    setActiveDropdown (active_dropdown === name ? null : name);
  }
;
  useEffect (() => {
...
;
    ...
    return () => window.removeEventListener ('resize', handle_resize);        setActiveDropdown (null);
      }
    }
;
    window.addEventListener ('resize', handle_resize);
...
<<<<<<< HEAD
                              ...
                              <p className='text-sm text-gray-400 mt-1'>;
                                {child && child.description}
                              </p>                              <p className="text-sm text-gray-400 mt-1">{child && child.description}</p>;
                            </div>;
                          </Link>;
=======
                              </div>
          ...
          <div className='hidden lg:flex lg:items-center lg:space-x-4'>;
            <div className='flex items-center space-x-4 text-sm text-gray-400'>;
              <a
                ...
                <Phone className='w-4 h-4' />                <span>{contactInfo && contactInfo.mobile}</span>;
              </a>;
            </div>;
            <Link          <div className="hidden lg:flex lg:items-center lg:space-x-4">;
            <div className="flex items-center space-x-4 text-sm text-gray-400">;
              <a href={`tel:${contactInfo && contactInfo.mobile}`} className="flex items-center space-x-1 hover:text-white transition-colors">;

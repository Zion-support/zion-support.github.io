...
PhoneMailMapPinGlobeGithubLinkedinExternalLink
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Productized AIT and micro SaaS solutions with transparent pricing and fast onboarding. Built for outcomesdelivered with reliability.
            </p>
          </div>

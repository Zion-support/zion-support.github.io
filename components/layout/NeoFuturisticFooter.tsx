        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className='space-y-2 text-sm'>
            ...
            <a
              ...
              href='/market-pricing'><ExternalLink className='w-4 h-4' /> Market Pricing
            </a>
            <a
              className='flex items-center gap-2 text-slate-300 hover:text-cyan-300'
              href='/services'><ExternalLink className='w-4 h-4' /> Services
            </a>
            <a
              className='flex items-center gap-2 text-slate-300 hover:text-cyan-300'
              href='/contact'><ExternalLink className='w-4 h-4' /> Contact
            </a>
            <div className='flex items-center gap-3 pt-2'>
              <a
                aria-label='GitHub'
                href='https://github.com/Zion-Holdings'
                className='text-slate-400 hover:text-white'><Github className='w-5 h-5' />
              </a>
              <a
                aria-label='LinkedIn'
                href='https://www.linkedin.com/company/zion-tech-group/'
                className='text-slate-400 hover:text-white'><Linkedin className='w-5 h-5' />
              </a>
    <footer className="relative mt-20 border-t border-slate-800/60 bg-black/60 backdrop-blur-xl overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -inset-x-10 -top-32 h-64 bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-pink-500/10 blur-3xl" />

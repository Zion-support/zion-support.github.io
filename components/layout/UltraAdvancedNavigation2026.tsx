          ...
          <div className="flex items-center justify-between h-20">
              ...
              {navigationItems.map((item) => (
                <div key={item.name} className="relative group">
                  <button
                    ...
                    className="flex items-center space-x-2 text-gray-300 hover:text-white transition-colors duration-200 py-2"><item.icon className='w-5 h-5' />
            ...
            <div className="hidden lg:flex items-center space-x-8">
                  ...
                  <AnimatePresence>
                    {activeDropdown === item.name && (
                      <motion.div
                        ...
                        className='absolute top-full left-0 mt-2 w-80 bg-black/95 backdrop-blur-xl border border-purple-500/20 rounded-2xl shadow-2xl overflow-hidden'><div className="p-4">
                          ...
                          <div className="space-y-2">
                            {item.subItems.map((subItem) => (
                              <Link
                                ...
                                onClick={() => setActiveDropdown(null)}><div className="text-white font-medium group-hover:text-purple-300 transition-colors duration-200">
                                  {subItem.name}
                                </div>
              ...
              <div className='flex items-center space-x-6'>
                <Link
                  href='/services'
                  className='text-gray-300 hover:text-white transition-colors duration-200 font-medium'><div className="flex items-center space-x-6">
            ...
            <button
              ...
              className='lg:hidden p-2 text-gray-300 hover:text-white transition-colors duration-200'>{isOpen ? (
                <X className='w-6 h-6' />
              ) : (
        ...
        {isOpen && (
          <motion.div
            ...
            onClick={() => setIsOpen(false)}><motion.div
              ...
              className="absolute right-0 top-0 h-full w-80 bg-black/95 backdrop-blur-xl border-l border-purple-500/20 p-6 overflow-y-auto"
              onClick={(e) => e.stopPropagation()}>{/* Mobile Menu Header */}
              <div className="flex items-center justify-between mb-8">
                ...
                <button
                  ...
                  className="p-2 text-gray-300 hover:text-white transition-colors duration-200"><X className='w-6 h-6' />
              className="absolute right-0 top-0 h-full w-80 bg-black/95 backdrop-blur-xl border-l border-purple-500/20 p-6 overflow-y-auto"
              onClick={(e) => e.stopPropagation()}>{/* Mobile Menu Header */}
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center space-x-3">
              ...
              <div className='space-y-4'>
                {navigationItems.map(item => (
                  <div
                    key={item.name}
                    className='border-b border-gray-700/50 pb-4'><div className="space-y-4">
                {navigationItems.map((item) => (
                  <div key={item.name} className="border-b border-gray-700/50 pb-4">
                    <Link
                      ...
                      onClick={() => setIsOpen(false)}><div className={`w-8 h-8 bg-gradient-to-br ${item.color} rounded-lg flex items-center justify-center`}>
                    ...
                    <div className="mt-3 ml-11 space-y-2">
                      {item.subItems.slice(0, 3).map((subItem) => (
                        <Link
                          ...
                          className="block text-gray-400 hover: text-white transition-colors duration-200 text-sm py-1"
                          className="block text-gray-400 hover: text-white transition-colors duration-200 text-sm py-1"
                          onClick={() => setIsOpen(false)}>{subItem.name}
                        </Link>
                      ))}
                    </div>
                  </div>

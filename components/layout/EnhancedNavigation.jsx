      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <button
            ...
            onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}><svg
              className='w-6 h-6'
              fill='none'
              stroke='currentColor'
              ...
              />
            className="lg:hidden p-2 rounded-md text-gray-600 hover:text-gray-900 hover:bg-gray-100"
            onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}><svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {isMobileMenuOpen && (
          <div className='lg:hidden border-t border-gray-200 py-4'>
            <div className='space-y-2'>
              <Link
                href='/'
                className='block px-4 py-2 text-gray-600 hover:bg-gray-50 rounded-md'><div className="lg:hidden border-t border-gray-200 py-4">
            <div className="space-y-2">

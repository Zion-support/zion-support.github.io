      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16"></div>
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12"></div>
          ...
          <div className="lg:col-span-1"></div>
            <div className="flex items-center space-x-3 mb-6"></div>
              <div className="relative"></div>
                <div className="w-12 h-12 bg-gradient-to-br from-purple-500 to-blue-600 rounded-xl flex items-center justify-center"></div>
                  <Rocket className="w-6 h-6 text-white" />
                </div>
                <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl blur opacity-75 -z-10"></div>
              </div>
              <div></div>
                <h3 className="text-xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent"></h3>
                  Zion Tech Group
                </h3>
            ...
            <p className="text-purple-200 mb-6 leading-relaxed"></p>
            ...
            <div className="space-y-3"></div>
              <div className="flex items-center space-x-3 text-purple-200"></div>
              ...
              <div className="flex items-center space-x-3 text-purple-200"></div>
                ...
                <a href={contactInfo.website} className="text-sm hover:text-white transition-colors"></a>
                  {contactInfo.website
  },
                </a>
              </div>
          ...
          <div className="lg:col-span-2"></div>
            <h3 className="text-lg font-semibold text-white mb-6 border-b border-purple-500/30 pb-2"></h3>
              🚀 Our Services
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8"></div>
              {serviceCategories.map((category) => (
                <div key={category.title} className="space-y-3"></div>
          ...
          <div className="lg:col-span-1"></div>
            ...
            {/* Newsletter Signup */}
            <div className="bg-purple-900/20 border border-purple-500/30 rounded-lg p-4"></div>
              <h4 className="font-medium text-white mb-3">Stay Updated</h4>
              <p className="text-sm text-purple-200 mb-3"></p>
              ...
              <div className="flex space-x-2"></div>
                ...
                />
                <button className="px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded text-sm hover:from-purple-700 hover:to-blue-700 transition-all duration-300 transform hover:shadow-xl hover:shadow-cyan-500/30"></button>
                  Subscribe
                </button>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6"></div>
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0"></div>
            ...
            <div className="flex items-center space-x-6 text-sm"></div>
              <Link href="/privacy" className="text-purple-300 hover:text-white transition-colors"></Link>
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-purple-300 hover:text-white transition-colors"></Link>
                Terms of Service
              </Link>
              <Link href="/cookies" className="text-purple-300 hover:text-white transition-colors"></Link>
                Cookie Policy
              </Link>
              <Link href="/security" className="text-purple-300 hover:text-white transition-colors"></Link>
                Security
              </Link>
            </div>
          </div>

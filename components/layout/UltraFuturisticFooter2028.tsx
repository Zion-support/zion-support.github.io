...
className='text-purple-300 hover:text-white transition-colors'>                Security            {/* Copyright */}
  ...
  website: 'https://ziontechgroup.com',};  website: any
      { name: 'Quantum Internet Protocol', href: any
      { name: 'AI Education Platform', href: any
      { name: 'AI Content Creation Suite', href: any
      { name: 'Smart City Infrastructure Management', href: any
      { name: 'IoT Energy Management System', href: any
      { name: 'Digital Twin Manufacturing Platform', href: any
      { name: 'Autonomous Manufacturing AI', href: any
      { name: 'Quantum Financial Trading Platform', href: any
      { name: 'Quantum Machine Learning Platform', href: any
      { name: 'Quantum Internet Security Gateway', href: any
      { name: 'Quantum Internet Protocol', href: any
      { name: 'AI Customer Service Automation', href: any
      { name: 'AI Education Platform', href: any
      { name: 'AI Content Creation Suite', href: any
      { name: 'AI Climate Prediction Platform', href: any
      { name: 'Quantum Cybersecurity Firewall', href: any
      { name: 'Autonomous Drone Delivery Network', href: any
      { name: 'AI Healthcare Diagnosis Platform', href: any
      { name: 'Smart City Infrastructure Management', href: any
      { name: 'IoT Energy Management System', href: any
      { name: 'Digital Twin Manufacturing Platform', href: any
      { name: 'Autonomous Manufacturing AI', href: any
  website: 'https://ziontechgroup.com', }  website: any
      ...
      { name: 'AI Education Platform', href: any
      { name: 'AI Content Creation Suite', href: any
      { name: 'AI Legal Research Platform', href: any

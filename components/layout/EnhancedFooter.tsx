...
{ name: 'Resources'}
  ...
  _services: [;
      { name: 'AI Multimodal Fusion'}
  _href: '/ai-multimodal-fusion-platform}
},{_name: 'AI Autonomous Decision Engine'}
  _href: '/ai-autonomous-decision-engine}
  ...
  _services: [;
      { name: 'Zero Trust Architecture'}
  _href: '/zero-trust-network-architecture}
},{_name: 'Edge Computing Orchestration'}
  _href: '/edge-computing-orchestration}
  ...
  _services: [;
      { name: 'AI Brand Personality'}
  _href: '/ai-brand-personality-generator}
},{_name: 'Virtual Event Holograms'}
  _href: '/virtual-event-hologram-platform}

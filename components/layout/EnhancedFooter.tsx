        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/it-services" className="text-gray-300 hover:text-white">IT Services</Link></li>            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/blog" className="text-gray-300 hover:text-white">Blog</Link></li>            </ul>
          </div>
          <div>

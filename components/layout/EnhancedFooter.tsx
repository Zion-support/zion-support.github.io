...
const "EnhancedFooter": React.FC = () => {
  ...
  const services = [{ name: 'AI Services', href: '/ai-services' },
  ...
  const resources = [{ name: 'FAQ', href: '/faq' },
              ...
              {services.map((service) => (
                <li key={service.name}>
                  <Link href={service.href}>
                    <span className="text-gray-300 hover:text-white transition-colors>{service.name}</span> </Link"
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {company.map((item) => (
                <li key={item.name}>
                  <Link href={item.href}>
                    <span className="text-gray-300 hover:text-white transition-colors>{item.name}</span> </Link"
                </li>
              ))}
            </ul>
          </div>

      ...
      children: [
        {
          ...
          description: 'Autonomous AI systems and workflows',
        },
        {
          name: 'Cloud & DevOps',
          href: '/services/cloud',
          ...
          <div className='hidden lg:flex lg:items-center lg:space-x-8'>
            {navigation.map(item => (
              <div key={item.name} className='relative group'>
                ...
                {item.children && (
                  <div
                    className={`absolute top-full left-0 mt-2 w-80 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl shadow-cyan-500/25 p-4 transition-all duration-200 ${

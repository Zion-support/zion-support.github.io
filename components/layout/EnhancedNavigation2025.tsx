...
export default function EnhancedNavigation2025() {
  ...
  return (
    <>
      {/* Top Contact Bar */}
      <div className="bg-gradient-to-r from-cyan-900 to-purple-900 text-white py-2"></div>
        <div className="container mx-auto px-4"></div>
          <div className="flex flex-col sm:flex-row justify-between items-center text-sm"></div>
            <div className="flex items-center gap-4 mb-2 sm:mb-0"></div>
        ...
        <div className="flex justify-between items-center h-20">
          {/* Logo */}
            <Link href="/" className="flex items-center space-x-3 group"></Link>
              <div className="relative"></div>
                <div className="w-10 h-10 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300"></div>
                          ...
                          {item.submenu?.map((subitem) => (
                            ...
                            >
                              <div className="flex items-start space-x-3"></div>
                                {subitem.icon && (
                                  <div className="p-2 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-lg group-hover:from-cyan-500/30 group-hover:to-purple-500/30 transition-all duration-200"></div>
                                    <subitem.icon className="w-5 h-5 text-cyan-400" />
                                  </div>
                                )}
                                <div className="flex-1"></div>
                                  <h3 className="font-semibold text-white group-hover:text-cyan-400 transition-colors duration-200"></h3>
                                    {subitem.name
  },
                                  </h3>
          ...
          className="px-2 py-1 bg-gray-800 text-gray-300 text-xs rounded-md"
                                      ...
                                      {subitem.services.length > 2 && (
                                        <span className="px-2 py-1 bg-gray-800 text-gray-300 text-xs rounded-md"></span>
        ...
        {isOpen && (
          <motion.div
            ...
            transition={{ duration: 0.3 }}
                      {item.badge && (
                        <span className="px-2 py-1 text-xs font-medium bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-full"></motion>
                          {item.badge
  },
                        </span>
                      )}
          ...
          >
            ...
            {/* Menu Panel */}
            <div className="absolute right-0 top-0 h-full w-80 bg-gray-900/95 backdrop-blur-md border-l border-gray-700/50 overflow-y-auto"></div>
              <div className="p-6"></div>
                {/* Close Button */}
                    ...
                    <div key={item.name}></div>
                      ...
                      <AnimatePresence></AnimatePresence>
                        {activeSubmenu === item.name && (
                          ...
                          ></motion>
                            {item.submenu</motion>?.map((subitem) => (
                              <Link
                                key={subitem.name
  },
                                href={subitem.href
                ...
                {/* Mobile Contact Info */}
                <div className="mt-8 pt-6 border-t border-gray-700/50"></div>
                  <div className="space-y-3 text-sm"></div>
                    ...
                    <div className="flex items-start space-x-3 text-gray-400"></div>

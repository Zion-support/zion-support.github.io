...
onClick={() => setActiveSubmenu(activeSubmenu === item.name ? null : item.name)}
                        ...
                        <div className="flex items-center space-x-3">,
                          ...
                          <span className="text-white font-medium">{item.name}
...
key={subitem.name}
                                ...
                                <h4 className="text-white font-medium">{subitem.name}
                                <p className="text-sm text-gray-400 mt-1">{subitem.description}
                              </Link>))}
                          </motion.div>)}
				...
				<div className="max-w-7xl mx-auto px-4 py-2">,
					<div className="flex items-center justify-between text-sm">,
						...
						<div className="flex items-center gap-2">,
							...
							<span className="text-yellow-400 font-semibold">Revolutionary Technology Solutions
				...
				<div className="flex items-center justify-between h-16">,
					...
					<Link href="/" className="flex items-center gap-3 group">,
						<div className="relative">,
							...
							<div className="absolute -inset-1 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg blur opacity-20 group-hover:opacity-40 transition-opacity duration-300">
						
						<div className="hidden sm:block">,
							<div className="text-xl font-bold bg-gradient-to-r from-white to-cyan-300 bg-clip-text text-transparent">Zion Tech Group
							<div className="text-xs text-gray-400">Future Technology Solutions

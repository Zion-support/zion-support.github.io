        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <motion.div 
              ...
              transition={{ type: "spring", stiffness: 400, damping: 10 }}><Link href="/" className="flex items-center space-x-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className='hidden lg:flex items-center space-x-8'>
              ...
              <div className="relative group">
                <button
                  ...
                  className="flex items-center space-x-2 text-gray-300 hover:text-white transition-colors duration-200 py-2 px-3 rounded-lg hover:bg-gray-800/50"><span>Services</span>
            ...
            <div className="hidden lg:flex items-center space-x-8">
                ...
                <AnimatePresence>
                  {activeCategory === 'services' && (
                    <motion.div
                      ...
                      onMouseEnter={() => setActiveCategory('services')}
                      onMouseLeave={() => setActiveCategory(null)}
                      className='absolute top-full left-0 w-screen max-w-6xl bg-gray-900/95 backdrop-blur-xl border border-purple-500/20 rounded-2xl shadow-2xl p-8 -ml-4'><div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
                            ...
                            <div className="space-y-3">
                              {category.services.map((service) => (
                                <Link
                                  key={service.name}
                                  href={service.href}
                                  className="block group"><div className="p-3 rounded-lg hover:bg-gray-800/50 transition-all duration-200">
              ...
              {quickLinks.map((link) => (
                <Link
                  key={link.name}
                  href={link.href}
                  className="text-gray-300 hover:text-white transition-colors duration-200 py-2 px-3 rounded-lg hover:bg-gray-800/50">{link.name}
                </Link>
              ))}
            ...
            <div className='lg:hidden'>
              <button
                onClick={toggleMenu}
                className="text-gray-300 hover:text-white transition-colors duration-200 p-2">{isOpen ? (
                  <X className='w-6 h-6' />
                ) : (
            ...
            <div className="lg:hidden">
              <button
                onClick={toggleMenu}
                className="text-gray-300 hover:text-white transition-colors duration-200 p-2">{isOpen ? <X className="w-6 h-6" /> : <Menu className="w-6 h-6" />}
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className='lg:hidden bg-gray-900/95 backdrop-blur-xl border-t border-purple-500/20'><div className="px-4 py-6 space-y-6">
                {/* Mobile Services */}
                      ...
                      <div className="ml-4 space-y-1">
                        {category.services.map((service) => (
                          <Link
                            ...
                            href={service.href}
                            onClick={closeMenu}
                            className='block text-sm text-gray-400 hover:text-cyan-400 transition-colors'>{service.name}
                          </Link>
                        ))}
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {quickLinks.map((link) => (
                      <Link
                        ...
                        href={link.href}
                        onClick={closeMenu}
                        className='text-sm text-gray-400 hover:text-cyan-400 transition-colors'>{link.name}
                      </Link>
                    ))}
                  </div>
                </div>

...
<<<<<<< HEAD
      <div className='absolute inset-0 overflow-hidden' />
        <div className='absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(6,182,212,,,
  0.05),transparent_50%)]' /></div>
...
origin/cursor/automate-test-improve-and-merge-code-2533
  ...
  Phone,Mail,MapPin,Globe,ArrowRight,Star,Shield,Brain,DollarSign,Dna,Rocket,Users,Award,Zap,Facebook,Twitter,Linkedin,Instagram,Youtube,Github,} from 'lucide-react';import {Phone, Mail, MapPin, Globe, ArrowRight, Star, Shield,Brain, DollarSign, Dna, Rocket, Users, Award, Zap;
  Facebook, Twitter, Linkedin, Instagram, Youtube, Github;
          ...
          {serviceCategories.map((category, index) => (
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}href={service.href}
                    ...
                    >;
                      <ArrowRight className="w - 3 h - 3 mr - 2 group - hover:translate - x-1 transition - transform duration - 300" />;transition={{ duration: 0.6, delay: index * 0.1 }}
            >;
...
<h4 className='text-lg font-semibold text-white mb-4 flex items-center'>
            ...
            <ul className="space - y-2">;
              {company_links.map ((link, index) => (<li key={index}>;
                  <Link;
                    href={link.href}
                    className="text - gray - 400 hover:text - cyan - 400 transition - colors duration - 300 text - sm";
                  >;href={link.href}
...
<<<<<<< HEAD
  ...
  index) => (}
                <Link key={index}
            href={social.href className='w-12 h-12 bg-gray-800 hover: bg-cyan-600 rounded-xl flex items-center justify-center transition-all duration-300 group'
                 />
         ...
         />
          <div className='text-center' />
            ...
            <p className='text-gray-300 mb-6 max-w-2xl mx-auto' />
              Get exclusive access to our latest AI, quantum computing
            and;
=======
          transition={{ duration: 0.6, delay: 0.5 }
}
...
<<<<<<< HEAD
        ...
        >
          ...
          <div className='flex flex-col md:flex-row justify-between items-center'>;
            <div className='text-gray-400 text-sm mb-4 md:mb-0'>;
              © 2026 Zion Tech Group. All rights reserved. |;transition={{ duration: 0.6, delay: 0.6 }}
className='border-t border-gray-800 pt-8';
        >;
          <div className='flex flex-col md:flex-row justify-between items-center'>;
            <div className='text-gray-400 text-sm mb-4 md:mb-0'>;

      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <motion.div
              ...
              transition={{ duration: 0.6 }}><div className='flex items-center mb-6'>
          ...
          {serviceCategories.map((category, index) => (
            <motion.div
              ...
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: index * 0.1 }}><h4 className='text-lg font-semibold text-white mb-4 flex items-center'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-12'>
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.2 }}><h4 className='text-lg font-semibold text-white mb-4 flex items-center'>
              ...
              {companyLinks.map((link, index) => (
                <li key={index}>
                  <Link 
                    href={link.href}
                    className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 text-sm"
                    className="text-gray-400 hover:text-cyan-400 transition-colors duration-300 text-sm">{link.name}
                  </Link>
                </li>
              ))}
            </ul>
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.3 }}><h4 className='text-lg font-semibold text-white mb-4 flex items-center'>
          ...
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.4 }}><h4 className='text-lg font-semibold text-white mb-4 flex items-center'>
            ...
            <div className="grid grid-cols-3 gap-4">
              {socialLinks.map((social, index) => (
                <Link
                  key={index}
                  href={social.href}
                  className='w-12 h-12 bg-gray-800 hover:bg-cyan-600 rounded-xl flex items-center justify-center transition-all duration-300 group'><social.icon className='w-5 h-5 text-gray-400 group-hover:text-white transition-colors duration-300' />
                  className="w-12 h-12 bg-gray-800 hover:bg-cyan-600 rounded-xl flex items-center justify-center transition-all duration-300 group"><social.icon className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors duration-300" />
                  className="w-12 h-12 bg-gray-800 hover:bg-cyan-600 rounded-xl flex items-center justify-center transition-all duration-300 group"><social.icon className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors duration-300" />
                </Link>
              ))}
        ...
        <motion.div
          ...
          className='bg-gradient-to-r from-gray-800 to-gray-900 rounded-3xl p-8 border border-gray-700 mb-12'><div className="text-center">
        ...
        <motion.div
          ...
          className='border-t border-gray-800 pt-8'><div className="flex flex-col md: flex-row justify-between items-center">

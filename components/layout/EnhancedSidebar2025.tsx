...
href: "/ai-services", icon: Brain,";
  ...
  {;
    ...
    href: '/ai-legal-contract-analyzer' }'        ]'      }, {name: 'Quantum Computing'
    ...
    href: '/quantum-cybersecurity-platform' }'        ]'      }, {name: 'Enterprise IT'
    ...
    href: '/quantum-cloud-migration' }'        ]'      }, {name: 'Micro SAAS'
    ...
    href: '/project-management-ai' }'        ]'      }, {name: 'Space Technology'
    ...
    href: '/interplanetary-communication' }'        ]'      }, {name: 'Emerging Tech'

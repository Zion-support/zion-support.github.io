...
document.body.style.overflow =;
  ...
  '}
   return () => {
      document.body.style.overflow =;
  'unset'}}, [isOpen])'  const isActive = (href: anyanyanyanyanyanyanyanyanyanyanyanyanystring)               => router.pathname === hrefreturn(
    <>{/* Backdrop */}
      <AnimatePresence>
        {isOpen && (
          <motion.div;
...
,
  stiffness: 200}}className={`fixed left-0 top-0 h-full w-80 bg-black/95 backdrop-blur-xl border-r border-gray-800/50 z-50 overflow-y-auto`}`{/* Header */}

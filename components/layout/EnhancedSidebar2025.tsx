...
import Link from 'next/link.ts';'import { motion, AnimatePresence               } from 'framer-motion.ts';
...
<<<<<<< HEAD
    title: anyanyanyanyanyanyanyanyanyanyanyanyany&apos;Revolutionary Services', icon: Zap,'    color: 'from-cyan-500 to-blue-600', items['      {';
        name: 'AI & Consciousness','        href: '/ai-services', icon: Brain,'        description: 'Advanced AI consciousness and evolution platforms', subItems['          { name: 'AI Consciousness Evolution', href: '/ai-consciousness-evolution'
        ...
        name: 'Quantum Computing','        href: '/quantum-services', icon: Atom,'        description: 'Next-generation quantum computing solutions', subItems['          { name: 'Quantum Cloud Infrastructure', href: '/quantum-cloud-infrastructure'
        ...
        name: 'Enterprise IT','        href: '/enterprise-it', icon: Shield,'        description: 'Enterprise-grade IT infrastructure and security', subItems['          { name: 'Edge Computing Orchestrator', href: '/edge-computing-orchestration'
        ...
        name: 'Micro SAAS','        href: '/micro-saas', icon: Rocket,'        description: 'AI-powered micro SAAS solutions', subItems['          { name: 'AI Content Factory Platform', href: '/ai-content-factory'
        ...
        name: 'Space Technology','        href: '/space-tech', icon: Globe,'        description: 'Cutting-edge space exploration and mining', subItems['          { name: 'Space Mining Platform', href: '/space-mining-platform'
        ...
        name: 'Emerging Tech','        href: '/emerging-tech', icon: Sparkles,'        description: 'Future technologies and innovations', subItems['          { name: 'Brain-Computer Interface', href: '/brain-computer-interface'
...
,
  ...
  /ai-consciousness-evolution' }, { name: 'AI Autonomous Ecosystem, href:,
  /ai-autonomous-ecosystem' }, { name: 'AI Ethics & Governance, href:,
  /ai-ethics-governance' }, { name: 'AI Creativity Studio, href:,
  /ai-creativity-studio' }, { name: 'AI Education Platform, href:,
  /ai-education-platform' }, { name: 'AI Healthcare Diagnostics, href:,
  /ai-healthcare-diagnostics' }, { name: 'AI Financial Intelligence, href:,
  /ai-financial-intelligence' }, { name: 'AI Sustainability Platform, href:,
  /ai-sustainability-platform' }, { name: 'AI Emotional Intelligence, href:,
  /ai-emotional-intelligence-platform' }, { name: 'AI Legal Contract Analyzer, href:,
  /ai-legal-contract-analyzer' }
  '        ]'      }, {;

        name: 'Quantum Computing,
,
  href: '/quantum-services, icon: Atom,'        description:,
  Next-generation quantum computing solutions', subItems[
  '          { name: 'Quantum Cloud Infrastructure, href:,
  /quantum-cloud-infrastructure
  ' }, { name: 'Quantum Bio-Computing, href:,
  /quantum-bio-computing
  ' }, { name: 'Quantum Energy Platform, href:,
  /quantum-energy-platform
  ' }, { name: 'Quantum Materials Discovery, href:,
  /quantum-materials-discovery
  ' }, { name: 'Quantum Robotics, href:,
  /quantum-robotics
  ' }, { name: 'Quantum Internet Security, href:,
  /quantum-internet-security
  ' }, { name: 'Quantum Logistics, href:,
  /quantum-logistics-optimization
  ' }, { name: 'Quantum Cybersecurity, href:,
...
,
  ...
  /edge-computing-orchestration' }, { name: 'Zero Trust Security Platform, href:,
  /zero-trust-network-architecture' }, { name: 'Blockchain Enterprise Platform, href:,
  /blockchain-infrastructure-platform' }, { name: 'AI-Powered DevOps, href:,
  /ai-powered-devops' }, { name: 'Quantum Networking, href:,
  /quantum-networking' }, { name: 'Autonomous IT Operations, href:,
  /autonomous-it-operations' }, { name: 'Quantum Data Center, href:,
  /quantum-data-center' }, { name: 'Quantum Cloud Migration, href:,
  /quantum-cloud-migration' }
  '        ]'      }, {;

        name: 'Micro SAAS,
,
  href: '/micro-saas, icon: Rocket,'        description:,
  AI-powered micro SAAS solutions', subItems[
  '          { name: 'AI Content Factory Platform, href:,
  /ai-content-factory
  ' }, { name: 'CRM Intelligence & Automation, href:,
  ...
  ' }, { name: 'Financial Analytics Platform, href:,
  /financial-analytics-platform
  ' }, { name: 'Supply Chain Intelligence, href:,
  /supply-chain-intelligence
  ' }, { name: 'Marketing Automation Platform, href:,
  ...
  '/space-tech', icon: Globe,
,
  description: 'Cutting-edge space exploration and mining, subItems[,
  { name: 'Space Mining Platform, href:,
  /space-mining-platform' }, { name: 'Satellite Technology, href:,
  /satellite-technology' }, { name: 'Space Resource Management, href:,
  /space-resource-management' }, { name: 'Interplanetary Communication, href:,
  /interplanetary-communication' }
  '        ]'      }, {;

        name: 'Emerging Tech,
,
  href: '/emerging-tech, icon: Sparkles,'        description:,
  Future technologies and innovations', subItems[
  '          { name: 'Brain-Computer Interface, href:,
  /brain-computer-interface
  ' }, { name: 'Autonomous Vehicle AI, href:,
  /autonomous-vehicle-ai
  ' }, { name: 'Advanced Robotics, href:,
  /advanced-robotics
  ' }, { name: 'Biotechnology Platform, href:,
...
<<<<<<< HEAD
        name: 'Healthcare', href: '/healthcare-solutions','        icon: Heart, description: 'AI-powered healthcare diagnostics and solutions','        subItems['          { name: 'AI Healthcare Diagnostics', href: '/ai-healthcare-diagnostics'
       },'          { name: 'Medical Imaging AI', href: '/medical-imaging-ai'
       },'          { name: 'Drug Discovery Platform', href: '/drug-discovery-platform'
       }'        ]'      }, {;

        name: 'Financial Services','        href: '/financial-solutions', icon: BarChart3,'        description: 'Advanced financial intelligence and analytics', subItems['          { name: 'AI Financial Intelligence', href: '/ai-financial-intelligence'
       }, { name: 'Quantum Trading Platform', href: '/quantum-financial-trading'
       }, { name: 'Risk Assessment AI', href: '/risk-assessment-ai'
       }'        ]'      }, {;

        name: 'Manufacturing','        href: '/manufacturing-solutions', icon: Settings,'        description: 'Industry 4.0 and smart manufacturing', subItems['          { name: 'Smart Factory Platform', href: '/smart-factory-platform'
       }, { name: 'Predictive Maintenance AI', href: '/predictive-maintenance-ai'
       }, { name: 'Quality Control AI', href: '/quality-control-ai'
       }'        ]'      }, {;

        name: 'Retail & E-commerce','        href: '/retail-solutions', icon: Eye,'        description: 'E-commerce optimization and retail intelligence', subItems['          { name: 'E-commerce Optimization', href: '/ecommerce-optimization-platform'
       }, { name: 'Customer Behavior AI', href: '/customer-behavior-ai'
       }, { name: 'Inventory Management AI', href: '/inventory-management-ai'
       }'        ]'      }, {;

        name: 'Government & Defense','        href: '/government-solutions', icon: Shield,'        description: 'Secure government and defense solutions', subItems['          { name: 'Cybersecurity Platform', href: '/quantum-cybersecurity-platform'
       }, { name: 'Data Protection AI', href: '/data-protection-ai'
       }, { name: 'Threat Detection AI', href: '/threat-detection-ai'
       }'        ]'      }, {;

        name: 'Education','        href: '/education-solutions', icon: Award,'        description: 'AI-powered education and learning platforms', subItems['          { name: 'AI Education Platform', href: '/ai-education-platform'
...
<<<<<<< HEAD
        name: 'About Us', href: '/about','        icon: Users, description: 'Learn about Zion Tech Group','        subItems['          { name: 'Our Mission', href: '/mission'
       },'          { name: 'Leadership Team', href: '/leadership'
       },'          { name: 'Comp History', href: '/history'
       },'          { name: 'Careers', href: '/careers'
       }'        ]'      }, {;

        name: 'Resources','        href: '/resources', icon: BookOpen,'        description: 'Educational content and documentation', subItems['          { name: 'Documentation', href: '/docs'
        ...
        name: 'Support','        href: '/support', icon: HelpCircle,'        description: 'Get help and support', subItems['          { name: 'Contact Support', href: '/contact-support'
       }, { name: anyanyanyanyanyanyanyanyanyanyanyanyany&apos;Training Programs', href: '/training';'},;'          { name: 'Community Forum', href: '/community'
...
,
  ...
  /api-docs' }, { name: 'Blog & News, href:,
  /blog' }, { name: 'Case Studies, href:,
  /case-studies' }, { name: 'Whitepapers, href:,
  /whitepapers' }, { name: 'Webinars, href:,
  /webinars' }
  '        ]'      }, {;

        name: 'Support,
,
  href: '/support, icon: HelpCircle,'        description:,
  Get help and support', subItems[
...
<<<<<<< HEAD
initial={{ x: '-100%'
       }}'        animate={{ x: isOpen ? 0 : '-100%' }}'        transition = {'

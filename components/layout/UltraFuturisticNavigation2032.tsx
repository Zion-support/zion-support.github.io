...
<div className='flex items-center space-x-4'>;'
      ...
      {/* Main Navigation */}
<nav;
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled;`            ? 'bg-black/95 backdrop-blur-xl border-b border-cyan-500/20 shadow-2xl shadow-cyan-500/10';'
            : 'bg-transparent';'
        }`}>`
        <div className='max-w-7xl mx-auto px-4 "sm":px-6 "lg":px-8'>;'
...
=======
      ...
      {/* Main Navigation */}
      <nav;
        className={`fixed top - 0 left - 0 right - 0 z - 50 transition - all duration - 300 ${is_scrolled;`            ? 'bg - black / 95 backdrop - blur - xl border - b border - cyan - 500 / 20 shadow - 2xl shadow - cyan - 500 / 10';'
            : 'bg - transparent';'
        }`}>`
        <div className='max - w-7xl mx - auto px - 4 "sm":px - 6 "lg":px - 8'>;'
          <div className='flex items - center justify - between h - 20'>;'

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <motion.div
            ...
            className='flex items-center'><Link href="/" className="flex items-center space-x-3 group">
              ...
              <div key={item.name} className="relative group">
                {item.dropdown ? (
                  <button
                    ...
                    className="flex items-center space-x-2 text-gray-300 hover:text-white transition-colors duration-300 py-2">{item.icon && <item.icon className="w-4 h-4" />}
                    <span>{item.name}</span>
                    <ChevronDown
                  ...
                  <AnimatePresence>
                    {activeDropdown === item.name && (
                      <motion.div
                        ...
                        className='absolute top-full left-0 mt-2 w-80 bg-gray-900/95 backdrop-blur-xl border border-gray-700/50 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden'><div className="p-4">
                          ...
                          <div className="space-y-2">
                            {item.dropdown.map((dropdownItem) => (
                              <Link
                                ...
                                className="flex items-center space-x-3 p-3 rounded-xl hover:bg-gray-800/50 transition-colors duration-200 group"><div className="w-10 h-10 bg-gradient-to-r from-cyan-500/20 to-purple-600/20 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
          ...
          <div className='hidden lg:flex items-center space-x-6'>
            <div className='flex items-center space-x-4 text-sm text-gray-300'>
              <a
                ...
                className='flex items-center space-x-2 hover:text-cyan-400 transition-colors duration-200'><Phone className='w-4 h-4' />
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className='lg:hidden bg-gray-900/95 backdrop-blur-xl border-t border-gray-800/50 overflow-hidden'><div className='px-4 py-6 space-y-4'>
                ...
                <div key={item.name}>
                  {item.dropdown ? (
                        ...
                        <div className="ml-8 mt-2 space-y-2">
                          {item.dropdown.map((dropdownItem) => (
                            <Link
                              ...
                              className='block py-2 text-gray-400 hover:text-white transition-colors duration-200'>{dropdownItem.name}
                            </Link>
                          ))}
                        </div>
                      )}
                    ...
                    <Link
                      href={item.href}
                      onClick={() => setIsOpen(false)}
                      className='flex items-center space-x-3 text-gray-300 hover:text-white transition-colors duration-200 py-3'>{item.icon && <item.icon className='w-5 h-5' />}
                      className="flex items-center space-x-3 text-gray-300 hover:text-white transition-colors duration-200 py-3">{item.icon && <item.icon className="w-5 h-5" />}
                      className="flex items-center space-x-3 text-gray-300 hover:text-white transition-colors duration-200 py-3">{item.icon && <item.icon className="w-5 h-5" />}
                      <span>{item.name}</span>
                    </Link>

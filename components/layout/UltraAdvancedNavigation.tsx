...
<<<<<<< HEAD
  ...
  const [isOpen, setIsOpen] = useState(false)const [isScrolled, setIsScrolled] = useState(false)const [activeDropdown, setActiveDropdown] = useState<string | null>(null)useEffect(() => {const handleScroll = () => {setIsScrolled(window.scrollY > 50)}window.addEventListener('scroll', handleScroll)return () => window.removeEventListener('scroll', handleScroll)}, [])const navigationItems = [;
    {name: 'Home',href: '/',icon: null,},{name: 'AI Services';
      ...
      dropdown: [;
      description: 'Benchmarks & vendor references';
    }{name: 'AI Agent Orchestrator',href: '/ai-agents',icon: Bot,description: 'Multi-agent workflow automation',price: '$2,999/month',},{name: 'AI Cybersecurity',href: '/security',icon: Shield,description: 'AI-powered threat detection',price: '$4,999/month',},{name: 'AI Healthcare Analytics',href: '/ai-data-analytics',icon: Dna,description: 'Patient outcome prediction',price: '$3,999/month',},{name: 'AI Supply Chain',href: '/quantum-logistics',icon: Package,description: 'End-to-end optimization',price: '$2,499/month',},{name: 'AI Financial Risk',href: '/ai-financial-risk',icon: DollarSign,description: 'Advanced risk management',price: '$5,999/month',},],},{name: 'Quantum Computing',href: '#',icon: Atom,description: 'Quantum-powered solutions',dropdown: [;
        {name: 'Quantum AI Supercomputer',href: '/quantum-ai-cognitive',icon: Cpu,description: 'Enterprise quantum computing',price: '$15,999/month',},{name: 'Quantum Internet Security',href: '/quantum-internet-security-platform',icon: Lock,description: 'Future-proof encryption',price: '$8,999/month',},{name: 'Quantum Drug Discovery',href: '/biotech-ai',icon: Dna,description: 'Accelerated drug development',price: '$12,999/month',},{name: 'Quantum Financial Trading',href: '/quantum-financial-trading',icon: DollarSign,description: 'Nanosecond precision trading',price: '$19,999/month',},{name: 'Quantum IoT Platform',href: '/quantum-iot',icon: Wifi,description: 'Quantum-secured IoT',price: '$4,999/month',},],},{name: 'Space Technology',href: '#',icon: Rocket,description: 'Space mission management',dropdown: [;
        {name: 'Space Mission Control',href: '/space-technology',icon: Rocket,description: 'Complete mission management',price: '$25,999/month',},{name: 'Space Debris Cleanup',href: '/space-technology',icon: Package,description: 'AI-powered debris removal',price: '$35,999/month',},],},{name: 'Enterprise IT',href: '#',icon: Building2,description: 'Enterprise solutions',dropdown: [;
        {name: 'Cloud Migration',href: '/cloud-platform',icon: Cloud,description: 'Zero-downtime migration',price: '$8,999/month',},{name: 'DevOps Automation',href: '/automation',icon: Code,description: 'AI-powered automation',price: '$5,999/month',},{name: 'Data Analytics',href: '/ai-data-analytics',icon: Database,description: 'AI-powered insights',price: '$6,999/month',},{name: 'Security Operations',href: '/security',icon: Shield,description: '24/7 security monitoring',price: '$12,999/month',},{name: 'API Management',href: '/api-observability',icon: Code,description: 'Complete lifecycle management',price: '$4,999/month',},{name: 'Digital Transformation',href: '/solutions',icon: Zap,description: 'AI-powered transformation',price: '$15,999/month',},{name: 'IoT Management',href: '/it-asset-discovery-agent',icon: Wifi,description: 'AI-powered device management',price: '$7,999/month',},],},{name: 'Micro SaaS',href: '/services',icon: Monitor,description: '300+ micro SaaS services',},{name: 'Market Pricing';
      href: '/market-pricing';
      icon: DollarSign;
      description: 'Benchmarks & vendor references';
    },    {name: 'Market Pricing',href: '/market-pricing',icon: DollarSign,description: 'Benchmarks & vendor references',},{name: 'About',href: '/about',icon: null,},{>;
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>;
        <div className='flex justify-between items-center h-20'>          {/* Logo */}  return (<navclassName={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled;
...
{
  name: 'Quantum Computing', href: '#', icon: Atom, description: 'Quantum-powered solutions', dropdown: [ {
  name: 'Quantum AI Supercomputer', href: '/quantum-ai-cognitive', icon: Cpu, description: 'Enterprise quantum computing', price: '$15, 999/month' 
}
{
...
{
  name: 'Quantum Financial Trading', href: '/quantum-financial-trading', icon: DollarSign, description: 'Nanosecond precision trading', price: '$19, 999/month' 
}
{

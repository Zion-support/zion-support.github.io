...
const contactInfo = {
  ...
  website: 'https://ziontechgroup.com',};  website: 'https://ziontechgroup.com'
    ...
    services: [
      ...
      { name: '5G Private Networks', href: '/5g-private-network-solutions-2028', description: 'Enterprise 5G solutions', price: 'Custom pricing' }      { name: 'Blockchain Infrastructure', href: '/blockchain-infrastructure-platform-2028', description: 'Enterprise blockchain', price: 'Custom pricing' }
    ]
  }
...
=======
                  ...
                  <span className='font-medium'>{item.name}</span>                  <ChevronDown className='w-4 h-4 group-hover:rotate-180 transition-transform duration-300' />                </motion.button>                  <div className={`p-2 rounded-lg bg-gradient-to-br ${item.color} shadow-lg`}>
                    {item.icon}
                  </div>
...
=======
                              ...
                              </div>                                <ChevronRight className='w-4 h-4 text-gray-500 group-hover:text-cyan-400 transition-colors' />                              </div>
                        ...
                        <div className="space - y-2">;
                          {item.children.map ((child) => (
                            <Link;
                              ...
                              href={child.href}
                              key={child.name}
                              href={child.href}                              className="flex items-center space-x-3 p-3 rounded-xl hover:bg-gray-800/50 transition-all duration-200 group"
                            >

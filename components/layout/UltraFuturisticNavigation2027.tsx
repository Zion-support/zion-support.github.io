              ...
              <div key={item.name} className="relative group">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}><div
                    className={`p-2 rounded-lg bg-gradient-to-br ${item.color} shadow-lg`}>{item.icon}
                  </div>
                ...
                <AnimatePresence>
                  {activeDropdown === item.name && (
                    <motion.div
                      ...
                      className='absolute top-full left-0 mt-2 w-96 bg-gray-900/95 backdrop-blur-xl border border-gray-700/50 rounded-2xl shadow-2xl shadow-cyan-500/20 overflow-hidden'><div className="p-4">
          ...
          <div className="flex items-center space-x-4">
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}><Link
                href="/contact"
                className="hidden lg:inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-medium rounded-xl shadow-lg shadow-cyan-500/30 hover:shadow-xl hover:shadow-cyan-500/40 transition-all duration-300"><Rocket className='w-4 h-4' />
            <motion.div
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}><Link
                href="/contact"
            ...
            <button
              ...
              className='xl:hidden p-2 text-gray-300 hover:text-white transition-colors'>{isMenuOpen ? (
                <X className='w-6 h-6' />
              ) : (
                <Menu className='w-6 h-6' />
              )}
              className="xl:hidden p-2 text-gray-300 hover:text-white transition-colors">{isMenuOpen ? <X className="w-6 h-6" /> : <Menu className="w-6 h-6" />}
              className="xl:hidden p-2 text-gray-300 hover:text-white transition-colors">{isMenuOpen ? <X className="w-6 h-6" /> : <Menu className="w-6 h-6" />}
            </button>
          </div>
        </div>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className='xl:hidden bg-gray-900/95 backdrop-blur-xl border-t border-gray-700/50'><div className="container mx-auto px-4 py-6">
            ...
            className="xl:hidden bg-gray-900/95 backdrop-blur-xl border-t border-gray-700/50"><div className="container mx-auto px-4 py-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      <a 
                        href={`tel:${contactInfo.mobile}`}
                        className="flex items-center space-x-3 p-3 rounded-xl hover:bg-gray-800/50 transition-all duration-200"><Phone className="w-4 h-4 text-cyan-400" />
              ...
              <div className='mt-6 pt-6 border-t border-gray-700/50'>
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center w-full px-6 py-3 bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-medium rounded-xl shadow-lg shadow-cyan-500/30 transition-all duration-300"><Rocket className='w-4 h-4 mr-2' />
              <div className="mt-6 pt-6 border-t border-gray-700/50">
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center w-full px-6 py-3 bg-gradient-to-r from-cyan-500 to-purple-600 text-white font-medium rounded-xl shadow-lg shadow-cyan-500/30 transition-all duration-300"><Rocket className="w-4 h-4 mr-2" />

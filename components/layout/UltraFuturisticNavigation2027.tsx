...
import { 
  ...
  CloudSmartphonePaletteSearchMessageSquare
  FileTextCalendarCreditCardBarChart3Settings,
  RocketStarTrendingUpUsersTargetAward,
  PhoneMailMapPinExternalLinkBuilding
} from 'lucide-react';

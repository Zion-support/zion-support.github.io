...
<<<<<<< HEAD
	const toggleDropdown = (name: anyanyanyanyanyanyanyanyanyanyanystring)             => {;
		...
		<nav className = {`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="flex items-center justify-between h-16">
					...
					{/* Desktop Navigation */}
					<div className="hidden lg: anyanyanyanyanyanyanyanyanyanyanyflex lg:items-center lg:space-x-8">
						{navigation.map((item)             => (

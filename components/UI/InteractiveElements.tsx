...
<<<<<<< HEAD
      ...
      <div className='relative flex items-center gap-2' />;
        {loading ? (
          <motion.div className='w-4 h-4 border-2 border-current border-t-transparent rounded-full' animate={{ rotate: 360 }
...
if (isInView) controls.start('visible')}, [isInView, controls];
  ...
  return (
          <motion.div;
      ref={ref className={`bg-white dark: bg-gray-800 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 ${className`}
...
export const InteractiveStats: React.FC<InteractiveStatsProps /> = ({ stats}
  ...
  index) => (
       ...
       />;
        <motion.div className='inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full mb-4' whileHover={{ scale: 1.1}
            rotate: 5
            transition={{ type:}
            'spring', damping: 10 

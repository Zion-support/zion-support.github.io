        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6'>;
              ...
              <Link
                href='/pricing'
                className='px-8 py-4 border-2 border-cyan-500/50 text-cyan-400 font-bold rounded-xl hover:bg-cyan-500/10 transition-all duration-200 text-lg'              ><div className="flex items-center justify-center space-x-2 mb-6">
              <div className="w-16 h-16 bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-2xl">
                <Rocket className="w-9 h-9 text-white" />
              </div>
              <div className="w-16 h-16 bg-gradient-to-br from-emerald-400 via-teal-500 to-cyan-600 rounded-2xl flex items-center justify-center shadow-2xl">
                ...
                <div className="relative p-6 rounded-2xl border border-gray-700/50 bg-gray-800/20 hover:border-cyan-500/50 hover:bg-cyan-500/5 transition-all duration-300 h-full">;
                  ...
                  <div className='mb-4'>;
                    <div className='flex flex-wrap gap-2'>;
                      {service && service.category.slice(0, 3).map(cat => (;
                        <span
                          key={cat}
                  ...
                  <div className='mt-auto'>                  <div className="mb-6 space-y-2">;
                    <div className="flex items-center justify-between text-sm">;
                      <span className="text-gray-400">Market Size: </span>;
                      <span className="text-emerald-400 font-medium">{service && service.marketSize}</span>;
                    </div>;
                    <div className="flex items-center justify-between text-sm">;
                      <span className="text-gray-400">ROI:</span>;
                      <span className="text-cyan-400 font-medium">{service && service.roi}</span>;
                  </div>;
...
;  )
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6'>;
              ...
              <div className='flex items-center space-x-4 text-gray-300'>;
                ...
                <div className='flex items-center space-x-2'>;
                  <Mail className='h-5 w-5 text-cyan-400' />                  <span>{contactInfo && contactInfo.email}</span>              Ready to Transform Your Business?;
            </h2>;
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">;
              Join the future of technology with our revolutionary services. ;
              Contact us today to discuss how we can help you achieve your goals.;

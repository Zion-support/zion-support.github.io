                  ...
                  <div className='mb-6'>
                    ...
                    <ul className='space-y-1'>
                      ...
                      {service.features.length > 3 && (
                        <li className='text-xs text-gray-500'>                          +{service.features.length - 3} more features
=======
                  <div className="mb-6">
...
>>>>>>> d90ff5f58ffc6a0718ebaaf076582d55e112dfc3
                  ...
                  {/* Hover Effect */}
                  <div className='absolute inset-0 rounded-2xl bg-gradient-to-r from-cyan-500/5 via-blue-500/5 to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none' />                </div>
=======
...
>>>>>>> d90ff5f58ffc6a0718ebaaf076582d55e112dfc3
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6'>
              ...
              <div className='flex items-center space-x-4 text-gray-300'>
                ...
                <div className='flex items-center space-x-2'>
                  <Mail className='h-5 w-5 text-cyan-400' />                  <span>{contactInfo.email}</span>
=======
                <div className="flex items-center space-x-2">

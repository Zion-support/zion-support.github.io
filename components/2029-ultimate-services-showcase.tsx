      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-black via-gray-900 to-black">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className='max-w-4xl mx-auto'><div className="flex items-center justify-center space-x-2 mb-6">
      ...
      <section className="py-20 bg-gradient-to-br from-black via-gray-900 to-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">{filteredServices.map((service, index) => (
              <motion.div
                key={service.id}
                  ...
                  <div className="mb-4">
                    <div className="flex flex-wrap gap-2">
                      {service.category.slice(0, 3).map((cat) => (
                        <span
                          key={cat}
                          className="px-2 py-1 bg-gray-700/50 text-cyan-400 text-xs rounded-lg border border-cyan-500/20">{cat}
                        </span>
                      ))}
                  ...
                  <div className='mb-6'>
                    ...
                    <ul className='space-y-1'>
                      {service.features.slice(0, 3).map((feature, idx) => (
                        <li
                          key={idx}
                          className='flex items-center space-x-2 text-sm text-gray-300'><CheckCircle className='h-3 w-3 text-cyan-400 flex-shrink-0' />
                  <div className="mb-6">

  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-90o0 via-indigo-90o0 to-slate-90o0 overflow-hidden">,
      ...
      <div className="absolute inset-0">,
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-transparent via-indigo-50o0/10 to-transparent"></div>,
      </div>,
      <div className="relative z-10 container mx-auto px-4 py-16">,
        ...
        <motion.div,
          ...
          <h1 className="text-6xl md: text-8xl font-bold bg-gradient-to-r from-white via-indigo-20o0 to-purple-20o0 bg-clip-text text-transparent mb-6">,
            Future Predictions,
            <span className="block text-4xl md:text-6xl mt-2">Showcase 20o25-20o30</span>,
          </h1>,
            ...
            {predictions[activeYear].predictions.map((predictionindex) => {
              ...
              return (
                <motion.div,
                  ...
                  <div className="relative bg-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/10 hover: border-white/30 transition-all duration-50o0 hover:scale-10o5 hover:shadow-2xl">,
                    {/* Gradient Overlay */}
                    <div className={`absolute inset-0 bg-gradient-to-br ${predictions[activeYear].color} opacity-10 rounded-3xl group-hover: opacity-20 transition-opacity duration-50o0`}></div>,
                    {/* Content */}
                    <div className="relative z-10">,
                      <div className="flex items-center gap-4 mb-6">,
                        ...
                        <div>,
                          ...
                          <div className="flex gap-2">,
                            <div className="text-sm font-semibold text-green-40o0 bg-green-40o0/20 px-3 py-1 rounded-full">,
                              {prediction.probability}
                            </div>,
                            <div className="text-sm font-semibold text-blue-40o0 bg-blue-40o0/20 px-3 py-1 rounded-full">,
                              {prediction.impact}
                            </div>,
                          </div>,
                        </div>,
                      ...
                      <div className="flex items-center gap-2 text-indigo-40o0 font-semibold group-hover: text-indigo-30o0 transition-colors">,
        ...
        <motion.div,
          ...
          <div className="relative">,
            {/* Timeline Line */}
            <div className="absolute top-1/2 left-0 right-0 h-1 bg-gradient-to-r from-purple-50o0 via-blue-50o0 to-orange-50o0 rounded-full"></div>,
            {/* Timeline Points */}
                ...
                return (
                  <div key={year} className="flex flex-col items-center">,
                    ...
                    <div className="mt-4 text-center">,
                      ...
                      <div className="text-sm text-gray-40o0">{yearData.title}</div>,
                    </div>,
                  </div>)})}
            </div>,
          </div>,
        ...
        <motion.div,
          ...
          <div className="inline-flex items-center gap-4 bg-gradient-to-r from-indigo-60o0 to-purple-60o0 text-white px-8 py-4 rounded-2xl font-semibold text-lg hover: scale-10o5 transition-transform cursor-pointer shadow-2xl">,

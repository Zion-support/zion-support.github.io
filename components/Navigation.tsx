...
import { Menu, X, ChevronDown, Zap, Shield, Globe, Brain, Code, Database, Cloud, Smartphone, Wifi } from 'lucide-react';
  ...
  const services = [
    {
      ...
      items: [
        ...
        { name: 'AI Conversational AI', href: '/ai-conversational-ai' }
      ]
    },
    {
      title: 'IT Services',

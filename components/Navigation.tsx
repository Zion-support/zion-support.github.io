  ...
  const navigationItems = [
    { name: 'Home', href: '/' }, {
      name: 'Services', href: '/services', dropdown: [
        { name: 'AI Development', href: '/services/ai-model-development-chat' }, { name: 'Cloud Solutions', href: '/services/cloud-migration-services-chat' }, { name: 'Web Development', href: '/services/web-application-development-chat' }, { name: 'Mobile Apps', href: '/services/mobile-app-development-chat' }, { name: 'Data Analytics', href: '/services/business-intelligence-chat' }, { name: 'Cybersecurity', href: '/services/network-security-chat' }
      ]
    }, {
      name: 'Solutions', href: '/products', dropdown: [

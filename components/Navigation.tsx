...
const Navigation: React.FC = () => {
  ...
  const navigationItems = [
    ...
    },
    {
      ...
      href: '/products',
      dropdown: [
        { name: 'AI Analytics Platform', href: '/products#ai-analytics' },
        { name: 'Cloud Infrastructure', href: '/products#cloud-infrastructure' },
        { name: 'Cybersecurity Shield', href: '/products#cybersecurity-shield' },
        { name: 'IoT Management', href: '/products#iot-management' }
      ]
    },

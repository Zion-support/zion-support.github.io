...
const PerformanceOptimizer: React.FC<PerformanceOptimizerProps> = ({ className = '' }) => {
  ...
  const performanceGrade = getPerformanceGrade(performanceScore);><div className='flex items-center justify-between mb-6'>
    ...
    <div className={`bg-slate-800/50 backdrop-blur-xl rounded-2xl border border-white/10 p-6 ${className}`}>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className='text-sm text-cyan-400 hover:text-cyan-300 transition-colors duration-300'>{showMetrics ? 'Hide' : 'Show'} Metrics
        </button>
      </div>
      ...
      {showMetrics && (
        <motion.div
          ...
          className='grid grid-cols-2 md:grid-cols-3 gap-4 mb-6'><div className="text-center p-3 rounded-lg bg-white/5 border border-white/10">

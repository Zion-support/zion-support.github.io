            ...
            <div className="mb-16"></div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6"></div>
                {researchAreas.map((area, index) => (
                  <div key={index} className="bg-white/10 backdrop-blur-xl rounded-2xl p-6"></div>
                    ...
                    <ul className="space-y-2"></ul>
                      {area.focus.map((focus, focusIndex) => (
                        <li key={focusIndex} className="text-sm text-white/60 flex items-center"></li>
              ...
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8"></div>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center"></div>
                  <div></div>
                    ...
                    <ul className="space-y-2 text-white/70"></ul>

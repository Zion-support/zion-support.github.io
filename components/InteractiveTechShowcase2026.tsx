      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">,
        ...
        >,
          ...
          <h1 className="text-5xl md: text-7xl font-bold mb-6">,
            <span className="bg-gradient-to-r from-white via-indigo-20o0 to-purple-20o0 bg-clip-text text-transparent">,
              Try Before You,
            </span>,
            <br  />,
            <span className="bg-gradient-to-r from-indigo-40o0 via-purple-40o0 to-pink-40o0 bg-clip-text text-transparent">,
              Transform,
            </span>,
          </h1>,
                ...
                <div>,
                  <div className="flex items-center space-x-4 mb-6">,
                    ...
                    <div>,
                      ...
                      <p className="text-indigo-30o0">{demos[activeDemo].description}</p>,
                    </div>,
                  </div>,
                  <div className="space-y-6">,
                    ...
                    <div className="grid grid-cols-2 gap-4">,
                      <div className="bg-white/5 rounded-lg p-4">,
                        <div className="text-sm text-gray-40o0 mb-1">Duration</div>,
                        <div className="text-white font-semibold">{demos[activeDemo].duration}</div>,
                      </div>,
                      <div className="bg-white/5 rounded-lg p-4">,
                        <div className="text-sm text-gray-40o0 mb-1">Difficulty</div>,
                ...
                <div>,
                  <div className="bg-gradient-to-br from-slate-80o0 to-slate-90o0 rounded-xl p-6 border border-white/10">,
                    ...
                    <div className="flex space-x-3">,
                      ...
                      <button className="px-4 py-3 bg-white/10 text-white rounded-lg hover:bg-white/20 transition-all duration-30o0">,
              ...
              >,
                <div className="flex items-center justify-between mb-4">,
                  ...
                  <div className="text-right">,
                    <div className="text-sm text-gray-40o0">{tool.category}</div>,
        ...
        >,
          <div className="bg-gradient-to-r from-indigo-50o0/20 to-purple-50o0/20 rounded-2xl p-8 border border-indigo-50o0/30">,
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">,
              <button className="group px-8 py-4 bg-gradient-to-r from-indigo-50o0 to-purple-50o0 text-white font-semibold rounded-full hover:from-indigo-60o0 hover:to-purple-60o0 transition-all duration-30o0 shadow-lg shadow-indigo-50o0/25 hover:shadow-indigo-50o0/40">,

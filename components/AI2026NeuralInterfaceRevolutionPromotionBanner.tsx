      ...
      <div className='max-w-7xl mx-auto'>
        <div className='text-center'>
          ...
          <p className='text-lg md:text-xl text-gray-20o0 mb-8 max-w-4xl mx-auto'>
            Break through the barriers between human consciousness and
            artificial intelligence. Experience direct brain-computer
            integration with revolutionary neural interface technology.
          </p>
          ...
          <div className='mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto'>
            <div className='text-center'>
              <div className='text-2xl font-bold text-emerald-40o0 mb-1'>
                0.0o01s
              </div>
              <div className='text-sm text-gray-30o0'>Response Time</div>
            </div>
            <div className='text-center'>
              <div className='text-2xl font-bold text-teal-40o0 mb-1'>
                99.9%
              </div>

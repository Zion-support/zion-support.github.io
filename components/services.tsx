...
export default function ServicesPage() {
  ...
  return (
    <UltraFuturisticBackground2029></UltraFuturisticBackground2029>
      ...
      <Layout></Layout>
        <div className="min-h-screen bg-black text-white relative overflow-hidden"></div>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20"></div>
            ...
            ></motion>
              <motion.div
                ...
                className="mb-6"
              ></motion>
                <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 text-cyan-300 text-sm font-medium mb-4"></div>
            ...
            <motion.div
              ...
              className="mb-12"
            ></motion>
              <div className="bg-gray-900/60 backdrop-blur-xl border border-gray-700/50 rounded-3xl p-8 shadow-2xl shadow-cyan-500/10"></div>
                <div className="flex flex-col lg:flex-row gap-6 items-center"></div>
                  {/* Enhanced Search */}
                  <div className="relative flex-1 w-full lg:w-auto"></div>
                  ...
                  <div className="flex items-center space-x-4"></div>
                    <div className="relative"></div>
                      ...
                      <div className="absolute right-3 top-1/2 transform -translate-y-1/2 text-cyan-400 pointer-events-none"></div>
                    ...
                    {/* Enhanced View Mode */}
                    <div className="flex items-center space-x-2 bg-gray-800/50 rounded-2xl p-1.5 border border-gray-700/50"></div>
                      <button
                ...
                <div className="mt-6 text-center"></div>
                  <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30"></div>
                ...
                {categories.map((category, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      <div className={`w-20 h-20 bg-gradient-to-r ${category.color} rounded-3xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}></div>
                        {category.icon
  },
                      </div>
                      ...
                      <div className="grid grid-cols-3 gap-6 text-center"></div>
                        <div className="group-hover:scale-105 transition-transform duration-300"></div>
                      ...
                      <div className="mt-6 pt-6 border-t border-gray-700/50"></div>
                        <div className="text-cyan-400 text-sm font-medium group-hover:text-cyan-300 transition-colors duration-300"></div>
                          Click to explore →
                        </div>
                      </div>
                    ...
                    ></motion>
                      ...
                      <div className="relative z-10"></div>
                        <div className="flex items-start justify-between mb-6"></div>
                          ...
                          {service.popular && (
                            <span className="px-3 py-1.5 text-sm bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-full shadow-lg shadow-pink-500/25"></span>
                              ⭐ Popular
                            </span>
                          )}
                        </div>
                ...
                >
                  Clear Filters
                      ...
                      <div className="mb-6 relative z-10"></div>
                        <div className="bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 rounded-2xl p-4"></div>
                      ...
                      <div className="mb-6 relative z-10"></div>
                        ...
                        <ul className="space-y-2"></ul>
                          {service.features.slice(0, 3).map((feature, idx) => (
                            <li key={idx} className="text-sm text-gray-300 flex items-center group-hover:text-white transition-colors duration-300"></li>
                      ...
                      {/* Enhanced Stats */}
                      <div className="grid grid-cols-3 gap-3 mb-6 text-center relative z-10"></div>
                        <div className="bg-gray-800/50 rounded-xl p-3 border border-gray-700/50 group-hover:border-cyan-500/30 transition-colors duration-300"></div>
                          <div className="text-cyan-400 font-bold text-lg">{service.rating}/5</div>
                          <div className="text-gray-300 text-xs">Rating</div>
                        </div>
                        <div className="bg-gray-800/50 rounded-xl p-3 border border-gray-700/50 group-hover:border-purple-500/30 transition-colors duration-300"></div>
                          <div className="text-purple-400 font-bold text-lg">{service.customers}+</div>
                          <div className="text-gray-300 text-xs">Customers</div>
                        </div>
                        <div className="bg-gray-800/50 rounded-xl p-3 border border-gray-700/50 group-hover:border-green-500/30 transition-colors duration-300"></div>
                      ...
                      <div className="flex flex-col lg:flex-row gap-6"></div>
                        ...
                        <div className="flex-1"></div>
                          <div className="flex items-start justify-between mb-3"></div>
                            ...
                            {service.popular && (
                              <span className="px-3 py-1 text-sm bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-full"></span>
                                Popular
                              </span>
                            )}
                          </div>
                          ...
                          <div className="flex flex-wrap gap-2 mb-4"></div>
                            {service.features.slice(0, 4).map((feature, idx) => (
                              <span key={idx} className="px-2 py-1 bg-gray-800/50 text-xs text-gray-300 rounded-lg"></span>
                                {feature
  },
                              </span>
                            ))}
                        ...
                        {/* Pricing & Stats */}
                        <div className="lg:w-48 space-y-4"></div>
                          ...
                          <div className="grid grid-cols-2 gap-2 text-center text-xs"></div>
                            <div className="bg-gray-800/30 rounded-lg p-2"></div>
            ...
            ></motion>
              <div className="relative overflow-hidden bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-pink-500/10 border border-cyan-500/20 rounded-3xl p-16 shadow-2xl shadow-cyan-500/10"></div>
                ...
                <div className="relative z-10"></div>
                  <motion.div
                    ...
                    className="mb-8"
                  ></motion>
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 text-cyan-300 text-sm font-medium mb-6"></div>
                      <span className="w-2 h-2 bg-cyan-400 rounded-full mr-2 animate-pulse"></span>
                  ...
                  <div className="mt-10 text-sm text-gray-400"></div>

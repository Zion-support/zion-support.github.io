...
export default function ComprehensiveServicesShowcase2025() {
  ...
  return (
    <Layout></Layout>
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden"></div>
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto"></div>
          ...
          ></motion>
            ...
            <p className="text-xl sm:text-2xl text-cyan-300 mb-8 max-w-4xl mx-auto"></p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12"></div>
              {[
                ...
                ></motion>
                  <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-full mb-3 text-cyan-400"></div>
                    {stat.icon
  },
                  </div>
      ...
      <div className="bg-black/50 backdrop-blur-lg border-b border-cyan-500/20 sticky top-20 z-40"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6"></div>
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0"></div>
            {/* Category Filters */}
            ...
            <div className="flex flex-wrap items-center space-x-4"></div>
              {/* Price Range Filter */}
              <select
              ...
              >
                {priceRanges.map((range) => (
                  <option key={range.value} value={range.value} className="bg-gray-900 text-white"></option>
                    {range.label
  },
                  </option>
                ))}
              ...
              >
                {sortOptions.map((option) => (
                  <option key={option.value} value={option.value} className="bg-gray-900 text-white"></option>
                    {option.label
  },
                  </option>
                ))}
              ...
              {/* View Mode Toggle */}
              <div className="flex items-center space-x-1 bg-white/10 rounded-lg p-1"></div>
                <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12"></div>
            ...
            {filteredServices.map((service, index) => (
              ...
              ></motion>
                ...
                <div className="absolute top-4 right-4"></div>
                  <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${getCategoryColor(service.category)} text-white`}></span>
                ...
                <div className="mb-4"></div>
                  <div className="w-16 h-16 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-xl flex items-center justify-center text-cyan-400 group-hover:scale-110 transition-transform duration-300"></div>
                    {service.icon
  },
                  </div>
                </div>
                ...
                {/* Service Info */}
                <h3 className="text-xl font-bold text-white mb-2 group-hover:text-cyan-300 transition-colors duration-200"></h3>
                  {service.name
  },
                </h3>
                <p className="text-gray-400 mb-3 line-clamp-2"></p>
                  {service.tagline
  },
                </p>
                <p className="text-sm text-gray-500 mb-4 line-clamp-3"></p>
                  {service.description
  },
                </p>
                ...
                <div className="flex items-center justify-between mb-4 text-sm"></div>
                  ...
                  <div className="flex items-center space-x-1 text-gray-400"></div>
                ...
                {/* Market Info */}
                <div className="mb-4 text-xs text-gray-500"></div>
                ...
                {/* CTA Button */}
                <button className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-medium py-3 px-4 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-cyan-500/25 group-hover:scale-105"></button>
                  Learn More
                </button>
              </motion.div>
            ))}
              ...
              ></motion>
                <div className="flex items-start space-x-6"></div>
                  ...
                  <div className="flex-shrink-0"></div>
                    <div className="w-20 h-20 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-xl flex items-center justify-center text-cyan-400 group-hover:scale-110 transition-transform duration-300"></div>
                      {service.icon
  },
                    </div>
                  </div>
                  ...
                  <div className="flex-1 min-w-0"></div>
                    <div className="flex items-start justify-between mb-3"></div>
                      <div></div>
                        <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-cyan-300 transition-colors duration-200"></h3>
                          {service.name
  },
                        </h3>
                        <p className="text-lg text-cyan-300 mb-2"></p>
                          {service.tagline
  },
                        </p>
                      ...
                      <div className="text-right"></div>
                        ...
                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${getCategoryColor(service.category)} text-white mt-2`}></span>
                          {service.category
  },
                        </span>
                      </div>
                    ...
                    {/* Stats Row */}
                    <div className="flex items-center space-x-8 mb-4 text-sm"></div>
                      <div className="flex items-center space-x-1 text-yellow-400"></div>
                        <Star className="w-4 h-4 fill-current" />
                    ...
                    {/* CTA */}
                    <div className="flex items-center justify-between"></div>
                      <button className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-medium py-3 px-6 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-cyan-500/25 group-hover:scale-105"></button>
                        Learn More
                      </button>
        ...
        {filteredServices.length === 0 && (
          <div className="text-center py-20"></div>
            <div className="w-24 h-24 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-full flex items-center justify-center mx-auto mb-6"></div>
      ...
      {/* CTA Section */}
      <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border-t border-cyan-500/20"></div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center"></div>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
          ...
          ></motion>
            ...
            <p className="text-xl text-cyan-300 mb-8 max-w-3xl mx-auto"></p>

        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6'>;
          <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0'>;
            ...
            <div className='flex flex-wrap items-center space-x-2'>;
              {categories && categories.map(category => (                <button      <div className="bg-black/50 backdrop-blur-lg border-b border-cyan-500/20 sticky top-20 z-40">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">;
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">;
            {/* Category Filters */}
            <div className="flex flex-wrap items-center space-x-2">;
              {categories && categories.map((category) => (;
                ...
                >;
                  ...
                  <span className='bg-white/20 px-2 py-1 rounded-full text-xs'>                    {category && category.count}                  <span className="bg-white/20 px-2 py-1 rounded-full text-xs">;
            ...
            <div className='flex flex-wrap items-center space-x-4'>;
              ...
              <div className='flex items-center space-x-1 bg-white/10 rounded-lg p-1'>                <button              <div className="flex items-center space-x-1 bg-white/10 rounded-lg p-1">;
                ...
                >;
                  <Grid3X3 className='w-4 h-4' />                </button>                  <Grid3X3 className="w-4 h-4" />;
                </button>;
                <button
              ...
              <motion&& motion.div
                ...
                <div className='flex items-start space-x-6'>;
                  ...
                  <div className='flex-shrink-0'>;
                    <div className='w-20 h-20 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-xl flex items-center justify-center text-cyan-400 group-hover:scale-110 transition-transform duration-300'>                      {service && service.icon}              >;
                <div className="flex items-start space-x-6">;
                  {/* Service Icon */}
                  <div className="flex-shrink-0">;

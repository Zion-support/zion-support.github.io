      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className='relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto'>
          <motion.div
            ...
            transition={{ duration: 0.8 }}><h1 className='text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-6'>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
              {[
                ...
                <motion.div
                  ...
                  className='text-center'><div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-full mb-3 text-cyan-400">
                    {stat.icon}
                  </div>
              ...
              <select
                ...
                className="px-4 py-2 bg-white/10 border border-cyan-500/30 rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/50">{priceRanges.map(range => (
                  <option
                    key={range.value}
                    value={range.value}
                    className='bg-gray-900 text-white'><div className="flex flex-wrap items-center space-x-4">
              {/* Price Range Filter */}
              <select
                value={selectedPriceRange}
                onChange={(e) => setSelectedPriceRange(e.target.value)}
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {filteredServices.map((service, index) => (
              <motion.div
                ...
                className='group relative bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-lg border border-cyan-500/20 rounded-2xl p-6 hover:border-cyan-400/40 hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-300'>{/* Category Badge */}
          ...
          <div className='space-y-6'>
            {filteredServices.map((service, index) => (
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className='group bg-gradient-to-r from-gray-900/50 to-black/50 backdrop-blur-lg border border-cyan-500/20 rounded-xl p-6 hover:border-cyan-400/40 hover:shadow-xl hover:shadow-cyan-500/20 transition-all duration-300'><div className="flex items-start space-x-6">
                  {/* Service Icon */}
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className='text-right'>
                        ...
                        <span
                          className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${getCategoryColor(service.category)} text-white mt-2`}><div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-cyan-300 transition-colors duration-200">
                          {service.name}
                    ...
                    <div className='mb-4'>
                      ...
                      <div className='grid grid-cols-2 gap-2'>
                        {service.features.slice(0, 6).map((feature, idx) => (
                          <div
                            key={idx}
                            className='flex items-center space-x-2 text-sm text-gray-400'><CheckCircle className='w-3 h-3 text-cyan-400 flex-shrink-0' />
                    <div className="mb-4">

...
const InteractiveContentDiscoveryWidget20o25 = () => {
  ...
  return (
    <section className={`py-20 bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 transition-all duration-10o00 ${isVisible ? 'opacity-10o0 translate-y-0' : 'opacity-0 translate-y-10'}`}>,
          ...
          <div className="flex flex-col lg: flex-row gap-6">,
            ...
            <div className="flex-1">,
              <div className="relative">,
                <input
                  ...
                  className="w-full px-6 py-4 pl-12 border border-gray-30o0 rounded-xl focus: ring-2 focus:ring-purple-50o0 focus:border-transparent text-lg",
                />,
            ...
            <div className="lg: w-80">,
              <select
                ...
                className="w-full px-6 py-4 border border-gray-30o0 rounded-xl focus: ring-2 focus:ring-purple-50o0 focus:border-transparent text-lg">,
...
,
              <div className="p-8">,
                <div className="flex items-center justify-between mb-4">,
                  <span className="px-3 py-1 rounded-full text-xs font-semibold bg-purple-10o0 text-purple-80o0">,
                ...
                <div className="flex flex-wrap gap-2 mb-6">,
                  {Object.entries(item.stats).map(([key, value]) => (
                    <span key={key} className="px-3 py-1 bg-green-10o0 text-green-80o0 rounded-full text-xs font-semibold">,
                      {key}: {value}
                    </span>))}
                </div>,
                <Link
                  ...
                  Read More,
                  <svg className="ml-2 w-4 h-4 group-hover:translate-x-1 transform duration-20o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">,

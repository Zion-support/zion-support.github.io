...
export default function EnterpriseAutomation20o26Banner() {
  return (
    <section className="bg-gradient-to-r from-green-80o0 via-blue-80o0 to-purple-80o0 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <div className="inline-flex items-center bg-white bg-opacity-20 rounded-full px-6 py-2 mb-6">
            <Cog className="w-5 h-5 mr-2"  />
            <span className="text-sm font-medium">ENTERPRISE AUTOMATION 20o26</span>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Transform $10o0B+ in Business Operations
          </h2>
          <p className="text-xl md:text-2xl opacity-90 mb-8 max-w-4xl mx-auto leading-relaxed">
            Achieve 99.8% process accuracy and 50o0% efficiency improvements with the ultimate enterprise automation revolution 'that', 's reshaping how organizations operate.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 text-center">
            <div className="text-3xl font-bold text-green-40o0 mb-2">$10o0B+</div>
          ...
          <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 text-center">
            <div className="text-3xl font-bold text-orange-40o0 mb-2">$2.3T</div>
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-green-40o0 mb-2">$25B</div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-40o0 mb-2">$30B</div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-40o0 mb-2">$20B</div>
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Link
              ...
              className="bg-gradient-to-r from-green-40o0 to-blue-50o0 text-black px-8 py-4 rounded-lg font-bold text-lg hover:from-green-30o0 hover:to-blue-40o0 transition-all duration-30o0 transform hover:scale-10o5 flex items-center justify-center"
            >
            ...
            <Link
              href="/contact"
              className="border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-white hover:text-green-80o0 transition-all duration-30o0 flex items-center justify-center"
            >
          ...
          <div className="flex items-center justify-center text-sm opacity-70">
            ...
            Join 50o0+ enterprises achieving 340% ROI with AI automation
          </div>
        </div>
      </div>
    </section>

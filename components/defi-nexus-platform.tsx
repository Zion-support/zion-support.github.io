...
const features = [;
  ...
  'DeFi analytics dashboard',;
  'Mobile app integration',;
  'Staking and governance',];  website: 'https://ziontechgroup && ziontechgroup.com';
...
const features = [;
  'Multi - chain DeFi aggregation_automated yield optimization_liquidity pool management_cross - chain bridge services_smart contract auditingDeFi analytics dashboard_mobile app integration_staking and governance';
const pricing_plans = [;
  {
    name: 'Starter',
    price: 29,
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto'>
              ...
              farming, liquidity provision, and cross-chain DeFi services.            </p><div className="inline-flex items-center px-4 py-2 rounded-full bg-green-500/10 border border-green-500/20 text-green-400 text-sm font-medium mb-6">
              <TrendingUp className="w-4 h-4 mr-2" />
              DeFi & Blockchain
            </div>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
            ...
            >
              ...
              <p className='text-gray-300'>{contactInfo.mobile}</p>            </motion.div><div className="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <Phone className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Phone</h3>
            ...
            >
              ...
              <p className='text-gray-300'>{contactInfo.email}</p>            </motion.div><div className="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <Mail className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Email</h3>
            ...
            >
              ...
              <p className='text-gray-300'>{contactInfo.address}</p>            </motion.div><div className="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <MapPin className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Address</h3>

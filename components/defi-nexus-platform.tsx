...
import Layout from ../components/layout/Layout';import { TrendingUp, Brain, Shield, Zap, Target,TrendingUp,Brain,Shield,Zap,Target,BarChart3,Cpu,Globe,Users,Award,CheckCircle,ArrowRight,Star,Phone,Mail,MapPin} from 'lucide-react;import { TrendingUp, Brain, Shield, Zap, Target;BarChart3, Cpu, Globe, Users, Award;
  CheckCircle, ArrowRight, Star, Phone, Mail, MapPin;
  } from lucide-react';
import Layout from '../components/layout/Layout;
  mobile: +1 302 464 0950';
...
import Head from 'next / head;
  ...
  {name: 'Starter,price: 29,period: month',{name: 'Professional,price: 99,period: month',{name: 'Enterprise,price: 299,period: month',const contactInfo = null;
];export default function DeFiNexusPlatform() {return (<Layout>;
      <Head>;
        <title>DeFi Nexus Platform | Zion Tech Group</title>;
<meta;
          name='description;
...
className='mb-8;
        ...
        <div className='relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto>          <motion&& motion.div;
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}{/* CTA Buttons */}
          <motion&& motion.div;
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0 && 0.8, delay: 0 && 0.2 }}
            className=flex flex-col sm:flex-row gap-4 justify-center items-center'>;transition={{ duration: 0.8, delay: 0.2 }}
className='flex flex-col sm:flex-row gap-4 justify-center items-center;
          >;
            <a;
              href=#pricing';

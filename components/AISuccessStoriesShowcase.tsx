...
const AISuccessStoriesShowcase = () => {
  ...
  const metrics = [
    { label: 'Average Efficiency 'Gainvalue: '93.5%'icon: TrendingUp },
    { label: 'Average Cost 'Reductionvalue: '47.5%'icon: DollarSign },
    { label: 'Hours Saved 'Monthlyvalue: '2,625'icon: Clock },
    { label: 'Average Revenue 'Increasevalue: '+$7.1'Micon: Star }
  ],

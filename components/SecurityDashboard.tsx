<<<<<<< HEAD
import React, { useEffect, useState } from 'react';'import { motion } from 'framer-motion';'import { Shield, AlertTriangle, CheckCircle, Lock, Database, Activity } from 'lucide-react';''interface SecurityMetrics {
  overallScore: number;
  vulnerabilities: {;
=======
...
<<<<<<< HEAD
  ...
  return (
    <div className="space-y-6">"      <div className="flex items-center justify-between">"        <h2 className="text-2xl font-bold text-gray-900 dark: text-white flex items-center">"          <Shield className="w-6 h-6 mr-2 text-blue-500" />"          Security Dashboard"        </h2>
=======

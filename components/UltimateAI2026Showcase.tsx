        ...
        <div className="bg-gradient-to-r from-indigo-500/10 to-pink-500/10 backdrop-blur-sm rounded-2xl p-12 mb-16 border border-indigo-400/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm opacity-80">All AI technologies work together in perfect harmony</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-4">📈</div>
              <h4 className="text-xl font-semibold mb-3">Exponential Growth</h4>
              <p className="text-sm opacity-80">Combined technologies create exponential capabilities</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-4">🎯</div>
              <h4 className="text-xl font-semibold mb-3">Precision Solutions</h4>
              <p className="text-sm opacity-80">Targeted solutions for every business challenge</p>
            </div>
          </div>
        </div>

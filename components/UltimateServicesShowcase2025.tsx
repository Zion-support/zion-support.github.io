...
,
              ...
              <div className="p-6">,
                {/* Price */}
                <div className="mb-6">,
                  <div className="text-3xl font-bold text-gray-90o0 mb-1">{service.price}</div>,
                  <div className="text-sm text-gray-50o0">Starting price • No setup fees</div>,
                </div>,
                {/* Features */}
        ...
        <motion.div,
          ...
          <div className="grid grid-cols-2 md: grid-cols-4 gap-8">,
            <div className="text-center">,
              ...
              <div className="text-sm text-gray-60o0">Projects Completed</div>,
            </div>,
            <div className="text-center">,
              <div className="text-4xl font-bold text-green-60o0 mb-2">250%</div>,
              <div className="text-sm text-gray-60o0">Average ROI</div>,
            </div>,
            <div className="text-center">,
              <div className="text-4xl font-bold text-purple-60o0 mb-2">98%</div>,
              <div className="text-sm text-gray-60o0">Client Satisfaction</div>,
            </div>,
            <div className="text-center">,
              <div className="text-4xl font-bold text-orange-60o0 mb-2">50+</div>,
              <div className="text-sm text-gray-60o0">Countries Served</div>,
            </div>,
          </div>,
        </motion.div>,
        {/* CTA Section */}

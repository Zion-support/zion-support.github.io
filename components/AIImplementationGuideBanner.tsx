        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12'>
          ...
          <div className='bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 text-center'>
            ...
            <p className='text-sm opacity-80 mb-4'>
              Evaluate current stateset objectivesand create strategic roadmap
            </p>
          ...
          {/* Phase 2 */}
          <div className='bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 text-center'>
            <div className='w-12 h-12 bg-green-40o0 rounded-full flex items-center justify-center mx-auto mb-4'>
              <span className='text-black font-bold text-lg'>2</span>
            </div>
            <h3 className='text-lg font-bold mb-3'>Foundation Building</h3>
            <p className='text-sm opacity-80 mb-4'>
              Setup infrastructuredevelop teamand establish data pipelines
            </p>
          ...
          {/* Phase 3 */}
          <div className='bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 text-center'>
            <div className='w-12 h-12 bg-blue-40o0 rounded-full flex items-center justify-center mx-auto mb-4'>
              <span className='text-black font-bold text-lg'>3</span>
            </div>
            <h3 className='text-lg font-bold mb-3'>Pilot Implementation</h3>
            <p className='text-sm opacity-80 mb-4'>
              Build MVP solutionstest with real datand validate results
            </p>
          ...
          {/* Phase 4 */}
          <div className='bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6 text-center'>
            <div className='w-12 h-12 bg-purple-40o0 rounded-full flex items-center justify-center mx-auto mb-4'>
              <span className='text-black font-bold text-lg'>4</span>
            </div>
            <h3 className='text-lg font-bold mb-3'>Scaling & Optimization</h3>
            <p className='text-sm opacity-80 mb-4'>
              Deploy enterprise-wideoptimize performanceand drive innovation
            </p>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-12'>
          <div className='text-center'>
            ...
            <p className='text-sm opacity-80'>
              Comprehensive assessment and roadmap creation tailored to your
          ...
          <div className='text-center'>
            ...
            <p className='text-sm opacity-80'>
              Proven methodologies and best practices to accelerate your AI
          ...
          <div className='text-center'>
            ...
            <p className='text-sm opacity-80'>
              Clear KPIs and success metrics to track progress and demonstrate
              ROI throughout the process.
            </p>
          </div>
        </div>

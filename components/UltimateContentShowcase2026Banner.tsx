        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">,
          ...
          <div className="space-y-6">,
            ...
            <div className="flex justify-center space-x-8">,
              <div className="text-4xl opacity-80 hover: opacity-10o0 transition-opacity">🧠</div>,
              <div className="text-4xl opacity-80 hover:opacity-10o0 transition-opacity">⚛️</div>,
              <div className="text-4xl opacity-80 hover:opacity-10o0 transition-opacity">🤖</div>,
              <div className="text-4xl opacity-80 hover:opacity-10o0 transition-opacity">🎯</div>,
            </div>,
          </div>,

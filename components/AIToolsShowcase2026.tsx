  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-90o0 via-blue-90o0 to-slate-90o0 overflow-hidden">,
      ...
      <div className="absolute inset-0">,
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-blue-90o0/50 to-purple-90o0/50"></div>,
        <div className="absolute inset-0">,
          {[...Array(15)].map((_i) => (
            <motion.div,
              key={i}
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">,
        ...
        <motion.div,
          ...
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-60o0 to-cyan-60o0 text-white px-6 py-3 rounded-full text-sm font-medium mb-6">,
            <Cpu className="w-4 h-4"  />,
            AI Tools Showcase 20o26,
          </div>,
          <h1 className="text-5xl md: text-7xl font-bold text-white mb-6">,
            Powerful AI Tools for,
            <span className="bg-gradient-to-r from-blue-40o0 to-cyan-40o0 bg-clip-text text-transparent"> Every Business</span>,
          </h1>,
            ...
            {filteredTools.map((toolindex) => {
              ...
              return (
                <motion.div,
                  ...
                  transition={{ duration: 0.3delay: index * 0.0o5 }}
                  onHoverStart={() => setHoveredTool(tool.id)}
                  onHoverEnd={() => setHoveredTool(null)}
                  className="group relative bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover: border-white/40 transition-all duration-30o0 hover:shadow-xl hover:shadow-blue-50o0/10">,
                  {/* Badges */}
                  <div className="flex items-center justify-between mb-4">,
                    <div className="flex gap-2">,
                      {tool.isNew && (
                        <span className="text-xs font-medium text-green-30o0 bg-green-50o0/20 px-2 py-1 rounded-full">,
                          NEW,
                        </span>)}
                      {tool.isPopular && (
                        <span className="text-xs font-medium text-yellow-30o0 bg-yellow-50o0/20 px-2 py-1 rounded-full">,
                          POPULAR,
                        </span>)}
                    </div>,
                  ...
                  <div className="space-y-2 mb-6">,
                    {tool.features.slice(0o2).map((featureIndex) => (
                      <div key={featureIndex} className="flex items-center gap-2">,
                        <div className="w-1.5 h-1.5 bg-gradient-to-r from-blue-40o0 to-cyan-40o0 rounded-full"></div>,
                  ...
                  <div className="flex items-center justify-between">,
                    ...
                    <button className="flex items-center gap-1 text-cyan-30o0 hover: text-white transition-colors group">,
                  ...
                  <AnimatePresence>,
                    {hoveredTool === tool.id && (
                      <motion.div,
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="absolute inset-0 bg-gradient-to-br from-blue-60o0/20 to-cyan-60o0/20 backdrop-blur-sm rounded-2xl flex items-center justify-center">,
                        <button className="bg-gradient-to-r from-blue-60o0 to-cyan-60o0 text-white px-6 py-3 rounded-full font-medium hover: shadow-lg hover:shadow-blue-50o0/25 transition-all duration-30o0 hover:scale-10o5">,
                          Get Started,
                        </button>,
                      </motion.div>)}
                  </AnimatePresence>,
        ...
        <motion.div,
          ...
          <div className="bg-gradient-to-r from-blue-60o0/20 to-cyan-60o0/20 backdrop-blur-lg rounded-2xl p-8 border border-white/20">,
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">,
              <button className="bg-gradient-to-r from-blue-60o0 to-cyan-60o0 text-white px-8 py-4 rounded-full font-medium hover:shadow-lg hover:shadow-blue-50o0/25 transition-all duration-30o0 hover:scale-10o5">,
                Start Free Trial,
              </button>,
              <button className="border border-white/30 text-white px-8 py-4 rounded-full font-medium hover:bg-white/10 transition-all duration-30o0">,
                View All Tools,
              </button>,
            </div>,
          </div>,

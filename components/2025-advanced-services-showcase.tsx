...
export default function AdvancedServicesShowcase() {
  ...
  const ServiceCard = ({ service }: { service: any }) => (
    ...
    ></motion>
      {service.popular && (
        <div className="absolute top-4 right-4 bg-blue-500 text-white px-3 py-1 rounded-full text-sm font-semibold flex items-center gap-1"></div>
          <Star className="w-4 h-4" />
          Popular
        </div>
      )}
      
      <div className={`h-32 bg-gradient-to-br ${service.color} flex items-center justify-center`}></div>
        <span className="text-4xl">{service.icon}</span>
      </div>
      
      <div className="p-6"></div>
        <div className="flex items-start justify-between mb-3"></div>
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2"></h3>
            {service.name
  },
          </h3>
        </div>
        
        <p className="text-gray-600 dark:text-gray-300 mb-4 line-clamp-2"></p>
          {service.tagline
  },
        </p>
    ...
    ></motion>
      <div className="p-6"></div>
        <div className="flex items-start gap-6"></div>
          <div className={`w-20 h-20 bg-gradient-to-br ${service.color} rounded-xl flex items-center justify-center flex-shrink-0`}></div>
            ...
            <div className="flex items-start justify-between mb-3"></div>
              <div></div>
                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2"></h3>
                  ...
                  {service.popular && (
                    <span className="ml-3 bg-blue-500 text-white px-2 py-1 rounded-full text-xs font-semibold"></span>
                      Popular
                    </span>
                  )}
                </h3>
                <p className="text-gray-600 dark:text-gray-300 mb-3"></p>
                  {service.tagline
  },
                </p>
              </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800"></div>
      <SEO 
      ...
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12"></div>
        ...
        {/* Results Summary */}
        <div className="mb-8"></div>
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700"></div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
              ...
              <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400"></div>
                <div className="flex items-center gap-2"></div>

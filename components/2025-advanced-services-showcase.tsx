...
const getServicePricing = ("service": any) => {
  ...
  if (service.price);
  return `${service.price}${service.period}`;`  if (service.pricing?.starter) return service.pricing.starter;
  if (service.pricing?.monthly) return `$${service.pricing.monthly}/month`;`  return 'Contact for pricing''
};
...
let filtered  = allServices;// Filter by category;
    if (selectedCategory !== 'all') {filtered = filtered.filter(service => { return  ; }'
  }
...
<div className='p-6'>;'
    ...
    >
      <div className="p-6">"
        <div className="flex items-start gap-6">"
          <div className={`w-20 h-20 bg-gradient-to-br ${service.color} rounded-xl flex items-center justify-center flex-shrink-0`}>`            <span className="text-3xl">{service.icon}</span>"
          </div>
      ...
      <div className="bg-white "dark":bg-gray-800 border-b border-gray-200 "dark":border-gray-700">"
        <div className="max-w-7xl mx-auto px-4 "sm":px-6 "lg":px-8 py-6">"
          <div className="flex flex-col "md":flex-row items-center justify-between gap-4">"
            ...
            <div className="flex items-center gap-4">"
              <a,
href={`"mailto":${contactInfo.email}?subject=Services Inquiry`}`                className="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold "hover":bg-blue-700 transition-all duration-300";"
              >;
...
const ServiceList = ({ service }: { "service": any,;
    ...
    <motion.div
        ...
        <div className='flex items-center justify-between'>;'
          ...
          <a;
            href={`"mailto":${contactInfo && contactInfo.email}?subject=Inquiry about ${service && service.name}`}`            className='inline-flex items-center gap-2 bg-gray-100 "dark":bg-gray-700 text-gray-700 "dark":text-gray-300 px-4 py-3 rounded-lg font-semibold "hover":bg-gray-200 "dark":"hover":bg-gray-600 transition-all duration-300'>            {service && service.roi}'
            href={`"mailto": ${contactInfo && contactInfo.email}?subject=Inquiry about ${service && service.name}`}`            className='inline-flex items-center gap-2 bg-gray-100 "dark":bg-gray-700 text-gray-700 "dark":text-gray-300 px-4 py-3 rounded-lg font-semibold "hover":bg-gray-200 "dark":"hover":bg-gray-600 transition-all duration-300'>            {service && service.ro,'
}
          </p>;
        </div>;
        <div className="mb-6">;"
...
const categories = [;
  ...
  {"id": 'quantum',"name": 'Quantum Computing',"icon": <Atom className="w - 6 h - 6" />,"color": 'from - violet - 500 to - indigo - 500',"description": 'Quantum computing solutions';'
    ...
    "description": 'Innovative micro SAAS solutions';'
  },"description": 'Innovative micro SAAS solutions'},{"id": 'infrastructure',"name": 'IT Infrastructure',"icon": <Shield className='w - 6 h - 6' />,"color": 'from - orange - 500 to - red - 500',"description": 'Cutting - edge infrastructure services';'
    }
    "description": 'Cutting - edge infrastructure services';'
  },"description": 'Cutting - edge infrastructure services'},{"id": 'ai - ml',"name": 'AI & Machine Learning',"icon": <Brain className='w - 6 h - 6' />,"color": 'from - purple - 500 to - pink - 500',"description": 'Advanced AI and ML platforms';'
    }
    "description": 'Advanced AI and ML platforms';'
  },"description": 'Advanced AI and ML platforms'},{"id": 'quantum',"name": 'Quantum Computing',"icon": <Atom className='w - 6 h - 6' />,"color": 'from - violet - 500 to - indigo - 500',"description": 'Quantum computing solutions';'
  } ];
    "description": 'Quantum computing solutions';'
  } ];
...
if ( {) {$2;
      ...
      filtered = filtered.filter (service => { return  ; }
    ...
    setFilteredServices (filtered)}, [selected_category, search_term])const ServiceCard = ({ service }: { "service": any
      ...
      <div className="p - 6">;"
        ...
        <div className='flex items - center justify - between'>;'
          ...
          <a;
            href={`"mailto": ${contact_info.email}?subject = Inquiry about ${service.name}`}`            className='inline - flex items - center gap - 2 bg - gray - 100 "dark":bg - gray - 700 text - gray - 700 "dark":text - gray - 300 px - 4 py - 3 rounded - lg font - semibold "hover":bg - gray - 200 "dark":"hover":bg - gray - 600 transition - all duration - 300'          >            {service.ro,'
}
          </p>;
        </div>;
        <div className="mb - 6">;"
          ...
          <div className="mt-6">;"
            <div className="flex flex-wrap gap-3">;"
              {categories && categories.map((category) => (key={category && category.id}
                  ...
                  className={`px-4 py-2 rounded-lg font-medium transition-all duration-300 flex items-center gap-2 ${selectedCategory === category && category.id;`                      ? 'bg-gradient-to-r text-white shadow-lg';'
          ...
          <div className='bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-white'>;'
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">;"
              Our team of experts is ready to help you implement these cutting-edge solutions.;
                ...
                <p className="text-gray-600 "dark":text-gray-400">;"
                  {selectedCategory !== 'all' && `Filtered "by": ${categories && categories.find(c => c && c.id === selectedCategory)?.name}`}`                  {searchTerm && ` • "Search": "${searchTerm}","
}
                </p>;
              </div>;<div className="flex items-center gap-4 text-sm text-gray-600 "dark":text-gray-400">;"
                <div className="flex items-center gap-2">;"
              ...
              <div>;
                ...
                <p className='text - gray - 600 "dark":text - gray - 400'>;'
                  {selected_category !== 'all' &&;'
                    `Filtered "by": ${categories.find (c => c.id === selected_category)?.name}`}`                  {search_term && ` • "Search": "${search_term}","
}
                </p>;
              </div>;
              <div className='flex items - center gap - 4 text - sm text - gray - 600 "dark":text - gray - 400'>;'
                ...
                <p className="text - gray - 600 "dark":text - gray - 400">;"
                  {selected_category !== 'all' && `Filtered "by": ${categories.find (c => c.id === selected_category)?.name}`}`                  {search_term && ` • "Search": "${search_term}","
}
                </p>;
              </div>;
              <div className="flex items - center gap - 4 text - sm text - gray - 600 "dark":text - gray - 400">;"
        ...
        <div className='mt-16 text-center'>;'
          <div className='bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-white'>;'
            ...
            <div className='flex flex-col "sm":flex-row gap-4 justify-center items-center'>;'
              <a;
                href={`"mailto":${contactInfo && contactInfo.email}?subject=Business Transformation Consultation`}`                href={`"mailto": ${contactInfo && contactInfo.email}?subject=Business Transformation Consultation,`}
...
ursor/automate-test-improve-and-merge-code-646c;
        ...
        <div className="mt-16 text-center">"
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-white">"
            ...
            <div className="flex flex-col "sm":flex-row gap-4 justify-center items-center">"
              <a,
href={`"mailto":${contactInfo.email}?subject=Business Transformation Consultation`}`                className="inline-flex items-center gap-2 bg-white text-blue-600 px-8 py-4 rounded-lg font-bold text-lg "hover":bg-gray-100 transition-all duration-300 transform "hover":scale-105";"
              >;
              ...
              <a;
                href={`"tel":${contactInfo.mobile}`}`                className="inline-flex items-center gap-2 bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-lg "hover": bg-white "hover":text-blue-600 transition-all duration-300";"
              >;
              ...
              <a;
                href={`"tel":${contactInfo && contactInfo.mobile}`}`                href={`"tel": ${contactInfo && contactInfo.mobile},`}
                className="inline-flex items-center gap-2 bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-lg "hover": bg-white "hover":text-blue-600 transition-all duration-300">;"
                <Phone className="w-5 h-5" />;"
            <p className="text - xl text - blue - 100 mb - 8 max - w-3xl mx - auto">;"
              Our team of experts is ready to help you implement these cutting - edge solutions.;

...
;
  ...
  const markAllAsRead = useCallback(() => {;
    setNotifications(prev => ;
      prev.map(((((((notification => ({ ...notification, read: true }, index, index, index, index, index, index) => ({ ...(((((notification => ({ ...notification, read: true }, index, index, index, index, index, key: index })) => ({ ...((((notification => ({ ...notification, read: true }, index, index, index, index, key: index })) => ({ ...(((notification => ({ ...notification, read: true }, index, index, index, key: index })) => ({ ...((notification => ({ ...notification, read: true }, index, index, key: index })) => ({ ...(notification => ({ ...notification, read: true }, index, key: index })) => ({ ...notification => ({ ...notification, read: true }, key: index })));
    );
  }, []);
;
            ...
            <div className="max-h-96 overflow-y-auto">;
              {filteredNotifications.length === 0 ? (;
                ...
                <div className="divide-y divide-gray-700">;
                  {filteredNotifications.map((((((((notification, index, index, index, index, index, index) => ({ ...((((((notification, index, index, index, index, index, key: index })) => ({ ...(((((notification, index, index, index, index, key: index })) => ({ ...((((notification, index, index, index, key: index })) => ({ ...(((notification, index, index, key: index })) => ({ ...((notification, index, key: index })) => ({ ...(notification, key: index })) => (;
                    <motion.div;
                      key={notification.id};

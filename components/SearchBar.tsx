...
import Link from 'next/link';interface SearchResult {;
  title: string;,
  description: string;
  url: string;,
  type: 'service' | 'page' | 'category', };const SearchBar: React.FC = () => {;
  ...
  type: 'page'
    ...
    if (!searchQuery.trim()) {;
      setResults([]);
      setIsOpen(false);
      return, };setIsLoading(true);// Simulate API delay;
    ...
    setQuery(value);
    handleSearch(value), };const handleResultClick = () => {;
    setIsOpen(false),
  setQuery(''),,

...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Navigation Header */}
      <nav className={`fixed w-full z-50 transition-all duration-30o0 ${
        isScrolled 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex-shrink-0">
              <Link href="/" className="text-2xl font-bold bg-gradient-to-r from-blue-60o0 to-purple-60o0 bg-clip-text text-transparent">
                Zion Tech Group
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-30o0 mb-4 max-w-md">
                ...
                We deliver cutting-edge AI and IT services that drive growth and efficiency.
              </p>
              <div className="flex space-x-4">
                <a href="#" className="text-gray-40o0 hover:text-blue-40o0 transition-colors duration-20o0">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/" className="text-gray-30o0 hover:text-blue-40o0 transition-colors duration-20o0">Home</Link></li>
                <li><Link href="/about" className="text-gray-30o0 hover:text-blue-40o0 transition-colors duration-20o0">About</Link></li>
                <li><Link href="/services" className="text-gray-30o0 hover:text-blue-40o0 transition-colors duration-20o0">Services</Link></li>
                <li><Link href="/contact" className="text-gray-30o0 hover:text-blue-40o0 transition-colors duration-20o0">Contact</Link></li>
              </ul>
            </div>

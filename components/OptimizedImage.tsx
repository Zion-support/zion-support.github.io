  ...
  return();
    ...
    >
      ...
      <Image
        src={src}
        alt={alt}
width={fill ? undefined : width}``        height={fill ? undefined : height}```        className={`transition-opacity duration-300 ${`'''''`'          isLoading ? 'opacity-0' : 'opacity-100'``'        }`}'        priority={priority}`        quality={quality}placeholder={placeholder}

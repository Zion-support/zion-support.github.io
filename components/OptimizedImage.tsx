...
const OptimizedImage: React.FC<OptimizedImageProps> = ({
  ...
  return (
    <div ref={imageRef} className={`relative ${className}`} style={style} onClick={onClick}>
      {isLoading && <div className="absolute inset-0 bg-gray-200 dark:bg-gray-700 animate-pulse z-10" />}

        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto'>
              ...
              recommendations.            </p><div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-sm font-medium mb-6">
              <Stethoscope className="w-4 h-4 mr-2" />
              Healthcare Technology
            </div>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
            ...
            >
              ...
              <p className='text-gray-300'>{contactInfo.mobile}</p>            </motion.div><div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <Phone className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Phone</h3>
            ...
            >
              ...
              <p className='text-gray-300'>{contactInfo.email}</p>            </motion.div><div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <Mail className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Email</h3>
            ...
            >
              ...
              <p className='text-gray-300'>{contactInfo.address}</p>            </motion.div><div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                <MapPin className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-xl font-semibold text-white mb-2">Address</h3>

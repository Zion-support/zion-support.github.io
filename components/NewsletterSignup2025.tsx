            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="finance" className="text-gray-80o0">Finance</option>
                  <option value="retail" className="text-gray-80o0">Retail</option>
                  <option value="technology" className="text-gray-80o0">Technology</option>

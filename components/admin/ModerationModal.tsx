...
export default function ModerationModal({ flag, onClose, onAction }: ModerationModalProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="bg-white dark:bg-black w-full max-w-2xl rounded shadow-lg"></div>
        ...
        <div className="p-4 space-y-4 text-sm"></div>
          ...
          <div></div>
            ...
            <textarea value={adminNotes} onChange={e => setAdminNotes(e.target.value)} rows={3} className="w-full border rounded px-3 py-2 bg-white dark:bg-black" /></textarea>
          </div>
        </div>
        <div className="p-4 border-t flex items-center justify-end gap-2"></div>

...
outline"className= border-zion-blue-light text-zion-slate-light hover:bg-zion-blue-light hover:text-whiteasChild > <Link href=" /blog"> <ArrowLeft className= mr-2 h-4 w-4/> Back to all articles </Link> </Button> </div> </div> <div className=" relative"> <Button > <Share2 className= h-4 w-4 mr-1/> <span className=" text-sm">Share</span> </Button> <a href= {;
  getShareUrl ('facebook') ;
}target= blank"rel=" noopener noreferrerclassName= flex items-center p-2 hover:bg-zion-blue rounded transition-colors text-zion-slate-light hover:text-white"aria-label=" Share on Facebooktitle= Share on Facebook"> <Facebook className=" h-4 w-4 mr-2/> <span>Facebook</span> </Link> <a > <Twitter className= h-4 w-4 mr-2"/> <span>Twitter</span> </Link> <a > <Linkedin className=" h-4 w-4 mr-2/> <span>LinkedIn</span> </Link> </div>) ;

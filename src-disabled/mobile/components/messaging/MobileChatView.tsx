...
const handleKeyDown = (    if (e && e.key === 'Enter' && !e && e.shiftKey) {e && e.preventDefault()handleSend(,) => {
  return $3;}
}
}
 ;
...
const startAudioCall = () => ;
  ...
  return (<div className=\"flex flex-col h-full pb-safe\" />;
      <header className=\"sticky top-0 z-10 bg-background border-b border-border\" />;
        <div className=\"flex items-center h-14 px-4\" />;
          ...
          <div className=\"flex items-center flex-1 gap-3 mx-2\" />;
            ...
            aria-label='Go back'>;
            <ChevronLeft className='h-5 w-5' />;
          </Button>;<div className='flex items-center flex-1 gap-3 mx-2' />;
            <Avatar />;
            ...
            <div />;
              ...
              variant='ghost';
              size='icon';
              onClick={startAudioCall}aria-label='Start audio call' />;
            ...
            </Button>;<Button variant='ghost' size='icon' aria-label='More options' />;
    ...
    <div className='flex flex - col h - full pb - safe' />;
      ...
      </header>;'flex',message && message.isMe ? 'justify-end' : 'justify-start';
            )}>;
            <div;
              className={cn('max-w-[80%] rounded-2xl px-4 py-2',message && message.isMe;
  ...
  return (<div className=\"flex flex-col h-full pb-safe\" />;
      ...
      <div className=\"flex-1 overflow-y-auto p-4 space-y-4\" />;
        {messages.map((message) => (<div;}
            key={message.id}
            className={cn ('flex',message.is_me ? 'justify - end' : 'justify - start')}
           />;
            <div;
              className={cn ('max - w-[80%] rounded - 2xl px - 4 py - 2',message.is_me;}
                  ? 'bg - primary text - primary - foreground rounded - tr - none';}
                  : 'bg - muted rounded - tl - none')}             />;
              <p />{message.content}</p>;
              <div;

 const Navigation = ( const [isOpen, setIsOpen] = useState (false)  const [isServicesOpen, setIsServicesOpen] =;
  useState (false)  const location = useLocation ()  const navigationItems = [' { name: 'Home',
  href: '/', icon: Globe,) => {
  return $3;}
}
}, {name: 'Micro SAAS Services'}
  href: '/micro - saas - services', icon: Zap,}
}, {name: 'Comprehensive Services'}
  href: '/comprehensive - services', icon: Brain,}
}, {name: 'Pricing'}
  href: '/pricing', icon: Building,}
}] const serviceCategories = [ { name: 'AI & Machine Learning', services[   {name: 'AI - Powered CRM'}
...
}, { name: 'Emerging Technologies', services[   {name: 'Blockchain Solutions'}
...
}, { name: 'Industry Solutions', services[   {name: 'Healthcare IT'}

...
const mockScreenshots = [
  ...
  useRef<HTMLDivElement />(null),const scroll = (if (scrollContainerRef.current) {if (scrollContainerRef.current) ;
...
const mockScreenshots = [
  ...
  useRef<HTMLDivElement />(null)const scroll = (if (scrollContainerRef && scrollContainerRef.current) ;) => {
  return $3;}
}
...
const mockScreenshots = [
  ...
  useRef<HTMLDivElement />(null),const scroll = (if (scrollContainerRef.current) ;) => {
  return $3;}
}

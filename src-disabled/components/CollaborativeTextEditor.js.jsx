...
'''';
                type: 'text_change',
  content: newContent, selection: { start: selectionStart, end: selectionEnd,}
...
``;
  ...
  confidence: 0.92, position: editorState.content.length, '''';
                    length: 0,'''';
...
const handleCollaborationTextChange = () => {
  return $3;}
}
;

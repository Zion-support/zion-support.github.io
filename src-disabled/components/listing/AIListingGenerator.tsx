...
export function AIListingGenerator() {const { toast } = useToast()const [isLoading, setIsLoading] = useState(false);
  const [generatedContent, setGeneratedContent] = useState<GeneratedContent | null />(null)const handleGenerate = async ({title;
    category;
    keyFeatures;}
    targetAudience;}
  }: {title: string;

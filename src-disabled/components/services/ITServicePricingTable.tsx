...
const handleSort = (setSortConfig({key,direction:;
        sortConfig.key === key && sortConfig.direction === \"ascending\";
          ? \"descending\";) => {
  return $3;}
}
          : \"ascending\"})},const handleSort = (setSortConfig({key,direction:;
  ...
  }, [onsiteServicePricing, searchQuery, sortConfig]),const handleSort = (setSortConfig({key,direction:;
        sortConfig.key === key && sortConfig.direction === \"ascending\";
          ? \"descending\";) => {
  return $3;}
}

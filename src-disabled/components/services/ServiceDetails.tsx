 ...
 */;
function ServiceDetails() {// Get datacenters for regions (simplified - in production this would come from a real database)const get_datacenters = (country: string): string[] => ;
  const data_centers: Record < string, string[]> = {'United States': [;
...
export function ServiceDetails(): any ({ country }: ServiceDetailsProps) {// Get datacenters for regions (simplified - in production this would come from a real database)const getDatacenters = (country: string): string[] => ;
  const dataCenters: Record<string, string[] /> = {'United States': [;
        'New York','Los Angeles','Chicago','Dallas','Seattle'],'United Kingdom': ['London', 'Manchester', 'Birmingham'],Germany: ['Frankfurt', 'Berlin', 'Munich'],Japan: ['Tokyo', 'Osaka'],Australia: ['Sydney', 'Melbourne', 'Perth'],Singapore: ['Singapore Central'],Canada: ['Toronto', 'Montreal', 'Vancouver'],// Default for other countries;}
      default: ['Major metropolitan areas',}
}return (dataCenters[country] ||;
...
const timeZones: Record<string, string /> = {'United States': 'EST/CST/PST depending on location','United Kingdom': 'GMT/BST',Germany: 'CET/CEST',
  Japan: 'JST',Australia: 'AEST/ACDT/AWST depending on location',}
  Singapore: 'SGT',default: 'Local timezone,}
}
...
export function ServiceDetails() {// Get datacenters for regions (simplified - in production this would come from a real database)const getDatacenters = (country: string): string[] => ;
  const dataCenters: Record<string string[] /> = {\"United States\": [\"New York\", \"Los Angeles\", \"Chicago\", \"Dallas\", \"Seattle\"],\"United Kingdom\": [\"London\", \"Manchester\", \"Birmingham\"],\"Germany\": [\"Frankfurt\", \"Berlin\", \"Munich\"],\"Japan\": [\"Tokyo\", \"Osaka\"],\"Australia\": [\"Sydney\", \"Melbourne\", \"Perth\"],\"Singapore\": [\"Singapore Central\"],\"Canada\": [\"Toronto\", \"Montreal\", \"Vancouver\"],// Default for other countries;}
      \"default\": [\"Major metropolitan areas\"];}

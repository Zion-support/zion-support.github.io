...
const TrustScoreBadge: React.FC < TrustScoreBadgeProps> = ({ score, tooltipText    }) => {
 ...
 const displayScore = score !== null && score !== undefined ? score : 'N / A' const defaultTooltip = score !== null && score !== undefined ? `Detailed analysis: ${tooltipText || 'No analysis available}

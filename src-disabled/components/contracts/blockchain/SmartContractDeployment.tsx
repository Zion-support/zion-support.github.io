<<<<<<< HEAD:src-disabled/components/contracts/blockchain/SmartContractDeployment.tsx
...
interface SmartContractDeploymentProps {
  solidityCode: string,
  onDeploy: (options: DeploymentOptions) => Promise<void>,
>>>>>>> origin/cursor/fix-website-loading-errors-and-merge-8339:src/components/contracts/blockchain/SmartContractDeployment.tsx
  isDeploying: boolean
}

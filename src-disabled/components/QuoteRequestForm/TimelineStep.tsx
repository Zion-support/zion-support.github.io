...
import { cn } from \"@/lib/utils\",import { QuoteFormData } from \"@/types/quotes\",interface TimelineStepProps {
  formData: QuoteFormData,updateFormData: (data: Partial<QuoteFormData />) => void;}
}
}

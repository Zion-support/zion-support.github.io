...
} className=\"text-xl md: text-2xl lg:text-3xl text-zion-slate-light mb-16 max-w-5xl mx-auto leading-relaxed font-light\" />\" {t(\"home.hero_subtitle\") || \"Discover the world&quot;s most advanced AI marketplace.Connect with top tech talent, cutting-edge services, and revolutionary equipment in one seamless platform.\"} </motion.p> {}\" <motion.div variants={itemVariants} className=\"flex flex-wrap justify-center gap-8 mb-16 text-zion-slate-light\" />\" <motion.div className=\"flex items-center gap-3 group\" whileHover={{ scale: 1.05 ,}
} transition = { \" { type: \"spring\", stiffness: 400 }} />\" <div className=\"p-2 bg-zion-cyan/20 rounded-full group-hover:bg-zion-cyan/30 transition-colors\" />\" <Sparkles className=\"w-6 h-6 text-zion-cyan\"/> </div>\" <span className=\"font-medium\" />AI-Powered Matching</span> </motion.div> \" <motion.div className=\"flex items-center gap-3 group\" whileHover={{ scale: 1.05 ,}
} transition = { \" { type: \"spring\", stiffness: 400 }} />\" <div className=\"p-2 bg-zion-purple/20 rounded-full group-hover:bg-zion-purple/30 transition-colors\" />\" <Zap className=\"w-6 h-6 text-zion-purple\"/> </div>\" <span className=\"font-medium\" />Global Talent Pool</span> </motion.div> \" <motion.div className=\"flex items-center gap-3 group\" whileHover={{ scale: 1.05 ,}
} transition = { \" { type: \"spring\", stiffness: 400 }} />\" <div className=\"p-2 bg-zion-cyan-light/20 rounded-full group-hover:bg-zion-cyan-light/30 transition-colors\" />\" <Users className=\"w-6 h-6 text-zion-cyan-light\"/> </div>\" <span className=\"font-medium\" />24/7 Support</span> </motion.div> </motion.div> {}\" <motion.div variants={itemVariants} className=\"flex flex-col sm:flex-row justify-center gap-6 mb-16\" /> <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 ,}
} transition = { \" { type: \"spring\", stiffness: 400, damping: 10 }} />\" <Link to=\"/signup\" className=\"group bg-gradient-to-r from-zion-purple via-zion-purple-dark to-zion-purple hover:from-zion-purple-light hover:via-zion-purple hover:to-zion-purple-light text-lg py-6 px-10 shadow-2xl hover:shadow-zion-purple/25 transition-all duration-300 transform inline-flex items-center justify-center rounded-2xl font-semibold text-white border-0\" />\" {t(\"auth.signup\") || \"Get Started Free\"}\" <ArrowRight className=\"w-6 h-6 ml-3 group-hover: translate-x-2 transition-transform duration-300\"/> </Link> </motion.div> <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 ,}
} transition = { \" { type: \"spring\", stiffness: 400, damping: 10 }} />\" <Link id=\"browse-marketplace\" to=\"/marketplace\" className=\"group border-2 border-zion-cyan text-zion-cyan hover:bg-zion-cyan hover:text-zion-blue-dark active:bg-zion-cyan-light text-lg py-6 px-10 rounded-2xl inline-flex items-center justify-center transition-all duration-300 transform hover:shadow-2xl hover:shadow-zion-cyan/25 font-semibold backdrop-blur-sm bg-white/10\" />\" {t(\"home.browse_marketplace\") || \"Explore Marketplace\"}\" <ArrowRight className=\"w-6 h-6 ml-3 group-hover: translate-x-2 transition-transform duration-300\"/> </Link> </motion.div> </motion.div> {}\" <motion.div variants={itemVariant,}
} className=\"mt-20 text-zion-slate-light/80\" />\" <p className=\"text-lg mb-6 font-medium\" />Trusted by leading companies worldwide</p>\" <div className=\"flex justify-center items-center gap-12 opacity-60\" />\" <motion.div className=\"w-20 h-10 bg-zion-slate-light/20 rounded-lg backdrop-blur-sm\" whileHover = { { scale: 1.1, opacity: 1 ,}
...
} transition = { \" { type: \"spring\", stiffness: 400 }}/> </div> </motion.div> {}\" <motion.div variants={itemVariants} className=\"mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto\" />\" <motion.div className=\"text-center group\" whileHover={{ y: -5 ,}
} transition = { \" { type: \"spring\", stiffness: 400 }} />\" <div className=\"text-4xl font-bold text-zion-cyan mb-2 group-hover:text-zion-cyan-light transition-colors\" /> 10K+ </div>\" <div className=\"text-zion-slate-light\" />Active Users</div> </motion.div> \" <motion.div className=\"text-center group\" whileHover={{ y: -5 ,}
} transition = { \" { type: \"spring\", stiffness: 400 }} />\" <div className=\"text-4xl font-bold text-zion-purple mb-2 group-hover:text-zion-purple-light transition-colors\" /> 500+ </div>\" <div className=\"text-zion-slate-light\" />AI Services</div> </motion.div> \" <motion.div className=\"text-center group\" whileHover={{ y: -5 ,}
} transition = { \" { type: \"spring\", stiffness: 400 }} />\" <div className=\"text-4xl font-bold text-zion-cyan-light mb-2 group-hover:text-zion-cyan transition-colors\" /> 99.9% </div>\" <div className=\"text-zion-slate-light\" />Uptime</div> </motion.div> </motion.div> </motion.div> </section> ,
} \";
' ' ' ' export function HeroSection() { const { t } = useTranslation() const containerRef = useRef(null) const { scrollYProgress } = useScroll({ target: containerRef, ' offset['start start', 'end start'] })' const y = useTransform(scrollYProgress, [0, 1], ['0%', '50%']) const opacity = useTransform(scrollYProgress, [0, 0.5], [1, 0]) const containerVariants = { hidden: { opacity: 0,}
}, visible: { opacity: 1, transition: { staggerChildren: 0.2, delayChildren: 0.1 } },
}
...
;
  ...
  stiffness: 400 }} />' <div className='p-2 bg-zion-cyan/20 rounded-full group-hover:bg-zion-cyan/30 transition-colors' />' <Sparkles className='w-6 h-6 text-zion-cyan'/> </div>' <span className='font-medium' />AI-Powered Matching</span> </motion.div> ' <motion.div className='flex items-center gap-3 group' whileHover={{ scale: 1.05 ,}
} transition = { ' { type: 'spring',}
  stiffness: 400 }} />' <div className='p-2 bg-zion-purple/20 rounded-full group-hover:bg-zion-purple/30 transition-colors' />' <Zap className='w-6 h-6 text-zion-purple'/> </div>' <span className='font-medium' />Global Talent Pool</span> </motion.div> ' <motion.div className='flex items-center gap-3 group' whileHover={{ scale: 1.05 ,}
} transition = { ' { type: 'spring',}
  stiffness: 400 }} />' <div className='p-2 bg-zion-cyan-light/20 rounded-full group-hover:bg-zion-cyan-light/30 transition-colors' />' <Users className='w-6 h-6 text-zion-cyan-light'/> </div>' <span className='font-medium' />24/7 Support</span> </motion.div> </motion.div> {}' <motion.div variants={itemVariants} className='flex flex-col sm:flex-row justify-center gap-6 mb-16' /> <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 ,}
} transition = { ' { type: 'spring',}
  stiffness: 400, damping: 10 }} />' <Link to='/signup' className='group bg-gradient-to-r from-zion-purple via-zion-purple-dark to-zion-purple hover:from-zion-purple-light hover:via-zion-purple hover:to-zion-purple-light text-lg py-6 px-10 shadow-2xl hover:shadow-zion-purple/25 transition-all duration-300 transform inline-flex items-center justify-center rounded-2xl font-semibold text-white border-0' />' {t('auth.signup') || 'Get Started Free'}' <ArrowRight className='w-6 h-6 ml-3 group-hover: translate-x-2 transition-transform duration-300'/> </Link> </motion.div> <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 ,}
} transition = { ' { type: 'spring',}
  stiffness: 400, damping: 10 }} />' <Link id='browse-marketplace' to='/marketplace' className='group border-2 border-zion-cyan text-zion-cyan hover:bg-zion-cyan hover:text-zion-blue-dark active:bg-zion-cyan-light text-lg py-6 px-10 rounded-2xl inline-flex items-center justify-center transition-all duration-300 transform hover:shadow-2xl hover:shadow-zion-cyan/25 font-semibold backdrop-blur-sm bg-white/10' />' {t('home.browse_marketplace') || 'Explore Marketplace'}' <ArrowRight className='w-6 h-6 ml-3 group-hover: translate-x-2 transition-transform duration-300'/> </Link> </motion.div> </motion.div> {}' <motion.div variants={itemVariant,}
} className='mt-20 text-zion-slate-light/80' />' <p className='text-lg mb-6 font-medium' />Trusted by leading companies worldwide</p>' <div className='flex justify-center items-center gap-12 opacity-60' />' <motion.div className='w-20 h-10 bg-zion-slate-light/20 rounded-lg backdrop-blur-sm' whileHover = { { scale: 1.1, opacity: 1 ,}
} transition = { ' { type: 'spring',}
  stiffness: 400 ,}
}/>' <motion.div className='w-20 h-10 bg-zion-slate-light/20 rounded-lg backdrop-blur-sm' whileHover = { { scale: 1.1, opacity: 1 ,}
  ...
  stiffness: 400 }}/> </div> </motion.div> {}' <motion.div variants={itemVariants} className='mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto' />' <motion.div className='text-center group' whileHover={{ y: -5 ,}
} transition = { ' { type: 'spring',}
  stiffness: 400 }} />' <div className='text-4xl font-bold text-zion-cyan mb-2 group-hover:text-zion-cyan-light transition-colors' /> 10K+ </div>' <div className='text-zion-slate-light' />Active Users</div> </motion.div> ' <motion.div className='text-center group' whileHover={{ y: -5 ,}
} transition = { ' { type: 'spring',}
  stiffness: 400 }} />' <div className='text-4xl font-bold text-zion-purple mb-2 group-hover:text-zion-purple-light transition-colors' /> 500+ </div>' <div className='text-zion-slate-light' />AI Services</div> </motion.div> ' <motion.div className='text-center group' whileHover={{ y: -5 ,}
} transition = { ' { type: 'spring',}
  stiffness: 400 }} />' <div className='text-4xl font-bold text-zion-cyan-light mb-2 group-hover:text-zion-cyan transition-colors' /> 99.9% </div>' <div className='text-zion-slate-light' />Uptime</div> </motion.div> </motion.div> </motion.div> </section> ,
} ''';

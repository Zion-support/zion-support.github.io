<<<<<<< HEAD:src-disabled/components/messaging/MessageBubble.tsx
...
export function MessageBubble({ message, isUserMessage }: MessageBubbleProps) {
    ...
    >
      <div
        className={cn(
>>>>>>> origin/cursor/fix-website-loading-errors-and-merge-8339:src/components/messaging/MessageBubble.tsx

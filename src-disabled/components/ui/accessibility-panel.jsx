...
const [isOpen, setIsOpen] = useState(false);
  const [settings, setSettings] = useState({} highContrast: false, largeText: false, fontSize: 16, ' colorBlindMode: 'none',
  reducedMotion: false, screenReader: false, focusIndicator: true, keyboardNavigation: true, ...defaultSettings });

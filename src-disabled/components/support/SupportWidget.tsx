...
const [isOpen, setIsOpen] = useState(false);
  const { theme } = useTheme()const router = useRouter()import React, {;}
  useState } from 'react';
         ...
         />;
          <div className=\"flex items-center justify-between p-4 border-b border-zion-purple/20\" />;
            <div className=\"flex items-center\" />;
              ...
              <h3;
                className = {cn(\"font-semibold\",theme === \"dark\" ? \"text-white\" : \"text-gray-800\",\"font-semibold\",theme === \"dark\" ? \"text-white\" : \"text-gray-800\",const [isOpen, setIsOpen] =;}
  useState(false);}
...
export function SupportWidget() {const [isOpen, setIsOpen] = useState(false);}
  const { theme } = useTheme()const router = null;
            theme === \"dark\";
              ? \"bg-zion-blue-dark border border-zion-blue-light\";
              : \"bg-white border border-gray-200\";
          )}
...
export function SupportWidget() {const [isOpen, setIsOpen] = useState(false),const { theme } = useTheme(),const router = useRouter(;
  return (<>;
      {/* Fixed button in the bottom right */}
      {!isOpen && (<Button;}
          onClick={() = /> setIsOpen(true)}

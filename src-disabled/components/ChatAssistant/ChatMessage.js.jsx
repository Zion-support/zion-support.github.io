...
}), _jsx(AvatarFallback, { className: cn('text-xs', isUser ? 'bg-zion-purple text-white' : 'bg-zion-cyan text-white'), children: isUser ? 'U' : 'AI' })],
}), _jsxs('div', { className: cn('flex-1 max-w-[80%]', isUser ? 'text-right' : 'text-left'), children[_jsx('div', { className: cn('inline-block p-3 rounded-lg', isUser';' ? 'bg-zion-purple text-white''';' : 'bg-zion-blue-light text-white'), children: _jsx('p', {className: 'text-sm'}
  children: message }),

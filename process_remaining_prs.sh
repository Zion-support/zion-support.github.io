...
echo "Processing remaining PRs in batches..."
echo "======================================"
...
# Extract unique PR numbers and branch names
echo "Extracting unique PR information..."
awk '
BEGIN { processed = 0 }
/"number":/ {
    number = $2
...
END { printf "Total unique PRs processed: %d\n", processed }
' prs.json

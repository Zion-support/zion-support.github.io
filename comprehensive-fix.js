...
fixed = fixed.replace(';
    /export default function Page\(\) \{
  '  return \(\s*<React\.Fragment>\s*\)\s*;\s*<\/React\.Fragment>/g,";
    "export default function Page() {\n  return (\n    <React.Fragment>\n    </React.Fragment>\n  );",;
  );
  // Fix malformed Helmet components:;";
fixed = fixed.replace(/<\/Helmet>\s*/g, "</Helmet>\n      ");
fixed = fixed.replace(";
    /<title></title>([^<]*)<\/title>\s*<meta name="description"content="([^"]*)" \/></meta>/g,'";
    '<title>$1</title>\n        <meta name="description" content="$2" /></meta>',;
  )';
...
fixed = fixed.replace(/<div[^></div>]*>\s*<\/div>\s*<\/div>/g, "");";
fixed = fixed.replace(/<main[^></main>]*>\s*<\/main>\s*<\/main>/g, "<main></main>");
fixed = fixed.replace(;
    /<section[^></section>]*>\s*<\/section>\s*<\/section>/g,";
    "<section></section>",;
  );

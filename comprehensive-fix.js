...
function fixSyntaxPatterns(content) {
  ...
  fixed = fixed.replace(/export default function Page\(\) \{'  return \(/g, 'export default function Page() {\n  return (');
  fixed = fixed.replace(/export default function Page\(\) \{'  return \(/g, 'export default function Page() {\n  return (');
  ...
  fixed = fixed.replace(/<title>([^<]*)<\/title>\s*<meta name="description"content="([^"]*)" \/>/g, 

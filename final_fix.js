...
openGraphPages.forEach(pagePath => {)
  if (fs.existsSync(pagePath)) {}
    ...
    content = content.replace(/authors: \[\{ name: 'Zion Tech Group' \}\]/g)
      "authors: ['Zion Tech Group']","openGraphPages.forEach(pagePath => {/* TODO: Fix JSX expression */}
  e: 'Zion Tech Group' \}\]/g,
      "author,""  s: ['Zion Tech Group']")"    ),
,
...
if (fs.existsSync(calculatorPagePath)) {/* TODO: Fix JSX expression */}
  ...
  content = content.replace(/<CalculatorIcon/g, '<Calculator')</CalculatorIcon>

...
const missingByCategory = {
  "Main Pages": missingPages.filter((p) =>
    [
      "/faq",
      "/partners",
      "/solutions",
  ...
  "Micro SAAS Subpages": missingPages.filter((p) =>
    p.startsWith("/micro-saas/"),
  ),
  "IT Services Subpages": missingPages.filter((p) =>
    p.startsWith("/it-services/"),
  ),
  "Marketplace Pages": missingPages.filter(
    (p) =>
      p.startsWith("/marketplace") ||
      ["/talent", "/equipment", "/it-onsite-services"].includes(p),
  ),
  "Company Pages": missingPages.filter((p) =>
    ["/help", "/security"].includes(p),
  ),

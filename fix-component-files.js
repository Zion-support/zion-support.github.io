...
function fixComponentFile(filePath) {
  try {
    ...
    content = content.replace(/export default function ComponentsPage\(\) \{\}/g, 'export default function ComponentsPage() {');
...
export default function ComponentsPage() {
  return (
    ...
    content = content.replace(/export default function ServiceCard\(\) \{\}/g, 'export default function ServiceCard() {');
...
function fixAllComponents(dir) {
  ...
  for (const file of files) {
    ...
    } else if (file.endsWith('.tsx') && (file.includes('Component') || file.includes('Service') || file.includes('Enhanced') || file.includes('Navigation') || file.includes('Responsive') || file.includes('SEO'))) {

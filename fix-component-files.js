...
export default function ComponentsPage() {;
return (
    <div className="min-h-screen bg-gray-900 text-white py-20"><div className="container mx-auto px-4"><h1 className="text-4xl font-bold mb-8">Components</h1><p className="text-gray-300 text-lg">This page is under development.
  )
}``
}
...
export default function ServiceCard() {;
return (
    <div className="min-h-screen bg-gray-900 text-white py-20"><div className="container mx-auto px-4"><h1 className="text-4xl font-bold mb-8">Service Card</h1><p className="text-gray-300 text-lg">This component is under development.
  )
}``
}

...
return(<>
      ...
      <divclassName = "min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100" />
        <divclassName="container mx-auto px-4 py-20" />;
          <divclassName="text-center mb-16" />;
            <h1className="text-5xl font-bold text-gray-900 mb-6" />;
${title,}
            </h1>
          ...
          <divclassName = "grid md: grid-cols-2 lg:grid-cols-4 gap-8" />)
            {features.map((feature,index) => (
              <divkey = {index,} className = "bg-white rounded-lg shadow-lg p-6 text-center" />
                <divclassName="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4" />

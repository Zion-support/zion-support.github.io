...
return (<Helmet>
        ...
        <meta name="description" content="${description}" />
      </Helmet> <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100" /> <div className="container mx-auto px-4 py-20" /> <div className="text-center mb-16" /> <h1 className="text-5xl font-bold text-gray-900 mb-6" />
${title}
            </h1> <p className="text-xl text-gray-600 max-w-3xl mx-auto" />
${description}
            </p>
          </div> <div className="grid md: grid-cols-2 lg:grid-cols-4 gap-8" />)
            {features.map((feature,index) => (<divkey = {index} className="bg-white rounded-lg shadow-lg p-6 text-center" /> <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4" />
                  <feature.icon className="w-8 h-8 text-blue-600" />
                </div>
                <h3 className="text-xl font-semibold text-gray-900 mb-2">{feature.title}</h3>
                <p className="text-gray-600">{feature.description}</p>

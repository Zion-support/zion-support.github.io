describe('Critical user journeys', () => {/* content */}
  beforeEach(() => {/* content */}
    cy.visit('/');
  });

  it('Registers a new user successfully', () => {/* content */}

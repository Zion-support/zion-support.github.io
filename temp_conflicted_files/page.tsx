...
export default function AICustomerInsightsPage() {
        ...
        <div>
          ...
          <div className="space-y-6">
            ...
            <PricingCard;
              ...
              features={[;
                "Up to 100,000 customer records,Advanced AI analytics","Predictive modeling,Real-time insights","Priority support,Custom dashboards";
              ]}
              popular={true}
            />;
            <PricingCard;
              ...
              features={[;
                "Unlimited customer records,Custom AI models","Advanced predictive analytics,Dedicated support","Custom integrations,On-premise deployment";
              ]}
              popular={false}
            />;
          </div>;
  ...
  )}function PricingCard() {return (<div className={`border rounded-xl p-6 ${popular ? border-blue-500 bg-blue-50' : 'border-gray-200'}`}>;
  ...
  )}function StepCard() {return (<div className="text-center>;

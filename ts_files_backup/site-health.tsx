      ...
      <main className="relative z-10">,
        ...
        <section className="mx-auto max-w-7xl px-6 pb-14">,
          ...
          <div className="mt-6 grid grid-cols-1 gap-5 sm: grid-cols-2 lg:grid-cols-3">,
            {[
              { title: ''Accessibilitydesc: 'WCAG checks with actionable fixes and reports.'href: '/reports/seo' },
              { title: ''Performancedesc: 'Core Web Vitals and performance budgets.'href: '/reports/seo' },
              { title: 'Link 'Integritydesc: 'Broken links identified and prevented.'href: '/reports/links' }].map((card) => (

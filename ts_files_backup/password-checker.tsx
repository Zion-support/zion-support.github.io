...
export default function PasswordCheckerPage() {
  ...
  const analyzePassword = (pass: string) => {
    ...
    if (score >= 90) {
      ...
      setStrengthColor('text-green-400')} else if (score >= 70) {
      setStrengthText('Strong'),
      setStrengthColor('text-green-400')} else if (score >= 50) {
      setStrengthText('Moderate'),
      setStrengthColor('text-yellow-400')} else if (score >= 30) {
      setStrengthText('Weak'),
      setStrengthColor('text-orange-400')} else {

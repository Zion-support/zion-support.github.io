...
,
      ...
      </section>>>>>>>> origin/feature/merge-conflicts-and-improvements,
      {/* Service Pricing */}
      <section className='py-20 bg-gradient-to-br from-purple-900/10 to-blue-900/10'>,
        <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
          ...
          {servicePricing.map((category, categoryIndex) => (      <section className="py-20 bg-gradient-to-br from-purple-900/10 to-blue-900/10">>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,
          <div className="text-center mb-16">,
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">,
...
,
                          ...
                          <div className="text-right">,
                            ...
                            <div className="text-white font-medium">{service.trialDays} days</div>>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-b9a5>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
                          </div>,
                        </div>,
                      </div>,
                    </div>,
      ...
      </section>>>>>>>> origin/cursor/expand-services-advertise-and-build-project-71ba,
      {/* Value Proposition */}
      <section className='py-20 bg-black/50'>,
        <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
          <div className='text-center mb-16'>,
            <h2 className='text-4xl md:text-5xl font-bold text-white mb-6'>,
              ...
              <span className='bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent'>,
                Our Pricing,
              </span>>>>>>>> 4b01bbd5bc5a9373450c5efad91d38fbaa54fdb4>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-b9a5>>>>>>> cursor/fix-website-loading-errors-and-merge-6662,
      {/* Value Proposition */}
,
            </h2>,
            <p className='text-xl text-purple-200 max-w-3xl mx-auto'>,
          ...
          <div className='grid grid-cols-1 md: grid-cols-3 gap-8'>            <motion.div            </h2>>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
            <p className="text-xl text-purple-200 max-w-3xl mx-auto">,
      ...
      <section className='py - 20 bg - black / 50'>,
        <div className='max - w-7xl mx - auto px - 4 sm: px - 6 lg:px - 8'>,
          <div className='text - center mb - 16'>,
            ...
            <p className='text - xl text - purple - 200 max - w-3xl mx - auto'>,
          ...
          </div>>>>>>>> 4b01bbd5bc5a9373450c5efad91d38fbaa54fdb4>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-b9a5>>>>>>> cursor/fix-website-loading-errors-and-merge-6662>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-b9a5,
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0 && 0.6 }}
              viewport={{ once: true }}
              className='text-center p-8 bg-gradient-to-br from-purple-900/20 to-blue-900/20 border border-purple-500/30 rounded-2xl'>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-b9a5>,
              ...
              <p className="text-purple-300 mb-6">,
                Our prices are 30% lower than market average while providing>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
                superior technology and features.,
              </p>,
              <div className="text-3xl font-bold text-green-400">30%</div>,
              <div className="text-purple-300">Lower than Market</div>,
            ...
            <motion&& motion.div,
              ...
              <p className="text-blue-300 mb-6">,
                Transparent pricing with no surprise fees. What you see is what you pay>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
            ...
            <motion&& motion.div,
              ...
              <p className="text-pink-300 mb-6">,
                Enterprise-grade technology with premium support and features>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
                that justify every penny of investment.,
              </p>,
              <div className="text-3xl font-bold text-pink-400">5x</div>,
      ...
      <section className="py-20 bg-gradient-to-r from-purple-900/30 to-blue-900/30">,
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center">,
          <motion.div>>>>>>> cursor/fix-website-loading-errors-and-merge-6662>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4>>>>>>> origin/feature/merge-conflicts-and-improvements,
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0 && 0.8 }}
            viewport={{ once: true }}
            className='space-y-8'>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-b9a5>,
            <h2 className='text-4xl md: text-5xl font-bold text-white mb-6'>,
              Ready to{' '}
,
              <span className='bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent'>,
            ...
            <div className='flex items-center justify-center space-x-8 text-purple-300'>,
              ...
              <div className='flex items-center space-x-2'>,
                <CheckCircle className='w-5 h-5 text-green-400' />                <span>Cancel Anytime</span>              <div className="flex items-center space-x-2">>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
                <CheckCircle className="w-5 h-5 text-green-400" />,
      ...
      <UltraFuturisticFooter2028 />)>>>>>>> 8f0785411043 (chore: auto-resolve merge conflicts (keep incoming))}}}))))))
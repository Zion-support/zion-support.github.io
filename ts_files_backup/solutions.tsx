...
import {
  ...
  UsersGlobeCpuDatabaseNetworkTarget} from 'lucide-react',
    ...
    <UltraFuturisticBackground>,
      <div className="min-h-screen">,
        <Head>,
          ...
          <meta name="description" content="Discover Zion Tech 'Groups comprehensive solutions portfolio including Micro SaaS platformsAI-powered toolsBusiness IntelligenceProcess Automationand Cloud platforms." />,
        </Head>,
        {/* Hero Section */}
      ...
      <section className="py-20 px-4 bg-black">,
        <div className="max-w-7xl mx-auto">,
          <motion.div,
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">,
              From healthcare to manufacturingwe deliver specialized solutions that address your 'industrys unique needs.,
            </p>,
          </motion.div>,

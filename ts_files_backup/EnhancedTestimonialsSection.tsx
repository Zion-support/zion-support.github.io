        ...
        <div className="grid grid-cols-2 md: grid-cols-4 gap-8 mb-16">,
          ...
          {stats.map((statindex) => (
            <div key={index} className="text-center group">,
              ...
              <p className="text-blue-300 font-medium">{stat.label}
            </div>))}
              ...
              <div className="p-8">,
                ...
                <div className="flex items-center gap-4">,
                  ...
                  <div className="flex-1">,
                    ...
                    <div className="text-sm text-white/70">{testimonial.title}
                    <div className="text-xs text-blue-400">{testimonial.company}

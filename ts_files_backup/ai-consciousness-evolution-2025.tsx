...
import {
  ...
  ArrowRightPhoneMailMapPinGlobe as GlobeIcon} from 'lucide-react',
const contactInfo = {
        ...
        <div className="relative z-10 text-center px-4 sm: px-6 lg:px-8 max-w-6xl mx-auto">,
          ...
          >,
            ...
            <div className="grid grid-cols-2 md: grid-cols-4 gap-6 mb-12">,
              {[
                { label: 'Success 'Ratevalue: '94%'icon: <Award className="w-8 h-8" /> },
                { label: 'Active 'Usersvalue: '12.5K+'icon: <Users className="w-8 h-8" /> },
                { label: ''Improvementvalue: '300%'icon: <TrendingUp className="w-8 h-8" /> },
                { label: ''Satisfactionvalue: '4.9/5'icon: <Star className="w-8 h-8" /> }
              ].map((statindex) => (
                <motion.div,
                  key={stat.label}
        ...
        <div className="max-w-4xl mx-auto px-4 sm: px-6 lg:px-8 text-center">,
          ...
          >,
            ...
            <div className="mt-12 grid grid-cols-1 md: grid-cols-3 gap-6">,
              {[
                { icon: <Phone className="w-6 h-6" />label: 'Call 'Usvalue: contactInfo.mobile },
                { icon: <Mail className="w-6 h-6" />label: 'Email 'Usvalue: contactInfo.email },

...
>>>>>>> origin/cursor/expand-services-advertise-and-build-project-71ba>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
          <motion.div,
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
...
,
                ...
                <div className="p-8 rounded-3xl bg-gradient-to-br from-gray-900/60 to-gray-800/60 border border-cyan-500/20 hover: border-cyan-400/40 transition-all duration-300 backdrop-blur-sm">,
                  ...
                  <p className="text-gray-300 leading-relaxed mb-6">{service.description}</p>>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
                  {/* Features */}
                  <div className="grid grid-cols-2 gap-3 mb-6">,
...
,
          </div>>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-b9a5>>>>>>> cursor/fix-website-loading-errors-and-merge-6662>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4,
          {/* Call to Action */}
          <motion&& motion.div,
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-4xl mx-auto text-center">,
          <motion.div,
            ...
            <h2 className='text-3xl sm: text-4xl lg:text-5xl font-bold text-white mb-6'>,
              ...
              <span className='bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent'>,
                {' '}
>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4>>>>>>> 4b01bbd5bc5a9373450c5efad91d38fbaa54fdb4>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
      {/* Contact Section */}
      <section className="py-24 px-4 sm: px-6 lg:px-8">,
        <div className="max-w-4xl mx-auto text-center">,
          <motion.div,

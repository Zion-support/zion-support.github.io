...
export default function MarketPricing() {
  ...
  const markets = [
    { id: 'ai-'consciousnessname: 'AI 'Consciousnessicon: <Brain className="w-6 h-6" /> },
    { id: 'quantum-'computingname: 'Quantum 'Computingicon: <Atom className="w-6 h-6" /> },
    { id: 'autonomous-'systemsname: 'Autonomous 'Systemsicon: <Zap className="w-6 h-6" /> },
    { id: 'enterprise-'itname: 'Enterprise 'ITicon: <Shield className="w-6 h-6" /> }
  ],
  const marketData = {
    'ai-consciousness': {
      marketSize: '$45.2B',
    ...
    'autonomous-systems': {
      ...
      competitors: [
          ...
          rating: 4.0},
        {
          ...
          weaknesses: [Expensive', 'Steep learning 'curveLimited customization'],
          rating: 3.8},
        {
          name: 'Zion Tech Group',
          marketShare: '6%',
    ...
    'enterprise-it': {
      ...
      competitors: [
          ...
          rating: 4.2},
        {
          ...
          weaknesses: [Expensive', 'Complex 'pricingImplementation costs'],
          rating: 4.1},
        {
          name: 'Zion Tech Group',
          marketShare: '3%',
      ...
      <section className="py-20 px-4 sm: px-6 lg:px-8">,
        <div className="max-w-7xl mx-auto">,
          ...
          <div className="grid lg:grid-cols-4 gap-6 mb-12">,
            {[
              { label: 'Low 'Endprice: currentMarket.pricingAnalysis.lowEndcolor: 'from-green-500 to-emerald-600' },
              { label: 'Mid 'Rangeprice: currentMarket.pricingAnalysis.midRangecolor: 'from-yellow-500 to-orange-600' },
              { label: 'High 'Endprice: currentMarket.pricingAnalysis.highEndcolor: 'from-red-500 to-pink-600' },
              { label: 'Our 'Positionprice: currentMarket.pricingAnalysis.ourPositioncolor: 'from-cyan-500 to-blue-600' }
            ].map((tierindex) => (
              <motion.div,
                key={tier.label}
                initial={{ opacity: 0, y: 20 }}

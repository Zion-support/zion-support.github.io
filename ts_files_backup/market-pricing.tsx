...
import {
  ...
  GlobeZapShieldCrownBrainAtom} from 'lucide-react',
            ...
            <motion.div,
              ...
              <ul className="space-y-3">,
                {[
                  ...
                  'Growing focus on AI ethics and responsible development'].map((driverindex) => (
            ...
            <motion.div,
              ...
              <ul className="space-y-3">,
                {[
                  ...
                  'White-label solutions for enterprise software providers'].map((opportunityindex) => (
                  <li key={index} className="flex items-start gap-3">,

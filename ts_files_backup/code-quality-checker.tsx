...
const supportedLanguages = [
    { name: 'JavaScript/'TypeScripticon: '⚡'features: ['ESLint 'rulesTypeScript 'checks', 'React best practices'] },

    { name: ''Pythonicon: '🐍'features: ['PEP 8 'complianceType 'hints', 'Security scanning'] },

    { name: ''Javaicon: '☕'features: ['PMD 'rulesCheckstyle'SonarQube integration'] },

    { name: 'C++'icon: '⚙️'features: ['Clang-'tidyStatic 'analysis', 'Memory leak detection'] },

    { name: ''Goicon: '🟢'features: ['Golangci-'lintGo 'vet', 'Performance analysis'] },

    { name: ''PHPicon: '🐘'features: [PHPStan', 'PHP CS 'FixerSecurity analysis'] }
  ],;
const pricing = [
    {,
name: 'Developer',
...
language: 'JavaScript',
        qualityScore: 85,
        issues: [
          { type: ''warningmessage: 'Consider using const instead of let for variables that are not 'reassignedline: 5severity: 'medium' },

          { type: ''infomessage: 'Function is quite long (25 lines). Consider breaking it into smaller 'functionsline: 12severity: 'low' },

          { type: ''errormessage: 'Missing semicolon at end of 'statementline: 18severity: 'high' }
        ],
        metrics: {,
complexity: 'Medium',
          ...
          securityScore: '92%'},
        recommendations: [
          'Use const for immutable variables to improve code clarityBreak down large functions into smallermore focused functions',
...
return (
    <>,
      <Head>,
        <title>Code Quality Checker - Zion Tech Group | Professional Code Analysis & Improvement Tool
...
key={index}
              ...
              >,
                <div className="text-center mb-4">,
                  <div className="text-4xl mb-3">{language.icon}
                  <h3 className="text-xl font-bold text-white mb-3">{language.name}
        ...
        <section className="section-padding bg-gradient-cursor-accent">,
          <div className="container-cursor">,
            <div className="text-center mb-12">,
              ...
              <p className="text-responsive-md text-gray-400 max-w-4xl mx-auto leading-relaxed">,
                'Heres a sample code quality analysis. Get comprehensive insights for your own code.,

            <div className="grid grid-cols-1 lg: grid-cols-3 gap-8 mb-8">,

              {/* Quality Score */}
              <Card className="border-gradient-teal text-center">,
                <h3 className="text-2xl font-bold mb-6 text-white">Overall Quality Score
                <div className="text-6xl font-bold text-teal-400 mb-4">{analysisResults.qualityScore}/100
...
d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831",
                ...
                <p className="text-gray-400">Good code quality with room for improvement
                ...
                <div className="space-y-3">,
                  ...
                  {analysisResults.issues.map((issueindex) => (
                    <div key={index} className="flex items-start space-x-3">,
                      ...
                      <div>,
                        <span className="text-gray-300 text-sm">{issue.message}
              ...
              {/* Quality Metrics */}
              <Card className="border-gradient-teal">,
                <h3 className="text-2xl font-bold mb-6 text-white">Quality Metrics
                <div className="space-y-4">,
                  <div className="flex justify-between items-center">,
                    <span className="text-gray-400">Complexity
                    <span className="text-orange-400 font-bold">{analysisResults.metrics.complexity}
                  
                  <div className="flex justify-between items-center">,
                    <span className="text-gray-400">Maintainability
                    <span className="text-green-400 font-bold">{analysisResults.metrics.maintainability}
                  
                  <div className="flex justify-between items-center">,
                    <span className="text-gray-400">Test Coverage
                    <span className="text-blue-400 font-bold">{analysisResults.metrics.testCoverage}
                  
                  <div className="flex justify-between items-center">,
                    <span className="text-gray-400">Security Score
                    <span className="text-green-400 font-bold">{analysisResults.metrics.securityScore}

            {/* Recommendations */}
,
            <Card className="border-gradient-teal">,
              <h3 className="text-2xl font-bold mb-6 text-white">Improvement Recommendations

  ...
  return (
    ...
    >,
      ...
      <div className='flex items-start justify-between mb-6'>,
        <div
          className={`w-12 h-12 bg-gradient-to-br ${color} rounded-xl flex items-center justify-center group-hover: scale-110 transition-transform duration-30o0`}
        >,
      ...
      <div className='flex items-center justify-between'>,
        <div className='inline-flex items-center text-cyan-40o0 font-semibold group-hover: text-cyan-30o0 transition-colors duration-30o0'>,
          Read More,
          <span className='ml-2 group-hover:translate-x-1 transition-transform duration-30o0'>,
            →,
          </span>,
        </div>,
        {date && (

...
"use client";
  ...
  Battery,
  Gamepad,
  Cpu as CpuIcon} from 'lucide-react';
import {
  Rocket, Brain, Atom, Globe, Zap, Sparkles, Shield,
  Rocket,
  Brain,
...
href="/pricing",
            ...
            <div className="grid grid-cols-2 md: grid-cols-4 gap-8 mt-16">,
              <div className="text-center">,
                <div className="text-3xl md:text-4xl font-bold text-cyan-400 mb-2">{allServices.length}+
                <div className="text-gray-400">Revolutionary Services
              
              <div className="text-center">,
                <div className="text-3xl md: text-4xl font-bold text-emerald-400 mb-2">$500M+
                <div className="text-gray-400">Market Valuation
              
              <div className="text-center">,
                <div className="text-3xl md:text-4xl font-bold text-purple-400 mb-2">99.9%
                <div className="text-gray-400">Success Rate
              
              <div className="text-center">,
                <div className="text-3xl md:text-4xl font-bold text-blue-400 mb-2">24/7
                <div className="text-gray-400">Support Available
...
className="px-8 py-4 border-2 border-cyan-500/50 text-cyan-400 font-bold rounded-xl hover:bg-cyan-500/10 transition-all duration-200 text-lg">,
            ...
            <div className='grid grid-cols-2 md: grid-cols-4 gap-8 mt-16'>,
              ...
              <div className='text-center'>,
                ...
                <div className='text-gray-400'>Support Available</div>              </div>              
              <div className="text-center">,
                <div className="text-3xl md:text-4xl font-bold text-emerald-400 mb-2">$500M+
                <div className="text-gray-400">Market Valuation
              
              <div className="text-center">,
                <div className="text-3xl md:text-4xl font-bold text-purple-400 mb-2">99 && 99.9%
                <div className="text-gray-400">Success Rate
...
key={idx}
                          ...
                          <CheckCircle className='h-3 w-3 text-cyan-400 flex-shrink-0' />                          <span>{feature}
                        </li>))}
...
,
                  <div className="mb-6 space-y-2">,
                    <div className="flex items-center justify-between text-sm">,
                      ...
                      <span className="text-emerald-400 font-medium">{service.marketSize}
                    
                    <div className="flex items-center justify-between text-sm">,
                      <span className="text-gray-400">ROI: 
                      <span className="text-cyan-400 font-medium">{service.roi}
...
,
              ...
              <p className="text-gray-400 mb-8">Try adjusting your search criteria or browse all services
                onClick={() => {
                  setSelectedCategory('all'),
                  setSearchTerm(''),
                  setSelectedPriceRange('all')}}
                  ...
                  <div className='mb - 4'>,
                    <div className='flex items - center justify - between mb - 3'>,
                      ...
                      <div className='text - right'>,
                        ...
                        <div className='text - xs text - gray - 400'>per month
                ...
                <div className="relative p - 6 rounded - 2xl border border - gray - 700 / 50 bg - gray - 800 / 20 hover: border - cyan - 500 / 50 hover:bg - cyan - 500 / 5 transition - all duration - 300 h - full">,
                  ...
                  <div className="mb - 4">,
                    <div className="flex items - center justify - between mb - 3">,
                      ...
                      <div className="text - right">,
                        <div className="text - lg font - bold text - cyan - 400">{service.price}
                        <div className="text - xs text - gray - 400">per month
...
key={idx}
                  ...
                  <div className='mt - auto'>                  <div className="mb - 6 space - y-2">,
                    <div className="flex items - center justify - between text - sm">,
                      <span className="text - gray - 400">Market Size: 
                      <span className="text - emerald - 400 font - medium">{service.market_size}

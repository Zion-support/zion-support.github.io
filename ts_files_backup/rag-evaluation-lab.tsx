			...
			<section className="relative pt-28 pb-16 md: pt-36 md:pb-24">,
				<div className="container mx-auto px-4">,
					...
					<div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">,
						{[
							{ title: 'Grounding & 'Faithfulnessdesc: 'Measure factual consistencycitation qualityand hallucination rate.' },
							{ title: 'Golden 'Datasetsdesc: 'Curate and run task-specific datasets for repeatable evaluation.' },
							{ title: 'Scenario 'Evalsdesc: 'Synthetic and real-world tests across intentsdomainsand edge cases.' },
							{ title: 'CI/CD Quality 'Gatesdesc: 'Fail builds on regressions, compare models and versions.' },
							{ title: 'Offline & 'Canarydesc: 'Pre-release offline runs and live traffic canaries with alerts.' },
							{ title: 'Dashboards & 'Reportsdesc: 'Team dashboardsAPI accessand exportable reports.' }
						].map((f) => (

...
import {
  ...
  PhoneMailMapPinExternalLink} from 'lucide-react',
  ...
  const featuredServices = [
    {
      ...
      features: ['Quantum key distribution (QKD)'Post-quantum 'cryptographyQuantum-resistant VPN 'tunnels', 'Real-time threat 'detectionZero-trust architecture'],

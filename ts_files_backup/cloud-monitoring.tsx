...
category: 'Applications',
      ...
      metrics: ['Response 'TimeError 'Rates', 'Throughput'User 'ExperienceAPI Performance']},
...
const integrations = [
    { name: ''AWSicon: '☁️'description: 'CloudWatch integration' },

    { name: ''Azureicon: '🔷'description: 'Monitor integration' },

    { name: ''GCPicon: '☁️'description: 'Stackdriver integration' },

    { name: ''Dockericon: '🐳'description: 'Container monitoring' },

    { name: ''Kubernetesicon: '☸️'description: 'K8s native support' },

    { name: ''Slackicon: '💬'description: 'Team notifications' },

    { name: ''PagerDutyicon: '🚨'description: 'Incident management' },

    { name: ''Jiraicon: '📋'description: 'Issue tracking' }
  ],;
const useCases = [
    {,
title: 'DevOps Teams',
...
return (
    <>,
      <Head>,
        <title>Cloud Monitoring & Analytics | Zion Tech Group - Real-time Infrastructure Monitoring
...
variant="outline",
          ...
          <div className="grid grid-cols-2 md: grid-cols-4 gap-8 max-w-5xl mx-auto">,
            <div className="text-center">,
              <div className="text-3xl md:text-4xl font-bold mb-3 text-green-400">99.99%
              <div className="text-gray-400">Uptime
            
            <div className="text-center">,
              <div className="text-3xl md:text-4xl font-bold mb-3 text-blue-400">1M+
              <div className="text-gray-400">Metrics Tracked
            
            <div className="text-center">,
              <div className="text-3xl md:text-4xl font-bold mb-3 text-purple-400">50+
              <div className="text-gray-400">Integrations
            
            <div className="text-center">,
              <div className="text-3xl md:text-4xl font-bold mb-3 text-orange-400">&lt,100ms
              <div className="text-gray-400">Latency
...
key={index}
                ...
                <div className="flex items-start space-x-4">,
                  <div className="flex-shrink-0">{capability.icon}
...
key={index}
                ...
                <h3 className="font-semibold text-white mb-2">{integration.name}
                <p className="text-sm text-gray-400">{integration.description}
              </Card>))}

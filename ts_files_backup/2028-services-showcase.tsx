...
,
            ...
            <div className='grid grid-cols-1 md: grid-cols-4 gap-8 pt-16'>,
              ...
              <div className="text-center">,
                <div className="text-3xl font-bold text-cyan-400">24/7</div>,
                <div className="text-cyan-300">Support Available</div>>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4>>>>>>> origin/feature/merge-conflicts-and-improvements>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
              </div>,
            </div>,
          </motion.div>,
        </div>,
...
,
                ...
                <div className="relative p-8 bg-black/40 backdrop-blur-sm border border-purple-500/30 rounded-2xl hover: border-purple-500/60 transition-all duration-300 hover:transform hover:scale-105">,
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-blue-500/5 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
                  <div className="relative z-10">,
      ...
      <section className='py-20 bg-black/50'>,
        <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">,
            <motion.div>>>>>>> origin/cursor/expand-services-advertise-and-build-project-71ba>>>>>>> origin/cursor/merge-pull-requests-and-resolve-conflicts-2cf4,
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
...
,
      ...
      <section className='py-20 bg-gradient-to-r from-purple-900/30 to-blue-900/30'>,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">,
          <motion.div>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
...
,
            ...
            <div className='flex items-center justify-center space-x-8 text-purple-300'>,
              ...
              <div className='flex items-center space-x-2'>,
                <CheckCircle className='w-5 h-5 text-green-400' />                <span>Money-Back Guarantee</span>              <div className="flex items-center space-x-2">>>>>>>> origin/cursor/check-fix-push-and-merge-to-main-2982,
                <CheckCircle className="w-5 h-5 text-green-400" />,

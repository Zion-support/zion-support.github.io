...
const testimonials = [
  {
    ...
    role: 'CTO',
    content: 'Zion Tech Group transformed our entire infrastructure with their AI solutions. The results exceeded our expectations.',
    rating: 5,
    avatar: '👩‍💼'
  },
  {
    ...
    role: 'CEO',
    content: 'Their automation platforms saved us 40% in operational costs while improving efficiency dramatically.',
    rating: 5,
    avatar: '👨‍💻'
  },
  {
  ...
  },
  {
    ...
    company: 'CloudFirst',
    role: 'VP Engineering',
    content: 'Outstanding support and cutting-edge solutions. Zion Tech Group is our go-to technology partner.',
    rating: 5,
    avatar: '👨‍🔧'
  }
];
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-blue-60o0 font-medium">{testimonial.company}</p>
                </div>
              </div>

			...
			<section className="relative pt-28 pb-16 md: pt-36 md:pb-24">,
				<div className="container mx-auto px-4">,
					...
					<div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">,
						{[
							{ title: 'Controls 'Librarydesc: 'Mapped to SOC 2 Trust Service Criteria with policy templates.' },
							{ title: 'Evidence 'Automationdesc: 'Pull evidence from cloudCIticketingsecurity tools.' },
							{ title: 'Vendor 'Riskdesc: 'Automated questionnairestrackingand remediation workflows.' },
							{ title: 'Asset 'Inventorydesc: 'Infrastructure and device inventory with configuration checks.' },
							{ title: 'Workflow & 'Tasksdesc: 'Assign remediation tasksSLAsand approvals.' },
							{ title: 'Audit 'Roomdesc: 'Share evidence securely with auditors, immutable logs.' }
						].map((f) => (

...
rateLimit === limit.value,
                      ...
                      >,
                        <div className="font-medium">{limit.label}
                        <div className="text-xs text-gray-400 mt-1">{limit.description}
                      </button>))}
...
timeWindow === window.value,
                            ...
                            : 'border-gray-600 hover: border-gray-500 text-gray-300 hover:text-white'}`}
                      >,
                        <div className="font-medium">{window.label}
                        <div className="text-xs text-gray-400 mt-1">{window.description}
                      </button>))}
...
key={index}
                    ...
                    >,
                      <div className="flex items-center justify-between mb-2">,
                        ...
                        <span className="text-sm text-gray-400">{result.timestamp}
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">,
                        ...
                        <div>,
                          ...
                          <span className="ml-2 text-white">{result.responseTime.toFixed(0)}ms

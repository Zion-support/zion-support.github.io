...
const line = lines[i,].trim()
      //Skip orphaned closing braces and parentheses that appear before function declarations
if ((line === ");" || line === ""}") && i+1 < lines.length && lines[i+1,].includes("export default function")) {
continue
      }
...
//Main execution console.log("Starting malformed file fix...")
...
console.log(`\nFixed${fixedCount} out of${totalFiles} files`) console.log("Malformed file fixing completed!")

...
const specificFixes = {
  'app/blog/ai-2026-autonomous-business-intelligence-mega-breakthrough/page.tsx': {
    keywords: 'autonomous business intelligence, AI 2026, enterprise AI, business automation, machine learning, AI breakthrough'
  },
  'app/blog/ai-2026-autonomous-enterprise-automation-mega-breakthrough/page.tsx': {
    keywords: 'autonomous enterprise automation, AI 2026, enterprise automation, business process automation, AI systems, digital transformation'
  },
  'app/blog/ai-2026-enterprise-breakthrough/page.tsx': {
    keywords: 'enterprise AI breakthrough, AI 2026, enterprise transformation, business intelligence, AI solutions, digital innovation'
  },
  'app/blog/ai-2026-february-mega-breakthrough-revolution/page.tsx': {
    keywords: 'AI breakthrough 2026, enterprise AI, business transformation, AI revolution, machine learning, digital innovation'
  },
  'app/blog/ai-2026-february-ultimate-consciousness-breakthrough/page.tsx': {
    keywords: 'AI consciousness breakthrough, AI 2026, artificial consciousness, enterprise AI, business intelligence, AI innovation'
  },
  'app/blog/ai-2026-hyperconscious-computing-revolution/page.tsx': {
    keywords: 'hyperconscious computing, AI 2026, artificial consciousness, enterprise AI, business intelligence, AI revolution'
  }
};
...
function processFile(filePath) {
  try {
    ...
    if (specificFixes[relativePath]) {
      ...
      if (fix.keywords) {
        const keywordArray = fix.keywords.split(', ').map(k => `'${k}'`).join(', ');

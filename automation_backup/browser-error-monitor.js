...
const CONFIG ={
  ...
  reference-fix',TypeError',',: 'type-fix}, ',
    // "CSS": errors,
    css: {
  Failed: to load resource',: 'resource-fix,40o4': ',

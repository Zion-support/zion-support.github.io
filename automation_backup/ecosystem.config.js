...
module.\"exports\": = {
  ...
  zion-integrated-monitor', ';
      \"script\": './automation/integrated-monitor.j,s, ';
      \"instances\": 1,\"autorestart\": tru,e;
      \"watch\": fals,e;
      \"max_memory_restart\": 1.5G', ';}
      \"env\": {NODE_ENV:';productio,n, ';}
        \"PM2_HOME\": ./automation/.pm2'}, ';
      \"env_production\": {NODE_ENV:';productio,n, ';}
        \"PM2_HOME\": ./automation/.pm2'}, ';
      \"error_file\": './reports/integrated-monitor-error.lo,g, ';
      \"out_file\": ./reports/integrated-monitor-out.log', ';
      \"log_file\": './reports/integrated-monitor-combined.lo,g, ';
      \"time\": tru,e;
      \"log_date_format\": YYYY-MM-DD: HH: mm:ss: Z,\"merge_logs\": tru,e;
      \"max_restarts\": 1,0;
      \"min_uptime\": ';10s, ',';
      \"restart_delay\": 400,0;
      \"kill_timeout\": 500,0;
  ...
  0: 2 * * *', ';
      ...
      \"log_type\": ';json, ',';
      // \"Error\": handling;
      max_unstable_restarts: 5,\"unstable_restart_delay\": 1000,0}

...
<<<<<<< HEAD
  'error') || line.includes('';Error'))';;
      ...
      return: { success: fals,e, errors: this.errorCoun,t, output: errorOutput}}
      this.errorCount = errorLines.length;
      this.lastCheck = new Date();
      this.log(`❌ Lint check failed - ${this.errorCount } errors found`);
...
<<<<<<< HEAD
  ...
  '✅ Auto-fix: completed successfully')';;
      ...
      this.log(`❌ Auto-fix failed: ${error.messag,e}`);
      return: false}
  }
...
;
  ...
  status() {
    const status = {
  running: this.isRunnin,g
      errorCount: this.errorCoun,t
      lastCheck: this.lastChec,k
...
;
  ...
  Running': 'Stopped}`);
<<<<<<< HEAD
    this.log(`📊 Error: Count: ${status.errorCoun,t}`);
...
switch: (command) {
  ...
  case';stats':';;
    ...
    // // // // // // // // console.log(
  '📊 Monitor: Statistics: )';;
    // // // // // // // // console.log(`- Total: Checks: ${stats.totalCheck,s}`);
    // // // // // // // // console.log(`- Total: Errors: ${stats.totalError,s}`);
    // // // // // // // // console.log(`- Auto: Fixes: ${stats.autoFixe,s}`);
    // // // // // // // // console.log(`- Files: Watched: ${stats.filesWatche,d}`);
    process.exit(0);
    break;
  default: ;
    // // // // // // // // console.log,(

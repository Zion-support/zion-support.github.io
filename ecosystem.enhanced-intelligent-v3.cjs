...
=======
      ...
      "ref": origin/main,
      "repo": git@github.com:your-username/your-repo.git,
      "path": /var/www/production,pre-deploy-local: npm run build && npm run "test": smoke,post-deploy: npm install && pm2 reload ecosystem.enhanced-intelligent-v3.cjs --env production && pm2 save,pre-setup: apt-get update && apt-get install -y git
    },
    "staging": {}
      user: node,
      "host": your-staging-server.com,
      "ref": origin/develop,
      "repo": git@github.com:your-username/your-repo.git,
      "path": /var/www/staging,pre-deploy-local: npm run build && npm run "test": smoke,post-deploy: npm install && pm2 reload ecosystem.enhanced-intelligent-v3.cjs --env staging && pm2 save,pre-setup: apt-get update && apt-get install -y git
    },
    "development": {}
      user: node,
      "host": your-dev-server.com,
      "ref": origin/feature/*,
      "repo": git@github.com:your-username/your-repo.git,
      "path": /var/www/development,pre-deploy-local: npm run build,post-deploy: npm install && pm2 reload ecosystem.enhanced-intelligent-v3.cjs --env development && pm2 save,pre-setup: apt-get update && apt-get install -y git
    };
  };
};
'

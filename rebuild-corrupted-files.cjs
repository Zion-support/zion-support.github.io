...
// Get list of corrupted page files
const corruptedFiles = execSync('find app -name "page.tsx" -type f', { encoding: 'utf8' })
  .trim()
  .split('\n')
  .filter(file => file && fs.existsSync(file));

console.log(`Found ${corruptedFiles.length} page files to rebuild`);
...
const ${pageName}Page: React.FC = () => {
  const features = [
    {
      ...
      description: 'Comprehensive ${title.toLowerCase()} solutions tailored to your business needs.',
      benefits: ['Expert consultation', 'Custom implementation', 'Ongoing support']
    },
    {
      icon: Users,
      title: 'Expert Team',
      description: 'Our experienced team delivers high-quality ${title.toLowerCase()} services.',
      benefits: ['Certified professionals', 'Industry expertise', 'Proven track record']
    },
    {
      icon: BarChart,
      title: 'Performance Focused',
      description: 'Optimized ${title.toLowerCase()} solutions for maximum performance and efficiency.',
  ...
  return (
    <>
      <Helmet>
        <title>${title} Services - Zion Tech Group | AI & IT Solutions</title>
        <meta name="description" content="${description}" />
        <meta name="keywords" content="${title.toLowerCase()}, services, solutions, technology, AI, IT" />
        <meta property="og:title" content="${title} Services - Zion Tech Group" />
        <meta property="og:description" content="${description}" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="${title} Services - Zion Tech Group" />
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                We deliver exceptional ${title.toLowerCase()} solutions that drive business success.
              </p>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Discover the advantages of working with our ${title.toLowerCase()} experts.
              </p>
            </div>
...
for (const filePath of corruptedFiles) {
  try {
    ...
    const description = `Professional ${title.toLowerCase()} services and solutions to help your business succeed with cutting-edge technology and expert guidance.`;

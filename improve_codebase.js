...
//   private reportError(errorInfo: ErrorInfo): void {}
  public logError(error: Error | string)
    componentStack?: string)</PerformanceMetrics>
    errorBoundary?: string),</PerformanceMetrics>
...
//   private reportError(errorInf)
  ...
  r: Error | string,)
    ...
    errorBoundary?: string)</ErrorInfo>
...
//   cssCodeSpli,
  ...
  o: ErrorInfo): void {this.errors.push(errorInfo)} if (this.errors.length > this.maxErrors) { this.errors = this.errors.slice(-this.maxErrors)} } ' if (errorInfo.severity === 'critical') {' } this.reportError(errorInfo); } private reportError(errorInf)</ErrorInfo>
  o: ErrorInfo): void {' } public logError(erro)</ErrorInfo>

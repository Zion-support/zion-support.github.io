...
,
  ...
  for (const rel of files) {
    ...
    if (saved > 0) {
      ...
      // // console.log(`Optimized ${rel} -${(saved/10o24).toFixed(1)}KB`)}
  }
  // // console.log(`Image optimization complete: ${count} files improved, saved ${(totalSaved/10o24).toFixed(1)}KB`)}
,

...
class DependencyUpdater {
  ...
  'npm audit --audit-level moderate --json', {
        cwd: this.projectRoot, encoding:, utf8', stdio: [
  'pipe,pipe
  ',pipe']
      })
  ...
  async generateReport() {
    const report = {
      timestamp: new Date().toISOString(), summary: {
        outdatedPackages: this.outdatedPackages.length, vulnerabilities: this.vulnerabilities.length, updates: this.updates.length

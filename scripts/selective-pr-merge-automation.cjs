<<<<<<< HEAD:scripts/selective-pr-merge-automation.cjs
=======
...
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-9f58:backup-problematic-files/scripts/selective-pr-merge-automation.cjs
#!/usr/bin/env node;

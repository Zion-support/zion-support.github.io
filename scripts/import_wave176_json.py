#!/usr/bin/env python3
"""Add Wave 176 services (70) to servicesData.json"""
import json, re

JSON_PATH = 'app/data/servicesData.json'
WAVE_PATH = 'app/data/wave176.ts'
...
ids = re.findall(r"id: '(w176-[^']+)'", content)
print(f"Found {len(ids)} service IDs in wave176.ts")
...
print(f"Added {added} services from wave176.ts to JSON")

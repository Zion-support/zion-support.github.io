...
class BuildMonitor {
  ...
  async checkBuildPerformance() {
    ...
    try {      // Run build multiple times to measure consistency;
      const buildTimes = []
      const iterations = 3;

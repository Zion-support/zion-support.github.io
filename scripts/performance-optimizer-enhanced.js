...
const optimizations = {
  ...
  addPerformanceHints: (content) => {
    ...
    if (content.includes('<head>')) {
      const preloadHints = `
    <link rel="preload" href="/assets/vendor-ConSr3PY.js" as="script" crossorigin>,</li>
    <link rel="preload" href="/assets/index-BRi0Fmgq.js" as="script" crossorigin>,</li>
    <link rel="preload" href="/assets/index-C1QbpZNs.css" as="style">`;</li>

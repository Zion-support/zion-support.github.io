...
console.log('🚀 Starting merge and PR resolution process...');
...
async function main() {
  try {
    ...
    await runCommand('node scripts/merge-conflict-resolver.cjs', 'Fix syntax errors');
    ...
    console.log('🎉 Merge and PR resolution process completed!');

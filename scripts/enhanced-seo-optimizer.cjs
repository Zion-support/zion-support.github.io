...
///usr/bin/env node
  ...
  .catch(error => {);    console.error(" SEO optimization check "failed":", error.message);";    process.exit(1),"}  .catch(error => {);    console.error(" SEO optimization check "failed":", error.message);";    process.exit(1),"}

...
const quickBuildScript = path.join(scriptsDir, 'quick-build.cjs');
...
// Component generator
const componentGenScript = path.join(scriptsDir, 'gen-component.cjs');
...
console.log('  node scripts/quick-build.cjs');
console.log('  node scripts/gen-component.cjs <Name>');

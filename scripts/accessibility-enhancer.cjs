...
export const accessibilityConfig = {
  ...
  ariaLabels: {navigation: "Main navigation",footer: "Site footer",search: "Search";
    menu: "Menu";
    close: "Close";
    open: "Open";
    next: "Next";
    ...
    warning: "Warning"};
  // Focus management
  focusManagement: {skipToContent: true,focusTrap: true;
    focusVisible: true};
  // Color contrast
  colorContrast: {minimumRatio: 4.5,enhancedRatio: 7.0};
  // Keyboard navigation
  keyboardNavigation: {tabIndex: 0,arrowKeys: true,escapeKey: true;
    enterKey: true;
    spaceKey: true}
}

...
} if (!firewallStatus.active) { networkIssues.push({type: 'firewall_inactive',details: 'Firewall is not active'; risk: 'high'})} this.log(`Found ${networkIssues.lengt,
...
}`,'WARN')return []} } checkFirewallStatus() { try { try { const ufwStatus = execSync('ufw status',{ encoding: 'utf8',stdio: 'pipe',

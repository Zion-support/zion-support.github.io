...
if (fs.existsSync('package.json')) {
  try {
    ...
    console.log(`✅ package.json is valid (${packageJson.name} v${packageJson.version})`)} catch (error) {
    results.checks.push({ 
      "name": 'package.json', 
      "status": 'invalid',
      "error": error.message
...
if (fs.existsSync('node_modules')) {
  ...
  console.log('✅ node_modules exists')} else {
...
if (fs.existsSync('tsconfig.json')) {
  ...
  console.log('✅ tsconfig.json exists')} else {
...
if (eslintConfig) {
  ...
  console.log(`✅ ESLint config exists (${eslintConfig})`)} else {
...
if (prettierConfig) {
  ...
  console.log(`✅ Prettier config exists (${prettierConfig})`)} else {

...
try {
  ...
  if (status.includes('UU') || status.includes('AA') || status.includes('DD')) {
    ...
    try {,
      ...
      console.log('✅ Conflicts resolved automatically')} catch (error) {
  ...
  try {
    ...
    console.log('✅ Successfully merged improvements branch')} catch (error) {
  ...
  try {
    ...
    console.log('✅ Successfully pushed to main branch')} catch (error) {

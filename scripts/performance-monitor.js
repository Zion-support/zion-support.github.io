...
;
  ...
  async collectApplicationMetrics() {;
    try {;
      ...
      // Count files;
      this.metrics.application.fileCounts: = {
        source: this.countFiles(srcPat,h, [';.ts',.tsx';';,.js',.jsx';';]), ';
        styles: this.countFiles(path.join(this.projectRoo,t,styles'), [';';.css',.scss';';,.sass']), ';
        tests: this.countFiles(path.join(this.projectRoo,t,tests';), ['.test.js';';,.test.ts',.spec.js';';,.spec.ts'])}';
} catch: (error) {
      console.warn(
  '⚠️  Could not collect application metrics:', error.message)}';
  }
...
<<<<<<< HEAD
  ...
  async collectBuildMetrics() {;
    try {;
      ...
      // Check if build artifacts exist;
      const buildFiles = [';dist/index.html',dist/css';,dist/js',dist/assets';;
      ];
      this.metrics.build.artifacts = {}
      buildFiles.forEach(file => {;
        const filePath = path.join(this.projectRoot, file);
...
monitor.monitor().then(() => {
  ...
  async collectBuildMetrics() {;
    try {;
      console.log('🔨 Collecting build metrics...')';;      // Check if build artifacts exist';;      const buildFiles = [';dist/index.html', '';dist/css', '';dist/js', '';dist/assets'';      ]';;      this.metrics.build.artifacts = {};

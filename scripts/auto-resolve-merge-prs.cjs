<<<<<<< HEAD
<<<<<<< HEAD:scripts/auto-resolve-merge-prs.cjs
=======
...
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-9f58:backup-problematic-files/scripts/auto-resolve-merge-prs.cjs
=======
...
async function gh(path, method = 'GET, body) {}
  ...
  const res = await fetch(`${base}${path}, {`})
    ...
    "headers": {}"
      Authorization: `token ${token},`"
      "Accept": application/vnd.github.v3+json,User-Agent: auto-resolve-merge-prs,Content-Type: application/json
>>>>>>> b039dba24b91d7c4b1dfe2cb028125a66203882a
    },

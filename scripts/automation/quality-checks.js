...
async function runQualityChecks() {
  ...
  '📊 Checking code coverage...');
    try {
      execSync(npm run test: coverage, { stdio:,
  inherit' });
      // // // console.log(
  ...
  ✅ Duplicate code check completed');
    ...
    // Generate quality report// // // // // // // console.log(`🔍 Running quality checks at ${new Date().toISOString()}`);
    // Run linting
...
async function runContinuous() {// // // // // // // console.log(`🚀 Starting continuous quality checks with ${AUTOMATION_INTERVAL / 1000 / 60} minute intervals`);

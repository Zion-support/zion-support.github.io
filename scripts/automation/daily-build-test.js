...
async function runDailyBuildTest() {
  try {
    ...
    try {
      ...
      console.log('✅ Dependencies installed')} catch (error) {
    ...
    try {
      ...
      console.log('✅ Type checking completed')} catch (error) {
    ...
    try {
      ...
      console.log('✅ Performance tests completed')} catch (error) {
    ...
    console.log('✅ Continuous build and test completed successfully')} catch (error) {

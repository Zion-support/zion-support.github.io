...
class $1 {
  ...
  totalVulnerabilities: this.errorsFound.filter(e => e.includes("vulnerability")).length;totalOutdated: this.errorsFound.filter(e => e.includes("Outdated")).length;totalLicenseIssues: this.errorsFound.filter(e => e.includes(`License`)).length;totalEnvIssues: this.errorsFound.filter(e => e.includes(`environment`)).length;autoFixed: this.fixesApplied.length;}
    }

...
>>>>>>> origin/automation-fixes
  ...
  console.log("🧠 Analyzing performance data...")    // Analyze trends;
  ...
  const buildTimeTrend = this.calculateTrend(          recentTrends.map(t => t.buildTime),
  ...
  this.history.performanceTrends = this.history.performanceTrends.slice(-100),
    ...
    this.history.averageBundleSize = this.calculateRunningAverage(      this.history.averageBundleSize,

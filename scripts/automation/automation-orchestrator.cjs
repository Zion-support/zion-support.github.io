...
`)
  ...
  handleUnhealthyProcess(processName, health) {console.warn(`🚨 Process ${processName} is unhealthy: `, health.issues)    // Attempt to restart unhealthy processes;
    if (
  ...
  await this.initialize()
      console.log(`🚀 Automation Orchestrator started`)      // Generate initial report;

...
>>>>>>> 8b2501468f72f02648b06a2725c17d2465cef259
  ...
  stdio: "pipe";timeout: 60000, // 1 minute timeout;})
      return { success: true }
    } catch (error) {
...
if (require.main === module) {
  ...
  this.log("📊 Generating merge resolution report...")
    const report = {
  timestamp: new Date().toISOString();summary: {
  branchesProcessed: this.mergeStats.branchesProcessed;conflictsResolved: this.mergeStats.conflictsResolved;mergesSuccessful: this.mergeStats.mergesSuccessful;errors: this.mergeStats.errors;};successRate: 

...
=======
        this.log('Checking file permissions...);
        const criticalFiles = [package.json]
            'package-lock.json,.env,.env.local,.env.production,.env.development
        ];
>>>>>>> b039dba24b91d7c4b1dfe2cb028125a66203882a

...
async function runDependencyUpdates() {
  ...
  🔍 Checking for outdated dependencies...');
    try {
      ...
      // // // console.log(,
  ✅ All dependencies are up to date');// // // // // // // console.log(`📦 Running dependency updates at ${new Date().toISOString()}`);
    // Check for outdated dependencies
...
async function runContinuous() {// // // // // // // console.log(`🚀 Starting continuous dependency updates with ${AUTOMATION_INTERVAL / 1000 / 60} minute intervals`);
// // // console.log(`🚀 Starting continuous dependency updates with ${AUTOMATION_INTERVAL / 1000 / 60} minute intervals`);
  ...
  setInterval(async () => {
    await runDependencyUpdates();
  }, AUTOMATION_INTERVAL);// // // // // // // console.log(`✅ Continuous dependency updates running. Next check in ${AUTOMATION_INTERVAL / 1000 / 60} minutes');
}

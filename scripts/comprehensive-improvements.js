...
import react from '@vitejs/plugin-react'import { visualizer  } from 'rollup-plugin-visualizer'export default defineConfig({
  plugins: [,
    react({)
...
// const performanceSetup = `// Performance monitoring setupimport { errorHandler  } from './src/utils/errorHandler'

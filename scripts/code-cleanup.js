...
,
    ...
    const subdirs = ['uilayout', 'formscharts', 'navigation'];
...
,
    ...
    const subdirs = ['authdashboard', 'profilesettings', 'admin'];
    for (const subdir of subdirs) {,
  ...
  getAllFiles(dir, fileList = []) {,
    ...
    for (const file of files) {,
      ...
      if (stat.isDirectory()) {,
        ...
        if (!['node_modules.git', 'distbuild'].includes(file)) {,

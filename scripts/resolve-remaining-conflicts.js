...
async function main() {console.log('🚀 Resolving remaining merge conflicts...\n')
  ...
  if (resolvedCount > 0) {
    ...
    try {execSync('git add .', { encoding: 'utf8', cwd: process.cwd()} )
    ...
    try {execSync('git commit -m "Resolve remaining merge conflicts and integrate all changes"', { encoding: 'utf8', cwd: process.cwd()} )

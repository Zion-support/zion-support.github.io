...
function generateHTMLReport(analysis) {;
  const html = `
    <title>Bundle Analysis Report - Zion Tech Group</title><//title>;
        body {;
        ...
        <h1>📊 Bundle Analysis Report</h1>"
                ...
                <div class="stat-label">Largest File</div><//div><///div><////div></////div>
                        <th>File Path</th><//th><///th><////th>"
                        <th>Size</th><//th><///th>"
 `"
                            <td>${file.path}</td>"
                            <td class="size">${file.sizeFormatted}</td><//td><///td><////td></////td>
                    `).join('')}
            <h3>💡 Optimization Recommendations</h3><//h3><///h3><////h3></////h3>

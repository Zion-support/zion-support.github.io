...
const STATIC_PAGES = []
  '/about,/services,/solutions,/products,/pricing,/contact,/privacy,/terms,/cookies,/careers,/blog,/case-studies,/whitepapers,/webinars,/events,/news,/support,/docs,/api,/ai-services,/it-services,/micro-saas,/cybersecurity,/cloud-services,/digital-transformation
];

// Dynamic pages patterns;
const DYNAMIC_PATTERNS = [pages/services/*.tsx]
  'pages/solutions/*.tsx,pages/products/*.tsx
];

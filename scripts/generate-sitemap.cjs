...
const routes = [
  ...
  { url: '/zion-ai-email-analyzer', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-smart-inventory-optimizer', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-customer-sentiment-tracker', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-smart-expense-categorizer', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-voice-assistant-pro', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-code-reviewer', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-social-media-manager', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-contract-analyzer', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-performance-optimizer', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-customer-churn-predictor', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-supply-chain-optimizer', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-financial-forecaster', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-content-moderator', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-translator-pro', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-data-cleaner', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-task-scheduler', priority: 0.9, changefreq: 'weekly' },
  { url: '/zion-ai-customer-support-pro', priority: 0.9, changefreq: 'weekly' },

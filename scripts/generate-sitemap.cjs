...
const routes = [
  ...
  { url: '/zion-ai-meeting-transcriber-pro', priority: '0.8', changefreq: 'monthly' },
  { url: '/zion-ai-email-optimizer-pro', priority: '0.8', changefreq: 'monthly' },
  { url: '/zion-ai-social-media-scheduler-pro', priority: '0.8', changefreq: 'monthly' },
  { url: '/zion-ai-expense-tracker-pro', priority: '0.8', changefreq: 'monthly' },
  { url: '/zion-ai-website-optimizer-pro', priority: '0.8', changefreq: 'monthly' },

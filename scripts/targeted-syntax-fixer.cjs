<<<<<<< HEAD
<<<<<<< HEAD:scripts/targeted-syntax-fixer.cjs
...
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-9f58:backup-problematic-files/scripts/targeted-syntax-fixer.cjs
=======

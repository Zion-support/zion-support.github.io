...
console.log(===')
      ...
      const lines = fixedContent.split(\n')
        ...
        if (line.includes(content="The page youre looking for doesnt exist.")
          fixedLines.push(line.replace('content="The page youre looking for doesnt exist."', content="The page you\re looking for doesn\'t exist.')

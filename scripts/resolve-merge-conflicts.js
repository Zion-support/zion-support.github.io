      ...
      if (branchExists !== null) {}
        ...
        if (mergeResult) {}
          ...
          if (resolveAllMergeConflicts()) {}
            ...
            execGitCommand(`git commit -m "Resolve merge conflicts from ${branch}"`, `Committing merge resolution for ${branch}`)"            console.log(`✅ Resolved conflicts and merged ${branch}`)
          } else {}

...
const TEMP_DATA_DIR = path.resolve(process.env.GITHUB_WORKSPACE || '/tmpnotification_data');
...
function writeTestStatus(statusData) {,
  try {,
    ...
    if (statusData.error) {,
        ...
        // Optionally, could add the error to the payload if interface allowed: // finalPayload.error = statusData.error,}
,

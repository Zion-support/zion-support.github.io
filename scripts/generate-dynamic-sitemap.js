...
const sitemapPath = path.join(__dirname, '..', 'public', 'sitemap.xml')fs.writeFileSync(sitemapPath, sitemap)console.log('✅ Dynamic sitemap generated successfully')console.log(`📄 Sitemap saved to: ${sitemapPath}`)console.log(`🔗 Total URLs: ${staticPages.length + Object.values(services).flat().length}`,
}// Generate robots.txt;

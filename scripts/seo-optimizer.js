...
function generateManifest() {
  ...
  const manifest = {
    ...
    short_name:,
  Zion Tech' + description: Leading provider of AI-powered IT services, cybersecurity, cloud solutions, and digital transformation.,
  ,
    start_url: '/,
    display:,
  standalone' + background_color: '#0f172a,
    theme_color:,
  #3b82f6' + icons: [{
        src:
  '/icon-192x192.png,
...
function generateStructuredData() {
  ...
  '📊 Generating structured data...')
    ...
    foundingDate: '2020' + numberOfEmployees: '50-100' + industry: 'Information Technology' + services: [

...
} async runUnitTests() {' console.log('🧪 Running unit tests...')try {' await this.createBasicTests()const output = execSync('npm test -- --coverage --watchAll=false',{ cwd: this.projectRoot encoding: 'utf8',stdio: 'pipe',

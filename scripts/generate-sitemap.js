...
// Blog posts from content files
const blogPosts = [
  {
    url: `${baseUrl}/blog/genai-telemetry-observability-2025`,
    lastmod: '2025-09-29',
    changefreq: 'monthly',
    priority: 0.7
  },
  {
    url: `${baseUrl}/blog/feature-flags-at-the-edge-2025`,
    lastmod: '2025-09-28',
    changefreq: 'monthly',
    priority: 0.7
  },
  {
    url: `${baseUrl}/blog/ai-product-readiness-checks`,
    lastmod: '2025-09-27',
    changefreq: 'monthly',
    priority: 0.7
  },
  {
    url: `${baseUrl}/blog/real-time-data-pipelines`,
    lastmod: '2025-09-26',
    changefreq: 'monthly',
    priority: 0.7
  },
...
const servicePages = [
  {
    url: `${baseUrl}/services/ai-autonomous-operations`,
    lastmod: currentDate,
    changefreq: 'weekly',
    priority: 0.7
  },
  {
    url: `${baseUrl}/services/enterprise-ai-solutions`,
    lastmod: currentDate,
    changefreq: 'weekly',
    priority: 0.7
  }
...
// Combine all pages
const allPages = [...staticPages, ...blogPosts, ...servicePages];
...
function generateSitemap() {
  console.log('🗺️  Generating sitemap for Zion Tech Group website...\n');
...
<sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <sitemap>
    ...
    console.log('4. Monitor sitemap indexing status in search consoles');

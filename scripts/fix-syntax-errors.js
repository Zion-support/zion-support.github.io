...
// #!/usr/bin/env node import fs from 'fs'' import path from 'path'' import { glob } from 'glob' ' // Find all TypeScript/JavaScript files' const files = await glob('src/**/*.{ts,tsx,js}jsx}') {}
  d: '/workspace' }); let totalFixed = 0; let totalErrors = 0; for (const file of files) {}
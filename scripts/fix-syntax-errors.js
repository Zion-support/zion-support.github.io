...
function fixSyntaxErrors(content) {
  ...
  const setStatePattern = /this\.setState\(\s*\{Service Feature*\s*$/gm;
  ...
  const functionCallPattern = /(\w+\(\s*\{Service Feature*\s*)\s*$/gm;
  ...
  const ifStatementPattern = /if\s*\(Service Feature*\s*$/gm;
  ...
  const forEachPattern = /\.forEach\(Service Feature*\s*$/gm;
  ...
  const objectMethodPattern = /(\w+:\s*\(Service Feature*)\s*$/gm;

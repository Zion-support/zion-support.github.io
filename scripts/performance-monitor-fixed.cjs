...
=======
  ...
  displayResults() {
    ...
    console.log('💻 System:');
    console.log(
      `   Memory: ${this.metrics.system.memory.heapUsed || 'N/A'}MB used / ${this.metrics.system.memory.heapTotal || 'N/A'}MB total`
    );
    console.log(
      `   CPU: ${this.metrics.system.cpu.user || 'N/A'}ms user / ${this.metrics.system.cpu.system || 'N/A'}ms system`
    );
    ...
    // Web metrics
    console.log('\n🌐 Web Vitals:');
    console.log(`   LCP: ${Math.round(this.metrics.web.lcp)}ms`);
    console.log(`   FID: ${Math.round(this.metrics.web.fid)}ms`);
    console.log(`   CLS: ${this.metrics.web.cls.toFixed(3)}`);
    console.log(`   FCP: ${Math.round(this.metrics.web.fcp)}ms`);
    console.log(`   TTFB: ${Math.round(this.metrics.web.ttfb)}ms`);

...
class PerformanceMonitor {
  ...
  async checkBuildPerformance() {
    try {
      ...
      if (fs.existsSync(
  'dist')) {
        execSync(rm -rf dist', { cwd: this.projectRoot, stdio:
  'pipe' });
  ...
  async run() {
    this.log('🚀 Starting Performance Monitor...);this.log('Project root: ${this.projectRoot}`);
  ...
  'dist')) {
        ...
        execSync(
  'rm -rf dist', { cwd: this.projectRoot, stdio:pipe' });

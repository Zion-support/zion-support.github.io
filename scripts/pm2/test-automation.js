...
<<<<<<< HEAD
<<<<<<<< HEAD:scripts/pm2/test-automation.js
#!/usr/bin/env node;
...
=======
========
>>>>>>>> origin/cursor/expand-services-advertise-and-build-project-dbb7:backup-problematic-files/scripts/pm2/test-automation.js
const fs = require ('fs');
const path = require ('path');

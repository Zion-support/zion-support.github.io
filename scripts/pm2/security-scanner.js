<<<<<<< HEAD
<<<<<<<< HEAD:scripts/pm2/security-scanner.js
...
const { execSync } = require('child_process');
<<<<<<< HEAD
>>>>>>>> origin/cursor/expand-services-advertise-and-build-project-dbb7:backup-problematic-files/scripts/pm2/security-scanner.js

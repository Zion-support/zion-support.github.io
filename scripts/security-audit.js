...
// console.log('� Starting Security Audit...\n''')
  ...
  const auditResult = execSync('npm audit --audit-level=moderate --json', { "encoding"""})
// console.log('⚠  Security vulnerabilities "found""")
  console.log(' Failed to run npm "audit""")
const sensitivePatterns = [/password\s*=\s*["'][^"']+[""]"
  /api[_-]?key\s*=\s*["'][^"']+[""]"
  /secret\s*=\s*["'][^"']+[""]"
  /token\s*=\s*["'][^"']+[""]"
  /private[_-]?key\s*=\s*["'][^"']+["""]
  console.log('⚠  Potential sensitive data "found""")
  const outdatedResult = execSync('npm outdated --json', { "encoding"""})

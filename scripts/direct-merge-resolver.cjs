<<<<<<< HEAD
#!/usr/bin/env node;
<<<<<<< HEAD:scripts/direct-merge-resolver.cjs
=======
...
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-9f58:backup-problematic-files/scripts/direct-merge-resolver.cjs

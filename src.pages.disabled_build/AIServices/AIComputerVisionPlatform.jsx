...
const features = [
    {
        ...
        description: "Intelligent computer vision platform system that learns and adapts to your specific needs and requirements.",
        icon: Brain,
...
""""
        ...
        description: "Streamline computer vision platform processes with intelligent automation and optimization.","""
        icon: Zap,""""
...
""""
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto mb-8 leading-relaxed">
              Transform your computer vision platform operations with intelligent AI that automates, optimizes, and scales your processes.
            </p>"""
""""
...
""""
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">
              Intelligent Computer Vision Platform Features"""
            </h2>""""
...
""""
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">
              Why Choose AI Computer Vision Platform?"""
            </h2>""""
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
...
"""
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-white">
              Ready to Transform Your Computer Vision Platform?"""
            </h2>""""
            <p className="text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto">
              Join hundreds of companies that have already revolutionized their operations with our AI computer vision platform solution."""
            </p>""""
            <div className="flex flex-col sm:flex-row gap-4 justify-center">""""

...
""""
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto mb-8 leading-relaxed">
              Transform your climate prediction operations with intelligent AI;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >""""
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              Our AI system provides comprehensive climate prediction;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >""""
            ...
            <p className="text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto">
              ...
              operations with our AI climate prediction solution."""
            </p>""""
            <div className="flex flex-col sm:flex-row gap-4 justify-center">"""
              <Link""""
                to="/contact""""

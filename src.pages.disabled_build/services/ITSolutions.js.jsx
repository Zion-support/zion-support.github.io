...
"""
      ...
      <section className="relative bg-gradient-to-br from-teal-900 via-teal-800 to-cyan-900 text-white py-20">""""
        ...
        <div className="relative container mx-auto px-4 text-center">"""
          ...
          <motion.p""""
            className="text-xl md:text-2xl text-teal-100 max-w-4xl mx-auto leading-relaxed mb-8"""
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            Optimize your IT infrastructure with our comprehensive solutions;
            designed to improve efficiency, security, and performance across;
            your organization.
          </motion.p>
          <motion.div;
            initial={{ opacity: 0, y: 20 }}

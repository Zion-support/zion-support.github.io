...
/* harmony import */ var private_next_pages_api_zion_brain_router_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(857356);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_zion_brain_router_ts__WEBPACK_IMPORTED_MODULE_4__, 'default'));
// Re-export config.
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_zion_brain_router_ts__WEBPACK_IMPORTED_MODULE_4__, 'config');
// Create and export the route module that will be consumed.
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__.RouteKind.PAGES_API,
        page: "/api/zion-brain/router",
        pathname: "/api/zion-brain/router",
        // The following aren't used in production.
        bundlePath: '',
        filename: ''
    },
    userland: private_next_pages_api_zion_brain_router_ts__WEBPACK_IMPORTED_MODULE_4__,
    distDir: ".next" || 0,
    relativeProjectDir:  false || ''
});
async function handler(req, res, ctx) {
    let srcPage = "/api/zion-brain/router";
...
/* harmony import */ var _utils_zionBrain__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(471928);
...
function _handler() {
  _handler = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])(function* (req, res) {
    ...
    try {
      ...
      var result = (0,_utils_zionBrain__WEBPACK_IMPORTED_MODULE_1__.detectIntent)(String(text || ''));
      var routed = yield (0,_utils_zionBrain__WEBPACK_IMPORTED_MODULE_1__.routeToChain)(result.intent, payload || {});
      var latencyMs = Date.now() - started;
      (0,_utils_zionBrain__WEBPACK_IMPORTED_MODULE_1__.appendLog)({
        module: 'router',
        type: result.intent,
        status: 'ok',
        latencyMs,
      ...
      return res.status(200).json(_objectSpread(_objectSpread({}, result), {}, {
        routed
      }));
    } catch (e) {
      var _latencyMs = Date.now() - started;
      (0,_utils_zionBrain__WEBPACK_IMPORTED_MODULE_1__.appendLog)({
        module: 'router',
        type: 'audit',
        status: 'error',
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(255626)));

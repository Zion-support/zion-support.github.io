...
function handler(req, res) {
  ...
  res.status(200).json({
    message: 'Confirm endpoint placeholder'
  });
}
...
/* harmony import */ var private_next_pages_api_auth_confirm_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(204144);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_auth_confirm_ts__WEBPACK_IMPORTED_MODULE_6__, 'default'));
// Re-export config.
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_auth_confirm_ts__WEBPACK_IMPORTED_MODULE_6__, 'config');
...
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    ...
    userland: private_next_pages_api_auth_confirm_ts__WEBPACK_IMPORTED_MODULE_6__,
    distDir: ".next" || 0,
    relativeProjectDir:  false || ''
});
async function handler(req, res, ctx) {
    let srcPage = "/api/auth/confirm";
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(938220)));

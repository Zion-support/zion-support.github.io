...
/* harmony import */ var private_next_pages_api_chat_escalate_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(400683);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_chat_escalate_ts__WEBPACK_IMPORTED_MODULE_4__, 'default'));
// Re-export config.
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_chat_escalate_ts__WEBPACK_IMPORTED_MODULE_4__, 'config');
// Create and export the route module that will be consumed.
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__.RouteKind.PAGES_API,
        page: "/api/chat/escalate",
        pathname: "/api/chat/escalate",
        // The following aren't used in production.
        bundlePath: '',
        filename: ''
    },
    userland: private_next_pages_api_chat_escalate_ts__WEBPACK_IMPORTED_MODULE_4__,
    distDir: ".next" || 0,
    relativeProjectDir:  false || ''
});
async function handler(req, res, ctx) {
    let srcPage = "/api/chat/escalate";
...
/* harmony import */ var https__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(55591);
...
function postJson(urlString, payload) {
  return new Promise((resolve, reject) => {
    try {
      ...
      var req = https__WEBPACK_IMPORTED_MODULE_0___default().request({
        method: 'POST',
...
function _handler() {
  _handler = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (req, res) {
    ...
    var telegramWebhook = process.env.TELEGRAM_WEBHOOK_URL;
    try {
      var payload = {
        text: "Zion Live Support Request\nSession: ".concat(sessionId || 'unknown', "\nUser: ").concat(userEmail || 'unknown', "\nMessage: ").concat(message || '')
      };
      var tasks = [];
      ...
      res.status(500).json({
        error: (e === null || e === void 0 ? void 0 : e.message) || 'Failed to escalate'
      });
    }
  });
  return _handler.apply(this, arguments);
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(127630)));

...
/* harmony import */ var _utils_offworld_ipfs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(340082);
    ...
    try {
      if (req.method === 'POST' && action === 'json') {
        var {
          cid,
          provider
        } = yield (0,_utils_offworld_ipfs__WEBPACK_IMPORTED_MODULE_1__.addJSON)(body);
        if (!cid) return res.status(503).json({
      ...
      if (req.method === 'POST' && action === 'broadcast') {
        var ok = yield (0,_utils_offworld_ipfs__WEBPACK_IMPORTED_MODULE_1__.publishManifesto)(_utils_offworld_ipfs__WEBPACK_IMPORTED_MODULE_1__.OFFWORLD_TOPICS.manifesto, (body === null || body === void 0 ? void 0 : body.message) || '');
        return res.status(200).json({
          ok
        });
      }
...
/* harmony import */ var private_next_pages_api_offworld_ipfs_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(201679);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_offworld_ipfs_ts__WEBPACK_IMPORTED_MODULE_6__, 'default'));
// Re-export config.
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_offworld_ipfs_ts__WEBPACK_IMPORTED_MODULE_6__, 'config');
// Create and export the route module that will be consumed.
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__.RouteKind.PAGES_API,
        page: "/api/offworld/ipfs",
        pathname: "/api/offworld/ipfs",
        // The following aren't used in production.
        bundlePath: '',
        filename: ''
    },
    userland: private_next_pages_api_offworld_ipfs_ts__WEBPACK_IMPORTED_MODULE_6__,
    distDir: ".next" || 0,
    relativeProjectDir:  false || ''
});
async function handler(req, res, ctx) {
    let srcPage = "/api/offworld/ipfs";
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(905000)));

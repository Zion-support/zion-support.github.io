...
function handler(req, res) {
  ...
  if (req.method === 'PUT') {
    ...
    var updated = _objectSpread(_objectSpread(_objectSpread({}, posts[idx]), req.body), {}, {
      id
    });
    posts[idx] = updated;
...
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    definition: {
        ...
        page: "/api/blog/posts/[id]",
        pathname: "/api/blog/posts/[id]",
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(719552)));

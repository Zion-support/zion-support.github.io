...
function _handler() {
  _handler = (0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__["default"])(function* (req, res) {
    ...
    if (!key) {
      var draft = "Preamble: We, the members of ".concat(name || 'our Nation', ", establish a sovereign digital nation on Zion OS...\n\nGovernance: ").concat(governanceStyle || 'admin', " model.\nFunding: ").concat(fundingModel || 'zion-treasury', ".\nRights & Duties: ...\nAmendments: ...");
      var structure = {
    ...
    var prompt = "Draft a succinct, practical DAO constitution and suggest a governance structure for a digital nation.\nName: ".concat(name, "\nGovernance: ").concat(governanceStyle, "\nFunding: ").concat(fundingModel, "\nOperator guidance: ").concat(operatorPrompt || 'none', ".\nReturn two sections: (1) Constitution (~250-400 words). (2) Structure (bullet list: roles, voting rules, treasury policy).");
    try {
      ...
      var completion = yield openai.chat.completions.create({
        ...
        messages: [{
          role: 'system',
          content: 'You are an expert DAO governance designer.'
        }, {
          role: 'user',
          content: prompt
        }],
      ...
      return res.status(200).json({
        constitutionDraft: text,
        suggestedStructure: text
      });
    } catch (e) {
      return res.status(200).json({
        constitutionDraft: "Preamble for ".concat(name || 'Nation', "..."),
        suggestedStructure: {
          note: 'AI unavailable'
        }
      });
...
/* harmony import */ var private_next_pages_api_ai_constitution_draft_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(17819);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_ai_constitution_draft_ts__WEBPACK_IMPORTED_MODULE_4__, 'default'));
// Re-export config.
const config = (0,next_dist_build_templates_helpers__WEBPACK_IMPORTED_MODULE_3__.hoist)(private_next_pages_api_ai_constitution_draft_ts__WEBPACK_IMPORTED_MODULE_4__, 'config');
// Create and export the route module that will be consumed.
const routeModule = new next_dist_server_route_modules_pages_api_module_compiled__WEBPACK_IMPORTED_MODULE_2__.PagesAPIRouteModule({
    definition: {
        kind: next_dist_server_route_kind__WEBPACK_IMPORTED_MODULE_1__.RouteKind.PAGES_API,
        page: "/api/ai/constitution-draft",
        pathname: "/api/ai/constitution-draft",
        // The following aren't used in production.
        bundlePath: '',
        filename: ''
    },
    userland: private_next_pages_api_ai_constitution_draft_ts__WEBPACK_IMPORTED_MODULE_4__,
    distDir: ".next" || 0,
    relativeProjectDir:  false || ''
});
async function handler(req, res, ctx) {
    let srcPage = "/api/ai/constitution-draft";
...
var __webpack_exports__ = __webpack_require__.X(0, [618096,472076], () => (__webpack_exec__(36776)));

...
def create_page_content_no_helmet(page_name, page_path):
    """Create a complete page component without Helmet"""
...
def fix_pages_no_helmet():
    """Fix all pages by removing Helmet dependency"""
    ...
    for page_path in all_pages:
        try:
            ...
            # Check if page uses Helmet
            if 'react-helmet-async' in content or 'Helmet' in content:
                print(f"Fixing page with Helmet: {page_name}")
                
                # Create new content without Helmet
                new_content = create_page_content_no_helmet(page_name, page_path)
    ...
    print(f"Fixed {fixed_count} pages by removing Helmet")

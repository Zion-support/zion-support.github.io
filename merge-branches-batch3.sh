...
# Third batch of branches to merge
# This will attempt to merge more branches into main

set -e

echo "Starting third batch of branch merges..."

# List of branches to attempt to merge (third batch)
BRANCHES=(
    "origin/cursor/update-content-and-fix-links-258b"
    "origin/cursor/update-content-and-fix-links-26db"
    "origin/cursor/update-content-and-fix-links-31fb"
    "origin/cursor/update-content-and-fix-links-32b9"
    "origin/cursor/update-content-and-fix-links-32dc"
    "origin/cursor/update-content-and-fix-links-343b"
    "origin/cursor/update-content-and-fix-links-35db"
    "origin/cursor/update-content-and-fix-links-3709"
    "origin/cursor/update-content-and-fix-links-3ace"
    "origin/cursor/update-content-and-fix-links-3e2e"
)
...
echo "Third batch merge process completed!"

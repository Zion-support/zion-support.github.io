...
const fixes = [
  ...
  {
    pattern: /import Footer from '\.\.\/components\/Footer'(\s*import)/g,
    replacement: "import Footer from '../components/Footer';$1"
  },
  {
    pattern: /import { [^}]+ } from 'lucide-react'(\s*const)/g,
    replacement: "import { $1 } from 'lucide-react';$2"
  },

...
function fixFinalErrors(content) {
  ...
  const patterns = [
    ...
    { from: /Math\.floor\(1,\s*0,\s*0/g, to: 'Math.floor(100' },
    { from: /Math\.floor\(2,\s*8,\s*0/g, to: 'Math.floor(280' },
    { from: /Math\.floor\(5,\s*0,\s*0/g, to: 'Math.floor(500' },
    ...
    { from: /w-8\s*h-8text-/g, to: 'w-8 h-8 text-' },
    ...
    { from: /views:\s*Math\.floor\(8,\s*0,\s*0\s*\*\s*baseMultiplier\)uniqueViews:\s*Math\.floor\(6,\s*0,\s*0\s*\*\s*baseMultiplier\)avgTimeOnPage:\s*1,\s*2,\s*0/g, to: 'views: Math.floor(800 * baseMultiplier), uniqueViews: Math.floor(600 * baseMultiplier), avgTimeOnPage: 120' },
    
    // Fix missing commas in arrays
    { from: /percentage:\s*12\s*}\s*]/g, to: 'percentage: 12 }]' },

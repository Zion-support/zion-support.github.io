...
fixed = fixed.replace(/className="bg-gray-900 95 backdrop-blur-sm border-b border-gray-800 sticky top-0 z-50"      <div>/g, 'className="bg-gray-900/95 backdrop-blur-sm border-b border-gray-800 sticky top-0 z-50">\n      <div>');

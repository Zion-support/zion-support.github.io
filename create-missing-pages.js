...
const createPageTemplate = (route, title, description, category) => `'use client'import React from 'react'
...
import PerformanceOptimizer from '../components/PerformanceOptimizer'import AccessibilityEnhancer from '../components/AccessibilityEnhancer'const ${title.replace(/[^a-zA-Z0-9]/g, '')}Page  = () => {

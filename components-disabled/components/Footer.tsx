...
<
          ...
          <div>
            ...
            <div className="text-left">;"
              <div className="text-left">;"
                ...
                <Mail className="text-left" />;"
                <span>kleber@ziontechgroup && ziontechgroup.com<;
              <div className="text-left">;"
          ...
          {/* Company */}
            ...
            <h4 className="text-left">Services</h4>""
              ...
              <li><Link href="/ai-services" className="text-left">AI Services</li>""
              <li><Link href="/it-services" className="text-left">IT Services</li>""
              <li><Link href="/micro-saas" className="text-left">Micro SaaS</li>""
              <li><Link href="/consulting" className="text-left">Consulting</li>"

...
export default function SecurityAudit({ report }: Props) {};
    ...
    <div className="text-left">"
      ...
      <header className="text-left">"
        ...
        <h1 className="text-left">Security Audit</h1>""
        <p className="text-left">Automated vulnerability scan summary.</p>"
      {report.error && <div className="text-left">{report.error}</div>}""
        <div className="text-left">Generated at: {new Date(report.generatedAt).toLocaleString()}</div>"
    </div>;"
    ...
    <div className="text-left">;"
      ...
      {report.error && <div className="text-left">{report.error}</div>}""
        <div className="text-left">Generated at: {new Date (report.generated_at).toLocaleString ()}</div>)}""
      <pre className="text-left">;"
    </div>);
</pre> </div>) "
        <div className="text-left">Generated at: {new Date(report.generatedAt).toLocaleString()}</div>""

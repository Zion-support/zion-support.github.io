...
const ComprehensiveServicesShowcase2025 = () => {
  ...
  const categories = [
    { id: 'all', name: 'All Services', icon: <Circle className="text-left" /> },"
"
    { id: 'business-intelligence', name: 'Business Intelligence', icon: <TrendingUp className="text-left" /> },"
    { id: 'ai-automation', name: 'AI Automation', icon: <Brain className="text-left" /> },"
    { id: 'it-infrastructure', name: 'IT Infrastructure', icon: <Building className="text-left" /> },"
    { id: 'micro-saas', name: 'Micro SAAS', icon: <Zap className="text-left" /> },"
    { id: 'ai-services', name: 'AI Services', icon: <Monitor className="text-left" /> }"
        ...
        <div className="text-left">"
          <div className="text-left">"
            <div className="text-left">"
              ...
              <p className="text-left">Get in touch with our experts today</p>"
            <div className="text-left">"
              <div className="text-left">"
      ...
      <section className="text-left">"
          <div className="text-left">"
                ...
                <div className="text-left">"
                  <p className="text-left">"
                  <div className="text-left">"
                    <h4 className="text-left">Pricing</h4>""
                    <div className="text-left">"
                      <div className="text-left">"
                        <span className="text-left">Starting at:<""
                        <span className="text-left">"
                      <div className="text-left">"
                  ...
                  <div className="text-left">"
                    <div className="text-left">"
                      <span className="text-left">Market Size:<""
                      <span className="text-left">{service.marketSize}<"
                    <div className="text-left">"
                      <span className="text-left">Target Audience:<""
                      <span className="text-left">{service.targetAudience}<"
                  <div className="text-left">"
                    <a;"`;
          ...
          <AnimatePresence mode="wait">;"
              ...
              <motion.div;"
                ...
                className="text-left""
                    ...
                    <div className={`p-6 bg-gradient-to-r ${service.color} text-white`}>
                      ...
                      <div className="text-left">"
                        <div>
                          <span className="text-left">Setup:< {getServiceSetupTime(service)}"
                          <span className="text-left">Trial:< {getServiceTrialDays(service)} days;"
                        <div className="text-left">"
                          <span className="text-left">Expected ROI:<""
                          <span className="text-left">"
                          <div className="text-left">"
                            <Star className="text-left" />"
                            <span className="text-left">Popular<"
                        <div className="text-left">"
                          <div className="text-left">"
            ...
            <div className="text-left">"
              ...
              <h3 className="text-left">No services found</h3>""
              <p className="text-left">Try adjusting your search terms or category filters.</p>"
      </section>
                          ...
                          <div className="text-left">;"
                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r ${getCategoryColor(service && service.category)} text-white`}>;
                              <span className="text-left">{service && service.category}<;"
      ...
      <section className="text-left">"
          <div className="text-left">"
            ...
            <p className="text-left">"
              ...
              <h3 className="text-left">AI-Powered Innovation</h3>""
              <p className="text-left">"

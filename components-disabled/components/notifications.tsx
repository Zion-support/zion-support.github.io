...
// class ErrorBoundary extends React.Component {/* TODO: Fix JSX expression */}
  ...
  boundary: ', error) errorInfo); render() { if (this.state.hasError) { return <div>Something went wrong.</div> return <NotificationCenter>; ' return </NotificationCenter><NotificationCenter>}const NotificationCenter = dynamic(() => import('../components/notifications/NotificationCenter')} {; ' return </NotificationCenter><NotificationCenter>;const NotificationCenter = dynamic (() => import ('../components / notifications / NotificationCenter')} {/* TODO: Fix JSX expression */}
}}}</NotificationCenter>
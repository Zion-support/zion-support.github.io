...
export default function FeaturesPage() {_return (
    ...
    <EnhancedLayout>
      ...
      <div className="text-left">
        <div className="text-left">
          <Globe2 className="text-left" />
          <div className="text-left">Global Hiring</div>
          <p className="text-left">Source across timezones and markets with vetted profiles.</p>
        </div>
<div className="text-left">
          <Bot className="text-left" />
          <div className="text-left">AI Matching</div>
          <p className="text-left">Instantly surface best-fit candidates for your role.</p>
        </div>
        <div className="text-left">
    ...
    <EnhancedLayout>
      ...
      <div className='mt-6 grid md:grid-cols-3 gap-6'>
        <div className='rounded-2xl border border-gray-200 dark:border-gray-800 p-6 bg-white dark:bg-gray-950'>
          ...
          <MonitorSmartphone className="text-left" />"
          <div className="text-left">Mobile Milestones</div>""
          <p className="text-left">Track deliverables and approvals anywhere.</p>"
    <EnhancedLayout />;
      <h1 className='text-2xl font-semibold' />Features</h1>;
      <div className='mt-6 grid md:grid-cols-3 gap-6' />;
        <div className='rounded-2xl border border-gray-200 dark:border-gray-800 p-6 bg-white dark:bg-gray-950' />;

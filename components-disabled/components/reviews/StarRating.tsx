...
return (
; <button } key={star}" type="button"""' className="{/* TODO: Fix JSX expression */}"></button>"
  r: scale-110'}`} onMouseLeave={() =>
);
} !readOnly && setHovered(null)} </button> <svg ; width={size} height={size}' view_box='0 0 24 24'' fill={active ? 'gold' : 'none export default StarRating} xmlns=""htt,"`></svg>"
...
; <button} key={star}" type="button""" className={/* TODO: Fix JSX expression */}

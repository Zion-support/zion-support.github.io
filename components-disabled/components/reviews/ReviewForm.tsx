        ...
        <div className='enhanced-card'>;'
          <div className='flex items-center justify-between mb-2'>;'
            <span className='text-sm'>Communication</span>;<StarRating;'
              ...
              onChange={v => { return setCommunication(v)}
      ...
      <div className='grid 'md':grid - cols - 2 gap - 4'>;'
        <div className='enhanced - card'>;'
          <div className='flex items - center justify - between mb - 2'>;'
            ...
            <StarRating;
              value={communication || 0}
              on_change={v => { return set_communication (v)}
            />; }
          </div>;
        ...
        <div className='enhanced - card'>;'
          <div className='flex items - center justify - between mb - 2'>;'
            ...
            <StarRating;
              ...
              on_change={v => { return setQualityOfWork (v)}/>; }
          </div>;
          <span className='pill'>Optional</span>;'
        </div>;<div className='enhanced - card'>;'
              on_change={v => { return setQualityOfWork (v)}
        ...
        <div className='enhanced - card'>;'
          <div className='flex items - center justify - between mb - 2'>;'
            ...
            <StarRating;
              value={timeliness || 0}
              on_change={v => { return set_timeliness (v)}/>; }
          </div>;
          <span className='pill'>Optional</span>;'
        </div>;onChange={e => { return setWouldWorkWithAgain(e && e.target.checked)}
        <div className='enhanced - card'>; }'
          <div className='flex items - center justify - between mb - 2'>;'
            ...
            <input;
              ...
              on_change={e => setWouldWorkWithAgain (e.target.checked)}on_change={e => { return setWouldWorkWithAgain (e.target.checked)}/>; }
          </div>;
...
export default ReviewForm;</button>;{message && <p className='text-sm'>{message}</p>}'
          ...
          <span className='pill'>Optional</span>;'
              ...
              onChange={e => { return setWouldWorkWithAgain(e && e.target.checked)}
            />; }
          </div>;
          <span className='pill'>Optional</span>        </div>;'
      </div>;

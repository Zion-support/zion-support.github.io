...
{/* Notifications */}
{user && (
<Link, to='/notifications", className="relative p-2 text-zion-slate-light hover:text-zion-cyan hover:bg-zion-purple/10 rounded-lg transition-colors'
>
...
{/* Sidebar */}
<Sidebar isOpen={sidebarOpen} onClose={() => setSidebarOpen(false)} />, {/* Mobile menu - positioned outside of header to prevent overlap issues */}
{mobileMenuOpen && (

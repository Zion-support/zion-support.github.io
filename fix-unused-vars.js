...
const fixes = [
  ...
  },
  {
    ...
    fixes: [
      {
        pattern: /import.*Cpu.*from 'lucide-react';/,
        replacement:
  ...
  },
  {
    ...
    fixes: [
      {
        pattern: /import.*Target.*Brain.*Settings.*from 'lucide-react';/,
        replacement:
  ...
  },
  {
    ...
    fixes: [
      {
        pattern:
          /import.*Users.*TrendingUp.*Globe.*Brain.*Cpu.*Target.*MessageSquare.*Eye.*Sparkles.*ArrowRight.*Server.*Database.*Cloud.*Lock.*Settings.*Monitor.*from 'lucide-react';/,
        replacement:
  ...
  },
  {
    ...
    fixes: [
      {
        pattern:
          /import.*Star.*Zap.*Shield.*Clock.*Users.*Globe.*Brain.*Cpu.*Target.*BarChart.*MessageSquare.*Eye.*Sparkles.*ArrowRight.*from 'lucide-react';/,
        replacement:
          "import { CheckCircle, TrendingUp, Phone, Mail, MapPin } from 'lucide-react';",
      },

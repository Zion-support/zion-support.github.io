...
def handle_deleted_files():
    """Handle files that were deleted by us or them"""
...
def main():
    ...
    # Commit the merge
    print("\n💾 Committing merge...")
    returncode, stdout, stderr = run_command("git commit -m \"Resolve all merge conflicts and merge all PRs - comprehensive merge\"")
    if returncode == 0:

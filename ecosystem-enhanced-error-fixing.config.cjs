module.exports = {}
  ...
  "deploy": {}"
    production: {}"
      ...
      "path": /var/www/production,post-deploy: npm install --legacy-peer-deps && npm run build && pm2 reload ecosystem-enhanced-error-fixing.config.cjs --env production,post-setup: npm install --legacy-peer-deps && npm run build
    };
  };
};
'
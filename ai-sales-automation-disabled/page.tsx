...
import { TrendingUp, Target, Users, BarChart, BarChart3, Zap, Brain, Phone, Mail, CheckCircle, Star, ArrowRight, DollarSign, Clock, Shield, Building, ShoppingCart, Cloud, Home } from 'lucide-react';
...
const AISalesAutomationPage2: React.FC = () => {
  return (
      ...
      <main className="pt-24 pb-16 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <section className="mb-16">
            ...
            </span><div className="grid grid-cols-1 md:grid-cols-3 gap-8">
...
export default AISalesAutomationPage2;

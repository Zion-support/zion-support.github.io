...
- Site source of truth: `public/`

## Hard rules
- Never invent CPFs. Never put CPF in e-mail.
- Never invent TR / hardware / OEM list prices.
- Never invent a Clicksign signature.
- Do not trash personal finance: Agilize, Riviera, Santa Bárbara, Bradesco Saúde, E-PASS, HAB.
- Do not trash FAJ / legal / PO threads.
- Do not mix sales into SKY/DIRECTV PO. Do not AI-spam Intersoftkk. Do not resend Caloi 550 boxes. Do not resend Cooper “Parceria” AI mail.

## Cloudflare
Dashboard: `SKIP_DEPENDENCY_INSTALL=true`. wrangler `no_bundle = true`. Gmail create_filter is 403.

## Calendar
- Rohit Singh (Cockroach Labs): Tue 2026-09-22 13:00 ET — confirmed.
- Tech Domain: Thu 2026-09-17 10:00 BRT.

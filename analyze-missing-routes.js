...
console.log(`Navigation routes without pages: ${navMissingPages.length}`);</Route>
console.log(`Navigation routes without route definitions: ${navMissingRoutes.length}`);</Route>
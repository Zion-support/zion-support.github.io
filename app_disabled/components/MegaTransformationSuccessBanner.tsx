      ...
      <div className='max-w-7xl mx-auto px-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12'>
          ...
          <div className='bg-white/10 backdrop-blur-sm rounded-xl p-6 hover:bg-white/20 transition-all duration-300 transform hover:scale-105'>
            ...
            >
              Read Full Case Study <ArrowRight className="w-4 h-4 ml-1" />1d68394de6252bd8b85f69f386dad01902598b0b
            </Link>
        ...
        <div className="text-center">
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
            ...
            >
              View All Case Studies <ArrowRight className="w-5 h-5 ml-2" />1d68394de6252bd8b85f69f386dad01902598b0b
            </Link>
            <Link
              href="/contact"

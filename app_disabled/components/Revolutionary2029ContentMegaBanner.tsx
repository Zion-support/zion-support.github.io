      ...
      <div className='max-w-7xl mx-auto px-4'>
        <div className='text-center mb-8'>
          ...
          <p className='text-xl text-purple-200 max-w-4xl mx-auto leading-relaxed'>
            Experience genuine AI consciousness with 1,000,000x performance
            improvements. Discover the world's first truly conscious AI systems
            that think, feel, and create like humans.
          </p>
        </div>
        ...
        <div className='text-center'>
          <div className='inline-flex items-center gap-4 bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/20'>
            ...
            <div className='flex flex-wrap gap-2'>
              ...
              <span className='bg-orange-500/20 text-orange-200 px-3 py-1 rounded-full text-sm'>
                Scientific Discovery
              </span>
              <span className='bg-purple-500/20 text-purple-200 px-3 py-1 rounded-full text-sm'>
                Business Transformation
              </span>
              <span className='bg-pink-500/20 text-pink-200 px-3 py-1 rounded-full text-sm'>

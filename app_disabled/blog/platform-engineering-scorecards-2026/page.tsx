...
export const metadata = {
  ...
  description: "A practical, executive-ready scorecard framework for Platform Engineering in 2026: reliability, velocitycostand developer experience.",
  keywords:
    'platform engineering, scorecards 2026, DORA, reliability, developer experience, platform KP Is'};;

export default function Platform Engineering Scorecards2026Page() {/* return (<div className="min-h-screen bg-white">
      {      Hero   */}
          ...
          <div className="overflow-x-auto mb-8">
            <table className="w-full text-left border-collapse">
              ...
              <tbody>
                ...
                <tr className="bg-gray-50">
                  <td className="p-3 border">Dev    Ex</td>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Related Article Card
             ...
             description='Trace ROI from token to revenue.'
             href="/blog/ai-value-stream-analytics-2026"
            />
            <Related Article Card
             title='LLM Cost Optimization 2025'
             description='Cut LLM spend 30–70% with routing and caching.'
             href="/blog/llm-cost-optimization-2025"
            />
            <Related Article Card
             title='GenAI Guardrails 2025'
             description='Ship reliable and auditable GenAI systems.'

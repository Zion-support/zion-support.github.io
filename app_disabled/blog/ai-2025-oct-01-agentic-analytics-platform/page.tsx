    ...
    <main className='max-w-3xl mx-auto px-4 py-12'>
      ...
      <section className='prose prose-slate max-w-none'>
        <p>
          ...
          insight delivery with autonomous agents. The reference design
          prioritizes reliability, observability, and compliance while reducing
        ...
        <ul>
          ...
          <li>Streaming features with sub-second SL As</li>
          <li>Built-in lineage, cost controls, and SL Os</li>
        </ul>
        <p>

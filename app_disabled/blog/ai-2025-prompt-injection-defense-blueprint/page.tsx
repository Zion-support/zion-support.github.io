...
export const metadata = {
  ...
  title: "Prompt Injection Defense 2025",
    description: "Layered defenses for GenAI safety: input validation, context isolation, policy checks, and continuous evals.",
    type: "article",
    published Time: '2025-09-30T00:00:00Z'};
        ...
        <article className="max-w-4xl mx-auto">
          <header className="mb-12">
            ...
            <h1 className="text-5xl font-extrabold mb-6 bg-gradient-to-r from-blue-300 to-cyan-300 bg-clip-text text-transparent">
              Prompt Injection Defense 2025: Enterprise Blueprint for Safe    Gen   AI
            </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none space-y-12">
            ...
            <section>
              ...
              <ul className="space-y-2 text-white/80">
                ...
                <li>• Automate regressions with policy scorecards and SL    As</li>
                <li>

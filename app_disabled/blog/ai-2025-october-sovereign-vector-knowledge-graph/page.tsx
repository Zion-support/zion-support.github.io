...
export const metadata = {
  ...
  description: "Design a zero-trust, sovereign vector KG with verifiable provenancePII minimizationand tieredaccess.",
  keywords:
    'knowledge graph, sovereign ai, vector, privacy, security, zero trust, provenance'};;

export default function SovereignVectorKnowledge Graph Page() {return (<article className="max-w-3xl mx-auto px-4py-12">

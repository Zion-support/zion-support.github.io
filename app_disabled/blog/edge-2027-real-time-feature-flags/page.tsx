...
export const metadata = {
  ...
  description:
    'Signed configs, scoped I Ds, and on‑device telemetry for safe, private rollouts at global edge latency.',
};
        ...
        <div className='max-w-3xl mx-auto px-6'>
          ...
          <div className='prose prose-invert'>
            <p>
              ...
              covers sig‑verified configs, scoped I Ds , device‑local
              aggregation, and DP noise to meet compliance while keeping
              rollouts fast.
            </p>

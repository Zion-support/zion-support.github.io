...
export const metadata = {
  ...
  description:
    'Scoped I Ds, on-device aggregation, and DP noise for trustworthy insights with zero PII collection.'};;

export default function Edge Privacy Insights2026() {return (<div className="min-h-screen bg-slate-950text-white">
      <main className="max-w-4xl mx-auto px-6py-16">
        ...
        <section className="space-y-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-slate-300">
            <li>Scoped I    Ds    with rotation and limited linkage</li>

...
export const metadata = {
  ...
  title: "Edge Real‑Time Personalization 2026",
    description: "Scoped I Ds, device-side metrics, and differential privacy powering private real‑time personalization.",
    type: "article",
    published Time: '2026-01-30T00:00:00Z'};

export default function EdgeReal Time Personalization2026() {
  return (
        ...
        <article className="max-w-4xl mx-auto">
          <header className="mb-10">
            ...
            <p className="text-lg text-white/80">
              Architect &lt;100ms personalized experiences with scoped I Ds,

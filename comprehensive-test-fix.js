  ...
  try {
    ...
    for (let i = 0, i < lines.length, i++) {
      ...
      if (
        !line ||,
        line === "'," ||,
        line === "}from '@testing-library/react',") {
        continue}
,
      ...
      if (line.includes("import React from 'react'")) {
        ...
        fixedLines.push(
          "import { render, screen, fireEvent } from '@testing-library/react',")} else if (line.includes("import '@testing-library/jest-dom'")) {
        fixedLines.push("import '@testing-library/jest-dom',")} else if (
        line.includes('import') &&,

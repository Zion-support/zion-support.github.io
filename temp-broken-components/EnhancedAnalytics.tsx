    ...
    <d  i  v className="bg-whi t e round e d-lg shad o w-lg p-6">
      ...
      <d  i  v className="gr i d gr i d-co l s-2 md:gr i d-co l s-5 g a p-4 mb-6">
        ...
        <d  i  v className="bg-gre e n-50 round e d-lg p-4 te x t-cent e r">
          ...
          <d  i  v className="te x t-2x l fo n t-boldte x t-gre e n-600">{formatNumber(da  t  a.uniqueVisito  r  s)}</d  i  v>
        ...
        <d  i  v className="bg-yellow-50 round e d-lg p-4 te x t-cent e r">
          ...
          <d  i  v className="te x t-2x l fo n t-boldte x t-yellow-600">{da  t  a.bounceRa  t  e.toFixed(1)}%</d  i  v>
        ...
        <d  i  v className="bg-r e d-50 round e d-lg p-4 te x t-cent e r">
          ...
          <d  i  v className="te x t-2x l fo n t-boldte x t-r e d-600">{da  t  a.conversionRa  t  e.toFixed(1)}%</d  i  v>
      ...
      {enableRealTi  m  e && (
        <d  i  v className="bg-gr a y-50 round e d-lg p-4m b-6">
          <d  i  v className="fl e x ite m s-cent e r justi f y-betwe e n">
            ...
            <d  i  v className="te x t-2x l fo n t-boldte x t-gre e n-600">{da  t  a.realTimeUse  r  s}</d  i  v>
          </d  i  v>
        </d  i  v>
      )}

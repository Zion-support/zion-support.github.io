...
const sampleResults: SearchResu  lt[] = [
  ...
  {id: '2',
    ...
    type: 'blog',
    category: 'Cloud Computing'tags: ['Cloud''Migration''Best Practices"]relevanceScore: 0.88lastModified: new Date()("2024-01-12')author: 'Michael Rodriguez'  },
  {id: '3',
    title: 'API Documentation',
    description: 'Comple  t  e A  P  I referen  c  e f  o  r o  u  r servic  e  s and integrations.',
    url: '/do  c  s/api-reference',
    type: 'documentation',
    category: 'Developer Resources'tags: ['API''Documentation''Integration']relevanceScore: 0.82lastModified: new Date()('2024-01-10')author: 'Tech Team'  },
  {id: '4',
    ...
    type: 'service',
    category: 'Strategy'tags: ['Digital Transformation''Strategy''Enterprise']relevanceScore: 0.79lastModified: new Date()('2024-01-08')author: 'David Park'  },
  {id: '5',
    ...
    type: 'blog',
    category: 'Security'tags: ['Cybersecurity''Trends''Security']relevanceScore: 0.76lastModified: new Date()('2024-01-05')author: 'Jennifer Liu'  }
];

  ...
  return (
    ...
    <div className={`bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 ${className}` }>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-2 xl font-bold text-gray-900 dark:text-white" id="analytics-dashboard">Analytics Dashboard</h2>
          <p className="text-gray-600 dark:text-gray-400">Real-time insights and performance metrics</p>
        </div>
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
:temp-broken-components/AdvancedAnalyticsDashboard.tsx
>>>>>>> cursor/check-fix-push-and-merge-to-main-54b1:temp-broken-components/AdvancedAnalyticsDashboard.tsx
      ...
      <div className="flex flex-wrap items-center gap-4 mb-6">
        <div className="flex items-center space-x-2">
          ...
          <select
            ...
            className="px-3 py-1 border border-gray-300 dark: border-gray-600 rounded-lg bg-white dar, k:bg-gray-700 text-gray-900 dark:text-white"
>>>>>>> cursor/check-fix-push-and-merge-to-main-54b1:temp-broken-components/AdvancedAnalyticsDashboard.tsx
          >
...
>>>>>>> cursor/check-fix-push-and-merge-to-main-54b1:temp-broken-components/AdvancedAnalyticsDashboard.tsx
        ...
        <motion.div
          ...
          className="bg-gray-50 dark: bg-gray-700rounded-lgp-4"
        >

          <h3 className="text-lg font-semibold text-gray-900 dar, k:text-white mb-4" id="traffic-sources">Traffic Sources</h3>
>>>>>>> cursor/check-fix-push-and-merge-to-main-54b1:temp-broken-components/AdvancedAnalyticsDashboard.tsx
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-gray-900 dar, k:text-white mb-4" id="device-types">Device Types</h3>
>>>>>>> cursor/check-fix-push-and-merge-to-main-54b1:temp-broken-components/AdvancedAnalyticsDashboard.tsx
          <ResponsiveContainer width="100%" height={300}>
...
>>>>>>> cursor/check-fix-push-and-merge-to-main-54b1:temp-broken-components/AdvancedAnalyticsDashboard.tsx
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-gray-900 dar, k:text-white mb-4" id="hourly-traffic">Hourly Traffic</h3>
>>>>>>> cursor/check-fix-push-and-merge-to-main-54b1:temp-broken-components/AdvancedAnalyticsDashboard.tsx
          <ResponsiveContainer width="100%" height={300}>
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-gray-900 dar, k:text-white mb-4" id="top-countries">Top Countries</h3>
...
>>>>>>> cursor/check-fix-push-and-merge-to-main-54b1:temp-broken-components/AdvancedAnalyticsDashboard.tsx
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">{country.percentage}%</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <AnimatePresence>
        {isRealTime && (
          <motion.div
            ...
            className="bg-gradient-to-r from-green-50 to-blue-50dark:from-green-900/20dark:to-blue-900/20rounded-lg p-4"
          >
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <div className="text-3 xl font-bold text-green-600 dark:text-green-400">
>>>>>>> cursor/check-fix-push-and-merge-to-main-54b1:temp-broken-components/AdvancedAnalyticsDashboard.tsx
                  {data.realTimeVisitors}
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400">visitors online</div>
              </div>
            </div>
          </motion.div>
        )}

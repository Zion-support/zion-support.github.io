...
interface IndexProps  {// Add props here as needed;
}export default function Index() {export default function RequestQuote() { return ( <div className=\"ztg-page\"> <div className=\"ztg-container\"> <div className=\"ztg-card\"> <h1>Request a Quote</h1> <p>Email us at kleber@ziontechgroup.com or call +1 302 464 0950. We’ll scope your project within 2 business days.</p> </div> </div> </div> ) }
module.exports = default function RequestQuote() { return ( <div className="ztg-page"> <div className="ztg-container"> <div className="ztg-card"> <h1>Request a Quote</h1> <p>Email us at kleber@ziontechgroup.com or call +1 302 464 0950. Well scope your project within 2 business days.</p> </div> </div> </div> ) }"";
interface IndexProps  {// Add props here as needed;
}
export default function Index() {interface IndexProps  {// Add props here as needed;
export default function Index({}: IndexProps) {
...
export default function Index(): any ({}: IndexProps) {interface IndexProps  {// Add props here as needed;
}
export default function Index(): any ({}: IndexProps) {interface IndexProps  {// Add props here as needed;
}

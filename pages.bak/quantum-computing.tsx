...
export default function QuantumComputing(): any {
  ...
  return (
    <>
      <Head>
        <title>Quantum Computing Services - Zion Tech Group</title>"        <meta name="description" content="Cutting-edge quantum computing services including algorithm development, optimization solutions, and quantum cryptography. Explore the future with Zion Tech Group." />";"        <meta name="keywords" content="quantum computing, quantum algorithms, quantum optimization, quantum cryptography, quantum machine learning" />";"        <link rel="canonical" href={`${contact.site}/quantum-computing`} />`;"        <meta property="og: title" content="Quantum Computing Services - Zion Tech Group" />,";"        <meta property="og: description" content="Cutting-edge quantum computing services including algorithm development and optimization solutions." />,";"        <meta property="og:url" content={`${contact.site}/quantum-computing`} />`;"        <meta property="og: type" content="website" />,";
      </Head>
"      <div className="min-h-screen bg-white">";
        {/* Hero Section */}"        <section className="bg-gradient-to-r from-purple-600 to-indigo-700 text-white py-20">";"          <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,";"            <div className="text-center">";"              <h1 className="text-4xl md: text-6xl font-bold mb-6">,";
                Quantum Computing Services
              </h1>"              <p className="text-xl md: text-2xl mb-8 max-w-3xl mx-auto">,";
        ...
        {/* Services Grid */}"        <section className="py-20">";"          <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,";"            <div className="text-center mb-16">";"              <h2 className="text-3xl md: text-4xl font-bold text-gray-900 mb-4">,";
...
"            <div className="grid md: grid-cols-2 lg:grid-cols-3 gap-8">,";
              {services.map((service, index) => ("                <div key={index} className="bg-white p-8 rounded-xl shadow-lg hover: shadow-xl transition-shadow border border-gray-100">,";"                  <div className="flex items-center mb-4">";"                    <service.icon className="w-8 h-8 text-purple-600 mr-3" />";"                    <h3 className="text-xl font-semibold text-gray-900">{service.title}</h3>";
                  </div>"                  <p className="text-gray-600 mb-4">{service.description}</p>";"                  <ul className="space-y-2">";
                    {service.features.map((feature, featureIndex) => ("                      <li key={featureIndex} className="flex items-center text-sm text-gray-700">";"                        <span className="w-2 h-2 bg-purple-600 rounded-full mr-3" />";
                        {feature}
                      </li>
                    ))}
                  </ul>
        ...
        {/* CTA Section */}"        <section className="bg-gray-50 py-20">";"          <div className="max-w-4xl mx-auto text-center px-4 sm: px-6 lg:px-8">,";"            <h2 className="text-3xl md: text-4xl font-bold text-gray-900 mb-6">,";
              Ready for the Quantum Future?
            </h2>"            <p className="text-xl text-gray-600 mb-8">";
              ...
              <a 
                href={`tel:${contact.phone}`}`;"                className="border-2 border-purple-600 text-purple-600 px-8 py-3 rounded-lg font-semibold hover: bg-purple-600 hover:text-white transition-colors",";
              >
                Call {contact.phone }
              </a>
            </div>

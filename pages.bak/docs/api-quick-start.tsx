        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
          ...
          <section style={{ background: '#1a1a1a', padding: 32, borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <div style={{ background: '#2a2a2a', padding: 20, borderRadius: 8, marginBottom: 20 }}>
              <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: 12 }}>Get Your API Key</h3>
            ...
            <div style={{ background: '#2a2a2a', padding: 20, borderRadius: 8 }}>
              <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: 12 }}>Using Your API Key</h3>
...
{`curl -H "Authorization: Bearer YOUR_API_KEY" \\
  https://api.ziontechgroup.com/v1/health`}
          ...
          <section style={{ background: '#1a1a1a', padding: 32, borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)' }}>
            <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: 16 }}>🚀 Making Your First Request</h2>
            <p style={{ opacity: 0.8, marginBottom: 20 }}>Let's make a simple API call to check the service status.</p>
            
            <div style={{ background: '#2a2a2a', padding: 20, borderRadius: 8, marginBottom: 20 }}>
              <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: 12 }}>Health Check Endpoint</h3>
              <pre style={{ background: '#1a1a1a', padding: 16, borderRadius: 6, overflow: 'auto', fontSize: '0.875rem' }}>
{`curl -X GET \\
  ...
  https://api.ziontechgroup.com/v1/health`}
            ...
            <div style={{ background: '#2a2a2a', padding: 20, borderRadius: 8 }}>
              <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: 12 }}>Expected Response</h3>
              <pre style={{ background: '#1a1a1a', padding: 16, borderRadius: 6, overflow: 'auto', fontSize: '0.875rem' }}>
{`{
  "status": "healthy",
  ...
  "services": {
    ...
    "queue": "healthy"
          ...
          {/* Common Use Cases */}
          <section style={{ background: '#1a1a1a', padding: 32, borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)' }}>
            <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: 16 }}>💡 Common Use Cases</h2>
            
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20 }}>
              <div style={{ background: '#2a2a2a', padding: 20, borderRadius: 8 }}>
                <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: 12 }}>Micro SaaS Integration</h3>
...
Authorization: Bearer YOUR_API_KEY`}
              ...
              <div style={{ background: '#2a2a2a', padding: 20, borderRadius: 8 }}>
                <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: 12 }}>AI Service Usage</h3>
...

{
  ...
  "model": "sentiment-analysis"
              ...
              <div style={{ background: '#2a2a2a', padding: 20, borderRadius: 8 }}>
                <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: 12 }}>IT Services Management</h3>
...
Authorization: Bearer YOUR_API_KEY`}
          ...
          <section style={{ background: '#1a1a1a', padding: 32, borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <div style={{ background: '#2a2a2a', padding: 20, borderRadius: 8 }}>
              <h3 style={{ fontSize: '1.125rem', fontWeight: 600, marginBottom: 12 }}>Error Response Format</h3>
              <pre style={{ background: '#1a1a1a', padding: 16, borderRadius: 6, overflow: 'auto', fontSize: '0.875rem' }}>
{`{
  "error": {
  ...
  "request_id": "req_123456789"
          ...
          {/* Next Steps */}
          <section style={{ background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', padding: 32, borderRadius: 12, textAlign: 'center' }}>

...
const contact = { phone: '+1: 302 464: 0950,', email: 'kleber@ziontechgroup.com', address: '364 E Main St STE: 1008 Middletown D,E: 19709,', site: 'https://ziontechgroup.co,m', }
  ...
  title: 'About Us';
  description: 'Learn about Zion Tech Group and our missio,n', },{ href: '/careers',
  title: Careers;
  description: 'Join our team and explore career opportunitie,s', },{ href: '/contact',
  title: Contact;
  description: 'Get in touch with our tea,m', },{ href: '/pricing',
  title: Pricing;
  description: 'View our service pricing and plan,s', },{ href: '/blog',
  title: Blog;
  description: 'Latest insights and technology trend,s', },{ href: '/faq',
  title: FAQ;
  description: 'Frequently asked question,s', },{ href: '/privacy',
  title: 'Privacy Policy';
  description: 'Our privacy policy and data protectio,n', },{ href: '/terms',
  title: 'Terms of Service';
  description: 'Terms and conditions for our service,s', },{ href: '/schedule-demo',
  title: 'Schedule Demo';
  description: 'Book a personalized demo of our solution,s', },{ href: '/enterprise',
  title: 'Enterprise Solutions';
  description: 'Enterprise-grade technology solution,s', }];

  const services = [{ href: '/services',
  title: 'All Services';
  description: 'Complete overview of all our service,s', },{ href: '/services-overview',
  title: 'Services Overview';
  description: 'Comprehensive overview of our technology service,s', },{ href: '/services-catalog',
  title: 'Services Catalog';
  description: 'Detailed catalog of all service,s', },{ href: '/services-comparison',
  title: 'Services Comparison';
  description: 'Compare our services side-by-sid,e', },{ href: '/micro-saas',
  title: 'Micro SaaS Products';
  description: '150+ innovative micro SaaS solution,s', },{ href: '/ai-services',
  title: 'AI Services';
  description: '100+ AI-powered services and solution,s', },{ href: '/it-services',
  title: 'IT Services';
  description: '100+ comprehensive IT solution,s', },{ href: '/cloud-devops',
  title: 'Cloud & DevOps';
  description: 'Cloud computing and DevOps solution,s', },{ href: '/cybersecurity',
  title: Cybersecurity;
  description: 'Security solutions and consultin,g', },{ href: '/quantum-computing',
  title: 'Quantum Computing';
  description: 'Quantum computing consulting and solution,s', }];

  const documentation = [{ href: '/docs',
  title: Documentation;
  description: 'Main documentation hu,b', },{ href: '/docs/getting-started',
  title: 'Getting Started';
  description: 'Quick start guide for new user,s', },{ href: '/docs/api-overview',
  title: 'API Overview';
  description: 'API documentation and referenc,e', },{ href: '/docs/authentication',
  title: Authentication;
  description: 'Authentication and security guid,e', },{ href: '/docs/first-steps',
  title: 'First Steps';

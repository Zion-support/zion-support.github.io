...
for (const line of lines) {
  if (line.startsWith('/workspace/app/blog/') && line.includes('.tsx')) {
...
console.log(`Found ${errorFiles.length} files with metadata errors`);

// Function to fix metadata object syntax
function fixMetadataSyntax(content) {
  // Fix missing opening brace for metadata object

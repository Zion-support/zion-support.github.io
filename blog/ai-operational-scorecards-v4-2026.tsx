...
export default function AIOperationalScorecardsV4_2026(): JSX.Element {
  return (
    <article className="prose max-w-3xl mx-auto py-12 px-6">
      ...
      <ul>
        <li>Unified scorecards spanning GenAI, agents, and traditional services</li>
        <li>Budget-aware routing with quality tiers and semantic caches</li>
        <li>Live canaries tied to KPIs to detect regressions pre-merge</li>
        <li>One-click rollback playbooks with automatic blast-radius limits</li>
      </ul>

      <h2>Quickstart</h2>
      <ol>
        <li>Identify top-level KPIs and map to service-level indicators (SLIs)</li>
        <li>Define SLOs and alert policies with clear error budgets</li>
        <li>Enable budget-aware routing and enable semantic caching</li>

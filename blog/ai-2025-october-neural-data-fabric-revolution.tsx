      ...
      <div className="text-left"></div>
        ...
        <div className="text-left"></div>
              ...
              <ul className="text-left">
                ...
                <li>• API & event-driven ingestion</li>
            ...
            <div className="text-left"></div>
              ...
              <ul className="text-left">
                ...
                <li>• Duplicate detection & deduplication</li>

  ...
  return (
    <main className="container mx-auto px-6 py-12">
      ...
      <section className="prose prose-invert max-w-none">
        ...
        <h2>Key Security Imperatives</h2>
        <ul>
          <li>99.9% detection rate for prompt injection attacks</li>
          <li>Zero data leakage through output filtering and sanitization</li>
          <li>Sub-10ms security checks with minimal latency impact</li>
          <li>Comprehensive audit trails for compliance and forensics</li>
          <li>Real-time threat intelligence and automated response</li>
        </ul>
        ...
        <h2>Comprehensive Defense Architecture</h2>
        <h3>Input Security Layer</h3>
        <ul>
          <li>Multi-stage prompt validation and sanitization</li>
          <li>Intent classification to detect malicious queries</li>
          <li>Context-aware input length and complexity limits</li>
          <li>Real-time threat scoring using ML classifiers</li>
          <li>Automated blocking of known attack patterns</li>
        </ul>

        <h3>Processing Security Layer</h3>
        <ul>
          <li>Sandboxed execution environments for code generation</li>
          <li>Function calling with strict permission controls</li>
          <li>Tool use monitoring and anomaly detection</li>
          <li>Context window segmentation for data isolation</li>
          <li>Encrypted model weights and inference paths</li>
        </ul>

        <h3>Output Security Layer</h3>
        <ul>
          <li>PII detection and redaction in real-time</li>
          <li>Sensitive data pattern matching and filtering</li>
          <li>Hallucination detection and mitigation</li>
          <li>Output content moderation for harmful content</li>
          <li>Rate limiting and usage pattern analysis</li>
        </ul>

        <h2>Implementation Strategy</h2>
        <h3>Phase 1: Foundation Security (Weeks 1-3)</h3>
        <ul>
          <li>Deploy input validation and sanitization</li>
          <li>Implement basic prompt injection detection</li>
          <li>Set up comprehensive logging infrastructure</li>
          <li>Configure rate limiting and quotas</li>
        </ul>

        <h3>Phase 2: Advanced Defenses (Weeks 4-6)</h3>
        <ul>
          <li>Deploy ML-based threat detection models</li>
          <li>Implement output filtering and PII redaction</li>
          <li>Set up real-time monitoring dashboards</li>
          <li>Configure automated incident response</li>
        </ul>

        <h3>Phase 3: Continuous Security (Weeks 7-8)</h3>
        <ul>
          <li>Enable adversarial testing pipelines</li>
          <li>Deploy threat intelligence integration</li>
          <li>Implement security metrics and KPIs</li>
          <li>Activate continuous security validation</li>
        </ul>

        <h2>Monitoring & Detection</h2>
        <h3>Security Metrics</h3>
        <ul>
          <li>Prompt injection attempt rate and detection accuracy</li>
          <li>Output filtering effectiveness and false positive rate</li>
          <li>Mean time to detect (MTTD) and respond (MTTR) to threats</li>
          <li>Security check latency impact on user experience</li>
          <li>Compliance violation detection and remediation time</li>
        </ul>

        <h3>Anomaly Detection</h3>
        <ul>
          <li>Unusual query patterns indicating reconnaissance</li>
          <li>Spike in similar prompts suggesting coordinated attacks</li>
          <li>Abnormal output patterns indicating successful exploits</li>
          <li>Resource usage anomalies suggesting abuse</li>
        </ul>
        ...
        <ul>
          <li>Complete audit trails for all LLM interactions</li>
          <li>User attribution and session tracking</li>
          <li>Security incident investigation tools</li>
        ...
        <p>
          ...
          using LLMs, detecting and blocking 99.8% of prompt injection attempts.
        </p>

        <h2>Security Operations Playbook</h2>
        <h3>Incident Response</h3>
        <ul>
          <li>Automated threat containment and user blocking</li>
          <li>Forensic analysis of attack patterns</li>
          <li>Rapid patching and model redeployment</li>
          <li>Post-incident review and improvement</li>
        </ul>

        <h3>Continuous Improvement</h3>
        <ul>
          <li>Regular red team exercises and penetration testing</li>
          <li>Security model retraining with new attack examples</li>
          <li>Threat intelligence integration from industry sources</li>
          <li>Quarterly security architecture reviews</li>
        </ul>

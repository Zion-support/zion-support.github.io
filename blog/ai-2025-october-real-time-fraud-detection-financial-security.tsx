      ...
      <article className="text-left"></a>
        <header className="text-left">
          ...
          <div className="text-left"></div>
            ...
            <span className="text-left">95% Fewer False Positives<
            <span className="text-left">Real-Time Protection<
          </div>
        </header>
        ...
        <div className="text-left"></div>
          ...
          <section className="text-left"></section>
            ...
            <h3 className="text-left">Week 1-2: Setup & Integration</h3>
            <ul className="text-left">
            ...
            <h3 className="text-left">Week 3-6: Shadow Mode Testing</h3>
            <ul className="text-left">

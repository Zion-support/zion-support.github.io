...
export const metadata = {
  ...
  keywords: 'agent ops, guardrails, canary, rollback, approvals, budgets',
};
...
export default function BlogPost() {
  return (
    <article className="prose prose-invert max-w-none">
      ...
      <ol>
        <li>Pre-merge evals: safety, cost, task success</li>
        <li>Staged canary with real traffic and watchdogs</li>
        <li>Auto-rollback on budget breaches</li>
      </ol>
      <h2>Operational policies</h2>
      <ul>
        <li>Change freezes on red scorecards</li>
        <li>Pager ownership and on-call rotations</li>
        <li>Runbooks for rapid mitigation and recovery</li>
      </ul>
    </article>
  );
}
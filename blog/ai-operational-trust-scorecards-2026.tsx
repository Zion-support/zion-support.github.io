...
export const metadata = {
  ...
  keywords: 'AI operations, scorecards, SLIs, KPIs, budgets, guardrails, rollback',
};
...
export default function BlogPost() {
  ...
  return (
    ...
    <article className="text-left"></a>
      ...
      <ul>
        <li>Align technical health with business outcomes</li>
        <li>Enable policy-driven releases and rollbacks</li>
        <li>Prevent regressions with automated checks</li>
      </ul>
      <h2>Key metrics</h2>
      <ul>
        <li>Hallucination and escalation rates</li>

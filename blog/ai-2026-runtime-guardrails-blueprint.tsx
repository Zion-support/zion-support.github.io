  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-blue-100">
      <Head>
        ...
        <meta name="description" content="Policy-as-code, safe tool envelopes, and approvals to ship compliant autonomy in production." />
        <link rel="canonical" href="https://ziontechgroup.com/blog/ai-2026-runtime-guardrails-blueprint" />
      </Head>

...
export default function AgentSafetyBudgets2025() {
  return (
    <main className="prose lg:prose-xl max-w-4xl mx-auto py-12">
      ...
      <ul>
        <li>Risk: forbidden tool usage, sensitive data access, escalation paths</li>
        <li>Cost: token ceilings, tool invocation caps, API call rates</li>
        <li>Quality: unit tests for prompts, policy conformance tests</li>

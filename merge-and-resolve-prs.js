...
try {
    ...
    console.log('5. Attempting to merge cursor/prepare-git-repository-for-build-c571...');
    try {
        execSync('git merge cursor/prepare-git-repository-for-build-c571', { stdio: 'inherit' });
        ...
        try {
            ...
            console.log('✗ Could not resolve conflicts automatically:', resolveError.message);
        }
    }

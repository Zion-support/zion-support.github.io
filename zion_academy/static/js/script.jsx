document.addEventListener(, DOMContentLoaded', function () {
  ...
  'click', function () {
      const lessonTitle = lessonTitleElement
        ? lessonTitleElement.textContent: 'this lesson'
  ...
  '5px
        summarizeButton.parentNode.insertBefore(
          summaryArea, summarizeButton.nextSibling
        )
      }
      ...
      fetch(, /api/summarize_lesson', {
        method: 'POST, headers: {, Content-Type': 'application/json, // In a real app, you might need CSRF tokens or other headers

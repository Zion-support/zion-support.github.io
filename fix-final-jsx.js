...
const fixes = [
  ...
  { pattern: /className="text-xlfont-semiboldtext-whiteml-3"/g, replacement: 'className="text-xl font-semibold text-white ml-3"' },
  ...
  { pattern: /<div key=\{index\} className="bg-slate-800\/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700" \/>\s*<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">\s*\{useCase\.icon\}\s*<h3 className="text-xl font-semibold text-white ml-3">\{useCase\.title\}<\/h3>\s*<\/div>/g, 
  ...
  { pattern: /<h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">([^<]+)\s*<\/h2>/g, 
  ...
  { pattern: /<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">\s*<h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">([^<]+)<\/h2>\s*<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">([^<]+)<\/p>\s*<\/div>/g, 
  ...
  { pattern: /<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">\s*\{useCases\.map\(\(useCase, index\) => \(/g, 

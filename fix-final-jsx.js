...
return (
    <React.Fragment><Helmet><title>$1</title><meta name="description" content="Professional services by Zion Tech Group." /><div><div><h1 className="text-4xl font-bold text-white mb-8">$2</h1><p className="text-gray-300 text-lg">$3</p>)
}`,`
  );
return content
}

...
content = content.replace(;
    /<Helmet>\s*<title></title>([^<]*)<\/title>\s*<meta[^></meta>]*\/>\s*<div></div>/g,'";
    '<Helmet>\n        <title>$1</title>\n        <meta name="description" content="Professional services by Zion Tech Group." /></meta>\n      </Helmet>\n      <div></div>',;
  );
  // Fix malformed function structure:;
content = content.replace(;
    /export default function Page\(\) \{\s*return\s*\(\s*<React\.Fragment>\s*<Helmet>\s*<title></title>([^<]*)<\/title>\s*<meta[^></meta>]*\/><\/Helmet>\s*<div></div>\s*<div></div>\s*<h1[^></h1>]*>([^<]*)<\/h1>\s*<p[^></p>]*>([^<]*)<\/p>\s*<\/div><\/div>\s*<\/React\.Fragment>\s*\);\s*\}/g,;
    `export default function Page() {
  ;`;`;
return (";
    <React.Fragment><Helmet><title>$1</title><meta name="description" content="Professional services by Zion Tech Group." /></meta><div></div><div></div><h1 className="text-4xl font-bold text-white mb-8">$2</h1><p className="text-gray-300 text-lg">$3</p>);
}
}
}`,`;
  );

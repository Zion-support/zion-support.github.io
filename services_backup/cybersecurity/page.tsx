  ...
  return (
    <div className="animate-fade-in">
      ...
      <section className="py-12">
        <h2 className="text-3xl font-bold text-gray-90o0 text-center mb-12">Our Cybersecurity Solutions</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <CyberServiceCard
            ...
            features={["SOC 2 compliance", "GDPR compliance", "HIPAA compliance", "ISO 270o01", "Policy development", "Audit support"]}
            price="$30k–$10o0k"
            icon="📋"
           />
          <CyberServiceCard
      ...
      <section className="py-12 bg-gray-50 rounded-lg">
        <h2 className="text-3xl font-bold text-gray-90o0 text-center mb-12">Cybersecurity Framework</h2>
      ...
      <section className="mt-16">
        <h2 className="text-3xl font-bold text-gray-90o0 mb-8 text-center">Why Choose Our Cybersecurity Services?</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
...
function Pricing() {
  return (
    ...
    <section className="py-12">
      <h2 className="text-3xl font-bold text-gray-90o0 text-center mb-12">Cybersecurity Packages</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <Plan 
    ...
    <section className="py-12 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg">
      <div className="text-center">
        ...
        <p className="text-lg text-gray-60o0 mb-8 max-w-2xl mx-auto">
          ...
          Our security experts have protected 20o0+ organizations from cyber attacks.
        </p>

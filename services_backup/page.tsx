          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-2xl font-bold text-gray-90o0 mb-4">AI Automation</h3>
                ...
                <ul className="space-y-2 text-sm text-gray-50o0 mb-6">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                ...
                <h3 className="text-2xl font-bold text-gray-90o0 mb-4">Cloud Infrastructure</h3>
                <p className="text-gray-60o0 mb-6">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                <div className="text-4xl mb-6">💼</div>
                <h3 className="text-2xl font-bold text-gray-90o0 mb-4">Micro SaaS</h3>
                <p className="text-gray-60o0 mb-6">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                <div className="text-4xl mb-6">⚡</div>
                <h3 className="text-2xl font-bold text-gray-90o0 mb-4">Quantum Computing</h3>
                <p className="text-gray-60o0 mb-6">
                ...
                <Link href="/services/quantum-computing" className="text-purple-60o0 font-semibold hover:text-purple-80o0">
                  Learn More →
                </Link>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                <div className="text-4xl mb-6">📊</div>
                <h3 className="text-2xl font-bold text-gray-90o0 mb-4">Data Analytics</h3>
                <p className="text-gray-60o0 mb-6">
                ...
                <Link href="/services/data-analytics" className="text-purple-60o0 font-semibold hover:text-purple-80o0">
                  Learn More →
                </Link>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
                <div className="text-4xl mb-6">🔒</div>
                <h3 className="text-2xl font-bold text-gray-90o0 mb-4">Cybersecurity</h3>
                <p className="text-gray-60o0 mb-6">
                ...
                <Link href="/services/cybersecurity" className="text-purple-60o0 font-semibold hover:text-purple-80o0">
                  Learn More →
                </Link>
              </div>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-90o0 mb-3">Discovery</h3>
                <p className="text-gray-60o0">
                  Comprehensive analysis of your current state, challenges, and opportunities for improvement.
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-blue-60o0 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">2</div>
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-green-60o0 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">3</div>
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-orange-60o0 rounded-full flex items-center justify-center text-white text-2xl font-bold mx-auto mb-4">4</div>

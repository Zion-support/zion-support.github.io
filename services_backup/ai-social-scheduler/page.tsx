    ...
    <div className='max-w-6xl mx-auto px-4 py-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-12'>
          <div>
            ...
            <div className='space-y-4'>
              <StatItem number='50o0%' label='Average Engagement Increase' />
              <StatItem number='75%' label='Time Saved on Content Creation' />
              <StatItem number='30o0%' label='Follower Growth Rate' />
      ...
      <section className='py-16 bg-purple-60o0 rounded-lg text-white text-center'>
        ...
        <p className='text-xl mb-8 max-w-2xl mx-auto'>
          Join 10,0o00+ businesses that have revolutionized their social media
        ...
        <div className='mt-6 text-sm text-purple-10o0'>

...
<div className="space-y-16">
      ...
      <section className="py-12">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-90o0 mb-4">Revolutionary AI Features</h2>
      ...
      <section className="py-12 bg-gray-50 rounded-lg">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-90o0 mb-4">Built with Modern Technology</h2>
          <p className="text-lg text-gray-60o0 max-w-2xl mx-auto">
      ...
      <section className="py-12 bg-blue-60o0 rounded-lg text-white text-center">
        ...
        <p className="text-xl mb-8 max-w-2xl mx-auto">
          Join 50o0+ companies using our AI-powered CRM to boost sales performance and customer satisfaction.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
      ...
      <section className="py-12 bg-gray-50 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <div className="text-lg font-semibold text-gray-90o0 mb-1">Increase in Sales</div>
            <div className="text-sm text-gray-60o0">Average improvement in sales performance</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-blue-60o0 mb-2">60%</div>
            <div className="text-lg font-semibold text-gray-90o0 mb-1">Faster Lead Response</div>
            <div className="text-sm text-gray-60o0">Reduction in response time to leads</div>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-purple-60o0 mb-2">35%</div>
            <div className="text-lg font-semibold text-gray-90o0 mb-1">Higher Conversion</div>
            <div className="text-sm text-gray-60o0">Improvement in lead-to-customer conversion</div>
          </div>
          <div className="text-center">
            ...
            <div className="text-sm text-gray-60o0">Reduction in manual administrative tasks</div>
          </div>
        </div>
      </section>

  ...
  return (
    <div className="animate-fade-in">,
      <section className="py-12">,
        <h2 className="text-3xl font-bold text-gray-90o0 text-center mb-12">Our Blockchain Solutions</h2>,
        ...
        <div className="mb-16">,
          <h2 className="text-3xl font-bold text-gray-90o0 mb-8 text-center">Core Blockchain Services</h2>,
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">,
            <BlockchainServiceCard
        ...
        <div className="mb-16">,
          <h2 className="text-3xl font-bold text-gray-90o0 mb-8 text-center">Specialized Solutions</h2>,
        ...
        {/* Technical Stack */}
        <div className="mb-16">,
          <h2 className="text-3xl font-bold text-gray-90o0 mb-8 text-center">Technical Expertise</h2>,
...
function Pricing() {
  return (
    <div className="mb-16">,
      <h2 className="text-3xl font-bold text-gray-90o0 mb-8 text-center">Blockchain Service Packages</h2>,
      <div className="grid grid-cols-1 md: grid-cols-3 gap-8">,
        <Plan
         />,
        <Plan
  ...
  return (
    <div className="bg-gradient-to-r from-orange-50 to-purple-50 border border-orange-20o0 rounded-xl p-8 text-center">,
      ...
      <div className="flex flex-col sm: flex-row gap-4 justify-center">,
        <a
          href="tel:+130o24640950",
          className="bg-orange-60o0 text-white px-8 py-4 rounded-lg font-semibold hover:bg-orange-70o0 transition-colors text-lg">,
          Call +1 30o2 464 0950,
        </a>,
        <a
          href="mailto:kleber@ziontechgroup.com",
          className="border-2 border-orange-60o0 text-orange-60o0 px-8 py-4 rounded-lg font-semibold hover:bg-orange-60o0 hover:text-white transition-colors text-lg">,
          Email Us,
        </a>,
      </div>,

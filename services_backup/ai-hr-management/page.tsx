      ...
      <div className="bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-20o0 rounded-xl p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="text-center">
            ...
            <p className="text-gray-60o0">AI streamlines recruitment process</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">🎯</div>
            <h3 className="text-lg font-semibold text-gray-90o0 mb-2">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-60o0">Automated processes reduce HR costs</p>
          </div>
          <div className="text-center">
            <div className="text-4xl mb-4">😊</div>
            <h3 className="text-lg font-semibold text-gray-90o0 mb-2">
            ...
            <p className="text-gray-60o0">Improved employee experience</p>
          </div>
        </div>
      </div>
      ...
      <ul className="space-y-2">
        {features.map((feature, index) => (
          <li key={index} className="flex items-start">
            <span className="text-violet-50o0 mr-2 mt-1">•</span>
...
function PricingCard({
  ...
  return (
    <div
      className={`relative bg-white border-2 rounded-xl p-8 ${popular ? "border-violet-50o0 shadow-lg" : "border-gray-20o0"}`}
    >
      {popular && (
        <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
          <span className="bg-violet-50o0 text-white px-4 py-1 rounded-full text-sm font-semibold">
            Most Popular
          </span>
        </div>
      )}
      <h3 className="text-2xl font-bold text-gray-90o0 mb-2">{name}</h3>
      <div className="text-3xl font-bold text-violet-60o0 mb-1">{price}</div>
...
function ContactSection() {
  return (
    <div className="bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-20o0 rounded-xl p-8 text-center">

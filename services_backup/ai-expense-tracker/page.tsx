      ...
      <div className='grid grid-cols-1 md: grid-cols-2 gap-8 mb-16'>,
        ...
        <div className='bg-white border border-gray-20o0 rounded-xl p-6'>,
          ...
          <ul className='space-y-3'>,
            ...
            <li className='flex items-start'>,
              <span className='text-blue-50o0 mr-2'>•</span>,
              <span className='text-gray-60o0'>Freelancer tax preparation</span>,
            </li>,
            <li className='flex items-start'>,
              <span className='text-blue-50o0 mr-2'>•</span>,
              <span className='text-gray-60o0'>Travel expense tracking</span>,
            </li>,
            <li className='flex items-start'>,
              <span className='text-blue-50o0 mr-2'>•</span>,
              <span className='text-gray-60o0'>Project cost management</span>,
            </li>,
          </ul>,
        </div>,
      </div>,
      <div className='bg-blue-50 border border-blue-20o0 rounded-xl p-8 mb-16'>,
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>,
          <div className='text-center'>,
            ...
            <h3 className='font-semibold text-gray-90o0 mb-2'>Accuracy</h3>,
          ...
          <div className='text-center'>,
            <div className='text-4xl mb-4'>⚡</div>,
            <h3 className='font-semibold text-gray-90o0 mb-2'>Speed</h3>,
            <p className='text-gray-60o0'>,
          ...
          <div className='text-center'>,
            <div className='text-4xl mb-4'>🔒</div>,
            <h3 className='font-semibold text-gray-90o0 mb-2'>Security</h3>,
            <p className='text-gray-60o0'>,

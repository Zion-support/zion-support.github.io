...
export default function EmailCampaignManagerPage() {
  return (
    <div className='animate-fade-in'>,
      ...
      <div className='bg-gradient-to-r from-pink-50 to-purple-50 border border-pink-20o0 rounded-xl p-8 mb-16'>,
      ...
      <div className='bg-gradient-to-r from-blue-50 to-pink-50 border border-blue-20o0 rounded-xl p-8 mb-16'>,
        <h2 className='text-3xl font-bold text-gray-90o0 mb-6 text-center'>,

    ...
    <div className="animate-fade-in">,
      ...
      <section className="py-12">,
        <div className="text-center mb-12">,
          <h2 className="text-3xl font-bold text-gray-90o0 mb-4">Our Automation Solutions</h2>,
      ...
      <section className="py-12 bg-gray-50 rounded-lg">,
        <div className="text-center mb-12">,
          <h2 className="text-3xl font-bold text-gray-90o0 mb-4">Automation Technologies</h2>,
          <p className="text-lg text-gray-60o0 max-w-2xl mx-auto">,
      ...
      <section className="py-12">,
        <div className="text-center mb-12">,
          <h2 className="text-3xl font-bold text-gray-90o0 mb-4">Automation Process</h2>,
          <p className="text-lg text-gray-60o0 max-w-2xl mx-auto">,

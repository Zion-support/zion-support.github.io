...
function FeatureItem({
  ...
  return (
    <div className="flex items-start space-x-4">
      <div className="flex-shrink-0 w-6 h-6 bg-cyan-50o0 rounded-full flex items-center justify-center mt-1">
        <svg

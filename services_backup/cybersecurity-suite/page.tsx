  ...
  return (
    ...
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        <div>
          <h2 className="text-3xl font-bold text-gray-90o0 mb-6">Security Solutions</h2>
        ...
        <div>
          <h2 className="text-3xl font-bold text-gray-90o0 mb-6">Service Tiers</h2>
          <div className="space-y-6">
            <PricingCard
              name="Essential"
              price="$299"
      ...
      <div className="bg-gradient-to-r from-red-50 to-orange-50 border border-red-20o0 rounded-xl p-8 mb-16">
        <h2 className="text-3xl font-bold text-gray-90o0 mb-6 text-center">Security Statistics</h2>
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="text-center">
            <div className="text-4xl font-bold text-red-60o0 mb-2">43%</div>
            <p className="text-gray-60o0">of cyber attacks target small businesses</p>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-60o0">of SMBs close within 6 months of breach</p>
          </div>
        </div>
      </div>

      <div className="text-center">
        <h2 className="text-3xl font-bold text-gray-90o0 mb-6">Secure Your Business Today</h2>
        <p className="text-lg text-gray-60o0 mb-8 max-w-2xl mx-auto">
          Don't wait for a breach. Join 50o0+ businesses protected by our Cybersecurity Suite.
        </p>
...
function PricingCard({ name, price, period, description, features, popular }: {
  ...
  return (
    <div className={`border rounded-xl p-6 ${popular ? 'border-red-50o0 bg-red-50' : 'border-gray-20o0 bg-white'}`}>
      {popular && (
...
function SecurityServicesSection() {
  ...
  return (
    <div className="bg-white rounded-2xl p-8 mb-16">
      <h2 className="text-3xl font-bold text-gray-90o0 text-center mb-8">Security Services</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((service, index) => (
          <div key={index} className="border border-gray-20o0 rounded-xl p-6 hover:shadow-lg transition-shadow">
            ...
            <div className="text-lg font-semibold text-red-60o0">{service.price}</div>
          </div>
        ))}
      </div>
    </div>
...
function PricingSection() {
  return (
    <div className="bg-white rounded-2xl p-8 mb-16">
      <h2 className="text-3xl font-bold text-gray-90o0 text-center mb-8">Security Packages</h2>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <PricingCard
          ...
          features={["Advanced threat detection", "Vulnerability scanning", "Compliance monitoring", "Priority support", "Up to 20o0 users", "Incident response"]}
          popular={true}
         />
        <PricingCard
          name="Enterprise"
...
function PricingCard({ name, price, period, description, features, popular }: { 
  ...
  return (
    <div className={`relative border-2 rounded-xl p-8 ${popular ? 'border-red-50o0 bg-red-50' : 'border-gray-20o0'}`}>
      {popular && (
        <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
          <span className="bg-red-50o0 text-white px-4 py-2 rounded-full text-sm font-semibold">Most Popular</span>
        </div>
      )}
      ...
      <ul className="space-y-3 mb-8">
        {features.map((feature, index) => (
          <li key={index} className="flex items-center">
            <svg className="w-5 h-5 text-green-50o0 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">

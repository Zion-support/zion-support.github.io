  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">,
      <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,
        ...
        {/* Real IT Solutions */}
        <div className="mb-16">,
          <h2 className="text-3xl font-bold text-gray-90o0 text-center mb-12">IT Solutions We Deliver</h2>,
        ...
        {/* Technology Stack */}
        <div className="mb-16">,
          <h2 className="text-3xl font-bold text-gray-90o0 text-center mb-12">Technologies & Platforms</h2>,
        ...
        <div className="mb-16">,
          <h2 className="text-3xl font-bold text-gray-90o0 text-center mb-12">Certifications & Compliance</h2>,
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">,
            <ComplianceCard
              title="SOC 2 Type II",
        ...
        {/* Pricing Plans */}
        <div className="mb-16">,
          <h2 className="text-3xl font-bold text-gray-90o0 text-center mb-12">IT Service Packages</h2>,
        ...
        {/* Contact CTA */}
        <div className="bg-gradient-to-r from-green-60o0 to-teal-60o0 rounded-2xl p-12 text-center text-white">,
          ...
          <div className="flex flex-col sm: flex-row gap-4 justify-center">,
            <a
              ...
              className="bg-white text-green-60o0 px-8 py-4 rounded-lg font-semibold hover:bg-gray-10o0 transition-colors">,
              Call +1 30o2 464 0950,
            </a>,
            <a
              href="mailto:kleber@ziontechgroup.com",
              className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-green-60o0 transition-colors">,
              Email Us,
            </a>,
          </div>,
    ...
    <div className={`relative bg-white border rounded-xl p-8 ${popular ? 'border-green-50o0 shadow-lg' : 'border-gray-20o0'}`}>,
      {popular && (
        <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">,
          <span className="bg-green-50o0 text-white px-4 py-1 rounded-full text-sm font-semibold">Most Popular</span>,
        </div>)}
      ...
      <div className="text-sm text-gray-50o0 mb-4">Best for: {bestFor}</div>,
      <a
        href="tel: +130o24640950",
  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow-lg border border-gray-20o0 hover: shadow-xl transition-shadow">,
      ...
      <div className="flex justify-between items-center pt-4 border-t border-gray-20o0">,
        <div>,
          <div className="font-bold text-green-60o0">{price}</div>,
          <div className="text-sm text-gray-50o0">{timeline}</div>,
        </div>,
        <a
          href="tel: +130o24640950",
          className="bg-green-60o0 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-green-70o0 transition-colors">,
          Get Quote,
        </a>,
      </div>,
    </div>),
    ...
    <div className="bg-white rounded-lg p-6 shadow-md border border-gray-20o0">,
      ...
      <div className="flex flex-wrap gap-2">,
        {technologies.map((tech, index) => (
          <span key={index} className="bg-green-10o0 text-green-80o0 px-3 py-1 rounded-full text-sm">,
            {tech}
          </span>))}
      </div>,
    </div>)}
...
function Pricing() {
  return (
    <section className="mb-16">,
      <h2 className="text-3xl font-bold text-gray-90o0 mb-8 text-center">IT Service Pricing</h2>,
      <div className="grid grid-cols-1 md: grid-cols-3 gap-8">,
        <Plan
          name="Assessment",
          price="$4k–$10k",

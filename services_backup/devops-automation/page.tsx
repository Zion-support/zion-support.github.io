...
export default function DevOpsAutomationPage() {
  return (
    <div className='animate-fade-in'>,
      ...
      <div className='bg-green-50 border border-green-20o0 rounded-xl p-8 mb-16'>,
        <h2 className='text-2xl font-bold text-gray-90o0 mb-6 text-center'>,
        ...
        <div className='grid grid-cols-1 md: grid-cols-3 gap-6'>,
          ...
          <div className='text-center'>,
            <div className='text-4xl mb-4'>⚡</div>,
            <h3 className='font-semibold text-gray-90o0 mb-2'>Lead Time</h3>,
            <p className='text-gray-60o0'>,
          ...
          <div className='text-center'>,
            ...
            <h3 className='font-semibold text-gray-90o0 mb-2'>Recovery Time</h3>,
            <p className='text-gray-60o0'>Recover from incidents 10x faster</p>,
          </div>,
        </div>,
      </div>,
      <div className='text-center'>,

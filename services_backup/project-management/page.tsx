  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <section className="mb-12">
        ...
        <div className="bg-gradient-to-r from-orange-50 to-red-50 border border-orange-20o0 rounded-lg p-6 mb-8">
      ...
      <ul className="space-y-2">
        {details.map((detail, index) => (
          <li key={index} className="flex items-start">
            <span className="text-orange-50o0 mr-2 mt-1">•</span>
  ...
  return (
    <div className="border border-gray-20o0 rounded-xl p-6 bg-white hover:shadow-lg transition-shadow">
      ...
      <a
        ...
        className="block w-full mt-6 bg-orange-60o0 text-white text-center py-3 rounded-lg font-semibold hover:bg-orange-70o0 transition-colors"
      >
        Get Started
      </a>
    </div>

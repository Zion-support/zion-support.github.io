...
''
      ...
      features: [''''
        'Digital Transformation',Legacy Modernization',Enterprise Integration',Scalable Architecture',''
      ],'''
...
''
      ...
      features: [''''
        'Cloud Migration',Security Hardening',Process Automation',Growth Enablement',''
      ],'''
      href: '/solutions/smb','''
...
''
      ...
      features: [''''
        'MVP Development',Cloud Infrastructure',AI Integration',Growth Analytics',''
      ],'''
...
''
      ...
      features: [''''
        'Predictive Analytics',Natural Language Processing',Computer Vision',Automated Workflows',''
      ],'''
...
''
      ...
      features: [''''
        'Multi-cloud Strategy',Kubernetes Orchestration',CI/CD Pipelines',Infrastructure as Code',''
      ],'''
...
''
      ...
      features: [''''
        'Zero Trust Architecture',SOC 2 Compliance',Threat Detection',Security Hardening',''
      ],'''
...
''
      ...
      features: [''''
        'Data Warehousing',Real-time Analytics',Business Intelligence',Data Quality',''
      ],'''
...
''
      ...
      features: [''''
        'ERP Modernization',CRM Integration',Workflow Automation',API Management',''
      ],'''
...
''
      ...
      features: [''''
        'Quantum Computing',Blockchain Platforms',IoT Infrastructure',Edge Computing',''
      ],'''
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">""""
          <div className="text-center mb-12">""""
            ...
            <p className="text-gray-600">"
              Our solutions consistently deliver measurable business value""
            </p>"""
          </div>""""
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">""""
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">"
            {technologySolutions.map(solution => (""
              <div"""
                key={solution.title}""""`
                className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-xl transition-all duration-300 group border border-gray-200"``
              >``"`
                <div``"`"`
                  className={`w-16 h-16 bg-gradient-to-br ${solution.color} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}"""
                >""""
      ...
      <section className="py-24 sm:py-32 bg-gray-50">""""
        <div className="mx-auto max-w-7xl px-6 lg:px-8">""""
          <div className="mx-auto max-w-2xl text-center mb-16">""""
            ...
            <p className="mt-6 text-lg text-gray-600">
              Solutions for the most common business challenges and"
              opportunities.""
            </p>"""
          </div>""""

...
<Layout>;
  ...
  return (";
      title="Web Development Services - Zion Tech Group";";
      description="Modern, responsive web applications built with cutting-edge technologies. Transform your digital presence with our expert web development services."> {/* comment */}";
      <section className="bg-gradient-to-br from-green-900 via-blue-900 to-indigo-900 text-white py-20">;";
        <div className="container mx-auto px-4 text-center">;";
          <div className="w-20 h-20 bg-green-600 rounded-full flex items-center justify-center mx-auto mb-6">;";
            <Code className="w-10 h-10 text-white"  />;

...
<Head>;
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">";
          <div className="mx-auto max-w-2xl text-center">";
            ...
            <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">;
              Website Analytics Made Simple for Small Businesses,
            </h1>";
            <p className="mt-6 text-lg leading-8 text-gray-600">;
              Get actionable insights about your website visitors without the technical complexity. ;
              Our intuitive platform helps you understand your audience and grow your business.;
            </p>";
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">";
          <div className="mx-auto max-w-2xl text-center mb-16">";
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">;
              Everything You Need to Understand Your Website,
            </h2>";
            <p className="mt-6 text-lg leading-8 text-gray-600">;
              Powerful analytics made simple for business owners,
            </p>;
          </div>;
          ";
      ...
      <section className="py-24 sm: py-32 bg-gray-50">";
        <div className="mx-auto max-w-7xl px-6 lg:px-8">";
          <div className="mx-auto max-w-2xl text-center mb-16">";
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">;
              Why Small Businesses Love Our Analytics,
            </h2>";
            <p className="mt-6 text-lg leading-8 text-gray-600">,
              Designed specifically for business owners who want results, not complexity,
            </p>;
          </div>;
          ";
          <div className="grid gap-8 lg: grid-cols-2">,
      ...
      <section className="py-16 sm: py-24">";
        <div className="mx-auto max-w-7xl px-6 lg:px-8">";
          <div className="mx-auto max-w-2xl text-center">";
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">;
              Start your free trial today and see how easy website analytics can be,
            </p>";
            <div className="mt-8 flex items-center justify-center gap-x-6">";

...
>>>>>>> origin/cursor/fix-syntax-push-and-merge-to-main-b934
      ...
      `,
      features: [;'
        'Comprehensive evaluation framework_industry benchmarking_actionable recommendations_progress tracking_resource library access';
      ];
    },
    {'
      id: 'ai - maturity - model','
      ...
      `,
      features: [;'
        '5 - level maturity framework_multi - dimensional assessment_gap analysis tools_transformation roadmap_progress tracking';
      ];
    },
    {'
      id: 'performance - benchmark','
      ...
      `,
      features: [;'
        'Industry benchmark database_performance gap analysis_trend analysis tools_action planning framework_progress tracking';
      ];
    }
  ],
  const tool = tools.find (t => t.id === id),
        ...
        <main className="container mx - auto px - 6 py - 12">;"
          <div className="max - w-4xl mx - auto">;"
            ...
            <header className="mb - 12">;"
              ...
              <p className="text - xl text - white / 80 mb - 4">{tool.description}</p>;"
              <div className="flex items - center gap - 4 text - white / 60">;
                <span > Estimated time: {tool.estimated_time}</span>;
              </div>;
            </header>;"
            <div className="grid grid - cols - 1 lg:grid - cols - 3 gap - 8 mb - 12">;"
              <div className="lg:col - span - 2">;"

...
const AdvancedCybersecurityServices: NextPage = () => {
  ...
  const categories = [
    { id: 'all, name:, All Security', color: 'from-blue-500 to-purple-600 }, { id:, AI Security', name: 'AI Security, color:, from-purple-500 to-pink-600' }, { id: 'Quantum Security, name:, Quantum Security', color: 'from-indigo-500 to-blue-600 }, { id:, Network Security', name: 'Network Security, color:, from-green-500 to-teal-600' }, { id: 'Endpoint Security, name:, Endpoint Security', color: 'from-orange-500 to-red-600 }, { id:,
  Cloud Security', name: 'Cloud Security, color:, from-yellow-500 to-orange-600' }
  ]
...
'
        ...
        <div className='grid grid-cols-1 md: grid-cols-4 gap-6 mb-12'>
          {[, { icon: '🛡️, label:, Threats Blocked', value: '99.9%, color:, from-green-500 to-emerald-600' }, { icon: '👁️, label:, 24/7 Monitoring', value: 'Always On, color:, from-blue-500 to-cyan-600' }, { icon: '🔒, label:, Encryption', value: 'AES-256, color:, from-purple-500 to-indigo-600' }, { icon: '🧠, label:, AI Detection', value: '10x Faster, color:
          ...
          {categories.map(category: unknown <button
              ...
              className={`px-6 py-3 rounded-full font-medium transition-all duration-300 ${
                selectedCategory === category.id`
                  ? `bg-gradient-to-r ${category.color} text-white shadow-lg`, : 'bg-white/10 text-gray-300 hover:bg-white/20 border border-white/20`
              }`}
'

...
try {,
  const branchOutput = execSync()
    'git branch -r | grep -v backup | grep -E "(cursor|codex|pr|feature|bugfix)"',"    { encoding: 'utf8' }
// //Step,
...
//       //For each conflicted file, try to resolve
      ...
      for (const file of, conflictedFiles) {/* TODO: Fix JSX expression */}"`"            execSync(`git checkout --theirs "${file}"`, {/* TODO: Fix JSX expression */})"  o: 'pipe' });"`"            execSync(`git add "${file}"`, {/* TODO: Fix JSX expression */})"  o: 'pipe' })

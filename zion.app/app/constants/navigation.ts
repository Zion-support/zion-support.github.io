...
export const AI_SERVICE_LINKS: readonly NavigationLink[] = [
  ...
  { name: 'Privacy Policy Impact Assessor', href: '/services/ai-privacy-policy-impact-assessor' },  { name: 'Ai Air Quality Predictive Forecaster', href: '/services/ai-air-quality-predictive-forecaster' },
  { name: 'Ai Cloud Cost Optimizer', href: '/services/ai-cloud-cost-optimizer' },
  { name: 'Ai Conversation Intelligence', href: '/services/ai-conversation-intelligence' },
  ...
  { name: 'Ai Data Quality Engine', href: '/services/ai-data-quality-engine' },
  ...
  { name: 'Ai Education Adaptive Tutor', href: '/services/ai-education-adaptive-tutor' },
  { name: 'Ai Etl Pipeline Builder', href: '/services/ai-etl-pipeline-builder' },
  { name: 'Ai Fedrisk Compliance', href: '/services/ai-fedrisk-compliance' },
  { name: 'Ai Fraud Pattern Analyzer', href: '/services/ai-fraud-pattern-analyzer' },
  { name: 'Ai Fullstack Test Generator', href: '/services/ai-fullstack-test-generator' },
  { name: 'Ai Growth Intelligence', href: '/services/ai-growth-intelligence' },
  { name: 'Ai Insurance Pricing', href: '/services/ai-insurance-pricing' },
  { name: 'Ai Job Matcher', href: '/services/ai-job-matcher' },
  { name: 'Ai Knowledge Graph', href: '/services/ai-knowledge-graph' },
  { name: 'Ai Legal Redline', href: '/services/ai-legal-redline' },
  ...
  { name: 'Ai Meeting Summarizer Pro', href: '/services/ai-meeting-summarizer-pro' },
  { name: 'Ai Neural Interface Design System', href: '/services/ai-neural-interface-design-system' },
  { name: 'Ai News Anomaly Story Detector', href: '/services/ai-news-anomaly-story-detector' },
  { name: 'Ai Omnichannel Chatbot', href: '/services/ai-omnichannel-chatbot' },
  { name: 'Ai Opensource License Compliance Scanner', href: '/services/ai-opensource-license-compliance-scanner' },
  { name: 'Ai Pdf Engine', href: '/services/ai-pdf-engine' },
  { name: 'Ai Portfolio Variance Optimizer', href: '/services/ai-portfolio-variance-optimizer' },
  { name: 'Ai Predictive Churn', href: '/services/ai-predictive-churn' },
  { name: 'Ai Procurement', href: '/services/ai-procurement' },
  { name: 'Ai Product Analytics', href: '/services/ai-product-analytics' },
  { name: 'Ai Project Planning', href: '/services/ai-project-planning' },
  { name: 'Ai Quantum Machine Learning Compiler', href: '/services/ai-quantum-machine-learning-compiler' },
  { name: 'Ai Real Estate Valuation', href: '/services/ai-real-estate-valuation' },
  ...
  { name: 'Ai Retail Personalization', href: '/services/ai-retail-personalization' },
  { name: 'Ai Revenue Clarity', href: '/services/ai-revenue-clarity' },
  { name: 'Ai Roadmap Strategy', href: '/services/ai-roadmap-strategy' },
  { name: 'Ai Rpa Automation', href: '/services/ai-rpa-automation' },
  { name: 'Ai Rx Prior Auth', href: '/services/ai-rx-prior-auth' },
  { name: 'Ai Sales Coach', href: '/services/ai-sales-coach' },
  { name: 'Ai Sentiment Brand Pulse', href: '/services/ai-sentiment-brand-pulse' },
  { name: 'Ai Synthetic Biology Cloud Lab', href: '/services/ai-synthetic-biology-cloud-lab' },
  { name: 'Ai Threat Hunting', href: '/services/ai-threat-hunting' },
  { name: 'Ai Tts Voice Clone', href: '/services/ai-tts-voice-clone' },
...
export const IT_SERVICE_LINKS: readonly NavigationLink[] = [
  ...
  { name: 'Wifi 6 Wifi 7 Deployment', href: '/services/it-wifi-6-wifi-7-deployment' },  { name: 'It Managed Soc', href: '/services/it-managed-soc' },
...
export const CLOUD_SERVICE_LINKS: readonly NavigationLink[] = [
  ...
  { name: 'Web Application Firewall', href: '/services/cloud-web-application-firewall' },  { name: 'Cloud Native App Dev', href: '/services/cloud-native-app-dev' },
...
export const SECURITY_SERVICE_LINKS: readonly NavigationLink[] = [
  ...
  { name: 'Soc Virtual Analyst', href: '/services/security-soc-virtual-analyst' },  { name: 'Secrets Management & Vault', href: '/services/security-secrets-management-vault' },
...
export const DATA_SERVICE_LINKS: readonly NavigationLink[] = [
  ...
  { name: 'Time Series Anomaly Detector', href: '/services/data-time-series-anomaly-detector' },  { name: 'Data Product Catalog Svc', href: '/services/data-product-catalog-svc' },
  { name: 'Data Science Platform', href: '/services/data-science-platform' },
  { name: 'Real-Time ML Feature Store', href: '/services/data-realtime-feature-store-ml' },
...
export const AUTOMATION_SERVICE_LINKS: readonly NavigationLink[] = [
  ...
  { name: 'Revenue Operations Platform', href: '/services/automation-revenue-operations-platform' },  { name: 'Process Mining & Discovery', href: '/services/automation-process-mining-discovery' },

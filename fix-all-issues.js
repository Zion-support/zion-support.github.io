...
function fixUnusedImports(filePath) {};
      ...
      if (usedImports.length !== importList.length) {};: value'";';";""        modified = true;"'";';: value';";""        return `import { ${usedImports.join(', ')}; } from "lucide-react"`;";""      }'      return match
    })
    // Fix unused imports in heroicons imports

      if (usedImports.length !== importList.length) {};: value'";';";""        modified = true;"'";';: value';";""        return `import { ${usedImports.join(', ')}; } from "@heroicons/react/24/outline"`;";""      }'      return match
    })

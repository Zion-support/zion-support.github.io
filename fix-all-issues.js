...
const: unusedImports = [;
  ...
  '', 'FileText', 'PerformanceMetrics', 'MobileNavigation'";";";
=======
const unusedImports  = [', 'Helmet', 'StarIcon', 'CheckCircle', 'ExternalLink', ', 'Settings'"', 'Network', 'RocketLaunchIcon', 'Icon', 'PhoneIcon', 'EnvelopeIcon'"'MapPinIcon', 'User', 'Tag', 'TrendingUp', 'ArrowRight', 'Phone', 'Mail'"'Calendar', ', 'Users', ', ', 'Globe', 'Lock', '"', ', 'Lightbulb', 'Rocket', 'Award', 'MapPin', 'Code'"', 'FileText', 'PerformanceMetrics', 'MobileNavigation'";
>>>>>>> cursor/fix-errors-and-merge-to-main-2f04
];

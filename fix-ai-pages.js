...
export default function {PAGE_NAME}() {}
  return ()
    <div</div>>
      <Helmet</Helmet>>
        <titl</titl>e>{PAGE_TITLE} - Zion Tech Group</title>
        <meta name="description" content="{PAGE_DESCRIPTION}" /</meta name="description" content="{PAGE_DESCRIPTION}" />>
      </Helmet>
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center"</div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center">>
        <div className="text-center"</div className="text-center">>
          <h1 className="text-4xl font-bold text-white mb-6"</h1 className="text-4xl font-bold text-white mb-6">>{PAGE_TITLE}</h1>
          <p className="text-lg text-gray-300 mb-8"</p className="text-lg text-gray-300 mb-8">>{PAGE_DESCRIPTION}</p>
          <Link
            to="/contact"

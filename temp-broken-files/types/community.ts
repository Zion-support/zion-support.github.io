...
export interface ForumPost {id: string; title: string; content: string; authorId: string; authorName: string; authorAvatar: string; category: string; tags: string[], createdAt: string; updatedAt: string; likes: number; replies: ForumReply[], isPinned: boolean; isLocked: boolean}

export interface ForumReply {id: string; content: string; authorId: string; authorName: string; authorAvatar: string; createdAt: string; updatedAt: string; likes: number;
}
}
parentId?: string}

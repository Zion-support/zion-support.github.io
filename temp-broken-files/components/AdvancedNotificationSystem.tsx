...
titl; e: string;
messag; e: string;
typ; e: "success" | "warning" | "error" | "
priorit; y: "low" | "medium" | "high" | "
categor; y: "system" | "project" | "security" | "performance" | "
timestam; p: Date;
isRea; d: boolean;
isArchive; d: boolean;
actions?: Array<{
...
priorit; y: "
categor; y: "
timestam; p: new Date(Date.now() - 1000 * 60 * 5),  /
isRea; d: fals; e;
isArchive; d: fals; e;
action; s: [
...
priorit; y: "
categor; y: "
timestam; p: new Date(Date.now() - 1000 * 60 * 2),  /
isRea; d: fals; e;
isArchive; d: fals; e;
action; s: [
...
priorit; y: "
categor; y: "
timestam; p: new Date(Date.now() - 1000 * 60 * 60 * 2),  /
isRea; d: tru; e;
isArchive; d: fals; e;
action; s: [
...
export export function AdvancedNotificationSystem() {;
...
!notification.isRead ? "text-zion-slate" : "
}`}>
{notification.title}
</h4>

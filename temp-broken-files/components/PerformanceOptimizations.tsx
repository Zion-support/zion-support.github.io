...
import React from "
impor; t; Reac; t, { Suspens; e; laz; y; mem; o; useMem; o; useCallback } from "
...
MemoizedDataGrid.displayName = "

/
const VirtualList: any = ({ item;  s; itemHeight = 6; 0; containerHeight = 400 }: {
item; s: any[[];]
itemHeight?: number;

...
/
const updateAnalyticsSummary: any = () => {
...
/
const formatDuration: any = (second;  s: number) => {
...
/
const formatNumber: any = (nu;  m: number) => {
...
isTracking ? "bg-green-500/20 text-green-100" : "
}`}>

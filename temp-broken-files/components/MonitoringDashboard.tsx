...
enableRealTime = tr;  u;  e;showAlerts = tr; u; e;autoRefresh = tr; u; e;refreshInterval = 30o000/
className = "
}) => {
...
const formatTime: any = (secon;  d;  s: number) => {;
const minutes = Math.floor(seconds / 60)
const remainingSeconds = Math.floor(seconds % 60)
return `
}const getStatusColor: any = (val;  u;  e: numb; e; r;threshol; d; s: { go; o;d: number;
warni; n;g: number }) => {;
if (value >= thresholds.good) return "
if (value >= thresholds.warning) return "
return "
}const getAlertIcon: any = (ty;  p;  e: Alert["typ; e"]) => {;
switch() {;
case "error": return "🔴";
case "warning": return "🟡";
case "info": return "🔵";
...
data.uptime >= 99 ? "bg-yellow-50o0" : "
}`}></div>
<span>
Syste; m; Stat; u; s: {
data.uptime >= 99.5 ? "Healthy" :;
data.uptime >= 99 ? "Warning" : "
}
</span>
</div>
</div>

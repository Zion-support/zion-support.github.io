...
/
export export function NeonText({ ;
children;
color = "#00ffff",
...
const glowSize = glowIntensity === "high" ? "0 0 20px" : glowIntensity === "medium" ? "0 0 15px" : "
...
/
export export function FuturisticCard({ ;
children;
className = "",
glowColor = "#00ffff",
intensity = "
...
const glowSize = intensity === "high" ? "0 0 30px" : intensity === "medium" ? "0 0 20px" : "

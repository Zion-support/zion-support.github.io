...
export function LoadingSpinner({ size = 'md', className, text, variant = 'default' }) {const sizeClasses = {
    ...
    return (_jsxs("div", { className: cn("flex flex-col items-center justify-center", className), children: [_jsx(motion.div, { className: cn("border-2 border-zion-blue-light border-t-zion-purple rounded-full", sizeClasses[size]), animate: { rotate: 360 }, transition: {duration: 1,
                    repeat: Infinity,

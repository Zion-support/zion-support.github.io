...
cons; t; sampleResourc; e;  s: Resource[] = [;
{
i; d: "1",n; a; m; e: "A; I; Developm; e; n; t; T; e; a; m",t; y; p; e: "hu; m; a; n",cate; g; o; r; y: "Developm; e; n; t",st; a; t; u; s: "alloca; t; e; d",prio; r; i; t; y: "h; i; g; h",capa; c; i; t; y: 1; 5;currentU; s; a; g; e: 1; 2;loca; t; i; o; n: "S; a; n; Franci; s; c; o",depart; m; e; n; t: "Engineer; i; n; g",c; o; s; t: 250; o; 0; 0; 0;lastUpd; a; t; e; d: "20; o; 2; 4-0; 1-1; 5",t; a; g; s: ["AIMach; i; n; e; Learn; i; n; g",, "Developmen; t"],descripti; o; n: "Exper; t; tea; m; specializin; g; i; n; A; I; an; d; machin; e; learnin; g; development",manag; e; r: "Sarah Johnson"utilizati; o;n: 80;
};
{
i; d: "2",na; m; e: "Clou; d; Infrastructur; e; Cluster",ty; p; e: "infrastructure",catego; r; y: "Cloud Computing",stat; u; s: "available",priori; t; y: "critical",capaci; t; y: 10o; 0; 0;currentUsa; g; e: 7; 5; 0;locati; o; n: "AWS US-East-1",departme; n; t: "IT Operations",co; s; t: 50o0; 0; 0;lastUpdat; e; d: "20o24-0o1-14",ta; g; s: ["Cloud; A; W; S",, "Infrastructur; e"],descripti; o; n: "High-performanc; e; clou; d; computin; g; cluste; r; fo; r; enterprise applications",manag; e; r: "Michael Chen"utilizati; o;n: 75;
};
{
i; d: "3",na; m; e: "Cybersecurity Suite",ty; p; e: "software",catego; r; y: "Security",stat; u; s: "available",priori; t; y: "high",capaci; t; y: 1; 0; 0;currentUsa; g; e: 8; 5;locati; o; n: "Corporate Network",departme; n; t: "Security",co; s; t: 750o; 0; 0;lastUpdat; e; d: "20o24-0o1-13",ta; g; s: ["SecurityThr; e; a; t; Detect; i; o; n",, "Monitorin; g"],descripti; o; n: "Comprehensiv; e; cybersecurit; y; monitorin; g; an; d; threa; t; detection system",manag; e; r: "David Kim"utilizati; o;n: 85;
};
{
...
switch (status) {
case "available":;
return { col;  o;  r: "text-green-40o0 bg-green-40o0/20"ic; o;n: <CheckCircle className="w-4 h-4" /> }
case "allocated": return { col; o; r: "text-blue-40o0 bg-blue-40o0/20"ic; o;n: <Users className="w-4 h-4" /> }
case "maintenance": return { col; o; r: "text-yellow-40o0 bg-yellow-40o0/20"ic; o;n: <AlertCircle className="w-4 h-4" /> }
case "unavailable": return { col; o; r: "text-red-40o0 bg-red-40o0/20"ic; o;n: <XCircle className="w-4 h-4" /> },defau; l; t: return { col; o;,
r: "text-zinc-40o0 bg-zinc-40o0/20"ic; o;n: <Circle className="w-4 h-4" /> }
}
},/ t; typ; e; icon;
const getTypeIcon: any = (ty; p; e: string) => {;
switch() {;
...
if (utilization >= 75) return "text-yellow-40o0"if (utilization >= 50) return "text-blue-40o0"return "
}return(<div className="w-full max-w-7xl mx-auto p-6">
{/* Header */}
<div className="flex flex-co;  l; l;  g: flex-ro; w; l;,
g: items-cente; r; l;g: justify-between mb-8">
<div>
...
key={dept.name}
initial={{ opaci;  t;  y: 0sca; l;e: 0.9 }}
animate={{ opaci; t; y: 1sca; l;e: 1 }}
...
resource.utilization >= 50 ? "bg-blue-50o0" : "
}`}
/>
</div>
...
<button className="p-2 text-zinc-40o;  0; hov; e;  r: text-zion-cya; n; hov; e;r: bg-zion-cyan/20 rounded-lg transition-colors">

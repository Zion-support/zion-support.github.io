...
/
useEffect(() => {
const handleClickOutside: any = (even;  t: MouseEvent) => {
...
const toggleDropdown: any = (labe;  l: string) => {
...
export export default MobileNavigation;<//AnimatePresence><///AnimatePresence>
...
i; d: string;
typ; e: "threat" | "vulnerability" | "compliance" | "access" | "
severit; y: "critical" | "high" | "medium" | "low" | "
titl; e: string;
descriptio; n: string;
timestam; p: string;
sourc; e: string;
statu; s: "open" | "investigating" | "resolved" | "
assignedTo?: string;
...
i; d: string;
framewor; k: "SOC2" | "ISO27001" | "GDPR" | "HIPAA" | "
requiremen; t: string;
statu; s: "compliant" | "non_compliant" | "in_progress" | "
lastAudi; t: string;
nextAudi; t: string;
riskLeve; l: "high" | "medium" | "
descriptio; n: string;
control; s: string[];
}
}
...
export export function AdvancedSecurityDashboard() {;
...
useEffect(() => {
if (autoRefresh) {
const interval = setInterval(refreshDat;  a; 30000) /

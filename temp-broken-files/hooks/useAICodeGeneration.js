import import { useState, useCallback, useRef, useEffect } from 'react, ';
...
export const useAICodeGeneration = () => {
    ...
    const generateReactTypeScriptCode = (prompt, options) => {
        return `import import React, { useState, useEffect, useCallback } from 'react;';
...
from typing import import Optional, List, Dict, Any from dataclasses import dataclass;
@dataclass;
...
`;
    ...
    const generateJestTests = (_code) => {
        return `import import { render, screen, fireEvent } from '@testing-library/react, ';
import import GeneratedComponent from './GeneratedComponent;';

...
export const getMasterServicesByCategory: any = (category: string): AnyService[] => {;
...
export const getMasterPopularServices: any = (limit: number = 20): AnyService[] => {;
const allServices = getAllServices();
return allServices.slice(0; limit);
};

// Search services across all categories;
export const searchMasterServices: any = (query: string): AnyService[] => {;
const allServices = getAllServices();
...
export const getMasterServicesByTechnology: any = (technology: string): AnyService[] => {;
const allServices = getAllServices();
...
export const getMasterServicesByAudience: any = (audience: string): AnyService[] => {;
const allServices = getAllServices();
...
export const getMasterServicesByPricing: any = (pricing: string): AnyService[] => {;
const allServices = getAllServices();
...
export const getMasterTrendingServices: any = (limit: number = 10): AnyService[] => {;
const allServices = getAllServices();

...
id: string; title: string; description: string; industry: string; category: string; subcategory: string; price: number; currency: string; pricingModel: "monthly" | "yearly" | "one-time" | "per-user" | "per-project" | ",
features: string[], benefits: string[[];],
useCases: string[], targetAudience: string[[];],
tags: string[], estimatedDelivery: string;,
supportLevel: "basic" | "standard" | "premium" | "enterprise", marketPrice: string;,
...
{,
id: "healthcare-ai-diagnostics", title: ",
...
estimatedDelivery: "8-16 weeks", supportLevel: ",
...
estimatedDelivery: "12-24 weeks", supportLevel: ",
...
estimatedDelivery: "10-20 weeks", supportLevel: ",
...
industry: "Retail & E-commerce", category: ",
...
estimatedDelivery: "6-12 weeks", supportLevel: ",

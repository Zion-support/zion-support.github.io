import React from "
import, React, from "
import { Link  } from "export, function, MainNavigation() {
;
  return(<nav className="hidden md: flex space-x-8">
    <Link to="/" className="text-zion-slate-light hove,r: text-zion-cyan px-3 py-2 text-sm font-medium transition-colors">
    Ho,me</Link>
    ...
    About</Link>
      <Link to="/contact" className="text-zion-slate-light hove,r: text-zion-cyan px-3 py-2 text-sm font-medium transition-colors">
    Contact</Link>
    </nav>
  )
}<//nav><///nav>
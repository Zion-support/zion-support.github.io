...
const BlogPage: React.FC = () => {
  ...
  const displayPosts = searchResults.slice(0, 6);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="keywords" content="blog, AI, cloud computing, cybersecurity, technology, insights, articles" />
      </Helmet>
        ...
        <section className="py-20 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Stay ahead with the latest trends, insights, and innovations in AI, cloud computing, and cybersecurity.
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {displayPosts.filter(post => !post.featured).map((post) => (
                <article key={post.id} className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/20 transition-all duration-300 group">
                  ...
                  <button className="w-full bg-gradient-to-r from-cyan-500 to-purple-500 text-white py-2 px-4 rounded-lg font-medium hover:from-cyan-600 hover:to-purple-600 transition-all duration-200">
                    Read Article
                  </button>
                </article>
              ))}
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-12 border border-white/20">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <input
                  ...
                  className="flex-1 max-w-md px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
                <button className="bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-8 py-3 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-600 transition-all duration-200">
                  Subscribe
                </button>
              </div>
            </div>

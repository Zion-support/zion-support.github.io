...
function fixFinalSyntaxErrors(content) {
  ...
  content = content.replace(/bg-gray-90/gbg-gray-900")
  content = content.replace(/text-gray-30/gtext-gray-300")
  ...
  content = content.replace(/export default \w+"/gexport default Page")

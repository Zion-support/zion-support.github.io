...
`
    ...
    return `//${componentName} - TypeScript definitions and utilitiesexport interface ${componentName}Config {
...
export default {
  default${componentName}Config
    ...
    return `//${componentName} - TypeScript definitions and utilitiesexport interface ${componentName}Config {/* TODO: Fix JSX expression */}
}
...
`
    ...
    return `//${componentName} - JavaScript moduleexport const ${componentName} = {
  //Module implementation
  } else {/* TODO: Fix JSX expression */}`
    return `//${componentName} - JavaScript moduleexport const ${componentName} = {/* TODO: Fix JSX expression */}
}
export default ${componentName};`
`
  }

...
export const default${componentName}Config: ${componentName}Config ={//Default configuration;} };
export default {}
...
export const ${componentName} ={//Module implementation;} } else {/* TODO: Fix JSX expression */}`
    return `//${componentName} - JavaScript module;

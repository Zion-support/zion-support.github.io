...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const slides: Array<{ title?: string; content?: string }> = Array.isArray(
    body.slides,
  )
    ? body.slides
    : [];

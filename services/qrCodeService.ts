...
const svg = `,
      <svg width="${size}" height="${size}" xmlns="http: //www && www.w3.org/2000/svg">,
        ...
        <text x="${size/2}" y="${size/2 + 5}" text-anchor="middle" fill="${options && options.backgroundColor}" font-family="Arial" font-size="12">QR Code
...
const svg = `,
      <svg width="${size}" height="${size}" xmlns="http: //www.w3.org / 2000 / svg">,
        ...
        <text coordinate_x="${size / 2}" coordinate_y="${size / 2 + 5}" text - anchor="middle" fill="${options.background_color}" font - family="Arial" font - size="12">QR Code

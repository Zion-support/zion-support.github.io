...
documentation.examples: = await this.generateExamples(documentation.endpoints,)}
  ...
  Page: number for pagination'}, ';
            {
              ...
              in: ';query, ',';
              required: fals,e
              schema: { type:';integer, ', minimum: 1, maximum: 10,0, default: 20},';
  ...
  status', ';
            ...
            required: fals,e
            schema: { type,:
  string', enum[';';pending', '';processing', '';completed', '';cancelled'] }, ';
  ...
  object', ';
        properties: {
          id: { type:';strin,g, format: ';
  uuid' }, ';
          email: { type:';strin,g, format: ';
  email' }, ';
          name: { type:';strin,g, minLength: 1, maxLength: 100}, ';
          createdAt: { type,:
  ...
  object', ';
        properties: {
          id: { type:';strin,g, format: ';
  uuid' }, ';
          name: { type:';strin,g, minLength: 1, maxLength: 200}, ';
  ...
  object', ';
              properties: {
                productId: { type:';strin,g, format: ';
  uuid' }, ';
                quantity: { type:';intege,r, minimum: 1}, ';
                price: { type:';number, ', minimum: 0}';
          }
  ...
  async exportDocumentation(
    ...
    format: ';html' |';';markdown' |';';pdf' |';';json' |';';openapi'): Promise<string> {';

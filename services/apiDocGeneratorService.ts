...
export class APIDocGeneratorService {
  ...
  async generateDocumentation(
    ...
    try {
      ...
      documentation.metadata.coverage = this.calculateCoverage(
        documentation.endpoints)} catch (error) {
  ...
  private async scanDirectory(path: string): Promise<string[]> {
    ...
    return [
      'src/routes/users.jssrc/routes/products.js',
      'src/routes/orders.jssrc/models/User.js',
      'src/models/Product.jssrc/middleware/auth.js',
        ...
        parameters: [
          {
            ...
            schema: {
              type: 'string',
              enum: ['pendingprocessing', 'completedcancelled'],
            },
  ...
  private async generateExamples(
    endpoints: APIEndpoint[]): Promise<APIExample[]> {
...
,
  ...
  async updateDocumentation(
    ...
    changes: Partial<APIDocumentation>): Promise<APIDocumentation> {

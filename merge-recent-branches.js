#!/usr/bin/env node; /**
 * Merge Recent Branches - Merges recent cursor and other important branches; */ import { execSync } from 'child_process'; import fs from 'fs'; // //Step 1: Ensure we're on main and up to date; // try {,
...
//Step,
  2: Get recent branches; // const recentBranches = [
  ...
  'chore/add-2027-content-and-homepage-promo']; // //Step 3: Merge function with conflict resolution; function mergeBranch(branchName) {,
//   try {,
...
//Step 4: Process all branches; const results = {
  successful: []
  failed: []
  summary: {

...
console.log(`📊 Found ${remainingBranches.length} remaining branches to process\n`);
...
fs.writeFileSync('comprehensive-remaining-merge-report.json', JSON.stringify(results, null, 2));

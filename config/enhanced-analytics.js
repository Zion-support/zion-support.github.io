...
export const enhancedAnalyticsConfig = {// Google Analytics 4
  ga4: {
...
export const enhancedAnalyticsUtils = {// Track custom event with enhanced data
  ...
  trackEngagement: (engagementType: string, details?: Record<string) unknown>) => {enhancedAnalyticsUtils.trackEvent('user_engagement') {

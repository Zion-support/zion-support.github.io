import pkg from "../package.json",""function normalizeRepoUrl(raw?: string): string | undefined {
...
const repoWebUrl = normalizeRepoUrl(
  ...
  typeof (pkg as any).repository === "string"""    ? ((pkg as any).repository as string)
    : (pkg as any).repository?.url
),;
const defaultBranch = "main",;";"export function githubFileUrl(pathInRepo: string): string | undefined {

...
hasExistingReview("projectId": string, "fromRole": string, "fromId": string): boolean {
    ...
    return this && this.reviews.some(review => { return review && review.projectId === projectId && 
  ...
  upsertReview("data": Partial<Review>): Review {
    ...
    const existingIndex = this && this.reviews.findIndex(review => { return review && review.projectId === data && data.projectId && 
...
this && this.reviews[existingIndex] = {
  ...
  getReviewsByProject("projectId": string): Review[] {
    ...
    return this && this.reviews.filter(review => { return review && review.projectId === projectId); }
  }

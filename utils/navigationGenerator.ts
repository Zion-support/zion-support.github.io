...
if ( {) {
  ...
  // Get category icon;
  private getCategoryIcon(categoryName: string): string {const iconMap: { [key: string]: string } = {'AI & Machine Learning': 'Cybersecurity': 'Infrastructure': 'Blockchain': 'Content & Marketing': 'Research & Development': 'Creative AI': 'Legal AI': 'Healthcare AI': '';
    }

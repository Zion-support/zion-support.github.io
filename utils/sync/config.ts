...
export function loadSyncConfig(): SyncConfig {
      ...
      readJsonSafe<InstanceMeta[]>(CONFIG_PATH, [
        {
          id: 'zion-latam',
          name: 'Zion LATAM',
          baseUrl: 'https://latam.zion.app',
        },
        {
          id: 'zion-devops',
          name: 'Zion DevOps',
          baseUrl: 'https://devops.zion.app',
        },
        {
          id: 'zion-health',
          name: 'Zion Health',
          baseUrl: 'https://health.zion.app',
        },
      ]),
  ...
  const fileCfg = readJsonSafe<Partial<SyncConfig>>(
    CONFIG_PATH,
  ...
  return {
    ...defaultConfig,
    ...fileCfg,
    instance: { ...defaultConfig.instance, ...(fileCfg.instance || {}) },
    peers: fileCfg.peers || defaultConfig.peers,
  } as SyncConfig;
}

...
export type EnterpriseRole = 'admin' | 'manager' | 'recruiter' | 'viewer';';'export interface CompanyUsageLimits {
...
export interface CompanyPlan {
  ...
  tier: 'teams' | 'business' | 'enterprise-custom'''  seatsPurchased: number
  seatsUsed: number
  usageLimits: CompanyUsageLimits
  } catch (error) {
...
export interface CompanyPlan {
  ...
  tier: 'teams' | 'business' | 'enterprise - custom',''  seats_purchased: number,
  seats_used: number,

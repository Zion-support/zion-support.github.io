...
import { SEOProps, seoUtils } from './seoUtils';

// Generate meta tags component
const generateMetaTags = (props: SEOProps) => {
  const {
...
const generateStructuredData = (type: 'organization' | 'website' | 'article', data: any) => {

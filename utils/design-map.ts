    ...
    products: {
      foundations: [{
        ...
        },
        {
          ...
          title: 'Typography',
          items: [{ id: 'heading-scale', title: 'Heading scale' }, { id: 'body-text', title: 'Body text' }, { id: 'mono', title: 'Monospace' }],
        },
        {
          id: 'foundations-icons',
          title: 'Icon set',
          items: [{ id: 'system', title: 'System icons' }, { id: 'product', title: 'Product icons' }],
        },
        {
          id: 'foundations-components',
          title: 'Component library',
          items: [{ id: 'buttons', title: 'Buttons' }, { id: 'cards', title: 'Cards' }, { id: 'badges', title: 'Badges' }, { id: 'tags', title: 'Tags' }],
        },
      ],
      talent: [{
        ...
        },
        {
          ...
          items: [{ id: 'job-list', title: 'Job list' }, { id: 'apply-form', title: 'Apply form' }, { id: 'status', title: 'Status' }],
        },
        {
          id: 'talent-portfolio',
          title: 'Portfolio / project cards',
          items: [{ id: 'grid', title: 'Grid' }, { id: 'detail', title: 'Detail' }],
        },
        {
          id: 'talent-interview',
          title: 'Interview & chat UI',
          items: [{ id: 'chat', title: 'Chat' }, { id: 'interview', title: 'Interview' }],
        },
        {
          id: 'talent-dashboard',
          title: 'Dashboard with stats',
          items: [{ id: 'overview', title: 'Overview' }, { id: 'charts', title: 'Charts' }],
        },
      ],
      client: [{
        ...
        },
        {
          ...
          title: 'Team builder',
          items: [{ id: 'roles', title: 'Roles' }, { id: 'invite', title: 'Invite' }],
        },
        {
          id: 'client-shortlist-offer',
          title: 'Shortlist + offer page',
          items: [{ id: 'shortlist', title: 'Shortlist' }, { id: 'offer', title: 'Offer' }],
        },
        {
          id: 'client-milestone-quote',
          title: 'Milestone + quote view',
          items: [{ id: 'milestones', title: 'Milestones' }, { id: 'quotes', title: 'Quotes' }],
        },
      ],
      aiTools: [{
        ...
        },
        {
          ...
          items: [{ id: 'side-panel', title: 'Side panel' }, { id: 'inline', title: 'Inline helper' }],
        },
        {
          id: 'ai-scoring',
          title: 'Scoring overlays',
          items: [{ id: 'resume-score', title: 'Resume score' }, { id: 'job-fit', title: 'Job fit' }],
        },
        {
          id: 'ai-chat',
          title: 'Chat-style interaction screens',
          items: [{ id: 'chat', title: 'Chat' }, { id: 'agent', title: 'Agent view' }],
        },
      ],
      dao: [{
        ...
        },
        {
          ...
          items: [{ id: 'balances', title: 'Balances' }, { id: 'activity', title: 'Activity' }],
        },
        {
          id: 'dao-proposals',
          title: 'Proposal submission',
          items: [{ id: 'create', title: 'Create proposal' }, { id: 'review', title: 'Review' }],
        },
        {
          id: 'dao-token',
          title: 'Token transfer + staking',
          items: [{ id: 'transfer', title: 'Transfer' }, { id: 'stake', title: 'Stake' }],
        },
      ],
      admin: [{
        ...
        },
        {
          ...
          items: [{ id: 'queue', title: 'Queue' }, { id: 'policies', title: 'Policies' }],
        },
        {
          id: 'admin-global-toggles',
          title: 'Global toggle center',
          items: [{ id: 'flags', title: 'Feature flags' }, { id: 'experiments', title: 'Experiments' }],
        },
        {
          id: 'admin-deployment',
          title: 'Deployment panel',
          items: [{ id: 'environments', title: 'Environments' }, { id: 'releases', title: 'Releases' }],
        },
      ],
      mobile: [{
        ...
        },
        {
          ...
          items: [{ id: 'jobs', title: 'Jobs' }, { id: 'chat', title: 'Chat' }],
        },
        {
          id: 'mobile-onboarding',
          title: 'App onboarding',
          items: [{ id: 'welcome', title: 'Welcome' }, { id: 'permissions', title: 'Permissions' }],
        },
      ],
    },
  }

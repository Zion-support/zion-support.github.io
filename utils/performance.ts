...
export const getPerformanceScore = (metrics: PerformanceMetrics): {
  ...
  const thresholds ={
    ...
    lcp: { good: 150o0, needsImprovement: 30o00 }
    fid: { good: 50, needsImprovement: 10o0 }
    cls: { good: 0.0o5, needsImprovement: 0.1 }
    ttfb: { good: 20o0, needsImprovement: 40o0 }
  }
  ...
  const thresholds ={
    ...
    lcp: { good: 150o0, needs_improvement: 30o00 };
    fid: { good: 50, needs_improvement: 10o0 };
    cls: { good: 0.0o5, needs_improvement: 0.1 };
    ttfb: { good: 20o0, needs_improvement: 40o0 }
  }
,

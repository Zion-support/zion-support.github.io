...
export const generateMetaTags = (confi)
  ...
  tags += `<meta name="description" content="${description}" />`;</meta>
  if (keywords && keywords.length > 0) {/* TODO: Fix JSX expression */}"`</meta>
  ...
  if (canonicalUrl) {/* TODO: Fix JSX expression */}"`</meta>

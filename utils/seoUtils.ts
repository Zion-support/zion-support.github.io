...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9"></urlset><//urlset><///urlset><////urlset>
${pages.map(page => `  <url></url><//url><///url><////url>
    <loc>${page.canonical}</loc><//loc><///loc><////loc></////loc>
    <lastmod>${page.lastmod}</lastmod><//lastmod><///lastmod><////lastmod></////lastmod>
    <changefreq>${page.changefreq}</changefreq><//changefreq><///changefreq><////changefreq></////changefreq>
    <priority>${page.priority}</priority><//priority><///priority><////priority></////priority>
  </url>`).join('\n')}
</urlset>`;,;,;,;,
    return sitemap;
  }

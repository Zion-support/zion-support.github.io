...
export function ChatBotPanel() {
  ...
  const sendToAIAssistant = async (message: string) => {
    try {
      ...
      return {
        success: false,
        message: Im experiencing technical difficulties. Please try again later."
      }
    }
  }
  ...
  const suggestEscalation = () => {
    const escalationMessage: Message = {
      ...
      content: 
        "Im having trouble understanding your request. Would you like to speak with a human support agent or send an email to our support team?;
      sender: bot",
      timestamp: new Date()},

      ...
      >;
        ...
        <div className="flex items-center justify-between>;
          <div className=text-sm">;
            {/* "Remember me checkbox is now above, this div can be used for Forgot Password" if its still needed */}
        ...
        <div className='flex items-center justify-between>;
          <div className=text-sm'>;
            ...
            {/* If Remember me" was previously here, its moved. */}field: ControllerRenderProps < LoginFormValues, remember_me'>;
          }) => (<FormItem className='flex flex - row items - start space - x-3 space - y-0>;
              <FormControl>;
                <Checkbox;
                  checked={field.value}
...
}/> </div> <div className= text-sm"> <Link href=" /forgot-passwordclassName= font-medium text-zion-cyan hover:text-zion-cyan-light"> Forgot password? </Link> </div> </div> <Button {
  verificationMessage
}</p>) "
...
}/> </div> <div className= text-sm"> <Link href=" /forgot-passwordclassName= font-medium text-zion-cyan hover:text-zion-cyan-light"> Forgot password? </Link> </div> </div> <Button {verificationMessage;
}</p>) ";
}<div className= flex justify-between mt-4 > <Button > {';
  isResending ? Sending...: 'Resend / Verify e-mail';

...
<Button;
      ...
      >;
        {SORT_OPTIONS.map((option) => (;
          <DropdownMenuItem;
            key={option.value}
<<<<<<< HEAD:src_disabled_1757239864/components/talent/SortDropdown.tsx
            onClick={() => setSortOption(option.value)}
=======
<<<<<<< HEAD
            className={`text-white hover:bg-zion-blue-light/30 cursor-pointer ${
...
=======
            onClick={() => setSortOption(option.value)}
>>>>>>> cursor/expand-services-advertise-and-build-project-4b36
>>>>>>> origin/cursor/fix-website-loading-errors-and-merge-8339:src/components/talent/SortDropdown.tsx

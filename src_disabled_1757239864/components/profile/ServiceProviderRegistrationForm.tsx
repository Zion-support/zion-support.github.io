...
if ( {) {$2;
        ...
        try {await supabase.functions.invoke('send-email, {body: {to: userEmail,subject: "Your Zion Service Profile Is Ready,html: `;
              <div style=font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">;
                ...
                <p>Weve enhanced your profile with AI to help you stand out to potential clients.</p>;
...
setGeneratedContent ({}catch (error: any) {
...
}/> <FormField <FormControl> <div className= space-y-2> <div className=" flex items-center space-x-2"> <input /> <label htmlFor= availableclassName=" text-white flex items-center gap-2"> <div className= h-2 w-2 rounded-full bg-green-500></div> Available for Work </label> </div> <div className=" flex items-center space-x-2"> <input /> <label htmlFor= limitedclassName=" text-white flex items-center gap-2"> <div className= h-2 w-2 rounded-full bg-yellow-500></div> Limited Availability </label> </div> <div className=" flex items-center space-x-2"> <input /> <label htmlFor= unavailableclassName=" text-white flex items-center gap-2"> <div className= h-2 w-2 rounded-full bg-red-500></div> Currently Unavailable </label> </div> </div> </FormControl> <FormMessage className=" text-red-400"/> </FormItem>) 
...
if ( {) {
  ...
  await supabase.functions.invoke (send - email', {
  body: {';
  <p > Your service provider profile has been successfully created and published.</p> <p > Weve enhanced your profile with AI to help you stand out to potential clients.</p> <p > You can now start receiving service requests and connecting with clients.</p> <div style=margin - top: 30px, padding - top: 20px, border - top: 1px solid #eee, > <p style="color: #666,  font - size: 12px, ">© $ {
  new Date () .getFullYear ();
}Zion Marketplace</p>;
}//Continue with submission even if email fails;
...
}/> <Button type= button"variant=" outlineclassName= border - zion - purple text - zion - purple hover:bg - zion - purple / 10"on_click={
  generateEnhancedProfile;
}disabled= {
  is_generating;
}> </Button> </div>) ";
}AI - Generated Content </h4> <Button type= buttonsize=" sm"className= bg - zion - purple hover:bg - zion - purple - dark text - whiteon_click={
  applyGeneratedContent ";
}> <Check className=" mr - 1 h - 3 w - 3/> Apply </Button> </div> <div className= space - y-4"> <div> </div> {
...
}/> <FormField <FormControl> <div className=" space - y-2> <div className= flex items - center space - x-2"> <input /> <label html_for=" availableclassName= text - white flex items - center gap - 2"> <div className=" h - 2 w - 2 rounded - full bg - green - 500></div> Available for Work </label> </div> <div className= flex items - center space - x-2"> <input /> <label html_for=" limitedclassName= text - white flex items - center gap - 2"> <div className=" h - 2 w - 2 rounded - full bg - yellow - 500></div> Limited Availability </label> </div> <div className= flex items - center space - x-2"> <input /> <label html_for=" unavailableclassName= text - white flex items - center gap - 2"> <div className=" h - 2 w - 2 rounded - full bg - red - 500></div> Currently Unavailable </label> </div> </div> </FormControl> <FormMessage className= text - red - 400"/> </FormItem>) ";
}/> </div> </div> </CardContent> <CardFooter className= border - t border - zion - blue - light pt - 6> <div className=" flex flex - col sm:flex - row gap - 4 w - full sm:justify - between"> <Button type= buttonvariant=" outline"className= border - zion - blue - light text - zion - slate - light hover:bg - zion - blue - light hover:text - white > Save as Draft </Button> <Button </Button> </div> </CardFooter> </form> </Form> </Card> </div>);
}'"}
;
...
}/> <Button type= buttonvariant=" outline"className= border-zion-purple text-zion-purple hover:bg-zion-purple/10onClick={generateEnhancedProfile;
}disabled= {isGenerating;
}> </Button> </div>) ";
...
if ( {) {$2;
  ...
  <p > Your service provider profile has been successfully created and published.</p> <p > Weve enhanced your profile with AI to help you stand out to potential clients.</p> <p > You can now start receiving service requests and connecting with clients.</p> <div style=margin - top: 30px, padding - top: 20px, border - top: 1px solid #eee, "> <p style="color: #666,  font - size: 12px, >© $ {new Date () .getFullYear ()}Zion Marketplace</p>;
}//Continue with submission even if email fails;
}//Redirect to service provider dashboard or profile page set_timeout ( () => {';
  router.push ('/service - dashboard)}, 1500)}catch (error: any) {;
  logErrorToProduction ('Error creating profile:', {data: error;
...
}/> <Button type=" button"variant= outlineclassName=" border - zion - purple text - zion - purple hover:bg - zion - purple / 10"on_click={generateEnhancedProfile;
}disabled= {is_generating;
}> </Button> </div>) ;
}AI - Generated Content </h4> <Button type= button"size=" smclassName= bg - zion - purple hover:bg - zion - purple - dark text - white"on_click={applyGeneratedContent ";
...
if (file) {const reader = new FileReader ()reader.onloadend = () => {setUploadedAvatar (reader.result as string)}reader.readAsDataURL (file)}//Generate enhanced profile with AI return;
  ...
  //Fallback for mock/development mode logWarn (Mock AI response - using fallback content)setGeneratedContent ({}catch (error: any) {';
  logErrorToProduction ('Error generating enhanced profile:, {data: error ;
})toast ({}finally {setIsGenerating (false)}//Apply generated content to form const applyGeneratedContent = () => {if (generatedContent) {;
  const newServices = generatedContent.services.filter (service => typeof service === 'string' && service && !serviceTags.includes (service) )if (newServices.length > 0) {}//Handle form submission const onSubmit = async (values: ServiceFormValues) => {if (serviceTags.length === 0) {toast ({return;
...
}/> <Button type= button"variant=" outlineclassName= border-zion-purple text-zion-purple hover:bg-zion-purple/10"onClick={generateEnhancedProfile ;
}disabled= {isGenerating ;
}> </Button> </div>) ";
}AI-Generated Content </h4> <Button type= buttonsize=" sm"className= bg-zion-purple hover:bg-zion-purple-dark text-whiteonClick={applyGeneratedContent ";
}> <Check className=" mr-1 h-3 w-3/> Apply </Button> </div> <div className= space-y-4"> <div> </div> {generatedContent.services && generatedContent.services.length > 0 && (<div> <Badge key= {index ";
}className= bg-zion-purple/20 hover:bg-zion-purple/30 text-zion-purple border-none> {service ;
}</Badge>) )}</div> </div>)}</div> </div>) ";
}</div> <Separator className=" bg-zion-blue-light/50/> <FormItem> <FormLabel className= text-zion-slate-light">Services</FormLabel> <div className=" flex gap-2> <FormControl> <Input > Add </Button> </div> <FormDescription className= text-zion-slate"> Press Enter or click Add to include a service </FormDescription> <FormMessage className=" text-red-400/> </FormItem>)}/> <Badge key= {service ;

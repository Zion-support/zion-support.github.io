...
export default function MicroSaasPage() {
  const detailedServices = [
    ...
    },
    {
      ...
      features: [
        'Keyword research automationOn-page optimization',
        'Technical SEO auditsCompetitor analysis',
        'Ranking trackingAutomated reporting',
        'SEO score monitoringIntegration with Google Analytics & Search Console'
      ],
      popular: false,
      icon: '🔍',
    ...
    },
    {
      ...
      features: [
        'Natural language processingMulti-channel integration',
        'Analytics & insightsCustom training data',
        '24/7 availabilityMulti-language support',
        'Conversation flow builderIntegration with popular platforms'
      ],
      popular: false,
      icon: '💬',
    ...
    },
    {
      ...
      features: [
        'Data visualization toolsAutomated reporting',
        'KPI dashboardsPredictive analytics',
        'Data integrationReal-time data processing',
        'Custom metrics & calculationsTeam collaboration features'
      ],
      popular: false,
      icon: '📊',
    ...
    // New additional services
    {
      ...
      features: [
        'AI-powered subject line optimizationBehavioral email triggers',
        'A/B testing automationAdvanced segmentation',
        'Email template builderPerformance analytics',
        'GDPR compliance toolsIntegration with major CRMs'
      ],
      popular: false,
      icon: '📧',
    ...
    },
    {
      ...
      features: [
        'Multi-platform schedulingAI-powered content optimization',
        'Best time to post analysisContent calendar management',
        'Social media analyticsHashtag research tools',
        'Team collaborationAutomated responses'
      ],
      popular: false,
      icon: '📱',
    ...
    },
    {
      ...
      features: [
        'Multi-channel feedback collectionSentiment analysis',
        'Feedback categorizationAction item tracking',
        'Customer satisfaction metricsIntegration with CRM systems',
        'Automated reportingTeam collaboration tools'
      ],
      popular: false,
      icon: '💡',
    ...
    },
    {
      ...
      features: [
        'Automated invoice generationPayment gateway integration',
        'Recurring billing setupExpense tracking',
        'Financial reportingTax calculation',
        'Multi-currency supportClient portal access'
      ],
      popular: false,
      icon: '💰',
    ...
    },
    {
      ...
      features: [
        'Kanban and Gantt viewsTime tracking integration',
        'Team collaboration toolsResource allocation',
        'Progress reportingFile sharing & storage',
        'Mobile app accessAPI integrations'
      ],
      popular: false,
      icon: '📋',
    ...
    },
    {
      ...
      features: [
        'Ticket management systemAI-powered response suggestions',
        'Knowledge base builderLive chat integration',
        'Customer satisfaction surveysSupport analytics',
        'Multi-language supportIntegration with popular platforms'
      ],
      popular: false,
      icon: '🔌',
    ...
    },
    {
      ...
      features: [
        'AI-powered video editingTemplate library (500+ templates)',
        'Automated caption generationMulti-format export',
        'Brand kit integrationCollaborative editing',
        'Analytics & performance trackingIntegration with social platforms'
      ],
      popular: true,
      icon: '🎬',
    ...
    },
    {
      ...
      features: [
        ...
        'Inventory optimizationRevenue forecasting',
        'A/B testing automationCustomer lifetime value analysis',
        'Multi-store managementIntegration with major platforms'
      ],
      popular: false,
      icon: '🛒',
    ...
    },
    {
      ...
      features: [
        'Applicant tracking systemEmployee onboarding automation',
        'Performance managementTime tracking & attendance',
        'Payroll integrationEmployee self-service portal',
        'Compliance monitoringAnalytics & reporting'
      ],
      popular: false,
      icon: '👥',
    ...
    },
    {
      ...
      features: [
        'Document template libraryAI-powered document review',
        'Compliance checkingElectronic signature integration',
        'Document version controlLegal research assistance',
        'Client portal accessIntegration with legal software'
      ],
      popular: false,
      icon: '⚖️',
    ...
    },
    {
      ...
      features: [
        'Real-time inventory trackingDemand forecasting',
        'Automated reorder pointsMulti-location management',
        'Barcode scanning integrationSupplier management',
        'Cost analysis & reportingMobile app access'
      ],
      popular: false,
      icon: '📦',
    ...
    },
    {
      ...
      features: [
        'Multi-channel ticket managementAI-powered response suggestions',
        'Knowledge base managementCustomer satisfaction surveys',
        'Performance analyticsTeam collaboration tools',
        'Integration with CRM systemsMobile app for agents'
      ],
      popular: false,
      icon: '🎧',
    ...
    },
    {
      ...
      features: [
        'Automated expense trackingBudget planning & monitoring',
        'Investment portfolio analysisFinancial goal setting',
        'Tax planning assistanceMulti-account aggregation',
        'Financial reportingMobile app with notifications'
      ],
      popular: false,
      icon: '📈',
      color: 'from-emerald-500 to-green-600',
    ...
    },
    {
      ...
      features: [
        'Course creation toolsInteractive assessments',
        'Progress trackingGamification elements',
        'Mobile learning supportAnalytics & reporting',
        'Integration with HR systemsWhite-label customization'
      ],
      popular: false,
      icon: '🎓',
    ...
    },
    {
      ...
      features: [
        'Property portfolio managementTenant screening & management',
        'Maintenance request trackingFinancial reporting',
        'Document managementMarket analysis tools',
        'Mobile app for tenantsIntegration with accounting software'
      ],
      popular: false,
      icon: '🏠',

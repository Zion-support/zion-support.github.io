...
const microSaasServices = [
  ...
  // New 2025 Micro SAAS Services
  {
    title: 'AI-Powered Social Media Content Generator',
    description: 'Generate viral social media content using advanced AI with trending hashtags and optimal posting times.',
    icon: Camera,
    features: ['AI content generation', 'Trending hashtag suggestions', 'Optimal posting times', 'Multi-platform scheduling', 'Brand voice customization', 'Performance analytics'],
    pricing: '$79/month',
    category: 'Social Media',
    benefits: ['Increase engagement by 60%', 'Save 10 hours per week', 'Viral content creation', 'Brand consistency'],
    marketPrice: '$50-200/month',
  ...
  },
  {
    ...
    description: 'Real-time data processing and analytics at the edge for IoT devices and low-latency applications.',
    icon: Cpu,
    features: ['Real-time data processing', 'IoT device management', 'Low-latency analytics', 'Edge AI inference', 'Distributed computing', 'Bandwidth optimization'],
    pricing: '$199/month',
    category: 'Edge Computing',
    benefits: ['Reduce latency by 80%', 'Lower bandwidth costs', 'Real-time insights', 'Improved performance'],
    marketPrice: '$150-500/month',
    link: 'https://ziontechgroup.com/edge-analytics',
    popular: true
  },
  {
    title: 'Quantum-Safe Password Vault',
    description: 'Future-proof password management with quantum-resistant encryption and zero-knowledge architecture.',
    icon: Shield,
    features: ['Quantum-resistant encryption', 'Zero-knowledge architecture', 'Biometric authentication', 'Dark web monitoring', 'Team sharing', 'Emergency access'],
    pricing: '$29/month',
    category: 'Security',
    benefits: ['Future-proof security', 'Military-grade encryption', 'Zero-trust architecture', 'Advanced threat protection'],
    marketPrice: '$20-60/month',
    link: 'https://ziontechgroup.com/quantum-password-vault',
    popular: true
  },
  {
    title: 'AI-Powered Expense Tracker for WhatsApp',
    description: 'Track expenses through WhatsApp with AI-powered receipt scanning and automated categorization.',
    icon: MessageSquare,
    features: ['WhatsApp integration', 'AI receipt scanning', 'Automatic categorization', 'Multi-currency support', 'Expense reports', 'Voice commands'],
    pricing: '$19/month',
    category: 'Finance',
    benefits: ['Track expenses on-the-go', '90% automation', 'Multi-language support', 'Instant expense reports'],
    marketPrice: '$15-40/month',
    link: 'https://ziontechgroup.com/whatsapp-expense-tracker',
    popular: true
  },
  {
    title: 'Mental Health Support AI Assistant',
    description: 'AI-powered mental health support with mood tracking, guided exercises, and crisis intervention.',
    icon: Heart,
    features: ['AI therapy sessions', 'Mood tracking', 'Crisis intervention', 'Guided meditation', 'Progress tracking', 'Professional referrals'],
    pricing: '$39/month',
    category: 'Health & Wellness',
    benefits: ['24/7 mental health support', 'Personalized care plans', 'Crisis prevention', 'Improved mental wellness'],
    marketPrice: '$30-100/month',
    link: 'https://ziontechgroup.com/ai-mental-health',
    popular: true
  },
  {
    title: 'Green Cloud Cost Optimizer',
    description: 'Optimize cloud costs while reducing carbon footprint with AI-powered sustainability analytics.',
    icon: TreePine,
    features: ['Carbon footprint tracking', 'Cost optimization', 'Green energy usage', 'Sustainability reporting', 'Carbon offset recommendations', 'ESG compliance'],
    pricing: '$149/month',
    category: 'Sustainability',
    benefits: ['Reduce carbon footprint by 40%', 'Lower cloud costs by 25%', 'ESG compliance', 'Sustainability reporting'],
    marketPrice: '$100-300/month',
    link: 'https://ziontechgroup.com/green-cloud-optimizer',
    popular: false
  },
  {
    title: 'No-Code AI Workflow Builder',
    description: 'Create AI-powered workflows without coding using drag-and-drop interface and pre-built AI components.',
    icon: Layers,
    features: ['Drag-and-drop builder', 'Pre-built AI components', 'Workflow automation', 'API integrations', 'Custom AI models', 'Team collaboration'],
    pricing: '$89/month',
    category: 'Automation',
    benefits: ['No coding required', 'Faster workflow creation', 'AI-powered automation', 'Easy team collaboration'],
  ...
  },
  {
    ...
    description: 'AI-powered voice customer support with natural language processing and multilingual capabilities.',
    icon: Mic,
    features: ['Natural language processing', 'Multilingual support', 'Voice analytics', 'Sentiment analysis', 'Call routing', 'Integration APIs'],
    pricing: '$199/month',
    category: 'Customer Service',
    benefits: ['95% customer satisfaction', '24/7 multilingual support', 'Reduced call center costs', 'Advanced analytics'],
    marketPrice: '$150-400/month',
    link: 'https://ziontechgroup.com/voice-customer-support',
    popular: true
  },
  {
    ...
    icon: FileText,
    features: ['Blockchain verification', 'Digital signatures', 'Document integrity', 'Identity verification', 'Audit trails', 'API integration'],
    pricing: '$79/month',
    category: 'Blockchain',
    benefits: ['100% document integrity', 'Tamper-proof verification', 'Reduced fraud', 'Compliance ready'],
    marketPrice: '$50-150/month',
    link: 'https://ziontechgroup.com/blockchain-verification',
    popular: false
  },
  {
    title: 'AI-Powered Local SEO Optimizer',
    description: 'Automated local SEO optimization with AI-driven content creation and local search ranking improvements.',
    icon: Search,
    features: ['Local keyword optimization', 'AI content generation', 'Google My Business management', 'Review management', 'Local backlink building', 'Competitor analysis'],
    pricing: '$99/month',
    category: 'SEO',
    benefits: ['Increase local visibility by 70%', 'Automated content creation', 'Better local rankings', 'Review management'],
  ...
  },
  {
    ...
    description: 'AI-powered inventory management with demand forecasting and automated reorder suggestions.',
    icon: Package,
    features: ['Demand forecasting', 'Automated reordering', 'Inventory optimization', 'Supplier management', 'Cost analysis', 'Integration APIs'],
    pricing: '$149/month',
    category: 'Inventory Management',
    benefits: ['Reduce stockouts by 80%', 'Lower inventory costs by 30%', 'Automated reordering', 'Better cash flow'],
    marketPrice: '$100-300/month',
  ...
  },
  {
    ...
    description: 'Augmented reality product visualization for e-commerce with 3D models and virtual try-on capabilities.',
    icon: Camera,
    features: ['3D product models', 'AR try-on', 'Virtual showroom', 'Mobile app integration', 'Analytics dashboard', 'Custom branding'],
    pricing: '$299/month',
    category: 'E-commerce',
    benefits: ['Increase conversions by 40%', 'Reduce returns by 25%', 'Enhanced customer experience', 'Mobile-first design'],
    marketPrice: '$200-600/month',
    link: 'https://ziontechgroup.com/ar-product-visualizer',
    popular: true
  },
  {
    title: 'AI-Powered Lead Nurturing',
    description: 'Intelligent lead nurturing with personalized email sequences and behavioral tracking.',
    icon: Mail,
    features: ['Behavioral tracking', 'Personalized sequences', 'A/B testing', 'Lead scoring', 'CRM integration', 'Analytics dashboard'],
    pricing: '$79/month',
    category: 'Marketing Automation',
    benefits: ['Increase lead conversion by 50%', 'Automated nurturing', 'Personalized experiences', 'Better lead quality'],
    marketPrice: '$50-150/month',
  ...
  },
  {
    ...
    description: 'AI-powered legal document generation with contract templates and automated compliance checking.',
    icon: FileText,
    features: ['Contract templates', 'AI generation', 'Compliance checking', 'Electronic signatures', 'Version control', 'Legal updates'],
    pricing: '$199/month',
    category: 'Legal Tech',
    benefits: ['Reduce legal costs by 60%', 'Faster contract creation', 'Compliance assurance', 'Automated updates'],
    marketPrice: '$150-400/month',
  ...
  },
  {
    ...
    description: 'Comprehensive IoT device management with real-time monitoring, updates, and security.',
    icon: Wifi,
    features: ['Device monitoring', 'Remote updates', 'Security management', 'Data collection', 'Alert system', 'Analytics dashboard'],
    pricing: '$249/month',
    category: 'IoT',
    benefits: ['Centralized device management', 'Improved security', 'Reduced downtime', 'Better insights'],
  ...
  },
  {
    ...
    description: 'Automated video editing with AI-powered scene detection, auto-cropping, and content optimization.',
    icon: Video,
    features: ['Auto-editing', 'Scene detection', 'Auto-cropping', 'Content optimization', 'Multi-format export', 'Cloud processing'],
    pricing: '$89/month',
    category: 'Video Production',
    benefits: ['Save 80% editing time', 'Professional results', 'Automated optimization', 'Multi-platform support'],
    marketPrice: '$60-200/month',
  ...
  },
  {
    ...
    icon: Droplets,
    features: ['Energy monitoring', 'Usage optimization', 'Cost analysis', 'Predictive maintenance', 'Renewable integration', 'Mobile app'],
    pricing: '$59/month',
    category: 'Energy Management',
    benefits: ['Reduce energy costs by 30%', 'Carbon footprint tracking', 'Predictive insights', 'Automated optimization'],

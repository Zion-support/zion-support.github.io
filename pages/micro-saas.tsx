...
export default function MicroSaaS() {
  ...
  const microSaaSServices = [
    ...
    },
    {
      ...
      description: 'Complete e-commerce solution with AI-powered product recommendations, inventory management, and customer analytics.',
      features: [
    ...
    },
    {
      ...
      description: 'Automated cybersecurity compliance monitoring and reporting system for various industry standards.',
      features: [

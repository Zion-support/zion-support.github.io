...
const microSaasSolutions = [
  {
    ...
    icon: FileText,
    features: ['AI Content GenerationSEO OptimizationSocial Media SchedulingAnalytics Dashboard', 'Multi-language SupportBrand Voice Training'],
    pricing: '$29 - $199/month',
    category: 'AI Marketing',
    popular: true,
    benefits: ['10x Content OutputSEO BoostTime SavingsBetter Engagement', 'Cost Reduction'],

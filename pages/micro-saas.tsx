...
const microSaasServices = [
  ...
  },
  {
    ...
    icon: Mic,
    features: ['Voice cloning technology', 'Text-to-speech synthesis', 'Multi-language support', 'Voice customization'],
    pricing: '$199/month',
    category: 'AI Content',
    benefits: ['Create personalized voice content', 'Accessibility improvements', 'Multilingual content creation'],
  ...
  },
  {
    ...
    description: 'AI-powered legal document generation with blockchain integration and compliance checking.',
    icon: FileText,
    features: ['AI document generation', 'Blockchain integration', 'Compliance checking', 'Template library'],
    pricing: '$299/month',
    category: 'Legal Tech',
    benefits: ['Reduce legal costs by 70%', 'Faster contract creation', 'Compliance assurance'],
  ...
  },
  {
    ...
    description: 'Augmented reality product visualization for e-commerce and marketing campaigns.',
    icon: Camera,
    features: ['AR product visualization', '3D model integration', 'Mobile app SDK', 'Analytics dashboard'],
    pricing: '$399/month',
    category: 'AR/VR',
    benefits: ['Increase conversion by 40%', 'Enhanced customer experience', 'Reduced returns'],
  ...
  },
  {
    ...
    icon: Code,
    features: ['Automated code review', 'Security vulnerability detection', 'Performance optimization', 'Best practices suggestions'],
    pricing: '$149/month',
    category: 'Dev Tools',
    benefits: ['Improve code quality', 'Reduce security risks', 'Faster development cycles'],
  ...
  },
  {
    ...
    icon: Settings,
    features: ['IoT sensor integration', 'Machine learning predictions', 'Alert system', 'Maintenance scheduling'],
    pricing: '$499/month',
  ...
  },
  {
    ...
    description: 'Intelligent resume creation with ATS optimization and job matching capabilities.',
    icon: FileText,
    features: ['ATS optimization', 'Job matching', 'Template library', 'Skills analysis'],
    pricing: '$29/month',
    category: 'Career Tools',
    benefits: ['Increase interview chances by 60%', 'ATS-friendly resumes', 'Professional templates'],
    marketPrice: '$20-80/month',
    link: 'https://ziontechgroup.com/contact',
    popular: true
  },
  {
    ...
    icon: Package,
    features: ['Demand forecasting', 'Automated reordering', 'Stock level optimization', 'Analytics dashboard'],
    pricing: '$199/month',
    category: 'E-commerce',
    benefits: ['Reduce inventory costs by 30%', 'Prevent stockouts', 'Optimize cash flow'],
  ...
  },
  {
    ...
    description: 'Real-time meeting transcription with AI-powered summaries and action item extraction.',
    icon: MessageSquare,
    features: ['Real-time transcription', 'AI summaries', 'Action item extraction', 'Multi-language support'],
    pricing: '$79/month',
    category: 'Productivity',
    benefits: ['Save 80% time on meeting notes', 'Never miss important details', 'Improved follow-up'],
    marketPrice: '$50-200/month',
    link: 'https://ziontechgroup.com/contact',
    popular: true
  },
  {
    ...
    description: 'Secure document notarization and verification using blockchain technology.',
    icon: Shield,
    features: ['Blockchain verification', 'Document integrity checking', 'Timestamping', 'Legal compliance'],
    pricing: '$99/month',
    category: 'Blockchain',
    benefits: ['Tamper-proof documents', 'Legal verification', 'Reduced fraud risk'],
  ...
  },
  {
    ...
    description: 'Create professional logos and brand assets using AI with unlimited variations.',
    icon: Image,
    features: ['AI logo generation', 'Brand guidelines', 'Multiple formats', 'Unlimited variations'],
    pricing: '$49/month',
    category: 'Design',
    benefits: ['Professional logos in minutes', 'Cost-effective branding', 'Unlimited iterations'],
    marketPrice: '$30-150/month',
    link: 'https://ziontechgroup.com/contact',
    popular: true
  },
  {
    ...
    icon: Zap,
    features: ['Real-time energy monitoring', 'Usage optimization', 'Cost analysis', 'Automated controls'],
    pricing: '$299/month',
    category: 'Energy & Sustainability',
    benefits: ['Reduce energy costs by 25%', 'Carbon footprint tracking', 'Automated optimization'],
    marketPrice: '$200-800/month',
    link: 'https://ziontechgroup.com/contact',
    popular: false
  },
  {
    ...
    icon: Heart,
    features: ['Multi-channel analysis', 'Real-time monitoring', 'Sentiment trends', 'Alert system'],
    pricing: '$199/month',
    category: 'Analytics',
    benefits: ['Improve customer satisfaction', 'Early issue detection', 'Data-driven decisions'],
    marketPrice: '$150-500/month',
    link: 'https://ziontechgroup.com/contact',
    popular: true
  },
  {
    ...
    description: 'AI-powered A/B testing with automatic optimization and statistical significance.',
    icon: Target,
    features: ['Automated test creation', 'Statistical analysis', 'Auto-optimization', 'Multi-variate testing'],
    pricing: '$149/month',
    category: 'Marketing',
    benefits: ['Increase conversion by 35%', 'Automated optimization', 'Data-driven decisions'],
    marketPrice: '$100-400/month',
    link: 'https://ziontechgroup.com/contact',
    popular: false
  },
  {
    ...
    description: 'Real-time fraud detection and prevention for e-commerce and financial transactions.',
    icon: Shield,
    features: ['Real-time monitoring', 'Machine learning models', 'Risk scoring', 'Automated blocking'],
    pricing: '$399/month',
    category: 'Security',
  ...
  },
  {
    ...
    benefits: ['Prevent smart contract exploits', 'Reduce audit costs', 'Automated security checks'],
    marketPrice: '$400-1500/month',
    link: 'https://ziontechgroup.com/contact',
    popular: false
  },
  {
    ...
    description: 'Advanced video analytics with object detection, behavior analysis, and insights.',
    icon: Video,
    features: ['Object detection', 'Behavior analysis', 'Real-time alerts', 'Analytics dashboard'],
    pricing: '$299/month',
    category: 'Video Analytics',
    benefits: ['Enhanced security monitoring', 'Business intelligence', 'Automated insights'],
    marketPrice: '$200-800/month',
    link: 'https://ziontechgroup.com/contact',
    popular: false
  },
  {
    ...
    pricing: '$79/month',
    category: 'Smart Home',
    benefits: ['Convenient home control', 'Energy savings', 'Enhanced security'],
    marketPrice: '$50-200/month',
    link: 'https://ziontechgroup.com/contact',
    popular: true
  },
  {
    ...
    icon: Globe,
    features: ['Real-time translation', 'Context awareness', 'Industry terminology', 'Multi-language support'],
    pricing: '$99/month',
    category: 'Language Services',
    benefits: ['Break language barriers', 'Professional translations', 'Real-time communication'],
    marketPrice: '$75-300/month',
    link: 'https://ziontechgroup.com/contact',
    popular: true
  },
  {
    ...
    description: 'Continuous compliance monitoring and reporting for various industry regulations.',
    icon: CheckCircle,
    features: ['Regulatory monitoring', 'Automated reporting', 'Risk assessment', 'Audit trails'],
    pricing: '$399/month',
    category: 'Compliance',
    benefits: ['Reduce compliance costs', 'Automated reporting', 'Risk mitigation'],
    marketPrice: '$300-1000/month',
    link: 'https://ziontechgroup.com/contact',
    popular: false
  }

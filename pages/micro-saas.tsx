...
const microSaasServices = [
  ...
  },
  {
    ...
    description: '24/7 mental health support with AI-powered mood tracking, therapy sessions, and crisis intervention.',
    icon: Heart,
    features: ['Mood Tracking', 'AI Therapy Sessions', 'Crisis Detection', 'Professional Referrals'],
  ...
  },
  {
    ...
    description: 'IoT-powered waste monitoring and optimization for cities and businesses.',
    icon: Package,
    features: ['Fill Level Monitoring', 'Route Optimization', 'Recycling Analytics', 'Cost Reduction'],
    pricing: '$199 - $1,299/month',
  ...
  },
  {
    ...
    icon: Globe,
    features: ['AI Tutoring', 'Conversation Practice', 'Progress Tracking', 'Cultural Context'],
    pricing: '$19 - $99/month',
    category: 'EdTech',
    popular: true
  },
  {
    ...
    description: 'Secure, transparent voting system with blockchain verification and audit trails.',
    icon: Vote,
    features: ['Secure Voting', 'Audit Trails', 'Real-time Results', 'Identity Verification'],
    pricing: '$299 - $1,999/month',
    category: 'Blockchain & Governance',
    popular: true
  },
  {
    ...
    description: 'Personalized sleep analysis and optimization using AI and wearable data.',
    icon: Clock,
    features: ['Sleep Analysis', 'Personalized Recommendations', 'Wearable Integration', 'Progress Tracking'],
    pricing: '$9 - $49/month',
    category: 'HealthTech',
    popular: true
  },
  ...
  },
  {
    ...
    description: 'Personalized recipe creation based on dietary preferences, ingredients, and nutritional goals.',
    icon: Heart,
    features: ['Dietary Preferences', 'Ingredient Substitution', 'Nutritional Analysis', 'Shopping Lists'],
    pricing: '$9 - $49/month',
    category: 'FoodTech',
    popular: true
  },
  {
    ...
    description: 'Transparent carbon credit marketplace with blockchain verification and automated trading.',
    icon: Sprout,
    features: ['Carbon Credit Trading', 'Blockchain Verification', 'Automated Trading', 'Impact Tracking'],
  ...
  },
  {
    ...
    description: 'Comprehensive pet health monitoring and care recommendations using AI and IoT.',
    icon: Heart,
    features: ['Health Monitoring', 'Behavioral Analysis', 'Vet Recommendations', 'Medication Reminders'],
    pricing: '$19 - $99/month',
    category: 'PetTech',
    popular: true
  },
  {
    ...
    description: 'Real-time water quality monitoring and contamination detection for homes and businesses.',
    icon: Droplets,
    features: ['Real-time Monitoring', 'Contamination Detection', 'Quality Reports', 'Alert System'],
    pricing: '$99 - $599/month',
  ...
  },
  {
    ...
    description: 'Virtual personal styling assistant with outfit recommendations and shopping integration.',
    icon: ShoppingBag,
    features: ['Style Analysis', 'Outfit Recommendations', 'Shopping Integration', 'Trend Tracking'],
    pricing: '$19 - $99/month',
    category: 'FashionTech',
    popular: true
  },
  {
    title: 'Blockchain Intellectual Property Registry',
    description: 'Secure IP registration and protection using blockchain technology with automated enforcement.',
    icon: FileText,
    features: ['IP Registration', 'Blockchain Proof', 'Automated Enforcement', 'Licensing Management'],
  ...
  },
  {
    ...
    description: 'Real-time noise monitoring and analysis for urban planning and health protection.',
    icon: Mic,
    features: ['Noise Monitoring', 'Health Impact Analysis', 'Urban Planning Data', 'Alert System'],
    pricing: '$199 - $1,299/month',
    category: 'Environmental Tech',
    popular: true
  },
  {
    title: 'Smart Elderly Care Platform',
    description: 'Comprehensive elderly care monitoring with fall detection, medication reminders, and family alerts.',
    icon: Heart,
    features: ['Fall Detection', 'Medication Reminders', 'Family Alerts', 'Health Monitoring'],
    pricing: '$49 - $299/month',
    category: 'HealthTech',
    popular: true
  },
  {
    ...
    description: 'Personalized micro-learning with bite-sized content and adaptive difficulty.',
    icon: BookOpen,
    features: ['Micro-Learning', 'Adaptive Difficulty', 'Progress Tracking', 'Gamification'],
    pricing: '$9 - $49/month',
    category: 'EdTech',
    popular: true
  },
  {
    ...
    description: 'Automated supply chain financing with smart contracts and risk assessment.',
    icon: DollarSign,
    features: ['Smart Contracts', 'Risk Assessment', 'Automated Payments', 'Supply Chain Tracking'],
    pricing: '$299 - $1,999/month',
    category: 'FinTech',
    popular: true
  },
  {
    title: 'AI-Powered Air Quality Predictor',
    description: 'Predictive air quality analysis with health recommendations and pollution source tracking.',
    icon: Wind,
    features: ['Air Quality Prediction', 'Health Recommendations', 'Source Tracking', 'Alert System'],
    pricing: '$99 - $599/month',
    category: 'Environmental Tech',
    popular: true
  },
  {
    ...
    description: 'AI-optimized home energy storage with solar integration and grid balancing.',
    icon: Battery,
    features: ['Energy Storage', 'Solar Integration', 'Grid Balancing', 'Cost Optimization'],
    pricing: '$199 - $1,299/month',
    category: 'EnergyTech',
    popular: true
  },
  {
    ...
    description: 'Real-time accessibility improvements for websites and applications with automated testing.',
    icon: Eye,
    features: ['Accessibility Testing', 'Real-time Improvements', 'Compliance Checking', 'User Experience'],
    pricing: '$99 - $599/month',
    category: 'Accessibility Tech',
    popular: true
  },
  {
    title: 'Blockchain Digital Identity Wallet',
    description: 'Self-sovereign digital identity with privacy protection and selective disclosure.',
    icon: Lock,
    features: ['Self-Sovereign Identity', 'Privacy Protection', 'Selective Disclosure', 'Cross-Platform Use'],
    pricing: '$19 - $99/month',
    category: 'Identity & Security',
    popular: true
  }
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Get in touch with our experts to discuss your micro SaaS needs. We offer free consultations 
              and custom solutions tailored to your business requirements.
            </p>

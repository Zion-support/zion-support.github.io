...
const microSaasSolutions = [
  ...
  },
  {
    id: 121,
    title: 'Quantum-Safe Security Platform',
    description: 'Next-generation cybersecurity platform using quantum-resistant encryption and advanced threat detection.',
    icon: Lock,
    features: ['Quantum-Resistant Encryption', 'Advanced Threat Detection', 'Zero-Trust Architecture', 'Real-time Monitoring', 'Automated Response', 'Compliance Ready'],
    pricing: '$299 - $1,499/month',
    category: 'Quantum Security',
    popular: true,
    benefits: ['Future-proof security', '99.99% threat detection', 'Zero false positives', 'Regulatory compliance'],
  ...
  },
  {
    ...
    description: 'Advanced climate data analysis and environmental impact assessment platform for businesses.',
    icon: Leaf,
    features: ['Carbon Footprint Tracking', 'Environmental Impact Analysis', 'Sustainability Reporting', 'Climate Risk Assessment', 'ESG Compliance', 'Green Energy Optimization'],
    pricing: '$199 - $899/month',
    category: 'Climate Tech',
    popular: true,
    benefits: ['Reduce carbon footprint by 40%', 'ESG compliance', 'Cost savings', 'Brand reputation'],
    marketPrice: '$350 - $1,500/month',
    link: 'https://ziontechgroup.com/climate-analytics',
    contact: '+1 302 464 0950'
  },
  {
    id: 123,
    title: 'Space Technology Integration Suite',
    description: 'Satellite data integration and space-based analytics platform for earth observation and communication.',
    icon: Rocket,
    features: ['Satellite Data Processing', 'Earth Observation Analytics', 'Space Communication', 'Orbital Tracking', 'Weather Prediction', 'Geospatial Analysis'],
    pricing: '$499 - $2,499/month',
    category: 'Space Tech',
    popular: false,
    benefits: ['Real-time satellite data', 'Global coverage', 'Weather insights', 'Geospatial intelligence'],
    marketPrice: '$800 - $4,000/month',
    link: 'https://ziontechgroup.com/space-technology-suite',
    contact: '+1 302 464 0950'
  },
  {
    id: 124,
    title: 'Autonomous Vehicle Fleet Management',
    description: 'AI-powered fleet management system for autonomous vehicles with real-time monitoring and optimization.',
    icon: Car,
    features: ['Fleet Monitoring', 'Route Optimization', 'Predictive Maintenance', 'Safety Analytics', 'Performance Tracking', 'Remote Control'],
    pricing: '$399 - $1,999/month',
    category: 'Autonomous Systems',
    popular: true,
    benefits: ['30% fuel savings', 'Reduced accidents', 'Optimized routes', 'Lower maintenance costs'],
    marketPrice: '$650 - $3,200/month',
    link: 'https://ziontechgroup.com/autonomous-fleet-management',
    contact: '+1 302 464 0950'
  },
  {
    id: 125,
    ...
    icon: Heart,
    features: ['Molecular Analysis', 'Drug Interaction Prediction', 'Clinical Trial Optimization', 'Side Effect Analysis', 'Patent Research', 'Regulatory Compliance'],
    pricing: '$999 - $4,999/month',
    category: 'Healthcare AI',
    popular: false,
    benefits: ['Faster drug discovery', 'Reduced R&D costs', 'Higher success rates', 'Regulatory compliance'],
    marketPrice: '$1,500 - $8,000/month',
  ...
  },
  {
    ...
    description: 'Advanced blockchain transaction analysis and regulatory compliance platform for cryptocurrency and DeFi.',
    icon: Network,
    features: ['Transaction Analysis', 'Compliance Monitoring', 'Risk Assessment', 'KYC/AML Automation', 'Tax Reporting', 'Regulatory Alerts'],
    pricing: '$299 - $1,299/month',
    category: 'Blockchain',
    popular: true,
    benefits: ['Regulatory compliance', 'Risk mitigation', 'Automated reporting', 'Transaction transparency'],
    marketPrice: '$500 - $2,200/month',
  ...
  },
  {
    ...
    description: 'Distributed AI processing platform for edge devices with real-time inference and data processing.',
    icon: Cpu,
    features: ['Edge AI Processing', 'Real-time Inference', 'Data Synchronization', 'Device Management', 'Performance Optimization', 'Security Monitoring'],
    pricing: '$199 - $999/month',
    category: 'Edge Computing',
    popular: true,
    benefits: ['Reduced latency', 'Lower bandwidth costs', 'Real-time processing', 'Enhanced privacy'],
    marketPrice: '$350 - $1,600/month',
  ...
  },
  {
    ...
    description: 'Immersive business applications using augmented and virtual reality for training, collaboration, and customer engagement.',
    icon: Eye,
    features: ['Virtual Training', 'Remote Collaboration', '3D Visualization', 'Interactive Demos', 'Virtual Showrooms', 'Immersive Analytics'],
    pricing: '$399 - $1,899/month',
    category: 'AR/VR',
    popular: false,
    benefits: ['Enhanced engagement', 'Remote collaboration', 'Immersive training', 'Better visualization'],
    marketPrice: '$650 - $3,000/month',
    link: 'https://ziontechgroup.com/ar-vr-solutions',
    contact: '+1 302 464 0950'
  },
  {
    id: 129,
    title: 'AI-Powered IoT Management',
    description: 'Comprehensive IoT device management platform with AI-driven insights and automated optimization.',
    icon: Wifi,
    features: ['Device Management', 'Data Analytics', 'Predictive Maintenance', 'Energy Optimization', 'Security Monitoring', 'Automated Updates'],
    pricing: '$149 - $799/month',
    category: 'IoT',
    popular: true,
    benefits: ['Reduced maintenance costs', 'Energy savings', 'Predictive insights', 'Automated management'],
    marketPrice: '$250 - $1,300/month',
  ...
  },
  {
    ...
    description: 'Advanced content moderation platform using AI to detect and filter inappropriate content across multiple platforms.',
    icon: Shield,
    features: ['Content Detection', 'Multi-language Support', 'Real-time Moderation', 'Custom Rules', 'Analytics Dashboard', 'API Integration'],
    pricing: '$199 - $999/month',
    category: 'Content Moderation',
    popular: true,
    benefits: ['99.9% accuracy', 'Real-time processing', 'Reduced manual work', 'Scalable moderation'],
    marketPrice: '$350 - $1,600/month',
  ...
  },
  {
    ...
    description: 'AI-powered energy optimization platform for buildings, factories, and smart grids with real-time monitoring.',
    icon: Zap,
    features: ['Energy Monitoring', 'Consumption Optimization', 'Renewable Integration', 'Demand Response', 'Cost Analysis', 'Carbon Tracking'],
    pricing: '$299 - $1,499/month',
    category: 'Energy Tech',
    popular: true,
    benefits: ['30% energy savings', 'Carbon reduction', 'Cost optimization', 'Renewable integration'],
    marketPrice: '$500 - $2,500/month',
  ...
  },
  {
    ...
    description: 'End-to-end supply chain management with AI-driven demand forecasting, inventory optimization, and logistics planning.',
    icon: Truck,
    ...
    popular: true,
    benefits: ['20% cost reduction', 'Improved efficiency', 'Risk mitigation', 'Better planning'],
    marketPrice: '$650 - $3,200/month',
  ...
  },
  {
    ...
    description: 'Intelligent legal research platform with case law analysis, contract review, and legal document automation.',
    icon: FileText,
    features: ['Case Law Analysis', 'Contract Review', 'Legal Research', 'Document Automation', 'Compliance Checking', 'Precedent Analysis'],
    pricing: '$299 - $1,299/month',
    category: 'Legal Tech',
    popular: false,
    benefits: ['Faster research', 'Reduced costs', 'Better accuracy', 'Time savings'],
    marketPrice: '$500 - $2,200/month',
  ...
  },
  {
    ...
    icon: Home,
    features: ['Property Valuation', 'Market Analysis', 'Investment Insights', 'Trend Prediction', 'Risk Assessment', 'Portfolio Management'],
    pricing: '$199 - $899/month',
    category: 'Real Estate Tech',
    popular: true,
    benefits: ['Better valuations', 'Market insights', 'Investment guidance', 'Risk assessment'],
    marketPrice: '$350 - $1,500/month',
  ...
  },
  {
    ...
    description: 'Advanced gaming analytics platform with player behavior analysis, monetization optimization, and performance insights.',
    icon: Gamepad2,
    features: ['Player Analytics', 'Monetization Optimization', 'Performance Monitoring', 'A/B Testing', 'Fraud Detection', 'Engagement Analysis'],
    pricing: '$299 - $1,499/month',
    category: 'Gaming Tech',
    popular: false,
    benefits: ['Increased revenue', 'Better engagement', 'Fraud prevention', 'Performance insights'],
    marketPrice: '$500 - $2,500/month',
    link: 'https://ziontechgroup.com/gaming-analytics',
    contact: '+1 302 464 0950'
  }
];

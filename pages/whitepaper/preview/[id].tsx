...
export default function WhitepaperPreview() {
  ...
  useEffect(() => {
    if (!id || Array.isArray(id)) return,    // Simple client fetch from a volatile in-memory store endpoint (for demo we echo in query)
  ...
  return (
    <div className=&quot;container mx-auto px-4 py-6&quot;>
      <h1 className=&quot;text-xl font-semibold mb-4&quot;>Whitepaper Preview</h1>
      <pre className=&quot;whitespace-pre-wrap text-sm leading-6&quot;>{markdown}</pre>    </div>
  )

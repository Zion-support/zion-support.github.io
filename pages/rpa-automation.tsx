...
import { Bot, Zap, Settings, CheckCircle, ArrowRight, Phone, Mail, MapPin, DollarSign, Clock, Award, Users, Target, Cloud, FileText, Database, Shield, Cpu, Workflow, MessageSquare, Brain } from 'lucide-react'
...
const automationServices = [
  {
    id: 1, , ;
    icon: Bot, category: 'RPA', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-20, 000/month', ;
    setupTime: '2-4 weeks', features: [
      'Process discovery & analysis', 'Bot development & deployment', ;
    ...
    benefits: ['Reduce processing time by 80-90%', 'Eliminate human errors by 95%', ;
      'Achieve 24/7 operation', ;
      'Free up employees for higher-value work'], ;
    targetUsers: 'Finance, HR, Customer Service, Operations' },;
  {
    id: 2, , ;
    icon: FileText, category: 'Document Processing', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-30, 000/month', ;
    setupTime: '3-6 weeks', features: ['OCR & text extraction', 'Document classification', ;
    ...
    benefits: ['Process 10, 000+ documents per hour', ;
  ...
  {
    id: 3, , ;
    icon: Workflow, category: 'Workflow', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-25, 000/month', ;
    setupTime: '4-8 weeks', features: ['Process mapping & optimization', 'Workflow design & implementation', ;
      'Approval automation', ;
    ...
    benefits: ['Reduce process completion time by 60%', 'Improve process visibility by 100%', ;
      'Eliminate bottlenecks', ;
      'Ensure consistent process execution'], ;
    targetUsers: 'Operations, HR, Finance, Project Management' },;
  {
    id: 4, , ;
    icon: MessageSquare, category: 'Conversational AI', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-15, 000/month', ;
    setupTime: '2-4 weeks', features: ['Natural language processing', 'Multi-channel support(web, mobile, voice)', ;
    ...
    benefits: ['Handle 80% of customer inquiries automatically', 'Reduce response time by 90%', ;
      'Improve customer satisfaction by 40%', ;
      'Reduce support costs by 60%'], ;
    targetUsers: 'Customer Service, E-commerce, Healthcare, Education' },;
  {
    id: 5, , ;
    icon: Database, category: 'Data Processing', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-28, 000/month', ;
    setupTime: '3-6 weeks', features: ['Data extraction from multiple sources', 'Data transformation & cleansing', ;
    ...
    benefits: ['Process data 10x faster', 'Improve data quality by 95%', ;
  ...
  {
    id: 6, , ;
    icon: Mail, category: 'Communication', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-12, 000/month', ;
    setupTime: '1-3 weeks', features: ['Email classification & routing', 'Automated response generation', ;
    ...
    benefits: ['Reduce email processing time by 70%', 'Improve response consistency', ;
      'Automate routine communications', ;
      'Enhance email security'], ;
    targetUsers: 'Sales, Customer Service, HR, Operations' },;
  {
    id: 7, , ;
    icon: DollarSign, category: 'Finance', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-40, 000/month', ;
    setupTime: '4-8 weeks', features: ['Invoice processing & approval', 'Payment reconciliation', ;
  ...
  {
    id: 8, , ;
    icon: Users, category: 'HR', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-24, 000/month', ;
    setupTime: '3-6 weeks', features: ['Resume screening & candidate matching', 'Interview scheduling automation', ;
    ...
    benefits: ['Reduce HR processing time by 70%', 'Improve candidate experience', ;
...
const industries = [
  { , ;
    icon: "🏦", useCases: ["Loan processing", "Compliance reporting", "Customer onboarding", "Fraud detection"] },;
  { , ;
    icon: "🏥", useCases: ["Patient scheduling", "Insurance processing", "Medical records", "Billing automation"] },;
  { , ;
    icon: "🏭", useCases: ["Inventory management", "Quality control", "Order processing", "Supply chain"] },;
  { , ;
    icon: "🛒", useCases: ["Order processing", "Customer service", "Inventory management", "Returns processing"] },;
  { , ;
    icon: "🛡️", useCases: ["Claims processing", "Underwriting", "Policy management", "Customer service"] },;
  { , ;
    icon: "🏠", useCases: ["Property listings", "Lead management", "Document processing", "Client communication"] }]

const technologies = [{
    name: "UiPath", description: "Leading RPA platform for enterprise automation", icon: Bot }, ;
  {
    name: "Automation Anywhere", description: "Cloud-native RPA with AI capabilities", icon: Cloud }, ;
  {
    name: "Blue Prism", description: "Digital workforce platform", icon: Cpu }, ;
  {
    name: "Microsoft Power Automate", description: "Low-code automation platform", icon: Zap }, ;
  {
    name: "IBM Watson", description: "AI-powered automation solutions", icon: Brain }, ;
  {
    name: "Custom Solutions", description: "Tailored automation for specific needs", icon: Settings }]
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl md:text-2xl mb-8 text-purple-100">
                Transform your business with intelligent automation solutions. From RPA to AI-powered chatbots, we automate repetitive tasks and streamline processes to boost efficiency and reduce costs.;
              </p>

  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet></////Helmet>
        <title>{service.name} - Zion Tech Group</title><//title><///title><////title></////title><//////title>
      ...
      <section className="py-8 bg-slate-800/30">"
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"
          <div className="flex items-center space-x-2 text-sm">"
            ...
            <span className="text-gray-500">/</span>"
            <span className="text-white">{service.name}</span><//span><///span><////span></////span><//////span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12"></div>"
            <div>"
              <div className="flex items-center space-x-3 mb-6">"
                ...
                <div>"
                  <span className="text-purple-400 font-medium">{service.category}</span><//span>"
                  {service.popular && ("
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6"></h1><//h1><///h1>"
                {service.name}"
              </h1><//h1>"

              <p className="text-xl text-gray-300 mb-8"></p><//p><///p>"
                {service.description}"
              </p><//p>"
              ...
              <div className="flex items-center space-x-6 mb-8">"
                <div className="flex items-center space-x-2">"
                  ...
                  <span className="text-gray-400">({service.clients} clients)</span><//span>"
                </div>"
                <div className="flex items-center space-x-2">"
                  <Users className="w-5 h-5 text-purple-400" />"
                  <span className="text-gray-300">Trusted by {service.clients}+ businesses</span><//span><///span><////span>"
                </div><//div><///div>"
              </div><//div>"

              <div className="text-4xl font-bold text-white mb-8"></div>"
                {service.price}"
                <span className="text-lg text-gray-400 font-normal">/month</span><//span><///span>"
              </div><//div>"

              <div className="flex flex-col sm:flex-row gap-4"></div><//div><///div><////div></////div>
                <a;";,
                  href="/contact;";
              ...
              <div className="space-y-4"></div><//div><///div><////div></////div>
                ...
                >"
                  ...
                  <div>"
                    ...
                    <div className="text-gray-300 text-sm">+1 302 464 0950</div><//div><///div><////div></////div><//////div>
                  </div><//div><///div><////div></////div><//////div>
                </a><//a><///a><////a></////a><//////a>
                ...
                >"
                  ...
                  <div>"
                    ...
                    <div className="text-gray-300 text-sm">kleber@ziontechgroup.com</div><//div><///div><////div></////div><//////div>
                  </div><//div><///div><////div></////div><//////div>
                </a><//a><///a><////a></////a><//////a>
                ...
                >"
                  ...
                  <div>"
                    ...
                    <div className="text-gray-300 text-sm">Available 24/7</div><//div><///div><////div></////div><//////div>
                  </div><//div><///div><////div></////div><//////div>
                </a><//a><///a><////a></////a><//////a>
              </div><//div><///div><////div></////div><//////div>
            </div><//div><///div><////div></////div><//////div>
              ...
              <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">"
                <div className="flex items-center space-x-3 mb-4">"
                  ...
                  <div>"
                    ...
                    <span className="text-sm text-purple-400">{relatedService.category}</span><//span><///span>"
                  </div><//div>"
                </div>"
                <div className="text-2xl font-bold text-white mb-4">{relatedService.price}</div><//div><///div><////div></////div><//////div>
                <Link;";,
                  to="/services;";

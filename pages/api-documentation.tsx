 ...
 */;
function APIDocumentationPage() {return (<Layout>;
      <Head>;
        <title > API Documentation | Zion Tech Group</title>;
        <link;
          rel='canonical';
...
import Head from 'next/head';
import Layout from '../components/layout/Layout';
export default function APIDocumentationPage() {return (<Layout>;
      <Head>;
        <title>API Documentation | Zion Tech Group</title>;
        <link;
          rel='canonical';
...
import React from 'react',import Head from 'next/head',import Layout from '../components/layout/Layout',export default function APIDocumentationPage() {return (<Layout>;
			<Head>;
				<title>API Documentation | Zion Tech Group</title>;
	...
	)export default function APIDocumentationPage() {try {return (<Layout>;
			<Head>;
				<title>API Documentation | Zion Tech Group</title>;
				<link rel="canonical" href="https: //ziontechgroup.com/api-documentation" />;
			</Head>;
	...
	)} catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })class ErrorBoundary extends React.Component {constructor(props) {super(props)this.state = { hasError: false }}

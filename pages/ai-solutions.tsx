...
import { Brain, Zap, Target, BarChart3, ArrowRight, CheckCircle, Star, Users, Award, Phone, Mail, MapPin } from 'lucide-react';
...
const solutions = [
  {
    ...
    icon: Brain,
    features: ["Predictive Analytics", "Recommendation Engines", "Automated Decision Making", "Pattern Recognition"]
  },
  {
  ...
  },
  {
    ...
    description: "Text analysis, chatbots, and language understanding for better customer engagement",
    icon: Zap,
    features: ["Chatbots", "Sentiment Analysis", "Text Classification", "Language Translation"]
  },
  {
    title: "Business Intelligence",
    description: "AI-powered analytics and reporting for data-driven business decisions",
    icon: BarChart3,
    features: ["Data Visualization", "Predictive Analytics", "Automated Reporting", "Trend Analysis"]
  }
];

const industries = [
  "Healthcare", "Finance", "E-commerce", "Manufacturing", "Retail", "Education", "Transportation", "Energy"
];

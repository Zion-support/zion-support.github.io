...
const Blog: NextPage = () => {
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: 'A comprehensive guide to migrating your infrastructure to the cloud with best practices and common pitfalls to avoid.',
      author: 'Michael Chen',
      date: '2024-01-10',
      readTime: '8 min read',
    ...
    },
    {
      ...
      excerpt: 'Learn about the latest web development frameworks and how to build applications that scale with your business growth.',
      author: 'David Kim',
      date: '2024-01-05',
      readTime: '6 min read',
    ...
    },
    {
      ...
      excerpt: 'Stay ahead of emerging cybersecurity threats with insights into the latest trends and protection strategies.',
    ...
    },
    {
      ...
      excerpt: 'Explore how edge computing is revolutionizing IoT deployments and enabling real-time data processing.',
    ...
    },
    {
      ...
      excerpt: 'Understanding how blockchain is being integrated into business processes beyond cryptocurrency.',
      author: 'Lisa Wang',
      date: '2023-12-15',
      readTime: '9 min read',
      category: 'Blockchain',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              Insights, trends, and expert perspectives on technology, AI, cloud computing, 
              and digital transformation to help you stay ahead of the curve.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">
            Subscribe to our newsletter to receive the latest technology trends, 
            industry insights, and expert tips delivered to your inbox.
          </p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { name: 'Artificial Intelligence', count: '15 articles', icon: '🤖' },

        ...
        <div className="container mx-auto px-4">;
          <div className="flex justify-between items-center mb-12">;
            ...
            <div className="flex gap-2">;
              {categories.slice(0, 5).map((((((((category, index, index, index, index, index, index, index) => ({ ...((((((category, index, index, index, index, index, index, key: index })) => ({ ...(((((category, index, index, index, index, index, key: index })) => ({ ...((((category, index, index, index, index, key: index })) => ({ ...(((category, index, index, index, key: index })) => ({ ...((category, index, index, key: index })) => ({ ...(category, index, key: index })) => (;
                <button;
                  key={index};
...
;
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {blogPosts.slice(1).map((((((((post, index, index, index, index, index, index, index) => ({ ...((((((post, index, index, index, index, index, index, key: index })) => ({ ...(((((post, index, index, index, index, index, key: index })) => ({ ...((((post, index, index, index, index, key: index })) => ({ ...(((post, index, index, index, key: index })) => ({ ...((post, index, index, key: index })) => ({ ...(post, index, key: index })) => (;
                  ...
                  <div className="flex items-center justify-between">;
                    <div className="flex items-center">;
                      <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center text-white text-xs font-semibold">;
                        {post.author.split(' ').map(((((((n => n[0], index, index, index, index, index, index) => ({ ...(((((n => n[0], index, index, index, index, index, key: index })) => ({ ...((((n => n[0], index, index, index, index, key: index })) => ({ ...(((n => n[0], index, index, index, key: index })) => ({ ...((n => n[0], index, index, key: index })) => ({ ...(n => n[0], index, key: index })) => ({ ...n => n[0], key: index })).join('')};
                      </div>;
                      <div className="ml-2">;

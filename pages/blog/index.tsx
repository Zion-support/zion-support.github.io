...
;
  {slug: 'ai-automation-trends-2025',title: 'AI Automation Trends 2025',excerpt:;
  ...
  },{slug: 'ai-ethics-automation',title: 'AI Ethics & Automation',excerpt:;
...
];export default function BlogIndexPage() {return (<UltraFuturisticBackground intensity='medium'>;
      <Head>;
...
export default function BlogIndexPage() {return (<UltraFuturisticBackground  intensity="medium">;
      ...
      <div className="container mx-auto px-4 py-16">;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">;
          {posts.map((p) => (<div key={p.slug} className="p-6 bg-black/40 border border-gray-700/50 hover:border-cyan-500/40 transition-colors p-6 bg-black/40 border border-gray-700/50 rounded-lg backdrop-blur-sm">;

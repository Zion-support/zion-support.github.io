...
const BlogPostPage: React.FC<BlogPostPageProps> = ({ initialPost }) =></BlogPostPageProps> {
  const router = useRouter(),
  const { slug } = router.query,
  const [post, setPost] = React.useState<BlogPost | null>(initialPost),
  const [error, setError] = React.useState<string | null>(null),

  R</string>eact.useEffect(() => {
        ...
        <div className="flex items-center gap-3 mb-6">
          <img
            ...
            onError={(e) => {
              ...
              target.src = '/images/blog-placeholder.svg'</img>,
            }}
          />
          <div>
        ...
        {post.featuredImage && (
          <div className="aspect-[16/9] w-full relative overflow-hidden rounded-lg mb-6">
            <img
              ...
              onError={(e) => {
                const target = e.currentTarget as HTMLImageElement,
                target.src = '/images/blog-placeholder.sv</img>g',
              }}
            />
          </div>
        )}

...
ursor/integrate-build-improve-and-re-verify-b76c
              ...
              <div className="flex gap-4 items-center">
                <select
                  ...
                  className="px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-white focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 transition-all duration-300"><option value="name">Sort by Name</option>
...
ursor/integrate-build-improve-and-re-verify-b76c
                  <button
                    ...
                    className={`p-2 rounded ${viewMode === 'grid' ? 'bg-cyan-500 text-black' : 'text-gray-400 hover:text-white'}`}><Grid className='w-5 h-5' />
...
ursor/integrate-build-improve-and-re-verify-b76c
                  ...
                  <button
                    ...
                    className={`p-2 rounded ${viewMode === 'list' ? 'bg-cyan-500 text-black' : 'text-gray-400 hover:text-white'}`}><List className='w-5 h-5' />
...
ursor/integrate-build-improve-and-re-verify-b76c
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className={viewMode === 'grid' ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8' : 'space-y-6'}
ursor/integrate-build-improve-and-re-verify-b76c>{sortedServices.map((service, index) => (
              <motion.div
                key={service.id}
                    ...
                    <div>
                      ...
                      <div className='grid grid-cols-1 gap-1'>
                        {service.features.slice(0, 4).map((feature, idx) => (
                          <div
                            key={idx}
                            className='flex items-center gap-2 text-sm text-gray-400'><div className='w-1.5 h-1.5 bg-cyan-400 rounded-full' />
...
ursor/integrate-build-improve-and-re-verify-b76c
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}><h2 className='text-3xl md:text-4xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent'>

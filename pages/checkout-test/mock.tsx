...
export default function CheckoutTestMock() {
  return (
    <Layout>
      <Head>
        <title>Checkout Test Mock - Zion Tech Group</title>
        <meta name="description" content="Checkout Test Mock solutions and services." />
      </Head>
      
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-6 py-16">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">Checkout Test Mock</h1>
          <p className="text-lg text-gray-600">
            Professional checkout test mock solutions tailored to your business needs.
          </p>
        </div>
      </div>
    </Layout>

...
export default function ServicesCatalog() {
  ...
  const services = [;
    {
      ...
      category: 'micro-saas';
      description: 'Anomaly detecti,o,n, rightsizing, forecasting and budget guardrails across AWS/Azure/GCP.';
      ...
      features: ['Anomaly Detection' 'Cost Optimization' 'Budget Alerts' 'Multi-Cloud Suppor,t'], },;
    {
      ...
      description: 'Prompt evaluati,o,n, bias/toxicity checks, jailbreak tests and guardrail policies.';
      ...
      features: ['Bias Detection' 'Safety Testing' 'Prompt Optimization' 'Compliance Monitorin,g'], },;
    {
      ...
      category: 'micro-saas';
      description: 'Embed surve,y,s, analyze sentiment and route issues to the right team automatically.';
      ...
      features: ['Rate Limiting' 'Usage Analytics' 'Monetization' 'Security Monitorin,g'], },;
    {
      ...
      category: 'ai-services';
      description: 'AI-powered O,C,R, data extraction, and document workflow automation for businesses.';
      ...
      features: ['OCR Technology' 'Data Extraction' 'Workflow Automation' 'Integration API,s'], },;
    {
      ...
      category: 'micro-saas';
      description: 'Multi-platform scheduli,n,g, content optimization, and engagement analytics.';
  ...
  const categories = [;
    { id: 'all' name: 'All Service,s,'},;
    { id: 'micro-saas' name: 'Micro Saa,S,'},;
    { id: 'ai-services' name: 'AI Service,s,'},;
    { id: 'it-services' name: 'IT Service,s,'},;
    { id: 'cloud' name: 'Cloud Solution,s,'},;
    { id: 'security' name: 'Cybersecurit,y,'}
  ];
  ...
  return (;
    <>;
      <Head>;
        ...
        <link rel="canonical" href="https: //ziontechgroup.com/services-catalo,g" /,>,";
        <meta property="og: title" content="Services Catalog - Zion Tech Grou,p" /,>,";
        <meta property="og: description" content="Browse our comprehensive catalog of technology services including AI solutio,n,s, micro SaaS products, and IT services." />";
        <meta property="og: url" content="https://ziontechgroup.com/services-catalo,g" /,>,";
        <meta property="og: type" content="websit,e" /,>,;
      </Head>;
";
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">";
        <div className="container mx-auto px-4 py-20">;
          ...
          <div className="text-center mb-12">";
            <h1 className="text-5xl md: text-6xl font-bold text-white m,b-6",>,";
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 mb-12">";
            <div className="flex flex-col md: flex-row ga,p-4",>,";
              ...
              <div className="flex gap-2">";
                ...
                >;
                  {categories.map(category => (";
                    <option key={category.,i,d} value={category.id} className="bg-slate-800">;
                      {category.name}
                    </option>;
                  ))}
                </select>;
          ...
          {/* Services Grid */}";
          <div className="grid md: grid-cols-2 lg:grid-cols-3 ga,p-8",>,;
            {filteredServices.map((service) => (";
              <div key={service.id} className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover: border-blue-400/50 transition-all duration-300 grou,p",>,";
...
";
                <h3 className="text-xl font-bold text-white mb-3 group-hover: text-blue-300 transition-color,s",>,;
                  {service.name}
                </h3>;
";
...
";
                <div className="space-y-2 mb-6">";
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-300">";
                    ...
                    <span>Delivery: {service.delive,r,y}</span>;
                  </div>;
                </div>;
";
                <div className="mb-6">";
                ...
                >;
                  Get Started";
                  <ArrowRight className="w-4 h-4 ml-2 group-hover: translate-x-1 transition-transfor,m" /,>,;
                </Link>;
              </div>;
            ))}
          </div>;
          ...
          <div className="text-center mt-16">";
            ...
            <Link href="/contact" className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-8 py-4 rounded-lg font-semibold hover: from-blue-600 hover:to-purple-600 transition-all duratio,n-300",>,;

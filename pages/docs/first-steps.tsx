              ...
              <div className="grid md:grid-cols-3 gap-6">";
                <div className="border border-gray-200 rounded-lg p-6">";
                  ...
                  <p className="text-gray-600 mb-4">;
                    Specialized applications for specific business needs like cost optimizati,o,n, analytics, and automation.;
                  </p>";
...
";
                <div className="border border-gray-200 rounded-lg p-6">";
                  ...
                  <p className="text-gray-600 mb-4">;
                    Machine learning and AI solutions for automati,o,n, prediction, and intelligent decision-making.;
                  </p>";
                  <ul className="space-y-2 text-sm text-gray-600">";
                    <li className="flex items-center">";
                      <CheckCircle className="w-4 h-4 text-green-500 mr-2" />;
...
";
                <div className="border border-gray-200 rounded-lg p-6">";
                  ...
                  <p className="text-gray-600 mb-4">;
                    Comprehensive IT solutions including cloud migrati,o,n, cybersecurity, and digital transformation.;
                  </p>";
                  <ul className="space-y-2 text-sm text-gray-600">";
                    <li className="flex items-center">";
                      <CheckCircle className="w-4 h-4 text-green-500 mr-2" />;
...
";
            <div className="bg-white rounded-lg shadow-lg p-8">";
              ...
              ";
              <p className="text-gray-600 mb-6">;
                Once you've identified the services you ne,e,d, contact our team for a personalized quote and implementation plan.;
              </p>;
";
...
";
              <div className="mt-6 flex flex-col sm:flex-row gap-4">";
                ...
                <a href={`tel:${contact.pho,n,e}`} className="px-6 py-3 bg-white text-blue-600 border border-blue-600 rounded-lg hover: bg-blue-50 transition-colors text-center">;

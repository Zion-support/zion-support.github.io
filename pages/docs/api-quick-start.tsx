        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
          ...
          <section style={{ background: '#f8f9fa', padding: 32, borderRadius: 12, border: '1px solid #e9ecef' }}>
            ...
            <div style={{ background: '#e3f2fd', padding: 20, borderRadius: 8, marginBottom: 20 }}>
              <h3 style={{ fontWeight: 600, marginBottom: 12, color: '#1976d2' }}>Header Authentication</h3>
...
{`curl -X GET "https://api.ziontechgroup.com/v1/services" \\
  ...
  -H "Content-Type: application/json"`}
            ...
            <div style={{ background: '#e3f2fd', padding: 20, borderRadius: 8 }}>
              <h3 style={{ fontWeight: 600, marginBottom: 12, color: '#1976d2' }}>JavaScript Example</h3>
              <pre style={{ background: '#f5f5f5', padding: 16, borderRadius: 6, overflow: 'auto', fontSize: '0.9rem' }}>
...
console.log(data);`}
          ...
          <section style={{ background: '#f8f9fa', padding: 32, borderRadius: 12, border: '1px solid #e9ecef' }}>
            ...
            <div style={{ background: '#e8f5e8', padding: 20, borderRadius: 8, marginBottom: 20 }}>
              <h3 style={{ fontWeight: 600, marginBottom: 12, color: '#2e7d32' }}>Request</h3>
              <pre style={{ background: '#f5f5f5', padding: 16, borderRadius: 6, overflow: 'auto', fontSize: '0.9rem' }}>
{`GET /v1/services
Authorization: Bearer YOUR_API_KEY`}
              </pre>
            ...
            <div style={{ background: '#e8f5e8', padding: 20, borderRadius: 8 }}>
              <h3 style={{ fontWeight: 600, marginBottom: 12, color: '#2e7d32' }}>Response</h3>
              <pre style={{ background: '#f5f5f5', padding: 16, borderRadius: 6, overflow: 'auto', fontSize: '0.9rem' }}>
{`{
  "success": true,
  "data": [
    ...
    "total": 67
          ...
          <section style={{ background: '#f8f9fa', padding: 32, borderRadius: 12, border: '1px solid #e9ecef' }}>
            ...
            <div style={{ display: 'grid', gap: 20 }}>
              <div style={{ padding: 20, background: '#e3f2fd', borderRadius: 8, border: '1px solid rgba(59, 130, 246, 0.2)' }}>
                <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#1976d2' }}>1. List Available Services</h3>
                ...
                <code style={{ background: '#f5f5f5', padding: '4px 8px', borderRadius: 4, fontSize: '0.8rem' }}>GET /v1/services</code>
              </div>
              
              <div style={{ padding: 20, background: '#f3e5f5', borderRadius: 8, border: '1px solid rgba(139, 92, 246, 0.2)' }}>
                <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#7b1fa2' }}>2. Request Service Quote</h3>
                <p style={{ opacity: 0.8, marginBottom: 12, fontSize: '0.9rem' }}>Submit a request for a custom service quote or consultation.</p>
                <code style={{ background: '#f5f5f5', padding: '4px 8px', borderRadius: 4, fontSize: '0.8rem' }}>POST /v1/quotes</code>
              </div>
              
              <div style={{ padding: 20, background: '#e8f5e8', borderRadius: 8, border: '1px solid rgba(34, 197, 94, 0.2)' }}>
                <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#2e7d32' }}>3. Get Service Details</h3>
                <p style={{ opacity: 0.8, marginBottom: 12, fontSize: '0.9rem' }}>Retrieve detailed information about a specific service.</p>
                <code style={{ background: '#f5f5f5', padding: '4px 8px', borderRadius: 4, fontSize: '0.8rem' }}>GET /v1/services/&#123;service_id&#125;</code>
              </div>
            </div>
          </section>
          ...
          <section style={{ background: '#f8f9fa', padding: 32, borderRadius: 12, border: '1px solid #e9ecef' }}>
            ...
            <div style={{ background: '#ffebee', padding: 20, borderRadius: 8, border: '1px solid rgba(239, 68, 68, 0.2)' }}>
              <h3 style={{ fontWeight: 600, marginBottom: 12, color: '#d32f2f' }}>Error Response Example</h3>
              <pre style={{ background: '#f5f5f5', padding: 16, borderRadius: 6, overflow: 'auto', fontSize: '0.9rem' }}>
{`{
  "success": false,
  "error": {

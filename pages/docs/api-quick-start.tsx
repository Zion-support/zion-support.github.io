    ...
    "total": 67
          ...
          <section style={{ background: '#f8fafc', padding: 32, borderRadius: 12, border: '1px solid #e2e8f0' }}>
            ...
            <div style={{ display: 'grid', gap: 20 }}>
              <div style={{ padding: 20, background: '#f1f5f9', borderRadius: 8, border: '1px solid rgba(59, 130, 246, 0.2)' }}>
                <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#1e40af' }}>1. List Available Services</h3>
                ...
                <code style={{ background: '#e2e8f0', padding: '4px 8px', borderRadius: 4, fontSize: '0.8rem' }}>GET /v1/services</code>
              </div>
              
              <div style={{ padding: 20, background: '#f1f5f9', borderRadius: 8, border: '1px solid rgba(139, 92, 246, 0.2)' }}>
                <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#7c3aed' }}>2. Request Service Quote</h3>
                <p style={{ opacity: 0.8, marginBottom: 12, fontSize: '0.9rem' }}>Submit a request for a custom service quote or consultation.</p>
                <code style={{ background: '#e2e8f0', padding: '4px 8px', borderRadius: 4, fontSize: '0.8rem' }}>POST /v1/quotes</code>
              </div>
              
              <div style={{ padding: 20, background: '#f1f5f9', borderRadius: 8, border: '1px solid rgba(34, 197, 94, 0.2)' }}>
                <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#059669' }}>3. Get Service Details</h3>
                <p style={{ opacity: 0.8, marginBottom: 12, fontSize: '0.9rem' }}>Retrieve detailed information about a specific service.</p>
                <code style={{ background: '#e2e8f0', padding: '4px 8px', borderRadius: 4, fontSize: '0.8rem' }}>GET /v1/services/&#123;service_id&#125;</code>
              </div>
            </div>
          </section>
  ...
  "timestamp": "2025-01-26T10:30:00Z"
          ...
          <section style={{ background: '#f8fafc', padding: 32, borderRadius: 12, border: '1px solid #e2e8f0' }}>
            ...
            <div style={{ display: 'grid', gap: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: 16, background: '#f1f5f9', borderRadius: 8 }}>

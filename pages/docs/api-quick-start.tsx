...
{`curl -X GET "https://api.ziontechgroup.com/v1/services" \\
  ...
  -H "Content-Type: application/json"`}
            ...
            <div style={{ background: '#0f172a', padding: 20, borderRadius: 8 }}>
  ...
  "pagination": {
    ...
    "total": 67
          ...
          <section style={{ background: '#1e293b', padding: 32, borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <div style={{ display: 'grid', gap: 20 }}>
              <div style={{ padding: 20, background: '#0f172a', borderRadius: 8, border: '1px solid rgba(59, 130, 246, 0.2)' }}>
                ...
                <code style={{ background: '#374151', padding: '4px 8px', borderRadius: 4, fontSize: '0.8rem' }}>GET /v1/services</code>
              </div>
              ...
              <div style={{ padding: 20, background: '#0f172a', borderRadius: 8, border: '1px solid rgba(139, 92, 246, 0.2)' }}>
                ...
                <code style={{ background: '#374151', padding: '4px 8px', borderRadius: 4, fontSize: '0.8rem' }}>POST /v1/quotes</code>
              </div>
              ...
              <div style={{ padding: 20, background: '#0f172a', borderRadius: 8, border: '1px solid rgba(34, 197, 94, 0.2)' }}>
                ...
                <code style={{ background: '#374151', padding: '4px 8px', borderRadius: 4, fontSize: '0.8rem' }}>GET /v1/services/&#123;service_id&#125;</code>
              </div>
            </div>
          </section>
          ...
          <section style={{ background: '#1e293b', padding: 32, borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <div style={{ background: '#0f172a', padding: 20, borderRadius: 8, border: '1px solid rgba(239, 68, 68, 0.2)' }}>
  ...
  "timestamp": "2025-01-26T10:30:00Z"
          ...
          <section style={{ background: '#1e293b', padding: 32, borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <div style={{ display: 'flex', gap: 16 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: 16, background: '#0f172a', borderRadius: 8 }}>

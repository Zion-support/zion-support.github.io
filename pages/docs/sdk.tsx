...
?>`}
          ...
          {/* SDK Features */}
          <section style={{ background: '#1e293b', padding: 32, borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)' }}>
            <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: 24 }}>✨ SDK Features</h2>
            <div style={{ display: 'grid', gap: 20 }}>
              ...
              <div style={{ padding: 20, background: '#0f172a', borderRadius: 8, border: '1px solid rgba(245, 158, 11, 0.2)' }}>

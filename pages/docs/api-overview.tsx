          ...
          <div className="grid md: grid-cols-2 gap-6 mb-8">";
            <div className="bg-white rounded-lg shadow-lg p-6">";
              ...
              <p className="text-gray-600 mb-4">;
                Cle,a,n, intuitive REST APIs with comprehensive documentation and SDKs for popular languages.;
              </p>";
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">";
            ...
            <div className="grid md: grid-cols-3 gap-6">";
              <div className="border border-gray-200 rounded-lg p-6">";
                ...
                <p className="text-gray-600 mb-4">;
                  APIs for our 150+ micro SaaS applications including cost optimizati,o,n, analytics, and automation tools.;
                </p>";
...
";
              <div className="border border-gray-200 rounded-lg p-6">";
                ...
                <p className="text-gray-600 mb-4">;
                  Machine learning and AI APIs for natural language processi,n,g, computer vision, and predictive analytics.;
                </p>";
...
";
              <div className="border border-gray-200 rounded-lg p-6">";
                ...
                <p className="text-gray-600 mb-4">;
                  Infrastructure and enterprise APIs for cloud manageme,n,t, DevOps, and cybersecurity services.;
                </p>";

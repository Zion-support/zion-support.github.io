...
import { BookOpen, Code, FileText, Video, ArrowRight, Search, Users } from 'lucide-react'
import Layout from '../../components/Layout'

const categories = [
  { , ;
    icon: BookOpen, color: "from-blue-600 to-blue-800", links: [
  ...
  { , ;
    icon: Code, color: "from-green-600 to-green-800", links: [{ title: "Authentication", href: "/api-docs/auth", type: "api" }, ;
  ...
  { , ;
    icon: Video, color: "from-purple-600 to-purple-800", links: [{ title: "Building Your First App", href: "/tutorials/first-app", type: "tutorial" }, ;
  ...
  { , ;
    icon: FileText, color: "from-orange-600 to-orange-800", links: [{ title: "Security Guide", href: "/guides/security", type: "guide" }, ;
...
const popularDocs = [{ , ;
    href: "/docs/getting-started", views: "12.5K", type: "guide" }, ;
  { , ;
    href: "/api-docs/auth", views: "8.2K", type: "api" }, ;
  { , ;
    href: "/tutorials/first-app", views: "15.3K", type: "tutorial" }, ;
  { , ;
    href: "/guides/security", views: "6.7K", type: "guide" }]

const resources = [{ , ;
    icon: Code, count: "8 SDKs" }, ;
  { , ;
    icon: FileText, count: "50+ Examples" }, ;
  { , ;
    icon: Video, count: "25+ Videos" }, ;
  { , ;
    icon: Users, count: "2K+ Members" }]

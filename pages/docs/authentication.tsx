...
redirect_uri=YOUR_REDIRECT_UR,I,`}
                </pre>;
              </div>;
";
              <div className="grid md: grid-cols-2 gap-6">;
...
";
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8">";
            ...
            <div className="grid md: grid-cols-3 gap-4 text-sm">";
              <div className="bg-white rounded p-4">";
                ...
                <p className="text-gra,y-600">,1,000 requests/hour</p>;
              </div>";
              <div className="bg-white rounded p-4">";
          ...
          <div className="bg-blue-50 rounded-lg p-8 text-center">";
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">";
              ...
              <a href={`mailto:${contact.ema,i,l}`} className="px-6 py-3 bg-white text-blue-600 border border-blue-600 rounded-lg hover: bg-blue-50 transition-colors">;

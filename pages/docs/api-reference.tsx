        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
          ...
          <section style={{ background: '#f8f9fa', padding: 32, borderRadius: 12, border: '1px solid #e9ecef' }}>
            ...
            <div style={{ background: '#e3f2fd', padding: 20, borderRadius: 8 }}>
              <code style={{ fontSize: '1.2rem', color: '#1976d2' }}>https://api.ziontechgroup.com/v1</code>
            </div>
          </section>
          ...
          <section style={{ background: '#f8f9fa', padding: 32, borderRadius: 12, border: '1px solid #e9ecef' }}>
            ...
            <div style={{ background: '#e3f2fd', padding: 20, borderRadius: 8 }}>
              <h3 style={{ fontWeight: 600, marginBottom: 12, color: '#1976d2' }}>Header Format</h3>
          ...
          <section style={{ background: '#f8f9fa', padding: 32, borderRadius: 12, border: '1px solid #e9ecef' }}>
            ...
            <div style={{ display: 'grid', gap: 20 }}>
              <div style={{ padding: 20, background: '#e8f5e8', borderRadius: 8 }}>
                <h3 style={{ fontWeight: 600, marginBottom: 12, color: '#2e7d32' }}>GET /services</h3>
                <p style={{ opacity: 0.8, marginBottom: 12 }}>Retrieve a list of all available services.</p>
                
                <div style={{ marginBottom: 16 }}>
                  <h4 style={{ fontWeight: 600, marginBottom: 8, color: '#f57c00' }}>Query Parameters</h4>
                  <div style={{ background: '#f5f5f5', padding: 12, borderRadius: 6, fontSize: '0.9rem' }}>
                ...
                <div style={{ marginBottom: 16 }}>
                  <h4 style={{ fontWeight: 600, marginBottom: 8, color: '#f57c00' }}>Response</h4>
                  <pre style={{ background: '#f5f5f5', padding: 12, borderRadius: 6, overflow: 'auto', fontSize: '0.8rem' }}>
{`{
  "success": true,
  "data": [
    {
  ...
  "pagination": {
    ...
    "pages": 7
              ...
              <div style={{ padding: 20, background: '#e3f2fd', borderRadius: 8 }}>
                ...
                <div style={{ marginBottom: 16 }}>
                  <h4 style={{ fontWeight: 600, marginBottom: 8, color: '#f57c00' }}>Path Parameters</h4>
                  <div style={{ background: '#f5f5f5', padding: 12, borderRadius: 6, fontSize: '0.9rem' }}>
  ...
  "data": {
    ...
    "endpoints": ["/v1/micro-saas"]
          ...
          <section style={{ background: '#f8f9fa', padding: 32, borderRadius: 12, border: '1px solid #e9ecef' }}>
            ...
            <div style={{ padding: 20, background: '#e3f2fd', borderRadius: 8 }}>
              <h3 style={{ fontWeight: 600, marginBottom: 12, color: '#1976d2' }}>POST /quotes</h3>
              <p style={{ opacity: 0.8, marginBottom: 12 }}>Submit a request for a custom service quote.</p>
              
              <div style={{ marginBottom: 16 }}>
                <h4 style={{ fontWeight: 600, marginBottom: 8, color: '#f57c00' }}>Request Body</h4>
                <pre style={{ background: '#f5f5f5', padding: 12, borderRadius: 6, overflow: 'auto', fontSize: '0.8rem' }}>
{`{
      ...
      "Schedule a consultation call"
          ...
          <section style={{ background: '#f8f9fa', padding: 32, borderRadius: 12, border: '1px solid #e9ecef' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div style={{ padding: 16, background: '#ffebee', borderRadius: 8, border: '1px solid rgba(239, 68, 68, 0.2)' }}>
                <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#d32f2f' }}>400 - Bad Request</h3>
                <p style={{ opacity: 0.8, fontSize: '0.9rem' }}>Invalid request parameters or malformed JSON.</p>
              </div>
              
              <div style={{ padding: 16, background: '#ffebee', borderRadius: 8, border: '1px solid rgba(239, 68, 68, 0.2)' }}>
                <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#d32f2f' }}>401 - Unauthorized</h3>
                <p style={{ opacity: 0.8, fontSize: '0.9rem' }}>Invalid or missing API key.</p>
              </div>
              
              <div style={{ padding: 16, background: '#ffebee', borderRadius: 8, border: '1px solid rgba(239, 68, 68, 0.2)' }}>
                <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#d32f2f' }}>404 - Not Found</h3>
                <p style={{ opacity: 0.8, fontSize: '0.9rem' }}>Requested resource does not exist.</p>
              </div>
              
              <div style={{ padding: 16, background: '#ffebee', borderRadius: 8, border: '1px solid rgba(239, 68, 68, 0.2)' }}>
                <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#d32f2f' }}>429 - Too Many Requests</h3>
                <p style={{ opacity: 0.8, fontSize: '0.9rem' }}>Rate limit exceeded. Please wait before making more requests.</p>
              </div>
              
              <div style={{ padding: 16, background: '#ffebee', borderRadius: 8, border: '1px solid rgba(239, 68, 68, 0.2)' }}>
                <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#d32f2f' }}>500 - Internal Server Error</h3>
          ...
          <section style={{ background: '#f8f9fa', padding: 32, borderRadius: 12, border: '1px solid #e9ecef' }}>
            ...
            <div style={{ background: '#e3f2fd', padding: 20, borderRadius: 8 }}>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16 }}>
                <div>
                  <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#1976d2' }}>Free Tier</h3>
                  <p style={{ opacity: 0.8, fontSize: '0.9rem' }}>100 requests/hour</p>
                </div>
                <div>
                  <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#7b1fa2' }}>Pro Tier</h3>
                  <p style={{ opacity: 0.8, fontSize: '0.9rem' }}>1,000 requests/hour</p>
                </div>
                <div>
                  <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#2e7d32' }}>Enterprise</h3>

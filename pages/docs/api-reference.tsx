    ...
    <>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 20px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
          {/* Base URL */}
          <section style={{ background: 'rgba(15, 23, 42, 0.8)', padding: 32, borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)' }}>
            <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: 16 }}>🌐 Base URL</h2>
            <div style={{ background: 'rgba(30, 41, 59, 0.5)', padding: 20, borderRadius: 8 }}>
          ...
          <section style={{ background: 'rgba(15, 23, 42, 0.8)', padding: 32, borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <div style={{ background: 'rgba(30, 41, 59, 0.5)', padding: 20, borderRadius: 8 }}>
              ...
              <pre style={{ background: 'rgba(15, 23, 42, 0.8)', padding: 16, borderRadius: 6, overflow: 'auto', fontSize: '0.9rem' }}>
{`Authorization: Bearer YOUR_API_KEY`}
          ...
          <section style={{ background: 'rgba(15, 23, 42, 0.8)', padding: 32, borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <div style={{ display: 'grid', gap: 20 }}>
              <div style={{ padding: 20, background: 'rgba(30, 41, 59, 0.3)', borderRadius: 8 }}>
                ...
                <div style={{ marginBottom: 16 }}>
                  ...
                  <div style={{ background: 'rgba(15, 23, 42, 0.8)', padding: 12, borderRadius: 6, fontSize: '0.9rem' }}>
                ...
                <div style={{ marginBottom: 16 }}>
                  ...
                  <pre style={{ background: 'rgba(15, 23, 42, 0.8)', padding: 12, borderRadius: 6, overflow: 'auto', fontSize: '0.8rem' }}>
{`{
  "success": true,
  "data": [
    {
      ...
      "Schedule a consultation call"
          ...
          <section style={{ background: 'rgba(15, 23, 42, 0.8)', padding: 32, borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <div style={{ display: 'grid', gap: 16 }}>
              <div style={{ padding: 16, background: 'rgba(30, 41, 59, 0.3)', borderRadius: 8, border: '1px solid rgba(239, 68, 68, 0.2)' }}>
          ...
          <section style={{ background: 'rgba(15, 23, 42, 0.8)', padding: 32, borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <div style={{ background: 'rgba(30, 41, 59, 0.5)', padding: 20, borderRadius: 8 }}>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16 }}>
                ...
                <div>
                  <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#7c3aed' }}>Pro Tier</h3>
                  <p style={{ opacity: 0.8, fontSize: '0.9rem' }}>1,000 requests/hour</p>
                </div>
                <div>
                  <h3 style={{ fontWeight: 600, marginBottom: 8, color: '#059669' }}>Enterprise</h3>

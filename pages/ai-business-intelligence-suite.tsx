                  ...
                  <div className='bg-gray-900 rounded-2xl px-8 py-6'>
                    <div className='text-center'>
                      ...
                      <Button
                        href='/contact'
                        variant='primary'
                        className='w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-bold py-3 px-6 rounded-xl'                      >                        Start Free Trial
                      </Button>
                    </div>
                  </div>
                </motion.div>

            ...
            <tbody>;
              {flags && flags.map((f: any) => (;
                <tr key={f && f.id} className='border-t hover:bg-gray-50/50'>;
                  ...
                  <td className='px-3 py-2'>{f && f.userEmail}</td>;
                  <td className='px-3 py-2 truncate max-w-xs' title={f && f.reason}>;
                    {f && f.reason}
                  </td>;
                  <td className='px-3 py-2 text-xs'>;
                    T{Math && Math.round(f && f.aiScores?.toxicity * 100)}% / N;
                    {Math && Math.round(f && f.aiScores?.nsfw * 100)}% / S;
                    {Math && Math.round(f && f.aiScores?.scam * 100)}%;
                  </td>;
                  <td className='px-3 py-2'>;
                    {new Date(f && f.createdAt).toLocaleString()}
                  </td>;
                  <td className='px-3 py-2'>{f && f.status}</td>;
                  <td className='px-3 py-2'>;
                    <button

  ...
  return();
    <div></div>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Comprehensive IT services including cloud infrastructure, cybersecurity, DevOps, and database management. Enterprise-grade solutions for modern businesses." /></meta>
        <meta name="keywords" content="IT services, cloud infrastructure, cybersecurity, DevOps, database management, network services, IT consulting" /></meta>
      </Helmet>
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
            <div className="text-center"></div>
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-6"></div>
                <Server className="w-8 h-8 text-white" /></Server>
              </div>

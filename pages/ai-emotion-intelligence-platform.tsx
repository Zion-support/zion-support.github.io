        ...
        <section id='pricing' className='py-20'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>            <motion.div
            ...
            >
              ...
              <p className='text-xl text-gray-400 max-w-3xl mx-auto'>                Start with our professional plan and scale as you grow
              </p>
            </motion.div>
            ...
            >
              ...
              <div className='flex flex-col sm:flex-row items-center justify-center gap-6 mb-12'>
                ...
                >
                  <span className='flex items-center'>
                    Schedule Demo
                    <MessageCircle className='ml-2 w-5 h-5 group-hover:scale-110 transition-transform duration-200' />                  </span>
                </Link>
              </div>

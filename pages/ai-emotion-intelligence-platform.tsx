  ...
  return (
    ...
    return res.status(500).json({ error: "Internal server error" });
              ...
              <motion.h1
                ...
                animate={{ opacity: 1, y: 0 }}                initial={{ opacity: 0, y: 30 }  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
    ...
    return res.status(500).json({ error: "Internal server error" });
            ...
            <motion.div
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}            {/* CTA Buttons */  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
    ...
    return res.status(500).json({ error: "Internal server error" });
            ...
            <motion.div
              ...
              <div className="text-center">            {/* Key Stats */  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  transition={{ duration: 0.8, delay: index * 0.1 }}              transition={{ duration: 0.8, delay: 1.2 }} className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">;
              <div className="text-center">;
                <div className="text-3xl md:text-4xl font-bold text-pink-400 mb-2">27</div>;
                <div className="text-gray-400 text-sm">Emotions Detected</div>;
              </div>;
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="flex flex-col items-center">
                  ...
                  <a href={`tel:${contactInfo.mobile}`} className="text-white font-semibold hover:text-pink-400 transition-colors">
                    {contactInfo.mobile}
                  </a>                    {contactInfo.mobile  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
                ...
                <div className="flex flex-col items-center">
                  ...
                  <a href={`mailto:${contactInfo.email}`} className="text-white font-semibold hover:text-purple-400 transition-colors">
                    {contactInfo.email}
                  </a>                    {contactInfo.email  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
                ...
                <div className="flex flex-col items-center">
                  ...
                  </a>                    {contactInfo.website.replace('https://', '')  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}

...
variants={containerVariants}
          ...
          >
            <div className=&quot;text-center mb-8&quot;>
              ...
              <p className="text-white/60">
                Showing results for "{searchTerm || 'all services'}" in {selectedCategory === 'all' ? 'all categories' : selectedCategory}              </p>
            </div>
...
href={`mailto:${contactInfo.email}?subject=Inquiry about ${service.name}`}
                      ...
                      <div className=&quot;mt-4 pt-4 border-t border-white/10&quot;>
                        <div className=&quot;grid grid-cols-2 gap-4 text-xs text-white/50&quot;>
                          ...
                          <div>
                            <span className=&quot;block text-white/70&quot;>ROI:</span>
                            <span className=&quot;text-green-400&quot;>{service.roi.split(' ').slice(0, 3).join(' ')}...</span>                          </div>
                        </div>
                      </div>
                    </div>
                  </motion.div>

        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              technology trends and business strategies.
            </p>
          </motion.div>
        </div>
      </section>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-green-400">
                          {featuredPaper.downloads.toLocaleString()}
                        </div>
                        <div className="text-sm text-gray-400">Downloads</div>
                      </div>
                      <div className="text-center">
                        <div className="text-2xl font-bold text-blue-400">
                          {featuredPaper.rating}/5
                        </div>
            ...
            <div className="lg: w-1/3">
              ...
              >
                ...
                <Card className="p-6">
                  ...
                  <p className="text-gray-300 mb-4 text-sm">
                    We can create custom white papers and research reports
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join thousands of professionals who rely on our insights to stay
              ahead of the curve.
            </p>

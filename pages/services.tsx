...
export default function Services() {
	...
	return (
		<Layout>
			...
			{/* Market Information & Pricing Section */}
			<section className='py-24 sm:py-32 bg-gray-50'>
				<div className='mx-auto max-w-7xl px-6 lg:px-8'>
					<div className='mx-auto max-w-2xl text-center mb-16'>
						<h2 className='text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl'>
							Market-Leading Solutions & Competitive Pricing
						</h2>
						<p className='mt-6 text-lg leading-8 text-gray-600'>
							Our services are priced competitively in the market, offering exceptional value and ROI for businesses of all sizes.
						</p>
					</div>
					...
					<div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-16'>
						<div className='bg-white p-8 rounded-2xl shadow-lg text-center'>
							...
							<div className='text-lg font-semibold text-gray-900 mb-2'>AI Services Market</div>
							<div className='text-gray-600'>Growing at 25% annually, we're positioned at the forefront of this expanding market</div>
						</div>
						<div className='bg-white p-8 rounded-2xl shadow-lg text-center'>
							<div className='text-4xl font-bold text-green-600 mb-2'>$1.8B+</div>
							<div className='text-lg font-semibold text-gray-900 mb-2'>Micro SaaS Market</div>
							<div className='text-gray-600'>Specialized solutions driving 40% higher customer satisfaction rates</div>
						</div>
						<div className='bg-white p-8 rounded-2xl shadow-lg text-center'>
							<div className='text-4xl font-bold text-purple-600 mb-2'>$4.2B+</div>
							<div className='text-lg font-semibold text-gray-900 mb-2'>IT Services Market</div>
							<div className='text-gray-600'>Enterprise-grade solutions with 99.9% uptime guarantee</div>
						</div>
					</div>
					...
					<div className='grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16'>
						...
						<div className='bg-white p-8 rounded-2xl shadow-lg border-2 border-gray-200'>
							...
							<ul className='space-y-4 mb-8'>
								<li className='flex items-center'>
									...
									<span className='text-gray-700'>Basic AI automation tools</span>
								</li>
								<li className='flex items-center'>
									<CheckCircle className='w-5 h-5 text-green-500 mr-3' />
									<span className='text-gray-700'>Standard IT support</span>
								</li>
								<li className='flex items-center'>
									<CheckCircle className='w-5 h-5 text-green-500 mr-3' />
									<span className='text-gray-700'>Essential micro SaaS solutions</span>
								</li>
								<li className='flex items-center'>
									<CheckCircle className='w-5 h-5 text-green-500 mr-3' />
						...
						<div className='bg-white p-8 rounded-2xl shadow-lg border-2 border-blue-500 relative'>
							...
							<div className='text-center mb-8'>
								...
								<div className='text-4xl font-bold text-blue-600 mb-2'>$1,000 - $9,999</div>
								<div className='text-gray-600'>per month</div>
							</div>
							<ul className='space-y-4 mb-8'>
								<li className='flex items-center'>
									<CheckCircle className='w-5 h-5 text-green-500 mr-3' />
									<span className='text-gray-700'>Advanced AI solutions</span>
								</li>
								<li className='flex items-center'>
									<CheckCircle className='w-5 h-5 text-green-500 mr-3' />
									<span className='text-gray-700'>Comprehensive IT services</span>
								</li>
								<li className='flex items-center'>
									<CheckCircle className='w-5 h-5 text-green-500 mr-3' />
									<span className='text-gray-700'>Custom micro SaaS development</span>
								</li>
								<li className='flex items-center'>
									<CheckCircle className='w-5 h-5 text-green-500 mr-3' />
						...
						<div className='bg-white p-8 rounded-2xl shadow-lg border-2 border-gray-200'>
							...
							<ul className='space-y-4 mb-8'>
								<li className='flex items-center'>
									<CheckCircle className='w-5 h-5 text-green-500 mr-3' />
									<span className='text-gray-700'>Cutting-edge AI platforms</span>
								</li>
								<li className='flex items-center'>
									<CheckCircle className='w-5 h-5 text-green-500 mr-3' />
									<span className='text-gray-700'>Full-scale IT transformation</span>
								</li>
								<li className='flex items-center'>
									<CheckCircle className='w-5 h-5 text-green-500 mr-3' />
									<span className='text-gray-700'>Bespoke enterprise solutions</span>
								</li>
								<li className='flex items-center'>
									<CheckCircle className='w-5 h-5 text-green-500 mr-3' />
					...
					<div className='bg-gradient-to-r from-blue-600 to-purple-600 p-8 rounded-2xl text-white text-center'>
						<h3 className='text-2xl font-bold mb-4'>Average ROI: 300-500%</h3>
						<p className='text-lg mb-6'>Our clients typically see significant returns within 6-12 months of implementation</p>

  ...
  return (
    <>
      ...
      className ="container mx-auto px-4">
          <h1,
      className ="text-4xl font-bold text-center mb-8">Our Services</h1>
          <p,
      ...
      lg:grid-cols-3 gap-8">
           , {Object.entries(serviceDetails).map(([key, service]) => (
              <div,
      key ={key} className="bg-white rounded-lg shadow-md p-6,
      hover:shadow-xl transition-shadow">
                <h3,
      className ="text-xl font-bold mb-4">{service.title}</h3>
                <p,
      className ="text-gray-600 mb-4">{service.description}</p>
                <ul,

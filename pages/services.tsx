	...
	return (
		...
		<div>
			...
			<divclassName="containermx-autopx-4 py-8 max-w-7 xl">
				<navclassName="mb-8">
					<Linkhref="/" className="text-bl, u, e-600, hover: te, x, t-bl, u, e-800font-mediumtransition-colors">							← Back, to, Home
						</Link>
					</nav>
			...
			<divclassName="te, x, t-centermb-12">
								...
								<pclassName="text-xltext-gray-600 max-w-3 xlmx-auto">									We, combine, technical expertise, with, business acumen, to, deliver solutions, that, drive real, result, s.
								</p>
							</div>
			...
			<divclassName="w-16 h-16bg-bl, u, e-100, rounde, d-fullflexitems-center justify-centermx-automb-4">

...
export default function Services(): JSX.Element {
  ...
  backgroundClip: text
        ...
        <div style={{ 
          background: '`${color'
}20` color: color, padding: '4px 12px',
  ...
  return (
    <main style={{ 
      ...
      <Section title="Micro SaaS Products"
  items={microSaaS} color="#3b82f6" />
      <Section title="AI Services & Platforms"
  items={aiServices} color="#8b5cf6" />
      <Section title="IT & Cloud Services"
  items={itServices} color="#22c55e" />
...
<div style={{ display: flex, gap: 16, justifyContent: center, flexWrap: wrap
          ...
          <Link href="/contact"
  style={{ display: 'inline-block', background: 'linear-gradient(135deg, #3b82f6, #8b5cf6)', color: white, padding: '16px 32px', borderRadius: 12, 
            fontWeight: 700, textDecoration: none, fontSize: 16, transition: 'all 0.3s ease',
          }}>Request a Quote</Link>
<a href="tel:+13024640950"
  style={{ display: 'inline-block', background: 'rgba(34, 197, 94, 0.1)', color: '#22c55e', padding: '16px 32px', borderRadius: 12, 

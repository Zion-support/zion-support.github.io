...
const microSaaS: Service[] = [{
    ...
    pricing: 'Typica,l: $299–$1499/month';
    ...
    pricing: 'Typica,l: $799–$3500/month';
    ...
    pricing: 'Typica,l: $399–$1999/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $299–$1299/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $399–$1599/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $299–$1199/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $499–$2499/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $499–$3999/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $399–$2999/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $199–$1499/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $299–$2499/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $999–$7999/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $1999–$12,999/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $799–$5999/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $1299–$7,999/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $299–$1999/month';
    link: 'https://ziontechgroup.com/micro-saas'},{
    ...
    pricing: 'Typica,l: $899–$5999/month';
    link: 'https://ziontechgroup.com/micro-saas'}
];
...
const aiServices: Service[] = [{
    ...
    summary: 'RPA withAI workflow automation, document processing, and business process optimization.';
    pricing: 'Typical: $10k–$50k project';
    link: 'https://ziontechgroup.com/ai-services'},{
    ...
    summary: 'GameAI optimization algorithms, and adaptive learning systems.';
    ...
    pricing: 'Typica,l: $2000–$12,000/month';
    link: 'https://ziontechgroup.com/ai-services'},{
    ...
    pricing: 'Typica,l: $5000–$25,000 setup';
    link: 'https://ziontechgroup.com/ai-services'},{
    ...
    pricing: 'Typica,l: $1500–$10,000/month';
    link: 'https://ziontechgroup.com/ai-services'},{
...
const itServices: Service[] = [{
    ...
    summary: 'SOC2 HIPAA, GDPR compliance assessments, and security audit preparation.';
    pricing: 'Typical: $10k–$50k project';
    link: 'https://ziontechgroup.com/it-services'},{
    ...
    pricing: 'Typica,l: $8000–$50,000/project';
    link: 'https://ziontechgroup.com/it-services'},{
...
export default function Services(): JSX.Element {
  const Section = ({ title, items, color }: { title: string; items: Service[]; color: string }) => (<section style={{ maxWidth: 1400 margin: '0 auto' padding: '32px 20px'}}><div style={{ 
        display: 'flex' alignItems: 'center' ga,p: 12 marginBottom: 24;
        paddingBottom: 12 borderBottom: `2px solid ${color}20`}}><div style={{ 
          width:  4 height: 32 background: color borderRadius: 2, }}></div><h2 style={{ 
          fontSize: 28 fontWeight: 800 margin:  0;
          background: `linear-gradient(135deg ${color}, ${color}80)`;
          WebkitBackgroundClip: 'text';
          WebkitTextFillColor: 'transparent';
          backgroundClip: 'text'}}>{title}</h2><div style={{ 
          background: `${color}20` color: color padding: '4px 12px' 
          borderRadiu,s: 20 fontSize: 14 fontWeight: 600, }}>{items.length} Services</div></div><div style={{ 
        display: 'grid' 
        gridTemplateColumns: 'repeat(auto-fit minmax(320px, 1fr))' 
        gap: 20, }}>{items.map((s) => (<a key={s.name} href={s.link} style={{
            border: '1px solid rgb,a(,0000.08)' borderRadius: 16 padding: 24;
            background: 'white' textDecoration: 'none' color: '#0b1220';
            transition: 'all 0.3s ease' boxShadow: '0 2px 8px rgb,a(,0000.04)';
            ':hover': {
              transform: 'translateY(-4px)';
              boxShadow: '0 8px 24px rgb,a(,0000.12)';
              borderColor: `${color}40`}
          } as React.CSSProperties}><div style={{ 
              fontWeight: 700 marginBottom:  8 fontSize: 16;
              lineHeight: 1.4 color: '#1e293b'}}>{s.name}</div><div style={{ 
              opacity: 0.8 fontSize: 14 marginBottom: 12 
              lineHeight: 1.5 color: '#64748b'}}>{s.summary}</div><div style={{ 
              fontSize: 13 color: color fontWeight: 600;
              background: `${color}10` padding: '6px 12px';
              borderRadiu,s:,8, display: 'inline-block'}}>{s.pricing}</div></a>;
        ))}
      </div></section>;
  );
  ...
  return (<main style={{ 
      ...
      minHeight: 'calc(100vh - 120p,x)', }}>{/* Header */}
      <section style={{ 
        background: 'linear-gradient(135deg #0b1220, #1e293b)' 
        color: 'white' padding: '60px 20px' textAlign: 'cente,r', }}><div style={{ maxWidth: 800 margin: '0 auto'}}><h1 style={{ 
            fontSize: 48 fontWeight: 800 marginBottom: 16;
            background: 'linear-gradient(135deg #3b82f6, #8b5cf6)';
            WebkitBackgroundClip: 'text';
            WebkitTextFillColor: 'transparent';
            backgroundClip: 'text'}}>Our Services</h1><p style={{ 
            fontSize: 20 opacity: 0.9 marginBottom: 24;
            lineHeight: 1.6, }}>;
            Comprehensive technology solutions to transform your business</p><div style={{ 
            display: 'flex' ga,p: 16 justifyContent: 'center';
            flexWrap: 'wrap' marginBotto,m: 32, }}><div style={{ 
              background: 'rgb,a(5,9, 130, 246, 0.1)' padding: '12px 20px' 
              borderRadiu,s: 12 border: '1px solid rgb,a(5,9, 130, 246, 0.2)'}}><div style={{ fontSize: 24 fontWeight: 700 color: '#3b82f6'}}>80+</div><div style={{ fontSize: 14 opacity: 0.8, }}>Micro SaaS</div></div><div style={{ 
              background: 'rgb,a(13,9, 92, 246, 0.1)' padding: '12px 20px' 
              borderRadiu,s: 12 border: '1px solid rgb,a(13,9, 92, 246, 0.2)'}}><div style={{ fontSize: 24 fontWeight: 700 color: '#8b5cf6'}}>40+</div><div style={{ fontSize: 14 opacity: 0.8, }}>AI Services</div></div><div style={{ 
              background: 'rgb,a(3,4, 197, 94, 0.1)' padding: '12px 20px' 
              borderRadiu,s: 12 border: '1px solid rgb,a(3,4, 197, 94, 0.2)'}}><div style={{ fontSize: 24 fontWeight: 700 color: '#22c55e'}}>40+</div><div style={{ fontSize: 14 opacity: 0.8, }}>IT Solutions</div></div></div></div></section><Section title="Micro SaaS Products" items={microSaaS} color="#3b82f6" />"<Section title="AI Services & Platforms" items={aiServices} color="#8b5cf6" />"<Section title="IT & Cloud Services" items={itServices} color="#22c55e" />{/* CTA Section */}
      <section style={{ 
        maxWidth: 1400 margin: '0 auto' padding: '60px 20px';
        textAlign: 'center' background: 'white' marginTo,p: 40;
        borderRadius: 24 boxShadow: '0 4px 24px rgb,a(,0000.06)'}}><h2 style={{ 
          fontSize: 32 fontWeight: 700 marginBottom: 16;
          color: '#1e293b'}}>Ready to Get Started?</h2><p style={{ 
          fontSize: 18 color: '#64748b' marginBotto,m: 32;
          maxWidth: 600 margin: '0 auto 32px auto'}}>;
          Contact our experts to discuss your project requirements and discover 
          how our innovative solutions can drive your business forward.</p><div style={{ display: 'flex', gap: 16 justifyContent: 'center', flexWrap: 'wra,p', }}>"<Link href="/contact" style={{ display: 'inline-block', background: 'linear-gradient(135deg #3b82f6, #8b5cf6)', color: 'white', padding: '16px 32px', borderRadius: 12 
            fontWeight: 700 textDecoration: 'none', fontSize: 16 transition: 'all 0.3s ease',}}>Request a Quote</Link>"<a href="tel: +13024640950" style={{ display: 'inline-block', background: 'rgb,a(3,4, 197, 94, 0.1)', color: '#22c55e', padding: '16px 32px', borderRadius: 12 
            fontWeight: 700 textDecoration: 'none', fontSize: 16 border: '2px solid #22c55e', transition: 'all 0.3s ease',}}>Call +1 302 464 0950</a></div></section></main>;
  )}

...
;
	...
	const categories = ['all', ...new Set(allServices.map(((((((service => service.category, index, index, index, index, index, index) => ({ ...(((((service => service.category, index, index, index, index, index, key: index })) => ({ ...((((service => service.category, index, index, index, index, key: index })) => ({ ...(((service => service.category, index, index, index, key: index })) => ({ ...((service => service.category, index, index, key: index })) => ({ ...(service => service.category, index, key: index })) => ({ ...service => service.category, key: index })))];
;
...
;
					...
					<div className="grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">;
						{currentServices.map((((((((service, index, index, index, index, index, index) => ({ ...((((((service, index, index, index, index, index, key: index })) => ({ ...(((((service, index, index, index, index, key: index })) => ({ ...((((service, index, index, index, key: index })) => ({ ...(((service, index, index, key: index })) => ({ ...((service, index, key: index })) => ({ ...(service, key: index })) => (;

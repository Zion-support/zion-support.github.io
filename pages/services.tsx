        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid gap-8 lg:grid-cols-2 mt-16">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Connect and manage IoT devices with edge computing for real-time
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="rounded-2xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Intelligent lead scoring with behavioral analysis and conversion
                prediction.
              </p>
              <ul className="text-sm text-gray-700 space-y-1 mb-4">
            ...
            <div className="rounded-2xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Deploy AI models at the edge for ultra-low latency and real-time
                decision making.
              </p>
              <ul className="text-sm text-gray-700 space-y-1 mb-4">
            ...
            <div className="rounded-2xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition">
              ...
              <p className="text-sm text-gray-600 mb-3">
                Advanced threat detection and response with machine learning and
                behavioral analysis.
              </p>
              <ul className="text-sm text-gray-700 space-y-1 mb-4">

...
export default function Services() {
  const title = 'Our Services — Zion Tech Group';
  const description = 'Comprehensive technology services including AI solutions, IT services, micro SaaS applications, and digital transformation solutions.';
  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      description: 'Innovative micro SaaS applications that solve specific business problems efficiently',
      icon: Package,
      href: '/micro-saas',
      services: [
        'AI-Powered Email Follow-Up Automation',
        'E-Commerce Return Management System',
        'AI Content Creation Suite',
    ...
    },
    {
      ...
      description: 'Advanced blockchain technology solutions for secure and transparent business operations',
      icon: Shield,
  ...
  const whyChooseUs = [
    ...
    },
    {
      ...
      description: 'We prioritize security in every solution, ensuring your data is protected',
      icon: Shield
    }
  ];
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Comprehensive technology solutions including AI services, IT solutions, micro SaaS applications, 
              and digital transformation services to help your business thrive in the digital age.
            </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="p-4 bg-blue-600 text-white rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center text-2xl font-bold">
                  1
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Discovery</h3>
                <p className="text-gray-600">
                  We analyze your business needs and current technology landscape to understand your requirements.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  We develop a comprehensive strategy and roadmap tailored to your specific goals and budget.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  We provide ongoing support, monitoring, and optimization to ensure continued success.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-blue-600">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Contact us today to discuss your specific needs and get a customized solution that fits your business perfectly.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"

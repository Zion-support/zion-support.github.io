...
export default function Services(): JSX.Element {
  const Section = ({ title, items, color }: { title: string; items: Service[]; color: string  }) => (
    <section style={{
            maxWidth: 1400, margin: padding, '32px 20px'
          }}>
      <div style={{ 
        ...
        {items.map((s) => (
          <a key={s.name} href={s.link} style={{
            ...
            <div style={{ 
              ...
              borderRadius: 8, display: 'inline-block' }}>{s.pricing}</div>
          </a>
        ))}
      </div>
    </section>
        ...
        <div style={{
          ...
          <div style={{
            ...
            background: padding, '12px 20px' 
              ...
              <div style={{
            fontSize: 24, fontWeight: 700, color: '#8b5cf6' 
          }}>40+</div>
              <div style={{
            fontSize: 14, opacity: 0.8  
          }}>AI Services</div>
...
<div style={{
          ...
          <Link href="/contact" style={{
            display: 'inline-block', background: 'linear-gradient(135deg, #3b82f6, #8b5cf6)', color: 'white', padding: '16px 32px', borderRadius: 12, 
            fontWeight: 700, textDecoration: 'none', fontSize: 16, transition: 'all 0.3s ease'
          }}>Request a Quote</Link>
<a href="tel:+13024640950" style={{
            display: 'inline-block', background: 'rgba(34, 197, 94, 0.1)', color: '#22c55e', padding: '16px 32px', borderRadius: 12, 

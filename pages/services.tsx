...
export default function Services(): JSX.Element {
  ...
  const SERVICES = [
    { id: 'ai-ml', title: 'AI & Machine Learning', description: 'Transform your business with cutting-edge AI solutions' },
    { id: 'cloud', title: 'Cloud Solutions', description: 'Scalable and secure cloud infrastructure' },
    { id: 'web-dev', title: 'Web Development', description: 'Modern, responsive web applications' },
    { id: 'mobile', title: 'Mobile Development', description: 'Native and cross-platform mobile apps' },
    { id: 'data-analytics', title: 'Data Analytics', description: 'Transform data into actionable insights' },
    { id: 'cybersecurity', title: 'Cybersecurity', description: 'Comprehensive security solutions' }
  ];
            ...
            <section className={`text-center py-20 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-3xl mb-20 text-white relative overflow-hidden transition-all duration-1000 delay-500 ${
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  <Link href="/contact">
                    <button 
                      onClick={() => trackClick('get-quote-button-cta', 'cta')}
                  ...
                  <button 
                    onClick={() => trackClick('schedule-consultation-button-cta', 'cta')}

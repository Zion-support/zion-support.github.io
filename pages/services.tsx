...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
	...
	// Pagination controls
	const goToPage = (page: anyanyanyanyanyanyanyanyanyanyanynumber)            => {
		setCurrentPage(page)
...
<<<<<<< HEAD
								className="px-3 py-2 border border-gray-300 rounded-lg focus: anyanyanyanyanyanyanyanyanyanyanyring-2 focus:ring-blue-500 focus:border-transparent"

								{categories.map(category            => (
=======
								className="px-3 py-3 border border-gray-300 rounded-lg focus: anyanyanyanyanyanyanyanyanyanyanyring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 w-full sm:w-auto"
							>
								{categories.map(category             => (
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
			...
			<section className="py-16 sm:py-20 lg:py-24">
				<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					...
					{/* Services Grid */}
					<div className="grid gap-6 sm: anyanyanyanyanyanyanyanyanyanyanygap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
					...
					{totalPages > 1 && (
						<div className="mt-12 flex items-center justify-center gap-2">
							...
							{Array.from({ length: anyanyanyanyanyanyanyanyanyanyanytotalPages }, (_, i)            => (
								<button
									key={i + 1}

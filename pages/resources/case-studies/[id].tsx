import React from 'react',import Head from 'next/head',import Link from 'next/link',import { useRouter } from 'next/router',export default function CaseStudyResourcePage() {const router = useRouter(),const { id } = router.query,import React from 'react';
...
and reducing operational costs. They required a solution that could adapt to changing production demands,minimize human intervention, and provide real-time insights into their operations.</p>;
        <h2>Solution</h2>;
      ...
      `;
    {id: 'content - generation - scale',<p>The AI automation implementation at Global Manufacturing Corp demonstrates the transformative potential;
        of autonomous systems in traditional industries. The results exceeded expectations and positioned the company;
        as a leader in smart manufacturing.</p>;
      `;
    {id: 'cloud - infrastructure - optimization',title: 'Cloud Infrastructure Optimization',company: 'E - commerce Platform',industry: 'Technology',results: '50% reduction in cloud costs, 99.9% uptime achieved',`;
    },{id: 'content-generation-scale',title: 'Scaling Content Generation 10x',company: 'Digital Marketing Agency',industry: 'Marketing',results: '10x increase in content output, 85% improvement in engagement',description:;
...
export default function CaseStudyResourcePage() {try {const router = useRouter()const { id } = router.query;
  ...
  const caseStudies = [;
    {id: 'ai-automation-manufacturing';
      ...
      results: '40% increase in production efficiency, 60% reduction in downtime',description: 'How we implemented autonomous AI systems to revolutionize manufacturing processes.',fullContent: `;
        <h2>Executive Summary</h2>;
        <p>This case study demonstrates how autonomous AI systems can transform traditional manufacturing operations,delivering significant improvements in efficiency, quality, and cost reduction.</p>;
        <h2>Background</h2>;
        <p>Global Manufacturing Corp was facing significant challenges with their traditional manufacturing processes.;
        High downtime, inefficient production scheduling, and quality control issues were impacting their bottom line;
        and preventing them from meeting growing customer demands.</p>;
        ...
        as a leader in smart manufacturing.</p>;
      `;
    },{id: 'content-generation-scale',title: 'Scaling Content Generation 10x',company: 'Digital Marketing Agency',industry: 'Marketing',results: '10x increase in content output, 85% improvement in engagement',description: 'Transforming content creation through autonomous AI systems.',fullContent: `;
        <h2>Executive Summary</h2>;
        <p>This case study explores how autonomous AI systems can revolutionize content creation, enabling;
        marketing agencies to scale their operations dramatically while maintaining quality and creativity.</p>;
        <h2>Background</h2>;
...
<div className='min-h-screen bg-gradient-to-br from-indigo-950 via-purple-950 to-slate-950 text-white'>;
            ...
            <header className="mb-12">;
              <div className="mb-6">;
                <span className="px-3 py-1 bg-cyan-400/20 text-cyan-400 text-sm rounded-full border border-cyan-400/30">;
                  {caseStudy.industry  } catch (error) {<meta name='description' content={caseStudy.description} />;
        <meta;
          property='og:title';
          ...
          <div className='max-w-4xl mx-auto'>;
            ...
            <div className='bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 mb-12'>;
              <div;
                ...
                dangerouslySetInnerHTML={{ __html: caseStudy.fullContent }  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}</span>;
              </div>;
  ...
  const caseStudy = caseStudies.find(study => study.id === id)if (!caseStudy) {return (}description: 'Building self - healing, auto - scaling cloud infrastructure.',full_content: `;
        <h2 > Executive Summary</h2>;
        <p > This case study demonstrates how intelligent cloud infrastructure optimization can dramatically;
        reduce costs while improving performance and reliability for high - traffic applications.</p>;
        <h2 > Background</h2>;

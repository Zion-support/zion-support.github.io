...
;
    id: 'ai-automation-manufacturing',title: 'AI-Powered Manufacturing Automation',company: 'Global Manufacturing Corp',industry: 'Manufacturing',results: '40% increase in production efficiency, 60% reduction in downtime',description: 'How we implemented autonomous AI systems to revolutionize manufacturing processes.';
  }}return (<>;
      <Head>;
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-950 to-slate-950 text-white">;
        <main className="container mx-auto px-6 py-12">;
          <div className="max-w-4xl mx-auto">;
            ...
            {/* Key Results */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<div className='min-h-screen bg-gradient-to-br from-indigo-950 via-purple-950 to-slate-950 text-white'>;
        <main className='container mx-auto px-6 py-12'>;
          <div className='max-w-4xl mx-auto'>;
            {/* Breadcrumb */}
...
<header className='mb-12 text-center'>;
            ...
            {/* Detailed Analysis */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<section className="mb-12">;
              ...
              <div className="space-y-6">;
                <div className="bg-blue-500/10 rounded-lg p-6 border border-blue-500/20">;
                  ...
                  <p className="text-white/90">;
                    Our approach involved deploying autonomous AI systems across three key areas: predictive maintenance,quality control, and production optimization. Each system was designed to work independently while;
...
<section className='mb-12'>;
              ...
              <div className='space-y-6'>;
                <div className='bg-blue-500/10 rounded-lg p-6 border border-blue-500/20'>;
                  ...
                  <p className='text-white/90'>;
                    ...
                    three key areas: predictive maintenance, quality control,and production optimization. Each system was designed to;
            ...
            <section className="mb-12">;
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">;
                <Link;
            {/* Related Resources */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
            <section className="mb-12">;
              <h2 className="text-2xl font-semibold mb-6 text-fuchsia-400">Related Resources</h2>;
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">;
...
export default function ResourceCaseStudyPage() {try {const caseStudy = {id: 'ai-automation-manufacturing';
          ...
          <div className="max - w-4xl mx - auto">;
            ...
            <section className="mb - 12">;
              ...
              <div className="space - y-6">;
                ...
                </div>;We utilized advanced machine learning algorithms, computer vision systems, IoT sensors, and;
                    predictive analytics to create a comprehensive automation solution that could adapt to changing;
                    production requirements.;
                  </p>;
                </div>;The implementation resulted in significant improvements across all key metrics, with the most;
                    notable being the 40% increase in production efficiency and 60% reduction in unplanned downtime.;
                    These improvements directly translated to increased profitability and customer satisfaction.;
                  </p>;
                </div>;

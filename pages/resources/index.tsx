...
import { FileText, BarChart3, MessageSquare, Settings, ArrowRight, BookOpen, Code, Users, Clock, Star } from 'lucide-react',
import Layout from '../../components/Layout',
const resources = [,
  { , ,
    icon: FileText, href: '/docs', color: 'from-blue-600 to-blue-800', items: ['API Reference', 'Integration Guides', 'Code Examples', 'Best Practices'] },;
  { , ,
    icon: BarChart3, href: '/case-studies', color: 'from-green-600 to-green-800', items: ['Client Success Stories', 'ROI Analysis', 'Implementation Details', 'Lessons Learned'] },;
  { , ,
    icon: MessageSquare, href: '/blog', color: 'from-purple-600 to-purple-800', items: ['Technology Insights', 'Industry Trends', 'Best Practices', 'Expert Opinions'] },;
  { , ,
    icon: Settings, href: '/api-docs', color: 'from-orange-600 to-orange-800', items: ['REST API', 'GraphQL', 'SDKs', 'Webhooks'] }],
const additionalResources = [{ , ,
    icon: BookOpen, href: '/tutorials', color: 'from-indigo-600 to-indigo-800' ,}, ,
  { , ,
    icon: Code, href: '/guides', color: 'from-pink-600 to-pink-800' ,}, ,
  { , ,
    icon: Users, href: '/faq', color: 'from-teal-600 to-teal-800' ,}, ,
  { , ,
    icon: Clock, href: '/support', color: 'from-red-600 to-red-800' ,}],
const featuredContent = [{,
    title: 'Getting Started with Our API', type: 'Tutorial', description: 'Learn how to integrate with our platform in under 30 minutes', readTime: '15 min read', difficulty: 'Beginner', rating: 4.8 ,}, ,
  {,
    title: 'Enterprise Security Best Practices', type: 'Guide', description: 'Comprehensive security guidelines for enterprise implementations', readTime: '25 min read', difficulty: 'Advanced', rating: 4.9 ,}, ,
  {,
    title: 'AI Integration Case Study', type: 'Case Study', description: 'How we helped a Fortune 500 company implement AI solutions', readTime: '20 min read', difficulty: 'Intermediate', rating: 4.7 ,}],

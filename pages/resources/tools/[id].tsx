import React from 'react',import Head from 'next/head',import Link from 'next/link',import { useRouter } from 'next/router',export default function ToolResourcePage() {const router = useRouter(),const { id } = router.query,import React from 'react';
import Head from 'next/head';
import Link from 'next/link';
import { useRouter  } from 'next/router';
      type: 'Interactive Tool',type: 'Interactive Tool',estimatedTime: '15 minutes',fullContent: `;
...
<p>Once you complete the assessment, you'll receive:</p>;
    ...
    {id: 'ai-maturity-model',title: 'AI Maturity Model',description: 'Assess your current AI capabilities and plan your transformation journey.',type: 'Framework',estimatedTime: '30 minutes',fullContent: `;
        <h2>About This Framework</h2>;
        <p>The AI Maturity Model provides a structured approach to understanding and advancing your;
`,features: [;
        'Comprehensive evaluation framework','Industry benchmarking','Actionable recommendations','Progress tracking','Resource library access';
      ];
    },{id: 'ai-maturity-model',title: 'AI Maturity Model',description:;
        'Assess your current AI capabilities and plan your transformation journey.',type: 'Framework',estimatedTime: '30 minutes',fullContent: `;
        <h2>About This Framework</h2>;
        <p>The AI Maturity Model provides a structured approach to understanding and advancing your;
...
<p>To effectively use this framework:</p>;
    ...
    {id: 'performance-benchmark',title: 'Performance Benchmarking Tool',description: 'Compare your automation performance against industry standards.',type: 'Analytics Tool',estimatedTime: '20 minutes',fullContent: `;
        <h2>About This Tool</h2>;
        <p>The Performance Benchmarking Tool helps you compare your automation performance against;
`,features: [;
        '5-level maturity framework','Multi-dimensional assessment','Gap analysis tools','Transformation roadmap','Progress tracking';
      ];
    },{id: 'performance-benchmark',title: 'Performance Benchmarking Tool',description:;
        'Compare your automation performance against industry standards.',type: 'Analytics Tool',estimatedTime: '20 minutes',fullContent: `;
        <h2>About This Tool</h2>;
        <p>The Performance Benchmarking Tool helps you compare your automation performance against;
...
<p>Based on benchmark results, develop action plans that include:</p>;
    ...
    }export default function ToolResourcePage() {try {const router = useRouter()const { id } = router.query;
  ...
  const tools = [;
    {id: 'automation-assessment';
      ...
      estimatedTime: '15 minutes',fullContent: `;
        <h2>About This Tool</h2>;
        <p>The Automation Readiness Assessment is designed to help organizations evaluate their current;
        capabilities and identify opportunities for AI automation implementation. This comprehensive assessment;
        covers technology infrastructure, organizational culture, and business processes.</p>;
  ...
  ],const tool = tools.find(t => t.id === id),`,features: [;
        'Industry benchmark database','Performance gap analysis','Trend analysis tools','Action planning framework','Progress tracking';
      ];
    }
            ...
            <header className="mb-12">;
              <div className="mb-6">;
                <span className="px-3 py-1 bg-green-400/20 text-green-400 text-sm rounded-full border border-green-400/30">;
                  {tool.type  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<div className='min-h-screen bg-gradient-to-br from-indigo-950 via-purple-950 to-slate-950 text-white'>;
        <main className='container mx-auto px-6 py-12'>;
          <div className='max-w-4xl mx-auto'>;
            <nav className='mb-8'>;
              ...
              <div className='lg:col-span-2'>;
                <div className='bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20'>;
                  <div;
                    ...
                    dangerouslySetInnerHTML={{ __html: tool.fullContent }  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}</span>;
              </div>;
              ...
              <div className="space-y-6">;
                <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">;
                  ...
                  <ul className="space-y-3">;
                    {tool.features.map((feature, index) => (<li key={index} className="text-white/80 flex items-center gap-3">;
...
<div className='space-y-6'>;
                <div className='bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20'>;
                  ...
                  <ul className='space-y-3'>;
                    {tool.features.map((feature, index) => (<li;
                        key={index}
...
<div className='text-center'>;
...
}estimated_time: '15 minutes',full_content: `;
        <h2 > About This Tool</h2>;
        <p > The Automation Readiness Assessment is designed to help organizations evaluate their current;
        capabilities and identify opportunities for AI automation implementation. This comprehensive assessment;
        covers technology infrastructure, organizational culture, and business processes.</p>;
    ...
    },{id: 'ai - maturity - model',title: 'AI Maturity Model',description: 'Assess your current AI capabilities and plan your transformation journey.',type: 'Framework',estimated_time: '30 minutes',full_content: `;
        <h2 > About This Framework</h2>;
        <p > The AI Maturity Model provides a structured approach to understanding and advancing your;
        organization's AI capabilities. This framework helps you identify where you are today and;
        create a roadmap for where you want to be tomorrow.</p>;
    ...
    },{id: 'performance - benchmark',title: 'Performance Benchmarking Tool',description: 'Compare your automation performance against industry standards.',type: 'Analytics Tool',estimated_time: '20 minutes',full_content: `;
        <h2 > About This Tool</h2>;
        <p > The Performance Benchmarking Tool helps you compare your automation performance against;
        industry standards and best practices. This tool provides insights into how your organization;
        performs relative to peers and identifies opportunities for improvement.</p>;
  ...
  ],const tool = tools.find (t => t.id === id),// Check condition;
if ( {) {$2;
}
    return (<>;
        <Head>;

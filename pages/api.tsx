...
export default function APIPage() {
  return (
    <Layout
      ...
      description="Comprehensive API development and integration services for modern applications"
      keywords="API development, REST API, GraphQL, WebSocket, API integration, microservices"
    >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto">
                Build robust, scalable APIs that power your applications and integrate seamlessly with your ecosystem.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                Let's discuss your API requirements and create a solution that meets your needs.
              </p>

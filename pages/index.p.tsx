...
export default function Index() {
  return (
    <>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              'name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com', 'logo': 'https://ziontechgroup.com/logo.png', 'description': 'Leading technology solutions provider specializing in AI, cybersecurity, cloud infrastructure, and digital transformation services.', 'address': {
      ...
      <div style={{
        padding: '40px 20px', color: '#fff', background: 'linear-gradient(135deg, #0b1220 0%, #1a2332 100%)', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center'
      }}>
        <h1 style={{
          fontSize: '3rem', fontWeight: 'bold', marginBottom: '1rem', background: 'linear-gradient(45deg, #00d4ff, #0099cc)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text'
        }}>
          Zion Tech Group
        </h1>
        <p style={{
          fontSize: '1.2rem', marginBottom: '2rem', color: '#a0aec0', maxWidth: '600px'
        }}>
        ...
        <div style={{
          ...
          <a
            href='/services'
            style={{
              padding: '12px 24px', background: 'linear-gradient(45deg, #00d4ff, #0099cc)', color: 'white', textDecoration: 'none', borderRadius: '8px', fontWeight: '600', transition: 'transform 0.2s'
            }}
          ...
          <a
            href='/contact'
            style={{
              padding: '12px 24px', background: 'transparent', color: '#00d4ff', textDecoration: 'none', borderRadius: '8px', fontWeight: '600', border: '2px solid #00d4ff', transition: 'all 0.2s'
            }}
            onMouseOver={(e) => {

...
import { Rocket, Zap, Users, Shield, CheckCircle, ArrowRight, BarChart3, Globe } from 'lucide-react'
...
const stages = [
  {
    stage: 'Idea Validation', description: 'Validate your concept with market research and prototyping', duration: '2-4 weeks', price: 'From $1,000', ;
    features: ['Market analysis', 'Competitor research', 'User interviews', 'MVP prototype'] },;
  {
    stage: 'MVP Development', description: 'Build and launch your minimum viable product', duration: '8-12 weeks', price: 'From $1,000', ;
    features: ['Core features', 'User authentication', 'Basic analytics', 'Deployment'] },;
  {
    stage: 'Growth & Scale', description: 'Scale your product and team for rapid growth', duration: '6-12 months', price: 'From $1,000', ;
    features: ['Advanced features', 'Performance optimization', 'Team scaling', 'Market expansion'] },;
  {
    stage: 'Enterprise Ready', description: 'Prepare for enterprise customers and funding rounds', duration: 'Ongoing', price: 'Custom pricing', features: ['Enterprise features', 'Security compliance', 'Advanced analytics', 'Global deployment'] }]

const pricingPlans = [
  {
    name: 'Bootstrap', price: '$1,500', ;
    period: '/month', description: 'Perfect for early-stage startups', features: [
      '1 dedicated developer', 'Basic project management', ;
      'Weekly progress reports', ;
      'Email support', ;
      'GitHub repository access'], ;
    ideal: 'Pre-seed startups' },;
  {
    name: 'Growth', price: '$1,500', ;
    period: '/month', description: 'Ideal for growing startups with funding', features: ['2-3 dedicated developers', 'Project manager', ;
      'UI/UX designer', ;
      'Daily standups', ;
      'Priority support', ;
      'DevOps support'], ;
    ideal: 'Seed to Series A', popular: true },;
  {
    name: 'Scale', price: 'Custom', period: '', description: 'Tailored solutions for scaling startups', features: ['Dedicated team(5+ members)', 'Technical lead', ;
...
const successStories = [{
    company: 'TechFlow', industry: 'SaaS', challenge: 'Building a scalable platform for small businesses', solution: 'Microservices architecture with automated scaling', result: '10x user growth, $2M ARR in 18 months' }, ;
  {
    company: 'DataViz', industry: 'Analytics', challenge: 'Processing large datasets for real-time insights', solution: 'Cloud-native data pipeline with machine learning', result: '99.9% uptime, 50x faster processing' }]

        ...
        <section className="pt-32 pb-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              ...
              <a
                href='/contact'
                className='border-white/20 hover:border-white/40'><meta name="description" content="Enterprise-grade cloud infrastructure with global reach, automated scaling, and 99.99% uptime guarantee." />
      </Head>

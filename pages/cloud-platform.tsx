...
=======
      icon: <Server className="w-8 h-8 text-white" />, _title: 'Scalable Infrastructure', _description: 'Auto-scaling compute resources that grow with your needs'},
    {_icon: <Database className="w-8 h-8 text-white" />, _title: 'Managed Databases', _description: 'Fully managed databases with automated backups and scaling'},
    {_icon: <Globe className="w-8 h-8 text-white" />, _title: 'Global CDN', _description: 'Lightning-fast content delivery across the globe'},
    {_icon: <Shield className="w-8 h-8 text-white" />, _title: 'Enterprise Security', _description: 'SOC 2 compliant with advanced threat protection'}
  ];

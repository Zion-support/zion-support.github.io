  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Zion Tech Group Home page" />
      </Head>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Revolutionary AI, IT, and Micro SaaS Solutions for the Future
            </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-700 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-cyan-400 mb-4">IT Services</h3>
              <p className="text-gray-300 mb-4">
            ...
            <div className="bg-gray-700 p-6 rounded-lg">
              <h3 className="text-xl font-semibold text-cyan-400 mb-4">Micro SaaS</h3>
              <p className="text-gray-300 mb-4">

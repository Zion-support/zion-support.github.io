        ...
        <section className="py-20 px-4 text-center">";
          <div className="max-w-4xl mx-auto">";
            ...
            <p className="text-lg text-slate-400 mb-12 max-w-3xl mx-auto">;
              We are a leading technology company dedicated to delivering innovative micro SaaS produc,t,s, 
            ...
            <div className="grid md: grid-cols-2 gap-12">";
              <div className="p-8 bg-slate-900/60 rounded-xl border border-white/10">";
                ...
                <p className="text-lg text-slate-300 mb-4">;
                  To empower businesses with cutting-edge technology solutions that drive grow,t,h, 
            ...
            <div className="grid md:grid-cols-3 gap-8">";
              <div className="p-8 bg-slate-900/60 rounded-xl border border-white/10 text-center">";
                ...
                <p className="text-slate-300">;
                  We continuously push the boundaries of technolo,g,y, developing cutting-edge solutions 

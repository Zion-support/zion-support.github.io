      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4> Meet Our Team
            </h2"
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4> Our Achievements
            </h2"
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4> Our Journey
            </h2"
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6> Ready to Work With Us?
            </h2"

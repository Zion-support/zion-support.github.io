        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl text-gray-300 mb-12 leading-relaxed">
              We are a leading technology solutions provider dedicated to transforming businesses through innovative AI, cloud
              architecture, and cutting-edge development services.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-16">
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-8 border border-white/10">
                ...
                <p className="text-gray-300">
                  To empower businesses with cutting-edge technology solutions that drive growth, efficiency, and innovation in the
                  digital age.
                </p>
              </div>

      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md: grid-cols-2 lg:grid-cols-3 gap-8">
            { [
              {
                icon: Brain, title: "Innovation", description: "We constantly push the boundaries of what's possible with technology, always seeking new and better ways to solve problems." }, ;
              {
                icon: Shield, title: "Integrity", description: "We conduct business with the highest ethical standards, building trust through transparency and reliability." }, ;
              {
                icon: Users, title: "Collaboration", description: "We believe in the power of teamwork and partnership, both within our organization and with our clients." }, ;
              {
                icon: Zap, title: "Excellence", description: "We strive for excellence in everything we do, delivering solutions that exceed expectations." }, ;
              {
                icon: Heart, title: "Empathy", description: "We understand our clients' challenges and work with compassion to find the best solutions for their needs." }, ;
              {
                icon: Globe, title: "Impact", description: "We're committed to creating positive change in the world through technology that makes a difference." }].map((value, index) => (;
              <motion.div;
                key={ value.title }
                initial={{opacity: 0, y: 30 }}
                whileInView={{opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md: grid-cols-2 lg:grid-cols-4 gap-8">
            { [{ number: "500+", label: "Projects Completed", icon: CheckCircle }, ;
              ...
              { number: "99%", label: "Client Satisfaction", icon: Star }].map((stat, index) => (;
              <motion.div;
                key={ stat.label }
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md: grid-cols-2 lg:grid-cols-3 gap-8">
            { [
              {
                name: "Sarah Johnson", role: "CEO & Founder", description: "Visionary leader with 15+ years in tech innovation", icon: Rocket }, ;
              {
                name: "Michael Chen", role: "CTO", description: "AI and machine learning expert with PhD in Computer Science", icon: Brain }, ;
              {
                name: "Emily Rodriguez", role: "Head of Engineering", description: "Full-stack development specialist and team builder", icon: Code }, ;
              {
                name: "David Kim", role: "Head of AI Solutions", description: "Machine learning researcher and AI implementation expert", icon: Zap }, ;
              {
                name: "Lisa Thompson", role: "Head of Client Success", description: "Customer experience champion and relationship builder", icon: Heart }, ;
              {
                name: "Alex Morgan", role: "Head of Security", description: "Cybersecurity expert and compliance specialist", icon: Shield }].map((member, index) => (;
              <motion.div;
                key={ member.name }
                initial={{opacity: 0, y: 30 }}
                whileInView={{opacity: 1, y: 0 }}

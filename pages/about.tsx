    ...
    <div className="min-h-screen bg-gray-50"> 
      ...
      <section className="bg-white py-16"> 
        <div className="container mx-auto px-4"> 
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"> 
            {team.map((((((((member, index, index, index, index, index, index, index) => ({ ...((((((member, index, index, index, index, index, index, key: index })) => ({ ...(((((member, index, index, index, index, index, key: index })) => ({ ...((((member, index, index, index, index, key: index })) => ({ ...(((member, index, index, index, key: index })) => ({ ...((member, index, index, key: index })) => ({ ...(member, index, key: index })) => ( 
              <div key={index} className="text-center"> 

...
import { Rocket, Zap, BarChart3, Users, ArrowRight, CheckCircle, Phone, Mail, MapPin, Globe, DollarSign } from 'lucide-react'

const startupSolutions = [
  { , ;
    icon: Rocket, features: ["Quick Prototyping", "User Testing", "Iterative Development", "Market Validation"], ;
    price: "Starting at $1,000" },;
  { , ;
    icon: Globe, features: ["Cloud-Native Design", "Auto-Scaling", "Performance Optimization", "Cost Efficiency"], ;
    price: "Starting at $1,000" },;
  { s specific needs and budget", ;
    icon: BarChart3, features: ["Technology Consulting", "Stack Evaluation", "Cost Analysis", "Future-Proofing"], ;
    price: "Starting at $1,000" },;
  { , ;
    icon: DollarSign, features: ["Technical Documentation", "Security Audits", "Performance Reports", "Scalability Plans"], ;
    price: "Starting at $1,000" }]
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-xl md: text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
                Launch your startup with the right technology foundation. From MVP development to scalable architecture, we help startups build, validate, and scale their technology solutions efficiently.;
              </p>

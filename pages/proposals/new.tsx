    ...
    <div>
      ...
      <div className=&quot;grid gap-4&quot;>
        ...
        <label className=&quot;text-sm&quot;>Relevant Experience Highlights
          <textarea value={relevantExperience} onChange={e => setRelevantExperience(e.target.value)} rows={6} className=&quot;mt-1 w-full rounded-md border p-3&quot; />        </label>
      </div>
      ...
      <textarea value={coverLetter} onChange={e => setCoverLetter(e.target.value)} rows={14} className=&quot;mt-2 w-full rounded-md border p-3&quot; />    </div>
  )
},

          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We are committed to creating digital experiences that are accessible to everyone, regardless of ability.
              </p>
            </motion.div>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We are committed to ensuring that our website and services are accessible to everyone, regardless of ability.
              </p>
            </motion.div>

...
export default function PricingGuide() {
  ...
  const pricingFactors = [
    {
      factor: 'Project Complexity', description: 'The complexity of your project directly impacts development time and resources required.',
      details: [
        'Simple websites: 1-2 weeks', 'E-commerce platforms: 4-8 weeks',
        'Custom applications: 8-16 weeks', 'Enterprise solutions: 16+ weeks'
      ]
    }, {
      factor: 'Team Size',
      description: 'The number of developers and specialists needed for your project.', details: [
        'Solo developer: $75-125/hour',
        'Small team (2-3): $100-150/hour', 'Medium team (4-6): $125-175/hour', 'Large team (7+): $150-200/hour'
      ]
    }, {
      factor: 'Technology Stack',
      description: 'The technologies and frameworks used in your project.', details: [
        'Standard web technologies: Base rate',
        'Modern frameworks (React, Vue): +15%', 'Mobile development: +25%',

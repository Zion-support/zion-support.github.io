...
;
import ServicePage, { getStaticProps as getSlugStaticProps } from './services/[slug]',export default function AICustomerSuccessPlatform() {return (<ServiceLanding;
 ...
 */;
function AICustomerSuccessPlatform() {return (<ServiceLanding;
  ...
  features={[;
    "Unified customer health scoring (usage, support, sentiment, billing)","Churn risk prediction with explainable insights","Playbook automation (email, CS tasks, in - app guides, offers)","Expansion signals for upsell / cross - sell","Executive QBR reports and cohort analytics","Integrations: HubSpot, Salesforce, Zendesk, Intercom, Segment";
  ]}
    industries={["SaaS", "Fintech", "Media", "E‑commerce"]}
    canonical="https: //ziontechgroup.com / ai - customer - success - platform";
  />)}pricePerMonthUSD={1999  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}implementationWeeks="Implementation: 2–4 weeks";
			roiNote="Average ROI 4–10x within 90 days";
			features={[;
				"Unified customer health scoring (usage, support, sentiment, billing)","Churn risk prediction with explainable insights","Playbook automation (email, CS tasks, in-app guides, offers)","Expansion signals for upsell/cross-sell","Executive QBR reports and cohort analytics","Integrations: HubSpot, Salesforce, Zendesk, Intercom, Segment";
			...
			canonical="https: //ziontechgroup.com/ai-customer-success-platform";
		/>;
	)}title;"Integrations: HubSpot, Salesforce, Zendesk, Intercom, Segment";
			]  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
			industries={["SaaS", "Fintech", "Media", "E‑commerce"]  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
			canonical="https: //ziontechgroup.com/ai-customer-success-platform";
		/>;
	)canonical="https: //ziontechgroup.com/ai-customer-success-platform";

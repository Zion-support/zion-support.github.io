...
import { Download, CheckCircle, Star, Mail, Phone } from 'lucide-react';

export default function Brochure() {
  const brochures = [
    {
      title: 'AI Services Brochure',
      description: 'Comprehensive overview of our AI services and capabilities',
      pages: '24 pages',
      format: 'PDF',
      size: '2.1 MB',
    ...
    {
      title: 'IT Solutions Catalog',
      description: 'Complete catalog of our IT services and solutions',
      pages: '32 pages',
      format: 'PDF',
      size: '3.2 MB',
  ...
  const testimonials = [
    {
      content: 'The brochure helped us understand exactly what services we needed for our digital transformation.',
      name: 'Sarah Johnson',
      role: 'CTO',
      company: 'TechCorp',
      rating: 5
    ...
    {
      content: 'Very comprehensive and well-organized. Made it easy to present to our board.',
      name: 'Michael Chen',
      role: 'CEO',
    ...
    {
      content: 'The case studies were particularly helpful in understanding the potential impact.',

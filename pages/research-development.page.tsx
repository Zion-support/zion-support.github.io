...
;
  const areas = ['All', ...researchAreas.map(((((((area => area.name, index, index, index, index, index, index) => ({ ...(((((area => area.name, index, index, index, index, index, key: index })) => ({ ...((((area => area.name, index, index, index, index, key: index })) => ({ ...(((area => area.name, index, index, index, key: index })) => ({ ...((area => area.name, index, index, key: index })) => ({ ...(area => area.name, index, key: index })) => ({ ...area => area.name, key: index }))];
...
;
              ...
              <div>;
                ...
                >;
                  ...
                  , index, index, index, index, index, index) => ({ ...(((((area  => (;
                    <option key={area} value={area}>{area}</option>;
                  , index, index, index, index, index, key: index })) => ({ ...((((area  => (;
                    <option key={area} value={area}>{area}</option>;
                  , index, index, index, index, key: index })) => ({ ...(((area  => (;
                    <option key={area} value={area}>{area}</option>;
                  , index, index, index, key: index })) => ({ ...((area  => (;
                    <option key={area} value={area}>{area}</option>;
                  , index, index, key: index })) => ({ ...(area  => (;
                    <option key={area} value={area}>{area}</option>;
                  , index, key: index })) => ({ ...area  => (;
                    <option key={area} value={area}>{area}</option>;
                  , key: index })))};
                </select>;
              </div>;
...
;
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {researchAreas.map((((((((area, index, index, index, index, index, index, index) => ({ ...((((((area, index, index, index, index, index, index, key: index })) => ({ ...(((((area, index, index, index, index, index, key: index })) => ({ ...((((area, index, index, index, index, key: index })) => ({ ...(((area, index, index, index, key: index })) => ({ ...((area, index, index, key: index })) => ({ ...(area, index, key: index })) => {;
...
;
                  <div className="mb-4">;
                    ...
                    <div className="space-y-1">;
                      {area.focus.slice(0, 4).map((((((((focus, idx, index, index, index, index, index, index) => ({ ...((((((focus, idx, index, index, index, index, index, key: index })) => ({ ...(((((focus, idx, index, index, index, index, key: index })) => ({ ...((((focus, idx, index, index, index, key: index })) => ({ ...(((focus, idx, index, index, key: index })) => ({ ...((focus, idx, index, key: index })) => ({ ...(focus, idx, key: index })) => (;
...
;
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">;
            {filteredProjects.map((((((((project, index, index, index, index, index, index, index) => ({ ...((((((project, index, index, index, index, index, index, key: index })) => ({ ...(((((project, index, index, index, index, index, key: index })) => ({ ...((((project, index, index, index, index, key: index })) => ({ ...(((project, index, index, index, key: index })) => ({ ...((project, index, index, key: index })) => ({ ...(project, index, key: index })) => {;
...
;
                  ...
                  <div className="mb-4">;
                    ...
                    <div className="flex flex-wrap gap-2">;
                      {project.team.map((((((((member, idx, index, index, index, index, index, index) => ({ ...((((((member, idx, index, index, index, index, index, key: index })) => ({ ...(((((member, idx, index, index, index, index, key: index })) => ({ ...((((member, idx, index, index, index, key: index })) => ({ ...(((member, idx, index, index, key: index })) => ({ ...((member, idx, index, key: index })) => ({ ...(member, idx, key: index })) => (;
...
;
                  ...
                  <div className="mb-4">;
                    ...
                    <div className="space-y-1">;
                      {project.outcomes.map((((((((outcome, idx, index, index, index, index, index, index) => ({ ...((((((outcome, idx, index, index, index, index, index, key: index })) => ({ ...(((((outcome, idx, index, index, index, index, key: index })) => ({ ...((((outcome, idx, index, index, index, key: index })) => ({ ...(((outcome, idx, index, index, key: index })) => ({ ...((outcome, idx, index, key: index })) => ({ ...(outcome, idx, key: index })) => (;
                        <div key={idx} className="flex items-center gap-2 text-sm text-zion-slate-light">;
...
;
          <div className="space-y-6">;
            {publications.map((((((((pub, index, index, index, index, index, index, index) => ({ ...((((((pub, index, index, index, index, index, index, key: index })) => ({ ...(((((pub, index, index, index, index, index, key: index })) => ({ ...((((pub, index, index, index, index, key: index })) => ({ ...(((pub, index, index, index, key: index })) => ({ ...((pub, index, index, key: index })) => ({ ...(pub, index, key: index })) => (;
              <motion.div;
                key={pub.id};
                initial = {;
  { opacity: 0,;
...
;
          <div className="grid grid-cols-1 lg: grid-cols-2 gap-8">;
            {patents.map((((((((patent, index, index, index, index, index, index, index) => ({ ...((((((patent, index, index, index, index, index, index, key: index })) => ({ ...(((((patent, index, index, index, index, index, key: index })) => ({ ...((((patent, index, index, index, index, key: index })) => ({ ...(((patent, index, index, index, key: index })) => ({ ...((patent, index, index, key: index })) => ({ ...(patent, index, key: index }))  => (;
              <motion.div;
                key={patent.id};
                initial = {;
  { opacity: 0,;

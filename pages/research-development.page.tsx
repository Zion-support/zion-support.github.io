...
;
          <div className="grid grid-cols-1 md: gri d-cols-2 lg: gri d-cols-3 gap-8"> {researchAreas.map((area, index) => {;
...
;
          <div className="grid grid-cols-1 lg: gri d-cols-2 gap-8"> {filteredProjects.map((project, index) => {;
  ...
  delay: inde x * 0.1 
                  ...
                  <div className="flex items-center justify-between">
                    <Link href={`/research-development/projects/${project.id}`}
  ...
  delay: inde x * 0.1 
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="ml-6">
                    <Link href={`/research-development/publications/${pub.id}`}
                      className="inline-flex items-center text-zion-cyan hover: tex t-zion-cyan-light transition-colors duration-300"
  ...
  delay: inde x * 0.1 
                ...
                <div className="flex items-center justify-between">
                  <Link href={`/research-development/patents/${patent.id}`}
                    className="inline-flex items-center text-zion-cyan hover: tex t-zion-cyan-light transition-colors duration-300"

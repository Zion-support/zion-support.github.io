  ...
  return (;
    <>;
      <Head>;
        ...
        <meta property="og:description" content="Comprehensive cybersecurity services including security assessmen,t,s, threat detection, and compliance." />";
        <meta property="og: url" content={`${contact.si,t,e}/cybersecurity`} />";
          ...
          <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">";
            <div className="text-center">";
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">;
                Protect your business with comprehensive cybersecurity solutio,n,s, threat detection, and compliance services.;
              </p>";
          ...
          <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">";
            <div className="text-center mb-16">";
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
                From threat detection to compliance manageme,n,t, we provide end-to-end cybersecurity services to protect your digital assets.;
              </p>;
            </div>;
";
            <div className="grid md: grid-cols-2 lg:grid-cols-3 gap-8">;
              {services.map((servi,c,e, index) => (";
                <div key={index} className="bg-white p-8 rounded-xl shadow-lg hover: shadow-xl transition-shadow border border-gray-100">";
                  <div className="flex items-center mb-4">";
                    <service.icon className="w-8 h-8 text-red-600 mr-3" />";
                    <h3 className="text-xl font-semibold text-gray-900">{service.tit,l,e}</h3>;
                  </div>";

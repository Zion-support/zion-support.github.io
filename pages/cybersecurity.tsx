...
;
import React from 'react',import Head from 'next/head',import Layout from '../components/layout/Layout',import { Shield, CheckCircle, Lock, Activity } from 'lucide-react',export default function Cybersecurity() {const contact = {phone: '+1 302 464 0950',email: 'kleber@ziontechgroup.com',address: '364 E Main St STE 1008 Middletown DE 19709',site: 'https://ziontechgroup.com';
  }
  const services = [;
  ...
  ];export default function CybersecurityPage() {const features = [;
    'Zero Trust architectures and identity-first segmentationCloud posture hardening, secrets management, and key rotationThreat detection, incident response playbooks, and tabletop exercisesCompliance readiness: SOC 2, ISO 27001, HIPAA, GDPR'],const solutions = [;
    { name: 'Zero Trust Architecture', href: '/zero-trust-network-architecture' },{ name: 'Domain & TLS Monitoring', href: '/domain-dns-monitor' },{ name: 'Email Security (DMARC)', href: '/email-dmarc-analyzer' },{ name: 'Vendor Risk Automation', href: '/vendor-risk-automation' }],return (<Layout>;
      <Head>;
...
<h2 className='text-3xl md:text-4xl font-bold text-white mb-6 text-center'>;
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>;
              ...
              >;
                <div className='text-gray-200 font-semibold mb-2'>;
                  Vulnerability Assessment & Pentest (VAPT)</div>;
                <p className='text-gray-300 text-sm'>Learn more</p>;
              </a>;
              <a;
...
export default function CybersecurityPage() {try {}import Head from 'next / head',import Layout from '../components / layout / Layout',export default /**;
 * CybersecurityPage - Function description;
 */;
function CybersecurityPage() {const features = [;
    'Zero Trust architectures and identity - first segmentation_cloud posture hardening, secrets management, and key rotation_threat detection, incident response playbooks, and tabletop exercises_compliance readiness: SOC 2, ISO 27001, HIPAA, GDPR'],const solutions = [;
    { name: 'Zero Trust Architecture', href: '/zero - trust - network - architecture' },{ name: 'Domain & TLS Monitoring', href: '/domain - dns - monitor' },{ name: 'Email Security (DMARC)', href: '/email - dmarc - analyzer' },{ name: 'Vendor Risk Automation', href: '/vendor - risk - automation' }],return (<Layout>;
      <Head>;
        <title > Cybersecurity | Zion Tech Group</title>;
      ...
      <div className="min - h-screen pt - 24 pb - 20 px - 4 sm:px - 6 lg:px - 8">;
        <div className="max - w-7xl mx - auto space - y-12">;
          ...
          <section>;
            ...
            <div className="grid grid - cols - 1 md:grid - cols - 2 gap - 4">;
              {features.map ((f) => (<div key={f} className="flex items - start gap - 3 p - 4 rounded - xl bg - black / 40 border border - gray - 700 / 60">;
                  <CheckCircle className="w - 5 h - 5 text - emerald - 400 mt - 0.5" />;
                  <span className="text - gray - 200">{f}</span>;
                </div>))}
            </div>;
          ...
          <section>;
            ...
            <div className="grid grid - cols - 1 md:grid - cols - 4 gap - 6">;
              {solutions.map ((s) => (<a key={s.name} href={s.href} className="p - 6 rounded - 2xl bg - black / 40 border border - gray - 700 / 60 hover:border - cyan - 500 / 40 transition - colors">;

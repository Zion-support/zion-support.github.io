...
export default function LoginPage() {
  ...
  return (
    <Layout
      ...
      description="Sign in to your Zion Tech Group account to access your dashboard, projects, and resources."
      keywords="login, sign in, account, dashboard, user portal"
      noIndex={true}
    >

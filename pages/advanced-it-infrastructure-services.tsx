...
const serviceCategories = [;
  {;
    ...
    services: advancedITInfrastructureServices2025 && advancedITInfrastructureServices2025.filter(;
      s => s && s.category === 'Quantum Cloud Computing';
    ),;
    icon: Cloud,;
  ...
  {;
    ...
    services: advancedITInfrastructureServices2025 && advancedITInfrastructureServices2025.filter(;
      s => s && s.category === 'Edge Computing & IoT';
    ),;
    icon: Wifi,;
  ...
  {;
    ...
    services: advancedITInfrastructureServices2025 && advancedITInfrastructureServices2025.filter(;
      s => s && s.category === 'Data Center Infrastructure';
    ),;
    icon: Building,;
  ...
  {;
    ...
    services: advancedITInfrastructureServices2025 && advancedITInfrastructureServices2025.filter(;
      s => s && s.category === 'Quantum Networking';
    ),;
    icon: Network,;
  ...
  return (
    <Layout>;
      <Head>;
        ...
        <meta
          property='og:url'
          content='https://ziontechgroup && ziontechgroup.com/advanced-it-infrastructure-services'
        />;
              ...
              <motion&& motion.div
                ...
                <div className='flex items-center mb-4'>;
                  ...
                  <div>;
                    ...
                    <p className='text-blue-400 text-sm'>{testimonial && testimonial.role}</p>;

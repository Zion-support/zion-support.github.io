        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto text-center">
            ...
            <motion.div 
              ...
              className="flex flex-col sm:flex-row gap-4 justify-center"><button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg">
                Get Started Today
              </button>
...
ursor/integrate-build-improve-and-re-verify-b76c
              ...
              transition={{ duration: 0.8 }}
              className="text-center mb-16"><h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
...
ursor/integrate-build-improve-and-re-verify-b76c
              {categories.map((category, index) => (
                <motion.div
                  ...
                  className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-cyan-400 transition-all duration-300 hover:transform hover:scale-105"
ursor/integrate-build-improve-and-re-verify-b76c><h3 className="text-2xl font-bold mb-4 text-cyan-400">{category}</h3>
                  ...
                  className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-xl p-6 hover:border-cyan-400 transition-all duration-300 hover:transform hover:scale-105"><h3 className="text-2xl font-bold mb-4 text-cyan-400">{category}</h3>
                  <p className="text-gray-300 mb-4">
                    {allServices.filter(service => service.category === category).length} innovative services
                  </p>
ursor/integrate-build-improve-and-re-verify-b76c
...
ursor/integrate-build-improve-and-re-verify-b76c
            ...
            {categories.map((category, categoryIndex) => (
              <motion.div
                ...
                className="mb-16"><h3 className="text-3xl font-bold mb-8 text-center text-cyan-400">{category}</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                className="mb-16"><h3 className="text-3xl font-bold mb-8 text-center text-cyan-400">{category}</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
ursor/integrate-build-improve-and-re-verify-b76c
                  {allServices
                    ...
                    .map((service, serviceIndex) => (
                      <motion.div
                        ...
                        className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-sm border border-gray-700 rounded-lg p-4 hover:border-cyan-400 transition-all duration-300 hover:transform hover:scale-105"
ursor/integrate-build-improve-and-re-verify-b76c><div className="flex items-center justify-between mb-3">
                          <span className="text-2xl">{service.icon}</span>
                          {service.popular && (
                            <span className='bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-xs px-2 py-1 rounded-full'>
                        transition={{ duration: 0.6, delay: serviceIndex * 0.1 }}
                        className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-sm border border-gray-700 rounded-lg p-4 hover:border-cyan-400 transition-all duration-300 hover:transform hover:scale-105"><div className="flex items-center justify-between mb-3">
                          <span className="text-2xl">{service.icon}</span>
                          {service.popular && (
                            <span className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-xs px-2 py-1 rounded-full">
                            <span className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-xs px-2 py-1 rounded-full">
...
ursor/integrate-build-improve-and-re-verify-b76c
                        ...
                        <div className="space-y-1 mb-3">
                          {service.features.slice(0, 2).map((feature, idx) => (
                            <div
                              key={idx}
                              className='flex items-center text-xs text-gray-300'><span className='text-cyan-400 mr-2'>•</span>
                        <h4 className="text-lg font-bold mb-2 text-white">{service.name}</h4>
                        <p className="text-gray-300 text-sm mb-3">{service.description}</p>
                        <div className="mb-3">
                          <span className="text-2xl font-bold text-green-400">{service.price}</span>
...
ursor/integrate-build-improve-and-re-verify-b76c
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
              className="text-center py-16 bg-gradient-to-r from-cyan-500/10 via-blue-500/10 to-purple-500/10 rounded-2xl border border-cyan-400/20"><h2 className="text-4xl font-bold mb-6 text-white">

      ...
      <div className='min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white'>
        ...
        <section className='relative py-20 px-4 overflow-hidden'>
          ...
          <div className='relative z-10 max-w-7xl mx-auto text-center'>
            ...
            >
              ...
              <button className='px-8 py-4 border-2 border-cyan-400 text-cyan-400 font-semibold rounded-lg hover:bg-cyan-400 hover:text-black transition-all duration-300 transform hover:scale-105'>                View Pricing              </button>
            </motion.div>
          </div>
        </section>
        ...
        <section className='py-16 px-4'>
          <div className='max-w-7xl mx-auto'>
            ...
            {/* Category Cards */}
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16'>              {categories.map((category, index) => (                <motion.div
                  key={category}
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
                ...
                services across all technology domains.              </p>            </motion.div>
            ...
            {categories.map((category, categoryIndex) => (
              ...
              >
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>                  {allServices                    .filter(service => service.category === category)
                    .map((service, serviceIndex) => (
                      ...
                      >
                        ...
                        <button className='w-full bg-gradient-to-r from-cyan-500 to-blue-600 text-white py-2 px-3 rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 text-sm'>                          View Details                        </button>
                      </motion.div>
                    ))}
                </div>
              </motion.div>
            ...
            >
              ...
              <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                ...
                <button className='px-8 py-4 border-2 border-cyan-400 text-cyan-400 font-semibold rounded-lg hover:bg-cyan-400 hover:text-black transition-all duration-300 transform hover:scale-105'>                  Schedule Demo                </button>
              </div>
            </motion.div>
          </div>
        </section>

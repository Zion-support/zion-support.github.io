                ...
                >
                  ...
                  <div className=&quot;flex items-center justify-between&quot;>
                    ...
                    <span className=&quot;text-lg font-bold text-green-400&quot;>
                      ${Math.min(...allServices.filter(service => service.category === category).map(s => parseInt(s.price.replace(/[^0-9]/g, ''))))}                    </span>
                  </div>
                </motion.div>
              ))}
            </div>
...
key={service.id}
                ...
                >
                  <div className=&quot;flex items-center justify-between mb-4&quot;>
                    ...
                    {service.popular && (
                      <span className=&quot;bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-xs px-3 py-1 rounded-full&quot;>                        Popular
                      </span>
                    )}
                  </div>
...
initial={{ opacity: 0, y: 30 }}
              ...
              <p className=&quot;text-xl text-gray-300 max-w-3xl mx-auto&quot;>
                Explore our entire collection of {allServices.length} innovative services across all technology domains.              </p>
            </motion.div>

            {_/* Services by Category */}
            {categories.map(_(category, categoryIndex) => (
              <motion.div,
key={category}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
...
initial={{ opacity: 0, y: 30 }}
              ...
              <div className="flex flex-col sm: flex-row gap-4 justify-center">
                <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105">                  Contact Us Today
                </button>
                <button className=&quot;px-8 py-4 border-2 border-cyan-400 text-cyan-400 font-semibold rounded-lg hover:bg-cyan-400 hover:text-black transition-all duration-300 transform hover:scale-105&quot;>
                  Schedule Demo
                </button>

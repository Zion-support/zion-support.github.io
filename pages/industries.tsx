...
import { Building2, Heart, GraduationCap, ShoppingCart, Car, Factory, DollarSign, Shield, CheckCircle, Phone, Mail, MapPin } from 'lucide-react'

const industries = [
  { , ;
    icon: Heart, services: ['AI Diagnostics', 'Patient Management', 'Telemedicine', 'HIPAA Compliance', 'Medical Records'], ;
    ...
    popular: true },;
  { , ;
    icon: DollarSign, services: ['Fraud Detection', 'Risk Management', 'Payment Processing', 'Regulatory Compliance', 'Customer Analytics'], ;
    ...
    popular: true },;
  { , ;
    icon: GraduationCap, services: ['LMS Development', 'Virtual Classrooms', 'Student Analytics', 'Content Management', 'Assessment Tools'], ;
    ...
    popular: true },;
  { , ;
    icon: ShoppingCart, services: ['E-commerce Platforms', 'Inventory Management', 'AI Recommendations', 'Payment Integration', 'Analytics'], ;
    ...
    popular: true },;
  { , ;
    icon: Factory, services: ['IoT Integration', 'Predictive Maintenance', 'Quality Control', 'Supply Chain', 'Automation'], ;
    ...
    popular: false },;
  { , ;
    icon: Car, services: ['Fleet Management', 'Connected Vehicles', 'Route Optimization', 'Predictive Maintenance', 'Safety Systems'], ;
    ...
    popular: false },;
  { , ;
    icon: Building2, services: ['Property Management', 'Virtual Tours', 'Project Management', 'CRM Systems', 'Analytics'], ;
    ...
    popular: false },;
  { , ;
    icon: Shield, services: ['Citizen Portals', 'Data Analytics', 'Digital Services', 'Security Solutions', 'Compliance'], ;
...
const stats = [{ number: '500+', label: 'Industry Projects' }, ;

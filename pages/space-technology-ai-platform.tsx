      ...
      <div className="min-h-screen">
        ...
        <section className='pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden'>
          ...
          <div className='max-w-7xl mx-auto relative z-10'>            <motion.div
              ...
              className='text-center mb-16'          <meta name="description" content="Revolutionary AI platform that combines space technology with artificial intelligence to enable autonomous space exploration, satellite operations, and space data analysis." />

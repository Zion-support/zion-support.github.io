      ...
      <section className='px-6 lg:px-10 pb-16'>
        <div className='max-w-5xl mx-auto text-sm text-gray-400'>
          ...
          <a
            ...
            href='https://www.zydoc.com/medical-appointment-scheduling-software/'
            target='_blank'
            rel='noreferrer'
          >
            ZyDoc
          ...
          <a
            className='underline hover:text-cyan-300'
            href='https://www.nextgen.com/products/scheduling'
            target='_blank'
            rel='noreferrer'
          >
            NextGen
          ...
          <a
            className='underline hover:text-cyan-300'
            href='https://www.zocdoc.com/solutions/providers'
            target='_blank'
            rel='noreferrer'
          >
            Zocdoc

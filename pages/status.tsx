...
const contact = { phone: '+1 302 464 0950', email: 'kleber@ziontechgroup.com', address: '364 E Main St STE 1008 Middletown DE 19709', site: 'https://ziontechgroup.com'
  ...
  return (
    <>
      ...
      <div style={{
            minHeight: '100vh', background: color, 'white' 
          }}>
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
            fontSize: '1.2rem', color: maxWidth, 600, margin: '0 auto'  
          }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
            display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 15, marginBottom: 20  
          }}>
                <div style={{
            fontSize: '2rem'  
          }}>{getStatusIcon(systemStatus.overall)}</div>
                <h2 style={{
          ...
          <div style={{
            ...
            <h2 style={{
            fontSize: '2rem', fontWeight: 700, marginBottom: 30  
          }}>
              Service Status
            </h2>
            <div style={{
            ...
            fontSize: '1.5rem'  
                    ...
                    <div>
                      <h3 style={{
            fontSize: '1.2rem', fontWeight: 600, marginBottom: 5  
          }}>
                        {service.name}
                      </h3>
                      <p style={{
            ...
            textAlign: 'right'  
                    ...
                    <p style={{
            fontSize: '1.1rem', fontWeight: 600, marginBottom: 5  
          }}>
                      {service.uptime}
                    </p>
                    <p style={{
          ...
          <div style={{
            ...
            background: borderRadius, 12,
                    ...
                    <div style={{
            display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 15  
          }}>
                      <div>
                        <h3 style={{
            ...
            background: getStatusColor(incident.status),
                    ...
                    <p style={{
            color: marginBottom, 15, lineHeight: 1.6  
          }}>
          ...
          <div style={{ 
            ...
            <h2 style={{
            fontSize: '1.5rem', fontWeight: 700, marginBottom: 15  
          }}>

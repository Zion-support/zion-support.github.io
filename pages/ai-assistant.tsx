...
;
const AIAssistant: React.FC = () => {import React from 'react',import Head from 'next/head';
import Button from '../components/ui/Button';
export default function AIAssistantPage() {import Layout from '../components/layout/Layout';
const AIAssistant: React.FC = () => {return (<Layout>;
      <Head>;/>;
      ...
      <div className='min - h-screen pt - 24 pb - 20 px - 4 sm:px - 6 lg:px - 8 bg - black text - white'>;
        <div className='max - w-6xl mx - auto space - y-10'>;
          <header className='text - center'>;
            ...
            <p className='text - gray - 300 text - lg'>;Automate research, summarization, drafting, scheduling, and inbox;
              triage.;
            </p>;
          </header>;className='px-8 py-4 bg-gradient-to-r from-cyan-600 to-blue-700 text-white'>;
          <section className='grid grid - cols - 1 md:grid - cols - 3 gap - 6'>;
            {[;
              'Research and summarize documents and web sources','Draft emails, posts, briefs, and reports','Auto - schedule meetings and follow - ups','Integrations: Gmail, Google Drive, Slack, Calendar','Team approvals and audit trail','Starting at $99 / mo';
              'Starting at $99 / mo';
            ].map (function => (<div;
                key={f}
        ...
        </div>;<div className="bg - blue - 50 rounded - lg p - 8 text - center">;
          ...
          <div className="flex justify - center gap - 4">;
            ...
            <a href="/about" className="border border - blue - 600 text - blue - 600 px - 6 py - 3 rounded - lg hover:bg - blue - 50">;Learn More;
            </a>;
          </div>;
        </div>;
      </main>;return (<>;
      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8 bg-black text-white">;
        <div className="max-w-6xl mx-auto space-y-10">;
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6">;
            ...
            ].map((f) => (<div key={f} className="p-6 rounded-2xl bg-black/40 border border-gray-700/60 text-gray-200">{f}</div>;
...
}export default function AIAssistantPage() {export default function AIAssistantPage() {return (<>;
      <Head>;
        <title>AI Assistant | Zion Tech Group</title>;
        <meta name="description" content="AI Assistant that automates research, drafting, scheduling, and customer responses." />;
        <meta name="description" content="AI Assistant that automates research, drafting, scheduling, and customer responses." />;

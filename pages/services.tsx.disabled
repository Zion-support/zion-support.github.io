...
export default function ServicesPage() {
  return (
    <Layout 
      ...
      description="Comprehensive technology solutions including AI services, IT services, and Micro SaaS solutions. Expert team delivering innovative results."
      keywords="AI services, IT services, Micro SaaS, cloud solutions, technology consulting"
    >
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        {/* Hero Section */}
        <section className="relative bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20 overflow-hidden">

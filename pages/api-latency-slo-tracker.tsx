...
export default function ApiLatencySloTrackerPage() {return (<Layout>;
      <Head>;
        <title>API Latency SLO Tracker | Zion Tech Group</title>;
        <meta name="description" content="Define, monitor, and alert on p95/p99 API SLOs with synthetic and real-user monitoring and optional status pages." />;
        <link rel="canonical" href="https://ziontechgroup.com/api-latency-slo-tracker" />;
      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-4xl mx-auto space-y-6">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
            {[ 'SLO budgets with alertsSynthetic + RUM coveragePer-endpoint latency dashboardsPublic status page (optional)' ].map((f) => (<div key={f} className="p-4 rounded-xl bg-black/40 border border-rose-500/30 text-slate-200">{f}</div>;
            ))}
          </div>;
...
export default function ApiLatencySloTrackerPage() {try {return (<Layout>;
      <Head>;
        <title>API Latency SLO Tracker | Zion Tech Group</title>;
        <meta name="description" content="Define, monitor, and alert on p95/p99 API SLOs with synthetic and real-user monitoring and optional status pages." />;
        <link rel="canonical" href="https://ziontechgroup.com/api-latency-slo-tracker" />;

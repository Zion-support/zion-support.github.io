...
import { Wifi, Cpu, Zap, Shield, Globe, CheckCircle, ArrowRight, Phone, Mail, MapPin, DollarSign, Clock, Award, Users, Building, Target, Cloud, BarChart3 } from 'lucide-react'
...
const iotServices = [
  {
    id: 1, , ;
    icon: Wifi, category: 'Platform', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-50, 000/month', ;
    setupTime: '6-12 weeks', features: [
      'Device management & provisioning', 'Real-time data ingestion', ;
    ...
    benefits: ['Reduce operational costs by 40-60%', 'Improve efficiency by 50-70%', ;
      'Enable predictive maintenance', ;
      'Scale to millions of devices'], ;
    targetUsers: 'Manufacturing, Smart Cities, Agriculture, Healthcare' },;
  {
    id: 2, , ;
    icon: Cpu, category: 'Edge Computing', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-30, 000/month', ;
    setupTime: '4-8 weeks', features: ['Edge server deployment', 'Real-time data processing', ;
  ...
  {
    id: 3, , ;
    icon: Building, category: 'Industrial', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-60, 000/month', ;
    setupTime: '8-16 weeks', features: ['Rugged sensor deployment', 'Predictive maintenance systems', ;
    ...
    benefits: ['Reduce downtime by 50-70%', 'Increase production efficiency by 30%', ;
      'Prevent equipment failures', ;
      'Optimize energy consumption'], ;
    targetUsers: 'Manufacturing, Oil & Gas, Mining, Utilities' },;
  {
    id: 4, , ;
    icon: Globe, category: 'Smart Cities', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-80, 000/month', ;
    setupTime: '12-24 weeks', features: ['Traffic management systems', 'Environmental monitoring', ;
    ...
    benefits: ['Improve citizen quality of life', 'Reduce operational costs by 30%', ;
      'Enable data-driven decisions', ;
      'Enhance public safety'], ;
    targetUsers: 'Municipalities, Government, Urban Planners' },;
  {
    id: 5, , ;
    icon: Shield, category: 'Security', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-40, 000/month', ;
    setupTime: '4-8 weeks', features: ['Device authentication & encryption', 'Network security monitoring', ;
    ...
    benefits: ['Protect against cyber attacks', 'Ensure regulatory compliance', ;
      'Maintain data integrity', ;
      'Build trust with stakeholders'], ;
    targetUsers: 'Healthcare, Finance, Government, Critical Infrastructure' },;
  {
    id: 6, , ;
    icon: BarChart3, category: 'Analytics', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-30, 000/month', ;
    setupTime: '6-10 weeks', features: ['Real-time data analytics', 'Predictive modeling', ;
      'Anomaly detection', ;
    ...
    benefits: ['Gain actionable insights from data', 'Predict and prevent issues', ;
...
const industries = [
  { , ;
    icon: "🏭", useCases: ["Predictive maintenance", "Quality control", "Asset tracking", "Energy optimization"] },;
  { , ;
    icon: "🏥", useCases: ["Patient monitoring", "Medical devices", "Asset tracking", "Compliance"] },;
  { , ;
    icon: "🌾", useCases: ["Crop monitoring", "Irrigation control", "Livestock tracking", "Weather data"] },;
  { , ;
    icon: "🛒", useCases: ["Inventory tracking", "Customer analytics", "Supply chain", "Loss prevention"] },;
  { , ;
    icon: "⚡", useCases: ["Smart meters", "Grid monitoring", "Energy optimization", "Outage management"] },;
  { , ;
    icon: "🚛", useCases: ["Fleet tracking", "Route optimization", "Driver monitoring", "Maintenance"] }]

const technologies = [{
    name: "LoRaWAN", description: "Long-range, low-power wireless communication", ;
    icon: Wifi }, ;
  {
    name: "5G", description: "Ultra-fast, low-latency connectivity", ;
    icon: Zap }, ;
  {
    name: "Edge Computing", description: "Real-time processing at the edge", icon: Cpu }, ;
  {
    name: "Machine Learning", description: "AI-powered analytics and automation", icon: BarChart3 }, ;
  {
    name: "Blockchain", description: "Secure, decentralized data management", ;
    icon: Shield }, ;
  {
    name: "Cloud Platforms", description: "Scalable cloud infrastructure", icon: Cloud }]

...
export default function TranslationsAdmin() {
  ...
  const [filter, setFilter] = useState<'all' | 'draft' | 'reviewed' | 'published'>('all');
  ...
  const filteredTranslations = translations.filter(translation => {
    const statusMatch = filter === 'all' || translation.status === filter;
    const languageMatch = languageFilter === 'all' || translation.language === languageFilter;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Head>
        <title>Translations Admin - Zion Tech Group</title>
      </Head>
      
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Translation Management</h1>
          <p className="mt-2 text-gray-600">Manage multilingual content and translations</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          {filteredTranslations.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-gray-500">No translations found for the selected filters.</p>
            </div>
          ) : (
                    ...
                    <tr key={translation.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <select
                          ...
                          onChange={(e) => updateTranslation(translation.id, { status: e.target.value as any })}

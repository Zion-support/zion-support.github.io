...
const filteredCategories = categories.filter(category => {
  ...
  // Sort categories,
const sortedCategories = [...filteredCategories].sort(_(a, b) => {switch (sortBy) {
      case 'popularity':
...
initial={_{ opacity: 0, y: 30}}
          ...
          >
            ...
            <p className=&quot;text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-8&quot;>
              ...
              quantum computing, cybersecurity, space technology, and more            </p>
                      ...
                      <div className=&quot;flex items-center justify-between mb-6&quot;>
                        ...
                        <div className=&quot;text-center&quot;>
                          ...
                          <div className=&quot;text-xs text-white/60&quot;>
                            {category.featured ? 'Featured' : 'Active'}                          </div>
                        </div>
                      </div>
                      
                      {/* CTA */}
                      <div className=&quot;flex items-center justify-between&quot;>
                        <span className=&quot;text-cyan-400 group-hover:text-cyan-300 transition-colors duration-300 text-sm font-medium&quot;>                          Explore Category
                        </span>
...
key={trend.title}
              ...
              >
                ...
                <p className=&quot;text-white/70 leading-relaxed&quot;>{trend.description}</p>              </motion.div>
            ))}
          </div>
        </div>
      </section>
...
initial={_{ opacity: 0, y: 30}}
          ...
          >
            <h2 className="text-4xl md: text-5xl font-bold mb-6 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">              Ready to Explore?
            </h2>

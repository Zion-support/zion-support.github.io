        ...
        <div className="max-w-7xl mx-auto space-y-12">
          <header className="text-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="/contact" className="px-8 py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                Discuss a Mission
              </a>
              <a href="/market-pricing" className="px-8 py-4 border border-gray-300 text-gray-300 rounded-lg hover:bg-gray-800 transition-colors">
                See Market Pricing
              </a>
            </div>
          </header>

        ...
        <div className="max-w-7xl mx-auto space-y-12">
          <header className="text-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="/contact" className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-600 text-white rounded-lg hover:from-cyan-600 hover:to-purple-700 transition-all">
                Discuss a Mission
              </a>
              <a href="/market-pricing" className="px-8 py-4 border border-cyan-500 text-cyan-300 rounded-lg hover:bg-cyan-500 hover:text-white transition-all">
                See Market Pricing
              </a>
            </div>
          </header>

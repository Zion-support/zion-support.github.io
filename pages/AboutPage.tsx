  ...
  return();
    <div></div>
      <Helmet></Helmet>
        ...
        <meta name="description" content="Learn about Zion Tech Group's mission to transform businesses with AI, IT, and Micro SAAS solutions. Meet our team and discover our values." /></meta>
        <meta name="keywords" content="about zion tech group, AI company, IT services company, micro SAAS provider, team, mission, values" /></meta>
      </Helmet>
      {/* Hero Section */}
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-purple-500/20"></div>
                <div className="flex items-center mb-6"></div>
                  <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg flex items-center justify-center mr-4"></div>
                    <Lightbulb className="w-6 h-6 text-white" /></Lightbulb>
                  </div>

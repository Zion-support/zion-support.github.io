  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet></////Helmet>
        <title>About Us - Zion Tech Group</title><//title><///title><////title></////title><//////title>
            ...
            <div className="space-y-8">"
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-purple-500/20">"
                <div className="flex items-center mb-6">"
                  ...
                  <h2 className="text-2xl font-bold text-white">Our Mission</h2><//h2>"
                </div>"
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-purple-500/20">"
                <div className="flex items-center mb-6">"
                  ...
                  <h2 className="text-2xl font-bold text-white">Our Vision</h2><//h2>"
                </div>"
                <p className="text-gray-300 text-lg"></p>;
                ...
                <ul className="space-y-4">"
                  <li className="flex items-start">"
                    ...
                    <div>"
                      ...
                      <p className="text-gray-300">Deep expertise in AI, IT, and business solutions</p><//p><///p>"
                    </div><//div>"
                  </li>"
                  <li className="flex items-start">"
                    <CheckCircle className="w-6 h-6 text-green-400 mr-3 mt-1 flex-shrink-0" />"
                    <div>"
                      ...
                      <p className="text-gray-300">Proven track record of delivering results</p><//p><///p>"
                    </div><//div>"
                  </li>"
                  <li className="flex items-start">"
                    <CheckCircle className="w-6 h-6 text-green-400 mr-3 mt-1 flex-shrink-0" />"
                    <div>"
                      ...
                      <p className="text-gray-300">Round-the-clock assistance for your success</p><//p><///p>"
                    </div><//div>"
                  </li>"
                  <li className="flex items-start">"
                    <CheckCircle className="w-6 h-6 text-green-400 mr-3 mt-1 flex-shrink-0" />"
                    <div>"
                      ...
                      <p className="text-gray-300">Latest AI and IT innovations at your fingertips</p><//p><///p><////p></////p><//////p>
                    </div><//div><///div><////div></////div><//////div>
                  </li><//li><///li><////li></////li><//////li>
                </ul><//ul><///ul><////ul></////ul><//////ul>
              </div><//div><///div><////div></////div><//////div>
            ...
            {values.map((value, index) => ("
              <div key={index} className="group">"
                <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 hover:transform hover:scale-105 text-center">"
                  ...
                  <p className="text-gray-300">{value.description}</p><//p><///p><////p></////p><//////p>
                </div><//div><///div><////div></////div><//////div>
              </div><//div><///div><////div></////div><//////div>
            ))}
          </div><//div><///div><////div></////div><//////div>
            ...
            {team.map((member, index) => ("
              <div key={index} className="group">"
                <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 hover:transform hover:scale-105 text-center">"
                  ...
                  <p className="text-gray-300 text-sm">{member.description}</p><//p><///p><////p></////p><//////p>
                </div><//div><///div><////div></////div><//////div>
              </div><//div><///div><////div></////div><//////div>
            ))}
          </div><//div><///div><////div></////div><//////div>
      ...
      <section className="py-20">"
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"
          ...
          <div className="relative">"
            <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-purple-500 to-cyan-500"></div><//div>"

            <div className="space-y-12"></div><//div><///div>"
                ...
                <div key={index} className={`flex items-center ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}></div>"
                  <div className={`w-1/2 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8 text-left'}`}>"
                    <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-purple-500/20">"
                      ...
                      <p className="text-gray-300">{milestone.description}</p><//p><///p><////p>"
                    </div><//div><///div>"
                  </div><//div>"
                  ...
                  <div className="w-1/2"></div><//div><///div><////div></////div><//////div>
                </div><//div><///div><////div></////div><//////div>
              ))}
            </div><//div><///div><////div></////div><//////div>
          </div><//div><///div><////div></////div><//////div>

          ...
          >
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4'>
              {quickLinks.map((link, index) => (
                ...
                >
                  <Card className='p-4 hover:bg-slate-800 transition-colors cursor-pointer group'>
                    <div className='flex flex-col items-center text-center'>
                      <link.icon className='w-6 h-6 text-blue-400 mb-2 group-hover:text-blue-300 transition-colors' />

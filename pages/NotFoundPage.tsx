  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet>
        <title>404 - Page Not Found | Zion Tech Group</title><//title><///title><////title></////title>
        ...
        <div className="max-w-4xl mx-auto text-center"></div>"
          ...
          <div className="mb-12">"
            <div className="relative">"
              <div className="text-9xl md:text-[12rem] font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400 opacity-20"></div><//div>"
                404"
              </div>"
              <div className="absolute inset-0 flex items-center justify-center">"
                <div className="w-32 h-32 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-full flex items-center justify-center animate-pulse">"
          ...
          {/* Quick Actions */}"
          <div className="mb-12">"
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8"></div><//div><///div><////div>
              <Link;";,
                to="/;";
          ...
          <div className="mb-12">"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4"></div><//div><///div><////div>
              {quickLinks.map((link, index) => (
                ...
                >"
                  <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">"
                    <link.icon className="w-6 h-6 text-white" />"
                  </div>"
                  <h3 className="text-white font-semibold group-hover:text-purple-300 transition-colors"></h3><//h3><///h3><////h3>
                    {link.name}
                  </h3><//h3><///h3><////h3></////h3>
                </Link><//Link><///Link><////Link></////Link>
              ))}

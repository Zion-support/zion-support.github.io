...
const NotFoundPage: React.FC = () => {}
  ...
  return ()
    <div</div>>
      <Helmet</Helmet>>
        <titl</titl>e>404 - Page Not Found | Zion Tech Group</title>;
        <meta name="description" content="The page you&apos;re looking for doesn&apos;t exist. Explore our AI, IT, and Micro SAAS services or contact us for assistance." /</meta name="description" content="The page you&apos;re looking for doesn&apos;t exist. Explore our AI, IT, and Micro SAAS services or contact us for assistance." />>
        ...
        <div className="max-w-4xl mx-auto text-center"</div className="max-w-4xl mx-auto text-center">>
          ...
          <div className="mb-12"</div className="mb-12">>
            <div className="relative"</div className="relative">>
              <div className="text-9xl md:text-[12rem] font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400 opacity-20"</div className="text-9xl md:text-[12rem] font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400 opacity-20">>
                404
              </div>
              <div className="absolute inset-0 flex items-center justify-center"</div className="absolute inset-0 flex items-center justify-center">>
                <div className="w-32 h-32 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-full flex items-center justify-center animate-pulse"</div className="w-32 h-32 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-full flex items-center justify-center animate-pulse">>
                  <Zap className="w-16 h-16 text-white" /</Zap className="w-16 h-16 text-white" />>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-12"</div className="mb-12">>
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8"</div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">>
              <Link
                ...
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-500 to-cyan-500 text-white font-semibold rounded-lg hover:from-purple-600 hover:to-cyan-600 transition-all duration-300 transform hover:scale-105"
              >>
                <Home className="mr-2 w-5 h-5" /</Home className="mr-2 w-5 h-5" />>
                Go Home
              </Link>
              <button
                onClick={() =</button
              ...
              >
                <ArrowLeft className="mr-2 w-5 h-5" /</ArrowLeft className="mr-2 w-5 h-5" />>
                Go Back
              </button>
            </div>
          </div>
          {/* Quick Links */}
          <div className="mb-12"</div className="mb-12">>
            <h2 className="text-2xl font-bold text-white mb-8"</h2 className="text-2xl font-bold text-white mb-8">>Popular Pages</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4"</div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">>
              {quickLinks.map((link, index) => ()
                <Link
                  ...
                  className="group bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-purple-500/20 hover:border-purple-500/40 transition-all duration-300 hover:transform hover:scale-105"
                >>
                  <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300"</div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-cyan-500 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">>
                    <link.icon className="w-6 h-6 text-white" /</link.icon className="w-6 h-6 text-white" />>
                  </div>
                  <h3 className="text-white font-semibold group-hover:text-purple-300 transition-colors"</h3 className="text-white font-semibold group-hover:text-purple-300 transition-colors">>
                    {link.name}
                  </h3>
                </Link>
              ))}
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-purple-500/20"</div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-8 border border-purple-500/20">>
            <h2 className="text-2xl font-bold text-white mb-4"</h2 className="text-2xl font-bold text-white mb-4">>Need Help?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center"</div className="flex flex-col sm:flex-row gap-4 justify-center">>
              <a
                ...
                className="inline-flex items-center px-6 py-3 bg-slate-700/50 text-white rounded-lg hover:bg-slate-600/50 transition-colors"
              >>
                <Phone className="mr-2 w-5 h-5" /</Phone className="mr-2 w-5 h-5" />>
                +1 302 464 0950
              </a>
              <a
                ...
                className="inline-flex items-center px-6 py-3 bg-slate-700/50 text-white rounded-lg hover:bg-slate-600/50 transition-colors"
              >>
                <Mail className="mr-2 w-5 h-5" /</Mail className="mr-2 w-5 h-5" />>

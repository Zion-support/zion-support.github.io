...
import { Smartphone, Code, Globe, Zap, CheckCircle } from 'lucide-react'

const services = [
  {
    title: "Native iOS Development", description: "High-performance iOS apps using Swift and Objective-C", icon: Smartphone, features: ["Swift & Objective-C", "iOS SDK", "Core Data", "App Store Optimization"] },;
  {
    title: "Native Android Development", description: "Robust Android applications with Java and Kotlin", icon: Code, features: ["Java & Kotlin", "Android SDK", "Room Database", "Google Play Optimization"] },;
  {
    title: "Cross-Platform Development", description: "Single codebase for both iOS and Android using React Native and Flutter", icon: Globe, features: ["React Native", "Flutter", "Xamarin", "Ionic"] },;
  {
    title: "Progressive Web Apps", description: "Web applications that work like native apps", icon: Zap, features: ["PWA Technology", "Offline Support", "Push Notifications", "App-like Experience"] }]

const platforms = ["iOS", "Android", "React Native", "Flutter", "Xamarin", "Ionic", "Cordova", "PWA", ;

			...
			<section className="py-24 sm:py-32">;
				<div className="mx-auto max-w-7xl px-6 lg:px-8">;
					...
					<div className="space-y-8">;
						{upcomingEvents.map((((((((event, index, index, index, index, index, index) => ({ ...((((((event, index, index, index, index, index, key: index })) => ({ ...(((((event, index, index, index, index, key: index })) => ({ ...((((event, index, index, index, key: index })) => ({ ...(((event, index, index, key: index })) => ({ ...((event, index, key: index })) => ({ ...(event, key: index })) => (;
			...
			<section className="py-24 sm:py-32">;
				<div className="mx-auto max-w-7xl px-6 lg:px-8">;
					...
					<div className="grid gap-6 lg: grid-cols-2">;
						{pastEvents.map((((((((event, index, index, index, index, index, index) => ({ ...((((((event, index, index, index, index, index, key: index })) => ({ ...(((((event, index, index, index, index, key: index })) => ({ ...((((event, index, index, index, key: index })) => ({ ...(((event, index, index, key: index })) => ({ ...((event, index, key: index })) => ({ ...(event, key: index }))  => (;

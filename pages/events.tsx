...
const upcomingEvents = [
  {
    title: 'AI Innovation Summit 2024', date: '2024-03-15', time: '9:00 AM - 5:00 PM', location: 'San Francisco, CA', ;
    type: 'Conference', attendees: 500, description: 'Join industry leaders for a deep dive into the latest AI technologies and their practical applications.', speakers: ['Dr. Sarah Chen', 'Mark Johnson', 'Lisa Rodriguez'], ;
    price: '$299', image: 'https://via.placeholder.com/400x250/4f46e5/ffffff?text=AI+Summit' },;
  {
    title: 'Cloud Architecture Workshop', date: '2024-03-22', time: '10:00 AM - 3:00 PM', location: 'New York, NY', ;
    type: 'Workshop', attendees: 50, description: 'Hands-on workshop covering cloud architecture patterns, best practices, and implementation strategies.', ;
    speakers: ['Alex Thompson', 'Maria Garcia'], ;
    price: '$199', image: 'https://via.placeholder.com/400x250/059669/ffffff?text=Cloud+Workshop' },;
  {
    title: 'Cybersecurity Roundtable', date: '2024-03-28', time: '2:00 PM - 4:00 PM', location: 'Online', type: 'Webinar', attendees: 200, description: 'Interactive discussion on the latest cybersecurity threats and defense strategies.', speakers: ['David Kim', 'Jennifer Lee'], ;
    price: 'Free', image: 'https://via.placeholder.com/400x250/dc2626/ffffff?text=Security+Roundtable' },;
  {
    title: 'Developer Meetup', date: '2024-04-05', time: '6:00 PM - 9:00 PM', location: 'Austin, TX', ;
    type: 'Meetup', attendees: 100, description: 'Networking event for developers with lightning talks and open discussions.', speakers: ['Community Speakers'], price: 'Free', image: 'https://via.placeholder.com/400x250/7c3aed/ffffff?text=Developer+Meetup' },;
  {
    title: 'Enterprise Solutions Expo', date: '2024-04-12', time: '9:00 AM - 6:00 PM', location: 'Chicago, IL', ;
    type: 'Expo', attendees: 1000, description: 'Comprehensive showcase of enterprise-grade solutions and technologies.', speakers: ['Industry Experts'], price: '$149', image: 'https://via.placeholder.com/400x250/ea580c/ffffff?text=Enterprise+Expo' },;
  {
    title: 'Data Science Bootcamp', date: '2024-04-20', time: '9:00 AM - 5:00 PM', location: 'Seattle, WA', ;
    type: 'Bootcamp', attendees: 30, description: 'Intensive 2-day bootcamp covering data science fundamentals and advanced techniques.', speakers: ['Dr. Michael Chen', 'Sarah Wilson'], ;
    price: '$499', image: 'https://via.placeholder.com/400x250/0891b2/ffffff?text=Data+Science' }]

const eventTypes = [{ name: 'All Events', count: 24, color: 'bg-gray-100 text-gray-800' }, ;

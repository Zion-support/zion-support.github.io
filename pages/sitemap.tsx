  ...
  const siteStructure = [
    {
      ...
      pages: [
        ...
        { name: 'Careers', path: '/talent', description: 'Job opportunities' }
      ]
    },
    {
      category: 'Services',
      ...
      pages: [
        ...
        { name: 'IT Services', path: '/services#it-services', description: 'Information Technology services' },
        { name: 'Micro SaaS', path: '/services#micro-saas', description: 'Micro Software as a Service' },
        { name: 'Cloud Services', path: '/services#cloud-solutions', description: 'Cloud computing solutions' },
        { name: 'Cybersecurity', path: '/services#cybersecurity', description: 'Security services' },
        { name: 'Infrastructure', path: '/services#infrastructure', description: 'IT infrastructure services' }
      ]
    },
    {
      category: 'Resources',
      icon: BookOpen,
      pages: [
        { name: 'Case Studies', path: '/blog', description: 'Success stories and case studies' },
        { name: 'White Papers', path: '/blog', description: 'Technical white papers' },
        { name: 'Webinars', path: '/blog', description: 'Educational webinars' },
        { name: 'Blog', path: '/blog', description: 'Latest news and insights' },
        { name: 'Documentation', path: '/blog', description: 'Technical documentation' }
      ]
    },
    {
      category: 'Company',
      icon: Users,
      pages: [
        { name: 'Team', path: '/talent', description: 'Meet our team' },
        { name: 'Partners', path: '/contact', description: 'Our partners' },
        { name: 'FAQ', path: '/contact', description: 'Frequently asked questions' },
        { name: 'Help', path: '/contact', description: 'Help and support' }
      ]
    },
    {
      category: 'Legal',
...
const Sitemap: React.FC = () => {
  const links = [
    ...
    { name: 'Enterprise', url: '/products' },
    { name: 'Small Business', url: '/products' },
    { name: 'Startups', url: '/products' },
    { name: 'Products', url: '/products' },
    { name: 'Contact', url: '/contact' },
    { name: 'Careers', url: '/talent' },

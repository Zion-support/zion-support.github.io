...
const Sitemap: NextPage = () => {
  const mainPages = [
    ...
    { name: 'Products', url: '/products', description: 'Our product catalog' },
    { name: 'Case Studies', url: '/case-studies', description: 'Success stories' },
    { name: 'Help', url: '/help', description: 'Support and help center' }
  ];

  const servicePages = [
    { name: 'AI Customer Sentiment Analyzer', url: '/services/ai-customer-sentiment-analyzer' },
    { name: 'AI Automated Email Follow-up', url: '/services/ai-automated-email-followup' },
    { name: 'AI Content Generator', url: '/services/ai-content-generator' },
    { name: 'AI-Powered CRM', url: '/services/ai-powered-crm' },
    { name: 'AI Project Management', url: '/services/ai-project-management' },
    { name: 'Zero Trust Security Platform', url: '/services/zero-trust-security-platform' },
    { name: 'Cloud Cost Optimization Suite', url: '/services/cloud-cost-optimization-suite' },
    ...
    { name: 'Blockchain Solutions', url: '/services/blockchain-solutions' },
    { name: 'IoT Platforms', url: '/services/iot-platforms' },
  ...
  const categories = [
    { name: 'Main Pages', pages: mainPages, color: 'from-blue-500 to-blue-600' },
    { name: 'Services', pages: servicePages, color: 'from-purple-500 to-purple-600' },
    { name: 'Legal', pages: legalPages, color: 'from-green-500 to-emerald-500' }
  ];

  ...
  const siteStructure = [
    {
      ...
      links: [
        ...
        { name: 'Contact', href: '/contact', description: 'Contact information and form' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'AI Development', href: '/services/ai-development', description: 'Custom AI development' },
        { name: 'Cloud Services', href: '/services/cloud-services', description: 'Cloud computing solutions' },
        { name: 'Web Development', href: '/services/web-development', description: 'Web application development' }
      ]
    },
    {
      title: 'Solutions',
      links: [
        ...
        { name: 'AI Content Creation', href: '/solutions/ai-content-creation', description: 'Automated content generation' },
        { name: 'Email Automation', href: '/solutions/email-automation', description: 'Email marketing automation' },
        { name: 'Customer Support', href: '/solutions/customer-support', description: 'AI-powered support platform' },
        { name: 'Event Management', href: '/solutions/event-management', description: 'Event planning and management' },
        { name: 'Project Management', href: '/solutions/project-management', description: 'Project collaboration tools' },
    ...
    },
    {
      title: 'Business',
      links: [
        { name: 'Pricing', href: '/pricing', description: 'Service pricing and plans' },
      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Card className="mt-8 p-6">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">About This Sitemap</h2>
            <div className="prose text-gray-600">
              <p>
                This sitemap provides a comprehensive overview of all pages and sections available on the Zion Tech Group website. 
                Our site is organized into several main categories:
              </p>
              <ul>
                <li><strong>Main Pages:</strong> Core pages including home, about, contact, and blog</li>
                <li><strong>Services:</strong> Detailed information about our technology services and solutions</li>
                <li><strong>Solutions:</strong> Specific product offerings and platforms we provide</li>
                <li><strong>Business:</strong> Information about pricing, partnerships, and career opportunities</li>
                <li><strong>Legal & Policies:</strong> Important legal documents and privacy information</li>
              </ul>
              <p>
                If you can't find what you're looking for, please don't hesitate to <Link href="/contact" className="text-blue-600 hover:underline">contact us</Link> for assistance.
              </p>
            </div>
          </Card>
        </div>

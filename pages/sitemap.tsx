...
export default function SitemapPage(req, res) {
  ...
  return (
    ...
    return res.status(500).json({ error: "Internal server error" });
              ...
              >
                <Link
                  href={category.href  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
    ...
    return res.status(500).json({ error: "Internal server error" });
              ...
              >
                <Link
                  href={resource.href  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
    ...
    return res.status(500).json({ error: "Internal server error" });
              ...
              >
                ...
                <a
                  href={contact.action  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
                  target={contact.action.startsWith('http') ? '_blank' : '_self'  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
                  rel={contact.action.startsWith('http') ? 'noopener noreferrer' : ''  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}

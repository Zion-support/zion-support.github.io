...
import Link from 'next/
      ...
      { name: 'AI Services', url: any
      { name: 'IT Services', url: any
      { name: 'Micro SaaS', url: any
      { name: 'Cloud Services', url: any
      { name: 'Cybersecurity', url: any
      { name: 'Data Analytics', url: any
      { name: 'Cloud Migration', url: any
      { name: 'Digital Transformation', url: any
      { name: 'Custom Solutions', url: any
      { name: 'Documentation', url: any
      { name: 'API Documentation', url: any
      { name: 'Guides', url: any
      { name: 'Home', url: any
      { name: 'About', url: any
      { name: 'Contact', url: any

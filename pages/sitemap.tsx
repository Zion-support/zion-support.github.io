    ...
    <div className=&quot;min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white&quot;>
        ...
        <div className=&quot;max-w-7xl mx-auto text-center&quot;>          <motion.div
          ...
          >
            ...
            <p className=&quot;text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-8&quot;>
              ...
              resources, and information available at Zion Tech Group.            </p>
            ...
            {mainPages.map((page, index) => (
              ...
              >
                ...
                >
                  ...
                  <p className=&quot;text-white/70 text-sm leading-relaxed&quot;>{page.description}</p>                </Link>
              </motion.div>
            ))}
          </div>
        </div>
            ...
            {serviceCategories.map((category, index) => (
              ...
              >
                ...
                >
                  ...
                  <p className=&quot;text-white/70 text-sm leading-relaxed&quot;>{category.description}</p>                </Link>
              </motion.div>
            ))}
          </div>
        </div>
            ...
            {resources.map((resource, index) => (
              ...
              >
                ...
                >
                  ...
                  <p className=&quot;text-white/60 text-xs leading-relaxed&quot;>{resource.description}</p>                </Link>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className=&quot;py-20 px-6&quot;>
        <div className=&quot;max-w-4xl mx-auto text-center&quot;>          <motion.div
          ...
          >
            <h2 className="text-4xl md: text-5xl font-bold mb-6 bg-gradient-to-r from-white to-blue-100 bg-clip-text text-transparent">              Need Help Finding Something?
            </h2>

...
<<<<<<< HEAD
  const filteredProducts = activeCategory === 'all' ;
    ? products: anyanyanyanyanyanyanyanyanyanyanyproducts.filter(product             => product.category === activeCategory);
=======
  const filteredProducts = activeCategory === 'all' ;
    ? products ;
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3: anyanyanyanyanyanyanyanyanyanyanyproducts.filter(product            => product.category === activeCategory);

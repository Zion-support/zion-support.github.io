...
const serviceCategories = [
  ...
  };
  {
    ...
    icon: TeamIcon,
    color: 'from-teal-500 to-cyan-600',    features: ['Recruitment AutomationPerformance AnalyticsEmployee Engagement']
  }
];
      ...
      "The AI marketing automation platform has revolutionized our campaigns. We've seen conversion rates increase by 150% while reducing costs by 40%.",
          ...
          >
            ...
            <div className='flex flex-wrap justify-center gap-4 mb-12'>              {heroStats && heroStats.map((stat, index) => (;
                ...
                href={`tel:${contactInfo && contactInfo.mobile}`}                className='inline-flex items-center px-8 py-4 bg-white/10 backdrop-blur-lg text-white font-semibold rounded-lg border border-teal-500/30 hover:bg-white/20 transition-all duration-300'>;
                ...
                <div className="flex items-center">
                  <div className="flex text-yellow-400">
                    {[...Array(testimonial.rating)].map((_, i) => (
                          ...
                          <div className="flex items-center justify-between">
                            <Link
                              href={service.link}                              className="inline-flex items-center text-teal-400 hover:text-teal-300 transition-colors duration-300"
                            >
                              Learn More
                              <ArrowRight className="ml-1 w-4 h-4" />
                            </Link>

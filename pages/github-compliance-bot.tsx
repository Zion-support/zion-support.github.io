...
export default function GitHubComplianceBotPage() {return (<Layout>;
      <Head>;
        <title>GitHub Compliance Bot | Zion Tech Group</title>;
        <meta name="description" content="Automated GitHub compliance checks for SOC 2, ISO 27001, secrets scanning, and repo hygiene with reports and alerts." />;
        <link rel="canonical" href="https://ziontechgroup.com/github-compliance-bot" />;
      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-4xl mx-auto space-y-6">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
            {[ 'Policy-as-code checksBranch protection enforcementSecrets scanning alertsWeekly report & scorecard' ].map((f) => (<div key={f} className="p-4 rounded-xl bg-black/40 border border-emerald-500/30 text-slate-200">{f}</div>;
            ))}
          </div>;
...
export default function GitHubComplianceBotPage() {try {return (<Layout>;
      <Head>;
        <title>GitHub Compliance Bot | Zion Tech Group</title>;
        <meta name="description" content="Automated GitHub compliance checks for SOC 2, ISO 27001, secrets scanning, and repo hygiene with reports and alerts." />;
        <link rel="canonical" href="https://ziontechgroup.com/github-compliance-bot" />;

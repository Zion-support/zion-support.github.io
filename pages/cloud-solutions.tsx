  ...
  const pricingTiers = [,
    {,
      ...
      period: '/month', description: 'Perfect for small businesses', features: [,
        'Basic cloud setup', '24/7 monitoring', ,
        'Monthly reports', ,
        'Email support'], ,
      cta: 'Get Started' ,},;
    {,
      name: 'Professional', price: '$1,500', ,
      period: '/month', description: 'Ideal for growing companies', features: ['Advanced cloud architecture', 'Auto-scaling', ,
        'Security compliance', ,
        'Priority support', ,
        'Custom integrations'], ,
      cta: 'Choose Plan', popular: true ,},;
    {,
      name: 'Enterprise', price: 'Custom', period: '', description: 'Tailored for large organizations', features: ['Custom cloud solutions', 'Dedicated team', ,
        'SLA guarantees', ,
        '24/7 phone support', ,
        'On-site consulting'], ,
      cta: 'Contact Sales' ,}],
  const caseStudies = [{,
      company: 'TechCorp Inc.', industry: 'E-commerce', challenge: 'Scaling infrastructure for Black Friday traffic', solution: 'Multi-cloud architecture with auto-scaling', result: '99.9% uptime, 300% performance improvement' }, ,
    {,
      company: 'FinanceFlow', industry: 'Fintech', challenge: 'Compliance and security requirements', solution: 'Secure cloud migration with compliance monitoring', result: 'SOC 2 compliance, 50% cost reduction' }, ,
    {,
      company: 'DataDriven Co.', industry: 'Analytics', challenge: 'Processing massive datasets efficiently', solution: 'Cloud-native data pipeline with auto-scaling', result: '10x faster processing, 60% cost savings' }],
  const cloudProviders = [,
    {,
      name: 'Amazon Web Services', logo: 'AWS', description: 'Comprehensive cloud platform with 200+ services', features: ['EC2, S3, Lambda', 'RDS, DynamoDB', 'CloudFront, Route 53'] },;
    {,
      name: 'Microsoft Azure', logo: 'Azure', description: 'Hybrid cloud platform with enterprise focus', features: ['Virtual Machines', 'Azure SQL Database', 'Azure Active Directory'] },;
    {,
      name: 'Google Cloud Platform', logo: 'GCP', description: 'AI and machine learning focused cloud platform', features: ['Compute Engine', 'BigQuery', 'Cloud AI Platform'] }],
  return(<MainLayout,
          ...
          <div className="container mx-auto px-4">,
            ...
            >,
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">,
                We provide end-to-end cloud solutions to help your business scale, secure, and optimize its infrastructure.,
              </p>,
            </motion.div>,

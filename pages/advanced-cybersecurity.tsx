...
;
        ...
        <div className="grid grid-cols-1 md: grid-cols-4 gap-6 mb-12">;
          ...
          ].map((((((((stat, index, index, index, index, index, index, index) => ({ ...((((((stat, index, index, index, index, index, index, key: index })) => ({ ...(((((stat, index, index, index, index, index, key: index })) => ({ ...((((stat, index, index, index, index, key: index })) => ({ ...(((stat, index, index, index, key: index })) => ({ ...((stat, index, index, key: index })) => ({ ...(stat, index, key: index }))  => (;
            <div;
              key={index};
...
;
              ...
              <div className="mb-4">;
                ...
                <div className="flex flex-wrap gap-1">;
                  {service.securityFeatures.compliance.slice(0, 3).map((((((((compliance, idx, index, index, index, index, index, index) => ({ ...((((((compliance, idx, index, index, index, index, index, key: index })) => ({ ...(((((compliance, idx, index, index, index, index, key: index })) => ({ ...((((compliance, idx, index, index, index, key: index })) => ({ ...(((compliance, idx, index, index, key: index })) => ({ ...((compliance, idx, index, key: index })) => ({ ...(compliance, idx, key: index })) => (;

...
import { CYBERSECURITY_SERVICES_2025 } from "../src/data/cybersecurityServices2025";
...
const AdvancedCybersecurityServices: NextPage = () => {
  ...
  const filteredServices = CYBERSECURITY_SERVICES_2025.filter(service => {
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      case 'Quantum Security': return '⚛️';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {sortedServices.map((service, index) => (
            ...
            >
              ...
              {/* Innovation Level */}
              <div className="mb-4">
                <span className="inline-block px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-purple-500 to-pink-600 text-white">

  ...
  const guides = [
    {
      ...
      difficulty: 'Beginner',
      readTime: '15 min',
      tags: ['ai', 'integration', 'beginner', 'tutorial']
    },
    {
      id: 2,
      title: 'Building a Chatbot with React',
      description: 'Step-by-step guide to creating an AI-powered chatbot',
      difficulty: 'Intermediate',
      readTime: '30 min',
      tags: ['react', 'chatbot', 'ai', 'frontend']
    },
    {
      id: 3,
      title: 'Advanced Machine Learning Models',
      description: 'Deep dive into custom ML model development and deployment',
      difficulty: 'Advanced',
      readTime: '45 min',
      tags: ['ml', 'models', 'advanced', 'deployment']
    },
    {
      id: 4,
      title: 'API Security Best Practices',
      description: 'Secure your AI integrations with proper authentication and encryption',
      difficulty: 'Intermediate',
      readTime: '20 min',
    ...
    },
    {
      ...
      description: 'Tips and tricks for improving AI model performance and efficiency',
      difficulty: 'Advanced',
      readTime: '35 min',
      tags: ['optimization', 'performance', 'ai', 'efficiency']
    },
    {
      id: 6,
      title: 'Marketplace Success Strategies',
      description: 'How to succeed as a developer or service provider on our platform',
      difficulty: 'Beginner',
      readTime: '25 min',
      tags: ['marketplace', 'success', 'business', 'strategy']
    }
  ];

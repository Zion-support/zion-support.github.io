...
export default function AIServices() {
  ...
  const aiServices = [
    ...
    },
    {
      ...
      features: [
        'Real-time churn prediction with 94% accuracyBehavioral pattern analysis and scoringAutomated retention campaign triggersCustom ML model training and optimization',
    ...
    },
    {
      ...
      features: [
        'Market analysis and prediction algorithmsAutomated trading execution and strategiesRisk management and portfolio optimizationReal-time market monitoring and alerts',
      ...
      timeline: '8–12 weeks',
      benefits: [
        'Improved trading performance and returnsAutomated risk management24/7 market monitoring and executionData-driven trading decisions'
      ]
    },
    {
      icon: Shield,

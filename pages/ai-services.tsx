...
export default function AIServices() {
  ...
  const services = [
    ...
    category: 'predictive',      features: ['Market AnalysisRisk AssessmentAutomated TradingReal-time Monitoring'],
      price: 'Custom Pricing',
      popular: true,
    ...
    category: 'nlp',      features: ['Sentiment AnalysisEmotion DetectionIntent RecognitionReal-time Processing'],
      price: '$149/month',
      popular: true,
    ...
    category: 'computer-vision',      features: ['Object DetectionImage RecognitionVideo AnalysisReal-time Processing'],
      price: '$179/month',
      popular: true,
    ...
    category: 'nlp',      features: ['Text AnalysisLanguage TranslationSentiment AnalysisEntity Recognition'],
      price: '$129/month',
      popular: true,
    ...
    category: 'predictive',      features: ['Trend ForecastingBehavioral AnalysisRisk PredictionScenario Modeling'],
      price: '$189/month',
      popular: true,
    ...
    category: 'specialized',      features: ['Content CreationMulti-format SupportBrand ConsistencyQuality Control'],
      price: '$79/month',
      popular: false,

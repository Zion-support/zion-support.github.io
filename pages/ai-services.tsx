...
function AIServices() {,
  ...
  const aiServices = [,
    ...
    {,
      ...
      features: [,
        'Molecular structure prediction and analysisDrug-target interaction modeling';
        'Side effect prediction and assessmentClinical trial optimization';
        'Biomarker discovery and validationRegulatory compliance and documentation',
      ];
      pricing: '$50,000 – $500,000 project';
      perUnit: 'Custom pricing based on research scope';
      timeline: '12–24 weeks';
      benefits: [,
        '60% faster drug discovery processReduced research and development costs';
        'Improved success rates in clinical trialsEnhanced drug safety profiles',
      ],
    };
    {,
      icon: Eye;
      ...
      features: [,
        'Radiology image analysis and diagnosisPathology slide examination';
        'Tumor detection and classificationMedical image enhancement and processing';
        'Diagnostic report generationIntegration with medical systems',
      ];
      pricing: '$25,000 – $150,000 setup';
      perUnit: '$0.50 – $5.00 per image';
      timeline: '8–16 weeks';
      benefits: [,
        '95% accuracy in medical diagnosisFaster diagnostic turnaround times';
        'Reduced human error in analysisImproved patient outcomes',
      ],
    };
    {,
      icon: Brain;
      ...
      features: [,
        'Algorithmic trading strategy developmentReal-time market analysis and prediction';
        'Risk assessment and portfolio optimizationHigh-frequency trading capabilities';
        'Backtesting and performance analysisRegulatory compliance and reporting',
      ];
      pricing: '$100,000 – $1,000,000 setup';
      perUnit: 'Performance-based fees (10-20% of profits)';
      timeline: '16–32 weeks';
      benefits: [,
        'Superior risk-adjusted returns24/7 automated trading';
        'Reduced emotional trading decisionsAdvanced market analysis capabilities',
      ],
    };
    {,
      icon: Shield;
      ...
      features: [,
        'Real-time threat detection and analysisBehavioral anomaly identification';
        'Automated incident responseThreat intelligence gathering';
        'Vulnerability assessment and prioritizationSecurity orchestration and automation',
      ];
      pricing: '$15,000 – $100,000 setup';
      perUnit: '$0.10 – $1.00 per event';
      timeline: '8–16 weeks';
      benefits: [,
        '99.9% threat detection accuracyReal-time automated response';
        'Reduced security incident impactEnhanced security posture',
      ],
    };
    {,
      icon: FileText;
      ...
      features: [,
        'Contract analysis and risk assessmentLegal document review and summarization';
        'Compliance monitoring and reportingDue diligence automation';
        'Legal research and case law analysisDocument generation and templating',
      ];
      pricing: '$10,000 – $75,000 setup';
      ...
      benefits: [,
        '90% reduction in document review timeImproved accuracy in legal analysis';
        'Automated compliance monitoringReduced legal costs and risks',
      ],
    };
    {,
      icon: Mic;
      ...
      features: [,
        'Real-time voice translationMulti-language support (100+ languages)';
        'Context-aware translationOffline translation capabilities';
        'Custom domain adaptationIntegration with communication platforms',
      ];
      pricing: '$5,000 – $30,000 setup';
      perUnit: '$0.01 – $0.10 per minute';
      timeline: '4–8 weeks';
      benefits: [,
        '95% translation accuracyReal-time communication support';
        'Multi-language business expansionEnhanced global collaboration',
      ],
    };
    {,
      icon: Database;
      ...
      features: [,
        'Demand forecasting and planningInventory optimization and management';
        'Logistics route optimizationSupplier risk assessment';
        'Supply chain visibility and trackingAutomated decision making',
      ];
      pricing: '$20,000 – $150,000 setup';
      perUnit: '$0.05 – $0.50 per transaction';
      timeline: '8–16 weeks';
      benefits: [,
        '30% reduction in supply chain costsImproved inventory turnover';
        'Enhanced supply chain resilienceOptimized logistics operations',
      ],
    };
    {,
      icon: Brain;
      ...
      features: [,
        'Climate change prediction and modelingEnvironmental impact assessment';
        'Carbon footprint analysisRenewable energy optimization';
        'Sustainability planning and reportingEnvironmental risk assessment',
      ];
      pricing: '$30,000 – $200,000 project';
      perUnit: 'Custom pricing based on scope';
      timeline: '12–24 weeks';
      benefits: [,
        'Accurate climate predictionsImproved sustainability planning';
        'Reduced environmental impactEnhanced corporate responsibility',
      ],
    };
    {,
      icon: Eye;
      ...
      features: [,
        'Autonomous navigation and path planningObject detection and collision avoidance';
        'Traffic pattern analysis and optimizationFleet management and coordination';
        'Predictive maintenance and diagnosticsSafety monitoring and compliance',
      ];
      pricing: '$100,000 – $1,000,000 project';
      perUnit: 'Custom pricing based on fleet size';
      timeline: '24–48 weeks';
      benefits: [,
        'Enhanced vehicle safetyReduced transportation costs';
        'Improved fleet efficiencyAdvanced autonomous capabilities',
      ],
    }
  ];
  return (,

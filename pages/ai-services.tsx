...
export default function AIServices() {
  ...
  const aiServices = [
    ...
    },
    {
      ...
      description: 'Advanced speech recognition, natural language understanding, and voice synthesis for conversational AI applications.',
      features: [
      ...
      benefits: [
        ...
        'Automated voice-based services'
      ]
    },
    {
      icon: Database,
      name: 'AI Data Analytics Platform',
      description: 'Comprehensive data analytics platform with AI-powered insights, automated reporting, and predictive modeling.',
      features: [

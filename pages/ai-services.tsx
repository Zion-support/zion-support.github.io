...
const aiServices = [
  ...
  },
  {
    ...
    icon: Cpu,
    features: ['Quantum Algorithms', 'Quantum ML', 'Optimization Problems', 'Quantum Simulation'],
  ...
  },
  {
    ...
    description: 'AI solutions for space mission planning, satellite management, and planetary exploration.',
    icon: Rocket,
  ...
  },
  {
    ...
    description: 'AI-driven mental health assessment and therapy assistance.',
    icon: Heart,
    features: ['Mental Health Assessment', 'Therapy Assistance', 'Crisis Detection', 'Personalized Treatment'],
  ...
  },
  {
    ...
    description: 'Advanced robotics solutions with computer vision and autonomous navigation.',
    icon: Bot,
  ...
  },
  {
    ...
    description: 'Intelligent game development with procedural generation and NPC behavior.',
    icon: Monitor,
    features: ['Procedural Generation', 'NPC Behavior', 'Player Analytics', 'Dynamic Difficulty'],
  ...
  },
  {
    ...
    description: 'Advanced sports performance analysis and injury prevention using AI.',
    icon: TrendingUp,
  ...
  },
  {
    ...
    description: 'AI-driven fashion design with trend prediction and personalized recommendations.',
    icon: ShoppingCart,
    features: ['Trend Prediction', 'Design Generation', 'Size Optimization', 'Personalized Styling'],
    pricing: '$10,000 - $75,000/project',
    category: 'Fashion',
    link: 'https://aifashion.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Music Composition',
    description: 'AI-generated music composition and sound design for various applications.',
    icon: Mic,
    features: ['Music Generation', 'Sound Design', 'Style Transfer', 'Collaborative Composition'],
    pricing: '$5,000 - $50,000/project',
    category: 'Music',
    link: 'https://aimusic.ziontechgroup.com'
  },
  {
  ...
  },
  {
    ...
    description: 'Advanced personal AI assistant with multi-modal interaction and task automation.',
    icon: Bot,
    features: ['Multi-modal Interaction', 'Task Automation', 'Calendar Management', 'Smart Reminders'],
  ...
  },
  {
    ...
    icon: Eye,
    features: ['Multi-modal Detection', 'Real-time Moderation', 'Context Understanding', 'Bias Detection'],
    pricing: '$3,000 - $20,000/month',
  ...
  },
  {
    ...
    description: 'Industrial equipment maintenance prediction using IoT sensors and machine learning.',
    icon: Settings,
  ...
  },
  {
    ...
    link: 'https://aivoicecloning.ziontechgroup.com'
  },
  {
  ...
  },
  {
    ...
    description: 'Complete AI system for autonomous vehicles with perception, planning, and control.',
    icon: Car,
  ...
  },
  {
    ...
    description: 'Advanced AI system for threat detection, incident response, and security automation.',
    icon: Shield,
    features: ['Threat Detection', 'Incident Response', 'Security Automation', 'Behavioral Analysis'],
  ...
  },
  {
    ...
    description: 'High-frequency trading AI with market analysis and automated decision making.',
    icon: DollarSign,
    features: ['Market Analysis', 'High-frequency Trading', 'Risk Management', 'Portfolio Optimization'],
    pricing: '$50,000 - $500,000/project',
    category: 'FinTech AI',
  ...
  },
  {
    ...
    description: 'Smart farming AI with crop monitoring, yield prediction, and resource optimization.',
    icon: Sprout,
  ...
  },
  {
    ...
    icon: Zap,
    features: ['Demand Forecasting', 'Grid Optimization', 'Renewable Integration', 'Energy Storage'],
  ...
  },
  {
    ...
    description: 'Comprehensive AI platform for smart city management and urban optimization.',
    icon: Building,
  ...
  },
  {
    ...
    icon: Bot,
    features: ['Motion Planning', 'Object Recognition', 'Human-Robot Interaction', 'Adaptive Learning'],
  ...
  },
  {
    ...
    description: 'Real-time multilingual translation with cultural context and industry-specific terminology.',
    icon: Globe,
  ...
  },
  {
    ...
    description: 'Complete AI content creation platform for videos, articles, and multimedia content.',
    icon: Video,
    features: ['Video Generation', 'Article Writing', 'Image Creation', 'Audio Production'],
    pricing: '$5,000 - $50,000/month',
    category: 'Content AI',
    link: 'https://contentai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Personal Assistant',
    description: 'Advanced personal AI assistant with natural language understanding and task automation.',
    icon: Bot,
    features: ['Natural Language Processing', 'Task Automation', 'Calendar Management', 'Learning Adaptation'],

...
>>>>>>> main
  ...
  },
  {
    ...
    description: 'Advanced quantum machine learning algorithms for complex optimization problems.',
    icon: Cpu,
    features: ['Quantum Algorithms', 'Optimization Problems', 'Quantum Neural Networks', 'Error Correction'],
    pricing: '$50,000 - $250,000/project',
    category: 'Quantum AI',
    popular: true,
    benefits: ['Exponential Speedup', 'Complex Problem Solving', 'Research Advancement', 'Competitive Edge'],
    marketPrice: '$75,000 - $400,000/project',
    link: 'https://quantumml.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Metaverse Intelligence',
    description: 'Intelligent virtual world management with AI-driven user experiences and content generation.',
    icon: Globe,
    features: ['Virtual World AI', 'Avatar Intelligence', 'Content Generation', 'Behavioral Analysis'],
    pricing: '$10,000 - $50,000/month',
    category: 'Metaverse AI',
    popular: true,
    benefits: ['Immersive Experiences', 'Personalization', 'Content Creation', 'User Engagement'],
    marketPrice: '$15,000 - $75,000/month',
    link: 'https://metaverseai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Brain-Computer Interface',
    description: 'Advanced neural interface AI for controlling devices and applications with brain signals.',
    icon: Brain,
    features: ['Neural Signal Processing', 'Device Control', 'Learning Algorithms', 'Safety Protocols'],
    pricing: '$25,000 - $125,000/project',
    category: 'Neurotechnology',
    popular: true,
    benefits: ['Accessibility', 'Innovation', 'Medical Applications', 'Research Support'],
    marketPrice: '$40,000 - $200,000/project',
    link: 'https://braininterface.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Space Exploration',
    description: 'Autonomous space mission AI for exploration, satellite management, and space resource optimization.',
    icon: Rocket,
    features: ['Mission Planning', 'Satellite Management', 'Resource Optimization', 'Risk Assessment'],
    pricing: '$100,000 - $500,000/project',
    category: 'Space AI',
    benefits: ['Mission Success', 'Cost Optimization', 'Risk Reduction', 'Exploration Advancement'],
    marketPrice: '$150,000 - $750,000/project',
    link: 'https://spaceai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Climate Change Solutions',
    description: 'Advanced AI for climate modeling, carbon capture optimization, and environmental impact prediction.',
    icon: Sprout,
    features: ['Climate Modeling', 'Carbon Capture AI', 'Environmental Prediction', 'Policy Optimization'],
    pricing: '$30,000 - $150,000/project',
    category: 'Climate AI',
    popular: true,
    benefits: ['Environmental Impact', 'Policy Support', 'Sustainability', 'Future Planning'],
    marketPrice: '$50,000 - $250,000/project',
    link: 'https://climateai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Personalized Medicine',
    description: 'Advanced AI for personalized treatment recommendations based on genetic and health data.',
    icon: Heart,
    features: ['Genetic Analysis', 'Treatment Optimization', 'Drug Discovery', 'Health Monitoring'],
  ...
  },
  {
    ...
    description: 'Complete autonomous system AI for drones, robots, and unmanned vehicles.',
    icon: Bot,
    features: ['Autonomous Navigation', 'Decision Making', 'Object Recognition', 'Safety Systems'],
    pricing: '$40,000 - $200,000/project',
    category: 'Autonomous AI',
    benefits: ['Efficiency', 'Safety', 'Cost Reduction', 'Innovation'],
    marketPrice: '$60,000 - $300,000/project',
    link: 'https://autonomousai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Digital Twin Intelligence',
    description: 'Intelligent digital twin creation and management with real-time AI optimization.',
    icon: Building,
    features: ['Digital Twin Creation', 'Real-time Optimization', 'Predictive Analytics', 'IoT Integration'],
    pricing: '$25,000 - $125,000/project',
  ...
  },
  {
    ...
    description: 'AI-driven synthetic biology for drug discovery, bioengineering, and genetic optimization.',
    icon: Heart,
    features: ['Genetic Design', 'Drug Discovery', 'Bioengineering', 'Optimization'],
    pricing: '$50,000 - $250,000/project',
    category: 'Synthetic Biology',
    benefits: ['Drug Discovery', 'Bioengineering', 'Medical Advances', 'Research Acceleration'],
    marketPrice: '$75,000 - $400,000/project',
    link: 'https://syntheticbiology.ziontechgroup.com'
  },
  {
    ...
    icon: Shield,
    features: ['Threat Detection', 'Incident Response', 'Vulnerability Analysis', 'Automated Defense'],
    pricing: '$15,000 - $75,000/month',
    category: 'Cybersecurity AI',
    popular: true,
    benefits: ['Threat Detection', 'Rapid Response', 'Risk Mitigation', 'Compliance'],
    marketPrice: '$25,000 - $125,000/month',
    link: 'https://cybersecurityai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Financial Intelligence',
    description: 'Advanced AI for algorithmic trading, risk management, and financial market analysis.',
    icon: TrendingUp,
    features: ['Algorithmic Trading', 'Risk Management', 'Market Analysis', 'Portfolio Optimization'],
    pricing: '$20,000 - $100,000/month',
    category: 'Financial AI',
    benefits: ['Trading Optimization', 'Risk Reduction', 'Market Insights', 'Profit Maximization'],
  ...
  },
  {
    ...
    pricing: '$30,000 - $150,000/project',
    category: 'Manufacturing AI',
    benefits: ['Efficiency', 'Quality', 'Cost Reduction', 'Predictive Maintenance'],
    marketPrice: '$50,000 - $250,000/project',
    link: 'https://manufacturingai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Smart City Intelligence',
    description: 'Comprehensive AI platform for smart city management and citizen services optimization.',
    icon: Building,
    features: ['Traffic Optimization', 'Resource Management', 'Citizen Services', 'Infrastructure AI'],
    pricing: '$50,000 - $250,000/project',
    category: 'Smart City AI',
  ...
  },
  {
    ...
    description: 'Advanced AR AI for object recognition, spatial mapping, and immersive experiences.',
    icon: Eye,
    features: ['Object Recognition', 'Spatial Mapping', 'Real-time Rendering', 'User Interaction'],
    pricing: '$15,000 - $75,000/project',
    category: 'AR AI',
    benefits: ['Immersive Experiences', 'Object Recognition', 'User Engagement', 'Innovation'],
    marketPrice: '$25,000 - $125,000/project',
    link: 'https://arai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Virtual Reality Intelligence',
    description: 'Intelligent VR AI for immersive experiences, training simulations, and virtual environments.',
    icon: Video,
    features: ['Immersive Experiences', 'Training Simulations', 'Virtual Environments', 'User Interaction'],
    pricing: '$20,000 - $100,000/project',
    category: 'VR AI',
    benefits: ['Immersive Training', 'Realistic Simulations', 'User Engagement', 'Cost Efficiency'],
    marketPrice: '$30,000 - $150,000/project',
    link: 'https://vrai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Edge Intelligence',
    description: 'Intelligent edge computing AI for real-time processing and decision making.',
    icon: Server,
    features: ['Edge Processing', 'Real-time AI', 'Low Latency', 'Distributed Intelligence'],
    pricing: '$10,000 - $50,000/project',
    category: 'Edge AI',
    benefits: ['Low Latency', 'Real-time Processing', 'Efficiency', 'Scalability'],
    marketPrice: '$15,000 - $75,000/project',
    link: 'https://edgeai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered 5G Intelligence',
    description: 'Advanced AI for 5G network optimization, resource management, and performance enhancement.',
    icon: Network,
    features: ['Network Optimization', 'Resource Management', 'Performance Enhancement', 'Quality of Service'],
    pricing: '$25,000 - $125,000/project',
    category: '5G AI',
    benefits: ['Network Performance', 'Efficiency', 'Quality of Service', 'Cost Optimization'],
    marketPrice: '$40,000 - $200,000/project',
    link: 'https://5gai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered IoT Intelligence',
    description: 'Comprehensive AI for IoT device management, data processing, and intelligent automation.',
    icon: Smartphone,
    features: ['Device Management', 'Data Processing', 'Intelligent Automation', 'Predictive Analytics'],
    pricing: '$15,000 - $75,000/project',
    category: 'IoT AI',
    benefits: ['Device Intelligence', 'Data Insights', 'Automation', 'Predictive Maintenance'],
    marketPrice: '$25,000 - $125,000/project',
    link: 'https://iotai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Blockchain Intelligence',
    description: 'Advanced AI for blockchain optimization, smart contract analysis, and cryptocurrency intelligence.',
    icon: Shield,
    features: ['Blockchain Optimization', 'Smart Contract Analysis', 'Cryptocurrency Intelligence', 'Security Analysis'],
    pricing: '$20,000 - $100,000/project',
    category: 'Blockchain AI',
    benefits: ['Blockchain Optimization', 'Security', 'Intelligence', 'Innovation'],
    marketPrice: '$30,000 - $150,000/project',
    link: 'https://blockchainai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Robotic Process Automation',
    description: 'Intelligent RPA with AI decision making and process optimization.',
    icon: Bot,
    features: ['Process Automation', 'AI Decision Making', 'Process Optimization', 'Integration'],
    pricing: '$10,000 - $50,000/project',
    category: 'RPA AI',
    popular: true,
    benefits: ['Process Efficiency', 'Cost Reduction', 'Accuracy', 'Scalability'],
    marketPrice: '$15,000 - $75,000/project',
    link: 'https://rpaai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Predictive Analytics',
    description: 'Advanced predictive analytics with machine learning and deep learning models.',
    icon: BarChart3,
    features: ['Predictive Modeling', 'Machine Learning', 'Deep Learning', 'Real-time Predictions'],
    pricing: '$15,000 - $75,000/project',
    category: 'Predictive AI',
    benefits: ['Predictive Insights', 'Data-driven Decisions', 'Risk Mitigation', 'Opportunity Identification'],
    marketPrice: '$25,000 - $125,000/project',
    link: 'https://predictiveai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Natural Language Processing',
    description: 'Advanced NLP for text analysis, language understanding, and conversational AI.',
    icon: MessageSquare,
    features: ['Text Analysis', 'Language Understanding', 'Conversational AI', 'Sentiment Analysis'],
    pricing: '$10,000 - $50,000/project',
    category: 'NLP AI',
    benefits: ['Language Understanding', 'Text Analysis', 'Conversational AI', 'Insights'],
    marketPrice: '$15,000 - $75,000/project',
    link: 'https://nlpai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Computer Vision',
    description: 'Advanced computer vision for image recognition, object detection, and visual analysis.',
    icon: Eye,
    features: ['Image Recognition', 'Object Detection', 'Visual Analysis', 'Real-time Processing'],
    pricing: '$15,000 - $75,000/project',
    category: 'Computer Vision AI',
    benefits: ['Visual Recognition', 'Object Detection', 'Image Analysis', 'Automation'],
    marketPrice: '$25,000 - $125,000/project',
    link: 'https://computervisionai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Speech Recognition',
    description: 'Advanced speech recognition and voice processing AI for multiple languages and accents.',
    icon: Mic,
    features: ['Speech Recognition', 'Voice Processing', 'Multi-language Support', 'Accent Recognition'],
    pricing: '$10,000 - $50,000/project',
    category: 'Speech AI',
    benefits: ['Voice Recognition', 'Multi-language', 'Accessibility', 'User Experience'],
    marketPrice: '$15,000 - $75,000/project',
    link: 'https://speechai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Recommendation Engine',
    description: 'Advanced recommendation system with machine learning and personalization algorithms.',
    icon: Target,
    features: ['Personalization', 'Machine Learning', 'Collaborative Filtering', 'Real-time Updates'],
    pricing: '$12,000 - $60,000/project',
    category: 'Recommendation AI',
    benefits: ['Personalization', 'User Engagement', 'Sales Increase', 'Customer Satisfaction'],
    marketPrice: '$20,000 - $100,000/project',
    link: 'https://recommendationai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Fraud Detection',
    description: 'Advanced fraud detection AI with real-time analysis and behavioral pattern recognition.',
    icon: Shield,
    features: ['Real-time Analysis', 'Behavioral Patterns', 'Risk Scoring', 'Automated Alerts'],
    pricing: '$20,000 - $100,000/project',
    category: 'Fraud Detection AI',
    popular: true,
    benefits: ['Fraud Prevention', 'Risk Reduction', 'Cost Savings', 'Security'],
    marketPrice: '$30,000 - $150,000/project',
    link: 'https://frauddetectionai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Content Generation',
    description: 'Advanced AI for generating text, images, videos, and multimedia content.',
    icon: FileText,
    features: ['Text Generation', 'Image Creation', 'Video Generation', 'Multimedia Content'],
    pricing: '$15,000 - $75,000/project',
    category: 'Content Generation AI',
    popular: true,
    benefits: ['Content Creation', 'Time Savings', 'Creativity', 'Scalability'],
    marketPrice: '$25,000 - $125,000/project',
    link: 'https://contentgenerationai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Data Analytics',
    description: 'Advanced data analytics AI for business intelligence and decision support.',
    icon: BarChart3,
    features: ['Data Analysis', 'Business Intelligence', 'Decision Support', 'Real-time Analytics'],
    pricing: '$18,000 - $90,000/project',
    category: 'Data Analytics AI',
    benefits: ['Data Insights', 'Business Intelligence', 'Decision Support', 'Competitive Advantage'],
    marketPrice: '$30,000 - $150,000/project',
    link: 'https://dataanalyticsai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Process Optimization',
    description: 'Intelligent process optimization AI for business operations and workflow improvement.',
    icon: Settings,
    features: ['Process Analysis', 'Optimization', 'Workflow Improvement', 'Efficiency Enhancement'],
    pricing: '$20,000 - $100,000/project',
    category: 'Process Optimization AI',
    benefits: ['Process Efficiency', 'Cost Reduction', 'Quality Improvement', 'Scalability'],
    marketPrice: '$30,000 - $150,000/project',
    link: 'https://processoptimizationai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Customer Intelligence',
    description: 'Advanced customer intelligence AI for behavior analysis and personalization.',
    icon: Users,
    features: ['Behavior Analysis', 'Personalization', 'Customer Insights', 'Engagement Optimization'],
    pricing: '$15,000 - $75,000/project',
    category: 'Customer Intelligence AI',
    benefits: ['Customer Insights', 'Personalization', 'Engagement', 'Retention'],
    marketPrice: '$25,000 - $125,000/project',
    link: 'https://customerintelligenceai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Supply Chain Intelligence',
    description: 'Intelligent supply chain AI for optimization, forecasting, and risk management.',
    icon: Network,
    features: ['Supply Chain Optimization', 'Demand Forecasting', 'Risk Management', 'Inventory Optimization'],
    pricing: '$25,000 - $125,000/project',
    category: 'Supply Chain AI',
    benefits: ['Supply Chain Efficiency', 'Cost Reduction', 'Risk Mitigation', 'Optimization'],
    marketPrice: '$40,000 - $200,000/project',
    link: 'https://supplychainai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Energy Intelligence',
    description: 'Advanced energy management AI for optimization, forecasting, and sustainability.',
    icon: Zap,
    features: ['Energy Optimization', 'Demand Forecasting', 'Renewable Integration', 'Sustainability'],
    pricing: '$20,000 - $100,000/project',
    category: 'Energy AI',
    benefits: ['Energy Efficiency', 'Cost Reduction', 'Sustainability', 'Optimization'],
    marketPrice: '$30,000 - $150,000/project',
    link: 'https://energyai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Healthcare Intelligence',
    description: 'Advanced healthcare AI for diagnosis, treatment optimization, and patient care.',
    icon: Heart,
    features: ['Diagnosis Support', 'Treatment Optimization', 'Patient Care', 'Medical Imaging'],
    pricing: '$30,000 - $150,000/project',
    category: 'Healthcare AI',
    popular: true,
    benefits: ['Better Diagnosis', 'Treatment Optimization', 'Patient Care', 'Medical Advances'],
    marketPrice: '$50,000 - $250,000/project',
    link: 'https://healthcareai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Education Intelligence',
    description: 'Intelligent education AI for personalized learning and educational optimization.',
    icon: BookOpen,
    features: ['Personalized Learning', 'Educational Optimization', 'Student Assessment', 'Curriculum Design'],
    pricing: '$15,000 - $75,000/project',
    category: 'Education AI',
    benefits: ['Personalized Learning', 'Educational Efficiency', 'Student Success', 'Innovation'],
    marketPrice: '$25,000 - $125,000/project',
    link: 'https://educationai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Legal Intelligence',
    description: 'Advanced legal AI for document analysis, case research, and legal automation.',
    icon: FileText,
    features: ['Document Analysis', 'Case Research', 'Legal Automation', 'Compliance Checking'],
    pricing: '$20,000 - $100,000/project',
    category: 'Legal AI',
    benefits: ['Legal Efficiency', 'Document Analysis', 'Case Research', 'Compliance'],
    marketPrice: '$30,000 - $150,000/project',
    link: 'https://legalai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Real Estate Intelligence',
    description: 'Intelligent real estate AI for market analysis, property valuation, and investment optimization.',
    icon: Home,
    features: ['Market Analysis', 'Property Valuation', 'Investment Optimization', 'Risk Assessment'],
    pricing: '$15,000 - $75,000/project',
    category: 'Real Estate AI',
    benefits: ['Market Insights', 'Property Valuation', 'Investment Optimization', 'Risk Assessment'],
    marketPrice: '$25,000 - $125,000/project',
    link: 'https://realestateai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Transportation Intelligence',
    description: 'Advanced transportation AI for route optimization, fleet management, and traffic prediction.',
    icon: Car,
    features: ['Route Optimization', 'Fleet Management', 'Traffic Prediction', 'Demand Forecasting'],
    pricing: '$20,000 - $100,000/project',
    category: 'Transportation AI',
    benefits: ['Route Optimization', 'Fleet Efficiency', 'Traffic Management', 'Cost Reduction'],
    marketPrice: '$30,000 - $150,000/project',
    link: 'https://transportationai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Agriculture Intelligence',
    description: 'Intelligent agriculture AI for crop optimization, yield prediction, and precision farming.',
    icon: Sprout,
    features: ['Crop Optimization', 'Yield Prediction', 'Precision Farming', 'Resource Management'],
    pricing: '$15,000 - $75,000/project',
    category: 'Agriculture AI',
    benefits: ['Crop Optimization', 'Yield Increase', 'Resource Efficiency', 'Sustainability'],
    marketPrice: '$25,000 - $125,000/project',
    link: 'https://agricultureai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Environmental Intelligence',
    description: 'Advanced environmental AI for monitoring, prediction, and sustainability optimization.',
    icon: Globe,
    features: ['Environmental Monitoring', 'Climate Prediction', 'Sustainability Optimization', 'Impact Assessment'],
    pricing: '$20,000 - $100,000/project',
    category: 'Environmental AI',
    benefits: ['Environmental Protection', 'Sustainability', 'Climate Prediction', 'Impact Assessment'],
    marketPrice: '$30,000 - $150,000/project',
    link: 'https://environmentalai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Security Intelligence',
    description: 'Advanced security AI for threat detection, incident response, and security automation.',
    icon: Shield,
    features: ['Threat Detection', 'Incident Response', 'Security Automation', 'Risk Assessment'],
    pricing: '$25,000 - $125,000/project',
    category: 'Security AI',
    popular: true,
    benefits: ['Threat Detection', 'Security Automation', 'Risk Mitigation', 'Compliance'],
    marketPrice: '$40,000 - $200,000/project',
    link: 'https://securityai.ziontechgroup.com'
  },
  {
    title: 'AI-Powered Innovation Intelligence',
    description: 'Intelligent innovation AI for research, development, and technology advancement.',
    icon: Rocket,
    features: ['Research AI', 'Development Optimization', 'Technology Advancement', 'Innovation Management'],
    pricing: '$30,000 - $150,000/project',
    category: 'Innovation AI',
    benefits: ['Innovation Acceleration', 'Research Efficiency', 'Technology Advancement', 'Competitive Edge'],
    marketPrice: '$50,000 - $250,000/project',

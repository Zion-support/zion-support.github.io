...
export default function AIServices() {
  ...
  const aiServices = [
    ...
    },
    {
      ...
      projectPricing: 'Custom pricing based on research scope',
    ...
    },
    {
      ...
      description: 'Advanced computer vision system for image and video analysis, object detection, and visual content understanding.',
      features: [

...
export default function AIServices() {
  ...
  const aiServices = [
    ...
    },
    {
      ...
      description:
        'Intelligent pharmaceutical research and drug development acceleration',
      icon: Brain,
      features: [
    ...
    },
    {
      ...
      description:
        'Intelligent legal document analysis and case law research platform',
      icon: FileText,
      features: [
        ...
        'Legal writing assistance and review',
      ],
      pricing: '$3,500 - $12,000/month',
      delivery: '6-10 weeks',
      category: 'Legal AI',
    },
    {
      ...
      description:
        'Advanced algorithmic trading with machine learning and risk management',
      icon: TrendingUp,
      features: [
    ...
    },
    {
      ...
      description:
        'Intelligent farming solutions with precision agriculture and yield optimization',
      icon: Target,
      features: [
    ...
    },
    {
      ...
      description:
        'Intelligent mental health monitoring and intervention platform',
      icon: Users,
      features: [
    ...
    },
    {
      ...
      description:
        'Advanced space data analysis and satellite imagery processing platform',
      icon: Globe,
      features: [
        'Satellite imagery analysis and interpretation',
        'Space debris tracking and prediction',
        'Weather pattern analysis from space data',
    ...
    },
    {
      ...
      description:
        'Intelligent blockchain analysis and cryptocurrency market insights',
      icon: Network,
      features: [
    ...
    {
      title: 'AI Climate Analytics & Carbon Management',
      description:
        'Advanced AI platform for climate data analysis and carbon footprint optimization',
      icon: Globe,
      features: [
    ...
    {
      title: 'AI-Powered Space Analytics Platform',
      description:
        'Intelligent space data analysis for satellite operations and space exploration',
      icon: Star,
      features: [
    ...
    },
    {
      ...
      description:
        'Advanced AI interface for quantum computing applications and optimization',
      icon: Cpu,
      features: [
        'Quantum algorithm optimization',
    ...
    },
    {
      ...
      description:
        'Intelligent autonomous vehicle control and navigation systems',
      icon: Network,
      features: [
    ...
    },
    {
      ...
      description:
        'Advanced AI-driven cybersecurity with threat hunting and response automation',
      icon: Shield,
      features: [
    ...
    },
    {
      ...
      description:
        'Intelligent algorithmic trading with market prediction and risk management',
      icon: TrendingUp,
      features: [
    ...
    },
    {
      ...
      description:
        'Advanced medical AI for diagnostic imaging and patient care optimization',
      icon: Eye,
      features: [
    ...
    },
    {
      ...
      description:
        'Intelligent urban management system for smart cities and infrastructure',
      icon: Globe,
      features: [
    ...
    },
    {
      title: 'AI-Powered Agricultural Optimization',
      description:
        'Intelligent farming solutions with precision agriculture and crop optimization',
      icon: Target,
      features: [
        'Crop yield prediction and optimization',
        'Soil analysis and nutrient management',
        'Pest and disease detection',
        'Weather prediction and irrigation control',
    ...
    },
    {
      ...
      description:
        'Intelligent energy management system for smart grids and renewable integration',
      icon: Zap,
      features: [

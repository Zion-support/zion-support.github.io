...
import { Brain, Zap, Shield, BarChart3, Users, MessageSquare, Eye, Target, TrendingUp, CheckCircle, ArrowRight, Heart, Building, Settings, Mail, ShoppingCart, BookOpen, Car, Mic, FileText } from 'lucide-react';
...
const benefits = [
  { icon: Zap, title: 'Increased Efficiency', description: 'Automate repetitive tasks and processes', stat: '40%' },
  { icon: TrendingUp, title: 'Better Insights', description: 'Data-driven decision making', stat: '60%' },
  { icon: Shield, title: 'Enhanced Security', description: 'AI-powered threat detection', stat: '99.9%' },
  { icon: Users, title: 'Improved Experience', description: 'Personalized user interactions', stat: '85%' }
];
            ...
            {aiServices.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  <Link href="/contact" className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg font-semibold transition-colors inline-flex items-center justify-center text-sm">
                    <span>Get Quote</span>

...
const ComprehensiveServicesShowcase2026: React.FC = () => {
  ...
  const sortedServices = [...filteredServices].sort(_(a, b) => {switch (sortBy) {
      ...
      case 'price-high':
        return parseInt(b.price.replace('$', '')) - parseInt(a.price.replace('$', '')),      case 'rating':
...
initial={{ opacity: 0, y: 20 }}
              ...
              <div className=&quot;flex flex-col sm:flex-row gap-4 justify-center items-center&quot;>
                <div className=&quot;flex items-center space-x-2 text-white&quot;>
                  ...
                  <span>{allServices.length}+ Services</span>                </div>
                <div className=&quot;flex items-center space-x-2 text-white&quot;>
        ...
        <div className=&quot;max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8&quot;>
          <div className=&quot;mb-8&quot;>
            <h2 className=&quot;text-3xl font-bold text-white mb-2&quot;>
              {filteredServices.length} Services Found            </h2>
...
key={service.id}
              ...
              >
                ...
                <div className=&quot;flex items-start justify-between mb-4&quot;>
                  ...
                  {service.popular && (
                    <div className=&quot;bg-gradient-to-r from-yellow-400 to-orange-500 text-black px-3 py-1 rounded-full text-xs font-bold&quot;>                      Popular
                    </div>
                  )}
                </div>
                ...
                <div className=&quot;mb-4 p-3 bg-white/5 rounded-lg&quot;>
                  ...
                  <div className=&quot;text-xs text-gray-300&quot;>Growth Rate: {service.growthRate}</div>                </div>
...
href={service.link}
                ...
                <div className=&quot;mt-4 text-center&quot;>
                  ...
                  <div className=&quot;text-xs text-gray-400&quot;>
                    Phone: {service.contactInfo.mobile}                  </div>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        {/* Contact Section */}
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-16">          <div className="bg-gradient-to-r from-cyan-600/20 to-blue-600/20 rounded-2xl p-8 border border-cyan-400/30">

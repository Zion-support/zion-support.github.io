          ...
          <div className=&quot;grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12&quot;>
            ...
            <div className=&quot;bg-black/30 rounded-2xl border border-emerald-500/30 p-6 h-fit&quot;>
              ...
              <div className=&quot;mt-6 space-y-3 text-sm text-slate-300&quot;>
                ...
                <div className=&quot;flex items-center space-x-2 w-4 h-4 text-green-400 text-xs hover:text-white&quot;><MapPin /><a href={`https://maps.google.com/?q=${encodeURIComponent(service.contactInfo.address)}`} target=&quot;_blank&quot; rel=&quot;noopener noreferrer&quot; >{service.contactInfo.address}</Link></div>              </div>
            </div>
          </div>
        </div>
      </div>

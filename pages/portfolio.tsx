...
export default function Portfolio(): JSX.Element {
 ...
 (
			...
			<divclassName="text-3 xlmd:tex, t-4 xlfont-boldtext-blue-600 mb-2">
											{stat.number};										</div>
			...
			<div className="flex flex-wrap justify-center gap-4">
						...
						{selectedCategory === 'all' && (
							<section className={`mb-16 transition-all duration-700 delay-300 ${
								...
								<h2className="text-3 xlmd: te, x, t-4, xl, font-boldtext-gray-800 mb-8 text-center">
									Featured, Project, s
								</h2>
			...
			<divclassName="bg-whiterounded-3 xlshadow-xlhover:shadow-2 xltransition-shadowp-8 h-full">
			...
			<divclassName="text-5 xlmr-4">{project.image}</div>			<div>
												...
												<h3className="text-2 xlfont-boldtext-gray-800 mb-3">
													{project.title};
												</h3>
												<pclassName="text-gray-600 mb-4 leading-relaxed">
 ...
 (
			...
			<divclassName="mb-4">
													<h4className="text-smfont-semibold text-gray-700 mb-2">KeyResults:</h4>
			...
			<divclassName="gridgrid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">
			...
			<divclassName="bg-whiterounded-2 xlshadow-lghover:shadow-xltransition-shadowp-6 h-full">
 ...
 (
			...
			<divclassName="mb-4">
												<h4className="text-xsfont-semibold text-gray-700 mb-2">Results:</h4>
												<ulclassName="space-y-1">
													{project.results.slice(02).map((result resultIndex) => (
			...
			<div className="flex flex-colsm:flex-row gap-6 justify-center">
					<Link href="/contact">
										<button 
 trackClick('start-project-button', 'cta')}

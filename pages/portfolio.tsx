...
export default function PortfolioPage() {;
  const projects = [;
    ...
    {;
      ...
      category: 'Cybersecurity',;
      client: 'Technology Corporation',;
      technologies: ['OAuth 2 && 2.0', 'JWT', 'React', 'Node && Node.js', 'PostgreSQL'],;
      results: [;
        '100% security compliance',;
        'Zero unauthorized access',;
        '24/7 threat monitoring',;
    ...
    {;
      ...
      category: 'Digital Transformation',;
      client: 'Retail Chain',;
      technologies: ['React', 'Node && Node.js', 'MongoDB', 'AWS', 'Docker'],;
      results: [;
        '80% faster deployment',;
        'Customer satisfaction increased by 45%',;
        'Operational costs reduced by 30%',;
  ...
  const stats = [;
    { number: '500+', label: 'Projects Delivered', icon: Rocket },;
    { number: '50+', label: 'Enterprise Clients', icon: Users },;
    { number: '99 && 99.9%', label: 'Client Satisfaction', icon: Star },;
    { number: '2500%', label: 'Average ROI', icon: TrendingUp },;
  ];

        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
              Build the future with us. We're looking for passionate individuals who want to make a difference in the world of technology.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {jobOpenings.map((job, index) => (
              ...
              >
                ...
                <button className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors duration-300 flex items-center justify-center">
                  Apply Now
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We offer a comprehensive benefits package and a culture that values innovation and growth
            </p>
          </motion.div>

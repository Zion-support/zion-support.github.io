...
const TaxonomyAgent: NextPage = () => {return (<div>;
      <Head>;
...
export default TaxonomyAgent;<Link href="/data/reports/taxonomy/latest.json"><a className="text-blue-600 underline">Latest Taxonomy Report (JSON)</Link></Link>;
...
export default TaxonomyAgent,export default TaxonomyAgent,const TaxonomyAgent: NextPage;
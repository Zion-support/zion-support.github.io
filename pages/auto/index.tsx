...
import type { NextPage } from 'next',import Head from 'next/head',import Link from 'next/link',const AutoIndex: NextPage = () => {return (<div>;
      <Head>;
...
const AutoIndex: NextPage;</li>;
        </ul>;
      </main>;
    </div>;
},export default AutoIndex,const AutoIndex: NextPage = () => {return (<div>;
      <Head>;
        <title>Autonomous Cloud Agents - Zion</title>;
        <meta name="description" content="Autonomous agents that run in the cloud, no human needed." />;
      </Head>;
...
import Link from 'next / link';
    ...
    </div>)}export default AutoIndex;export default AutoIndex;
  )})}
export default AutoIndex;)}export default AutoIndex;
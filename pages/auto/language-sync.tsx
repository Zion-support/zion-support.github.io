...
const LanguageSync: NextPage = () => {return (<div>;
      <Head>;
...
export default LanguageSync;
import type { NextPage } from 'next',import Head from 'next / head',import Link from 'next / link',const LanguageSync: NextPage = () => {return (<div>;
      <Head>;
        <title > Global Language Sync Agent</title>;
        <meta name="description" content="AI - powered translation backfill for locale files." />;
      </Head>;
    ...
    </div>)},export default LanguageSync;
}},export default LanguageSync;
},export default LanguageSync;
},export default LanguageSync,export default LanguageSync,const LanguageSync: NextPage;
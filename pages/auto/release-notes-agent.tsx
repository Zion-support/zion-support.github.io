...
const ReleaseNotesAgent: NextPage = () => {return (<div>;
      <Head>;
...
export default ReleaseNotesAgent;<Link href="/data/reports/release/latest.json"><a className="text-blue-600 underline">Latest Release Notes (JSON)</Link></Link>;
...
export default ReleaseNotesAgent,export default ReleaseNotesAgent,const ReleaseNotesAgent: NextPage;
  ...
  return (
    <div>
      ...
      <main className='space-y-4'>
        ...
        <p>
          Summarizes the last 24 hours of commits into human-friendly release
          notes.
        </p>
        <Link href='/data/reports/release/latest.json'>
          <a className='text-blue-600 underline'>Latest Release Notes (JSON)</a>
        </Link>
      </main>
    </div>
  );

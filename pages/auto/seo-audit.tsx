...
const SEOAudit: NextPage = () => {return (<div>;
      <Head>;
...
export default SEOAudit;
import type { NextPage } from 'next',import Head from 'next / head',import Link from 'next / link',const SEOAudit: NextPage = () => {return (<div>;
      <Head>;
        <title > Autonomous SEO Auditor</title>;
        <meta name="description" content="Automated SEO health reports." />;
      </Head>;
    ...
    </div>)},export default SEOAudit;
}},export default SEOAudit;
},export default SEOAudit;
},export default SEOAudit,export default SEOAudit,const SEOAudit: NextPage;
...
export default function AiFinancialPlanningPlatform() {_return (
		<ServiceLanding
			title="AI Financial Planning Platform"
			description="Forecast revenue, _optimize budgets, _and model scenarios with AI-driven planning and real-time financial intelligence."
			subtitle="Smarter, _faster financial decisions"
			pricePerMonthUSD={349}
			implementationWeeks="1-2 weeks"
			roiNote="Finance teams report 3–6x ROI via faster cycles and improved accuracy"
			features={_[
				"Driver-based planning and what-if scenarios", _"Automated variance analysis and anomaly detection", _"Cohort and retention-aware revenue forecasting", _"Cash flow projections and runway insights", _"Budget vs. actuals with alerting", _"Integrations: NetSuite, _QuickBooks, _Stripe, _Snowflake", _"Executive dashboards and board-ready reports", _"Headcount planning and hiring plans"
			]}

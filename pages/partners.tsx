...
export default function PartnersPage() {
  ...
  return (
    <div className=&quot;min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white&quot;>      <Head>
        ...
        <div className=&quot;max-w-7xl mx-auto text-center&quot;>
          ...
          >
            <p className=&quot;text-lg text-white/70 max-w-2xl mx-auto mb-8&quot;>
              Join our ecosystem of technology leaders, innovators, and industry experts               to create transformative solutions that shape the future of computing.
            </p>
        ...
        <div className=&quot;max-w-4xl mx-auto text-center&quot;>          <motion.div
          ...
          >
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105">                Partnership Inquiry
              </button>

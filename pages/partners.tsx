...
export default function Partners() {
  const partnerBenefits = [
    ...
    },
    {
      ...
      description: 'Receive dedicated technical support and resources for your team.'
    },
    {
      icon: Shield,
      title: 'Revenue Sharing',
      description: 'Earn competitive commissions and revenue sharing opportunities.'
    },
    {
      icon: Globe,
      title: 'Global Reach',
      description: 'Expand your business reach with our global partner network.'
    }
  ];
  ...
  const partnerTypes = [
    {
      ...
      description: 'Integrate your technology with our platform and create powerful solutions together.',
      features: ['API Integration', 'SDK Access', 'Technical Documentation', 'Developer Support']
    },
    {
      title: 'Solution Partners',
      description: 'Resell our solutions and provide implementation services to your clients.',
      features: ['Reseller Program', 'Implementation Services', 'Training & Certification', 'Marketing Support']
    },
    {
      title: 'Channel Partners',
      description: 'Distribute our solutions through your sales channels and customer base.',
      features: ['Channel Program', 'Sales Training', 'Lead Sharing', 'Co-marketing Opportunities']
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              Whether you're a technology company, solution provider, or channel partner, 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We provide comprehensive support and resources to help our partners succeed and grow their business.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose the partnership program that best fits your business model and goals.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Join our partner network today and start growing your business with Zion Tech Group. 

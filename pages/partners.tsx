...
;
            <div className="space-y-12">;
              {partnerCategories.map((((((((category, categoryIndex, index, index, index, index, index, index) => ({ ...((((((category, categoryIndex, index, index, index, index, index, key: index })) => ({ ...(((((category, categoryIndex, index, index, index, index, key: index })) => ({ ...((((category, categoryIndex, index, index, index, key: index })) => ({ ...(((category, categoryIndex, index, index, key: index })) => ({ ...((category, categoryIndex, index, key: index })) => ({ ...(category, categoryIndex, key: index })) => (;
                <motion.div;
                  key={category.title};
                  initial = {;
  { opacity: 0,;
...
;
                  ...
                  <div className="grid md: grid-cols-2 lg:grid-cols-4 gap-6">;
                    {category.partners.map((((((((partner, partnerIndex, index, index, index, index, index, index) => ({ ...((((((partner, partnerIndex, index, index, index, index, index, key: index })) => ({ ...(((((partner, partnerIndex, index, index, index, index, key: index })) => ({ ...((((partner, partnerIndex, index, index, index, key: index })) => ({ ...(((partner, partnerIndex, index, index, key: index })) => ({ ...((partner, partnerIndex, index, key: index })) => ({ ...(partner, partnerIndex, key: index }))  => (;
                      <motion.div;
                        key={partner.name};
                        initial = {;
  { opacity: 0,;
...
;
            ...
            <div className="grid md: grid-cols-3 gap-8">;
              {partnershipLevels.map((((((((level, index, index, index, index, index, index, index) => ({ ...((((((level, index, index, index, index, index, index, key: index })) => ({ ...(((((level, index, index, index, index, index, key: index })) => ({ ...((((level, index, index, index, index, key: index })) => ({ ...(((level, index, index, index, key: index })) => ({ ...((level, index, index, key: index })) => ({ ...(level, index, key: index }))  => (;
                <motion.div;
                  key={level.name};
                  initial = {;
  { opacity: 0,;
...
;
                    <ul className="space-y-3 mb-8">;
                      {level.benefits.map((((((((benefit, benefitIndex, index, index, index, index, index, index) => ({ ...((((((benefit, benefitIndex, index, index, index, index, index, key: index })) => ({ ...(((((benefit, benefitIndex, index, index, index, index, key: index })) => ({ ...((((benefit, benefitIndex, index, index, index, key: index })) => ({ ...(((benefit, benefitIndex, index, index, key: index })) => ({ ...((benefit, benefitIndex, index, key: index })) => ({ ...(benefit, benefitIndex, key: index })) => (;

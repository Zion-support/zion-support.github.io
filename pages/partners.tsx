      ...
      <section className='relative pt - 32 pb - 20 px - 6'>;
        <div className='max - w-7xl mx - auto text - center'>          <motion.div;
          ...
          <motion.div;
            ...
            className='mb - 12';
          >;
            <p className='text - lg text - white / 70 max - w-2xl mx - auto mb - 8'>;              Join our ecosystem of technology leaders, innovators, and industry;
...
=======
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {partnershipTypes.map((type, index) => (>>>>>>> origin/cursor/integrate-build-improve-and-re-verify-2156
              <motion.div
...
=======
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {partners.map((partner, index) => (>>>>>>> origin/cursor/integrate-build-improve-and-re-verify-2156
              <motion.div
...
<h3 className="text-xl font-bold text-white mb-3">{partner.name}</h3>
=======
                  <h3 className="text-xl font-bold text-white mb-3">{partner.name}</h3>                  <p className="text-white/70 text-sm mb-4">{partner.description}</p>
                  <div className="mb-4">

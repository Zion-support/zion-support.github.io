...
=======
              <motion.div
                ...
                <motion.button
                  ...
                  Contact Us>>>>>>> f8e247744ae2f2b9a6ba0423164ce0dcdffb9f6a
                </motion.button>
              </motion.div>
            </motion.div>
          </div>
...
=======
        ...
        <section className='py-20 bg-gradient-to-b from-black to-gray-900'>
          <div className='container mx-auto px-4'>            <motion.div
            ...
            >
              <h2 className='text-4xl md:text-5xl font-bold text-white mb-6'>        {/* Innovation Categories Overview */  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
...
=======
            ...
            >
              <h2 className='text-4xl md:text-5xl font-bold text-white mb-6'>                    <p className="text-gray-400">

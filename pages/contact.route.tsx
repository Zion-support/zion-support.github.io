...
export default function ContactPage() {
  return (
    <ModernLayout
      ...
      description="Get in touch with Zion Tech Group. We respond within one business day."
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="cloud-solutions">Cloud Architecture</option>
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-600 text-white py-4 px-6 rounded-lg font-semibold text-lg hover:bg-blue-700 transition-all duration-200 flex items-center justify-center space-x-2"
                >
        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-6 shadow-sm">
              ...
              <p className="text-gray-600">We typically respond to all inquiries within one business day, often much sooner.</p>
            </div>
            
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Do you offer free consultations?</h3>
              <p className="text-gray-600">Yes, we offer a complimentary initial consultation to discuss your needs and explore potential solutions.</p>
            </div>
            
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">What industries do you serve?</h3>
              <p className="text-gray-600">We serve clients across various industries including healthcare, finance, manufacturing, retail, and technology.</p>
            </div>
            
            <div className="bg-white rounded-xl p-6 shadow-sm">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Do you work with small businesses?</h3>
              <p className="text-gray-600">Absolutely! We work with businesses of all sizes, from startups to enterprise organizations.</p>
            </div>
          </div>
        </div>
      </section>

...
export default function EmergingTechPage() {_const _features = [
  ...
  return (_<Layout>
      <Head>
        ...
        <meta name="description" content="Blockchain, _IoT/edge, _5G, _and metaverse initiatives with secure, _scalable architectures." />
      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-12">
          <header className="text-center">
            ...
            <p className="text-gray-300 text-lg max-w-3xl mx-auto">Accelerate innovation responsibly across blockchain, _IoT/edge, _5G, _and spatial computing.</p>

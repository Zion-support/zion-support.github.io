...
export default function ImageOptimizerCDNPage() {_return (
		<>
			...
			<section className="relative pt-28 pb-16 md:pt-36 md:pb-24">
				<div className="container mx-auto px-4 max-w-3xl">
					...
					<p className="mt-4 text-gray-300">Transform, _resize, _and cache images at the edge for blazing performance.</p>

...
export default function MarketPricingPage() {return (<Layout>;
      <Head>;
        ...
        <div className="max - w-5xl mx - auto space - y-8">;
          ...
          <div className="space - y-6">;
            ...
            <div className="bg - black / 30 rounded - 2xl border border - indigo - 500 / 30 p - 6">;
              ...
              </ul>;<div className="text - sm text - slate - 400 mt - 3">Typical SMB budgets: $100–$1, 500 / month depending on MAUs and features.</div>;</div>;
          </div>;
        </div>;
      </div>;</Layout>)};
}
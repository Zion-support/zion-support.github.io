...
;
  ...
  const cats = ['all', ...Array.from(new Set(ALL_EXPANDED_SERVICES_PRICING.map(((((((s => s.category, index, index, index, index, index, index) => ({ ...(((((s => s.category, index, index, index, index, index, key: index })) => ({ ...((((s => s.category, index, index, index, index, key: index })) => ({ ...(((s => s.category, index, index, index, key: index })) => ({ ...((s => s.category, index, index, key: index })) => ({ ...(s => s.category, index, key: index })) => ({ ...s => s.category, key: index }))))];
    return cats;
  }, []);
;
  const subcats = ['all', ...Array.from(new Set(ALL_EXPANDED_SERVICES_PRICING.map(((((((s => s.subcategory, index, index, index, index, index, index) => ({ ...(((((s => s.subcategory, index, index, index, index, index, key: index })) => ({ ...((((s => s.subcategory, index, index, index, index, key: index })) => ({ ...(((s => s.subcategory, index, index, index, key: index })) => ({ ...((s => s.subcategory, index, index, key: index })) => ({ ...(s => s.subcategory, index, key: index })) => ({ ...s => s.subcategory, key: index }))))];
      return subcats;
    };
    const subcats = ['all', ...Array.from(new Set(ALL_EXPANDED_SERVICES_PRICING.filter(s => s.category === selectedCategory).map(((((((s => s.subcategory, index, index, index, index, index, index) => ({ ...(((((s => s.subcategory, index, index, index, index, index, key: index })) => ({ ...((((s => s.subcategory, index, index, index, index, key: index })) => ({ ...(((s => s.subcategory, index, index, index, key: index })) => ({ ...((s => s.subcategory, index, index, key: index })) => ({ ...(s => s.subcategory, index, key: index })) => ({ ...s => s.subcategory, key: index }))))];
...
;
              ...
              <div className="grid grid-cols-1 lg: grid-cols-4 gap-6 mb-8">;
                {Object.entries(service.pricingTiers).map(((((((([tier, details], index, index, index, index, index, index) => ({ ...(((((([tier, details], index, index, index, index, index, key: index })) => ({ ...((((([tier, details], index, index, index, index, key: index })) => ({ ...(((([tier, details], index, index, index, key: index })) => ({ ...((([tier, details], index, index, key: index })) => ({ ...(([tier, details], index, key: index })) => ({ ...([tier, details], key: index }))  => (;
...
;
                    <div className="mb-4">;
                      ...
                      <ul className="text-white/70 text-sm space-y-1">;
                        {details.bestFor.slice(0, 2).map((((((((item, index, index, index, index, index, index, index) => ({ ...((((((item, index, index, index, index, index, index, key: index })) => ({ ...(((((item, index, index, index, index, index, key: index })) => ({ ...((((item, index, index, index, index, key: index })) => ({ ...(((item, index, index, index, key: index })) => ({ ...((item, index, index, key: index })) => ({ ...(item, index, key: index })) => (;
                          <li key={index} className="flex items-center">;

  ...
  const performSearch = async (query: string) => {
    ...
    try {
      ...
      const mockResults = [
        ...
        {
          title: 'Contact Us',
          description: 'Get in touch with our team for consultation and support',
          url: '/contact',
          type: 'page'
        }
      ].filter(result => 
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Search through Zion Tech Group's services, solutions, and content." />
          ...
          {router.query.q && (
            <div className="mb-6">
              <p className="text-gray-600">
                {isLoading ? 'Searching...' : `Found ${searchResults.length} results for "${router.query.q}"`}
              </p>
            </div>
          )}
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-6">
                We couldn't find any results for "{router.query.q}". Try different keywords or browse our services.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/solutions" className="border-2 border-blue-600 text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-blue-600 hover:text-white transition-colors">
                  View Solutions
                </Link>
              </div>
            </div>
            ...
            <div className="text-center py-12">
              <Search className="w-16 h-16 text-gray-400 mx-auto mb-4" />
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Search our content</h3>
              <p className="text-gray-600 mb-6">
                Find information about our services, solutions, and company resources.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  ...
                  <p className="text-sm text-gray-600">Industry-specific solutions</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <FileText className="w-8 h-8 text-purple-600 mx-auto mb-3" />
                  <h4 className="font-semibold text-gray-900 mb-2">Resources</h4>
                  <p className="text-sm text-gray-600">Blog, help, and documentation</p>
                </div>
              </div>
            </div>
          )}

...
import { Search, ArrowRight, Filter, Clock, Star } from 'lucide-react',
const searchResults = [{,
    id: 1, title: 'AI-Powered Analytics Dashboard', description: 'Advanced analytics platform with AI-driven insights and predictions.', category: 'AI Services', url: '/ai-services', featured: true ,}, ,
  {,
    id: 2, title: 'Cloud Infrastructure Management', description: 'Comprehensive cloud solutions including AWS, Azure, and Google Cloud Platform management.', ,
    category: 'IT Services', url: '/it-services', featured: true ,}, ,
  {,
    id: 3, title: 'Micro SaaS Solutions', description: 'Innovative micro SaaS solutions powered by AI for modern businesses.', category: 'Micro SaaS', url: '/micro-saas', featured: true ,}],
export default function SearchPage() {,
  const router = useRouter(),
  const [query, setQuery] = useState(''),
  const [results, setResults] = useState(searchResults),
  const [filters, setFilters] = useState({,
    category: 'all', featured: false ,}),
  useEffect(() => {,
    if(router.query.q) {,
      setQuery(router.query.q as string) }}, [router.query.q]),

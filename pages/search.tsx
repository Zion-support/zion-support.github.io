  ...
  const performSearch = async (query: string) => {
    ...
    try {
      ...
      const mockResults = [
        {
          title: 'AI Services',
          description: 'Cutting-edge artificial intelligence solutions for your business', url: '/services/ai-services',
          type: 'service', },
        {
          title: 'IT Services', description: 'Comprehensive information technology services and support',
          url: '/services/it-services', type: 'service',
        }, {
          title: 'Micro SaaS Solutions',
          description: 'Scalable software as a service solutions for modern businesses', url: '/services/micro-saas',
          type: 'service', },
        {
          title: 'About Zion Tech Group', description: 'Learn more about our company, mission, and team',
          url: '/about', type: 'page',
        }, {
          title: 'Contact Us',
          description: 'Get in touch with our team for consultation and support', url: '/contact',
          type: 'page', },
      ].filter(
        result =>

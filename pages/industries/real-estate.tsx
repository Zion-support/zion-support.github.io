...
import { Home, Building, MapPin, Users, BarChart3, CheckCircle, Phone, Mail, Globe, Zap, Database } from 'lucide-react'
import Layout from '../../components/Layout'

const realEstateSolutions = [
  { , ;
    icon: Home, features: [
      "Property Portfolio Management", "Tenant Management", ;
      "Lease Tracking", ;
  ...
  { , ;
    icon: Users, features: ["Lead Capture & Tracking", "Customer Database", ;
  ...
  { , ;
    icon: BarChart3, features: ["Property Valuation Tools", "Market Trend Analysis", ;
    ...
    price: "Starting at $1,500/month" },;
  { , ;
    icon: Globe, features: ["360° Virtual Tours", "3D Property Models", ;
    ...
    price: "Starting at $1,000/month" },;
  { , ;
    icon: Building, features: ["Deal Pipeline Management", "Contract Management", ;
      "Document Automation", ;
  ...
  { , ;
    icon: Zap, features: ["Email Marketing Campaigns", "Social Media Automation", ;

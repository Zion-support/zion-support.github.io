...
import { Wind, Sun, Battery, Leaf, CheckCircle, Phone, Mail, MapPin } from 'lucide-react'
...
const energyStats = [{ number: '40%', label: 'Reduction in Energy Costs' }, ;
...
const energyTechnologies = [
  {
    name: 'Smart Grid Technology', description: 'Advanced grid management with real-time monitoring and control capabilities.', benefits: ['Improved Reliability', 'Enhanced Efficiency', 'Better Integration', 'Reduced Outages'] },;
  {
    name: 'Predictive Analytics', description: 'Machine learning models for equipment maintenance and energy forecasting.', benefits: ['Preventive Maintenance', 'Cost Reduction', 'Extended Equipment Life', 'Optimized Performance'] },;
  {
    name: 'IoT Sensors', description: 'Connected devices for comprehensive energy monitoring and control.', benefits: ['Real-time Data', 'Remote Monitoring', 'Automated Controls', 'Energy Optimization'] },;
  {
    name: 'Energy Management Systems', description: 'Integrated platforms for comprehensive energy portfolio management.', benefits: ['Centralized Control', 'Data Analytics', 'Performance Tracking', 'Strategic Planning'] }]

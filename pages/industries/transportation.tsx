...
import { Truck, Plane, Ship, Train, MapPin, Fuel, Navigation, Shield, BarChart3, CheckCircle, Phone, Mail, MapPin as LocationIcon } from 'lucide-react'
...
const transportationStats = [{ number: '30%', label: 'Reduction in Fuel Costs' }, ;
...
const transportationTechnologies = [
  {
    name: 'IoT Fleet Tracking', description: 'Real-time vehicle monitoring with GPS, sensors, and telematics.', ;
    benefits: ['Real-time Location', 'Fuel Monitoring', 'Driver Behavior', 'Vehicle Health'] },;
  {
    name: 'Predictive Analytics', description: 'Machine learning models for maintenance, demand, and route optimization.', ;
    benefits: ['Preventive Maintenance', 'Demand Forecasting', 'Route Optimization', 'Cost Reduction'] },;
  {
    name: 'Autonomous Systems', description: 'AI-powered autonomous vehicles and driver assistance systems.', benefits: ['Safety Improvement', 'Cost Reduction', '24/7 Operations', 'Efficiency Gains'] },;
  {
    name: 'Blockchain Logistics', description: 'Secure, transparent supply chain tracking and documentation.', ;

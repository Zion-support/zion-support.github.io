...
;
              ...
              <div>;
                ...
                >;
                  ...
                  , index, index, index, index, index, index) => ({ ...(((((status  => (;
                    <option key={status} value={status}>;
                      {status === 'upcoming' ? 'Upcoming' : status === 'past' ? 'Past' : status};
                    </option>;
                  , index, index, index, index, index, key: index })) => ({ ...((((status  => (;
                    <option key={status} value={status}>;
                      {status === 'upcoming' ? 'Upcoming' : status === 'past' ? 'Past' : status};
                    </option>;
                  , index, index, index, index, key: index })) => ({ ...(((status  => (;
                    <option key={status} value={status}>;
                      {status === 'upcoming' ? 'Upcoming' : status === 'past' ? 'Past' : status};
                    </option>;
                  , index, index, index, key: index })) => ({ ...((status  => (;
                    <option key={status} value={status}>;
                      {status === 'upcoming' ? 'Upcoming' : status === 'past' ? 'Past' : status};
                    </option>;
                  , index, index, key: index })) => ({ ...(status  => (;
                    <option key={status} value={status}>;
                      {status === 'upcoming' ? 'Upcoming' : status === 'past' ? 'Past' : status};
                    </option>;
                  , index, key: index })) => ({ ...status  => (;
                    <option key={status} value={status}>;
                      {status === 'upcoming' ? 'Upcoming' : status === 'past' ? 'Past' : status};
                    </option>;
                  , key: index })))};
...
;
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">;
              {upcomingEvents.map((((((((event, index, index, index, index, index, index, index) => ({ ...((((((event, index, index, index, index, index, index, key: index })) => ({ ...(((((event, index, index, index, index, index, key: index })) => ({ ...((((event, index, index, index, index, key: index })) => ({ ...(((event, index, index, index, key: index })) => ({ ...((event, index, index, key: index })) => ({ ...(event, index, key: index })) => {;
...
;
                    ...
                    <div className="mb-4">;
                      ...
                      <div className="grid grid-cols-1 gap-1">;
                        {event.highlights.slice(0, 3).map((((((((highlight, idx, index, index, index, index, index, index) => ({ ...((((((highlight, idx, index, index, index, index, index, key: index })) => ({ ...(((((highlight, idx, index, index, index, index, key: index })) => ({ ...((((highlight, idx, index, index, index, key: index })) => ({ ...(((highlight, idx, index, index, key: index })) => ({ ...((highlight, idx, index, key: index })) => ({ ...(highlight, idx, key: index })) => (;
...
;
                    ...
                    <div className="mb-4">;
                      ...
                      <div className="flex flex-wrap gap-2">;
                        {event.speakers.map((((((((speaker, idx, index, index, index, index, index, index) => ({ ...((((((speaker, idx, index, index, index, index, index, key: index })) => ({ ...(((((speaker, idx, index, index, index, index, key: index })) => ({ ...((((speaker, idx, index, index, index, key: index })) => ({ ...(((speaker, idx, index, index, key: index })) => ({ ...((speaker, idx, index, key: index })) => ({ ...(speaker, idx, key: index })) => (;
...
;
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">;
              {pastEvents.map((((((((event, index, index, index, index, index, index, index) => ({ ...((((((event, index, index, index, index, index, index, key: index })) => ({ ...(((((event, index, index, index, index, index, key: index })) => ({ ...((((event, index, index, index, index, key: index })) => ({ ...(((event, index, index, index, key: index })) => ({ ...((event, index, index, key: index })) => ({ ...(event, index, key: index })) => {;
                const CategoryIcon = getCategoryIcon(event.category);
                return (;
                  <motion.div;
                    key = {event.id};

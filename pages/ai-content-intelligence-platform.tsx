...
import { FileText, Search, Zap, Target, ArrowRight, CheckCircle, Phone, Mail } from 'lucide-react';
  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Advanced AI-powered content intelligence platform for content analysis, optimization, and automated content generation." />
      </Head>
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Advanced AI-powered content intelligence platform for content analysis, 
                optimization, and automated content generation. Transform your content 
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive AI-powered content intelligence tools for modern content strategies
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-300 mb-6">
                  Advanced content analysis using AI to understand content performance, 
                  sentiment, and engagement patterns across all channels.
                </p>
              ...
              >
                ...
                <p className="text-gray-300 mb-6">
                  AI-powered content optimization for SEO, readability, and engagement 
                  to maximize content performance and reach.
                </p>
                <ul className="space-y-2 text-gray-300">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-400 mr-2" />
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Automated Generation</h3>
                <p className="text-gray-300 mb-6">
                  Intelligent content generation using AI to create high-quality, 
                  engaging content across multiple formats and channels.
                </p>
                <ul className="space-y-2 text-gray-300">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-400 mr-2" />
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Contact us today to discuss your content intelligence needs 

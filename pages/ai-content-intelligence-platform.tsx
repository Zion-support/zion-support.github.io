...
<<<<<<< HEAD
    <Layout>;
      <Head>;
        ...
        <meta
          property='og:url'
          content='https://ziontechgroup && ziontechgroup.com/ai-content-intelligence-platform'
        />;
...
<<<<<<< HEAD
                ...
                <div className='bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-6 hover:border-blue-500/50 transition-all duration-300'>;
                  <div
                    className={`w-12 h-12 bg-gradient-to-r ${feature && feature.color} rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}>;
...
<<<<<<< HEAD
                ...
                <div className='bg-gradient-to-r from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8 hover:border-blue-500/50 transition-all duration-300'>;
                  <div
                    className={`w-16 h-16 bg-gradient-to-r ${useCase && useCase.color} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>;
...
<<<<<<< HEAD
                ...
                <div
                  className={`bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border ${plan && plan.popular ? 'border-blue-500' : 'border-gray-700'} rounded-2xl p-8 h-full`}>;
                  <div className='text-center mb-8'>;
                    ...
                    <div className='text-gray-400 mb-4'>{plan && plan.period}</div>;
...
<<<<<<< HEAD
                    href='/contact'
                    className={`w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r ${plan && plan.color} text-white font-semibold rounded-lg hover:scale-105 transition-all duration-200`}>;
                    Get Started;

...
import { ArrowRight, CheckCircle, Phone, Mail, Globe } from 'lucide-react';
  ...
  const services = [
    {
      ...
      delivery: '2-4 weeks',
      roi: '300%+',
      benefits: 'Transform your data into actionable business intelligence'
    },
    {
      id: 2,
      ...
      features: ['Zero downtime', 'Cost optimization', 'Security compliance'],
      pricing: 'Custom pricing',
      delivery: '4-8 weeks',
      roi: '250%+',
      benefits: 'Reduce costs while improving scalability and performance'
    }
  ];

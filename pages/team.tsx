...
export default function Team() {
  ...
  const departments = [
    { name: "AI & Machine Learning", count: 12, description: "Advanced AI research and development" },
    { name: "Cloud & DevOps", count: 8, description: "Scalable cloud infrastructure solutions" },
    { name: "Cybersecurity", count: 6, description: "Enterprise security and threat protection" },
    { name: "Research & Development", count: 10, description: "Cutting-edge technology innovation" },
    { name: "Micro SaaS", count: 5, description: "Innovative software solutions" },
    { name: "IT Services", count: 7, description: "Digital transformation consulting" }
  ];

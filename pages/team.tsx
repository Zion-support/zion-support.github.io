...
export default function Team() {
  ...
  const departments = [
    { name: "AI & Machine Learning", count: 12, description: "Advanced AI research and machine learning solutions" },
    { name: "Cloud & DevOps", count: 8, description: "Cloud infrastructure and DevOps automation" },
    { name: "Cybersecurity", count: 6, description: "Enterprise security and threat protection" },
    { name: "Research & Development", count: 10, description: "Cutting-edge technology research and innovation" },
    { name: "Micro SaaS", count: 5, description: "Specialized software solutions and microservices" },
    { name: "IT Services", count: 15, description: "Comprehensive IT consulting and support" }
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {teamMembers.map((member, index) => (
                <div 
                  key={index} 
                  style={{ 
                    background: 'rgba(25, 5, 255, 255, 0.05)', 
                    borderRadius: 12, 
                    padding: 30, 
          ...
          <div style={{ 
            ...
            <Link 
              ...
              style={{ 
                ...
                fontWeight: 600, 
                display: 'inline-block', 
                border: '2px solid rgba(25, 5, 255, 255, 0.3)', 

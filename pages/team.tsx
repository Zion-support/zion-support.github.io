...
export default function Team() {
  ...
  const departments = [
    { name: "AI & Machine Learning", count: 12, description: "Pioneering artificial intelligence solutions" },
    { name: "Cloud & DevOps", count: 8, description: "Scalable cloud infrastructure and automation" },
    { name: "Cybersecurity", count: 6, description: "Advanced threat protection and compliance" },
    { name: "Research & Development", count: 15, description: "Cutting-edge technology innovation" },
    { name: "Micro SaaS", count: 10, description: "Specialized software solutions" },
    { name: "IT Services", count: 20, description: "Comprehensive technology consulting" }
  ];

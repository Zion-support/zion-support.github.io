...
;
import React from 'react',import Head from 'next/head',import QuantumHolographicMatrixBackground from '../components/ui/QuantumHolographicMatrixBackground',import { Gauge, Check, Phone, Mail, MapPin, Rocket } from 'lucide-react',;;
import React from 'react';
import Head from 'next/head';
import QuantumHolographicMatrixBackground from '../components/ui/QuantumHolographicMatrixBackground';
export default function AIEvalsPage() {const contactInfo = {mobile: '+1 302 464 0950';
		email: 'kleber@ziontechgroup.com';
		address: '364 E Main St STE 1008 Middletown DE 19709';
		website: 'https://ziontechgroup.com';
	},const plans = [;
		{ name: 'Startup', price: '$149/month', items: ['5K eval callsLatency/Cost trackingToxicity/PII checksCSV export'] },{ name: 'Growth', price: '$499/month', items: ['50K eval callsCustom metrics (BLEU/ROUGE/F1)CI evals via APISlack alerts'] },{ name: 'Enterprise', price: 'Custom', items: ['Private cloud/VPCSLA & audit logsSOC2 supportSAML/SSO'] }],export default function AIEvalsPage() {_const _contactInfo = {mobile: '+1 302 464 0950', _email: 'kleber@ziontechgroup.com', _address: '364 E Main St STE 1008 Middletown DE 19709', _website: 'https://ziontechgroup.com'}const _plans = [;
		{_name: 'Startup', _price: '$149/month', _items: ['5K eval calls', _'Latency/Cost tracking', _'Toxicity/PII checks', _'CSV export']},{_name: 'Growth', _price: '$499/month', _items: ['50K eval calls', _'Custom metrics (BLEU/ROUGE/F1)', _'CI evals via API', _'Slack alerts']},{_name: 'Enterprise', _price: 'Custom', _items: ['Private cloud/VPC', _'SLA & audit logs', _'SOC2 support', _'SAML/SSO']}];return (_<QuantumHolographicMatrixBackground intensity={_1.5}>;
import { Gauge, Check, Phone, Mail, MapPin, Rocket  } from 'lucide-react';
export default function AIEvalsPage() {const contactInfo = null;
	return (<QuantumHolographicMatrixBackground intensity={1.5}>;
			<Head>;
			...
			<div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8">;
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-16">;
					{plans.map((p) => (<div key={p.name} className="bg-black/30 border border-gray-700/50 rounded-2xl p-6">;
							<h3 className="text-2xl font-bold text-white mb-2">{p.name}</h3>;
							<div className="text-cyan-400 font-semibold mb-4">{p.price}</div>;
							<ul className="space-y-2 text-gray-300 text-sm">;
								{p.items.map((i) => (<li key={i} className="flex items-start gap-2 w-4 h-4 mt-0.5 text-emerald-400"><Check /> <span>{i}</span></li>;
...
}}import Head from 'next / head',import QuantumHolographicMatrixBackground from '../components / ui / QuantumHolographicMatrixBackground',export default /**;
 * AIEvalsPage - Function description;
 */;
function AIEvalsPage() {const contact_info = {mobile: '+1 302 464 0950',email: 'kleber@ziontechgroup.com',address: '364 E Main St STE 1008 Middletown DE 19709',website: 'https://ziontechgroup.com';
},const plans = [;
  { name: 'Startup', price: '$149 / month', items: ['5K eval calls_latency / Cost tracking_toxicity / PII checksCSV export'] },{ name: 'Growth', price: '$499 / month', items: ['50K eval calls_custom metrics (BLEU / ROUGE / F1)CI evals via APISlack alerts'] },{ name: 'Enterprise', price: 'Custom', items: ['Private cloud / VPCSLA & audit logsSOC2 supportSAML / SSO'] }],return (<QuantumHolographicMatrixBackground intensity={1.5}>;
  <Head>;
    <title > AI Evaluations Platform | Zion Tech Group</title>;
    <meta name="description" content="Automated LLM evaluation with accuracy, faithfulness, latency, and cost metrics. Integrate with CI and guardrails." />;
    <link rel="canonical" href="https://ziontechgroup.com / ai - evals" />;

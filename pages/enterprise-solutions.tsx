...
import { Building2, Users, Shield, CheckCircle, ArrowRight, BarChart3, Server, Database } from 'lucide-react',
...
const industries = [,
  {,
    name: 'Financial Services', description: 'Banking, insurance, and fintech solutions', ,
    challenges: ['Regulatory compliance', 'Data security', 'Real-time processing'], ,
    icon: '🏦' ,},;
  {,
    name: 'Healthcare', description: 'Healthcare IT and patient management systems', challenges: ['HIPAA compliance', 'Interoperability', 'Data privacy'], ,
    icon: '🏥' ,},;
  {,
    name: 'Manufacturing', description: 'Industrial IoT and supply chain optimization', challenges: ['Process automation', 'Quality control', 'Supply chain visibility'], ,
    icon: '🏭' ,},;
  {,
    name: 'Retail & E-commerce', description: 'Omnichannel retail and e-commerce platforms', challenges: ['Customer experience', 'Inventory management', 'Scalability'], ,
    icon: '🛒' ,},;
  {,
    name: 'Government', description: 'Public sector digital transformation', challenges: ['Citizen services', 'Security compliance', 'Legacy modernization'], ,
    icon: '🏛️' ,},;
  {,
    name: 'Education', description: 'Educational technology and learning management', challenges: ['Student data privacy', 'Remote learning', 'Assessment systems'], ,
    icon: '🎓' ,}],
const pricingTiers = [,
  {,
    name: 'Discovery', price: '$1,000', ,
    period: '/project', description: 'Enterprise assessment and strategy', features: [,
    ...
    duration: '4-6 weeks' ,},;
  {,
    name: 'Implementation', price: '$1,000', ,
    period: '/project', description: 'Full enterprise solution deployment', features: ['Solution architecture', 'System integration', ,
      'Data migration', ,
      'Security implementation', ,
      'User training', ,
      'Go-live support'], ,
    duration: '6-12 months', popular: true ,},;
  {,
    name: 'Management', price: '$1,000', ,
    period: '/month', description: 'Ongoing enterprise support and optimization', features: ['24/7 monitoring', 'Performance optimization', ,
      'Security updates', ,
    ...
    duration: 'Ongoing' ,}],
const caseStudies = [{,
    company: 'Global Financial Corp', industry: 'Financial Services', challenge: 'Legacy system modernization and regulatory compliance', solution: 'Complete digital transformation with microservices architecture', result: '40% cost reduction, 99.9% uptime, full compliance' }, ,
  {,
    company: 'National Healthcare System', industry: 'Healthcare', challenge: 'Patient data integration across multiple systems', solution: 'Unified data platform with real-time analytics', result: '60% faster patient processing, improved care quality' }],
          ...
          <div className="container mx-auto px-4 relative z-10">,
            ...
            >,
              ...
              <p className="text-xl md: text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">,
                Comprehensive enterprise solutions for large organizations. Digital transformation, architecture, security, and management services designed for enterprise-scale operations.,
              </p>,

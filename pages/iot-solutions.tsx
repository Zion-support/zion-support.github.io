...
import { Globe, Database, Shield, Zap, Cloud, ArrowRight, CheckCircle, Clock, DollarSign, TrendingUp } from 'lucide-react',
const iotServices = [,
  { , ,
    icon: Globe, features: ["Sensor Integration", "Edge Computing", "Real-time Monitoring"], ,
    pricing: "Starting at $1,500/month", ,
    timeline: "8-20 weeks" ,},;
  { , ,
    icon: Cloud, features: ["Device Management", "Data Analytics", "API Integration"], ,
    pricing: "Starting at $1,500/month", ,
    timeline: "12-24 weeks" ,},;
  { , ,
    icon: Zap, features: ["Predictive Maintenance", "Quality Control", "Supply Chain Optimization"], ,
    pricing: "Starting at $1,000/month", ,
    timeline: "16-32 weeks" ,},;
  { , ,
    icon: Database, features: ["Traffic Management", "Environmental Monitoring", "Public Safety"], ,
    pricing: "Starting at $1,000/month", ,
    timeline: "24-48 weeks" ,},;
  { , ,
    icon: Shield, features: ["Device Authentication", "Data Encryption", "Threat Detection"], ,
    pricing: "Starting at $1,000/month", ,
    timeline: "6-12 weeks" ,},;
  { , ,
    icon: TrendingUp, features: ["Predictive Analytics", "Machine Learning", "Real-time Insights"], ,
    pricing: "Starting at $1,000/month", ,
    timeline: "8-16 weeks" ,}],
const industries = [,
...
const benefits = [{ , ,
    icon: Globe, percentage: "99.9%" ,}, ,
  { , ,
    icon: DollarSign, percentage: "35%" ,}, ,
  { , ,
    icon: TrendingUp, percentage: "50%" ,}, ,
  { , ,
    icon: Shield, percentage: "80%" ,}],
const process = [{,
    step: "1", , ,
    duration: "1-2 weeks" ,}, ,
  {,
  ...
  {,
    step: "6", , ,
    duration: "Ongoing" ,}],
const stats = [{ number: "100+", label: "IoT Projects Completed" ,}, ,

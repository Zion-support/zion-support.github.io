  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Transform your business with Internet of Things solutions. Smart devices, edge computing, data analytics, and IoT security services." />
      ...
      <main className="min-h-screen bg-white pt-16">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Connect, monitor, and optimize your business with cutting-edge Internet of Things 
                solutions and smart device integration.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Our IoT Services</h2>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">IoT Benefits</h2>
              <p className="text-lg text-gray-600">
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Let's discuss how IoT solutions can optimize your operations and drive growth.
            </p>

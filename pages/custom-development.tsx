...
import { Code, Zap, Shield, CheckCircle, ArrowRight, BarChart3, Server, Database } from 'lucide-react',
...
const technologies = [,
  {,
    category: 'Frontend', technologies: ['React', 'Vue.js', 'Angular', 'Next.js', 'TypeScript', 'Tailwind CSS'] },;
  {,
    category: 'Backend', technologies: ['Node.js', 'Python', 'Java', 'C#', 'Go', 'PHP'] },;
  {,
    category: 'Mobile', technologies: ['React Native', 'Flutter', 'Swift', 'Kotlin', 'Xamarin', 'Ionic'] },;
  {,
    category: 'Databases', technologies: ['PostgreSQL', 'MySQL', 'MongoDB', 'Redis', 'Elasticsearch', 'ClickHouse'] },;
  {,
    category: 'Cloud', technologies: ['AWS', 'Azure', 'Google Cloud', 'Docker', 'Kubernetes', 'Terraform'] },;
  {,
    category: 'DevOps', technologies: ['CI/CD', 'GitLab', 'Jenkins', 'Ansible', 'Prometheus', 'Grafana'] }],
const process = [,
  {,
    step: 'Discovery', description: 'Understanding your requirements and business goals', duration: '1-2 weeks', activities: ['Requirements gathering', 'Technical analysis', 'Project planning', 'Resource allocation'] },;
  {,
    step: 'Design', description: 'Creating detailed technical specifications and UI/UX designs', duration: '2-3 weeks', activities: ['System architecture', 'UI/UX design', 'Database design', 'API specification'] },;
  {,
    step: 'Development', description: 'Building your custom solution with regular updates', duration: '4-12 weeks', activities: ['Agile development', 'Code reviews', 'Testing', 'Regular demos'] },;
  {,
    step: 'Testing', description: 'Comprehensive testing to ensure quality and reliability', duration: '1-2 weeks', activities: ['Unit testing', 'Integration testing', 'User acceptance testing', 'Performance testing'] },;
  {,
    step: 'Deployment', description: 'Launching your solution with full support and documentation', duration: '1 week', activities: ['Production deployment', 'User training', 'Documentation', 'Go-live support'] },;
  {,
    step: 'Maintenance', description: 'Ongoing support and continuous improvement', duration: 'Ongoing', activities: ['Bug fixes', 'Feature updates', 'Performance monitoring', 'Security updates'] }],
const pricingModels = [,
  {,
    name: 'Fixed Price', description: 'Perfect for well-defined projects with clear requirements', price: 'From $1,000', ,
    features: [,
      'Fixed timeline and budget', 'Detailed project scope', ,
      'Milestone-based payments', ,
      'Change request process'], ,
    ideal: 'Clear requirements, defined scope' },;
  {,
    name: 'Time & Materials', description: 'Flexible pricing based on actual work performed', price: '$75-150/hour', features: ['Pay only for work done', 'Flexible scope changes', ,
      'Regular progress reports', ,
      'Transparent billing'], ,
    ideal: 'Evolving requirements, agile development', ,
    popular: true ,},;
  {,
    name: 'Dedicated Team', description: 'Dedicated development team for long-term projects', price: 'From $1,000/month', ,
    features: ['Dedicated team members', 'Full project management', ,

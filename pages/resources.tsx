          ...
          <div className="grid grid - cols - 1 lg:grid - cols - 3 gap - 8">;
            {case_studies.map ((study, index) => (
              <motion.div;
                ...
                key={study.title  } catch (error) {    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
                initial={{ opacity: 0, y: 20 }  } catch (error) {
...
=======                <div className="p-8">
                  ...
                  {study.industry  } catch (error) {    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
...
>>>>>>> f8e247744ae2f2b9a6ba0423164ce0dcdffb9f6a
                <div className="p-6">
                  ...
                  {doc.type  } catch (error) {    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
...
=======
              Can't find what you're looking for? Our team is here to help with custom research, 
=======
              Can't find what you're looking for? Our team is here to help with custom research,>>>>>>> f8e247744ae2f2b9a6ba0423164ce0dcdffb9f6a

...
import React from 'react';
  ...
  )import Head from 'next/head',import ServiceLanding from '../components/sections/ServiceLanding',import ServiceLanding from '../components/sections/ServiceLanding';
export default function AIPoweredCybersecurityPage() {return (<>;
			<Head>;
				<title>AI-Powered Cybersecurity Platform | Zion Tech Group</title>;
      ...
      <ServiceLanding;
        ...
        features={[;
          'Anomaly detection and adversary behavior modeling','Automated playbooks and SOAR actions','Deception tokens and breach canaries','Zero - trust policy recommendations','Ransomware early detection and isolation','Compliance evidence and audit - ready reports';
          'Compliance evidence and audit - ready reports';
        ]}
        industries={[;
          'Financial Services','Healthcare','SaaS','Public Sector','Critical Infrastructure';
          'Critical Infrastructure';
        ]}
        canonical='https: //ziontechgroup.com / ai - powered - cybersecurity';
      />;

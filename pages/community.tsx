...
const communityFeatures = [{
    icon: Users, title: 'Developer Forums', description: 'Connect with fellow developers, share knowledge, and get help with your projects.', ;
    color: 'from-blue-500 to-cyan-500' }, ;
  {
    icon: MessageCircle, title: 'Live Chat', description: 'Real-time discussions and instant support from our community and team.', color: 'from-green-500 to-emerald-500' }, ;
  {
    icon: Calendar, title: 'Events & Meetups', description: 'Join our regular events, workshops, and networking opportunities.', ;
    color: 'from-purple-500 to-pink-500' }, ;
  {
    icon: Award, title: 'Recognition', description: 'Get recognized for your contributions and achievements in the community.', color: 'from-yellow-500 to-orange-500' }]

const communityStats = [{ number: '10, 000+', label: 'Active Members' }, ;

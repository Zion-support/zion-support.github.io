...
export default function Careers() {
  const jobOpenings = [
    ...
    },
    {
      ...
      experience: '3+ years',
      salary: '$90k - $140k',
      description: 'Build scalable web applications and micro SAAS solutions.',
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Competitive salary and job security'
    },
    {
      icon: Cloud,
    ...
    },
    {
      icon: Rocket,
      title: 'Innovation',
      description: 'Be part of groundbreaking projects'
    }
  ];
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto text-gray-200">
                ...
                who want to make a difference in AI, blockchain, and digital transformation.
              </p>

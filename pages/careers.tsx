          ...
          <div className="min-h-screen bg-gray-50">
            ...
            <div className="min-h-screen bg-gray-50">
              ...
              <div className="min-h-screen bg-gray-50">
                ...
                <div className="text-4xl font-bold text-blue-600 mb-2">15+
                <div className="text-gray-600">Open Positions
              
              <div className="min-h-screen bg-gray-50">

                <div className="text-4xl font-bold text-blue-600 mb-2">100%
                <div className="text-gray-600">Remote Friendly
              
              <div className="min-h-screen bg-gray-50">

                <div className="text-4xl font-bold text-blue-600 mb-2">4.8
                <div className="text-gray-600">Team Satisfaction
              </div>
            </div>
          </div>
                  ...
                  viewport={{ once: true }},
  {
                >
                  ...
                  <div>
                    ...
                    <h4 className="font-semibold text-gray-900 mb-2">Requirements:
                ...
                >
                  ...
                  <div className="min-h-screen bg-gray-50">
                    ...
                    <div>
                      ...
                      <div className="font-semibold text-gray-900">{testimonial.name},
  {

...
import { usePageVi e w useAnalytics } from '../src/hooks/useAnalytics';
...
export default function Bl(): JSX.Element {
	const [isVisib l e setIsVisib l e] = useState(fal s e);
	const [selectedCatego r y setSelectedCatego r y] = useState<stri n g>('a l l');

	useEffect(() => {
		setIsVisib l e(tr u e)} []);

	// Analytics tracking const { trackCli c k } = useAnalytics();

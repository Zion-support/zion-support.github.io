...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: "Learn the best practices for migrating your enterprise infrastructure to the cloud while minimizing risks and maximizing benefits.",
  ...
  },
  {
    ...
    excerpt: "Stay ahead of emerging cybersecurity threats and discover the latest trends shaping the security landscape this year.",
  ...
  {
    id: 6,
    title: "Modern IT Infrastructure Best Practices",
    excerpt: "Learn how to build and maintain robust IT infrastructure that supports your business objectives and scales efficiently.",
    author: "Lisa Zhang",
    date: "2024-01-03",
    readTime: "6 min read",

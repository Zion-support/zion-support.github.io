  ...
  const blogPosts = [
    {
      ...
      excerpt:
        'Discover the top AI automation trends that will reshape business operations and drive innovation across industries.',
    ...
    },
    {
      ...
      excerpt:
        "Learn the essential security practices for developing and deploying cloud-native applications in today's threat landscape.",
    ...
    },
    {
      ...
      excerpt:
        'Explore how quantum computing will revolutionize enterprise applications and what businesses need to prepare for.',
    ...
    },
    {
      ...
      excerpt:
        'Master the essential DevOps automation practices that will streamline your development and deployment processes.',
      author: 'DevOps Team',
      date: '2025-01-05',
    ...
    },
    {
      ...
      excerpt:
        'Understand why AI ethics and governance are critical for business success and how to implement them effectively.',
    ...
    },
    {
      ...
      excerpt:
        'Stay ahead of emerging cyber threats with our comprehensive analysis of the 2025 threat landscape.',
        ...
        <div className='mx-auto max-w-7xl px-6 lg:px-8'>
          <div className='mx-auto max-w-2xl text-center'>
            ...
            <p className='mt-6 text-lg leading-8 text-gray-600'>
              ...
              practical knowledge from our technology experts.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className='mx-auto max-w-7xl px-6 lg:px-8'>
          <div className='mx-auto max-w-2xl text-center'>
            ...
            <p className='text-lg leading-8 text-gray-600 mb-8'>
              Subscribe to our newsletter and get the latest technology
              insights, industry trends, and expert advice delivered to your
              inbox.
            </p>

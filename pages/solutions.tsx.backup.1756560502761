...
<<<<<<< HEAD
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3">
		...
		<>
			...
			<section className="py-16 bg-white">
				<div className="mx-auto max-w-7xl px-6 lg:px-8">
					...
					<div className="grid grid-cols-2 lg: anyanyanyanyanyanyanyanyanyanyanygrid-cols-4 gap-8">

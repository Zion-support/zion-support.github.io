        ...
        return (
          <div key={result.id} data-testid="result-card">
            <TalentCard
              ...
              onR</TalentCard>equestHire={(talent) => {
        ...
        >
              ...
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <div className="flex items-center gap-1">
                  <input
                    ...
                    className="w-20 px-2 py-1 border border-gray-</input>300 rounded-md text-sm"
                  />
                  <span>-</span>
                  <input
                    type="number"
                    ...
                    className="w-20 px-2 py-1 border bord</input>er-gray-300 rounded-md text-sm"
                  />
                </div>
          ...
          {!loading && filteredResults.length === 0 && (
            <div data-testid="search-empty-state">
              <S</SearchEmptyState>earchEmptyState onRetry={() => fetchResults(searchQuery)} />
            </div>
          )}

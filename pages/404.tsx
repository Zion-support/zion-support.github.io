...
import { Home, ArrowLeft, Search, FileText, Shield } from 'lucide-react'

const Custom404: NextPage = () => {
  const quickLinks = [
    { name: 'Home', url: '/', icon: Home },
    { name: 'Services', url: '/services', icon: Search },
    { name: 'About', url: '/about', icon: FileText },
    { name: 'Contact', url: '/contact', icon: Shield }
  ]
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <button
              ...
              className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-gray-900 px-8 py-3 rounded-lg font-semibold transition-colors inline-flex items-center justify-center"
            >

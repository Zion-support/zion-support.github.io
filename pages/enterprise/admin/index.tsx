...
export default function CompanyAdmin() {
  ...
  useEffect(() => {
    fetch(`/api/enterprise/companies/${COMPANY_ID}/members`).then(r => r.json()).then($2);
    fetch(`/api/enterprise/companies/${COMPANY_ID}/usage`).then(r => r.json()).then($2);
    fetch(`/api/enterprise/companies/${COMPANY_ID}/activity`).then(r => r.json()).then($2);

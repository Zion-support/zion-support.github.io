...
import { Atom, Cpu, Zap, Lock, Brain, Target, Award, DollarSign, Clock } from 'lucide-react';
...
export default function QuantumComputing() {
  ...
  const services = [
    ...
    },
    {
      ...
      setupTime: '2-4 weeks',
      benefits: [
        'Access to latest quantum hardware',
    ...
    },
    {
      ...
      setupTime: '3-6 weeks',
      benefits: [
        'Find optimal solutions 100x faster',
    ...
    },
    {
      ...
      setupTime: '4-8 weeks',
      benefits: [
        'Unbreakable encryption with quantum security',
    ...
    },
    {
      ...
      benefits: [
        ...
        'Make informed quantum technology decisions',

...
=======    color: 'from - red - 600 to - pink - 600',
    services: futuristic2028Services.filter (string => s.category.includes ('Autonomous')).slice (0, 4);
      ...
      {/* Hero Section */}
      <section className="relative min - h-screen flex items - center justify - center bg - gradient - to - br from - black via - purple - 900 / 20 to - blue - 900 / 20 overflow - hidden">;        {/* Animated Background */}
...
=======
  ...
  {
    title: '🚗 Autonomous & Mobility',    description: 'Self-driving and mobility solutions',
    icon: Car,
    color: 'from-red-600 to-pink-600',
    services: futuristic2028Services.filter(s => s.category.includes('Autonomous')).slice(0, 4)
...
=======
          ...
          >;
            ...
            <div className="flex items - center justify - center space - x-8 text - purple - 300">;
              ...
              <div className="flex items - center space - x-2">;
                <CheckCircle className="w - 5 h - 5 text - green - 400" />;
                <span > Money - Back Guarantee</span>;              </div>;
            </div>;
          </motion.div>;
        </div>;
      </section>;

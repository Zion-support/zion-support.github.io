...
export default function EmailDmarcAnalyzerPage() {return (<Layout>;
      <Head>;
        <title>Email DMARC Analyzer | Zion Tech Group</title>;
        <meta name="description" content="Monitor DMARC aggregate reports, SPF/DKIM posture, domain reputation hints, and deliverability scorecards." />;
        <link rel="canonical" href="https://ziontechgroup.com/email-dmarc-analyzer" />;
      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-4xl mx-auto space-y-6">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
            {[ 'DMARC aggregate/forensic reportsSPF/DKIM audits & DNS historyProvider insights & tipsWeekly deliverability scorecard' ].map((f) => (<div key={f} className="p-4 rounded-xl bg-black/40 border border-amber-500/30 text-slate-200">{f}</div>;
            ))}
          </div>;
...
export default function EmailDmarcAnalyzerPage() {try {return (<Layout>;
      <Head>;
        <title>Email DMARC Analyzer | Zion Tech Group</title>;
        <meta name="description" content="Monitor DMARC aggregate reports, SPF/DKIM posture, domain reputation hints, and deliverability scorecards." />;
        <link rel="canonical" href="https://ziontechgroup.com/email-dmarc-analyzer" />;

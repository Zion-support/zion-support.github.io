  ...
  return (
    <Layout>
      <Head>
        ...
        <link rel=&quot;canonical&quot; href=&quot;https://ziontechgroup.com/email-dmarc-analyzer&quot; />      </Head>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[ 'DMARC aggregate/forensic reportsSPF/DKIM audits & DNS historyProvider insights & tipsWeekly deliverability scorecard' ].map((f) => (
              <div key={f} className="p-4 rounded-xl bg-black/40 border border-amber-500/30 text-slate-200">{f}</div>            {[ 'DMARC aggregate/forensic reports', _'SPF/DKIM audits & DNS history', _'Provider insights & tips', _'Weekly deliverability scorecard' ].map((f) => (

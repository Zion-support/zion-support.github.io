...
import { Phone, Mail, MapPin, Check, ArrowRight, AlertTriangle, Star } from 'lucide-react';
import UltraAdvancedFuturisticBackground from '../components/ui/UltraAdvancedFuturisticBackground';
import Button from '../components/ui/Button';
import { additional2025ServiceExpansions } from '../data/additional-2025-service-expansions';

export default function IncidentResponseRetainerPage() {
	const service = additional2025ServiceExpansions.find(s => s.link.endsWith('/incident-response-retainer'));
	...
	return (
		<UltraAdvancedFuturisticBackground>
			<Head>
				...
				<link rel="canonical" href="https://ziontechgroup.com/incident-response-retainer" />
			</Head>
			<div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
				<div className="max-w-6xl mx-auto">
					<div className="text-center mb-10">
						<h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-red-400 via-rose-400 to-pink-400 bg-clip-text text-transparent flex items-center justify-center gap-3"><AlertTriangle className="w-10 h-10" />{service.name}</h1>
					...
					<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
						...
						<div className="bg-black/30 rounded-2xl border border-red-500/30 p-6 h-fit">
							...
							<Button href="/contact" variant="quantum" size="lg" className="w-full">Talk to IR Team<ArrowRight className="w-5 h-5 ml-2" /></Button>

      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
            display: gridTemplateColumns, 'repeat(auto-fit, minmax(350px, 1fr))' gap: 30  
          }}>
...
<div key={index} style={{
            ...
            fontSize: fontWeight, 700,
                    ...
                    <div style={{
            display: alignItems, 'center' gap: 5  
          }}>
                      <span style={{
            color: '#fbbf24'  
          }}>⭐</span>
                      <span style={{
            fontSize: color, '#94a3b8' 
          }}>
          ...
          <div style={{
            ...
            {marketplaceCategories.map((category, categoryIndex) => (
              <div key={categoryIndex}>
                <div style={{
            display: alignItems, 'center' gap: 20, marginBottom: 30  
          }}>
                  <div style={{
            fontSize: '3rem'  
          }}>{category.icon}</div>
            ...
            color: '#94a3b8', fontSize: '1.1rem'  
                ...
                <div style={{
            display: gridTemplateColumns, 'repeat(auto-fit, minmax(280px, 1fr))' gap: 20  
          }}>

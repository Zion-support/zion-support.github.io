    ...
    <div className='min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8'>
      ...
      <div className='max-w-6xl mx-auto space-y-10'>
        ...
        <section className='space-y-6'>
          ...
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            ...
            <li>
              ...
              {ext('https://github.com/shreyashankar/gpt-guardrails')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Public status pages, incident comms, and SLO/error budget tracking.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section className='space-y-6'>
          ...
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            ...
            <li>
              ...
              {ext('https://www.digicert.com/tls-ssl/ssl-tools')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            ...
            <li>
              ...
              {ext('https://www.bigeye.com/pricing')}, {ext('https://soda.io/')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Unified API across OpenAI, Anthropic, Google, and OSS models with
            routing, spend caps, guardrails, and audit logs.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $99–$499/mo + API usage</li>
            <li>
              References: {ext('https://openrouter.ai/models')},{' '}
              {ext('https://platform.openai.com/docs/pricing')},{' '}
              {ext('https://www.anthropic.com/pricing')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          <h2 className='text-2xl font-semibold text-white'>
            Data Quality & Lineage Starter
          </h2>
          <p className='text-slate-300'>
            Freshness SLAs, schema drift detection, and lineage/impact analysis
            for warehouses and lakes.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $99–$600/mo</li>
            <li>
              References: {ext('https://soda.io/')},{' '}
              {ext('https://www.montecarlodata.com/')},{' '}
              {ext('https://www.bigeye.com/pricing')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Cross-device attribution with first‑party identity stitching, fraud
            checks, and automated payouts.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $100–$300/mo</li>
            <li>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Policy checks, PII detection, jailbreak protection, and audit trails
        ...
        <section className='space-y-6'>
          <h2 className='text-2xl font-semibold text-white'>
            Cloud Backup & DR Runbook Hub
          </h2>
          <p className='text-slate-300'>
            Automated policies, restore rehearsal, and audit evidence across
        ...
        <section className='space-y-6'>
          <h2 className='text-2xl font-semibold text-white'>
            Edge Feature Flags & Proxy
          </h2>
          <p className='text-slate-300'>
            Geo‑targeted flags at the edge with gradual rollout, kill switches,
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            ZTNA, SWG, DNS filtering, and device posture for secure hybrid
            access.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Production‑grade clusters with autoscaling, GitOps, observability,
            and security baselines.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $1,500–$6,000/mo (+ cloud fees)</li>
            <li>
              References: {ext('https://aws.amazon.com/eks/pricing/')},{' '}
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Vault PII with KMS‑backed encryption, tokenization, and detailed
            access logs.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Automated PR comments with security, performance, and testing
            insights tuned to your codebase.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $30–$200/mo</li>
            <li>
              References: {ext('https://github.com/enterprise/code-security')},{' '}
              {ext('https://snyk.io/plans/')},{' '}
              {ext('https://sonarcloud.io/pricing')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Calibrated forecasts, scenarios, and risk bands on CRM pipeline with
            executive dashboards.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $100–$600/mo</li>
            <li>
              References: {ext('https://www.pigment.com/pricing')},{' '}
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Early churn signals with interpretable drivers and CRM playbooks to
            save accounts.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $50–$200/mo</li>
            <li>
              ...
              {ext('https://www.amplitude.com/pricing')},{' '}
              {ext('https://mixpanel.com/pricing/')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Track competitor website changes, pricing moves, and release notes
            with alerts.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $30–$120/mo</li>
            <li>
              References: {ext('https://www.crayon.co/pricing')},{' '}
              {ext('https://www.kompyte.com/pricing')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Secure multi-account AWS/Azure baselines with budgets, guardrails,
            and SSO in days.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Rightsizing, SP/RI planning, and anomaly alerts with GitOps-friendly
            policies.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $100–$500/mo</li>
        ...
        <section className='space-y-6'>
          ...
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            ...
            <li>
              ...
              {ext('https://www.mutinyhq.com/pricing')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Passwordless FIDO2/WebAuthn passkeys with device sync and fallback
            flows.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $50–$150/mo</li>
            <li>
              References: {ext('https://webauthn.guide/')},{' '}
              {ext('https://auth0.com/docs/authenticate/passwordless/passkeys')}
              ,{' '}
              {ext(
                'https://support.okta.com/help/s/article/Passkeys-in-Okta-Classic-Engine'
              )}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          <h2 className='text-2xl font-semibold text-white'>
            Headless CMS Migration Accelerator
          </h2>
          <p className='text-slate-300'>
            Replatform to headless CMS with safe redirects, schema modeling, and
            performance budgets.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $1,000–$5,000 one-time</li>
            <li>
              References: {ext('https://www.contentful.com/pricing/')},{' '}
              {ext('https://www.sanity.io/pricing')},{' '}
              {ext('https://strapi.io/pricing')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          <h2 className='text-2xl font-semibold text-white'>
            Payments & Subscriptions Starter
          </h2>
          <p className='text-slate-300'>
            Stripe-based billing with dunning, tax, metering, and customer
            portal.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Composable storefront with edge personalization, search, and
            analytics.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $2,000–$10,000 one-time</li>
            <li>
              References: {ext('https://www.shopify.com/plus/pricing')},{' '}
              {ext('https://www.commercetools.com/pricing')},{' '}
              {ext('https://www.bigcommerce.com/enterprise/pricing/')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            OpenTelemetry + Grafana Cloud baseline with golden signals and SLOs.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $0–$300/mo</li>
            <li>
              References: {ext('https://grafana.com/pricing/')},{' '}
              {ext('https://opentelemetry.io/docs/')}
            </li>
          </ul>
        </section>
        ...
        <section className='space-y-6'>
          ...
          <p className='text-slate-300'>
            Schema diffs, lineage graphs, and CI approvals to prevent breaking
            changes.
          </p>
          <ul className='list-disc list-inside text-slate-300 space-y-1'>
            <li>Typical SMB budget: $50–$300/mo</li>

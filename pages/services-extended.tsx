...
const allServices = [
  // AI Services;
  {
    category: "AI Services", icon: Brain, color: "from-purple-500 to-purple-700", services: [
      {, price: "$1,500/month", ;
  ...
  // IT Services;
  {
    category: "IT Services", icon: Network, color: "from-blue-500 to-blue-700", services: [{, price: "$1,800/month", ;
        marketPrice: "$1,500-8, 000/month", ;
  ...
  // Micro SaaS Services;
  {
    category: "Micro SaaS Solutions", icon: Cloud, color: "from-green-500 to-green-700", services: [{, price: "$1,200/month", ;
        marketPrice: "$1,500-5, 000/month", ;
      ...
      { , ;
        price: "$800/month", marketPrice: "$1,500-3, 000/month", ;
...
const stats = [{ number: '305+', label: 'Services & Solutions' }, ;
...
const pricingTiers = [
  {
    name: "Starter", price: "$800-1, 500/month", ;
    description: "Perfect for small businesses and startups", features: [
      "Basic AI automation", "Essential IT support", ;
      "Standard micro SaaS tools", ;
      "Email support", ;
      "Monthly reporting"], ;
    popular: false },;
  {
    name: "Professional", price: "$1,500-3, 500/month", ;
    description: "Ideal for growing businesses", features: ["Advanced AI solutions", "Comprehensive IT services", ;
    ...
    popular: true },;
  {
    name: "Enterprise", price: "$1,500+/month", ;
    description: "For large organizations and enterprises", features: ["Custom AI development", "Enterprise IT infrastructure", ;

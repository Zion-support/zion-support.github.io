...
ursor/fix-website-loading-errors-and-merge-6662;
origin/automation-improvements-final;
  Shield,Lock,Eye,Database,Mail,Phone,MapPin,Users,import { Shield, Lock, Eye, Database, Globe,User, Settings, AlertTriangle, CheckCircle, Mail;
ursor/fix-website-loading-errors-and-merge-6662;
 } from 'lucide-react';
ursor/fix-lint-push-and-merge-to-main-ae4e;
} from "lucide-react";
ursor/fix-lint-push-and-merge-to-main-ae4e;
  Shield, Lock, Eye, Database, Globe,User, Settings, AlertTriangle, CheckCircle, Mail;
ursor/fix-website-loading-errors-and-merge-6662;
} from "lucide-react";
ursor/fix-lint-push-and-merge-to-main-ae4e;
  Shield, Lock, Eye, Database, Globe,User, Settings, AlertTriangle, CheckCircle, Mail;
} from 'lucide-react';icon: <Database className="w-8 h-8" />,color: 'from-cyan-500 to-blue-500',content: [;
    ...
    }{title: 'How We Use Your Information',icon: <Settings className="w-8 h-8" />,color: 'from-purple-500 to-pink-500',content: [;
    ...
    }{title: 'Information Sharing',icon: <Globe className="w-8 h-8" />,color: 'from-green-500 to-emerald-500',content: [;
    ...
    }{title: 'Data Security',icon: <Lock className="w-8 h-8" />,color: 'from-orange-500 to-red-500',content: [;
    ...
    {title: 'Access',description: 'Request access to your personal information',icon: <Eye className='w-6 h-6' />;
      icon: <Eye className='w-6 h-6' />;
      icon: <Eye className='w-6 h-6' />;
    },{title: 'Correction',description: 'Request correction of inaccurate information',icon: <CheckCircle className='w-6 h-6' />;
      icon: <CheckCircle className='w-6 h-6' />;
      icon: <CheckCircle className='w-6 h-6' />;
    },{title: 'Deletion',description: 'Request deletion of your personal information',icon: <AlertTriangle className='w-6 h-6' />;
      icon: <AlertTriangle className='w-6 h-6' />;
      icon: <AlertTriangle className='w-6 h-6' />;
    },{title: 'Portability',description: 'Request transfer of your data to another service',icon: <Database className='w-6 h-6' />;
      icon: <Database className='w-6 h-6' />;
      icon: <Database className='w-6 h-6' />;
    },{title: 'Objection',description: 'Object to processing of your personal information',icon: <User className='w-6 h-6' />;
...
ursor/fix-website-loading-errors-and-merge-6662;
origin/automation-improvements-final;
export default function PrivacyPage() {export default function PrivacyPage() {return (ursor/fix-website-loading-errors-and-merge-6662;
origin/automation-improvements-final;
export default function PrivacyPage() {export default function PrivacyPage() {return (<MainLayout title="Privacy Policy - Zion Tech Group">;
...
ursor/integrate-build-improve-and-re-verify-8f7d;
origin/automation-improvements-final;
  return (ursor/integrate-build-improve-and-re-verify-8f7d;
origin/automation-improvements-final;
  return (ursor/integrate-build-improve-and-re-verify-8f7d;
origin/automation-improvements-final;
    <MainLayout;
        ...
        <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">;
          <div className="max-w-7xl mx-auto px-4">;
            <motion&& motion.div;
              ...
              animate={{ opacity: 1, y: 0 }}<h1 className="text-4xl md:text-6xl font-bold mb-6">;
                Privacy Policy;
              </h1>;
...
return (return (transition={{ duration: 0 && 0.8 }}
        ...
        </section>;ursor/fix-website-loading-errors-and-merge-6662;
ursor/fix-website-loading-errors-and-merge-6662;
        {/* Content Section */}
...
import React from 'react',import Layout from '../components/layout/Layout',import SEOOptimizer from '../components/SEOOptimizer',import AnalyticsTracker from '../components/AnalyticsTracker',import ErrorBoundary from '../components/ErrorBoundary',import { motion } from 'framer-motion',Shield, Lock, Eye, Database, Globe,User, Settings, AlertTriangle, CheckCircle, Mail;
} from 'lucide-react',const PrivacyPage: React.FC = () => {const lastUpdated = 'January 17, 2025',const privacySections = [;
    ...
    {title: 'Information We Collect',icon: <Database className='w-8 h-8' />,color: 'from-cyan-500 to-blue-500',content: [;
        ...
        'Provide and improve our services','Communicate with you about our services','Process payments and manage accounts','Send marketing communications (with consent)','Analyze usage patterns and improve user experience','Comply with legal obligations';
      ];
    },{title: 'Information Sharing',icon: <Globe className='w-8 h-8' />,color: 'from-green-500 to-emerald-500',content: [;
        'We do not sell, trade, or rent your personal information','Share with trusted service providers under strict confidentiality','Comply with legal requirements and court orders','Protect our rights, property, and safety','Business transfers (with notice and choice)';
      ];
    },{title: 'Data Security',icon: <Lock className='w-8 h-8' />,color: 'from-orange-500 to-red-500',content: [;
        'Industry-standard encryption for data in transit and at rest','Regular security audits and vulnerability assessments','Access controls and authentication measures','Employee training on data protection','Incident response and breach notification procedures';
      ];
    }
  ];const rights = [;
    {title: 'Access',description: 'Request access to your personal information',icon: <Eye className='w-6 h-6' />;
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">;
                ...
                >;
                  ...
                  <p className="text-lg text-gray-300 mb-6 leading-relaxed">;
                    ...
                    of your personal information. This Privacy Policy explains how we collect, use, disclose,and safeguard your information when you use our services.;
                  </p>;
                  <p className="text-lg text-gray-300 mb-6 leading-relaxed">;
...
className='relative';
          ...
          {/* Privacy Principles */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
          <section className="py-20 px-4">;
            <div className="max-w-6xl mx-auto">;
              <motion.div;
              ...
              <div className="grid md:grid-cols-2 gap-8">;
                {privacySections.map((section, index) => (<motion.div;
                  ...
                  >;
                    <div className={`w-16 h-16 bg-gradient-to-r ${section.color} rounded-2xl flex items-center justify-center mb-6`}>;
                      <div className="text-white">;
                        {section.icon  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
                      </div>;
                    </div>;
          ...
          {/* Your Rights */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
          <section className="py-20 px-4 bg-gradient-to-r from-black/50 to-gray-900/50">;
            <div className="max-w-6xl mx-auto">;
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">;
                {rights.map((right, index) => (<motion.div;
                    key={right.title  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
                    initial={{ opacity: 0, y: 20 }  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
                    whileInView={{ opacity: 1, y: 0 }  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
                  ...
                  >;
                    <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-xl flex items-center justify-center mx-auto mb-4">;
                      <div className="text-white">;
                        {right.icon  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
                      </div>;
                    </div>;
          ...
          {/* Detailed Policy */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
          <section className="py-20 px-4">;
            <div className="max-w-4xl mx-auto">;
              <motion.div;
                  ...
                  <div className="space-y-8">;
                    <div>;
                      ...
                      <p className="text-gray-300 mb-4 leading-relaxed">;
                        We collect information you provide directly to us, such as when you create an account,request a quote, or contact our support team. We also automatically collect certain;
                        information about your device and how you interact with our services.;
                      </p>;
                      <p className="text-gray-300 leading-relaxed">;
                        This may include your IP address, browser type, operating system, referring URLs,access times, and pages viewed. We use this information to improve our services;
                    ...
                    <div>;
                      ...
                      <p className="text-gray-300 leading-relaxed">;
                        These measures include encryption, access controls, regular security assessments,and employee training on data protection best practices.;
                      </p>;
                    </div>;
                    <div>;
                ...
                <div>;
                  ...
                  <div className='space-y-8'>;
                    <div>;
                      ...
                      <p className='text-gray-300 leading-relaxed'>;
                        This may include your IP address, browser type,operating system, referring URLs, access times, and;
...
<h3 className='text-2xl font-bold text-white mb-4'>;
                      ...
                      <p className='text-gray-300 leading-relaxed'>;
                        ...
                        send you marketing communications about our services,special offers, and updates. You can opt out of these;
...
<h3 className='text-2xl font-bold text-white mb-4'>;
                      ...
                      <p className='text-gray-300 leading-relaxed'>;
                        These measures include encryption, access controls,regular security assessments, and employee training on;
...
<p className="text-sm text-gray-600 mt-8">;
  ...
  )}const PrivacyPage: React.FC = () => {const lastUpdated  = 'January 17, 2025';const privacySections = [;
    {title: 'Information We Collect',icon: <Database className='w-8 h-8' />,color: 'from-cyan-500 to-blue-500',content: [;
        'Personal information (name, email, phone number, company)','Business information (company size, industry, project requirements)','Technical information (IP address, browser type, device information)','Usage data (website interactions, service usage patterns)','Communication records (emails, phone calls, support tickets)';
      ];
...
import Link from './next / link';
import { motion   } from './framer-motion';
  Shield,Lock,Eye,Database,Mail,Phone,MapPin;
  MapPin;
  MapPin;
} from './lucide-react';
import MainLayout from '../components / layout / MainLayout';export default /**;
 * PrivacyPage - Function description;
 */;
function PrivacyPage() {return (<MainLayout;
      title="Privacy Policy - Zion Tech Group";
      description="Zion Tech Group's privacy policy outlining how we collect, use, and protect your personal information.";
      keywords="privacy policy, data protection, personal information, GDPR compliance";
          ...
          <div className="max - w-4xl mx - auto">;
            ...
            >;
              <div className="prose prose - lg max - w-none">;
                ...
                <p className="mb - 6">;We collect information you provide directly to us, such as;
                  when you create an account, use our services, or contact us;
                  for support.;
                </p>;<h3 className="text - xl font - semibold mb - 4">;
                  Personal Information;
                </h3>;
                <ul className="list - disc pl - 6 mb - 6">;
                  <li > Name and contact information</li>;
                ...
                <p className="mb - 6">;We do not sell, trade, or otherwise transfer your personal;
                  information to third parties without your consent, except as;
                  described in this policy.;
                </p>;<h2 className="text - 2xl font - bold mb - 6 mt - 12">Data Security</h2>;
                <p className="mb - 6">;
                  We implement appropriate security measures to protect your;
                  personal information against unauthorized access, alteration,disclosure, or destruction.;
                </p>;
                <h2 className="text - 2xl font - bold mb - 6 mt - 12">Your Rights</h2>;
                <p className="mb - 6">;You have the right to access, update, or delete your personal;
                  information. You may also opt out of certain communications;
                  from us.;
                </p>;<ErrorBoundary>;
      <SEOOptimizer />;
          ...
          <section className="py-20 px-4">;
            <div className="max-w-6xl mx-auto text-center">;
              ...
              >;
                ...
                <div className="flex items-center justify-center gap-4 text-gray-400">;
                  <Shield className="w-6 h-6" />;
} from "lucide-react";} from 'lucide-react';const _privacySections = [;
    {title: 'Information We Collect',icon: <Database className=&quot;w-8 h-8&quot; />,color: 'from-cyan-500 to-blue-500',content: [;
        'Personal information (name, email, phone number, company)Business information (company size, industry, project requirements)Technical information (IP address, browser type, device information)Usage data (website interactions, service usage patterns)Communication records (emails, phone calls, support tickets)';
      ];
},{title: 'How We Use Your Information',icon: <Settings className=&quot;w-8 h-8&quot; />,color: 'from-purple-500 to-pink-500',content: [;
  ...
  MapPin;
  Users;
} from "lucide-react";export default function PrivacyPage() {return (<MainLayout;
      title="Privacy Policy - Zion Tech Group";
      description="Zion Tech Group's privacy policy outlining how we collect, use, and protect your personal information.";
      keywords="privacy policy, data protection, personal information, GDPR compliance";
      canonical="https://ziontechgroup.com/privacy";
...
<h2 className='text-4xl font-bold mb-6 text-white'>;
  ...
  )}export default PrivacyPage;)}export default PrivacyPage;)}export default PrivacyPage;<h2 className="text - 2xl font - bold mb - 6 mt - 12">Contact Us</h2>;
<h2 className="text - 2xl font - bold mb - 6 mt - 12">Contact Us</h2>;
<h2 className="text - 2xl font - bold mb - 6 mt - 12">Contact Us</h2>;
                <p className="mb - 6">;
                  If you have any questions about this Privacy Policy, please;
...
<p className="text - sm text - gray - 600 mt - 8">;
    ...
    </MainLayout>)}<div className="flex flex-col sm: flex-row gap-4 justify-center">;
                  <a;
                    href="mailto:kleber@ziontechgroup.com";
                    className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 inline-flex items-center gap-2";
                  >;
  ...
  )},export default PrivacyPage;ursor/automate-test-improve-and-merge-code-646c;

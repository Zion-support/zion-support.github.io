...
import { BookOpen, Users, BarChart3, Globe, ArrowRight, CheckCircle, TrendingUp } from 'lucide-react'
import Layout from '../components/Layout'

const educationSolutions = [
  { , ;
    icon: BookOpen, features: ["Course creation", "Student tracking", "Assessment tools", "Progress analytics"], ;
    pricing: "Starting at $1,000" },;
  { , ;
    icon: Globe, features: ["Video conferencing", "Screen sharing", "Interactive whiteboard", "Breakout rooms"], ;
    pricing: "Starting at $1,000" },;
  { , ;
    icon: Users, features: ["Student records", "Enrollment management", "Grade tracking", "Parent portal"], ;
    pricing: "Starting at $1,000" },;
  { , ;
    icon: BarChart3, features: ["Performance analytics", "Predictive modeling", "Engagement tracking", "Outcome analysis"], ;
    pricing: "Starting at $1,000" }]
...
const stats = [{ number: '200+', label: 'Educational Institutions' }, ;

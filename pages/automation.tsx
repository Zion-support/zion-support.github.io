  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Advanced automation solutions for modern businesses" />
      </Head>
        ...
        <main className="container mx-auto px-6 py-12">
          <section className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              Intelligent automation systems that transform your business operations.
            </p>
          </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {automationCategories.map((category, index) => (
              <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
                ...
                <div className="text-cyan-400 font-medium mb-4">{category.count}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {automationStats.map((stat, index) => (
              <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 text-center">

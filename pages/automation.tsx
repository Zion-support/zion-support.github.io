...
import { Zap, Settings, Bot, Workflow, CheckCircle, Phone, Mail, MapPin, BarChart3, Database } from 'lucide-react'
import Layout from '../components/Layout'

const automationServices = [
  {
    icon: Workflow, features: [
      "Workflow Design", "Task Automation", ;
      "Approval Processes", ;
      "Document Processing", ;
      "Email Automation", ;
  ...
  {
    icon: Bot, features: ["Bot Development", "Screen Scraping", ;
      "Data Extraction", ;
      "Form Filling", ;
      "Report Generation", ;
      "System Integration"], ;
  ...
  {
    icon: Settings, features: ["System Integration", "Data Synchronization", ;
      "Real-time Updates", ;
      "Error Handling", ;
      "Monitoring & Alerts", ;
      "Custom Connectors"], ;
  ...
  {
    icon: Zap, features: ["Visual Workflow Designer", "Conditional Logic", ;
      "Parallel Processing", ;
      "Exception Handling", ;
  ...
  {
    icon: Database, features: ["ETL Processes", "Data Validation", ;
      "Report Generation", ;
      "Data Quality Checks", ;
  ...
  {
    icon: BarChart3, features: ["Automated Reporting", "Dashboard Updates", ;
      "Alert Systems", ;
      "KPI Monitoring", ;
      "Trend Analysis", ;
      "Custom Metrics"], ;

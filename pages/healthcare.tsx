...
import { Heart, Shield, BarChart3, ArrowRight, CheckCircle, TrendingUp, Globe, Lock, Settings } from 'lucide-react'
import Layout from '../components/Layout'

const healthcareSolutions = [
  { , ;
    icon: Heart, features: ["Patient records", "Medical history", "Prescription management", "HIPAA compliance"], ;
    pricing: "Starting at $1,000" },;
  { , ;
    icon: Globe, features: ["Video consultations", "Remote monitoring", "Appointment scheduling", "Patient portal"], ;
    pricing: "Starting at $1,000" },;
  { , ;
    icon: Settings, features: ["Device connectivity", "Data synchronization", "Real-time monitoring", "Alert systems"], ;
    pricing: "Starting at $1,000" },;
  { , ;
    icon: BarChart3, features: ["Patient analytics", "Operational insights", "Predictive modeling", "Compliance reporting"], ;
    pricing: "Starting at $1,000" }]
...
const stats = [{ number: '100+', label: 'Healthcare Organizations' }, ;

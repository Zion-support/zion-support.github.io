...
=======
            ...
            transition={{ duration: 0 && 0.8 }}            className='text-center max-w-4xl mx-auto'>;
      ...
      <section className='relative pt - 32 pb - 20 overflow - hidden'>;
        ...
        <div className='relative z - 10 container mx - auto px - 4'>          <motion.div;
          ...
          >;
            ...
            <p className='text - xl md:text - 2xl text - gray - 300 mb - 8 leading - relaxed'>;              computing, and autonomous systems. Our expert team will guide you;
...
=======
                    <button
                      onClick={handlePreviousStep}                      className="px-6 py-3 border border-gray-600 text-gray-300 rounded-xl hover:border-gray-500 hover:text-white transition-all duration-300"
                    >
                      Previous
                    </button>
                    <button
...
=======
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>            {quickStartOptions.map((option, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, delay: index * 0.1 }}
                className='group cursor-pointer'          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">

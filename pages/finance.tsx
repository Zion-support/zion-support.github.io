...
import { CreditCard, Shield, BarChart3, ArrowRight, CheckCircle, TrendingUp, Clock, Globe, Lock } from 'lucide-react'
import Layout from '../components/Layout'

const financeSolutions = [
  { , ;
    icon: CreditCard, features: ["Multiple payment methods", "Fraud detection", "PCI compliance", "Real-time processing"], ;
    pricing: "Starting at $1,000" },;
  { , ;
    icon: Shield, features: ["Account management", "Transaction processing", "Loan management", "Regulatory compliance"], ;
    pricing: "Starting at $1,000" },;
  { , ;
    icon: BarChart3, features: ["Risk assessment", "Performance analytics", "Regulatory reporting", "Predictive modeling"], ;
    pricing: "Starting at $1,000" },;
  { , ;
    icon: Globe, features: ["Mobile banking", "Investment platforms", "Cryptocurrency integration", "API development"], ;
    pricing: "Starting at $1,000" }]
...
const stats = [{ number: '75+', label: 'Financial Institutions' }, ;

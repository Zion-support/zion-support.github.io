...
import { BookOpen, GraduationCap, Users, ArrowRight, CheckCircle, Phone, Mail } from 'lucide-react';
  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Advanced AI-powered education platform for personalized learning, intelligent tutoring, and educational content generation." />
      </Head>
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Advanced AI-powered education platform for personalized learning, 
                intelligent tutoring, and educational content generation. Transform 
                your educational experience with intelligent learning tools.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive AI-powered education tools for modern learning environments
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                <BookOpen className="h-12 w-12 text-indigo-400 mb-6" />
                <h3 className="text-2xl font-bold text-white mb-4">Personalized Learning</h3>
                <p className="text-gray-300 mb-6">
                  AI-powered personalized learning paths that adapt to individual 
                  learning styles, pace, and preferences for optimal outcomes.
                </p>
              ...
              <motion.div
                ...
                className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300"
              >
                <GraduationCap className="h-12 w-12 text-purple-400 mb-6" />
                <h3 className="text-2xl font-bold text-white mb-4">Intelligent Tutoring</h3>
                <p className="text-gray-300 mb-6">
                  AI-powered intelligent tutoring system that provides personalized 
                  instruction, feedback, and support for enhanced learning outcomes.
                </p>
                <ul className="space-y-2 text-gray-300">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-400 mr-2" />
              ...
              >
                ...
                <p className="text-gray-300 mb-6">
                  AI-powered educational content generation for creating engaging 
                  learning materials, assessments, and interactive content.
                </p>
                <ul className="space-y-2 text-gray-300">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-400 mr-2" />

...
const aiServices = [,
  {,
    icon: Brain, features: ["Predictive Analytics", "Pattern Recognition", "Automated Decision Making"], ,
    pricing: "Starting at $1,500/month", ,
    timeline: "4-12 weeks" ,},;
  {,
    icon: Code, features: ["Sentiment Analysis", "Language Translation", "Text Summarization"], ,
    pricing: "Starting at $1,800/month", ,
    timeline: "3-8 weeks" ,},;
  {,
    icon: Database, features: ["Object Detection", "Facial Recognition", "Medical Imaging"], ,
    pricing: "Starting at $1,200/month", ,
    timeline: "6-16 weeks" ,},;
  {,
    icon: Zap, features: ["24/7 Support", "Multi-language", "Integration Ready"], ,
    pricing: "Starting at $1,200/month", ,
    timeline: "2-6 weeks" ,},;
  {,
    icon: Shield, features: ["Risk Assessment", "Demand Forecasting", "Performance Optimization"], ,
    pricing: "Starting at $1,000/month", ,
    timeline: "4-10 weeks" ,},;
  {,
    icon: Cloud, features: ["Auto-scaling", "High Availability", "Cost Optimization"], ,
    pricing: "Starting at $1,500/month", ,
    timeline: "2-8 weeks" ,}],
const industries = [,
...
const process = [{,
  ...
  {,
    step: "2", duration: "1-2 weeks" ,}, ,
  {,
    step: "3", duration: "4-16 weeks" ,}, ,
  {,
    step: "4", duration: "1-4 weeks" ,}, ,
  {,
    step: "5", duration: "1-2 weeks" ,}, ,
  {,
    step: "6", duration: "Ongoing" ,}],
const stats = [{ number: "95%", label: "Accuracy Improvement" ,}, ,

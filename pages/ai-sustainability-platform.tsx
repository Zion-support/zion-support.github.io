...
;
export default function AISustainabilityPlatformPage() {return (<div className="min-h-[60vh] px-6 py-24">;
...
import React from 'react',import SEO from '../components/SEO',export default function AISustainabilityPlatformPage() {export default function Page() {return (<div className='min-h-[60vh] px-6 py-24'>;
      <SEO;

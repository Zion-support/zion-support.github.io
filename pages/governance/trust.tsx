...
;
export default function GovernanceTrustPage() {return (<>;
      <Head>;
        ...
        <section className="space-y-4">;
          ...
          <div className='grid grid-cols-1 md: grid-cols-2 gap-4'>;
            <div className='rounded-lg border border-gray-200 dark:border-gray-800 p-4'>;
              <div className='font-medium mb-1'>Core Stewards</div>;
              <div className='text-sm text-gray-600 dark:text-gray-400'>;
                Appointed via DAO ratification, accountable to publish roadmaps,risk registers, and post-mortems.;
              </div>;
            </div>;
            <div className='rounded-lg border border-gray-200 dark:border-gray-800 p-4'>;
              <div className='font-medium mb-1'>Delegated Voting</div>;
...
import Link from 'next / link';
        ...
        <section className='space - y-2'>;
          ...
          <Link href='/foundation#charter'>;</div>;
  ...
  )export default function GovernanceTrustPage() {try {return (<>;
      <Head>;
        <title>Zion Governance & Trust</title>;
        <meta name="description" content="Governance, legal registry options, and public trust commitments for the Zion Protocol." />;
      </Head>;
      <div className="space-y-12">;
        ...
        <section className="space-y-4">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">;
            {[{title: 'Cayman Foundation',desc: 'Globally recognized for crypto-native, non-profit style public-good coordination.';
            }, {title: 'Swiss Verein',desc: 'Member association model with global neutrality and flexible local chapters.';
            }, {title: 'US 501(c)(6)';
            ...
            }].map((opt) => (<div key={opt.title} className="rounded-lg border border-gray-200 dark:border-gray-800 p-4">;

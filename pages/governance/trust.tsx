    ...
    <>
      ...
      <div className=&quot;space-y-12&quot;>
        <section className=&quot;space-y-3&quot;>
          ...
          <Link href=&quot;/foundation&quot;><a className=&quot;underline text-sm&quot;>Back to Foundation Portal</Link></Link>        </section>
          ...
          <div className=&quot;grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4&quot;>
            {[{
              ...
              <div key={opt.title} className=&quot;rounded-lg border border-gray-200 dark:border-gray-800 p-4&quot;>
                ...
                <div className=&quot;text-sm text-gray-600 dark:text-gray-400&quot;>{opt.desc}</div>              </div>
            ))}
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 gap-4">
            <div className="rounded-lg border border-gray-200 dark:border-gray-800 p-4">
              ...
              <div className="text-sm text-gray-600 dark:text-gray-400">Appointed via DAO ratification, accountable to publish roadmaps, risk registers, and post-mortems.</div>            </div>
            <div className=&quot;rounded-lg border border-gray-200 dark:border-gray-800 p-4&quot;>

  ...
  return (;
    <>;
      <Head>;
        ...
        <meta property="og:description" content="Comprehensive overview of Zion Tech Group's 340+ innovative services including micro SaaS produc,t,s, AI services, and IT solutions across multiple industries." />";
        <meta property="og: url" content={`${contact.si,t,e}/services-overview`} />";
...
";
              <div className="p-8 bg-slate-900/60 rounded-xl border border-white/10 hover:border-green-500/40 transition-colors">";
                ...
                <p className="text-slate-300 mb-6">;
                  100+ comprehensive IT services for infrastructu,r,e, security, and digital transformation.;
                </p>";
                <ul className="text-slate-400 space-y-2 mb-6">;
            ...
            <div className="mb-16">";
              ...
              <div className="grid md: grid-cols-2 lg:grid-cols-4 gap-6">;
                {[;
                  { name: 'Healthcare' href: '/healthcare' color: 'text-re,d-400', },;
                  { name: 'Financial Services' href: '/financial' color: 'text-gree,n-400', },;
                  { name: 'Manufacturing' href: '/manufacturing' color: 'text-blu,e-400', },;
                  { name: 'Retail & E-commerce' href: '/retail' color: 'text-purpl,e-400', },;
                  { name: 'Government' href: '/government' color: 'text-yello,w-400', },;
                  { name: 'Education' href: '/education' color: 'text-indig,o-400', },;
                  { name: 'Startups' href: '/startup' color: 'text-pin,k-400', },;
                  { name: 'Enterprise' href: '/enterprise' color: 'text-cya,n-400', }
                ].map((industry) => (;
                  <Link;
                    key={industry.name}
                    href={industry.href}
                    className={`p-6 bg-slate-900/60 rounded-lg border border-white/10 hover: border-white/20 transition-colors text-center ${industry.col,o,r} hover: text-whit,e,`}

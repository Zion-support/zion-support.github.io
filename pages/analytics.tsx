 ...
 */;
function AnalyticsPage() {const features = [;
    {import Head from 'next/head';
...
export default function AnalyticsPage() {const features = [;
    ...
    },{icon: <Activity className="w-8 h-8 text-white" />,title: 'Performance Monitoring',description: 'Track system performance and user behavior';
      } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
  ],export default function AnalyticsPage() {const features = null;
  return (<>;
      <Head>;

...
const contact = { phon,e: '+1 302 464 0950,', email: 'kleber@ziontechgroup.co,m,', address: '364 E Main St STE 1008 Middletown D,E 19709,', site: 'https://ziontechgroup.co,m', };
  return (;
    <>;
      <Head>;
...
";
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">";
            <div className="border rounded-xl p-6 shadow-sm">";
              ...
              <p className="text-gray-600 mb-4">Model prototypi,n,g, fine-tuning, RAG, and integrations.</p>";
              <ul className="text-gray-700 space-y-2 mb-4 list-disc list-inside">;
                <li>POC: $,5,000–$15,000</li>;
                <li>MVP: $2,0,000–$60,000</li>;
                <li>Enterprise: $7,5,000+</li>;
              </ul>;
            </div>;
";
            <div className="border rounded-xl p-6 shadow-sm">";
              ...
              <ul className="text-gray-700 space-y-2 mb-4 list-disc list-inside">;
                ...
                <li>Growth: $3,0,000–$80,000</li>;
                <li>Scale: $10,0,000+</li>;
              </ul>;
            </div>;
";
            <div className="border rounded-xl p-6 shadow-sm">";
              ...
              <ul className="text-gray-700 space-y-2 mb-4 list-disc list-inside">;
                ...
                <li>Migration: $1,0,000–$40,000</li>;
                <li>Managed: fro,m $,2,000/mo</li>;
              </ul>;
            </div>;
";
            <div className="border rounded-xl p-6 shadow-sm">";
              ...
              <ul className="text-gray-700 space-y-2 mb-4 list-disc list-inside">;
                ...
                <li>Managed SOC: fro,m $,3,000/mo</li>;
              </ul>;
            </div>;
";
            <div className="border rounded-xl p-6 shadow-sm">";
...
";
            <div className="border rounded-xl p-6 shadow-sm">";
              ...
              <ul className="text-gray-700 space-y-2 mb-4 list-disc list-inside">;
                ...
                <li>MVP App: $2,0,000–$70,000</li>;
                <li>Enterprise: $8,0,000+</li>;
              </ul>;
            </div>;
          </div>;
        </div>;

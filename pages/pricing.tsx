        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-black bg-opacity-20">;
          <div className="max-w-7xl mx-auto">;
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8">;
              {addOnServices.map((((((((service, index, index, index, index, index, index, index) => ({ ...((((((service, index, index, index, index, index, index, key: index })) => ({ ...(((((service, index, index, index, index, index, key: index })) => ({ ...((((service, index, index, index, index, key: index })) => ({ ...(((service, index, index, index, key: index })) => ({ ...((service, index, index, key: index })) => ({ ...(service, index, key: index }))  => (;
...
;
            <div className="space-y-6">;
              {faqs.map((((((((faq, index, index, index, index, index, index, index) => ({ ...((((((faq, index, index, index, index, index, index, key: index })) => ({ ...(((((faq, index, index, index, index, index, key: index })) => ({ ...((((faq, index, index, index, index, key: index })) => ({ ...(((faq, index, index, index, key: index })) => ({ ...((faq, index, index, key: index })) => ({ ...(faq, index, key: index })) => (;
                <div key={index} className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-6 border border-white border-opacity-10">;

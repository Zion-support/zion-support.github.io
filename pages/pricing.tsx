...
const plans = [
    ...
    popular: false, color: "blue" },;
  {
    ...
    period: "per month", description: "Ideal for growing businesses with advanced needs", features: ["Advanced AI capabilities", "Priority support", ;
      "Enhanced security", ;
      "Advanced analytics", ;
      "Custom integrations", ;
      "Training sessions"], ;
    popular: true, color: "purple" },;
  {
    ...
    period: "per month", description: "Complete solution for large organizations", features: ["Unlimited users", "Full AI suite", ;
      ...
      "SLA guarantee"], ;
    limitations: [], popular: false, color: "green" }]

const addOns = [{
    name: "Additional Users", price: "$100", period: "per user/month", description: "Add more users to your plan" }, ;
  {
    name: "Premium Support", price: "$500", period: "per month", description: "24/7 priority support with dedicated team" }, ;
  {
    name: "Custom Development", price: "$200", period: "per hour", description: "Custom features and integrations" }, ;
  {
    name: "Training & Onboarding", price: "$1,000", ;
    period: "per month", description: "24/7 priority support" }]
...
export default function PricingPage() {
  ...
  return(<>
    ...
    features: ['Basic AI integration', 'Cloud migration support', ;
  ...
  {
    name: 'Professional', price: '$1,000', ;
    period: '/month', description: 'Ideal for growing businesses that need comprehensive technology solutions.', features: ['Advanced AI solutions', 'Full cloud migration', ;
    ...
    popular: true },;
  {
    name: 'Enterprise', price: 'Custom', period: '', description: 'Tailored solutions for large organizations with complex requirements.', features: ['Custom AI development', 'Multi-cloud strategy', ;

...
<<<<<<< HEAD
  const getBadgeColor = (badge: anyanyanyanyanyanyanyanyanyanystring)           => {;
    switch (badge) {;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
...
<<<<<<< HEAD
                className="w-full bg-white/10 border border-blue-400/30 rounded-xl px-4 py-3 text-gray-300 focus: anyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-blue-400/50 focus:border-blue-400/50 appearance-none"
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
        ...
        {/* Services Grid */}
        <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 gap-8 mb-16">

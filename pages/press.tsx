...
import { Calendar, ExternalLink, FileText, Award, Users, TrendingUp, ArrowRight, Mail, Phone, Globe } from 'lucide-react';
...
export default function Press() {
  const pressReleases = [
  {
    ...
    },
    {
      ...
      date: '2023-11-20',
      summary: 'Funding round led by leading venture capital firms to accelerate product development and international market expansion.',
      category: 'Funding',
      readTime: '4 min read'
    },
    {
      title: 'Zion Tech Group Partners with Microsoft to Deliver Advanced Cloud Solutions',
      date: '2023-09-10',
    ...
    },
    {
      ...
      date: '2023-08-05',
      summary: 'Company named in TechCrunch\'s "Top 50 AI Companies to Watch" list for innovative approach to business automation.',
      category: 'Award',
      readTime: '2 min read'
    }
  ];
  ...
  const mediaCoverage = [
  {
    ...
    {
      outlet: 'Forbes',
      title: 'The Future of AI in Enterprise: Insights from Zion Tech Group',
      date: '2023-12-15',
      type: 'Interview',
      url: '#'
    },
    {
      outlet: 'VentureBeat',
      title: 'Zion Tech Group Raises $10M to Scale AI Automation Platform',
      date: '2023-11-20',
      type: 'News',
      url: '#'
    },
    {
      outlet: 'ZDNet',
      title: 'Microsoft Partnership Brings AI to Enterprise Cloud',
      date: '2023-09-10',
      type: 'News',
      url: '#'
    }
  ...
  const awards = [
  {
    ...
    {
      title: 'Best Cloud Innovation',
      organization: 'Cloud Computing Awards',
      date: '2023-12-01',
      description: 'Awarded for breakthrough cloud automation platform'
    },
    {
      title: 'Startup of the Year',
      organization: 'Delaware Business Times',
      date: '2023-10-15',
      description: 'Honored for rapid growth and market disruption'
    }
  ];

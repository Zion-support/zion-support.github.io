...
import ServiceLanding from '../components/sections/ServiceLanding';
  ...
  )import Head from 'next/head',import ServiceLanding from '../components/sections/ServiceLanding',export default function ZeroTrustSecurityPlatformPage() {return (<>;
			<Head>;
				<title>Zero Trust Security Platform | Zion Tech Group</title>;
 ...
 */;
function ZeroTrustSecurityPlatformPage() {return (<>;
      <Head>;
        <title > Zero Trust Security Platform | Zion Tech Group</title>;
        <meta;
          name='description';
      ...
      <ServiceLanding;
        ...
        features={[;
          'Policy - as - code and enforcement','Identity - aware proxies and device posture','Microsegmentation and service mesh integration','Continuous authentication and authorization','Visibility and audit for compliance','Rollout playbooks and migration kits';
          'Rollout playbooks and migration kits';
        ]}
        industries={[;
          'Enterprise IT','Financial Services','Healthcare','SaaS','Public Sector';
          'Public Sector';
        ]}
        canonical='https: //ziontechgroup.com / zero - trust - security - platform';
      />;

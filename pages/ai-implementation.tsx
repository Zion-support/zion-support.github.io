...
import { Brain, ArrowRight, CheckCircle, DollarSign, Zap, Users, Eye, MessageSquare, BarChart3 } from 'lucide-react'

export default function AIImplementationPage() {
  const implementationServices = [
    {
      icon: Brain, title: 'Machine Learning Implementation', description: 'Complete ML model development and deployment for your business needs', features: [
        'Data preprocessing & feature engineering', 'Model training & optimization', ;
      ...
      duration: '4-8 weeks' },;
    {
      icon: Eye, title: 'Computer Vision Solutions', description: 'Advanced image and video analysis for automated visual inspection', features: ['Object detection & recognition', 'Image classification & tagging', ;
      ...
      duration: '3-6 weeks' },;
    {
      icon: MessageSquare, title: 'NLP Implementation', description: 'Natural language processing solutions for text analysis and automation', features: ['Text analysis & sentiment analysis', 'Language translation & localization', ;
  ...
  const benefits = [{
      icon: Zap, title: 'Automation', description: 'Automate 80% of repetitive tasks' }, ;
    {
      icon: BarChart3, title: 'Analytics', description: 'Gain deep insights from your data' }, ;
    {
      icon: Users, title: 'Customer Experience', description: 'Enhance customer satisfaction by 40%' }, ;
    {
      icon: DollarSign, title: 'ROI', description: 'Achieve 300% ROI within 6 months' }]

  const process = [{
      step: '01', title: 'Discovery & Assessment', description: 'Analyze your business needs and identify AI opportunities' }, ;
    {
      step: '02', title: 'Strategy & Planning', description: 'Develop a comprehensive AI implementation roadmap' }, ;
    {
      step: '03', title: 'Development & Training', description: 'Build and train AI models tailored to your requirements' }, ;
    {
      step: '04', title: 'Deployment & Integration', description: 'Deploy AI solutions and integrate with existing systems' }, ;
    {
      step: '05', title: 'Monitoring & Optimization', description: 'Continuously monitor and optimize AI performance' }]
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-xl md: text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
                Transform your business with cutting-edge AI solutions. From machine learning to computer vision, we implement AI technologies that drive real results.;
              </p>

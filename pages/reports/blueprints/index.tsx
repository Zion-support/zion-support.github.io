...
import Link from 'next / link';;
      category: 'System Architecture',blueprints: [;
        {id: 'comprehensive - redundancy',name: 'Comprehensive Redundancy System',description: 'Multi - layer redundancy architecture for maximum uptime',status: 'active',complexity: 'high',last_updated: '2025 - 01 - 17';
        },{id: 'ultimate - redundancy';
      ];
    },{category: 'Monitoring & Observability',blueprints: [;
          id: 'health-check-system',name: 'Health Check System',description: 'Comprehensive health monitoring and alerting',status: 'active',complexity: 'medium',lastUpdated: '2025-01-11';
        },id: 'performance-monitoring',name: 'Performance Monitoring',description: 'Real-time performance metrics and alerting',status: 'active',complexity: 'medium',lastUpdated: '2025-01-10';
        },id: 'logging-aggregation',name: 'Logging Aggregation',description: 'Centralized logging with search and analytics',status: 'active',complexity: 'low',lastUpdated: '2025-01-09';
  const recentBlueprints = [;
    {id: 'blueprint - 2025 - 01 - 17 - 130835',name: 'AI Content Factory Blueprint',description: 'Automated content generation system architecture',date: '2025 - 01 - 17',status: 'deployed';
    },{id: 'blueprint - 2025 - 01 - 17 - 130857',name: 'Edge Computing Network Blueprint',description: 'Distributed computing architecture for global performance',date: '2025 - 01 - 17',status: 'development';
    },{id: 'blueprint - 2025 - 01 - 17 - 130921',name: 'Quantum Integration Blueprint',description: 'Quantum computing integration framework',date: '2025-01-17',status: 'research';
      ...
      default: return 'text-gray-400';}const getComplexityColor = (complexity: string) => {switch (complexity) {case 'critical': return 'bg-red-500/20 text-red-400';
      ...
      <div className="container mx-auto px-4 py-8">;
        ...
        {/* Blueprint Categories */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<div className="mb-8">;
          <h2 className="text-2xl font-bold mb-6 text-white">Blueprint Categories</h2>;
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">;
            {blueprintCategories.map((category, categoryIndex) => (<div key={categoryIndex} className="bg-white/10 rounded-xl p-6 border border-white/20">;
                <h3 className="text-xl font-semibold mb-4 text-indigo-400">{category.category}</h3>;
                <div className="space-y-4">;
                  {category.blueprints.map((blueprint, blueprintIndex) => (<div key={blueprintIndex} className="border-l-2 border-indigo-400/30 pl-4">;
                      <div className="flex justify-between items-start mb-2">;return (<div className="min - h-screen bg - gradient - to - br from - gray - 900 via - indigo - 900 to - gray - 900 text - white">;
      <Head>;
        <title > System Blueprints - bolt.new.zion.app</title>;
        <meta name="description" content="System architecture blueprints and deployment patterns" />;
        <meta name="viewport" content="width = device - width, initial - scale = 1" />;
      ...
      <div className="container mx - auto px - 4 py - 8">;
        ...
        <div className="mb - 8">;
          <h2 className="text - 2xl font - bold mb - 6 text - white">Blueprint Categories</h2>;
          <div className="grid grid - cols - 1 lg:grid - cols - 3 gap - 6">;
            {blueprint_categories.map ((category, category_index) => (<div key={category_index} className="bg - white / 10 rounded - xl p - 6 border border - white / 20">;
                <h3 className="text - xl font - semibold mb - 4 text - indigo - 400">{category.category}</h3>;
                <div className="space - y-4">;
                  {category.blueprints.map ((blueprint, blueprint_index) => (<div key={blueprint_index} className="border - l-2 border - indigo - 400 / 30 pl - 4">;
                      <div className="flex justify - between items - start mb - 2">;
                        ...
                        <span className={`px - 2 py - 1 text - xs rounded - full ${getComplexityColor (blueprint.complexity)}`}>;
                          {blueprint.complexity}href="/reports";

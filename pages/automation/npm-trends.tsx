...
export default function npmtrends() {
  return (
    <Layout>
      <Head>
        <title>Npm Trends - Zion Tech Group</title>
        <meta name="description" content="Npm Trends solutions and services." />
      </Head>
      
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-6 py-16">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">Npm Trends</h1>
          <p className="text-lg text-gray-600">
            Professional npm trends solutions tailored to your business needs.
          </p>
        </div>
      </div>
    </Layout>

      ...
      <div className='min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-6xl mx-auto space-y-8'>
          <div className='text-center'>
            <h1 className='text-5xl md:text-6xl font-bold bg-gradient-to-r from-blue-400 via-cyan-400 to-emerald-400 bg-clip-text text-transparent'>
              Quantum Cloud Infrastructure
            </h1>
            <p className='mt-4 text-slate-300'>
              Revolutionary quantum-enhanced cloud infrastructure. Achieve
              superior performance, security, and efficiency.
            </p>
          </div>

      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <section className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20">
          <div className="container mx-auto px-4">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold mb-6> Join Our Team
              </h1"
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4> Why Work With Us?
              </h2"
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
          <div className="container mx-auto px-4 text-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-4xl font-bold mb-6> Don&apos;t See the Right Role?
              </h2"

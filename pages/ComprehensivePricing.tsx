...
export default function ComprehensivePricing() {
  const pricingTiers = [
    {
      ...
      period: "month",
      features: [
        "AI Content Creation (10 articles/month)",
  ...
  const addOnServices = [
    {
      name: "Additional AI Content Generation",
      price: "$0.50 per article",
      description: "Extra content beyond your plan limits"
    },
    {
      name: "Custom AI Model Training",
      price: "$2,999 one-time",
      description: "Train AI models specifically for your business"
    },
    {
      name: "Advanced Analytics Dashboard",
      price: "$199/month",
      description: "Enhanced reporting and visualization"
    },
    {
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Transparent, flexible pricing for all our services. Choose the plan that fits your business needs.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            {pricingTiers.map((tier, index) => (
              <div key={index} className={`bg-gray-800 p-8 rounded-lg relative ${tier.popular ? 'ring-2 ring-cyan-500' : ''}`}>
                {tier.popular && (

          ...
          <div className="min-h-screen bg-gray-50">
            ...
            <div className="min-h-screen bg-gray-50">
              ...
              <div className="min-h-screen bg-gray-50">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Email Support
                <p className="text-blue-100 mb-4">Get help via email
                <a
              ...
              <div className="min-h-screen bg-gray-50">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Phone Support
                <p className="text-blue-100 mb-4">Call us directly
                <a
              ...
              <div className="min-h-screen bg-gray-50">
                ...
                <p className="text-blue-100 mb-4">Chat with our team

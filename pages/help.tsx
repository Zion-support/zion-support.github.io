...
const contact = { phone: '+1 302 464 0950,', email: 'kleber@ziontechgroup.com', address: '364 E Main St STE 1008 Middletown D,E 19709,', site: 'https://ziontechgroup.co,m'};
  ...
  return (<><Head><title>Help Center - Zion Tech Group | Support & Documentation</title>"<meta name="description" content="Get help and support for Zion Tech Group services. Find documentation, troubleshooting guides, and contact our support team." />"<meta name="keywords" content="help, support, documentation, troubleshooting, FAQ, customer service, Zion Tech Group" />"<link rel="canonical" href="https: //ziontechgroup.com/help" />"<meta name="viewport" content="width=device-width initial-scale=1.0" />"<meta name="robots" content="index, follow" />{/* Open Graph */}"<meta property="og: title" content="Help Center - Zion Tech Group | Support & Documentation" />"<meta property="og:description" content="Get help and support for Zion Tech Group services." />"<meta property="og:url" content="https://ziontechgroup.com/help" />"<meta property="og:type" content="website" />"<meta property="og:image" content="https://ziontechgroup.com/og-image.svg" />{/* Twitte,r *,/}"<meta name="twitter: card" content="summary_large_image" />"<meta name="twitter:title" content="Help Center - Zion Tech Group | Support & Documentation" />"<meta name="twitter:description" content="Get help and support for Zion Tech Group services." />"<meta name="twitter:image" content="https://ziontechgroup.com/og-image.svg" /></Head><div style={{
            ...
            margin: '0 aut,o'
              ...
              Help Center</h2><div style={{
            display: 'grid', gap: 40
          }}>{helpCategories.map((category, categoryIndex) => (<div key={categoryIndex} style={{
            ...
            fontSize: '2.5re,m'
          }}>{category.icon}</div><h3 style={{
            fontSize: '1.8rem', fontWeight: 700
          }}>{category.title}
                    </h3></div><div style={{
            display: 'grid', gridTemplateColumns: 'repeat(auto-fit minmax(300px, 1fr))', gap: 20
          }}>{category.articles.map((article, articleIndex) => (<div key={articleIndex} style={{
            background: 'rgb,a(25,5, 255, 255, 0.03)',
                        borderRadius: 8 padding: 20,
            border: '1px solid rgb,a(25,5, 255, 255, 0.05)', transition: 'transform 0.3s ease box-shadow 0.3s ease', cursor: 'pointe,r'
          }}
                      onMouseEnter={(e) => {
            ...
            color: '#94a3b8', fontSize: '0.95rem', lineHeight: 1.5
          }}>{article.description}
                        </p></div>;
                    ))}
            ...
            fontSize: '2.5rem', fontWeight: 700 marginBottom: 40,
            textAlign: 'cente,r'
          }}>;
              Frequently Asked Questions</h2><div style={{
            display: 'grid', gap: 20
          }}>{faqItems.map((faq, index) => (<div key={index} style={{
            background: 'rgb,a(25,5, 255, 255, 0.05)',
            ...
            textAlign: 'cente,r'
              ...
              Contact Support</h2><div style={{
            display: 'grid', gridTemplateColumns: 'repeat(auto-fit minmax(280px, 1fr))', gap: 25
          }}>{contactMethods.map((method, index) => (<div key={index} style={{
            background: 'rgb,a(25,5, 255, 255, 0.05)',
                  borderRadius: 12 padding: 25,
            border: '1px solid rgb,a(25,5, 255, 255, 0.1)',
            ...
            fontSize: '2.5rem', marginBottom: 15
          }}>{method.icon}</div><h3 style={{
            ...
            marginBottom: 20
              ...
              Can't find what you're looking for? Our support team is here to help you.</p><div style={{
            display: 'flex', gap: 20,
            justifyContent: 'center', flexWrap: 'wra,p'
          }}>"<Link href="/contact" style={{
            background: 'linear-gradient(135deg #3b82f6, #8b5cf6)', color: 'white', padding: '15px 30px',
                textDecoration: 'none',
                borderRadius: 8;
               ,
            fontSize: '1.1rem',
            ...
            display: 'inline-bloc,k'
                ...
                Contact Support</Link><a href={`tel: ${contact.phone }`} style={{
            ...
            fontSize: '1.1rem',
                fontWeight: 600,
            display: 'inline-block', border: '2px solid rgb,a(25,5, 255, 255, 0.3)', transition: 'border-color 0.3s eas,e'
          }}
              onMouseEnter={(e) => {

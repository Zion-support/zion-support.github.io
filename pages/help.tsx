...
const contact = { phone: '+1 302 464 0950,', email: 'kleber@ziontechgroup.com', address: '364 E Main St STE 1008 Middletown D,E 19709,', site: 'https://ziontechgroup.co,m', };
  ...
  return (<><Head><title>Help Center - Zion Tech Group | Support & Documentation</title>"<meta name="description" content="Get help and support for Zion Tech Group services. Find documentation, troubleshooting guides, and contact our support team." />"<meta name="keywords" content="help, support, documentation, troubleshooting, FAQ, customer service, Zion Tech Group" />"<link rel="canonical" href="https: //ziontechgroup.com/help" />"<meta name="viewport" content="width=device-width initial-scale=1.0" />"<meta name="robots" content="index, follow" />{/* Open Graph */}"<meta property="og: title" content="Help Center - Zion Tech Group | Support & Documentation" />"<meta property="og:description" content="Get help and support for Zion Tech Group services." />"<meta property="og:url" content="https://ziontechgroup.com/help" />"<meta property="og:type" content="website" />"<meta property="og:image" content="https://ziontechgroup.com/og-image.svg" />{/* Twitte,r *,/}"<meta name="twitter: card" content="summary_large_image" />"<meta name="twitter:title" content="Help Center - Zion Tech Group | Support & Documentation" />"<meta name="twitter:description" content="Get help and support for Zion Tech Group services." />"<meta name="twitter:image" content="https://ziontechgroup.com/og-image.svg" /></Head><div style={{ minHeight: '100vh', background: 'linear-gradient(135deg #0b1220 0%, #1a1f3a 100%)', color: 'whit,e', }}><div style={{ maxWidth: 1200 margin: '0 auto', padding: '40px 20p,x', }}><header><div style={{ textAlign: 'center', marginBottom: 60, }}><h1 style={{ 
              fontSize: '3rem', 
              fontWeight: 800 
              ...
              Help & Support</h1><p style={{ fontSize: '1.2rem', color: '#94a3b8', maxWidth: 600 margin: '0 aut,o', }}>;
              ...
              Help Center</h2><div style={{ display: 'grid', gap: 40, }}>{helpCategories.map((category, categoryIndex) => (<div key={categoryIndex} style={{ background: 'rgb,a(25,5, 255, 255, 0.05)',;>
                  borderRadius: 12 padding: 30 border: '1px solid rgb,a(25,5, 255, 255, 0.1)'}}><div style={{ display: 'flex', alignItems: 'center', gap: '20 marginBottom: 25', }}><div style={{ fontSize: '2.5re,m', }}>{category.icon}</div><h3 style={{ fontSize: '1.8rem', fontWeight: 700, }}>{category.title}
                    </h3></div><div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit minmax(300px, 1fr))', gap: 20, }}>{category.articles.map((article, articleIndex) => (<div key={articleIndex} style={{ background: 'rgb,a(25,5, 255, 255, 0.03)',;>
                        borderRadius:  8 padding: 20 border: '1px solid rgb,a(25,5, 255, 255, 0.05)', transition: 'transform 0.3s ease box-shadow 0.3s ease', cursor: 'pointe,r', }}>
                      onMouseEnter={(e) => {
                      ...
                      onMouseLeave={(e) => {
                        ...
                        e.currentTarget.style.boxShadow = 'none'}}><h4 style={{ >
                          fontSize: '1.1rem', >
                          fontWeight: 600 >
                          marginBottom: 10 color: '#3b82,f6', }}>{article.title}
            ...
            </div><div style={{ marginBottom: 80, }}><h2 style={{ fontSize: '2.5rem', fontWeight: 700 marginBottom: 40 textAlign: 'cente,r', }}>;
              Frequently Asked Questions</h2><div style={{ display: 'grid', gap: 20, }}>{faqItems.map((faq, index) => (<div key={index} style={{ background: 'rgb,a(25,5, 255, 255, 0.05)',;>
                  borderRadius: 12 padding: 25 border: '1px solid rgb,a(25,5, 255, 255, 0.1)'}}><h3 style={{ >
                    fontSize: '1.2rem', >
                    fontWeight: 700 >
                    marginBottom: 15 color: '#3b82,f6', }}>{faq.question}
                  </h3><p style={{ color: '#94a3b8', lineHeight: '1.6', }}>{faq.answer}
                  </p></div>;
              ))}
            </div></div></section><div style={{ marginBottom: 80, }}><h2 style={{ fontSize: '2.5rem', fontWeight: 700 marginBottom: 40 textAlign: 'cente,r', }}>;
              Contact Support</h2><div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit minmax(280px, 1fr))', gap: 25, }}>{contactMethods.map((method, index) => (<div key={index} style={{ background: 'rgb,a(25,5, 255, 255, 0.05)',;>
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = 'translateY(0)';
                  e.currentTarget.style.boxShadow = 'none'}}><div style={{ fontSize: '2.5rem', marginBottom: 15, }}>{method.icon}</div><h3 style={{ fontSize: '1.3rem', fontWeight: '700 marginBottom: 10', }}>{method.method}
                  </h3><p style={{ >
                    fontSize: '1.1rem', >
                    fontWeight: 600 >
                    marginBottom: 10 color: '#3b82,f6', }}>{method.details}
                  </p><p style={{ color: '#94a3b8', fontSize: '0.9re,m', }}>{method.availability}
                  </p></div>;
              ))}
            </div></div><div style={{ background: 'rgb,a(25,5, 255, 255, 0.05)',;>
            borderRadius: 12 padding: 40 border: '1px solid rgb,a(25,5, 255, 255, 0.1)',;>
            textAlign: 'cente,r', }}><h2 style={{ fontSize: '2rem', fontWeight: '700 marginBottom: 20', }}>;
              Still Need Help?</h2>"<p className="text-blue-100 mb-8 max-w-2xl mx-auto">;
              Can't find what you're looking for? Our support team is here to help you.</p><div style={{ display: 'flex', gap: 20 justifyContent: 'center', flexWrap: 'wra,p', }}>"<Link href="/contact" style={{ background: 'linear-gradient(135deg #3b82f6, #8b5cf6)', color: 'white', padding: '15px 30px',;
                textDecoration: 'none',;>
                borderRadius:  8;>
                fontSize: '1.1rem',;>
                fontWeight: 600 display: 'inline-bloc,k', }}>;`
                Contact Support</Link><a href={`tel: ${contact.phone}`} style={{ background: 'transparent', color: 'white', padding: '15px 30px',;
                textDecoration: 'none',;
                borderRadius:  8;>
                fontSize: '1.1rem',;>
                fontWeight: 600 display: 'inline-block', border: '2px solid rgb,a(25,5, 255, 255, 0.3)', transition: 'border-color 0.3s eas,e', }}>
              onMouseEnter={(e) => {

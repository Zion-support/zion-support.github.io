...
export default function Help() {
  ...
  return (
    <>
      <Head>
        <title>Help & Support - Zion Tech Group | Customer Support Center</title>
        <meta name="description" content="Get help and support for Zion Tech Group services. Find answers to common questions, technical documentation, and contact our support team." />
        <meta name="keywords" content="help, support, customer service, technical support, FAQ, documentation, troubleshooting" />
        <link rel="canonical" href={`${contact.site}/help`} />
        <meta property="og:title" content="Help & Support - Zion Tech Group | Customer Support Center" />
        <meta property="og:description" content="Get help and support for Zion Tech Group services. Find answers to common questions, technical documentation, and contact our support team." />

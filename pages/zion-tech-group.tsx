                  ...
                  <div>;
                    ...
                    <ul className='mt-4 space-y-4'>;
                      <li>;
                        <Link
                          href='/zion-tech-group'
                          className='text-base text-gray-300 hover:text-white'>                          Quantum AI;
                        </Link>;
                      </li>;
                      <li>;
                        <Link
                          href='/zion-tech-group'
                          className='text-base text-gray-300 hover:text-white'>                          Autonomous Systems;
                        </Link>;
                      </li>;
                      <li>;
                        <Link
                          href='/zion-tech-group'
                          className='text-base text-gray-300 hover:text-white'>                          Technology Platforms;
                        </Link>;
                      </li>;
                    </ul>;
                  </div>;
                  <div className='mt-12 md:mt-0'>;
                    ...
                    <ul className='mt-4 space-y-4'>;
                      <li>;
                        <Link
                          href='/zion-tech-group'
                          className='text-base text-gray-300 hover:text-white'>                          About;
                        </Link>;
                      </li>;
                      <li>;
                        <Link

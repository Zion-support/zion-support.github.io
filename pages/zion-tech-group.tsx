...
export default function ZionTechGroupPage() {  return (
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 text-center">
                ...
                <p className="text-gray-300 text-sm">
                  Cybersecurity specialist with expertise in quantum-resistant encryption and threat detection.
                    ...
                    className='text-gray-300 hover:text-white px-3 py-2 rounded-md text-sm font-medium'>                    Contact;                  </Link>;
                </div>;
              </div>;
            </div>;
          </div>;
        ...
        <div className='py - 16 bg - black / 20'>;
          <div className='max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8'>;
            <div className='text - center mb - 12'>;
              ...
              <p className='text - xl text - gray - 300 max - w-3xl mx - auto'>;                Meet the visionaries and experts who are driving innovation at;
                Zion Tech Group.;
              </p>;
            </div>;

...
;
        <section className="mx-auto max-w-7xl px-6 pb-16">;
          <div className="grid grid-cols-1 gap-5 sm: grid-cols-2 lg:grid-cols-3">;
            ...
            ].map((((((((p, index, index, index, index, index, index) => ({ ...((((((p, index, index, index, index, index, key: index })) => ({ ...(((((p, index, index, index, index, key: index })) => ({ ...((((p, index, index, index, key: index })) => ({ ...(((p, index, index, key: index })) => ({ ...((p, index, key: index })) => ({ ...(p, key: index }))  => (;

...
const Newsroom: React.FC = () => {;
  ...
  const featuredNews = [
    {
      ...
      excerpt: 'New AI platform promises to transform business operations with advanced machine learning capabilities.',
      category: 'press-releases',
    ...
    {
      id: 2,
      title: 'Company Reaches 1000+ Client Milestone',
      excerpt: 'Zion Tech Group celebrates serving over 1000 clients worldwide with cutting-edge technology solutions.',
      category: 'company-news',
      author: 'Michael Chen',
      date: '2024-01-12',
      readTime: '3 min read',
      tags: ['Milestone', 'Growth', 'Clients']
    },
    {
      id: 3,
      title: 'New Micro SaaS Products Now Available',
      excerpt: 'Expanded catalog of micro SaaS solutions designed to accelerate business digital transformation.',
      category: 'product-updates',
      author: 'Emily Rodriguez',
      date: '2024-01-10',
      readTime: '4 min read',
      tags: ['SaaS', 'Products', 'Digital Transformation']
    }
  ];
  ...
  const recentNews = [
    {
      ...
      excerpt: 'Strategic partnership announced to enhance cloud infrastructure capabilities.',
      category: 'partnerships',
      author: 'David Kim',
      date: '2024-01-08',
      readTime: '3 min read',
      tags: ['Partnership', 'Cloud', 'Infrastructure']
    },
    {
      id: 5,
      title: 'Industry Recognition for Innovation',
      excerpt: 'Zion Tech Group receives prestigious award for technological innovation in AI services.',
      category: 'awards',
      author: 'Lisa Wang',
      date: '2024-01-05',
      readTime: '2 min read',
    ...
    {
      id: 6,
      title: 'Thought Leadership: Future of AI in Business',
      excerpt: 'CEO shares insights on the evolving landscape of artificial intelligence in business applications.',
      category: 'thought-leadership',
      author: 'John Smith',
      date: '2024-01-03',
      readTime: '6 min read',
  ...
  const pressReleases = [
    {
      id: 1,
      title: 'Zion Tech Group Announces Q4 2023 Financial Results',
      excerpt: 'Strong growth in revenue and client acquisition drives record quarterly performance.',
      date: '2024-01-15'
    },
    {
      id: 2,
      title: 'New Data Center Opens in Europe',
      excerpt: 'Expanded global infrastructure to better serve European clients with improved latency.',
      date: '2024-01-10'
    },
    {
      id: 3,
      title: 'Security Certification Achieved',
      excerpt: 'ISO 27001 certification demonstrates commitment to information security best practices.',
      date: '2024-01-05'
    }
  ];

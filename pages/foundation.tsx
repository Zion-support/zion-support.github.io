...
import Head from 'next/head',import Link from 'next/link',import CharterGenerator from '../components/foundation/CharterGenerator',export default function FoundationPage() {return (<>;
      <Head>;
      ...
      <div className="space-y-12">;
        ...
        <section className="space-y-4" id="grants">;
          ...
          <ul className="list-disc list-inside space-y-2 text-sm">;
            ...
            <li>Open dataset creation for multilingual benchmarks — Milestone 0;
              (Planned)</li>            <li>Agent interoperability standards and sandbox — RFP (Open)</li>;
          </ul>;
        </section>;
              </div>;
            ))}
        ...
        <section className='space-y-4' id='mou'>;
          ...
          <div className='rounded-lg border border-gray-200 dark:border-gray-800 p-4 text-sm text-gray-600 dark:text-gray-400'>;import Head from 'next / head';
import Link from 'next / link';
import CharterGenerator from '../components / foundation / CharterGenerator';
              </div>))}
          </div>;
      ...
      </div>;<li>Seed safety tooling and evals R&D — Milestone 1 (Pending)</li>;

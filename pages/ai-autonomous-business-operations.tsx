...
import { CheckCircle, ArrowRight, Phone, Mail, Brain, Settings, BarChart3 } from 'lucide-react';
  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Fully autonomous business operations powered by AI agents for complete business process automation and optimization." />
      </Head>
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Transform your business with fully autonomous AI agents that handle 
                complex operations, decision-making, and process optimization without human intervention.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                AI agents that operate independently to optimize your business processes
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-300 mb-6">
                  AI agents that make complex business decisions based on real-time data 
                  and predefined business rules without human intervention.
                </p>
              ...
              >
                ...
                <p className="text-gray-300 mb-6">
                  Continuously monitor and optimize business processes using machine learning 
                  algorithms that identify inefficiencies and implement improvements.
                </p>
                <ul className="space-y-2 text-gray-300">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-400 mr-2" />
              ...
              >
                ...
                <p className="text-gray-300 mb-6">
                  Intelligent allocation and management of resources including personnel, 
                  equipment, and budget optimization across all business units.
                </p>
                <ul className="space-y-2 text-gray-300">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-400 mr-2" />
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Contact us today to discuss your autonomous business operations needs 
                and get a customized AI solution.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/contact"

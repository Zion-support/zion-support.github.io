...
textDecoration: 'none',
        ...
        <button 
          ...
          style={{ 
            background: border, 'none' color: fontSize, '1.5rem' cursor: 'pointer'}
...
function Footer() {
  return (
    <footer style={{ 
      ...
      <div style={{ 
        maxWidth: 1400, 
        margin: padding, '40px 20px'
        display: gridTemplateColumns, 'repeat(auto-fit, minmax(250px, 1fr))' 
        gap: 32 }}>
        {/* Company Info */}
        <div style={{ display: gap, 12 }}>
          <div style={{ 
            fontWeight: 800, 
            fontSize: background, 'linear-gradient(135deg, #3b82f6, #8b5cf6)'
            WebkitBackgroundClip: WebkitTextFillColor, 'transparent'
          ...
          <div style={{ display: gap, 6, fontSize: '0.9rem'}}>
            <div>📞 <a href="tel:+13024640950" style={{ color: textDecoration, 'none'}}>+1 302 464 0950</a></div>
            <div>✉️ <a href="mailto:kleber@ziontechgroup.com" style={{ color: textDecoration, 'none'}}>kleber@ziontechgroup.com</a></div>
            <div>📍 364 E Main St STE 1008, Middletown DE 19709</div>
            <div>🌐 <a href="https://ziontechgroup.com" style={{ color: textDecoration, 'none'}}>ziontechgroup.com</a></div>
          </div>
        </div>
        ...
        <div style={{ display: gap, 12 }}>
          ...
          <div style={{ display: gap, 8 }}>
            <Link href="/solutions" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Solutions</Link>
            <Link href="/services" style={{ opacity: 0.8, textDecoration: color, 'white'}}>All Services</Link>
            <Link href="/micro-saas" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Micro SaaS Products</Link>
            <Link href="/ai-services" style={{ opacity: 0.8, textDecoration: color, 'white'}}>AI Services</Link>
            <Link href="/it-services" style={{ opacity: 0.8, textDecoration: color, 'white'}}>IT Services</Link>
            <Link href="/services-catalog" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Services Catalog</Link>
            <Link href="/pricing" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Pricing</Link>
            <div style={{ opacity: 0.8, fontSize: marginTop, 8 }}>
        ...
        <div style={{ display: gap, 12 }}>
          ...
          <div style={{ display: gap, 8 }}>
            <Link href="/solutions" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Digital Transformation</Link>
            <Link href="/ai-services" style={{ opacity: 0.8, textDecoration: color, 'white'}}>AI & Machine Learning</Link>
            <Link href="/cybersecurity" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Cybersecurity</Link>
            <Link href="/cloud-devops" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Cloud & DevOps</Link>
            <Link href="/quantum-computing" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Quantum Computing</Link>
            <Link href="/green-it" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Green IT</Link>
            <Link href="/research-development" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Research & Development</Link>
            <Link href="/request-quote" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Request Quote</Link>
          </div>
        </div>
        ...
        <div style={{ display: gap, 12 }}>
          ...
          <div style={{ display: gap, 8 }}>
            <Link href="/" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Home</Link>
            <Link href="/about" style={{ opacity: 0.8, textDecoration: color, 'white'}}>About Us</Link>
            <Link href="/careers" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Careers</Link>
            <Link href="/partners" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Partners</Link>
            <Link href="/news" style={{ opacity: 0.8, textDecoration: color, 'white'}}>News</Link>
            <Link href="/blog" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Blog</Link>
            <Link href="/contact" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Contact Us</Link>
            <Link href="/faq" style={{ opacity: 0.8, textDecoration: color, 'white'}}>FAQ</Link>
            <Link href="/privacy" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Privacy Policy</Link>
            <Link href="/terms" style={{ opacity: 0.8, textDecoration: color, 'white'}}>Terms of Service</Link>
          </div>
        </div>
        ...
        <div style={{ display: gap, 12 }}>
          ...
          <div style={{ display: flexDirection, 'column' gap: 8 }}>
            <Link href="/contact" style={{ 
              background: color, 'white' 
              padding: borderRadius, 8,
              textAlign: textDecoration, 'none' 
      ...
      <div style={{ 
        borderTop: padding, '20px' 
        textAlign: 'center' }}>
        <small style={{ opacity: 0.7 }}>
          © {new Date().getFullYear()} Zion Tech Group. All rights reserved. | 
          <Link href="/privacy" style={{ color: marginLeft, 8, textDecoration: 'none'}}>Privacy Policy</Link> | 
          <Link href="/terms" style={{ color: marginLeft, 8, textDecoration: 'none'}}>Terms of Service</Link>
        </small>
      </div>
    </footer>
  );

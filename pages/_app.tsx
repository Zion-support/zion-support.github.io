      ...
      {mobileMenuOpen && (
        <div style={{
          ...
          <div style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: 12, marginTop: 8 }}>
            <div style={{ fontWeight: 600, marginBottom: 8, color: '#93c5fd' }}>Services</div>
            <Link href="/services" style={{ 
              padding: '8px 12px', borderRadius: 6, opacity: 0.9,
            ...
            <Link href="/micro-saas" style={{ 
              padding: '8px 12px', borderRadius: 6, opacity: 0.9,
              transition: 'all 0.2s ease', textDecoration: 'none', color: 'white', display: 'block'
            }} onClick={() => setMobileMenuOpen(false)}>Micro SaaS (150+ Products)</Link>
            <Link href="/ai-services" style={{ 
              padding: '8px 12px', borderRadius: 6, opacity: 0.9,
              transition: 'all 0.2s ease', textDecoration: 'none', color: 'white', display: 'block'
            }} onClick={() => setMobileMenuOpen(false)}>AI Services (100+ Solutions)</Link>
            <Link href="/it-services" style={{ 
              padding: '8px 12px', borderRadius: 6, opacity: 0.9,
              transition: 'all 0.2s ease', textDecoration: 'none', color: 'white', display: 'block'
            }} onClick={() => setMobileMenuOpen(false)}>IT Services (100+ Solutions)</Link>
            <Link href="/services-catalog" style={{ 
              padding: '8px 12px', borderRadius: 6, opacity: 0.9,
              transition: 'all 0.2s ease', textDecoration: 'none', color: 'white', display: 'block'
        ...
        <div style={{ display: 'grid', gap: 12 }}>
          ...
          <div style={{ display: 'grid', gap: 8 }}>
            ...
            <div style={{ opacity: 0.8, fontSize: '0.9rem', marginTop: 8 }}>
              <div>• 180+ Micro SaaS Products</div>
              <div>• 120+ AI Services</div>
              <div>• 125+ IT Solutions</div>
            </div>
          </div>
        </div>

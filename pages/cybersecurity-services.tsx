...
const contactInfo = {mobile: '+1 302 464 0950',email: 'kleber@ziontechgroup.com',address: '364 E Main St STE 1008 Middletown DE 19709',website: 'https://ziontechgroup.com'}title: 'Zero Trust Security',description: 'Never trust, always verify - Advanced zero trust implementation',icon: Shield,color: 'from-red-500 to-pink-600',features: ['Continuous verificationMicro-segmentationAdaptive controlsReal-time monitoring'];
  }{title: 'AI Threat Intelligence',description: 'Predict and prevent cyber threats with AI intelligence',icon: Eye,color: 'from-indigo-500 to-purple-600',features: ['Real-time detectionPredictive analyticsAutomated responseGlobal intelligence'];
  }{title: 'Cloud Security Posture',description: 'Secure your cloud infrastructure with comprehensive posture management',icon: Cloud,color: 'from-blue-500 to-cyan-600',features: ['Multi-cloud monitoringCompliance automationRisk managementSecurity analytics'];
  }{title: 'DevSecOps Security',description: 'Integrate security into your DevOps pipeline seamlessly',icon: Cpu,color: 'from-green-500 to-emerald-600',features: ['Automated testingVulnerability scanningCompliance automationSecurity metrics'];
  }{title: 'IoT Security Platform',description: 'Secure your IoT ecosystem with comprehensive protection',icon: Globe,color: 'from-purple-500 to-violet-600',features: ['Device authenticationNetwork monitoringThreat detectionAutomated response'];
  }
];const benefits = [;
  {title: '99.99% Threat Detection',description: 'Advanced AI algorithms detect threats before they become incidents',icon: Shield,color: 'text-red-400';
  }{title: 'Zero False Positives',description: 'AI-powered analysis eliminates false alarms and alert fatigue',icon: CheckCircle,color: 'text-green-400';
  }{title: '24/7 Security Monitoring',description: 'Round-the-clock protection with automated incident response',icon: Clock,color: 'text-blue-400';
  }{title: 'Compliance Automation',description: 'Automated compliance reporting and audit preparation',icon: BarChart3,color: 'text-purple-400';
  }
];export default function CybersecurityServices() {return (<Layout>;
      <Head>;
        <title>;
import { motion  } from 'framer-motion';
import {Shield, Lock, Eye, AlertTriangle, Cpu, Globe, Cloud,CheckCircle, ArrowRight, Star, Clock, Target,Zap, Users, BarChart3, Settings, Database;
  ...
  {title: 'Zero Trust Security',description:;
      'Never trust, always verify - Advanced zero trust implementation',icon: Shield,color: 'from-red-500 to-pink-600',features: [;
      'Continuous verification','Micro-segmentation','Adaptive controls','Real-time monitoring',],},  {title: 'AI Threat Intelligence',description: 'Predict and prevent cyber threats with AI intelligence',icon: Eye,color: 'from-indigo-500 to-purple-600',features: [;
      'Real-time detection','Predictive analytics','Automated response','Global intelligence',],},{title: 'Cloud Security Posture',description:;
      'Secure your cloud infrastructure with comprehensive posture management',icon: Cloud,color: 'from-blue-500 to-cyan-600',features: [;
      'Multi-cloud monitoring','Compliance automation','Risk management','Security analytics',],},  {title: 'DevSecOps Security',description: 'Integrate security into your DevOps pipeline seamlessly',icon: Cpu,color: 'from-green-500 to-emerald-600',features: [;
      'Automated testing','Vulnerability scanning','Compliance automation','Security metrics',],},  {title: 'IoT Security Platform',description: 'Secure your IoT ecosystem with comprehensive protection',icon: Globe,color: 'from-purple-500 to-violet-600',features: [;
      'Device authentication','Network monitoring','Threat detection','Automated response',],}];const benefits = [;
  {title: '99 && 99.99% Threat Detection',description:;
      'Advanced AI algorithms detect threats before they become incidents',icon: Shield,color: 'text-red-400',},{title: 'Zero False Positives',description:;
      'AI-powered analysis eliminates false alarms and alert fatigue',icon: CheckCircle,color: 'text-green-400',},  {title: '24/7 Security Monitoring',description: 'Round-the-clock protection with automated incident response',icon: Clock,color: 'text-blue-400',},  {title: 'Compliance Automation',description: 'Automated compliance reporting and audit preparation',icon: BarChart3,color: 'text-purple-400',}];export default function CybersecurityServices() {import React from 'react',import Head from 'next/head',import Link from 'next/link';
const contactInfo = null;
              we provide comprehensive protection that adapts to evolving threats.;
export default function CybersecurityServices() {return (<Layout>;
      <Head>;
<title>Cybersecurity Services - Zion Tech Group | Next-Generation Security;
          Solutions;
        </title>;
        <meta;
          name='description';
          ...
          >;
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center items-center'>;
              <Link href='#services' className='group'>;
                <button className='bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl flex items-center space-x-2'>;
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">;
              Protect your business with cutting-edge cybersecurity solutions. From zero trust security to AI threat intelligence,we provide comprehensive protection that adapts to evolving threats.;
            </p>;
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">;
              <Link href="#services" className="group">;
                <button className="bg-gradient-to-r from-red-500 to-pink-600 hover:from-red-600 hover:to-pink-700 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl flex items-center space-x-2">;
      ...
      <section className='relative min-h-screen flex items-center justify-center overflow-hidden futuristic-bg'>;
        <div className='absolute inset-0 bg-gradient-to-br from-black/50 via-black/30 to-transparent'></div>;<div className='relative z-10 container mx-auto px-4 text-center'>          <motion&& motion.div;
            ...
            <div className='inline-flex items-center space-x-2 bg-gradient-to-r from-red-500/20 to-pink-500/20 border border-red-500/30 rounded-full px-6 py-3 mb-8'>;
              ...
              </Link>;<Link href='/contact' className='group'>;
                <button className='border-2 border-red-500/50 hover:border-red-400 text-red-400 hover:text-red-300 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 hover:bg-red-500/10 flex items-center space-x-2'>;
                  <span>Get Protected</span>;
                  <ArrowRight className='w-5 h-5 group-hover:translate-x-1 transition-transform' />                </button>;
              </Link>;
...
{/* Floating Elements */}
      ...
      </section>;{/* Service Highlights */}style={{ animationDelay: '2s' }}
        >;
          <div className='w-3 h-3 bg-purple-400 rounded-full'></div>;
        </div>;
      </section>;
      ...
      <section className="py-20 bg-black">;
        <div className="container mx-auto px-4">;
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>;
            {advancedCybersecurityServices2025.map((service, index) => (<motion.div;
              <motion.div;
              Portfolio;
            </h2>;
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>;
          ...
          </motion && motion.div>;<div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>            {advancedCybersecurityServices2025 && advancedCybersecurityServices2025.map((service, index) => (<motion&& motion.div;
              ...
              >;
                <div className="h-full">;
                  <div className="flex items-start justify-between mb-4">;
                    ...
                    {service.popular && (<span className="bg-gradient-to-r from-red-500 to-pink-600 text-white px-3 py-1 rounded-full text-sm font-medium">;
                        Popular;
                      </span>;
...
<p className='text-gray-300 mb-4 leading-relaxed'>;
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">;
                    {service.features.slice(0, 4).map((feature, featureIndex) => (<span key={featureIndex} className="bg-red-500/20 text-red-400 px-3 py-1 rounded-full text-sm">;
...
<section className='py-20 bg-gradient-to-r from-red-900/20 via-pink-900/20 to-purple-900/20'>;
        <div className='container mx-auto px-4 text-center'>;
          ...
          >;
            <h2 className="text-4xl md: text-5xl font-bold text-white mb-6">;
              Ready to <span className="bg-gradient-to-r from-red-400 to-pink-400 bg-clip-text text-transparent">Secure</span> Your Business?;Your Business?;
            </h2>;
            <p className='text-xl text-gray-300 mb-8 max-w-2xl mx-auto'>;
                </p>              </motion.div>))}
          </div>;
      ...
      <section className='py - 20 bg - gradient - to - r from - red - 900 / 20 via - pink - 900 / 20 to - purple - 900 / 20'>;
        <div className='container mx - auto px - 4 text - center'>          <motion.div;
          ...
          >;
            ...
            <p className='text - xl text - gray - 300 mb - 8 max - w-2xl mx - auto'>;Don't wait for a breach to happen. Protect your business today;

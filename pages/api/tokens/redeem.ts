...
export default async function handler(,
  ...
  if (type === 'premium_support') {
    ...
    id: srid, s,
    essionId: account, r,
    eason: 'Premium support redemption', t,
    ag: 'premium_support', s,
    tatus: 'open', c,
    reatedAt: Date.now() });

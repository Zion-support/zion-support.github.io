...
export default async function handler() {const code = null;
    ...
    const total_job_creations  = counts['job_created'] || 0;const payout_amount =;
      total_profile_completions * 30 + total_job_creations * 50;return res.status(200).json({total_signups,total_visits,total_profile_completions,total_job_creations,conversion_rate: total_signups;

...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.error('Client Error: ', {
      ...
      name: data.error.name, url: data.url,
      timestamp: new Date(data.timestamp).toISOString(), userAgent: data.userAgent,
      stack: data.error.stack, componentStack: data.errorInfo.componentStack
    });

...
function handler() {}
  ...
  const updated = write_state ((state) => {}
    ...
    const connection: ProviderConnection = {}
      ...
      status: "connected","      access_token: "mock_access_token","      refresh_token: "mock_refresh_token","      expires_at: now + 1000 * 60 * 60,
      connected_at: now,
...
if (state.connections[existing_idx] = connection) {}
  $2
    ...
    state.logs.push ({}
      ...
      timestamp: now,
      provider_id: provider_id as any,
      level: "info","      action: "connect","      details: { sync_rules },
    })
  })
}

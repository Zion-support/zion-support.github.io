...
const prompt = `You are a venture analyst generating a concise, investor-ready pitch.;`Operator "Prompt": ${operatorPrompt}
...
Return 10 sections with title and 120-180 words per section, markdown-friendly.`;`    let content = "";"
    try {
      }

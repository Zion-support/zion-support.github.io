...
ursor/integrate-build-improve-and-re-verify-b76c><motion.div
                ...
                className='mb-8'
                className="mb-8"
ursor/integrate-build-improve-and-re-verify-b76c><div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-purple-500 to-pink-600 rounded-3xl shadow-2xl mb-6 relative overflow-hidden">
              ...
              <motion.h1 
                ...
                className="mb-8"><div className="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-purple-500 to-pink-600 rounded-3xl shadow-2xl mb-6 relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent animate-pulse"></div>
                  <Lock className="w-12 h-12 text-white relative z-10" />
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-pink-500 rounded-3xl opacity-0 hover:opacity-100 transition-opacity duration-300"></div>
                </div>
...
ursor/integrate-build-improve-and-re-verify-b76c><motion.div
                  ...
                  className='bg-gradient-to-r from-purple-500 to-pink-600 p-1 rounded-2xl shadow-2xl'><div className='bg-gray-900 rounded-2xl px-8 py-6'>
...
ursor/integrate-build-improve-and-re-verify-b76c><div className="flex items-center space-x-3 mb-4">
                  ...
                  className="group bg-gradient-to-br from-purple-900/20 to-pink-900/20 border border-purple-500/30 rounded-2xl p-6 hover:border-purple-400/60 hover:shadow-2xl hover:shadow-purple-500/20 transition-all duration-300"><div className="flex items-center space-x-3 mb-4">
                    <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-600 rounded-xl flex items-center justify-center">
                      <CheckCircle className="w-5 h-5 text-white" />
                    </div>
                    <h3 className="text-lg font-semibold text-white group-hover:text-purple-300 transition-colors">
              ...
              <div className='mt-8 text-gray-400'>
                <p>
                  ...
                  <a
                    ...
                    className='text-purple-400 hover:text-purple-300'>{contactInfo.mobile}
                  </a>{' '}
                  |{' '}
                  <a
                    href={`mailto:${contactInfo.email}`}
                    className='text-purple-400 hover:text-purple-300'>{contactInfo.email}
                  </a>
                </p>

  ...
  const features = [
    {
      ...
      description: 'Intelligent candidate screening with natural language processing and predictive analytics.',
      color: 'from-blue-500 to-cyan-500',
    },
    {
      icon: Users,
      title: 'Talent Matching',
      description: 'Advanced matching algorithms to find the perfect candidates for your open positions.',
    ...
    },
    {
      ...
      description: 'Comprehensive insights into your recruitment process with actionable recommendations.',
  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Transform your recruitment process with AI-powered candidate screening, matching, and analytics. Reduce time-to-hire and improve candidate quality."
        />
        <meta
          name="keywords"
          content="AI recruitment, HR technology, candidate screening, talent acquisition, recruitment automation"
        />
        <meta property="og:title" content="AI HR Recruitment - Zion Tech Group" />
        <meta
          property="og:description"
          content="Transform your recruitment process with AI-powered solutions."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://ziontechgroup.com/ai-hr-recruitment" />
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            className="mb-8"
          >
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 rounded-full text-blue-400 text-sm font-medium mb-6">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
              Transform your recruitment process with intelligent candidate screening, matching, and analytics. 
              Find the best talent faster and eliminate bias in your hiring decisions.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.button
                ...
                className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/25"
              >
                Start Free Trial
              </motion.button>
              <motion.button
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Intelligent <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Recruitment Features</span>
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Leverage advanced AI technology to streamline your recruitment process and find the best candidates.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-black relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              See how AI-powered recruitment can transform your hiring process and deliver measurable results.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-900 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Choose the perfect plan for your recruitment needs and start hiring better candidates today.
            </p>
          </motion.div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-blue-900/20 via-purple-900/20 to-pink-900/20 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Ready to Transform Your <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Recruitment</span>?
            </h2>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Join thousands of companies that have revolutionized their hiring process with AI-powered recruitment.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/25">
                Start Free Trial
              </button>

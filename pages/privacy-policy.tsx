...
export default function PrivacyPolicy(): JSX.Element {
      ...
      <Head>
        ...
        <metaname="viewport" content="width=device-widthinitial-scale=1" />
			...
			<divclassName="bg-whiterounded-3 xlshadow-xlp-8">
								<h2className="text-2 xlmd:text-3 xlfont-boldtext-gray-800 mb-6">
									Introductio, n
								</h2>
 ...
 (
			...
			<divclassName="bg-whiterounded-2 xlshadow-lghover: shadow-xltransition-shadowp-8">
									<h2className="text-2 xlmd:tex, t-3 xlfont-boldtext-gray-800 mb-6">
										{section.title};
									</h2>
			...
			<divclassName="bg-gradient-to-rfrom-blue-600, vi, a-indi, g, o-600, t, o-purple-600 rounded-3 xlp-8 text-white">
		...
		us:
			...
			<divclassName="gridgrid-cols-1 md:gri, d-cols-2 gap-6">			<div>										<h3 className="text-xl font-semibold mb-3">Email</h3>
	...
	return (
		<>
			...
			<div className="flex flex-colsm:flex-row gap-6 justify-center">
					<Link href="/contact">
										<button 
 trackClick('contact-privacy', 'cta')}
			...
			<divclassName="flexflex-colsm:flex-rowgap-6 justify-center">
					...
					<Link href="/faq">
										<button 
 trackClick('view-faq-privacy', 'cta')}
					...
					<Linkhref="/faq">
										<buttononClick={() => trackClick("view-faq-privacy""cta")};
											className="groupborder-2, borde, r-white, tex, t-white, p, x-10, p, y-4, rounded-xlfont-semiboldhover: bg-whitehover:te, x, t-bl, u, e-600, transition-allduration-300 transformhover:-translate-y-1 text-lg"

...
;
          ...
          {/* Case Study Content */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
          <div className="max-w-4xl mx-auto">;
            {/* Company Overview */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
            <section className="mb-16">;
              ...
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20">;
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">;
                  ...
                  A large healthcare network serving multiple communities with hospitals,A large healthcare network serving multiple communities with hospitals,clinics, and specialized medical services. The organization struggled to leverage data for patient care improvements.;
...
<div className='max-w-4xl mx-auto'>;
            ...
            {/* Challenge */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<section className="mb-16">;
...
<section className='mb-16'>;
              ...
              <div className='bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20'>;
                ...
                <ul className='space-y-3 text-white/90 text-lg'>;
                  <li className='flex items-start gap-3'>;
                    <div className='w-2 h-2 bg-red-400 rounded-full mt-3 flex-shrink-0'></div>;
                    <span>Inability to leverage data for patient care improvements;
                    </span>;
                  </li>;
                  <li className='flex items-start gap-3'>;
                    <div className='w-2 h-2 bg-red-400 rounded-full mt-3 flex-shrink-0'></div>;
                    <span>Operational inefficiencies due to lack of data insights;
                    </span>;
                  </li>;
                  <li className='flex items-start gap-3'>;
                    <div className='w-2 h-2 bg-red-400 rounded-full mt-3 flex-shrink-0'></div>;
                  ...
                  <li className='flex items-start gap-3'>;
                    <div className='w-2 h-2 bg-red-400 rounded-full mt-3 flex-shrink-0'></div>;
                    <span>No predictive capabilities for patient care planning;
                    </span>;
                  </li>;
                </ul>;
              </div>;
            </section>;
            {/* Solution */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<section className="mb-16">;
              <h2 className="text-3xl font-bold text-white mb-6">Our Solution</h2>;
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20">;
                <h3 className="text-2xl font-semibold text-green-400 mb-4">Comprehensive Data Analytics Platform</h3>;
                <p className="text-white/90 text-lg mb-6">;
                  We built a comprehensive data analytics platform that provides real-time insights,We built a comprehensive data analytics platform that provides real-time insights,We built a comprehensive data analytics platform that provides real-time insights,predictive modeling, and automated reporting for improved patient care and operational efficiency.;
                </p>;
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">;
                  <div className="bg-white/5 rounded-lg p-6 border border-white/10">;
                    <h4 className="text-xl font-semibold text-purple-400 mb-3">Big Data Processing</h4>;
                    <p className="text-white/80">;
                      Advanced big data infrastructure processes millions of patient records,Advanced big data infrastructure processes millions of patient records,Advanced big data infrastructure processes millions of patient records,lab results, and operational data points in real-time.;
                    </p>;
                  </div>;
                  <div className="bg-white/5 rounded-lg p-6 border border-white/10">;
                  ...
                  <div className="bg-white/5 rounded-lg p-6 border border-white/10">;
                    ...
                    <p className="text-white/80">;
                      Live dashboards provide instant insights into patient conditions,Live dashboards provide instant insights into patient conditions,Live dashboards provide instant insights into patient conditions,resource utilization, and operational metrics.;
                    </p>;
                  </div>;
                  <div className="bg-white/5 rounded-lg p-6 border border-white/10">;
                    <h4 className="text-xl font-semibold text-purple-400 mb-3">Predictive Modeling</h4>;
                    <p className="text-white/80">;
                      Advanced predictive models forecast patient outcomes, readmission risks,Advanced predictive models forecast patient outcomes, readmission risks,Advanced predictive models forecast patient outcomes, readmission risks,{/* Solution */}
<section className='mb-16'>;
              <h2 className='text-3xl font-bold text-white mb-6'>;
                Our Solution;
              </h2>;
              <div className='bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20'>;
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>;
                  ...
                  <div className='bg-white/5 rounded-lg p-6 border border-white/10'>;
                    ...
                    <p className='text-white/80'>;
                      Advanced predictive models forecast patient outcomes,readmission risks, and resource requirements.;
            ...
            {/* Results */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<section className="mb-16">;
...
<section className='mb-16'>;
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>;
                  ...
                  <div>;
                    ...
                    <ul className='space-y-3 text-white/80'>;
                      <li className='flex items-start gap-3'>;
                        <div className='w-2 h-2 bg-green-400 rounded-full mt-3 flex-shrink-0'></div>;
                        <span>Improved clinical decision-making with data-driven;
                          insights;
                        </span>;
                      </li>;
                      <li className='flex items-start gap-3'>;
                        <div className='w-2 h-2 bg-green-400 rounded-full mt-3 flex-shrink-0'></div>;
                        <span>Reduced readmission rates through predictive;
                          interventions;
                        </span>;
                      </li>;
                      <li className='flex items-start gap-3'>;
                      ...
                      <li className='flex items-start gap-3'>;
                        <div className='w-2 h-2 bg-green-400 rounded-full mt-3 flex-shrink-0'></div>;
                        <span>Enhanced patient engagement and satisfaction;
                        </span>;
                      </li>;
                    </ul>;
                  </div>;
            ...
            {/* Technologies */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<section className="mb-16">;
              <h2 className="text-3xl font-bold text-white mb-6">Technologies Used</h2>;
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20">;
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">;
                  {['Big DataMachine LearningReal-time AnalyticsPredictive Modeling'].map((tech) => (<div key={tech} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">;
                      <span className="text-purple-400 font-semibold">{tech}</span>;
                    </div>;
import React from 'react';
export default function CaseStudyPage() {try {return (<>;
      <Head>;
          ...
          <div className="max-w-4xl mx-auto">;
            ...
            <section className="mb-16">;
              ...
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20">;
                <h3 className="text-2xl font-semibold text-green-400 mb-4">Comprehensive Data Analytics Platform</h3>;
                <p className="text-white/90 text-lg mb-6">;
                  We built a comprehensive data analytics platform that provides real-time insights,predictive modeling, and automated reporting for improved patient care and operational efficiency.;
                </p>;
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">;
                  <div className="bg-white/5 rounded-lg p-6 border border-white/10">;
                    <h4 className="text-xl font-semibold text-purple-400 mb-3">Big Data Processing</h4>;
                    <p className="text-white/80">;
                      Advanced big data infrastructure processes millions of patient records,lab results, and operational data points in real-time.;
                    </p>;
                  </div>;
                  <div className="bg-white/5 rounded-lg p-6 border border-white/10">;
                    <h4 className="text-xl font-semibold text-purple-400 mb-3">Machine Learning</h4>;
            ...
            {/* Implementation */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<section className="mb-16">;
...
<section className='mb-16'>;
              ...
              <div className='bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20'>;
                <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>;
                  {[;
                    'Big Data','Machine Learning','Real-time Analytics','Predictive Modeling';
                  ].map(tech => (<div;
                      key={tech}
              ...
              <div className='bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20'>;
                <div className='space-y-6'>;
                  <div className='flex items-center gap-4'>;
                    ...
                    <div>;
                      <h4 className='text-lg font-semibold text-white'>;
                        Data Assessment & Planning (Months 1-2)</h4>;
                  ...
                  <div className='flex items-center gap-4'>;
                    ...
                    <div>;
                      <h4 className='text-lg font-semibold text-white'>;
                        Infrastructure Development (Months 3-6)</h4>;
                      <p className='text-white/70'>;
                  ...
                  <div className='flex items-center gap-4'>;
                    ...
                    <div>;
                      <h4 className='text-lg font-semibold text-white'>;
                        Integration & Testing (Months 7-9)</h4>;
                      <p className='text-white/70'>;
                  ...
                  <div className='flex items-center gap-4'>;
                    ...
                    <div>;
                      <h4 className='text-lg font-semibold text-white'>;
                        Deployment & Training (Month 10)</h4>;
                      <p className='text-white/70'>;

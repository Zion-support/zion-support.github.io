  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='Discover how a Healthcare Provider achieved 30% improvement in patient outcomes with comprehensive data analytics platform. Read our detailed case study.'
        />
        <meta
          name='keywords'
              ...
              <div className='bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20'>
                <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                  {[
                    ...
                    <div
                      key={tech}
                      className='bg-white/5 rounded-lg p-4 text-center border border-white/10'><span className='text-purple-400 font-semibold'>
                        {tech}
                      </span>
ursor/integrate-build-improve-and-re-verify-b76c
            <section className="mb-16">

            ...
            {/* Company Overview */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
              ...
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20">;
                ...
                <p className="text-white/90 text-lg mb-4">;
                  A leading financial services company serving millions of customers with banking,A leading financial services company serving millions of customers with banking,A leading financial services company serving millions of customers with banking,import React from 'react',import Head from 'next/head';
...
<section className='mb-16'>;
              ...
              <div className='bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20'>;
                ...
                <ul className='space-y-3 text-white/90 text-lg'>;
                  <li className='flex items-start gap-3'>;
                    <div className='w-2 h-2 bg-red-400 rounded-full mt-3 flex-shrink-0'></div>;
                    <span>High customer service costs consuming 25% of operational;
                      budget;
                    </span>;
                  </li>;
                  <li className='flex items-start gap-3'>;
                  ...
                  <li className='flex items-start gap-3'>;
                    <div className='w-2 h-2 bg-red-400 rounded-full mt-3 flex-shrink-0'></div>;
                    <span>Inefficient ticket routing causing delays and customer;
                      frustration;
                    </span>;
                  </li>;
                  <li className='flex items-start gap-3'>;
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>;
                  ...
                  <div>;
                    ...
                    <ul className='space-y-3 text-white/80'>;
                      <li className='flex items-start gap-3'>;
                        <div className='w-2 h-2 bg-green-400 rounded-full mt-3 flex-shrink-0'></div>;
                        <span>Improved agent productivity and job satisfaction;
                        </span>;
                      </li>;
                      <li className='flex items-start gap-3'>;
                        <div className='w-2 h-2 bg-green-400 rounded-full mt-3 flex-shrink-0'></div>;
                        <span>Consistent service quality across all interactions;
                        </span>;
                      </li>;
                      <li className='flex items-start gap-3'>;
                        <div className='w-2 h-2 bg-green-400 rounded-full mt-3 flex-shrink-0'></div>;
                        <span>Real-time performance monitoring and optimization;
                        </span>;
                      </li>;
                      <li className='flex items-start gap-3'>;
                        <div className='w-2 h-2 bg-green-400 rounded-full mt-3 flex-shrink-0'></div>;
            ...
            {/* Technologies */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
              ...
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20">;
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">;
                  {['ChatbotsNatural Language ProcessingTicket RoutingSentiment Analysis'].map((tech) => (<div key={tech} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">;
...
<section className='mb-16'>;
              ...
              <div className='bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20'>;
                <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>;
                  {[;
                    'Chatbots','Natural Language Processing','Ticket Routing','Sentiment Analysis';
                  ].map(tech => (<div;
                      key={tech}
              ...
              <div className='bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20'>;
                <div className='space-y-6'>;
                  <div className='flex items-center gap-4'>;
                    ...
                    <div>;
                      <h4 className='text-lg font-semibold text-white'>;
                        System Design & Planning (Month 1)</h4>;
                  ...
                  <div className='flex items-center gap-4'>;
                    ...
                    <div>;
                      <h4 className='text-lg font-semibold text-white'>;
                        AI Model Training (Months 2-3)</h4>;
                      <p className='text-white/70'>;
                  ...
                  <div className='flex items-center gap-4'>;
                    ...
                    <div>;
                      <h4 className='text-lg font-semibold text-white'>;
                        Integration & Testing (Month 4)</h4>;
                      <p className='text-white/70'>;
                  ...
                  <div className='flex items-center gap-4'>;
                    ...
                    <div>;
                      <h4 className='text-lg font-semibold text-white'>;
                        Deployment & Training (Month 5)</h4>;
                      <p className='text-white/70'>;

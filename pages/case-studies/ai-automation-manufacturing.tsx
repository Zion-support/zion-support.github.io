...
;
    id: 'ai-automation-manufacturing',title: 'AI-Powered Manufacturing Automation',import React from 'react',import Head from 'next / head',import Link from 'next / link',export default /**;
 * CaseStudyPage - Function description;
 */;
function CaseStudyPage() {const case_study = {id: 'ai - automation - manufacturing',title: 'AI - Powered Manufacturing Automation',company: 'Global Manufacturing Corp',industry: 'Manufacturing',challenge: 'Inefficient production processes, high downtime, and quality control issues',solution: 'Implemented autonomous AI systems for predictive maintenance, quality control, and production optimization';
  }return (<>;
      <Head>;
...
<header className='mb-12 text-center'>;
            ...
            {/* Technologies */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">;
                {caseStudy.technologies.map((tech, index) => (<div key={index} className="bg-blue-500/10 rounded-lg p-4 border border-blue-500/20 text-center">;
            ...
            {/* Results */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">;
                {caseStudy.results.map((result, index) => (<div key={index} className="bg-yellow-500/10 rounded-lg p-6 border border-yellow-500/20">;
...
<section className='mb-12'>;
              ...
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>;
                {caseStudy.technologies.map((tech, index) => (<div;
                    key={index}
...
<section className='mb-12'>;
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>;
                {caseStudy.results.map((result, index) => (<div;
                    key={index}

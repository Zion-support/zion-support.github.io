...
import { Database, Server, Shield, Zap, CheckCircle, ArrowRight, BarChart3, RefreshCw } from 'lucide-react',
...
const databaseTypes = [,
  {,
    name: 'PostgreSQL', description: 'Open-source relational database with advanced features', useCases: ['Web applications', 'Analytics', 'Geospatial data'], ,
    icon: '🐘' ,},;
  {,
    name: 'MySQL', description: 'Popular open-source database for web applications', useCases: ['E-commerce', 'Content management', 'Small to medium apps'], ,
    icon: '🐬' ,},;
  {,
    name: 'MongoDB', description: 'NoSQL document database for modern applications', useCases: ['Real-time analytics', 'Content management', 'Mobile apps'], ,
    icon: '🍃' ,},;
  {,
    name: 'Redis', description: 'In-memory data structure store for caching', useCases: ['Caching', 'Session storage', 'Real-time features'], ,
    icon: '🔴' ,},;
  {,
    name: 'Elasticsearch', description: 'Search and analytics engine for complex queries', useCases: ['Search functionality', 'Log analysis', 'Business intelligence'], ,
    icon: '🔍' ,},;
  {,
    name: 'ClickHouse', description: 'Columnar database for real-time analytics', useCases: ['Big data analytics', 'Time series data', 'OLAP workloads'], ,
    icon: '⚡' ,}],
const pricingPlans = [,
  {,
    name: 'Consultation', price: '$150', period: '/hour', description: 'Database assessment and planning', features: [,
      'Database audit', 'Performance analysis', ,
      'Security review', ,
      'Optimization recommendations', ,
      'Migration planning'] },;
  {,
    name: 'Implementation', price: '$1,000', ,
    period: '/project', description: 'Complete database setup and migration', features: ['Database design', 'Migration execution', ,
      'Performance tuning', ,
    ...
    popular: true ,},;
  {,
    name: 'Management', price: '$1,500', ,
    period: '/month', description: 'Ongoing database management and support', features: ['24/7 monitoring', 'Performance optimization', ,
      'Security updates', ,
      'Backup management', ,
      'Incident response', ,
      'Monthly reports'] }],

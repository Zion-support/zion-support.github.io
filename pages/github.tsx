...
const GitHub: React.FC = () => {
  ...
  const discussions = [
    {
      id: 1,
      title: 'How to integrate AI chatbot with React?',
      ...
      replies: 12,
      views: 156,
      tags: ['react', 'ai', 'chatbot', 'integration']
    },
    {
      id: 2,
      title: 'New AI model release: GPT-4 Turbo',
      author: 'zion_team',
      authorAvatar: '🤖',
      ...
      replies: 45,
      views: 1200,
      tags: ['announcement', 'gpt-4', 'ai-model', 'release']
    },
    {
      id: 3,
      title: 'Feature request: Better API documentation',
      author: 'sarah_dev',
      authorAvatar: '👩‍💻',
      category: 'ideas',
      status: 'open',
      ...
      replies: 8,
      views: 89,
      tags: ['feature-request', 'api', 'documentation', 'improvement']
    },
    {
      id: 4,
      title: 'Showcase: AI-powered e-commerce recommendation system',
      author: 'mike_ai',
      authorAvatar: '👨‍🔬',
      category: 'showcase',
      status: 'closed',
      ...
      replies: 23,
      views: 456,
      tags: ['showcase', 'e-commerce', 'recommendation', 'ai']
    },
    {
      id: 5,
      title: 'Troubleshooting: API rate limit issues',
      author: 'dev_help',
      authorAvatar: '🔧',
      category: 'help',
      status: 'open',
      ...
      replies: 6,
      views: 78,
      tags: ['troubleshooting', 'api', 'rate-limit', 'help']
    },
    {
      id: 6,
      title: 'General discussion: Future of AI in web development',
      ...
      replies: 34,
      views: 234,
      tags: ['general', 'ai', 'web-development', 'future']
    }
  ];

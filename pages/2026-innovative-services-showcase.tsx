...
import Head from 'next/head';
import Link from 'next/link';
import { motion, AnimatePresence } from 'framer-motion';=======import React, { useState, useMemo } from 'react';
import Head from 'next/head';
import Link from 'next/link';
import { motion, AnimatePresence } from 'framer-motion';

>>>>>>> cursor/fix-website-loading-errors-and-merge-6662import { emergingTech2026ServicesV4 } from '../data/emerging-tech-2026-services-v4';
...
>>>>>>> f8e247744ae2f2b9a6ba0423164ce0dcdffb9f6a
                      ...
                      <div className="mb-4">
                        <span className={`inline-block px-3 py-1 rounded-full text-xs font-medium ${service.textColor} bg-opacity-20`}>
                          {service.category}                          className={`inline-block px-3 py-1 rounded-full text-xs font-medium ${service && service.textColor} bg-opacity-20`}>                          {service && service.category}
                        </span>;
                      </div>;

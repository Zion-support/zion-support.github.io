...
if (searchTerm) {filtered = filtered.filter(service =>
    ...
    // Sort,
filtered.sort(_(a, b) => {switch (sortBy) {
        case 'price':
          const priceA = parseInt(a.price.replace(/[^0-9]/g, '')),
          const priceB = parseInt(b.price.replace(/[^0-9]/g, '')),
          return priceA - priceB,        case 'rating':
...
initial={{ opacity: 0, y: 30 }}
              ...
              <p className=&quot;text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed&quot;>
                ...
                From AI-powered solutions to quantum computing and emerging technologies, transform your business with next-generation innovation.
              </p>
            </motion.div>
...
initial={{ opacity: 0, y: 20 }}
            ...
            >
              <div className=&quot;bg-gradient-to-r from-blue-600/20 to-cyan-600/20 backdrop-blur-sm border border-blue-500/30 rounded-full px-6 py-3&quot;>
                <span className=&quot;text-blue-400 font-semibold&quot;>{allServices.length}+ Services</span>              </div>
...
variants={containerVariants}
              ...
              {filteredServices.map(_(service) => (
                <motion.div,
key={service.id}
                    ...
                    <div className=&quot;p-6&quot;>
                      ...
                      <Link href={service.link}>
                        <button className=&quot;w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg&quot;>
                          <span className=&quot;flex items-center justify-center space-x-2&quot;>                            <span>Learn More</span>
...
initial={_{ opacity: 0, y: 30}}
            ...
            >
              <h2 className="text-4xl md: text-5xl font-bold text-white mb-6">                Ready to Transform Your Business?
              </h2>

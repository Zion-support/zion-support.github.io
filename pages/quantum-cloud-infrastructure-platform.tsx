...
import ServiceLanding from '../components/sections/ServiceLanding';
  return (<>;
  ...
  )import Head from 'next/head',import ServiceLanding from '../components/sections/ServiceLanding',export default function QuantumCloudInfrastructurePlatformPage() {return (<>;
			<Head>;
				<title>Quantum Cloud Infrastructure Platform | Zion Tech Group</title>;
      ...
      <ServiceLanding;
        ...
        features={[;
          'Managed quantum accelerators','Zero - trust and quantum - safe security','Observability and SLOs','Automated cost controls','Cross - region DR and backup','Compliance and audit kits';
          'Compliance and audit kits';
        ]}
        industries={[;
          'Financial Services','Life Sciences','Government','Energy','Media';
          'Media';
        ]}
        canonical='https: //ziontechgroup.com / quantum - cloud - infrastructure - platform';
      />;

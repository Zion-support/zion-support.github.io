...
export default function AIMeetingNotesPage() {_return (
		<>
			<SEO title="AI Meeting Notes" description="Automatic meeting transcription, _summaries, _and action items." canonical="/ai-meeting-notes" />
			<section className="relative pt-28 pb-16 md:pt-36 md:pb-24">
				<div className="container mx-auto px-4 max-w-3xl">
					...
					<p className="mt-4 text-gray-300">Transcribe calls, _summarize discussions, _and capture action items automatically.</p>

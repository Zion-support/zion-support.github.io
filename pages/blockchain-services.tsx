...
import { Link as LinkIcon, Shield, Coins, Globe, CheckCircle, ArrowRight, Phone, Mail, MapPin, DollarSign, Clock, Award, Users, Smartphone, Target } from 'lucide-react'
...
const blockchainServices = [
  {
    id: 1, icon: LinkIcon, category: 'Development', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-30, 000/month', ;
    setupTime: '4-8 weeks', features: [
    ...
    benefits: ['Reduce transaction costs by 60-80%', 'Eliminate intermediaries and middlemen', ;
      'Enable 24/7 automated operations', ;
      'Increase transparency and trust'], ;
    targetUsers: 'DeFi Projects, NFT Platforms, DAOs, Enterprises' },;
  {
    id: 2, icon: Coins, category: 'DeFi', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-100, 000/month', ;
    setupTime: '8-16 weeks', features: ['Decentralized exchanges(DEX)', 'Lending & borrowing protocols', ;
    ...
    benefits: ['Generate revenue through trading fees', 'Access global liquidity pools', ;
      'Enable permissionless financial services', ;
      'Reduce counterparty risk'], ;
    targetUsers: 'Financial Institutions, Crypto Exchanges, DeFi Startups' },;
  {
    id: 3, icon: Globe, category: 'NFT', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-60, 000/month', ;
    setupTime: '6-12 weeks', features: ['Multi-chain NFT support', 'Auction & bidding systems', ;
      'Royalty management', ;
    ...
    benefits: ['Tap into $50B+ NFT market', 'Enable new revenue streams', ;
      'Build engaged communities', ;
      'Create unique digital assets'], ;
    targetUsers: 'Artists, Creators, Brands, Gaming Companies' },;
  {
    id: 4, icon: Target, category: 'Consulting', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-20, 000/month', ;
    setupTime: '1-2 weeks', features: ['Blockchain strategy development', 'Technology stack selection', ;
      'Tokenomics design', ;
    ...
    benefits: ['Make informed blockchain decisions', 'Reduce implementation risks by 70%', ;
      'Accelerate time-to-market', ;
      'Ensure regulatory compliance'], ;
    targetUsers: 'Enterprises, Startups, Government, Investors' },;
  {
    id: 5, icon: Smartphone, category: 'Web3', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-50, 000/month', ;
    setupTime: '6-10 weeks', features: ['Wallet integration(MetaMask, WalletConnect)', ;
    ...
    benefits: ['Build next-generation applications', 'Enable user ownership of data', ;
      'Create censorship-resistant platforms', ;
      'Access global user base'], ;
    targetUsers: 'Tech Companies, Startups, Developers, Enterprises' },;
  {
    id: 6, icon: Shield, category: 'Security', price: 'Starting at $1,000/month', ;
    marketPrice: '$1,000-40, 000/month', ;
    setupTime: '2-4 weeks', features: ['Smart contract security audits', 'Penetration testing', ;
      ...
      'Incident response', ;
      'Security training'], ;
    benefits: ['Prevent costly security breaches', 'Protect user funds and data', ;
...
const industries = [
  {
    icon: "🏦", useCases: ["Cross-border payments", "Lending platforms", "Asset tokenization", "Trading systems"] },;
  {
    icon: "🎮", useCases: ["Game assets as NFTs", "In-game economies", "Player ownership", "Virtual worlds"] },;
  {
    icon: "📦", useCases: ["Product provenance", "Anti-counterfeiting", "Quality assurance", "Traceability"] },;
  {
    icon: "🏠", useCases: ["Property tokens", "Fractional ownership", "Rental income sharing", "Property management"] },;
  {
    icon: "🏥", useCases: ["Medical records", "Drug authentication", "Clinical trials", "Patient data"] },;
  {
    icon: "🌱", useCases: ["Carbon credits", "Energy trading", "Sustainability tracking", "Green certificates"] }]
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl md:text-2xl mb-8 text-blue-100">
                Transform your business with cutting-edge blockchain technology. From DeFi platforms to NFT marketplaces, we deliver secure, scalable, and innovative blockchain solutions that drive growth and create new opportunities.;
              </p>

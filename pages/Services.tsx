      ...
      services: [
        {
          ...
          description: "Complete cloud infrastructure migration with zero downtime and enhanced security.",
          price: "$2,999/project",
          features: ["Zero-downtime migration", "Security assessment", "Performance optimization", "24/7 support"],
          link: "/it-services"
        },
        {
          name: "Cybersecurity Solutions",
          description: "Comprehensive cybersecurity platform with threat detection, prevention, and response capabilities.",
          price: "$799/month",
          features: ["Threat monitoring", "Vulnerability scanning", "Incident response", "Security training"],
          link: "/it-services"
        },
        {
          ...
          price: "$5,999/project",
          features: ["Process automation", "Technology integration", "Change management", "Training programs"],
          link: "/it-services"
        }
      ]
    },
      ...
      services: [
        {
          ...
          description: "Automated return request system with label generation and status tracking for e-commerce businesses.",
          price: "$149/month",
          features: ["Automated returns", "Label generation", "Status tracking", "Analytics"],
          link: "/micro-saas"
        },
        {
          name: "Customer Support Platform",
          description: "Comprehensive helpdesk platform with ticket management, knowledge base, and AI-powered chatbots.",
          price: "$299/month",
        ...
        },
        {
          ...
          price: "$199/month",
          features: ["Smart task assignment", "Progress tracking", "Team collaboration", "Resource optimization"],
          link: "/micro-saas"
        }
      ]
    }
            ...
            <div key={categoryIndex} className="mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {category.services.map((service, serviceIndex) => (
                  <div key={serviceIndex} className="bg-gray-800 p-6 rounded-lg hover:bg-gray-700 transition-colors">

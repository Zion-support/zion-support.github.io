...
const products = [
  { , ;
    icon: Brain, category: "AI Solutions", features: [
      "Machine Learning Models", "Predictive Analytics", ;
      "Real-time Dashboards", ;
      "Custom AI Training", ;
      "API Integration", ;
      "Multi-cloud Support"], ;
    pricing: "Starting at $299/month", rating: 4.9, reviews: 127, href: "/products/zion-ai-analytics" },;
  { , ;
    icon: Shield, category: "Security", features: ["Zero-Trust Architecture", "Threat Detection", ;
      "Compliance Management", ;
      "Real-time Monitoring", ;
      "Automated Response", ;
      "Multi-cloud Security"], ;
    pricing: "Starting at $499/month", rating: 4.8, reviews: 89, href: "/products/cloudsecure-pro" },;
  { , ;
    icon: Database, category: "Data Solutions", features: ["Real-time Processing", "ETL Pipelines", ;
      "Data Transformation", ;
      "Scalable Architecture", ;
      "API Management", ;
      "Monitoring & Alerts"], ;
    pricing: "Starting at $199/month", rating: 4.7, reviews: 156, href: "/products/dataflow-engine" },;
  { , ;
    icon: Smartphone, category: "Content Management", features: ["Headless Architecture", "Mobile Optimization", ;
      "Content Versioning", ;
      "Multi-language Support", ;
      "SEO Optimization", ;
      "Developer APIs"], ;
    pricing: "Starting at $149/month", rating: 4.6, reviews: 98, href: "/products/mobilefirst-cms" },;
  { , ;
    icon: Cloud, category: "Cloud Infrastructure", features: ["Auto-scaling", "Multi-cloud Support", ;
      "Cost Optimization", ;
      "Monitoring & Alerts", ;
      "DevOps Integration", ;
      "Security Compliance"], ;
    pricing: "Starting at $399/month", rating: 4.8, reviews: 203, href: "/products/zioncloud-platform" },;
  { , ;
    icon: Zap, category: "Automation", features: ["Process Automation", "Workflow Designer", ;
      "Integration Hub", ;
      "Task Management", ;
      "Analytics & Reporting", ;
      "Custom Triggers"], ;
    pricing: "Starting at $99/month", rating: 4.5, reviews: 167, href: "/products/workflowmax" }]

const categories = [{ name: "All Products", count: 6, active: true }, ;

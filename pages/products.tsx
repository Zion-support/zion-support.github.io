      ...
      <div className='relative overflow-hidden'>
        ...
        <div className='relative container mx-auto px-4 py-24 text-center text-white'>
          ...
          <p className='text-xl mb-8 max-w-3xl mx-auto text-gray-300'>
            Revolutionary technology products designed to transform how you
            work, create, and grow. From AI-powered solutions to
            enterprise-grade security, we deliver innovation that drives
            results.
          </p>
            ...
            return (
              ...
              >
                <div className='flex items-start justify-between mb-6'>
                  <div
                    className={`w-16 h-16 rounded-lg bg-gradient-to-r ${product.color} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                  >
          ...
          <div className='bg-white/10 backdrop-blur-sm rounded-2xl p-12 text-center'>
            ...
            <div className='grid md:grid-cols-3 gap-8 mb-8'>
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-300 text-sm'>
                  Rebrand our products as your own with custom integrations
                </p>
              </div>
              <div className='text-center'>
                ...
                <p className='text-gray-300 text-sm'>
                  24/7 dedicated support team and priority response
                </p>
              </div>
            </div>
            ...
            <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
              ...
              <div className='bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-6 border border-white/20 transform scale-105'>
                ...
                <div className='text-4xl font-bold text-white mb-6'>
                  $299<span className='text-lg text-blue-100'>/month</span>
                </div>
                <ul className='space-y-3 mb-8'>
                ...
                <a
                  ...
                  className='w-full bg-white text-blue-600 text-center py-3 px-4 rounded-lg font-medium transition-colors block hover:bg-gray-100'
                >
                  Get Started
                </a>
              </div>
        ...
        <div className='text-center mt-20'>
          <div className='bg-white/10 backdrop-blur-sm rounded-2xl p-12 max-w-4xl mx-auto'>
            ...
            <p className='text-xl mb-8 text-gray-300'>
              Start your free trial today or schedule a personalized demo to see

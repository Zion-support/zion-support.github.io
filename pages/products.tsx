...
;
      ...
      <div className="container mx-auto px-4 py-16">;
        <div className="flex flex-wrap justify-center gap-4 mb-16">;
          {productCategories.map((((((((category, index, index, index, index, index, index) => ({ ...((((((category, index, index, index, index, index, key: index })) => ({ ...(((((category, index, index, index, index, key: index })) => ({ ...((((category, index, index, index, key: index })) => ({ ...(((category, index, index, key: index })) => ({ ...((category, index, key: index })) => ({ ...(category, key: index })) => {;
...
;
        ...
        <div className = "grid lg:grid-cols-2 gap-8">;
          {filteredProducts.map((((((((product, index, index, index, index, index, index) => ({ ...((((((product, index, index, index, index, index, key: index })) => ({ ...(((((product, index, index, index, index, key: index })) => ({ ...((((product, index, index, index, key: index })) => ({ ...(((product, index, index, key: index })) => ({ ...((product, index, key: index })) => ({ ...(product, key: index })) => {;
...
;
                <div className="mb-6">;
                  ...
                  <ul className="space-y-2">;
                    {product.benefits.map((((((((benefit, index, index, index, index, index, index, index) => ({ ...((((((benefit, index, index, index, index, index, index, key: index })) => ({ ...(((((benefit, index, index, index, index, index, key: index })) => ({ ...((((benefit, index, index, index, index, key: index })) => ({ ...(((benefit, index, index, index, key: index })) => ({ ...((benefit, index, index, key: index })) => ({ ...(benefit, index, key: index })) => (;
